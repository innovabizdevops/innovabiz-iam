...
export class ProcurementService {
    ...
    getHello(): string {
        return "Hello from Procurement Core (SCM.03) - Universally Harmonized!";
    }
    ...
    async create(data: any) {
        ...
        this.logger.log(`[SCM.03] Created Record: ${id}`);
        return { status: 'SUCCESS', id, message: 'Procurement Entry Created' };
    }

    async findAll() {
        this.logger.log(`[SCM.03] Retrieving all records...`);
