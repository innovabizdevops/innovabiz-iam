...
export class TreasuryService {
    ...
    getHello(): string {
        return "Hello from Treasury Core (FIN.02) - Universally Harmonized!";
    }
    ...
    async create(data: any) {
        ...
        this.logger.log(`[FIN.02] Created Record: ${id}`);
        return { status: 'SUCCESS', id, message: 'Treasury Entry Created' };
    }

    async findAll() {
        this.logger.log(`[FIN.02] Retrieving all records...`);
