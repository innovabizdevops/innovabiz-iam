...
describe('DocumentManagementService', () => {
    ...
    beforeEach(async () => {
        const module: TestingModule = await Test.createTestingModule({
            providers: [DocumentManagementService, PRISMA_MOCK_PROVIDER],
        }).compile();
    ...
    describe('CRUD', () => {
        ...
        it('should findOne', async () => { const c = await service.create({ t: 'X' }); expect(((await service.findOne(c.id)) as any).t).toBe('X'); });
