...
export class ConstructionService {
    ...
    getHello(): string {
        return "Hello from Construction Core (CONST.01) - Universally Harmonized!";
    }
    ...
    async create(data: any) {
        ...
        this.logger.log(`[CONST.01] Created Record: ${id}`);
        return { status: 'SUCCESS', id, message: 'Construction Entry Created' };
    }

    async findAll() {
        this.logger.log(`[CONST.01] Retrieving all records...`);
