...
export class EsgService {
    ...
    getHello(): string {
        return "Hello from Esg Core (STRAT.02) - Universally Harmonized!";
    }
    ...
    async create(data: any) {
        ...
        this.logger.log(`[STRAT.02] Created Record: ${id}`);
        return { status: 'SUCCESS', id, message: 'Esg Entry Created' };
    }

    async findAll() {
        this.logger.log(`[STRAT.02] Retrieving all records...`);
