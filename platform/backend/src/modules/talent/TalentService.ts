...
export class TalentService {
    ...
    getHello(): string {
        return "Hello from Talent Core (HCM.01) - Universally Harmonized!";
    }
    ...
    async create(data: any) {
        ...
        this.logger.log(`[HCM.01] Created Record: ${id}`);
        return { status: 'SUCCESS', id, message: 'Talent Entry Created' };
    }

    async findAll() {
        this.logger.log(`[HCM.01] Retrieving all records...`);
