...
export class AssetsService {
    ...
    getHello(): string {
        return "Hello from Assets Core (FIN.04) - Universally Harmonized!";
    }
    ...
    async create(data: any) {
        ...
        this.logger.log(`[FIN.04] Created Record: ${id}`);
        return { status: 'SUCCESS', id, message: 'Assets Entry Created' };
    }

    async findAll() {
        this.logger.log(`[FIN.04] Retrieving all records...`);
