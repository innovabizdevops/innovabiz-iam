...
const PAGE = "Capacity";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.760","t":"+9.5%","d":"up"},{"l":"NC Abertas","v":"8.422","t":"+8.9%","d":"up"},{"l":"Conformidade (%)","v":"86.0%","t":"+14.6%","d":"up"},{"l":"CAPAs Pendentes","v":"2.680","t":"-2.1%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","9.083","80.1%","6.196","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.653","98.5%","2.991","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.213","81.8%","3.040","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.588","92.7%","7.561","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.248","92.3%","5.761","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":822},{"label":"Fev","value":907},{"label":"Mar","value":959},{"label":"Abr","value":764},{"label":"Mai","value":689},{"label":"Jun","value":869},{"label":"Jul","value":934},{"label":"Ago","value":1016},{"label":"Set","value":744},{"label":"Out","value":920},{"label":"Nov","value":1001},{"label":"Dez","value":771}];
const MX = 1016;
