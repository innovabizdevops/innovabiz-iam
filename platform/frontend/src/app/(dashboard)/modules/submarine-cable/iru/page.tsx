...
const ACCENT = "#6366f1";
const MODULE = "Submarine Cable";
const PAGE = "IRU";
const KPIS = [{"l":"Total Submarine Cable","v":"6.946","t":"-3.7%","d":"down"},{"l":"IRU Ativos","v":"5.503","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"89.8%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"85","t":"+1.8%","d":"up"}];
const COLS = ["ID","IRU","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Submarine Cable #001","Submarine Cable #002","8.005","7.716","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Submarine Cable #002","Submarine Cable #003","2.561","4.754","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Submarine Cable #003","Submarine Cable #004","4.735","6.400","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Submarine Cable #004","Submarine Cable #005","5.450","6.734","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Submarine Cable #005","Submarine Cable #001","7.422","2.594","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":629},{"label":"Mar","value":952},{"label":"Abr","value":869},{"label":"Mai","value":852},{"label":"Jun","value":728},{"label":"Jul","value":953},{"label":"Ago","value":957},{"label":"Set","value":898},{"label":"Out","value":698},{"label":"Nov","value":828},{"label":"Dez","value":766}];
const MX = 957;
...
export default function IruPage() {
    return (
