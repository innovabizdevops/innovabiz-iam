...
const PAGE = "Route";
const KPIS = [{"l":"Total Submarine Cable","v":"8.858","t":"+0.4%","d":"up"},{"l":"Route Ativos","v":"3.767","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"87.4%","t":"+4.3%","d":"up"},{"l":"Score Performance","v":"70","t":"+2.1%","d":"up"}];
const COLS = ["ID","Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Submarine Cable #001","Submarine Cable #002","513","3.796","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Submarine Cable #002","Submarine Cable #003","1.990","3.113","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Submarine Cable #003","Submarine Cable #004","8.544","2.670","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Submarine Cable #004","Submarine Cable #005","2.823","6.142","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Submarine Cable #005","Submarine Cable #001","4.469","8.982","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":260},{"label":"Mar","value":280},{"label":"Abr","value":503},{"label":"Mai","value":290},{"label":"Jun","value":430},{"label":"Jul","value":276},{"label":"Ago","value":606},{"label":"Set","value":473},{"label":"Out","value":410},{"label":"Nov","value":249},{"label":"Dez","value":506}];
const MX = 606;
