...
const PAGE = "Modeling";
const KPIS = [{"l":"Total Climate Tech","v":"2.192","t":"+16.1%","d":"up"},{"l":"Modeling Ativos","v":"1.622","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"89","t":"-4.1%","d":"down"}];
const COLS = ["ID","Modeling","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Climate Tech #001","Climate Tech #002","8.275","5.526","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Climate Tech #002","Climate Tech #003","712","1.550","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Climate Tech #003","Climate Tech #004","1.652","1.231","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Climate Tech #004","Climate Tech #005","258","1.478","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Climate Tech #005","Climate Tech #001","4.274","7.933","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":1078},{"label":"Mar","value":858},{"label":"Abr","value":1071},{"label":"Mai","value":1091},{"label":"Jun","value":714},{"label":"Jul","value":865},{"label":"Ago","value":887},{"label":"Set","value":821},{"label":"Out","value":726},{"label":"Nov","value":912},{"label":"Dez","value":856}];
const MX = 1091;
