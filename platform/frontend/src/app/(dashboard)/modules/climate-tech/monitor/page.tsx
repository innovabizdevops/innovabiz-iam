...
const ACCENT = "#16a34a";
const MODULE = "Climate Tech";
const PAGE = "Monitoring";
const KPIS = [{"l":"Total Climate Tech","v":"3.164","t":"+2.5%","d":"up"},{"l":"Monitoring Ativos","v":"8.527","t":"+13.5%","d":"up"},{"l":"Eficiência (%)","v":"89.9%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"72","t":"+1.2%","d":"up"}];
const COLS = ["ID","Monitoring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Climate Tech #001","Climate Tech #002","2.753","5.442","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Climate Tech #002","Climate Tech #003","1.031","802","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Climate Tech #003","Climate Tech #004","8.069","5.698","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Climate Tech #004","Climate Tech #005","1.533","6.298","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Climate Tech #005","Climate Tech #001","7.158","2.271","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":444},{"label":"Mar","value":635},{"label":"Abr","value":480},{"label":"Mai","value":595},{"label":"Jun","value":530},{"label":"Jul","value":533},{"label":"Ago","value":604},{"label":"Set","value":415},{"label":"Out","value":783},{"label":"Nov","value":554},{"label":"Dez","value":753}];
const MX = 783;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#16a34a'}}>IoT</span></h1>
                </div>
