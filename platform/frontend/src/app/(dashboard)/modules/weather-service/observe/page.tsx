...
const ACCENT = "#0ea5e9";
const MODULE = "Meteorological Service";
const PAGE = "Observe";
const KPIS = [{"l":"Total Weather Service","v":"4.911","t":"+14.4%","d":"up"},{"l":"Observe Ativos","v":"1.718","t":"-3.8%","d":"down"},{"l":"Eficiência (%)","v":"73.1%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"94","t":"+12.7%","d":"up"}];
const COLS = ["ID","Observe","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Weather Service #001","Weather Service #002","3.495","7.178","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Weather Service #002","Weather Service #003","3.358","4.552","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Weather Service #003","Weather Service #004","2.623","3.293","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Weather Service #004","Weather Service #005","6.341","1.894","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Weather Service #005","Weather Service #001","7.736","1.647","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":392},{"label":"Mar","value":401},{"label":"Abr","value":560},{"label":"Mai","value":384},{"label":"Jun","value":503},{"label":"Jul","value":332},{"label":"Ago","value":451},{"label":"Set","value":344},{"label":"Out","value":329},{"label":"Nov","value":387},{"label":"Dez","value":578}];
const MX = 578;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0ea5e9'}}>IoT</span></h1>
                </div>
