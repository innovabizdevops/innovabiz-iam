...
const PAGE = "Forecast";
const KPIS = [{"l":"Total Weather Service","v":"8.453","t":"+18.0%","d":"up"},{"l":"Forecast Ativos","v":"8.791","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"74.6%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"72","t":"+3.3%","d":"up"}];
const COLS = ["ID","Forecast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Weather Service #001","Weather Service #002","6.005","8.195","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Weather Service #002","Weather Service #003","4.235","2.263","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Weather Service #003","Weather Service #004","2.222","3.291","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Weather Service #004","Weather Service #005","2.688","5.344","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Weather Service #005","Weather Service #001","8.736","7.686","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":847},{"label":"Mar","value":833},{"label":"Abr","value":961},{"label":"Mai","value":627},{"label":"Jun","value":935},{"label":"Jul","value":1001},{"label":"Ago","value":744},{"label":"Set","value":768},{"label":"Out","value":909},{"label":"Nov","value":802},{"label":"Dez","value":698}];
const MX = 1001;
