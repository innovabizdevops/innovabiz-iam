...
const PAGE = "Climate";
const KPIS = [{"l":"Total Weather Service","v":"8.306","t":"+3.9%","d":"up"},{"l":"Climate Ativos","v":"6.653","t":"+14.8%","d":"up"},{"l":"Eficiência (%)","v":"93.1%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"65","t":"-5.7%","d":"down"}];
const COLS = ["ID","Climate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Weather Service #001","Weather Service #002","1.746","4.050","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Weather Service #002","Weather Service #003","3.472","3.665","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Weather Service #003","Weather Service #004","6.390","871","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Weather Service #004","Weather Service #005","8.533","5.707","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Weather Service #005","Weather Service #001","884","6.891","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":663},{"label":"Mar","value":776},{"label":"Abr","value":772},{"label":"Mai","value":741},{"label":"Jun","value":697},{"label":"Jul","value":731},{"label":"Ago","value":745},{"label":"Set","value":778},{"label":"Out","value":947},{"label":"Nov","value":719},{"label":"Dez","value":798}];
const MX = 947;
