...
const PAGE = "Aviation";
const KPIS = [{"l":"Total Weather Service","v":"2.120","t":"+5.3%","d":"up"},{"l":"Aviation Ativos","v":"2.577","t":"+4.9%","d":"up"},{"l":"Eficiência (%)","v":"79.7%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"86","t":"-2.7%","d":"down"}];
const COLS = ["ID","Aviation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Weather Service #001","Weather Service #002","120","5.675","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Weather Service #002","Weather Service #003","3.928","5.054","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Weather Service #003","Weather Service #004","6.693","6.113","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Weather Service #004","Weather Service #005","1.336","2.846","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Weather Service #005","Weather Service #001","1.121","1.944","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":899},{"label":"Mar","value":673},{"label":"Abr","value":548},{"label":"Mai","value":532},{"label":"Jun","value":615},{"label":"Jul","value":562},{"label":"Ago","value":854},{"label":"Set","value":841},{"label":"Out","value":808},{"label":"Nov","value":707},{"label":"Dez","value":719}];
const MX = 899;
