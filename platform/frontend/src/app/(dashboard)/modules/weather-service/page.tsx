...
/* ═══ Meteorological Service — Dashboard ═══ */

const ACCENT = "#0ea5e9";

const KPIS = [
    { label: "Total Registos", value: "5877", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "196", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€54K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1521289277", cells: ["WEA-2277", "Meteorological Service Item 1", "26/6/2026", "€39 377"], status: "active" as const },
    { id: "1521292848", cells: ["WEA-5848", "Meteorological Service Item 2", "13/1/2026", "€42 948"], status: "pending" as const },
    { id: "1521296419", cells: ["WEA-9419", "Meteorological Service Item 3", "28/8/2026", "€46 519"], status: "completed" as const },
    { id: "1521299990", cells: ["WEA-3990", "Meteorological Service Item 4", "15/3/2026", "€50 090"], status: "warning" as const },
    { id: "1521303561", cells: ["WEA-7561", "Meteorological Service Item 5", "2/10/2026", "€3661"], status: "active" as const },
];
...
export default function MeteorologicalServicePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Meteorological Service</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Meteorological Service</p>
                    </div>
                </div>
