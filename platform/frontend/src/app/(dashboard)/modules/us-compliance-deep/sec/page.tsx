...
const PAGE = "SEC";
const KPIS = [{"l":"Auditorias Realizadas","v":"932","t":"+1.2%","d":"up"},{"l":"NC Abertas","v":"1.368","t":"+15.1%","d":"up"},{"l":"Conformidade (%)","v":"69.6%","t":"-2.7%","d":"down"},{"l":"CAPAs Pendentes","v":"5.837","t":"+11.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.833","99.4%","7.753","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.987","80.4%","6.764","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.094","78.1%","7.356","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.994","73.5%","1.615","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.404","91.5%","7.074","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":741},{"label":"Mar","value":554},{"label":"Abr","value":616},{"label":"Mai","value":475},{"label":"Jun","value":606},{"label":"Jul","value":607},{"label":"Ago","value":590},{"label":"Set","value":495},{"label":"Out","value":440},{"label":"Nov","value":486},{"label":"Dez","value":487}];
const MX = 741;
