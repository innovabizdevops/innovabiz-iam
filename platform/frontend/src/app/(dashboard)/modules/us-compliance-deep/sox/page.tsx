...
const ACCENT = "#14532d";
const MODULE = "US Compliance Deep";
const PAGE = "SOX";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.315","t":"+13.2%","d":"up"},{"l":"NC Abertas","v":"3.208","t":"+10.2%","d":"up"},{"l":"Conformidade (%)","v":"89.4%","t":"-1.4%","d":"down"},{"l":"CAPAs Pendentes","v":"8.185","t":"+6.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.595","83.5%","1.352","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.966","72.5%","6.972","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.270","93.2%","4.802","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.975","75.0%","5.899","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.638","94.4%","2.072","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":559},{"label":"Mar","value":280},{"label":"Abr","value":353},{"label":"Mai","value":285},{"label":"Jun","value":295},{"label":"Jul","value":382},{"label":"Ago","value":581},{"label":"Set","value":554},{"label":"Out","value":427},{"label":"Nov","value":233},{"label":"Dez","value":346}];
const MX = 581;
