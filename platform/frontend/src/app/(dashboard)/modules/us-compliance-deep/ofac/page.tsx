...
const PAGE = "OFAC";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.043","t":"+8.1%","d":"up"},{"l":"NC Abertas","v":"7.671","t":"-5.4%","d":"down"},{"l":"Conformidade (%)","v":"90.5%","t":"+14.1%","d":"up"},{"l":"CAPAs Pendentes","v":"4.061","t":"+5.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.060","87.0%","4.149","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.200","78.8%","6.831","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.692","97.9%","6.223","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.225","83.1%","1.896","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.598","98.1%","7.158","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":589},{"label":"Mar","value":339},{"label":"Abr","value":642},{"label":"Mai","value":392},{"label":"Jun","value":623},{"label":"Jul","value":419},{"label":"Ago","value":451},{"label":"Set","value":657},{"label":"Out","value":294},{"label":"Nov","value":354},{"label":"Dez","value":326}];
const MX = 657;
