...
const PAGE = "ADA";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.642","t":"+14.2%","d":"up"},{"l":"NC Abertas","v":"8.485","t":"+17.7%","d":"up"},{"l":"Conformidade (%)","v":"74.0%","t":"+15.0%","d":"up"},{"l":"CAPAs Pendentes","v":"8.116","t":"-1.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.576","87.2%","3.060","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.000","77.6%","4.908","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.717","86.2%","1.368","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.467","91.0%","8.336","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.190","87.3%","1.623","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":691},{"label":"Mar","value":557},{"label":"Abr","value":716},{"label":"Mai","value":602},{"label":"Jun","value":717},{"label":"Jul","value":562},{"label":"Ago","value":575},{"label":"Set","value":800},{"label":"Out","value":590},{"label":"Nov","value":547},{"label":"Dez","value":762}];
const MX = 800;
