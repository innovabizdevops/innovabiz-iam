...
/* ═══ US Compliance Deep — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "5954", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "932", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€378K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1416992854", cells: ["US-6854", "US Compliance Deep Item 1", "19/11/2026", "€42 954"], status: "active" as const },
    { id: "1416996425", cells: ["US-1425", "US Compliance Deep Item 2", "6/6/2026", "€46 525"], status: "pending" as const },
    { id: "1416999996", cells: ["US-4996", "US Compliance Deep Item 3", "21/1/2026", "€50 096"], status: "completed" as const },
    { id: "1417003567", cells: ["US-8567", "US Compliance Deep Item 4", "8/8/2026", "€3667"], status: "warning" as const },
    { id: "1417007138", cells: ["US-3138", "US Compliance Deep Item 5", "23/3/2026", "€7238"], status: "active" as const },
];
...
export default function UsComplianceDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">US Compliance Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • US Compliance Deep</p>
                    </div>
                </div>
