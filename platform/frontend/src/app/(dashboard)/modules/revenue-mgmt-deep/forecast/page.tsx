...
const ACCENT = "#6366f1";
const MODULE = "Revenue Management Deep";
const PAGE = "Forecast";
const KPIS = [{"l":"ARR (€M)","v":"€10.0M","t":"+1.5%","d":"up"},{"l":"MRR (€)","v":"€27630","t":"-3.4%","d":"down"},{"l":"Churn (%)","v":"85.4%","t":"+14.0%","d":"up"},{"l":"ARPU (€)","v":"€39553","t":"+11.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 16207.42","5.018","€ 21506.47","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 14318.26","3.980","€ 41845.36","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 33467.35","8.124","€ 37286.40","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 16077.64","2.750","€ 24071.29","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 13346.15","1.507","€ 1982.04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":861},{"label":"Mar","value":793},{"label":"Abr","value":534},{"label":"Mai","value":573},{"label":"Jun","value":683},{"label":"Jul","value":889},{"label":"Ago","value":767},{"label":"Set","value":606},{"label":"Out","value":513},{"label":"Nov","value":898},{"label":"Dez","value":690}];
const MX = 898;
