...
const KPIS = [{"l":"ARR (€M)","v":"€32.4M","t":"+16.3%","d":"up"},{"l":"MRR (€)","v":"€75324","t":"-5.4%","d":"down"},{"l":"Churn (%)","v":"81.6%","t":"+8.5%","d":"up"},{"l":"ARPU (€)","v":"€30202","t":"+12.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 34109.21","8.112","€ 2961.53","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 31478.59","5.028","€ 2675.90","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 45147.18","759","€ 48583.64","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 26767.93","7.755","€ 13761.72","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 11144.46","1.370","€ 29941.94","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":426},{"label":"Fev","value":434},{"label":"Mar","value":723},{"label":"Abr","value":705},{"label":"Mai","value":499},{"label":"Jun","value":555},{"label":"Jul","value":504},{"label":"Ago","value":543},{"label":"Set","value":570},{"label":"Out","value":547},{"label":"Nov","value":529},{"label":"Dez","value":451}];
const MX = 723;
