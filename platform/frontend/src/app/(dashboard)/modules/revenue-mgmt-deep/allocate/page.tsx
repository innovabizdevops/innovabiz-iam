...
const PAGE = "Allocate";
const KPIS = [{"l":"ARR (€M)","v":"€3.1M","t":"+10.4%","d":"up"},{"l":"MRR (€)","v":"€79288","t":"+0.8%","d":"up"},{"l":"Churn (%)","v":"73.5%","t":"-0.8%","d":"down"},{"l":"ARPU (€)","v":"€54795","t":"+6.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 10865.99","1.309","€ 5453.08","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 29329.56","2.919","€ 38201.08","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 5086.41","3.309","€ 40235.45","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 38381.96","1.494","€ 32678.40","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 39240.55","4.995","€ 12059.05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":501},{"label":"Fev","value":602},{"label":"Mar","value":586},{"label":"Abr","value":353},{"label":"Mai","value":266},{"label":"Jun","value":332},{"label":"Jul","value":434},{"label":"Ago","value":597},{"label":"Set","value":326},{"label":"Out","value":599},{"label":"Nov","value":430},{"label":"Dez","value":562}];
const MX = 602;
