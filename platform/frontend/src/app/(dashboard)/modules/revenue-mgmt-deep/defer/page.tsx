...
const PAGE = "Defer";
const KPIS = [{"l":"ARR (€M)","v":"€50.1M","t":"+10.1%","d":"up"},{"l":"MRR (€)","v":"€64440","t":"+5.4%","d":"up"},{"l":"Churn (%)","v":"85.7%","t":"+3.9%","d":"up"},{"l":"ARPU (€)","v":"€54068","t":"-3.9%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 579.13","7.809","€ 7581.78","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 17102.28","1.916","€ 12695.06","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 2293.38","5.513","€ 47163.46","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 23269.52","2.980","€ 37459.11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 7193.64","1.923","€ 11121.14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":429},{"label":"Fev","value":794},{"label":"Mar","value":651},{"label":"Abr","value":755},{"label":"Mai","value":598},{"label":"Jun","value":738},{"label":"Jul","value":592},{"label":"Ago","value":516},{"label":"Set","value":740},{"label":"Out","value":639},{"label":"Nov","value":563},{"label":"Dez","value":661}];
const MX = 794;
