...
const PAGE = "Report";
const KPIS = [{"l":"ARR (€M)","v":"€22.3M","t":"-0.6%","d":"down"},{"l":"MRR (€)","v":"€89221","t":"+3.0%","d":"up"},{"l":"Churn (%)","v":"87.6%","t":"+6.5%","d":"up"},{"l":"ARPU (€)","v":"€74876","t":"+12.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 42614.27","1.118","€ 12922.14","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 3885.84","4.872","€ 49913.93","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 7059.76","3.362","€ 578.74","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 14899.42","1.025","€ 26894.87","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 42762.97","8.720","€ 6606.49","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":593},{"label":"Mar","value":636},{"label":"Abr","value":622},{"label":"Mai","value":913},{"label":"Jun","value":888},{"label":"Jul","value":785},{"label":"Ago","value":863},{"label":"Set","value":739},{"label":"Out","value":657},{"label":"Nov","value":730},{"label":"Dez","value":923}];
const MX = 923;
