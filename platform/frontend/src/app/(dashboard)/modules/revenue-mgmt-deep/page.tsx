...
/* ═══ Revenue Management Deep — Dashboard ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total Registos", value: "4994", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "331", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€460K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1435227694", cells: ["REV-7694", "Revenue Management Deep Item 1", "27/11/2026", "€27 794"], status: "active" as const },
    { id: "1435231265", cells: ["REV-2265", "Revenue Management Deep Item 2", "14/6/2026", "€31 365"], status: "pending" as const },
    { id: "1435234836", cells: ["REV-5836", "Revenue Management Deep Item 3", "1/1/2026", "€34 936"], status: "completed" as const },
    { id: "1435238407", cells: ["REV-9407", "Revenue Management Deep Item 4", "16/8/2026", "€38 507"], status: "warning" as const },
    { id: "1435241978", cells: ["REV-3978", "Revenue Management Deep Item 5", "3/3/2026", "€42 078"], status: "active" as const },
];
...
export default function RevenueManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Revenue Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Revenue Management Deep</p>
                    </div>
                </div>
