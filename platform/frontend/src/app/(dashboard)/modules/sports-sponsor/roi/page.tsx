...
const ACCENT = "#6366f1";
const MODULE = "Sports Sponsorship";
const PAGE = "ROI";
const KPIS = [{"l":"Eventos Planeados","v":"8.708","t":"+14.1%","d":"up"},{"l":"Participantes","v":"7.847","t":"+6.6%","d":"up"},{"l":"NPS Evento","v":"62","t":"-0.6%","d":"down"},{"l":"Receita (€)","v":"€80861","t":"+13.5%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-25","8.038","2.223","€ 11054.21","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-01","4.106","7.878","€ 26541.71","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-23","1.292","4.912","€ 13350.51","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-28","7.942","708","€ 34311.58","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-09","3.962","5.096","€ 16587.29","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":360},{"label":"Fev","value":629},{"label":"Mar","value":415},{"label":"Abr","value":311},{"label":"Mai","value":459},{"label":"Jun","value":444},{"label":"Jul","value":263},{"label":"Ago","value":460},{"label":"Set","value":559},{"label":"Out","value":431},{"label":"Nov","value":368},{"label":"Dez","value":607}];
const MX = 629;
