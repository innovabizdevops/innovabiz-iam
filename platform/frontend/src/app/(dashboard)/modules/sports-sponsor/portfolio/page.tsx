...
const KPIS = [{"l":"Eventos Planeados","v":"147","t":"+3.4%","d":"up"},{"l":"Participantes","v":"1.932","t":"+16.6%","d":"up"},{"l":"NPS Evento","v":"61","t":"+1.0%","d":"up"},{"l":"Receita (€)","v":"€50640","t":"-6.0%","d":"down"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-18","494","2.923","€ 28111.12","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-09","3.248","5.798","€ 10359.46","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-09","5.603","5.039","€ 27509.16","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-06","868","4.621","€ 32959.54","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-15","1.152","1.856","€ 11468.07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":912},{"label":"Mar","value":610},{"label":"Abr","value":843},{"label":"Mai","value":958},{"label":"Jun","value":584},{"label":"Jul","value":615},{"label":"Ago","value":971},{"label":"Set","value":975},{"label":"Out","value":747},{"label":"Nov","value":821},{"label":"Dez","value":660}];
const MX = 975;
