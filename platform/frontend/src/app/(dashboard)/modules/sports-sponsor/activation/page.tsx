...
const KPIS = [{"l":"Eventos Planeados","v":"6.619","t":"-2.1%","d":"down"},{"l":"Participantes","v":"6.421","t":"+0.6%","d":"up"},{"l":"NPS Evento","v":"67","t":"+14.1%","d":"up"},{"l":"Receita (€)","v":"€9725","t":"+0.4%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-15","6.621","164","€ 14529.30","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-12","2.420","3.052","€ 27258.00","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-20","6.753","5.894","€ 42002.04","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-25","3.525","1.483","€ 15825.58","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-07","6.594","5.247","€ 10101.93","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":935},{"label":"Fev","value":837},{"label":"Mar","value":637},{"label":"Abr","value":594},{"label":"Mai","value":899},{"label":"Jun","value":871},{"label":"Jul","value":838},{"label":"Ago","value":758},{"label":"Set","value":695},{"label":"Out","value":955},{"label":"Nov","value":915},{"label":"Dez","value":922}];
const MX = 955;
