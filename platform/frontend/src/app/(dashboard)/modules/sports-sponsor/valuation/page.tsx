...
const KPIS = [{"l":"Eventos Planeados","v":"5.389","t":"+4.0%","d":"up"},{"l":"Participantes","v":"4.963","t":"-1.2%","d":"down"},{"l":"NPS Evento","v":"83","t":"-2.5%","d":"down"},{"l":"Receita (€)","v":"€70614","t":"+10.0%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-18","2.987","4.641","€ 35663.38","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-07","6.083","7.114","€ 21315.12","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-07","8.075","5.340","€ 30120.26","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-25","6.435","4.243","€ 8396.53","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-02","2.981","7.300","€ 15990.39","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":844},{"label":"Fev","value":607},{"label":"Mar","value":852},{"label":"Abr","value":530},{"label":"Mai","value":662},{"label":"Jun","value":778},{"label":"Jul","value":708},{"label":"Ago","value":545},{"label":"Set","value":658},{"label":"Out","value":573},{"label":"Nov","value":858},{"label":"Dez","value":557}];
const MX = 858;
