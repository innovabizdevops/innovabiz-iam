...
export default function ArcticOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Arctic Ops</h1><p className="text-sm text-muted-foreground">Arctic Ops • iBOS Enterprise</p></div>
