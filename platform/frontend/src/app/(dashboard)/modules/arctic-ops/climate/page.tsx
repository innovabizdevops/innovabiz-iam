...
const ACCENT = "#6366f1";
const MODULE = "Arctic Operations";
const PAGE = "Climate";
const KPIS = [{"l":"Total Arctic Ops","v":"1.171","t":"+16.9%","d":"up"},{"l":"Climate Ativos","v":"3.199","t":"+6.4%","d":"up"},{"l":"Eficiência (%)","v":"85.0%","t":"+5.6%","d":"up"},{"l":"Score Performance","v":"64","t":"+17.7%","d":"up"}];
const COLS = ["ID","Climate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arctic Ops #001","Arctic Ops #002","4.556","2.007","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Arctic Ops #002","Arctic Ops #003","1.636","4.998","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Arctic Ops #003","Arctic Ops #004","7.074","4.303","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Arctic Ops #004","Arctic Ops #005","5.079","3.483","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arctic Ops #005","Arctic Ops #001","6.384","397","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":634},{"label":"Mar","value":310},{"label":"Abr","value":434},{"label":"Mai","value":451},{"label":"Jun","value":400},{"label":"Jul","value":465},{"label":"Ago","value":466},{"label":"Set","value":372},{"label":"Out","value":449},{"label":"Nov","value":559},{"label":"Dez","value":351}];
const MX = 637;
