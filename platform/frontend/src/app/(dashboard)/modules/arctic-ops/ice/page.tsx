...
const PAGE = "Icebreaker";
const KPIS = [{"l":"Total Arctic Ops","v":"4.406","t":"+4.6%","d":"up"},{"l":"Icebreaker Ativos","v":"7.493","t":"+7.0%","d":"up"},{"l":"Eficiência (%)","v":"68.3%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"66","t":"+5.3%","d":"up"}];
const COLS = ["ID","Icebreaker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arctic Ops #001","Arctic Ops #002","2.350","5.075","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Arctic Ops #002","Arctic Ops #003","6.655","3.771","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Arctic Ops #003","Arctic Ops #004","8.171","4.895","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Arctic Ops #004","Arctic Ops #005","8.432","1.867","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arctic Ops #005","Arctic Ops #001","3.335","8.609","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":227},{"label":"Fev","value":255},{"label":"Mar","value":296},{"label":"Abr","value":432},{"label":"Mai","value":340},{"label":"Jun","value":615},{"label":"Jul","value":399},{"label":"Ago","value":252},{"label":"Set","value":552},{"label":"Out","value":561},{"label":"Nov","value":586},{"label":"Dez","value":507}];
const MX = 615;
