...
const PAGE = "Research";
const KPIS = [{"l":"Ideias Submetidas","v":"1.185","t":"+4.5%","d":"up"},{"l":"Patentes (YTD)","v":"1.889","t":"-3.7%","d":"down"},{"l":"Projetos Innovation Lab","v":"7.359","t":"+1.7%","d":"up"},{"l":"Budget I&D (€M)","v":"€40.5M","t":"+2.4%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.865","81.0%","2.105","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.722","94.7%","1.426","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","7.101","73.1%","6.258","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","7.788","79.7%","941","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.363","90.5%","4.378","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":964},{"label":"Mar","value":983},{"label":"Abr","value":1025},{"label":"Mai","value":828},{"label":"Jun","value":791},{"label":"Jul","value":681},{"label":"Ago","value":955},{"label":"Set","value":969},{"label":"Out","value":910},{"label":"Nov","value":924},{"label":"Dez","value":741}];
const MX = 1025;
