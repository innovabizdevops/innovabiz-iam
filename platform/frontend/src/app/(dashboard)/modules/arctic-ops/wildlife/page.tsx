...
const PAGE = "Wildlife";
const KPIS = [{"l":"Total Arctic Ops","v":"5.516","t":"+8.1%","d":"up"},{"l":"Wildlife Ativos","v":"3.211","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"79.7%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"72","t":"+1.1%","d":"up"}];
const COLS = ["ID","Wildlife","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arctic Ops #001","Arctic Ops #002","1.598","776","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Arctic Ops #002","Arctic Ops #003","9.056","3.419","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Arctic Ops #003","Arctic Ops #004","4.683","1.971","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Arctic Ops #004","Arctic Ops #005","455","5.130","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arctic Ops #005","Arctic Ops #001","619","2.495","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":498},{"label":"Mar","value":568},{"label":"Abr","value":484},{"label":"Mai","value":738},{"label":"Jun","value":541},{"label":"Jul","value":709},{"label":"Ago","value":432},{"label":"Set","value":593},{"label":"Out","value":708},{"label":"Nov","value":501},{"label":"Dez","value":433}];
const MX = 738;
