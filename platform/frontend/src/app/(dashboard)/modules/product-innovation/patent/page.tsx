...
const PAGE = "Patent";
const KPIS = [{"l":"Ideias Submetidas","v":"1.313","t":"+8.3%","d":"up"},{"l":"Patentes (YTD)","v":"4.828","t":"+16.3%","d":"up"},{"l":"Projetos Innovation Lab","v":"3.902","t":"+5.4%","d":"up"},{"l":"Budget I&D (€M)","v":"€37.0M","t":"+13.6%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","1.559","94.1%","2.769","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","4.421","74.8%","3.189","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","4.240","97.7%","7.834","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.421","93.7%","2.731","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.192","91.0%","5.512","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":291},{"label":"Mar","value":519},{"label":"Abr","value":425},{"label":"Mai","value":318},{"label":"Jun","value":294},{"label":"Jul","value":464},{"label":"Ago","value":491},{"label":"Set","value":513},{"label":"Out","value":489},{"label":"Nov","value":576},{"label":"Dez","value":613}];
const MX = 613;
