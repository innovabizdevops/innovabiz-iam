...
const PAGE = "Discover";
const KPIS = [{"l":"Ideias Submetidas","v":"569","t":"+9.7%","d":"up"},{"l":"Patentes (YTD)","v":"1.656","t":"+15.5%","d":"up"},{"l":"Projetos Innovation Lab","v":"5.632","t":"+13.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€5.9M","t":"-4.3%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","2.663","81.1%","4.024","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.194","76.4%","5.188","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","4.748","86.1%","7.918","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","3.816","88.4%","4.936","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","6.872","99.1%","6.123","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":911},{"label":"Fev","value":745},{"label":"Mar","value":592},{"label":"Abr","value":660},{"label":"Mai","value":656},{"label":"Jun","value":570},{"label":"Jul","value":883},{"label":"Ago","value":577},{"label":"Set","value":734},{"label":"Out","value":582},{"label":"Nov","value":834},{"label":"Dez","value":687}];
const MX = 911;
