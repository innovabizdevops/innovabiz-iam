...
const KPIS = [{"l":"Ideias Submetidas","v":"4.917","t":"-1.5%","d":"down"},{"l":"Patentes (YTD)","v":"8.886","t":"+0.4%","d":"up"},{"l":"Projetos Innovation Lab","v":"5.237","t":"+4.9%","d":"up"},{"l":"Budget I&D (€M)","v":"€43.6M","t":"+8.3%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.313","80.3%","7.012","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","1.029","97.6%","5.160","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","9.019","90.2%","7.880","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","8.097","89.7%","3.203","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","214","86.7%","6.272","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":872},{"label":"Fev","value":664},{"label":"Mar","value":739},{"label":"Abr","value":670},{"label":"Mai","value":749},{"label":"Jun","value":543},{"label":"Jul","value":612},{"label":"Ago","value":822},{"label":"Set","value":661},{"label":"Out","value":746},{"label":"Nov","value":594},{"label":"Dez","value":585}];
const MX = 872;
