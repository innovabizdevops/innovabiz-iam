...
const PAGE = "Scale";
const KPIS = [{"l":"Ideias Submetidas","v":"1.561","t":"-2.1%","d":"down"},{"l":"Patentes (YTD)","v":"1.237","t":"+5.1%","d":"up"},{"l":"Projetos Innovation Lab","v":"4.529","t":"+5.9%","d":"up"},{"l":"Budget I&D (€M)","v":"€29.5M","t":"+10.9%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","8.480","93.5%","951","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","4.252","91.5%","8.959","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","7.461","95.2%","5.709","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","3.235","83.9%","4.152","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.333","98.3%","1.307","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":802},{"label":"Mar","value":603},{"label":"Abr","value":521},{"label":"Mai","value":669},{"label":"Jun","value":457},{"label":"Jul","value":721},{"label":"Ago","value":760},{"label":"Set","value":699},{"label":"Out","value":603},{"label":"Nov","value":593},{"label":"Dez","value":618}];
const MX = 802;
