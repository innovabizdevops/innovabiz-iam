...
/* ═══ Product Innovation Lab — Dashboard ═══ */

const ACCENT = "#93c5fd";

const KPIS = [
    { label: "Total Registos", value: "9306", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2671", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€21K", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "675189206", cells: ["PRO-1206", "Product Innovation Lab Item 1", "7/3/2026", "€39 306"], status: "active" as const },
    { id: "675192777", cells: ["PRO-4777", "Product Innovation Lab Item 2", "22/10/2026", "€42 877"], status: "pending" as const },
    { id: "675196348", cells: ["PRO-8348", "Product Innovation Lab Item 3", "9/5/2026", "€46 448"], status: "completed" as const },
    { id: "675199919", cells: ["PRO-2919", "Product Innovation Lab Item 4", "24/12/2026", "€50 019"], status: "warning" as const },
    { id: "675203490", cells: ["PRO-6490", "Product Innovation Lab Item 5", "11/7/2026", "€3590"], status: "active" as const },
];
...
export default function ProductInnovationLabPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Product Innovation Lab</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Product Innovation Lab</p>
                    </div>
                </div>
