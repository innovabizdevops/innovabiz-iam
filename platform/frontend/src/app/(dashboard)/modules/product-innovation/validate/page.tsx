...
const ACCENT = "#93c5fd";
const MODULE = "Product Innovation Lab";
const PAGE = "Validate";
const KPIS = [{"l":"Ideias Submetidas","v":"6.207","t":"-3.0%","d":"down"},{"l":"Patentes (YTD)","v":"2.065","t":"+13.6%","d":"up"},{"l":"Projetos Innovation Lab","v":"3.025","t":"+13.6%","d":"up"},{"l":"Budget I&D (€M)","v":"€23.9M","t":"+14.8%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","3.538","82.7%","8.160","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","5.236","90.9%","8.130","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","604","80.8%","996","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","3.607","95.9%","4.575","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","4.024","76.9%","4.512","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":924},{"label":"Fev","value":987},{"label":"Mar","value":752},{"label":"Abr","value":716},{"label":"Mai","value":985},{"label":"Jun","value":818},{"label":"Jul","value":711},{"label":"Ago","value":922},{"label":"Set","value":1011},{"label":"Out","value":853},{"label":"Nov","value":750},{"label":"Dez","value":807}];
const MX = 1011;
