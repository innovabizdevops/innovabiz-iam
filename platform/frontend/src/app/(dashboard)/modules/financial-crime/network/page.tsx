...
const ACCENT = "#1e3a5f";
const MODULE = "Financial Crime Platform";
const PAGE = "Network";
const KPIS = [{"l":"Total Financial Crime","v":"6.412","t":"-4.5%","d":"down"},{"l":"Network Ativos","v":"1.896","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"79.2%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"90","t":"+6.8%","d":"up"}];
const COLS = ["ID","Network","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Crime #001","Financial Crime #002","3.353","4.354","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Crime #002","Financial Crime #003","7.183","7.905","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Crime #003","Financial Crime #004","1.274","4.544","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Crime #004","Financial Crime #005","4.212","7.487","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Crime #005","Financial Crime #001","2.369","4.487","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":630},{"label":"Mar","value":700},{"label":"Abr","value":839},{"label":"Mai","value":834},{"label":"Jun","value":642},{"label":"Jul","value":904},{"label":"Ago","value":812},{"label":"Set","value":658},{"label":"Out","value":699},{"label":"Nov","value":832},{"label":"Dez","value":658}];
const MX = 904;
