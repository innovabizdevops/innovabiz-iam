...
/* ═══ Financial Crime Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "4571", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4919", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€50K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1161620971", cells: ["FIN-9971", "Financial Crime Platform Item 1", "8/8/2026", "€21 071"], status: "active" as const },
    { id: "1161624542", cells: ["FIN-4542", "Financial Crime Platform Item 2", "23/3/2026", "€24 642"], status: "pending" as const },
    { id: "1161628113", cells: ["FIN-8113", "Financial Crime Platform Item 3", "10/10/2026", "€28 213"], status: "completed" as const },
    { id: "1161631684", cells: ["FIN-2684", "Financial Crime Platform Item 4", "25/5/2026", "€31 784"], status: "warning" as const },
    { id: "1161635255", cells: ["FIN-6255", "Financial Crime Platform Item 5", "12/12/2026", "€35 355"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 31 }, { label: "Fev", value: 40 }, { label: "Mar", value: 49 }, { label: "Abr", value: 58 }, { label: "Mai", value: 67 }, { label: "Jun", value: 76 }];
...
export default function FinancialCrimePlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Financial Crime Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Financial Crime Platform</p>
                    </div>
                </div>
