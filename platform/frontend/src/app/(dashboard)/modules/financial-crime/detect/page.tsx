...
const PAGE = "Detect";
const KPIS = [{"l":"Total Financial Crime","v":"8.670","t":"+5.1%","d":"up"},{"l":"Detect Ativos","v":"905","t":"-1.5%","d":"down"},{"l":"Eficiência (%)","v":"73.9%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"94","t":"+1.3%","d":"up"}];
const COLS = ["ID","Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Crime #001","Financial Crime #002","1.139","6.220","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Crime #002","Financial Crime #003","4.671","5.659","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Crime #003","Financial Crime #004","6.082","606","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Crime #004","Financial Crime #005","7.953","3.399","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Crime #005","Financial Crime #001","1.310","3.848","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":449},{"label":"Mar","value":441},{"label":"Abr","value":703},{"label":"Mai","value":665},{"label":"Jun","value":742},{"label":"Jul","value":519},{"label":"Ago","value":470},{"label":"Set","value":768},{"label":"Out","value":502},{"label":"Nov","value":689},{"label":"Dez","value":445}];
const MX = 768;
