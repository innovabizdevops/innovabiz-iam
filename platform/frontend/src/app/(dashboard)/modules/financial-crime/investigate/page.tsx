...
const KPIS = [{"l":"Total Financial Crime","v":"7.985","t":"+8.1%","d":"up"},{"l":"Investigate Ativos","v":"1.212","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"94.8%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"64","t":"+10.0%","d":"up"}];
const COLS = ["ID","Investigate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Crime #001","Financial Crime #002","1.128","1.869","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Crime #002","Financial Crime #003","1.215","4.469","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Crime #003","Financial Crime #004","8.412","7.699","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Crime #004","Financial Crime #005","4.008","2.449","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Crime #005","Financial Crime #001","5.077","1.231","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":782},{"label":"Fev","value":753},{"label":"Mar","value":678},{"label":"Abr","value":513},{"label":"Mai","value":477},{"label":"Jun","value":686},{"label":"Jul","value":530},{"label":"Ago","value":531},{"label":"Set","value":627},{"label":"Out","value":628},{"label":"Nov","value":793},{"label":"Dez","value":602}];
const MX = 793;
