...
const PAGE = "Case";
const KPIS = [{"l":"Total Financial Crime","v":"2.682","t":"+11.0%","d":"up"},{"l":"Case Ativos","v":"3.829","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"75.9%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"58","t":"+4.6%","d":"up"}];
const COLS = ["ID","Case","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Crime #001","Financial Crime #002","2.232","3.205","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Crime #002","Financial Crime #003","8.480","4.548","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Crime #003","Financial Crime #004","2.927","8.634","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Crime #004","Financial Crime #005","344","6.235","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Crime #005","Financial Crime #001","5.547","5.876","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":855},{"label":"Fev","value":892},{"label":"Mar","value":811},{"label":"Abr","value":638},{"label":"Mai","value":771},{"label":"Jun","value":643},{"label":"Jul","value":535},{"label":"Ago","value":699},{"label":"Set","value":787},{"label":"Out","value":498},{"label":"Nov","value":743},{"label":"Dez","value":604}];
const MX = 892;
