...
const PAGE = "Point Cloud";
const KPIS = [{"l":"Dispositivos Online","v":"7.096","t":"+16.7%","d":"up"},{"l":"Dados/Min (MB)","v":"3.852","t":"+11.6%","d":"up"},{"l":"Alertas Ativos","v":"1.988","t":"-2.8%","d":"down"},{"l":"Uptime (%)","v":"86.8%","t":"+2.2%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.661","5.135","9.050","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.886","1.158","4.752","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.847","4.061","2.777","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.689","8.166","7.985","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.392","8.680","7.160","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":917},{"label":"Fev","value":829},{"label":"Mar","value":696},{"label":"Abr","value":774},{"label":"Mai","value":881},{"label":"Jun","value":554},{"label":"Jul","value":560},{"label":"Ago","value":625},{"label":"Set","value":688},{"label":"Out","value":540},{"label":"Nov","value":661},{"label":"Dez","value":762}];
const MX = 917;
