...
const PAGE = "Calibrate";
const KPIS = [{"l":"Dispositivos Online","v":"7.800","t":"-4.5%","d":"down"},{"l":"Dados/Min (MB)","v":"966","t":"+12.7%","d":"up"},{"l":"Alertas Ativos","v":"3.775","t":"+17.0%","d":"up"},{"l":"Uptime (%)","v":"84.1%","t":"+11.2%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.393","1.081","5.890","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.281","6.013","8.003","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.194","2.648","7.275","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","202","2.022","2.672","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.030","6.189","6.680","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":367},{"label":"Mar","value":286},{"label":"Abr","value":466},{"label":"Mai","value":321},{"label":"Jun","value":422},{"label":"Jul","value":297},{"label":"Ago","value":557},{"label":"Set","value":506},{"label":"Out","value":270},{"label":"Nov","value":367},{"label":"Dez","value":444}];
const MX = 595;
