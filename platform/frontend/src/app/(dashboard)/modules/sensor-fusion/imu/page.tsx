...
const PAGE = "IMU Fusion";
const KPIS = [{"l":"Dispositivos Online","v":"3.102","t":"+14.5%","d":"up"},{"l":"Dados/Min (MB)","v":"3.948","t":"+3.3%","d":"up"},{"l":"Alertas Ativos","v":"4.312","t":"+9.3%","d":"up"},{"l":"Uptime (%)","v":"69.7%","t":"+-0.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","243","4.003","4.568","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.854","8.096","4.951","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","3.782","3.293","3.172","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.414","1.271","6.684","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.746","4.524","8.296","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":831},{"label":"Mar","value":751},{"label":"Abr","value":855},{"label":"Mai","value":894},{"label":"Jun","value":660},{"label":"Jul","value":547},{"label":"Ago","value":879},{"label":"Set","value":661},{"label":"Out","value":684},{"label":"Nov","value":787},{"label":"Dez","value":853}];
const MX = 910;
