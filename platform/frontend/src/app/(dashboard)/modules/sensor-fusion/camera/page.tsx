...
const PAGE = "Camera Array";
const KPIS = [{"l":"Dispositivos Online","v":"3.939","t":"-4.5%","d":"down"},{"l":"Dados/Min (MB)","v":"4.367","t":"-0.5%","d":"down"},{"l":"Alertas Ativos","v":"5.719","t":"+12.0%","d":"up"},{"l":"Uptime (%)","v":"82.2%","t":"+9.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.792","5.383","3.119","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.219","3.066","2.518","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.237","2.711","3.640","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","176","7.759","5.721","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.090","7.892","3.439","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":857},{"label":"Mar","value":608},{"label":"Abr","value":840},{"label":"Mai","value":829},{"label":"Jun","value":721},{"label":"Jul","value":850},{"label":"Ago","value":738},{"label":"Set","value":659},{"label":"Out","value":941},{"label":"Nov","value":866},{"label":"Dez","value":956}];
const MX = 956;
