...
const ACCENT = "#6366f1";
const MODULE = "Sensor Fusion";
const PAGE = "Kalman";
const KPIS = [{"l":"Dispositivos Online","v":"8.477","t":"+13.5%","d":"up"},{"l":"Dados/Min (MB)","v":"4.349","t":"+7.5%","d":"up"},{"l":"Alertas Ativos","v":"2.219","t":"-1.6%","d":"down"},{"l":"Uptime (%)","v":"66.8%","t":"+15.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.413","4.001","531","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","715","9.027","4.734","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.051","503","1.051","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.453","1.230","321","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.990","1.811","3.456","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":448},{"label":"Mar","value":690},{"label":"Abr","value":656},{"label":"Mai","value":718},{"label":"Jun","value":526},{"label":"Jul","value":429},{"label":"Ago","value":477},{"label":"Set","value":603},{"label":"Out","value":771},{"label":"Nov","value":754},{"label":"Dez","value":376}];
const MX = 771;
...
export default function KalmanPage() {
    return (
