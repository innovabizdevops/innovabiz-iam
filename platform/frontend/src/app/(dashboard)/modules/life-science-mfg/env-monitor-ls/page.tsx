...
/* ═══ Life Science Mfg — Env Monitor Ls ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "409", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "157", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1938", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1045472441", cells: ["LIF-6441", "Env Monitor Ls Item 1", "14/6/2026", "€22 541"], status: "active" as const },
    { id: "1045476012", cells: ["LIF-1012", "Env Monitor Ls Item 2", "1/1/2026", "€26 112"], status: "pending" as const },
    { id: "1045479583", cells: ["LIF-4583", "Env Monitor Ls Item 3", "16/8/2026", "€29 683"], status: "completed" as const },
    { id: "1045483154", cells: ["LIF-8154", "Env Monitor Ls Item 4", "3/3/2026", "€33 254"], status: "warning" as const },
    { id: "1045486725", cells: ["LIF-2725", "Env Monitor Ls Item 5", "18/10/2026", "€36 825"], status: "active" as const },
];
...
export default function LifeScienceMfgEnvMonitorLsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Env Monitor Ls</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Life Science Mfg • Env Monitor Ls</p>
                    </div>
                </div>
