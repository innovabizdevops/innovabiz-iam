...
/* ═══ Life Science Mfg — Supplier Qualify ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "3135", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "226", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "822", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "967786510", cells: ["LIF-8510", "Supplier Qualify Item 1", "27/11/2026", "€36 610"], status: "active" as const },
    { id: "967790081", cells: ["LIF-3081", "Supplier Qualify Item 2", "14/6/2026", "€40 181"], status: "pending" as const },
    { id: "967793652", cells: ["LIF-6652", "Supplier Qualify Item 3", "1/1/2026", "€43 752"], status: "completed" as const },
    { id: "967797223", cells: ["LIF-1223", "Supplier Qualify Item 4", "16/8/2026", "€47 323"], status: "warning" as const },
    { id: "967800794", cells: ["LIF-4794", "Supplier Qualify Item 5", "3/3/2026", "€894"], status: "active" as const },
];
...
export default function LifeScienceMfgSupplierQualifyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Supplier Qualify</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Life Science Mfg • Supplier Qualify</p>
                    </div>
                </div>
