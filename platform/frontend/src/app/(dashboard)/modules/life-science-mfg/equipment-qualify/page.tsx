...
/* ═══ Life Science Mfg — Equipment Qualify ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "3809", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "230", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "626", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "631041698", cells: ["LIF-7698", "Equipment Qualify Item 1", "15/3/2026", "€41 798"], status: "active" as const },
    { id: "631045269", cells: ["LIF-2269", "Equipment Qualify Item 2", "2/10/2026", "€45 369"], status: "pending" as const },
    { id: "631048840", cells: ["LIF-5840", "Equipment Qualify Item 3", "17/5/2026", "€48 940"], status: "completed" as const },
    { id: "631052411", cells: ["LIF-9411", "Equipment Qualify Item 4", "4/12/2026", "€2511"], status: "warning" as const },
    { id: "631055982", cells: ["LIF-3982", "Equipment Qualify Item 5", "19/7/2026", "€6082"], status: "active" as const },
];
...
export default function LifeScienceMfgEquipmentQualifyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Equipment Qualify</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Life Science Mfg • Equipment Qualify</p>
                    </div>
                </div>
