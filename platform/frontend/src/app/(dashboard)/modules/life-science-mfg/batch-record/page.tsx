...
/* ═══ Life Science Mfg — Batch Record ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "3837", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "132", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2917", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1305479088", cells: ["LIF-3088", "Batch Record Item 1", "5/1/2026", "€29 188"], status: "active" as const },
    { id: "1305482659", cells: ["LIF-6659", "Batch Record Item 2", "20/8/2026", "€32 759"], status: "pending" as const },
    { id: "1305486230", cells: ["LIF-1230", "Batch Record Item 3", "7/3/2026", "€36 330"], status: "completed" as const },
    { id: "1305489801", cells: ["LIF-4801", "Batch Record Item 4", "22/10/2026", "€39 901"], status: "warning" as const },
    { id: "1305493372", cells: ["LIF-8372", "Batch Record Item 5", "9/5/2026", "€43 472"], status: "active" as const },
];
...
export default function LifeScienceMfgBatchRecordPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Batch Record</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Life Science Mfg • Batch Record</p>
                    </div>
                </div>
