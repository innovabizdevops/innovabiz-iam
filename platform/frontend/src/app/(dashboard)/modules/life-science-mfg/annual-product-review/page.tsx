...
/* ═══ Life Science Mfg — Annual Product Review ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "2300", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "165", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3863", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "74%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "994792657", cells: ["LIF-5657", "Annual Product Review Item 1", "6/2/2026", "€42 757"], status: "active" as const },
    { id: "994796228", cells: ["LIF-9228", "Annual Product Review Item 2", "21/9/2026", "€46 328"], status: "pending" as const },
    { id: "994799799", cells: ["LIF-3799", "Annual Product Review Item 3", "8/4/2026", "€49 899"], status: "completed" as const },
    { id: "994803370", cells: ["LIF-7370", "Annual Product Review Item 4", "23/11/2026", "€3470"], status: "warning" as const },
    { id: "994806941", cells: ["LIF-1941", "Annual Product Review Item 5", "10/6/2026", "€7041"], status: "active" as const },
];
...
export default function LifeScienceMfgAnnualProductReviewPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Annual Product Review</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Life Science Mfg • Annual Product Review</p>
                    </div>
                </div>
