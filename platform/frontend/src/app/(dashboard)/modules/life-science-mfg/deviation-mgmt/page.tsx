...
/* ═══ Life Science Mfg — Deviation Mgmt ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "1275", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "171", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1648", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "78%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1854208391", cells: ["LIF-2391", "Deviation Mgmt Item 1", "8/12/2026", "€8491"], status: "active" as const },
    { id: "1854211962", cells: ["LIF-5962", "Deviation Mgmt Item 2", "23/7/2026", "€12 062"], status: "pending" as const },
    { id: "1854215533", cells: ["LIF-9533", "Deviation Mgmt Item 3", "10/2/2026", "€15 633"], status: "completed" as const },
    { id: "1854219104", cells: ["LIF-4104", "Deviation Mgmt Item 4", "25/9/2026", "€19 204"], status: "warning" as const },
    { id: "1854222675", cells: ["LIF-7675", "Deviation Mgmt Item 5", "12/4/2026", "€22 775"], status: "active" as const },
];
...
export default function LifeScienceMfgDeviationMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Deviation Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Life Science Mfg • Deviation Mgmt</p>
                    </div>
                </div>
