...
/* ═══ Life Science Mfg — Gmp Compliance ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "2026", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "126", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "43", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1458139946", cells: ["LIF-5946", "Gmp Compliance Item 1", "19/3/2026", "€40 046"], status: "active" as const },
    { id: "1458143517", cells: ["LIF-9517", "Gmp Compliance Item 2", "6/10/2026", "€43 617"], status: "pending" as const },
    { id: "1458147088", cells: ["LIF-4088", "Gmp Compliance Item 3", "21/5/2026", "€47 188"], status: "completed" as const },
    { id: "1458150659", cells: ["LIF-7659", "Gmp Compliance Item 4", "8/12/2026", "€759"], status: "warning" as const },
    { id: "1458154230", cells: ["LIF-2230", "Gmp Compliance Item 5", "23/7/2026", "€4330"], status: "active" as const },
];
...
export default function LifeScienceMfgGmpCompliancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Gmp Compliance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Life Science Mfg • Gmp Compliance</p>
                    </div>
                </div>
