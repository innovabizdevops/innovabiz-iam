...
/* ═══ Life Science Mfg — Change Control Ls ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "3107", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "101", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2552", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "681294305", cells: ["LIF-4305", "Change Control Ls Item 1", "14/6/2026", "€44 405"], status: "active" as const },
    { id: "681297876", cells: ["LIF-7876", "Change Control Ls Item 2", "1/1/2026", "€47 976"], status: "pending" as const },
    { id: "681301447", cells: ["LIF-2447", "Change Control Ls Item 3", "16/8/2026", "€1547"], status: "completed" as const },
    { id: "681305018", cells: ["LIF-6018", "Change Control Ls Item 4", "3/3/2026", "€5118"], status: "warning" as const },
    { id: "681308589", cells: ["LIF-9589", "Change Control Ls Item 5", "18/10/2026", "€8689"], status: "active" as const },
];
...
export default function LifeScienceMfgChangeControlLsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Change Control Ls</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Life Science Mfg • Change Control Ls</p>
                    </div>
                </div>
