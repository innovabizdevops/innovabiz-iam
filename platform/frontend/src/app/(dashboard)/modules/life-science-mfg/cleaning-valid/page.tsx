...
/* ═══ Life Science Mfg — Cleaning Valid ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "3564", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "438", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3138", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "232327346", cells: ["LIF-2346", "Cleaning Valid Item 1", "7/3/2026", "€27 446"], status: "active" as const },
    { id: "232330917", cells: ["LIF-5917", "Cleaning Valid Item 2", "22/10/2026", "€31 017"], status: "pending" as const },
    { id: "232334488", cells: ["LIF-9488", "Cleaning Valid Item 3", "9/5/2026", "€34 588"], status: "completed" as const },
    { id: "232338059", cells: ["LIF-4059", "Cleaning Valid Item 4", "24/12/2026", "€38 159"], status: "warning" as const },
    { id: "232341630", cells: ["LIF-7630", "Cleaning Valid Item 5", "11/7/2026", "€41 730"], status: "active" as const },
];
...
export default function LifeScienceMfgCleaningValidPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cleaning Valid</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Life Science Mfg • Cleaning Valid</p>
                    </div>
                </div>
