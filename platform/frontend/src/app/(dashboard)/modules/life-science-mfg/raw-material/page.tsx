...
/* ═══ Life Science Mfg — Raw Material ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "3441", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "300", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1466", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1952550440", cells: ["LIF-1440", "Raw Material Item 1", "9/9/2026", "€540"], status: "active" as const },
    { id: "1952554011", cells: ["LIF-5011", "Raw Material Item 2", "24/4/2026", "€4111"], status: "pending" as const },
    { id: "1952557582", cells: ["LIF-8582", "Raw Material Item 3", "11/11/2026", "€7682"], status: "completed" as const },
    { id: "1952561153", cells: ["LIF-3153", "Raw Material Item 4", "26/6/2026", "€11 253"], status: "warning" as const },
    { id: "1952564724", cells: ["LIF-6724", "Raw Material Item 5", "13/1/2026", "€14 824"], status: "active" as const },
];
...
export default function LifeScienceMfgRawMaterialPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Raw Material</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Life Science Mfg • Raw Material</p>
                    </div>
                </div>
