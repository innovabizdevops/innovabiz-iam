...
const PAGE = "Category Plan";
const KPIS = [{"l":"Utilizadores Ativos","v":"6.450","t":"-4.7%","d":"down"},{"l":"Sessões/Dia","v":"949","t":"+17.4%","d":"up"},{"l":"MFA Adoção (%)","v":"84.4%","t":"+8.7%","d":"up"},{"l":"Tentativas Bloqueadas","v":"4.454","t":"+1.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.232","7.122","221","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.564","1.085","3.602","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","453","6.660","7.196","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","376","4.106","6.101","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.595","4.645","6.094","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":761},{"label":"Mar","value":726},{"label":"Abr","value":836},{"label":"Mai","value":867},{"label":"Jun","value":1026},{"label":"Jul","value":1008},{"label":"Ago","value":826},{"label":"Set","value":737},{"label":"Out","value":926},{"label":"Nov","value":990},{"label":"Dez","value":776}];
const MX = 1026;
