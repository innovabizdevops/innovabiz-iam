...
const PAGE = "Cluster Model";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.750","t":"-5.9%","d":"down"},{"l":"Sessões/Dia","v":"4155","t":"-3.1%","d":"down"},{"l":"MFA Adoção (%)","v":"74.7%","t":"+3.9%","d":"up"},{"l":"Tentativas Bloqueadas","v":"5.760","t":"+15.5%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","7.681","865","7.300","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.459","3.979","783","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","2.005","8.949","2.725","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.954","4.434","4.190","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.950","8.582","3.444","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":947},{"label":"Fev","value":634},{"label":"Mar","value":833},{"label":"Abr","value":781},{"label":"Mai","value":846},{"label":"Jun","value":1006},{"label":"Jul","value":871},{"label":"Ago","value":889},{"label":"Set","value":641},{"label":"Out","value":954},{"label":"Nov","value":851},{"label":"Dez","value":808}];
const MX = 1006;
