...
const PAGE = "New Intro";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.834","t":"+13.3%","d":"up"},{"l":"Sessões/Dia","v":"2602","t":"+8.4%","d":"up"},{"l":"MFA Adoção (%)","v":"93.7%","t":"+15.7%","d":"up"},{"l":"Tentativas Bloqueadas","v":"7.963","t":"-4.8%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.768","3.558","6.442","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.328","6.553","522","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.078","1.977","2.074","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","6.968","2.783","9.060","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.581","8.983","6.583","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":455},{"label":"Mar","value":660},{"label":"Abr","value":557},{"label":"Mai","value":386},{"label":"Jun","value":427},{"label":"Jul","value":527},{"label":"Ago","value":590},{"label":"Set","value":698},{"label":"Out","value":363},{"label":"Nov","value":698},{"label":"Dez","value":724}];
const MX = 724;
