...
const ACCENT = "#4338ca";
const MODULE = "Assortment Planning";
const PAGE = "Demand Sensing";
const KPIS = [{"l":"Utilizadores Ativos","v":"3.813","t":"+3.4%","d":"up"},{"l":"Sessões/Dia","v":"1049","t":"-2.8%","d":"down"},{"l":"MFA Adoção (%)","v":"68.9%","t":"+13.0%","d":"up"},{"l":"Tentativas Bloqueadas","v":"6.243","t":"+12.7%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.778","3.464","1.047","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","728","3.753","5.161","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.207","5.174","6.157","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","924","1.767","7.083","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","3.284","8.788","4.174","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":531},{"label":"Mar","value":537},{"label":"Abr","value":715},{"label":"Mai","value":613},{"label":"Jun","value":745},{"label":"Jul","value":725},{"label":"Ago","value":620},{"label":"Set","value":474},{"label":"Out","value":537},{"label":"Nov","value":569},{"label":"Dez","value":767}];
const MX = 767;
