...
const KPIS = [{"l":"Utilizadores Ativos","v":"5.105","t":"+6.7%","d":"up"},{"l":"Sessões/Dia","v":"4186","t":"+1.1%","d":"up"},{"l":"MFA Adoção (%)","v":"67.0%","t":"+10.7%","d":"up"},{"l":"Tentativas Bloqueadas","v":"3.172","t":"-0.6%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","8.731","1.569","1.921","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.823","7.448","8.868","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","7.198","5.219","3.051","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","6.737","8.557","3.874","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.513","5.678","344","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1068},{"label":"Fev","value":943},{"label":"Mar","value":779},{"label":"Abr","value":1001},{"label":"Mai","value":725},{"label":"Jun","value":724},{"label":"Jul","value":894},{"label":"Ago","value":820},{"label":"Set","value":1006},{"label":"Out","value":731},{"label":"Nov","value":698},{"label":"Dez","value":868}];
const MX = 1068;
