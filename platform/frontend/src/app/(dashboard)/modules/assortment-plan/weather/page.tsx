...
const KPIS = [{"l":"Utilizadores Ativos","v":"7.637","t":"+8.4%","d":"up"},{"l":"Sessões/Dia","v":"2025","t":"+2.6%","d":"up"},{"l":"MFA Adoção (%)","v":"85.4%","t":"+2.0%","d":"up"},{"l":"Tentativas Bloqueadas","v":"6.474","t":"+14.7%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","9.096","8.927","6.505","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.612","5.021","4.022","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.649","7.817","5.555","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","556","5.770","3.089","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","1.220","7.044","5.858","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":608},{"label":"Mar","value":885},{"label":"Abr","value":512},{"label":"Mai","value":565},{"label":"Jun","value":560},{"label":"Jul","value":743},{"label":"Ago","value":881},{"label":"Set","value":842},{"label":"Out","value":649},{"label":"Nov","value":538},{"label":"Dez","value":686}];
const MX = 885;
