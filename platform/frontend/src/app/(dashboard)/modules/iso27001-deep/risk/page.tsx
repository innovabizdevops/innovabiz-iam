...
const ACCENT = "#0e7490";
const MODULE = "ISMS Deep (ISO 27001)";
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"7.983","t":"-5.0%","d":"down"},{"l":"Mitigações Ativas","v":"2.485","t":"-4.8%","d":"down"},{"l":"Score Risco Geral","v":"66","t":"+14.5%","d":"up"},{"l":"Incidentes YTD","v":"2.937","t":"+16.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.792","4.969","3.216","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.003","4.465","1.304","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.837","5.903","4.874","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.172","1.350","4.386","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.986","4.904","3.293","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":444},{"label":"Mar","value":810},{"label":"Abr","value":838},{"label":"Mai","value":490},{"label":"Jun","value":714},{"label":"Jul","value":544},{"label":"Ago","value":527},{"label":"Set","value":829},{"label":"Out","value":584},{"label":"Nov","value":689},{"label":"Dez","value":463}];
const MX = 838;
