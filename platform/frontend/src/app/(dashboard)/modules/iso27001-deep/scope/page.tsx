...
const PAGE = "Scope";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.624","t":"-5.6%","d":"down"},{"l":"NC Abertas","v":"661","t":"+5.5%","d":"up"},{"l":"Conformidade (%)","v":"73.8%","t":"+1.8%","d":"up"},{"l":"CAPAs Pendentes","v":"6.284","t":"+4.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.563","70.7%","345","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.058","72.6%","1.416","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.091","74.2%","7.989","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.309","71.0%","9.043","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.035","84.0%","1.446","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":776},{"label":"Fev","value":752},{"label":"Mar","value":663},{"label":"Abr","value":794},{"label":"Mai","value":787},{"label":"Jun","value":782},{"label":"Jul","value":586},{"label":"Ago","value":926},{"label":"Set","value":829},{"label":"Out","value":866},{"label":"Nov","value":608},{"label":"Dez","value":596}];
const MX = 926;
