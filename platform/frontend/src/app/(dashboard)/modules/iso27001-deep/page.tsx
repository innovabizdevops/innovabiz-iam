...
/* ═══ ISMS Deep (ISO 27001) — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "1721", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3325", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€419K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1594089721", cells: ["ISO-1721", "ISMS Deep (ISO 27001) Item 1", "22/2/2026", "€39 821"], status: "active" as const },
    { id: "1594093292", cells: ["ISO-5292", "ISMS Deep (ISO 27001) Item 2", "9/9/2026", "€43 392"], status: "pending" as const },
    { id: "1594096863", cells: ["ISO-8863", "ISMS Deep (ISO 27001) Item 3", "24/4/2026", "€46 963"], status: "completed" as const },
    { id: "1594100434", cells: ["ISO-3434", "ISMS Deep (ISO 27001) Item 4", "11/11/2026", "€534"], status: "warning" as const },
    { id: "1594104005", cells: ["ISO-7005", "ISMS Deep (ISO 27001) Item 5", "26/6/2026", "€4105"], status: "active" as const },
];
...
export default function IsmsDeepIso27001Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">ISMS Deep (ISO 27001)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • ISMS Deep (ISO 27001)</p>
                    </div>
                </div>
