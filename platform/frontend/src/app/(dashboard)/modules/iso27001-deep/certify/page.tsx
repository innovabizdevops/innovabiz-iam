...
const PAGE = "Certify";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.390","t":"+8.7%","d":"up"},{"l":"NC Abertas","v":"7.076","t":"+5.7%","d":"up"},{"l":"Conformidade (%)","v":"76.9%","t":"+2.4%","d":"up"},{"l":"CAPAs Pendentes","v":"6.889","t":"-3.5%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.758","86.9%","8.105","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.059","77.2%","3.293","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.264","76.2%","3.950","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.707","71.8%","8.914","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.427","95.8%","615","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":894},{"label":"Fev","value":908},{"label":"Mar","value":835},{"label":"Abr","value":852},{"label":"Mai","value":1046},{"label":"Jun","value":1055},{"label":"Jul","value":1033},{"label":"Ago","value":909},{"label":"Set","value":858},{"label":"Out","value":931},{"label":"Nov","value":741},{"label":"Dez","value":1047}];
const MX = 1055;
