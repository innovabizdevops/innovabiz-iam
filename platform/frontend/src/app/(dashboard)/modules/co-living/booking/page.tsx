...
const PAGE = "Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"2.592","t":"+17.6%","d":"up"},{"l":"RevPAR (€)","v":"€72743","t":"-3.4%","d":"down"},{"l":"Ocupação (%)","v":"84.1%","t":"+2.5%","d":"up"},{"l":"Guest Satisfaction","v":"1.076","t":"-5.7%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","543","2026-01-24","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.047","2026-01-10","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","4.896","2026-03-28","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.456","2026-01-08","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.958","2026-03-13","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":588},{"label":"Mar","value":461},{"label":"Abr","value":489},{"label":"Mai","value":469},{"label":"Jun","value":424},{"label":"Jul","value":443},{"label":"Ago","value":550},{"label":"Set","value":393},{"label":"Out","value":598},{"label":"Nov","value":443},{"label":"Dez","value":468}];
const MX = 609;
