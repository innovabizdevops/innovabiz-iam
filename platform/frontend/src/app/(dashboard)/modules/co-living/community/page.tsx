...
const ACCENT = "#6366f1";
const MODULE = "Co-Living Platform";
const PAGE = "Community";
const KPIS = [{"l":"Projetos Sociais","v":"4.969","t":"+3.7%","d":"up"},{"l":"Beneficiários","v":"6.161","t":"+11.0%","d":"up"},{"l":"Investimento CSR (€)","v":"€37109","t":"+3.5%","d":"up"},{"l":"Score Impacto","v":"88","t":"+0.8%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","2.574","€ 9724.05","4.664","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","8.600","€ 5068.25","2.599","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","5.970","€ 24852.78","7.072","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","1.755","€ 20093.27","7.449","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","2.959","€ 25599.65","2.575","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":956},{"label":"Mar","value":767},{"label":"Abr","value":830},{"label":"Mai","value":755},{"label":"Jun","value":1008},{"label":"Jul","value":1042},{"label":"Ago","value":726},{"label":"Set","value":861},{"label":"Out","value":715},{"label":"Nov","value":757},{"label":"Dez","value":899}];
const MX = 1042;
