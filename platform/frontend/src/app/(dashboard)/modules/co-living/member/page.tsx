...
const PAGE = "Member";
const KPIS = [{"l":"Total Co Living","v":"8.404","t":"+6.7%","d":"up"},{"l":"Member Ativos","v":"7.935","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"77.1%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"86","t":"-2.9%","d":"down"}];
const COLS = ["ID","Member","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Co Living #001","Co Living #002","588","3.055","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Co Living #002","Co Living #003","351","6.733","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Co Living #003","Co Living #004","6.792","2.603","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Co Living #004","Co Living #005","1.974","2.087","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Co Living #005","Co Living #001","8.433","4.149","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":482},{"label":"Mar","value":760},{"label":"Abr","value":473},{"label":"Mai","value":729},{"label":"Jun","value":557},{"label":"Jul","value":715},{"label":"Ago","value":423},{"label":"Set","value":495},{"label":"Out","value":619},{"label":"Nov","value":687},{"label":"Dez","value":620}];
const MX = 760;
