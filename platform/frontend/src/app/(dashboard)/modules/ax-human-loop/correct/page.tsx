...
const ACCENT = "#4f46e5";
const MODULE = "AX Human-in-the-Loop";
const PAGE = "Correct";
const KPIS = [{"l":"Total Ax Human Loop","v":"4.756","t":"-2.8%","d":"down"},{"l":"Correct Ativos","v":"5.675","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"81.9%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"76","t":"+2.1%","d":"up"}];
const COLS = ["ID","Correct","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Human Loop #001","Ax Human Loop #002","7.551","1.678","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Human Loop #002","Ax Human Loop #003","2.180","6.147","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Human Loop #003","Ax Human Loop #004","5.306","135","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Human Loop #004","Ax Human Loop #005","8.330","6.984","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Human Loop #005","Ax Human Loop #001","5.393","1.556","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":931},{"label":"Mar","value":648},{"label":"Abr","value":843},{"label":"Mai","value":642},{"label":"Jun","value":684},{"label":"Jul","value":908},{"label":"Ago","value":779},{"label":"Set","value":778},{"label":"Out","value":789},{"label":"Nov","value":727},{"label":"Dez","value":986}];
const MX = 986;
