...
const PAGE = "Feedback";
const KPIS = [{"l":"Surveys Ativos","v":"2.722","t":"-3.3%","d":"down"},{"l":"Respostas/Semana","v":"2983","t":"+4.8%","d":"up"},{"l":"NPS Médio","v":"92","t":"+10.9%","d":"up"},{"l":"Taxa Resposta (%)","v":"89.1%","t":"+10.7%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","7.020","76","75.8%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","8.464","77","83.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","7.801","73","99.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","1.942","93","71.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","8.386","62","91.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1012},{"label":"Fev","value":790},{"label":"Mar","value":701},{"label":"Abr","value":952},{"label":"Mai","value":919},{"label":"Jun","value":880},{"label":"Jul","value":653},{"label":"Ago","value":694},{"label":"Set","value":697},{"label":"Out","value":974},{"label":"Nov","value":1019},{"label":"Dez","value":742}];
const MX = 1019;
