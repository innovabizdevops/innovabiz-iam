...
const PAGE = "Approve";
const KPIS = [{"l":"Aprovações Pendentes","v":"845","t":"+5.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"89.1%","t":"+10.6%","d":"up"},{"l":"Tempo Médio (h)","v":"13h","t":"-2.5%","d":"down"},{"l":"Rejeitadas (%)","v":"87.1%","t":"+1.4%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","8.784","€ 28488.88","7.113","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","405","€ 45570.66","2.535","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","8.329","€ 14387.03","987","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","3.926","€ 49656.25","8.249","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","5.791","€ 34063.08","6.224","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":710},{"label":"Mar","value":696},{"label":"Abr","value":582},{"label":"Mai","value":816},{"label":"Jun","value":659},{"label":"Jul","value":694},{"label":"Ago","value":503},{"label":"Set","value":650},{"label":"Out","value":792},{"label":"Nov","value":525},{"label":"Dez","value":834}];
const MX = 834;
