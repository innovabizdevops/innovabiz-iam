...
const PAGE = "Teach";
const KPIS = [{"l":"Total Ax Human Loop","v":"4.570","t":"+10.5%","d":"up"},{"l":"Teach Ativos","v":"7.117","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"94.8%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"93","t":"+3.3%","d":"up"}];
const COLS = ["ID","Teach","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Human Loop #001","Ax Human Loop #002","695","8.393","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Human Loop #002","Ax Human Loop #003","7.318","3.128","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Human Loop #003","Ax Human Loop #004","1.519","4.182","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Human Loop #004","Ax Human Loop #005","7.261","4.771","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Human Loop #005","Ax Human Loop #001","7.973","1.048","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":766},{"label":"Mar","value":843},{"label":"Abr","value":600},{"label":"Mai","value":661},{"label":"Jun","value":859},{"label":"Jul","value":927},{"label":"Ago","value":817},{"label":"Set","value":922},{"label":"Out","value":630},{"label":"Nov","value":928},{"label":"Dez","value":681}];
const MX = 928;
