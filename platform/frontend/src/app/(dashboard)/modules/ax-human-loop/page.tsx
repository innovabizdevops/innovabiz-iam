...
/* ═══ AX Human-in-the-Loop — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "5967", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2211", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€43K", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "837773567", cells: ["AX-9567", "AX Human-in-the-Loop Item 1", "16/12/2026", "€23 667"], status: "active" as const },
    { id: "837777138", cells: ["AX-4138", "AX Human-in-the-Loop Item 2", "3/7/2026", "€27 238"], status: "pending" as const },
    { id: "837780709", cells: ["AX-7709", "AX Human-in-the-Loop Item 3", "18/2/2026", "€30 809"], status: "completed" as const },
    { id: "837784280", cells: ["AX-2280", "AX Human-in-the-Loop Item 4", "5/9/2026", "€34 380"], status: "warning" as const },
    { id: "837787851", cells: ["AX-5851", "AX Human-in-the-Loop Item 5", "20/4/2026", "€37 951"], status: "active" as const },
];
...
export default function AxHumanintheloopPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AX Human-in-the-Loop</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AX Human-in-the-Loop</p>
                    </div>
                </div>
