...
const PAGE = "Override";
const KPIS = [{"l":"Total Ax Human Loop","v":"3.951","t":"+5.3%","d":"up"},{"l":"Override Ativos","v":"3.921","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"72.2%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"64","t":"+5.2%","d":"up"}];
const COLS = ["ID","Override","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Human Loop #001","Ax Human Loop #002","2.324","4.518","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Human Loop #002","Ax Human Loop #003","8.386","6.999","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Human Loop #003","Ax Human Loop #004","7.387","8.343","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Human Loop #004","Ax Human Loop #005","7.792","6.845","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Human Loop #005","Ax Human Loop #001","2.779","2.492","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":615},{"label":"Mar","value":712},{"label":"Abr","value":502},{"label":"Mai","value":584},{"label":"Jun","value":692},{"label":"Jul","value":572},{"label":"Ago","value":552},{"label":"Set","value":652},{"label":"Out","value":524},{"label":"Nov","value":542},{"label":"Dez","value":620}];
const MX = 829;
