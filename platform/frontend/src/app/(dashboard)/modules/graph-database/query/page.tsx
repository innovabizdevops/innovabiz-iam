...
const PAGE = "Query";
const KPIS = [{"l":"Total Graph Database","v":"8.100","t":"-1.4%","d":"down"},{"l":"Query Ativos","v":"8.797","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"79.0%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"63","t":"+13.2%","d":"up"}];
const COLS = ["ID","Query","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Graph Database #001","Graph Database #002","6.013","8.823","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Graph Database #002","Graph Database #003","8.662","2.896","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Graph Database #003","Graph Database #004","7.830","6.490","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Graph Database #004","Graph Database #005","5.452","858","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Graph Database #005","Graph Database #001","850","4.497","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":970},{"label":"Mar","value":803},{"label":"Abr","value":820},{"label":"Mai","value":756},{"label":"Jun","value":656},{"label":"Jul","value":739},{"label":"Ago","value":835},{"label":"Set","value":861},{"label":"Out","value":781},{"label":"Nov","value":792},{"label":"Dez","value":598}];
const MX = 970;
