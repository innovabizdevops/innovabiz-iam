...
const ACCENT = "#1e3a5f";
const MODULE = "Graph Database Platform";
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"5.292","t":"-4.5%","d":"down"},{"l":"Queries/Dia","v":"3475","t":"+1.3%","d":"up"},{"l":"Dados Processados (GB)","v":"821","t":"+11.2%","d":"up"},{"l":"Utilizadores Analytics","v":"5.925","t":"+12.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3790","2026-02-14","7.924","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3030","2026-01-14","6.208","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1107","2026-02-23","8.440","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1510","2026-02-18","615","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4696","2026-02-20","2.678","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":1014},{"label":"Mar","value":656},{"label":"Abr","value":1032},{"label":"Mai","value":713},{"label":"Jun","value":738},{"label":"Jul","value":742},{"label":"Ago","value":995},{"label":"Set","value":853},{"label":"Out","value":653},{"label":"Nov","value":786},{"label":"Dez","value":726}];
const MX = 1032;
