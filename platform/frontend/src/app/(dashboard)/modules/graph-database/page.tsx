...
/* ═══ Graph Database Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "7631", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4227", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€102K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "99631231", cells: ["GRA-2231", "Graph Database Platform Item 1", "8/8/2026", "€31 331"], status: "active" as const },
    { id: "99634802", cells: ["GRA-5802", "Graph Database Platform Item 2", "23/3/2026", "€34 902"], status: "pending" as const },
    { id: "99638373", cells: ["GRA-9373", "Graph Database Platform Item 3", "10/10/2026", "€38 473"], status: "completed" as const },
    { id: "99641944", cells: ["GRA-3944", "Graph Database Platform Item 4", "25/5/2026", "€42 044"], status: "warning" as const },
    { id: "99645515", cells: ["GRA-7515", "Graph Database Platform Item 5", "12/12/2026", "€45 615"], status: "active" as const },
];
...
export default function GraphDatabasePlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Graph Database Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Graph Database Platform</p>
                    </div>
                </div>
