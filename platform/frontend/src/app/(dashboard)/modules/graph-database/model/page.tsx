...
const PAGE = "Model";
const KPIS = [{"l":"Total Graph Database","v":"5.662","t":"+10.2%","d":"up"},{"l":"Model Ativos","v":"724","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"85.4%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"70","t":"+11.1%","d":"up"}];
const COLS = ["ID","Model","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Graph Database #001","Graph Database #002","3.662","6.041","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Graph Database #002","Graph Database #003","8.660","8.176","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Graph Database #003","Graph Database #004","7.966","7.068","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Graph Database #004","Graph Database #005","5.131","599","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Graph Database #005","Graph Database #001","6.629","4.144","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":605},{"label":"Mar","value":660},{"label":"Abr","value":848},{"label":"Mai","value":770},{"label":"Jun","value":921},{"label":"Jul","value":667},{"label":"Ago","value":781},{"label":"Set","value":828},{"label":"Out","value":932},{"label":"Nov","value":786},{"label":"Dez","value":923}];
const MX = 932;
