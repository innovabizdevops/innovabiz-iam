...
const KPIS = [{"l":"Dashboards Ativos","v":"3.190","t":"+5.8%","d":"up"},{"l":"Queries/Dia","v":"3572","t":"+8.4%","d":"up"},{"l":"Dados Processados (GB)","v":"1.153","t":"+14.6%","d":"up"},{"l":"Utilizadores Analytics","v":"6.285","t":"+16.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3541","2026-03-11","1.937","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1749","2026-03-08","6.571","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1614","2026-01-23","1.409","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","652","2026-02-06","2.329","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","819","2026-02-21","7.829","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":433},{"label":"Fev","value":340},{"label":"Mar","value":430},{"label":"Abr","value":549},{"label":"Mai","value":265},{"label":"Jun","value":412},{"label":"Jul","value":325},{"label":"Ago","value":447},{"label":"Set","value":238},{"label":"Out","value":225},{"label":"Nov","value":395},{"label":"Dez","value":266}];
const MX = 549;
