...
const PAGE = "Murabaha";
const KPIS = [{"l":"Tickets Abertos","v":"1.926","t":"+10.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"70.7%","t":"+9.0%","d":"up"},{"l":"MTTR (h)","v":"14h","t":"+4.5%","d":"up"},{"l":"Satisfação (%)","v":"89.1%","t":"+5.2%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.515","8.551","8.143","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","365","3.401","5.785","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.342","1.776","5.124","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.901","8.428","6.226","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.397","1.440","885","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1025},{"label":"Fev","value":995},{"label":"Mar","value":701},{"label":"Abr","value":791},{"label":"Mai","value":860},{"label":"Jun","value":1070},{"label":"Jul","value":795},{"label":"Ago","value":833},{"label":"Set","value":880},{"label":"Out","value":978},{"label":"Nov","value":826},{"label":"Dez","value":986}];
const MX = 1070;
