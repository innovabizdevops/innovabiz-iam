...
const PAGE = "Takaful";
const KPIS = [{"l":"Tickets Abertos","v":"3.133","t":"-5.2%","d":"down"},{"l":"SLA Cumprido (%)","v":"93.0%","t":"+12.9%","d":"up"},{"l":"MTTR (h)","v":"168h","t":"+11.7%","d":"up"},{"l":"Satisfação (%)","v":"76.9%","t":"+11.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","504","5.733","5.916","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.969","7.326","5.976","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.886","8.077","7.062","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","296","8.039","7.198","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.444","6.457","1.238","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":870},{"label":"Fev","value":788},{"label":"Mar","value":1020},{"label":"Abr","value":949},{"label":"Mai","value":808},{"label":"Jun","value":934},{"label":"Jul","value":842},{"label":"Ago","value":964},{"label":"Set","value":687},{"label":"Out","value":714},{"label":"Nov","value":894},{"label":"Dez","value":902}];
const MX = 1020;
