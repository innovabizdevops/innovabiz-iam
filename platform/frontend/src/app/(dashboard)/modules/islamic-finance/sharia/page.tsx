...
const ACCENT = "#78350f";
const MODULE = "Islamic Finance";
const PAGE = "Sharia Board";
const KPIS = [{"l":"Tickets Abertos","v":"5.303","t":"+7.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"90.2%","t":"+6.9%","d":"up"},{"l":"MTTR (h)","v":"102h","t":"+9.1%","d":"up"},{"l":"Satisfação (%)","v":"91.0%","t":"-4.4%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.587","8.654","1.721","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.091","6.808","6.422","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.160","6.299","6.316","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","106","7.300","3.367","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.071","1.981","818","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":577},{"label":"Mar","value":589},{"label":"Abr","value":744},{"label":"Mai","value":662},{"label":"Jun","value":469},{"label":"Jul","value":417},{"label":"Ago","value":609},{"label":"Set","value":763},{"label":"Out","value":425},{"label":"Nov","value":467},{"label":"Dez","value":661}];
const MX = 763;
