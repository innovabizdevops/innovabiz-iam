...
const PAGE = "Sukuk";
const KPIS = [{"l":"Tickets Abertos","v":"8.669","t":"+9.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"81.9%","t":"+13.9%","d":"up"},{"l":"MTTR (h)","v":"153h","t":"+3.5%","d":"up"},{"l":"Satisfação (%)","v":"91.5%","t":"+2.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.459","5.539","3.427","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.155","144","3.294","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","422","5.148","8.898","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","9.061","291","2.726","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.480","6.773","3.474","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":654},{"label":"Mar","value":747},{"label":"Abr","value":843},{"label":"Mai","value":551},{"label":"Jun","value":668},{"label":"Jul","value":745},{"label":"Ago","value":862},{"label":"Set","value":643},{"label":"Out","value":819},{"label":"Nov","value":879},{"label":"Dez","value":740}];
const MX = 879;
