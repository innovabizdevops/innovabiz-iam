...
const PAGE = "Ijara";
const KPIS = [{"l":"Tickets Abertos","v":"4.754","t":"+15.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"84.5%","t":"-0.1%","d":"down"},{"l":"MTTR (h)","v":"15h","t":"-0.8%","d":"down"},{"l":"Satisfação (%)","v":"78.3%","t":"+13.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.932","5.623","3.880","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.143","8.984","934","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.974","7.702","7.265","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.675","2.396","3.395","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.687","5.038","2.022","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":357},{"label":"Fev","value":593},{"label":"Mar","value":334},{"label":"Abr","value":607},{"label":"Mai","value":480},{"label":"Jun","value":608},{"label":"Jul","value":649},{"label":"Ago","value":588},{"label":"Set","value":302},{"label":"Out","value":568},{"label":"Nov","value":526},{"label":"Dez","value":532}];
const MX = 649;
