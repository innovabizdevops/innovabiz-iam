...
const PAGE = "Size Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"4.242","t":"-2.7%","d":"down"},{"l":"Queries/Dia","v":"1797","t":"+0.6%","d":"up"},{"l":"Dados Processados (GB)","v":"6.087","t":"+14.0%","d":"up"},{"l":"Utilizadores Analytics","v":"6.545","t":"+1.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1518","2026-01-03","8.190","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2842","2026-03-09","7.033","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4399","2026-02-19","5.329","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3634","2026-02-07","7.229","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3085","2026-03-10","5.122","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":956},{"label":"Fev","value":847},{"label":"Mar","value":1082},{"label":"Abr","value":783},{"label":"Mai","value":761},{"label":"Jun","value":950},{"label":"Jul","value":1045},{"label":"Ago","value":944},{"label":"Set","value":891},{"label":"Out","value":1043},{"label":"Nov","value":928},{"label":"Dez","value":804}];
const MX = 1082;
