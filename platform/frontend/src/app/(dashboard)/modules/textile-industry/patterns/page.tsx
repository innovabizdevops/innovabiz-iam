...
const PAGE = "Pattern Design";
const KPIS = [{"l":"Formulários Ativos","v":"7.579","t":"+2.8%","d":"up"},{"l":"Submissões/Dia","v":"298","t":"-3.3%","d":"down"},{"l":"Documentos Gerados","v":"6.888","t":"+16.4%","d":"up"},{"l":"Templates","v":"4.496","t":"+5.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.505","2026-03-08","126","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.639","2026-03-19","2.759","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.582","2026-03-15","2.183","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.280","2026-02-20","5.107","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.282","2026-01-27","3.431","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":659},{"label":"Mar","value":632},{"label":"Abr","value":658},{"label":"Mai","value":536},{"label":"Jun","value":569},{"label":"Jul","value":806},{"label":"Ago","value":689},{"label":"Set","value":472},{"label":"Out","value":657},{"label":"Nov","value":608},{"label":"Dez","value":737}];
const MX = 806;
