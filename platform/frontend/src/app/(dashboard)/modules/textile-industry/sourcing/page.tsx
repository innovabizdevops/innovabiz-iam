...
const PAGE = "Fabric Sourcing";
const KPIS = [{"l":"Fornecedores Ativos","v":"7.570","t":"+10.6%","d":"up"},{"l":"Contratos (€M)","v":"€44.9M","t":"-4.8%","d":"down"},{"l":"On-Time Delivery (%)","v":"73.3%","t":"+0.6%","d":"up"},{"l":"Score Médio","v":"90","t":"+12.0%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","77.1%","€ 28138.13","4.779","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","96.8%","€ 47293.36","2.958","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","75.8%","€ 16040.16","5.392","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","77.4%","€ 10464.36","3.626","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","91.1%","€ 8941.59","3.964","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":793},{"label":"Fev","value":730},{"label":"Mar","value":768},{"label":"Abr","value":523},{"label":"Mai","value":827},{"label":"Jun","value":583},{"label":"Jul","value":696},{"label":"Ago","value":641},{"label":"Set","value":543},{"label":"Out","value":837},{"label":"Nov","value":558},{"label":"Dez","value":814}];
const MX = 837;
