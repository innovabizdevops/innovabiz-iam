...
const ACCENT = "#a16207";
const MODULE = "Textile & Apparel";
const PAGE = "Fair Trade Cert";
const KPIS = [{"l":"Projetos Sociais","v":"2.948","t":"+10.6%","d":"up"},{"l":"Beneficiários","v":"9.064","t":"+-0.0%","d":"up"},{"l":"Investimento CSR (€)","v":"€91506","t":"-3.0%","d":"down"},{"l":"Score Impacto","v":"55","t":"+4.2%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","6.211","€ 39747.70","830","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","7.766","€ 28470.43","2.348","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","7.223","€ 33679.13","4.584","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","5.941","€ 32286.96","1.798","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","5.226","€ 35556.11","2.109","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":743},{"label":"Mar","value":558},{"label":"Abr","value":675},{"label":"Mai","value":699},{"label":"Jun","value":835},{"label":"Jul","value":585},{"label":"Ago","value":630},{"label":"Set","value":690},{"label":"Out","value":649},{"label":"Nov","value":849},{"label":"Dez","value":639}];
const MX = 849;
