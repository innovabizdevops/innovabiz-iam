...
const PAGE = "Dye Management";
const KPIS = [{"l":"Projetos Melhoria","v":"7.077","t":"+12.3%","d":"up"},{"l":"Savings (€)","v":"€20823","t":"+4.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"67.8%","t":"+2.9%","d":"up"},{"l":"Ciclos PDCA","v":"6.157","t":"+1.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.752","€ 47301.41","5.108","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","504","€ 33692.25","7.999","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.576","€ 40875.30","7.768","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","570","€ 41317.35","7.431","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.092","€ 30328.75","3.621","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":356},{"label":"Fev","value":532},{"label":"Mar","value":363},{"label":"Abr","value":464},{"label":"Mai","value":392},{"label":"Jun","value":396},{"label":"Jul","value":476},{"label":"Ago","value":286},{"label":"Set","value":386},{"label":"Out","value":296},{"label":"Nov","value":241},{"label":"Dez","value":345}];
const MX = 532;
