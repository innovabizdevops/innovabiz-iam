...
const PAGE = "Storage";
const KPIS = [{"l":"Total Ammunition Mgmt","v":"3.320","t":"+7.5%","d":"up"},{"l":"Storage Ativos","v":"7.114","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"66.7%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"66","t":"+9.9%","d":"up"}];
const COLS = ["ID","Storage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ammunition Mgmt #001","Ammunition Mgmt #002","6.467","7.998","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Ammunition Mgmt #002","Ammunition Mgmt #003","1.874","545","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Ammunition Mgmt #003","Ammunition Mgmt #004","4.266","6.153","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Ammunition Mgmt #004","Ammunition Mgmt #005","777","7.506","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ammunition Mgmt #005","Ammunition Mgmt #001","1.871","1.299","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":618},{"label":"Mar","value":904},{"label":"Abr","value":736},{"label":"Mai","value":623},{"label":"Jun","value":677},{"label":"Jul","value":692},{"label":"Ago","value":587},{"label":"Set","value":636},{"label":"Out","value":733},{"label":"Nov","value":778},{"label":"Dez","value":817}];
const MX = 904;
