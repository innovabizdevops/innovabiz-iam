...
const ACCENT = "#1e293b";
const MODULE = "Ammunition Mgmt";
const PAGE = "Issue";
const KPIS = [{"l":"Total Ammunition Mgmt","v":"2.555","t":"-4.6%","d":"down"},{"l":"Issue Ativos","v":"3.897","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"89.2%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"68","t":"-3.0%","d":"down"}];
const COLS = ["ID","Issue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ammunition Mgmt #001","Ammunition Mgmt #002","1.424","5.880","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Ammunition Mgmt #002","Ammunition Mgmt #003","7.597","2.935","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Ammunition Mgmt #003","Ammunition Mgmt #004","5.472","7.183","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Ammunition Mgmt #004","Ammunition Mgmt #005","573","1.012","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ammunition Mgmt #005","Ammunition Mgmt #001","957","2.405","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":269},{"label":"Fev","value":517},{"label":"Mar","value":409},{"label":"Abr","value":555},{"label":"Mai","value":288},{"label":"Jun","value":301},{"label":"Jul","value":606},{"label":"Ago","value":611},{"label":"Set","value":342},{"label":"Out","value":413},{"label":"Nov","value":584},{"label":"Dez","value":609}];
const MX = 611;
