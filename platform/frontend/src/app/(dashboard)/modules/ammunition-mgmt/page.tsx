...
/* ═══ Ammunition Mgmt — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "9994", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2751", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€169K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1838093394", cells: ["AMM-6394", "Ammunition Mgmt Item 1", "19/7/2026", "€43 494"], status: "active" as const },
    { id: "1838096965", cells: ["AMM-9965", "Ammunition Mgmt Item 2", "6/2/2026", "€47 065"], status: "pending" as const },
    { id: "1838100536", cells: ["AMM-4536", "Ammunition Mgmt Item 3", "21/9/2026", "€636"], status: "completed" as const },
    { id: "1838104107", cells: ["AMM-8107", "Ammunition Mgmt Item 4", "8/4/2026", "€4207"], status: "warning" as const },
    { id: "1838107678", cells: ["AMM-2678", "Ammunition Mgmt Item 5", "23/11/2026", "€7778"], status: "active" as const },
];
...
export default function AmmunitionMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ammunition Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Ammunition Mgmt</p>
                    </div>
                </div>
