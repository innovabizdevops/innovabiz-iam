...
const KPIS = [{"l":"Total Ammunition Mgmt","v":"2.608","t":"+16.4%","d":"up"},{"l":"Inventory Ativos","v":"2.306","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"75.3%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"87","t":"+5.9%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ammunition Mgmt #001","Ammunition Mgmt #002","8.464","4.167","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Ammunition Mgmt #002","Ammunition Mgmt #003","8.875","3.594","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Ammunition Mgmt #003","Ammunition Mgmt #004","1.146","363","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Ammunition Mgmt #004","Ammunition Mgmt #005","4.731","6.113","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ammunition Mgmt #005","Ammunition Mgmt #001","1.625","3.344","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":389},{"label":"Fev","value":312},{"label":"Mar","value":414},{"label":"Abr","value":606},{"label":"Mai","value":224},{"label":"Jun","value":403},{"label":"Jul","value":267},{"label":"Ago","value":311},{"label":"Set","value":551},{"label":"Out","value":315},{"label":"Nov","value":330},{"label":"Dez","value":299}];
const MX = 606;
