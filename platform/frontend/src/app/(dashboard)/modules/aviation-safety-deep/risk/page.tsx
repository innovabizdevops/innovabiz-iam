...
const ACCENT = "#6366f1";
const MODULE = "Aviation Safety";
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"4.761","t":"+10.7%","d":"up"},{"l":"Mitigações Ativas","v":"5.686","t":"+5.9%","d":"up"},{"l":"Score Risco Geral","v":"84","t":"+6.9%","d":"up"},{"l":"Incidentes YTD","v":"3.384","t":"+1.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.410","4.761","6.766","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.468","3.777","8.737","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.815","5.839","2.160","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.625","2.797","973","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.361","4.790","1.960","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":503},{"label":"Mar","value":519},{"label":"Abr","value":534},{"label":"Mai","value":443},{"label":"Jun","value":430},{"label":"Jul","value":716},{"label":"Ago","value":501},{"label":"Set","value":562},{"label":"Out","value":489},{"label":"Nov","value":526},{"label":"Dez","value":775}];
const MX = 775;
