...
export default function LaundryMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div><h1 className="text-2xl font-bold">Laundry Mgmt</h1><p className="text-sm text-muted-foreground">Laundry Mgmt • iBOS</p></div>
