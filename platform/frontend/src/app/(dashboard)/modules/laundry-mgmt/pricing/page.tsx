...
const PAGE = "Pricing";
const KPIS = [{"l":"ARR (€M)","v":"€37.1M","t":"+6.6%","d":"up"},{"l":"MRR (€)","v":"€15205","t":"-2.9%","d":"down"},{"l":"Churn (%)","v":"89.6%","t":"+16.4%","d":"up"},{"l":"ARPU (€)","v":"€59992","t":"+2.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 25698.93","4.691","€ 27726.53","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 9596.37","3.953","€ 9106.69","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 9852.51","208","€ 39527.35","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 6759.04","1.938","€ 43583.25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 32468.02","3.698","€ 49104.94","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":432},{"label":"Mar","value":529},{"label":"Abr","value":636},{"label":"Mai","value":618},{"label":"Jun","value":529},{"label":"Jul","value":698},{"label":"Ago","value":743},{"label":"Set","value":429},{"label":"Out","value":527},{"label":"Nov","value":614},{"label":"Dez","value":603}];
const MX = 743;
