...
const ACCENT = "#6366f1";
const MODULE = "Laundry Management";
const PAGE = "Process";
const KPIS = [{"l":"Total Laundry Mgmt","v":"6.053","t":"+12.1%","d":"up"},{"l":"Process Ativos","v":"8.713","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"84.8%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"55","t":"-3.0%","d":"down"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Laundry Mgmt #001","Laundry Mgmt #002","6.521","2.409","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Laundry Mgmt #002","Laundry Mgmt #003","6.033","8.578","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Laundry Mgmt #003","Laundry Mgmt #004","1.700","8.567","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Laundry Mgmt #004","Laundry Mgmt #005","8.541","7.332","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Laundry Mgmt #005","Laundry Mgmt #001","3.176","2.981","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":327},{"label":"Fev","value":484},{"label":"Mar","value":210},{"label":"Abr","value":413},{"label":"Mai","value":585},{"label":"Jun","value":428},{"label":"Jul","value":559},{"label":"Ago","value":283},{"label":"Set","value":467},{"label":"Out","value":344},{"label":"Nov","value":316},{"label":"Dez","value":533}];
const MX = 585;
