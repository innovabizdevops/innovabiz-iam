...
const PAGE = "Order";
const KPIS = [{"l":"Total Laundry Mgmt","v":"4.581","t":"+17.1%","d":"up"},{"l":"Order Ativos","v":"3.931","t":"+4.4%","d":"up"},{"l":"Eficiência (%)","v":"90.0%","t":"+7.6%","d":"up"},{"l":"Score Performance","v":"80","t":"+7.5%","d":"up"}];
const COLS = ["ID","Order","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Laundry Mgmt #001","Laundry Mgmt #002","8.462","4.359","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Laundry Mgmt #002","Laundry Mgmt #003","4.287","8.286","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Laundry Mgmt #003","Laundry Mgmt #004","2.600","5.065","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Laundry Mgmt #004","Laundry Mgmt #005","1.074","1.861","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Laundry Mgmt #005","Laundry Mgmt #001","5.325","6.856","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":459},{"label":"Mar","value":362},{"label":"Abr","value":448},{"label":"Mai","value":665},{"label":"Jun","value":289},{"label":"Jul","value":329},{"label":"Ago","value":274},{"label":"Set","value":645},{"label":"Out","value":550},{"label":"Nov","value":529},{"label":"Dez","value":561}];
const MX = 665;
