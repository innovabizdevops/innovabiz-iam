...
const KPIS = [{"l":"Dashboards Ativos","v":"9.050","t":"+3.6%","d":"up"},{"l":"Queries/Dia","v":"1150","t":"+5.2%","d":"up"},{"l":"Dados Processados (GB)","v":"942","t":"-4.5%","d":"down"},{"l":"Utilizadores Analytics","v":"1.691","t":"+1.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2003","2026-01-16","4.892","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2273","2026-03-01","7.172","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1464","2026-01-19","3.539","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1557","2026-03-15","7.494","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4909","2026-01-13","7.997","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":538},{"label":"Mar","value":393},{"label":"Abr","value":377},{"label":"Mai","value":420},{"label":"Jun","value":475},{"label":"Jul","value":420},{"label":"Ago","value":364},{"label":"Set","value":221},{"label":"Out","value":450},{"label":"Nov","value":581},{"label":"Dez","value":286}];
const MX = 581;
