...
const KPIS = [{"l":"Total Db Admin","v":"3.249","t":"+5.4%","d":"up"},{"l":"Replication Ativos","v":"7.126","t":"-3.9%","d":"down"},{"l":"Eficiência (%)","v":"67.5%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"85","t":"+13.9%","d":"up"}];
const COLS = ["ID","Replication","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Db Admin #001","Db Admin #002","186","2.373","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Db Admin #002","Db Admin #003","6.133","7.005","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Db Admin #003","Db Admin #004","4.715","4.600","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Db Admin #004","Db Admin #005","5.197","7.472","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Db Admin #005","Db Admin #001","1.755","3.750","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":1041},{"label":"Mar","value":814},{"label":"Abr","value":744},{"label":"Mai","value":679},{"label":"Jun","value":885},{"label":"Jul","value":802},{"label":"Ago","value":668},{"label":"Set","value":876},{"label":"Out","value":791},{"label":"Nov","value":734},{"label":"Dez","value":894}];
const MX = 1041;
