...
const PAGE = "Backup/Restore";
const KPIS = [{"l":"Pedidos/Dia","v":"2193","t":"+2.3%","d":"up"},{"l":"GMV (€)","v":"€45029","t":"-1.4%","d":"down"},{"l":"Conversão (%)","v":"93.7%","t":"+1.1%","d":"up"},{"l":"AOV (€)","v":"€98304","t":"+17.0%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 49049.49","5.665","7.440","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 12617.85","4.333","5.413","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 892.97","2.846","3.120","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 37565.55","8.280","7.079","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 40022.40","3.654","1.483","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":521},{"label":"Mar","value":679},{"label":"Abr","value":740},{"label":"Mai","value":450},{"label":"Jun","value":685},{"label":"Jul","value":490},{"label":"Ago","value":480},{"label":"Set","value":397},{"label":"Out","value":689},{"label":"Nov","value":641},{"label":"Dez","value":524}];
const MX = 740;
