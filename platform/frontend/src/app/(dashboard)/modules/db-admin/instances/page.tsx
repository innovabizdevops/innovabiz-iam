...
const KPIS = [{"l":"Total Db Admin","v":"4.654","t":"+0.4%","d":"up"},{"l":"Instance Mgmt Ativos","v":"7.158","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"93","t":"+17.1%","d":"up"}];
const COLS = ["ID","Instance Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Db Admin #001","Db Admin #002","3.823","7.422","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Db Admin #002","Db Admin #003","1.074","7.299","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Db Admin #003","Db Admin #004","198","5.469","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Db Admin #004","Db Admin #005","2.383","7.161","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Db Admin #005","Db Admin #001","4.095","5.379","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":982},{"label":"Fev","value":751},{"label":"Mar","value":903},{"label":"Abr","value":1017},{"label":"Mai","value":856},{"label":"Jun","value":925},{"label":"Jul","value":949},{"label":"Ago","value":762},{"label":"Set","value":773},{"label":"Out","value":812},{"label":"Nov","value":755},{"label":"Dez","value":830}];
const MX = 1017;
