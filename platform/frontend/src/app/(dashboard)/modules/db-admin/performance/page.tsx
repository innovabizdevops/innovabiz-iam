...
const KPIS = [{"l":"Formulários Ativos","v":"6.757","t":"+13.5%","d":"up"},{"l":"Submissões/Dia","v":"4283","t":"+13.3%","d":"up"},{"l":"Documentos Gerados","v":"7.584","t":"+8.4%","d":"up"},{"l":"Templates","v":"121","t":"+14.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","777","2026-02-16","5.880","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","572","2026-02-26","6.948","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.880","2026-02-23","5.204","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.922","2026-03-03","3.724","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.602","2026-03-09","3.931","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":311},{"label":"Fev","value":346},{"label":"Mar","value":630},{"label":"Abr","value":582},{"label":"Mai","value":244},{"label":"Jun","value":615},{"label":"Jul","value":408},{"label":"Ago","value":347},{"label":"Set","value":627},{"label":"Out","value":301},{"label":"Nov","value":619},{"label":"Dez","value":378}];
const MX = 630;
