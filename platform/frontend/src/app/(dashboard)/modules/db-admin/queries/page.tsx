...
const ACCENT = "#475569";
const MODULE = "Database Administration";
const PAGE = "Query Analyzer";
const KPIS = [{"l":"Dashboards Ativos","v":"1.591","t":"+6.0%","d":"up"},{"l":"Queries/Dia","v":"2172","t":"+3.5%","d":"up"},{"l":"Dados Processados (GB)","v":"1.845","t":"-1.4%","d":"down"},{"l":"Utilizadores Analytics","v":"4.289","t":"+2.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5015","2026-02-11","677","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4835","2026-01-28","5.501","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2437","2026-03-02","8.744","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2715","2026-02-10","5.048","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1511","2026-03-10","5.646","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1064},{"label":"Fev","value":809},{"label":"Mar","value":1031},{"label":"Abr","value":970},{"label":"Mai","value":1037},{"label":"Jun","value":972},{"label":"Jul","value":1075},{"label":"Ago","value":714},{"label":"Set","value":691},{"label":"Out","value":1009},{"label":"Nov","value":927},{"label":"Dez","value":840}];
const MX = 1075;
