...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.927","t":"+18.0%","d":"up"},{"l":"NC Abertas","v":"4.278","t":"+7.0%","d":"up"},{"l":"Conformidade (%)","v":"89.9%","t":"+12.7%","d":"up"},{"l":"CAPAs Pendentes","v":"7.457","t":"+15.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.306","79.6%","5.545","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.855","85.3%","3.677","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.541","82.7%","8.065","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.876","86.7%","6.270","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.313","87.5%","2.107","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":996},{"label":"Mar","value":829},{"label":"Abr","value":930},{"label":"Mai","value":886},{"label":"Jun","value":889},{"label":"Jul","value":991},{"label":"Ago","value":733},{"label":"Set","value":691},{"label":"Out","value":812},{"label":"Nov","value":851},{"label":"Dez","value":628}];
const MX = 996;
