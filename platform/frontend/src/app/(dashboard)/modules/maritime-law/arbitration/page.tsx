...
const PAGE = "Arbitration";
const KPIS = [{"l":"Total Maritime Law","v":"3.188","t":"+10.6%","d":"up"},{"l":"Arbitration Ativos","v":"4.393","t":"+5.7%","d":"up"},{"l":"Eficiência (%)","v":"82.0%","t":"+4.5%","d":"up"},{"l":"Score Performance","v":"65","t":"+13.1%","d":"up"}];
const COLS = ["ID","Arbitration","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Maritime Law #001","Maritime Law #002","3.301","8.903","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Maritime Law #002","Maritime Law #003","8.887","1.554","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Maritime Law #003","Maritime Law #004","5.898","5.834","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Maritime Law #004","Maritime Law #005","3.503","657","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Maritime Law #005","Maritime Law #001","7.651","3.679","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":940},{"label":"Fev","value":771},{"label":"Mar","value":847},{"label":"Abr","value":974},{"label":"Mai","value":1028},{"label":"Jun","value":780},{"label":"Jul","value":901},{"label":"Ago","value":773},{"label":"Set","value":660},{"label":"Out","value":1014},{"label":"Nov","value":987},{"label":"Dez","value":923}];
const MX = 1028;
