...
const ACCENT = "#78350f";
const MODULE = "Maritime Law";
const PAGE = "Collision";
const KPIS = [{"l":"Total Maritime Law","v":"6.781","t":"-3.9%","d":"down"},{"l":"Collision Ativos","v":"8.966","t":"-4.0%","d":"down"},{"l":"Eficiência (%)","v":"65.6%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"87","t":"+12.2%","d":"up"}];
const COLS = ["ID","Collision","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Maritime Law #001","Maritime Law #002","3.276","2.628","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Maritime Law #002","Maritime Law #003","4.748","1.871","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Maritime Law #003","Maritime Law #004","3.875","8.680","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Maritime Law #004","Maritime Law #005","8.497","8.590","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Maritime Law #005","Maritime Law #001","5.261","1.015","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":653},{"label":"Mar","value":380},{"label":"Abr","value":618},{"label":"Mai","value":633},{"label":"Jun","value":422},{"label":"Jul","value":414},{"label":"Ago","value":435},{"label":"Set","value":319},{"label":"Out","value":496},{"label":"Nov","value":452},{"label":"Dez","value":382}];
const MX = 653;
