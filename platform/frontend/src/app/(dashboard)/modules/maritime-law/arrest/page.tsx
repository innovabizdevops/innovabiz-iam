...
const PAGE = "Arrest/Lien";
const KPIS = [{"l":"ARR (€M)","v":"€6.5M","t":"-4.9%","d":"down"},{"l":"MRR (€)","v":"€2530","t":"+10.7%","d":"up"},{"l":"Churn (%)","v":"89.7%","t":"+17.7%","d":"up"},{"l":"ARPU (€)","v":"€42409","t":"+1.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 29915.00","6.312","€ 46385.34","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 6888.89","2.882","€ 45055.72","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 46580.72","5.991","€ 26566.54","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 24394.50","164","€ 46458.17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 1407.05","604","€ 3391.86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":373},{"label":"Fev","value":464},{"label":"Mar","value":565},{"label":"Abr","value":483},{"label":"Mai","value":366},{"label":"Jun","value":513},{"label":"Jul","value":233},{"label":"Ago","value":317},{"label":"Set","value":626},{"label":"Out","value":487},{"label":"Nov","value":575},{"label":"Dez","value":333}];
const MX = 626;
...
export default function ArrestPage() {
    return (
