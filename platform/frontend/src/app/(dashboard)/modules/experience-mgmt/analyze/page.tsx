...
const ACCENT = "#f43f5e";
const MODULE = "Experience Management (XM)";
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"2.593","t":"+6.2%","d":"up"},{"l":"Queries/Dia","v":"1905","t":"-3.2%","d":"down"},{"l":"Dados Processados (GB)","v":"3.148","t":"+4.3%","d":"up"},{"l":"Utilizadores Analytics","v":"5.527","t":"+2.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","207","2026-01-06","145","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4503","2026-01-14","2.612","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","291","2026-03-17","7.956","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4512","2026-01-09","2.814","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4457","2026-02-14","8.663","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":379},{"label":"Fev","value":545},{"label":"Mar","value":673},{"label":"Abr","value":367},{"label":"Mai","value":696},{"label":"Jun","value":406},{"label":"Jul","value":481},{"label":"Ago","value":469},{"label":"Set","value":470},{"label":"Out","value":435},{"label":"Nov","value":421},{"label":"Dez","value":445}];
const MX = 696;
