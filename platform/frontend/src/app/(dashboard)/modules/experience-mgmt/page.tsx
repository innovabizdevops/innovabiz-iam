...
/* ═══ Experience Management (XM) — Dashboard ═══ */

const ACCENT = "#f43f5e";

const KPIS = [
    { label: "Total Registos", value: "6111", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1343", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€197K", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "247783211", cells: ["EXP-5211", "Experience Management (XM) Item 1", "12/12/2026", "€33 311"], status: "active" as const },
    { id: "247786782", cells: ["EXP-8782", "Experience Management (XM) Item 2", "27/7/2026", "€36 882"], status: "pending" as const },
    { id: "247790353", cells: ["EXP-3353", "Experience Management (XM) Item 3", "14/2/2026", "€40 453"], status: "completed" as const },
    { id: "247793924", cells: ["EXP-6924", "Experience Management (XM) Item 4", "1/9/2026", "€44 024"], status: "warning" as const },
    { id: "247797495", cells: ["EXP-1495", "Experience Management (XM) Item 5", "16/4/2026", "€47 595"], status: "active" as const },
];
...
export default function ExperienceManagementXmPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Experience Management (XM)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Experience Management (XM)</p>
                    </div>
                </div>
