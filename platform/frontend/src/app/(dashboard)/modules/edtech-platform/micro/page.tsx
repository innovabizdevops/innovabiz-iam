...
const KPIS = [{"l":"Formulários Ativos","v":"3.704","t":"+6.3%","d":"up"},{"l":"Submissões/Dia","v":"2548","t":"+11.4%","d":"up"},{"l":"Documentos Gerados","v":"3.300","t":"+7.6%","d":"up"},{"l":"Templates","v":"2.744","t":"+14.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.370","2026-03-14","4.112","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.903","2026-01-12","3.308","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.400","2026-01-02","2.730","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.669","2026-01-17","8.430","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.025","2026-01-26","6.971","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":380},{"label":"Fev","value":605},{"label":"Mar","value":356},{"label":"Abr","value":458},{"label":"Mai","value":228},{"label":"Jun","value":491},{"label":"Jul","value":314},{"label":"Ago","value":361},{"label":"Set","value":311},{"label":"Out","value":546},{"label":"Nov","value":418},{"label":"Dez","value":508}];
const MX = 605;
