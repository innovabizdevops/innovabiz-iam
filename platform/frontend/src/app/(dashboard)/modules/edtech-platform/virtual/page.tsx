...
const KPIS = [{"l":"Formulários Ativos","v":"8.964","t":"-2.4%","d":"down"},{"l":"Submissões/Dia","v":"4890","t":"+3.0%","d":"up"},{"l":"Documentos Gerados","v":"1.489","t":"+4.8%","d":"up"},{"l":"Templates","v":"8.411","t":"+11.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.457","2026-02-09","8.090","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.625","2026-01-20","536","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.254","2026-02-21","6.713","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.405","2026-03-12","8.206","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.090","2026-01-13","8.711","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":431},{"label":"Mar","value":797},{"label":"Abr","value":432},{"label":"Mai","value":712},{"label":"Jun","value":734},{"label":"Jul","value":539},{"label":"Ago","value":747},{"label":"Set","value":653},{"label":"Out","value":424},{"label":"Nov","value":486},{"label":"Dez","value":773}];
const MX = 797;
