...
const KPIS = [{"l":"Formulários Ativos","v":"8.115","t":"+16.2%","d":"up"},{"l":"Submissões/Dia","v":"806","t":"+0.4%","d":"up"},{"l":"Documentos Gerados","v":"3.160","t":"-3.6%","d":"down"},{"l":"Templates","v":"6.734","t":"+11.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.268","2026-01-11","4.727","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.564","2026-02-17","364","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.973","2026-02-05","7.122","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.352","2026-02-20","3.579","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.334","2026-03-10","2.063","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":768},{"label":"Mar","value":612},{"label":"Abr","value":732},{"label":"Mai","value":502},{"label":"Jun","value":838},{"label":"Jul","value":864},{"label":"Ago","value":729},{"label":"Set","value":566},{"label":"Out","value":628},{"label":"Nov","value":559},{"label":"Dez","value":720}];
const MX = 864;
