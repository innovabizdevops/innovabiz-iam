...
const PAGE = "Adaptive Learning";
const KPIS = [{"l":"Formulários Ativos","v":"3.793","t":"-3.3%","d":"down"},{"l":"Submissões/Dia","v":"3846","t":"+3.5%","d":"up"},{"l":"Documentos Gerados","v":"3.436","t":"-1.6%","d":"down"},{"l":"Templates","v":"4.763","t":"+18.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","582","2026-03-16","7.175","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.571","2026-01-14","3.591","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.091","2026-02-12","8.280","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.684","2026-01-12","575","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.747","2026-02-22","3.193","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":493},{"label":"Mar","value":449},{"label":"Abr","value":596},{"label":"Mai","value":655},{"label":"Jun","value":407},{"label":"Jul","value":703},{"label":"Ago","value":605},{"label":"Set","value":642},{"label":"Out","value":585},{"label":"Nov","value":624},{"label":"Dez","value":380}];
const MX = 703;
