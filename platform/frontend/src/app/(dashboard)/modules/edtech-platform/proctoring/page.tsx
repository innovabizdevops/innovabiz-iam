...
const ACCENT = "#15803d";
const MODULE = "EdTech Platform";
const PAGE = "Proctoring AI";
const KPIS = [{"l":"Formulários Ativos","v":"1.766","t":"+0.2%","d":"up"},{"l":"Submissões/Dia","v":"2266","t":"+8.6%","d":"up"},{"l":"Documentos Gerados","v":"8.664","t":"+1.3%","d":"up"},{"l":"Templates","v":"4.307","t":"-2.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.796","2026-01-20","2.782","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.351","2026-01-15","6.353","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.436","2026-01-10","5.211","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.846","2026-01-21","1.617","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.371","2026-03-14","3.914","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":887},{"label":"Mar","value":814},{"label":"Abr","value":952},{"label":"Mai","value":694},{"label":"Jun","value":791},{"label":"Jul","value":1019},{"label":"Ago","value":872},{"label":"Set","value":926},{"label":"Out","value":948},{"label":"Nov","value":1030},{"label":"Dez","value":954}];
const MX = 1030;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#15803d'}}>AI</span></h1>
                </div>
