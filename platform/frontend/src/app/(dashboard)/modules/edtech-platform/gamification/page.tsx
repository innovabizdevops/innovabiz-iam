...
const PAGE = "Gamification Engine";
const KPIS = [{"l":"Formulários Ativos","v":"505","t":"+12.6%","d":"up"},{"l":"Submissões/Dia","v":"4325","t":"+13.4%","d":"up"},{"l":"Documentos Gerados","v":"884","t":"+5.8%","d":"up"},{"l":"Templates","v":"5.864","t":"+1.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.097","2026-01-10","1.350","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","342","2026-02-23","6.309","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.919","2026-03-07","4.187","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.190","2026-01-07","7.550","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.577","2026-02-06","5.446","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":935},{"label":"Fev","value":778},{"label":"Mar","value":680},{"label":"Abr","value":744},{"label":"Mai","value":721},{"label":"Jun","value":971},{"label":"Jul","value":658},{"label":"Ago","value":911},{"label":"Set","value":704},{"label":"Out","value":746},{"label":"Nov","value":1036},{"label":"Dez","value":969}];
const MX = 1036;
