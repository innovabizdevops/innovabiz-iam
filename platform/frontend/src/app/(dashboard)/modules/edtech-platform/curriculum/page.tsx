...
const PAGE = "Curriculum Designer";
const KPIS = [{"l":"Formulários Ativos","v":"2.284","t":"+16.6%","d":"up"},{"l":"Submissões/Dia","v":"3771","t":"-2.1%","d":"down"},{"l":"Documentos Gerados","v":"8.468","t":"+6.0%","d":"up"},{"l":"Templates","v":"3.242","t":"+1.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.771","2026-01-27","526","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","233","2026-02-14","690","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.806","2026-01-14","8.450","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.678","2026-01-12","1.479","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.657","2026-03-06","4.965","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":998},{"label":"Fev","value":709},{"label":"Mar","value":692},{"label":"Abr","value":743},{"label":"Mai","value":928},{"label":"Jun","value":885},{"label":"Jul","value":764},{"label":"Ago","value":993},{"label":"Set","value":828},{"label":"Out","value":998},{"label":"Nov","value":657},{"label":"Dez","value":901}];
const MX = 998;
