...
const PAGE = "Student Analytics";
const KPIS = [{"l":"Formulários Ativos","v":"3.373","t":"-3.6%","d":"down"},{"l":"Submissões/Dia","v":"4143","t":"+0.6%","d":"up"},{"l":"Documentos Gerados","v":"4.909","t":"+15.8%","d":"up"},{"l":"Templates","v":"6.637","t":"+10.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.337","2026-01-05","2.576","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.269","2026-02-13","4.465","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","865","2026-01-25","2.945","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","177","2026-01-11","4.526","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","429","2026-02-03","233","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":785},{"label":"Fev","value":819},{"label":"Mar","value":631},{"label":"Abr","value":856},{"label":"Mai","value":867},{"label":"Jun","value":689},{"label":"Jul","value":984},{"label":"Ago","value":727},{"label":"Set","value":692},{"label":"Out","value":766},{"label":"Nov","value":932},{"label":"Dez","value":727}];
const MX = 984;
