...
const PAGE = "Credentialing";
const KPIS = [{"l":"Formulários Ativos","v":"2.527","t":"+14.9%","d":"up"},{"l":"Submissões/Dia","v":"2117","t":"+16.4%","d":"up"},{"l":"Documentos Gerados","v":"5.568","t":"-2.2%","d":"down"},{"l":"Templates","v":"6.798","t":"+10.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.483","2026-02-08","4.550","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.971","2026-03-15","6.461","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.011","2026-02-28","3.312","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.668","2026-02-21","4.272","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.047","2026-03-07","2.383","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":526},{"label":"Mar","value":602},{"label":"Abr","value":600},{"label":"Mai","value":565},{"label":"Jun","value":548},{"label":"Jul","value":500},{"label":"Ago","value":668},{"label":"Set","value":513},{"label":"Out","value":590},{"label":"Nov","value":751},{"label":"Dez","value":507}];
const MX = 850;
