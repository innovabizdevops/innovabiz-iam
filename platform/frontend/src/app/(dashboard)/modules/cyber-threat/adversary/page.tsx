...
const PAGE = "Adversary Track";
const KPIS = [{"l":"Total Cyber Threat","v":"840","t":"+1.8%","d":"up"},{"l":"Adversary Track Ativos","v":"3.574","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"72.7%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"85","t":"-4.5%","d":"down"}];
const COLS = ["ID","Adversary Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cyber Threat #001","Cyber Threat #002","7.398","598","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Cyber Threat #002","Cyber Threat #003","3.697","2.756","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Cyber Threat #003","Cyber Threat #004","1.337","2.146","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Cyber Threat #004","Cyber Threat #005","2.061","7.730","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cyber Threat #005","Cyber Threat #001","6.040","8.370","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":432},{"label":"Fev","value":342},{"label":"Mar","value":611},{"label":"Abr","value":296},{"label":"Mai","value":572},{"label":"Jun","value":630},{"label":"Jul","value":640},{"label":"Ago","value":510},{"label":"Set","value":537},{"label":"Out","value":305},{"label":"Nov","value":595},{"label":"Dez","value":328}];
const MX = 640;
