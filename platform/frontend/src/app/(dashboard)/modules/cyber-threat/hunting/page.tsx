...
const ACCENT = "#dc2626";
const MODULE = "Cyber Threat Intel";
const PAGE = "Hunting Ops";
const KPIS = [{"l":"Total Cyber Threat","v":"3.621","t":"+1.3%","d":"up"},{"l":"Hunting Ops Ativos","v":"5.895","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"82.1%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"85","t":"-1.4%","d":"down"}];
const COLS = ["ID","Hunting Ops","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cyber Threat #001","Cyber Threat #002","7.033","4.558","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Cyber Threat #002","Cyber Threat #003","6.768","3.990","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Cyber Threat #003","Cyber Threat #004","5.222","1.061","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Cyber Threat #004","Cyber Threat #005","6.781","4.652","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cyber Threat #005","Cyber Threat #001","4.147","3.131","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":892},{"label":"Fev","value":891},{"label":"Mar","value":758},{"label":"Abr","value":705},{"label":"Mai","value":688},{"label":"Jun","value":856},{"label":"Jul","value":877},{"label":"Ago","value":894},{"label":"Set","value":883},{"label":"Out","value":609},{"label":"Nov","value":660},{"label":"Dez","value":608}];
const MX = 894;
