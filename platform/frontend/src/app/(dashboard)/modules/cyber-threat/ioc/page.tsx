...
const PAGE = "IOC Feed";
const KPIS = [{"l":"Total Cyber Threat","v":"8.785","t":"+18.0%","d":"up"},{"l":"IOC Feed Ativos","v":"119","t":"-3.9%","d":"down"},{"l":"Eficiência (%)","v":"78.8%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"85","t":"-0.4%","d":"down"}];
const COLS = ["ID","IOC Feed","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cyber Threat #001","Cyber Threat #002","7.894","8.386","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Cyber Threat #002","Cyber Threat #003","6.060","8.876","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Cyber Threat #003","Cyber Threat #004","2.919","8.432","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Cyber Threat #004","Cyber Threat #005","7.116","1.418","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cyber Threat #005","Cyber Threat #001","1.384","5.119","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":656},{"label":"Mar","value":739},{"label":"Abr","value":629},{"label":"Mai","value":597},{"label":"Jun","value":626},{"label":"Jul","value":614},{"label":"Ago","value":552},{"label":"Set","value":744},{"label":"Out","value":741},{"label":"Nov","value":822},{"label":"Dez","value":598}];
const MX = 822;
