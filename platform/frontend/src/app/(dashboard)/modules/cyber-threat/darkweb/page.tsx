...
const PAGE = "Dark Web Mon";
const KPIS = [{"l":"Total Cyber Threat","v":"7.914","t":"-3.6%","d":"down"},{"l":"Dark Web Mon Ativos","v":"2.674","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"75.9%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"69","t":"+7.1%","d":"up"}];
const COLS = ["ID","Dark Web Mon","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cyber Threat #001","Cyber Threat #002","7.505","6.587","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Cyber Threat #002","Cyber Threat #003","2.116","6.103","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Cyber Threat #003","Cyber Threat #004","3.557","4.208","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Cyber Threat #004","Cyber Threat #005","221","3.054","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cyber Threat #005","Cyber Threat #001","7.399","1.525","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":786},{"label":"Fev","value":488},{"label":"Mar","value":593},{"label":"Abr","value":454},{"label":"Mai","value":747},{"label":"Jun","value":549},{"label":"Jul","value":549},{"label":"Ago","value":813},{"label":"Set","value":733},{"label":"Out","value":698},{"label":"Nov","value":524},{"label":"Dez","value":497}];
const MX = 813;
