...
const PAGE = "APT Tracker";
const KPIS = [{"l":"Total Cyber Threat","v":"2.297","t":"+17.3%","d":"up"},{"l":"APT Tracker Ativos","v":"271","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"94.8%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"93","t":"+13.1%","d":"up"}];
const COLS = ["ID","APT Tracker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cyber Threat #001","Cyber Threat #002","7.856","6.359","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Cyber Threat #002","Cyber Threat #003","7.933","5.817","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Cyber Threat #003","Cyber Threat #004","4.217","210","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Cyber Threat #004","Cyber Threat #005","8.106","3.113","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cyber Threat #005","Cyber Threat #001","3.922","8.966","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":907},{"label":"Mar","value":772},{"label":"Abr","value":824},{"label":"Mai","value":590},{"label":"Jun","value":757},{"label":"Jul","value":881},{"label":"Ago","value":832},{"label":"Set","value":663},{"label":"Out","value":886},{"label":"Nov","value":596},{"label":"Dez","value":911}];
const MX = 911;
