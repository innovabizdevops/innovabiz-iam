...
const PAGE = "Ransomware Intel";
const KPIS = [{"l":"Total Cyber Threat","v":"8.106","t":"-0.3%","d":"down"},{"l":"Ransomware Intel Ativos","v":"3.498","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"65.1%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"83","t":"+17.2%","d":"up"}];
const COLS = ["ID","Ransomware Intel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cyber Threat #001","Cyber Threat #002","7.879","2.727","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Cyber Threat #002","Cyber Threat #003","7.602","8.951","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Cyber Threat #003","Cyber Threat #004","1.327","7.028","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Cyber Threat #004","Cyber Threat #005","2.898","2.106","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cyber Threat #005","Cyber Threat #001","785","4.684","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":889},{"label":"Mar","value":889},{"label":"Abr","value":778},{"label":"Mai","value":928},{"label":"Jun","value":555},{"label":"Jul","value":559},{"label":"Ago","value":721},{"label":"Set","value":697},{"label":"Out","value":807},{"label":"Nov","value":834},{"label":"Dez","value":875}];
const MX = 928;
