...
const KPIS = [{"l":"Surveys Ativos","v":"8.956","t":"+4.5%","d":"up"},{"l":"Respostas/Semana","v":"709","t":"+11.5%","d":"up"},{"l":"NPS Médio","v":"90","t":"+16.5%","d":"up"},{"l":"Taxa Resposta (%)","v":"77.7%","t":"+16.0%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","4.236","56","70.3%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","4.645","67","78.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","120","71","93.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","4.442","58","99.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","5.797","63","95.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":983},{"label":"Mar","value":950},{"label":"Abr","value":1025},{"label":"Mai","value":1007},{"label":"Jun","value":947},{"label":"Jul","value":716},{"label":"Ago","value":661},{"label":"Set","value":1021},{"label":"Out","value":691},{"label":"Nov","value":770},{"label":"Dez","value":820}];
const MX = 1025;
