...
const KPIS = [{"l":"Total Precision Ag","v":"1.598","t":"+1.4%","d":"up"},{"l":"Yield Maps Ativos","v":"2.316","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"68.3%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"61","t":"-1.0%","d":"down"}];
const COLS = ["ID","Yield Maps","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Precision Ag #001","Precision Ag #002","583","5.926","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Precision Ag #002","Precision Ag #003","873","3.593","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Precision Ag #003","Precision Ag #004","1.421","2.046","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Precision Ag #004","Precision Ag #005","3.034","4.286","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Precision Ag #005","Precision Ag #001","2.986","5.118","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":586},{"label":"Mar","value":682},{"label":"Abr","value":454},{"label":"Mai","value":540},{"label":"Jun","value":601},{"label":"Jul","value":604},{"label":"Ago","value":649},{"label":"Set","value":400},{"label":"Out","value":401},{"label":"Nov","value":374},{"label":"Dez","value":587}];
const MX = 682;
...
export default function YieldMapsPage() {
    return (
