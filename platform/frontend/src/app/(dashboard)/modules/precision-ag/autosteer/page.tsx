...
const PAGE = "Auto-Steer";
const KPIS = [{"l":"Total Precision Ag","v":"2.140","t":"+9.7%","d":"up"},{"l":"Auto Steer Ativos","v":"2.777","t":"+6.2%","d":"up"},{"l":"Eficiência (%)","v":"77.7%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"79","t":"+16.5%","d":"up"}];
const COLS = ["ID","Auto Steer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Precision Ag #001","Precision Ag #002","5.517","2.977","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Precision Ag #002","Precision Ag #003","6.179","537","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Precision Ag #003","Precision Ag #004","3.292","1.194","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Precision Ag #004","Precision Ag #005","8.548","2.063","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Precision Ag #005","Precision Ag #001","4.033","1.146","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":554},{"label":"Mar","value":719},{"label":"Abr","value":671},{"label":"Mai","value":645},{"label":"Jun","value":730},{"label":"Jul","value":636},{"label":"Ago","value":637},{"label":"Set","value":727},{"label":"Out","value":500},{"label":"Nov","value":542},{"label":"Dez","value":411}];
const MX = 730;
...
export default function AutosteerPage() {
    return (
