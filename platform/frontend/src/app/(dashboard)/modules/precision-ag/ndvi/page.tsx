...
const PAGE = "NDVI Mapping";
const KPIS = [{"l":"Total Precision Ag","v":"6.837","t":"+11.8%","d":"up"},{"l":"NDVI Mapping Ativos","v":"1.005","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"81.8%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"63","t":"+12.8%","d":"up"}];
const COLS = ["ID","NDVI Mapping","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Precision Ag #001","Precision Ag #002","2.491","4.046","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Precision Ag #002","Precision Ag #003","5.717","5.987","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Precision Ag #003","Precision Ag #004","9.096","6.447","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Precision Ag #004","Precision Ag #005","3.290","1.292","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Precision Ag #005","Precision Ag #001","2.758","8.283","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":652},{"label":"Mar","value":678},{"label":"Abr","value":482},{"label":"Mai","value":559},{"label":"Jun","value":431},{"label":"Jul","value":678},{"label":"Ago","value":680},{"label":"Set","value":580},{"label":"Out","value":676},{"label":"Nov","value":515},{"label":"Dez","value":438}];
const MX = 680;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4ade80'}}>AI</span></h1>
                </div>
