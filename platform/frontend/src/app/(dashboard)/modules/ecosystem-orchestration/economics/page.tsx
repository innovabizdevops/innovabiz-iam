...
const PAGE = "Platform Economics";
const KPIS = [{"l":"Formulários Ativos","v":"5.140","t":"+1.4%","d":"up"},{"l":"Submissões/Dia","v":"1998","t":"+14.7%","d":"up"},{"l":"Documentos Gerados","v":"617","t":"+10.1%","d":"up"},{"l":"Templates","v":"4.726","t":"-5.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.358","2026-01-17","466","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.266","2026-01-17","889","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.403","2026-03-04","346","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.579","2026-03-28","5.065","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.265","2026-02-19","7.554","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":780},{"label":"Fev","value":719},{"label":"Mar","value":664},{"label":"Abr","value":633},{"label":"Mai","value":649},{"label":"Jun","value":673},{"label":"Jul","value":463},{"label":"Ago","value":624},{"label":"Set","value":774},{"label":"Out","value":556},{"label":"Nov","value":444},{"label":"Dez","value":645}];
const MX = 780;
