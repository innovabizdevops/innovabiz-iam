...
const ACCENT = "#6d28d9";
const MODULE = "Ecosystem Orchestration";
const PAGE = "Partner Ecosystem Map";
const KPIS = [{"l":"Total Ecosystem Orchestration","v":"484","t":"-5.3%","d":"down"},{"l":"Partner Ecosystem Map Ativos","v":"1.598","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"72.5%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"91","t":"+13.7%","d":"up"}];
const COLS = ["ID","Partner Ecosystem Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ecosystem Orchestration #001","Ecosystem Orchestration #002","6.245","6.960","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Ecosystem Orchestration #002","Ecosystem Orchestration #003","5.002","5.583","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Ecosystem Orchestration #003","Ecosystem Orchestration #004","5.897","6.667","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Ecosystem Orchestration #004","Ecosystem Orchestration #005","2.353","4.399","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ecosystem Orchestration #005","Ecosystem Orchestration #001","4.551","7.014","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":739},{"label":"Mar","value":901},{"label":"Abr","value":817},{"label":"Mai","value":863},{"label":"Jun","value":855},{"label":"Jul","value":791},{"label":"Ago","value":700},{"label":"Set","value":959},{"label":"Out","value":598},{"label":"Nov","value":804},{"label":"Dez","value":622}];
const MX = 959;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6d28d9'}}>AI</span></h1>
                </div>
