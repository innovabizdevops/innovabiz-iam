...
const PAGE = "Marketplace Revenue";
const KPIS = [{"l":"Pedidos/Dia","v":"1579","t":"+6.3%","d":"up"},{"l":"GMV (€)","v":"€80713","t":"+3.0%","d":"up"},{"l":"Conversão (%)","v":"74.0%","t":"-3.6%","d":"down"},{"l":"AOV (€)","v":"€81234","t":"+3.7%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 20860.74","2.935","4.013","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 33346.46","3.275","2.819","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 22869.17","3.330","1.816","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 27472.79","1.386","5.786","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 49040.85","4.007","473","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":864},{"label":"Mar","value":581},{"label":"Abr","value":570},{"label":"Mai","value":737},{"label":"Jun","value":857},{"label":"Jul","value":690},{"label":"Ago","value":831},{"label":"Set","value":672},{"label":"Out","value":854},{"label":"Nov","value":521},{"label":"Dez","value":667}];
const MX = 864;
