...
const PAGE = "Revenue Share Engine";
const KPIS = [{"l":"ARR (€M)","v":"€10.2M","t":"+3.1%","d":"up"},{"l":"MRR (€)","v":"€38989","t":"-0.2%","d":"down"},{"l":"Churn (%)","v":"92.9%","t":"+8.3%","d":"up"},{"l":"ARPU (€)","v":"€21392","t":"-0.2%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 8535.01","1.447","€ 47492.06","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 2834.03","1.568","€ 35036.62","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 39262.52","6.922","€ 1888.73","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 45003.45","6.896","€ 1631.18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 5619.28","2.078","€ 21535.73","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":614},{"label":"Fev","value":262},{"label":"Mar","value":429},{"label":"Abr","value":613},{"label":"Mai","value":547},{"label":"Jun","value":285},{"label":"Jul","value":555},{"label":"Ago","value":437},{"label":"Set","value":404},{"label":"Out","value":290},{"label":"Nov","value":348},{"label":"Dez","value":395}];
const MX = 614;
