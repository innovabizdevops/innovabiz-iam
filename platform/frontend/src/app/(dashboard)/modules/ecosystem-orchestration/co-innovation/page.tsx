...
const PAGE = "Co-Innovation Hub";
const KPIS = [{"l":"Ideias Submetidas","v":"7.671","t":"-3.0%","d":"down"},{"l":"Patentes (YTD)","v":"7.659","t":"+10.4%","d":"up"},{"l":"Projetos Innovation Lab","v":"432","t":"-3.1%","d":"down"},{"l":"Budget I&D (€M)","v":"€45.5M","t":"+11.8%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","1.552","92.1%","9.011","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.382","79.1%","3.301","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.446","87.9%","4.187","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","8.642","76.4%","984","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.336","86.6%","4.376","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":310},{"label":"Fev","value":370},{"label":"Mar","value":461},{"label":"Abr","value":305},{"label":"Mai","value":434},{"label":"Jun","value":607},{"label":"Jul","value":298},{"label":"Ago","value":382},{"label":"Set","value":381},{"label":"Out","value":420},{"label":"Nov","value":617},{"label":"Dez","value":535}];
const MX = 617;
