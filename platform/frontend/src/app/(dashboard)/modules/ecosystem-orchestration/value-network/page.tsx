...
const PAGE = "Value Network Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"2.893","t":"-5.3%","d":"down"},{"l":"Queries/Dia","v":"2995","t":"+3.9%","d":"up"},{"l":"Dados Processados (GB)","v":"3.662","t":"+10.8%","d":"up"},{"l":"Utilizadores Analytics","v":"4.677","t":"+17.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3805","2026-02-04","4.216","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3600","2026-03-18","5.894","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3438","2026-03-20","7.651","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","205","2026-02-26","3.543","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4149","2026-03-17","3.406","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":416},{"label":"Mar","value":454},{"label":"Abr","value":592},{"label":"Mai","value":432},{"label":"Jun","value":719},{"label":"Jul","value":713},{"label":"Ago","value":672},{"label":"Set","value":461},{"label":"Out","value":664},{"label":"Nov","value":434},{"label":"Dez","value":535}];
const MX = 719;
...
export default function ValueNetworkPage() {
    return (
