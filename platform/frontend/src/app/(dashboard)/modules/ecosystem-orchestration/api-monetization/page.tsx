...
const PAGE = "API Monetization";
const KPIS = [{"l":"ARR (€M)","v":"€4.1M","t":"-6.0%","d":"down"},{"l":"MRR (€)","v":"€63299","t":"+16.3%","d":"up"},{"l":"Churn (%)","v":"68.6%","t":"-5.5%","d":"down"},{"l":"ARPU (€)","v":"€5306","t":"+15.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 25596.97","6.179","€ 2162.42","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 33776.49","5.642","€ 10058.02","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 21798.26","430","€ 42839.46","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 20708.40","8.399","€ 30043.71","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 20608.27","2.829","€ 27382.66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":294},{"label":"Fev","value":573},{"label":"Mar","value":420},{"label":"Abr","value":591},{"label":"Mai","value":360},{"label":"Jun","value":477},{"label":"Jul","value":287},{"label":"Ago","value":513},{"label":"Set","value":368},{"label":"Out","value":500},{"label":"Nov","value":292},{"label":"Dez","value":303}];
const MX = 591;
