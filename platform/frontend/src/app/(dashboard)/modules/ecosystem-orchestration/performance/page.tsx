...
const PAGE = "Partner Performance AI";
const KPIS = [{"l":"Formulários Ativos","v":"3.087","t":"-1.2%","d":"down"},{"l":"Submissões/Dia","v":"2852","t":"+14.5%","d":"up"},{"l":"Documentos Gerados","v":"6.877","t":"-0.8%","d":"down"},{"l":"Templates","v":"7.608","t":"-3.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.495","2026-03-18","6.842","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.447","2026-03-04","3.726","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.537","2026-03-25","6.005","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.097","2026-03-10","3.781","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.730","2026-03-17","5.859","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":737},{"label":"Mar","value":793},{"label":"Abr","value":516},{"label":"Mai","value":836},{"label":"Jun","value":765},{"label":"Jul","value":734},{"label":"Ago","value":869},{"label":"Set","value":797},{"label":"Out","value":744},{"label":"Nov","value":732},{"label":"Dez","value":658}];
const MX = 869;
