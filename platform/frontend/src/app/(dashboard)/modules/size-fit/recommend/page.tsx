...
const ACCENT = "#be185d";
const MODULE = "Size & Fit Technology";
const PAGE = "Recommend";
const KPIS = [{"l":"Total Size Fit","v":"5.293","t":"+17.3%","d":"up"},{"l":"Recommend Ativos","v":"877","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"91","t":"-1.3%","d":"down"}];
const COLS = ["ID","Recommend","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Size Fit #001","Size Fit #002","1.588","2.856","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Size Fit #002","Size Fit #003","1.181","2.657","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Size Fit #003","Size Fit #004","5.942","5.411","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Size Fit #004","Size Fit #005","3.161","3.187","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Size Fit #005","Size Fit #001","4.851","3.667","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":393},{"label":"Fev","value":567},{"label":"Mar","value":426},{"label":"Abr","value":577},{"label":"Mai","value":489},{"label":"Jun","value":556},{"label":"Jul","value":486},{"label":"Ago","value":569},{"label":"Set","value":380},{"label":"Out","value":319},{"label":"Nov","value":622},{"label":"Dez","value":324}];
const MX = 622;
