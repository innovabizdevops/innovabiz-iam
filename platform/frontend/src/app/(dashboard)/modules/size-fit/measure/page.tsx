...
const PAGE = "Measure";
const KPIS = [{"l":"Total Size Fit","v":"7.331","t":"+5.5%","d":"up"},{"l":"Measure Ativos","v":"4.160","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"84.9%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"60","t":"+3.4%","d":"up"}];
const COLS = ["ID","Measure","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Size Fit #001","Size Fit #002","8.058","5.994","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Size Fit #002","Size Fit #003","7.830","7.898","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Size Fit #003","Size Fit #004","585","1.848","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Size Fit #004","Size Fit #005","1.098","4.493","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Size Fit #005","Size Fit #001","9.030","4.139","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":863},{"label":"Fev","value":710},{"label":"Mar","value":936},{"label":"Abr","value":761},{"label":"Mai","value":728},{"label":"Jun","value":829},{"label":"Jul","value":964},{"label":"Ago","value":741},{"label":"Set","value":973},{"label":"Out","value":775},{"label":"Nov","value":703},{"label":"Dez","value":1046}];
const MX = 1046;
