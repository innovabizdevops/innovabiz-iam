...
const KPIS = [{"l":"Dashboards Ativos","v":"2.638","t":"+17.8%","d":"up"},{"l":"Queries/Dia","v":"3337","t":"+11.6%","d":"up"},{"l":"Dados Processados (GB)","v":"4.618","t":"+5.7%","d":"up"},{"l":"Utilizadores Analytics","v":"5.488","t":"+6.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2173","2026-03-18","8.050","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2815","2026-02-03","340","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3331","2026-03-24","7.314","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3423","2026-01-28","1.151","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5095","2026-02-12","6.437","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":516},{"label":"Mar","value":542},{"label":"Abr","value":590},{"label":"Mai","value":524},{"label":"Jun","value":846},{"label":"Jul","value":506},{"label":"Ago","value":777},{"label":"Set","value":799},{"label":"Out","value":794},{"label":"Nov","value":540},{"label":"Dez","value":878}];
const MX = 878;
