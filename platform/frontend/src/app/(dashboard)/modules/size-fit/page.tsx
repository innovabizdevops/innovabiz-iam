...
/* ═══ Size & Fit Technology — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "6456", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3471", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€453K", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "606203156", cells: ["SIZ-9156", "Size & Fit Technology Item 1", "21/9/2026", "€3256"], status: "active" as const },
    { id: "606206727", cells: ["SIZ-3727", "Size & Fit Technology Item 2", "8/4/2026", "€6827"], status: "pending" as const },
    { id: "606210298", cells: ["SIZ-7298", "Size & Fit Technology Item 3", "23/11/2026", "€10 398"], status: "completed" as const },
    { id: "606213869", cells: ["SIZ-1869", "Size & Fit Technology Item 4", "10/6/2026", "€13 969"], status: "warning" as const },
    { id: "606217440", cells: ["SIZ-5440", "Size & Fit Technology Item 5", "25/1/2026", "€17 540"], status: "active" as const },
];
...
export default function SizeFitTechnologyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Size & Fit Technology</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Size & Fit Technology</p>
                    </div>
                </div>
