...
const ACCENT = "#78350f";
const MODULE = "Council Minutes";
const PAGE = "Minutes Draft";
const KPIS = [{"l":"Total Council Minutes","v":"7.312","t":"-3.8%","d":"down"},{"l":"Minutes Draft Ativos","v":"4.709","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"94","t":"-3.4%","d":"down"}];
const COLS = ["ID","Minutes Draft","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Council Minutes #001","Council Minutes #002","4.498","3.377","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Council Minutes #002","Council Minutes #003","2.669","7.198","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Council Minutes #003","Council Minutes #004","4.193","5.098","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Council Minutes #004","Council Minutes #005","4.649","5.320","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Council Minutes #005","Council Minutes #001","4.742","8.603","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":917},{"label":"Fev","value":929},{"label":"Mar","value":682},{"label":"Abr","value":693},{"label":"Mai","value":586},{"label":"Jun","value":864},{"label":"Jul","value":963},{"label":"Ago","value":876},{"label":"Set","value":735},{"label":"Out","value":971},{"label":"Nov","value":633},{"label":"Dez","value":598}];
const MX = 971;
