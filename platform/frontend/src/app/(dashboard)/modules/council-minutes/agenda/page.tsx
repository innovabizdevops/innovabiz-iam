...
const PAGE = "Agenda Builder";
const KPIS = [{"l":"Teams Ativos","v":"8.640","t":"+15.6%","d":"up"},{"l":"Reuniões/Semana","v":"130","t":"+3.3%","d":"up"},{"l":"Mensagens/Dia","v":"2575","t":"+12.2%","d":"up"},{"l":"Ficheiros Partilhados","v":"236","t":"+9.7%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.342","1965","4.528","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","5.507","3160","5.889","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","8.213","4727","5.645","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.492","2544","1.723","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.904","3488","7.092","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":1001},{"label":"Mar","value":715},{"label":"Abr","value":823},{"label":"Mai","value":1068},{"label":"Jun","value":776},{"label":"Jul","value":1051},{"label":"Ago","value":1071},{"label":"Set","value":1053},{"label":"Out","value":1002},{"label":"Nov","value":952},{"label":"Dez","value":714}];
const MX = 1071;
