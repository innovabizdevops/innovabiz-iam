...
const PAGE = "Voting Record";
const KPIS = [{"l":"Total Council Minutes","v":"798","t":"+14.1%","d":"up"},{"l":"Voting Record Ativos","v":"2.683","t":"+13.4%","d":"up"},{"l":"Eficiência (%)","v":"90.0%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"57","t":"+7.7%","d":"up"}];
const COLS = ["ID","Voting Record","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Council Minutes #001","Council Minutes #002","3.803","3.143","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Council Minutes #002","Council Minutes #003","4.026","6.306","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Council Minutes #003","Council Minutes #004","7.569","1.208","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Council Minutes #004","Council Minutes #005","193","6.640","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Council Minutes #005","Council Minutes #001","6.542","585","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":862},{"label":"Mar","value":755},{"label":"Abr","value":761},{"label":"Mai","value":925},{"label":"Jun","value":697},{"label":"Jul","value":904},{"label":"Ago","value":923},{"label":"Set","value":873},{"label":"Out","value":669},{"label":"Nov","value":886},{"label":"Dez","value":981}];
const MX = 981;
