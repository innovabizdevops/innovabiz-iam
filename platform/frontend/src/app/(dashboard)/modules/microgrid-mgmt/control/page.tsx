...
const PAGE = "Control";
const KPIS = [{"l":"Total Microgrid Mgmt","v":"1.392","t":"+7.7%","d":"up"},{"l":"Control Ativos","v":"3.104","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"86.4%","t":"+14.0%","d":"up"},{"l":"Score Performance","v":"67","t":"-4.5%","d":"down"}];
const COLS = ["ID","Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Microgrid Mgmt #001","Microgrid Mgmt #002","8.405","5.484","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Microgrid Mgmt #002","Microgrid Mgmt #003","4.083","6.160","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Microgrid Mgmt #003","Microgrid Mgmt #004","3.050","3.431","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Microgrid Mgmt #004","Microgrid Mgmt #005","2.551","613","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Microgrid Mgmt #005","Microgrid Mgmt #001","7.865","8.434","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":849},{"label":"Fev","value":801},{"label":"Mar","value":932},{"label":"Abr","value":880},{"label":"Mai","value":682},{"label":"Jun","value":906},{"label":"Jul","value":803},{"label":"Ago","value":1032},{"label":"Set","value":801},{"label":"Out","value":653},{"label":"Nov","value":707},{"label":"Dez","value":773}];
const MX = 1032;
