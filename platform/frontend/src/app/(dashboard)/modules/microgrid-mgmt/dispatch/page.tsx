...
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"1.769","t":"+1.5%","d":"up"},{"l":"Viagens/Dia","v":"3863","t":"-2.5%","d":"down"},{"l":"Pontualidade (%)","v":"74.7%","t":"+8.9%","d":"up"},{"l":"Passageiros/Dia","v":"3768","t":"-3.5%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-16","2026-02-23","8.500","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-01","2026-03-04","1.270","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-24","2026-01-24","3.035","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-19","2026-03-16","4.661","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-12","2026-03-24","8.525","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":457},{"label":"Fev","value":741},{"label":"Mar","value":353},{"label":"Abr","value":671},{"label":"Mai","value":455},{"label":"Jun","value":502},{"label":"Jul","value":493},{"label":"Ago","value":518},{"label":"Set","value":548},{"label":"Out","value":594},{"label":"Nov","value":624},{"label":"Dez","value":700}];
const MX = 741;
