...
const PAGE = "Island Mode";
const KPIS = [{"l":"Tickets Abertos","v":"7.405","t":"+4.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"85.6%","t":"+4.6%","d":"up"},{"l":"MTTR (h)","v":"97h","t":"-5.1%","d":"down"},{"l":"Satisfação (%)","v":"84.7%","t":"+11.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.509","766","5.838","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.782","8.106","484","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.369","4.487","2.267","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.170","4.796","7.728","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.087","7.998","3.479","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":457},{"label":"Fev","value":486},{"label":"Mar","value":569},{"label":"Abr","value":672},{"label":"Mai","value":340},{"label":"Jun","value":662},{"label":"Jul","value":331},{"label":"Ago","value":327},{"label":"Set","value":415},{"label":"Out","value":439},{"label":"Nov","value":583},{"label":"Dez","value":328}];
const MX = 672;
