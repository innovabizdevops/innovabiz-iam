...
const PAGE = "PV+Wind";
const KPIS = [{"l":"Total Microgrid Mgmt","v":"744","t":"+16.0%","d":"up"},{"l":"PV+Wind Ativos","v":"7.220","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"73.9%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"83","t":"+2.4%","d":"up"}];
const COLS = ["ID","PV+Wind","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Microgrid Mgmt #001","Microgrid Mgmt #002","3.101","2.087","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Microgrid Mgmt #002","Microgrid Mgmt #003","1.625","4.724","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Microgrid Mgmt #003","Microgrid Mgmt #004","7.242","6.339","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Microgrid Mgmt #004","Microgrid Mgmt #005","7.758","7.835","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Microgrid Mgmt #005","Microgrid Mgmt #001","7.163","300","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":841},{"label":"Fev","value":858},{"label":"Mar","value":765},{"label":"Abr","value":677},{"label":"Mai","value":596},{"label":"Jun","value":844},{"label":"Jul","value":492},{"label":"Ago","value":693},{"label":"Set","value":531},{"label":"Out","value":537},{"label":"Nov","value":792},{"label":"Dez","value":494}];
const MX = 858;
