...
const ACCENT = "#6366f1";
const MODULE = "Microgrid Mgmt";
const PAGE = "Storage";
const KPIS = [{"l":"Total Microgrid Mgmt","v":"4.659","t":"+6.0%","d":"up"},{"l":"Storage Ativos","v":"834","t":"+10.0%","d":"up"},{"l":"Eficiência (%)","v":"78.0%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"78","t":"+10.4%","d":"up"}];
const COLS = ["ID","Storage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Microgrid Mgmt #001","Microgrid Mgmt #002","4.838","3.780","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Microgrid Mgmt #002","Microgrid Mgmt #003","3.698","3.919","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Microgrid Mgmt #003","Microgrid Mgmt #004","6.412","4.440","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Microgrid Mgmt #004","Microgrid Mgmt #005","8.396","5.445","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Microgrid Mgmt #005","Microgrid Mgmt #001","3.264","626","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":475},{"label":"Mar","value":291},{"label":"Abr","value":375},{"label":"Mai","value":400},{"label":"Jun","value":408},{"label":"Jul","value":582},{"label":"Ago","value":290},{"label":"Set","value":414},{"label":"Out","value":310},{"label":"Nov","value":389},{"label":"Dez","value":543}];
const MX = 582;
