...
const ACCENT = "#0284c7";
const MODULE = "SC: Core File Storage";
const PAGE = "Transform";
const KPIS = [{"l":"Formulários Ativos","v":"8.867","t":"-1.4%","d":"down"},{"l":"Submissões/Dia","v":"3021","t":"+0.2%","d":"up"},{"l":"Documentos Gerados","v":"3.782","t":"-2.8%","d":"down"},{"l":"Templates","v":"7.487","t":"+0.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","610","2026-01-24","4.806","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.506","2026-01-08","7.198","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.770","2026-03-28","2.888","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.075","2026-01-17","4.497","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.256","2026-01-18","7.536","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":413},{"label":"Fev","value":689},{"label":"Mar","value":312},{"label":"Abr","value":325},{"label":"Mai","value":521},{"label":"Jun","value":665},{"label":"Jul","value":555},{"label":"Ago","value":322},{"label":"Set","value":641},{"label":"Out","value":453},{"label":"Nov","value":633},{"label":"Dez","value":325}];
const MX = 689;
