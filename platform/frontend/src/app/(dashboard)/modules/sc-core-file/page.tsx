...
/* ═══ SC: Core File Storage — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "7084", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3881", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€98K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "-17%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2009241684", cells: ["SC-1684", "SC: Core File Storage Item 1", "17/1/2026", "€41 784"], status: "active" as const },
    { id: "2009245255", cells: ["SC-5255", "SC: Core File Storage Item 2", "4/8/2026", "€45 355"], status: "pending" as const },
    { id: "2009248826", cells: ["SC-8826", "SC: Core File Storage Item 3", "19/3/2026", "€48 926"], status: "completed" as const },
    { id: "2009252397", cells: ["SC-3397", "SC: Core File Storage Item 4", "6/10/2026", "€2497"], status: "warning" as const },
    { id: "2009255968", cells: ["SC-6968", "SC: Core File Storage Item 5", "21/5/2026", "€6068"], status: "active" as const },
];
...
export default function ScCoreFileStoragePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: Core File Storage</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: Core File Storage</p>
                    </div>
                </div>
