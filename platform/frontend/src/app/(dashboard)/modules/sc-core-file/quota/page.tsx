...
const PAGE = "Quota";
const KPIS = [{"l":"Vendas YTD (€)","v":"€35651","t":"+1.1%","d":"up"},{"l":"Pipeline (€)","v":"€26164","t":"+7.5%","d":"up"},{"l":"Atingimento Quota (%)","v":"71.7%","t":"+4.5%","d":"up"},{"l":"Win Rate (%)","v":"67.0%","t":"+1.1%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 7397.70","€ 18245.79","€ 2025.43","72.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 42020.48","€ 20012.29","€ 8166.15","96.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 48797.08","€ 33418.79","€ 3422.82","96.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 1014.16","€ 49436.67","€ 44272.78","74.7%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 42628.69","€ 46864.10","€ 3867.07","73.1%"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":428},{"label":"Mar","value":714},{"label":"Abr","value":446},{"label":"Mai","value":529},{"label":"Jun","value":678},{"label":"Jul","value":608},{"label":"Ago","value":681},{"label":"Set","value":584},{"label":"Out","value":716},{"label":"Nov","value":472},{"label":"Dez","value":420}];
const MX = 716;
