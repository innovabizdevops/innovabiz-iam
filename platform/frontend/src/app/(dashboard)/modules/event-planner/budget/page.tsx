...
const ACCENT = "#6366f1";
const MODULE = "Event Planning";
const PAGE = "Budget";
const KPIS = [{"l":"Eventos Planeados","v":"1.320","t":"+15.2%","d":"up"},{"l":"Participantes","v":"415","t":"+8.9%","d":"up"},{"l":"NPS Evento","v":"56","t":"-5.3%","d":"down"},{"l":"Receita (€)","v":"€33688","t":"+15.6%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-08","1.574","5.496","€ 40785.26","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-13","2.269","8.339","€ 27342.38","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-27","1.852","1.756","€ 43015.13","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-24","8.710","5.438","€ 7730.03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-23","6.797","5.663","€ 22768.21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":475},{"label":"Mar","value":557},{"label":"Abr","value":621},{"label":"Mai","value":549},{"label":"Jun","value":473},{"label":"Jul","value":376},{"label":"Ago","value":606},{"label":"Set","value":361},{"label":"Out","value":525},{"label":"Nov","value":729},{"label":"Dez","value":724}];
const MX = 729;
