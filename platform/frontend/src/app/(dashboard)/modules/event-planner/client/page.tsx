...
const PAGE = "Client";
const KPIS = [{"l":"Eventos Planeados","v":"5.331","t":"-2.1%","d":"down"},{"l":"Participantes","v":"6.067","t":"+11.8%","d":"up"},{"l":"NPS Evento","v":"77","t":"+1.6%","d":"up"},{"l":"Receita (€)","v":"€28147","t":"+8.7%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-12","2.482","3.240","€ 16660.81","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-06","1.603","8.058","€ 45116.34","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-19","4.956","8.121","€ 5229.89","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-10","4.207","3.196","€ 46286.79","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-26","9.029","6.132","€ 32852.04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":882},{"label":"Mar","value":673},{"label":"Abr","value":891},{"label":"Mai","value":905},{"label":"Jun","value":923},{"label":"Jul","value":856},{"label":"Ago","value":979},{"label":"Set","value":972},{"label":"Out","value":766},{"label":"Nov","value":943},{"label":"Dez","value":724}];
const MX = 979;
