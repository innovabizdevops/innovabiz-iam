...
const PAGE = "Reach &amp; Freq";
const KPIS = [{"l":"Total Audience Measure","v":"6.357","t":"-3.4%","d":"down"},{"l":"Reach & Freq Ativos","v":"8.660","t":"+4.8%","d":"up"},{"l":"Eficiência (%)","v":"65.2%","t":"+-0.0%","d":"up"},{"l":"Score Performance","v":"60","t":"+0.8%","d":"up"}];
const COLS = ["ID","Reach & Freq","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Audience Measure #001","Audience Measure #002","7.369","579","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Audience Measure #002","Audience Measure #003","7.783","6.863","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Audience Measure #003","Audience Measure #004","968","3.285","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Audience Measure #004","Audience Measure #005","6.210","8.831","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Audience Measure #005","Audience Measure #001","6.986","5.554","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":579},{"label":"Mar","value":673},{"label":"Abr","value":569},{"label":"Mai","value":821},{"label":"Jun","value":752},{"label":"Jul","value":697},{"label":"Ago","value":835},{"label":"Set","value":583},{"label":"Out","value":693},{"label":"Nov","value":707},{"label":"Dez","value":548}];
const MX = 835;
