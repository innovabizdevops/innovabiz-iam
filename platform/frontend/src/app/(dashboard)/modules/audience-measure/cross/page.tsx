...
const PAGE = "Cross-Platform";
const KPIS = [{"l":"Formulários Ativos","v":"7.739","t":"-4.3%","d":"down"},{"l":"Submissões/Dia","v":"3555","t":"+0.1%","d":"up"},{"l":"Documentos Gerados","v":"4.259","t":"+6.9%","d":"up"},{"l":"Templates","v":"3.090","t":"+12.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.375","2026-02-07","2.047","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.940","2026-02-14","5.836","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","590","2026-01-25","5.196","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.411","2026-02-06","1.982","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.905","2026-03-06","1.931","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":927},{"label":"Fev","value":1021},{"label":"Mar","value":712},{"label":"Abr","value":965},{"label":"Mai","value":1042},{"label":"Jun","value":1032},{"label":"Jul","value":742},{"label":"Ago","value":979},{"label":"Set","value":1060},{"label":"Out","value":757},{"label":"Nov","value":774},{"label":"Dez","value":728}];
const MX = 1060;
