...
const KPIS = [{"l":"Total Audience Measure","v":"2.175","t":"+2.1%","d":"up"},{"l":"Demographics Ativos","v":"2.681","t":"+13.0%","d":"up"},{"l":"Eficiência (%)","v":"75.3%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"75","t":"+2.7%","d":"up"}];
const COLS = ["ID","Demographics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Audience Measure #001","Audience Measure #002","5.144","5.547","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Audience Measure #002","Audience Measure #003","556","6.180","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Audience Measure #003","Audience Measure #004","5.985","4.220","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Audience Measure #004","Audience Measure #005","5.167","1.861","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Audience Measure #005","Audience Measure #001","6.930","7.973","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":484},{"label":"Mar","value":734},{"label":"Abr","value":530},{"label":"Mai","value":825},{"label":"Jun","value":500},{"label":"Jul","value":504},{"label":"Ago","value":517},{"label":"Set","value":797},{"label":"Out","value":791},{"label":"Nov","value":582},{"label":"Dez","value":816}];
const MX = 825;
