...
const ACCENT = "#0e7490";
const MODULE = "Audience Measurement";
const PAGE = "Digital Meter";
const KPIS = [{"l":"Total Audience Measure","v":"7.914","t":"-1.9%","d":"down"},{"l":"Digital Meter Ativos","v":"1.052","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"88.4%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"87","t":"+9.9%","d":"up"}];
const COLS = ["ID","Digital Meter","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Audience Measure #001","Audience Measure #002","4.586","5.676","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Audience Measure #002","Audience Measure #003","2.959","5.753","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Audience Measure #003","Audience Measure #004","5.879","7.518","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Audience Measure #004","Audience Measure #005","2.215","2.369","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Audience Measure #005","Audience Measure #001","6.602","4.475","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":454},{"label":"Fev","value":466},{"label":"Mar","value":526},{"label":"Abr","value":661},{"label":"Mai","value":480},{"label":"Jun","value":286},{"label":"Jul","value":435},{"label":"Ago","value":409},{"label":"Set","value":617},{"label":"Out","value":490},{"label":"Nov","value":415},{"label":"Dez","value":336}];
const MX = 661;
