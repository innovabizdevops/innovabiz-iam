...
const PAGE = "Compliance Check";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.564","t":"-5.1%","d":"down"},{"l":"NC Abertas","v":"201","t":"+12.0%","d":"up"},{"l":"Conformidade (%)","v":"70.4%","t":"-2.8%","d":"down"},{"l":"CAPAs Pendentes","v":"7.472","t":"+16.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.825","78.7%","6.242","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.404","78.9%","7.381","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.048","92.3%","7.080","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","803","81.0%","6.743","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.724","99.8%","8.898","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":257},{"label":"Fev","value":642},{"label":"Mar","value":436},{"label":"Abr","value":310},{"label":"Mai","value":446},{"label":"Jun","value":288},{"label":"Jul","value":529},{"label":"Ago","value":642},{"label":"Set","value":253},{"label":"Out","value":612},{"label":"Nov","value":504},{"label":"Dez","value":526}];
const MX = 642;
