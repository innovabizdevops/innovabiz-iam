...
const PAGE = "Performance SLA";
const KPIS = [{"l":"Tickets Abertos","v":"6.988","t":"+0.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"74.8%","t":"+4.6%","d":"up"},{"l":"MTTR (h)","v":"12h","t":"+6.1%","d":"up"},{"l":"Satisfação (%)","v":"81.2%","t":"+11.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.798","7.109","6.808","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.048","8.492","8.979","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.730","6.162","2.793","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.378","1.410","4.064","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","617","1.825","7.647","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":461},{"label":"Fev","value":649},{"label":"Mar","value":793},{"label":"Abr","value":520},{"label":"Mai","value":541},{"label":"Jun","value":707},{"label":"Jul","value":817},{"label":"Ago","value":828},{"label":"Set","value":691},{"label":"Out","value":588},{"label":"Nov","value":774},{"label":"Dez","value":705}];
const MX = 828;
