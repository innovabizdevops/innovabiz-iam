...
const KPIS = [{"l":"Projetos Melhoria","v":"134","t":"-2.6%","d":"down"},{"l":"Savings (€)","v":"€61828","t":"+8.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"80.1%","t":"+1.3%","d":"up"},{"l":"Ciclos PDCA","v":"1.598","t":"+16.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.378","€ 11800.51","541","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.001","€ 32538.14","4.640","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.031","€ 47179.14","2.394","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","839","€ 23339.68","3.626","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.908","€ 2583.13","7.096","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":538},{"label":"Mar","value":386},{"label":"Abr","value":475},{"label":"Mai","value":643},{"label":"Jun","value":680},{"label":"Jul","value":579},{"label":"Ago","value":348},{"label":"Set","value":615},{"label":"Out","value":324},{"label":"Nov","value":468},{"label":"Dez","value":674}];
const MX = 680;
