...
const PAGE = "Vendor Portal";
const KPIS = [{"l":"Projetos Melhoria","v":"7.372","t":"+13.3%","d":"up"},{"l":"Savings (€)","v":"€20521","t":"+8.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"87.7%","t":"+11.4%","d":"up"},{"l":"Ciclos PDCA","v":"2.445","t":"-6.0%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.828","€ 38045.31","950","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.077","€ 7578.35","5.634","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","209","€ 13764.83","2.053","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.271","€ 120.34","6.356","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.692","€ 6925.65","8.862","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":384},{"label":"Mar","value":631},{"label":"Abr","value":667},{"label":"Mai","value":476},{"label":"Jun","value":554},{"label":"Jul","value":486},{"label":"Ago","value":434},{"label":"Set","value":548},{"label":"Out","value":548},{"label":"Nov","value":474},{"label":"Dez","value":418}];
const MX = 667;
