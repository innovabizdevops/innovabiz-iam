...
const PAGE = "Supplier Sustainability";
const KPIS = [{"l":"Projetos Melhoria","v":"1.132","t":"+13.2%","d":"up"},{"l":"Savings (€)","v":"€15816","t":"+5.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"77.5%","t":"+15.0%","d":"up"},{"l":"Ciclos PDCA","v":"520","t":"-4.9%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.969","€ 46105.13","4.947","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.531","€ 49295.20","2.483","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.496","€ 22748.25","8.922","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.748","€ 28228.77","7.742","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.926","€ 15551.46","7.008","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":858},{"label":"Fev","value":773},{"label":"Mar","value":943},{"label":"Abr","value":680},{"label":"Mai","value":738},{"label":"Jun","value":711},{"label":"Jul","value":946},{"label":"Ago","value":896},{"label":"Set","value":734},{"label":"Out","value":709},{"label":"Nov","value":838},{"label":"Dez","value":1005}];
const MX = 1005;
