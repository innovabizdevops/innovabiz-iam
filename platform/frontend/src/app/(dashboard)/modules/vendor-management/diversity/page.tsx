...
const PAGE = "Diversity &amp; Inclusion";
const KPIS = [{"l":"Projetos Melhoria","v":"5.734","t":"+6.5%","d":"up"},{"l":"Savings (€)","v":"€87027","t":"-0.3%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"78.0%","t":"+16.9%","d":"up"},{"l":"Ciclos PDCA","v":"4.866","t":"-2.9%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.502","€ 17365.07","8.746","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.564","€ 12891.56","5.976","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.231","€ 40870.20","1.752","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.891","€ 18324.80","1.036","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.793","€ 32408.57","1.027","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":821},{"label":"Mar","value":977},{"label":"Abr","value":789},{"label":"Mai","value":789},{"label":"Jun","value":725},{"label":"Jul","value":907},{"label":"Ago","value":908},{"label":"Set","value":921},{"label":"Out","value":653},{"label":"Nov","value":896},{"label":"Dez","value":772}];
const MX = 977;
