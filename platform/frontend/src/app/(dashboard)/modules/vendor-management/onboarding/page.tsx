...
const PAGE = "Vendor Onboarding";
const KPIS = [{"l":"eNPS","v":"80","t":"+7.5%","d":"up"},{"l":"Engagement (%)","v":"81.7%","t":"-5.4%","d":"down"},{"l":"Turnover (%)","v":"67.7%","t":"+15.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"303","t":"-3.7%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.647","2026-03-08","65","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.651","2026-02-03","59","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.399","2026-02-13","76","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.353","2026-02-18","79","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.400","2026-02-11","81","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":629},{"label":"Mar","value":661},{"label":"Abr","value":443},{"label":"Mai","value":760},{"label":"Jun","value":405},{"label":"Jul","value":528},{"label":"Ago","value":532},{"label":"Set","value":698},{"label":"Out","value":532},{"label":"Nov","value":458},{"label":"Dez","value":600}];
const MX = 760;
