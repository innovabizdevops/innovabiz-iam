...
const PAGE = "Risk Assessment AI";
const KPIS = [{"l":"Riscos Identificados","v":"6.324","t":"-5.5%","d":"down"},{"l":"Mitigações Ativas","v":"7.689","t":"+16.1%","d":"up"},{"l":"Score Risco Geral","v":"92","t":"+7.7%","d":"up"},{"l":"Incidentes YTD","v":"5.830","t":"+1.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.847","7.596","528","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.531","2.900","7.555","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.362","1.654","1.104","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.160","6.084","5.875","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.742","591","3.339","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":544},{"label":"Mar","value":684},{"label":"Abr","value":726},{"label":"Mai","value":833},{"label":"Jun","value":574},{"label":"Jul","value":496},{"label":"Ago","value":841},{"label":"Set","value":779},{"label":"Out","value":480},{"label":"Nov","value":683},{"label":"Dez","value":644}];
const MX = 841;
