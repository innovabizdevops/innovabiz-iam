...
const PAGE = "Spend Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"212","t":"-3.1%","d":"down"},{"l":"Queries/Dia","v":"3738","t":"+13.4%","d":"up"},{"l":"Dados Processados (GB)","v":"6.167","t":"-1.3%","d":"down"},{"l":"Utilizadores Analytics","v":"6.394","t":"-0.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4089","2026-02-22","5.986","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4520","2026-03-18","4.455","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3189","2026-02-03","5.792","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3377","2026-01-28","2.768","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3024","2026-03-21","2.370","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":695},{"label":"Mar","value":945},{"label":"Abr","value":1001},{"label":"Mai","value":775},{"label":"Jun","value":925},{"label":"Jul","value":947},{"label":"Ago","value":729},{"label":"Set","value":1060},{"label":"Out","value":803},{"label":"Nov","value":1086},{"label":"Dez","value":1057}];
const MX = 1086;
