...
const PAGE = "Supplier Audits";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.495","t":"-1.7%","d":"down"},{"l":"NC Abertas","v":"2.283","t":"+10.4%","d":"up"},{"l":"Conformidade (%)","v":"73.6%","t":"-2.9%","d":"down"},{"l":"CAPAs Pendentes","v":"9.064","t":"+14.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.154","88.3%","1.579","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.808","80.3%","2.379","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.138","92.0%","6.929","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.278","88.2%","8.973","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.185","88.5%","6.387","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":644},{"label":"Mar","value":797},{"label":"Abr","value":662},{"label":"Mai","value":721},{"label":"Jun","value":744},{"label":"Jul","value":585},{"label":"Ago","value":531},{"label":"Set","value":871},{"label":"Out","value":841},{"label":"Nov","value":493},{"label":"Dez","value":486}];
const MX = 871;
