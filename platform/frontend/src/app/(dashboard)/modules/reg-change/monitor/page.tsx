...
const ACCENT = "#7c3aed";
const MODULE = "Regulatory Change";
const PAGE = "AI Monitor";
const KPIS = [{"l":"Total Reg Change","v":"2.680","t":"-0.5%","d":"down"},{"l":"AI Monitor Ativos","v":"3.973","t":"+15.8%","d":"up"},{"l":"Eficiência (%)","v":"80.7%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"67","t":"+4.5%","d":"up"}];
const COLS = ["ID","AI Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reg Change #001","Reg Change #002","5.480","472","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Reg Change #002","Reg Change #003","7.089","7.525","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Reg Change #003","Reg Change #004","7.047","6.176","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Reg Change #004","Reg Change #005","775","805","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reg Change #005","Reg Change #001","803","7.089","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":415},{"label":"Fev","value":377},{"label":"Mar","value":255},{"label":"Abr","value":344},{"label":"Mai","value":273},{"label":"Jun","value":437},{"label":"Jul","value":617},{"label":"Ago","value":579},{"label":"Set","value":608},{"label":"Out","value":350},{"label":"Nov","value":370},{"label":"Dez","value":612}];
const MX = 617;
