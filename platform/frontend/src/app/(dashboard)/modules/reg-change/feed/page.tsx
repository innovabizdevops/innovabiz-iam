...
const PAGE = "Change Feed";
const KPIS = [{"l":"Total Reg Change","v":"390","t":"-3.7%","d":"down"},{"l":"Change Feed Ativos","v":"7.005","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"90.0%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"61","t":"+5.7%","d":"up"}];
const COLS = ["ID","Change Feed","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reg Change #001","Reg Change #002","7.501","5.024","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Reg Change #002","Reg Change #003","8.104","8.334","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Reg Change #003","Reg Change #004","8.343","894","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Reg Change #004","Reg Change #005","6.345","6.917","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reg Change #005","Reg Change #001","624","7.279","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":419},{"label":"Mar","value":509},{"label":"Abr","value":572},{"label":"Mai","value":415},{"label":"Jun","value":563},{"label":"Jul","value":599},{"label":"Ago","value":571},{"label":"Set","value":443},{"label":"Out","value":600},{"label":"Nov","value":761},{"label":"Dez","value":624}];
const MX = 761;
