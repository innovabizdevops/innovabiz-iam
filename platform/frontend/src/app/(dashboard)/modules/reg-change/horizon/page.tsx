...
const KPIS = [{"l":"Total Reg Change","v":"3.234","t":"+18.0%","d":"up"},{"l":"Horizon Scan Ativos","v":"556","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"79.6%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"68","t":"-3.0%","d":"down"}];
const COLS = ["ID","Horizon Scan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reg Change #001","Reg Change #002","491","3.670","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Reg Change #002","Reg Change #003","6.462","997","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Reg Change #003","Reg Change #004","2.829","3.442","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Reg Change #004","Reg Change #005","2.515","7.612","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reg Change #005","Reg Change #001","8.701","3.511","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":474},{"label":"Fev","value":656},{"label":"Mar","value":572},{"label":"Abr","value":437},{"label":"Mai","value":624},{"label":"Jun","value":726},{"label":"Jul","value":566},{"label":"Ago","value":448},{"label":"Set","value":733},{"label":"Out","value":603},{"label":"Nov","value":508},{"label":"Dez","value":574}];
const MX = 733;
