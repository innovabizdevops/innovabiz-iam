...
const KPIS = [{"l":"Total Reg Change","v":"6.647","t":"+13.3%","d":"up"},{"l":"Action Items Ativos","v":"5.735","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"81.6%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"85","t":"-0.3%","d":"down"}];
const COLS = ["ID","Action Items","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reg Change #001","Reg Change #002","1.259","9.069","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Reg Change #002","Reg Change #003","792","1.507","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Reg Change #003","Reg Change #004","5.541","2.161","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Reg Change #004","Reg Change #005","5.269","2.266","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reg Change #005","Reg Change #001","8.975","5.029","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":806},{"label":"Fev","value":671},{"label":"Mar","value":665},{"label":"Abr","value":808},{"label":"Mai","value":609},{"label":"Jun","value":833},{"label":"Jul","value":567},{"label":"Ago","value":619},{"label":"Set","value":709},{"label":"Out","value":817},{"label":"Nov","value":514},{"label":"Dez","value":830}];
const MX = 833;
