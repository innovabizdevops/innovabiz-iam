...
const KPIS = [{"l":"Dashboards Ativos","v":"8.642","t":"+6.0%","d":"up"},{"l":"Queries/Dia","v":"937","t":"-1.4%","d":"down"},{"l":"Dados Processados (GB)","v":"7.084","t":"+3.2%","d":"up"},{"l":"Utilizadores Analytics","v":"2.780","t":"+1.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","732","2026-02-14","1.890","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","258","2026-02-03","6.487","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","845","2026-03-25","7.323","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4376","2026-02-15","4.692","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1958","2026-03-02","2.138","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":433},{"label":"Mar","value":520},{"label":"Abr","value":638},{"label":"Mai","value":711},{"label":"Jun","value":403},{"label":"Jul","value":386},{"label":"Ago","value":629},{"label":"Set","value":645},{"label":"Out","value":613},{"label":"Nov","value":521},{"label":"Dez","value":491}];
const MX = 711;
