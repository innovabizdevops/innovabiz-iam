...
/* ═══ Explosives Manufacturing — Dashboard ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total Registos", value: "5314", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2564", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€78K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1068264714", cells: ["EXP-1714", "Explosives Manufacturing Item 1", "7/7/2026", "€14 814"], status: "active" as const },
    { id: "1068268285", cells: ["EXP-5285", "Explosives Manufacturing Item 2", "22/2/2026", "€18 385"], status: "pending" as const },
    { id: "1068271856", cells: ["EXP-8856", "Explosives Manufacturing Item 3", "9/9/2026", "€21 956"], status: "completed" as const },
    { id: "1068275427", cells: ["EXP-3427", "Explosives Manufacturing Item 4", "24/4/2026", "€25 527"], status: "warning" as const },
    { id: "1068278998", cells: ["EXP-6998", "Explosives Manufacturing Item 5", "11/11/2026", "€29 098"], status: "active" as const },
];
...
export default function ExplosivesManufacturingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Explosives Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Explosives Manufacturing</p>
                    </div>
                </div>
