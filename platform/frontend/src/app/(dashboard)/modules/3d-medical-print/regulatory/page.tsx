...
const KPIS = [{"l":"Integrações Ativas","v":"6.605","t":"-0.7%","d":"down"},{"l":"Chamadas/Hora","v":"2135","t":"-2.6%","d":"down"},{"l":"Taxa Sucesso (%)","v":"85.9%","t":"-3.1%","d":"down"},{"l":"Latência Média (ms)","v":"112ms","t":"+12.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.985","2.812","79.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.742","8.994","85.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.295","9.017","85.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.597","372","78.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.746","3.485","98.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":742},{"label":"Mar","value":420},{"label":"Abr","value":744},{"label":"Mai","value":434},{"label":"Jun","value":747},{"label":"Jul","value":768},{"label":"Ago","value":687},{"label":"Set","value":439},{"label":"Out","value":466},{"label":"Nov","value":555},{"label":"Dez","value":504}];
const MX = 768;
