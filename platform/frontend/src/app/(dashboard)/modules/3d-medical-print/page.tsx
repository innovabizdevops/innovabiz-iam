...
/* ═══ Medical 3D Printing — Dashboard ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total Registos", value: "3104", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2728", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€344K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1061520604", cells: ["3D-7604", "Medical 3D Printing Item 1", "5/5/2026", "€20 704"], status: "active" as const },
    { id: "1061524175", cells: ["3D-2175", "Medical 3D Printing Item 2", "20/12/2026", "€24 275"], status: "pending" as const },
    { id: "1061527746", cells: ["3D-5746", "Medical 3D Printing Item 3", "7/7/2026", "€27 846"], status: "completed" as const },
    { id: "1061531317", cells: ["3D-9317", "Medical 3D Printing Item 4", "22/2/2026", "€31 417"], status: "warning" as const },
    { id: "1061534888", cells: ["3D-3888", "Medical 3D Printing Item 5", "9/9/2026", "€34 988"], status: "active" as const },
];
...
export default function Medical3dPrintingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Medical 3D Printing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Medical 3D Printing</p>
                    </div>
                </div>
