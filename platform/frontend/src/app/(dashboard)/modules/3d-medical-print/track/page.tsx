...
const PAGE = "Track";
const KPIS = [{"l":"Integrações Ativas","v":"6.550","t":"+3.9%","d":"up"},{"l":"Chamadas/Hora","v":"538","t":"+4.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"74.0%","t":"+13.5%","d":"up"},{"l":"Latência Média (ms)","v":"86ms","t":"+6.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.074","1.934","77.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.524","5.986","80.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.855","5.705","70.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.942","3.212","85.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.631","8.210","100.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":383},{"label":"Fev","value":552},{"label":"Mar","value":604},{"label":"Abr","value":605},{"label":"Mai","value":536},{"label":"Jun","value":506},{"label":"Jul","value":390},{"label":"Ago","value":401},{"label":"Set","value":507},{"label":"Out","value":434},{"label":"Nov","value":660},{"label":"Dez","value":458}];
const MX = 660;
