...
const ACCENT = "#3730a3";
const MODULE = "Medical 3D Printing";
const PAGE = "Model";
const KPIS = [{"l":"Integrações Ativas","v":"4.890","t":"+14.7%","d":"up"},{"l":"Chamadas/Hora","v":"2923","t":"-0.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"66.1%","t":"+15.8%","d":"up"},{"l":"Latência Média (ms)","v":"144ms","t":"-5.5%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.644","6.569","74.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.985","7.827","84.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.877","649","75.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.629","4.176","87.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","491","5.395","92.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":503},{"label":"Mar","value":681},{"label":"Abr","value":460},{"label":"Mai","value":571},{"label":"Jun","value":376},{"label":"Jul","value":470},{"label":"Ago","value":369},{"label":"Set","value":597},{"label":"Out","value":509},{"label":"Nov","value":651},{"label":"Dez","value":663}];
const MX = 681;
