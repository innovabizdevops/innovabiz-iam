...
const PAGE = "Implant";
const KPIS = [{"l":"Integrações Ativas","v":"8.022","t":"+1.4%","d":"up"},{"l":"Chamadas/Hora","v":"4825","t":"+8.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.6%","t":"+4.4%","d":"up"},{"l":"Latência Média (ms)","v":"45ms","t":"+0.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.110","7.893","77.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.056","1.462","73.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.204","6.908","89.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.635","6.776","82.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.056","4.724","77.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":540},{"label":"Mar","value":575},{"label":"Abr","value":492},{"label":"Mai","value":431},{"label":"Jun","value":672},{"label":"Jul","value":718},{"label":"Ago","value":549},{"label":"Set","value":345},{"label":"Out","value":504},{"label":"Nov","value":472},{"label":"Dez","value":443}];
const MX = 718;
