...
const PAGE = "Guide";
const KPIS = [{"l":"Integrações Ativas","v":"6.288","t":"+1.3%","d":"up"},{"l":"Chamadas/Hora","v":"4497","t":"+16.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"77.6%","t":"+17.6%","d":"up"},{"l":"Latência Média (ms)","v":"141ms","t":"+8.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.913","2.593","80.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.496","2.436","96.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.179","7.939","82.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.089","879","73.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.726","4.140","92.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":295},{"label":"Fev","value":246},{"label":"Mar","value":371},{"label":"Abr","value":418},{"label":"Mai","value":310},{"label":"Jun","value":584},{"label":"Jul","value":353},{"label":"Ago","value":547},{"label":"Set","value":298},{"label":"Out","value":493},{"label":"Nov","value":567},{"label":"Dez","value":387}];
const MX = 584;
