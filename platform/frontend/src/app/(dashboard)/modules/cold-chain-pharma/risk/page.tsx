...
const KPIS = [{"l":"Riscos Identificados","v":"4.864","t":"+9.1%","d":"up"},{"l":"Mitigações Ativas","v":"2.532","t":"+8.4%","d":"up"},{"l":"Score Risco Geral","v":"67","t":"+14.7%","d":"up"},{"l":"Incidentes YTD","v":"8.181","t":"+7.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.807","5.213","3.713","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.144","1.079","8.649","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","967","288","924","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.532","6.374","8.643","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.725","586","7.556","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":353},{"label":"Fev","value":610},{"label":"Mar","value":652},{"label":"Abr","value":286},{"label":"Mai","value":424},{"label":"Jun","value":451},{"label":"Jul","value":292},{"label":"Ago","value":567},{"label":"Set","value":636},{"label":"Out","value":652},{"label":"Nov","value":434},{"label":"Dez","value":313}];
const MX = 652;
