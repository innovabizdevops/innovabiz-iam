...
const ACCENT = "#4338ca";
const MODULE = "Cold Chain Pharma";
const PAGE = "Temp Monitor";
const KPIS = [{"l":"Total Cold Chain Pharma","v":"2.978","t":"+1.0%","d":"up"},{"l":"Temp Monitor Ativos","v":"5.834","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"71.2%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"90","t":"-2.3%","d":"down"}];
const COLS = ["ID","Temp Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cold Chain Pharma #001","Cold Chain Pharma #002","3.354","6.226","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Cold Chain Pharma #002","Cold Chain Pharma #003","3.136","780","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Cold Chain Pharma #003","Cold Chain Pharma #004","5.553","1.327","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Cold Chain Pharma #004","Cold Chain Pharma #005","7.935","1.215","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cold Chain Pharma #005","Cold Chain Pharma #001","6.676","7.993","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":587},{"label":"Mar","value":552},{"label":"Abr","value":485},{"label":"Mai","value":468},{"label":"Jun","value":479},{"label":"Jul","value":422},{"label":"Ago","value":602},{"label":"Set","value":255},{"label":"Out","value":514},{"label":"Nov","value":474},{"label":"Dez","value":384}];
const MX = 602;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>IoT</span></h1>
                </div>
