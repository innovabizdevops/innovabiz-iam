...
const PAGE = "Seat Inventory";
const KPIS = [{"l":"ARR (€M)","v":"€2.7M","t":"+7.8%","d":"up"},{"l":"MRR (€)","v":"€15002","t":"+4.2%","d":"up"},{"l":"Churn (%)","v":"74.7%","t":"+17.4%","d":"up"},{"l":"ARPU (€)","v":"€29793","t":"+7.4%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 49324.59","8.299","€ 21373.18","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 25319.15","8.182","€ 34172.91","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 32639.99","9.047","€ 12675.16","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 2621.02","8.607","€ 11384.77","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 48932.48","459","€ 7352.35","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":740},{"label":"Mar","value":613},{"label":"Abr","value":717},{"label":"Mai","value":756},{"label":"Jun","value":707},{"label":"Jul","value":584},{"label":"Ago","value":694},{"label":"Set","value":815},{"label":"Out","value":796},{"label":"Nov","value":825},{"label":"Dez","value":614}];
const MX = 825;
