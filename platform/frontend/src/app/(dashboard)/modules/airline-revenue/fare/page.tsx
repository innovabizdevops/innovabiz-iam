...
const PAGE = "Fare Class";
const KPIS = [{"l":"ARR (€M)","v":"€41.1M","t":"+14.6%","d":"up"},{"l":"MRR (€)","v":"€5879","t":"+5.4%","d":"up"},{"l":"Churn (%)","v":"67.3%","t":"+5.8%","d":"up"},{"l":"ARPU (€)","v":"€64355","t":"+10.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 2074.67","5.224","€ 49374.43","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 6089.59","4.972","€ 22731.01","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 32428.62","5.535","€ 47209.24","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 33302.79","6.277","€ 2394.73","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 48594.58","6.267","€ 15221.91","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":736},{"label":"Mar","value":734},{"label":"Abr","value":815},{"label":"Mai","value":781},{"label":"Jun","value":756},{"label":"Jul","value":849},{"label":"Ago","value":847},{"label":"Set","value":812},{"label":"Out","value":743},{"label":"Nov","value":939},{"label":"Dez","value":821}];
const MX = 939;
