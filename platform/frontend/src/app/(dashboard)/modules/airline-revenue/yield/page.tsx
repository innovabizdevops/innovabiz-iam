...
const ACCENT = "#b45309";
const MODULE = "Airline Revenue Mgmt";
const PAGE = "Yield Mgmt";
const KPIS = [{"l":"ARR (€M)","v":"€14.3M","t":"-4.8%","d":"down"},{"l":"MRR (€)","v":"€40352","t":"+13.2%","d":"up"},{"l":"Churn (%)","v":"70.5%","t":"+11.1%","d":"up"},{"l":"ARPU (€)","v":"€24062","t":"-5.4%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 47987.16","3.570","€ 13533.43","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 2684.90","7.289","€ 2994.22","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 3000.27","1.128","€ 2395.45","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 6014.84","5.276","€ 35313.73","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 16763.05","2.386","€ 16548.67","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":793},{"label":"Fev","value":773},{"label":"Mar","value":667},{"label":"Abr","value":689},{"label":"Mai","value":714},{"label":"Jun","value":815},{"label":"Jul","value":750},{"label":"Ago","value":730},{"label":"Set","value":655},{"label":"Out","value":593},{"label":"Nov","value":741},{"label":"Dez","value":701}];
const MX = 815;
