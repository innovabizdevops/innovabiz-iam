...
const PAGE = "NDC Channel";
const KPIS = [{"l":"ARR (€M)","v":"€2.2M","t":"+1.3%","d":"up"},{"l":"MRR (€)","v":"€84964","t":"-5.3%","d":"down"},{"l":"Churn (%)","v":"75.6%","t":"+5.0%","d":"up"},{"l":"ARPU (€)","v":"€41335","t":"+5.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 42225.15","7.440","€ 32060.75","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 15078.42","5.559","€ 37044.31","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 32180.00","2.720","€ 16756.09","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 42546.80","2.540","€ 11544.56","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 40149.93","4.121","€ 40642.81","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":703},{"label":"Mar","value":605},{"label":"Abr","value":520},{"label":"Mai","value":436},{"label":"Jun","value":560},{"label":"Jul","value":322},{"label":"Ago","value":679},{"label":"Set","value":477},{"label":"Out","value":348},{"label":"Nov","value":549},{"label":"Dez","value":621}];
const MX = 703;
