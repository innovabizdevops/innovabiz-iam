...
const KPIS = [{"l":"ARR (€M)","v":"€41.6M","t":"-1.1%","d":"down"},{"l":"MRR (€)","v":"€66128","t":"+2.0%","d":"up"},{"l":"Churn (%)","v":"72.7%","t":"-1.5%","d":"down"},{"l":"ARPU (€)","v":"€70830","t":"+2.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 18409.82","7.937","€ 14058.86","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 41898.86","4.519","€ 40266.34","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 14285.28","2.854","€ 23099.85","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 45400.77","8.489","€ 24634.19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 12111.53","7.320","€ 11072.04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":593},{"label":"Mar","value":792},{"label":"Abr","value":717},{"label":"Mai","value":504},{"label":"Jun","value":682},{"label":"Jul","value":504},{"label":"Ago","value":777},{"label":"Set","value":560},{"label":"Out","value":849},{"label":"Nov","value":693},{"label":"Dez","value":710}];
const MX = 849;
