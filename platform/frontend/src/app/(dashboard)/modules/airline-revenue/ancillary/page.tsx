...
const PAGE = "Ancillary";
const KPIS = [{"l":"ARR (€M)","v":"€37.5M","t":"+7.3%","d":"up"},{"l":"MRR (€)","v":"€97420","t":"+16.4%","d":"up"},{"l":"Churn (%)","v":"90.5%","t":"+5.3%","d":"up"},{"l":"ARPU (€)","v":"€62172","t":"+5.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 7548.06","7.931","€ 9969.02","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 17902.73","4.743","€ 11332.59","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 8970.15","7.088","€ 16668.55","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 29812.21","1.576","€ 35181.30","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 16189.35","5.005","€ 36379.80","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1023},{"label":"Fev","value":1052},{"label":"Mar","value":988},{"label":"Abr","value":966},{"label":"Mai","value":1093},{"label":"Jun","value":911},{"label":"Jul","value":1044},{"label":"Ago","value":808},{"label":"Set","value":822},{"label":"Out","value":878},{"label":"Nov","value":782},{"label":"Dez","value":1090}];
const MX = 1093;
