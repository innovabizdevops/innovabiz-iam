...
const PAGE = "Overbook Model";
const KPIS = [{"l":"ARR (€M)","v":"€9.4M","t":"+11.3%","d":"up"},{"l":"MRR (€)","v":"€79043","t":"+12.8%","d":"up"},{"l":"Churn (%)","v":"94.5%","t":"-2.1%","d":"down"},{"l":"ARPU (€)","v":"€64120","t":"+8.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 32947.38","7.037","€ 22209.32","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 38052.01","4.515","€ 47385.83","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 46432.28","112","€ 37956.59","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 38141.57","6.307","€ 15146.78","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 29360.46","6.043","€ 36656.93","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":557},{"label":"Mar","value":722},{"label":"Abr","value":671},{"label":"Mai","value":713},{"label":"Jun","value":690},{"label":"Jul","value":787},{"label":"Ago","value":589},{"label":"Set","value":653},{"label":"Out","value":598},{"label":"Nov","value":819},{"label":"Dez","value":719}];
const MX = 819;
