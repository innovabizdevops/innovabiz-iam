...
/* ═══ SSC Operations — Escalation Matrix ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "1783", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "249", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3055", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "92%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "303055765", cells: ["SSC-8765", "Escalation Matrix Item 1", "6/2/2026", "€5865"], status: "active" as const },
    { id: "303059336", cells: ["SSC-3336", "Escalation Matrix Item 2", "21/9/2026", "€9436"], status: "pending" as const },
    { id: "303062907", cells: ["SSC-6907", "Escalation Matrix Item 3", "8/4/2026", "€13 007"], status: "completed" as const },
    { id: "303066478", cells: ["SSC-1478", "Escalation Matrix Item 4", "23/11/2026", "€16 578"], status: "warning" as const },
    { id: "303070049", cells: ["SSC-5049", "Escalation Matrix Item 5", "10/6/2026", "€20 149"], status: "active" as const },
];
...
export default function SscOperationsEscalationMatrixPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Escalation Matrix</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">SSC Operations • Escalation Matrix</p>
                    </div>
                </div>
