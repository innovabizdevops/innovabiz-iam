...
/* ═══ SSC Operations — Knowledge Base ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "4271", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "302", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "956", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1627650602", cells: ["SSC-1602", "Knowledge Base Item 1", "19/3/2026", "€702"], status: "active" as const },
    { id: "1627654173", cells: ["SSC-5173", "Knowledge Base Item 2", "6/10/2026", "€4273"], status: "pending" as const },
    { id: "1627657744", cells: ["SSC-8744", "Knowledge Base Item 3", "21/5/2026", "€7844"], status: "completed" as const },
    { id: "1627661315", cells: ["SSC-3315", "Knowledge Base Item 4", "8/12/2026", "€11 415"], status: "warning" as const },
    { id: "1627664886", cells: ["SSC-6886", "Knowledge Base Item 5", "23/7/2026", "€14 986"], status: "active" as const },
];
...
export default function SscOperationsKnowledgeBasePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Knowledge Base</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">SSC Operations • Knowledge Base</p>
                    </div>
                </div>
