...
/* ═══ SSC Operations — Reporting Hub ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "3537", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "120", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3138", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "492021716", cells: ["SSC-1716", "Reporting Hub Item 1", "5/9/2026", "€21 816"], status: "active" as const },
    { id: "492025287", cells: ["SSC-5287", "Reporting Hub Item 2", "20/4/2026", "€25 387"], status: "pending" as const },
    { id: "492028858", cells: ["SSC-8858", "Reporting Hub Item 3", "7/11/2026", "€28 958"], status: "completed" as const },
    { id: "492032429", cells: ["SSC-3429", "Reporting Hub Item 4", "22/6/2026", "€32 529"], status: "warning" as const },
    { id: "492036000", cells: ["SSC-7000", "Reporting Hub Item 5", "9/1/2026", "€36 100"], status: "active" as const },
];
...
export default function SscOperationsReportingHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Reporting Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">SSC Operations • Reporting Hub</p>
                    </div>
                </div>
