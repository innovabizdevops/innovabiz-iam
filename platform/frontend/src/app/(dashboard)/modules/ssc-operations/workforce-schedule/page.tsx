...
/* ═══ SSC Operations — Workforce Schedule ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "4878", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "184", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2498", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1039011572", cells: ["SSC-7572", "Workforce Schedule Item 1", "5/9/2026", "€11 672"], status: "active" as const },
    { id: "1039015143", cells: ["SSC-2143", "Workforce Schedule Item 2", "20/4/2026", "€15 243"], status: "pending" as const },
    { id: "1039018714", cells: ["SSC-5714", "Workforce Schedule Item 3", "7/11/2026", "€18 814"], status: "completed" as const },
    { id: "1039022285", cells: ["SSC-9285", "Workforce Schedule Item 4", "22/6/2026", "€22 385"], status: "warning" as const },
    { id: "1039025856", cells: ["SSC-3856", "Workforce Schedule Item 5", "9/1/2026", "€25 956"], status: "active" as const },
];
...
export default function SscOperationsWorkforceSchedulePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Workforce Schedule</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">SSC Operations • Workforce Schedule</p>
                    </div>
                </div>
