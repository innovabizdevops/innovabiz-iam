...
/* ═══ SSC Operations — Training Center ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "4071", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "224", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1765", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1174269820", cells: ["SSC-4820", "Training Center Item 1", "25/5/2026", "€19 920"], status: "active" as const },
    { id: "1174273391", cells: ["SSC-8391", "Training Center Item 2", "12/12/2026", "€23 491"], status: "pending" as const },
    { id: "1174276962", cells: ["SSC-2962", "Training Center Item 3", "27/7/2026", "€27 062"], status: "completed" as const },
    { id: "1174280533", cells: ["SSC-6533", "Training Center Item 4", "14/2/2026", "€30 633"], status: "warning" as const },
    { id: "1174284104", cells: ["SSC-1104", "Training Center Item 5", "1/9/2026", "€34 204"], status: "active" as const },
];
...
export default function SscOperationsTrainingCenterPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Training Center</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">SSC Operations • Training Center</p>
                    </div>
                </div>
