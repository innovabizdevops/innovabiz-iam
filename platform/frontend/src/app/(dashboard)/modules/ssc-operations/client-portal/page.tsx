...
/* ═══ SSC Operations — Client Portal ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "26", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "362", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2587", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "395850038", cells: ["SSC-4038", "Client Portal Item 1", "11/3/2026", "€138"], status: "active" as const },
    { id: "395853609", cells: ["SSC-7609", "Client Portal Item 2", "26/10/2026", "€3709"], status: "pending" as const },
    { id: "395857180", cells: ["SSC-2180", "Client Portal Item 3", "13/5/2026", "€7280"], status: "completed" as const },
    { id: "395860751", cells: ["SSC-5751", "Client Portal Item 4", "28/12/2026", "€10 851"], status: "warning" as const },
    { id: "395864322", cells: ["SSC-9322", "Client Portal Item 5", "15/7/2026", "€14 422"], status: "active" as const },
];
...
export default function SscOperationsClientPortalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Client Portal</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">SSC Operations • Client Portal</p>
                    </div>
                </div>
