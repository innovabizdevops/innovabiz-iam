...
export default function SscOperationsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">SSC Operations</h1><p className="text-sm text-muted-foreground">SSC Operations — iBOS Enterprise</p></div>
