...
/* ═══ SSC Operations — Quality Monitor ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "1221", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "486", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "949", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "659948834", cells: ["SSC-6834", "Quality Monitor Item 1", "7/3/2026", "€48 934"], status: "active" as const },
    { id: "659952405", cells: ["SSC-1405", "Quality Monitor Item 2", "22/10/2026", "€2505"], status: "pending" as const },
    { id: "659955976", cells: ["SSC-4976", "Quality Monitor Item 3", "9/5/2026", "€6076"], status: "completed" as const },
    { id: "659959547", cells: ["SSC-8547", "Quality Monitor Item 4", "24/12/2026", "€9647"], status: "warning" as const },
    { id: "659963118", cells: ["SSC-3118", "Quality Monitor Item 5", "11/7/2026", "€13 218"], status: "active" as const },
];
...
export default function SscOperationsQualityMonitorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Quality Monitor</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">SSC Operations • Quality Monitor</p>
                    </div>
                </div>
