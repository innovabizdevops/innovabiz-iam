...
/* ═══ SSC Operations — Ticket Mgmt ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "1404", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "162", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1844", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "172772350", cells: ["SSC-9350", "Ticket Mgmt Item 1", "3/11/2026", "€22 450"], status: "active" as const },
    { id: "172775921", cells: ["SSC-3921", "Ticket Mgmt Item 2", "18/6/2026", "€26 021"], status: "pending" as const },
    { id: "172779492", cells: ["SSC-7492", "Ticket Mgmt Item 3", "5/1/2026", "€29 592"], status: "completed" as const },
    { id: "172783063", cells: ["SSC-2063", "Ticket Mgmt Item 4", "20/8/2026", "€33 163"], status: "warning" as const },
    { id: "172786634", cells: ["SSC-5634", "Ticket Mgmt Item 5", "7/3/2026", "€36 734"], status: "active" as const },
];
...
export default function SscOperationsTicketMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ticket Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">SSC Operations • Ticket Mgmt</p>
                    </div>
                </div>
