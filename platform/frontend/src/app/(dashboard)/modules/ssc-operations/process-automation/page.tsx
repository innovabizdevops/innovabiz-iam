...
/* ═══ SSC Operations — Process Automation ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "580", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "291", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3100", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "200291551", cells: ["SSC-6551", "Process Automation Item 1", "20/8/2026", "€41 651"], status: "active" as const },
    { id: "200295122", cells: ["SSC-1122", "Process Automation Item 2", "7/3/2026", "€45 222"], status: "pending" as const },
    { id: "200298693", cells: ["SSC-4693", "Process Automation Item 3", "22/10/2026", "€48 793"], status: "completed" as const },
    { id: "200302264", cells: ["SSC-8264", "Process Automation Item 4", "9/5/2026", "€2364"], status: "warning" as const },
    { id: "200305835", cells: ["SSC-2835", "Process Automation Item 5", "24/12/2026", "€5935"], status: "active" as const },
];
...
export default function SscOperationsProcessAutomationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Process Automation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">SSC Operations • Process Automation</p>
                    </div>
                </div>
