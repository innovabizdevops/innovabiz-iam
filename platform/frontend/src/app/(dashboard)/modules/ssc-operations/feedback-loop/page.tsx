...
/* ═══ SSC Operations — Feedback Loop ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "485", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "332", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "616", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1892197688", cells: ["SSC-2688", "Feedback Loop Item 1", "25/9/2026", "€47 788"], status: "active" as const },
    { id: "1892201259", cells: ["SSC-6259", "Feedback Loop Item 2", "12/4/2026", "€1359"], status: "pending" as const },
    { id: "1892204830", cells: ["SSC-9830", "Feedback Loop Item 3", "27/11/2026", "€4930"], status: "completed" as const },
    { id: "1892208401", cells: ["SSC-4401", "Feedback Loop Item 4", "14/6/2026", "€8501"], status: "warning" as const },
    { id: "1892211972", cells: ["SSC-7972", "Feedback Loop Item 5", "1/1/2026", "€12 072"], status: "active" as const },
];
...
export default function SscOperationsFeedbackLoopPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Feedback Loop</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">SSC Operations • Feedback Loop</p>
                    </div>
                </div>
