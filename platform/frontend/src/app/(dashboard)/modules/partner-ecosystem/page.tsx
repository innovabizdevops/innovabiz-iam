...
/* ═══ Partner Ecosystem Platform — Dashboard ═══ */

const ACCENT = "#f43f5e";

const KPIS = [
    { label: "Total Registos", value: "5186", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3659", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€129K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "780946786", cells: ["PAR-8786", "Partner Ecosystem Platform Item 1", "19/11/2026", "€46 886"], status: "active" as const },
    { id: "780950357", cells: ["PAR-3357", "Partner Ecosystem Platform Item 2", "6/6/2026", "€457"], status: "pending" as const },
    { id: "780953928", cells: ["PAR-6928", "Partner Ecosystem Platform Item 3", "21/1/2026", "€4028"], status: "completed" as const },
    { id: "780957499", cells: ["PAR-1499", "Partner Ecosystem Platform Item 4", "8/8/2026", "€7599"], status: "warning" as const },
    { id: "780961070", cells: ["PAR-5070", "Partner Ecosystem Platform Item 5", "23/3/2026", "€11 170"], status: "active" as const },
];
...
export default function PartnerEcosystemPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Partner Ecosystem Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Partner Ecosystem Platform</p>
                    </div>
                </div>
