...
const PAGE = "Incentive";
const KPIS = [{"l":"Vendas YTD (€)","v":"€95565","t":"-3.9%","d":"down"},{"l":"Pipeline (€)","v":"€73016","t":"+9.4%","d":"up"},{"l":"Atingimento Quota (%)","v":"72.3%","t":"-4.5%","d":"down"},{"l":"Win Rate (%)","v":"82.5%","t":"-4.4%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 32379.77","€ 15844.34","€ 40920.54","84.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 28051.63","€ 45191.46","€ 3550.16","94.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 10844.21","€ 5974.06","€ 27657.24","79.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 3852.27","€ 44863.08","€ 47411.63","76.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 44738.81","€ 15665.77","€ 12138.39","74.3%"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":620},{"label":"Mar","value":734},{"label":"Abr","value":590},{"label":"Mai","value":625},{"label":"Jun","value":712},{"label":"Jul","value":641},{"label":"Ago","value":738},{"label":"Set","value":596},{"label":"Out","value":636},{"label":"Nov","value":732},{"label":"Dez","value":421}];
const MX = 738;
