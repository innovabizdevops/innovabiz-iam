...
const KPIS = [{"l":"Total Dock Schedule","v":"526","t":"+9.7%","d":"up"},{"l":"Turnaround Ativos","v":"834","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"80.8%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"90","t":"-4.5%","d":"down"}];
const COLS = ["ID","Turnaround","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dock Schedule #001","Dock Schedule #002","7.924","1.668","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Dock Schedule #002","Dock Schedule #003","835","1.953","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Dock Schedule #003","Dock Schedule #004","3.792","1.660","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Dock Schedule #004","Dock Schedule #005","7.651","3.145","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dock Schedule #005","Dock Schedule #001","2.270","197","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":308},{"label":"Fev","value":305},{"label":"Mar","value":548},{"label":"Abr","value":316},{"label":"Mai","value":607},{"label":"Jun","value":561},{"label":"Jul","value":571},{"label":"Ago","value":415},{"label":"Set","value":292},{"label":"Out","value":622},{"label":"Nov","value":359},{"label":"Dez","value":505}];
const MX = 622;
