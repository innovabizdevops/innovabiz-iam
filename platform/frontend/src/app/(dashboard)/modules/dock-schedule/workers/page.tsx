...
const ACCENT = "#059669";
const MODULE = "Dock Scheduling";
const PAGE = "Worker Assign";
const KPIS = [{"l":"Total Dock Schedule","v":"7.478","t":"+9.2%","d":"up"},{"l":"Worker Assign Ativos","v":"3.483","t":"+1.5%","d":"up"},{"l":"Eficiência (%)","v":"67.5%","t":"+4.7%","d":"up"},{"l":"Score Performance","v":"86","t":"+2.4%","d":"up"}];
const COLS = ["ID","Worker Assign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dock Schedule #001","Dock Schedule #002","4.258","8.079","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Dock Schedule #002","Dock Schedule #003","2.658","2.163","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Dock Schedule #003","Dock Schedule #004","7.248","6.694","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Dock Schedule #004","Dock Schedule #005","3.177","1.328","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dock Schedule #005","Dock Schedule #001","106","8.462","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":885},{"label":"Fev","value":910},{"label":"Mar","value":791},{"label":"Abr","value":853},{"label":"Mai","value":672},{"label":"Jun","value":958},{"label":"Jul","value":824},{"label":"Ago","value":1033},{"label":"Set","value":791},{"label":"Out","value":996},{"label":"Nov","value":809},{"label":"Dez","value":844}];
const MX = 1033;
