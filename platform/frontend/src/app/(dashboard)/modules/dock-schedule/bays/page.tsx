...
const PAGE = "Bay Assign";
const KPIS = [{"l":"Total Dock Schedule","v":"8.021","t":"+6.4%","d":"up"},{"l":"Bay Assign Ativos","v":"8.770","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"85.2%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"77","t":"+8.9%","d":"up"}];
const COLS = ["ID","Bay Assign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dock Schedule #001","Dock Schedule #002","8.200","5.010","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Dock Schedule #002","Dock Schedule #003","3.017","2.282","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Dock Schedule #003","Dock Schedule #004","4.821","4.896","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Dock Schedule #004","Dock Schedule #005","7.308","4.929","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dock Schedule #005","Dock Schedule #001","5.977","6.038","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":790},{"label":"Fev","value":526},{"label":"Mar","value":494},{"label":"Abr","value":548},{"label":"Mai","value":704},{"label":"Jun","value":787},{"label":"Jul","value":488},{"label":"Ago","value":786},{"label":"Set","value":702},{"label":"Out","value":427},{"label":"Nov","value":607},{"label":"Dez","value":563}];
const MX = 790;
