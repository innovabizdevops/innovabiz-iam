...
const KPIS = [{"l":"Total Dock Schedule","v":"4.200","t":"-3.2%","d":"down"},{"l":"Appointment Ativos","v":"4.231","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"76.4%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"61","t":"-3.7%","d":"down"}];
const COLS = ["ID","Appointment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dock Schedule #001","Dock Schedule #002","1.761","7.029","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Dock Schedule #002","Dock Schedule #003","7.165","8.429","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Dock Schedule #003","Dock Schedule #004","3.898","4.672","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Dock Schedule #004","Dock Schedule #005","8.323","6.149","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dock Schedule #005","Dock Schedule #001","1.390","1.549","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":296},{"label":"Fev","value":341},{"label":"Mar","value":415},{"label":"Abr","value":437},{"label":"Mai","value":345},{"label":"Jun","value":636},{"label":"Jul","value":577},{"label":"Ago","value":321},{"label":"Set","value":658},{"label":"Out","value":496},{"label":"Nov","value":493},{"label":"Dez","value":571}];
const MX = 658;
