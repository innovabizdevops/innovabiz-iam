...
const PAGE = "Wait Time";
const KPIS = [{"l":"Total Dock Schedule","v":"5.746","t":"+4.3%","d":"up"},{"l":"Wait Time Ativos","v":"7.445","t":"+6.2%","d":"up"},{"l":"Eficiência (%)","v":"89.8%","t":"+4.2%","d":"up"},{"l":"Score Performance","v":"87","t":"+15.3%","d":"up"}];
const COLS = ["ID","Wait Time","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dock Schedule #001","Dock Schedule #002","413","5.645","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Dock Schedule #002","Dock Schedule #003","2.566","2.579","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Dock Schedule #003","Dock Schedule #004","5.296","2.044","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Dock Schedule #004","Dock Schedule #005","4.852","985","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dock Schedule #005","Dock Schedule #001","1.298","644","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":692},{"label":"Mar","value":676},{"label":"Abr","value":653},{"label":"Mai","value":725},{"label":"Jun","value":463},{"label":"Jul","value":511},{"label":"Ago","value":747},{"label":"Set","value":633},{"label":"Out","value":743},{"label":"Nov","value":586},{"label":"Dez","value":699}];
const MX = 747;
