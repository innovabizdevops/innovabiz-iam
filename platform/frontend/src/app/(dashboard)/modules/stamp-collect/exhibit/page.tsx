...
const ACCENT = "#ca8a04";
const MODULE = "Stamp Collecting";
const PAGE = "Exhibit";
const KPIS = [{"l":"Total Stamp Collect","v":"8.489","t":"-4.4%","d":"down"},{"l":"Exhibit Ativos","v":"4.192","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"81.1%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"84","t":"+17.6%","d":"up"}];
const COLS = ["ID","Exhibit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stamp Collect #001","Stamp Collect #002","2.638","6.832","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Stamp Collect #002","Stamp Collect #003","4.663","1.919","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Stamp Collect #003","Stamp Collect #004","3.547","2.735","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Stamp Collect #004","Stamp Collect #005","4.782","3.694","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stamp Collect #005","Stamp Collect #001","7.316","6.083","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":1038},{"label":"Mar","value":812},{"label":"Abr","value":650},{"label":"Mai","value":735},{"label":"Jun","value":936},{"label":"Jul","value":718},{"label":"Ago","value":711},{"label":"Set","value":768},{"label":"Out","value":851},{"label":"Nov","value":835},{"label":"Dez","value":864}];
const MX = 1038;
