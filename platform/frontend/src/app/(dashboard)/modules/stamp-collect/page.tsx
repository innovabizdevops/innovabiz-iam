...
/* ═══ Stamp Collecting — Dashboard ═══ */

const ACCENT = "#ca8a04";

const KPIS = [
    { label: "Total Registos", value: "4019", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1631", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€307K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "501914119", cells: ["STA-3119", "Stamp Collecting Item 1", "8/8/2026", "€14 219"], status: "active" as const },
    { id: "501917690", cells: ["STA-6690", "Stamp Collecting Item 2", "23/3/2026", "€17 790"], status: "pending" as const },
    { id: "501921261", cells: ["STA-1261", "Stamp Collecting Item 3", "10/10/2026", "€21 361"], status: "completed" as const },
    { id: "501924832", cells: ["STA-4832", "Stamp Collecting Item 4", "25/5/2026", "€24 932"], status: "warning" as const },
    { id: "501928403", cells: ["STA-8403", "Stamp Collecting Item 5", "12/12/2026", "€28 503"], status: "active" as const },
];
...
export default function StampCollectingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Stamp Collecting</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Stamp Collecting</p>
                    </div>
                </div>
