...
const PAGE = "Trade";
const KPIS = [{"l":"Total Stamp Collect","v":"3.296","t":"-2.2%","d":"down"},{"l":"Trade Ativos","v":"3.304","t":"+10.6%","d":"up"},{"l":"Eficiência (%)","v":"90.3%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"58","t":"+14.6%","d":"up"}];
const COLS = ["ID","Trade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stamp Collect #001","Stamp Collect #002","3.083","5.530","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Stamp Collect #002","Stamp Collect #003","4.158","5.965","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Stamp Collect #003","Stamp Collect #004","5.281","1.865","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Stamp Collect #004","Stamp Collect #005","2.192","7.491","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stamp Collect #005","Stamp Collect #001","7.166","1.448","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":584},{"label":"Fev","value":323},{"label":"Mar","value":418},{"label":"Abr","value":463},{"label":"Mai","value":509},{"label":"Jun","value":500},{"label":"Jul","value":472},{"label":"Ago","value":533},{"label":"Set","value":505},{"label":"Out","value":353},{"label":"Nov","value":439},{"label":"Dez","value":496}];
const MX = 584;
