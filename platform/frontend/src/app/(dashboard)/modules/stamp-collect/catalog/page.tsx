...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"359","t":"+2.0%","d":"up"},{"l":"Queries/Dia","v":"274","t":"+11.4%","d":"up"},{"l":"Dados Processados (GB)","v":"5.376","t":"+0.0%","d":"up"},{"l":"Utilizadores Analytics","v":"6.908","t":"+16.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2828","2026-02-15","4.964","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","280","2026-02-10","6.865","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3668","2026-03-21","8.667","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2904","2026-01-12","5.689","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1503","2026-03-01","551","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":708},{"label":"Mar","value":475},{"label":"Abr","value":623},{"label":"Mai","value":700},{"label":"Jun","value":806},{"label":"Jul","value":804},{"label":"Ago","value":525},{"label":"Set","value":478},{"label":"Out","value":514},{"label":"Nov","value":596},{"label":"Dez","value":778}];
const MX = 806;
