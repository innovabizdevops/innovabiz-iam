...
const PAGE = "Grade";
const KPIS = [{"l":"Total Stamp Collect","v":"2.748","t":"+9.3%","d":"up"},{"l":"Grade Ativos","v":"150","t":"+10.4%","d":"up"},{"l":"Eficiência (%)","v":"83.2%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"89","t":"+9.4%","d":"up"}];
const COLS = ["ID","Grade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stamp Collect #001","Stamp Collect #002","3.986","5.928","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Stamp Collect #002","Stamp Collect #003","5.516","6.461","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Stamp Collect #003","Stamp Collect #004","6.010","3.699","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Stamp Collect #004","Stamp Collect #005","1.313","5.710","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stamp Collect #005","Stamp Collect #001","3.932","7.849","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":522},{"label":"Mar","value":811},{"label":"Abr","value":628},{"label":"Mai","value":485},{"label":"Jun","value":462},{"label":"Jul","value":647},{"label":"Ago","value":802},{"label":"Set","value":492},{"label":"Out","value":707},{"label":"Nov","value":486},{"label":"Dez","value":587}];
const MX = 811;
