...
const PAGE = "Appraise";
const KPIS = [{"l":"Total Stamp Collect","v":"4.651","t":"-4.0%","d":"down"},{"l":"Appraise Ativos","v":"6.537","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"67.7%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"67","t":"+15.5%","d":"up"}];
const COLS = ["ID","Appraise","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stamp Collect #001","Stamp Collect #002","3.239","748","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Stamp Collect #002","Stamp Collect #003","980","6.127","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Stamp Collect #003","Stamp Collect #004","3.344","7.035","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Stamp Collect #004","Stamp Collect #005","229","8.968","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stamp Collect #005","Stamp Collect #001","5.780","2.197","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":861},{"label":"Mar","value":819},{"label":"Abr","value":767},{"label":"Mai","value":783},{"label":"Jun","value":530},{"label":"Jul","value":657},{"label":"Ago","value":754},{"label":"Set","value":768},{"label":"Out","value":794},{"label":"Nov","value":666},{"label":"Dez","value":864}];
const MX = 864;
