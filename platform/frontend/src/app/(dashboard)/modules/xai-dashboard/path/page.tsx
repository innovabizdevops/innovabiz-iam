...
const PAGE = "Decision Path";
const KPIS = [{"l":"Aprovações Pendentes","v":"1.078","t":"+15.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"74.1%","t":"+14.5%","d":"up"},{"l":"Tempo Médio (h)","v":"141h","t":"+-0.0%","d":"up"},{"l":"Rejeitadas (%)","v":"68.5%","t":"+10.8%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","944","€ 34341.84","3.365","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","3.842","€ 3089.18","1.923","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","7.894","€ 24176.57","5.459","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","1.650","€ 18032.00","3.996","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","423","€ 15790.41","7.884","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":358},{"label":"Mar","value":615},{"label":"Abr","value":407},{"label":"Mai","value":377},{"label":"Jun","value":245},{"label":"Jul","value":403},{"label":"Ago","value":423},{"label":"Set","value":360},{"label":"Out","value":322},{"label":"Nov","value":507},{"label":"Dez","value":368}];
const MX = 618;
