...
const PAGE = "Compare";
const KPIS = [{"l":"Teams Ativos","v":"990","t":"-1.2%","d":"down"},{"l":"Reuniões/Semana","v":"360","t":"+13.6%","d":"up"},{"l":"Mensagens/Dia","v":"943","t":"+9.5%","d":"up"},{"l":"Ficheiros Partilhados","v":"8.300","t":"-3.8%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","3.457","173","5.514","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","529","2503","4.257","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.469","4416","2.565","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.107","4467","5.961","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","8.120","3629","4.404","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":876},{"label":"Mar","value":692},{"label":"Abr","value":919},{"label":"Mai","value":886},{"label":"Jun","value":546},{"label":"Jul","value":867},{"label":"Ago","value":697},{"label":"Set","value":787},{"label":"Out","value":660},{"label":"Nov","value":571},{"label":"Dez","value":615}];
const MX = 919;
