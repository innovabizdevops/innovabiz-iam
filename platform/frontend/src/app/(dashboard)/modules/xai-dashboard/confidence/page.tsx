...
const ACCENT = "#d97706";
const MODULE = "XAI Transparency Dashboard";
const PAGE = "Confidence";
const KPIS = [{"l":"Teams Ativos","v":"2.828","t":"+9.9%","d":"up"},{"l":"Reuniões/Semana","v":"321","t":"+16.3%","d":"up"},{"l":"Mensagens/Dia","v":"2949","t":"-0.5%","d":"down"},{"l":"Ficheiros Partilhados","v":"428","t":"+4.8%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.005","3696","6.587","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.787","3973","413","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","3.523","226","597","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.226","936","5.446","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.648","2059","7.084","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":348},{"label":"Fev","value":548},{"label":"Mar","value":480},{"label":"Abr","value":583},{"label":"Mai","value":550},{"label":"Jun","value":624},{"label":"Jul","value":677},{"label":"Ago","value":644},{"label":"Set","value":518},{"label":"Out","value":360},{"label":"Nov","value":458},{"label":"Dez","value":616}];
const MX = 677;
