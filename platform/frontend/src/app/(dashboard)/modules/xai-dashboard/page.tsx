...
/* ═══ XAI Transparency Dashboard — Dashboard ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total Registos", value: "5134", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "362", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€147K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "-17%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "928605234", cells: ["XAI-4234", "XAI Transparency Dashboard Item 1", "19/7/2026", "€5334"], status: "active" as const },
    { id: "928608805", cells: ["XAI-7805", "XAI Transparency Dashboard Item 2", "6/2/2026", "€8905"], status: "pending" as const },
    { id: "928612376", cells: ["XAI-2376", "XAI Transparency Dashboard Item 3", "21/9/2026", "€12 476"], status: "completed" as const },
    { id: "928615947", cells: ["XAI-5947", "XAI Transparency Dashboard Item 4", "8/4/2026", "€16 047"], status: "warning" as const },
    { id: "928619518", cells: ["XAI-9518", "XAI Transparency Dashboard Item 5", "23/11/2026", "€19 618"], status: "active" as const },
];
...
export default function XaiTransparencyDashboardPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">XAI Transparency Dashboard</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • XAI Transparency Dashboard</p>
                    </div>
                </div>
