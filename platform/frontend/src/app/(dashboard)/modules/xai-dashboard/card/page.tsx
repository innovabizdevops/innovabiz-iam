...
const PAGE = "Model Card";
const KPIS = [{"l":"Teams Ativos","v":"736","t":"-5.1%","d":"down"},{"l":"Reuniões/Semana","v":"4704","t":"+13.2%","d":"up"},{"l":"Mensagens/Dia","v":"4331","t":"+14.2%","d":"up"},{"l":"Ficheiros Partilhados","v":"116","t":"+0.5%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","1.836","920","3.855","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.364","1038","5.373","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.512","1282","5.301","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","6.436","1730","1.211","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","680","3414","2.994","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":534},{"label":"Mar","value":607},{"label":"Abr","value":786},{"label":"Mai","value":552},{"label":"Jun","value":443},{"label":"Jul","value":515},{"label":"Ago","value":462},{"label":"Set","value":394},{"label":"Out","value":625},{"label":"Nov","value":622},{"label":"Dez","value":574}];
const MX = 786;
