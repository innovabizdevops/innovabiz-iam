...
const PAGE = "API Gateway";
const KPIS = [{"l":"Integrações Ativas","v":"6.730","t":"+0.5%","d":"up"},{"l":"Chamadas/Hora","v":"1778","t":"+1.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"76.0%","t":"+6.0%","d":"up"},{"l":"Latência Média (ms)","v":"108ms","t":"+0.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.345","2.490","73.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.108","7.220","81.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.107","199","71.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.704","2.387","89.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.548","5.973","85.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":453},{"label":"Mar","value":472},{"label":"Abr","value":407},{"label":"Mai","value":439},{"label":"Jun","value":592},{"label":"Jul","value":372},{"label":"Ago","value":506},{"label":"Set","value":622},{"label":"Out","value":546},{"label":"Nov","value":474},{"label":"Dez","value":307}];
const MX = 638;
