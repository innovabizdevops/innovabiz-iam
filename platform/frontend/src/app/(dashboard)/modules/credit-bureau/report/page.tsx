...
const PAGE = "Report Bureau";
const KPIS = [{"l":"Integrações Ativas","v":"3.933","t":"+1.9%","d":"up"},{"l":"Chamadas/Hora","v":"4562","t":"+13.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"77.3%","t":"-1.5%","d":"down"},{"l":"Latência Média (ms)","v":"103ms","t":"+11.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.191","8.911","85.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.853","8.578","71.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.405","5.681","96.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","169","5.364","83.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.641","8.530","91.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":654},{"label":"Mar","value":677},{"label":"Abr","value":377},{"label":"Mai","value":466},{"label":"Jun","value":414},{"label":"Jul","value":468},{"label":"Ago","value":585},{"label":"Set","value":665},{"label":"Out","value":462},{"label":"Nov","value":341},{"label":"Dez","value":695}];
const MX = 695;
