...
const ACCENT = "#1e40af";
const MODULE = "Bureaux de Crédito";
const PAGE = "Fraud Detect";
const KPIS = [{"l":"Integrações Ativas","v":"7.030","t":"+4.5%","d":"up"},{"l":"Chamadas/Hora","v":"3318","t":"+16.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"76.9%","t":"+13.5%","d":"up"},{"l":"Latência Média (ms)","v":"56ms","t":"+14.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.808","4.732","73.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.073","1.215","83.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.154","5.589","84.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.315","2.906","89.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.741","4.975","84.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":905},{"label":"Fev","value":717},{"label":"Mar","value":792},{"label":"Abr","value":666},{"label":"Mai","value":576},{"label":"Jun","value":910},{"label":"Jul","value":623},{"label":"Ago","value":823},{"label":"Set","value":824},{"label":"Out","value":932},{"label":"Nov","value":610},{"label":"Dez","value":633}];
const MX = 932;
