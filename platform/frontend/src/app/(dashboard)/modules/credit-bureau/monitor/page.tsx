...
const KPIS = [{"l":"Integrações Ativas","v":"6.815","t":"+12.7%","d":"up"},{"l":"Chamadas/Hora","v":"169","t":"+6.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"73.3%","t":"-0.1%","d":"down"},{"l":"Latência Média (ms)","v":"20ms","t":"+5.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.279","6.115","98.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.282","5.359","74.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.856","354","100.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.856","8.185","71.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.254","8.487","73.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":648},{"label":"Mar","value":793},{"label":"Abr","value":784},{"label":"Mai","value":852},{"label":"Jun","value":715},{"label":"Jul","value":633},{"label":"Ago","value":676},{"label":"Set","value":762},{"label":"Out","value":768},{"label":"Nov","value":876},{"label":"Dez","value":757}];
const MX = 876;
