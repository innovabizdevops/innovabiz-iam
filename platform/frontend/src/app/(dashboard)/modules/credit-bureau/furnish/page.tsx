...
const PAGE = "Data Furnish";
const KPIS = [{"l":"Integrações Ativas","v":"4.347","t":"+7.8%","d":"up"},{"l":"Chamadas/Hora","v":"2144","t":"+8.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"89.0%","t":"-0.2%","d":"down"},{"l":"Latência Média (ms)","v":"167ms","t":"+4.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.072","7.647","80.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.835","145","75.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.577","6.438","96.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.753","3.388","84.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.018","1.589","97.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":461},{"label":"Fev","value":595},{"label":"Mar","value":530},{"label":"Abr","value":465},{"label":"Mai","value":342},{"label":"Jun","value":331},{"label":"Jul","value":649},{"label":"Ago","value":505},{"label":"Set","value":289},{"label":"Out","value":635},{"label":"Nov","value":361},{"label":"Dez","value":532}];
const MX = 649;
