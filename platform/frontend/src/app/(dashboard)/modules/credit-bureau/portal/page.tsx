...
const PAGE = "Consumer Portal";
const KPIS = [{"l":"Integrações Ativas","v":"2.266","t":"-3.3%","d":"down"},{"l":"Chamadas/Hora","v":"4942","t":"+14.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"89.8%","t":"+10.3%","d":"up"},{"l":"Latência Média (ms)","v":"74ms","t":"+9.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.492","4.434","90.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","400","1.285","84.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.060","7.093","89.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.147","8.116","73.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.395","8.288","85.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":726},{"label":"Mar","value":733},{"label":"Abr","value":671},{"label":"Mai","value":857},{"label":"Jun","value":841},{"label":"Jul","value":485},{"label":"Ago","value":766},{"label":"Set","value":519},{"label":"Out","value":510},{"label":"Nov","value":786},{"label":"Dez","value":555}];
const MX = 857;
