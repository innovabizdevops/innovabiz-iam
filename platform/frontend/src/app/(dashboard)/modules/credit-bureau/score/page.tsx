...
const PAGE = "Score Engine";
const KPIS = [{"l":"Integrações Ativas","v":"2.622","t":"+9.2%","d":"up"},{"l":"Chamadas/Hora","v":"321","t":"+5.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"91.1%","t":"+13.7%","d":"up"},{"l":"Latência Média (ms)","v":"47ms","t":"+16.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.050","2.454","91.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.785","7.339","91.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.768","5.429","70.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.924","7.374","96.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.758","6.371","95.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":497},{"label":"Mar","value":620},{"label":"Abr","value":478},{"label":"Mai","value":487},{"label":"Jun","value":568},{"label":"Jul","value":649},{"label":"Ago","value":648},{"label":"Set","value":347},{"label":"Out","value":670},{"label":"Nov","value":272},{"label":"Dez","value":274}];
const MX = 670;
