...
const KPIS = [{"l":"Integrações Ativas","v":"7.429","t":"-3.4%","d":"down"},{"l":"Chamadas/Hora","v":"3379","t":"+0.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"78.7%","t":"+10.7%","d":"up"},{"l":"Latência Média (ms)","v":"24ms","t":"+5.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.499","3.298","93.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.822","5.362","71.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.184","7.835","94.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.762","8.569","81.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.338","1.383","94.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":637},{"label":"Mar","value":530},{"label":"Abr","value":500},{"label":"Mai","value":514},{"label":"Jun","value":818},{"label":"Jul","value":557},{"label":"Ago","value":787},{"label":"Set","value":612},{"label":"Out","value":675},{"label":"Nov","value":680},{"label":"Dez","value":501}];
const MX = 818;
