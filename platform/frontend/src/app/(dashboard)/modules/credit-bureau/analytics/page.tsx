...
const KPIS = [{"l":"Dashboards Ativos","v":"2.947","t":"+3.4%","d":"up"},{"l":"Queries/Dia","v":"4657","t":"+17.0%","d":"up"},{"l":"Dados Processados (GB)","v":"8.514","t":"+5.3%","d":"up"},{"l":"Utilizadores Analytics","v":"2.486","t":"-5.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3529","2026-01-26","3.611","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4391","2026-01-21","2.981","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1755","2026-03-21","4.581","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1648","2026-02-21","5.232","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2602","2026-02-14","6.044","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":569},{"label":"Mar","value":677},{"label":"Abr","value":478},{"label":"Mai","value":428},{"label":"Jun","value":675},{"label":"Jul","value":612},{"label":"Ago","value":602},{"label":"Set","value":350},{"label":"Out","value":319},{"label":"Nov","value":408},{"label":"Dez","value":631}];
const MX = 677;
