...
const PAGE = "Quiz";
const KPIS = [{"l":"Total Lms K12","v":"6.640","t":"+12.8%","d":"up"},{"l":"Quiz Ativos","v":"6.064","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"65.2%","t":"+2.5%","d":"up"},{"l":"Score Performance","v":"55","t":"-4.9%","d":"down"}];
const COLS = ["ID","Quiz","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lms K12 #001","Lms K12 #002","3.227","4.465","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Lms K12 #002","Lms K12 #003","2.659","818","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Lms K12 #003","Lms K12 #004","4.303","7.390","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Lms K12 #004","Lms K12 #005","3.541","6.469","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lms K12 #005","Lms K12 #001","5.384","8.631","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":379},{"label":"Mar","value":434},{"label":"Abr","value":526},{"label":"Mai","value":441},{"label":"Jun","value":406},{"label":"Jul","value":239},{"label":"Ago","value":238},{"label":"Set","value":232},{"label":"Out","value":271},{"label":"Nov","value":470},{"label":"Dez","value":384}];
const MX = 526;
