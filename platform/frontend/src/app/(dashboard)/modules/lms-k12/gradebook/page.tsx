...
const ACCENT = "#6366f1";
const MODULE = "LMS K-12";
const PAGE = "Gradebook";
const KPIS = [{"l":"Total Lms K12","v":"1.260","t":"+1.0%","d":"up"},{"l":"Gradebook Ativos","v":"3.070","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"87.3%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"56","t":"+4.0%","d":"up"}];
const COLS = ["ID","Gradebook","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lms K12 #001","Lms K12 #002","3.251","6.904","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Lms K12 #002","Lms K12 #003","6.401","3.264","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Lms K12 #003","Lms K12 #004","1.820","6.929","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Lms K12 #004","Lms K12 #005","8.780","3.243","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lms K12 #005","Lms K12 #001","1.505","3.058","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":448},{"label":"Mar","value":711},{"label":"Abr","value":578},{"label":"Mai","value":727},{"label":"Jun","value":653},{"label":"Jul","value":625},{"label":"Ago","value":441},{"label":"Set","value":630},{"label":"Out","value":536},{"label":"Nov","value":827},{"label":"Dez","value":529}];
const MX = 827;
