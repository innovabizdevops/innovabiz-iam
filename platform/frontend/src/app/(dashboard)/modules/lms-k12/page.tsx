...
export default function LmsK12Page() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Lms K12</h1><p className="text-sm text-muted-foreground">Lms K12 • iBOS Enterprise</p></div>
