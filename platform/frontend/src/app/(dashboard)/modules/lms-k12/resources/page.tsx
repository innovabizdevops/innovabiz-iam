...
const KPIS = [{"l":"Total Lms K12","v":"4.709","t":"+12.4%","d":"up"},{"l":"Resources Ativos","v":"4.174","t":"+0.9%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"84","t":"+7.4%","d":"up"}];
const COLS = ["ID","Resources","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lms K12 #001","Lms K12 #002","1.177","1.303","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Lms K12 #002","Lms K12 #003","1.668","6.126","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Lms K12 #003","Lms K12 #004","4.655","3.245","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Lms K12 #004","Lms K12 #005","6.346","8.381","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lms K12 #005","Lms K12 #001","6.238","6.456","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":847},{"label":"Mar","value":654},{"label":"Abr","value":626},{"label":"Mai","value":557},{"label":"Jun","value":875},{"label":"Jul","value":863},{"label":"Ago","value":723},{"label":"Set","value":848},{"label":"Out","value":896},{"label":"Nov","value":893},{"label":"Dez","value":916}];
const MX = 916;
