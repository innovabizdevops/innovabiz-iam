...
const KPIS = [{"l":"Total Lms K12","v":"4.919","t":"+1.8%","d":"up"},{"l":"Assignment Ativos","v":"4.577","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"66.8%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"76","t":"-0.3%","d":"down"}];
const COLS = ["ID","Assignment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lms K12 #001","Lms K12 #002","1.193","3.027","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Lms K12 #002","Lms K12 #003","1.624","5.660","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Lms K12 #003","Lms K12 #004","4.047","5.063","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Lms K12 #004","Lms K12 #005","6.558","6.701","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lms K12 #005","Lms K12 #001","3.730","419","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":317},{"label":"Fev","value":428},{"label":"Mar","value":500},{"label":"Abr","value":648},{"label":"Mai","value":670},{"label":"Jun","value":320},{"label":"Jul","value":434},{"label":"Ago","value":477},{"label":"Set","value":640},{"label":"Out","value":368},{"label":"Nov","value":490},{"label":"Dez","value":552}];
const MX = 670;
