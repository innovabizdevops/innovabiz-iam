...
const PAGE = "Course";
const KPIS = [{"l":"Total Lms K12","v":"5.070","t":"+17.5%","d":"up"},{"l":"Course Ativos","v":"3.775","t":"+4.9%","d":"up"},{"l":"Eficiência (%)","v":"77.0%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"63","t":"+9.1%","d":"up"}];
const COLS = ["ID","Course","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lms K12 #001","Lms K12 #002","533","7.255","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Lms K12 #002","Lms K12 #003","5.838","3.740","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Lms K12 #003","Lms K12 #004","5.597","5.554","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Lms K12 #004","Lms K12 #005","7.749","7.293","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lms K12 #005","Lms K12 #001","535","6.620","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":905},{"label":"Mar","value":954},{"label":"Abr","value":730},{"label":"Mai","value":933},{"label":"Jun","value":989},{"label":"Jul","value":715},{"label":"Ago","value":624},{"label":"Set","value":618},{"label":"Out","value":785},{"label":"Nov","value":859},{"label":"Dez","value":683}];
const MX = 989;
