...
const PAGE = "ABM Campaigns";
const KPIS = [{"l":"Total Marketing","v":"185","t":"+13.0%","d":"up"},{"l":"ABM Campaigns Ativos","v":"1.385","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"82.1%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"84","t":"+6.6%","d":"up"}];
const COLS = ["ID","ABM Campaigns","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marketing #001","Marketing #002","5.149","4.949","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Marketing #002","Marketing #003","3.489","6.458","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Marketing #003","Marketing #004","5.622","5.556","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Marketing #004","Marketing #005","2.132","7.024","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marketing #005","Marketing #001","1.612","2.196","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":471},{"label":"Fev","value":531},{"label":"Mar","value":567},{"label":"Abr","value":642},{"label":"Mai","value":455},{"label":"Jun","value":557},{"label":"Jul","value":503},{"label":"Ago","value":476},{"label":"Set","value":619},{"label":"Out","value":430},{"label":"Nov","value":594},{"label":"Dez","value":404}];
const MX = 642;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#f43f5e'}}>ABM</span></h1>
                </div>
