...
const ROWS = [
  { id: "001", c: ["Validate Rules-001", "Validate Rules Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Validate Rules-002", "Validate Rules Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Validate Rules-003", "Validate Rules Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Validate Rules-004", "Validate Rules Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Validate Rules-005", "Validate Rules Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Validate Rules", ts: "Há 2min", a: "Sistema" },
...
export default function ValidateRulesPage() {
  return (
