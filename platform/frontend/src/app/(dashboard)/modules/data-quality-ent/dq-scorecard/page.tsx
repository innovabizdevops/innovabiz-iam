...
const ROWS = [
  { id: "001", c: ["Dq Scorecard-001", "Dq Scorecard Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Dq Scorecard-002", "Dq Scorecard Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Dq Scorecard-003", "Dq Scorecard Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Dq Scorecard-004", "Dq Scorecard Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Dq Scorecard-005", "Dq Scorecard Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Dq Scorecard", ts: "Há 2min", a: "Sistema" },
...
export default function DqScorecardPage() {
  return (
