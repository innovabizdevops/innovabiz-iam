...
const PAGE = "Act";
const KPIS = [{"l":"Dashboards Ativos","v":"8.499","t":"+13.6%","d":"up"},{"l":"Queries/Dia","v":"220","t":"-5.0%","d":"down"},{"l":"Dados Processados (GB)","v":"6.850","t":"+4.1%","d":"up"},{"l":"Utilizadores Analytics","v":"1.733","t":"+12.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","505","2026-01-28","2.091","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","249","2026-01-28","3.480","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4089","2026-02-16","7.077","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","896","2026-03-09","5.938","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5030","2026-03-14","7.537","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":529},{"label":"Mar","value":561},{"label":"Abr","value":282},{"label":"Mai","value":283},{"label":"Jun","value":273},{"label":"Jul","value":429},{"label":"Ago","value":414},{"label":"Set","value":412},{"label":"Out","value":414},{"label":"Nov","value":665},{"label":"Dez","value":312}];
const MX = 665;
