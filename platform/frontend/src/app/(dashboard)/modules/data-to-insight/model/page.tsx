...
const PAGE = "Model";
const KPIS = [{"l":"Dashboards Ativos","v":"9.070","t":"+2.6%","d":"up"},{"l":"Queries/Dia","v":"2797","t":"+9.4%","d":"up"},{"l":"Dados Processados (GB)","v":"5.853","t":"+17.4%","d":"up"},{"l":"Utilizadores Analytics","v":"4.398","t":"+9.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","132","2026-01-12","3.280","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4526","2026-01-24","6.366","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2113","2026-01-08","6.440","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2003","2026-01-26","6.509","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1284","2026-02-08","1.846","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":824},{"label":"Mar","value":937},{"label":"Abr","value":729},{"label":"Mai","value":660},{"label":"Jun","value":853},{"label":"Jul","value":780},{"label":"Ago","value":844},{"label":"Set","value":972},{"label":"Out","value":668},{"label":"Nov","value":747},{"label":"Dez","value":923}];
const MX = 972;
