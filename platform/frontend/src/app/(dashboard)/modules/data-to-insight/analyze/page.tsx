...
const ACCENT = "#06b6d4";
const MODULE = "Data-to-Insight E2E";
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"3.605","t":"+17.9%","d":"up"},{"l":"Queries/Dia","v":"4257","t":"+0.2%","d":"up"},{"l":"Dados Processados (GB)","v":"7.523","t":"+5.1%","d":"up"},{"l":"Utilizadores Analytics","v":"7.153","t":"+4.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4317","2026-03-23","7.751","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","492","2026-03-26","877","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","595","2026-01-25","6.558","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3029","2026-01-06","5.973","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2714","2026-03-13","1.341","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":881},{"label":"Mar","value":960},{"label":"Abr","value":909},{"label":"Mai","value":888},{"label":"Jun","value":943},{"label":"Jul","value":758},{"label":"Ago","value":1030},{"label":"Set","value":1003},{"label":"Out","value":668},{"label":"Nov","value":741},{"label":"Dez","value":1051}];
const MX = 1051;
