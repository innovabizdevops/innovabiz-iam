...
const PAGE = "Ingest";
const KPIS = [{"l":"Dashboards Ativos","v":"6.533","t":"+11.3%","d":"up"},{"l":"Queries/Dia","v":"3200","t":"+2.9%","d":"up"},{"l":"Dados Processados (GB)","v":"1.279","t":"+6.9%","d":"up"},{"l":"Utilizadores Analytics","v":"4.954","t":"-0.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4625","2026-01-12","9.064","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","195","2026-01-03","7.725","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4661","2026-02-22","6.475","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4648","2026-02-02","5.270","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","937","2026-01-10","8.873","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":899},{"label":"Fev","value":772},{"label":"Mar","value":634},{"label":"Abr","value":895},{"label":"Mai","value":737},{"label":"Jun","value":768},{"label":"Jul","value":765},{"label":"Ago","value":890},{"label":"Set","value":749},{"label":"Out","value":658},{"label":"Nov","value":809},{"label":"Dez","value":629}];
const MX = 899;
