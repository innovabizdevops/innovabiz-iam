...
/* ═══ Data-to-Insight E2E — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "7292", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1087", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€193K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1503876592", cells: ["DAT-4592", "Data-to-Insight E2E Item 1", "9/5/2026", "€26 692"], status: "active" as const },
    { id: "1503880163", cells: ["DAT-8163", "Data-to-Insight E2E Item 2", "24/12/2026", "€30 263"], status: "pending" as const },
    { id: "1503883734", cells: ["DAT-2734", "Data-to-Insight E2E Item 3", "11/7/2026", "€33 834"], status: "completed" as const },
    { id: "1503887305", cells: ["DAT-6305", "Data-to-Insight E2E Item 4", "26/2/2026", "€37 405"], status: "warning" as const },
    { id: "1503890876", cells: ["DAT-9876", "Data-to-Insight E2E Item 5", "13/9/2026", "€40 976"], status: "active" as const },
];
...
export default function DatatoinsightE2ePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data-to-Insight E2E</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data-to-Insight E2E</p>
                    </div>
                </div>
