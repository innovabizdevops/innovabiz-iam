...
const PAGE = "Clean";
const KPIS = [{"l":"Dashboards Ativos","v":"2.316","t":"+15.9%","d":"up"},{"l":"Queries/Dia","v":"4408","t":"-2.7%","d":"down"},{"l":"Dados Processados (GB)","v":"7.795","t":"-1.1%","d":"down"},{"l":"Utilizadores Analytics","v":"3.413","t":"+17.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","343","2026-02-16","1.315","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5062","2026-02-27","1.295","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2079","2026-01-08","6.890","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1481","2026-02-20","1.960","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3507","2026-02-09","2.333","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":539},{"label":"Fev","value":407},{"label":"Mar","value":645},{"label":"Abr","value":417},{"label":"Mai","value":639},{"label":"Jun","value":534},{"label":"Jul","value":522},{"label":"Ago","value":502},{"label":"Set","value":489},{"label":"Out","value":487},{"label":"Nov","value":763},{"label":"Dez","value":709}];
const MX = 763;
