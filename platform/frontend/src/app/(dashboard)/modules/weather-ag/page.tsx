...
export default function WeatherAgPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Weather Ag</h1><p className="text-sm text-muted-foreground">Weather Ag • iBOS Enterprise</p></div>
