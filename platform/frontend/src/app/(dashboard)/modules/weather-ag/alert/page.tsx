...
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"490","t":"+13.0%","d":"up"},{"l":"Taxa Entrega (%)","v":"75.3%","t":"+8.8%","d":"up"},{"l":"Taxa Abertura (%)","v":"93.1%","t":"+12.4%","d":"up"},{"l":"Escalações","v":"7.583","t":"-0.7%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","6.722","99.1%","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","5.827","72.0%","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","7.844","93.9%","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","5.496","97.0%","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","2.227","97.8%","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":692},{"label":"Mar","value":848},{"label":"Abr","value":890},{"label":"Mai","value":966},{"label":"Jun","value":932},{"label":"Jul","value":746},{"label":"Ago","value":753},{"label":"Set","value":885},{"label":"Out","value":881},{"label":"Nov","value":945},{"label":"Dez","value":862}];
const MX = 966;
