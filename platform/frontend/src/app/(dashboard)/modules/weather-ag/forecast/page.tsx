...
const ACCENT = "#6366f1";
const MODULE = "Agricultural Weather";
const PAGE = "Forecast";
const KPIS = [{"l":"Total Weather Ag","v":"6.541","t":"-0.4%","d":"down"},{"l":"Forecast Ativos","v":"638","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"69.4%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"79","t":"+5.4%","d":"up"}];
const COLS = ["ID","Forecast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Weather Ag #001","Weather Ag #002","3.560","7.851","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Weather Ag #002","Weather Ag #003","7.994","8.374","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Weather Ag #003","Weather Ag #004","7.753","6.469","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Weather Ag #004","Weather Ag #005","2.967","3.224","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Weather Ag #005","Weather Ag #001","6.126","7.950","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":422},{"label":"Fev","value":652},{"label":"Mar","value":314},{"label":"Abr","value":381},{"label":"Mai","value":421},{"label":"Jun","value":322},{"label":"Jul","value":629},{"label":"Ago","value":308},{"label":"Set","value":532},{"label":"Out","value":644},{"label":"Nov","value":590},{"label":"Dez","value":605}];
const MX = 652;
