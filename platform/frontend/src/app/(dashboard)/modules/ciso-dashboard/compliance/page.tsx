...
const KPIS = [{"l":"Auditorias Realizadas","v":"8.849","t":"-3.1%","d":"down"},{"l":"NC Abertas","v":"6.011","t":"+0.2%","d":"up"},{"l":"Conformidade (%)","v":"79.0%","t":"+12.8%","d":"up"},{"l":"CAPAs Pendentes","v":"8.185","t":"+13.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.933","76.3%","1.593","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","519","78.2%","1.035","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.436","95.8%","1.244","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.894","82.5%","4.908","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.009","84.5%","5.249","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":718},{"label":"Mar","value":827},{"label":"Abr","value":648},{"label":"Mai","value":791},{"label":"Jun","value":555},{"label":"Jul","value":639},{"label":"Ago","value":572},{"label":"Set","value":636},{"label":"Out","value":800},{"label":"Nov","value":653},{"label":"Dez","value":733}];
const MX = 827;
