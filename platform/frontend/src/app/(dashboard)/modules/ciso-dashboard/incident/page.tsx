...
const ACCENT = "#1e293b";
const MODULE = "CISO Dashboard";
const PAGE = "Incident";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.192","t":"+14.3%","d":"up"},{"l":"NC Abertas","v":"7.875","t":"+7.4%","d":"up"},{"l":"Conformidade (%)","v":"84.5%","t":"+10.3%","d":"up"},{"l":"CAPAs Pendentes","v":"4.134","t":"+11.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.390","76.0%","8.344","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.400","75.6%","7.131","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.199","71.4%","2.096","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.882","92.5%","8.558","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.956","93.5%","4.126","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":482},{"label":"Fev","value":829},{"label":"Mar","value":839},{"label":"Abr","value":628},{"label":"Mai","value":770},{"label":"Jun","value":852},{"label":"Jul","value":629},{"label":"Ago","value":800},{"label":"Set","value":835},{"label":"Out","value":666},{"label":"Nov","value":809},{"label":"Dez","value":477}];
const MX = 852;
