...
const KPIS = [
    ...
    { label: "Ativos", value: "1792", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€496K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1521106576", cells: ["CIS-8576", "CISO Dashboard Item 1", "25/5/2026", "€6676"], status: "active" as const },
    { id: "1521110147", cells: ["CIS-3147", "CISO Dashboard Item 2", "12/12/2026", "€10 247"], status: "pending" as const },
    { id: "1521113718", cells: ["CIS-6718", "CISO Dashboard Item 3", "27/7/2026", "€13 818"], status: "completed" as const },
    { id: "1521117289", cells: ["CIS-1289", "CISO Dashboard Item 4", "14/2/2026", "€17 389"], status: "warning" as const },
    { id: "1521120860", cells: ["CIS-4860", "CISO Dashboard Item 5", "1/9/2026", "€20 960"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CISO Dashboard</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CISO Dashboard</p>
                    </div>
                </div>
