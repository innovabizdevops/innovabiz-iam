...
const PAGE = "Breach Notify";
const KPIS = [{"l":"Notificações Enviadas","v":"6.804","t":"-4.3%","d":"down"},{"l":"Taxa Entrega (%)","v":"72.9%","t":"+8.6%","d":"up"},{"l":"Taxa Abertura (%)","v":"70.1%","t":"+12.3%","d":"up"},{"l":"Escalações","v":"1.284","t":"+0.8%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","7.201","80.4%","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","2.562","84.3%","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","4.856","70.6%","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","8.546","98.7%","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","1.236","93.2%","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":884},{"label":"Fev","value":862},{"label":"Mar","value":1000},{"label":"Abr","value":759},{"label":"Mai","value":836},{"label":"Jun","value":678},{"label":"Jul","value":1004},{"label":"Ago","value":951},{"label":"Set","value":1055},{"label":"Out","value":698},{"label":"Nov","value":842},{"label":"Dez","value":1044}];
const MX = 1055;
