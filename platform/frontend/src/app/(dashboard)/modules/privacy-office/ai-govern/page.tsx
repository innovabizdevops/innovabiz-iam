...
const KPIS = [{"l":"Riscos Identificados","v":"6.331","t":"+8.6%","d":"up"},{"l":"Mitigações Ativas","v":"2.907","t":"+13.8%","d":"up"},{"l":"Score Risco Geral","v":"56","t":"+6.2%","d":"up"},{"l":"Incidentes YTD","v":"7.017","t":"+12.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.098","4.077","7.893","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.918","3.440","3.414","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.614","8.653","4.980","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.952","5.256","7.168","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.678","2.094","8.968","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":384},{"label":"Fev","value":421},{"label":"Mar","value":591},{"label":"Abr","value":558},{"label":"Mai","value":612},{"label":"Jun","value":684},{"label":"Jul","value":482},{"label":"Ago","value":617},{"label":"Set","value":353},{"label":"Out","value":619},{"label":"Nov","value":680},{"label":"Dez","value":695}];
const MX = 695;
...
export default function AiGovernPage() {
    return (
