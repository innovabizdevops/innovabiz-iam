...
export default function PrivacyOfficePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Privacy Office</h1><p className="text-sm text-muted-foreground">Privacy Office • iBOS Enterprise</p></div>
