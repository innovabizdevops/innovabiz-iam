...
const PAGE = "Print";
const KPIS = [{"l":"Total 3d Concrete","v":"8.584","t":"-2.4%","d":"down"},{"l":"Print Ativos","v":"1.098","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"86","t":"-0.4%","d":"down"}];
const COLS = ["ID","Print","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Concrete #001","3d Concrete #002","3.118","1.024","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["3d Concrete #002","3d Concrete #003","6.945","3.275","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Concrete #003","3d Concrete #004","2.211","8.492","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["3d Concrete #004","3d Concrete #005","5.148","5.870","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Concrete #005","3d Concrete #001","7.968","5.211","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":883},{"label":"Fev","value":673},{"label":"Mar","value":818},{"label":"Abr","value":1009},{"label":"Mai","value":1024},{"label":"Jun","value":733},{"label":"Jul","value":1010},{"label":"Ago","value":996},{"label":"Set","value":749},{"label":"Out","value":910},{"label":"Nov","value":883},{"label":"Dez","value":768}];
const MX = 1024;
