...
const PAGE = "Cure";
const KPIS = [{"l":"Total 3d Concrete","v":"2.532","t":"+0.6%","d":"up"},{"l":"Cure Ativos","v":"8.557","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"77.6%","t":"+3.5%","d":"up"},{"l":"Score Performance","v":"94","t":"+12.6%","d":"up"}];
const COLS = ["ID","Cure","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Concrete #001","3d Concrete #002","714","7.977","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["3d Concrete #002","3d Concrete #003","6.102","2.643","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Concrete #003","3d Concrete #004","3.547","5.870","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["3d Concrete #004","3d Concrete #005","1.481","2.866","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Concrete #005","3d Concrete #001","2.132","7.840","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":734},{"label":"Mar","value":572},{"label":"Abr","value":444},{"label":"Mai","value":478},{"label":"Jun","value":591},{"label":"Jul","value":739},{"label":"Ago","value":484},{"label":"Set","value":517},{"label":"Out","value":560},{"label":"Nov","value":542},{"label":"Dez","value":790}];
const MX = 790;
