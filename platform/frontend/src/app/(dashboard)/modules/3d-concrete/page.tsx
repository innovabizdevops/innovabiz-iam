...
/* ═══ 3D Concrete Printing — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "2520", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4946", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€276K", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "497962520", cells: ["3D-2520", "3D Concrete Printing Item 1", "21/9/2026", "€12 620"], status: "active" as const },
    { id: "497966091", cells: ["3D-6091", "3D Concrete Printing Item 2", "8/4/2026", "€16 191"], status: "pending" as const },
    { id: "497969662", cells: ["3D-9662", "3D Concrete Printing Item 3", "23/11/2026", "€19 762"], status: "completed" as const },
    { id: "497973233", cells: ["3D-4233", "3D Concrete Printing Item 4", "10/6/2026", "€23 333"], status: "warning" as const },
    { id: "497976804", cells: ["3D-7804", "3D Concrete Printing Item 5", "25/1/2026", "€26 904"], status: "active" as const },
];
...
export default function P3dConcretePrintingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">3D Concrete Printing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • 3D Concrete Printing</p>
                    </div>
                </div>
