...
const ACCENT = "#312e81";
const MODULE = "3D Concrete Printing";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"5.197","t":"-5.3%","d":"down"},{"l":"Submissões/Dia","v":"620","t":"+8.5%","d":"up"},{"l":"Documentos Gerados","v":"5.608","t":"-5.7%","d":"down"},{"l":"Templates","v":"6.414","t":"+14.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.993","2026-01-04","2.807","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","245","2026-03-20","3.055","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","201","2026-03-07","8.609","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.287","2026-03-06","176","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.337","2026-02-03","2.682","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":383},{"label":"Fev","value":589},{"label":"Mar","value":564},{"label":"Abr","value":456},{"label":"Mai","value":514},{"label":"Jun","value":429},{"label":"Jul","value":554},{"label":"Ago","value":358},{"label":"Set","value":605},{"label":"Out","value":508},{"label":"Nov","value":422},{"label":"Dez","value":605}];
const MX = 605;
