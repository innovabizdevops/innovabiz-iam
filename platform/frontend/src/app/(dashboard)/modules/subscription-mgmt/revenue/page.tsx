...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€47.4M","t":"+5.6%","d":"up"},{"l":"MRR (€)","v":"€44141","t":"+1.5%","d":"up"},{"l":"Churn (%)","v":"76.8%","t":"+11.3%","d":"up"},{"l":"ARPU (€)","v":"€91295","t":"+5.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 724.92","8.644","€ 47936.35","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 25412.11","7.422","€ 47528.35","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 34777.62","900","€ 32348.12","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 13100.17","966","€ 45873.27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 2928.07","1.352","€ 16783.03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":697},{"label":"Mar","value":810},{"label":"Abr","value":795},{"label":"Mai","value":984},{"label":"Jun","value":663},{"label":"Jul","value":851},{"label":"Ago","value":991},{"label":"Set","value":959},{"label":"Out","value":864},{"label":"Nov","value":667},{"label":"Dez","value":607}];
const MX = 991;
