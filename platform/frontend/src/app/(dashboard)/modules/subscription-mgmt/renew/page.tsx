...
const PAGE = "Renew";
const KPIS = [{"l":"ARR (€M)","v":"€44.5M","t":"-2.0%","d":"down"},{"l":"MRR (€)","v":"€16102","t":"-2.8%","d":"down"},{"l":"Churn (%)","v":"76.3%","t":"+5.0%","d":"up"},{"l":"ARPU (€)","v":"€22692","t":"+6.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 44632.90","5.227","€ 46886.99","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 17270.53","6.382","€ 33700.31","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 43193.37","1.582","€ 32752.51","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 30958.67","4.134","€ 2404.67","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 31279.52","5.031","€ 29830.21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":914},{"label":"Fev","value":617},{"label":"Mar","value":604},{"label":"Abr","value":784},{"label":"Mai","value":532},{"label":"Jun","value":921},{"label":"Jul","value":543},{"label":"Ago","value":612},{"label":"Set","value":552},{"label":"Out","value":740},{"label":"Nov","value":548},{"label":"Dez","value":565}];
const MX = 921;
