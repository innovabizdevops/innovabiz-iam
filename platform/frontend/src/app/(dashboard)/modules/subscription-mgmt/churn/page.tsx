...
const ACCENT = "#f43f5e";
const MODULE = "Subscription Management";
const PAGE = "Churn";
const KPIS = [{"l":"ARR (€M)","v":"€46.9M","t":"+1.7%","d":"up"},{"l":"MRR (€)","v":"€65512","t":"-0.8%","d":"down"},{"l":"Churn (%)","v":"79.5%","t":"+14.7%","d":"up"},{"l":"ARPU (€)","v":"€73548","t":"+11.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 13807.99","2.539","€ 17343.30","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 3736.74","3.055","€ 34330.19","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 18064.93","4.828","€ 2649.05","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 4998.83","7.507","€ 15084.85","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 37092.24","3.495","€ 35690.47","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":454},{"label":"Fev","value":566},{"label":"Mar","value":512},{"label":"Abr","value":438},{"label":"Mai","value":558},{"label":"Jun","value":502},{"label":"Jul","value":499},{"label":"Ago","value":428},{"label":"Set","value":578},{"label":"Out","value":509},{"label":"Nov","value":417},{"label":"Dez","value":517}];
const MX = 578;
