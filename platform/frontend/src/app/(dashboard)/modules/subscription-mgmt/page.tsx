...
const KPIS = [
    { label: "Total Registos", value: "7820", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "921", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€419K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "242557720", cells: ["SUB-8720", "Subscription Management Item 1", "21/5/2026", "€7820"], status: "active" as const },
    { id: "242561291", cells: ["SUB-3291", "Subscription Management Item 2", "8/12/2026", "€11 391"], status: "pending" as const },
    { id: "242564862", cells: ["SUB-6862", "Subscription Management Item 3", "23/7/2026", "€14 962"], status: "completed" as const },
    { id: "242568433", cells: ["SUB-1433", "Subscription Management Item 4", "10/2/2026", "€18 533"], status: "warning" as const },
    { id: "242572004", cells: ["SUB-5004", "Subscription Management Item 5", "25/9/2026", "€22 104"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Subscription Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Subscription Management</p>
                    </div>
                </div>
