...
const PAGE = "Plan";
const KPIS = [{"l":"ARR (€M)","v":"€29.6M","t":"+3.1%","d":"up"},{"l":"MRR (€)","v":"€21971","t":"-4.1%","d":"down"},{"l":"Churn (%)","v":"93.6%","t":"+15.4%","d":"up"},{"l":"ARPU (€)","v":"€41753","t":"+14.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 47364.28","6.695","€ 14720.32","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 43697.26","1.513","€ 21691.51","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 42684.35","756","€ 23497.02","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 7781.75","6.234","€ 1948.23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 23924.78","4.014","€ 36258.98","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":475},{"label":"Mar","value":565},{"label":"Abr","value":356},{"label":"Mai","value":601},{"label":"Jun","value":578},{"label":"Jul","value":674},{"label":"Ago","value":592},{"label":"Set","value":298},{"label":"Out","value":361},{"label":"Nov","value":470},{"label":"Dez","value":642}];
const MX = 674;
