...
const KPIS = [{"l":"ARR (€M)","v":"€39.7M","t":"+7.1%","d":"up"},{"l":"MRR (€)","v":"€99061","t":"+6.6%","d":"up"},{"l":"Churn (%)","v":"69.3%","t":"+2.4%","d":"up"},{"l":"ARPU (€)","v":"€40585","t":"+4.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 17267.96","4.997","€ 44310.97","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 43369.55","8.574","€ 28219.23","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 40339.97","3.087","€ 47772.11","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 4371.52","3.663","€ 25523.25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 43991.75","6.403","€ 31080.56","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":419},{"label":"Mar","value":328},{"label":"Abr","value":427},{"label":"Mai","value":577},{"label":"Jun","value":450},{"label":"Jul","value":329},{"label":"Ago","value":627},{"label":"Set","value":485},{"label":"Out","value":562},{"label":"Nov","value":567},{"label":"Dez","value":462}];
const MX = 632;
