...
const PAGE = "Partnership";
const KPIS = [{"l":"Total Guest Loyalty","v":"1.586","t":"+10.7%","d":"up"},{"l":"Partnership Ativos","v":"5.619","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"69.1%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"71","t":"+0.1%","d":"up"}];
const COLS = ["ID","Partnership","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Guest Loyalty #001","Guest Loyalty #002","1.553","1.834","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Guest Loyalty #002","Guest Loyalty #003","7.557","1.696","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Guest Loyalty #003","Guest Loyalty #004","8.280","5.563","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Guest Loyalty #004","Guest Loyalty #005","7.835","8.149","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Guest Loyalty #005","Guest Loyalty #001","2.337","7.496","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":304},{"label":"Fev","value":320},{"label":"Mar","value":353},{"label":"Abr","value":629},{"label":"Mai","value":461},{"label":"Jun","value":420},{"label":"Jul","value":320},{"label":"Ago","value":589},{"label":"Set","value":542},{"label":"Out","value":415},{"label":"Nov","value":512},{"label":"Dez","value":489}];
const MX = 629;
