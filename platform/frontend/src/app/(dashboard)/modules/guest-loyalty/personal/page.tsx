...
const ACCENT = "#4338ca";
const MODULE = "Guest Loyalty";
const PAGE = "Personalize";
const KPIS = [{"l":"Perfis Unificados","v":"2.237","t":"+6.0%","d":"up"},{"l":"Segmentos Ativos","v":"5.622","t":"-6.0%","d":"down"},{"l":"NPS Score","v":"88","t":"+15.5%","d":"up"},{"l":"Churn Previsto (%)","v":"72.0%","t":"+8.8%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","3.104","€ 31507.53","76.6%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","6.949","€ 22159.33","78.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","8.757","€ 33076.13","90.6%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","6.495","€ 4483.62","94.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","8.652","€ 19325.40","85.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":860},{"label":"Mar","value":860},{"label":"Abr","value":731},{"label":"Mai","value":553},{"label":"Jun","value":649},{"label":"Jul","value":701},{"label":"Ago","value":869},{"label":"Set","value":586},{"label":"Out","value":822},{"label":"Nov","value":761},{"label":"Dez","value":852}];
const MX = 869;
