...
const KPIS = [{"l":"ARR (€M)","v":"€39.9M","t":"+7.3%","d":"up"},{"l":"MRR (€)","v":"€35313","t":"+2.1%","d":"up"},{"l":"Churn (%)","v":"83.5%","t":"+2.7%","d":"up"},{"l":"ARPU (€)","v":"€43975","t":"+13.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 36892.82","6.568","€ 33415.15","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 25966.97","2.220","€ 12519.24","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 35136.63","1.086","€ 49283.86","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 27741.17","7.018","€ 12259.23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 45524.04","9.086","€ 48097.98","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":500},{"label":"Fev","value":368},{"label":"Mar","value":348},{"label":"Abr","value":259},{"label":"Mai","value":649},{"label":"Jun","value":364},{"label":"Jul","value":518},{"label":"Ago","value":609},{"label":"Set","value":611},{"label":"Out","value":472},{"label":"Nov","value":607},{"label":"Dez","value":391}];
const MX = 649;
