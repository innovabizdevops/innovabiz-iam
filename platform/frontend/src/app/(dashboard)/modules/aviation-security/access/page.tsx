...
const ACCENT = "#6366f1";
const MODULE = "Aviation Security";
const PAGE = "Access";
const KPIS = [{"l":"Total Aviation Security","v":"4.192","t":"+17.7%","d":"up"},{"l":"Access Ativos","v":"1.866","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"90.7%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"78","t":"+13.7%","d":"up"}];
const COLS = ["ID","Access","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aviation Security #001","Aviation Security #002","6.187","3.457","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Aviation Security #002","Aviation Security #003","7.953","2.664","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Aviation Security #003","Aviation Security #004","4.614","4.951","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Aviation Security #004","Aviation Security #005","6.548","5.343","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aviation Security #005","Aviation Security #001","9.084","7.298","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":866},{"label":"Mar","value":933},{"label":"Abr","value":756},{"label":"Mai","value":1014},{"label":"Jun","value":851},{"label":"Jul","value":757},{"label":"Ago","value":653},{"label":"Set","value":925},{"label":"Out","value":703},{"label":"Nov","value":946},{"label":"Dez","value":986}];
const MX = 1014;
