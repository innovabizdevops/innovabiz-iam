...
const PAGE = "Cyber";
const KPIS = [{"l":"Total Aviation Security","v":"2.938","t":"+11.8%","d":"up"},{"l":"Cyber Ativos","v":"410","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"92.8%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"67","t":"+9.8%","d":"up"}];
const COLS = ["ID","Cyber","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aviation Security #001","Aviation Security #002","9.079","8.920","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Aviation Security #002","Aviation Security #003","1.676","7.645","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Aviation Security #003","Aviation Security #004","2.658","8.530","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Aviation Security #004","Aviation Security #005","1.897","803","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aviation Security #005","Aviation Security #001","1.254","8.930","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":276},{"label":"Fev","value":452},{"label":"Mar","value":646},{"label":"Abr","value":404},{"label":"Mai","value":316},{"label":"Jun","value":487},{"label":"Jul","value":358},{"label":"Ago","value":332},{"label":"Set","value":316},{"label":"Out","value":365},{"label":"Nov","value":603},{"label":"Dez","value":555}];
const MX = 646;
