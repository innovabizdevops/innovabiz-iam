...
const PAGE = "Screen";
const KPIS = [{"l":"Total Aviation Security","v":"1.902","t":"-4.7%","d":"down"},{"l":"Screen Ativos","v":"7.225","t":"-4.0%","d":"down"},{"l":"Eficiência (%)","v":"79.8%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"84","t":"+6.0%","d":"up"}];
const COLS = ["ID","Screen","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aviation Security #001","Aviation Security #002","1.328","2.185","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Aviation Security #002","Aviation Security #003","8.547","2.956","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Aviation Security #003","Aviation Security #004","7.332","6.587","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Aviation Security #004","Aviation Security #005","2.547","6.309","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aviation Security #005","Aviation Security #001","7.165","2.620","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":578},{"label":"Mar","value":670},{"label":"Abr","value":710},{"label":"Mai","value":561},{"label":"Jun","value":380},{"label":"Jul","value":446},{"label":"Ago","value":504},{"label":"Set","value":674},{"label":"Out","value":672},{"label":"Nov","value":694},{"label":"Dez","value":470}];
const MX = 710;
