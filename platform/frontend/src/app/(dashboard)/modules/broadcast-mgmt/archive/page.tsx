...
const PAGE = "Archive";
const KPIS = [{"l":"Total Broadcast Mgmt","v":"521","t":"-5.4%","d":"down"},{"l":"Archive Ativos","v":"6.587","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"66.8%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"79","t":"+3.4%","d":"up"}];
const COLS = ["ID","Archive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Broadcast Mgmt #001","Broadcast Mgmt #002","6.129","7.941","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Broadcast Mgmt #002","Broadcast Mgmt #003","3.099","4.918","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Broadcast Mgmt #003","Broadcast Mgmt #004","5.338","4.016","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Broadcast Mgmt #004","Broadcast Mgmt #005","8.092","1.017","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Broadcast Mgmt #005","Broadcast Mgmt #001","3.491","4.036","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":550},{"label":"Mar","value":502},{"label":"Abr","value":709},{"label":"Mai","value":514},{"label":"Jun","value":654},{"label":"Jul","value":712},{"label":"Ago","value":514},{"label":"Set","value":781},{"label":"Out","value":467},{"label":"Nov","value":500},{"label":"Dez","value":497}];
const MX = 781;
