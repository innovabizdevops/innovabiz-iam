...
const ACCENT = "#6d28d9";
const MODULE = "Broadcast Management";
const PAGE = "Traffic";
const KPIS = [{"l":"Total Broadcast Mgmt","v":"5.395","t":"+5.6%","d":"up"},{"l":"Traffic Ativos","v":"5.839","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"89.6%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"72","t":"-3.1%","d":"down"}];
const COLS = ["ID","Traffic","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Broadcast Mgmt #001","Broadcast Mgmt #002","3.893","2.886","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Broadcast Mgmt #002","Broadcast Mgmt #003","1.011","5.168","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Broadcast Mgmt #003","Broadcast Mgmt #004","2.975","1.842","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Broadcast Mgmt #004","Broadcast Mgmt #005","808","6.642","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Broadcast Mgmt #005","Broadcast Mgmt #001","4.618","5.308","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":896},{"label":"Fev","value":670},{"label":"Mar","value":679},{"label":"Abr","value":756},{"label":"Mai","value":822},{"label":"Jun","value":935},{"label":"Jul","value":745},{"label":"Ago","value":760},{"label":"Set","value":951},{"label":"Out","value":967},{"label":"Nov","value":879},{"label":"Dez","value":941}];
const MX = 967;
