...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Broadcast Mgmt","v":"209","t":"+11.5%","d":"up"},{"l":"Schedule Ativos","v":"306","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"64","t":"+2.1%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Broadcast Mgmt #001","Broadcast Mgmt #002","1.991","4.374","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Broadcast Mgmt #002","Broadcast Mgmt #003","5.530","2.926","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Broadcast Mgmt #003","Broadcast Mgmt #004","1.980","8.261","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Broadcast Mgmt #004","Broadcast Mgmt #005","3.713","7.320","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Broadcast Mgmt #005","Broadcast Mgmt #001","4.374","829","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":849},{"label":"Fev","value":739},{"label":"Mar","value":843},{"label":"Abr","value":493},{"label":"Mai","value":697},{"label":"Jun","value":568},{"label":"Jul","value":755},{"label":"Ago","value":563},{"label":"Set","value":648},{"label":"Out","value":515},{"label":"Nov","value":541},{"label":"Dez","value":680}];
const MX = 849;
