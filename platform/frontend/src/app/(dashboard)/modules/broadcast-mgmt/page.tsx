...
const KPIS = [
    { label: "Total Registos", value: "8728", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3404", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€103K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "-11%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1682691828", cells: ["BRO-7828", "Broadcast Management Item 1", "21/1/2026", "€41 928"], status: "active" as const },
    { id: "1682695399", cells: ["BRO-2399", "Broadcast Management Item 2", "8/8/2026", "€45 499"], status: "pending" as const },
    { id: "1682698970", cells: ["BRO-5970", "Broadcast Management Item 3", "23/3/2026", "€49 070"], status: "completed" as const },
    { id: "1682702541", cells: ["BRO-9541", "Broadcast Management Item 4", "10/10/2026", "€2641"], status: "warning" as const },
    { id: "1682706112", cells: ["BRO-4112", "Broadcast Management Item 5", "25/5/2026", "€6212"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Broadcast Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Broadcast Management</p>
                    </div>
                </div>
