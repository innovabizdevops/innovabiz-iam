...
const ACCENT = "#4f46e5";
const MODULE = "AX Planning & Reasoning";
const PAGE = "Plan";
const KPIS = [{"l":"Total Ax Planning","v":"6.492","t":"+14.5%","d":"up"},{"l":"Plan Ativos","v":"1.366","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"83.4%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"72","t":"+1.1%","d":"up"}];
const COLS = ["ID","Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Planning #001","Ax Planning #002","2.281","588","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Planning #002","Ax Planning #003","2.061","624","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Planning #003","Ax Planning #004","1.016","6.125","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Planning #004","Ax Planning #005","879","4.157","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Planning #005","Ax Planning #001","5.137","6.557","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":574},{"label":"Mar","value":808},{"label":"Abr","value":597},{"label":"Mai","value":701},{"label":"Jun","value":699},{"label":"Jul","value":882},{"label":"Ago","value":601},{"label":"Set","value":736},{"label":"Out","value":801},{"label":"Nov","value":945},{"label":"Dez","value":908}];
const MX = 945;
