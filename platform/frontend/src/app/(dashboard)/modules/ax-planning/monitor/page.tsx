...
const PAGE = "Monitor";
const KPIS = [{"l":"Total Ax Planning","v":"2.675","t":"+11.1%","d":"up"},{"l":"Monitor Ativos","v":"6.741","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"66.1%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"58","t":"+3.7%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Planning #001","Ax Planning #002","267","6.383","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Planning #002","Ax Planning #003","8.318","7.328","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Planning #003","Ax Planning #004","2.678","3.079","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Planning #004","Ax Planning #005","5.826","476","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Planning #005","Ax Planning #001","2.266","693","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":919},{"label":"Mar","value":951},{"label":"Abr","value":696},{"label":"Mai","value":814},{"label":"Jun","value":655},{"label":"Jul","value":956},{"label":"Ago","value":708},{"label":"Set","value":773},{"label":"Out","value":900},{"label":"Nov","value":989},{"label":"Dez","value":687}];
const MX = 989;
