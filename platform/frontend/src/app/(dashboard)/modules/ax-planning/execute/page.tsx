...
const PAGE = "Execute";
const KPIS = [{"l":"Total Ax Planning","v":"7.199","t":"+0.4%","d":"up"},{"l":"Execute Ativos","v":"7.464","t":"+17.7%","d":"up"},{"l":"Eficiência (%)","v":"72.5%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"67","t":"-0.3%","d":"down"}];
const COLS = ["ID","Execute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Planning #001","Ax Planning #002","7.923","1.379","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Planning #002","Ax Planning #003","8.926","8.006","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Planning #003","Ax Planning #004","1.717","4.428","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Planning #004","Ax Planning #005","8.212","1.751","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Planning #005","Ax Planning #001","3.963","8.441","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":386},{"label":"Fev","value":502},{"label":"Mar","value":528},{"label":"Abr","value":517},{"label":"Mai","value":565},{"label":"Jun","value":219},{"label":"Jul","value":248},{"label":"Ago","value":287},{"label":"Set","value":593},{"label":"Out","value":543},{"label":"Nov","value":362},{"label":"Dez","value":308}];
const MX = 593;
