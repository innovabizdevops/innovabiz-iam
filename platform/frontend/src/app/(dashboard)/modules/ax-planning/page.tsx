...
/* ═══ AX Planning & Reasoning — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "958", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2401", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€470K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "-16%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "568904358", cells: ["AX-6358", "AX Planning & Reasoning Item 1", "23/7/2026", "€4458"], status: "active" as const },
    { id: "568907929", cells: ["AX-9929", "AX Planning & Reasoning Item 2", "10/2/2026", "€8029"], status: "pending" as const },
    { id: "568911500", cells: ["AX-4500", "AX Planning & Reasoning Item 3", "25/9/2026", "€11 600"], status: "completed" as const },
    { id: "568915071", cells: ["AX-8071", "AX Planning & Reasoning Item 4", "12/4/2026", "€15 171"], status: "warning" as const },
    { id: "568918642", cells: ["AX-2642", "AX Planning & Reasoning Item 5", "27/11/2026", "€18 742"], status: "active" as const },
];
...
export default function AxPlanningReasoningPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AX Planning & Reasoning</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AX Planning & Reasoning</p>
                    </div>
                </div>
