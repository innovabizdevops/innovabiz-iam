...
const PAGE = "Adapt";
const KPIS = [{"l":"Total Ax Planning","v":"3.903","t":"-1.1%","d":"down"},{"l":"Adapt Ativos","v":"3.208","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"72.1%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"87","t":"+15.6%","d":"up"}];
const COLS = ["ID","Adapt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Planning #001","Ax Planning #002","5.835","5.439","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Planning #002","Ax Planning #003","5.282","8.568","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Planning #003","Ax Planning #004","2.830","515","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Planning #004","Ax Planning #005","7.508","1.062","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Planning #005","Ax Planning #001","6.584","5.984","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":412},{"label":"Mar","value":416},{"label":"Abr","value":384},{"label":"Mai","value":684},{"label":"Jun","value":515},{"label":"Jul","value":422},{"label":"Ago","value":666},{"label":"Set","value":592},{"label":"Out","value":732},{"label":"Nov","value":698},{"label":"Dez","value":695}];
const MX = 745;
