...
const ACCENT = "#14532d";
const MODULE = "CPLP Compliance Hub";
const PAGE = "Moçambique";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.376","t":"+9.1%","d":"up"},{"l":"NC Abertas","v":"5.557","t":"+6.6%","d":"up"},{"l":"Conformidade (%)","v":"76.5%","t":"+2.6%","d":"up"},{"l":"CAPAs Pendentes","v":"5.759","t":"+9.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.807","97.9%","6.000","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.321","95.5%","3.945","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.232","73.5%","2.223","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.754","78.3%","6.468","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.485","83.8%","5.117","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":732},{"label":"Mar","value":865},{"label":"Abr","value":764},{"label":"Mai","value":822},{"label":"Jun","value":683},{"label":"Jul","value":813},{"label":"Ago","value":828},{"label":"Set","value":820},{"label":"Out","value":638},{"label":"Nov","value":560},{"label":"Dez","value":831}];
const MX = 865;
