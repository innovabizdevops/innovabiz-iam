...
/* ═══ CPLP Compliance Hub — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "7006", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3227", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€67K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "-14%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1917072606", cells: ["CPL-1606", "CPLP Compliance Hub Item 1", "23/7/2026", "€22 706"], status: "active" as const },
    { id: "1917076177", cells: ["CPL-5177", "CPLP Compliance Hub Item 2", "10/2/2026", "€26 277"], status: "pending" as const },
    { id: "1917079748", cells: ["CPL-8748", "CPLP Compliance Hub Item 3", "25/9/2026", "€29 848"], status: "completed" as const },
    { id: "1917083319", cells: ["CPL-3319", "CPLP Compliance Hub Item 4", "12/4/2026", "€33 419"], status: "warning" as const },
    { id: "1917086890", cells: ["CPL-6890", "CPLP Compliance Hub Item 5", "27/11/2026", "€36 990"], status: "active" as const },
];
...
export default function CplpComplianceHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CPLP Compliance Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CPLP Compliance Hub</p>
                    </div>
                </div>
