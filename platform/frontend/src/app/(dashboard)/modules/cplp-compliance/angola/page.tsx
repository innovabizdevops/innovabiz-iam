...
const PAGE = "Angola";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.088","t":"-0.1%","d":"down"},{"l":"NC Abertas","v":"6.415","t":"+16.9%","d":"up"},{"l":"Conformidade (%)","v":"70.3%","t":"+11.3%","d":"up"},{"l":"CAPAs Pendentes","v":"6.517","t":"-4.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.329","81.9%","3.764","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.212","90.5%","8.353","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.037","93.3%","3.887","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.968","96.6%","5.439","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.789","87.4%","9.044","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":358},{"label":"Mar","value":498},{"label":"Abr","value":626},{"label":"Mai","value":719},{"label":"Jun","value":665},{"label":"Jul","value":660},{"label":"Ago","value":608},{"label":"Set","value":334},{"label":"Out","value":548},{"label":"Nov","value":506},{"label":"Dez","value":727}];
const MX = 727;
