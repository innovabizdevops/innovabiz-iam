...
const PAGE = "Portugal";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.890","t":"-5.1%","d":"down"},{"l":"NC Abertas","v":"8.238","t":"-0.5%","d":"down"},{"l":"Conformidade (%)","v":"70.7%","t":"+4.1%","d":"up"},{"l":"CAPAs Pendentes","v":"2.802","t":"+5.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.028","95.2%","5.401","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.754","86.4%","3.660","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.645","70.2%","3.957","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.918","88.2%","6.113","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.912","95.4%","3.874","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":596},{"label":"Mar","value":532},{"label":"Abr","value":835},{"label":"Mai","value":577},{"label":"Jun","value":595},{"label":"Jul","value":552},{"label":"Ago","value":657},{"label":"Set","value":815},{"label":"Out","value":646},{"label":"Nov","value":454},{"label":"Dez","value":633}];
const MX = 835;
