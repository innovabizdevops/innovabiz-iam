...
export default function CoworkingMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div><h1 className="text-2xl font-bold">Coworking Mgmt</h1><p className="text-sm text-muted-foreground">Coworking Mgmt • iBOS</p></div>
