...
const KPIS = [{"l":"Projetos Sociais","v":"3.121","t":"+16.1%","d":"up"},{"l":"Beneficiários","v":"8.460","t":"-5.4%","d":"down"},{"l":"Investimento CSR (€)","v":"€3224","t":"+8.5%","d":"up"},{"l":"Score Impacto","v":"74","t":"-4.3%","d":"down"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","4.568","€ 34920.65","3.975","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","7.019","€ 49845.78","5.935","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","2.829","€ 9254.03","3.276","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","1.370","€ 36954.56","2.233","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","2.417","€ 26689.60","1.354","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":314},{"label":"Fev","value":560},{"label":"Mar","value":650},{"label":"Abr","value":511},{"label":"Mai","value":292},{"label":"Jun","value":642},{"label":"Jul","value":283},{"label":"Ago","value":664},{"label":"Set","value":509},{"label":"Out","value":623},{"label":"Nov","value":445},{"label":"Dez","value":489}];
const MX = 664;
