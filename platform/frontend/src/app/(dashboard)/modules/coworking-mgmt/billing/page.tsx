...
const PAGE = "Billing";
const KPIS = [{"l":"Total Coworking Mgmt","v":"1.182","t":"+13.5%","d":"up"},{"l":"Billing Ativos","v":"4.545","t":"+18.0%","d":"up"},{"l":"Eficiência (%)","v":"75.0%","t":"+12.8%","d":"up"},{"l":"Score Performance","v":"95","t":"+10.5%","d":"up"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coworking Mgmt #001","Coworking Mgmt #002","7.733","1.855","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Coworking Mgmt #002","Coworking Mgmt #003","1.961","228","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Coworking Mgmt #003","Coworking Mgmt #004","7.743","5.089","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Coworking Mgmt #004","Coworking Mgmt #005","1.928","1.154","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coworking Mgmt #005","Coworking Mgmt #001","1.907","1.007","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":597},{"label":"Fev","value":574},{"label":"Mar","value":537},{"label":"Abr","value":511},{"label":"Mai","value":624},{"label":"Jun","value":590},{"label":"Jul","value":301},{"label":"Ago","value":612},{"label":"Set","value":577},{"label":"Out","value":559},{"label":"Nov","value":514},{"label":"Dez","value":534}];
const MX = 624;
