...
const ACCENT = "#f59e0b";
const MODULE = "Coworking Space";
const PAGE = "Access";
const KPIS = [{"l":"Total Coworking Mgmt","v":"3.074","t":"-1.9%","d":"down"},{"l":"Access Ativos","v":"8.697","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"83.7%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"78","t":"-3.7%","d":"down"}];
const COLS = ["ID","Access","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coworking Mgmt #001","Coworking Mgmt #002","7.859","3.538","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Coworking Mgmt #002","Coworking Mgmt #003","7.113","6.787","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Coworking Mgmt #003","Coworking Mgmt #004","3.266","7.414","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Coworking Mgmt #004","Coworking Mgmt #005","8.515","6.688","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coworking Mgmt #005","Coworking Mgmt #001","4.015","2.741","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":873},{"label":"Fev","value":688},{"label":"Mar","value":772},{"label":"Abr","value":787},{"label":"Mai","value":640},{"label":"Jun","value":510},{"label":"Jul","value":861},{"label":"Ago","value":746},{"label":"Set","value":618},{"label":"Out","value":638},{"label":"Nov","value":858},{"label":"Dez","value":571}];
const MX = 873;
