...
const KPIS = [{"l":"Twins Ativos","v":"831","t":"+1.8%","d":"up"},{"l":"Simulações/Dia","v":"1170","t":"+7.9%","d":"up"},{"l":"Precisão Modelo (%)","v":"94.5%","t":"+10.8%","d":"up"},{"l":"Latência Sync (ms)","v":"38ms","t":"+3.4%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","94.5%","2026-02-15","6.577","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","90.2%","2026-01-11","3.404","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","81.2%","2026-01-20","5.489","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","88.5%","2026-01-04","806","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","84.0%","2026-02-10","6.735","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":817},{"label":"Mar","value":787},{"label":"Abr","value":856},{"label":"Mai","value":754},{"label":"Jun","value":950},{"label":"Jul","value":674},{"label":"Ago","value":670},{"label":"Set","value":715},{"label":"Out","value":854},{"label":"Nov","value":668},{"label":"Dez","value":932}];
const MX = 950;
