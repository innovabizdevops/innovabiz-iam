...
const PAGE = "Maintenance AI";
const KPIS = [{"l":"Total Manufacturing Services","v":"7.677","t":"+6.4%","d":"up"},{"l":"Maintenance AI Ativos","v":"7.373","t":"+17.3%","d":"up"},{"l":"Eficiência (%)","v":"73.9%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"61","t":"-5.4%","d":"down"}];
const COLS = ["ID","Maintenance AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Manufacturing Services #001","Manufacturing Services #002","4.460","5.935","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Manufacturing Services #002","Manufacturing Services #003","5.295","4.716","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Manufacturing Services #003","Manufacturing Services #004","8.410","4.120","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Manufacturing Services #004","Manufacturing Services #005","4.255","4.833","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Manufacturing Services #005","Manufacturing Services #001","6.210","1.701","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":822},{"label":"Fev","value":875},{"label":"Mar","value":921},{"label":"Abr","value":639},{"label":"Mai","value":785},{"label":"Jun","value":902},{"label":"Jul","value":940},{"label":"Ago","value":626},{"label":"Set","value":612},{"label":"Out","value":765},{"label":"Nov","value":589},{"label":"Dez","value":673}];
const MX = 940;
