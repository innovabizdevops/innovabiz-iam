...
const PAGE = "Quality Control";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.711","t":"+0.6%","d":"up"},{"l":"NC Abertas","v":"5.708","t":"-0.8%","d":"down"},{"l":"Conformidade (%)","v":"75.0%","t":"+8.4%","d":"up"},{"l":"CAPAs Pendentes","v":"4.235","t":"+1.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.246","84.0%","5.556","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","645","91.9%","7.572","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.325","88.9%","8.341","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.945","99.8%","1.099","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.993","80.1%","5.420","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":899},{"label":"Fev","value":922},{"label":"Mar","value":772},{"label":"Abr","value":786},{"label":"Mai","value":1004},{"label":"Jun","value":987},{"label":"Jul","value":648},{"label":"Ago","value":871},{"label":"Set","value":722},{"label":"Out","value":920},{"label":"Nov","value":818},{"label":"Dez","value":697}];
const MX = 1004;
