...
const PAGE = "Predictive Quality AI";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.255","t":"+4.0%","d":"up"},{"l":"NC Abertas","v":"8.708","t":"+6.1%","d":"up"},{"l":"Conformidade (%)","v":"93.9%","t":"+2.0%","d":"up"},{"l":"CAPAs Pendentes","v":"2.463","t":"-4.4%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.651","73.1%","6.013","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.880","81.8%","8.600","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.865","72.3%","7.711","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.030","95.1%","7.251","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.099","84.4%","8.828","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":598},{"label":"Mar","value":798},{"label":"Abr","value":884},{"label":"Mai","value":677},{"label":"Jun","value":620},{"label":"Jul","value":707},{"label":"Ago","value":660},{"label":"Set","value":634},{"label":"Out","value":840},{"label":"Nov","value":883},{"label":"Dez","value":831}];
const MX = 884;
...
export default function PredictiveQualityPage() {
    return (
