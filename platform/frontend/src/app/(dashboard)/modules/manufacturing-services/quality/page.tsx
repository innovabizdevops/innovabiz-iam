...
const PAGE = "Quality &amp; Maintenance";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.437","t":"+6.8%","d":"up"},{"l":"NC Abertas","v":"8.714","t":"-1.6%","d":"down"},{"l":"Conformidade (%)","v":"76.9%","t":"+16.3%","d":"up"},{"l":"CAPAs Pendentes","v":"8.638","t":"+8.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.724","73.1%","4.179","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","787","89.2%","8.053","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.161","83.7%","302","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.652","99.5%","3.978","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.082","73.5%","1.241","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":565},{"label":"Fev","value":631},{"label":"Mar","value":637},{"label":"Abr","value":639},{"label":"Mai","value":490},{"label":"Jun","value":589},{"label":"Jul","value":524},{"label":"Ago","value":524},{"label":"Set","value":613},{"label":"Out","value":557},{"label":"Nov","value":465},{"label":"Dez","value":543}];
const MX = 639;
