...
const PAGE = "IoT &amp; Sensors";
const KPIS = [{"l":"Dispositivos Online","v":"3.172","t":"-3.1%","d":"down"},{"l":"Dados/Min (MB)","v":"4.633","t":"+10.0%","d":"up"},{"l":"Alertas Ativos","v":"763","t":"+7.3%","d":"up"},{"l":"Uptime (%)","v":"86.1%","t":"+10.6%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.817","5.835","4.430","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.629","4.251","5.627","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","9.046","420","902","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.552","5.369","2.552","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","991","4.765","3.917","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":508},{"label":"Fev","value":798},{"label":"Mar","value":708},{"label":"Abr","value":550},{"label":"Mai","value":446},{"label":"Jun","value":751},{"label":"Jul","value":677},{"label":"Ago","value":652},{"label":"Set","value":544},{"label":"Out","value":621},{"label":"Nov","value":508},{"label":"Dez","value":519}];
const MX = 798;
