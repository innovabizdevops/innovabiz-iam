...
const ACCENT = "#6366f1";
const MODULE = "Manufacturing Services";
const PAGE = "Shop Floor Control";
const KPIS = [{"l":"Total Manufacturing Services","v":"7.400","t":"-2.2%","d":"down"},{"l":"Shop Floor Control Ativos","v":"2.021","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"68.4%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"85","t":"+13.2%","d":"up"}];
const COLS = ["ID","Shop Floor Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Manufacturing Services #001","Manufacturing Services #002","4.919","385","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Manufacturing Services #002","Manufacturing Services #003","7.247","2.402","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Manufacturing Services #003","Manufacturing Services #004","5.967","6.302","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Manufacturing Services #004","Manufacturing Services #005","5.666","1.963","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Manufacturing Services #005","Manufacturing Services #001","5.868","801","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":601},{"label":"Mar","value":628},{"label":"Abr","value":740},{"label":"Mai","value":564},{"label":"Jun","value":357},{"label":"Jul","value":429},{"label":"Ago","value":463},{"label":"Set","value":369},{"label":"Out","value":709},{"label":"Nov","value":604},{"label":"Dez","value":715}];
const MX = 740;
...
export default function ShopFloorManufacturingPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>MES</span></h1>
                </div>
