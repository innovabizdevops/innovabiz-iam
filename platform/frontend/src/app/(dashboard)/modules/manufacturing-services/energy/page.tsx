...
const PAGE = "Energy Management";
const KPIS = [{"l":"Projetos Melhoria","v":"7.573","t":"+3.3%","d":"up"},{"l":"Savings (€)","v":"€24559","t":"+15.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"69.3%","t":"+9.1%","d":"up"},{"l":"Ciclos PDCA","v":"1.327","t":"+5.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.573","€ 19845.80","836","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.326","€ 14830.62","7.963","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.010","€ 25694.35","791","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.444","€ 46088.23","3.626","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","642","€ 31269.07","7.775","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":657},{"label":"Mar","value":754},{"label":"Abr","value":841},{"label":"Mai","value":527},{"label":"Jun","value":761},{"label":"Jul","value":816},{"label":"Ago","value":600},{"label":"Set","value":674},{"label":"Out","value":827},{"label":"Nov","value":768},{"label":"Dez","value":755}];
const MX = 841;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>ISO 50001</span></h1>
                </div>
