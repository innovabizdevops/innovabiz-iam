...
const PAGE = "Industry 4.0 Maturity";
const KPIS = [{"l":"Total Manufacturing Services","v":"632","t":"-2.5%","d":"down"},{"l":"Industry 4.0 Maturity Ativos","v":"4.482","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"78.3%","t":"-5.2%","d":"down"},{"l":"Score Performance","v":"76","t":"+17.7%","d":"up"}];
const COLS = ["ID","Industry 4.0 Maturity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Manufacturing Services #001","Manufacturing Services #002","6.477","3.106","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Manufacturing Services #002","Manufacturing Services #003","163","1.235","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Manufacturing Services #003","Manufacturing Services #004","2.203","648","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Manufacturing Services #004","Manufacturing Services #005","3.806","1.350","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Manufacturing Services #005","Manufacturing Services #001","8.120","6.238","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":825},{"label":"Mar","value":881},{"label":"Abr","value":881},{"label":"Mai","value":889},{"label":"Jun","value":855},{"label":"Jul","value":991},{"label":"Ago","value":946},{"label":"Set","value":740},{"label":"Out","value":808},{"label":"Nov","value":882},{"label":"Dez","value":733}];
const MX = 991;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>I4.0</span></h1>
                </div>
