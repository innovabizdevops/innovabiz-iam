...
const PAGE = "MRP Planning";
const KPIS = [{"l":"Total Manufacturing Services","v":"4.767","t":"+9.2%","d":"up"},{"l":"MRP Planning Ativos","v":"7.148","t":"+5.3%","d":"up"},{"l":"Eficiência (%)","v":"74.6%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"89","t":"+15.9%","d":"up"}];
const COLS = ["ID","MRP Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Manufacturing Services #001","Manufacturing Services #002","358","7.894","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Manufacturing Services #002","Manufacturing Services #003","6.255","6.523","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Manufacturing Services #003","Manufacturing Services #004","5.933","3.733","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Manufacturing Services #004","Manufacturing Services #005","8.531","3.553","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Manufacturing Services #005","Manufacturing Services #001","1.638","1.713","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":647},{"label":"Mar","value":831},{"label":"Abr","value":532},{"label":"Mai","value":705},{"label":"Jun","value":769},{"label":"Jul","value":886},{"label":"Ago","value":574},{"label":"Set","value":640},{"label":"Out","value":891},{"label":"Nov","value":529},{"label":"Dez","value":770}];
const MX = 891;
