...
const PAGE = "PLM Integration";
const KPIS = [{"l":"Integrações Ativas","v":"6.271","t":"+3.8%","d":"up"},{"l":"Chamadas/Hora","v":"928","t":"+10.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"66.4%","t":"+10.6%","d":"up"},{"l":"Latência Média (ms)","v":"110ms","t":"+10.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","815","6.965","86.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.091","8.780","91.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.037","1.238","96.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.810","5.263","91.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.975","7.174","87.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":659},{"label":"Mar","value":758},{"label":"Abr","value":802},{"label":"Mai","value":892},{"label":"Jun","value":893},{"label":"Jul","value":927},{"label":"Ago","value":817},{"label":"Set","value":901},{"label":"Out","value":751},{"label":"Nov","value":825},{"label":"Dez","value":981}];
const MX = 981;
