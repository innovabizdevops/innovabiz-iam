...
const PAGE = "OPC-UA Connectivity";
const KPIS = [{"l":"Total Manufacturing Services","v":"597","t":"+10.1%","d":"up"},{"l":"OPC UA Connectivity Ativos","v":"6.342","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"81.0%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"69","t":"+11.8%","d":"up"}];
const COLS = ["ID","OPC UA Connectivity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Manufacturing Services #001","Manufacturing Services #002","3.581","171","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Manufacturing Services #002","Manufacturing Services #003","8.571","8.817","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Manufacturing Services #003","Manufacturing Services #004","7.315","5.070","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Manufacturing Services #004","Manufacturing Services #005","1.583","3.459","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Manufacturing Services #005","Manufacturing Services #001","8.110","4.557","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":261},{"label":"Mar","value":648},{"label":"Abr","value":430},{"label":"Mai","value":559},{"label":"Jun","value":355},{"label":"Jul","value":542},{"label":"Ago","value":295},{"label":"Set","value":538},{"label":"Out","value":652},{"label":"Nov","value":541},{"label":"Dez","value":301}];
const MX = 652;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>OPC</span></h1>
                </div>
