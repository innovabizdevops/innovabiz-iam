...
const PAGE = "Quality Inline";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.053","t":"+12.4%","d":"up"},{"l":"NC Abertas","v":"6.070","t":"+1.0%","d":"up"},{"l":"Conformidade (%)","v":"67.0%","t":"-3.4%","d":"down"},{"l":"CAPAs Pendentes","v":"3.970","t":"+12.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.831","94.9%","3.900","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.927","94.5%","3.078","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.328","82.8%","4.232","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.045","78.5%","2.934","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.317","85.6%","5.055","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":465},{"label":"Fev","value":703},{"label":"Mar","value":452},{"label":"Abr","value":706},{"label":"Mai","value":408},{"label":"Jun","value":446},{"label":"Jul","value":781},{"label":"Ago","value":578},{"label":"Set","value":406},{"label":"Out","value":403},{"label":"Nov","value":577},{"label":"Dez","value":408}];
const MX = 781;
...
export default function QualityInlinePage() {
    return (
