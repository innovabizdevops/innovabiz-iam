...
const PAGE = "ISA-95 Integration";
const KPIS = [{"l":"Integrações Ativas","v":"4.647","t":"-3.5%","d":"down"},{"l":"Chamadas/Hora","v":"1112","t":"+0.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.6%","t":"+8.5%","d":"up"},{"l":"Latência Média (ms)","v":"118ms","t":"-3.4%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.725","8.754","81.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.122","7.525","74.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.686","1.126","80.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.788","8.515","73.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.928","6.501","70.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":336},{"label":"Fev","value":296},{"label":"Mar","value":611},{"label":"Abr","value":261},{"label":"Mai","value":435},{"label":"Jun","value":628},{"label":"Jul","value":334},{"label":"Ago","value":375},{"label":"Set","value":550},{"label":"Out","value":504},{"label":"Nov","value":347},{"label":"Dez","value":507}];
const MX = 628;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>ISA</span></h1>
                </div>
