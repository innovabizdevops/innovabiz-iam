...
const PAGE = "Shop Floor";
const KPIS = [{"l":"Total Manufacturing Services","v":"4.596","t":"+11.4%","d":"up"},{"l":"Shop Floor Ativos","v":"7.385","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"81.7%","t":"+17.2%","d":"up"},{"l":"Score Performance","v":"65","t":"-5.5%","d":"down"}];
const COLS = ["ID","Shop Floor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Manufacturing Services #001","Manufacturing Services #002","8.286","8.184","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Manufacturing Services #002","Manufacturing Services #003","3.827","4.230","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Manufacturing Services #003","Manufacturing Services #004","7.837","6.861","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Manufacturing Services #004","Manufacturing Services #005","2.553","1.120","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Manufacturing Services #005","Manufacturing Services #001","3.794","4.609","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":621},{"label":"Mar","value":634},{"label":"Abr","value":734},{"label":"Mai","value":764},{"label":"Jun","value":610},{"label":"Jul","value":417},{"label":"Ago","value":431},{"label":"Set","value":799},{"label":"Out","value":614},{"label":"Nov","value":642},{"label":"Dez","value":418}];
const MX = 799;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>New</span></h1>
                </div>
