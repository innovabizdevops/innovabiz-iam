...
const ACCENT = "#dc2626";
const MODULE = "Ad Server Platform";
const PAGE = "Targeting";
const KPIS = [{"l":"Total Ad Server","v":"1.201","t":"+9.3%","d":"up"},{"l":"Targeting Ativos","v":"2.403","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"79.2%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"94","t":"+3.3%","d":"up"}];
const COLS = ["ID","Targeting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ad Server #001","Ad Server #002","3.405","4.327","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Ad Server #002","Ad Server #003","2.333","2.515","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Ad Server #003","Ad Server #004","2.668","1.917","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Ad Server #004","Ad Server #005","4.295","1.995","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ad Server #005","Ad Server #001","8.627","4.158","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":554},{"label":"Mar","value":741},{"label":"Abr","value":591},{"label":"Mai","value":441},{"label":"Jun","value":714},{"label":"Jul","value":573},{"label":"Ago","value":550},{"label":"Set","value":655},{"label":"Out","value":544},{"label":"Nov","value":526},{"label":"Dez","value":645}];
const MX = 741;
