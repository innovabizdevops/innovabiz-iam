...
const PAGE = "Connected TV";
const KPIS = [{"l":"Total Ad Server","v":"3.738","t":"+16.0%","d":"up"},{"l":"Connected TV Ativos","v":"1.389","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"93.4%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"80","t":"+1.8%","d":"up"}];
const COLS = ["ID","Connected TV","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ad Server #001","Ad Server #002","1.004","3.733","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Ad Server #002","Ad Server #003","3.353","421","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Ad Server #003","Ad Server #004","7.391","3.926","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Ad Server #004","Ad Server #005","8.040","5.283","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ad Server #005","Ad Server #001","3.874","4.603","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":891},{"label":"Fev","value":808},{"label":"Mar","value":909},{"label":"Abr","value":549},{"label":"Mai","value":802},{"label":"Jun","value":778},{"label":"Jul","value":563},{"label":"Ago","value":582},{"label":"Set","value":712},{"label":"Out","value":542},{"label":"Nov","value":793},{"label":"Dez","value":654}];
const MX = 909;
