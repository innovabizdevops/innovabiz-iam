...
const PAGE = "DOOH Mgmt";
const KPIS = [{"l":"Total Ad Server","v":"4.365","t":"-4.5%","d":"down"},{"l":"DOOH Mgmt Ativos","v":"2.132","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"77.1%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"76","t":"+9.6%","d":"up"}];
const COLS = ["ID","DOOH Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ad Server #001","Ad Server #002","4.848","5.759","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Ad Server #002","Ad Server #003","2.099","8.417","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Ad Server #003","Ad Server #004","7.788","3.286","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Ad Server #004","Ad Server #005","8.736","1.500","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ad Server #005","Ad Server #001","8.439","6.522","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":892},{"label":"Fev","value":734},{"label":"Mar","value":704},{"label":"Abr","value":714},{"label":"Mai","value":825},{"label":"Jun","value":775},{"label":"Jul","value":663},{"label":"Ago","value":899},{"label":"Set","value":889},{"label":"Out","value":616},{"label":"Nov","value":620},{"label":"Dez","value":641}];
const MX = 899;
