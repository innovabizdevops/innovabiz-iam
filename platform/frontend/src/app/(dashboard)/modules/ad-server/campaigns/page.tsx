...
const KPIS = [{"l":"Total Ad Server","v":"5.477","t":"+3.1%","d":"up"},{"l":"Campaign Mgmt Ativos","v":"420","t":"+0.9%","d":"up"},{"l":"Eficiência (%)","v":"71.6%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"88","t":"+2.4%","d":"up"}];
const COLS = ["ID","Campaign Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ad Server #001","Ad Server #002","805","5.802","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Ad Server #002","Ad Server #003","6.547","7.097","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Ad Server #003","Ad Server #004","5.044","8.306","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Ad Server #004","Ad Server #005","3.782","3.523","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ad Server #005","Ad Server #001","8.407","1.343","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":718},{"label":"Fev","value":820},{"label":"Mar","value":787},{"label":"Abr","value":960},{"label":"Mai","value":709},{"label":"Jun","value":703},{"label":"Jul","value":884},{"label":"Ago","value":971},{"label":"Set","value":760},{"label":"Out","value":1071},{"label":"Nov","value":919},{"label":"Dez","value":801}];
const MX = 1071;
