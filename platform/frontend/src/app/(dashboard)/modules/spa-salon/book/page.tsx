...
const PAGE = "Book";
const KPIS = [{"l":"Quartos Ocupados","v":"7.828","t":"+5.2%","d":"up"},{"l":"RevPAR (€)","v":"€80789","t":"-1.4%","d":"down"},{"l":"Ocupação (%)","v":"66.0%","t":"+5.4%","d":"up"},{"l":"Guest Satisfaction","v":"6.682","t":"+16.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.166","2026-02-19","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","5.920","2026-03-28","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","4.686","2026-01-09","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.574","2026-03-16","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.858","2026-03-20","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":569},{"label":"Mar","value":535},{"label":"Abr","value":687},{"label":"Mai","value":782},{"label":"Jun","value":819},{"label":"Jul","value":578},{"label":"Ago","value":853},{"label":"Set","value":596},{"label":"Out","value":744},{"label":"Nov","value":889},{"label":"Dez","value":741}];
const MX = 889;
