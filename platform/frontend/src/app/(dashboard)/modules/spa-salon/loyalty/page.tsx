...
const PAGE = "Loyalty";
const KPIS = [{"l":"Quartos Ocupados","v":"2.689","t":"+8.0%","d":"up"},{"l":"RevPAR (€)","v":"€32139","t":"+3.0%","d":"up"},{"l":"Ocupação (%)","v":"81.0%","t":"-3.1%","d":"down"},{"l":"Guest Satisfaction","v":"8.100","t":"+2.6%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.647","2026-02-11","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","2.959","2026-03-06","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.231","2026-01-11","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","2.517","2026-01-12","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.528","2026-01-05","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":975},{"label":"Mar","value":803},{"label":"Abr","value":813},{"label":"Mai","value":738},{"label":"Jun","value":697},{"label":"Jul","value":650},{"label":"Ago","value":810},{"label":"Set","value":818},{"label":"Out","value":649},{"label":"Nov","value":745},{"label":"Dez","value":887}];
const MX = 975;
