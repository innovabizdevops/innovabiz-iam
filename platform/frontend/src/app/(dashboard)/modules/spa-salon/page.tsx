...
/* ═══ Spa & Salon Management — Dashboard ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total Registos", value: "9513", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1406", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€361K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1502591813", cells: ["SPA-6813", "Spa & Salon Management Item 1", "10/6/2026", "€41 913"], status: "active" as const },
    { id: "1502595384", cells: ["SPA-1384", "Spa & Salon Management Item 2", "25/1/2026", "€45 484"], status: "pending" as const },
    { id: "1502598955", cells: ["SPA-4955", "Spa & Salon Management Item 3", "12/8/2026", "€49 055"], status: "completed" as const },
    { id: "1502602526", cells: ["SPA-8526", "Spa & Salon Management Item 4", "27/3/2026", "€2626"], status: "warning" as const },
    { id: "1502606097", cells: ["SPA-3097", "Spa & Salon Management Item 5", "14/10/2026", "€6197"], status: "active" as const },
];
...
export default function SpaSalonManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Spa & Salon Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Spa & Salon Management</p>
                    </div>
                </div>
