...
const ACCENT = "#b91c1c";
const MODULE = "Spa & Salon Management";
const PAGE = "Product";
const KPIS = [{"l":"Quartos Ocupados","v":"3.077","t":"+5.0%","d":"up"},{"l":"RevPAR (€)","v":"€45395","t":"+17.8%","d":"up"},{"l":"Ocupação (%)","v":"76.6%","t":"+0.7%","d":"up"},{"l":"Guest Satisfaction","v":"4.245","t":"+9.3%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.135","2026-01-16","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.270","2026-03-25","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.860","2026-01-03","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","2.120","2026-03-12","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.421","2026-02-20","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":716},{"label":"Mar","value":742},{"label":"Abr","value":664},{"label":"Mai","value":439},{"label":"Jun","value":507},{"label":"Jul","value":395},{"label":"Ago","value":587},{"label":"Set","value":577},{"label":"Out","value":375},{"label":"Nov","value":700},{"label":"Dez","value":556}];
const MX = 742;
