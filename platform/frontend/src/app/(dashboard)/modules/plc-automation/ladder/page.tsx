...
const PAGE = "Ladder";
const KPIS = [{"l":"Dispositivos Online","v":"7.282","t":"+2.6%","d":"up"},{"l":"Dados/Min (MB)","v":"3.506","t":"+11.7%","d":"up"},{"l":"Alertas Ativos","v":"3.523","t":"+10.6%","d":"up"},{"l":"Uptime (%)","v":"87.1%","t":"-2.3%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.606","4.199","3.799","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.762","4.678","3.218","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.330","7.108","4.238","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","357","2.314","2.051","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.618","5.511","2.321","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":426},{"label":"Mar","value":515},{"label":"Abr","value":603},{"label":"Mai","value":545},{"label":"Jun","value":628},{"label":"Jul","value":508},{"label":"Ago","value":408},{"label":"Set","value":629},{"label":"Out","value":425},{"label":"Nov","value":421},{"label":"Dez","value":451}];
const MX = 629;
