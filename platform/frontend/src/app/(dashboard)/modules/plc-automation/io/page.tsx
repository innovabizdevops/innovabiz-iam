...
const ACCENT = "#6366f1";
const MODULE = "PLC Automation";
const PAGE = "I/O Config";
const KPIS = [{"l":"Dispositivos Online","v":"5.518","t":"-3.4%","d":"down"},{"l":"Dados/Min (MB)","v":"5.330","t":"-2.9%","d":"down"},{"l":"Alertas Ativos","v":"1.201","t":"+7.6%","d":"up"},{"l":"Uptime (%)","v":"65.0%","t":"+12.7%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.514","1.809","5.621","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.540","416","2.784","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.137","4.305","1.502","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","4.989","4.736","8.443","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.471","4.775","5.682","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":493},{"label":"Mar","value":657},{"label":"Abr","value":487},{"label":"Mai","value":468},{"label":"Jun","value":332},{"label":"Jul","value":417},{"label":"Ago","value":427},{"label":"Set","value":499},{"label":"Out","value":639},{"label":"Nov","value":332},{"label":"Dez","value":447}];
const MX = 657;
