...
const PAGE = "Diagnose";
const KPIS = [{"l":"Dispositivos Online","v":"2.551","t":"+10.4%","d":"up"},{"l":"Dados/Min (MB)","v":"5.090","t":"-5.0%","d":"down"},{"l":"Alertas Ativos","v":"1.909","t":"+10.7%","d":"up"},{"l":"Uptime (%)","v":"77.2%","t":"+13.4%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","8.553","1.572","1.958","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.224","5.753","7.697","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.248","4.651","5.178","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.288","7.376","5.507","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","942","3.676","1.330","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":465},{"label":"Mar","value":602},{"label":"Abr","value":753},{"label":"Mai","value":564},{"label":"Jun","value":498},{"label":"Jul","value":669},{"label":"Ago","value":647},{"label":"Set","value":702},{"label":"Out","value":739},{"label":"Nov","value":674},{"label":"Dez","value":537}];
const MX = 753;
