...
const PAGE = "Program";
const KPIS = [{"l":"Dispositivos Online","v":"317","t":"+1.8%","d":"up"},{"l":"Dados/Min (MB)","v":"251","t":"+16.3%","d":"up"},{"l":"Alertas Ativos","v":"3.504","t":"-2.8%","d":"down"},{"l":"Uptime (%)","v":"70.4%","t":"+3.6%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.249","2.007","1.605","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.528","6.829","7.026","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.349","4.875","5.220","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.747","3.608","514","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","504","8.378","3.255","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":870},{"label":"Mar","value":846},{"label":"Abr","value":709},{"label":"Mai","value":900},{"label":"Jun","value":853},{"label":"Jul","value":905},{"label":"Ago","value":521},{"label":"Set","value":519},{"label":"Out","value":753},{"label":"Nov","value":602},{"label":"Dez","value":628}];
const MX = 905;
