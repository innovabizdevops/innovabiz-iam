...
export default function PlcAutomationPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Plc Automation</h1><p className="text-sm text-muted-foreground">Plc Automation • iBOS Enterprise</p></div>
