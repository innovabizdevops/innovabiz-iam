...
const PAGE = "HMI";
const KPIS = [{"l":"Dispositivos Online","v":"5.811","t":"+17.6%","d":"up"},{"l":"Dados/Min (MB)","v":"5.774","t":"+5.0%","d":"up"},{"l":"Alertas Ativos","v":"2.229","t":"+0.2%","d":"up"},{"l":"Uptime (%)","v":"81.3%","t":"-0.2%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.395","1.793","2.972","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.002","1.491","7.496","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.283","3.714","4.998","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.940","5.643","2.543","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.495","8.910","5.030","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":516},{"label":"Mar","value":290},{"label":"Abr","value":654},{"label":"Mai","value":388},{"label":"Jun","value":625},{"label":"Jul","value":393},{"label":"Ago","value":318},{"label":"Set","value":353},{"label":"Out","value":337},{"label":"Nov","value":542},{"label":"Dez","value":314}];
const MX = 654;
