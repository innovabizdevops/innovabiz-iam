...
const ACCENT = "#6366f1";
const MODULE = "Consent & Preference Mgmt";
const PAGE = "Enforce";
const KPIS = [{"l":"Configurações","v":"5.920","t":"+12.3%","d":"up"},{"l":"Últimas Alterações","v":"3.004","t":"-0.1%","d":"down"},{"l":"Ambientes","v":"1.308","t":"-2.1%","d":"down"},{"l":"Versão Config","v":"1.750","t":"+8.0%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 24264.60","2.545","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 16110.05","6.579","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 11357.31","4.768","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 8369.62","5.850","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 22793.08","1.619","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":241},{"label":"Fev","value":465},{"label":"Mar","value":461},{"label":"Abr","value":489},{"label":"Mai","value":214},{"label":"Jun","value":256},{"label":"Jul","value":467},{"label":"Ago","value":521},{"label":"Set","value":526},{"label":"Out","value":435},{"label":"Nov","value":470},{"label":"Dez","value":580}];
const MX = 580;
