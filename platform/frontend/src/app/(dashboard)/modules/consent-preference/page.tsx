...
/* ═══ Consent & Preference Mgmt — Dashboard ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total Registos", value: "4807", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4545", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€153K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "-15%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1136267307", cells: ["CON-9307", "Consent & Preference Mgmt Item 1", "8/4/2026", "€17 407"], status: "active" as const },
    { id: "1136270878", cells: ["CON-3878", "Consent & Preference Mgmt Item 2", "23/11/2026", "€20 978"], status: "pending" as const },
    { id: "1136274449", cells: ["CON-7449", "Consent & Preference Mgmt Item 3", "10/6/2026", "€24 549"], status: "completed" as const },
    { id: "1136278020", cells: ["CON-2020", "Consent & Preference Mgmt Item 4", "25/1/2026", "€28 120"], status: "warning" as const },
    { id: "1136281591", cells: ["CON-5591", "Consent & Preference Mgmt Item 5", "12/8/2026", "€31 691"], status: "active" as const },
];
...
export default function ConsentPreferenceMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Consent & Preference Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Consent & Preference Mgmt</p>
                    </div>
                </div>
