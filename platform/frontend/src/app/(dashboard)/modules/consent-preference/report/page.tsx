...
const PAGE = "Report";
const KPIS = [{"l":"Configurações","v":"9.091","t":"+9.3%","d":"up"},{"l":"Últimas Alterações","v":"9.077","t":"+10.5%","d":"up"},{"l":"Ambientes","v":"6.660","t":"+5.7%","d":"up"},{"l":"Versão Config","v":"9.094","t":"+6.1%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 4722.02","1.354","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 12018.72","6.466","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 660.23","2.491","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 12269.71","7.122","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 21157.79","3.184","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":500},{"label":"Mar","value":493},{"label":"Abr","value":302},{"label":"Mai","value":621},{"label":"Jun","value":432},{"label":"Jul","value":650},{"label":"Ago","value":367},{"label":"Set","value":505},{"label":"Out","value":461},{"label":"Nov","value":642},{"label":"Dez","value":466}];
const MX = 650;
