...
const PAGE = "Collect";
const KPIS = [{"l":"Configurações","v":"309","t":"+16.7%","d":"up"},{"l":"Últimas Alterações","v":"2.821","t":"+2.0%","d":"up"},{"l":"Ambientes","v":"2.337","t":"+-0.0%","d":"up"},{"l":"Versão Config","v":"5.408","t":"+8.8%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 14643.80","1.585","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 39593.04","5.196","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 18200.22","4.056","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 31362.86","2.180","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 28979.31","2.584","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":864},{"label":"Mar","value":590},{"label":"Abr","value":733},{"label":"Mai","value":803},{"label":"Jun","value":744},{"label":"Jul","value":738},{"label":"Ago","value":536},{"label":"Set","value":671},{"label":"Out","value":856},{"label":"Nov","value":679},{"label":"Dez","value":571}];
const MX = 864;
