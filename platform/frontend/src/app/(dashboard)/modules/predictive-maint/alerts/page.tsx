...
const PAGE = "Alert Config";
const KPIS = [{"l":"Integrações Ativas","v":"8.580","t":"+6.2%","d":"up"},{"l":"Chamadas/Hora","v":"2325","t":"+5.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.5%","t":"+0.8%","d":"up"},{"l":"Latência Média (ms)","v":"30ms","t":"-3.7%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.564","4.262","81.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.163","395","80.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.014","1.417","72.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.426","3.408","71.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.619","2.327","94.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":840},{"label":"Mar","value":759},{"label":"Abr","value":789},{"label":"Mai","value":724},{"label":"Jun","value":744},{"label":"Jul","value":897},{"label":"Ago","value":921},{"label":"Set","value":738},{"label":"Out","value":713},{"label":"Nov","value":753},{"label":"Dez","value":701}];
const MX = 921;
