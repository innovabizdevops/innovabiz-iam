...
const KPIS = [{"l":"Integrações Ativas","v":"5.690","t":"+10.3%","d":"up"},{"l":"Chamadas/Hora","v":"3582","t":"-0.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"69.7%","t":"-2.9%","d":"down"},{"l":"Latência Média (ms)","v":"34ms","t":"+11.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.631","6.552","82.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.809","4.128","99.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.690","5.072","94.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.195","6.474","84.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.241","5.466","86.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":909},{"label":"Fev","value":989},{"label":"Mar","value":913},{"label":"Abr","value":734},{"label":"Mai","value":1014},{"label":"Jun","value":681},{"label":"Jul","value":900},{"label":"Ago","value":797},{"label":"Set","value":868},{"label":"Out","value":882},{"label":"Nov","value":925},{"label":"Dez","value":886}];
const MX = 1014;
