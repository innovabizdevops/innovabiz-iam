...
const ACCENT = "#dc2626";
const MODULE = "Predictive Maintenance";
const PAGE = "Spare Part Predict";
const KPIS = [{"l":"Integrações Ativas","v":"3.592","t":"+0.3%","d":"up"},{"l":"Chamadas/Hora","v":"2204","t":"+11.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"82.3%","t":"+5.2%","d":"up"},{"l":"Latência Média (ms)","v":"200ms","t":"-1.9%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.822","1.401","83.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.176","4.847","74.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.721","1.682","91.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.385","578","71.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.885","960","83.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":290},{"label":"Fev","value":329},{"label":"Mar","value":447},{"label":"Abr","value":489},{"label":"Mai","value":371},{"label":"Jun","value":347},{"label":"Jul","value":631},{"label":"Ago","value":572},{"label":"Set","value":322},{"label":"Out","value":507},{"label":"Nov","value":478},{"label":"Dez","value":361}];
const MX = 631;
...
export default function SparePredictPage() {
    return (
