...
const PAGE = "ROI Dashboard";
const KPIS = [{"l":"Integrações Ativas","v":"4.204","t":"+11.2%","d":"up"},{"l":"Chamadas/Hora","v":"2535","t":"+8.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.1%","t":"+11.2%","d":"up"},{"l":"Latência Média (ms)","v":"117ms","t":"+2.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.535","5.462","99.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.438","1.125","70.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","920","269","88.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.194","4.112","77.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.688","9.099","96.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":549},{"label":"Mar","value":671},{"label":"Abr","value":734},{"label":"Mai","value":679},{"label":"Jun","value":451},{"label":"Jul","value":656},{"label":"Ago","value":584},{"label":"Set","value":801},{"label":"Out","value":723},{"label":"Nov","value":451},{"label":"Dez","value":710}];
const MX = 801;
