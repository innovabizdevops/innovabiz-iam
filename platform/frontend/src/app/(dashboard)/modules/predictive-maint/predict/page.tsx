...
const PAGE = "Failure Predict";
const KPIS = [{"l":"Integrações Ativas","v":"3.322","t":"+10.4%","d":"up"},{"l":"Chamadas/Hora","v":"3398","t":"+3.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"91.6%","t":"+1.5%","d":"up"},{"l":"Latência Média (ms)","v":"183ms","t":"-3.4%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.651","8.065","96.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.012","7.126","92.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.563","3.575","84.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.638","444","90.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.477","8.512","96.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":731},{"label":"Mar","value":612},{"label":"Abr","value":546},{"label":"Mai","value":696},{"label":"Jun","value":492},{"label":"Jul","value":593},{"label":"Ago","value":590},{"label":"Set","value":390},{"label":"Out","value":699},{"label":"Nov","value":763},{"label":"Dez","value":598}];
const MX = 763;
