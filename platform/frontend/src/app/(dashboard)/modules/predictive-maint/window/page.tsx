...
const PAGE = "Maintenance Window";
const KPIS = [{"l":"Integrações Ativas","v":"4.621","t":"+14.0%","d":"up"},{"l":"Chamadas/Hora","v":"720","t":"+9.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.1%","t":"+11.2%","d":"up"},{"l":"Latência Média (ms)","v":"181ms","t":"+6.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.818","8.106","84.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.120","4.348","81.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.129","7.431","74.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.708","2.922","78.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.390","3.462","88.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":251},{"label":"Fev","value":311},{"label":"Mar","value":366},{"label":"Abr","value":512},{"label":"Mai","value":379},{"label":"Jun","value":525},{"label":"Jul","value":473},{"label":"Ago","value":520},{"label":"Set","value":493},{"label":"Out","value":584},{"label":"Nov","value":273},{"label":"Dez","value":325}];
const MX = 584;
