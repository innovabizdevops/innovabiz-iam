...
const PAGE = "RUL Estimation";
const KPIS = [{"l":"Integrações Ativas","v":"2.163","t":"-1.6%","d":"down"},{"l":"Chamadas/Hora","v":"3365","t":"+9.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"94.1%","t":"-5.6%","d":"down"},{"l":"Latência Média (ms)","v":"38ms","t":"+15.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.243","4.847","88.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","233","8.941","78.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.282","7.451","92.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.072","7.093","70.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.027","3.601","91.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":863},{"label":"Fev","value":506},{"label":"Mar","value":759},{"label":"Abr","value":733},{"label":"Mai","value":800},{"label":"Jun","value":634},{"label":"Jul","value":597},{"label":"Ago","value":499},{"label":"Set","value":555},{"label":"Out","value":739},{"label":"Nov","value":562},{"label":"Dez","value":584}];
const MX = 863;
