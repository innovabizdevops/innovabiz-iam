...
const PAGE = "Student";
const KPIS = [{"l":"Total Driving School","v":"7.803","t":"-3.1%","d":"down"},{"l":"Student Ativos","v":"609","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"66.6%","t":"+6.5%","d":"up"},{"l":"Score Performance","v":"68","t":"-2.0%","d":"down"}];
const COLS = ["ID","Student","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Driving School #001","Driving School #002","7.856","6.642","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Driving School #002","Driving School #003","3.643","1.824","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Driving School #003","Driving School #004","905","5.890","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Driving School #004","Driving School #005","8.194","2.695","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Driving School #005","Driving School #001","8.720","969","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":940},{"label":"Fev","value":1053},{"label":"Mar","value":945},{"label":"Abr","value":816},{"label":"Mai","value":883},{"label":"Jun","value":695},{"label":"Jul","value":948},{"label":"Ago","value":929},{"label":"Set","value":976},{"label":"Out","value":997},{"label":"Nov","value":1062},{"label":"Dez","value":725}];
const MX = 1062;
