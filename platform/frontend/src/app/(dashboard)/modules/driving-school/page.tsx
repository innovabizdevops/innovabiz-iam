...
const KPIS = [
    { label: "Total Registos", value: "3639", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1067", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€50K", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1394329439", cells: ["DRI-5439", "Driving School Item 1", "28/12/2026", "€29 539"], status: "active" as const },
    { id: "1394333010", cells: ["DRI-9010", "Driving School Item 2", "15/7/2026", "€33 110"], status: "pending" as const },
    { id: "1394336581", cells: ["DRI-3581", "Driving School Item 3", "2/2/2026", "€36 681"], status: "completed" as const },
    { id: "1394340152", cells: ["DRI-7152", "Driving School Item 4", "17/9/2026", "€40 252"], status: "warning" as const },
    { id: "1394343723", cells: ["DRI-1723", "Driving School Item 5", "4/4/2026", "€43 823"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Driving School</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Driving School</p>
                    </div>
                </div>
