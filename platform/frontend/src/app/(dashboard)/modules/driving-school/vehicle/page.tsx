...
const ACCENT = "#0891b2";
const MODULE = "Driving School";
const PAGE = "Vehicle";
const KPIS = [{"l":"Total Driving School","v":"7.636","t":"+3.3%","d":"up"},{"l":"Vehicle Ativos","v":"5.376","t":"+4.0%","d":"up"},{"l":"Eficiência (%)","v":"73.9%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"77","t":"+15.3%","d":"up"}];
const COLS = ["ID","Vehicle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Driving School #001","Driving School #002","3.360","7.191","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Driving School #002","Driving School #003","4.590","611","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Driving School #003","Driving School #004","6.054","1.241","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Driving School #004","Driving School #005","7.315","1.281","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Driving School #005","Driving School #001","8.082","2.204","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":745},{"label":"Mar","value":883},{"label":"Abr","value":906},{"label":"Mai","value":722},{"label":"Jun","value":752},{"label":"Jul","value":926},{"label":"Ago","value":792},{"label":"Set","value":1017},{"label":"Out","value":900},{"label":"Nov","value":936},{"label":"Dez","value":1012}];
const MX = 1017;
