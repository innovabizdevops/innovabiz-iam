...
const PAGE = "License";
const KPIS = [{"l":"Total Driving School","v":"3.165","t":"-2.1%","d":"down"},{"l":"License Ativos","v":"4.419","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"65.2%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"70","t":"+0.8%","d":"up"}];
const COLS = ["ID","License","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Driving School #001","Driving School #002","2.455","3.235","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Driving School #002","Driving School #003","2.695","5.796","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Driving School #003","Driving School #004","8.341","7.018","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Driving School #004","Driving School #005","2.873","8.289","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Driving School #005","Driving School #001","1.918","1.004","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":725},{"label":"Mar","value":732},{"label":"Abr","value":905},{"label":"Mai","value":724},{"label":"Jun","value":925},{"label":"Jul","value":650},{"label":"Ago","value":681},{"label":"Set","value":968},{"label":"Out","value":963},{"label":"Nov","value":766},{"label":"Dez","value":780}];
const MX = 968;
