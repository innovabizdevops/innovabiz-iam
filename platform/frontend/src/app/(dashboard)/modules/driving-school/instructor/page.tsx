...
const KPIS = [{"l":"Total Driving School","v":"4.305","t":"-2.7%","d":"down"},{"l":"Instructor Ativos","v":"2.092","t":"+14.8%","d":"up"},{"l":"Eficiência (%)","v":"82.4%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"82","t":"-0.1%","d":"down"}];
const COLS = ["ID","Instructor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Driving School #001","Driving School #002","6.455","1.316","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Driving School #002","Driving School #003","7.250","6.975","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Driving School #003","Driving School #004","5.555","1.242","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Driving School #004","Driving School #005","4.298","6.541","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Driving School #005","Driving School #001","7.337","6.450","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":581},{"label":"Fev","value":478},{"label":"Mar","value":501},{"label":"Abr","value":541},{"label":"Mai","value":469},{"label":"Jun","value":338},{"label":"Jul","value":333},{"label":"Ago","value":344},{"label":"Set","value":443},{"label":"Out","value":419},{"label":"Nov","value":297},{"label":"Dez","value":398}];
const MX = 581;
