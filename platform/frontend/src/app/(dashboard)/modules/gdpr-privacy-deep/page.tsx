...
/* ═══ GDPR Privacy Ops Deep — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "158", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2486", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€152K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "412077658", cells: ["GDP-4658", "GDPR Privacy Ops Deep Item 1", "7/11/2026", "€27 758"], status: "active" as const },
    { id: "412081229", cells: ["GDP-8229", "GDPR Privacy Ops Deep Item 2", "22/6/2026", "€31 329"], status: "pending" as const },
    { id: "412084800", cells: ["GDP-2800", "GDPR Privacy Ops Deep Item 3", "9/1/2026", "€34 900"], status: "completed" as const },
    { id: "412088371", cells: ["GDP-6371", "GDPR Privacy Ops Deep Item 4", "24/8/2026", "€38 471"], status: "warning" as const },
    { id: "412091942", cells: ["GDP-9942", "GDPR Privacy Ops Deep Item 5", "11/3/2026", "€42 042"], status: "active" as const },
];
...
export default function GdprPrivacyOpsDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GDPR Privacy Ops Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GDPR Privacy Ops Deep</p>
                    </div>
                </div>
