...
const PAGE = "Archive";
const KPIS = [{"l":"Total Sat Imagery","v":"6.295","t":"+6.5%","d":"up"},{"l":"Archive Ativos","v":"5.388","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"85.1%","t":"+15.4%","d":"up"},{"l":"Score Performance","v":"71","t":"-2.0%","d":"down"}];
const COLS = ["ID","Archive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sat Imagery #001","Sat Imagery #002","3.358","1.756","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Sat Imagery #002","Sat Imagery #003","653","4.429","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Sat Imagery #003","Sat Imagery #004","3.458","6.683","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Sat Imagery #004","Sat Imagery #005","6.199","4.371","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sat Imagery #005","Sat Imagery #001","7.017","3.620","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":468},{"label":"Mar","value":612},{"label":"Abr","value":492},{"label":"Mai","value":291},{"label":"Jun","value":240},{"label":"Jul","value":449},{"label":"Ago","value":243},{"label":"Set","value":508},{"label":"Out","value":304},{"label":"Nov","value":591},{"label":"Dez","value":466}];
const MX = 612;
