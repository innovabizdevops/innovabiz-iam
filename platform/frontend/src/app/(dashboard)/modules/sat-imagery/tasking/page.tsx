...
const PAGE = "Tasking";
const KPIS = [{"l":"Total Sat Imagery","v":"1.902","t":"+10.9%","d":"up"},{"l":"Tasking Ativos","v":"8.593","t":"+15.0%","d":"up"},{"l":"Eficiência (%)","v":"85.8%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"88","t":"+0.3%","d":"up"}];
const COLS = ["ID","Tasking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sat Imagery #001","Sat Imagery #002","5.609","158","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Sat Imagery #002","Sat Imagery #003","4.109","2.841","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Sat Imagery #003","Sat Imagery #004","1.442","2.219","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Sat Imagery #004","Sat Imagery #005","5.494","5.112","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sat Imagery #005","Sat Imagery #001","4.495","4.989","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":853},{"label":"Mar","value":731},{"label":"Abr","value":760},{"label":"Mai","value":862},{"label":"Jun","value":706},{"label":"Jul","value":898},{"label":"Ago","value":578},{"label":"Set","value":834},{"label":"Out","value":573},{"label":"Nov","value":836},{"label":"Dez","value":639}];
const MX = 898;
