...
const ACCENT = "#059669";
const MODULE = "Satellite Imagery";
const PAGE = "Processing";
const KPIS = [{"l":"Total Sat Imagery","v":"5.218","t":"+6.1%","d":"up"},{"l":"Processing Ativos","v":"3.260","t":"+15.8%","d":"up"},{"l":"Eficiência (%)","v":"75.2%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"78","t":"+7.9%","d":"up"}];
const COLS = ["ID","Processing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sat Imagery #001","Sat Imagery #002","2.689","5.221","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Sat Imagery #002","Sat Imagery #003","2.271","8.100","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Sat Imagery #003","Sat Imagery #004","8.799","2.059","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Sat Imagery #004","Sat Imagery #005","7.109","4.250","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sat Imagery #005","Sat Imagery #001","3.559","4.881","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":389},{"label":"Fev","value":373},{"label":"Mar","value":411},{"label":"Abr","value":391},{"label":"Mai","value":550},{"label":"Jun","value":563},{"label":"Jul","value":390},{"label":"Ago","value":532},{"label":"Set","value":551},{"label":"Out","value":516},{"label":"Nov","value":504},{"label":"Dez","value":378}];
const MX = 563;
