...
const KPIS = [{"l":"Dashboards Ativos","v":"7.608","t":"+3.2%","d":"up"},{"l":"Queries/Dia","v":"258","t":"+1.0%","d":"up"},{"l":"Dados Processados (GB)","v":"3.170","t":"+9.1%","d":"up"},{"l":"Utilizadores Analytics","v":"4.795","t":"+17.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1105","2026-01-14","5.150","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4897","2026-01-27","6.928","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4380","2026-03-01","726","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3317","2026-02-15","253","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3324","2026-02-09","5.584","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":284},{"label":"Fev","value":565},{"label":"Mar","value":331},{"label":"Abr","value":569},{"label":"Mai","value":643},{"label":"Jun","value":333},{"label":"Jul","value":621},{"label":"Ago","value":351},{"label":"Set","value":430},{"label":"Out","value":534},{"label":"Nov","value":393},{"label":"Dez","value":308}];
const MX = 643;
