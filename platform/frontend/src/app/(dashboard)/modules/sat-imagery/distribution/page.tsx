...
const KPIS = [{"l":"Total Sat Imagery","v":"8.968","t":"-3.4%","d":"down"},{"l":"Distribution Ativos","v":"5.483","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"85.6%","t":"-3.0%","d":"down"},{"l":"Score Performance","v":"56","t":"-2.9%","d":"down"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sat Imagery #001","Sat Imagery #002","5.626","187","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Sat Imagery #002","Sat Imagery #003","8.655","3.478","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Sat Imagery #003","Sat Imagery #004","5.418","7.305","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Sat Imagery #004","Sat Imagery #005","6.346","5.247","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sat Imagery #005","Sat Imagery #001","1.266","6.032","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":700},{"label":"Mar","value":645},{"label":"Abr","value":430},{"label":"Mai","value":455},{"label":"Jun","value":596},{"label":"Jul","value":708},{"label":"Ago","value":518},{"label":"Set","value":500},{"label":"Out","value":488},{"label":"Nov","value":404},{"label":"Dez","value":750}];
const MX = 787;
