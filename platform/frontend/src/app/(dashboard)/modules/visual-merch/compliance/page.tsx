...
const PAGE = "Photo Comply";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.487","t":"+16.7%","d":"up"},{"l":"NC Abertas","v":"1.082","t":"-1.5%","d":"down"},{"l":"Conformidade (%)","v":"71.9%","t":"+3.0%","d":"up"},{"l":"CAPAs Pendentes","v":"7.013","t":"+9.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.685","72.9%","2.684","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.513","95.9%","2.634","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","278","96.6%","2.089","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.059","90.2%","906","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.564","71.7%","1.749","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":863},{"label":"Fev","value":906},{"label":"Mar","value":908},{"label":"Abr","value":760},{"label":"Mai","value":744},{"label":"Jun","value":960},{"label":"Jul","value":900},{"label":"Ago","value":809},{"label":"Set","value":633},{"label":"Out","value":887},{"label":"Nov","value":636},{"label":"Dez","value":913}];
const MX = 960;
