...
const PAGE = "Feedback";
const KPIS = [{"l":"Dashboards Ativos","v":"4.642","t":"-5.8%","d":"down"},{"l":"Queries/Dia","v":"141","t":"-1.2%","d":"down"},{"l":"Dados Processados (GB)","v":"1.142","t":"+4.6%","d":"up"},{"l":"Utilizadores Analytics","v":"3.899","t":"+1.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4270","2026-02-22","2.887","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1885","2026-02-05","2.955","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2182","2026-02-16","4.158","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3174","2026-03-15","364","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1499","2026-02-24","5.611","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":851},{"label":"Fev","value":625},{"label":"Mar","value":691},{"label":"Abr","value":762},{"label":"Mai","value":587},{"label":"Jun","value":649},{"label":"Jul","value":811},{"label":"Ago","value":576},{"label":"Set","value":710},{"label":"Out","value":802},{"label":"Nov","value":856},{"label":"Dez","value":630}];
const MX = 856;
