...
const PAGE = "Window Design";
const KPIS = [{"l":"Formulários Ativos","v":"3.735","t":"+6.8%","d":"up"},{"l":"Submissões/Dia","v":"3513","t":"+10.3%","d":"up"},{"l":"Documentos Gerados","v":"7.332","t":"+16.1%","d":"up"},{"l":"Templates","v":"7.710","t":"-1.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.437","2026-01-01","8.115","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.214","2026-03-03","8.407","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.561","2026-01-09","3.247","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.413","2026-02-05","7.050","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.319","2026-02-05","1.374","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":718},{"label":"Fev","value":1068},{"label":"Mar","value":956},{"label":"Abr","value":792},{"label":"Mai","value":764},{"label":"Jun","value":1008},{"label":"Jul","value":747},{"label":"Ago","value":1018},{"label":"Set","value":842},{"label":"Out","value":890},{"label":"Nov","value":838},{"label":"Dez","value":994}];
const MX = 1068;
