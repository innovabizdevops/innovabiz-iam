...
const PAGE = "Display Guide";
const KPIS = [{"l":"Dashboards Ativos","v":"6.727","t":"+0.4%","d":"up"},{"l":"Queries/Dia","v":"3401","t":"+16.9%","d":"up"},{"l":"Dados Processados (GB)","v":"361","t":"+4.2%","d":"up"},{"l":"Utilizadores Analytics","v":"8.435","t":"-4.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2960","2026-03-19","8.948","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4981","2026-03-04","8.858","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2693","2026-02-22","4.199","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","486","2026-03-23","6.269","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3098","2026-02-06","6.210","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":303},{"label":"Fev","value":522},{"label":"Mar","value":470},{"label":"Abr","value":600},{"label":"Mai","value":587},{"label":"Jun","value":327},{"label":"Jul","value":503},{"label":"Ago","value":596},{"label":"Set","value":265},{"label":"Out","value":553},{"label":"Nov","value":441},{"label":"Dez","value":419}];
const MX = 600;
