...
export default function VisualMerchPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Visual Merch</h1><p className="text-sm text-muted-foreground">Visual Merch • iBOS Enterprise</p></div>
