...
const ACCENT = "#16a34a";
const MODULE = "Visual Merchandising";
const PAGE = "Planogram AI";
const KPIS = [{"l":"Pedidos/Dia","v":"2345","t":"-1.8%","d":"down"},{"l":"GMV (€)","v":"€92162","t":"+6.5%","d":"up"},{"l":"Conversão (%)","v":"74.7%","t":"+12.6%","d":"up"},{"l":"AOV (€)","v":"€50573","t":"+4.1%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 35267.93","8.596","3.201","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 40166.31","7.387","7.398","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 46831.17","8.788","7.731","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 31180.05","6.700","1.985","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 10389.62","4.902","6.778","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":620},{"label":"Mar","value":474},{"label":"Abr","value":768},{"label":"Mai","value":581},{"label":"Jun","value":751},{"label":"Jul","value":775},{"label":"Ago","value":588},{"label":"Set","value":489},{"label":"Out","value":519},{"label":"Nov","value":665},{"label":"Dez","value":687}];
const MX = 775;
