...
const ACCENT = "#1e40af";
const MODULE = "SDN/NFV Platform";
const PAGE = "VNF Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"6.139","t":"-4.4%","d":"down"},{"l":"Queries/Dia","v":"3298","t":"+13.9%","d":"up"},{"l":"Dados Processados (GB)","v":"255","t":"-0.1%","d":"down"},{"l":"Utilizadores Analytics","v":"2.856","t":"+1.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2064","2026-03-05","9.081","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3164","2026-03-21","2.360","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3108","2026-01-09","7.549","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3608","2026-02-06","6.763","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2732","2026-01-27","7.088","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":416},{"label":"Mar","value":538},{"label":"Abr","value":598},{"label":"Mai","value":341},{"label":"Jun","value":457},{"label":"Jul","value":605},{"label":"Ago","value":539},{"label":"Set","value":562},{"label":"Out","value":383},{"label":"Nov","value":516},{"label":"Dez","value":522}];
const MX = 605;
...
export default function VnfPage() {
    return (
