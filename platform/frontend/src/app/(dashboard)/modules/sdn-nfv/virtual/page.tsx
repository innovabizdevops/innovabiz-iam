...
const PAGE = "Virtual Network";
const KPIS = [{"l":"Total Sdn Nfv","v":"2.632","t":"+12.0%","d":"up"},{"l":"Virtual Network Ativos","v":"8.308","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"83.6%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"70","t":"+9.8%","d":"up"}];
const COLS = ["ID","Virtual Network","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sdn Nfv #001","Sdn Nfv #002","130","2.815","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Sdn Nfv #002","Sdn Nfv #003","5.238","2.885","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Sdn Nfv #003","Sdn Nfv #004","7.387","2.019","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Sdn Nfv #004","Sdn Nfv #005","8.759","3.993","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sdn Nfv #005","Sdn Nfv #001","3.994","6.888","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":960},{"label":"Fev","value":994},{"label":"Mar","value":751},{"label":"Abr","value":828},{"label":"Mai","value":704},{"label":"Jun","value":851},{"label":"Jul","value":766},{"label":"Ago","value":675},{"label":"Set","value":741},{"label":"Out","value":959},{"label":"Nov","value":730},{"label":"Dez","value":701}];
const MX = 994;
