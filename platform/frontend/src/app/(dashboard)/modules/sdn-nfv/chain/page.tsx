...
const PAGE = "Service Chain";
const KPIS = [{"l":"Total Sdn Nfv","v":"3.177","t":"+13.8%","d":"up"},{"l":"Service Chain Ativos","v":"1.480","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"82.1%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"82","t":"+8.1%","d":"up"}];
const COLS = ["ID","Service Chain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sdn Nfv #001","Sdn Nfv #002","6.681","2.173","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Sdn Nfv #002","Sdn Nfv #003","2.897","6.965","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Sdn Nfv #003","Sdn Nfv #004","2.353","5.887","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Sdn Nfv #004","Sdn Nfv #005","4.037","3.613","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sdn Nfv #005","Sdn Nfv #001","7.367","2.022","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":626},{"label":"Mar","value":881},{"label":"Abr","value":879},{"label":"Mai","value":695},{"label":"Jun","value":528},{"label":"Jul","value":489},{"label":"Ago","value":558},{"label":"Set","value":793},{"label":"Out","value":707},{"label":"Nov","value":590},{"label":"Dez","value":821}];
const MX = 881;
