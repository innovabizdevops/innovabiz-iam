...
const KPIS = [{"l":"Formulários Ativos","v":"7.062","t":"+10.1%","d":"up"},{"l":"Submissões/Dia","v":"3961","t":"+9.4%","d":"up"},{"l":"Documentos Gerados","v":"8.107","t":"+2.0%","d":"up"},{"l":"Templates","v":"7.827","t":"+12.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.161","2026-02-10","3.376","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","891","2026-03-07","976","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.266","2026-01-28","6.386","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.685","2026-02-17","754","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.876","2026-03-07","652","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":428},{"label":"Mar","value":302},{"label":"Abr","value":396},{"label":"Mai","value":572},{"label":"Jun","value":583},{"label":"Jul","value":606},{"label":"Ago","value":380},{"label":"Set","value":368},{"label":"Out","value":319},{"label":"Nov","value":651},{"label":"Dez","value":402}];
const MX = 651;
