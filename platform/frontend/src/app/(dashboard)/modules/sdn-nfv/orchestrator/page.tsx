...
const KPIS = [{"l":"Total Sdn Nfv","v":"440","t":"+15.5%","d":"up"},{"l":"Orchestrator Ativos","v":"6.520","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"75.6%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"57","t":"+10.7%","d":"up"}];
const COLS = ["ID","Orchestrator","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sdn Nfv #001","Sdn Nfv #002","7.404","6.577","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Sdn Nfv #002","Sdn Nfv #003","4.388","1.015","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Sdn Nfv #003","Sdn Nfv #004","5.242","2.797","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Sdn Nfv #004","Sdn Nfv #005","8.234","5.777","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sdn Nfv #005","Sdn Nfv #001","8.592","933","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":754},{"label":"Fev","value":560},{"label":"Mar","value":663},{"label":"Abr","value":644},{"label":"Mai","value":717},{"label":"Jun","value":678},{"label":"Jul","value":555},{"label":"Ago","value":514},{"label":"Set","value":667},{"label":"Out","value":558},{"label":"Nov","value":647},{"label":"Dez","value":734}];
const MX = 754;
