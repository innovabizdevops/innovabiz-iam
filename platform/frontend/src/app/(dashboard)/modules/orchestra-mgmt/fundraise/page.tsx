...
const ACCENT = "#7c3aed";
const MODULE = "Orchestra Management";
const PAGE = "Fundraise";
const KPIS = [{"l":"Total Orchestra Mgmt","v":"7.379","t":"-1.4%","d":"down"},{"l":"Fundraise Ativos","v":"2.047","t":"+15.9%","d":"up"},{"l":"Eficiência (%)","v":"73.7%","t":"+12.0%","d":"up"},{"l":"Score Performance","v":"67","t":"-2.3%","d":"down"}];
const COLS = ["ID","Fundraise","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Orchestra Mgmt #001","Orchestra Mgmt #002","197","2.462","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Orchestra Mgmt #002","Orchestra Mgmt #003","7.100","6.692","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Orchestra Mgmt #003","Orchestra Mgmt #004","4.435","4.358","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Orchestra Mgmt #004","Orchestra Mgmt #005","390","283","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Orchestra Mgmt #005","Orchestra Mgmt #001","2.807","8.330","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":920},{"label":"Fev","value":628},{"label":"Mar","value":594},{"label":"Abr","value":877},{"label":"Mai","value":800},{"label":"Jun","value":694},{"label":"Jul","value":820},{"label":"Ago","value":595},{"label":"Set","value":601},{"label":"Out","value":554},{"label":"Nov","value":561},{"label":"Dez","value":542}];
const MX = 920;
