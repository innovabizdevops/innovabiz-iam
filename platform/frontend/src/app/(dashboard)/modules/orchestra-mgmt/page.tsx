...
/* ═══ Orchestra Management — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "700", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1034", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€137K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "-8%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2065140600", cells: ["ORC-1600", "Orchestra Management Item 1", "13/1/2026", "€40 700"], status: "active" as const },
    { id: "2065144171", cells: ["ORC-5171", "Orchestra Management Item 2", "28/8/2026", "€44 271"], status: "pending" as const },
    { id: "2065147742", cells: ["ORC-8742", "Orchestra Management Item 3", "15/3/2026", "€47 842"], status: "completed" as const },
    { id: "2065151313", cells: ["ORC-3313", "Orchestra Management Item 4", "2/10/2026", "€1413"], status: "warning" as const },
    { id: "2065154884", cells: ["ORC-6884", "Orchestra Management Item 5", "17/5/2026", "€4984"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Orchestra Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Orchestra Management</p>
                    </div>
                </div>
