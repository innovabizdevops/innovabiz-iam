...
const PAGE = "Musician";
const KPIS = [{"l":"Total Orchestra Mgmt","v":"5.161","t":"+12.5%","d":"up"},{"l":"Musician Ativos","v":"8.099","t":"+0.6%","d":"up"},{"l":"Eficiência (%)","v":"65.9%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"66","t":"-1.5%","d":"down"}];
const COLS = ["ID","Musician","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Orchestra Mgmt #001","Orchestra Mgmt #002","4.549","5.010","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Orchestra Mgmt #002","Orchestra Mgmt #003","6.729","864","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Orchestra Mgmt #003","Orchestra Mgmt #004","1.340","6.193","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Orchestra Mgmt #004","Orchestra Mgmt #005","8.956","452","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Orchestra Mgmt #005","Orchestra Mgmt #001","1.144","5.829","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":258},{"label":"Fev","value":376},{"label":"Mar","value":575},{"label":"Abr","value":600},{"label":"Mai","value":369},{"label":"Jun","value":470},{"label":"Jul","value":527},{"label":"Ago","value":385},{"label":"Set","value":558},{"label":"Out","value":413},{"label":"Nov","value":225},{"label":"Dez","value":236}];
const MX = 600;
