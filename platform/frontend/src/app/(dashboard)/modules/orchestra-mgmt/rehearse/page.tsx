...
const PAGE = "Rehearse";
const KPIS = [{"l":"Total Orchestra Mgmt","v":"6.998","t":"+10.2%","d":"up"},{"l":"Rehearse Ativos","v":"4.589","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"90.6%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"93","t":"+10.8%","d":"up"}];
const COLS = ["ID","Rehearse","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Orchestra Mgmt #001","Orchestra Mgmt #002","1.330","1.236","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Orchestra Mgmt #002","Orchestra Mgmt #003","4.508","6.973","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Orchestra Mgmt #003","Orchestra Mgmt #004","1.177","8.139","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Orchestra Mgmt #004","Orchestra Mgmt #005","554","721","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Orchestra Mgmt #005","Orchestra Mgmt #001","7.974","4.502","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":372},{"label":"Mar","value":626},{"label":"Abr","value":311},{"label":"Mai","value":412},{"label":"Jun","value":457},{"label":"Jul","value":343},{"label":"Ago","value":520},{"label":"Set","value":321},{"label":"Out","value":663},{"label":"Nov","value":360},{"label":"Dez","value":341}];
const MX = 663;
