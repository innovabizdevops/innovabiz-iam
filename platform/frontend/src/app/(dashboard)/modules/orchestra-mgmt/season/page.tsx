...
const PAGE = "Season";
const KPIS = [{"l":"Total Orchestra Mgmt","v":"8.252","t":"-2.4%","d":"down"},{"l":"Season Ativos","v":"7.422","t":"+1.3%","d":"up"},{"l":"Eficiência (%)","v":"75.4%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"77","t":"+16.0%","d":"up"}];
const COLS = ["ID","Season","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Orchestra Mgmt #001","Orchestra Mgmt #002","9.078","6.620","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Orchestra Mgmt #002","Orchestra Mgmt #003","3.741","2.929","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Orchestra Mgmt #003","Orchestra Mgmt #004","4.734","4.707","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Orchestra Mgmt #004","Orchestra Mgmt #005","4.651","7.430","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Orchestra Mgmt #005","Orchestra Mgmt #001","1.432","8.594","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":502},{"label":"Fev","value":578},{"label":"Mar","value":503},{"label":"Abr","value":428},{"label":"Mai","value":681},{"label":"Jun","value":749},{"label":"Jul","value":679},{"label":"Ago","value":509},{"label":"Set","value":783},{"label":"Out","value":804},{"label":"Nov","value":733},{"label":"Dez","value":667}];
const MX = 804;
