...
const PAGE = "Concert";
const KPIS = [{"l":"Total Orchestra Mgmt","v":"5.711","t":"-2.0%","d":"down"},{"l":"Concert Ativos","v":"2.735","t":"+8.0%","d":"up"},{"l":"Eficiência (%)","v":"70.3%","t":"+6.7%","d":"up"},{"l":"Score Performance","v":"93","t":"+14.9%","d":"up"}];
const COLS = ["ID","Concert","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Orchestra Mgmt #001","Orchestra Mgmt #002","8.209","6.035","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Orchestra Mgmt #002","Orchestra Mgmt #003","202","8.220","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Orchestra Mgmt #003","Orchestra Mgmt #004","5.233","1.344","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Orchestra Mgmt #004","Orchestra Mgmt #005","2.284","6.536","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Orchestra Mgmt #005","Orchestra Mgmt #001","5.322","8.211","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":345},{"label":"Fev","value":304},{"label":"Mar","value":645},{"label":"Abr","value":346},{"label":"Mai","value":417},{"label":"Jun","value":593},{"label":"Jul","value":667},{"label":"Ago","value":540},{"label":"Set","value":497},{"label":"Out","value":444},{"label":"Nov","value":290},{"label":"Dez","value":493}];
const MX = 667;
