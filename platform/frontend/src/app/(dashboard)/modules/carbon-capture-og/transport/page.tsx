...
const KPIS = [{"l":"Atletas Registados","v":"3.873","t":"-2.3%","d":"down"},{"l":"Treinos/Semana","v":"1511","t":"+6.2%","d":"up"},{"l":"Competições","v":"5.870","t":"+10.1%","d":"up"},{"l":"Performance Score","v":"78","t":"+4.2%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.868","5.883","8.605","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.939","6.444","6.273","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.135","7.324","8.960","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.692","2.791","3.379","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","195","7.233","1.781","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":553},{"label":"Mar","value":473},{"label":"Abr","value":845},{"label":"Mai","value":520},{"label":"Jun","value":798},{"label":"Jul","value":683},{"label":"Ago","value":640},{"label":"Set","value":848},{"label":"Out","value":695},{"label":"Nov","value":629},{"label":"Dez","value":651}];
const MX = 848;
