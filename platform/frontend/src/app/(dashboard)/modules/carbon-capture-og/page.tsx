...
export default function CarbonCaptureOgPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Carbon Capture Og</h1><p className="text-sm text-muted-foreground">Carbon Capture Og • iBOS Enterprise</p></div>
