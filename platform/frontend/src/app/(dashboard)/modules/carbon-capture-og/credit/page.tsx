...
const PAGE = "Credit";
const KPIS = [{"l":"Integrações Ativas","v":"3.060","t":"+4.0%","d":"up"},{"l":"Chamadas/Hora","v":"1288","t":"+9.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"83.4%","t":"+4.4%","d":"up"},{"l":"Latência Média (ms)","v":"186ms","t":"+7.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.918","1.830","78.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.182","8.968","72.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.123","7.748","86.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.657","3.571","72.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.747","8.216","91.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":490},{"label":"Mar","value":559},{"label":"Abr","value":491},{"label":"Mai","value":645},{"label":"Jun","value":515},{"label":"Jul","value":502},{"label":"Ago","value":391},{"label":"Set","value":396},{"label":"Out","value":676},{"label":"Nov","value":506},{"label":"Dez","value":578}];
const MX = 676;
