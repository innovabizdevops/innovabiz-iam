...
const KPIS = [{"l":"ARR (€M)","v":"€27.4M","t":"+15.2%","d":"up"},{"l":"MRR (€)","v":"€15375","t":"+6.7%","d":"up"},{"l":"Churn (%)","v":"66.8%","t":"-0.5%","d":"down"},{"l":"ARPU (€)","v":"€60438","t":"+9.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 25776.53","799","€ 15707.98","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 22278.41","5.388","€ 38931.85","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 30206.87","225","€ 41242.64","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 9627.75","2.567","€ 1752.30","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 20900.28","4.712","€ 8841.56","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":498},{"label":"Mar","value":759},{"label":"Abr","value":598},{"label":"Mai","value":581},{"label":"Jun","value":553},{"label":"Jul","value":574},{"label":"Ago","value":852},{"label":"Set","value":474},{"label":"Out","value":830},{"label":"Nov","value":493},{"label":"Dez","value":772}];
const MX = 852;
