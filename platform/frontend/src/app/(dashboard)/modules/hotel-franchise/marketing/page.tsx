...
const KPIS = [{"l":"Quartos Ocupados","v":"1.701","t":"+1.7%","d":"up"},{"l":"RevPAR (€)","v":"€23109","t":"+6.7%","d":"up"},{"l":"Ocupação (%)","v":"73.6%","t":"+15.9%","d":"up"},{"l":"Guest Satisfaction","v":"1.715","t":"+11.3%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","1.628","2026-03-27","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.414","2026-02-10","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.437","2026-01-15","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.936","2026-03-28","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","9.086","2026-02-08","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":354},{"label":"Mar","value":575},{"label":"Abr","value":589},{"label":"Mai","value":517},{"label":"Jun","value":473},{"label":"Jul","value":550},{"label":"Ago","value":554},{"label":"Set","value":587},{"label":"Out","value":406},{"label":"Nov","value":298},{"label":"Dez","value":300}];
const MX = 639;
