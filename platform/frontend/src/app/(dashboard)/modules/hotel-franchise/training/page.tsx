...
const ACCENT = "#6366f1";
const MODULE = "Hotel Franchise";
const PAGE = "Training";
const KPIS = [{"l":"Quartos Ocupados","v":"4.442","t":"-2.5%","d":"down"},{"l":"RevPAR (€)","v":"€22550","t":"+6.2%","d":"up"},{"l":"Ocupação (%)","v":"93.0%","t":"+16.8%","d":"up"},{"l":"Guest Satisfaction","v":"3.361","t":"+1.0%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.928","2026-03-08","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.925","2026-03-04","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","4.839","2026-02-27","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.643","2026-02-08","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.388","2026-01-22","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":641},{"label":"Mar","value":416},{"label":"Abr","value":614},{"label":"Mai","value":458},{"label":"Jun","value":473},{"label":"Jul","value":675},{"label":"Ago","value":646},{"label":"Set","value":421},{"label":"Out","value":509},{"label":"Nov","value":499},{"label":"Dez","value":729}];
const MX = 729;
