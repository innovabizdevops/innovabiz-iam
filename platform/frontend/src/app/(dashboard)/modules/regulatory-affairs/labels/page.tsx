...
const PAGE = "Label Mgmt";
const KPIS = [{"l":"Total Regulatory Affairs","v":"3.736","t":"+1.6%","d":"up"},{"l":"Label Mgmt Ativos","v":"7.388","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"81.3%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"84","t":"+15.7%","d":"up"}];
const COLS = ["ID","Label Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Regulatory Affairs #001","Regulatory Affairs #002","1.142","8.650","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Regulatory Affairs #002","Regulatory Affairs #003","8.569","2.212","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Regulatory Affairs #003","Regulatory Affairs #004","522","4.045","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Regulatory Affairs #004","Regulatory Affairs #005","2.161","4.023","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Regulatory Affairs #005","Regulatory Affairs #001","1.346","5.360","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":794},{"label":"Fev","value":909},{"label":"Mar","value":757},{"label":"Abr","value":789},{"label":"Mai","value":721},{"label":"Jun","value":852},{"label":"Jul","value":616},{"label":"Ago","value":831},{"label":"Set","value":699},{"label":"Out","value":892},{"label":"Nov","value":564},{"label":"Dez","value":783}];
const MX = 909;
