...
const ACCENT = "#ca8a04";
const MODULE = "Regulatory Affairs";
const PAGE = "Submission Plan";
const KPIS = [{"l":"Total Regulatory Affairs","v":"5.658","t":"+1.6%","d":"up"},{"l":"Submission Plan Ativos","v":"7.377","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"83.9%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"85","t":"+1.0%","d":"up"}];
const COLS = ["ID","Submission Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Regulatory Affairs #001","Regulatory Affairs #002","3.849","5.183","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Regulatory Affairs #002","Regulatory Affairs #003","4.306","4.240","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Regulatory Affairs #003","Regulatory Affairs #004","431","8.080","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Regulatory Affairs #004","Regulatory Affairs #005","824","6.753","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Regulatory Affairs #005","Regulatory Affairs #001","7.450","7.202","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":872},{"label":"Mar","value":679},{"label":"Abr","value":647},{"label":"Mai","value":840},{"label":"Jun","value":921},{"label":"Jul","value":840},{"label":"Ago","value":922},{"label":"Set","value":904},{"label":"Out","value":707},{"label":"Nov","value":757},{"label":"Dez","value":897}];
const MX = 922;
