...
const ACCENT = "#be185d";
const MODULE = "Aesthetic Nursing";
const PAGE = "Protocol";
const KPIS = [{"l":"Integrações Ativas","v":"5.242","t":"-0.1%","d":"down"},{"l":"Chamadas/Hora","v":"4128","t":"+2.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"81.3%","t":"+11.9%","d":"up"},{"l":"Latência Média (ms)","v":"133ms","t":"+0.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","269","3.103","73.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","208","2.601","89.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.751","2.035","82.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.756","1.528","93.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.112","1.672","90.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":342},{"label":"Mar","value":285},{"label":"Abr","value":557},{"label":"Mai","value":428},{"label":"Jun","value":269},{"label":"Jul","value":597},{"label":"Ago","value":632},{"label":"Set","value":442},{"label":"Out","value":499},{"label":"Nov","value":323},{"label":"Dez","value":622}];
const MX = 632;
