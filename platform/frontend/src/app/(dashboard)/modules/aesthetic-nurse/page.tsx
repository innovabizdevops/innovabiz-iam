...
/* ═══ Aesthetic Nursing — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "2499", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2581", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€203K", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1611831299", cells: ["AES-4299", "Aesthetic Nursing Item 1", "16/12/2026", "€31 399"], status: "active" as const },
    { id: "1611834870", cells: ["AES-7870", "Aesthetic Nursing Item 2", "3/7/2026", "€34 970"], status: "pending" as const },
    { id: "1611838441", cells: ["AES-2441", "Aesthetic Nursing Item 3", "18/2/2026", "€38 541"], status: "completed" as const },
    { id: "1611842012", cells: ["AES-6012", "Aesthetic Nursing Item 4", "5/9/2026", "€42 112"], status: "warning" as const },
    { id: "1611845583", cells: ["AES-9583", "Aesthetic Nursing Item 5", "20/4/2026", "€45 683"], status: "active" as const },
];
...
export default function AestheticNursingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Aesthetic Nursing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Aesthetic Nursing</p>
                    </div>
                </div>
