...
const ACCENT = "#6366f1";
const MODULE = "Restaurant Reservation";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"2.594","t":"+15.4%","d":"up"},{"l":"Queries/Dia","v":"147","t":"+10.4%","d":"up"},{"l":"Dados Processados (GB)","v":"5.806","t":"-4.3%","d":"down"},{"l":"Utilizadores Analytics","v":"980","t":"+12.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1481","2026-02-05","6.785","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4129","2026-01-18","2.582","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4950","2026-01-13","7.483","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1330","2026-01-14","6.434","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4826","2026-03-22","1.477","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":646},{"label":"Fev","value":398},{"label":"Mar","value":393},{"label":"Abr","value":382},{"label":"Mai","value":567},{"label":"Jun","value":582},{"label":"Jul","value":612},{"label":"Ago","value":499},{"label":"Set","value":496},{"label":"Out","value":467},{"label":"Nov","value":518},{"label":"Dez","value":520}];
const MX = 646;
