...
const PAGE = "Table Mgmt";
const KPIS = [{"l":"Quartos Ocupados","v":"6.459","t":"+11.5%","d":"up"},{"l":"RevPAR (€)","v":"€10546","t":"+17.3%","d":"up"},{"l":"Ocupação (%)","v":"91.5%","t":"+12.7%","d":"up"},{"l":"Guest Satisfaction","v":"5.319","t":"+2.4%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","5.303","2026-03-07","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","274","2026-03-17","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","404","2026-01-18","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.531","2026-01-20","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.432","2026-01-22","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":230},{"label":"Fev","value":342},{"label":"Mar","value":291},{"label":"Abr","value":296},{"label":"Mai","value":573},{"label":"Jun","value":327},{"label":"Jul","value":276},{"label":"Ago","value":264},{"label":"Set","value":298},{"label":"Out","value":411},{"label":"Nov","value":567},{"label":"Dez","value":301}];
const MX = 573;
