...
const PAGE = "Book";
const KPIS = [{"l":"Quartos Ocupados","v":"8.757","t":"+9.6%","d":"up"},{"l":"RevPAR (€)","v":"€42213","t":"+2.1%","d":"up"},{"l":"Ocupação (%)","v":"70.0%","t":"-3.6%","d":"down"},{"l":"Guest Satisfaction","v":"7.797","t":"+4.9%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.055","2026-02-28","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.841","2026-01-20","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","4.245","2026-01-26","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.676","2026-01-21","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.913","2026-01-12","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":914},{"label":"Fev","value":993},{"label":"Mar","value":830},{"label":"Abr","value":605},{"label":"Mai","value":833},{"label":"Jun","value":773},{"label":"Jul","value":702},{"label":"Ago","value":775},{"label":"Set","value":646},{"label":"Out","value":823},{"label":"Nov","value":666},{"label":"Dez","value":796}];
const MX = 993;
