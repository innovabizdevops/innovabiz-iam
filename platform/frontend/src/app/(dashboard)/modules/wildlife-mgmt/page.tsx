...
/* ═══ Wildlife Management — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "5761", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2477", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€472K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "-19%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "780432561", cells: ["WIL-7561", "Wildlife Management Item 1", "14/10/2026", "€32 661"], status: "active" as const },
    { id: "780436132", cells: ["WIL-2132", "Wildlife Management Item 2", "1/5/2026", "€36 232"], status: "pending" as const },
    { id: "780439703", cells: ["WIL-5703", "Wildlife Management Item 3", "16/12/2026", "€39 803"], status: "completed" as const },
    { id: "780443274", cells: ["WIL-9274", "Wildlife Management Item 4", "3/7/2026", "€43 374"], status: "warning" as const },
    { id: "780446845", cells: ["WIL-3845", "Wildlife Management Item 5", "18/2/2026", "€46 945"], status: "active" as const },
];
...
export default function WildlifeManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wildlife Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Wildlife Management</p>
                    </div>
                </div>
