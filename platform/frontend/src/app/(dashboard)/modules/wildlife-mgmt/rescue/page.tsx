...
const PAGE = "Rescue";
const KPIS = [{"l":"Total Wildlife Mgmt","v":"7.975","t":"+8.3%","d":"up"},{"l":"Rescue Ativos","v":"4.273","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"77.7%","t":"+9.3%","d":"up"},{"l":"Score Performance","v":"85","t":"+2.4%","d":"up"}];
const COLS = ["ID","Rescue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wildlife Mgmt #001","Wildlife Mgmt #002","2.448","6.348","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Wildlife Mgmt #002","Wildlife Mgmt #003","8.754","9.008","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Wildlife Mgmt #003","Wildlife Mgmt #004","1.370","2.910","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Wildlife Mgmt #004","Wildlife Mgmt #005","992","6.273","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wildlife Mgmt #005","Wildlife Mgmt #001","5.562","2.740","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":860},{"label":"Fev","value":776},{"label":"Mar","value":793},{"label":"Abr","value":761},{"label":"Mai","value":709},{"label":"Jun","value":564},{"label":"Jul","value":690},{"label":"Ago","value":512},{"label":"Set","value":684},{"label":"Out","value":775},{"label":"Nov","value":545},{"label":"Dez","value":711}];
const MX = 860;
