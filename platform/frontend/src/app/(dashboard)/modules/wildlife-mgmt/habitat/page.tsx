...
const ACCENT = "#78350f";
const MODULE = "Wildlife Management";
const PAGE = "Habitat";
const KPIS = [{"l":"Total Wildlife Mgmt","v":"3.277","t":"+7.0%","d":"up"},{"l":"Habitat Ativos","v":"8.976","t":"+13.1%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"94","t":"+15.5%","d":"up"}];
const COLS = ["ID","Habitat","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wildlife Mgmt #001","Wildlife Mgmt #002","2.847","6.196","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Wildlife Mgmt #002","Wildlife Mgmt #003","1.927","1.992","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Wildlife Mgmt #003","Wildlife Mgmt #004","3.701","6.243","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Wildlife Mgmt #004","Wildlife Mgmt #005","3.065","3.105","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wildlife Mgmt #005","Wildlife Mgmt #001","4.409","5.602","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":601},{"label":"Mar","value":792},{"label":"Abr","value":637},{"label":"Mai","value":767},{"label":"Jun","value":824},{"label":"Jul","value":922},{"label":"Ago","value":727},{"label":"Set","value":854},{"label":"Out","value":738},{"label":"Nov","value":937},{"label":"Dez","value":905}];
const MX = 937;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#78350f'}}>GIS</span></h1>
                </div>
