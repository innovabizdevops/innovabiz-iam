...
const PAGE = "Survey";
const KPIS = [{"l":"Surveys Ativos","v":"5.394","t":"+16.3%","d":"up"},{"l":"Respostas/Semana","v":"4118","t":"-4.7%","d":"down"},{"l":"NPS Médio","v":"88","t":"-4.9%","d":"down"},{"l":"Taxa Resposta (%)","v":"93.6%","t":"+16.3%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","3.604","73","73.8%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","7.731","73","87.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","3.265","82","84.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","2.695","58","75.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","6.352","69","90.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":497},{"label":"Mar","value":329},{"label":"Abr","value":472},{"label":"Mai","value":650},{"label":"Jun","value":424},{"label":"Jul","value":564},{"label":"Ago","value":269},{"label":"Set","value":448},{"label":"Out","value":625},{"label":"Nov","value":503},{"label":"Dez","value":308}];
const MX = 650;
