...
const PAGE = "Species";
const KPIS = [{"l":"Total Wildlife Mgmt","v":"3.448","t":"+8.5%","d":"up"},{"l":"Species Ativos","v":"8.353","t":"+10.4%","d":"up"},{"l":"Eficiência (%)","v":"86.6%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"64","t":"+1.9%","d":"up"}];
const COLS = ["ID","Species","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wildlife Mgmt #001","Wildlife Mgmt #002","4.029","3.651","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Wildlife Mgmt #002","Wildlife Mgmt #003","4.987","6.188","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Wildlife Mgmt #003","Wildlife Mgmt #004","1.742","5.747","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Wildlife Mgmt #004","Wildlife Mgmt #005","4.487","1.259","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wildlife Mgmt #005","Wildlife Mgmt #001","5.111","1.727","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":402},{"label":"Mar","value":595},{"label":"Abr","value":357},{"label":"Mai","value":367},{"label":"Jun","value":661},{"label":"Jul","value":547},{"label":"Ago","value":374},{"label":"Set","value":462},{"label":"Out","value":688},{"label":"Nov","value":541},{"label":"Dez","value":372}];
const MX = 688;
