...
const PAGE = "Permit";
const KPIS = [{"l":"Riscos Identificados","v":"1.770","t":"-1.1%","d":"down"},{"l":"Mitigações Ativas","v":"334","t":"+2.5%","d":"up"},{"l":"Score Risco Geral","v":"58","t":"+1.7%","d":"up"},{"l":"Incidentes YTD","v":"4.031","t":"+4.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.964","7.332","6.674","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.749","6.694","4.887","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.307","8.212","4.760","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.205","7.483","3.269","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.604","5.376","1.697","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":839},{"label":"Mar","value":976},{"label":"Abr","value":913},{"label":"Mai","value":724},{"label":"Jun","value":675},{"label":"Jul","value":663},{"label":"Ago","value":732},{"label":"Set","value":840},{"label":"Out","value":815},{"label":"Nov","value":1036},{"label":"Dez","value":954}];
const MX = 1036;
