...
const PAGE = "Reporting &amp; Profitability";
const KPIS = [{"l":"Total Epm","v":"2.747","t":"+16.2%","d":"up"},{"l":"Reporting & Profitability Ativos","v":"5.089","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"85.3%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"91","t":"+3.7%","d":"up"}];
const COLS = ["ID","Reporting & Profitability","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Epm #001","Epm #002","1.014","2.117","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Epm #002","Epm #003","1.501","6.075","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Epm #003","Epm #004","2.834","4.988","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Epm #004","Epm #005","354","7.999","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Epm #005","Epm #001","8.496","2.641","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":852},{"label":"Mar","value":618},{"label":"Abr","value":808},{"label":"Mai","value":543},{"label":"Jun","value":734},{"label":"Jul","value":724},{"label":"Ago","value":675},{"label":"Set","value":736},{"label":"Out","value":672},{"label":"Nov","value":680},{"label":"Dez","value":846}];
const MX = 852;
