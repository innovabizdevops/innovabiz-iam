...
const PAGE = "Account Reconciliation";
const KPIS = [{"l":"Total Epm","v":"1.798","t":"-3.4%","d":"down"},{"l":"Account Reconciliation Ativos","v":"415","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"89.0%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"78","t":"+4.2%","d":"up"}];
const COLS = ["ID","Account Reconciliation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Epm #001","Epm #002","8.409","6.621","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Epm #002","Epm #003","2.343","8.029","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Epm #003","Epm #004","9.025","8.352","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Epm #004","Epm #005","2.990","6.307","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Epm #005","Epm #001","1.543","6.768","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":454},{"label":"Mar","value":474},{"label":"Abr","value":790},{"label":"Mai","value":547},{"label":"Jun","value":537},{"label":"Jul","value":489},{"label":"Ago","value":790},{"label":"Set","value":427},{"label":"Out","value":458},{"label":"Nov","value":541},{"label":"Dez","value":499}];
const MX = 790;
