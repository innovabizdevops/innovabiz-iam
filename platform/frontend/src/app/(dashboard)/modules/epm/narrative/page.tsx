...
const PAGE = "Narrative Reporting";
const KPIS = [{"l":"ARR (€M)","v":"€34.7M","t":"-0.3%","d":"down"},{"l":"MRR (€)","v":"€5850","t":"+9.0%","d":"up"},{"l":"Churn (%)","v":"93.4%","t":"+17.5%","d":"up"},{"l":"ARPU (€)","v":"€5412","t":"+11.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 41159.80","8.600","€ 7814.39","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 43268.10","1.142","€ 41310.62","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 17025.31","7.420","€ 25330.46","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 19678.84","3.286","€ 28807.56","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 26457.10","2.880","€ 14247.27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":965},{"label":"Mar","value":676},{"label":"Abr","value":833},{"label":"Mai","value":873},{"label":"Jun","value":962},{"label":"Jul","value":961},{"label":"Ago","value":792},{"label":"Set","value":887},{"label":"Out","value":662},{"label":"Nov","value":899},{"label":"Dez","value":856}];
const MX = 965;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0d9488'}}>GenAI</span></h1>
                </div>
