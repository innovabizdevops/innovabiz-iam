...
const PAGE = "Close &amp; Consolidation";
const KPIS = [{"l":"Total Epm","v":"2.043","t":"-3.6%","d":"down"},{"l":"Close & Consolidation Ativos","v":"2.623","t":"+17.8%","d":"up"},{"l":"Eficiência (%)","v":"66.8%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"92","t":"-4.6%","d":"down"}];
const COLS = ["ID","Close & Consolidation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Epm #001","Epm #002","3.945","6.602","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Epm #002","Epm #003","6.820","131","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Epm #003","Epm #004","4.716","6.009","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Epm #004","Epm #005","5.747","415","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Epm #005","Epm #001","8.377","6.258","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":625},{"label":"Mar","value":341},{"label":"Abr","value":408},{"label":"Mai","value":450},{"label":"Jun","value":247},{"label":"Jul","value":263},{"label":"Ago","value":637},{"label":"Set","value":601},{"label":"Out","value":625},{"label":"Nov","value":422},{"label":"Dez","value":610}];
const MX = 637;
