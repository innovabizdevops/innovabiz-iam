...
const PAGE = "Management Reporting";
const KPIS = [{"l":"Projetos Melhoria","v":"4.000","t":"+11.7%","d":"up"},{"l":"Savings (€)","v":"€83652","t":"-2.7%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"82.0%","t":"-3.4%","d":"down"},{"l":"Ciclos PDCA","v":"2.429","t":"+7.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.197","€ 34976.04","1.614","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.593","€ 9356.21","3.143","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.877","€ 34156.59","2.794","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.774","€ 36244.94","3.103","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.058","€ 13151.05","8.773","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":903},{"label":"Fev","value":763},{"label":"Mar","value":776},{"label":"Abr","value":896},{"label":"Mai","value":734},{"label":"Jun","value":570},{"label":"Jul","value":647},{"label":"Ago","value":694},{"label":"Set","value":879},{"label":"Out","value":541},{"label":"Nov","value":846},{"label":"Dez","value":899}];
const MX = 903;
...
export default function ReportingEpmPage() {
    return (
