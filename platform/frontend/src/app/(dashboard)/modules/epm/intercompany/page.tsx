...
const KPIS = [{"l":"Total Epm","v":"5.425","t":"+9.9%","d":"up"},{"l":"Intercompany Ativos","v":"643","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"92.5%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"79","t":"+10.8%","d":"up"}];
const COLS = ["ID","Intercompany","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Epm #001","Epm #002","5.791","8.657","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Epm #002","Epm #003","3.105","1.260","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Epm #003","Epm #004","5.923","6.057","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Epm #004","Epm #005","2.542","501","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Epm #005","Epm #001","4.516","380","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":406},{"label":"Fev","value":754},{"label":"Mar","value":517},{"label":"Abr","value":579},{"label":"Mai","value":443},{"label":"Jun","value":389},{"label":"Jul","value":536},{"label":"Ago","value":625},{"label":"Set","value":650},{"label":"Out","value":580},{"label":"Nov","value":598},{"label":"Dez","value":499}];
const MX = 754;
