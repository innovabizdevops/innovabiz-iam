...
const PAGE = "Rolling Forecasts";
const KPIS = [{"l":"Total Epm","v":"965","t":"+8.8%","d":"up"},{"l":"Rolling Forecasts Ativos","v":"1.704","t":"+4.8%","d":"up"},{"l":"Eficiência (%)","v":"80.5%","t":"+4.6%","d":"up"},{"l":"Score Performance","v":"84","t":"-1.6%","d":"down"}];
const COLS = ["ID","Rolling Forecasts","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Epm #001","Epm #002","913","3.524","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Epm #002","Epm #003","2.471","3.190","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Epm #003","Epm #004","1.863","183","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Epm #004","Epm #005","7.642","8.436","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Epm #005","Epm #001","2.246","2.789","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":876},{"label":"Fev","value":708},{"label":"Mar","value":850},{"label":"Abr","value":667},{"label":"Mai","value":756},{"label":"Jun","value":629},{"label":"Jul","value":889},{"label":"Ago","value":606},{"label":"Set","value":976},{"label":"Out","value":784},{"label":"Nov","value":868},{"label":"Dez","value":758}];
const MX = 976;
