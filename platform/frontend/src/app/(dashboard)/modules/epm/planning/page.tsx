...
const PAGE = "Planning &amp; Budgeting";
const KPIS = [{"l":"Total Epm","v":"5.761","t":"-4.0%","d":"down"},{"l":"Planning & Budgeting Ativos","v":"€96570","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"91.2%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"86","t":"-0.3%","d":"down"}];
const COLS = ["ID","Planning & Budgeting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Epm #001","€ 16770.43","8.033","954","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Epm #002","€ 20005.15","6.665","7.618","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Epm #003","€ 31408.95","7.663","3.840","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Epm #004","€ 45017.86","4.206","390","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Epm #005","€ 6058.61","8.613","7.510","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":383},{"label":"Mar","value":451},{"label":"Abr","value":739},{"label":"Mai","value":394},{"label":"Jun","value":670},{"label":"Jul","value":548},{"label":"Ago","value":533},{"label":"Set","value":401},{"label":"Out","value":713},{"label":"Nov","value":666},{"label":"Dez","value":594}];
const MX = 739;
