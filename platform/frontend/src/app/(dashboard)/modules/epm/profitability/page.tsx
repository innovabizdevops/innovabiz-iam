...
const ACCENT = "#0d9488";
const MODULE = "Enterprise Performance";
const PAGE = "Profitability Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"3.437","t":"+0.5%","d":"up"},{"l":"Queries/Dia","v":"591","t":"-1.9%","d":"down"},{"l":"Dados Processados (GB)","v":"2.379","t":"+11.1%","d":"up"},{"l":"Utilizadores Analytics","v":"2.527","t":"+0.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","718","2026-02-12","296","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3691","2026-03-22","741","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3612","2026-02-27","8.234","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4577","2026-03-08","5.903","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1320","2026-02-02","6.872","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":405},{"label":"Mar","value":786},{"label":"Abr","value":538},{"label":"Mai","value":733},{"label":"Jun","value":511},{"label":"Jul","value":633},{"label":"Ago","value":708},{"label":"Set","value":744},{"label":"Out","value":504},{"label":"Nov","value":568},{"label":"Dez","value":516}];
const MX = 786;
