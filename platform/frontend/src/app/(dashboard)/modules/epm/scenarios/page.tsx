...
const PAGE = "Scenario Modeling";
const KPIS = [{"l":"Total Epm","v":"7.189","t":"+12.8%","d":"up"},{"l":"Scenario Modeling Ativos","v":"8.749","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"76.9%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"76","t":"+13.4%","d":"up"}];
const COLS = ["ID","Scenario Modeling","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Epm #001","Epm #002","5.405","7.410","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Epm #002","Epm #003","4.371","4.795","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Epm #003","Epm #004","340","5.126","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Epm #004","Epm #005","497","3.411","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Epm #005","Epm #001","2.659","1.198","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1014},{"label":"Fev","value":794},{"label":"Mar","value":1017},{"label":"Abr","value":839},{"label":"Mai","value":760},{"label":"Jun","value":884},{"label":"Jul","value":785},{"label":"Ago","value":1074},{"label":"Set","value":1018},{"label":"Out","value":889},{"label":"Nov","value":912},{"label":"Dez","value":886}];
const MX = 1074;
