...
const KPIS = [{"l":"Total Epm","v":"7.720","t":"+8.4%","d":"up"},{"l":"Consolidation Ativos","v":"5.626","t":"+0.1%","d":"up"},{"l":"Eficiência (%)","v":"70.1%","t":"-4.4%","d":"down"},{"l":"Score Performance","v":"80","t":"+16.4%","d":"up"}];
const COLS = ["ID","Consolidation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Epm #001","Epm #002","6.693","7.944","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Epm #002","Epm #003","3.494","2.566","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Epm #003","Epm #004","8.711","8.399","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Epm #004","Epm #005","3.161","8.600","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Epm #005","Epm #001","4.706","2.882","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":699},{"label":"Mar","value":727},{"label":"Abr","value":501},{"label":"Mai","value":400},{"label":"Jun","value":528},{"label":"Jul","value":735},{"label":"Ago","value":522},{"label":"Set","value":483},{"label":"Out","value":778},{"label":"Nov","value":470},{"label":"Dez","value":732}];
const MX = 778;
