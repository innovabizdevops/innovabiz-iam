...
const PAGE = "Financial Planning";
const KPIS = [{"l":"Total Epm","v":"2.770","t":"+3.5%","d":"up"},{"l":"Financial Planning Ativos","v":"3.864","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"75","t":"+15.7%","d":"up"}];
const COLS = ["ID","Financial Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Epm #001","Epm #002","346","2.075","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Epm #002","Epm #003","3.339","1.089","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Epm #003","Epm #004","5.575","6.136","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Epm #004","Epm #005","1.106","881","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Epm #005","Epm #001","1.763","4.097","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":536},{"label":"Mar","value":719},{"label":"Abr","value":591},{"label":"Mai","value":530},{"label":"Jun","value":464},{"label":"Jul","value":363},{"label":"Ago","value":500},{"label":"Set","value":636},{"label":"Out","value":550},{"label":"Nov","value":708},{"label":"Dez","value":712}];
const MX = 719;
...
export default function PlanningEpmPage() {
    return (
