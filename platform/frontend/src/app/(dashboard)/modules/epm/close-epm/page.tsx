...
const KPIS = [{"l":"Total Epm","v":"6.452","t":"-1.0%","d":"down"},{"l":"Financial Close Ativos","v":"7.853","t":"+14.9%","d":"up"},{"l":"Eficiência (%)","v":"80.4%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"59","t":"-1.5%","d":"down"}];
const COLS = ["ID","Financial Close","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Epm #001","Epm #002","5.024","1.430","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Epm #002","Epm #003","514","2.481","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Epm #003","Epm #004","6.041","7.487","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Epm #004","Epm #005","2.067","2.071","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Epm #005","Epm #001","1.109","8.605","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":704},{"label":"Mar","value":504},{"label":"Abr","value":647},{"label":"Mai","value":839},{"label":"Jun","value":646},{"label":"Jul","value":652},{"label":"Ago","value":825},{"label":"Set","value":561},{"label":"Out","value":715},{"label":"Nov","value":870},{"label":"Dez","value":764}];
const MX = 870;
...
export default function CloseEpmPage() {
    return (
