...
const KPIS = [{"l":"Total Epm","v":"1.804","t":"+11.1%","d":"up"},{"l":"Tax Reporting Ativos","v":"6.193","t":"-3.7%","d":"down"},{"l":"Eficiência (%)","v":"88.2%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"75","t":"+4.4%","d":"up"}];
const COLS = ["ID","Tax Reporting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Epm #001","Epm #002","2.365","3.755","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Epm #002","Epm #003","3.406","724","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Epm #003","Epm #004","7.635","406","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Epm #004","Epm #005","2.035","193","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Epm #005","Epm #001","7.678","8.656","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":442},{"label":"Mar","value":572},{"label":"Abr","value":418},{"label":"Mai","value":374},{"label":"Jun","value":405},{"label":"Jul","value":437},{"label":"Ago","value":587},{"label":"Set","value":710},{"label":"Out","value":742},{"label":"Nov","value":378},{"label":"Dez","value":587}];
const MX = 742;
