...
const PAGE = "Scenario Manager";
const KPIS = [{"l":"Total Epm","v":"4.355","t":"-4.3%","d":"down"},{"l":"Scenario Manager Ativos","v":"8.194","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"91.7%","t":"+16.7%","d":"up"},{"l":"Score Performance","v":"71","t":"+14.0%","d":"up"}];
const COLS = ["ID","Scenario Manager","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Epm #001","Epm #002","5.860","1.792","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Epm #002","Epm #003","3.499","6.721","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Epm #003","Epm #004","4.612","2.752","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Epm #004","Epm #005","8.805","2.919","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Epm #005","Epm #001","8.498","9.037","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":513},{"label":"Fev","value":445},{"label":"Mar","value":757},{"label":"Abr","value":686},{"label":"Mai","value":491},{"label":"Jun","value":662},{"label":"Jul","value":615},{"label":"Ago","value":699},{"label":"Set","value":569},{"label":"Out","value":622},{"label":"Nov","value":737},{"label":"Dez","value":765}];
const MX = 765;
...
export default function ScenariosEpmPage() {
    return (
