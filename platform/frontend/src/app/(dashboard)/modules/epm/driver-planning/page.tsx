...
const PAGE = "Driver-Based Planning";
const KPIS = [{"l":"Total Epm","v":"5.830","t":"+13.6%","d":"up"},{"l":"Driver Based Planning Ativos","v":"532","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"82.9%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"86","t":"-1.9%","d":"down"}];
const COLS = ["ID","Driver Based Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Epm #001","Epm #002","5.495","208","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Epm #002","Epm #003","1.235","8.255","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Epm #003","Epm #004","5.806","2.109","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Epm #004","Epm #005","2.516","5.891","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Epm #005","Epm #001","217","5.596","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":759},{"label":"Mar","value":619},{"label":"Abr","value":799},{"label":"Mai","value":793},{"label":"Jun","value":791},{"label":"Jul","value":996},{"label":"Ago","value":884},{"label":"Set","value":956},{"label":"Out","value":736},{"label":"Nov","value":835},{"label":"Dez","value":849}];
const MX = 996;
