...
const KPIS = [
    ...
    { label: "Ativos", value: "268", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€350K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "-1%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "395951943", cells: ["TRU-6943", "Truck Fleet Management Item 1", "24/4/2026", "€2043"], status: "active" as const },
    { id: "395955514", cells: ["TRU-1514", "Truck Fleet Management Item 2", "11/11/2026", "€5614"], status: "pending" as const },
    { id: "395959085", cells: ["TRU-5085", "Truck Fleet Management Item 3", "26/6/2026", "€9185"], status: "completed" as const },
    { id: "395962656", cells: ["TRU-8656", "Truck Fleet Management Item 4", "13/1/2026", "€12 756"], status: "warning" as const },
    { id: "395966227", cells: ["TRU-3227", "Truck Fleet Management Item 5", "28/8/2026", "€16 327"], status: "active" as const },
];
...
export default function TruckFleetManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Truck Fleet Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Truck Fleet Management</p>
                    </div>
                </div>
