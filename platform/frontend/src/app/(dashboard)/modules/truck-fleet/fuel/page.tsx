...
const PAGE = "Fuel";
const KPIS = [{"l":"Total Truck Fleet","v":"3.737","t":"+11.7%","d":"up"},{"l":"Fuel Ativos","v":"372","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"-3.0%","d":"down"},{"l":"Score Performance","v":"91","t":"+4.0%","d":"up"}];
const COLS = ["ID","Fuel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Truck Fleet #001","Truck Fleet #002","5.122","4.635","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Truck Fleet #002","Truck Fleet #003","4.979","3.866","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Truck Fleet #003","Truck Fleet #004","5.402","4.620","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Truck Fleet #004","Truck Fleet #005","5.887","6.734","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Truck Fleet #005","Truck Fleet #001","540","8.964","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":646},{"label":"Mar","value":571},{"label":"Abr","value":594},{"label":"Mai","value":651},{"label":"Jun","value":697},{"label":"Jul","value":486},{"label":"Ago","value":329},{"label":"Set","value":557},{"label":"Out","value":342},{"label":"Nov","value":391},{"label":"Dez","value":521}];
const MX = 697;
