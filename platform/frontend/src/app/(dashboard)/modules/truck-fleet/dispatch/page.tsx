...
const ACCENT = "#1e3a5f";
const MODULE = "Truck Fleet Management";
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"3.681","t":"+12.5%","d":"up"},{"l":"Viagens/Dia","v":"3672","t":"+10.6%","d":"up"},{"l":"Pontualidade (%)","v":"68.1%","t":"+2.8%","d":"up"},{"l":"Passageiros/Dia","v":"613","t":"+1.8%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-28","2026-01-16","1.417","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-21","2026-03-24","6.067","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-18","2026-02-22","2.300","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-10","2026-01-21","5.089","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-27","2026-02-12","6.001","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":705},{"label":"Mar","value":552},{"label":"Abr","value":841},{"label":"Mai","value":892},{"label":"Jun","value":562},{"label":"Jul","value":636},{"label":"Ago","value":889},{"label":"Set","value":518},{"label":"Out","value":802},{"label":"Nov","value":522},{"label":"Dez","value":592}];
const MX = 892;
