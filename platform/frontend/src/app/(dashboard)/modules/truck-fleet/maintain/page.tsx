...
const PAGE = "Maintain";
const KPIS = [{"l":"Total Truck Fleet","v":"3.234","t":"-2.9%","d":"down"},{"l":"Maintain Ativos","v":"7.372","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"88.4%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"58","t":"+6.2%","d":"up"}];
const COLS = ["ID","Maintain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Truck Fleet #001","Truck Fleet #002","8.761","6.086","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Truck Fleet #002","Truck Fleet #003","2.381","1.689","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Truck Fleet #003","Truck Fleet #004","1.661","498","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Truck Fleet #004","Truck Fleet #005","2.455","2.753","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Truck Fleet #005","Truck Fleet #001","796","8.583","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":974},{"label":"Fev","value":893},{"label":"Mar","value":662},{"label":"Abr","value":638},{"label":"Mai","value":770},{"label":"Jun","value":780},{"label":"Jul","value":798},{"label":"Ago","value":864},{"label":"Set","value":989},{"label":"Out","value":978},{"label":"Nov","value":852},{"label":"Dez","value":884}];
const MX = 989;
