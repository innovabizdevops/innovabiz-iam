...
const PAGE = "Comply";
const KPIS = [{"l":"Total Truck Fleet","v":"4.222","t":"-5.6%","d":"down"},{"l":"Comply Ativos","v":"4.447","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"65.6%","t":"+8.9%","d":"up"},{"l":"Score Performance","v":"75","t":"+10.9%","d":"up"}];
const COLS = ["ID","Comply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Truck Fleet #001","Truck Fleet #002","103","1.541","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Truck Fleet #002","Truck Fleet #003","5.917","1.686","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Truck Fleet #003","Truck Fleet #004","1.156","8.172","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Truck Fleet #004","Truck Fleet #005","1.883","3.218","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Truck Fleet #005","Truck Fleet #001","5.461","5.966","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":467},{"label":"Mar","value":695},{"label":"Abr","value":492},{"label":"Mai","value":760},{"label":"Jun","value":808},{"label":"Jul","value":810},{"label":"Ago","value":833},{"label":"Set","value":805},{"label":"Out","value":835},{"label":"Nov","value":461},{"label":"Dez","value":702}];
const MX = 835;
