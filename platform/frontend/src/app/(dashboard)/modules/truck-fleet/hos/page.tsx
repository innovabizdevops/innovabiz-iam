...
const PAGE = "HOS";
const KPIS = [{"l":"Total Truck Fleet","v":"5.410","t":"+16.8%","d":"up"},{"l":"HOS Ativos","v":"7.628","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"66.3%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"86","t":"+7.2%","d":"up"}];
const COLS = ["ID","HOS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Truck Fleet #001","Truck Fleet #002","6.001","6.945","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Truck Fleet #002","Truck Fleet #003","7.534","8.277","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Truck Fleet #003","Truck Fleet #004","6.468","6.165","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Truck Fleet #004","Truck Fleet #005","7.657","1.403","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Truck Fleet #005","Truck Fleet #001","3.266","5.953","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":837},{"label":"Fev","value":806},{"label":"Mar","value":692},{"label":"Abr","value":947},{"label":"Mai","value":988},{"label":"Jun","value":892},{"label":"Jul","value":690},{"label":"Ago","value":669},{"label":"Set","value":765},{"label":"Out","value":712},{"label":"Nov","value":758},{"label":"Dez","value":666}];
const MX = 988;
