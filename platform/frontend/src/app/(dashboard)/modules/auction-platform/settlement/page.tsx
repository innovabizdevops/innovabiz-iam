...
const KPIS = [{"l":"Formulários Ativos","v":"549","t":"+16.7%","d":"up"},{"l":"Submissões/Dia","v":"3368","t":"+0.5%","d":"up"},{"l":"Documentos Gerados","v":"8.435","t":"+7.1%","d":"up"},{"l":"Templates","v":"3.680","t":"+14.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","515","2026-02-15","1.347","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.876","2026-03-15","4.363","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.600","2026-01-16","8.514","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.646","2026-02-14","5.645","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.161","2026-02-27","5.807","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":429},{"label":"Mar","value":394},{"label":"Abr","value":589},{"label":"Mai","value":729},{"label":"Jun","value":585},{"label":"Jul","value":453},{"label":"Ago","value":472},{"label":"Set","value":393},{"label":"Out","value":484},{"label":"Nov","value":601},{"label":"Dez","value":722}];
const MX = 729;
