...
const PAGE = "Lot Catalog";
const KPIS = [{"l":"Formulários Ativos","v":"523","t":"-4.4%","d":"down"},{"l":"Submissões/Dia","v":"179","t":"+8.5%","d":"up"},{"l":"Documentos Gerados","v":"1.201","t":"+5.9%","d":"up"},{"l":"Templates","v":"1.613","t":"-3.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.743","2026-03-07","5.262","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.004","2026-01-19","5.121","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.784","2026-02-02","6.204","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.755","2026-02-16","3.006","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.938","2026-03-22","6.522","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1057},{"label":"Fev","value":959},{"label":"Mar","value":922},{"label":"Abr","value":1039},{"label":"Mai","value":797},{"label":"Jun","value":799},{"label":"Jul","value":947},{"label":"Ago","value":787},{"label":"Set","value":982},{"label":"Out","value":986},{"label":"Nov","value":747},{"label":"Dez","value":852}];
const MX = 1057;
