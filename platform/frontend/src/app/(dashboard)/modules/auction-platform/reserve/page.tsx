...
const PAGE = "Reserve Pricing";
const KPIS = [{"l":"ARR (€M)","v":"€2.8M","t":"+15.6%","d":"up"},{"l":"MRR (€)","v":"€65613","t":"+8.1%","d":"up"},{"l":"Churn (%)","v":"78.3%","t":"+7.8%","d":"up"},{"l":"ARPU (€)","v":"€81556","t":"+11.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 26171.31","907","€ 47279.50","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 16954.07","8.564","€ 34413.64","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 433.23","5.832","€ 38765.12","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 44602.53","4.318","€ 37003.66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 20346.24","6.664","€ 42591.81","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":603},{"label":"Mar","value":667},{"label":"Abr","value":736},{"label":"Mai","value":867},{"label":"Jun","value":911},{"label":"Jul","value":852},{"label":"Ago","value":919},{"label":"Set","value":770},{"label":"Out","value":602},{"label":"Nov","value":554},{"label":"Dez","value":798}];
const MX = 919;
