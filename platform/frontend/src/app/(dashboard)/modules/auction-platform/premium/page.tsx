...
const PAGE = "Buyer Premium";
const KPIS = [{"l":"Formulários Ativos","v":"8.123","t":"+0.6%","d":"up"},{"l":"Submissões/Dia","v":"3458","t":"+8.8%","d":"up"},{"l":"Documentos Gerados","v":"7.067","t":"+3.9%","d":"up"},{"l":"Templates","v":"3.335","t":"+10.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.987","2026-03-24","5.419","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.176","2026-03-12","2.769","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.596","2026-02-10","8.093","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.683","2026-03-13","1.361","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.738","2026-01-22","5.072","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":474},{"label":"Mar","value":701},{"label":"Abr","value":728},{"label":"Mai","value":526},{"label":"Jun","value":434},{"label":"Jul","value":566},{"label":"Ago","value":605},{"label":"Set","value":715},{"label":"Out","value":709},{"label":"Nov","value":552},{"label":"Dez","value":446}];
const MX = 728;
