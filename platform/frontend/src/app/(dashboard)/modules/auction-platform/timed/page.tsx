...
const PAGE = "Timed Auctions";
const KPIS = [{"l":"Formulários Ativos","v":"8.871","t":"+8.3%","d":"up"},{"l":"Submissões/Dia","v":"4158","t":"+5.5%","d":"up"},{"l":"Documentos Gerados","v":"1.636","t":"-5.1%","d":"down"},{"l":"Templates","v":"4.748","t":"+0.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.308","2026-02-17","932","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.813","2026-03-19","480","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.249","2026-03-19","4.529","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.446","2026-03-19","6.721","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.940","2026-02-05","3.212","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":968},{"label":"Mar","value":657},{"label":"Abr","value":689},{"label":"Mai","value":946},{"label":"Jun","value":947},{"label":"Jul","value":1003},{"label":"Ago","value":811},{"label":"Set","value":1001},{"label":"Out","value":927},{"label":"Nov","value":829},{"label":"Dez","value":947}];
const MX = 1003;
