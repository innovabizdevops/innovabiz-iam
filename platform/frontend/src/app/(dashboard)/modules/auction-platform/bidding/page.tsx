...
const ACCENT = "#78350f";
const MODULE = "Auction Platform";
const PAGE = "Live Bidding";
const KPIS = [{"l":"Formulários Ativos","v":"6.676","t":"-4.1%","d":"down"},{"l":"Submissões/Dia","v":"2770","t":"-2.3%","d":"down"},{"l":"Documentos Gerados","v":"8.022","t":"+2.8%","d":"up"},{"l":"Templates","v":"7.059","t":"+17.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.043","2026-02-23","7.568","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.560","2026-02-11","4.728","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","651","2026-02-18","8.049","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.293","2026-03-01","7.984","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.929","2026-01-12","4.639","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":903},{"label":"Fev","value":1042},{"label":"Mar","value":854},{"label":"Abr","value":838},{"label":"Mai","value":1075},{"label":"Jun","value":996},{"label":"Jul","value":936},{"label":"Ago","value":973},{"label":"Set","value":849},{"label":"Out","value":870},{"label":"Nov","value":770},{"label":"Dez","value":744}];
const MX = 1075;
