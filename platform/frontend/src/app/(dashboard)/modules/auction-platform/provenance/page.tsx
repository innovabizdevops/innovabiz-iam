...
const PAGE = "Provenance Cert";
const KPIS = [{"l":"Formulários Ativos","v":"7.822","t":"+12.2%","d":"up"},{"l":"Submissões/Dia","v":"2494","t":"+15.7%","d":"up"},{"l":"Documentos Gerados","v":"3.197","t":"+3.7%","d":"up"},{"l":"Templates","v":"3.308","t":"-0.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.144","2026-02-02","3.402","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.404","2026-03-28","9.041","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.871","2026-01-09","158","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.081","2026-01-19","6.993","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.594","2026-02-19","8.648","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":785},{"label":"Fev","value":749},{"label":"Mar","value":996},{"label":"Abr","value":963},{"label":"Mai","value":903},{"label":"Jun","value":814},{"label":"Jul","value":778},{"label":"Ago","value":1027},{"label":"Set","value":704},{"label":"Out","value":1002},{"label":"Nov","value":726},{"label":"Dez","value":987}];
const MX = 1027;
