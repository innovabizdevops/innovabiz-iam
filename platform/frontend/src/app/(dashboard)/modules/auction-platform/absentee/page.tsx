...
const PAGE = "Absentee Bidding";
const KPIS = [{"l":"Formulários Ativos","v":"6.069","t":"+6.4%","d":"up"},{"l":"Submissões/Dia","v":"4398","t":"+8.0%","d":"up"},{"l":"Documentos Gerados","v":"2.327","t":"+4.2%","d":"up"},{"l":"Templates","v":"3.008","t":"+9.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.129","2026-02-14","5.527","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.825","2026-02-21","3.139","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.187","2026-03-16","3.414","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.497","2026-03-26","1.853","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.810","2026-02-03","1.922","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":915},{"label":"Mar","value":548},{"label":"Abr","value":873},{"label":"Mai","value":757},{"label":"Jun","value":606},{"label":"Jul","value":552},{"label":"Ago","value":630},{"label":"Set","value":828},{"label":"Out","value":761},{"label":"Nov","value":771},{"label":"Dez","value":860}];
const MX = 915;
