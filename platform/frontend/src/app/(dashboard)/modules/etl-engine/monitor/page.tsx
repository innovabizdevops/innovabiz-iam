...
const PAGE = "Monitor";
const KPIS = [{"l":"Dashboards Ativos","v":"1.353","t":"-0.1%","d":"down"},{"l":"Queries/Dia","v":"3269","t":"+4.2%","d":"up"},{"l":"Dados Processados (GB)","v":"2.919","t":"-2.7%","d":"down"},{"l":"Utilizadores Analytics","v":"4.417","t":"+2.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3489","2026-02-10","4.004","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","508","2026-02-11","4.473","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4911","2026-01-08","250","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4768","2026-02-04","4.225","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2089","2026-03-28","6.310","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":433},{"label":"Fev","value":513},{"label":"Mar","value":418},{"label":"Abr","value":359},{"label":"Mai","value":714},{"label":"Jun","value":690},{"label":"Jul","value":495},{"label":"Ago","value":569},{"label":"Set","value":614},{"label":"Out","value":557},{"label":"Nov","value":639},{"label":"Dez","value":374}];
const MX = 714;
