...
const KPIS = [{"l":"Formulários Ativos","v":"3.697","t":"-2.3%","d":"down"},{"l":"Submissões/Dia","v":"3962","t":"+2.0%","d":"up"},{"l":"Documentos Gerados","v":"7.022","t":"-0.1%","d":"down"},{"l":"Templates","v":"3.525","t":"+11.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.461","2026-03-07","8.672","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.463","2026-01-13","2.741","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.792","2026-02-07","8.382","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.308","2026-03-25","4.639","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.400","2026-01-23","8.244","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":425},{"label":"Fev","value":662},{"label":"Mar","value":428},{"label":"Abr","value":669},{"label":"Mai","value":642},{"label":"Jun","value":414},{"label":"Jul","value":432},{"label":"Ago","value":452},{"label":"Set","value":526},{"label":"Out","value":342},{"label":"Nov","value":620},{"label":"Dez","value":342}];
const MX = 669;
