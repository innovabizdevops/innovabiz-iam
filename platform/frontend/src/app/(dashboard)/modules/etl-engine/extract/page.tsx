...
const ACCENT = "#06b6d4";
const MODULE = "ETL/ELT Engine";
const PAGE = "Extract";
const KPIS = [{"l":"Dashboards Ativos","v":"5.015","t":"-5.0%","d":"down"},{"l":"Queries/Dia","v":"4793","t":"-5.6%","d":"down"},{"l":"Dados Processados (GB)","v":"1.262","t":"+9.4%","d":"up"},{"l":"Utilizadores Analytics","v":"4.843","t":"+-0.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","507","2026-01-05","5.006","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2945","2026-02-24","6.362","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3740","2026-01-28","1.693","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4053","2026-01-06","5.793","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4455","2026-02-02","5.336","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":769},{"label":"Fev","value":668},{"label":"Mar","value":501},{"label":"Abr","value":516},{"label":"Mai","value":667},{"label":"Jun","value":565},{"label":"Jul","value":649},{"label":"Ago","value":676},{"label":"Set","value":866},{"label":"Out","value":799},{"label":"Nov","value":597},{"label":"Dez","value":867}];
const MX = 867;
