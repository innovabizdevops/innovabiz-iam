...
const PAGE = "Schedule";
const KPIS = [{"l":"Dashboards Ativos","v":"6.740","t":"+11.8%","d":"up"},{"l":"Queries/Dia","v":"3347","t":"+5.0%","d":"up"},{"l":"Dados Processados (GB)","v":"5.317","t":"+3.4%","d":"up"},{"l":"Utilizadores Analytics","v":"4.652","t":"+9.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3871","2026-03-07","5.424","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2333","2026-03-23","7.653","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2505","2026-01-10","3.755","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4150","2026-01-27","1.631","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5016","2026-03-13","3.293","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":598},{"label":"Mar","value":686},{"label":"Abr","value":661},{"label":"Mai","value":642},{"label":"Jun","value":584},{"label":"Jul","value":707},{"label":"Ago","value":634},{"label":"Set","value":757},{"label":"Out","value":836},{"label":"Nov","value":650},{"label":"Dez","value":584}];
const MX = 836;
