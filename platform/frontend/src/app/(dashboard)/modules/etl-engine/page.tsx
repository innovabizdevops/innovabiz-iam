...
/* ═══ ETL/ELT Engine — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "9361", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1739", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€181K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "-19%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "884524761", cells: ["ETL-5761", "ETL/ELT Engine Item 1", "2/10/2026", "€24 861"], status: "active" as const },
    { id: "884528332", cells: ["ETL-9332", "ETL/ELT Engine Item 2", "17/5/2026", "€28 432"], status: "pending" as const },
    { id: "884531903", cells: ["ETL-3903", "ETL/ELT Engine Item 3", "4/12/2026", "€32 003"], status: "completed" as const },
    { id: "884535474", cells: ["ETL-7474", "ETL/ELT Engine Item 4", "19/7/2026", "€35 574"], status: "warning" as const },
    { id: "884539045", cells: ["ETL-2045", "ETL/ELT Engine Item 5", "6/2/2026", "€39 145"], status: "active" as const },
];
...
export default function EtleltEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">ETL/ELT Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • ETL/ELT Engine</p>
                    </div>
                </div>
