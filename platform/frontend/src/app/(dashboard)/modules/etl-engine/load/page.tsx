...
const PAGE = "Load";
const KPIS = [{"l":"Dashboards Ativos","v":"8.011","t":"-4.8%","d":"down"},{"l":"Queries/Dia","v":"2370","t":"+1.4%","d":"up"},{"l":"Dados Processados (GB)","v":"3.098","t":"+16.2%","d":"up"},{"l":"Utilizadores Analytics","v":"2.129","t":"+1.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4739","2026-02-13","1.530","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4452","2026-02-23","3.847","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","547","2026-01-15","8.126","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1992","2026-01-10","2.749","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1376","2026-02-26","3.804","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":486},{"label":"Fev","value":435},{"label":"Mar","value":400},{"label":"Abr","value":662},{"label":"Mai","value":722},{"label":"Jun","value":606},{"label":"Jul","value":437},{"label":"Ago","value":544},{"label":"Set","value":695},{"label":"Out","value":679},{"label":"Nov","value":526},{"label":"Dez","value":405}];
const MX = 722;
