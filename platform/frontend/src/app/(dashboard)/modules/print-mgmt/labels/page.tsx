...
const PAGE = "Label Printing";
const KPIS = [{"l":"Total Print Mgmt","v":"8.905","t":"+10.6%","d":"up"},{"l":"Label Printing Ativos","v":"4.515","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"72.4%","t":"+6.8%","d":"up"},{"l":"Score Performance","v":"69","t":"+12.2%","d":"up"}];
const COLS = ["ID","Label Printing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Mgmt #001","Print Mgmt #002","7.901","1.014","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Print Mgmt #002","Print Mgmt #003","5.898","8.247","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Mgmt #003","Print Mgmt #004","1.715","3.190","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Print Mgmt #004","Print Mgmt #005","2.712","4.502","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Mgmt #005","Print Mgmt #001","8.335","1.742","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":894},{"label":"Fev","value":789},{"label":"Mar","value":987},{"label":"Abr","value":837},{"label":"Mai","value":841},{"label":"Jun","value":1056},{"label":"Jul","value":873},{"label":"Ago","value":896},{"label":"Set","value":966},{"label":"Out","value":898},{"label":"Nov","value":702},{"label":"Dez","value":978}];
const MX = 1056;
