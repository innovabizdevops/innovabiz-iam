...
const PAGE = "Batch Print";
const KPIS = [{"l":"Total Print Mgmt","v":"7.587","t":"-3.9%","d":"down"},{"l":"Batch Print Ativos","v":"9.026","t":"-1.3%","d":"down"},{"l":"Eficiência (%)","v":"71.5%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"59","t":"+14.7%","d":"up"}];
const COLS = ["ID","Batch Print","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Mgmt #001","Print Mgmt #002","250","5.419","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Print Mgmt #002","Print Mgmt #003","3.688","5.730","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Mgmt #003","Print Mgmt #004","4.036","4.371","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Print Mgmt #004","Print Mgmt #005","7.683","6.061","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Mgmt #005","Print Mgmt #001","7.481","1.807","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":482},{"label":"Mar","value":775},{"label":"Abr","value":516},{"label":"Mai","value":853},{"label":"Jun","value":867},{"label":"Jul","value":835},{"label":"Ago","value":832},{"label":"Set","value":708},{"label":"Out","value":831},{"label":"Nov","value":779},{"label":"Dez","value":697}];
const MX = 867;
