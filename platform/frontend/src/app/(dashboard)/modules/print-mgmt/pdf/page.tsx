...
const ACCENT = "#78350f";
const MODULE = "Print & Output Mgmt";
const PAGE = "PDF Generation";
const KPIS = [{"l":"Formulários Ativos","v":"7.256","t":"+6.0%","d":"up"},{"l":"Submissões/Dia","v":"4529","t":"+11.8%","d":"up"},{"l":"Documentos Gerados","v":"6.092","t":"+0.9%","d":"up"},{"l":"Templates","v":"5.109","t":"+1.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.690","2026-02-21","5.264","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.503","2026-03-03","783","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.311","2026-01-10","1.905","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.696","2026-01-10","5.862","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.303","2026-03-02","5.774","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":531},{"label":"Mar","value":505},{"label":"Abr","value":402},{"label":"Mai","value":358},{"label":"Jun","value":634},{"label":"Jul","value":699},{"label":"Ago","value":663},{"label":"Set","value":688},{"label":"Out","value":362},{"label":"Nov","value":632},{"label":"Dez","value":504}];
const MX = 699;
