...
const KPIS = [{"l":"Total Print Mgmt","v":"5.580","t":"+13.5%","d":"up"},{"l":"Print Queue Ativos","v":"4.386","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"87.7%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"65","t":"+0.7%","d":"up"}];
const COLS = ["ID","Print Queue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Mgmt #001","Print Mgmt #002","5.303","2.952","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Print Mgmt #002","Print Mgmt #003","5.679","6.663","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Mgmt #003","Print Mgmt #004","4.811","8.952","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Print Mgmt #004","Print Mgmt #005","2.532","7.480","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Mgmt #005","Print Mgmt #001","588","5.617","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":388},{"label":"Fev","value":757},{"label":"Mar","value":530},{"label":"Abr","value":397},{"label":"Mai","value":529},{"label":"Jun","value":454},{"label":"Jul","value":481},{"label":"Ago","value":551},{"label":"Set","value":451},{"label":"Out","value":587},{"label":"Nov","value":773},{"label":"Dez","value":442}];
const MX = 773;
