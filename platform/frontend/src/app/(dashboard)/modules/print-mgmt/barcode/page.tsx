...
const PAGE = "Barcode/QR Gen";
const KPIS = [{"l":"Total Print Mgmt","v":"941","t":"-4.5%","d":"down"},{"l":"Barcode/QR Gen Ativos","v":"8.687","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"91.4%","t":"+5.5%","d":"up"},{"l":"Score Performance","v":"81","t":"+1.0%","d":"up"}];
const COLS = ["ID","Barcode/QR Gen","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Mgmt #001","Print Mgmt #002","7.101","817","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Print Mgmt #002","Print Mgmt #003","658","1.255","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Mgmt #003","Print Mgmt #004","2.734","1.982","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Print Mgmt #004","Print Mgmt #005","1.343","8.608","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Mgmt #005","Print Mgmt #001","9.059","3.941","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":694},{"label":"Mar","value":471},{"label":"Abr","value":610},{"label":"Mai","value":643},{"label":"Jun","value":544},{"label":"Jul","value":621},{"label":"Ago","value":354},{"label":"Set","value":550},{"label":"Out","value":691},{"label":"Nov","value":581},{"label":"Dez","value":454}];
const MX = 694;
