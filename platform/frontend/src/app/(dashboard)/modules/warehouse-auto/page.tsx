...
export default function WarehouseAutoPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Warehouse Auto</h1><p className="text-sm text-muted-foreground">Warehouse Auto • iBOS Enterprise</p></div>
