...
const PAGE = "Installment";
const KPIS = [{"l":"Formulários Ativos","v":"7.990","t":"+6.0%","d":"up"},{"l":"Submissões/Dia","v":"4846","t":"+7.2%","d":"up"},{"l":"Documentos Gerados","v":"2.105","t":"+17.8%","d":"up"},{"l":"Templates","v":"521","t":"+16.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.643","2026-03-21","6.306","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.926","2026-03-11","606","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.621","2026-03-08","4.895","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.582","2026-01-07","4.615","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.462","2026-01-02","7.738","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":449},{"label":"Mar","value":457},{"label":"Abr","value":436},{"label":"Mai","value":607},{"label":"Jun","value":406},{"label":"Jul","value":774},{"label":"Ago","value":720},{"label":"Set","value":444},{"label":"Out","value":547},{"label":"Nov","value":652},{"label":"Dez","value":702}];
const MX = 774;
