...
const ACCENT = "#dc2626";
const MODULE = "BNPL Platform";
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"6.428","t":"+11.6%","d":"up"},{"l":"Mitigações Ativas","v":"3.657","t":"+4.1%","d":"up"},{"l":"Score Risco Geral","v":"88","t":"-1.4%","d":"down"},{"l":"Incidentes YTD","v":"8.141","t":"+10.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.971","6.810","7.072","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.794","1.946","2.512","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.927","2.106","4.160","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.063","6.911","4.104","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","969","1.491","3.054","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":639},{"label":"Mar","value":736},{"label":"Abr","value":597},{"label":"Mai","value":608},{"label":"Jun","value":544},{"label":"Jul","value":754},{"label":"Ago","value":581},{"label":"Set","value":606},{"label":"Out","value":528},{"label":"Nov","value":674},{"label":"Dez","value":456}];
const MX = 754;
