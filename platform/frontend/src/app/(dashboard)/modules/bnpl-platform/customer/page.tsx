...
const PAGE = "Customer";
const KPIS = [{"l":"Formulários Ativos","v":"5.893","t":"+2.4%","d":"up"},{"l":"Submissões/Dia","v":"1413","t":"+7.6%","d":"up"},{"l":"Documentos Gerados","v":"8.708","t":"-3.7%","d":"down"},{"l":"Templates","v":"4.457","t":"+12.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.582","2026-01-25","8.556","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","642","2026-01-18","3.681","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.351","2026-03-06","8.928","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.618","2026-01-19","6.469","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.724","2026-02-08","6.966","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":545},{"label":"Fev","value":760},{"label":"Mar","value":748},{"label":"Abr","value":639},{"label":"Mai","value":753},{"label":"Jun","value":787},{"label":"Jul","value":826},{"label":"Ago","value":768},{"label":"Set","value":899},{"label":"Out","value":617},{"label":"Nov","value":585},{"label":"Dez","value":610}];
const MX = 899;
