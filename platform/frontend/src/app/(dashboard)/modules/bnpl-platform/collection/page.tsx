...
const KPIS = [{"l":"Formulários Ativos","v":"3.389","t":"+14.8%","d":"up"},{"l":"Submissões/Dia","v":"3545","t":"+12.2%","d":"up"},{"l":"Documentos Gerados","v":"5.041","t":"-2.0%","d":"down"},{"l":"Templates","v":"4.742","t":"-5.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.005","2026-02-28","1.205","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.063","2026-01-15","4.205","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.320","2026-02-16","8.388","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.273","2026-03-01","309","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.575","2026-01-24","6.668","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":457},{"label":"Mar","value":400},{"label":"Abr","value":530},{"label":"Mai","value":422},{"label":"Jun","value":318},{"label":"Jul","value":471},{"label":"Ago","value":304},{"label":"Set","value":319},{"label":"Out","value":562},{"label":"Nov","value":233},{"label":"Dez","value":528}];
const MX = 576;
