...
/* ═══ BNPL Platform — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "1931", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "603", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€89K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "861242431", cells: ["BNP-6431", "BNPL Platform Item 1", "8/8/2026", "€42 531"], status: "active" as const },
    { id: "861246002", cells: ["BNP-1002", "BNPL Platform Item 2", "23/3/2026", "€46 102"], status: "pending" as const },
    { id: "861249573", cells: ["BNP-4573", "BNPL Platform Item 3", "10/10/2026", "€49 673"], status: "completed" as const },
    { id: "861253144", cells: ["BNP-8144", "BNPL Platform Item 4", "25/5/2026", "€3244"], status: "warning" as const },
    { id: "861256715", cells: ["BNP-2715", "BNPL Platform Item 5", "12/12/2026", "€6815"], status: "active" as const },
];
...
export default function BnplPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">BNPL Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • BNPL Platform</p>
                    </div>
                </div>
