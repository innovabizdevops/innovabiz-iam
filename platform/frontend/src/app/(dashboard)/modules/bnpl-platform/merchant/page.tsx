...
const PAGE = "Merchant";
const KPIS = [{"l":"Formulários Ativos","v":"7.931","t":"+9.0%","d":"up"},{"l":"Submissões/Dia","v":"3737","t":"+17.4%","d":"up"},{"l":"Documentos Gerados","v":"6.444","t":"+15.6%","d":"up"},{"l":"Templates","v":"3.468","t":"-0.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.726","2026-03-06","3.218","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.686","2026-03-25","1.809","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.273","2026-02-06","1.228","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.592","2026-02-06","2.453","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.373","2026-03-04","1.870","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":803},{"label":"Mar","value":780},{"label":"Abr","value":528},{"label":"Mai","value":645},{"label":"Jun","value":796},{"label":"Jul","value":728},{"label":"Ago","value":607},{"label":"Set","value":795},{"label":"Out","value":677},{"label":"Nov","value":859},{"label":"Dez","value":849}];
const MX = 859;
