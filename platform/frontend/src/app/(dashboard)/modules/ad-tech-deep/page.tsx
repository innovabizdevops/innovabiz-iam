...
/* ═══ Ad Tech Platform Deep — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "2472", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2487", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€25K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1501287872", cells: ["AD-7872", "Ad Tech Platform Deep Item 1", "1/9/2026", "€37 972"], status: "active" as const },
    { id: "1501291443", cells: ["AD-2443", "Ad Tech Platform Deep Item 2", "16/4/2026", "€41 543"], status: "pending" as const },
    { id: "1501295014", cells: ["AD-6014", "Ad Tech Platform Deep Item 3", "3/11/2026", "€45 114"], status: "completed" as const },
    { id: "1501298585", cells: ["AD-9585", "Ad Tech Platform Deep Item 4", "18/6/2026", "€48 685"], status: "warning" as const },
    { id: "1501302156", cells: ["AD-4156", "Ad Tech Platform Deep Item 5", "5/1/2026", "€2256"], status: "active" as const },
];
...
export default function AdTechPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ad Tech Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Ad Tech Platform Deep</p>
                    </div>
                </div>
