...
const ACCENT = "#6d28d9";
const MODULE = "Ad Tech Platform Deep";
const PAGE = "Creative";
const KPIS = [{"l":"Total Ad Tech Deep","v":"1.079","t":"+8.0%","d":"up"},{"l":"Creative Ativos","v":"1.568","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"83.0%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"86","t":"+11.8%","d":"up"}];
const COLS = ["ID","Creative","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ad Tech Deep #001","Ad Tech Deep #002","2.249","612","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Ad Tech Deep #002","Ad Tech Deep #003","6.675","5.777","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Ad Tech Deep #003","Ad Tech Deep #004","1.777","4.727","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Ad Tech Deep #004","Ad Tech Deep #005","5.423","5.626","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ad Tech Deep #005","Ad Tech Deep #001","5.833","4.921","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":482},{"label":"Fev","value":471},{"label":"Mar","value":480},{"label":"Abr","value":542},{"label":"Mai","value":597},{"label":"Jun","value":519},{"label":"Jul","value":329},{"label":"Ago","value":448},{"label":"Set","value":302},{"label":"Out","value":272},{"label":"Nov","value":309},{"label":"Dez","value":237}];
const MX = 597;
