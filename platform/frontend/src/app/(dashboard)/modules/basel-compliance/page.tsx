...
/* ═══ Basel III/IV Compliance — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "9484", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4589", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€391K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "-17%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "240648684", cells: ["BAS-7684", "Basel III/IV Compliance Item 1", "25/1/2026", "€48 784"], status: "active" as const },
    { id: "240652255", cells: ["BAS-2255", "Basel III/IV Compliance Item 2", "12/8/2026", "€2355"], status: "pending" as const },
    { id: "240655826", cells: ["BAS-5826", "Basel III/IV Compliance Item 3", "27/3/2026", "€5926"], status: "completed" as const },
    { id: "240659397", cells: ["BAS-9397", "Basel III/IV Compliance Item 4", "14/10/2026", "€9497"], status: "warning" as const },
    { id: "240662968", cells: ["BAS-3968", "Basel III/IV Compliance Item 5", "1/5/2026", "€13 068"], status: "active" as const },
];
...
export default function BaselIiiivCompliancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Basel III/IV Compliance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Basel III/IV Compliance</p>
                    </div>
                </div>
