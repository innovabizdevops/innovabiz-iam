...
const ACCENT = "#dc2626";
const MODULE = "Basel III/IV Compliance";
const PAGE = "Risk Weight";
const KPIS = [{"l":"Riscos Identificados","v":"414","t":"+12.2%","d":"up"},{"l":"Mitigações Ativas","v":"2.137","t":"-4.6%","d":"down"},{"l":"Score Risco Geral","v":"84","t":"+10.3%","d":"up"},{"l":"Incidentes YTD","v":"4.343","t":"+17.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.022","1.449","311","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.353","7.767","1.964","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","662","3.918","133","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.312","297","8.286","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","314","328","4.373","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1070},{"label":"Fev","value":898},{"label":"Mar","value":861},{"label":"Abr","value":836},{"label":"Mai","value":849},{"label":"Jun","value":718},{"label":"Jul","value":913},{"label":"Ago","value":677},{"label":"Set","value":747},{"label":"Out","value":1034},{"label":"Nov","value":953},{"label":"Dez","value":774}];
const MX = 1070;
