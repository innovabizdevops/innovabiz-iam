...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.470","t":"-5.3%","d":"down"},{"l":"NC Abertas","v":"6.813","t":"+5.1%","d":"up"},{"l":"Conformidade (%)","v":"93.2%","t":"+11.9%","d":"up"},{"l":"CAPAs Pendentes","v":"9.038","t":"+1.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.865","86.5%","4.818","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.155","98.6%","8.964","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","185","75.5%","716","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.757","83.7%","4.508","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.312","91.2%","5.690","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":819},{"label":"Mar","value":684},{"label":"Abr","value":702},{"label":"Mai","value":783},{"label":"Jun","value":1008},{"label":"Jul","value":952},{"label":"Ago","value":1025},{"label":"Set","value":899},{"label":"Out","value":808},{"label":"Nov","value":674},{"label":"Dez","value":1026}];
const MX = 1026;
