...
const PAGE = "Capital";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.095","t":"+5.8%","d":"up"},{"l":"NC Abertas","v":"2.488","t":"+12.6%","d":"up"},{"l":"Conformidade (%)","v":"93.8%","t":"-5.4%","d":"down"},{"l":"CAPAs Pendentes","v":"6.093","t":"+11.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.858","91.4%","6.673","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.468","97.0%","432","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.709","83.9%","1.984","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.629","90.9%","8.759","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.549","94.9%","3.434","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":624},{"label":"Mar","value":877},{"label":"Abr","value":896},{"label":"Mai","value":671},{"label":"Jun","value":627},{"label":"Jul","value":731},{"label":"Ago","value":544},{"label":"Set","value":784},{"label":"Out","value":603},{"label":"Nov","value":773},{"label":"Dez","value":823}];
const MX = 896;
