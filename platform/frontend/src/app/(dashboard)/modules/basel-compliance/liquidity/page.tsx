...
const KPIS = [{"l":"Auditorias Realizadas","v":"1.390","t":"-5.3%","d":"down"},{"l":"NC Abertas","v":"158","t":"+10.7%","d":"up"},{"l":"Conformidade (%)","v":"83.4%","t":"+8.5%","d":"up"},{"l":"CAPAs Pendentes","v":"3.186","t":"+12.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.512","93.7%","792","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","817","92.1%","5.334","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.465","97.7%","1.257","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.786","77.9%","2.331","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.198","97.6%","1.074","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":761},{"label":"Mar","value":551},{"label":"Abr","value":810},{"label":"Mai","value":933},{"label":"Jun","value":921},{"label":"Jul","value":616},{"label":"Ago","value":570},{"label":"Set","value":722},{"label":"Out","value":673},{"label":"Nov","value":753},{"label":"Dez","value":752}];
const MX = 933;
