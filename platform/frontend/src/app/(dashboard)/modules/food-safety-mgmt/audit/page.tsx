...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.321","t":"-2.9%","d":"down"},{"l":"NC Abertas","v":"233","t":"+4.7%","d":"up"},{"l":"Conformidade (%)","v":"71.9%","t":"+17.0%","d":"up"},{"l":"CAPAs Pendentes","v":"3.952","t":"+11.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.831","73.2%","5.462","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.619","82.4%","3.771","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.392","73.9%","3.511","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.592","88.2%","4.462","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.765","84.1%","4.343","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":328},{"label":"Mar","value":421},{"label":"Abr","value":406},{"label":"Mai","value":618},{"label":"Jun","value":681},{"label":"Jul","value":447},{"label":"Ago","value":454},{"label":"Set","value":574},{"label":"Out","value":316},{"label":"Nov","value":582},{"label":"Dez","value":370}];
const MX = 681;
