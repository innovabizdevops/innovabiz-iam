...
const PAGE = "Rider Mgmt";
const KPIS = [{"l":"Total Concert Mgmt","v":"5.876","t":"-5.1%","d":"down"},{"l":"Rider Mgmt Ativos","v":"960","t":"+15.3%","d":"up"},{"l":"Eficiência (%)","v":"90.7%","t":"-2.8%","d":"down"},{"l":"Score Performance","v":"83","t":"-1.9%","d":"down"}];
const COLS = ["ID","Rider Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Concert Mgmt #001","Concert Mgmt #002","8.275","3.784","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Concert Mgmt #002","Concert Mgmt #003","2.915","6.644","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Concert Mgmt #003","Concert Mgmt #004","2.296","214","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Concert Mgmt #004","Concert Mgmt #005","4.695","3.737","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Concert Mgmt #005","Concert Mgmt #001","3.180","6.717","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":537},{"label":"Fev","value":258},{"label":"Mar","value":561},{"label":"Abr","value":484},{"label":"Mai","value":424},{"label":"Jun","value":359},{"label":"Jul","value":515},{"label":"Ago","value":381},{"label":"Set","value":457},{"label":"Out","value":289},{"label":"Nov","value":336},{"label":"Dez","value":510}];
const MX = 561;
