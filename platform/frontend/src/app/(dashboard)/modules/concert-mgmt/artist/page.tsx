...
const PAGE = "Artist Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"1.688","t":"+17.3%","d":"up"},{"l":"RevPAR (€)","v":"€93357","t":"+3.6%","d":"up"},{"l":"Ocupação (%)","v":"78.6%","t":"+11.4%","d":"up"},{"l":"Guest Satisfaction","v":"2.215","t":"+14.7%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","5.211","2026-03-22","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.999","2026-01-01","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.627","2026-02-20","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.638","2026-02-11","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.894","2026-03-20","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":463},{"label":"Fev","value":507},{"label":"Mar","value":760},{"label":"Abr","value":738},{"label":"Mai","value":505},{"label":"Jun","value":533},{"label":"Jul","value":619},{"label":"Ago","value":611},{"label":"Set","value":719},{"label":"Out","value":737},{"label":"Nov","value":734},{"label":"Dez","value":758}];
const MX = 760;
