...
const KPIS = [{"l":"Total Concert Mgmt","v":"8.297","t":"+9.7%","d":"up"},{"l":"Production Ativos","v":"9.061","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"81.0%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"76","t":"+17.6%","d":"up"}];
const COLS = ["ID","Production","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Concert Mgmt #001","Concert Mgmt #002","6.964","1.292","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Concert Mgmt #002","Concert Mgmt #003","5.268","8.731","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Concert Mgmt #003","Concert Mgmt #004","8.008","284","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Concert Mgmt #004","Concert Mgmt #005","835","9.019","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Concert Mgmt #005","Concert Mgmt #001","1.564","2.287","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":598},{"label":"Mar","value":554},{"label":"Abr","value":617},{"label":"Mai","value":571},{"label":"Jun","value":376},{"label":"Jul","value":493},{"label":"Ago","value":554},{"label":"Set","value":698},{"label":"Out","value":614},{"label":"Nov","value":306},{"label":"Dez","value":631}];
const MX = 698;
