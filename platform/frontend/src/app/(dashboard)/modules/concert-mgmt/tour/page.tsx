...
const ACCENT = "#4338ca";
const MODULE = "Concert Management";
const PAGE = "Tour Planning";
const KPIS = [{"l":"Total Concert Mgmt","v":"7.274","t":"+12.9%","d":"up"},{"l":"Tour Planning Ativos","v":"8.014","t":"+13.0%","d":"up"},{"l":"Eficiência (%)","v":"86.0%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"68","t":"+4.4%","d":"up"}];
const COLS = ["ID","Tour Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Concert Mgmt #001","Concert Mgmt #002","3.506","4.707","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Concert Mgmt #002","Concert Mgmt #003","3.435","5.346","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Concert Mgmt #003","Concert Mgmt #004","4.419","6.509","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Concert Mgmt #004","Concert Mgmt #005","8.713","8.535","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Concert Mgmt #005","Concert Mgmt #001","4.647","7.942","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":847},{"label":"Mar","value":857},{"label":"Abr","value":829},{"label":"Mai","value":798},{"label":"Jun","value":758},{"label":"Jul","value":956},{"label":"Ago","value":788},{"label":"Set","value":755},{"label":"Out","value":886},{"label":"Nov","value":611},{"label":"Dez","value":867}];
const MX = 956;
