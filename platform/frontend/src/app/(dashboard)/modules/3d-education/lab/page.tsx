...
const PAGE = "Lab";
const KPIS = [{"l":"Total 3d Education","v":"754","t":"+11.7%","d":"up"},{"l":"Lab Ativos","v":"8.881","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"80.5%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"74","t":"+10.8%","d":"up"}];
const COLS = ["ID","Lab","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Education #001","3d Education #002","395","7.522","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["3d Education #002","3d Education #003","3.648","6.611","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Education #003","3d Education #004","7.745","7.369","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["3d Education #004","3d Education #005","6.632","6.045","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Education #005","3d Education #001","3.372","7.309","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":948},{"label":"Fev","value":728},{"label":"Mar","value":744},{"label":"Abr","value":842},{"label":"Mai","value":917},{"label":"Jun","value":1015},{"label":"Jul","value":959},{"label":"Ago","value":917},{"label":"Set","value":1052},{"label":"Out","value":759},{"label":"Nov","value":794},{"label":"Dez","value":986}];
const MX = 1052;
