...
const PAGE = "Resource";
const KPIS = [{"l":"Total 3d Education","v":"520","t":"+8.5%","d":"up"},{"l":"Resource Ativos","v":"1.511","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"78.3%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"64","t":"+8.8%","d":"up"}];
const COLS = ["ID","Resource","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Education #001","3d Education #002","8.931","7.216","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["3d Education #002","3d Education #003","2.222","8.308","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Education #003","3d Education #004","5.428","3.471","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["3d Education #004","3d Education #005","2.555","8.972","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Education #005","3d Education #001","6.336","1.677","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":888},{"label":"Fev","value":974},{"label":"Mar","value":926},{"label":"Abr","value":940},{"label":"Mai","value":759},{"label":"Jun","value":911},{"label":"Jul","value":746},{"label":"Ago","value":887},{"label":"Set","value":978},{"label":"Out","value":713},{"label":"Nov","value":782},{"label":"Dez","value":792}];
const MX = 978;
