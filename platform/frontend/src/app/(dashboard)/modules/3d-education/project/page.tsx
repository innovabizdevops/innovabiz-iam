...
const PAGE = "Project";
const KPIS = [{"l":"Total 3d Education","v":"2.340","t":"+13.0%","d":"up"},{"l":"Project Ativos","v":"3.660","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"69.8%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"92","t":"-5.2%","d":"down"}];
const COLS = ["ID","Project","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Education #001","3d Education #002","5.195","6.966","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["3d Education #002","3d Education #003","7.827","7.592","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Education #003","3d Education #004","5.504","224","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["3d Education #004","3d Education #005","2.293","1.916","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Education #005","3d Education #001","3.251","8.487","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":478},{"label":"Mar","value":570},{"label":"Abr","value":221},{"label":"Mai","value":479},{"label":"Jun","value":292},{"label":"Jul","value":488},{"label":"Ago","value":342},{"label":"Set","value":604},{"label":"Out","value":309},{"label":"Nov","value":253},{"label":"Dez","value":598}];
const MX = 604;
