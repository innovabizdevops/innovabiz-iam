...
/* ═══ 3D Printing Education — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "1411", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1000", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€248K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "-19%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "682141011", cells: ["3D-5011", "3D Printing Education Item 1", "28/4/2026", "€41 111"], status: "active" as const },
    { id: "682144582", cells: ["3D-8582", "3D Printing Education Item 2", "15/11/2026", "€44 682"], status: "pending" as const },
    { id: "682148153", cells: ["3D-3153", "3D Printing Education Item 3", "2/6/2026", "€48 253"], status: "completed" as const },
    { id: "682151724", cells: ["3D-6724", "3D Printing Education Item 4", "17/1/2026", "€1824"], status: "warning" as const },
    { id: "682155295", cells: ["3D-1295", "3D Printing Education Item 5", "4/8/2026", "€5395"], status: "active" as const },
];
...
export default function P3dPrintingEducationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">3D Printing Education</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • 3D Printing Education</p>
                    </div>
                </div>
