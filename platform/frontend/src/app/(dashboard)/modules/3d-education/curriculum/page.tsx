...
const ACCENT = "#4f46e5";
const MODULE = "3D Printing Education";
const PAGE = "Curriculum";
const KPIS = [{"l":"Total 3d Education","v":"2.867","t":"+7.8%","d":"up"},{"l":"Curriculum Ativos","v":"3.899","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"81.0%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"72","t":"+16.3%","d":"up"}];
const COLS = ["ID","Curriculum","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Education #001","3d Education #002","3.782","8.634","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["3d Education #002","3d Education #003","2.483","4.273","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Education #003","3d Education #004","2.687","8.663","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["3d Education #004","3d Education #005","3.674","1.256","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Education #005","3d Education #001","212","7.814","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":360},{"label":"Fev","value":436},{"label":"Mar","value":515},{"label":"Abr","value":372},{"label":"Mai","value":317},{"label":"Jun","value":660},{"label":"Jul","value":355},{"label":"Ago","value":656},{"label":"Set","value":325},{"label":"Out","value":306},{"label":"Nov","value":389},{"label":"Dez","value":563}];
const MX = 660;
