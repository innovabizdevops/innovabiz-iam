...
/* ═══ Demand Sensing & Shaping — Dashboard ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total Registos", value: "5004", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4969", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€147K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1332683504", cells: ["DEM-9504", "Demand Sensing & Shaping Item 1", "13/9/2026", "€33 604"], status: "active" as const },
    { id: "1332687075", cells: ["DEM-4075", "Demand Sensing & Shaping Item 2", "28/4/2026", "€37 175"], status: "pending" as const },
    { id: "1332690646", cells: ["DEM-7646", "Demand Sensing & Shaping Item 3", "15/11/2026", "€40 746"], status: "completed" as const },
    { id: "1332694217", cells: ["DEM-2217", "Demand Sensing & Shaping Item 4", "2/6/2026", "€44 317"], status: "warning" as const },
    { id: "1332697788", cells: ["DEM-5788", "Demand Sensing & Shaping Item 5", "17/1/2026", "€47 888"], status: "active" as const },
];
...
export default function DemandSensingShapingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Demand Sensing & Shaping</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Demand Sensing & Shaping</p>
                    </div>
                </div>
