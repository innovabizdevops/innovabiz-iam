...
const PAGE = "Schedule";
const KPIS = [{"l":"Atletas Registados","v":"2.045","t":"-5.0%","d":"down"},{"l":"Treinos/Semana","v":"4592","t":"+14.9%","d":"up"},{"l":"Competições","v":"8.832","t":"+0.9%","d":"up"},{"l":"Performance Score","v":"76","t":"-1.9%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.837","8.389","6.170","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.904","7.919","3.846","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.096","3.568","3.982","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.706","653","8.526","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.361","3.559","3.906","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":528},{"label":"Mar","value":463},{"label":"Abr","value":465},{"label":"Mai","value":540},{"label":"Jun","value":765},{"label":"Jul","value":660},{"label":"Ago","value":601},{"label":"Set","value":758},{"label":"Out","value":747},{"label":"Nov","value":654},{"label":"Dez","value":498}];
const MX = 765;
