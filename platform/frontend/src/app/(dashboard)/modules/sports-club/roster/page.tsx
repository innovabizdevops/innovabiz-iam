...
const PAGE = "Roster";
const KPIS = [{"l":"Atletas Registados","v":"8.066","t":"-1.5%","d":"down"},{"l":"Treinos/Semana","v":"1646","t":"-1.6%","d":"down"},{"l":"Competições","v":"6.820","t":"+3.4%","d":"up"},{"l":"Performance Score","v":"59","t":"-0.7%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.294","2.751","3.421","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.710","1.837","508","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","9.002","8.133","8.890","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.853","7.019","2.305","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","940","4.253","5.983","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":257},{"label":"Fev","value":518},{"label":"Mar","value":385},{"label":"Abr","value":393},{"label":"Mai","value":439},{"label":"Jun","value":591},{"label":"Jul","value":529},{"label":"Ago","value":283},{"label":"Set","value":619},{"label":"Out","value":296},{"label":"Nov","value":454},{"label":"Dez","value":558}];
const MX = 619;
