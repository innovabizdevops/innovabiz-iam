...
const PAGE = "Facility";
const KPIS = [{"l":"Atletas Registados","v":"1.304","t":"+14.1%","d":"up"},{"l":"Treinos/Semana","v":"943","t":"+13.9%","d":"up"},{"l":"Competições","v":"632","t":"+6.4%","d":"up"},{"l":"Performance Score","v":"70","t":"+3.2%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.287","6.277","6.219","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","160","4.586","2.154","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.637","8.274","2.240","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.900","7.138","6.515","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","105","5.678","1.586","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":724},{"label":"Mar","value":506},{"label":"Abr","value":426},{"label":"Mai","value":569},{"label":"Jun","value":619},{"label":"Jul","value":701},{"label":"Ago","value":463},{"label":"Set","value":396},{"label":"Out","value":670},{"label":"Nov","value":540},{"label":"Dez","value":700}];
const MX = 724;
