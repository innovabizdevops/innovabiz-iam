...
const ACCENT = "#6366f1";
const MODULE = "Sports Club Mgmt";
const PAGE = "Fan Engage";
const KPIS = [{"l":"Atletas Registados","v":"5.141","t":"+4.4%","d":"up"},{"l":"Treinos/Semana","v":"1227","t":"-5.4%","d":"down"},{"l":"Competições","v":"3.550","t":"+10.0%","d":"up"},{"l":"Performance Score","v":"56","t":"+2.8%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.302","9.038","8.179","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.170","6.630","1.844","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.074","883","6.850","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.214","6.408","5.442","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.910","7.384","261","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":434},{"label":"Fev","value":587},{"label":"Mar","value":244},{"label":"Abr","value":438},{"label":"Mai","value":330},{"label":"Jun","value":609},{"label":"Jul","value":629},{"label":"Ago","value":567},{"label":"Set","value":333},{"label":"Out","value":529},{"label":"Nov","value":633},{"label":"Dez","value":548}];
const MX = 633;
