...
const PAGE = "Finance";
const KPIS = [{"l":"Atletas Registados","v":"4.283","t":"+10.6%","d":"up"},{"l":"Treinos/Semana","v":"2467","t":"+6.8%","d":"up"},{"l":"Competições","v":"1.853","t":"+13.7%","d":"up"},{"l":"Performance Score","v":"86","t":"+3.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.771","1.326","759","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.891","2.818","5.304","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.588","8.836","9.045","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.320","4.264","955","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.890","5.019","3.239","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":436},{"label":"Mar","value":579},{"label":"Abr","value":809},{"label":"Mai","value":646},{"label":"Jun","value":654},{"label":"Jul","value":481},{"label":"Ago","value":808},{"label":"Set","value":588},{"label":"Out","value":458},{"label":"Nov","value":693},{"label":"Dez","value":474}];
const MX = 809;
