...
const KPIS = [
    { label: "Total Registos", value: "2598", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1867", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€23K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1003515998", cells: ["AI-7998", "EU AI Act Compliance Item 1", "3/3/2026", "€16 098"], status: "active" as const },
    { id: "1003519569", cells: ["AI-2569", "EU AI Act Compliance Item 2", "18/10/2026", "€19 669"], status: "pending" as const },
    { id: "1003523140", cells: ["AI-6140", "EU AI Act Compliance Item 3", "5/5/2026", "€23 240"], status: "completed" as const },
    { id: "1003526711", cells: ["AI-9711", "EU AI Act Compliance Item 4", "20/12/2026", "€26 811"], status: "warning" as const },
    { id: "1003530282", cells: ["AI-4282", "EU AI Act Compliance Item 5", "7/7/2026", "€30 382"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EU AI Act Compliance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EU AI Act Compliance</p>
                    </div>
                </div>
