...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.971","t":"+14.5%","d":"up"},{"l":"NC Abertas","v":"3.585","t":"-5.7%","d":"down"},{"l":"Conformidade (%)","v":"93.2%","t":"+6.0%","d":"up"},{"l":"CAPAs Pendentes","v":"6.275","t":"+4.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.636","76.0%","5.444","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.634","91.4%","7.764","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.600","72.4%","3.336","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.761","81.9%","6.749","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","687","91.4%","4.308","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":434},{"label":"Fev","value":465},{"label":"Mar","value":341},{"label":"Abr","value":472},{"label":"Mai","value":332},{"label":"Jun","value":413},{"label":"Jul","value":647},{"label":"Ago","value":488},{"label":"Set","value":577},{"label":"Out","value":372},{"label":"Nov","value":354},{"label":"Dez","value":537}];
const MX = 647;
