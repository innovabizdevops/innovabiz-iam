...
const KPIS = [{"l":"Auditorias Realizadas","v":"1.292","t":"+3.0%","d":"up"},{"l":"NC Abertas","v":"7.788","t":"+3.0%","d":"up"},{"l":"Conformidade (%)","v":"85.3%","t":"-4.7%","d":"down"},{"l":"CAPAs Pendentes","v":"5.875","t":"+5.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.344","85.8%","8.991","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.982","76.3%","3.026","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.181","76.0%","739","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.611","71.3%","6.971","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","715","90.3%","5.343","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":531},{"label":"Mar","value":776},{"label":"Abr","value":819},{"label":"Mai","value":566},{"label":"Jun","value":531},{"label":"Jul","value":721},{"label":"Ago","value":803},{"label":"Set","value":862},{"label":"Out","value":537},{"label":"Nov","value":527},{"label":"Dez","value":838}];
const MX = 862;
