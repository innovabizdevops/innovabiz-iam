...
const PAGE = "Risk Class";
const KPIS = [{"l":"Riscos Identificados","v":"5.683","t":"+10.3%","d":"up"},{"l":"Mitigações Ativas","v":"8.138","t":"-4.7%","d":"down"},{"l":"Score Risco Geral","v":"84","t":"+9.3%","d":"up"},{"l":"Incidentes YTD","v":"2.561","t":"+8.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.876","1.359","5.184","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","463","1.046","3.202","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","876","2.783","2.266","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.662","4.317","2.647","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.649","6.800","4.059","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":412},{"label":"Fev","value":772},{"label":"Mar","value":674},{"label":"Abr","value":471},{"label":"Mai","value":483},{"label":"Jun","value":728},{"label":"Jul","value":655},{"label":"Ago","value":597},{"label":"Set","value":426},{"label":"Out","value":515},{"label":"Nov","value":641},{"label":"Dez","value":433}];
const MX = 772;
