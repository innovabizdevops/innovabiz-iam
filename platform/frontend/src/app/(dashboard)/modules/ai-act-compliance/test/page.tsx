...
const ACCENT = "#dc2626";
const MODULE = "EU AI Act Compliance";
const PAGE = "Test";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.070","t":"+10.5%","d":"up"},{"l":"NC Abertas","v":"267","t":"-3.0%","d":"down"},{"l":"Conformidade (%)","v":"77.1%","t":"-0.9%","d":"down"},{"l":"CAPAs Pendentes","v":"4.765","t":"+0.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","635","99.9%","1.731","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.693","99.0%","8.031","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","356","99.8%","7.638","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.594","77.3%","4.586","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.789","72.8%","5.969","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":649},{"label":"Mar","value":895},{"label":"Abr","value":948},{"label":"Mai","value":722},{"label":"Jun","value":714},{"label":"Jul","value":791},{"label":"Ago","value":650},{"label":"Set","value":801},{"label":"Out","value":885},{"label":"Nov","value":790},{"label":"Dez","value":647}];
const MX = 948;
