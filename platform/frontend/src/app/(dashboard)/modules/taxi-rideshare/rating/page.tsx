...
const PAGE = "Rating";
const KPIS = [{"l":"Surveys Ativos","v":"4.002","t":"+15.4%","d":"up"},{"l":"Respostas/Semana","v":"1480","t":"+4.6%","d":"up"},{"l":"NPS Médio","v":"89","t":"+10.5%","d":"up"},{"l":"Taxa Resposta (%)","v":"89.4%","t":"+11.1%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","7.130","89","79.2%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","5.613","78","79.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","1.911","57","72.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","688","81","79.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","4.500","80","82.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":895},{"label":"Mar","value":641},{"label":"Abr","value":648},{"label":"Mai","value":1034},{"label":"Jun","value":939},{"label":"Jul","value":961},{"label":"Ago","value":862},{"label":"Set","value":956},{"label":"Out","value":782},{"label":"Nov","value":969},{"label":"Dez","value":847}];
const MX = 1034;
