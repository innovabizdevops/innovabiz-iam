...
const PAGE = "Pricing";
const KPIS = [{"l":"ARR (€M)","v":"€37.3M","t":"+1.5%","d":"up"},{"l":"MRR (€)","v":"€89095","t":"+1.6%","d":"up"},{"l":"Churn (%)","v":"77.9%","t":"+13.6%","d":"up"},{"l":"ARPU (€)","v":"€16497","t":"+16.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 30133.48","102","€ 24634.10","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 37379.25","1.860","€ 24091.09","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 26908.09","5.042","€ 22895.10","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 11005.90","3.261","€ 32462.83","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 27053.92","8.105","€ 31070.00","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":907},{"label":"Mar","value":776},{"label":"Abr","value":849},{"label":"Mai","value":806},{"label":"Jun","value":826},{"label":"Jul","value":818},{"label":"Ago","value":943},{"label":"Set","value":691},{"label":"Out","value":917},{"label":"Nov","value":635},{"label":"Dez","value":706}];
const MX = 943;
