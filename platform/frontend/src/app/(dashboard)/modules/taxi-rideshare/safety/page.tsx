...
const PAGE = "Safety";
const KPIS = [{"l":"Total Taxi Rideshare","v":"8.039","t":"+12.7%","d":"up"},{"l":"Safety Ativos","v":"6.279","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"91.2%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"63","t":"+14.8%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Taxi Rideshare #001","Taxi Rideshare #002","7.421","8.677","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Taxi Rideshare #002","Taxi Rideshare #003","7.169","1.156","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Taxi Rideshare #003","Taxi Rideshare #004","8.331","7.184","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Taxi Rideshare #004","Taxi Rideshare #005","3.430","4.316","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Taxi Rideshare #005","Taxi Rideshare #001","6.593","8.775","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":736},{"label":"Mar","value":906},{"label":"Abr","value":663},{"label":"Mai","value":1002},{"label":"Jun","value":707},{"label":"Jul","value":674},{"label":"Ago","value":798},{"label":"Set","value":899},{"label":"Out","value":678},{"label":"Nov","value":914},{"label":"Dez","value":675}];
const MX = 1002;
