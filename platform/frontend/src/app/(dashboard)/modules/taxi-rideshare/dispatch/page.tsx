...
const ACCENT = "#6366f1";
const MODULE = "Taxi & Rideshare";
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"8.423","t":"-2.4%","d":"down"},{"l":"Viagens/Dia","v":"3020","t":"+0.5%","d":"up"},{"l":"Pontualidade (%)","v":"90.3%","t":"+4.9%","d":"up"},{"l":"Passageiros/Dia","v":"1666","t":"+2.4%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-10","2026-01-21","3.584","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-16","2026-02-25","8.167","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-22","2026-03-09","3.486","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-28","2026-03-01","5.066","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-05","2026-01-24","3.904","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":703},{"label":"Mar","value":686},{"label":"Abr","value":864},{"label":"Mai","value":914},{"label":"Jun","value":766},{"label":"Jul","value":641},{"label":"Ago","value":516},{"label":"Set","value":782},{"label":"Out","value":674},{"label":"Nov","value":688},{"label":"Dez","value":909}];
const MX = 914;
