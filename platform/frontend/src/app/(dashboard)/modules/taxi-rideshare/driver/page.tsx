...
const PAGE = "Driver";
const KPIS = [{"l":"Total Taxi Rideshare","v":"6.154","t":"+11.4%","d":"up"},{"l":"Driver Ativos","v":"5.180","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"86.1%","t":"+5.5%","d":"up"},{"l":"Score Performance","v":"78","t":"+6.8%","d":"up"}];
const COLS = ["ID","Driver","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Taxi Rideshare #001","Taxi Rideshare #002","4.400","6.583","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Taxi Rideshare #002","Taxi Rideshare #003","5.088","1.843","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Taxi Rideshare #003","Taxi Rideshare #004","2.929","3.882","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Taxi Rideshare #004","Taxi Rideshare #005","1.169","1.108","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Taxi Rideshare #005","Taxi Rideshare #001","1.875","4.683","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":415},{"label":"Fev","value":443},{"label":"Mar","value":514},{"label":"Abr","value":419},{"label":"Mai","value":691},{"label":"Jun","value":389},{"label":"Jul","value":707},{"label":"Ago","value":479},{"label":"Set","value":542},{"label":"Out","value":481},{"label":"Nov","value":631},{"label":"Dez","value":344}];
const MX = 707;
