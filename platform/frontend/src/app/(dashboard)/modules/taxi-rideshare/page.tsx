...
export default function TaxiRidesharePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Taxi Rideshare</h1><p className="text-sm text-muted-foreground">Taxi Rideshare • iBOS Enterprise</p></div>
