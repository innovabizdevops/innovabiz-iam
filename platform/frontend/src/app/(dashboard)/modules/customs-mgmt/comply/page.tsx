...
const PAGE = "Comply";
const KPIS = [{"l":"Total Customs Mgmt","v":"€34828","t":"+14.4%","d":"up"},{"l":"Comply Ativos","v":"1.812","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"65.9%","t":"+6.7%","d":"up"},{"l":"Score Performance","v":"86","t":"+15.9%","d":"up"}];
const COLS = ["ID","Comply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Mgmt #001","Customs Mgmt #002","417","7.774","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Mgmt #002","Customs Mgmt #003","920","1.545","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Mgmt #003","Customs Mgmt #004","201","5.113","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Mgmt #004","Customs Mgmt #005","3.111","4.082","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Mgmt #005","Customs Mgmt #001","8.164","3.371","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":323},{"label":"Fev","value":680},{"label":"Mar","value":430},{"label":"Abr","value":643},{"label":"Mai","value":339},{"label":"Jun","value":499},{"label":"Jul","value":326},{"label":"Ago","value":688},{"label":"Set","value":672},{"label":"Out","value":557},{"label":"Nov","value":414},{"label":"Dez","value":570}];
const MX = 688;
