...
const ACCENT = "#dc2626";
const MODULE = "Customs Management";
const PAGE = "Clearance";
const KPIS = [{"l":"Total Customs Mgmt","v":"€65932","t":"+0.6%","d":"up"},{"l":"Clearance Ativos","v":"6.655","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"92.1%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"57","t":"+13.0%","d":"up"}];
const COLS = ["ID","Clearance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Mgmt #001","Customs Mgmt #002","6.889","8.269","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Mgmt #002","Customs Mgmt #003","6.100","3.620","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Mgmt #003","Customs Mgmt #004","4.568","628","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Mgmt #004","Customs Mgmt #005","3.275","4.581","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Mgmt #005","Customs Mgmt #001","3.315","7.611","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":902},{"label":"Fev","value":890},{"label":"Mar","value":773},{"label":"Abr","value":666},{"label":"Mai","value":675},{"label":"Jun","value":777},{"label":"Jul","value":616},{"label":"Ago","value":811},{"label":"Set","value":642},{"label":"Out","value":804},{"label":"Nov","value":674},{"label":"Dez","value":916}];
const MX = 916;
