...
const PAGE = "Tariff";
const KPIS = [{"l":"Total Customs Mgmt","v":"€46012","t":"-4.0%","d":"down"},{"l":"Tariff Ativos","v":"6.681","t":"+5.3%","d":"up"},{"l":"Eficiência (%)","v":"85.7%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"65","t":"+9.2%","d":"up"}];
const COLS = ["ID","Tariff","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Mgmt #001","Customs Mgmt #002","8.423","6.698","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Mgmt #002","Customs Mgmt #003","5.871","3.774","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Mgmt #003","Customs Mgmt #004","8.271","406","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Mgmt #004","Customs Mgmt #005","1.888","3.845","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Mgmt #005","Customs Mgmt #001","3.473","6.854","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":649},{"label":"Mar","value":851},{"label":"Abr","value":856},{"label":"Mai","value":790},{"label":"Jun","value":778},{"label":"Jul","value":823},{"label":"Ago","value":896},{"label":"Set","value":683},{"label":"Out","value":691},{"label":"Nov","value":741},{"label":"Dez","value":680}];
const MX = 896;
