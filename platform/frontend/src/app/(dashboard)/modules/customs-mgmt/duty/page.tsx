...
const PAGE = "Duty";
const KPIS = [{"l":"Total Customs Mgmt","v":"€59463","t":"+5.4%","d":"up"},{"l":"Duty Ativos","v":"4.309","t":"-5.4%","d":"down"},{"l":"Eficiência (%)","v":"76.5%","t":"+13.2%","d":"up"},{"l":"Score Performance","v":"61","t":"+11.4%","d":"up"}];
const COLS = ["ID","Duty","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Mgmt #001","Customs Mgmt #002","1.049","2.432","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Mgmt #002","Customs Mgmt #003","8.455","1.796","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Mgmt #003","Customs Mgmt #004","4.504","4.592","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Mgmt #004","Customs Mgmt #005","6.220","4.218","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Mgmt #005","Customs Mgmt #001","951","7.881","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":494},{"label":"Mar","value":626},{"label":"Abr","value":809},{"label":"Mai","value":777},{"label":"Jun","value":851},{"label":"Jul","value":640},{"label":"Ago","value":669},{"label":"Set","value":651},{"label":"Out","value":743},{"label":"Nov","value":603},{"label":"Dez","value":685}];
const MX = 875;
