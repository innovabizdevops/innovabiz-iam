...
const PAGE = "Declare";
const KPIS = [{"l":"Total Customs Mgmt","v":"€74006","t":"+0.3%","d":"up"},{"l":"Declare Ativos","v":"8.099","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"68.9%","t":"+10.6%","d":"up"},{"l":"Score Performance","v":"56","t":"+16.0%","d":"up"}];
const COLS = ["ID","Declare","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Mgmt #001","Customs Mgmt #002","8.468","4.932","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Mgmt #002","Customs Mgmt #003","2.373","1.930","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Mgmt #003","Customs Mgmt #004","542","8.127","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Mgmt #004","Customs Mgmt #005","6.531","2.929","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Mgmt #005","Customs Mgmt #001","4.880","947","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":505},{"label":"Mar","value":761},{"label":"Abr","value":609},{"label":"Mai","value":782},{"label":"Jun","value":736},{"label":"Jul","value":740},{"label":"Ago","value":411},{"label":"Set","value":670},{"label":"Out","value":427},{"label":"Nov","value":545},{"label":"Dez","value":698}];
const MX = 782;
