...
const KPIS = [
    { label: "Total Registos", value: "7749", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2138", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€316K", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "997937549", cells: ["CUS-9549", "Customs Management Item 1", "22/6/2026", "€37 649"], status: "active" as const },
    { id: "997941120", cells: ["CUS-4120", "Customs Management Item 2", "9/1/2026", "€41 220"], status: "pending" as const },
    { id: "997944691", cells: ["CUS-7691", "Customs Management Item 3", "24/8/2026", "€44 791"], status: "completed" as const },
    { id: "997948262", cells: ["CUS-2262", "Customs Management Item 4", "11/3/2026", "€48 362"], status: "warning" as const },
    { id: "997951833", cells: ["CUS-5833", "Customs Management Item 5", "26/10/2026", "€1933"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Customs Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Customs Management</p>
                    </div>
                </div>
