...
const ROWS = [
  { id: "001", c: ["Sweep Target-001", "Sweep Target Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Sweep Target-002", "Sweep Target Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Sweep Target-003", "Sweep Target Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Sweep Target-004", "Sweep Target Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Sweep Target-005", "Sweep Target Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Sweep Target", ts: "Há 2min", a: "Sistema" },
...
export default function SweepTargetPage() {
  return (
