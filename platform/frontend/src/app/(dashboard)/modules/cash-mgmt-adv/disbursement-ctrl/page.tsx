...
const ROWS = [
  { id: "001", c: ["Disbursement Ctrl-001", "Disbursement Ctrl Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Disbursement Ctrl-002", "Disbursement Ctrl Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Disbursement Ctrl-003", "Disbursement Ctrl Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Disbursement Ctrl-004", "Disbursement Ctrl Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Disbursement Ctrl-005", "Disbursement Ctrl Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Disbursement Ctrl", ts: "Há 2min", a: "Sistema" },
...
export default function DisbursementCtrlPage() {
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Cash Mgmt Advanced — iBOS Enterprise</p>
        </div>
