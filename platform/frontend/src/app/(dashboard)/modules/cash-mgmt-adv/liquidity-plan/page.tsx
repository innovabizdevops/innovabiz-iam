...
const ROWS = [
  { id: "001", c: ["Liquidity Plan-001", "Liquidity Plan Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Liquidity Plan-002", "Liquidity Plan Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Liquidity Plan-003", "Liquidity Plan Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Liquidity Plan-004", "Liquidity Plan Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Liquidity Plan-005", "Liquidity Plan Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Liquidity Plan", ts: "Há 2min", a: "Sistema" },
...
export default function LiquidityPlanPage() {
  return (
