...
const ROWS = [
  { id: "001", c: ["Cash Concentration-001", "Cash Concentration Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Cash Concentration-002", "Cash Concentration Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Cash Concentration-003", "Cash Concentration Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Cash Concentration-004", "Cash Concentration Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Cash Concentration-005", "Cash Concentration Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Cash Concentration", ts: "Há 2min", a: "Sistema" },
