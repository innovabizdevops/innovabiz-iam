...
const ROWS = [
  { id: "001", c: ["Zero Balance-001", "Zero Balance Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Zero Balance-002", "Zero Balance Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Zero Balance-003", "Zero Balance Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Zero Balance-004", "Zero Balance Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Zero Balance-005", "Zero Balance Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Zero Balance", ts: "Há 2min", a: "Sistema" },
...
export default function ZeroBalancePage() {
  return (
