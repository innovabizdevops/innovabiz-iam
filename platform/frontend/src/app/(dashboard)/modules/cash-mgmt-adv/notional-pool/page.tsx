...
const ROWS = [
  { id: "001", c: ["Notional Pool-001", "Notional Pool Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Notional Pool-002", "Notional Pool Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Notional Pool-003", "Notional Pool Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Notional Pool-004", "Notional Pool Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Notional Pool-005", "Notional Pool Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Notional Pool", ts: "Há 2min", a: "Sistema" },
...
export default function NotionalPoolPage() {
  return (
