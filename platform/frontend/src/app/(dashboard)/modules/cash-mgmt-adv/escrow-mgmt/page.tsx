...
const ROWS = [
  { id: "001", c: ["Escrow Mgmt-001", "Escrow Mgmt Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Escrow Mgmt-002", "Escrow Mgmt Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Escrow Mgmt-003", "Escrow Mgmt Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Escrow Mgmt-004", "Escrow Mgmt Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Escrow Mgmt-005", "Escrow Mgmt Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Escrow Mgmt", ts: "Há 2min", a: "Sistema" },
...
export default function EscrowMgmtPage() {
  return (
