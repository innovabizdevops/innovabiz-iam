...
const PAGE = "Veneer";
const KPIS = [{"l":"Total Wood Product","v":"882","t":"-1.5%","d":"down"},{"l":"Veneer Ativos","v":"5.708","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"82.7%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"90","t":"+4.3%","d":"up"}];
const COLS = ["ID","Veneer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wood Product #001","Wood Product #002","6.975","492","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Wood Product #002","Wood Product #003","2.201","8.815","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Wood Product #003","Wood Product #004","1.307","8.615","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Wood Product #004","Wood Product #005","7.180","4.208","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wood Product #005","Wood Product #001","5.738","2.511","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":532},{"label":"Mar","value":604},{"label":"Abr","value":474},{"label":"Mai","value":430},{"label":"Jun","value":503},{"label":"Jul","value":669},{"label":"Ago","value":632},{"label":"Set","value":466},{"label":"Out","value":545},{"label":"Nov","value":304},{"label":"Dez","value":656}];
const MX = 669;
