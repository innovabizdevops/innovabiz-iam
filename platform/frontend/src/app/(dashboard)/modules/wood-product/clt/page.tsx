...
const PAGE = "CLT/Glulam";
const KPIS = [{"l":"Total Wood Product","v":"2.849","t":"-5.5%","d":"down"},{"l":"CLT/Glulam Ativos","v":"1.835","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"81.5%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"62","t":"+3.1%","d":"up"}];
const COLS = ["ID","CLT/Glulam","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wood Product #001","Wood Product #002","4.824","5.992","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Wood Product #002","Wood Product #003","7.430","2.220","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Wood Product #003","Wood Product #004","839","5.502","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Wood Product #004","Wood Product #005","4.531","6.938","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wood Product #005","Wood Product #001","7.480","707","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":822},{"label":"Fev","value":967},{"label":"Mar","value":748},{"label":"Abr","value":628},{"label":"Mai","value":846},{"label":"Jun","value":688},{"label":"Jul","value":854},{"label":"Ago","value":766},{"label":"Set","value":1002},{"label":"Out","value":697},{"label":"Nov","value":856},{"label":"Dez","value":777}];
const MX = 1002;
