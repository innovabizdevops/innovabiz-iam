...
const ACCENT = "#78350f";
const MODULE = "Wood Products";
const PAGE = "Biomass";
const KPIS = [{"l":"Total Wood Product","v":"8.130","t":"+17.9%","d":"up"},{"l":"Biomass Ativos","v":"3.859","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"75.5%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"90","t":"+8.6%","d":"up"}];
const COLS = ["ID","Biomass","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wood Product #001","Wood Product #002","1.834","5.770","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Wood Product #002","Wood Product #003","6.467","8.996","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Wood Product #003","Wood Product #004","1.155","3.732","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Wood Product #004","Wood Product #005","3.877","475","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wood Product #005","Wood Product #001","6.721","3.054","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":895},{"label":"Fev","value":903},{"label":"Mar","value":697},{"label":"Abr","value":985},{"label":"Mai","value":753},{"label":"Jun","value":912},{"label":"Jul","value":875},{"label":"Ago","value":898},{"label":"Set","value":811},{"label":"Out","value":982},{"label":"Nov","value":802},{"label":"Dez","value":708}];
const MX = 985;
