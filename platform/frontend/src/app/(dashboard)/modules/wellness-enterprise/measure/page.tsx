...
const ACCENT = "#b91c1c";
const MODULE = "Enterprise Wellness Platform";
const PAGE = "Measure";
const KPIS = [{"l":"Total Wellness Enterprise","v":"4.656","t":"+15.4%","d":"up"},{"l":"Measure Ativos","v":"7.950","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"80.3%","t":"+15.9%","d":"up"},{"l":"Score Performance","v":"95","t":"-0.8%","d":"down"}];
const COLS = ["ID","Measure","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wellness Enterprise #001","Wellness Enterprise #002","7.118","6.365","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Wellness Enterprise #002","Wellness Enterprise #003","3.415","7.181","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Wellness Enterprise #003","Wellness Enterprise #004","2.336","6.411","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Wellness Enterprise #004","Wellness Enterprise #005","8.090","5.481","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wellness Enterprise #005","Wellness Enterprise #001","8.483","6.202","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":854},{"label":"Mar","value":664},{"label":"Abr","value":848},{"label":"Mai","value":850},{"label":"Jun","value":751},{"label":"Jul","value":922},{"label":"Ago","value":919},{"label":"Set","value":939},{"label":"Out","value":741},{"label":"Nov","value":871},{"label":"Dez","value":762}];
const MX = 939;
