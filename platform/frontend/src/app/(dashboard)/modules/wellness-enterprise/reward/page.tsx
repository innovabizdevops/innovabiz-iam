...
const PAGE = "Reward";
const KPIS = [{"l":"Total Wellness Enterprise","v":"6.969","t":"+2.8%","d":"up"},{"l":"Reward Ativos","v":"3.349","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"66.2%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"83","t":"-2.0%","d":"down"}];
const COLS = ["ID","Reward","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wellness Enterprise #001","Wellness Enterprise #002","4.082","1.860","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Wellness Enterprise #002","Wellness Enterprise #003","9.052","8.451","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Wellness Enterprise #003","Wellness Enterprise #004","424","3.681","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Wellness Enterprise #004","Wellness Enterprise #005","8.451","4.413","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wellness Enterprise #005","Wellness Enterprise #001","6.457","7.156","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":638},{"label":"Mar","value":721},{"label":"Abr","value":559},{"label":"Mai","value":776},{"label":"Jun","value":503},{"label":"Jul","value":704},{"label":"Ago","value":650},{"label":"Set","value":570},{"label":"Out","value":611},{"label":"Nov","value":725},{"label":"Dez","value":629}];
const MX = 776;
