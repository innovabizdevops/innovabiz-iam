...
const PAGE = "Report";
const KPIS = [{"l":"Total Wellness Enterprise","v":"1.122","t":"-4.6%","d":"down"},{"l":"Report Ativos","v":"7.489","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"76.9%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"56","t":"+15.1%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wellness Enterprise #001","Wellness Enterprise #002","7.574","1.269","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Wellness Enterprise #002","Wellness Enterprise #003","3.318","5.969","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Wellness Enterprise #003","Wellness Enterprise #004","6.661","5.737","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Wellness Enterprise #004","Wellness Enterprise #005","4.326","6.540","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wellness Enterprise #005","Wellness Enterprise #001","5.810","2.342","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":906},{"label":"Mar","value":880},{"label":"Abr","value":910},{"label":"Mai","value":742},{"label":"Jun","value":723},{"label":"Jul","value":825},{"label":"Ago","value":647},{"label":"Set","value":655},{"label":"Out","value":943},{"label":"Nov","value":775},{"label":"Dez","value":720}];
const MX = 943;
