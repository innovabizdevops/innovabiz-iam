...
/* ═══ Enterprise Wellness Platform — Dashboard ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total Registos", value: "4876", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4480", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€99K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "-9%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1901418576", cells: ["WEL-7576", "Enterprise Wellness Platform Item 1", "9/1/2026", "€18 676"], status: "active" as const },
    { id: "1901422147", cells: ["WEL-2147", "Enterprise Wellness Platform Item 2", "24/8/2026", "€22 247"], status: "pending" as const },
    { id: "1901425718", cells: ["WEL-5718", "Enterprise Wellness Platform Item 3", "11/3/2026", "€25 818"], status: "completed" as const },
    { id: "1901429289", cells: ["WEL-9289", "Enterprise Wellness Platform Item 4", "26/10/2026", "€29 389"], status: "warning" as const },
    { id: "1901432860", cells: ["WEL-3860", "Enterprise Wellness Platform Item 5", "13/5/2026", "€32 960"], status: "active" as const },
];
...
export default function EnterpriseWellnessPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Enterprise Wellness Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Enterprise Wellness Platform</p>
                    </div>
                </div>
