...
const PAGE = "Program";
const KPIS = [{"l":"Total Wellness Enterprise","v":"7.115","t":"+2.5%","d":"up"},{"l":"Program Ativos","v":"1.915","t":"+8.3%","d":"up"},{"l":"Eficiência (%)","v":"70.9%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"79","t":"+8.4%","d":"up"}];
const COLS = ["ID","Program","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wellness Enterprise #001","Wellness Enterprise #002","1.662","1.264","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Wellness Enterprise #002","Wellness Enterprise #003","2.622","3.682","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Wellness Enterprise #003","Wellness Enterprise #004","5.340","7.137","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Wellness Enterprise #004","Wellness Enterprise #005","1.560","2.804","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wellness Enterprise #005","Wellness Enterprise #001","2.195","2.564","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":398},{"label":"Mar","value":438},{"label":"Abr","value":682},{"label":"Mai","value":582},{"label":"Jun","value":685},{"label":"Jul","value":596},{"label":"Ago","value":321},{"label":"Set","value":474},{"label":"Out","value":412},{"label":"Nov","value":465},{"label":"Dez","value":490}];
const MX = 685;
