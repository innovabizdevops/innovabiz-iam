...
const PAGE = "Wall";
const KPIS = [{"l":"Total 3d Construction Print","v":"8.883","t":"+2.1%","d":"up"},{"l":"Wall Ativos","v":"2.731","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"86.0%","t":"+5.5%","d":"up"},{"l":"Score Performance","v":"59","t":"-1.6%","d":"down"}];
const COLS = ["ID","Wall","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Construction Print #001","3d Construction Print #002","5.837","3.196","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["3d Construction Print #002","3d Construction Print #003","3.003","5.511","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Construction Print #003","3d Construction Print #004","8.880","6.991","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["3d Construction Print #004","3d Construction Print #005","1.396","6.158","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Construction Print #005","3d Construction Print #001","6.253","6.618","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":518},{"label":"Fev","value":233},{"label":"Mar","value":273},{"label":"Abr","value":308},{"label":"Mai","value":573},{"label":"Jun","value":432},{"label":"Jul","value":264},{"label":"Ago","value":206},{"label":"Set","value":445},{"label":"Out","value":419},{"label":"Nov","value":211},{"label":"Dez","value":318}];
const MX = 573;
