...
const ACCENT = "#3730a3";
const MODULE = "3D Construction";
const PAGE = "Finish";
const KPIS = [{"l":"Total 3d Construction Print","v":"5.140","t":"+8.4%","d":"up"},{"l":"Finish Ativos","v":"8.263","t":"+8.3%","d":"up"},{"l":"Eficiência (%)","v":"70.3%","t":"+15.9%","d":"up"},{"l":"Score Performance","v":"56","t":"-0.8%","d":"down"}];
const COLS = ["ID","Finish","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Construction Print #001","3d Construction Print #002","7.843","7.740","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["3d Construction Print #002","3d Construction Print #003","341","3.657","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Construction Print #003","3d Construction Print #004","8.693","6.380","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["3d Construction Print #004","3d Construction Print #005","8.794","1.513","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Construction Print #005","3d Construction Print #001","8.498","849","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":851},{"label":"Mar","value":840},{"label":"Abr","value":899},{"label":"Mai","value":875},{"label":"Jun","value":880},{"label":"Jul","value":1002},{"label":"Ago","value":985},{"label":"Set","value":1045},{"label":"Out","value":1090},{"label":"Nov","value":1085},{"label":"Dez","value":741}];
const MX = 1090;
