...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"3.444","t":"-4.9%","d":"down"},{"l":"Submissões/Dia","v":"1382","t":"-5.9%","d":"down"},{"l":"Documentos Gerados","v":"3.381","t":"-4.9%","d":"down"},{"l":"Templates","v":"2.312","t":"+10.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.236","2026-02-05","4.519","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.310","2026-02-10","6.368","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.728","2026-03-27","1.867","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.992","2026-02-27","2.242","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.241","2026-03-06","7.977","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":268},{"label":"Mar","value":303},{"label":"Abr","value":510},{"label":"Mai","value":499},{"label":"Jun","value":394},{"label":"Jul","value":379},{"label":"Ago","value":529},{"label":"Set","value":360},{"label":"Out","value":475},{"label":"Nov","value":281},{"label":"Dez","value":593}];
const MX = 593;
