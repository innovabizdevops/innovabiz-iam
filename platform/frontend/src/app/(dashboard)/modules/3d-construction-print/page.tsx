...
/* ═══ 3D Construction — Dashboard ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total Registos", value: "9540", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3365", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€311K", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "244034540", cells: ["3D-9540", "3D Construction Item 1", "9/9/2026", "€34 640"], status: "active" as const },
    { id: "244038111", cells: ["3D-4111", "3D Construction Item 2", "24/4/2026", "€38 211"], status: "pending" as const },
    { id: "244041682", cells: ["3D-7682", "3D Construction Item 3", "11/11/2026", "€41 782"], status: "completed" as const },
    { id: "244045253", cells: ["3D-2253", "3D Construction Item 4", "26/6/2026", "€45 353"], status: "warning" as const },
    { id: "244048824", cells: ["3D-5824", "3D Construction Item 5", "13/1/2026", "€48 924"], status: "active" as const },
];
...
export default function P3dConstructionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">3D Construction</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • 3D Construction</p>
                    </div>
                </div>
