...
const PAGE = "Resource";
const KPIS = [{"l":"Total Agent Project","v":"161","t":"-0.7%","d":"down"},{"l":"Resource Ativos","v":"3.806","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"90.2%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"74","t":"+17.9%","d":"up"}];
const COLS = ["ID","Resource","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agent Project #001","Agent Project #002","117","4.812","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Agent Project #002","Agent Project #003","7.966","5.412","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Agent Project #003","Agent Project #004","6.878","1.206","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Agent Project #004","Agent Project #005","714","8.282","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agent Project #005","Agent Project #001","7.987","5.688","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":684},{"label":"Mar","value":620},{"label":"Abr","value":866},{"label":"Mai","value":644},{"label":"Jun","value":668},{"label":"Jul","value":655},{"label":"Ago","value":806},{"label":"Set","value":798},{"label":"Out","value":710},{"label":"Nov","value":863},{"label":"Dez","value":786}];
const MX = 866;
