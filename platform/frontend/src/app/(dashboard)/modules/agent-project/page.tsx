...
/* ═══ AI Project Agent — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "5088", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1268", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€355K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1769936888", cells: ["AGE-6888", "AI Project Agent Item 1", "21/9/2026", "€36 988"], status: "active" as const },
    { id: "1769940459", cells: ["AGE-1459", "AI Project Agent Item 2", "8/4/2026", "€40 559"], status: "pending" as const },
    { id: "1769944030", cells: ["AGE-5030", "AI Project Agent Item 3", "23/11/2026", "€44 130"], status: "completed" as const },
    { id: "1769947601", cells: ["AGE-8601", "AI Project Agent Item 4", "10/6/2026", "€47 701"], status: "warning" as const },
    { id: "1769951172", cells: ["AGE-3172", "AI Project Agent Item 5", "25/1/2026", "€1272"], status: "active" as const },
];
...
export default function AiProjectAgentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Project Agent</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Project Agent</p>
                    </div>
                </div>
