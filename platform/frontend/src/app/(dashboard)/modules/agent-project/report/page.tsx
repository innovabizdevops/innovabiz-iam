...
const PAGE = "Report";
const KPIS = [{"l":"Total Agent Project","v":"4.211","t":"+6.5%","d":"up"},{"l":"Report Ativos","v":"644","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"73.4%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"85","t":"-4.6%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agent Project #001","Agent Project #002","5.821","6.512","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Agent Project #002","Agent Project #003","7.035","199","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Agent Project #003","Agent Project #004","4.691","3.852","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Agent Project #004","Agent Project #005","4.959","1.515","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agent Project #005","Agent Project #001","1.170","6.239","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":268},{"label":"Mar","value":467},{"label":"Abr","value":252},{"label":"Mai","value":439},{"label":"Jun","value":393},{"label":"Jul","value":313},{"label":"Ago","value":625},{"label":"Set","value":593},{"label":"Out","value":261},{"label":"Nov","value":597},{"label":"Dez","value":618}];
const MX = 625;
