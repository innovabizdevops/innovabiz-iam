...
const ACCENT = "#7c3aed";
const MODULE = "AI Project Agent";
const PAGE = "Plan";
const KPIS = [{"l":"Total Agent Project","v":"855","t":"+9.0%","d":"up"},{"l":"Plan Ativos","v":"5.993","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"84.3%","t":"-6.0%","d":"down"},{"l":"Score Performance","v":"55","t":"+17.4%","d":"up"}];
const COLS = ["ID","Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agent Project #001","Agent Project #002","1.170","7.420","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Agent Project #002","Agent Project #003","9.085","3.174","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Agent Project #003","Agent Project #004","2.230","2.621","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Agent Project #004","Agent Project #005","7.517","8.069","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agent Project #005","Agent Project #001","2.588","5.647","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":844},{"label":"Fev","value":867},{"label":"Mar","value":794},{"label":"Abr","value":806},{"label":"Mai","value":825},{"label":"Jun","value":955},{"label":"Jul","value":637},{"label":"Ago","value":899},{"label":"Set","value":899},{"label":"Out","value":602},{"label":"Nov","value":801},{"label":"Dez","value":919}];
const MX = 955;
