...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"5.899","t":"-0.4%","d":"down"},{"l":"Mitigações Ativas","v":"7.327","t":"+5.0%","d":"up"},{"l":"Score Risco Geral","v":"86","t":"-1.6%","d":"down"},{"l":"Incidentes YTD","v":"8.846","t":"+14.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.800","8.062","3.651","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.552","697","4.622","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.327","8.477","1.292","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.456","5.658","3.961","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.878","4.512","1.177","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":918},{"label":"Mar","value":560},{"label":"Abr","value":783},{"label":"Mai","value":794},{"label":"Jun","value":702},{"label":"Jul","value":908},{"label":"Ago","value":830},{"label":"Set","value":938},{"label":"Out","value":765},{"label":"Nov","value":599},{"label":"Dez","value":827}];
const MX = 938;
