...
const PAGE = "Fitting Track";
const KPIS = [{"l":"Total Haute Couture","v":"6.761","t":"+7.4%","d":"up"},{"l":"Fitting Track Ativos","v":"1.205","t":"+4.4%","d":"up"},{"l":"Eficiência (%)","v":"75.5%","t":"-0.9%","d":"down"},{"l":"Score Performance","v":"93","t":"+4.9%","d":"up"}];
const COLS = ["ID","Fitting Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Haute Couture #001","Haute Couture #002","2.906","3.735","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Haute Couture #002","Haute Couture #003","385","8.858","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Haute Couture #003","Haute Couture #004","2.525","956","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Haute Couture #004","Haute Couture #005","3.078","1.591","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Haute Couture #005","Haute Couture #001","3.809","2.205","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":741},{"label":"Fev","value":681},{"label":"Mar","value":431},{"label":"Abr","value":692},{"label":"Mai","value":780},{"label":"Jun","value":661},{"label":"Jul","value":759},{"label":"Ago","value":569},{"label":"Set","value":438},{"label":"Out","value":462},{"label":"Nov","value":561},{"label":"Dez","value":534}];
const MX = 780;
