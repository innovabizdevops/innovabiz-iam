...
const PAGE = "Fabric Source";
const KPIS = [{"l":"Total Haute Couture","v":"3.746","t":"+14.2%","d":"up"},{"l":"Fabric Source Ativos","v":"5.176","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"84.7%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"79","t":"+-0.0%","d":"up"}];
const COLS = ["ID","Fabric Source","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Haute Couture #001","Haute Couture #002","1.539","1.517","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Haute Couture #002","Haute Couture #003","3.122","2.552","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Haute Couture #003","Haute Couture #004","669","5.985","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Haute Couture #004","Haute Couture #005","1.606","6.696","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Haute Couture #005","Haute Couture #001","125","5.947","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":930},{"label":"Mar","value":617},{"label":"Abr","value":891},{"label":"Mai","value":670},{"label":"Jun","value":824},{"label":"Jul","value":791},{"label":"Ago","value":728},{"label":"Set","value":869},{"label":"Out","value":867},{"label":"Nov","value":805},{"label":"Dez","value":623}];
const MX = 930;
