...
const PAGE = "Delivery";
const KPIS = [{"l":"Total Haute Couture","v":"3.974","t":"+11.9%","d":"up"},{"l":"Delivery Ativos","v":"4.394","t":"+5.9%","d":"up"},{"l":"Eficiência (%)","v":"70.6%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"61","t":"+4.4%","d":"up"}];
const COLS = ["ID","Delivery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Haute Couture #001","Haute Couture #002","4.287","8.191","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Haute Couture #002","Haute Couture #003","6.146","231","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Haute Couture #003","Haute Couture #004","5.647","7.031","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Haute Couture #004","Haute Couture #005","7.272","5.123","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Haute Couture #005","Haute Couture #001","3.011","8.465","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":652},{"label":"Mar","value":835},{"label":"Abr","value":580},{"label":"Mai","value":696},{"label":"Jun","value":642},{"label":"Jul","value":527},{"label":"Ago","value":791},{"label":"Set","value":552},{"label":"Out","value":834},{"label":"Nov","value":731},{"label":"Dez","value":816}];
const MX = 835;
