...
const ACCENT = "#6366f1";
const MODULE = "Mineral Processing";
const PAGE = "Leaching";
const KPIS = [{"l":"Total Mineral Process","v":"2.299","t":"+2.8%","d":"up"},{"l":"Leaching Ativos","v":"5.786","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"83.5%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"89","t":"+6.7%","d":"up"}];
const COLS = ["ID","Leaching","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mineral Process #001","Mineral Process #002","1.134","7.791","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Mineral Process #002","Mineral Process #003","6.001","1.428","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Mineral Process #003","Mineral Process #004","3.790","9.084","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Mineral Process #004","Mineral Process #005","2.056","7.973","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mineral Process #005","Mineral Process #001","6.662","1.020","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":602},{"label":"Mar","value":919},{"label":"Abr","value":898},{"label":"Mai","value":659},{"label":"Jun","value":625},{"label":"Jul","value":645},{"label":"Ago","value":579},{"label":"Set","value":742},{"label":"Out","value":695},{"label":"Nov","value":782},{"label":"Dez","value":664}];
const MX = 919;
...
export default function LeachPage() {
    return (
