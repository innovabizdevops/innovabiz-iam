...
export default function MineralProcessPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Mineral Process</h1><p className="text-sm text-muted-foreground">Mineral Process • iBOS Enterprise</p></div>
