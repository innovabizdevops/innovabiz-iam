...
const PAGE = "Dewatering";
const KPIS = [{"l":"Total Mineral Process","v":"5.592","t":"+9.3%","d":"up"},{"l":"Dewatering Ativos","v":"6.449","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"86.6%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"58","t":"+2.9%","d":"up"}];
const COLS = ["ID","Dewatering","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mineral Process #001","Mineral Process #002","3.007","387","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Mineral Process #002","Mineral Process #003","5.033","3.186","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Mineral Process #003","Mineral Process #004","5.681","4.629","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Mineral Process #004","Mineral Process #005","1.071","2.411","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mineral Process #005","Mineral Process #001","2.885","6.307","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":749},{"label":"Fev","value":708},{"label":"Mar","value":850},{"label":"Abr","value":682},{"label":"Mai","value":604},{"label":"Jun","value":528},{"label":"Jul","value":529},{"label":"Ago","value":507},{"label":"Set","value":555},{"label":"Out","value":897},{"label":"Nov","value":559},{"label":"Dez","value":519}];
const MX = 897;
...
export default function DewaterPage() {
    return (
