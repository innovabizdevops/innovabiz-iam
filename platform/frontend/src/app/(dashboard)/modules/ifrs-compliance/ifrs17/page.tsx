...
const ACCENT = "#dc2626";
const MODULE = "IFRS Compliance";
const PAGE = "IFRS 17";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.672","t":"+8.1%","d":"up"},{"l":"NC Abertas","v":"5.881","t":"+13.6%","d":"up"},{"l":"Conformidade (%)","v":"73.3%","t":"-2.9%","d":"down"},{"l":"CAPAs Pendentes","v":"2.409","t":"-0.6%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.428","74.8%","101","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.283","93.8%","716","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.722","91.7%","7.206","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.125","79.2%","2.380","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.590","84.5%","9.025","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1018},{"label":"Fev","value":964},{"label":"Mar","value":1019},{"label":"Abr","value":714},{"label":"Mai","value":740},{"label":"Jun","value":1039},{"label":"Jul","value":767},{"label":"Ago","value":1033},{"label":"Set","value":837},{"label":"Out","value":764},{"label":"Nov","value":982},{"label":"Dez","value":880}];
const MX = 1039;
