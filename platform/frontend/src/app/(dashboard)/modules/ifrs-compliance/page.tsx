...
const KPIS = [
    { label: "Total Registos", value: "5989", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4928", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€100K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "68236689", cells: ["IFR-8689", "IFRS Compliance Item 1", "18/10/2026", "€36 789"], status: "active" as const },
    { id: "68240260", cells: ["IFR-3260", "IFRS Compliance Item 2", "5/5/2026", "€40 360"], status: "pending" as const },
    { id: "68243831", cells: ["IFR-6831", "IFRS Compliance Item 3", "20/12/2026", "€43 931"], status: "completed" as const },
    { id: "68247402", cells: ["IFR-1402", "IFRS Compliance Item 4", "7/7/2026", "€47 502"], status: "warning" as const },
    { id: "68250973", cells: ["IFR-4973", "IFRS Compliance Item 5", "22/2/2026", "€1073"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">IFRS Compliance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • IFRS Compliance</p>
                    </div>
                </div>
