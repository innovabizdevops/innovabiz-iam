...
const PAGE = "RTK Service";
const KPIS = [{"l":"Formulários Ativos","v":"5.547","t":"-0.2%","d":"down"},{"l":"Submissões/Dia","v":"1956","t":"+4.9%","d":"up"},{"l":"Documentos Gerados","v":"4.580","t":"+6.3%","d":"up"},{"l":"Templates","v":"185","t":"-0.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.967","2026-03-08","2.500","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","753","2026-03-17","8.455","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.013","2026-01-26","5.886","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.326","2026-03-24","5.867","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.178","2026-03-10","7.776","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":477},{"label":"Mar","value":532},{"label":"Abr","value":664},{"label":"Mai","value":439},{"label":"Jun","value":574},{"label":"Jul","value":489},{"label":"Ago","value":526},{"label":"Set","value":475},{"label":"Out","value":391},{"label":"Nov","value":388},{"label":"Dez","value":487}];
const MX = 664;
