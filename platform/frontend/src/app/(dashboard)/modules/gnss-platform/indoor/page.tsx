...
const PAGE = "Indoor Nav";
const KPIS = [{"l":"Formulários Ativos","v":"3.729","t":"-1.9%","d":"down"},{"l":"Submissões/Dia","v":"4205","t":"+11.8%","d":"up"},{"l":"Documentos Gerados","v":"378","t":"+0.3%","d":"up"},{"l":"Templates","v":"6.527","t":"+16.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","769","2026-03-09","4.517","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.619","2026-02-27","2.532","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.351","2026-02-09","156","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.122","2026-03-12","6.190","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.561","2026-02-26","2.407","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":702},{"label":"Mar","value":609},{"label":"Abr","value":651},{"label":"Mai","value":612},{"label":"Jun","value":670},{"label":"Jul","value":816},{"label":"Ago","value":618},{"label":"Set","value":586},{"label":"Out","value":707},{"label":"Nov","value":466},{"label":"Dez","value":689}];
const MX = 816;
