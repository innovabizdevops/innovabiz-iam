...
export default function GnssPlatformPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Gnss Platform</h1><p className="text-sm text-muted-foreground">Gnss Platform • iBOS Enterprise</p></div>
