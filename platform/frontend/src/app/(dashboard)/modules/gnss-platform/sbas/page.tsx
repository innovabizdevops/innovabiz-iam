...
const ACCENT = "#0e7490";
const MODULE = "GNSS Platform";
const PAGE = "SBAS";
const KPIS = [{"l":"Formulários Ativos","v":"5.700","t":"+13.7%","d":"up"},{"l":"Submissões/Dia","v":"3335","t":"+6.3%","d":"up"},{"l":"Documentos Gerados","v":"8.665","t":"-2.7%","d":"down"},{"l":"Templates","v":"2.296","t":"+5.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.449","2026-02-11","294","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.587","2026-01-10","8.088","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","778","2026-01-14","8.229","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.710","2026-01-07","1.711","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.792","2026-01-10","1.909","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":930},{"label":"Fev","value":642},{"label":"Mar","value":791},{"label":"Abr","value":969},{"label":"Mai","value":960},{"label":"Jun","value":948},{"label":"Jul","value":982},{"label":"Ago","value":691},{"label":"Set","value":909},{"label":"Out","value":743},{"label":"Nov","value":938},{"label":"Dez","value":773}];
const MX = 982;
...
export default function SbasPage() {
    return (
