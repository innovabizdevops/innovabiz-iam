...
const PAGE = "Timing";
const KPIS = [{"l":"Formulários Ativos","v":"7.480","t":"+6.1%","d":"up"},{"l":"Submissões/Dia","v":"1078","t":"+1.0%","d":"up"},{"l":"Documentos Gerados","v":"7.997","t":"-3.5%","d":"down"},{"l":"Templates","v":"6.181","t":"+5.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.110","2026-02-14","8.792","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.037","2026-01-19","5.757","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.425","2026-02-10","4.310","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.180","2026-03-12","4.533","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.489","2026-02-02","3.377","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":666},{"label":"Mar","value":888},{"label":"Abr","value":618},{"label":"Mai","value":847},{"label":"Jun","value":515},{"label":"Jul","value":625},{"label":"Ago","value":503},{"label":"Set","value":528},{"label":"Out","value":755},{"label":"Nov","value":533},{"label":"Dez","value":565}];
const MX = 888;
