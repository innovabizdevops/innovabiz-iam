...
const PAGE = "GPS/GNSS";
const KPIS = [{"l":"Formulários Ativos","v":"7.710","t":"+6.9%","d":"up"},{"l":"Submissões/Dia","v":"1259","t":"+16.4%","d":"up"},{"l":"Documentos Gerados","v":"7.927","t":"+17.0%","d":"up"},{"l":"Templates","v":"3.517","t":"+15.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.718","2026-02-17","4.280","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.473","2026-03-17","7.614","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.316","2026-02-03","7.935","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.122","2026-02-19","4.004","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","9.069","2026-01-26","719","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":463},{"label":"Mar","value":684},{"label":"Abr","value":703},{"label":"Mai","value":496},{"label":"Jun","value":544},{"label":"Jul","value":531},{"label":"Ago","value":459},{"label":"Set","value":795},{"label":"Out","value":622},{"label":"Nov","value":796},{"label":"Dez","value":807}];
const MX = 823;
