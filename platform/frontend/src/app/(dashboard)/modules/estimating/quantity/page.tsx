...
const PAGE = "Quantity Survey";
const KPIS = [{"l":"Surveys Ativos","v":"2.033","t":"+13.5%","d":"up"},{"l":"Respostas/Semana","v":"1003","t":"+14.1%","d":"up"},{"l":"NPS Médio","v":"78","t":"+16.9%","d":"up"},{"l":"Taxa Resposta (%)","v":"75.7%","t":"+3.4%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","2.385","82","83.3%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","3.703","82","78.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","3.070","62","96.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","1.681","66","94.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","4.840","90","73.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":304},{"label":"Fev","value":513},{"label":"Mar","value":393},{"label":"Abr","value":288},{"label":"Mai","value":328},{"label":"Jun","value":447},{"label":"Jul","value":370},{"label":"Ago","value":397},{"label":"Set","value":625},{"label":"Out","value":261},{"label":"Nov","value":522},{"label":"Dez","value":639}];
const MX = 639;
