...
const ACCENT = "#1e40af";
const MODULE = "Cost Estimating";
const PAGE = "Material Price";
const KPIS = [{"l":"Total Estimating","v":"295","t":"+16.0%","d":"up"},{"l":"Material Price Ativos","v":"3.209","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"84.9%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"67","t":"+9.3%","d":"up"}];
const COLS = ["ID","Material Price","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Estimating #001","Estimating #002","8.195","3.966","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Estimating #002","Estimating #003","7.903","1.291","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Estimating #003","Estimating #004","1.557","942","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Estimating #004","Estimating #005","2.105","8.769","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Estimating #005","Estimating #001","5.489","4.962","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":639},{"label":"Mar","value":710},{"label":"Abr","value":532},{"label":"Mai","value":867},{"label":"Jun","value":722},{"label":"Jul","value":794},{"label":"Ago","value":551},{"label":"Set","value":597},{"label":"Out","value":918},{"label":"Nov","value":819},{"label":"Dez","value":602}];
const MX = 918;
