...
const PAGE = "Gene Design";
const KPIS = [{"l":"Formulários Ativos","v":"1.127","t":"+0.1%","d":"up"},{"l":"Submissões/Dia","v":"974","t":"+2.5%","d":"up"},{"l":"Documentos Gerados","v":"4.971","t":"+15.6%","d":"up"},{"l":"Templates","v":"6.404","t":"+10.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.950","2026-03-17","5.202","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.417","2026-01-20","5.050","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.273","2026-03-04","7.428","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.225","2026-03-09","4.369","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.648","2026-01-24","570","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":791},{"label":"Fev","value":525},{"label":"Mar","value":657},{"label":"Abr","value":711},{"label":"Mai","value":703},{"label":"Jun","value":846},{"label":"Jul","value":677},{"label":"Ago","value":552},{"label":"Set","value":687},{"label":"Out","value":632},{"label":"Nov","value":708},{"label":"Dez","value":531}];
const MX = 846;
