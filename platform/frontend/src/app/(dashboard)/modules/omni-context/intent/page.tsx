...
const ACCENT = "#2563eb";
const MODULE = "OMNI Context Engine";
const PAGE = "Intent";
const KPIS = [{"l":"Total Omni Context","v":"2.419","t":"+13.1%","d":"up"},{"l":"Intent Ativos","v":"7.048","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"78.4%","t":"+14.1%","d":"up"},{"l":"Score Performance","v":"71","t":"+6.9%","d":"up"}];
const COLS = ["ID","Intent","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Omni Context #001","Omni Context #002","5.412","2.656","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Omni Context #002","Omni Context #003","2.548","8.584","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Omni Context #003","Omni Context #004","3.960","6.306","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Omni Context #004","Omni Context #005","6.632","6.872","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Omni Context #005","Omni Context #001","5.519","7.285","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":972},{"label":"Mar","value":890},{"label":"Abr","value":786},{"label":"Mai","value":1080},{"label":"Jun","value":1031},{"label":"Jul","value":942},{"label":"Ago","value":912},{"label":"Set","value":805},{"label":"Out","value":877},{"label":"Nov","value":930},{"label":"Dez","value":1022}];
const MX = 1080;
