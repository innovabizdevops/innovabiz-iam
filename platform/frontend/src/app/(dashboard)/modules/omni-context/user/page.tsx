...
const PAGE = "User";
const KPIS = [{"l":"Utilizadores Ativos","v":"4.497","t":"+8.4%","d":"up"},{"l":"Sessões/Dia","v":"1638","t":"+12.5%","d":"up"},{"l":"MFA Adoção (%)","v":"78.1%","t":"+6.3%","d":"up"},{"l":"Tentativas Bloqueadas","v":"5.048","t":"+6.3%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.925","284","2.147","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.460","5.133","3.657","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","7.126","7.484","3.476","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.331","449","6.348","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.762","2.897","662","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":503},{"label":"Fev","value":383},{"label":"Mar","value":600},{"label":"Abr","value":574},{"label":"Mai","value":623},{"label":"Jun","value":570},{"label":"Jul","value":579},{"label":"Ago","value":536},{"label":"Set","value":421},{"label":"Out","value":351},{"label":"Nov","value":605},{"label":"Dez","value":368}];
const MX = 623;
