...
/* ═══ OMNI Context Engine — Dashboard ═══ */

const ACCENT = "#2563eb";

const KPIS = [
    { label: "Total Registos", value: "1078", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2590", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€55K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1818393378", cells: ["OMN-7378", "OMNI Context Engine Item 1", "19/7/2026", "€43 478"], status: "active" as const },
    { id: "1818396949", cells: ["OMN-1949", "OMNI Context Engine Item 2", "6/2/2026", "€47 049"], status: "pending" as const },
    { id: "1818400520", cells: ["OMN-5520", "OMNI Context Engine Item 3", "21/9/2026", "€620"], status: "completed" as const },
    { id: "1818404091", cells: ["OMN-9091", "OMNI Context Engine Item 4", "8/4/2026", "€4191"], status: "warning" as const },
    { id: "1818407662", cells: ["OMN-3662", "OMNI Context Engine Item 5", "23/11/2026", "€7762"], status: "active" as const },
];
...
export default function OmniContextEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">OMNI Context Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • OMNI Context Engine</p>
                    </div>
                </div>
