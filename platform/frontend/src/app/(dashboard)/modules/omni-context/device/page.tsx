...
const PAGE = "Device";
const KPIS = [{"l":"Dispositivos Online","v":"6.143","t":"+10.7%","d":"up"},{"l":"Dados/Min (MB)","v":"1.596","t":"+8.9%","d":"up"},{"l":"Alertas Ativos","v":"1.848","t":"-4.0%","d":"down"},{"l":"Uptime (%)","v":"86.6%","t":"-0.5%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.524","2.409","1.754","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.649","3.694","391","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.601","1.936","5.984","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","917","3.542","1.030","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.793","6.946","5.645","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":351},{"label":"Fev","value":541},{"label":"Mar","value":342},{"label":"Abr","value":511},{"label":"Mai","value":302},{"label":"Jun","value":423},{"label":"Jul","value":366},{"label":"Ago","value":335},{"label":"Set","value":484},{"label":"Out","value":577},{"label":"Nov","value":545},{"label":"Dez","value":224}];
const MX = 577;
