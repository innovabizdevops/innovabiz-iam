...
const PAGE = "Location";
const KPIS = [{"l":"Total Omni Context","v":"4.158","t":"+8.3%","d":"up"},{"l":"Location Ativos","v":"3.792","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"59","t":"+12.6%","d":"up"}];
const COLS = ["ID","Location","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Omni Context #001","Omni Context #002","6.466","6.651","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Omni Context #002","Omni Context #003","4.743","4.686","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Omni Context #003","Omni Context #004","1.682","5.819","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Omni Context #004","Omni Context #005","1.024","4.176","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Omni Context #005","Omni Context #001","5.095","7.075","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":293},{"label":"Mar","value":350},{"label":"Abr","value":474},{"label":"Mai","value":549},{"label":"Jun","value":643},{"label":"Jul","value":389},{"label":"Ago","value":686},{"label":"Set","value":388},{"label":"Out","value":311},{"label":"Nov","value":653},{"label":"Dez","value":385}];
const MX = 686;
