...
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"1.011","t":"+0.4%","d":"up"},{"l":"Taxa Entrega (%)","v":"69.5%","t":"-1.3%","d":"down"},{"l":"Taxa Abertura (%)","v":"82.5%","t":"+17.8%","d":"up"},{"l":"Escalações","v":"3.965","t":"+4.4%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","3.988","81.3%","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","2.384","79.8%","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","1.792","76.5%","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","5.313","89.5%","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","5.540","70.4%","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":648},{"label":"Mar","value":585},{"label":"Abr","value":492},{"label":"Mai","value":564},{"label":"Jun","value":508},{"label":"Jul","value":630},{"label":"Ago","value":573},{"label":"Set","value":613},{"label":"Out","value":725},{"label":"Nov","value":679},{"label":"Dez","value":637}];
const MX = 725;
