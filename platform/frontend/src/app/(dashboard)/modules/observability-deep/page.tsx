...
const KPIS = [
    { label: "Total Registos", value: "8661", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4541", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€237K", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1793848961", cells: ["OBS-5961", "Observability Platform Item 1", "10/6/2026", "€49 061"], status: "active" as const },
    { id: "1793852532", cells: ["OBS-9532", "Observability Platform Item 2", "25/1/2026", "€2632"], status: "pending" as const },
    { id: "1793856103", cells: ["OBS-4103", "Observability Platform Item 3", "12/8/2026", "€6203"], status: "completed" as const },
    { id: "1793859674", cells: ["OBS-7674", "Observability Platform Item 4", "27/3/2026", "€9774"], status: "warning" as const },
    { id: "1793863245", cells: ["OBS-2245", "Observability Platform Item 5", "14/10/2026", "€13 345"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Observability Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Observability Platform</p>
                    </div>
                </div>
