...
const ACCENT = "#8b5cf6";
const MODULE = "Observability Platform";
const PAGE = "AIOps";
const KPIS = [{"l":"Total Observability Deep","v":"5.524","t":"+0.7%","d":"up"},{"l":"AIOps Ativos","v":"1.160","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"66.5%","t":"+10.4%","d":"up"},{"l":"Score Performance","v":"67","t":"-5.0%","d":"down"}];
const COLS = ["ID","AIOps","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Observability Deep #001","Observability Deep #002","2.694","8.700","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Observability Deep #002","Observability Deep #003","3.114","4.547","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Observability Deep #003","Observability Deep #004","484","7.061","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Observability Deep #004","Observability Deep #005","1.764","4.950","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Observability Deep #005","Observability Deep #001","3.796","8.916","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":630},{"label":"Mar","value":816},{"label":"Abr","value":545},{"label":"Mai","value":613},{"label":"Jun","value":523},{"label":"Jul","value":598},{"label":"Ago","value":872},{"label":"Set","value":743},{"label":"Out","value":532},{"label":"Nov","value":798},{"label":"Dez","value":560}];
const MX = 872;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#8b5cf6'}}>AI</span></h1>
                </div>
