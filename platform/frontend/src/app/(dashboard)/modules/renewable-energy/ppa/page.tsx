...
const PAGE = "PPA Mgmt";
const KPIS = [{"l":"Total Renewable Energy","v":"1.374","t":"+16.9%","d":"up"},{"l":"PPA Mgmt Ativos","v":"1.523","t":"-1.8%","d":"down"},{"l":"Eficiência (%)","v":"68.1%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"63","t":"-3.2%","d":"down"}];
const COLS = ["ID","PPA Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Renewable Energy #001","Renewable Energy #002","1.392","4.327","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Renewable Energy #002","Renewable Energy #003","3.427","795","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Renewable Energy #003","Renewable Energy #004","6.186","4.586","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Renewable Energy #004","Renewable Energy #005","2.168","6.491","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Renewable Energy #005","Renewable Energy #001","3.122","6.611","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":961},{"label":"Mar","value":637},{"label":"Abr","value":734},{"label":"Mai","value":815},{"label":"Jun","value":754},{"label":"Jul","value":738},{"label":"Ago","value":873},{"label":"Set","value":949},{"label":"Out","value":815},{"label":"Nov","value":952},{"label":"Dez","value":789}];
const MX = 961;
