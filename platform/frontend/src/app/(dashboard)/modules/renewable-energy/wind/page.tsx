...
const PAGE = "Wind Farm";
const KPIS = [{"l":"Total Renewable Energy","v":"7.372","t":"+15.9%","d":"up"},{"l":"Wind Farm Ativos","v":"2.504","t":"-5.4%","d":"down"},{"l":"Eficiência (%)","v":"78.2%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"72","t":"-4.6%","d":"down"}];
const COLS = ["ID","Wind Farm","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Renewable Energy #001","Renewable Energy #002","893","2.920","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Renewable Energy #002","Renewable Energy #003","4.226","7.601","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Renewable Energy #003","Renewable Energy #004","5.727","8.772","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Renewable Energy #004","Renewable Energy #005","1.718","4.422","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Renewable Energy #005","Renewable Energy #001","450","6.279","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":630},{"label":"Mar","value":646},{"label":"Abr","value":415},{"label":"Mai","value":632},{"label":"Jun","value":668},{"label":"Jul","value":459},{"label":"Ago","value":764},{"label":"Set","value":788},{"label":"Out","value":728},{"label":"Nov","value":557},{"label":"Dez","value":524}];
const MX = 788;
