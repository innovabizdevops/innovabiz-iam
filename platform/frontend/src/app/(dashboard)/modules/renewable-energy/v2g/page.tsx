...
const ACCENT = "#059669";
const MODULE = "Renewable Energy";
const PAGE = "V2G Vehicle";
const KPIS = [{"l":"Total Renewable Energy","v":"1.100","t":"+4.6%","d":"up"},{"l":"V2G Vehicle Ativos","v":"8.745","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"78.2%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"93","t":"+14.0%","d":"up"}];
const COLS = ["ID","V2G Vehicle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Renewable Energy #001","Renewable Energy #002","2.573","3.103","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Renewable Energy #002","Renewable Energy #003","2.089","7.840","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Renewable Energy #003","Renewable Energy #004","2.833","2.695","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Renewable Energy #004","Renewable Energy #005","7.267","1.952","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Renewable Energy #005","Renewable Energy #001","5.266","1.408","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":530},{"label":"Mar","value":766},{"label":"Abr","value":809},{"label":"Mai","value":653},{"label":"Jun","value":765},{"label":"Jul","value":613},{"label":"Ago","value":816},{"label":"Set","value":836},{"label":"Out","value":663},{"label":"Nov","value":660},{"label":"Dez","value":581}];
const MX = 836;
