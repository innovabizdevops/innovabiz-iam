...
const PAGE = "Solar Farm";
const KPIS = [{"l":"Total Renewable Energy","v":"8.900","t":"+2.2%","d":"up"},{"l":"Solar Farm Ativos","v":"5.657","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"69.4%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"55","t":"-2.0%","d":"down"}];
const COLS = ["ID","Solar Farm","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Renewable Energy #001","Renewable Energy #002","737","2.829","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Renewable Energy #002","Renewable Energy #003","397","7.891","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Renewable Energy #003","Renewable Energy #004","6.591","4.147","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Renewable Energy #004","Renewable Energy #005","5.590","1.455","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Renewable Energy #005","Renewable Energy #001","6.701","3.909","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":752},{"label":"Fev","value":719},{"label":"Mar","value":960},{"label":"Abr","value":705},{"label":"Mai","value":818},{"label":"Jun","value":1023},{"label":"Jul","value":904},{"label":"Ago","value":1009},{"label":"Set","value":1070},{"label":"Out","value":874},{"label":"Nov","value":834},{"label":"Dez","value":772}];
const MX = 1070;
