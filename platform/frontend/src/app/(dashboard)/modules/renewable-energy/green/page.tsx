...
const PAGE = "Green Cert";
const KPIS = [{"l":"Total Renewable Energy","v":"5.097","t":"-5.4%","d":"down"},{"l":"Green Cert Ativos","v":"7.954","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"75.5%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"76","t":"+1.9%","d":"up"}];
const COLS = ["ID","Green Cert","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Renewable Energy #001","Renewable Energy #002","1.866","5.012","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Renewable Energy #002","Renewable Energy #003","4.395","8.618","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Renewable Energy #003","Renewable Energy #004","9.087","7.584","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Renewable Energy #004","Renewable Energy #005","6.062","8.614","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Renewable Energy #005","Renewable Energy #001","6.653","4.794","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":985},{"label":"Fev","value":774},{"label":"Mar","value":807},{"label":"Abr","value":990},{"label":"Mai","value":801},{"label":"Jun","value":881},{"label":"Jul","value":1038},{"label":"Ago","value":831},{"label":"Set","value":824},{"label":"Out","value":1000},{"label":"Nov","value":819},{"label":"Dez","value":655}];
const MX = 1038;
