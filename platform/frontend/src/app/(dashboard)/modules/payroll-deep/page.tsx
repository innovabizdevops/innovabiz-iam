...
/* ═══ Payroll Deep (APQC 6.6) — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "8225", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4414", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€252K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1791413125", cells: ["PAY-9125", "Payroll Deep (APQC 6.6) Item 1", "6/2/2026", "€13 225"], status: "active" as const },
    { id: "1791416696", cells: ["PAY-3696", "Payroll Deep (APQC 6.6) Item 2", "21/9/2026", "€16 796"], status: "pending" as const },
    { id: "1791420267", cells: ["PAY-7267", "Payroll Deep (APQC 6.6) Item 3", "8/4/2026", "€20 367"], status: "completed" as const },
    { id: "1791423838", cells: ["PAY-1838", "Payroll Deep (APQC 6.6) Item 4", "23/11/2026", "€23 938"], status: "warning" as const },
    { id: "1791427409", cells: ["PAY-5409", "Payroll Deep (APQC 6.6) Item 5", "10/6/2026", "€27 509"], status: "active" as const },
];
...
export default function PayrollDeepApqc66Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Payroll Deep (APQC 6.6)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Payroll Deep (APQC 6.6)</p>
                    </div>
                </div>
