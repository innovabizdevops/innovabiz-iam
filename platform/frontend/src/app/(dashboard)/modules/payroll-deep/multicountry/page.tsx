...
const ACCENT = "#7c3aed";
const MODULE = "Payroll Deep (APQC 6.6)";
const PAGE = "Multi-Country";
const KPIS = [{"l":"Total Payroll Deep","v":"754","t":"+5.3%","d":"up"},{"l":"Multi Country Ativos","v":"8.605","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"84.8%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"64","t":"+13.0%","d":"up"}];
const COLS = ["ID","Multi Country","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll Deep #001","Payroll Deep #002","7.572","1.250","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll Deep #002","Payroll Deep #003","5.892","1.692","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll Deep #003","Payroll Deep #004","8.639","5.237","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll Deep #004","Payroll Deep #005","2.070","7.971","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll Deep #005","Payroll Deep #001","7.764","7.767","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":793},{"label":"Mar","value":830},{"label":"Abr","value":672},{"label":"Mai","value":515},{"label":"Jun","value":789},{"label":"Jul","value":626},{"label":"Ago","value":813},{"label":"Set","value":474},{"label":"Out","value":713},{"label":"Nov","value":453},{"label":"Dez","value":494}];
const MX = 830;
