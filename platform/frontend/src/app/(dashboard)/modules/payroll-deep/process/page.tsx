...
const PAGE = "Process";
const KPIS = [{"l":"Total Payroll Deep","v":"4.117","t":"+1.6%","d":"up"},{"l":"Process Ativos","v":"7.886","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"87","t":"+13.3%","d":"up"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll Deep #001","Payroll Deep #002","5.157","185","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll Deep #002","Payroll Deep #003","3.440","1.830","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll Deep #003","Payroll Deep #004","3.467","2.487","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll Deep #004","Payroll Deep #005","1.466","4.189","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll Deep #005","Payroll Deep #001","8.994","4.040","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":809},{"label":"Mar","value":889},{"label":"Abr","value":942},{"label":"Mai","value":665},{"label":"Jun","value":724},{"label":"Jul","value":656},{"label":"Ago","value":914},{"label":"Set","value":921},{"label":"Out","value":587},{"label":"Nov","value":576},{"label":"Dez","value":951}];
const MX = 951;
