...
const KPIS = [{"l":"Total Payroll Deep","v":"6.579","t":"+0.1%","d":"up"},{"l":"Reconcile Ativos","v":"6.631","t":"+5.3%","d":"up"},{"l":"Eficiência (%)","v":"81.8%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"59","t":"+2.5%","d":"up"}];
const COLS = ["ID","Reconcile","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll Deep #001","Payroll Deep #002","2.072","2.486","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll Deep #002","Payroll Deep #003","7.007","8.075","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll Deep #003","Payroll Deep #004","873","889","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll Deep #004","Payroll Deep #005","4.931","748","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll Deep #005","Payroll Deep #001","5.037","8.833","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":751},{"label":"Mar","value":617},{"label":"Abr","value":604},{"label":"Mai","value":689},{"label":"Jun","value":745},{"label":"Jul","value":703},{"label":"Ago","value":810},{"label":"Set","value":707},{"label":"Out","value":583},{"label":"Nov","value":768},{"label":"Dez","value":604}];
const MX = 810;
