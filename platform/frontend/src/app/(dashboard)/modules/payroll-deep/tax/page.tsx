...
const PAGE = "Tax";
const KPIS = [{"l":"Total Payroll Deep","v":"8.240","t":"+17.2%","d":"up"},{"l":"Tax Ativos","v":"8.298","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"93.2%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"65","t":"+10.4%","d":"up"}];
const COLS = ["ID","Tax","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll Deep #001","Payroll Deep #002","3.158","6.601","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll Deep #002","Payroll Deep #003","8.710","5.701","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll Deep #003","Payroll Deep #004","6.590","584","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll Deep #004","Payroll Deep #005","8.902","2.613","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll Deep #005","Payroll Deep #001","6.361","3.380","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":790},{"label":"Mar","value":915},{"label":"Abr","value":959},{"label":"Mai","value":999},{"label":"Jun","value":859},{"label":"Jul","value":717},{"label":"Ago","value":707},{"label":"Set","value":700},{"label":"Out","value":961},{"label":"Nov","value":879},{"label":"Dez","value":806}];
const MX = 999;
