...
const PAGE = "Statutory";
const KPIS = [{"l":"Total Payroll Deep","v":"3.972","t":"+4.0%","d":"up"},{"l":"Statutory Ativos","v":"3.522","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"65.0%","t":"+17.8%","d":"up"},{"l":"Score Performance","v":"63","t":"+7.7%","d":"up"}];
const COLS = ["ID","Statutory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll Deep #001","Payroll Deep #002","8.666","5.912","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll Deep #002","Payroll Deep #003","2.211","688","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll Deep #003","Payroll Deep #004","8.537","2.902","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll Deep #004","Payroll Deep #005","6.869","5.608","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll Deep #005","Payroll Deep #001","2.213","1.236","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":439},{"label":"Mar","value":568},{"label":"Abr","value":394},{"label":"Mai","value":742},{"label":"Jun","value":480},{"label":"Jul","value":524},{"label":"Ago","value":715},{"label":"Set","value":427},{"label":"Out","value":710},{"label":"Nov","value":608},{"label":"Dez","value":621}];
const MX = 742;
