...
const PAGE = "Cost";
const KPIS = [{"l":"Dashboards Ativos","v":"7.946","t":"+9.9%","d":"up"},{"l":"Queries/Dia","v":"3165","t":"+5.4%","d":"up"},{"l":"Dados Processados (GB)","v":"4.526","t":"+15.5%","d":"up"},{"l":"Utilizadores Analytics","v":"2.392","t":"+6.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1653","2026-01-03","2.796","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2504","2026-01-27","7.007","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1177","2026-01-06","4.996","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3581","2026-03-07","921","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","466","2026-01-07","2.773","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":228},{"label":"Fev","value":350},{"label":"Mar","value":609},{"label":"Abr","value":226},{"label":"Mai","value":267},{"label":"Jun","value":547},{"label":"Jul","value":419},{"label":"Ago","value":437},{"label":"Set","value":620},{"label":"Out","value":368},{"label":"Nov","value":289},{"label":"Dez","value":479}];
const MX = 620;
