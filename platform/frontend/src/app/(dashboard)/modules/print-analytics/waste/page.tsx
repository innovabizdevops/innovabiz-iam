...
const PAGE = "Waste";
const KPIS = [{"l":"Dashboards Ativos","v":"1.378","t":"+17.6%","d":"up"},{"l":"Queries/Dia","v":"3983","t":"+6.9%","d":"up"},{"l":"Dados Processados (GB)","v":"7.023","t":"+2.3%","d":"up"},{"l":"Utilizadores Analytics","v":"293","t":"+12.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","337","2026-03-24","8.651","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","542","2026-03-23","272","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1757","2026-02-14","298","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3257","2026-01-17","8.832","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2127","2026-02-15","2.721","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":981},{"label":"Fev","value":727},{"label":"Mar","value":898},{"label":"Abr","value":991},{"label":"Mai","value":986},{"label":"Jun","value":1056},{"label":"Jul","value":938},{"label":"Ago","value":1034},{"label":"Set","value":751},{"label":"Out","value":973},{"label":"Nov","value":779},{"label":"Dez","value":1029}];
const MX = 1056;
