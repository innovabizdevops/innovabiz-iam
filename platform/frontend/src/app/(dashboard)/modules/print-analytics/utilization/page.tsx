...
const PAGE = "Utilization";
const KPIS = [{"l":"Dashboards Ativos","v":"3.610","t":"-2.5%","d":"down"},{"l":"Queries/Dia","v":"745","t":"+6.7%","d":"up"},{"l":"Dados Processados (GB)","v":"137","t":"+7.8%","d":"up"},{"l":"Utilizadores Analytics","v":"1.275","t":"+7.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4300","2026-03-25","4.664","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5010","2026-01-20","9.052","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1337","2026-01-08","1.109","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1617","2026-02-10","5.741","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1606","2026-02-11","3.211","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":472},{"label":"Mar","value":554},{"label":"Abr","value":422},{"label":"Mai","value":585},{"label":"Jun","value":728},{"label":"Jul","value":760},{"label":"Ago","value":434},{"label":"Set","value":718},{"label":"Out","value":791},{"label":"Nov","value":632},{"label":"Dez","value":778}];
const MX = 791;
