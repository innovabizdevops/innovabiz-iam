...
const ACCENT = "#6366f1";
const MODULE = "Print Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"4.010","t":"-0.9%","d":"down"},{"l":"Queries/Dia","v":"3240","t":"+9.0%","d":"up"},{"l":"Dados Processados (GB)","v":"6.011","t":"-1.0%","d":"down"},{"l":"Utilizadores Analytics","v":"7.558","t":"+11.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2822","2026-03-09","2.947","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2785","2026-01-10","3.678","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1282","2026-02-13","335","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","553","2026-03-11","8.026","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3657","2026-02-14","6.705","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":824},{"label":"Mar","value":504},{"label":"Abr","value":530},{"label":"Mai","value":721},{"label":"Jun","value":842},{"label":"Jul","value":566},{"label":"Ago","value":721},{"label":"Set","value":661},{"label":"Out","value":824},{"label":"Nov","value":694},{"label":"Dez","value":795}];
const MX = 842;
