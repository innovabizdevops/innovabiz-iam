...
const KPIS = [{"l":"Dashboards Ativos","v":"5.477","t":"+15.8%","d":"up"},{"l":"Queries/Dia","v":"1903","t":"-0.7%","d":"down"},{"l":"Dados Processados (GB)","v":"2.742","t":"+9.6%","d":"up"},{"l":"Utilizadores Analytics","v":"5.388","t":"-5.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2101","2026-01-28","3.569","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","259","2026-01-14","573","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3238","2026-02-22","2.284","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1928","2026-02-10","8.937","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","298","2026-03-06","4.889","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":304},{"label":"Fev","value":332},{"label":"Mar","value":440},{"label":"Abr","value":362},{"label":"Mai","value":574},{"label":"Jun","value":398},{"label":"Jul","value":232},{"label":"Ago","value":377},{"label":"Set","value":384},{"label":"Out","value":218},{"label":"Nov","value":359},{"label":"Dez","value":516}];
const MX = 574;
