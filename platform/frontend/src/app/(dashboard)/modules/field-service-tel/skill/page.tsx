...
const ACCENT = "#0e7490";
const MODULE = "Field Service Telecom";
const PAGE = "Skill Route";
const KPIS = [{"l":"Total Field Service Tel","v":"6.506","t":"-1.9%","d":"down"},{"l":"Skill Route Ativos","v":"7.627","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"77.6%","t":"-4.3%","d":"down"},{"l":"Score Performance","v":"74","t":"+9.3%","d":"up"}];
const COLS = ["ID","Skill Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Field Service Tel #001","Field Service Tel #002","3.568","4.566","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Field Service Tel #002","Field Service Tel #003","4.666","3.331","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Field Service Tel #003","Field Service Tel #004","9.057","2.462","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Field Service Tel #004","Field Service Tel #005","5.433","8.176","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Field Service Tel #005","Field Service Tel #001","2.121","6.581","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":348},{"label":"Fev","value":371},{"label":"Mar","value":447},{"label":"Abr","value":534},{"label":"Mai","value":392},{"label":"Jun","value":410},{"label":"Jul","value":301},{"label":"Ago","value":442},{"label":"Set","value":257},{"label":"Out","value":480},{"label":"Nov","value":607},{"label":"Dez","value":358}];
const MX = 607;
