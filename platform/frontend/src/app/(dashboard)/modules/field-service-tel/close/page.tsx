...
const PAGE = "Close Report";
const KPIS = [{"l":"Total Field Service Tel","v":"5.733","t":"+11.5%","d":"up"},{"l":"Close Report Ativos","v":"3.120","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"82.8%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"95","t":"+16.4%","d":"up"}];
const COLS = ["ID","Close Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Field Service Tel #001","Field Service Tel #002","8.769","6.176","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Field Service Tel #002","Field Service Tel #003","3.047","8.963","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Field Service Tel #003","Field Service Tel #004","3.379","5.614","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Field Service Tel #004","Field Service Tel #005","840","715","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Field Service Tel #005","Field Service Tel #001","8.000","2.249","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":529},{"label":"Mar","value":596},{"label":"Abr","value":217},{"label":"Mai","value":242},{"label":"Jun","value":585},{"label":"Jul","value":322},{"label":"Ago","value":548},{"label":"Set","value":362},{"label":"Out","value":311},{"label":"Nov","value":219},{"label":"Dez","value":346}];
const MX = 596;
