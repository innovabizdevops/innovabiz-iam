...
const KPIS = [{"l":"Total Field Service Tel","v":"2.391","t":"+3.9%","d":"up"},{"l":"Work Order Ativos","v":"1.160","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"83.0%","t":"+12.8%","d":"up"},{"l":"Score Performance","v":"75","t":"+8.8%","d":"up"}];
const COLS = ["ID","Work Order","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Field Service Tel #001","Field Service Tel #002","5.235","3.129","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Field Service Tel #002","Field Service Tel #003","275","1.437","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Field Service Tel #003","Field Service Tel #004","4.662","5.374","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Field Service Tel #004","Field Service Tel #005","3.448","7.336","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Field Service Tel #005","Field Service Tel #001","6.308","1.783","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":375},{"label":"Fev","value":697},{"label":"Mar","value":565},{"label":"Abr","value":401},{"label":"Mai","value":641},{"label":"Jun","value":399},{"label":"Jul","value":675},{"label":"Ago","value":459},{"label":"Set","value":714},{"label":"Out","value":351},{"label":"Nov","value":347},{"label":"Dez","value":556}];
const MX = 714;
