...
export default function FieldServiceTelPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Field Service Tel</h1><p className="text-sm text-muted-foreground">Field Service Tel • iBOS Enterprise</p></div>
