...
const KPIS = [{"l":"Total Field Service Tel","v":"7.534","t":"-6.0%","d":"down"},{"l":"Inventory Ativos","v":"927","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"69.8%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"77","t":"+0.3%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Field Service Tel #001","Field Service Tel #002","4.030","2.034","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Field Service Tel #002","Field Service Tel #003","3.553","3.744","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Field Service Tel #003","Field Service Tel #004","123","3.695","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Field Service Tel #004","Field Service Tel #005","7.275","3.767","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Field Service Tel #005","Field Service Tel #001","8.340","4.977","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":857},{"label":"Mar","value":693},{"label":"Abr","value":747},{"label":"Mai","value":673},{"label":"Jun","value":715},{"label":"Jul","value":861},{"label":"Ago","value":656},{"label":"Set","value":841},{"label":"Out","value":868},{"label":"Nov","value":645},{"label":"Dez","value":663}];
const MX = 868;
