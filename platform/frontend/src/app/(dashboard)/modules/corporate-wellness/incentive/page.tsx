...
const KPIS = [{"l":"Vendas YTD (€)","v":"€12299","t":"+12.2%","d":"up"},{"l":"Pipeline (€)","v":"€52433","t":"+0.7%","d":"up"},{"l":"Atingimento Quota (%)","v":"70.0%","t":"+9.2%","d":"up"},{"l":"Win Rate (%)","v":"67.0%","t":"+1.5%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 9753.73","€ 29082.37","€ 18172.88","74.6%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 22871.13","€ 11831.71","€ 48981.83","95.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 723.72","€ 14828.34","€ 28797.01","83.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 7768.31","€ 40763.64","€ 3697.67","82.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 4971.99","€ 29001.68","€ 28343.49","81.0%"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":611},{"label":"Mar","value":669},{"label":"Abr","value":739},{"label":"Mai","value":851},{"label":"Jun","value":931},{"label":"Jul","value":777},{"label":"Ago","value":944},{"label":"Set","value":746},{"label":"Out","value":826},{"label":"Nov","value":953},{"label":"Dez","value":924}];
const MX = 953;
