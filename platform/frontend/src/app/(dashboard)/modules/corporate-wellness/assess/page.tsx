...
const ACCENT = "#6366f1";
const MODULE = "Corporate Wellness";
const PAGE = "Assessment";
const KPIS = [{"l":"Total Corporate Wellness","v":"718","t":"+2.1%","d":"up"},{"l":"Assessment Ativos","v":"5.407","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"70.1%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"64","t":"-4.7%","d":"down"}];
const COLS = ["ID","Assessment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Corporate Wellness #001","Corporate Wellness #002","6.256","3.728","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Corporate Wellness #002","Corporate Wellness #003","4.779","1.697","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Corporate Wellness #003","Corporate Wellness #004","7.462","711","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Corporate Wellness #004","Corporate Wellness #005","5.566","4.502","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Corporate Wellness #005","Corporate Wellness #001","6.326","7.827","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":670},{"label":"Mar","value":796},{"label":"Abr","value":692},{"label":"Mai","value":594},{"label":"Jun","value":720},{"label":"Jul","value":623},{"label":"Ago","value":707},{"label":"Set","value":771},{"label":"Out","value":665},{"label":"Nov","value":602},{"label":"Dez","value":924}];
const MX = 924;
