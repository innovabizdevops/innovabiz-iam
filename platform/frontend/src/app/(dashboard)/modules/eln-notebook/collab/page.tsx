...
const KPIS = [{"l":"Teams Ativos","v":"8.378","t":"+13.6%","d":"up"},{"l":"Reuniões/Semana","v":"407","t":"+12.7%","d":"up"},{"l":"Mensagens/Dia","v":"2041","t":"+7.0%","d":"up"},{"l":"Ficheiros Partilhados","v":"5.471","t":"+2.3%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","8.902","2429","3.349","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","3.046","4691","8.700","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","3.581","4265","7.012","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","8.411","3369","4.821","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","8.984","4595","6.699","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":743},{"label":"Mar","value":662},{"label":"Abr","value":523},{"label":"Mai","value":664},{"label":"Jun","value":833},{"label":"Jul","value":841},{"label":"Ago","value":776},{"label":"Set","value":793},{"label":"Out","value":792},{"label":"Nov","value":811},{"label":"Dez","value":856}];
const MX = 856;
