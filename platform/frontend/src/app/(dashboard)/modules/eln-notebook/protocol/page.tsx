...
const PAGE = "Protocol";
const KPIS = [{"l":"Integrações Ativas","v":"9.096","t":"+15.9%","d":"up"},{"l":"Chamadas/Hora","v":"1314","t":"-0.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"87.4%","t":"+8.7%","d":"up"},{"l":"Latência Média (ms)","v":"201ms","t":"+11.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.010","3.860","70.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.489","7.366","95.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.459","3.014","96.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","938","320","95.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","370","7.986","97.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":575},{"label":"Mar","value":793},{"label":"Abr","value":788},{"label":"Mai","value":668},{"label":"Jun","value":688},{"label":"Jul","value":436},{"label":"Ago","value":496},{"label":"Set","value":566},{"label":"Out","value":790},{"label":"Nov","value":741},{"label":"Dez","value":798}];
const MX = 798;
