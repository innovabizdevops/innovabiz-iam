...
const ACCENT = "#059669";
const MODULE = "Electronic Lab Notebook";
const PAGE = "IP Protection";
const KPIS = [{"l":"Total Eln Notebook","v":"2.163","t":"+2.7%","d":"up"},{"l":"IP Protection Ativos","v":"8.296","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"81.3%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"84","t":"+14.5%","d":"up"}];
const COLS = ["ID","IP Protection","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Eln Notebook #001","Eln Notebook #002","5.499","7.428","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Eln Notebook #002","Eln Notebook #003","5.590","7.083","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Eln Notebook #003","Eln Notebook #004","5.704","3.618","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Eln Notebook #004","Eln Notebook #005","9.022","8.126","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Eln Notebook #005","Eln Notebook #001","6.346","8.133","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":682},{"label":"Mar","value":578},{"label":"Abr","value":684},{"label":"Mai","value":674},{"label":"Jun","value":762},{"label":"Jul","value":884},{"label":"Ago","value":632},{"label":"Set","value":857},{"label":"Out","value":632},{"label":"Nov","value":554},{"label":"Dez","value":784}];
const MX = 884;
