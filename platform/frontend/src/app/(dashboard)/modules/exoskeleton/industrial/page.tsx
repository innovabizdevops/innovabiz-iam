...
const KPIS = [{"l":"Total Exoskeleton","v":"6.023","t":"-0.5%","d":"down"},{"l":"Industrial Ativos","v":"1.161","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"75.9%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"70","t":"+12.0%","d":"up"}];
const COLS = ["ID","Industrial","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Exoskeleton #001","Exoskeleton #002","370","4.121","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Exoskeleton #002","Exoskeleton #003","8.637","2.346","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Exoskeleton #003","Exoskeleton #004","8.813","567","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Exoskeleton #004","Exoskeleton #005","2.310","5.108","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Exoskeleton #005","Exoskeleton #001","8.317","409","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":690},{"label":"Mar","value":961},{"label":"Abr","value":1045},{"label":"Mai","value":774},{"label":"Jun","value":1030},{"label":"Jul","value":865},{"label":"Ago","value":981},{"label":"Set","value":980},{"label":"Out","value":725},{"label":"Nov","value":801},{"label":"Dez","value":1029}];
const MX = 1045;
