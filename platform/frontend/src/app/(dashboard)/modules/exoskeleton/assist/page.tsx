...
const ACCENT = "#6366f1";
const MODULE = "Exoskeleton Systems";
const PAGE = "Power Assist";
const KPIS = [{"l":"Total Exoskeleton","v":"598","t":"+12.8%","d":"up"},{"l":"Power Assist Ativos","v":"5.278","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"83.7%","t":"+17.2%","d":"up"},{"l":"Score Performance","v":"82","t":"-3.9%","d":"down"}];
const COLS = ["ID","Power Assist","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Exoskeleton #001","Exoskeleton #002","4.740","5.708","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Exoskeleton #002","Exoskeleton #003","5.551","7.478","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Exoskeleton #003","Exoskeleton #004","5.000","5.255","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Exoskeleton #004","Exoskeleton #005","3.776","8.606","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Exoskeleton #005","Exoskeleton #001","3.504","7.577","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":389},{"label":"Fev","value":309},{"label":"Mar","value":531},{"label":"Abr","value":410},{"label":"Mai","value":248},{"label":"Jun","value":470},{"label":"Jul","value":432},{"label":"Ago","value":371},{"label":"Set","value":642},{"label":"Out","value":309},{"label":"Nov","value":345},{"label":"Dez","value":391}];
const MX = 642;
