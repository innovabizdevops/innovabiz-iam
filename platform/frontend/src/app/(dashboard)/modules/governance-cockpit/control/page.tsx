...
const PAGE = "Control";
const KPIS = [{"l":"Riscos Identificados","v":"2.095","t":"+4.3%","d":"up"},{"l":"Mitigações Ativas","v":"7.719","t":"-5.3%","d":"down"},{"l":"Score Risco Geral","v":"90","t":"+9.3%","d":"up"},{"l":"Incidentes YTD","v":"7.294","t":"+13.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.368","6.171","5.081","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.384","1.276","5.063","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.847","8.546","1.299","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.467","7.781","6.793","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.795","3.584","2.148","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":419},{"label":"Mar","value":677},{"label":"Abr","value":622},{"label":"Mai","value":595},{"label":"Jun","value":682},{"label":"Jul","value":462},{"label":"Ago","value":474},{"label":"Set","value":573},{"label":"Out","value":626},{"label":"Nov","value":318},{"label":"Dez","value":668}];
const MX = 682;
