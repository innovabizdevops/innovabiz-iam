...
const PAGE = "Action";
const KPIS = [{"l":"Riscos Identificados","v":"4.496","t":"+6.4%","d":"up"},{"l":"Mitigações Ativas","v":"562","t":"+16.5%","d":"up"},{"l":"Score Risco Geral","v":"93","t":"+12.1%","d":"up"},{"l":"Incidentes YTD","v":"7.536","t":"+10.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.785","3.084","5.554","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.544","5.484","519","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","430","6.743","4.406","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.933","7.932","2.220","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.395","8.396","1.306","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":733},{"label":"Mar","value":924},{"label":"Abr","value":641},{"label":"Mai","value":851},{"label":"Jun","value":952},{"label":"Jul","value":965},{"label":"Ago","value":879},{"label":"Set","value":866},{"label":"Out","value":860},{"label":"Nov","value":818},{"label":"Dez","value":906}];
const MX = 965;
