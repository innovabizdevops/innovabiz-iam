...
const KPIS = [
    { label: "Total Registos", value: "6413", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "794", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€320K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "880225213", cells: ["GOV-8213", "Governance Cockpit Item 1", "22/2/2026", "€25 313"], status: "active" as const },
    { id: "880228784", cells: ["GOV-2784", "Governance Cockpit Item 2", "9/9/2026", "€28 884"], status: "pending" as const },
    { id: "880232355", cells: ["GOV-6355", "Governance Cockpit Item 3", "24/4/2026", "€32 455"], status: "completed" as const },
    { id: "880235926", cells: ["GOV-9926", "Governance Cockpit Item 4", "11/11/2026", "€36 026"], status: "warning" as const },
    { id: "880239497", cells: ["GOV-4497", "Governance Cockpit Item 5", "26/6/2026", "€39 597"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Governance Cockpit</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Governance Cockpit</p>
                    </div>
                </div>
