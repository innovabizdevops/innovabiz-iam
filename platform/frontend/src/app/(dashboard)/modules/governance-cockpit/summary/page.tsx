...
const PAGE = "Summary";
const KPIS = [{"l":"Riscos Identificados","v":"1.876","t":"-3.7%","d":"down"},{"l":"Mitigações Ativas","v":"7.441","t":"+12.7%","d":"up"},{"l":"Score Risco Geral","v":"84","t":"+6.9%","d":"up"},{"l":"Incidentes YTD","v":"4.661","t":"+16.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.788","172","2.362","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.359","6.548","6.429","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.241","771","3.676","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.140","7.749","3.468","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.398","1.480","7.931","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":726},{"label":"Mar","value":796},{"label":"Abr","value":886},{"label":"Mai","value":646},{"label":"Jun","value":701},{"label":"Jul","value":816},{"label":"Ago","value":700},{"label":"Set","value":804},{"label":"Out","value":784},{"label":"Nov","value":859},{"label":"Dez","value":781}];
const MX = 886;
