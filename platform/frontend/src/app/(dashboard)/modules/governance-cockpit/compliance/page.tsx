...
const KPIS = [{"l":"Riscos Identificados","v":"2.631","t":"+0.5%","d":"up"},{"l":"Mitigações Ativas","v":"5.577","t":"+5.8%","d":"up"},{"l":"Score Risco Geral","v":"90","t":"+11.1%","d":"up"},{"l":"Incidentes YTD","v":"5.882","t":"+6.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.938","1.323","7.272","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.949","4.124","2.045","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.490","5.731","7.006","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.576","8.462","4.816","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.571","8.194","2.315","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":659},{"label":"Mar","value":609},{"label":"Abr","value":821},{"label":"Mai","value":766},{"label":"Jun","value":643},{"label":"Jul","value":613},{"label":"Ago","value":844},{"label":"Set","value":694},{"label":"Out","value":719},{"label":"Nov","value":582},{"label":"Dez","value":859}];
const MX = 859;
