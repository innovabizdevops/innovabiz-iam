...
const ACCENT = "#1e293b";
const MODULE = "Governance Cockpit";
const PAGE = "Risk Heat Map";
const KPIS = [{"l":"Riscos Identificados","v":"7.622","t":"-2.7%","d":"down"},{"l":"Mitigações Ativas","v":"3.153","t":"+17.5%","d":"up"},{"l":"Score Risco Geral","v":"55","t":"+12.9%","d":"up"},{"l":"Incidentes YTD","v":"7.710","t":"+4.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.213","3.144","7.426","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.375","2.813","3.062","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","209","1.556","5.993","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.515","8.638","3.693","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.344","5.792","3.965","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":436},{"label":"Fev","value":499},{"label":"Mar","value":495},{"label":"Abr","value":462},{"label":"Mai","value":555},{"label":"Jun","value":299},{"label":"Jul","value":428},{"label":"Ago","value":579},{"label":"Set","value":412},{"label":"Out","value":286},{"label":"Nov","value":261},{"label":"Dez","value":565}];
const MX = 579;
