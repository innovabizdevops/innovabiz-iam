...
const ACCENT = "#ca8a04";
const MODULE = "Energy & Utilities";
const PAGE = "Renewable Optimization";
const KPIS = [{"l":"Total Energy","v":"7.513","t":"+6.3%","d":"up"},{"l":"Renewable Optimization Ativos","v":"3.096","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"66.7%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"63","t":"+8.5%","d":"up"}];
const COLS = ["ID","Renewable Optimization","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy #001","Energy #002","5.733","6.716","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Energy #002","Energy #003","7.057","5.607","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy #003","Energy #004","3.254","325","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Energy #004","Energy #005","4.664","2.093","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy #005","Energy #001","8.008","5.874","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":726},{"label":"Mar","value":780},{"label":"Abr","value":460},{"label":"Mai","value":518},{"label":"Jun","value":633},{"label":"Jul","value":799},{"label":"Ago","value":494},{"label":"Set","value":466},{"label":"Out","value":445},{"label":"Nov","value":655},{"label":"Dez","value":655}];
const MX = 799;
...
export default function RenewableAiPage() {
    return (
