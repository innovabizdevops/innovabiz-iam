...
const PAGE = "Grid Monitor";
const KPIS = [{"l":"Total Energy","v":"4.231","t":"+1.6%","d":"up"},{"l":"Grid Monitor Ativos","v":"7.702","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"87.4%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"72","t":"+4.1%","d":"up"}];
const COLS = ["ID","Grid Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy #001","Energy #002","3.625","8.085","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Energy #002","Energy #003","4.890","6.907","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy #003","Energy #004","1.397","7.440","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Energy #004","Energy #005","3.579","2.403","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy #005","Energy #001","3.685","8.340","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":771},{"label":"Fev","value":873},{"label":"Mar","value":904},{"label":"Abr","value":566},{"label":"Mai","value":709},{"label":"Jun","value":599},{"label":"Jul","value":644},{"label":"Ago","value":667},{"label":"Set","value":624},{"label":"Out","value":721},{"label":"Nov","value":829},{"label":"Dez","value":541}];
const MX = 904;
