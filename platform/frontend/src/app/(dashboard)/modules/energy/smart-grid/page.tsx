...
const PAGE = "Smart Grid Mgmt";
const KPIS = [{"l":"Total Energy","v":"3.416","t":"+3.5%","d":"up"},{"l":"Smart Grid Mgmt Ativos","v":"7.359","t":"-5.7%","d":"down"},{"l":"Eficiência (%)","v":"66.5%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"66","t":"+4.1%","d":"up"}];
const COLS = ["ID","Smart Grid Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy #001","Energy #002","5.031","7.616","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Energy #002","Energy #003","7.964","1.190","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy #003","Energy #004","3.352","8.281","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Energy #004","Energy #005","302","4.487","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy #005","Energy #001","621","5.498","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":872},{"label":"Fev","value":809},{"label":"Mar","value":599},{"label":"Abr","value":871},{"label":"Mai","value":757},{"label":"Jun","value":700},{"label":"Jul","value":879},{"label":"Ago","value":542},{"label":"Set","value":924},{"label":"Out","value":771},{"label":"Nov","value":706},{"label":"Dez","value":855}];
const MX = 924;
