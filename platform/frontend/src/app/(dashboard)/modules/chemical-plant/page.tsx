...
export default function ChemicalPlantPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Chemical Plant</h1><p className="text-sm text-muted-foreground">Chemical Plant • iBOS Enterprise</p></div>
