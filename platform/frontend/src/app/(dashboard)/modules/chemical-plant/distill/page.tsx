...
const KPIS = [{"l":"Total Chemical Plant","v":"4.725","t":"+10.5%","d":"up"},{"l":"Distillation Ativos","v":"2.407","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"93.3%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"87","t":"+2.7%","d":"up"}];
const COLS = ["ID","Distillation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemical Plant #001","Chemical Plant #002","1.579","5.187","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Chemical Plant #002","Chemical Plant #003","5.429","4.893","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemical Plant #003","Chemical Plant #004","6.667","7.372","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Chemical Plant #004","Chemical Plant #005","764","2.410","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemical Plant #005","Chemical Plant #001","2.291","2.868","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":632},{"label":"Mar","value":452},{"label":"Abr","value":822},{"label":"Mai","value":558},{"label":"Jun","value":796},{"label":"Jul","value":710},{"label":"Ago","value":466},{"label":"Set","value":802},{"label":"Out","value":830},{"label":"Nov","value":524},{"label":"Dez","value":648}];
const MX = 830;
