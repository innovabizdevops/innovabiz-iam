...
const ACCENT = "#6366f1";
const MODULE = "Chemical Plant Ops";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Chemical Plant","v":"923","t":"+11.2%","d":"up"},{"l":"Monitor Ativos","v":"7.538","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"89.3%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"74","t":"+5.4%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemical Plant #001","Chemical Plant #002","4.533","1.441","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Chemical Plant #002","Chemical Plant #003","7.144","8.345","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemical Plant #003","Chemical Plant #004","1.652","907","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Chemical Plant #004","Chemical Plant #005","3.001","2.558","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemical Plant #005","Chemical Plant #001","8.535","7.402","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":510},{"label":"Mar","value":398},{"label":"Abr","value":360},{"label":"Mai","value":410},{"label":"Jun","value":446},{"label":"Jul","value":439},{"label":"Ago","value":509},{"label":"Set","value":303},{"label":"Out","value":478},{"label":"Nov","value":637},{"label":"Dez","value":415}];
const MX = 637;
