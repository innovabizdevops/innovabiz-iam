...
const PAGE = "Safety";
const KPIS = [{"l":"Total Chemical Plant","v":"278","t":"+13.0%","d":"up"},{"l":"Safety Ativos","v":"7.231","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"74.1%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"59","t":"-1.1%","d":"down"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemical Plant #001","Chemical Plant #002","7.809","2.718","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Chemical Plant #002","Chemical Plant #003","2.510","1.354","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemical Plant #003","Chemical Plant #004","6.577","6.434","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Chemical Plant #004","Chemical Plant #005","755","913","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemical Plant #005","Chemical Plant #001","7.744","6.635","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":771},{"label":"Fev","value":870},{"label":"Mar","value":966},{"label":"Abr","value":919},{"label":"Mai","value":609},{"label":"Jun","value":785},{"label":"Jul","value":696},{"label":"Ago","value":643},{"label":"Set","value":642},{"label":"Out","value":1002},{"label":"Nov","value":615},{"label":"Dez","value":722}];
const MX = 1002;
