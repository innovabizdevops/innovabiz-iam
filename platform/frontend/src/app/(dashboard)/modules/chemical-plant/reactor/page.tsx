...
const PAGE = "Reactor";
const KPIS = [{"l":"Total Chemical Plant","v":"2.113","t":"+3.0%","d":"up"},{"l":"Reactor Ativos","v":"7.162","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"67.8%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"64","t":"-0.4%","d":"down"}];
const COLS = ["ID","Reactor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemical Plant #001","Chemical Plant #002","4.954","3.367","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Chemical Plant #002","Chemical Plant #003","4.692","1.253","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemical Plant #003","Chemical Plant #004","6.038","5.706","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Chemical Plant #004","Chemical Plant #005","7.237","7.988","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemical Plant #005","Chemical Plant #001","8.535","6.178","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":850},{"label":"Mar","value":874},{"label":"Abr","value":967},{"label":"Mai","value":968},{"label":"Jun","value":771},{"label":"Jul","value":1045},{"label":"Ago","value":990},{"label":"Set","value":844},{"label":"Out","value":1071},{"label":"Nov","value":950},{"label":"Dez","value":904}];
const MX = 1071;
