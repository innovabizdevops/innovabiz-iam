...
const PAGE = "Process";
const KPIS = [{"l":"Total Chemical Plant","v":"3.548","t":"+6.5%","d":"up"},{"l":"Process Ativos","v":"3.469","t":"+0.1%","d":"up"},{"l":"Eficiência (%)","v":"92.9%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"67","t":"-4.8%","d":"down"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemical Plant #001","Chemical Plant #002","2.864","8.068","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Chemical Plant #002","Chemical Plant #003","1.205","5.733","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemical Plant #003","Chemical Plant #004","1.919","2.510","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Chemical Plant #004","Chemical Plant #005","398","722","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemical Plant #005","Chemical Plant #001","4.112","5.052","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":317},{"label":"Fev","value":259},{"label":"Mar","value":500},{"label":"Abr","value":329},{"label":"Mai","value":599},{"label":"Jun","value":415},{"label":"Jul","value":479},{"label":"Ago","value":356},{"label":"Set","value":477},{"label":"Out","value":255},{"label":"Nov","value":391},{"label":"Dez","value":300}];
const MX = 599;
