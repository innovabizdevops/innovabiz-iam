...
/* ═══ Logistics Management Deep — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "907", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2913", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€42K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "-15%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1566982707", cells: ["LOG-2707", "Logistics Management Deep Item 1", "4/4/2026", "€32 807"], status: "active" as const },
    { id: "1566986278", cells: ["LOG-6278", "Logistics Management Deep Item 2", "19/11/2026", "€36 378"], status: "pending" as const },
    { id: "1566989849", cells: ["LOG-9849", "Logistics Management Deep Item 3", "6/6/2026", "€39 949"], status: "completed" as const },
    { id: "1566993420", cells: ["LOG-4420", "Logistics Management Deep Item 4", "21/1/2026", "€43 520"], status: "warning" as const },
    { id: "1566996991", cells: ["LOG-7991", "Logistics Management Deep Item 5", "8/8/2026", "€47 091"], status: "active" as const },
];
...
export default function LogisticsManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Logistics Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Logistics Management Deep</p>
                    </div>
                </div>
