...
const PAGE = "Carrier";
const KPIS = [{"l":"ARR (€M)","v":"€1.8M","t":"-0.4%","d":"down"},{"l":"MRR (€)","v":"€34483","t":"-1.6%","d":"down"},{"l":"Churn (%)","v":"67.1%","t":"-1.4%","d":"down"},{"l":"ARPU (€)","v":"€16941","t":"+3.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 13222.23","4.549","€ 20562.86","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 31244.50","2.341","€ 25563.81","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 30876.08","6.140","€ 8659.09","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 44264.51","7.951","€ 1889.67","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 6995.05","5.044","€ 11287.62","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":881},{"label":"Fev","value":693},{"label":"Mar","value":835},{"label":"Abr","value":724},{"label":"Mai","value":820},{"label":"Jun","value":862},{"label":"Jul","value":980},{"label":"Ago","value":985},{"label":"Set","value":1015},{"label":"Out","value":707},{"label":"Nov","value":655},{"label":"Dez","value":943}];
const MX = 1015;
