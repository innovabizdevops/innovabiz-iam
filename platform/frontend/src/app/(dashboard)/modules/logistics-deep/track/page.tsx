...
const ACCENT = "#059669";
const MODULE = "Logistics Management Deep";
const PAGE = "Track";
const KPIS = [{"l":"Total Logistics Deep","v":"7.094","t":"+1.5%","d":"up"},{"l":"Track Ativos","v":"2.281","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"77.8%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"58","t":"+15.9%","d":"up"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Logistics Deep #001","Logistics Deep #002","7.697","5.716","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Logistics Deep #002","Logistics Deep #003","5.305","5.694","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Logistics Deep #003","Logistics Deep #004","6.124","3.591","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Logistics Deep #004","Logistics Deep #005","2.587","7.480","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Logistics Deep #005","Logistics Deep #001","1.751","2.175","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":698},{"label":"Mar","value":854},{"label":"Abr","value":1038},{"label":"Mai","value":684},{"label":"Jun","value":751},{"label":"Jul","value":962},{"label":"Ago","value":952},{"label":"Set","value":1070},{"label":"Out","value":977},{"label":"Nov","value":931},{"label":"Dez","value":890}];
const MX = 1070;
