...
const PAGE = "Marriage";
const KPIS = [{"l":"ARR (€M)","v":"€2.6M","t":"+16.2%","d":"up"},{"l":"MRR (€)","v":"€95208","t":"-4.0%","d":"down"},{"l":"Churn (%)","v":"73.5%","t":"-3.8%","d":"down"},{"l":"ARPU (€)","v":"€46433","t":"+13.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 9793.30","8.074","€ 39322.59","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 26409.90","1.399","€ 32834.17","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 4799.82","1.391","€ 39079.21","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 26585.20","4.359","€ 43057.34","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 16514.87","602","€ 33408.88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":637},{"label":"Mar","value":759},{"label":"Abr","value":908},{"label":"Mai","value":916},{"label":"Jun","value":835},{"label":"Jul","value":781},{"label":"Ago","value":892},{"label":"Set","value":638},{"label":"Out","value":777},{"label":"Nov","value":522},{"label":"Dez","value":587}];
const MX = 916;
