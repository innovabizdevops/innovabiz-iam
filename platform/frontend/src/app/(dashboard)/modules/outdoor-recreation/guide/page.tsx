...
const PAGE = "Guide";
const KPIS = [{"l":"Artigos Publicados","v":"2.055","t":"+10.9%","d":"up"},{"l":"Views/Semana","v":"4728","t":"+0.0%","d":"up"},{"l":"Feedback Útil (%)","v":"94.6%","t":"+14.8%","d":"up"},{"l":"Artigos Desatualizados","v":"5.862","t":"+15.9%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","1.431","77.4%","5.893","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","2.159","74.6%","5.572","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","117","82.0%","4.161","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","1.980","72.6%","3.978","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","1.087","81.9%","6.671","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":869},{"label":"Mar","value":874},{"label":"Abr","value":536},{"label":"Mai","value":779},{"label":"Jun","value":854},{"label":"Jul","value":515},{"label":"Ago","value":500},{"label":"Set","value":546},{"label":"Out","value":666},{"label":"Nov","value":556},{"label":"Dez","value":598}];
const MX = 874;
