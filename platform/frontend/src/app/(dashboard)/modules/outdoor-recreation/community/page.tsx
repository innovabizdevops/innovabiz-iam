...
const KPIS = [{"l":"Projetos Sociais","v":"648","t":"+7.7%","d":"up"},{"l":"Beneficiários","v":"4.215","t":"+4.0%","d":"up"},{"l":"Investimento CSR (€)","v":"€25905","t":"-5.4%","d":"down"},{"l":"Score Impacto","v":"74","t":"+13.1%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","4.239","€ 47282.47","3.083","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","565","€ 40578.74","2.034","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","487","€ 48790.67","8.290","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","8.790","€ 41304.18","7.544","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","7.851","€ 35576.05","8.305","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":477},{"label":"Fev","value":648},{"label":"Mar","value":670},{"label":"Abr","value":581},{"label":"Mai","value":395},{"label":"Jun","value":484},{"label":"Jul","value":475},{"label":"Ago","value":490},{"label":"Set","value":493},{"label":"Out","value":590},{"label":"Nov","value":386},{"label":"Dez","value":385}];
const MX = 670;
