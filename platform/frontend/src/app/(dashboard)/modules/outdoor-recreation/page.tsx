...
/* ═══ Outdoor Recreation Platform — Dashboard ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total Registos", value: "8662", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "836", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€277K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "-20%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1877157462", cells: ["OUT-1462", "Outdoor Recreation Platform Item 1", "27/7/2026", "€7562"], status: "active" as const },
    { id: "1877161033", cells: ["OUT-5033", "Outdoor Recreation Platform Item 2", "14/2/2026", "€11 133"], status: "pending" as const },
    { id: "1877164604", cells: ["OUT-8604", "Outdoor Recreation Platform Item 3", "1/9/2026", "€14 704"], status: "completed" as const },
    { id: "1877168175", cells: ["OUT-3175", "Outdoor Recreation Platform Item 4", "16/4/2026", "€18 275"], status: "warning" as const },
    { id: "1877171746", cells: ["OUT-6746", "Outdoor Recreation Platform Item 5", "3/11/2026", "€21 846"], status: "active" as const },
];
...
export default function OutdoorRecreationPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Outdoor Recreation Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Outdoor Recreation Platform</p>
                    </div>
                </div>
