...
const ACCENT = "#1e40af";
const MODULE = "Ground Station Ops";
const PAGE = "Antenna Schedule";
const KPIS = [{"l":"Total Sat Ground","v":"1.429","t":"+3.9%","d":"up"},{"l":"Antenna Schedule Ativos","v":"8.529","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"90.5%","t":"+14.0%","d":"up"},{"l":"Score Performance","v":"90","t":"+6.1%","d":"up"}];
const COLS = ["ID","Antenna Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sat Ground #001","Sat Ground #002","4.327","2.195","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Sat Ground #002","Sat Ground #003","5.722","1.763","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Sat Ground #003","Sat Ground #004","1.261","5.774","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Sat Ground #004","Sat Ground #005","3.825","8.055","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sat Ground #005","Sat Ground #001","7.572","7.018","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":546},{"label":"Mar","value":628},{"label":"Abr","value":642},{"label":"Mai","value":754},{"label":"Jun","value":859},{"label":"Jul","value":648},{"label":"Ago","value":635},{"label":"Set","value":677},{"label":"Out","value":758},{"label":"Nov","value":589},{"label":"Dez","value":845}];
const MX = 859;
