...
const PAGE = "Data Download";
const KPIS = [{"l":"Total Sat Ground","v":"847","t":"+4.1%","d":"up"},{"l":"Data Download Ativos","v":"2.076","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"65.1%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"94","t":"-3.6%","d":"down"}];
const COLS = ["ID","Data Download","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sat Ground #001","2026-03-08","1.681","1.821","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Sat Ground #002","2026-02-26","1.549","6.171","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Sat Ground #003","2026-01-28","4.928","2.711","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Sat Ground #004","2026-01-23","2.967","1.395","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sat Ground #005","2026-01-21","2.142","1.294","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":368},{"label":"Mar","value":387},{"label":"Abr","value":458},{"label":"Mai","value":536},{"label":"Jun","value":565},{"label":"Jul","value":681},{"label":"Ago","value":565},{"label":"Set","value":629},{"label":"Out","value":637},{"label":"Nov","value":650},{"label":"Dez","value":376}];
const MX = 681;
