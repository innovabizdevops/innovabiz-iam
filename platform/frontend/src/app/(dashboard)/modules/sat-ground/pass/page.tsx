...
const PAGE = "Pass Predict";
const KPIS = [{"l":"Integrações Ativas","v":"5.299","t":"+2.0%","d":"up"},{"l":"Chamadas/Hora","v":"474","t":"-5.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"84.7%","t":"+11.7%","d":"up"},{"l":"Latência Média (ms)","v":"53ms","t":"+0.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.534","4.258","95.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.278","6.874","79.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.005","6.557","72.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.987","1.464","79.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.141","102","91.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":393},{"label":"Fev","value":337},{"label":"Mar","value":586},{"label":"Abr","value":596},{"label":"Mai","value":359},{"label":"Jun","value":281},{"label":"Jul","value":267},{"label":"Ago","value":436},{"label":"Set","value":457},{"label":"Out","value":390},{"label":"Nov","value":352},{"label":"Dez","value":449}];
const MX = 596;
