...
const KPIS = [{"l":"Total Sat Ground","v":"1.512","t":"+11.3%","d":"up"},{"l":"Link Budget Ativos","v":"€82113","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"74.1%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"86","t":"-3.6%","d":"down"}];
const COLS = ["ID","Link Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sat Ground #001","€ 48777.49","1.006","662","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Sat Ground #002","€ 19077.88","1.649","3.023","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Sat Ground #003","€ 18118.09","7.662","6.699","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Sat Ground #004","€ 17415.60","4.818","1.043","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sat Ground #005","€ 40806.31","3.783","4.647","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":991},{"label":"Fev","value":851},{"label":"Mar","value":863},{"label":"Abr","value":721},{"label":"Mai","value":713},{"label":"Jun","value":1015},{"label":"Jul","value":714},{"label":"Ago","value":780},{"label":"Set","value":816},{"label":"Out","value":888},{"label":"Nov","value":626},{"label":"Dez","value":807}];
const MX = 1015;
