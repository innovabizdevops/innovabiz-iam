...
const ACCENT = "#1d4ed8";
const MODULE = "Corretores Imobiliários";
const PAGE = "Avaliação AI";
const KPIS = [{"l":"Total Corretor Imobiliario","v":"4.073","t":"+2.4%","d":"up"},{"l":"AvaliaçãO AI Ativos","v":"6.640","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"71.4%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"61","t":"+15.3%","d":"up"}];
const COLS = ["ID","AvaliaçãO AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Corretor Imobiliario #001","Corretor Imobiliario #002","7.321","592","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Corretor Imobiliario #002","Corretor Imobiliario #003","1.380","4.805","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Corretor Imobiliario #003","Corretor Imobiliario #004","7.198","4.998","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Corretor Imobiliario #004","Corretor Imobiliario #005","1.772","3.993","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Corretor Imobiliario #005","Corretor Imobiliario #001","4.374","5.225","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":390},{"label":"Mar","value":735},{"label":"Abr","value":670},{"label":"Mai","value":411},{"label":"Jun","value":581},{"label":"Jul","value":454},{"label":"Ago","value":432},{"label":"Set","value":728},{"label":"Out","value":605},{"label":"Nov","value":773},{"label":"Dez","value":412}];
const MX = 773;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1d4ed8'}}>AI</span></h1>
                </div>
