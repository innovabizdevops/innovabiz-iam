...
const PAGE = "CRM Imobiliário";
const KPIS = [{"l":"Total Corretor Imobiliario","v":"9.081","t":"+9.3%","d":"up"},{"l":"CRM ImobiliáRio Ativos","v":"5.527","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"92.5%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"90","t":"+9.0%","d":"up"}];
const COLS = ["ID","CRM ImobiliáRio","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Corretor Imobiliario #001","Corretor Imobiliario #002","8.634","7.402","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Corretor Imobiliario #002","Corretor Imobiliario #003","2.126","6.488","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Corretor Imobiliario #003","Corretor Imobiliario #004","3.699","3.233","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Corretor Imobiliario #004","Corretor Imobiliario #005","4.079","7.869","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Corretor Imobiliario #005","Corretor Imobiliario #001","2.955","4.612","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":645},{"label":"Mar","value":442},{"label":"Abr","value":501},{"label":"Mai","value":378},{"label":"Jun","value":366},{"label":"Jul","value":495},{"label":"Ago","value":504},{"label":"Set","value":504},{"label":"Out","value":722},{"label":"Nov","value":703},{"label":"Dez","value":562}];
const MX = 722;
