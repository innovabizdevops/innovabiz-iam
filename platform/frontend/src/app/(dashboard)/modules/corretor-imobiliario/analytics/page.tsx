...
const KPIS = [{"l":"Dashboards Ativos","v":"6.716","t":"+14.2%","d":"up"},{"l":"Queries/Dia","v":"4109","t":"+14.4%","d":"up"},{"l":"Dados Processados (GB)","v":"2.303","t":"+4.4%","d":"up"},{"l":"Utilizadores Analytics","v":"377","t":"+9.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1536","2026-03-04","4.892","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1574","2026-02-24","4.590","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4158","2026-03-02","6.515","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1638","2026-02-14","5.995","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1008","2026-03-11","7.304","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":773},{"label":"Mar","value":825},{"label":"Abr","value":641},{"label":"Mai","value":617},{"label":"Jun","value":474},{"label":"Jul","value":609},{"label":"Ago","value":528},{"label":"Set","value":856},{"label":"Out","value":520},{"label":"Nov","value":602},{"label":"Dez","value":552}];
const MX = 856;
