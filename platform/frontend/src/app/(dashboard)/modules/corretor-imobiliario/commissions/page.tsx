...
const KPIS = [{"l":"Vendas YTD (€)","v":"€33036","t":"-4.3%","d":"down"},{"l":"Pipeline (€)","v":"€11557","t":"-0.8%","d":"down"},{"l":"Atingimento Quota (%)","v":"89.7%","t":"+9.6%","d":"up"},{"l":"Win Rate (%)","v":"74.7%","t":"+3.5%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 5448.02","€ 16005.52","€ 9329.02","93.5%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 20537.14","€ 20070.64","€ 31154.40","88.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 4112.22","€ 27894.78","€ 48111.25","91.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 4324.65","€ 18816.03","€ 8290.53","75.1%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 34281.86","€ 47135.98","€ 15848.27","84.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":681},{"label":"Mar","value":916},{"label":"Abr","value":834},{"label":"Mai","value":893},{"label":"Jun","value":939},{"label":"Jul","value":888},{"label":"Ago","value":717},{"label":"Set","value":948},{"label":"Out","value":975},{"label":"Nov","value":765},{"label":"Dez","value":648}];
const MX = 975;
