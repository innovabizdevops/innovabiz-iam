...
const PAGE = "Compliance AMI";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.376","t":"+17.2%","d":"up"},{"l":"NC Abertas","v":"1.134","t":"+8.7%","d":"up"},{"l":"Conformidade (%)","v":"87.4%","t":"+9.3%","d":"up"},{"l":"CAPAs Pendentes","v":"1.943","t":"+15.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.484","91.2%","2.378","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.601","75.0%","7.670","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.910","99.4%","8.996","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.804","85.1%","1.019","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.461","86.5%","6.336","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":941},{"label":"Mar","value":750},{"label":"Abr","value":709},{"label":"Mai","value":920},{"label":"Jun","value":1047},{"label":"Jul","value":998},{"label":"Ago","value":1015},{"label":"Set","value":695},{"label":"Out","value":875},{"label":"Nov","value":770},{"label":"Dez","value":1039}];
const MX = 1047;
