...
const PAGE = "Imóveis";
const KPIS = [{"l":"Total Corretor Imobiliario","v":"3.162","t":"+12.6%","d":"up"},{"l":"ImóVeis Ativos","v":"321","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"90.1%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"83","t":"+6.7%","d":"up"}];
const COLS = ["ID","ImóVeis","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Corretor Imobiliario #001","Corretor Imobiliario #002","3.871","1.052","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Corretor Imobiliario #002","Corretor Imobiliario #003","7.925","7.857","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Corretor Imobiliario #003","Corretor Imobiliario #004","6.498","4.209","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Corretor Imobiliario #004","Corretor Imobiliario #005","5.779","7.991","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Corretor Imobiliario #005","Corretor Imobiliario #001","8.702","2.443","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":728},{"label":"Mar","value":989},{"label":"Abr","value":882},{"label":"Mai","value":705},{"label":"Jun","value":859},{"label":"Jul","value":855},{"label":"Ago","value":978},{"label":"Set","value":912},{"label":"Out","value":970},{"label":"Nov","value":704},{"label":"Dez","value":1020}];
const MX = 1020;
