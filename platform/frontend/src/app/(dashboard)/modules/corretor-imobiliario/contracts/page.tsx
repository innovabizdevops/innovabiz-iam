...
const PAGE = "Contratos";
const KPIS = [{"l":"Contratos Ativos","v":"4.800","t":"+12.7%","d":"up"},{"l":"Valor Total (€M)","v":"€18.7M","t":"+8.1%","d":"up"},{"l":"Renovações Próx. 30d","v":"1.683","t":"-4.5%","d":"down"},{"l":"Obrigações Pendentes","v":"3.926","t":"-1.1%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 4540.87","2026-02-15","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 39191.73","2026-03-09","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 27155.08","2026-03-27","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 26249.18","2026-01-04","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 14673.39","2026-01-02","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":470},{"label":"Fev","value":338},{"label":"Mar","value":526},{"label":"Abr","value":522},{"label":"Mai","value":355},{"label":"Jun","value":356},{"label":"Jul","value":378},{"label":"Ago","value":492},{"label":"Set","value":558},{"label":"Out","value":519},{"label":"Nov","value":444},{"label":"Dez","value":463}];
const MX = 558;
