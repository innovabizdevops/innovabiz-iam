...
const PAGE = "ESG";
const KPIS = [{"l":"Dashboards Ativos","v":"6.161","t":"+8.7%","d":"up"},{"l":"Queries/Dia","v":"4941","t":"+18.0%","d":"up"},{"l":"Dados Processados (GB)","v":"3.428","t":"+7.3%","d":"up"},{"l":"Utilizadores Analytics","v":"1.089","t":"+16.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2708","2026-02-16","5.086","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1151","2026-02-01","917","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4419","2026-02-19","1.706","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1566","2026-02-12","4.581","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2561","2026-03-14","3.972","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":778},{"label":"Fev","value":732},{"label":"Mar","value":673},{"label":"Abr","value":600},{"label":"Mai","value":545},{"label":"Jun","value":755},{"label":"Jul","value":686},{"label":"Ago","value":731},{"label":"Set","value":853},{"label":"Out","value":487},{"label":"Nov","value":805},{"label":"Dez","value":531}];
const MX = 853;
