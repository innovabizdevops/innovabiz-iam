...
const KPIS = [{"l":"Dashboards Ativos","v":"8.942","t":"+3.4%","d":"up"},{"l":"Queries/Dia","v":"4466","t":"-2.4%","d":"down"},{"l":"Dados Processados (GB)","v":"6.219","t":"+17.0%","d":"up"},{"l":"Utilizadores Analytics","v":"1.420","t":"+0.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","530","2026-01-20","3.045","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4548","2026-03-01","2.914","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3958","2026-01-20","5.046","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4733","2026-02-17","1.024","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","128","2026-03-05","1.414","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":593},{"label":"Mar","value":579},{"label":"Abr","value":490},{"label":"Mai","value":497},{"label":"Jun","value":524},{"label":"Jul","value":396},{"label":"Ago","value":283},{"label":"Set","value":405},{"label":"Out","value":640},{"label":"Nov","value":362},{"label":"Dez","value":265}];
const MX = 640;
