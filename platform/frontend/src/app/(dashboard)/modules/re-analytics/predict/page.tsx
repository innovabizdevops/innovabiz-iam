...
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"7.047","t":"+12.3%","d":"up"},{"l":"Queries/Dia","v":"1453","t":"+10.3%","d":"up"},{"l":"Dados Processados (GB)","v":"1.696","t":"-5.1%","d":"down"},{"l":"Utilizadores Analytics","v":"3.522","t":"+8.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","527","2026-03-02","7.556","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3449","2026-02-15","4.595","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1599","2026-02-15","7.520","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","441","2026-03-04","8.309","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1847","2026-02-14","8.792","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":786},{"label":"Fev","value":855},{"label":"Mar","value":786},{"label":"Abr","value":862},{"label":"Mai","value":602},{"label":"Jun","value":908},{"label":"Jul","value":635},{"label":"Ago","value":695},{"label":"Set","value":786},{"label":"Out","value":799},{"label":"Nov","value":897},{"label":"Dez","value":787}];
const MX = 908;
