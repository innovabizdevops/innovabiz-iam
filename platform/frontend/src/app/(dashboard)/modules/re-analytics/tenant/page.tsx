...
const PAGE = "Tenant";
const KPIS = [{"l":"Dashboards Ativos","v":"5.758","t":"+17.1%","d":"up"},{"l":"Queries/Dia","v":"4350","t":"+2.1%","d":"up"},{"l":"Dados Processados (GB)","v":"8.212","t":"+7.7%","d":"up"},{"l":"Utilizadores Analytics","v":"4.667","t":"+8.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1364","2026-02-20","7.655","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4434","2026-01-05","2.698","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1255","2026-02-15","3.664","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2184","2026-03-24","5.963","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1051","2026-03-13","7.019","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":376},{"label":"Mar","value":520},{"label":"Abr","value":595},{"label":"Mai","value":517},{"label":"Jun","value":545},{"label":"Jul","value":359},{"label":"Ago","value":437},{"label":"Set","value":493},{"label":"Out","value":585},{"label":"Nov","value":614},{"label":"Dez","value":652}];
const MX = 652;
