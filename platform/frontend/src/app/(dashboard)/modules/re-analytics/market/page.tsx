...
const ACCENT = "#6366f1";
const MODULE = "Real Estate Analytics";
const PAGE = "Market";
const KPIS = [{"l":"Dashboards Ativos","v":"173","t":"+16.1%","d":"up"},{"l":"Queries/Dia","v":"3650","t":"+11.6%","d":"up"},{"l":"Dados Processados (GB)","v":"5.181","t":"+14.1%","d":"up"},{"l":"Utilizadores Analytics","v":"3.144","t":"-1.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","823","2026-03-24","6.454","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2801","2026-03-20","3.739","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","5055","2026-01-19","1.751","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","764","2026-03-16","4.996","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4354","2026-03-27","8.973","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":532},{"label":"Mar","value":666},{"label":"Abr","value":611},{"label":"Mai","value":873},{"label":"Jun","value":768},{"label":"Jul","value":626},{"label":"Ago","value":710},{"label":"Set","value":613},{"label":"Out","value":889},{"label":"Nov","value":612},{"label":"Dez","value":852}];
const MX = 889;
