...
const PAGE = "Renewal Forecast";
const KPIS = [{"l":"Contratos Ativos","v":"4.291","t":"-0.9%","d":"down"},{"l":"Valor Total (€M)","v":"€27.2M","t":"+13.7%","d":"up"},{"l":"Renovações Próx. 30d","v":"3.282","t":"+11.5%","d":"up"},{"l":"Obrigações Pendentes","v":"6.421","t":"-4.7%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 37077.92","2026-03-10","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 6241.27","2026-02-04","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 47251.55","2026-01-12","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 38281.04","2026-03-04","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 36773.73","2026-02-14","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":752},{"label":"Mar","value":568},{"label":"Abr","value":533},{"label":"Mai","value":745},{"label":"Jun","value":668},{"label":"Jul","value":622},{"label":"Ago","value":563},{"label":"Set","value":779},{"label":"Out","value":690},{"label":"Nov","value":723},{"label":"Dez","value":705}];
const MX = 779;
