...
const PAGE = "QBR Templates";
const KPIS = [{"l":"Formulários Ativos","v":"7.397","t":"+12.2%","d":"up"},{"l":"Submissões/Dia","v":"288","t":"-2.0%","d":"down"},{"l":"Documentos Gerados","v":"7.742","t":"+12.4%","d":"up"},{"l":"Templates","v":"3.107","t":"+8.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.485","2026-03-23","4.160","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.188","2026-03-09","2.562","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.277","2026-02-26","9.061","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.978","2026-01-23","4.589","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.076","2026-03-14","6.353","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":380},{"label":"Fev","value":358},{"label":"Mar","value":517},{"label":"Abr","value":384},{"label":"Mai","value":667},{"label":"Jun","value":628},{"label":"Jul","value":355},{"label":"Ago","value":290},{"label":"Set","value":353},{"label":"Out","value":306},{"label":"Nov","value":525},{"label":"Dez","value":422}];
const MX = 667;
