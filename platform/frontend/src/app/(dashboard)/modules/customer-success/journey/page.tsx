...
const PAGE = "Journey Orchestration";
const KPIS = [{"l":"Perfis Unificados","v":"8.414","t":"+11.2%","d":"up"},{"l":"Segmentos Ativos","v":"687","t":"-1.6%","d":"down"},{"l":"NPS Score","v":"59","t":"+7.8%","d":"up"},{"l":"Churn Previsto (%)","v":"80.5%","t":"+4.4%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","4.049","€ 21064.11","87.6%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","2.483","€ 4974.87","97.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","6.728","€ 49582.70","78.0%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","7.584","€ 44017.22","79.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","1.837","€ 37000.04","73.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":591},{"label":"Mar","value":411},{"label":"Abr","value":426},{"label":"Mai","value":513},{"label":"Jun","value":587},{"label":"Jul","value":362},{"label":"Ago","value":544},{"label":"Set","value":529},{"label":"Out","value":730},{"label":"Nov","value":547},{"label":"Dez","value":538}];
const MX = 730;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#16a34a'}}>Flow</span></h1>
                </div>
