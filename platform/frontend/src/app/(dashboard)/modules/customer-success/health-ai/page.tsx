...
const KPIS = [{"l":"Total Customer Success","v":"€72674","t":"-0.1%","d":"down"},{"l":"Health Score AI Ativos","v":"56","t":"+15.8%","d":"up"},{"l":"Eficiência (%)","v":"79.6%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"68","t":"+9.8%","d":"up"}];
const COLS = ["ID","Health Score AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customer Success #001","90.3%","5.289","5.598","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Customer Success #002","73.4%","336","5.128","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Customer Success #003","95.5%","3.354","6.727","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Customer Success #004","93.3%","192","8.456","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customer Success #005","81.9%","2.519","4.710","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":565},{"label":"Fev","value":666},{"label":"Mar","value":719},{"label":"Abr","value":497},{"label":"Mai","value":794},{"label":"Jun","value":702},{"label":"Jul","value":484},{"label":"Ago","value":759},{"label":"Set","value":502},{"label":"Out","value":596},{"label":"Nov","value":665},{"label":"Dez","value":650}];
const MX = 794;
