...
const PAGE = "Renewal Automation";
const KPIS = [{"l":"Contratos Ativos","v":"9.013","t":"+13.2%","d":"up"},{"l":"Valor Total (€M)","v":"€10.9M","t":"+8.8%","d":"up"},{"l":"Renovações Próx. 30d","v":"4.011","t":"+11.7%","d":"up"},{"l":"Obrigações Pendentes","v":"2.883","t":"-3.4%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 14251.55","2026-01-13","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 110.39","2026-02-15","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 20942.25","2026-03-08","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 1234.03","2026-02-12","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 14667.13","2026-02-22","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":729},{"label":"Mar","value":834},{"label":"Abr","value":887},{"label":"Mai","value":971},{"label":"Jun","value":812},{"label":"Jul","value":906},{"label":"Ago","value":735},{"label":"Set","value":689},{"label":"Out","value":868},{"label":"Nov","value":606},{"label":"Dez","value":583}];
const MX = 971;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#16a34a'}}>Auto</span></h1>
                </div>
