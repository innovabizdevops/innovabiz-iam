...
const PAGE = "Risk Alerts";
const KPIS = [{"l":"Riscos Identificados","v":"4.755","t":"+14.0%","d":"up"},{"l":"Mitigações Ativas","v":"3.944","t":"-4.6%","d":"down"},{"l":"Score Risco Geral","v":"76","t":"+6.2%","d":"up"},{"l":"Incidentes YTD","v":"6.648","t":"-3.9%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","986","2.234","6.385","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.379","8.990","7.206","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.599","8.333","5.767","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.329","2.990","2.338","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.887","1.383","3.046","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":759},{"label":"Fev","value":963},{"label":"Mar","value":944},{"label":"Abr","value":945},{"label":"Mai","value":796},{"label":"Jun","value":688},{"label":"Jul","value":604},{"label":"Ago","value":902},{"label":"Set","value":963},{"label":"Out","value":595},{"label":"Nov","value":690},{"label":"Dez","value":807}];
const MX = 963;
