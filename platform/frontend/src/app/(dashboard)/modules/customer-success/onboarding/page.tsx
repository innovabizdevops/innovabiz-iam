...
const PAGE = "Onboarding Tracker";
const KPIS = [{"l":"eNPS","v":"89","t":"+2.0%","d":"up"},{"l":"Engagement (%)","v":"75.6%","t":"+1.5%","d":"up"},{"l":"Turnover (%)","v":"81.0%","t":"+17.4%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.390","t":"+3.1%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","234","2026-03-15","73","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.313","2026-02-20","73","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.912","2026-02-05","57","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.538","2026-01-21","73","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.490","2026-02-21","86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":570},{"label":"Mar","value":699},{"label":"Abr","value":639},{"label":"Mai","value":748},{"label":"Jun","value":709},{"label":"Jul","value":679},{"label":"Ago","value":717},{"label":"Set","value":518},{"label":"Out","value":549},{"label":"Nov","value":641},{"label":"Dez","value":399}];
const MX = 748;
