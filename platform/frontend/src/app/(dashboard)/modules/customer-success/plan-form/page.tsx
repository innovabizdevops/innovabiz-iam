...
const PAGE = "Success Plan Form";
const KPIS = [{"l":"Formulários Ativos","v":"1.733","t":"-0.5%","d":"down"},{"l":"Submissões/Dia","v":"3737","t":"-2.3%","d":"down"},{"l":"Documentos Gerados","v":"6.478","t":"-5.0%","d":"down"},{"l":"Templates","v":"3.051","t":"+6.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.905","2026-01-19","1.678","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.293","2026-02-23","2.395","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.483","2026-01-11","8.923","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.666","2026-02-28","3.972","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.788","2026-01-04","4.330","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":319},{"label":"Fev","value":656},{"label":"Mar","value":640},{"label":"Abr","value":641},{"label":"Mai","value":358},{"label":"Jun","value":651},{"label":"Jul","value":553},{"label":"Ago","value":435},{"label":"Set","value":561},{"label":"Out","value":561},{"label":"Nov","value":486},{"label":"Dez","value":561}];
const MX = 656;
