...
const PAGE = "Renewal Playbook";
const KPIS = [{"l":"Contratos Ativos","v":"2.073","t":"+4.2%","d":"up"},{"l":"Valor Total (€M)","v":"€23.1M","t":"+8.5%","d":"up"},{"l":"Renovações Próx. 30d","v":"4.227","t":"+11.0%","d":"up"},{"l":"Obrigações Pendentes","v":"3.010","t":"-4.9%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 43619.21","2026-02-26","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 28440.28","2026-03-27","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 30304.79","2026-01-14","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 23219.04","2026-01-12","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 41123.97","2026-02-24","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":590},{"label":"Mar","value":478},{"label":"Abr","value":399},{"label":"Mai","value":663},{"label":"Jun","value":761},{"label":"Jul","value":614},{"label":"Ago","value":613},{"label":"Set","value":637},{"label":"Out","value":666},{"label":"Nov","value":416},{"label":"Dez","value":446}];
const MX = 761;
...
export default function PlaybooksCustomerSuccessPage() {
    return (
