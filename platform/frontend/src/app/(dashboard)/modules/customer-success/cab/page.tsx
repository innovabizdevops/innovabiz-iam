...
const PAGE = "Customer Advisory Board";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.878","t":"+9.0%","d":"up"},{"l":"NC Abertas","v":"8.969","t":"+0.4%","d":"up"},{"l":"Conformidade (%)","v":"93.8%","t":"-2.0%","d":"down"},{"l":"CAPAs Pendentes","v":"6.611","t":"+13.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","963","89.4%","3.144","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.139","88.6%","2.196","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.954","78.3%","2.642","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.328","99.1%","5.911","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.668","80.8%","7.988","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":603},{"label":"Mar","value":493},{"label":"Abr","value":361},{"label":"Mai","value":576},{"label":"Jun","value":629},{"label":"Jul","value":362},{"label":"Ago","value":384},{"label":"Set","value":722},{"label":"Out","value":423},{"label":"Nov","value":598},{"label":"Dez","value":591}];
const MX = 722;
