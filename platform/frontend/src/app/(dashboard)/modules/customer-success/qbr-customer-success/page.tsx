...
const ACCENT = "#16a34a";
const MODULE = "Customer Success";
const PAGE = "QBR Automation";
const KPIS = [{"l":"Total Customer Success","v":"€13473","t":"+5.5%","d":"up"},{"l":"QBR Automation Ativos","v":"1.429","t":"+1.2%","d":"up"},{"l":"Eficiência (%)","v":"71.9%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"85","t":"+17.8%","d":"up"}];
const COLS = ["ID","QBR Automation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customer Success #001","Customer Success #002","5.531","7.626","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Customer Success #002","Customer Success #003","7.880","8.703","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Customer Success #003","Customer Success #004","8.641","2.861","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Customer Success #004","Customer Success #005","2.246","6.325","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customer Success #005","Customer Success #001","2.206","239","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":630},{"label":"Mar","value":762},{"label":"Abr","value":709},{"label":"Mai","value":487},{"label":"Jun","value":808},{"label":"Jul","value":618},{"label":"Ago","value":683},{"label":"Set","value":678},{"label":"Out","value":422},{"label":"Nov","value":636},{"label":"Dez","value":732}];
const MX = 808;
...
export default function QbrCustomerSuccessPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#16a34a'}}>Automation</span></h1>
                </div>
