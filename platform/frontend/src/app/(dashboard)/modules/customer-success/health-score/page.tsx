...
const PAGE = "Health Score AI";
const KPIS = [{"l":"Total Customer Success","v":"€25128","t":"+9.4%","d":"up"},{"l":"Health Score AI Ativos","v":"78","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"65.4%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"85","t":"+7.2%","d":"up"}];
const COLS = ["ID","Health Score AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customer Success #001","96.2%","383","6.604","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Customer Success #002","80.2%","7.510","8.517","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Customer Success #003","98.0%","5.147","4.253","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Customer Success #004","77.4%","9.075","5.474","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customer Success #005","98.9%","6.288","5.022","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":896},{"label":"Fev","value":718},{"label":"Mar","value":914},{"label":"Abr","value":926},{"label":"Mai","value":913},{"label":"Jun","value":960},{"label":"Jul","value":686},{"label":"Ago","value":980},{"label":"Set","value":754},{"label":"Out","value":847},{"label":"Nov","value":973},{"label":"Dez","value":774}];
const MX = 980;
