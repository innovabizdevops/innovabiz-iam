...
const PAGE = "Expansion Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€18.3M","t":"-5.2%","d":"down"},{"l":"MRR (€)","v":"€19903","t":"-5.1%","d":"down"},{"l":"Churn (%)","v":"90.1%","t":"+0.2%","d":"up"},{"l":"ARPU (€)","v":"€75871","t":"+7.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 40395.63","6.210","€ 14635.86","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 19171.24","7.786","€ 42743.44","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 37730.04","7.056","€ 37949.39","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 1782.34","6.461","€ 25896.21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 14486.45","6.936","€ 41462.31","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":591},{"label":"Mar","value":610},{"label":"Abr","value":801},{"label":"Mai","value":604},{"label":"Jun","value":659},{"label":"Jul","value":741},{"label":"Ago","value":526},{"label":"Set","value":822},{"label":"Out","value":593},{"label":"Nov","value":559},{"label":"Dez","value":514}];
const MX = 853;
...
export default function ExpansionCustomerSuccessPage() {
    return (
