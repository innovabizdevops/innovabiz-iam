...
const KPIS = [{"l":"Dashboards Ativos","v":"5.844","t":"+12.3%","d":"up"},{"l":"Queries/Dia","v":"3485","t":"+5.3%","d":"up"},{"l":"Dados Processados (GB)","v":"7.070","t":"+7.2%","d":"up"},{"l":"Utilizadores Analytics","v":"2.844","t":"+6.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1041","2026-02-06","1.774","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3525","2026-01-06","7.021","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2022","2026-03-28","5.238","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4928","2026-01-10","4.482","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3819","2026-03-23","2.028","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":751},{"label":"Mar","value":454},{"label":"Abr","value":567},{"label":"Mai","value":688},{"label":"Jun","value":468},{"label":"Jul","value":830},{"label":"Ago","value":482},{"label":"Set","value":597},{"label":"Out","value":483},{"label":"Nov","value":677},{"label":"Dez","value":443}];
const MX = 830;
