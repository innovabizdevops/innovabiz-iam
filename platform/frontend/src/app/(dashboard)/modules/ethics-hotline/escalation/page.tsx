...
const PAGE = "Escalation";
const KPIS = [{"l":"Notificações Enviadas","v":"8.168","t":"+11.1%","d":"up"},{"l":"Taxa Entrega (%)","v":"72.6%","t":"+10.5%","d":"up"},{"l":"Taxa Abertura (%)","v":"70.2%","t":"+8.1%","d":"up"},{"l":"Escalações","v":"2.920","t":"+14.2%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","763","87.4%","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","9.032","76.8%","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","6.998","88.5%","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","3.146","83.5%","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","8.981","91.6%","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":420},{"label":"Fev","value":507},{"label":"Mar","value":501},{"label":"Abr","value":763},{"label":"Mai","value":581},{"label":"Jun","value":612},{"label":"Jul","value":653},{"label":"Ago","value":578},{"label":"Set","value":445},{"label":"Out","value":679},{"label":"Nov","value":535},{"label":"Dez","value":759}];
const MX = 763;
