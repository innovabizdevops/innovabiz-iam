...
const PAGE = "Impact";
const KPIS = [{"l":"Projetos Sociais","v":"5.258","t":"+8.5%","d":"up"},{"l":"Beneficiários","v":"2.177","t":"+3.7%","d":"up"},{"l":"Investimento CSR (€)","v":"€4615","t":"-2.6%","d":"down"},{"l":"Score Impacto","v":"93","t":"+4.1%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","5.640","€ 45463.21","756","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","998","€ 2765.79","8.860","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","5.389","€ 34692.65","2.999","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","3.674","€ 35397.21","3.529","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","519","€ 4525.05","7.512","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":445},{"label":"Mar","value":692},{"label":"Abr","value":721},{"label":"Mai","value":384},{"label":"Jun","value":645},{"label":"Jul","value":382},{"label":"Ago","value":621},{"label":"Set","value":745},{"label":"Out","value":524},{"label":"Nov","value":447},{"label":"Dez","value":769}];
const MX = 769;
