...
export default function AdvocacyCampaignPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Advocacy Campaign</h1><p className="text-sm text-muted-foreground">Advocacy Campaign • iBOS Enterprise</p></div>
