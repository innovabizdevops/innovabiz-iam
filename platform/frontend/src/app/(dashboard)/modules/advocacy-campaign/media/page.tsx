...
const PAGE = "Media";
const KPIS = [{"l":"Integrações Ativas","v":"4.215","t":"+16.0%","d":"up"},{"l":"Chamadas/Hora","v":"4035","t":"-3.6%","d":"down"},{"l":"Taxa Sucesso (%)","v":"83.8%","t":"+13.6%","d":"up"},{"l":"Latência Média (ms)","v":"174ms","t":"-3.7%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.609","7.726","82.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.785","8.144","91.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.435","2.322","75.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.773","8.893","74.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.913","4.506","84.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":325},{"label":"Mar","value":239},{"label":"Abr","value":220},{"label":"Mai","value":490},{"label":"Jun","value":265},{"label":"Jul","value":334},{"label":"Ago","value":581},{"label":"Set","value":505},{"label":"Out","value":226},{"label":"Nov","value":421},{"label":"Dez","value":581}];
const MX = 581;
