...
const KPIS = [
    { label: "Total Registos", value: "2464", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2713", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€474K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "974726664", cells: ["WAR-9664", "Warehouse Automation Item 1", "17/1/2026", "€26 764"], status: "active" as const },
    { id: "974730235", cells: ["WAR-4235", "Warehouse Automation Item 2", "4/8/2026", "€30 335"], status: "pending" as const },
    { id: "974733806", cells: ["WAR-7806", "Warehouse Automation Item 3", "19/3/2026", "€33 906"], status: "completed" as const },
    { id: "974737377", cells: ["WAR-2377", "Warehouse Automation Item 4", "6/10/2026", "€37 477"], status: "warning" as const },
    { id: "974740948", cells: ["WAR-5948", "Warehouse Automation Item 5", "21/5/2026", "€41 048"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Warehouse Automation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Warehouse Automation</p>
                    </div>
                </div>
