...
/* ═══ Exotic Car Dealer — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "9448", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2931", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€478K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "-6%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "710166048", cells: ["EXO-4048", "Exotic Car Dealer Item 1", "5/1/2026", "€16 148"], status: "active" as const },
    { id: "710169619", cells: ["EXO-7619", "Exotic Car Dealer Item 2", "20/8/2026", "€19 719"], status: "pending" as const },
    { id: "710173190", cells: ["EXO-2190", "Exotic Car Dealer Item 3", "7/3/2026", "€23 290"], status: "completed" as const },
    { id: "710176761", cells: ["EXO-5761", "Exotic Car Dealer Item 4", "22/10/2026", "€26 861"], status: "warning" as const },
    { id: "710180332", cells: ["EXO-9332", "Exotic Car Dealer Item 5", "9/5/2026", "€30 432"], status: "active" as const },
];
...
export default function ExoticCarDealerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Exotic Car Dealer</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Exotic Car Dealer</p>
                    </div>
                </div>
