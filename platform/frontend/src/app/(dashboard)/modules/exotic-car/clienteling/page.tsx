...
const ACCENT = "#78350f";
const MODULE = "Exotic Car Dealer";
const PAGE = "Clienteling";
const KPIS = [{"l":"Total Exotic Car","v":"1.107","t":"+13.7%","d":"up"},{"l":"Clienteling Ativos","v":"2.857","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"86.0%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"80","t":"+14.4%","d":"up"}];
const COLS = ["ID","Clienteling","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Exotic Car #001","Exotic Car #002","6.987","3.610","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Exotic Car #002","Exotic Car #003","6.882","3.569","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Exotic Car #003","Exotic Car #004","1.421","7.103","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Exotic Car #004","Exotic Car #005","8.864","8.516","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Exotic Car #005","Exotic Car #001","5.749","3.555","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":867},{"label":"Mar","value":583},{"label":"Abr","value":737},{"label":"Mai","value":611},{"label":"Jun","value":765},{"label":"Jul","value":779},{"label":"Ago","value":911},{"label":"Set","value":617},{"label":"Out","value":818},{"label":"Nov","value":944},{"label":"Dez","value":581}];
const MX = 944;
