...
const PAGE = "Event";
const KPIS = [{"l":"Total Exotic Car","v":"2.080","t":"+15.4%","d":"up"},{"l":"Event Ativos","v":"1.275","t":"+1.2%","d":"up"},{"l":"Eficiência (%)","v":"66.2%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"64","t":"-2.6%","d":"down"}];
const COLS = ["ID","Event","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Exotic Car #001","Exotic Car #002","7.265","6.024","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Exotic Car #002","Exotic Car #003","8.965","5.408","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Exotic Car #003","Exotic Car #004","833","105","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Exotic Car #004","Exotic Car #005","6.711","4.208","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Exotic Car #005","Exotic Car #001","2.424","1.005","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":543},{"label":"Mar","value":845},{"label":"Abr","value":689},{"label":"Mai","value":628},{"label":"Jun","value":615},{"label":"Jul","value":704},{"label":"Ago","value":482},{"label":"Set","value":724},{"label":"Out","value":802},{"label":"Nov","value":647},{"label":"Dez","value":714}];
const MX = 845;
