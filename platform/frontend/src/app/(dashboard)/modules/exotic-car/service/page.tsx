...
const PAGE = "Service";
const KPIS = [{"l":"Total Exotic Car","v":"2.241","t":"+8.8%","d":"up"},{"l":"Service Ativos","v":"707","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"92.1%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"84","t":"-1.1%","d":"down"}];
const COLS = ["ID","Service","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Exotic Car #001","Exotic Car #002","8.989","7.622","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Exotic Car #002","Exotic Car #003","4.346","7.814","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Exotic Car #003","Exotic Car #004","5.679","8.242","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Exotic Car #004","Exotic Car #005","3.890","4.935","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Exotic Car #005","Exotic Car #001","2.054","8.964","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":539},{"label":"Fev","value":804},{"label":"Mar","value":779},{"label":"Abr","value":574},{"label":"Mai","value":801},{"label":"Jun","value":750},{"label":"Jul","value":542},{"label":"Ago","value":615},{"label":"Set","value":632},{"label":"Out","value":562},{"label":"Nov","value":660},{"label":"Dez","value":716}];
const MX = 804;
