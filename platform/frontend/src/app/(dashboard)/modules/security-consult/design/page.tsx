...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"7.353","t":"+13.2%","d":"up"},{"l":"Submissões/Dia","v":"3392","t":"+15.8%","d":"up"},{"l":"Documentos Gerados","v":"1.781","t":"-4.4%","d":"down"},{"l":"Templates","v":"4.970","t":"-4.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.208","2026-03-11","5.323","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","431","2026-02-11","1.961","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","578","2026-02-02","7.795","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","252","2026-02-03","4.818","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.089","2026-01-11","2.108","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":813},{"label":"Fev","value":808},{"label":"Mar","value":685},{"label":"Abr","value":995},{"label":"Mai","value":814},{"label":"Jun","value":919},{"label":"Jul","value":889},{"label":"Ago","value":680},{"label":"Set","value":803},{"label":"Out","value":918},{"label":"Nov","value":952},{"label":"Dez","value":925}];
const MX = 995;
