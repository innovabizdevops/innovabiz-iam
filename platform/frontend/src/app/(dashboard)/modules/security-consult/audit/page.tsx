...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.633","t":"-3.1%","d":"down"},{"l":"NC Abertas","v":"5.786","t":"+9.6%","d":"up"},{"l":"Conformidade (%)","v":"77.9%","t":"+16.4%","d":"up"},{"l":"CAPAs Pendentes","v":"6.094","t":"+10.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","285","83.7%","948","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.254","82.4%","5.707","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.432","93.2%","6.734","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.828","97.6%","6.875","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.336","76.4%","4.307","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":797},{"label":"Fev","value":415},{"label":"Mar","value":770},{"label":"Abr","value":594},{"label":"Mai","value":601},{"label":"Jun","value":700},{"label":"Jul","value":624},{"label":"Ago","value":623},{"label":"Set","value":666},{"label":"Out","value":637},{"label":"Nov","value":439},{"label":"Dez","value":492}];
const MX = 797;
