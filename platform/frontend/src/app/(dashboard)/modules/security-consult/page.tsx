...
export default function SecurityConsultPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Security Consult</h1><p className="text-sm text-muted-foreground">Security Consult • iBOS Enterprise</p></div>
