...
const PAGE = "Factor";
const KPIS = [{"l":"Total Sc Finance","v":"7.339","t":"+12.5%","d":"up"},{"l":"Factor Ativos","v":"6.210","t":"+6.6%","d":"up"},{"l":"Eficiência (%)","v":"88.8%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"67","t":"+10.6%","d":"up"}];
const COLS = ["ID","Factor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Finance #001","Sc Finance #002","4.345","8.581","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Finance #002","Sc Finance #003","3.792","4.489","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Finance #003","Sc Finance #004","4.202","2.430","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Finance #004","Sc Finance #005","2.846","1.544","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Finance #005","Sc Finance #001","1.993","9.063","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":470},{"label":"Fev","value":431},{"label":"Mar","value":442},{"label":"Abr","value":454},{"label":"Mai","value":410},{"label":"Jun","value":659},{"label":"Jul","value":550},{"label":"Ago","value":716},{"label":"Set","value":613},{"label":"Out","value":549},{"label":"Nov","value":669},{"label":"Dez","value":390}];
const MX = 716;
