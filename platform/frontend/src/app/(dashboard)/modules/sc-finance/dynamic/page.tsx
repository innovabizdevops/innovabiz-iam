...
const ACCENT = "#78350f";
const MODULE = "Supply Chain Finance";
const PAGE = "Dynamic";
const KPIS = [{"l":"Total Sc Finance","v":"3.900","t":"+10.5%","d":"up"},{"l":"Dynamic Ativos","v":"2.451","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"83.9%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"63","t":"+13.0%","d":"up"}];
const COLS = ["ID","Dynamic","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Finance #001","Sc Finance #002","4.278","4.301","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Finance #002","Sc Finance #003","8.996","8.094","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Finance #003","Sc Finance #004","5.955","4.384","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Finance #004","Sc Finance #005","1.839","903","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Finance #005","Sc Finance #001","4.720","973","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":630},{"label":"Mar","value":759},{"label":"Abr","value":552},{"label":"Mai","value":787},{"label":"Jun","value":904},{"label":"Jul","value":711},{"label":"Ago","value":940},{"label":"Set","value":902},{"label":"Out","value":638},{"label":"Nov","value":761},{"label":"Dez","value":924}];
const MX = 940;
