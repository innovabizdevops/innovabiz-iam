...
const PAGE = "Reverse";
const KPIS = [{"l":"Total Sc Finance","v":"812","t":"-1.3%","d":"down"},{"l":"Reverse Ativos","v":"3.351","t":"+14.3%","d":"up"},{"l":"Eficiência (%)","v":"90.7%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"89","t":"-4.3%","d":"down"}];
const COLS = ["ID","Reverse","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Finance #001","Sc Finance #002","3.446","1.901","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Finance #002","Sc Finance #003","8.742","485","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Finance #003","Sc Finance #004","7.321","6.747","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Finance #004","Sc Finance #005","3.729","8.147","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Finance #005","Sc Finance #001","8.534","1.495","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":535},{"label":"Mar","value":840},{"label":"Abr","value":824},{"label":"Mai","value":512},{"label":"Jun","value":601},{"label":"Jul","value":653},{"label":"Ago","value":684},{"label":"Set","value":568},{"label":"Out","value":707},{"label":"Nov","value":632},{"label":"Dez","value":480}];
const MX = 840;
