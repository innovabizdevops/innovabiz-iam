...
const KPIS = [
    { label: "Total Registos", value: "2920", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2954", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€16K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1546620420", cells: ["SC-7420", "Supply Chain Finance Item 1", "17/1/2026", "€20 520"], status: "active" as const },
    { id: "1546623991", cells: ["SC-1991", "Supply Chain Finance Item 2", "4/8/2026", "€24 091"], status: "pending" as const },
    { id: "1546627562", cells: ["SC-5562", "Supply Chain Finance Item 3", "19/3/2026", "€27 662"], status: "completed" as const },
    { id: "1546631133", cells: ["SC-9133", "Supply Chain Finance Item 4", "6/10/2026", "€31 233"], status: "warning" as const },
    { id: "1546634704", cells: ["SC-3704", "Supply Chain Finance Item 5", "21/5/2026", "€34 804"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Supply Chain Finance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Supply Chain Finance</p>
                    </div>
                </div>
