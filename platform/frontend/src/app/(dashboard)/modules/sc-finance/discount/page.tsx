...
const PAGE = "Discount";
const KPIS = [{"l":"ARR (€M)","v":"€29.5M","t":"-1.9%","d":"down"},{"l":"MRR (€)","v":"€81560","t":"+17.2%","d":"up"},{"l":"Churn (%)","v":"81.5%","t":"+13.8%","d":"up"},{"l":"ARPU (€)","v":"€66799","t":"+8.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 6504.26","4.876","€ 22254.61","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 14110.80","1.492","€ 4531.86","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 38697.17","8.576","€ 31094.10","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 6962.81","2.530","€ 2463.77","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 7886.86","2.046","€ 2045.31","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":773},{"label":"Mar","value":557},{"label":"Abr","value":710},{"label":"Mai","value":820},{"label":"Jun","value":514},{"label":"Jul","value":795},{"label":"Ago","value":638},{"label":"Set","value":611},{"label":"Out","value":470},{"label":"Nov","value":472},{"label":"Dez","value":564}];
const MX = 820;
