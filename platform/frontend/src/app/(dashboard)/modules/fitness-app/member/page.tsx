...
const PAGE = "Member";
const KPIS = [{"l":"Atletas Registados","v":"670","t":"+5.2%","d":"up"},{"l":"Treinos/Semana","v":"832","t":"+4.7%","d":"up"},{"l":"Competições","v":"7.507","t":"+2.6%","d":"up"},{"l":"Performance Score","v":"55","t":"+2.8%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.168","6.278","3.425","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.944","5.364","2.034","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.531","8.513","8.858","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.650","1.695","1.588","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.448","7.406","8.618","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":579},{"label":"Mar","value":711},{"label":"Abr","value":549},{"label":"Mai","value":361},{"label":"Jun","value":414},{"label":"Jul","value":454},{"label":"Ago","value":491},{"label":"Set","value":392},{"label":"Out","value":704},{"label":"Nov","value":714},{"label":"Dez","value":464}];
const MX = 714;
