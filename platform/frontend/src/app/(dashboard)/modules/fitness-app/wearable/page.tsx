...
const ACCENT = "#16a34a";
const MODULE = "Fitness Platform";
const PAGE = "Wearable";
const KPIS = [{"l":"Atletas Registados","v":"3.491","t":"+0.9%","d":"up"},{"l":"Treinos/Semana","v":"2423","t":"+7.6%","d":"up"},{"l":"Competições","v":"8.134","t":"+9.3%","d":"up"},{"l":"Performance Score","v":"68","t":"+12.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","386","1.524","2.393","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.446","1.627","964","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.511","5.280","594","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.547","1.165","445","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.594","8.338","7.322","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":471},{"label":"Fev","value":475},{"label":"Mar","value":637},{"label":"Abr","value":513},{"label":"Mai","value":637},{"label":"Jun","value":839},{"label":"Jul","value":665},{"label":"Ago","value":796},{"label":"Set","value":824},{"label":"Out","value":594},{"label":"Nov","value":562},{"label":"Dez","value":634}];
const MX = 839;
