...
const PAGE = "Class";
const KPIS = [{"l":"Atletas Registados","v":"7.839","t":"+14.1%","d":"up"},{"l":"Treinos/Semana","v":"4741","t":"+11.2%","d":"up"},{"l":"Competições","v":"5.264","t":"+3.0%","d":"up"},{"l":"Performance Score","v":"93","t":"+3.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.321","7.827","8.879","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.769","8.840","6.069","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.706","2.731","7.132","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.241","191","3.746","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.126","2.803","3.189","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":738},{"label":"Mar","value":402},{"label":"Abr","value":565},{"label":"Mai","value":490},{"label":"Jun","value":425},{"label":"Jul","value":752},{"label":"Ago","value":436},{"label":"Set","value":531},{"label":"Out","value":673},{"label":"Nov","value":709},{"label":"Dez","value":582}];
const MX = 752;
