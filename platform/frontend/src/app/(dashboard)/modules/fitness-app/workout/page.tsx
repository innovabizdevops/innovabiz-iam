...
const PAGE = "Workout";
const KPIS = [{"l":"Atletas Registados","v":"2.389","t":"+1.9%","d":"up"},{"l":"Treinos/Semana","v":"776","t":"+12.7%","d":"up"},{"l":"Competições","v":"3.575","t":"-5.4%","d":"down"},{"l":"Performance Score","v":"89","t":"+9.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.272","1.504","6.908","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.161","6.549","4.527","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.979","1.176","2.501","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.051","3.499","9.064","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.232","1.416","8.081","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":314},{"label":"Mar","value":432},{"label":"Abr","value":611},{"label":"Mai","value":347},{"label":"Jun","value":616},{"label":"Jul","value":583},{"label":"Ago","value":426},{"label":"Set","value":346},{"label":"Out","value":552},{"label":"Nov","value":301},{"label":"Dez","value":337}];
const MX = 647;
