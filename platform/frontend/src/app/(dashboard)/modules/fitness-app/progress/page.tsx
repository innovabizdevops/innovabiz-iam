...
const PAGE = "Progress";
const KPIS = [{"l":"Atletas Registados","v":"3.647","t":"-4.0%","d":"down"},{"l":"Treinos/Semana","v":"1958","t":"+10.8%","d":"up"},{"l":"Competições","v":"8.843","t":"+4.4%","d":"up"},{"l":"Performance Score","v":"85","t":"+17.5%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","624","8.634","5.386","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.197","2.698","1.250","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.842","3.654","7.918","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","908","448","4.887","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.151","2.637","1.888","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":538},{"label":"Mar","value":872},{"label":"Abr","value":877},{"label":"Mai","value":582},{"label":"Jun","value":688},{"label":"Jul","value":598},{"label":"Ago","value":591},{"label":"Set","value":676},{"label":"Out","value":885},{"label":"Nov","value":599},{"label":"Dez","value":679}];
const MX = 885;
