...
const PAGE = "Drone Surveys";
const KPIS = [{"l":"Surveys Ativos","v":"2.249","t":"+5.5%","d":"up"},{"l":"Respostas/Semana","v":"2985","t":"-2.9%","d":"down"},{"l":"NPS Médio","v":"72","t":"-4.0%","d":"down"},{"l":"Taxa Resposta (%)","v":"93.9%","t":"+15.3%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","1.009","67","77.2%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","8.179","74","94.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","8.823","56","79.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","1.404","82","75.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","3.903","84","98.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":583},{"label":"Mar","value":372},{"label":"Abr","value":585},{"label":"Mai","value":589},{"label":"Jun","value":330},{"label":"Jul","value":630},{"label":"Ago","value":328},{"label":"Set","value":308},{"label":"Out","value":351},{"label":"Nov","value":371},{"label":"Dez","value":370}];
const MX = 658;
