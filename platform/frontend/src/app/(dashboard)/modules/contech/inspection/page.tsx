...
const PAGE = "Site Inspection";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.364","t":"-4.7%","d":"down"},{"l":"NC Abertas","v":"8.337","t":"+4.9%","d":"up"},{"l":"Conformidade (%)","v":"94.6%","t":"+3.8%","d":"up"},{"l":"CAPAs Pendentes","v":"584","t":"-0.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.395","70.8%","8.571","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.135","95.3%","6.199","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.982","94.5%","3.072","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.163","91.0%","9.086","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.657","96.0%","8.526","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":692},{"label":"Mar","value":581},{"label":"Abr","value":508},{"label":"Mai","value":808},{"label":"Jun","value":825},{"label":"Jul","value":791},{"label":"Ago","value":548},{"label":"Set","value":493},{"label":"Out","value":521},{"label":"Nov","value":601},{"label":"Dez","value":755}];
const MX = 825;
