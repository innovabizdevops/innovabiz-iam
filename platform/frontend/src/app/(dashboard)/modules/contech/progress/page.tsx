...
const ACCENT = "#b45309";
const MODULE = "Construction Tech";
const PAGE = "Progress Monitoring";
const KPIS = [{"l":"Total Contech","v":"8.818","t":"+2.7%","d":"up"},{"l":"Progress Monitoring Ativos","v":"6.624","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"83.6%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"87","t":"+17.0%","d":"up"}];
const COLS = ["ID","Progress Monitoring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Contech #001","Contech #002","1.321","2.759","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Contech #002","Contech #003","6.287","6.475","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Contech #003","Contech #004","9.084","4.484","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Contech #004","Contech #005","7.711","3.736","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Contech #005","Contech #001","7.098","2.295","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":470},{"label":"Fev","value":636},{"label":"Mar","value":584},{"label":"Abr","value":715},{"label":"Mai","value":625},{"label":"Jun","value":410},{"label":"Jul","value":645},{"label":"Ago","value":576},{"label":"Set","value":450},{"label":"Out","value":677},{"label":"Nov","value":713},{"label":"Dez","value":554}];
const MX = 715;
