...
const PAGE = "Project Scheduling";
const KPIS = [{"l":"eNPS","v":"83","t":"-3.6%","d":"down"},{"l":"Engagement (%)","v":"74.7%","t":"-4.6%","d":"down"},{"l":"Turnover (%)","v":"67.3%","t":"-4.4%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"2.332","t":"-1.7%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.503","2026-03-21","56","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.936","2026-02-26","71","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.707","2026-03-12","79","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.649","2026-03-04","91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","9.087","2026-03-08","61","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":1038},{"label":"Mar","value":796},{"label":"Abr","value":852},{"label":"Mai","value":1071},{"label":"Jun","value":882},{"label":"Jul","value":704},{"label":"Ago","value":848},{"label":"Set","value":899},{"label":"Out","value":873},{"label":"Nov","value":892},{"label":"Dez","value":782}];
const MX = 1071;
