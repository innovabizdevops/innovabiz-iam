...
const PAGE = "Safety Management";
const KPIS = [{"l":"Projetos Melhoria","v":"1.013","t":"+0.6%","d":"up"},{"l":"Savings (€)","v":"€61274","t":"-5.2%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"92.9%","t":"+5.4%","d":"up"},{"l":"Ciclos PDCA","v":"6.081","t":"+17.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.002","€ 43287.66","8.979","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.546","€ 39791.51","5.229","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.577","€ 5413.46","8.514","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","333","€ 8086.53","5.900","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.903","€ 34678.41","4.439","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":427},{"label":"Fev","value":672},{"label":"Mar","value":642},{"label":"Abr","value":478},{"label":"Mai","value":645},{"label":"Jun","value":632},{"label":"Jul","value":695},{"label":"Ago","value":397},{"label":"Set","value":506},{"label":"Out","value":659},{"label":"Nov","value":745},{"label":"Dez","value":563}];
const MX = 745;
