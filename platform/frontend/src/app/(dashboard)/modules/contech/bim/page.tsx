...
const PAGE = "BIM Management";
const KPIS = [{"l":"Projetos Melhoria","v":"6.547","t":"-0.7%","d":"down"},{"l":"Savings (€)","v":"€99539","t":"+9.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"80.0%","t":"+9.8%","d":"up"},{"l":"Ciclos PDCA","v":"4.679","t":"+9.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.693","€ 13038.97","6.660","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.210","€ 7157.77","4.782","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.580","€ 2674.53","4.809","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.469","€ 14343.28","8.257","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.417","€ 45555.09","1.373","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":779},{"label":"Fev","value":593},{"label":"Mar","value":672},{"label":"Abr","value":690},{"label":"Mai","value":753},{"label":"Jun","value":850},{"label":"Jul","value":661},{"label":"Ago","value":592},{"label":"Set","value":922},{"label":"Out","value":641},{"label":"Nov","value":809},{"label":"Dez","value":832}];
const MX = 922;
