...
const PAGE = "Loyalty";
const KPIS = [{"l":"Quartos Ocupados","v":"2.919","t":"+10.5%","d":"up"},{"l":"RevPAR (€)","v":"€1524","t":"-3.9%","d":"down"},{"l":"Ocupação (%)","v":"74.8%","t":"-5.6%","d":"down"},{"l":"Guest Satisfaction","v":"4.376","t":"+17.4%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.613","2026-02-14","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.024","2026-03-25","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.843","2026-03-03","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.151","2026-01-19","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.984","2026-02-10","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":371},{"label":"Fev","value":588},{"label":"Mar","value":490},{"label":"Abr","value":586},{"label":"Mai","value":278},{"label":"Jun","value":640},{"label":"Jul","value":648},{"label":"Ago","value":418},{"label":"Set","value":260},{"label":"Out","value":537},{"label":"Nov","value":301},{"label":"Dez","value":463}];
const MX = 648;
