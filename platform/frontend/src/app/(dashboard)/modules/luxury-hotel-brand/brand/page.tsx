...
const ACCENT = "#b45309";
const MODULE = "Luxury Hotel Brand";
const PAGE = "Brand";
const KPIS = [{"l":"Quartos Ocupados","v":"6.273","t":"+11.7%","d":"up"},{"l":"RevPAR (€)","v":"€97306","t":"+14.1%","d":"up"},{"l":"Ocupação (%)","v":"91.9%","t":"+3.8%","d":"up"},{"l":"Guest Satisfaction","v":"2.630","t":"+1.3%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.329","2026-01-18","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.869","2026-01-11","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.053","2026-02-11","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.165","2026-02-17","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.337","2026-01-23","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":371},{"label":"Fev","value":637},{"label":"Mar","value":638},{"label":"Abr","value":362},{"label":"Mai","value":423},{"label":"Jun","value":404},{"label":"Jul","value":401},{"label":"Ago","value":504},{"label":"Set","value":358},{"label":"Out","value":288},{"label":"Nov","value":340},{"label":"Dez","value":612}];
const MX = 638;
