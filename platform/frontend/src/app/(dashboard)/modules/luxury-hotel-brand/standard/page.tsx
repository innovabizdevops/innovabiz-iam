...
const PAGE = "Standard";
const KPIS = [{"l":"Quartos Ocupados","v":"967","t":"+17.1%","d":"up"},{"l":"RevPAR (€)","v":"€79422","t":"+2.8%","d":"up"},{"l":"Ocupação (%)","v":"89.9%","t":"-3.5%","d":"down"},{"l":"Guest Satisfaction","v":"4.392","t":"-3.6%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.704","2026-03-24","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.169","2026-01-01","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.869","2026-02-11","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.295","2026-02-13","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.913","2026-01-28","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":651},{"label":"Mar","value":574},{"label":"Abr","value":534},{"label":"Mai","value":622},{"label":"Jun","value":432},{"label":"Jul","value":507},{"label":"Ago","value":506},{"label":"Set","value":557},{"label":"Out","value":690},{"label":"Nov","value":426},{"label":"Dez","value":606}];
const MX = 690;
