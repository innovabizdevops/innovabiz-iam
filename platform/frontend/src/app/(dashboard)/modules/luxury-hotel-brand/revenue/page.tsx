...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€30.7M","t":"+15.8%","d":"up"},{"l":"MRR (€)","v":"€84749","t":"-3.8%","d":"down"},{"l":"Churn (%)","v":"73.1%","t":"-6.0%","d":"down"},{"l":"ARPU (€)","v":"€5132","t":"+14.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 36724.20","6.578","€ 47096.84","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 882.17","8.517","€ 151.82","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 44070.48","5.508","€ 37925.50","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 181.15","5.585","€ 11656.02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 16203.74","3.276","€ 20274.29","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":741},{"label":"Mar","value":814},{"label":"Abr","value":978},{"label":"Mai","value":863},{"label":"Jun","value":708},{"label":"Jul","value":901},{"label":"Ago","value":962},{"label":"Set","value":919},{"label":"Out","value":755},{"label":"Nov","value":969},{"label":"Dez","value":777}];
const MX = 978;
