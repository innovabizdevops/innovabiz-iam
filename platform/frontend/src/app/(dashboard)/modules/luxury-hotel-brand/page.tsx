...
/* ═══ Luxury Hotel Brand — Dashboard ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total Registos", value: "2503", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4486", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€142K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "-11%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "131375403", cells: ["LUX-3403", "Luxury Hotel Brand Item 1", "20/4/2026", "€25 503"], status: "active" as const },
    { id: "131378974", cells: ["LUX-6974", "Luxury Hotel Brand Item 2", "7/11/2026", "€29 074"], status: "pending" as const },
    { id: "131382545", cells: ["LUX-1545", "Luxury Hotel Brand Item 3", "22/6/2026", "€32 645"], status: "completed" as const },
    { id: "131386116", cells: ["LUX-5116", "Luxury Hotel Brand Item 4", "9/1/2026", "€36 216"], status: "warning" as const },
    { id: "131389687", cells: ["LUX-8687", "Luxury Hotel Brand Item 5", "24/8/2026", "€39 787"], status: "active" as const },
];
...
export default function LuxuryHotelBrandPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Luxury Hotel Brand</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Luxury Hotel Brand</p>
                    </div>
                </div>
