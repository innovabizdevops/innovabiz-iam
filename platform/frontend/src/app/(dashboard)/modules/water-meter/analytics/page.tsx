...
const KPIS = [{"l":"Dashboards Ativos","v":"2.045","t":"+10.0%","d":"up"},{"l":"Queries/Dia","v":"843","t":"-3.4%","d":"down"},{"l":"Dados Processados (GB)","v":"6.307","t":"+6.3%","d":"up"},{"l":"Utilizadores Analytics","v":"4.753","t":"+16.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","179","2026-02-23","1.990","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5083","2026-01-05","4.881","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2054","2026-03-21","8.048","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4944","2026-02-04","5.063","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","863","2026-03-19","7.825","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":944},{"label":"Fev","value":642},{"label":"Mar","value":662},{"label":"Abr","value":867},{"label":"Mai","value":607},{"label":"Jun","value":620},{"label":"Jul","value":770},{"label":"Ago","value":969},{"label":"Set","value":858},{"label":"Out","value":794},{"label":"Nov","value":963},{"label":"Dez","value":775}];
const MX = 969;
