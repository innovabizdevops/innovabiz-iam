...
const PAGE = "Billing";
const KPIS = [{"l":"Total Water Meter","v":"7.169","t":"+2.9%","d":"up"},{"l":"Billing Ativos","v":"442","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"76.3%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"86","t":"+6.7%","d":"up"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Meter #001","Water Meter #002","6.508","2.942","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Water Meter #002","Water Meter #003","7.624","2.411","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Meter #003","Water Meter #004","7.981","1.037","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Water Meter #004","Water Meter #005","4.482","6.773","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Meter #005","Water Meter #001","7.189","8.419","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":271},{"label":"Fev","value":346},{"label":"Mar","value":591},{"label":"Abr","value":326},{"label":"Mai","value":662},{"label":"Jun","value":650},{"label":"Jul","value":376},{"label":"Ago","value":590},{"label":"Set","value":382},{"label":"Out","value":515},{"label":"Nov","value":407},{"label":"Dez","value":275}];
const MX = 662;
