...
const PAGE = "Leak";
const KPIS = [{"l":"Total Water Meter","v":"2.382","t":"+2.0%","d":"up"},{"l":"Leak Ativos","v":"8.909","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"68.8%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"82","t":"+13.8%","d":"up"}];
const COLS = ["ID","Leak","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Meter #001","Water Meter #002","118","3.506","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Water Meter #002","Water Meter #003","8.635","4.676","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Meter #003","Water Meter #004","7.937","6.284","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Water Meter #004","Water Meter #005","9.047","5.799","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Meter #005","Water Meter #001","2.407","958","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":586},{"label":"Mar","value":517},{"label":"Abr","value":641},{"label":"Mai","value":716},{"label":"Jun","value":678},{"label":"Jul","value":523},{"label":"Ago","value":767},{"label":"Set","value":714},{"label":"Out","value":625},{"label":"Nov","value":476},{"label":"Dez","value":493}];
const MX = 767;
