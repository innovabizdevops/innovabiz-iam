...
const PAGE = "Read";
const KPIS = [{"l":"Total Water Meter","v":"5.125","t":"+4.1%","d":"up"},{"l":"Read Ativos","v":"912","t":"+7.0%","d":"up"},{"l":"Eficiência (%)","v":"69.7%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"81","t":"+5.9%","d":"up"}];
const COLS = ["ID","Read","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Meter #001","Water Meter #002","2.000","3.217","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Water Meter #002","Water Meter #003","1.170","2.832","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Meter #003","Water Meter #004","6.632","305","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Water Meter #004","Water Meter #005","1.187","1.080","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Meter #005","Water Meter #001","8.033","4.455","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":797},{"label":"Mar","value":650},{"label":"Abr","value":838},{"label":"Mai","value":739},{"label":"Jun","value":554},{"label":"Jul","value":539},{"label":"Ago","value":729},{"label":"Set","value":568},{"label":"Out","value":894},{"label":"Nov","value":615},{"label":"Dez","value":542}];
const MX = 894;
