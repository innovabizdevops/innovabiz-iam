...
const KPIS = [{"l":"Perfis Unificados","v":"194","t":"-0.9%","d":"down"},{"l":"Segmentos Ativos","v":"4.887","t":"-4.6%","d":"down"},{"l":"NPS Score","v":"64","t":"+0.4%","d":"up"},{"l":"Churn Previsto (%)","v":"75.1%","t":"-1.1%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","1.414","€ 18767.97","73.4%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","6.750","€ 25191.29","70.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","1.342","€ 23360.15","98.5%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","8.246","€ 8072.87","77.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","6.735","€ 29086.96","86.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":689},{"label":"Fev","value":562},{"label":"Mar","value":885},{"label":"Abr","value":733},{"label":"Mai","value":959},{"label":"Jun","value":749},{"label":"Jul","value":831},{"label":"Ago","value":951},{"label":"Set","value":640},{"label":"Out","value":686},{"label":"Nov","value":604},{"label":"Dez","value":701}];
const MX = 959;
