...
const KPIS = [{"l":"Integrações Ativas","v":"4.327","t":"+6.1%","d":"up"},{"l":"Chamadas/Hora","v":"3347","t":"+8.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"78.0%","t":"-5.5%","d":"down"},{"l":"Latência Média (ms)","v":"204ms","t":"-3.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.551","1.456","90.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.817","6.917","99.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","870","7.698","86.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.961","6.979","76.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.371","511","95.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":991},{"label":"Fev","value":939},{"label":"Mar","value":700},{"label":"Abr","value":974},{"label":"Mai","value":612},{"label":"Jun","value":872},{"label":"Jul","value":863},{"label":"Ago","value":874},{"label":"Set","value":659},{"label":"Out","value":934},{"label":"Nov","value":693},{"label":"Dez","value":910}];
const MX = 991;
