...
const ACCENT = "#1e40af";
const MODULE = "Zero Trust Network";
const PAGE = "Trust Score";
const KPIS = [{"l":"Total Zero Trust","v":"8.918","t":"+7.1%","d":"up"},{"l":"Trust Score Ativos","v":"77","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"90.9%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"88","t":"+15.6%","d":"up"}];
const COLS = ["ID","Trust Score","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Zero Trust #001","71.1%","4.970","5.272","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Zero Trust #002","91.8%","3.921","6.132","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Zero Trust #003","70.2%","7.108","4.099","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Zero Trust #004","79.0%","3.114","892","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Zero Trust #005","91.8%","1.960","720","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":844},{"label":"Fev","value":872},{"label":"Mar","value":851},{"label":"Abr","value":916},{"label":"Mai","value":873},{"label":"Jun","value":700},{"label":"Jul","value":737},{"label":"Ago","value":888},{"label":"Set","value":972},{"label":"Out","value":700},{"label":"Nov","value":801},{"label":"Dez","value":824}];
const MX = 972;
