...
const PAGE = "Identity Verify";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.593","t":"+8.6%","d":"up"},{"l":"Sessões/Dia","v":"2040","t":"-5.3%","d":"down"},{"l":"MFA Adoção (%)","v":"92.1%","t":"+16.1%","d":"up"},{"l":"Tentativas Bloqueadas","v":"6.817","t":"+10.4%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","8.065","1.919","3.207","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","1.184","1.619","4.642","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.165","5.606","6.250","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.280","4.766","6.912","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","5.465","1.888","4.912","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":897},{"label":"Mar","value":703},{"label":"Abr","value":758},{"label":"Mai","value":836},{"label":"Jun","value":988},{"label":"Jul","value":772},{"label":"Ago","value":1058},{"label":"Set","value":743},{"label":"Out","value":948},{"label":"Nov","value":1063},{"label":"Dez","value":880}];
const MX = 1063;
