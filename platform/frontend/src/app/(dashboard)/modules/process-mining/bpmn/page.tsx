...
const PAGE = "BPMN 2.0 Modeler";
const KPIS = [{"l":"Diagramas Criados","v":"1.480","t":"+12.6%","d":"up"},{"l":"Templates","v":"2.359","t":"-2.0%","d":"down"},{"l":"Colaboradores","v":"2.769","t":"+8.5%","d":"up"},{"l":"Comentários/Semana","v":"4144","t":"+5.7%","d":"up"}];
const COLS = ["Diagrama","Tipo","Criador","Última Edição","Partilhado","Estado"];
const ROWS = [{"id":"r0","cells":["Processo Onboarding BPMN","Org Chart 2026","4.288","2026-02-12","2.753","Ativo"],"status":"active"},{"id":"r1","cells":["Org Chart 2026","Network Topology","5.316","2026-02-10","1.380","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Topology","Data Flow ETL","8.651","2026-03-27","6.931","Concluído"],"status":"done"},{"id":"r3","cells":["Data Flow ETL","User Journey Map","6.030","2026-03-16","5.444","Em Análise"],"status":"risk"},{"id":"r4","cells":["User Journey Map","Processo Onboarding BPMN","7.593","2026-02-16","1.541","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":888},{"label":"Fev","value":813},{"label":"Mar","value":753},{"label":"Abr","value":932},{"label":"Mai","value":760},{"label":"Jun","value":966},{"label":"Jul","value":987},{"label":"Ago","value":673},{"label":"Set","value":932},{"label":"Out","value":1026},{"label":"Nov","value":806},{"label":"Dez","value":730}];
const MX = 1026;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0ea5e9'}}>BPMN</span></h1>
                </div>
