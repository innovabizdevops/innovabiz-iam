...
const PAGE = "Object-Centric PM";
const KPIS = [{"l":"Total Process Mining","v":"4.961","t":"+1.6%","d":"up"},{"l":"Object Centric PM Ativos","v":"5.341","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"86.4%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"67","t":"-3.3%","d":"down"}];
const COLS = ["ID","Object Centric PM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Process Mining #001","Process Mining #002","6.750","4.871","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Process Mining #002","Process Mining #003","106","5.855","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Process Mining #003","Process Mining #004","2.222","7.402","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Process Mining #004","Process Mining #005","6.207","3.706","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Process Mining #005","Process Mining #001","1.628","5.753","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":753},{"label":"Mar","value":790},{"label":"Abr","value":777},{"label":"Mai","value":763},{"label":"Jun","value":695},{"label":"Jul","value":617},{"label":"Ago","value":603},{"label":"Set","value":516},{"label":"Out","value":769},{"label":"Nov","value":800},{"label":"Dez","value":564}];
const MX = 800;
...
export default function ObjectCentricPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0ea5e9'}}>AI</span></h1>
                </div>
