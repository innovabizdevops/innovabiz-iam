...
const PAGE = "DMN Decision Models";
const KPIS = [{"l":"Aprovações Pendentes","v":"8.623","t":"-2.4%","d":"down"},{"l":"SLA Cumprido (%)","v":"71.1%","t":"+3.8%","d":"up"},{"l":"Tempo Médio (h)","v":"196h","t":"-1.3%","d":"down"},{"l":"Rejeitadas (%)","v":"92.5%","t":"+12.2%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","3.416","€ 30666.36","2.416","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","2.024","€ 35653.60","2.032","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","6.164","€ 10556.58","5.827","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","3.464","€ 31827.21","6.422","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","576","€ 29511.40","3.474","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":686},{"label":"Mar","value":724},{"label":"Abr","value":534},{"label":"Mai","value":655},{"label":"Jun","value":768},{"label":"Jul","value":661},{"label":"Ago","value":577},{"label":"Set","value":799},{"label":"Out","value":427},{"label":"Nov","value":554},{"label":"Dez","value":804}];
const MX = 804;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0ea5e9'}}>DMN</span></h1>
                </div>
