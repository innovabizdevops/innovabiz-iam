...
const PAGE = "Conformance Check";
const KPIS = [{"l":"Formulários Ativos","v":"4.884","t":"+3.4%","d":"up"},{"l":"Submissões/Dia","v":"358","t":"+1.7%","d":"up"},{"l":"Documentos Gerados","v":"3.604","t":"+17.2%","d":"up"},{"l":"Templates","v":"7.077","t":"+16.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.365","2026-02-09","3.263","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.463","2026-02-28","6.666","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.656","2026-01-08","5.755","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.041","2026-01-26","1.357","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.468","2026-01-07","5.261","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":458},{"label":"Fev","value":755},{"label":"Mar","value":602},{"label":"Abr","value":651},{"label":"Mai","value":797},{"label":"Jun","value":524},{"label":"Jul","value":480},{"label":"Ago","value":696},{"label":"Set","value":597},{"label":"Out","value":670},{"label":"Nov","value":701},{"label":"Dez","value":683}];
const MX = 797;
...
export default function ConformanceProcessMiningPage() {
    return (
