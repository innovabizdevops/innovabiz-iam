...
const ACCENT = "#0ea5e9";
const MODULE = "Process Mining";
const PAGE = "APQC PCF Library";
const KPIS = [{"l":"Total Process Mining","v":"1.367","t":"+2.8%","d":"up"},{"l":"APQC PCF Library Ativos","v":"3.294","t":"-5.9%","d":"down"},{"l":"Eficiência (%)","v":"82.9%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"75","t":"+2.0%","d":"up"}];
const COLS = ["ID","APQC PCF Library","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Process Mining #001","Process Mining #002","8.490","6.851","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Process Mining #002","Process Mining #003","5.208","8.743","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Process Mining #003","Process Mining #004","2.469","4.957","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Process Mining #004","Process Mining #005","4.363","8.811","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Process Mining #005","Process Mining #001","2.574","6.758","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":485},{"label":"Fev","value":625},{"label":"Mar","value":322},{"label":"Abr","value":389},{"label":"Mai","value":253},{"label":"Jun","value":567},{"label":"Jul","value":279},{"label":"Ago","value":504},{"label":"Set","value":514},{"label":"Out","value":335},{"label":"Nov","value":589},{"label":"Dez","value":250}];
const MX = 625;
...
export default function ApqcPcfPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0ea5e9'}}>APQC</span></h1>
                </div>
