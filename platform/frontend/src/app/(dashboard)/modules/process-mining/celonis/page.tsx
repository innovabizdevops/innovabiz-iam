...
const PAGE = "Celonis Integration";
const KPIS = [{"l":"Integrações Ativas","v":"1.808","t":"-6.0%","d":"down"},{"l":"Chamadas/Hora","v":"4483","t":"-0.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"83.0%","t":"+7.0%","d":"up"},{"l":"Latência Média (ms)","v":"194ms","t":"+16.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.239","6.243","98.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.779","4.520","82.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.954","8.380","80.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.054","1.430","73.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.433","2.998","75.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":594},{"label":"Mar","value":621},{"label":"Abr","value":401},{"label":"Mai","value":489},{"label":"Jun","value":350},{"label":"Jul","value":341},{"label":"Ago","value":380},{"label":"Set","value":298},{"label":"Out","value":373},{"label":"Nov","value":480},{"label":"Dez","value":280}];
const MX = 621;
...
export default function CelonisPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0ea5e9'}}>Partner</span></h1>
                </div>
