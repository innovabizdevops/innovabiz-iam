...
const PAGE = "Process Simulation";
const KPIS = [{"l":"Twins Ativos","v":"8.338","t":"-1.1%","d":"down"},{"l":"Simulações/Dia","v":"4325","t":"+16.4%","d":"up"},{"l":"Precisão Modelo (%)","v":"81.8%","t":"+5.3%","d":"up"},{"l":"Latência Sync (ms)","v":"100ms","t":"+10.9%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","94.9%","2026-02-24","1.863","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","92.9%","2026-02-05","8.252","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","85.2%","2026-03-05","5.972","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","81.2%","2026-01-11","8.679","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","79.2%","2026-03-02","5.150","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":581},{"label":"Mar","value":873},{"label":"Abr","value":555},{"label":"Mai","value":858},{"label":"Jun","value":538},{"label":"Jul","value":751},{"label":"Ago","value":724},{"label":"Set","value":567},{"label":"Out","value":537},{"label":"Nov","value":615},{"label":"Dez","value":777}];
const MX = 873;
...
export default function SimulationProcessMiningPage() {
    return (
