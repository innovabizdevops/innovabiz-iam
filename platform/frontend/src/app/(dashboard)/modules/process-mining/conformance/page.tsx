...
const KPIS = [{"l":"Formulários Ativos","v":"2.245","t":"+1.0%","d":"up"},{"l":"Submissões/Dia","v":"847","t":"+8.0%","d":"up"},{"l":"Documentos Gerados","v":"7.126","t":"+7.8%","d":"up"},{"l":"Templates","v":"4.216","t":"+3.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.078","2026-03-05","404","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.362","2026-01-17","8.703","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.497","2026-01-11","917","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.879","2026-01-07","2.235","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.370","2026-02-08","1.106","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":969},{"label":"Fev","value":578},{"label":"Mar","value":909},{"label":"Abr","value":921},{"label":"Mai","value":807},{"label":"Jun","value":757},{"label":"Jul","value":956},{"label":"Ago","value":745},{"label":"Set","value":861},{"label":"Out","value":863},{"label":"Nov","value":861},{"label":"Dez","value":831}];
const MX = 969;
