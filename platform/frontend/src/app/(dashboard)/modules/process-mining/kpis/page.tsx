...
const PAGE = "Process KPIs";
const KPIS = [{"l":"Total Process Mining","v":"8.216","t":"+15.1%","d":"up"},{"l":"Process KPIs Ativos","v":"4.988","t":"+11.9%","d":"up"},{"l":"Eficiência (%)","v":"71.1%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"81","t":"+6.3%","d":"up"}];
const COLS = ["ID","Process KPIs","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Process Mining #001","Process Mining #002","3.298","1.729","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Process Mining #002","Process Mining #003","7.689","4.203","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Process Mining #003","Process Mining #004","5.893","2.258","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Process Mining #004","Process Mining #005","3.223","5.453","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Process Mining #005","Process Mining #001","4.605","4.308","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":581},{"label":"Mar","value":727},{"label":"Abr","value":829},{"label":"Mai","value":760},{"label":"Jun","value":751},{"label":"Jul","value":895},{"label":"Ago","value":851},{"label":"Set","value":924},{"label":"Out","value":768},{"label":"Nov","value":843},{"label":"Dez","value":827}];
const MX = 924;
