...
const KPIS = [{"l":"Total Process Mining","v":"4.744","t":"+2.8%","d":"up"},{"l":"Task Mining Ativos","v":"4.011","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"72.1%","t":"+8.9%","d":"up"},{"l":"Score Performance","v":"57","t":"+5.1%","d":"up"}];
const COLS = ["ID","Task Mining","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Process Mining #001","Process Mining #002","3.520","5.550","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Process Mining #002","Process Mining #003","7.993","6.962","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Process Mining #003","Process Mining #004","2.072","8.056","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Process Mining #004","Process Mining #005","8.891","2.856","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Process Mining #005","Process Mining #001","2.770","394","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":930},{"label":"Mar","value":672},{"label":"Abr","value":887},{"label":"Mai","value":679},{"label":"Jun","value":889},{"label":"Jul","value":861},{"label":"Ago","value":805},{"label":"Set","value":925},{"label":"Out","value":677},{"label":"Nov","value":786},{"label":"Dez","value":677}];
const MX = 930;
