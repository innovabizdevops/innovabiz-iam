...
const PAGE = "Bottleneck Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"8.770","t":"+8.9%","d":"up"},{"l":"Queries/Dia","v":"4378","t":"+17.1%","d":"up"},{"l":"Dados Processados (GB)","v":"5.934","t":"+14.2%","d":"up"},{"l":"Utilizadores Analytics","v":"884","t":"+10.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4354","2026-03-26","6.545","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4496","2026-03-20","2.821","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","635","2026-03-22","8.078","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2414","2026-03-05","771","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3556","2026-01-13","6.859","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":426},{"label":"Mar","value":391},{"label":"Abr","value":637},{"label":"Mai","value":493},{"label":"Jun","value":527},{"label":"Jul","value":650},{"label":"Ago","value":513},{"label":"Set","value":423},{"label":"Out","value":433},{"label":"Nov","value":611},{"label":"Dez","value":659}];
const MX = 679;
