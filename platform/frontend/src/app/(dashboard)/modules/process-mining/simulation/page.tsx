...
const KPIS = [{"l":"Twins Ativos","v":"7.988","t":"+17.1%","d":"up"},{"l":"Simulações/Dia","v":"4766","t":"-3.4%","d":"down"},{"l":"Precisão Modelo (%)","v":"71.2%","t":"-1.6%","d":"down"},{"l":"Latência Sync (ms)","v":"154ms","t":"+7.9%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","83.3%","2026-02-13","3.858","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","91.8%","2026-01-24","7.475","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","95.8%","2026-03-20","1.578","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","73.4%","2026-02-17","2.454","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","84.8%","2026-02-01","5.253","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":578},{"label":"Mar","value":650},{"label":"Abr","value":936},{"label":"Mai","value":664},{"label":"Jun","value":926},{"label":"Jul","value":829},{"label":"Ago","value":840},{"label":"Set","value":874},{"label":"Out","value":629},{"label":"Nov","value":561},{"label":"Dez","value":735}];
const MX = 936;
