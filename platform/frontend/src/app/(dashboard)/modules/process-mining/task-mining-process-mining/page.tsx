...
const PAGE = "Task Mining";
const KPIS = [{"l":"Total Process Mining","v":"5.091","t":"+0.5%","d":"up"},{"l":"Task Mining Ativos","v":"1.641","t":"+15.2%","d":"up"},{"l":"Eficiência (%)","v":"71.1%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"87","t":"-2.8%","d":"down"}];
const COLS = ["ID","Task Mining","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Process Mining #001","Process Mining #002","2.316","5.559","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Process Mining #002","Process Mining #003","959","8.857","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Process Mining #003","Process Mining #004","6.247","2.489","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Process Mining #004","Process Mining #005","6.043","6.964","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Process Mining #005","Process Mining #001","4.328","1.019","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":603},{"label":"Mar","value":416},{"label":"Abr","value":620},{"label":"Mai","value":649},{"label":"Jun","value":482},{"label":"Jul","value":625},{"label":"Ago","value":480},{"label":"Set","value":435},{"label":"Out","value":699},{"label":"Nov","value":373},{"label":"Dez","value":519}];
const MX = 699;
...
export default function TaskMiningProcessMiningPage() {
    return (
