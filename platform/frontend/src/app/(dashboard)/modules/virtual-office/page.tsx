...
const KPIS = [
    { label: "Total Registos", value: "9409", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "29", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€469K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "-17%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1769238309", cells: ["VIR-1309", "Virtual Office Item 1", "14/10/2026", "€38 409"], status: "active" as const },
    { id: "1769241880", cells: ["VIR-4880", "Virtual Office Item 2", "1/5/2026", "€41 980"], status: "pending" as const },
    { id: "1769245451", cells: ["VIR-8451", "Virtual Office Item 3", "16/12/2026", "€45 551"], status: "completed" as const },
    { id: "1769249022", cells: ["VIR-3022", "Virtual Office Item 4", "3/7/2026", "€49 122"], status: "warning" as const },
    { id: "1769252593", cells: ["VIR-6593", "Virtual Office Item 5", "18/2/2026", "€2693"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Virtual Office</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Virtual Office</p>
                    </div>
                </div>
