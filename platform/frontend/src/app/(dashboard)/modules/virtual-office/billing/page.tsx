...
const ACCENT = "#3730a3";
const MODULE = "Virtual Office";
const PAGE = "Billing";
const KPIS = [{"l":"Total Virtual Office","v":"5.753","t":"+2.0%","d":"up"},{"l":"Billing Ativos","v":"1.497","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"70.8%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"66","t":"+2.7%","d":"up"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Virtual Office #001","Virtual Office #002","6.489","1.303","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Virtual Office #002","Virtual Office #003","5.172","4.448","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Virtual Office #003","Virtual Office #004","3.289","6.177","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Virtual Office #004","Virtual Office #005","6.417","740","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Virtual Office #005","Virtual Office #001","3.203","3.346","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":891},{"label":"Fev","value":748},{"label":"Mar","value":798},{"label":"Abr","value":957},{"label":"Mai","value":797},{"label":"Jun","value":736},{"label":"Jul","value":684},{"label":"Ago","value":725},{"label":"Set","value":832},{"label":"Out","value":993},{"label":"Nov","value":753},{"label":"Dez","value":729}];
const MX = 993;
