...
const PAGE = "Meeting";
const KPIS = [{"l":"Teams Ativos","v":"4.637","t":"+17.2%","d":"up"},{"l":"Reuniões/Semana","v":"2287","t":"+4.4%","d":"up"},{"l":"Mensagens/Dia","v":"3994","t":"+4.2%","d":"up"},{"l":"Ficheiros Partilhados","v":"2.799","t":"+16.5%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","3.710","455","5.040","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","8.590","367","1.067","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","564","2970","8.930","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","3.849","1035","637","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.169","4558","5.957","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":832},{"label":"Mar","value":830},{"label":"Abr","value":910},{"label":"Mai","value":839},{"label":"Jun","value":843},{"label":"Jul","value":800},{"label":"Ago","value":1049},{"label":"Set","value":1006},{"label":"Out","value":1035},{"label":"Nov","value":950},{"label":"Dez","value":891}];
const MX = 1049;
