...
const PAGE = "Protocol";
const KPIS = [{"l":"Integrações Ativas","v":"6.811","t":"+11.7%","d":"up"},{"l":"Chamadas/Hora","v":"4492","t":"+5.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"66.0%","t":"-5.2%","d":"down"},{"l":"Latência Média (ms)","v":"38ms","t":"-0.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.149","9.060","98.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.085","6.511","74.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.657","416","85.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.375","7.422","89.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.819","8.695","89.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":387},{"label":"Fev","value":235},{"label":"Mar","value":234},{"label":"Abr","value":353},{"label":"Mai","value":591},{"label":"Jun","value":526},{"label":"Jul","value":257},{"label":"Ago","value":297},{"label":"Set","value":467},{"label":"Out","value":237},{"label":"Nov","value":400},{"label":"Dez","value":428}];
const MX = 591;
