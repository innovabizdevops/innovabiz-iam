...
const ACCENT = "#96b9df";
const MODULE = "Foreign Affairs";
const PAGE = "Consular";
const KPIS = [{"l":"Total Foreign Affairs","v":"6.879","t":"+5.3%","d":"up"},{"l":"Consular Ativos","v":"3.976","t":"+15.3%","d":"up"},{"l":"Eficiência (%)","v":"73.8%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"85","t":"-1.5%","d":"down"}];
const COLS = ["ID","Consular","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Foreign Affairs #001","Foreign Affairs #002","6.364","3.907","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Foreign Affairs #002","Foreign Affairs #003","6.533","4.003","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Foreign Affairs #003","Foreign Affairs #004","6.500","3.968","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Foreign Affairs #004","Foreign Affairs #005","3.978","6.208","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Foreign Affairs #005","Foreign Affairs #001","8.467","8.764","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":683},{"label":"Mar","value":371},{"label":"Abr","value":412},{"label":"Mai","value":580},{"label":"Jun","value":629},{"label":"Jul","value":495},{"label":"Ago","value":689},{"label":"Set","value":512},{"label":"Out","value":461},{"label":"Nov","value":434},{"label":"Dez","value":467}];
const MX = 689;
