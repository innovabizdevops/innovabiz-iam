...
const PAGE = "Visa";
const KPIS = [{"l":"Total Foreign Affairs","v":"6.505","t":"+13.6%","d":"up"},{"l":"Visa Ativos","v":"2.998","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"65.9%","t":"-2.6%","d":"down"},{"l":"Score Performance","v":"70","t":"+14.3%","d":"up"}];
const COLS = ["ID","Visa","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Foreign Affairs #001","Foreign Affairs #002","6.786","8.636","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Foreign Affairs #002","Foreign Affairs #003","5.734","7.003","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Foreign Affairs #003","Foreign Affairs #004","2.489","1.370","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Foreign Affairs #004","Foreign Affairs #005","5.923","8.074","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Foreign Affairs #005","Foreign Affairs #001","5.728","1.232","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":608},{"label":"Fev","value":826},{"label":"Mar","value":728},{"label":"Abr","value":734},{"label":"Mai","value":516},{"label":"Jun","value":537},{"label":"Jul","value":729},{"label":"Ago","value":619},{"label":"Set","value":505},{"label":"Out","value":749},{"label":"Nov","value":803},{"label":"Dez","value":742}];
const MX = 826;
