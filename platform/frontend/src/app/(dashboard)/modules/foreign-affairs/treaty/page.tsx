...
const PAGE = "Treaty";
const KPIS = [{"l":"Total Foreign Affairs","v":"1.812","t":"+8.2%","d":"up"},{"l":"Treaty Ativos","v":"6.992","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"90.2%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"78","t":"+1.5%","d":"up"}];
const COLS = ["ID","Treaty","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Foreign Affairs #001","Foreign Affairs #002","776","8.978","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Foreign Affairs #002","Foreign Affairs #003","6.391","905","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Foreign Affairs #003","Foreign Affairs #004","300","1.991","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Foreign Affairs #004","Foreign Affairs #005","284","5.464","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Foreign Affairs #005","Foreign Affairs #001","6.606","205","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":288},{"label":"Mar","value":302},{"label":"Abr","value":345},{"label":"Mai","value":542},{"label":"Jun","value":605},{"label":"Jul","value":367},{"label":"Ago","value":361},{"label":"Set","value":402},{"label":"Out","value":481},{"label":"Nov","value":341},{"label":"Dez","value":469}];
const MX = 650;
