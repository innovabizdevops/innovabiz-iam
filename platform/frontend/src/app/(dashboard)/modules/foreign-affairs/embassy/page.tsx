...
const PAGE = "Embassy";
const KPIS = [{"l":"Total Foreign Affairs","v":"8.098","t":"+15.1%","d":"up"},{"l":"Embassy Ativos","v":"6.565","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"75.3%","t":"+16.3%","d":"up"},{"l":"Score Performance","v":"68","t":"+15.5%","d":"up"}];
const COLS = ["ID","Embassy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Foreign Affairs #001","Foreign Affairs #002","6.608","8.320","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Foreign Affairs #002","Foreign Affairs #003","3.344","2.143","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Foreign Affairs #003","Foreign Affairs #004","8.327","741","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Foreign Affairs #004","Foreign Affairs #005","4.266","6.104","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Foreign Affairs #005","Foreign Affairs #001","306","4.051","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":436},{"label":"Mar","value":461},{"label":"Abr","value":263},{"label":"Mai","value":329},{"label":"Jun","value":332},{"label":"Jul","value":373},{"label":"Ago","value":310},{"label":"Set","value":488},{"label":"Out","value":402},{"label":"Nov","value":279},{"label":"Dez","value":323}];
const MX = 629;
