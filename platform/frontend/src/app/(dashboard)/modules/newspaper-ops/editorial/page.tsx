...
const PAGE = "Editorial";
const KPIS = [{"l":"Integrações Ativas","v":"781","t":"+10.4%","d":"up"},{"l":"Chamadas/Hora","v":"2480","t":"-0.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"93.5%","t":"+17.5%","d":"up"},{"l":"Latência Média (ms)","v":"186ms","t":"-3.5%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.588","5.319","84.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.938","3.880","90.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.761","1.109","82.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.907","796","88.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.448","817","83.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":975},{"label":"Fev","value":894},{"label":"Mar","value":988},{"label":"Abr","value":739},{"label":"Mai","value":924},{"label":"Jun","value":967},{"label":"Jul","value":709},{"label":"Ago","value":863},{"label":"Set","value":707},{"label":"Out","value":853},{"label":"Nov","value":848},{"label":"Dez","value":596}];
const MX = 988;
