...
const ACCENT = "#6366f1";
const MODULE = "Newspaper Operations";
const PAGE = "Print Run";
const KPIS = [{"l":"Quartos Ocupados","v":"4.866","t":"+1.9%","d":"up"},{"l":"RevPAR (€)","v":"€30652","t":"+11.8%","d":"up"},{"l":"Ocupação (%)","v":"80.2%","t":"+4.0%","d":"up"},{"l":"Guest Satisfaction","v":"274","t":"+15.0%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.617","2026-02-23","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","5.214","2026-02-22","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.483","2026-03-01","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.243","2026-03-17","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","166","2026-02-15","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":761},{"label":"Mar","value":617},{"label":"Abr","value":457},{"label":"Mai","value":766},{"label":"Jun","value":485},{"label":"Jul","value":532},{"label":"Ago","value":433},{"label":"Set","value":511},{"label":"Out","value":736},{"label":"Nov","value":635},{"label":"Dez","value":673}];
const MX = 766;
