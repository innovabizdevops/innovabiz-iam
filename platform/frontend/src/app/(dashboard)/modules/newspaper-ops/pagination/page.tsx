...
const KPIS = [{"l":"Quartos Ocupados","v":"2.757","t":"+12.3%","d":"up"},{"l":"RevPAR (€)","v":"€21861","t":"+12.8%","d":"up"},{"l":"Ocupação (%)","v":"68.0%","t":"-4.5%","d":"down"},{"l":"Guest Satisfaction","v":"6.238","t":"+14.9%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","5.855","2026-02-07","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.883","2026-01-04","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.257","2026-01-13","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","8.913","2026-01-20","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.876","2026-01-22","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":759},{"label":"Mar","value":542},{"label":"Abr","value":859},{"label":"Mai","value":858},{"label":"Jun","value":920},{"label":"Jul","value":544},{"label":"Ago","value":864},{"label":"Set","value":696},{"label":"Out","value":642},{"label":"Nov","value":704},{"label":"Dez","value":906}];
const MX = 920;
