...
const PAGE = "Ad Mgmt";
const KPIS = [{"l":"Quartos Ocupados","v":"2.854","t":"-3.2%","d":"down"},{"l":"RevPAR (€)","v":"€58614","t":"+5.9%","d":"up"},{"l":"Ocupação (%)","v":"91.7%","t":"-5.5%","d":"down"},{"l":"Guest Satisfaction","v":"6.850","t":"+13.3%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.480","2026-03-26","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","2.112","2026-02-16","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","541","2026-02-20","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.287","2026-01-28","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.454","2026-02-26","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":679},{"label":"Mar","value":559},{"label":"Abr","value":638},{"label":"Mai","value":582},{"label":"Jun","value":561},{"label":"Jul","value":676},{"label":"Ago","value":683},{"label":"Set","value":709},{"label":"Out","value":722},{"label":"Nov","value":433},{"label":"Dez","value":756}];
const MX = 756;
