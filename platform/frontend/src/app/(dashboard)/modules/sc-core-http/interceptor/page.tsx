...
const ACCENT = "#0284c7";
const MODULE = "SC: Core HTTP Client";
const PAGE = "Interceptor";
const KPIS = [{"l":"Total Sc Core Http","v":"1.839","t":"-5.6%","d":"down"},{"l":"Interceptor Ativos","v":"732","t":"+14.4%","d":"up"},{"l":"Eficiência (%)","v":"79.7%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"93","t":"+4.9%","d":"up"}];
const COLS = ["ID","Interceptor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Http #001","Sc Core Http #002","6.715","7.469","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Http #002","Sc Core Http #003","6.959","2.387","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Http #003","Sc Core Http #004","5.038","913","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Http #004","Sc Core Http #005","439","5.481","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Http #005","Sc Core Http #001","8.150","1.172","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":422},{"label":"Fev","value":346},{"label":"Mar","value":213},{"label":"Abr","value":351},{"label":"Mai","value":505},{"label":"Jun","value":283},{"label":"Jul","value":463},{"label":"Ago","value":413},{"label":"Set","value":277},{"label":"Out","value":300},{"label":"Nov","value":505},{"label":"Dez","value":284}];
const MX = 505;
