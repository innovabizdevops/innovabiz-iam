...
/* ═══ SC: Core HTTP Client — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "3640", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4563", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€157K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "-23%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "511724640", cells: ["SC-3640", "SC: Core HTTP Client Item 1", "1/1/2026", "€24 740"], status: "active" as const },
    { id: "511728211", cells: ["SC-7211", "SC: Core HTTP Client Item 2", "16/8/2026", "€28 311"], status: "pending" as const },
    { id: "511731782", cells: ["SC-1782", "SC: Core HTTP Client Item 3", "3/3/2026", "€31 882"], status: "completed" as const },
    { id: "511735353", cells: ["SC-5353", "SC: Core HTTP Client Item 4", "18/10/2026", "€35 453"], status: "warning" as const },
    { id: "511738924", cells: ["SC-8924", "SC: Core HTTP Client Item 5", "5/5/2026", "€39 024"], status: "active" as const },
];
...
export default function ScCoreHttpClientPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: Core HTTP Client</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: Core HTTP Client</p>
                    </div>
                </div>
