...
const PAGE = "Trace";
const KPIS = [{"l":"Total Sc Core Http","v":"1.537","t":"+17.6%","d":"up"},{"l":"Trace Ativos","v":"8.843","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"70.9%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"56","t":"+6.7%","d":"up"}];
const COLS = ["ID","Trace","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Http #001","Sc Core Http #002","1.043","5.378","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Http #002","Sc Core Http #003","5.332","1.619","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Http #003","Sc Core Http #004","5.883","4.160","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Http #004","Sc Core Http #005","7.005","1.584","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Http #005","Sc Core Http #001","6.229","529","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":705},{"label":"Mar","value":549},{"label":"Abr","value":763},{"label":"Mai","value":874},{"label":"Jun","value":833},{"label":"Jul","value":857},{"label":"Ago","value":820},{"label":"Set","value":897},{"label":"Out","value":753},{"label":"Nov","value":629},{"label":"Dez","value":821}];
const MX = 897;
