...
const PAGE = "FX Management";
const KPIS = [{"l":"Projetos Melhoria","v":"5.074","t":"+1.2%","d":"up"},{"l":"Savings (€)","v":"€42994","t":"+11.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"73.4%","t":"+15.1%","d":"up"},{"l":"Ciclos PDCA","v":"1.176","t":"+0.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.698","€ 11256.90","919","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.206","€ 12038.77","6.534","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.869","€ 38823.59","6.016","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.150","€ 35424.17","8.356","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","9.023","€ 48174.79","2.217","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":707},{"label":"Mar","value":534},{"label":"Abr","value":582},{"label":"Mai","value":690},{"label":"Jun","value":492},{"label":"Jul","value":367},{"label":"Ago","value":460},{"label":"Set","value":453},{"label":"Out","value":708},{"label":"Nov","value":660},{"label":"Dez","value":543}];
const MX = 708;
