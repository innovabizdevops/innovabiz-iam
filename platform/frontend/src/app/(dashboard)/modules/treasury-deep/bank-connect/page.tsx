...
const ACCENT = "#15803d";
const MODULE = "Treasury & Cash Mgmt";
const PAGE = "Bank Connectivity";
const KPIS = [{"l":"Total Treasury Deep","v":"6.966","t":"+5.2%","d":"up"},{"l":"Bank Connectivity Ativos","v":"7.061","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"66.8%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"86","t":"+9.0%","d":"up"}];
const COLS = ["ID","Bank Connectivity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Treasury Deep #001","Treasury Deep #002","2.168","8.843","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Treasury Deep #002","Treasury Deep #003","3.866","3.556","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Treasury Deep #003","Treasury Deep #004","8.919","5.247","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Treasury Deep #004","Treasury Deep #005","5.610","5.016","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Treasury Deep #005","Treasury Deep #001","6.025","7.868","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":525},{"label":"Mar","value":576},{"label":"Abr","value":774},{"label":"Mai","value":612},{"label":"Jun","value":610},{"label":"Jul","value":706},{"label":"Ago","value":756},{"label":"Set","value":685},{"label":"Out","value":516},{"label":"Nov","value":661},{"label":"Dez","value":670}];
const MX = 809;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#15803d'}}>SWIFT</span></h1>
                </div>
