...
const PAGE = "Drill Schedule";
const KPIS = [{"l":"Total Maritime Safety","v":"2.896","t":"+10.5%","d":"up"},{"l":"Drill Schedule Ativos","v":"4.882","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"78.1%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"62","t":"+17.1%","d":"up"}];
const COLS = ["ID","Drill Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Maritime Safety #001","Maritime Safety #002","6.762","4.209","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Maritime Safety #002","Maritime Safety #003","517","7.974","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Maritime Safety #003","Maritime Safety #004","3.766","2.253","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Maritime Safety #004","Maritime Safety #005","797","7.961","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Maritime Safety #005","Maritime Safety #001","4.470","1.167","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":339},{"label":"Fev","value":405},{"label":"Mar","value":484},{"label":"Abr","value":640},{"label":"Mai","value":332},{"label":"Jun","value":559},{"label":"Jul","value":700},{"label":"Ago","value":473},{"label":"Set","value":323},{"label":"Out","value":421},{"label":"Nov","value":519},{"label":"Dez","value":571}];
const MX = 700;
