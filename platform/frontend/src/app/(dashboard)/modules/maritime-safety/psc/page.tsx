...
const PAGE = "PSC Inspect";
const KPIS = [{"l":"Total Maritime Safety","v":"3.339","t":"+5.7%","d":"up"},{"l":"PSC Inspect Ativos","v":"4.199","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"66.9%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"64","t":"+4.2%","d":"up"}];
const COLS = ["ID","PSC Inspect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Maritime Safety #001","Maritime Safety #002","6.078","5.366","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Maritime Safety #002","Maritime Safety #003","7.339","6.226","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Maritime Safety #003","Maritime Safety #004","153","986","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Maritime Safety #004","Maritime Safety #005","9.059","4.963","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Maritime Safety #005","Maritime Safety #001","7.068","4.736","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":526},{"label":"Fev","value":479},{"label":"Mar","value":760},{"label":"Abr","value":506},{"label":"Mai","value":685},{"label":"Jun","value":550},{"label":"Jul","value":537},{"label":"Ago","value":766},{"label":"Set","value":728},{"label":"Out","value":485},{"label":"Nov","value":489},{"label":"Dez","value":772}];
const MX = 772;
