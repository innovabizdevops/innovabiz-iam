...
const ACCENT = "#dc2626";
const MODULE = "Maritime Safety";
const PAGE = "Ballast Water";
const KPIS = [{"l":"Total Maritime Safety","v":"6.488","t":"+2.3%","d":"up"},{"l":"Ballast Water Ativos","v":"4.794","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"93.3%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"67","t":"-5.4%","d":"down"}];
const COLS = ["ID","Ballast Water","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Maritime Safety #001","Maritime Safety #002","4.296","3.768","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Maritime Safety #002","Maritime Safety #003","5.408","999","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Maritime Safety #003","Maritime Safety #004","5.268","1.524","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Maritime Safety #004","Maritime Safety #005","3.780","3.372","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Maritime Safety #005","Maritime Safety #001","2.508","1.181","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":614},{"label":"Fev","value":845},{"label":"Mar","value":860},{"label":"Abr","value":718},{"label":"Mai","value":646},{"label":"Jun","value":845},{"label":"Jul","value":714},{"label":"Ago","value":673},{"label":"Set","value":534},{"label":"Out","value":885},{"label":"Nov","value":596},{"label":"Dez","value":848}];
const MX = 885;
