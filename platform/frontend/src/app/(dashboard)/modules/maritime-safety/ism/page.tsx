...
const PAGE = "ISM Code";
const KPIS = [{"l":"Total Maritime Safety","v":"8.839","t":"+17.8%","d":"up"},{"l":"ISM Code Ativos","v":"681","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"92.8%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"81","t":"+8.7%","d":"up"}];
const COLS = ["ID","ISM Code","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Maritime Safety #001","Maritime Safety #002","1.353","3.527","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Maritime Safety #002","Maritime Safety #003","4.522","931","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Maritime Safety #003","Maritime Safety #004","4.250","866","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Maritime Safety #004","Maritime Safety #005","407","114","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Maritime Safety #005","Maritime Safety #001","3.249","5.327","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":444},{"label":"Fev","value":646},{"label":"Mar","value":643},{"label":"Abr","value":483},{"label":"Mai","value":643},{"label":"Jun","value":333},{"label":"Jul","value":485},{"label":"Ago","value":635},{"label":"Set","value":466},{"label":"Out","value":302},{"label":"Nov","value":444},{"label":"Dez","value":416}];
const MX = 646;
