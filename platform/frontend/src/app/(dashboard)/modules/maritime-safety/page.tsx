...
export default function MaritimeSafetyPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Maritime Safety</h1><p className="text-sm text-muted-foreground">Maritime Safety • iBOS Enterprise</p></div>
