...
const KPIS = [{"l":"Tickets Abertos","v":"2.643","t":"-0.7%","d":"down"},{"l":"SLA Cumprido (%)","v":"78.9%","t":"-1.2%","d":"down"},{"l":"MTTR (h)","v":"187h","t":"+11.6%","d":"up"},{"l":"Satisfação (%)","v":"68.5%","t":"+11.7%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","705","1.322","5.085","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.428","8.043","7.254","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.129","6.698","7.370","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.787","5.125","6.221","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","550","3.432","1.736","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":539},{"label":"Fev","value":524},{"label":"Mar","value":609},{"label":"Abr","value":617},{"label":"Mai","value":688},{"label":"Jun","value":698},{"label":"Jul","value":666},{"label":"Ago","value":695},{"label":"Set","value":676},{"label":"Out","value":402},{"label":"Nov","value":353},{"label":"Dez","value":303}];
const MX = 698;
