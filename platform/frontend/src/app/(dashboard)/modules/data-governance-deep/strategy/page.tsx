...
const PAGE = "Strategy";
const KPIS = [{"l":"Riscos Identificados","v":"1.323","t":"+14.3%","d":"up"},{"l":"Mitigações Ativas","v":"7.273","t":"+14.4%","d":"up"},{"l":"Score Risco Geral","v":"56","t":"+9.4%","d":"up"},{"l":"Incidentes YTD","v":"928","t":"+11.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.083","4.735","2.264","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","9.007","879","2.979","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.707","8.961","6.190","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.912","2.502","1.263","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.821","8.542","2.798","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":845},{"label":"Fev","value":923},{"label":"Mar","value":730},{"label":"Abr","value":914},{"label":"Mai","value":834},{"label":"Jun","value":977},{"label":"Jul","value":947},{"label":"Ago","value":933},{"label":"Set","value":743},{"label":"Out","value":939},{"label":"Nov","value":890},{"label":"Dez","value":739}];
const MX = 977;
