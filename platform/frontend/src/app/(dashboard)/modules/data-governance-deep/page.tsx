...
/* ═══ Data Governance (DAMA) — Dashboard ═══ */

const ACCENT = "#164e63";

const KPIS = [
    { label: "Total Registos", value: "1437", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4997", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€267K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "47610437", cells: ["DAT-1437", "Data Governance (DAMA) Item 1", "22/6/2026", "€10 537"], status: "active" as const },
    { id: "47614008", cells: ["DAT-5008", "Data Governance (DAMA) Item 2", "9/1/2026", "€14 108"], status: "pending" as const },
    { id: "47617579", cells: ["DAT-8579", "Data Governance (DAMA) Item 3", "24/8/2026", "€17 679"], status: "completed" as const },
    { id: "47621150", cells: ["DAT-3150", "Data Governance (DAMA) Item 4", "11/3/2026", "€21 250"], status: "warning" as const },
    { id: "47624721", cells: ["DAT-6721", "Data Governance (DAMA) Item 5", "26/10/2026", "€24 821"], status: "active" as const },
];
...
export default function DataGovernanceDamaPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Governance (DAMA)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Governance (DAMA)</p>
                    </div>
                </div>
