...
const PAGE = "Quality";
const KPIS = [{"l":"Riscos Identificados","v":"298","t":"+16.5%","d":"up"},{"l":"Mitigações Ativas","v":"7.302","t":"+2.4%","d":"up"},{"l":"Score Risco Geral","v":"74","t":"+6.6%","d":"up"},{"l":"Incidentes YTD","v":"3.336","t":"+3.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.081","6.694","2.955","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.422","7.794","7.980","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.252","2.217","4.079","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","9.089","1.097","7.297","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.644","560","2.126","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":681},{"label":"Mar","value":652},{"label":"Abr","value":612},{"label":"Mai","value":884},{"label":"Jun","value":837},{"label":"Jul","value":681},{"label":"Ago","value":874},{"label":"Set","value":973},{"label":"Out","value":711},{"label":"Nov","value":695},{"label":"Dez","value":876}];
const MX = 973;
