...
const PAGE = "Metadata";
const KPIS = [{"l":"Riscos Identificados","v":"5.045","t":"-0.7%","d":"down"},{"l":"Mitigações Ativas","v":"1.495","t":"+12.9%","d":"up"},{"l":"Score Risco Geral","v":"78","t":"+15.1%","d":"up"},{"l":"Incidentes YTD","v":"7.052","t":"-3.3%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.974","5.624","7.987","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.510","2.891","2.361","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.089","732","840","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.126","7.598","6.947","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.190","3.660","6.401","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":824},{"label":"Mar","value":730},{"label":"Abr","value":584},{"label":"Mai","value":607},{"label":"Jun","value":659},{"label":"Jul","value":715},{"label":"Ago","value":605},{"label":"Set","value":645},{"label":"Out","value":868},{"label":"Nov","value":612},{"label":"Dez","value":833}];
const MX = 868;
