...
const ACCENT = "#164e63";
const MODULE = "Data Governance (DAMA)";
const PAGE = "Privacy";
const KPIS = [{"l":"Riscos Identificados","v":"2.552","t":"+17.8%","d":"up"},{"l":"Mitigações Ativas","v":"9.031","t":"-2.8%","d":"down"},{"l":"Score Risco Geral","v":"90","t":"+14.4%","d":"up"},{"l":"Incidentes YTD","v":"7.155","t":"-4.4%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.675","7.346","7.675","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.285","6.580","385","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.422","7.258","3.737","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.657","1.801","3.774","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.030","793","8.695","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":400},{"label":"Fev","value":637},{"label":"Mar","value":542},{"label":"Abr","value":602},{"label":"Mai","value":343},{"label":"Jun","value":579},{"label":"Jul","value":644},{"label":"Ago","value":411},{"label":"Set","value":430},{"label":"Out","value":402},{"label":"Nov","value":624},{"label":"Dez","value":524}];
const MX = 644;
