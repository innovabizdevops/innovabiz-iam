...
const KPIS = [{"l":"Riscos Identificados","v":"3.347","t":"+1.4%","d":"up"},{"l":"Mitigações Ativas","v":"6.926","t":"+16.8%","d":"up"},{"l":"Score Risco Geral","v":"69","t":"+6.2%","d":"up"},{"l":"Incidentes YTD","v":"6.876","t":"-4.3%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.094","7.121","3.804","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","879","8.577","3.025","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.329","3.026","5.700","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.777","5.937","2.811","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.049","8.506","2.418","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":715},{"label":"Fev","value":723},{"label":"Mar","value":963},{"label":"Abr","value":884},{"label":"Mai","value":1079},{"label":"Jun","value":959},{"label":"Jul","value":841},{"label":"Ago","value":947},{"label":"Set","value":882},{"label":"Out","value":961},{"label":"Nov","value":890},{"label":"Dez","value":977}];
const MX = 1079;
