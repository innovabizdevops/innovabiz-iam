...
/* ═══ Textile Recycling — Dashboard ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total Registos", value: "9398", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "332", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€437K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1926668098", cells: ["TEX-3098", "Textile Recycling Item 1", "27/11/2026", "€18 198"], status: "active" as const },
    { id: "1926671669", cells: ["TEX-6669", "Textile Recycling Item 2", "14/6/2026", "€21 769"], status: "pending" as const },
    { id: "1926675240", cells: ["TEX-1240", "Textile Recycling Item 3", "1/1/2026", "€25 340"], status: "completed" as const },
    { id: "1926678811", cells: ["TEX-4811", "Textile Recycling Item 4", "16/8/2026", "€28 911"], status: "warning" as const },
    { id: "1926682382", cells: ["TEX-8382", "Textile Recycling Item 5", "3/3/2026", "€32 482"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Textile Recycling</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Textile Recycling</p>
                    </div>
                </div>
