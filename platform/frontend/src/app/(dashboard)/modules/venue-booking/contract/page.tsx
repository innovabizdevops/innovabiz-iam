...
const ACCENT = "#78350f";
const MODULE = "Venue Booking";
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"2.976","t":"+13.4%","d":"up"},{"l":"Valor Total (€M)","v":"€32.1M","t":"+14.7%","d":"up"},{"l":"Renovações Próx. 30d","v":"5.791","t":"+8.4%","d":"up"},{"l":"Obrigações Pendentes","v":"8.723","t":"+16.1%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 41379.54","2026-02-16","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 45628.30","2026-01-28","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 44121.27","2026-02-09","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 39747.14","2026-03-05","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 44040.90","2026-02-15","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":769},{"label":"Mar","value":741},{"label":"Abr","value":679},{"label":"Mai","value":626},{"label":"Jun","value":477},{"label":"Jul","value":594},{"label":"Ago","value":508},{"label":"Set","value":786},{"label":"Out","value":587},{"label":"Nov","value":467},{"label":"Dez","value":575}];
const MX = 786;
