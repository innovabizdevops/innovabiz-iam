...
const PAGE = "Room Scheduler";
const KPIS = [{"l":"Quartos Ocupados","v":"5.740","t":"+17.6%","d":"up"},{"l":"RevPAR (€)","v":"€56127","t":"+15.1%","d":"up"},{"l":"Ocupação (%)","v":"84.4%","t":"+14.9%","d":"up"},{"l":"Guest Satisfaction","v":"5.027","t":"+3.5%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","5.816","2026-02-19","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.692","2026-02-15","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","4.314","2026-02-03","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.420","2026-03-04","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.261","2026-02-11","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":770},{"label":"Mar","value":593},{"label":"Abr","value":954},{"label":"Mai","value":684},{"label":"Jun","value":930},{"label":"Jul","value":904},{"label":"Ago","value":861},{"label":"Set","value":875},{"label":"Out","value":575},{"label":"Nov","value":919},{"label":"Dez","value":655}];
const MX = 954;
