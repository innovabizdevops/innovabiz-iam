...
const PAGE = "AV Setup";
const KPIS = [{"l":"Quartos Ocupados","v":"5.333","t":"+3.6%","d":"up"},{"l":"RevPAR (€)","v":"€62175","t":"+5.7%","d":"up"},{"l":"Ocupação (%)","v":"92.1%","t":"+12.3%","d":"up"},{"l":"Guest Satisfaction","v":"5.589","t":"+11.2%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","1.227","2026-01-11","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.048","2026-02-16","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.937","2026-03-02","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.269","2026-03-18","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.289","2026-02-01","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":680},{"label":"Mar","value":608},{"label":"Abr","value":928},{"label":"Mai","value":916},{"label":"Jun","value":759},{"label":"Jul","value":706},{"label":"Ago","value":739},{"label":"Set","value":781},{"label":"Out","value":591},{"label":"Nov","value":867},{"label":"Dez","value":869}];
const MX = 928;
