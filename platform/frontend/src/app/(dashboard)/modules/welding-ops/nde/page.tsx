...
const PAGE = "NDE";
const KPIS = [{"l":"Total Welding Ops","v":"4.602","t":"+14.0%","d":"up"},{"l":"NDE Ativos","v":"2.842","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"81.8%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"85","t":"+13.0%","d":"up"}];
const COLS = ["ID","NDE","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Welding Ops #001","Welding Ops #002","6.471","8.292","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Welding Ops #002","Welding Ops #003","6.201","2.159","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Welding Ops #003","Welding Ops #004","6.282","7.276","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Welding Ops #004","Welding Ops #005","6.899","8.868","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Welding Ops #005","Welding Ops #001","1.698","3.062","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":845},{"label":"Mar","value":547},{"label":"Abr","value":812},{"label":"Mai","value":886},{"label":"Jun","value":596},{"label":"Jul","value":549},{"label":"Ago","value":555},{"label":"Set","value":822},{"label":"Out","value":719},{"label":"Nov","value":547},{"label":"Dez","value":891}];
const MX = 891;
