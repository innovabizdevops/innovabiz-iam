...
const PAGE = "Welder Qual";
const KPIS = [{"l":"Total Welding Ops","v":"3.920","t":"+9.8%","d":"up"},{"l":"Welder Qual Ativos","v":"3.457","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"87.5%","t":"+1.5%","d":"up"},{"l":"Score Performance","v":"56","t":"-5.1%","d":"down"}];
const COLS = ["ID","Welder Qual","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Welding Ops #001","Welding Ops #002","2.640","8.483","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Welding Ops #002","Welding Ops #003","8.779","6.073","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Welding Ops #003","Welding Ops #004","658","3.082","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Welding Ops #004","Welding Ops #005","8.624","2.905","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Welding Ops #005","Welding Ops #001","2.728","5.111","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":730},{"label":"Mar","value":582},{"label":"Abr","value":766},{"label":"Mai","value":548},{"label":"Jun","value":549},{"label":"Jul","value":664},{"label":"Ago","value":646},{"label":"Set","value":867},{"label":"Out","value":628},{"label":"Nov","value":651},{"label":"Dez","value":882}];
const MX = 882;
