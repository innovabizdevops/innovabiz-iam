...
const ACCENT = "#6366f1";
const MODULE = "Welding Operations";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Welding Ops","v":"1.145","t":"+11.9%","d":"up"},{"l":"Monitor Ativos","v":"3.060","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"75.3%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"86","t":"+7.5%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Welding Ops #001","Welding Ops #002","7.631","2.105","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Welding Ops #002","Welding Ops #003","7.441","7.268","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Welding Ops #003","Welding Ops #004","892","886","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Welding Ops #004","Welding Ops #005","8.304","424","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Welding Ops #005","Welding Ops #001","8.465","4.334","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":337},{"label":"Mar","value":491},{"label":"Abr","value":431},{"label":"Mai","value":366},{"label":"Jun","value":487},{"label":"Jul","value":305},{"label":"Ago","value":553},{"label":"Set","value":318},{"label":"Out","value":490},{"label":"Nov","value":317},{"label":"Dez","value":225}];
const MX = 553;
