...
const PAGE = "WPS";
const KPIS = [{"l":"Total Welding Ops","v":"2.156","t":"-2.4%","d":"down"},{"l":"WPS Ativos","v":"6.990","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"71.2%","t":"+14.0%","d":"up"},{"l":"Score Performance","v":"93","t":"-2.9%","d":"down"}];
const COLS = ["ID","WPS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Welding Ops #001","Welding Ops #002","3.206","6.431","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Welding Ops #002","Welding Ops #003","5.003","6.584","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Welding Ops #003","Welding Ops #004","8.095","6.714","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Welding Ops #004","Welding Ops #005","607","2.095","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Welding Ops #005","Welding Ops #001","4.477","3.880","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":760},{"label":"Fev","value":714},{"label":"Mar","value":945},{"label":"Abr","value":889},{"label":"Mai","value":645},{"label":"Jun","value":950},{"label":"Jul","value":692},{"label":"Ago","value":673},{"label":"Set","value":961},{"label":"Out","value":878},{"label":"Nov","value":682},{"label":"Dez","value":691}];
const MX = 961;
