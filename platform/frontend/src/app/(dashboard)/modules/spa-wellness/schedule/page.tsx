...
const PAGE = "Therapist Sched";
const KPIS = [{"l":"Quartos Ocupados","v":"1.886","t":"+0.9%","d":"up"},{"l":"RevPAR (€)","v":"€9841","t":"-0.6%","d":"down"},{"l":"Ocupação (%)","v":"67.7%","t":"+9.9%","d":"up"},{"l":"Guest Satisfaction","v":"2.967","t":"-1.3%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.483","2026-03-26","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.003","2026-01-05","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.252","2026-02-13","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.274","2026-03-06","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.906","2026-01-01","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":694},{"label":"Mar","value":544},{"label":"Abr","value":509},{"label":"Mai","value":655},{"label":"Jun","value":540},{"label":"Jul","value":510},{"label":"Ago","value":508},{"label":"Set","value":350},{"label":"Out","value":403},{"label":"Nov","value":629},{"label":"Dez","value":616}];
const MX = 694;
