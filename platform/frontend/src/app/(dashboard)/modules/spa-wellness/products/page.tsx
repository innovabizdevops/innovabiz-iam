...
const ACCENT = "#78350f";
const MODULE = "Spa & Wellness";
const PAGE = "Product Sales";
const KPIS = [{"l":"Vendas YTD (€)","v":"€66063","t":"-3.3%","d":"down"},{"l":"Pipeline (€)","v":"€5384","t":"+15.5%","d":"up"},{"l":"Atingimento Quota (%)","v":"87.0%","t":"+1.6%","d":"up"},{"l":"Win Rate (%)","v":"87.8%","t":"+0.3%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 46482.38","€ 1067.85","€ 6484.88","76.8%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 29464.88","€ 39377.74","€ 41926.99","78.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 28618.43","€ 33334.53","€ 45590.07","99.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 30676.37","€ 39978.39","€ 1784.40","96.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 39483.95","€ 11936.98","€ 39811.13","91.4%"],"status":"active"}];
const CHART = [{"label":"Jan","value":813},{"label":"Fev","value":743},{"label":"Mar","value":678},{"label":"Abr","value":766},{"label":"Mai","value":971},{"label":"Jun","value":648},{"label":"Jul","value":877},{"label":"Ago","value":918},{"label":"Set","value":825},{"label":"Out","value":623},{"label":"Nov","value":1004},{"label":"Dez","value":967}];
const MX = 1004;
