...
const PAGE = "Offset";
const KPIS = [{"l":"Fornecedores Ativos","v":"6.143","t":"+11.4%","d":"up"},{"l":"Contratos (€M)","v":"€20.0M","t":"+4.5%","d":"up"},{"l":"On-Time Delivery (%)","v":"73.6%","t":"+16.4%","d":"up"},{"l":"Score Médio","v":"71","t":"+0.2%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","73.2%","€ 32315.74","3.514","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","82.0%","€ 7803.51","4.290","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","80.1%","€ 46893.58","6.133","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","71.5%","€ 9826.05","1.695","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","76.6%","€ 30950.16","2.335","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":658},{"label":"Mar","value":486},{"label":"Abr","value":396},{"label":"Mai","value":511},{"label":"Jun","value":468},{"label":"Jul","value":789},{"label":"Ago","value":779},{"label":"Set","value":394},{"label":"Out","value":635},{"label":"Nov","value":408},{"label":"Dez","value":512}];
const MX = 789;
