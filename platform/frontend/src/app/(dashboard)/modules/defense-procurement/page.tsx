...
export default function DefenseProcurementPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Defense Procurement</h1><p className="text-sm text-muted-foreground">Defense Procurement • iBOS Enterprise</p></div>
