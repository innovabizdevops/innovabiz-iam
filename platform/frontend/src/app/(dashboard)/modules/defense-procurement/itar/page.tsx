...
const ACCENT = "#6366f1";
const MODULE = "Defense Procurement";
const PAGE = "ITAR";
const KPIS = [{"l":"Fornecedores Ativos","v":"2.810","t":"+17.8%","d":"up"},{"l":"Contratos (€M)","v":"€11.7M","t":"-4.1%","d":"down"},{"l":"On-Time Delivery (%)","v":"85.9%","t":"+14.2%","d":"up"},{"l":"Score Médio","v":"73","t":"+12.5%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","86.8%","€ 19122.51","3.947","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","90.1%","€ 36038.91","4.004","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","87.1%","€ 41518.63","1.354","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","95.5%","€ 27928.17","4.225","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","87.2%","€ 17928.30","4.688","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":338},{"label":"Fev","value":515},{"label":"Mar","value":457},{"label":"Abr","value":394},{"label":"Mai","value":296},{"label":"Jun","value":434},{"label":"Jul","value":494},{"label":"Ago","value":424},{"label":"Set","value":347},{"label":"Out","value":444},{"label":"Nov","value":446},{"label":"Dez","value":335}];
const MX = 515;
