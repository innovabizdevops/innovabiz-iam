...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.711","t":"-3.3%","d":"down"},{"l":"NC Abertas","v":"8.416","t":"+6.3%","d":"up"},{"l":"Conformidade (%)","v":"82.3%","t":"+6.6%","d":"up"},{"l":"CAPAs Pendentes","v":"1.803","t":"+8.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.444","77.0%","6.815","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.332","74.7%","7.489","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.124","86.1%","3.769","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.411","95.7%","3.969","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.185","88.4%","7.143","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":420},{"label":"Fev","value":614},{"label":"Mar","value":653},{"label":"Abr","value":624},{"label":"Mai","value":261},{"label":"Jun","value":281},{"label":"Jul","value":522},{"label":"Ago","value":387},{"label":"Set","value":456},{"label":"Out","value":634},{"label":"Nov","value":440},{"label":"Dez","value":501}];
const MX = 653;
