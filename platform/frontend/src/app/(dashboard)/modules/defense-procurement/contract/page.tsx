...
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"1.610","t":"+6.5%","d":"up"},{"l":"Valor Total (€M)","v":"€13.6M","t":"+1.0%","d":"up"},{"l":"Renovações Próx. 30d","v":"2.838","t":"+17.4%","d":"up"},{"l":"Obrigações Pendentes","v":"5.047","t":"+17.2%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 22443.40","2026-03-23","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 28520.40","2026-02-28","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 23672.05","2026-01-03","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 7309.91","2026-01-13","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 13264.61","2026-03-11","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":902},{"label":"Fev","value":682},{"label":"Mar","value":924},{"label":"Abr","value":553},{"label":"Mai","value":758},{"label":"Jun","value":852},{"label":"Jul","value":569},{"label":"Ago","value":928},{"label":"Set","value":600},{"label":"Out","value":753},{"label":"Nov","value":871},{"label":"Dez","value":635}];
const MX = 928;
