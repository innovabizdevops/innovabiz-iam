...
const PAGE = "RFP";
const KPIS = [{"l":"Fornecedores Ativos","v":"2.355","t":"+9.0%","d":"up"},{"l":"Contratos (€M)","v":"€12.0M","t":"+14.5%","d":"up"},{"l":"On-Time Delivery (%)","v":"92.2%","t":"-4.5%","d":"down"},{"l":"Score Médio","v":"85","t":"-2.7%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","98.5%","€ 14257.10","7.698","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","89.4%","€ 14416.28","6.206","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","70.4%","€ 30846.60","1.647","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","98.2%","€ 37980.99","8.754","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","72.8%","€ 28671.25","3.298","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":740},{"label":"Mar","value":935},{"label":"Abr","value":660},{"label":"Mai","value":748},{"label":"Jun","value":788},{"label":"Jul","value":787},{"label":"Ago","value":636},{"label":"Set","value":754},{"label":"Out","value":636},{"label":"Nov","value":744},{"label":"Dez","value":712}];
const MX = 935;
