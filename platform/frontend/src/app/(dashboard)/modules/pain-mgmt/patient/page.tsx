...
const PAGE = "Patient";
const KPIS = [{"l":"Total Pain Mgmt","v":"6.607","t":"+0.0%","d":"up"},{"l":"Patient Ativos","v":"6.620","t":"+10.5%","d":"up"},{"l":"Eficiência (%)","v":"68.5%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"76","t":"-1.4%","d":"down"}];
const COLS = ["ID","Patient","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pain Mgmt #001","Pain Mgmt #002","5.259","1.511","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Pain Mgmt #002","Pain Mgmt #003","1.234","4.450","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Pain Mgmt #003","Pain Mgmt #004","7.138","6.932","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Pain Mgmt #004","Pain Mgmt #005","8.921","8.452","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pain Mgmt #005","Pain Mgmt #001","2.863","1.010","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":572},{"label":"Mar","value":405},{"label":"Abr","value":754},{"label":"Mai","value":440},{"label":"Jun","value":517},{"label":"Jul","value":597},{"label":"Ago","value":450},{"label":"Set","value":591},{"label":"Out","value":669},{"label":"Nov","value":407},{"label":"Dez","value":665}];
const MX = 754;
