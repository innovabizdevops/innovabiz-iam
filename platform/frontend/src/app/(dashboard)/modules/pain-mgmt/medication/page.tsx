...
const KPIS = [{"l":"Integrações Ativas","v":"8.544","t":"+1.6%","d":"up"},{"l":"Chamadas/Hora","v":"1639","t":"+9.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"91.4%","t":"-5.9%","d":"down"},{"l":"Latência Média (ms)","v":"64ms","t":"-2.4%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","9.090","8.016","82.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.239","6.832","94.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.179","5.804","83.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.641","4.558","78.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.744","8.922","98.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":843},{"label":"Mar","value":522},{"label":"Abr","value":868},{"label":"Mai","value":782},{"label":"Jun","value":583},{"label":"Jul","value":642},{"label":"Ago","value":853},{"label":"Set","value":720},{"label":"Out","value":692},{"label":"Nov","value":807},{"label":"Dez","value":758}];
const MX = 868;
