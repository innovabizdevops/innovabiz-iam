...
const KPIS = [
    { label: "Total Registos", value: "2659", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3379", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€459K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "-17%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1309495359", cells: ["PAI-5359", "Pain Management Item 1", "12/4/2026", "€45 459"], status: "active" as const },
    { id: "1309498930", cells: ["PAI-8930", "Pain Management Item 2", "27/11/2026", "€49 030"], status: "pending" as const },
    { id: "1309502501", cells: ["PAI-3501", "Pain Management Item 3", "14/6/2026", "€2601"], status: "completed" as const },
    { id: "1309506072", cells: ["PAI-7072", "Pain Management Item 4", "1/1/2026", "€6172"], status: "warning" as const },
    { id: "1309509643", cells: ["PAI-1643", "Pain Management Item 5", "16/8/2026", "€9743"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pain Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pain Management</p>
                    </div>
                </div>
