...
const PAGE = "Outcome";
const KPIS = [{"l":"Total Pain Mgmt","v":"1.537","t":"+0.8%","d":"up"},{"l":"Outcome Ativos","v":"8.592","t":"+0.3%","d":"up"},{"l":"Eficiência (%)","v":"77.7%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"68","t":"+11.7%","d":"up"}];
const COLS = ["ID","Outcome","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pain Mgmt #001","Pain Mgmt #002","6.331","2.317","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Pain Mgmt #002","Pain Mgmt #003","7.291","3.918","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Pain Mgmt #003","Pain Mgmt #004","6.262","528","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Pain Mgmt #004","Pain Mgmt #005","7.191","7.386","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pain Mgmt #005","Pain Mgmt #001","131","1.831","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":655},{"label":"Mar","value":887},{"label":"Abr","value":816},{"label":"Mai","value":922},{"label":"Jun","value":783},{"label":"Jul","value":888},{"label":"Ago","value":663},{"label":"Set","value":783},{"label":"Out","value":887},{"label":"Nov","value":902},{"label":"Dez","value":606}];
const MX = 922;
