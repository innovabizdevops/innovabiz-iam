...
const PAGE = "Assess";
const KPIS = [{"l":"Total Pain Mgmt","v":"8.318","t":"+3.3%","d":"up"},{"l":"Assess Ativos","v":"3.629","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"79.8%","t":"+13.2%","d":"up"},{"l":"Score Performance","v":"86","t":"+11.0%","d":"up"}];
const COLS = ["ID","Assess","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pain Mgmt #001","Pain Mgmt #002","3.932","8.726","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Pain Mgmt #002","Pain Mgmt #003","6.288","2.809","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Pain Mgmt #003","Pain Mgmt #004","1.334","1.549","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Pain Mgmt #004","Pain Mgmt #005","3.167","5.799","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pain Mgmt #005","Pain Mgmt #001","7.096","7.808","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":808},{"label":"Fev","value":687},{"label":"Mar","value":732},{"label":"Abr","value":505},{"label":"Mai","value":646},{"label":"Jun","value":710},{"label":"Jul","value":704},{"label":"Ago","value":680},{"label":"Set","value":572},{"label":"Out","value":676},{"label":"Nov","value":767},{"label":"Dez","value":634}];
const MX = 808;
