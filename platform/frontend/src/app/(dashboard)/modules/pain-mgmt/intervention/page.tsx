...
const ACCENT = "#7c2d12";
const MODULE = "Pain Management";
const PAGE = "Intervention";
const KPIS = [{"l":"Total Pain Mgmt","v":"7.392","t":"+17.6%","d":"up"},{"l":"Intervention Ativos","v":"667","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"71.1%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"69","t":"-5.6%","d":"down"}];
const COLS = ["ID","Intervention","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pain Mgmt #001","Pain Mgmt #002","1.482","8.955","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Pain Mgmt #002","Pain Mgmt #003","8.895","288","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Pain Mgmt #003","Pain Mgmt #004","3.515","6.069","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Pain Mgmt #004","Pain Mgmt #005","7.409","2.324","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pain Mgmt #005","Pain Mgmt #001","2.335","727","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":981},{"label":"Fev","value":920},{"label":"Mar","value":715},{"label":"Abr","value":877},{"label":"Mai","value":955},{"label":"Jun","value":691},{"label":"Jul","value":628},{"label":"Ago","value":972},{"label":"Set","value":935},{"label":"Out","value":741},{"label":"Nov","value":904},{"label":"Dez","value":813}];
const MX = 981;
