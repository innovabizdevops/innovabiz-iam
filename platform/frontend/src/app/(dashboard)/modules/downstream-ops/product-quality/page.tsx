...
/* ═══ Downstream Ops — Product Quality ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "2481", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "92", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2330", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1684611528", cells: ["DOW-1528", "Product Quality Item 1", "13/1/2026", "€11 628"], status: "active" as const },
    { id: "1684615099", cells: ["DOW-5099", "Product Quality Item 2", "28/8/2026", "€15 199"], status: "pending" as const },
    { id: "1684618670", cells: ["DOW-8670", "Product Quality Item 3", "15/3/2026", "€18 770"], status: "completed" as const },
    { id: "1684622241", cells: ["DOW-3241", "Product Quality Item 4", "2/10/2026", "€22 341"], status: "warning" as const },
    { id: "1684625812", cells: ["DOW-6812", "Product Quality Item 5", "17/5/2026", "€25 912"], status: "active" as const },
];
...
export default function DownstreamOpsProductQualityPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Product Quality</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Downstream Ops • Product Quality</p>
                    </div>
                </div>
