...
/* ═══ Downstream Ops — Terminal Ops Og ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "314", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "344", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2205", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1585183620", cells: ["DOW-5620", "Terminal Ops Og Item 1", "21/1/2026", "€33 720"], status: "active" as const },
    { id: "1585187191", cells: ["DOW-9191", "Terminal Ops Og Item 2", "8/8/2026", "€37 291"], status: "pending" as const },
    { id: "1585190762", cells: ["DOW-3762", "Terminal Ops Og Item 3", "23/3/2026", "€40 862"], status: "completed" as const },
    { id: "1585194333", cells: ["DOW-7333", "Terminal Ops Og Item 4", "10/10/2026", "€44 433"], status: "warning" as const },
    { id: "1585197904", cells: ["DOW-1904", "Terminal Ops Og Item 5", "25/5/2026", "€48 004"], status: "active" as const },
];
...
export default function DownstreamOpsTerminalOpsOgPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Terminal Ops Og</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Downstream Ops • Terminal Ops Og</p>
                    </div>
                </div>
