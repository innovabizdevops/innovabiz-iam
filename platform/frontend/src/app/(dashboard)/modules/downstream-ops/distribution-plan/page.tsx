...
/* ═══ Downstream Ops — Distribution Plan ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "195", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "51", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2281", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "72%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "260207615", cells: ["DOW-9615", "Distribution Plan Item 1", "4/12/2026", "€7715"], status: "active" as const },
    { id: "260211186", cells: ["DOW-4186", "Distribution Plan Item 2", "19/7/2026", "€11 286"], status: "pending" as const },
    { id: "260214757", cells: ["DOW-7757", "Distribution Plan Item 3", "6/2/2026", "€14 857"], status: "completed" as const },
    { id: "260218328", cells: ["DOW-2328", "Distribution Plan Item 4", "21/9/2026", "€18 428"], status: "warning" as const },
    { id: "260221899", cells: ["DOW-5899", "Distribution Plan Item 5", "8/4/2026", "€21 999"], status: "active" as const },
];
...
export default function DownstreamOpsDistributionPlanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Distribution Plan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Downstream Ops • Distribution Plan</p>
                    </div>
                </div>
