...
/* ═══ Downstream Ops — Catalyst Mgmt ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "2263", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "486", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2719", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1976637378", cells: ["DOW-4378", "Catalyst Mgmt Item 1", "3/7/2026", "€37 478"], status: "active" as const },
    { id: "1976640949", cells: ["DOW-7949", "Catalyst Mgmt Item 2", "18/2/2026", "€41 049"], status: "pending" as const },
    { id: "1976644520", cells: ["DOW-2520", "Catalyst Mgmt Item 3", "5/9/2026", "€44 620"], status: "completed" as const },
    { id: "1976648091", cells: ["DOW-6091", "Catalyst Mgmt Item 4", "20/4/2026", "€48 191"], status: "warning" as const },
    { id: "1976651662", cells: ["DOW-9662", "Catalyst Mgmt Item 5", "7/11/2026", "€1762"], status: "active" as const },
];
...
export default function DownstreamOpsCatalystMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Catalyst Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Downstream Ops • Catalyst Mgmt</p>
                    </div>
                </div>
