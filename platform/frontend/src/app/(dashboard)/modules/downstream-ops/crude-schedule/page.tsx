...
/* ═══ Downstream Ops — Crude Schedule ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "2857", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "110", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1616", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1537821834", cells: ["DOW-1834", "Crude Schedule Item 1", "11/7/2026", "€21 934"], status: "active" as const },
    { id: "1537825405", cells: ["DOW-5405", "Crude Schedule Item 2", "26/2/2026", "€25 505"], status: "pending" as const },
    { id: "1537828976", cells: ["DOW-8976", "Crude Schedule Item 3", "13/9/2026", "€29 076"], status: "completed" as const },
    { id: "1537832547", cells: ["DOW-3547", "Crude Schedule Item 4", "28/4/2026", "€32 647"], status: "warning" as const },
    { id: "1537836118", cells: ["DOW-7118", "Crude Schedule Item 5", "15/11/2026", "€36 218"], status: "active" as const },
];
...
export default function DownstreamOpsCrudeSchedulePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Crude Schedule</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Downstream Ops • Crude Schedule</p>
                    </div>
                </div>
