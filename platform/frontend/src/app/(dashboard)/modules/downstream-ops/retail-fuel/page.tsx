...
/* ═══ Downstream Ops — Retail Fuel ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "3250", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "209", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "673", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1211636461", cells: ["DOW-3461", "Retail Fuel Item 1", "22/2/2026", "€36 561"], status: "active" as const },
    { id: "1211640032", cells: ["DOW-7032", "Retail Fuel Item 2", "9/9/2026", "€40 132"], status: "pending" as const },
    { id: "1211643603", cells: ["DOW-1603", "Retail Fuel Item 3", "24/4/2026", "€43 703"], status: "completed" as const },
    { id: "1211647174", cells: ["DOW-5174", "Retail Fuel Item 4", "11/11/2026", "€47 274"], status: "warning" as const },
    { id: "1211650745", cells: ["DOW-8745", "Retail Fuel Item 5", "26/6/2026", "€845"], status: "active" as const },
];
...
export default function DownstreamOpsRetailFuelPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Retail Fuel</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Downstream Ops • Retail Fuel</p>
                    </div>
                </div>
