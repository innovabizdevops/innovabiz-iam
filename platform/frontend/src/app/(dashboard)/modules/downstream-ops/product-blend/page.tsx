...
/* ═══ Downstream Ops — Product Blend ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "1256", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "170", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3416", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "97280166", cells: ["DOW-9166", "Product Blend Item 1", "19/7/2026", "€30 266"], status: "active" as const },
    { id: "97283737", cells: ["DOW-3737", "Product Blend Item 2", "6/2/2026", "€33 837"], status: "pending" as const },
    { id: "97287308", cells: ["DOW-7308", "Product Blend Item 3", "21/9/2026", "€37 408"], status: "completed" as const },
    { id: "97290879", cells: ["DOW-1879", "Product Blend Item 4", "8/4/2026", "€40 979"], status: "warning" as const },
    { id: "97294450", cells: ["DOW-5450", "Product Blend Item 5", "23/11/2026", "€44 550"], status: "active" as const },
];
...
export default function DownstreamOpsProductBlendPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Product Blend</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Downstream Ops • Product Blend</p>
                    </div>
                </div>
