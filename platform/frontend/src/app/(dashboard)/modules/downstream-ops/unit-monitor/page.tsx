...
/* ═══ Downstream Ops — Unit Monitor ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "794", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "328", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1905", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "364719556", cells: ["DOW-4556", "Unit Monitor Item 1", "13/5/2026", "€19 656"], status: "active" as const },
    { id: "364723127", cells: ["DOW-8127", "Unit Monitor Item 2", "28/12/2026", "€23 227"], status: "pending" as const },
    { id: "364726698", cells: ["DOW-2698", "Unit Monitor Item 3", "15/7/2026", "€26 798"], status: "completed" as const },
    { id: "364730269", cells: ["DOW-6269", "Unit Monitor Item 4", "2/2/2026", "€30 369"], status: "warning" as const },
    { id: "364733840", cells: ["DOW-9840", "Unit Monitor Item 5", "17/9/2026", "€33 940"], status: "active" as const },
];
...
export default function DownstreamOpsUnitMonitorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Unit Monitor</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Downstream Ops • Unit Monitor</p>
                    </div>
                </div>
