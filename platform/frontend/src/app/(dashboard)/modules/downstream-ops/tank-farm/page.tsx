...
/* ═══ Downstream Ops — Tank Farm ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "4866", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "206", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "823", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1444076442", cells: ["DOW-9442", "Tank Farm Item 1", "19/7/2026", "€26 542"], status: "active" as const },
    { id: "1444080013", cells: ["DOW-4013", "Tank Farm Item 2", "6/2/2026", "€30 113"], status: "pending" as const },
    { id: "1444083584", cells: ["DOW-7584", "Tank Farm Item 3", "21/9/2026", "€33 684"], status: "completed" as const },
    { id: "1444087155", cells: ["DOW-2155", "Tank Farm Item 4", "8/4/2026", "€37 255"], status: "warning" as const },
    { id: "1444090726", cells: ["DOW-5726", "Tank Farm Item 5", "23/11/2026", "€40 826"], status: "active" as const },
];
...
export default function DownstreamOpsTankFarmPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tank Farm</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Downstream Ops • Tank Farm</p>
                    </div>
                </div>
