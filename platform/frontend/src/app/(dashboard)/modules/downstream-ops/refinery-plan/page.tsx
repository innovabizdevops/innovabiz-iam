...
/* ═══ Downstream Ops — Refinery Plan ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "3465", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "53", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "481", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "358376433", cells: ["DOW-6433", "Refinery Plan Item 1", "10/10/2026", "€26 533"], status: "active" as const },
    { id: "358380004", cells: ["DOW-1004", "Refinery Plan Item 2", "25/5/2026", "€30 104"], status: "pending" as const },
    { id: "358383575", cells: ["DOW-4575", "Refinery Plan Item 3", "12/12/2026", "€33 675"], status: "completed" as const },
    { id: "358387146", cells: ["DOW-8146", "Refinery Plan Item 4", "27/7/2026", "€37 246"], status: "warning" as const },
    { id: "358390717", cells: ["DOW-2717", "Refinery Plan Item 5", "14/2/2026", "€40 817"], status: "active" as const },
];
...
export default function DownstreamOpsRefineryPlanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Refinery Plan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Downstream Ops • Refinery Plan</p>
                    </div>
                </div>
