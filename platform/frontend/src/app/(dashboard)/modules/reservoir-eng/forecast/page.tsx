...
const PAGE = "Forecast";
const KPIS = [{"l":"Total Reservoir Eng","v":"1.775","t":"-1.6%","d":"down"},{"l":"Forecast Ativos","v":"4.276","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"88.5%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"65","t":"+9.3%","d":"up"}];
const COLS = ["ID","Forecast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reservoir Eng #001","Reservoir Eng #002","4.109","7.453","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Reservoir Eng #002","Reservoir Eng #003","5.070","3.664","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Reservoir Eng #003","Reservoir Eng #004","5.348","4.550","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Reservoir Eng #004","Reservoir Eng #005","7.902","1.300","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reservoir Eng #005","Reservoir Eng #001","5.206","232","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":917},{"label":"Fev","value":617},{"label":"Mar","value":926},{"label":"Abr","value":678},{"label":"Mai","value":820},{"label":"Jun","value":882},{"label":"Jul","value":581},{"label":"Ago","value":554},{"label":"Set","value":726},{"label":"Out","value":716},{"label":"Nov","value":563},{"label":"Dez","value":583}];
const MX = 926;
