...
const KPIS = [{"l":"Atletas Registados","v":"7.290","t":"-0.5%","d":"down"},{"l":"Treinos/Semana","v":"1646","t":"-5.4%","d":"down"},{"l":"Competições","v":"3.045","t":"+15.6%","d":"up"},{"l":"Performance Score","v":"82","t":"+15.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.290","6.682","2.878","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","5.737","5.616","4.029","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.496","4.572","7.008","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","3.648","8.312","1.379","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.209","1.907","6.671","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":797},{"label":"Fev","value":660},{"label":"Mar","value":701},{"label":"Abr","value":805},{"label":"Mai","value":610},{"label":"Jun","value":816},{"label":"Jul","value":664},{"label":"Ago","value":726},{"label":"Set","value":744},{"label":"Out","value":611},{"label":"Nov","value":730},{"label":"Dez","value":823}];
const MX = 823;
