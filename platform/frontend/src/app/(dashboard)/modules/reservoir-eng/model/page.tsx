...
const ACCENT = "#6366f1";
const MODULE = "Reservoir Engineering";
const PAGE = "Modeling";
const KPIS = [{"l":"Total Reservoir Eng","v":"4.912","t":"+16.6%","d":"up"},{"l":"Modeling Ativos","v":"7.462","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"65.8%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"77","t":"+12.1%","d":"up"}];
const COLS = ["ID","Modeling","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reservoir Eng #001","Reservoir Eng #002","8.413","442","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Reservoir Eng #002","Reservoir Eng #003","6.199","6.703","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Reservoir Eng #003","Reservoir Eng #004","7.044","4.765","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Reservoir Eng #004","Reservoir Eng #005","7.841","4.573","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reservoir Eng #005","Reservoir Eng #001","5.931","973","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":333},{"label":"Fev","value":374},{"label":"Mar","value":350},{"label":"Abr","value":248},{"label":"Mai","value":577},{"label":"Jun","value":495},{"label":"Jul","value":613},{"label":"Ago","value":450},{"label":"Set","value":402},{"label":"Out","value":506},{"label":"Nov","value":391},{"label":"Dez","value":591}];
const MX = 613;
