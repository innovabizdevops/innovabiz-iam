...
export default function ReservoirEngPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Reservoir Eng</h1><p className="text-sm text-muted-foreground">Reservoir Eng • iBOS Enterprise</p></div>
