...
const KPIS = [{"l":"Twins Ativos","v":"4.076","t":"-5.8%","d":"down"},{"l":"Simulações/Dia","v":"3047","t":"-2.9%","d":"down"},{"l":"Precisão Modelo (%)","v":"80.0%","t":"-3.3%","d":"down"},{"l":"Latência Sync (ms)","v":"111ms","t":"+17.6%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","70.6%","2026-02-12","5.520","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","90.6%","2026-02-22","563","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","85.8%","2026-02-25","4.386","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","82.8%","2026-01-19","8.694","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","70.1%","2026-02-09","7.504","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":413},{"label":"Fev","value":385},{"label":"Mar","value":630},{"label":"Abr","value":583},{"label":"Mai","value":418},{"label":"Jun","value":357},{"label":"Jul","value":632},{"label":"Ago","value":488},{"label":"Set","value":639},{"label":"Out","value":689},{"label":"Nov","value":581},{"label":"Dez","value":432}];
const MX = 689;
