...
/* ═══ IT Portfolio Mgmt (COBIT APO05) — Dashboard ═══ */

const ACCENT = "#475569";

const KPIS = [
    { label: "Total Registos", value: "5001", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3511", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€305K", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "770601101", cells: ["IT-4101", "IT Portfolio Mgmt (COBIT APO05) Item 1", "26/6/2026", "€1201"], status: "active" as const },
    { id: "770604672", cells: ["IT-7672", "IT Portfolio Mgmt (COBIT APO05) Item 2", "13/1/2026", "€4772"], status: "pending" as const },
    { id: "770608243", cells: ["IT-2243", "IT Portfolio Mgmt (COBIT APO05) Item 3", "28/8/2026", "€8343"], status: "completed" as const },
    { id: "770611814", cells: ["IT-5814", "IT Portfolio Mgmt (COBIT APO05) Item 4", "15/3/2026", "€11 914"], status: "warning" as const },
    { id: "770615385", cells: ["IT-9385", "IT Portfolio Mgmt (COBIT APO05) Item 5", "2/10/2026", "€15 485"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 81 }, { label: "Fev", value: 90 }, { label: "Mar", value: 99 }, { label: "Abr", value: 28 }, { label: "Mai", value: 37 }, { label: "Jun", value: 46 }];
...
export default function ItPortfolioMgmtCobitApo05Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">IT Portfolio Mgmt (COBIT APO05)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • IT Portfolio Mgmt (COBIT APO05)</p>
                    </div>
                </div>
