...
export default function TradeComplyPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Trade Comply</h1><p className="text-sm text-muted-foreground">Trade Comply • iBOS Enterprise</p></div>
