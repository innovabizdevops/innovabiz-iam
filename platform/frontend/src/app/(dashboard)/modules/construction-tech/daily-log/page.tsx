...
/* ═══ Construction Tech — Daily Log ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "590", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "342", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2868", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1629823618", cells: ["CON-5618", "Daily Log Item 1", "11/11/2026", "€23 718"], status: "active" as const },
    { id: "1629827189", cells: ["CON-9189", "Daily Log Item 2", "26/6/2026", "€27 289"], status: "pending" as const },
    { id: "1629830760", cells: ["CON-3760", "Daily Log Item 3", "13/1/2026", "€30 860"], status: "completed" as const },
    { id: "1629834331", cells: ["CON-7331", "Daily Log Item 4", "28/8/2026", "€34 431"], status: "warning" as const },
    { id: "1629837902", cells: ["CON-1902", "Daily Log Item 5", "15/3/2026", "€38 002"], status: "active" as const },
];
...
export default function ConstructionTechDailyLogPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Daily Log</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Construction Tech • Daily Log</p>
                    </div>
                </div>
