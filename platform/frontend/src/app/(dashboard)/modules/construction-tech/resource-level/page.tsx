...
/* ═══ Construction Tech — Resource Level ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "4713", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "481", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2805", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "211478029", cells: ["CON-6029", "Resource Level Item 1", "22/2/2026", "€28 129"], status: "active" as const },
    { id: "211481600", cells: ["CON-9600", "Resource Level Item 2", "9/9/2026", "€31 700"], status: "pending" as const },
    { id: "211485171", cells: ["CON-4171", "Resource Level Item 3", "24/4/2026", "€35 271"], status: "completed" as const },
    { id: "211488742", cells: ["CON-7742", "Resource Level Item 4", "11/11/2026", "€38 842"], status: "warning" as const },
    { id: "211492313", cells: ["CON-2313", "Resource Level Item 5", "26/6/2026", "€42 413"], status: "active" as const },
];
...
export default function ConstructionTechResourceLevelPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Resource Level</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Construction Tech • Resource Level</p>
                    </div>
                </div>
