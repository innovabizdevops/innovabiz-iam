...
/* ═══ Construction Tech — Cost Control Const ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "1213", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "44", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "380", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "77%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1128431800", cells: ["CON-3800", "Cost Control Const Item 1", "21/5/2026", "€31 900"], status: "active" as const },
    { id: "1128435371", cells: ["CON-7371", "Cost Control Const Item 2", "8/12/2026", "€35 471"], status: "pending" as const },
    { id: "1128438942", cells: ["CON-1942", "Cost Control Const Item 3", "23/7/2026", "€39 042"], status: "completed" as const },
    { id: "1128442513", cells: ["CON-5513", "Cost Control Const Item 4", "10/2/2026", "€42 613"], status: "warning" as const },
    { id: "1128446084", cells: ["CON-9084", "Cost Control Const Item 5", "25/9/2026", "€46 184"], status: "active" as const },
];
...
export default function ConstructionTechCostControlConstPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cost Control Const</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Construction Tech • Cost Control Const</p>
                    </div>
                </div>
