...
/* ═══ Construction Tech — Submittal Track ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "3194", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "61", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1040", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1483260297", cells: ["CON-7297", "Submittal Track Item 1", "2/10/2026", "€10 397"], status: "active" as const },
    { id: "1483263868", cells: ["CON-1868", "Submittal Track Item 2", "17/5/2026", "€13 968"], status: "pending" as const },
    { id: "1483267439", cells: ["CON-5439", "Submittal Track Item 3", "4/12/2026", "€17 539"], status: "completed" as const },
    { id: "1483271010", cells: ["CON-9010", "Submittal Track Item 4", "19/7/2026", "€21 110"], status: "warning" as const },
    { id: "1483274581", cells: ["CON-3581", "Submittal Track Item 5", "6/2/2026", "€24 681"], status: "active" as const },
];
...
export default function ConstructionTechSubmittalTrackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Submittal Track</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Construction Tech • Submittal Track</p>
                    </div>
                </div>
