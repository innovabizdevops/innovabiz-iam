...
/* ═══ Construction Tech — Punch List ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "3110", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "265", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2969", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "627803349", cells: ["CON-9349", "Punch List Item 1", "6/10/2026", "€3449"], status: "active" as const },
    { id: "627806920", cells: ["CON-3920", "Punch List Item 2", "21/5/2026", "€7020"], status: "pending" as const },
    { id: "627810491", cells: ["CON-7491", "Punch List Item 3", "8/12/2026", "€10 591"], status: "completed" as const },
    { id: "627814062", cells: ["CON-2062", "Punch List Item 4", "23/7/2026", "€14 162"], status: "warning" as const },
    { id: "627817633", cells: ["CON-5633", "Punch List Item 5", "10/2/2026", "€17 733"], status: "active" as const },
];
...
export default function ConstructionTechPunchListPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Punch List</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Construction Tech • Punch List</p>
                    </div>
                </div>
