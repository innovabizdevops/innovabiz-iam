...
/* ═══ Construction Tech — Rfi Mgmt ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "2204", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "141", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3217", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "276930841", cells: ["CON-1841", "Rfi Mgmt Item 1", "6/2/2026", "€30 941"], status: "active" as const },
    { id: "276934412", cells: ["CON-5412", "Rfi Mgmt Item 2", "21/9/2026", "€34 512"], status: "pending" as const },
    { id: "276937983", cells: ["CON-8983", "Rfi Mgmt Item 3", "8/4/2026", "€38 083"], status: "completed" as const },
    { id: "276941554", cells: ["CON-3554", "Rfi Mgmt Item 4", "23/11/2026", "€41 654"], status: "warning" as const },
    { id: "276945125", cells: ["CON-7125", "Rfi Mgmt Item 5", "10/6/2026", "€45 225"], status: "active" as const },
];
...
export default function ConstructionTechRfiMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Rfi Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Construction Tech • Rfi Mgmt</p>
                    </div>
                </div>
