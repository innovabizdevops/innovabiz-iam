...
/* ═══ Construction Tech — Drone Survey Const ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "2122", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "260", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "268", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "79%", trend: "-5%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1526031072", cells: ["CON-1072", "Drone Survey Const Item 1", "21/1/2026", "€31 172"], status: "active" as const },
    { id: "1526034643", cells: ["CON-4643", "Drone Survey Const Item 2", "8/8/2026", "€34 743"], status: "pending" as const },
    { id: "1526038214", cells: ["CON-8214", "Drone Survey Const Item 3", "23/3/2026", "€38 314"], status: "completed" as const },
    { id: "1526041785", cells: ["CON-2785", "Drone Survey Const Item 4", "10/10/2026", "€41 885"], status: "warning" as const },
    { id: "1526045356", cells: ["CON-6356", "Drone Survey Const Item 5", "25/5/2026", "€45 456"], status: "active" as const },
];
...
export default function ConstructionTechDroneSurveyConstPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Drone Survey Const</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Construction Tech • Drone Survey Const</p>
                    </div>
                </div>
