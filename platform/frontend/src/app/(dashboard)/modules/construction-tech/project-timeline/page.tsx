...
/* ═══ Construction Tech — Project Timeline ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "4845", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "327", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1195", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "96%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "552467459", cells: ["CON-3459", "Project Timeline Item 1", "20/12/2026", "€17 559"], status: "active" as const },
    { id: "552471030", cells: ["CON-7030", "Project Timeline Item 2", "7/7/2026", "€21 130"], status: "pending" as const },
    { id: "552474601", cells: ["CON-1601", "Project Timeline Item 3", "22/2/2026", "€24 701"], status: "completed" as const },
    { id: "552478172", cells: ["CON-5172", "Project Timeline Item 4", "9/9/2026", "€28 272"], status: "warning" as const },
    { id: "552481743", cells: ["CON-8743", "Project Timeline Item 5", "24/4/2026", "€31 843"], status: "active" as const },
];
...
export default function ConstructionTechProjectTimelinePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Project Timeline</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Construction Tech • Project Timeline</p>
                    </div>
                </div>
