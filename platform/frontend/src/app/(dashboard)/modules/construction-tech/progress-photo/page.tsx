...
/* ═══ Construction Tech — Progress Photo ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "4140", trend: "-19%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "170", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2174", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "85%", trend: "-1%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1641532518", cells: ["CON-5518", "Progress Photo Item 1", "11/7/2026", "€32 618"], status: "active" as const },
    { id: "1641536089", cells: ["CON-9089", "Progress Photo Item 2", "26/2/2026", "€36 189"], status: "pending" as const },
    { id: "1641539660", cells: ["CON-3660", "Progress Photo Item 3", "13/9/2026", "€39 760"], status: "completed" as const },
    { id: "1641543231", cells: ["CON-7231", "Progress Photo Item 4", "28/4/2026", "€43 331"], status: "warning" as const },
    { id: "1641546802", cells: ["CON-1802", "Progress Photo Item 5", "15/11/2026", "€46 902"], status: "active" as const },
];
...
export default function ConstructionTechProgressPhotoPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Progress Photo</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Construction Tech • Progress Photo</p>
                    </div>
                </div>
