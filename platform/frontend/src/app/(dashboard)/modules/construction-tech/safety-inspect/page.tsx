...
/* ═══ Construction Tech — Safety Inspect ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "2474", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "227", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "269", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1489704991", cells: ["CON-7991", "Safety Inspect Item 1", "20/8/2026", "€5091"], status: "active" as const },
    { id: "1489708562", cells: ["CON-2562", "Safety Inspect Item 2", "7/3/2026", "€8662"], status: "pending" as const },
    { id: "1489712133", cells: ["CON-6133", "Safety Inspect Item 3", "22/10/2026", "€12 233"], status: "completed" as const },
    { id: "1489715704", cells: ["CON-9704", "Safety Inspect Item 4", "9/5/2026", "€15 804"], status: "warning" as const },
    { id: "1489719275", cells: ["CON-4275", "Safety Inspect Item 5", "24/12/2026", "€19 375"], status: "active" as const },
];
...
export default function ConstructionTechSafetyInspectPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Safety Inspect</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Construction Tech • Safety Inspect</p>
                    </div>
                </div>
