...
const PAGE = "War Risk";
const KPIS = [{"l":"Riscos Identificados","v":"2.080","t":"+1.7%","d":"up"},{"l":"Mitigações Ativas","v":"519","t":"-4.7%","d":"down"},{"l":"Score Risco Geral","v":"82","t":"+3.3%","d":"up"},{"l":"Incidentes YTD","v":"7.191","t":"-3.6%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.180","4.564","1.129","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.878","591","3.794","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.385","149","8.949","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.360","2.584","322","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.068","595","5.895","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":336},{"label":"Fev","value":415},{"label":"Mar","value":633},{"label":"Abr","value":447},{"label":"Mai","value":566},{"label":"Jun","value":722},{"label":"Jul","value":604},{"label":"Ago","value":648},{"label":"Set","value":639},{"label":"Out","value":603},{"label":"Nov","value":729},{"label":"Dez","value":692}];
const MX = 729;
