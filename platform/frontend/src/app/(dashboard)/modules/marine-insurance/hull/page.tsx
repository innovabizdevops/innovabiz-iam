...
const ACCENT = "#6366f1";
const MODULE = "Marine Insurance";
const PAGE = "Hull";
const KPIS = [{"l":"Total Marine Insurance","v":"5.821","t":"-3.8%","d":"down"},{"l":"Hull Ativos","v":"2.038","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"94.6%","t":"+4.7%","d":"up"},{"l":"Score Performance","v":"95","t":"+4.3%","d":"up"}];
const COLS = ["ID","Hull","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marine Insurance #001","Marine Insurance #002","7.832","8.602","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Marine Insurance #002","Marine Insurance #003","1.410","3.641","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Marine Insurance #003","Marine Insurance #004","2.194","8.602","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Marine Insurance #004","Marine Insurance #005","4.468","6.811","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marine Insurance #005","Marine Insurance #001","8.587","427","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":621},{"label":"Mar","value":615},{"label":"Abr","value":576},{"label":"Mai","value":823},{"label":"Jun","value":903},{"label":"Jul","value":868},{"label":"Ago","value":761},{"label":"Set","value":833},{"label":"Out","value":575},{"label":"Nov","value":925},{"label":"Dez","value":925}];
const MX = 925;
