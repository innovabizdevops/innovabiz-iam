...
export default function BusinessAviationPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Business Aviation</h1><p className="text-sm text-muted-foreground">Business Aviation • iBOS Enterprise</p></div>
