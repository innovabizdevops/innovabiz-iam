...
const PAGE = "Concierge";
const KPIS = [{"l":"Quartos Ocupados","v":"2.433","t":"-3.5%","d":"down"},{"l":"RevPAR (€)","v":"€74015","t":"+13.9%","d":"up"},{"l":"Ocupação (%)","v":"79.3%","t":"-3.6%","d":"down"},{"l":"Guest Satisfaction","v":"8.800","t":"+1.0%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.279","2026-01-02","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.159","2026-01-27","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.903","2026-01-02","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.221","2026-03-04","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.994","2026-01-15","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":712},{"label":"Fev","value":685},{"label":"Mar","value":456},{"label":"Abr","value":533},{"label":"Mai","value":723},{"label":"Jun","value":480},{"label":"Jul","value":579},{"label":"Ago","value":572},{"label":"Set","value":684},{"label":"Out","value":719},{"label":"Nov","value":670},{"label":"Dez","value":415}];
const MX = 723;
