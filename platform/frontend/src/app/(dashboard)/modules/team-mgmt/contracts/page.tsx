...
const ACCENT = "#059669";
const MODULE = "Team Management";
const PAGE = "Contract Mgmt";
const KPIS = [{"l":"Contratos Ativos","v":"1.649","t":"+7.1%","d":"up"},{"l":"Valor Total (€M)","v":"€21.7M","t":"-4.9%","d":"down"},{"l":"Renovações Próx. 30d","v":"3.396","t":"+8.7%","d":"up"},{"l":"Obrigações Pendentes","v":"1.217","t":"+15.2%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 39971.07","2026-01-17","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 49756.10","2026-02-01","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 43638.52","2026-03-28","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 25153.66","2026-03-05","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 40052.23","2026-01-28","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":911},{"label":"Mar","value":775},{"label":"Abr","value":826},{"label":"Mai","value":715},{"label":"Jun","value":682},{"label":"Jul","value":794},{"label":"Ago","value":733},{"label":"Set","value":741},{"label":"Out","value":970},{"label":"Nov","value":642},{"label":"Dez","value":822}];
const MX = 970;
