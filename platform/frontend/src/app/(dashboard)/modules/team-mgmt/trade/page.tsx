...
const PAGE = "Trade Sim";
const KPIS = [{"l":"Teams Ativos","v":"7.432","t":"+16.6%","d":"up"},{"l":"Reuniões/Semana","v":"486","t":"+17.2%","d":"up"},{"l":"Mensagens/Dia","v":"2451","t":"+10.3%","d":"up"},{"l":"Ficheiros Partilhados","v":"8.919","t":"-5.7%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.798","2890","7.004","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","8.605","122","3.073","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","805","4563","6.770","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.456","3249","3.317","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.876","2998","8.612","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":795},{"label":"Fev","value":923},{"label":"Mar","value":704},{"label":"Abr","value":834},{"label":"Mai","value":868},{"label":"Jun","value":733},{"label":"Jul","value":924},{"label":"Ago","value":684},{"label":"Set","value":747},{"label":"Out","value":628},{"label":"Nov","value":701},{"label":"Dez","value":626}];
const MX = 924;
