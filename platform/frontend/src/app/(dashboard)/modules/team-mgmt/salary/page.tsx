...
const KPIS = [{"l":"Teams Ativos","v":"6.385","t":"+0.7%","d":"up"},{"l":"Reuniões/Semana","v":"4446","t":"+17.5%","d":"up"},{"l":"Mensagens/Dia","v":"3674","t":"+0.5%","d":"up"},{"l":"Ficheiros Partilhados","v":"8.100","t":"+1.7%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","6.191","126","6.402","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","4.548","463","8.167","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","5.715","4549","4.110","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","3.829","4524","2.554","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.605","520","5.429","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":938},{"label":"Mar","value":894},{"label":"Abr","value":746},{"label":"Mai","value":965},{"label":"Jun","value":628},{"label":"Jul","value":781},{"label":"Ago","value":946},{"label":"Set","value":907},{"label":"Out","value":927},{"label":"Nov","value":877},{"label":"Dez","value":635}];
const MX = 965;
