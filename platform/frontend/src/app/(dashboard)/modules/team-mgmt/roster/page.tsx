...
const PAGE = "Roster Mgmt";
const KPIS = [{"l":"Teams Ativos","v":"6.578","t":"+0.7%","d":"up"},{"l":"Reuniões/Semana","v":"3916","t":"+10.0%","d":"up"},{"l":"Mensagens/Dia","v":"259","t":"-3.6%","d":"down"},{"l":"Ficheiros Partilhados","v":"5.397","t":"+13.3%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.738","408","5.477","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","4.999","3726","6.402","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","7.285","4326","4.274","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.692","216","7.690","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.990","3104","8.115","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":879},{"label":"Fev","value":877},{"label":"Mar","value":680},{"label":"Abr","value":791},{"label":"Mai","value":846},{"label":"Jun","value":651},{"label":"Jul","value":657},{"label":"Ago","value":646},{"label":"Set","value":812},{"label":"Out","value":708},{"label":"Nov","value":941},{"label":"Dez","value":976}];
const MX = 976;
