...
const PAGE = "Draft Board";
const KPIS = [{"l":"Teams Ativos","v":"1.135","t":"+15.1%","d":"up"},{"l":"Reuniões/Semana","v":"2117","t":"+5.7%","d":"up"},{"l":"Mensagens/Dia","v":"2545","t":"+11.9%","d":"up"},{"l":"Ficheiros Partilhados","v":"5.013","t":"+17.9%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","263","1504","3.023","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.726","1749","5.122","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","4.880","3299","8.696","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","602","1316","632","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","7.898","4095","2.682","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":830},{"label":"Mar","value":733},{"label":"Abr","value":836},{"label":"Mai","value":551},{"label":"Jun","value":794},{"label":"Jul","value":914},{"label":"Ago","value":610},{"label":"Set","value":670},{"label":"Out","value":575},{"label":"Nov","value":691},{"label":"Dez","value":891}];
const MX = 914;
