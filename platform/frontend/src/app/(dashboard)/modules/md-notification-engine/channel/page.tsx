...
const PAGE = "Channel";
const KPIS = [{"l":"Notificações Enviadas","v":"7.050","t":"+7.3%","d":"up"},{"l":"Taxa Entrega (%)","v":"79.1%","t":"+10.3%","d":"up"},{"l":"Taxa Abertura (%)","v":"89.9%","t":"+1.2%","d":"up"},{"l":"Escalações","v":"1.308","t":"+2.6%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","6.339","86.2%","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","2.812","73.2%","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","2.494","77.0%","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","3.749","81.6%","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","294","79.6%","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":722},{"label":"Mar","value":761},{"label":"Abr","value":724},{"label":"Mai","value":846},{"label":"Jun","value":721},{"label":"Jul","value":794},{"label":"Ago","value":686},{"label":"Set","value":748},{"label":"Out","value":634},{"label":"Nov","value":818},{"label":"Dez","value":789}];
const MX = 846;
