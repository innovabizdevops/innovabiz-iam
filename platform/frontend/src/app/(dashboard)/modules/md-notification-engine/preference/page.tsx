...
const KPIS = [{"l":"Notificações Enviadas","v":"7.714","t":"+12.1%","d":"up"},{"l":"Taxa Entrega (%)","v":"81.7%","t":"+3.2%","d":"up"},{"l":"Taxa Abertura (%)","v":"91.5%","t":"+9.7%","d":"up"},{"l":"Escalações","v":"4.241","t":"-0.2%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","5.412","99.2%","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","232","73.9%","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","5.583","79.8%","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","6.207","83.1%","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","2.097","84.1%","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":486},{"label":"Fev","value":595},{"label":"Mar","value":292},{"label":"Abr","value":243},{"label":"Mai","value":405},{"label":"Jun","value":315},{"label":"Jul","value":457},{"label":"Ago","value":569},{"label":"Set","value":251},{"label":"Out","value":239},{"label":"Nov","value":341},{"label":"Dez","value":347}];
const MX = 595;
