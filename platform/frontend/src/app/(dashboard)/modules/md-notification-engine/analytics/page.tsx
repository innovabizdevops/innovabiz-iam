...
const ACCENT = "#7c2d12";
const MODULE = "MD: Multi-Notification Engine";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"3.438","t":"-1.7%","d":"down"},{"l":"Queries/Dia","v":"2617","t":"-4.1%","d":"down"},{"l":"Dados Processados (GB)","v":"6.693","t":"+3.3%","d":"up"},{"l":"Utilizadores Analytics","v":"8.623","t":"-2.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1878","2026-02-18","1.009","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","324","2026-03-17","8.767","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3724","2026-03-03","2.407","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4388","2026-01-26","5.869","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3692","2026-02-27","1.064","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":257},{"label":"Fev","value":529},{"label":"Mar","value":218},{"label":"Abr","value":430},{"label":"Mai","value":427},{"label":"Jun","value":554},{"label":"Jul","value":610},{"label":"Ago","value":469},{"label":"Set","value":237},{"label":"Out","value":307},{"label":"Nov","value":218},{"label":"Dez","value":303}];
const MX = 610;
