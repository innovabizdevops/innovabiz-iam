...
/* ═══ MD: Multi-Notification Engine — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "3087", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1444", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€164K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "356244587", cells: ["MD-7587", "MD: Multi-Notification Engine Item 1", "28/12/2026", "€44 687"], status: "active" as const },
    { id: "356248158", cells: ["MD-2158", "MD: Multi-Notification Engine Item 2", "15/7/2026", "€48 258"], status: "pending" as const },
    { id: "356251729", cells: ["MD-5729", "MD: Multi-Notification Engine Item 3", "2/2/2026", "€1829"], status: "completed" as const },
    { id: "356255300", cells: ["MD-9300", "MD: Multi-Notification Engine Item 4", "17/9/2026", "€5400"], status: "warning" as const },
    { id: "356258871", cells: ["MD-3871", "MD: Multi-Notification Engine Item 5", "4/4/2026", "€8971"], status: "active" as const },
];
...
export default function MdMultinotificationEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Notification Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Notification Engine</p>
                    </div>
                </div>
