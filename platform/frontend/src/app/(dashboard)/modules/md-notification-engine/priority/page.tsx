...
const PAGE = "Priority";
const KPIS = [{"l":"Notificações Enviadas","v":"7.331","t":"+11.5%","d":"up"},{"l":"Taxa Entrega (%)","v":"67.3%","t":"+8.4%","d":"up"},{"l":"Taxa Abertura (%)","v":"93.6%","t":"+2.5%","d":"up"},{"l":"Escalações","v":"279","t":"+4.6%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","1.686","87.7%","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","8.522","96.8%","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","9.075","95.8%","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","219","71.0%","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","7.630","82.6%","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":437},{"label":"Fev","value":569},{"label":"Mar","value":213},{"label":"Abr","value":402},{"label":"Mai","value":296},{"label":"Jun","value":405},{"label":"Jul","value":503},{"label":"Ago","value":542},{"label":"Set","value":525},{"label":"Out","value":403},{"label":"Nov","value":435},{"label":"Dez","value":458}];
const MX = 569;
