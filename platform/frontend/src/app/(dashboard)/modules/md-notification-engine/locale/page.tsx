...
const PAGE = "Locale";
const KPIS = [{"l":"Notificações Enviadas","v":"6.512","t":"-5.3%","d":"down"},{"l":"Taxa Entrega (%)","v":"88.2%","t":"-2.9%","d":"down"},{"l":"Taxa Abertura (%)","v":"75.1%","t":"+16.4%","d":"up"},{"l":"Escalações","v":"2.567","t":"-0.7%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","8.430","96.6%","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","5.184","71.2%","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","641","77.8%","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","4.567","99.9%","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","803","94.7%","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":580},{"label":"Mar","value":695},{"label":"Abr","value":550},{"label":"Mai","value":727},{"label":"Jun","value":455},{"label":"Jul","value":786},{"label":"Ago","value":784},{"label":"Set","value":618},{"label":"Out","value":708},{"label":"Nov","value":477},{"label":"Dez","value":546}];
const MX = 786;
