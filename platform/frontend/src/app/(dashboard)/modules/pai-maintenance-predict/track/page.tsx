...
const PAGE = "Track";
const KPIS = [{"l":"Integrações Ativas","v":"6.007","t":"-1.9%","d":"down"},{"l":"Chamadas/Hora","v":"2362","t":"+5.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"83.8%","t":"+7.1%","d":"up"},{"l":"Latência Média (ms)","v":"178ms","t":"+8.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.247","303","74.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.923","4.720","93.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.464","6.293","70.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.933","4.618","72.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.786","3.178","87.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":508},{"label":"Mar","value":618},{"label":"Abr","value":655},{"label":"Mai","value":810},{"label":"Jun","value":743},{"label":"Jul","value":665},{"label":"Ago","value":661},{"label":"Set","value":588},{"label":"Out","value":750},{"label":"Nov","value":490},{"label":"Dez","value":521}];
const MX = 810;
