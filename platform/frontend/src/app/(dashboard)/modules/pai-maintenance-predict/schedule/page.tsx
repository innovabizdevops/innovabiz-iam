...
const PAGE = "Schedule";
const KPIS = [{"l":"Integrações Ativas","v":"7.265","t":"+11.2%","d":"up"},{"l":"Chamadas/Hora","v":"4509","t":"+2.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.8%","t":"+3.4%","d":"up"},{"l":"Latência Média (ms)","v":"10ms","t":"+0.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.387","1.642","75.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.833","7.513","85.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.857","2.181","72.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.007","7.647","79.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.155","3.615","75.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":692},{"label":"Mar","value":824},{"label":"Abr","value":663},{"label":"Mai","value":469},{"label":"Jun","value":743},{"label":"Jul","value":549},{"label":"Ago","value":786},{"label":"Set","value":706},{"label":"Out","value":765},{"label":"Nov","value":509},{"label":"Dez","value":544}];
const MX = 824;
