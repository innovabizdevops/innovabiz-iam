...
/* ═══ P-AI Predictive Maintenance — Dashboard ═══ */

const ACCENT = "#0c4a6e";

const KPIS = [
    { label: "Total Registos", value: "1357", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2765", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€480K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "-15%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "879893457", cells: ["PAI-9457", "P-AI Predictive Maintenance Item 1", "10/10/2026", "€43 557"], status: "active" as const },
    { id: "879897028", cells: ["PAI-4028", "P-AI Predictive Maintenance Item 2", "25/5/2026", "€47 128"], status: "pending" as const },
    { id: "879900599", cells: ["PAI-7599", "P-AI Predictive Maintenance Item 3", "12/12/2026", "€699"], status: "completed" as const },
    { id: "879904170", cells: ["PAI-2170", "P-AI Predictive Maintenance Item 4", "27/7/2026", "€4270"], status: "warning" as const },
    { id: "879907741", cells: ["PAI-5741", "P-AI Predictive Maintenance Item 5", "14/2/2026", "€7841"], status: "active" as const },
];
...
export default function PaiPredictiveMaintenancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">P-AI Predictive Maintenance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • P-AI Predictive Maintenance</p>
                    </div>
                </div>
