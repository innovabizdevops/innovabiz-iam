...
const PAGE = "Predict";
const KPIS = [{"l":"Integrações Ativas","v":"7.535","t":"+12.6%","d":"up"},{"l":"Chamadas/Hora","v":"3007","t":"+5.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"82.3%","t":"+5.0%","d":"up"},{"l":"Latência Média (ms)","v":"14ms","t":"+3.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","530","4.250","86.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.644","5.300","92.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","160","3.317","81.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.531","379","91.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.684","3.408","73.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1001},{"label":"Fev","value":732},{"label":"Mar","value":970},{"label":"Abr","value":939},{"label":"Mai","value":724},{"label":"Jun","value":1006},{"label":"Jul","value":809},{"label":"Ago","value":681},{"label":"Set","value":1013},{"label":"Out","value":1064},{"label":"Nov","value":731},{"label":"Dez","value":803}];
const MX = 1064;
