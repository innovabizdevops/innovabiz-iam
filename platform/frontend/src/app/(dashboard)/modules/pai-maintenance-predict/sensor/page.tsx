...
const PAGE = "Sensor";
const KPIS = [{"l":"Dispositivos Online","v":"6.127","t":"+3.5%","d":"up"},{"l":"Dados/Min (MB)","v":"7.186","t":"+1.5%","d":"up"},{"l":"Alertas Ativos","v":"1.122","t":"+10.8%","d":"up"},{"l":"Uptime (%)","v":"80.5%","t":"-0.3%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.490","3.905","3.591","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","324","425","8.006","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.183","7.292","5.392","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.902","5.071","2.154","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","1.113","4.491","1.800","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":324},{"label":"Mar","value":421},{"label":"Abr","value":507},{"label":"Mai","value":375},{"label":"Jun","value":614},{"label":"Jul","value":471},{"label":"Ago","value":597},{"label":"Set","value":428},{"label":"Out","value":525},{"label":"Nov","value":552},{"label":"Dez","value":546}];
const MX = 614;
