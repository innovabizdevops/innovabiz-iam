...
const ACCENT = "#0c4a6e";
const MODULE = "P-AI Predictive Maintenance";
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"3.287","t":"-5.9%","d":"down"},{"l":"Queries/Dia","v":"4439","t":"-0.4%","d":"down"},{"l":"Dados Processados (GB)","v":"4.948","t":"+5.1%","d":"up"},{"l":"Utilizadores Analytics","v":"5.652","t":"+13.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4387","2026-03-28","7.580","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","469","2026-02-11","1.183","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2900","2026-01-09","2.021","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2981","2026-03-27","5.755","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2022","2026-01-08","8.620","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":850},{"label":"Mar","value":571},{"label":"Abr","value":937},{"label":"Mai","value":920},{"label":"Jun","value":953},{"label":"Jul","value":635},{"label":"Ago","value":784},{"label":"Set","value":852},{"label":"Out","value":703},{"label":"Nov","value":962},{"label":"Dez","value":798}];
const MX = 962;
