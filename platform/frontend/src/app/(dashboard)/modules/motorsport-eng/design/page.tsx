...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"6.789","t":"+4.9%","d":"up"},{"l":"Submissões/Dia","v":"1055","t":"+10.9%","d":"up"},{"l":"Documentos Gerados","v":"4.459","t":"-2.8%","d":"down"},{"l":"Templates","v":"3.859","t":"+5.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.273","2026-02-18","7.235","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.659","2026-03-26","7.209","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.011","2026-03-17","8.733","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","874","2026-01-05","8.661","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.049","2026-02-17","1.575","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":672},{"label":"Fev","value":922},{"label":"Mar","value":681},{"label":"Abr","value":736},{"label":"Mai","value":964},{"label":"Jun","value":704},{"label":"Jul","value":798},{"label":"Ago","value":626},{"label":"Set","value":940},{"label":"Out","value":748},{"label":"Nov","value":717},{"label":"Dez","value":925}];
const MX = 964;
