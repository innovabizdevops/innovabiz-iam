...
export default function MotorsportEngPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Motorsport Eng</h1><p className="text-sm text-muted-foreground">Motorsport Eng • iBOS Enterprise</p></div>
