...
const PAGE = "Pit";
const KPIS = [{"l":"Atletas Registados","v":"4.362","t":"+8.6%","d":"up"},{"l":"Treinos/Semana","v":"3316","t":"+17.4%","d":"up"},{"l":"Competições","v":"6.860","t":"-3.6%","d":"down"},{"l":"Performance Score","v":"79","t":"+6.8%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","422","4.400","1.006","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.826","3.460","9.056","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.666","8.255","8.555","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.797","6.837","5.107","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.931","2.622","1.826","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":672},{"label":"Mar","value":402},{"label":"Abr","value":743},{"label":"Mai","value":654},{"label":"Jun","value":619},{"label":"Jul","value":754},{"label":"Ago","value":736},{"label":"Set","value":730},{"label":"Out","value":401},{"label":"Nov","value":501},{"label":"Dez","value":628}];
const MX = 754;
