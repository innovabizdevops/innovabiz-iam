...
const KPIS = [{"l":"Dashboards Ativos","v":"9.033","t":"+3.2%","d":"up"},{"l":"Queries/Dia","v":"4330","t":"+9.1%","d":"up"},{"l":"Dados Processados (GB)","v":"5.258","t":"+0.6%","d":"up"},{"l":"Utilizadores Analytics","v":"2.829","t":"+13.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1806","2026-03-15","6.954","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1153","2026-03-06","4.924","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4141","2026-02-28","6.324","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1653","2026-03-05","876","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1245","2026-03-13","7.609","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":782},{"label":"Mar","value":618},{"label":"Abr","value":519},{"label":"Mai","value":446},{"label":"Jun","value":499},{"label":"Jul","value":641},{"label":"Ago","value":442},{"label":"Set","value":702},{"label":"Out","value":433},{"label":"Nov","value":466},{"label":"Dez","value":557}];
const MX = 782;
