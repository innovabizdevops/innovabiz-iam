...
const PAGE = "Strategy";
const KPIS = [{"l":"Atletas Registados","v":"5.882","t":"+7.5%","d":"up"},{"l":"Treinos/Semana","v":"209","t":"-4.4%","d":"down"},{"l":"Competições","v":"6.166","t":"-0.5%","d":"down"},{"l":"Performance Score","v":"62","t":"+3.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","978","6.805","6.589","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.845","8.721","8.514","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.338","4.146","3.958","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.642","8.924","1.781","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.219","6.091","3.252","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":837},{"label":"Fev","value":933},{"label":"Mar","value":762},{"label":"Abr","value":877},{"label":"Mai","value":935},{"label":"Jun","value":862},{"label":"Jul","value":715},{"label":"Ago","value":883},{"label":"Set","value":934},{"label":"Out","value":693},{"label":"Nov","value":651},{"label":"Dez","value":622}];
const MX = 935;
