...
const ACCENT = "#6366f1";
const MODULE = "Motorsport Engineering";
const PAGE = "Telemetry";
const KPIS = [{"l":"Atletas Registados","v":"2.339","t":"-0.9%","d":"down"},{"l":"Treinos/Semana","v":"378","t":"+11.1%","d":"up"},{"l":"Competições","v":"445","t":"+3.2%","d":"up"},{"l":"Performance Score","v":"88","t":"+14.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.006","3.604","1.366","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.877","5.074","5.637","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.489","4.842","3.978","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","3.706","2.107","1.806","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.411","7.505","2.435","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":861},{"label":"Mar","value":498},{"label":"Abr","value":524},{"label":"Mai","value":662},{"label":"Jun","value":640},{"label":"Jul","value":643},{"label":"Ago","value":791},{"label":"Set","value":653},{"label":"Out","value":701},{"label":"Nov","value":818},{"label":"Dez","value":507}];
const MX = 861;
