...
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"5.481","t":"+13.8%","d":"up"},{"l":"Valor Total (€M)","v":"€20.4M","t":"+1.3%","d":"up"},{"l":"Renovações Próx. 30d","v":"8.457","t":"+2.0%","d":"up"},{"l":"Obrigações Pendentes","v":"7.839","t":"-1.8%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 37471.37","2026-02-13","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 6134.67","2026-01-10","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 28585.63","2026-02-03","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 18242.97","2026-02-18","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 576.30","2026-02-28","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":842},{"label":"Mar","value":676},{"label":"Abr","value":927},{"label":"Mai","value":715},{"label":"Jun","value":686},{"label":"Jul","value":847},{"label":"Ago","value":624},{"label":"Set","value":784},{"label":"Out","value":812},{"label":"Nov","value":747},{"label":"Dez","value":695}];
const MX = 927;
