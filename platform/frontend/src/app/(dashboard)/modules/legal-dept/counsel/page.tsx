...
const ACCENT = "#64748b";
const MODULE = "Legal Department Mgmt";
const PAGE = "Outside Counsel";
const KPIS = [{"l":"Total Legal Dept","v":"1.203","t":"+5.9%","d":"up"},{"l":"Outside Counsel Ativos","v":"7.179","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"94.2%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"70","t":"+3.4%","d":"up"}];
const COLS = ["ID","Outside Counsel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legal Dept #001","Legal Dept #002","6.838","2.297","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Legal Dept #002","Legal Dept #003","1.401","7.373","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Legal Dept #003","Legal Dept #004","1.470","4.537","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Legal Dept #004","Legal Dept #005","854","4.020","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legal Dept #005","Legal Dept #001","4.388","4.569","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":477},{"label":"Mar","value":503},{"label":"Abr","value":640},{"label":"Mai","value":709},{"label":"Jun","value":608},{"label":"Jul","value":740},{"label":"Ago","value":411},{"label":"Set","value":627},{"label":"Out","value":384},{"label":"Nov","value":393},{"label":"Dez","value":703}];
const MX = 740;
