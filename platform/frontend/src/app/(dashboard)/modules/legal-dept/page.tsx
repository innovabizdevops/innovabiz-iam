...
/* ═══ Legal Department Mgmt — Dashboard ═══ */

const ACCENT = "#64748b";

const KPIS = [
    { label: "Total Registos", value: "944", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4476", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€146K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "868418944", cells: ["LEG-9944", "Legal Department Mgmt Item 1", "9/5/2026", "€19 044"], status: "active" as const },
    { id: "868422515", cells: ["LEG-4515", "Legal Department Mgmt Item 2", "24/12/2026", "€22 615"], status: "pending" as const },
    { id: "868426086", cells: ["LEG-8086", "Legal Department Mgmt Item 3", "11/7/2026", "€26 186"], status: "completed" as const },
    { id: "868429657", cells: ["LEG-2657", "Legal Department Mgmt Item 4", "26/2/2026", "€29 757"], status: "warning" as const },
    { id: "868433228", cells: ["LEG-6228", "Legal Department Mgmt Item 5", "13/9/2026", "€33 328"], status: "active" as const },
];
...
export default function LegalDepartmentMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Legal Department Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Legal Department Mgmt</p>
                    </div>
                </div>
