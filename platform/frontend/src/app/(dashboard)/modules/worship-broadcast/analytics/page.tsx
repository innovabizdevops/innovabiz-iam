...
const KPIS = [{"l":"Dashboards Ativos","v":"5.823","t":"+1.4%","d":"up"},{"l":"Queries/Dia","v":"3920","t":"+3.9%","d":"up"},{"l":"Dados Processados (GB)","v":"4.201","t":"-4.2%","d":"down"},{"l":"Utilizadores Analytics","v":"6.604","t":"-4.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","772","2026-02-26","3.943","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","392","2026-03-25","3.039","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4889","2026-02-26","2.414","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","955","2026-02-12","1.307","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4684","2026-03-07","1.603","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":515},{"label":"Fev","value":289},{"label":"Mar","value":600},{"label":"Abr","value":291},{"label":"Mai","value":514},{"label":"Jun","value":414},{"label":"Jul","value":333},{"label":"Ago","value":257},{"label":"Set","value":601},{"label":"Out","value":293},{"label":"Nov","value":379},{"label":"Dez","value":471}];
const MX = 601;
