...
/* ═══ Worship Broadcast — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "5247", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "290", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€196K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1374828047", cells: ["WOR-7047", "Worship Broadcast Item 1", "20/12/2026", "€28 147"], status: "active" as const },
    { id: "1374831618", cells: ["WOR-1618", "Worship Broadcast Item 2", "7/7/2026", "€31 718"], status: "pending" as const },
    { id: "1374835189", cells: ["WOR-5189", "Worship Broadcast Item 3", "22/2/2026", "€35 289"], status: "completed" as const },
    { id: "1374838760", cells: ["WOR-8760", "Worship Broadcast Item 4", "9/9/2026", "€38 860"], status: "warning" as const },
    { id: "1374842331", cells: ["WOR-3331", "Worship Broadcast Item 5", "24/4/2026", "€42 431"], status: "active" as const },
];
...
export default function WorshipBroadcastPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Worship Broadcast</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Worship Broadcast</p>
                    </div>
                </div>
