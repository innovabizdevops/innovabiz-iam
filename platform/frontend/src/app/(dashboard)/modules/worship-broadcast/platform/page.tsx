...
const PAGE = "Platform";
const KPIS = [{"l":"Formulários Ativos","v":"2.196","t":"-2.9%","d":"down"},{"l":"Submissões/Dia","v":"2391","t":"-0.9%","d":"down"},{"l":"Documentos Gerados","v":"3.912","t":"+2.6%","d":"up"},{"l":"Templates","v":"7.221","t":"+17.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.298","2026-01-10","7.049","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.004","2026-02-24","1.928","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.189","2026-01-24","2.668","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.476","2026-01-07","6.425","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.283","2026-03-04","1.950","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":927},{"label":"Mar","value":724},{"label":"Abr","value":920},{"label":"Mai","value":744},{"label":"Jun","value":793},{"label":"Jul","value":682},{"label":"Ago","value":694},{"label":"Set","value":901},{"label":"Out","value":733},{"label":"Nov","value":987},{"label":"Dez","value":681}];
const MX = 987;
