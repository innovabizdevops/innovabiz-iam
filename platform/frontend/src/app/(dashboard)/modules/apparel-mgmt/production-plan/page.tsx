...
/* ═══ Apparel Mgmt — Production Plan ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "4938", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "60", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2124", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "85090360", cells: ["APP-5360", "Production Plan Item 1", "13/5/2026", "€40 460"], status: "active" as const },
    { id: "85093931", cells: ["APP-8931", "Production Plan Item 2", "28/12/2026", "€44 031"], status: "pending" as const },
    { id: "85097502", cells: ["APP-3502", "Production Plan Item 3", "15/7/2026", "€47 602"], status: "completed" as const },
    { id: "85101073", cells: ["APP-7073", "Production Plan Item 4", "2/2/2026", "€1173"], status: "warning" as const },
    { id: "85104644", cells: ["APP-1644", "Production Plan Item 5", "17/9/2026", "€4744"], status: "active" as const },
];
...
export default function ApparelMgmtProductionPlanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Production Plan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Apparel Mgmt • Production Plan</p>
                    </div>
                </div>
