...
/* ═══ Apparel Mgmt — Merchandiser ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "517", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "189", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1795", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "440281049", cells: ["APP-2049", "Merchandiser Item 1", "6/6/2026", "€31 149"], status: "active" as const },
    { id: "440284620", cells: ["APP-5620", "Merchandiser Item 2", "21/1/2026", "€34 720"], status: "pending" as const },
    { id: "440288191", cells: ["APP-9191", "Merchandiser Item 3", "8/8/2026", "€38 291"], status: "completed" as const },
    { id: "440291762", cells: ["APP-3762", "Merchandiser Item 4", "23/3/2026", "€41 862"], status: "warning" as const },
    { id: "440295333", cells: ["APP-7333", "Merchandiser Item 5", "10/10/2026", "€45 433"], status: "active" as const },
];
...
export default function ApparelMgmtMerchandiserPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Merchandiser</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Apparel Mgmt • Merchandiser</p>
                    </div>
                </div>
