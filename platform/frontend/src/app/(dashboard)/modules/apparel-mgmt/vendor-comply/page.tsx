...
/* ═══ Apparel Mgmt — Vendor Comply ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "174", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "48", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "845", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1937380028", cells: ["APP-5028", "Vendor Comply Item 1", "25/9/2026", "€30 128"], status: "active" as const },
    { id: "1937383599", cells: ["APP-8599", "Vendor Comply Item 2", "12/4/2026", "€33 699"], status: "pending" as const },
    { id: "1937387170", cells: ["APP-3170", "Vendor Comply Item 3", "27/11/2026", "€37 270"], status: "completed" as const },
    { id: "1937390741", cells: ["APP-6741", "Vendor Comply Item 4", "14/6/2026", "€40 841"], status: "warning" as const },
    { id: "1937394312", cells: ["APP-1312", "Vendor Comply Item 5", "1/1/2026", "€44 412"], status: "active" as const },
];
...
export default function ApparelMgmtVendorComplyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Vendor Comply</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Apparel Mgmt • Vendor Comply</p>
                    </div>
                </div>
