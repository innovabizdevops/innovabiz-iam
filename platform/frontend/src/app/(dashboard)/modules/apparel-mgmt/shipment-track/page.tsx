...
/* ═══ Apparel Mgmt — Shipment Track ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "4991", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "103", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1960", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "999671747", cells: ["APP-6747", "Shipment Track Item 1", "12/12/2026", "€21 847"], status: "active" as const },
    { id: "999675318", cells: ["APP-1318", "Shipment Track Item 2", "27/7/2026", "€25 418"], status: "pending" as const },
    { id: "999678889", cells: ["APP-4889", "Shipment Track Item 3", "14/2/2026", "€28 989"], status: "completed" as const },
    { id: "999682460", cells: ["APP-8460", "Shipment Track Item 4", "1/9/2026", "€32 560"], status: "warning" as const },
    { id: "999686031", cells: ["APP-3031", "Shipment Track Item 5", "16/4/2026", "€36 131"], status: "active" as const },
];
...
export default function ApparelMgmtShipmentTrackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Shipment Track</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Apparel Mgmt • Shipment Track</p>
                    </div>
                </div>
