...
/* ═══ Apparel Mgmt — Costing Sheet ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "3391", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "152", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1201", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1892409796", cells: ["APP-7796", "Costing Sheet Item 1", "5/5/2026", "€9896"], status: "active" as const },
    { id: "1892413367", cells: ["APP-2367", "Costing Sheet Item 2", "20/12/2026", "€13 467"], status: "pending" as const },
    { id: "1892416938", cells: ["APP-5938", "Costing Sheet Item 3", "7/7/2026", "€17 038"], status: "completed" as const },
    { id: "1892420509", cells: ["APP-9509", "Costing Sheet Item 4", "22/2/2026", "€20 609"], status: "warning" as const },
    { id: "1892424080", cells: ["APP-4080", "Costing Sheet Item 5", "9/9/2026", "€24 180"], status: "active" as const },
];
...
export default function ApparelMgmtCostingSheetPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Costing Sheet</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Apparel Mgmt • Costing Sheet</p>
                    </div>
                </div>
