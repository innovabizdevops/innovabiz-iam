...
/* ═══ Apparel Mgmt — Markdown Opt ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "2187", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "58", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "177", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1993612550", cells: ["APP-5550", "Markdown Opt Item 1", "7/3/2026", "€12 650"], status: "active" as const },
    { id: "1993616121", cells: ["APP-9121", "Markdown Opt Item 2", "22/10/2026", "€16 221"], status: "pending" as const },
    { id: "1993619692", cells: ["APP-3692", "Markdown Opt Item 3", "9/5/2026", "€19 792"], status: "completed" as const },
    { id: "1993623263", cells: ["APP-7263", "Markdown Opt Item 4", "24/12/2026", "€23 363"], status: "warning" as const },
    { id: "1993626834", cells: ["APP-1834", "Markdown Opt Item 5", "11/7/2026", "€26 934"], status: "active" as const },
];
...
export default function ApparelMgmtMarkdownOptPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Markdown Opt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Apparel Mgmt • Markdown Opt</p>
                    </div>
                </div>
