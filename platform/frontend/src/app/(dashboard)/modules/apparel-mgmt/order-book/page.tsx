...
/* ═══ Apparel Mgmt — Order Book ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "1636", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "311", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1052", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "163811763", cells: ["APP-3763", "Order Book Item 1", "4/4/2026", "€11 863"], status: "active" as const },
    { id: "163815334", cells: ["APP-7334", "Order Book Item 2", "19/11/2026", "€15 434"], status: "pending" as const },
    { id: "163818905", cells: ["APP-1905", "Order Book Item 3", "6/6/2026", "€19 005"], status: "completed" as const },
    { id: "163822476", cells: ["APP-5476", "Order Book Item 4", "21/1/2026", "€22 576"], status: "warning" as const },
    { id: "163826047", cells: ["APP-9047", "Order Book Item 5", "8/8/2026", "€26 147"], status: "active" as const },
];
...
export default function ApparelMgmtOrderBookPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Order Book</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Apparel Mgmt • Order Book</p>
                    </div>
                </div>
