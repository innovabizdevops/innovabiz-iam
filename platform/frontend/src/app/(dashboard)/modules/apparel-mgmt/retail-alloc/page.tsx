...
/* ═══ Apparel Mgmt — Retail Alloc ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "1676", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "20", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1821", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "217850672", cells: ["APP-6672", "Retail Alloc Item 1", "5/9/2026", "€772"], status: "active" as const },
    { id: "217854243", cells: ["APP-1243", "Retail Alloc Item 2", "20/4/2026", "€4343"], status: "pending" as const },
    { id: "217857814", cells: ["APP-4814", "Retail Alloc Item 3", "7/11/2026", "€7914"], status: "completed" as const },
    { id: "217861385", cells: ["APP-8385", "Retail Alloc Item 4", "22/6/2026", "€11 485"], status: "warning" as const },
    { id: "217864956", cells: ["APP-2956", "Retail Alloc Item 5", "9/1/2026", "€15 056"], status: "active" as const },
];
...
export default function ApparelMgmtRetailAllocPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Retail Alloc</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Apparel Mgmt • Retail Alloc</p>
                    </div>
                </div>
