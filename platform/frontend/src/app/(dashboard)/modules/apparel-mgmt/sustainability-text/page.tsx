...
/* ═══ Apparel Mgmt — Sustainability Text ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "2740", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "118", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "174", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "87%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1675262450", cells: ["APP-3450", "Sustainability Text Item 1", "23/3/2026", "€12 550"], status: "active" as const },
    { id: "1675266021", cells: ["APP-7021", "Sustainability Text Item 2", "10/10/2026", "€16 121"], status: "pending" as const },
    { id: "1675269592", cells: ["APP-1592", "Sustainability Text Item 3", "25/5/2026", "€19 692"], status: "completed" as const },
    { id: "1675273163", cells: ["APP-5163", "Sustainability Text Item 4", "12/12/2026", "€23 263"], status: "warning" as const },
    { id: "1675276734", cells: ["APP-8734", "Sustainability Text Item 5", "27/7/2026", "€26 834"], status: "active" as const },
];
...
export default function ApparelMgmtSustainabilityTextPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sustainability Text</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Apparel Mgmt • Sustainability Text</p>
                    </div>
                </div>
