...
/* ═══ Apparel Mgmt — Material Req ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "4115", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "33", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2408", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1130920221", cells: ["APP-8221", "Material Req Item 1", "26/10/2026", "€20 321"], status: "active" as const },
    { id: "1130923792", cells: ["APP-2792", "Material Req Item 2", "13/5/2026", "€23 892"], status: "pending" as const },
    { id: "1130927363", cells: ["APP-6363", "Material Req Item 3", "28/12/2026", "€27 463"], status: "completed" as const },
    { id: "1130930934", cells: ["APP-9934", "Material Req Item 4", "15/7/2026", "€31 034"], status: "warning" as const },
    { id: "1130934505", cells: ["APP-4505", "Material Req Item 5", "2/2/2026", "€34 605"], status: "active" as const },
];
...
export default function ApparelMgmtMaterialReqPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Material Req</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Apparel Mgmt • Material Req</p>
                    </div>
                </div>
