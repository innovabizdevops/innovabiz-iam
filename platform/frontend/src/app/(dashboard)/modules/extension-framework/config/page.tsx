...
const PAGE = "Config";
const KPIS = [{"l":"Configurações","v":"5.689","t":"+6.3%","d":"up"},{"l":"Últimas Alterações","v":"4.964","t":"+14.4%","d":"up"},{"l":"Ambientes","v":"913","t":"+12.3%","d":"up"},{"l":"Versão Config","v":"3.316","t":"+10.2%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 22807.25","4.142","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 32310.95","1.856","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 29306.51","3.857","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 47884.66","3.738","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 28786.79","1.953","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":713},{"label":"Mar","value":522},{"label":"Abr","value":513},{"label":"Mai","value":463},{"label":"Jun","value":593},{"label":"Jul","value":524},{"label":"Ago","value":746},{"label":"Set","value":576},{"label":"Out","value":610},{"label":"Nov","value":628},{"label":"Dez","value":707}];
const MX = 746;
