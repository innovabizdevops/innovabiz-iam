...
const ACCENT = "#059669";
const MODULE = "Extension Framework";
const PAGE = "Register";
const KPIS = [{"l":"Total Extension Framework","v":"3.998","t":"+3.4%","d":"up"},{"l":"Register Ativos","v":"4.009","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"75","t":"+10.2%","d":"up"}];
const COLS = ["ID","Register","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Extension Framework #001","Extension Framework #002","2.917","1.512","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Extension Framework #002","Extension Framework #003","3.094","1.437","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Extension Framework #003","Extension Framework #004","3.601","3.698","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Extension Framework #004","Extension Framework #005","5.265","7.007","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Extension Framework #005","Extension Framework #001","6.952","7.122","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":921},{"label":"Mar","value":836},{"label":"Abr","value":673},{"label":"Mai","value":930},{"label":"Jun","value":784},{"label":"Jul","value":742},{"label":"Ago","value":903},{"label":"Set","value":726},{"label":"Out","value":947},{"label":"Nov","value":976},{"label":"Dez","value":956}];
const MX = 976;
