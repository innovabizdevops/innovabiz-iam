...
/* ═══ Extension Framework — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "4913", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2136", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€459K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1940771113", cells: ["EXT-3113", "Extension Framework Item 1", "2/2/2026", "€21 213"], status: "active" as const },
    { id: "1940774684", cells: ["EXT-6684", "Extension Framework Item 2", "17/9/2026", "€24 784"], status: "pending" as const },
    { id: "1940778255", cells: ["EXT-1255", "Extension Framework Item 3", "4/4/2026", "€28 355"], status: "completed" as const },
    { id: "1940781826", cells: ["EXT-4826", "Extension Framework Item 4", "19/11/2026", "€31 926"], status: "warning" as const },
    { id: "1940785397", cells: ["EXT-8397", "Extension Framework Item 5", "6/6/2026", "€35 497"], status: "active" as const },
];
...
export default function ExtensionFrameworkPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Extension Framework</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Extension Framework</p>
                    </div>
                </div>
