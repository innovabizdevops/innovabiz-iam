...
const PAGE = "Ideas";
const KPIS = [{"l":"Ideias Submetidas","v":"3.410","t":"+2.6%","d":"up"},{"l":"Patentes (YTD)","v":"4.076","t":"-2.5%","d":"down"},{"l":"Projetos Innovation Lab","v":"6.406","t":"+15.3%","d":"up"},{"l":"Budget I&D (€M)","v":"€45.0M","t":"-0.9%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","1.546","72.7%","1.007","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.995","88.9%","5.231","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","781","74.4%","8.778","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.702","74.1%","2.152","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.357","81.9%","6.744","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":946},{"label":"Mar","value":879},{"label":"Abr","value":670},{"label":"Mai","value":725},{"label":"Jun","value":925},{"label":"Jul","value":598},{"label":"Ago","value":587},{"label":"Set","value":595},{"label":"Out","value":765},{"label":"Nov","value":938},{"label":"Dez","value":825}];
const MX = 946;
