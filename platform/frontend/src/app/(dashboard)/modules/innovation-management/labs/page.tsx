...
const PAGE = "Labs";
const KPIS = [{"l":"Ideias Submetidas","v":"8.676","t":"+11.9%","d":"up"},{"l":"Patentes (YTD)","v":"7.303","t":"-5.9%","d":"down"},{"l":"Projetos Innovation Lab","v":"2.950","t":"+15.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€17.2M","t":"+12.8%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","8.081","84.9%","8.769","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","4.491","77.2%","2.192","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","689","89.1%","1.514","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.040","93.4%","3.787","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","4.704","87.4%","6.634","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":912},{"label":"Fev","value":957},{"label":"Mar","value":982},{"label":"Abr","value":836},{"label":"Mai","value":646},{"label":"Jun","value":915},{"label":"Jul","value":785},{"label":"Ago","value":696},{"label":"Set","value":732},{"label":"Out","value":1000},{"label":"Nov","value":951},{"label":"Dez","value":789}];
const MX = 1000;
