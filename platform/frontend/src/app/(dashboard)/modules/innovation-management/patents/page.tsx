...
const PAGE = "Patents";
const KPIS = [{"l":"Ideias Submetidas","v":"632","t":"+13.0%","d":"up"},{"l":"Patentes (YTD)","v":"4.171","t":"+14.7%","d":"up"},{"l":"Projetos Innovation Lab","v":"6.251","t":"-5.0%","d":"down"},{"l":"Budget I&D (€M)","v":"€28.7M","t":"+13.7%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","295","99.0%","7.577","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.185","70.7%","1.494","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","8.267","74.3%","4.380","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","8.363","85.0%","6.544","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.772","89.8%","2.448","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":857},{"label":"Mar","value":556},{"label":"Abr","value":568},{"label":"Mai","value":699},{"label":"Jun","value":692},{"label":"Jul","value":652},{"label":"Ago","value":842},{"label":"Set","value":929},{"label":"Out","value":596},{"label":"Nov","value":716},{"label":"Dez","value":809}];
const MX = 929;
