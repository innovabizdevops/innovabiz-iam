...
const ACCENT = "#6366f1";
const MODULE = "Innovation Management";
const PAGE = "Innovation Pipeline";
const KPIS = [{"l":"Ideias Submetidas","v":"6.646","t":"+4.1%","d":"up"},{"l":"Patentes (YTD)","v":"6.036","t":"+0.6%","d":"up"},{"l":"Projetos Innovation Lab","v":"6.045","t":"+6.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€15.4M","t":"+16.9%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","1.878","82.0%","8.518","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.998","82.1%","6.321","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.408","95.7%","3.511","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","8.284","87.2%","2.646","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.836","78.5%","4.224","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":561},{"label":"Mar","value":758},{"label":"Abr","value":547},{"label":"Mai","value":688},{"label":"Jun","value":839},{"label":"Jul","value":637},{"label":"Ago","value":854},{"label":"Set","value":669},{"label":"Out","value":681},{"label":"Nov","value":589},{"label":"Dez","value":752}];
const MX = 854;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>Kanban</span></h1>
                </div>
