...
const PAGE = "Idea Submission Form";
const KPIS = [{"l":"Formulários Ativos","v":"6.400","t":"+1.8%","d":"up"},{"l":"Submissões/Dia","v":"2921","t":"+10.5%","d":"up"},{"l":"Documentos Gerados","v":"8.981","t":"-0.3%","d":"down"},{"l":"Templates","v":"8.173","t":"-0.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.403","2026-03-27","5.651","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.482","2026-01-05","3.233","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.154","2026-03-10","1.505","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.123","2026-02-05","2.544","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.733","2026-03-26","3.562","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":789},{"label":"Mar","value":761},{"label":"Abr","value":892},{"label":"Mai","value":905},{"label":"Jun","value":765},{"label":"Jul","value":906},{"label":"Ago","value":767},{"label":"Set","value":843},{"label":"Out","value":836},{"label":"Nov","value":901},{"label":"Dez","value":838}];
const MX = 906;
