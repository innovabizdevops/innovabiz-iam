...
const KPIS = [{"l":"Total Cosmetic Surgery","v":"3.037","t":"-4.2%","d":"down"},{"l":"Procedure Ativos","v":"4.282","t":"+0.6%","d":"up"},{"l":"Eficiência (%)","v":"73.2%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"91","t":"-3.5%","d":"down"}];
const COLS = ["ID","Procedure","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmetic Surgery #001","Cosmetic Surgery #002","8.851","2.845","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmetic Surgery #002","Cosmetic Surgery #003","7.184","5.641","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmetic Surgery #003","Cosmetic Surgery #004","6.049","3.925","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmetic Surgery #004","Cosmetic Surgery #005","7.891","287","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmetic Surgery #005","Cosmetic Surgery #001","411","4.071","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":343},{"label":"Fev","value":617},{"label":"Mar","value":305},{"label":"Abr","value":600},{"label":"Mai","value":573},{"label":"Jun","value":499},{"label":"Jul","value":623},{"label":"Ago","value":422},{"label":"Set","value":358},{"label":"Out","value":255},{"label":"Nov","value":539},{"label":"Dez","value":285}];
const MX = 623;
