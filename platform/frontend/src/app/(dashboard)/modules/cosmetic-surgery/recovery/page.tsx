...
const ACCENT = "#6366f1";
const MODULE = "Cosmetic Surgery";
const PAGE = "Recovery";
const KPIS = [{"l":"BCP Plans Ativos","v":"7.940","t":"+13.8%","d":"up"},{"l":"RTO Médio (h)","v":"157h","t":"+12.7%","d":"up"},{"l":"RPO Médio (h)","v":"75h","t":"-1.5%","d":"down"},{"l":"Testes DR (YTD)","v":"8.125","t":"-0.3%","d":"down"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","150h","160h","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","49h","74h","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","124h","130h","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","132h","150h","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","26h","16h","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":714},{"label":"Mar","value":592},{"label":"Abr","value":859},{"label":"Mai","value":866},{"label":"Jun","value":942},{"label":"Jul","value":803},{"label":"Ago","value":680},{"label":"Set","value":573},{"label":"Out","value":680},{"label":"Nov","value":659},{"label":"Dez","value":635}];
const MX = 942;
