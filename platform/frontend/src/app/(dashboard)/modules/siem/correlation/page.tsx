...
const PAGE = "Correlation Rules";
const KPIS = [{"l":"Total Siem","v":"608","t":"+15.8%","d":"up"},{"l":"Correlation Rules Ativos","v":"8.020","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"82.9%","t":"+8.9%","d":"up"},{"l":"Score Performance","v":"60","t":"+10.1%","d":"up"}];
const COLS = ["ID","Correlation Rules","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Siem #001","Siem #002","7.017","1.239","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Siem #002","Siem #003","8.895","547","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Siem #003","Siem #004","8.555","5.622","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Siem #004","Siem #005","924","811","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Siem #005","Siem #001","3.810","7.386","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":467},{"label":"Mar","value":669},{"label":"Abr","value":470},{"label":"Mai","value":649},{"label":"Jun","value":465},{"label":"Jul","value":591},{"label":"Ago","value":743},{"label":"Set","value":422},{"label":"Out","value":590},{"label":"Nov","value":563},{"label":"Dez","value":758}];
const MX = 758;
