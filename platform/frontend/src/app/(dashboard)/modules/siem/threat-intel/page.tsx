...
const KPIS = [{"l":"Total Siem","v":"4.631","t":"+9.4%","d":"up"},{"l":"Threat Intel Ativos","v":"973","t":"+15.8%","d":"up"},{"l":"Eficiência (%)","v":"80.3%","t":"+5.0%","d":"up"},{"l":"Score Performance","v":"71","t":"+6.4%","d":"up"}];
const COLS = ["ID","Threat Intel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Siem #001","Siem #002","745","3.373","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Siem #002","Siem #003","9.097","3.787","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Siem #003","Siem #004","6.234","7.206","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Siem #004","Siem #005","144","7.134","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Siem #005","Siem #001","1.031","5.721","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":367},{"label":"Fev","value":691},{"label":"Mar","value":348},{"label":"Abr","value":680},{"label":"Mai","value":674},{"label":"Jun","value":355},{"label":"Jul","value":580},{"label":"Ago","value":584},{"label":"Set","value":713},{"label":"Out","value":665},{"label":"Nov","value":634},{"label":"Dez","value":502}];
const MX = 713;
