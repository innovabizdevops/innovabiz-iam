...
const PAGE = "Alert Triage";
const KPIS = [{"l":"Notificações Enviadas","v":"966","t":"+0.4%","d":"up"},{"l":"Taxa Entrega (%)","v":"86.8%","t":"+9.0%","d":"up"},{"l":"Taxa Abertura (%)","v":"81.7%","t":"-4.8%","d":"down"},{"l":"Escalações","v":"8.022","t":"+7.3%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","8.648","95.3%","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","2.813","86.0%","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","9.066","79.0%","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","2.206","98.7%","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","1.773","73.8%","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":764},{"label":"Fev","value":973},{"label":"Mar","value":908},{"label":"Abr","value":694},{"label":"Mai","value":956},{"label":"Jun","value":858},{"label":"Jul","value":774},{"label":"Ago","value":720},{"label":"Set","value":749},{"label":"Out","value":806},{"label":"Nov","value":890},{"label":"Dez","value":786}];
const MX = 973;
