...
const KPIS = [{"l":"Total Siem","v":"4.678","t":"+15.4%","d":"up"},{"l":"SOAR Playbooks Ativos","v":"579","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"72.3%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"89","t":"+14.6%","d":"up"}];
const COLS = ["ID","SOAR Playbooks","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Siem #001","Siem #002","6.331","2.747","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Siem #002","Siem #003","2.614","4.575","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Siem #003","Siem #004","8.588","4.393","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Siem #004","Siem #005","5.790","2.749","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Siem #005","Siem #001","2.700","3.666","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":323},{"label":"Mar","value":451},{"label":"Abr","value":423},{"label":"Mai","value":382},{"label":"Jun","value":602},{"label":"Jul","value":351},{"label":"Ago","value":325},{"label":"Set","value":222},{"label":"Out","value":477},{"label":"Nov","value":214},{"label":"Dez","value":412}];
const MX = 602;
