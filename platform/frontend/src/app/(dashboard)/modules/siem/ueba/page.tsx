...
const ACCENT = "#dc2626";
const MODULE = "SIEM & Log Analytics";
const PAGE = "User Behavior";
const KPIS = [{"l":"Utilizadores Ativos","v":"6.998","t":"-5.8%","d":"down"},{"l":"Sessões/Dia","v":"4653","t":"+11.7%","d":"up"},{"l":"MFA Adoção (%)","v":"85.4%","t":"-3.7%","d":"down"},{"l":"Tentativas Bloqueadas","v":"8.014","t":"+12.1%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.371","6.454","7.425","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","215","1.881","1.441","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","2.812","8.250","6.324","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","7.044","8.589","4.762","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","1.674","5.630","8.804","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":333},{"label":"Mar","value":249},{"label":"Abr","value":312},{"label":"Mai","value":532},{"label":"Jun","value":562},{"label":"Jul","value":309},{"label":"Ago","value":602},{"label":"Set","value":263},{"label":"Out","value":426},{"label":"Nov","value":533},{"label":"Dez","value":418}];
const MX = 602;
