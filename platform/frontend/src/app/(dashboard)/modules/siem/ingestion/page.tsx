...
const PAGE = "Log Ingestion";
const KPIS = [{"l":"Total Siem","v":"5.614","t":"+17.5%","d":"up"},{"l":"Log Ingestion Ativos","v":"6.319","t":"+11.7%","d":"up"},{"l":"Eficiência (%)","v":"80.6%","t":"+0.0%","d":"up"},{"l":"Score Performance","v":"90","t":"+7.9%","d":"up"}];
const COLS = ["ID","Log Ingestion","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Siem #001","Siem #002","6.738","3.706","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Siem #002","Siem #003","1.647","6.802","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Siem #003","Siem #004","3.925","1.854","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Siem #004","Siem #005","3.436","7.067","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Siem #005","Siem #001","4.769","3.707","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":609},{"label":"Mar","value":437},{"label":"Abr","value":562},{"label":"Mai","value":351},{"label":"Jun","value":589},{"label":"Jul","value":301},{"label":"Ago","value":612},{"label":"Set","value":378},{"label":"Out","value":360},{"label":"Nov","value":665},{"label":"Dez","value":580}];
const MX = 665;
