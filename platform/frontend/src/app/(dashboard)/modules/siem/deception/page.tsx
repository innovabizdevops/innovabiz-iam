...
const PAGE = "Deception Tech";
const KPIS = [{"l":"Total Siem","v":"397","t":"-3.8%","d":"down"},{"l":"Deception Tech Ativos","v":"8.429","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"74.5%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"66","t":"+4.5%","d":"up"}];
const COLS = ["ID","Deception Tech","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Siem #001","Siem #002","8.721","1.927","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Siem #002","Siem #003","3.128","8.467","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Siem #003","Siem #004","317","6.717","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Siem #004","Siem #005","7.906","7.752","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Siem #005","Siem #001","8.564","1.448","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":714},{"label":"Mar","value":826},{"label":"Abr","value":955},{"label":"Mai","value":883},{"label":"Jun","value":614},{"label":"Jul","value":712},{"label":"Ago","value":963},{"label":"Set","value":790},{"label":"Out","value":693},{"label":"Nov","value":735},{"label":"Dez","value":729}];
const MX = 963;
