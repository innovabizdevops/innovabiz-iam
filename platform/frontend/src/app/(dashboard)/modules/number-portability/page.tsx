...
export default function NumberPortabilityPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Number Portability</h1><p className="text-sm text-muted-foreground">Number Portability • iBOS Enterprise</p></div>
            </div>
