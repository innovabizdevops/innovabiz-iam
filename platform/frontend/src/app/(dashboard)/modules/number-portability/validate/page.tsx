...
const PAGE = "Validate";
const KPIS = [{"l":"Total Number Portability","v":"2.347","t":"+1.1%","d":"up"},{"l":"Validate Ativos","v":"2.425","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"92.8%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"61","t":"+3.4%","d":"up"}];
const COLS = ["ID","Validate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Number Portability #001","Number Portability #002","4.195","403","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Number Portability #002","Number Portability #003","7.101","2.864","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Number Portability #003","Number Portability #004","740","6.875","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Number Portability #004","Number Portability #005","7.755","313","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Number Portability #005","Number Portability #001","7.709","7.924","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":975},{"label":"Fev","value":975},{"label":"Mar","value":848},{"label":"Abr","value":904},{"label":"Mai","value":791},{"label":"Jun","value":823},{"label":"Jul","value":855},{"label":"Ago","value":983},{"label":"Set","value":770},{"label":"Out","value":687},{"label":"Nov","value":1083},{"label":"Dez","value":884}];
const MX = 1083;
