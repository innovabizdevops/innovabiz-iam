...
const ACCENT = "#f97316";
const MODULE = "Number Portability";
const PAGE = "Reject";
const KPIS = [{"l":"Total Number Portability","v":"5.235","t":"-4.4%","d":"down"},{"l":"Reject Ativos","v":"3.988","t":"+11.7%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"69","t":"+8.8%","d":"up"}];
const COLS = ["ID","Reject","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Number Portability #001","Number Portability #002","2.605","7.944","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Number Portability #002","Number Portability #003","7.272","1.132","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Number Portability #003","Number Portability #004","6.589","4.837","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Number Portability #004","Number Portability #005","2.734","1.430","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Number Portability #005","Number Portability #001","3.226","7.185","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":598},{"label":"Mar","value":763},{"label":"Abr","value":488},{"label":"Mai","value":528},{"label":"Jun","value":725},{"label":"Jul","value":757},{"label":"Ago","value":610},{"label":"Set","value":661},{"label":"Out","value":597},{"label":"Nov","value":527},{"label":"Dez","value":782}];
const MX = 782;
