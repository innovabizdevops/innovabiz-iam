...
const PAGE = "Port";
const KPIS = [{"l":"Total Number Portability","v":"7.059","t":"+4.6%","d":"up"},{"l":"Port Ativos","v":"5.641","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"89.7%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"74","t":"-2.7%","d":"down"}];
const COLS = ["ID","Port","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Number Portability #001","Number Portability #002","7.386","4.149","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Number Portability #002","Number Portability #003","5.965","1.107","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Number Portability #003","Number Portability #004","2.458","987","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Number Portability #004","Number Portability #005","6.423","4.929","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Number Portability #005","Number Portability #001","5.436","1.166","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":737},{"label":"Fev","value":819},{"label":"Mar","value":788},{"label":"Abr","value":527},{"label":"Mai","value":654},{"label":"Jun","value":549},{"label":"Jul","value":659},{"label":"Ago","value":735},{"label":"Set","value":537},{"label":"Out","value":547},{"label":"Nov","value":541},{"label":"Dez","value":536}];
const MX = 819;
