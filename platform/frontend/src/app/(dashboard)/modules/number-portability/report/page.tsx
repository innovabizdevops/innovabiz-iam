...
const PAGE = "Report";
const KPIS = [{"l":"Total Number Portability","v":"6.895","t":"+1.7%","d":"up"},{"l":"Report Ativos","v":"5.228","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"+9.3%","d":"up"},{"l":"Score Performance","v":"77","t":"+16.0%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Number Portability #001","Number Portability #002","3.990","3.048","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Number Portability #002","Number Portability #003","8.867","5.215","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Number Portability #003","Number Portability #004","5.446","7.535","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Number Portability #004","Number Portability #005","6.600","4.618","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Number Portability #005","Number Portability #001","1.112","2.896","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":936},{"label":"Mar","value":725},{"label":"Abr","value":820},{"label":"Mai","value":669},{"label":"Jun","value":895},{"label":"Jul","value":692},{"label":"Ago","value":699},{"label":"Set","value":581},{"label":"Out","value":603},{"label":"Nov","value":565},{"label":"Dez","value":570}];
const MX = 936;
