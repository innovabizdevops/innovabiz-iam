...
const PAGE = "Share";
const KPIS = [{"l":"Total Tableau Crm","v":"3.808","t":"+12.5%","d":"up"},{"l":"Share Ativos","v":"7.784","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"82.0%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"78","t":"+16.7%","d":"up"}];
const COLS = ["ID","Share","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tableau Crm #001","Tableau Crm #002","5.528","2.062","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Tableau Crm #002","Tableau Crm #003","1.235","2.702","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Tableau Crm #003","Tableau Crm #004","3.494","7.255","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Tableau Crm #004","Tableau Crm #005","4.480","2.354","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tableau Crm #005","Tableau Crm #001","6.074","8.919","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":550},{"label":"Mar","value":277},{"label":"Abr","value":448},{"label":"Mai","value":250},{"label":"Jun","value":330},{"label":"Jul","value":220},{"label":"Ago","value":358},{"label":"Set","value":256},{"label":"Out","value":563},{"label":"Nov","value":486},{"label":"Dez","value":519}];
const MX = 563;
