...
const ACCENT = "#00a1e0";
const MODULE = "Tableau CRM (Analytics)";
const PAGE = "Visualize";
const KPIS = [{"l":"Dashboards Ativos","v":"4.030","t":"+1.4%","d":"up"},{"l":"Queries/Dia","v":"554","t":"+3.5%","d":"up"},{"l":"Dados Processados (GB)","v":"5.223","t":"+5.0%","d":"up"},{"l":"Utilizadores Analytics","v":"3.593","t":"+9.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3312","2026-01-24","5.357","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2580","2026-01-17","8.248","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","749","2026-02-11","4.295","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2896","2026-01-20","1.893","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3449","2026-01-13","4.663","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":906},{"label":"Mar","value":848},{"label":"Abr","value":903},{"label":"Mai","value":670},{"label":"Jun","value":735},{"label":"Jul","value":674},{"label":"Ago","value":749},{"label":"Set","value":946},{"label":"Out","value":997},{"label":"Nov","value":720},{"label":"Dez","value":684}];
const MX = 997;
