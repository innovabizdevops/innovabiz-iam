...
/* ═══ Tableau CRM (Analytics) — Dashboard ═══ */

const ACCENT = "#00a1e0";

const KPIS = [
    { label: "Total Registos", value: "7082", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3755", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€122K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1812013882", cells: ["TAB-8882", "Tableau CRM (Analytics) Item 1", "15/11/2026", "€13 982"], status: "active" as const },
    { id: "1812017453", cells: ["TAB-3453", "Tableau CRM (Analytics) Item 2", "2/6/2026", "€17 553"], status: "pending" as const },
    { id: "1812021024", cells: ["TAB-7024", "Tableau CRM (Analytics) Item 3", "17/1/2026", "€21 124"], status: "completed" as const },
    { id: "1812024595", cells: ["TAB-1595", "Tableau CRM (Analytics) Item 4", "4/8/2026", "€24 695"], status: "warning" as const },
    { id: "1812028166", cells: ["TAB-5166", "Tableau CRM (Analytics) Item 5", "19/3/2026", "€28 266"], status: "active" as const },
];
...
export default function TableauCrmAnalyticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tableau CRM (Analytics)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Tableau CRM (Analytics)</p>
                    </div>
                </div>
