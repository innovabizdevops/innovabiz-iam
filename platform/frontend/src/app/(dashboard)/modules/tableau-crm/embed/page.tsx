...
const PAGE = "Embed";
const KPIS = [{"l":"Dashboards Ativos","v":"266","t":"+12.7%","d":"up"},{"l":"Queries/Dia","v":"2071","t":"-1.6%","d":"down"},{"l":"Dados Processados (GB)","v":"6.401","t":"+9.7%","d":"up"},{"l":"Utilizadores Analytics","v":"8.870","t":"+6.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4695","2026-01-27","6.280","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3103","2026-01-16","7.606","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2417","2026-01-22","5.967","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4517","2026-01-16","3.369","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3238","2026-01-12","2.668","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":717},{"label":"Mar","value":788},{"label":"Abr","value":800},{"label":"Mai","value":801},{"label":"Jun","value":874},{"label":"Jul","value":904},{"label":"Ago","value":736},{"label":"Set","value":764},{"label":"Out","value":680},{"label":"Nov","value":954},{"label":"Dez","value":1018}];
const MX = 1018;
