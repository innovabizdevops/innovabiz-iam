...
const ACCENT = "#1d4ed8";
const MODULE = "Space Agency";
const PAGE = "Launch";
const KPIS = [{"l":"Quartos Ocupados","v":"1.359","t":"+1.2%","d":"up"},{"l":"RevPAR (€)","v":"€66417","t":"+8.7%","d":"up"},{"l":"Ocupação (%)","v":"80.9%","t":"+16.4%","d":"up"},{"l":"Guest Satisfaction","v":"5.611","t":"+1.4%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.178","2026-02-24","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.111","2026-01-22","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.962","2026-02-26","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.375","2026-01-06","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.259","2026-01-01","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":645},{"label":"Mar","value":610},{"label":"Abr","value":748},{"label":"Mai","value":646},{"label":"Jun","value":719},{"label":"Jul","value":828},{"label":"Ago","value":623},{"label":"Set","value":650},{"label":"Out","value":837},{"label":"Nov","value":642},{"label":"Dez","value":802}];
const MX = 837;
