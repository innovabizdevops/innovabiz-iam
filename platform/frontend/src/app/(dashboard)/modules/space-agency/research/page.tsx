...
const PAGE = "Research";
const KPIS = [{"l":"Ideias Submetidas","v":"749","t":"-5.6%","d":"down"},{"l":"Patentes (YTD)","v":"5.888","t":"+1.9%","d":"up"},{"l":"Projetos Innovation Lab","v":"6.408","t":"-3.2%","d":"down"},{"l":"Budget I&D (€M)","v":"€50.1M","t":"+14.5%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","4.112","77.6%","3.978","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.716","77.7%","6.852","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","5.957","95.0%","6.885","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.762","77.9%","4.137","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","8.057","76.5%","2.136","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":675},{"label":"Mar","value":582},{"label":"Abr","value":686},{"label":"Mai","value":568},{"label":"Jun","value":584},{"label":"Jul","value":731},{"label":"Ago","value":652},{"label":"Set","value":568},{"label":"Out","value":408},{"label":"Nov","value":503},{"label":"Dez","value":687}];
const MX = 772;
