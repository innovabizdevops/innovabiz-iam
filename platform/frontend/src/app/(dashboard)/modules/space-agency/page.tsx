...
/* ═══ Space Agency — Dashboard ═══ */

const ACCENT = "#1d4ed8";

const KPIS = [
    { label: "Total Registos", value: "5385", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3082", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€165K", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1247147885", cells: ["SPA-9885", "Space Agency Item 1", "26/6/2026", "€47 985"], status: "active" as const },
    { id: "1247151456", cells: ["SPA-4456", "Space Agency Item 2", "13/1/2026", "€1556"], status: "pending" as const },
    { id: "1247155027", cells: ["SPA-8027", "Space Agency Item 3", "28/8/2026", "€5127"], status: "completed" as const },
    { id: "1247158598", cells: ["SPA-2598", "Space Agency Item 4", "15/3/2026", "€8698"], status: "warning" as const },
    { id: "1247162169", cells: ["SPA-6169", "Space Agency Item 5", "2/10/2026", "€12 269"], status: "active" as const },
];
...
export default function SpaceAgencyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Space Agency</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Space Agency</p>
                    </div>
                </div>
