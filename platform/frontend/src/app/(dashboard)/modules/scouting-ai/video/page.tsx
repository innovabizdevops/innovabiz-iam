...
const ACCENT = "#b45309";
const MODULE = "Scouting AI";
const PAGE = "Video Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"2.503","t":"-4.1%","d":"down"},{"l":"Queries/Dia","v":"1630","t":"-1.0%","d":"down"},{"l":"Dados Processados (GB)","v":"795","t":"+17.8%","d":"up"},{"l":"Utilizadores Analytics","v":"6.433","t":"+10.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2115","2026-01-13","6.974","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4193","2026-01-23","7.607","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4699","2026-01-18","1.533","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1014","2026-03-07","6.196","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3438","2026-02-16","8.595","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":531},{"label":"Mar","value":585},{"label":"Abr","value":840},{"label":"Mai","value":572},{"label":"Jun","value":646},{"label":"Jul","value":529},{"label":"Ago","value":510},{"label":"Set","value":586},{"label":"Out","value":608},{"label":"Nov","value":839},{"label":"Dez","value":597}];
const MX = 840;
