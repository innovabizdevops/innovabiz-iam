...
const PAGE = "Player Database";
const KPIS = [{"l":"Total Scouting Ai","v":"7.959","t":"+16.9%","d":"up"},{"l":"Player Database Ativos","v":"5.011","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"81.9%","t":"+5.6%","d":"up"},{"l":"Score Performance","v":"67","t":"+12.3%","d":"up"}];
const COLS = ["ID","Player Database","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Scouting Ai #001","2026-03-21","8.930","8.123","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Scouting Ai #002","2026-03-09","6.942","3.389","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Scouting Ai #003","2026-01-03","115","1.886","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Scouting Ai #004","2026-03-13","6.107","7.534","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Scouting Ai #005","2026-02-07","7.730","5.999","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":321},{"label":"Mar","value":315},{"label":"Abr","value":482},{"label":"Mai","value":618},{"label":"Jun","value":439},{"label":"Jul","value":324},{"label":"Ago","value":386},{"label":"Set","value":322},{"label":"Out","value":299},{"label":"Nov","value":438},{"label":"Dez","value":614}];
const MX = 618;
