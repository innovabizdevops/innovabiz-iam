...
export default function ScoutingAiPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Scouting Ai</h1><p className="text-sm text-muted-foreground">Scouting Ai • iBOS Enterprise</p></div>
