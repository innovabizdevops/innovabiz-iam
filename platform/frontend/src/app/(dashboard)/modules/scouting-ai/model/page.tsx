...
const PAGE = "Draft Model";
const KPIS = [{"l":"Total Scouting Ai","v":"3.682","t":"-2.3%","d":"down"},{"l":"Draft Model Ativos","v":"4.785","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"86.1%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"66","t":"+5.3%","d":"up"}];
const COLS = ["ID","Draft Model","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Scouting Ai #001","Scouting Ai #002","6.306","318","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Scouting Ai #002","Scouting Ai #003","3.617","3.042","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Scouting Ai #003","Scouting Ai #004","1.457","6.449","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Scouting Ai #004","Scouting Ai #005","7.659","143","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Scouting Ai #005","Scouting Ai #001","3.594","3.935","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":909},{"label":"Mar","value":788},{"label":"Abr","value":653},{"label":"Mai","value":923},{"label":"Jun","value":681},{"label":"Jul","value":863},{"label":"Ago","value":792},{"label":"Set","value":836},{"label":"Out","value":603},{"label":"Nov","value":696},{"label":"Dez","value":926}];
const MX = 926;
