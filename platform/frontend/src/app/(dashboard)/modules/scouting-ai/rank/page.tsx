...
const PAGE = "Prospect Rank";
const KPIS = [{"l":"Total Scouting Ai","v":"7.713","t":"+6.2%","d":"up"},{"l":"Prospect Rank Ativos","v":"1.512","t":"+6.2%","d":"up"},{"l":"Eficiência (%)","v":"77.9%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"92","t":"+14.6%","d":"up"}];
const COLS = ["ID","Prospect Rank","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Scouting Ai #001","Scouting Ai #002","6.566","4.614","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Scouting Ai #002","Scouting Ai #003","815","1.587","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Scouting Ai #003","Scouting Ai #004","201","7.196","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Scouting Ai #004","Scouting Ai #005","6.800","9.050","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Scouting Ai #005","Scouting Ai #001","2.357","5.080","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":945},{"label":"Fev","value":724},{"label":"Mar","value":702},{"label":"Abr","value":1009},{"label":"Mai","value":974},{"label":"Jun","value":711},{"label":"Jul","value":895},{"label":"Ago","value":1028},{"label":"Set","value":701},{"label":"Out","value":999},{"label":"Nov","value":925},{"label":"Dez","value":712}];
const MX = 1028;
