...
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"2.876","t":"+9.4%","d":"up"},{"l":"Taxa Entrega (%)","v":"68.8%","t":"+2.4%","d":"up"},{"l":"Taxa Abertura (%)","v":"82.3%","t":"-5.1%","d":"down"},{"l":"Escalações","v":"5.494","t":"+1.5%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","6.603","83.4%","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","335","87.8%","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","6.155","70.5%","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","794","91.8%","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","7.843","72.4%","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":429},{"label":"Fev","value":590},{"label":"Mar","value":287},{"label":"Abr","value":611},{"label":"Mai","value":503},{"label":"Jun","value":256},{"label":"Jul","value":435},{"label":"Ago","value":446},{"label":"Set","value":432},{"label":"Out","value":627},{"label":"Nov","value":449},{"label":"Dez","value":399}];
const MX = 627;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>RTM</span></h1>
                </div>
