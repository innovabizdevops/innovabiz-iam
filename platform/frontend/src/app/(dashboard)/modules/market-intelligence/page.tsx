...
const KPIS = [
    { label: "Total Registos", value: "2127", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2969", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€275K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1354015127", cells: ["MAR-2127", "Market Intelligence Platform Item 1", "4/12/2026", "€15 227"], status: "active" as const },
    { id: "1354018698", cells: ["MAR-5698", "Market Intelligence Platform Item 2", "19/7/2026", "€18 798"], status: "pending" as const },
    { id: "1354022269", cells: ["MAR-9269", "Market Intelligence Platform Item 3", "6/2/2026", "€22 369"], status: "completed" as const },
    { id: "1354025840", cells: ["MAR-3840", "Market Intelligence Platform Item 4", "21/9/2026", "€25 940"], status: "warning" as const },
    { id: "1354029411", cells: ["MAR-7411", "Market Intelligence Platform Item 5", "8/4/2026", "€29 511"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Market Intelligence Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Market Intelligence Platform</p>
                    </div>
                </div>
