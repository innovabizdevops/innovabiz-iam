...
const ACCENT = "#0891b2";
const MODULE = "Market Intelligence Platform";
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"4.386","t":"+3.1%","d":"up"},{"l":"Queries/Dia","v":"200","t":"+1.6%","d":"up"},{"l":"Dados Processados (GB)","v":"6.523","t":"+7.4%","d":"up"},{"l":"Utilizadores Analytics","v":"141","t":"+15.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4358","2026-01-03","3.415","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2064","2026-02-11","6.450","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","586","2026-01-19","4.086","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1444","2026-03-13","1.982","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","492","2026-01-02","5.361","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":307},{"label":"Fev","value":269},{"label":"Mar","value":460},{"label":"Abr","value":373},{"label":"Mai","value":501},{"label":"Jun","value":317},{"label":"Jul","value":472},{"label":"Ago","value":636},{"label":"Set","value":413},{"label":"Out","value":389},{"label":"Nov","value":444},{"label":"Dez","value":425}];
const MX = 636;
