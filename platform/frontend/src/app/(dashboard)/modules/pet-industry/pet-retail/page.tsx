...
/* ═══ Pet Industry — Pet Retail ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "4413", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "41", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2148", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "852970757", cells: ["PET-5757", "Pet Retail Item 1", "10/6/2026", "€20 857"], status: "active" as const },
    { id: "852974328", cells: ["PET-9328", "Pet Retail Item 2", "25/1/2026", "€24 428"], status: "pending" as const },
    { id: "852977899", cells: ["PET-3899", "Pet Retail Item 3", "12/8/2026", "€27 999"], status: "completed" as const },
    { id: "852981470", cells: ["PET-7470", "Pet Retail Item 4", "27/3/2026", "€31 570"], status: "warning" as const },
    { id: "852985041", cells: ["PET-2041", "Pet Retail Item 5", "14/10/2026", "€35 141"], status: "active" as const },
];
...
export default function PetIndustryPetRetailPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pet Retail</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pet Industry • Pet Retail</p>
                    </div>
                </div>
