...
/* ═══ Pet Industry — Pet Wellness ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "1296", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "269", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2172", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "728467545", cells: ["PET-8545", "Pet Wellness Item 1", "2/10/2026", "€17 645"], status: "active" as const },
    { id: "728471116", cells: ["PET-3116", "Pet Wellness Item 2", "17/5/2026", "€21 216"], status: "pending" as const },
    { id: "728474687", cells: ["PET-6687", "Pet Wellness Item 3", "4/12/2026", "€24 787"], status: "completed" as const },
    { id: "728478258", cells: ["PET-1258", "Pet Wellness Item 4", "19/7/2026", "€28 358"], status: "warning" as const },
    { id: "728481829", cells: ["PET-4829", "Pet Wellness Item 5", "6/2/2026", "€31 929"], status: "active" as const },
];
...
export default function PetIndustryPetWellnessPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pet Wellness</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pet Industry • Pet Wellness</p>
                    </div>
                </div>
