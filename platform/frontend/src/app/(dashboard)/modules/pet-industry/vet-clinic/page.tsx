...
/* ═══ Pet Industry — Vet Clinic ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "1697", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "128", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3931", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "749398108", cells: ["PET-5108", "Vet Clinic Item 1", "5/5/2026", "€48 208"], status: "active" as const },
    { id: "749401679", cells: ["PET-8679", "Vet Clinic Item 2", "20/12/2026", "€1779"], status: "pending" as const },
    { id: "749405250", cells: ["PET-3250", "Vet Clinic Item 3", "7/7/2026", "€5350"], status: "completed" as const },
    { id: "749408821", cells: ["PET-6821", "Vet Clinic Item 4", "22/2/2026", "€8921"], status: "warning" as const },
    { id: "749412392", cells: ["PET-1392", "Vet Clinic Item 5", "9/9/2026", "€12 492"], status: "active" as const },
];
...
export default function PetIndustryVetClinicPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Vet Clinic</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pet Industry • Vet Clinic</p>
                    </div>
                </div>
