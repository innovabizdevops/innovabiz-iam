...
/* ═══ Pet Industry — Pet Food Mfg ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "3349", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "402", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3398", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "69782158", cells: ["PET-6158", "Pet Food Mfg Item 1", "27/11/2026", "€32 258"], status: "active" as const },
    { id: "69785729", cells: ["PET-9729", "Pet Food Mfg Item 2", "14/6/2026", "€35 829"], status: "pending" as const },
    { id: "69789300", cells: ["PET-4300", "Pet Food Mfg Item 3", "1/1/2026", "€39 400"], status: "completed" as const },
    { id: "69792871", cells: ["PET-7871", "Pet Food Mfg Item 4", "16/8/2026", "€42 971"], status: "warning" as const },
    { id: "69796442", cells: ["PET-2442", "Pet Food Mfg Item 5", "3/3/2026", "€46 542"], status: "active" as const },
];
...
export default function PetIndustryPetFoodMfgPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pet Food Mfg</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pet Industry • Pet Food Mfg</p>
                    </div>
                </div>
