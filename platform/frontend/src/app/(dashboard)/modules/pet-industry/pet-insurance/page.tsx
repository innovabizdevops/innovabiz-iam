...
const KPIS = [
    { label: "Total", value: "4974", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "236", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "710", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "888884328", cells: ["PET-9328", "Pet Insurance Item 1", "25/1/2026", "€34 428"], status: "active" as const },
    { id: "888887899", cells: ["PET-3899", "Pet Insurance Item 2", "12/8/2026", "€37 999"], status: "pending" as const },
    { id: "888891470", cells: ["PET-7470", "Pet Insurance Item 3", "27/3/2026", "€41 570"], status: "completed" as const },
    { id: "888895041", cells: ["PET-2041", "Pet Insurance Item 4", "14/10/2026", "€45 141"], status: "warning" as const },
    { id: "888898612", cells: ["PET-5612", "Pet Insurance Item 5", "1/5/2026", "€48 712"], status: "active" as const },
];
...
export default function PetIndustryPetInsurancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pet Insurance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pet Industry • Pet Insurance</p>
                    </div>
                </div>
