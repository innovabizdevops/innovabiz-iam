...
/* ═══ Pet Industry — Pet Adoption ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "2183", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "330", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "962", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1213328934", cells: ["PET-3934", "Pet Adoption Item 1", "7/7/2026", "€29 034"], status: "active" as const },
    { id: "1213332505", cells: ["PET-7505", "Pet Adoption Item 2", "22/2/2026", "€32 605"], status: "pending" as const },
    { id: "1213336076", cells: ["PET-2076", "Pet Adoption Item 3", "9/9/2026", "€36 176"], status: "completed" as const },
    { id: "1213339647", cells: ["PET-5647", "Pet Adoption Item 4", "24/4/2026", "€39 747"], status: "warning" as const },
    { id: "1213343218", cells: ["PET-9218", "Pet Adoption Item 5", "11/11/2026", "€43 318"], status: "active" as const },
];
...
export default function PetIndustryPetAdoptionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pet Adoption</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pet Industry • Pet Adoption</p>
                    </div>
                </div>
