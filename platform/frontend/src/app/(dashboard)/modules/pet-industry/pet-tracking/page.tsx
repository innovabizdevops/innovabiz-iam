...
/* ═══ Pet Industry — Pet Tracking ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "4895", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "445", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2042", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "962363961", cells: ["PET-3961", "Pet Tracking Item 1", "14/10/2026", "€14 061"], status: "active" as const },
    { id: "962367532", cells: ["PET-7532", "Pet Tracking Item 2", "1/5/2026", "€17 632"], status: "pending" as const },
    { id: "962371103", cells: ["PET-2103", "Pet Tracking Item 3", "16/12/2026", "€21 203"], status: "completed" as const },
    { id: "962374674", cells: ["PET-5674", "Pet Tracking Item 4", "3/7/2026", "€24 774"], status: "warning" as const },
    { id: "962378245", cells: ["PET-9245", "Pet Tracking Item 5", "18/2/2026", "€28 345"], status: "active" as const },
];
...
export default function PetIndustryPetTrackingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pet Tracking</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pet Industry • Pet Tracking</p>
                    </div>
                </div>
