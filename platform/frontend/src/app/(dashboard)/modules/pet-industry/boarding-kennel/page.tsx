...
/* ═══ Pet Industry — Boarding Kennel ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "325", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "88", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3411", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "197362468", cells: ["PET-2468", "Boarding Kennel Item 1", "17/5/2026", "€12 568"], status: "active" as const },
    { id: "197366039", cells: ["PET-6039", "Boarding Kennel Item 2", "4/12/2026", "€16 139"], status: "pending" as const },
    { id: "197369610", cells: ["PET-9610", "Boarding Kennel Item 3", "19/7/2026", "€19 710"], status: "completed" as const },
    { id: "197373181", cells: ["PET-4181", "Boarding Kennel Item 4", "6/2/2026", "€23 281"], status: "warning" as const },
    { id: "197376752", cells: ["PET-7752", "Boarding Kennel Item 5", "21/9/2026", "€26 852"], status: "active" as const },
];
...
export default function PetIndustryBoardingKennelPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Boarding Kennel</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pet Industry • Boarding Kennel</p>
                    </div>
                </div>
