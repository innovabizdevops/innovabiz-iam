...
/* ═══ Pet Industry — Pet Health ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "3610", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "130", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "660", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "566124126", cells: ["PET-7126", "Pet Health Item 1", "23/7/2026", "€24 226"], status: "active" as const },
    { id: "566127697", cells: ["PET-1697", "Pet Health Item 2", "10/2/2026", "€27 797"], status: "pending" as const },
    { id: "566131268", cells: ["PET-5268", "Pet Health Item 3", "25/9/2026", "€31 368"], status: "completed" as const },
    { id: "566134839", cells: ["PET-8839", "Pet Health Item 4", "12/4/2026", "€34 939"], status: "warning" as const },
    { id: "566138410", cells: ["PET-3410", "Pet Health Item 5", "27/11/2026", "€38 510"], status: "active" as const },
];
...
export default function PetIndustryPetHealthPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pet Health</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pet Industry • Pet Health</p>
                    </div>
                </div>
