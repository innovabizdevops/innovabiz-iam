...
/* ═══ Pet Industry — Grooming Ops ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "4181", trend: "-19%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "257", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1650", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "70%", trend: "-1%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "560725293", cells: ["PET-8293", "Grooming Ops Item 1", "10/10/2026", "€25 393"], status: "active" as const },
    { id: "560728864", cells: ["PET-2864", "Grooming Ops Item 2", "25/5/2026", "€28 964"], status: "pending" as const },
    { id: "560732435", cells: ["PET-6435", "Grooming Ops Item 3", "12/12/2026", "€32 535"], status: "completed" as const },
    { id: "560736006", cells: ["PET-1006", "Grooming Ops Item 4", "27/7/2026", "€36 106"], status: "warning" as const },
    { id: "560739577", cells: ["PET-4577", "Grooming Ops Item 5", "14/2/2026", "€39 677"], status: "active" as const },
];
...
export default function PetIndustryGroomingOpsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Grooming Ops</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pet Industry • Grooming Ops</p>
                    </div>
                </div>
