...
export default function EnvCompliancePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Env Compliance</h1><p className="text-sm text-muted-foreground">Env Compliance • iBOS Enterprise</p></div>
