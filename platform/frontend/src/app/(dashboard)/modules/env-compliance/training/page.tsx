...
const PAGE = "Training";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.634","t":"+4.6%","d":"up"},{"l":"NC Abertas","v":"7.887","t":"-4.1%","d":"down"},{"l":"Conformidade (%)","v":"86.7%","t":"+11.0%","d":"up"},{"l":"CAPAs Pendentes","v":"6.702","t":"+3.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.701","74.4%","5.766","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.586","88.6%","6.797","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.989","91.2%","8.589","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.081","91.6%","5.511","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.337","82.8%","6.129","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":988},{"label":"Fev","value":740},{"label":"Mar","value":723},{"label":"Abr","value":756},{"label":"Mai","value":954},{"label":"Jun","value":768},{"label":"Jul","value":930},{"label":"Ago","value":952},{"label":"Set","value":723},{"label":"Out","value":849},{"label":"Nov","value":711},{"label":"Dez","value":842}];
const MX = 988;
