...
const ACCENT = "#6366f1";
const MODULE = "Env Compliance";
const PAGE = "Permit";
const KPIS = [{"l":"Riscos Identificados","v":"4.850","t":"+9.3%","d":"up"},{"l":"Mitigações Ativas","v":"4.954","t":"-2.1%","d":"down"},{"l":"Score Risco Geral","v":"63","t":"+12.7%","d":"up"},{"l":"Incidentes YTD","v":"8.524","t":"+14.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.931","1.591","8.095","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.599","5.274","6.798","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.070","3.239","6.450","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.537","2.940","3.927","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","544","3.981","4.596","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1032},{"label":"Fev","value":711},{"label":"Mar","value":940},{"label":"Abr","value":982},{"label":"Mai","value":920},{"label":"Jun","value":755},{"label":"Jul","value":964},{"label":"Ago","value":772},{"label":"Set","value":725},{"label":"Out","value":981},{"label":"Nov","value":780},{"label":"Dez","value":674}];
const MX = 1032;
