...
const PAGE = "Incident";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.958","t":"+2.6%","d":"up"},{"l":"NC Abertas","v":"6.968","t":"+1.1%","d":"up"},{"l":"Conformidade (%)","v":"87.3%","t":"-3.5%","d":"down"},{"l":"CAPAs Pendentes","v":"4.303","t":"-1.7%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.442","74.6%","3.532","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.117","85.6%","4.653","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.346","77.3%","8.778","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","9.022","98.1%","6.501","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.834","78.4%","7.691","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":410},{"label":"Mar","value":387},{"label":"Abr","value":604},{"label":"Mai","value":411},{"label":"Jun","value":418},{"label":"Jul","value":659},{"label":"Ago","value":663},{"label":"Set","value":577},{"label":"Out","value":596},{"label":"Nov","value":435},{"label":"Dez","value":304}];
const MX = 663;
