...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.396","t":"-5.8%","d":"down"},{"l":"NC Abertas","v":"4.218","t":"+5.1%","d":"up"},{"l":"Conformidade (%)","v":"70.4%","t":"-1.4%","d":"down"},{"l":"CAPAs Pendentes","v":"7.811","t":"+2.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.268","86.2%","3.327","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.329","81.0%","6.511","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.129","95.2%","6.686","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.379","82.5%","5.457","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.080","77.7%","8.367","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":868},{"label":"Mar","value":989},{"label":"Abr","value":868},{"label":"Mai","value":819},{"label":"Jun","value":880},{"label":"Jul","value":625},{"label":"Ago","value":766},{"label":"Set","value":907},{"label":"Out","value":784},{"label":"Nov","value":796},{"label":"Dez","value":771}];
const MX = 989;
