...
const PAGE = "Memory";
const KPIS = [{"l":"Total Agent Builder","v":"4.075","t":"-3.0%","d":"down"},{"l":"Memory Ativos","v":"8.050","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"90.8%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"92","t":"+15.9%","d":"up"}];
const COLS = ["ID","Memory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agent Builder #001","Agent Builder #002","4.729","931","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Agent Builder #002","Agent Builder #003","7.477","856","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Agent Builder #003","Agent Builder #004","8.520","2.641","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Agent Builder #004","Agent Builder #005","4.672","4.633","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agent Builder #005","Agent Builder #001","1.990","424","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":579},{"label":"Mar","value":591},{"label":"Abr","value":657},{"label":"Mai","value":764},{"label":"Jun","value":617},{"label":"Jul","value":577},{"label":"Ago","value":790},{"label":"Set","value":767},{"label":"Out","value":526},{"label":"Nov","value":572},{"label":"Dez","value":502}];
const MX = 790;
