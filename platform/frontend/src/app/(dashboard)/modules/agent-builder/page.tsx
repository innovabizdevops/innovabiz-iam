...
/* ═══ AI Agent Builder Studio — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "234", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3285", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€490K", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1150845434", cells: ["AGE-7434", "AI Agent Builder Studio Item 1", "19/3/2026", "€45 534"], status: "active" as const },
    { id: "1150849005", cells: ["AGE-2005", "AI Agent Builder Studio Item 2", "6/10/2026", "€49 105"], status: "pending" as const },
    { id: "1150852576", cells: ["AGE-5576", "AI Agent Builder Studio Item 3", "21/5/2026", "€2676"], status: "completed" as const },
    { id: "1150856147", cells: ["AGE-9147", "AI Agent Builder Studio Item 4", "8/12/2026", "€6247"], status: "warning" as const },
    { id: "1150859718", cells: ["AGE-3718", "AI Agent Builder Studio Item 5", "23/7/2026", "€9818"], status: "active" as const },
];
...
export default function AiAgentBuilderStudioPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Agent Builder Studio</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Agent Builder Studio</p>
                    </div>
                </div>
