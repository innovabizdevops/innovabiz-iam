...
const PAGE = "Chain";
const KPIS = [{"l":"Total Agent Builder","v":"7.244","t":"+10.7%","d":"up"},{"l":"Chain Ativos","v":"9.035","t":"+2.8%","d":"up"},{"l":"Eficiência (%)","v":"92.3%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"69","t":"+6.6%","d":"up"}];
const COLS = ["ID","Chain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agent Builder #001","Agent Builder #002","5.404","1.430","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Agent Builder #002","Agent Builder #003","2.069","5.857","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Agent Builder #003","Agent Builder #004","9.027","8.854","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Agent Builder #004","Agent Builder #005","2.579","7.036","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agent Builder #005","Agent Builder #001","6.715","2.129","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":689},{"label":"Fev","value":378},{"label":"Mar","value":482},{"label":"Abr","value":416},{"label":"Mai","value":458},{"label":"Jun","value":393},{"label":"Jul","value":312},{"label":"Ago","value":417},{"label":"Set","value":474},{"label":"Out","value":370},{"label":"Nov","value":563},{"label":"Dez","value":455}];
const MX = 689;
