...
const ACCENT = "#7c3aed";
const MODULE = "AI Agent Builder Studio";
const PAGE = "Deploy";
const KPIS = [{"l":"Total Agent Builder","v":"4.311","t":"+13.7%","d":"up"},{"l":"Deploy Ativos","v":"796","t":"+10.6%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"+9.7%","d":"up"},{"l":"Score Performance","v":"78","t":"-3.9%","d":"down"}];
const COLS = ["ID","Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agent Builder #001","Agent Builder #002","469","1.250","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Agent Builder #002","Agent Builder #003","2.089","6.051","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Agent Builder #003","Agent Builder #004","8.269","6.763","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Agent Builder #004","Agent Builder #005","7.234","4.076","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agent Builder #005","Agent Builder #001","5.762","4.855","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":878},{"label":"Mar","value":566},{"label":"Abr","value":571},{"label":"Mai","value":593},{"label":"Jun","value":691},{"label":"Jul","value":662},{"label":"Ago","value":535},{"label":"Set","value":771},{"label":"Out","value":537},{"label":"Nov","value":534},{"label":"Dez","value":609}];
const MX = 878;
