...
const PAGE = "Tool";
const KPIS = [{"l":"Total Agent Builder","v":"7.365","t":"-1.1%","d":"down"},{"l":"Tool Ativos","v":"1.605","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"65.7%","t":"+14.0%","d":"up"},{"l":"Score Performance","v":"55","t":"+1.3%","d":"up"}];
const COLS = ["ID","Tool","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agent Builder #001","Agent Builder #002","4.591","3.429","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Agent Builder #002","Agent Builder #003","1.965","2.912","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Agent Builder #003","Agent Builder #004","6.692","3.372","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Agent Builder #004","Agent Builder #005","109","185","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agent Builder #005","Agent Builder #001","8.183","7.801","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":779},{"label":"Mar","value":650},{"label":"Abr","value":528},{"label":"Mai","value":642},{"label":"Jun","value":601},{"label":"Jul","value":648},{"label":"Ago","value":831},{"label":"Set","value":531},{"label":"Out","value":666},{"label":"Nov","value":444},{"label":"Dez","value":507}];
const MX = 831;
