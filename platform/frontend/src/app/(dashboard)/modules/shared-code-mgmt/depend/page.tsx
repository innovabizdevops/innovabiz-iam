...
const PAGE = "Depend";
const KPIS = [{"l":"Total Shared Code Mgmt","v":"6.215","t":"+14.8%","d":"up"},{"l":"Depend Ativos","v":"5.491","t":"+2.8%","d":"up"},{"l":"Eficiência (%)","v":"94.9%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"91","t":"+11.2%","d":"up"}];
const COLS = ["ID","Depend","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Shared Code Mgmt #001","Shared Code Mgmt #002","3.990","5.511","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Shared Code Mgmt #002","Shared Code Mgmt #003","2.871","892","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Shared Code Mgmt #003","Shared Code Mgmt #004","7.671","8.634","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Shared Code Mgmt #004","Shared Code Mgmt #005","1.291","1.563","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Shared Code Mgmt #005","Shared Code Mgmt #001","1.369","8.551","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":288},{"label":"Mar","value":602},{"label":"Abr","value":448},{"label":"Mai","value":535},{"label":"Jun","value":443},{"label":"Jul","value":293},{"label":"Ago","value":323},{"label":"Set","value":303},{"label":"Out","value":380},{"label":"Nov","value":386},{"label":"Dez","value":610}];
const MX = 610;
