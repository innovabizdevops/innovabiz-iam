...
/* ═══ Shared Code Platform — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "8904", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2357", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€356K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "539964704", cells: ["SHA-1704", "Shared Code Platform Item 1", "21/9/2026", "€14 804"], status: "active" as const },
    { id: "539968275", cells: ["SHA-5275", "Shared Code Platform Item 2", "8/4/2026", "€18 375"], status: "pending" as const },
    { id: "539971846", cells: ["SHA-8846", "Shared Code Platform Item 3", "23/11/2026", "€21 946"], status: "completed" as const },
    { id: "539975417", cells: ["SHA-3417", "Shared Code Platform Item 4", "10/6/2026", "€25 517"], status: "warning" as const },
    { id: "539978988", cells: ["SHA-6988", "Shared Code Platform Item 5", "25/1/2026", "€29 088"], status: "active" as const },
];
...
export default function SharedCodePlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Shared Code Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Shared Code Platform</p>
                    </div>
                </div>
