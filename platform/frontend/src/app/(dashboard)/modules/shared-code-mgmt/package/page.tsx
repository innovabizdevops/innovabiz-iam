...
const PAGE = "Package";
const KPIS = [{"l":"Total Shared Code Mgmt","v":"5.927","t":"+10.2%","d":"up"},{"l":"Package Ativos","v":"4.548","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"69.2%","t":"+4.5%","d":"up"},{"l":"Score Performance","v":"78","t":"+9.7%","d":"up"}];
const COLS = ["ID","Package","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Shared Code Mgmt #001","Shared Code Mgmt #002","377","8.996","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Shared Code Mgmt #002","Shared Code Mgmt #003","1.327","2.194","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Shared Code Mgmt #003","Shared Code Mgmt #004","8.274","5.637","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Shared Code Mgmt #004","Shared Code Mgmt #005","6.797","7.463","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Shared Code Mgmt #005","Shared Code Mgmt #001","8.625","4.290","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":575},{"label":"Mar","value":489},{"label":"Abr","value":781},{"label":"Mai","value":670},{"label":"Jun","value":619},{"label":"Jul","value":558},{"label":"Ago","value":696},{"label":"Set","value":674},{"label":"Out","value":620},{"label":"Nov","value":568},{"label":"Dez","value":855}];
const MX = 855;
