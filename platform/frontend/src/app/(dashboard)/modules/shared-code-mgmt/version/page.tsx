...
const ACCENT = "#059669";
const MODULE = "Shared Code Platform";
const PAGE = "Version";
const KPIS = [{"l":"Formulários Ativos","v":"8.661","t":"+7.3%","d":"up"},{"l":"Submissões/Dia","v":"1038","t":"-1.0%","d":"down"},{"l":"Documentos Gerados","v":"1.737","t":"+4.7%","d":"up"},{"l":"Templates","v":"723","t":"+15.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.260","2026-03-20","7.937","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.212","2026-02-15","7.500","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.652","2026-02-21","3.881","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.974","2026-02-27","6.757","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.256","2026-03-12","4.913","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":450},{"label":"Fev","value":565},{"label":"Mar","value":454},{"label":"Abr","value":722},{"label":"Mai","value":600},{"label":"Jun","value":468},{"label":"Jul","value":511},{"label":"Ago","value":507},{"label":"Set","value":773},{"label":"Out","value":676},{"label":"Nov","value":498},{"label":"Dez","value":579}];
const MX = 773;
