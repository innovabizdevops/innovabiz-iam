...
const PAGE = "Publish";
const KPIS = [{"l":"Total Shared Code Mgmt","v":"8.167","t":"+16.0%","d":"up"},{"l":"Publish Ativos","v":"834","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"68.3%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"84","t":"+16.6%","d":"up"}];
const COLS = ["ID","Publish","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Shared Code Mgmt #001","Shared Code Mgmt #002","4.644","491","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Shared Code Mgmt #002","Shared Code Mgmt #003","6.268","8.077","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Shared Code Mgmt #003","Shared Code Mgmt #004","4.163","1.295","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Shared Code Mgmt #004","Shared Code Mgmt #005","790","6.301","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Shared Code Mgmt #005","Shared Code Mgmt #001","3.992","3.436","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":837},{"label":"Fev","value":1006},{"label":"Mar","value":769},{"label":"Abr","value":1042},{"label":"Mai","value":954},{"label":"Jun","value":1069},{"label":"Jul","value":840},{"label":"Ago","value":851},{"label":"Set","value":775},{"label":"Out","value":798},{"label":"Nov","value":1067},{"label":"Dez","value":957}];
const MX = 1069;
