...
export default function SurveyorSvcPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Surveyor Svc</h1><p className="text-sm text-muted-foreground">Surveyor Svc • iBOS Enterprise</p></div>
