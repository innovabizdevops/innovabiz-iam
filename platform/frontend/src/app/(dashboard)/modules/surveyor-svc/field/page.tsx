...
const ACCENT = "#6366f1";
const MODULE = "Surveyor Services";
const PAGE = "Field";
const KPIS = [{"l":"Surveys Ativos","v":"3.012","t":"+15.9%","d":"up"},{"l":"Respostas/Semana","v":"1463","t":"+1.5%","d":"up"},{"l":"NPS Médio","v":"55","t":"+5.2%","d":"up"},{"l":"Taxa Resposta (%)","v":"74.0%","t":"-1.6%","d":"down"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","6.870","67","93.1%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","623","71","91.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","3.435","80","71.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","367","86","72.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","1.014","58","71.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":972},{"label":"Mar","value":687},{"label":"Abr","value":808},{"label":"Mai","value":633},{"label":"Jun","value":869},{"label":"Jul","value":950},{"label":"Ago","value":718},{"label":"Set","value":813},{"label":"Out","value":771},{"label":"Nov","value":1016},{"label":"Dez","value":996}];
const MX = 1016;
