...
const KPIS = [{"l":"Surveys Ativos","v":"7.528","t":"-3.9%","d":"down"},{"l":"Respostas/Semana","v":"3542","t":"-1.8%","d":"down"},{"l":"NPS Médio","v":"83","t":"+6.3%","d":"up"},{"l":"Taxa Resposta (%)","v":"85.2%","t":"+1.8%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","4.137","65","90.8%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","6.222","58","89.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","2.105","76","79.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","4.610","89","73.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","3.185","66","92.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":412},{"label":"Fev","value":352},{"label":"Mar","value":509},{"label":"Abr","value":543},{"label":"Mai","value":702},{"label":"Jun","value":557},{"label":"Jul","value":736},{"label":"Ago","value":488},{"label":"Set","value":719},{"label":"Out","value":671},{"label":"Nov","value":681},{"label":"Dez","value":594}];
const MX = 736;
