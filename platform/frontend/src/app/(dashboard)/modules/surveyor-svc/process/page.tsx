...
const PAGE = "Process";
const KPIS = [{"l":"Surveys Ativos","v":"6.849","t":"+2.9%","d":"up"},{"l":"Respostas/Semana","v":"3605","t":"-0.6%","d":"down"},{"l":"NPS Médio","v":"82","t":"-1.3%","d":"down"},{"l":"Taxa Resposta (%)","v":"83.9%","t":"+15.7%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","2.950","91","83.7%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","2.446","86","89.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","7.634","74","80.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","1.261","72","82.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","7.329","71","80.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":505},{"label":"Mar","value":715},{"label":"Abr","value":473},{"label":"Mai","value":658},{"label":"Jun","value":737},{"label":"Jul","value":678},{"label":"Ago","value":423},{"label":"Set","value":520},{"label":"Out","value":664},{"label":"Nov","value":431},{"label":"Dez","value":423}];
const MX = 737;
