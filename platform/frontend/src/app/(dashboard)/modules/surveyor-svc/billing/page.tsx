...
const PAGE = "Billing";
const KPIS = [{"l":"Surveys Ativos","v":"4.035","t":"+17.9%","d":"up"},{"l":"Respostas/Semana","v":"3642","t":"+13.4%","d":"up"},{"l":"NPS Médio","v":"94","t":"+6.6%","d":"up"},{"l":"Taxa Resposta (%)","v":"88.5%","t":"+5.4%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","1.878","65","90.2%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","5.060","80","97.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","2.570","86","95.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","6.208","61","72.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","6.289","57","88.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":774},{"label":"Mar","value":810},{"label":"Abr","value":816},{"label":"Mai","value":814},{"label":"Jun","value":540},{"label":"Jul","value":456},{"label":"Ago","value":576},{"label":"Set","value":762},{"label":"Out","value":562},{"label":"Nov","value":694},{"label":"Dez","value":476}];
const MX = 816;
