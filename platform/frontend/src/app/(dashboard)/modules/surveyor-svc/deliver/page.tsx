...
const PAGE = "Deliver";
const KPIS = [{"l":"Surveys Ativos","v":"6.462","t":"+7.6%","d":"up"},{"l":"Respostas/Semana","v":"537","t":"+10.1%","d":"up"},{"l":"NPS Médio","v":"63","t":"+10.0%","d":"up"},{"l":"Taxa Resposta (%)","v":"84.6%","t":"-1.0%","d":"down"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","1.988","82","73.2%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","8.120","71","70.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","2.930","57","72.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","5.744","59","85.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","2.841","71","74.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":526},{"label":"Mar","value":364},{"label":"Abr","value":522},{"label":"Mai","value":616},{"label":"Jun","value":647},{"label":"Jul","value":311},{"label":"Ago","value":586},{"label":"Set","value":479},{"label":"Out","value":536},{"label":"Nov","value":402},{"label":"Dez","value":418}];
const MX = 647;
