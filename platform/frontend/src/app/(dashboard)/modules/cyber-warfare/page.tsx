...
const KPIS = [
    ...
    { label: "Ativos", value: "2555", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€494K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1300219913", cells: ["CYB-8913", "Cyber Warfare Item 1", "14/6/2026", "€20 013"], status: "active" as const },
    { id: "1300223484", cells: ["CYB-3484", "Cyber Warfare Item 2", "1/1/2026", "€23 584"], status: "pending" as const },
    { id: "1300227055", cells: ["CYB-7055", "Cyber Warfare Item 3", "16/8/2026", "€27 155"], status: "completed" as const },
    { id: "1300230626", cells: ["CYB-1626", "Cyber Warfare Item 4", "3/3/2026", "€30 726"], status: "warning" as const },
    { id: "1300234197", cells: ["CYB-5197", "Cyber Warfare Item 5", "18/10/2026", "€34 297"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cyber Warfare</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cyber Warfare</p>
                    </div>
                </div>
