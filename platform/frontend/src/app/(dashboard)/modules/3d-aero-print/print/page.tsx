...
const PAGE = "Print";
const KPIS = [{"l":"Total 3d Aero Print","v":"1.285","t":"-3.0%","d":"down"},{"l":"Print Ativos","v":"2.137","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"71.2%","t":"+10.8%","d":"up"},{"l":"Score Performance","v":"76","t":"-2.2%","d":"down"}];
const COLS = ["ID","Print","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Aero Print #001","3d Aero Print #002","2.136","2.233","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["3d Aero Print #002","3d Aero Print #003","6.923","7.950","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Aero Print #003","3d Aero Print #004","3.014","1.588","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["3d Aero Print #004","3d Aero Print #005","3.171","3.776","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Aero Print #005","3d Aero Print #001","1.673","6.365","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":766},{"label":"Mar","value":609},{"label":"Abr","value":640},{"label":"Mai","value":899},{"label":"Jun","value":726},{"label":"Jul","value":899},{"label":"Ago","value":936},{"label":"Set","value":810},{"label":"Out","value":824},{"label":"Nov","value":580},{"label":"Dez","value":635}];
const MX = 936;
