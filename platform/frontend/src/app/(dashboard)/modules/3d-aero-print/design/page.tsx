...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"3.657","t":"+2.6%","d":"up"},{"l":"Submissões/Dia","v":"2137","t":"+16.2%","d":"up"},{"l":"Documentos Gerados","v":"747","t":"-1.9%","d":"down"},{"l":"Templates","v":"6.861","t":"+12.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.801","2026-03-06","739","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.738","2026-01-02","3.421","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.195","2026-02-21","8.036","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.681","2026-01-10","7.794","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.540","2026-03-01","3.566","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":896},{"label":"Fev","value":632},{"label":"Mar","value":765},{"label":"Abr","value":833},{"label":"Mai","value":627},{"label":"Jun","value":955},{"label":"Jul","value":766},{"label":"Ago","value":712},{"label":"Set","value":817},{"label":"Out","value":745},{"label":"Nov","value":770},{"label":"Dez","value":983}];
const MX = 983;
