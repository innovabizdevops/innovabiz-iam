...
/* ═══ Aerospace 3D Printing — Dashboard ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total Registos", value: "8164", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1257", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€106K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1160396964", cells: ["3D-9964", "Aerospace 3D Printing Item 1", "21/1/2026", "€47 064"], status: "active" as const },
    { id: "1160400535", cells: ["3D-4535", "Aerospace 3D Printing Item 2", "8/8/2026", "€635"], status: "pending" as const },
    { id: "1160404106", cells: ["3D-8106", "Aerospace 3D Printing Item 3", "23/3/2026", "€4206"], status: "completed" as const },
    { id: "1160407677", cells: ["3D-2677", "Aerospace 3D Printing Item 4", "10/10/2026", "€7777"], status: "warning" as const },
    { id: "1160411248", cells: ["3D-6248", "Aerospace 3D Printing Item 5", "25/5/2026", "€11 348"], status: "active" as const },
];
...
export default function Aerospace3dPrintingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Aerospace 3D Printing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Aerospace 3D Printing</p>
                    </div>
                </div>
