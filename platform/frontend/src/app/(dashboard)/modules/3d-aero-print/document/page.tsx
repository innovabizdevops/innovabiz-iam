...
const ACCENT = "#4338ca";
const MODULE = "Aerospace 3D Printing";
const PAGE = "Document";
const KPIS = [{"l":"Formulários Ativos","v":"3.915","t":"-3.2%","d":"down"},{"l":"Submissões/Dia","v":"3349","t":"+14.5%","d":"up"},{"l":"Documentos Gerados","v":"3.674","t":"+1.2%","d":"up"},{"l":"Templates","v":"7.987","t":"+17.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.986","2026-01-17","5.062","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.415","2026-03-04","5.029","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.494","2026-02-08","1.866","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.110","2026-03-19","3.137","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.259","2026-01-20","8.663","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":656},{"label":"Mar","value":580},{"label":"Abr","value":637},{"label":"Mai","value":720},{"label":"Jun","value":546},{"label":"Jul","value":722},{"label":"Ago","value":760},{"label":"Set","value":616},{"label":"Out","value":580},{"label":"Nov","value":438},{"label":"Dez","value":719}];
const MX = 760;
