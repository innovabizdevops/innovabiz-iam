...
const PAGE = "Zone";
const KPIS = [{"l":"ARR (€M)","v":"€47.2M","t":"+12.3%","d":"up"},{"l":"MRR (€)","v":"€79005","t":"-1.2%","d":"down"},{"l":"Churn (%)","v":"67.5%","t":"+11.4%","d":"up"},{"l":"ARPU (€)","v":"€63924","t":"+14.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 32665.57","705","€ 28703.40","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 6740.10","4.428","€ 1847.81","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 18988.99","767","€ 26943.10","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 10743.03","5.641","€ 33111.76","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 33348.67","808","€ 6910.60","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":780},{"label":"Mar","value":772},{"label":"Abr","value":574},{"label":"Mai","value":746},{"label":"Jun","value":515},{"label":"Jul","value":427},{"label":"Ago","value":513},{"label":"Set","value":449},{"label":"Out","value":454},{"label":"Nov","value":604},{"label":"Dez","value":790}];
const MX = 790;
