...
const PAGE = "Margin";
const KPIS = [{"l":"ARR (€M)","v":"€15.4M","t":"+2.9%","d":"up"},{"l":"MRR (€)","v":"€81303","t":"+0.1%","d":"up"},{"l":"Churn (%)","v":"93.9%","t":"+7.6%","d":"up"},{"l":"ARPU (€)","v":"€62810","t":"+9.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 45427.57","7.988","€ 48182.83","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 37411.99","8.626","€ 35066.69","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 16739.01","895","€ 21292.41","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 31635.24","3.029","€ 19120.33","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 4196.27","1.702","€ 37778.95","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":545},{"label":"Fev","value":727},{"label":"Mar","value":366},{"label":"Abr","value":488},{"label":"Mai","value":646},{"label":"Jun","value":699},{"label":"Jul","value":622},{"label":"Ago","value":650},{"label":"Set","value":566},{"label":"Out","value":619},{"label":"Nov","value":715},{"label":"Dez","value":731}];
const MX = 731;
