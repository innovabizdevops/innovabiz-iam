...
const PAGE = "Promo";
const KPIS = [{"l":"ARR (€M)","v":"€30.2M","t":"+16.8%","d":"up"},{"l":"MRR (€)","v":"€79831","t":"+4.7%","d":"up"},{"l":"Churn (%)","v":"67.3%","t":"+12.1%","d":"up"},{"l":"ARPU (€)","v":"€81552","t":"+4.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 41214.32","289","€ 24012.15","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 21853.16","6.553","€ 19011.92","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 39657.17","4.227","€ 47757.25","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 45612.42","8.802","€ 42771.54","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 35804.65","9.064","€ 24125.76","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":751},{"label":"Mar","value":684},{"label":"Abr","value":421},{"label":"Mai","value":447},{"label":"Jun","value":689},{"label":"Jul","value":689},{"label":"Ago","value":557},{"label":"Set","value":777},{"label":"Out","value":555},{"label":"Nov","value":524},{"label":"Dez","value":746}];
const MX = 777;
