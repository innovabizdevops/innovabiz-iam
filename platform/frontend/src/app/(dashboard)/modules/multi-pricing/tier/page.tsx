...
const PAGE = "Tier";
const KPIS = [{"l":"ARR (€M)","v":"€27.1M","t":"+4.6%","d":"up"},{"l":"MRR (€)","v":"€87204","t":"-0.9%","d":"down"},{"l":"Churn (%)","v":"76.6%","t":"+5.9%","d":"up"},{"l":"ARPU (€)","v":"€76344","t":"+0.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 21624.53","8.838","€ 8632.81","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 26396.87","5.165","€ 25513.90","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 6463.42","2.369","€ 48437.68","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 42424.46","8.122","€ 11321.62","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 24017.61","3.827","€ 1395.26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":554},{"label":"Mar","value":698},{"label":"Abr","value":603},{"label":"Mai","value":494},{"label":"Jun","value":710},{"label":"Jul","value":589},{"label":"Ago","value":627},{"label":"Set","value":852},{"label":"Out","value":572},{"label":"Nov","value":745},{"label":"Dez","value":853}];
const MX = 853;
