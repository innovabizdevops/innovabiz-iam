...
/* ═══ Multi-Pricing Engine — Dashboard ═══ */

const ACCENT = "#0ea5e9";

const KPIS = [
    { label: "Total Registos", value: "3617", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "576", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€199K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1705387417", cells: ["MUL-5417", "Multi-Pricing Engine Item 1", "14/2/2026", "€37 517"], status: "active" as const },
    { id: "1705390988", cells: ["MUL-8988", "Multi-Pricing Engine Item 2", "1/9/2026", "€41 088"], status: "pending" as const },
    { id: "1705394559", cells: ["MUL-3559", "Multi-Pricing Engine Item 3", "16/4/2026", "€44 659"], status: "completed" as const },
    { id: "1705398130", cells: ["MUL-7130", "Multi-Pricing Engine Item 4", "3/11/2026", "€48 230"], status: "warning" as const },
    { id: "1705401701", cells: ["MUL-1701", "Multi-Pricing Engine Item 5", "18/6/2026", "€1801"], status: "active" as const },
];
...
export default function MultipricingEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Multi-Pricing Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Multi-Pricing Engine</p>
                    </div>
                </div>
