...
const ACCENT = "#0ea5e9";
const MODULE = "Multi-Pricing Engine";
const PAGE = "Dynamic";
const KPIS = [{"l":"ARR (€M)","v":"€2.0M","t":"+6.0%","d":"up"},{"l":"MRR (€)","v":"€66103","t":"+5.6%","d":"up"},{"l":"Churn (%)","v":"66.1%","t":"-3.5%","d":"down"},{"l":"ARPU (€)","v":"€84455","t":"+1.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 26506.74","4.740","€ 14766.43","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 39834.23","7.206","€ 40799.53","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 16132.91","1.932","€ 20688.62","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 39447.82","8.283","€ 24342.25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 11942.82","3.864","€ 45380.36","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":797},{"label":"Mar","value":472},{"label":"Abr","value":682},{"label":"Mai","value":750},{"label":"Jun","value":536},{"label":"Jul","value":568},{"label":"Ago","value":639},{"label":"Set","value":634},{"label":"Out","value":561},{"label":"Nov","value":465},{"label":"Dez","value":625}];
const MX = 797;
