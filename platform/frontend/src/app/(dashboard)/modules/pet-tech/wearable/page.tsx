...
const ACCENT = "#f97316";
const MODULE = "Pet Technology";
const PAGE = "Wearable";
const KPIS = [{"l":"Total Pet Tech","v":"3.189","t":"+7.9%","d":"up"},{"l":"Wearable Ativos","v":"2.708","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"66.0%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"66","t":"+16.8%","d":"up"}];
const COLS = ["ID","Wearable","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Tech #001","Pet Tech #002","8.414","1.242","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Tech #002","Pet Tech #003","733","4.723","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Tech #003","Pet Tech #004","8.300","5.757","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Tech #004","Pet Tech #005","6.335","3.338","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Tech #005","Pet Tech #001","6.439","5.795","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":453},{"label":"Fev","value":485},{"label":"Mar","value":342},{"label":"Abr","value":564},{"label":"Mai","value":369},{"label":"Jun","value":427},{"label":"Jul","value":427},{"label":"Ago","value":438},{"label":"Set","value":525},{"label":"Out","value":432},{"label":"Nov","value":462},{"label":"Dez","value":300}];
const MX = 564;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#f97316'}}>IoT</span></h1>
                </div>
