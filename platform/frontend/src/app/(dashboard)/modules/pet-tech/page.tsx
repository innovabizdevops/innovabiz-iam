...
/* ═══ Pet Technology — Dashboard ═══ */

const ACCENT = "#f97316";

const KPIS = [
    { label: "Total Registos", value: "4893", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2531", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€313K", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "416012693", cells: ["PET-6693", "Pet Technology Item 1", "6/6/2026", "€12 793"], status: "active" as const },
    { id: "416016264", cells: ["PET-1264", "Pet Technology Item 2", "21/1/2026", "€16 364"], status: "pending" as const },
    { id: "416019835", cells: ["PET-4835", "Pet Technology Item 3", "8/8/2026", "€19 935"], status: "completed" as const },
    { id: "416023406", cells: ["PET-8406", "Pet Technology Item 4", "23/3/2026", "€23 506"], status: "warning" as const },
    { id: "416026977", cells: ["PET-2977", "Pet Technology Item 5", "10/10/2026", "€27 077"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pet Technology</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pet Technology</p>
                    </div>
                </div>
