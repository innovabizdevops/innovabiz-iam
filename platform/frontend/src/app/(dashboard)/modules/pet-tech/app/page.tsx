...
const PAGE = "App";
const KPIS = [{"l":"Total Pet Tech","v":"8.960","t":"+16.8%","d":"up"},{"l":"App Ativos","v":"2.285","t":"-1.3%","d":"down"},{"l":"Eficiência (%)","v":"83.0%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"94","t":"+13.2%","d":"up"}];
const COLS = ["ID","App","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Tech #001","Pet Tech #002","8.363","6.235","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Tech #002","Pet Tech #003","6.011","6.477","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Tech #003","Pet Tech #004","6.912","969","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Tech #004","Pet Tech #005","8.904","6.608","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Tech #005","Pet Tech #001","8.611","2.109","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":933},{"label":"Mar","value":673},{"label":"Abr","value":840},{"label":"Mai","value":576},{"label":"Jun","value":638},{"label":"Jul","value":772},{"label":"Ago","value":643},{"label":"Set","value":612},{"label":"Out","value":789},{"label":"Nov","value":855},{"label":"Dez","value":618}];
const MX = 933;
