...
const PAGE = "Camera";
const KPIS = [{"l":"Total Pet Tech","v":"4.387","t":"+7.9%","d":"up"},{"l":"Camera Ativos","v":"6.326","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"68.3%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"81","t":"+10.2%","d":"up"}];
const COLS = ["ID","Camera","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Tech #001","Pet Tech #002","5.459","8.929","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Tech #002","Pet Tech #003","1.462","6.237","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Tech #003","Pet Tech #004","3.044","3.159","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Tech #004","Pet Tech #005","1.155","3.316","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Tech #005","Pet Tech #001","4.541","2.735","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":536},{"label":"Mar","value":477},{"label":"Abr","value":633},{"label":"Mai","value":536},{"label":"Jun","value":563},{"label":"Jul","value":372},{"label":"Ago","value":539},{"label":"Set","value":552},{"label":"Out","value":441},{"label":"Nov","value":628},{"label":"Dez","value":638}];
const MX = 638;
