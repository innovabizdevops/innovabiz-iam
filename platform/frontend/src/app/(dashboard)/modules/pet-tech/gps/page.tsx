...
const PAGE = "GPS";
const KPIS = [{"l":"Total Pet Tech","v":"1.886","t":"-0.4%","d":"down"},{"l":"GPS Ativos","v":"7.569","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"74.1%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"89","t":"-4.5%","d":"down"}];
const COLS = ["ID","GPS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Tech #001","Pet Tech #002","1.704","3.117","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Tech #002","Pet Tech #003","4.629","5.761","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Tech #003","Pet Tech #004","6.463","4.457","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Tech #004","Pet Tech #005","688","8.259","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Tech #005","Pet Tech #001","5.735","3.393","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":584},{"label":"Fev","value":634},{"label":"Mar","value":487},{"label":"Abr","value":620},{"label":"Mai","value":602},{"label":"Jun","value":499},{"label":"Jul","value":732},{"label":"Ago","value":727},{"label":"Set","value":420},{"label":"Out","value":435},{"label":"Nov","value":676},{"label":"Dez","value":691}];
const MX = 732;
