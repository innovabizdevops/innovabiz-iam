...
const PAGE = "Feeder";
const KPIS = [{"l":"Total Pet Tech","v":"7.419","t":"-1.6%","d":"down"},{"l":"Feeder Ativos","v":"2.328","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"67.6%","t":"-3.1%","d":"down"},{"l":"Score Performance","v":"67","t":"-5.2%","d":"down"}];
const COLS = ["ID","Feeder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Tech #001","Pet Tech #002","5.884","6.208","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Tech #002","Pet Tech #003","8.894","2.317","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Tech #003","Pet Tech #004","745","4.848","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Tech #004","Pet Tech #005","5.104","8.666","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Tech #005","Pet Tech #001","2.979","4.345","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":581},{"label":"Fev","value":531},{"label":"Mar","value":384},{"label":"Abr","value":331},{"label":"Mai","value":305},{"label":"Jun","value":389},{"label":"Jul","value":325},{"label":"Ago","value":610},{"label":"Set","value":325},{"label":"Out","value":336},{"label":"Nov","value":360},{"label":"Dez","value":409}];
const MX = 610;
