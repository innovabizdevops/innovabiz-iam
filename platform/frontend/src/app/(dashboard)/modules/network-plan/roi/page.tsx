...
const PAGE = "ROI Model";
const KPIS = [{"l":"Total Network Plan","v":"2.242","t":"-5.7%","d":"down"},{"l":"ROI Model Ativos","v":"2.019","t":"-1.5%","d":"down"},{"l":"Eficiência (%)","v":"72.2%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"88","t":"-3.6%","d":"down"}];
const COLS = ["ID","ROI Model","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Network Plan #001","Network Plan #002","4.928","6.081","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Network Plan #002","Network Plan #003","4.491","6.860","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Plan #003","Network Plan #004","8.289","8.940","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Network Plan #004","Network Plan #005","3.463","2.705","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Network Plan #005","Network Plan #001","4.689","8.917","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":614},{"label":"Mar","value":571},{"label":"Abr","value":673},{"label":"Mai","value":550},{"label":"Jun","value":467},{"label":"Jul","value":733},{"label":"Ago","value":600},{"label":"Set","value":706},{"label":"Out","value":788},{"label":"Nov","value":710},{"label":"Dez","value":661}];
const MX = 788;
