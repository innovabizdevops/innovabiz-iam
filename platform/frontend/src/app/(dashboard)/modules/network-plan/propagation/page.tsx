...
const PAGE = "Propagation";
const KPIS = [{"l":"Total Network Plan","v":"1.387","t":"-5.6%","d":"down"},{"l":"Propagation Ativos","v":"8.643","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"85.6%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"70","t":"+11.1%","d":"up"}];
const COLS = ["ID","Propagation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Network Plan #001","Network Plan #002","4.462","5.782","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Network Plan #002","Network Plan #003","6.603","2.440","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Plan #003","Network Plan #004","4.342","1.966","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Network Plan #004","Network Plan #005","1.257","1.916","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Network Plan #005","Network Plan #001","4.005","8.077","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":732},{"label":"Mar","value":762},{"label":"Abr","value":875},{"label":"Mai","value":592},{"label":"Jun","value":735},{"label":"Jul","value":715},{"label":"Ago","value":649},{"label":"Set","value":762},{"label":"Out","value":604},{"label":"Nov","value":571},{"label":"Dez","value":620}];
const MX = 875;
