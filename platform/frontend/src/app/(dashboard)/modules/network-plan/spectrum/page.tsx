...
const PAGE = "Spectrum Mgmt";
const KPIS = [{"l":"Total Network Plan","v":"5.225","t":"+16.9%","d":"up"},{"l":"Spectrum Mgmt Ativos","v":"7.473","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"83.9%","t":"+6.7%","d":"up"},{"l":"Score Performance","v":"62","t":"+13.5%","d":"up"}];
const COLS = ["ID","Spectrum Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Network Plan #001","Network Plan #002","1.729","7.991","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Network Plan #002","Network Plan #003","3.648","1.647","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Plan #003","Network Plan #004","3.445","6.431","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Network Plan #004","Network Plan #005","821","8.090","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Network Plan #005","Network Plan #001","1.836","3.413","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":474},{"label":"Fev","value":714},{"label":"Mar","value":579},{"label":"Abr","value":587},{"label":"Mai","value":486},{"label":"Jun","value":532},{"label":"Jul","value":451},{"label":"Ago","value":683},{"label":"Set","value":668},{"label":"Out","value":727},{"label":"Nov","value":716},{"label":"Dez","value":725}];
const MX = 727;
