...
const PAGE = "Coverage Map";
const KPIS = [{"l":"Total Network Plan","v":"5.956","t":"+13.2%","d":"up"},{"l":"Coverage Map Ativos","v":"7.949","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"84.8%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"88","t":"+15.6%","d":"up"}];
const COLS = ["ID","Coverage Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Network Plan #001","Network Plan #002","437","2.651","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Network Plan #002","Network Plan #003","5.304","2.929","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Plan #003","Network Plan #004","5.496","1.066","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Network Plan #004","Network Plan #005","1.447","8.113","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Network Plan #005","Network Plan #001","7.036","8.782","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":442},{"label":"Mar","value":565},{"label":"Abr","value":518},{"label":"Mai","value":612},{"label":"Jun","value":588},{"label":"Jul","value":418},{"label":"Ago","value":455},{"label":"Set","value":468},{"label":"Out","value":555},{"label":"Nov","value":570},{"label":"Dez","value":575}];
const MX = 612;
