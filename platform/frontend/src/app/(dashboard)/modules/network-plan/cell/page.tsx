...
const PAGE = "Cell Plan";
const KPIS = [{"l":"Total Network Plan","v":"6.323","t":"-0.5%","d":"down"},{"l":"Cell Plan Ativos","v":"1.607","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"81.3%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"63","t":"+11.4%","d":"up"}];
const COLS = ["ID","Cell Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Network Plan #001","Network Plan #002","2.583","5.964","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Network Plan #002","Network Plan #003","4.629","3.577","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Plan #003","Network Plan #004","8.060","6.498","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Network Plan #004","Network Plan #005","2.651","2.295","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Network Plan #005","Network Plan #001","6.162","1.344","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":490},{"label":"Mar","value":591},{"label":"Abr","value":347},{"label":"Mai","value":400},{"label":"Jun","value":563},{"label":"Jul","value":374},{"label":"Ago","value":482},{"label":"Set","value":577},{"label":"Out","value":520},{"label":"Nov","value":466},{"label":"Dez","value":421}];
const MX = 591;
