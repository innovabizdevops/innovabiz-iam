...
const ACCENT = "#0e7490";
const MODULE = "Space Commerce";
const PAGE = "In-Orbit Service";
const KPIS = [{"l":"Pedidos/Dia","v":"3577","t":"+1.2%","d":"up"},{"l":"GMV (€)","v":"€88769","t":"+11.2%","d":"up"},{"l":"Conversão (%)","v":"85.5%","t":"+11.1%","d":"up"},{"l":"AOV (€)","v":"€34449","t":"+15.7%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 30609.48","1.345","8.324","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 23978.82","5.829","3.507","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 18312.04","3.921","7.097","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 7914.89","5.407","6.680","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 31880.85","8.870","2.417","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":396},{"label":"Mar","value":523},{"label":"Abr","value":687},{"label":"Mai","value":534},{"label":"Jun","value":483},{"label":"Jul","value":590},{"label":"Ago","value":483},{"label":"Set","value":440},{"label":"Out","value":696},{"label":"Nov","value":694},{"label":"Dez","value":449}];
const MX = 696;
...
export default function InOrbitPage() {
    return (
