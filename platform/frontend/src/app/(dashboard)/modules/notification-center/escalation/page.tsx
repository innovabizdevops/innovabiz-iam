...
const PAGE = "Escalation Rules";
const KPIS = [{"l":"Notificações Enviadas","v":"6.372","t":"+11.4%","d":"up"},{"l":"Taxa Entrega (%)","v":"91.6%","t":"+1.3%","d":"up"},{"l":"Taxa Abertura (%)","v":"84.3%","t":"+13.6%","d":"up"},{"l":"Escalações","v":"7.171","t":"+10.4%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","2.689","90.2%","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","7.472","88.8%","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","3.641","70.4%","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","1.645","74.8%","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","7.085","98.3%","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":961},{"label":"Fev","value":677},{"label":"Mar","value":845},{"label":"Abr","value":860},{"label":"Mai","value":789},{"label":"Jun","value":846},{"label":"Jul","value":929},{"label":"Ago","value":969},{"label":"Set","value":967},{"label":"Out","value":831},{"label":"Nov","value":852},{"label":"Dez","value":1008}];
const MX = 1008;
