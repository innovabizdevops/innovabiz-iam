...
const KPIS = [{"l":"Formulários Ativos","v":"1.708","t":"+11.0%","d":"up"},{"l":"Submissões/Dia","v":"2217","t":"-1.9%","d":"down"},{"l":"Documentos Gerados","v":"3.691","t":"-3.8%","d":"down"},{"l":"Templates","v":"6.180","t":"+5.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.537","2026-01-09","1.969","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","760","2026-02-17","8.187","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.297","2026-01-12","4.355","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.666","2026-03-07","409","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.878","2026-03-24","987","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":916},{"label":"Mar","value":894},{"label":"Abr","value":641},{"label":"Mai","value":738},{"label":"Jun","value":629},{"label":"Jul","value":847},{"label":"Ago","value":830},{"label":"Set","value":863},{"label":"Out","value":753},{"label":"Nov","value":675},{"label":"Dez","value":649}];
const MX = 916;
