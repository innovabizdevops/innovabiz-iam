...
const KPIS = [{"l":"Integrações Ativas","v":"5.670","t":"+7.4%","d":"up"},{"l":"Chamadas/Hora","v":"3359","t":"+5.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"77.3%","t":"+11.4%","d":"up"},{"l":"Latência Média (ms)","v":"12ms","t":"+15.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.221","7.773","74.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.392","5.064","87.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.891","5.586","99.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.021","4.251","97.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","917","6.772","95.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":486},{"label":"Mar","value":631},{"label":"Abr","value":485},{"label":"Mai","value":248},{"label":"Jun","value":562},{"label":"Jul","value":348},{"label":"Ago","value":517},{"label":"Set","value":541},{"label":"Out","value":487},{"label":"Nov","value":448},{"label":"Dez","value":321}];
const MX = 631;
