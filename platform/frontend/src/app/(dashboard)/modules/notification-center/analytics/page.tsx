...
const KPIS = [{"l":"Dashboards Ativos","v":"7.248","t":"+1.8%","d":"up"},{"l":"Queries/Dia","v":"677","t":"+17.9%","d":"up"},{"l":"Dados Processados (GB)","v":"6.356","t":"-0.9%","d":"down"},{"l":"Utilizadores Analytics","v":"646","t":"+2.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4524","2026-03-06","2.658","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","824","2026-03-15","1.979","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4809","2026-01-10","1.747","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3487","2026-03-01","5.602","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1208","2026-01-18","3.915","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":864},{"label":"Mar","value":1070},{"label":"Abr","value":891},{"label":"Mai","value":874},{"label":"Jun","value":831},{"label":"Jul","value":1066},{"label":"Ago","value":776},{"label":"Set","value":1017},{"label":"Out","value":907},{"label":"Nov","value":849},{"label":"Dez","value":990}];
const MX = 1070;
