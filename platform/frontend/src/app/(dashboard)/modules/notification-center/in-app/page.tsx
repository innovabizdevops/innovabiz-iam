...
const PAGE = "In-App Messaging";
const KPIS = [{"l":"Notificações Enviadas","v":"3.142","t":"+7.9%","d":"up"},{"l":"Taxa Entrega (%)","v":"71.5%","t":"+15.5%","d":"up"},{"l":"Taxa Abertura (%)","v":"88.6%","t":"-4.6%","d":"down"},{"l":"Escalações","v":"5.463","t":"+3.0%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","530","70.0%","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","3.336","79.3%","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","5.130","83.7%","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","8.182","83.7%","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","8.633","95.1%","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":682},{"label":"Mar","value":528},{"label":"Abr","value":450},{"label":"Mai","value":624},{"label":"Jun","value":627},{"label":"Jul","value":695},{"label":"Ago","value":808},{"label":"Set","value":695},{"label":"Out","value":481},{"label":"Nov","value":766},{"label":"Dez","value":534}];
const MX = 808;
