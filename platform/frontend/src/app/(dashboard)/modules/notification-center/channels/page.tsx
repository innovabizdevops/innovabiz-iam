...
const PAGE = "Channels Config";
const KPIS = [{"l":"Notificações Enviadas","v":"6.360","t":"+5.3%","d":"up"},{"l":"Taxa Entrega (%)","v":"77.3%","t":"-3.4%","d":"down"},{"l":"Taxa Abertura (%)","v":"81.0%","t":"+9.8%","d":"up"},{"l":"Escalações","v":"343","t":"-5.4%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","3.124","91.8%","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","6.685","96.6%","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","2.697","76.6%","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","7.108","81.4%","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","8.501","85.9%","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":868},{"label":"Mar","value":1038},{"label":"Abr","value":893},{"label":"Mai","value":740},{"label":"Jun","value":885},{"label":"Jul","value":808},{"label":"Ago","value":955},{"label":"Set","value":869},{"label":"Out","value":752},{"label":"Nov","value":1012},{"label":"Dez","value":917}];
const MX = 1038;
