...
const PAGE = "SMS Gateway";
const KPIS = [{"l":"Integrações Ativas","v":"262","t":"+0.3%","d":"up"},{"l":"Chamadas/Hora","v":"1632","t":"+15.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"73.9%","t":"+0.7%","d":"up"},{"l":"Latência Média (ms)","v":"107ms","t":"+1.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.876","8.558","75.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.835","5.067","85.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.001","1.710","74.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.214","1.981","77.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.936","7.948","74.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":347},{"label":"Fev","value":523},{"label":"Mar","value":531},{"label":"Abr","value":570},{"label":"Mai","value":543},{"label":"Jun","value":701},{"label":"Jul","value":406},{"label":"Ago","value":444},{"label":"Set","value":657},{"label":"Out","value":394},{"label":"Nov","value":517},{"label":"Dez","value":702}];
const MX = 702;
