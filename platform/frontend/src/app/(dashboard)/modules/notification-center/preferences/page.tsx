...
const KPIS = [{"l":"Notificações Enviadas","v":"827","t":"-3.4%","d":"down"},{"l":"Taxa Entrega (%)","v":"78.3%","t":"-2.7%","d":"down"},{"l":"Taxa Abertura (%)","v":"81.5%","t":"+4.8%","d":"up"},{"l":"Escalações","v":"5.423","t":"-2.8%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","5.499","85.7%","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","8.874","84.6%","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","7.557","96.3%","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","3.748","71.7%","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","3.391","85.9%","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":614},{"label":"Fev","value":675},{"label":"Mar","value":828},{"label":"Abr","value":596},{"label":"Mai","value":904},{"label":"Jun","value":702},{"label":"Jul","value":927},{"label":"Ago","value":653},{"label":"Set","value":829},{"label":"Out","value":718},{"label":"Nov","value":605},{"label":"Dez","value":738}];
const MX = 927;
