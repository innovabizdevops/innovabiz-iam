...
const PAGE = "Webhook Management";
const KPIS = [{"l":"Integrações Ativas","v":"3.480","t":"+15.6%","d":"up"},{"l":"Chamadas/Hora","v":"751","t":"+15.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"69.7%","t":"+13.6%","d":"up"},{"l":"Latência Média (ms)","v":"98ms","t":"-3.3%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.866","5.880","75.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.300","922","94.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.052","3.690","73.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.983","1.610","95.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.335","7.234","79.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1012},{"label":"Fev","value":695},{"label":"Mar","value":655},{"label":"Abr","value":638},{"label":"Mai","value":995},{"label":"Jun","value":941},{"label":"Jul","value":1009},{"label":"Ago","value":763},{"label":"Set","value":780},{"label":"Out","value":626},{"label":"Nov","value":1009},{"label":"Dez","value":673}];
const MX = 1012;
