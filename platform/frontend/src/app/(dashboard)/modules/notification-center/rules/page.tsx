...
const PAGE = "Delivery Rules";
const KPIS = [{"l":"Notificações Enviadas","v":"5.865","t":"-1.2%","d":"down"},{"l":"Taxa Entrega (%)","v":"91.9%","t":"-2.9%","d":"down"},{"l":"Taxa Abertura (%)","v":"72.1%","t":"+4.2%","d":"up"},{"l":"Escalações","v":"7.515","t":"-5.0%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","5.568","90.2%","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","3.876","83.6%","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","4.820","78.3%","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","8.863","89.2%","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","7.212","91.4%","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":408},{"label":"Fev","value":613},{"label":"Mar","value":525},{"label":"Abr","value":611},{"label":"Mai","value":427},{"label":"Jun","value":407},{"label":"Jul","value":432},{"label":"Ago","value":335},{"label":"Set","value":481},{"label":"Out","value":405},{"label":"Nov","value":386},{"label":"Dez","value":560}];
const MX = 613;
