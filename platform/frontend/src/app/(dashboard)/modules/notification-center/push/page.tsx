...
const KPIS = [{"l":"Notificações Enviadas","v":"5.270","t":"+3.5%","d":"up"},{"l":"Taxa Entrega (%)","v":"72.8%","t":"+17.0%","d":"up"},{"l":"Taxa Abertura (%)","v":"85.6%","t":"+4.2%","d":"up"},{"l":"Escalações","v":"4.857","t":"+0.1%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","5.176","88.2%","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","2.972","82.3%","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","3.240","90.9%","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","5.561","85.5%","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","4.844","91.1%","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":688},{"label":"Mar","value":824},{"label":"Abr","value":495},{"label":"Mai","value":638},{"label":"Jun","value":497},{"label":"Jul","value":751},{"label":"Ago","value":569},{"label":"Set","value":508},{"label":"Out","value":654},{"label":"Nov","value":635},{"label":"Dez","value":622}];
const MX = 824;
