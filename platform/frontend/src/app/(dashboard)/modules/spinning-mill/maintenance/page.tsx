...
const KPIS = [{"l":"Total Spinning Mill","v":"7.172","t":"-4.0%","d":"down"},{"l":"Maintenance Ativos","v":"7.314","t":"+11.7%","d":"up"},{"l":"Eficiência (%)","v":"83.0%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"75","t":"+7.1%","d":"up"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Spinning Mill #001","Spinning Mill #002","5.824","7.394","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Spinning Mill #002","Spinning Mill #003","4.383","7.088","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Spinning Mill #003","Spinning Mill #004","8.563","8.136","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Spinning Mill #004","Spinning Mill #005","596","3.272","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Spinning Mill #005","Spinning Mill #001","1.205","888","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":360},{"label":"Fev","value":535},{"label":"Mar","value":522},{"label":"Abr","value":714},{"label":"Mai","value":721},{"label":"Jun","value":500},{"label":"Jul","value":420},{"label":"Ago","value":559},{"label":"Set","value":712},{"label":"Out","value":641},{"label":"Nov","value":482},{"label":"Dez","value":706}];
const MX = 721;
