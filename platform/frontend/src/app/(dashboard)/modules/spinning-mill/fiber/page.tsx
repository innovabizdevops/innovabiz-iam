...
const PAGE = "Fiber";
const KPIS = [{"l":"Total Spinning Mill","v":"1.152","t":"-3.5%","d":"down"},{"l":"Fiber Ativos","v":"7.093","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"+8.4%","d":"up"},{"l":"Score Performance","v":"81","t":"+2.2%","d":"up"}];
const COLS = ["ID","Fiber","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Spinning Mill #001","Spinning Mill #002","4.037","2.799","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Spinning Mill #002","Spinning Mill #003","6.542","7.201","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Spinning Mill #003","Spinning Mill #004","3.407","8.475","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Spinning Mill #004","Spinning Mill #005","6.458","1.365","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Spinning Mill #005","Spinning Mill #001","8.071","1.639","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":816},{"label":"Mar","value":800},{"label":"Abr","value":879},{"label":"Mai","value":590},{"label":"Jun","value":543},{"label":"Jul","value":841},{"label":"Ago","value":626},{"label":"Set","value":521},{"label":"Out","value":829},{"label":"Nov","value":601},{"label":"Dez","value":532}];
const MX = 879;
