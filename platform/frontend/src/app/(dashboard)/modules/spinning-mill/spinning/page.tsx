...
const PAGE = "Spinning";
const KPIS = [{"l":"Total Spinning Mill","v":"8.397","t":"-3.0%","d":"down"},{"l":"Spinning Ativos","v":"667","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"68.3%","t":"+10.8%","d":"up"},{"l":"Score Performance","v":"68","t":"-4.1%","d":"down"}];
const COLS = ["ID","Spinning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Spinning Mill #001","Spinning Mill #002","3.979","2.423","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Spinning Mill #002","Spinning Mill #003","3.760","5.552","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Spinning Mill #003","Spinning Mill #004","4.137","4.607","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Spinning Mill #004","Spinning Mill #005","2.264","4.947","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Spinning Mill #005","Spinning Mill #001","614","2.371","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":369},{"label":"Mar","value":723},{"label":"Abr","value":468},{"label":"Mai","value":438},{"label":"Jun","value":649},{"label":"Jul","value":491},{"label":"Ago","value":392},{"label":"Set","value":638},{"label":"Out","value":582},{"label":"Nov","value":721},{"label":"Dez","value":651}];
const MX = 723;
