...
const ACCENT = "#6366f1";
const MODULE = "Spinning Mill";
const PAGE = "Production";
const KPIS = [{"l":"Total Spinning Mill","v":"8.970","t":"-0.2%","d":"down"},{"l":"Production Ativos","v":"212","t":"+5.7%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"57","t":"+17.5%","d":"up"}];
const COLS = ["ID","Production","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Spinning Mill #001","Spinning Mill #002","5.649","2.990","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Spinning Mill #002","Spinning Mill #003","2.275","5.293","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Spinning Mill #003","Spinning Mill #004","8.805","8.226","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Spinning Mill #004","Spinning Mill #005","8.052","4.793","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Spinning Mill #005","Spinning Mill #001","2.590","7.163","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":539},{"label":"Fev","value":420},{"label":"Mar","value":465},{"label":"Abr","value":539},{"label":"Mai","value":729},{"label":"Jun","value":730},{"label":"Jul","value":714},{"label":"Ago","value":594},{"label":"Set","value":620},{"label":"Out","value":685},{"label":"Nov","value":358},{"label":"Dez","value":473}];
const MX = 730;
