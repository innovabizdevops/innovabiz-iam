...
export default function SpinningMillPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Spinning Mill</h1><p className="text-sm text-muted-foreground">Spinning Mill • iBOS Enterprise</p></div>
