...
/* ═══ MD: Multi-Brand Engine — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "9213", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4179", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€358K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2128043813", cells: ["MD-3813", "MD: Multi-Brand Engine Item 1", "22/6/2026", "€43 913"], status: "active" as const },
    { id: "2128047384", cells: ["MD-7384", "MD: Multi-Brand Engine Item 2", "9/1/2026", "€47 484"], status: "pending" as const },
    { id: "2128050955", cells: ["MD-1955", "MD: Multi-Brand Engine Item 3", "24/8/2026", "€1055"], status: "completed" as const },
    { id: "2128054526", cells: ["MD-5526", "MD: Multi-Brand Engine Item 4", "11/3/2026", "€4626"], status: "warning" as const },
    { id: "2128058097", cells: ["MD-9097", "MD: Multi-Brand Engine Item 5", "26/10/2026", "€8197"], status: "active" as const },
];
...
export default function MdMultibrandEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Brand Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Brand Engine</p>
                    </div>
                </div>
