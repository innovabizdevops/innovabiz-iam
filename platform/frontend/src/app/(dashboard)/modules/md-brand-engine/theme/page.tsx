...
const PAGE = "Theme";
const KPIS = [{"l":"Configurações","v":"8.647","t":"-3.2%","d":"down"},{"l":"Últimas Alterações","v":"7.155","t":"-3.2%","d":"down"},{"l":"Ambientes","v":"1.331","t":"+17.2%","d":"up"},{"l":"Versão Config","v":"2.015","t":"+2.2%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 48401.99","852","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 43092.59","6.933","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 22460.09","4.177","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 24634.12","701","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 7818.51","4.180","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":442},{"label":"Fev","value":552},{"label":"Mar","value":381},{"label":"Abr","value":637},{"label":"Mai","value":362},{"label":"Jun","value":408},{"label":"Jul","value":608},{"label":"Ago","value":503},{"label":"Set","value":507},{"label":"Out","value":258},{"label":"Nov","value":546},{"label":"Dez","value":615}];
const MX = 637;
