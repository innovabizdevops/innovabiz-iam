...
const PAGE = "Employee";
const KPIS = [{"l":"eNPS","v":"56","t":"+1.6%","d":"up"},{"l":"Engagement (%)","v":"68.1%","t":"+9.7%","d":"up"},{"l":"Turnover (%)","v":"67.2%","t":"+4.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.491","t":"+16.9%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.615","2026-02-17","80","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.393","2026-03-02","74","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.293","2026-01-09","79","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.596","2026-01-09","86","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.078","2026-02-10","56","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":855},{"label":"Fev","value":1072},{"label":"Mar","value":797},{"label":"Abr","value":861},{"label":"Mai","value":1022},{"label":"Jun","value":736},{"label":"Jul","value":694},{"label":"Ago","value":771},{"label":"Set","value":1010},{"label":"Out","value":843},{"label":"Nov","value":990},{"label":"Dez","value":791}];
const MX = 1072;
