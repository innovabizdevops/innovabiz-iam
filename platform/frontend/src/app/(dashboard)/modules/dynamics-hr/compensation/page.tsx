...
const ACCENT = "#00bcf2";
const MODULE = "HR Hub (D365)";
const PAGE = "Compensation";
const KPIS = [{"l":"Total Dynamics Hr","v":"6.418","t":"+1.1%","d":"up"},{"l":"Compensation Ativos","v":"7.721","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"67.8%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"81","t":"+0.9%","d":"up"}];
const COLS = ["ID","Compensation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dynamics Hr #001","Dynamics Hr #002","7.597","8.607","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Dynamics Hr #002","Dynamics Hr #003","1.735","8.761","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Dynamics Hr #003","Dynamics Hr #004","3.373","8.299","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Dynamics Hr #004","Dynamics Hr #005","5.817","1.242","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dynamics Hr #005","Dynamics Hr #001","587","1.140","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":875},{"label":"Mar","value":783},{"label":"Abr","value":902},{"label":"Mai","value":1007},{"label":"Jun","value":1028},{"label":"Jul","value":674},{"label":"Ago","value":736},{"label":"Set","value":1036},{"label":"Out","value":945},{"label":"Nov","value":761},{"label":"Dez","value":976}];
const MX = 1036;
