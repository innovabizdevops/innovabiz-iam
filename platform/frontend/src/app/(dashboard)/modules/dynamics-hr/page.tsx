...
/* ═══ HR Hub (D365) — Dashboard ═══ */

const ACCENT = "#00bcf2";

const KPIS = [
    { label: "Total Registos", value: "7810", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "413", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€73K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "-18%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "632360310", cells: ["DYN-3310", "HR Hub (D365) Item 1", "23/7/2026", "€10 410"], status: "active" as const },
    { id: "632363881", cells: ["DYN-6881", "HR Hub (D365) Item 2", "10/2/2026", "€13 981"], status: "pending" as const },
    { id: "632367452", cells: ["DYN-1452", "HR Hub (D365) Item 3", "25/9/2026", "€17 552"], status: "completed" as const },
    { id: "632371023", cells: ["DYN-5023", "HR Hub (D365) Item 4", "12/4/2026", "€21 123"], status: "warning" as const },
    { id: "632374594", cells: ["DYN-8594", "HR Hub (D365) Item 5", "27/11/2026", "€24 694"], status: "active" as const },
];
...
export default function HrHubD365Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">HR Hub (D365)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • HR Hub (D365)</p>
                    </div>
                </div>
