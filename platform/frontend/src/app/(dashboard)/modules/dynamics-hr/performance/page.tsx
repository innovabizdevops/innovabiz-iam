...
const KPIS = [{"l":"Formulários Ativos","v":"8.963","t":"-5.5%","d":"down"},{"l":"Submissões/Dia","v":"4321","t":"-4.8%","d":"down"},{"l":"Documentos Gerados","v":"3.561","t":"-4.2%","d":"down"},{"l":"Templates","v":"6.108","t":"+10.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.233","2026-02-05","5.747","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.502","2026-02-14","7.028","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.080","2026-01-05","4.687","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.322","2026-02-02","8.192","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.757","2026-02-04","283","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":898},{"label":"Fev","value":940},{"label":"Mar","value":814},{"label":"Abr","value":665},{"label":"Mai","value":645},{"label":"Jun","value":827},{"label":"Jul","value":617},{"label":"Ago","value":739},{"label":"Set","value":582},{"label":"Out","value":934},{"label":"Nov","value":734},{"label":"Dez","value":714}];
const MX = 940;
