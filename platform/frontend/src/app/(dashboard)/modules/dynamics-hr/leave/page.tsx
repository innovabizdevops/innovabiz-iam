...
const PAGE = "Leave";
const KPIS = [{"l":"Total Dynamics Hr","v":"5.883","t":"+4.5%","d":"up"},{"l":"Leave Ativos","v":"162","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"77.9%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"77","t":"+1.8%","d":"up"}];
const COLS = ["ID","Leave","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dynamics Hr #001","Dynamics Hr #002","6.630","6.648","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Dynamics Hr #002","Dynamics Hr #003","8.110","959","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Dynamics Hr #003","Dynamics Hr #004","996","8.461","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Dynamics Hr #004","Dynamics Hr #005","7.824","8.227","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dynamics Hr #005","Dynamics Hr #001","8.930","2.836","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":824},{"label":"Fev","value":751},{"label":"Mar","value":830},{"label":"Abr","value":593},{"label":"Mai","value":701},{"label":"Jun","value":614},{"label":"Jul","value":697},{"label":"Ago","value":944},{"label":"Set","value":708},{"label":"Out","value":791},{"label":"Nov","value":676},{"label":"Dez","value":621}];
const MX = 944;
