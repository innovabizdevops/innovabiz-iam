...
const PAGE = "Closing";
const KPIS = [{"l":"Formulários Ativos","v":"5.418","t":"+14.4%","d":"up"},{"l":"Submissões/Dia","v":"113","t":"+0.7%","d":"up"},{"l":"Documentos Gerados","v":"2.376","t":"+2.7%","d":"up"},{"l":"Templates","v":"6.930","t":"+5.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.799","2026-03-11","5.383","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","326","2026-01-20","5.697","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.750","2026-03-14","2.388","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.353","2026-02-22","196","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.703","2026-02-27","5.634","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":562},{"label":"Mar","value":642},{"label":"Abr","value":595},{"label":"Mai","value":325},{"label":"Jun","value":555},{"label":"Jul","value":428},{"label":"Ago","value":409},{"label":"Set","value":441},{"label":"Out","value":510},{"label":"Nov","value":672},{"label":"Dez","value":554}];
const MX = 672;
