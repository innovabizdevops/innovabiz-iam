...
const ACCENT = "#0e7490";
const MODULE = "Mortgage Platform";
const PAGE = "Servicing";
const KPIS = [{"l":"Formulários Ativos","v":"4.324","t":"-4.9%","d":"down"},{"l":"Submissões/Dia","v":"4369","t":"-0.9%","d":"down"},{"l":"Documentos Gerados","v":"2.839","t":"+3.0%","d":"up"},{"l":"Templates","v":"2.365","t":"+15.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.489","2026-03-02","4.353","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.799","2026-01-07","8.820","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.484","2026-01-03","1.159","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.556","2026-01-11","7.488","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.979","2026-01-24","5.954","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":878},{"label":"Fev","value":899},{"label":"Mar","value":650},{"label":"Abr","value":919},{"label":"Mai","value":800},{"label":"Jun","value":734},{"label":"Jul","value":925},{"label":"Ago","value":744},{"label":"Set","value":863},{"label":"Out","value":634},{"label":"Nov","value":660},{"label":"Dez","value":910}];
const MX = 925;
