...
const KPIS = [{"l":"Formulários Ativos","v":"157","t":"+4.2%","d":"up"},{"l":"Submissões/Dia","v":"3947","t":"+3.9%","d":"up"},{"l":"Documentos Gerados","v":"1.116","t":"+7.6%","d":"up"},{"l":"Templates","v":"8.063","t":"-4.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.037","2026-01-16","1.489","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.118","2026-01-28","2.568","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.988","2026-03-15","966","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","929","2026-02-12","8.766","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.302","2026-01-03","7.920","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":515},{"label":"Fev","value":664},{"label":"Mar","value":552},{"label":"Abr","value":396},{"label":"Mai","value":332},{"label":"Jun","value":341},{"label":"Jul","value":444},{"label":"Ago","value":652},{"label":"Set","value":391},{"label":"Out","value":385},{"label":"Nov","value":647},{"label":"Dez","value":342}];
const MX = 664;
