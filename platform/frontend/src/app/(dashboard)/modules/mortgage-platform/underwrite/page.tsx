...
const KPIS = [{"l":"Formulários Ativos","v":"8.998","t":"+14.8%","d":"up"},{"l":"Submissões/Dia","v":"3093","t":"+8.2%","d":"up"},{"l":"Documentos Gerados","v":"175","t":"-1.4%","d":"down"},{"l":"Templates","v":"4.317","t":"-1.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.139","2026-02-01","3.298","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.502","2026-03-05","6.054","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.315","2026-01-03","1.814","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.663","2026-01-22","354","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.987","2026-02-20","8.451","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":752},{"label":"Mar","value":729},{"label":"Abr","value":792},{"label":"Mai","value":730},{"label":"Jun","value":570},{"label":"Jul","value":571},{"label":"Ago","value":713},{"label":"Set","value":521},{"label":"Out","value":675},{"label":"Nov","value":452},{"label":"Dez","value":555}];
const MX = 792;
