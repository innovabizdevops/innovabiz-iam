...
const KPIS = [{"l":"Formulários Ativos","v":"2.553","t":"-0.2%","d":"down"},{"l":"Submissões/Dia","v":"1248","t":"-5.5%","d":"down"},{"l":"Documentos Gerados","v":"8.435","t":"+16.8%","d":"up"},{"l":"Templates","v":"3.817","t":"+8.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.758","2026-03-17","8.112","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.641","2026-03-18","505","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.391","2026-03-26","3.256","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","9.032","2026-02-21","1.686","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.546","2026-01-13","6.832","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":912},{"label":"Mar","value":764},{"label":"Abr","value":786},{"label":"Mai","value":747},{"label":"Jun","value":719},{"label":"Jul","value":854},{"label":"Ago","value":832},{"label":"Set","value":757},{"label":"Out","value":727},{"label":"Nov","value":656},{"label":"Dez","value":958}];
const MX = 958;
