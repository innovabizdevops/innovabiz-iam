...
const ACCENT = "#1e3a5f";
const MODULE = "Weapon Systems Management";
const PAGE = "Decommission";
const KPIS = [{"l":"Vendas YTD (€)","v":"€93439","t":"+12.9%","d":"up"},{"l":"Pipeline (€)","v":"€92158","t":"+2.5%","d":"up"},{"l":"Atingimento Quota (%)","v":"86.0%","t":"+2.5%","d":"up"},{"l":"Win Rate (%)","v":"87.1%","t":"+2.3%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 36149.81","€ 32727.79","€ 25587.77","93.1%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 6507.14","€ 13762.33","€ 30447.76","96.5%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 37469.35","€ 15098.52","€ 27352.21","96.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 4243.26","€ 35325.25","€ 47010.49","90.4%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 12654.95","€ 18166.47","€ 13980.61","81.1%"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":378},{"label":"Mar","value":398},{"label":"Abr","value":584},{"label":"Mai","value":547},{"label":"Jun","value":428},{"label":"Jul","value":480},{"label":"Ago","value":478},{"label":"Set","value":350},{"label":"Out","value":521},{"label":"Nov","value":384},{"label":"Dez","value":325}];
const MX = 584;
