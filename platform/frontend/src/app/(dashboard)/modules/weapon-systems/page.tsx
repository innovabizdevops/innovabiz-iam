...
/* ═══ Weapon Systems Management — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "7490", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "789", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€484K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1060148890", cells: ["WEA-3890", "Weapon Systems Management Item 1", "11/11/2026", "€48 990"], status: "active" as const },
    { id: "1060152461", cells: ["WEA-7461", "Weapon Systems Management Item 2", "26/6/2026", "€2561"], status: "pending" as const },
    { id: "1060156032", cells: ["WEA-2032", "Weapon Systems Management Item 3", "13/1/2026", "€6132"], status: "completed" as const },
    { id: "1060159603", cells: ["WEA-5603", "Weapon Systems Management Item 4", "28/8/2026", "€9703"], status: "warning" as const },
    { id: "1060163174", cells: ["WEA-9174", "Weapon Systems Management Item 5", "15/3/2026", "€13 274"], status: "active" as const },
];
...
export default function WeaponSystemsManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Weapon Systems Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Weapon Systems Management</p>
                    </div>
                </div>
