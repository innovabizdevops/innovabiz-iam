...
/* ═══ Multi-Context Engine — Dashboard ═══ */

const ACCENT = "#0ea5e9";

const KPIS = [
    { label: "Total Registos", value: "374", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1052", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€294K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1948963774", cells: ["MUL-5774", "Multi-Context Engine Item 1", "3/11/2026", "€13 874"], status: "active" as const },
    { id: "1948967345", cells: ["MUL-9345", "Multi-Context Engine Item 2", "18/6/2026", "€17 445"], status: "pending" as const },
    { id: "1948970916", cells: ["MUL-3916", "Multi-Context Engine Item 3", "5/1/2026", "€21 016"], status: "completed" as const },
    { id: "1948974487", cells: ["MUL-7487", "Multi-Context Engine Item 4", "20/8/2026", "€24 587"], status: "warning" as const },
    { id: "1948978058", cells: ["MUL-2058", "Multi-Context Engine Item 5", "7/3/2026", "€28 158"], status: "active" as const },
];
...
export default function MulticontextEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Multi-Context Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Multi-Context Engine</p>
                    </div>
                </div>
