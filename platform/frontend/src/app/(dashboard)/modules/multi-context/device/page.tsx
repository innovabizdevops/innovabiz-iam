...
const PAGE = "Device";
const KPIS = [{"l":"Dispositivos Online","v":"6.105","t":"+12.0%","d":"up"},{"l":"Dados/Min (MB)","v":"2.649","t":"-5.0%","d":"down"},{"l":"Alertas Ativos","v":"3.737","t":"+11.2%","d":"up"},{"l":"Uptime (%)","v":"66.6%","t":"-2.9%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","8.884","6.232","8.011","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.197","7.958","3.345","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.606","1.901","6.291","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.539","3.971","1.688","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.088","3.921","1.778","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":760},{"label":"Fev","value":794},{"label":"Mar","value":721},{"label":"Abr","value":620},{"label":"Mai","value":772},{"label":"Jun","value":633},{"label":"Jul","value":893},{"label":"Ago","value":683},{"label":"Set","value":794},{"label":"Out","value":560},{"label":"Nov","value":664},{"label":"Dez","value":571}];
const MX = 893;
