...
const ACCENT = "#0ea5e9";
const MODULE = "Multi-Context Engine";
const PAGE = "Intent";
const KPIS = [{"l":"Total Multi Context","v":"553","t":"+10.2%","d":"up"},{"l":"Intent Ativos","v":"3.651","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"76.4%","t":"+1.4%","d":"up"},{"l":"Score Performance","v":"93","t":"+12.4%","d":"up"}];
const COLS = ["ID","Intent","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Multi Context #001","Multi Context #002","2.364","4.198","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Multi Context #002","Multi Context #003","6.347","3.517","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Multi Context #003","Multi Context #004","2.991","1.720","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Multi Context #004","Multi Context #005","5.561","777","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Multi Context #005","Multi Context #001","1.963","5.378","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":378},{"label":"Fev","value":432},{"label":"Mar","value":381},{"label":"Abr","value":418},{"label":"Mai","value":604},{"label":"Jun","value":247},{"label":"Jul","value":536},{"label":"Ago","value":546},{"label":"Set","value":417},{"label":"Out","value":475},{"label":"Nov","value":218},{"label":"Dez","value":403}];
const MX = 604;
