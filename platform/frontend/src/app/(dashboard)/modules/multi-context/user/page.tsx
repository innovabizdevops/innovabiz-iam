...
const PAGE = "User";
const KPIS = [{"l":"Utilizadores Ativos","v":"6.661","t":"+0.4%","d":"up"},{"l":"Sessões/Dia","v":"4289","t":"+5.9%","d":"up"},{"l":"MFA Adoção (%)","v":"90.5%","t":"+2.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"7.804","t":"+1.4%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","619","1.817","302","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.440","7.656","8.556","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","6.542","5.737","3.136","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.023","2.021","7.381","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","394","1.819","8.257","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":751},{"label":"Mar","value":511},{"label":"Abr","value":756},{"label":"Mai","value":705},{"label":"Jun","value":759},{"label":"Jul","value":471},{"label":"Ago","value":718},{"label":"Set","value":536},{"label":"Out","value":636},{"label":"Nov","value":669},{"label":"Dez","value":672}];
const MX = 759;
