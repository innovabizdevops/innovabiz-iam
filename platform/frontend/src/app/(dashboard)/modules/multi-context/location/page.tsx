...
const PAGE = "Location";
const KPIS = [{"l":"Total Multi Context","v":"1.209","t":"-0.4%","d":"down"},{"l":"Location Ativos","v":"2.061","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"80.9%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"85","t":"+15.1%","d":"up"}];
const COLS = ["ID","Location","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Multi Context #001","Multi Context #002","1.506","716","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Multi Context #002","Multi Context #003","7.186","393","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Multi Context #003","Multi Context #004","1.017","3.147","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Multi Context #004","Multi Context #005","2.851","5.046","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Multi Context #005","Multi Context #001","3.745","3.296","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":634},{"label":"Mar","value":592},{"label":"Abr","value":666},{"label":"Mai","value":672},{"label":"Jun","value":519},{"label":"Jul","value":544},{"label":"Ago","value":749},{"label":"Set","value":602},{"label":"Out","value":570},{"label":"Nov","value":579},{"label":"Dez","value":662}];
const MX = 749;
