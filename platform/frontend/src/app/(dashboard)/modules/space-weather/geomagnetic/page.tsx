...
const PAGE = "Geomagnetic";
const KPIS = [{"l":"Quartos Ocupados","v":"2.628","t":"+8.4%","d":"up"},{"l":"RevPAR (€)","v":"€76240","t":"+7.6%","d":"up"},{"l":"Ocupação (%)","v":"90.5%","t":"+9.6%","d":"up"},{"l":"Guest Satisfaction","v":"6.960","t":"+15.6%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.691","2026-01-04","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.300","2026-01-03","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.531","2026-03-18","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.790","2026-02-07","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","755","2026-03-05","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":526},{"label":"Fev","value":529},{"label":"Mar","value":890},{"label":"Abr","value":764},{"label":"Mai","value":803},{"label":"Jun","value":570},{"label":"Jul","value":579},{"label":"Ago","value":625},{"label":"Set","value":634},{"label":"Out","value":519},{"label":"Nov","value":668},{"label":"Dez","value":622}];
const MX = 890;
