...
const ACCENT = "#4338ca";
const MODULE = "Space Weather";
const PAGE = "Impact Assess";
const KPIS = [{"l":"Projetos Sociais","v":"8.224","t":"+13.0%","d":"up"},{"l":"Beneficiários","v":"8.125","t":"+12.3%","d":"up"},{"l":"Investimento CSR (€)","v":"€82634","t":"+6.5%","d":"up"},{"l":"Score Impacto","v":"91","t":"+0.3%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","796","€ 6297.41","4.590","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.561","€ 11813.17","493","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","1.466","€ 43167.01","3.169","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","5.717","€ 26599.31","8.558","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","8.140","€ 11666.75","8.048","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":912},{"label":"Fev","value":849},{"label":"Mar","value":909},{"label":"Abr","value":602},{"label":"Mai","value":955},{"label":"Jun","value":791},{"label":"Jul","value":613},{"label":"Ago","value":637},{"label":"Set","value":829},{"label":"Out","value":814},{"label":"Nov","value":837},{"label":"Dez","value":654}];
const MX = 955;
