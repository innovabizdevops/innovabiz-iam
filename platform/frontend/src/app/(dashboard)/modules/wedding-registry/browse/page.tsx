...
const PAGE = "Browse";
const KPIS = [{"l":"Total Wedding Registry","v":"763","t":"-3.3%","d":"down"},{"l":"Browse Ativos","v":"5.624","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"68.2%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"56","t":"+4.6%","d":"up"}];
const COLS = ["ID","Browse","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wedding Registry #001","Wedding Registry #002","2.061","5.853","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Wedding Registry #002","Wedding Registry #003","2.781","4.923","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Wedding Registry #003","Wedding Registry #004","293","994","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Wedding Registry #004","Wedding Registry #005","6.957","6.960","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wedding Registry #005","Wedding Registry #001","4.313","5.581","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":474},{"label":"Mar","value":395},{"label":"Abr","value":411},{"label":"Mai","value":493},{"label":"Jun","value":541},{"label":"Jul","value":270},{"label":"Ago","value":492},{"label":"Set","value":360},{"label":"Out","value":547},{"label":"Nov","value":430},{"label":"Dez","value":511}];
const MX = 573;
