...
const ACCENT = "#be185d";
const MODULE = "Wedding Gift Registry";
const PAGE = "Thank";
const KPIS = [{"l":"Total Wedding Registry","v":"7.839","t":"+16.6%","d":"up"},{"l":"Thank Ativos","v":"1.739","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"70.6%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"71","t":"-5.2%","d":"down"}];
const COLS = ["ID","Thank","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wedding Registry #001","Wedding Registry #002","4.603","1.380","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Wedding Registry #002","Wedding Registry #003","3.659","8.020","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Wedding Registry #003","Wedding Registry #004","2.971","8.375","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Wedding Registry #004","Wedding Registry #005","4.019","6.680","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wedding Registry #005","Wedding Registry #001","7.225","6.251","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1013},{"label":"Fev","value":731},{"label":"Mar","value":868},{"label":"Abr","value":928},{"label":"Mai","value":953},{"label":"Jun","value":892},{"label":"Jul","value":785},{"label":"Ago","value":663},{"label":"Set","value":685},{"label":"Out","value":727},{"label":"Nov","value":847},{"label":"Dez","value":1007}];
const MX = 1013;
