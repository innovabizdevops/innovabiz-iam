...
const PAGE = "Return";
const KPIS = [{"l":"Total Wedding Registry","v":"705","t":"+10.9%","d":"up"},{"l":"Return Ativos","v":"6.145","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"72.6%","t":"+10.3%","d":"up"},{"l":"Score Performance","v":"73","t":"+13.0%","d":"up"}];
const COLS = ["ID","Return","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wedding Registry #001","Wedding Registry #002","3.652","6.889","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Wedding Registry #002","Wedding Registry #003","3.072","697","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Wedding Registry #003","Wedding Registry #004","3.529","5.979","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Wedding Registry #004","Wedding Registry #005","2.094","7.779","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wedding Registry #005","Wedding Registry #001","3.667","8.718","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":614},{"label":"Fev","value":415},{"label":"Mar","value":340},{"label":"Abr","value":278},{"label":"Mai","value":593},{"label":"Jun","value":652},{"label":"Jul","value":553},{"label":"Ago","value":448},{"label":"Set","value":494},{"label":"Out","value":470},{"label":"Nov","value":377},{"label":"Dez","value":468}];
const MX = 652;
