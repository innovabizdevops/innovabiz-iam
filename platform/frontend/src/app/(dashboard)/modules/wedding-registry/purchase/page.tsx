...
const PAGE = "Purchase";
const KPIS = [{"l":"Total Wedding Registry","v":"4.845","t":"+10.5%","d":"up"},{"l":"Purchase Ativos","v":"821","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"74.8%","t":"-6.0%","d":"down"},{"l":"Score Performance","v":"58","t":"+16.0%","d":"up"}];
const COLS = ["ID","Purchase","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wedding Registry #001","Wedding Registry #002","4.435","3.412","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Wedding Registry #002","Wedding Registry #003","679","5.908","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Wedding Registry #003","Wedding Registry #004","8.408","1.471","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Wedding Registry #004","Wedding Registry #005","541","9.017","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wedding Registry #005","Wedding Registry #001","4.984","8.274","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":584},{"label":"Mar","value":688},{"label":"Abr","value":814},{"label":"Mai","value":742},{"label":"Jun","value":738},{"label":"Jul","value":644},{"label":"Ago","value":474},{"label":"Set","value":792},{"label":"Out","value":506},{"label":"Nov","value":822},{"label":"Dez","value":549}];
const MX = 822;
