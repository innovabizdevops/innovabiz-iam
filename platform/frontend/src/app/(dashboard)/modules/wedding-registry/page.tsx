...
/* ═══ Wedding Gift Registry — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "2427", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "892", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€183K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "663233027", cells: ["WED-6027", "Wedding Gift Registry Item 1", "24/12/2026", "€33 127"], status: "active" as const },
    { id: "663236598", cells: ["WED-9598", "Wedding Gift Registry Item 2", "11/7/2026", "€36 698"], status: "pending" as const },
    { id: "663240169", cells: ["WED-4169", "Wedding Gift Registry Item 3", "26/2/2026", "€40 269"], status: "completed" as const },
    { id: "663243740", cells: ["WED-7740", "Wedding Gift Registry Item 4", "13/9/2026", "€43 840"], status: "warning" as const },
    { id: "663247311", cells: ["WED-2311", "Wedding Gift Registry Item 5", "28/4/2026", "€47 411"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wedding Gift Registry</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Wedding Gift Registry</p>
                    </div>
                </div>
