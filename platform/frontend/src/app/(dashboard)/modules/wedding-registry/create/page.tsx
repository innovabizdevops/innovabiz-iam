...
const PAGE = "Create";
const KPIS = [{"l":"Total Wedding Registry","v":"3.707","t":"+16.0%","d":"up"},{"l":"Create Ativos","v":"1.171","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"82.9%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"69","t":"+7.6%","d":"up"}];
const COLS = ["ID","Create","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wedding Registry #001","Wedding Registry #002","6.507","4.670","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Wedding Registry #002","Wedding Registry #003","6.551","8.336","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Wedding Registry #003","Wedding Registry #004","2.939","6.397","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Wedding Registry #004","Wedding Registry #005","7.022","1.896","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wedding Registry #005","Wedding Registry #001","7.127","8.435","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":813},{"label":"Mar","value":786},{"label":"Abr","value":992},{"label":"Mai","value":1013},{"label":"Jun","value":690},{"label":"Jul","value":897},{"label":"Ago","value":1045},{"label":"Set","value":828},{"label":"Out","value":1022},{"label":"Nov","value":887},{"label":"Dez","value":858}];
const MX = 1045;
