...
const PAGE = "LiDAR Scan";
const KPIS = [{"l":"Total Forest Inventory","v":"7.205","t":"-3.6%","d":"down"},{"l":"LiDAR Scan Ativos","v":"5.513","t":"+1.2%","d":"up"},{"l":"Eficiência (%)","v":"87.2%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"90","t":"+7.8%","d":"up"}];
const COLS = ["ID","LiDAR Scan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Inventory #001","Forest Inventory #002","7.835","7.387","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Inventory #002","Forest Inventory #003","6.637","8.969","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Inventory #003","Forest Inventory #004","7.037","731","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Inventory #004","Forest Inventory #005","1.327","3.488","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Inventory #005","Forest Inventory #001","6.403","1.355","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":660},{"label":"Mar","value":675},{"label":"Abr","value":729},{"label":"Mai","value":662},{"label":"Jun","value":617},{"label":"Jul","value":811},{"label":"Ago","value":802},{"label":"Set","value":468},{"label":"Out","value":561},{"label":"Nov","value":788},{"label":"Dez","value":793}];
const MX = 811;
