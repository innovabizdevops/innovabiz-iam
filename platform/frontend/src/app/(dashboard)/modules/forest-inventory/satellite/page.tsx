...
const ACCENT = "#059669";
const MODULE = "Forest Inventory";
const PAGE = "Satellite Mon";
const KPIS = [{"l":"Total Forest Inventory","v":"4.397","t":"+16.7%","d":"up"},{"l":"Satellite Mon Ativos","v":"7.035","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"93.2%","t":"+15.9%","d":"up"},{"l":"Score Performance","v":"87","t":"+1.4%","d":"up"}];
const COLS = ["ID","Satellite Mon","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Inventory #001","Forest Inventory #002","7.331","1.539","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Inventory #002","Forest Inventory #003","4.892","1.812","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Inventory #003","Forest Inventory #004","6.092","6.108","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Inventory #004","Forest Inventory #005","5.626","2.849","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Inventory #005","Forest Inventory #001","741","1.198","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":831},{"label":"Fev","value":835},{"label":"Mar","value":834},{"label":"Abr","value":505},{"label":"Mai","value":812},{"label":"Jun","value":739},{"label":"Jul","value":732},{"label":"Ago","value":522},{"label":"Set","value":514},{"label":"Out","value":800},{"label":"Nov","value":848},{"label":"Dez","value":793}];
const MX = 848;
