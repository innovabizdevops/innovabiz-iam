...
const PAGE = "GIS Layer";
const KPIS = [{"l":"Total Forest Inventory","v":"3.085","t":"+10.9%","d":"up"},{"l":"GIS Layer Ativos","v":"6.166","t":"+3.3%","d":"up"},{"l":"Eficiência (%)","v":"73.5%","t":"+2.0%","d":"up"},{"l":"Score Performance","v":"62","t":"+7.6%","d":"up"}];
const COLS = ["ID","GIS Layer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Inventory #001","Forest Inventory #002","7.427","2.342","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Inventory #002","Forest Inventory #003","727","6.431","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Inventory #003","Forest Inventory #004","1.881","7.962","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Inventory #004","Forest Inventory #005","9.053","7.229","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Inventory #005","Forest Inventory #001","319","3.340","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":621},{"label":"Mar","value":591},{"label":"Abr","value":282},{"label":"Mai","value":315},{"label":"Jun","value":641},{"label":"Jul","value":391},{"label":"Ago","value":334},{"label":"Set","value":454},{"label":"Out","value":630},{"label":"Nov","value":288},{"label":"Dez","value":499}];
const MX = 641;
