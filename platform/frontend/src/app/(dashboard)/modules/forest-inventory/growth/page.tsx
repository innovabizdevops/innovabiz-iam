...
const PAGE = "Growth Model";
const KPIS = [{"l":"Total Forest Inventory","v":"527","t":"+17.5%","d":"up"},{"l":"Growth Model Ativos","v":"6.613","t":"+0.6%","d":"up"},{"l":"Eficiência (%)","v":"91.8%","t":"-1.8%","d":"down"},{"l":"Score Performance","v":"69","t":"+2.3%","d":"up"}];
const COLS = ["ID","Growth Model","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Inventory #001","Forest Inventory #002","3.449","1.716","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Inventory #002","Forest Inventory #003","3.293","6.717","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Inventory #003","Forest Inventory #004","6.933","7.937","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Inventory #004","Forest Inventory #005","2.069","669","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Inventory #005","Forest Inventory #001","1.245","6.164","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1059},{"label":"Fev","value":876},{"label":"Mar","value":820},{"label":"Abr","value":1021},{"label":"Mai","value":867},{"label":"Jun","value":809},{"label":"Jul","value":1030},{"label":"Ago","value":809},{"label":"Set","value":1000},{"label":"Out","value":1063},{"label":"Nov","value":987},{"label":"Dez","value":757}];
const MX = 1063;
