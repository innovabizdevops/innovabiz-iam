...
const PAGE = "Last Mile";
const KPIS = [{"l":"Projetos Melhoria","v":"4.296","t":"+9.1%","d":"up"},{"l":"Savings (€)","v":"€12551","t":"-2.9%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"66.9%","t":"+16.4%","d":"up"},{"l":"Ciclos PDCA","v":"4.896","t":"+9.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.878","€ 33953.42","5.581","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.856","€ 24921.74","7.428","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.269","€ 33446.94","6.149","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.852","€ 19929.10","904","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.008","€ 15260.90","7.969","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":619},{"label":"Mar","value":699},{"label":"Abr","value":640},{"label":"Mai","value":747},{"label":"Jun","value":699},{"label":"Jul","value":537},{"label":"Ago","value":543},{"label":"Set","value":690},{"label":"Out","value":815},{"label":"Nov","value":457},{"label":"Dez","value":567}];
const MX = 815;
