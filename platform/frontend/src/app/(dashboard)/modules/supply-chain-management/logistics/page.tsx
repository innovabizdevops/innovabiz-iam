...
const PAGE = "Logistics &amp; Transport";
const KPIS = [{"l":"Projetos Melhoria","v":"7.532","t":"+15.9%","d":"up"},{"l":"Savings (€)","v":"€31421","t":"+7.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"90.6%","t":"+3.8%","d":"up"},{"l":"Ciclos PDCA","v":"1.294","t":"+12.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.672","€ 2522.01","2.579","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.161","€ 46483.00","8.439","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.196","€ 14959.99","7.542","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.854","€ 4176.59","4.292","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.559","€ 24585.68","4.612","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":450},{"label":"Fev","value":619},{"label":"Mar","value":476},{"label":"Abr","value":268},{"label":"Mai","value":494},{"label":"Jun","value":633},{"label":"Jul","value":426},{"label":"Ago","value":561},{"label":"Set","value":398},{"label":"Out","value":581},{"label":"Nov","value":443},{"label":"Dez","value":276}];
const MX = 633;
