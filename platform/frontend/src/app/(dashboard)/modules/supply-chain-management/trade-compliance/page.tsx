...
const PAGE = "Trade Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.251","t":"+11.1%","d":"up"},{"l":"NC Abertas","v":"2.055","t":"+0.1%","d":"up"},{"l":"Conformidade (%)","v":"82.3%","t":"+4.4%","d":"up"},{"l":"CAPAs Pendentes","v":"6.779","t":"-0.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.716","89.6%","1.850","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.377","98.8%","8.186","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.487","97.4%","4.666","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.715","70.3%","8.677","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.190","84.3%","7.835","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":283},{"label":"Fev","value":474},{"label":"Mar","value":496},{"label":"Abr","value":418},{"label":"Mai","value":390},{"label":"Jun","value":518},{"label":"Jul","value":470},{"label":"Ago","value":261},{"label":"Set","value":612},{"label":"Out","value":404},{"label":"Nov","value":616},{"label":"Dez","value":334}];
const MX = 616;
