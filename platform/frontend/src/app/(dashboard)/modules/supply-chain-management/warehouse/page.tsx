...
const KPIS = [{"l":"Projetos Melhoria","v":"3.546","t":"-3.9%","d":"down"},{"l":"Savings (€)","v":"€21700","t":"+1.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"87.3%","t":"+0.5%","d":"up"},{"l":"Ciclos PDCA","v":"8.958","t":"+15.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","546","€ 18190.76","8.987","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.778","€ 38448.91","4.644","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","298","€ 39634.35","8.081","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.856","€ 45316.26","8.696","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.493","€ 47825.58","1.744","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":451},{"label":"Mar","value":672},{"label":"Abr","value":345},{"label":"Mai","value":465},{"label":"Jun","value":373},{"label":"Jul","value":403},{"label":"Ago","value":521},{"label":"Set","value":675},{"label":"Out","value":356},{"label":"Nov","value":598},{"label":"Dez","value":384}];
const MX = 697;
