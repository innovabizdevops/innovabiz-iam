...
const ACCENT = "#6366f1";
const MODULE = "Supply Chain Management";
const PAGE = "Transportation Mgmt";
const KPIS = [{"l":"Projetos Melhoria","v":"5.311","t":"+5.6%","d":"up"},{"l":"Savings (€)","v":"€43175","t":"+4.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"77.9%","t":"-0.7%","d":"down"},{"l":"Ciclos PDCA","v":"984","t":"+14.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.607","€ 43627.18","1.510","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.154","€ 45497.12","8.683","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.160","€ 13255.24","5.469","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.814","€ 47005.53","1.153","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.842","€ 37590.87","4.688","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":504},{"label":"Fev","value":269},{"label":"Mar","value":392},{"label":"Abr","value":285},{"label":"Mai","value":594},{"label":"Jun","value":415},{"label":"Jul","value":344},{"label":"Ago","value":373},{"label":"Set","value":377},{"label":"Out","value":535},{"label":"Nov","value":345},{"label":"Dez","value":265}];
const MX = 594;
