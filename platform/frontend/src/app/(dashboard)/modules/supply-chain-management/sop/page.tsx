...
const PAGE = "S&amp;OP";
const KPIS = [{"l":"Projetos Melhoria","v":"1.375","t":"-0.2%","d":"down"},{"l":"Savings (€)","v":"€26265","t":"+17.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"93.2%","t":"+3.2%","d":"up"},{"l":"Ciclos PDCA","v":"6.239","t":"+1.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.135","€ 36180.59","294","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.017","€ 45208.55","8.646","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.234","€ 4517.11","3.922","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.954","€ 17975.51","812","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.834","€ 21230.49","5.694","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":643},{"label":"Mar","value":623},{"label":"Abr","value":858},{"label":"Mai","value":840},{"label":"Jun","value":918},{"label":"Jul","value":660},{"label":"Ago","value":916},{"label":"Set","value":798},{"label":"Out","value":622},{"label":"Nov","value":869},{"label":"Dez","value":667}];
const MX = 918;
