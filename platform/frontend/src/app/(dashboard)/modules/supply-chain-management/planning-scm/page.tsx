...
const PAGE = "Planning";
const KPIS = [{"l":"Projetos Melhoria","v":"5.714","t":"+7.9%","d":"up"},{"l":"Savings (€)","v":"€51185","t":"+17.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"87.4%","t":"+11.3%","d":"up"},{"l":"Ciclos PDCA","v":"4.785","t":"+1.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.702","€ 25942.27","4.596","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.724","€ 22664.96","6.910","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.969","€ 44097.78","4.028","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.162","€ 14233.27","5.877","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.883","€ 26386.53","2.914","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":291},{"label":"Mar","value":487},{"label":"Abr","value":491},{"label":"Mai","value":541},{"label":"Jun","value":512},{"label":"Jul","value":464},{"label":"Ago","value":584},{"label":"Set","value":581},{"label":"Out","value":434},{"label":"Nov","value":322},{"label":"Dez","value":338}];
const MX = 584;
...
export default function PlanningScmPage() {
    return (
