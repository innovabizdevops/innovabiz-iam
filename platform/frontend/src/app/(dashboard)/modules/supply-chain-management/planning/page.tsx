...
const PAGE = "Planning &amp; Demand";
const KPIS = [{"l":"Projetos Melhoria","v":"7.056","t":"+5.2%","d":"up"},{"l":"Savings (€)","v":"€40482","t":"+3.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"69.1%","t":"+13.3%","d":"up"},{"l":"Ciclos PDCA","v":"2.242","t":"+16.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.213","€ 5681.46","1.855","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.281","€ 24075.69","2.303","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.341","€ 28170.78","202","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.024","€ 48523.42","1.901","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","927","€ 7556.21","6.482","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":349},{"label":"Fev","value":697},{"label":"Mar","value":528},{"label":"Abr","value":400},{"label":"Mai","value":690},{"label":"Jun","value":484},{"label":"Jul","value":610},{"label":"Ago","value":448},{"label":"Set","value":362},{"label":"Out","value":458},{"label":"Nov","value":418},{"label":"Dez","value":494}];
const MX = 697;
