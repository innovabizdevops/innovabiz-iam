...
const KPIS = [{"l":"Projetos Melhoria","v":"2.651","t":"-2.0%","d":"down"},{"l":"Savings (€)","v":"€68856","t":"-0.9%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"65.2%","t":"+2.3%","d":"up"},{"l":"Ciclos PDCA","v":"7.727","t":"+4.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","376","€ 24957.45","7.015","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.330","€ 5308.21","5.803","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.947","€ 45665.23","4.423","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.538","€ 44329.96","7.033","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","468","€ 21106.00","1.747","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1051},{"label":"Fev","value":872},{"label":"Mar","value":783},{"label":"Abr","value":709},{"label":"Mai","value":825},{"label":"Jun","value":786},{"label":"Jul","value":716},{"label":"Ago","value":867},{"label":"Set","value":921},{"label":"Out","value":715},{"label":"Nov","value":840},{"label":"Dez","value":751}];
const MX = 1051;
...
export default function LogisticsScmPage() {
    return (
