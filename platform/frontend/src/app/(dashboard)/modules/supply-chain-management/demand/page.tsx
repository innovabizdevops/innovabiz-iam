...
const PAGE = "Demand AI";
const KPIS = [{"l":"Projetos Melhoria","v":"446","t":"-3.1%","d":"down"},{"l":"Savings (€)","v":"€29554","t":"+12.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"76.6%","t":"+10.3%","d":"up"},{"l":"Ciclos PDCA","v":"4.730","t":"+12.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.895","€ 16289.02","4.137","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.188","€ 39229.90","6.709","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.290","€ 2331.95","4.053","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.678","€ 19061.32","5.283","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.633","€ 5697.61","7.649","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":692},{"label":"Mar","value":765},{"label":"Abr","value":818},{"label":"Mai","value":877},{"label":"Jun","value":845},{"label":"Jul","value":908},{"label":"Ago","value":763},{"label":"Set","value":696},{"label":"Out","value":661},{"label":"Nov","value":752},{"label":"Dez","value":698}];
const MX = 908;
