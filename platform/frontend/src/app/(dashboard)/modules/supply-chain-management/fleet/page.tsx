...
const KPIS = [{"l":"Projetos Melhoria","v":"2.580","t":"+4.3%","d":"up"},{"l":"Savings (€)","v":"€97527","t":"+10.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"88.3%","t":"+1.6%","d":"up"},{"l":"Ciclos PDCA","v":"8.979","t":"-2.5%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","670","€ 17725.95","8.812","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.827","€ 29955.98","8.586","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.278","€ 5525.89","2.328","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.286","€ 29210.68","987","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.123","€ 20193.20","1.899","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":335},{"label":"Fev","value":607},{"label":"Mar","value":597},{"label":"Abr","value":352},{"label":"Mai","value":502},{"label":"Jun","value":620},{"label":"Jul","value":539},{"label":"Ago","value":562},{"label":"Set","value":428},{"label":"Out","value":574},{"label":"Nov","value":453},{"label":"Dez","value":346}];
const MX = 620;
