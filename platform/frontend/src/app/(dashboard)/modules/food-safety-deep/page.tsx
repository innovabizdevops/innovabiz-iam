...
/* ═══ Food Safety Deep — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "3453", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "980", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€402K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2123652353", cells: ["FOO-4353", "Food Safety Deep Item 1", "26/6/2026", "€2453"], status: "active" as const },
    { id: "2123655924", cells: ["FOO-7924", "Food Safety Deep Item 2", "13/1/2026", "€6024"], status: "pending" as const },
    { id: "2123659495", cells: ["FOO-2495", "Food Safety Deep Item 3", "28/8/2026", "€9595"], status: "completed" as const },
    { id: "2123663066", cells: ["FOO-6066", "Food Safety Deep Item 4", "15/3/2026", "€13 166"], status: "warning" as const },
    { id: "2123666637", cells: ["FOO-9637", "Food Safety Deep Item 5", "2/10/2026", "€16 737"], status: "active" as const },
];
...
export default function FoodSafetyDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Food Safety Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Food Safety Deep</p>
                    </div>
                </div>
