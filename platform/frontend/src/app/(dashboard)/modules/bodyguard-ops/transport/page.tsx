...
const KPIS = [{"l":"Atletas Registados","v":"5.764","t":"+15.0%","d":"up"},{"l":"Treinos/Semana","v":"580","t":"+11.5%","d":"up"},{"l":"Competições","v":"4.082","t":"+8.5%","d":"up"},{"l":"Performance Score","v":"74","t":"+12.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.584","5.804","4.757","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.037","874","1.343","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.051","2.292","5.218","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.933","8.660","2.857","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.020","1.780","8.186","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":248},{"label":"Fev","value":587},{"label":"Mar","value":384},{"label":"Abr","value":488},{"label":"Mai","value":564},{"label":"Jun","value":546},{"label":"Jul","value":288},{"label":"Ago","value":442},{"label":"Set","value":618},{"label":"Out","value":382},{"label":"Nov","value":416},{"label":"Dez","value":537}];
const MX = 618;
