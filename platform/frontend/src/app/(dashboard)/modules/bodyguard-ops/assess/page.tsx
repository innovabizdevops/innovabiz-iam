...
const ACCENT = "#6366f1";
const MODULE = "Bodyguard Operations";
const PAGE = "Assessment";
const KPIS = [{"l":"Total Bodyguard Ops","v":"2.739","t":"-3.6%","d":"down"},{"l":"Assessment Ativos","v":"6.542","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"93.2%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"59","t":"+3.1%","d":"up"}];
const COLS = ["ID","Assessment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bodyguard Ops #001","Bodyguard Ops #002","9.087","3.672","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Bodyguard Ops #002","Bodyguard Ops #003","2.184","3.111","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Bodyguard Ops #003","Bodyguard Ops #004","3.911","8.998","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Bodyguard Ops #004","Bodyguard Ops #005","8.302","5.700","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bodyguard Ops #005","Bodyguard Ops #001","7.021","6.725","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":580},{"label":"Mar","value":523},{"label":"Abr","value":385},{"label":"Mai","value":653},{"label":"Jun","value":499},{"label":"Jul","value":345},{"label":"Ago","value":601},{"label":"Set","value":487},{"label":"Out","value":685},{"label":"Nov","value":569},{"label":"Dez","value":350}];
const MX = 728;
