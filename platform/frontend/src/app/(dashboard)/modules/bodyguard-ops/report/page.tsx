...
const PAGE = "Report";
const KPIS = [{"l":"Total Bodyguard Ops","v":"7.705","t":"+16.2%","d":"up"},{"l":"Report Ativos","v":"1.326","t":"-5.3%","d":"down"},{"l":"Eficiência (%)","v":"71.3%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"79","t":"-3.8%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bodyguard Ops #001","Bodyguard Ops #002","1.655","8.366","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Bodyguard Ops #002","Bodyguard Ops #003","1.346","1.391","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Bodyguard Ops #003","Bodyguard Ops #004","5.112","1.404","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Bodyguard Ops #004","Bodyguard Ops #005","6.530","4.244","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bodyguard Ops #005","Bodyguard Ops #001","6.732","8.070","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":417},{"label":"Mar","value":661},{"label":"Abr","value":448},{"label":"Mai","value":735},{"label":"Jun","value":384},{"label":"Jul","value":400},{"label":"Ago","value":515},{"label":"Set","value":357},{"label":"Out","value":484},{"label":"Nov","value":581},{"label":"Dez","value":683}];
const MX = 735;
