...
export default function DemolitionMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Demolition Mgmt</h1><p className="text-sm text-muted-foreground">Demolition Mgmt • iBOS Enterprise</p></div>
