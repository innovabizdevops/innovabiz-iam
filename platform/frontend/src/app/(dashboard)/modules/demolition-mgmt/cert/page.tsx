...
const ACCENT = "#6366f1";
const MODULE = "Demolition Mgmt";
const PAGE = "Certificate";
const KPIS = [{"l":"Total Demolition Mgmt","v":"5.055","t":"+16.8%","d":"up"},{"l":"Certificate Ativos","v":"907","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"70.8%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"87","t":"+9.6%","d":"up"}];
const COLS = ["ID","Certificate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Demolition Mgmt #001","Demolition Mgmt #002","2.491","3.133","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Demolition Mgmt #002","Demolition Mgmt #003","1.753","5.386","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Demolition Mgmt #003","Demolition Mgmt #004","3.822","1.193","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Demolition Mgmt #004","Demolition Mgmt #005","2.328","375","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Demolition Mgmt #005","Demolition Mgmt #001","1.983","1.604","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":558},{"label":"Mar","value":578},{"label":"Abr","value":534},{"label":"Mai","value":335},{"label":"Jun","value":571},{"label":"Jul","value":413},{"label":"Ago","value":598},{"label":"Set","value":558},{"label":"Out","value":462},{"label":"Nov","value":456},{"label":"Dez","value":352}];
const MX = 598;
