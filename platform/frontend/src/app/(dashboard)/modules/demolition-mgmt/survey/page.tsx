...
const PAGE = "Survey";
const KPIS = [{"l":"Surveys Ativos","v":"6.516","t":"+16.5%","d":"up"},{"l":"Respostas/Semana","v":"1755","t":"-5.1%","d":"down"},{"l":"NPS Médio","v":"56","t":"+7.7%","d":"up"},{"l":"Taxa Resposta (%)","v":"88.6%","t":"+14.7%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","2.201","56","71.3%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","3.151","63","75.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","716","69","75.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","7.149","67","83.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","5.819","70","91.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":784},{"label":"Mar","value":904},{"label":"Abr","value":868},{"label":"Mai","value":549},{"label":"Jun","value":865},{"label":"Jul","value":544},{"label":"Ago","value":565},{"label":"Set","value":881},{"label":"Out","value":850},{"label":"Nov","value":732},{"label":"Dez","value":923}];
const MX = 923;
