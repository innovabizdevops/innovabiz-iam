...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.305","t":"-4.0%","d":"down"},{"l":"NC Abertas","v":"2.417","t":"-4.1%","d":"down"},{"l":"Conformidade (%)","v":"93.7%","t":"+9.4%","d":"up"},{"l":"CAPAs Pendentes","v":"6.677","t":"-3.5%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.412","74.0%","3.426","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.759","81.4%","165","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.827","81.0%","7.393","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","795","89.9%","6.535","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.872","89.7%","8.714","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":712},{"label":"Mar","value":492},{"label":"Abr","value":627},{"label":"Mai","value":515},{"label":"Jun","value":561},{"label":"Jul","value":477},{"label":"Ago","value":416},{"label":"Set","value":353},{"label":"Out","value":606},{"label":"Nov","value":485},{"label":"Dez","value":439}];
const MX = 712;
