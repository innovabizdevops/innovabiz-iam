...
/* ═══ COSMOS Compliance Fabric — Dashboard ═══ */

const ACCENT = "#1e1b4b";

const KPIS = [
    { label: "Total Registos", value: "1173", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4292", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€115K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "721344773", cells: ["COS-4773", "COSMOS Compliance Fabric Item 1", "10/6/2026", "€44 873"], status: "active" as const },
    { id: "721348344", cells: ["COS-8344", "COSMOS Compliance Fabric Item 2", "25/1/2026", "€48 444"], status: "pending" as const },
    { id: "721351915", cells: ["COS-2915", "COSMOS Compliance Fabric Item 3", "12/8/2026", "€2015"], status: "completed" as const },
    { id: "721355486", cells: ["COS-6486", "COSMOS Compliance Fabric Item 4", "27/3/2026", "€5586"], status: "warning" as const },
    { id: "721359057", cells: ["COS-1057", "COSMOS Compliance Fabric Item 5", "14/10/2026", "€9157"], status: "active" as const },
];
...
export default function CosmosComplianceFabricPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">COSMOS Compliance Fabric</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • COSMOS Compliance Fabric</p>
                    </div>
                </div>
