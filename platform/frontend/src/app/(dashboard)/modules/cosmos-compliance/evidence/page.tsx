...
const PAGE = "Evidence";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.934","t":"-2.6%","d":"down"},{"l":"NC Abertas","v":"3.568","t":"+7.4%","d":"up"},{"l":"Conformidade (%)","v":"83.3%","t":"-1.6%","d":"down"},{"l":"CAPAs Pendentes","v":"2.065","t":"+1.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.274","97.6%","861","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.400","88.9%","8.147","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.270","79.9%","4.905","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.499","71.3%","6.917","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.490","84.8%","5.821","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":381},{"label":"Mar","value":399},{"label":"Abr","value":499},{"label":"Mai","value":610},{"label":"Jun","value":438},{"label":"Jul","value":688},{"label":"Ago","value":545},{"label":"Set","value":505},{"label":"Out","value":568},{"label":"Nov","value":507},{"label":"Dez","value":699}];
const MX = 699;
