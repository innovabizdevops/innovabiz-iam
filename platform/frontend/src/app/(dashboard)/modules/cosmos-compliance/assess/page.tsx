...
const ACCENT = "#1e1b4b";
const MODULE = "COSMOS Compliance Fabric";
const PAGE = "Assess";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.702","t":"+14.5%","d":"up"},{"l":"NC Abertas","v":"4.668","t":"+11.5%","d":"up"},{"l":"Conformidade (%)","v":"81.5%","t":"+0.2%","d":"up"},{"l":"CAPAs Pendentes","v":"8.019","t":"+0.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.567","70.6%","3.946","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.339","70.8%","3.575","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.956","88.0%","5.725","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.937","76.2%","4.987","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.752","77.2%","6.465","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":879},{"label":"Fev","value":953},{"label":"Mar","value":856},{"label":"Abr","value":860},{"label":"Mai","value":927},{"label":"Jun","value":745},{"label":"Jul","value":844},{"label":"Ago","value":1034},{"label":"Set","value":845},{"label":"Out","value":864},{"label":"Nov","value":752},{"label":"Dez","value":977}];
const MX = 1034;
