...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.574","t":"-1.8%","d":"down"},{"l":"NC Abertas","v":"6.404","t":"+10.2%","d":"up"},{"l":"Conformidade (%)","v":"88.1%","t":"-0.1%","d":"down"},{"l":"CAPAs Pendentes","v":"3.005","t":"+7.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.323","99.4%","6.229","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.870","94.2%","5.252","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.066","88.8%","4.424","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.920","97.8%","7.923","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.294","97.0%","8.971","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":676},{"label":"Mar","value":1025},{"label":"Abr","value":1034},{"label":"Mai","value":1008},{"label":"Jun","value":1050},{"label":"Jul","value":936},{"label":"Ago","value":1042},{"label":"Set","value":1027},{"label":"Out","value":1007},{"label":"Nov","value":1026},{"label":"Dez","value":895}];
const MX = 1050;
