...
const PAGE = "Comply";
const KPIS = [{"l":"Dashboards Ativos","v":"5.050","t":"+13.1%","d":"up"},{"l":"Queries/Dia","v":"1032","t":"+15.9%","d":"up"},{"l":"Dados Processados (GB)","v":"5.669","t":"+1.9%","d":"up"},{"l":"Utilizadores Analytics","v":"7.119","t":"-2.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1268","2026-03-21","3.499","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2287","2026-01-21","7.368","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3164","2026-01-05","5.047","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4994","2026-02-14","9.067","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","168","2026-01-21","8.316","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":912},{"label":"Mar","value":804},{"label":"Abr","value":728},{"label":"Mai","value":1009},{"label":"Jun","value":798},{"label":"Jul","value":700},{"label":"Ago","value":755},{"label":"Set","value":964},{"label":"Out","value":681},{"label":"Nov","value":1018},{"label":"Dez","value":831}];
const MX = 1018;
