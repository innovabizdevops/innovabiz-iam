...
/* ═══ S-AI Data Sovereignty Engine — Dashboard ═══ */

const ACCENT = "#991b1b";

const KPIS = [
    { label: "Total Registos", value: "2253", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3279", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€200K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "708159053", cells: ["SAI-4053", "S-AI Data Sovereignty Engine Item 1", "22/6/2026", "€9153"], status: "active" as const },
    { id: "708162624", cells: ["SAI-7624", "S-AI Data Sovereignty Engine Item 2", "9/1/2026", "€12 724"], status: "pending" as const },
    { id: "708166195", cells: ["SAI-2195", "S-AI Data Sovereignty Engine Item 3", "24/8/2026", "€16 295"], status: "completed" as const },
    { id: "708169766", cells: ["SAI-5766", "S-AI Data Sovereignty Engine Item 4", "11/3/2026", "€19 866"], status: "warning" as const },
    { id: "708173337", cells: ["SAI-9337", "S-AI Data Sovereignty Engine Item 5", "26/10/2026", "€23 437"], status: "active" as const },
];
...
export default function SaiDataSovereigntyEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">S-AI Data Sovereignty Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • S-AI Data Sovereignty Engine</p>
                    </div>
                </div>
