...
const PAGE = "Classify";
const KPIS = [{"l":"Dashboards Ativos","v":"323","t":"-0.8%","d":"down"},{"l":"Queries/Dia","v":"4504","t":"-1.0%","d":"down"},{"l":"Dados Processados (GB)","v":"5.050","t":"+11.4%","d":"up"},{"l":"Utilizadores Analytics","v":"5.561","t":"+11.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4974","2026-02-16","7.638","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","668","2026-01-26","6.836","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","5072","2026-03-08","3.969","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4959","2026-03-16","5.505","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","107","2026-03-21","7.511","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":515},{"label":"Fev","value":556},{"label":"Mar","value":504},{"label":"Abr","value":527},{"label":"Mai","value":642},{"label":"Jun","value":770},{"label":"Jul","value":722},{"label":"Ago","value":509},{"label":"Set","value":705},{"label":"Out","value":488},{"label":"Nov","value":446},{"label":"Dez","value":554}];
const MX = 770;
