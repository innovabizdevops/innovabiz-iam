...
const PAGE = "Residency";
const KPIS = [{"l":"Dashboards Ativos","v":"7.442","t":"+1.2%","d":"up"},{"l":"Queries/Dia","v":"2106","t":"+12.7%","d":"up"},{"l":"Dados Processados (GB)","v":"3.736","t":"-0.5%","d":"down"},{"l":"Utilizadores Analytics","v":"2.574","t":"+1.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2402","2026-01-25","803","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","712","2026-03-26","3.261","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","616","2026-01-07","8.781","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3239","2026-03-24","5.901","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1605","2026-01-14","7.500","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":633},{"label":"Mar","value":411},{"label":"Abr","value":677},{"label":"Mai","value":691},{"label":"Jun","value":486},{"label":"Jul","value":391},{"label":"Ago","value":442},{"label":"Set","value":558},{"label":"Out","value":538},{"label":"Nov","value":381},{"label":"Dez","value":519}];
const MX = 691;
