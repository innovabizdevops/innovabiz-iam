...
const ACCENT = "#991b1b";
const MODULE = "S-AI Data Sovereignty Engine";
const PAGE = "Encrypt";
const KPIS = [{"l":"Dashboards Ativos","v":"4.452","t":"+14.5%","d":"up"},{"l":"Queries/Dia","v":"1169","t":"+15.3%","d":"up"},{"l":"Dados Processados (GB)","v":"1.896","t":"-5.0%","d":"down"},{"l":"Utilizadores Analytics","v":"6.911","t":"-5.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","518","2026-03-23","6.622","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3893","2026-01-15","7.643","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4107","2026-02-23","5.770","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2691","2026-02-24","4.275","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3114","2026-03-26","6.269","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":429},{"label":"Mar","value":523},{"label":"Abr","value":708},{"label":"Mai","value":620},{"label":"Jun","value":370},{"label":"Jul","value":514},{"label":"Ago","value":339},{"label":"Set","value":413},{"label":"Out","value":437},{"label":"Nov","value":474},{"label":"Dez","value":668}];
const MX = 708;
