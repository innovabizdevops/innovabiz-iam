...
const ACCENT = "#4c1d95";
const MODULE = "Digital Notary Platform";
const PAGE = "Verify";
const KPIS = [{"l":"Total Notary Digital","v":"4.423","t":"+1.4%","d":"up"},{"l":"Verify Ativos","v":"1.302","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"66.0%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"87","t":"+13.5%","d":"up"}];
const COLS = ["ID","Verify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Notary Digital #001","Notary Digital #002","699","5.562","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Notary Digital #002","Notary Digital #003","8.407","3.046","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Notary Digital #003","Notary Digital #004","3.621","6.827","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Notary Digital #004","Notary Digital #005","3.255","4.448","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Notary Digital #005","Notary Digital #001","8.743","5.598","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":358},{"label":"Fev","value":323},{"label":"Mar","value":621},{"label":"Abr","value":631},{"label":"Mai","value":401},{"label":"Jun","value":346},{"label":"Jul","value":374},{"label":"Ago","value":264},{"label":"Set","value":383},{"label":"Out","value":402},{"label":"Nov","value":361},{"label":"Dez","value":478}];
const MX = 631;
