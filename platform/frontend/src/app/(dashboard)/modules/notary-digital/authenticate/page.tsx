...
const KPIS = [{"l":"Utilizadores Ativos","v":"6.472","t":"+2.1%","d":"up"},{"l":"Sessões/Dia","v":"2189","t":"+8.7%","d":"up"},{"l":"MFA Adoção (%)","v":"91.3%","t":"-4.6%","d":"down"},{"l":"Tentativas Bloqueadas","v":"8.754","t":"-3.1%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","168","7.348","5.464","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","230","2.407","327","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.538","8.459","7.366","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.247","7.568","6.140","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.142","1.387","359","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":691},{"label":"Mar","value":364},{"label":"Abr","value":639},{"label":"Mai","value":445},{"label":"Jun","value":605},{"label":"Jul","value":565},{"label":"Ago","value":326},{"label":"Set","value":338},{"label":"Out","value":538},{"label":"Nov","value":701},{"label":"Dez","value":398}];
const MX = 701;
