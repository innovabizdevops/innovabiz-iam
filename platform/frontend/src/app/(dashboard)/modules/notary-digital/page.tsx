...
/* ═══ Digital Notary Platform — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "6093", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3909", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€292K", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "495520793", cells: ["NOT-8793", "Digital Notary Platform Item 1", "6/6/2026", "€20 893"], status: "active" as const },
    { id: "495524364", cells: ["NOT-3364", "Digital Notary Platform Item 2", "21/1/2026", "€24 464"], status: "pending" as const },
    { id: "495527935", cells: ["NOT-6935", "Digital Notary Platform Item 3", "8/8/2026", "€28 035"], status: "completed" as const },
    { id: "495531506", cells: ["NOT-1506", "Digital Notary Platform Item 4", "23/3/2026", "€31 606"], status: "warning" as const },
    { id: "495535077", cells: ["NOT-5077", "Digital Notary Platform Item 5", "10/10/2026", "€35 177"], status: "active" as const },
];
...
export default function DigitalNotaryPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Digital Notary Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Digital Notary Platform</p>
                    </div>
                </div>
