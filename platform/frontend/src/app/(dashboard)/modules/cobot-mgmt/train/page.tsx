...
const PAGE = "Training";
const KPIS = [{"l":"Total Cobot Mgmt","v":"6.248","t":"-4.5%","d":"down"},{"l":"Training Ativos","v":"4.716","t":"+13.4%","d":"up"},{"l":"Eficiência (%)","v":"93.5%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"66","t":"+9.9%","d":"up"}];
const COLS = ["ID","Training","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cobot Mgmt #001","Cobot Mgmt #002","3.027","3.390","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Cobot Mgmt #002","Cobot Mgmt #003","6.995","4.568","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Cobot Mgmt #003","Cobot Mgmt #004","1.678","1.373","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Cobot Mgmt #004","Cobot Mgmt #005","3.690","3.639","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cobot Mgmt #005","Cobot Mgmt #001","3.334","8.443","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":779},{"label":"Mar","value":705},{"label":"Abr","value":754},{"label":"Mai","value":830},{"label":"Jun","value":1009},{"label":"Jul","value":1027},{"label":"Ago","value":989},{"label":"Set","value":747},{"label":"Out","value":904},{"label":"Nov","value":996},{"label":"Dez","value":738}];
const MX = 1027;
