...
const PAGE = "Safety Zone";
const KPIS = [{"l":"Total Cobot Mgmt","v":"3.282","t":"+0.9%","d":"up"},{"l":"Safety Zone Ativos","v":"7.947","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"66.1%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"67","t":"+6.4%","d":"up"}];
const COLS = ["ID","Safety Zone","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cobot Mgmt #001","Cobot Mgmt #002","2.393","329","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Cobot Mgmt #002","Cobot Mgmt #003","3.333","8.779","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Cobot Mgmt #003","Cobot Mgmt #004","7.879","5.564","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Cobot Mgmt #004","Cobot Mgmt #005","3.141","8.180","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cobot Mgmt #005","Cobot Mgmt #001","6.860","2.434","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":788},{"label":"Mar","value":481},{"label":"Abr","value":794},{"label":"Mai","value":537},{"label":"Jun","value":512},{"label":"Jul","value":466},{"label":"Ago","value":468},{"label":"Set","value":769},{"label":"Out","value":685},{"label":"Nov","value":677},{"label":"Dez","value":492}];
const MX = 794;
