...
const PAGE = "Task Assign";
const KPIS = [{"l":"Total Cobot Mgmt","v":"7.122","t":"-1.3%","d":"down"},{"l":"Task Assign Ativos","v":"2.570","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"70.1%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"69","t":"+5.8%","d":"up"}];
const COLS = ["ID","Task Assign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cobot Mgmt #001","Cobot Mgmt #002","5.688","5.138","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Cobot Mgmt #002","Cobot Mgmt #003","3.899","5.472","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Cobot Mgmt #003","Cobot Mgmt #004","8.071","2.392","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Cobot Mgmt #004","Cobot Mgmt #005","2.767","7.846","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cobot Mgmt #005","Cobot Mgmt #001","7.590","4.854","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":735},{"label":"Mar","value":401},{"label":"Abr","value":773},{"label":"Mai","value":663},{"label":"Jun","value":683},{"label":"Jul","value":672},{"label":"Ago","value":574},{"label":"Set","value":408},{"label":"Out","value":688},{"label":"Nov","value":618},{"label":"Dez","value":769}];
const MX = 773;
