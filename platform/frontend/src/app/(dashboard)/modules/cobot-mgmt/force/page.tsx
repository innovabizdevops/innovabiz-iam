...
const ACCENT = "#6366f1";
const MODULE = "Cobot Management";
const PAGE = "Force Sensor";
const KPIS = [{"l":"Dispositivos Online","v":"8.278","t":"+3.1%","d":"up"},{"l":"Dados/Min (MB)","v":"273","t":"+17.0%","d":"up"},{"l":"Alertas Ativos","v":"1.085","t":"+0.8%","d":"up"},{"l":"Uptime (%)","v":"92.3%","t":"+14.6%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","1.864","3.666","6.929","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.918","8.295","156","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","3.704","4.480","691","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.479","2.113","6.432","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.928","3.653","3.665","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":518},{"label":"Fev","value":751},{"label":"Mar","value":578},{"label":"Abr","value":539},{"label":"Mai","value":459},{"label":"Jun","value":593},{"label":"Jul","value":724},{"label":"Ago","value":436},{"label":"Set","value":760},{"label":"Out","value":606},{"label":"Nov","value":461},{"label":"Dez","value":693}];
const MX = 760;
