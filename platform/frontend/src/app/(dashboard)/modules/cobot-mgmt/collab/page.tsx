...
const PAGE = "Human-Robot";
const KPIS = [{"l":"Total Cobot Mgmt","v":"1.254","t":"+2.2%","d":"up"},{"l":"Human Robot Ativos","v":"5.820","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"84.5%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"74","t":"-4.1%","d":"down"}];
const COLS = ["ID","Human Robot","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cobot Mgmt #001","Cobot Mgmt #002","8.554","8.488","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Cobot Mgmt #002","Cobot Mgmt #003","2.038","5.913","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Cobot Mgmt #003","Cobot Mgmt #004","5.583","6.913","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Cobot Mgmt #004","Cobot Mgmt #005","5.354","1.450","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cobot Mgmt #005","Cobot Mgmt #001","7.473","5.494","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":393},{"label":"Mar","value":559},{"label":"Abr","value":650},{"label":"Mai","value":484},{"label":"Jun","value":559},{"label":"Jul","value":737},{"label":"Ago","value":639},{"label":"Set","value":643},{"label":"Out","value":602},{"label":"Nov","value":383},{"label":"Dez","value":698}];
const MX = 737;
