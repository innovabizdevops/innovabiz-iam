...
const PAGE = "Folding";
const KPIS = [{"l":"Total Protein Eng","v":"3.607","t":"+5.7%","d":"up"},{"l":"Folding Ativos","v":"819","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"82.9%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"56","t":"+5.7%","d":"up"}];
const COLS = ["ID","Folding","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Protein Eng #001","Protein Eng #002","1.461","990","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Protein Eng #002","Protein Eng #003","3.370","7.224","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Protein Eng #003","Protein Eng #004","2.358","3.357","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Protein Eng #004","Protein Eng #005","2.982","4.605","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Protein Eng #005","Protein Eng #001","8.588","5.503","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":479},{"label":"Mar","value":449},{"label":"Abr","value":461},{"label":"Mai","value":437},{"label":"Jun","value":724},{"label":"Jul","value":429},{"label":"Ago","value":411},{"label":"Set","value":453},{"label":"Out","value":717},{"label":"Nov","value":693},{"label":"Dez","value":630}];
const MX = 724;
