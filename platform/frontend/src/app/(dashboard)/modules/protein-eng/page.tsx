...
export default function ProteinEngPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Protein Eng</h1><p className="text-sm text-muted-foreground">Protein Eng • iBOS Enterprise</p></div>
