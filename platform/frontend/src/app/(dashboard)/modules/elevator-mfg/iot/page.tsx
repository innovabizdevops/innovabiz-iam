...
const ACCENT = "#475569";
const MODULE = "Elevator Manufacturing";
const PAGE = "IoT";
const KPIS = [{"l":"Dispositivos Online","v":"1.195","t":"+17.3%","d":"up"},{"l":"Dados/Min (MB)","v":"3.541","t":"+11.0%","d":"up"},{"l":"Alertas Ativos","v":"6.676","t":"+13.1%","d":"up"},{"l":"Uptime (%)","v":"71.9%","t":"-3.2%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","822","4.150","6.590","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.959","5.424","7.578","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.880","4.462","7.291","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","4.279","7.939","3.665","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","914","8.763","4.147","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":581},{"label":"Fev","value":760},{"label":"Mar","value":557},{"label":"Abr","value":753},{"label":"Mai","value":690},{"label":"Jun","value":863},{"label":"Jul","value":923},{"label":"Ago","value":808},{"label":"Set","value":712},{"label":"Out","value":832},{"label":"Nov","value":611},{"label":"Dez","value":598}];
const MX = 923;
