...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"348","t":"+13.3%","d":"up"},{"l":"Submissões/Dia","v":"2427","t":"+5.7%","d":"up"},{"l":"Documentos Gerados","v":"2.398","t":"+0.1%","d":"up"},{"l":"Templates","v":"6.186","t":"-5.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.169","2026-02-15","3.529","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.071","2026-01-22","3.256","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.713","2026-03-16","1.934","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.871","2026-02-07","4.274","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.221","2026-01-14","3.785","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1059},{"label":"Fev","value":928},{"label":"Mar","value":889},{"label":"Abr","value":887},{"label":"Mai","value":749},{"label":"Jun","value":1073},{"label":"Jul","value":803},{"label":"Ago","value":990},{"label":"Set","value":810},{"label":"Out","value":917},{"label":"Nov","value":891},{"label":"Dez","value":1016}];
const MX = 1073;
