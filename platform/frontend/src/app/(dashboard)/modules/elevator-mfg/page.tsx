...
/* ═══ Elevator Manufacturing — Dashboard ═══ */

const ACCENT = "#475569";

const KPIS = [
    { label: "Total Registos", value: "826", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3082", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€349K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "-9%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "782724426", cells: ["ELE-4426", "Elevator Manufacturing Item 1", "23/7/2026", "€24 526"], status: "active" as const },
    { id: "782727997", cells: ["ELE-7997", "Elevator Manufacturing Item 2", "10/2/2026", "€28 097"], status: "pending" as const },
    { id: "782731568", cells: ["ELE-2568", "Elevator Manufacturing Item 3", "25/9/2026", "€31 668"], status: "completed" as const },
    { id: "782735139", cells: ["ELE-6139", "Elevator Manufacturing Item 4", "12/4/2026", "€35 239"], status: "warning" as const },
    { id: "782738710", cells: ["ELE-9710", "Elevator Manufacturing Item 5", "27/11/2026", "€38 810"], status: "active" as const },
];
...
export default function ElevatorManufacturingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Elevator Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Elevator Manufacturing</p>
                    </div>
                </div>
