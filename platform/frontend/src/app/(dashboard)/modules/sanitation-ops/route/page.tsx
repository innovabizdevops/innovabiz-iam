...
const PAGE = "Route";
const KPIS = [{"l":"Total Sanitation Ops","v":"2.534","t":"+2.1%","d":"up"},{"l":"Route Ativos","v":"706","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"84.7%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"93","t":"+6.2%","d":"up"}];
const COLS = ["ID","Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sanitation Ops #001","Sanitation Ops #002","2.549","2.386","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Sanitation Ops #002","Sanitation Ops #003","3.237","4.863","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Sanitation Ops #003","Sanitation Ops #004","8.457","819","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Sanitation Ops #004","Sanitation Ops #005","8.098","108","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sanitation Ops #005","Sanitation Ops #001","5.282","4.431","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":830},{"label":"Mar","value":998},{"label":"Abr","value":935},{"label":"Mai","value":1018},{"label":"Jun","value":838},{"label":"Jul","value":887},{"label":"Ago","value":750},{"label":"Set","value":916},{"label":"Out","value":699},{"label":"Nov","value":673},{"label":"Dez","value":807}];
const MX = 1018;
