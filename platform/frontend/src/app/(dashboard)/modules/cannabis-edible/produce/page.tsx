...
const ACCENT = "#0d3b1e";
const MODULE = "Cannabis Edibles";
const PAGE = "Produce";
const KPIS = [{"l":"Integrações Ativas","v":"6.457","t":"-5.9%","d":"down"},{"l":"Chamadas/Hora","v":"473","t":"+15.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.3%","t":"+6.1%","d":"up"},{"l":"Latência Média (ms)","v":"153ms","t":"-4.3%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.725","4.244","84.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.518","3.826","83.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.882","1.894","94.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.804","674","74.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.138","7.831","79.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":698},{"label":"Mar","value":734},{"label":"Abr","value":656},{"label":"Mai","value":465},{"label":"Jun","value":474},{"label":"Jul","value":775},{"label":"Ago","value":752},{"label":"Set","value":597},{"label":"Out","value":557},{"label":"Nov","value":705},{"label":"Dez","value":547}];
const MX = 775;
