...
const PAGE = "Recipe";
const KPIS = [{"l":"Integrações Ativas","v":"6.752","t":"+14.8%","d":"up"},{"l":"Chamadas/Hora","v":"4608","t":"-1.8%","d":"down"},{"l":"Taxa Sucesso (%)","v":"65.6%","t":"+17.6%","d":"up"},{"l":"Latência Média (ms)","v":"169ms","t":"+9.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.146","8.839","94.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.008","4.187","78.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.107","8.343","92.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.034","6.648","78.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.393","184","78.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":809},{"label":"Mar","value":654},{"label":"Abr","value":602},{"label":"Mai","value":587},{"label":"Jun","value":743},{"label":"Jul","value":596},{"label":"Ago","value":688},{"label":"Set","value":635},{"label":"Out","value":742},{"label":"Nov","value":504},{"label":"Dez","value":485}];
const MX = 809;
