...
/* ═══ Cannabis Edibles — Dashboard ═══ */

const ACCENT = "#0d3b1e";

const KPIS = [
    { label: "Total Registos", value: "1268", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2628", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€408K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1011929668", cells: ["CAN-6668", "Cannabis Edibles Item 1", "9/5/2026", "€29 768"], status: "active" as const },
    { id: "1011933239", cells: ["CAN-1239", "Cannabis Edibles Item 2", "24/12/2026", "€33 339"], status: "pending" as const },
    { id: "1011936810", cells: ["CAN-4810", "Cannabis Edibles Item 3", "11/7/2026", "€36 910"], status: "completed" as const },
    { id: "1011940381", cells: ["CAN-8381", "Cannabis Edibles Item 4", "26/2/2026", "€40 481"], status: "warning" as const },
    { id: "1011943952", cells: ["CAN-2952", "Cannabis Edibles Item 5", "13/9/2026", "€44 052"], status: "active" as const },
];
...
export default function CannabisEdiblesPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cannabis Edibles</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cannabis Edibles</p>
                    </div>
                </div>
