...
const PAGE = "Dose";
const KPIS = [{"l":"Integrações Ativas","v":"4.506","t":"-5.9%","d":"down"},{"l":"Chamadas/Hora","v":"4438","t":"+7.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.3%","t":"+15.8%","d":"up"},{"l":"Latência Média (ms)","v":"49ms","t":"+7.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.732","5.075","95.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.696","3.600","72.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.306","5.771","90.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.578","1.200","73.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.493","2.813","73.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":888},{"label":"Mar","value":903},{"label":"Abr","value":917},{"label":"Mai","value":704},{"label":"Jun","value":1018},{"label":"Jul","value":899},{"label":"Ago","value":905},{"label":"Set","value":1051},{"label":"Out","value":926},{"label":"Nov","value":1003},{"label":"Dez","value":954}];
const MX = 1051;
