...
const PAGE = "Test";
const KPIS = [{"l":"Integrações Ativas","v":"8.796","t":"+3.4%","d":"up"},{"l":"Chamadas/Hora","v":"547","t":"-4.5%","d":"down"},{"l":"Taxa Sucesso (%)","v":"81.0%","t":"-2.6%","d":"down"},{"l":"Latência Média (ms)","v":"106ms","t":"-3.7%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.756","2.939","79.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.095","5.242","81.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.291","4.904","92.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.878","5.910","74.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","614","6.936","82.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":599},{"label":"Mar","value":711},{"label":"Abr","value":723},{"label":"Mai","value":455},{"label":"Jun","value":805},{"label":"Jul","value":433},{"label":"Ago","value":758},{"label":"Set","value":789},{"label":"Out","value":471},{"label":"Nov","value":776},{"label":"Dez","value":821}];
const MX = 821;
