...
const PAGE = "Package";
const KPIS = [{"l":"Integrações Ativas","v":"630","t":"+3.9%","d":"up"},{"l":"Chamadas/Hora","v":"3226","t":"+12.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"91.8%","t":"+13.3%","d":"up"},{"l":"Latência Média (ms)","v":"132ms","t":"-2.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.992","2.446","75.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.257","8.223","76.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.671","6.849","88.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.847","7.562","88.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.912","3.375","94.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":802},{"label":"Fev","value":651},{"label":"Mar","value":572},{"label":"Abr","value":753},{"label":"Mai","value":601},{"label":"Jun","value":686},{"label":"Jul","value":591},{"label":"Ago","value":737},{"label":"Set","value":545},{"label":"Out","value":711},{"label":"Nov","value":659},{"label":"Dez","value":859}];
const MX = 859;
