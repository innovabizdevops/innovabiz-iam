...
const KPIS = [{"l":"Total Grain Storage","v":"7.393","t":"-4.9%","d":"down"},{"l":"Temp Control Ativos","v":"3.934","t":"+0.6%","d":"up"},{"l":"Eficiência (%)","v":"69.6%","t":"+8.9%","d":"up"},{"l":"Score Performance","v":"71","t":"+10.1%","d":"up"}];
const COLS = ["ID","Temp Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grain Storage #001","Grain Storage #002","4.436","4.845","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Grain Storage #002","Grain Storage #003","6.011","6.426","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Grain Storage #003","Grain Storage #004","1.706","8.526","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Grain Storage #004","Grain Storage #005","7.501","2.960","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grain Storage #005","Grain Storage #001","5.003","8.698","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":945},{"label":"Fev","value":923},{"label":"Mar","value":910},{"label":"Abr","value":745},{"label":"Mai","value":969},{"label":"Jun","value":795},{"label":"Jul","value":740},{"label":"Ago","value":892},{"label":"Set","value":948},{"label":"Out","value":751},{"label":"Nov","value":754},{"label":"Dez","value":998}];
const MX = 998;
