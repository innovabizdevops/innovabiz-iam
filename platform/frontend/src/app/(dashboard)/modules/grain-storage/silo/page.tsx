...
const ACCENT = "#475569";
const MODULE = "Grain Storage";
const PAGE = "Silo Monitor";
const KPIS = [{"l":"Total Grain Storage","v":"6.517","t":"+8.6%","d":"up"},{"l":"Silo Monitor Ativos","v":"4.253","t":"+18.0%","d":"up"},{"l":"Eficiência (%)","v":"78.5%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"74","t":"+13.8%","d":"up"}];
const COLS = ["ID","Silo Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grain Storage #001","Grain Storage #002","3.692","1.994","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Grain Storage #002","Grain Storage #003","6.433","8.465","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Grain Storage #003","Grain Storage #004","8.848","8.920","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Grain Storage #004","Grain Storage #005","8.021","4.949","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grain Storage #005","Grain Storage #001","489","1.456","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":752},{"label":"Mar","value":686},{"label":"Abr","value":876},{"label":"Mai","value":797},{"label":"Jun","value":1025},{"label":"Jul","value":702},{"label":"Ago","value":945},{"label":"Set","value":778},{"label":"Out","value":655},{"label":"Nov","value":899},{"label":"Dez","value":832}];
const MX = 1025;
