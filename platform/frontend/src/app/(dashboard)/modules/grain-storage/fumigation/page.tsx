...
const PAGE = "Fumigation";
const KPIS = [{"l":"Total Grain Storage","v":"3.543","t":"+15.7%","d":"up"},{"l":"Fumigation Ativos","v":"3.859","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"71.9%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"72","t":"+11.3%","d":"up"}];
const COLS = ["ID","Fumigation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grain Storage #001","Grain Storage #002","363","425","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Grain Storage #002","Grain Storage #003","6.262","7.259","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Grain Storage #003","Grain Storage #004","2.866","1.758","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Grain Storage #004","Grain Storage #005","2.713","6.952","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grain Storage #005","Grain Storage #001","421","5.220","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":1007},{"label":"Mar","value":693},{"label":"Abr","value":817},{"label":"Mai","value":993},{"label":"Jun","value":858},{"label":"Jul","value":650},{"label":"Ago","value":896},{"label":"Set","value":900},{"label":"Out","value":635},{"label":"Nov","value":919},{"label":"Dez","value":974}];
const MX = 1007;
