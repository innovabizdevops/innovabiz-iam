...
const KPIS = [{"l":"Total Grain Storage","v":"5.437","t":"+8.7%","d":"up"},{"l":"Inventory Ativos","v":"347","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"68.0%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"59","t":"-3.8%","d":"down"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grain Storage #001","Grain Storage #002","5.953","2.142","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Grain Storage #002","Grain Storage #003","8.763","7.697","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Grain Storage #003","Grain Storage #004","5.912","2.103","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Grain Storage #004","Grain Storage #005","1.016","6.463","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grain Storage #005","Grain Storage #001","6.554","737","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":583},{"label":"Mar","value":586},{"label":"Abr","value":506},{"label":"Mai","value":245},{"label":"Jun","value":318},{"label":"Jul","value":552},{"label":"Ago","value":410},{"label":"Set","value":392},{"label":"Out","value":221},{"label":"Nov","value":582},{"label":"Dez","value":506}];
const MX = 589;
