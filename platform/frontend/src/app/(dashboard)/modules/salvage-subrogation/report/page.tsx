...
const PAGE = "Report";
const KPIS = [{"l":"Total Salvage Subrogation","v":"2.052","t":"+2.4%","d":"up"},{"l":"Report Ativos","v":"4.943","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"69.4%","t":"+6.1%","d":"up"},{"l":"Score Performance","v":"76","t":"+7.2%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Salvage Subrogation #001","Salvage Subrogation #002","8.840","5.514","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Salvage Subrogation #002","Salvage Subrogation #003","8.884","5.357","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Salvage Subrogation #003","Salvage Subrogation #004","7.831","3.800","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Salvage Subrogation #004","Salvage Subrogation #005","8.000","2.065","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Salvage Subrogation #005","Salvage Subrogation #001","2.754","6.352","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":520},{"label":"Mar","value":474},{"label":"Abr","value":484},{"label":"Mai","value":600},{"label":"Jun","value":561},{"label":"Jul","value":728},{"label":"Ago","value":543},{"label":"Set","value":712},{"label":"Out","value":728},{"label":"Nov","value":501},{"label":"Dez","value":704}];
const MX = 728;
