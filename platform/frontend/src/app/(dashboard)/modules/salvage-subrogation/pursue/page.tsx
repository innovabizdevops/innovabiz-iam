...
const PAGE = "Pursue";
const KPIS = [{"l":"Total Salvage Subrogation","v":"1.001","t":"+7.2%","d":"up"},{"l":"Pursue Ativos","v":"6.751","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"94.8%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"69","t":"+0.5%","d":"up"}];
const COLS = ["ID","Pursue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Salvage Subrogation #001","Salvage Subrogation #002","2.371","247","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Salvage Subrogation #002","Salvage Subrogation #003","6.588","4.263","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Salvage Subrogation #003","Salvage Subrogation #004","361","2.992","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Salvage Subrogation #004","Salvage Subrogation #005","8.779","2.872","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Salvage Subrogation #005","Salvage Subrogation #001","568","3.827","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1073},{"label":"Fev","value":779},{"label":"Mar","value":749},{"label":"Abr","value":767},{"label":"Mai","value":1066},{"label":"Jun","value":1052},{"label":"Jul","value":709},{"label":"Ago","value":836},{"label":"Set","value":722},{"label":"Out","value":880},{"label":"Nov","value":925},{"label":"Dez","value":873}];
const MX = 1073;
