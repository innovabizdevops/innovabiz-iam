...
const PAGE = "Recover";
const KPIS = [{"l":"Total Salvage Subrogation","v":"6.632","t":"+10.0%","d":"up"},{"l":"Recover Ativos","v":"1.791","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"70.1%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"73","t":"+6.5%","d":"up"}];
const COLS = ["ID","Recover","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Salvage Subrogation #001","Salvage Subrogation #002","1.565","6.516","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Salvage Subrogation #002","Salvage Subrogation #003","3.042","1.542","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Salvage Subrogation #003","Salvage Subrogation #004","7.228","6.198","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Salvage Subrogation #004","Salvage Subrogation #005","2.523","5.347","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Salvage Subrogation #005","Salvage Subrogation #001","1.312","5.538","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":512},{"label":"Mar","value":501},{"label":"Abr","value":315},{"label":"Mai","value":396},{"label":"Jun","value":492},{"label":"Jul","value":373},{"label":"Ago","value":353},{"label":"Set","value":314},{"label":"Out","value":494},{"label":"Nov","value":349},{"label":"Dez","value":324}];
const MX = 587;
