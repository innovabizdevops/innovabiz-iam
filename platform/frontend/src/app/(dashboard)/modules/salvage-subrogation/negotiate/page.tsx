...
const KPIS = [{"l":"Total Salvage Subrogation","v":"3.097","t":"+0.1%","d":"up"},{"l":"Negotiate Ativos","v":"4.384","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"76.3%","t":"+13.3%","d":"up"},{"l":"Score Performance","v":"75","t":"+11.8%","d":"up"}];
const COLS = ["ID","Negotiate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Salvage Subrogation #001","Salvage Subrogation #002","2.068","689","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Salvage Subrogation #002","Salvage Subrogation #003","5.347","7.014","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Salvage Subrogation #003","Salvage Subrogation #004","6.979","2.568","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Salvage Subrogation #004","Salvage Subrogation #005","6.243","2.625","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Salvage Subrogation #005","Salvage Subrogation #001","6.646","2.577","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":979},{"label":"Fev","value":845},{"label":"Mar","value":695},{"label":"Abr","value":828},{"label":"Mai","value":801},{"label":"Jun","value":783},{"label":"Jul","value":781},{"label":"Ago","value":756},{"label":"Set","value":869},{"label":"Out","value":940},{"label":"Nov","value":751},{"label":"Dez","value":811}];
const MX = 979;
