...
const ACCENT = "#92400e";
const MODULE = "Salvage & Subrogation";
const PAGE = "Identify";
const KPIS = [{"l":"Total Salvage Subrogation","v":"8.029","t":"+5.2%","d":"up"},{"l":"Identify Ativos","v":"5.912","t":"+18.0%","d":"up"},{"l":"Eficiência (%)","v":"84.3%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"84","t":"+14.2%","d":"up"}];
const COLS = ["ID","Identify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Salvage Subrogation #001","Salvage Subrogation #002","7.951","7.808","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Salvage Subrogation #002","Salvage Subrogation #003","7.390","8.284","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Salvage Subrogation #003","Salvage Subrogation #004","5.483","1.083","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Salvage Subrogation #004","Salvage Subrogation #005","7.238","4.750","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Salvage Subrogation #005","Salvage Subrogation #001","1.258","5.567","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":567},{"label":"Mar","value":517},{"label":"Abr","value":725},{"label":"Mai","value":456},{"label":"Jun","value":601},{"label":"Jul","value":726},{"label":"Ago","value":735},{"label":"Set","value":650},{"label":"Out","value":420},{"label":"Nov","value":733},{"label":"Dez","value":535}];
const MX = 799;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#92400e'}}>AI</span></h1>
                </div>
