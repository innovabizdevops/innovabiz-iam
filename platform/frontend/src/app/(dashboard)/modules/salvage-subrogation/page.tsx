...
/* ═══ Salvage & Subrogation — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "4664", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2325", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€174K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1950245164", cells: ["SAL-9164", "Salvage & Subrogation Item 1", "1/5/2026", "€45 264"], status: "active" as const },
    { id: "1950248735", cells: ["SAL-3735", "Salvage & Subrogation Item 2", "16/12/2026", "€48 835"], status: "pending" as const },
    { id: "1950252306", cells: ["SAL-7306", "Salvage & Subrogation Item 3", "3/7/2026", "€2406"], status: "completed" as const },
    { id: "1950255877", cells: ["SAL-1877", "Salvage & Subrogation Item 4", "18/2/2026", "€5977"], status: "warning" as const },
    { id: "1950259448", cells: ["SAL-5448", "Salvage & Subrogation Item 5", "5/9/2026", "€9548"], status: "active" as const },
];
...
export default function SalvageSubrogationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Salvage & Subrogation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Salvage & Subrogation</p>
                    </div>
                </div>
