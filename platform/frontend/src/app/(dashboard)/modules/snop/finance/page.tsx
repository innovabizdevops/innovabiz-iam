...
const PAGE = "Financial Recon";
const KPIS = [{"l":"Total Snop","v":"2.502","t":"+5.1%","d":"up"},{"l":"Financial Recon Ativos","v":"6.747","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"89.8%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"94","t":"+2.5%","d":"up"}];
const COLS = ["ID","Financial Recon","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snop #001","Snop #002","8.360","4.684","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Snop #002","Snop #003","4.514","3.811","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Snop #003","Snop #004","2.286","6.464","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Snop #004","Snop #005","5.778","1.483","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snop #005","Snop #001","8.385","6.538","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":594},{"label":"Mar","value":865},{"label":"Abr","value":907},{"label":"Mai","value":546},{"label":"Jun","value":545},{"label":"Jul","value":743},{"label":"Ago","value":879},{"label":"Set","value":616},{"label":"Out","value":900},{"label":"Nov","value":609},{"label":"Dez","value":857}];
const MX = 907;
