...
const PAGE = "Executive S&amp;OP";
const KPIS = [{"l":"Total Snop","v":"605","t":"+7.1%","d":"up"},{"l":"Executive S&OP Ativos","v":"687","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"72.5%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"66","t":"+11.5%","d":"up"}];
const COLS = ["ID","Executive S&OP","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snop #001","Snop #002","4.869","5.596","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Snop #002","Snop #003","6.578","7.001","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Snop #003","Snop #004","348","8.577","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Snop #004","Snop #005","8.615","4.976","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snop #005","Snop #001","2.022","2.554","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":601},{"label":"Mar","value":668},{"label":"Abr","value":887},{"label":"Mai","value":882},{"label":"Jun","value":867},{"label":"Jul","value":590},{"label":"Ago","value":762},{"label":"Set","value":554},{"label":"Out","value":872},{"label":"Nov","value":707},{"label":"Dez","value":791}];
const MX = 907;
