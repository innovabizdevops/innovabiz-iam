...
const ACCENT = "#7c3aed";
const MODULE = "S&OP Process";
const PAGE = "What-If Scenarios";
const KPIS = [{"l":"Total Snop","v":"2.212","t":"+14.0%","d":"up"},{"l":"What If Scenarios Ativos","v":"3.650","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"87.9%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"89","t":"+3.4%","d":"up"}];
const COLS = ["ID","What If Scenarios","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snop #001","Snop #002","1.197","7.044","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Snop #002","Snop #003","7.522","2.621","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Snop #003","Snop #004","5.312","3.548","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Snop #004","Snop #005","8.452","4.547","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snop #005","Snop #001","1.212","4.739","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":964},{"label":"Fev","value":908},{"label":"Mar","value":949},{"label":"Abr","value":713},{"label":"Mai","value":975},{"label":"Jun","value":691},{"label":"Jul","value":731},{"label":"Ago","value":922},{"label":"Set","value":989},{"label":"Out","value":885},{"label":"Nov","value":899},{"label":"Dez","value":711}];
const MX = 989;
