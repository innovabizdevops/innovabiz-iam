...
const PAGE = "Demand Review";
const KPIS = [{"l":"Total Snop","v":"2.132","t":"+15.8%","d":"up"},{"l":"Demand Review Ativos","v":"6.839","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"85.3%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"56","t":"-1.8%","d":"down"}];
const COLS = ["ID","Demand Review","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snop #001","Snop #002","3.378","7.432","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Snop #002","Snop #003","8.293","744","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Snop #003","Snop #004","134","1.659","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Snop #004","Snop #005","6.276","6.482","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snop #005","Snop #001","3.555","3.815","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":304},{"label":"Fev","value":530},{"label":"Mar","value":633},{"label":"Abr","value":640},{"label":"Mai","value":446},{"label":"Jun","value":380},{"label":"Jul","value":533},{"label":"Ago","value":369},{"label":"Set","value":670},{"label":"Out","value":686},{"label":"Nov","value":633},{"label":"Dez","value":660}];
const MX = 686;
