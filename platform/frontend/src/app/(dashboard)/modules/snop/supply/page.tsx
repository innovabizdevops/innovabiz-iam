...
const PAGE = "Supply Review";
const KPIS = [{"l":"Total Snop","v":"5.290","t":"+12.6%","d":"up"},{"l":"Supply Review Ativos","v":"5.184","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"68.4%","t":"+0.0%","d":"up"},{"l":"Score Performance","v":"88","t":"-2.7%","d":"down"}];
const COLS = ["ID","Supply Review","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snop #001","Snop #002","1.952","5.841","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Snop #002","Snop #003","4.095","7.958","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Snop #003","Snop #004","3.045","2.144","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Snop #004","Snop #005","3.194","7.303","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snop #005","Snop #001","3.785","7.339","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":930},{"label":"Mar","value":834},{"label":"Abr","value":862},{"label":"Mai","value":706},{"label":"Jun","value":814},{"label":"Jul","value":560},{"label":"Ago","value":931},{"label":"Set","value":895},{"label":"Out","value":703},{"label":"Nov","value":660},{"label":"Dez","value":939}];
const MX = 939;
