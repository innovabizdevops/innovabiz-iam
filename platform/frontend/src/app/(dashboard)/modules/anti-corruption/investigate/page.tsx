...
const KPIS = [{"l":"Total Anti Corruption","v":"1.013","t":"+3.4%","d":"up"},{"l":"Investigation Ativos","v":"8.404","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"75.5%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"91","t":"+15.2%","d":"up"}];
const COLS = ["ID","Investigation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Anti Corruption #001","Anti Corruption #002","8.207","3.018","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Anti Corruption #002","Anti Corruption #003","2.884","4.851","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Anti Corruption #003","Anti Corruption #004","5.772","4.946","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Anti Corruption #004","Anti Corruption #005","1.372","5.479","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Anti Corruption #005","Anti Corruption #001","1.844","9.092","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":951},{"label":"Fev","value":762},{"label":"Mar","value":800},{"label":"Abr","value":988},{"label":"Mai","value":665},{"label":"Jun","value":835},{"label":"Jul","value":968},{"label":"Ago","value":912},{"label":"Set","value":997},{"label":"Out","value":725},{"label":"Nov","value":819},{"label":"Dez","value":837}];
const MX = 997;
