...
const PAGE = "Asset Declare";
const KPIS = [{"l":"Ativos Registados","v":"9.097","t":"-2.0%","d":"down"},{"l":"Valor Total (€M)","v":"€17.3M","t":"+2.5%","d":"up"},{"l":"Depreciação Anual (€)","v":"€33721","t":"+1.9%","d":"up"},{"l":"Ativos em Garantia","v":"6.445","t":"-0.3%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 26275.73","8.587","€ 11947.10","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 28685.53","2.507","€ 49708.73","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 37916.59","2.075","€ 38284.41","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 49966.41","8.917","€ 19545.61","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 4958.90","2.802","€ 39068.08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":859},{"label":"Fev","value":931},{"label":"Mar","value":717},{"label":"Abr","value":937},{"label":"Mai","value":678},{"label":"Jun","value":847},{"label":"Jul","value":942},{"label":"Ago","value":755},{"label":"Set","value":732},{"label":"Out","value":852},{"label":"Nov","value":930},{"label":"Dez","value":793}];
const MX = 942;
