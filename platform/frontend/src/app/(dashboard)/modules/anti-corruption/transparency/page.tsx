...
const KPIS = [{"l":"Quartos Ocupados","v":"7.443","t":"+12.1%","d":"up"},{"l":"RevPAR (€)","v":"€27958","t":"+0.0%","d":"up"},{"l":"Ocupação (%)","v":"69.5%","t":"+7.3%","d":"up"},{"l":"Guest Satisfaction","v":"6.274","t":"+7.9%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.447","2026-01-08","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.077","2026-01-22","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.497","2026-01-17","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.550","2026-03-11","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.075","2026-03-22","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":995},{"label":"Fev","value":1046},{"label":"Mar","value":1033},{"label":"Abr","value":843},{"label":"Mai","value":1026},{"label":"Jun","value":681},{"label":"Jul","value":670},{"label":"Ago","value":831},{"label":"Set","value":863},{"label":"Out","value":1032},{"label":"Nov","value":930},{"label":"Dez","value":965}];
const MX = 1046;
