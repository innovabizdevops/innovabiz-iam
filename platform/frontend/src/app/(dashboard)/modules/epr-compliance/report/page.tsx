...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.278","t":"-1.6%","d":"down"},{"l":"NC Abertas","v":"2.768","t":"+12.4%","d":"up"},{"l":"Conformidade (%)","v":"88.6%","t":"-5.9%","d":"down"},{"l":"CAPAs Pendentes","v":"5.993","t":"-6.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.940","86.4%","2.875","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.224","88.3%","7.089","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.000","90.0%","7.161","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.372","98.3%","3.533","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.409","83.9%","2.165","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":490},{"label":"Mar","value":422},{"label":"Abr","value":781},{"label":"Mai","value":774},{"label":"Jun","value":778},{"label":"Jul","value":672},{"label":"Ago","value":679},{"label":"Set","value":709},{"label":"Out","value":605},{"label":"Nov","value":563},{"label":"Dez","value":519}];
const MX = 781;
