...
const PAGE = "Recycle";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.259","t":"-4.0%","d":"down"},{"l":"NC Abertas","v":"6.912","t":"+16.0%","d":"up"},{"l":"Conformidade (%)","v":"76.0%","t":"+13.1%","d":"up"},{"l":"CAPAs Pendentes","v":"7.679","t":"-2.5%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","964","82.4%","6.236","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.026","97.4%","8.041","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.000","83.8%","4.971","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.494","94.6%","5.328","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.686","88.9%","1.736","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":264},{"label":"Fev","value":405},{"label":"Mar","value":512},{"label":"Abr","value":500},{"label":"Mai","value":569},{"label":"Jun","value":238},{"label":"Jul","value":555},{"label":"Ago","value":618},{"label":"Set","value":298},{"label":"Out","value":611},{"label":"Nov","value":490},{"label":"Dez","value":567}];
const MX = 618;
