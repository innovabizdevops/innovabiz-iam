...
const ACCENT = "#064e3b";
const MODULE = "EPR Compliance";
const PAGE = "Fee";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.565","t":"+7.8%","d":"up"},{"l":"NC Abertas","v":"570","t":"+11.3%","d":"up"},{"l":"Conformidade (%)","v":"70.5%","t":"+12.8%","d":"up"},{"l":"CAPAs Pendentes","v":"2.360","t":"+14.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.575","72.3%","1.310","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.510","85.0%","4.320","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.527","89.5%","8.093","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.852","72.6%","2.526","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.864","94.1%","2.909","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":713},{"label":"Mar","value":1024},{"label":"Abr","value":889},{"label":"Mai","value":971},{"label":"Jun","value":660},{"label":"Jul","value":901},{"label":"Ago","value":741},{"label":"Set","value":747},{"label":"Out","value":1054},{"label":"Nov","value":703},{"label":"Dez","value":1028}];
const MX = 1054;
