...
const KPIS = [
    { label: "Total Registos", value: "2712", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1238", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€168K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1252580312", cells: ["EPR-6312", "EPR Compliance Item 1", "5/9/2026", "€30 412"], status: "active" as const },
    { id: "1252583883", cells: ["EPR-9883", "EPR Compliance Item 2", "20/4/2026", "€33 983"], status: "pending" as const },
    { id: "1252587454", cells: ["EPR-4454", "EPR Compliance Item 3", "7/11/2026", "€37 554"], status: "completed" as const },
    { id: "1252591025", cells: ["EPR-8025", "EPR Compliance Item 4", "22/6/2026", "€41 125"], status: "warning" as const },
    { id: "1252594596", cells: ["EPR-2596", "EPR Compliance Item 5", "9/1/2026", "€44 696"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EPR Compliance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EPR Compliance</p>
                    </div>
                </div>
