...
const PAGE = "Register";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.514","t":"+3.3%","d":"up"},{"l":"NC Abertas","v":"5.491","t":"+12.6%","d":"up"},{"l":"Conformidade (%)","v":"67.7%","t":"-1.3%","d":"down"},{"l":"CAPAs Pendentes","v":"722","t":"+12.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","467","98.8%","5.023","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.133","74.0%","2.680","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.786","88.1%","3.640","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.722","82.4%","7.536","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.868","84.8%","2.468","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":961},{"label":"Fev","value":882},{"label":"Mar","value":614},{"label":"Abr","value":880},{"label":"Mai","value":975},{"label":"Jun","value":764},{"label":"Jul","value":668},{"label":"Ago","value":770},{"label":"Set","value":619},{"label":"Out","value":777},{"label":"Nov","value":968},{"label":"Dez","value":687}];
const MX = 975;
