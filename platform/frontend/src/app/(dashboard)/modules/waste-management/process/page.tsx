...
const PAGE = "Process";
const KPIS = [{"l":"Projetos Melhoria","v":"3.528","t":"-4.4%","d":"down"},{"l":"Savings (€)","v":"€43651","t":"+12.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"77.5%","t":"+14.7%","d":"up"},{"l":"Ciclos PDCA","v":"6.838","t":"+12.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.227","€ 16206.75","5.782","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","739","€ 14037.91","260","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.806","€ 15707.62","7.269","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","136","€ 16784.12","5.228","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.663","€ 39252.89","4.656","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":549},{"label":"Mar","value":505},{"label":"Abr","value":419},{"label":"Mai","value":657},{"label":"Jun","value":607},{"label":"Jul","value":441},{"label":"Ago","value":593},{"label":"Set","value":377},{"label":"Out","value":519},{"label":"Nov","value":675},{"label":"Dez","value":634}];
const MX = 675;
