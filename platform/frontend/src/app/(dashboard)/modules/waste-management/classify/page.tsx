...
const PAGE = "Classify";
const KPIS = [{"l":"Projetos Melhoria","v":"2.567","t":"+1.6%","d":"up"},{"l":"Savings (€)","v":"€78165","t":"+11.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"76.4%","t":"+3.9%","d":"up"},{"l":"Ciclos PDCA","v":"4.523","t":"+15.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.732","€ 18806.10","4.660","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.256","€ 38198.25","1.020","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.551","€ 241.40","7.066","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.468","€ 40488.09","8.802","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.539","€ 40190.81","6.407","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":624},{"label":"Mar","value":710},{"label":"Abr","value":522},{"label":"Mai","value":645},{"label":"Jun","value":683},{"label":"Jul","value":648},{"label":"Ago","value":752},{"label":"Set","value":625},{"label":"Out","value":529},{"label":"Nov","value":418},{"label":"Dez","value":612}];
const MX = 752;
