...
/* ═══ Waste Management Deep — Dashboard ═══ */

const ACCENT = "#22c55e";

const KPIS = [
    { label: "Total Registos", value: "8861", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "780", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€492K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "233203261", cells: ["WAS-5261", "Waste Management Deep Item 1", "26/2/2026", "€3361"], status: "active" as const },
    { id: "233206832", cells: ["WAS-8832", "Waste Management Deep Item 2", "13/9/2026", "€6932"], status: "pending" as const },
    { id: "233210403", cells: ["WAS-3403", "Waste Management Deep Item 3", "28/4/2026", "€10 503"], status: "completed" as const },
    { id: "233213974", cells: ["WAS-6974", "Waste Management Deep Item 4", "15/11/2026", "€14 074"], status: "warning" as const },
    { id: "233217545", cells: ["WAS-1545", "Waste Management Deep Item 5", "2/6/2026", "€17 645"], status: "active" as const },
];
...
export default function WasteManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Waste Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Waste Management Deep</p>
                    </div>
                </div>
