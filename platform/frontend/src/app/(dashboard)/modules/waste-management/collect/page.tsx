...
const PAGE = "Collect";
const KPIS = [{"l":"Projetos Melhoria","v":"7.505","t":"-0.7%","d":"down"},{"l":"Savings (€)","v":"€8278","t":"-3.8%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"68.9%","t":"-2.9%","d":"down"},{"l":"Ciclos PDCA","v":"8.574","t":"+15.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","553","€ 16164.02","1.411","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.281","€ 6420.27","4.088","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","633","€ 39861.19","6.574","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.456","€ 14120.81","8.462","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.506","€ 46142.55","2.585","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":346},{"label":"Fev","value":636},{"label":"Mar","value":465},{"label":"Abr","value":458},{"label":"Mai","value":475},{"label":"Jun","value":577},{"label":"Jul","value":479},{"label":"Ago","value":621},{"label":"Set","value":392},{"label":"Out","value":426},{"label":"Nov","value":516},{"label":"Dez","value":523}];
const MX = 636;
