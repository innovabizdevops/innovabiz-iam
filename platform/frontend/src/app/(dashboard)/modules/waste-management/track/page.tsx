...
const PAGE = "Track";
const KPIS = [{"l":"Projetos Melhoria","v":"4.727","t":"-4.2%","d":"down"},{"l":"Savings (€)","v":"€24543","t":"+13.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"70.4%","t":"+14.8%","d":"up"},{"l":"Ciclos PDCA","v":"1.159","t":"+6.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.958","€ 33349.15","4.565","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.116","€ 39830.70","2.225","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.189","€ 36974.80","8.770","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.485","€ 42542.27","6.720","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","963","€ 12251.07","7.584","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":934},{"label":"Fev","value":1073},{"label":"Mar","value":722},{"label":"Abr","value":875},{"label":"Mai","value":903},{"label":"Jun","value":904},{"label":"Jul","value":760},{"label":"Ago","value":907},{"label":"Set","value":854},{"label":"Out","value":930},{"label":"Nov","value":765},{"label":"Dez","value":803}];
const MX = 1073;
