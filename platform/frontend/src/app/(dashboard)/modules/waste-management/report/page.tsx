...
const ACCENT = "#22c55e";
const MODULE = "Waste Management Deep";
const PAGE = "Report";
const KPIS = [{"l":"Projetos Melhoria","v":"8.031","t":"+16.9%","d":"up"},{"l":"Savings (€)","v":"€2818","t":"-4.8%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"90.7%","t":"+17.2%","d":"up"},{"l":"Ciclos PDCA","v":"5.539","t":"-4.1%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","9.011","€ 48673.39","2.891","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.241","€ 20389.62","8.440","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.783","€ 31972.95","445","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.399","€ 28755.22","7.441","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.937","€ 48809.28","3.074","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":937},{"label":"Fev","value":953},{"label":"Mar","value":1009},{"label":"Abr","value":855},{"label":"Mai","value":702},{"label":"Jun","value":649},{"label":"Jul","value":1004},{"label":"Ago","value":648},{"label":"Set","value":727},{"label":"Out","value":822},{"label":"Nov","value":685},{"label":"Dez","value":903}];
const MX = 1009;
