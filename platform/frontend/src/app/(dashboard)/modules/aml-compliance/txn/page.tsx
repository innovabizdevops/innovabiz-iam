...
const ACCENT = "#dc2626";
const MODULE = "AML Compliance Deep";
const PAGE = "Transaction Monitor";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.459","t":"+5.5%","d":"up"},{"l":"NC Abertas","v":"5.887","t":"+17.1%","d":"up"},{"l":"Conformidade (%)","v":"94.9%","t":"+2.1%","d":"up"},{"l":"CAPAs Pendentes","v":"2.205","t":"+7.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.032","75.5%","8.808","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.386","83.9%","5.089","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.273","97.5%","2.350","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.909","88.6%","4.521","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.662","93.9%","8.646","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":636},{"label":"Mar","value":516},{"label":"Abr","value":731},{"label":"Mai","value":815},{"label":"Jun","value":537},{"label":"Jul","value":863},{"label":"Ago","value":742},{"label":"Set","value":629},{"label":"Out","value":852},{"label":"Nov","value":802},{"label":"Dez","value":730}];
const MX = 863;
