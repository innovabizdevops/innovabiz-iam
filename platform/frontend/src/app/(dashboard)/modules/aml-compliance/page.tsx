...
/* ═══ AML Compliance Deep — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "7201", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2906", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€201K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "-9%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1080443601", cells: ["AML-3601", "AML Compliance Deep Item 1", "14/10/2026", "€43 701"], status: "active" as const },
    { id: "1080447172", cells: ["AML-7172", "AML Compliance Deep Item 2", "1/5/2026", "€47 272"], status: "pending" as const },
    { id: "1080450743", cells: ["AML-1743", "AML Compliance Deep Item 3", "16/12/2026", "€843"], status: "completed" as const },
    { id: "1080454314", cells: ["AML-5314", "AML Compliance Deep Item 4", "3/7/2026", "€4414"], status: "warning" as const },
    { id: "1080457885", cells: ["AML-8885", "AML Compliance Deep Item 5", "18/2/2026", "€7985"], status: "active" as const },
];
...
export default function AmlComplianceDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AML Compliance Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AML Compliance Deep</p>
                    </div>
                </div>
