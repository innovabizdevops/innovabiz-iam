...
const PAGE = "STR/SAR";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.118","t":"+0.1%","d":"up"},{"l":"NC Abertas","v":"7.124","t":"+3.3%","d":"up"},{"l":"Conformidade (%)","v":"86.9%","t":"-5.9%","d":"down"},{"l":"CAPAs Pendentes","v":"2.015","t":"+10.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.582","71.8%","8.073","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.432","100.0%","8.825","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.012","96.8%","7.687","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.913","78.3%","2.750","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.237","81.6%","8.553","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":671},{"label":"Mar","value":942},{"label":"Abr","value":958},{"label":"Mai","value":886},{"label":"Jun","value":687},{"label":"Jul","value":710},{"label":"Ago","value":960},{"label":"Set","value":727},{"label":"Out","value":731},{"label":"Nov","value":729},{"label":"Dez","value":876}];
const MX = 960;
