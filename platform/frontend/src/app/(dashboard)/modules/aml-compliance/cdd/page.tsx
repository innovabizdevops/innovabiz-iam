...
const PAGE = "CDD/KYC";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.706","t":"+16.6%","d":"up"},{"l":"NC Abertas","v":"6.307","t":"+15.4%","d":"up"},{"l":"Conformidade (%)","v":"67.2%","t":"-5.3%","d":"down"},{"l":"CAPAs Pendentes","v":"4.295","t":"+17.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.274","81.4%","7.944","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.910","87.3%","1.281","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.260","78.5%","381","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.513","91.3%","3.653","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.006","81.3%","3.002","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":442},{"label":"Mar","value":451},{"label":"Abr","value":325},{"label":"Mai","value":564},{"label":"Jun","value":465},{"label":"Jul","value":435},{"label":"Ago","value":367},{"label":"Set","value":369},{"label":"Out","value":306},{"label":"Nov","value":472},{"label":"Dez","value":583}];
const MX = 653;
