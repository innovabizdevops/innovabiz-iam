...
const PAGE = "Retry Policy";
const KPIS = [{"l":"Integrações Ativas","v":"2.677","t":"+3.0%","d":"up"},{"l":"Chamadas/Hora","v":"1765","t":"+0.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"76.8%","t":"+17.8%","d":"up"},{"l":"Latência Média (ms)","v":"32ms","t":"-3.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.860","5.569","82.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.310","5.446","73.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.598","2.378","96.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.188","2.771","96.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.523","2.776","93.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":648},{"label":"Mar","value":779},{"label":"Abr","value":707},{"label":"Mai","value":708},{"label":"Jun","value":607},{"label":"Jul","value":549},{"label":"Ago","value":575},{"label":"Set","value":525},{"label":"Out","value":538},{"label":"Nov","value":504},{"label":"Dez","value":799}];
const MX = 799;
