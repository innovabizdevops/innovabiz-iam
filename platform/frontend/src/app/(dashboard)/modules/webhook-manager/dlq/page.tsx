...
const PAGE = "Dead Letter Queue";
const KPIS = [{"l":"Integrações Ativas","v":"7.988","t":"+3.3%","d":"up"},{"l":"Chamadas/Hora","v":"1838","t":"+3.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"93.2%","t":"+9.9%","d":"up"},{"l":"Latência Média (ms)","v":"53ms","t":"-0.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.660","8.913","91.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.579","1.689","70.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.322","2.155","71.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","415","3.686","83.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.692","8.451","81.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":724},{"label":"Mar","value":675},{"label":"Abr","value":647},{"label":"Mai","value":685},{"label":"Jun","value":602},{"label":"Jul","value":658},{"label":"Ago","value":801},{"label":"Set","value":841},{"label":"Out","value":934},{"label":"Nov","value":733},{"label":"Dez","value":577}];
const MX = 934;
