...
const PAGE = "Webhook Registry";
const KPIS = [{"l":"Integrações Ativas","v":"8.293","t":"+13.2%","d":"up"},{"l":"Chamadas/Hora","v":"105","t":"+17.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"92.0%","t":"+14.1%","d":"up"},{"l":"Latência Média (ms)","v":"107ms","t":"+11.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.919","331","85.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.746","8.226","86.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.484","5.144","71.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.116","3.338","87.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.451","1.220","95.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":463},{"label":"Mar","value":729},{"label":"Abr","value":638},{"label":"Mai","value":543},{"label":"Jun","value":598},{"label":"Jul","value":461},{"label":"Ago","value":648},{"label":"Set","value":501},{"label":"Out","value":821},{"label":"Nov","value":816},{"label":"Dez","value":430}];
const MX = 821;
