...
const PAGE = "Delivery Log";
const KPIS = [{"l":"Integrações Ativas","v":"7.147","t":"-4.1%","d":"down"},{"l":"Chamadas/Hora","v":"420","t":"-1.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"84.7%","t":"-4.5%","d":"down"},{"l":"Latência Média (ms)","v":"133ms","t":"+9.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.881","1.306","90.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.523","826","79.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.102","8.719","80.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.945","8.782","99.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.732","1.338","89.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":770},{"label":"Mar","value":949},{"label":"Abr","value":893},{"label":"Mai","value":669},{"label":"Jun","value":1059},{"label":"Jul","value":945},{"label":"Ago","value":687},{"label":"Set","value":992},{"label":"Out","value":1021},{"label":"Nov","value":1014},{"label":"Dez","value":911}];
const MX = 1059;
