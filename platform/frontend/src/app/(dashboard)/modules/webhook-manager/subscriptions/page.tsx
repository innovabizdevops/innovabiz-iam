...
const PAGE = "Event Subscriptions";
const KPIS = [{"l":"ARR (€M)","v":"€34.4M","t":"+13.7%","d":"up"},{"l":"MRR (€)","v":"€14421","t":"-2.9%","d":"down"},{"l":"Churn (%)","v":"88.0%","t":"+3.7%","d":"up"},{"l":"ARPU (€)","v":"€28291","t":"+4.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 4634.26","5.561","€ 22893.57","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 46199.39","391","€ 49840.96","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 23755.36","5.057","€ 36358.62","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 44600.46","8.552","€ 21598.07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 27331.83","2.076","€ 37054.67","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":523},{"label":"Mar","value":282},{"label":"Abr","value":434},{"label":"Mai","value":614},{"label":"Jun","value":284},{"label":"Jul","value":390},{"label":"Ago","value":637},{"label":"Set","value":485},{"label":"Out","value":640},{"label":"Nov","value":287},{"label":"Dez","value":276}];
const MX = 640;
