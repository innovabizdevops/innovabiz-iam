...
const PAGE = "Signature Verify";
const KPIS = [{"l":"Formulários Ativos","v":"7.637","t":"+0.9%","d":"up"},{"l":"Submissões/Dia","v":"4238","t":"+2.9%","d":"up"},{"l":"Documentos Gerados","v":"6.804","t":"+6.6%","d":"up"},{"l":"Templates","v":"6.124","t":"+2.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.071","2026-02-22","5.080","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.003","2026-01-19","997","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.340","2026-01-02","4.957","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.622","2026-03-12","3.178","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.134","2026-03-03","455","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":812},{"label":"Mar","value":712},{"label":"Abr","value":714},{"label":"Mai","value":570},{"label":"Jun","value":831},{"label":"Jul","value":590},{"label":"Ago","value":744},{"label":"Set","value":883},{"label":"Out","value":792},{"label":"Nov","value":845},{"label":"Dez","value":631}];
const MX = 883;
