...
const ACCENT = "#7c3aed";
const MODULE = "Webhook & Events";
const PAGE = "Payload Transform";
const KPIS = [{"l":"Formulários Ativos","v":"4.409","t":"+2.2%","d":"up"},{"l":"Submissões/Dia","v":"709","t":"-0.1%","d":"down"},{"l":"Documentos Gerados","v":"5.149","t":"+12.6%","d":"up"},{"l":"Templates","v":"4.656","t":"+10.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","505","2026-01-16","6.804","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.006","2026-01-11","4.484","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.131","2026-02-24","7.066","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.336","2026-03-18","1.998","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.530","2026-01-24","6.018","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":538},{"label":"Mar","value":609},{"label":"Abr","value":386},{"label":"Mai","value":428},{"label":"Jun","value":461},{"label":"Jul","value":609},{"label":"Ago","value":491},{"label":"Set","value":608},{"label":"Out","value":535},{"label":"Nov","value":449},{"label":"Dez","value":369}];
const MX = 609;
