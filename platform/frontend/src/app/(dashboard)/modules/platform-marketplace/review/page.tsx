...
const ACCENT = "#0ea5e9";
const MODULE = "Platform Marketplace";
const PAGE = "Review";
const KPIS = [{"l":"Pedidos/Dia","v":"4285","t":"+15.5%","d":"up"},{"l":"GMV (€)","v":"€91194","t":"-2.2%","d":"down"},{"l":"Conversão (%)","v":"81.9%","t":"-5.2%","d":"down"},{"l":"AOV (€)","v":"€98144","t":"+12.3%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 18145.35","7.802","7.425","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 46343.69","5.882","5.315","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 44655.07","4.194","3.964","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 3134.86","3.962","8.413","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 21416.43","5.608","5.742","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":327},{"label":"Mar","value":556},{"label":"Abr","value":446},{"label":"Mai","value":380},{"label":"Jun","value":683},{"label":"Jul","value":608},{"label":"Ago","value":531},{"label":"Set","value":510},{"label":"Out","value":518},{"label":"Nov","value":543},{"label":"Dez","value":606}];
const MX = 683;
