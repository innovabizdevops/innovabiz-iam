...
const KPIS = [
    ...
    { label: "Ativos", value: "2350", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€63K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "-17%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "947544984", cells: ["PLA-7984", "Platform Marketplace Item 1", "9/1/2026", "€45 084"], status: "active" as const },
    { id: "947548555", cells: ["PLA-2555", "Platform Marketplace Item 2", "24/8/2026", "€48 655"], status: "pending" as const },
    { id: "947552126", cells: ["PLA-6126", "Platform Marketplace Item 3", "11/3/2026", "€2226"], status: "completed" as const },
    { id: "947555697", cells: ["PLA-9697", "Platform Marketplace Item 4", "26/10/2026", "€5797"], status: "warning" as const },
    { id: "947559268", cells: ["PLA-4268", "Platform Marketplace Item 5", "13/5/2026", "€9368"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Platform Marketplace</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Platform Marketplace</p>
                    </div>
                </div>
