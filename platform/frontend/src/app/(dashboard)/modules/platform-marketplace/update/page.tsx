...
const PAGE = "Update";
const KPIS = [{"l":"Pedidos/Dia","v":"879","t":"+5.2%","d":"up"},{"l":"GMV (€)","v":"€98331","t":"+16.2%","d":"up"},{"l":"Conversão (%)","v":"94.2%","t":"+14.3%","d":"up"},{"l":"AOV (€)","v":"€95434","t":"+6.1%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 35713.05","1.771","570","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 27699.56","1.678","6.151","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 2310.23","6.277","4.663","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 47224.47","2.072","3.764","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 40437.86","6.721","4.790","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1004},{"label":"Fev","value":869},{"label":"Mar","value":1065},{"label":"Abr","value":833},{"label":"Mai","value":925},{"label":"Jun","value":796},{"label":"Jul","value":726},{"label":"Ago","value":993},{"label":"Set","value":693},{"label":"Out","value":790},{"label":"Nov","value":1052},{"label":"Dez","value":899}];
const MX = 1065;
