...
const ACCENT = "#8b5cf6";
const MODULE = "No-Code AI Builder";
const PAGE = "Deploy";
const KPIS = [{"l":"Total No Code Ai","v":"4.603","t":"-4.9%","d":"down"},{"l":"Deploy Ativos","v":"5.726","t":"+10.2%","d":"up"},{"l":"Eficiência (%)","v":"93.0%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"71","t":"-1.0%","d":"down"}];
const COLS = ["ID","Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["No Code Ai #001","No Code Ai #002","6.225","819","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["No Code Ai #002","No Code Ai #003","2.471","5.126","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["No Code Ai #003","No Code Ai #004","635","2.448","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["No Code Ai #004","No Code Ai #005","7.212","3.428","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["No Code Ai #005","No Code Ai #001","846","5.668","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":800},{"label":"Fev","value":637},{"label":"Mar","value":556},{"label":"Abr","value":694},{"label":"Mai","value":487},{"label":"Jun","value":728},{"label":"Jul","value":772},{"label":"Ago","value":649},{"label":"Set","value":668},{"label":"Out","value":575},{"label":"Nov","value":513},{"label":"Dez","value":625}];
const MX = 800;
