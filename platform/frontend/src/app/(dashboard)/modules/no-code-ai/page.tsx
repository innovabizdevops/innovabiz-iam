...
/* ═══ No-Code AI Builder — Dashboard ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total Registos", value: "8885", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3346", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€127K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1958713885", cells: ["NO-8885", "No-Code AI Builder Item 1", "10/2/2026", "€13 985"], status: "active" as const },
    { id: "1958717456", cells: ["NO-3456", "No-Code AI Builder Item 2", "25/9/2026", "€17 556"], status: "pending" as const },
    { id: "1958721027", cells: ["NO-7027", "No-Code AI Builder Item 3", "12/4/2026", "€21 127"], status: "completed" as const },
    { id: "1958724598", cells: ["NO-1598", "No-Code AI Builder Item 4", "27/11/2026", "€24 698"], status: "warning" as const },
    { id: "1958728169", cells: ["NO-5169", "No-Code AI Builder Item 5", "14/6/2026", "€28 269"], status: "active" as const },
];
...
export default function NocodeAiBuilderPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">No-Code AI Builder</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • No-Code AI Builder</p>
                    </div>
                </div>
