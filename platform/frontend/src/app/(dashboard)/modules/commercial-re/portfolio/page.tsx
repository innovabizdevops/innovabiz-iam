...
const KPIS = [{"l":"Total Commercial Re","v":"1.792","t":"-5.1%","d":"down"},{"l":"Portfolio Ativos","v":"8.765","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"70.9%","t":"+4.6%","d":"up"},{"l":"Score Performance","v":"73","t":"+13.4%","d":"up"}];
const COLS = ["ID","Portfolio","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Commercial Re #001","Commercial Re #002","7.845","5.522","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Commercial Re #002","Commercial Re #003","5.156","2.736","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Commercial Re #003","Commercial Re #004","2.247","7.859","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Commercial Re #004","Commercial Re #005","7.547","3.407","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Commercial Re #005","Commercial Re #001","1.257","1.672","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":840},{"label":"Mar","value":771},{"label":"Abr","value":956},{"label":"Mai","value":1086},{"label":"Jun","value":846},{"label":"Jul","value":802},{"label":"Ago","value":724},{"label":"Set","value":857},{"label":"Out","value":818},{"label":"Nov","value":821},{"label":"Dez","value":806}];
const MX = 1086;
