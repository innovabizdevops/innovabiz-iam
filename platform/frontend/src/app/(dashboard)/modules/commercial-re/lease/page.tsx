...
const ACCENT = "#6366f1";
const MODULE = "Commercial Real Estate";
const PAGE = "Lease Admin";
const KPIS = [{"l":"Total Commercial Re","v":"5.143","t":"-5.1%","d":"down"},{"l":"Lease Admin Ativos","v":"3.845","t":"+13.5%","d":"up"},{"l":"Eficiência (%)","v":"73.4%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"67","t":"-0.3%","d":"down"}];
const COLS = ["ID","Lease Admin","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Commercial Re #001","Commercial Re #002","7.583","3.146","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Commercial Re #002","Commercial Re #003","9.032","5.393","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Commercial Re #003","Commercial Re #004","3.340","8.958","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Commercial Re #004","Commercial Re #005","7.142","6.069","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Commercial Re #005","Commercial Re #001","3.646","4.397","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":889},{"label":"Mar","value":949},{"label":"Abr","value":873},{"label":"Mai","value":676},{"label":"Jun","value":611},{"label":"Jul","value":856},{"label":"Ago","value":660},{"label":"Set","value":640},{"label":"Out","value":612},{"label":"Nov","value":850},{"label":"Dez","value":751}];
const MX = 949;
