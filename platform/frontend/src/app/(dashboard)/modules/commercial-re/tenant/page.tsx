...
const PAGE = "Tenant";
const KPIS = [{"l":"Configurações","v":"2.751","t":"-0.9%","d":"down"},{"l":"Últimas Alterações","v":"7.550","t":"+12.1%","d":"up"},{"l":"Ambientes","v":"4.709","t":"+17.0%","d":"up"},{"l":"Versão Config","v":"735","t":"-4.1%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 42791.22","3.289","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 12009.99","4.587","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 12966.56","2.476","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 40210.39","3.567","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 7908.09","5.556","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":947},{"label":"Fev","value":909},{"label":"Mar","value":900},{"label":"Abr","value":815},{"label":"Mai","value":806},{"label":"Jun","value":887},{"label":"Jul","value":904},{"label":"Ago","value":700},{"label":"Set","value":927},{"label":"Out","value":763},{"label":"Nov","value":828},{"label":"Dez","value":933}];
const MX = 947;
