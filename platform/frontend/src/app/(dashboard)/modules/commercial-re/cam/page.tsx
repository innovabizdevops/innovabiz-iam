...
const PAGE = "CAM";
const KPIS = [{"l":"Total Commercial Re","v":"8.565","t":"+7.1%","d":"up"},{"l":"CAM Ativos","v":"990","t":"+12.0%","d":"up"},{"l":"Eficiência (%)","v":"65.1%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"66","t":"+8.3%","d":"up"}];
const COLS = ["ID","CAM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Commercial Re #001","Commercial Re #002","6.455","4.274","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Commercial Re #002","Commercial Re #003","3.377","7.845","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Commercial Re #003","Commercial Re #004","231","7.996","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Commercial Re #004","Commercial Re #005","924","5.027","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Commercial Re #005","Commercial Re #001","4.509","1.980","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":264},{"label":"Fev","value":242},{"label":"Mar","value":324},{"label":"Abr","value":423},{"label":"Mai","value":528},{"label":"Jun","value":210},{"label":"Jul","value":457},{"label":"Ago","value":553},{"label":"Set","value":227},{"label":"Out","value":389},{"label":"Nov","value":520},{"label":"Dez","value":244}];
const MX = 553;
