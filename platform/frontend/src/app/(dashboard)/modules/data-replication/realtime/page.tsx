...
const KPIS = [{"l":"Dashboards Ativos","v":"6.315","t":"+13.9%","d":"up"},{"l":"Queries/Dia","v":"3575","t":"+15.4%","d":"up"},{"l":"Dados Processados (GB)","v":"4.255","t":"+7.1%","d":"up"},{"l":"Utilizadores Analytics","v":"2.903","t":"-1.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","352","2026-01-23","8.662","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1015","2026-01-26","7.016","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","920","2026-03-05","6.831","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2306","2026-03-22","3.380","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2777","2026-03-15","5.938","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":643},{"label":"Mar","value":798},{"label":"Abr","value":869},{"label":"Mai","value":508},{"label":"Jun","value":834},{"label":"Jul","value":723},{"label":"Ago","value":787},{"label":"Set","value":848},{"label":"Out","value":762},{"label":"Nov","value":517},{"label":"Dez","value":672}];
const MX = 869;
