...
/* ═══ Data Replication Engine — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "5920", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4464", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€400K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "-3%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1394153520", cells: ["DAT-9520", "Data Replication Engine Item 1", "5/1/2026", "€3620"], status: "active" as const },
    { id: "1394157091", cells: ["DAT-4091", "Data Replication Engine Item 2", "20/8/2026", "€7191"], status: "pending" as const },
    { id: "1394160662", cells: ["DAT-7662", "Data Replication Engine Item 3", "7/3/2026", "€10 762"], status: "completed" as const },
    { id: "1394164233", cells: ["DAT-2233", "Data Replication Engine Item 4", "22/10/2026", "€14 333"], status: "warning" as const },
    { id: "1394167804", cells: ["DAT-5804", "Data Replication Engine Item 5", "9/5/2026", "€17 904"], status: "active" as const },
];
...
export default function DataReplicationEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Replication Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Replication Engine</p>
                    </div>
                </div>
