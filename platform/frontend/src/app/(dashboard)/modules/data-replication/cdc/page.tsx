...
const PAGE = "CDC";
const KPIS = [{"l":"Dashboards Ativos","v":"8.129","t":"+6.7%","d":"up"},{"l":"Queries/Dia","v":"1461","t":"-2.6%","d":"down"},{"l":"Dados Processados (GB)","v":"5.117","t":"+11.2%","d":"up"},{"l":"Utilizadores Analytics","v":"8.162","t":"+13.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1950","2026-02-18","3.464","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1877","2026-03-17","4.279","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1749","2026-03-26","3.159","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4986","2026-02-09","9.086","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3335","2026-02-10","8.339","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":359},{"label":"Fev","value":303},{"label":"Mar","value":537},{"label":"Abr","value":304},{"label":"Mai","value":543},{"label":"Jun","value":514},{"label":"Jul","value":497},{"label":"Ago","value":342},{"label":"Set","value":433},{"label":"Out","value":542},{"label":"Nov","value":433},{"label":"Dez","value":324}];
const MX = 543;
