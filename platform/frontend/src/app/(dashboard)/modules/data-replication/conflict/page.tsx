...
const PAGE = "Conflict";
const KPIS = [{"l":"Dashboards Ativos","v":"4.730","t":"+-0.0%","d":"up"},{"l":"Queries/Dia","v":"3233","t":"+3.7%","d":"up"},{"l":"Dados Processados (GB)","v":"6.421","t":"-0.2%","d":"down"},{"l":"Utilizadores Analytics","v":"665","t":"-4.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3672","2026-02-01","791","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5052","2026-02-22","2.806","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1599","2026-01-11","3.480","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3266","2026-03-21","1.984","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3023","2026-02-08","6.081","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":588},{"label":"Mar","value":654},{"label":"Abr","value":441},{"label":"Mai","value":676},{"label":"Jun","value":682},{"label":"Jul","value":525},{"label":"Ago","value":775},{"label":"Set","value":527},{"label":"Out","value":589},{"label":"Nov","value":671},{"label":"Dez","value":764}];
const MX = 775;
