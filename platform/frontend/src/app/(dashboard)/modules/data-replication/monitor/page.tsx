...
const ACCENT = "#0d9488";
const MODULE = "Data Replication Engine";
const PAGE = "Monitor";
const KPIS = [{"l":"Dashboards Ativos","v":"8.325","t":"-1.7%","d":"down"},{"l":"Queries/Dia","v":"410","t":"+11.5%","d":"up"},{"l":"Dados Processados (GB)","v":"150","t":"+17.5%","d":"up"},{"l":"Utilizadores Analytics","v":"8.623","t":"+5.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4539","2026-03-26","5.185","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3806","2026-02-17","6.598","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3734","2026-03-19","9.049","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2132","2026-01-04","6.475","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2300","2026-01-01","8.316","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":405},{"label":"Fev","value":557},{"label":"Mar","value":444},{"label":"Abr","value":457},{"label":"Mai","value":627},{"label":"Jun","value":309},{"label":"Jul","value":427},{"label":"Ago","value":330},{"label":"Set","value":397},{"label":"Out","value":284},{"label":"Nov","value":639},{"label":"Dez","value":400}];
const MX = 639;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0d9488'}}>RTM</span></h1>
                </div>
