...
const KPIS = [{"l":"Formulários Ativos","v":"4.256","t":"+6.2%","d":"up"},{"l":"Submissões/Dia","v":"239","t":"+12.0%","d":"up"},{"l":"Documentos Gerados","v":"5.044","t":"+3.8%","d":"up"},{"l":"Templates","v":"7.980","t":"+11.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.770","2026-01-22","2.835","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.610","2026-02-17","4.759","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.754","2026-02-07","5.882","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.593","2026-02-01","6.003","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.427","2026-02-09","5.540","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":746},{"label":"Mar","value":740},{"label":"Abr","value":1014},{"label":"Mai","value":992},{"label":"Jun","value":911},{"label":"Jul","value":762},{"label":"Ago","value":958},{"label":"Set","value":727},{"label":"Out","value":751},{"label":"Nov","value":1011},{"label":"Dez","value":1049}];
const MX = 1049;
