...
const KPIS = [{"l":"Formulários Ativos","v":"685","t":"-0.7%","d":"down"},{"l":"Submissões/Dia","v":"235","t":"+5.5%","d":"up"},{"l":"Documentos Gerados","v":"606","t":"+4.1%","d":"up"},{"l":"Templates","v":"4.656","t":"-2.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.626","2026-01-26","6.252","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","171","2026-03-26","5.377","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.188","2026-02-27","129","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.301","2026-03-04","4.224","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.771","2026-03-11","7.223","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":400},{"label":"Fev","value":366},{"label":"Mar","value":452},{"label":"Abr","value":282},{"label":"Mai","value":524},{"label":"Jun","value":569},{"label":"Jul","value":661},{"label":"Ago","value":588},{"label":"Set","value":468},{"label":"Out","value":624},{"label":"Nov","value":532},{"label":"Dez","value":308}];
const MX = 661;
