...
const KPIS = [{"l":"Formulários Ativos","v":"4.476","t":"+15.5%","d":"up"},{"l":"Submissões/Dia","v":"3808","t":"+3.8%","d":"up"},{"l":"Documentos Gerados","v":"914","t":"+5.0%","d":"up"},{"l":"Templates","v":"6.220","t":"-1.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.128","2026-01-02","3.811","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.203","2026-01-19","8.974","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","875","2026-02-02","1.595","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.205","2026-01-03","8.088","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.215","2026-03-27","568","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":420},{"label":"Fev","value":601},{"label":"Mar","value":400},{"label":"Abr","value":388},{"label":"Mai","value":251},{"label":"Jun","value":255},{"label":"Jul","value":388},{"label":"Ago","value":264},{"label":"Set","value":588},{"label":"Out","value":428},{"label":"Nov","value":597},{"label":"Dez","value":253}];
const MX = 601;
