...
const ACCENT = "#6366f1";
const MODULE = "Student Info System";
const PAGE = "Attendance";
const KPIS = [{"l":"Formulários Ativos","v":"7.191","t":"-4.5%","d":"down"},{"l":"Submissões/Dia","v":"4919","t":"+4.3%","d":"up"},{"l":"Documentos Gerados","v":"3.807","t":"+14.7%","d":"up"},{"l":"Templates","v":"5.559","t":"+6.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.511","2026-01-19","204","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.135","2026-03-06","8.452","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.860","2026-03-05","3.720","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.837","2026-01-21","8.016","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.460","2026-02-18","8.852","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":916},{"label":"Fev","value":557},{"label":"Mar","value":800},{"label":"Abr","value":875},{"label":"Mai","value":637},{"label":"Jun","value":635},{"label":"Jul","value":775},{"label":"Ago","value":896},{"label":"Set","value":819},{"label":"Out","value":558},{"label":"Nov","value":891},{"label":"Dez","value":807}];
const MX = 916;
