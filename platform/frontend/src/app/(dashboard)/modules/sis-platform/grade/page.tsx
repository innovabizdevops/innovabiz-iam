...
const PAGE = "Grade";
const KPIS = [{"l":"Formulários Ativos","v":"688","t":"+12.8%","d":"up"},{"l":"Submissões/Dia","v":"1550","t":"+3.0%","d":"up"},{"l":"Documentos Gerados","v":"6.227","t":"+11.2%","d":"up"},{"l":"Templates","v":"8.795","t":"+6.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.647","2026-03-26","1.105","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.100","2026-03-16","313","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.520","2026-01-19","2.523","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.072","2026-02-05","5.127","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.108","2026-02-27","1.585","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":741},{"label":"Mar","value":657},{"label":"Abr","value":953},{"label":"Mai","value":923},{"label":"Jun","value":817},{"label":"Jul","value":832},{"label":"Ago","value":792},{"label":"Set","value":783},{"label":"Out","value":725},{"label":"Nov","value":1000},{"label":"Dez","value":769}];
const MX = 1000;
