...
const PAGE = "Bypass";
const KPIS = [{"l":"Total Telecom Fraud","v":"3.589","t":"+-0.0%","d":"up"},{"l":"Bypass Ativos","v":"4.098","t":"+6.6%","d":"up"},{"l":"Eficiência (%)","v":"66.0%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"56","t":"-0.1%","d":"down"}];
const COLS = ["ID","Bypass","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Fraud #001","Telecom Fraud #002","8.432","862","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Fraud #002","Telecom Fraud #003","7.207","8.571","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Fraud #003","Telecom Fraud #004","6.030","2.513","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Fraud #004","Telecom Fraud #005","6.287","1.651","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Fraud #005","Telecom Fraud #001","6.416","7.616","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":332},{"label":"Fev","value":520},{"label":"Mar","value":491},{"label":"Abr","value":642},{"label":"Mai","value":341},{"label":"Jun","value":678},{"label":"Jul","value":666},{"label":"Ago","value":607},{"label":"Set","value":518},{"label":"Out","value":559},{"label":"Nov","value":707},{"label":"Dez","value":450}];
const MX = 707;
