...
const PAGE = "Wangiri";
const KPIS = [{"l":"Total Telecom Fraud","v":"7.815","t":"+11.5%","d":"up"},{"l":"Wangiri Ativos","v":"3.746","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"62","t":"+17.9%","d":"up"}];
const COLS = ["ID","Wangiri","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Fraud #001","Telecom Fraud #002","6.826","7.012","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Fraud #002","Telecom Fraud #003","593","3.521","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Fraud #003","Telecom Fraud #004","1.919","7.621","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Fraud #004","Telecom Fraud #005","2.592","1.031","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Fraud #005","Telecom Fraud #001","3.193","8.661","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":694},{"label":"Mar","value":665},{"label":"Abr","value":925},{"label":"Mai","value":754},{"label":"Jun","value":711},{"label":"Jul","value":648},{"label":"Ago","value":646},{"label":"Set","value":651},{"label":"Out","value":822},{"label":"Nov","value":594},{"label":"Dez","value":666}];
const MX = 925;
...
export default function WangiriPage() {
    return (
