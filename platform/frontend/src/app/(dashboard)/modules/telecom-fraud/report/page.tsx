...
const PAGE = "Report";
const KPIS = [{"l":"Total Telecom Fraud","v":"550","t":"+10.5%","d":"up"},{"l":"Report Ativos","v":"6.145","t":"+6.0%","d":"up"},{"l":"Eficiência (%)","v":"78.4%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"71","t":"+8.9%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Fraud #001","Telecom Fraud #002","4.475","2.090","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Fraud #002","Telecom Fraud #003","374","7.919","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Fraud #003","Telecom Fraud #004","8.819","6.605","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Fraud #004","Telecom Fraud #005","437","7.404","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Fraud #005","Telecom Fraud #001","6.274","6.110","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":488},{"label":"Fev","value":496},{"label":"Mar","value":695},{"label":"Abr","value":574},{"label":"Mai","value":556},{"label":"Jun","value":684},{"label":"Jul","value":545},{"label":"Ago","value":449},{"label":"Set","value":551},{"label":"Out","value":642},{"label":"Nov","value":663},{"label":"Dez","value":484}];
const MX = 695;
