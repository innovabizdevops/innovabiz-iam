...
const ACCENT = "#6366f1";
const MODULE = "Telecom Fraud Mgmt";
const PAGE = "Detection";
const KPIS = [{"l":"Total Telecom Fraud","v":"6.705","t":"+3.4%","d":"up"},{"l":"Detection Ativos","v":"3.375","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"81.1%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"67","t":"+14.8%","d":"up"}];
const COLS = ["ID","Detection","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Fraud #001","Telecom Fraud #002","3.870","5.570","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Fraud #002","Telecom Fraud #003","3.106","7.001","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Fraud #003","Telecom Fraud #004","1.332","3.001","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Fraud #004","Telecom Fraud #005","6.290","4.212","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Fraud #005","Telecom Fraud #001","5.441","3.387","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":987},{"label":"Mar","value":730},{"label":"Abr","value":778},{"label":"Mai","value":881},{"label":"Jun","value":850},{"label":"Jul","value":787},{"label":"Ago","value":754},{"label":"Set","value":979},{"label":"Out","value":971},{"label":"Nov","value":749},{"label":"Dez","value":890}];
const MX = 987;
