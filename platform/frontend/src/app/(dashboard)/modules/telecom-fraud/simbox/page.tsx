...
const PAGE = "SIM Box";
const KPIS = [{"l":"Total Telecom Fraud","v":"8.933","t":"+4.6%","d":"up"},{"l":"SIM Box Ativos","v":"785","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"74.3%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"94","t":"+8.2%","d":"up"}];
const COLS = ["ID","SIM Box","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Fraud #001","Telecom Fraud #002","4.079","4.546","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Fraud #002","Telecom Fraud #003","6.360","2.177","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Fraud #003","Telecom Fraud #004","6.129","1.406","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Fraud #004","Telecom Fraud #005","3.215","181","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Fraud #005","Telecom Fraud #001","3.407","9.017","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":636},{"label":"Mar","value":446},{"label":"Abr","value":545},{"label":"Mai","value":538},{"label":"Jun","value":568},{"label":"Jul","value":584},{"label":"Ago","value":578},{"label":"Set","value":487},{"label":"Out","value":735},{"label":"Nov","value":523},{"label":"Dez","value":619}];
const MX = 735;
...
export default function SimboxPage() {
    return (
