...
const ACCENT = "#96b9df";
const MODULE = "Tolling Management";
const PAGE = "ANPR";
const KPIS = [{"l":"Total Tolling Mgmt","v":"4.575","t":"+8.8%","d":"up"},{"l":"ANPR Ativos","v":"5.272","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"88.4%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"86","t":"+14.1%","d":"up"}];
const COLS = ["ID","ANPR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tolling Mgmt #001","Tolling Mgmt #002","8.180","8.587","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Tolling Mgmt #002","Tolling Mgmt #003","4.392","6.218","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Tolling Mgmt #003","Tolling Mgmt #004","1.481","1.441","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Tolling Mgmt #004","Tolling Mgmt #005","948","8.081","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tolling Mgmt #005","Tolling Mgmt #001","4.560","445","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":688},{"label":"Mar","value":592},{"label":"Abr","value":407},{"label":"Mai","value":568},{"label":"Jun","value":442},{"label":"Jul","value":508},{"label":"Ago","value":477},{"label":"Set","value":459},{"label":"Out","value":496},{"label":"Nov","value":385},{"label":"Dez","value":528}];
const MX = 701;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#96b9df'}}>AI</span></h1>
                </div>
