...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€15.4M","t":"+0.1%","d":"up"},{"l":"MRR (€)","v":"€91436","t":"+16.3%","d":"up"},{"l":"Churn (%)","v":"86.3%","t":"+9.2%","d":"up"},{"l":"ARPU (€)","v":"€83474","t":"+12.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 33552.67","986","€ 28332.76","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 15215.08","6.381","€ 38795.37","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 5987.70","5.145","€ 12196.03","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 30984.24","8.555","€ 15801.94","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 6273.90","7.327","€ 1731.31","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":555},{"label":"Mar","value":612},{"label":"Abr","value":797},{"label":"Mai","value":646},{"label":"Jun","value":506},{"label":"Jul","value":599},{"label":"Ago","value":753},{"label":"Set","value":543},{"label":"Out","value":608},{"label":"Nov","value":621},{"label":"Dez","value":834}];
const MX = 834;
