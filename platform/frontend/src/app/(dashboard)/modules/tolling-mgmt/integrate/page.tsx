...
const KPIS = [{"l":"Integrações Ativas","v":"5.446","t":"+12.4%","d":"up"},{"l":"Chamadas/Hora","v":"4843","t":"+0.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"77.8%","t":"+10.5%","d":"up"},{"l":"Latência Média (ms)","v":"181ms","t":"-5.4%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.738","5.985","92.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.379","4.289","72.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.728","6.565","84.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.947","8.924","98.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.978","2.295","87.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":771},{"label":"Fev","value":881},{"label":"Mar","value":697},{"label":"Abr","value":951},{"label":"Mai","value":692},{"label":"Jun","value":897},{"label":"Jul","value":954},{"label":"Ago","value":919},{"label":"Set","value":812},{"label":"Out","value":760},{"label":"Nov","value":806},{"label":"Dez","value":706}];
const MX = 954;
