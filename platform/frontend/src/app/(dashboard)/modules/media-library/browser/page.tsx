...
const PAGE = "Asset Browser";
const KPIS = [{"l":"Integrações Ativas","v":"6.752","t":"+2.9%","d":"up"},{"l":"Chamadas/Hora","v":"2612","t":"-0.7%","d":"down"},{"l":"Taxa Sucesso (%)","v":"77.5%","t":"+15.5%","d":"up"},{"l":"Latência Média (ms)","v":"170ms","t":"-3.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.186","6.801","74.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.035","5.267","92.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.309","3.163","85.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.130","7.001","84.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.565","5.443","98.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":541},{"label":"Mar","value":475},{"label":"Abr","value":374},{"label":"Mai","value":403},{"label":"Jun","value":601},{"label":"Jul","value":322},{"label":"Ago","value":625},{"label":"Set","value":428},{"label":"Out","value":326},{"label":"Nov","value":619},{"label":"Dez","value":688}];
const MX = 688;
