...
const PAGE = "Video Hosting";
const KPIS = [{"l":"Integrações Ativas","v":"7.364","t":"-1.2%","d":"down"},{"l":"Chamadas/Hora","v":"3088","t":"+5.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"87.4%","t":"+1.5%","d":"up"},{"l":"Latência Média (ms)","v":"53ms","t":"-1.2%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","721","8.785","94.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.548","1.911","74.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","241","2.767","88.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","476","1.863","90.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.744","1.806","82.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":665},{"label":"Mar","value":578},{"label":"Abr","value":752},{"label":"Mai","value":580},{"label":"Jun","value":728},{"label":"Jul","value":786},{"label":"Ago","value":796},{"label":"Set","value":540},{"label":"Out","value":652},{"label":"Nov","value":813},{"label":"Dez","value":691}];
const MX = 813;
