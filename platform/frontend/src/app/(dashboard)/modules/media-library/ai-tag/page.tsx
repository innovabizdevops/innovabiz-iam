...
const PAGE = "AI Tagging";
const KPIS = [{"l":"Integrações Ativas","v":"7.804","t":"+6.0%","d":"up"},{"l":"Chamadas/Hora","v":"841","t":"-2.7%","d":"down"},{"l":"Taxa Sucesso (%)","v":"84.0%","t":"+2.7%","d":"up"},{"l":"Latência Média (ms)","v":"153ms","t":"-4.2%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.159","4.777","87.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.444","4.794","72.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","432","7.616","96.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.648","6.705","94.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","9.055","3.239","70.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":917},{"label":"Fev","value":975},{"label":"Mar","value":821},{"label":"Abr","value":966},{"label":"Mai","value":806},{"label":"Jun","value":685},{"label":"Jul","value":809},{"label":"Ago","value":773},{"label":"Set","value":783},{"label":"Out","value":889},{"label":"Nov","value":927},{"label":"Dez","value":695}];
const MX = 975;
