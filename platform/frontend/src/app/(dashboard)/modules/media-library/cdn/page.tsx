...
const PAGE = "Image CDN";
const KPIS = [{"l":"Integrações Ativas","v":"7.428","t":"+17.8%","d":"up"},{"l":"Chamadas/Hora","v":"1243","t":"-4.5%","d":"down"},{"l":"Taxa Sucesso (%)","v":"80.2%","t":"+0.9%","d":"up"},{"l":"Latência Média (ms)","v":"201ms","t":"+4.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.873","4.331","71.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.721","4.247","77.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.716","1.663","75.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.526","5.121","71.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.199","7.234","90.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":723},{"label":"Mar","value":921},{"label":"Abr","value":956},{"label":"Mai","value":913},{"label":"Jun","value":1046},{"label":"Jul","value":714},{"label":"Ago","value":1053},{"label":"Set","value":719},{"label":"Out","value":860},{"label":"Nov","value":859},{"label":"Dez","value":840}];
const MX = 1053;
