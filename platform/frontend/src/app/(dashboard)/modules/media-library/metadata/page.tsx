...
const PAGE = "DAM Metadata";
const KPIS = [{"l":"Integrações Ativas","v":"1.437","t":"+4.3%","d":"up"},{"l":"Chamadas/Hora","v":"2602","t":"+2.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"76.9%","t":"+15.9%","d":"up"},{"l":"Latência Média (ms)","v":"112ms","t":"+7.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.597","1.119","77.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.435","2.803","83.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.003","3.324","96.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.370","8.910","91.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.585","1.389","90.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":606},{"label":"Mar","value":609},{"label":"Abr","value":656},{"label":"Mai","value":418},{"label":"Jun","value":489},{"label":"Jul","value":412},{"label":"Ago","value":649},{"label":"Set","value":653},{"label":"Out","value":706},{"label":"Nov","value":618},{"label":"Dez","value":515}];
const MX = 706;
