...
export default function ComicMangaPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Comic Manga</h1><p className="text-sm text-muted-foreground">Comic Manga • iBOS Enterprise</p></div>
