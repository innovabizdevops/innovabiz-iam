...
const KPIS = [{"l":"Total Comic Manga","v":"8.907","t":"+1.4%","d":"up"},{"l":"Serialization Ativos","v":"1.927","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"85.5%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"73","t":"-2.9%","d":"down"}];
const COLS = ["ID","Serialization","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Comic Manga #001","Comic Manga #002","3.991","7.598","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Comic Manga #002","Comic Manga #003","692","7.555","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Comic Manga #003","Comic Manga #004","5.929","967","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Comic Manga #004","Comic Manga #005","2.796","3.218","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Comic Manga #005","Comic Manga #001","4.443","4.067","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":578},{"label":"Mar","value":679},{"label":"Abr","value":836},{"label":"Mai","value":725},{"label":"Jun","value":760},{"label":"Jul","value":786},{"label":"Ago","value":830},{"label":"Set","value":840},{"label":"Out","value":637},{"label":"Nov","value":555},{"label":"Dez","value":665}];
const MX = 840;
