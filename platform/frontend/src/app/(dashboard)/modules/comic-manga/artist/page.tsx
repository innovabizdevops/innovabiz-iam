...
const ACCENT = "#dc2626";
const MODULE = "Comic & Manga";
const PAGE = "Artist Assign";
const KPIS = [{"l":"Total Comic Manga","v":"4.448","t":"+1.1%","d":"up"},{"l":"Artist Assign Ativos","v":"4.749","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"81.7%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"73","t":"+4.7%","d":"up"}];
const COLS = ["ID","Artist Assign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Comic Manga #001","Comic Manga #002","2.250","4.258","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Comic Manga #002","Comic Manga #003","7.980","5.615","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Comic Manga #003","Comic Manga #004","4.909","8.465","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Comic Manga #004","Comic Manga #005","4.337","3.784","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Comic Manga #005","Comic Manga #001","4.658","6.761","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":359},{"label":"Mar","value":565},{"label":"Abr","value":407},{"label":"Mai","value":646},{"label":"Jun","value":354},{"label":"Jul","value":557},{"label":"Ago","value":436},{"label":"Set","value":682},{"label":"Out","value":495},{"label":"Nov","value":371},{"label":"Dez","value":401}];
const MX = 682;
