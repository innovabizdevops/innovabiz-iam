...
const PAGE = "Panel Layout";
const KPIS = [{"l":"Total Comic Manga","v":"6.116","t":"+5.1%","d":"up"},{"l":"Panel Layout Ativos","v":"4.480","t":"+-0.0%","d":"up"},{"l":"Eficiência (%)","v":"68.3%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"64","t":"+5.4%","d":"up"}];
const COLS = ["ID","Panel Layout","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Comic Manga #001","Comic Manga #002","5.493","3.817","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Comic Manga #002","Comic Manga #003","3.358","173","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Comic Manga #003","Comic Manga #004","8.897","4.529","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Comic Manga #004","Comic Manga #005","1.545","2.208","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Comic Manga #005","Comic Manga #001","2.149","7.739","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":595},{"label":"Mar","value":595},{"label":"Abr","value":915},{"label":"Mai","value":731},{"label":"Jun","value":925},{"label":"Jul","value":935},{"label":"Ago","value":697},{"label":"Set","value":922},{"label":"Out","value":715},{"label":"Nov","value":649},{"label":"Dez","value":647}];
const MX = 935;
