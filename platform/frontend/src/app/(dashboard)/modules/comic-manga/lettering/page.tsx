...
const PAGE = "Lettering";
const KPIS = [{"l":"Total Comic Manga","v":"4.932","t":"-4.3%","d":"down"},{"l":"Lettering Ativos","v":"6.392","t":"+1.2%","d":"up"},{"l":"Eficiência (%)","v":"71.0%","t":"+4.5%","d":"up"},{"l":"Score Performance","v":"81","t":"+5.1%","d":"up"}];
const COLS = ["ID","Lettering","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Comic Manga #001","Comic Manga #002","4.236","9.002","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Comic Manga #002","Comic Manga #003","7.562","9.096","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Comic Manga #003","Comic Manga #004","6.169","9.041","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Comic Manga #004","Comic Manga #005","7.412","8.404","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Comic Manga #005","Comic Manga #001","4.823","8.011","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":813},{"label":"Mar","value":759},{"label":"Abr","value":624},{"label":"Mai","value":640},{"label":"Jun","value":630},{"label":"Jul","value":556},{"label":"Ago","value":851},{"label":"Set","value":721},{"label":"Out","value":669},{"label":"Nov","value":841},{"label":"Dez","value":853}];
const MX = 853;
