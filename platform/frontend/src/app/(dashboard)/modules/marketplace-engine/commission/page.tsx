...
const PAGE = "Commission Engine";
const KPIS = [{"l":"Pedidos/Dia","v":"4824","t":"+4.0%","d":"up"},{"l":"GMV (€)","v":"€97212","t":"-2.3%","d":"down"},{"l":"Conversão (%)","v":"89.1%","t":"+0.6%","d":"up"},{"l":"AOV (€)","v":"€8068","t":"+0.0%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 12866.34","8.632","5.082","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 42769.33","2.716","6.335","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 711.64","1.163","5.812","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 5621.51","4.838","3.780","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 43857.76","1.558","8.201","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":575},{"label":"Mar","value":463},{"label":"Abr","value":535},{"label":"Mai","value":486},{"label":"Jun","value":498},{"label":"Jul","value":415},{"label":"Ago","value":333},{"label":"Set","value":434},{"label":"Out","value":439},{"label":"Nov","value":444},{"label":"Dez","value":630}];
const MX = 657;
