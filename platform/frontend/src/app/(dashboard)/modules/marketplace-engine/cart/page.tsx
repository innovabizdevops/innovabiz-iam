...
const ACCENT = "#c026d3";
const MODULE = "Marketplace Engine";
const PAGE = "Multi-Seller Cart";
const KPIS = [{"l":"Pedidos/Dia","v":"4415","t":"+10.1%","d":"up"},{"l":"GMV (€)","v":"€41749","t":"+13.0%","d":"up"},{"l":"Conversão (%)","v":"89.0%","t":"+2.5%","d":"up"},{"l":"AOV (€)","v":"€45753","t":"+15.8%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 14025.13","2.997","1.665","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 45292.57","6.331","5.406","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 30061.38","5.566","4.669","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 40289.78","6.645","8.033","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 25868.36","2.299","1.680","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":294},{"label":"Fev","value":453},{"label":"Mar","value":422},{"label":"Abr","value":451},{"label":"Mai","value":485},{"label":"Jun","value":367},{"label":"Jul","value":470},{"label":"Ago","value":598},{"label":"Set","value":625},{"label":"Out","value":323},{"label":"Nov","value":516},{"label":"Dez","value":425}];
const MX = 625;
