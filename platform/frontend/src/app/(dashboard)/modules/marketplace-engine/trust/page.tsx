...
const PAGE = "Trust &amp; Safety";
const KPIS = [{"l":"Pedidos/Dia","v":"2077","t":"+5.7%","d":"up"},{"l":"GMV (€)","v":"€29308","t":"+10.1%","d":"up"},{"l":"Conversão (%)","v":"81.3%","t":"-1.1%","d":"down"},{"l":"AOV (€)","v":"€1179","t":"+2.4%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 22768.54","8.073","2.447","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 47102.72","426","6.808","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 44794.00","5.163","2.286","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 40519.25","1.844","2.583","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 3880.67","7.080","1.088","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":577},{"label":"Mar","value":503},{"label":"Abr","value":512},{"label":"Mai","value":688},{"label":"Jun","value":648},{"label":"Jul","value":417},{"label":"Ago","value":611},{"label":"Set","value":427},{"label":"Out","value":409},{"label":"Nov","value":531},{"label":"Dez","value":520}];
const MX = 688;
