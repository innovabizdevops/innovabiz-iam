...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"3.708","t":"+5.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"69.6%","t":"+2.1%","d":"up"},{"l":"MTTR (h)","v":"119h","t":"+12.9%","d":"up"},{"l":"Satisfação (%)","v":"94.5%","t":"+17.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.405","458","2.415","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.467","3.712","3.512","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","780","4.704","5.342","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.049","8.375","6.737","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.491","4.298","2.029","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":521},{"label":"Mar","value":538},{"label":"Abr","value":552},{"label":"Mai","value":842},{"label":"Jun","value":825},{"label":"Jul","value":769},{"label":"Ago","value":788},{"label":"Set","value":837},{"label":"Out","value":537},{"label":"Nov","value":771},{"label":"Dez","value":620}];
const MX = 842;
