...
const ACCENT = "#6366f1";
const MODULE = "Nuclear Operations";
const PAGE = "Fuel Rod";
const KPIS = [{"l":"Total Nuclear Ops","v":"4.274","t":"+12.3%","d":"up"},{"l":"Fuel Rod Ativos","v":"5.997","t":"+1.5%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"84","t":"+9.8%","d":"up"}];
const COLS = ["ID","Fuel Rod","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nuclear Ops #001","Nuclear Ops #002","388","8.529","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Nuclear Ops #002","Nuclear Ops #003","3.336","1.548","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Nuclear Ops #003","Nuclear Ops #004","8.741","6.026","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Nuclear Ops #004","Nuclear Ops #005","6.006","6.147","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nuclear Ops #005","Nuclear Ops #001","5.147","3.394","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":806},{"label":"Mar","value":987},{"label":"Abr","value":945},{"label":"Mai","value":832},{"label":"Jun","value":940},{"label":"Jul","value":859},{"label":"Ago","value":920},{"label":"Set","value":678},{"label":"Out","value":903},{"label":"Nov","value":862},{"label":"Dez","value":723}];
const MX = 987;
...
export default function FuelrodPage() {
    return (
