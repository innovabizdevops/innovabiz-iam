...
const KPIS = [{"l":"Tickets Abertos","v":"4.863","t":"+10.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"67.1%","t":"-2.4%","d":"down"},{"l":"MTTR (h)","v":"33h","t":"+13.0%","d":"up"},{"l":"Satisfação (%)","v":"83.0%","t":"-5.1%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.762","8.738","7.339","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.354","1.005","7.351","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.938","6.422","8.701","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.256","8.710","7.544","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.319","4.650","2.577","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":848},{"label":"Mar","value":610},{"label":"Abr","value":603},{"label":"Mai","value":857},{"label":"Jun","value":692},{"label":"Jul","value":688},{"label":"Ago","value":874},{"label":"Set","value":679},{"label":"Out","value":846},{"label":"Nov","value":811},{"label":"Dez","value":846}];
const MX = 874;
