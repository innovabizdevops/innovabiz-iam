...
const ACCENT = "#1e40af";
const MODULE = "Incident Management Deep";
const PAGE = "Detect";
const KPIS = [{"l":"Tickets Abertos","v":"8.558","t":"+8.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"82.3%","t":"-4.2%","d":"down"},{"l":"MTTR (h)","v":"198h","t":"+2.2%","d":"up"},{"l":"Satisfação (%)","v":"95.0%","t":"+11.7%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.270","2.576","8.311","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.512","3.322","2.805","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.062","7.210","8.239","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.442","8.804","2.197","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.500","3.648","948","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":871},{"label":"Mar","value":961},{"label":"Abr","value":1001},{"label":"Mai","value":677},{"label":"Jun","value":651},{"label":"Jul","value":663},{"label":"Ago","value":693},{"label":"Set","value":1004},{"label":"Out","value":1009},{"label":"Nov","value":927},{"label":"Dez","value":996}];
const MX = 1009;
