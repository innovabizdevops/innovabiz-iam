...
const PAGE = "Page";
const KPIS = [{"l":"Tickets Abertos","v":"7.846","t":"+10.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"78.4%","t":"+14.3%","d":"up"},{"l":"MTTR (h)","v":"138h","t":"-5.6%","d":"down"},{"l":"Satisfação (%)","v":"83.6%","t":"+5.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.379","842","794","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.787","4.832","340","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.573","4.118","1.819","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.720","491","1.039","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.701","8.319","2.224","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":576},{"label":"Mar","value":457},{"label":"Abr","value":719},{"label":"Mai","value":555},{"label":"Jun","value":440},{"label":"Jul","value":435},{"label":"Ago","value":703},{"label":"Set","value":415},{"label":"Out","value":506},{"label":"Nov","value":438},{"label":"Dez","value":461}];
const MX = 719;
