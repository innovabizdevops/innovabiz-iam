...
const PAGE = "Mitigate";
const KPIS = [{"l":"Tickets Abertos","v":"5.539","t":"+1.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"79.9%","t":"+3.6%","d":"up"},{"l":"MTTR (h)","v":"110h","t":"+17.0%","d":"up"},{"l":"Satisfação (%)","v":"83.1%","t":"+5.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.515","779","438","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.486","2.440","4.766","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","552","6.070","1.937","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.657","4.057","2.004","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.845","6.151","3.514","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":905},{"label":"Fev","value":825},{"label":"Mar","value":765},{"label":"Abr","value":731},{"label":"Mai","value":793},{"label":"Jun","value":1014},{"label":"Jul","value":757},{"label":"Ago","value":653},{"label":"Set","value":724},{"label":"Out","value":1020},{"label":"Nov","value":802},{"label":"Dez","value":780}];
const MX = 1020;
