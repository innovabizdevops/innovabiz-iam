...
/* ═══ Incident Management Deep — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "9134", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1956", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€336K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1450745134", cells: ["INC-9134", "Incident Management Deep Item 1", "7/11/2026", "€45 234"], status: "active" as const },
    { id: "1450748705", cells: ["INC-3705", "Incident Management Deep Item 2", "22/6/2026", "€48 805"], status: "pending" as const },
    { id: "1450752276", cells: ["INC-7276", "Incident Management Deep Item 3", "9/1/2026", "€2376"], status: "completed" as const },
    { id: "1450755847", cells: ["INC-1847", "Incident Management Deep Item 4", "24/8/2026", "€5947"], status: "warning" as const },
    { id: "1450759418", cells: ["INC-5418", "Incident Management Deep Item 5", "11/3/2026", "€9518"], status: "active" as const },
];
...
export default function IncidentManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Incident Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Incident Management Deep</p>
                    </div>
                </div>
