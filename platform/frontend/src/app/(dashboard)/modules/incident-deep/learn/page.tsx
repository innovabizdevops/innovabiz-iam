...
const PAGE = "Learn";
const KPIS = [{"l":"Tickets Abertos","v":"3.098","t":"-5.9%","d":"down"},{"l":"SLA Cumprido (%)","v":"69.0%","t":"+6.2%","d":"up"},{"l":"MTTR (h)","v":"191h","t":"+11.5%","d":"up"},{"l":"Satisfação (%)","v":"78.9%","t":"+12.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","323","7.385","4.207","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.610","8.996","2.661","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.058","2.645","1.013","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.344","9.092","4.805","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","720","6.980","2.018","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":622},{"label":"Mar","value":470},{"label":"Abr","value":657},{"label":"Mai","value":528},{"label":"Jun","value":419},{"label":"Jul","value":643},{"label":"Ago","value":643},{"label":"Set","value":394},{"label":"Out","value":706},{"label":"Nov","value":597},{"label":"Dez","value":698}];
const MX = 706;
