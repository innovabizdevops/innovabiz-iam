...
const PAGE = "Ingest";
const KPIS = [{"l":"Total Rag Engine","v":"6.574","t":"+7.5%","d":"up"},{"l":"Ingest Ativos","v":"8.452","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"80.2%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"86","t":"-4.2%","d":"down"}];
const COLS = ["ID","Ingest","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rag Engine #001","Rag Engine #002","7.815","1.848","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Rag Engine #002","Rag Engine #003","8.705","1.986","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Rag Engine #003","Rag Engine #004","3.350","2.690","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Rag Engine #004","Rag Engine #005","7.854","2.152","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rag Engine #005","Rag Engine #001","3.796","7.552","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":497},{"label":"Fev","value":506},{"label":"Mar","value":586},{"label":"Abr","value":742},{"label":"Mai","value":798},{"label":"Jun","value":653},{"label":"Jul","value":569},{"label":"Ago","value":533},{"label":"Set","value":749},{"label":"Out","value":710},{"label":"Nov","value":723},{"label":"Dez","value":627}];
const MX = 798;
