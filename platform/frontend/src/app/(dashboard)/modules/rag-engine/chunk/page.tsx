...
const PAGE = "Chunk";
const KPIS = [{"l":"Total Rag Engine","v":"1.439","t":"+6.5%","d":"up"},{"l":"Chunk Ativos","v":"2.923","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"68.0%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"94","t":"+3.3%","d":"up"}];
const COLS = ["ID","Chunk","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rag Engine #001","Rag Engine #002","3.075","5.787","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Rag Engine #002","Rag Engine #003","609","3.453","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Rag Engine #003","Rag Engine #004","9.062","4.936","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Rag Engine #004","Rag Engine #005","5.984","3.053","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rag Engine #005","Rag Engine #001","2.975","3.015","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":816},{"label":"Mar","value":987},{"label":"Abr","value":673},{"label":"Mai","value":804},{"label":"Jun","value":688},{"label":"Jul","value":783},{"label":"Ago","value":718},{"label":"Set","value":972},{"label":"Out","value":770},{"label":"Nov","value":1011},{"label":"Dez","value":1001}];
const MX = 1011;
