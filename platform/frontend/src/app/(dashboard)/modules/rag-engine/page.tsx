...
/* ═══ RAG Engine Platform — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "7934", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1383", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€123K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "579732034", cells: ["RAG-7034", "RAG Engine Platform Item 1", "15/11/2026", "€32 134"], status: "active" as const },
    { id: "579735605", cells: ["RAG-1605", "RAG Engine Platform Item 2", "2/6/2026", "€35 705"], status: "pending" as const },
    { id: "579739176", cells: ["RAG-5176", "RAG Engine Platform Item 3", "17/1/2026", "€39 276"], status: "completed" as const },
    { id: "579742747", cells: ["RAG-8747", "RAG Engine Platform Item 4", "4/8/2026", "€42 847"], status: "warning" as const },
    { id: "579746318", cells: ["RAG-3318", "RAG Engine Platform Item 5", "19/3/2026", "€46 418"], status: "active" as const },
];
...
export default function RagEnginePlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">RAG Engine Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • RAG Engine Platform</p>
                    </div>
                </div>
