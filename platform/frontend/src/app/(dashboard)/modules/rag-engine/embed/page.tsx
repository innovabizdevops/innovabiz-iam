...
const PAGE = "Embed";
const KPIS = [{"l":"Dashboards Ativos","v":"424","t":"-4.8%","d":"down"},{"l":"Queries/Dia","v":"2480","t":"+3.7%","d":"up"},{"l":"Dados Processados (GB)","v":"1.160","t":"+15.5%","d":"up"},{"l":"Utilizadores Analytics","v":"5.687","t":"+14.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4153","2026-01-03","5.202","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1055","2026-02-01","6.635","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4603","2026-03-26","1.579","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3113","2026-02-15","4.997","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3812","2026-03-09","6.891","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":508},{"label":"Mar","value":666},{"label":"Abr","value":480},{"label":"Mai","value":510},{"label":"Jun","value":789},{"label":"Jul","value":651},{"label":"Ago","value":635},{"label":"Set","value":543},{"label":"Out","value":761},{"label":"Nov","value":573},{"label":"Dez","value":472}];
const MX = 789;
