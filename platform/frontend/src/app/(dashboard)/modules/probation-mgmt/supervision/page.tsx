...
const KPIS = [{"l":"Total Probation Mgmt","v":"1.139","t":"+10.9%","d":"up"},{"l":"Supervision Ativos","v":"2.185","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"91.9%","t":"+9.9%","d":"up"},{"l":"Score Performance","v":"83","t":"-5.6%","d":"down"}];
const COLS = ["ID","Supervision","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Probation Mgmt #001","Probation Mgmt #002","3.022","9.038","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Probation Mgmt #002","Probation Mgmt #003","7.393","1.303","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Probation Mgmt #003","Probation Mgmt #004","3.907","6.337","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Probation Mgmt #004","Probation Mgmt #005","1.590","3.300","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Probation Mgmt #005","Probation Mgmt #001","8.390","4.078","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":574},{"label":"Mar","value":681},{"label":"Abr","value":416},{"label":"Mai","value":627},{"label":"Jun","value":689},{"label":"Jul","value":639},{"label":"Ago","value":738},{"label":"Set","value":750},{"label":"Out","value":583},{"label":"Nov","value":546},{"label":"Dez","value":574}];
const MX = 750;
