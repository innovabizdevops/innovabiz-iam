...
const PAGE = "Drug Test";
const KPIS = [{"l":"Total Probation Mgmt","v":"7.647","t":"-0.8%","d":"down"},{"l":"Drug Test Ativos","v":"7.220","t":"+14.5%","d":"up"},{"l":"Eficiência (%)","v":"71.9%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"68","t":"+12.9%","d":"up"}];
const COLS = ["ID","Drug Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Probation Mgmt #001","Probation Mgmt #002","4.003","3.886","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Probation Mgmt #002","Probation Mgmt #003","335","6.212","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Probation Mgmt #003","Probation Mgmt #004","6.329","4.165","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Probation Mgmt #004","Probation Mgmt #005","7.006","5.230","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Probation Mgmt #005","Probation Mgmt #001","1.318","5.498","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":779},{"label":"Mar","value":529},{"label":"Abr","value":899},{"label":"Mai","value":760},{"label":"Jun","value":637},{"label":"Jul","value":683},{"label":"Ago","value":677},{"label":"Set","value":915},{"label":"Out","value":917},{"label":"Nov","value":683},{"label":"Dez","value":834}];
const MX = 917;
