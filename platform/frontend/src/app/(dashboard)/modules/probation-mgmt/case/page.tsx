...
const PAGE = "Case";
const KPIS = [{"l":"Total Probation Mgmt","v":"8.037","t":"+7.4%","d":"up"},{"l":"Case Ativos","v":"7.579","t":"+1.3%","d":"up"},{"l":"Eficiência (%)","v":"66.2%","t":"-3.0%","d":"down"},{"l":"Score Performance","v":"84","t":"-3.1%","d":"down"}];
const COLS = ["ID","Case","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Probation Mgmt #001","Probation Mgmt #002","3.555","5.069","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Probation Mgmt #002","Probation Mgmt #003","355","3.602","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Probation Mgmt #003","Probation Mgmt #004","1.948","2.499","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Probation Mgmt #004","Probation Mgmt #005","1.610","6.978","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Probation Mgmt #005","Probation Mgmt #001","7.797","3.239","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":685},{"label":"Mar","value":818},{"label":"Abr","value":687},{"label":"Mai","value":493},{"label":"Jun","value":524},{"label":"Jul","value":542},{"label":"Ago","value":500},{"label":"Set","value":805},{"label":"Out","value":827},{"label":"Nov","value":496},{"label":"Dez","value":799}];
const MX = 827;
