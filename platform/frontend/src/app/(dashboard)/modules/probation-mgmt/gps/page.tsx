...
const ACCENT = "#6366f1";
const MODULE = "Probation Management";
const PAGE = "GPS Monitor";
const KPIS = [{"l":"Total Probation Mgmt","v":"826","t":"+9.8%","d":"up"},{"l":"GPS Monitor Ativos","v":"1.279","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"70.0%","t":"+9.9%","d":"up"},{"l":"Score Performance","v":"83","t":"+6.1%","d":"up"}];
const COLS = ["ID","GPS Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Probation Mgmt #001","Probation Mgmt #002","3.793","8.669","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Probation Mgmt #002","Probation Mgmt #003","5.069","1.674","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Probation Mgmt #003","Probation Mgmt #004","6.798","7.431","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Probation Mgmt #004","Probation Mgmt #005","661","2.458","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Probation Mgmt #005","Probation Mgmt #001","8.837","7.006","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1007},{"label":"Fev","value":903},{"label":"Mar","value":652},{"label":"Abr","value":990},{"label":"Mai","value":643},{"label":"Jun","value":987},{"label":"Jul","value":759},{"label":"Ago","value":983},{"label":"Set","value":752},{"label":"Out","value":812},{"label":"Nov","value":689},{"label":"Dez","value":666}];
const MX = 1007;
