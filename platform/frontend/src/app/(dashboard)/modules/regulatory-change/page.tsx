...
/* ═══ Regulatory Change Tracker — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "2172", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "396", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€418K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2110018772", cells: ["REG-5772", "Regulatory Change Tracker Item 1", "9/9/2026", "€18 872"], status: "active" as const },
    { id: "2110022343", cells: ["REG-9343", "Regulatory Change Tracker Item 2", "24/4/2026", "€22 443"], status: "pending" as const },
    { id: "2110025914", cells: ["REG-3914", "Regulatory Change Tracker Item 3", "11/11/2026", "€26 014"], status: "completed" as const },
    { id: "2110029485", cells: ["REG-7485", "Regulatory Change Tracker Item 4", "26/6/2026", "€29 585"], status: "warning" as const },
    { id: "2110033056", cells: ["REG-2056", "Regulatory Change Tracker Item 5", "13/1/2026", "€33 156"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Regulatory Change Tracker</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Regulatory Change Tracker</p>
                    </div>
                </div>
