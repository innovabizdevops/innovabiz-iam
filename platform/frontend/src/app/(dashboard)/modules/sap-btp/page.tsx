...
/* ═══ Business Technology Platform — Dashboard ═══ */

const ACCENT = "#0070f3";

const KPIS = [
    { label: "Total Registos", value: "5438", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3665", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€472K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "785758438", cells: ["SAP-5438", "Business Technology Platform Item 1", "11/11/2026", "€8538"], status: "active" as const },
    { id: "785762009", cells: ["SAP-9009", "Business Technology Platform Item 2", "26/6/2026", "€12 109"], status: "pending" as const },
    { id: "785765580", cells: ["SAP-3580", "Business Technology Platform Item 3", "13/1/2026", "€15 680"], status: "completed" as const },
    { id: "785769151", cells: ["SAP-7151", "Business Technology Platform Item 4", "28/8/2026", "€19 251"], status: "warning" as const },
    { id: "785772722", cells: ["SAP-1722", "Business Technology Platform Item 5", "15/3/2026", "€22 822"], status: "active" as const },
];
...
export default function BusinessTechnologyPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Business Technology Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Business Technology Platform</p>
                    </div>
                </div>
