...
const ACCENT = "#0070f3";
const MODULE = "Business Technology Platform";
const PAGE = "AI";
const KPIS = [{"l":"Total Sap Btp","v":"126","t":"+14.5%","d":"up"},{"l":"AI Ativos","v":"6.518","t":"+12.0%","d":"up"},{"l":"Eficiência (%)","v":"78.1%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"79","t":"+5.7%","d":"up"}];
const COLS = ["ID","AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sap Btp #001","Sap Btp #002","8.116","1.985","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Sap Btp #002","Sap Btp #003","7.631","1.009","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Sap Btp #003","Sap Btp #004","6.693","6.620","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Sap Btp #004","Sap Btp #005","7.318","1.089","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sap Btp #005","Sap Btp #001","6.707","6.402","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":989},{"label":"Mar","value":963},{"label":"Abr","value":959},{"label":"Mai","value":1000},{"label":"Jun","value":975},{"label":"Jul","value":995},{"label":"Ago","value":966},{"label":"Set","value":819},{"label":"Out","value":871},{"label":"Nov","value":953},{"label":"Dez","value":749}];
const MX = 1000;
