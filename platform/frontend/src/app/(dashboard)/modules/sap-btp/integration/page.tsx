...
const KPIS = [{"l":"Integrações Ativas","v":"6.902","t":"+13.8%","d":"up"},{"l":"Chamadas/Hora","v":"1728","t":"+15.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"94.4%","t":"+6.4%","d":"up"},{"l":"Latência Média (ms)","v":"36ms","t":"+11.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","712","3.499","88.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.712","6.120","86.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.724","7.323","82.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","679","2.773","94.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.365","5.159","81.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":603},{"label":"Mar","value":691},{"label":"Abr","value":452},{"label":"Mai","value":400},{"label":"Jun","value":637},{"label":"Jul","value":543},{"label":"Ago","value":641},{"label":"Set","value":649},{"label":"Out","value":479},{"label":"Nov","value":498},{"label":"Dez","value":719}];
const MX = 719;
