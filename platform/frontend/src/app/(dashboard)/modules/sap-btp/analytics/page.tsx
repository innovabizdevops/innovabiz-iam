...
const KPIS = [{"l":"Dashboards Ativos","v":"6.558","t":"+12.7%","d":"up"},{"l":"Queries/Dia","v":"338","t":"+14.5%","d":"up"},{"l":"Dados Processados (GB)","v":"5.957","t":"-1.4%","d":"down"},{"l":"Utilizadores Analytics","v":"7.770","t":"+11.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1628","2026-02-22","7.339","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4530","2026-03-13","2.761","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","917","2026-01-12","7.825","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1184","2026-02-18","2.887","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","218","2026-01-25","3.172","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":490},{"label":"Fev","value":462},{"label":"Mar","value":513},{"label":"Abr","value":551},{"label":"Mai","value":369},{"label":"Jun","value":578},{"label":"Jul","value":575},{"label":"Ago","value":263},{"label":"Set","value":362},{"label":"Out","value":556},{"label":"Nov","value":377},{"label":"Dez","value":261}];
const MX = 578;
