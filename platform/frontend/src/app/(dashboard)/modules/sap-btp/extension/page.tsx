...
const KPIS = [{"l":"Total Sap Btp","v":"7.734","t":"+0.1%","d":"up"},{"l":"Extension Ativos","v":"4.509","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"73.7%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"88","t":"+4.4%","d":"up"}];
const COLS = ["ID","Extension","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sap Btp #001","Sap Btp #002","6.847","1.098","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Sap Btp #002","Sap Btp #003","7.880","6.923","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Sap Btp #003","Sap Btp #004","6.248","3.394","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Sap Btp #004","Sap Btp #005","7.041","7.678","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sap Btp #005","Sap Btp #001","508","4.491","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":487},{"label":"Mar","value":615},{"label":"Abr","value":403},{"label":"Mai","value":637},{"label":"Jun","value":619},{"label":"Jul","value":731},{"label":"Ago","value":421},{"label":"Set","value":431},{"label":"Out","value":668},{"label":"Nov","value":549},{"label":"Dez","value":427}];
const MX = 731;
