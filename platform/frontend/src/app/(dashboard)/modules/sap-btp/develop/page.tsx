...
const PAGE = "Develop";
const KPIS = [{"l":"Total Sap Btp","v":"7.988","t":"+0.3%","d":"up"},{"l":"Develop Ativos","v":"4.749","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"68.7%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"74","t":"+17.4%","d":"up"}];
const COLS = ["ID","Develop","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sap Btp #001","Sap Btp #002","3.301","3.633","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Sap Btp #002","Sap Btp #003","6.104","803","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Sap Btp #003","Sap Btp #004","7.460","4.531","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Sap Btp #004","Sap Btp #005","7.530","7.347","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sap Btp #005","Sap Btp #001","5.451","3.498","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":254},{"label":"Fev","value":631},{"label":"Mar","value":488},{"label":"Abr","value":376},{"label":"Mai","value":624},{"label":"Jun","value":303},{"label":"Jul","value":271},{"label":"Ago","value":539},{"label":"Set","value":277},{"label":"Out","value":430},{"label":"Nov","value":386},{"label":"Dez","value":438}];
const MX = 631;
