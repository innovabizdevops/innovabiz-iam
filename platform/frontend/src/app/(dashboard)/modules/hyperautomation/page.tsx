...
/* ═══ Hyperautomation Engine — Dashboard ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total Registos", value: "6834", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3802", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€444K", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2121358934", cells: ["HYP-5934", "Hyperautomation Engine Item 1", "3/3/2026", "€9034"], status: "active" as const },
    { id: "2121362505", cells: ["HYP-9505", "Hyperautomation Engine Item 2", "18/10/2026", "€12 605"], status: "pending" as const },
    { id: "2121366076", cells: ["HYP-4076", "Hyperautomation Engine Item 3", "5/5/2026", "€16 176"], status: "completed" as const },
    { id: "2121369647", cells: ["HYP-7647", "Hyperautomation Engine Item 4", "20/12/2026", "€19 747"], status: "warning" as const },
    { id: "2121373218", cells: ["HYP-2218", "Hyperautomation Engine Item 5", "7/7/2026", "€23 318"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Hyperautomation Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Hyperautomation Engine</p>
                    </div>
                </div>
