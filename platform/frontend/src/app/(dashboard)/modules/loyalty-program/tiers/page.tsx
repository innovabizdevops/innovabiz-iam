...
const PAGE = "Tiers";
const KPIS = [{"l":"ARR (€M)","v":"€39.5M","t":"+3.5%","d":"up"},{"l":"MRR (€)","v":"€91600","t":"-5.1%","d":"down"},{"l":"Churn (%)","v":"68.2%","t":"+16.1%","d":"up"},{"l":"ARPU (€)","v":"€67161","t":"+15.4%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 40530.51","6.115","€ 38541.26","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 26091.48","7.150","€ 19502.33","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 10906.32","8.842","€ 46446.84","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 47444.82","1.990","€ 13082.76","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 42615.54","219","€ 34644.25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":975},{"label":"Mar","value":712},{"label":"Abr","value":735},{"label":"Mai","value":786},{"label":"Jun","value":761},{"label":"Jul","value":890},{"label":"Ago","value":943},{"label":"Set","value":870},{"label":"Out","value":771},{"label":"Nov","value":715},{"label":"Dez","value":668}];
const MX = 975;
