...
const ACCENT = "#6366f1";
const MODULE = "Loyalty Program";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"1.629","t":"+6.4%","d":"up"},{"l":"Queries/Dia","v":"240","t":"+9.9%","d":"up"},{"l":"Dados Processados (GB)","v":"4.331","t":"+13.0%","d":"up"},{"l":"Utilizadores Analytics","v":"8.281","t":"+4.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3108","2026-02-27","2.771","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2867","2026-02-18","8.116","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","676","2026-01-25","6.279","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","424","2026-02-16","4.122","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3099","2026-03-18","8.712","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":768},{"label":"Mar","value":437},{"label":"Abr","value":773},{"label":"Mai","value":608},{"label":"Jun","value":770},{"label":"Jul","value":567},{"label":"Ago","value":704},{"label":"Set","value":562},{"label":"Out","value":430},{"label":"Nov","value":583},{"label":"Dez","value":714}];
const MX = 773;
