...
const PAGE = "Campaign";
const KPIS = [{"l":"Total Loyalty Program","v":"4.448","t":"-2.7%","d":"down"},{"l":"Campaign Ativos","v":"4.505","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"74.9%","t":"+16.3%","d":"up"},{"l":"Score Performance","v":"86","t":"+10.5%","d":"up"}];
const COLS = ["ID","Campaign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Loyalty Program #001","Loyalty Program #002","6.404","5.062","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Loyalty Program #002","Loyalty Program #003","3.000","3.127","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Loyalty Program #003","Loyalty Program #004","6.315","5.261","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Loyalty Program #004","Loyalty Program #005","5.683","2.813","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Loyalty Program #005","Loyalty Program #001","1.256","983","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":835},{"label":"Fev","value":761},{"label":"Mar","value":638},{"label":"Abr","value":927},{"label":"Mai","value":703},{"label":"Jun","value":980},{"label":"Jul","value":886},{"label":"Ago","value":961},{"label":"Set","value":828},{"label":"Out","value":668},{"label":"Nov","value":958},{"label":"Dez","value":927}];
const MX = 980;
