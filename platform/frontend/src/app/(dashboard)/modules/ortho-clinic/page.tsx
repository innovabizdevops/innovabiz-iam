...
/* ═══ Orthopaedic Clinic — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "9268", trend: "-19%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2497", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€412K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "-1%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "104147268", cells: ["ORT-9268", "Orthopaedic Clinic Item 1", "9/1/2026", "€47 368"], status: "active" as const },
    { id: "104150839", cells: ["ORT-3839", "Orthopaedic Clinic Item 2", "24/8/2026", "€939"], status: "pending" as const },
    { id: "104154410", cells: ["ORT-7410", "Orthopaedic Clinic Item 3", "11/3/2026", "€4510"], status: "completed" as const },
    { id: "104157981", cells: ["ORT-1981", "Orthopaedic Clinic Item 4", "26/10/2026", "€8081"], status: "warning" as const },
    { id: "104161552", cells: ["ORT-5552", "Orthopaedic Clinic Item 5", "13/5/2026", "€11 652"], status: "active" as const },
];
...
export default function OrthopaedicClinicPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Orthopaedic Clinic</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Orthopaedic Clinic</p>
                    </div>
                </div>
