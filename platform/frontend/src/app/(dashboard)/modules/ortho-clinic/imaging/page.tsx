...
const PAGE = "Imaging";
const KPIS = [{"l":"Total Ortho Clinic","v":"1.777","t":"+4.2%","d":"up"},{"l":"Imaging Ativos","v":"4.508","t":"+0.4%","d":"up"},{"l":"Eficiência (%)","v":"80.1%","t":"+12.2%","d":"up"},{"l":"Score Performance","v":"80","t":"+1.9%","d":"up"}];
const COLS = ["ID","Imaging","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ortho Clinic #001","Ortho Clinic #002","8.201","8.772","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Ortho Clinic #002","Ortho Clinic #003","4.725","3.304","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Ortho Clinic #003","Ortho Clinic #004","3.316","647","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Ortho Clinic #004","Ortho Clinic #005","1.239","512","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ortho Clinic #005","Ortho Clinic #001","7.971","947","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1057},{"label":"Fev","value":725},{"label":"Mar","value":951},{"label":"Abr","value":1031},{"label":"Mai","value":812},{"label":"Jun","value":768},{"label":"Jul","value":1002},{"label":"Ago","value":976},{"label":"Set","value":828},{"label":"Out","value":768},{"label":"Nov","value":1011},{"label":"Dez","value":877}];
const MX = 1057;
