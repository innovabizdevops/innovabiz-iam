...
const PAGE = "Surgery";
const KPIS = [{"l":"Total Ortho Clinic","v":"470","t":"+12.5%","d":"up"},{"l":"Surgery Ativos","v":"6.648","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"77.9%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"84","t":"+15.4%","d":"up"}];
const COLS = ["ID","Surgery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ortho Clinic #001","Ortho Clinic #002","3.195","5.784","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Ortho Clinic #002","Ortho Clinic #003","8.436","2.368","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Ortho Clinic #003","Ortho Clinic #004","694","8.196","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Ortho Clinic #004","Ortho Clinic #005","6.985","7.241","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ortho Clinic #005","Ortho Clinic #001","5.315","8.105","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":656},{"label":"Mar","value":495},{"label":"Abr","value":688},{"label":"Mai","value":600},{"label":"Jun","value":689},{"label":"Jul","value":691},{"label":"Ago","value":655},{"label":"Set","value":643},{"label":"Out","value":749},{"label":"Nov","value":793},{"label":"Dez","value":569}];
const MX = 839;
