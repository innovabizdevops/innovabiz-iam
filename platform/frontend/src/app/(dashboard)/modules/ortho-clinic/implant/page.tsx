...
const ACCENT = "#1e293b";
const MODULE = "Orthopaedic Clinic";
const PAGE = "Implant";
const KPIS = [{"l":"Total Ortho Clinic","v":"1.516","t":"-3.2%","d":"down"},{"l":"Implant Ativos","v":"4.642","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"75.6%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"86","t":"+14.3%","d":"up"}];
const COLS = ["ID","Implant","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ortho Clinic #001","Ortho Clinic #002","6.876","7.184","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Ortho Clinic #002","Ortho Clinic #003","6.131","1.248","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Ortho Clinic #003","Ortho Clinic #004","3.937","1.552","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Ortho Clinic #004","Ortho Clinic #005","4.406","8.615","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ortho Clinic #005","Ortho Clinic #001","7.362","3.307","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":625},{"label":"Mar","value":763},{"label":"Abr","value":669},{"label":"Mai","value":534},{"label":"Jun","value":869},{"label":"Jul","value":658},{"label":"Ago","value":688},{"label":"Set","value":761},{"label":"Out","value":735},{"label":"Nov","value":723},{"label":"Dez","value":659}];
const MX = 869;
