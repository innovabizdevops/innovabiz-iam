...
const PAGE = "Segment";
const KPIS = [{"l":"Dashboards Ativos","v":"2.880","t":"+6.4%","d":"up"},{"l":"Queries/Dia","v":"2849","t":"+17.3%","d":"up"},{"l":"Dados Processados (GB)","v":"3.895","t":"+15.5%","d":"up"},{"l":"Utilizadores Analytics","v":"4.053","t":"+3.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","998","2026-02-18","3.109","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3871","2026-02-14","618","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4997","2026-02-10","867","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1986","2026-02-07","9.087","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","753","2026-02-17","6.719","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":963},{"label":"Fev","value":887},{"label":"Mar","value":692},{"label":"Abr","value":793},{"label":"Mai","value":582},{"label":"Jun","value":929},{"label":"Jul","value":832},{"label":"Ago","value":837},{"label":"Set","value":734},{"label":"Out","value":882},{"label":"Nov","value":661},{"label":"Dez","value":602}];
const MX = 963;
