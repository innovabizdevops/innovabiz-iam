...
const PAGE = "Privacy";
const KPIS = [{"l":"Dashboards Ativos","v":"4.818","t":"+10.8%","d":"up"},{"l":"Queries/Dia","v":"3072","t":"+10.9%","d":"up"},{"l":"Dados Processados (GB)","v":"1.752","t":"+14.6%","d":"up"},{"l":"Utilizadores Analytics","v":"3.763","t":"+17.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1360","2026-02-25","119","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4912","2026-01-04","8.677","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3365","2026-02-20","2.287","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2157","2026-01-16","1.071","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3415","2026-03-01","1.418","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":414},{"label":"Fev","value":451},{"label":"Mar","value":656},{"label":"Abr","value":471},{"label":"Mai","value":643},{"label":"Jun","value":333},{"label":"Jul","value":559},{"label":"Ago","value":587},{"label":"Set","value":449},{"label":"Out","value":585},{"label":"Nov","value":594},{"label":"Dez","value":650}];
const MX = 656;
