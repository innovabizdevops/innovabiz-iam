...
const PAGE = "Event";
const KPIS = [{"l":"Dashboards Ativos","v":"7.371","t":"+6.0%","d":"up"},{"l":"Queries/Dia","v":"3283","t":"+13.9%","d":"up"},{"l":"Dados Processados (GB)","v":"4.544","t":"-0.6%","d":"down"},{"l":"Utilizadores Analytics","v":"4.915","t":"+13.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","494","2026-03-04","3.385","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","922","2026-02-26","5.713","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1400","2026-01-16","3.009","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1383","2026-03-05","5.976","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1246","2026-02-28","3.882","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":785},{"label":"Mar","value":786},{"label":"Abr","value":874},{"label":"Mai","value":673},{"label":"Jun","value":691},{"label":"Jul","value":822},{"label":"Ago","value":638},{"label":"Set","value":722},{"label":"Out","value":883},{"label":"Nov","value":793},{"label":"Dez","value":781}];
const MX = 907;
