...
const PAGE = "Report";
const KPIS = [{"l":"Dashboards Ativos","v":"8.091","t":"+3.1%","d":"up"},{"l":"Queries/Dia","v":"877","t":"+0.8%","d":"up"},{"l":"Dados Processados (GB)","v":"1.674","t":"-2.5%","d":"down"},{"l":"Utilizadores Analytics","v":"8.169","t":"-0.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3764","2026-03-05","6.983","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","826","2026-01-25","4.311","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4149","2026-03-11","8.860","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4208","2026-02-21","6.887","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","973","2026-03-24","3.810","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":365},{"label":"Fev","value":307},{"label":"Mar","value":424},{"label":"Abr","value":476},{"label":"Mai","value":588},{"label":"Jun","value":487},{"label":"Jul","value":316},{"label":"Ago","value":511},{"label":"Set","value":425},{"label":"Out","value":413},{"label":"Nov","value":624},{"label":"Dez","value":639}];
const MX = 639;
