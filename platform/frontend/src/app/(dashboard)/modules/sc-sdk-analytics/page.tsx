...
/* ═══ SC: SDK Analytics — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "727", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "448", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€39K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "454648227", cells: ["SC-5227", "SC: SDK Analytics Item 1", "20/4/2026", "€48 327"], status: "active" as const },
    { id: "454651798", cells: ["SC-8798", "SC: SDK Analytics Item 2", "7/11/2026", "€1898"], status: "pending" as const },
    { id: "454655369", cells: ["SC-3369", "SC: SDK Analytics Item 3", "22/6/2026", "€5469"], status: "completed" as const },
    { id: "454658940", cells: ["SC-6940", "SC: SDK Analytics Item 4", "9/1/2026", "€9040"], status: "warning" as const },
    { id: "454662511", cells: ["SC-1511", "SC: SDK Analytics Item 5", "24/8/2026", "€12 611"], status: "active" as const },
];
...
export default function ScSdkAnalyticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: SDK Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: SDK Analytics</p>
                    </div>
                </div>
