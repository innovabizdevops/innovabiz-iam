...
const ACCENT = "#0284c7";
const MODULE = "SC: SDK Analytics";
const PAGE = "Track";
const KPIS = [{"l":"Dashboards Ativos","v":"3.994","t":"+12.9%","d":"up"},{"l":"Queries/Dia","v":"4562","t":"+11.6%","d":"up"},{"l":"Dados Processados (GB)","v":"6.686","t":"-2.2%","d":"down"},{"l":"Utilizadores Analytics","v":"4.781","t":"+17.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3300","2026-02-17","1.178","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5019","2026-02-19","5.523","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4644","2026-03-20","5.197","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1803","2026-01-13","8.361","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1392","2026-02-22","6.297","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":857},{"label":"Mar","value":524},{"label":"Abr","value":675},{"label":"Mai","value":851},{"label":"Jun","value":823},{"label":"Jul","value":618},{"label":"Ago","value":701},{"label":"Set","value":867},{"label":"Out","value":795},{"label":"Nov","value":816},{"label":"Dez","value":747}];
const MX = 867;
