...
const KPIS = [
    { label: "Total Registos", value: "9315", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4055", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€470K", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1095711515", cells: ["MIG-7515", "Migration Center Item 1", "4/12/2026", "€11 615"], status: "active" as const },
    { id: "1095715086", cells: ["MIG-2086", "Migration Center Item 2", "19/7/2026", "€15 186"], status: "pending" as const },
    { id: "1095718657", cells: ["MIG-5657", "Migration Center Item 3", "6/2/2026", "€18 757"], status: "completed" as const },
    { id: "1095722228", cells: ["MIG-9228", "Migration Center Item 4", "21/9/2026", "€22 328"], status: "warning" as const },
    { id: "1095725799", cells: ["MIG-3799", "Migration Center Item 5", "8/4/2026", "€25 899"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Migration Center</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Migration Center</p>
                    </div>
                </div>
