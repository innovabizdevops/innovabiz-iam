...
const PAGE = "Migrate";
const KPIS = [{"l":"Total Migration Center","v":"6.930","t":"-0.4%","d":"down"},{"l":"Migrate Ativos","v":"7.780","t":"-5.9%","d":"down"},{"l":"Eficiência (%)","v":"74.7%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"65","t":"+4.2%","d":"up"}];
const COLS = ["ID","Migrate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Migration Center #001","Migration Center #002","4.080","7.152","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Migration Center #002","Migration Center #003","7.294","985","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Migration Center #003","Migration Center #004","7.860","3.777","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Migration Center #004","Migration Center #005","5.519","7.055","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Migration Center #005","Migration Center #001","3.050","5.185","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":705},{"label":"Mar","value":686},{"label":"Abr","value":989},{"label":"Mai","value":847},{"label":"Jun","value":979},{"label":"Jul","value":839},{"label":"Ago","value":710},{"label":"Set","value":811},{"label":"Out","value":708},{"label":"Nov","value":807},{"label":"Dez","value":734}];
const MX = 989;
