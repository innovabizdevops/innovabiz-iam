...
const PAGE = "Report";
const KPIS = [{"l":"Total Migration Center","v":"1.837","t":"+13.9%","d":"up"},{"l":"Report Ativos","v":"7.091","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"71.3%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"75","t":"-2.4%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Migration Center #001","Migration Center #002","9.086","6.298","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Migration Center #002","Migration Center #003","6.485","527","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Migration Center #003","Migration Center #004","8.875","744","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Migration Center #004","Migration Center #005","670","2.197","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Migration Center #005","Migration Center #001","3.941","7.156","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":492},{"label":"Mar","value":769},{"label":"Abr","value":548},{"label":"Mai","value":699},{"label":"Jun","value":591},{"label":"Jul","value":395},{"label":"Ago","value":664},{"label":"Set","value":650},{"label":"Out","value":629},{"label":"Nov","value":412},{"label":"Dez","value":722}];
const MX = 769;
