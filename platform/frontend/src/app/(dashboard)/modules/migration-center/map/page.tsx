...
const PAGE = "Map";
const KPIS = [{"l":"Total Migration Center","v":"5.681","t":"-0.4%","d":"down"},{"l":"Map Ativos","v":"4.739","t":"+0.6%","d":"up"},{"l":"Eficiência (%)","v":"80.2%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"72","t":"+11.4%","d":"up"}];
const COLS = ["ID","Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Migration Center #001","Migration Center #002","8.552","6.772","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Migration Center #002","Migration Center #003","511","3.646","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Migration Center #003","Migration Center #004","6.575","3.918","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Migration Center #004","Migration Center #005","292","2.582","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Migration Center #005","Migration Center #001","8.350","4.404","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":338},{"label":"Mar","value":429},{"label":"Abr","value":360},{"label":"Mai","value":359},{"label":"Jun","value":581},{"label":"Jul","value":307},{"label":"Ago","value":432},{"label":"Set","value":358},{"label":"Out","value":482},{"label":"Nov","value":272},{"label":"Dez","value":536}];
const MX = 581;
