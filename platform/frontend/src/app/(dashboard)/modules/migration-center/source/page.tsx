...
const ACCENT = "#059669";
const MODULE = "Migration Center";
const PAGE = "Source";
const KPIS = [{"l":"Total Migration Center","v":"5.200","t":"+17.6%","d":"up"},{"l":"Source Ativos","v":"3.077","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"76.8%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"59","t":"+6.7%","d":"up"}];
const COLS = ["ID","Source","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Migration Center #001","Migration Center #002","6.794","3.431","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Migration Center #002","Migration Center #003","8.582","4.508","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Migration Center #003","Migration Center #004","8.501","8.302","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Migration Center #004","Migration Center #005","8.242","5.517","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Migration Center #005","Migration Center #001","7.831","3.715","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":445},{"label":"Fev","value":442},{"label":"Mar","value":482},{"label":"Abr","value":556},{"label":"Mai","value":332},{"label":"Jun","value":584},{"label":"Jul","value":575},{"label":"Ago","value":564},{"label":"Set","value":284},{"label":"Out","value":543},{"label":"Nov","value":312},{"label":"Dez","value":385}];
const MX = 584;
