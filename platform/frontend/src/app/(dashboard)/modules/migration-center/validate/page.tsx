...
const PAGE = "Validate";
const KPIS = [{"l":"Total Migration Center","v":"6.340","t":"+5.5%","d":"up"},{"l":"Validate Ativos","v":"7.569","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"82.3%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"63","t":"+8.2%","d":"up"}];
const COLS = ["ID","Validate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Migration Center #001","Migration Center #002","3.625","4.416","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Migration Center #002","Migration Center #003","6.465","4.155","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Migration Center #003","Migration Center #004","4.083","1.321","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Migration Center #004","Migration Center #005","6.272","2.002","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Migration Center #005","Migration Center #001","8.731","502","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":615},{"label":"Mar","value":576},{"label":"Abr","value":401},{"label":"Mai","value":381},{"label":"Jun","value":551},{"label":"Jul","value":644},{"label":"Ago","value":509},{"label":"Set","value":400},{"label":"Out","value":491},{"label":"Nov","value":416},{"label":"Dez","value":587}];
const MX = 682;
