...
const PAGE = "UAV";
const KPIS = [{"l":"Total Air Force Ops","v":"5.668","t":"+0.5%","d":"up"},{"l":"UAV Ativos","v":"4.783","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"75.3%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"83","t":"+1.1%","d":"up"}];
const COLS = ["ID","UAV","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Air Force Ops #001","Air Force Ops #002","7.890","8.231","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Air Force Ops #002","Air Force Ops #003","5.344","9.084","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Air Force Ops #003","Air Force Ops #004","4.983","8.360","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Air Force Ops #004","Air Force Ops #005","741","2.368","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Air Force Ops #005","Air Force Ops #001","1.873","2.565","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":961},{"label":"Fev","value":920},{"label":"Mar","value":1028},{"label":"Abr","value":795},{"label":"Mai","value":656},{"label":"Jun","value":767},{"label":"Jul","value":973},{"label":"Ago","value":730},{"label":"Set","value":785},{"label":"Out","value":729},{"label":"Nov","value":1007},{"label":"Dez","value":809}];
const MX = 1028;
