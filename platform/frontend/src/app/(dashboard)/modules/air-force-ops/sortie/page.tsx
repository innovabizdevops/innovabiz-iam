...
const PAGE = "Sortie";
const KPIS = [{"l":"Total Air Force Ops","v":"8.704","t":"+8.1%","d":"up"},{"l":"Sortie Ativos","v":"6.187","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"78.7%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"75","t":"+1.5%","d":"up"}];
const COLS = ["ID","Sortie","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Air Force Ops #001","Air Force Ops #002","1.483","7.851","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Air Force Ops #002","Air Force Ops #003","2.735","5.831","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Air Force Ops #003","Air Force Ops #004","1.366","6.862","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Air Force Ops #004","Air Force Ops #005","8.197","3.226","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Air Force Ops #005","Air Force Ops #001","4.729","8.930","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":632},{"label":"Mar","value":806},{"label":"Abr","value":825},{"label":"Mai","value":748},{"label":"Jun","value":590},{"label":"Jul","value":669},{"label":"Ago","value":671},{"label":"Set","value":890},{"label":"Out","value":747},{"label":"Nov","value":765},{"label":"Dez","value":586}];
const MX = 907;
