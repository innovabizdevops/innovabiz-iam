...
/* ═══ Air Force Operations — Dashboard ═══ */

const ACCENT = "#475569";

const KPIS = [
    { label: "Total Registos", value: "2180", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3965", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€94K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "300021580", cells: ["AIR-7580", "Air Force Operations Item 1", "13/5/2026", "€21 680"], status: "active" as const },
    { id: "300025151", cells: ["AIR-2151", "Air Force Operations Item 2", "28/12/2026", "€25 251"], status: "pending" as const },
    { id: "300028722", cells: ["AIR-5722", "Air Force Operations Item 3", "15/7/2026", "€28 822"], status: "completed" as const },
    { id: "300032293", cells: ["AIR-9293", "Air Force Operations Item 4", "2/2/2026", "€32 393"], status: "warning" as const },
    { id: "300035864", cells: ["AIR-3864", "Air Force Operations Item 5", "17/9/2026", "€35 964"], status: "active" as const },
];
...
export default function AirForceOperationsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Air Force Operations</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Air Force Operations</p>
                    </div>
                </div>
