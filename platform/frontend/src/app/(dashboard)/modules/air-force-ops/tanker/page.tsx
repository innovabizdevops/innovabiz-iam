...
const PAGE = "Tanker";
const KPIS = [{"l":"Total Air Force Ops","v":"3.350","t":"+6.1%","d":"up"},{"l":"Tanker Ativos","v":"7.806","t":"+15.8%","d":"up"},{"l":"Eficiência (%)","v":"93.9%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"68","t":"+15.5%","d":"up"}];
const COLS = ["ID","Tanker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Air Force Ops #001","Air Force Ops #002","6.475","5.766","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Air Force Ops #002","Air Force Ops #003","3.279","7.252","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Air Force Ops #003","Air Force Ops #004","2.192","3.683","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Air Force Ops #004","Air Force Ops #005","6.131","3.997","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Air Force Ops #005","Air Force Ops #001","4.795","2.271","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":361},{"label":"Fev","value":452},{"label":"Mar","value":306},{"label":"Abr","value":506},{"label":"Mai","value":405},{"label":"Jun","value":273},{"label":"Jul","value":511},{"label":"Ago","value":595},{"label":"Set","value":396},{"label":"Out","value":283},{"label":"Nov","value":432},{"label":"Dez","value":343}];
const MX = 595;
