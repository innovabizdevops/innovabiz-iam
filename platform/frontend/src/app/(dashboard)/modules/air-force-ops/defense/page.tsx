...
const ACCENT = "#475569";
const MODULE = "Air Force Operations";
const PAGE = "Air Defense";
const KPIS = [{"l":"Total Air Force Ops","v":"4.282","t":"+1.0%","d":"up"},{"l":"Air Defense Ativos","v":"5.470","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"87.3%","t":"+15.3%","d":"up"},{"l":"Score Performance","v":"87","t":"+9.7%","d":"up"}];
const COLS = ["ID","Air Defense","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Air Force Ops #001","Air Force Ops #002","8.950","6.044","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Air Force Ops #002","Air Force Ops #003","3.229","869","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Air Force Ops #003","Air Force Ops #004","5.895","2.932","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Air Force Ops #004","Air Force Ops #005","3.365","6.441","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Air Force Ops #005","Air Force Ops #001","5.252","4.992","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":749},{"label":"Mar","value":955},{"label":"Abr","value":869},{"label":"Mai","value":793},{"label":"Jun","value":900},{"label":"Jul","value":1033},{"label":"Ago","value":999},{"label":"Set","value":1041},{"label":"Out","value":1005},{"label":"Nov","value":895},{"label":"Dez","value":887}];
const MX = 1041;
