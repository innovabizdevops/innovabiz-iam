...
const KPIS = [{"l":"Projetos Sociais","v":"6.083","t":"+9.3%","d":"up"},{"l":"Beneficiários","v":"6.698","t":"+1.1%","d":"up"},{"l":"Investimento CSR (€)","v":"€25061","t":"-6.0%","d":"down"},{"l":"Score Impacto","v":"84","t":"+9.4%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","3.719","€ 42435.62","2.233","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","2.044","€ 30486.54","785","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","4.846","€ 7142.07","2.472","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","6.061","€ 39978.26","6.414","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","6.275","€ 23349.50","2.267","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":344},{"label":"Mar","value":397},{"label":"Abr","value":364},{"label":"Mai","value":394},{"label":"Jun","value":610},{"label":"Jul","value":378},{"label":"Ago","value":426},{"label":"Set","value":714},{"label":"Out","value":585},{"label":"Nov","value":597},{"label":"Dez","value":665}];
const MX = 714;
