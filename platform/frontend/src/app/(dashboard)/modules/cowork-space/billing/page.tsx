...
const PAGE = "Billing";
const KPIS = [{"l":"Quartos Ocupados","v":"6.674","t":"+16.3%","d":"up"},{"l":"RevPAR (€)","v":"€94590","t":"+0.5%","d":"up"},{"l":"Ocupação (%)","v":"81.2%","t":"+4.9%","d":"up"},{"l":"Guest Satisfaction","v":"1.447","t":"+9.0%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.677","2026-01-22","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","145","2026-03-19","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.512","2026-02-28","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.291","2026-03-12","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.629","2026-03-09","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":831},{"label":"Fev","value":779},{"label":"Mar","value":967},{"label":"Abr","value":718},{"label":"Mai","value":992},{"label":"Jun","value":1013},{"label":"Jul","value":648},{"label":"Ago","value":981},{"label":"Set","value":825},{"label":"Out","value":899},{"label":"Nov","value":839},{"label":"Dez","value":871}];
const MX = 1013;
