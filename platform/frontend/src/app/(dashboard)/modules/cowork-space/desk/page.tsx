...
const PAGE = "Desk";
const KPIS = [{"l":"Quartos Ocupados","v":"3.561","t":"+7.5%","d":"up"},{"l":"RevPAR (€)","v":"€65177","t":"+13.9%","d":"up"},{"l":"Ocupação (%)","v":"76.5%","t":"+5.7%","d":"up"},{"l":"Guest Satisfaction","v":"8.396","t":"+17.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","5.609","2026-03-18","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","120","2026-01-28","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.004","2026-03-12","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.195","2026-03-14","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","569","2026-02-20","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":987},{"label":"Mar","value":852},{"label":"Abr","value":963},{"label":"Mai","value":992},{"label":"Jun","value":1033},{"label":"Jul","value":789},{"label":"Ago","value":1060},{"label":"Set","value":996},{"label":"Out","value":1021},{"label":"Nov","value":1007},{"label":"Dez","value":684}];
const MX = 1060;
