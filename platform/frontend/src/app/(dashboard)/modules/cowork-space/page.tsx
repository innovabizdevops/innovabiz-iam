...
const KPIS = [
    { label: "Total Registos", value: "6291", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "337", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€180K", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1412369891", cells: ["COW-9891", "Coworking Space Item 1", "24/12/2026", "€19 991"], status: "active" as const },
    { id: "1412373462", cells: ["COW-4462", "Coworking Space Item 2", "11/7/2026", "€23 562"], status: "pending" as const },
    { id: "1412377033", cells: ["COW-8033", "Coworking Space Item 3", "26/2/2026", "€27 133"], status: "completed" as const },
    { id: "1412380604", cells: ["COW-2604", "Coworking Space Item 4", "13/9/2026", "€30 704"], status: "warning" as const },
    { id: "1412384175", cells: ["COW-6175", "Coworking Space Item 5", "28/4/2026", "€34 275"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Coworking Space</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Coworking Space</p>
                    </div>
                </div>
