...
const KPIS = [{"l":"ARR (€M)","v":"€48.7M","t":"+13.8%","d":"up"},{"l":"MRR (€)","v":"€47298","t":"+4.5%","d":"up"},{"l":"Churn (%)","v":"84.6%","t":"-5.1%","d":"down"},{"l":"ARPU (€)","v":"€77422","t":"+9.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 4940.44","1.812","€ 3752.12","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 4222.40","4.213","€ 8530.38","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 12009.17","7.138","€ 30460.83","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 4397.00","5.663","€ 16243.84","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 47898.85","2.049","€ 25276.31","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":885},{"label":"Mar","value":814},{"label":"Abr","value":805},{"label":"Mai","value":880},{"label":"Jun","value":677},{"label":"Jul","value":812},{"label":"Ago","value":822},{"label":"Set","value":635},{"label":"Out","value":673},{"label":"Nov","value":951},{"label":"Dez","value":883}];
const MX = 951;
