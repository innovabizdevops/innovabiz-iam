...
const ACCENT = "#dc2626";
const MODULE = "Revenue Recognition";
const PAGE = "IFRS 15";
const KPIS = [{"l":"ARR (€M)","v":"€45.9M","t":"+1.3%","d":"up"},{"l":"MRR (€)","v":"€43493","t":"+5.1%","d":"up"},{"l":"Churn (%)","v":"74.4%","t":"-1.5%","d":"down"},{"l":"ARPU (€)","v":"€91438","t":"+17.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 48257.91","8.507","€ 9851.76","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 29981.14","6.064","€ 26992.66","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 16312.95","3.764","€ 18761.08","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 43149.88","1.274","€ 15613.63","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 47500.56","2.137","€ 49105.73","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":306},{"label":"Mar","value":451},{"label":"Abr","value":544},{"label":"Mai","value":325},{"label":"Jun","value":403},{"label":"Jul","value":348},{"label":"Ago","value":500},{"label":"Set","value":408},{"label":"Out","value":377},{"label":"Nov","value":487},{"label":"Dez","value":449}];
const MX = 544;
