...
const PAGE = "ASC 606 Rules";
const KPIS = [{"l":"ARR (€M)","v":"€38.0M","t":"+6.8%","d":"up"},{"l":"MRR (€)","v":"€76147","t":"+7.7%","d":"up"},{"l":"Churn (%)","v":"92.6%","t":"+12.8%","d":"up"},{"l":"ARPU (€)","v":"€75899","t":"+4.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 28948.57","6.659","€ 23474.70","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 25965.23","7.615","€ 17771.85","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 6214.38","4.097","€ 21958.94","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 33530.79","3.597","€ 2287.51","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 24731.35","7.409","€ 24511.96","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":728},{"label":"Mar","value":666},{"label":"Abr","value":771},{"label":"Mai","value":694},{"label":"Jun","value":745},{"label":"Jul","value":710},{"label":"Ago","value":783},{"label":"Set","value":564},{"label":"Out","value":423},{"label":"Nov","value":757},{"label":"Dez","value":573}];
const MX = 783;
...
export default function Asc606Page() {
    return (
