...
export default function RevenueRecogPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Revenue Recog</h1><p className="text-sm text-muted-foreground">Revenue Recog • iBOS Enterprise</p></div>
