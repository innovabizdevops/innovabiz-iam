...
const PAGE = "Contract Mod";
const KPIS = [{"l":"ARR (€M)","v":"€21.6M","t":"+9.9%","d":"up"},{"l":"MRR (€)","v":"€94177","t":"+14.7%","d":"up"},{"l":"Churn (%)","v":"79.5%","t":"+7.1%","d":"up"},{"l":"ARPU (€)","v":"€80515","t":"+13.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 45101.79","2.250","€ 769.41","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 35352.63","2.363","€ 4598.01","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 24314.94","1.907","€ 7714.23","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 44494.78","3.870","€ 8123.51","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 13622.18","1.396","€ 32558.01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":895},{"label":"Fev","value":836},{"label":"Mar","value":955},{"label":"Abr","value":819},{"label":"Mai","value":776},{"label":"Jun","value":808},{"label":"Jul","value":900},{"label":"Ago","value":891},{"label":"Set","value":725},{"label":"Out","value":649},{"label":"Nov","value":775},{"label":"Dez","value":938}];
const MX = 955;
