...
const PAGE = "Deferral";
const KPIS = [{"l":"ARR (€M)","v":"€8.1M","t":"+6.7%","d":"up"},{"l":"MRR (€)","v":"€28035","t":"+17.1%","d":"up"},{"l":"Churn (%)","v":"79.9%","t":"-5.4%","d":"down"},{"l":"ARPU (€)","v":"€85178","t":"-0.9%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 42220.69","329","€ 17936.14","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 8844.19","7.500","€ 7343.65","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 11187.50","9.039","€ 33403.56","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 5567.40","7.456","€ 42943.21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 30276.44","6.426","€ 35297.88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":858},{"label":"Fev","value":932},{"label":"Mar","value":1000},{"label":"Abr","value":700},{"label":"Mai","value":801},{"label":"Jun","value":927},{"label":"Jul","value":874},{"label":"Ago","value":663},{"label":"Set","value":657},{"label":"Out","value":641},{"label":"Nov","value":1006},{"label":"Dez","value":951}];
const MX = 1006;
