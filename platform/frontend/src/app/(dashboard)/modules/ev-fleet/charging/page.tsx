...
const ACCENT = "#6366f1";
const MODULE = "EV Fleet Mgmt";
const PAGE = "Charging";
const KPIS = [{"l":"Total Ev Fleet","v":"4.069","t":"+16.4%","d":"up"},{"l":"Charging Ativos","v":"7.308","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"76.4%","t":"+1.7%","d":"up"},{"l":"Score Performance","v":"84","t":"-3.0%","d":"down"}];
const COLS = ["ID","Charging","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Fleet #001","Ev Fleet #002","6.231","8.210","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Fleet #002","Ev Fleet #003","786","2.134","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Fleet #003","Ev Fleet #004","6.603","2.465","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Fleet #004","Ev Fleet #005","5.399","3.946","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Fleet #005","Ev Fleet #001","8.891","3.513","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":259},{"label":"Mar","value":270},{"label":"Abr","value":479},{"label":"Mai","value":289},{"label":"Jun","value":594},{"label":"Jul","value":308},{"label":"Ago","value":273},{"label":"Set","value":345},{"label":"Out","value":475},{"label":"Nov","value":489},{"label":"Dez","value":320}];
const MX = 594;
