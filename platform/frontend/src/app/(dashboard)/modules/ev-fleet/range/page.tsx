...
const PAGE = "Range";
const KPIS = [{"l":"Total Ev Fleet","v":"9.084","t":"+16.9%","d":"up"},{"l":"Range Ativos","v":"6.400","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"85.6%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"76","t":"+4.9%","d":"up"}];
const COLS = ["ID","Range","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Fleet #001","Ev Fleet #002","5.928","1.867","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Fleet #002","Ev Fleet #003","5.300","1.880","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Fleet #003","Ev Fleet #004","8.361","1.235","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Fleet #004","Ev Fleet #005","8.242","6.615","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Fleet #005","Ev Fleet #001","1.124","4.281","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":614},{"label":"Fev","value":406},{"label":"Mar","value":384},{"label":"Abr","value":762},{"label":"Mai","value":725},{"label":"Jun","value":493},{"label":"Jul","value":421},{"label":"Ago","value":720},{"label":"Set","value":424},{"label":"Out","value":769},{"label":"Nov","value":674},{"label":"Dez","value":415}];
const MX = 769;
