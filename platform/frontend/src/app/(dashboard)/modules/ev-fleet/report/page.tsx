...
const PAGE = "Report";
const KPIS = [{"l":"Total Ev Fleet","v":"4.849","t":"+1.9%","d":"up"},{"l":"Report Ativos","v":"8.359","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"78.3%","t":"-5.2%","d":"down"},{"l":"Score Performance","v":"69","t":"-3.2%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Fleet #001","Ev Fleet #002","9.016","7.182","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Fleet #002","Ev Fleet #003","8.897","1.989","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Fleet #003","Ev Fleet #004","6.113","5.280","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Fleet #004","Ev Fleet #005","1.510","831","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Fleet #005","Ev Fleet #001","1.297","2.411","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":694},{"label":"Mar","value":965},{"label":"Abr","value":838},{"label":"Mai","value":596},{"label":"Jun","value":835},{"label":"Jul","value":833},{"label":"Ago","value":581},{"label":"Set","value":727},{"label":"Out","value":713},{"label":"Nov","value":897},{"label":"Dez","value":851}];
const MX = 965;
