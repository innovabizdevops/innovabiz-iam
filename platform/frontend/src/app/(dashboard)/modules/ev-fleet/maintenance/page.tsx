...
const KPIS = [{"l":"Total Ev Fleet","v":"5.248","t":"+7.0%","d":"up"},{"l":"Maintenance Ativos","v":"6.038","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"80.2%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"72","t":"+13.5%","d":"up"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Fleet #001","Ev Fleet #002","1.505","2.331","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Fleet #002","Ev Fleet #003","5.850","7.186","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Fleet #003","Ev Fleet #004","7.856","5.097","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Fleet #004","Ev Fleet #005","7.447","4.070","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Fleet #005","Ev Fleet #001","7.736","7.512","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":426},{"label":"Fev","value":681},{"label":"Mar","value":442},{"label":"Abr","value":542},{"label":"Mai","value":672},{"label":"Jun","value":692},{"label":"Jul","value":561},{"label":"Ago","value":590},{"label":"Set","value":473},{"label":"Out","value":559},{"label":"Nov","value":485},{"label":"Dez","value":514}];
const MX = 692;
