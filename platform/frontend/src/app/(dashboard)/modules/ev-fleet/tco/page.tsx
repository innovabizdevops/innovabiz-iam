...
const PAGE = "TCO";
const KPIS = [{"l":"Total Ev Fleet","v":"7.821","t":"-1.2%","d":"down"},{"l":"TCO Ativos","v":"228","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"88.2%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"69","t":"+17.5%","d":"up"}];
const COLS = ["ID","TCO","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Fleet #001","Ev Fleet #002","4.067","6.825","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Fleet #002","Ev Fleet #003","3.907","8.855","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Fleet #003","Ev Fleet #004","5.711","7.130","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Fleet #004","Ev Fleet #005","4.682","2.124","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Fleet #005","Ev Fleet #001","5.338","494","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":739},{"label":"Mar","value":653},{"label":"Abr","value":729},{"label":"Mai","value":743},{"label":"Jun","value":663},{"label":"Jul","value":896},{"label":"Ago","value":741},{"label":"Set","value":830},{"label":"Out","value":616},{"label":"Nov","value":919},{"label":"Dez","value":851}];
const MX = 919;
