...
const KPIS = [{"l":"Projetos Melhoria","v":"9.084","t":"+11.2%","d":"up"},{"l":"Savings (€)","v":"€14980","t":"+16.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"67.6%","t":"+11.1%","d":"up"},{"l":"Ciclos PDCA","v":"7.625","t":"-2.3%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.576","€ 32909.23","934","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.609","€ 33000.27","3.518","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.790","€ 42353.37","172","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.057","€ 35018.27","6.246","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.033","€ 38652.08","3.929","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":504},{"label":"Fev","value":534},{"label":"Mar","value":354},{"label":"Abr","value":540},{"label":"Mai","value":453},{"label":"Jun","value":496},{"label":"Jul","value":538},{"label":"Ago","value":432},{"label":"Set","value":574},{"label":"Out","value":455},{"label":"Nov","value":674},{"label":"Dez","value":627}];
const MX = 674;
