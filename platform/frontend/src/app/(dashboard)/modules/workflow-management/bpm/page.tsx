...
const PAGE = "BPM Hub";
const KPIS = [{"l":"Projetos Melhoria","v":"9.020","t":"-4.3%","d":"down"},{"l":"Savings (€)","v":"€10433","t":"+1.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"66.2%","t":"-1.8%","d":"down"},{"l":"Ciclos PDCA","v":"1.603","t":"+16.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.042","€ 13975.43","2.726","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.208","€ 21456.57","8.682","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.153","€ 7646.94","8.576","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.134","€ 31421.52","938","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.541","€ 36246.26","3.542","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":422},{"label":"Mar","value":769},{"label":"Abr","value":736},{"label":"Mai","value":674},{"label":"Jun","value":490},{"label":"Jul","value":568},{"label":"Ago","value":779},{"label":"Set","value":608},{"label":"Out","value":709},{"label":"Nov","value":734},{"label":"Dez","value":484}];
const MX = 805;
