...
const KPIS = [{"l":"Projetos Melhoria","v":"5.397","t":"-2.9%","d":"down"},{"l":"Savings (€)","v":"€24619","t":"+0.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"94.6%","t":"-5.4%","d":"down"},{"l":"Ciclos PDCA","v":"679","t":"+5.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.745","€ 19258.21","148","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.705","€ 37669.07","8.788","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.942","€ 20217.80","6.722","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.715","€ 31520.83","258","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.006","€ 23264.71","6.837","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":914},{"label":"Fev","value":994},{"label":"Mar","value":996},{"label":"Abr","value":941},{"label":"Mai","value":946},{"label":"Jun","value":832},{"label":"Jul","value":865},{"label":"Ago","value":911},{"label":"Set","value":649},{"label":"Out","value":890},{"label":"Nov","value":695},{"label":"Dez","value":840}];
const MX = 996;
