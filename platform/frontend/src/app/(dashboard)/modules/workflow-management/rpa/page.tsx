...
const PAGE = "RPA";
const KPIS = [{"l":"Projetos Melhoria","v":"8.263","t":"-3.2%","d":"down"},{"l":"Savings (€)","v":"€81043","t":"-1.8%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"67.5%","t":"+9.5%","d":"up"},{"l":"Ciclos PDCA","v":"698","t":"-3.8%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.489","€ 43455.87","4.895","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.947","€ 34257.02","472","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.857","€ 18088.93","466","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.525","€ 19007.23","3.500","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.488","€ 29146.21","2.976","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":474},{"label":"Fev","value":614},{"label":"Mar","value":494},{"label":"Abr","value":781},{"label":"Mai","value":650},{"label":"Jun","value":557},{"label":"Jul","value":664},{"label":"Ago","value":525},{"label":"Set","value":720},{"label":"Out","value":541},{"label":"Nov","value":558},{"label":"Dez","value":695}];
const MX = 781;
