...
const PAGE = "Designer";
const KPIS = [{"l":"Formulários Ativos","v":"3.841","t":"+13.9%","d":"up"},{"l":"Submissões/Dia","v":"1946","t":"+0.9%","d":"up"},{"l":"Documentos Gerados","v":"582","t":"-4.8%","d":"down"},{"l":"Templates","v":"5.086","t":"-2.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","9.001","2026-03-08","6.024","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","769","2026-03-23","8.292","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.810","2026-01-02","6.217","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.801","2026-02-02","5.376","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","879","2026-02-01","5.233","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":578},{"label":"Mar","value":829},{"label":"Abr","value":721},{"label":"Mai","value":745},{"label":"Jun","value":818},{"label":"Jul","value":699},{"label":"Ago","value":627},{"label":"Set","value":777},{"label":"Out","value":744},{"label":"Nov","value":677},{"label":"Dez","value":796}];
const MX = 839;
