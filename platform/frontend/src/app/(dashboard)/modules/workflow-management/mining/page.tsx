...
const ACCENT = "#6366f1";
const MODULE = "Workflow Management";
const PAGE = "Process Mining";
const KPIS = [{"l":"Projetos Melhoria","v":"2.560","t":"+8.0%","d":"up"},{"l":"Savings (€)","v":"€10590","t":"-3.4%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"65.8%","t":"+15.4%","d":"up"},{"l":"Ciclos PDCA","v":"6.958","t":"+16.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.159","€ 48807.01","6.735","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","120","€ 23215.58","2.289","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.042","€ 13240.30","1.988","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.095","€ 5750.13","3.049","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.081","€ 28409.24","8.587","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":681},{"label":"Mar","value":687},{"label":"Abr","value":374},{"label":"Mai","value":369},{"label":"Jun","value":448},{"label":"Jul","value":592},{"label":"Ago","value":699},{"label":"Set","value":697},{"label":"Out","value":349},{"label":"Nov","value":402},{"label":"Dez","value":504}];
const MX = 699;
