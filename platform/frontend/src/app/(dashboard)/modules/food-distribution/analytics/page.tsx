...
const KPIS = [{"l":"Dashboards Ativos","v":"787","t":"+13.1%","d":"up"},{"l":"Queries/Dia","v":"2949","t":"+7.8%","d":"up"},{"l":"Dados Processados (GB)","v":"7.426","t":"-2.2%","d":"down"},{"l":"Utilizadores Analytics","v":"1.593","t":"+13.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3076","2026-01-15","6.510","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4720","2026-02-09","5.129","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1632","2026-03-23","6.197","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1335","2026-03-01","6.361","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","440","2026-01-21","3.221","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":748},{"label":"Mar","value":816},{"label":"Abr","value":814},{"label":"Mai","value":699},{"label":"Jun","value":753},{"label":"Jul","value":665},{"label":"Ago","value":611},{"label":"Set","value":770},{"label":"Out","value":500},{"label":"Nov","value":641},{"label":"Dez","value":855}];
const MX = 855;
