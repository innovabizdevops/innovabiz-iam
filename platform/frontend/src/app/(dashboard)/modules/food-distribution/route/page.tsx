...
const PAGE = "Route";
const KPIS = [{"l":"Total Food Distribution","v":"6.934","t":"+7.4%","d":"up"},{"l":"Route Ativos","v":"8.411","t":"+12.0%","d":"up"},{"l":"Eficiência (%)","v":"89.2%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"56","t":"+2.9%","d":"up"}];
const COLS = ["ID","Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Distribution #001","Food Distribution #002","4.839","3.266","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Food Distribution #002","Food Distribution #003","6.668","984","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Distribution #003","Food Distribution #004","2.896","3.449","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Food Distribution #004","Food Distribution #005","6.463","7.773","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Distribution #005","Food Distribution #001","4.214","2.607","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":439},{"label":"Mar","value":604},{"label":"Abr","value":544},{"label":"Mai","value":630},{"label":"Jun","value":617},{"label":"Jul","value":524},{"label":"Ago","value":596},{"label":"Set","value":718},{"label":"Out","value":715},{"label":"Nov","value":664},{"label":"Dez","value":500}];
const MX = 718;
