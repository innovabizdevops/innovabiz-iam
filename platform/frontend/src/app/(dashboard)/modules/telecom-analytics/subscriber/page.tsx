...
const KPIS = [{"l":"Dashboards Ativos","v":"4.094","t":"+5.4%","d":"up"},{"l":"Queries/Dia","v":"4277","t":"+18.0%","d":"up"},{"l":"Dados Processados (GB)","v":"1.469","t":"+17.9%","d":"up"},{"l":"Utilizadores Analytics","v":"5.755","t":"-5.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","659","2026-03-23","8.120","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3995","2026-02-23","8.621","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2367","2026-02-10","4.488","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3197","2026-02-21","3.479","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2920","2026-01-18","5.792","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":414},{"label":"Mar","value":542},{"label":"Abr","value":367},{"label":"Mai","value":662},{"label":"Jun","value":466},{"label":"Jul","value":422},{"label":"Ago","value":531},{"label":"Set","value":561},{"label":"Out","value":569},{"label":"Nov","value":757},{"label":"Dez","value":632}];
const MX = 757;
