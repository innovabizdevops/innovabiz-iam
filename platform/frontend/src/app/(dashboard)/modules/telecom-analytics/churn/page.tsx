...
const PAGE = "Churn";
const KPIS = [{"l":"ARR (€M)","v":"€12.2M","t":"+7.5%","d":"up"},{"l":"MRR (€)","v":"€75907","t":"+0.6%","d":"up"},{"l":"Churn (%)","v":"73.8%","t":"+8.3%","d":"up"},{"l":"ARPU (€)","v":"€65248","t":"-5.9%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 5351.93","1.661","€ 14891.59","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 37696.30","5.323","€ 25472.45","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 39296.88","1.770","€ 26472.04","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 45376.06","6.088","€ 32427.27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 19773.92","1.973","€ 12721.90","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":793},{"label":"Mar","value":506},{"label":"Abr","value":668},{"label":"Mai","value":817},{"label":"Jun","value":657},{"label":"Jul","value":809},{"label":"Ago","value":536},{"label":"Set","value":618},{"label":"Out","value":847},{"label":"Nov","value":736},{"label":"Dez","value":597}];
const MX = 847;
