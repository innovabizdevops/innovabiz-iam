...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€20.0M","t":"+12.4%","d":"up"},{"l":"MRR (€)","v":"€29003","t":"+2.2%","d":"up"},{"l":"Churn (%)","v":"72.3%","t":"+5.6%","d":"up"},{"l":"ARPU (€)","v":"€68064","t":"+14.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 21617.04","6.399","€ 45779.77","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 30599.96","5.846","€ 20036.00","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 29040.21","3.875","€ 38993.99","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 14394.50","8.875","€ 17866.58","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 3260.70","7.781","€ 42080.12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":908},{"label":"Fev","value":619},{"label":"Mar","value":755},{"label":"Abr","value":605},{"label":"Mai","value":730},{"label":"Jun","value":647},{"label":"Jul","value":568},{"label":"Ago","value":572},{"label":"Set","value":612},{"label":"Out","value":706},{"label":"Nov","value":791},{"label":"Dez","value":540}];
const MX = 908;
