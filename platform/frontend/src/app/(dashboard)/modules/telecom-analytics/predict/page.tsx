...
const ACCENT = "#fb923c";
const MODULE = "Telecom Analytics Deep";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"9.034","t":"+6.0%","d":"up"},{"l":"Queries/Dia","v":"3025","t":"+11.6%","d":"up"},{"l":"Dados Processados (GB)","v":"906","t":"+15.0%","d":"up"},{"l":"Utilizadores Analytics","v":"952","t":"-1.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1577","2026-01-08","8.034","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1113","2026-03-06","8.278","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","888","2026-03-12","8.478","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4237","2026-02-06","3.435","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4177","2026-01-25","4.939","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":841},{"label":"Fev","value":788},{"label":"Mar","value":946},{"label":"Abr","value":1023},{"label":"Mai","value":967},{"label":"Jun","value":804},{"label":"Jul","value":877},{"label":"Ago","value":946},{"label":"Set","value":946},{"label":"Out","value":966},{"label":"Nov","value":674},{"label":"Dez","value":883}];
const MX = 1023;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#fb923c'}}>AI</span></h1>
                </div>
