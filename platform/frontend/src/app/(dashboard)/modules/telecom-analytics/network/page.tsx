...
const PAGE = "Network";
const KPIS = [{"l":"Dashboards Ativos","v":"6.179","t":"+2.8%","d":"up"},{"l":"Queries/Dia","v":"3312","t":"-2.9%","d":"down"},{"l":"Dados Processados (GB)","v":"1.725","t":"+6.4%","d":"up"},{"l":"Utilizadores Analytics","v":"8.348","t":"-4.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2042","2026-03-05","5.430","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2499","2026-03-11","8.325","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3581","2026-03-16","1.625","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1594","2026-02-26","452","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4320","2026-01-11","4.035","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":350},{"label":"Mar","value":526},{"label":"Abr","value":272},{"label":"Mai","value":309},{"label":"Jun","value":518},{"label":"Jul","value":272},{"label":"Ago","value":243},{"label":"Set","value":382},{"label":"Out","value":234},{"label":"Nov","value":451},{"label":"Dez","value":409}];
const MX = 541;
