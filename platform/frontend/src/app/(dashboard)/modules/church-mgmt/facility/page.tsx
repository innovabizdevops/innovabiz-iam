...
const ACCENT = "#ec4899";
const MODULE = "Church Management";
const PAGE = "Facility Book";
const KPIS = [{"l":"Total Church Mgmt","v":"8.185","t":"+3.9%","d":"up"},{"l":"Facility Book Ativos","v":"4.375","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"94.1%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"74","t":"+8.2%","d":"up"}];
const COLS = ["ID","Facility Book","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Church Mgmt #001","Church Mgmt #002","5.838","7.206","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Church Mgmt #002","Church Mgmt #003","1.370","457","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Church Mgmt #003","Church Mgmt #004","8.556","7.187","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Church Mgmt #004","Church Mgmt #005","1.487","5.194","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Church Mgmt #005","Church Mgmt #001","7.333","6.404","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":634},{"label":"Mar","value":463},{"label":"Abr","value":495},{"label":"Mai","value":624},{"label":"Jun","value":444},{"label":"Jul","value":432},{"label":"Ago","value":603},{"label":"Set","value":364},{"label":"Out","value":637},{"label":"Nov","value":495},{"label":"Dez","value":672}];
const MX = 672;
