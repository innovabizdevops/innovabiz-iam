...
const PAGE = "Small Groups";
const KPIS = [{"l":"Total Church Mgmt","v":"147","t":"+14.1%","d":"up"},{"l":"Small Groups Ativos","v":"1.071","t":"-5.7%","d":"down"},{"l":"Eficiência (%)","v":"70.5%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"64","t":"+5.4%","d":"up"}];
const COLS = ["ID","Small Groups","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Church Mgmt #001","Church Mgmt #002","3.222","6.015","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Church Mgmt #002","Church Mgmt #003","8.058","2.336","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Church Mgmt #003","Church Mgmt #004","7.118","6.977","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Church Mgmt #004","Church Mgmt #005","4.192","3.237","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Church Mgmt #005","Church Mgmt #001","1.402","3.199","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":621},{"label":"Mar","value":885},{"label":"Abr","value":679},{"label":"Mai","value":735},{"label":"Jun","value":653},{"label":"Jul","value":957},{"label":"Ago","value":663},{"label":"Set","value":760},{"label":"Out","value":759},{"label":"Nov","value":810},{"label":"Dez","value":895}];
const MX = 957;
