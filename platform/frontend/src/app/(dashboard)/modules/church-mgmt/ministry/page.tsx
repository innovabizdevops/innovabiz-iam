...
const PAGE = "Ministry";
const KPIS = [{"l":"Total Church Mgmt","v":"3.566","t":"-5.6%","d":"down"},{"l":"Ministry Ativos","v":"283","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"66.6%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"73","t":"-1.3%","d":"down"}];
const COLS = ["ID","Ministry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Church Mgmt #001","Church Mgmt #002","5.323","110","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Church Mgmt #002","Church Mgmt #003","5.630","8.685","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Church Mgmt #003","Church Mgmt #004","4.421","6.297","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Church Mgmt #004","Church Mgmt #005","4.118","887","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Church Mgmt #005","Church Mgmt #001","8.040","5.532","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":487},{"label":"Mar","value":473},{"label":"Abr","value":636},{"label":"Mai","value":461},{"label":"Jun","value":546},{"label":"Jul","value":483},{"label":"Ago","value":590},{"label":"Set","value":517},{"label":"Out","value":741},{"label":"Nov","value":442},{"label":"Dez","value":634}];
const MX = 741;
