...
export default function ChurchMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Church Mgmt</h1><p className="text-sm text-muted-foreground">Church Mgmt • iBOS Enterprise</p></div>
