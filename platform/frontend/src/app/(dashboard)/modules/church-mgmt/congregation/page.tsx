...
const PAGE = "Congregation";
const KPIS = [{"l":"Total Church Mgmt","v":"4.554","t":"+1.0%","d":"up"},{"l":"Congregation Ativos","v":"4.837","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"75.7%","t":"-2.3%","d":"down"},{"l":"Score Performance","v":"63","t":"+18.0%","d":"up"}];
const COLS = ["ID","Congregation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Church Mgmt #001","Church Mgmt #002","1.035","8.916","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Church Mgmt #002","Church Mgmt #003","8.532","5.773","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Church Mgmt #003","Church Mgmt #004","3.583","4.496","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Church Mgmt #004","Church Mgmt #005","6.925","6.289","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Church Mgmt #005","Church Mgmt #001","575","6.510","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":392},{"label":"Fev","value":299},{"label":"Mar","value":307},{"label":"Abr","value":568},{"label":"Mai","value":592},{"label":"Jun","value":465},{"label":"Jul","value":516},{"label":"Ago","value":567},{"label":"Set","value":303},{"label":"Out","value":606},{"label":"Nov","value":536},{"label":"Dez","value":473}];
const MX = 606;
