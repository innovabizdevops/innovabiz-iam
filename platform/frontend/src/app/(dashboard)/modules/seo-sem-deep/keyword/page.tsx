...
const ACCENT = "#be185d";
const MODULE = "SEO & SEM Deep";
const PAGE = "Keyword";
const KPIS = [{"l":"Total Seo Sem Deep","v":"5.737","t":"+4.4%","d":"up"},{"l":"Keyword Ativos","v":"6.560","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"73.6%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"76","t":"+2.1%","d":"up"}];
const COLS = ["ID","Keyword","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Seo Sem Deep #001","Seo Sem Deep #002","3.509","2.035","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Seo Sem Deep #002","Seo Sem Deep #003","8.135","8.768","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Seo Sem Deep #003","Seo Sem Deep #004","6.920","3.077","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Seo Sem Deep #004","Seo Sem Deep #005","6.378","3.000","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Seo Sem Deep #005","Seo Sem Deep #001","7.419","7.760","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":907},{"label":"Mar","value":965},{"label":"Abr","value":900},{"label":"Mai","value":706},{"label":"Jun","value":908},{"label":"Jul","value":720},{"label":"Ago","value":932},{"label":"Set","value":976},{"label":"Out","value":822},{"label":"Nov","value":651},{"label":"Dez","value":728}];
const MX = 976;
