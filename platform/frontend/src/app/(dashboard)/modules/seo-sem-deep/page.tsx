...
/* ═══ SEO & SEM Deep — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "6019", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3089", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€459K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1625041419", cells: ["SEO-2419", "SEO & SEM Deep Item 1", "16/4/2026", "€41 519"], status: "active" as const },
    { id: "1625044990", cells: ["SEO-5990", "SEO & SEM Deep Item 2", "3/11/2026", "€45 090"], status: "pending" as const },
    { id: "1625048561", cells: ["SEO-9561", "SEO & SEM Deep Item 3", "18/6/2026", "€48 661"], status: "completed" as const },
    { id: "1625052132", cells: ["SEO-4132", "SEO & SEM Deep Item 4", "5/1/2026", "€2232"], status: "warning" as const },
    { id: "1625055703", cells: ["SEO-7703", "SEO & SEM Deep Item 5", "20/8/2026", "€5803"], status: "active" as const },
];
...
export default function SeoSemDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SEO & SEM Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SEO & SEM Deep</p>
                    </div>
                </div>
