...
const PAGE = "Track";
const KPIS = [{"l":"Total Seo Sem Deep","v":"2.292","t":"+1.1%","d":"up"},{"l":"Track Ativos","v":"2.892","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"88.6%","t":"+16.3%","d":"up"},{"l":"Score Performance","v":"85","t":"+10.1%","d":"up"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Seo Sem Deep #001","Seo Sem Deep #002","2.661","6.955","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Seo Sem Deep #002","Seo Sem Deep #003","1.596","1.652","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Seo Sem Deep #003","Seo Sem Deep #004","6.635","2.988","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Seo Sem Deep #004","Seo Sem Deep #005","3.699","2.574","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Seo Sem Deep #005","Seo Sem Deep #001","6.012","3.351","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":308},{"label":"Fev","value":468},{"label":"Mar","value":416},{"label":"Abr","value":208},{"label":"Mai","value":543},{"label":"Jun","value":216},{"label":"Jul","value":578},{"label":"Ago","value":605},{"label":"Set","value":274},{"label":"Out","value":220},{"label":"Nov","value":272},{"label":"Dez","value":343}];
const MX = 605;
