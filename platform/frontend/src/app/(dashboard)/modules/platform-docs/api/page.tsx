...
const PAGE = "API Ref";
const KPIS = [{"l":"Formulários Ativos","v":"8.620","t":"+14.2%","d":"up"},{"l":"Submissões/Dia","v":"721","t":"+13.4%","d":"up"},{"l":"Documentos Gerados","v":"2.832","t":"+15.5%","d":"up"},{"l":"Templates","v":"4.303","t":"+7.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.338","2026-01-16","6.392","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.432","2026-03-21","3.244","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","9.076","2026-03-17","1.469","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","639","2026-03-16","1.094","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","272","2026-02-09","8.038","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":959},{"label":"Mar","value":696},{"label":"Abr","value":794},{"label":"Mai","value":725},{"label":"Jun","value":713},{"label":"Jul","value":892},{"label":"Ago","value":936},{"label":"Set","value":891},{"label":"Out","value":708},{"label":"Nov","value":848},{"label":"Dez","value":747}];
const MX = 959;
