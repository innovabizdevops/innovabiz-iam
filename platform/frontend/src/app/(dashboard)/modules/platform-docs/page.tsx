...
/* ═══ Platform Documentation Hub — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "6552", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3194", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€84K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1935298052", cells: ["PLA-2052", "Platform Documentation Hub Item 1", "17/9/2026", "€48 152"], status: "active" as const },
    { id: "1935301623", cells: ["PLA-5623", "Platform Documentation Hub Item 2", "4/4/2026", "€1723"], status: "pending" as const },
    { id: "1935305194", cells: ["PLA-9194", "Platform Documentation Hub Item 3", "19/11/2026", "€5294"], status: "completed" as const },
    { id: "1935308765", cells: ["PLA-3765", "Platform Documentation Hub Item 4", "6/6/2026", "€8865"], status: "warning" as const },
    { id: "1935312336", cells: ["PLA-7336", "Platform Documentation Hub Item 5", "21/1/2026", "€12 436"], status: "active" as const },
];
...
export default function PlatformDocumentationHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Platform Documentation Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Platform Documentation Hub</p>
                    </div>
                </div>
