...
const ACCENT = "#312e81";
const MODULE = "Platform Documentation Hub";
const PAGE = "Guides";
const KPIS = [{"l":"Formulários Ativos","v":"7.204","t":"-1.8%","d":"down"},{"l":"Submissões/Dia","v":"1486","t":"+13.2%","d":"up"},{"l":"Documentos Gerados","v":"7.477","t":"-0.2%","d":"down"},{"l":"Templates","v":"1.437","t":"+12.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.163","2026-03-23","6.358","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.970","2026-02-01","3.919","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.781","2026-03-09","4.542","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.363","2026-01-07","8.279","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.429","2026-02-09","5.443","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":856},{"label":"Fev","value":1083},{"label":"Mar","value":905},{"label":"Abr","value":838},{"label":"Mai","value":1019},{"label":"Jun","value":1005},{"label":"Jul","value":1015},{"label":"Ago","value":833},{"label":"Set","value":690},{"label":"Out","value":992},{"label":"Nov","value":966},{"label":"Dez","value":986}];
const MX = 1083;
