...
const KPIS = [{"l":"Formulários Ativos","v":"7.045","t":"+0.4%","d":"up"},{"l":"Submissões/Dia","v":"4366","t":"+1.0%","d":"up"},{"l":"Documentos Gerados","v":"687","t":"+9.8%","d":"up"},{"l":"Templates","v":"4.532","t":"+6.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","894","2026-02-15","4.305","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.302","2026-01-21","7.139","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.891","2026-01-24","6.423","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","325","2026-01-13","4.972","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.086","2026-02-16","8.234","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":322},{"label":"Mar","value":569},{"label":"Abr","value":264},{"label":"Mai","value":523},{"label":"Jun","value":389},{"label":"Jul","value":551},{"label":"Ago","value":259},{"label":"Set","value":391},{"label":"Out","value":503},{"label":"Nov","value":527},{"label":"Dez","value":559}];
const MX = 569;
