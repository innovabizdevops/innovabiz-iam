...
const KPIS = [{"l":"Formulários Ativos","v":"5.138","t":"-3.5%","d":"down"},{"l":"Submissões/Dia","v":"176","t":"-3.8%","d":"down"},{"l":"Documentos Gerados","v":"6.245","t":"+3.8%","d":"up"},{"l":"Templates","v":"8.040","t":"+3.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.038","2026-03-21","245","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.535","2026-01-27","2.111","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.081","2026-03-13","7.407","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.773","2026-03-23","900","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.776","2026-03-05","2.797","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":311},{"label":"Mar","value":650},{"label":"Abr","value":473},{"label":"Mai","value":532},{"label":"Jun","value":464},{"label":"Jul","value":438},{"label":"Ago","value":582},{"label":"Set","value":420},{"label":"Out","value":403},{"label":"Nov","value":458},{"label":"Dez","value":315}];
const MX = 650;
