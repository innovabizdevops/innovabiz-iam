...
const PAGE = "Tutorial";
const KPIS = [{"l":"Formulários Ativos","v":"3.122","t":"+0.1%","d":"up"},{"l":"Submissões/Dia","v":"2621","t":"+9.2%","d":"up"},{"l":"Documentos Gerados","v":"7.070","t":"+0.6%","d":"up"},{"l":"Templates","v":"5.176","t":"+0.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.820","2026-01-13","1.733","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.149","2026-01-14","6.758","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.754","2026-01-20","4.307","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.476","2026-03-27","3.403","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.669","2026-03-20","8.293","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":665},{"label":"Mar","value":551},{"label":"Abr","value":710},{"label":"Mai","value":433},{"label":"Jun","value":437},{"label":"Jul","value":473},{"label":"Ago","value":789},{"label":"Set","value":826},{"label":"Out","value":540},{"label":"Nov","value":510},{"label":"Dez","value":508}];
const MX = 826;
