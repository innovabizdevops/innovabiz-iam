...
const PAGE = "Archive";
const KPIS = [{"l":"Total Md Report Engine","v":"8.652","t":"+13.6%","d":"up"},{"l":"Archive Ativos","v":"699","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"64","t":"+7.8%","d":"up"}];
const COLS = ["ID","Archive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Md Report Engine #001","Md Report Engine #002","778","2.488","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Md Report Engine #002","Md Report Engine #003","2.087","6.268","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Md Report Engine #003","Md Report Engine #004","1.696","2.818","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Md Report Engine #004","Md Report Engine #005","8.634","1.230","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Md Report Engine #005","Md Report Engine #001","8.876","5.459","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":983},{"label":"Fev","value":872},{"label":"Mar","value":868},{"label":"Abr","value":765},{"label":"Mai","value":815},{"label":"Jun","value":613},{"label":"Jul","value":896},{"label":"Ago","value":706},{"label":"Set","value":788},{"label":"Out","value":853},{"label":"Nov","value":884},{"label":"Dez","value":987}];
const MX = 987;
