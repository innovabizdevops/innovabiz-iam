...
const PAGE = "Template";
const KPIS = [{"l":"Formulários Ativos","v":"550","t":"-5.1%","d":"down"},{"l":"Submissões/Dia","v":"4436","t":"+15.6%","d":"up"},{"l":"Documentos Gerados","v":"3.141","t":"-1.8%","d":"down"},{"l":"Templates","v":"3.102","t":"+10.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.432","2026-03-02","198","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.392","2026-02-08","7.013","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.685","2026-01-05","2.482","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.255","2026-01-16","7.397","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","795","2026-01-07","5.568","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":336},{"label":"Fev","value":336},{"label":"Mar","value":596},{"label":"Abr","value":546},{"label":"Mai","value":690},{"label":"Jun","value":327},{"label":"Jul","value":459},{"label":"Ago","value":488},{"label":"Set","value":670},{"label":"Out","value":342},{"label":"Nov","value":603},{"label":"Dez","value":573}];
const MX = 690;
