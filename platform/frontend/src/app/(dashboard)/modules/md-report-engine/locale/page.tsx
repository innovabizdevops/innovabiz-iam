...
const PAGE = "Locale";
const KPIS = [{"l":"Configurações","v":"1.859","t":"+3.4%","d":"up"},{"l":"Últimas Alterações","v":"7.050","t":"-5.1%","d":"down"},{"l":"Ambientes","v":"8.694","t":"+9.6%","d":"up"},{"l":"Versão Config","v":"8.770","t":"+1.3%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 3742.54","3.045","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 44095.49","148","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 11512.28","4.456","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 19601.87","7.622","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 31731.98","1.401","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":890},{"label":"Fev","value":898},{"label":"Mar","value":817},{"label":"Abr","value":846},{"label":"Mai","value":758},{"label":"Jun","value":754},{"label":"Jul","value":880},{"label":"Ago","value":755},{"label":"Set","value":600},{"label":"Out","value":889},{"label":"Nov","value":635},{"label":"Dez","value":870}];
const MX = 898;
