...
/* ═══ MD: Multi-Report Engine — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "6468", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3287", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€377K", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "582373868", cells: ["MD-2868", "MD: Multi-Report Engine Item 1", "21/9/2026", "€23 968"], status: "active" as const },
    { id: "582377439", cells: ["MD-6439", "MD: Multi-Report Engine Item 2", "8/4/2026", "€27 539"], status: "pending" as const },
    { id: "582381010", cells: ["MD-1010", "MD: Multi-Report Engine Item 3", "23/11/2026", "€31 110"], status: "completed" as const },
    { id: "582384581", cells: ["MD-4581", "MD: Multi-Report Engine Item 4", "10/6/2026", "€34 681"], status: "warning" as const },
    { id: "582388152", cells: ["MD-8152", "MD: Multi-Report Engine Item 5", "25/1/2026", "€38 252"], status: "active" as const },
];
...
export default function MdMultireportEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Report Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Report Engine</p>
                    </div>
                </div>
