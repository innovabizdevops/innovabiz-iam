...
const PAGE = "Multimodal Trip";
const KPIS = [{"l":"Veículos Operação","v":"398","t":"-1.3%","d":"down"},{"l":"Viagens/Dia","v":"1181","t":"+7.9%","d":"up"},{"l":"Pontualidade (%)","v":"92.8%","t":"+16.4%","d":"up"},{"l":"Passageiros/Dia","v":"1926","t":"-2.6%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-26","2026-03-26","171","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-20","2026-01-25","2.027","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-11","2026-02-24","8.409","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-10","2026-02-19","317","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-07","2026-02-28","530","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":513},{"label":"Fev","value":560},{"label":"Mar","value":853},{"label":"Abr","value":682},{"label":"Mai","value":721},{"label":"Jun","value":512},{"label":"Jul","value":533},{"label":"Ago","value":721},{"label":"Set","value":568},{"label":"Out","value":494},{"label":"Nov","value":765},{"label":"Dez","value":822}];
const MX = 853;
