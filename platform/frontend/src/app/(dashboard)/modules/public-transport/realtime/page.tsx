...
const ACCENT = "#1e40af";
const MODULE = "Public Transport";
const PAGE = "Real-Time Info";
const KPIS = [{"l":"Veículos Operação","v":"2.849","t":"+5.1%","d":"up"},{"l":"Viagens/Dia","v":"4708","t":"+0.6%","d":"up"},{"l":"Pontualidade (%)","v":"92.0%","t":"+16.9%","d":"up"},{"l":"Passageiros/Dia","v":"3346","t":"+1.3%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-23","2026-03-21","4.195","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-01","2026-01-09","7.980","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-15","2026-01-20","1.505","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-20","2026-01-22","8.364","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-15","2026-02-04","2.280","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":565},{"label":"Mar","value":349},{"label":"Abr","value":662},{"label":"Mai","value":368},{"label":"Jun","value":322},{"label":"Jul","value":544},{"label":"Ago","value":447},{"label":"Set","value":485},{"label":"Out","value":457},{"label":"Nov","value":673},{"label":"Dez","value":369}];
const MX = 673;
