...
const PAGE = "Fleet Tracker";
const KPIS = [{"l":"Veículos Operação","v":"3.485","t":"+5.0%","d":"up"},{"l":"Viagens/Dia","v":"452","t":"+2.2%","d":"up"},{"l":"Pontualidade (%)","v":"71.1%","t":"+15.6%","d":"up"},{"l":"Passageiros/Dia","v":"2550","t":"+5.6%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-12","2026-02-06","4.872","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-28","2026-03-02","2.813","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-07","2026-03-16","4.831","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-06","2026-03-01","629","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-26","2026-03-18","6.273","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":550},{"label":"Mar","value":599},{"label":"Abr","value":573},{"label":"Mai","value":612},{"label":"Jun","value":642},{"label":"Jul","value":585},{"label":"Ago","value":568},{"label":"Set","value":545},{"label":"Out","value":687},{"label":"Nov","value":834},{"label":"Dez","value":570}];
const MX = 834;
