...
const PAGE = "Passenger Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"5.614","t":"-5.5%","d":"down"},{"l":"Queries/Dia","v":"4801","t":"+12.2%","d":"up"},{"l":"Dados Processados (GB)","v":"1.942","t":"+6.2%","d":"up"},{"l":"Utilizadores Analytics","v":"7.749","t":"+14.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4043","2026-02-05","1.656","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4009","2026-03-11","6.503","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1914","2026-02-06","5.753","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4272","2026-01-05","3.701","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","753","2026-03-03","3.067","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":545},{"label":"Fev","value":554},{"label":"Mar","value":625},{"label":"Abr","value":590},{"label":"Mai","value":710},{"label":"Jun","value":420},{"label":"Jul","value":683},{"label":"Ago","value":365},{"label":"Set","value":726},{"label":"Out","value":586},{"label":"Nov","value":476},{"label":"Dez","value":391}];
const MX = 726;
