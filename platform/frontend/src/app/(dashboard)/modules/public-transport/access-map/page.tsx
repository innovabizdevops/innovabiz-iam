...
const PAGE = "Accessibility Map";
const KPIS = [{"l":"Veículos Operação","v":"6.019","t":"+16.2%","d":"up"},{"l":"Viagens/Dia","v":"310","t":"+11.9%","d":"up"},{"l":"Pontualidade (%)","v":"72.9%","t":"-5.0%","d":"down"},{"l":"Passageiros/Dia","v":"4130","t":"+8.2%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-02","2026-03-10","6.367","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-15","2026-03-26","471","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-08","2026-01-22","5.698","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-22","2026-03-16","1.012","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-13","2026-01-20","2.280","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":432},{"label":"Fev","value":802},{"label":"Mar","value":432},{"label":"Abr","value":488},{"label":"Mai","value":751},{"label":"Jun","value":473},{"label":"Jul","value":637},{"label":"Ago","value":528},{"label":"Set","value":722},{"label":"Out","value":755},{"label":"Nov","value":490},{"label":"Dez","value":728}];
const MX = 802;
