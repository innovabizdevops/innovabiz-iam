...
const PAGE = "Ticketing System";
const KPIS = [{"l":"Tickets Abertos","v":"1.288","t":"+3.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"76.5%","t":"+15.2%","d":"up"},{"l":"MTTR (h)","v":"148h","t":"+1.7%","d":"up"},{"l":"Satisfação (%)","v":"75.4%","t":"+8.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.302","8.883","8.785","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.369","1.315","2.309","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.981","5.429","3.773","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.871","1.489","1.318","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.815","6.132","6.592","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":712},{"label":"Fev","value":708},{"label":"Mar","value":470},{"label":"Abr","value":680},{"label":"Mai","value":715},{"label":"Jun","value":532},{"label":"Jul","value":726},{"label":"Ago","value":575},{"label":"Set","value":635},{"label":"Out","value":515},{"label":"Nov","value":457},{"label":"Dez","value":625}];
const MX = 726;
