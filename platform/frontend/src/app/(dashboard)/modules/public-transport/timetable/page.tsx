...
const PAGE = "Timetable Mgmt";
const KPIS = [{"l":"Veículos Operação","v":"1.892","t":"+16.7%","d":"up"},{"l":"Viagens/Dia","v":"4763","t":"+3.2%","d":"up"},{"l":"Pontualidade (%)","v":"79.5%","t":"+10.1%","d":"up"},{"l":"Passageiros/Dia","v":"2198","t":"+4.0%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-24","2026-03-08","729","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-01","2026-02-19","2.902","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-16","2026-03-10","4.624","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-13","2026-03-07","4.082","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-14","2026-03-25","5.764","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":540},{"label":"Mar","value":728},{"label":"Abr","value":561},{"label":"Mai","value":667},{"label":"Jun","value":639},{"label":"Jul","value":643},{"label":"Ago","value":600},{"label":"Set","value":833},{"label":"Out","value":636},{"label":"Nov","value":628},{"label":"Dez","value":781}];
const MX = 833;
