...
const PAGE = "Route Planning";
const KPIS = [{"l":"Veículos Operação","v":"1.437","t":"+7.3%","d":"up"},{"l":"Viagens/Dia","v":"1107","t":"-0.4%","d":"down"},{"l":"Pontualidade (%)","v":"93.9%","t":"+4.4%","d":"up"},{"l":"Passageiros/Dia","v":"682","t":"+4.7%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-15","2026-01-05","925","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-12","2026-01-08","8.514","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-05","2026-01-15","5.773","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-14","2026-03-21","642","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-03","2026-03-20","4.731","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":428},{"label":"Fev","value":548},{"label":"Mar","value":477},{"label":"Abr","value":380},{"label":"Mai","value":707},{"label":"Jun","value":450},{"label":"Jul","value":552},{"label":"Ago","value":646},{"label":"Set","value":678},{"label":"Out","value":543},{"label":"Nov","value":472},{"label":"Dez","value":559}];
const MX = 707;
