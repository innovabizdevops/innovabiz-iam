...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"4.887","t":"+11.5%","d":"up"},{"l":"Submissões/Dia","v":"3330","t":"+6.4%","d":"up"},{"l":"Documentos Gerados","v":"6.157","t":"+14.1%","d":"up"},{"l":"Templates","v":"7.721","t":"+11.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.380","2026-01-09","7.654","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.847","2026-02-25","293","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.763","2026-02-03","4.494","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.908","2026-02-21","5.772","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.644","2026-03-18","949","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":789},{"label":"Mar","value":786},{"label":"Abr","value":485},{"label":"Mai","value":755},{"label":"Jun","value":731},{"label":"Jul","value":822},{"label":"Ago","value":796},{"label":"Set","value":791},{"label":"Out","value":615},{"label":"Nov","value":733},{"label":"Dez","value":532}];
const MX = 822;
