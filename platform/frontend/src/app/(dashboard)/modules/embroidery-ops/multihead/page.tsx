...
const PAGE = "Multi-Head";
const KPIS = [{"l":"Total Embroidery Ops","v":"5.331","t":"-0.7%","d":"down"},{"l":"Multi Head Ativos","v":"640","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"90.7%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"94","t":"-2.8%","d":"down"}];
const COLS = ["ID","Multi Head","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Embroidery Ops #001","Embroidery Ops #002","9.061","493","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Embroidery Ops #002","Embroidery Ops #003","312","7.438","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Embroidery Ops #003","Embroidery Ops #004","4.787","9.010","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Embroidery Ops #004","Embroidery Ops #005","4.254","1.012","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Embroidery Ops #005","Embroidery Ops #001","8.754","3.593","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":987},{"label":"Fev","value":1015},{"label":"Mar","value":708},{"label":"Abr","value":760},{"label":"Mai","value":820},{"label":"Jun","value":781},{"label":"Jul","value":783},{"label":"Ago","value":738},{"label":"Set","value":812},{"label":"Out","value":821},{"label":"Nov","value":1013},{"label":"Dez","value":823}];
const MX = 1015;
