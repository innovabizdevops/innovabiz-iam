...
const ACCENT = "#6366f1";
const MODULE = "Embroidery Operations";
const PAGE = "Production";
const KPIS = [{"l":"Total Embroidery Ops","v":"7.208","t":"+1.1%","d":"up"},{"l":"Production Ativos","v":"3.712","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"70.8%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"91","t":"+2.0%","d":"up"}];
const COLS = ["ID","Production","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Embroidery Ops #001","Embroidery Ops #002","2.058","6.095","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Embroidery Ops #002","Embroidery Ops #003","8.112","9.043","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Embroidery Ops #003","Embroidery Ops #004","2.017","3.142","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Embroidery Ops #004","Embroidery Ops #005","3.443","5.403","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Embroidery Ops #005","Embroidery Ops #001","6.370","6.210","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":552},{"label":"Mar","value":425},{"label":"Abr","value":497},{"label":"Mai","value":664},{"label":"Jun","value":660},{"label":"Jul","value":553},{"label":"Ago","value":736},{"label":"Set","value":778},{"label":"Out","value":623},{"label":"Nov","value":679},{"label":"Dez","value":632}];
const MX = 778;
