...
const PAGE = "Digitize";
const KPIS = [{"l":"Total Embroidery Ops","v":"8.578","t":"-4.7%","d":"down"},{"l":"Digitize Ativos","v":"5.308","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"70.3%","t":"+17.2%","d":"up"},{"l":"Score Performance","v":"85","t":"-1.1%","d":"down"}];
const COLS = ["ID","Digitize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Embroidery Ops #001","Embroidery Ops #002","6.412","3.567","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Embroidery Ops #002","Embroidery Ops #003","2.926","486","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Embroidery Ops #003","Embroidery Ops #004","3.397","2.602","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Embroidery Ops #004","Embroidery Ops #005","2.303","4.798","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Embroidery Ops #005","Embroidery Ops #001","5.433","7.466","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":975},{"label":"Fev","value":602},{"label":"Mar","value":597},{"label":"Abr","value":823},{"label":"Mai","value":935},{"label":"Jun","value":904},{"label":"Jul","value":856},{"label":"Ago","value":961},{"label":"Set","value":778},{"label":"Out","value":880},{"label":"Nov","value":964},{"label":"Dez","value":615}];
const MX = 975;
