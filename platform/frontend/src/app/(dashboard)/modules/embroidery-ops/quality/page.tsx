...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.782","t":"+7.4%","d":"up"},{"l":"NC Abertas","v":"7.560","t":"+2.9%","d":"up"},{"l":"Conformidade (%)","v":"71.9%","t":"-4.1%","d":"down"},{"l":"CAPAs Pendentes","v":"8.542","t":"+1.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.146","99.1%","4.302","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.257","86.4%","3.020","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","9.094","96.2%","8.080","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.495","71.7%","7.131","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.195","80.7%","8.319","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":764},{"label":"Fev","value":588},{"label":"Mar","value":589},{"label":"Abr","value":799},{"label":"Mai","value":644},{"label":"Jun","value":627},{"label":"Jul","value":860},{"label":"Ago","value":546},{"label":"Set","value":883},{"label":"Out","value":828},{"label":"Nov","value":898},{"label":"Dez","value":689}];
const MX = 898;
