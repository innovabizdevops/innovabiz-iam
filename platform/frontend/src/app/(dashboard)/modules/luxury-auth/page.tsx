...
/* ═══ Luxury Authentication — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "6759", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3189", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€205K", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2070542159", cells: ["LUX-3159", "Luxury Authentication Item 1", "8/12/2026", "€42 259"], status: "active" as const },
    { id: "2070545730", cells: ["LUX-6730", "Luxury Authentication Item 2", "23/7/2026", "€45 830"], status: "pending" as const },
    { id: "2070549301", cells: ["LUX-1301", "Luxury Authentication Item 3", "10/2/2026", "€49 401"], status: "completed" as const },
    { id: "2070552872", cells: ["LUX-4872", "Luxury Authentication Item 4", "25/9/2026", "€2972"], status: "warning" as const },
    { id: "2070556443", cells: ["LUX-8443", "Luxury Authentication Item 5", "12/4/2026", "€6543"], status: "active" as const },
];
...
export default function LuxuryAuthenticationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Luxury Authentication</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Luxury Authentication</p>
                    </div>
                </div>
