...
const KPIS = [{"l":"Utilizadores Ativos","v":"7.987","t":"+15.5%","d":"up"},{"l":"Sessões/Dia","v":"4684","t":"+11.6%","d":"up"},{"l":"MFA Adoção (%)","v":"91.2%","t":"+7.3%","d":"up"},{"l":"Tentativas Bloqueadas","v":"8.235","t":"-0.6%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.190","5.808","7.696","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.010","1.670","7.190","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.108","427","6.097","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","526","651","1.425","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.661","9.099","2.605","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":812},{"label":"Mar","value":926},{"label":"Abr","value":852},{"label":"Mai","value":582},{"label":"Jun","value":776},{"label":"Jul","value":582},{"label":"Ago","value":878},{"label":"Set","value":891},{"label":"Out","value":746},{"label":"Nov","value":609},{"label":"Dez","value":758}];
const MX = 926;
