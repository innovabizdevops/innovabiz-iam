...
const PAGE = "Verify";
const KPIS = [{"l":"Utilizadores Ativos","v":"1.127","t":"+8.2%","d":"up"},{"l":"Sessões/Dia","v":"4044","t":"-1.3%","d":"down"},{"l":"MFA Adoção (%)","v":"71.7%","t":"+16.9%","d":"up"},{"l":"Tentativas Bloqueadas","v":"8.095","t":"+6.6%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","4.608","1.866","779","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","2.007","6.287","7.423","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.689","3.220","1.188","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","231","297","2.497","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","3.352","4.522","2.160","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":948},{"label":"Mar","value":779},{"label":"Abr","value":862},{"label":"Mai","value":705},{"label":"Jun","value":855},{"label":"Jul","value":937},{"label":"Ago","value":835},{"label":"Set","value":1071},{"label":"Out","value":782},{"label":"Nov","value":945},{"label":"Dez","value":918}];
const MX = 1071;
