...
const PAGE = "Report";
const KPIS = [{"l":"Utilizadores Ativos","v":"1.322","t":"+4.8%","d":"up"},{"l":"Sessões/Dia","v":"4660","t":"-1.2%","d":"down"},{"l":"MFA Adoção (%)","v":"75.9%","t":"-1.9%","d":"down"},{"l":"Tentativas Bloqueadas","v":"8.865","t":"+1.9%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.199","7.824","5.742","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.017","1.839","5.087","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.879","8.275","5.988","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.206","7.529","230","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","2.083","1.022","8.665","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":615},{"label":"Mar","value":644},{"label":"Abr","value":394},{"label":"Mai","value":393},{"label":"Jun","value":543},{"label":"Jul","value":411},{"label":"Ago","value":513},{"label":"Set","value":605},{"label":"Out","value":439},{"label":"Nov","value":587},{"label":"Dez","value":511}];
const MX = 644;
