...
const ACCENT = "#be185d";
const MODULE = "Luxury Authentication";
const PAGE = "NFC";
const KPIS = [{"l":"Utilizadores Ativos","v":"9.100","t":"+11.8%","d":"up"},{"l":"Sessões/Dia","v":"3844","t":"-2.8%","d":"down"},{"l":"MFA Adoção (%)","v":"93.2%","t":"+4.9%","d":"up"},{"l":"Tentativas Bloqueadas","v":"2.923","t":"-5.7%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","8.629","4.985","6.997","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.797","6.504","1.667","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.079","8.293","6.713","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.404","5.275","3.722","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","2.465","7.058","4.200","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":811},{"label":"Mar","value":565},{"label":"Abr","value":481},{"label":"Mai","value":689},{"label":"Jun","value":665},{"label":"Jul","value":846},{"label":"Ago","value":789},{"label":"Set","value":856},{"label":"Out","value":729},{"label":"Nov","value":809},{"label":"Dez","value":599}];
const MX = 856;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#be185d'}}>IoT</span></h1>
                </div>
