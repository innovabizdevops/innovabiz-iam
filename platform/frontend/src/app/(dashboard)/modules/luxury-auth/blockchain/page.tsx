...
const KPIS = [{"l":"Utilizadores Ativos","v":"6.622","t":"+8.8%","d":"up"},{"l":"Sessões/Dia","v":"3984","t":"+4.1%","d":"up"},{"l":"MFA Adoção (%)","v":"80.7%","t":"-2.3%","d":"down"},{"l":"Tentativas Bloqueadas","v":"8.374","t":"+3.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","5.434","3.747","401","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.746","2.662","1.578","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.176","7.967","2.964","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","677","5.917","5.966","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.526","4.289","2.334","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":803},{"label":"Mar","value":1081},{"label":"Abr","value":721},{"label":"Mai","value":781},{"label":"Jun","value":966},{"label":"Jul","value":769},{"label":"Ago","value":925},{"label":"Set","value":827},{"label":"Out","value":1041},{"label":"Nov","value":864},{"label":"Dez","value":905}];
const MX = 1081;
