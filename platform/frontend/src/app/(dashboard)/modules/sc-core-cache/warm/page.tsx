...
const PAGE = "Warm";
const KPIS = [{"l":"Total Sc Core Cache","v":"2.353","t":"+12.5%","d":"up"},{"l":"Warm Ativos","v":"1.684","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"91.3%","t":"+15.2%","d":"up"},{"l":"Score Performance","v":"59","t":"+11.7%","d":"up"}];
const COLS = ["ID","Warm","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Cache #001","Sc Core Cache #002","3.566","2.398","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Cache #002","Sc Core Cache #003","3.383","368","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Cache #003","Sc Core Cache #004","8.016","1.698","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Cache #004","Sc Core Cache #005","8.987","1.899","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Cache #005","Sc Core Cache #001","3.252","7.373","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":859},{"label":"Fev","value":597},{"label":"Mar","value":751},{"label":"Abr","value":603},{"label":"Mai","value":668},{"label":"Jun","value":840},{"label":"Jul","value":560},{"label":"Ago","value":581},{"label":"Set","value":585},{"label":"Out","value":886},{"label":"Nov","value":824},{"label":"Dez","value":729}];
const MX = 886;
