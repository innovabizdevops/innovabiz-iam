...
const KPIS = [{"l":"Total Sc Core Cache","v":"2.548","t":"+15.5%","d":"up"},{"l":"Invalidate Ativos","v":"7.974","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"83.3%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"74","t":"+14.7%","d":"up"}];
const COLS = ["ID","Invalidate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Cache #001","Sc Core Cache #002","709","3.805","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Cache #002","Sc Core Cache #003","3.394","957","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Cache #003","Sc Core Cache #004","8.488","2.758","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Cache #004","Sc Core Cache #005","7.776","4.120","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Cache #005","Sc Core Cache #001","3.797","7.535","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":666},{"label":"Mar","value":813},{"label":"Abr","value":887},{"label":"Mai","value":855},{"label":"Jun","value":698},{"label":"Jul","value":835},{"label":"Ago","value":828},{"label":"Set","value":975},{"label":"Out","value":911},{"label":"Nov","value":854},{"label":"Dez","value":932}];
const MX = 975;
