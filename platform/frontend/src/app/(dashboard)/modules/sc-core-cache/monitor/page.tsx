...
const PAGE = "Monitor";
const KPIS = [{"l":"Total Sc Core Cache","v":"960","t":"+10.0%","d":"up"},{"l":"Monitor Ativos","v":"1.399","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"82.2%","t":"+9.3%","d":"up"},{"l":"Score Performance","v":"75","t":"+5.7%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Cache #001","Sc Core Cache #002","5.893","3.746","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Cache #002","Sc Core Cache #003","1.109","5.007","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Cache #003","Sc Core Cache #004","903","2.759","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Cache #004","Sc Core Cache #005","1.310","6.031","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Cache #005","Sc Core Cache #001","8.696","6.068","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":434},{"label":"Fev","value":476},{"label":"Mar","value":226},{"label":"Abr","value":253},{"label":"Mai","value":307},{"label":"Jun","value":281},{"label":"Jul","value":290},{"label":"Ago","value":545},{"label":"Set","value":242},{"label":"Out","value":571},{"label":"Nov","value":485},{"label":"Dez","value":362}];
const MX = 571;
