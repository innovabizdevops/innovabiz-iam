...
/* ═══ SC: Core Cache Engine — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "900", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1509", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€105K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "304980200", cells: ["SC-7200", "SC: Core Cache Engine Item 1", "1/9/2026", "€30 300"], status: "active" as const },
    { id: "304983771", cells: ["SC-1771", "SC: Core Cache Engine Item 2", "16/4/2026", "€33 871"], status: "pending" as const },
    { id: "304987342", cells: ["SC-5342", "SC: Core Cache Engine Item 3", "3/11/2026", "€37 442"], status: "completed" as const },
    { id: "304990913", cells: ["SC-8913", "SC: Core Cache Engine Item 4", "18/6/2026", "€41 013"], status: "warning" as const },
    { id: "304994484", cells: ["SC-3484", "SC: Core Cache Engine Item 5", "5/1/2026", "€44 584"], status: "active" as const },
];
...
export default function ScCoreCacheEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: Core Cache Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: Core Cache Engine</p>
                    </div>
                </div>
