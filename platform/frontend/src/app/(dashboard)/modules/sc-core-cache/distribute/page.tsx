...
const ACCENT = "#0284c7";
const MODULE = "SC: Core Cache Engine";
const PAGE = "Distribute";
const KPIS = [{"l":"Total Sc Core Cache","v":"5.104","t":"+16.9%","d":"up"},{"l":"Distribute Ativos","v":"3.964","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"81.2%","t":"+17.8%","d":"up"},{"l":"Score Performance","v":"60","t":"+17.7%","d":"up"}];
const COLS = ["ID","Distribute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Cache #001","Sc Core Cache #002","4.426","8.463","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Cache #002","Sc Core Cache #003","6.181","6.413","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Cache #003","Sc Core Cache #004","6.146","2.047","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Cache #004","Sc Core Cache #005","7.994","5.814","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Cache #005","Sc Core Cache #001","4.857","8.457","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":417},{"label":"Fev","value":333},{"label":"Mar","value":322},{"label":"Abr","value":576},{"label":"Mai","value":554},{"label":"Jun","value":440},{"label":"Jul","value":323},{"label":"Ago","value":674},{"label":"Set","value":536},{"label":"Out","value":480},{"label":"Nov","value":362},{"label":"Dez","value":563}];
const MX = 674;
