...
const PAGE = "Strategy";
const KPIS = [{"l":"Total Sc Core Cache","v":"4.520","t":"+1.7%","d":"up"},{"l":"Strategy Ativos","v":"4.542","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"92.6%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"66","t":"+15.9%","d":"up"}];
const COLS = ["ID","Strategy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Cache #001","Sc Core Cache #002","5.364","2.674","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Cache #002","Sc Core Cache #003","1.966","3.020","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Cache #003","Sc Core Cache #004","1.618","3.967","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Cache #004","Sc Core Cache #005","2.013","5.350","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Cache #005","Sc Core Cache #001","8.793","357","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":751},{"label":"Mar","value":781},{"label":"Abr","value":655},{"label":"Mai","value":750},{"label":"Jun","value":617},{"label":"Jul","value":560},{"label":"Ago","value":520},{"label":"Set","value":543},{"label":"Out","value":455},{"label":"Nov","value":432},{"label":"Dez","value":740}];
const MX = 781;
