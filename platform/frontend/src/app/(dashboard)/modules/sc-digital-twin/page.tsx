...
/* ═══ Supply Chain Digital Twin — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "6257", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4274", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€340K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1073710657", cells: ["SC-2657", "Supply Chain Digital Twin Item 1", "6/2/2026", "€10 757"], status: "active" as const },
    { id: "1073714228", cells: ["SC-6228", "Supply Chain Digital Twin Item 2", "21/9/2026", "€14 328"], status: "pending" as const },
    { id: "1073717799", cells: ["SC-9799", "Supply Chain Digital Twin Item 3", "8/4/2026", "€17 899"], status: "completed" as const },
    { id: "1073721370", cells: ["SC-4370", "Supply Chain Digital Twin Item 4", "23/11/2026", "€21 470"], status: "warning" as const },
    { id: "1073724941", cells: ["SC-7941", "Supply Chain Digital Twin Item 5", "10/6/2026", "€25 041"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Supply Chain Digital Twin</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Supply Chain Digital Twin</p>
                    </div>
                </div>
