...
const ACCENT = "#78350f";
const MODULE = "Supply Chain Digital Twin";
const PAGE = "Predict";
const KPIS = [{"l":"Twins Ativos","v":"2.695","t":"+0.8%","d":"up"},{"l":"Simulações/Dia","v":"3388","t":"+6.4%","d":"up"},{"l":"Precisão Modelo (%)","v":"68.8%","t":"-0.3%","d":"down"},{"l":"Latência Sync (ms)","v":"15ms","t":"+4.4%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","97.5%","2026-01-09","3.282","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","73.5%","2026-02-24","5.610","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","71.7%","2026-01-08","9.039","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","86.8%","2026-02-25","8.631","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","77.8%","2026-01-02","8.100","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":953},{"label":"Fev","value":703},{"label":"Mar","value":905},{"label":"Abr","value":776},{"label":"Mai","value":991},{"label":"Jun","value":1020},{"label":"Jul","value":1011},{"label":"Ago","value":815},{"label":"Set","value":909},{"label":"Out","value":658},{"label":"Nov","value":989},{"label":"Dez","value":828}];
const MX = 1020;
