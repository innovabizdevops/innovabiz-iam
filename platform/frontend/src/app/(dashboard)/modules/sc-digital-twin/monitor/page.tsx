...
const PAGE = "Monitor";
const KPIS = [{"l":"Twins Ativos","v":"6.488","t":"+9.6%","d":"up"},{"l":"Simulações/Dia","v":"3397","t":"+0.2%","d":"up"},{"l":"Precisão Modelo (%)","v":"87.0%","t":"+17.3%","d":"up"},{"l":"Latência Sync (ms)","v":"171ms","t":"+1.9%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","82.0%","2026-03-04","4.575","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","82.3%","2026-01-27","713","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","88.6%","2026-02-24","4.101","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","76.2%","2026-02-17","5.207","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","74.5%","2026-02-17","7.563","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":719},{"label":"Mar","value":676},{"label":"Abr","value":398},{"label":"Mai","value":569},{"label":"Jun","value":534},{"label":"Jul","value":379},{"label":"Ago","value":370},{"label":"Set","value":522},{"label":"Out","value":580},{"label":"Nov","value":687},{"label":"Dez","value":418}];
const MX = 719;
