...
const PAGE = "Model";
const KPIS = [{"l":"Twins Ativos","v":"7.319","t":"+7.6%","d":"up"},{"l":"Simulações/Dia","v":"3599","t":"-1.5%","d":"down"},{"l":"Precisão Modelo (%)","v":"95.0%","t":"+1.1%","d":"up"},{"l":"Latência Sync (ms)","v":"187ms","t":"+12.0%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","98.0%","2026-03-01","8.850","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","72.4%","2026-03-18","3.130","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","85.8%","2026-01-22","7.705","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","98.1%","2026-03-12","3.054","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","92.2%","2026-01-09","7.038","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":692},{"label":"Mar","value":742},{"label":"Abr","value":701},{"label":"Mai","value":562},{"label":"Jun","value":636},{"label":"Jul","value":836},{"label":"Ago","value":700},{"label":"Set","value":768},{"label":"Out","value":800},{"label":"Nov","value":579},{"label":"Dez","value":868}];
const MX = 868;
