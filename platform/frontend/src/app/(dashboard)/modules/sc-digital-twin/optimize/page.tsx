...
const PAGE = "Optimize";
const KPIS = [{"l":"Twins Ativos","v":"3.333","t":"+3.6%","d":"up"},{"l":"Simulações/Dia","v":"4735","t":"+8.8%","d":"up"},{"l":"Precisão Modelo (%)","v":"70.1%","t":"-1.2%","d":"down"},{"l":"Latência Sync (ms)","v":"16ms","t":"+2.7%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","84.2%","2026-02-26","5.063","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","94.9%","2026-01-07","5.852","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","81.6%","2026-01-17","4.359","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","80.2%","2026-02-12","6.117","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","81.0%","2026-01-06","997","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":386},{"label":"Mar","value":556},{"label":"Abr","value":418},{"label":"Mai","value":471},{"label":"Jun","value":604},{"label":"Jul","value":404},{"label":"Ago","value":458},{"label":"Set","value":546},{"label":"Out","value":449},{"label":"Nov","value":519},{"label":"Dez","value":495}];
const MX = 604;
