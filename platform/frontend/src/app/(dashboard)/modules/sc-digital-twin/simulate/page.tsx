...
const PAGE = "Simulate";
const KPIS = [{"l":"Twins Ativos","v":"3.026","t":"-3.4%","d":"down"},{"l":"Simulações/Dia","v":"1255","t":"-4.0%","d":"down"},{"l":"Precisão Modelo (%)","v":"82.8%","t":"+4.2%","d":"up"},{"l":"Latência Sync (ms)","v":"178ms","t":"+9.9%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","93.7%","2026-02-23","397","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","96.7%","2026-03-02","4.935","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","71.3%","2026-03-18","1.984","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","71.1%","2026-01-24","344","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","97.8%","2026-01-22","8.180","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":534},{"label":"Mar","value":623},{"label":"Abr","value":395},{"label":"Mai","value":766},{"label":"Jun","value":625},{"label":"Jul","value":706},{"label":"Ago","value":478},{"label":"Set","value":690},{"label":"Out","value":727},{"label":"Nov","value":640},{"label":"Dez","value":456}];
const MX = 766;
