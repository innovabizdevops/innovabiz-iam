...
const ACCENT = "#78350f";
const MODULE = "Airport Commercial";
const PAGE = "Parking Rev";
const KPIS = [{"l":"Total Airport Commercial","v":"4.451","t":"+17.9%","d":"up"},{"l":"Parking Rev Ativos","v":"4.140","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"79.0%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"66","t":"+16.5%","d":"up"}];
const COLS = ["ID","Parking Rev","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airport Commercial #001","Airport Commercial #002","6.301","8.306","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Airport Commercial #002","Airport Commercial #003","105","2.990","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Airport Commercial #003","Airport Commercial #004","3.120","311","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Airport Commercial #004","Airport Commercial #005","7.912","809","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airport Commercial #005","Airport Commercial #001","4.886","267","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":797},{"label":"Fev","value":1049},{"label":"Mar","value":1022},{"label":"Abr","value":1042},{"label":"Mai","value":813},{"label":"Jun","value":799},{"label":"Jul","value":741},{"label":"Ago","value":701},{"label":"Set","value":999},{"label":"Out","value":872},{"label":"Nov","value":663},{"label":"Dez","value":775}];
const MX = 1049;
