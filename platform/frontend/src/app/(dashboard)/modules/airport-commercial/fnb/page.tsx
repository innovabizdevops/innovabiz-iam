...
const PAGE = "F&amp;B Tenant";
const KPIS = [{"l":"Configurações","v":"374","t":"+14.6%","d":"up"},{"l":"Últimas Alterações","v":"2.485","t":"+14.7%","d":"up"},{"l":"Ambientes","v":"3.557","t":"-2.3%","d":"down"},{"l":"Versão Config","v":"2.607","t":"+10.8%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 46082.80","5.878","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 31898.46","4.509","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 131.62","4.289","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 48959.18","5.243","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 46534.12","4.152","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":421},{"label":"Fev","value":309},{"label":"Mar","value":463},{"label":"Abr","value":674},{"label":"Mai","value":438},{"label":"Jun","value":510},{"label":"Jul","value":336},{"label":"Ago","value":609},{"label":"Set","value":587},{"label":"Out","value":347},{"label":"Nov","value":666},{"label":"Dez","value":612}];
const MX = 674;
