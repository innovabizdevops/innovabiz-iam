...
export default function AirportCommercialPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Airport Commercial</h1><p className="text-sm text-muted-foreground">Airport Commercial • iBOS Enterprise</p></div>
