...
const PAGE = "Duty Free";
const KPIS = [{"l":"Total Airport Commercial","v":"5.775","t":"+1.6%","d":"up"},{"l":"Duty Free Ativos","v":"4.268","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"78.5%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"85","t":"-2.3%","d":"down"}];
const COLS = ["ID","Duty Free","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airport Commercial #001","Airport Commercial #002","1.650","8.172","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Airport Commercial #002","Airport Commercial #003","8.077","7.817","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Airport Commercial #003","Airport Commercial #004","8.367","4.404","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Airport Commercial #004","Airport Commercial #005","8.228","1.674","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airport Commercial #005","Airport Commercial #001","2.662","4.194","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":630},{"label":"Mar","value":416},{"label":"Abr","value":631},{"label":"Mai","value":489},{"label":"Jun","value":568},{"label":"Jul","value":787},{"label":"Ago","value":507},{"label":"Set","value":571},{"label":"Out","value":760},{"label":"Nov","value":715},{"label":"Dez","value":413}];
const MX = 787;
