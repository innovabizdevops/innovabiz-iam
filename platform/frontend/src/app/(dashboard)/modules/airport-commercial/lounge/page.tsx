...
const PAGE = "Lounge";
const KPIS = [{"l":"Total Airport Commercial","v":"7.735","t":"+2.2%","d":"up"},{"l":"Lounge Ativos","v":"8.030","t":"+5.8%","d":"up"},{"l":"Eficiência (%)","v":"80.4%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"81","t":"+2.1%","d":"up"}];
const COLS = ["ID","Lounge","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airport Commercial #001","Airport Commercial #002","2.271","2.992","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Airport Commercial #002","Airport Commercial #003","2.203","6.880","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Airport Commercial #003","Airport Commercial #004","2.485","7.275","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Airport Commercial #004","Airport Commercial #005","2.408","2.342","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airport Commercial #005","Airport Commercial #001","8.033","7.712","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":496},{"label":"Mar","value":331},{"label":"Abr","value":510},{"label":"Mai","value":388},{"label":"Jun","value":478},{"label":"Jul","value":462},{"label":"Ago","value":259},{"label":"Set","value":513},{"label":"Out","value":266},{"label":"Nov","value":395},{"label":"Dez","value":227}];
const MX = 524;
