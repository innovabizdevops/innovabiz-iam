...
const ACCENT = "#713f12";
const MODULE = "Vintage Watch";
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"8.107","t":"-1.6%","d":"down"},{"l":"Queries/Dia","v":"1241","t":"+9.7%","d":"up"},{"l":"Dados Processados (GB)","v":"3.230","t":"+14.4%","d":"up"},{"l":"Utilizadores Analytics","v":"940","t":"+9.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3938","2026-03-10","3.907","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3935","2026-02-20","1.036","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","437","2026-01-16","2.536","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","564","2026-02-25","2.132","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3884","2026-03-08","4.257","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":480},{"label":"Mar","value":399},{"label":"Abr","value":344},{"label":"Mai","value":454},{"label":"Jun","value":697},{"label":"Jul","value":638},{"label":"Ago","value":567},{"label":"Set","value":399},{"label":"Out","value":351},{"label":"Nov","value":526},{"label":"Dez","value":434}];
const MX = 697;
