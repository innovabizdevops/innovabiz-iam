...
const KPIS = [{"l":"Utilizadores Ativos","v":"5.609","t":"+12.9%","d":"up"},{"l":"Sessões/Dia","v":"1013","t":"+2.3%","d":"up"},{"l":"MFA Adoção (%)","v":"70.0%","t":"-2.8%","d":"down"},{"l":"Tentativas Bloqueadas","v":"5.706","t":"+1.5%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.927","4.452","4.994","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.202","461","5.956","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","2.900","5.022","3.003","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.005","6.548","3.043","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.366","3.186","3.693","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":801},{"label":"Mar","value":699},{"label":"Abr","value":831},{"label":"Mai","value":704},{"label":"Jun","value":556},{"label":"Jul","value":558},{"label":"Ago","value":502},{"label":"Set","value":830},{"label":"Out","value":752},{"label":"Nov","value":658},{"label":"Dez","value":521}];
const MX = 831;
