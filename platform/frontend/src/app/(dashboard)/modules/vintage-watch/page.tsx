...
/* ═══ Vintage Watch — Dashboard ═══ */

const ACCENT = "#713f12";

const KPIS = [
    { label: "Total Registos", value: "7131", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3197", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€308K", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1251386831", cells: ["VIN-9831", "Vintage Watch Item 1", "24/12/2026", "€36 931"], status: "active" as const },
    { id: "1251390402", cells: ["VIN-4402", "Vintage Watch Item 2", "11/7/2026", "€40 502"], status: "pending" as const },
    { id: "1251393973", cells: ["VIN-7973", "Vintage Watch Item 3", "26/2/2026", "€44 073"], status: "completed" as const },
    { id: "1251397544", cells: ["VIN-2544", "Vintage Watch Item 4", "13/9/2026", "€47 644"], status: "warning" as const },
    { id: "1251401115", cells: ["VIN-6115", "Vintage Watch Item 5", "28/4/2026", "€1215"], status: "active" as const },
];
...
export default function VintageWatchPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Vintage Watch</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Vintage Watch</p>
                    </div>
                </div>
