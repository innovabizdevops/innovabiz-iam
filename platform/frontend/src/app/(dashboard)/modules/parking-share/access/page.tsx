...
const ACCENT = "#6366f1";
const MODULE = "Parking Space Sharing";
const PAGE = "Access";
const KPIS = [{"l":"Total Parking Share","v":"2.493","t":"+17.6%","d":"up"},{"l":"Access Ativos","v":"4.012","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"74.7%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"59","t":"+1.8%","d":"up"}];
const COLS = ["ID","Access","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Parking Share #001","Parking Share #002","4.532","7.435","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Parking Share #002","Parking Share #003","938","8.716","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Parking Share #003","Parking Share #004","8.271","2.805","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Parking Share #004","Parking Share #005","798","8.531","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Parking Share #005","Parking Share #001","8.882","4.175","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":539},{"label":"Fev","value":414},{"label":"Mar","value":424},{"label":"Abr","value":362},{"label":"Mai","value":277},{"label":"Jun","value":556},{"label":"Jul","value":411},{"label":"Ago","value":511},{"label":"Set","value":282},{"label":"Out","value":476},{"label":"Nov","value":635},{"label":"Dez","value":655}];
const MX = 655;
