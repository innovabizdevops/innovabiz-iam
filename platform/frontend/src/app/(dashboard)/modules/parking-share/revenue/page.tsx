...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€13.7M","t":"+17.2%","d":"up"},{"l":"MRR (€)","v":"€99747","t":"+15.5%","d":"up"},{"l":"Churn (%)","v":"68.1%","t":"+10.0%","d":"up"},{"l":"ARPU (€)","v":"€76160","t":"+8.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 31782.29","8.691","€ 5539.44","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 11329.85","7.437","€ 49443.97","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 46641.52","657","€ 29478.17","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 43597.51","751","€ 44900.12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 426.48","8.841","€ 12050.28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":922},{"label":"Fev","value":623},{"label":"Mar","value":856},{"label":"Abr","value":589},{"label":"Mai","value":785},{"label":"Jun","value":828},{"label":"Jul","value":574},{"label":"Ago","value":877},{"label":"Set","value":870},{"label":"Out","value":653},{"label":"Nov","value":610},{"label":"Dez","value":771}];
const MX = 922;
