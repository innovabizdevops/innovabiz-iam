...
const PAGE = "Pay";
const KPIS = [{"l":"Total Parking Share","v":"6.063","t":"+10.4%","d":"up"},{"l":"Pay Ativos","v":"7.910","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"78.2%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"70","t":"+0.5%","d":"up"}];
const COLS = ["ID","Pay","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Parking Share #001","Parking Share #002","1.498","4.034","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Parking Share #002","Parking Share #003","602","4.479","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Parking Share #003","Parking Share #004","2.344","8.292","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Parking Share #004","Parking Share #005","930","6.929","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Parking Share #005","Parking Share #001","2.514","4.603","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":655},{"label":"Mar","value":671},{"label":"Abr","value":448},{"label":"Mai","value":762},{"label":"Jun","value":773},{"label":"Jul","value":431},{"label":"Ago","value":760},{"label":"Set","value":667},{"label":"Out","value":508},{"label":"Nov","value":758},{"label":"Dez","value":751}];
const MX = 773;
