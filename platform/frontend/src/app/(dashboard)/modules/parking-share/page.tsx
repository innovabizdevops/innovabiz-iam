...
/* ═══ Parking Space Sharing — Dashboard ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total Registos", value: "8319", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3322", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€260K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1673890319", cells: ["PAR-8319", "Parking Space Sharing Item 1", "4/12/2026", "€40 419"], status: "active" as const },
    { id: "1673893890", cells: ["PAR-2890", "Parking Space Sharing Item 2", "19/7/2026", "€43 990"], status: "pending" as const },
    { id: "1673897461", cells: ["PAR-6461", "Parking Space Sharing Item 3", "6/2/2026", "€47 561"], status: "completed" as const },
    { id: "1673901032", cells: ["PAR-1032", "Parking Space Sharing Item 4", "21/9/2026", "€1132"], status: "warning" as const },
    { id: "1673904603", cells: ["PAR-4603", "Parking Space Sharing Item 5", "8/4/2026", "€4703"], status: "active" as const },
];
...
export default function ParkingSpaceSharingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Parking Space Sharing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Parking Space Sharing</p>
                    </div>
                </div>
