...
/* ═══ Entertainment Ops — Ticketing Sys ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "3070", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "7", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "933", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1428100579", cells: ["ENT-8579", "Ticketing Sys Item 1", "4/8/2026", "€679"], status: "active" as const },
    { id: "1428104150", cells: ["ENT-3150", "Ticketing Sys Item 2", "19/3/2026", "€4250"], status: "pending" as const },
    { id: "1428107721", cells: ["ENT-6721", "Ticketing Sys Item 3", "6/10/2026", "€7821"], status: "completed" as const },
    { id: "1428111292", cells: ["ENT-1292", "Ticketing Sys Item 4", "21/5/2026", "€11 392"], status: "warning" as const },
    { id: "1428114863", cells: ["ENT-4863", "Ticketing Sys Item 5", "8/12/2026", "€14 963"], status: "active" as const },
];
...
export default function EntertainmentOpsTicketingSysPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ticketing Sys</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Entertainment Ops • Ticketing Sys</p>
                    </div>
                </div>
