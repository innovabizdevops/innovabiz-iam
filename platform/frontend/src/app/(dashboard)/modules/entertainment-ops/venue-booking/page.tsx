...
/* ═══ Entertainment Ops — Venue Booking ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "1850", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "188", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2776", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "513612664", cells: ["ENT-1664", "Venue Booking Item 1", "13/5/2026", "€12 764"], status: "active" as const },
    { id: "513616235", cells: ["ENT-5235", "Venue Booking Item 2", "28/12/2026", "€16 335"], status: "pending" as const },
    { id: "513619806", cells: ["ENT-8806", "Venue Booking Item 3", "15/7/2026", "€19 906"], status: "completed" as const },
    { id: "513623377", cells: ["ENT-3377", "Venue Booking Item 4", "2/2/2026", "€23 477"], status: "warning" as const },
    { id: "513626948", cells: ["ENT-6948", "Venue Booking Item 5", "17/9/2026", "€27 048"], status: "active" as const },
];
...
export default function EntertainmentOpsVenueBookingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Venue Booking</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Entertainment Ops • Venue Booking</p>
                    </div>
                </div>
