...
/* ═══ Entertainment Ops — Show Schedule ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "3635", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "94", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1904", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "721167738", cells: ["ENT-7738", "Show Schedule Item 1", "19/7/2026", "€17 838"], status: "active" as const },
    { id: "721171309", cells: ["ENT-2309", "Show Schedule Item 2", "6/2/2026", "€21 409"], status: "pending" as const },
    { id: "721174880", cells: ["ENT-5880", "Show Schedule Item 3", "21/9/2026", "€24 980"], status: "completed" as const },
    { id: "721178451", cells: ["ENT-9451", "Show Schedule Item 4", "8/4/2026", "€28 551"], status: "warning" as const },
    { id: "721182022", cells: ["ENT-4022", "Show Schedule Item 5", "23/11/2026", "€32 122"], status: "active" as const },
];
...
export default function EntertainmentOpsShowSchedulePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Show Schedule</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Entertainment Ops • Show Schedule</p>
                    </div>
                </div>
