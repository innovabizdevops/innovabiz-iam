...
/* ═══ Entertainment Ops — Content Licensing ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "673", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "253", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1096", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "94%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1897781577", cells: ["ENT-6577", "Content Licensing Item 1", "14/10/2026", "€31 677"], status: "active" as const },
    { id: "1897785148", cells: ["ENT-1148", "Content Licensing Item 2", "1/5/2026", "€35 248"], status: "pending" as const },
    { id: "1897788719", cells: ["ENT-4719", "Content Licensing Item 3", "16/12/2026", "€38 819"], status: "completed" as const },
    { id: "1897792290", cells: ["ENT-8290", "Content Licensing Item 4", "3/7/2026", "€42 390"], status: "warning" as const },
    { id: "1897795861", cells: ["ENT-2861", "Content Licensing Item 5", "18/2/2026", "€45 961"], status: "active" as const },
];
...
export default function EntertainmentOpsContentLicensingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Content Licensing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Entertainment Ops • Content Licensing</p>
                    </div>
                </div>
