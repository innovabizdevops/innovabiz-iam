...
/* ═══ Entertainment Ops — Artist Mgmt ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "1627", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "362", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3349", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "595823846", cells: ["ENT-6846", "Artist Mgmt Item 1", "3/3/2026", "€23 946"], status: "active" as const },
    { id: "595827417", cells: ["ENT-1417", "Artist Mgmt Item 2", "18/10/2026", "€27 517"], status: "pending" as const },
    { id: "595830988", cells: ["ENT-4988", "Artist Mgmt Item 3", "5/5/2026", "€31 088"], status: "completed" as const },
    { id: "595834559", cells: ["ENT-8559", "Artist Mgmt Item 4", "20/12/2026", "€34 659"], status: "warning" as const },
    { id: "595838130", cells: ["ENT-3130", "Artist Mgmt Item 5", "7/7/2026", "€38 230"], status: "active" as const },
];
...
export default function EntertainmentOpsArtistMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Artist Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Entertainment Ops • Artist Mgmt</p>
                    </div>
                </div>
