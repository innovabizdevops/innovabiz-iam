...
/* ═══ Entertainment Ops — Fan Club ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "2990", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "209", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3169", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "524995389", cells: ["ENT-8389", "Fan Club Item 1", "10/10/2026", "€45 489"], status: "active" as const },
    { id: "524998960", cells: ["ENT-2960", "Fan Club Item 2", "25/5/2026", "€49 060"], status: "pending" as const },
    { id: "525002531", cells: ["ENT-6531", "Fan Club Item 3", "12/12/2026", "€2631"], status: "completed" as const },
    { id: "525006102", cells: ["ENT-1102", "Fan Club Item 4", "27/7/2026", "€6202"], status: "warning" as const },
    { id: "525009673", cells: ["ENT-4673", "Fan Club Item 5", "14/2/2026", "€9773"], status: "active" as const },
];
...
export default function EntertainmentOpsFanClubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fan Club</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Entertainment Ops • Fan Club</p>
                    </div>
                </div>
