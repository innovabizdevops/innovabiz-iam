...
/* ═══ Entertainment Ops — Streaming Rights ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "4977", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "329", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1143", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "86%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "412790389", cells: ["ENT-6389", "Streaming Rights Item 1", "26/2/2026", "€40 489"], status: "active" as const },
    { id: "412793960", cells: ["ENT-9960", "Streaming Rights Item 2", "13/9/2026", "€44 060"], status: "pending" as const },
    { id: "412797531", cells: ["ENT-4531", "Streaming Rights Item 3", "28/4/2026", "€47 631"], status: "completed" as const },
    { id: "412801102", cells: ["ENT-8102", "Streaming Rights Item 4", "15/11/2026", "€1202"], status: "warning" as const },
    { id: "412804673", cells: ["ENT-2673", "Streaming Rights Item 5", "2/6/2026", "€4773"], status: "active" as const },
];
...
export default function EntertainmentOpsStreamingRightsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Streaming Rights</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Entertainment Ops • Streaming Rights</p>
                    </div>
                </div>
