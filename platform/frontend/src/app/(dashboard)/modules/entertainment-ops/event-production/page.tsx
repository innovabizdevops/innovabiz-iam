...
/* ═══ Entertainment Ops — Event Production ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "723", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "499", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "840", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "664187167", cells: ["ENT-6167", "Event Production Item 1", "8/8/2026", "€37 267"], status: "active" as const },
    { id: "664190738", cells: ["ENT-9738", "Event Production Item 2", "23/3/2026", "€40 838"], status: "pending" as const },
    { id: "664194309", cells: ["ENT-4309", "Event Production Item 3", "10/10/2026", "€44 409"], status: "completed" as const },
    { id: "664197880", cells: ["ENT-7880", "Event Production Item 4", "25/5/2026", "€47 980"], status: "warning" as const },
    { id: "664201451", cells: ["ENT-2451", "Event Production Item 5", "12/12/2026", "€1551"], status: "active" as const },
];
...
export default function EntertainmentOpsEventProductionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Event Production</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Entertainment Ops • Event Production</p>
                    </div>
                </div>
