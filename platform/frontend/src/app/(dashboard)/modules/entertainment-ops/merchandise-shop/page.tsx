...
/* ═══ Entertainment Ops — Merchandise Shop ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "1449", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "305", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1244", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "88%", trend: "-14%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "151383981", cells: ["ENT-4981", "Merchandise Shop Item 1", "22/10/2026", "€34 081"], status: "active" as const },
    { id: "151387552", cells: ["ENT-8552", "Merchandise Shop Item 2", "9/5/2026", "€37 652"], status: "pending" as const },
    { id: "151391123", cells: ["ENT-3123", "Merchandise Shop Item 3", "24/12/2026", "€41 223"], status: "completed" as const },
    { id: "151394694", cells: ["ENT-6694", "Merchandise Shop Item 4", "11/7/2026", "€44 794"], status: "warning" as const },
    { id: "151398265", cells: ["ENT-1265", "Merchandise Shop Item 5", "26/2/2026", "€48 365"], status: "active" as const },
];
...
export default function EntertainmentOpsMerchandiseShopPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Merchandise Shop</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Entertainment Ops • Merchandise Shop</p>
                    </div>
                </div>
