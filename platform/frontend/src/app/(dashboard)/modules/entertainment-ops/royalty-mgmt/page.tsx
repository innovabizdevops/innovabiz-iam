...
/* ═══ Entertainment Ops — Royalty Mgmt ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "1925", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "185", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1830", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1487707061", cells: ["ENT-8061", "Royalty Mgmt Item 1", "2/6/2026", "€7161"], status: "active" as const },
    { id: "1487710632", cells: ["ENT-2632", "Royalty Mgmt Item 2", "17/1/2026", "€10 732"], status: "pending" as const },
    { id: "1487714203", cells: ["ENT-6203", "Royalty Mgmt Item 3", "4/8/2026", "€14 303"], status: "completed" as const },
    { id: "1487717774", cells: ["ENT-9774", "Royalty Mgmt Item 4", "19/3/2026", "€17 874"], status: "warning" as const },
    { id: "1487721345", cells: ["ENT-4345", "Royalty Mgmt Item 5", "6/10/2026", "€21 445"], status: "active" as const },
];
...
export default function EntertainmentOpsRoyaltyMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Royalty Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Entertainment Ops • Royalty Mgmt</p>
                    </div>
                </div>
