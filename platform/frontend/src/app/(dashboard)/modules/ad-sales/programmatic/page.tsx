...
const PAGE = "Programmatic";
const KPIS = [{"l":"Vendas YTD (€)","v":"€8318","t":"+14.2%","d":"up"},{"l":"Pipeline (€)","v":"€14975","t":"+8.6%","d":"up"},{"l":"Atingimento Quota (%)","v":"93.2%","t":"-1.8%","d":"down"},{"l":"Win Rate (%)","v":"71.4%","t":"-5.6%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 2062.70","€ 5680.64","€ 33907.12","78.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 45188.12","€ 40753.14","€ 47398.86","74.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 36415.80","€ 49541.70","€ 12061.58","86.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 44783.48","€ 46923.98","€ 3501.22","71.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 25191.19","€ 3479.59","€ 12548.20","74.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":373},{"label":"Mar","value":661},{"label":"Abr","value":561},{"label":"Mai","value":371},{"label":"Jun","value":424},{"label":"Jul","value":688},{"label":"Ago","value":600},{"label":"Set","value":428},{"label":"Out","value":610},{"label":"Nov","value":604},{"label":"Dez","value":674}];
const MX = 688;
