...
const KPIS = [{"l":"Vendas YTD (€)","v":"€41856","t":"-1.8%","d":"down"},{"l":"Pipeline (€)","v":"€51206","t":"+2.8%","d":"up"},{"l":"Atingimento Quota (%)","v":"65.9%","t":"+8.4%","d":"up"},{"l":"Win Rate (%)","v":"81.6%","t":"+5.0%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 39421.34","€ 29973.81","€ 43924.71","92.5%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 47625.94","€ 14704.91","€ 35373.31","81.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 8939.60","€ 22160.99","€ 35904.76","96.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 33330.62","€ 45659.80","€ 11462.59","94.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 38178.91","€ 41797.30","€ 48328.04","72.1%"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":954},{"label":"Mar","value":651},{"label":"Abr","value":1026},{"label":"Mai","value":889},{"label":"Jun","value":920},{"label":"Jul","value":939},{"label":"Ago","value":792},{"label":"Set","value":1007},{"label":"Out","value":758},{"label":"Nov","value":914},{"label":"Dez","value":1009}];
const MX = 1026;
