...
const KPIS = [{"l":"Vendas YTD (€)","v":"€52419","t":"-2.5%","d":"down"},{"l":"Pipeline (€)","v":"€77555","t":"+14.8%","d":"up"},{"l":"Atingimento Quota (%)","v":"70.9%","t":"+3.5%","d":"up"},{"l":"Win Rate (%)","v":"89.4%","t":"+16.6%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 39937.15","€ 16054.77","€ 39368.07","71.8%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 34737.25","€ 10634.46","€ 8507.16","95.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 9204.05","€ 20220.05","€ 4959.69","97.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 12417.30","€ 23768.88","€ 27373.24","84.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 30592.47","€ 7460.50","€ 49717.39","76.4%"],"status":"active"}];
const CHART = [{"label":"Jan","value":489},{"label":"Fev","value":380},{"label":"Mar","value":658},{"label":"Abr","value":519},{"label":"Mai","value":489},{"label":"Jun","value":479},{"label":"Jul","value":307},{"label":"Ago","value":428},{"label":"Set","value":664},{"label":"Out","value":566},{"label":"Nov","value":402},{"label":"Dez","value":690}];
const MX = 690;
