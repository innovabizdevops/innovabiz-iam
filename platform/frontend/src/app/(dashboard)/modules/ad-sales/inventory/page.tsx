...
const KPIS = [{"l":"Vendas YTD (€)","v":"€61353","t":"-5.2%","d":"down"},{"l":"Pipeline (€)","v":"€18773","t":"+3.8%","d":"up"},{"l":"Atingimento Quota (%)","v":"90.4%","t":"+0.5%","d":"up"},{"l":"Win Rate (%)","v":"71.0%","t":"+13.8%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 48824.77","€ 41894.23","€ 48088.96","77.4%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 20109.84","€ 121.16","€ 18572.96","96.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 25850.51","€ 36620.99","€ 41027.73","93.6%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 24373.95","€ 35072.47","€ 20626.17","77.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 38952.80","€ 16030.43","€ 31621.86","90.8%"],"status":"active"}];
const CHART = [{"label":"Jan","value":405},{"label":"Fev","value":367},{"label":"Mar","value":604},{"label":"Abr","value":328},{"label":"Mai","value":467},{"label":"Jun","value":460},{"label":"Jul","value":595},{"label":"Ago","value":404},{"label":"Set","value":547},{"label":"Out","value":425},{"label":"Nov","value":489},{"label":"Dez","value":539}];
const MX = 604;
