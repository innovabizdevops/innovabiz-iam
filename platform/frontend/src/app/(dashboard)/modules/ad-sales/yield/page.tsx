...
const ACCENT = "#1e40af";
const MODULE = "Ad Sales";
const PAGE = "Yield Optimize";
const KPIS = [{"l":"Vendas YTD (€)","v":"€87863","t":"+4.1%","d":"up"},{"l":"Pipeline (€)","v":"€36088","t":"+17.6%","d":"up"},{"l":"Atingimento Quota (%)","v":"92.9%","t":"+9.4%","d":"up"},{"l":"Win Rate (%)","v":"85.2%","t":"-0.4%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 8343.95","€ 31806.81","€ 48338.80","80.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 27607.62","€ 31007.83","€ 1405.68","96.4%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 20093.86","€ 39765.77","€ 21094.03","94.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 34277.75","€ 19840.68","€ 40253.57","85.4%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 4719.43","€ 13308.14","€ 27075.30","81.0%"],"status":"active"}];
const CHART = [{"label":"Jan","value":892},{"label":"Fev","value":619},{"label":"Mar","value":752},{"label":"Abr","value":850},{"label":"Mai","value":914},{"label":"Jun","value":719},{"label":"Jul","value":648},{"label":"Ago","value":704},{"label":"Set","value":792},{"label":"Out","value":878},{"label":"Nov","value":657},{"label":"Dez","value":671}];
const MX = 914;
