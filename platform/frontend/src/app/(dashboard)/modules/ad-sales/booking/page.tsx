...
const PAGE = "Booking";
const KPIS = [{"l":"Vendas YTD (€)","v":"€74782","t":"+2.1%","d":"up"},{"l":"Pipeline (€)","v":"€28835","t":"+4.3%","d":"up"},{"l":"Atingimento Quota (%)","v":"90.3%","t":"-5.2%","d":"down"},{"l":"Win Rate (%)","v":"78.3%","t":"+6.8%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 28862.27","€ 6814.82","€ 13322.69","79.5%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 49466.06","€ 11003.15","€ 46996.79","71.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 15131.00","€ 19580.62","€ 23138.59","88.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 27527.98","€ 40181.69","€ 21107.06","94.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 5225.05","€ 7813.11","€ 3085.96","90.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":866},{"label":"Mar","value":627},{"label":"Abr","value":667},{"label":"Mai","value":703},{"label":"Jun","value":774},{"label":"Jul","value":922},{"label":"Ago","value":935},{"label":"Set","value":567},{"label":"Out","value":765},{"label":"Nov","value":680},{"label":"Dez","value":753}];
const MX = 935;
