...
const PAGE = "Ingest";
const KPIS = [{"l":"Total Time Series Deep","v":"6.906","t":"-5.4%","d":"down"},{"l":"Ingest Ativos","v":"2.531","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"65.2%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"77","t":"+12.9%","d":"up"}];
const COLS = ["ID","Ingest","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Time Series Deep #001","Time Series Deep #002","2.302","8.103","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Time Series Deep #002","Time Series Deep #003","635","3.636","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Time Series Deep #003","Time Series Deep #004","2.166","717","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Time Series Deep #004","Time Series Deep #005","7.870","329","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Time Series Deep #005","Time Series Deep #001","2.229","6.584","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":758},{"label":"Mar","value":706},{"label":"Abr","value":614},{"label":"Mai","value":753},{"label":"Jun","value":573},{"label":"Jul","value":797},{"label":"Ago","value":782},{"label":"Set","value":483},{"label":"Out","value":758},{"label":"Nov","value":667},{"label":"Dez","value":614}];
const MX = 797;
