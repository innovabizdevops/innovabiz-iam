...
const PAGE = "Downsample";
const KPIS = [{"l":"Total Time Series Deep","v":"3.266","t":"+2.7%","d":"up"},{"l":"Downsample Ativos","v":"8.201","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"86.2%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"88","t":"+11.3%","d":"up"}];
const COLS = ["ID","Downsample","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Time Series Deep #001","Time Series Deep #002","962","8.473","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Time Series Deep #002","Time Series Deep #003","4.451","6.401","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Time Series Deep #003","Time Series Deep #004","3.577","6.103","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Time Series Deep #004","Time Series Deep #005","6.196","7.582","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Time Series Deep #005","Time Series Deep #001","1.057","4.399","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":505},{"label":"Mar","value":324},{"label":"Abr","value":408},{"label":"Mai","value":548},{"label":"Jun","value":370},{"label":"Jul","value":531},{"label":"Ago","value":503},{"label":"Set","value":506},{"label":"Out","value":460},{"label":"Nov","value":553},{"label":"Dez","value":325}];
const MX = 553;
...
export default function DownsamplePage() {
    return (
