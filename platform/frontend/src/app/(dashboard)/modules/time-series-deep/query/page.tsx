...
const PAGE = "Query";
const KPIS = [{"l":"Total Time Series Deep","v":"8.267","t":"+11.5%","d":"up"},{"l":"Query Ativos","v":"1.832","t":"+14.4%","d":"up"},{"l":"Eficiência (%)","v":"84.2%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"94","t":"+2.5%","d":"up"}];
const COLS = ["ID","Query","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Time Series Deep #001","Time Series Deep #002","4.590","8.897","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Time Series Deep #002","Time Series Deep #003","2.558","6.312","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Time Series Deep #003","Time Series Deep #004","7.020","8.799","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Time Series Deep #004","Time Series Deep #005","3.820","8.045","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Time Series Deep #005","Time Series Deep #001","750","6.160","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":818},{"label":"Fev","value":746},{"label":"Mar","value":763},{"label":"Abr","value":904},{"label":"Mai","value":899},{"label":"Jun","value":851},{"label":"Jul","value":637},{"label":"Ago","value":711},{"label":"Set","value":688},{"label":"Out","value":713},{"label":"Nov","value":881},{"label":"Dez","value":810}];
const MX = 904;
