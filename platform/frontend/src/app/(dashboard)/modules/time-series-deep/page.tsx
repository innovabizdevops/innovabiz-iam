...
/* ═══ Time Series Database Deep — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "8413", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1926", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€81K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "-21%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "633806313", cells: ["TIM-9313", "Time Series Database Deep Item 1", "22/10/2026", "€6413"], status: "active" as const },
    { id: "633809884", cells: ["TIM-3884", "Time Series Database Deep Item 2", "9/5/2026", "€9984"], status: "pending" as const },
    { id: "633813455", cells: ["TIM-7455", "Time Series Database Deep Item 3", "24/12/2026", "€13 555"], status: "completed" as const },
    { id: "633817026", cells: ["TIM-2026", "Time Series Database Deep Item 4", "11/7/2026", "€17 126"], status: "warning" as const },
    { id: "633820597", cells: ["TIM-5597", "Time Series Database Deep Item 5", "26/2/2026", "€20 697"], status: "active" as const },
];
...
export default function TimeSeriesDatabaseDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Time Series Database Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Time Series Database Deep</p>
                    </div>
                </div>
