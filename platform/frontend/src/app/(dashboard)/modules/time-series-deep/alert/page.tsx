...
const ACCENT = "#1e3a5f";
const MODULE = "Time Series Database Deep";
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"1.319","t":"-3.6%","d":"down"},{"l":"Taxa Entrega (%)","v":"67.8%","t":"+17.7%","d":"up"},{"l":"Taxa Abertura (%)","v":"87.4%","t":"+4.6%","d":"up"},{"l":"Escalações","v":"4.591","t":"+13.1%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","8.290","96.8%","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","8.474","86.0%","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","1.333","71.4%","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","2.792","78.2%","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","6.567","94.4%","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":308},{"label":"Fev","value":386},{"label":"Mar","value":601},{"label":"Abr","value":302},{"label":"Mai","value":264},{"label":"Jun","value":557},{"label":"Jul","value":300},{"label":"Ago","value":545},{"label":"Set","value":381},{"label":"Out","value":276},{"label":"Nov","value":524},{"label":"Dez","value":342}];
const MX = 601;
