...
const ACCENT = "#6366f1";
const MODULE = "Adaptive Learning";
const PAGE = "Content AI";
const KPIS = [{"l":"Total Adaptive Learn","v":"1.324","t":"+8.9%","d":"up"},{"l":"Content AI Ativos","v":"1.304","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"75.5%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"91","t":"+2.6%","d":"up"}];
const COLS = ["ID","Content AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Adaptive Learn #001","Adaptive Learn #002","2.783","1.101","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Adaptive Learn #002","Adaptive Learn #003","8.025","7.804","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Adaptive Learn #003","Adaptive Learn #004","2.758","338","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Adaptive Learn #004","Adaptive Learn #005","8.491","8.705","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Adaptive Learn #005","Adaptive Learn #001","3.158","2.381","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":432},{"label":"Mar","value":448},{"label":"Abr","value":437},{"label":"Mai","value":719},{"label":"Jun","value":658},{"label":"Jul","value":505},{"label":"Ago","value":725},{"label":"Set","value":718},{"label":"Out","value":432},{"label":"Nov","value":666},{"label":"Dez","value":745}];
const MX = 745;
