...
const PAGE = "Path Design";
const KPIS = [{"l":"Formulários Ativos","v":"7.967","t":"+11.0%","d":"up"},{"l":"Submissões/Dia","v":"2335","t":"-5.4%","d":"down"},{"l":"Documentos Gerados","v":"2.407","t":"-5.6%","d":"down"},{"l":"Templates","v":"5.570","t":"-3.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.465","2026-03-17","8.783","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.708","2026-03-03","1.309","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.071","2026-02-20","8.120","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.935","2026-03-20","6.779","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.713","2026-02-28","4.431","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":961},{"label":"Fev","value":733},{"label":"Mar","value":952},{"label":"Abr","value":869},{"label":"Mai","value":914},{"label":"Jun","value":772},{"label":"Jul","value":828},{"label":"Ago","value":636},{"label":"Set","value":800},{"label":"Out","value":758},{"label":"Nov","value":819},{"label":"Dez","value":939}];
const MX = 961;
