...
const PAGE = "Monitor";
const KPIS = [{"l":"Total Stakeholder Mgmt","v":"6.889","t":"+11.0%","d":"up"},{"l":"Monitor Ativos","v":"8.595","t":"+5.8%","d":"up"},{"l":"Eficiência (%)","v":"83.6%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"60","t":"+14.8%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stakeholder Mgmt #001","Stakeholder Mgmt #002","7.454","1.321","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Stakeholder Mgmt #002","Stakeholder Mgmt #003","1.016","2.204","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Stakeholder Mgmt #003","Stakeholder Mgmt #004","6.413","2.727","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Stakeholder Mgmt #004","Stakeholder Mgmt #005","889","8.331","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stakeholder Mgmt #005","Stakeholder Mgmt #001","7.615","2.153","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":676},{"label":"Mar","value":770},{"label":"Abr","value":749},{"label":"Mai","value":804},{"label":"Jun","value":505},{"label":"Jul","value":852},{"label":"Ago","value":745},{"label":"Set","value":685},{"label":"Out","value":818},{"label":"Nov","value":844},{"label":"Dez","value":704}];
const MX = 852;
