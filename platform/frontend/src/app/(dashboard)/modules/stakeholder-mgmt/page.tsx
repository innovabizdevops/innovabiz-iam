...
const KPIS = [
    { label: "Total Registos", value: "3001", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3041", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€24K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "-9%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2103366801", cells: ["STA-4801", "Stakeholder Management Item 1", "26/10/2026", "€16 901"], status: "active" as const },
    { id: "2103370372", cells: ["STA-8372", "Stakeholder Management Item 2", "13/5/2026", "€20 472"], status: "pending" as const },
    { id: "2103373943", cells: ["STA-2943", "Stakeholder Management Item 3", "28/12/2026", "€24 043"], status: "completed" as const },
    { id: "2103377514", cells: ["STA-6514", "Stakeholder Management Item 4", "15/7/2026", "€27 614"], status: "warning" as const },
    { id: "2103381085", cells: ["STA-1085", "Stakeholder Management Item 5", "2/2/2026", "€31 185"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Stakeholder Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Stakeholder Management</p>
                    </div>
                </div>
