...
const ACCENT = "#64748b";
const MODULE = "Stakeholder Management";
const PAGE = "Communicate";
const KPIS = [{"l":"Total Stakeholder Mgmt","v":"541","t":"+6.9%","d":"up"},{"l":"Communicate Ativos","v":"1.882","t":"+11.9%","d":"up"},{"l":"Eficiência (%)","v":"65.2%","t":"+12.8%","d":"up"},{"l":"Score Performance","v":"87","t":"-5.2%","d":"down"}];
const COLS = ["ID","Communicate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stakeholder Mgmt #001","Stakeholder Mgmt #002","4.508","2.223","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Stakeholder Mgmt #002","Stakeholder Mgmt #003","680","6.411","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Stakeholder Mgmt #003","Stakeholder Mgmt #004","5.639","2.856","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Stakeholder Mgmt #004","Stakeholder Mgmt #005","482","1.132","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stakeholder Mgmt #005","Stakeholder Mgmt #001","5.414","6.825","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":992},{"label":"Mar","value":1001},{"label":"Abr","value":677},{"label":"Mai","value":817},{"label":"Jun","value":889},{"label":"Jul","value":775},{"label":"Ago","value":849},{"label":"Set","value":988},{"label":"Out","value":980},{"label":"Nov","value":728},{"label":"Dez","value":621}];
const MX = 1001;
