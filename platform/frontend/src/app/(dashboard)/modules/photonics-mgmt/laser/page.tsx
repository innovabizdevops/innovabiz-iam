...
const PAGE = "Laser Module";
const KPIS = [{"l":"Total Photonics Mgmt","v":"6.876","t":"-3.1%","d":"down"},{"l":"Laser Module Ativos","v":"3.064","t":"+6.6%","d":"up"},{"l":"Eficiência (%)","v":"69.2%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"70","t":"+10.9%","d":"up"}];
const COLS = ["ID","Laser Module","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Photonics Mgmt #001","Photonics Mgmt #002","2.412","3.422","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Photonics Mgmt #002","Photonics Mgmt #003","644","2.995","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Photonics Mgmt #003","Photonics Mgmt #004","6.113","8.279","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Photonics Mgmt #004","Photonics Mgmt #005","1.879","2.469","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Photonics Mgmt #005","Photonics Mgmt #001","7.914","6.722","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":733},{"label":"Mar","value":571},{"label":"Abr","value":551},{"label":"Mai","value":498},{"label":"Jun","value":702},{"label":"Jul","value":654},{"label":"Ago","value":806},{"label":"Set","value":763},{"label":"Out","value":757},{"label":"Nov","value":534},{"label":"Dez","value":538}];
const MX = 806;
