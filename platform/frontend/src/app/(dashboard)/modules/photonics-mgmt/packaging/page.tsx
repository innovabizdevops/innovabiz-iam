...
const KPIS = [{"l":"Total Photonics Mgmt","v":"2.497","t":"-4.0%","d":"down"},{"l":"Packaging Ativos","v":"4.055","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"93.1%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"65","t":"+8.9%","d":"up"}];
const COLS = ["ID","Packaging","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Photonics Mgmt #001","Photonics Mgmt #002","1.471","2.947","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Photonics Mgmt #002","Photonics Mgmt #003","7.815","2.582","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Photonics Mgmt #003","Photonics Mgmt #004","5.654","1.365","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Photonics Mgmt #004","Photonics Mgmt #005","2.848","7.953","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Photonics Mgmt #005","Photonics Mgmt #001","299","3.021","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":657},{"label":"Mar","value":806},{"label":"Abr","value":748},{"label":"Mai","value":792},{"label":"Jun","value":475},{"label":"Jul","value":836},{"label":"Ago","value":616},{"label":"Set","value":623},{"label":"Out","value":668},{"label":"Nov","value":443},{"label":"Dez","value":485}];
const MX = 836;
