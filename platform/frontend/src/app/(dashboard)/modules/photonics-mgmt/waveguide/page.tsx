...
const PAGE = "Waveguide Design";
const KPIS = [{"l":"Formulários Ativos","v":"7.722","t":"+11.4%","d":"up"},{"l":"Submissões/Dia","v":"4954","t":"+13.4%","d":"up"},{"l":"Documentos Gerados","v":"1.317","t":"-4.6%","d":"down"},{"l":"Templates","v":"5.522","t":"-4.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.968","2026-02-27","522","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.121","2026-01-01","7.153","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","408","2026-02-07","9.069","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.230","2026-01-23","9.028","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.952","2026-01-08","6.351","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":865},{"label":"Fev","value":1043},{"label":"Mar","value":1036},{"label":"Abr","value":1045},{"label":"Mai","value":754},{"label":"Jun","value":866},{"label":"Jul","value":713},{"label":"Ago","value":1034},{"label":"Set","value":655},{"label":"Out","value":781},{"label":"Nov","value":905},{"label":"Dez","value":925}];
const MX = 1045;
