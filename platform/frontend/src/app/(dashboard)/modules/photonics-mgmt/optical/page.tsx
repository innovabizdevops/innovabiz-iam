...
const PAGE = "Optical Compute";
const KPIS = [{"l":"Total Photonics Mgmt","v":"3.340","t":"-3.1%","d":"down"},{"l":"Optical Compute Ativos","v":"4.705","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"67.7%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"63","t":"+6.7%","d":"up"}];
const COLS = ["ID","Optical Compute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Photonics Mgmt #001","Photonics Mgmt #002","4.188","3.873","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Photonics Mgmt #002","Photonics Mgmt #003","5.169","2.845","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Photonics Mgmt #003","Photonics Mgmt #004","1.796","7.031","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Photonics Mgmt #004","Photonics Mgmt #005","6.191","1.055","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Photonics Mgmt #005","Photonics Mgmt #001","7.619","2.634","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":978},{"label":"Fev","value":805},{"label":"Mar","value":626},{"label":"Abr","value":903},{"label":"Mai","value":793},{"label":"Jun","value":991},{"label":"Jul","value":736},{"label":"Ago","value":809},{"label":"Set","value":971},{"label":"Out","value":877},{"label":"Nov","value":908},{"label":"Dez","value":916}];
const MX = 991;
