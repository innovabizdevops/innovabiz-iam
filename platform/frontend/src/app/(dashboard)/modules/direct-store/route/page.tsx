...
const PAGE = "Route";
const KPIS = [{"l":"Pedidos/Dia","v":"4035","t":"+1.0%","d":"up"},{"l":"GMV (€)","v":"€60195","t":"-3.5%","d":"down"},{"l":"Conversão (%)","v":"86.8%","t":"-0.8%","d":"down"},{"l":"AOV (€)","v":"€80207","t":"+11.8%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 4270.96","6.691","1.892","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 25074.55","2.197","7.565","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 2995.12","2.662","3.705","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 19644.72","2.217","243","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 3054.96","2.465","3.073","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":687},{"label":"Mar","value":470},{"label":"Abr","value":762},{"label":"Mai","value":748},{"label":"Jun","value":801},{"label":"Jul","value":549},{"label":"Ago","value":625},{"label":"Set","value":557},{"label":"Out","value":598},{"label":"Nov","value":553},{"label":"Dez","value":798}];
const MX = 801;
