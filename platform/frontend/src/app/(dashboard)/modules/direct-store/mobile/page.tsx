...
const ACCENT = "#6366f1";
const MODULE = "Direct Store Delivery";
const PAGE = "Mobile";
const KPIS = [{"l":"Pedidos/Dia","v":"1038","t":"+1.7%","d":"up"},{"l":"GMV (€)","v":"€48631","t":"+13.6%","d":"up"},{"l":"Conversão (%)","v":"78.1%","t":"-5.0%","d":"down"},{"l":"AOV (€)","v":"€34894","t":"-5.0%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 8352.53","111","3.931","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 38326.88","6.762","3.663","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 47616.23","9.070","6.876","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 43839.50","3.264","3.034","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 35471.76","3.524","9.038","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":906},{"label":"Mar","value":883},{"label":"Abr","value":620},{"label":"Mai","value":870},{"label":"Jun","value":812},{"label":"Jul","value":664},{"label":"Ago","value":817},{"label":"Set","value":613},{"label":"Out","value":923},{"label":"Nov","value":586},{"label":"Dez","value":839}];
const MX = 923;
