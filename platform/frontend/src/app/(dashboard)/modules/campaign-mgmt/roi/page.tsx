...
const PAGE = "ROI Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"4.252","t":"-4.1%","d":"down"},{"l":"Queries/Dia","v":"4063","t":"+8.7%","d":"up"},{"l":"Dados Processados (GB)","v":"8.063","t":"+3.4%","d":"up"},{"l":"Utilizadores Analytics","v":"2.444","t":"+7.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4264","2026-03-27","363","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3226","2026-02-02","7.015","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","100","2026-02-01","5.488","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1082","2026-02-05","5.865","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2268","2026-01-11","8.857","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":501},{"label":"Fev","value":536},{"label":"Mar","value":533},{"label":"Abr","value":681},{"label":"Mai","value":569},{"label":"Jun","value":717},{"label":"Jul","value":461},{"label":"Ago","value":602},{"label":"Set","value":675},{"label":"Out","value":609},{"label":"Nov","value":413},{"label":"Dez","value":626}];
const MX = 717;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>Chart</span></h1>
                </div>
