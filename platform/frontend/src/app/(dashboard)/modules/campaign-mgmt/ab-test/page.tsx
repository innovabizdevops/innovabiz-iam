...
const KPIS = [{"l":"Total Campaign Mgmt","v":"3.229","t":"-0.3%","d":"down"},{"l":"A/B Testing Ativos","v":"3.684","t":"+10.6%","d":"up"},{"l":"Eficiência (%)","v":"76.9%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"68","t":"+4.8%","d":"up"}];
const COLS = ["ID","A/B Testing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Campaign Mgmt #001","Campaign Mgmt #002","1.107","3.448","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Campaign Mgmt #002","Campaign Mgmt #003","6.549","4.934","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Campaign Mgmt #003","Campaign Mgmt #004","8.027","6.059","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Campaign Mgmt #004","Campaign Mgmt #005","4.845","3.825","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Campaign Mgmt #005","Campaign Mgmt #001","5.160","6.500","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":898},{"label":"Fev","value":867},{"label":"Mar","value":824},{"label":"Abr","value":747},{"label":"Mai","value":722},{"label":"Jun","value":534},{"label":"Jul","value":753},{"label":"Ago","value":880},{"label":"Set","value":806},{"label":"Out","value":564},{"label":"Nov","value":811},{"label":"Dez","value":567}];
const MX = 898;
