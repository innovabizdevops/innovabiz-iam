...
const PAGE = "Influencer Mgmt";
const KPIS = [{"l":"Total Campaign Mgmt","v":"7.459","t":"+15.6%","d":"up"},{"l":"Influencer Mgmt Ativos","v":"749","t":"+8.3%","d":"up"},{"l":"Eficiência (%)","v":"87.1%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"72","t":"+0.0%","d":"up"}];
const COLS = ["ID","Influencer Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Campaign Mgmt #001","Campaign Mgmt #002","1.051","754","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Campaign Mgmt #002","Campaign Mgmt #003","1.577","7.263","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Campaign Mgmt #003","Campaign Mgmt #004","1.738","7.534","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Campaign Mgmt #004","Campaign Mgmt #005","150","4.718","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Campaign Mgmt #005","Campaign Mgmt #001","8.686","924","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":366},{"label":"Mar","value":375},{"label":"Abr","value":616},{"label":"Mai","value":578},{"label":"Jun","value":460},{"label":"Jul","value":400},{"label":"Ago","value":438},{"label":"Set","value":384},{"label":"Out","value":532},{"label":"Nov","value":468},{"label":"Dez","value":674}];
const MX = 674;
