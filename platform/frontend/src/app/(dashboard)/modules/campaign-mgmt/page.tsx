...
export default function CampaignMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Campaign Mgmt</h1><p className="text-sm text-muted-foreground">Campaign Mgmt • iBOS Enterprise</p></div>
