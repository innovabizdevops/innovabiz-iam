...
const PAGE = "Audience Segmentation";
const KPIS = [{"l":"Perfis Unificados","v":"5.100","t":"+13.5%","d":"up"},{"l":"Segmentos Ativos","v":"721","t":"+6.4%","d":"up"},{"l":"NPS Score","v":"69","t":"+9.5%","d":"up"},{"l":"Churn Previsto (%)","v":"84.6%","t":"-5.5%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","2.551","€ 14292.52","85.7%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","2.309","€ 8660.95","85.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","6.166","€ 23168.19","87.9%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","5.046","€ 19846.50","81.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","1.439","€ 34860.39","90.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":800},{"label":"Fev","value":793},{"label":"Mar","value":444},{"label":"Abr","value":617},{"label":"Mai","value":782},{"label":"Jun","value":549},{"label":"Jul","value":545},{"label":"Ago","value":579},{"label":"Set","value":787},{"label":"Out","value":566},{"label":"Nov","value":748},{"label":"Dez","value":752}];
const MX = 800;
