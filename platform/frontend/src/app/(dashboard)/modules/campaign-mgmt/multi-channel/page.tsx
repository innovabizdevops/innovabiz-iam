...
const KPIS = [{"l":"Total Campaign Mgmt","v":"2.274","t":"-2.5%","d":"down"},{"l":"Multi Channel Ativos","v":"3.127","t":"+14.8%","d":"up"},{"l":"Eficiência (%)","v":"65.8%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"85","t":"+15.6%","d":"up"}];
const COLS = ["ID","Multi Channel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Campaign Mgmt #001","Campaign Mgmt #002","5.502","4.178","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Campaign Mgmt #002","Campaign Mgmt #003","7.144","4.993","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Campaign Mgmt #003","Campaign Mgmt #004","6.519","6.826","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Campaign Mgmt #004","Campaign Mgmt #005","431","4.490","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Campaign Mgmt #005","Campaign Mgmt #001","1.915","7.109","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":486},{"label":"Mar","value":244},{"label":"Abr","value":562},{"label":"Mai","value":303},{"label":"Jun","value":378},{"label":"Jul","value":325},{"label":"Ago","value":307},{"label":"Set","value":216},{"label":"Out","value":302},{"label":"Nov","value":447},{"label":"Dez","value":209}];
const MX = 573;
