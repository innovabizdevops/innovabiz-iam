...
const KPIS = [{"l":"Total Campaign Mgmt","v":"8.744","t":"+16.2%","d":"up"},{"l":"Campaign Builder Ativos","v":"387","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"82.0%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"61","t":"-4.3%","d":"down"}];
const COLS = ["ID","Campaign Builder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Campaign Mgmt #001","Campaign Mgmt #002","8.589","7.617","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Campaign Mgmt #002","Campaign Mgmt #003","8.961","2.798","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Campaign Mgmt #003","Campaign Mgmt #004","5.695","3.487","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Campaign Mgmt #004","Campaign Mgmt #005","6.039","3.289","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Campaign Mgmt #005","Campaign Mgmt #001","9.094","6.843","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":331},{"label":"Fev","value":583},{"label":"Mar","value":603},{"label":"Abr","value":403},{"label":"Mai","value":312},{"label":"Jun","value":418},{"label":"Jul","value":470},{"label":"Ago","value":451},{"label":"Set","value":267},{"label":"Out","value":555},{"label":"Nov","value":391},{"label":"Dez","value":295}];
const MX = 603;
