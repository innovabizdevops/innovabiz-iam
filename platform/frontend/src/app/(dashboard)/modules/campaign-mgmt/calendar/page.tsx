...
const PAGE = "Content Calendar";
const KPIS = [{"l":"Total Campaign Mgmt","v":"1.145","t":"+13.9%","d":"up"},{"l":"Content Calendar Ativos","v":"5.321","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"71.7%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"86","t":"+5.2%","d":"up"}];
const COLS = ["ID","Content Calendar","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Campaign Mgmt #001","Campaign Mgmt #002","6.572","240","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Campaign Mgmt #002","Campaign Mgmt #003","8.254","8.815","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Campaign Mgmt #003","Campaign Mgmt #004","2.962","4.987","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Campaign Mgmt #004","Campaign Mgmt #005","2.318","1.993","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Campaign Mgmt #005","Campaign Mgmt #001","8.779","2.700","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":343},{"label":"Fev","value":541},{"label":"Mar","value":450},{"label":"Abr","value":275},{"label":"Mai","value":473},{"label":"Jun","value":571},{"label":"Jul","value":515},{"label":"Ago","value":317},{"label":"Set","value":332},{"label":"Out","value":489},{"label":"Nov","value":356},{"label":"Dez","value":512}];
const MX = 571;
