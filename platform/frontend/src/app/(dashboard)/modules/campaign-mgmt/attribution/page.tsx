...
const ACCENT = "#dc2626";
const MODULE = "Campaign Management";
const PAGE = "Attribution Model";
const KPIS = [{"l":"Total Campaign Mgmt","v":"5.600","t":"-0.5%","d":"down"},{"l":"Attribution Model Ativos","v":"4.111","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"80.9%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"81","t":"+12.8%","d":"up"}];
const COLS = ["ID","Attribution Model","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Campaign Mgmt #001","Campaign Mgmt #002","5.405","1.382","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Campaign Mgmt #002","Campaign Mgmt #003","7.874","7.834","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Campaign Mgmt #003","Campaign Mgmt #004","2.622","7.378","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Campaign Mgmt #004","Campaign Mgmt #005","8.607","4.975","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Campaign Mgmt #005","Campaign Mgmt #001","7.922","7.591","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":701},{"label":"Mar","value":444},{"label":"Abr","value":744},{"label":"Mai","value":551},{"label":"Jun","value":451},{"label":"Jul","value":566},{"label":"Ago","value":653},{"label":"Set","value":696},{"label":"Out","value":453},{"label":"Nov","value":803},{"label":"Dez","value":535}];
const MX = 803;
