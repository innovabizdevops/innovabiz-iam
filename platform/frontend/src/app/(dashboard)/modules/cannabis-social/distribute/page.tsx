...
const ACCENT = "#166534";
const MODULE = "Cannabis Social Club";
const PAGE = "Distribute";
const KPIS = [{"l":"Total Cannabis Social","v":"7.426","t":"-0.5%","d":"down"},{"l":"Distribute Ativos","v":"1.555","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"88.9%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"62","t":"+8.7%","d":"up"}];
const COLS = ["ID","Distribute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Social #001","Cannabis Social #002","832","8.614","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Social #002","Cannabis Social #003","7.622","7.484","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Social #003","Cannabis Social #004","3.325","1.063","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Social #004","Cannabis Social #005","7.381","4.158","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Social #005","Cannabis Social #001","4.541","7.361","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":904},{"label":"Mar","value":644},{"label":"Abr","value":877},{"label":"Mai","value":694},{"label":"Jun","value":701},{"label":"Jul","value":937},{"label":"Ago","value":876},{"label":"Set","value":896},{"label":"Out","value":710},{"label":"Nov","value":832},{"label":"Dez","value":931}];
const MX = 937;
