...
/* ═══ Cannabis Social Club — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "4172", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3539", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€296K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "300409672", cells: ["CAN-8672", "Cannabis Social Club Item 1", "25/5/2026", "€9772"], status: "active" as const },
    { id: "300413243", cells: ["CAN-3243", "Cannabis Social Club Item 2", "12/12/2026", "€13 343"], status: "pending" as const },
    { id: "300416814", cells: ["CAN-6814", "Cannabis Social Club Item 3", "27/7/2026", "€16 914"], status: "completed" as const },
    { id: "300420385", cells: ["CAN-1385", "Cannabis Social Club Item 4", "14/2/2026", "€20 485"], status: "warning" as const },
    { id: "300423956", cells: ["CAN-4956", "Cannabis Social Club Item 5", "1/9/2026", "€24 056"], status: "active" as const },
];
...
export default function CannabisSocialClubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cannabis Social Club</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cannabis Social Club</p>
                    </div>
                </div>
