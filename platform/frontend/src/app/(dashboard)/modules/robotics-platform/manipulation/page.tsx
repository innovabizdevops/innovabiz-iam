...
const PAGE = "Manipulation";
const KPIS = [{"l":"Formulários Ativos","v":"8.681","t":"+12.4%","d":"up"},{"l":"Submissões/Dia","v":"336","t":"-1.8%","d":"down"},{"l":"Documentos Gerados","v":"7.092","t":"+10.9%","d":"up"},{"l":"Templates","v":"6.385","t":"+7.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.516","2026-02-05","5.942","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.029","2026-02-20","1.390","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.994","2026-03-04","8.582","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.565","2026-02-03","6.569","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.312","2026-01-17","4.644","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":868},{"label":"Fev","value":686},{"label":"Mar","value":581},{"label":"Abr","value":730},{"label":"Mai","value":788},{"label":"Jun","value":772},{"label":"Jul","value":977},{"label":"Ago","value":607},{"label":"Set","value":606},{"label":"Out","value":747},{"label":"Nov","value":748},{"label":"Dez","value":777}];
const MX = 977;
