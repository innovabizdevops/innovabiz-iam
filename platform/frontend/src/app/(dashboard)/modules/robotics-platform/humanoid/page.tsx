...
const PAGE = "Humanoid";
const KPIS = [{"l":"Formulários Ativos","v":"8.959","t":"-4.4%","d":"down"},{"l":"Submissões/Dia","v":"4906","t":"-1.8%","d":"down"},{"l":"Documentos Gerados","v":"8.881","t":"+7.0%","d":"up"},{"l":"Templates","v":"9.086","t":"+17.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.292","2026-02-24","4.197","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.828","2026-02-17","2.755","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.899","2026-01-15","1.364","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.762","2026-01-24","2.212","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.836","2026-01-19","1.414","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":529},{"label":"Mar","value":346},{"label":"Abr","value":487},{"label":"Mai","value":379},{"label":"Jun","value":475},{"label":"Jul","value":377},{"label":"Ago","value":342},{"label":"Set","value":593},{"label":"Out","value":639},{"label":"Nov","value":438},{"label":"Dez","value":539}];
const MX = 639;
