...
const KPIS = [{"l":"Formulários Ativos","v":"1.753","t":"+9.3%","d":"up"},{"l":"Submissões/Dia","v":"4527","t":"+10.4%","d":"up"},{"l":"Documentos Gerados","v":"4.327","t":"+1.0%","d":"up"},{"l":"Templates","v":"6.392","t":"-4.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.578","2026-02-20","1.648","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.678","2026-03-14","5.509","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.519","2026-02-05","5.890","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.392","2026-02-01","6.714","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.650","2026-02-23","7.627","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":929},{"label":"Mar","value":847},{"label":"Abr","value":878},{"label":"Mai","value":570},{"label":"Jun","value":761},{"label":"Jul","value":822},{"label":"Ago","value":661},{"label":"Set","value":580},{"label":"Out","value":638},{"label":"Nov","value":641},{"label":"Dez","value":929}];
const MX = 929;
