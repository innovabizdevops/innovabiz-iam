...
const KPIS = [{"l":"Formulários Ativos","v":"964","t":"-5.1%","d":"down"},{"l":"Submissões/Dia","v":"3612","t":"+16.4%","d":"up"},{"l":"Documentos Gerados","v":"6.093","t":"+0.7%","d":"up"},{"l":"Templates","v":"2.605","t":"+17.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","269","2026-02-11","7.958","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.678","2026-02-17","8.716","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","905","2026-02-12","1.085","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.329","2026-01-07","1.113","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","672","2026-03-13","8.489","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":509},{"label":"Mar","value":412},{"label":"Abr","value":747},{"label":"Mai","value":590},{"label":"Jun","value":753},{"label":"Jul","value":597},{"label":"Ago","value":506},{"label":"Set","value":398},{"label":"Out","value":704},{"label":"Nov","value":569},{"label":"Dez","value":514}];
const MX = 753;
