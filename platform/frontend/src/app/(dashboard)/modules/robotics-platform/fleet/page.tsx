...
const KPIS = [{"l":"Formulários Ativos","v":"4.155","t":"+6.4%","d":"up"},{"l":"Submissões/Dia","v":"4904","t":"+8.6%","d":"up"},{"l":"Documentos Gerados","v":"5.293","t":"+15.2%","d":"up"},{"l":"Templates","v":"889","t":"+16.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","287","2026-01-18","1.372","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.784","2026-02-25","1.499","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.918","2026-03-23","1.012","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.032","2026-02-17","1.151","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.791","2026-03-15","1.961","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":653},{"label":"Mar","value":543},{"label":"Abr","value":439},{"label":"Mai","value":436},{"label":"Jun","value":514},{"label":"Jul","value":768},{"label":"Ago","value":563},{"label":"Set","value":660},{"label":"Out","value":483},{"label":"Nov","value":484},{"label":"Dez","value":465}];
const MX = 768;
