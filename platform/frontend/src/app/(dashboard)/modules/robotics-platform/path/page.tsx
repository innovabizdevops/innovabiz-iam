...
const ACCENT = "#0e7490";
const MODULE = "Robotics Platform";
const PAGE = "Path Planning";
const KPIS = [{"l":"Formulários Ativos","v":"4.134","t":"-4.1%","d":"down"},{"l":"Submissões/Dia","v":"3973","t":"+1.1%","d":"up"},{"l":"Documentos Gerados","v":"1.642","t":"+7.0%","d":"up"},{"l":"Templates","v":"1.263","t":"+10.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.491","2026-03-07","7.690","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.686","2026-03-19","3.378","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","422","2026-02-02","361","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.364","2026-02-18","3.145","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.386","2026-02-27","1.506","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":877},{"label":"Fev","value":762},{"label":"Mar","value":774},{"label":"Abr","value":939},{"label":"Mai","value":1057},{"label":"Jun","value":820},{"label":"Jul","value":1031},{"label":"Ago","value":717},{"label":"Set","value":786},{"label":"Out","value":888},{"label":"Nov","value":804},{"label":"Dez","value":809}];
const MX = 1057;
