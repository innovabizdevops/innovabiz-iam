...
const KPIS = [{"l":"Twins Ativos","v":"1.998","t":"-3.7%","d":"down"},{"l":"Simulações/Dia","v":"1518","t":"-3.6%","d":"down"},{"l":"Precisão Modelo (%)","v":"75.0%","t":"+15.9%","d":"up"},{"l":"Latência Sync (ms)","v":"63ms","t":"-3.9%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","95.6%","2026-02-01","3.460","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","98.4%","2026-02-15","1.825","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","96.2%","2026-02-18","8.584","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","78.9%","2026-01-10","4.553","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","83.1%","2026-02-06","7.381","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":507},{"label":"Mar","value":492},{"label":"Abr","value":780},{"label":"Mai","value":796},{"label":"Jun","value":769},{"label":"Jul","value":823},{"label":"Ago","value":776},{"label":"Set","value":487},{"label":"Out","value":725},{"label":"Nov","value":596},{"label":"Dez","value":598}];
const MX = 823;
