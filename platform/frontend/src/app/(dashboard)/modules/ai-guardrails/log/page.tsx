...
const PAGE = "Log";
const KPIS = [{"l":"Veículos Operação","v":"2.523","t":"+3.0%","d":"up"},{"l":"Viagens/Dia","v":"4324","t":"-0.9%","d":"down"},{"l":"Pontualidade (%)","v":"71.2%","t":"+14.2%","d":"up"},{"l":"Passageiros/Dia","v":"2041","t":"+0.1%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-21","2026-03-05","5.876","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-11","2026-02-05","6.088","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-28","2026-03-25","6.476","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-07","2026-03-01","628","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-18","2026-01-25","8.557","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":586},{"label":"Mar","value":653},{"label":"Abr","value":520},{"label":"Mai","value":799},{"label":"Jun","value":737},{"label":"Jul","value":671},{"label":"Ago","value":701},{"label":"Set","value":658},{"label":"Out","value":690},{"label":"Nov","value":567},{"label":"Dez","value":660}];
const MX = 799;
