...
const PAGE = "Content";
const KPIS = [{"l":"Veículos Operação","v":"2.368","t":"-5.5%","d":"down"},{"l":"Viagens/Dia","v":"3823","t":"+12.8%","d":"up"},{"l":"Pontualidade (%)","v":"94.4%","t":"+14.0%","d":"up"},{"l":"Passageiros/Dia","v":"3963","t":"-4.3%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-22","2026-03-11","1.766","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-19","2026-02-12","8.234","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-24","2026-03-11","6.071","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-22","2026-03-23","6.394","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-28","2026-01-26","2.279","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":721},{"label":"Mar","value":828},{"label":"Abr","value":626},{"label":"Mai","value":772},{"label":"Jun","value":635},{"label":"Jul","value":831},{"label":"Ago","value":601},{"label":"Set","value":819},{"label":"Out","value":861},{"label":"Nov","value":921},{"label":"Dez","value":774}];
const MX = 921;
