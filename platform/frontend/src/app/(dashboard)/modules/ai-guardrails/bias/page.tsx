...
const PAGE = "Bias";
const KPIS = [{"l":"BCP Plans Ativos","v":"1.781","t":"+17.9%","d":"up"},{"l":"RTO Médio (h)","v":"33h","t":"+5.0%","d":"up"},{"l":"RPO Médio (h)","v":"137h","t":"+1.0%","d":"up"},{"l":"Testes DR (YTD)","v":"3.756","t":"-5.9%","d":"down"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","21h","173h","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","105h","116h","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","183h","66h","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","53h","156h","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","127h","171h","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":404},{"label":"Fev","value":614},{"label":"Mar","value":581},{"label":"Abr","value":528},{"label":"Mai","value":590},{"label":"Jun","value":490},{"label":"Jul","value":514},{"label":"Ago","value":460},{"label":"Set","value":721},{"label":"Out","value":723},{"label":"Nov","value":449},{"label":"Dez","value":712}];
const MX = 723;
