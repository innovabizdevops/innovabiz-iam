...
const ACCENT = "#7c3aed";
const MODULE = "AI Guardrails Platform";
const PAGE = "Hallucination";
const KPIS = [{"l":"Veículos Operação","v":"3.989","t":"+4.7%","d":"up"},{"l":"Viagens/Dia","v":"5082","t":"+14.3%","d":"up"},{"l":"Pontualidade (%)","v":"86.8%","t":"+1.2%","d":"up"},{"l":"Passageiros/Dia","v":"3871","t":"+16.2%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-04","2026-02-18","118","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-26","2026-01-07","1.853","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-06","2026-03-19","1.919","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-25","2026-02-09","7.766","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-05","2026-03-06","3.224","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":392},{"label":"Mar","value":482},{"label":"Abr","value":435},{"label":"Mai","value":580},{"label":"Jun","value":737},{"label":"Jul","value":742},{"label":"Ago","value":423},{"label":"Set","value":532},{"label":"Out","value":382},{"label":"Nov","value":686},{"label":"Dez","value":428}];
const MX = 742;
