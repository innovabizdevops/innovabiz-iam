...
/* ═══ AI Guardrails Platform — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "2784", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2114", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€20K", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "310753784", cells: ["AI-2784", "AI Guardrails Platform Item 1", "13/9/2026", "€3884"], status: "active" as const },
    { id: "310757355", cells: ["AI-6355", "AI Guardrails Platform Item 2", "28/4/2026", "€7455"], status: "pending" as const },
    { id: "310760926", cells: ["AI-9926", "AI Guardrails Platform Item 3", "15/11/2026", "€11 026"], status: "completed" as const },
    { id: "310764497", cells: ["AI-4497", "AI Guardrails Platform Item 4", "2/6/2026", "€14 597"], status: "warning" as const },
    { id: "310768068", cells: ["AI-8068", "AI Guardrails Platform Item 5", "17/1/2026", "€18 168"], status: "active" as const },
];
...
export default function AiGuardrailsPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Guardrails Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Guardrails Platform</p>
                    </div>
                </div>
