...
const PAGE = "Self-Service Return";
const KPIS = [{"l":"Total Returns Mgmt","v":"5.480","t":"+12.7%","d":"up"},{"l":"Self Service Return Ativos","v":"2.079","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"81.9%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"91","t":"+4.1%","d":"up"}];
const COLS = ["ID","Self Service Return","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Returns Mgmt #001","Returns Mgmt #002","8.876","1.740","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Returns Mgmt #002","Returns Mgmt #003","3.563","7.193","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Returns Mgmt #003","Returns Mgmt #004","3.824","5.974","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Returns Mgmt #004","Returns Mgmt #005","2.067","4.479","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Returns Mgmt #005","Returns Mgmt #001","8.053","8.860","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":477},{"label":"Fev","value":620},{"label":"Mar","value":800},{"label":"Abr","value":770},{"label":"Mai","value":787},{"label":"Jun","value":575},{"label":"Jul","value":763},{"label":"Ago","value":500},{"label":"Set","value":812},{"label":"Out","value":546},{"label":"Nov","value":815},{"label":"Dez","value":481}];
const MX = 815;
