...
const PAGE = "Warranty Check";
const KPIS = [{"l":"ARR (€M)","v":"€17.3M","t":"-0.2%","d":"down"},{"l":"MRR (€)","v":"€16788","t":"+1.8%","d":"up"},{"l":"Churn (%)","v":"65.1%","t":"+12.3%","d":"up"},{"l":"ARPU (€)","v":"€99586","t":"-1.5%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 33803.06","1.421","€ 39633.56","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 11417.67","391","€ 28290.92","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 1997.41","1.737","€ 24220.01","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 50025.05","5.889","€ 14550.10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 2672.63","1.519","€ 3155.94","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":555},{"label":"Mar","value":388},{"label":"Abr","value":363},{"label":"Mai","value":589},{"label":"Jun","value":323},{"label":"Jul","value":474},{"label":"Ago","value":664},{"label":"Set","value":273},{"label":"Out","value":337},{"label":"Nov","value":436},{"label":"Dez","value":411}];
const MX = 664;
