...
const ACCENT = "#92400e";
const MODULE = "Returns & RMA";
const PAGE = "Fraud Detection";
const KPIS = [{"l":"Total Returns Mgmt","v":"6.831","t":"+3.0%","d":"up"},{"l":"Fraud Detection Ativos","v":"4.018","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"83.9%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"70","t":"+17.6%","d":"up"}];
const COLS = ["ID","Fraud Detection","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Returns Mgmt #001","Returns Mgmt #002","1.050","3.699","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Returns Mgmt #002","Returns Mgmt #003","1.350","3.903","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Returns Mgmt #003","Returns Mgmt #004","680","542","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Returns Mgmt #004","Returns Mgmt #005","3.303","3.450","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Returns Mgmt #005","Returns Mgmt #001","267","2.434","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":274},{"label":"Fev","value":631},{"label":"Mar","value":421},{"label":"Abr","value":530},{"label":"Mai","value":243},{"label":"Jun","value":368},{"label":"Jul","value":333},{"label":"Ago","value":458},{"label":"Set","value":372},{"label":"Out","value":352},{"label":"Nov","value":390},{"label":"Dez","value":242}];
const MX = 631;
