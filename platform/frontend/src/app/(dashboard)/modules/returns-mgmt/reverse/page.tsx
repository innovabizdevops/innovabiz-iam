...
const PAGE = "Reverse Logistics";
const KPIS = [{"l":"Total Returns Mgmt","v":"4.553","t":"+4.1%","d":"up"},{"l":"Reverse Logistics Ativos","v":"2.065","t":"+4.0%","d":"up"},{"l":"Eficiência (%)","v":"79.4%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"59","t":"-4.7%","d":"down"}];
const COLS = ["ID","Reverse Logistics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Returns Mgmt #001","Returns Mgmt #002","7.828","3.497","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Returns Mgmt #002","Returns Mgmt #003","777","108","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Returns Mgmt #003","Returns Mgmt #004","5.280","7.969","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Returns Mgmt #004","Returns Mgmt #005","9.079","2.942","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Returns Mgmt #005","Returns Mgmt #001","819","847","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":348},{"label":"Fev","value":521},{"label":"Mar","value":517},{"label":"Abr","value":272},{"label":"Mai","value":302},{"label":"Jun","value":604},{"label":"Jul","value":244},{"label":"Ago","value":523},{"label":"Set","value":567},{"label":"Out","value":314},{"label":"Nov","value":422},{"label":"Dez","value":501}];
const MX = 604;
