...
const PAGE = "Refund Engine";
const KPIS = [{"l":"Total Returns Mgmt","v":"3.751","t":"-0.2%","d":"down"},{"l":"Refund Engine Ativos","v":"7.211","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"76.9%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"67","t":"+1.2%","d":"up"}];
const COLS = ["ID","Refund Engine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Returns Mgmt #001","Returns Mgmt #002","7.007","6.066","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Returns Mgmt #002","Returns Mgmt #003","705","6.224","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Returns Mgmt #003","Returns Mgmt #004","7.921","230","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Returns Mgmt #004","Returns Mgmt #005","1.331","5.509","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Returns Mgmt #005","Returns Mgmt #001","6.065","4.478","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":394},{"label":"Fev","value":614},{"label":"Mar","value":710},{"label":"Abr","value":701},{"label":"Mai","value":674},{"label":"Jun","value":454},{"label":"Jul","value":497},{"label":"Ago","value":453},{"label":"Set","value":566},{"label":"Out","value":447},{"label":"Nov","value":554},{"label":"Dez","value":624}];
const MX = 710;
