...
const PAGE = "RMA Workflow";
const KPIS = [{"l":"Total Returns Mgmt","v":"4.861","t":"-2.4%","d":"down"},{"l":"RMA Workflow Ativos","v":"4.234","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"70.9%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"58","t":"+13.2%","d":"up"}];
const COLS = ["ID","RMA Workflow","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Returns Mgmt #001","Returns Mgmt #002","5.933","6.436","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Returns Mgmt #002","Returns Mgmt #003","3.658","613","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Returns Mgmt #003","Returns Mgmt #004","5.264","4.766","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Returns Mgmt #004","Returns Mgmt #005","659","2.976","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Returns Mgmt #005","Returns Mgmt #001","8.001","8.962","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":698},{"label":"Mar","value":743},{"label":"Abr","value":622},{"label":"Mai","value":635},{"label":"Jun","value":841},{"label":"Jul","value":710},{"label":"Ago","value":757},{"label":"Set","value":835},{"label":"Out","value":625},{"label":"Nov","value":710},{"label":"Dez","value":675}];
const MX = 841;
