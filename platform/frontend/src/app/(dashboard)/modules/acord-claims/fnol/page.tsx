...
const PAGE = "FNOL";
const KPIS = [{"l":"Total Acord Claims","v":"4.622","t":"+3.2%","d":"up"},{"l":"FNOL Ativos","v":"1.587","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"68.7%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"66","t":"+8.6%","d":"up"}];
const COLS = ["ID","FNOL","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Acord Claims #001","Acord Claims #002","7.228","8.852","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Acord Claims #002","Acord Claims #003","5.484","1.172","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Acord Claims #003","Acord Claims #004","3.537","1.790","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Acord Claims #004","Acord Claims #005","2.200","928","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Acord Claims #005","Acord Claims #001","686","6.724","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":789},{"label":"Mar","value":921},{"label":"Abr","value":977},{"label":"Mai","value":745},{"label":"Jun","value":822},{"label":"Jul","value":865},{"label":"Ago","value":956},{"label":"Set","value":874},{"label":"Out","value":952},{"label":"Nov","value":603},{"label":"Dez","value":920}];
const MX = 977;
