...
const PAGE = "Adjust";
const KPIS = [{"l":"Total Acord Claims","v":"1.012","t":"+17.7%","d":"up"},{"l":"Adjust Ativos","v":"7.670","t":"-3.8%","d":"down"},{"l":"Eficiência (%)","v":"79.2%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"89","t":"+5.6%","d":"up"}];
const COLS = ["ID","Adjust","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Acord Claims #001","Acord Claims #002","4.642","5.839","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Acord Claims #002","Acord Claims #003","9.061","5.550","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Acord Claims #003","Acord Claims #004","3.416","5.035","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Acord Claims #004","Acord Claims #005","5.292","3.442","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Acord Claims #005","Acord Claims #001","659","2.455","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":939},{"label":"Fev","value":604},{"label":"Mar","value":584},{"label":"Abr","value":643},{"label":"Mai","value":714},{"label":"Jun","value":837},{"label":"Jul","value":880},{"label":"Ago","value":673},{"label":"Set","value":741},{"label":"Out","value":859},{"label":"Nov","value":598},{"label":"Dez","value":806}];
const MX = 939;
