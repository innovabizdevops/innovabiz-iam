...
const KPIS = [{"l":"Total Acord Claims","v":"3.408","t":"+15.9%","d":"up"},{"l":"Investigate Ativos","v":"6.317","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"82.2%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"73","t":"+1.1%","d":"up"}];
const COLS = ["ID","Investigate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Acord Claims #001","Acord Claims #002","2.607","9.072","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Acord Claims #002","Acord Claims #003","1.972","8.832","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Acord Claims #003","Acord Claims #004","1.527","3.804","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Acord Claims #004","Acord Claims #005","328","6.681","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Acord Claims #005","Acord Claims #001","4.028","509","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":983},{"label":"Fev","value":795},{"label":"Mar","value":895},{"label":"Abr","value":1015},{"label":"Mai","value":800},{"label":"Jun","value":997},{"label":"Jul","value":839},{"label":"Ago","value":866},{"label":"Set","value":929},{"label":"Out","value":862},{"label":"Nov","value":971},{"label":"Dez","value":839}];
const MX = 1015;
