...
const PAGE = "Settle";
const KPIS = [{"l":"Total Acord Claims","v":"1.796","t":"-3.6%","d":"down"},{"l":"Settle Ativos","v":"5.348","t":"+14.1%","d":"up"},{"l":"Eficiência (%)","v":"94.8%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"68","t":"+0.6%","d":"up"}];
const COLS = ["ID","Settle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Acord Claims #001","Acord Claims #002","6.331","1.482","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Acord Claims #002","Acord Claims #003","6.307","1.214","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Acord Claims #003","Acord Claims #004","7.309","5.546","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Acord Claims #004","Acord Claims #005","791","6.400","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Acord Claims #005","Acord Claims #001","1.860","5.098","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":631},{"label":"Mar","value":801},{"label":"Abr","value":617},{"label":"Mai","value":713},{"label":"Jun","value":572},{"label":"Jul","value":601},{"label":"Ago","value":508},{"label":"Set","value":597},{"label":"Out","value":553},{"label":"Nov","value":520},{"label":"Dez","value":655}];
const MX = 801;
