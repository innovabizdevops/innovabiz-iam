...
/* ═══ Claims (ACORD) — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "5508", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4996", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€276K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1279471508", cells: ["ACO-5508", "Claims (ACORD) Item 1", "1/9/2026", "€21 608"], status: "active" as const },
    { id: "1279475079", cells: ["ACO-9079", "Claims (ACORD) Item 2", "16/4/2026", "€25 179"], status: "pending" as const },
    { id: "1279478650", cells: ["ACO-3650", "Claims (ACORD) Item 3", "3/11/2026", "€28 750"], status: "completed" as const },
    { id: "1279482221", cells: ["ACO-7221", "Claims (ACORD) Item 4", "18/6/2026", "€32 321"], status: "warning" as const },
    { id: "1279485792", cells: ["ACO-1792", "Claims (ACORD) Item 5", "5/1/2026", "€35 892"], status: "active" as const },
];
...
export default function ClaimsAcordPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Claims (ACORD)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Claims (ACORD)</p>
                    </div>
                </div>
