...
const ACCENT = "#0891b2";
const MODULE = "Claims (ACORD)";
const PAGE = "Subrogate";
const KPIS = [{"l":"Total Acord Claims","v":"6.107","t":"+13.2%","d":"up"},{"l":"Subrogate Ativos","v":"8.357","t":"-3.9%","d":"down"},{"l":"Eficiência (%)","v":"94.2%","t":"+13.3%","d":"up"},{"l":"Score Performance","v":"80","t":"+8.3%","d":"up"}];
const COLS = ["ID","Subrogate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Acord Claims #001","Acord Claims #002","5.050","3.860","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Acord Claims #002","Acord Claims #003","6.389","3.721","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Acord Claims #003","Acord Claims #004","3.464","3.388","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Acord Claims #004","Acord Claims #005","1.534","2.561","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Acord Claims #005","Acord Claims #001","2.094","3.051","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":759},{"label":"Fev","value":820},{"label":"Mar","value":691},{"label":"Abr","value":812},{"label":"Mai","value":825},{"label":"Jun","value":587},{"label":"Jul","value":637},{"label":"Ago","value":429},{"label":"Set","value":636},{"label":"Out","value":591},{"label":"Nov","value":725},{"label":"Dez","value":677}];
const MX = 825;
...
export default function SubrogatePage() {
    return (
