...
const PAGE = "Permit Track";
const KPIS = [{"l":"Riscos Identificados","v":"3.508","t":"+14.6%","d":"up"},{"l":"Mitigações Ativas","v":"7.032","t":"+4.7%","d":"up"},{"l":"Score Risco Geral","v":"91","t":"-2.3%","d":"down"},{"l":"Incidentes YTD","v":"7.129","t":"+5.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.953","5.826","884","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.987","545","4.735","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.920","6.311","1.128","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.354","3.978","2.247","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.083","3.550","5.937","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":384},{"label":"Mar","value":748},{"label":"Abr","value":589},{"label":"Mai","value":617},{"label":"Jun","value":555},{"label":"Jul","value":511},{"label":"Ago","value":766},{"label":"Set","value":673},{"label":"Out","value":455},{"label":"Nov","value":582},{"label":"Dez","value":429}];
const MX = 766;
