...
const ACCENT = "#0c4a6e";
const MODULE = "Stormwater Management";
const PAGE = "Green Infra";
const KPIS = [{"l":"Total Stormwater","v":"3.696","t":"-2.0%","d":"down"},{"l":"Green Infra Ativos","v":"2.826","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"92.1%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"69","t":"+7.6%","d":"up"}];
const COLS = ["ID","Green Infra","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stormwater #001","Stormwater #002","1.514","834","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Stormwater #002","Stormwater #003","1.499","5.848","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Stormwater #003","Stormwater #004","5.064","7.647","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Stormwater #004","Stormwater #005","6.847","668","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stormwater #005","Stormwater #001","8.519","5.175","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":419},{"label":"Mar","value":636},{"label":"Abr","value":531},{"label":"Mai","value":616},{"label":"Jun","value":410},{"label":"Jul","value":278},{"label":"Ago","value":381},{"label":"Set","value":566},{"label":"Out","value":509},{"label":"Nov","value":432},{"label":"Dez","value":508}];
const MX = 636;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0c4a6e'}}>ESG</span></h1>
                </div>
