...
const KPIS = [{"l":"Dashboards Ativos","v":"3.949","t":"+11.1%","d":"up"},{"l":"Queries/Dia","v":"4108","t":"+11.3%","d":"up"},{"l":"Dados Processados (GB)","v":"606","t":"+7.5%","d":"up"},{"l":"Utilizadores Analytics","v":"6.167","t":"-2.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2989","2026-03-26","5.702","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1716","2026-03-05","8.098","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2758","2026-02-01","7.704","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4722","2026-03-04","4.008","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4226","2026-03-25","746","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":518},{"label":"Fev","value":388},{"label":"Mar","value":709},{"label":"Abr","value":389},{"label":"Mai","value":721},{"label":"Jun","value":528},{"label":"Jul","value":757},{"label":"Ago","value":584},{"label":"Set","value":672},{"label":"Out","value":740},{"label":"Nov","value":379},{"label":"Dez","value":407}];
const MX = 757;
