...
const PAGE = "Carbon";
const KPIS = [{"l":"Dashboards Ativos","v":"8.862","t":"+4.5%","d":"up"},{"l":"Queries/Dia","v":"2276","t":"+13.8%","d":"up"},{"l":"Dados Processados (GB)","v":"8.263","t":"+10.8%","d":"up"},{"l":"Utilizadores Analytics","v":"6.905","t":"+8.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","635","2026-02-20","4.939","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4622","2026-01-19","1.766","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4686","2026-01-17","3.681","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","333","2026-03-11","847","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2805","2026-02-11","7.871","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":854},{"label":"Fev","value":869},{"label":"Mar","value":744},{"label":"Abr","value":963},{"label":"Mai","value":847},{"label":"Jun","value":795},{"label":"Jul","value":969},{"label":"Ago","value":708},{"label":"Set","value":926},{"label":"Out","value":972},{"label":"Nov","value":625},{"label":"Dez","value":748}];
const MX = 972;
