...
const PAGE = "Recovery";
const KPIS = [{"l":"Dashboards Ativos","v":"800","t":"+17.4%","d":"up"},{"l":"Queries/Dia","v":"4516","t":"+9.2%","d":"up"},{"l":"Dados Processados (GB)","v":"6.771","t":"+5.7%","d":"up"},{"l":"Utilizadores Analytics","v":"6.839","t":"-1.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3527","2026-02-05","8.910","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2839","2026-03-01","4.868","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3350","2026-01-10","7.562","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1690","2026-01-23","4.255","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2638","2026-01-23","5.453","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":794},{"label":"Fev","value":664},{"label":"Mar","value":684},{"label":"Abr","value":789},{"label":"Mai","value":561},{"label":"Jun","value":542},{"label":"Jul","value":517},{"label":"Ago","value":495},{"label":"Set","value":819},{"label":"Out","value":813},{"label":"Nov","value":833},{"label":"Dez","value":479}];
const MX = 833;
