...
const ACCENT = "#064e3b";
const MODULE = "Circular Economy Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"4.132","t":"+17.1%","d":"up"},{"l":"Queries/Dia","v":"3802","t":"+5.4%","d":"up"},{"l":"Dados Processados (GB)","v":"8.857","t":"-2.7%","d":"down"},{"l":"Utilizadores Analytics","v":"2.408","t":"+3.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1199","2026-01-02","3.401","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2061","2026-02-14","6.642","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","5018","2026-03-24","7.783","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2355","2026-02-23","7.570","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","308","2026-02-06","5.184","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":768},{"label":"Mar","value":553},{"label":"Abr","value":778},{"label":"Mai","value":502},{"label":"Jun","value":493},{"label":"Jul","value":559},{"label":"Ago","value":612},{"label":"Set","value":746},{"label":"Out","value":663},{"label":"Nov","value":494},{"label":"Dez","value":728}];
const MX = 778;
