...
const PAGE = "Value";
const KPIS = [{"l":"Dashboards Ativos","v":"3.035","t":"+7.5%","d":"up"},{"l":"Queries/Dia","v":"1905","t":"+13.5%","d":"up"},{"l":"Dados Processados (GB)","v":"9.072","t":"+7.0%","d":"up"},{"l":"Utilizadores Analytics","v":"3.881","t":"-2.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2231","2026-03-16","6.472","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","659","2026-01-05","6.051","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1183","2026-01-16","7.311","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3055","2026-03-01","4.567","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2866","2026-02-13","2.658","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":488},{"label":"Fev","value":441},{"label":"Mar","value":436},{"label":"Abr","value":339},{"label":"Mai","value":320},{"label":"Jun","value":211},{"label":"Jul","value":599},{"label":"Ago","value":216},{"label":"Set","value":501},{"label":"Out","value":372},{"label":"Nov","value":495},{"label":"Dez","value":482}];
const MX = 599;
