...
const KPIS = [
    { label: "Total Registos", value: "9435", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2955", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€268K", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "601196735", cells: ["CIR-6735", "Circular Economy Analytics Item 1", "28/12/2026", "€46 835"], status: "active" as const },
    { id: "601200306", cells: ["CIR-1306", "Circular Economy Analytics Item 2", "15/7/2026", "€406"], status: "pending" as const },
    { id: "601203877", cells: ["CIR-4877", "Circular Economy Analytics Item 3", "2/2/2026", "€3977"], status: "completed" as const },
    { id: "601207448", cells: ["CIR-8448", "Circular Economy Analytics Item 4", "17/9/2026", "€7548"], status: "warning" as const },
    { id: "601211019", cells: ["CIR-3019", "Circular Economy Analytics Item 5", "4/4/2026", "€11 119"], status: "active" as const },
];
...
export default function CircularEconomyAnalyticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Circular Economy Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Circular Economy Analytics</p>
                    </div>
                </div>
