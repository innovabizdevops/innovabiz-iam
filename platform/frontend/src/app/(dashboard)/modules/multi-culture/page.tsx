...
/* ═══ Multi-Culture Engine — Dashboard ═══ */

const ACCENT = "#0ea5e9";

const KPIS = [
    { label: "Total Registos", value: "1117", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "867", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€88K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "573151617", cells: ["MUL-5617", "Multi-Culture Engine Item 1", "18/10/2026", "€1717"], status: "active" as const },
    { id: "573155188", cells: ["MUL-9188", "Multi-Culture Engine Item 2", "5/5/2026", "€5288"], status: "pending" as const },
    { id: "573158759", cells: ["MUL-3759", "Multi-Culture Engine Item 3", "20/12/2026", "€8859"], status: "completed" as const },
    { id: "573162330", cells: ["MUL-7330", "Multi-Culture Engine Item 4", "7/7/2026", "€12 430"], status: "warning" as const },
    { id: "573165901", cells: ["MUL-1901", "Multi-Culture Engine Item 5", "22/2/2026", "€16 001"], status: "active" as const },
];
...
export default function MulticultureEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Multi-Culture Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Multi-Culture Engine</p>
                    </div>
                </div>
