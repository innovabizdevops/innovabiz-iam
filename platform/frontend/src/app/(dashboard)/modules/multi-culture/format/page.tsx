...
const PAGE = "Format";
const KPIS = [{"l":"Formulários Ativos","v":"3.979","t":"+16.9%","d":"up"},{"l":"Submissões/Dia","v":"2748","t":"+5.5%","d":"up"},{"l":"Documentos Gerados","v":"7.611","t":"+13.0%","d":"up"},{"l":"Templates","v":"8.974","t":"-3.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.101","2026-02-23","4.531","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","416","2026-01-03","7.727","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.656","2026-03-14","8.485","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.385","2026-01-20","1.551","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.923","2026-01-25","5.021","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":838},{"label":"Mar","value":524},{"label":"Abr","value":633},{"label":"Mai","value":552},{"label":"Jun","value":548},{"label":"Jul","value":713},{"label":"Ago","value":711},{"label":"Set","value":671},{"label":"Out","value":674},{"label":"Nov","value":614},{"label":"Dez","value":596}];
const MX = 838;
