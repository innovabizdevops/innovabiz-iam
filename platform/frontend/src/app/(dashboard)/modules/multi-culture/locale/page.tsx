...
const ACCENT = "#0ea5e9";
const MODULE = "Multi-Culture Engine";
const PAGE = "Locale";
const KPIS = [{"l":"Configurações","v":"8.633","t":"+16.5%","d":"up"},{"l":"Últimas Alterações","v":"1.735","t":"-5.1%","d":"down"},{"l":"Ambientes","v":"3.191","t":"+13.2%","d":"up"},{"l":"Versão Config","v":"7.416","t":"+13.5%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 28351.73","5.756","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 22756.96","2.770","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 13489.52","1.170","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 14764.84","2.367","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 25320.68","7.969","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":369},{"label":"Fev","value":548},{"label":"Mar","value":336},{"label":"Abr","value":559},{"label":"Mai","value":523},{"label":"Jun","value":447},{"label":"Jul","value":610},{"label":"Ago","value":494},{"label":"Set","value":411},{"label":"Out","value":666},{"label":"Nov","value":527},{"label":"Dez","value":651}];
const MX = 666;
