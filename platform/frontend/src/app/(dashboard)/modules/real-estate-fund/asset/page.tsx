...
const KPIS = [{"l":"Ativos Registados","v":"5.056","t":"+16.9%","d":"up"},{"l":"Valor Total (€M)","v":"€41.9M","t":"-0.7%","d":"down"},{"l":"Depreciação Anual (€)","v":"€62016","t":"+6.4%","d":"up"},{"l":"Ativos em Garantia","v":"2.778","t":"+12.7%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 48163.74","2.474","€ 33691.53","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 47499.18","3.901","€ 47497.51","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 42625.76","1.554","€ 47638.63","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 49618.94","8.423","€ 13635.31","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 16583.29","9.064","€ 48550.23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1041},{"label":"Fev","value":667},{"label":"Mar","value":874},{"label":"Abr","value":903},{"label":"Mai","value":651},{"label":"Jun","value":845},{"label":"Jul","value":990},{"label":"Ago","value":997},{"label":"Set","value":741},{"label":"Out","value":901},{"label":"Nov","value":912},{"label":"Dez","value":945}];
const MX = 1041;
