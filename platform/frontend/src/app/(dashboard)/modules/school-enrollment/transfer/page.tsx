...
const PAGE = "Transfer";
const KPIS = [{"l":"Total School Enrollment","v":"3.348","t":"+15.8%","d":"up"},{"l":"Transfer Ativos","v":"3.330","t":"+2.8%","d":"up"},{"l":"Eficiência (%)","v":"78.9%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"71","t":"+6.2%","d":"up"}];
const COLS = ["ID","Transfer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["School Enrollment #001","School Enrollment #002","547","4.186","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["School Enrollment #002","School Enrollment #003","245","4.914","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["School Enrollment #003","School Enrollment #004","4.714","3.632","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["School Enrollment #004","School Enrollment #005","5.897","1.622","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["School Enrollment #005","School Enrollment #001","7.497","3.957","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":354},{"label":"Fev","value":585},{"label":"Mar","value":684},{"label":"Abr","value":704},{"label":"Mai","value":452},{"label":"Jun","value":605},{"label":"Jul","value":645},{"label":"Ago","value":343},{"label":"Set","value":401},{"label":"Out","value":649},{"label":"Nov","value":356},{"label":"Dez","value":520}];
const MX = 704;
