...
const PAGE = "Report";
const KPIS = [{"l":"Total School Enrollment","v":"759","t":"+0.9%","d":"up"},{"l":"Report Ativos","v":"8.708","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"94.2%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"94","t":"-3.0%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["School Enrollment #001","School Enrollment #002","686","5.568","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["School Enrollment #002","School Enrollment #003","7.766","3.461","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["School Enrollment #003","School Enrollment #004","1.894","2.854","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["School Enrollment #004","School Enrollment #005","6.264","4.090","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["School Enrollment #005","School Enrollment #001","1.731","8.889","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":832},{"label":"Fev","value":852},{"label":"Mar","value":948},{"label":"Abr","value":904},{"label":"Mai","value":988},{"label":"Jun","value":677},{"label":"Jul","value":714},{"label":"Ago","value":700},{"label":"Set","value":824},{"label":"Out","value":956},{"label":"Nov","value":740},{"label":"Dez","value":1049}];
const MX = 1049;
