...
const KPIS = [{"l":"Total School Enrollment","v":"3.147","t":"+5.7%","d":"up"},{"l":"Application Ativos","v":"4.025","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"77.1%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"93","t":"-0.2%","d":"down"}];
const COLS = ["ID","Application","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["School Enrollment #001","School Enrollment #002","5.217","5.734","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["School Enrollment #002","School Enrollment #003","4.075","5.975","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["School Enrollment #003","School Enrollment #004","1.028","634","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["School Enrollment #004","School Enrollment #005","1.784","721","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["School Enrollment #005","School Enrollment #001","6.850","8.973","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":801},{"label":"Mar","value":597},{"label":"Abr","value":737},{"label":"Mai","value":594},{"label":"Jun","value":714},{"label":"Jul","value":651},{"label":"Ago","value":601},{"label":"Set","value":846},{"label":"Out","value":693},{"label":"Nov","value":739},{"label":"Dez","value":497}];
const MX = 864;
