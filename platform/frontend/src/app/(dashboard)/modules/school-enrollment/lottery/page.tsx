...
const PAGE = "Lottery";
const KPIS = [{"l":"Total School Enrollment","v":"7.882","t":"+5.3%","d":"up"},{"l":"Lottery Ativos","v":"6.783","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"94.0%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"62","t":"+4.0%","d":"up"}];
const COLS = ["ID","Lottery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["School Enrollment #001","School Enrollment #002","2.920","8.357","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["School Enrollment #002","School Enrollment #003","2.495","1.696","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["School Enrollment #003","School Enrollment #004","6.725","326","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["School Enrollment #004","School Enrollment #005","6.940","712","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["School Enrollment #005","School Enrollment #001","2.180","3.806","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":768},{"label":"Mar","value":575},{"label":"Abr","value":839},{"label":"Mai","value":672},{"label":"Jun","value":784},{"label":"Jul","value":667},{"label":"Ago","value":684},{"label":"Set","value":802},{"label":"Out","value":507},{"label":"Nov","value":683},{"label":"Dez","value":815}];
const MX = 875;
