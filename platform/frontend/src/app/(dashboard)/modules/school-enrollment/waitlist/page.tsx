...
const ACCENT = "#6366f1";
const MODULE = "School Enrollment";
const PAGE = "Wait List";
const KPIS = [{"l":"Total School Enrollment","v":"5.463","t":"+9.8%","d":"up"},{"l":"Wait List Ativos","v":"6.673","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"67.3%","t":"+15.4%","d":"up"},{"l":"Score Performance","v":"83","t":"-4.0%","d":"down"}];
const COLS = ["ID","Wait List","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["School Enrollment #001","School Enrollment #002","4.042","7.435","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["School Enrollment #002","School Enrollment #003","7.764","1.800","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["School Enrollment #003","School Enrollment #004","7.521","3.131","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["School Enrollment #004","School Enrollment #005","4.145","8.346","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["School Enrollment #005","School Enrollment #001","7.681","7.555","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":988},{"label":"Mar","value":823},{"label":"Abr","value":916},{"label":"Mai","value":990},{"label":"Jun","value":968},{"label":"Jul","value":693},{"label":"Ago","value":877},{"label":"Set","value":869},{"label":"Out","value":937},{"label":"Nov","value":850},{"label":"Dez","value":947}];
const MX = 990;
