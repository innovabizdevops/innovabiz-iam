...
const PAGE = "Form";
const KPIS = [{"l":"Formulários Ativos","v":"1.972","t":"+16.2%","d":"up"},{"l":"Submissões/Dia","v":"830","t":"-4.3%","d":"down"},{"l":"Documentos Gerados","v":"7.725","t":"+8.7%","d":"up"},{"l":"Templates","v":"7.231","t":"+2.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.827","2026-03-04","1.241","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.287","2026-02-10","2.166","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","248","2026-02-08","6.047","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.263","2026-02-23","1.107","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.599","2026-02-06","8.965","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":771},{"label":"Fev","value":593},{"label":"Mar","value":488},{"label":"Abr","value":599},{"label":"Mai","value":688},{"label":"Jun","value":619},{"label":"Jul","value":827},{"label":"Ago","value":817},{"label":"Set","value":788},{"label":"Out","value":754},{"label":"Nov","value":608},{"label":"Dez","value":610}];
const MX = 827;
