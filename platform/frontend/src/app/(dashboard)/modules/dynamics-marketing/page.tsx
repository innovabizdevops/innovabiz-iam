...
/* ═══ Marketing Hub (D365) — Dashboard ═══ */

const ACCENT = "#00bcf2";

const KPIS = [
    { label: "Total Registos", value: "4264", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4616", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€457K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1812218964", cells: ["DYN-6964", "Marketing Hub (D365) Item 1", "25/1/2026", "€19 064"], status: "active" as const },
    { id: "1812222535", cells: ["DYN-1535", "Marketing Hub (D365) Item 2", "12/8/2026", "€22 635"], status: "pending" as const },
    { id: "1812226106", cells: ["DYN-5106", "Marketing Hub (D365) Item 3", "27/3/2026", "€26 206"], status: "completed" as const },
    { id: "1812229677", cells: ["DYN-8677", "Marketing Hub (D365) Item 4", "14/10/2026", "€29 777"], status: "warning" as const },
    { id: "1812233248", cells: ["DYN-3248", "Marketing Hub (D365) Item 5", "1/5/2026", "€33 348"], status: "active" as const },
];
...
export default function MarketingHubD365Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Marketing Hub (D365)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Marketing Hub (D365)</p>
                    </div>
                </div>
