...
const ACCENT = "#00bcf2";
const MODULE = "Marketing Hub (D365)";
const PAGE = "Segment";
const KPIS = [{"l":"Perfis Unificados","v":"8.921","t":"+10.0%","d":"up"},{"l":"Segmentos Ativos","v":"5.037","t":"+10.9%","d":"up"},{"l":"NPS Score","v":"73","t":"+8.4%","d":"up"},{"l":"Churn Previsto (%)","v":"81.0%","t":"+0.6%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","6.320","€ 22832.39","79.1%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","6.496","€ 12178.84","89.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","3.262","€ 8054.18","93.9%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","8.062","€ 42677.27","83.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","2.307","€ 8275.46","74.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":971},{"label":"Fev","value":922},{"label":"Mar","value":621},{"label":"Abr","value":678},{"label":"Mai","value":632},{"label":"Jun","value":980},{"label":"Jul","value":888},{"label":"Ago","value":931},{"label":"Set","value":731},{"label":"Out","value":703},{"label":"Nov","value":666},{"label":"Dez","value":748}];
const MX = 980;
