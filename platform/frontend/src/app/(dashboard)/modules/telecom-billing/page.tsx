...
export default function TelecomBillingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Telecom Billing</h1><p className="text-sm text-muted-foreground">Telecom Billing • iBOS Enterprise</p></div>
