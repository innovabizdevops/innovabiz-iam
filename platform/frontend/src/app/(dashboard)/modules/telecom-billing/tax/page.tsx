...
const KPIS = [{"l":"Total Telecom Billing","v":"8.069","t":"+2.5%","d":"up"},{"l":"Tax Engine Ativos","v":"3.505","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"87.1%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"84","t":"+1.0%","d":"up"}];
const COLS = ["ID","Tax Engine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Billing #001","Telecom Billing #002","4.339","6.700","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Billing #002","Telecom Billing #003","3.791","4.955","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Billing #003","Telecom Billing #004","4.089","3.248","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Billing #004","Telecom Billing #005","303","6.709","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Billing #005","Telecom Billing #001","2.088","3.318","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":886},{"label":"Mar","value":901},{"label":"Abr","value":710},{"label":"Mai","value":714},{"label":"Jun","value":802},{"label":"Jul","value":784},{"label":"Ago","value":652},{"label":"Set","value":713},{"label":"Out","value":849},{"label":"Nov","value":883},{"label":"Dez","value":850}];
const MX = 901;
