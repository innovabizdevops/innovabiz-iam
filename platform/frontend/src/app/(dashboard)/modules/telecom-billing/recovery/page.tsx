...
const PAGE = "Revenue Recov";
const KPIS = [{"l":"ARR (€M)","v":"€15.3M","t":"+12.0%","d":"up"},{"l":"MRR (€)","v":"€19631","t":"-0.8%","d":"down"},{"l":"Churn (%)","v":"65.9%","t":"+0.5%","d":"up"},{"l":"ARPU (€)","v":"€67931","t":"+7.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 48818.02","5.763","€ 21724.95","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 32852.37","4.198","€ 42217.97","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 2364.27","7.772","€ 43359.58","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 15383.16","8.089","€ 24446.02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 19501.77","5.049","€ 46099.90","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":563},{"label":"Mar","value":582},{"label":"Abr","value":558},{"label":"Mai","value":718},{"label":"Jun","value":685},{"label":"Jul","value":418},{"label":"Ago","value":466},{"label":"Set","value":461},{"label":"Out","value":547},{"label":"Nov","value":757},{"label":"Dez","value":692}];
const MX = 757;
