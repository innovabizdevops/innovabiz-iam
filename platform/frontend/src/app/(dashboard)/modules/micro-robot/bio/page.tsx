...
const PAGE = "Bio Micro";
const KPIS = [{"l":"Total Micro Robot","v":"8.036","t":"+1.8%","d":"up"},{"l":"Bio Micro Ativos","v":"1.401","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"82.1%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"68","t":"-0.3%","d":"down"}];
const COLS = ["ID","Bio Micro","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Micro Robot #001","Micro Robot #002","2.224","5.546","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Micro Robot #002","Micro Robot #003","5.500","2.572","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Micro Robot #003","Micro Robot #004","1.697","7.086","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Micro Robot #004","Micro Robot #005","7.345","6.080","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Micro Robot #005","Micro Robot #001","6.046","840","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":750},{"label":"Mar","value":591},{"label":"Abr","value":684},{"label":"Mai","value":983},{"label":"Jun","value":706},{"label":"Jul","value":931},{"label":"Ago","value":767},{"label":"Set","value":618},{"label":"Out","value":947},{"label":"Nov","value":927},{"label":"Dez","value":898}];
const MX = 983;
