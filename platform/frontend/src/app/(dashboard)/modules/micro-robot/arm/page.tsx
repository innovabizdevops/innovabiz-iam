...
const PAGE = "Micro Arm";
const KPIS = [{"l":"Total Micro Robot","v":"1.516","t":"+3.6%","d":"up"},{"l":"Micro Arm Ativos","v":"3.256","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"86.9%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"83","t":"+1.4%","d":"up"}];
const COLS = ["ID","Micro Arm","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Micro Robot #001","Micro Robot #002","7.662","2.318","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Micro Robot #002","Micro Robot #003","6.797","2.228","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Micro Robot #003","Micro Robot #004","6.759","2.353","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Micro Robot #004","Micro Robot #005","4.800","469","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Micro Robot #005","Micro Robot #001","1.463","5.384","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":321},{"label":"Fev","value":563},{"label":"Mar","value":581},{"label":"Abr","value":376},{"label":"Mai","value":651},{"label":"Jun","value":438},{"label":"Jul","value":587},{"label":"Ago","value":539},{"label":"Set","value":507},{"label":"Out","value":432},{"label":"Nov","value":377},{"label":"Dez","value":275}];
const MX = 651;
