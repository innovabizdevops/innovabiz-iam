...
export default function MicroRobotPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Micro Robot</h1><p className="text-sm text-muted-foreground">Micro Robot • iBOS Enterprise</p></div>
