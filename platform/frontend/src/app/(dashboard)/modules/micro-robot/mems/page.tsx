...
const PAGE = "MEMS";
const KPIS = [{"l":"Total Micro Robot","v":"4.930","t":"+2.1%","d":"up"},{"l":"MEMS Ativos","v":"6.196","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"84","t":"-0.8%","d":"down"}];
const COLS = ["ID","MEMS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Micro Robot #001","Micro Robot #002","4.733","1.325","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Micro Robot #002","Micro Robot #003","230","6.717","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Micro Robot #003","Micro Robot #004","973","1.837","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Micro Robot #004","Micro Robot #005","2.534","6.786","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Micro Robot #005","Micro Robot #001","243","2.712","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":903},{"label":"Mar","value":797},{"label":"Abr","value":821},{"label":"Mai","value":736},{"label":"Jun","value":728},{"label":"Jul","value":839},{"label":"Ago","value":776},{"label":"Set","value":594},{"label":"Out","value":819},{"label":"Nov","value":647},{"label":"Dez","value":892}];
const MX = 903;
