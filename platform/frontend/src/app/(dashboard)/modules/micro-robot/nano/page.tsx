...
const ACCENT = "#6366f1";
const MODULE = "Micro Robotics";
const PAGE = "Nano Assem";
const KPIS = [{"l":"Total Micro Robot","v":"3.360","t":"+17.9%","d":"up"},{"l":"Nano Assem Ativos","v":"1.205","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"72","t":"+9.2%","d":"up"}];
const COLS = ["ID","Nano Assem","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Micro Robot #001","Micro Robot #002","4.078","7.203","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Micro Robot #002","Micro Robot #003","4.011","2.645","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Micro Robot #003","Micro Robot #004","1.338","7.142","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Micro Robot #004","Micro Robot #005","641","4.077","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Micro Robot #005","Micro Robot #001","9.029","1.101","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":789},{"label":"Mar","value":658},{"label":"Abr","value":626},{"label":"Mai","value":820},{"label":"Jun","value":762},{"label":"Jul","value":698},{"label":"Ago","value":631},{"label":"Set","value":612},{"label":"Out","value":902},{"label":"Nov","value":904},{"label":"Dez","value":820}];
const MX = 904;
