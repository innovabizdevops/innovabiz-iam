...
const PAGE = "Measure";
const KPIS = [{"l":"eNPS","v":"64","t":"+3.3%","d":"up"},{"l":"Engagement (%)","v":"86.6%","t":"+14.1%","d":"up"},{"l":"Turnover (%)","v":"87.7%","t":"+16.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"694","t":"+0.5%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.998","2026-03-02","59","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.353","2026-02-11","70","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.009","2026-02-28","88","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.152","2026-02-03","71","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.192","2026-02-17","86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":523},{"label":"Mar","value":840},{"label":"Abr","value":772},{"label":"Mai","value":647},{"label":"Jun","value":626},{"label":"Jul","value":729},{"label":"Ago","value":701},{"label":"Set","value":605},{"label":"Out","value":676},{"label":"Nov","value":564},{"label":"Dez","value":859}];
const MX = 864;
