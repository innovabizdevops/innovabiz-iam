...
const PAGE = "Social";
const KPIS = [{"l":"eNPS","v":"62","t":"+3.6%","d":"up"},{"l":"Engagement (%)","v":"74.3%","t":"+11.9%","d":"up"},{"l":"Turnover (%)","v":"73.9%","t":"+6.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.200","t":"+9.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.792","2026-02-24","56","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.017","2026-01-26","90","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.532","2026-02-21","80","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.311","2026-03-17","72","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.027","2026-01-19","78","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":411},{"label":"Mar","value":273},{"label":"Abr","value":251},{"label":"Mai","value":212},{"label":"Jun","value":264},{"label":"Jul","value":334},{"label":"Ago","value":385},{"label":"Set","value":569},{"label":"Out","value":316},{"label":"Nov","value":369},{"label":"Dez","value":228}];
const MX = 569;
