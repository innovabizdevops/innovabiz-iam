...
/* ═══ Employee Wellbeing Platform — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "7417", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4380", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€349K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "-25%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "630073017", cells: ["EMP-2017", "Employee Wellbeing Platform Item 1", "22/10/2026", "€23 117"], status: "active" as const },
    { id: "630076588", cells: ["EMP-5588", "Employee Wellbeing Platform Item 2", "9/5/2026", "€26 688"], status: "pending" as const },
    { id: "630080159", cells: ["EMP-9159", "Employee Wellbeing Platform Item 3", "24/12/2026", "€30 259"], status: "completed" as const },
    { id: "630083730", cells: ["EMP-3730", "Employee Wellbeing Platform Item 4", "11/7/2026", "€33 830"], status: "warning" as const },
    { id: "630087301", cells: ["EMP-7301", "Employee Wellbeing Platform Item 5", "26/2/2026", "€37 401"], status: "active" as const },
];
...
export default function EmployeeWellbeingPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Employee Wellbeing Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Employee Wellbeing Platform</p>
                    </div>
                </div>
