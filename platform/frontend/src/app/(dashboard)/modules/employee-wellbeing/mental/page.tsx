...
const PAGE = "Mental";
const KPIS = [{"l":"eNPS","v":"94","t":"+6.7%","d":"up"},{"l":"Engagement (%)","v":"88.3%","t":"+0.3%","d":"up"},{"l":"Turnover (%)","v":"75.7%","t":"+7.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"8.487","t":"-0.7%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.146","2026-02-07","77","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.111","2026-02-22","85","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.475","2026-03-26","61","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.080","2026-01-17","78","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.375","2026-03-02","86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":504},{"label":"Mar","value":679},{"label":"Abr","value":831},{"label":"Mai","value":499},{"label":"Jun","value":618},{"label":"Jul","value":695},{"label":"Ago","value":788},{"label":"Set","value":495},{"label":"Out","value":723},{"label":"Nov","value":772},{"label":"Dez","value":490}];
const MX = 831;
