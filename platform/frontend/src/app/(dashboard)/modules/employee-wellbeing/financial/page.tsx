...
const ACCENT = "#0e7490";
const MODULE = "Employee Wellbeing Platform";
const PAGE = "Financial";
const KPIS = [{"l":"eNPS","v":"94","t":"+8.2%","d":"up"},{"l":"Engagement (%)","v":"84.2%","t":"+6.4%","d":"up"},{"l":"Turnover (%)","v":"69.7%","t":"-1.8%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"7.910","t":"+9.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.685","2026-02-09","64","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.019","2026-02-19","73","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.640","2026-03-09","86","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.888","2026-01-12","83","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.483","2026-01-20","85","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":710},{"label":"Mar","value":667},{"label":"Abr","value":700},{"label":"Mai","value":545},{"label":"Jun","value":659},{"label":"Jul","value":803},{"label":"Ago","value":678},{"label":"Set","value":618},{"label":"Out","value":565},{"label":"Nov","value":861},{"label":"Dez","value":481}];
const MX = 861;
