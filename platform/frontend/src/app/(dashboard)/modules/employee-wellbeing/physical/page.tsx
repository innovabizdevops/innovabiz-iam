...
const PAGE = "Physical";
const KPIS = [{"l":"eNPS","v":"69","t":"+17.0%","d":"up"},{"l":"Engagement (%)","v":"67.6%","t":"+5.2%","d":"up"},{"l":"Turnover (%)","v":"80.5%","t":"-0.2%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"7.717","t":"+14.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.423","2026-01-22","71","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.219","2026-01-03","73","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.599","2026-01-07","57","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.341","2026-01-04","81","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","901","2026-03-18","62","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":820},{"label":"Mar","value":844},{"label":"Abr","value":971},{"label":"Mai","value":844},{"label":"Jun","value":653},{"label":"Jul","value":741},{"label":"Ago","value":769},{"label":"Set","value":605},{"label":"Out","value":768},{"label":"Nov","value":600},{"label":"Dez","value":591}];
const MX = 971;
