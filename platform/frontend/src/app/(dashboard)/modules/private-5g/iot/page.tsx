...
const ACCENT = "#9333ea";
const MODULE = "Private 5G";
const PAGE = "IoT Connect";
const KPIS = [{"l":"Dispositivos Online","v":"3.053","t":"-2.0%","d":"down"},{"l":"Dados/Min (MB)","v":"1.830","t":"+14.3%","d":"up"},{"l":"Alertas Ativos","v":"2.208","t":"+16.6%","d":"up"},{"l":"Uptime (%)","v":"93.6%","t":"+10.2%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","1.538","3.313","4.121","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.396","8.474","8.784","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.801","4.841","3.591","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.622","2.895","8.979","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.789","3.547","8.879","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":582},{"label":"Mar","value":342},{"label":"Abr","value":562},{"label":"Mai","value":266},{"label":"Jun","value":516},{"label":"Jul","value":294},{"label":"Ago","value":551},{"label":"Set","value":272},{"label":"Out","value":250},{"label":"Nov","value":423},{"label":"Dez","value":439}];
const MX = 582;
