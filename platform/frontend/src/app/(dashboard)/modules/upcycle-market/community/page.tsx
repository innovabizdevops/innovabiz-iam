...
const KPIS = [{"l":"Projetos Sociais","v":"423","t":"+13.2%","d":"up"},{"l":"Beneficiários","v":"8.753","t":"-4.3%","d":"down"},{"l":"Investimento CSR (€)","v":"€14816","t":"-3.1%","d":"down"},{"l":"Score Impacto","v":"71","t":"-4.4%","d":"down"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","9.062","€ 19086.04","6.969","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","4.030","€ 44736.41","7.466","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","7.970","€ 46052.80","7.846","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","6.447","€ 31158.32","5.948","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","611","€ 32179.92","8.772","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":306},{"label":"Fev","value":391},{"label":"Mar","value":354},{"label":"Abr","value":388},{"label":"Mai","value":372},{"label":"Jun","value":307},{"label":"Jul","value":423},{"label":"Ago","value":412},{"label":"Set","value":582},{"label":"Out","value":593},{"label":"Nov","value":383},{"label":"Dez","value":369}];
const MX = 593;
