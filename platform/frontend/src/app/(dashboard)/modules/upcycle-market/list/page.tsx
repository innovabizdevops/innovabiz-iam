...
const ACCENT = "#047857";
const MODULE = "Upcycle Marketplace";
const PAGE = "List";
const KPIS = [{"l":"Total Upcycle Market","v":"6.600","t":"+3.4%","d":"up"},{"l":"List Ativos","v":"9.098","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"91.8%","t":"-2.8%","d":"down"},{"l":"Score Performance","v":"86","t":"+4.8%","d":"up"}];
const COLS = ["ID","List","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Upcycle Market #001","Upcycle Market #002","8.954","7.674","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Upcycle Market #002","Upcycle Market #003","1.093","227","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Upcycle Market #003","Upcycle Market #004","7.634","4.986","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Upcycle Market #004","Upcycle Market #005","7.811","5.381","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Upcycle Market #005","Upcycle Market #001","5.443","2.612","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":1008},{"label":"Mar","value":871},{"label":"Abr","value":674},{"label":"Mai","value":812},{"label":"Jun","value":734},{"label":"Jul","value":851},{"label":"Ago","value":912},{"label":"Set","value":829},{"label":"Out","value":631},{"label":"Nov","value":766},{"label":"Dez","value":695}];
const MX = 1008;
