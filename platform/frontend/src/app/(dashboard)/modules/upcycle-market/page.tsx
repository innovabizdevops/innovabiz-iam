...
/* ═══ Upcycle Marketplace — Dashboard ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total Registos", value: "5675", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1856", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€459K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1229892475", cells: ["UPC-7475", "Upcycle Marketplace Item 1", "8/8/2026", "€42 575"], status: "active" as const },
    { id: "1229896046", cells: ["UPC-2046", "Upcycle Marketplace Item 2", "23/3/2026", "€46 146"], status: "pending" as const },
    { id: "1229899617", cells: ["UPC-5617", "Upcycle Marketplace Item 3", "10/10/2026", "€49 717"], status: "completed" as const },
    { id: "1229903188", cells: ["UPC-9188", "Upcycle Marketplace Item 4", "25/5/2026", "€3288"], status: "warning" as const },
    { id: "1229906759", cells: ["UPC-3759", "Upcycle Marketplace Item 5", "12/12/2026", "€6859"], status: "active" as const },
];
...
export default function UpcycleMarketplacePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Upcycle Marketplace</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Upcycle Marketplace</p>
                    </div>
                </div>
