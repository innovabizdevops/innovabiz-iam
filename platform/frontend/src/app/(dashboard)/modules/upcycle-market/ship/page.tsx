...
const PAGE = "Ship";
const KPIS = [{"l":"Total Upcycle Market","v":"8.506","t":"-1.4%","d":"down"},{"l":"Ship Ativos","v":"7.748","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"71.9%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"91","t":"+7.0%","d":"up"}];
const COLS = ["ID","Ship","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Upcycle Market #001","Upcycle Market #002","8.157","637","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Upcycle Market #002","Upcycle Market #003","6.641","1.283","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Upcycle Market #003","Upcycle Market #004","8.096","2.443","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Upcycle Market #004","Upcycle Market #005","1.345","3.399","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Upcycle Market #005","Upcycle Market #001","551","3.767","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":434},{"label":"Fev","value":630},{"label":"Mar","value":623},{"label":"Abr","value":686},{"label":"Mai","value":427},{"label":"Jun","value":442},{"label":"Jul","value":791},{"label":"Ago","value":535},{"label":"Set","value":743},{"label":"Out","value":672},{"label":"Nov","value":514},{"label":"Dez","value":733}];
const MX = 791;
