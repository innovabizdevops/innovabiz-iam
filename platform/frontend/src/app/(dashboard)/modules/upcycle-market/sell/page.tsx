...
const PAGE = "Sell";
const KPIS = [{"l":"Total Upcycle Market","v":"3.509","t":"+17.4%","d":"up"},{"l":"Sell Ativos","v":"7.115","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+16.1%","d":"up"},{"l":"Score Performance","v":"80","t":"+9.2%","d":"up"}];
const COLS = ["ID","Sell","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Upcycle Market #001","Upcycle Market #002","7.677","2.116","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Upcycle Market #002","Upcycle Market #003","4.311","8.821","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Upcycle Market #003","Upcycle Market #004","8.779","6.243","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Upcycle Market #004","Upcycle Market #005","2.818","2.451","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Upcycle Market #005","Upcycle Market #001","4.387","6.075","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":782},{"label":"Fev","value":685},{"label":"Mar","value":487},{"label":"Abr","value":464},{"label":"Mai","value":633},{"label":"Jun","value":564},{"label":"Jul","value":572},{"label":"Ago","value":788},{"label":"Set","value":603},{"label":"Out","value":776},{"label":"Nov","value":495},{"label":"Dez","value":653}];
const MX = 788;
