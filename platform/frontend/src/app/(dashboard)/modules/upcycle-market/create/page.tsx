...
const PAGE = "Create";
const KPIS = [{"l":"Total Upcycle Market","v":"5.452","t":"+12.2%","d":"up"},{"l":"Create Ativos","v":"4.125","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"70.5%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"56","t":"+5.4%","d":"up"}];
const COLS = ["ID","Create","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Upcycle Market #001","Upcycle Market #002","1.017","6.173","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Upcycle Market #002","Upcycle Market #003","7.708","7.925","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Upcycle Market #003","Upcycle Market #004","7.571","7.590","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Upcycle Market #004","Upcycle Market #005","2.620","5.596","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Upcycle Market #005","Upcycle Market #001","2.492","3.596","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":935},{"label":"Mar","value":667},{"label":"Abr","value":771},{"label":"Mai","value":606},{"label":"Jun","value":787},{"label":"Jul","value":744},{"label":"Ago","value":935},{"label":"Set","value":710},{"label":"Out","value":911},{"label":"Nov","value":912},{"label":"Dez","value":778}];
const MX = 935;
