...
const ROWS = [
  { id: "001", c: ["Cash Forecast-001", "Cash Forecast Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Cash Forecast-002", "Cash Forecast Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Cash Forecast-003", "Cash Forecast Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Cash Forecast-004", "Cash Forecast Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Cash Forecast-005", "Cash Forecast Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Cash Forecast", ts: "Há 2min", a: "Sistema" },
