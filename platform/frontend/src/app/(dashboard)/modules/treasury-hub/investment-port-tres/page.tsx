...
const PAGE = "Investment Port Tres";
const KPIS = [{"l":"Posição Caixa (€M)","v":"47.2","d":"+3.1%","u":true},{"l":"Previsão 30d (€M)","v":"52.8","d":"+8.2%","u":true},{"l":"FX Exposição (€M)","v":"12.4","d":"-2.1%","u":false},{"l":"Cobertura Hedge (%)","v":"87.3%","d":"+4.5%","u":true}];
const COLS = ["Conta","Banco","Moeda","Saldo (€)","Movimento","Estado"];
const ROWS = [
  { id: "001", c: ["Investment Port Tres-001", "Investment Port Tres Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Investment Port Tres-002", "Investment Port Tres Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Investment Port Tres-003", "Investment Port Tres Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Investment Port Tres-004", "Investment Port Tres Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Investment Port Tres-005", "Investment Port Tres Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Investment Port Tres", ts: "Há 2min", a: "Sistema" },
...
export default function InvestmentPortTresPage() {
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Treasury Hub — iBOS Enterprise</p>
        </div>
