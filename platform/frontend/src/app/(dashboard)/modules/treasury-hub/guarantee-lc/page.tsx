...
const ROWS = [
  { id: "001", c: ["Guarantee Lc-001", "Guarantee Lc Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Guarantee Lc-002", "Guarantee Lc Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Guarantee Lc-003", "Guarantee Lc Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Guarantee Lc-004", "Guarantee Lc Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Guarantee Lc-005", "Guarantee Lc Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Guarantee Lc", ts: "Há 2min", a: "Sistema" },
...
export default function GuaranteeLcPage() {
  return (
