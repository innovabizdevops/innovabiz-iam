...
const ROWS = [
  { id: "001", c: ["Bank Reconcile-001", "Bank Reconcile Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Bank Reconcile-002", "Bank Reconcile Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Bank Reconcile-003", "Bank Reconcile Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Bank Reconcile-004", "Bank Reconcile Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Bank Reconcile-005", "Bank Reconcile Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Bank Reconcile", ts: "Há 2min", a: "Sistema" },
