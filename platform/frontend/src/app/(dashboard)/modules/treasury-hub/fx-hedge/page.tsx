...
const ROWS = [
  { id: "001", c: ["Fx Hedge-001", "Fx Hedge Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Fx Hedge-002", "Fx Hedge Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Fx Hedge-003", "Fx Hedge Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Fx Hedge-004", "Fx Hedge Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Fx Hedge-005", "Fx Hedge Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Fx Hedge", ts: "Há 2min", a: "Sistema" },
