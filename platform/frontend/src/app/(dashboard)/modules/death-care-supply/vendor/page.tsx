...
const PAGE = "Vendor";
const KPIS = [{"l":"Fornecedores Ativos","v":"4.672","t":"+11.7%","d":"up"},{"l":"Contratos (€M)","v":"€18.3M","t":"+8.9%","d":"up"},{"l":"On-Time Delivery (%)","v":"92.4%","t":"+9.8%","d":"up"},{"l":"Score Médio","v":"65","t":"+16.0%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","92.2%","€ 223.22","2.483","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","93.2%","€ 858.54","6.877","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","84.0%","€ 14127.49","7.712","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","88.4%","€ 4795.79","6.165","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","95.7%","€ 6417.15","3.340","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":462},{"label":"Fev","value":556},{"label":"Mar","value":313},{"label":"Abr","value":406},{"label":"Mai","value":452},{"label":"Jun","value":537},{"label":"Jul","value":590},{"label":"Ago","value":257},{"label":"Set","value":531},{"label":"Out","value":280},{"label":"Nov","value":211},{"label":"Dez","value":547}];
const MX = 590;
