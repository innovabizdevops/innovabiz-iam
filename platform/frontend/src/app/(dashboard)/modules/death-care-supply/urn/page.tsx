...
const PAGE = "Urn";
const KPIS = [{"l":"Total Death Care Supply","v":"5.255","t":"+12.9%","d":"up"},{"l":"Urn Ativos","v":"7.999","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"92.6%","t":"+11.8%","d":"up"},{"l":"Score Performance","v":"89","t":"-5.2%","d":"down"}];
const COLS = ["ID","Urn","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Death Care Supply #001","Death Care Supply #002","2.681","3.283","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Death Care Supply #002","Death Care Supply #003","4.189","1.713","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Death Care Supply #003","Death Care Supply #004","8.082","2.560","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Death Care Supply #004","Death Care Supply #005","1.260","1.065","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Death Care Supply #005","Death Care Supply #001","2.657","2.772","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":890},{"label":"Fev","value":704},{"label":"Mar","value":714},{"label":"Abr","value":746},{"label":"Mai","value":643},{"label":"Jun","value":886},{"label":"Jul","value":596},{"label":"Ago","value":892},{"label":"Set","value":565},{"label":"Out","value":844},{"label":"Nov","value":819},{"label":"Dez","value":925}];
const MX = 925;
