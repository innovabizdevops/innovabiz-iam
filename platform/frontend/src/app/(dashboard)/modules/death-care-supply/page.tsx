...
/* ═══ Death Care Supply — Dashboard ═══ */

const ACCENT = "#334155";

const KPIS = [
    { label: "Total Registos", value: "1385", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2600", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€423K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2096019385", cells: ["DEA-1385", "Death Care Supply Item 1", "6/2/2026", "€19 485"], status: "active" as const },
    { id: "2096022956", cells: ["DEA-4956", "Death Care Supply Item 2", "21/9/2026", "€23 056"], status: "pending" as const },
    { id: "2096026527", cells: ["DEA-8527", "Death Care Supply Item 3", "8/4/2026", "€26 627"], status: "completed" as const },
    { id: "2096030098", cells: ["DEA-3098", "Death Care Supply Item 4", "23/11/2026", "€30 198"], status: "warning" as const },
    { id: "2096033669", cells: ["DEA-6669", "Death Care Supply Item 5", "10/6/2026", "€33 769"], status: "active" as const },
];
...
export default function DeathCareSupplyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Death Care Supply</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Death Care Supply</p>
                    </div>
                </div>
