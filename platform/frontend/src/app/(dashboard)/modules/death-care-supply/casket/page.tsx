...
const ACCENT = "#334155";
const MODULE = "Death Care Supply";
const PAGE = "Casket";
const KPIS = [{"l":"Total Death Care Supply","v":"7.680","t":"+11.4%","d":"up"},{"l":"Casket Ativos","v":"4.742","t":"+2.9%","d":"up"},{"l":"Eficiência (%)","v":"83.4%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"74","t":"+7.2%","d":"up"}];
const COLS = ["ID","Casket","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Death Care Supply #001","Death Care Supply #002","2.661","7.849","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Death Care Supply #002","Death Care Supply #003","8.182","1.488","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Death Care Supply #003","Death Care Supply #004","8.173","5.196","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Death Care Supply #004","Death Care Supply #005","8.793","329","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Death Care Supply #005","Death Care Supply #001","6.397","4.357","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":819},{"label":"Mar","value":706},{"label":"Abr","value":853},{"label":"Mai","value":806},{"label":"Jun","value":665},{"label":"Jul","value":737},{"label":"Ago","value":638},{"label":"Set","value":865},{"label":"Out","value":566},{"label":"Nov","value":849},{"label":"Dez","value":588}];
const MX = 865;
...
export default function CasketPage() {
    return (
