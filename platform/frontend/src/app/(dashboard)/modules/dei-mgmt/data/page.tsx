...
const ACCENT = "#ec4899";
const MODULE = "DEI Management";
const PAGE = "Diversity Data";
const KPIS = [{"l":"Projetos Sociais","v":"2.772","t":"+7.1%","d":"up"},{"l":"Beneficiários","v":"4.706","t":"+2.3%","d":"up"},{"l":"Investimento CSR (€)","v":"€91014","t":"+5.5%","d":"up"},{"l":"Score Impacto","v":"67","t":"+17.4%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","2.664","€ 28899.48","556","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","5.773","€ 35537.41","522","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","5.374","€ 13396.82","7.385","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","5.659","€ 27650.08","6.795","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","4.562","€ 22598.60","1.917","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":944},{"label":"Fev","value":956},{"label":"Mar","value":806},{"label":"Abr","value":761},{"label":"Mai","value":587},{"label":"Jun","value":761},{"label":"Jul","value":714},{"label":"Ago","value":637},{"label":"Set","value":581},{"label":"Out","value":642},{"label":"Nov","value":746},{"label":"Dez","value":768}];
const MX = 956;
