...
const KPIS = [{"l":"Projetos Sociais","v":"1.309","t":"+2.1%","d":"up"},{"l":"Beneficiários","v":"7.686","t":"+16.4%","d":"up"},{"l":"Investimento CSR (€)","v":"€40918","t":"+10.0%","d":"up"},{"l":"Score Impacto","v":"73","t":"+13.5%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","418","€ 30030.45","4.152","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","986","€ 49644.58","2.071","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","570","€ 9444.90","9.081","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","6.980","€ 43044.04","6.600","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","1.826","€ 42066.94","8.838","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":348},{"label":"Mar","value":372},{"label":"Abr","value":629},{"label":"Mai","value":578},{"label":"Jun","value":328},{"label":"Jul","value":393},{"label":"Ago","value":345},{"label":"Set","value":366},{"label":"Out","value":317},{"label":"Nov","value":642},{"label":"Dez","value":621}];
const MX = 643;
