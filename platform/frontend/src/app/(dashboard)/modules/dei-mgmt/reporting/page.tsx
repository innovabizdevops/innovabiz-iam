...
const KPIS = [{"l":"Projetos Sociais","v":"4.779","t":"+3.7%","d":"up"},{"l":"Beneficiários","v":"1.462","t":"-1.4%","d":"down"},{"l":"Investimento CSR (€)","v":"€50518","t":"+11.1%","d":"up"},{"l":"Score Impacto","v":"74","t":"+14.0%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","1.639","€ 25328.83","6.786","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","4.644","€ 31422.52","1.298","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","1.590","€ 33451.30","2.772","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","4.775","€ 37579.92","460","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","6.846","€ 35733.80","7.318","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":909},{"label":"Mar","value":703},{"label":"Abr","value":868},{"label":"Mai","value":641},{"label":"Jun","value":755},{"label":"Jul","value":606},{"label":"Ago","value":802},{"label":"Set","value":824},{"label":"Out","value":730},{"label":"Nov","value":760},{"label":"Dez","value":750}];
const MX = 909;
