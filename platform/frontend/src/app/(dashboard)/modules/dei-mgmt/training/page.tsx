...
const PAGE = "Training";
const KPIS = [{"l":"Projetos Sociais","v":"3.760","t":"+17.7%","d":"up"},{"l":"Beneficiários","v":"1.070","t":"+6.4%","d":"up"},{"l":"Investimento CSR (€)","v":"€88050","t":"+8.0%","d":"up"},{"l":"Score Impacto","v":"90","t":"-4.2%","d":"down"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","4.240","€ 43674.73","6.429","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","5.606","€ 35323.61","1.772","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","3.711","€ 860.18","7.443","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","3.339","€ 29782.41","5.209","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","8.382","€ 3947.76","7.934","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":298},{"label":"Fev","value":626},{"label":"Mar","value":405},{"label":"Abr","value":534},{"label":"Mai","value":274},{"label":"Jun","value":380},{"label":"Jul","value":560},{"label":"Ago","value":563},{"label":"Set","value":542},{"label":"Out","value":488},{"label":"Nov","value":368},{"label":"Dez","value":366}];
const MX = 626;
