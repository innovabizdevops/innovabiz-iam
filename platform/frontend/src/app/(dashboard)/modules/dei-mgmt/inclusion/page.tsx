...
const PAGE = "Inclusion Index";
const KPIS = [{"l":"Projetos Sociais","v":"691","t":"-4.6%","d":"down"},{"l":"Beneficiários","v":"5.559","t":"+17.8%","d":"up"},{"l":"Investimento CSR (€)","v":"€99069","t":"+6.4%","d":"up"},{"l":"Score Impacto","v":"75","t":"+10.0%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","7.738","€ 18217.44","3.265","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","2.645","€ 6440.94","4.276","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","7.564","€ 24660.64","7.531","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","9.013","€ 46608.13","3.650","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","678","€ 28299.74","7.530","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":377},{"label":"Mar","value":467},{"label":"Abr","value":389},{"label":"Mai","value":294},{"label":"Jun","value":582},{"label":"Jul","value":292},{"label":"Ago","value":350},{"label":"Set","value":401},{"label":"Out","value":329},{"label":"Nov","value":634},{"label":"Dez","value":624}];
const MX = 634;
