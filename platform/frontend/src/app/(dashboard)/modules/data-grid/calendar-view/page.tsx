...
const PAGE = "Calendar View";
const KPIS = [{"l":"Dashboards Ativos","v":"2.973","t":"+14.2%","d":"up"},{"l":"Queries/Dia","v":"2088","t":"+3.6%","d":"up"},{"l":"Dados Processados (GB)","v":"1.366","t":"+6.8%","d":"up"},{"l":"Utilizadores Analytics","v":"7.131","t":"+6.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2414","2026-02-23","6.593","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3015","2026-03-26","4.727","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4986","2026-03-27","6.261","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","5024","2026-01-11","6.103","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","570","2026-01-18","3.364","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":871},{"label":"Fev","value":744},{"label":"Mar","value":728},{"label":"Abr","value":880},{"label":"Mai","value":856},{"label":"Jun","value":783},{"label":"Jul","value":773},{"label":"Ago","value":555},{"label":"Set","value":552},{"label":"Out","value":717},{"label":"Nov","value":563},{"label":"Dez","value":757}];
const MX = 880;
