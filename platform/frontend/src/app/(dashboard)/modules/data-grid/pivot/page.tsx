...
const PAGE = "Pivot Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"6.201","t":"+3.7%","d":"up"},{"l":"Queries/Dia","v":"2244","t":"-3.0%","d":"down"},{"l":"Dados Processados (GB)","v":"3.538","t":"+16.8%","d":"up"},{"l":"Utilizadores Analytics","v":"6.983","t":"+3.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1907","2026-01-10","4.180","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1751","2026-02-27","2.178","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3466","2026-01-25","5.034","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1197","2026-03-19","768","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2087","2026-03-25","3.712","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":356},{"label":"Fev","value":382},{"label":"Mar","value":465},{"label":"Abr","value":340},{"label":"Mai","value":616},{"label":"Jun","value":418},{"label":"Jul","value":422},{"label":"Ago","value":463},{"label":"Set","value":350},{"label":"Out","value":419},{"label":"Nov","value":616},{"label":"Dez","value":372}];
const MX = 616;
