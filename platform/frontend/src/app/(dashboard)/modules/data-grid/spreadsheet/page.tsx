...
const PAGE = "Spreadsheet View";
const KPIS = [{"l":"Dashboards Ativos","v":"5.435","t":"-0.3%","d":"down"},{"l":"Queries/Dia","v":"1259","t":"+16.5%","d":"up"},{"l":"Dados Processados (GB)","v":"1.333","t":"+15.5%","d":"up"},{"l":"Utilizadores Analytics","v":"211","t":"+14.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4008","2026-03-13","8.368","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4068","2026-03-01","7.859","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2020","2026-02-13","3.237","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4028","2026-02-15","7.205","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5090","2026-01-24","511","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":960},{"label":"Mar","value":939},{"label":"Abr","value":1010},{"label":"Mai","value":982},{"label":"Jun","value":687},{"label":"Jul","value":1030},{"label":"Ago","value":792},{"label":"Set","value":930},{"label":"Out","value":1015},{"label":"Nov","value":900},{"label":"Dez","value":990}];
const MX = 1030;
