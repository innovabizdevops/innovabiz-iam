...
const PAGE = "Timeline View";
const KPIS = [{"l":"Dashboards Ativos","v":"4.737","t":"+3.3%","d":"up"},{"l":"Queries/Dia","v":"785","t":"+9.8%","d":"up"},{"l":"Dados Processados (GB)","v":"674","t":"+4.3%","d":"up"},{"l":"Utilizadores Analytics","v":"852","t":"+8.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4704","2026-03-12","6.263","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2629","2026-03-16","8.894","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","149","2026-02-24","6.627","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","292","2026-01-18","5.832","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5076","2026-01-16","4.989","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1025},{"label":"Fev","value":789},{"label":"Mar","value":1046},{"label":"Abr","value":693},{"label":"Mai","value":953},{"label":"Jun","value":706},{"label":"Jul","value":1055},{"label":"Ago","value":866},{"label":"Set","value":726},{"label":"Out","value":820},{"label":"Nov","value":979},{"label":"Dez","value":909}];
const MX = 1055;
