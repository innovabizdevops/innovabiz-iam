...
const PAGE = "Import/Export CSV";
const KPIS = [{"l":"Dashboards Ativos","v":"3.887","t":"-4.7%","d":"down"},{"l":"Queries/Dia","v":"130","t":"-5.1%","d":"down"},{"l":"Dados Processados (GB)","v":"6.086","t":"+15.5%","d":"up"},{"l":"Utilizadores Analytics","v":"8.428","t":"+1.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1237","2026-03-11","2.049","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","929","2026-02-12","6.847","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3813","2026-02-15","5.161","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1706","2026-03-12","2.852","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1021","2026-02-05","6.013","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":742},{"label":"Mar","value":631},{"label":"Abr","value":899},{"label":"Mai","value":976},{"label":"Jun","value":676},{"label":"Jul","value":897},{"label":"Ago","value":701},{"label":"Set","value":892},{"label":"Out","value":658},{"label":"Nov","value":893},{"label":"Dez","value":674}];
const MX = 976;
