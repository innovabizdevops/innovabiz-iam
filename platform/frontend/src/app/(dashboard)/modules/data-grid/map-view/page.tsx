...
const ACCENT = "#059669";
const MODULE = "Data Grid & Tables";
const PAGE = "Map View";
const KPIS = [{"l":"Dashboards Ativos","v":"6.376","t":"+11.6%","d":"up"},{"l":"Queries/Dia","v":"1016","t":"-1.1%","d":"down"},{"l":"Dados Processados (GB)","v":"3.610","t":"-2.0%","d":"down"},{"l":"Utilizadores Analytics","v":"7.171","t":"+15.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2592","2026-02-19","7.759","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1632","2026-01-12","3.424","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2595","2026-03-18","6.356","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4959","2026-02-02","7.875","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","481","2026-01-19","7.579","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":851},{"label":"Mar","value":719},{"label":"Abr","value":827},{"label":"Mai","value":603},{"label":"Jun","value":813},{"label":"Jul","value":524},{"label":"Ago","value":678},{"label":"Set","value":581},{"label":"Out","value":690},{"label":"Nov","value":554},{"label":"Dez","value":716}];
const MX = 851;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#059669'}}>GIS</span></h1>
                </div>
