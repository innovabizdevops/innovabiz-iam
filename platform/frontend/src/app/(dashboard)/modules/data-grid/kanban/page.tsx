...
const PAGE = "Kanban Boards";
const KPIS = [{"l":"Dashboards Ativos","v":"3.513","t":"+16.0%","d":"up"},{"l":"Queries/Dia","v":"4421","t":"+11.2%","d":"up"},{"l":"Dados Processados (GB)","v":"933","t":"-5.6%","d":"down"},{"l":"Utilizadores Analytics","v":"1.157","t":"+6.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3741","2026-01-02","7.760","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2190","2026-03-23","4.796","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","5070","2026-02-17","1.276","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3422","2026-03-10","5.750","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4325","2026-01-21","613","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":695},{"label":"Mar","value":615},{"label":"Abr","value":520},{"label":"Mai","value":739},{"label":"Jun","value":580},{"label":"Jul","value":476},{"label":"Ago","value":566},{"label":"Set","value":616},{"label":"Out","value":416},{"label":"Nov","value":650},{"label":"Dez","value":397}];
const MX = 739;
