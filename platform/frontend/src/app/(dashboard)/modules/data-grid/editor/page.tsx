...
const PAGE = "Advanced Grid Editor";
const KPIS = [{"l":"Dashboards Ativos","v":"1.223","t":"+6.2%","d":"up"},{"l":"Queries/Dia","v":"1140","t":"+5.5%","d":"up"},{"l":"Dados Processados (GB)","v":"236","t":"-0.6%","d":"down"},{"l":"Utilizadores Analytics","v":"7.482","t":"+9.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2617","2026-01-26","2.022","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1870","2026-02-28","4.396","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","568","2026-01-05","2.724","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4966","2026-03-11","2.019","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1215","2026-01-22","6.158","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":539},{"label":"Mar","value":645},{"label":"Abr","value":557},{"label":"Mai","value":626},{"label":"Jun","value":569},{"label":"Jul","value":703},{"label":"Ago","value":701},{"label":"Set","value":581},{"label":"Out","value":727},{"label":"Nov","value":838},{"label":"Dez","value":534}];
const MX = 838;
