...
const PAGE = "Gantt Charts";
const KPIS = [{"l":"Dashboards Ativos","v":"6.379","t":"+13.9%","d":"up"},{"l":"Queries/Dia","v":"844","t":"+10.6%","d":"up"},{"l":"Dados Processados (GB)","v":"5.347","t":"-2.8%","d":"down"},{"l":"Utilizadores Analytics","v":"3.142","t":"+9.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","112","2026-02-07","6.792","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1108","2026-02-27","498","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3954","2026-02-14","5.036","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4786","2026-03-28","3.605","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","435","2026-01-07","2.931","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":742},{"label":"Mar","value":845},{"label":"Abr","value":762},{"label":"Mai","value":790},{"label":"Jun","value":729},{"label":"Jul","value":765},{"label":"Ago","value":719},{"label":"Set","value":567},{"label":"Out","value":899},{"label":"Nov","value":834},{"label":"Dez","value":593}];
const MX = 899;
