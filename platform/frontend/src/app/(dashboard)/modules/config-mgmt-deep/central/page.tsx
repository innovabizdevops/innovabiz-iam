...
const PAGE = "Central";
const KPIS = [{"l":"Ativos Registados","v":"7.795","t":"+6.0%","d":"up"},{"l":"Valor Total (€M)","v":"€18.0M","t":"-3.6%","d":"down"},{"l":"Depreciação Anual (€)","v":"€17855","t":"+4.3%","d":"up"},{"l":"Ativos em Garantia","v":"7.490","t":"+15.4%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 2070.53","2.393","€ 2727.65","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 48686.22","8.036","€ 4656.95","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 37813.59","788","€ 14048.57","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 37422.69","8.753","€ 21084.67","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 28143.60","8.634","€ 28530.11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":615},{"label":"Mar","value":722},{"label":"Abr","value":545},{"label":"Mai","value":364},{"label":"Jun","value":372},{"label":"Jul","value":577},{"label":"Ago","value":464},{"label":"Set","value":745},{"label":"Out","value":394},{"label":"Nov","value":725},{"label":"Dez","value":725}];
const MX = 745;
