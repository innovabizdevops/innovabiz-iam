...
const PAGE = "Feature";
const KPIS = [{"l":"Ativos Registados","v":"4.210","t":"+11.6%","d":"up"},{"l":"Valor Total (€M)","v":"€24.1M","t":"+5.9%","d":"up"},{"l":"Depreciação Anual (€)","v":"€72063","t":"+4.0%","d":"up"},{"l":"Ativos em Garantia","v":"4.784","t":"+9.3%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 18101.79","1.840","€ 39364.09","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 46266.32","457","€ 38472.88","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 12277.13","8.691","€ 4924.05","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 1740.52","8.114","€ 13182.05","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 18751.71","7.951","€ 8780.63","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":498},{"label":"Mar","value":563},{"label":"Abr","value":639},{"label":"Mai","value":575},{"label":"Jun","value":300},{"label":"Jul","value":338},{"label":"Ago","value":432},{"label":"Set","value":384},{"label":"Out","value":597},{"label":"Nov","value":384},{"label":"Dez","value":457}];
const MX = 639;
