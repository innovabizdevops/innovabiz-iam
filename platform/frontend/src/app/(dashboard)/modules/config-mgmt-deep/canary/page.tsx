...
const PAGE = "Canary";
const KPIS = [{"l":"Ativos Registados","v":"7.175","t":"+6.0%","d":"up"},{"l":"Valor Total (€M)","v":"€34.2M","t":"-5.4%","d":"down"},{"l":"Depreciação Anual (€)","v":"€30437","t":"+12.4%","d":"up"},{"l":"Ativos em Garantia","v":"8.236","t":"+3.1%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 7809.88","7.530","€ 29693.85","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 12438.95","5.064","€ 28328.05","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 31584.16","6.832","€ 12479.28","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 13117.99","4.807","€ 19987.81","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 40327.03","8.585","€ 13102.57","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":406},{"label":"Mar","value":681},{"label":"Abr","value":709},{"label":"Mai","value":578},{"label":"Jun","value":417},{"label":"Jul","value":694},{"label":"Ago","value":532},{"label":"Set","value":623},{"label":"Out","value":431},{"label":"Nov","value":652},{"label":"Dez","value":471}];
const MX = 709;
