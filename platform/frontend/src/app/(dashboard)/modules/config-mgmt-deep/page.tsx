...
/* ═══ Config Management Deep — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "260", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4983", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€449K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2082732460", cells: ["CON-7460", "Config Management Deep Item 1", "5/5/2026", "€32 560"], status: "active" as const },
    { id: "2082736031", cells: ["CON-2031", "Config Management Deep Item 2", "20/12/2026", "€36 131"], status: "pending" as const },
    { id: "2082739602", cells: ["CON-5602", "Config Management Deep Item 3", "7/7/2026", "€39 702"], status: "completed" as const },
    { id: "2082743173", cells: ["CON-9173", "Config Management Deep Item 4", "22/2/2026", "€43 273"], status: "warning" as const },
    { id: "2082746744", cells: ["CON-3744", "Config Management Deep Item 5", "9/9/2026", "€46 844"], status: "active" as const },
];
...
export default function ConfigManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Config Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Config Management Deep</p>
                    </div>
                </div>
