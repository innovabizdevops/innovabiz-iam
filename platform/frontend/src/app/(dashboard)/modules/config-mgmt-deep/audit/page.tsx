...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.255","t":"+14.7%","d":"up"},{"l":"NC Abertas","v":"6.937","t":"+5.4%","d":"up"},{"l":"Conformidade (%)","v":"66.1%","t":"+0.5%","d":"up"},{"l":"CAPAs Pendentes","v":"5.207","t":"-2.1%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","865","87.8%","7.239","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.181","96.6%","6.014","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","324","99.5%","3.942","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.410","88.0%","8.141","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.672","98.9%","3.585","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":526},{"label":"Mar","value":489},{"label":"Abr","value":508},{"label":"Mai","value":538},{"label":"Jun","value":649},{"label":"Jul","value":624},{"label":"Ago","value":495},{"label":"Set","value":520},{"label":"Out","value":627},{"label":"Nov","value":790},{"label":"Dez","value":737}];
const MX = 790;
