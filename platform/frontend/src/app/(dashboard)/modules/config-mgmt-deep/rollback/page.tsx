...
const ACCENT = "#1e40af";
const MODULE = "Config Management Deep";
const PAGE = "Rollback";
const KPIS = [{"l":"Ativos Registados","v":"3.827","t":"-2.3%","d":"down"},{"l":"Valor Total (€M)","v":"€25.5M","t":"+0.2%","d":"up"},{"l":"Depreciação Anual (€)","v":"€14905","t":"+16.5%","d":"up"},{"l":"Ativos em Garantia","v":"6.493","t":"-5.0%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 46288.55","2.668","€ 43801.81","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 10135.31","5.724","€ 26760.68","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 44778.60","8.335","€ 13931.62","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 43879.51","5.922","€ 12502.20","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 26310.79","4.316","€ 26014.18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":767},{"label":"Mar","value":478},{"label":"Abr","value":532},{"label":"Mai","value":804},{"label":"Jun","value":562},{"label":"Jul","value":766},{"label":"Ago","value":648},{"label":"Set","value":771},{"label":"Out","value":615},{"label":"Nov","value":695},{"label":"Dez","value":521}];
const MX = 804;
