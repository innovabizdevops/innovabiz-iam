...
const ACCENT = "#16a34a";
const MODULE = "GreenTech & Sustainability";
const PAGE = "ESG Rating Engine";
const KPIS = [{"l":"Surveys Ativos","v":"8.388","t":"+9.5%","d":"up"},{"l":"Respostas/Semana","v":"2784","t":"+6.8%","d":"up"},{"l":"NPS Médio","v":"85","t":"-3.7%","d":"down"},{"l":"Taxa Resposta (%)","v":"76.3%","t":"-5.4%","d":"down"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","3.973","88","97.6%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","3.313","66","98.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","6.046","94","83.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","6.530","76","90.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","5.783","60","71.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":578},{"label":"Mar","value":401},{"label":"Abr","value":643},{"label":"Mai","value":774},{"label":"Jun","value":498},{"label":"Jul","value":423},{"label":"Ago","value":651},{"label":"Set","value":568},{"label":"Out","value":745},{"label":"Nov","value":517},{"label":"Dez","value":484}];
const MX = 774;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#16a34a'}}>Rating</span></h1>
                </div>
