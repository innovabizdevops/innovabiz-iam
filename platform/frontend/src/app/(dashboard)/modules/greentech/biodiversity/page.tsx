...
const PAGE = "Biodiversity Impact";
const KPIS = [{"l":"Projetos Sociais","v":"7.272","t":"+4.5%","d":"up"},{"l":"Beneficiários","v":"3.377","t":"+13.8%","d":"up"},{"l":"Investimento CSR (€)","v":"€51317","t":"+9.5%","d":"up"},{"l":"Score Impacto","v":"62","t":"+6.0%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","6.521","€ 7790.41","4.104","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","2.771","€ 4303.94","5.812","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","4.350","€ 48557.56","8.810","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","5.260","€ 10323.61","7.957","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","3.240","€ 36531.05","7.109","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":676},{"label":"Mar","value":697},{"label":"Abr","value":621},{"label":"Mai","value":575},{"label":"Jun","value":703},{"label":"Jul","value":733},{"label":"Ago","value":542},{"label":"Set","value":636},{"label":"Out","value":455},{"label":"Nov","value":540},{"label":"Dez","value":664}];
const MX = 733;
