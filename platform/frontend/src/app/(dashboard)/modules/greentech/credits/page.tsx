...
const KPIS = [{"l":"Integrações Ativas","v":"4.279","t":"+4.9%","d":"up"},{"l":"Chamadas/Hora","v":"3787","t":"+12.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"80.5%","t":"+8.2%","d":"up"},{"l":"Latência Média (ms)","v":"156ms","t":"+7.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.844","8.205","94.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.553","4.770","75.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.215","4.913","95.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.773","7.341","84.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.267","5.063","85.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":811},{"label":"Mar","value":658},{"label":"Abr","value":759},{"label":"Mai","value":902},{"label":"Jun","value":881},{"label":"Jul","value":807},{"label":"Ago","value":553},{"label":"Set","value":580},{"label":"Out","value":877},{"label":"Nov","value":589},{"label":"Dez","value":597}];
const MX = 902;
