...
const KPIS = [{"l":"Total Greentech","v":"7.735","t":"+12.4%","d":"up"},{"l":"Supply Chain ESG Ativos","v":"4.338","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"81.8%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"81","t":"+17.7%","d":"up"}];
const COLS = ["ID","Supply Chain ESG","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Greentech #001","Greentech #002","8.964","4.052","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Greentech #002","Greentech #003","6.029","1.216","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Greentech #003","Greentech #004","1.861","2.745","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Greentech #004","Greentech #005","3.389","566","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Greentech #005","Greentech #001","7.851","4.408","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":636},{"label":"Mar","value":854},{"label":"Abr","value":786},{"label":"Mai","value":677},{"label":"Jun","value":585},{"label":"Jul","value":597},{"label":"Ago","value":747},{"label":"Set","value":822},{"label":"Out","value":762},{"label":"Nov","value":831},{"label":"Dez","value":615}];
const MX = 854;
...
export default function SupplyEsgPage() {
    return (
