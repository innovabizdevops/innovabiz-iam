...
const PAGE = "Policy Learn";
const KPIS = [{"l":"Total Reg Sandbox","v":"5.091","t":"+6.6%","d":"up"},{"l":"Policy Learn Ativos","v":"7.156","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"73.5%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"65","t":"+17.0%","d":"up"}];
const COLS = ["ID","Policy Learn","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reg Sandbox #001","Reg Sandbox #002","4.927","507","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Reg Sandbox #002","Reg Sandbox #003","4.805","2.473","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Reg Sandbox #003","Reg Sandbox #004","4.896","8.299","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Reg Sandbox #004","Reg Sandbox #005","7.511","7.382","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reg Sandbox #005","Reg Sandbox #001","7.107","1.003","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":228},{"label":"Mar","value":441},{"label":"Abr","value":354},{"label":"Mai","value":484},{"label":"Jun","value":310},{"label":"Jul","value":463},{"label":"Ago","value":407},{"label":"Set","value":364},{"label":"Out","value":579},{"label":"Nov","value":335},{"label":"Dez","value":412}];
const MX = 579;
