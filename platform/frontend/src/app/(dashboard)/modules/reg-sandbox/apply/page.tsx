...
const ACCENT = "#b45309";
const MODULE = "Regulatory Sandbox";
const PAGE = "Sandbox Apply";
const KPIS = [{"l":"Total Reg Sandbox","v":"7.336","t":"-5.7%","d":"down"},{"l":"Sandbox Apply Ativos","v":"2.996","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"65.6%","t":"+0.1%","d":"up"},{"l":"Score Performance","v":"71","t":"+1.1%","d":"up"}];
const COLS = ["ID","Sandbox Apply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reg Sandbox #001","Reg Sandbox #002","3.205","375","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Reg Sandbox #002","Reg Sandbox #003","4.560","4.569","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Reg Sandbox #003","Reg Sandbox #004","2.552","5.335","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Reg Sandbox #004","Reg Sandbox #005","4.894","787","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reg Sandbox #005","Reg Sandbox #001","6.999","6.654","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":992},{"label":"Fev","value":866},{"label":"Mar","value":795},{"label":"Abr","value":962},{"label":"Mai","value":945},{"label":"Jun","value":686},{"label":"Jul","value":728},{"label":"Ago","value":739},{"label":"Set","value":849},{"label":"Out","value":753},{"label":"Nov","value":1013},{"label":"Dez","value":859}];
const MX = 1013;
