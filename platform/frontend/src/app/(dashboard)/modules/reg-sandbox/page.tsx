...
export default function RegSandboxPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Reg Sandbox</h1><p className="text-sm text-muted-foreground">Reg Sandbox • iBOS Enterprise</p></div>
