...
/* ═══ Agri Finance Deep — Dashboard ═══ */

const ACCENT = "#22c55e";

const KPIS = [
    { label: "Total Registos", value: "9957", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "176", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€164K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1354923857", cells: ["AGR-1857", "Agri Finance Deep Item 1", "22/6/2026", "€23 957"], status: "active" as const },
    { id: "1354927428", cells: ["AGR-5428", "Agri Finance Deep Item 2", "9/1/2026", "€27 528"], status: "pending" as const },
    { id: "1354930999", cells: ["AGR-8999", "Agri Finance Deep Item 3", "24/8/2026", "€31 099"], status: "completed" as const },
    { id: "1354934570", cells: ["AGR-3570", "Agri Finance Deep Item 4", "11/3/2026", "€34 670"], status: "warning" as const },
    { id: "1354938141", cells: ["AGR-7141", "Agri Finance Deep Item 5", "26/10/2026", "€38 241"], status: "active" as const },
];
...
export default function AgriFinanceDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Agri Finance Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Agri Finance Deep</p>
                    </div>
                </div>
