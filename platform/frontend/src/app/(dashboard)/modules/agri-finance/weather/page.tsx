...
const ACCENT = "#22c55e";
const MODULE = "Agri Finance Deep";
const PAGE = "Weather Risk";
const KPIS = [{"l":"Riscos Identificados","v":"1.637","t":"-4.1%","d":"down"},{"l":"Mitigações Ativas","v":"6.638","t":"+2.5%","d":"up"},{"l":"Score Risco Geral","v":"72","t":"+13.2%","d":"up"},{"l":"Incidentes YTD","v":"4.740","t":"-5.0%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.385","2.282","6.474","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.411","7.490","2.421","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.781","7.538","3.292","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","589","1.372","3.892","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","989","1.348","3.283","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":957},{"label":"Mar","value":979},{"label":"Abr","value":636},{"label":"Mai","value":877},{"label":"Jun","value":1021},{"label":"Jul","value":714},{"label":"Ago","value":688},{"label":"Set","value":930},{"label":"Out","value":787},{"label":"Nov","value":730},{"label":"Dez","value":632}];
const MX = 1021;
