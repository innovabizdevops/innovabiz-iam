...
const ACCENT = "#7c3aed";
const MODULE = "Invoicing & Billing";
const PAGE = "e-Invoice SAF-T";
const KPIS = [{"l":"Total Invoicing","v":"6.516","t":"+10.5%","d":"up"},{"l":"E Invoice SAF T Ativos","v":"8.228","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"68","t":"+13.1%","d":"up"}];
const COLS = ["ID","E Invoice SAF T","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Invoicing #001","Invoicing #002","1.724","8.611","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Invoicing #002","Invoicing #003","8.522","6.651","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Invoicing #003","Invoicing #004","7.163","6.467","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Invoicing #004","Invoicing #005","4.036","7.940","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Invoicing #005","Invoicing #001","8.909","5.063","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":983},{"label":"Mar","value":620},{"label":"Abr","value":717},{"label":"Mai","value":620},{"label":"Jun","value":635},{"label":"Jul","value":953},{"label":"Ago","value":707},{"label":"Set","value":849},{"label":"Out","value":770},{"label":"Nov","value":976},{"label":"Dez","value":836}];
const MX = 983;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>SAF-T</span></h1>
                </div>
