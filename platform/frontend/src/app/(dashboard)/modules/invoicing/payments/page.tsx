...
const PAGE = "Payment Tracking";
const KPIS = [{"l":"Total Invoicing","v":"1.392","t":"+4.1%","d":"up"},{"l":"Payment Tracking Ativos","v":"3.048","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"87.4%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"56","t":"+14.8%","d":"up"}];
const COLS = ["ID","Payment Tracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Invoicing #001","Invoicing #002","932","2.198","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Invoicing #002","Invoicing #003","2.678","4.548","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Invoicing #003","Invoicing #004","1.993","1.586","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Invoicing #004","Invoicing #005","1.279","2.054","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Invoicing #005","Invoicing #001","1.474","6.480","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":355},{"label":"Fev","value":266},{"label":"Mar","value":570},{"label":"Abr","value":259},{"label":"Mai","value":273},{"label":"Jun","value":325},{"label":"Jul","value":454},{"label":"Ago","value":502},{"label":"Set","value":472},{"label":"Out","value":639},{"label":"Nov","value":588},{"label":"Dez","value":326}];
const MX = 639;
