...
const PAGE = "Late Fee Rules";
const KPIS = [{"l":"Total Invoicing","v":"1.535","t":"-2.3%","d":"down"},{"l":"Late Fee Rules Ativos","v":"1.012","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"73.0%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"82","t":"+9.7%","d":"up"}];
const COLS = ["ID","Late Fee Rules","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Invoicing #001","Invoicing #002","7.381","3.332","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Invoicing #002","Invoicing #003","8.172","5.730","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Invoicing #003","Invoicing #004","4.244","5.863","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Invoicing #004","Invoicing #005","6.699","7.572","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Invoicing #005","Invoicing #001","7.670","7.919","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":696},{"label":"Mar","value":712},{"label":"Abr","value":559},{"label":"Mai","value":403},{"label":"Jun","value":490},{"label":"Jul","value":500},{"label":"Ago","value":666},{"label":"Set","value":411},{"label":"Out","value":584},{"label":"Nov","value":502},{"label":"Dez","value":428}];
const MX = 712;
