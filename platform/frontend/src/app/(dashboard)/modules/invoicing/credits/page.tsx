...
const KPIS = [{"l":"Integrações Ativas","v":"4.454","t":"+5.4%","d":"up"},{"l":"Chamadas/Hora","v":"617","t":"+1.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"80.0%","t":"+2.4%","d":"up"},{"l":"Latência Média (ms)","v":"86ms","t":"+6.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.349","3.704","85.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.626","5.299","84.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.900","1.923","98.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.812","4.676","90.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.104","8.134","83.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":291},{"label":"Fev","value":526},{"label":"Mar","value":372},{"label":"Abr","value":388},{"label":"Mai","value":545},{"label":"Jun","value":331},{"label":"Jul","value":429},{"label":"Ago","value":371},{"label":"Set","value":488},{"label":"Out","value":303},{"label":"Nov","value":482},{"label":"Dez","value":287}];
const MX = 545;
