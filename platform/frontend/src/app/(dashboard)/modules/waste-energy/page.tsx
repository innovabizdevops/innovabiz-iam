...
const KPIS = [
    ...
    { label: "Ativos", value: "1298", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€247K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "661246014", cells: ["WAS-8014", "Waste-to-Energy Item 1", "3/7/2026", "€46 114"], status: "active" as const },
    { id: "661249585", cells: ["WAS-2585", "Waste-to-Energy Item 2", "18/2/2026", "€49 685"], status: "pending" as const },
    { id: "661253156", cells: ["WAS-6156", "Waste-to-Energy Item 3", "5/9/2026", "€3256"], status: "completed" as const },
    { id: "661256727", cells: ["WAS-9727", "Waste-to-Energy Item 4", "20/4/2026", "€6827"], status: "warning" as const },
    { id: "661260298", cells: ["WAS-4298", "Waste-to-Energy Item 5", "7/11/2026", "€10 398"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Waste-to-Energy</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Waste-to-Energy</p>
                    </div>
                </div>
