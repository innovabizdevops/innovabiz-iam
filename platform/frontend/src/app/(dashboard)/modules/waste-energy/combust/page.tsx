...
const PAGE = "Combust";
const KPIS = [{"l":"Total Waste Energy","v":"1.421","t":"+16.5%","d":"up"},{"l":"Combust Ativos","v":"5.102","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"83.4%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"66","t":"+8.1%","d":"up"}];
const COLS = ["ID","Combust","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Energy #001","Waste Energy #002","1.916","8.355","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Energy #002","Waste Energy #003","7.506","891","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Energy #003","Waste Energy #004","908","8.402","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Energy #004","Waste Energy #005","3.772","2.843","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Energy #005","Waste Energy #001","1.792","2.078","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":662},{"label":"Mar","value":655},{"label":"Abr","value":631},{"label":"Mai","value":563},{"label":"Jun","value":662},{"label":"Jul","value":566},{"label":"Ago","value":611},{"label":"Set","value":513},{"label":"Out","value":683},{"label":"Nov","value":314},{"label":"Dez","value":593}];
const MX = 683;
...
export default function CombustPage() {
    return (
