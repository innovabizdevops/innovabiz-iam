...
const PAGE = "Generate";
const KPIS = [{"l":"Total Waste Energy","v":"5.943","t":"+7.7%","d":"up"},{"l":"Generate Ativos","v":"655","t":"+10.0%","d":"up"},{"l":"Eficiência (%)","v":"80.6%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"93","t":"+5.2%","d":"up"}];
const COLS = ["ID","Generate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Energy #001","Waste Energy #002","7.397","4.611","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Energy #002","Waste Energy #003","4.217","2.916","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Energy #003","Waste Energy #004","1.320","4.948","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Energy #004","Waste Energy #005","6.053","3.670","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Energy #005","Waste Energy #001","1.632","6.638","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":433},{"label":"Mar","value":405},{"label":"Abr","value":530},{"label":"Mai","value":565},{"label":"Jun","value":540},{"label":"Jul","value":406},{"label":"Ago","value":400},{"label":"Set","value":590},{"label":"Out","value":451},{"label":"Nov","value":703},{"label":"Dez","value":448}];
const MX = 703;
