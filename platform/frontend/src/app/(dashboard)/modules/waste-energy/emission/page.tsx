...
const PAGE = "Emission";
const KPIS = [{"l":"Total Waste Energy","v":"6.391","t":"+17.7%","d":"up"},{"l":"Emission Ativos","v":"8.817","t":"+14.8%","d":"up"},{"l":"Eficiência (%)","v":"71.0%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"62","t":"+17.7%","d":"up"}];
const COLS = ["ID","Emission","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Energy #001","Waste Energy #002","8.130","146","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Energy #002","Waste Energy #003","5.939","5.990","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Energy #003","Waste Energy #004","5.398","6.124","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Energy #004","Waste Energy #005","6.787","7.313","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Energy #005","Waste Energy #001","6.360","4.079","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":919},{"label":"Mar","value":695},{"label":"Abr","value":810},{"label":"Mai","value":843},{"label":"Jun","value":790},{"label":"Jul","value":670},{"label":"Ago","value":718},{"label":"Set","value":985},{"label":"Out","value":744},{"label":"Nov","value":847},{"label":"Dez","value":777}];
const MX = 985;
