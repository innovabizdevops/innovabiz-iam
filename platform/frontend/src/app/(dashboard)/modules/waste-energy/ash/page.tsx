...
const PAGE = "Ash";
const KPIS = [{"l":"Total Waste Energy","v":"2.795","t":"+10.7%","d":"up"},{"l":"Ash Ativos","v":"4.904","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"77.9%","t":"+10.3%","d":"up"},{"l":"Score Performance","v":"84","t":"+12.7%","d":"up"}];
const COLS = ["ID","Ash","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Energy #001","Waste Energy #002","7.690","7.253","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Energy #002","Waste Energy #003","3.192","2.252","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Energy #003","Waste Energy #004","772","2.238","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Energy #004","Waste Energy #005","4.539","8.731","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Energy #005","Waste Energy #001","1.507","6.419","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":573},{"label":"Mar","value":786},{"label":"Abr","value":807},{"label":"Mai","value":856},{"label":"Jun","value":630},{"label":"Jul","value":705},{"label":"Ago","value":841},{"label":"Set","value":837},{"label":"Out","value":852},{"label":"Nov","value":905},{"label":"Dez","value":787}];
const MX = 905;
