...
const PAGE = "Gate In/Out";
const KPIS = [{"l":"Ideias Submetidas","v":"154","t":"+1.5%","d":"up"},{"l":"Patentes (YTD)","v":"2.786","t":"-5.6%","d":"down"},{"l":"Projetos Innovation Lab","v":"7.423","t":"+6.9%","d":"up"},{"l":"Budget I&D (€M)","v":"€25.9M","t":"-2.1%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","8.053","76.2%","321","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.277","99.5%","212","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","503","71.1%","7.009","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","3.122","83.1%","2.566","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.600","94.1%","6.355","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":581},{"label":"Fev","value":851},{"label":"Mar","value":947},{"label":"Abr","value":662},{"label":"Mai","value":872},{"label":"Jun","value":710},{"label":"Jul","value":659},{"label":"Ago","value":931},{"label":"Set","value":623},{"label":"Out","value":684},{"label":"Nov","value":649},{"label":"Dez","value":767}];
const MX = 947;
