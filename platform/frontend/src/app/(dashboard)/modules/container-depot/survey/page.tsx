...
const ACCENT = "#0e7490";
const MODULE = "Container Depot";
const PAGE = "Survey Inspect";
const KPIS = [{"l":"Ideias Submetidas","v":"3.342","t":"+13.5%","d":"up"},{"l":"Patentes (YTD)","v":"3.437","t":"+17.4%","d":"up"},{"l":"Projetos Innovation Lab","v":"324","t":"+15.5%","d":"up"},{"l":"Budget I&D (€M)","v":"€6.6M","t":"-1.5%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.522","89.1%","1.605","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","7.417","75.7%","5.126","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.083","91.1%","6.855","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","3.591","87.9%","1.738","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.968","73.0%","9.076","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":980},{"label":"Mar","value":708},{"label":"Abr","value":659},{"label":"Mai","value":998},{"label":"Jun","value":1042},{"label":"Jul","value":859},{"label":"Ago","value":769},{"label":"Set","value":810},{"label":"Out","value":713},{"label":"Nov","value":1009},{"label":"Dez","value":995}];
const MX = 1042;
