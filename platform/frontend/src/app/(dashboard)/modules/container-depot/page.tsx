...
export default function ContainerDepotPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Container Depot</h1><p className="text-sm text-muted-foreground">Container Depot • iBOS Enterprise</p></div>
