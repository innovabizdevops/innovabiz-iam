...
const PAGE = "M&amp;R Estimate";
const KPIS = [{"l":"Ideias Submetidas","v":"5.440","t":"+5.0%","d":"up"},{"l":"Patentes (YTD)","v":"3.776","t":"+1.7%","d":"up"},{"l":"Projetos Innovation Lab","v":"1.520","t":"+13.6%","d":"up"},{"l":"Budget I&D (€M)","v":"€22.7M","t":"-3.7%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.696","96.4%","6.986","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","5.186","96.0%","8.376","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","3.489","82.7%","5.816","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","8.487","74.4%","5.154","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","5.961","81.4%","133","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":865},{"label":"Fev","value":756},{"label":"Mar","value":849},{"label":"Abr","value":710},{"label":"Mai","value":1024},{"label":"Jun","value":870},{"label":"Jul","value":970},{"label":"Ago","value":690},{"label":"Set","value":953},{"label":"Out","value":935},{"label":"Nov","value":800},{"label":"Dez","value":966}];
const MX = 1024;
