...
const PAGE = "Repair Shop";
const KPIS = [{"l":"Ideias Submetidas","v":"4.025","t":"+13.0%","d":"up"},{"l":"Patentes (YTD)","v":"5.858","t":"+1.7%","d":"up"},{"l":"Projetos Innovation Lab","v":"4.532","t":"+10.6%","d":"up"},{"l":"Budget I&D (€M)","v":"€4.1M","t":"-3.0%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","562","86.9%","4.032","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.486","88.0%","1.387","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","8.847","81.1%","3.130","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","6.425","80.8%","6.470","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","9.036","88.2%","6.619","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":1002},{"label":"Mar","value":758},{"label":"Abr","value":826},{"label":"Mai","value":1017},{"label":"Jun","value":888},{"label":"Jul","value":717},{"label":"Ago","value":672},{"label":"Set","value":865},{"label":"Out","value":1064},{"label":"Nov","value":783},{"label":"Dez","value":737}];
const MX = 1064;
