...
const ACCENT = "#00a1e0";
const MODULE = "Einstein Analytics Deep";
const PAGE = "Story";
const KPIS = [{"l":"Dashboards Ativos","v":"2.647","t":"+10.8%","d":"up"},{"l":"Queries/Dia","v":"2499","t":"+4.7%","d":"up"},{"l":"Dados Processados (GB)","v":"7.049","t":"-2.4%","d":"down"},{"l":"Utilizadores Analytics","v":"3.925","t":"+10.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1610","2026-03-04","8.772","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3777","2026-02-11","8.097","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2442","2026-02-03","3.653","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1543","2026-01-19","6.790","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","965","2026-01-18","6.269","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":966},{"label":"Fev","value":622},{"label":"Mar","value":813},{"label":"Abr","value":971},{"label":"Mai","value":968},{"label":"Jun","value":643},{"label":"Jul","value":995},{"label":"Ago","value":672},{"label":"Set","value":771},{"label":"Out","value":748},{"label":"Nov","value":606},{"label":"Dez","value":716}];
const MX = 995;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#00a1e0'}}>AI</span></h1>
                </div>
