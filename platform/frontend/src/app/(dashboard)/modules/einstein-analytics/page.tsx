...
/* ═══ Einstein Analytics Deep — Dashboard ═══ */

const ACCENT = "#00a1e0";

const KPIS = [
    { label: "Total Registos", value: "2595", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1332", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€218K", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1065638495", cells: ["EIN-3495", "Einstein Analytics Deep Item 1", "20/12/2026", "€38 595"], status: "active" as const },
    { id: "1065642066", cells: ["EIN-7066", "Einstein Analytics Deep Item 2", "7/7/2026", "€42 166"], status: "pending" as const },
    { id: "1065645637", cells: ["EIN-1637", "Einstein Analytics Deep Item 3", "22/2/2026", "€45 737"], status: "completed" as const },
    { id: "1065649208", cells: ["EIN-5208", "Einstein Analytics Deep Item 4", "9/9/2026", "€49 308"], status: "warning" as const },
    { id: "1065652779", cells: ["EIN-8779", "Einstein Analytics Deep Item 5", "24/4/2026", "€2879"], status: "active" as const },
];
...
export default function EinsteinAnalyticsDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Einstein Analytics Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Einstein Analytics Deep</p>
                    </div>
                </div>
