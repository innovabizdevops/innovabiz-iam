...
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"1.513","t":"+4.0%","d":"up"},{"l":"Queries/Dia","v":"2576","t":"+10.7%","d":"up"},{"l":"Dados Processados (GB)","v":"8.851","t":"+6.0%","d":"up"},{"l":"Utilizadores Analytics","v":"8.394","t":"+9.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1352","2026-03-26","5.954","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3642","2026-01-25","3.675","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","227","2026-01-19","779","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2376","2026-01-02","6.605","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4328","2026-02-02","5.178","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":868},{"label":"Mar","value":894},{"label":"Abr","value":704},{"label":"Mai","value":761},{"label":"Jun","value":1003},{"label":"Jul","value":697},{"label":"Ago","value":1025},{"label":"Set","value":856},{"label":"Out","value":909},{"label":"Nov","value":792},{"label":"Dez","value":748}];
const MX = 1025;
