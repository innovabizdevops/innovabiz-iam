...
const PAGE = "Lens";
const KPIS = [{"l":"Dashboards Ativos","v":"3.913","t":"-0.6%","d":"down"},{"l":"Queries/Dia","v":"986","t":"+6.8%","d":"up"},{"l":"Dados Processados (GB)","v":"7.544","t":"+13.5%","d":"up"},{"l":"Utilizadores Analytics","v":"710","t":"+5.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3585","2026-03-25","4.251","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2849","2026-01-01","2.220","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1627","2026-02-18","931","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3962","2026-02-16","2.933","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5046","2026-03-12","2.402","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":743},{"label":"Mar","value":658},{"label":"Abr","value":554},{"label":"Mai","value":541},{"label":"Jun","value":470},{"label":"Jul","value":587},{"label":"Ago","value":594},{"label":"Set","value":620},{"label":"Out","value":557},{"label":"Nov","value":447},{"label":"Dez","value":452}];
const MX = 743;
