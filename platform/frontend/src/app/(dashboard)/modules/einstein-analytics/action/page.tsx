...
const PAGE = "Action";
const KPIS = [{"l":"Dashboards Ativos","v":"7.143","t":"+13.7%","d":"up"},{"l":"Queries/Dia","v":"4819","t":"+9.3%","d":"up"},{"l":"Dados Processados (GB)","v":"2.061","t":"+18.0%","d":"up"},{"l":"Utilizadores Analytics","v":"3.216","t":"+2.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","294","2026-01-03","1.082","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1361","2026-02-26","665","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3212","2026-02-14","7.346","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2706","2026-02-28","1.098","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","994","2026-02-17","4.205","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":613},{"label":"Mar","value":674},{"label":"Abr","value":762},{"label":"Mai","value":474},{"label":"Jun","value":732},{"label":"Jul","value":609},{"label":"Ago","value":469},{"label":"Set","value":655},{"label":"Out","value":583},{"label":"Nov","value":651},{"label":"Dez","value":738}];
const MX = 762;
