...
const PAGE = "Dataset";
const KPIS = [{"l":"Dashboards Ativos","v":"7.155","t":"-3.8%","d":"down"},{"l":"Queries/Dia","v":"4539","t":"+11.1%","d":"up"},{"l":"Dados Processados (GB)","v":"1.590","t":"+3.5%","d":"up"},{"l":"Utilizadores Analytics","v":"8.534","t":"+9.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2718","2026-01-05","472","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1093","2026-03-06","3.558","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4934","2026-03-23","4.639","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","249","2026-03-09","1.398","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4592","2026-02-26","8.864","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":697},{"label":"Mar","value":914},{"label":"Abr","value":764},{"label":"Mai","value":713},{"label":"Jun","value":878},{"label":"Jul","value":814},{"label":"Ago","value":657},{"label":"Set","value":790},{"label":"Out","value":951},{"label":"Nov","value":738},{"label":"Dez","value":861}];
const MX = 951;
