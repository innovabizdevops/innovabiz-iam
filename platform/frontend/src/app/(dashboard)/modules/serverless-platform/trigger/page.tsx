...
const PAGE = "Trigger";
const KPIS = [{"l":"Formulários Ativos","v":"739","t":"+16.8%","d":"up"},{"l":"Submissões/Dia","v":"1059","t":"+0.3%","d":"up"},{"l":"Documentos Gerados","v":"7.298","t":"+12.7%","d":"up"},{"l":"Templates","v":"1.150","t":"-0.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.979","2026-03-04","7.528","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.292","2026-02-01","416","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.842","2026-01-05","1.325","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.123","2026-01-06","628","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.669","2026-01-06","9.035","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1001},{"label":"Fev","value":1053},{"label":"Mar","value":860},{"label":"Abr","value":1017},{"label":"Mai","value":972},{"label":"Jun","value":879},{"label":"Jul","value":883},{"label":"Ago","value":814},{"label":"Set","value":758},{"label":"Out","value":965},{"label":"Nov","value":790},{"label":"Dez","value":732}];
const MX = 1053;
