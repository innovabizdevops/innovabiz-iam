...
const ACCENT = "#0d9488";
const MODULE = "Serverless Platform";
const PAGE = "Monitor";
const KPIS = [{"l":"Formulários Ativos","v":"8.790","t":"+15.0%","d":"up"},{"l":"Submissões/Dia","v":"1460","t":"-0.1%","d":"down"},{"l":"Documentos Gerados","v":"1.264","t":"+0.6%","d":"up"},{"l":"Templates","v":"903","t":"-1.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.351","2026-02-27","4.308","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.905","2026-02-17","8.110","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.419","2026-02-04","6.147","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.674","2026-01-25","4.253","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.037","2026-01-21","6.677","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":424},{"label":"Fev","value":621},{"label":"Mar","value":749},{"label":"Abr","value":521},{"label":"Mai","value":421},{"label":"Jun","value":722},{"label":"Jul","value":687},{"label":"Ago","value":730},{"label":"Set","value":494},{"label":"Out","value":386},{"label":"Nov","value":624},{"label":"Dez","value":403}];
const MX = 749;
