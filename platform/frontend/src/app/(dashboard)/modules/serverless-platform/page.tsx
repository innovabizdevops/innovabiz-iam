...
const KPIS = [
    { label: "Total Registos", value: "4875", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4833", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€172K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "724239275", cells: ["SER-1275", "Serverless Platform Item 1", "12/12/2026", "€39 375"], status: "active" as const },
    { id: "724242846", cells: ["SER-4846", "Serverless Platform Item 2", "27/7/2026", "€42 946"], status: "pending" as const },
    { id: "724246417", cells: ["SER-8417", "Serverless Platform Item 3", "14/2/2026", "€46 517"], status: "completed" as const },
    { id: "724249988", cells: ["SER-2988", "Serverless Platform Item 4", "1/9/2026", "€50 088"], status: "warning" as const },
    { id: "724253559", cells: ["SER-6559", "Serverless Platform Item 5", "16/4/2026", "€3659"], status: "active" as const },
];
...
export default function ServerlessPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Serverless Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Serverless Platform</p>
                    </div>
                </div>
