...
const PAGE = "Deploy";
const KPIS = [{"l":"Formulários Ativos","v":"4.620","t":"+10.9%","d":"up"},{"l":"Submissões/Dia","v":"4871","t":"+17.9%","d":"up"},{"l":"Documentos Gerados","v":"1.474","t":"-1.6%","d":"down"},{"l":"Templates","v":"6.068","t":"+12.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.328","2026-01-26","6.485","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.896","2026-03-15","7.590","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.052","2026-01-26","4.799","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.874","2026-02-04","4.468","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.248","2026-02-10","556","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":597},{"label":"Mar","value":362},{"label":"Abr","value":379},{"label":"Mai","value":611},{"label":"Jun","value":286},{"label":"Jul","value":536},{"label":"Ago","value":634},{"label":"Set","value":421},{"label":"Out","value":650},{"label":"Nov","value":614},{"label":"Dez","value":565}];
const MX = 650;
