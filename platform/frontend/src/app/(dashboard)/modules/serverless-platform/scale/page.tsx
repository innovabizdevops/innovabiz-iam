...
const PAGE = "Scale";
const KPIS = [{"l":"Formulários Ativos","v":"124","t":"+13.3%","d":"up"},{"l":"Submissões/Dia","v":"3680","t":"+15.3%","d":"up"},{"l":"Documentos Gerados","v":"8.177","t":"+17.7%","d":"up"},{"l":"Templates","v":"8.789","t":"+13.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.998","2026-01-04","8.810","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.233","2026-02-27","3.153","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.745","2026-02-07","2.461","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.034","2026-02-02","4.659","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","284","2026-03-17","2.588","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":627},{"label":"Mar","value":550},{"label":"Abr","value":521},{"label":"Mai","value":591},{"label":"Jun","value":599},{"label":"Jul","value":740},{"label":"Ago","value":549},{"label":"Set","value":389},{"label":"Out","value":583},{"label":"Nov","value":383},{"label":"Dez","value":379}];
const MX = 740;
