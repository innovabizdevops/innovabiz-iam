...
const PAGE = "Function";
const KPIS = [{"l":"Formulários Ativos","v":"3.599","t":"-3.3%","d":"down"},{"l":"Submissões/Dia","v":"4594","t":"-4.9%","d":"down"},{"l":"Documentos Gerados","v":"4.341","t":"-1.3%","d":"down"},{"l":"Templates","v":"4.594","t":"+17.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.440","2026-01-09","4.285","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.816","2026-03-01","3.705","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.439","2026-01-17","854","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.261","2026-03-05","339","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.228","2026-01-07","2.993","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":778},{"label":"Fev","value":581},{"label":"Mar","value":633},{"label":"Abr","value":845},{"label":"Mai","value":585},{"label":"Jun","value":820},{"label":"Jul","value":830},{"label":"Ago","value":632},{"label":"Set","value":667},{"label":"Out","value":777},{"label":"Nov","value":833},{"label":"Dez","value":933}];
const MX = 933;
