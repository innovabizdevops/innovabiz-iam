...
/* ═══ Beauty & Cosmetics Platform — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "2014", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1253", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€40K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1819552614", cells: ["BEA-5614", "Beauty & Cosmetics Platform Item 1", "27/7/2026", "€2714"], status: "active" as const },
    { id: "1819556185", cells: ["BEA-9185", "Beauty & Cosmetics Platform Item 2", "14/2/2026", "€6285"], status: "pending" as const },
    { id: "1819559756", cells: ["BEA-3756", "Beauty & Cosmetics Platform Item 3", "1/9/2026", "€9856"], status: "completed" as const },
    { id: "1819563327", cells: ["BEA-7327", "Beauty & Cosmetics Platform Item 4", "16/4/2026", "€13 427"], status: "warning" as const },
    { id: "1819566898", cells: ["BEA-1898", "Beauty & Cosmetics Platform Item 5", "3/11/2026", "€16 998"], status: "active" as const },
];
...
export default function BeautyCosmeticsPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Beauty & Cosmetics Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Beauty & Cosmetics Platform</p>
                    </div>
                </div>
