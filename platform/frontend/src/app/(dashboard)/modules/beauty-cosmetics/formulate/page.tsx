...
const PAGE = "Formulate";
const KPIS = [{"l":"Formulários Ativos","v":"6.431","t":"+9.5%","d":"up"},{"l":"Submissões/Dia","v":"4427","t":"+5.3%","d":"up"},{"l":"Documentos Gerados","v":"8.364","t":"+10.7%","d":"up"},{"l":"Templates","v":"3.188","t":"+17.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.289","2026-03-27","6.093","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.892","2026-02-02","3.451","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.569","2026-03-07","8.587","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.745","2026-03-27","3.036","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.538","2026-03-25","2.319","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":361},{"label":"Mar","value":342},{"label":"Abr","value":668},{"label":"Mai","value":334},{"label":"Jun","value":330},{"label":"Jul","value":386},{"label":"Ago","value":700},{"label":"Set","value":462},{"label":"Out","value":539},{"label":"Nov","value":470},{"label":"Dez","value":490}];
const MX = 700;
