...
const ACCENT = "#be185d";
const MODULE = "Beauty & Cosmetics Platform";
const PAGE = "Produce";
const KPIS = [{"l":"Total Beauty Cosmetics","v":"2.492","t":"+10.4%","d":"up"},{"l":"Produce Ativos","v":"8.791","t":"+6.4%","d":"up"},{"l":"Eficiência (%)","v":"65.5%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"57","t":"-3.4%","d":"down"}];
const COLS = ["ID","Produce","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Beauty Cosmetics #001","Beauty Cosmetics #002","3.501","7.700","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Beauty Cosmetics #002","Beauty Cosmetics #003","3.104","5.235","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Beauty Cosmetics #003","Beauty Cosmetics #004","8.888","7.388","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Beauty Cosmetics #004","Beauty Cosmetics #005","2.935","8.129","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Beauty Cosmetics #005","Beauty Cosmetics #001","7.912","6.599","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":432},{"label":"Fev","value":776},{"label":"Mar","value":672},{"label":"Abr","value":415},{"label":"Mai","value":414},{"label":"Jun","value":451},{"label":"Jul","value":736},{"label":"Ago","value":766},{"label":"Set","value":654},{"label":"Out","value":448},{"label":"Nov","value":666},{"label":"Dez","value":491}];
const MX = 776;
