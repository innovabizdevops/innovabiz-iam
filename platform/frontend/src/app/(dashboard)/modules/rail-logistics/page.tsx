...
export default function RailLogisticsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Rail Logistics</h1><p className="text-sm text-muted-foreground">Rail Logistics • iBOS Enterprise</p></div>
