...
const ACCENT = "#6366f1";
const MODULE = "Rail Logistics";
const PAGE = "Booking";
const KPIS = [{"l":"Veículos Operação","v":"4.179","t":"+3.4%","d":"up"},{"l":"Viagens/Dia","v":"3096","t":"+7.3%","d":"up"},{"l":"Pontualidade (%)","v":"79.0%","t":"+8.2%","d":"up"},{"l":"Passageiros/Dia","v":"534","t":"+9.8%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-17","2026-02-15","4.566","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-02","2026-02-08","8.389","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-27","2026-02-16","5.576","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-14","2026-03-13","6.125","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-28","2026-03-05","3.294","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":279},{"label":"Fev","value":626},{"label":"Mar","value":367},{"label":"Abr","value":368},{"label":"Mai","value":548},{"label":"Jun","value":414},{"label":"Jul","value":280},{"label":"Ago","value":400},{"label":"Set","value":299},{"label":"Out","value":273},{"label":"Nov","value":502},{"label":"Dez","value":310}];
const MX = 626;
