...
const PAGE = "Wagon";
const KPIS = [{"l":"Veículos Operação","v":"7.214","t":"-3.2%","d":"down"},{"l":"Viagens/Dia","v":"2811","t":"+3.8%","d":"up"},{"l":"Pontualidade (%)","v":"87.9%","t":"-2.0%","d":"down"},{"l":"Passageiros/Dia","v":"503","t":"-5.4%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-28","2026-02-21","3.883","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-15","2026-01-16","1.452","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-19","2026-02-20","4.232","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-16","2026-01-20","8.457","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-19","2026-01-08","7.874","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":613},{"label":"Mar","value":649},{"label":"Abr","value":751},{"label":"Mai","value":840},{"label":"Jun","value":547},{"label":"Jul","value":579},{"label":"Ago","value":479},{"label":"Set","value":811},{"label":"Out","value":455},{"label":"Nov","value":543},{"label":"Dez","value":653}];
const MX = 840;
