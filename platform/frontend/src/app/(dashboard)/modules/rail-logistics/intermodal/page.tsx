...
const KPIS = [{"l":"Riscos Identificados","v":"5.224","t":"+9.7%","d":"up"},{"l":"Mitigações Ativas","v":"2.883","t":"+3.3%","d":"up"},{"l":"Score Risco Geral","v":"65","t":"-5.0%","d":"down"},{"l":"Incidentes YTD","v":"1.954","t":"+14.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","834","5.660","6.554","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.250","5.442","2.912","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.846","8.204","3.880","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.595","7.531","830","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.665","4.622","4.367","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":423},{"label":"Fev","value":713},{"label":"Mar","value":386},{"label":"Abr","value":376},{"label":"Mai","value":562},{"label":"Jun","value":627},{"label":"Jul","value":637},{"label":"Ago","value":577},{"label":"Set","value":415},{"label":"Out","value":731},{"label":"Nov","value":514},{"label":"Dez","value":518}];
const MX = 731;
