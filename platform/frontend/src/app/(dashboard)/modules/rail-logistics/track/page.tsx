...
const PAGE = "Track";
const KPIS = [{"l":"Veículos Operação","v":"3.146","t":"+5.8%","d":"up"},{"l":"Viagens/Dia","v":"4475","t":"+14.1%","d":"up"},{"l":"Pontualidade (%)","v":"82.4%","t":"+12.7%","d":"up"},{"l":"Passageiros/Dia","v":"1218","t":"+4.8%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-04","2026-03-23","431","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-22","2026-02-27","1.045","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-09","2026-03-16","3.183","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-22","2026-03-22","5.738","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-06","2026-02-11","3.071","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":711},{"label":"Mar","value":664},{"label":"Abr","value":698},{"label":"Mai","value":718},{"label":"Jun","value":490},{"label":"Jul","value":515},{"label":"Ago","value":692},{"label":"Set","value":724},{"label":"Out","value":821},{"label":"Nov","value":784},{"label":"Dez","value":619}];
const MX = 821;
