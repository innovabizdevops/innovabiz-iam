...
const KPIS = [
    { label: "Total Registos", value: "4121", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1022", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€269K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1271134321", cells: ["NIS-2321", "NIST Cybersecurity Framework Item 1", "10/2/2026", "€34 421"], status: "active" as const },
    { id: "1271137892", cells: ["NIS-5892", "NIST Cybersecurity Framework Item 2", "25/9/2026", "€37 992"], status: "pending" as const },
    { id: "1271141463", cells: ["NIS-9463", "NIST Cybersecurity Framework Item 3", "12/4/2026", "€41 563"], status: "completed" as const },
    { id: "1271145034", cells: ["NIS-4034", "NIST Cybersecurity Framework Item 4", "27/11/2026", "€45 134"], status: "warning" as const },
    { id: "1271148605", cells: ["NIS-7605", "NIST Cybersecurity Framework Item 5", "14/6/2026", "€48 705"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">NIST Cybersecurity Framework</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • NIST Cybersecurity Framework</p>
                    </div>
                </div>
