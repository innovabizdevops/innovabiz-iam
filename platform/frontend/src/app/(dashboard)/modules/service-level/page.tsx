...
/* ═══ Service Level Mgmt (ITIL) — Dashboard ═══ */

const ACCENT = "#94a3b8";

const KPIS = [
    { label: "Total Registos", value: "2541", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4424", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€349K", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1717325741", cells: ["SER-9741", "Service Level Mgmt (ITIL) Item 1", "6/6/2026", "€25 841"], status: "active" as const },
    { id: "1717329312", cells: ["SER-4312", "Service Level Mgmt (ITIL) Item 2", "21/1/2026", "€29 412"], status: "pending" as const },
    { id: "1717332883", cells: ["SER-7883", "Service Level Mgmt (ITIL) Item 3", "8/8/2026", "€32 983"], status: "completed" as const },
    { id: "1717336454", cells: ["SER-2454", "Service Level Mgmt (ITIL) Item 4", "23/3/2026", "€36 554"], status: "warning" as const },
    { id: "1717340025", cells: ["SER-6025", "Service Level Mgmt (ITIL) Item 5", "10/10/2026", "€40 125"], status: "active" as const },
];
...
export default function ServiceLevelMgmtItilPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Service Level Mgmt (ITIL)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Service Level Mgmt (ITIL)</p>
                    </div>
                </div>
