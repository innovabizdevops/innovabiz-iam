...
const PAGE = "SLA";
const KPIS = [{"l":"Tickets Abertos","v":"7.980","t":"-4.8%","d":"down"},{"l":"SLA Cumprido (%)","v":"78.4%","t":"+2.2%","d":"up"},{"l":"MTTR (h)","v":"22h","t":"+13.8%","d":"up"},{"l":"Satisfação (%)","v":"81.7%","t":"-4.0%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.920","4.791","8.662","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.302","881","8.793","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.771","3.019","8.777","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.639","1.098","4.922","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.043","7.537","7.769","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":448},{"label":"Fev","value":745},{"label":"Mar","value":573},{"label":"Abr","value":719},{"label":"Mai","value":705},{"label":"Jun","value":826},{"label":"Jul","value":678},{"label":"Ago","value":652},{"label":"Set","value":543},{"label":"Out","value":568},{"label":"Nov","value":793},{"label":"Dez","value":649}];
const MX = 826;
