...
const PAGE = "Estate Planning";
const KPIS = [{"l":"Total Wealthtech","v":"2.965","t":"+13.7%","d":"up"},{"l":"Estate Planning Ativos","v":"5.799","t":"+17.8%","d":"up"},{"l":"Eficiência (%)","v":"78.1%","t":"+4.3%","d":"up"},{"l":"Score Performance","v":"81","t":"-3.4%","d":"down"}];
const COLS = ["ID","Estate Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wealthtech #001","Wealthtech #002","5.190","6.053","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Wealthtech #002","Wealthtech #003","8.082","4.704","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Wealthtech #003","Wealthtech #004","338","6.686","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Wealthtech #004","Wealthtech #005","7.391","1.368","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wealthtech #005","Wealthtech #001","4.317","7.814","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":528},{"label":"Mar","value":797},{"label":"Abr","value":777},{"label":"Mai","value":804},{"label":"Jun","value":602},{"label":"Jul","value":553},{"label":"Ago","value":601},{"label":"Set","value":706},{"label":"Out","value":762},{"label":"Nov","value":660},{"label":"Dez","value":609}];
const MX = 804;
