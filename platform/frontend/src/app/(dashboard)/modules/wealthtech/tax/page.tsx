...
const PAGE = "Tax Optimization";
const KPIS = [{"l":"Total Wealthtech","v":"8.866","t":"+9.9%","d":"up"},{"l":"Tax Optimization Ativos","v":"2.332","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"72.6%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"65","t":"+9.0%","d":"up"}];
const COLS = ["ID","Tax Optimization","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wealthtech #001","Wealthtech #002","3.636","1.233","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Wealthtech #002","Wealthtech #003","9.085","5.524","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Wealthtech #003","Wealthtech #004","8.703","2.342","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Wealthtech #004","Wealthtech #005","6.373","7.115","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wealthtech #005","Wealthtech #001","5.541","5.610","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":531},{"label":"Mar","value":569},{"label":"Abr","value":365},{"label":"Mai","value":312},{"label":"Jun","value":521},{"label":"Jul","value":492},{"label":"Ago","value":342},{"label":"Set","value":497},{"label":"Out","value":618},{"label":"Nov","value":311},{"label":"Dez","value":576}];
const MX = 618;
