...
const PAGE = "Robo-Advisor";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.763","t":"+8.6%","d":"up"},{"l":"NC Abertas","v":"5.588","t":"+17.0%","d":"up"},{"l":"Conformidade (%)","v":"66.4%","t":"+1.4%","d":"up"},{"l":"CAPAs Pendentes","v":"8.612","t":"+13.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.701","72.2%","5.331","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.194","85.1%","1.025","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.618","94.8%","6.966","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.988","89.7%","4.612","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.997","82.5%","6.592","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":889},{"label":"Fev","value":554},{"label":"Mar","value":770},{"label":"Abr","value":868},{"label":"Mai","value":745},{"label":"Jun","value":828},{"label":"Jul","value":725},{"label":"Ago","value":701},{"label":"Set","value":737},{"label":"Out","value":563},{"label":"Nov","value":721},{"label":"Dez","value":840}];
const MX = 889;
