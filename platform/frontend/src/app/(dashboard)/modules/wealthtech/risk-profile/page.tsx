...
const PAGE = "Risk Profiling";
const KPIS = [{"l":"Riscos Identificados","v":"6.649","t":"+0.5%","d":"up"},{"l":"Mitigações Ativas","v":"1.743","t":"-5.0%","d":"down"},{"l":"Score Risco Geral","v":"75","t":"+10.6%","d":"up"},{"l":"Incidentes YTD","v":"4.380","t":"-1.6%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.137","5.275","5.836","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.500","2.548","6.778","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.882","8.002","3.611","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.796","5.257","2.992","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.795","658","5.266","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":396},{"label":"Mar","value":440},{"label":"Abr","value":655},{"label":"Mai","value":501},{"label":"Jun","value":313},{"label":"Jul","value":626},{"label":"Ago","value":361},{"label":"Set","value":501},{"label":"Out","value":563},{"label":"Nov","value":353},{"label":"Dez","value":460}];
const MX = 655;
