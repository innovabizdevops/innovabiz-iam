...
const ACCENT = "#15803d";
const MODULE = "WealthTech & Advisory";
const PAGE = "ESG Investing";
const KPIS = [{"l":"Total Wealthtech","v":"9.097","t":"+8.6%","d":"up"},{"l":"ESG Investing Ativos","v":"7.772","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"88.9%","t":"+8.3%","d":"up"},{"l":"Score Performance","v":"60","t":"+17.9%","d":"up"}];
const COLS = ["ID","ESG Investing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wealthtech #001","Wealthtech #002","4.448","7.801","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Wealthtech #002","Wealthtech #003","3.885","7.942","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Wealthtech #003","Wealthtech #004","4.061","3.005","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Wealthtech #004","Wealthtech #005","5.873","8.454","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wealthtech #005","Wealthtech #001","3.824","5.798","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":927},{"label":"Fev","value":832},{"label":"Mar","value":1043},{"label":"Abr","value":663},{"label":"Mai","value":797},{"label":"Jun","value":971},{"label":"Jul","value":819},{"label":"Ago","value":833},{"label":"Set","value":739},{"label":"Out","value":1051},{"label":"Nov","value":913},{"label":"Dez","value":1047}];
const MX = 1051;
