...
const PAGE = "Alt Investments";
const KPIS = [{"l":"Total Wealthtech","v":"8.956","t":"-4.3%","d":"down"},{"l":"Alt Investments Ativos","v":"8.512","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"67.6%","t":"+2.3%","d":"up"},{"l":"Score Performance","v":"77","t":"+5.1%","d":"up"}];
const COLS = ["ID","Alt Investments","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wealthtech #001","Wealthtech #002","7.318","7.378","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Wealthtech #002","Wealthtech #003","362","8.481","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Wealthtech #003","Wealthtech #004","196","3.607","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Wealthtech #004","Wealthtech #005","7.886","3.236","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wealthtech #005","Wealthtech #001","3.819","7.656","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":863},{"label":"Fev","value":812},{"label":"Mar","value":1006},{"label":"Abr","value":1003},{"label":"Mai","value":783},{"label":"Jun","value":719},{"label":"Jul","value":694},{"label":"Ago","value":879},{"label":"Set","value":970},{"label":"Out","value":948},{"label":"Nov","value":948},{"label":"Dez","value":827}];
const MX = 1006;
