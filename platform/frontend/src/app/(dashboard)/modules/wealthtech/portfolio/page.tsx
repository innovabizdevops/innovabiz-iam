...
const PAGE = "Portfolio Mgmt";
const KPIS = [{"l":"Total Wealthtech","v":"3.564","t":"-4.5%","d":"down"},{"l":"Portfolio Mgmt Ativos","v":"4.485","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"81.0%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"57","t":"+0.2%","d":"up"}];
const COLS = ["ID","Portfolio Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wealthtech #001","Wealthtech #002","8.315","2.209","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Wealthtech #002","Wealthtech #003","3.690","1.490","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Wealthtech #003","Wealthtech #004","6.626","4.645","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Wealthtech #004","Wealthtech #005","8.389","7.995","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wealthtech #005","Wealthtech #001","2.427","1.403","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":833},{"label":"Mar","value":716},{"label":"Abr","value":930},{"label":"Mai","value":758},{"label":"Jun","value":915},{"label":"Jul","value":1019},{"label":"Ago","value":777},{"label":"Set","value":1005},{"label":"Out","value":1027},{"label":"Nov","value":1052},{"label":"Dez","value":979}];
const MX = 1052;
