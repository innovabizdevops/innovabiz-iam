...
const PAGE = "Client Reporting";
const KPIS = [{"l":"Total Wealthtech","v":"6.983","t":"-3.5%","d":"down"},{"l":"Client Reporting Ativos","v":"4.150","t":"-5.9%","d":"down"},{"l":"Eficiência (%)","v":"82.7%","t":"+14.0%","d":"up"},{"l":"Score Performance","v":"57","t":"+0.7%","d":"up"}];
const COLS = ["ID","Client Reporting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wealthtech #001","Wealthtech #002","4.266","7.292","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Wealthtech #002","Wealthtech #003","4.268","698","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Wealthtech #003","Wealthtech #004","6.742","3.851","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Wealthtech #004","Wealthtech #005","1.691","744","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wealthtech #005","Wealthtech #001","7.487","6.942","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":919},{"label":"Fev","value":927},{"label":"Mar","value":898},{"label":"Abr","value":655},{"label":"Mai","value":826},{"label":"Jun","value":789},{"label":"Jul","value":690},{"label":"Ago","value":901},{"label":"Set","value":788},{"label":"Out","value":666},{"label":"Nov","value":850},{"label":"Dez","value":898}];
const MX = 927;
