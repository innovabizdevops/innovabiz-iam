...
const PAGE = "Early Payment";
const KPIS = [{"l":"Total Accounts Payable","v":"5.335","t":"+9.3%","d":"up"},{"l":"Early Payment Ativos","v":"2.522","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"76.2%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"84","t":"+8.9%","d":"up"}];
const COLS = ["ID","Early Payment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Accounts Payable #001","Accounts Payable #002","3.739","2.494","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Accounts Payable #002","Accounts Payable #003","625","7.306","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Accounts Payable #003","Accounts Payable #004","7.534","5.317","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Accounts Payable #004","Accounts Payable #005","276","3.078","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Accounts Payable #005","Accounts Payable #001","8.240","4.054","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":941},{"label":"Fev","value":936},{"label":"Mar","value":690},{"label":"Abr","value":592},{"label":"Mai","value":617},{"label":"Jun","value":552},{"label":"Jul","value":661},{"label":"Ago","value":742},{"label":"Set","value":787},{"label":"Out","value":813},{"label":"Nov","value":933},{"label":"Dez","value":775}];
const MX = 941;
