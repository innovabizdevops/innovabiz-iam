...
const PAGE = "Payment Runs";
const KPIS = [{"l":"Total Accounts Payable","v":"2.516","t":"+16.8%","d":"up"},{"l":"Payment Runs Ativos","v":"4.997","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"80.5%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"73","t":"-5.5%","d":"down"}];
const COLS = ["ID","Payment Runs","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Accounts Payable #001","Accounts Payable #002","5.474","7.510","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Accounts Payable #002","Accounts Payable #003","8.153","2.559","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Accounts Payable #003","Accounts Payable #004","1.153","6.908","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Accounts Payable #004","Accounts Payable #005","9.015","6.562","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Accounts Payable #005","Accounts Payable #001","5.537","8.462","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":918},{"label":"Fev","value":700},{"label":"Mar","value":902},{"label":"Abr","value":1018},{"label":"Mai","value":693},{"label":"Jun","value":903},{"label":"Jul","value":953},{"label":"Ago","value":639},{"label":"Set","value":934},{"label":"Out","value":953},{"label":"Nov","value":1017},{"label":"Dez","value":869}];
const MX = 1018;
