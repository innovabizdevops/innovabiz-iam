...
const PAGE = "OCR Invoice AI";
const KPIS = [{"l":"Total Accounts Payable","v":"8.242","t":"+3.3%","d":"up"},{"l":"OCR Invoice AI Ativos","v":"4.029","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"68.8%","t":"+7.6%","d":"up"},{"l":"Score Performance","v":"80","t":"-3.1%","d":"down"}];
const COLS = ["ID","OCR Invoice AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Accounts Payable #001","Accounts Payable #002","3.285","1.345","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Accounts Payable #002","Accounts Payable #003","4.167","1.930","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Accounts Payable #003","Accounts Payable #004","4.581","5.370","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Accounts Payable #004","Accounts Payable #005","3.346","6.486","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Accounts Payable #005","Accounts Payable #001","5.770","7.351","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":882},{"label":"Mar","value":845},{"label":"Abr","value":819},{"label":"Mai","value":997},{"label":"Jun","value":927},{"label":"Jul","value":1011},{"label":"Ago","value":754},{"label":"Set","value":960},{"label":"Out","value":936},{"label":"Nov","value":883},{"label":"Dez","value":919}];
const MX = 1011;
