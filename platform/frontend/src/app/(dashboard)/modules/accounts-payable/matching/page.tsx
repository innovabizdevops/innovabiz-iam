...
const PAGE = "3-Way Match";
const KPIS = [{"l":"Atletas Registados","v":"5.530","t":"+14.1%","d":"up"},{"l":"Treinos/Semana","v":"1249","t":"-2.5%","d":"down"},{"l":"Competições","v":"6.250","t":"-5.0%","d":"down"},{"l":"Performance Score","v":"81","t":"+9.9%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.960","8.249","5.270","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.072","2.316","5.062","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.850","5.360","6.752","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.200","7.983","607","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","593","2.862","1.014","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":855},{"label":"Fev","value":865},{"label":"Mar","value":1004},{"label":"Abr","value":1008},{"label":"Mai","value":906},{"label":"Jun","value":854},{"label":"Jul","value":697},{"label":"Ago","value":693},{"label":"Set","value":892},{"label":"Out","value":808},{"label":"Nov","value":778},{"label":"Dez","value":1009}];
const MX = 1009;
