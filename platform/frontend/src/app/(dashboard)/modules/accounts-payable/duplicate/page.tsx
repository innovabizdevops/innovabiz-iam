...
const PAGE = "Duplicate Detect";
const KPIS = [{"l":"Total Accounts Payable","v":"6.327","t":"+8.0%","d":"up"},{"l":"Duplicate Detect Ativos","v":"4.039","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"74.1%","t":"+10.5%","d":"up"},{"l":"Score Performance","v":"90","t":"+17.4%","d":"up"}];
const COLS = ["ID","Duplicate Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Accounts Payable #001","Accounts Payable #002","5.556","2.435","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Accounts Payable #002","Accounts Payable #003","242","4.169","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Accounts Payable #003","Accounts Payable #004","5.962","1.090","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Accounts Payable #004","Accounts Payable #005","4.877","642","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Accounts Payable #005","Accounts Payable #001","4.738","3.940","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":820},{"label":"Mar","value":752},{"label":"Abr","value":728},{"label":"Mai","value":673},{"label":"Jun","value":540},{"label":"Jul","value":533},{"label":"Ago","value":520},{"label":"Set","value":829},{"label":"Out","value":788},{"label":"Nov","value":756},{"label":"Dez","value":517}];
const MX = 829;
