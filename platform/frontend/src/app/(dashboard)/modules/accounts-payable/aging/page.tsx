...
const PAGE = "Vendor Aging";
const KPIS = [{"l":"Fornecedores Ativos","v":"2.013","t":"+10.4%","d":"up"},{"l":"Contratos (€M)","v":"€36.5M","t":"+1.6%","d":"up"},{"l":"On-Time Delivery (%)","v":"70.2%","t":"+16.1%","d":"up"},{"l":"Score Médio","v":"68","t":"+8.5%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","75.3%","€ 7247.43","5.612","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","78.9%","€ 17810.34","1.902","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","78.2%","€ 25896.56","2.303","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","82.9%","€ 15394.88","8.537","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","76.4%","€ 38148.07","1.321","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":924},{"label":"Fev","value":808},{"label":"Mar","value":703},{"label":"Abr","value":777},{"label":"Mai","value":871},{"label":"Jun","value":874},{"label":"Jul","value":654},{"label":"Ago","value":788},{"label":"Set","value":848},{"label":"Out","value":762},{"label":"Nov","value":850},{"label":"Dez","value":980}];
const MX = 980;
