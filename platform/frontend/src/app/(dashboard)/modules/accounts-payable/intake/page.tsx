...
const ACCENT = "#dc2626";
const MODULE = "Accounts Payable";
const PAGE = "Invoice Intake AI";
const KPIS = [{"l":"Total Accounts Payable","v":"6.576","t":"+12.5%","d":"up"},{"l":"Invoice Intake AI Ativos","v":"7.637","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"70.6%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"72","t":"+17.5%","d":"up"}];
const COLS = ["ID","Invoice Intake AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Accounts Payable #001","Accounts Payable #002","1.860","6.626","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Accounts Payable #002","Accounts Payable #003","627","2.613","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Accounts Payable #003","Accounts Payable #004","1.256","3.937","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Accounts Payable #004","Accounts Payable #005","2.696","7.036","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Accounts Payable #005","Accounts Payable #001","204","6.669","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":363},{"label":"Fev","value":460},{"label":"Mar","value":520},{"label":"Abr","value":399},{"label":"Mai","value":424},{"label":"Jun","value":612},{"label":"Jul","value":352},{"label":"Ago","value":456},{"label":"Set","value":388},{"label":"Out","value":619},{"label":"Nov","value":548},{"label":"Dez","value":501}];
const MX = 619;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>AI</span></h1>
                </div>
