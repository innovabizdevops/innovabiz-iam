...
const ACCENT = "#6366f1";
const MODULE = "Live Broadcast";
const PAGE = "Multi-Camera";
const KPIS = [{"l":"Total Live Broadcast","v":"5.294","t":"+3.8%","d":"up"},{"l":"Multi Camera Ativos","v":"1.581","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"88.2%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"78","t":"-1.1%","d":"down"}];
const COLS = ["ID","Multi Camera","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Live Broadcast #001","Live Broadcast #002","7.448","8.218","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Live Broadcast #002","Live Broadcast #003","4.416","6.860","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Live Broadcast #003","Live Broadcast #004","2.972","8.341","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Live Broadcast #004","Live Broadcast #005","1.493","6.743","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Live Broadcast #005","Live Broadcast #001","8.976","2.785","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":496},{"label":"Fev","value":363},{"label":"Mar","value":366},{"label":"Abr","value":263},{"label":"Mai","value":306},{"label":"Jun","value":584},{"label":"Jul","value":217},{"label":"Ago","value":304},{"label":"Set","value":457},{"label":"Out","value":540},{"label":"Nov","value":536},{"label":"Dez","value":368}];
const MX = 584;
