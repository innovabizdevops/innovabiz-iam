...
const PAGE = "Uplink";
const KPIS = [{"l":"Total Live Broadcast","v":"7.150","t":"-5.1%","d":"down"},{"l":"Uplink Ativos","v":"6.007","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"65.5%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"68","t":"-5.4%","d":"down"}];
const COLS = ["ID","Uplink","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Live Broadcast #001","Live Broadcast #002","3.204","2.419","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Live Broadcast #002","Live Broadcast #003","2.447","1.694","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Live Broadcast #003","Live Broadcast #004","2.562","7.804","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Live Broadcast #004","Live Broadcast #005","7.756","245","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Live Broadcast #005","Live Broadcast #001","119","6.491","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":795},{"label":"Mar","value":521},{"label":"Abr","value":638},{"label":"Mai","value":890},{"label":"Jun","value":808},{"label":"Jul","value":713},{"label":"Ago","value":577},{"label":"Set","value":633},{"label":"Out","value":888},{"label":"Nov","value":817},{"label":"Dez","value":742}];
const MX = 890;
