...
const PAGE = "Replay";
const KPIS = [{"l":"Total Live Broadcast","v":"2.991","t":"-3.7%","d":"down"},{"l":"Replay Ativos","v":"4.873","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"75.8%","t":"+16.7%","d":"up"},{"l":"Score Performance","v":"80","t":"+7.3%","d":"up"}];
const COLS = ["ID","Replay","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Live Broadcast #001","Live Broadcast #002","4.668","7.189","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Live Broadcast #002","Live Broadcast #003","2.178","1.635","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Live Broadcast #003","Live Broadcast #004","5.666","8.464","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Live Broadcast #004","Live Broadcast #005","5.811","6.699","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Live Broadcast #005","Live Broadcast #001","8.167","1.407","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":720},{"label":"Mar","value":687},{"label":"Abr","value":596},{"label":"Mai","value":584},{"label":"Jun","value":701},{"label":"Jul","value":811},{"label":"Ago","value":470},{"label":"Set","value":537},{"label":"Out","value":823},{"label":"Nov","value":470},{"label":"Dez","value":593}];
const MX = 823;
