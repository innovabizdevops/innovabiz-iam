...
const PAGE = "Graphics";
const KPIS = [{"l":"Total Live Broadcast","v":"8.632","t":"+16.0%","d":"up"},{"l":"Graphics Ativos","v":"1.285","t":"+5.9%","d":"up"},{"l":"Eficiência (%)","v":"73.6%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"78","t":"+13.9%","d":"up"}];
const COLS = ["ID","Graphics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Live Broadcast #001","Live Broadcast #002","4.138","7.695","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Live Broadcast #002","Live Broadcast #003","7.446","4.635","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Live Broadcast #003","Live Broadcast #004","4.877","4.742","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Live Broadcast #004","Live Broadcast #005","8.800","2.502","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Live Broadcast #005","Live Broadcast #001","6.954","7.877","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":561},{"label":"Mar","value":591},{"label":"Abr","value":691},{"label":"Mai","value":559},{"label":"Jun","value":687},{"label":"Jul","value":866},{"label":"Ago","value":581},{"label":"Set","value":563},{"label":"Out","value":745},{"label":"Nov","value":771},{"label":"Dez","value":555}];
const MX = 866;
