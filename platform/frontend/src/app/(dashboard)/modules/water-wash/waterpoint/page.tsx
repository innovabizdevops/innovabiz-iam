...
const ACCENT = "#0e7490";
const MODULE = "WASH Program";
const PAGE = "Water Point";
const KPIS = [{"l":"Total Water Wash","v":"5.286","t":"-4.5%","d":"down"},{"l":"Water Point Ativos","v":"2.211","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"65.1%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"89","t":"+14.8%","d":"up"}];
const COLS = ["ID","Water Point","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Wash #001","Water Wash #002","3.551","2.654","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Water Wash #002","Water Wash #003","5.451","1.261","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Wash #003","Water Wash #004","4.377","2.686","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Water Wash #004","Water Wash #005","6.933","1.038","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Wash #005","Water Wash #001","2.076","7.733","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":936},{"label":"Fev","value":931},{"label":"Mar","value":607},{"label":"Abr","value":921},{"label":"Mai","value":627},{"label":"Jun","value":765},{"label":"Jul","value":890},{"label":"Ago","value":666},{"label":"Set","value":702},{"label":"Out","value":799},{"label":"Nov","value":586},{"label":"Dez","value":689}];
const MX = 936;
