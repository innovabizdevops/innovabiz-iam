...
/* ═══ Platform Governance — Release Mgmt ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "1175", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "446", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "395", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1777356442", cells: ["PLA-1442", "Release Mgmt Item 1", "23/11/2026", "€6542"], status: "active" as const },
    { id: "1777360013", cells: ["PLA-5013", "Release Mgmt Item 2", "10/6/2026", "€10 113"], status: "pending" as const },
    { id: "1777363584", cells: ["PLA-8584", "Release Mgmt Item 3", "25/1/2026", "€13 684"], status: "completed" as const },
    { id: "1777367155", cells: ["PLA-3155", "Release Mgmt Item 4", "12/8/2026", "€17 255"], status: "warning" as const },
    { id: "1777370726", cells: ["PLA-6726", "Release Mgmt Item 5", "27/3/2026", "€20 826"], status: "active" as const },
];
...
export default function PlatformGovernanceReleaseMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Release Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Governance • Release Mgmt</p>
                    </div>
                </div>
