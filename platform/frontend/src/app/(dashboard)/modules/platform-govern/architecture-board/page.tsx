...
/* ═══ Platform Governance — Architecture Board ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "3492", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "123", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3168", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "915207431", cells: ["PLA-7431", "Architecture Board Item 1", "20/12/2026", "€7531"], status: "active" as const },
    { id: "915211002", cells: ["PLA-2002", "Architecture Board Item 2", "7/7/2026", "€11 102"], status: "pending" as const },
    { id: "915214573", cells: ["PLA-5573", "Architecture Board Item 3", "22/2/2026", "€14 673"], status: "completed" as const },
    { id: "915218144", cells: ["PLA-9144", "Architecture Board Item 4", "9/9/2026", "€18 244"], status: "warning" as const },
    { id: "915221715", cells: ["PLA-3715", "Architecture Board Item 5", "24/4/2026", "€21 815"], status: "active" as const },
];
...
export default function PlatformGovernanceArchitectureBoardPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Architecture Board</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Governance • Architecture Board</p>
                    </div>
                </div>
