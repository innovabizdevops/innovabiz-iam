...
/* ═══ Platform Governance — Capability Catalog ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "3122", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "83", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "30", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "78%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1287636431", cells: ["PLA-7431", "Capability Catalog Item 1", "12/12/2026", "€36 531"], status: "active" as const },
    { id: "1287640002", cells: ["PLA-2002", "Capability Catalog Item 2", "27/7/2026", "€40 102"], status: "pending" as const },
    { id: "1287643573", cells: ["PLA-5573", "Capability Catalog Item 3", "14/2/2026", "€43 673"], status: "completed" as const },
    { id: "1287647144", cells: ["PLA-9144", "Capability Catalog Item 4", "1/9/2026", "€47 244"], status: "warning" as const },
    { id: "1287650715", cells: ["PLA-3715", "Capability Catalog Item 5", "16/4/2026", "€815"], status: "active" as const },
];
...
export default function PlatformGovernanceCapabilityCatalogPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Capability Catalog</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Governance • Capability Catalog</p>
                    </div>
                </div>
