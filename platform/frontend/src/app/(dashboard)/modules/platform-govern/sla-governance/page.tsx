...
/* ═══ Platform Governance — Sla Governance ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "640", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "170", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2862", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "95%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "415306438", cells: ["PLA-2438", "Sla Governance Item 1", "23/11/2026", "€6538"], status: "active" as const },
    { id: "415310009", cells: ["PLA-6009", "Sla Governance Item 2", "10/6/2026", "€10 109"], status: "pending" as const },
    { id: "415313580", cells: ["PLA-9580", "Sla Governance Item 3", "25/1/2026", "€13 680"], status: "completed" as const },
    { id: "415317151", cells: ["PLA-4151", "Sla Governance Item 4", "12/8/2026", "€17 251"], status: "warning" as const },
    { id: "415320722", cells: ["PLA-7722", "Sla Governance Item 5", "27/3/2026", "€20 822"], status: "active" as const },
];
...
export default function PlatformGovernanceSlaGovernancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sla Governance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Governance • Sla Governance</p>
                    </div>
                </div>
