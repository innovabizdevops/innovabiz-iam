...
/* ═══ Platform Governance — Change Advisory ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "2322", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "141", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "825", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "69492233", cells: ["PLA-4233", "Change Advisory Item 1", "14/6/2026", "€42 333"], status: "active" as const },
    { id: "69495804", cells: ["PLA-7804", "Change Advisory Item 2", "1/1/2026", "€45 904"], status: "pending" as const },
    { id: "69499375", cells: ["PLA-2375", "Change Advisory Item 3", "16/8/2026", "€49 475"], status: "completed" as const },
    { id: "69502946", cells: ["PLA-5946", "Change Advisory Item 4", "3/3/2026", "€3046"], status: "warning" as const },
    { id: "69506517", cells: ["PLA-9517", "Change Advisory Item 5", "18/10/2026", "€6617"], status: "active" as const },
];
...
export default function PlatformGovernanceChangeAdvisoryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Change Advisory</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Governance • Change Advisory</p>
                    </div>
                </div>
