...
/* ═══ Platform Governance — Api Governance ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "2054", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "108", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3971", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "83%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "46136056", cells: ["PLA-3056", "Api Governance Item 1", "9/5/2026", "€36 156"], status: "active" as const },
    { id: "46139627", cells: ["PLA-6627", "Api Governance Item 2", "24/12/2026", "€39 727"], status: "pending" as const },
    { id: "46143198", cells: ["PLA-1198", "Api Governance Item 3", "11/7/2026", "€43 298"], status: "completed" as const },
    { id: "46146769", cells: ["PLA-4769", "Api Governance Item 4", "26/2/2026", "€46 869"], status: "warning" as const },
    { id: "46150340", cells: ["PLA-8340", "Api Governance Item 5", "13/9/2026", "€440"], status: "active" as const },
];
...
export default function PlatformGovernanceApiGovernancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Api Governance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Governance • Api Governance</p>
                    </div>
                </div>
