...
/* ═══ Platform Governance — Data Governance ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "4155", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "492", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1032", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "95%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "94907128", cells: ["PLA-3128", "Data Governance Item 1", "9/5/2026", "€7228"], status: "active" as const },
    { id: "94910699", cells: ["PLA-6699", "Data Governance Item 2", "24/12/2026", "€10 799"], status: "pending" as const },
    { id: "94914270", cells: ["PLA-1270", "Data Governance Item 3", "11/7/2026", "€14 370"], status: "completed" as const },
    { id: "94917841", cells: ["PLA-4841", "Data Governance Item 4", "26/2/2026", "€17 941"], status: "warning" as const },
    { id: "94921412", cells: ["PLA-8412", "Data Governance Item 5", "13/9/2026", "€21 512"], status: "active" as const },
];
...
export default function PlatformGovernanceDataGovernancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Governance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Governance • Data Governance</p>
                    </div>
                </div>
