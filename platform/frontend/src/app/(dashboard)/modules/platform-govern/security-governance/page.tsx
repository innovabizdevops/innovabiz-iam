...
const KPIS = [
    { label: "Total", value: "3850", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "310", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2498", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1742457250", cells: ["PLA-4250", "Security Governance Item 1", "3/11/2026", "€7350"], status: "active" as const },
    { id: "1742460821", cells: ["PLA-7821", "Security Governance Item 2", "18/6/2026", "€10 921"], status: "pending" as const },
    { id: "1742464392", cells: ["PLA-2392", "Security Governance Item 3", "5/1/2026", "€14 492"], status: "completed" as const },
    { id: "1742467963", cells: ["PLA-5963", "Security Governance Item 4", "20/8/2026", "€18 063"], status: "warning" as const },
    { id: "1742471534", cells: ["PLA-9534", "Security Governance Item 5", "7/3/2026", "€21 634"], status: "active" as const },
];
...
export default function PlatformGovernanceSecurityGovernancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Security Governance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Governance • Security Governance</p>
                    </div>
                </div>
