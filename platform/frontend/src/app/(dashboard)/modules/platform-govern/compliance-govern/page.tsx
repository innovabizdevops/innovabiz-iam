...
/* ═══ Platform Governance — Compliance Govern ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "2287", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "92", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "920", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "87%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1558422680", cells: ["PLA-1680", "Compliance Govern Item 1", "25/9/2026", "€22 780"], status: "active" as const },
    { id: "1558426251", cells: ["PLA-5251", "Compliance Govern Item 2", "12/4/2026", "€26 351"], status: "pending" as const },
    { id: "1558429822", cells: ["PLA-8822", "Compliance Govern Item 3", "27/11/2026", "€29 922"], status: "completed" as const },
    { id: "1558433393", cells: ["PLA-3393", "Compliance Govern Item 4", "14/6/2026", "€33 493"], status: "warning" as const },
    { id: "1558436964", cells: ["PLA-6964", "Compliance Govern Item 5", "1/1/2026", "€37 064"], status: "active" as const },
];
...
export default function PlatformGovernanceComplianceGovernPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Compliance Govern</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Governance • Compliance Govern</p>
                    </div>
                </div>
