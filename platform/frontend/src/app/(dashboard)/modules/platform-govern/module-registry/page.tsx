...
/* ═══ Platform Governance — Module Registry ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "2789", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "307", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "88", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "94%", trend: "-20%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1629178287", cells: ["PLA-8287", "Module Registry Item 1", "24/4/2026", "€28 387"], status: "active" as const },
    { id: "1629181858", cells: ["PLA-2858", "Module Registry Item 2", "11/11/2026", "€31 958"], status: "pending" as const },
    { id: "1629185429", cells: ["PLA-6429", "Module Registry Item 3", "26/6/2026", "€35 529"], status: "completed" as const },
    { id: "1629189000", cells: ["PLA-1000", "Module Registry Item 4", "13/1/2026", "€39 100"], status: "warning" as const },
    { id: "1629192571", cells: ["PLA-4571", "Module Registry Item 5", "28/8/2026", "€42 671"], status: "active" as const },
];
...
export default function PlatformGovernanceModuleRegistryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Module Registry</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Governance • Module Registry</p>
                    </div>
                </div>
