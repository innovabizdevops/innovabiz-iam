...
const ACCENT = "#6366f1";
const MODULE = "Potash Mining";
const PAGE = "Granulation";
const KPIS = [{"l":"Total Potash Mine","v":"495","t":"+7.6%","d":"up"},{"l":"Granulation Ativos","v":"7.805","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"82.2%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"59","t":"+3.5%","d":"up"}];
const COLS = ["ID","Granulation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Potash Mine #001","Potash Mine #002","7.220","5.536","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Potash Mine #002","Potash Mine #003","3.486","8.072","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Potash Mine #003","Potash Mine #004","2.818","7.640","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Potash Mine #004","Potash Mine #005","6.708","6.470","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Potash Mine #005","Potash Mine #001","427","7.609","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":798},{"label":"Mar","value":568},{"label":"Abr","value":526},{"label":"Mai","value":642},{"label":"Jun","value":538},{"label":"Jul","value":734},{"label":"Ago","value":765},{"label":"Set","value":613},{"label":"Out","value":659},{"label":"Nov","value":584},{"label":"Dez","value":689}];
const MX = 798;
...
export default function GranulationPage() {
    return (
