...
export default function PotashMinePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Potash Mine</h1><p className="text-sm text-muted-foreground">Potash Mine • iBOS Enterprise</p></div>
