...
/* ═══ Supply Chain 4.0 — Procurement Predict ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "368", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "266", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2847", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "97%", trend: "-23%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1038449190", cells: ["SUP-3190", "Procurement Predict Item 1", "3/7/2026", "€49 290"], status: "active" as const },
    { id: "1038452761", cells: ["SUP-6761", "Procurement Predict Item 2", "18/2/2026", "€2861"], status: "pending" as const },
    { id: "1038456332", cells: ["SUP-1332", "Procurement Predict Item 3", "5/9/2026", "€6432"], status: "completed" as const },
    { id: "1038459903", cells: ["SUP-4903", "Procurement Predict Item 4", "20/4/2026", "€10 003"], status: "warning" as const },
    { id: "1038463474", cells: ["SUP-8474", "Procurement Predict Item 5", "7/11/2026", "€13 574"], status: "active" as const },
];
...
export default function SupplyChain40ProcurementPredictPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Procurement Predict</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Supply Chain 4.0 • Procurement Predict</p>
                    </div>
                </div>
