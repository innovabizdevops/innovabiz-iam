...
/* ═══ Supply Chain 4.0 — S And Op ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "4247", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "426", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3779", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1836155238", cells: ["SUP-3238", "S And Op Item 1", "23/7/2026", "€5338"], status: "active" as const },
    { id: "1836158809", cells: ["SUP-6809", "S And Op Item 2", "10/2/2026", "€8909"], status: "pending" as const },
    { id: "1836162380", cells: ["SUP-1380", "S And Op Item 3", "25/9/2026", "€12 480"], status: "completed" as const },
    { id: "1836165951", cells: ["SUP-4951", "S And Op Item 4", "12/4/2026", "€16 051"], status: "warning" as const },
    { id: "1836169522", cells: ["SUP-8522", "S And Op Item 5", "27/11/2026", "€19 622"], status: "active" as const },
];
...
export default function SupplyChain40SAndOpPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">S And Op</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Supply Chain 4.0 • S And Op</p>
                    </div>
                </div>
