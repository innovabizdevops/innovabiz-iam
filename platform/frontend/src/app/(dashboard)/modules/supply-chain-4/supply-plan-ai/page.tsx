...
/* ═══ Supply Chain 4.0 — Supply Plan Ai ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "4386", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "277", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2822", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "359388497", cells: ["SUP-1497", "Supply Plan Ai Item 1", "14/6/2026", "€38 597"], status: "active" as const },
    { id: "359392068", cells: ["SUP-5068", "Supply Plan Ai Item 2", "1/1/2026", "€42 168"], status: "pending" as const },
    { id: "359395639", cells: ["SUP-8639", "Supply Plan Ai Item 3", "16/8/2026", "€45 739"], status: "completed" as const },
    { id: "359399210", cells: ["SUP-3210", "Supply Plan Ai Item 4", "3/3/2026", "€49 310"], status: "warning" as const },
    { id: "359402781", cells: ["SUP-6781", "Supply Plan Ai Item 5", "18/10/2026", "€2881"], status: "active" as const },
];
...
export default function SupplyChain40SupplyPlanAiPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Supply Plan Ai</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Supply Chain 4.0 • Supply Plan Ai</p>
                    </div>
                </div>
