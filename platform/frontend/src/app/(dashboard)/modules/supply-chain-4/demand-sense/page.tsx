...
/* ═══ Supply Chain 4.0 — Demand Sense ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "3023", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "328", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1562", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2125360836", cells: ["SUP-2836", "Demand Sense Item 1", "5/1/2026", "€10 936"], status: "active" as const },
    { id: "2125364407", cells: ["SUP-6407", "Demand Sense Item 2", "20/8/2026", "€14 507"], status: "pending" as const },
    { id: "2125367978", cells: ["SUP-9978", "Demand Sense Item 3", "7/3/2026", "€18 078"], status: "completed" as const },
    { id: "2125371549", cells: ["SUP-4549", "Demand Sense Item 4", "22/10/2026", "€21 649"], status: "warning" as const },
    { id: "2125375120", cells: ["SUP-8120", "Demand Sense Item 5", "9/5/2026", "€25 220"], status: "active" as const },
];
...
export default function SupplyChain40DemandSensePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Demand Sense</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Supply Chain 4.0 • Demand Sense</p>
                    </div>
                </div>
