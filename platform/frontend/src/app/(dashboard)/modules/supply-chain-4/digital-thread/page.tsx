...
/* ═══ Supply Chain 4.0 — Digital Thread ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "2804", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "111", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2782", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "758544331", cells: ["SUP-7331", "Digital Thread Item 1", "28/8/2026", "€44 431"], status: "active" as const },
    { id: "758547902", cells: ["SUP-1902", "Digital Thread Item 2", "15/3/2026", "€48 002"], status: "pending" as const },
    { id: "758551473", cells: ["SUP-5473", "Digital Thread Item 3", "2/10/2026", "€1573"], status: "completed" as const },
    { id: "758555044", cells: ["SUP-9044", "Digital Thread Item 4", "17/5/2026", "€5144"], status: "warning" as const },
    { id: "758558615", cells: ["SUP-3615", "Digital Thread Item 5", "4/12/2026", "€8715"], status: "active" as const },
];
...
export default function SupplyChain40DigitalThreadPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Digital Thread</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Supply Chain 4.0 • Digital Thread</p>
                    </div>
                </div>
