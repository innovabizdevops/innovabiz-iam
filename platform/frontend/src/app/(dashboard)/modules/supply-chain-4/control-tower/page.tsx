...
/* ═══ Supply Chain 4.0 — Control Tower ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "4344", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "481", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2630", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "506975485", cells: ["SUP-6485", "Control Tower Item 1", "10/2/2026", "€25 585"], status: "active" as const },
    { id: "506979056", cells: ["SUP-1056", "Control Tower Item 2", "25/9/2026", "€29 156"], status: "pending" as const },
    { id: "506982627", cells: ["SUP-4627", "Control Tower Item 3", "12/4/2026", "€32 727"], status: "completed" as const },
    { id: "506986198", cells: ["SUP-8198", "Control Tower Item 4", "27/11/2026", "€36 298"], status: "warning" as const },
    { id: "506989769", cells: ["SUP-2769", "Control Tower Item 5", "14/6/2026", "€39 869"], status: "active" as const },
];
...
export default function SupplyChain40ControlTowerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Control Tower</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Supply Chain 4.0 • Control Tower</p>
                    </div>
                </div>
