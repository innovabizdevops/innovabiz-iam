...
/* ═══ Supply Chain 4.0 — Resilience Hub ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "640", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "349", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3602", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "793817609", cells: ["SUP-9609", "Resilience Hub Item 1", "26/6/2026", "€17 709"], status: "active" as const },
    { id: "793821180", cells: ["SUP-4180", "Resilience Hub Item 2", "13/1/2026", "€21 280"], status: "pending" as const },
    { id: "793824751", cells: ["SUP-7751", "Resilience Hub Item 3", "28/8/2026", "€24 851"], status: "completed" as const },
    { id: "793828322", cells: ["SUP-2322", "Resilience Hub Item 4", "15/3/2026", "€28 422"], status: "warning" as const },
    { id: "793831893", cells: ["SUP-5893", "Resilience Hub Item 5", "2/10/2026", "€31 993"], status: "active" as const },
];
...
export default function SupplyChain40ResilienceHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Resilience Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Supply Chain 4.0 • Resilience Hub</p>
                    </div>
                </div>
