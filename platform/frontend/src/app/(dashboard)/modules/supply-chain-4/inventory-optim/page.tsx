...
/* ═══ Supply Chain 4.0 — Inventory Optim ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "3691", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "292", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "17", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "89%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1534256272", cells: ["SUP-9272", "Inventory Optim Item 1", "25/5/2026", "€6372"], status: "active" as const },
    { id: "1534259843", cells: ["SUP-3843", "Inventory Optim Item 2", "12/12/2026", "€9943"], status: "pending" as const },
    { id: "1534263414", cells: ["SUP-7414", "Inventory Optim Item 3", "27/7/2026", "€13 514"], status: "completed" as const },
    { id: "1534266985", cells: ["SUP-1985", "Inventory Optim Item 4", "14/2/2026", "€17 085"], status: "warning" as const },
    { id: "1534270556", cells: ["SUP-5556", "Inventory Optim Item 5", "1/9/2026", "€20 656"], status: "active" as const },
];
...
export default function SupplyChain40InventoryOptimPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Inventory Optim</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Supply Chain 4.0 • Inventory Optim</p>
                    </div>
                </div>
