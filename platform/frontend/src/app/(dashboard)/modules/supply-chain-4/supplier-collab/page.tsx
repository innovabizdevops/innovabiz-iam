...
/* ═══ Supply Chain 4.0 — Supplier Collab ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "585", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "418", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1704", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "779611742", cells: ["SUP-5742", "Supplier Collab Item 1", "15/3/2026", "€11 842"], status: "active" as const },
    { id: "779615313", cells: ["SUP-9313", "Supplier Collab Item 2", "2/10/2026", "€15 413"], status: "pending" as const },
    { id: "779618884", cells: ["SUP-3884", "Supplier Collab Item 3", "17/5/2026", "€18 984"], status: "completed" as const },
    { id: "779622455", cells: ["SUP-7455", "Supplier Collab Item 4", "4/12/2026", "€22 555"], status: "warning" as const },
    { id: "779626026", cells: ["SUP-2026", "Supplier Collab Item 5", "19/7/2026", "€26 126"], status: "active" as const },
];
...
export default function SupplyChain40SupplierCollabPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Supplier Collab</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Supply Chain 4.0 • Supplier Collab</p>
                    </div>
                </div>
