...
/* ═══ Supply Chain 4.0 — Nearshore Mgmt ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "1577", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "227", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1600", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1429917151", cells: ["SUP-7151", "Nearshore Mgmt Item 1", "20/8/2026", "€17 251"], status: "active" as const },
    { id: "1429920722", cells: ["SUP-1722", "Nearshore Mgmt Item 2", "7/3/2026", "€20 822"], status: "pending" as const },
    { id: "1429924293", cells: ["SUP-5293", "Nearshore Mgmt Item 3", "22/10/2026", "€24 393"], status: "completed" as const },
    { id: "1429927864", cells: ["SUP-8864", "Nearshore Mgmt Item 4", "9/5/2026", "€27 964"], status: "warning" as const },
    { id: "1429931435", cells: ["SUP-3435", "Nearshore Mgmt Item 5", "24/12/2026", "€31 535"], status: "active" as const },
];
...
export default function SupplyChain40NearshoreMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Nearshore Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Supply Chain 4.0 • Nearshore Mgmt</p>
                    </div>
                </div>
