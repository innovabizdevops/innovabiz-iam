...
const KPIS = [{"l":"Configurações","v":"1.864","t":"-3.5%","d":"down"},{"l":"Últimas Alterações","v":"2.979","t":"-2.6%","d":"down"},{"l":"Ambientes","v":"8.628","t":"+0.3%","d":"up"},{"l":"Versão Config","v":"336","t":"+14.4%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 4042.65","8.130","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 30641.75","6.169","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 45243.54","1.479","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 2626.43","9.084","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 43949.97","8.811","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":914},{"label":"Mar","value":541},{"label":"Abr","value":731},{"label":"Mai","value":702},{"label":"Jun","value":763},{"label":"Jul","value":889},{"label":"Ago","value":558},{"label":"Set","value":529},{"label":"Out","value":847},{"label":"Nov","value":899},{"label":"Dez","value":549}];
const MX = 914;
