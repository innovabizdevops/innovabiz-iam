...
const ACCENT = "#78350f";
const MODULE = "Cookie Consent";
const PAGE = "Banner Builder";
const KPIS = [{"l":"Total Cookie Consent","v":"2.065","t":"+18.0%","d":"up"},{"l":"Banner Builder Ativos","v":"5.764","t":"+1.5%","d":"up"},{"l":"Eficiência (%)","v":"73.5%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"57","t":"+2.2%","d":"up"}];
const COLS = ["ID","Banner Builder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cookie Consent #001","Cookie Consent #002","4.941","6.648","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Cookie Consent #002","Cookie Consent #003","535","303","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Cookie Consent #003","Cookie Consent #004","5.433","6.502","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Cookie Consent #004","Cookie Consent #005","7.279","2.577","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cookie Consent #005","Cookie Consent #001","1.038","2.292","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":858},{"label":"Fev","value":690},{"label":"Mar","value":843},{"label":"Abr","value":892},{"label":"Mai","value":853},{"label":"Jun","value":880},{"label":"Jul","value":731},{"label":"Ago","value":874},{"label":"Set","value":647},{"label":"Out","value":772},{"label":"Nov","value":708},{"label":"Dez","value":782}];
const MX = 892;
