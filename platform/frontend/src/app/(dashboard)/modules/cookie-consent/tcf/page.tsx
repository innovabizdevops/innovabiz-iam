...
const PAGE = "TCF v2.2";
const KPIS = [{"l":"Total Cookie Consent","v":"8.641","t":"+4.1%","d":"up"},{"l":"TCF V2.2 Ativos","v":"6.299","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"71.1%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"77","t":"+5.3%","d":"up"}];
const COLS = ["ID","TCF V2.2","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cookie Consent #001","Cookie Consent #002","3.997","6.279","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Cookie Consent #002","Cookie Consent #003","8.258","2.172","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Cookie Consent #003","Cookie Consent #004","3.450","8.331","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Cookie Consent #004","Cookie Consent #005","1.261","5.319","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cookie Consent #005","Cookie Consent #001","5.237","3.110","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":449},{"label":"Fev","value":464},{"label":"Mar","value":479},{"label":"Abr","value":451},{"label":"Mai","value":815},{"label":"Jun","value":539},{"label":"Jul","value":737},{"label":"Ago","value":554},{"label":"Set","value":665},{"label":"Out","value":567},{"label":"Nov","value":540},{"label":"Dez","value":601}];
const MX = 815;
