...
const PAGE = "Scan &amp; Classify";
const KPIS = [{"l":"Total Cookie Consent","v":"860","t":"+4.6%","d":"up"},{"l":"Scan & Classify Ativos","v":"655","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"82.9%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"69","t":"+5.3%","d":"up"}];
const COLS = ["ID","Scan & Classify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cookie Consent #001","Cookie Consent #002","3.960","6.850","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Cookie Consent #002","Cookie Consent #003","1.700","2.549","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Cookie Consent #003","Cookie Consent #004","3.587","1.362","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Cookie Consent #004","Cookie Consent #005","1.497","278","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cookie Consent #005","Cookie Consent #001","3.676","1.513","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":393},{"label":"Fev","value":458},{"label":"Mar","value":289},{"label":"Abr","value":666},{"label":"Mai","value":457},{"label":"Jun","value":409},{"label":"Jul","value":403},{"label":"Ago","value":349},{"label":"Set","value":659},{"label":"Out","value":292},{"label":"Nov","value":446},{"label":"Dez","value":430}];
const MX = 666;
