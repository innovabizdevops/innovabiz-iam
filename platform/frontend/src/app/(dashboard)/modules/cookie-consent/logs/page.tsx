...
const PAGE = "Consent Logs";
const KPIS = [{"l":"Total Cookie Consent","v":"4.671","t":"+2.6%","d":"up"},{"l":"Consent Logs Ativos","v":"5.032","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"90.5%","t":"+2.5%","d":"up"},{"l":"Score Performance","v":"81","t":"+5.7%","d":"up"}];
const COLS = ["ID","Consent Logs","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cookie Consent #001","Cookie Consent #002","7.761","2.910","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Cookie Consent #002","Cookie Consent #003","2.302","8.251","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Cookie Consent #003","Cookie Consent #004","984","4.600","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Cookie Consent #004","Cookie Consent #005","1.744","6.652","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cookie Consent #005","Cookie Consent #001","878","9.035","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":471},{"label":"Mar","value":704},{"label":"Abr","value":751},{"label":"Mai","value":593},{"label":"Jun","value":603},{"label":"Jul","value":729},{"label":"Ago","value":572},{"label":"Set","value":711},{"label":"Out","value":782},{"label":"Nov","value":494},{"label":"Dez","value":509}];
const MX = 782;
