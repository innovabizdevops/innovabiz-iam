...
const PAGE = "Access";
const KPIS = [{"l":"Total Archive Mgmt","v":"1.321","t":"+1.8%","d":"up"},{"l":"Access Ativos","v":"7.961","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"72.3%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"59","t":"+14.4%","d":"up"}];
const COLS = ["ID","Access","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Archive Mgmt #001","Archive Mgmt #002","6.653","6.683","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Archive Mgmt #002","Archive Mgmt #003","2.756","885","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Archive Mgmt #003","Archive Mgmt #004","5.435","4.343","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Archive Mgmt #004","Archive Mgmt #005","6.106","2.109","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Archive Mgmt #005","Archive Mgmt #001","7.289","828","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":461},{"label":"Mar","value":827},{"label":"Abr","value":634},{"label":"Mai","value":826},{"label":"Jun","value":503},{"label":"Jul","value":702},{"label":"Ago","value":772},{"label":"Set","value":630},{"label":"Out","value":515},{"label":"Nov","value":838},{"label":"Dez","value":695}];
const MX = 838;
