...
const KPIS = [{"l":"Total Archive Mgmt","v":"8.559","t":"-2.8%","d":"down"},{"l":"Acquisition Ativos","v":"5.848","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"93.2%","t":"+4.6%","d":"up"},{"l":"Score Performance","v":"74","t":"+5.4%","d":"up"}];
const COLS = ["ID","Acquisition","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Archive Mgmt #001","Archive Mgmt #002","3.591","8.060","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Archive Mgmt #002","Archive Mgmt #003","5.523","7.538","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Archive Mgmt #003","Archive Mgmt #004","2.794","3.742","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Archive Mgmt #004","Archive Mgmt #005","3.044","1.517","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Archive Mgmt #005","Archive Mgmt #001","6.582","1.668","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":846},{"label":"Fev","value":821},{"label":"Mar","value":703},{"label":"Abr","value":564},{"label":"Mai","value":629},{"label":"Jun","value":899},{"label":"Jul","value":766},{"label":"Ago","value":682},{"label":"Set","value":757},{"label":"Out","value":608},{"label":"Nov","value":884},{"label":"Dez","value":776}];
const MX = 899;
