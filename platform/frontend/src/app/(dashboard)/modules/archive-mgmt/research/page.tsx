...
const ACCENT = "#db2777";
const MODULE = "Archive Management";
const PAGE = "Research";
const KPIS = [{"l":"Ideias Submetidas","v":"3.201","t":"+4.1%","d":"up"},{"l":"Patentes (YTD)","v":"7.130","t":"+10.1%","d":"up"},{"l":"Projetos Innovation Lab","v":"611","t":"+9.0%","d":"up"},{"l":"Budget I&D (€M)","v":"€27.4M","t":"+10.7%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","966","86.7%","4.755","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","4.119","75.1%","7.661","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","3.677","86.4%","4.054","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","650","82.8%","2.355","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","3.422","85.2%","2.730","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":334},{"label":"Mar","value":351},{"label":"Abr","value":413},{"label":"Mai","value":276},{"label":"Jun","value":556},{"label":"Jul","value":341},{"label":"Ago","value":577},{"label":"Set","value":393},{"label":"Out","value":241},{"label":"Nov","value":438},{"label":"Dez","value":348}];
const MX = 577;
