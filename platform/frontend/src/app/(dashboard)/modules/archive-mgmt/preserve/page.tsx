...
const PAGE = "Preserve";
const KPIS = [{"l":"Total Archive Mgmt","v":"4.534","t":"+12.4%","d":"up"},{"l":"Preserve Ativos","v":"5.501","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"91.9%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"60","t":"+13.2%","d":"up"}];
const COLS = ["ID","Preserve","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Archive Mgmt #001","Archive Mgmt #002","4.229","2.376","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Archive Mgmt #002","Archive Mgmt #003","5.258","4.803","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Archive Mgmt #003","Archive Mgmt #004","2.648","8.908","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Archive Mgmt #004","Archive Mgmt #005","7.712","3.004","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Archive Mgmt #005","Archive Mgmt #001","8.667","9.026","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":488},{"label":"Fev","value":267},{"label":"Mar","value":278},{"label":"Abr","value":476},{"label":"Mai","value":572},{"label":"Jun","value":398},{"label":"Jul","value":483},{"label":"Ago","value":553},{"label":"Set","value":249},{"label":"Out","value":502},{"label":"Nov","value":309},{"label":"Dez","value":479}];
const MX = 572;
