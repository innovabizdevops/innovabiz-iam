...
const KPIS = [
    { label: "Total Registos", value: "8651", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3841", trend: "-21%", trendDirection: "down" as const, icon: Users },
...
const TABLE_ROWS = [
    { id: "1478999251", cells: ["ARC-3251", "Archive Management Item 1", "24/8/2026", "€49 351"], status: "active" as const },
    { id: "1479002822", cells: ["ARC-6822", "Archive Management Item 2", "11/3/2026", "€2922"], status: "pending" as const },
    { id: "1479006393", cells: ["ARC-1393", "Archive Management Item 3", "26/10/2026", "€6493"], status: "completed" as const },
    { id: "1479009964", cells: ["ARC-4964", "Archive Management Item 4", "13/5/2026", "€10 064"], status: "warning" as const },
    { id: "1479013535", cells: ["ARC-8535", "Archive Management Item 5", "28/12/2026", "€13 635"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Archive Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Archive Management</p>
                    </div>
                </div>
