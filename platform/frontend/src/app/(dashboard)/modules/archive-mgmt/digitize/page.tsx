...
const PAGE = "Digitize";
const KPIS = [{"l":"Total Archive Mgmt","v":"672","t":"+1.3%","d":"up"},{"l":"Digitize Ativos","v":"3.636","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"88.8%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"66","t":"+6.2%","d":"up"}];
const COLS = ["ID","Digitize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Archive Mgmt #001","Archive Mgmt #002","5.881","113","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Archive Mgmt #002","Archive Mgmt #003","3.324","3.403","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Archive Mgmt #003","Archive Mgmt #004","2.421","5.604","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Archive Mgmt #004","Archive Mgmt #005","1.528","2.001","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Archive Mgmt #005","Archive Mgmt #001","8.492","7.573","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":338},{"label":"Fev","value":369},{"label":"Mar","value":651},{"label":"Abr","value":672},{"label":"Mai","value":428},{"label":"Jun","value":514},{"label":"Jul","value":502},{"label":"Ago","value":617},{"label":"Set","value":343},{"label":"Out","value":525},{"label":"Nov","value":372},{"label":"Dez","value":667}];
const MX = 672;
