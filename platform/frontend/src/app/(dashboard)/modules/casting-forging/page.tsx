...
export default function CastingForgingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Casting Forging</h1><p className="text-sm text-muted-foreground">Casting Forging • iBOS Enterprise</p></div>
