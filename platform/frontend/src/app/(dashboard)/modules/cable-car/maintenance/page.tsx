...
const ACCENT = "#6366f1";
const MODULE = "Cable Car & Gondola";
const PAGE = "Maintenance";
const KPIS = [{"l":"Total Cable Car","v":"1.077","t":"-4.8%","d":"down"},{"l":"Maintenance Ativos","v":"3.455","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"74.1%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"57","t":"+13.7%","d":"up"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cable Car #001","Cable Car #002","3.385","5.577","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Cable Car #002","Cable Car #003","3.184","7.133","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Cable Car #003","Cable Car #004","7.278","1.256","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Cable Car #004","Cable Car #005","140","6.402","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cable Car #005","Cable Car #001","8.257","8.538","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":806},{"label":"Fev","value":526},{"label":"Mar","value":518},{"label":"Abr","value":604},{"label":"Mai","value":597},{"label":"Jun","value":556},{"label":"Jul","value":550},{"label":"Ago","value":523},{"label":"Set","value":451},{"label":"Out","value":709},{"label":"Nov","value":473},{"label":"Dez","value":680}];
const MX = 806;
