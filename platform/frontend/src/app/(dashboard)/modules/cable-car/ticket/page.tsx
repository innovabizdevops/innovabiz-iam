...
const PAGE = "Ticket";
const KPIS = [{"l":"Tickets Abertos","v":"7.971","t":"+4.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"82.1%","t":"+2.7%","d":"up"},{"l":"MTTR (h)","v":"189h","t":"+6.2%","d":"up"},{"l":"Satisfação (%)","v":"70.4%","t":"+6.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.585","7.869","5.654","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.745","6.087","2.884","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.103","2.096","6.544","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","188","1.372","6.587","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.160","3.402","6.306","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":679},{"label":"Mar","value":617},{"label":"Abr","value":803},{"label":"Mai","value":799},{"label":"Jun","value":924},{"label":"Jul","value":945},{"label":"Ago","value":956},{"label":"Set","value":580},{"label":"Out","value":686},{"label":"Nov","value":701},{"label":"Dez","value":837}];
const MX = 956;
