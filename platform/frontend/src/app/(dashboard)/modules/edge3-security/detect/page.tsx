...
const ACCENT = "#0f766e";
const MODULE = "EDGE3 Edge Security";
const PAGE = "Detect";
const KPIS = [{"l":"Total Edge3 Security","v":"148","t":"+11.5%","d":"up"},{"l":"Detect Ativos","v":"6.289","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"65.2%","t":"+0.0%","d":"up"},{"l":"Score Performance","v":"66","t":"-1.0%","d":"down"}];
const COLS = ["ID","Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Edge3 Security #001","Edge3 Security #002","3.212","6.469","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Edge3 Security #002","Edge3 Security #003","6.395","1.662","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Edge3 Security #003","Edge3 Security #004","566","238","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Edge3 Security #004","Edge3 Security #005","658","8.210","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Edge3 Security #005","Edge3 Security #001","734","115","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":482},{"label":"Fev","value":814},{"label":"Mar","value":737},{"label":"Abr","value":667},{"label":"Mai","value":614},{"label":"Jun","value":741},{"label":"Jul","value":733},{"label":"Ago","value":474},{"label":"Set","value":776},{"label":"Out","value":701},{"label":"Nov","value":752},{"label":"Dez","value":729}];
const MX = 814;
