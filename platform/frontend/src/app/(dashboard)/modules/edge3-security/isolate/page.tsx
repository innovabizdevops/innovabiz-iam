...
const PAGE = "Isolate";
const KPIS = [{"l":"Auditorias Realizadas","v":"392","t":"-3.6%","d":"down"},{"l":"NC Abertas","v":"589","t":"-5.2%","d":"down"},{"l":"Conformidade (%)","v":"68.9%","t":"-3.2%","d":"down"},{"l":"CAPAs Pendentes","v":"5.147","t":"+1.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","265","92.9%","7.938","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.548","75.7%","2.444","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.829","98.7%","8.299","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.025","98.0%","1.536","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.959","75.8%","993","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":646},{"label":"Mar","value":829},{"label":"Abr","value":784},{"label":"Mai","value":788},{"label":"Jun","value":841},{"label":"Jul","value":1000},{"label":"Ago","value":704},{"label":"Set","value":712},{"label":"Out","value":760},{"label":"Nov","value":960},{"label":"Dez","value":681}];
const MX = 1000;
