...
/* ═══ EDGE3 Edge Security — Dashboard ═══ */

const ACCENT = "#0f766e";

const KPIS = [
    { label: "Total Registos", value: "3270", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4676", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€78K", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1466866370", cells: ["EDG-2370", "EDGE3 Edge Security Item 1", "19/3/2026", "€16 470"], status: "active" as const },
    { id: "1466869941", cells: ["EDG-5941", "EDGE3 Edge Security Item 2", "6/10/2026", "€20 041"], status: "pending" as const },
    { id: "1466873512", cells: ["EDG-9512", "EDGE3 Edge Security Item 3", "21/5/2026", "€23 612"], status: "completed" as const },
    { id: "1466877083", cells: ["EDG-4083", "EDGE3 Edge Security Item 4", "8/12/2026", "€27 183"], status: "warning" as const },
    { id: "1466880654", cells: ["EDG-7654", "EDGE3 Edge Security Item 5", "23/7/2026", "€30 754"], status: "active" as const },
];
...
export default function Edge3EdgeSecurityPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EDGE3 Edge Security</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EDGE3 Edge Security</p>
                    </div>
                </div>
