...
const ACCENT = "#14532d";
const MODULE = "Cannabis Delivery";
const PAGE = "Age Verify";
const KPIS = [{"l":"Total Cannabis Delivery","v":"4.325","t":"+4.8%","d":"up"},{"l":"Age Verify Ativos","v":"3.284","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"90.3%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"80","t":"+14.3%","d":"up"}];
const COLS = ["ID","Age Verify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Delivery #001","Cannabis Delivery #002","2.715","470","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Delivery #002","Cannabis Delivery #003","3.097","7.301","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Delivery #003","Cannabis Delivery #004","2.669","3.590","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Delivery #004","Cannabis Delivery #005","2.739","4.092","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Delivery #005","Cannabis Delivery #001","5.260","8.408","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":765},{"label":"Mar","value":614},{"label":"Abr","value":530},{"label":"Mai","value":807},{"label":"Jun","value":737},{"label":"Jul","value":588},{"label":"Ago","value":885},{"label":"Set","value":687},{"label":"Out","value":777},{"label":"Nov","value":564},{"label":"Dez","value":539}];
const MX = 885;
