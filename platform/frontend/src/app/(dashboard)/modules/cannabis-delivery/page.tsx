...
/* ═══ Cannabis Delivery — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "1325", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2904", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€408K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1139946625", cells: ["CAN-7625", "Cannabis Delivery Item 1", "14/2/2026", "€46 725"], status: "active" as const },
    { id: "1139950196", cells: ["CAN-2196", "Cannabis Delivery Item 2", "1/9/2026", "€296"], status: "pending" as const },
    { id: "1139953767", cells: ["CAN-5767", "Cannabis Delivery Item 3", "16/4/2026", "€3867"], status: "completed" as const },
    { id: "1139957338", cells: ["CAN-9338", "Cannabis Delivery Item 4", "3/11/2026", "€7438"], status: "warning" as const },
    { id: "1139960909", cells: ["CAN-3909", "Cannabis Delivery Item 5", "18/6/2026", "€11 009"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cannabis Delivery</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cannabis Delivery</p>
                    </div>
                </div>
