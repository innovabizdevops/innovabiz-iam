...
const ACCENT = "#166534";
const MODULE = "Green Finance Platform";
const PAGE = "Impact";
const KPIS = [{"l":"Projetos Sociais","v":"1.515","t":"-1.1%","d":"down"},{"l":"Beneficiários","v":"8.613","t":"+5.2%","d":"up"},{"l":"Investimento CSR (€)","v":"€75727","t":"-3.5%","d":"down"},{"l":"Score Impacto","v":"57","t":"+6.1%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","1.304","€ 29233.21","6.718","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.854","€ 6198.21","8.944","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","7.447","€ 49291.55","7.203","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","2.597","€ 30442.65","8.731","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","859","€ 49464.24","7.366","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":1062},{"label":"Mar","value":778},{"label":"Abr","value":938},{"label":"Mai","value":778},{"label":"Jun","value":887},{"label":"Jul","value":775},{"label":"Ago","value":882},{"label":"Set","value":969},{"label":"Out","value":851},{"label":"Nov","value":700},{"label":"Dez","value":946}];
const MX = 1062;
