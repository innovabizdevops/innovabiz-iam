...
const PAGE = "Finance";
const KPIS = [{"l":"Total Green Finance","v":"4.812","t":"+0.8%","d":"up"},{"l":"Finance Ativos","v":"8.465","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"90.2%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"70","t":"+10.2%","d":"up"}];
const COLS = ["ID","Finance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Green Finance #001","Green Finance #002","7.279","7.900","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Green Finance #002","Green Finance #003","2.421","7.100","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Green Finance #003","Green Finance #004","3.526","1.799","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Green Finance #004","Green Finance #005","6.571","2.473","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Green Finance #005","Green Finance #001","4.790","6.516","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":352},{"label":"Fev","value":360},{"label":"Mar","value":591},{"label":"Abr","value":584},{"label":"Mai","value":524},{"label":"Jun","value":497},{"label":"Jul","value":319},{"label":"Ago","value":504},{"label":"Set","value":546},{"label":"Out","value":348},{"label":"Nov","value":452},{"label":"Dez","value":528}];
const MX = 591;
