...
const PAGE = "Taxonomy";
const KPIS = [{"l":"Total Green Finance","v":"7.149","t":"+9.9%","d":"up"},{"l":"Taxonomy Ativos","v":"1.217","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"89.3%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"92","t":"+15.4%","d":"up"}];
const COLS = ["ID","Taxonomy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Green Finance #001","Green Finance #002","4.749","3.442","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Green Finance #002","Green Finance #003","8.262","530","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Green Finance #003","Green Finance #004","5.214","8.079","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Green Finance #004","Green Finance #005","3.982","726","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Green Finance #005","Green Finance #001","1.947","908","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":362},{"label":"Fev","value":391},{"label":"Mar","value":590},{"label":"Abr","value":372},{"label":"Mai","value":609},{"label":"Jun","value":357},{"label":"Jul","value":514},{"label":"Ago","value":693},{"label":"Set","value":304},{"label":"Out","value":460},{"label":"Nov","value":452},{"label":"Dez","value":326}];
const MX = 693;
