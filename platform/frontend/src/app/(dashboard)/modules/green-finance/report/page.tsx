...
const PAGE = "Report";
const KPIS = [{"l":"Total Green Finance","v":"2.342","t":"+2.6%","d":"up"},{"l":"Report Ativos","v":"171","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"82.0%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"82","t":"+3.8%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Green Finance #001","Green Finance #002","3.073","6.575","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Green Finance #002","Green Finance #003","177","8.866","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Green Finance #003","Green Finance #004","3.131","5.134","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Green Finance #004","Green Finance #005","1.032","2.113","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Green Finance #005","Green Finance #001","2.176","3.502","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1024},{"label":"Fev","value":993},{"label":"Mar","value":1030},{"label":"Abr","value":1008},{"label":"Mai","value":890},{"label":"Jun","value":1063},{"label":"Jul","value":932},{"label":"Ago","value":716},{"label":"Set","value":1094},{"label":"Out","value":1062},{"label":"Nov","value":834},{"label":"Dez","value":841}];
const MX = 1094;
