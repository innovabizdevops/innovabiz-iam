...
/* ═══ Green Finance Platform — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "3619", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2122", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€450K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "-2%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1099081719", cells: ["GRE-2719", "Green Finance Platform Item 1", "16/4/2026", "€31 819"], status: "active" as const },
    { id: "1099085290", cells: ["GRE-6290", "Green Finance Platform Item 2", "3/11/2026", "€35 390"], status: "pending" as const },
    { id: "1099088861", cells: ["GRE-9861", "Green Finance Platform Item 3", "18/6/2026", "€38 961"], status: "completed" as const },
    { id: "1099092432", cells: ["GRE-4432", "Green Finance Platform Item 4", "5/1/2026", "€42 532"], status: "warning" as const },
    { id: "1099096003", cells: ["GRE-8003", "Green Finance Platform Item 5", "20/8/2026", "€46 103"], status: "active" as const },
];
...
export default function GreenFinancePlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Green Finance Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Green Finance Platform</p>
                    </div>
                </div>
