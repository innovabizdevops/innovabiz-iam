...
const PAGE = "BEO";
const KPIS = [{"l":"Quartos Ocupados","v":"8.377","t":"+12.8%","d":"up"},{"l":"RevPAR (€)","v":"€4399","t":"+6.8%","d":"up"},{"l":"Ocupação (%)","v":"69.5%","t":"+7.9%","d":"up"},{"l":"Guest Satisfaction","v":"7.599","t":"+4.7%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.494","2026-02-18","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.954","2026-01-10","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.966","2026-02-03","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.480","2026-02-02","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.828","2026-01-16","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":476},{"label":"Fev","value":597},{"label":"Mar","value":444},{"label":"Abr","value":384},{"label":"Mai","value":645},{"label":"Jun","value":491},{"label":"Jul","value":687},{"label":"Ago","value":330},{"label":"Set","value":290},{"label":"Out","value":531},{"label":"Nov","value":320},{"label":"Dez","value":313}];
const MX = 687;
