...
const ACCENT = "#6366f1";
const MODULE = "Hotel Events & Banquet";
const PAGE = "Inquiry";
const KPIS = [{"l":"Quartos Ocupados","v":"7.377","t":"-1.3%","d":"down"},{"l":"RevPAR (€)","v":"€25906","t":"+12.7%","d":"up"},{"l":"Ocupação (%)","v":"72.2%","t":"-0.2%","d":"down"},{"l":"Guest Satisfaction","v":"6.235","t":"-0.4%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.435","2026-01-15","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.537","2026-03-01","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.841","2026-03-21","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","2.134","2026-03-04","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.122","2026-01-11","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":927},{"label":"Fev","value":1027},{"label":"Mar","value":692},{"label":"Abr","value":777},{"label":"Mai","value":660},{"label":"Jun","value":993},{"label":"Jul","value":767},{"label":"Ago","value":702},{"label":"Set","value":956},{"label":"Out","value":870},{"label":"Nov","value":841},{"label":"Dez","value":818}];
const MX = 1027;
