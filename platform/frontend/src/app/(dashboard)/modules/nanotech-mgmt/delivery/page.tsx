...
const PAGE = "Drug Delivery";
const KPIS = [{"l":"Total Nanotech Mgmt","v":"8.858","t":"-5.1%","d":"down"},{"l":"Drug Delivery Ativos","v":"3.630","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"78.9%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"63","t":"-1.9%","d":"down"}];
const COLS = ["ID","Drug Delivery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nanotech Mgmt #001","Nanotech Mgmt #002","4.743","7.050","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Nanotech Mgmt #002","Nanotech Mgmt #003","2.678","8.244","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Nanotech Mgmt #003","Nanotech Mgmt #004","8.699","3.089","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Nanotech Mgmt #004","Nanotech Mgmt #005","3.687","5.955","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nanotech Mgmt #005","Nanotech Mgmt #001","1.205","3.886","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":474},{"label":"Fev","value":604},{"label":"Mar","value":666},{"label":"Abr","value":590},{"label":"Mai","value":809},{"label":"Jun","value":535},{"label":"Jul","value":858},{"label":"Ago","value":504},{"label":"Set","value":658},{"label":"Out","value":507},{"label":"Nov","value":822},{"label":"Dez","value":545}];
const MX = 858;
