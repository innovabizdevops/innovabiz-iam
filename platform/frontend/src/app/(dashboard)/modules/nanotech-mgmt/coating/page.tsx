...
const PAGE = "Coating";
const KPIS = [{"l":"Total Nanotech Mgmt","v":"2.722","t":"+1.1%","d":"up"},{"l":"Coating Ativos","v":"7.402","t":"+4.0%","d":"up"},{"l":"Eficiência (%)","v":"76.7%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"75","t":"-0.9%","d":"down"}];
const COLS = ["ID","Coating","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nanotech Mgmt #001","Nanotech Mgmt #002","7.271","5.513","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Nanotech Mgmt #002","Nanotech Mgmt #003","2.442","4.352","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Nanotech Mgmt #003","Nanotech Mgmt #004","7.758","5.339","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Nanotech Mgmt #004","Nanotech Mgmt #005","5.325","5.502","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nanotech Mgmt #005","Nanotech Mgmt #001","6.578","4.920","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":729},{"label":"Mar","value":907},{"label":"Abr","value":635},{"label":"Mai","value":753},{"label":"Jun","value":894},{"label":"Jul","value":536},{"label":"Ago","value":594},{"label":"Set","value":700},{"label":"Out","value":599},{"label":"Nov","value":628},{"label":"Dez","value":623}];
const MX = 907;
