...
const PAGE = "EHS Nano";
const KPIS = [{"l":"Incidentes (YTD)","v":"385","t":"-2.6%","d":"down"},{"l":"LTIR","v":"768","t":"-4.6%","d":"down"},{"l":"Formações HSE","v":"1.637","t":"+14.8%","d":"up"},{"l":"Inspeções Realizadas","v":"2.430","t":"-4.1%","d":"down"}];
const COLS = ["Incidente","Local","Tipo","Gravidade","Investigador","Estado"];
const ROWS = [{"id":"r0","cells":["EHS-INC-4521","EHS-NM-3214","4.729","3.076","1.141","Ativo"],"status":"active"},{"id":"r1","cells":["EHS-NM-3214","EHS-INSP-7891","4.176","7.910","7.327","Pendente"],"status":"pending"},{"id":"r2","cells":["EHS-INSP-7891","EHS-FORM-1098","3.639","7.767","5.826","Concluído"],"status":"done"},{"id":"r3","cells":["EHS-FORM-1098","EHS-AUD-5623","1.666","2.647","8.282","Em Análise"],"status":"risk"},{"id":"r4","cells":["EHS-AUD-5623","EHS-INC-4521","5.621","4.449","4.490","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":369},{"label":"Fev","value":275},{"label":"Mar","value":235},{"label":"Abr","value":208},{"label":"Mai","value":211},{"label":"Jun","value":268},{"label":"Jul","value":423},{"label":"Ago","value":555},{"label":"Set","value":347},{"label":"Out","value":274},{"label":"Nov","value":312},{"label":"Dez","value":522}];
const MX = 555;
