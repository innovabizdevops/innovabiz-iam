...
const ACCENT = "#4338ca";
const MODULE = "Nanotech Management";
const PAGE = "Characterize";
const KPIS = [{"l":"Total Nanotech Mgmt","v":"2.424","t":"-2.9%","d":"down"},{"l":"Characterize Ativos","v":"1.058","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"83.8%","t":"+15.4%","d":"up"},{"l":"Score Performance","v":"74","t":"+10.8%","d":"up"}];
const COLS = ["ID","Characterize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nanotech Mgmt #001","Nanotech Mgmt #002","8.059","3.189","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Nanotech Mgmt #002","Nanotech Mgmt #003","5.807","8.023","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Nanotech Mgmt #003","Nanotech Mgmt #004","8.406","8.169","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Nanotech Mgmt #004","Nanotech Mgmt #005","4.805","627","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nanotech Mgmt #005","Nanotech Mgmt #001","8.353","2.351","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":758},{"label":"Mar","value":680},{"label":"Abr","value":454},{"label":"Mai","value":823},{"label":"Jun","value":652},{"label":"Jul","value":760},{"label":"Ago","value":578},{"label":"Set","value":736},{"label":"Out","value":491},{"label":"Nov","value":698},{"label":"Dez","value":585}];
const MX = 823;
