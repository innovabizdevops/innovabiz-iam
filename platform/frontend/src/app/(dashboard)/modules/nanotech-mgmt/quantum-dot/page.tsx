...
const PAGE = "Quantum Dot";
const KPIS = [{"l":"Total Nanotech Mgmt","v":"5.349","t":"+4.2%","d":"up"},{"l":"Quantum Dot Ativos","v":"3.173","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"82.2%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"74","t":"+16.5%","d":"up"}];
const COLS = ["ID","Quantum Dot","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nanotech Mgmt #001","Nanotech Mgmt #002","8.528","742","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Nanotech Mgmt #002","Nanotech Mgmt #003","3.525","2.541","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Nanotech Mgmt #003","Nanotech Mgmt #004","1.001","8.682","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Nanotech Mgmt #004","Nanotech Mgmt #005","5.498","771","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nanotech Mgmt #005","Nanotech Mgmt #001","4.550","1.274","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":785},{"label":"Mar","value":688},{"label":"Abr","value":483},{"label":"Mai","value":814},{"label":"Jun","value":502},{"label":"Jul","value":768},{"label":"Ago","value":678},{"label":"Set","value":782},{"label":"Out","value":432},{"label":"Nov","value":636},{"label":"Dez","value":487}];
const MX = 814;
...
export default function QuantumDotPage() {
    return (
