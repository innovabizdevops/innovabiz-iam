...
const PAGE = "Graphene App";
const KPIS = [{"l":"Total Nanotech Mgmt","v":"5.740","t":"+3.4%","d":"up"},{"l":"Graphene App Ativos","v":"290","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"82.5%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"90","t":"-5.6%","d":"down"}];
const COLS = ["ID","Graphene App","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nanotech Mgmt #001","Nanotech Mgmt #002","2.027","5.477","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Nanotech Mgmt #002","Nanotech Mgmt #003","5.248","8.004","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Nanotech Mgmt #003","Nanotech Mgmt #004","4.573","1.869","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Nanotech Mgmt #004","Nanotech Mgmt #005","5.890","8.769","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nanotech Mgmt #005","Nanotech Mgmt #001","7.597","7.043","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":624},{"label":"Mar","value":425},{"label":"Abr","value":642},{"label":"Mai","value":341},{"label":"Jun","value":389},{"label":"Jul","value":401},{"label":"Ago","value":349},{"label":"Set","value":421},{"label":"Out","value":607},{"label":"Nov","value":679},{"label":"Dez","value":457}];
const MX = 679;
