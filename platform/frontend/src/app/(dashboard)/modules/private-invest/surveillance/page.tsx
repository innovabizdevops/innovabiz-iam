...
const ACCENT = "#6366f1";
const MODULE = "Private Investigation";
const PAGE = "Surveillance";
const KPIS = [{"l":"Total Private Invest","v":"1.229","t":"-0.6%","d":"down"},{"l":"Surveillance Ativos","v":"1.237","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"73.5%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"68","t":"-4.3%","d":"down"}];
const COLS = ["ID","Surveillance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Private Invest #001","Private Invest #002","7.375","7.007","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Private Invest #002","Private Invest #003","478","4.236","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Private Invest #003","Private Invest #004","7.104","788","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Private Invest #004","Private Invest #005","6.028","7.181","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Private Invest #005","Private Invest #001","4.300","6.077","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":714},{"label":"Fev","value":647},{"label":"Mar","value":459},{"label":"Abr","value":668},{"label":"Mai","value":737},{"label":"Jun","value":637},{"label":"Jul","value":478},{"label":"Ago","value":467},{"label":"Set","value":700},{"label":"Out","value":508},{"label":"Nov","value":754},{"label":"Dez","value":458}];
const MX = 754;
