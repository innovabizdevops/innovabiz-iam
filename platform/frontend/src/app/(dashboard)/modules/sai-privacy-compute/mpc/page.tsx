...
const PAGE = "MPC";
const KPIS = [{"l":"Total Sai Privacy Compute","v":"2.025","t":"+12.5%","d":"up"},{"l":"MPC Ativos","v":"894","t":"+2.9%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"75","t":"-3.8%","d":"down"}];
const COLS = ["ID","MPC","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sai Privacy Compute #001","Sai Privacy Compute #002","1.465","1.189","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Sai Privacy Compute #002","Sai Privacy Compute #003","2.065","6.539","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Sai Privacy Compute #003","Sai Privacy Compute #004","7.363","464","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Sai Privacy Compute #004","Sai Privacy Compute #005","5.036","4.114","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sai Privacy Compute #005","Sai Privacy Compute #001","2.978","1.284","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":402},{"label":"Fev","value":584},{"label":"Mar","value":263},{"label":"Abr","value":559},{"label":"Mai","value":378},{"label":"Jun","value":430},{"label":"Jul","value":229},{"label":"Ago","value":577},{"label":"Set","value":325},{"label":"Out","value":506},{"label":"Nov","value":380},{"label":"Dez","value":299}];
const MX = 584;
