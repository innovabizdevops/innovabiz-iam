...
const ACCENT = "#991b1b";
const MODULE = "S-AI Privacy Computing";
const PAGE = "Federated";
const KPIS = [{"l":"Total Sai Privacy Compute","v":"2.399","t":"+14.5%","d":"up"},{"l":"Federated Ativos","v":"7.003","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"75.0%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"78","t":"+1.3%","d":"up"}];
const COLS = ["ID","Federated","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sai Privacy Compute #001","Sai Privacy Compute #002","4.459","1.301","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Sai Privacy Compute #002","Sai Privacy Compute #003","1.102","5.372","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Sai Privacy Compute #003","Sai Privacy Compute #004","2.276","782","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Sai Privacy Compute #004","Sai Privacy Compute #005","7.240","2.876","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sai Privacy Compute #005","Sai Privacy Compute #001","3.472","6.450","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":209},{"label":"Fev","value":295},{"label":"Mar","value":604},{"label":"Abr","value":540},{"label":"Mai","value":258},{"label":"Jun","value":603},{"label":"Jul","value":212},{"label":"Ago","value":260},{"label":"Set","value":600},{"label":"Out","value":542},{"label":"Nov","value":234},{"label":"Dez","value":259}];
const MX = 604;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#991b1b'}}>AI</span></h1>
                </div>
