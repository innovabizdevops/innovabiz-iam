...
/* ═══ S-AI Privacy Computing — Dashboard ═══ */

const ACCENT = "#991b1b";

const KPIS = [
    { label: "Total Registos", value: "693", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1350", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€339K", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1208493593", cells: ["SAI-1593", "S-AI Privacy Computing Item 1", "14/6/2026", "€43 693"], status: "active" as const },
    { id: "1208497164", cells: ["SAI-5164", "S-AI Privacy Computing Item 2", "1/1/2026", "€47 264"], status: "pending" as const },
    { id: "1208500735", cells: ["SAI-8735", "S-AI Privacy Computing Item 3", "16/8/2026", "€835"], status: "completed" as const },
    { id: "1208504306", cells: ["SAI-3306", "S-AI Privacy Computing Item 4", "3/3/2026", "€4406"], status: "warning" as const },
    { id: "1208507877", cells: ["SAI-6877", "S-AI Privacy Computing Item 5", "18/10/2026", "€7977"], status: "active" as const },
];
...
export default function SaiPrivacyComputingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">S-AI Privacy Computing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • S-AI Privacy Computing</p>
                    </div>
                </div>
