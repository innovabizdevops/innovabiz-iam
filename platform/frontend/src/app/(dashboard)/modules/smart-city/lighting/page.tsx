...
const PAGE = "Lighting";
const KPIS = [{"l":"Total Smart City","v":"5.930","t":"+15.2%","d":"up"},{"l":"Lighting Ativos","v":"5.579","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"68.8%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"72","t":"+3.1%","d":"up"}];
const COLS = ["ID","Lighting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Smart City #001","Smart City #002","902","1.853","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Smart City #002","Smart City #003","3.113","1.075","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart City #003","Smart City #004","3.604","8.787","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Smart City #004","Smart City #005","1.977","3.718","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Smart City #005","Smart City #001","6.602","2.538","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":660},{"label":"Mar","value":982},{"label":"Abr","value":867},{"label":"Mai","value":651},{"label":"Jun","value":932},{"label":"Jul","value":772},{"label":"Ago","value":977},{"label":"Set","value":850},{"label":"Out","value":712},{"label":"Nov","value":921},{"label":"Dez","value":680}];
const MX = 982;
