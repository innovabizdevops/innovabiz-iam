...
const KPIS = [{"l":"Twins Ativos","v":"8.124","t":"+4.8%","d":"up"},{"l":"Simulações/Dia","v":"3784","t":"-3.0%","d":"down"},{"l":"Precisão Modelo (%)","v":"74.4%","t":"-1.2%","d":"down"},{"l":"Latência Sync (ms)","v":"125ms","t":"+11.6%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","91.9%","2026-02-20","8.092","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","91.7%","2026-02-25","6.159","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","84.0%","2026-02-20","5.181","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","96.7%","2026-03-13","2.380","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","83.1%","2026-03-23","7.651","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":895},{"label":"Fev","value":829},{"label":"Mar","value":609},{"label":"Abr","value":564},{"label":"Mai","value":570},{"label":"Jun","value":895},{"label":"Jul","value":875},{"label":"Ago","value":692},{"label":"Set","value":615},{"label":"Out","value":758},{"label":"Nov","value":606},{"label":"Dez","value":755}];
const MX = 895;
