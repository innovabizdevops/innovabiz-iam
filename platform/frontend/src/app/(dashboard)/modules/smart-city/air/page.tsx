...
const PAGE = "Air Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.766","t":"-1.3%","d":"down"},{"l":"NC Abertas","v":"906","t":"+6.9%","d":"up"},{"l":"Conformidade (%)","v":"90.7%","t":"-2.0%","d":"down"},{"l":"CAPAs Pendentes","v":"4.835","t":"+8.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.325","89.7%","5.516","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.260","96.3%","1.112","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","440","79.9%","7.652","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.095","96.8%","8.791","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","651","95.9%","8.514","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":770},{"label":"Mar","value":982},{"label":"Abr","value":968},{"label":"Mai","value":921},{"label":"Jun","value":1011},{"label":"Jul","value":1009},{"label":"Ago","value":987},{"label":"Set","value":787},{"label":"Out","value":981},{"label":"Nov","value":776},{"label":"Dez","value":1029}];
const MX = 1029;
