...
const PAGE = "Waste Mgmt";
const KPIS = [{"l":"Total Smart City","v":"7.315","t":"+8.1%","d":"up"},{"l":"Waste Mgmt Ativos","v":"2.259","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"77.5%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"56","t":"+16.7%","d":"up"}];
const COLS = ["ID","Waste Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Smart City #001","Smart City #002","8.790","5.440","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Smart City #002","Smart City #003","8.143","1.599","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart City #003","Smart City #004","2.661","5.214","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Smart City #004","Smart City #005","2.681","6.258","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Smart City #005","Smart City #001","8.990","262","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":906},{"label":"Fev","value":704},{"label":"Mar","value":831},{"label":"Abr","value":611},{"label":"Mai","value":855},{"label":"Jun","value":719},{"label":"Jul","value":746},{"label":"Ago","value":874},{"label":"Set","value":567},{"label":"Out","value":825},{"label":"Nov","value":670},{"label":"Dez","value":668}];
const MX = 906;
