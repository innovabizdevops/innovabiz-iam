...
const PAGE = "IoT Dashboard";
const KPIS = [{"l":"Dispositivos Online","v":"8.091","t":"+12.9%","d":"up"},{"l":"Dados/Min (MB)","v":"3.018","t":"+4.1%","d":"up"},{"l":"Alertas Ativos","v":"5.006","t":"-2.5%","d":"down"},{"l":"Uptime (%)","v":"84.4%","t":"+12.2%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.710","4.294","312","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","1.266","8.113","7.472","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.671","3.491","2.598","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","190","8.072","7.339","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.139","2.994","745","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":513},{"label":"Mar","value":661},{"label":"Abr","value":658},{"label":"Mai","value":706},{"label":"Jun","value":657},{"label":"Jul","value":552},{"label":"Ago","value":728},{"label":"Set","value":786},{"label":"Out","value":766},{"label":"Nov","value":770},{"label":"Dez","value":582}];
const MX = 786;
