...
const PAGE = "Explain";
const KPIS = [{"l":"Total Aix Prescriptive","v":"4.060","t":"+15.7%","d":"up"},{"l":"Explain Ativos","v":"7.600","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"88","t":"+9.0%","d":"up"}];
const COLS = ["ID","Explain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aix Prescriptive #001","Aix Prescriptive #002","4.792","7.756","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Aix Prescriptive #002","Aix Prescriptive #003","7.241","3.001","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Aix Prescriptive #003","Aix Prescriptive #004","1.270","7.365","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Aix Prescriptive #004","Aix Prescriptive #005","5.820","405","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aix Prescriptive #005","Aix Prescriptive #001","2.389","1.728","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":800},{"label":"Mar","value":818},{"label":"Abr","value":714},{"label":"Mai","value":587},{"label":"Jun","value":453},{"label":"Jul","value":788},{"label":"Ago","value":436},{"label":"Set","value":510},{"label":"Out","value":604},{"label":"Nov","value":455},{"label":"Dez","value":435}];
const MX = 818;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>XAI</span></h1>
                </div>
