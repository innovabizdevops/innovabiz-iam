...
const PAGE = "Simulate";
const KPIS = [{"l":"Twins Ativos","v":"8.927","t":"+17.7%","d":"up"},{"l":"Simulações/Dia","v":"3225","t":"+13.8%","d":"up"},{"l":"Precisão Modelo (%)","v":"84.1%","t":"+1.6%","d":"up"},{"l":"Latência Sync (ms)","v":"63ms","t":"+13.5%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","92.5%","2026-01-03","2.220","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","92.0%","2026-02-22","1.224","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","72.2%","2026-03-11","7.079","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","97.4%","2026-02-21","1.876","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","88.3%","2026-01-01","7.817","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":492},{"label":"Mar","value":317},{"label":"Abr","value":361},{"label":"Mai","value":594},{"label":"Jun","value":626},{"label":"Jul","value":280},{"label":"Ago","value":491},{"label":"Set","value":271},{"label":"Out","value":604},{"label":"Nov","value":480},{"label":"Dez","value":460}];
const MX = 626;
