...
/* ═══ AIX Prescriptive Intelligence — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "950", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3627", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€230K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1195445650", cells: ["AIX-3650", "AIX Prescriptive Intelligence Item 1", "15/11/2026", "€45 750"], status: "active" as const },
    { id: "1195449221", cells: ["AIX-7221", "AIX Prescriptive Intelligence Item 2", "2/6/2026", "€49 321"], status: "pending" as const },
    { id: "1195452792", cells: ["AIX-1792", "AIX Prescriptive Intelligence Item 3", "17/1/2026", "€2892"], status: "completed" as const },
    { id: "1195456363", cells: ["AIX-5363", "AIX Prescriptive Intelligence Item 4", "4/8/2026", "€6463"], status: "warning" as const },
    { id: "1195459934", cells: ["AIX-8934", "AIX Prescriptive Intelligence Item 5", "19/3/2026", "€10 034"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 70 }, { label: "Fev", value: 79 }, { label: "Mar", value: 88 }, { label: "Abr", value: 97 }, { label: "Mai", value: 26 }, { label: "Jun", value: 35 }];
...
export default function AixPrescriptiveIntelligencePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AIX Prescriptive Intelligence</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AIX Prescriptive Intelligence</p>
                    </div>
                </div>
