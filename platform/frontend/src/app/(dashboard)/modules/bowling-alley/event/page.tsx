...
const ACCENT = "#16a34a";
const MODULE = "Bowling Center";
const PAGE = "Event";
const KPIS = [{"l":"Total Bowling Alley","v":"8.290","t":"+2.1%","d":"up"},{"l":"Event Ativos","v":"5.045","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"91.1%","t":"+12.2%","d":"up"},{"l":"Score Performance","v":"79","t":"-4.6%","d":"down"}];
const COLS = ["ID","Event","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bowling Alley #001","Bowling Alley #002","1.661","1.873","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Bowling Alley #002","Bowling Alley #003","8.123","3.449","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Bowling Alley #003","Bowling Alley #004","7.943","7.443","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Bowling Alley #004","Bowling Alley #005","4.836","6.934","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bowling Alley #005","Bowling Alley #001","1.061","2.481","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":859},{"label":"Mar","value":975},{"label":"Abr","value":892},{"label":"Mai","value":696},{"label":"Jun","value":760},{"label":"Jul","value":971},{"label":"Ago","value":755},{"label":"Set","value":737},{"label":"Out","value":808},{"label":"Nov","value":732},{"label":"Dez","value":907}];
const MX = 975;
