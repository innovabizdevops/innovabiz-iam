...
const PAGE = "League";
const KPIS = [{"l":"Atletas Registados","v":"8.537","t":"+13.8%","d":"up"},{"l":"Treinos/Semana","v":"2314","t":"+2.1%","d":"up"},{"l":"Competições","v":"7.147","t":"+12.1%","d":"up"},{"l":"Performance Score","v":"88","t":"+17.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.001","9.084","7.286","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.428","5.335","4.012","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.226","8.379","1.402","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.298","7.533","7.202","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.643","8.606","1.721","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":834},{"label":"Mar","value":728},{"label":"Abr","value":682},{"label":"Mai","value":881},{"label":"Jun","value":941},{"label":"Jul","value":834},{"label":"Ago","value":937},{"label":"Set","value":1005},{"label":"Out","value":925},{"label":"Nov","value":779},{"label":"Dez","value":728}];
const MX = 1005;
