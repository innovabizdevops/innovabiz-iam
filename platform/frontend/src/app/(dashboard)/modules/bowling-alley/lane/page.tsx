...
const PAGE = "Lane";
const KPIS = [{"l":"Total Bowling Alley","v":"8.882","t":"-2.4%","d":"down"},{"l":"Lane Ativos","v":"5.262","t":"-0.2%","d":"down"},{"l":"Eficiência (%)","v":"83.9%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"62","t":"+7.6%","d":"up"}];
const COLS = ["ID","Lane","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bowling Alley #001","Bowling Alley #002","3.956","1.279","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Bowling Alley #002","Bowling Alley #003","4.761","6.381","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Bowling Alley #003","Bowling Alley #004","1.211","4.275","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Bowling Alley #004","Bowling Alley #005","4.601","5.556","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bowling Alley #005","Bowling Alley #001","5.607","7.200","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":720},{"label":"Mar","value":700},{"label":"Abr","value":697},{"label":"Mai","value":952},{"label":"Jun","value":719},{"label":"Jul","value":846},{"label":"Ago","value":635},{"label":"Set","value":933},{"label":"Out","value":843},{"label":"Nov","value":898},{"label":"Dez","value":927}];
const MX = 952;
