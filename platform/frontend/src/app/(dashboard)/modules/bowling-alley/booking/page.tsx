...
const PAGE = "Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"2.789","t":"+11.8%","d":"up"},{"l":"RevPAR (€)","v":"€75353","t":"-3.4%","d":"down"},{"l":"Ocupação (%)","v":"87.9%","t":"+6.8%","d":"up"},{"l":"Guest Satisfaction","v":"6.745","t":"+3.8%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.354","2026-01-01","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.443","2026-01-13","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","892","2026-03-24","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.079","2026-01-05","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.723","2026-03-22","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":683},{"label":"Mar","value":850},{"label":"Abr","value":581},{"label":"Mai","value":755},{"label":"Jun","value":858},{"label":"Jul","value":776},{"label":"Ago","value":850},{"label":"Set","value":773},{"label":"Out","value":830},{"label":"Nov","value":867},{"label":"Dez","value":667}];
const MX = 867;
