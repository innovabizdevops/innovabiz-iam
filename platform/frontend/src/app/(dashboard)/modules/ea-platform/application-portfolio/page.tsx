...
const KPIS = [{"l":"Capacidades Mapeadas","v":"4,847","d":"+8.2%","u":true},{"l":"Aplicações Portfolio","v":"342","d":"+2.1%","u":true},{"l":"ADRs Registados","v":"247","d":"+12.3%","u":true},{"l":"Debt Técnico (h)","v":"1,247","d":"-5.4%","u":false}];
const COLS = ["Capacidade","Nível","Aplicação","Owner","Maturidade","Estado"];
const ROWS = [
  { id: "001", c: ["Application Portfolio-001", "Application Portfolio Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Application Portfolio-002", "Application Portfolio Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Application Portfolio-003", "Application Portfolio Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Application Portfolio-004", "Application Portfolio Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Application Portfolio-005", "Application Portfolio Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Application Portfolio", ts: "Há 2min", a: "Sistema" },
...
export default function ApplicationPortfolioPage() {
  return (
