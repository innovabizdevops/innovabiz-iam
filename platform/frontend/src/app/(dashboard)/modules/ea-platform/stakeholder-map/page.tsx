...
const ROWS = [
  { id: "001", c: ["Stakeholder Map-001", "Stakeholder Map Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Stakeholder Map-002", "Stakeholder Map Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Stakeholder Map-003", "Stakeholder Map Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Stakeholder Map-004", "Stakeholder Map Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Stakeholder Map-005", "Stakeholder Map Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Stakeholder Map", ts: "Há 2min", a: "Sistema" },
