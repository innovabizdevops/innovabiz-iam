...
const ROWS = [
  { id: "001", c: ["Impact Analysis-001", "Impact Analysis Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Impact Analysis-002", "Impact Analysis Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Impact Analysis-003", "Impact Analysis Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Impact Analysis-004", "Impact Analysis Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Impact Analysis-005", "Impact Analysis Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Impact Analysis", ts: "Há 2min", a: "Sistema" },
