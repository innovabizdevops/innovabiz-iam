...
const ROWS = [
  { id: "001", c: ["Adm Workflow-001", "Adm Workflow Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Adm Workflow-002", "Adm Workflow Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Adm Workflow-003", "Adm Workflow Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Adm Workflow-004", "Adm Workflow Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Adm Workflow-005", "Adm Workflow Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Adm Workflow", ts: "Há 2min", a: "Sistema" },
...
export default function AdmWorkflowPage() {
  return (
