...
const ROWS = [
  { id: "001", c: ["Architecture Roadmap-001", "Architecture Roadmap Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Architecture Roadmap-002", "Architecture Roadmap Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Architecture Roadmap-003", "Architecture Roadmap Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Architecture Roadmap-004", "Architecture Roadmap Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Architecture Roadmap-005", "Architecture Roadmap Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Architecture Roadmap", ts: "Há 2min", a: "Sistema" },
