...
const PAGE = "Technology Radar Ea";
...
const ROWS = [
  { id: "001", c: ["Technology Radar Ea-001", "Technology Radar Ea Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Technology Radar Ea-002", "Technology Radar Ea Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Technology Radar Ea-003", "Technology Radar Ea Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Technology Radar Ea-004", "Technology Radar Ea Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Technology Radar Ea-005", "Technology Radar Ea Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Technology Radar Ea", ts: "Há 2min", a: "Sistema" },
...
export default function TechnologyRadarEaPage() {
  return (
