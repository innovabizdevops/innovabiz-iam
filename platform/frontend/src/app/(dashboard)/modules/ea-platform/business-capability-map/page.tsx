...
const PAGE = "Business Capability Map";
const KPIS = [{"l":"Data Assets","v":"4,847","d":"+8.2%","u":true},{"l":"Qualidade (%)","v":"94.3%","d":"+2.1%","u":true},{"l":"Dashboards Ativos","v":"342","d":"+12.3%","u":true},{"l":"Utilizadores BI","v":"2,847","d":"+5.4%","u":true}];
const COLS = ["Asset","Domínio","Qualidade (%)","Owner","Última Atualização","Estado"];
const ROWS = [
  { id: "001", c: ["Business Capability Map-001", "Business Capability Map Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Business Capability Map-002", "Business Capability Map Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Business Capability Map-003", "Business Capability Map Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Business Capability Map-004", "Business Capability Map Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Business Capability Map-005", "Business Capability Map Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Business Capability Map", ts: "Há 2min", a: "Sistema" },
...
export default function BusinessCapabilityMapPage() {
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">EA Platform — iBOS Enterprise</p>
        </div>
