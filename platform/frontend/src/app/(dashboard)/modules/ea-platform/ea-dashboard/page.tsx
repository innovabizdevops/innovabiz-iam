...
const ROWS = [
  { id: "001", c: ["Ea Dashboard-001", "Ea Dashboard Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Ea Dashboard-002", "Ea Dashboard Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Ea Dashboard-003", "Ea Dashboard Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Ea Dashboard-004", "Ea Dashboard Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Ea Dashboard-005", "Ea Dashboard Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Ea Dashboard", ts: "Há 2min", a: "Sistema" },
