...
const ROWS = [
  { id: "001", c: ["Gap Analysis-001", "Gap Analysis Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Gap Analysis-002", "Gap Analysis Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Gap Analysis-003", "Gap Analysis Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Gap Analysis-004", "Gap Analysis Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Gap Analysis-005", "Gap Analysis Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Gap Analysis", ts: "Há 2min", a: "Sistema" },
