...
const KPIS = [{"l":"Formulários Ativos","v":"1.966","t":"+2.2%","d":"up"},{"l":"Submissões/Dia","v":"1871","t":"+0.9%","d":"up"},{"l":"Documentos Gerados","v":"4.381","t":"+3.3%","d":"up"},{"l":"Templates","v":"2.760","t":"+12.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.333","2026-03-11","1.688","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.495","2026-03-10","3.466","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.007","2026-01-15","545","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.710","2026-01-16","8.519","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.299","2026-02-16","5.249","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":711},{"label":"Mar","value":470},{"label":"Abr","value":460},{"label":"Mai","value":732},{"label":"Jun","value":487},{"label":"Jul","value":662},{"label":"Ago","value":756},{"label":"Set","value":742},{"label":"Out","value":603},{"label":"Nov","value":591},{"label":"Dez","value":613}];
const MX = 756;
