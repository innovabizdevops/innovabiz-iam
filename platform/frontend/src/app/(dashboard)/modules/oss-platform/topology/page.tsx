...
const PAGE = "Topology";
const KPIS = [{"l":"Formulários Ativos","v":"9.025","t":"-2.6%","d":"down"},{"l":"Submissões/Dia","v":"3908","t":"+16.5%","d":"up"},{"l":"Documentos Gerados","v":"7.503","t":"+9.6%","d":"up"},{"l":"Templates","v":"957","t":"-4.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.975","2026-02-17","6.202","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.507","2026-01-19","645","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.758","2026-03-10","651","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.135","2026-01-02","4.530","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.843","2026-01-10","2.306","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":771},{"label":"Mar","value":734},{"label":"Abr","value":498},{"label":"Mai","value":769},{"label":"Jun","value":704},{"label":"Jul","value":602},{"label":"Ago","value":645},{"label":"Set","value":749},{"label":"Out","value":714},{"label":"Nov","value":766},{"label":"Dez","value":661}];
const MX = 771;
