...
const KPIS = [{"l":"Formulários Ativos","v":"8.022","t":"+15.4%","d":"up"},{"l":"Submissões/Dia","v":"4380","t":"-5.7%","d":"down"},{"l":"Documentos Gerados","v":"8.391","t":"-3.3%","d":"down"},{"l":"Templates","v":"6.524","t":"-4.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.987","2026-03-04","6.091","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.775","2026-02-26","7.895","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.324","2026-01-23","841","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.216","2026-03-18","7.878","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.446","2026-03-08","357","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":1013},{"label":"Mar","value":1055},{"label":"Abr","value":891},{"label":"Mai","value":764},{"label":"Jun","value":796},{"label":"Jul","value":811},{"label":"Ago","value":985},{"label":"Set","value":889},{"label":"Out","value":773},{"label":"Nov","value":756},{"label":"Dez","value":757}];
const MX = 1055;
