...
const ACCENT = "#7c2d12";
const MODULE = "OSS Platform";
const PAGE = "Assurance";
const KPIS = [{"l":"Formulários Ativos","v":"5.030","t":"+5.9%","d":"up"},{"l":"Submissões/Dia","v":"2843","t":"+16.7%","d":"up"},{"l":"Documentos Gerados","v":"2.557","t":"+7.2%","d":"up"},{"l":"Templates","v":"3.414","t":"-2.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.048","2026-02-02","2.361","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.262","2026-03-20","1.077","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.869","2026-01-16","5.391","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.652","2026-01-07","7.562","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.140","2026-02-08","2.039","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":601},{"label":"Mar","value":615},{"label":"Abr","value":628},{"label":"Mai","value":552},{"label":"Jun","value":499},{"label":"Jul","value":696},{"label":"Ago","value":444},{"label":"Set","value":711},{"label":"Out","value":721},{"label":"Nov","value":750},{"label":"Dez","value":683}];
const MX = 750;
