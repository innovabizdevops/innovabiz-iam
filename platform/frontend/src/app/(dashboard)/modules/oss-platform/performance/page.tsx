...
const KPIS = [{"l":"Formulários Ativos","v":"7.878","t":"+3.8%","d":"up"},{"l":"Submissões/Dia","v":"4188","t":"-2.7%","d":"down"},{"l":"Documentos Gerados","v":"3.095","t":"+7.7%","d":"up"},{"l":"Templates","v":"7.642","t":"+5.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","988","2026-03-02","5.457","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.378","2026-02-08","460","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.469","2026-01-19","2.968","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.058","2026-01-14","5.983","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","921","2026-01-25","1.380","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":847},{"label":"Mar","value":1010},{"label":"Abr","value":1038},{"label":"Mai","value":811},{"label":"Jun","value":710},{"label":"Jul","value":992},{"label":"Ago","value":913},{"label":"Set","value":938},{"label":"Out","value":828},{"label":"Nov","value":1034},{"label":"Dez","value":819}];
const MX = 1038;
