...
const PAGE = "Compare";
const KPIS = [{"l":"Total Xai Interactive","v":"2.819","t":"+12.8%","d":"up"},{"l":"Compare Ativos","v":"2.802","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"89.2%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"84","t":"+0.5%","d":"up"}];
const COLS = ["ID","Compare","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Xai Interactive #001","Xai Interactive #002","3.868","8.902","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Xai Interactive #002","Xai Interactive #003","744","2.528","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Xai Interactive #003","Xai Interactive #004","5.981","3.960","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Xai Interactive #004","Xai Interactive #005","6.485","4.851","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Xai Interactive #005","Xai Interactive #001","5.564","2.956","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":843},{"label":"Fev","value":789},{"label":"Mar","value":968},{"label":"Abr","value":793},{"label":"Mai","value":848},{"label":"Jun","value":902},{"label":"Jul","value":579},{"label":"Ago","value":816},{"label":"Set","value":923},{"label":"Out","value":762},{"label":"Nov","value":688},{"label":"Dez","value":859}];
const MX = 968;
