...
const PAGE = "Export";
const KPIS = [{"l":"Total Xai Interactive","v":"1.580","t":"-4.0%","d":"down"},{"l":"Export Ativos","v":"5.824","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"66.0%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"59","t":"+7.0%","d":"up"}];
const COLS = ["ID","Export","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Xai Interactive #001","Xai Interactive #002","4.143","2.250","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Xai Interactive #002","Xai Interactive #003","2.470","2.780","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Xai Interactive #003","Xai Interactive #004","4.547","6.235","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Xai Interactive #004","Xai Interactive #005","7.603","5.312","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Xai Interactive #005","Xai Interactive #001","2.801","1.316","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":957},{"label":"Fev","value":949},{"label":"Mar","value":851},{"label":"Abr","value":739},{"label":"Mai","value":626},{"label":"Jun","value":712},{"label":"Jul","value":743},{"label":"Ago","value":905},{"label":"Set","value":672},{"label":"Out","value":719},{"label":"Nov","value":633},{"label":"Dez","value":881}];
const MX = 957;
