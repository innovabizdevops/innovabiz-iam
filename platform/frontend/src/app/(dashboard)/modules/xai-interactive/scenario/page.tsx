...
const PAGE = "Scenario";
const KPIS = [{"l":"Total Xai Interactive","v":"1.835","t":"+5.4%","d":"up"},{"l":"Scenario Ativos","v":"2.547","t":"+6.4%","d":"up"},{"l":"Eficiência (%)","v":"92.2%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"64","t":"+9.2%","d":"up"}];
const COLS = ["ID","Scenario","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Xai Interactive #001","Xai Interactive #002","5.493","3.860","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Xai Interactive #002","Xai Interactive #003","600","6.064","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Xai Interactive #003","Xai Interactive #004","1.652","5.876","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Xai Interactive #004","Xai Interactive #005","5.608","7.655","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Xai Interactive #005","Xai Interactive #001","5.043","6.989","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":614},{"label":"Fev","value":538},{"label":"Mar","value":581},{"label":"Abr","value":584},{"label":"Mai","value":357},{"label":"Jun","value":465},{"label":"Jul","value":425},{"label":"Ago","value":616},{"label":"Set","value":512},{"label":"Out","value":547},{"label":"Nov","value":443},{"label":"Dez","value":629}];
const MX = 629;
