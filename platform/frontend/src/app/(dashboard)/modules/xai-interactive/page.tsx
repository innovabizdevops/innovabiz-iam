...
/* ═══ XAI Interactive Explorer — Dashboard ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total Registos", value: "8408", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3352", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€208K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1138627108", cells: ["XAI-2108", "XAI Interactive Explorer Item 1", "25/5/2026", "€27 208"], status: "active" as const },
    { id: "1138630679", cells: ["XAI-5679", "XAI Interactive Explorer Item 2", "12/12/2026", "€30 779"], status: "pending" as const },
    { id: "1138634250", cells: ["XAI-9250", "XAI Interactive Explorer Item 3", "27/7/2026", "€34 350"], status: "completed" as const },
    { id: "1138637821", cells: ["XAI-3821", "XAI Interactive Explorer Item 4", "14/2/2026", "€37 921"], status: "warning" as const },
    { id: "1138641392", cells: ["XAI-7392", "XAI Interactive Explorer Item 5", "1/9/2026", "€41 492"], status: "active" as const },
];
...
export default function XaiInteractiveExplorerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">XAI Interactive Explorer</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • XAI Interactive Explorer</p>
                    </div>
                </div>
