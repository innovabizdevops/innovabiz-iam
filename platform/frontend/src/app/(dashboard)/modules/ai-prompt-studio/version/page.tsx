...
const PAGE = "Version";
const KPIS = [{"l":"Formulários Ativos","v":"3.693","t":"-5.3%","d":"down"},{"l":"Submissões/Dia","v":"462","t":"+4.1%","d":"up"},{"l":"Documentos Gerados","v":"5.569","t":"+9.9%","d":"up"},{"l":"Templates","v":"3.329","t":"+9.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.417","2026-01-14","2.043","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.164","2026-02-03","1.104","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.582","2026-01-12","5.270","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.793","2026-01-25","2.064","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.654","2026-03-06","1.816","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":759},{"label":"Mar","value":647},{"label":"Abr","value":718},{"label":"Mai","value":808},{"label":"Jun","value":798},{"label":"Jul","value":549},{"label":"Ago","value":666},{"label":"Set","value":688},{"label":"Out","value":781},{"label":"Nov","value":745},{"label":"Dez","value":604}];
const MX = 819;
