...
const ACCENT = "#6366f1";
const MODULE = "AI Prompt Studio";
const PAGE = "Optimize";
const KPIS = [{"l":"Total Ai Prompt Studio","v":"2.990","t":"+8.4%","d":"up"},{"l":"Optimize Ativos","v":"7.912","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"90.6%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"73","t":"-1.2%","d":"down"}];
const COLS = ["ID","Optimize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ai Prompt Studio #001","Ai Prompt Studio #002","6.046","1.326","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Ai Prompt Studio #002","Ai Prompt Studio #003","3.214","5.625","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Ai Prompt Studio #003","Ai Prompt Studio #004","2.354","3.599","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Ai Prompt Studio #004","Ai Prompt Studio #005","4.160","6.090","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ai Prompt Studio #005","Ai Prompt Studio #001","967","6.919","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":534},{"label":"Mar","value":606},{"label":"Abr","value":634},{"label":"Mai","value":651},{"label":"Jun","value":531},{"label":"Jul","value":436},{"label":"Ago","value":486},{"label":"Set","value":606},{"label":"Out","value":524},{"label":"Nov","value":762},{"label":"Dez","value":456}];
const MX = 762;
