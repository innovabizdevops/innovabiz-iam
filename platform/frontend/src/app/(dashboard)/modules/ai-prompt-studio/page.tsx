...
/* ═══ AI Prompt Studio — Dashboard ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total Registos", value: "3449", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2690", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€152K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "936711649", cells: ["AI-1649", "AI Prompt Studio Item 1", "14/2/2026", "€11 749"], status: "active" as const },
    { id: "936715220", cells: ["AI-5220", "AI Prompt Studio Item 2", "1/9/2026", "€15 320"], status: "pending" as const },
    { id: "936718791", cells: ["AI-8791", "AI Prompt Studio Item 3", "16/4/2026", "€18 891"], status: "completed" as const },
    { id: "936722362", cells: ["AI-3362", "AI Prompt Studio Item 4", "3/11/2026", "€22 462"], status: "warning" as const },
    { id: "936725933", cells: ["AI-6933", "AI Prompt Studio Item 5", "18/6/2026", "€26 033"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Prompt Studio</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Prompt Studio</p>
                    </div>
                </div>
