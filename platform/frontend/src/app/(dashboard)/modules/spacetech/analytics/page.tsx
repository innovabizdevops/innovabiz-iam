...
const ACCENT = "#1e40af";
const MODULE = "SpaceTech Platform";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"3.053","t":"+17.8%","d":"up"},{"l":"Queries/Dia","v":"1654","t":"+1.8%","d":"up"},{"l":"Dados Processados (GB)","v":"1.137","t":"+9.9%","d":"up"},{"l":"Utilizadores Analytics","v":"3.371","t":"-2.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3527","2026-01-07","517","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","833","2026-03-18","3.704","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4290","2026-01-07","2.293","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1072","2026-01-08","1.008","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2443","2026-01-24","3.382","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":985},{"label":"Mar","value":748},{"label":"Abr","value":847},{"label":"Mai","value":957},{"label":"Jun","value":632},{"label":"Jul","value":753},{"label":"Ago","value":816},{"label":"Set","value":824},{"label":"Out","value":891},{"label":"Nov","value":622},{"label":"Dez","value":877}];
const MX = 985;
