...
/* ═══ SpaceTech Platform — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "2241", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1924", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€124K", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1251599741", cells: ["SPA-6741", "SpaceTech Platform Item 1", "22/6/2026", "€49 841"], status: "active" as const },
    { id: "1251603312", cells: ["SPA-1312", "SpaceTech Platform Item 2", "9/1/2026", "€3412"], status: "pending" as const },
    { id: "1251606883", cells: ["SPA-4883", "SpaceTech Platform Item 3", "24/8/2026", "€6983"], status: "completed" as const },
    { id: "1251610454", cells: ["SPA-8454", "SpaceTech Platform Item 4", "11/3/2026", "€10 554"], status: "warning" as const },
    { id: "1251614025", cells: ["SPA-3025", "SpaceTech Platform Item 5", "26/10/2026", "€14 125"], status: "active" as const },
];
...
export default function SpacetechPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SpaceTech Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SpaceTech Platform</p>
                    </div>
                </div>
