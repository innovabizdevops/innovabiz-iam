...
const PAGE = "Ground";
const KPIS = [{"l":"Quartos Ocupados","v":"7.533","t":"+9.6%","d":"up"},{"l":"RevPAR (€)","v":"€50089","t":"+-0.0%","d":"up"},{"l":"Ocupação (%)","v":"82.3%","t":"+1.3%","d":"up"},{"l":"Guest Satisfaction","v":"2.202","t":"-3.5%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.433","2026-03-04","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.780","2026-03-08","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.177","2026-03-23","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.661","2026-03-06","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.200","2026-03-04","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":616},{"label":"Mar","value":805},{"label":"Abr","value":625},{"label":"Mai","value":637},{"label":"Jun","value":755},{"label":"Jul","value":556},{"label":"Ago","value":756},{"label":"Set","value":757},{"label":"Out","value":685},{"label":"Nov","value":606},{"label":"Dez","value":443}];
const MX = 805;
