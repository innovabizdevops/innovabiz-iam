...
const KPIS = [{"l":"Quartos Ocupados","v":"6.113","t":"+0.5%","d":"up"},{"l":"RevPAR (€)","v":"€3074","t":"+11.5%","d":"up"},{"l":"Ocupação (%)","v":"88.2%","t":"+9.9%","d":"up"},{"l":"Guest Satisfaction","v":"706","t":"+9.7%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","1.491","2026-01-12","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.959","2026-01-08","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.301","2026-01-09","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.244","2026-02-28","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.374","2026-01-09","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":430},{"label":"Mar","value":493},{"label":"Abr","value":624},{"label":"Mai","value":439},{"label":"Jun","value":356},{"label":"Jul","value":476},{"label":"Ago","value":466},{"label":"Set","value":684},{"label":"Out","value":489},{"label":"Nov","value":379},{"label":"Dez","value":695}];
const MX = 695;
