...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"183","t":"+15.3%","d":"up"},{"l":"Submissões/Dia","v":"468","t":"+2.4%","d":"up"},{"l":"Documentos Gerados","v":"7.523","t":"+0.2%","d":"up"},{"l":"Templates","v":"7.535","t":"+0.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.683","2026-01-06","7.068","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","896","2026-02-16","8.232","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.053","2026-01-26","4.551","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.384","2026-02-18","8.091","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.692","2026-01-01","1.943","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":628},{"label":"Mar","value":850},{"label":"Abr","value":680},{"label":"Mai","value":825},{"label":"Jun","value":759},{"label":"Jul","value":962},{"label":"Ago","value":907},{"label":"Set","value":799},{"label":"Out","value":875},{"label":"Nov","value":720},{"label":"Dez","value":688}];
const MX = 962;
