...
const ACCENT = "#6366f1";
const MODULE = "Engineering Firm";
const PAGE = "Project";
const KPIS = [{"l":"Total Engineering Firm","v":"4.730","t":"-1.4%","d":"down"},{"l":"Project Ativos","v":"4.808","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"87.0%","t":"-4.3%","d":"down"},{"l":"Score Performance","v":"60","t":"-5.4%","d":"down"}];
const COLS = ["ID","Project","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Firm #001","Engineering Firm #002","4.371","6.761","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Engineering Firm #002","Engineering Firm #003","8.585","6.931","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Engineering Firm #003","Engineering Firm #004","1.068","4.001","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Engineering Firm #004","Engineering Firm #005","5.302","8.217","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Engineering Firm #005","Engineering Firm #001","270","3.871","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":802},{"label":"Fev","value":789},{"label":"Mar","value":803},{"label":"Abr","value":894},{"label":"Mai","value":783},{"label":"Jun","value":953},{"label":"Jul","value":1028},{"label":"Ago","value":893},{"label":"Set","value":827},{"label":"Out","value":999},{"label":"Nov","value":1046},{"label":"Dez","value":923}];
const MX = 1046;
