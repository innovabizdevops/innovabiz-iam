...
const ACCENT = "#4c1d95";
const MODULE = "Policy Management Deep";
const PAGE = "Create";
const KPIS = [{"l":"Total Policy Mgmt Deep","v":"8.727","t":"+9.0%","d":"up"},{"l":"Create Ativos","v":"1.975","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"77.6%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"66","t":"+17.6%","d":"up"}];
const COLS = ["ID","Create","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Policy Mgmt Deep #001","Policy Mgmt Deep #002","1.540","5.979","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Policy Mgmt Deep #002","Policy Mgmt Deep #003","5.860","7.630","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Policy Mgmt Deep #003","Policy Mgmt Deep #004","6.100","3.051","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Policy Mgmt Deep #004","Policy Mgmt Deep #005","5.690","2.758","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Policy Mgmt Deep #005","Policy Mgmt Deep #001","1.503","5.013","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":288},{"label":"Fev","value":462},{"label":"Mar","value":372},{"label":"Abr","value":334},{"label":"Mai","value":429},{"label":"Jun","value":574},{"label":"Jul","value":389},{"label":"Ago","value":374},{"label":"Set","value":503},{"label":"Out","value":330},{"label":"Nov","value":466},{"label":"Dez","value":462}];
const MX = 574;
