...
const KPIS = [{"l":"Total Policy Mgmt Deep","v":"8.822","t":"+7.0%","d":"up"},{"l":"Distribute Ativos","v":"8.420","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"81.8%","t":"-5.9%","d":"down"},{"l":"Score Performance","v":"84","t":"+16.6%","d":"up"}];
const COLS = ["ID","Distribute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Policy Mgmt Deep #001","Policy Mgmt Deep #002","4.649","3.371","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Policy Mgmt Deep #002","Policy Mgmt Deep #003","2.676","6.470","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Policy Mgmt Deep #003","Policy Mgmt Deep #004","5.013","2.424","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Policy Mgmt Deep #004","Policy Mgmt Deep #005","7.957","5.850","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Policy Mgmt Deep #005","Policy Mgmt Deep #001","4.415","3.109","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":932},{"label":"Fev","value":810},{"label":"Mar","value":661},{"label":"Abr","value":793},{"label":"Mai","value":932},{"label":"Jun","value":567},{"label":"Jul","value":725},{"label":"Ago","value":871},{"label":"Set","value":610},{"label":"Out","value":567},{"label":"Nov","value":640},{"label":"Dez","value":555}];
const MX = 932;
