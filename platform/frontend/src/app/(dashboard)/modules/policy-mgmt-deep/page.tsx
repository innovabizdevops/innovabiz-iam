...
/* ═══ Policy Management Deep — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "8364", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3164", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€371K", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1041616964", cells: ["POL-2964", "Policy Management Deep Item 1", "25/9/2026", "€17 064"], status: "active" as const },
    { id: "1041620535", cells: ["POL-6535", "Policy Management Deep Item 2", "12/4/2026", "€20 635"], status: "pending" as const },
    { id: "1041624106", cells: ["POL-1106", "Policy Management Deep Item 3", "27/11/2026", "€24 206"], status: "completed" as const },
    { id: "1041627677", cells: ["POL-4677", "Policy Management Deep Item 4", "14/6/2026", "€27 777"], status: "warning" as const },
    { id: "1041631248", cells: ["POL-8248", "Policy Management Deep Item 5", "1/1/2026", "€31 348"], status: "active" as const },
];
...
export default function PolicyManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Policy Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Policy Management Deep</p>
                    </div>
                </div>
