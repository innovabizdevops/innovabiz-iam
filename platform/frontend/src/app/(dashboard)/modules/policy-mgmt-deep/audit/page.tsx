...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.087","t":"+11.7%","d":"up"},{"l":"NC Abertas","v":"3.384","t":"+13.5%","d":"up"},{"l":"Conformidade (%)","v":"84.1%","t":"+3.6%","d":"up"},{"l":"CAPAs Pendentes","v":"3.439","t":"+8.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.800","82.7%","878","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.038","93.3%","8.009","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.964","73.5%","3.411","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.516","79.4%","8.379","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.655","73.3%","7.976","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":279},{"label":"Mar","value":650},{"label":"Abr","value":287},{"label":"Mai","value":583},{"label":"Jun","value":446},{"label":"Jul","value":628},{"label":"Ago","value":425},{"label":"Set","value":543},{"label":"Out","value":320},{"label":"Nov","value":338},{"label":"Dez","value":401}];
const MX = 650;
