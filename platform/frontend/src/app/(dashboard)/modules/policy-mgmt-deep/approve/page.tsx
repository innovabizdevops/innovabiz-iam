...
const PAGE = "Approve";
const KPIS = [{"l":"Aprovações Pendentes","v":"4.554","t":"-5.7%","d":"down"},{"l":"SLA Cumprido (%)","v":"67.6%","t":"+0.6%","d":"up"},{"l":"Tempo Médio (h)","v":"62h","t":"+11.2%","d":"up"},{"l":"Rejeitadas (%)","v":"92.6%","t":"+4.7%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","8.740","€ 43014.20","4.819","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","5.756","€ 18628.55","6.442","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","6.178","€ 1157.51","6.739","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","5.186","€ 4683.49","323","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","478","€ 27504.41","2.175","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":315},{"label":"Mar","value":272},{"label":"Abr","value":565},{"label":"Mai","value":473},{"label":"Jun","value":447},{"label":"Jul","value":406},{"label":"Ago","value":474},{"label":"Set","value":413},{"label":"Out","value":273},{"label":"Nov","value":436},{"label":"Dez","value":438}];
const MX = 589;
