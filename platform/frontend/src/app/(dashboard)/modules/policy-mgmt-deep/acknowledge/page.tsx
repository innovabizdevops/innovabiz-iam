...
const PAGE = "Acknowledge";
const KPIS = [{"l":"Artigos Publicados","v":"6.899","t":"+6.9%","d":"up"},{"l":"Views/Semana","v":"3813","t":"+14.8%","d":"up"},{"l":"Feedback Útil (%)","v":"90.9%","t":"+0.5%","d":"up"},{"l":"Artigos Desatualizados","v":"3.325","t":"+4.8%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","5.398","74.4%","6.626","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","4.636","75.2%","3.691","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","8.657","89.1%","7.227","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","669","95.6%","7.998","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","7.272","75.6%","5.203","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":845},{"label":"Mar","value":745},{"label":"Abr","value":954},{"label":"Mai","value":949},{"label":"Jun","value":813},{"label":"Jul","value":674},{"label":"Ago","value":905},{"label":"Set","value":1027},{"label":"Out","value":863},{"label":"Nov","value":942},{"label":"Dez","value":785}];
const MX = 1027;
