...
const PAGE = "Causal Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"244","t":"-5.1%","d":"down"},{"l":"Queries/Dia","v":"4479","t":"+2.2%","d":"up"},{"l":"Dados Processados (GB)","v":"3.989","t":"+14.6%","d":"up"},{"l":"Utilizadores Analytics","v":"632","t":"+3.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2566","2026-03-16","4.172","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","658","2026-01-19","7.449","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4111","2026-03-23","4.019","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3505","2026-01-06","8.169","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4906","2026-02-02","2.363","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":496},{"label":"Fev","value":382},{"label":"Mar","value":533},{"label":"Abr","value":468},{"label":"Mai","value":670},{"label":"Jun","value":714},{"label":"Jul","value":677},{"label":"Ago","value":515},{"label":"Set","value":613},{"label":"Out","value":694},{"label":"Nov","value":613},{"label":"Dez","value":421}];
const MX = 714;
