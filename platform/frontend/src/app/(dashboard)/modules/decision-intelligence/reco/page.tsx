...
const ACCENT = "#7c3aed";
const MODULE = "Decision Intelligence";
const PAGE = "Recommendation AI";
const KPIS = [{"l":"Aprovações Pendentes","v":"5.796","t":"-4.9%","d":"down"},{"l":"SLA Cumprido (%)","v":"85.8%","t":"+2.4%","d":"up"},{"l":"Tempo Médio (h)","v":"84h","t":"+6.9%","d":"up"},{"l":"Rejeitadas (%)","v":"84.4%","t":"-3.2%","d":"down"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","1.279","€ 11645.41","4.243","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","637","€ 42312.75","6.774","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","3.551","€ 30330.46","5.488","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","7.153","€ 24395.41","5.802","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","6.305","€ 43091.96","5.140","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":703},{"label":"Mar","value":944},{"label":"Abr","value":865},{"label":"Mai","value":993},{"label":"Jun","value":936},{"label":"Jul","value":969},{"label":"Ago","value":873},{"label":"Set","value":838},{"label":"Out","value":1014},{"label":"Nov","value":707},{"label":"Dez","value":839}];
const MX = 1014;
