...
const PAGE = "Optimization Engine";
const KPIS = [{"l":"Aprovações Pendentes","v":"6.293","t":"-0.1%","d":"down"},{"l":"SLA Cumprido (%)","v":"85.1%","t":"-3.8%","d":"down"},{"l":"Tempo Médio (h)","v":"55h","t":"+7.8%","d":"up"},{"l":"Rejeitadas (%)","v":"84.2%","t":"+16.9%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","6.989","€ 44814.21","4.924","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","105","€ 42607.14","5.791","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","1.855","€ 41251.42","2.329","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","1.020","€ 49289.70","710","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","5.662","€ 2449.96","8.786","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":694},{"label":"Fev","value":647},{"label":"Mar","value":873},{"label":"Abr","value":911},{"label":"Mai","value":779},{"label":"Jun","value":860},{"label":"Jul","value":826},{"label":"Ago","value":689},{"label":"Set","value":731},{"label":"Out","value":579},{"label":"Nov","value":935},{"label":"Dez","value":609}];
const MX = 935;
