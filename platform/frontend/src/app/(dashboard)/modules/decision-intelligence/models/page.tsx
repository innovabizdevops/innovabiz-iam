...
const PAGE = "Decision Models";
const KPIS = [{"l":"Aprovações Pendentes","v":"3.570","t":"+3.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"75.8%","t":"+10.3%","d":"up"},{"l":"Tempo Médio (h)","v":"130h","t":"-5.6%","d":"down"},{"l":"Rejeitadas (%)","v":"84.0%","t":"+8.4%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","6.026","€ 25522.95","501","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","4.477","€ 6268.34","7.246","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","878","€ 38432.65","3.603","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","4.914","€ 33558.69","6.918","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","496","€ 38187.08","3.893","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":1045},{"label":"Mar","value":693},{"label":"Abr","value":836},{"label":"Mai","value":855},{"label":"Jun","value":811},{"label":"Jul","value":836},{"label":"Ago","value":836},{"label":"Set","value":986},{"label":"Out","value":1027},{"label":"Nov","value":812},{"label":"Dez","value":854}];
const MX = 1045;
