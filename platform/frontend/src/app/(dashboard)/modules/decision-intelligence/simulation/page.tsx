...
const PAGE = "Simulation Lab";
const KPIS = [{"l":"Twins Ativos","v":"5.243","t":"+0.0%","d":"up"},{"l":"Simulações/Dia","v":"4444","t":"+0.3%","d":"up"},{"l":"Precisão Modelo (%)","v":"92.7%","t":"+5.9%","d":"up"},{"l":"Latência Sync (ms)","v":"143ms","t":"+1.0%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","91.9%","2026-02-14","8.120","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","72.8%","2026-02-23","2.858","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","90.0%","2026-03-23","4.892","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","72.8%","2026-01-13","1.032","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","94.3%","2026-03-13","4.011","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":878},{"label":"Fev","value":709},{"label":"Mar","value":544},{"label":"Abr","value":524},{"label":"Mai","value":811},{"label":"Jun","value":667},{"label":"Jul","value":840},{"label":"Ago","value":886},{"label":"Set","value":502},{"label":"Out","value":646},{"label":"Nov","value":532},{"label":"Dez","value":657}];
const MX = 886;
