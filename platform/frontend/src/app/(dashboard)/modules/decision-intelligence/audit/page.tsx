...
const PAGE = "Decision Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.495","t":"-4.3%","d":"down"},{"l":"NC Abertas","v":"6.720","t":"+15.7%","d":"up"},{"l":"Conformidade (%)","v":"93.2%","t":"+3.3%","d":"up"},{"l":"CAPAs Pendentes","v":"5.862","t":"+17.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.596","100.0%","2.367","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.785","81.1%","4.762","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","689","84.5%","3.796","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","9.062","93.8%","8.492","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","355","81.9%","7.322","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":597},{"label":"Mar","value":364},{"label":"Abr","value":545},{"label":"Mai","value":309},{"label":"Jun","value":585},{"label":"Jul","value":459},{"label":"Ago","value":492},{"label":"Set","value":394},{"label":"Out","value":657},{"label":"Nov","value":365},{"label":"Dez","value":456}];
const MX = 657;
