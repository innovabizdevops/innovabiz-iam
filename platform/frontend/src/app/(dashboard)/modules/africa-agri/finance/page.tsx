...
const PAGE = "Finance";
const KPIS = [{"l":"Total Africa Agri","v":"8.182","t":"+7.3%","d":"up"},{"l":"Finance Ativos","v":"5.987","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"71.3%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"77","t":"+7.2%","d":"up"}];
const COLS = ["ID","Finance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Africa Agri #001","Africa Agri #002","217","7.639","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Africa Agri #002","Africa Agri #003","5.896","221","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Africa Agri #003","Africa Agri #004","6.102","2.443","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Africa Agri #004","Africa Agri #005","3.141","1.360","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Africa Agri #005","Africa Agri #001","8.023","898","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":812},{"label":"Fev","value":794},{"label":"Mar","value":558},{"label":"Abr","value":665},{"label":"Mai","value":600},{"label":"Jun","value":792},{"label":"Jul","value":817},{"label":"Ago","value":590},{"label":"Set","value":495},{"label":"Out","value":811},{"label":"Nov","value":569},{"label":"Dez","value":565}];
const MX = 817;
