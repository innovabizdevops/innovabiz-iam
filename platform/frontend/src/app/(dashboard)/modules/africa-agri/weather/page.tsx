...
const ACCENT = "#14532d";
const MODULE = "Africa AgriTech Hub";
const PAGE = "Weather";
const KPIS = [{"l":"Total Africa Agri","v":"1.930","t":"-0.1%","d":"down"},{"l":"Weather Ativos","v":"3.130","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"83.9%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"60","t":"+16.5%","d":"up"}];
const COLS = ["ID","Weather","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Africa Agri #001","Africa Agri #002","7.497","9.039","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Africa Agri #002","Africa Agri #003","5.208","718","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Africa Agri #003","Africa Agri #004","882","4.297","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Africa Agri #004","Africa Agri #005","7.098","566","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Africa Agri #005","Africa Agri #001","3.582","4.123","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":387},{"label":"Mar","value":551},{"label":"Abr","value":462},{"label":"Mai","value":360},{"label":"Jun","value":505},{"label":"Jul","value":657},{"label":"Ago","value":430},{"label":"Set","value":394},{"label":"Out","value":517},{"label":"Nov","value":609},{"label":"Dez","value":591}];
const MX = 657;
