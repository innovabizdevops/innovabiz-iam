...
/* ═══ Africa AgriTech Hub — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "5137", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "748", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€151K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "-20%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "264424137", cells: ["AFR-5137", "Africa AgriTech Hub Item 1", "6/10/2026", "€24 237"], status: "active" as const },
    { id: "264427708", cells: ["AFR-8708", "Africa AgriTech Hub Item 2", "21/5/2026", "€27 808"], status: "pending" as const },
    { id: "264431279", cells: ["AFR-3279", "Africa AgriTech Hub Item 3", "8/12/2026", "€31 379"], status: "completed" as const },
    { id: "264434850", cells: ["AFR-6850", "Africa AgriTech Hub Item 4", "23/7/2026", "€34 950"], status: "warning" as const },
    { id: "264438421", cells: ["AFR-1421", "Africa AgriTech Hub Item 5", "10/2/2026", "€38 521"], status: "active" as const },
];
...
export default function AfricaAgritechHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Africa AgriTech Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Africa AgriTech Hub</p>
                    </div>
                </div>
