...
const PAGE = "Assay Results";
const KPIS = [{"l":"Total Geology Mgmt","v":"3.390","t":"-2.4%","d":"down"},{"l":"Assay Results Ativos","v":"5.543","t":"+8.4%","d":"up"},{"l":"Eficiência (%)","v":"73.6%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"60","t":"+11.3%","d":"up"}];
const COLS = ["ID","Assay Results","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Geology Mgmt #001","Geology Mgmt #002","827","3.891","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Geology Mgmt #002","Geology Mgmt #003","6.697","2.064","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Geology Mgmt #003","Geology Mgmt #004","8.557","8.842","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Geology Mgmt #004","Geology Mgmt #005","2.708","6.064","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Geology Mgmt #005","Geology Mgmt #001","8.435","4.417","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":687},{"label":"Mar","value":842},{"label":"Abr","value":780},{"label":"Mai","value":568},{"label":"Jun","value":665},{"label":"Jul","value":678},{"label":"Ago","value":789},{"label":"Set","value":696},{"label":"Out","value":564},{"label":"Nov","value":717},{"label":"Dez","value":686}];
const MX = 842;
