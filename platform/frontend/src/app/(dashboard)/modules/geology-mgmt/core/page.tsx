...
const PAGE = "Core Logging";
const KPIS = [{"l":"Total Geology Mgmt","v":"1.832","t":"-3.3%","d":"down"},{"l":"Core Logging Ativos","v":"3.384","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"81.1%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"69","t":"+0.5%","d":"up"}];
const COLS = ["ID","Core Logging","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Geology Mgmt #001","Geology Mgmt #002","7.049","6.650","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Geology Mgmt #002","Geology Mgmt #003","7.882","6.305","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Geology Mgmt #003","Geology Mgmt #004","4.521","5.190","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Geology Mgmt #004","Geology Mgmt #005","3.906","5.553","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Geology Mgmt #005","Geology Mgmt #001","886","1.797","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":387},{"label":"Fev","value":692},{"label":"Mar","value":406},{"label":"Abr","value":640},{"label":"Mai","value":431},{"label":"Jun","value":490},{"label":"Jul","value":426},{"label":"Ago","value":614},{"label":"Set","value":638},{"label":"Out","value":473},{"label":"Nov","value":408},{"label":"Dez","value":596}];
const MX = 692;
