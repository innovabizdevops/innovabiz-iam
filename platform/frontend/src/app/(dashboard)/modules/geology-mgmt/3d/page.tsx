...
const ACCENT = "#059669";
const MODULE = "Geology Management";
const PAGE = "3D Modeling";
const KPIS = [{"l":"Total Geology Mgmt","v":"1.806","t":"-1.1%","d":"down"},{"l":"3D Modeling Ativos","v":"3.438","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"81.9%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"90","t":"+4.9%","d":"up"}];
const COLS = ["ID","3D Modeling","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Geology Mgmt #001","Geology Mgmt #002","8.061","4.439","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Geology Mgmt #002","Geology Mgmt #003","8.743","1.249","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Geology Mgmt #003","Geology Mgmt #004","7.848","8.442","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Geology Mgmt #004","Geology Mgmt #005","7.726","4.116","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Geology Mgmt #005","Geology Mgmt #001","7.180","6.236","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":260},{"label":"Fev","value":298},{"label":"Mar","value":544},{"label":"Abr","value":614},{"label":"Mai","value":493},{"label":"Jun","value":317},{"label":"Jul","value":273},{"label":"Ago","value":291},{"label":"Set","value":459},{"label":"Out","value":268},{"label":"Nov","value":607},{"label":"Dez","value":290}];
const MX = 614;
