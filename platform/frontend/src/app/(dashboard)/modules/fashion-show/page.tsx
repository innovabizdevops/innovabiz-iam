...
/* ═══ Fashion Show Production — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "6277", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1508", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€400K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1576818777", cells: ["FAS-1777", "Fashion Show Production Item 1", "10/10/2026", "€18 877"], status: "active" as const },
    { id: "1576822348", cells: ["FAS-5348", "Fashion Show Production Item 2", "25/5/2026", "€22 448"], status: "pending" as const },
    { id: "1576825919", cells: ["FAS-8919", "Fashion Show Production Item 3", "12/12/2026", "€26 019"], status: "completed" as const },
    { id: "1576829490", cells: ["FAS-3490", "Fashion Show Production Item 4", "27/7/2026", "€29 590"], status: "warning" as const },
    { id: "1576833061", cells: ["FAS-7061", "Fashion Show Production Item 5", "14/2/2026", "€33 161"], status: "active" as const },
];
...
export default function FashionShowProductionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fashion Show Production</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fashion Show Production</p>
                    </div>
                </div>
