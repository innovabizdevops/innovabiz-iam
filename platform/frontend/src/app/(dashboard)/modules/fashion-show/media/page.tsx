...
const PAGE = "Media";
const KPIS = [{"l":"Integrações Ativas","v":"7.243","t":"+1.0%","d":"up"},{"l":"Chamadas/Hora","v":"4693","t":"+16.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"69.4%","t":"-4.8%","d":"down"},{"l":"Latência Média (ms)","v":"15ms","t":"+11.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","794","7.274","80.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.455","2.991","81.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.056","2.718","73.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.732","7.971","71.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.693","5.308","80.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":518},{"label":"Fev","value":242},{"label":"Mar","value":366},{"label":"Abr","value":494},{"label":"Mai","value":362},{"label":"Jun","value":622},{"label":"Jul","value":331},{"label":"Ago","value":631},{"label":"Set","value":314},{"label":"Out","value":269},{"label":"Nov","value":397},{"label":"Dez","value":350}];
const MX = 631;
