...
const ACCENT = "#4c1d95";
const MODULE = "Fashion Show Production";
const PAGE = "Show";
const KPIS = [{"l":"Total Fashion Show","v":"8.692","t":"+0.2%","d":"up"},{"l":"Show Ativos","v":"2.295","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"74.6%","t":"+1.5%","d":"up"},{"l":"Score Performance","v":"66","t":"+11.0%","d":"up"}];
const COLS = ["ID","Show","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fashion Show #001","Fashion Show #002","3.751","7.046","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Fashion Show #002","Fashion Show #003","2.079","4.540","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Fashion Show #003","Fashion Show #004","3.826","289","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Fashion Show #004","Fashion Show #005","2.150","6.659","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fashion Show #005","Fashion Show #001","942","8.616","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":905},{"label":"Mar","value":1050},{"label":"Abr","value":906},{"label":"Mai","value":790},{"label":"Jun","value":1029},{"label":"Jul","value":864},{"label":"Ago","value":1079},{"label":"Set","value":993},{"label":"Out","value":798},{"label":"Nov","value":736},{"label":"Dez","value":921}];
const MX = 1079;
