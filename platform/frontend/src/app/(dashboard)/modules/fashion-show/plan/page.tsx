...
const PAGE = "Plan";
const KPIS = [{"l":"Total Fashion Show","v":"8.302","t":"-3.5%","d":"down"},{"l":"Plan Ativos","v":"8.110","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"78.2%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"72","t":"+1.5%","d":"up"}];
const COLS = ["ID","Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fashion Show #001","Fashion Show #002","654","329","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Fashion Show #002","Fashion Show #003","7.548","8.329","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Fashion Show #003","Fashion Show #004","2.925","8.485","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Fashion Show #004","Fashion Show #005","3.105","6.273","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fashion Show #005","Fashion Show #001","3.093","6.236","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":386},{"label":"Fev","value":558},{"label":"Mar","value":301},{"label":"Abr","value":237},{"label":"Mai","value":492},{"label":"Jun","value":494},{"label":"Jul","value":598},{"label":"Ago","value":214},{"label":"Set","value":583},{"label":"Out","value":507},{"label":"Nov","value":414},{"label":"Dez","value":471}];
const MX = 598;
