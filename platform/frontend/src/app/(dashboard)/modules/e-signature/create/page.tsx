...
const ACCENT = "#06b6d4";
const MODULE = "E-Signature Platform";
const PAGE = "Create";
const KPIS = [{"l":"Formulários Ativos","v":"4.613","t":"-5.8%","d":"down"},{"l":"Submissões/Dia","v":"3486","t":"-0.6%","d":"down"},{"l":"Documentos Gerados","v":"2.381","t":"+3.7%","d":"up"},{"l":"Templates","v":"4.003","t":"-4.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.234","2026-03-13","2.949","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.173","2026-02-02","5.725","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.841","2026-01-09","8.561","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.594","2026-01-06","5.889","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.440","2026-02-11","3.806","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":567},{"label":"Mar","value":447},{"label":"Abr","value":468},{"label":"Mai","value":704},{"label":"Jun","value":652},{"label":"Jul","value":681},{"label":"Ago","value":637},{"label":"Set","value":481},{"label":"Out","value":606},{"label":"Nov","value":648},{"label":"Dez","value":527}];
const MX = 704;
