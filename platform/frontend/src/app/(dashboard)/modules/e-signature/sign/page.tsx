...
const PAGE = "Sign";
const KPIS = [{"l":"Formulários Ativos","v":"3.230","t":"+2.7%","d":"up"},{"l":"Submissões/Dia","v":"2806","t":"+10.5%","d":"up"},{"l":"Documentos Gerados","v":"7.442","t":"-5.3%","d":"down"},{"l":"Templates","v":"4.540","t":"+9.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.705","2026-03-18","5.559","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.493","2026-02-25","101","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.827","2026-02-18","5.566","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","176","2026-02-23","5.343","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.182","2026-01-09","5.653","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":400},{"label":"Fev","value":580},{"label":"Mar","value":567},{"label":"Abr","value":666},{"label":"Mai","value":366},{"label":"Jun","value":545},{"label":"Jul","value":589},{"label":"Ago","value":415},{"label":"Set","value":660},{"label":"Out","value":425},{"label":"Nov","value":669},{"label":"Dez","value":675}];
const MX = 675;
