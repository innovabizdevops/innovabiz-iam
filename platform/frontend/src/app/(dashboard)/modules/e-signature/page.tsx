...
/* ═══ E-Signature Platform — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "8025", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2437", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€246K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "806254025", cells: ["E-8025", "E-Signature Platform Item 1", "18/6/2026", "€4125"], status: "active" as const },
    { id: "806257596", cells: ["E-2596", "E-Signature Platform Item 2", "5/1/2026", "€7696"], status: "pending" as const },
    { id: "806261167", cells: ["E-6167", "E-Signature Platform Item 3", "20/8/2026", "€11 267"], status: "completed" as const },
    { id: "806264738", cells: ["E-9738", "E-Signature Platform Item 4", "7/3/2026", "€14 838"], status: "warning" as const },
    { id: "806268309", cells: ["E-4309", "E-Signature Platform Item 5", "22/10/2026", "€18 409"], status: "active" as const },
];
...
export default function EsignaturePlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">E-Signature Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • E-Signature Platform</p>
                    </div>
                </div>
