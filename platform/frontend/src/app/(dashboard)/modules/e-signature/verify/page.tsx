...
const PAGE = "Verify";
const KPIS = [{"l":"Formulários Ativos","v":"4.406","t":"+8.5%","d":"up"},{"l":"Submissões/Dia","v":"2178","t":"+13.2%","d":"up"},{"l":"Documentos Gerados","v":"7.763","t":"-2.6%","d":"down"},{"l":"Templates","v":"8.443","t":"+10.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.454","2026-01-14","1.938","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.019","2026-03-02","7.659","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.929","2026-03-26","8.251","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","688","2026-03-18","1.430","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.183","2026-03-14","8.994","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":957},{"label":"Mar","value":742},{"label":"Abr","value":792},{"label":"Mai","value":703},{"label":"Jun","value":898},{"label":"Jul","value":900},{"label":"Ago","value":852},{"label":"Set","value":820},{"label":"Out","value":656},{"label":"Nov","value":901},{"label":"Dez","value":830}];
const MX = 957;
