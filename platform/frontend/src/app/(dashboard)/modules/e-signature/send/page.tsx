...
const PAGE = "Send";
const KPIS = [{"l":"Formulários Ativos","v":"3.468","t":"+5.9%","d":"up"},{"l":"Submissões/Dia","v":"2893","t":"+8.1%","d":"up"},{"l":"Documentos Gerados","v":"6.213","t":"+2.4%","d":"up"},{"l":"Templates","v":"8.195","t":"+6.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.714","2026-01-03","1.425","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.008","2026-01-28","4.021","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.243","2026-02-12","2.346","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.341","2026-03-17","4.812","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.093","2026-01-09","8.730","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":924},{"label":"Fev","value":747},{"label":"Mar","value":950},{"label":"Abr","value":878},{"label":"Mai","value":873},{"label":"Jun","value":986},{"label":"Jul","value":859},{"label":"Ago","value":782},{"label":"Set","value":746},{"label":"Out","value":1015},{"label":"Nov","value":879},{"label":"Dez","value":800}];
const MX = 1015;
