...
const PAGE = "Archive";
const KPIS = [{"l":"Formulários Ativos","v":"1.769","t":"+5.7%","d":"up"},{"l":"Submissões/Dia","v":"5077","t":"+2.0%","d":"up"},{"l":"Documentos Gerados","v":"7.575","t":"+6.6%","d":"up"},{"l":"Templates","v":"8.373","t":"+2.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.338","2026-02-28","3.983","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.939","2026-01-05","422","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.649","2026-02-17","8.874","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.476","2026-03-12","6.900","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.576","2026-01-25","2.823","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":688},{"label":"Mar","value":478},{"label":"Abr","value":688},{"label":"Mai","value":618},{"label":"Jun","value":757},{"label":"Jul","value":452},{"label":"Ago","value":675},{"label":"Set","value":544},{"label":"Out","value":463},{"label":"Nov","value":732},{"label":"Dez","value":417}];
const MX = 757;
