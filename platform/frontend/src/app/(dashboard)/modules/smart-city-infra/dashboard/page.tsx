...
const KPIS = [{"l":"Teams Ativos","v":"6.637","t":"+13.3%","d":"up"},{"l":"Reuniões/Semana","v":"1051","t":"+10.4%","d":"up"},{"l":"Mensagens/Dia","v":"202","t":"+15.1%","d":"up"},{"l":"Ficheiros Partilhados","v":"692","t":"-1.5%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","6.508","260","3.307","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.391","298","1.903","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.042","1425","3.354","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.621","1228","5.793","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","7.410","3366","4.063","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":421},{"label":"Fev","value":645},{"label":"Mar","value":452},{"label":"Abr","value":675},{"label":"Mai","value":393},{"label":"Jun","value":596},{"label":"Jul","value":379},{"label":"Ago","value":642},{"label":"Set","value":688},{"label":"Out","value":353},{"label":"Nov","value":671},{"label":"Dez","value":393}];
const MX = 688;
