...
export default function SmartCityInfraPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Smart City Infra</h1><p className="text-sm text-muted-foreground">Smart City Infra • iBOS Enterprise</p></div>
