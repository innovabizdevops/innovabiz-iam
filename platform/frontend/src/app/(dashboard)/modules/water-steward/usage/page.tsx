...
const PAGE = "Usage Track";
const KPIS = [{"l":"Total Water Steward","v":"8.520","t":"+16.2%","d":"up"},{"l":"Usage Track Ativos","v":"2.583","t":"+6.4%","d":"up"},{"l":"Eficiência (%)","v":"88.9%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"94","t":"-5.4%","d":"down"}];
const COLS = ["ID","Usage Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Steward #001","Water Steward #002","5.558","6.744","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Water Steward #002","Water Steward #003","5.270","8.532","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Steward #003","Water Steward #004","3.449","7.521","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Water Steward #004","Water Steward #005","9.098","7.390","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Steward #005","Water Steward #001","2.462","6.191","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":868},{"label":"Mar","value":679},{"label":"Abr","value":762},{"label":"Mai","value":694},{"label":"Jun","value":801},{"label":"Jul","value":719},{"label":"Ago","value":864},{"label":"Set","value":718},{"label":"Out","value":623},{"label":"Nov","value":731},{"label":"Dez","value":891}];
const MX = 891;
