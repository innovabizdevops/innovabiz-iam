...
const PAGE = "Watershed";
const KPIS = [{"l":"Total Water Steward","v":"3.321","t":"-2.8%","d":"down"},{"l":"Watershed Ativos","v":"6.260","t":"+10.5%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"77","t":"-2.8%","d":"down"}];
const COLS = ["ID","Watershed","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Steward #001","Water Steward #002","1.298","6.124","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Water Steward #002","Water Steward #003","5.684","5.715","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Steward #003","Water Steward #004","6.473","702","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Water Steward #004","Water Steward #005","7.375","3.068","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Steward #005","Water Steward #001","7.455","4.636","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":426},{"label":"Fev","value":715},{"label":"Mar","value":482},{"label":"Abr","value":572},{"label":"Mai","value":703},{"label":"Jun","value":384},{"label":"Jul","value":535},{"label":"Ago","value":720},{"label":"Set","value":551},{"label":"Out","value":618},{"label":"Nov","value":674},{"label":"Dez","value":717}];
const MX = 720;
