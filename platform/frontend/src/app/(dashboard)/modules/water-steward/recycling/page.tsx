...
const ACCENT = "#0e7490";
const MODULE = "Water Stewardship";
const PAGE = "Recycling";
const KPIS = [{"l":"Total Water Steward","v":"4.017","t":"-2.0%","d":"down"},{"l":"Recycling Ativos","v":"2.419","t":"+6.4%","d":"up"},{"l":"Eficiência (%)","v":"78.9%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"83","t":"+9.2%","d":"up"}];
const COLS = ["ID","Recycling","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Steward #001","Water Steward #002","4.884","1.008","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Water Steward #002","Water Steward #003","8.078","8.898","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Steward #003","Water Steward #004","2.509","6.107","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Water Steward #004","Water Steward #005","6.441","1.369","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Steward #005","Water Steward #001","1.467","4.353","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":269},{"label":"Fev","value":346},{"label":"Mar","value":513},{"label":"Abr","value":644},{"label":"Mai","value":464},{"label":"Jun","value":472},{"label":"Jul","value":650},{"label":"Ago","value":625},{"label":"Set","value":403},{"label":"Out","value":272},{"label":"Nov","value":436},{"label":"Dez","value":594}];
const MX = 650;
