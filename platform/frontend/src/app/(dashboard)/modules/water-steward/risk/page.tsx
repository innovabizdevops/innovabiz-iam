...
const PAGE = "Water Risk";
const KPIS = [{"l":"Riscos Identificados","v":"3.086","t":"+10.5%","d":"up"},{"l":"Mitigações Ativas","v":"2.204","t":"-3.6%","d":"down"},{"l":"Score Risco Geral","v":"93","t":"+6.0%","d":"up"},{"l":"Incidentes YTD","v":"4.968","t":"+3.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.384","4.113","2.898","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.829","5.396","6.266","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.337","895","8.467","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.459","4.720","6.564","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.254","1.603","1.125","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":772},{"label":"Mar","value":542},{"label":"Abr","value":902},{"label":"Mai","value":597},{"label":"Jun","value":721},{"label":"Jul","value":546},{"label":"Ago","value":678},{"label":"Set","value":823},{"label":"Out","value":508},{"label":"Nov","value":879},{"label":"Dez","value":555}];
const MX = 902;
