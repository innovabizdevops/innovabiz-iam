...
const PAGE = "SoH";
const KPIS = [{"l":"Total Battery Mgmt","v":"7.946","t":"-0.3%","d":"down"},{"l":"SoH Ativos","v":"8.385","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"72.0%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"85","t":"+2.0%","d":"up"}];
const COLS = ["ID","SoH","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Battery Mgmt #001","Battery Mgmt #002","6.297","6.792","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Battery Mgmt #002","Battery Mgmt #003","483","5.168","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Battery Mgmt #003","Battery Mgmt #004","6.556","570","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Battery Mgmt #004","Battery Mgmt #005","7.305","1.574","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Battery Mgmt #005","Battery Mgmt #001","4.952","1.798","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":897},{"label":"Fev","value":819},{"label":"Mar","value":1073},{"label":"Abr","value":1034},{"label":"Mai","value":922},{"label":"Jun","value":943},{"label":"Jul","value":879},{"label":"Ago","value":734},{"label":"Set","value":880},{"label":"Out","value":917},{"label":"Nov","value":736},{"label":"Dez","value":826}];
const MX = 1073;
