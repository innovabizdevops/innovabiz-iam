...
const PAGE = "Recycle";
const KPIS = [{"l":"Total Battery Mgmt","v":"2.680","t":"+8.0%","d":"up"},{"l":"Recycle Ativos","v":"2.819","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"71.2%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"63","t":"-5.2%","d":"down"}];
const COLS = ["ID","Recycle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Battery Mgmt #001","Battery Mgmt #002","6.374","5.409","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Battery Mgmt #002","Battery Mgmt #003","1.533","2.033","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Battery Mgmt #003","Battery Mgmt #004","5.521","8.129","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Battery Mgmt #004","Battery Mgmt #005","8.057","2.855","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Battery Mgmt #005","Battery Mgmt #001","7.734","414","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":861},{"label":"Fev","value":1005},{"label":"Mar","value":893},{"label":"Abr","value":983},{"label":"Mai","value":863},{"label":"Jun","value":945},{"label":"Jul","value":794},{"label":"Ago","value":891},{"label":"Set","value":847},{"label":"Out","value":666},{"label":"Nov","value":750},{"label":"Dez","value":917}];
const MX = 1005;
