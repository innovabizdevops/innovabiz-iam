...
const KPIS = [
    ...
    { label: "Ativos", value: "4097", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€190K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1488408616", cells: ["BAT-7616", "Battery Management System Item 1", "17/5/2026", "€8716"], status: "active" as const },
    { id: "1488412187", cells: ["BAT-2187", "Battery Management System Item 2", "4/12/2026", "€12 287"], status: "pending" as const },
    { id: "1488415758", cells: ["BAT-5758", "Battery Management System Item 3", "19/7/2026", "€15 858"], status: "completed" as const },
    { id: "1488419329", cells: ["BAT-9329", "Battery Management System Item 4", "6/2/2026", "€19 429"], status: "warning" as const },
    { id: "1488422900", cells: ["BAT-3900", "Battery Management System Item 5", "21/9/2026", "€23 000"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Battery Management System</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Battery Management System</p>
                    </div>
                </div>
