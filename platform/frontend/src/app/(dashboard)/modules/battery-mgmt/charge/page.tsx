...
const PAGE = "Charge";
const KPIS = [{"l":"Total Battery Mgmt","v":"405","t":"+1.2%","d":"up"},{"l":"Charge Ativos","v":"7.953","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"79.0%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"65","t":"+4.5%","d":"up"}];
const COLS = ["ID","Charge","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Battery Mgmt #001","Battery Mgmt #002","1.140","1.523","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Battery Mgmt #002","Battery Mgmt #003","3.924","1.538","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Battery Mgmt #003","Battery Mgmt #004","3.557","4.604","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Battery Mgmt #004","Battery Mgmt #005","5.288","716","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Battery Mgmt #005","Battery Mgmt #001","4.404","2.613","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":848},{"label":"Fev","value":617},{"label":"Mar","value":782},{"label":"Abr","value":631},{"label":"Mai","value":722},{"label":"Jun","value":837},{"label":"Jul","value":808},{"label":"Ago","value":742},{"label":"Set","value":527},{"label":"Out","value":809},{"label":"Nov","value":575},{"label":"Dez","value":587}];
const MX = 848;
