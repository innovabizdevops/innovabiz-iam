...
const KPIS = [{"l":"Total Battery Mgmt","v":"1.351","t":"-4.9%","d":"down"},{"l":"Lifecycle Ativos","v":"4.531","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"83.9%","t":"+1.5%","d":"up"},{"l":"Score Performance","v":"76","t":"-4.4%","d":"down"}];
const COLS = ["ID","Lifecycle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Battery Mgmt #001","Battery Mgmt #002","2.312","8.124","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Battery Mgmt #002","Battery Mgmt #003","505","2.349","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Battery Mgmt #003","Battery Mgmt #004","3.765","1.258","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Battery Mgmt #004","Battery Mgmt #005","8.033","6.684","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Battery Mgmt #005","Battery Mgmt #001","4.110","8.341","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":600},{"label":"Mar","value":949},{"label":"Abr","value":721},{"label":"Mai","value":838},{"label":"Jun","value":881},{"label":"Jul","value":870},{"label":"Ago","value":657},{"label":"Set","value":831},{"label":"Out","value":856},{"label":"Nov","value":818},{"label":"Dez","value":787}];
const MX = 949;
