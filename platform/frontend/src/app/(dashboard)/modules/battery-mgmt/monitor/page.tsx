...
const ACCENT = "#1e3a5f";
const MODULE = "Battery Management System";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Battery Mgmt","v":"5.446","t":"+0.1%","d":"up"},{"l":"Monitor Ativos","v":"1.770","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"74.3%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"67","t":"+1.0%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Battery Mgmt #001","Battery Mgmt #002","136","2.251","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Battery Mgmt #002","Battery Mgmt #003","8.878","6.647","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Battery Mgmt #003","Battery Mgmt #004","7.667","3.706","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Battery Mgmt #004","Battery Mgmt #005","3.798","2.631","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Battery Mgmt #005","Battery Mgmt #001","1.569","6.734","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":346},{"label":"Mar","value":517},{"label":"Abr","value":299},{"label":"Mai","value":467},{"label":"Jun","value":547},{"label":"Jul","value":405},{"label":"Ago","value":296},{"label":"Set","value":587},{"label":"Out","value":606},{"label":"Nov","value":389},{"label":"Dez","value":544}];
const MX = 606;
