...
const ACCENT = "#312e81";
const MODULE = "3D Print Materials";
const PAGE = "Inventory";
const KPIS = [{"l":"Total 3d Material","v":"1.239","t":"+12.4%","d":"up"},{"l":"Inventory Ativos","v":"1.826","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"91","t":"+7.8%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Material #001","3d Material #002","9.062","6.350","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["3d Material #002","3d Material #003","1.172","936","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Material #003","3d Material #004","4.446","2.733","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["3d Material #004","3d Material #005","4.739","2.850","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Material #005","3d Material #001","5.160","3.226","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":992},{"label":"Fev","value":894},{"label":"Mar","value":795},{"label":"Abr","value":848},{"label":"Mai","value":670},{"label":"Jun","value":654},{"label":"Jul","value":1033},{"label":"Ago","value":884},{"label":"Set","value":822},{"label":"Out","value":936},{"label":"Nov","value":1017},{"label":"Dez","value":657}];
const MX = 1033;
