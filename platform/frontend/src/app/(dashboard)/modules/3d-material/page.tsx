...
/* ═══ 3D Print Materials — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "9802", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "982", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€270K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1576673802", cells: ["3D-9802", "3D Print Materials Item 1", "19/7/2026", "€23 902"], status: "active" as const },
    { id: "1576677373", cells: ["3D-4373", "3D Print Materials Item 2", "6/2/2026", "€27 473"], status: "pending" as const },
    { id: "1576680944", cells: ["3D-7944", "3D Print Materials Item 3", "21/9/2026", "€31 044"], status: "completed" as const },
    { id: "1576684515", cells: ["3D-2515", "3D Print Materials Item 4", "8/4/2026", "€34 615"], status: "warning" as const },
    { id: "1576688086", cells: ["3D-6086", "3D Print Materials Item 5", "23/11/2026", "€38 186"], status: "active" as const },
];
...
export default function P3dPrintMaterialsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">3D Print Materials</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • 3D Print Materials</p>
                    </div>
                </div>
