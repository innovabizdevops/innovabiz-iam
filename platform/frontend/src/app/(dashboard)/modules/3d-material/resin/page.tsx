...
const PAGE = "Resin";
const KPIS = [{"l":"Total 3d Material","v":"1.108","t":"-0.2%","d":"down"},{"l":"Resin Ativos","v":"6.129","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"67.6%","t":"+4.1%","d":"up"},{"l":"Score Performance","v":"77","t":"+12.8%","d":"up"}];
const COLS = ["ID","Resin","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Material #001","3d Material #002","6.558","3.544","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["3d Material #002","3d Material #003","5.989","8.824","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Material #003","3d Material #004","6.323","6.532","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["3d Material #004","3d Material #005","606","6.643","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Material #005","3d Material #001","8.537","1.377","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":926},{"label":"Fev","value":656},{"label":"Mar","value":891},{"label":"Abr","value":653},{"label":"Mai","value":635},{"label":"Jun","value":697},{"label":"Jul","value":899},{"label":"Ago","value":859},{"label":"Set","value":671},{"label":"Out","value":868},{"label":"Nov","value":888},{"label":"Dez","value":952}];
const MX = 952;
