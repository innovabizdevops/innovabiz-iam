...
const PAGE = "Filament";
const KPIS = [{"l":"Total 3d Material","v":"2.309","t":"+8.5%","d":"up"},{"l":"Filament Ativos","v":"4.792","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"79.5%","t":"+2.5%","d":"up"},{"l":"Score Performance","v":"67","t":"+3.1%","d":"up"}];
const COLS = ["ID","Filament","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Material #001","3d Material #002","822","2.716","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["3d Material #002","3d Material #003","1.054","7.681","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Material #003","3d Material #004","8.445","4.622","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["3d Material #004","3d Material #005","8.079","7.914","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Material #005","3d Material #001","2.620","6.247","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":914},{"label":"Fev","value":776},{"label":"Mar","value":925},{"label":"Abr","value":797},{"label":"Mai","value":956},{"label":"Jun","value":882},{"label":"Jul","value":868},{"label":"Ago","value":788},{"label":"Set","value":1053},{"label":"Out","value":838},{"label":"Nov","value":896},{"label":"Dez","value":758}];
const MX = 1053;
