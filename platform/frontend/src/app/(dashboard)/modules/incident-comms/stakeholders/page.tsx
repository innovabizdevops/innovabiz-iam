...
const KPIS = [{"l":"Tickets Abertos","v":"3.718","t":"+1.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"85.3%","t":"-3.9%","d":"down"},{"l":"MTTR (h)","v":"41h","t":"+12.1%","d":"up"},{"l":"Satisfação (%)","v":"82.9%","t":"+2.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","138","7.273","6.630","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.620","3.590","2.267","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.724","7.999","3.739","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","127","5.786","2.331","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.565","2.327","6.688","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":835},{"label":"Fev","value":859},{"label":"Mar","value":823},{"label":"Abr","value":920},{"label":"Mai","value":949},{"label":"Jun","value":1010},{"label":"Jul","value":852},{"label":"Ago","value":989},{"label":"Set","value":934},{"label":"Out","value":948},{"label":"Nov","value":752},{"label":"Dez","value":651}];
const MX = 1010;
