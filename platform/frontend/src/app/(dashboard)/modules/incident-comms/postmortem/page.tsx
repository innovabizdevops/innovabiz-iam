...
const PAGE = "Post-Mortem";
const KPIS = [{"l":"Tickets Abertos","v":"8.474","t":"-4.7%","d":"down"},{"l":"SLA Cumprido (%)","v":"73.4%","t":"+10.6%","d":"up"},{"l":"MTTR (h)","v":"203h","t":"+5.6%","d":"up"},{"l":"Satisfação (%)","v":"66.4%","t":"+3.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.410","5.185","3.195","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.657","2.800","1.763","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.934","1.488","2.335","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.464","6.241","5.813","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.119","3.512","7.728","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":761},{"label":"Mar","value":749},{"label":"Abr","value":614},{"label":"Mai","value":884},{"label":"Jun","value":739},{"label":"Jul","value":640},{"label":"Ago","value":744},{"label":"Set","value":667},{"label":"Out","value":851},{"label":"Nov","value":881},{"label":"Dez","value":496}];
const MX = 884;
