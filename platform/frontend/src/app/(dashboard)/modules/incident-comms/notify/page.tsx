...
const PAGE = "Subscriber Notify";
const KPIS = [{"l":"Tickets Abertos","v":"355","t":"+6.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"93.4%","t":"+7.0%","d":"up"},{"l":"MTTR (h)","v":"55h","t":"+3.0%","d":"up"},{"l":"Satisfação (%)","v":"93.0%","t":"+17.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.184","8.240","2.020","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.254","312","3.163","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.039","5.283","7.642","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.632","5.388","8.111","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.750","7.856","4.700","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":336},{"label":"Mar","value":288},{"label":"Abr","value":310},{"label":"Mai","value":361},{"label":"Jun","value":279},{"label":"Jul","value":359},{"label":"Ago","value":471},{"label":"Set","value":582},{"label":"Out","value":378},{"label":"Nov","value":598},{"label":"Dez","value":476}];
const MX = 598;
