...
const PAGE = "Runbook Library";
const KPIS = [{"l":"Tickets Abertos","v":"5.531","t":"-5.2%","d":"down"},{"l":"SLA Cumprido (%)","v":"86.5%","t":"+4.5%","d":"up"},{"l":"MTTR (h)","v":"107h","t":"-0.8%","d":"down"},{"l":"Satisfação (%)","v":"94.3%","t":"+0.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.520","5.357","8.558","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.628","3.537","7.693","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.871","5.135","573","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.220","1.410","7.865","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.520","952","8.746","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":415},{"label":"Fev","value":233},{"label":"Mar","value":394},{"label":"Abr","value":282},{"label":"Mai","value":336},{"label":"Jun","value":297},{"label":"Jul","value":357},{"label":"Ago","value":394},{"label":"Set","value":477},{"label":"Out","value":516},{"label":"Nov","value":217},{"label":"Dez","value":601}];
const MX = 601;
