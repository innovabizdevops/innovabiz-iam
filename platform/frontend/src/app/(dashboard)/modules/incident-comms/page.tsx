...
export default function IncidentCommsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Incident Comms</h1><p className="text-sm text-muted-foreground">Incident Comms • iBOS Enterprise</p></div>
