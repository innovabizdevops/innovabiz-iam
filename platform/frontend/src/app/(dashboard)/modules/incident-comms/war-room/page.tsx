...
const PAGE = "War Room";
const KPIS = [{"l":"Tickets Abertos","v":"5.273","t":"+12.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"71.2%","t":"+14.0%","d":"up"},{"l":"MTTR (h)","v":"56h","t":"+5.5%","d":"up"},{"l":"Satisfação (%)","v":"88.6%","t":"-2.2%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","412","5.081","3.996","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.928","5.155","8.709","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.162","1.659","4.158","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","880","937","2.224","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.975","6.105","3.915","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":631},{"label":"Mar","value":454},{"label":"Abr","value":294},{"label":"Mai","value":672},{"label":"Jun","value":644},{"label":"Jul","value":607},{"label":"Ago","value":658},{"label":"Set","value":407},{"label":"Out","value":662},{"label":"Nov","value":581},{"label":"Dez","value":417}];
const MX = 672;
