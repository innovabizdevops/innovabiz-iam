...
const ACCENT = "#dc2626";
const MODULE = "Incident Communications";
const PAGE = "Incident Timeline";
const KPIS = [{"l":"Tickets Abertos","v":"3.229","t":"-5.5%","d":"down"},{"l":"SLA Cumprido (%)","v":"81.0%","t":"+11.7%","d":"up"},{"l":"MTTR (h)","v":"134h","t":"+11.0%","d":"up"},{"l":"Satisfação (%)","v":"76.8%","t":"+10.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.080","5.020","4.972","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.038","5.129","2.348","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.549","1.749","7.752","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.924","3.394","1.191","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.519","3.668","772","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":676},{"label":"Mar","value":448},{"label":"Abr","value":573},{"label":"Mai","value":310},{"label":"Jun","value":557},{"label":"Jul","value":564},{"label":"Ago","value":429},{"label":"Set","value":465},{"label":"Out","value":430},{"label":"Nov","value":656},{"label":"Dez","value":485}];
const MX = 676;
