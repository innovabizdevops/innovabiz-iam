...
const KPIS = [{"l":"Tickets Abertos","v":"537","t":"+5.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"92.0%","t":"+3.4%","d":"up"},{"l":"MTTR (h)","v":"52h","t":"-2.9%","d":"down"},{"l":"Satisfação (%)","v":"71.0%","t":"-0.7%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.455","3.570","6.561","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.865","5.301","5.748","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.356","3.531","3.781","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.719","3.164","3.850","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.476","308","4.914","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":609},{"label":"Mar","value":477},{"label":"Abr","value":506},{"label":"Mai","value":747},{"label":"Jun","value":740},{"label":"Jul","value":446},{"label":"Ago","value":804},{"label":"Set","value":570},{"label":"Out","value":675},{"label":"Nov","value":566},{"label":"Dez","value":586}];
const MX = 804;
