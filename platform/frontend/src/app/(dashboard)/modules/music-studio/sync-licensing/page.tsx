...
/* ═══ Music Studio — Sync Licensing ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "2530", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "44", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "455", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1805764440", cells: ["MUS-5440", "Sync Licensing Item 1", "5/1/2026", "€14 540"], status: "active" as const },
    { id: "1805768011", cells: ["MUS-9011", "Sync Licensing Item 2", "20/8/2026", "€18 111"], status: "pending" as const },
    { id: "1805771582", cells: ["MUS-3582", "Sync Licensing Item 3", "7/3/2026", "€21 682"], status: "completed" as const },
    { id: "1805775153", cells: ["MUS-7153", "Sync Licensing Item 4", "22/10/2026", "€25 253"], status: "warning" as const },
    { id: "1805778724", cells: ["MUS-1724", "Sync Licensing Item 5", "9/5/2026", "€28 824"], status: "active" as const },
];
...
export default function MusicStudioSyncLicensingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sync Licensing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Music Studio • Sync Licensing</p>
                    </div>
                </div>
