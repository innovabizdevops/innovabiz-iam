...
/* ═══ Music Studio — Mixing Master ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "88", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "65", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2740", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "78%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1668699821", cells: ["MUS-1821", "Mixing Master Item 1", "6/6/2026", "€49 921"], status: "active" as const },
    { id: "1668703392", cells: ["MUS-5392", "Mixing Master Item 2", "21/1/2026", "€3492"], status: "pending" as const },
    { id: "1668706963", cells: ["MUS-8963", "Mixing Master Item 3", "8/8/2026", "€7063"], status: "completed" as const },
    { id: "1668710534", cells: ["MUS-3534", "Mixing Master Item 4", "23/3/2026", "€10 634"], status: "warning" as const },
    { id: "1668714105", cells: ["MUS-7105", "Mixing Master Item 5", "10/10/2026", "€14 205"], status: "active" as const },
];
...
export default function MusicStudioMixingMasterPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mixing Master</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Music Studio • Mixing Master</p>
                    </div>
                </div>
