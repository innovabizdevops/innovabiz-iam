...
/* ═══ Music Studio — Catalog Mgmt Music ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "383", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "336", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2585", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "99%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "242819132", cells: ["MUS-9132", "Catalog Mgmt Music Item 1", "25/9/2026", "€19 232"], status: "active" as const },
    { id: "242822703", cells: ["MUS-3703", "Catalog Mgmt Music Item 2", "12/4/2026", "€22 803"], status: "pending" as const },
    { id: "242826274", cells: ["MUS-7274", "Catalog Mgmt Music Item 3", "27/11/2026", "€26 374"], status: "completed" as const },
    { id: "242829845", cells: ["MUS-1845", "Catalog Mgmt Music Item 4", "14/6/2026", "€29 945"], status: "warning" as const },
    { id: "242833416", cells: ["MUS-5416", "Catalog Mgmt Music Item 5", "1/1/2026", "€33 516"], status: "active" as const },
];
...
export default function MusicStudioCatalogMgmtMusicPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Catalog Mgmt Music</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Music Studio • Catalog Mgmt Music</p>
                    </div>
                </div>
