...
const KPIS = [
    { label: "Total", value: "1031", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "60", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "68", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "116601240", cells: ["MUS-7240", "Recording Session Item 1", "1/1/2026", "€1340"], status: "active" as const },
    { id: "116604811", cells: ["MUS-1811", "Recording Session Item 2", "16/8/2026", "€4911"], status: "pending" as const },
    { id: "116608382", cells: ["MUS-5382", "Recording Session Item 3", "3/3/2026", "€8482"], status: "completed" as const },
    { id: "116611953", cells: ["MUS-8953", "Recording Session Item 4", "18/10/2026", "€12 053"], status: "warning" as const },
    { id: "116615524", cells: ["MUS-3524", "Recording Session Item 5", "5/5/2026", "€15 624"], status: "active" as const },
];
...
export default function MusicStudioRecordingSessionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Recording Session</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Music Studio • Recording Session</p>
                    </div>
                </div>
