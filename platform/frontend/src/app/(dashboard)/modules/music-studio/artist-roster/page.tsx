...
/* ═══ Music Studio — Artist Roster ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "1083", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "217", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2234", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1544619125", cells: ["MUS-4125", "Artist Roster Item 1", "22/6/2026", "€19 225"], status: "active" as const },
    { id: "1544622696", cells: ["MUS-7696", "Artist Roster Item 2", "9/1/2026", "€22 796"], status: "pending" as const },
    { id: "1544626267", cells: ["MUS-2267", "Artist Roster Item 3", "24/8/2026", "€26 367"], status: "completed" as const },
    { id: "1544629838", cells: ["MUS-5838", "Artist Roster Item 4", "11/3/2026", "€29 938"], status: "warning" as const },
    { id: "1544633409", cells: ["MUS-9409", "Artist Roster Item 5", "26/10/2026", "€33 509"], status: "active" as const },
];
...
export default function MusicStudioArtistRosterPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Artist Roster</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Music Studio • Artist Roster</p>
                    </div>
                </div>
