...
/* ═══ Music Studio — A And R ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "1897", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "473", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3771", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1481311429", cells: ["MUS-2429", "A And R Item 1", "18/2/2026", "€11 529"], status: "active" as const },
    { id: "1481315000", cells: ["MUS-6000", "A And R Item 2", "5/9/2026", "€15 100"], status: "pending" as const },
    { id: "1481318571", cells: ["MUS-9571", "A And R Item 3", "20/4/2026", "€18 671"], status: "completed" as const },
    { id: "1481322142", cells: ["MUS-4142", "A And R Item 4", "7/11/2026", "€22 242"], status: "warning" as const },
    { id: "1481325713", cells: ["MUS-7713", "A And R Item 5", "22/6/2026", "€25 813"], status: "active" as const },
];
...
export default function MusicStudioAAndRPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">A And R</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Music Studio • A And R</p>
                    </div>
                </div>
