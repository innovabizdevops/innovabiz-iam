...
/* ═══ Music Studio — Tour Mgmt ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "4392", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "206", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1693", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1608658170", cells: ["MUS-8170", "Tour Mgmt Item 1", "15/7/2026", "€8270"], status: "active" as const },
    { id: "1608661741", cells: ["MUS-2741", "Tour Mgmt Item 2", "2/2/2026", "€11 841"], status: "pending" as const },
    { id: "1608665312", cells: ["MUS-6312", "Tour Mgmt Item 3", "17/9/2026", "€15 412"], status: "completed" as const },
    { id: "1608668883", cells: ["MUS-9883", "Tour Mgmt Item 4", "4/4/2026", "€18 983"], status: "warning" as const },
    { id: "1608672454", cells: ["MUS-4454", "Tour Mgmt Item 5", "19/11/2026", "€22 554"], status: "active" as const },
];
...
export default function MusicStudioTourMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tour Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Music Studio • Tour Mgmt</p>
                    </div>
                </div>
