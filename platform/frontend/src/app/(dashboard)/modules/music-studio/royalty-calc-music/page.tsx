...
/* ═══ Music Studio — Royalty Calc Music ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "2808", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "279", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "65", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1483638467", cells: ["MUS-7467", "Royalty Calc Music Item 1", "4/12/2026", "€38 567"], status: "active" as const },
    { id: "1483642038", cells: ["MUS-2038", "Royalty Calc Music Item 2", "19/7/2026", "€42 138"], status: "pending" as const },
    { id: "1483645609", cells: ["MUS-5609", "Royalty Calc Music Item 3", "6/2/2026", "€45 709"], status: "completed" as const },
    { id: "1483649180", cells: ["MUS-9180", "Royalty Calc Music Item 4", "21/9/2026", "€49 280"], status: "warning" as const },
    { id: "1483652751", cells: ["MUS-3751", "Royalty Calc Music Item 5", "8/4/2026", "€2851"], status: "active" as const },
];
...
export default function MusicStudioRoyaltyCalcMusicPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Royalty Calc Music</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Music Studio • Royalty Calc Music</p>
                    </div>
                </div>
