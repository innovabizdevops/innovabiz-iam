...
/* ═══ Music Studio — Fan Engagement Music ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "4096", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "276", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3579", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "569691008", cells: ["MUS-1008", "Fan Engagement Music Item 1", "13/9/2026", "€41 108"], status: "active" as const },
    { id: "569694579", cells: ["MUS-4579", "Fan Engagement Music Item 2", "28/4/2026", "€44 679"], status: "pending" as const },
    { id: "569698150", cells: ["MUS-8150", "Fan Engagement Music Item 3", "15/11/2026", "€48 250"], status: "completed" as const },
    { id: "569701721", cells: ["MUS-2721", "Fan Engagement Music Item 4", "2/6/2026", "€1821"], status: "warning" as const },
    { id: "569705292", cells: ["MUS-6292", "Fan Engagement Music Item 5", "17/1/2026", "€5392"], status: "active" as const },
];
...
export default function MusicStudioFanEngagementMusicPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fan Engagement Music</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Music Studio • Fan Engagement Music</p>
                    </div>
                </div>
