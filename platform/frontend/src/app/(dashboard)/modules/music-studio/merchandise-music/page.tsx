...
/* ═══ Music Studio — Merchandise Music ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "316", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "93", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1708", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "90%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "761480633", cells: ["MUS-9633", "Merchandise Music Item 1", "26/6/2026", "€30 733"], status: "active" as const },
    { id: "761484204", cells: ["MUS-4204", "Merchandise Music Item 2", "13/1/2026", "€34 304"], status: "pending" as const },
    { id: "761487775", cells: ["MUS-7775", "Merchandise Music Item 3", "28/8/2026", "€37 875"], status: "completed" as const },
    { id: "761491346", cells: ["MUS-2346", "Merchandise Music Item 4", "15/3/2026", "€41 446"], status: "warning" as const },
    { id: "761494917", cells: ["MUS-5917", "Merchandise Music Item 5", "2/10/2026", "€45 017"], status: "active" as const },
];
...
export default function MusicStudioMerchandiseMusicPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Merchandise Music</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Music Studio • Merchandise Music</p>
                    </div>
                </div>
