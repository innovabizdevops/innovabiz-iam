...
const PAGE = "Battery Pack";
const KPIS = [{"l":"Veículos Operação","v":"1.170","t":"+17.8%","d":"up"},{"l":"Viagens/Dia","v":"2691","t":"+15.3%","d":"up"},{"l":"Pontualidade (%)","v":"76.3%","t":"-5.8%","d":"down"},{"l":"Passageiros/Dia","v":"1401","t":"+17.4%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-27","2026-01-02","8.828","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-21","2026-02-10","7.346","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-21","2026-02-04","7.460","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-14","2026-03-04","5.084","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-05","2026-01-25","3.801","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":421},{"label":"Fev","value":393},{"label":"Mar","value":610},{"label":"Abr","value":520},{"label":"Mai","value":552},{"label":"Jun","value":516},{"label":"Jul","value":537},{"label":"Ago","value":471},{"label":"Set","value":538},{"label":"Out","value":449},{"label":"Nov","value":369},{"label":"Dez","value":470}];
const MX = 610;
