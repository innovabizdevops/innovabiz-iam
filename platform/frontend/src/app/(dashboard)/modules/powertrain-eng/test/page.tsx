...
const PAGE = "Test";
const KPIS = [{"l":"Veículos Operação","v":"1.434","t":"+1.6%","d":"up"},{"l":"Viagens/Dia","v":"2787","t":"+15.0%","d":"up"},{"l":"Pontualidade (%)","v":"66.3%","t":"-0.6%","d":"down"},{"l":"Passageiros/Dia","v":"4063","t":"+6.1%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-12","2026-02-22","8.745","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-28","2026-03-04","8.987","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-15","2026-02-08","8.938","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-16","2026-03-23","3.971","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-11","2026-03-22","2.576","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":793},{"label":"Fev","value":769},{"label":"Mar","value":771},{"label":"Abr","value":516},{"label":"Mai","value":806},{"label":"Jun","value":830},{"label":"Jul","value":745},{"label":"Ago","value":694},{"label":"Set","value":526},{"label":"Out","value":588},{"label":"Nov","value":826},{"label":"Dez","value":571}];
const MX = 830;
