...
const PAGE = "Transmission";
const KPIS = [{"l":"Veículos Operação","v":"4.341","t":"-5.3%","d":"down"},{"l":"Viagens/Dia","v":"906","t":"+9.3%","d":"up"},{"l":"Pontualidade (%)","v":"74.4%","t":"+11.3%","d":"up"},{"l":"Passageiros/Dia","v":"3322","t":"-4.4%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-05","2026-01-22","1.958","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-13","2026-01-22","3.744","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-15","2026-03-22","6.111","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-18","2026-03-26","1.339","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-19","2026-01-05","3.130","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":768},{"label":"Mar","value":565},{"label":"Abr","value":681},{"label":"Mai","value":538},{"label":"Jun","value":860},{"label":"Jul","value":634},{"label":"Ago","value":615},{"label":"Set","value":765},{"label":"Out","value":874},{"label":"Nov","value":655},{"label":"Dez","value":779}];
const MX = 874;
