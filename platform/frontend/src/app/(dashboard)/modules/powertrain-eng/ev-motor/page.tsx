...
const ACCENT = "#6366f1";
const MODULE = "Powertrain Engineering";
const PAGE = "EV Motor";
const KPIS = [{"l":"Veículos Operação","v":"3.633","t":"-0.1%","d":"down"},{"l":"Viagens/Dia","v":"3434","t":"+0.6%","d":"up"},{"l":"Pontualidade (%)","v":"90.1%","t":"+8.4%","d":"up"},{"l":"Passageiros/Dia","v":"5015","t":"+8.9%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-05","2026-01-21","5.509","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-25","2026-01-09","4.759","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-07","2026-03-16","3.703","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-03","2026-01-26","8.633","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-08","2026-02-15","4.782","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":693},{"label":"Mar","value":527},{"label":"Abr","value":874},{"label":"Mai","value":773},{"label":"Jun","value":697},{"label":"Jul","value":872},{"label":"Ago","value":824},{"label":"Set","value":548},{"label":"Out","value":527},{"label":"Nov","value":624},{"label":"Dez","value":790}];
const MX = 874;
...
export default function EvMotorPage() {
    return (
