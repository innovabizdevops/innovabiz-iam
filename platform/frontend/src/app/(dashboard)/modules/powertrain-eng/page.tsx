...
export default function PowertrainEngPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Powertrain Eng</h1><p className="text-sm text-muted-foreground">Powertrain Eng • iBOS Enterprise</p></div>
