...
const PAGE = "Engine";
const KPIS = [{"l":"Veículos Operação","v":"163","t":"+3.2%","d":"up"},{"l":"Viagens/Dia","v":"3847","t":"+3.4%","d":"up"},{"l":"Pontualidade (%)","v":"93.6%","t":"+2.0%","d":"up"},{"l":"Passageiros/Dia","v":"811","t":"+14.1%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-15","2026-03-07","5.980","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-07","2026-02-28","5.979","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-19","2026-03-01","5.406","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-16","2026-02-24","5.258","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-18","2026-03-12","6.523","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":622},{"label":"Mar","value":479},{"label":"Abr","value":668},{"label":"Mai","value":476},{"label":"Jun","value":757},{"label":"Jul","value":549},{"label":"Ago","value":602},{"label":"Set","value":745},{"label":"Out","value":578},{"label":"Nov","value":575},{"label":"Dez","value":551}];
const MX = 798;
