...
const ACCENT = "#d946ef";
const MODULE = "Composable Commerce";
const PAGE = "Headless Storefront";
const KPIS = [{"l":"Pedidos/Dia","v":"4704","t":"-2.1%","d":"down"},{"l":"GMV (€)","v":"€68871","t":"+16.9%","d":"up"},{"l":"Conversão (%)","v":"91.1%","t":"+1.4%","d":"up"},{"l":"AOV (€)","v":"€86272","t":"-5.0%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 11239.09","4.589","8.905","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 10427.87","176","9.047","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 31235.69","2.874","6.724","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 6409.91","6.711","3.837","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 15232.88","6.973","2.331","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":435},{"label":"Fev","value":335},{"label":"Mar","value":606},{"label":"Abr","value":438},{"label":"Mai","value":600},{"label":"Jun","value":490},{"label":"Jul","value":309},{"label":"Ago","value":649},{"label":"Set","value":468},{"label":"Out","value":406},{"label":"Nov","value":346},{"label":"Dez","value":303}];
const MX = 649;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#d946ef'}}>MACH</span></h1>
                </div>
