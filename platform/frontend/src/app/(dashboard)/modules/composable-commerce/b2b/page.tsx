...
const PAGE = "B2B Commerce Portal";
const KPIS = [{"l":"Pedidos/Dia","v":"1731","t":"+17.0%","d":"up"},{"l":"GMV (€)","v":"€11549","t":"+0.8%","d":"up"},{"l":"Conversão (%)","v":"72.8%","t":"+6.5%","d":"up"},{"l":"AOV (€)","v":"€86499","t":"+6.6%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 5664.46","500","7.923","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 24695.83","4.907","6.734","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 34693.92","5.509","6.195","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 16168.24","3.446","2.891","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 14646.61","6.590","8.870","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":441},{"label":"Mar","value":545},{"label":"Abr","value":660},{"label":"Mai","value":500},{"label":"Jun","value":308},{"label":"Jul","value":570},{"label":"Ago","value":424},{"label":"Set","value":439},{"label":"Out","value":556},{"label":"Nov","value":371},{"label":"Dez","value":302}];
const MX = 660;
