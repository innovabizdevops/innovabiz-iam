...
const KPIS = [{"l":"Pedidos/Dia","v":"1315","t":"+2.1%","d":"up"},{"l":"GMV (€)","v":"€64557","t":"-5.8%","d":"down"},{"l":"Conversão (%)","v":"93.7%","t":"+15.0%","d":"up"},{"l":"AOV (€)","v":"€36354","t":"+14.9%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 34264.16","1.474","7.384","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 20942.44","5.574","5.077","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 43669.95","1.799","4.002","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 40478.11","2.129","7.865","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 39179.16","1.927","8.366","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":737},{"label":"Mar","value":549},{"label":"Abr","value":623},{"label":"Mai","value":609},{"label":"Jun","value":876},{"label":"Jul","value":697},{"label":"Ago","value":677},{"label":"Set","value":783},{"label":"Out","value":615},{"label":"Nov","value":706},{"label":"Dez","value":638}];
const MX = 876;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#d946ef'}}>AI</span></h1>
                </div>
