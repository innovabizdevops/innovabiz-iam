...
const KPIS = [{"l":"Total Public Health Emr","v":"1.303","t":"-1.7%","d":"down"},{"l":"Surveillance Ativos","v":"7.556","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"93.5%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"75","t":"+16.7%","d":"up"}];
const COLS = ["ID","Surveillance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Health Emr #001","Public Health Emr #002","2.510","3.025","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Public Health Emr #002","Public Health Emr #003","542","1.186","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Health Emr #003","Public Health Emr #004","5.732","7.005","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Public Health Emr #004","Public Health Emr #005","1.064","5.014","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Health Emr #005","Public Health Emr #001","5.545","929","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":296},{"label":"Fev","value":299},{"label":"Mar","value":327},{"label":"Abr","value":411},{"label":"Mai","value":574},{"label":"Jun","value":586},{"label":"Jul","value":298},{"label":"Ago","value":389},{"label":"Set","value":600},{"label":"Out","value":398},{"label":"Nov","value":622},{"label":"Dez","value":460}];
const MX = 622;
