...
export default function PublicHealthEmrPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Public Health Emr</h1><p className="text-sm text-muted-foreground">Public Health Emr • iBOS Enterprise</p></div>
