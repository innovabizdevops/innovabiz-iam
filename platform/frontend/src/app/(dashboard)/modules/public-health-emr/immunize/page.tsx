...
const PAGE = "Immunize";
const KPIS = [{"l":"Total Public Health Emr","v":"4.878","t":"+10.4%","d":"up"},{"l":"Immunize Ativos","v":"271","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"69.7%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"86","t":"-4.8%","d":"down"}];
const COLS = ["ID","Immunize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Health Emr #001","Public Health Emr #002","374","4.142","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Public Health Emr #002","Public Health Emr #003","5.189","1.537","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Health Emr #003","Public Health Emr #004","3.380","6.886","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Public Health Emr #004","Public Health Emr #005","4.724","2.740","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Health Emr #005","Public Health Emr #001","3.919","3.394","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":380},{"label":"Fev","value":290},{"label":"Mar","value":528},{"label":"Abr","value":617},{"label":"Mai","value":626},{"label":"Jun","value":369},{"label":"Jul","value":418},{"label":"Ago","value":592},{"label":"Set","value":544},{"label":"Out","value":381},{"label":"Nov","value":645},{"label":"Dez","value":291}];
const MX = 645;
...
export default function ImmunizePage() {
    return (
