...
const PAGE = "Inspect";
const KPIS = [{"l":"Total Public Health Emr","v":"8.969","t":"+12.6%","d":"up"},{"l":"Inspect Ativos","v":"3.142","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"72.2%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"74","t":"+4.4%","d":"up"}];
const COLS = ["ID","Inspect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Health Emr #001","Public Health Emr #002","1.479","8.736","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Public Health Emr #002","Public Health Emr #003","7.809","4.294","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Health Emr #003","Public Health Emr #004","4.977","6.771","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Public Health Emr #004","Public Health Emr #005","801","6.370","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Health Emr #005","Public Health Emr #001","5.280","2.566","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":976},{"label":"Fev","value":773},{"label":"Mar","value":1013},{"label":"Abr","value":759},{"label":"Mai","value":802},{"label":"Jun","value":963},{"label":"Jul","value":1011},{"label":"Ago","value":887},{"label":"Set","value":944},{"label":"Out","value":670},{"label":"Nov","value":1014},{"label":"Dez","value":947}];
const MX = 1014;
