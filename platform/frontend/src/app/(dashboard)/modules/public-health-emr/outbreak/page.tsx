...
const ACCENT = "#6366f1";
const MODULE = "Public Health";
const PAGE = "Outbreak";
const KPIS = [{"l":"Total Public Health Emr","v":"8.178","t":"+8.1%","d":"up"},{"l":"Outbreak Ativos","v":"5.783","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"66.5%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"82","t":"-4.8%","d":"down"}];
const COLS = ["ID","Outbreak","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Health Emr #001","Public Health Emr #002","5.587","1.808","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Public Health Emr #002","Public Health Emr #003","6.461","8.325","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Health Emr #003","Public Health Emr #004","3.657","9.058","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Public Health Emr #004","Public Health Emr #005","6.923","7.015","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Health Emr #005","Public Health Emr #001","783","1.718","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":919},{"label":"Fev","value":991},{"label":"Mar","value":1051},{"label":"Abr","value":724},{"label":"Mai","value":957},{"label":"Jun","value":665},{"label":"Jul","value":813},{"label":"Ago","value":989},{"label":"Set","value":814},{"label":"Out","value":819},{"label":"Nov","value":830},{"label":"Dez","value":955}];
const MX = 1051;
