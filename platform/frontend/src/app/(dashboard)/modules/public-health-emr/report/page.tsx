...
const PAGE = "Report";
const KPIS = [{"l":"Total Public Health Emr","v":"7.766","t":"+13.1%","d":"up"},{"l":"Report Ativos","v":"2.890","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"77.5%","t":"+4.8%","d":"up"},{"l":"Score Performance","v":"56","t":"+2.0%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Health Emr #001","Public Health Emr #002","1.938","8.776","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Public Health Emr #002","Public Health Emr #003","7.849","3.403","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Health Emr #003","Public Health Emr #004","6.293","1.524","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Public Health Emr #004","Public Health Emr #005","4.967","8.946","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Health Emr #005","Public Health Emr #001","5.124","4.186","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":415},{"label":"Mar","value":396},{"label":"Abr","value":601},{"label":"Mai","value":553},{"label":"Jun","value":665},{"label":"Jul","value":305},{"label":"Ago","value":618},{"label":"Set","value":481},{"label":"Out","value":402},{"label":"Nov","value":429},{"label":"Dez","value":369}];
const MX = 665;
