...
const KPIS = [{"l":"Dashboards Ativos","v":"2.870","t":"+11.0%","d":"up"},{"l":"Queries/Dia","v":"3391","t":"-4.4%","d":"down"},{"l":"Dados Processados (GB)","v":"1.161","t":"+2.0%","d":"up"},{"l":"Utilizadores Analytics","v":"3.938","t":"+16.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2796","2026-03-14","6.840","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4218","2026-02-16","6.982","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4288","2026-01-22","3.611","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","5071","2026-01-17","3.960","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5021","2026-01-12","6.500","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":618},{"label":"Mar","value":657},{"label":"Abr","value":864},{"label":"Mai","value":802},{"label":"Jun","value":699},{"label":"Jul","value":888},{"label":"Ago","value":552},{"label":"Set","value":510},{"label":"Out","value":524},{"label":"Nov","value":563},{"label":"Dez","value":532}];
const MX = 888;
