...
const ACCENT = "#0e7490";
const MODULE = "Digital Signage";
const PAGE = "Device Status";
const KPIS = [{"l":"Dispositivos Online","v":"4.617","t":"+17.1%","d":"up"},{"l":"Dados/Min (MB)","v":"5.495","t":"+4.4%","d":"up"},{"l":"Alertas Ativos","v":"3.360","t":"+0.1%","d":"up"},{"l":"Uptime (%)","v":"76.7%","t":"+8.5%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","424","3.810","5.371","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","1.012","6.007","5.733","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.325","779","5.114","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","621","4.898","2.464","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.845","8.100","1.123","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1016},{"label":"Fev","value":659},{"label":"Mar","value":928},{"label":"Abr","value":735},{"label":"Mai","value":683},{"label":"Jun","value":959},{"label":"Jul","value":929},{"label":"Ago","value":883},{"label":"Set","value":811},{"label":"Out","value":767},{"label":"Nov","value":662},{"label":"Dez","value":755}];
const MX = 1016;
