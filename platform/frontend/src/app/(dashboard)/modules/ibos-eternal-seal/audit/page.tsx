...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.296","t":"+13.9%","d":"up"},{"l":"NC Abertas","v":"6.444","t":"-5.3%","d":"down"},{"l":"Conformidade (%)","v":"69.1%","t":"+4.9%","d":"up"},{"l":"CAPAs Pendentes","v":"2.042","t":"+2.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.758","70.3%","8.288","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.812","90.2%","514","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.148","93.7%","2.807","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.194","79.6%","3.768","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.131","90.3%","5.764","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":786},{"label":"Fev","value":719},{"label":"Mar","value":770},{"label":"Abr","value":577},{"label":"Mai","value":794},{"label":"Jun","value":765},{"label":"Jul","value":685},{"label":"Ago","value":575},{"label":"Set","value":757},{"label":"Out","value":701},{"label":"Nov","value":672},{"label":"Dez","value":440}];
const MX = 794;
