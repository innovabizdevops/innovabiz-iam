...
/* ═══ iBOS Eternal Seal — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "4236", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4947", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€53K", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "104538236", cells: ["IBO-4236", "iBOS Eternal Seal Item 1", "13/9/2026", "€38 336"], status: "active" as const },
    { id: "104541807", cells: ["IBO-7807", "iBOS Eternal Seal Item 2", "28/4/2026", "€41 907"], status: "pending" as const },
    { id: "104545378", cells: ["IBO-2378", "iBOS Eternal Seal Item 3", "15/11/2026", "€45 478"], status: "completed" as const },
    { id: "104548949", cells: ["IBO-5949", "iBOS Eternal Seal Item 4", "2/6/2026", "€49 049"], status: "warning" as const },
    { id: "104552520", cells: ["IBO-9520", "iBOS Eternal Seal Item 5", "17/1/2026", "€2620"], status: "active" as const },
];
...
export default function IbosEternalSealPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">iBOS Eternal Seal</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • iBOS Eternal Seal</p>
                    </div>
                </div>
