...
export default function PesWaterMeterPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Pes Water Meter</h1><p className="text-sm text-muted-foreground">Pes Water Meter • iBOS Enterprise</p></div>
