...
const PAGE = "Smart Water";
const KPIS = [{"l":"Total Pes Water Meter","v":"5.275","t":"-2.0%","d":"down"},{"l":"Smart Water Ativos","v":"6.611","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"74.6%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"85","t":"+17.8%","d":"up"}];
const COLS = ["ID","Smart Water","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pes Water Meter #001","Pes Water Meter #002","3.019","3.025","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Pes Water Meter #002","Pes Water Meter #003","4.188","2.894","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Pes Water Meter #003","Pes Water Meter #004","6.149","2.042","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Pes Water Meter #004","Pes Water Meter #005","1.770","7.629","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pes Water Meter #005","Pes Water Meter #001","7.089","8.007","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":597},{"label":"Mar","value":783},{"label":"Abr","value":439},{"label":"Mai","value":444},{"label":"Jun","value":505},{"label":"Jul","value":673},{"label":"Ago","value":470},{"label":"Set","value":526},{"label":"Out","value":773},{"label":"Nov","value":539},{"label":"Dez","value":421}];
const MX = 783;
