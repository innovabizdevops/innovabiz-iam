...
/* ═══ iBOS Neural Map — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "7031", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1238", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€295K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "908886331", cells: ["IBO-4331", "iBOS Neural Map Item 1", "4/8/2026", "€36 431"], status: "active" as const },
    { id: "908889902", cells: ["IBO-7902", "iBOS Neural Map Item 2", "19/3/2026", "€40 002"], status: "pending" as const },
    { id: "908893473", cells: ["IBO-2473", "iBOS Neural Map Item 3", "6/10/2026", "€43 573"], status: "completed" as const },
    { id: "908897044", cells: ["IBO-6044", "iBOS Neural Map Item 4", "21/5/2026", "€47 144"], status: "warning" as const },
    { id: "908900615", cells: ["IBO-9615", "iBOS Neural Map Item 5", "8/12/2026", "€715"], status: "active" as const },
];
...
export default function IbosNeuralMapPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">iBOS Neural Map</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • iBOS Neural Map</p>
                    </div>
                </div>
