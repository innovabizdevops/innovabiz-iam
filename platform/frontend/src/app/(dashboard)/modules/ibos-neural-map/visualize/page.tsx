...
const ACCENT = "#312e81";
const MODULE = "iBOS Neural Map";
const PAGE = "Visualize";
const KPIS = [{"l":"Dashboards Ativos","v":"433","t":"+6.0%","d":"up"},{"l":"Queries/Dia","v":"3121","t":"-5.2%","d":"down"},{"l":"Dados Processados (GB)","v":"3.841","t":"+0.4%","d":"up"},{"l":"Utilizadores Analytics","v":"7.763","t":"-0.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2188","2026-02-11","5.371","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1980","2026-03-05","8.838","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","227","2026-03-22","6.443","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4828","2026-02-16","1.625","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2944","2026-03-22","4.206","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":749},{"label":"Fev","value":814},{"label":"Mar","value":606},{"label":"Abr","value":741},{"label":"Mai","value":938},{"label":"Jun","value":583},{"label":"Jul","value":623},{"label":"Ago","value":680},{"label":"Set","value":715},{"label":"Out","value":687},{"label":"Nov","value":649},{"label":"Dez","value":846}];
const MX = 938;
