...
/* ═══ UX Research Lab — Dashboard ═══ */

const ACCENT = "#f43f5e";

const KPIS = [
    { label: "Total Registos", value: "3916", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4259", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€313K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "-24%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "212764716", cells: ["UX-5716", "UX Research Lab Item 1", "25/1/2026", "€14 816"], status: "active" as const },
    { id: "212768287", cells: ["UX-9287", "UX Research Lab Item 2", "12/8/2026", "€18 387"], status: "pending" as const },
    { id: "212771858", cells: ["UX-3858", "UX Research Lab Item 3", "27/3/2026", "€21 958"], status: "completed" as const },
    { id: "212775429", cells: ["UX-7429", "UX Research Lab Item 4", "14/10/2026", "€25 529"], status: "warning" as const },
    { id: "212779000", cells: ["UX-2000", "UX Research Lab Item 5", "1/5/2026", "€29 100"], status: "active" as const },
];
...
export default function UxResearchLabPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">UX Research Lab</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • UX Research Lab</p>
                    </div>
                </div>
