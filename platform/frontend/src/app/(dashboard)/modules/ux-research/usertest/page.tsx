...
const ACCENT = "#f43f5e";
const MODULE = "UX Research Lab";
const PAGE = "User Test";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.487","t":"+4.2%","d":"up"},{"l":"Sessões/Dia","v":"3206","t":"+3.4%","d":"up"},{"l":"MFA Adoção (%)","v":"66.6%","t":"+17.3%","d":"up"},{"l":"Tentativas Bloqueadas","v":"7.874","t":"-2.5%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","7.607","5.756","6.325","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","1.578","6.542","5.198","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.983","8.703","1.336","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","7.225","7.506","6.268","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.563","8.689","8.779","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":630},{"label":"Mar","value":570},{"label":"Abr","value":609},{"label":"Mai","value":652},{"label":"Jun","value":752},{"label":"Jul","value":829},{"label":"Ago","value":655},{"label":"Set","value":724},{"label":"Out","value":560},{"label":"Nov","value":751},{"label":"Dez","value":653}];
const MX = 829;
