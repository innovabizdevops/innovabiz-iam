...
const PAGE = "A/B Test";
const KPIS = [{"l":"Ideias Submetidas","v":"4.566","t":"-2.1%","d":"down"},{"l":"Patentes (YTD)","v":"532","t":"+10.7%","d":"up"},{"l":"Projetos Innovation Lab","v":"1.039","t":"+12.5%","d":"up"},{"l":"Budget I&D (€M)","v":"€2.6M","t":"-5.9%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","3.257","96.2%","1.437","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","499","78.2%","1.191","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","938","98.7%","1.235","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","3.376","84.6%","1.805","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","4.557","71.4%","7.636","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":722},{"label":"Mar","value":637},{"label":"Abr","value":636},{"label":"Mai","value":712},{"label":"Jun","value":522},{"label":"Jul","value":681},{"label":"Ago","value":517},{"label":"Set","value":680},{"label":"Out","value":626},{"label":"Nov","value":615},{"label":"Dez","value":703}];
const MX = 722;
