...
const PAGE = "Survey";
const KPIS = [{"l":"Ideias Submetidas","v":"5.829","t":"+5.8%","d":"up"},{"l":"Patentes (YTD)","v":"8.028","t":"-1.0%","d":"down"},{"l":"Projetos Innovation Lab","v":"129","t":"+14.7%","d":"up"},{"l":"Budget I&D (€M)","v":"€47.1M","t":"+10.3%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.659","76.7%","493","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","1.266","89.5%","4.062","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","7.379","92.8%","2.375","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","8.389","84.8%","6.180","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","433","72.9%","4.277","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":984},{"label":"Mar","value":709},{"label":"Abr","value":766},{"label":"Mai","value":898},{"label":"Jun","value":839},{"label":"Jul","value":893},{"label":"Ago","value":880},{"label":"Set","value":887},{"label":"Out","value":985},{"label":"Nov","value":914},{"label":"Dez","value":942}];
const MX = 985;
