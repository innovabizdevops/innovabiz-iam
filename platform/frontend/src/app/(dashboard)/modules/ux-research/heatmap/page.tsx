...
const PAGE = "Heatmap";
const KPIS = [{"l":"Ideias Submetidas","v":"6.297","t":"+9.8%","d":"up"},{"l":"Patentes (YTD)","v":"8.377","t":"-4.2%","d":"down"},{"l":"Projetos Innovation Lab","v":"8.641","t":"+15.6%","d":"up"},{"l":"Budget I&D (€M)","v":"€30.2M","t":"+16.9%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.067","93.7%","6.784","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.420","76.0%","1.342","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","2.716","70.8%","1.083","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","6.857","85.0%","5.306","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","3.521","72.2%","4.496","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":764},{"label":"Mar","value":780},{"label":"Abr","value":711},{"label":"Mai","value":764},{"label":"Jun","value":430},{"label":"Jul","value":751},{"label":"Ago","value":436},{"label":"Set","value":505},{"label":"Out","value":536},{"label":"Nov","value":459},{"label":"Dez","value":777}];
const MX = 780;
