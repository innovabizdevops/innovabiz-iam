...
const ACCENT = "#164e63";
const MODULE = "Water Quality Lab";
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.527","t":"+14.5%","d":"up"},{"l":"NC Abertas","v":"1.962","t":"+4.7%","d":"up"},{"l":"Conformidade (%)","v":"82.2%","t":"+4.2%","d":"up"},{"l":"CAPAs Pendentes","v":"4.965","t":"+1.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.133","95.4%","6.355","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.840","74.7%","2.366","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.729","81.4%","636","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.461","95.9%","6.173","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.960","76.1%","3.446","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":903},{"label":"Mar","value":1018},{"label":"Abr","value":949},{"label":"Mai","value":1073},{"label":"Jun","value":1003},{"label":"Jul","value":1016},{"label":"Ago","value":820},{"label":"Set","value":856},{"label":"Out","value":790},{"label":"Nov","value":692},{"label":"Dez","value":788}];
const MX = 1073;
