...
const PAGE = "LIMS";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.021","t":"-3.5%","d":"down"},{"l":"NC Abertas","v":"7.032","t":"+5.3%","d":"up"},{"l":"Conformidade (%)","v":"89.8%","t":"+1.4%","d":"up"},{"l":"CAPAs Pendentes","v":"4.449","t":"+6.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","394","89.8%","7.446","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.488","79.5%","5.330","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.310","76.7%","1.198","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","9.077","97.1%","299","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.595","85.7%","1.348","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":666},{"label":"Mar","value":720},{"label":"Abr","value":541},{"label":"Mai","value":804},{"label":"Jun","value":799},{"label":"Jul","value":733},{"label":"Ago","value":621},{"label":"Set","value":589},{"label":"Out","value":611},{"label":"Nov","value":514},{"label":"Dez","value":448}];
const MX = 833;
