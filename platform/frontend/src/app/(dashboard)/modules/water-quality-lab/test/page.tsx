...
const PAGE = "Test";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.397","t":"+15.9%","d":"up"},{"l":"NC Abertas","v":"1.131","t":"+12.1%","d":"up"},{"l":"Conformidade (%)","v":"94.4%","t":"+2.6%","d":"up"},{"l":"CAPAs Pendentes","v":"980","t":"+13.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.619","87.2%","3.265","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.333","84.3%","8.549","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.606","74.2%","4.491","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.200","79.1%","7.243","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.931","86.8%","6.170","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":627},{"label":"Mar","value":408},{"label":"Abr","value":324},{"label":"Mai","value":517},{"label":"Jun","value":299},{"label":"Jul","value":369},{"label":"Ago","value":484},{"label":"Set","value":578},{"label":"Out","value":333},{"label":"Nov","value":576},{"label":"Dez","value":462}];
const MX = 651;
