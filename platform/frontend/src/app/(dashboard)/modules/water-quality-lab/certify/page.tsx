...
const PAGE = "Certify";
const KPIS = [{"l":"Auditorias Realizadas","v":"831","t":"+8.9%","d":"up"},{"l":"NC Abertas","v":"5.043","t":"+1.3%","d":"up"},{"l":"Conformidade (%)","v":"73.1%","t":"+16.9%","d":"up"},{"l":"CAPAs Pendentes","v":"7.166","t":"-1.6%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","131","90.0%","4.987","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.373","79.4%","8.588","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.555","99.2%","6.907","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.998","86.5%","3.979","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.258","96.3%","3.317","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":738},{"label":"Mar","value":759},{"label":"Abr","value":797},{"label":"Mai","value":701},{"label":"Jun","value":751},{"label":"Jul","value":604},{"label":"Ago","value":688},{"label":"Set","value":604},{"label":"Out","value":486},{"label":"Nov","value":696},{"label":"Dez","value":676}];
const MX = 797;
