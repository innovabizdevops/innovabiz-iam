...
const ACCENT = "#93c5fd";
const MODULE = "Pricing Strategy Engine";
const PAGE = "Dynamic";
const KPIS = [{"l":"ARR (€M)","v":"€28.1M","t":"+12.5%","d":"up"},{"l":"MRR (€)","v":"€92233","t":"+12.3%","d":"up"},{"l":"Churn (%)","v":"82.2%","t":"+7.2%","d":"up"},{"l":"ARPU (€)","v":"€73073","t":"+15.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 40825.91","8.390","€ 10937.82","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 45785.92","4.446","€ 7409.42","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 1922.47","4.877","€ 26470.32","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 34148.43","2.139","€ 29989.49","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 49175.75","7.894","€ 47450.35","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":381},{"label":"Mar","value":440},{"label":"Abr","value":598},{"label":"Mai","value":669},{"label":"Jun","value":420},{"label":"Jul","value":689},{"label":"Ago","value":641},{"label":"Set","value":584},{"label":"Out","value":519},{"label":"Nov","value":616},{"label":"Dez","value":427}];
const MX = 689;
