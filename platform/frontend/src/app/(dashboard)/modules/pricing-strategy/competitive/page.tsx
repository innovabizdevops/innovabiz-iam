...
const PAGE = "Competitive";
const KPIS = [{"l":"ARR (€M)","v":"€42.4M","t":"+2.5%","d":"up"},{"l":"MRR (€)","v":"€12499","t":"+5.4%","d":"up"},{"l":"Churn (%)","v":"70.6%","t":"-0.9%","d":"down"},{"l":"ARPU (€)","v":"€58383","t":"+16.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 24048.68","2.280","€ 10926.82","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 14215.35","4.941","€ 8949.82","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 35032.05","6.583","€ 22382.54","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 28306.81","2.025","€ 15947.31","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 43293.28","4.199","€ 15567.14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":875},{"label":"Mar","value":761},{"label":"Abr","value":861},{"label":"Mai","value":829},{"label":"Jun","value":786},{"label":"Jul","value":863},{"label":"Ago","value":773},{"label":"Set","value":762},{"label":"Out","value":534},{"label":"Nov","value":660},{"label":"Dez","value":656}];
const MX = 875;
