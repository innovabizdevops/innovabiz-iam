...
const PAGE = "Optimize";
const KPIS = [{"l":"ARR (€M)","v":"€6.1M","t":"+4.7%","d":"up"},{"l":"MRR (€)","v":"€39222","t":"+1.6%","d":"up"},{"l":"Churn (%)","v":"79.6%","t":"-3.0%","d":"down"},{"l":"ARPU (€)","v":"€67161","t":"+12.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 29848.21","6.028","€ 31606.16","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 28843.89","7.929","€ 39565.49","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 26180.08","7.033","€ 25206.52","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 18015.49","3.896","€ 34658.41","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 44947.05","7.874","€ 2504.96","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":359},{"label":"Fev","value":257},{"label":"Mar","value":384},{"label":"Abr","value":536},{"label":"Mai","value":244},{"label":"Jun","value":488},{"label":"Jul","value":324},{"label":"Ago","value":482},{"label":"Set","value":561},{"label":"Out","value":293},{"label":"Nov","value":481},{"label":"Dez","value":363}];
const MX = 561;
