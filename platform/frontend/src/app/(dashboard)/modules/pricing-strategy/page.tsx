...
/* ═══ Pricing Strategy Engine — Dashboard ═══ */

const ACCENT = "#93c5fd";

const KPIS = [
    { label: "Total Registos", value: "649", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "61", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€213K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "407771649", cells: ["PRI-9649", "Pricing Strategy Engine Item 1", "6/10/2026", "€21 749"], status: "active" as const },
    { id: "407775220", cells: ["PRI-4220", "Pricing Strategy Engine Item 2", "21/5/2026", "€25 320"], status: "pending" as const },
    { id: "407778791", cells: ["PRI-7791", "Pricing Strategy Engine Item 3", "8/12/2026", "€28 891"], status: "completed" as const },
    { id: "407782362", cells: ["PRI-2362", "Pricing Strategy Engine Item 4", "23/7/2026", "€32 462"], status: "warning" as const },
    { id: "407785933", cells: ["PRI-5933", "Pricing Strategy Engine Item 5", "10/2/2026", "€36 033"], status: "active" as const },
];
...
export default function PricingStrategyEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pricing Strategy Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pricing Strategy Engine</p>
                    </div>
                </div>
