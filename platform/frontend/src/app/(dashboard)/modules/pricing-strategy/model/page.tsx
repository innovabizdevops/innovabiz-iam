...
const PAGE = "Model";
const KPIS = [{"l":"ARR (€M)","v":"€22.0M","t":"-2.3%","d":"down"},{"l":"MRR (€)","v":"€41696","t":"+2.7%","d":"up"},{"l":"Churn (%)","v":"74.5%","t":"+1.8%","d":"up"},{"l":"ARPU (€)","v":"€80835","t":"+17.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 43020.59","3.377","€ 31796.10","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 17903.21","2.966","€ 33378.36","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 8063.91","6.096","€ 599.18","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 48773.50","5.440","€ 10321.73","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 37463.57","703","€ 11941.74","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":597},{"label":"Mar","value":567},{"label":"Abr","value":693},{"label":"Mai","value":453},{"label":"Jun","value":445},{"label":"Jul","value":689},{"label":"Ago","value":460},{"label":"Set","value":466},{"label":"Out","value":502},{"label":"Nov","value":502},{"label":"Dez","value":446}];
const MX = 693;
