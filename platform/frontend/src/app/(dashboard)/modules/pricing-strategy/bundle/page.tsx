...
const PAGE = "Bundle";
const KPIS = [{"l":"ARR (€M)","v":"€12.0M","t":"+0.1%","d":"up"},{"l":"MRR (€)","v":"€56409","t":"+7.7%","d":"up"},{"l":"Churn (%)","v":"84.0%","t":"-0.6%","d":"down"},{"l":"ARPU (€)","v":"€32972","t":"-4.2%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 45624.05","6.737","€ 33314.23","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 12358.47","2.885","€ 3292.29","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 42982.43","5.402","€ 1734.22","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 7789.74","5.873","€ 20211.80","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 1342.33","7.075","€ 28445.37","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":580},{"label":"Mar","value":781},{"label":"Abr","value":721},{"label":"Mai","value":706},{"label":"Jun","value":502},{"label":"Jul","value":763},{"label":"Ago","value":509},{"label":"Set","value":831},{"label":"Out","value":497},{"label":"Nov","value":728},{"label":"Dez","value":530}];
const MX = 831;
