...
const PAGE = "Operator";
const KPIS = [{"l":"Total Shop Floor","v":"1.971","t":"+12.2%","d":"up"},{"l":"Operator Ativos","v":"4.576","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"65.5%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"72","t":"-0.6%","d":"down"}];
const COLS = ["ID","Operator","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Shop Floor #001","Shop Floor #002","5.408","5.111","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Shop Floor #002","Shop Floor #003","1.835","4.259","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Shop Floor #003","Shop Floor #004","3.043","2.979","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Shop Floor #004","Shop Floor #005","3.497","4.297","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Shop Floor #005","Shop Floor #001","7.296","1.725","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":479},{"label":"Mar","value":779},{"label":"Abr","value":458},{"label":"Mai","value":658},{"label":"Jun","value":529},{"label":"Jul","value":573},{"label":"Ago","value":460},{"label":"Set","value":741},{"label":"Out","value":407},{"label":"Nov","value":763},{"label":"Dez","value":750}];
const MX = 779;
