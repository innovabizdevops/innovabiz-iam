...
const PAGE = "SPC";
const KPIS = [{"l":"Total Shop Floor","v":"1.970","t":"+7.6%","d":"up"},{"l":"SPC Ativos","v":"5.264","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"78.4%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"72","t":"-5.3%","d":"down"}];
const COLS = ["ID","SPC","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Shop Floor #001","Shop Floor #002","7.848","6.945","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Shop Floor #002","Shop Floor #003","2.861","4.192","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Shop Floor #003","Shop Floor #004","8.289","7.227","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Shop Floor #004","Shop Floor #005","7.616","2.375","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Shop Floor #005","Shop Floor #001","4.307","5.421","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":716},{"label":"Mar","value":736},{"label":"Abr","value":940},{"label":"Mai","value":561},{"label":"Jun","value":579},{"label":"Jul","value":676},{"label":"Ago","value":866},{"label":"Set","value":907},{"label":"Out","value":597},{"label":"Nov","value":935},{"label":"Dez","value":710}];
const MX = 940;
