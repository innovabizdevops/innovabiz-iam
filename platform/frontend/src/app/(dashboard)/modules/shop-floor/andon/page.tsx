...
const PAGE = "Andon";
const KPIS = [{"l":"Total Shop Floor","v":"5.312","t":"+5.2%","d":"up"},{"l":"Andon Ativos","v":"1.501","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"73.0%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"88","t":"+17.9%","d":"up"}];
const COLS = ["ID","Andon","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Shop Floor #001","Shop Floor #002","4.746","8.200","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Shop Floor #002","Shop Floor #003","2.285","5.389","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Shop Floor #003","Shop Floor #004","7.979","6.926","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Shop Floor #004","Shop Floor #005","2.773","5.323","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Shop Floor #005","Shop Floor #001","4.423","6.843","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":557},{"label":"Mar","value":684},{"label":"Abr","value":654},{"label":"Mai","value":496},{"label":"Jun","value":653},{"label":"Jul","value":672},{"label":"Ago","value":559},{"label":"Set","value":643},{"label":"Out","value":467},{"label":"Nov","value":661},{"label":"Dez","value":400}];
const MX = 684;
