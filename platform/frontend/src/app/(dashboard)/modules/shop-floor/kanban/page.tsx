...
const PAGE = "Kanban";
const KPIS = [{"l":"Total Shop Floor","v":"5.443","t":"+11.6%","d":"up"},{"l":"Kanban Ativos","v":"8.225","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"58","t":"+14.8%","d":"up"}];
const COLS = ["ID","Kanban","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Shop Floor #001","Shop Floor #002","8.713","6.672","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Shop Floor #002","Shop Floor #003","3.901","5.805","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Shop Floor #003","Shop Floor #004","7.476","6.391","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Shop Floor #004","Shop Floor #005","5.634","5.055","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Shop Floor #005","Shop Floor #001","5.748","3.511","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":851},{"label":"Fev","value":833},{"label":"Mar","value":712},{"label":"Abr","value":627},{"label":"Mai","value":765},{"label":"Jun","value":501},{"label":"Jul","value":745},{"label":"Ago","value":746},{"label":"Set","value":811},{"label":"Out","value":576},{"label":"Nov","value":727},{"label":"Dez","value":721}];
const MX = 851;
