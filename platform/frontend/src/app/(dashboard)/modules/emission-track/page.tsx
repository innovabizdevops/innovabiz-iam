...
export default function EmissionTrackPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Emission Track</h1><p className="text-sm text-muted-foreground">Emission Track • iBOS Enterprise</p></div>
