...
const ACCENT = "#475569";
const MODULE = "Emission Tracking";
const PAGE = "Reporting";
const KPIS = [{"l":"Total Emission Track","v":"6.329","t":"+12.6%","d":"up"},{"l":"Reporting Ativos","v":"3.825","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"82.0%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"78","t":"-2.1%","d":"down"}];
const COLS = ["ID","Reporting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Emission Track #001","Emission Track #002","8.482","5.176","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Emission Track #002","Emission Track #003","1.526","4.815","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Emission Track #003","Emission Track #004","4.682","6.603","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Emission Track #004","Emission Track #005","1.799","879","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Emission Track #005","Emission Track #001","4.424","3.483","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":782},{"label":"Mar","value":452},{"label":"Abr","value":452},{"label":"Mai","value":555},{"label":"Jun","value":725},{"label":"Jul","value":570},{"label":"Ago","value":688},{"label":"Set","value":423},{"label":"Out","value":578},{"label":"Nov","value":461},{"label":"Dez","value":506}];
const MX = 782;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#475569'}}>ESG</span></h1>
                </div>
