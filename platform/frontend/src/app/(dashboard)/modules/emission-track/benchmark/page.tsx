...
const KPIS = [{"l":"Total Emission Track","v":"5.569","t":"+5.4%","d":"up"},{"l":"Benchmark Ativos","v":"6.656","t":"+4.4%","d":"up"},{"l":"Eficiência (%)","v":"92.1%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"80","t":"-2.5%","d":"down"}];
const COLS = ["ID","Benchmark","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Emission Track #001","Emission Track #002","1.005","1.048","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Emission Track #002","Emission Track #003","8.905","3.661","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Emission Track #003","Emission Track #004","2.201","4.026","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Emission Track #004","Emission Track #005","7.107","150","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Emission Track #005","Emission Track #001","7.911","4.537","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":329},{"label":"Fev","value":643},{"label":"Mar","value":393},{"label":"Abr","value":691},{"label":"Mai","value":680},{"label":"Jun","value":613},{"label":"Jul","value":509},{"label":"Ago","value":642},{"label":"Set","value":349},{"label":"Out","value":458},{"label":"Nov","value":658},{"label":"Dez","value":604}];
const MX = 691;
