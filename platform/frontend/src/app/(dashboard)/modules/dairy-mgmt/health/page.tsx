...
const PAGE = "Herd Health";
const KPIS = [{"l":"Total Dairy Mgmt","v":"2.894","t":"-3.7%","d":"down"},{"l":"Herd Health Ativos","v":"6.209","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"90.4%","t":"+4.8%","d":"up"},{"l":"Score Performance","v":"95","t":"-4.2%","d":"down"}];
const COLS = ["ID","Herd Health","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dairy Mgmt #001","Dairy Mgmt #002","5.772","6.976","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Dairy Mgmt #002","Dairy Mgmt #003","5.362","8.590","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Dairy Mgmt #003","Dairy Mgmt #004","4.503","7.859","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Dairy Mgmt #004","Dairy Mgmt #005","3.079","3.484","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dairy Mgmt #005","Dairy Mgmt #001","5.387","6.245","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":703},{"label":"Mar","value":867},{"label":"Abr","value":527},{"label":"Mai","value":568},{"label":"Jun","value":846},{"label":"Jul","value":578},{"label":"Ago","value":808},{"label":"Set","value":556},{"label":"Out","value":588},{"label":"Nov","value":792},{"label":"Dez","value":610}];
const MX = 867;
