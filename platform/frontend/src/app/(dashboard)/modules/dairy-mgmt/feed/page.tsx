...
const PAGE = "Feed";
const KPIS = [{"l":"Total Dairy Mgmt","v":"8.379","t":"+2.2%","d":"up"},{"l":"Feed Ativos","v":"617","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"65.4%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"65","t":"-0.3%","d":"down"}];
const COLS = ["ID","Feed","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dairy Mgmt #001","Dairy Mgmt #002","7.707","876","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Dairy Mgmt #002","Dairy Mgmt #003","6.196","1.760","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Dairy Mgmt #003","Dairy Mgmt #004","7.863","1.508","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Dairy Mgmt #004","Dairy Mgmt #005","1.062","5.913","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dairy Mgmt #005","Dairy Mgmt #001","2.513","3.515","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":932},{"label":"Fev","value":991},{"label":"Mar","value":748},{"label":"Abr","value":833},{"label":"Mai","value":707},{"label":"Jun","value":969},{"label":"Jul","value":858},{"label":"Ago","value":739},{"label":"Set","value":1049},{"label":"Out","value":710},{"label":"Nov","value":883},{"label":"Dez","value":946}];
const MX = 1049;
