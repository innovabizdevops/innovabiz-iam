...
const ACCENT = "#6366f1";
const MODULE = "Dairy Management";
const PAGE = "Milking";
const KPIS = [{"l":"Total Dairy Mgmt","v":"1.571","t":"+2.0%","d":"up"},{"l":"Milking Ativos","v":"2.534","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"70.4%","t":"+10.7%","d":"up"},{"l":"Score Performance","v":"78","t":"+5.7%","d":"up"}];
const COLS = ["ID","Milking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dairy Mgmt #001","Dairy Mgmt #002","5.234","1.470","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Dairy Mgmt #002","Dairy Mgmt #003","1.485","3.914","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Dairy Mgmt #003","Dairy Mgmt #004","3.241","481","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Dairy Mgmt #004","Dairy Mgmt #005","3.875","7.195","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dairy Mgmt #005","Dairy Mgmt #001","3.752","2.052","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":351},{"label":"Fev","value":609},{"label":"Mar","value":514},{"label":"Abr","value":667},{"label":"Mai","value":478},{"label":"Jun","value":658},{"label":"Jul","value":524},{"label":"Ago","value":308},{"label":"Set","value":385},{"label":"Out","value":343},{"label":"Nov","value":661},{"label":"Dez","value":405}];
const MX = 667;
