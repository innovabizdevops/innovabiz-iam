...
const PAGE = "Report";
const KPIS = [{"l":"Total Dairy Mgmt","v":"4.589","t":"+13.0%","d":"up"},{"l":"Report Ativos","v":"5.923","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"85.3%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"78","t":"+8.2%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dairy Mgmt #001","Dairy Mgmt #002","7.232","1.996","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Dairy Mgmt #002","Dairy Mgmt #003","904","7.746","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Dairy Mgmt #003","Dairy Mgmt #004","3.464","1.457","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Dairy Mgmt #004","Dairy Mgmt #005","5.391","6.728","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dairy Mgmt #005","Dairy Mgmt #001","2.003","5.512","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":965},{"label":"Mar","value":949},{"label":"Abr","value":734},{"label":"Mai","value":1028},{"label":"Jun","value":957},{"label":"Jul","value":762},{"label":"Ago","value":740},{"label":"Set","value":693},{"label":"Out","value":866},{"label":"Nov","value":720},{"label":"Dez","value":977}];
const MX = 1028;
