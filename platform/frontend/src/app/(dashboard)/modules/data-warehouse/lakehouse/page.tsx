...
const PAGE = "Data Lakehouse";
const KPIS = [{"l":"Dashboards Ativos","v":"6.700","t":"+17.2%","d":"up"},{"l":"Queries/Dia","v":"466","t":"-2.6%","d":"down"},{"l":"Dados Processados (GB)","v":"5.709","t":"+7.7%","d":"up"},{"l":"Utilizadores Analytics","v":"2.071","t":"+13.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","718","2026-03-21","6.764","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4572","2026-03-12","4.395","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4990","2026-03-04","8.783","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3349","2026-02-07","3.715","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1413","2026-02-27","3.057","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":478},{"label":"Mar","value":701},{"label":"Abr","value":563},{"label":"Mai","value":436},{"label":"Jun","value":500},{"label":"Jul","value":602},{"label":"Ago","value":666},{"label":"Set","value":407},{"label":"Out","value":728},{"label":"Nov","value":624},{"label":"Dez","value":574}];
const MX = 728;
