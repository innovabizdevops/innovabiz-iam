...
const PAGE = "Cost Optimizer";
const KPIS = [{"l":"Dashboards Ativos","v":"1.068","t":"+16.0%","d":"up"},{"l":"Queries/Dia","v":"1818","t":"+5.4%","d":"up"},{"l":"Dados Processados (GB)","v":"2.062","t":"+4.3%","d":"up"},{"l":"Utilizadores Analytics","v":"5.935","t":"+14.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3938","2026-02-17","8.249","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","813","2026-01-13","3.809","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","104","2026-02-06","7.220","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2777","2026-01-09","2.991","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3550","2026-02-09","1.166","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":832},{"label":"Fev","value":828},{"label":"Mar","value":865},{"label":"Abr","value":932},{"label":"Mai","value":569},{"label":"Jun","value":698},{"label":"Jul","value":698},{"label":"Ago","value":814},{"label":"Set","value":573},{"label":"Out","value":855},{"label":"Nov","value":869},{"label":"Dez","value":726}];
const MX = 932;
