...
const PAGE = "Time Travel";
const KPIS = [{"l":"Dashboards Ativos","v":"6.603","t":"+0.8%","d":"up"},{"l":"Queries/Dia","v":"124","t":"+16.3%","d":"up"},{"l":"Dados Processados (GB)","v":"7.771","t":"+14.2%","d":"up"},{"l":"Utilizadores Analytics","v":"2.307","t":"+14.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2515","2026-01-01","7.006","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4891","2026-02-10","5.238","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2606","2026-03-03","5.783","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4122","2026-03-26","180","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2312","2026-01-22","9.055","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":298},{"label":"Fev","value":618},{"label":"Mar","value":553},{"label":"Abr","value":445},{"label":"Mai","value":332},{"label":"Jun","value":616},{"label":"Jul","value":374},{"label":"Ago","value":288},{"label":"Set","value":460},{"label":"Out","value":495},{"label":"Nov","value":652},{"label":"Dez","value":474}];
const MX = 652;
