...
const ACCENT = "#0e7490";
const MODULE = "Data Warehouse";
const PAGE = "Materialized Views";
const KPIS = [{"l":"Dashboards Ativos","v":"8.721","t":"+17.3%","d":"up"},{"l":"Queries/Dia","v":"2073","t":"-0.2%","d":"down"},{"l":"Dados Processados (GB)","v":"1.169","t":"+7.6%","d":"up"},{"l":"Utilizadores Analytics","v":"6.031","t":"-1.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1916","2026-02-17","487","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4725","2026-03-27","5.204","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3161","2026-01-24","6.727","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3114","2026-01-06","2.865","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","865","2026-02-17","5.649","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":496},{"label":"Mar","value":437},{"label":"Abr","value":647},{"label":"Mai","value":666},{"label":"Jun","value":432},{"label":"Jul","value":580},{"label":"Ago","value":664},{"label":"Set","value":690},{"label":"Out","value":745},{"label":"Nov","value":804},{"label":"Dez","value":533}];
const MX = 804;
