...
const PAGE = "Schema Browser";
const KPIS = [{"l":"Dashboards Ativos","v":"4.402","t":"+10.2%","d":"up"},{"l":"Queries/Dia","v":"1017","t":"+10.4%","d":"up"},{"l":"Dados Processados (GB)","v":"3.177","t":"+13.1%","d":"up"},{"l":"Utilizadores Analytics","v":"4.755","t":"-5.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2609","2026-03-27","6.136","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2907","2026-03-04","2.926","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3815","2026-02-07","5.402","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3565","2026-01-01","4.589","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1558","2026-01-20","5.167","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":852},{"label":"Mar","value":1015},{"label":"Abr","value":717},{"label":"Mai","value":940},{"label":"Jun","value":916},{"label":"Jul","value":1007},{"label":"Ago","value":940},{"label":"Set","value":766},{"label":"Out","value":937},{"label":"Nov","value":945},{"label":"Dez","value":729}];
const MX = 1015;
