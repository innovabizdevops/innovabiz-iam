...
const PAGE = "Partition Mgmt";
const KPIS = [{"l":"Dashboards Ativos","v":"2.766","t":"+12.8%","d":"up"},{"l":"Queries/Dia","v":"398","t":"-5.6%","d":"down"},{"l":"Dados Processados (GB)","v":"6.719","t":"-1.4%","d":"down"},{"l":"Utilizadores Analytics","v":"1.038","t":"+9.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1975","2026-02-09","1.288","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2605","2026-02-24","5.936","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3394","2026-03-01","4.978","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2460","2026-03-19","957","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1631","2026-01-15","2.494","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":846},{"label":"Fev","value":658},{"label":"Mar","value":808},{"label":"Abr","value":943},{"label":"Mai","value":826},{"label":"Jun","value":936},{"label":"Jul","value":636},{"label":"Ago","value":762},{"label":"Set","value":680},{"label":"Out","value":728},{"label":"Nov","value":936},{"label":"Dez","value":756}];
const MX = 943;
