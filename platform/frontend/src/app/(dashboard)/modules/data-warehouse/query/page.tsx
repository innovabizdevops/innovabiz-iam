...
const PAGE = "Query Editor";
const KPIS = [{"l":"Dashboards Ativos","v":"4.540","t":"-4.9%","d":"down"},{"l":"Queries/Dia","v":"1218","t":"+5.9%","d":"up"},{"l":"Dados Processados (GB)","v":"7.790","t":"+7.4%","d":"up"},{"l":"Utilizadores Analytics","v":"1.576","t":"+16.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1408","2026-03-20","2.798","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","784","2026-01-11","2.558","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2849","2026-02-02","2.798","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4507","2026-01-23","2.481","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","335","2026-03-24","8.720","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":935},{"label":"Mar","value":915},{"label":"Abr","value":724},{"label":"Mai","value":996},{"label":"Jun","value":828},{"label":"Jul","value":1061},{"label":"Ago","value":1030},{"label":"Set","value":1011},{"label":"Out","value":883},{"label":"Nov","value":898},{"label":"Dez","value":878}];
const MX = 1061;
