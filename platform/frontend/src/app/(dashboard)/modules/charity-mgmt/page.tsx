...
const KPIS = [
    ...
    { label: "Ativos", value: "4809", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€162K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "514808125", cells: ["CHA-9125", "Charity Management Item 1", "14/2/2026", "€8225"], status: "active" as const },
    { id: "514811696", cells: ["CHA-3696", "Charity Management Item 2", "1/9/2026", "€11 796"], status: "pending" as const },
    { id: "514815267", cells: ["CHA-7267", "Charity Management Item 3", "16/4/2026", "€15 367"], status: "completed" as const },
    { id: "514818838", cells: ["CHA-1838", "Charity Management Item 4", "3/11/2026", "€18 938"], status: "warning" as const },
    { id: "514822409", cells: ["CHA-5409", "Charity Management Item 5", "18/6/2026", "€22 509"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Charity Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Charity Management</p>
                    </div>
                </div>
