...
const KPIS = [{"l":"Total Charity Mgmt","v":"4.023","t":"+12.1%","d":"up"},{"l":"Fundraise Ativos","v":"7.372","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"79.9%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"63","t":"+17.0%","d":"up"}];
const COLS = ["ID","Fundraise","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Charity Mgmt #001","Charity Mgmt #002","7.819","5.139","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Charity Mgmt #002","Charity Mgmt #003","4.583","8.542","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Charity Mgmt #003","Charity Mgmt #004","3.102","7.716","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Charity Mgmt #004","Charity Mgmt #005","2.696","3.862","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Charity Mgmt #005","Charity Mgmt #001","8.202","7.691","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":754},{"label":"Mar","value":755},{"label":"Abr","value":854},{"label":"Mai","value":875},{"label":"Jun","value":729},{"label":"Jul","value":758},{"label":"Ago","value":729},{"label":"Set","value":643},{"label":"Out","value":713},{"label":"Nov","value":807},{"label":"Dez","value":799}];
const MX = 875;
