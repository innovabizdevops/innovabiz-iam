...
const PAGE = "Program";
const KPIS = [{"l":"Total Charity Mgmt","v":"8.129","t":"-2.7%","d":"down"},{"l":"Program Ativos","v":"8.063","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"83.1%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"55","t":"-4.6%","d":"down"}];
const COLS = ["ID","Program","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Charity Mgmt #001","Charity Mgmt #002","7.448","4.862","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Charity Mgmt #002","Charity Mgmt #003","1.754","3.909","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Charity Mgmt #003","Charity Mgmt #004","1.150","1.944","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Charity Mgmt #004","Charity Mgmt #005","3.194","1.404","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Charity Mgmt #005","Charity Mgmt #001","5.665","1.412","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":799},{"label":"Mar","value":889},{"label":"Abr","value":652},{"label":"Mai","value":868},{"label":"Jun","value":796},{"label":"Jul","value":836},{"label":"Ago","value":880},{"label":"Set","value":904},{"label":"Out","value":845},{"label":"Nov","value":1037},{"label":"Dez","value":663}];
const MX = 1037;
