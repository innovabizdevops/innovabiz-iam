...
const ACCENT = "#9d174d";
const MODULE = "Charity Management";
const PAGE = "Volunteer";
const KPIS = [{"l":"Total Charity Mgmt","v":"539","t":"+0.4%","d":"up"},{"l":"Volunteer Ativos","v":"8.326","t":"+1.5%","d":"up"},{"l":"Eficiência (%)","v":"67.7%","t":"+7.6%","d":"up"},{"l":"Score Performance","v":"94","t":"+9.2%","d":"up"}];
const COLS = ["ID","Volunteer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Charity Mgmt #001","Charity Mgmt #002","4.776","1.658","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Charity Mgmt #002","Charity Mgmt #003","7.294","1.530","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Charity Mgmt #003","Charity Mgmt #004","5.737","8.928","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Charity Mgmt #004","Charity Mgmt #005","9.007","7.537","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Charity Mgmt #005","Charity Mgmt #001","3.012","7.759","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":800},{"label":"Fev","value":905},{"label":"Mar","value":671},{"label":"Abr","value":1067},{"label":"Mai","value":932},{"label":"Jun","value":925},{"label":"Jul","value":890},{"label":"Ago","value":990},{"label":"Set","value":778},{"label":"Out","value":1021},{"label":"Nov","value":838},{"label":"Dez","value":1058}];
const MX = 1067;
