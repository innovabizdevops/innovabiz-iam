...
const PAGE = "Donor";
const KPIS = [{"l":"Total Charity Mgmt","v":"375","t":"+16.0%","d":"up"},{"l":"Donor Ativos","v":"4.285","t":"+14.5%","d":"up"},{"l":"Eficiência (%)","v":"87.1%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"92","t":"+3.6%","d":"up"}];
const COLS = ["ID","Donor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Charity Mgmt #001","Charity Mgmt #002","6.755","4.799","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Charity Mgmt #002","Charity Mgmt #003","5.904","109","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Charity Mgmt #003","Charity Mgmt #004","8.181","7.575","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Charity Mgmt #004","Charity Mgmt #005","6.628","7.339","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Charity Mgmt #005","Charity Mgmt #001","534","3.609","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":969},{"label":"Fev","value":962},{"label":"Mar","value":729},{"label":"Abr","value":678},{"label":"Mai","value":745},{"label":"Jun","value":646},{"label":"Jul","value":825},{"label":"Ago","value":860},{"label":"Set","value":857},{"label":"Out","value":1005},{"label":"Nov","value":728},{"label":"Dez","value":728}];
const MX = 1005;
