...
const PAGE = "Report";
const KPIS = [{"l":"Total Charity Mgmt","v":"6.001","t":"+8.2%","d":"up"},{"l":"Report Ativos","v":"5.529","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"65.6%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"66","t":"+8.9%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Charity Mgmt #001","Charity Mgmt #002","292","2.403","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Charity Mgmt #002","Charity Mgmt #003","7.321","5.437","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Charity Mgmt #003","Charity Mgmt #004","4.726","2.997","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Charity Mgmt #004","Charity Mgmt #005","6.423","7.845","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Charity Mgmt #005","Charity Mgmt #001","3.551","8.277","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":389},{"label":"Fev","value":293},{"label":"Mar","value":581},{"label":"Abr","value":444},{"label":"Mai","value":351},{"label":"Jun","value":288},{"label":"Jul","value":224},{"label":"Ago","value":453},{"label":"Set","value":398},{"label":"Out","value":234},{"label":"Nov","value":569},{"label":"Dez","value":575}];
const MX = 581;
