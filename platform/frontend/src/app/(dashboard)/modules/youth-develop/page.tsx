...
const KPIS = [
    { label: "Total Registos", value: "7194", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "760", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€81K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2091679094", cells: ["YOU-8094", "Youth Development Item 1", "23/3/2026", "€29 194"], status: "active" as const },
    { id: "2091682665", cells: ["YOU-2665", "Youth Development Item 2", "10/10/2026", "€32 765"], status: "pending" as const },
    { id: "2091686236", cells: ["YOU-6236", "Youth Development Item 3", "25/5/2026", "€36 336"], status: "completed" as const },
    { id: "2091689807", cells: ["YOU-9807", "Youth Development Item 4", "12/12/2026", "€39 907"], status: "warning" as const },
    { id: "2091693378", cells: ["YOU-4378", "Youth Development Item 5", "27/7/2026", "€43 478"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Youth Development</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Youth Development</p>
                    </div>
                </div>
