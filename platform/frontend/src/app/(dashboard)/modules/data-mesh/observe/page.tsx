...
const PAGE = "Observe";
const KPIS = [{"l":"Dashboards Ativos","v":"467","t":"+9.1%","d":"up"},{"l":"Queries/Dia","v":"3501","t":"+17.1%","d":"up"},{"l":"Dados Processados (GB)","v":"7.073","t":"+16.5%","d":"up"},{"l":"Utilizadores Analytics","v":"8.332","t":"-3.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4737","2026-01-03","4.556","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4523","2026-02-19","1.487","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3876","2026-02-23","6.845","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4046","2026-03-26","5.712","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1133","2026-03-06","7.039","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":995},{"label":"Mar","value":953},{"label":"Abr","value":624},{"label":"Mai","value":685},{"label":"Jun","value":942},{"label":"Jul","value":1019},{"label":"Ago","value":970},{"label":"Set","value":932},{"label":"Out","value":729},{"label":"Nov","value":658},{"label":"Dez","value":705}];
const MX = 1019;
