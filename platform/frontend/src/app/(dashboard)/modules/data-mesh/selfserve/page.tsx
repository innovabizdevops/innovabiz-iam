...
const KPIS = [{"l":"Dashboards Ativos","v":"2.349","t":"+0.1%","d":"up"},{"l":"Queries/Dia","v":"4298","t":"+3.9%","d":"up"},{"l":"Dados Processados (GB)","v":"1.268","t":"+2.4%","d":"up"},{"l":"Utilizadores Analytics","v":"8.590","t":"+15.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4050","2026-02-17","7.406","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2057","2026-02-20","5.673","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3281","2026-02-28","1.571","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3607","2026-01-12","1.230","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","401","2026-02-25","6.782","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":712},{"label":"Mar","value":707},{"label":"Abr","value":799},{"label":"Mai","value":737},{"label":"Jun","value":854},{"label":"Jul","value":869},{"label":"Ago","value":863},{"label":"Set","value":776},{"label":"Out","value":623},{"label":"Nov","value":666},{"label":"Dez","value":679}];
const MX = 869;
