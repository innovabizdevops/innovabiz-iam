...
const PAGE = "Domain";
const KPIS = [{"l":"Dashboards Ativos","v":"4.259","t":"-3.3%","d":"down"},{"l":"Queries/Dia","v":"1673","t":"-0.9%","d":"down"},{"l":"Dados Processados (GB)","v":"1.452","t":"-2.4%","d":"down"},{"l":"Utilizadores Analytics","v":"2.778","t":"+14.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3350","2026-02-10","3.287","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3234","2026-01-24","1.071","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","131","2026-02-10","3.849","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1170","2026-02-05","6.837","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2515","2026-03-03","6.195","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":1017},{"label":"Mar","value":840},{"label":"Abr","value":1023},{"label":"Mai","value":791},{"label":"Jun","value":832},{"label":"Jul","value":837},{"label":"Ago","value":661},{"label":"Set","value":811},{"label":"Out","value":996},{"label":"Nov","value":693},{"label":"Dez","value":1018}];
const MX = 1023;
