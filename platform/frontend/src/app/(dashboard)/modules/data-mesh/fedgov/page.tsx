...
const ACCENT = "#8b5cf6";
const MODULE = "Data Mesh Architecture";
const PAGE = "Govern";
const KPIS = [{"l":"Dashboards Ativos","v":"5.256","t":"+6.4%","d":"up"},{"l":"Queries/Dia","v":"4010","t":"+8.3%","d":"up"},{"l":"Dados Processados (GB)","v":"6.870","t":"-0.3%","d":"down"},{"l":"Utilizadores Analytics","v":"3.805","t":"+2.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3765","2026-03-21","6.885","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2604","2026-02-28","2.749","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4723","2026-01-04","7.365","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2505","2026-03-25","353","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2184","2026-03-27","4.506","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":977},{"label":"Fev","value":1008},{"label":"Mar","value":967},{"label":"Abr","value":917},{"label":"Mai","value":1062},{"label":"Jun","value":751},{"label":"Jul","value":746},{"label":"Ago","value":804},{"label":"Set","value":875},{"label":"Out","value":767},{"label":"Nov","value":870},{"label":"Dez","value":982}];
const MX = 1062;
...
export default function FedgovPage() {
    return (
