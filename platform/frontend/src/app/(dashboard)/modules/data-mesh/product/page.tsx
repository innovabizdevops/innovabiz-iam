...
const PAGE = "Product";
const KPIS = [{"l":"Dashboards Ativos","v":"482","t":"+3.2%","d":"up"},{"l":"Queries/Dia","v":"2041","t":"+0.3%","d":"up"},{"l":"Dados Processados (GB)","v":"1.511","t":"+5.1%","d":"up"},{"l":"Utilizadores Analytics","v":"1.633","t":"+17.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2533","2026-03-09","1.861","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3622","2026-03-11","5.174","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1628","2026-02-02","1.043","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","950","2026-03-03","262","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1266","2026-02-22","7.900","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":673},{"label":"Mar","value":426},{"label":"Abr","value":653},{"label":"Mai","value":603},{"label":"Jun","value":397},{"label":"Jul","value":378},{"label":"Ago","value":498},{"label":"Set","value":630},{"label":"Out","value":686},{"label":"Nov","value":683},{"label":"Dez","value":738}];
const MX = 738;
