...
/* ═══ Data Mesh Architecture — Dashboard ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total Registos", value: "4867", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1631", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€141K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "-25%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "56652567", cells: ["DAT-7567", "Data Mesh Architecture Item 1", "28/4/2026", "€2667"], status: "active" as const },
    { id: "56656138", cells: ["DAT-2138", "Data Mesh Architecture Item 2", "15/11/2026", "€6238"], status: "pending" as const },
    { id: "56659709", cells: ["DAT-5709", "Data Mesh Architecture Item 3", "2/6/2026", "€9809"], status: "completed" as const },
    { id: "56663280", cells: ["DAT-9280", "Data Mesh Architecture Item 4", "17/1/2026", "€13 380"], status: "warning" as const },
    { id: "56666851", cells: ["DAT-3851", "Data Mesh Architecture Item 5", "4/8/2026", "€16 951"], status: "active" as const },
];
...
export default function DataMeshArchitecturePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Mesh Architecture</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Mesh Architecture</p>
                    </div>
                </div>
