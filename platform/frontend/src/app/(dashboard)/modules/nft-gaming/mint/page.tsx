...
const PAGE = "Token Mint";
const KPIS = [{"l":"Total Nft Gaming","v":"2.273","t":"+16.3%","d":"up"},{"l":"Token Mint Ativos","v":"6.038","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"85.0%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"66","t":"+11.5%","d":"up"}];
const COLS = ["ID","Token Mint","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nft Gaming #001","Nft Gaming #002","6.412","7.840","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Nft Gaming #002","Nft Gaming #003","5.542","3.545","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Nft Gaming #003","Nft Gaming #004","8.185","1.257","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Nft Gaming #004","Nft Gaming #005","4.137","1.472","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nft Gaming #005","Nft Gaming #001","6.999","1.898","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":369},{"label":"Mar","value":617},{"label":"Abr","value":423},{"label":"Mai","value":364},{"label":"Jun","value":574},{"label":"Jul","value":394},{"label":"Ago","value":380},{"label":"Set","value":539},{"label":"Out","value":288},{"label":"Nov","value":328},{"label":"Dez","value":406}];
const MX = 617;
