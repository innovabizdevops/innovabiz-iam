...
/* ═══ Resource Geology — Assay Lab ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "3729", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "148", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3148", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "53514592", cells: ["RES-1592", "Assay Lab Item 1", "13/5/2026", "€14 692"], status: "active" as const },
    { id: "53518163", cells: ["RES-5163", "Assay Lab Item 2", "28/12/2026", "€18 263"], status: "pending" as const },
    { id: "53521734", cells: ["RES-8734", "Assay Lab Item 3", "15/7/2026", "€21 834"], status: "completed" as const },
    { id: "53525305", cells: ["RES-3305", "Assay Lab Item 4", "2/2/2026", "€25 405"], status: "warning" as const },
    { id: "53528876", cells: ["RES-6876", "Assay Lab Item 5", "17/9/2026", "€28 976"], status: "active" as const },
];
...
export default function ResourceGeologyAssayLabPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Assay Lab</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Resource Geology • Assay Lab</p>
                    </div>
                </div>
