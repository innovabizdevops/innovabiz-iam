...
/* ═══ Resource Geology — Resource Estimate ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "229", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "408", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1200", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "75%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1940393588", cells: ["RES-3588", "Resource Estimate Item 1", "1/9/2026", "€43 688"], status: "active" as const },
    { id: "1940397159", cells: ["RES-7159", "Resource Estimate Item 2", "16/4/2026", "€47 259"], status: "pending" as const },
    { id: "1940400730", cells: ["RES-1730", "Resource Estimate Item 3", "3/11/2026", "€830"], status: "completed" as const },
    { id: "1940404301", cells: ["RES-5301", "Resource Estimate Item 4", "18/6/2026", "€4401"], status: "warning" as const },
    { id: "1940407872", cells: ["RES-8872", "Resource Estimate Item 5", "5/1/2026", "€7972"], status: "active" as const },
];
...
export default function ResourceGeologyResourceEstimatePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Resource Estimate</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Resource Geology • Resource Estimate</p>
                    </div>
                </div>
