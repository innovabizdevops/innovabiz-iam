...
/* ═══ Resource Geology — Geostatistics ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "2379", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "230", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1204", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "423262834", cells: ["RES-2834", "Geostatistics Item 1", "23/11/2026", "€12 934"], status: "active" as const },
    { id: "423266405", cells: ["RES-6405", "Geostatistics Item 2", "10/6/2026", "€16 505"], status: "pending" as const },
    { id: "423269976", cells: ["RES-9976", "Geostatistics Item 3", "25/1/2026", "€20 076"], status: "completed" as const },
    { id: "423273547", cells: ["RES-4547", "Geostatistics Item 4", "12/8/2026", "€23 647"], status: "warning" as const },
    { id: "423277118", cells: ["RES-8118", "Geostatistics Item 5", "27/3/2026", "€27 218"], status: "active" as const },
];
...
export default function ResourceGeologyGeostatisticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Geostatistics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Resource Geology • Geostatistics</p>
                    </div>
                </div>
