...
/* ═══ Resource Geology — Remote Sensing Geo ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "116", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "332", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3241", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "75%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1765226648", cells: ["RES-3648", "Remote Sensing Geo Item 1", "25/9/2026", "€26 748"], status: "active" as const },
    { id: "1765230219", cells: ["RES-7219", "Remote Sensing Geo Item 2", "12/4/2026", "€30 319"], status: "pending" as const },
    { id: "1765233790", cells: ["RES-1790", "Remote Sensing Geo Item 3", "27/11/2026", "€33 890"], status: "completed" as const },
    { id: "1765237361", cells: ["RES-5361", "Remote Sensing Geo Item 4", "14/6/2026", "€37 461"], status: "warning" as const },
    { id: "1765240932", cells: ["RES-8932", "Remote Sensing Geo Item 5", "1/1/2026", "€41 032"], status: "active" as const },
];
...
export default function ResourceGeologyRemoteSensingGeoPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Remote Sensing Geo</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Resource Geology • Remote Sensing Geo</p>
                    </div>
                </div>
