...
/* ═══ Resource Geology — Exploration Data ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "4777", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "241", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1581", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1340929805", cells: ["RES-2805", "Exploration Data Item 1", "6/6/2026", "€29 905"], status: "active" as const },
    { id: "1340933376", cells: ["RES-6376", "Exploration Data Item 2", "21/1/2026", "€33 476"], status: "pending" as const },
    { id: "1340936947", cells: ["RES-9947", "Exploration Data Item 3", "8/8/2026", "€37 047"], status: "completed" as const },
    { id: "1340940518", cells: ["RES-4518", "Exploration Data Item 4", "23/3/2026", "€40 618"], status: "warning" as const },
    { id: "1340944089", cells: ["RES-8089", "Exploration Data Item 5", "10/10/2026", "€44 189"], status: "active" as const },
];
...
export default function ResourceGeologyExplorationDataPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Exploration Data</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Resource Geology • Exploration Data</p>
                    </div>
                </div>
