...
/* ═══ Resource Geology — Core Logging ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "652", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "392", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2102", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "504296996", cells: ["RES-9996", "Core Logging Item 1", "1/9/2026", "€47 096"], status: "active" as const },
    { id: "504300567", cells: ["RES-4567", "Core Logging Item 2", "16/4/2026", "€667"], status: "pending" as const },
    { id: "504304138", cells: ["RES-8138", "Core Logging Item 3", "3/11/2026", "€4238"], status: "completed" as const },
    { id: "504307709", cells: ["RES-2709", "Core Logging Item 4", "18/6/2026", "€7809"], status: "warning" as const },
    { id: "504311280", cells: ["RES-6280", "Core Logging Item 5", "5/1/2026", "€11 380"], status: "active" as const },
];
...
export default function ResourceGeologyCoreLoggingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Core Logging</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Resource Geology • Core Logging</p>
                    </div>
                </div>
