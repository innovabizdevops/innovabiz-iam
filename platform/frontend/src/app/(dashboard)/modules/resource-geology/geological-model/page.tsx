...
/* ═══ Resource Geology — Geological Model ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "4495", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "13", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3526", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "82%", trend: "-8%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1987174425", cells: ["RES-2425", "Geological Model Item 1", "6/10/2026", "€24 525"], status: "active" as const },
    { id: "1987177996", cells: ["RES-5996", "Geological Model Item 2", "21/5/2026", "€28 096"], status: "pending" as const },
    { id: "1987181567", cells: ["RES-9567", "Geological Model Item 3", "8/12/2026", "€31 667"], status: "completed" as const },
    { id: "1987185138", cells: ["RES-4138", "Geological Model Item 4", "23/7/2026", "€35 238"], status: "warning" as const },
    { id: "1987188709", cells: ["RES-7709", "Geological Model Item 5", "10/2/2026", "€38 809"], status: "active" as const },
];
...
export default function ResourceGeologyGeologicalModelPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Geological Model</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Resource Geology • Geological Model</p>
                    </div>
                </div>
