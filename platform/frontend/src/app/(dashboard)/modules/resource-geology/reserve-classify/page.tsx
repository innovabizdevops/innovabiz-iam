...
/* ═══ Resource Geology — Reserve Classify ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "4253", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "278", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "300", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1295886098", cells: ["RES-4098", "Reserve Classify Item 1", "11/3/2026", "€36 198"], status: "active" as const },
    { id: "1295889669", cells: ["RES-7669", "Reserve Classify Item 2", "26/10/2026", "€39 769"], status: "pending" as const },
    { id: "1295893240", cells: ["RES-2240", "Reserve Classify Item 3", "13/5/2026", "€43 340"], status: "completed" as const },
    { id: "1295896811", cells: ["RES-5811", "Reserve Classify Item 4", "28/12/2026", "€46 911"], status: "warning" as const },
    { id: "1295900382", cells: ["RES-9382", "Reserve Classify Item 5", "15/7/2026", "€482"], status: "active" as const },
];
...
export default function ResourceGeologyReserveClassifyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Reserve Classify</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Resource Geology • Reserve Classify</p>
                    </div>
                </div>
