...
/* ═══ Resource Geology — Mine Planning Geo ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "688", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "431", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3626", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "90%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1159353323", cells: ["RES-1323", "Mine Planning Geo Item 1", "24/12/2026", "€3423"], status: "active" as const },
    { id: "1159356894", cells: ["RES-4894", "Mine Planning Geo Item 2", "11/7/2026", "€6994"], status: "pending" as const },
    { id: "1159360465", cells: ["RES-8465", "Mine Planning Geo Item 3", "26/2/2026", "€10 565"], status: "completed" as const },
    { id: "1159364036", cells: ["RES-3036", "Mine Planning Geo Item 4", "13/9/2026", "€14 136"], status: "warning" as const },
    { id: "1159367607", cells: ["RES-6607", "Mine Planning Geo Item 5", "28/4/2026", "€17 707"], status: "active" as const },
];
...
export default function ResourceGeologyMinePlanningGeoPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mine Planning Geo</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Resource Geology • Mine Planning Geo</p>
                    </div>
                </div>
