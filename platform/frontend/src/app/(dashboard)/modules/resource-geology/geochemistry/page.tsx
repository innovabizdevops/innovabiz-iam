...
/* ═══ Resource Geology — Geochemistry ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "1191", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "315", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2462", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "989207847", cells: ["RES-9847", "Geochemistry Item 1", "20/4/2026", "€7947"], status: "active" as const },
    { id: "989211418", cells: ["RES-4418", "Geochemistry Item 2", "7/11/2026", "€11 518"], status: "pending" as const },
    { id: "989214989", cells: ["RES-7989", "Geochemistry Item 3", "22/6/2026", "€15 089"], status: "completed" as const },
    { id: "989218560", cells: ["RES-2560", "Geochemistry Item 4", "9/1/2026", "€18 660"], status: "warning" as const },
    { id: "989222131", cells: ["RES-6131", "Geochemistry Item 5", "24/8/2026", "€22 231"], status: "active" as const },
];
...
export default function ResourceGeologyGeochemistryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Geochemistry</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Resource Geology • Geochemistry</p>
                    </div>
                </div>
