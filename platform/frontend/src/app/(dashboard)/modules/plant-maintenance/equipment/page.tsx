...
const PAGE = "Equipment Registry";
const KPIS = [{"l":"Total Plant Maintenance","v":"7.055","t":"+13.2%","d":"up"},{"l":"Equipment Registry Ativos","v":"1.384","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"92.5%","t":"-2.6%","d":"down"},{"l":"Score Performance","v":"60","t":"+8.1%","d":"up"}];
const COLS = ["ID","Equipment Registry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Plant Maintenance #001","Plant Maintenance #002","1.309","7.184","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Plant Maintenance #002","Plant Maintenance #003","2.392","724","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Plant Maintenance #003","Plant Maintenance #004","5.394","3.679","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Plant Maintenance #004","Plant Maintenance #005","1.861","4.298","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Plant Maintenance #005","Plant Maintenance #001","1.487","8.014","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":696},{"label":"Mar","value":610},{"label":"Abr","value":575},{"label":"Mai","value":629},{"label":"Jun","value":636},{"label":"Jul","value":572},{"label":"Ago","value":706},{"label":"Set","value":718},{"label":"Out","value":475},{"label":"Nov","value":506},{"label":"Dez","value":449}];
const MX = 718;
