...
const PAGE = "Spare Parts";
const KPIS = [{"l":"Quartos Ocupados","v":"2.073","t":"-5.8%","d":"down"},{"l":"RevPAR (€)","v":"€92357","t":"+12.8%","d":"up"},{"l":"Ocupação (%)","v":"65.4%","t":"+15.2%","d":"up"},{"l":"Guest Satisfaction","v":"2.460","t":"+2.4%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.123","2026-03-21","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.676","2026-02-16","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.771","2026-03-17","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.020","2026-01-27","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.846","2026-02-27","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":579},{"label":"Mar","value":676},{"label":"Abr","value":415},{"label":"Mai","value":410},{"label":"Jun","value":693},{"label":"Jul","value":394},{"label":"Ago","value":322},{"label":"Set","value":498},{"label":"Out","value":604},{"label":"Nov","value":422},{"label":"Dez","value":611}];
const MX = 693;
