...
const PAGE = "Predictive Maint AI";
const KPIS = [{"l":"Integrações Ativas","v":"8.652","t":"+5.1%","d":"up"},{"l":"Chamadas/Hora","v":"3973","t":"+3.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"91.2%","t":"+17.4%","d":"up"},{"l":"Latência Média (ms)","v":"179ms","t":"-2.6%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.923","6.121","94.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.866","4.561","73.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.390","8.469","79.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.149","5.840","70.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.587","2.433","73.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":839},{"label":"Mar","value":825},{"label":"Abr","value":805},{"label":"Mai","value":780},{"label":"Jun","value":743},{"label":"Jul","value":749},{"label":"Ago","value":896},{"label":"Set","value":767},{"label":"Out","value":682},{"label":"Nov","value":838},{"label":"Dez","value":728}];
const MX = 910;
