...
const PAGE = "Digital Work Instructions";
const KPIS = [{"l":"Total Plant Maintenance","v":"6.422","t":"-4.9%","d":"down"},{"l":"Digital Work Instructions Ativos","v":"1.271","t":"+13.4%","d":"up"},{"l":"Eficiência (%)","v":"82.1%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"62","t":"+11.1%","d":"up"}];
const COLS = ["ID","Digital Work Instructions","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Plant Maintenance #001","Plant Maintenance #002","5.599","4.930","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Plant Maintenance #002","Plant Maintenance #003","8.142","4.114","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Plant Maintenance #003","Plant Maintenance #004","1.063","2.440","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Plant Maintenance #004","Plant Maintenance #005","3.750","6.312","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Plant Maintenance #005","Plant Maintenance #001","6.998","1.624","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":861},{"label":"Fev","value":829},{"label":"Mar","value":807},{"label":"Abr","value":554},{"label":"Mai","value":791},{"label":"Jun","value":732},{"label":"Jul","value":490},{"label":"Ago","value":500},{"label":"Set","value":567},{"label":"Out","value":603},{"label":"Nov","value":478},{"label":"Dez","value":519}];
const MX = 861;
...
export default function WorkInstPage() {
    return (
