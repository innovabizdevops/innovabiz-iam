...
const PAGE = "MTBF/MTTR Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"7.966","t":"-5.8%","d":"down"},{"l":"Queries/Dia","v":"2654","t":"+14.9%","d":"up"},{"l":"Dados Processados (GB)","v":"446","t":"+0.6%","d":"up"},{"l":"Utilizadores Analytics","v":"6.100","t":"+9.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","962","2026-03-22","6.152","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3305","2026-03-25","8.416","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4887","2026-02-03","7.597","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","367","2026-03-08","6.503","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","709","2026-03-27","8.421","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":775},{"label":"Mar","value":530},{"label":"Abr","value":658},{"label":"Mai","value":768},{"label":"Jun","value":673},{"label":"Jul","value":740},{"label":"Ago","value":495},{"label":"Set","value":436},{"label":"Out","value":487},{"label":"Nov","value":586},{"label":"Dez","value":612}];
const MX = 775;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#93c5fd'}}>Chart</span></h1>
                </div>
