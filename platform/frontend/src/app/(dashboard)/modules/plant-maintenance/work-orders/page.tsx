...
const KPIS = [{"l":"Total Plant Maintenance","v":"9.092","t":"+12.9%","d":"up"},{"l":"Work Orders Ativos","v":"8.455","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"72.0%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"88","t":"+10.5%","d":"up"}];
const COLS = ["ID","Work Orders","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Plant Maintenance #001","Plant Maintenance #002","8.338","2.565","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Plant Maintenance #002","Plant Maintenance #003","1.923","6.676","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Plant Maintenance #003","Plant Maintenance #004","2.273","6.164","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Plant Maintenance #004","Plant Maintenance #005","161","8.457","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Plant Maintenance #005","Plant Maintenance #001","4.147","4.664","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":462},{"label":"Fev","value":248},{"label":"Mar","value":580},{"label":"Abr","value":390},{"label":"Mai","value":248},{"label":"Jun","value":279},{"label":"Jul","value":273},{"label":"Ago","value":513},{"label":"Set","value":448},{"label":"Out","value":331},{"label":"Nov","value":425},{"label":"Dez","value":468}];
const MX = 580;
