...
const PAGE = "Maintenance Calendar";
const KPIS = [{"l":"Total Plant Maintenance","v":"139","t":"+4.8%","d":"up"},{"l":"Maintenance Calendar Ativos","v":"3.656","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"88","t":"+17.6%","d":"up"}];
const COLS = ["ID","Maintenance Calendar","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Plant Maintenance #001","Plant Maintenance #002","3.735","6.778","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Plant Maintenance #002","Plant Maintenance #003","1.920","8.088","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Plant Maintenance #003","Plant Maintenance #004","2.649","4.731","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Plant Maintenance #004","Plant Maintenance #005","1.753","5.769","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Plant Maintenance #005","Plant Maintenance #001","8.716","8.793","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":788},{"label":"Mar","value":544},{"label":"Abr","value":467},{"label":"Mai","value":598},{"label":"Jun","value":638},{"label":"Jul","value":757},{"label":"Ago","value":665},{"label":"Set","value":721},{"label":"Out","value":734},{"label":"Nov","value":555},{"label":"Dez","value":605}];
const MX = 788;
