...
const ACCENT = "#93c5fd";
const MODULE = "Plant Maintenance";
const PAGE = "Condition Monitoring";
const KPIS = [{"l":"Total Plant Maintenance","v":"8.132","t":"+15.1%","d":"up"},{"l":"Condition Monitoring Ativos","v":"8.780","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"94.2%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"79","t":"-5.9%","d":"down"}];
const COLS = ["ID","Condition Monitoring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Plant Maintenance #001","Plant Maintenance #002","830","7.843","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Plant Maintenance #002","Plant Maintenance #003","5.180","4.455","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Plant Maintenance #003","Plant Maintenance #004","8.035","5.044","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Plant Maintenance #004","Plant Maintenance #005","2.219","4.129","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Plant Maintenance #005","Plant Maintenance #001","5.933","7.655","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":820},{"label":"Mar","value":878},{"label":"Abr","value":853},{"label":"Mai","value":565},{"label":"Jun","value":594},{"label":"Jul","value":692},{"label":"Ago","value":502},{"label":"Set","value":656},{"label":"Out","value":568},{"label":"Nov","value":549},{"label":"Dez","value":622}];
const MX = 878;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#93c5fd'}}>IoT</span></h1>
                </div>
