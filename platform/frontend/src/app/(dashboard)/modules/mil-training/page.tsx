...
/* ═══ Military Training — Dashboard ═══ */

const ACCENT = "#cbd5e1";

const KPIS = [
    { label: "Total Registos", value: "934", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1163", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€196K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "-17%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "483200034", cells: ["MIL-9034", "Military Training Item 1", "3/7/2026", "€134"], status: "active" as const },
    { id: "483203605", cells: ["MIL-3605", "Military Training Item 2", "18/2/2026", "€3705"], status: "pending" as const },
    { id: "483207176", cells: ["MIL-7176", "Military Training Item 3", "5/9/2026", "€7276"], status: "completed" as const },
    { id: "483210747", cells: ["MIL-1747", "Military Training Item 4", "20/4/2026", "€10 847"], status: "warning" as const },
    { id: "483214318", cells: ["MIL-5318", "Military Training Item 5", "7/11/2026", "€14 418"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Military Training</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Military Training</p>
                    </div>
                </div>
