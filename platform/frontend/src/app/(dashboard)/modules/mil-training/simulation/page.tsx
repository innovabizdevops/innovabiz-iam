...
const ACCENT = "#cbd5e1";
const MODULE = "Military Training";
const PAGE = "Simulation";
const KPIS = [{"l":"Twins Ativos","v":"4.656","t":"+2.1%","d":"up"},{"l":"Simulações/Dia","v":"854","t":"+6.0%","d":"up"},{"l":"Precisão Modelo (%)","v":"72.7%","t":"+0.3%","d":"up"},{"l":"Latência Sync (ms)","v":"105ms","t":"+1.2%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","72.3%","2026-02-02","5.693","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","82.5%","2026-02-22","3.791","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","72.7%","2026-01-14","1.520","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","76.5%","2026-03-03","2.123","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","74.2%","2026-01-10","3.208","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":831},{"label":"Mar","value":662},{"label":"Abr","value":938},{"label":"Mai","value":787},{"label":"Jun","value":829},{"label":"Jul","value":825},{"label":"Ago","value":733},{"label":"Set","value":950},{"label":"Out","value":957},{"label":"Nov","value":769},{"label":"Dez","value":901}];
const MX = 957;
