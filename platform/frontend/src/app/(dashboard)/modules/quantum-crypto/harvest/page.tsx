...
const PAGE = "Harvest Risk";
const KPIS = [{"l":"Riscos Identificados","v":"1.085","t":"+17.8%","d":"up"},{"l":"Mitigações Ativas","v":"3.239","t":"+9.8%","d":"up"},{"l":"Score Risco Geral","v":"72","t":"+6.8%","d":"up"},{"l":"Incidentes YTD","v":"8.564","t":"+4.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","203","8.361","1.126","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.419","8.329","4.078","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.253","2.948","4.448","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.026","2.356","6.904","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.497","5.192","2.353","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":433},{"label":"Fev","value":419},{"label":"Mar","value":675},{"label":"Abr","value":560},{"label":"Mai","value":298},{"label":"Jun","value":530},{"label":"Jul","value":329},{"label":"Ago","value":386},{"label":"Set","value":312},{"label":"Out","value":512},{"label":"Nov","value":534},{"label":"Dez","value":487}];
const MX = 675;
