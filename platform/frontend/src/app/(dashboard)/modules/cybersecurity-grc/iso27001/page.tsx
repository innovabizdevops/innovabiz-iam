...
const PAGE = "ISO 27001";
const KPIS = [{"l":"Riscos Identificados","v":"2.615","t":"+10.5%","d":"up"},{"l":"Mitigações Ativas","v":"8.124","t":"-3.1%","d":"down"},{"l":"Score Risco Geral","v":"93","t":"+11.3%","d":"up"},{"l":"Incidentes YTD","v":"7.386","t":"+1.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.829","779","7.386","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.196","5.777","3.574","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.035","5.779","5.933","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","478","3.735","8.447","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.824","8.566","5.736","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":443},{"label":"Mar","value":683},{"label":"Abr","value":523},{"label":"Mai","value":699},{"label":"Jun","value":735},{"label":"Jul","value":397},{"label":"Ago","value":673},{"label":"Set","value":602},{"label":"Out","value":369},{"label":"Nov","value":486},{"label":"Dez","value":761}];
const MX = 761;
