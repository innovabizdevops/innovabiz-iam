...
const PAGE = "CIS Controls";
const KPIS = [{"l":"Riscos Identificados","v":"4.930","t":"+17.2%","d":"up"},{"l":"Mitigações Ativas","v":"1.509","t":"+14.1%","d":"up"},{"l":"Score Risco Geral","v":"69","t":"+0.9%","d":"up"},{"l":"Incidentes YTD","v":"5.924","t":"+3.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.709","3.489","6.967","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.876","2.097","5.471","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.819","2.625","1.530","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.257","5.610","7.447","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.829","4.878","1.386","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":597},{"label":"Fev","value":518},{"label":"Mar","value":450},{"label":"Abr","value":502},{"label":"Mai","value":461},{"label":"Jun","value":345},{"label":"Jul","value":542},{"label":"Ago","value":407},{"label":"Set","value":607},{"label":"Out","value":329},{"label":"Nov","value":319},{"label":"Dez","value":280}];
const MX = 607;
