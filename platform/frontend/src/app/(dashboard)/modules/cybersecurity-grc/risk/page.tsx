...
const KPIS = [{"l":"Riscos Identificados","v":"3.913","t":"+5.6%","d":"up"},{"l":"Mitigações Ativas","v":"3.633","t":"+6.7%","d":"up"},{"l":"Score Risco Geral","v":"82","t":"-0.3%","d":"down"},{"l":"Incidentes YTD","v":"292","t":"+1.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.818","3.209","6.211","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.949","1.704","4.813","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.801","4.153","7.409","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.744","1.311","6.570","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.438","7.325","6.958","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":507},{"label":"Mar","value":730},{"label":"Abr","value":692},{"label":"Mai","value":794},{"label":"Jun","value":854},{"label":"Jul","value":747},{"label":"Ago","value":723},{"label":"Set","value":659},{"label":"Out","value":607},{"label":"Nov","value":887},{"label":"Dez","value":611}];
const MX = 887;
