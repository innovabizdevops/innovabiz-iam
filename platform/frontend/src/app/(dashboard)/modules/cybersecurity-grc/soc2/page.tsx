...
const PAGE = "SOC 2";
const KPIS = [{"l":"Riscos Identificados","v":"6.643","t":"+17.5%","d":"up"},{"l":"Mitigações Ativas","v":"7.091","t":"-2.4%","d":"down"},{"l":"Score Risco Geral","v":"75","t":"+9.5%","d":"up"},{"l":"Incidentes YTD","v":"152","t":"+9.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.575","1.509","2.859","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.772","4.412","5.153","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.225","4.657","2.965","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.646","6.481","868","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.661","2.766","6.378","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":336},{"label":"Fev","value":379},{"label":"Mar","value":382},{"label":"Abr","value":551},{"label":"Mai","value":568},{"label":"Jun","value":313},{"label":"Jul","value":451},{"label":"Ago","value":496},{"label":"Set","value":392},{"label":"Out","value":651},{"label":"Nov","value":606},{"label":"Dez","value":370}];
const MX = 651;
