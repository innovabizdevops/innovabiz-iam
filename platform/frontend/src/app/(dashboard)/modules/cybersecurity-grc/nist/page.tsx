...
const ACCENT = "#78350f";
const MODULE = "Cybersecurity GRC";
const PAGE = "NIST Framework";
const KPIS = [{"l":"Riscos Identificados","v":"4.592","t":"-2.1%","d":"down"},{"l":"Mitigações Ativas","v":"528","t":"-4.3%","d":"down"},{"l":"Score Risco Geral","v":"92","t":"-3.4%","d":"down"},{"l":"Incidentes YTD","v":"6.711","t":"-5.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.888","2.074","280","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.350","6.480","2.566","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.618","3.199","1.940","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.602","3.285","4.715","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.494","449","8.481","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":344},{"label":"Fev","value":654},{"label":"Mar","value":677},{"label":"Abr","value":471},{"label":"Mai","value":363},{"label":"Jun","value":579},{"label":"Jul","value":395},{"label":"Ago","value":680},{"label":"Set","value":577},{"label":"Out","value":706},{"label":"Nov","value":716},{"label":"Dez","value":576}];
const MX = 716;
