...
const ACCENT = "#6366f1";
const MODULE = "Milk Run Logistics";
const PAGE = "Optimize";
const KPIS = [{"l":"Total Milk Run","v":"7.430","t":"+2.2%","d":"up"},{"l":"Optimize Ativos","v":"7.434","t":"+13.4%","d":"up"},{"l":"Eficiência (%)","v":"79.7%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"67","t":"+4.7%","d":"up"}];
const COLS = ["ID","Optimize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Milk Run #001","Milk Run #002","5.040","5.301","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Milk Run #002","Milk Run #003","7.064","5.824","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Milk Run #003","Milk Run #004","3.501","5.143","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Milk Run #004","Milk Run #005","3.419","7.395","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Milk Run #005","Milk Run #001","4.575","8.792","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":361},{"label":"Fev","value":524},{"label":"Mar","value":358},{"label":"Abr","value":617},{"label":"Mai","value":404},{"label":"Jun","value":511},{"label":"Jul","value":605},{"label":"Ago","value":526},{"label":"Set","value":557},{"label":"Out","value":642},{"label":"Nov","value":455},{"label":"Dez","value":329}];
const MX = 642;
