...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Milk Run","v":"7.581","t":"-3.7%","d":"down"},{"l":"Schedule Ativos","v":"1.495","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"91.0%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"83","t":"-3.4%","d":"down"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Milk Run #001","Milk Run #002","185","1.979","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Milk Run #002","Milk Run #003","5.374","3.554","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Milk Run #003","Milk Run #004","4.132","8.733","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Milk Run #004","Milk Run #005","1.621","1.094","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Milk Run #005","Milk Run #001","4.895","8.858","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":250},{"label":"Fev","value":369},{"label":"Mar","value":640},{"label":"Abr","value":371},{"label":"Mai","value":432},{"label":"Jun","value":351},{"label":"Jul","value":589},{"label":"Ago","value":296},{"label":"Set","value":569},{"label":"Out","value":325},{"label":"Nov","value":508},{"label":"Dez","value":610}];
const MX = 640;
