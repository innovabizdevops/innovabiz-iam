...
const PAGE = "Track";
const KPIS = [{"l":"Total Milk Run","v":"7.773","t":"+2.6%","d":"up"},{"l":"Track Ativos","v":"8.664","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"94.5%","t":"+9.9%","d":"up"},{"l":"Score Performance","v":"86","t":"+12.2%","d":"up"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Milk Run #001","Milk Run #002","3.659","1.406","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Milk Run #002","Milk Run #003","6.771","7.479","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Milk Run #003","Milk Run #004","7.167","6.554","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Milk Run #004","Milk Run #005","6.570","3.476","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Milk Run #005","Milk Run #001","4.232","5.582","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":350},{"label":"Fev","value":373},{"label":"Mar","value":387},{"label":"Abr","value":521},{"label":"Mai","value":308},{"label":"Jun","value":323},{"label":"Jul","value":275},{"label":"Ago","value":362},{"label":"Set","value":367},{"label":"Out","value":417},{"label":"Nov","value":478},{"label":"Dez","value":610}];
const MX = 610;
