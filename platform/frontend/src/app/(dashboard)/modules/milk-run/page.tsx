...
export default function MilkRunPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Milk Run</h1><p className="text-sm text-muted-foreground">Milk Run • iBOS Enterprise</p></div>
