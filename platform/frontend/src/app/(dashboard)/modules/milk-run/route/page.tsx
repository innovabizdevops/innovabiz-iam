...
const PAGE = "Route";
const KPIS = [{"l":"Total Milk Run","v":"4.335","t":"+14.8%","d":"up"},{"l":"Route Ativos","v":"2.074","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"72","t":"-3.0%","d":"down"}];
const COLS = ["ID","Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Milk Run #001","Milk Run #002","3.361","1.131","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Milk Run #002","Milk Run #003","5.052","7.361","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Milk Run #003","Milk Run #004","474","8.239","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Milk Run #004","Milk Run #005","8.286","6.533","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Milk Run #005","Milk Run #001","6.877","5.738","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":611},{"label":"Mar","value":745},{"label":"Abr","value":777},{"label":"Mai","value":683},{"label":"Jun","value":704},{"label":"Jul","value":686},{"label":"Ago","value":498},{"label":"Set","value":677},{"label":"Out","value":711},{"label":"Nov","value":666},{"label":"Dez","value":621}];
const MX = 777;
