...
const PAGE = "Cost";
const KPIS = [{"l":"Total Milk Run","v":"7.310","t":"+2.2%","d":"up"},{"l":"Cost Ativos","v":"8.783","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"82.0%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"93","t":"-2.0%","d":"down"}];
const COLS = ["ID","Cost","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Milk Run #001","Milk Run #002","9.083","1.209","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Milk Run #002","Milk Run #003","3.270","3.482","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Milk Run #003","Milk Run #004","1.600","6.233","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Milk Run #004","Milk Run #005","8.222","499","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Milk Run #005","Milk Run #001","6.451","3.000","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":235},{"label":"Fev","value":483},{"label":"Mar","value":607},{"label":"Abr","value":406},{"label":"Mai","value":296},{"label":"Jun","value":457},{"label":"Jul","value":632},{"label":"Ago","value":366},{"label":"Set","value":614},{"label":"Out","value":509},{"label":"Nov","value":581},{"label":"Dez","value":247}];
const MX = 632;
