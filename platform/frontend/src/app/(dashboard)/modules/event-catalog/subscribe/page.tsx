...
const KPIS = [{"l":"Dashboards Ativos","v":"2.632","t":"+13.7%","d":"up"},{"l":"Queries/Dia","v":"1815","t":"+1.0%","d":"up"},{"l":"Dados Processados (GB)","v":"1.041","t":"+17.7%","d":"up"},{"l":"Utilizadores Analytics","v":"2.952","t":"-2.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4673","2026-02-20","3.391","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3333","2026-03-07","2.646","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","923","2026-01-02","4.753","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4512","2026-02-07","943","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4345","2026-02-05","6.019","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":817},{"label":"Mar","value":537},{"label":"Abr","value":710},{"label":"Mai","value":880},{"label":"Jun","value":740},{"label":"Jul","value":706},{"label":"Ago","value":532},{"label":"Set","value":856},{"label":"Out","value":491},{"label":"Nov","value":804},{"label":"Dez","value":862}];
const MX = 880;
