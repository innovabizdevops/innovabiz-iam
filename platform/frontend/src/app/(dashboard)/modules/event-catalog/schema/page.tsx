...
const PAGE = "Schema";
const KPIS = [{"l":"Dashboards Ativos","v":"6.336","t":"-5.6%","d":"down"},{"l":"Queries/Dia","v":"3930","t":"-0.8%","d":"down"},{"l":"Dados Processados (GB)","v":"6.411","t":"-1.5%","d":"down"},{"l":"Utilizadores Analytics","v":"5.729","t":"-2.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","536","2026-02-03","2.327","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","749","2026-03-26","5.345","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1920","2026-01-10","6.691","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2523","2026-03-07","8.478","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2994","2026-01-04","8.396","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":996},{"label":"Fev","value":690},{"label":"Mar","value":802},{"label":"Abr","value":722},{"label":"Mai","value":911},{"label":"Jun","value":894},{"label":"Jul","value":958},{"label":"Ago","value":773},{"label":"Set","value":1010},{"label":"Out","value":764},{"label":"Nov","value":735},{"label":"Dez","value":741}];
const MX = 1010;
