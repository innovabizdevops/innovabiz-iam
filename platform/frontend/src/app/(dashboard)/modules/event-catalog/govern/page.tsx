...
const PAGE = "Govern";
const KPIS = [{"l":"Dashboards Ativos","v":"7.260","t":"+7.4%","d":"up"},{"l":"Queries/Dia","v":"3056","t":"+13.4%","d":"up"},{"l":"Dados Processados (GB)","v":"2.770","t":"+3.5%","d":"up"},{"l":"Utilizadores Analytics","v":"9.070","t":"-4.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","934","2026-02-05","7.850","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","533","2026-01-08","8.938","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3008","2026-02-10","3.495","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4419","2026-03-20","7.931","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2790","2026-01-11","1.440","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":351},{"label":"Fev","value":442},{"label":"Mar","value":645},{"label":"Abr","value":561},{"label":"Mai","value":588},{"label":"Jun","value":441},{"label":"Jul","value":323},{"label":"Ago","value":519},{"label":"Set","value":526},{"label":"Out","value":408},{"label":"Nov","value":412},{"label":"Dez","value":605}];
const MX = 645;
