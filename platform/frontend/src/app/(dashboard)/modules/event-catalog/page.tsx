...
const KPIS = [
    { label: "Total Registos", value: "1255", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1433", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€164K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "-13%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2087435955", cells: ["EVE-3955", "Event Catalog Item 1", "4/4/2026", "€36 055"], status: "active" as const },
    { id: "2087439526", cells: ["EVE-7526", "Event Catalog Item 2", "19/11/2026", "€39 626"], status: "pending" as const },
    { id: "2087443097", cells: ["EVE-2097", "Event Catalog Item 3", "6/6/2026", "€43 197"], status: "completed" as const },
    { id: "2087446668", cells: ["EVE-5668", "Event Catalog Item 4", "21/1/2026", "€46 768"], status: "warning" as const },
    { id: "2087450239", cells: ["EVE-9239", "Event Catalog Item 5", "8/8/2026", "€339"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Event Catalog</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Event Catalog</p>
                    </div>
                </div>
