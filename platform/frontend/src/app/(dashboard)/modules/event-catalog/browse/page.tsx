...
const PAGE = "Browse";
const KPIS = [{"l":"Dashboards Ativos","v":"868","t":"+12.1%","d":"up"},{"l":"Queries/Dia","v":"594","t":"+16.8%","d":"up"},{"l":"Dados Processados (GB)","v":"7.605","t":"+17.2%","d":"up"},{"l":"Utilizadores Analytics","v":"1.496","t":"+9.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3310","2026-01-16","1.627","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4339","2026-03-14","3.206","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","402","2026-01-23","1.757","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4387","2026-01-23","8.959","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2585","2026-03-13","5.785","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":453},{"label":"Fev","value":400},{"label":"Mar","value":487},{"label":"Abr","value":592},{"label":"Mai","value":619},{"label":"Jun","value":380},{"label":"Jul","value":454},{"label":"Ago","value":480},{"label":"Set","value":589},{"label":"Out","value":401},{"label":"Nov","value":509},{"label":"Dez","value":378}];
const MX = 619;
