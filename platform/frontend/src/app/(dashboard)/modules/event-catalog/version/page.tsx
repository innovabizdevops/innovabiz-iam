...
const PAGE = "Version";
const KPIS = [{"l":"Formulários Ativos","v":"3.553","t":"+7.3%","d":"up"},{"l":"Submissões/Dia","v":"4167","t":"+13.5%","d":"up"},{"l":"Documentos Gerados","v":"1.327","t":"-5.8%","d":"down"},{"l":"Templates","v":"8.893","t":"-3.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.856","2026-03-20","2.025","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.768","2026-01-14","1.998","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.786","2026-03-15","5.611","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.533","2026-01-19","6.412","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.213","2026-03-03","5.994","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":318},{"label":"Fev","value":319},{"label":"Mar","value":503},{"label":"Abr","value":315},{"label":"Mai","value":393},{"label":"Jun","value":583},{"label":"Jul","value":550},{"label":"Ago","value":500},{"label":"Set","value":536},{"label":"Out","value":382},{"label":"Nov","value":549},{"label":"Dez","value":304}];
const MX = 583;
