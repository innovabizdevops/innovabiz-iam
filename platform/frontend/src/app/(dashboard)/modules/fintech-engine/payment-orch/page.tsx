...
const PAGE = "Payment Orchestration";
const KPIS = [{"l":"Total Fintech Engine","v":"8.272","t":"+16.5%","d":"up"},{"l":"Payment Orchestration Ativos","v":"1.022","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"80.5%","t":"+10.4%","d":"up"},{"l":"Score Performance","v":"92","t":"+15.3%","d":"up"}];
const COLS = ["ID","Payment Orchestration","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fintech Engine #001","Fintech Engine #002","2.488","6.047","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Fintech Engine #002","Fintech Engine #003","5.462","6.837","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Fintech Engine #003","Fintech Engine #004","2.921","7.198","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Fintech Engine #004","Fintech Engine #005","4.076","2.263","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fintech Engine #005","Fintech Engine #001","5.324","5.206","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":570},{"label":"Mar","value":423},{"label":"Abr","value":424},{"label":"Mai","value":668},{"label":"Jun","value":652},{"label":"Jul","value":667},{"label":"Ago","value":655},{"label":"Set","value":463},{"label":"Out","value":424},{"label":"Nov","value":371},{"label":"Dez","value":391}];
const MX = 668;
...
export default function PaymentOrchPage() {
    return (
