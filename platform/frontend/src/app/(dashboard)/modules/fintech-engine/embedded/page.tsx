...
const PAGE = "Embedded Finance";
const KPIS = [{"l":"Dashboards Ativos","v":"3.955","t":"+17.6%","d":"up"},{"l":"Queries/Dia","v":"1576","t":"-1.1%","d":"down"},{"l":"Dados Processados (GB)","v":"636","t":"+9.2%","d":"up"},{"l":"Utilizadores Analytics","v":"2.830","t":"+11.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3266","2026-02-20","321","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3180","2026-02-04","5.206","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","783","2026-02-25","5.802","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3095","2026-02-06","8.509","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4792","2026-01-24","1.077","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":632},{"label":"Mar","value":748},{"label":"Abr","value":887},{"label":"Mai","value":543},{"label":"Jun","value":841},{"label":"Jul","value":753},{"label":"Ago","value":583},{"label":"Set","value":608},{"label":"Out","value":664},{"label":"Nov","value":763},{"label":"Dez","value":837}];
const MX = 887;
