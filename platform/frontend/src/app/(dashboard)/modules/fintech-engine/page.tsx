...
export default function FintechEnginePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Fintech Engine</h1><p className="text-sm text-muted-foreground">Fintech Engine • iBOS Enterprise</p></div>
