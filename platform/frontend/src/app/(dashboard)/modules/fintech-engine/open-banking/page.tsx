...
const ACCENT = "#0d9488";
const MODULE = "FinTech Engine";
const PAGE = "Open Banking API";
const KPIS = [{"l":"Total Fintech Engine","v":"6.990","t":"-4.3%","d":"down"},{"l":"Open Banking API Ativos","v":"7.451","t":"+0.0%","d":"up"},{"l":"Eficiência (%)","v":"89.5%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"80","t":"+8.5%","d":"up"}];
const COLS = ["ID","Open Banking API","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fintech Engine #001","Fintech Engine #002","7.705","5.258","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Fintech Engine #002","Fintech Engine #003","635","5.856","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Fintech Engine #003","Fintech Engine #004","7.675","4.064","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Fintech Engine #004","Fintech Engine #005","2.606","5.680","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fintech Engine #005","Fintech Engine #001","3.054","1.453","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":627},{"label":"Mar","value":685},{"label":"Abr","value":941},{"label":"Mai","value":673},{"label":"Jun","value":980},{"label":"Jul","value":604},{"label":"Ago","value":600},{"label":"Set","value":627},{"label":"Out","value":817},{"label":"Nov","value":830},{"label":"Dez","value":724}];
const MX = 980;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0d9488'}}>PSD2</span></h1>
                </div>
