...
const KPIS = [{"l":"Formulários Ativos","v":"5.580","t":"+8.9%","d":"up"},{"l":"Submissões/Dia","v":"1077","t":"-5.8%","d":"down"},{"l":"Documentos Gerados","v":"8.614","t":"+5.9%","d":"up"},{"l":"Templates","v":"8.206","t":"+1.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","970","2026-03-10","4.878","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.340","2026-02-22","5.543","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","522","2026-02-09","3.904","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.244","2026-03-11","1.000","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.640","2026-03-06","6.986","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":844},{"label":"Fev","value":721},{"label":"Mar","value":1032},{"label":"Abr","value":735},{"label":"Mai","value":1048},{"label":"Jun","value":739},{"label":"Jul","value":856},{"label":"Ago","value":931},{"label":"Set","value":688},{"label":"Out","value":891},{"label":"Nov","value":942},{"label":"Dez","value":863}];
const MX = 1048;
