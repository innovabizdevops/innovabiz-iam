...
const PAGE = "RegTech Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.888","t":"+6.6%","d":"up"},{"l":"NC Abertas","v":"564","t":"-0.9%","d":"down"},{"l":"Conformidade (%)","v":"76.8%","t":"+11.4%","d":"up"},{"l":"CAPAs Pendentes","v":"3.111","t":"+12.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.738","78.9%","7.471","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.662","88.4%","3.146","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.490","70.3%","3.637","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.549","91.9%","8.870","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.141","73.0%","236","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":324},{"label":"Mar","value":365},{"label":"Abr","value":351},{"label":"Mai","value":604},{"label":"Jun","value":349},{"label":"Jul","value":429},{"label":"Ago","value":321},{"label":"Set","value":563},{"label":"Out","value":403},{"label":"Nov","value":328},{"label":"Dez","value":528}];
const MX = 616;
