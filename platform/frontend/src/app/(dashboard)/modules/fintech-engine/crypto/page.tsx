...
const PAGE = "Crypto Assets";
const KPIS = [{"l":"Ativos Registados","v":"4.123","t":"+7.1%","d":"up"},{"l":"Valor Total (€M)","v":"€21.6M","t":"+6.1%","d":"up"},{"l":"Depreciação Anual (€)","v":"€75908","t":"+14.4%","d":"up"},{"l":"Ativos em Garantia","v":"7.920","t":"-3.1%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 17601.30","4.003","€ 7115.19","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 33128.26","8.269","€ 31812.56","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 20804.65","3.352","€ 30886.12","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 15713.99","8.206","€ 20345.08","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 22652.17","2.187","€ 40845.40","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":748},{"label":"Mar","value":423},{"label":"Abr","value":662},{"label":"Mai","value":387},{"label":"Jun","value":472},{"label":"Jul","value":501},{"label":"Ago","value":450},{"label":"Set","value":706},{"label":"Out","value":635},{"label":"Nov","value":648},{"label":"Dez","value":528}];
const MX = 748;
