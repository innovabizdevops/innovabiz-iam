...
const PAGE = "Feedback";
const KPIS = [{"l":"Surveys Ativos","v":"5.543","t":"+10.4%","d":"up"},{"l":"Respostas/Semana","v":"2911","t":"+13.2%","d":"up"},{"l":"NPS Médio","v":"92","t":"-1.5%","d":"down"},{"l":"Taxa Resposta (%)","v":"90.7%","t":"+16.7%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","6.746","55","98.2%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","8.919","74","71.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","4.452","74","79.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","4.605","79","72.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","4.044","61","96.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":716},{"label":"Mar","value":675},{"label":"Abr","value":421},{"label":"Mai","value":494},{"label":"Jun","value":419},{"label":"Jul","value":366},{"label":"Ago","value":683},{"label":"Set","value":431},{"label":"Out","value":543},{"label":"Nov","value":366},{"label":"Dez","value":516}];
const MX = 716;
