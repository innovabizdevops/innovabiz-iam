...
const ACCENT = "#475569";
const MODULE = "Passenger Experience";
const PAGE = "Check-In AI";
const KPIS = [{"l":"Total Passenger Exp","v":"4.262","t":"-5.8%","d":"down"},{"l":"Check In AI Ativos","v":"8.626","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"+2.3%","d":"up"},{"l":"Score Performance","v":"57","t":"+10.2%","d":"up"}];
const COLS = ["ID","Check In AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Passenger Exp #001","2026-03-26","7.603","713","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Passenger Exp #002","2026-03-15","8.542","1.265","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Passenger Exp #003","2026-03-28","4.406","2.092","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Passenger Exp #004","2026-01-18","8.382","8.596","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Passenger Exp #005","2026-01-25","8.164","7.907","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1081},{"label":"Fev","value":1038},{"label":"Mar","value":965},{"label":"Abr","value":1003},{"label":"Mai","value":1097},{"label":"Jun","value":729},{"label":"Jul","value":854},{"label":"Ago","value":763},{"label":"Set","value":915},{"label":"Out","value":987},{"label":"Nov","value":753},{"label":"Dez","value":928}];
const MX = 1097;
