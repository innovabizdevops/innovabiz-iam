...
export default function PassengerExpPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Passenger Exp</h1><p className="text-sm text-muted-foreground">Passenger Exp • iBOS Enterprise</p></div>
