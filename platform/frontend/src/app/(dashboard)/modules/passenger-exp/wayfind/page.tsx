...
const PAGE = "Wayfinding";
const KPIS = [{"l":"Total Passenger Exp","v":"8.674","t":"+2.0%","d":"up"},{"l":"Wayfinding Ativos","v":"5.435","t":"+2.9%","d":"up"},{"l":"Eficiência (%)","v":"82.3%","t":"+0.1%","d":"up"},{"l":"Score Performance","v":"84","t":"+14.6%","d":"up"}];
const COLS = ["ID","Wayfinding","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Passenger Exp #001","Passenger Exp #002","1.111","5.552","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Passenger Exp #002","Passenger Exp #003","4.156","6.516","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Passenger Exp #003","Passenger Exp #004","3.939","4.648","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Passenger Exp #004","Passenger Exp #005","2.253","5.779","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Passenger Exp #005","Passenger Exp #001","6.578","7.696","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":754},{"label":"Fev","value":485},{"label":"Mar","value":673},{"label":"Abr","value":719},{"label":"Mai","value":635},{"label":"Jun","value":497},{"label":"Jul","value":787},{"label":"Ago","value":543},{"label":"Set","value":417},{"label":"Out","value":788},{"label":"Nov","value":625},{"label":"Dez","value":742}];
const MX = 788;
