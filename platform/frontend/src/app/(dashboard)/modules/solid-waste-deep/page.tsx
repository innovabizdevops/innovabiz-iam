...
export default function SolidWasteDeepPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Solid Waste Deep</h1><p className="text-sm text-muted-foreground">Solid Waste Deep • iBOS Enterprise</p></div>
            </div>
