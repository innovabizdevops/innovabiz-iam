...
const ACCENT = "#083344";
const MODULE = "Solid Waste Deep";
const PAGE = "Route";
const KPIS = [{"l":"Total Solid Waste Deep","v":"4.372","t":"+13.0%","d":"up"},{"l":"Route Ativos","v":"5.819","t":"+0.4%","d":"up"},{"l":"Eficiência (%)","v":"93.3%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"86","t":"-4.9%","d":"down"}];
const COLS = ["ID","Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Solid Waste Deep #001","Solid Waste Deep #002","7.875","3.300","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Solid Waste Deep #002","Solid Waste Deep #003","2.288","5.404","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Solid Waste Deep #003","Solid Waste Deep #004","4.612","1.726","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Solid Waste Deep #004","Solid Waste Deep #005","4.484","2.919","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Solid Waste Deep #005","Solid Waste Deep #001","2.599","4.984","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":896},{"label":"Mar","value":930},{"label":"Abr","value":747},{"label":"Mai","value":585},{"label":"Jun","value":767},{"label":"Jul","value":813},{"label":"Ago","value":772},{"label":"Set","value":901},{"label":"Out","value":646},{"label":"Nov","value":594},{"label":"Dez","value":595}];
const MX = 930;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#083344'}}>AI</span></h1>
                </div>
