...
const PAGE = "Fresh";
const KPIS = [{"l":"Total Grocery Ops","v":"117","t":"+9.9%","d":"up"},{"l":"Fresh Ativos","v":"8.329","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"78.7%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"63","t":"+10.4%","d":"up"}];
const COLS = ["ID","Fresh","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grocery Ops #001","Grocery Ops #002","1.053","2.720","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Grocery Ops #002","Grocery Ops #003","1.208","4.118","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Grocery Ops #003","Grocery Ops #004","8.344","230","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Grocery Ops #004","Grocery Ops #005","4.425","3.782","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grocery Ops #005","Grocery Ops #001","4.040","2.581","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":913},{"label":"Fev","value":812},{"label":"Mar","value":914},{"label":"Abr","value":1001},{"label":"Mai","value":940},{"label":"Jun","value":1009},{"label":"Jul","value":733},{"label":"Ago","value":926},{"label":"Set","value":969},{"label":"Out","value":874},{"label":"Nov","value":847},{"label":"Dez","value":959}];
const MX = 1009;
