...
const ACCENT = "#6366f1";
const MODULE = "Grocery Operations";
const PAGE = "Produce";
const KPIS = [{"l":"Total Grocery Ops","v":"3.802","t":"+14.8%","d":"up"},{"l":"Produce Ativos","v":"4.478","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"74","t":"+6.8%","d":"up"}];
const COLS = ["ID","Produce","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grocery Ops #001","Grocery Ops #002","6.777","7.602","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Grocery Ops #002","Grocery Ops #003","3.500","215","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Grocery Ops #003","Grocery Ops #004","6.061","5.556","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Grocery Ops #004","Grocery Ops #005","904","5.659","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grocery Ops #005","Grocery Ops #001","1.697","5.278","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":445},{"label":"Mar","value":523},{"label":"Abr","value":712},{"label":"Mai","value":388},{"label":"Jun","value":513},{"label":"Jul","value":458},{"label":"Ago","value":429},{"label":"Set","value":588},{"label":"Out","value":634},{"label":"Nov","value":654},{"label":"Dez","value":683}];
const MX = 712;
