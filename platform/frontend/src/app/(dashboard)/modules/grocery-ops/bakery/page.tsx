...
const PAGE = "Bakery";
const KPIS = [{"l":"Total Grocery Ops","v":"7.587","t":"+11.1%","d":"up"},{"l":"Bakery Ativos","v":"850","t":"+10.0%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"58","t":"+6.9%","d":"up"}];
const COLS = ["ID","Bakery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grocery Ops #001","Grocery Ops #002","5.453","8.382","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Grocery Ops #002","Grocery Ops #003","3.977","1.852","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Grocery Ops #003","Grocery Ops #004","2.006","2.370","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Grocery Ops #004","Grocery Ops #005","7.702","2.515","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grocery Ops #005","Grocery Ops #001","1.552","3.942","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":874},{"label":"Mar","value":549},{"label":"Abr","value":937},{"label":"Mai","value":635},{"label":"Jun","value":548},{"label":"Jul","value":633},{"label":"Ago","value":894},{"label":"Set","value":750},{"label":"Out","value":644},{"label":"Nov","value":776},{"label":"Dez","value":605}];
const MX = 937;
