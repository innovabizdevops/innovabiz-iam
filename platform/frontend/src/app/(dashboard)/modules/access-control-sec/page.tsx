...
export default function AccessControlSecPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Access Control Sec</h1><p className="text-sm text-muted-foreground">Access Control Sec • iBOS Enterprise</p></div>
