...
const PAGE = "Door";
const KPIS = [{"l":"Total Access Control Sec","v":"5.365","t":"+10.2%","d":"up"},{"l":"Door Ativos","v":"1.886","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"77.1%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"57","t":"+2.6%","d":"up"}];
const COLS = ["ID","Door","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Access Control Sec #001","Access Control Sec #002","565","3.196","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Access Control Sec #002","Access Control Sec #003","7.131","5.597","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Access Control Sec #003","Access Control Sec #004","4.707","652","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Access Control Sec #004","Access Control Sec #005","7.361","1.349","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Access Control Sec #005","Access Control Sec #001","4.749","2.981","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":734},{"label":"Mar","value":478},{"label":"Abr","value":457},{"label":"Mai","value":485},{"label":"Jun","value":516},{"label":"Jul","value":536},{"label":"Ago","value":666},{"label":"Set","value":712},{"label":"Out","value":529},{"label":"Nov","value":405},{"label":"Dez","value":662}];
const MX = 734;
