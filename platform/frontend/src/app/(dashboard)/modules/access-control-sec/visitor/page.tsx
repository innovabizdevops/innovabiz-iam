...
const PAGE = "Visitor";
const KPIS = [{"l":"Total Access Control Sec","v":"2.451","t":"+2.7%","d":"up"},{"l":"Visitor Ativos","v":"7.683","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"87.6%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"64","t":"+14.6%","d":"up"}];
const COLS = ["ID","Visitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Access Control Sec #001","Access Control Sec #002","6.679","6.457","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Access Control Sec #002","Access Control Sec #003","5.369","2.327","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Access Control Sec #003","Access Control Sec #004","3.039","7.352","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Access Control Sec #004","Access Control Sec #005","7.032","9.042","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Access Control Sec #005","Access Control Sec #001","5.902","5.778","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":820},{"label":"Mar","value":733},{"label":"Abr","value":833},{"label":"Mai","value":463},{"label":"Jun","value":447},{"label":"Jul","value":757},{"label":"Ago","value":446},{"label":"Set","value":631},{"label":"Out","value":821},{"label":"Nov","value":697},{"label":"Dez","value":584}];
const MX = 833;
