...
/* ═══ Silk Industry — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "1487", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1168", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€447K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1049579587", cells: ["SIL-9587", "Silk Industry Item 1", "8/8/2026", "€29 687"], status: "active" as const },
    { id: "1049583158", cells: ["SIL-4158", "Silk Industry Item 2", "23/3/2026", "€33 258"], status: "pending" as const },
    { id: "1049586729", cells: ["SIL-7729", "Silk Industry Item 3", "10/10/2026", "€36 829"], status: "completed" as const },
    { id: "1049590300", cells: ["SIL-2300", "Silk Industry Item 4", "25/5/2026", "€40 400"], status: "warning" as const },
    { id: "1049593871", cells: ["SIL-5871", "Silk Industry Item 5", "12/12/2026", "€43 971"], status: "active" as const },
];
...
export default function SilkIndustryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Silk Industry</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Silk Industry</p>
                    </div>
                </div>
