...
const ACCENT = "#7c3aed";
const MODULE = "Silk Industry";
const PAGE = "Sericulture";
const KPIS = [{"l":"Total Silk Industry","v":"6.091","t":"+8.7%","d":"up"},{"l":"Sericulture Ativos","v":"5.406","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"72.5%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"70","t":"-3.6%","d":"down"}];
const COLS = ["ID","Sericulture","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Silk Industry #001","Silk Industry #002","1.426","768","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Silk Industry #002","Silk Industry #003","3.946","8.367","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Silk Industry #003","Silk Industry #004","6.651","4.927","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Silk Industry #004","Silk Industry #005","5.615","4.495","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Silk Industry #005","Silk Industry #001","5.141","5.581","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":720},{"label":"Mar","value":640},{"label":"Abr","value":539},{"label":"Mai","value":526},{"label":"Jun","value":801},{"label":"Jul","value":666},{"label":"Ago","value":666},{"label":"Set","value":801},{"label":"Out","value":545},{"label":"Nov","value":595},{"label":"Dez","value":615}];
const MX = 801;
...
export default function SericulturePage() {
    return (
