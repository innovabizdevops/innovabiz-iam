...
const KPIS = [{"l":"Dashboards Ativos","v":"4.070","t":"+1.6%","d":"up"},{"l":"Queries/Dia","v":"695","t":"-5.3%","d":"down"},{"l":"Dados Processados (GB)","v":"4.997","t":"+12.8%","d":"up"},{"l":"Utilizadores Analytics","v":"4.119","t":"-1.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3827","2026-02-08","6.652","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","224","2026-01-20","7.404","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4580","2026-01-10","2.715","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2046","2026-01-15","6.238","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1394","2026-03-17","1.664","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":439},{"label":"Mar","value":431},{"label":"Abr","value":586},{"label":"Mai","value":812},{"label":"Jun","value":481},{"label":"Jul","value":679},{"label":"Ago","value":516},{"label":"Set","value":576},{"label":"Out","value":783},{"label":"Nov","value":599},{"label":"Dez","value":682}];
const MX = 812;
