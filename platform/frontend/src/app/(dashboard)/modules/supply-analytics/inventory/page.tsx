...
const KPIS = [{"l":"Dashboards Ativos","v":"6.586","t":"+14.1%","d":"up"},{"l":"Queries/Dia","v":"4230","t":"+2.2%","d":"up"},{"l":"Dados Processados (GB)","v":"7.374","t":"+6.7%","d":"up"},{"l":"Utilizadores Analytics","v":"7.115","t":"-1.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2722","2026-03-13","5.273","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1533","2026-02-02","5.834","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4406","2026-01-01","2.275","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1736","2026-03-14","5.115","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","948","2026-02-26","5.787","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":545},{"label":"Mar","value":388},{"label":"Abr","value":503},{"label":"Mai","value":500},{"label":"Jun","value":387},{"label":"Jul","value":591},{"label":"Ago","value":632},{"label":"Set","value":340},{"label":"Out","value":604},{"label":"Nov","value":412},{"label":"Dez","value":441}];
const MX = 632;
