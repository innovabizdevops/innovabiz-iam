...
const PAGE = "Demand";
const KPIS = [{"l":"Dashboards Ativos","v":"4.136","t":"+1.4%","d":"up"},{"l":"Queries/Dia","v":"4184","t":"+8.9%","d":"up"},{"l":"Dados Processados (GB)","v":"6.170","t":"+12.0%","d":"up"},{"l":"Utilizadores Analytics","v":"5.827","t":"+9.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","167","2026-03-19","1.731","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","111","2026-02-16","2.644","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2354","2026-02-07","1.778","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","422","2026-01-02","4.034","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3283","2026-02-23","5.707","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":782},{"label":"Fev","value":763},{"label":"Mar","value":697},{"label":"Abr","value":749},{"label":"Mai","value":774},{"label":"Jun","value":529},{"label":"Jul","value":551},{"label":"Ago","value":507},{"label":"Set","value":687},{"label":"Out","value":492},{"label":"Nov","value":496},{"label":"Dez","value":462}];
const MX = 782;
