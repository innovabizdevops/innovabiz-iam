...
const ACCENT = "#4338ca";
const MODULE = "Supply Chain Analytics";
const PAGE = "Disrupt";
const KPIS = [{"l":"Dashboards Ativos","v":"6.028","t":"-1.5%","d":"down"},{"l":"Queries/Dia","v":"2360","t":"-5.0%","d":"down"},{"l":"Dados Processados (GB)","v":"6.893","t":"-2.6%","d":"down"},{"l":"Utilizadores Analytics","v":"4.005","t":"-2.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3455","2026-03-03","5.646","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1153","2026-02-14","4.103","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1728","2026-03-15","3.419","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3557","2026-02-10","552","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1442","2026-02-22","7.740","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":306},{"label":"Mar","value":449},{"label":"Abr","value":316},{"label":"Mai","value":329},{"label":"Jun","value":644},{"label":"Jul","value":407},{"label":"Ago","value":530},{"label":"Set","value":430},{"label":"Out","value":550},{"label":"Nov","value":629},{"label":"Dez","value":647}];
const MX = 647;
