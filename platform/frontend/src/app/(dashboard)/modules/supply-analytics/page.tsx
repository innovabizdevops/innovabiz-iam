...
const KPIS = [
    { label: "Total Registos", value: "3119", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "862", trend: "-14%", trendDirection: "down" as const, icon: Users },
...
const TABLE_ROWS = [
    { id: "715842319", cells: ["SUP-1319", "Supply Chain Analytics Item 1", "4/8/2026", "€42 419"], status: "active" as const },
    { id: "715845890", cells: ["SUP-4890", "Supply Chain Analytics Item 2", "19/3/2026", "€45 990"], status: "pending" as const },
    { id: "715849461", cells: ["SUP-8461", "Supply Chain Analytics Item 3", "6/10/2026", "€49 561"], status: "completed" as const },
    { id: "715853032", cells: ["SUP-3032", "Supply Chain Analytics Item 4", "21/5/2026", "€3132"], status: "warning" as const },
    { id: "715856603", cells: ["SUP-6603", "Supply Chain Analytics Item 5", "8/12/2026", "€6703"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Supply Chain Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Supply Chain Analytics</p>
                    </div>
                </div>
