...
const PAGE = "Supplier";
const KPIS = [{"l":"Dashboards Ativos","v":"1.699","t":"+2.9%","d":"up"},{"l":"Queries/Dia","v":"2582","t":"+9.3%","d":"up"},{"l":"Dados Processados (GB)","v":"3.733","t":"+6.4%","d":"up"},{"l":"Utilizadores Analytics","v":"4.470","t":"+4.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2678","2026-03-20","2.936","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5080","2026-03-11","7.245","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2684","2026-02-23","8.727","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4852","2026-01-17","370","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2966","2026-02-20","6.431","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":242},{"label":"Mar","value":528},{"label":"Abr","value":541},{"label":"Mai","value":382},{"label":"Jun","value":388},{"label":"Jul","value":328},{"label":"Ago","value":460},{"label":"Set","value":257},{"label":"Out","value":626},{"label":"Nov","value":326},{"label":"Dez","value":420}];
const MX = 626;
