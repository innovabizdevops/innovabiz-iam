...
/* ═══ Dry Cleaning Ops — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "2187", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3104", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€396K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1976764787", cells: ["DRY-5787", "Dry Cleaning Ops Item 1", "12/12/2026", "€14 887"], status: "active" as const },
    { id: "1976768358", cells: ["DRY-9358", "Dry Cleaning Ops Item 2", "27/7/2026", "€18 458"], status: "pending" as const },
    { id: "1976771929", cells: ["DRY-3929", "Dry Cleaning Ops Item 3", "14/2/2026", "€22 029"], status: "completed" as const },
    { id: "1976775500", cells: ["DRY-7500", "Dry Cleaning Ops Item 4", "1/9/2026", "€25 600"], status: "warning" as const },
    { id: "1976779071", cells: ["DRY-2071", "Dry Cleaning Ops Item 5", "16/4/2026", "€29 171"], status: "active" as const },
];
...
export default function DryCleaningOpsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Dry Cleaning Ops</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Dry Cleaning Ops</p>
                    </div>
                </div>
