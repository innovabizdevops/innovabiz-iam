...
const PAGE = "Deliver";
const KPIS = [{"l":"Projetos Melhoria","v":"4.212","t":"+9.9%","d":"up"},{"l":"Savings (€)","v":"€70948","t":"+5.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"85.9%","t":"+16.6%","d":"up"},{"l":"Ciclos PDCA","v":"4.678","t":"+1.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.355","€ 38699.24","3.463","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.995","€ 30901.44","6.885","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.412","€ 47857.09","740","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.356","€ 20015.03","4.196","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.047","€ 43841.55","2.995","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":772},{"label":"Mar","value":646},{"label":"Abr","value":628},{"label":"Mai","value":490},{"label":"Jun","value":474},{"label":"Jul","value":416},{"label":"Ago","value":586},{"label":"Set","value":779},{"label":"Out","value":606},{"label":"Nov","value":763},{"label":"Dez","value":745}];
const MX = 781;
