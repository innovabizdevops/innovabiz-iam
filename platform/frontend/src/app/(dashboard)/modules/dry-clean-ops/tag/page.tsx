...
const PAGE = "Tag";
const KPIS = [{"l":"Projetos Melhoria","v":"8.283","t":"+7.0%","d":"up"},{"l":"Savings (€)","v":"€83724","t":"-1.1%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"91.1%","t":"+16.6%","d":"up"},{"l":"Ciclos PDCA","v":"2.167","t":"-1.9%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.883","€ 34305.03","265","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.355","€ 195.04","6.008","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.805","€ 13509.10","3.962","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.729","€ 27342.12","4.290","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.529","€ 14125.01","3.890","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":672},{"label":"Fev","value":608},{"label":"Mar","value":534},{"label":"Abr","value":626},{"label":"Mai","value":913},{"label":"Jun","value":615},{"label":"Jul","value":690},{"label":"Ago","value":629},{"label":"Set","value":701},{"label":"Out","value":604},{"label":"Nov","value":683},{"label":"Dez","value":710}];
const MX = 913;
