...
const PAGE = "Receive";
const KPIS = [{"l":"Projetos Melhoria","v":"2.354","t":"+15.8%","d":"up"},{"l":"Savings (€)","v":"€80070","t":"+4.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"86.6%","t":"+9.6%","d":"up"},{"l":"Ciclos PDCA","v":"3.509","t":"+11.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.004","€ 24197.46","7.019","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.346","€ 43626.48","467","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.500","€ 40229.75","6.539","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.035","€ 42106.09","3.373","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.281","€ 45653.47","5.637","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":831},{"label":"Mar","value":580},{"label":"Abr","value":915},{"label":"Mai","value":652},{"label":"Jun","value":612},{"label":"Jul","value":685},{"label":"Ago","value":880},{"label":"Set","value":722},{"label":"Out","value":898},{"label":"Nov","value":821},{"label":"Dez","value":775}];
const MX = 915;
