...
const PAGE = "Process";
const KPIS = [{"l":"Projetos Melhoria","v":"6.835","t":"+4.5%","d":"up"},{"l":"Savings (€)","v":"€44720","t":"+4.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"69.1%","t":"+10.6%","d":"up"},{"l":"Ciclos PDCA","v":"638","t":"+6.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.882","€ 13188.59","2.456","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.841","€ 32663.17","2.106","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.917","€ 36879.98","4.611","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.309","€ 5850.47","387","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.158","€ 8076.35","609","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":336},{"label":"Fev","value":640},{"label":"Mar","value":627},{"label":"Abr","value":315},{"label":"Mai","value":491},{"label":"Jun","value":517},{"label":"Jul","value":488},{"label":"Ago","value":625},{"label":"Set","value":324},{"label":"Out","value":657},{"label":"Nov","value":692},{"label":"Dez","value":677}];
const MX = 692;
