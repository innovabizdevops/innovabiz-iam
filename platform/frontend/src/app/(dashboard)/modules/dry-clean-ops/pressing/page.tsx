...
const ACCENT = "#0e7490";
const MODULE = "Dry Cleaning Ops";
const PAGE = "Pressing";
const KPIS = [{"l":"Projetos Melhoria","v":"7.357","t":"+14.7%","d":"up"},{"l":"Savings (€)","v":"€90559","t":"+11.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"75.4%","t":"+9.9%","d":"up"},{"l":"Ciclos PDCA","v":"1.352","t":"+10.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.237","€ 17879.82","7.245","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.220","€ 22928.19","4.194","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.841","€ 46578.49","6.559","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.983","€ 27184.52","4.731","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.063","€ 40731.73","5.442","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":388},{"label":"Mar","value":402},{"label":"Abr","value":692},{"label":"Mai","value":717},{"label":"Jun","value":720},{"label":"Jul","value":636},{"label":"Ago","value":508},{"label":"Set","value":715},{"label":"Out","value":509},{"label":"Nov","value":453},{"label":"Dez","value":530}];
const MX = 720;
