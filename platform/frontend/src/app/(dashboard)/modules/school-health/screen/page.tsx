...
const PAGE = "Screen";
const KPIS = [{"l":"Total School Health","v":"9.007","t":"+12.5%","d":"up"},{"l":"Screen Ativos","v":"2.734","t":"-5.9%","d":"down"},{"l":"Eficiência (%)","v":"68.4%","t":"+12.0%","d":"up"},{"l":"Score Performance","v":"84","t":"+15.2%","d":"up"}];
const COLS = ["ID","Screen","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["School Health #001","School Health #002","6.153","3.206","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["School Health #002","School Health #003","930","1.638","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["School Health #003","School Health #004","6.585","192","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["School Health #004","School Health #005","4.064","2.591","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["School Health #005","School Health #001","7.628","1.010","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":665},{"label":"Mar","value":677},{"label":"Abr","value":613},{"label":"Mai","value":453},{"label":"Jun","value":613},{"label":"Jul","value":620},{"label":"Ago","value":444},{"label":"Set","value":555},{"label":"Out","value":782},{"label":"Nov","value":736},{"label":"Dez","value":723}];
const MX = 782;
