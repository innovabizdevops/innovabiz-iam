...
const KPIS = [{"l":"Integrações Ativas","v":"1.603","t":"+5.6%","d":"up"},{"l":"Chamadas/Hora","v":"3214","t":"+0.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"83.6%","t":"-5.5%","d":"down"},{"l":"Latência Média (ms)","v":"105ms","t":"+0.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.767","8.008","93.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.339","5.847","80.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","216","6.701","95.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.074","4.110","95.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","148","1.554","91.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":281},{"label":"Fev","value":337},{"label":"Mar","value":431},{"label":"Abr","value":309},{"label":"Mai","value":610},{"label":"Jun","value":594},{"label":"Jul","value":498},{"label":"Ago","value":253},{"label":"Set","value":564},{"label":"Out","value":469},{"label":"Nov","value":433},{"label":"Dez","value":490}];
const MX = 610;
