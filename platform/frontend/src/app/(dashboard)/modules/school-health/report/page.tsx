...
const PAGE = "Report";
const KPIS = [{"l":"Total School Health","v":"7.534","t":"+6.9%","d":"up"},{"l":"Report Ativos","v":"1.888","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"89.2%","t":"+4.7%","d":"up"},{"l":"Score Performance","v":"64","t":"-3.8%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["School Health #001","School Health #002","294","5.572","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["School Health #002","School Health #003","2.565","2.113","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["School Health #003","School Health #004","5.115","2.334","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["School Health #004","School Health #005","4.960","3.543","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["School Health #005","School Health #001","2.059","341","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":906},{"label":"Mar","value":719},{"label":"Abr","value":686},{"label":"Mai","value":896},{"label":"Jun","value":595},{"label":"Jul","value":813},{"label":"Ago","value":653},{"label":"Set","value":903},{"label":"Out","value":652},{"label":"Nov","value":740},{"label":"Dez","value":739}];
const MX = 906;
