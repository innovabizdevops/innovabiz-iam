...
const PAGE = "SDS";
const KPIS = [{"l":"Total Chemical Regulatory","v":"8.013","t":"+17.7%","d":"up"},{"l":"SDS Ativos","v":"8.214","t":"+7.7%","d":"up"},{"l":"Eficiência (%)","v":"70.5%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"58","t":"-0.9%","d":"down"}];
const COLS = ["ID","SDS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemical Regulatory #001","Chemical Regulatory #002","8.208","4.819","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Chemical Regulatory #002","Chemical Regulatory #003","8.723","4.417","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemical Regulatory #003","Chemical Regulatory #004","6.861","4.467","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Chemical Regulatory #004","Chemical Regulatory #005","8.035","8.294","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemical Regulatory #005","Chemical Regulatory #001","3.761","8.150","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":458},{"label":"Fev","value":415},{"label":"Mar","value":410},{"label":"Abr","value":486},{"label":"Mai","value":354},{"label":"Jun","value":513},{"label":"Jul","value":348},{"label":"Ago","value":345},{"label":"Set","value":549},{"label":"Out","value":345},{"label":"Nov","value":484},{"label":"Dez","value":621}];
const MX = 621;
