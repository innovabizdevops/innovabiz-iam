...
export default function ChemicalRegulatoryPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Chemical Regulatory</h1><p className="text-sm text-muted-foreground">Chemical Regulatory • iBOS Enterprise</p></div>
