...
const PAGE = "Labor Cost Analytics";
const KPIS = [{"l":"eNPS","v":"90","t":"+15.8%","d":"up"},{"l":"Engagement (%)","v":"89.7%","t":"+10.7%","d":"up"},{"l":"Turnover (%)","v":"66.7%","t":"+15.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.887","t":"+4.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.164","2026-03-26","86","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","165","2026-01-26","75","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.949","2026-03-23","79","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.780","2026-02-08","94","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.710","2026-01-25","69","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":972},{"label":"Mar","value":738},{"label":"Abr","value":887},{"label":"Mai","value":731},{"label":"Jun","value":715},{"label":"Jul","value":902},{"label":"Ago","value":813},{"label":"Set","value":599},{"label":"Out","value":929},{"label":"Nov","value":742},{"label":"Dez","value":814}];
const MX = 972;
