...
const PAGE = "Demand Forecasting";
const KPIS = [{"l":"eNPS","v":"81","t":"-3.0%","d":"down"},{"l":"Engagement (%)","v":"77.3%","t":"+0.3%","d":"up"},{"l":"Turnover (%)","v":"90.9%","t":"+10.6%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.514","t":"-1.5%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.378","2026-02-13","60","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.653","2026-02-04","65","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.972","2026-01-21","80","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.378","2026-02-28","87","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.068","2026-01-27","91","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":669},{"label":"Mar","value":645},{"label":"Abr","value":525},{"label":"Mai","value":548},{"label":"Jun","value":592},{"label":"Jul","value":803},{"label":"Ago","value":680},{"label":"Set","value":460},{"label":"Out","value":563},{"label":"Nov","value":457},{"label":"Dez","value":486}];
const MX = 803;
