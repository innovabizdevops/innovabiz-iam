...
const PAGE = "Overtime Optimization";
const KPIS = [{"l":"eNPS","v":"58","t":"+15.4%","d":"up"},{"l":"Engagement (%)","v":"88.0%","t":"+12.1%","d":"up"},{"l":"Turnover (%)","v":"74.1%","t":"+6.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"582","t":"-3.4%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.369","2026-01-17","64","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.544","2026-03-18","87","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.111","2026-02-22","88","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.784","2026-02-25","86","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.903","2026-03-28","79","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":382},{"label":"Mar","value":650},{"label":"Abr","value":496},{"label":"Mai","value":611},{"label":"Jun","value":621},{"label":"Jul","value":611},{"label":"Ago","value":544},{"label":"Set","value":521},{"label":"Out","value":383},{"label":"Nov","value":613},{"label":"Dez","value":643}];
const MX = 650;
