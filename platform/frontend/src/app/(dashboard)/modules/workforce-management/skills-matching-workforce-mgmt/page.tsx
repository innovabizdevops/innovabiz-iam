...
const ACCENT = "#6366f1";
const MODULE = "Workforce Management";
const PAGE = "Skills Matching AI";
const KPIS = [{"l":"eNPS","v":"66","t":"+16.3%","d":"up"},{"l":"Engagement (%)","v":"92.0%","t":"+7.6%","d":"up"},{"l":"Turnover (%)","v":"94.1%","t":"+9.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.744","t":"+15.1%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","870","2026-01-27","73","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.386","2026-01-15","70","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.128","2026-02-20","81","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","970","2026-03-17","78","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.756","2026-03-03","80","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":587},{"label":"Mar","value":680},{"label":"Abr","value":689},{"label":"Mai","value":541},{"label":"Jun","value":477},{"label":"Jul","value":568},{"label":"Ago","value":596},{"label":"Set","value":675},{"label":"Out","value":576},{"label":"Nov","value":469},{"label":"Dez","value":608}];
const MX = 689;
...
export default function SkillsMatchingWorkforceMgmtPage() {
    return (
