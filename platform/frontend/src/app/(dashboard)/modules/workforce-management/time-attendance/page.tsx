...
const KPIS = [{"l":"eNPS","v":"94","t":"+3.8%","d":"up"},{"l":"Engagement (%)","v":"65.7%","t":"+17.6%","d":"up"},{"l":"Turnover (%)","v":"71.8%","t":"+8.5%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.248","t":"+1.4%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.308","2026-03-13","70","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.810","2026-01-27","72","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.915","2026-03-06","76","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.246","2026-03-17","59","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.417","2026-03-04","63","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":973},{"label":"Fev","value":821},{"label":"Mar","value":933},{"label":"Abr","value":617},{"label":"Mai","value":670},{"label":"Jun","value":945},{"label":"Jul","value":807},{"label":"Ago","value":605},{"label":"Set","value":641},{"label":"Out","value":729},{"label":"Nov","value":704},{"label":"Dez","value":586}];
const MX = 973;
