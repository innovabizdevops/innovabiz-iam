...
const PAGE = "Shift Scheduling";
const KPIS = [{"l":"eNPS","v":"66","t":"+8.6%","d":"up"},{"l":"Engagement (%)","v":"86.9%","t":"+6.5%","d":"up"},{"l":"Turnover (%)","v":"70.5%","t":"+5.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.636","t":"+17.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.928","2026-01-25","66","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.207","2026-03-18","63","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.364","2026-01-14","56","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.376","2026-01-22","61","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.047","2026-03-25","76","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":709},{"label":"Mar","value":750},{"label":"Abr","value":563},{"label":"Mai","value":822},{"label":"Jun","value":497},{"label":"Jul","value":496},{"label":"Ago","value":646},{"label":"Set","value":489},{"label":"Out","value":587},{"label":"Nov","value":780},{"label":"Dez","value":648}];
const MX = 864;
...
export default function SchedulingWorkforceMgmtPage() {
    return (
