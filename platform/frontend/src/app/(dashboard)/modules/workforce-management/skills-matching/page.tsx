...
const PAGE = "Skills Matching";
const KPIS = [{"l":"eNPS","v":"91","t":"+8.8%","d":"up"},{"l":"Engagement (%)","v":"69.5%","t":"-0.4%","d":"down"},{"l":"Turnover (%)","v":"68.7%","t":"+8.5%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.716","t":"+15.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.905","2026-03-03","92","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.237","2026-03-24","72","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.932","2026-02-17","66","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.872","2026-01-24","78","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.207","2026-01-08","86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1007},{"label":"Fev","value":953},{"label":"Mar","value":775},{"label":"Abr","value":864},{"label":"Mai","value":924},{"label":"Jun","value":822},{"label":"Jul","value":716},{"label":"Ago","value":943},{"label":"Set","value":905},{"label":"Out","value":787},{"label":"Nov","value":763},{"label":"Dez","value":692}];
const MX = 1007;
