...
const PAGE = "Productivity Analytics";
const KPIS = [{"l":"eNPS","v":"73","t":"+7.0%","d":"up"},{"l":"Engagement (%)","v":"87.8%","t":"-1.6%","d":"down"},{"l":"Turnover (%)","v":"71.8%","t":"+12.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.213","t":"+12.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.578","2026-03-16","76","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","509","2026-01-28","87","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.724","2026-01-15","71","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.642","2026-03-28","83","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.985","2026-01-09","77","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":330},{"label":"Mar","value":415},{"label":"Abr","value":428},{"label":"Mai","value":278},{"label":"Jun","value":212},{"label":"Jul","value":341},{"label":"Ago","value":278},{"label":"Set","value":228},{"label":"Out","value":309},{"label":"Nov","value":478},{"label":"Dez","value":326}];
const MX = 602;
...
export default function AnalyticsWorkforceMgmtPage() {
    return (
