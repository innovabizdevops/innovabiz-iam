...
const PAGE = "Fatigue Detection AI";
const KPIS = [{"l":"eNPS","v":"87","t":"+3.8%","d":"up"},{"l":"Engagement (%)","v":"66.2%","t":"+15.2%","d":"up"},{"l":"Turnover (%)","v":"75.9%","t":"+1.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.881","t":"+17.4%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.625","2026-03-24","84","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.391","2026-02-13","70","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","404","2026-03-17","59","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.538","2026-01-26","91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.994","2026-03-02","88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":252},{"label":"Fev","value":513},{"label":"Mar","value":434},{"label":"Abr","value":333},{"label":"Mai","value":317},{"label":"Jun","value":476},{"label":"Jul","value":280},{"label":"Ago","value":550},{"label":"Set","value":619},{"label":"Out","value":583},{"label":"Nov","value":621},{"label":"Dez","value":323}];
const MX = 621;
...
export default function FatigueDetectionPage() {
    return (
