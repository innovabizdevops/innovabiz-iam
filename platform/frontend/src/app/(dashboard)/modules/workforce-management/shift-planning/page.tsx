...
const PAGE = "Shift Planning AI";
const KPIS = [{"l":"eNPS","v":"83","t":"+12.1%","d":"up"},{"l":"Engagement (%)","v":"93.5%","t":"+17.6%","d":"up"},{"l":"Turnover (%)","v":"66.9%","t":"+9.4%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.452","t":"+13.9%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.087","2026-02-28","93","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.900","2026-01-13","79","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.847","2026-01-04","73","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.710","2026-03-10","56","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.360","2026-03-23","56","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":857},{"label":"Mar","value":842},{"label":"Abr","value":898},{"label":"Mai","value":606},{"label":"Jun","value":905},{"label":"Jul","value":732},{"label":"Ago","value":616},{"label":"Set","value":940},{"label":"Out","value":890},{"label":"Nov","value":998},{"label":"Dez","value":934}];
const MX = 998;
