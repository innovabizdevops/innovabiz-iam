...
const PAGE = "Geo-Fencing";
const KPIS = [{"l":"eNPS","v":"83","t":"+3.5%","d":"up"},{"l":"Engagement (%)","v":"79.6%","t":"+3.4%","d":"up"},{"l":"Turnover (%)","v":"79.8%","t":"+6.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.395","t":"+10.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.173","2026-02-18","74","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.449","2026-03-19","59","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.454","2026-02-21","78","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.944","2026-01-04","78","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.891","2026-03-06","86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":867},{"label":"Fev","value":778},{"label":"Mar","value":783},{"label":"Abr","value":866},{"label":"Mai","value":804},{"label":"Jun","value":811},{"label":"Jul","value":888},{"label":"Ago","value":841},{"label":"Set","value":649},{"label":"Out","value":961},{"label":"Nov","value":988},{"label":"Dez","value":694}];
const MX = 988;
