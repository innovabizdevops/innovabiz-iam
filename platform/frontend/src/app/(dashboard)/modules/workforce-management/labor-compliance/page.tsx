...
const PAGE = "Compliance &amp; Labor Law";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.730","t":"+0.1%","d":"up"},{"l":"NC Abertas","v":"5.129","t":"+9.0%","d":"up"},{"l":"Conformidade (%)","v":"71.1%","t":"-3.1%","d":"down"},{"l":"CAPAs Pendentes","v":"3.020","t":"-5.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.747","93.1%","4.246","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.480","77.1%","4.121","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.745","80.7%","2.439","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.048","81.9%","4.485","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.474","78.1%","7.588","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":582},{"label":"Mar","value":349},{"label":"Abr","value":356},{"label":"Mai","value":616},{"label":"Jun","value":614},{"label":"Jul","value":513},{"label":"Ago","value":302},{"label":"Set","value":281},{"label":"Out","value":619},{"label":"Nov","value":353},{"label":"Dez","value":599}];
const MX = 656;
