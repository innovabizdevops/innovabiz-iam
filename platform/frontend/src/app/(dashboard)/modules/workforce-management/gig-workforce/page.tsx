...
const PAGE = "Gig Workforce";
const KPIS = [{"l":"eNPS","v":"64","t":"+16.4%","d":"up"},{"l":"Engagement (%)","v":"71.2%","t":"+3.9%","d":"up"},{"l":"Turnover (%)","v":"88.2%","t":"-1.5%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"1.229","t":"+6.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.398","2026-02-23","55","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.288","2026-02-11","59","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.168","2026-01-13","60","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.655","2026-01-09","94","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.626","2026-01-25","77","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":708},{"label":"Mar","value":572},{"label":"Abr","value":722},{"label":"Mai","value":561},{"label":"Jun","value":613},{"label":"Jul","value":580},{"label":"Ago","value":400},{"label":"Set","value":628},{"label":"Out","value":436},{"label":"Nov","value":479},{"label":"Dez","value":471}];
const MX = 722;
...
export default function GigWorkforcePage() {
    return (
