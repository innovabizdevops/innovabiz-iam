...
const PAGE = "Workforce Analytics";
const KPIS = [{"l":"eNPS","v":"81","t":"+8.8%","d":"up"},{"l":"Engagement (%)","v":"93.9%","t":"+7.9%","d":"up"},{"l":"Turnover (%)","v":"76.1%","t":"+8.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.612","t":"+10.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.624","2026-02-17","65","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.990","2026-03-21","67","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.799","2026-02-15","74","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.833","2026-03-05","69","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.434","2026-02-28","68","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":430},{"label":"Mar","value":302},{"label":"Abr","value":290},{"label":"Mai","value":297},{"label":"Jun","value":683},{"label":"Jul","value":657},{"label":"Ago","value":467},{"label":"Set","value":359},{"label":"Out","value":554},{"label":"Nov","value":402},{"label":"Dez","value":601}];
const MX = 683;
