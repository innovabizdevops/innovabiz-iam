...
const PAGE = "Labor Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.211","t":"+10.0%","d":"up"},{"l":"NC Abertas","v":"6.599","t":"+9.4%","d":"up"},{"l":"Conformidade (%)","v":"69.3%","t":"+12.8%","d":"up"},{"l":"CAPAs Pendentes","v":"4.323","t":"-2.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.157","98.3%","1.733","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.014","89.6%","8.913","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.853","77.3%","3.757","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","876","87.5%","6.417","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","470","90.0%","7.467","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":390},{"label":"Fev","value":744},{"label":"Mar","value":435},{"label":"Abr","value":468},{"label":"Mai","value":638},{"label":"Jun","value":753},{"label":"Jul","value":637},{"label":"Ago","value":599},{"label":"Set","value":396},{"label":"Out","value":601},{"label":"Nov","value":475},{"label":"Dez","value":654}];
const MX = 753;
...
export default function LaborComplianceWorkforceMgmtPage() {
    return (
