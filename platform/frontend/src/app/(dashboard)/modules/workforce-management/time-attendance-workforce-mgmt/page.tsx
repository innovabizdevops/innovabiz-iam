...
const KPIS = [{"l":"eNPS","v":"56","t":"+4.6%","d":"up"},{"l":"Engagement (%)","v":"86.7%","t":"+12.5%","d":"up"},{"l":"Turnover (%)","v":"69.3%","t":"+5.8%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.975","t":"+0.5%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.475","2026-02-16","87","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.003","2026-01-27","71","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.566","2026-03-20","89","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.284","2026-02-26","59","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.089","2026-03-04","66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":639},{"label":"Mar","value":542},{"label":"Abr","value":534},{"label":"Mai","value":488},{"label":"Jun","value":465},{"label":"Jul","value":487},{"label":"Ago","value":567},{"label":"Set","value":726},{"label":"Out","value":537},{"label":"Nov","value":647},{"label":"Dez","value":585}];
const MX = 747;
...
export default function TimeAttendanceWorkforceMgmtPage() {
    return (
