...
const PAGE = "Scheduling &amp; Planning";
const KPIS = [{"l":"eNPS","v":"76","t":"+4.2%","d":"up"},{"l":"Engagement (%)","v":"78.4%","t":"+13.9%","d":"up"},{"l":"Turnover (%)","v":"68.4%","t":"-1.4%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"1.715","t":"+3.4%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.026","2026-03-21","73","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.881","2026-02-28","71","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.931","2026-01-07","84","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.346","2026-03-14","89","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.674","2026-03-15","95","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":695},{"label":"Mar","value":713},{"label":"Abr","value":721},{"label":"Mai","value":877},{"label":"Jun","value":801},{"label":"Jul","value":873},{"label":"Ago","value":947},{"label":"Set","value":768},{"label":"Out","value":855},{"label":"Nov","value":966},{"label":"Dez","value":699}];
const MX = 966;
