...
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"6.820","t":"+13.9%","d":"up"},{"l":"Queries/Dia","v":"5003","t":"-4.3%","d":"down"},{"l":"Dados Processados (GB)","v":"8.605","t":"+11.7%","d":"up"},{"l":"Utilizadores Analytics","v":"1.309","t":"+16.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4910","2026-03-02","2.142","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1780","2026-01-26","2.815","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2297","2026-01-25","8.848","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1552","2026-01-27","664","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4168","2026-03-27","2.457","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1020},{"label":"Fev","value":842},{"label":"Mar","value":639},{"label":"Abr","value":962},{"label":"Mai","value":693},{"label":"Jun","value":906},{"label":"Jul","value":987},{"label":"Ago","value":677},{"label":"Set","value":698},{"label":"Out","value":945},{"label":"Nov","value":785},{"label":"Dez","value":639}];
const MX = 1020;
