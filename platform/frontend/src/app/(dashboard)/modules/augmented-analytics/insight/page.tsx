...
const ACCENT = "#4338ca";
const MODULE = "Augmented Analytics (Gartner)";
const PAGE = "Auto Insight";
const KPIS = [{"l":"Dashboards Ativos","v":"6.935","t":"+17.1%","d":"up"},{"l":"Queries/Dia","v":"755","t":"+15.3%","d":"up"},{"l":"Dados Processados (GB)","v":"8.897","t":"+1.8%","d":"up"},{"l":"Utilizadores Analytics","v":"517","t":"-1.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3130","2026-01-06","1.134","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","700","2026-01-03","3.375","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","501","2026-01-09","2.318","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","635","2026-02-17","2.072","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1854","2026-02-27","8.313","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":834},{"label":"Mar","value":901},{"label":"Abr","value":952},{"label":"Mai","value":1032},{"label":"Jun","value":971},{"label":"Jul","value":727},{"label":"Ago","value":711},{"label":"Set","value":844},{"label":"Out","value":1041},{"label":"Nov","value":1045},{"label":"Dez","value":770}];
const MX = 1045;
