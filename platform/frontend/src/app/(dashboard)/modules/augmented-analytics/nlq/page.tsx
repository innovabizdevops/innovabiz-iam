...
const PAGE = "NLQ";
const KPIS = [{"l":"Dashboards Ativos","v":"6.783","t":"-3.2%","d":"down"},{"l":"Queries/Dia","v":"592","t":"-2.9%","d":"down"},{"l":"Dados Processados (GB)","v":"6.681","t":"-2.0%","d":"down"},{"l":"Utilizadores Analytics","v":"7.464","t":"+12.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3300","2026-03-27","2.789","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3344","2026-02-07","7.400","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2310","2026-02-03","5.310","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2418","2026-01-14","2.276","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4704","2026-02-15","1.316","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":794},{"label":"Fev","value":859},{"label":"Mar","value":728},{"label":"Abr","value":844},{"label":"Mai","value":867},{"label":"Jun","value":943},{"label":"Jul","value":772},{"label":"Ago","value":755},{"label":"Set","value":872},{"label":"Out","value":995},{"label":"Nov","value":789},{"label":"Dez","value":946}];
const MX = 995;
