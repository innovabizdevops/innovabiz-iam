...
const PAGE = "Explain";
const KPIS = [{"l":"Dashboards Ativos","v":"227","t":"-0.5%","d":"down"},{"l":"Queries/Dia","v":"1828","t":"+17.6%","d":"up"},{"l":"Dados Processados (GB)","v":"2.625","t":"-0.9%","d":"down"},{"l":"Utilizadores Analytics","v":"4.486","t":"-5.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1793","2026-01-12","861","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","598","2026-02-03","8.810","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4353","2026-02-24","6.067","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1141","2026-03-08","3.385","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2318","2026-02-25","5.598","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":856},{"label":"Fev","value":738},{"label":"Mar","value":549},{"label":"Abr","value":538},{"label":"Mai","value":630},{"label":"Jun","value":587},{"label":"Jul","value":712},{"label":"Ago","value":769},{"label":"Set","value":884},{"label":"Out","value":551},{"label":"Nov","value":637},{"label":"Dez","value":842}];
const MX = 884;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>XAI</span></h1>
                </div>
