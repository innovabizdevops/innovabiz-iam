...
const PAGE = "Auto Viz";
const KPIS = [{"l":"Dashboards Ativos","v":"3.733","t":"-3.8%","d":"down"},{"l":"Queries/Dia","v":"395","t":"+2.3%","d":"up"},{"l":"Dados Processados (GB)","v":"3.641","t":"+5.5%","d":"up"},{"l":"Utilizadores Analytics","v":"5.336","t":"+11.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2827","2026-02-01","8.501","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2385","2026-03-26","3.539","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3484","2026-01-18","2.973","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2725","2026-03-01","4.440","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","479","2026-03-15","7.211","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":435},{"label":"Mar","value":360},{"label":"Abr","value":710},{"label":"Mai","value":669},{"label":"Jun","value":443},{"label":"Jul","value":675},{"label":"Ago","value":493},{"label":"Set","value":426},{"label":"Out","value":671},{"label":"Nov","value":720},{"label":"Dez","value":613}];
const MX = 720;
