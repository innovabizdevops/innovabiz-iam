...
/* ═══ Augmented Analytics (Gartner) — Dashboard ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total Registos", value: "3312", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1190", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€377K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "495508112", cells: ["AUG-5112", "Augmented Analytics (Gartner) Item 1", "9/9/2026", "€8212"], status: "active" as const },
    { id: "495511683", cells: ["AUG-8683", "Augmented Analytics (Gartner) Item 2", "24/4/2026", "€11 783"], status: "pending" as const },
    { id: "495515254", cells: ["AUG-3254", "Augmented Analytics (Gartner) Item 3", "11/11/2026", "€15 354"], status: "completed" as const },
    { id: "495518825", cells: ["AUG-6825", "Augmented Analytics (Gartner) Item 4", "26/6/2026", "€18 925"], status: "warning" as const },
    { id: "495522396", cells: ["AUG-1396", "Augmented Analytics (Gartner) Item 5", "13/1/2026", "€22 496"], status: "active" as const },
];
...
export default function AugmentedAnalyticsGartnerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Augmented Analytics (Gartner)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Augmented Analytics (Gartner)</p>
                    </div>
                </div>
