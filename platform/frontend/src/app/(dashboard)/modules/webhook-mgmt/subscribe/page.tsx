...
const KPIS = [{"l":"Integrações Ativas","v":"4.742","t":"+4.1%","d":"up"},{"l":"Chamadas/Hora","v":"299","t":"+4.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"79.0%","t":"+7.7%","d":"up"},{"l":"Latência Média (ms)","v":"128ms","t":"+7.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","502","6.592","86.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.817","3.061","85.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.414","5.611","76.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.590","4.590","95.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.162","8.067","85.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":975},{"label":"Fev","value":974},{"label":"Mar","value":712},{"label":"Abr","value":708},{"label":"Mai","value":681},{"label":"Jun","value":782},{"label":"Jul","value":949},{"label":"Ago","value":758},{"label":"Set","value":974},{"label":"Out","value":798},{"label":"Nov","value":703},{"label":"Dez","value":917}];
const MX = 975;
