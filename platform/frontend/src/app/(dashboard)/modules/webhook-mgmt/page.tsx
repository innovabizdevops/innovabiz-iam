...
const KPIS = [
    ...
    { label: "Ativos", value: "4764", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€193K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "-13%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "208725630", cells: ["WEB-7630", "Webhook Management Item 1", "23/7/2026", "€25 730"], status: "active" as const },
    { id: "208729201", cells: ["WEB-2201", "Webhook Management Item 2", "10/2/2026", "€29 301"], status: "pending" as const },
    { id: "208732772", cells: ["WEB-5772", "Webhook Management Item 3", "25/9/2026", "€32 872"], status: "completed" as const },
    { id: "208736343", cells: ["WEB-9343", "Webhook Management Item 4", "12/4/2026", "€36 443"], status: "warning" as const },
    { id: "208739914", cells: ["WEB-3914", "Webhook Management Item 5", "27/11/2026", "€40 014"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Webhook Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Webhook Management</p>
                    </div>
                </div>
