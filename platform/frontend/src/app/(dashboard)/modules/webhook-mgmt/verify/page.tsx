...
const PAGE = "Verify";
const KPIS = [{"l":"Integrações Ativas","v":"5.384","t":"+0.9%","d":"up"},{"l":"Chamadas/Hora","v":"3734","t":"+13.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.3%","t":"+5.0%","d":"up"},{"l":"Latência Média (ms)","v":"7ms","t":"+1.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.384","2.641","99.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.078","3.953","70.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","629","8.409","78.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.675","3.209","96.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.475","897","87.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":730},{"label":"Mar","value":968},{"label":"Abr","value":731},{"label":"Mai","value":934},{"label":"Jun","value":651},{"label":"Jul","value":909},{"label":"Ago","value":740},{"label":"Set","value":610},{"label":"Out","value":712},{"label":"Nov","value":592},{"label":"Dez","value":708}];
const MX = 968;
