...
const ACCENT = "#06b6d4";
const MODULE = "Webhook Management";
const PAGE = "Deliver";
const KPIS = [{"l":"Integrações Ativas","v":"5.249","t":"+16.0%","d":"up"},{"l":"Chamadas/Hora","v":"1122","t":"+4.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.4%","t":"+5.7%","d":"up"},{"l":"Latência Média (ms)","v":"33ms","t":"+12.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.052","3.261","83.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.102","8.284","72.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.925","5.667","98.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","757","4.396","96.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","245","7.110","89.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":844},{"label":"Fev","value":944},{"label":"Mar","value":798},{"label":"Abr","value":1034},{"label":"Mai","value":1003},{"label":"Jun","value":722},{"label":"Jul","value":723},{"label":"Ago","value":972},{"label":"Set","value":891},{"label":"Out","value":832},{"label":"Nov","value":700},{"label":"Dez","value":1037}];
const MX = 1037;
