...
const PAGE = "Retry";
const KPIS = [{"l":"Integrações Ativas","v":"6.754","t":"+7.3%","d":"up"},{"l":"Chamadas/Hora","v":"4291","t":"+2.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"73.4%","t":"+3.7%","d":"up"},{"l":"Latência Média (ms)","v":"56ms","t":"+2.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.957","3.984","91.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.634","3.856","91.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.539","5.784","88.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.641","3.791","93.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.592","8.946","70.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":909},{"label":"Fev","value":989},{"label":"Mar","value":680},{"label":"Abr","value":621},{"label":"Mai","value":628},{"label":"Jun","value":665},{"label":"Jul","value":719},{"label":"Ago","value":665},{"label":"Set","value":702},{"label":"Out","value":764},{"label":"Nov","value":760},{"label":"Dez","value":853}];
const MX = 989;
