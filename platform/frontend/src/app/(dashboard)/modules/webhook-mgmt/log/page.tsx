...
const PAGE = "Log";
const KPIS = [{"l":"Integrações Ativas","v":"7.472","t":"+5.3%","d":"up"},{"l":"Chamadas/Hora","v":"4083","t":"-2.8%","d":"down"},{"l":"Taxa Sucesso (%)","v":"66.5%","t":"-1.6%","d":"down"},{"l":"Latência Média (ms)","v":"10ms","t":"+6.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.495","3.146","73.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.405","5.634","85.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.921","6.701","87.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","862","4.024","73.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.136","2.805","94.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":277},{"label":"Mar","value":366},{"label":"Abr","value":568},{"label":"Mai","value":470},{"label":"Jun","value":237},{"label":"Jul","value":455},{"label":"Ago","value":570},{"label":"Set","value":534},{"label":"Out","value":340},{"label":"Nov","value":464},{"label":"Dez","value":403}];
const MX = 570;
