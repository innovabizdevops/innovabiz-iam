...
const PAGE = "Flag Manager";
const KPIS = [{"l":"Total Feature Flags","v":"2.214","t":"+7.9%","d":"up"},{"l":"Flag Manager Ativos","v":"8.879","t":"-0.2%","d":"down"},{"l":"Eficiência (%)","v":"93.5%","t":"+3.3%","d":"up"},{"l":"Score Performance","v":"66","t":"-1.8%","d":"down"}];
const COLS = ["ID","Flag Manager","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Feature Flags #001","Feature Flags #002","7.019","445","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Feature Flags #002","Feature Flags #003","3.618","1.097","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Feature Flags #003","Feature Flags #004","2.547","545","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Feature Flags #004","Feature Flags #005","7.481","6.927","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flags #005","Feature Flags #001","2.338","6.735","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":726},{"label":"Mar","value":484},{"label":"Abr","value":724},{"label":"Mai","value":605},{"label":"Jun","value":734},{"label":"Jul","value":584},{"label":"Ago","value":684},{"label":"Set","value":569},{"label":"Out","value":653},{"label":"Nov","value":576},{"label":"Dez","value":459}];
const MX = 734;
