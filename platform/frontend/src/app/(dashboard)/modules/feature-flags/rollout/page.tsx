...
const PAGE = "Rollout %";
const KPIS = [{"l":"Total Feature Flags","v":"6.203","t":"-3.7%","d":"down"},{"l":"Rollout % Ativos","v":"89.6%","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"79.1%","t":"+-0.0%","d":"up"},{"l":"Score Performance","v":"68","t":"+3.7%","d":"up"}];
const COLS = ["ID","Rollout %","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Feature Flags #001","86.7%","6.991","7.394","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Feature Flags #002","95.3%","8.142","1.726","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Feature Flags #003","72.6%","5.851","793","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Feature Flags #004","89.3%","3.729","8.000","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flags #005","87.1%","6.390","7.986","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":843},{"label":"Mar","value":868},{"label":"Abr","value":496},{"label":"Mai","value":695},{"label":"Jun","value":671},{"label":"Jul","value":870},{"label":"Ago","value":765},{"label":"Set","value":861},{"label":"Out","value":724},{"label":"Nov","value":549},{"label":"Dez","value":633}];
const MX = 870;
