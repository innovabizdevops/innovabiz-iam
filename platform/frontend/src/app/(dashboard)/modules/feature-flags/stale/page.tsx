...
const PAGE = "Stale Flag Cleanup";
const KPIS = [{"l":"Projetos Melhoria","v":"7.789","t":"+9.1%","d":"up"},{"l":"Savings (€)","v":"€99592","t":"+13.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"74.2%","t":"+0.3%","d":"up"},{"l":"Ciclos PDCA","v":"5.458","t":"+6.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.089","€ 17302.78","7.807","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.388","€ 16675.14","2.430","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.674","€ 8905.93","2.788","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.252","€ 25555.83","6.931","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.142","€ 43590.74","7.985","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":457},{"label":"Fev","value":618},{"label":"Mar","value":520},{"label":"Abr","value":511},{"label":"Mai","value":472},{"label":"Jun","value":432},{"label":"Jul","value":389},{"label":"Ago","value":420},{"label":"Set","value":727},{"label":"Out","value":489},{"label":"Nov","value":360},{"label":"Dez","value":678}];
const MX = 727;
