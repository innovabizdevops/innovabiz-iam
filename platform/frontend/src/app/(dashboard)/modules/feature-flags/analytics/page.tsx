...
const PAGE = "Flag Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"3.912","t":"+1.6%","d":"up"},{"l":"Queries/Dia","v":"475","t":"-4.0%","d":"down"},{"l":"Dados Processados (GB)","v":"6.889","t":"+4.6%","d":"up"},{"l":"Utilizadores Analytics","v":"3.702","t":"-1.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4824","2026-01-19","8.053","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2393","2026-01-12","8.307","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","358","2026-02-15","5.110","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1327","2026-02-25","8.087","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4301","2026-02-15","5.877","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":436},{"label":"Fev","value":505},{"label":"Mar","value":522},{"label":"Abr","value":293},{"label":"Mai","value":446},{"label":"Jun","value":289},{"label":"Jul","value":452},{"label":"Ago","value":518},{"label":"Set","value":389},{"label":"Out","value":277},{"label":"Nov","value":339},{"label":"Dez","value":570}];
const MX = 570;
