...
const PAGE = "Test";
const KPIS = [{"l":"Total Surface Treatment","v":"7.445","t":"+2.5%","d":"up"},{"l":"Test Ativos","v":"6.634","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"+17.5%","d":"up"},{"l":"Score Performance","v":"60","t":"+2.8%","d":"up"}];
const COLS = ["ID","Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Surface Treatment #001","Surface Treatment #002","581","5.838","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Surface Treatment #002","Surface Treatment #003","8.996","2.495","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Surface Treatment #003","Surface Treatment #004","8.733","6.763","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Surface Treatment #004","Surface Treatment #005","6.399","7.827","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Surface Treatment #005","Surface Treatment #001","5.522","8.561","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":774},{"label":"Fev","value":924},{"label":"Mar","value":883},{"label":"Abr","value":1031},{"label":"Mai","value":780},{"label":"Jun","value":715},{"label":"Jul","value":735},{"label":"Ago","value":1082},{"label":"Set","value":825},{"label":"Out","value":897},{"label":"Nov","value":991},{"label":"Dez","value":719}];
const MX = 1082;
