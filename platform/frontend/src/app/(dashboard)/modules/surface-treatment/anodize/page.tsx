...
const ACCENT = "#6366f1";
const MODULE = "Surface Treatment";
const PAGE = "Anodize";
const KPIS = [{"l":"Total Surface Treatment","v":"8.715","t":"+11.5%","d":"up"},{"l":"Anodize Ativos","v":"7.527","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"74.2%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"77","t":"+16.7%","d":"up"}];
const COLS = ["ID","Anodize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Surface Treatment #001","Surface Treatment #002","5.416","2.576","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Surface Treatment #002","Surface Treatment #003","9.020","2.844","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Surface Treatment #003","Surface Treatment #004","7.862","6.899","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Surface Treatment #004","Surface Treatment #005","7.203","6.408","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Surface Treatment #005","Surface Treatment #001","5.128","1.904","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":663},{"label":"Mar","value":687},{"label":"Abr","value":717},{"label":"Mai","value":728},{"label":"Jun","value":575},{"label":"Jul","value":457},{"label":"Ago","value":473},{"label":"Set","value":677},{"label":"Out","value":468},{"label":"Nov","value":451},{"label":"Dez","value":740}];
const MX = 740;
...
export default function AnodizePage() {
    return (
