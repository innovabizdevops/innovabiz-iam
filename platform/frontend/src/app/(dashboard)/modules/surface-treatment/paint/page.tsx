...
const PAGE = "Paint";
const KPIS = [{"l":"Total Surface Treatment","v":"953","t":"+1.5%","d":"up"},{"l":"Paint Ativos","v":"1.991","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"90.9%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"93","t":"+7.2%","d":"up"}];
const COLS = ["ID","Paint","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Surface Treatment #001","Surface Treatment #002","9.009","2.010","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Surface Treatment #002","Surface Treatment #003","2.099","6.432","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Surface Treatment #003","Surface Treatment #004","6.724","5.795","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Surface Treatment #004","Surface Treatment #005","7.528","2.654","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Surface Treatment #005","Surface Treatment #001","8.931","2.488","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":929},{"label":"Mar","value":783},{"label":"Abr","value":877},{"label":"Mai","value":589},{"label":"Jun","value":789},{"label":"Jul","value":747},{"label":"Ago","value":720},{"label":"Set","value":746},{"label":"Out","value":960},{"label":"Nov","value":594},{"label":"Dez","value":899}];
const MX = 960;
