...
const PAGE = "Blast";
const KPIS = [{"l":"Total Surface Treatment","v":"3.299","t":"+12.2%","d":"up"},{"l":"Blast Ativos","v":"165","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"70.5%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"86","t":"-1.2%","d":"down"}];
const COLS = ["ID","Blast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Surface Treatment #001","Surface Treatment #002","3.335","3.075","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Surface Treatment #002","Surface Treatment #003","3.929","3.815","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Surface Treatment #003","Surface Treatment #004","702","3.964","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Surface Treatment #004","Surface Treatment #005","4.316","5.496","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Surface Treatment #005","Surface Treatment #001","7.992","1.336","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":728},{"label":"Mar","value":628},{"label":"Abr","value":658},{"label":"Mai","value":886},{"label":"Jun","value":745},{"label":"Jul","value":894},{"label":"Ago","value":647},{"label":"Set","value":573},{"label":"Out","value":582},{"label":"Nov","value":793},{"label":"Dez","value":705}];
const MX = 894;
