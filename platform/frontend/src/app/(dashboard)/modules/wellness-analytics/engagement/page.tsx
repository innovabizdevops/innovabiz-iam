...
const KPIS = [{"l":"eNPS","v":"65","t":"+8.6%","d":"up"},{"l":"Engagement (%)","v":"67.9%","t":"-4.6%","d":"down"},{"l":"Turnover (%)","v":"67.6%","t":"+2.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.595","t":"+17.1%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","996","2026-02-01","93","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.207","2026-03-27","75","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.923","2026-01-17","68","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.511","2026-02-22","88","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.437","2026-01-26","71","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":628},{"label":"Mar","value":848},{"label":"Abr","value":954},{"label":"Mai","value":770},{"label":"Jun","value":881},{"label":"Jul","value":839},{"label":"Ago","value":672},{"label":"Set","value":743},{"label":"Out","value":888},{"label":"Nov","value":855},{"label":"Dez","value":639}];
const MX = 954;
