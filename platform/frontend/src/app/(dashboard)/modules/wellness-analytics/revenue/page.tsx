...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€34.9M","t":"+12.2%","d":"up"},{"l":"MRR (€)","v":"€18332","t":"+10.0%","d":"up"},{"l":"Churn (%)","v":"74.3%","t":"+13.9%","d":"up"},{"l":"ARPU (€)","v":"€89248","t":"+16.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 26115.56","5.461","€ 43626.64","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 10155.53","8.503","€ 4774.86","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 44904.49","6.455","€ 9644.96","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 6305.94","6.960","€ 42466.91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 1764.17","9.077","€ 31632.78","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":355},{"label":"Fev","value":541},{"label":"Mar","value":596},{"label":"Abr","value":407},{"label":"Mai","value":340},{"label":"Jun","value":282},{"label":"Jul","value":501},{"label":"Ago","value":280},{"label":"Set","value":283},{"label":"Out","value":341},{"label":"Nov","value":374},{"label":"Dez","value":300}];
const MX = 596;
