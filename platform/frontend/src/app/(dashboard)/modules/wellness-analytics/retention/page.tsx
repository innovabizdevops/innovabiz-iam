...
const KPIS = [{"l":"Dashboards Ativos","v":"8.307","t":"+6.1%","d":"up"},{"l":"Queries/Dia","v":"4822","t":"+5.8%","d":"up"},{"l":"Dados Processados (GB)","v":"7.975","t":"+8.5%","d":"up"},{"l":"Utilizadores Analytics","v":"5.220","t":"+7.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1811","2026-03-23","3.094","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2831","2026-03-18","8.616","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1284","2026-01-24","4.569","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1776","2026-03-18","5.554","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4146","2026-02-21","8.793","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":780},{"label":"Fev","value":1019},{"label":"Mar","value":838},{"label":"Abr","value":896},{"label":"Mai","value":1032},{"label":"Jun","value":945},{"label":"Jul","value":1003},{"label":"Ago","value":851},{"label":"Set","value":722},{"label":"Out","value":870},{"label":"Nov","value":844},{"label":"Dez","value":834}];
const MX = 1032;
