...
const ACCENT = "#6366f1";
const MODULE = "Wellness Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"2.244","t":"+7.2%","d":"up"},{"l":"Queries/Dia","v":"1361","t":"+2.7%","d":"up"},{"l":"Dados Processados (GB)","v":"8.188","t":"+7.0%","d":"up"},{"l":"Utilizadores Analytics","v":"1.060","t":"+13.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3279","2026-02-24","3.306","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3671","2026-01-09","2.514","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1871","2026-02-05","2.064","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2288","2026-01-14","4.329","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3972","2026-02-19","8.466","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":289},{"label":"Mar","value":627},{"label":"Abr","value":548},{"label":"Mai","value":359},{"label":"Jun","value":342},{"label":"Jul","value":522},{"label":"Ago","value":664},{"label":"Set","value":383},{"label":"Out","value":515},{"label":"Nov","value":593},{"label":"Dez","value":469}];
const MX = 664;
