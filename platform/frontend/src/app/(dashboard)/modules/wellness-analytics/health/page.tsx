...
const PAGE = "Health";
const KPIS = [{"l":"Dashboards Ativos","v":"3.852","t":"-2.4%","d":"down"},{"l":"Queries/Dia","v":"1636","t":"+3.0%","d":"up"},{"l":"Dados Processados (GB)","v":"8.623","t":"+-0.0%","d":"up"},{"l":"Utilizadores Analytics","v":"2.804","t":"+15.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1843","2026-01-19","2.600","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3504","2026-03-08","4.087","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","736","2026-03-10","5.140","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","780","2026-03-16","8.432","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1724","2026-02-14","8.488","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":1064},{"label":"Mar","value":776},{"label":"Abr","value":1012},{"label":"Mai","value":936},{"label":"Jun","value":730},{"label":"Jul","value":721},{"label":"Ago","value":1048},{"label":"Set","value":942},{"label":"Out","value":1066},{"label":"Nov","value":987},{"label":"Dez","value":753}];
const MX = 1066;
