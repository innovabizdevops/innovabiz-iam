...
const PAGE = "Hazmat Handling";
const KPIS = [{"l":"Total Chemicals","v":"7.042","t":"+16.9%","d":"up"},{"l":"Hazmat Handling Ativos","v":"5.135","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"70.9%","t":"+6.7%","d":"up"},{"l":"Score Performance","v":"89","t":"-4.0%","d":"down"}];
const COLS = ["ID","Hazmat Handling","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemicals #001","Chemicals #002","413","3.897","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Chemicals #002","Chemicals #003","2.893","134","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemicals #003","Chemicals #004","8.637","1.950","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Chemicals #004","Chemicals #005","1.626","4.441","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemicals #005","Chemicals #001","2.030","7.210","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":306},{"label":"Mar","value":509},{"label":"Abr","value":637},{"label":"Mai","value":553},{"label":"Jun","value":566},{"label":"Jul","value":460},{"label":"Ago","value":474},{"label":"Set","value":616},{"label":"Out","value":421},{"label":"Nov","value":650},{"label":"Dez","value":360}];
const MX = 650;
