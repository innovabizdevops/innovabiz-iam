...
const PAGE = "Lab Integration";
const KPIS = [{"l":"Integrações Ativas","v":"5.854","t":"+16.8%","d":"up"},{"l":"Chamadas/Hora","v":"4874","t":"-3.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"74.1%","t":"+8.9%","d":"up"},{"l":"Latência Média (ms)","v":"108ms","t":"-1.4%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.574","442","89.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.589","1.537","72.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.235","1.368","94.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.357","1.286","98.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.548","8.205","75.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":504},{"label":"Fev","value":565},{"label":"Mar","value":780},{"label":"Abr","value":695},{"label":"Mai","value":508},{"label":"Jun","value":623},{"label":"Jul","value":713},{"label":"Ago","value":400},{"label":"Set","value":689},{"label":"Out","value":387},{"label":"Nov","value":509},{"label":"Dez","value":436}];
const MX = 780;
