...
const PAGE = "Batch Tracking";
const KPIS = [{"l":"Total Chemicals","v":"7.706","t":"+0.8%","d":"up"},{"l":"Batch Tracking Ativos","v":"9.043","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"94.5%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"77","t":"+7.3%","d":"up"}];
const COLS = ["ID","Batch Tracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemicals #001","Chemicals #002","1.238","969","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Chemicals #002","Chemicals #003","515","1.645","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemicals #003","Chemicals #004","2.893","7.185","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Chemicals #004","Chemicals #005","4.938","5.187","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemicals #005","Chemicals #001","8.773","6.491","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":809},{"label":"Mar","value":611},{"label":"Abr","value":526},{"label":"Mai","value":838},{"label":"Jun","value":877},{"label":"Jul","value":885},{"label":"Ago","value":676},{"label":"Set","value":533},{"label":"Out","value":729},{"label":"Nov","value":566},{"label":"Dez","value":745}];
const MX = 885;
