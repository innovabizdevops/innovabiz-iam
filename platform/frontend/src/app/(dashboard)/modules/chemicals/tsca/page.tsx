...
const PAGE = "TSCA Reporting";
const KPIS = [{"l":"Total Chemicals","v":"6.691","t":"-0.8%","d":"down"},{"l":"TSCA Reporting Ativos","v":"2.745","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"87.3%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"92","t":"+0.4%","d":"up"}];
const COLS = ["ID","TSCA Reporting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemicals #001","Chemicals #002","1.094","4.606","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Chemicals #002","Chemicals #003","5.283","2.818","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemicals #003","Chemicals #004","4.018","2.543","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Chemicals #004","Chemicals #005","4.938","6.280","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemicals #005","Chemicals #001","8.695","4.285","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":768},{"label":"Fev","value":884},{"label":"Mar","value":599},{"label":"Abr","value":568},{"label":"Mai","value":713},{"label":"Jun","value":589},{"label":"Jul","value":722},{"label":"Ago","value":643},{"label":"Set","value":541},{"label":"Out","value":765},{"label":"Nov","value":546},{"label":"Dez","value":572}];
const MX = 884;
...
export default function TscaPage() {
    return (
