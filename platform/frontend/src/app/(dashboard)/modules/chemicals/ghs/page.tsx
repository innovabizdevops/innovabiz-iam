...
const PAGE = "GHS Classification";
const KPIS = [{"l":"Total Chemicals","v":"1.485","t":"+16.9%","d":"up"},{"l":"GHS Classification Ativos","v":"1.074","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"69.9%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"90","t":"+2.1%","d":"up"}];
const COLS = ["ID","GHS Classification","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemicals #001","Chemicals #002","1.713","2.447","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Chemicals #002","Chemicals #003","5.439","5.914","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemicals #003","Chemicals #004","5.772","4.160","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Chemicals #004","Chemicals #005","7.858","6.094","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemicals #005","Chemicals #001","753","4.187","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":706},{"label":"Mar","value":973},{"label":"Abr","value":687},{"label":"Mai","value":794},{"label":"Jun","value":819},{"label":"Jul","value":687},{"label":"Ago","value":820},{"label":"Set","value":736},{"label":"Out","value":900},{"label":"Nov","value":875},{"label":"Dez","value":881}];
const MX = 973;
