...
const PAGE = "Formula Mgmt";
const KPIS = [{"l":"Formulários Ativos","v":"224","t":"-4.0%","d":"down"},{"l":"Submissões/Dia","v":"2110","t":"+5.8%","d":"up"},{"l":"Documentos Gerados","v":"671","t":"+13.0%","d":"up"},{"l":"Templates","v":"2.687","t":"+9.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.797","2026-02-28","6.976","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.998","2026-01-22","7.389","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.865","2026-03-27","434","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.248","2026-02-04","7.668","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","678","2026-01-19","5.002","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":965},{"label":"Fev","value":892},{"label":"Mar","value":1008},{"label":"Abr","value":950},{"label":"Mai","value":818},{"label":"Jun","value":772},{"label":"Jul","value":785},{"label":"Ago","value":896},{"label":"Set","value":859},{"label":"Out","value":918},{"label":"Nov","value":761},{"label":"Dez","value":727}];
const MX = 1008;
