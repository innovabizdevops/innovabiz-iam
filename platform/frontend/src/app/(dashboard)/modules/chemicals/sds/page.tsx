...
const PAGE = "SDS Management";
const KPIS = [{"l":"Projetos Melhoria","v":"8.423","t":"+6.6%","d":"up"},{"l":"Savings (€)","v":"€35186","t":"-4.8%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"94.2%","t":"+10.9%","d":"up"},{"l":"Ciclos PDCA","v":"7.231","t":"+8.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","231","€ 45964.00","2.833","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","946","€ 35376.36","597","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","985","€ 41881.56","7.240","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.323","€ 7655.39","134","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.177","€ 22156.33","6.224","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":978},{"label":"Mar","value":618},{"label":"Abr","value":759},{"label":"Mai","value":771},{"label":"Jun","value":940},{"label":"Jul","value":927},{"label":"Ago","value":892},{"label":"Set","value":899},{"label":"Out","value":603},{"label":"Nov","value":647},{"label":"Dez","value":917}];
const MX = 978;
