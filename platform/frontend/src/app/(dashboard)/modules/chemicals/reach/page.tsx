...
const ACCENT = "#dc2626";
const MODULE = "Chemicals & Materials";
const PAGE = "REACH Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.080","t":"+5.7%","d":"up"},{"l":"NC Abertas","v":"3.082","t":"+13.1%","d":"up"},{"l":"Conformidade (%)","v":"73.5%","t":"+11.8%","d":"up"},{"l":"CAPAs Pendentes","v":"4.642","t":"+1.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.914","71.3%","3.547","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.519","88.4%","6.188","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.958","96.9%","7.446","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","920","86.5%","2.522","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","285","89.2%","6.703","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":758},{"label":"Mar","value":410},{"label":"Abr","value":650},{"label":"Mai","value":402},{"label":"Jun","value":596},{"label":"Jul","value":539},{"label":"Ago","value":469},{"label":"Set","value":687},{"label":"Out","value":659},{"label":"Nov","value":623},{"label":"Dez","value":482}];
const MX = 758;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>REACH</span></h1>
                </div>
