...
const PAGE = "Campaign Rules";
const KPIS = [{"l":"Total Coupon Promo","v":"342","t":"+15.7%","d":"up"},{"l":"Campaign Rules Ativos","v":"264","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"75.6%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"73","t":"+10.7%","d":"up"}];
const COLS = ["ID","Campaign Rules","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coupon Promo #001","Coupon Promo #002","106","8.793","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Coupon Promo #002","Coupon Promo #003","5.544","6.873","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Coupon Promo #003","Coupon Promo #004","1.039","3.333","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Coupon Promo #004","Coupon Promo #005","4.110","2.978","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coupon Promo #005","Coupon Promo #001","2.298","3.883","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":670},{"label":"Mar","value":707},{"label":"Abr","value":922},{"label":"Mai","value":981},{"label":"Jun","value":975},{"label":"Jul","value":736},{"label":"Ago","value":779},{"label":"Set","value":955},{"label":"Out","value":949},{"label":"Nov","value":987},{"label":"Dez","value":668}];
const MX = 987;
