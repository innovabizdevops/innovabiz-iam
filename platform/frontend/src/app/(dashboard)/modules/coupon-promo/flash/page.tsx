...
const PAGE = "Flash Sales";
const KPIS = [{"l":"Vendas YTD (€)","v":"€40365","t":"+3.7%","d":"up"},{"l":"Pipeline (€)","v":"€16162","t":"+1.3%","d":"up"},{"l":"Atingimento Quota (%)","v":"76.6%","t":"-5.5%","d":"down"},{"l":"Win Rate (%)","v":"76.7%","t":"+6.0%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 45194.78","€ 11552.12","€ 15055.73","97.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 13016.99","€ 27410.69","€ 13587.37","84.0%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 6667.70","€ 1580.84","€ 15247.67","93.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 36440.27","€ 41352.04","€ 2007.06","95.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 16306.97","€ 10115.66","€ 10205.86","92.3%"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":682},{"label":"Mar","value":636},{"label":"Abr","value":427},{"label":"Mai","value":655},{"label":"Jun","value":559},{"label":"Jul","value":450},{"label":"Ago","value":486},{"label":"Set","value":538},{"label":"Out","value":487},{"label":"Nov","value":584},{"label":"Dez","value":700}];
const MX = 700;
