...
const PAGE = "Loyalty Bridge";
const KPIS = [{"l":"Total Coupon Promo","v":"3.782","t":"+9.5%","d":"up"},{"l":"Loyalty Bridge Ativos","v":"3.004","t":"+14.8%","d":"up"},{"l":"Eficiência (%)","v":"74.8%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"62","t":"-1.1%","d":"down"}];
const COLS = ["ID","Loyalty Bridge","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coupon Promo #001","Coupon Promo #002","1.315","8.226","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Coupon Promo #002","Coupon Promo #003","4.147","6.286","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Coupon Promo #003","Coupon Promo #004","5.099","6.024","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Coupon Promo #004","Coupon Promo #005","3.093","3.558","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coupon Promo #005","Coupon Promo #001","300","398","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":776},{"label":"Mar","value":885},{"label":"Abr","value":599},{"label":"Mai","value":912},{"label":"Jun","value":867},{"label":"Jul","value":675},{"label":"Ago","value":631},{"label":"Set","value":630},{"label":"Out","value":909},{"label":"Nov","value":702},{"label":"Dez","value":656}];
const MX = 912;
