...
const PAGE = "ROI Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"3.839","t":"-5.9%","d":"down"},{"l":"Queries/Dia","v":"761","t":"+10.4%","d":"up"},{"l":"Dados Processados (GB)","v":"6.917","t":"+-0.0%","d":"up"},{"l":"Utilizadores Analytics","v":"5.655","t":"+4.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1575","2026-02-25","3.069","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2945","2026-02-05","2.239","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4676","2026-01-08","994","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3010","2026-03-27","3.156","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3630","2026-03-06","2.035","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":635},{"label":"Mar","value":809},{"label":"Abr","value":767},{"label":"Mai","value":787},{"label":"Jun","value":745},{"label":"Jul","value":711},{"label":"Ago","value":719},{"label":"Set","value":618},{"label":"Out","value":495},{"label":"Nov","value":847},{"label":"Dez","value":812}];
const MX = 847;
