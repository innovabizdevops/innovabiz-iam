...
const ACCENT = "#dc2626";
const MODULE = "Coupon & Promotions";
const PAGE = "Personalized AI";
const KPIS = [{"l":"Perfis Unificados","v":"8.205","t":"-5.0%","d":"down"},{"l":"Segmentos Ativos","v":"5.185","t":"+8.5%","d":"up"},{"l":"NPS Score","v":"56","t":"-2.2%","d":"down"},{"l":"Churn Previsto (%)","v":"74.1%","t":"-4.4%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","1.530","€ 18042.19","88.4%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","603","€ 8547.80","97.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","1.932","€ 24751.81","99.1%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","8.898","€ 48882.63","83.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","8.535","€ 10095.98","76.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":676},{"label":"Mar","value":781},{"label":"Abr","value":658},{"label":"Mai","value":948},{"label":"Jun","value":873},{"label":"Jul","value":678},{"label":"Ago","value":684},{"label":"Set","value":819},{"label":"Out","value":590},{"label":"Nov","value":940},{"label":"Dez","value":657}];
const MX = 948;
