...
export default function CouponPromoPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Coupon Promo</h1><p className="text-sm text-muted-foreground">Coupon Promo • iBOS Enterprise</p></div>
