...
const PAGE = "Survey";
const KPIS = [{"l":"Surveys Ativos","v":"4.527","t":"+8.2%","d":"up"},{"l":"Respostas/Semana","v":"2604","t":"+9.9%","d":"up"},{"l":"NPS Médio","v":"77","t":"+1.5%","d":"up"},{"l":"Taxa Resposta (%)","v":"81.1%","t":"+6.7%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","3.762","74","96.5%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","6.738","78","99.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","1.214","66","95.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","4.102","75","99.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","6.231","83","92.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":513},{"label":"Fev","value":527},{"label":"Mar","value":659},{"label":"Abr","value":644},{"label":"Mai","value":664},{"label":"Jun","value":452},{"label":"Jul","value":721},{"label":"Ago","value":633},{"label":"Set","value":637},{"label":"Out","value":382},{"label":"Nov","value":578},{"label":"Dez","value":655}];
const MX = 721;
