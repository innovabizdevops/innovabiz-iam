...
const PAGE = "SLA";
const KPIS = [{"l":"Tickets Abertos","v":"8.601","t":"+13.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"67.2%","t":"-5.8%","d":"down"},{"l":"MTTR (h)","v":"39h","t":"-3.5%","d":"down"},{"l":"Satisfação (%)","v":"87.7%","t":"+16.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.173","4.036","3.868","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.698","3.808","3.945","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.158","5.458","3.670","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.868","4.805","176","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.095","1.432","1.317","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":578},{"label":"Mar","value":862},{"label":"Abr","value":922},{"label":"Mai","value":766},{"label":"Jun","value":793},{"label":"Jul","value":794},{"label":"Ago","value":804},{"label":"Set","value":619},{"label":"Out","value":604},{"label":"Nov","value":928},{"label":"Dez","value":669}];
const MX = 928;
