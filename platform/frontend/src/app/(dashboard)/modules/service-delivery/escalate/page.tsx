...
const PAGE = "Escalate";
const KPIS = [{"l":"Aprovações Pendentes","v":"8.513","t":"+5.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"88.1%","t":"+12.3%","d":"up"},{"l":"Tempo Médio (h)","v":"81h","t":"+12.7%","d":"up"},{"l":"Rejeitadas (%)","v":"85.1%","t":"+16.5%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","7.834","€ 938.67","4.372","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","7.006","€ 15690.58","2.733","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","2.961","€ 41421.83","3.896","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","7.884","€ 33484.99","1.492","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","6.003","€ 41584.73","1.805","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":356},{"label":"Mar","value":629},{"label":"Abr","value":361},{"label":"Mai","value":410},{"label":"Jun","value":317},{"label":"Jul","value":473},{"label":"Ago","value":401},{"label":"Set","value":627},{"label":"Out","value":627},{"label":"Nov","value":603},{"label":"Dez","value":652}];
const MX = 652;
