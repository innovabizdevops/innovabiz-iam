...
/* ═══ Service Delivery (APQC 5.1) — Dashboard ═══ */

const ACCENT = "#065f46";

const KPIS = [
    { label: "Total Registos", value: "4213", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "130", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€457K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "-21%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "895884813", cells: ["SER-7813", "Service Delivery (APQC 5.1) Item 1", "6/10/2026", "€34 913"], status: "active" as const },
    { id: "895888384", cells: ["SER-2384", "Service Delivery (APQC 5.1) Item 2", "21/5/2026", "€38 484"], status: "pending" as const },
    { id: "895891955", cells: ["SER-5955", "Service Delivery (APQC 5.1) Item 3", "8/12/2026", "€42 055"], status: "completed" as const },
    { id: "895895526", cells: ["SER-9526", "Service Delivery (APQC 5.1) Item 4", "23/7/2026", "€45 626"], status: "warning" as const },
    { id: "895899097", cells: ["SER-4097", "Service Delivery (APQC 5.1) Item 5", "10/2/2026", "€49 197"], status: "active" as const },
];
...
export default function ServiceDeliveryApqc51Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Service Delivery (APQC 5.1)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Service Delivery (APQC 5.1)</p>
                    </div>
                </div>
