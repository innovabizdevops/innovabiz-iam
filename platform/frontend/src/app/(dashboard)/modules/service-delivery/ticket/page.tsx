...
const PAGE = "Ticket";
const KPIS = [{"l":"Tickets Abertos","v":"3.281","t":"+0.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"77.5%","t":"+9.0%","d":"up"},{"l":"MTTR (h)","v":"157h","t":"+5.0%","d":"up"},{"l":"Satisfação (%)","v":"70.4%","t":"+7.2%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.059","4.077","7.201","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.264","7.407","2.958","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.450","1.389","6.930","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.595","8.676","3.605","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.790","5.442","4.404","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":785},{"label":"Fev","value":859},{"label":"Mar","value":730},{"label":"Abr","value":893},{"label":"Mai","value":590},{"label":"Jun","value":721},{"label":"Jul","value":636},{"label":"Ago","value":927},{"label":"Set","value":731},{"label":"Out","value":949},{"label":"Nov","value":748},{"label":"Dez","value":705}];
const MX = 949;
