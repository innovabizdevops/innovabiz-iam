...
const KPIS = [{"l":"Auditorias Realizadas","v":"1.042","t":"+6.6%","d":"up"},{"l":"NC Abertas","v":"1.059","t":"+8.6%","d":"up"},{"l":"Conformidade (%)","v":"74.8%","t":"+10.6%","d":"up"},{"l":"CAPAs Pendentes","v":"7.680","t":"-2.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","9.008","80.0%","773","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.271","93.4%","8.918","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.749","76.1%","5.851","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","906","72.9%","3.181","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.242","83.0%","1.596","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":581},{"label":"Mar","value":423},{"label":"Abr","value":622},{"label":"Mai","value":757},{"label":"Jun","value":481},{"label":"Jul","value":473},{"label":"Ago","value":457},{"label":"Set","value":795},{"label":"Out","value":556},{"label":"Nov","value":680},{"label":"Dez","value":603}];
const MX = 795;
