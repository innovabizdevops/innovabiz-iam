...
const ACCENT = "#92400e";
const MODULE = "Pawnshop Mgmt";
const PAGE = "Collateral";
const KPIS = [{"l":"Total Pawnshop Mgmt","v":"7.170","t":"-4.7%","d":"down"},{"l":"Collateral Ativos","v":"8.289","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"+15.4%","d":"up"},{"l":"Score Performance","v":"62","t":"+3.8%","d":"up"}];
const COLS = ["ID","Collateral","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pawnshop Mgmt #001","Pawnshop Mgmt #002","1.622","1.849","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Pawnshop Mgmt #002","Pawnshop Mgmt #003","2.645","8.020","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Pawnshop Mgmt #003","Pawnshop Mgmt #004","5.286","3.028","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Pawnshop Mgmt #004","Pawnshop Mgmt #005","4.943","3.992","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pawnshop Mgmt #005","Pawnshop Mgmt #001","6.775","6.885","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":678},{"label":"Mar","value":564},{"label":"Abr","value":741},{"label":"Mai","value":857},{"label":"Jun","value":638},{"label":"Jul","value":870},{"label":"Ago","value":536},{"label":"Set","value":884},{"label":"Out","value":846},{"label":"Nov","value":560},{"label":"Dez","value":528}];
const MX = 884;
