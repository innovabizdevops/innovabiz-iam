...
/* ═══ Pawnshop Mgmt — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "833", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3513", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€484K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1892969833", cells: ["PAW-9833", "Pawnshop Mgmt Item 1", "14/2/2026", "€19 933"], status: "active" as const },
    { id: "1892973404", cells: ["PAW-4404", "Pawnshop Mgmt Item 2", "1/9/2026", "€23 504"], status: "pending" as const },
    { id: "1892976975", cells: ["PAW-7975", "Pawnshop Mgmt Item 3", "16/4/2026", "€27 075"], status: "completed" as const },
    { id: "1892980546", cells: ["PAW-2546", "Pawnshop Mgmt Item 4", "3/11/2026", "€30 646"], status: "warning" as const },
    { id: "1892984117", cells: ["PAW-6117", "Pawnshop Mgmt Item 5", "18/6/2026", "€34 217"], status: "active" as const },
];
...
export default function PawnshopMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pawnshop Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pawnshop Mgmt</p>
                    </div>
                </div>
