...
const PAGE = "Feed";
const KPIS = [{"l":"Total Livestock Mgmt","v":"2.314","t":"+8.6%","d":"up"},{"l":"Feed Ativos","v":"7.151","t":"+17.7%","d":"up"},{"l":"Eficiência (%)","v":"78.7%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"85","t":"+15.6%","d":"up"}];
const COLS = ["ID","Feed","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Livestock Mgmt #001","Livestock Mgmt #002","247","171","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Livestock Mgmt #002","Livestock Mgmt #003","8.042","1.209","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Livestock Mgmt #003","Livestock Mgmt #004","5.410","8.447","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Livestock Mgmt #004","Livestock Mgmt #005","190","5.912","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Livestock Mgmt #005","Livestock Mgmt #001","3.782","2.138","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":492},{"label":"Mar","value":664},{"label":"Abr","value":539},{"label":"Mai","value":785},{"label":"Jun","value":827},{"label":"Jul","value":610},{"label":"Ago","value":568},{"label":"Set","value":630},{"label":"Out","value":688},{"label":"Nov","value":554},{"label":"Dez","value":847}];
const MX = 847;
