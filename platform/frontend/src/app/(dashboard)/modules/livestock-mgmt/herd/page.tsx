...
const PAGE = "Herd";
const KPIS = [{"l":"Total Livestock Mgmt","v":"6.442","t":"+3.4%","d":"up"},{"l":"Herd Ativos","v":"6.295","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"69.9%","t":"+5.8%","d":"up"},{"l":"Score Performance","v":"82","t":"-4.2%","d":"down"}];
const COLS = ["ID","Herd","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Livestock Mgmt #001","Livestock Mgmt #002","4.375","4.033","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Livestock Mgmt #002","Livestock Mgmt #003","3.620","6.529","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Livestock Mgmt #003","Livestock Mgmt #004","3.090","4.624","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Livestock Mgmt #004","Livestock Mgmt #005","4.124","747","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Livestock Mgmt #005","Livestock Mgmt #001","1.233","6.863","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":355},{"label":"Mar","value":278},{"label":"Abr","value":370},{"label":"Mai","value":488},{"label":"Jun","value":338},{"label":"Jul","value":397},{"label":"Ago","value":429},{"label":"Set","value":245},{"label":"Out","value":400},{"label":"Nov","value":615},{"label":"Dez","value":308}];
const MX = 615;
