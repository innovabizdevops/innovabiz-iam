...
const ACCENT = "#6366f1";
const MODULE = "Livestock Management";
const PAGE = "Breeding";
const KPIS = [{"l":"Integrações Ativas","v":"1.171","t":"+3.5%","d":"up"},{"l":"Chamadas/Hora","v":"1232","t":"+12.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"80.2%","t":"+8.4%","d":"up"},{"l":"Latência Média (ms)","v":"189ms","t":"+10.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.141","1.896","93.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.879","4.355","86.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.429","3.226","93.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","9.066","8.392","87.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.058","3.896","96.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":461},{"label":"Fev","value":301},{"label":"Mar","value":213},{"label":"Abr","value":542},{"label":"Mai","value":325},{"label":"Jun","value":378},{"label":"Jul","value":362},{"label":"Ago","value":336},{"label":"Set","value":470},{"label":"Out","value":571},{"label":"Nov","value":304},{"label":"Dez","value":205}];
const MX = 571;
