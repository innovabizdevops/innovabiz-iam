...
const KPIS = [{"l":"Total Livestock Mgmt","v":"1.088","t":"+2.0%","d":"up"},{"l":"Traceability Ativos","v":"1.706","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"84.2%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"57","t":"-2.9%","d":"down"}];
const COLS = ["ID","Traceability","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Livestock Mgmt #001","Livestock Mgmt #002","1.091","2.163","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Livestock Mgmt #002","Livestock Mgmt #003","2.197","418","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Livestock Mgmt #003","Livestock Mgmt #004","6.674","9.011","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Livestock Mgmt #004","Livestock Mgmt #005","9.007","4.069","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Livestock Mgmt #005","Livestock Mgmt #001","6.841","3.094","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":369},{"label":"Fev","value":505},{"label":"Mar","value":367},{"label":"Abr","value":418},{"label":"Mai","value":440},{"label":"Jun","value":332},{"label":"Jul","value":489},{"label":"Ago","value":469},{"label":"Set","value":460},{"label":"Out","value":525},{"label":"Nov","value":286},{"label":"Dez","value":501}];
const MX = 525;
