...
const PAGE = "Health";
const KPIS = [{"l":"Total Livestock Mgmt","v":"4.684","t":"-1.3%","d":"down"},{"l":"Health Ativos","v":"5.468","t":"+17.3%","d":"up"},{"l":"Eficiência (%)","v":"70.7%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"95","t":"+0.7%","d":"up"}];
const COLS = ["ID","Health","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Livestock Mgmt #001","Livestock Mgmt #002","5.188","4.678","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Livestock Mgmt #002","Livestock Mgmt #003","6.970","3.066","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Livestock Mgmt #003","Livestock Mgmt #004","3.533","5.291","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Livestock Mgmt #004","Livestock Mgmt #005","4.472","7.675","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Livestock Mgmt #005","Livestock Mgmt #001","3.089","7.748","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":647},{"label":"Mar","value":936},{"label":"Abr","value":667},{"label":"Mai","value":768},{"label":"Jun","value":910},{"label":"Jul","value":948},{"label":"Ago","value":641},{"label":"Set","value":761},{"label":"Out","value":675},{"label":"Nov","value":723},{"label":"Dez","value":854}];
const MX = 948;
