...
const PAGE = "Billing";
const KPIS = [{"l":"Total Robot As Service","v":"3.995","t":"-4.5%","d":"down"},{"l":"Billing Ativos","v":"5.797","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"80.3%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"62","t":"+13.0%","d":"up"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Robot As Service #001","Robot As Service #002","4.091","2.995","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Robot As Service #002","Robot As Service #003","600","3.956","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Robot As Service #003","Robot As Service #004","8.237","6.412","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Robot As Service #004","Robot As Service #005","3.799","4.721","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Robot As Service #005","Robot As Service #001","6.523","6.226","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":379},{"label":"Fev","value":324},{"label":"Mar","value":404},{"label":"Abr","value":374},{"label":"Mai","value":470},{"label":"Jun","value":364},{"label":"Jul","value":463},{"label":"Ago","value":408},{"label":"Set","value":428},{"label":"Out","value":337},{"label":"Nov","value":463},{"label":"Dez","value":349}];
const MX = 470;
