...
const PAGE = "SLA";
const KPIS = [{"l":"Tickets Abertos","v":"2.537","t":"+1.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"87.2%","t":"+12.5%","d":"up"},{"l":"MTTR (h)","v":"70h","t":"-5.2%","d":"down"},{"l":"Satisfação (%)","v":"79.7%","t":"+6.2%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.076","8.622","232","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.868","8.768","2.999","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.757","6.978","4.269","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.361","1.081","5.258","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","465","5.413","550","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":396},{"label":"Fev","value":411},{"label":"Mar","value":319},{"label":"Abr","value":565},{"label":"Mai","value":456},{"label":"Jun","value":554},{"label":"Jul","value":327},{"label":"Ago","value":557},{"label":"Set","value":415},{"label":"Out","value":595},{"label":"Nov","value":274},{"label":"Dez","value":252}];
const MX = 595;
