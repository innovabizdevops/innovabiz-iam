...
const ACCENT = "#6366f1";
const MODULE = "Robot as a Service";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Robot As Service","v":"3.007","t":"+9.9%","d":"up"},{"l":"Monitor Ativos","v":"4.218","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"74.9%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"66","t":"+13.6%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Robot As Service #001","Robot As Service #002","1.660","7.029","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Robot As Service #002","Robot As Service #003","1.700","226","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Robot As Service #003","Robot As Service #004","8.584","705","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Robot As Service #004","Robot As Service #005","6.924","7.585","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Robot As Service #005","Robot As Service #001","7.553","5.119","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":329},{"label":"Mar","value":410},{"label":"Abr","value":498},{"label":"Mai","value":479},{"label":"Jun","value":683},{"label":"Jul","value":497},{"label":"Ago","value":483},{"label":"Set","value":452},{"label":"Out","value":579},{"label":"Nov","value":654},{"label":"Dez","value":481}];
const MX = 683;
