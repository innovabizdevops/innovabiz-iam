...
const PAGE = "Deploy";
const KPIS = [{"l":"Total Robot As Service","v":"1.304","t":"+7.0%","d":"up"},{"l":"Deploy Ativos","v":"5.842","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+2.0%","d":"up"},{"l":"Score Performance","v":"89","t":"+10.2%","d":"up"}];
const COLS = ["ID","Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Robot As Service #001","Robot As Service #002","5.849","5.797","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Robot As Service #002","Robot As Service #003","8.658","8.428","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Robot As Service #003","Robot As Service #004","5.132","4.983","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Robot As Service #004","Robot As Service #005","6.406","5.143","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Robot As Service #005","Robot As Service #001","5.876","8.409","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":526},{"label":"Mar","value":607},{"label":"Abr","value":725},{"label":"Mai","value":514},{"label":"Jun","value":803},{"label":"Jul","value":653},{"label":"Ago","value":483},{"label":"Set","value":718},{"label":"Out","value":550},{"label":"Nov","value":526},{"label":"Dez","value":660}];
const MX = 803;
