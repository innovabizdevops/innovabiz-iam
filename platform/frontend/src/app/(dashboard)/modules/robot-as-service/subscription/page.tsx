...
const KPIS = [{"l":"ARR (€M)","v":"€48.7M","t":"+12.8%","d":"up"},{"l":"MRR (€)","v":"€56605","t":"-1.9%","d":"down"},{"l":"Churn (%)","v":"83.7%","t":"+10.7%","d":"up"},{"l":"ARPU (€)","v":"€43206","t":"+10.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 14900.78","7.579","€ 20658.63","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 49547.38","2.048","€ 38223.54","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 17239.79","247","€ 9157.50","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 33127.08","4.910","€ 2682.82","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 14678.16","7.824","€ 27609.63","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":753},{"label":"Mar","value":857},{"label":"Abr","value":559},{"label":"Mai","value":689},{"label":"Jun","value":706},{"label":"Jul","value":508},{"label":"Ago","value":479},{"label":"Set","value":622},{"label":"Out","value":668},{"label":"Nov","value":576},{"label":"Dez","value":568}];
const MX = 857;
