...
const PAGE = "Social Feed";
const KPIS = [{"l":"eNPS","v":"73","t":"+9.8%","d":"up"},{"l":"Engagement (%)","v":"90.7%","t":"-1.0%","d":"down"},{"l":"Turnover (%)","v":"69.9%","t":"-0.7%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"6.462","t":"+12.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.514","2026-01-03","73","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.064","2026-01-24","68","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.811","2026-03-17","63","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.362","2026-03-22","72","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.304","2026-02-10","83","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":760},{"label":"Mar","value":617},{"label":"Abr","value":747},{"label":"Mai","value":579},{"label":"Jun","value":722},{"label":"Jul","value":547},{"label":"Ago","value":644},{"label":"Set","value":546},{"label":"Out","value":513},{"label":"Nov","value":856},{"label":"Dez","value":802}];
const MX = 856;
