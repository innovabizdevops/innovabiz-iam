...
const PAGE = "Loyalty Points";
const KPIS = [{"l":"eNPS","v":"62","t":"+0.8%","d":"up"},{"l":"Engagement (%)","v":"73.5%","t":"+9.8%","d":"up"},{"l":"Turnover (%)","v":"90.6%","t":"+11.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"891","t":"-3.6%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.198","2026-03-10","68","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","217","2026-02-03","93","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.955","2026-02-24","76","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.048","2026-03-10","58","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.862","2026-01-16","66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":893},{"label":"Fev","value":1059},{"label":"Mar","value":719},{"label":"Abr","value":953},{"label":"Mai","value":1072},{"label":"Jun","value":686},{"label":"Jul","value":981},{"label":"Ago","value":691},{"label":"Set","value":861},{"label":"Out","value":710},{"label":"Nov","value":990},{"label":"Dez","value":948}];
const MX = 1072;
