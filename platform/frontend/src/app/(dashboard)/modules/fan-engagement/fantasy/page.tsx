...
const ACCENT = "#ec4899";
const MODULE = "Fan Engagement";
const PAGE = "Fantasy League";
const KPIS = [{"l":"eNPS","v":"76","t":"-5.6%","d":"down"},{"l":"Engagement (%)","v":"70.3%","t":"+12.0%","d":"up"},{"l":"Turnover (%)","v":"94.5%","t":"+16.4%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.934","t":"+2.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.171","2026-03-26","62","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.002","2026-03-23","59","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.574","2026-03-09","75","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","303","2026-01-04","88","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.724","2026-03-01","84","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":396},{"label":"Mar","value":468},{"label":"Abr","value":734},{"label":"Mai","value":549},{"label":"Jun","value":607},{"label":"Jul","value":603},{"label":"Ago","value":467},{"label":"Set","value":529},{"label":"Out","value":400},{"label":"Nov","value":343},{"label":"Dez","value":662}];
const MX = 734;
