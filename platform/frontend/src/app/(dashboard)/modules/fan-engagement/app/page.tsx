...
const PAGE = "Fan App";
const KPIS = [{"l":"eNPS","v":"74","t":"-2.1%","d":"down"},{"l":"Engagement (%)","v":"92.1%","t":"+7.9%","d":"up"},{"l":"Turnover (%)","v":"69.4%","t":"-5.4%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"4.704","t":"+16.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.294","2026-02-10","89","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.579","2026-01-16","80","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.792","2026-02-13","78","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.461","2026-01-17","91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.031","2026-02-26","77","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":849},{"label":"Fev","value":637},{"label":"Mar","value":750},{"label":"Abr","value":810},{"label":"Mai","value":855},{"label":"Jun","value":842},{"label":"Jul","value":943},{"label":"Ago","value":880},{"label":"Set","value":664},{"label":"Out","value":971},{"label":"Nov","value":683},{"label":"Dez","value":874}];
const MX = 971;
