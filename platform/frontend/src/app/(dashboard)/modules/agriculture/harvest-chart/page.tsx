...
const PAGE = "Harvest Dashboard";
const KPIS = [{"l":"Teams Ativos","v":"970","t":"+1.6%","d":"up"},{"l":"Reuniões/Semana","v":"4349","t":"-4.6%","d":"down"},{"l":"Mensagens/Dia","v":"2178","t":"-1.2%","d":"down"},{"l":"Ficheiros Partilhados","v":"3.378","t":"+1.9%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","528","4810","1.285","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","5.544","1127","661","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.385","4221","2.134","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.043","1717","4.544","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","5.864","1746","8.112","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":293},{"label":"Fev","value":617},{"label":"Mar","value":355},{"label":"Abr","value":508},{"label":"Mai","value":422},{"label":"Jun","value":346},{"label":"Jul","value":406},{"label":"Ago","value":554},{"label":"Set","value":625},{"label":"Out","value":543},{"label":"Nov","value":573},{"label":"Dez","value":509}];
const MX = 625;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#65a30d'}}>Chart</span></h1>
                </div>
