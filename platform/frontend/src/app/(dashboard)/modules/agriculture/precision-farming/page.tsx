...
const ACCENT = "#65a30d";
const MODULE = "Agriculture & AgriTech";
const PAGE = "Precision Farming AI";
const KPIS = [{"l":"Total Agriculture","v":"8.509","t":"+6.0%","d":"up"},{"l":"Precision Farming AI Ativos","v":"2.723","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"93.0%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"82","t":"+10.1%","d":"up"}];
const COLS = ["ID","Precision Farming AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agriculture #001","Agriculture #002","4.724","418","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Agriculture #002","Agriculture #003","7.510","6.117","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Agriculture #003","Agriculture #004","4.375","4.289","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Agriculture #004","Agriculture #005","828","7.825","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agriculture #005","Agriculture #001","857","6.096","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":888},{"label":"Mar","value":845},{"label":"Abr","value":657},{"label":"Mai","value":906},{"label":"Jun","value":868},{"label":"Jul","value":641},{"label":"Ago","value":902},{"label":"Set","value":911},{"label":"Out","value":803},{"label":"Nov","value":595},{"label":"Dez","value":594}];
const MX = 911;
...
export default function PrecisionFarmingPage() {
    return (
