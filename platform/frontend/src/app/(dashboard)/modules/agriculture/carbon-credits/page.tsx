...
const PAGE = "Carbon Credits";
const KPIS = [{"l":"Integrações Ativas","v":"6.414","t":"-0.9%","d":"down"},{"l":"Chamadas/Hora","v":"1287","t":"+16.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.8%","t":"-5.0%","d":"down"},{"l":"Latência Média (ms)","v":"51ms","t":"+5.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.490","6.569","73.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.914","1.894","92.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.385","1.222","90.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.168","7.707","97.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.900","4.816","86.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":985},{"label":"Fev","value":739},{"label":"Mar","value":842},{"label":"Abr","value":759},{"label":"Mai","value":682},{"label":"Jun","value":646},{"label":"Jul","value":781},{"label":"Ago","value":897},{"label":"Set","value":1000},{"label":"Out","value":946},{"label":"Nov","value":981},{"label":"Dez","value":941}];
const MX = 1000;
