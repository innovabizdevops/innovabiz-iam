...
const PAGE = "Crop Planning Form";
const KPIS = [{"l":"Formulários Ativos","v":"4.730","t":"+13.4%","d":"up"},{"l":"Submissões/Dia","v":"3528","t":"+17.9%","d":"up"},{"l":"Documentos Gerados","v":"4.338","t":"-4.0%","d":"down"},{"l":"Templates","v":"8.393","t":"+17.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.291","2026-01-03","2.134","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.841","2026-03-22","1.079","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.472","2026-01-21","4.032","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.176","2026-01-16","462","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.317","2026-01-09","6.050","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":731},{"label":"Mar","value":487},{"label":"Abr","value":777},{"label":"Mai","value":613},{"label":"Jun","value":626},{"label":"Jul","value":532},{"label":"Ago","value":460},{"label":"Set","value":728},{"label":"Out","value":613},{"label":"Nov","value":485},{"label":"Dez","value":491}];
const MX = 777;
