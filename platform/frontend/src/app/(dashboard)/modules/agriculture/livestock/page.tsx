...
const PAGE = "Livestock Management";
const KPIS = [{"l":"Projetos Melhoria","v":"2.030","t":"+6.1%","d":"up"},{"l":"Savings (€)","v":"€63136","t":"+7.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"80.9%","t":"+10.8%","d":"up"},{"l":"Ciclos PDCA","v":"8.740","t":"-5.1%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.908","€ 18332.06","4.059","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.713","€ 7998.38","2.298","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.749","€ 708.47","4.715","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.168","€ 15084.35","7.356","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.925","€ 43338.57","7.700","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":467},{"label":"Mar","value":645},{"label":"Abr","value":676},{"label":"Mai","value":598},{"label":"Jun","value":385},{"label":"Jul","value":420},{"label":"Ago","value":643},{"label":"Set","value":323},{"label":"Out","value":678},{"label":"Nov","value":315},{"label":"Dez","value":423}];
const MX = 678;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#65a30d'}}>IoT</span></h1>
                </div>
