...
const ACCENT = "#6366f1";
const MODULE = "Container Mgmt";
const PAGE = "Tracking";
const KPIS = [{"l":"Total Container Mgmt","v":"2.538","t":"+6.3%","d":"up"},{"l":"Tracking Ativos","v":"6.588","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"93.5%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"79","t":"-1.9%","d":"down"}];
const COLS = ["ID","Tracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Container Mgmt #001","Container Mgmt #002","5.047","7.857","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Container Mgmt #002","Container Mgmt #003","5.077","2.507","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Container Mgmt #003","Container Mgmt #004","7.627","3.219","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Container Mgmt #004","Container Mgmt #005","2.622","5.712","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Container Mgmt #005","Container Mgmt #001","3.898","8.835","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":793},{"label":"Mar","value":513},{"label":"Abr","value":716},{"label":"Mai","value":501},{"label":"Jun","value":688},{"label":"Jul","value":635},{"label":"Ago","value":692},{"label":"Set","value":651},{"label":"Out","value":566},{"label":"Nov","value":685},{"label":"Dez","value":750}];
const MX = 793;
