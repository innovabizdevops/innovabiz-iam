...
const PAGE = "Depot";
const KPIS = [{"l":"Total Container Mgmt","v":"3.581","t":"+1.1%","d":"up"},{"l":"Depot Ativos","v":"1.026","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"89.8%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"79","t":"+6.4%","d":"up"}];
const COLS = ["ID","Depot","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Container Mgmt #001","Container Mgmt #002","5.860","6.111","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Container Mgmt #002","Container Mgmt #003","487","6.902","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Container Mgmt #003","Container Mgmt #004","1.213","5.185","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Container Mgmt #004","Container Mgmt #005","1.811","3.508","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Container Mgmt #005","Container Mgmt #001","4.652","4.958","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":660},{"label":"Mar","value":1016},{"label":"Abr","value":1041},{"label":"Mai","value":902},{"label":"Jun","value":954},{"label":"Jul","value":973},{"label":"Ago","value":755},{"label":"Set","value":837},{"label":"Out","value":934},{"label":"Nov","value":874},{"label":"Dez","value":966}];
const MX = 1041;
