...
const KPIS = [{"l":"Total Container Mgmt","v":"1.012","t":"+10.9%","d":"up"},{"l":"Demurrage Ativos","v":"3.337","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"69.4%","t":"+7.2%","d":"up"},{"l":"Score Performance","v":"58","t":"+4.3%","d":"up"}];
const COLS = ["ID","Demurrage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Container Mgmt #001","Container Mgmt #002","969","4.653","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Container Mgmt #002","Container Mgmt #003","7.640","1.185","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Container Mgmt #003","Container Mgmt #004","7.202","8.377","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Container Mgmt #004","Container Mgmt #005","8.464","7.373","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Container Mgmt #005","Container Mgmt #001","3.983","6.260","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":400},{"label":"Mar","value":381},{"label":"Abr","value":427},{"label":"Mai","value":476},{"label":"Jun","value":547},{"label":"Jul","value":653},{"label":"Ago","value":634},{"label":"Set","value":675},{"label":"Out","value":574},{"label":"Nov","value":514},{"label":"Dez","value":356}];
const MX = 675;
