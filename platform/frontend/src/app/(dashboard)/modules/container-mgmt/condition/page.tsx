...
const KPIS = [{"l":"Total Container Mgmt","v":"5.752","t":"+0.5%","d":"up"},{"l":"Condition Ativos","v":"2.680","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"65.5%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"78","t":"+15.8%","d":"up"}];
const COLS = ["ID","Condition","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Container Mgmt #001","Container Mgmt #002","2.674","7.822","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Container Mgmt #002","Container Mgmt #003","7.971","6.098","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Container Mgmt #003","Container Mgmt #004","5.805","1.302","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Container Mgmt #004","Container Mgmt #005","965","2.695","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Container Mgmt #005","Container Mgmt #001","826","4.457","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":503},{"label":"Mar","value":576},{"label":"Abr","value":558},{"label":"Mai","value":525},{"label":"Jun","value":377},{"label":"Jul","value":384},{"label":"Ago","value":257},{"label":"Set","value":418},{"label":"Out","value":446},{"label":"Nov","value":419},{"label":"Dez","value":271}];
const MX = 630;
