...
const PAGE = "UL/VUL";
const KPIS = [{"l":"Total Life Insurance","v":"4.035","t":"+10.9%","d":"up"},{"l":"UL/VUL Ativos","v":"7.130","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"89.5%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"60","t":"+7.2%","d":"up"}];
const COLS = ["ID","UL/VUL","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Life Insurance #001","Life Insurance #002","8.503","3.256","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Life Insurance #002","Life Insurance #003","8.693","6.124","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Life Insurance #003","Life Insurance #004","5.790","2.295","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Life Insurance #004","Life Insurance #005","3.497","6.049","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Life Insurance #005","Life Insurance #001","4.780","3.265","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":386},{"label":"Mar","value":430},{"label":"Abr","value":313},{"label":"Mai","value":504},{"label":"Jun","value":300},{"label":"Jul","value":484},{"label":"Ago","value":556},{"label":"Set","value":657},{"label":"Out","value":512},{"label":"Nov","value":536},{"label":"Dez","value":638}];
const MX = 657;
