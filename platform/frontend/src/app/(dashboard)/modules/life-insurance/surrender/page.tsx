...
const ACCENT = "#6366f1";
const MODULE = "Life Insurance";
const PAGE = "Surrender";
const KPIS = [{"l":"Total Life Insurance","v":"8.033","t":"+9.4%","d":"up"},{"l":"Surrender Ativos","v":"6.204","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"66.4%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"75","t":"+9.6%","d":"up"}];
const COLS = ["ID","Surrender","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Life Insurance #001","Life Insurance #002","1.273","6.723","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Life Insurance #002","Life Insurance #003","8.189","492","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Life Insurance #003","Life Insurance #004","656","3.502","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Life Insurance #004","Life Insurance #005","3.689","4.597","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Life Insurance #005","Life Insurance #001","3.594","6.282","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":403},{"label":"Fev","value":581},{"label":"Mar","value":482},{"label":"Abr","value":430},{"label":"Mai","value":249},{"label":"Jun","value":239},{"label":"Jul","value":456},{"label":"Ago","value":528},{"label":"Set","value":508},{"label":"Out","value":289},{"label":"Nov","value":293},{"label":"Dez","value":359}];
const MX = 581;
