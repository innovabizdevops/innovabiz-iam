...
const PAGE = "Term";
const KPIS = [{"l":"Riscos Identificados","v":"2.894","t":"+0.2%","d":"up"},{"l":"Mitigações Ativas","v":"7.681","t":"+7.2%","d":"up"},{"l":"Score Risco Geral","v":"73","t":"+17.5%","d":"up"},{"l":"Incidentes YTD","v":"2.627","t":"+17.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.669","1.505","5.956","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.395","7.056","4.304","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.604","1.497","5.815","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.883","6.692","207","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.532","4.965","8.096","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":679},{"label":"Mar","value":545},{"label":"Abr","value":504},{"label":"Mai","value":785},{"label":"Jun","value":585},{"label":"Jul","value":685},{"label":"Ago","value":541},{"label":"Set","value":694},{"label":"Out","value":651},{"label":"Nov","value":504},{"label":"Dez","value":746}];
const MX = 785;
