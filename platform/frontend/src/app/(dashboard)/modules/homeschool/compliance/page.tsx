...
const KPIS = [{"l":"Auditorias Realizadas","v":"6.790","t":"+14.0%","d":"up"},{"l":"NC Abertas","v":"7.334","t":"-4.5%","d":"down"},{"l":"Conformidade (%)","v":"78.4%","t":"-5.3%","d":"down"},{"l":"CAPAs Pendentes","v":"2.431","t":"-0.1%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.897","79.5%","2.844","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","316","92.0%","5.889","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.211","93.2%","6.771","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.195","96.7%","3.934","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.105","93.5%","4.147","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":460},{"label":"Mar","value":256},{"label":"Abr","value":452},{"label":"Mai","value":436},{"label":"Jun","value":431},{"label":"Jul","value":278},{"label":"Ago","value":590},{"label":"Set","value":433},{"label":"Out","value":249},{"label":"Nov","value":512},{"label":"Dez","value":279}];
const MX = 590;
