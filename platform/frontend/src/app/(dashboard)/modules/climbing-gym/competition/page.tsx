...
const ACCENT = "#14532d";
const MODULE = "Climbing Gym";
const PAGE = "Competition";
const KPIS = [{"l":"Atletas Registados","v":"4.149","t":"-2.7%","d":"down"},{"l":"Treinos/Semana","v":"3456","t":"-5.9%","d":"down"},{"l":"Competições","v":"7.805","t":"+8.0%","d":"up"},{"l":"Performance Score","v":"80","t":"+12.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.604","284","7.527","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.817","1.028","8.583","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.332","3.315","8.741","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","3.869","2.482","6.863","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.534","8.563","6.916","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":802},{"label":"Fev","value":616},{"label":"Mar","value":776},{"label":"Abr","value":565},{"label":"Mai","value":595},{"label":"Jun","value":808},{"label":"Jul","value":617},{"label":"Ago","value":708},{"label":"Set","value":679},{"label":"Out","value":561},{"label":"Nov","value":800},{"label":"Dez","value":547}];
const MX = 808;
