...
const PAGE = "Route";
const KPIS = [{"l":"Atletas Registados","v":"4.023","t":"+16.8%","d":"up"},{"l":"Treinos/Semana","v":"3586","t":"+2.0%","d":"up"},{"l":"Competições","v":"1.207","t":"+5.0%","d":"up"},{"l":"Performance Score","v":"81","t":"+4.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.432","4.733","6.945","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.506","794","8.868","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.641","112","8.056","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.881","749","3.382","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","9.073","255","7.619","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":343},{"label":"Fev","value":456},{"label":"Mar","value":416},{"label":"Abr","value":441},{"label":"Mai","value":632},{"label":"Jun","value":696},{"label":"Jul","value":512},{"label":"Ago","value":653},{"label":"Set","value":466},{"label":"Out","value":675},{"label":"Nov","value":659},{"label":"Dez","value":563}];
const MX = 696;
