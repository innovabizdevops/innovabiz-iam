...
const PAGE = "Belay";
const KPIS = [{"l":"Atletas Registados","v":"1.680","t":"+7.5%","d":"up"},{"l":"Treinos/Semana","v":"1628","t":"+4.8%","d":"up"},{"l":"Competições","v":"8.933","t":"+14.1%","d":"up"},{"l":"Performance Score","v":"76","t":"+5.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.405","6.567","4.640","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","569","6.868","4.435","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.126","412","7.002","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.036","362","3.215","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.175","8.921","3.446","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":776},{"label":"Fev","value":851},{"label":"Mar","value":761},{"label":"Abr","value":709},{"label":"Mai","value":615},{"label":"Jun","value":554},{"label":"Jul","value":772},{"label":"Ago","value":811},{"label":"Set","value":895},{"label":"Out","value":650},{"label":"Nov","value":533},{"label":"Dez","value":513}];
const MX = 895;
