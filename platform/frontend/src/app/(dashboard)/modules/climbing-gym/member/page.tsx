...
const PAGE = "Member";
const KPIS = [{"l":"Atletas Registados","v":"4.704","t":"+10.6%","d":"up"},{"l":"Treinos/Semana","v":"2978","t":"+7.9%","d":"up"},{"l":"Competições","v":"7.533","t":"+5.7%","d":"up"},{"l":"Performance Score","v":"73","t":"-4.5%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.139","5.868","129","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.992","5.295","7.634","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.526","861","3.971","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.749","6.715","5.339","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.872","7.914","5.535","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":718},{"label":"Fev","value":543},{"label":"Mar","value":807},{"label":"Abr","value":810},{"label":"Mai","value":539},{"label":"Jun","value":513},{"label":"Jul","value":693},{"label":"Ago","value":607},{"label":"Set","value":441},{"label":"Out","value":787},{"label":"Nov","value":734},{"label":"Dez","value":587}];
const MX = 810;
