...
const PAGE = "Safety";
const KPIS = [{"l":"Atletas Registados","v":"3.477","t":"+10.2%","d":"up"},{"l":"Treinos/Semana","v":"4734","t":"+13.2%","d":"up"},{"l":"Competições","v":"5.645","t":"+5.3%","d":"up"},{"l":"Performance Score","v":"87","t":"+8.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","196","2.184","6.935","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.840","7.402","6.525","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.575","378","488","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.114","7.132","5.687","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.956","8.989","158","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":937},{"label":"Fev","value":793},{"label":"Mar","value":718},{"label":"Abr","value":631},{"label":"Mai","value":914},{"label":"Jun","value":919},{"label":"Jul","value":773},{"label":"Ago","value":892},{"label":"Set","value":978},{"label":"Out","value":717},{"label":"Nov","value":857},{"label":"Dez","value":612}];
const MX = 978;
