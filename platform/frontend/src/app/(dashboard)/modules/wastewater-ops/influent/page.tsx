...
const ACCENT = "#475569";
const MODULE = "Wastewater Operations";
const PAGE = "Influent Monitor";
const KPIS = [{"l":"Total Wastewater Ops","v":"7.881","t":"-3.1%","d":"down"},{"l":"Influent Monitor Ativos","v":"5.231","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"76.4%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"70","t":"-3.3%","d":"down"}];
const COLS = ["ID","Influent Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wastewater Ops #001","Wastewater Ops #002","7.045","3.826","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Wastewater Ops #002","Wastewater Ops #003","5.410","518","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Wastewater Ops #003","Wastewater Ops #004","3.086","2.164","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Wastewater Ops #004","Wastewater Ops #005","4.223","8.773","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wastewater Ops #005","Wastewater Ops #001","4.546","6.502","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":370},{"label":"Fev","value":485},{"label":"Mar","value":566},{"label":"Abr","value":671},{"label":"Mai","value":642},{"label":"Jun","value":760},{"label":"Jul","value":737},{"label":"Ago","value":525},{"label":"Set","value":387},{"label":"Out","value":542},{"label":"Nov","value":529},{"label":"Dez","value":686}];
const MX = 760;
...
export default function InfluentPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#475569'}}>IoT</span></h1>
                </div>
