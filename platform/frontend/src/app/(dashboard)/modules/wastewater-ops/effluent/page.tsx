...
const PAGE = "Effluent Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.565","t":"-3.0%","d":"down"},{"l":"NC Abertas","v":"5.678","t":"+7.7%","d":"up"},{"l":"Conformidade (%)","v":"66.6%","t":"+1.5%","d":"up"},{"l":"CAPAs Pendentes","v":"5.690","t":"+4.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.635","95.2%","4.081","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.161","72.5%","6.075","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.925","79.8%","3.398","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.044","78.5%","5.562","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.576","93.1%","1.498","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":950},{"label":"Fev","value":861},{"label":"Mar","value":897},{"label":"Abr","value":587},{"label":"Mai","value":954},{"label":"Jun","value":750},{"label":"Jul","value":818},{"label":"Ago","value":638},{"label":"Set","value":888},{"label":"Out","value":655},{"label":"Nov","value":846},{"label":"Dez","value":733}];
const MX = 954;
