...
const PAGE = "Biosolids";
const KPIS = [{"l":"Total Wastewater Ops","v":"289","t":"+15.2%","d":"up"},{"l":"Biosolids Ativos","v":"1.664","t":"+10.7%","d":"up"},{"l":"Eficiência (%)","v":"89.8%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"75","t":"+2.7%","d":"up"}];
const COLS = ["ID","Biosolids","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wastewater Ops #001","Wastewater Ops #002","6.348","4.390","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Wastewater Ops #002","Wastewater Ops #003","2.650","4.533","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Wastewater Ops #003","Wastewater Ops #004","8.107","4.010","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Wastewater Ops #004","Wastewater Ops #005","1.539","1.405","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wastewater Ops #005","Wastewater Ops #001","1.232","8.361","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":867},{"label":"Fev","value":531},{"label":"Mar","value":586},{"label":"Abr","value":584},{"label":"Mai","value":803},{"label":"Jun","value":680},{"label":"Jul","value":839},{"label":"Ago","value":618},{"label":"Set","value":774},{"label":"Out","value":869},{"label":"Nov","value":607},{"label":"Dez","value":586}];
const MX = 869;
...
export default function BiosolidsPage() {
    return (
