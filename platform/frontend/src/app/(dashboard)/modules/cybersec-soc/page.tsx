...
const KPIS = [
    { label: "Total Registos", value: "6397", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4152", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€160K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "-5%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "991035897", cells: ["CYB-1897", "Cybersecurity SOC Item 1", "6/10/2026", "€35 997"], status: "active" as const },
    { id: "991039468", cells: ["CYB-5468", "Cybersecurity SOC Item 2", "21/5/2026", "€39 568"], status: "pending" as const },
    { id: "991043039", cells: ["CYB-9039", "Cybersecurity SOC Item 3", "8/12/2026", "€43 139"], status: "completed" as const },
    { id: "991046610", cells: ["CYB-3610", "Cybersecurity SOC Item 4", "23/7/2026", "€46 710"], status: "warning" as const },
    { id: "991050181", cells: ["CYB-7181", "Cybersecurity SOC Item 5", "10/2/2026", "€281"], status: "active" as const },
];
...
export default function CybersecuritySocPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cybersecurity SOC</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cybersecurity SOC</p>
                    </div>
                </div>
