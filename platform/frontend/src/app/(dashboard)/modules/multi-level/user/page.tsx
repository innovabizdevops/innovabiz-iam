...
const PAGE = "User";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.928","t":"+5.0%","d":"up"},{"l":"Sessões/Dia","v":"3108","t":"+3.8%","d":"up"},{"l":"MFA Adoção (%)","v":"65.0%","t":"+15.9%","d":"up"},{"l":"Tentativas Bloqueadas","v":"5.914","t":"+3.1%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","7.977","6.191","383","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.669","8.847","7.062","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","1.308","7.825","3.496","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.946","6.499","7.177","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","2.018","2.662","4.834","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":668},{"label":"Mar","value":525},{"label":"Abr","value":745},{"label":"Mai","value":862},{"label":"Jun","value":828},{"label":"Jul","value":846},{"label":"Ago","value":589},{"label":"Set","value":785},{"label":"Out","value":796},{"label":"Nov","value":559},{"label":"Dez","value":842}];
const MX = 862;
