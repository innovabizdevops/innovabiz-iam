...
const ACCENT = "#0ea5e9";
const MODULE = "Multi-Level Access";
const PAGE = "Business Unit";
const KPIS = [{"l":"Total Multi Level","v":"6.055","t":"+2.8%","d":"up"},{"l":"Business Unit Ativos","v":"8.133","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"86.4%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"91","t":"+1.7%","d":"up"}];
const COLS = ["ID","Business Unit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Multi Level #001","Multi Level #002","6.179","1.262","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Multi Level #002","Multi Level #003","4.773","1.472","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Multi Level #003","Multi Level #004","4.961","6.571","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Multi Level #004","Multi Level #005","1.159","7.413","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Multi Level #005","Multi Level #001","7.731","6.645","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":444},{"label":"Mar","value":682},{"label":"Abr","value":746},{"label":"Mai","value":437},{"label":"Jun","value":412},{"label":"Jul","value":416},{"label":"Ago","value":588},{"label":"Set","value":374},{"label":"Out","value":468},{"label":"Nov","value":436},{"label":"Dez","value":741}];
const MX = 746;
