...
const KPIS = [
    { label: "Total Registos", value: "8089", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1749", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€356K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "984533289", cells: ["MUL-6289", "Multi-Level Access Item 1", "6/10/2026", "€33 389"], status: "active" as const },
    { id: "984536860", cells: ["MUL-9860", "Multi-Level Access Item 2", "21/5/2026", "€36 960"], status: "pending" as const },
    { id: "984540431", cells: ["MUL-4431", "Multi-Level Access Item 3", "8/12/2026", "€40 531"], status: "completed" as const },
    { id: "984544002", cells: ["MUL-8002", "Multi-Level Access Item 4", "23/7/2026", "€44 102"], status: "warning" as const },
    { id: "984547573", cells: ["MUL-2573", "Multi-Level Access Item 5", "10/2/2026", "€47 673"], status: "active" as const },
];
...
export default function MultilevelAccessPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Multi-Level Access</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Multi-Level Access</p>
                    </div>
                </div>
