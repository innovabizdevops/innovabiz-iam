...
const PAGE = "Team";
const KPIS = [{"l":"Teams Ativos","v":"208","t":"-2.5%","d":"down"},{"l":"Reuniões/Semana","v":"3907","t":"+5.4%","d":"up"},{"l":"Mensagens/Dia","v":"367","t":"-0.7%","d":"down"},{"l":"Ficheiros Partilhados","v":"4.777","t":"+14.1%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","1.967","3379","366","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","5.028","1095","986","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","1.134","2673","1.582","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.286","2866","7.286","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","6.239","362","7.211","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":482},{"label":"Fev","value":533},{"label":"Mar","value":442},{"label":"Abr","value":374},{"label":"Mai","value":350},{"label":"Jun","value":396},{"label":"Jul","value":326},{"label":"Ago","value":446},{"label":"Set","value":355},{"label":"Out","value":382},{"label":"Nov","value":419},{"label":"Dez","value":462}];
const MX = 533;
