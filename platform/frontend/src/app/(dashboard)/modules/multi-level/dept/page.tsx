...
const KPIS = [{"l":"Total Multi Level","v":"4.914","t":"+2.7%","d":"up"},{"l":"Department Ativos","v":"3.936","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"84.0%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"88","t":"+9.6%","d":"up"}];
const COLS = ["ID","Department","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Multi Level #001","Multi Level #002","3.123","1.048","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Multi Level #002","Multi Level #003","453","7.857","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Multi Level #003","Multi Level #004","6.544","5.344","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Multi Level #004","Multi Level #005","2.002","1.504","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Multi Level #005","Multi Level #001","9.055","3.055","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":638},{"label":"Mar","value":614},{"label":"Abr","value":329},{"label":"Mai","value":668},{"label":"Jun","value":547},{"label":"Jul","value":360},{"label":"Ago","value":577},{"label":"Set","value":630},{"label":"Out","value":689},{"label":"Nov","value":429},{"label":"Dez","value":586}];
const MX = 689;
