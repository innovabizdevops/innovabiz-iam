...
const ACCENT = "#6366f1";
const MODULE = "Specialty Chemicals";
const PAGE = "Regulatory";
const KPIS = [{"l":"Total Specialty Chem","v":"3.970","t":"+12.7%","d":"up"},{"l":"Regulatory Ativos","v":"3.687","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"68.5%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"64","t":"+12.8%","d":"up"}];
const COLS = ["ID","Regulatory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Specialty Chem #001","Specialty Chem #002","161","6.986","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Specialty Chem #002","Specialty Chem #003","2.327","8.208","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Specialty Chem #003","Specialty Chem #004","4.666","7.837","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Specialty Chem #004","Specialty Chem #005","4.195","3.412","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Specialty Chem #005","Specialty Chem #001","8.239","6.176","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":452},{"label":"Fev","value":449},{"label":"Mar","value":636},{"label":"Abr","value":383},{"label":"Mai","value":456},{"label":"Jun","value":488},{"label":"Jul","value":515},{"label":"Ago","value":424},{"label":"Set","value":491},{"label":"Out","value":390},{"label":"Nov","value":321},{"label":"Dez","value":474}];
const MX = 636;
