...
const PAGE = "Custom";
const KPIS = [{"l":"Total Specialty Chem","v":"6.110","t":"+14.2%","d":"up"},{"l":"Custom Ativos","v":"€12242","t":"+9.8%","d":"up"},{"l":"Eficiência (%)","v":"89.5%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"68","t":"+0.2%","d":"up"}];
const COLS = ["ID","Custom","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Specialty Chem #001","€ 19571.42","4.204","8.798","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Specialty Chem #002","€ 13655.10","2.738","8.630","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Specialty Chem #003","€ 10534.76","5.458","131","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Specialty Chem #004","€ 33245.85","4.083","8.517","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Specialty Chem #005","€ 45087.92","426","5.864","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":627},{"label":"Mar","value":551},{"label":"Abr","value":580},{"label":"Mai","value":506},{"label":"Jun","value":618},{"label":"Jul","value":649},{"label":"Ago","value":696},{"label":"Set","value":660},{"label":"Out","value":520},{"label":"Nov","value":655},{"label":"Dez","value":599}];
const MX = 696;
