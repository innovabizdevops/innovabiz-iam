...
const KPIS = [{"l":"Total Specialty Chem","v":"4.435","t":"+10.0%","d":"up"},{"l":"Application Ativos","v":"2.647","t":"+4.4%","d":"up"},{"l":"Eficiência (%)","v":"89.9%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"94","t":"+15.8%","d":"up"}];
const COLS = ["ID","Application","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Specialty Chem #001","Specialty Chem #002","8.923","8.226","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Specialty Chem #002","Specialty Chem #003","3.411","857","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Specialty Chem #003","Specialty Chem #004","4.364","7.790","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Specialty Chem #004","Specialty Chem #005","4.085","9.080","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Specialty Chem #005","Specialty Chem #001","7.834","8.569","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":870},{"label":"Fev","value":734},{"label":"Mar","value":823},{"label":"Abr","value":687},{"label":"Mai","value":874},{"label":"Jun","value":1058},{"label":"Jul","value":687},{"label":"Ago","value":914},{"label":"Set","value":817},{"label":"Out","value":787},{"label":"Nov","value":1026},{"label":"Dez","value":956}];
const MX = 1058;
