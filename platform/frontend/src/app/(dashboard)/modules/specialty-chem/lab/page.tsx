...
const PAGE = "Lab";
const KPIS = [{"l":"Total Specialty Chem","v":"7.064","t":"+6.0%","d":"up"},{"l":"Lab Ativos","v":"3.373","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"68.9%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"83","t":"+3.6%","d":"up"}];
const COLS = ["ID","Lab","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Specialty Chem #001","Specialty Chem #002","6.133","3.252","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Specialty Chem #002","Specialty Chem #003","4.230","1.734","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Specialty Chem #003","Specialty Chem #004","8.060","2.508","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Specialty Chem #004","Specialty Chem #005","5.588","2.244","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Specialty Chem #005","Specialty Chem #001","7.794","2.630","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":368},{"label":"Mar","value":443},{"label":"Abr","value":738},{"label":"Mai","value":550},{"label":"Jun","value":467},{"label":"Jul","value":751},{"label":"Ago","value":529},{"label":"Set","value":499},{"label":"Out","value":528},{"label":"Nov","value":605},{"label":"Dez","value":467}];
const MX = 751;
