...
const PAGE = "Formulation";
const KPIS = [{"l":"Formulários Ativos","v":"8.754","t":"+4.9%","d":"up"},{"l":"Submissões/Dia","v":"4846","t":"-1.6%","d":"down"},{"l":"Documentos Gerados","v":"542","t":"+7.9%","d":"up"},{"l":"Templates","v":"4.620","t":"+15.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.041","2026-01-14","842","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.463","2026-01-17","405","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.712","2026-02-13","3.717","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.545","2026-03-11","1.388","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.813","2026-03-23","556","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":638},{"label":"Mar","value":798},{"label":"Abr","value":790},{"label":"Mai","value":755},{"label":"Jun","value":748},{"label":"Jul","value":828},{"label":"Ago","value":825},{"label":"Set","value":676},{"label":"Out","value":625},{"label":"Nov","value":642},{"label":"Dez","value":770}];
const MX = 828;
