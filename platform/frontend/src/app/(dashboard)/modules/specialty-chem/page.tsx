...
export default function SpecialtyChemPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Specialty Chem</h1><p className="text-sm text-muted-foreground">Specialty Chem • iBOS Enterprise</p></div>
