...
/* ═══ Paper Mill — Maintenance Paper ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "4128", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "179", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3173", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "233309167", cells: ["PAP-3167", "Maintenance Paper Item 1", "8/8/2026", "€9267"], status: "active" as const },
    { id: "233312738", cells: ["PAP-6738", "Maintenance Paper Item 2", "23/3/2026", "€12 838"], status: "pending" as const },
    { id: "233316309", cells: ["PAP-1309", "Maintenance Paper Item 3", "10/10/2026", "€16 409"], status: "completed" as const },
    { id: "233319880", cells: ["PAP-4880", "Maintenance Paper Item 4", "25/5/2026", "€19 980"], status: "warning" as const },
    { id: "233323451", cells: ["PAP-8451", "Maintenance Paper Item 5", "12/12/2026", "€23 551"], status: "active" as const },
];
...
export default function PaperMillMaintenancePaperPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Maintenance Paper</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Paper Mill • Maintenance Paper</p>
                    </div>
                </div>
