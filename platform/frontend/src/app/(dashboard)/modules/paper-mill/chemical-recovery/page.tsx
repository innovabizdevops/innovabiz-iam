...
const KPIS = [
    { label: "Total", value: "3009", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "257", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1949", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "893235757", cells: ["PAP-4757", "Chemical Recovery Item 1", "2/2/2026", "€35 857"], status: "active" as const },
    { id: "893239328", cells: ["PAP-8328", "Chemical Recovery Item 2", "17/9/2026", "€39 428"], status: "pending" as const },
    { id: "893242899", cells: ["PAP-2899", "Chemical Recovery Item 3", "4/4/2026", "€42 999"], status: "completed" as const },
    { id: "893246470", cells: ["PAP-6470", "Chemical Recovery Item 4", "19/11/2026", "€46 570"], status: "warning" as const },
    { id: "893250041", cells: ["PAP-1041", "Chemical Recovery Item 5", "6/6/2026", "€141"], status: "active" as const },
];
...
export default function PaperMillChemicalRecoveryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Chemical Recovery</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Paper Mill • Chemical Recovery</p>
                    </div>
                </div>
