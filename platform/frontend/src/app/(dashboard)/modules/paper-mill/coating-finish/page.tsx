...
/* ═══ Paper Mill — Coating Finish ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "4135", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "356", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3191", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "319231424", cells: ["PAP-2424", "Coating Finish Item 1", "9/9/2026", "€31 524"], status: "active" as const },
    { id: "319234995", cells: ["PAP-5995", "Coating Finish Item 2", "24/4/2026", "€35 095"], status: "pending" as const },
    { id: "319238566", cells: ["PAP-9566", "Coating Finish Item 3", "11/11/2026", "€38 666"], status: "completed" as const },
    { id: "319242137", cells: ["PAP-4137", "Coating Finish Item 4", "26/6/2026", "€42 237"], status: "warning" as const },
    { id: "319245708", cells: ["PAP-7708", "Coating Finish Item 5", "13/1/2026", "€45 808"], status: "active" as const },
];
...
export default function PaperMillCoatingFinishPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Coating Finish</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Paper Mill • Coating Finish</p>
                    </div>
                </div>
