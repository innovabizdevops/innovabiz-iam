...
/* ═══ Paper Mill — Pulp Process ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "3285", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "156", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "453", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "567971752", cells: ["PAP-9752", "Pulp Process Item 1", "13/5/2026", "€21 852"], status: "active" as const },
    { id: "567975323", cells: ["PAP-4323", "Pulp Process Item 2", "28/12/2026", "€25 423"], status: "pending" as const },
    { id: "567978894", cells: ["PAP-7894", "Pulp Process Item 3", "15/7/2026", "€28 994"], status: "completed" as const },
    { id: "567982465", cells: ["PAP-2465", "Pulp Process Item 4", "2/2/2026", "€32 565"], status: "warning" as const },
    { id: "567986036", cells: ["PAP-6036", "Pulp Process Item 5", "17/9/2026", "€36 136"], status: "active" as const },
];
...
export default function PaperMillPulpProcessPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pulp Process</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Paper Mill • Pulp Process</p>
                    </div>
                </div>
