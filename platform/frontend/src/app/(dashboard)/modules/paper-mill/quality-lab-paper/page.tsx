...
/* ═══ Paper Mill — Quality Lab Paper ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "3674", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "156", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2124", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "792231704", cells: ["PAP-7704", "Quality Lab Paper Item 1", "13/9/2026", "€31 804"], status: "active" as const },
    { id: "792235275", cells: ["PAP-2275", "Quality Lab Paper Item 2", "28/4/2026", "€35 375"], status: "pending" as const },
    { id: "792238846", cells: ["PAP-5846", "Quality Lab Paper Item 3", "15/11/2026", "€38 946"], status: "completed" as const },
    { id: "792242417", cells: ["PAP-9417", "Quality Lab Paper Item 4", "2/6/2026", "€42 517"], status: "warning" as const },
    { id: "792245988", cells: ["PAP-3988", "Quality Lab Paper Item 5", "17/1/2026", "€46 088"], status: "active" as const },
];
...
export default function PaperMillQualityLabPaperPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Quality Lab Paper</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Paper Mill • Quality Lab Paper</p>
                    </div>
                </div>
