...
/* ═══ Paper Mill — Order Fulfill Paper ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "755", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "14", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "250", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "79%", trend: "-25%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1341120042", cells: ["PAP-4042", "Order Fulfill Paper Item 1", "11/7/2026", "€20 142"], status: "active" as const },
    { id: "1341123613", cells: ["PAP-7613", "Order Fulfill Paper Item 2", "26/2/2026", "€23 713"], status: "pending" as const },
    { id: "1341127184", cells: ["PAP-2184", "Order Fulfill Paper Item 3", "13/9/2026", "€27 284"], status: "completed" as const },
    { id: "1341130755", cells: ["PAP-5755", "Order Fulfill Paper Item 4", "28/4/2026", "€30 855"], status: "warning" as const },
    { id: "1341134326", cells: ["PAP-9326", "Order Fulfill Paper Item 5", "15/11/2026", "€34 426"], status: "active" as const },
];
...
export default function PaperMillOrderFulfillPaperPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Order Fulfill Paper</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Paper Mill • Order Fulfill Paper</p>
                    </div>
                </div>
