...
/* ═══ Paper Mill — Paper Machine ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "966", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "81", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1472", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1702143133", cells: ["PAP-1133", "Paper Machine Item 1", "6/2/2026", "€43 233"], status: "active" as const },
    { id: "1702146704", cells: ["PAP-4704", "Paper Machine Item 2", "21/9/2026", "€46 804"], status: "pending" as const },
    { id: "1702150275", cells: ["PAP-8275", "Paper Machine Item 3", "8/4/2026", "€375"], status: "completed" as const },
    { id: "1702153846", cells: ["PAP-2846", "Paper Machine Item 4", "23/11/2026", "€3946"], status: "warning" as const },
    { id: "1702157417", cells: ["PAP-6417", "Paper Machine Item 5", "10/6/2026", "€7517"], status: "active" as const },
];
...
export default function PaperMillPaperMachinePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Paper Machine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Paper Mill • Paper Machine</p>
                    </div>
                </div>
