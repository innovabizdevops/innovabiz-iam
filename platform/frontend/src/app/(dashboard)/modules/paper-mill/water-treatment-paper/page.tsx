...
/* ═══ Paper Mill — Water Treatment Paper ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "2699", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "127", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2089", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "86%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "2080566379", cells: ["PAP-1379", "Water Treatment Paper Item 1", "4/8/2026", "€16 479"], status: "active" as const },
    { id: "2080569950", cells: ["PAP-4950", "Water Treatment Paper Item 2", "19/3/2026", "€20 050"], status: "pending" as const },
    { id: "2080573521", cells: ["PAP-8521", "Water Treatment Paper Item 3", "6/10/2026", "€23 621"], status: "completed" as const },
    { id: "2080577092", cells: ["PAP-3092", "Water Treatment Paper Item 4", "21/5/2026", "€27 192"], status: "warning" as const },
    { id: "2080580663", cells: ["PAP-6663", "Water Treatment Paper Item 5", "8/12/2026", "€30 763"], status: "active" as const },
];
...
export default function PaperMillWaterTreatmentPaperPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Water Treatment Paper</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Paper Mill • Water Treatment Paper</p>
                    </div>
                </div>
