...
/* ═══ Paper Mill — Energy Cogen ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "833", trend: "-5%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "56", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3733", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "276999204", cells: ["PAP-7204", "Energy Cogen Item 1", "21/1/2026", "€49 304"], status: "active" as const },
    { id: "277002775", cells: ["PAP-1775", "Energy Cogen Item 2", "8/8/2026", "€2875"], status: "pending" as const },
    { id: "277006346", cells: ["PAP-5346", "Energy Cogen Item 3", "23/3/2026", "€6446"], status: "completed" as const },
    { id: "277009917", cells: ["PAP-8917", "Energy Cogen Item 4", "10/10/2026", "€10 017"], status: "warning" as const },
    { id: "277013488", cells: ["PAP-3488", "Energy Cogen Item 5", "25/5/2026", "€13 588"], status: "active" as const },
];
...
export default function PaperMillEnergyCogenPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Energy Cogen</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Paper Mill • Energy Cogen</p>
                    </div>
                </div>
