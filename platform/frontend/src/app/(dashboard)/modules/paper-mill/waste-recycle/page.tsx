...
/* ═══ Paper Mill — Waste Recycle ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "3928", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "455", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "598", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1224946371", cells: ["PAP-2371", "Waste Recycle Item 1", "20/4/2026", "€46 471"], status: "active" as const },
    { id: "1224949942", cells: ["PAP-5942", "Waste Recycle Item 2", "7/11/2026", "€50 042"], status: "pending" as const },
    { id: "1224953513", cells: ["PAP-9513", "Waste Recycle Item 3", "22/6/2026", "€3613"], status: "completed" as const },
    { id: "1224957084", cells: ["PAP-4084", "Waste Recycle Item 4", "9/1/2026", "€7184"], status: "warning" as const },
    { id: "1224960655", cells: ["PAP-7655", "Waste Recycle Item 5", "24/8/2026", "€10 755"], status: "active" as const },
];
...
export default function PaperMillWasteRecyclePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Waste Recycle</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Paper Mill • Waste Recycle</p>
                    </div>
                </div>
