...
const PAGE = "Pay";
const KPIS = [{"l":"Total Invoice Processing","v":"3.782","t":"-1.7%","d":"down"},{"l":"Pay Ativos","v":"7.801","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"75.4%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"88","t":"+14.0%","d":"up"}];
const COLS = ["ID","Pay","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Invoice Processing #001","Invoice Processing #002","5.214","8.143","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Invoice Processing #002","Invoice Processing #003","8.494","7.458","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Invoice Processing #003","Invoice Processing #004","909","4.756","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Invoice Processing #004","Invoice Processing #005","4.433","7.099","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Invoice Processing #005","Invoice Processing #001","8.145","7.132","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":630},{"label":"Mar","value":483},{"label":"Abr","value":502},{"label":"Mai","value":615},{"label":"Jun","value":775},{"label":"Jul","value":525},{"label":"Ago","value":592},{"label":"Set","value":411},{"label":"Out","value":527},{"label":"Nov","value":459},{"label":"Dez","value":627}];
const MX = 775;
