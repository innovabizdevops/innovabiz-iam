...
const PAGE = "Match";
const KPIS = [{"l":"Atletas Registados","v":"1.337","t":"+2.2%","d":"up"},{"l":"Treinos/Semana","v":"1822","t":"-4.5%","d":"down"},{"l":"Competições","v":"2.909","t":"+14.3%","d":"up"},{"l":"Performance Score","v":"59","t":"-2.2%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.403","7.424","1.076","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.777","385","7.012","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.721","5.192","9.018","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","580","1.371","7.002","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.905","6.154","5.191","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":415},{"label":"Fev","value":737},{"label":"Mar","value":431},{"label":"Abr","value":420},{"label":"Mai","value":709},{"label":"Jun","value":600},{"label":"Jul","value":579},{"label":"Ago","value":671},{"label":"Set","value":744},{"label":"Out","value":427},{"label":"Nov","value":634},{"label":"Dez","value":471}];
const MX = 744;
