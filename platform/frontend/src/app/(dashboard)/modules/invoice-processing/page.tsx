...
/* ═══ Invoice Processing (AP) — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "630", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "946", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€119K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1233203930", cells: ["INV-6930", "Invoice Processing (AP) Item 1", "15/3/2026", "€4030"], status: "active" as const },
    { id: "1233207501", cells: ["INV-1501", "Invoice Processing (AP) Item 2", "2/10/2026", "€7601"], status: "pending" as const },
    { id: "1233211072", cells: ["INV-5072", "Invoice Processing (AP) Item 3", "17/5/2026", "€11 172"], status: "completed" as const },
    { id: "1233214643", cells: ["INV-8643", "Invoice Processing (AP) Item 4", "4/12/2026", "€14 743"], status: "warning" as const },
    { id: "1233218214", cells: ["INV-3214", "Invoice Processing (AP) Item 5", "19/7/2026", "€18 314"], status: "active" as const },
];
...
export default function InvoiceProcessingApPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Invoice Processing (AP)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Invoice Processing (AP)</p>
                    </div>
                </div>
