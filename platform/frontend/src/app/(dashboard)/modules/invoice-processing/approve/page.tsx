...
const PAGE = "Approve";
const KPIS = [{"l":"Aprovações Pendentes","v":"1.208","t":"+2.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"69.4%","t":"-5.5%","d":"down"},{"l":"Tempo Médio (h)","v":"124h","t":"+14.6%","d":"up"},{"l":"Rejeitadas (%)","v":"67.7%","t":"+13.5%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","5.308","€ 47411.30","9.097","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","6.078","€ 48246.09","8.271","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","7.109","€ 21179.59","8.785","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","8.272","€ 2085.07","8.036","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","1.024","€ 2709.65","2.846","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":302},{"label":"Fev","value":341},{"label":"Mar","value":354},{"label":"Abr","value":511},{"label":"Mai","value":412},{"label":"Jun","value":519},{"label":"Jul","value":569},{"label":"Ago","value":410},{"label":"Set","value":416},{"label":"Out","value":302},{"label":"Nov","value":673},{"label":"Dez","value":575}];
const MX = 673;
