...
/* ═══ Media Ops — Syndication ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "3834", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "297", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2279", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1698340517", cells: ["MED-5517", "Syndication Item 1", "14/6/2026", "€40 617"], status: "active" as const },
    { id: "1698344088", cells: ["MED-9088", "Syndication Item 2", "1/1/2026", "€44 188"], status: "pending" as const },
    { id: "1698347659", cells: ["MED-3659", "Syndication Item 3", "16/8/2026", "€47 759"], status: "completed" as const },
    { id: "1698351230", cells: ["MED-7230", "Syndication Item 4", "3/3/2026", "€1330"], status: "warning" as const },
    { id: "1698354801", cells: ["MED-1801", "Syndication Item 5", "18/10/2026", "€4901"], status: "active" as const },
];
...
export default function MediaOpsSyndicationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Syndication</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Media Ops • Syndication</p>
                    </div>
                </div>
