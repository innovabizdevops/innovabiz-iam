...
/* ═══ Media Ops — Workflow Publish ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "1027", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "498", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2733", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "759997006", cells: ["MED-2006", "Workflow Publish Item 1", "7/11/2026", "€47 106"], status: "active" as const },
    { id: "760000577", cells: ["MED-5577", "Workflow Publish Item 2", "22/6/2026", "€677"], status: "pending" as const },
    { id: "760004148", cells: ["MED-9148", "Workflow Publish Item 3", "9/1/2026", "€4248"], status: "completed" as const },
    { id: "760007719", cells: ["MED-3719", "Workflow Publish Item 4", "24/8/2026", "€7819"], status: "warning" as const },
    { id: "760011290", cells: ["MED-7290", "Workflow Publish Item 5", "11/3/2026", "€11 390"], status: "active" as const },
];
...
export default function MediaOpsWorkflowPublishPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Workflow Publish</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Media Ops • Workflow Publish</p>
                    </div>
                </div>
