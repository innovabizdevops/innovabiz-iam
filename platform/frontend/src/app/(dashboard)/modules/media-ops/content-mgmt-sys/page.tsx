...
/* ═══ Media Ops — Content Mgmt Sys ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "4625", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "475", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1997", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1993370919", cells: ["MED-6919", "Content Mgmt Sys Item 1", "16/4/2026", "€21 019"], status: "active" as const },
    { id: "1993374490", cells: ["MED-1490", "Content Mgmt Sys Item 2", "3/11/2026", "€24 590"], status: "pending" as const },
    { id: "1993378061", cells: ["MED-5061", "Content Mgmt Sys Item 3", "18/6/2026", "€28 161"], status: "completed" as const },
    { id: "1993381632", cells: ["MED-8632", "Content Mgmt Sys Item 4", "5/1/2026", "€31 732"], status: "warning" as const },
    { id: "1993385203", cells: ["MED-3203", "Content Mgmt Sys Item 5", "20/8/2026", "€35 303"], status: "active" as const },
];
...
export default function MediaOpsContentMgmtSysPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Content Mgmt Sys</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Media Ops • Content Mgmt Sys</p>
                    </div>
                </div>
