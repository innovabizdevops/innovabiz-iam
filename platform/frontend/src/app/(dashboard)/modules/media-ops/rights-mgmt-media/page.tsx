...
/* ═══ Media Ops — Rights Mgmt Media ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "4237", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "218", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2509", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1684344310", cells: ["MED-4310", "Rights Mgmt Media Item 1", "27/11/2026", "€44 410"], status: "active" as const },
    { id: "1684347881", cells: ["MED-7881", "Rights Mgmt Media Item 2", "14/6/2026", "€47 981"], status: "pending" as const },
    { id: "1684351452", cells: ["MED-2452", "Rights Mgmt Media Item 3", "1/1/2026", "€1552"], status: "completed" as const },
    { id: "1684355023", cells: ["MED-6023", "Rights Mgmt Media Item 4", "16/8/2026", "€5123"], status: "warning" as const },
    { id: "1684358594", cells: ["MED-9594", "Rights Mgmt Media Item 5", "3/3/2026", "€8694"], status: "active" as const },
];
...
export default function MediaOpsRightsMgmtMediaPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Rights Mgmt Media</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Media Ops • Rights Mgmt Media</p>
                    </div>
                </div>
