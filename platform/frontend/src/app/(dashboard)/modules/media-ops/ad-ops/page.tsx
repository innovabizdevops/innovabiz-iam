...
const KPIS = [
    { label: "Total", value: "748", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "43", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "960", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "663484871", cells: ["MED-5871", "Ad Ops Item 1", "8/12/2026", "€34 971"], status: "active" as const },
    { id: "663488442", cells: ["MED-9442", "Ad Ops Item 2", "23/7/2026", "€38 542"], status: "pending" as const },
    { id: "663492013", cells: ["MED-4013", "Ad Ops Item 3", "10/2/2026", "€42 113"], status: "completed" as const },
    { id: "663495584", cells: ["MED-7584", "Ad Ops Item 4", "25/9/2026", "€45 684"], status: "warning" as const },
    { id: "663499155", cells: ["MED-2155", "Ad Ops Item 5", "12/4/2026", "€49 255"], status: "active" as const },
];
...
export default function MediaOpsAdOpsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ad Ops</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Media Ops • Ad Ops</p>
                    </div>
                </div>
