...
/* ═══ Media Ops — Translation Loc ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "3196", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "375", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "226", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "791220083", cells: ["MED-4083", "Translation Loc Item 1", "4/12/2026", "€20 183"], status: "active" as const },
    { id: "791223654", cells: ["MED-7654", "Translation Loc Item 2", "19/7/2026", "€23 754"], status: "pending" as const },
    { id: "791227225", cells: ["MED-2225", "Translation Loc Item 3", "6/2/2026", "€27 325"], status: "completed" as const },
    { id: "791230796", cells: ["MED-5796", "Translation Loc Item 4", "21/9/2026", "€30 896"], status: "warning" as const },
    { id: "791234367", cells: ["MED-9367", "Translation Loc Item 5", "8/4/2026", "€34 467"], status: "active" as const },
];
...
export default function MediaOpsTranslationLocPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Translation Loc</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Media Ops • Translation Loc</p>
                    </div>
                </div>
