...
/* ═══ Media Ops — Programmatic ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "2466", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "458", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3336", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1764113254", cells: ["MED-6254", "Programmatic Item 1", "23/11/2026", "€13 354"], status: "active" as const },
    { id: "1764116825", cells: ["MED-9825", "Programmatic Item 2", "10/6/2026", "€16 925"], status: "pending" as const },
    { id: "1764120396", cells: ["MED-4396", "Programmatic Item 3", "25/1/2026", "€20 496"], status: "completed" as const },
    { id: "1764123967", cells: ["MED-7967", "Programmatic Item 4", "12/8/2026", "€24 067"], status: "warning" as const },
    { id: "1764127538", cells: ["MED-2538", "Programmatic Item 5", "27/3/2026", "€27 638"], status: "active" as const },
];
...
export default function MediaOpsProgrammaticPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Programmatic</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Media Ops • Programmatic</p>
                    </div>
                </div>
