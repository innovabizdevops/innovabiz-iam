...
/* ═══ Media Ops — Asset Library ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "3355", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "493", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1437", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "92%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1387560505", cells: ["MED-4505", "Asset Library Item 1", "10/2/2026", "€10 605"], status: "active" as const },
    { id: "1387564076", cells: ["MED-8076", "Asset Library Item 2", "25/9/2026", "€14 176"], status: "pending" as const },
    { id: "1387567647", cells: ["MED-2647", "Asset Library Item 3", "12/4/2026", "€17 747"], status: "completed" as const },
    { id: "1387571218", cells: ["MED-6218", "Asset Library Item 4", "27/11/2026", "€21 318"], status: "warning" as const },
    { id: "1387574789", cells: ["MED-9789", "Asset Library Item 5", "14/6/2026", "€24 889"], status: "active" as const },
];
...
export default function MediaOpsAssetLibraryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Asset Library</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Media Ops • Asset Library</p>
                    </div>
                </div>
