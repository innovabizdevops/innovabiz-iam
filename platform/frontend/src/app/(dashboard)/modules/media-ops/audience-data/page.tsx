...
/* ═══ Media Ops — Audience Data ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "4322", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "34", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2049", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2127807806", cells: ["MED-1806", "Audience Data Item 1", "27/3/2026", "€7906"], status: "active" as const },
    { id: "2127811377", cells: ["MED-5377", "Audience Data Item 2", "14/10/2026", "€11 477"], status: "pending" as const },
    { id: "2127814948", cells: ["MED-8948", "Audience Data Item 3", "1/5/2026", "€15 048"], status: "completed" as const },
    { id: "2127818519", cells: ["MED-3519", "Audience Data Item 4", "16/12/2026", "€18 619"], status: "warning" as const },
    { id: "2127822090", cells: ["MED-7090", "Audience Data Item 5", "3/7/2026", "€22 190"], status: "active" as const },
];
...
export default function MediaOpsAudienceDataPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Audience Data</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Media Ops • Audience Data</p>
                    </div>
                </div>
