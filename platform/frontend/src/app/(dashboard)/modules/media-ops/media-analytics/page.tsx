...
/* ═══ Media Ops — Media Analytics ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "4648", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "318", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2143", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "413218426", cells: ["MED-2426", "Media Analytics Item 1", "27/11/2026", "€18 526"], status: "active" as const },
    { id: "413221997", cells: ["MED-5997", "Media Analytics Item 2", "14/6/2026", "€22 097"], status: "pending" as const },
    { id: "413225568", cells: ["MED-9568", "Media Analytics Item 3", "1/1/2026", "€25 668"], status: "completed" as const },
    { id: "413229139", cells: ["MED-4139", "Media Analytics Item 4", "16/8/2026", "€29 239"], status: "warning" as const },
    { id: "413232710", cells: ["MED-7710", "Media Analytics Item 5", "3/3/2026", "€32 810"], status: "active" as const },
];
...
export default function MediaOpsMediaAnalyticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Media Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Media Ops • Media Analytics</p>
                    </div>
                </div>
