...
const KPIS = [
    { label: "Total Registos", value: "4277", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1542", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€158K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1301299777", cells: ["DEM-8777", "Demand Generation Item 1", "2/2/2026", "€49 877"], status: "active" as const },
    { id: "1301303348", cells: ["DEM-3348", "Demand Generation Item 2", "17/9/2026", "€3448"], status: "pending" as const },
    { id: "1301306919", cells: ["DEM-6919", "Demand Generation Item 3", "4/4/2026", "€7019"], status: "completed" as const },
    { id: "1301310490", cells: ["DEM-1490", "Demand Generation Item 4", "19/11/2026", "€10 590"], status: "warning" as const },
    { id: "1301314061", cells: ["DEM-5061", "Demand Generation Item 5", "6/6/2026", "€14 161"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Demand Generation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Demand Generation</p>
                    </div>
                </div>
