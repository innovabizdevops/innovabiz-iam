...
const PAGE = "Score";
const KPIS = [{"l":"Total Demand Generation","v":"2.661","t":"+6.9%","d":"up"},{"l":"Score Ativos","v":"62","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"91.7%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"86","t":"+15.5%","d":"up"}];
const COLS = ["ID","Score","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Demand Generation #001","89.7%","2.073","5.010","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Demand Generation #002","94.9%","8.543","7.249","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Demand Generation #003","72.9%","3.233","8.824","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Demand Generation #004","98.1%","8.945","3.571","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Demand Generation #005","74.0%","3.293","4.970","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":367},{"label":"Fev","value":363},{"label":"Mar","value":374},{"label":"Abr","value":647},{"label":"Mai","value":508},{"label":"Jun","value":320},{"label":"Jul","value":577},{"label":"Ago","value":536},{"label":"Set","value":328},{"label":"Out","value":507},{"label":"Nov","value":302},{"label":"Dez","value":696}];
const MX = 696;
