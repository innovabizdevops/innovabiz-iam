...
const PAGE = "Nurture";
const KPIS = [{"l":"Total Demand Generation","v":"9.035","t":"+5.8%","d":"up"},{"l":"Nurture Ativos","v":"7.428","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"87.2%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"80","t":"+12.5%","d":"up"}];
const COLS = ["ID","Nurture","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Demand Generation #001","Demand Generation #002","2.296","2.540","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Demand Generation #002","Demand Generation #003","889","3.163","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Demand Generation #003","Demand Generation #004","4.329","8.596","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Demand Generation #004","Demand Generation #005","6.700","928","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Demand Generation #005","Demand Generation #001","6.806","8.155","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":891},{"label":"Mar","value":597},{"label":"Abr","value":747},{"label":"Mai","value":638},{"label":"Jun","value":911},{"label":"Jul","value":850},{"label":"Ago","value":828},{"label":"Set","value":670},{"label":"Out","value":569},{"label":"Nov","value":803},{"label":"Dez","value":759}];
const MX = 911;
