...
const PAGE = "Adverse Media";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.916","t":"+3.7%","d":"up"},{"l":"NC Abertas","v":"1.693","t":"+3.4%","d":"up"},{"l":"Conformidade (%)","v":"70.8%","t":"+2.0%","d":"up"},{"l":"CAPAs Pendentes","v":"6.701","t":"+16.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.321","98.1%","2.822","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.386","79.3%","6.922","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.021","81.5%","5.368","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.014","91.7%","2.089","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","109","95.6%","1.132","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":865},{"label":"Mar","value":709},{"label":"Abr","value":682},{"label":"Mai","value":918},{"label":"Jun","value":589},{"label":"Jul","value":952},{"label":"Ago","value":890},{"label":"Set","value":657},{"label":"Out","value":869},{"label":"Nov","value":708},{"label":"Dez","value":828}];
const MX = 952;
