...
const ACCENT = "#dc2626";
const MODULE = "AML Compliance";
const PAGE = "Transaction Mon";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.835","t":"+16.9%","d":"up"},{"l":"NC Abertas","v":"2.426","t":"-2.2%","d":"down"},{"l":"Conformidade (%)","v":"68.7%","t":"+2.1%","d":"up"},{"l":"CAPAs Pendentes","v":"3.282","t":"+11.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","970","72.9%","2.374","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","938","82.1%","4.817","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.778","88.9%","2.978","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.408","93.4%","3.972","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.245","97.2%","4.211","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":238},{"label":"Fev","value":535},{"label":"Mar","value":307},{"label":"Abr","value":564},{"label":"Mai","value":307},{"label":"Jun","value":473},{"label":"Jul","value":541},{"label":"Ago","value":423},{"label":"Set","value":468},{"label":"Out","value":545},{"label":"Nov","value":386},{"label":"Dez","value":501}];
const MX = 564;
