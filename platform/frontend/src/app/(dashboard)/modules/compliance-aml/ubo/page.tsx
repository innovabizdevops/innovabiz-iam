...
const PAGE = "UBO Disclosure";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.198","t":"+1.6%","d":"up"},{"l":"NC Abertas","v":"8.341","t":"-1.3%","d":"down"},{"l":"Conformidade (%)","v":"87.0%","t":"-5.9%","d":"down"},{"l":"CAPAs Pendentes","v":"5.001","t":"+0.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.483","87.0%","7.486","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.607","70.7%","1.208","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.220","93.9%","4.303","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.302","72.3%","798","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.542","85.0%","567","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":881},{"label":"Mar","value":1010},{"label":"Abr","value":996},{"label":"Mai","value":634},{"label":"Jun","value":1008},{"label":"Jul","value":983},{"label":"Ago","value":763},{"label":"Set","value":672},{"label":"Out","value":644},{"label":"Nov","value":680},{"label":"Dez","value":959}];
const MX = 1010;
