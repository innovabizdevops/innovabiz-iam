...
const KPIS = [{"l":"Total Game Economy","v":"680","t":"-2.6%","d":"down"},{"l":"Anti Cheat Ativos","v":"2.244","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"92.4%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"77","t":"-4.5%","d":"down"}];
const COLS = ["ID","Anti Cheat","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Game Economy #001","Game Economy #002","4.269","7.699","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Game Economy #002","Game Economy #003","6.758","3.480","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Game Economy #003","Game Economy #004","2.839","8.516","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Game Economy #004","Game Economy #005","1.796","6.586","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Game Economy #005","Game Economy #001","4.154","8.989","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":608},{"label":"Mar","value":615},{"label":"Abr","value":559},{"label":"Mai","value":685},{"label":"Jun","value":772},{"label":"Jul","value":633},{"label":"Ago","value":588},{"label":"Set","value":841},{"label":"Out","value":778},{"label":"Nov","value":617},{"label":"Dez","value":508}];
const MX = 841;
