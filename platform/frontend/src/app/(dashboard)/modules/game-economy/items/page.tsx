...
const PAGE = "Item Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"2.931","t":"-2.0%","d":"down"},{"l":"Queries/Dia","v":"2004","t":"-3.7%","d":"down"},{"l":"Dados Processados (GB)","v":"2.521","t":"+15.7%","d":"up"},{"l":"Utilizadores Analytics","v":"6.819","t":"+14.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3425","2026-01-23","4.720","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3622","2026-02-18","8.300","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2695","2026-02-25","551","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1798","2026-02-11","1.705","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3370","2026-02-06","336","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":718},{"label":"Fev","value":701},{"label":"Mar","value":1006},{"label":"Abr","value":700},{"label":"Mai","value":859},{"label":"Jun","value":899},{"label":"Jul","value":687},{"label":"Ago","value":709},{"label":"Set","value":707},{"label":"Out","value":911},{"label":"Nov","value":807},{"label":"Dez","value":897}];
const MX = 1006;
