...
const KPIS = [{"l":"Total Game Economy","v":"2.891","t":"+16.6%","d":"up"},{"l":"Fraud Detect Ativos","v":"291","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"81.5%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"64","t":"+17.1%","d":"up"}];
const COLS = ["ID","Fraud Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Game Economy #001","Game Economy #002","8.265","4.584","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Game Economy #002","Game Economy #003","2.125","2.526","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Game Economy #003","Game Economy #004","8.548","1.548","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Game Economy #004","Game Economy #005","8.163","2.412","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Game Economy #005","Game Economy #001","1.471","2.764","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":590},{"label":"Mar","value":442},{"label":"Abr","value":508},{"label":"Mai","value":500},{"label":"Jun","value":329},{"label":"Jul","value":396},{"label":"Ago","value":383},{"label":"Set","value":382},{"label":"Out","value":207},{"label":"Nov","value":460},{"label":"Dez","value":383}];
const MX = 590;
