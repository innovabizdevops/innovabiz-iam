...
const PAGE = "Virtual Currency";
const KPIS = [{"l":"Total Game Economy","v":"178","t":"+15.0%","d":"up"},{"l":"Virtual Currency Ativos","v":"5.788","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"66.1%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"73","t":"+15.2%","d":"up"}];
const COLS = ["ID","Virtual Currency","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Game Economy #001","Game Economy #002","4.109","4.975","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Game Economy #002","Game Economy #003","721","5.314","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Game Economy #003","Game Economy #004","8.410","2.279","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Game Economy #004","Game Economy #005","3.034","6.776","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Game Economy #005","Game Economy #001","1.006","1.099","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":786},{"label":"Mar","value":670},{"label":"Abr","value":801},{"label":"Mai","value":431},{"label":"Jun","value":762},{"label":"Jul","value":502},{"label":"Ago","value":633},{"label":"Set","value":526},{"label":"Out","value":640},{"label":"Nov","value":528},{"label":"Dez","value":827}];
const MX = 827;
