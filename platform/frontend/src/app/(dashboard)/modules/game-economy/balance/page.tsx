...
const ACCENT = "#b45309";
const MODULE = "Game Economy";
const PAGE = "Balance Sim";
const KPIS = [{"l":"Total Game Economy","v":"6.763","t":"+13.8%","d":"up"},{"l":"Balance Sim Ativos","v":"1.288","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"78.1%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"80","t":"+12.7%","d":"up"}];
const COLS = ["ID","Balance Sim","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Game Economy #001","Game Economy #002","6.289","8.597","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Game Economy #002","Game Economy #003","7.039","7.641","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Game Economy #003","Game Economy #004","6.739","4.836","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Game Economy #004","Game Economy #005","4.038","3.496","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Game Economy #005","Game Economy #001","8.410","4.685","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":743},{"label":"Mar","value":678},{"label":"Abr","value":577},{"label":"Mai","value":546},{"label":"Jun","value":651},{"label":"Jul","value":397},{"label":"Ago","value":708},{"label":"Set","value":714},{"label":"Out","value":470},{"label":"Nov","value":519},{"label":"Dez","value":373}];
const MX = 743;
