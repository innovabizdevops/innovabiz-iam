...
export default function GameEconomyPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Game Economy</h1><p className="text-sm text-muted-foreground">Game Economy • iBOS Enterprise</p></div>
