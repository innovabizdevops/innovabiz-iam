...
const ACCENT = "#6366f1";
const MODULE = "Platform Management";
const PAGE = "API Management";
const KPIS = [{"l":"Formulários Ativos","v":"980","t":"+5.1%","d":"up"},{"l":"Submissões/Dia","v":"869","t":"+0.9%","d":"up"},{"l":"Documentos Gerados","v":"8.445","t":"+16.4%","d":"up"},{"l":"Templates","v":"4.662","t":"+6.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.672","2026-02-15","6.857","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.540","2026-02-13","2.943","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.701","2026-02-26","9.044","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.888","2026-01-04","2.966","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.308","2026-03-08","2.045","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":856},{"label":"Fev","value":723},{"label":"Mar","value":859},{"label":"Abr","value":1038},{"label":"Mai","value":880},{"label":"Jun","value":797},{"label":"Jul","value":966},{"label":"Ago","value":796},{"label":"Set","value":906},{"label":"Out","value":968},{"label":"Nov","value":1040},{"label":"Dez","value":789}];
const MX = 1040;
