...
const PAGE = "Metadata Studio";
const KPIS = [{"l":"Formulários Ativos","v":"3.976","t":"-2.5%","d":"down"},{"l":"Submissões/Dia","v":"3432","t":"+0.1%","d":"up"},{"l":"Documentos Gerados","v":"497","t":"-5.6%","d":"down"},{"l":"Templates","v":"4.350","t":"+16.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.777","2026-03-16","1.005","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.635","2026-03-14","1.881","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.356","2026-01-14","2.641","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.080","2026-03-11","2.444","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.104","2026-01-19","8.371","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":559},{"label":"Mar","value":436},{"label":"Abr","value":606},{"label":"Mai","value":692},{"label":"Jun","value":517},{"label":"Jul","value":534},{"label":"Ago","value":470},{"label":"Set","value":472},{"label":"Out","value":692},{"label":"Nov","value":365},{"label":"Dez","value":591}];
const MX = 692;
