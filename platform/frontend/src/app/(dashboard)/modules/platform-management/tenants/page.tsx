...
const PAGE = "Tenants";
const KPIS = [{"l":"Formulários Ativos","v":"3.156","t":"+10.0%","d":"up"},{"l":"Submissões/Dia","v":"4334","t":"+3.2%","d":"up"},{"l":"Documentos Gerados","v":"6.290","t":"-2.9%","d":"down"},{"l":"Templates","v":"4.317","t":"+15.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.584","2026-01-11","6.671","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.571","2026-01-16","8.121","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","295","2026-01-10","5.331","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.897","2026-02-10","7.332","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.028","2026-02-20","8.698","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":557},{"label":"Mar","value":634},{"label":"Abr","value":704},{"label":"Mai","value":648},{"label":"Jun","value":487},{"label":"Jul","value":690},{"label":"Ago","value":515},{"label":"Set","value":566},{"label":"Out","value":747},{"label":"Nov","value":463},{"label":"Dez","value":618}];
const MX = 817;
