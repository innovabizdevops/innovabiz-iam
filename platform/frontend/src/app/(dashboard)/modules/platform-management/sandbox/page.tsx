...
const PAGE = "Sandbox";
const KPIS = [{"l":"Formulários Ativos","v":"3.072","t":"-1.2%","d":"down"},{"l":"Submissões/Dia","v":"283","t":"+0.8%","d":"up"},{"l":"Documentos Gerados","v":"4.142","t":"-0.9%","d":"down"},{"l":"Templates","v":"2.187","t":"+4.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.681","2026-01-16","209","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","413","2026-01-19","4.024","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.134","2026-03-18","8.632","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.979","2026-01-16","4.593","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.198","2026-03-12","2.298","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":863},{"label":"Mar","value":850},{"label":"Abr","value":781},{"label":"Mai","value":941},{"label":"Jun","value":1011},{"label":"Jul","value":1069},{"label":"Ago","value":1048},{"label":"Set","value":795},{"label":"Out","value":1028},{"label":"Nov","value":711},{"label":"Dez","value":969}];
const MX = 1069;
