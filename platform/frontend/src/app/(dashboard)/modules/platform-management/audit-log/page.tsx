...
const KPIS = [{"l":"Auditorias Realizadas","v":"2.113","t":"+0.9%","d":"up"},{"l":"NC Abertas","v":"1.695","t":"+11.1%","d":"up"},{"l":"Conformidade (%)","v":"86.6%","t":"+17.2%","d":"up"},{"l":"CAPAs Pendentes","v":"9.088","t":"-0.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.537","96.7%","1.662","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.639","72.6%","8.864","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.542","94.5%","545","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.400","91.6%","1.997","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.253","81.2%","3.612","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":639},{"label":"Mar","value":599},{"label":"Abr","value":528},{"label":"Mai","value":800},{"label":"Jun","value":711},{"label":"Jul","value":609},{"label":"Ago","value":782},{"label":"Set","value":826},{"label":"Out","value":624},{"label":"Nov","value":653},{"label":"Dez","value":800}];
const MX = 826;
