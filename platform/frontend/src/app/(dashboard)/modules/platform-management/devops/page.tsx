...
const PAGE = "DevOps";
const KPIS = [{"l":"Formulários Ativos","v":"2.780","t":"+10.5%","d":"up"},{"l":"Submissões/Dia","v":"2159","t":"+10.0%","d":"up"},{"l":"Documentos Gerados","v":"7.840","t":"+9.6%","d":"up"},{"l":"Templates","v":"6.030","t":"-3.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","236","2026-02-09","6.901","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.198","2026-02-10","5.876","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.862","2026-01-12","3.014","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.191","2026-02-11","4.324","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.438","2026-03-13","4.463","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":763},{"label":"Mar","value":716},{"label":"Abr","value":540},{"label":"Mai","value":650},{"label":"Jun","value":673},{"label":"Jul","value":741},{"label":"Ago","value":725},{"label":"Set","value":865},{"label":"Out","value":529},{"label":"Nov","value":563},{"label":"Dez","value":869}];
const MX = 869;
