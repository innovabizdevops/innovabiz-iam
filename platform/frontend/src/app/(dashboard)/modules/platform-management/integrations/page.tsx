...
const KPIS = [{"l":"Formulários Ativos","v":"7.351","t":"+16.5%","d":"up"},{"l":"Submissões/Dia","v":"2535","t":"-4.6%","d":"down"},{"l":"Documentos Gerados","v":"3.797","t":"+3.9%","d":"up"},{"l":"Templates","v":"1.654","t":"+15.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.478","2026-01-03","6.004","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","370","2026-02-02","6.313","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.890","2026-02-11","5.465","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.202","2026-01-19","4.373","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.749","2026-02-06","6.332","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":332},{"label":"Fev","value":491},{"label":"Mar","value":584},{"label":"Abr","value":511},{"label":"Mai","value":587},{"label":"Jun","value":563},{"label":"Jul","value":470},{"label":"Ago","value":550},{"label":"Set","value":470},{"label":"Out","value":565},{"label":"Nov","value":580},{"label":"Dez","value":382}];
const MX = 587;
