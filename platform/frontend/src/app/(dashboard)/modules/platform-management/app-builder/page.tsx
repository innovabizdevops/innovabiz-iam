...
const PAGE = "App Builder";
const KPIS = [{"l":"Formulários Ativos","v":"8.511","t":"+11.5%","d":"up"},{"l":"Submissões/Dia","v":"324","t":"+12.6%","d":"up"},{"l":"Documentos Gerados","v":"6.050","t":"-1.0%","d":"down"},{"l":"Templates","v":"8.837","t":"+15.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.177","2026-02-17","4.366","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.078","2026-02-17","4.131","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.213","2026-01-21","7.941","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.521","2026-02-04","6.579","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.312","2026-01-07","8.179","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":891},{"label":"Mar","value":653},{"label":"Abr","value":684},{"label":"Mai","value":555},{"label":"Jun","value":842},{"label":"Jul","value":670},{"label":"Ago","value":663},{"label":"Set","value":816},{"label":"Out","value":585},{"label":"Nov","value":926},{"label":"Dez","value":780}];
const MX = 926;
