...
const KPIS = [{"l":"Total Drill Mgmt","v":"3.073","t":"+3.6%","d":"up"},{"l":"Cost Track Ativos","v":"2.951","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"83.6%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"61","t":"+15.6%","d":"up"}];
const COLS = ["ID","Cost Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drill Mgmt #001","Drill Mgmt #002","7.509","6.827","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Drill Mgmt #002","Drill Mgmt #003","1.802","2.152","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Drill Mgmt #003","Drill Mgmt #004","6.378","5.591","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Drill Mgmt #004","Drill Mgmt #005","4.260","3.036","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drill Mgmt #005","Drill Mgmt #001","338","1.375","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":996},{"label":"Fev","value":986},{"label":"Mar","value":908},{"label":"Abr","value":731},{"label":"Mai","value":1001},{"label":"Jun","value":643},{"label":"Jul","value":682},{"label":"Ago","value":834},{"label":"Set","value":895},{"label":"Out","value":680},{"label":"Nov","value":834},{"label":"Dez","value":964}];
const MX = 1001;
