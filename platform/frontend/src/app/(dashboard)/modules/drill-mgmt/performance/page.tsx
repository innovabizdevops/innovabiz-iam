...
const ACCENT = "#dc2626";
const MODULE = "Drill Management";
const PAGE = "Performance";
const KPIS = [{"l":"Formulários Ativos","v":"3.206","t":"-0.2%","d":"down"},{"l":"Submissões/Dia","v":"241","t":"+3.9%","d":"up"},{"l":"Documentos Gerados","v":"6.947","t":"+1.7%","d":"up"},{"l":"Templates","v":"5.302","t":"+0.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.034","2026-01-09","5.504","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.779","2026-01-26","4.005","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","577","2026-02-16","3.398","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.355","2026-02-19","2.301","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.032","2026-03-16","6.374","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":413},{"label":"Mar","value":423},{"label":"Abr","value":720},{"label":"Mai","value":426},{"label":"Jun","value":643},{"label":"Jul","value":505},{"label":"Ago","value":464},{"label":"Set","value":605},{"label":"Out","value":695},{"label":"Nov","value":375},{"label":"Dez","value":375}];
const MX = 720;
