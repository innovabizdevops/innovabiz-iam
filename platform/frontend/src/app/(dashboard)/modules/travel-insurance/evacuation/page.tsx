...
const ACCENT = "#6366f1";
const MODULE = "Travel Insurance";
const PAGE = "Evacuation";
const KPIS = [{"l":"Total Travel Insurance","v":"3.766","t":"+1.2%","d":"up"},{"l":"Evacuation Ativos","v":"3.013","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"76.3%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"94","t":"-5.6%","d":"down"}];
const COLS = ["ID","Evacuation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Travel Insurance #001","Travel Insurance #002","4.952","7.037","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Travel Insurance #002","Travel Insurance #003","3.896","8.918","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Travel Insurance #003","Travel Insurance #004","3.249","7.060","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Travel Insurance #004","Travel Insurance #005","7.453","1.199","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Travel Insurance #005","Travel Insurance #001","7.274","811","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":569},{"label":"Mar","value":331},{"label":"Abr","value":621},{"label":"Mai","value":605},{"label":"Jun","value":539},{"label":"Jul","value":535},{"label":"Ago","value":693},{"label":"Set","value":364},{"label":"Out","value":499},{"label":"Nov","value":561},{"label":"Dez","value":349}];
const MX = 693;
