...
const PAGE = "Medical";
const KPIS = [{"l":"Integrações Ativas","v":"7.455","t":"+7.6%","d":"up"},{"l":"Chamadas/Hora","v":"728","t":"-1.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"88.0%","t":"-5.4%","d":"down"},{"l":"Latência Média (ms)","v":"88ms","t":"+1.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.363","3.210","91.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.551","6.585","94.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.360","1.557","82.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","9.002","957","81.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.262","2.625","72.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":621},{"label":"Mar","value":389},{"label":"Abr","value":442},{"label":"Mai","value":423},{"label":"Jun","value":440},{"label":"Jul","value":510},{"label":"Ago","value":515},{"label":"Set","value":430},{"label":"Out","value":655},{"label":"Nov","value":466},{"label":"Dez","value":392}];
const MX = 664;
