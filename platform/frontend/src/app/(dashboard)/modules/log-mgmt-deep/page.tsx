...
/* ═══ Log Management Deep — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "1614", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "917", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€78K", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "394269014", cells: ["LOG-7014", "Log Management Deep Item 1", "7/3/2026", "€19 114"], status: "active" as const },
    { id: "394272585", cells: ["LOG-1585", "Log Management Deep Item 2", "22/10/2026", "€22 685"], status: "pending" as const },
    { id: "394276156", cells: ["LOG-5156", "Log Management Deep Item 3", "9/5/2026", "€26 256"], status: "completed" as const },
    { id: "394279727", cells: ["LOG-8727", "Log Management Deep Item 4", "24/12/2026", "€29 827"], status: "warning" as const },
    { id: "394283298", cells: ["LOG-3298", "Log Management Deep Item 5", "11/7/2026", "€33 398"], status: "active" as const },
];
...
export default function LogManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Log Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Log Management Deep</p>
                    </div>
                </div>
