...
const PAGE = "Collect";
const KPIS = [{"l":"Total Log Mgmt Deep","v":"6.933","t":"+15.4%","d":"up"},{"l":"Collect Ativos","v":"2.389","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"73.9%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"79","t":"+7.8%","d":"up"}];
const COLS = ["ID","Collect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Log Mgmt Deep #001","Log Mgmt Deep #002","3.014","5.969","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Log Mgmt Deep #002","Log Mgmt Deep #003","8.480","152","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Log Mgmt Deep #003","Log Mgmt Deep #004","498","5.283","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Log Mgmt Deep #004","Log Mgmt Deep #005","8.435","7.623","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Log Mgmt Deep #005","Log Mgmt Deep #001","1.015","4.114","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":628},{"label":"Mar","value":925},{"label":"Abr","value":944},{"label":"Mai","value":636},{"label":"Jun","value":970},{"label":"Jul","value":919},{"label":"Ago","value":660},{"label":"Set","value":668},{"label":"Out","value":600},{"label":"Nov","value":855},{"label":"Dez","value":829}];
const MX = 970;
