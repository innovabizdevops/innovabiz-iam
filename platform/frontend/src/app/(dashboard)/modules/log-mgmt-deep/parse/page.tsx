...
const PAGE = "Parse";
const KPIS = [{"l":"Total Log Mgmt Deep","v":"7.441","t":"+3.1%","d":"up"},{"l":"Parse Ativos","v":"205","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"+14.1%","d":"up"},{"l":"Score Performance","v":"72","t":"+11.2%","d":"up"}];
const COLS = ["ID","Parse","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Log Mgmt Deep #001","Log Mgmt Deep #002","6.813","3.592","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Log Mgmt Deep #002","Log Mgmt Deep #003","1.581","5.967","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Log Mgmt Deep #003","Log Mgmt Deep #004","2.473","1.386","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Log Mgmt Deep #004","Log Mgmt Deep #005","8.492","2.298","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Log Mgmt Deep #005","Log Mgmt Deep #001","3.034","8.614","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":399},{"label":"Fev","value":667},{"label":"Mar","value":549},{"label":"Abr","value":319},{"label":"Mai","value":429},{"label":"Jun","value":417},{"label":"Jul","value":304},{"label":"Ago","value":671},{"label":"Set","value":333},{"label":"Out","value":460},{"label":"Nov","value":573},{"label":"Dez","value":550}];
const MX = 671;
