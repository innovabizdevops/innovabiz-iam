...
const ACCENT = "#1e40af";
const MODULE = "Log Management Deep";
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"2.381","t":"-3.5%","d":"down"},{"l":"Taxa Entrega (%)","v":"73.5%","t":"-5.2%","d":"down"},{"l":"Taxa Abertura (%)","v":"92.2%","t":"-3.2%","d":"down"},{"l":"Escalações","v":"1.638","t":"+16.9%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","1.110","91.9%","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","5.311","80.3%","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","1.865","93.7%","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","8.030","90.0%","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","1.402","70.3%","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":872},{"label":"Fev","value":826},{"label":"Mar","value":926},{"label":"Abr","value":950},{"label":"Mai","value":893},{"label":"Jun","value":949},{"label":"Jul","value":684},{"label":"Ago","value":960},{"label":"Set","value":921},{"label":"Out","value":1073},{"label":"Nov","value":870},{"label":"Dez","value":982}];
const MX = 1073;
