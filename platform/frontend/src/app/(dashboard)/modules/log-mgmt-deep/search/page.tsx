...
const PAGE = "Search";
const KPIS = [{"l":"Total Log Mgmt Deep","v":"4.940","t":"-3.5%","d":"down"},{"l":"Search Ativos","v":"3.570","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"69.4%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"70","t":"-4.1%","d":"down"}];
const COLS = ["ID","Search","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Log Mgmt Deep #001","Log Mgmt Deep #002","9.039","8.708","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Log Mgmt Deep #002","Log Mgmt Deep #003","7.213","5.105","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Log Mgmt Deep #003","Log Mgmt Deep #004","4.785","1.200","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Log Mgmt Deep #004","Log Mgmt Deep #005","8.710","7.942","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Log Mgmt Deep #005","Log Mgmt Deep #001","5.632","2.085","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":549},{"label":"Mar","value":542},{"label":"Abr","value":355},{"label":"Mai","value":589},{"label":"Jun","value":667},{"label":"Jul","value":625},{"label":"Ago","value":312},{"label":"Set","value":567},{"label":"Out","value":658},{"label":"Nov","value":395},{"label":"Dez","value":603}];
const MX = 667;
