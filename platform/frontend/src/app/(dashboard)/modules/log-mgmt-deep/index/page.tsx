...
const PAGE = "Index";
const KPIS = [{"l":"Total Log Mgmt Deep","v":"3.827","t":"-2.8%","d":"down"},{"l":"Index Ativos","v":"7.478","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"-2.8%","d":"down"},{"l":"Score Performance","v":"58","t":"+16.6%","d":"up"}];
const COLS = ["ID","Index","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Log Mgmt Deep #001","Log Mgmt Deep #002","8.382","4.640","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Log Mgmt Deep #002","Log Mgmt Deep #003","6.739","8.001","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Log Mgmt Deep #003","Log Mgmt Deep #004","1.840","4.740","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Log Mgmt Deep #004","Log Mgmt Deep #005","8.622","1.166","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Log Mgmt Deep #005","Log Mgmt Deep #001","327","3.042","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":602},{"label":"Mar","value":568},{"label":"Abr","value":575},{"label":"Mai","value":604},{"label":"Jun","value":566},{"label":"Jul","value":591},{"label":"Ago","value":755},{"label":"Set","value":713},{"label":"Out","value":714},{"label":"Nov","value":754},{"label":"Dez","value":720}];
const MX = 755;
