...
const PAGE = "Research";
const KPIS = [{"l":"Ideias Submetidas","v":"1.722","t":"+1.1%","d":"up"},{"l":"Patentes (YTD)","v":"6.282","t":"+16.6%","d":"up"},{"l":"Projetos Innovation Lab","v":"4.872","t":"+11.4%","d":"up"},{"l":"Budget I&D (€M)","v":"€29.5M","t":"+17.5%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","5.376","90.0%","2.489","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.413","88.9%","7.949","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","2.942","79.6%","1.286","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","1.153","96.4%","818","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","8.392","72.0%","3.814","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":570},{"label":"Fev","value":893},{"label":"Mar","value":837},{"label":"Abr","value":643},{"label":"Mai","value":816},{"label":"Jun","value":605},{"label":"Jul","value":799},{"label":"Ago","value":589},{"label":"Set","value":832},{"label":"Out","value":675},{"label":"Nov","value":802},{"label":"Dez","value":836}];
const MX = 893;
