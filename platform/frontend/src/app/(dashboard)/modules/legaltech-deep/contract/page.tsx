...
const ACCENT = "#64748b";
const MODULE = "LegalTech Platform Deep";
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"6.295","t":"+5.7%","d":"up"},{"l":"Valor Total (€M)","v":"€49.1M","t":"+17.8%","d":"up"},{"l":"Renovações Próx. 30d","v":"1.747","t":"+10.7%","d":"up"},{"l":"Obrigações Pendentes","v":"1.673","t":"+12.8%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 40291.62","2026-03-11","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 31792.45","2026-03-16","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 27153.83","2026-01-26","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 10333.48","2026-01-21","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 43262.07","2026-03-14","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":986},{"label":"Fev","value":646},{"label":"Mar","value":828},{"label":"Abr","value":1001},{"label":"Mai","value":941},{"label":"Jun","value":827},{"label":"Jul","value":723},{"label":"Ago","value":732},{"label":"Set","value":765},{"label":"Out","value":686},{"label":"Nov","value":851},{"label":"Dez","value":730}];
const MX = 1001;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#64748b'}}>AI</span></h1>
                </div>
