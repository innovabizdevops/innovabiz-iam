...
const PAGE = "V2N";
const KPIS = [{"l":"Formulários Ativos","v":"8.687","t":"+16.8%","d":"up"},{"l":"Submissões/Dia","v":"5093","t":"-5.6%","d":"down"},{"l":"Documentos Gerados","v":"5.722","t":"+1.1%","d":"up"},{"l":"Templates","v":"267","t":"-0.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.871","2026-02-27","8.594","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.937","2026-03-19","7.779","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.407","2026-02-22","5.725","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.846","2026-02-14","1.276","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.251","2026-03-19","2.282","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":420},{"label":"Fev","value":635},{"label":"Mar","value":305},{"label":"Abr","value":332},{"label":"Mai","value":310},{"label":"Jun","value":389},{"label":"Jul","value":510},{"label":"Ago","value":496},{"label":"Set","value":329},{"label":"Out","value":403},{"label":"Nov","value":629},{"label":"Dez","value":479}];
const MX = 635;
...
export default function V2nPage() {
    return (
