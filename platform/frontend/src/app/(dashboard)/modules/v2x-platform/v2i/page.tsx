...
const PAGE = "V2I";
const KPIS = [{"l":"Formulários Ativos","v":"8.054","t":"-5.5%","d":"down"},{"l":"Submissões/Dia","v":"4141","t":"+11.1%","d":"up"},{"l":"Documentos Gerados","v":"7.312","t":"-3.6%","d":"down"},{"l":"Templates","v":"3.126","t":"+14.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.364","2026-03-12","5.535","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.616","2026-03-05","2.606","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.502","2026-01-14","8.478","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.685","2026-03-17","6.444","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.926","2026-03-25","3.403","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":861},{"label":"Mar","value":960},{"label":"Abr","value":866},{"label":"Mai","value":719},{"label":"Jun","value":958},{"label":"Jul","value":909},{"label":"Ago","value":670},{"label":"Set","value":997},{"label":"Out","value":927},{"label":"Nov","value":724},{"label":"Dez","value":870}];
const MX = 997;
...
export default function V2iPage() {
    return (
