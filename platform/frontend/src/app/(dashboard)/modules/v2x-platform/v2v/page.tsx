...
const PAGE = "V2V";
const KPIS = [{"l":"Formulários Ativos","v":"720","t":"+0.4%","d":"up"},{"l":"Submissões/Dia","v":"1399","t":"-3.0%","d":"down"},{"l":"Documentos Gerados","v":"7.194","t":"+14.4%","d":"up"},{"l":"Templates","v":"7.324","t":"+17.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.718","2026-03-14","7.918","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","259","2026-01-21","2.406","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.386","2026-01-04","3.525","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.133","2026-02-11","4.885","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.083","2026-03-19","4.604","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":808},{"label":"Mar","value":891},{"label":"Abr","value":711},{"label":"Mai","value":763},{"label":"Jun","value":597},{"label":"Jul","value":595},{"label":"Ago","value":809},{"label":"Set","value":755},{"label":"Out","value":790},{"label":"Nov","value":606},{"label":"Dez","value":890}];
const MX = 891;
