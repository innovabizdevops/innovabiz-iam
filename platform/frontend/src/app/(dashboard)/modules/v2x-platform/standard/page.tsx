...
const PAGE = "Standard";
const KPIS = [{"l":"Formulários Ativos","v":"5.289","t":"+17.8%","d":"up"},{"l":"Submissões/Dia","v":"1153","t":"+2.7%","d":"up"},{"l":"Documentos Gerados","v":"6.549","t":"+11.8%","d":"up"},{"l":"Templates","v":"6.612","t":"+9.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.764","2026-03-15","7.602","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.325","2026-02-21","8.598","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.328","2026-01-21","7.920","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.947","2026-01-06","5.488","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.568","2026-02-08","3.072","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":382},{"label":"Mar","value":425},{"label":"Abr","value":524},{"label":"Mai","value":411},{"label":"Jun","value":403},{"label":"Jul","value":396},{"label":"Ago","value":709},{"label":"Set","value":672},{"label":"Out","value":420},{"label":"Nov","value":684},{"label":"Dez","value":727}];
const MX = 727;
