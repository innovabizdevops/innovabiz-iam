...
const ACCENT = "#1e3a5f";
const MODULE = "V2X Communication Platform";
const PAGE = "Safety";
const KPIS = [{"l":"Formulários Ativos","v":"1.976","t":"+10.3%","d":"up"},{"l":"Submissões/Dia","v":"4706","t":"-2.6%","d":"down"},{"l":"Documentos Gerados","v":"2.189","t":"+4.5%","d":"up"},{"l":"Templates","v":"2.135","t":"+12.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.195","2026-01-21","3.422","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.294","2026-01-07","4.361","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.210","2026-01-17","2.320","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.939","2026-03-07","2.681","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.650","2026-03-22","1.970","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":909},{"label":"Fev","value":1017},{"label":"Mar","value":907},{"label":"Abr","value":1084},{"label":"Mai","value":957},{"label":"Jun","value":1017},{"label":"Jul","value":867},{"label":"Ago","value":771},{"label":"Set","value":1032},{"label":"Out","value":963},{"label":"Nov","value":847},{"label":"Dez","value":1083}];
const MX = 1084;
