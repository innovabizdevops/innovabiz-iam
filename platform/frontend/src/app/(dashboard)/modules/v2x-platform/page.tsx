...
/* ═══ V2X Communication Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "4169", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1150", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€296K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "820951669", cells: ["V2X-8669", "V2X Communication Platform Item 1", "14/2/2026", "€1769"], status: "active" as const },
    { id: "820955240", cells: ["V2X-3240", "V2X Communication Platform Item 2", "1/9/2026", "€5340"], status: "pending" as const },
    { id: "820958811", cells: ["V2X-6811", "V2X Communication Platform Item 3", "16/4/2026", "€8911"], status: "completed" as const },
    { id: "820962382", cells: ["V2X-1382", "V2X Communication Platform Item 4", "3/11/2026", "€12 482"], status: "warning" as const },
    { id: "820965953", cells: ["V2X-4953", "V2X Communication Platform Item 5", "18/6/2026", "€16 053"], status: "active" as const },
];
...
export default function V2xCommunicationPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">V2X Communication Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • V2X Communication Platform</p>
                    </div>
                </div>
