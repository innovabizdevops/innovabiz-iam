...
const KPIS = [{"l":"Total Museum Gallery","v":"1.117","t":"+0.7%","d":"up"},{"l":"Collection Ativos","v":"1.716","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"78.4%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"60","t":"+7.8%","d":"up"}];
const COLS = ["ID","Collection","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Museum Gallery #001","Museum Gallery #002","6.524","3.375","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Museum Gallery #002","Museum Gallery #003","3.078","7.987","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Museum Gallery #003","Museum Gallery #004","3.927","2.667","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Museum Gallery #004","Museum Gallery #005","1.097","5.410","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Museum Gallery #005","Museum Gallery #001","3.028","853","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":780},{"label":"Fev","value":925},{"label":"Mar","value":793},{"label":"Abr","value":966},{"label":"Mai","value":900},{"label":"Jun","value":1039},{"label":"Jul","value":782},{"label":"Ago","value":938},{"label":"Set","value":771},{"label":"Out","value":927},{"label":"Nov","value":798},{"label":"Dez","value":911}];
const MX = 1039;
