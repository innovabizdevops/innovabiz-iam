...
const KPIS = [{"l":"Total Museum Gallery","v":"6.388","t":"+17.1%","d":"up"},{"l":"Conservation Ativos","v":"809","t":"-1.3%","d":"down"},{"l":"Eficiência (%)","v":"81.2%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"91","t":"-5.4%","d":"down"}];
const COLS = ["ID","Conservation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Museum Gallery #001","Museum Gallery #002","5.132","3.867","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Museum Gallery #002","Museum Gallery #003","8.705","254","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Museum Gallery #003","Museum Gallery #004","3.247","8.669","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Museum Gallery #004","Museum Gallery #005","8.906","6.324","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Museum Gallery #005","Museum Gallery #001","6.050","2.286","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":661},{"label":"Mar","value":598},{"label":"Abr","value":718},{"label":"Mai","value":395},{"label":"Jun","value":660},{"label":"Jul","value":434},{"label":"Ago","value":717},{"label":"Set","value":731},{"label":"Out","value":405},{"label":"Nov","value":365},{"label":"Dez","value":599}];
const MX = 731;
