...
const KPIS = [{"l":"Total Museum Gallery","v":"7.531","t":"-5.5%","d":"down"},{"l":"Education Ativos","v":"3.971","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"88.7%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"61","t":"+17.4%","d":"up"}];
const COLS = ["ID","Education","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Museum Gallery #001","Museum Gallery #002","2.441","5.100","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Museum Gallery #002","Museum Gallery #003","850","4.641","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Museum Gallery #003","Museum Gallery #004","3.758","3.466","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Museum Gallery #004","Museum Gallery #005","8.922","3.959","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Museum Gallery #005","Museum Gallery #001","7.225","8.091","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":789},{"label":"Mar","value":862},{"label":"Abr","value":578},{"label":"Mai","value":809},{"label":"Jun","value":725},{"label":"Jul","value":596},{"label":"Ago","value":562},{"label":"Set","value":622},{"label":"Out","value":735},{"label":"Nov","value":754},{"label":"Dez","value":803}];
const MX = 862;
