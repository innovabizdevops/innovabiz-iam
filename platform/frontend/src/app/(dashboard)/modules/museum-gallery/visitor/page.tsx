...
const ACCENT = "#2d4a6f";
const MODULE = "Museum & Gallery";
const PAGE = "Visitor";
const KPIS = [{"l":"Total Museum Gallery","v":"791","t":"+0.1%","d":"up"},{"l":"Visitor Ativos","v":"7.184","t":"+15.9%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"88","t":"+14.8%","d":"up"}];
const COLS = ["ID","Visitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Museum Gallery #001","Museum Gallery #002","8.445","3.424","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Museum Gallery #002","Museum Gallery #003","5.445","4.309","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Museum Gallery #003","Museum Gallery #004","7.109","2.995","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Museum Gallery #004","Museum Gallery #005","5.949","3.702","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Museum Gallery #005","Museum Gallery #001","1.003","7.032","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":633},{"label":"Mar","value":746},{"label":"Abr","value":383},{"label":"Mai","value":506},{"label":"Jun","value":474},{"label":"Jul","value":453},{"label":"Ago","value":621},{"label":"Set","value":402},{"label":"Out","value":412},{"label":"Nov","value":714},{"label":"Dez","value":725}];
const MX = 746;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#2d4a6f'}}>AI</span></h1>
                </div>
