...
/* ═══ Operational Risk (Basel) — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "4321", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1594", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€212K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "-4%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "876579921", cells: ["OPE-7921", "Operational Risk (Basel) Item 1", "22/10/2026", "€30 021"], status: "active" as const },
    { id: "876583492", cells: ["OPE-2492", "Operational Risk (Basel) Item 2", "9/5/2026", "€33 592"], status: "pending" as const },
    { id: "876587063", cells: ["OPE-6063", "Operational Risk (Basel) Item 3", "24/12/2026", "€37 163"], status: "completed" as const },
    { id: "876590634", cells: ["OPE-9634", "Operational Risk (Basel) Item 4", "11/7/2026", "€40 734"], status: "warning" as const },
    { id: "876594205", cells: ["OPE-4205", "Operational Risk (Basel) Item 5", "26/2/2026", "€44 305"], status: "active" as const },
];
...
export default function OperationalRiskBaselPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Operational Risk (Basel)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Operational Risk (Basel)</p>
                    </div>
                </div>
