...
const ACCENT = "#1e3a5f";
const MODULE = "Operational Risk (Basel)";
const PAGE = "Report";
const KPIS = [{"l":"Riscos Identificados","v":"6.407","t":"+10.6%","d":"up"},{"l":"Mitigações Ativas","v":"3.627","t":"-2.3%","d":"down"},{"l":"Score Risco Geral","v":"86","t":"+2.3%","d":"up"},{"l":"Incidentes YTD","v":"184","t":"+8.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.973","3.019","2.347","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.013","2.305","3.491","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.816","3.621","4.928","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.604","6.148","1.897","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.601","7.065","4.561","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":886},{"label":"Fev","value":801},{"label":"Mar","value":804},{"label":"Abr","value":829},{"label":"Mai","value":683},{"label":"Jun","value":797},{"label":"Jul","value":882},{"label":"Ago","value":761},{"label":"Set","value":842},{"label":"Out","value":694},{"label":"Nov","value":959},{"label":"Dez","value":1036}];
const MX = 1036;
