...
const PAGE = "Incident";
const KPIS = [{"l":"Riscos Identificados","v":"6.208","t":"-2.2%","d":"down"},{"l":"Mitigações Ativas","v":"6.243","t":"+10.4%","d":"up"},{"l":"Score Risco Geral","v":"83","t":"+6.6%","d":"up"},{"l":"Incidentes YTD","v":"6.807","t":"-4.1%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.827","1.663","5.564","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","234","6.799","8.413","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.145","5.462","7.156","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.915","3.093","7.807","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.950","6.239","8.126","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":304},{"label":"Fev","value":492},{"label":"Mar","value":316},{"label":"Abr","value":344},{"label":"Mai","value":464},{"label":"Jun","value":578},{"label":"Jul","value":396},{"label":"Ago","value":350},{"label":"Set","value":420},{"label":"Out","value":571},{"label":"Nov","value":361},{"label":"Dez","value":446}];
const MX = 578;
