...
const PAGE = "RCSA";
const KPIS = [{"l":"Riscos Identificados","v":"9.024","t":"+14.6%","d":"up"},{"l":"Mitigações Ativas","v":"3.174","t":"+6.8%","d":"up"},{"l":"Score Risco Geral","v":"80","t":"+2.9%","d":"up"},{"l":"Incidentes YTD","v":"4.880","t":"+1.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.905","494","2.648","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.073","4.548","8.587","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.434","2.273","4.458","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.385","4.213","3.595","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","823","3.394","9.043","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":564},{"label":"Mar","value":310},{"label":"Abr","value":419},{"label":"Mai","value":615},{"label":"Jun","value":441},{"label":"Jul","value":289},{"label":"Ago","value":344},{"label":"Set","value":367},{"label":"Out","value":566},{"label":"Nov","value":551},{"label":"Dez","value":687}];
const MX = 687;
