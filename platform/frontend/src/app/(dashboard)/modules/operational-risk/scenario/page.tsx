...
const PAGE = "Scenario";
const KPIS = [{"l":"Riscos Identificados","v":"5.209","t":"+15.8%","d":"up"},{"l":"Mitigações Ativas","v":"1.832","t":"+9.8%","d":"up"},{"l":"Score Risco Geral","v":"71","t":"+15.2%","d":"up"},{"l":"Incidentes YTD","v":"5.063","t":"+7.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.956","454","2.792","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.580","8.543","1.674","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.001","7.187","8.003","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.676","3.302","8.214","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.447","4.528","4.841","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":421},{"label":"Fev","value":420},{"label":"Mar","value":246},{"label":"Abr","value":584},{"label":"Mai","value":383},{"label":"Jun","value":596},{"label":"Jul","value":582},{"label":"Ago","value":512},{"label":"Set","value":554},{"label":"Out","value":470},{"label":"Nov","value":510},{"label":"Dez","value":265}];
const MX = 596;
