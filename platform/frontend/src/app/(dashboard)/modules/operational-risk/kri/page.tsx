...
const PAGE = "KRI";
const KPIS = [{"l":"Riscos Identificados","v":"4.025","t":"+9.1%","d":"up"},{"l":"Mitigações Ativas","v":"3.747","t":"+7.5%","d":"up"},{"l":"Score Risco Geral","v":"82","t":"+15.8%","d":"up"},{"l":"Incidentes YTD","v":"1.964","t":"-3.3%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.115","1.432","221","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.050","1.602","1.160","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.250","6.144","1.483","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.151","7.713","7.710","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.099","160","2.848","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":687},{"label":"Mar","value":388},{"label":"Abr","value":606},{"label":"Mai","value":497},{"label":"Jun","value":676},{"label":"Jul","value":389},{"label":"Ago","value":474},{"label":"Set","value":431},{"label":"Out","value":721},{"label":"Nov","value":495},{"label":"Dez","value":722}];
const MX = 722;
