...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€21.0M","t":"+0.8%","d":"up"},{"l":"MRR (€)","v":"€17177","t":"+6.6%","d":"up"},{"l":"Churn (%)","v":"74.2%","t":"-1.9%","d":"down"},{"l":"ARPU (€)","v":"€95649","t":"-3.6%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 437.99","670","€ 19680.27","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 45067.73","2.771","€ 19699.45","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 40428.88","2.796","€ 4529.82","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 45035.90","4.040","€ 28655.17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 12910.70","8.508","€ 32317.74","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":764},{"label":"Mar","value":796},{"label":"Abr","value":632},{"label":"Mai","value":691},{"label":"Jun","value":664},{"label":"Jul","value":705},{"label":"Ago","value":545},{"label":"Set","value":637},{"label":"Out","value":460},{"label":"Nov","value":727},{"label":"Dez","value":488}];
const MX = 796;
