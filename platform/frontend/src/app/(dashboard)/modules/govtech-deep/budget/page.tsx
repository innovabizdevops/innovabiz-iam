...
const PAGE = "Budget";
const KPIS = [{"l":"Total Govtech Deep","v":"3.939","t":"+1.8%","d":"up"},{"l":"Budget Ativos","v":"€72055","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"69.1%","t":"+16.3%","d":"up"},{"l":"Score Performance","v":"87","t":"+15.5%","d":"up"}];
const COLS = ["ID","Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Govtech Deep #001","€ 32574.66","5.815","9.038","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Govtech Deep #002","€ 34915.80","1.365","8.653","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Govtech Deep #003","€ 13627.83","5.391","8.926","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Govtech Deep #004","€ 17234.71","4.168","6.787","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Govtech Deep #005","€ 6733.24","3.761","3.017","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":384},{"label":"Fev","value":526},{"label":"Mar","value":561},{"label":"Abr","value":381},{"label":"Mai","value":284},{"label":"Jun","value":414},{"label":"Jul","value":553},{"label":"Ago","value":530},{"label":"Set","value":402},{"label":"Out","value":585},{"label":"Nov","value":367},{"label":"Dez","value":655}];
const MX = 655;
