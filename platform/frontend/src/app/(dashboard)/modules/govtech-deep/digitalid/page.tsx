...
const ACCENT = "#1e40af";
const MODULE = "GovTech Deep";
const PAGE = "Digital ID";
const KPIS = [{"l":"Total Govtech Deep","v":"9.036","t":"+12.7%","d":"up"},{"l":"Digital ID Ativos","v":"7.908","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"65.8%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"82","t":"-1.0%","d":"down"}];
const COLS = ["ID","Digital ID","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Govtech Deep #001","Govtech Deep #002","7.111","2.453","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Govtech Deep #002","Govtech Deep #003","8.069","4.545","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Govtech Deep #003","Govtech Deep #004","8.022","3.223","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Govtech Deep #004","Govtech Deep #005","5.484","7.942","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Govtech Deep #005","Govtech Deep #001","4.857","6.287","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":438},{"label":"Fev","value":442},{"label":"Mar","value":426},{"label":"Abr","value":575},{"label":"Mai","value":428},{"label":"Jun","value":495},{"label":"Jul","value":379},{"label":"Ago","value":389},{"label":"Set","value":393},{"label":"Out","value":734},{"label":"Nov","value":676},{"label":"Dez","value":575}];
const MX = 734;
