...
const KPIS = [{"l":"Fornecedores Ativos","v":"201","t":"-3.1%","d":"down"},{"l":"Contratos (€M)","v":"€34.9M","t":"-3.4%","d":"down"},{"l":"On-Time Delivery (%)","v":"72.5%","t":"+17.3%","d":"up"},{"l":"Score Médio","v":"84","t":"+4.9%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","85.4%","€ 41694.05","2.905","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","98.3%","€ 37685.74","1.207","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","92.2%","€ 35830.96","1.939","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","95.1%","€ 39897.43","8.806","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","84.9%","€ 49867.97","5.055","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":649},{"label":"Mar","value":854},{"label":"Abr","value":650},{"label":"Mai","value":491},{"label":"Jun","value":741},{"label":"Jul","value":640},{"label":"Ago","value":568},{"label":"Set","value":577},{"label":"Out","value":794},{"label":"Nov","value":588},{"label":"Dez","value":555}];
const MX = 854;
