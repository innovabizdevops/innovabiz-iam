...
/* ═══ GovTech Deep — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "8172", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4385", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€51K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1700738972", cells: ["GOV-9972", "GovTech Deep Item 1", "17/9/2026", "€39 072"], status: "active" as const },
    { id: "1700742543", cells: ["GOV-4543", "GovTech Deep Item 2", "4/4/2026", "€42 643"], status: "pending" as const },
    { id: "1700746114", cells: ["GOV-8114", "GovTech Deep Item 3", "19/11/2026", "€46 214"], status: "completed" as const },
    { id: "1700749685", cells: ["GOV-2685", "GovTech Deep Item 4", "6/6/2026", "€49 785"], status: "warning" as const },
    { id: "1700753256", cells: ["GOV-6256", "GovTech Deep Item 5", "21/1/2026", "€3356"], status: "active" as const },
];
...
export default function GovtechDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GovTech Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GovTech Deep</p>
                    </div>
                </div>
