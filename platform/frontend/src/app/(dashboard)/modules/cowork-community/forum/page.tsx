...
const PAGE = "Forum";
const KPIS = [{"l":"Projetos Sociais","v":"2.579","t":"+3.2%","d":"up"},{"l":"Beneficiários","v":"7.726","t":"-1.9%","d":"down"},{"l":"Investimento CSR (€)","v":"€33884","t":"+16.3%","d":"up"},{"l":"Score Impacto","v":"69","t":"+15.8%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","6.773","€ 19381.10","3.410","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.731","€ 8292.58","7.552","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","4.902","€ 16970.46","4.397","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","1.653","€ 7081.39","3.327","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","8.581","€ 37668.65","548","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":539},{"label":"Fev","value":510},{"label":"Mar","value":704},{"label":"Abr","value":493},{"label":"Mai","value":855},{"label":"Jun","value":486},{"label":"Jul","value":647},{"label":"Ago","value":766},{"label":"Set","value":716},{"label":"Out","value":670},{"label":"Nov","value":574},{"label":"Dez","value":666}];
const MX = 855;
