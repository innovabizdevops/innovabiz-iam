...
const PAGE = "Member";
const KPIS = [{"l":"Projetos Sociais","v":"5.262","t":"+16.4%","d":"up"},{"l":"Beneficiários","v":"2.425","t":"+10.1%","d":"up"},{"l":"Investimento CSR (€)","v":"€45984","t":"+17.4%","d":"up"},{"l":"Score Impacto","v":"74","t":"+16.6%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","3.281","€ 25486.36","2.345","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","5.435","€ 48144.87","242","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","8.796","€ 27235.00","4.091","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","1.149","€ 17125.21","1.881","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","7.751","€ 18427.85","4.922","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":442},{"label":"Mar","value":326},{"label":"Abr","value":537},{"label":"Mai","value":529},{"label":"Jun","value":644},{"label":"Jul","value":375},{"label":"Ago","value":611},{"label":"Set","value":584},{"label":"Out","value":466},{"label":"Nov","value":484},{"label":"Dez","value":487}];
const MX = 644;
