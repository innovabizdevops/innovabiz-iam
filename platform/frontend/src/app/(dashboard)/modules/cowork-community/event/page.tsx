...
const PAGE = "Event";
const KPIS = [{"l":"Projetos Sociais","v":"3.464","t":"+7.2%","d":"up"},{"l":"Beneficiários","v":"8.481","t":"+15.1%","d":"up"},{"l":"Investimento CSR (€)","v":"€50217","t":"+3.3%","d":"up"},{"l":"Score Impacto","v":"79","t":"+16.2%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","8.071","€ 20341.02","772","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","5.322","€ 21025.41","664","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","7.627","€ 743.84","1.753","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","5.441","€ 16564.13","6.676","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","6.420","€ 1608.46","1.483","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":461},{"label":"Mar","value":486},{"label":"Abr","value":314},{"label":"Mai","value":332},{"label":"Jun","value":529},{"label":"Jul","value":641},{"label":"Ago","value":286},{"label":"Set","value":353},{"label":"Out","value":457},{"label":"Nov","value":293},{"label":"Dez","value":368}];
const MX = 641;
