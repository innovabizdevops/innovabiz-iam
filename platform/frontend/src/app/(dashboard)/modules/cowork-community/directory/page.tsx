...
const ACCENT = "#4338ca";
const MODULE = "Cowork Community Platform";
const PAGE = "Directory";
const KPIS = [{"l":"Projetos Sociais","v":"486","t":"+15.9%","d":"up"},{"l":"Beneficiários","v":"2.502","t":"+15.0%","d":"up"},{"l":"Investimento CSR (€)","v":"€40355","t":"-0.2%","d":"down"},{"l":"Score Impacto","v":"62","t":"+11.2%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","1.591","€ 24993.46","1.807","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.152","€ 34812.72","7.320","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","7.897","€ 5615.68","7.186","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","3.976","€ 7669.63","6.053","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","5.596","€ 39701.20","5.504","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":918},{"label":"Mar","value":1018},{"label":"Abr","value":727},{"label":"Mai","value":691},{"label":"Jun","value":910},{"label":"Jul","value":1062},{"label":"Ago","value":1065},{"label":"Set","value":1023},{"label":"Out","value":881},{"label":"Nov","value":855},{"label":"Dez","value":959}];
const MX = 1065;
