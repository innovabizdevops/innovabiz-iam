...
/* ═══ Cowork Community Platform — Dashboard ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total Registos", value: "7268", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1035", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€496K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1535695168", cells: ["COW-8168", "Cowork Community Platform Item 1", "1/5/2026", "€45 268"], status: "active" as const },
    { id: "1535698739", cells: ["COW-2739", "Cowork Community Platform Item 2", "16/12/2026", "€48 839"], status: "pending" as const },
    { id: "1535702310", cells: ["COW-6310", "Cowork Community Platform Item 3", "3/7/2026", "€2410"], status: "completed" as const },
    { id: "1535705881", cells: ["COW-9881", "Cowork Community Platform Item 4", "18/2/2026", "€5981"], status: "warning" as const },
    { id: "1535709452", cells: ["COW-4452", "Cowork Community Platform Item 5", "5/9/2026", "€9552"], status: "active" as const },
];
...
export default function CoworkCommunityPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cowork Community Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cowork Community Platform</p>
                    </div>
                </div>
