...
const PAGE = "Collab";
const KPIS = [{"l":"Projetos Sociais","v":"8.958","t":"+8.3%","d":"up"},{"l":"Beneficiários","v":"2.062","t":"+7.2%","d":"up"},{"l":"Investimento CSR (€)","v":"€49182","t":"-3.2%","d":"down"},{"l":"Score Impacto","v":"85","t":"+13.3%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","738","€ 23206.27","3.579","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","400","€ 9236.21","4.696","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","7.987","€ 47388.65","1.761","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","1.794","€ 23294.18","114","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","2.800","€ 25257.93","3.922","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":363},{"label":"Fev","value":274},{"label":"Mar","value":356},{"label":"Abr","value":571},{"label":"Mai","value":368},{"label":"Jun","value":417},{"label":"Jul","value":351},{"label":"Ago","value":464},{"label":"Set","value":468},{"label":"Out","value":506},{"label":"Nov","value":538},{"label":"Dez","value":320}];
const MX = 571;
