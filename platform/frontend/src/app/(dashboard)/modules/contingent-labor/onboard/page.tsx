...
const PAGE = "Onboard";
const KPIS = [{"l":"eNPS","v":"94","t":"+0.8%","d":"up"},{"l":"Engagement (%)","v":"79.3%","t":"+4.0%","d":"up"},{"l":"Turnover (%)","v":"82.3%","t":"-1.3%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"7.879","t":"-4.8%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.534","2026-01-08","56","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.693","2026-03-08","65","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.581","2026-02-05","69","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.949","2026-03-08","84","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.060","2026-02-16","62","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":817},{"label":"Mar","value":784},{"label":"Abr","value":770},{"label":"Mai","value":450},{"label":"Jun","value":695},{"label":"Jul","value":719},{"label":"Ago","value":509},{"label":"Set","value":557},{"label":"Out","value":623},{"label":"Nov","value":538},{"label":"Dez","value":694}];
const MX = 817;
