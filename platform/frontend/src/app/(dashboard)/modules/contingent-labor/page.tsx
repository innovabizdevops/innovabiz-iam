...
/* ═══ Contingent Labor Mgmt — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "1517", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3793", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€22K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "534571717", cells: ["CON-8717", "Contingent Labor Mgmt Item 1", "2/2/2026", "€21 817"], status: "active" as const },
    { id: "534575288", cells: ["CON-3288", "Contingent Labor Mgmt Item 2", "17/9/2026", "€25 388"], status: "pending" as const },
    { id: "534578859", cells: ["CON-6859", "Contingent Labor Mgmt Item 3", "4/4/2026", "€28 959"], status: "completed" as const },
    { id: "534582430", cells: ["CON-1430", "Contingent Labor Mgmt Item 4", "19/11/2026", "€32 530"], status: "warning" as const },
    { id: "534586001", cells: ["CON-5001", "Contingent Labor Mgmt Item 5", "6/6/2026", "€36 101"], status: "active" as const },
];
...
export default function ContingentLaborMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Contingent Labor Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Contingent Labor Mgmt</p>
                    </div>
                </div>
