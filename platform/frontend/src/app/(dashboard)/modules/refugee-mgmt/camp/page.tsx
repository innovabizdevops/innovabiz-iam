...
const PAGE = "Camp Mgmt";
const KPIS = [{"l":"Total Refugee Mgmt","v":"7.250","t":"+16.1%","d":"up"},{"l":"Camp Mgmt Ativos","v":"7.354","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"74.9%","t":"+4.1%","d":"up"},{"l":"Score Performance","v":"62","t":"-6.0%","d":"down"}];
const COLS = ["ID","Camp Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Refugee Mgmt #001","Refugee Mgmt #002","459","5.779","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Refugee Mgmt #002","Refugee Mgmt #003","8.370","512","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Refugee Mgmt #003","Refugee Mgmt #004","8.060","8.373","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Refugee Mgmt #004","Refugee Mgmt #005","4.628","7.465","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Refugee Mgmt #005","Refugee Mgmt #001","6.408","8.677","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":385},{"label":"Mar","value":594},{"label":"Abr","value":508},{"label":"Mai","value":647},{"label":"Jun","value":552},{"label":"Jul","value":548},{"label":"Ago","value":432},{"label":"Set","value":683},{"label":"Out","value":568},{"label":"Nov","value":514},{"label":"Dez","value":550}];
const MX = 683;
