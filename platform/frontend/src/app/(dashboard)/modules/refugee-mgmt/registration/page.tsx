...
const KPIS = [{"l":"Eventos Planeados","v":"2.439","t":"+2.4%","d":"up"},{"l":"Participantes","v":"6.733","t":"-4.1%","d":"down"},{"l":"NPS Evento","v":"74","t":"+1.4%","d":"up"},{"l":"Receita (€)","v":"€38909","t":"-0.3%","d":"down"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-17","5.472","3.070","€ 12855.79","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-28","4.730","7.527","€ 29029.83","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-18","5.695","3.897","€ 43820.71","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-05","6.604","8.098","€ 34397.98","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-08","3.148","7.562","€ 16113.37","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":692},{"label":"Mar","value":467},{"label":"Abr","value":794},{"label":"Mai","value":656},{"label":"Jun","value":709},{"label":"Jul","value":697},{"label":"Ago","value":692},{"label":"Set","value":446},{"label":"Out","value":761},{"label":"Nov","value":659},{"label":"Dez","value":529}];
const MX = 794;
