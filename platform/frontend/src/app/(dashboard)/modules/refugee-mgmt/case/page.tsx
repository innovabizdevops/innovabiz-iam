...
const KPIS = [{"l":"Total Refugee Mgmt","v":"6.736","t":"+13.2%","d":"up"},{"l":"Case Mgmt Ativos","v":"4.031","t":"-1.3%","d":"down"},{"l":"Eficiência (%)","v":"74.7%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"68","t":"+17.1%","d":"up"}];
const COLS = ["ID","Case Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Refugee Mgmt #001","Refugee Mgmt #002","6.098","356","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Refugee Mgmt #002","Refugee Mgmt #003","2.393","4.048","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Refugee Mgmt #003","Refugee Mgmt #004","589","4.995","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Refugee Mgmt #004","Refugee Mgmt #005","2.863","1.543","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Refugee Mgmt #005","Refugee Mgmt #001","6.978","7.506","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":951},{"label":"Mar","value":716},{"label":"Abr","value":1002},{"label":"Mai","value":763},{"label":"Jun","value":649},{"label":"Jul","value":777},{"label":"Ago","value":908},{"label":"Set","value":813},{"label":"Out","value":772},{"label":"Nov","value":938},{"label":"Dez","value":755}];
const MX = 1002;
