...
const ACCENT = "#1e40af";
const MODULE = "Refugee Management";
const PAGE = "Resettlement";
const KPIS = [{"l":"Total Refugee Mgmt","v":"5.535","t":"+11.3%","d":"up"},{"l":"Resettlement Ativos","v":"5.062","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"90.3%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"90","t":"-2.2%","d":"down"}];
const COLS = ["ID","Resettlement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Refugee Mgmt #001","Refugee Mgmt #002","4.658","5.571","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Refugee Mgmt #002","Refugee Mgmt #003","4.279","6.131","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Refugee Mgmt #003","Refugee Mgmt #004","5.461","5.020","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Refugee Mgmt #004","Refugee Mgmt #005","2.516","1.796","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Refugee Mgmt #005","Refugee Mgmt #001","1.734","497","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":544},{"label":"Mar","value":330},{"label":"Abr","value":605},{"label":"Mai","value":431},{"label":"Jun","value":549},{"label":"Jul","value":312},{"label":"Ago","value":518},{"label":"Set","value":286},{"label":"Out","value":306},{"label":"Nov","value":526},{"label":"Dez","value":495}];
const MX = 605;
...
export default function ResettlePage() {
    return (
