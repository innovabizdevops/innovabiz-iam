...
const PAGE = "Status Track";
const KPIS = [{"l":"Total Refugee Mgmt","v":"5.537","t":"+0.6%","d":"up"},{"l":"Status Track Ativos","v":"2.032","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"77.5%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"67","t":"+11.1%","d":"up"}];
const COLS = ["ID","Status Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Refugee Mgmt #001","Ativo","2.194","5.575","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Refugee Mgmt #002","Pendente","4.761","4.171","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Refugee Mgmt #003","Concluído","4.348","566","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Refugee Mgmt #004","Em Análise","974","2.660","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Refugee Mgmt #005","Aprovado","3.535","7.992","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":355},{"label":"Fev","value":318},{"label":"Mar","value":473},{"label":"Abr","value":313},{"label":"Mai","value":448},{"label":"Jun","value":475},{"label":"Jul","value":593},{"label":"Ago","value":552},{"label":"Set","value":445},{"label":"Out","value":480},{"label":"Nov","value":209},{"label":"Dez","value":308}];
const MX = 593;
