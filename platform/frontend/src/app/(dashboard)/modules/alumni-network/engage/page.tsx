...
const ACCENT = "#0e7490";
const MODULE = "Alumni Network Platform";
const PAGE = "Engage";
const KPIS = [{"l":"Total Alumni Network","v":"3.216","t":"-4.3%","d":"down"},{"l":"Engage Ativos","v":"1.346","t":"+11.9%","d":"up"},{"l":"Eficiência (%)","v":"78.1%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"78","t":"+10.7%","d":"up"}];
const COLS = ["ID","Engage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Alumni Network #001","Alumni Network #002","475","1.708","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Alumni Network #002","Alumni Network #003","7.316","6.661","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Alumni Network #003","Alumni Network #004","4.051","6.361","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Alumni Network #004","Alumni Network #005","2.637","6.521","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Alumni Network #005","Alumni Network #001","2.837","2.074","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":698},{"label":"Mar","value":537},{"label":"Abr","value":640},{"label":"Mai","value":723},{"label":"Jun","value":732},{"label":"Jul","value":440},{"label":"Ago","value":759},{"label":"Set","value":470},{"label":"Out","value":543},{"label":"Nov","value":626},{"label":"Dez","value":539}];
const MX = 759;
