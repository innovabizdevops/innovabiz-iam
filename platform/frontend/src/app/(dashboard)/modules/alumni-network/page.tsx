...
/* ═══ Alumni Network Platform — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "2138", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1203", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€447K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1404406138", cells: ["ALU-2138", "Alumni Network Platform Item 1", "3/11/2026", "€6238"], status: "active" as const },
    { id: "1404409709", cells: ["ALU-5709", "Alumni Network Platform Item 2", "18/6/2026", "€9809"], status: "pending" as const },
    { id: "1404413280", cells: ["ALU-9280", "Alumni Network Platform Item 3", "5/1/2026", "€13 380"], status: "completed" as const },
    { id: "1404416851", cells: ["ALU-3851", "Alumni Network Platform Item 4", "20/8/2026", "€16 951"], status: "warning" as const },
    { id: "1404420422", cells: ["ALU-7422", "Alumni Network Platform Item 5", "7/3/2026", "€20 522"], status: "active" as const },
];
...
export default function AlumniNetworkPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Alumni Network Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Alumni Network Platform</p>
                    </div>
                </div>
