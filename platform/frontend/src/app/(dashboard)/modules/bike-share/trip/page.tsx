...
const PAGE = "Trip";
const KPIS = [{"l":"Total Bike Share","v":"3.842","t":"+6.5%","d":"up"},{"l":"Trip Ativos","v":"3.452","t":"+4.8%","d":"up"},{"l":"Eficiência (%)","v":"90.6%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"93","t":"+2.9%","d":"up"}];
const COLS = ["ID","Trip","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bike Share #001","Bike Share #002","875","144","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Bike Share #002","Bike Share #003","5.611","3.526","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Bike Share #003","Bike Share #004","2.133","2.909","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Bike Share #004","Bike Share #005","2.756","5.585","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bike Share #005","Bike Share #001","6.280","7.979","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":635},{"label":"Mar","value":790},{"label":"Abr","value":687},{"label":"Mai","value":673},{"label":"Jun","value":905},{"label":"Jul","value":614},{"label":"Ago","value":806},{"label":"Set","value":746},{"label":"Out","value":846},{"label":"Nov","value":677},{"label":"Dez","value":758}];
const MX = 905;
