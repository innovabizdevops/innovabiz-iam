...
const ACCENT = "#7dd3fc";
const MODULE = "Bike Sharing";
const PAGE = "Station";
const KPIS = [{"l":"Total Bike Share","v":"6.919","t":"+17.4%","d":"up"},{"l":"Station Ativos","v":"5.876","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"75.9%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"59","t":"-4.8%","d":"down"}];
const COLS = ["ID","Station","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bike Share #001","Bike Share #002","7.913","6.731","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Bike Share #002","Bike Share #003","4.775","2.530","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Bike Share #003","Bike Share #004","471","5.288","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Bike Share #004","Bike Share #005","1.481","2.824","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bike Share #005","Bike Share #001","2.187","8.726","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":861},{"label":"Fev","value":921},{"label":"Mar","value":601},{"label":"Abr","value":776},{"label":"Mai","value":656},{"label":"Jun","value":909},{"label":"Jul","value":781},{"label":"Ago","value":611},{"label":"Set","value":596},{"label":"Out","value":911},{"label":"Nov","value":782},{"label":"Dez","value":900}];
const MX = 921;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7dd3fc'}}>IoT</span></h1>
                </div>
