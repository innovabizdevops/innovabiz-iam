...
const KPIS = [{"l":"Dashboards Ativos","v":"7.484","t":"+4.0%","d":"up"},{"l":"Queries/Dia","v":"3644","t":"+4.0%","d":"up"},{"l":"Dados Processados (GB)","v":"369","t":"-2.9%","d":"down"},{"l":"Utilizadores Analytics","v":"2.457","t":"+1.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4386","2026-03-06","4.943","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1981","2026-02-11","8.501","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3501","2026-01-11","5.797","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4637","2026-02-24","6.979","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","440","2026-02-16","8.835","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":761},{"label":"Mar","value":505},{"label":"Abr","value":743},{"label":"Mai","value":713},{"label":"Jun","value":508},{"label":"Jul","value":466},{"label":"Ago","value":746},{"label":"Set","value":781},{"label":"Out","value":496},{"label":"Nov","value":471},{"label":"Dez","value":557}];
const MX = 781;
