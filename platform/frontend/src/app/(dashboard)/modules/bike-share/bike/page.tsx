...
const PAGE = "Bike";
const KPIS = [{"l":"Total Bike Share","v":"4.649","t":"+5.7%","d":"up"},{"l":"Bike Ativos","v":"5.894","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"68.8%","t":"+5.8%","d":"up"},{"l":"Score Performance","v":"95","t":"+2.3%","d":"up"}];
const COLS = ["ID","Bike","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bike Share #001","Bike Share #002","6.718","6.357","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Bike Share #002","Bike Share #003","563","6.556","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Bike Share #003","Bike Share #004","189","6.655","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Bike Share #004","Bike Share #005","1.864","7.432","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bike Share #005","Bike Share #001","7.609","4.729","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":647},{"label":"Mar","value":597},{"label":"Abr","value":379},{"label":"Mai","value":378},{"label":"Jun","value":302},{"label":"Jul","value":328},{"label":"Ago","value":672},{"label":"Set","value":314},{"label":"Out","value":470},{"label":"Nov","value":583},{"label":"Dez","value":557}];
const MX = 672;
