...
const PAGE = "Maintain";
const KPIS = [{"l":"Total Bike Share","v":"2.814","t":"-3.4%","d":"down"},{"l":"Maintain Ativos","v":"1.274","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"87.9%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"79","t":"+14.9%","d":"up"}];
const COLS = ["ID","Maintain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bike Share #001","Bike Share #002","8.336","2.255","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Bike Share #002","Bike Share #003","3.555","1.584","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Bike Share #003","Bike Share #004","6.879","6.548","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Bike Share #004","Bike Share #005","3.471","6.709","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bike Share #005","Bike Share #001","1.662","7.201","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":835},{"label":"Fev","value":747},{"label":"Mar","value":919},{"label":"Abr","value":722},{"label":"Mai","value":657},{"label":"Jun","value":770},{"label":"Jul","value":669},{"label":"Ago","value":698},{"label":"Set","value":659},{"label":"Out","value":770},{"label":"Nov","value":639},{"label":"Dez","value":578}];
const MX = 919;
