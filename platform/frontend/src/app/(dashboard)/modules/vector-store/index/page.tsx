...
const ACCENT = "#7c3aed";
const MODULE = "Vector Store Manager";
const PAGE = "Index";
const KPIS = [{"l":"Pedidos/Dia","v":"5077","t":"+2.5%","d":"up"},{"l":"GMV (€)","v":"€90282","t":"-4.0%","d":"down"},{"l":"Conversão (%)","v":"87.1%","t":"+5.8%","d":"up"},{"l":"AOV (€)","v":"€17632","t":"-3.1%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 48224.19","1.577","7.619","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 5016.75","6.718","6.722","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 23089.96","2.156","2.015","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 48354.10","801","4.036","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 39575.42","6.298","3.180","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":652},{"label":"Mar","value":736},{"label":"Abr","value":557},{"label":"Mai","value":846},{"label":"Jun","value":607},{"label":"Jul","value":656},{"label":"Ago","value":541},{"label":"Set","value":722},{"label":"Out","value":819},{"label":"Nov","value":651},{"label":"Dez","value":525}];
const MX = 846;
