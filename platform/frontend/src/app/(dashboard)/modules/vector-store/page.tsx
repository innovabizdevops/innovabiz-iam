...
/* ═══ Vector Store Manager — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "7930", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "37", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€431K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "40696830", cells: ["VEC-8830", "Vector Store Manager Item 1", "7/7/2026", "€46 930"], status: "active" as const },
    { id: "40700401", cells: ["VEC-3401", "Vector Store Manager Item 2", "22/2/2026", "€501"], status: "pending" as const },
    { id: "40703972", cells: ["VEC-6972", "Vector Store Manager Item 3", "9/9/2026", "€4072"], status: "completed" as const },
    { id: "40707543", cells: ["VEC-1543", "Vector Store Manager Item 4", "24/4/2026", "€7643"], status: "warning" as const },
    { id: "40711114", cells: ["VEC-5114", "Vector Store Manager Item 5", "11/11/2026", "€11 214"], status: "active" as const },
];
...
export default function VectorStoreManagerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Vector Store Manager</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Vector Store Manager</p>
                    </div>
                </div>
