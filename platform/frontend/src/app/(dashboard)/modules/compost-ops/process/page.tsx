...
const PAGE = "Process";
const KPIS = [{"l":"Pedidos/Dia","v":"2880","t":"+8.4%","d":"up"},{"l":"GMV (€)","v":"€1467","t":"-4.0%","d":"down"},{"l":"Conversão (%)","v":"91.3%","t":"+0.2%","d":"up"},{"l":"AOV (€)","v":"€52673","t":"-3.1%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 4303.40","7.688","4.374","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 27178.30","1.247","3.590","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 33319.52","5.029","2.879","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 2958.96","5.487","5.418","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 38641.05","7.345","528","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":924},{"label":"Fev","value":905},{"label":"Mar","value":816},{"label":"Abr","value":1034},{"label":"Mai","value":790},{"label":"Jun","value":803},{"label":"Jul","value":912},{"label":"Ago","value":984},{"label":"Set","value":1006},{"label":"Out","value":823},{"label":"Nov","value":791},{"label":"Dez","value":1017}];
const MX = 1034;
