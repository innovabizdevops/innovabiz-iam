...
/* ═══ Composting Operations — Dashboard ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total Registos", value: "4985", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4052", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€175K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1852987885", cells: ["COM-5885", "Composting Operations Item 1", "22/2/2026", "€37 985"], status: "active" as const },
    { id: "1852991456", cells: ["COM-9456", "Composting Operations Item 2", "9/9/2026", "€41 556"], status: "pending" as const },
    { id: "1852995027", cells: ["COM-4027", "Composting Operations Item 3", "24/4/2026", "€45 127"], status: "completed" as const },
    { id: "1852998598", cells: ["COM-7598", "Composting Operations Item 4", "11/11/2026", "€48 698"], status: "warning" as const },
    { id: "1853002169", cells: ["COM-2169", "Composting Operations Item 5", "26/6/2026", "€2269"], status: "active" as const },
];
...
export default function CompostingOperationsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Composting Operations</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Composting Operations</p>
                    </div>
                </div>
