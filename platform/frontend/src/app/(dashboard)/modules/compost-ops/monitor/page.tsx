...
const ACCENT = "#047857";
const MODULE = "Composting Operations";
const PAGE = "Monitor";
const KPIS = [{"l":"Pedidos/Dia","v":"1600","t":"+12.8%","d":"up"},{"l":"GMV (€)","v":"€41017","t":"+16.9%","d":"up"},{"l":"Conversão (%)","v":"66.5%","t":"+13.5%","d":"up"},{"l":"AOV (€)","v":"€95335","t":"+13.3%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 14412.01","6.827","2.803","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 46830.13","4.943","8.376","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 35263.57","7.330","6.645","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 7831.90","8.008","4.133","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 13321.32","2.995","6.884","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":379},{"label":"Mar","value":483},{"label":"Abr","value":482},{"label":"Mai","value":518},{"label":"Jun","value":325},{"label":"Jul","value":671},{"label":"Ago","value":670},{"label":"Set","value":688},{"label":"Out","value":494},{"label":"Nov","value":540},{"label":"Dez","value":556}];
const MX = 688;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#047857'}}>IoT</span></h1>
                </div>
