...
const PAGE = "Attend";
const KPIS = [{"l":"Eventos Planeados","v":"1.869","t":"+15.0%","d":"up"},{"l":"Participantes","v":"714","t":"-2.1%","d":"down"},{"l":"NPS Evento","v":"94","t":"+2.3%","d":"up"},{"l":"Receita (€)","v":"€69772","t":"+7.3%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-19","8.814","2.923","€ 22544.40","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-06","7.118","7.646","€ 5115.42","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-07","4.150","8.176","€ 27314.87","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-12","6.806","7.214","€ 33945.98","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-02","6.118","844","€ 4711.77","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":584},{"label":"Fev","value":930},{"label":"Mar","value":656},{"label":"Abr","value":907},{"label":"Mai","value":613},{"label":"Jun","value":640},{"label":"Jul","value":943},{"label":"Ago","value":746},{"label":"Set","value":628},{"label":"Out","value":694},{"label":"Nov","value":573},{"label":"Dez","value":770}];
const MX = 943;
