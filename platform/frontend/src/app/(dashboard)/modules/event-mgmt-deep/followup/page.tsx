...
const ACCENT = "#e11d48";
const MODULE = "Event Management Deep";
const PAGE = "Follow-Up";
const KPIS = [{"l":"Eventos Planeados","v":"5.550","t":"-4.8%","d":"down"},{"l":"Participantes","v":"4.046","t":"+14.7%","d":"up"},{"l":"NPS Evento","v":"77","t":"+14.9%","d":"up"},{"l":"Receita (€)","v":"€65655","t":"+9.0%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-07","145","776","€ 45206.03","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-25","694","1.193","€ 7922.78","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-21","8.694","3.079","€ 19064.28","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-01","8.376","855","€ 21800.62","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-25","7.814","8.411","€ 22962.49","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":486},{"label":"Fev","value":652},{"label":"Mar","value":413},{"label":"Abr","value":621},{"label":"Mai","value":539},{"label":"Jun","value":326},{"label":"Jul","value":408},{"label":"Ago","value":524},{"label":"Set","value":339},{"label":"Out","value":518},{"label":"Nov","value":535},{"label":"Dez","value":448}];
const MX = 652;
