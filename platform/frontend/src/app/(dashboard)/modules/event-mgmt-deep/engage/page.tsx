...
const PAGE = "Engage";
const KPIS = [{"l":"Eventos Planeados","v":"6.275","t":"-1.0%","d":"down"},{"l":"Participantes","v":"6.311","t":"+2.3%","d":"up"},{"l":"NPS Evento","v":"62","t":"-5.7%","d":"down"},{"l":"Receita (€)","v":"€10240","t":"+8.6%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-15","8.909","240","€ 26704.35","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-20","7.503","1.385","€ 14263.21","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-10","1.799","446","€ 9300.09","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-12","5.258","1.275","€ 33261.18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-18","3.882","6.163","€ 16165.84","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":649},{"label":"Mar","value":686},{"label":"Abr","value":597},{"label":"Mai","value":753},{"label":"Jun","value":652},{"label":"Jul","value":495},{"label":"Ago","value":483},{"label":"Set","value":620},{"label":"Out","value":606},{"label":"Nov","value":838},{"label":"Dez","value":693}];
const MX = 838;
