...
/* ═══ Event Management Deep — Dashboard ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total Registos", value: "5800", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2697", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€275K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "-8%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2099894700", cells: ["EVE-6700", "Event Management Deep Item 1", "9/1/2026", "€44 800"], status: "active" as const },
    { id: "2099898271", cells: ["EVE-1271", "Event Management Deep Item 2", "24/8/2026", "€48 371"], status: "pending" as const },
    { id: "2099901842", cells: ["EVE-4842", "Event Management Deep Item 3", "11/3/2026", "€1942"], status: "completed" as const },
    { id: "2099905413", cells: ["EVE-8413", "Event Management Deep Item 4", "26/10/2026", "€5513"], status: "warning" as const },
    { id: "2099908984", cells: ["EVE-2984", "Event Management Deep Item 5", "13/5/2026", "€9084"], status: "active" as const },
];
...
export default function EventManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Event Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Event Management Deep</p>
                    </div>
                </div>
