...
const PAGE = "Register";
const KPIS = [{"l":"Eventos Planeados","v":"7.404","t":"+0.7%","d":"up"},{"l":"Participantes","v":"8.515","t":"+15.8%","d":"up"},{"l":"NPS Evento","v":"57","t":"+15.1%","d":"up"},{"l":"Receita (€)","v":"€17133","t":"+9.5%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-27","7.649","5.571","€ 41418.37","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-20","4.172","3.003","€ 925.35","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-01","7.066","8.407","€ 12279.10","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-23","6.525","3.361","€ 8230.24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-24","676","5.037","€ 3000.36","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":319},{"label":"Fev","value":414},{"label":"Mar","value":251},{"label":"Abr","value":513},{"label":"Mai","value":368},{"label":"Jun","value":353},{"label":"Jul","value":233},{"label":"Ago","value":225},{"label":"Set","value":318},{"label":"Out","value":446},{"label":"Nov","value":486},{"label":"Dez","value":416}];
const MX = 513;
