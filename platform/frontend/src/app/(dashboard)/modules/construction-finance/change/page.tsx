...
const ACCENT = "#6366f1";
const MODULE = "Construction Finance";
const PAGE = "Change Order";
const KPIS = [{"l":"Total Construction Finance","v":"3.820","t":"+17.3%","d":"up"},{"l":"Change Order Ativos","v":"2.194","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"88.2%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"58","t":"+12.4%","d":"up"}];
const COLS = ["ID","Change Order","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Construction Finance #001","Construction Finance #002","4.409","563","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Construction Finance #002","Construction Finance #003","3.865","1.979","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Construction Finance #003","Construction Finance #004","351","8.276","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Construction Finance #004","Construction Finance #005","5.371","6.405","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Construction Finance #005","Construction Finance #001","2.671","4.956","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":581},{"label":"Fev","value":773},{"label":"Mar","value":732},{"label":"Abr","value":624},{"label":"Mai","value":768},{"label":"Jun","value":790},{"label":"Jul","value":756},{"label":"Ago","value":778},{"label":"Set","value":708},{"label":"Out","value":440},{"label":"Nov","value":451},{"label":"Dez","value":803}];
const MX = 803;
