...
const PAGE = "Budget";
const KPIS = [{"l":"Total Construction Finance","v":"1.739","t":"-2.3%","d":"down"},{"l":"Budget Ativos","v":"€25157","t":"+7.7%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"-2.6%","d":"down"},{"l":"Score Performance","v":"72","t":"+11.9%","d":"up"}];
const COLS = ["ID","Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Construction Finance #001","€ 17931.67","4.089","1.470","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Construction Finance #002","€ 1779.54","5.590","4.811","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Construction Finance #003","€ 7941.30","775","2.353","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Construction Finance #004","€ 43051.41","6.442","7.492","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Construction Finance #005","€ 17319.25","141","8.946","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":341},{"label":"Mar","value":418},{"label":"Abr","value":406},{"label":"Mai","value":403},{"label":"Jun","value":580},{"label":"Jul","value":309},{"label":"Ago","value":524},{"label":"Set","value":583},{"label":"Out","value":400},{"label":"Nov","value":527},{"label":"Dez","value":516}];
const MX = 688;
