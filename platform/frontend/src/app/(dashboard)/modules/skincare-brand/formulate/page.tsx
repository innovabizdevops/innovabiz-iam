...
const KPIS = [{"l":"Formulários Ativos","v":"4.897","t":"+13.4%","d":"up"},{"l":"Submissões/Dia","v":"2093","t":"-5.9%","d":"down"},{"l":"Documentos Gerados","v":"4.334","t":"+2.8%","d":"up"},{"l":"Templates","v":"8.520","t":"+9.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.728","2026-01-16","5.529","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.099","2026-02-01","2.645","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.901","2026-01-28","4.120","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.266","2026-01-25","380","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","836","2026-03-28","7.075","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":543},{"label":"Mar","value":341},{"label":"Abr","value":456},{"label":"Mai","value":344},{"label":"Jun","value":363},{"label":"Jul","value":321},{"label":"Ago","value":662},{"label":"Set","value":661},{"label":"Out","value":642},{"label":"Nov","value":316},{"label":"Dez","value":435}];
const MX = 662;
