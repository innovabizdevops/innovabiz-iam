...
const KPIS = [
    { label: "Total Registos", value: "7203", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "563", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€399K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1304312303", cells: ["SKI-6303", "Skincare Brand Item 1", "8/12/2026", "€12 403"], status: "active" as const },
    { id: "1304315874", cells: ["SKI-9874", "Skincare Brand Item 2", "23/7/2026", "€15 974"], status: "pending" as const },
    { id: "1304319445", cells: ["SKI-4445", "Skincare Brand Item 3", "10/2/2026", "€19 545"], status: "completed" as const },
    { id: "1304323016", cells: ["SKI-8016", "Skincare Brand Item 4", "25/9/2026", "€23 116"], status: "warning" as const },
    { id: "1304326587", cells: ["SKI-2587", "Skincare Brand Item 5", "12/4/2026", "€26 687"], status: "active" as const },
];
...
export default function SkincareBrandPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Skincare Brand</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Skincare Brand</p>
                    </div>
                </div>
