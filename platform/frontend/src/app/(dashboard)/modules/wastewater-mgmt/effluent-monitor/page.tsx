...
/* ═══ Wastewater Mgmt — Effluent Monitor ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "4016", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "455", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "968", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "80%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1193984563", cells: ["WAS-9563", "Effluent Monitor Item 1", "24/8/2026", "€34 663"], status: "active" as const },
    { id: "1193988134", cells: ["WAS-4134", "Effluent Monitor Item 2", "11/3/2026", "€38 234"], status: "pending" as const },
    { id: "1193991705", cells: ["WAS-7705", "Effluent Monitor Item 3", "26/10/2026", "€41 805"], status: "completed" as const },
    { id: "1193995276", cells: ["WAS-2276", "Effluent Monitor Item 4", "13/5/2026", "€45 376"], status: "warning" as const },
    { id: "1193998847", cells: ["WAS-5847", "Effluent Monitor Item 5", "28/12/2026", "€48 947"], status: "active" as const },
];
...
export default function WastewaterMgmtEffluentMonitorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Effluent Monitor</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Wastewater Mgmt • Effluent Monitor</p>
                    </div>
                </div>
