...
/* ═══ Wastewater Mgmt — Wwtp Process ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "4150", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "253", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2850", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "751671897", cells: ["WAS-1897", "Wwtp Process Item 1", "26/10/2026", "€21 997"], status: "active" as const },
    { id: "751675468", cells: ["WAS-5468", "Wwtp Process Item 2", "13/5/2026", "€25 568"], status: "pending" as const },
    { id: "751679039", cells: ["WAS-9039", "Wwtp Process Item 3", "28/12/2026", "€29 139"], status: "completed" as const },
    { id: "751682610", cells: ["WAS-3610", "Wwtp Process Item 4", "15/7/2026", "€32 710"], status: "warning" as const },
    { id: "751686181", cells: ["WAS-7181", "Wwtp Process Item 5", "2/2/2026", "€36 281"], status: "active" as const },
];
...
export default function WastewaterMgmtWwtpProcessPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wwtp Process</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Wastewater Mgmt • Wwtp Process</p>
                    </div>
                </div>
