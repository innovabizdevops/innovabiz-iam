...
/* ═══ Wastewater Mgmt — Pump Station ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "477", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "156", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2794", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1726629240", cells: ["WAS-7240", "Pump Station Item 1", "1/1/2026", "€29 340"], status: "active" as const },
    { id: "1726632811", cells: ["WAS-1811", "Pump Station Item 2", "16/8/2026", "€32 911"], status: "pending" as const },
    { id: "1726636382", cells: ["WAS-5382", "Pump Station Item 3", "3/3/2026", "€36 482"], status: "completed" as const },
    { id: "1726639953", cells: ["WAS-8953", "Pump Station Item 4", "18/10/2026", "€40 053"], status: "warning" as const },
    { id: "1726643524", cells: ["WAS-3524", "Pump Station Item 5", "5/5/2026", "€43 624"], status: "active" as const },
];
...
export default function WastewaterMgmtPumpStationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pump Station</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Wastewater Mgmt • Pump Station</p>
                    </div>
                </div>
