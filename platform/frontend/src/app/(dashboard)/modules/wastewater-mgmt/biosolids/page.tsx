...
/* ═══ Wastewater Mgmt — Biosolids ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "77", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "424", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3705", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1315377556", cells: ["WAS-1556", "Biosolids Item 1", "25/5/2026", "€27 656"], status: "active" as const },
    { id: "1315381127", cells: ["WAS-5127", "Biosolids Item 2", "12/12/2026", "€31 227"], status: "pending" as const },
    { id: "1315384698", cells: ["WAS-8698", "Biosolids Item 3", "27/7/2026", "€34 798"], status: "completed" as const },
    { id: "1315388269", cells: ["WAS-3269", "Biosolids Item 4", "14/2/2026", "€38 369"], status: "warning" as const },
    { id: "1315391840", cells: ["WAS-6840", "Biosolids Item 5", "1/9/2026", "€41 940"], status: "active" as const },
];
...
export default function WastewaterMgmtBiosolidsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Biosolids</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Wastewater Mgmt • Biosolids</p>
                    </div>
                </div>
