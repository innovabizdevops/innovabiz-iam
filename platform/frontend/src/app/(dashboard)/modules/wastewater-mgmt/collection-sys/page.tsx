...
/* ═══ Wastewater Mgmt — Collection Sys ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "981", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "157", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2348", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1514982073", cells: ["WAS-4073", "Collection Sys Item 1", "18/2/2026", "€32 173"], status: "active" as const },
    { id: "1514985644", cells: ["WAS-7644", "Collection Sys Item 2", "5/9/2026", "€35 744"], status: "pending" as const },
    { id: "1514989215", cells: ["WAS-2215", "Collection Sys Item 3", "20/4/2026", "€39 315"], status: "completed" as const },
    { id: "1514992786", cells: ["WAS-5786", "Collection Sys Item 4", "7/11/2026", "€42 886"], status: "warning" as const },
    { id: "1514996357", cells: ["WAS-9357", "Collection Sys Item 5", "22/6/2026", "€46 457"], status: "active" as const },
];
...
export default function WastewaterMgmtCollectionSysPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Collection Sys</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Wastewater Mgmt • Collection Sys</p>
                    </div>
                </div>
