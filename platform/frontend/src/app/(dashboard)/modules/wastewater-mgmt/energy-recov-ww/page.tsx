...
/* ═══ Wastewater Mgmt — Energy Recov Ww ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "3934", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "367", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "697", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1741745051", cells: ["WAS-3051", "Energy Recov Ww Item 1", "12/12/2026", "€45 151"], status: "active" as const },
    { id: "1741748622", cells: ["WAS-6622", "Energy Recov Ww Item 2", "27/7/2026", "€48 722"], status: "pending" as const },
    { id: "1741752193", cells: ["WAS-1193", "Energy Recov Ww Item 3", "14/2/2026", "€2293"], status: "completed" as const },
    { id: "1741755764", cells: ["WAS-4764", "Energy Recov Ww Item 4", "1/9/2026", "€5864"], status: "warning" as const },
    { id: "1741759335", cells: ["WAS-8335", "Energy Recov Ww Item 5", "16/4/2026", "€9435"], status: "active" as const },
];
...
export default function WastewaterMgmtEnergyRecovWwPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Energy Recov Ww</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Wastewater Mgmt • Energy Recov Ww</p>
                    </div>
                </div>
