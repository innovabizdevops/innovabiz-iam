...
/* ═══ Wastewater Mgmt — Permit Comply Ww ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "3002", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "367", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1362", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "92%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1576554235", cells: ["WAS-7235", "Permit Comply Ww Item 1", "12/8/2026", "€4335"], status: "active" as const },
    { id: "1576557806", cells: ["WAS-1806", "Permit Comply Ww Item 2", "27/3/2026", "€7906"], status: "pending" as const },
    { id: "1576561377", cells: ["WAS-5377", "Permit Comply Ww Item 3", "14/10/2026", "€11 477"], status: "completed" as const },
    { id: "1576564948", cells: ["WAS-8948", "Permit Comply Ww Item 4", "1/5/2026", "€15 048"], status: "warning" as const },
    { id: "1576568519", cells: ["WAS-3519", "Permit Comply Ww Item 5", "16/12/2026", "€18 619"], status: "active" as const },
];
...
export default function WastewaterMgmtPermitComplyWwPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Permit Comply Ww</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Wastewater Mgmt • Permit Comply Ww</p>
                    </div>
                </div>
