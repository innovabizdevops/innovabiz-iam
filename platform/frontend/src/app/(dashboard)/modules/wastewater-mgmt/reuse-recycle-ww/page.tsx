...
/* ═══ Wastewater Mgmt — Reuse Recycle Ww ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "4343", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "361", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "234", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1365884181", cells: ["WAS-9181", "Reuse Recycle Ww Item 1", "26/10/2026", "€34 281"], status: "active" as const },
    { id: "1365887752", cells: ["WAS-3752", "Reuse Recycle Ww Item 2", "13/5/2026", "€37 852"], status: "pending" as const },
    { id: "1365891323", cells: ["WAS-7323", "Reuse Recycle Ww Item 3", "28/12/2026", "€41 423"], status: "completed" as const },
    { id: "1365894894", cells: ["WAS-1894", "Reuse Recycle Ww Item 4", "15/7/2026", "€44 994"], status: "warning" as const },
    { id: "1365898465", cells: ["WAS-5465", "Reuse Recycle Ww Item 5", "2/2/2026", "€48 565"], status: "active" as const },
];
...
export default function WastewaterMgmtReuseRecycleWwPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Reuse Recycle Ww</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Wastewater Mgmt • Reuse Recycle Ww</p>
                    </div>
                </div>
