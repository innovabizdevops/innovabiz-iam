...
/* ═══ Wastewater Mgmt — Odor Control ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "2368", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "53", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1931", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "921691569", cells: ["WAS-2569", "Odor Control Item 1", "2/10/2026", "€41 669"], status: "active" as const },
    { id: "921695140", cells: ["WAS-6140", "Odor Control Item 2", "17/5/2026", "€45 240"], status: "pending" as const },
    { id: "921698711", cells: ["WAS-9711", "Odor Control Item 3", "4/12/2026", "€48 811"], status: "completed" as const },
    { id: "921702282", cells: ["WAS-4282", "Odor Control Item 4", "19/7/2026", "€2382"], status: "warning" as const },
    { id: "921705853", cells: ["WAS-7853", "Odor Control Item 5", "6/2/2026", "€5953"], status: "active" as const },
];
...
export default function WastewaterMgmtOdorControlPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Odor Control</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Wastewater Mgmt • Odor Control</p>
                    </div>
                </div>
