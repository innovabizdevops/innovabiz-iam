...
/* ═══ Wastewater Mgmt — Capacity Analyze ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "139", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "486", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2069", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1085614050", cells: ["WAS-8050", "Capacity Analyze Item 1", "11/7/2026", "€14 150"], status: "active" as const },
    { id: "1085617621", cells: ["WAS-2621", "Capacity Analyze Item 2", "26/2/2026", "€17 721"], status: "pending" as const },
    { id: "1085621192", cells: ["WAS-6192", "Capacity Analyze Item 3", "13/9/2026", "€21 292"], status: "completed" as const },
    { id: "1085624763", cells: ["WAS-9763", "Capacity Analyze Item 4", "28/4/2026", "€24 863"], status: "warning" as const },
    { id: "1085628334", cells: ["WAS-4334", "Capacity Analyze Item 5", "15/11/2026", "€28 434"], status: "active" as const },
];
...
export default function WastewaterMgmtCapacityAnalyzePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Capacity Analyze</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Wastewater Mgmt • Capacity Analyze</p>
                    </div>
                </div>
