...
const PAGE = "Contract";
const KPIS = [{"l":"Formulários Ativos","v":"3.923","t":"+14.8%","d":"up"},{"l":"Submissões/Dia","v":"2280","t":"+10.0%","d":"up"},{"l":"Documentos Gerados","v":"3.725","t":"+14.5%","d":"up"},{"l":"Templates","v":"8.834","t":"+1.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.332","2026-02-06","2.116","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.961","2026-02-23","3.906","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.185","2026-03-11","8.429","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.197","2026-02-07","3.932","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.363","2026-02-13","3.074","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":752},{"label":"Mar","value":829},{"label":"Abr","value":869},{"label":"Mai","value":664},{"label":"Jun","value":799},{"label":"Jul","value":859},{"label":"Ago","value":611},{"label":"Set","value":705},{"label":"Out","value":633},{"label":"Nov","value":729},{"label":"Dez","value":779}];
const MX = 869;
