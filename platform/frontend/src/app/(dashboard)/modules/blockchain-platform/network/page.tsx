...
const PAGE = "Network";
const KPIS = [{"l":"Formulários Ativos","v":"7.793","t":"+16.5%","d":"up"},{"l":"Submissões/Dia","v":"4493","t":"+13.5%","d":"up"},{"l":"Documentos Gerados","v":"8.098","t":"-2.8%","d":"down"},{"l":"Templates","v":"5.986","t":"+9.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.551","2026-02-10","7.780","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.261","2026-02-17","2.397","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.375","2026-01-14","1.850","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.724","2026-03-22","6.243","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.791","2026-01-01","4.591","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":474},{"label":"Fev","value":550},{"label":"Mar","value":454},{"label":"Abr","value":332},{"label":"Mai","value":381},{"label":"Jun","value":377},{"label":"Jul","value":583},{"label":"Ago","value":535},{"label":"Set","value":287},{"label":"Out","value":566},{"label":"Nov","value":423},{"label":"Dez","value":334}];
const MX = 583;
