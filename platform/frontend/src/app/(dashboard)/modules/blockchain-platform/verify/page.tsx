...
const PAGE = "Verify";
const KPIS = [{"l":"Formulários Ativos","v":"7.642","t":"+12.5%","d":"up"},{"l":"Submissões/Dia","v":"1631","t":"+5.9%","d":"up"},{"l":"Documentos Gerados","v":"943","t":"-1.4%","d":"down"},{"l":"Templates","v":"1.390","t":"+3.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.873","2026-01-14","5.934","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.105","2026-01-21","7.327","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.717","2026-03-21","8.151","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.983","2026-03-18","3.854","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.617","2026-02-01","2.499","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":235},{"label":"Mar","value":355},{"label":"Abr","value":561},{"label":"Mai","value":403},{"label":"Jun","value":611},{"label":"Jul","value":517},{"label":"Ago","value":236},{"label":"Set","value":316},{"label":"Out","value":354},{"label":"Nov","value":479},{"label":"Dez","value":425}];
const MX = 611;
