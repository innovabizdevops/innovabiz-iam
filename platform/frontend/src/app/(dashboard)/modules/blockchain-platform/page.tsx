...
/* ═══ Blockchain Platform — Dashboard ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total Registos", value: "1267", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1713", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€54K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "-25%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1099564467", cells: ["BLO-8467", "Blockchain Platform Item 1", "16/4/2026", "€14 567"], status: "active" as const },
    { id: "1099568038", cells: ["BLO-3038", "Blockchain Platform Item 2", "3/11/2026", "€18 138"], status: "pending" as const },
    { id: "1099571609", cells: ["BLO-6609", "Blockchain Platform Item 3", "18/6/2026", "€21 709"], status: "completed" as const },
    { id: "1099575180", cells: ["BLO-1180", "Blockchain Platform Item 4", "5/1/2026", "€25 280"], status: "warning" as const },
    { id: "1099578751", cells: ["BLO-4751", "Blockchain Platform Item 5", "20/8/2026", "€28 851"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Blockchain Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Blockchain Platform</p>
                    </div>
                </div>
