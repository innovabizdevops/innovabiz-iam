...
const ACCENT = "#8b5cf6";
const MODULE = "Blockchain Platform";
const PAGE = "Token";
const KPIS = [{"l":"Formulários Ativos","v":"8.014","t":"-5.7%","d":"down"},{"l":"Submissões/Dia","v":"101","t":"+10.6%","d":"up"},{"l":"Documentos Gerados","v":"8.342","t":"-0.5%","d":"down"},{"l":"Templates","v":"4.707","t":"-4.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.516","2026-03-01","2.146","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.799","2026-02-11","1.476","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.731","2026-01-03","8.826","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.704","2026-03-09","4.196","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.802","2026-02-15","7.180","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":306},{"label":"Mar","value":304},{"label":"Abr","value":255},{"label":"Mai","value":367},{"label":"Jun","value":427},{"label":"Jul","value":479},{"label":"Ago","value":589},{"label":"Set","value":633},{"label":"Out","value":577},{"label":"Nov","value":390},{"label":"Dez","value":514}];
const MX = 633;
