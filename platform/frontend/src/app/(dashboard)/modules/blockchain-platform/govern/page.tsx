...
const PAGE = "Govern";
const KPIS = [{"l":"Formulários Ativos","v":"5.929","t":"+6.3%","d":"up"},{"l":"Submissões/Dia","v":"2971","t":"-3.2%","d":"down"},{"l":"Documentos Gerados","v":"5.524","t":"+14.6%","d":"up"},{"l":"Templates","v":"7.827","t":"+10.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.098","2026-02-20","8.768","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","721","2026-01-10","6.240","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.284","2026-02-25","2.228","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.104","2026-03-07","2.328","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.471","2026-03-09","5.164","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":701},{"label":"Mar","value":336},{"label":"Abr","value":430},{"label":"Mai","value":459},{"label":"Jun","value":437},{"label":"Jul","value":466},{"label":"Ago","value":605},{"label":"Set","value":390},{"label":"Out","value":462},{"label":"Nov","value":336},{"label":"Dez","value":661}];
const MX = 701;
