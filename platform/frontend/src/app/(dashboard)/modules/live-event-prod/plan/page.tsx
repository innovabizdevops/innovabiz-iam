...
const ACCENT = "#6366f1";
const MODULE = "Live Event Production";
const PAGE = "Plan";
const KPIS = [{"l":"Eventos Planeados","v":"5.815","t":"+5.4%","d":"up"},{"l":"Participantes","v":"7.963","t":"+1.6%","d":"up"},{"l":"NPS Evento","v":"60","t":"+8.1%","d":"up"},{"l":"Receita (€)","v":"€74866","t":"+10.7%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-18","6.879","5.356","€ 12541.50","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-23","2.857","6.240","€ 13418.49","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-24","4.104","8.537","€ 30044.49","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-27","5.123","7.662","€ 19644.01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-11","8.925","4.463","€ 29049.27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":934},{"label":"Fev","value":936},{"label":"Mar","value":858},{"label":"Abr","value":907},{"label":"Mai","value":669},{"label":"Jun","value":697},{"label":"Jul","value":722},{"label":"Ago","value":957},{"label":"Set","value":763},{"label":"Out","value":947},{"label":"Nov","value":962},{"label":"Dez","value":964}];
const MX = 964;
