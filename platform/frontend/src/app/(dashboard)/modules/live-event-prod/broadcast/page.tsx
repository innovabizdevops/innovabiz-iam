...
const KPIS = [{"l":"Eventos Planeados","v":"3.250","t":"+7.3%","d":"up"},{"l":"Participantes","v":"3.948","t":"+3.9%","d":"up"},{"l":"NPS Evento","v":"74","t":"+17.8%","d":"up"},{"l":"Receita (€)","v":"€81919","t":"+3.1%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-10","3.092","5.834","€ 44354.09","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-11","6.807","4.668","€ 14514.87","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-17","4.875","1.059","€ 36496.01","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-16","3.539","976","€ 23097.22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-08","7.409","3.133","€ 31295.42","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":422},{"label":"Mar","value":703},{"label":"Abr","value":642},{"label":"Mai","value":556},{"label":"Jun","value":557},{"label":"Jul","value":680},{"label":"Ago","value":754},{"label":"Set","value":435},{"label":"Out","value":756},{"label":"Nov","value":672},{"label":"Dez","value":709}];
const MX = 756;
