...
const PAGE = "Crew";
const KPIS = [{"l":"Eventos Planeados","v":"3.397","t":"+1.0%","d":"up"},{"l":"Participantes","v":"962","t":"+2.2%","d":"up"},{"l":"NPS Evento","v":"72","t":"+15.0%","d":"up"},{"l":"Receita (€)","v":"€64828","t":"-5.0%","d":"down"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-09","5.092","4.399","€ 41379.87","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-11","7.751","6.909","€ 36058.66","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-16","7.545","1.415","€ 47594.77","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-13","5.660","2.887","€ 14602.99","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-28","352","8.125","€ 35125.52","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":1031},{"label":"Mar","value":725},{"label":"Abr","value":913},{"label":"Mai","value":942},{"label":"Jun","value":991},{"label":"Jul","value":888},{"label":"Ago","value":683},{"label":"Set","value":825},{"label":"Out","value":1049},{"label":"Nov","value":805},{"label":"Dez","value":710}];
const MX = 1049;
