...
export default function LiveEventProdPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Live Event Prod</h1><p className="text-sm text-muted-foreground">Live Event Prod • iBOS Enterprise</p></div>
