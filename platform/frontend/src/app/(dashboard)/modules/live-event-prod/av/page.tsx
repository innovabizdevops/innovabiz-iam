...
const PAGE = "AV";
const KPIS = [{"l":"Eventos Planeados","v":"993","t":"+10.9%","d":"up"},{"l":"Participantes","v":"7.498","t":"+7.6%","d":"up"},{"l":"NPS Evento","v":"88","t":"+5.2%","d":"up"},{"l":"Receita (€)","v":"€32968","t":"-1.1%","d":"down"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-03","7.927","3.124","€ 5362.55","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-28","8.665","6.986","€ 29374.07","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-14","7.083","8.013","€ 34709.34","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-27","7.758","2.253","€ 37931.19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-12","873","7.250","€ 32416.92","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":937},{"label":"Fev","value":683},{"label":"Mar","value":905},{"label":"Abr","value":586},{"label":"Mai","value":632},{"label":"Jun","value":903},{"label":"Jul","value":698},{"label":"Ago","value":911},{"label":"Set","value":908},{"label":"Out","value":613},{"label":"Nov","value":600},{"label":"Dez","value":762}];
const MX = 937;
