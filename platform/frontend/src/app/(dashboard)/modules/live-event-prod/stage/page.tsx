...
const PAGE = "Stage";
const KPIS = [{"l":"Eventos Planeados","v":"5.415","t":"+0.7%","d":"up"},{"l":"Participantes","v":"7.553","t":"+0.2%","d":"up"},{"l":"NPS Evento","v":"79","t":"+13.8%","d":"up"},{"l":"Receita (€)","v":"€72228","t":"+14.4%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-28","4.773","3.975","€ 16288.11","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-19","1.725","3.028","€ 44358.31","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-15","1.980","704","€ 27726.07","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-22","3.255","3.456","€ 9968.90","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-19","7.779","2.778","€ 6431.26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":452},{"label":"Fev","value":782},{"label":"Mar","value":578},{"label":"Abr","value":824},{"label":"Mai","value":448},{"label":"Jun","value":745},{"label":"Jul","value":471},{"label":"Ago","value":783},{"label":"Set","value":581},{"label":"Out","value":831},{"label":"Nov","value":630},{"label":"Dez","value":761}];
const MX = 831;
