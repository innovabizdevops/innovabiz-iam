...
export default function Co2CapturePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Co2 Capture</h1><p className="text-sm text-muted-foreground">Co2 Capture • iBOS Enterprise</p></div>
