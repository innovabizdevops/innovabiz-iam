...
const ACCENT = "#6366f1";
const MODULE = "CO2 Capture Tech";
const PAGE = "Point Source";
const KPIS = [{"l":"Total Co2 Capture","v":"2.920","t":"+6.1%","d":"up"},{"l":"Point Source Ativos","v":"4.321","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"67.0%","t":"+1.5%","d":"up"},{"l":"Score Performance","v":"91","t":"+13.7%","d":"up"}];
const COLS = ["ID","Point Source","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Co2 Capture #001","Co2 Capture #002","1.053","4.115","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Co2 Capture #002","Co2 Capture #003","671","4.924","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Co2 Capture #003","Co2 Capture #004","4.684","852","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Co2 Capture #004","Co2 Capture #005","5.455","6.385","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Co2 Capture #005","Co2 Capture #001","4.885","5.751","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":317},{"label":"Mar","value":599},{"label":"Abr","value":440},{"label":"Mai","value":441},{"label":"Jun","value":518},{"label":"Jul","value":411},{"label":"Ago","value":444},{"label":"Set","value":652},{"label":"Out","value":376},{"label":"Nov","value":406},{"label":"Dez","value":300}];
const MX = 652;
