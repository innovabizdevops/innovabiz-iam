...
const KPIS = [{"l":"Integrações Ativas","v":"5.562","t":"+0.1%","d":"up"},{"l":"Chamadas/Hora","v":"2455","t":"+6.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"81.4%","t":"-5.3%","d":"down"},{"l":"Latência Média (ms)","v":"160ms","t":"+13.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.841","1.774","77.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.384","8.857","97.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.465","5.024","96.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.571","1.819","82.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.923","7.956","94.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":424},{"label":"Mar","value":519},{"label":"Abr","value":577},{"label":"Mai","value":686},{"label":"Jun","value":691},{"label":"Jul","value":388},{"label":"Ago","value":576},{"label":"Set","value":382},{"label":"Out","value":668},{"label":"Nov","value":557},{"label":"Dez","value":432}];
const MX = 691;
