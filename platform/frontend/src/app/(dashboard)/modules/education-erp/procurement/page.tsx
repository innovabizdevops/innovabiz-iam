...
const KPIS = [{"l":"Fornecedores Ativos","v":"7.745","t":"+0.9%","d":"up"},{"l":"Contratos (€M)","v":"€3.6M","t":"+17.4%","d":"up"},{"l":"On-Time Delivery (%)","v":"75.6%","t":"+0.9%","d":"up"},{"l":"Score Médio","v":"93","t":"-1.8%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","78.7%","€ 37868.19","2.541","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","78.3%","€ 10700.29","1.147","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","99.8%","€ 1200.37","6.085","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","80.8%","€ 44125.65","8.480","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","84.5%","€ 49832.75","8.287","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":769},{"label":"Fev","value":725},{"label":"Mar","value":709},{"label":"Abr","value":1012},{"label":"Mai","value":784},{"label":"Jun","value":923},{"label":"Jul","value":1054},{"label":"Ago","value":1032},{"label":"Set","value":766},{"label":"Out","value":872},{"label":"Nov","value":1082},{"label":"Dez","value":755}];
const MX = 1082;
