...
const ACCENT = "#6366f1";
const MODULE = "Education ERP";
const PAGE = "Asset";
const KPIS = [{"l":"Ativos Registados","v":"8.588","t":"+1.5%","d":"up"},{"l":"Valor Total (€M)","v":"€41.4M","t":"+8.1%","d":"up"},{"l":"Depreciação Anual (€)","v":"€18616","t":"+5.7%","d":"up"},{"l":"Ativos em Garantia","v":"8.032","t":"+-0.0%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 36580.72","3.145","€ 1985.31","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 9866.72","2.836","€ 48419.18","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 16709.28","7.060","€ 12321.10","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 47263.35","4.673","€ 34555.41","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 5395.71","2.314","€ 17305.38","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":939},{"label":"Mar","value":906},{"label":"Abr","value":951},{"label":"Mai","value":865},{"label":"Jun","value":687},{"label":"Jul","value":973},{"label":"Ago","value":1047},{"label":"Set","value":1082},{"label":"Out","value":735},{"label":"Nov","value":875},{"label":"Dez","value":800}];
const MX = 1082;
