...
const PAGE = "HR";
const KPIS = [{"l":"Total Education Erp","v":"8.852","t":"+11.7%","d":"up"},{"l":"HR Ativos","v":"2.602","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"69.4%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"65","t":"+5.1%","d":"up"}];
const COLS = ["ID","HR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education Erp #001","Education Erp #002","6.052","6.070","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Education Erp #002","Education Erp #003","8.499","7.027","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Education Erp #003","Education Erp #004","1.386","4.633","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Education Erp #004","Education Erp #005","8.448","1.724","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education Erp #005","Education Erp #001","4.092","5.826","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":537},{"label":"Mar","value":617},{"label":"Abr","value":827},{"label":"Mai","value":524},{"label":"Jun","value":528},{"label":"Jul","value":816},{"label":"Ago","value":866},{"label":"Set","value":613},{"label":"Out","value":627},{"label":"Nov","value":535},{"label":"Dez","value":507}];
const MX = 866;
