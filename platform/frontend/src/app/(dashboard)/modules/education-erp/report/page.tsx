...
const PAGE = "Report";
const KPIS = [{"l":"Total Education Erp","v":"574","t":"+15.3%","d":"up"},{"l":"Report Ativos","v":"6.479","t":"+1.4%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"77","t":"+16.1%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education Erp #001","Education Erp #002","2.372","4.353","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Education Erp #002","Education Erp #003","8.702","6.382","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Education Erp #003","Education Erp #004","1.506","5.165","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Education Erp #004","Education Erp #005","7.778","8.588","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education Erp #005","Education Erp #001","7.258","8.892","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":475},{"label":"Mar","value":543},{"label":"Abr","value":623},{"label":"Mai","value":593},{"label":"Jun","value":785},{"label":"Jul","value":438},{"label":"Ago","value":826},{"label":"Set","value":639},{"label":"Out","value":802},{"label":"Nov","value":680},{"label":"Dez","value":816}];
const MX = 826;
