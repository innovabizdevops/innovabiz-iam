...
const PAGE = "Finance";
const KPIS = [{"l":"Total Education Erp","v":"229","t":"+4.0%","d":"up"},{"l":"Finance Ativos","v":"1.480","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"79.2%","t":"+16.1%","d":"up"},{"l":"Score Performance","v":"69","t":"+2.7%","d":"up"}];
const COLS = ["ID","Finance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education Erp #001","Education Erp #002","2.030","7.590","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Education Erp #002","Education Erp #003","4.276","3.863","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Education Erp #003","Education Erp #004","1.708","825","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Education Erp #004","Education Erp #005","2.796","7.101","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education Erp #005","Education Erp #001","7.088","5.844","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":369},{"label":"Fev","value":475},{"label":"Mar","value":455},{"label":"Abr","value":392},{"label":"Mai","value":338},{"label":"Jun","value":427},{"label":"Jul","value":584},{"label":"Ago","value":545},{"label":"Set","value":475},{"label":"Out","value":310},{"label":"Nov","value":485},{"label":"Dez","value":402}];
const MX = 584;
