...
const PAGE = "Grant";
const KPIS = [{"l":"Total Arts Council","v":"3.570","t":"+12.8%","d":"up"},{"l":"Grant Ativos","v":"5.184","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"95","t":"+9.5%","d":"up"}];
const COLS = ["ID","Grant","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arts Council #001","Arts Council #002","6.995","8.037","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Arts Council #002","Arts Council #003","6.163","2.205","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Arts Council #003","Arts Council #004","7.738","2.362","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Arts Council #004","Arts Council #005","2.421","8.104","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arts Council #005","Arts Council #001","4.638","4.953","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":549},{"label":"Fev","value":748},{"label":"Mar","value":673},{"label":"Abr","value":756},{"label":"Mai","value":697},{"label":"Jun","value":810},{"label":"Jul","value":625},{"label":"Ago","value":817},{"label":"Set","value":484},{"label":"Out","value":476},{"label":"Nov","value":719},{"label":"Dez","value":644}];
const MX = 817;
