...
const ACCENT = "#ec4899";
const MODULE = "Arts Council";
const PAGE = "Venue";
const KPIS = [{"l":"Total Arts Council","v":"7.716","t":"+6.5%","d":"up"},{"l":"Venue Ativos","v":"6.854","t":"+11.4%","d":"up"},{"l":"Eficiência (%)","v":"67.4%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"95","t":"+10.7%","d":"up"}];
const COLS = ["ID","Venue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arts Council #001","Arts Council #002","6.447","8.574","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Arts Council #002","Arts Council #003","2.177","3.325","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Arts Council #003","Arts Council #004","4.510","1.526","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Arts Council #004","Arts Council #005","4.472","3.016","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arts Council #005","Arts Council #001","2.950","435","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":861},{"label":"Mar","value":1059},{"label":"Abr","value":902},{"label":"Mai","value":898},{"label":"Jun","value":1033},{"label":"Jul","value":719},{"label":"Ago","value":924},{"label":"Set","value":994},{"label":"Out","value":1017},{"label":"Nov","value":772},{"label":"Dez","value":1025}];
const MX = 1059;
