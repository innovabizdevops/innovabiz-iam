...
const KPIS = [
    { label: "Total Registos", value: "9913", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1062", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€292K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "-21%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "121977813", cells: ["ART-1813", "Arts Council Item 1", "14/10/2026", "€27 913"], status: "active" as const },
    { id: "121981384", cells: ["ART-5384", "Arts Council Item 2", "1/5/2026", "€31 484"], status: "pending" as const },
    { id: "121984955", cells: ["ART-8955", "Arts Council Item 3", "16/12/2026", "€35 055"], status: "completed" as const },
    { id: "121988526", cells: ["ART-3526", "Arts Council Item 4", "3/7/2026", "€38 626"], status: "warning" as const },
    { id: "121992097", cells: ["ART-7097", "Arts Council Item 5", "18/2/2026", "€42 197"], status: "active" as const },
];
...
export default function ArtsCouncilPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Arts Council</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Arts Council</p>
                    </div>
                </div>
