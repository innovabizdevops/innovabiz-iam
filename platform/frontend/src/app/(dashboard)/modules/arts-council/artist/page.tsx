...
const PAGE = "Artist";
const KPIS = [{"l":"Total Arts Council","v":"5.055","t":"+16.5%","d":"up"},{"l":"Artist Ativos","v":"6.742","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"90.3%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"85","t":"+8.8%","d":"up"}];
const COLS = ["ID","Artist","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arts Council #001","Arts Council #002","4.566","8.604","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Arts Council #002","Arts Council #003","5.771","2.307","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Arts Council #003","Arts Council #004","8.533","7.759","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Arts Council #004","Arts Council #005","4.797","3.396","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arts Council #005","Arts Council #001","7.512","1.603","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":760},{"label":"Mar","value":815},{"label":"Abr","value":690},{"label":"Mai","value":713},{"label":"Jun","value":921},{"label":"Jul","value":723},{"label":"Ago","value":571},{"label":"Set","value":702},{"label":"Out","value":897},{"label":"Nov","value":618},{"label":"Dez","value":892}];
const MX = 921;
