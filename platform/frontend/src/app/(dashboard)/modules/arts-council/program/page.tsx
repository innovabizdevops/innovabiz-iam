...
const PAGE = "Program";
const KPIS = [{"l":"Total Arts Council","v":"5.847","t":"-3.9%","d":"down"},{"l":"Program Ativos","v":"4.248","t":"+15.9%","d":"up"},{"l":"Eficiência (%)","v":"93.6%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"65","t":"-3.7%","d":"down"}];
const COLS = ["ID","Program","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arts Council #001","Arts Council #002","2.828","3.426","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Arts Council #002","Arts Council #003","5.597","8.128","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Arts Council #003","Arts Council #004","7.269","5.633","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Arts Council #004","Arts Council #005","7.668","6.921","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arts Council #005","Arts Council #001","4.245","5.210","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":299},{"label":"Fev","value":461},{"label":"Mar","value":504},{"label":"Abr","value":571},{"label":"Mai","value":422},{"label":"Jun","value":555},{"label":"Jul","value":443},{"label":"Ago","value":454},{"label":"Set","value":604},{"label":"Out","value":269},{"label":"Nov","value":281},{"label":"Dez","value":552}];
const MX = 604;
