...
const PAGE = "Grant Management";
const KPIS = [{"l":"Projetos Melhoria","v":"262","t":"+12.9%","d":"up"},{"l":"Savings (€)","v":"€26840","t":"+8.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"90.9%","t":"-4.6%","d":"down"},{"l":"Ciclos PDCA","v":"3.691","t":"+15.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.326","€ 10573.46","7.227","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.080","€ 21010.57","3.296","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","510","€ 15977.68","8.478","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","795","€ 34721.59","5.627","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.639","€ 48862.38","8.664","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":622},{"label":"Mar","value":724},{"label":"Abr","value":725},{"label":"Mai","value":865},{"label":"Jun","value":570},{"label":"Jul","value":633},{"label":"Ago","value":861},{"label":"Set","value":842},{"label":"Out","value":896},{"label":"Nov","value":786},{"label":"Dez","value":781}];
const MX = 896;
...
export default function GrantsNonprofitPage() {
    return (
