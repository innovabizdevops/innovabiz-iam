...
const KPIS = [{"l":"Total Nonprofit","v":"3.324","t":"-5.4%","d":"down"},{"l":"Volunteer Mgmt Ativos","v":"6.930","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"79.6%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"68","t":"-2.6%","d":"down"}];
const COLS = ["ID","Volunteer Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nonprofit #001","Nonprofit #002","3.110","4.185","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Nonprofit #002","Nonprofit #003","3.763","3.923","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Nonprofit #003","Nonprofit #004","3.782","676","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Nonprofit #004","Nonprofit #005","1.364","6.404","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nonprofit #005","Nonprofit #001","4.062","1.695","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":969},{"label":"Fev","value":668},{"label":"Mar","value":614},{"label":"Abr","value":792},{"label":"Mai","value":869},{"label":"Jun","value":625},{"label":"Jul","value":769},{"label":"Ago","value":735},{"label":"Set","value":968},{"label":"Out","value":910},{"label":"Nov","value":845},{"label":"Dez","value":896}];
const MX = 969;
