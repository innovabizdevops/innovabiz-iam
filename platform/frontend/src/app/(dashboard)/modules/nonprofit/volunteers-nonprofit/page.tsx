...
const PAGE = "Volunteer Management";
const KPIS = [{"l":"Projetos Melhoria","v":"772","t":"+15.7%","d":"up"},{"l":"Savings (€)","v":"€39567","t":"+2.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"83.1%","t":"+15.3%","d":"up"},{"l":"Ciclos PDCA","v":"4.356","t":"-4.0%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.409","€ 45256.24","2.586","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.392","€ 16151.36","8.804","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.001","€ 25581.26","4.309","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.374","€ 41449.45","2.413","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","859","€ 47887.10","7.496","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":643},{"label":"Mar","value":863},{"label":"Abr","value":570},{"label":"Mai","value":752},{"label":"Jun","value":480},{"label":"Jul","value":480},{"label":"Ago","value":762},{"label":"Set","value":562},{"label":"Out","value":547},{"label":"Nov","value":742},{"label":"Dez","value":549}];
const MX = 863;
...
export default function VolunteersNonprofitPage() {
    return (
