...
const PAGE = "Legacy Giving";
const KPIS = [{"l":"Total Nonprofit","v":"6.311","t":"+0.8%","d":"up"},{"l":"Legacy Giving Ativos","v":"4.929","t":"+1.3%","d":"up"},{"l":"Eficiência (%)","v":"76.4%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"56","t":"+11.2%","d":"up"}];
const COLS = ["ID","Legacy Giving","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nonprofit #001","Nonprofit #002","191","2.240","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Nonprofit #002","Nonprofit #003","2.882","2.258","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Nonprofit #003","Nonprofit #004","8.679","2.331","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Nonprofit #004","Nonprofit #005","6.296","2.650","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nonprofit #005","Nonprofit #001","5.242","5.224","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":659},{"label":"Mar","value":866},{"label":"Abr","value":831},{"label":"Mai","value":736},{"label":"Jun","value":702},{"label":"Jul","value":763},{"label":"Ago","value":989},{"label":"Set","value":783},{"label":"Out","value":1004},{"label":"Nov","value":677},{"label":"Dez","value":762}];
const MX = 1004;
