...
const KPIS = [{"l":"Projetos Melhoria","v":"756","t":"+16.0%","d":"up"},{"l":"Savings (€)","v":"€49424","t":"+9.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"74.2%","t":"-0.6%","d":"down"},{"l":"Ciclos PDCA","v":"8.211","t":"+3.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","118","€ 28782.30","5.568","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.930","€ 29632.22","4.429","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.426","€ 3332.48","1.996","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","143","€ 7265.78","221","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.296","€ 29099.72","1.539","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":602},{"label":"Mar","value":509},{"label":"Abr","value":415},{"label":"Mai","value":530},{"label":"Jun","value":565},{"label":"Jul","value":608},{"label":"Ago","value":735},{"label":"Set","value":489},{"label":"Out","value":722},{"label":"Nov","value":486},{"label":"Dez","value":559}];
const MX = 735;
