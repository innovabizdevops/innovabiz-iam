...
const PAGE = "Donor Journey Flow";
const KPIS = [{"l":"Perfis Unificados","v":"3.399","t":"+8.1%","d":"up"},{"l":"Segmentos Ativos","v":"6.629","t":"+15.4%","d":"up"},{"l":"NPS Score","v":"92","t":"+11.0%","d":"up"},{"l":"Churn Previsto (%)","v":"83.0%","t":"-5.2%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","1.408","€ 37040.18","91.9%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","4.372","€ 14297.88","97.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","1.089","€ 32895.19","71.8%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","4.475","€ 31447.97","73.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","8.470","€ 20120.48","92.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":738},{"label":"Mar","value":760},{"label":"Abr","value":612},{"label":"Mai","value":658},{"label":"Jun","value":637},{"label":"Jul","value":693},{"label":"Ago","value":676},{"label":"Set","value":549},{"label":"Out","value":855},{"label":"Nov","value":886},{"label":"Dez","value":712}];
const MX = 886;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#be185d'}}>Flow</span></h1>
                </div>
