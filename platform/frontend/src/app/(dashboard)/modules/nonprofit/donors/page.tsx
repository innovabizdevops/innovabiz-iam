...
const PAGE = "Donor Management";
const KPIS = [{"l":"Projetos Melhoria","v":"6.538","t":"+10.8%","d":"up"},{"l":"Savings (€)","v":"€25676","t":"+11.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"83.3%","t":"+14.0%","d":"up"},{"l":"Ciclos PDCA","v":"7.308","t":"+4.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.052","€ 9369.34","8.877","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.856","€ 2039.45","1.281","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.053","€ 7659.04","4.994","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.337","€ 44661.32","3.132","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","906","€ 40287.53","4.287","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":975},{"label":"Fev","value":688},{"label":"Mar","value":923},{"label":"Abr","value":794},{"label":"Mai","value":736},{"label":"Jun","value":689},{"label":"Jul","value":674},{"label":"Ago","value":962},{"label":"Set","value":771},{"label":"Out","value":1011},{"label":"Nov","value":729},{"label":"Dez","value":735}];
const MX = 1011;
