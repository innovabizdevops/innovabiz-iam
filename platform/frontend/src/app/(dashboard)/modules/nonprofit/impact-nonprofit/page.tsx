...
const PAGE = "Impact Measurement";
const KPIS = [{"l":"Projetos Sociais","v":"3.092","t":"-2.1%","d":"down"},{"l":"Beneficiários","v":"6.860","t":"-2.5%","d":"down"},{"l":"Investimento CSR (€)","v":"€75031","t":"+15.8%","d":"up"},{"l":"Score Impacto","v":"75","t":"+9.2%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","7.211","€ 15194.99","9.093","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.321","€ 10024.64","2.690","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","7.157","€ 9255.24","7.960","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","7.193","€ 20556.87","865","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","2.745","€ 1015.64","4.634","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":753},{"label":"Mar","value":686},{"label":"Abr","value":598},{"label":"Mai","value":458},{"label":"Jun","value":661},{"label":"Jul","value":452},{"label":"Ago","value":677},{"label":"Set","value":639},{"label":"Out","value":582},{"label":"Nov","value":514},{"label":"Dez","value":738}];
const MX = 753;
...
export default function ImpactNonprofitPage() {
    return (
