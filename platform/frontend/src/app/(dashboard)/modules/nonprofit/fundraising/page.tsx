...
const KPIS = [{"l":"Total Nonprofit","v":"480","t":"+16.9%","d":"up"},{"l":"Fundraising Ativos","v":"1.275","t":"+14.4%","d":"up"},{"l":"Eficiência (%)","v":"87.1%","t":"+6.8%","d":"up"},{"l":"Score Performance","v":"64","t":"-5.4%","d":"down"}];
const COLS = ["ID","Fundraising","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nonprofit #001","Nonprofit #002","6.096","1.605","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Nonprofit #002","Nonprofit #003","1.718","7.242","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Nonprofit #003","Nonprofit #004","7.278","6.632","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Nonprofit #004","Nonprofit #005","5.922","5.991","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nonprofit #005","Nonprofit #001","7.522","6.888","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":822},{"label":"Fev","value":779},{"label":"Mar","value":682},{"label":"Abr","value":704},{"label":"Mai","value":822},{"label":"Jun","value":463},{"label":"Jul","value":772},{"label":"Ago","value":666},{"label":"Set","value":829},{"label":"Out","value":778},{"label":"Nov","value":827},{"label":"Dez","value":473}];
const MX = 829;
