...
const ACCENT = "#be185d";
const MODULE = "Nonprofit & NGO";
const PAGE = "Impact Reporting";
const KPIS = [{"l":"Projetos Sociais","v":"2.807","t":"-0.8%","d":"down"},{"l":"Beneficiários","v":"1.794","t":"+2.0%","d":"up"},{"l":"Investimento CSR (€)","v":"€66079","t":"+13.3%","d":"up"},{"l":"Score Impacto","v":"83","t":"+16.8%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","387","€ 49226.08","8.977","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","5.775","€ 40134.07","8.083","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","5.891","€ 40640.78","5.007","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","1.351","€ 25578.05","1.771","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","8.910","€ 24021.89","4.495","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":698},{"label":"Mar","value":684},{"label":"Abr","value":702},{"label":"Mai","value":466},{"label":"Jun","value":451},{"label":"Jul","value":737},{"label":"Ago","value":531},{"label":"Set","value":681},{"label":"Out","value":556},{"label":"Nov","value":807},{"label":"Dez","value":701}];
const MX = 807;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#be185d'}}>ESG</span></h1>
                </div>
