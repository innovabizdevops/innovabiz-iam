...
const PAGE = "Event Fundraising";
const KPIS = [{"l":"Total Nonprofit","v":"1.480","t":"+1.6%","d":"up"},{"l":"Event Fundraising Ativos","v":"6.917","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"91.0%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"93","t":"+16.8%","d":"up"}];
const COLS = ["ID","Event Fundraising","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nonprofit #001","Nonprofit #002","2.935","223","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Nonprofit #002","Nonprofit #003","5.008","1.348","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Nonprofit #003","Nonprofit #004","571","7.946","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Nonprofit #004","Nonprofit #005","6.046","3.738","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nonprofit #005","Nonprofit #001","5.567","8.353","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":394},{"label":"Fev","value":278},{"label":"Mar","value":591},{"label":"Abr","value":489},{"label":"Mai","value":396},{"label":"Jun","value":371},{"label":"Jul","value":518},{"label":"Ago","value":549},{"label":"Set","value":562},{"label":"Out","value":397},{"label":"Nov","value":311},{"label":"Dez","value":449}];
const MX = 591;
