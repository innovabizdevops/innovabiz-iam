...
const PAGE = "Onboard";
const KPIS = [{"l":"Vendas YTD (€)","v":"€74988","t":"+12.6%","d":"up"},{"l":"Pipeline (€)","v":"€63829","t":"+4.9%","d":"up"},{"l":"Atingimento Quota (%)","v":"75.7%","t":"+1.6%","d":"up"},{"l":"Win Rate (%)","v":"81.3%","t":"+17.9%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 32361.84","€ 806.00","€ 5031.69","87.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 28173.18","€ 42101.18","€ 34203.95","92.0%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 7138.09","€ 33439.25","€ 22279.70","87.5%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 10726.34","€ 27890.79","€ 50007.91","89.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 12691.24","€ 21442.36","€ 30608.06","79.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":590},{"label":"Mar","value":436},{"label":"Abr","value":486},{"label":"Mai","value":668},{"label":"Jun","value":550},{"label":"Jul","value":694},{"label":"Ago","value":328},{"label":"Set","value":480},{"label":"Out","value":504},{"label":"Nov","value":522},{"label":"Dez","value":570}];
const MX = 694;
