...
const PAGE = "Lead";
const KPIS = [{"l":"Vendas YTD (€)","v":"€31173","t":"+11.3%","d":"up"},{"l":"Pipeline (€)","v":"€74065","t":"+2.6%","d":"up"},{"l":"Atingimento Quota (%)","v":"66.8%","t":"-2.5%","d":"down"},{"l":"Win Rate (%)","v":"75.6%","t":"-5.6%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 40743.11","€ 15402.51","€ 6104.91","77.4%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 26421.38","€ 6300.24","€ 47877.57","92.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 7096.88","€ 38326.93","€ 31109.43","85.6%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 27842.98","€ 39491.53","€ 31801.08","97.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 4971.82","€ 14551.93","€ 35825.61","84.1%"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":598},{"label":"Mar","value":695},{"label":"Abr","value":453},{"label":"Mai","value":645},{"label":"Jun","value":448},{"label":"Jul","value":446},{"label":"Ago","value":483},{"label":"Set","value":596},{"label":"Out","value":363},{"label":"Nov","value":411},{"label":"Dez","value":637}];
const MX = 695;
