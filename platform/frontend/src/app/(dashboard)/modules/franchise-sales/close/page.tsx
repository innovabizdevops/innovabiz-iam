...
const PAGE = "Close";
const KPIS = [{"l":"Vendas YTD (€)","v":"€42205","t":"+2.9%","d":"up"},{"l":"Pipeline (€)","v":"€48415","t":"+5.0%","d":"up"},{"l":"Atingimento Quota (%)","v":"86.2%","t":"+16.3%","d":"up"},{"l":"Win Rate (%)","v":"76.8%","t":"+2.7%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 25430.96","€ 11073.95","€ 17571.04","73.7%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 29020.49","€ 15813.93","€ 47270.90","87.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 21992.39","€ 6958.63","€ 9872.33","89.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 13797.07","€ 42290.14","€ 27565.37","99.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 3339.71","€ 19498.99","€ 46135.37","93.9%"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":518},{"label":"Mar","value":505},{"label":"Abr","value":716},{"label":"Mai","value":689},{"label":"Jun","value":730},{"label":"Jul","value":631},{"label":"Ago","value":441},{"label":"Set","value":792},{"label":"Out","value":667},{"label":"Nov","value":703},{"label":"Dez","value":687}];
const MX = 817;
