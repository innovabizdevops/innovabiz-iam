...
const ACCENT = "#2563eb";
const MODULE = "Franchise Sales";
const PAGE = "Qualify";
const KPIS = [{"l":"Vendas YTD (€)","v":"€2867","t":"-0.7%","d":"down"},{"l":"Pipeline (€)","v":"€89969","t":"+9.2%","d":"up"},{"l":"Atingimento Quota (%)","v":"71.5%","t":"+11.0%","d":"up"},{"l":"Win Rate (%)","v":"85.1%","t":"-2.4%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 37821.76","€ 31491.33","€ 18054.11","70.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 40747.74","€ 35528.58","€ 40215.86","97.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 4205.71","€ 10851.97","€ 36553.67","81.6%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 11710.77","€ 49993.35","€ 14136.71","82.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 42449.23","€ 37591.48","€ 50098.66","75.3%"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":302},{"label":"Mar","value":465},{"label":"Abr","value":663},{"label":"Mai","value":602},{"label":"Jun","value":336},{"label":"Jul","value":511},{"label":"Ago","value":562},{"label":"Set","value":478},{"label":"Out","value":397},{"label":"Nov","value":360},{"label":"Dez","value":412}];
const MX = 663;
