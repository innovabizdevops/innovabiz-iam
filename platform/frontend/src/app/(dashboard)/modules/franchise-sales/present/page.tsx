...
const PAGE = "Present";
const KPIS = [{"l":"Vendas YTD (€)","v":"€49674","t":"+2.5%","d":"up"},{"l":"Pipeline (€)","v":"€57603","t":"+8.2%","d":"up"},{"l":"Atingimento Quota (%)","v":"78.8%","t":"-0.7%","d":"down"},{"l":"Win Rate (%)","v":"67.4%","t":"+16.5%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 48458.66","€ 11061.49","€ 485.07","93.5%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 37967.84","€ 41367.70","€ 33308.30","90.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 39418.47","€ 9542.68","€ 6239.90","74.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 37488.66","€ 25920.49","€ 15413.87","73.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 112.42","€ 39097.29","€ 10527.75","70.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":865},{"label":"Fev","value":755},{"label":"Mar","value":671},{"label":"Abr","value":680},{"label":"Mai","value":655},{"label":"Jun","value":948},{"label":"Jul","value":639},{"label":"Ago","value":952},{"label":"Set","value":946},{"label":"Out","value":841},{"label":"Nov","value":876},{"label":"Dez","value":867}];
const MX = 952;
