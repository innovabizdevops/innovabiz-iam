...
const KPIS = [
    { label: "Total Registos", value: "1153", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2189", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€444K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "-11%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1866190653", cells: ["FRA-5653", "Franchise Sales Item 1", "6/10/2026", "€40 753"], status: "active" as const },
    { id: "1866194224", cells: ["FRA-9224", "Franchise Sales Item 2", "21/5/2026", "€44 324"], status: "pending" as const },
    { id: "1866197795", cells: ["FRA-3795", "Franchise Sales Item 3", "8/12/2026", "€47 895"], status: "completed" as const },
    { id: "1866201366", cells: ["FRA-7366", "Franchise Sales Item 4", "23/7/2026", "€1466"], status: "warning" as const },
    { id: "1866204937", cells: ["FRA-1937", "Franchise Sales Item 5", "10/2/2026", "€5037"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Franchise Sales</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Franchise Sales</p>
                    </div>
                </div>
