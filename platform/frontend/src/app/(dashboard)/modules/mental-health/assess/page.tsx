...
const ACCENT = "#6366f1";
const MODULE = "Mental Health";
const PAGE = "Assessment";
const KPIS = [{"l":"Total Mental Health","v":"7.434","t":"+1.6%","d":"up"},{"l":"Assessment Ativos","v":"3.188","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"83.8%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"58","t":"+0.7%","d":"up"}];
const COLS = ["ID","Assessment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mental Health #001","Mental Health #002","6.276","3.810","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Mental Health #002","Mental Health #003","1.935","3.495","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Mental Health #003","Mental Health #004","3.789","2.456","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Mental Health #004","Mental Health #005","8.298","7.136","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mental Health #005","Mental Health #001","6.298","2.783","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":900},{"label":"Mar","value":900},{"label":"Abr","value":738},{"label":"Mai","value":888},{"label":"Jun","value":633},{"label":"Jul","value":860},{"label":"Ago","value":754},{"label":"Set","value":779},{"label":"Out","value":625},{"label":"Nov","value":769},{"label":"Dez","value":925}];
const MX = 925;
