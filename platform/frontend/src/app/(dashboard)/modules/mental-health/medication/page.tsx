...
const KPIS = [{"l":"Integrações Ativas","v":"2.963","t":"+8.7%","d":"up"},{"l":"Chamadas/Hora","v":"4533","t":"+16.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"85.6%","t":"+4.5%","d":"up"},{"l":"Latência Média (ms)","v":"174ms","t":"+13.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.872","6.918","86.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.989","6.965","91.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.358","4.936","76.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.935","5.503","94.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.838","6.572","81.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":431},{"label":"Fev","value":508},{"label":"Mar","value":424},{"label":"Abr","value":682},{"label":"Mai","value":413},{"label":"Jun","value":378},{"label":"Jul","value":415},{"label":"Ago","value":512},{"label":"Set","value":521},{"label":"Out","value":413},{"label":"Nov","value":625},{"label":"Dez","value":364}];
const MX = 682;
