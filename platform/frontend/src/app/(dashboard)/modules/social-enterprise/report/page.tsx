...
const PAGE = "Report Card";
const KPIS = [{"l":"Projetos Sociais","v":"3.752","t":"+10.9%","d":"up"},{"l":"Beneficiários","v":"5.723","t":"+9.4%","d":"up"},{"l":"Investimento CSR (€)","v":"€21342","t":"+15.7%","d":"up"},{"l":"Score Impacto","v":"85","t":"+3.6%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","2.349","€ 10989.19","4.007","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","8.000","€ 5634.71","212","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","710","€ 28667.61","4.733","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","2.432","€ 4800.51","8.265","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","1.805","€ 38819.30","2.850","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":816},{"label":"Mar","value":699},{"label":"Abr","value":926},{"label":"Mai","value":889},{"label":"Jun","value":746},{"label":"Jul","value":731},{"label":"Ago","value":611},{"label":"Set","value":793},{"label":"Out","value":661},{"label":"Nov","value":616},{"label":"Dez","value":866}];
const MX = 926;
