...
const ACCENT = "#0c4a6e";
const MODULE = "Social Enterprise";
const PAGE = "Impact Model";
const KPIS = [{"l":"Projetos Sociais","v":"3.230","t":"-2.3%","d":"down"},{"l":"Beneficiários","v":"2.324","t":"-3.2%","d":"down"},{"l":"Investimento CSR (€)","v":"€36245","t":"+2.7%","d":"up"},{"l":"Score Impacto","v":"68","t":"+17.5%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","7.851","€ 41673.95","3.111","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","7.344","€ 40290.57","1.722","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","8.631","€ 19038.94","4.757","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","6.901","€ 48287.40","2.878","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","1.562","€ 2557.15","2.175","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":461},{"label":"Fev","value":483},{"label":"Mar","value":368},{"label":"Abr","value":564},{"label":"Mai","value":270},{"label":"Jun","value":483},{"label":"Jul","value":398},{"label":"Ago","value":540},{"label":"Set","value":396},{"label":"Out","value":312},{"label":"Nov","value":256},{"label":"Dez","value":600}];
const MX = 600;
