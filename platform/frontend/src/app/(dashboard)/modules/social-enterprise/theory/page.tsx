...
const PAGE = "Theory Change";
const KPIS = [{"l":"Projetos Sociais","v":"7.237","t":"+3.3%","d":"up"},{"l":"Beneficiários","v":"2.957","t":"+6.7%","d":"up"},{"l":"Investimento CSR (€)","v":"€67639","t":"-1.5%","d":"down"},{"l":"Score Impacto","v":"63","t":"+15.2%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","1.587","€ 755.83","6.871","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","7.042","€ 31124.82","1.025","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","3.509","€ 30809.25","7.625","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","8.577","€ 12564.26","8.907","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","6.160","€ 29109.27","6.429","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":905},{"label":"Fev","value":593},{"label":"Mar","value":852},{"label":"Abr","value":920},{"label":"Mai","value":615},{"label":"Jun","value":891},{"label":"Jul","value":903},{"label":"Ago","value":890},{"label":"Set","value":785},{"label":"Out","value":776},{"label":"Nov","value":855},{"label":"Dez","value":585}];
const MX = 920;
