...
const PAGE = "Blended Finance";
const KPIS = [{"l":"Projetos Sociais","v":"6.345","t":"+4.7%","d":"up"},{"l":"Beneficiários","v":"7.198","t":"+0.2%","d":"up"},{"l":"Investimento CSR (€)","v":"€11815","t":"+11.2%","d":"up"},{"l":"Score Impacto","v":"77","t":"+4.1%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","2.459","€ 30705.59","7.484","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","8.651","€ 9598.12","8.032","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","109","€ 20329.63","5.848","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","2.825","€ 40772.80","6.688","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","7.744","€ 20864.09","5.846","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":283},{"label":"Fev","value":592},{"label":"Mar","value":316},{"label":"Abr","value":466},{"label":"Mai","value":285},{"label":"Jun","value":624},{"label":"Jul","value":494},{"label":"Ago","value":519},{"label":"Set","value":613},{"label":"Out","value":246},{"label":"Nov","value":533},{"label":"Dez","value":262}];
const MX = 624;
