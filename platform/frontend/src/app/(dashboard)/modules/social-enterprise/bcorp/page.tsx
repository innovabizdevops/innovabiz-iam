...
const PAGE = "B-Corp Score";
const KPIS = [{"l":"Projetos Sociais","v":"7.906","t":"+4.6%","d":"up"},{"l":"Beneficiários","v":"5.604","t":"+0.7%","d":"up"},{"l":"Investimento CSR (€)","v":"€92478","t":"-3.3%","d":"down"},{"l":"Score Impacto","v":"67","t":"+8.4%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","1.109","€ 25600.73","6.969","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","924","€ 21898.04","1.879","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","5.139","€ 44099.10","2.672","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","2.593","€ 13823.70","7.199","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","860","€ 16874.30","3.386","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":473},{"label":"Mar","value":751},{"label":"Abr","value":506},{"label":"Mai","value":497},{"label":"Jun","value":701},{"label":"Jul","value":653},{"label":"Ago","value":521},{"label":"Set","value":724},{"label":"Out","value":616},{"label":"Nov","value":634},{"label":"Dez","value":678}];
const MX = 751;
