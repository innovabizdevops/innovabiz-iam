...
const PAGE = "Secure";
const KPIS = [{"l":"Integrações Ativas","v":"7.709","t":"+5.2%","d":"up"},{"l":"Chamadas/Hora","v":"3120","t":"+14.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"77.9%","t":"+1.4%","d":"up"},{"l":"Latência Média (ms)","v":"95ms","t":"+13.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.287","7.099","80.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.646","1.688","91.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.904","1.964","76.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.873","4.262","73.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.701","2.578","71.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":516},{"label":"Mar","value":551},{"label":"Abr","value":539},{"label":"Mai","value":445},{"label":"Jun","value":603},{"label":"Jul","value":363},{"label":"Ago","value":749},{"label":"Set","value":663},{"label":"Out","value":369},{"label":"Nov","value":710},{"label":"Dez","value":526}];
const MX = 749;
