...
const ACCENT = "#8b5cf6";
const MODULE = "API Management Deep";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"8.423","t":"+17.6%","d":"up"},{"l":"Submissões/Dia","v":"187","t":"-1.9%","d":"down"},{"l":"Documentos Gerados","v":"7.810","t":"-5.2%","d":"down"},{"l":"Templates","v":"2.650","t":"+0.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.525","2026-01-08","5.968","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.634","2026-03-04","7.496","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.588","2026-03-14","4.059","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.760","2026-03-12","3.583","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.344","2026-02-01","8.259","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":633},{"label":"Mar","value":779},{"label":"Abr","value":886},{"label":"Mai","value":563},{"label":"Jun","value":776},{"label":"Jul","value":659},{"label":"Ago","value":552},{"label":"Set","value":754},{"label":"Out","value":775},{"label":"Nov","value":530},{"label":"Dez","value":619}];
const MX = 886;
