...
const KPIS = [{"l":"Dashboards Ativos","v":"7.405","t":"+0.3%","d":"up"},{"l":"Queries/Dia","v":"2111","t":"+7.4%","d":"up"},{"l":"Dados Processados (GB)","v":"7.340","t":"+6.5%","d":"up"},{"l":"Utilizadores Analytics","v":"1.924","t":"+2.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1535","2026-01-22","4.015","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","153","2026-02-06","3.171","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2170","2026-02-03","4.784","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1435","2026-01-16","125","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2056","2026-01-02","4.101","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":881},{"label":"Fev","value":951},{"label":"Mar","value":1023},{"label":"Abr","value":1010},{"label":"Mai","value":689},{"label":"Jun","value":999},{"label":"Jul","value":829},{"label":"Ago","value":826},{"label":"Set","value":931},{"label":"Out","value":924},{"label":"Nov","value":949},{"label":"Dez","value":775}];
const MX = 1023;
