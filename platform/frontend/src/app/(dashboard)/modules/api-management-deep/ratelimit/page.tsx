...
const KPIS = [{"l":"Integrações Ativas","v":"6.026","t":"+8.3%","d":"up"},{"l":"Chamadas/Hora","v":"4797","t":"+3.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"76.7%","t":"+9.7%","d":"up"},{"l":"Latência Média (ms)","v":"114ms","t":"-3.7%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","387","8.534","92.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.089","3.284","83.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.675","7.131","76.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.250","7.472","95.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","433","6.276","76.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":749},{"label":"Mar","value":854},{"label":"Abr","value":681},{"label":"Mai","value":926},{"label":"Jun","value":789},{"label":"Jul","value":858},{"label":"Ago","value":919},{"label":"Set","value":895},{"label":"Out","value":722},{"label":"Nov","value":602},{"label":"Dez","value":795}];
const MX = 926;
