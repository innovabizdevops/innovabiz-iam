...
/* ═══ API Management Deep — Dashboard ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total Registos", value: "3090", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3384", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€244K", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1624523690", cells: ["API-6690", "API Management Deep Item 1", "7/3/2026", "€23 790"], status: "active" as const },
    { id: "1624527261", cells: ["API-1261", "API Management Deep Item 2", "22/10/2026", "€27 361"], status: "pending" as const },
    { id: "1624530832", cells: ["API-4832", "API Management Deep Item 3", "9/5/2026", "€30 932"], status: "completed" as const },
    { id: "1624534403", cells: ["API-8403", "API Management Deep Item 4", "24/12/2026", "€34 503"], status: "warning" as const },
    { id: "1624537974", cells: ["API-2974", "API Management Deep Item 5", "11/7/2026", "€38 074"], status: "active" as const },
];
...
export default function ApiManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">API Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • API Management Deep</p>
                    </div>
                </div>
