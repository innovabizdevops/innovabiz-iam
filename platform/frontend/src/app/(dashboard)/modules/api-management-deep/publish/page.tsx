...
const PAGE = "Publish";
const KPIS = [{"l":"Integrações Ativas","v":"3.372","t":"-3.7%","d":"down"},{"l":"Chamadas/Hora","v":"4575","t":"+9.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"92.2%","t":"+13.7%","d":"up"},{"l":"Latência Média (ms)","v":"73ms","t":"-1.6%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.756","2.937","83.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.805","8.086","93.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.098","5.451","88.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.611","4.355","70.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.207","6.654","89.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":930},{"label":"Fev","value":895},{"label":"Mar","value":662},{"label":"Abr","value":915},{"label":"Mai","value":884},{"label":"Jun","value":830},{"label":"Jul","value":799},{"label":"Ago","value":827},{"label":"Set","value":640},{"label":"Out","value":849},{"label":"Nov","value":962},{"label":"Dez","value":620}];
const MX = 962;
