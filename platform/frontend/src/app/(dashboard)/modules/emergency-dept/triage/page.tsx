...
const ACCENT = "#6366f1";
const MODULE = "Emergency Dept";
const PAGE = "Triage";
const KPIS = [{"l":"Total Emergency Dept","v":"713","t":"+9.4%","d":"up"},{"l":"Triage Ativos","v":"3.152","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"70.1%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"63","t":"-4.0%","d":"down"}];
const COLS = ["ID","Triage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Emergency Dept #001","Emergency Dept #002","4.612","2.530","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Emergency Dept #002","Emergency Dept #003","4.604","474","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Emergency Dept #003","Emergency Dept #004","1.360","1.666","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Emergency Dept #004","Emergency Dept #005","4.032","591","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Emergency Dept #005","Emergency Dept #001","1.323","1.778","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":610},{"label":"Mar","value":863},{"label":"Abr","value":621},{"label":"Mai","value":598},{"label":"Jun","value":806},{"label":"Jul","value":650},{"label":"Ago","value":694},{"label":"Set","value":872},{"label":"Out","value":541},{"label":"Nov","value":788},{"label":"Dez","value":864}];
const MX = 872;
