...
const PAGE = "Track Board";
const KPIS = [{"l":"Teams Ativos","v":"2.104","t":"+16.3%","d":"up"},{"l":"Reuniões/Semana","v":"586","t":"+7.3%","d":"up"},{"l":"Mensagens/Dia","v":"3591","t":"+15.9%","d":"up"},{"l":"Ficheiros Partilhados","v":"6.707","t":"-5.1%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","2.617","1860","2.837","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","4.801","3129","5.879","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","9.096","2502","3.156","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.941","3094","4.352","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","5.839","263","1.902","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":454},{"label":"Fev","value":428},{"label":"Mar","value":567},{"label":"Abr","value":596},{"label":"Mai","value":570},{"label":"Jun","value":469},{"label":"Jul","value":574},{"label":"Ago","value":622},{"label":"Set","value":519},{"label":"Out","value":364},{"label":"Nov","value":634},{"label":"Dez","value":552}];
const MX = 634;
