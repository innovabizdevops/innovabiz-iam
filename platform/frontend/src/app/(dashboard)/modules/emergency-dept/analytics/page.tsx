...
const KPIS = [{"l":"Dashboards Ativos","v":"4.678","t":"+15.2%","d":"up"},{"l":"Queries/Dia","v":"3467","t":"+10.7%","d":"up"},{"l":"Dados Processados (GB)","v":"5.691","t":"+11.4%","d":"up"},{"l":"Utilizadores Analytics","v":"816","t":"+0.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4200","2026-01-19","2.949","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4751","2026-03-09","2.459","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3130","2026-03-18","5.315","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4558","2026-01-23","3.113","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2927","2026-03-20","6.174","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":594},{"label":"Mar","value":339},{"label":"Abr","value":557},{"label":"Mai","value":342},{"label":"Jun","value":510},{"label":"Jul","value":281},{"label":"Ago","value":215},{"label":"Set","value":426},{"label":"Out","value":355},{"label":"Nov","value":309},{"label":"Dez","value":286}];
const MX = 594;
