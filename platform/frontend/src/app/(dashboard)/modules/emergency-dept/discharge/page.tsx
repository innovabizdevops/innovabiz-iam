...
const PAGE = "Discharge";
const KPIS = [{"l":"Total Emergency Dept","v":"6.096","t":"-3.6%","d":"down"},{"l":"Discharge Ativos","v":"6.042","t":"-1.7%","d":"down"},{"l":"Eficiência (%)","v":"66.9%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"55","t":"+9.2%","d":"up"}];
const COLS = ["ID","Discharge","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Emergency Dept #001","Emergency Dept #002","6.466","497","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Emergency Dept #002","Emergency Dept #003","3.347","8.873","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Emergency Dept #003","Emergency Dept #004","5.705","2.906","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Emergency Dept #004","Emergency Dept #005","914","2.552","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Emergency Dept #005","Emergency Dept #001","7.804","1.983","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":871},{"label":"Fev","value":726},{"label":"Mar","value":751},{"label":"Abr","value":815},{"label":"Mai","value":694},{"label":"Jun","value":819},{"label":"Jul","value":899},{"label":"Ago","value":991},{"label":"Set","value":712},{"label":"Out","value":831},{"label":"Nov","value":607},{"label":"Dez","value":869}];
const MX = 991;
