...
export default function EmergencyDeptPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Emergency Dept</h1><p className="text-sm text-muted-foreground">Emergency Dept • iBOS Enterprise</p></div>
