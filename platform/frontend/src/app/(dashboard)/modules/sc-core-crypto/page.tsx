...
/* ═══ SC: Core Crypto Utils — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "4627", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1771", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€224K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1160541927", cells: ["SC-1927", "SC: Core Crypto Utils Item 1", "28/4/2026", "€42 027"], status: "active" as const },
    { id: "1160545498", cells: ["SC-5498", "SC: Core Crypto Utils Item 2", "15/11/2026", "€45 598"], status: "pending" as const },
    { id: "1160549069", cells: ["SC-9069", "SC: Core Crypto Utils Item 3", "2/6/2026", "€49 169"], status: "completed" as const },
    { id: "1160552640", cells: ["SC-3640", "SC: Core Crypto Utils Item 4", "17/1/2026", "€2740"], status: "warning" as const },
    { id: "1160556211", cells: ["SC-7211", "SC: Core Crypto Utils Item 5", "4/8/2026", "€6311"], status: "active" as const },
];
...
export default function ScCoreCryptoUtilsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: Core Crypto Utils</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: Core Crypto Utils</p>
                    </div>
                </div>
