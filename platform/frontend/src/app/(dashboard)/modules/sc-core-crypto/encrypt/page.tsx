...
const ACCENT = "#0284c7";
const MODULE = "SC: Core Crypto Utils";
const PAGE = "Encrypt";
const KPIS = [{"l":"Total Sc Core Crypto","v":"1.852","t":"+12.0%","d":"up"},{"l":"Encrypt Ativos","v":"4.590","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"84.9%","t":"-4.9%","d":"down"},{"l":"Score Performance","v":"62","t":"-1.5%","d":"down"}];
const COLS = ["ID","Encrypt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Crypto #001","Sc Core Crypto #002","8.632","226","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Crypto #002","Sc Core Crypto #003","1.435","7.137","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Crypto #003","Sc Core Crypto #004","2.227","9.025","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Crypto #004","Sc Core Crypto #005","3.007","3.052","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Crypto #005","Sc Core Crypto #001","1.239","7.545","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":617},{"label":"Mar","value":839},{"label":"Abr","value":747},{"label":"Mai","value":746},{"label":"Jun","value":803},{"label":"Jul","value":513},{"label":"Ago","value":569},{"label":"Set","value":540},{"label":"Out","value":849},{"label":"Nov","value":458},{"label":"Dez","value":623}];
const MX = 849;
