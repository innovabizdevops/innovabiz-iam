...
export default function CryptoCustodyPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Crypto Custody</h1><p className="text-sm text-muted-foreground">Crypto Custody • iBOS Enterprise</p></div>
