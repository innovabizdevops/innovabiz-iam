...
const PAGE = "Audit Proof";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.623","t":"+15.6%","d":"up"},{"l":"NC Abertas","v":"6.442","t":"-5.4%","d":"down"},{"l":"Conformidade (%)","v":"69.2%","t":"+13.9%","d":"up"},{"l":"CAPAs Pendentes","v":"6.664","t":"+2.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.812","72.9%","794","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.477","86.9%","2.923","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.944","87.3%","3.346","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","618","87.7%","4.963","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.530","76.8%","7.186","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":846},{"label":"Fev","value":798},{"label":"Mar","value":671},{"label":"Abr","value":764},{"label":"Mai","value":879},{"label":"Jun","value":705},{"label":"Jul","value":594},{"label":"Ago","value":636},{"label":"Set","value":706},{"label":"Out","value":859},{"label":"Nov","value":861},{"label":"Dez","value":655}];
const MX = 879;
