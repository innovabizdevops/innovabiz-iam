...
const ACCENT = "#6366f1";
const MODULE = "Petrol Station Mgmt";
const PAGE = "Tank";
const KPIS = [{"l":"Total Petrol Station","v":"8.626","t":"-4.6%","d":"down"},{"l":"Tank Ativos","v":"7.243","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"69.0%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"91","t":"+10.3%","d":"up"}];
const COLS = ["ID","Tank","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Petrol Station #001","Petrol Station #002","1.210","8.335","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Petrol Station #002","Petrol Station #003","5.872","6.522","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Petrol Station #003","Petrol Station #004","7.830","5.983","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Petrol Station #004","Petrol Station #005","7.501","4.816","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Petrol Station #005","Petrol Station #001","2.531","8.157","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":288},{"label":"Fev","value":636},{"label":"Mar","value":674},{"label":"Abr","value":391},{"label":"Mai","value":643},{"label":"Jun","value":425},{"label":"Jul","value":565},{"label":"Ago","value":659},{"label":"Set","value":432},{"label":"Out","value":676},{"label":"Nov","value":463},{"label":"Dez","value":620}];
const MX = 676;
