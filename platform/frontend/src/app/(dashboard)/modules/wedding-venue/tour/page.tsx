...
const PAGE = "Tour";
const KPIS = [{"l":"Total Wedding Venue","v":"6.875","t":"+13.0%","d":"up"},{"l":"Tour Ativos","v":"5.838","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"94.7%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"80","t":"+9.6%","d":"up"}];
const COLS = ["ID","Tour","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wedding Venue #001","Wedding Venue #002","6.602","8.526","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Wedding Venue #002","Wedding Venue #003","1.225","8.607","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Wedding Venue #003","Wedding Venue #004","8.418","7.271","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Wedding Venue #004","Wedding Venue #005","2.463","5.347","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wedding Venue #005","Wedding Venue #001","4.517","8.811","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":892},{"label":"Mar","value":607},{"label":"Abr","value":792},{"label":"Mai","value":744},{"label":"Jun","value":842},{"label":"Jul","value":714},{"label":"Ago","value":985},{"label":"Set","value":662},{"label":"Out","value":671},{"label":"Nov","value":991},{"label":"Dez","value":707}];
const MX = 991;
