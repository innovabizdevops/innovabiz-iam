...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€28.8M","t":"+2.8%","d":"up"},{"l":"MRR (€)","v":"€60293","t":"+3.4%","d":"up"},{"l":"Churn (%)","v":"84.1%","t":"+4.3%","d":"up"},{"l":"ARPU (€)","v":"€69902","t":"+10.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 26625.27","8.542","€ 31671.18","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 44890.92","5.430","€ 4051.91","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 28927.19","8.779","€ 2984.22","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 721.91","5.565","€ 49901.13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 23727.36","8.761","€ 32861.47","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":673},{"label":"Mar","value":671},{"label":"Abr","value":512},{"label":"Mai","value":622},{"label":"Jun","value":711},{"label":"Jul","value":674},{"label":"Ago","value":747},{"label":"Set","value":668},{"label":"Out","value":443},{"label":"Nov","value":443},{"label":"Dez","value":572}];
const MX = 747;
