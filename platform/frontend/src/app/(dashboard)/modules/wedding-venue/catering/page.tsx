...
const ACCENT = "#db2777";
const MODULE = "Wedding Venue";
const PAGE = "Catering";
const KPIS = [{"l":"Total Wedding Venue","v":"8.887","t":"+0.3%","d":"up"},{"l":"Catering Ativos","v":"1.390","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"82.7%","t":"+15.3%","d":"up"},{"l":"Score Performance","v":"62","t":"+10.3%","d":"up"}];
const COLS = ["ID","Catering","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wedding Venue #001","Wedding Venue #002","7.610","5.162","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Wedding Venue #002","Wedding Venue #003","3.648","3.391","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Wedding Venue #003","Wedding Venue #004","7.041","3.683","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Wedding Venue #004","Wedding Venue #005","5.149","2.498","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wedding Venue #005","Wedding Venue #001","2.082","1.331","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":409},{"label":"Mar","value":490},{"label":"Abr","value":575},{"label":"Mai","value":222},{"label":"Jun","value":438},{"label":"Jul","value":305},{"label":"Ago","value":531},{"label":"Set","value":221},{"label":"Out","value":567},{"label":"Nov","value":387},{"label":"Dez","value":390}];
const MX = 601;
