...
const KPIS = [
    { label: "Total Registos", value: "9053", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "594", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€200K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1402433053", cells: ["WED-9053", "Wedding Venue Item 1", "22/2/2026", "€33 153"], status: "active" as const },
    { id: "1402436624", cells: ["WED-3624", "Wedding Venue Item 2", "9/9/2026", "€36 724"], status: "pending" as const },
    { id: "1402440195", cells: ["WED-7195", "Wedding Venue Item 3", "24/4/2026", "€40 295"], status: "completed" as const },
    { id: "1402443766", cells: ["WED-1766", "Wedding Venue Item 4", "11/11/2026", "€43 866"], status: "warning" as const },
    { id: "1402447337", cells: ["WED-5337", "Wedding Venue Item 5", "26/6/2026", "€47 437"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wedding Venue</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Wedding Venue</p>
                    </div>
                </div>
