...
const PAGE = "Horse";
const KPIS = [{"l":"Total Equine Mgmt","v":"8.552","t":"+16.7%","d":"up"},{"l":"Horse Ativos","v":"3.632","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"74.5%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"62","t":"+17.1%","d":"up"}];
const COLS = ["ID","Horse","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Equine Mgmt #001","Equine Mgmt #002","2.822","4.289","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Equine Mgmt #002","Equine Mgmt #003","3.047","1.758","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Equine Mgmt #003","Equine Mgmt #004","2.409","909","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Equine Mgmt #004","Equine Mgmt #005","7.513","7.443","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Equine Mgmt #005","Equine Mgmt #001","4.831","2.701","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":344},{"label":"Fev","value":611},{"label":"Mar","value":303},{"label":"Abr","value":431},{"label":"Mai","value":671},{"label":"Jun","value":572},{"label":"Jul","value":368},{"label":"Ago","value":648},{"label":"Set","value":572},{"label":"Out","value":513},{"label":"Nov","value":539},{"label":"Dez","value":551}];
const MX = 671;
