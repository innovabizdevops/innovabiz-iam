...
/* ═══ Equine Management — Dashboard ═══ */

const ACCENT = "#f97316";

const KPIS = [
    { label: "Total Registos", value: "2622", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "834", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€300K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1391021822", cells: ["EQU-9822", "Equine Management Item 1", "23/3/2026", "€21 922"], status: "active" as const },
    { id: "1391025393", cells: ["EQU-4393", "Equine Management Item 2", "10/10/2026", "€25 493"], status: "pending" as const },
    { id: "1391028964", cells: ["EQU-7964", "Equine Management Item 3", "25/5/2026", "€29 064"], status: "completed" as const },
    { id: "1391032535", cells: ["EQU-2535", "Equine Management Item 4", "12/12/2026", "€32 635"], status: "warning" as const },
    { id: "1391036106", cells: ["EQU-6106", "Equine Management Item 5", "27/7/2026", "€36 206"], status: "active" as const },
];
...
export default function EquineManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Equine Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Equine Management</p>
                    </div>
                </div>
