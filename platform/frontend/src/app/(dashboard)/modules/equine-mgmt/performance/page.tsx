...
const ACCENT = "#f97316";
const MODULE = "Equine Management";
const PAGE = "Performance";
const KPIS = [{"l":"Formulários Ativos","v":"1.118","t":"+8.3%","d":"up"},{"l":"Submissões/Dia","v":"1181","t":"-3.5%","d":"down"},{"l":"Documentos Gerados","v":"630","t":"-0.6%","d":"down"},{"l":"Templates","v":"1.385","t":"+16.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.490","2026-03-03","8.007","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","776","2026-01-13","3.217","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.099","2026-01-23","8.378","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.395","2026-01-19","4.265","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.026","2026-01-27","8.440","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":321},{"label":"Fev","value":368},{"label":"Mar","value":407},{"label":"Abr","value":455},{"label":"Mai","value":256},{"label":"Jun","value":358},{"label":"Jul","value":442},{"label":"Ago","value":284},{"label":"Set","value":318},{"label":"Out","value":522},{"label":"Nov","value":315},{"label":"Dez","value":257}];
const MX = 522;
