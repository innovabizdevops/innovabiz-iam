...
const PAGE = "Health";
const KPIS = [{"l":"Total Equine Mgmt","v":"3.635","t":"+13.4%","d":"up"},{"l":"Health Ativos","v":"6.322","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"64","t":"+2.7%","d":"up"}];
const COLS = ["ID","Health","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Equine Mgmt #001","Equine Mgmt #002","1.562","5.166","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Equine Mgmt #002","Equine Mgmt #003","265","475","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Equine Mgmt #003","Equine Mgmt #004","8.157","341","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Equine Mgmt #004","Equine Mgmt #005","7.336","5.882","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Equine Mgmt #005","Equine Mgmt #001","1.699","8.317","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":646},{"label":"Fev","value":739},{"label":"Mar","value":717},{"label":"Abr","value":713},{"label":"Mai","value":502},{"label":"Jun","value":695},{"label":"Jul","value":617},{"label":"Ago","value":445},{"label":"Set","value":802},{"label":"Out","value":807},{"label":"Nov","value":463},{"label":"Dez","value":486}];
const MX = 807;
