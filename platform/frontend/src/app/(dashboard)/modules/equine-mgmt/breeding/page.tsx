...
const PAGE = "Breeding";
const KPIS = [{"l":"Integrações Ativas","v":"5.814","t":"-1.4%","d":"down"},{"l":"Chamadas/Hora","v":"4635","t":"+8.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"74.6%","t":"-2.7%","d":"down"},{"l":"Latência Média (ms)","v":"165ms","t":"+7.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.927","4.042","80.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.485","741","86.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.911","2.167","88.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.633","3.781","89.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.586","548","73.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":387},{"label":"Mar","value":714},{"label":"Abr","value":409},{"label":"Mai","value":538},{"label":"Jun","value":458},{"label":"Jul","value":724},{"label":"Ago","value":741},{"label":"Set","value":568},{"label":"Out","value":424},{"label":"Nov","value":424},{"label":"Dez","value":417}];
const MX = 741;
