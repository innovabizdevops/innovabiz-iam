...
const PAGE = "Utilization Rate";
const KPIS = [{"l":"Total Prof Services","v":"6.040","t":"-2.5%","d":"down"},{"l":"Utilization Rate Ativos","v":"3.840","t":"+6.8%","d":"up"},{"l":"Eficiência (%)","v":"79.0%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"73","t":"-4.6%","d":"down"}];
const COLS = ["ID","Utilization Rate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Prof Services #001","Prof Services #002","534","7.544","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Prof Services #002","Prof Services #003","6.097","2.511","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Prof Services #003","Prof Services #004","425","1.741","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Prof Services #004","Prof Services #005","5.401","8.022","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Prof Services #005","Prof Services #001","301","6.790","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":609},{"label":"Mar","value":843},{"label":"Abr","value":869},{"label":"Mai","value":794},{"label":"Jun","value":776},{"label":"Jul","value":725},{"label":"Ago","value":873},{"label":"Set","value":791},{"label":"Out","value":655},{"label":"Nov","value":974},{"label":"Dez","value":728}];
const MX = 974;
