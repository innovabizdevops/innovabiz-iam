...
const PAGE = "Engagement Mgmt";
const KPIS = [{"l":"eNPS","v":"94","t":"-4.3%","d":"down"},{"l":"Engagement (%)","v":"89.8%","t":"+9.5%","d":"up"},{"l":"Turnover (%)","v":"91.6%","t":"-3.1%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"1.120","t":"+11.1%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.657","2026-03-03","83","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.351","2026-01-13","88","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.288","2026-01-27","92","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.629","2026-03-14","65","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.950","2026-02-28","64","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":960},{"label":"Fev","value":925},{"label":"Mar","value":926},{"label":"Abr","value":728},{"label":"Mai","value":886},{"label":"Jun","value":922},{"label":"Jul","value":710},{"label":"Ago","value":897},{"label":"Set","value":624},{"label":"Out","value":738},{"label":"Nov","value":627},{"label":"Dez","value":620}];
const MX = 960;
