...
const PAGE = "Client Deliverables";
const KPIS = [{"l":"Total Prof Services","v":"8.088","t":"+3.6%","d":"up"},{"l":"Client Deliverables Ativos","v":"975","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"73.4%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"87","t":"-3.3%","d":"down"}];
const COLS = ["ID","Client Deliverables","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Prof Services #001","Prof Services #002","5.466","885","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Prof Services #002","Prof Services #003","2.728","1.976","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Prof Services #003","Prof Services #004","5.997","3.868","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Prof Services #004","Prof Services #005","5.487","1.706","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Prof Services #005","Prof Services #001","4.665","7.477","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":940},{"label":"Fev","value":732},{"label":"Mar","value":693},{"label":"Abr","value":963},{"label":"Mai","value":1050},{"label":"Jun","value":867},{"label":"Jul","value":768},{"label":"Ago","value":1053},{"label":"Set","value":941},{"label":"Out","value":661},{"label":"Nov","value":939},{"label":"Dez","value":1006}];
const MX = 1053;
