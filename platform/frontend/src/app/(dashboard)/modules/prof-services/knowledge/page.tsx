...
const KPIS = [{"l":"Artigos Publicados","v":"6.390","t":"+3.3%","d":"up"},{"l":"Views/Semana","v":"3330","t":"+0.4%","d":"up"},{"l":"Feedback Útil (%)","v":"68.0%","t":"+2.8%","d":"up"},{"l":"Artigos Desatualizados","v":"4.374","t":"+5.4%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","5.701","94.9%","4.569","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","6.962","79.4%","6.580","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","1.474","70.8%","2.812","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","8.263","87.9%","6.563","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","6.876","95.2%","2.425","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":881},{"label":"Mar","value":803},{"label":"Abr","value":938},{"label":"Mai","value":762},{"label":"Jun","value":699},{"label":"Jul","value":914},{"label":"Ago","value":877},{"label":"Set","value":646},{"label":"Out","value":913},{"label":"Nov","value":794},{"label":"Dez","value":918}];
const MX = 943;
