...
const PAGE = "Revenue Forecast";
const KPIS = [{"l":"ARR (€M)","v":"€30.2M","t":"+4.1%","d":"up"},{"l":"MRR (€)","v":"€93873","t":"-3.6%","d":"down"},{"l":"Churn (%)","v":"72.8%","t":"+11.8%","d":"up"},{"l":"ARPU (€)","v":"€45155","t":"-3.3%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 27593.35","5.707","€ 44560.73","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 19576.48","2.924","€ 24793.47","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 44603.47","8.525","€ 30122.48","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 11642.96","6.247","€ 45894.45","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 43077.04","7.539","€ 16079.70","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":792},{"label":"Mar","value":530},{"label":"Abr","value":612},{"label":"Mai","value":485},{"label":"Jun","value":574},{"label":"Jul","value":628},{"label":"Ago","value":670},{"label":"Set","value":449},{"label":"Out","value":663},{"label":"Nov","value":552},{"label":"Dez","value":426}];
const MX = 792;
