...
const KPIS = [{"l":"Total Prof Services","v":"1.196","t":"-5.7%","d":"down"},{"l":"SOW Builder Ativos","v":"2.997","t":"+0.7%","d":"up"},{"l":"Eficiência (%)","v":"85.2%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"62","t":"+1.4%","d":"up"}];
const COLS = ["ID","SOW Builder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Prof Services #001","Prof Services #002","8.021","4.824","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Prof Services #002","Prof Services #003","2.607","6.786","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Prof Services #003","Prof Services #004","8.926","6.302","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Prof Services #004","Prof Services #005","8.031","3.457","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Prof Services #005","Prof Services #001","4.141","2.046","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":530},{"label":"Mar","value":521},{"label":"Abr","value":639},{"label":"Mai","value":409},{"label":"Jun","value":414},{"label":"Jul","value":759},{"label":"Ago","value":428},{"label":"Set","value":582},{"label":"Out","value":430},{"label":"Nov","value":696},{"label":"Dez","value":659}];
const MX = 759;
