...
const KPIS = [{"l":"Total Prof Services","v":"6.149","t":"+1.2%","d":"up"},{"l":"Resource Planning Ativos","v":"5.310","t":"+14.3%","d":"up"},{"l":"Eficiência (%)","v":"72.7%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"60","t":"+2.0%","d":"up"}];
const COLS = ["ID","Resource Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Prof Services #001","Prof Services #002","1.302","4.660","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Prof Services #002","Prof Services #003","7.582","5.524","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Prof Services #003","Prof Services #004","5.164","3.337","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Prof Services #004","Prof Services #005","4.650","3.491","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Prof Services #005","Prof Services #001","2.976","8.387","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":480},{"label":"Mar","value":494},{"label":"Abr","value":432},{"label":"Mai","value":399},{"label":"Jun","value":434},{"label":"Jul","value":469},{"label":"Ago","value":449},{"label":"Set","value":384},{"label":"Out","value":624},{"label":"Nov","value":679},{"label":"Dez","value":507}];
const MX = 704;
