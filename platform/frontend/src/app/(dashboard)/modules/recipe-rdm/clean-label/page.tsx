...
const PAGE = "Clean Label";
const KPIS = [{"l":"Projetos Melhoria","v":"7.163","t":"+0.1%","d":"up"},{"l":"Savings (€)","v":"€86232","t":"+6.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"75.8%","t":"+6.2%","d":"up"},{"l":"Ciclos PDCA","v":"2.555","t":"-1.4%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.567","€ 35279.24","355","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.512","€ 18544.68","7.045","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.807","€ 42651.51","3.991","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.625","€ 30345.88","1.862","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.390","€ 11428.04","7.913","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":855},{"label":"Mar","value":827},{"label":"Abr","value":862},{"label":"Mai","value":936},{"label":"Jun","value":1028},{"label":"Jul","value":844},{"label":"Ago","value":803},{"label":"Set","value":1077},{"label":"Out","value":921},{"label":"Nov","value":1014},{"label":"Dez","value":808}];
const MX = 1077;
