...
const PAGE = "Scale-Up";
const KPIS = [{"l":"Total Recipe Rdm","v":"5.242","t":"+13.6%","d":"up"},{"l":"Scale Up Ativos","v":"6.841","t":"+8.4%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"+11.8%","d":"up"},{"l":"Score Performance","v":"67","t":"+2.4%","d":"up"}];
const COLS = ["ID","Scale Up","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recipe Rdm #001","Recipe Rdm #002","1.479","7.166","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Recipe Rdm #002","Recipe Rdm #003","6.322","3.957","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Recipe Rdm #003","Recipe Rdm #004","3.541","618","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Recipe Rdm #004","Recipe Rdm #005","8.839","7.238","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recipe Rdm #005","Recipe Rdm #001","5.450","5.539","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":600},{"label":"Mar","value":768},{"label":"Abr","value":913},{"label":"Mai","value":773},{"label":"Jun","value":932},{"label":"Jul","value":634},{"label":"Ago","value":551},{"label":"Set","value":754},{"label":"Out","value":780},{"label":"Nov","value":644},{"label":"Dez","value":698}];
const MX = 932;
