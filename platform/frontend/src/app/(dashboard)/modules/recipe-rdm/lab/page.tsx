...
const PAGE = "Recipe Lab";
const KPIS = [{"l":"Total Recipe Rdm","v":"1.452","t":"-4.5%","d":"down"},{"l":"Recipe Lab Ativos","v":"8.268","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"88.4%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"62","t":"+14.5%","d":"up"}];
const COLS = ["ID","Recipe Lab","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recipe Rdm #001","Recipe Rdm #002","2.563","8.185","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Recipe Rdm #002","Recipe Rdm #003","3.585","4.863","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Recipe Rdm #003","Recipe Rdm #004","6.335","1.977","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Recipe Rdm #004","Recipe Rdm #005","7.289","4.549","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recipe Rdm #005","Recipe Rdm #001","1.140","3.528","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":881},{"label":"Fev","value":1004},{"label":"Mar","value":951},{"label":"Abr","value":895},{"label":"Mai","value":814},{"label":"Jun","value":1000},{"label":"Jul","value":647},{"label":"Ago","value":723},{"label":"Set","value":876},{"label":"Out","value":847},{"label":"Nov","value":646},{"label":"Dez","value":804}];
const MX = 1004;
