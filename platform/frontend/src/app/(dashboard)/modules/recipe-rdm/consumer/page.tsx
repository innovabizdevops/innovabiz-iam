...
const ACCENT = "#b45309";
const MODULE = "Recipe R&D";
const PAGE = "Consumer Insight";
const KPIS = [{"l":"Total Recipe Rdm","v":"1.768","t":"+10.6%","d":"up"},{"l":"Consumer Insight Ativos","v":"1.382","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"88.5%","t":"-0.2%","d":"down"},{"l":"Score Performance","v":"62","t":"+2.4%","d":"up"}];
const COLS = ["ID","Consumer Insight","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recipe Rdm #001","Recipe Rdm #002","2.125","6.406","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Recipe Rdm #002","Recipe Rdm #003","6.289","3.827","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Recipe Rdm #003","Recipe Rdm #004","3.066","8.588","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Recipe Rdm #004","Recipe Rdm #005","6.933","4.681","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recipe Rdm #005","Recipe Rdm #001","2.227","4.055","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":996},{"label":"Mar","value":1060},{"label":"Abr","value":919},{"label":"Mai","value":1044},{"label":"Jun","value":743},{"label":"Jul","value":751},{"label":"Ago","value":778},{"label":"Set","value":948},{"label":"Out","value":953},{"label":"Nov","value":707},{"label":"Dez","value":897}];
const MX = 1060;
