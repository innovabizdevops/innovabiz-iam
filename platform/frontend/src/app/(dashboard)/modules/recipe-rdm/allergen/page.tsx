...
const PAGE = "Allergen Mgmt";
const KPIS = [{"l":"Total Recipe Rdm","v":"3.462","t":"-2.8%","d":"down"},{"l":"Allergen Mgmt Ativos","v":"6.339","t":"+6.6%","d":"up"},{"l":"Eficiência (%)","v":"95.0%","t":"+13.3%","d":"up"},{"l":"Score Performance","v":"79","t":"+12.8%","d":"up"}];
const COLS = ["ID","Allergen Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recipe Rdm #001","Recipe Rdm #002","3.363","3.354","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Recipe Rdm #002","Recipe Rdm #003","5.211","3.443","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Recipe Rdm #003","Recipe Rdm #004","8.608","4.569","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Recipe Rdm #004","Recipe Rdm #005","2.776","933","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recipe Rdm #005","Recipe Rdm #001","6.762","5.659","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":824},{"label":"Mar","value":977},{"label":"Abr","value":1076},{"label":"Mai","value":954},{"label":"Jun","value":775},{"label":"Jul","value":679},{"label":"Ago","value":750},{"label":"Set","value":830},{"label":"Out","value":1057},{"label":"Nov","value":764},{"label":"Dez","value":990}];
const MX = 1076;
