...
const KPIS = [{"l":"Integrações Ativas","v":"3.031","t":"-4.9%","d":"down"},{"l":"Chamadas/Hora","v":"252","t":"-5.6%","d":"down"},{"l":"Taxa Sucesso (%)","v":"70.5%","t":"-2.3%","d":"down"},{"l":"Latência Média (ms)","v":"44ms","t":"-3.3%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.897","3.157","86.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.147","7.148","85.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.438","2.673","82.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.492","1.520","80.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.748","2.465","87.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":949},{"label":"Mar","value":899},{"label":"Abr","value":759},{"label":"Mai","value":644},{"label":"Jun","value":595},{"label":"Jul","value":558},{"label":"Ago","value":904},{"label":"Set","value":669},{"label":"Out","value":621},{"label":"Nov","value":719},{"label":"Dez","value":572}];
const MX = 949;
