...
const ACCENT = "#0369a1";
const MODULE = "MAM Inter-Agent Protocol";
const PAGE = "Negotiate";
const KPIS = [{"l":"Teams Ativos","v":"2.401","t":"-3.0%","d":"down"},{"l":"Reuniões/Semana","v":"3694","t":"+8.7%","d":"up"},{"l":"Mensagens/Dia","v":"3882","t":"+10.1%","d":"up"},{"l":"Ficheiros Partilhados","v":"7.877","t":"+17.6%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.878","1537","6.922","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.197","3350","4.749","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","959","474","7.234","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.494","1283","2.304","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.347","2278","1.597","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":641},{"label":"Mar","value":717},{"label":"Abr","value":716},{"label":"Mai","value":671},{"label":"Jun","value":792},{"label":"Jul","value":608},{"label":"Ago","value":889},{"label":"Set","value":954},{"label":"Out","value":609},{"label":"Nov","value":747},{"label":"Dez","value":717}];
const MX = 954;
