...
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"6.780","t":"+9.3%","d":"up"},{"l":"Valor Total (€M)","v":"€24.8M","t":"+4.0%","d":"up"},{"l":"Renovações Próx. 30d","v":"6.578","t":"+12.7%","d":"up"},{"l":"Obrigações Pendentes","v":"7.493","t":"+6.7%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 14786.53","2026-02-12","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 1706.36","2026-02-04","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 19675.17","2026-02-07","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 29416.51","2026-02-09","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 47125.77","2026-01-26","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":253},{"label":"Fev","value":377},{"label":"Mar","value":365},{"label":"Abr","value":394},{"label":"Mai","value":479},{"label":"Jun","value":496},{"label":"Jul","value":509},{"label":"Ago","value":392},{"label":"Set","value":489},{"label":"Out","value":336},{"label":"Nov","value":374},{"label":"Dez","value":301}];
const MX = 509;
