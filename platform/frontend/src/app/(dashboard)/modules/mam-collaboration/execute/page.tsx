...
const PAGE = "Execute";
const KPIS = [{"l":"Teams Ativos","v":"9.026","t":"+4.7%","d":"up"},{"l":"Reuniões/Semana","v":"3959","t":"-1.9%","d":"down"},{"l":"Mensagens/Dia","v":"1765","t":"+9.4%","d":"up"},{"l":"Ficheiros Partilhados","v":"5.072","t":"+8.9%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.647","650","2.459","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.350","3694","5.014","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","7.700","1352","8.883","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.471","1034","7.953","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.231","3061","2.895","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":984},{"label":"Fev","value":694},{"label":"Mar","value":903},{"label":"Abr","value":720},{"label":"Mai","value":856},{"label":"Jun","value":795},{"label":"Jul","value":953},{"label":"Ago","value":1001},{"label":"Set","value":1043},{"label":"Out","value":959},{"label":"Nov","value":755},{"label":"Dez","value":1063}];
const MX = 1063;
