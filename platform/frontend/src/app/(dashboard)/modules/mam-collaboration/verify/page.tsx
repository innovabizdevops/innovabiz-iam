...
const PAGE = "Verify";
const KPIS = [{"l":"Teams Ativos","v":"3.790","t":"-5.9%","d":"down"},{"l":"Reuniões/Semana","v":"3355","t":"-4.1%","d":"down"},{"l":"Mensagens/Dia","v":"2166","t":"+1.4%","d":"up"},{"l":"Ficheiros Partilhados","v":"7.826","t":"-2.4%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","8.285","4095","403","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","7.059","4717","6.895","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","3.324","163","218","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","1.120","4934","5.572","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","8.524","5014","4.823","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":483},{"label":"Mar","value":362},{"label":"Abr","value":488},{"label":"Mai","value":431},{"label":"Jun","value":648},{"label":"Jul","value":381},{"label":"Ago","value":374},{"label":"Set","value":400},{"label":"Out","value":386},{"label":"Nov","value":671},{"label":"Dez","value":353}];
const MX = 671;
