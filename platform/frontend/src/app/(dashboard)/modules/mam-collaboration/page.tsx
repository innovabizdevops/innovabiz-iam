...
/* ═══ MAM Inter-Agent Protocol — Dashboard ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total Registos", value: "7088", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3487", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€389K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "172039288", cells: ["MAM-5288", "MAM Inter-Agent Protocol Item 1", "9/5/2026", "€39 388"], status: "active" as const },
    { id: "172042859", cells: ["MAM-8859", "MAM Inter-Agent Protocol Item 2", "24/12/2026", "€42 959"], status: "pending" as const },
    { id: "172046430", cells: ["MAM-3430", "MAM Inter-Agent Protocol Item 3", "11/7/2026", "€46 530"], status: "completed" as const },
    { id: "172050001", cells: ["MAM-7001", "MAM Inter-Agent Protocol Item 4", "26/2/2026", "€101"], status: "warning" as const },
    { id: "172053572", cells: ["MAM-1572", "MAM Inter-Agent Protocol Item 5", "13/9/2026", "€3672"], status: "active" as const },
];
...
export default function MamInteragentProtocolPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MAM Inter-Agent Protocol</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MAM Inter-Agent Protocol</p>
                    </div>
                </div>
