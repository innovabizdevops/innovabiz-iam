...
const PAGE = "Reward";
const KPIS = [{"l":"Teams Ativos","v":"5.863","t":"-4.2%","d":"down"},{"l":"Reuniões/Semana","v":"1687","t":"+0.0%","d":"up"},{"l":"Mensagens/Dia","v":"2338","t":"-3.3%","d":"down"},{"l":"Ficheiros Partilhados","v":"7.554","t":"+10.7%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","2.385","3903","5.534","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.418","2488","1.366","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","5.295","992","2.645","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","8.035","971","721","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","940","4072","6.879","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":937},{"label":"Fev","value":882},{"label":"Mar","value":771},{"label":"Abr","value":794},{"label":"Mai","value":720},{"label":"Jun","value":722},{"label":"Jul","value":777},{"label":"Ago","value":1001},{"label":"Set","value":1021},{"label":"Out","value":749},{"label":"Nov","value":838},{"label":"Dez","value":970}];
const MX = 1021;
