...
const KPIS = [{"l":"Total Hazardous Waste","v":"1.187","t":"+0.7%","d":"up"},{"l":"Treatment Ativos","v":"5.725","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"83.4%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"71","t":"+13.2%","d":"up"}];
const COLS = ["ID","Treatment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hazardous Waste #001","Hazardous Waste #002","5.145","5.797","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Hazardous Waste #002","Hazardous Waste #003","7.256","2.933","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Hazardous Waste #003","Hazardous Waste #004","8.992","6.909","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Hazardous Waste #004","Hazardous Waste #005","5.933","2.804","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hazardous Waste #005","Hazardous Waste #001","2.396","2.622","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":632},{"label":"Mar","value":881},{"label":"Abr","value":751},{"label":"Mai","value":823},{"label":"Jun","value":816},{"label":"Jul","value":931},{"label":"Ago","value":680},{"label":"Set","value":664},{"label":"Out","value":929},{"label":"Nov","value":576},{"label":"Dez","value":875}];
const MX = 931;
