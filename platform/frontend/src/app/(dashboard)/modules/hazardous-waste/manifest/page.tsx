...
const ACCENT = "#dc2626";
const MODULE = "Hazardous Waste";
const PAGE = "Manifest Track";
const KPIS = [{"l":"Total Hazardous Waste","v":"1.072","t":"+2.9%","d":"up"},{"l":"Manifest Track Ativos","v":"8.868","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"84.8%","t":"+15.3%","d":"up"},{"l":"Score Performance","v":"79","t":"-3.7%","d":"down"}];
const COLS = ["ID","Manifest Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hazardous Waste #001","Hazardous Waste #002","4.260","5.573","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Hazardous Waste #002","Hazardous Waste #003","264","4.586","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Hazardous Waste #003","Hazardous Waste #004","1.245","3.939","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Hazardous Waste #004","Hazardous Waste #005","6.351","2.420","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hazardous Waste #005","Hazardous Waste #001","2.896","2.229","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":982},{"label":"Mar","value":937},{"label":"Abr","value":753},{"label":"Mai","value":707},{"label":"Jun","value":695},{"label":"Jul","value":739},{"label":"Ago","value":779},{"label":"Set","value":670},{"label":"Out","value":1016},{"label":"Nov","value":660},{"label":"Dez","value":826}];
const MX = 1016;
