...
const PAGE = "Raw";
const KPIS = [{"l":"Total Leather Mgmt","v":"1.048","t":"+11.1%","d":"up"},{"l":"Raw Ativos","v":"5.538","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"66.9%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"80","t":"+17.5%","d":"up"}];
const COLS = ["ID","Raw","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Leather Mgmt #001","Leather Mgmt #002","1.116","5.483","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Leather Mgmt #002","Leather Mgmt #003","7.073","2.630","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Leather Mgmt #003","Leather Mgmt #004","1.719","7.379","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Leather Mgmt #004","Leather Mgmt #005","6.782","6.511","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Leather Mgmt #005","Leather Mgmt #001","1.249","4.094","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":820},{"label":"Mar","value":607},{"label":"Abr","value":831},{"label":"Mai","value":481},{"label":"Jun","value":651},{"label":"Jul","value":801},{"label":"Ago","value":583},{"label":"Set","value":829},{"label":"Out","value":789},{"label":"Nov","value":797},{"label":"Dez","value":627}];
const MX = 831;
