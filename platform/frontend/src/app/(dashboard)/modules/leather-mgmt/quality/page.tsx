...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.678","t":"+0.0%","d":"up"},{"l":"NC Abertas","v":"4.799","t":"-1.9%","d":"down"},{"l":"Conformidade (%)","v":"80.8%","t":"+7.5%","d":"up"},{"l":"CAPAs Pendentes","v":"7.102","t":"-2.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.171","74.2%","1.710","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.710","94.9%","2.310","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.309","99.7%","4.881","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.386","93.1%","5.296","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.395","81.2%","5.970","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1021},{"label":"Fev","value":745},{"label":"Mar","value":1060},{"label":"Abr","value":862},{"label":"Mai","value":766},{"label":"Jun","value":1059},{"label":"Jul","value":710},{"label":"Ago","value":865},{"label":"Set","value":900},{"label":"Out","value":852},{"label":"Nov","value":825},{"label":"Dez","value":949}];
const MX = 1060;
