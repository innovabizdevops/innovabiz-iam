...
const ACCENT = "#6366f1";
const MODULE = "Leather Management";
const PAGE = "Finish";
const KPIS = [{"l":"Total Leather Mgmt","v":"3.336","t":"-4.3%","d":"down"},{"l":"Finish Ativos","v":"1.798","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"85.6%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"74","t":"+6.2%","d":"up"}];
const COLS = ["ID","Finish","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Leather Mgmt #001","Leather Mgmt #002","2.517","3.891","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Leather Mgmt #002","Leather Mgmt #003","7.003","6.292","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Leather Mgmt #003","Leather Mgmt #004","4.324","7.109","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Leather Mgmt #004","Leather Mgmt #005","1.379","1.678","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Leather Mgmt #005","Leather Mgmt #001","7.274","5.183","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":375},{"label":"Fev","value":606},{"label":"Mar","value":381},{"label":"Abr","value":445},{"label":"Mai","value":595},{"label":"Jun","value":459},{"label":"Jul","value":554},{"label":"Ago","value":440},{"label":"Set","value":615},{"label":"Out","value":545},{"label":"Nov","value":537},{"label":"Dez","value":478}];
const MX = 615;
