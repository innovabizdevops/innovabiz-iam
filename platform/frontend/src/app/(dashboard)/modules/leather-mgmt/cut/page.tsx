...
const PAGE = "Cut";
const KPIS = [{"l":"Total Leather Mgmt","v":"742","t":"+12.9%","d":"up"},{"l":"Cut Ativos","v":"7.429","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"72.7%","t":"+17.8%","d":"up"},{"l":"Score Performance","v":"78","t":"+7.9%","d":"up"}];
const COLS = ["ID","Cut","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Leather Mgmt #001","Leather Mgmt #002","707","2.495","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Leather Mgmt #002","Leather Mgmt #003","1.143","8.551","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Leather Mgmt #003","Leather Mgmt #004","8.827","509","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Leather Mgmt #004","Leather Mgmt #005","3.719","2.322","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Leather Mgmt #005","Leather Mgmt #001","1.797","1.771","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":828},{"label":"Mar","value":1029},{"label":"Abr","value":731},{"label":"Mai","value":1065},{"label":"Jun","value":887},{"label":"Jul","value":704},{"label":"Ago","value":1059},{"label":"Set","value":850},{"label":"Out","value":863},{"label":"Nov","value":780},{"label":"Dez","value":851}];
const MX = 1065;
