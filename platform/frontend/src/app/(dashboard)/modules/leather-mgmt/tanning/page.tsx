...
const PAGE = "Tanning";
const KPIS = [{"l":"Total Leather Mgmt","v":"3.076","t":"+5.2%","d":"up"},{"l":"Tanning Ativos","v":"5.585","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"69","t":"-2.6%","d":"down"}];
const COLS = ["ID","Tanning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Leather Mgmt #001","Leather Mgmt #002","609","4.447","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Leather Mgmt #002","Leather Mgmt #003","5.579","194","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Leather Mgmt #003","Leather Mgmt #004","4.837","7.279","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Leather Mgmt #004","Leather Mgmt #005","7.475","8.471","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Leather Mgmt #005","Leather Mgmt #001","8.813","5.565","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":349},{"label":"Mar","value":318},{"label":"Abr","value":431},{"label":"Mai","value":632},{"label":"Jun","value":530},{"label":"Jul","value":562},{"label":"Ago","value":380},{"label":"Set","value":295},{"label":"Out","value":273},{"label":"Nov","value":608},{"label":"Dez","value":382}];
const MX = 658;
