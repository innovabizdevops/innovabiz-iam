...
const PAGE = "Test";
const KPIS = [{"l":"Total Ci Cd Deep","v":"3.371","t":"-0.7%","d":"down"},{"l":"Test Ativos","v":"588","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"85","t":"+4.2%","d":"up"}];
const COLS = ["ID","Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ci Cd Deep #001","Ci Cd Deep #002","3.844","5.847","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Ci Cd Deep #002","Ci Cd Deep #003","4.336","2.648","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Ci Cd Deep #003","Ci Cd Deep #004","8.553","8.875","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Ci Cd Deep #004","Ci Cd Deep #005","8.816","4.020","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ci Cd Deep #005","Ci Cd Deep #001","8.097","7.233","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":953},{"label":"Fev","value":951},{"label":"Mar","value":670},{"label":"Abr","value":764},{"label":"Mai","value":662},{"label":"Jun","value":792},{"label":"Jul","value":880},{"label":"Ago","value":917},{"label":"Set","value":924},{"label":"Out","value":627},{"label":"Nov","value":921},{"label":"Dez","value":630}];
const MX = 953;
