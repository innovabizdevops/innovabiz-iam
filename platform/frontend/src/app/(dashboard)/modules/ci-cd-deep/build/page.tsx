...
const PAGE = "Build";
const KPIS = [{"l":"Total Ci Cd Deep","v":"7.076","t":"+8.6%","d":"up"},{"l":"Build Ativos","v":"6.359","t":"+5.9%","d":"up"},{"l":"Eficiência (%)","v":"80.0%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"90","t":"+9.3%","d":"up"}];
const COLS = ["ID","Build","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ci Cd Deep #001","Ci Cd Deep #002","5.681","5.837","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Ci Cd Deep #002","Ci Cd Deep #003","2.695","1.736","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Ci Cd Deep #003","Ci Cd Deep #004","1.238","1.550","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Ci Cd Deep #004","Ci Cd Deep #005","3.582","6.389","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ci Cd Deep #005","Ci Cd Deep #001","7.557","1.576","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":782},{"label":"Mar","value":923},{"label":"Abr","value":704},{"label":"Mai","value":587},{"label":"Jun","value":899},{"label":"Jul","value":657},{"label":"Ago","value":626},{"label":"Set","value":842},{"label":"Out","value":667},{"label":"Nov","value":835},{"label":"Dez","value":897}];
const MX = 923;
