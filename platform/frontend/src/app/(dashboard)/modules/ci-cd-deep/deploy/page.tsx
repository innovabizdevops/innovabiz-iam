...
const PAGE = "Deploy";
const KPIS = [{"l":"Total Ci Cd Deep","v":"7.897","t":"+6.1%","d":"up"},{"l":"Deploy Ativos","v":"4.886","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"70.8%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"87","t":"+11.5%","d":"up"}];
const COLS = ["ID","Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ci Cd Deep #001","Ci Cd Deep #002","7.008","6.654","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Ci Cd Deep #002","Ci Cd Deep #003","8.367","7.986","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Ci Cd Deep #003","Ci Cd Deep #004","5.159","7.305","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Ci Cd Deep #004","Ci Cd Deep #005","4.363","2.405","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ci Cd Deep #005","Ci Cd Deep #001","922","5.497","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":579},{"label":"Mar","value":847},{"label":"Abr","value":660},{"label":"Mai","value":779},{"label":"Jun","value":681},{"label":"Jul","value":585},{"label":"Ago","value":745},{"label":"Set","value":750},{"label":"Out","value":806},{"label":"Nov","value":810},{"label":"Dez","value":563}];
const MX = 847;
