...
/* ═══ CI/CD Pipeline Deep — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "7272", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3565", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€257K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1102619672", cells: ["CI-3672", "CI/CD Pipeline Deep Item 1", "1/9/2026", "€19 772"], status: "active" as const },
    { id: "1102623243", cells: ["CI-7243", "CI/CD Pipeline Deep Item 2", "16/4/2026", "€23 343"], status: "pending" as const },
    { id: "1102626814", cells: ["CI-1814", "CI/CD Pipeline Deep Item 3", "3/11/2026", "€26 914"], status: "completed" as const },
    { id: "1102630385", cells: ["CI-5385", "CI/CD Pipeline Deep Item 4", "18/6/2026", "€30 485"], status: "warning" as const },
    { id: "1102633956", cells: ["CI-8956", "CI/CD Pipeline Deep Item 5", "5/1/2026", "€34 056"], status: "active" as const },
];
...
export default function CicdPipelineDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CI/CD Pipeline Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CI/CD Pipeline Deep</p>
                    </div>
                </div>
