...
const ACCENT = "#1e40af";
const MODULE = "CI/CD Pipeline Deep";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Ci Cd Deep","v":"1.506","t":"-0.9%","d":"down"},{"l":"Monitor Ativos","v":"1.400","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"76.5%","t":"-4.9%","d":"down"},{"l":"Score Performance","v":"93","t":"-0.1%","d":"down"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ci Cd Deep #001","Ci Cd Deep #002","8.586","8.255","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Ci Cd Deep #002","Ci Cd Deep #003","2.243","3.322","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Ci Cd Deep #003","Ci Cd Deep #004","2.953","2.040","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Ci Cd Deep #004","Ci Cd Deep #005","3.694","7.041","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ci Cd Deep #005","Ci Cd Deep #001","112","8.314","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":713},{"label":"Mar","value":788},{"label":"Abr","value":749},{"label":"Mai","value":714},{"label":"Jun","value":651},{"label":"Jul","value":664},{"label":"Ago","value":682},{"label":"Set","value":528},{"label":"Out","value":767},{"label":"Nov","value":585},{"label":"Dez","value":604}];
const MX = 788;
