...
const PAGE = "Fitting";
const KPIS = [{"l":"Total Bridal Shop","v":"5.970","t":"+9.6%","d":"up"},{"l":"Fitting Ativos","v":"2.885","t":"+7.7%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"74","t":"+4.1%","d":"up"}];
const COLS = ["ID","Fitting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bridal Shop #001","Bridal Shop #002","9.018","3.819","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Bridal Shop #002","Bridal Shop #003","5.677","5.673","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Bridal Shop #003","Bridal Shop #004","7.858","4.550","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Bridal Shop #004","Bridal Shop #005","760","8.375","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bridal Shop #005","Bridal Shop #001","1.182","6.365","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":422},{"label":"Mar","value":520},{"label":"Abr","value":679},{"label":"Mai","value":701},{"label":"Jun","value":559},{"label":"Jul","value":563},{"label":"Ago","value":568},{"label":"Set","value":572},{"label":"Out","value":729},{"label":"Nov","value":583},{"label":"Dez","value":772}];
const MX = 772;
