...
const KPIS = [{"l":"Total Bridal Shop","v":"7.902","t":"+4.6%","d":"up"},{"l":"Appointment Ativos","v":"8.233","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"76.8%","t":"+4.2%","d":"up"},{"l":"Score Performance","v":"93","t":"+17.4%","d":"up"}];
const COLS = ["ID","Appointment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bridal Shop #001","Bridal Shop #002","4.427","7.611","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Bridal Shop #002","Bridal Shop #003","6.059","6.888","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Bridal Shop #003","Bridal Shop #004","2.484","6.641","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Bridal Shop #004","Bridal Shop #005","3.795","3.062","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bridal Shop #005","Bridal Shop #001","1.832","3.251","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":729},{"label":"Mar","value":780},{"label":"Abr","value":761},{"label":"Mai","value":672},{"label":"Jun","value":771},{"label":"Jul","value":687},{"label":"Ago","value":808},{"label":"Set","value":825},{"label":"Out","value":644},{"label":"Nov","value":589},{"label":"Dez","value":572}];
const MX = 825;
