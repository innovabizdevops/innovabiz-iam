...
const PAGE = "Billing";
const KPIS = [{"l":"Total Bridal Shop","v":"4.893","t":"+17.5%","d":"up"},{"l":"Billing Ativos","v":"1.433","t":"+1.2%","d":"up"},{"l":"Eficiência (%)","v":"69.5%","t":"+11.5%","d":"up"},{"l":"Score Performance","v":"69","t":"+7.7%","d":"up"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bridal Shop #001","Bridal Shop #002","6.642","5.364","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Bridal Shop #002","Bridal Shop #003","1.140","7.864","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Bridal Shop #003","Bridal Shop #004","3.691","6.846","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Bridal Shop #004","Bridal Shop #005","4.785","8.687","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bridal Shop #005","Bridal Shop #001","2.980","1.989","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":874},{"label":"Fev","value":562},{"label":"Mar","value":706},{"label":"Abr","value":521},{"label":"Mai","value":570},{"label":"Jun","value":645},{"label":"Jul","value":556},{"label":"Ago","value":635},{"label":"Set","value":756},{"label":"Out","value":730},{"label":"Nov","value":753},{"label":"Dez","value":548}];
const MX = 874;
