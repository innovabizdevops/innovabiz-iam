...
const KPIS = [{"l":"Total Bridal Shop","v":"5.589","t":"+14.7%","d":"up"},{"l":"Inventory Ativos","v":"6.718","t":"+10.0%","d":"up"},{"l":"Eficiência (%)","v":"84.8%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"57","t":"+15.4%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bridal Shop #001","Bridal Shop #002","3.780","2.215","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Bridal Shop #002","Bridal Shop #003","5.062","3.831","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Bridal Shop #003","Bridal Shop #004","1.977","3.858","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Bridal Shop #004","Bridal Shop #005","4.990","3.653","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bridal Shop #005","Bridal Shop #001","6.192","8.739","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":631},{"label":"Mar","value":789},{"label":"Abr","value":637},{"label":"Mai","value":672},{"label":"Jun","value":588},{"label":"Jul","value":846},{"label":"Ago","value":946},{"label":"Set","value":767},{"label":"Out","value":806},{"label":"Nov","value":887},{"label":"Dez","value":759}];
const MX = 946;
