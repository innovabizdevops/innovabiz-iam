...
const ACCENT = "#9d174d";
const MODULE = "Bridal Shop";
const PAGE = "Alterations";
const KPIS = [{"l":"Total Bridal Shop","v":"3.947","t":"-2.7%","d":"down"},{"l":"Alterations Ativos","v":"7.110","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"90.5%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"94","t":"-1.1%","d":"down"}];
const COLS = ["ID","Alterations","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bridal Shop #001","Bridal Shop #002","4.796","1.162","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Bridal Shop #002","Bridal Shop #003","6.683","3.542","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Bridal Shop #003","Bridal Shop #004","8.842","7.036","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Bridal Shop #004","Bridal Shop #005","6.852","4.229","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bridal Shop #005","Bridal Shop #001","8.034","5.482","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":912},{"label":"Mar","value":731},{"label":"Abr","value":784},{"label":"Mai","value":710},{"label":"Jun","value":985},{"label":"Jul","value":838},{"label":"Ago","value":859},{"label":"Set","value":796},{"label":"Out","value":945},{"label":"Nov","value":922},{"label":"Dez","value":977}];
const MX = 985;
