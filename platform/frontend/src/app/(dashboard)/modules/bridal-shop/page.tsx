...
/* ═══ Bridal Shop — Dashboard ═══ */

const ACCENT = "#9d174d";

const KPIS = [
    { label: "Total Registos", value: "3608", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1424", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€17K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1580380108", cells: ["BRI-8108", "Bridal Shop Item 1", "21/5/2026", "€30 208"], status: "active" as const },
    { id: "1580383679", cells: ["BRI-2679", "Bridal Shop Item 2", "8/12/2026", "€33 779"], status: "pending" as const },
    { id: "1580387250", cells: ["BRI-6250", "Bridal Shop Item 3", "23/7/2026", "€37 350"], status: "completed" as const },
    { id: "1580390821", cells: ["BRI-9821", "Bridal Shop Item 4", "10/2/2026", "€40 921"], status: "warning" as const },
    { id: "1580394392", cells: ["BRI-4392", "Bridal Shop Item 5", "25/9/2026", "€44 492"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Bridal Shop</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Bridal Shop</p>
                    </div>
                </div>
