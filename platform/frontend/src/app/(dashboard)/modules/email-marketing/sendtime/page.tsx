...
const ACCENT = "#0d9488";
const MODULE = "Email Marketing";
const PAGE = "Send Time AI";
const KPIS = [{"l":"Total Email Marketing","v":"4.304","t":"+14.5%","d":"up"},{"l":"Send Time AI Ativos","v":"5.996","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"73.9%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"72","t":"+9.1%","d":"up"}];
const COLS = ["ID","Send Time AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Email Marketing #001","Email Marketing #002","7.251","3.749","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Email Marketing #002","Email Marketing #003","2.793","5.972","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Email Marketing #003","Email Marketing #004","3.465","1.588","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Email Marketing #004","Email Marketing #005","5.396","7.942","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Email Marketing #005","Email Marketing #001","1.289","2.865","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":887},{"label":"Fev","value":969},{"label":"Mar","value":926},{"label":"Abr","value":834},{"label":"Mai","value":1030},{"label":"Jun","value":963},{"label":"Jul","value":806},{"label":"Ago","value":656},{"label":"Set","value":1000},{"label":"Out","value":960},{"label":"Nov","value":1019},{"label":"Dez","value":887}];
const MX = 1030;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0d9488'}}>AI</span></h1>
                </div>
