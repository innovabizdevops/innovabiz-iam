...
const PAGE = "Template Editor";
const KPIS = [{"l":"Formulários Ativos","v":"5.954","t":"+3.8%","d":"up"},{"l":"Submissões/Dia","v":"2234","t":"+3.9%","d":"up"},{"l":"Documentos Gerados","v":"7.429","t":"+17.3%","d":"up"},{"l":"Templates","v":"3.100","t":"-2.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.645","2026-02-25","7.248","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.157","2026-02-07","1.658","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.521","2026-03-24","1.731","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.364","2026-01-24","1.928","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.880","2026-01-12","8.651","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":305},{"label":"Mar","value":507},{"label":"Abr","value":282},{"label":"Mai","value":585},{"label":"Jun","value":281},{"label":"Jul","value":555},{"label":"Ago","value":470},{"label":"Set","value":372},{"label":"Out","value":634},{"label":"Nov","value":602},{"label":"Dez","value":404}];
const MX = 634;
