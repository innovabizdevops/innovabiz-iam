...
/* ═══ Health NGO Platform — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "6520", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1245", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€308K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "-3%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2046158220", cells: ["HEA-9220", "Health NGO Platform Item 1", "9/1/2026", "€8320"], status: "active" as const },
    { id: "2046161791", cells: ["HEA-3791", "Health NGO Platform Item 2", "24/8/2026", "€11 891"], status: "pending" as const },
    { id: "2046165362", cells: ["HEA-7362", "Health NGO Platform Item 3", "11/3/2026", "€15 462"], status: "completed" as const },
    { id: "2046168933", cells: ["HEA-1933", "Health NGO Platform Item 4", "26/10/2026", "€19 033"], status: "warning" as const },
    { id: "2046172504", cells: ["HEA-5504", "Health NGO Platform Item 5", "13/5/2026", "€22 604"], status: "active" as const },
];
...
export default function HealthNgoPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Health NGO Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Health NGO Platform</p>
                    </div>
                </div>
