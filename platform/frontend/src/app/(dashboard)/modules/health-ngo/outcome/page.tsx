...
const ACCENT = "#9333ea";
const MODULE = "Health NGO Platform";
const PAGE = "Outcome";
const KPIS = [{"l":"Total Health Ngo","v":"4.864","t":"+5.2%","d":"up"},{"l":"Outcome Ativos","v":"7.535","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"82.1%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"78","t":"+2.3%","d":"up"}];
const COLS = ["ID","Outcome","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Health Ngo #001","Health Ngo #002","4.584","7.158","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Health Ngo #002","Health Ngo #003","3.849","8.695","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Health Ngo #003","Health Ngo #004","8.622","6.023","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Health Ngo #004","Health Ngo #005","8.467","1.188","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Health Ngo #005","Health Ngo #001","6.932","206","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":732},{"label":"Mar","value":1003},{"label":"Abr","value":899},{"label":"Mai","value":979},{"label":"Jun","value":695},{"label":"Jul","value":821},{"label":"Ago","value":885},{"label":"Set","value":787},{"label":"Out","value":804},{"label":"Nov","value":704},{"label":"Dez","value":970}];
const MX = 1003;
