...
const PAGE = "Clinic";
const KPIS = [{"l":"Total Health Ngo","v":"3.258","t":"+14.4%","d":"up"},{"l":"Clinic Ativos","v":"3.792","t":"+5.8%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"64","t":"-2.9%","d":"down"}];
const COLS = ["ID","Clinic","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Health Ngo #001","Health Ngo #002","3.507","8.930","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Health Ngo #002","Health Ngo #003","6.752","1.420","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Health Ngo #003","Health Ngo #004","3.657","788","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Health Ngo #004","Health Ngo #005","4.057","2.460","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Health Ngo #005","Health Ngo #001","3.332","4.622","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":423},{"label":"Fev","value":711},{"label":"Mar","value":748},{"label":"Abr","value":505},{"label":"Mai","value":403},{"label":"Jun","value":494},{"label":"Jul","value":732},{"label":"Ago","value":381},{"label":"Set","value":607},{"label":"Out","value":453},{"label":"Nov","value":634},{"label":"Dez","value":374}];
const MX = 748;
