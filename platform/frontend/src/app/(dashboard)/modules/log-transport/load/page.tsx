...
const PAGE = "Load Config";
const KPIS = [{"l":"Configurações","v":"7.363","t":"+8.3%","d":"up"},{"l":"Últimas Alterações","v":"1.306","t":"+6.4%","d":"up"},{"l":"Ambientes","v":"7.337","t":"+3.9%","d":"up"},{"l":"Versão Config","v":"1.348","t":"+0.5%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 2754.18","206","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 35687.70","2.766","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 39233.78","6.220","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 16493.64","5.972","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 34846.07","8.818","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":855},{"label":"Fev","value":1019},{"label":"Mar","value":1005},{"label":"Abr","value":715},{"label":"Mai","value":999},{"label":"Jun","value":869},{"label":"Jul","value":885},{"label":"Ago","value":919},{"label":"Set","value":898},{"label":"Out","value":692},{"label":"Nov","value":669},{"label":"Dez","value":790}];
const MX = 1019;
