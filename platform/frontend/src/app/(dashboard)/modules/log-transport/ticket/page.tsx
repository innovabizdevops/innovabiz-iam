...
const PAGE = "Scale Ticket";
const KPIS = [{"l":"Tickets Abertos","v":"7.503","t":"+7.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"83.1%","t":"-1.7%","d":"down"},{"l":"MTTR (h)","v":"123h","t":"+16.2%","d":"up"},{"l":"Satisfação (%)","v":"72.5%","t":"+7.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.857","6.802","9.055","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.153","7.293","1.558","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.862","1.866","4.947","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.365","4.675","8.348","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.161","5.066","7.806","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":344},{"label":"Fev","value":397},{"label":"Mar","value":495},{"label":"Abr","value":348},{"label":"Mai","value":604},{"label":"Jun","value":571},{"label":"Jul","value":454},{"label":"Ago","value":330},{"label":"Set","value":584},{"label":"Out","value":581},{"label":"Nov","value":339},{"label":"Dez","value":597}];
const MX = 604;
