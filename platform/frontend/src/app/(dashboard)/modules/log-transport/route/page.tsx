...
const KPIS = [{"l":"Atletas Registados","v":"3.562","t":"+3.3%","d":"up"},{"l":"Treinos/Semana","v":"1249","t":"+16.8%","d":"up"},{"l":"Competições","v":"6.238","t":"-2.0%","d":"down"},{"l":"Performance Score","v":"78","t":"+15.2%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.613","7.823","5.412","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.294","7.617","5.469","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.882","8.676","1.182","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.920","8.920","2.125","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.373","4.576","4.771","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":826},{"label":"Mar","value":462},{"label":"Abr","value":616},{"label":"Mai","value":506},{"label":"Jun","value":689},{"label":"Jul","value":573},{"label":"Ago","value":592},{"label":"Set","value":646},{"label":"Out","value":616},{"label":"Nov","value":653},{"label":"Dez","value":507}];
const MX = 826;
