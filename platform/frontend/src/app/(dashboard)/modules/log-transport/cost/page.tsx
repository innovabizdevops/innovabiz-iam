...
const PAGE = "Cost Calc";
const KPIS = [{"l":"Atletas Registados","v":"1.962","t":"+2.2%","d":"up"},{"l":"Treinos/Semana","v":"1660","t":"-1.3%","d":"down"},{"l":"Competições","v":"3.211","t":"+8.6%","d":"up"},{"l":"Performance Score","v":"82","t":"+3.2%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.184","2.924","2.378","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.269","8.409","7.638","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.637","4.877","7.362","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.814","5.278","8.211","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.862","6.705","4.994","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":320},{"label":"Fev","value":510},{"label":"Mar","value":517},{"label":"Abr","value":587},{"label":"Mai","value":388},{"label":"Jun","value":459},{"label":"Jul","value":610},{"label":"Ago","value":511},{"label":"Set","value":371},{"label":"Out","value":495},{"label":"Nov","value":381},{"label":"Dez","value":597}];
const MX = 610;
