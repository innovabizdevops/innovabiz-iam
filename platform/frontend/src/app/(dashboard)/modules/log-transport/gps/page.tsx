...
const ACCENT = "#b45309";
const MODULE = "Log Transport";
const PAGE = "GPS Track";
const KPIS = [{"l":"Atletas Registados","v":"1.109","t":"+13.7%","d":"up"},{"l":"Treinos/Semana","v":"4044","t":"+13.5%","d":"up"},{"l":"Competições","v":"6.344","t":"+10.0%","d":"up"},{"l":"Performance Score","v":"78","t":"-0.4%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.133","5.130","7.411","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.488","3.417","1.893","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.882","7.624","2.591","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.748","3.061","1.939","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.942","7.600","908","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":539},{"label":"Fev","value":591},{"label":"Mar","value":547},{"label":"Abr","value":525},{"label":"Mai","value":709},{"label":"Jun","value":613},{"label":"Jul","value":399},{"label":"Ago","value":580},{"label":"Set","value":573},{"label":"Out","value":568},{"label":"Nov","value":355},{"label":"Dez","value":623}];
const MX = 709;
