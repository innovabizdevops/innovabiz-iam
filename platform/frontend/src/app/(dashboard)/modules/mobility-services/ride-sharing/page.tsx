...
const KPIS = [
    { label: "Total", value: "3879", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "277", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2949", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2143617057", cells: ["MOB-7057", "Ride Sharing Item 1", "2/10/2026", "€17 157"], status: "active" as const },
    { id: "2143620628", cells: ["MOB-1628", "Ride Sharing Item 2", "17/5/2026", "€20 728"], status: "pending" as const },
    { id: "2143624199", cells: ["MOB-5199", "Ride Sharing Item 3", "4/12/2026", "€24 299"], status: "completed" as const },
    { id: "2143627770", cells: ["MOB-8770", "Ride Sharing Item 4", "19/7/2026", "€27 870"], status: "warning" as const },
    { id: "2143631341", cells: ["MOB-3341", "Ride Sharing Item 5", "6/2/2026", "€31 441"], status: "active" as const },
];
...
export default function MobilityServicesRideSharingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ride Sharing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mobility Services • Ride Sharing</p>
                    </div>
                </div>
