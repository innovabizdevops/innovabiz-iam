...
/* ═══ Mobility Services — Recall Mgmt Auto ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "351", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "304", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "267", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "3173228", cells: ["MOB-6228", "Recall Mgmt Auto Item 1", "17/9/2026", "€23 328"], status: "active" as const },
    { id: "3176799", cells: ["MOB-9799", "Recall Mgmt Auto Item 2", "4/4/2026", "€26 899"], status: "pending" as const },
    { id: "3180370", cells: ["MOB-4370", "Recall Mgmt Auto Item 3", "19/11/2026", "€30 470"], status: "completed" as const },
    { id: "3183941", cells: ["MOB-7941", "Recall Mgmt Auto Item 4", "6/6/2026", "€34 041"], status: "warning" as const },
    { id: "3187512", cells: ["MOB-2512", "Recall Mgmt Auto Item 5", "21/1/2026", "€37 612"], status: "active" as const },
];
...
export default function MobilityServicesRecallMgmtAutoPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Recall Mgmt Auto</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mobility Services • Recall Mgmt Auto</p>
                    </div>
                </div>
