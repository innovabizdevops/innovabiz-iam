...
/* ═══ Mobility Services — Fleet Telematics ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "729", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "134", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2792", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1191978914", cells: ["MOB-1914", "Fleet Telematics Item 1", "15/3/2026", "€29 014"], status: "active" as const },
    { id: "1191982485", cells: ["MOB-5485", "Fleet Telematics Item 2", "2/10/2026", "€32 585"], status: "pending" as const },
    { id: "1191986056", cells: ["MOB-9056", "Fleet Telematics Item 3", "17/5/2026", "€36 156"], status: "completed" as const },
    { id: "1191989627", cells: ["MOB-3627", "Fleet Telematics Item 4", "4/12/2026", "€39 727"], status: "warning" as const },
    { id: "1191993198", cells: ["MOB-7198", "Fleet Telematics Item 5", "19/7/2026", "€43 298"], status: "active" as const },
];
...
export default function MobilityServicesFleetTelematicsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fleet Telematics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mobility Services • Fleet Telematics</p>
                    </div>
                </div>
