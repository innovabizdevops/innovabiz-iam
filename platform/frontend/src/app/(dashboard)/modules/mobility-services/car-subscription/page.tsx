...
/* ═══ Mobility Services — Car Subscription ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "4052", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "30", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2041", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "512937450", cells: ["MOB-1450", "Car Subscription Item 1", "19/7/2026", "€37 550"], status: "active" as const },
    { id: "512941021", cells: ["MOB-5021", "Car Subscription Item 2", "6/2/2026", "€41 121"], status: "pending" as const },
    { id: "512944592", cells: ["MOB-8592", "Car Subscription Item 3", "21/9/2026", "€44 692"], status: "completed" as const },
    { id: "512948163", cells: ["MOB-3163", "Car Subscription Item 4", "8/4/2026", "€48 263"], status: "warning" as const },
    { id: "512951734", cells: ["MOB-6734", "Car Subscription Item 5", "23/11/2026", "€1834"], status: "active" as const },
];
...
export default function MobilityServicesCarSubscriptionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Car Subscription</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mobility Services • Car Subscription</p>
                    </div>
                </div>
