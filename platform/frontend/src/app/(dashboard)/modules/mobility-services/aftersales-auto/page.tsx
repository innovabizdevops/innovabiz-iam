...
/* ═══ Mobility Services — Aftersales Auto ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "176", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "274", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2451", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "110030446", cells: ["MOB-6446", "Aftersales Auto Item 1", "23/11/2026", "€30 546"], status: "active" as const },
    { id: "110034017", cells: ["MOB-1017", "Aftersales Auto Item 2", "10/6/2026", "€34 117"], status: "pending" as const },
    { id: "110037588", cells: ["MOB-4588", "Aftersales Auto Item 3", "25/1/2026", "€37 688"], status: "completed" as const },
    { id: "110041159", cells: ["MOB-8159", "Aftersales Auto Item 4", "12/8/2026", "€41 259"], status: "warning" as const },
    { id: "110044730", cells: ["MOB-2730", "Aftersales Auto Item 5", "27/3/2026", "€44 830"], status: "active" as const },
];
...
export default function MobilityServicesAftersalesAutoPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Aftersales Auto</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mobility Services • Aftersales Auto</p>
                    </div>
                </div>
