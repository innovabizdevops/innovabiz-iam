...
/* ═══ Mobility Services — Autonomous Drive ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "1530", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "171", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2793", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "97215687", cells: ["MOB-7687", "Autonomous Drive Item 1", "24/4/2026", "€15 787"], status: "active" as const },
    { id: "97219258", cells: ["MOB-2258", "Autonomous Drive Item 2", "11/11/2026", "€19 358"], status: "pending" as const },
    { id: "97222829", cells: ["MOB-5829", "Autonomous Drive Item 3", "26/6/2026", "€22 929"], status: "completed" as const },
    { id: "97226400", cells: ["MOB-9400", "Autonomous Drive Item 4", "13/1/2026", "€26 500"], status: "warning" as const },
    { id: "97229971", cells: ["MOB-3971", "Autonomous Drive Item 5", "28/8/2026", "€30 071"], status: "active" as const },
];
...
export default function MobilityServicesAutonomousDrivePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Autonomous Drive</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mobility Services • Autonomous Drive</p>
                    </div>
                </div>
