...
/* ═══ Mobility Services — Dealer Portal ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "2254", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "174", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "652", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "888453242", cells: ["MOB-1242", "Dealer Portal Item 1", "27/3/2026", "€3342"], status: "active" as const },
    { id: "888456813", cells: ["MOB-4813", "Dealer Portal Item 2", "14/10/2026", "€6913"], status: "pending" as const },
    { id: "888460384", cells: ["MOB-8384", "Dealer Portal Item 3", "1/5/2026", "€10 484"], status: "completed" as const },
    { id: "888463955", cells: ["MOB-2955", "Dealer Portal Item 4", "16/12/2026", "€14 055"], status: "warning" as const },
    { id: "888467526", cells: ["MOB-6526", "Dealer Portal Item 5", "3/7/2026", "€17 626"], status: "active" as const },
];
...
export default function MobilityServicesDealerPortalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Dealer Portal</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mobility Services • Dealer Portal</p>
                    </div>
                </div>
