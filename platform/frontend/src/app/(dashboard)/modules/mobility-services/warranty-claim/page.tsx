...
/* ═══ Mobility Services — Warranty Claim ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "3321", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "335", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "652", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2095998139", cells: ["MOB-7139", "Warranty Claim Item 1", "12/8/2026", "€48 239"], status: "active" as const },
    { id: "2096001710", cells: ["MOB-1710", "Warranty Claim Item 2", "27/3/2026", "€1810"], status: "pending" as const },
    { id: "2096005281", cells: ["MOB-5281", "Warranty Claim Item 3", "14/10/2026", "€5381"], status: "completed" as const },
    { id: "2096008852", cells: ["MOB-8852", "Warranty Claim Item 4", "1/5/2026", "€8952"], status: "warning" as const },
    { id: "2096012423", cells: ["MOB-3423", "Warranty Claim Item 5", "16/12/2026", "€12 523"], status: "active" as const },
];
...
export default function MobilityServicesWarrantyClaimPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Warranty Claim</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mobility Services • Warranty Claim</p>
                    </div>
                </div>
