...
/* ═══ Mobility Services — Connected Vehicle ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "3224", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "156", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1827", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "97%", trend: "-8%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1329511800", cells: ["MOB-5800", "Connected Vehicle Item 1", "9/1/2026", "€11 900"], status: "active" as const },
    { id: "1329515371", cells: ["MOB-9371", "Connected Vehicle Item 2", "24/8/2026", "€15 471"], status: "pending" as const },
    { id: "1329518942", cells: ["MOB-3942", "Connected Vehicle Item 3", "11/3/2026", "€19 042"], status: "completed" as const },
    { id: "1329522513", cells: ["MOB-7513", "Connected Vehicle Item 4", "26/10/2026", "€22 613"], status: "warning" as const },
    { id: "1329526084", cells: ["MOB-2084", "Connected Vehicle Item 5", "13/5/2026", "€26 184"], status: "active" as const },
];
...
export default function MobilityServicesConnectedVehiclePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Connected Vehicle</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mobility Services • Connected Vehicle</p>
                    </div>
                </div>
