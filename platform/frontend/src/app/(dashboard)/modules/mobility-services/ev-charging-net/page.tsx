...
/* ═══ Mobility Services — Ev Charging Net ═══ */

const ACCENT = "#2d4a6f";

const KPIS = [
    { label: "Total", value: "4324", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "308", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "496", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "669291312", cells: ["MOB-7312", "Ev Charging Net Item 1", "5/1/2026", "€41 412"], status: "active" as const },
    { id: "669294883", cells: ["MOB-1883", "Ev Charging Net Item 2", "20/8/2026", "€44 983"], status: "pending" as const },
    { id: "669298454", cells: ["MOB-5454", "Ev Charging Net Item 3", "7/3/2026", "€48 554"], status: "completed" as const },
    { id: "669302025", cells: ["MOB-9025", "Ev Charging Net Item 4", "22/10/2026", "€2125"], status: "warning" as const },
    { id: "669305596", cells: ["MOB-3596", "Ev Charging Net Item 5", "9/5/2026", "€5696"], status: "active" as const },
];
...
export default function MobilityServicesEvChargingNetPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ev Charging Net</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mobility Services • Ev Charging Net</p>
                    </div>
                </div>
