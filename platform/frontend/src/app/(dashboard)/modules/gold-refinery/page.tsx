...
/* ═══ Gold Refinery — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "5144", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "917", trend: "-14%", trendDirection: "down" as const, icon: Users },
...
const TABLE_ROWS = [
    { id: "1439930344", cells: ["GOL-3344", "Gold Refinery Item 1", "21/5/2026", "€30 444"], status: "active" as const },
    { id: "1439933915", cells: ["GOL-6915", "Gold Refinery Item 2", "8/12/2026", "€34 015"], status: "pending" as const },
    { id: "1439937486", cells: ["GOL-1486", "Gold Refinery Item 3", "23/7/2026", "€37 586"], status: "completed" as const },
    { id: "1439941057", cells: ["GOL-5057", "Gold Refinery Item 4", "10/2/2026", "€41 157"], status: "warning" as const },
    { id: "1439944628", cells: ["GOL-8628", "Gold Refinery Item 5", "25/9/2026", "€44 728"], status: "active" as const },
];
...
export default function GoldRefineryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Gold Refinery</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Gold Refinery</p>
                    </div>
                </div>
