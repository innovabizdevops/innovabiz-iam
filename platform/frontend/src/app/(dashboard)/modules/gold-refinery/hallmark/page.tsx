...
const ACCENT = "#92400e";
const MODULE = "Gold Refinery";
const PAGE = "Hallmark";
const KPIS = [{"l":"Total Gold Refinery","v":"2.427","t":"+14.1%","d":"up"},{"l":"Hallmark Ativos","v":"425","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"79.6%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"67","t":"+3.0%","d":"up"}];
const COLS = ["ID","Hallmark","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gold Refinery #001","Gold Refinery #002","7.401","4.656","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Gold Refinery #002","Gold Refinery #003","1.277","5.561","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Gold Refinery #003","Gold Refinery #004","8.734","613","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Gold Refinery #004","Gold Refinery #005","7.446","5.873","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gold Refinery #005","Gold Refinery #001","9.081","7.189","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":650},{"label":"Mar","value":896},{"label":"Abr","value":1029},{"label":"Mai","value":867},{"label":"Jun","value":875},{"label":"Jul","value":722},{"label":"Ago","value":643},{"label":"Set","value":636},{"label":"Out","value":903},{"label":"Nov","value":854},{"label":"Dez","value":928}];
const MX = 1029;
