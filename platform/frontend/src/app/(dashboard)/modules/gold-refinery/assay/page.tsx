...
const PAGE = "Assay";
const KPIS = [{"l":"Total Gold Refinery","v":"6.918","t":"+1.4%","d":"up"},{"l":"Assay Ativos","v":"4.479","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"94.9%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"75","t":"+0.4%","d":"up"}];
const COLS = ["ID","Assay","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gold Refinery #001","Gold Refinery #002","2.266","5.348","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Gold Refinery #002","Gold Refinery #003","4.257","7.207","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Gold Refinery #003","Gold Refinery #004","4.681","4.785","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Gold Refinery #004","Gold Refinery #005","2.829","8.065","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gold Refinery #005","Gold Refinery #001","7.638","2.051","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":450},{"label":"Mar","value":400},{"label":"Abr","value":671},{"label":"Mai","value":319},{"label":"Jun","value":468},{"label":"Jul","value":311},{"label":"Ago","value":557},{"label":"Set","value":585},{"label":"Out","value":592},{"label":"Nov","value":635},{"label":"Dez","value":336}];
const MX = 701;
