...
/* ═══ Telecom Infra — Ran Mgmt ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "4172", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "111", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "140", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "873985355", cells: ["TEL-5355", "Ran Mgmt Item 1", "20/12/2026", "€35 455"], status: "active" as const },
    { id: "873988926", cells: ["TEL-8926", "Ran Mgmt Item 2", "7/7/2026", "€39 026"], status: "pending" as const },
    { id: "873992497", cells: ["TEL-3497", "Ran Mgmt Item 3", "22/2/2026", "€42 597"], status: "completed" as const },
    { id: "873996068", cells: ["TEL-7068", "Ran Mgmt Item 4", "9/9/2026", "€46 168"], status: "warning" as const },
    { id: "873999639", cells: ["TEL-1639", "Ran Mgmt Item 5", "24/4/2026", "€49 739"], status: "active" as const },
];
...
export default function TelecomInfraRanMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ran Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Infra • Ran Mgmt</p>
                    </div>
                </div>
