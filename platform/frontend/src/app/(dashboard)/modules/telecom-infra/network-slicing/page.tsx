...
/* ═══ Telecom Infra — Network Slicing ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "1200", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "330", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2792", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "41213974", cells: ["TEL-3974", "Network Slicing Item 1", "19/11/2026", "€14 074"], status: "active" as const },
    { id: "41217545", cells: ["TEL-7545", "Network Slicing Item 2", "6/6/2026", "€17 645"], status: "pending" as const },
    { id: "41221116", cells: ["TEL-2116", "Network Slicing Item 3", "21/1/2026", "€21 216"], status: "completed" as const },
    { id: "41224687", cells: ["TEL-5687", "Network Slicing Item 4", "8/8/2026", "€24 787"], status: "warning" as const },
    { id: "41228258", cells: ["TEL-9258", "Network Slicing Item 5", "23/3/2026", "€28 358"], status: "active" as const },
];
...
export default function TelecomInfraNetworkSlicingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Network Slicing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Infra • Network Slicing</p>
                    </div>
                </div>
