...
/* ═══ Telecom Infra — Edge Compute Tel ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "3793", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "82", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2559", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1784063486", cells: ["TEL-3486", "Edge Compute Tel Item 1", "3/3/2026", "€13 586"], status: "active" as const },
    { id: "1784067057", cells: ["TEL-7057", "Edge Compute Tel Item 2", "18/10/2026", "€17 157"], status: "pending" as const },
    { id: "1784070628", cells: ["TEL-1628", "Edge Compute Tel Item 3", "5/5/2026", "€20 728"], status: "completed" as const },
    { id: "1784074199", cells: ["TEL-5199", "Edge Compute Tel Item 4", "20/12/2026", "€24 299"], status: "warning" as const },
    { id: "1784077770", cells: ["TEL-8770", "Edge Compute Tel Item 5", "7/7/2026", "€27 870"], status: "active" as const },
];
...
export default function TelecomInfraEdgeComputeTelPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Edge Compute Tel</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Infra • Edge Compute Tel</p>
                    </div>
                </div>
