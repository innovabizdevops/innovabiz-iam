...
/* ═══ Telecom Infra — Sd Wan Mgmt ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "1908", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "27", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3187", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1881201063", cells: ["TEL-4063", "Sd Wan Mgmt Item 1", "8/4/2026", "€1163"], status: "active" as const },
    { id: "1881204634", cells: ["TEL-7634", "Sd Wan Mgmt Item 2", "23/11/2026", "€4734"], status: "pending" as const },
    { id: "1881208205", cells: ["TEL-2205", "Sd Wan Mgmt Item 3", "10/6/2026", "€8305"], status: "completed" as const },
    { id: "1881211776", cells: ["TEL-5776", "Sd Wan Mgmt Item 4", "25/1/2026", "€11 876"], status: "warning" as const },
    { id: "1881215347", cells: ["TEL-9347", "Sd Wan Mgmt Item 5", "12/8/2026", "€15 447"], status: "active" as const },
];
...
export default function TelecomInfraSdWanMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sd Wan Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Infra • Sd Wan Mgmt</p>
                    </div>
                </div>
