...
/* ═══ Telecom Infra — Bss Platform ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "3440", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "472", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3396", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "487304612", cells: ["TEL-9612", "Bss Platform Item 1", "5/9/2026", "€4712"], status: "active" as const },
    { id: "487308183", cells: ["TEL-4183", "Bss Platform Item 2", "20/4/2026", "€8283"], status: "pending" as const },
    { id: "487311754", cells: ["TEL-7754", "Bss Platform Item 3", "7/11/2026", "€11 854"], status: "completed" as const },
    { id: "487315325", cells: ["TEL-2325", "Bss Platform Item 4", "22/6/2026", "€15 425"], status: "warning" as const },
    { id: "487318896", cells: ["TEL-5896", "Bss Platform Item 5", "9/1/2026", "€18 996"], status: "active" as const },
];
...
export default function TelecomInfraBssPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Bss Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Infra • Bss Platform</p>
                    </div>
                </div>
