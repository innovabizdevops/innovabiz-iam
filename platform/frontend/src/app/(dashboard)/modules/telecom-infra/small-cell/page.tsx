...
/* ═══ Telecom Infra — Small Cell ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "2151", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "310", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1896", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "127690066", cells: ["TEL-8066", "Small Cell Item 1", "15/11/2026", "€40 166"], status: "active" as const },
    { id: "127693637", cells: ["TEL-2637", "Small Cell Item 2", "2/6/2026", "€43 737"], status: "pending" as const },
    { id: "127697208", cells: ["TEL-6208", "Small Cell Item 3", "17/1/2026", "€47 308"], status: "completed" as const },
    { id: "127700779", cells: ["TEL-9779", "Small Cell Item 4", "4/8/2026", "€879"], status: "warning" as const },
    { id: "127704350", cells: ["TEL-4350", "Small Cell Item 5", "19/3/2026", "€4450"], status: "active" as const },
];
...
export default function TelecomInfraSmallCellPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Small Cell</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Infra • Small Cell</p>
                    </div>
                </div>
