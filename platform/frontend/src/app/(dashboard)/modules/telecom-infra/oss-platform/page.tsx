...
/* ═══ Telecom Infra — Oss Platform ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "655", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "413", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1594", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2129587337", cells: ["TEL-8337", "Oss Platform Item 1", "18/6/2026", "€37 437"], status: "active" as const },
    { id: "2129590908", cells: ["TEL-2908", "Oss Platform Item 2", "5/1/2026", "€41 008"], status: "pending" as const },
    { id: "2129594479", cells: ["TEL-6479", "Oss Platform Item 3", "20/8/2026", "€44 579"], status: "completed" as const },
    { id: "2129598050", cells: ["TEL-1050", "Oss Platform Item 4", "7/3/2026", "€48 150"], status: "warning" as const },
    { id: "2129601621", cells: ["TEL-4621", "Oss Platform Item 5", "22/10/2026", "€1721"], status: "active" as const },
];
...
export default function TelecomInfraOssPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Oss Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Infra • Oss Platform</p>
                    </div>
                </div>
