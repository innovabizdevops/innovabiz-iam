...
/* ═══ Telecom Infra — Fiber Network ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "2610", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "269", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2401", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1166507961", cells: ["TEL-9961", "Fiber Network Item 1", "18/10/2026", "€8061"], status: "active" as const },
    { id: "1166511532", cells: ["TEL-4532", "Fiber Network Item 2", "5/5/2026", "€11 632"], status: "pending" as const },
    { id: "1166515103", cells: ["TEL-8103", "Fiber Network Item 3", "20/12/2026", "€15 203"], status: "completed" as const },
    { id: "1166518674", cells: ["TEL-2674", "Fiber Network Item 4", "7/7/2026", "€18 774"], status: "warning" as const },
    { id: "1166522245", cells: ["TEL-6245", "Fiber Network Item 5", "22/2/2026", "€22 345"], status: "active" as const },
];
...
export default function TelecomInfraFiberNetworkPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fiber Network</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Infra • Fiber Network</p>
                    </div>
                </div>
