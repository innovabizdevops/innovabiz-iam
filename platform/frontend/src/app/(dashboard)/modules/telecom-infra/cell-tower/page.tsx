...
/* ═══ Telecom Infra — Cell Tower ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "1205", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "386", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3198", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "160872542", cells: ["TEL-7542", "Cell Tower Item 1", "27/3/2026", "€22 642"], status: "active" as const },
    { id: "160876113", cells: ["TEL-2113", "Cell Tower Item 2", "14/10/2026", "€26 213"], status: "pending" as const },
    { id: "160879684", cells: ["TEL-5684", "Cell Tower Item 3", "1/5/2026", "€29 784"], status: "completed" as const },
    { id: "160883255", cells: ["TEL-9255", "Cell Tower Item 4", "16/12/2026", "€33 355"], status: "warning" as const },
    { id: "160886826", cells: ["TEL-3826", "Cell Tower Item 5", "3/7/2026", "€36 926"], status: "active" as const },
];
...
export default function TelecomInfraCellTowerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cell Tower</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Infra • Cell Tower</p>
                    </div>
                </div>
