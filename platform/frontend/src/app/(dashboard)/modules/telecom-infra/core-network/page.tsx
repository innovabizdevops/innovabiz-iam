...
/* ═══ Telecom Infra — Core Network ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "110", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "276", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1183", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "754631552", cells: ["TEL-9552", "Core Network Item 1", "25/9/2026", "€31 652"], status: "active" as const },
    { id: "754635123", cells: ["TEL-4123", "Core Network Item 2", "12/4/2026", "€35 223"], status: "pending" as const },
    { id: "754638694", cells: ["TEL-7694", "Core Network Item 3", "27/11/2026", "€38 794"], status: "completed" as const },
    { id: "754642265", cells: ["TEL-2265", "Core Network Item 4", "14/6/2026", "€42 365"], status: "warning" as const },
    { id: "754645836", cells: ["TEL-5836", "Core Network Item 5", "1/1/2026", "€45 936"], status: "active" as const },
];
...
export default function TelecomInfraCoreNetworkPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Core Network</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Infra • Core Network</p>
                    </div>
                </div>
