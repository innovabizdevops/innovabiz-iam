...
const PAGE = "Report";
const KPIS = [{"l":"Total Mrf Ops","v":"7.066","t":"+12.5%","d":"up"},{"l":"Report Ativos","v":"4.070","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"84.4%","t":"+13.2%","d":"up"},{"l":"Score Performance","v":"80","t":"+13.0%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mrf Ops #001","Mrf Ops #002","555","8.017","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Mrf Ops #002","Mrf Ops #003","4.321","6.933","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Mrf Ops #003","Mrf Ops #004","4.819","1.360","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Mrf Ops #004","Mrf Ops #005","8.936","7.486","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mrf Ops #005","Mrf Ops #001","4.624","3.704","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":496},{"label":"Fev","value":434},{"label":"Mar","value":728},{"label":"Abr","value":421},{"label":"Mai","value":567},{"label":"Jun","value":527},{"label":"Jul","value":648},{"label":"Ago","value":548},{"label":"Set","value":555},{"label":"Out","value":726},{"label":"Nov","value":729},{"label":"Dez","value":763}];
const MX = 763;
