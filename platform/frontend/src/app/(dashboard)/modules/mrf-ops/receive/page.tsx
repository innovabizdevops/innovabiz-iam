...
const PAGE = "Receive";
const KPIS = [{"l":"Total Mrf Ops","v":"2.407","t":"+6.0%","d":"up"},{"l":"Receive Ativos","v":"3.454","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"73.7%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"89","t":"+1.8%","d":"up"}];
const COLS = ["ID","Receive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mrf Ops #001","Mrf Ops #002","1.408","575","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Mrf Ops #002","Mrf Ops #003","2.853","1.908","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Mrf Ops #003","Mrf Ops #004","8.349","1.153","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Mrf Ops #004","Mrf Ops #005","3.028","4.863","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mrf Ops #005","Mrf Ops #001","3.441","8.111","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":655},{"label":"Mar","value":440},{"label":"Abr","value":431},{"label":"Mai","value":780},{"label":"Jun","value":487},{"label":"Jul","value":734},{"label":"Ago","value":707},{"label":"Set","value":640},{"label":"Out","value":442},{"label":"Nov","value":579},{"label":"Dez","value":564}];
const MX = 780;
