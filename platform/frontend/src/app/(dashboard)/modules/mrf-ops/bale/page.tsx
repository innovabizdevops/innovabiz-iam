...
const PAGE = "Bale";
const KPIS = [{"l":"Total Mrf Ops","v":"6.596","t":"+5.3%","d":"up"},{"l":"Bale Ativos","v":"101","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"86.3%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"70","t":"+11.3%","d":"up"}];
const COLS = ["ID","Bale","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mrf Ops #001","Mrf Ops #002","7.197","4.878","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Mrf Ops #002","Mrf Ops #003","4.728","6.269","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Mrf Ops #003","Mrf Ops #004","7.864","8.404","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Mrf Ops #004","Mrf Ops #005","2.030","2.480","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mrf Ops #005","Mrf Ops #001","2.764","3.214","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":331},{"label":"Mar","value":402},{"label":"Abr","value":504},{"label":"Mai","value":355},{"label":"Jun","value":641},{"label":"Jul","value":364},{"label":"Ago","value":404},{"label":"Set","value":306},{"label":"Out","value":400},{"label":"Nov","value":485},{"label":"Dez","value":419}];
const MX = 641;
