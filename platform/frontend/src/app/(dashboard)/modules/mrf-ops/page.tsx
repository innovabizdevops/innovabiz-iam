...
/* ═══ MRF Operations — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "997", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2915", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€343K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "568033197", cells: ["MRF-8197", "MRF Operations Item 1", "26/10/2026", "€33 297"], status: "active" as const },
    { id: "568036768", cells: ["MRF-2768", "MRF Operations Item 2", "13/5/2026", "€36 868"], status: "pending" as const },
    { id: "568040339", cells: ["MRF-6339", "MRF Operations Item 3", "28/12/2026", "€40 439"], status: "completed" as const },
    { id: "568043910", cells: ["MRF-9910", "MRF Operations Item 4", "15/7/2026", "€44 010"], status: "warning" as const },
    { id: "568047481", cells: ["MRF-4481", "MRF Operations Item 5", "2/2/2026", "€47 581"], status: "active" as const },
];
...
export default function MrfOperationsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MRF Operations</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MRF Operations</p>
                    </div>
                </div>
