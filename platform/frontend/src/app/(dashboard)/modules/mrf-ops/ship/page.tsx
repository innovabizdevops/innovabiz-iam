...
const PAGE = "Ship";
const KPIS = [{"l":"Total Mrf Ops","v":"6.855","t":"+9.3%","d":"up"},{"l":"Ship Ativos","v":"2.922","t":"+8.3%","d":"up"},{"l":"Eficiência (%)","v":"82.0%","t":"+15.9%","d":"up"},{"l":"Score Performance","v":"88","t":"+15.1%","d":"up"}];
const COLS = ["ID","Ship","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mrf Ops #001","Mrf Ops #002","1.603","693","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Mrf Ops #002","Mrf Ops #003","7.318","846","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Mrf Ops #003","Mrf Ops #004","4.824","2.623","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Mrf Ops #004","Mrf Ops #005","3.359","946","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mrf Ops #005","Mrf Ops #001","4.877","1.470","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":212},{"label":"Fev","value":221},{"label":"Mar","value":595},{"label":"Abr","value":206},{"label":"Mai","value":404},{"label":"Jun","value":440},{"label":"Jul","value":311},{"label":"Ago","value":256},{"label":"Set","value":510},{"label":"Out","value":385},{"label":"Nov","value":325},{"label":"Dez","value":224}];
const MX = 595;
