...
const ACCENT = "#059669";
const MODULE = "MRF Operations";
const PAGE = "Sort";
const KPIS = [{"l":"Total Mrf Ops","v":"358","t":"+3.3%","d":"up"},{"l":"Sort Ativos","v":"6.700","t":"+17.7%","d":"up"},{"l":"Eficiência (%)","v":"75.1%","t":"+12.8%","d":"up"},{"l":"Score Performance","v":"92","t":"+1.9%","d":"up"}];
const COLS = ["ID","Sort","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mrf Ops #001","Mrf Ops #002","7.536","5.764","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Mrf Ops #002","Mrf Ops #003","8.250","743","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Mrf Ops #003","Mrf Ops #004","8.770","1.804","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Mrf Ops #004","Mrf Ops #005","3.781","8.221","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mrf Ops #005","Mrf Ops #001","4.965","1.575","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":206},{"label":"Fev","value":210},{"label":"Mar","value":584},{"label":"Abr","value":208},{"label":"Mai","value":280},{"label":"Jun","value":368},{"label":"Jul","value":416},{"label":"Ago","value":528},{"label":"Set","value":538},{"label":"Out","value":454},{"label":"Nov","value":368},{"label":"Dez","value":341}];
const MX = 584;
