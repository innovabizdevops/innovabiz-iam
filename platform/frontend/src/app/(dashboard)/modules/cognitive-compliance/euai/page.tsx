...
const PAGE = "EU AI Act";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.781","t":"+17.4%","d":"up"},{"l":"NC Abertas","v":"6.177","t":"-0.9%","d":"down"},{"l":"Conformidade (%)","v":"78.5%","t":"+5.8%","d":"up"},{"l":"CAPAs Pendentes","v":"6.528","t":"+2.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.664","76.1%","1.415","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","104","93.6%","271","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.913","99.8%","872","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.373","95.3%","3.113","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.179","70.6%","7.230","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":533},{"label":"Mar","value":661},{"label":"Abr","value":468},{"label":"Mai","value":581},{"label":"Jun","value":615},{"label":"Jul","value":375},{"label":"Ago","value":417},{"label":"Set","value":640},{"label":"Out","value":637},{"label":"Nov","value":668},{"label":"Dez","value":491}];
const MX = 668;
