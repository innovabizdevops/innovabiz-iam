...
/* ═══ Cognitive Compliance Hub — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "7903", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "664", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€331K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "417589803", cells: ["COG-8803", "Cognitive Compliance Hub Item 1", "16/4/2026", "€39 903"], status: "active" as const },
    { id: "417593374", cells: ["COG-3374", "Cognitive Compliance Hub Item 2", "3/11/2026", "€43 474"], status: "pending" as const },
    { id: "417596945", cells: ["COG-6945", "Cognitive Compliance Hub Item 3", "18/6/2026", "€47 045"], status: "completed" as const },
    { id: "417600516", cells: ["COG-1516", "Cognitive Compliance Hub Item 4", "5/1/2026", "€616"], status: "warning" as const },
    { id: "417604087", cells: ["COG-5087", "Cognitive Compliance Hub Item 5", "20/8/2026", "€4187"], status: "active" as const },
];
...
export default function CognitiveComplianceHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cognitive Compliance Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cognitive Compliance Hub</p>
                    </div>
                </div>
