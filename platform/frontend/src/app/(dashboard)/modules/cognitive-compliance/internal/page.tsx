...
const PAGE = "Internal";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.343","t":"+12.6%","d":"up"},{"l":"NC Abertas","v":"5.077","t":"-2.2%","d":"down"},{"l":"Conformidade (%)","v":"77.6%","t":"+7.4%","d":"up"},{"l":"CAPAs Pendentes","v":"2.344","t":"+6.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.829","97.4%","4.960","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","564","83.5%","7.526","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.417","75.4%","2.017","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.034","76.5%","8.460","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.503","72.7%","7.852","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":994},{"label":"Fev","value":855},{"label":"Mar","value":666},{"label":"Abr","value":781},{"label":"Mai","value":855},{"label":"Jun","value":738},{"label":"Jul","value":878},{"label":"Ago","value":904},{"label":"Set","value":990},{"label":"Out","value":922},{"label":"Nov","value":983},{"label":"Dez","value":646}];
const MX = 994;
