...
const PAGE = "NIST AI";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.817","t":"+4.5%","d":"up"},{"l":"NC Abertas","v":"6.976","t":"+4.2%","d":"up"},{"l":"Conformidade (%)","v":"70.6%","t":"+0.9%","d":"up"},{"l":"CAPAs Pendentes","v":"3.439","t":"+4.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.492","81.5%","2.699","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.604","91.1%","8.988","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.848","82.5%","7.853","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.616","99.2%","6.616","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.312","77.0%","9.004","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":627},{"label":"Mar","value":552},{"label":"Abr","value":471},{"label":"Mai","value":705},{"label":"Jun","value":690},{"label":"Jul","value":698},{"label":"Ago","value":597},{"label":"Set","value":461},{"label":"Out","value":695},{"label":"Nov","value":540},{"label":"Dez","value":634}];
const MX = 705;
