...
const ACCENT = "#312e81";
const MODULE = "Cognitive Compliance Hub";
const PAGE = "ISO 42001";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.333","t":"+15.4%","d":"up"},{"l":"NC Abertas","v":"7.637","t":"+1.7%","d":"up"},{"l":"Conformidade (%)","v":"90.5%","t":"+11.0%","d":"up"},{"l":"CAPAs Pendentes","v":"1.592","t":"+7.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.218","84.1%","2.154","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.479","98.1%","3.531","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.135","87.0%","1.313","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.371","89.6%","5.845","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.375","76.0%","6.581","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":261},{"label":"Fev","value":279},{"label":"Mar","value":528},{"label":"Abr","value":489},{"label":"Mai","value":219},{"label":"Jun","value":222},{"label":"Jul","value":589},{"label":"Ago","value":222},{"label":"Set","value":376},{"label":"Out","value":306},{"label":"Nov","value":469},{"label":"Dez","value":376}];
const MX = 589;
