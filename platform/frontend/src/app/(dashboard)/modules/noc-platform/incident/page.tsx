...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"2.963","t":"+6.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"89.6%","t":"+0.4%","d":"up"},{"l":"MTTR (h)","v":"92h","t":"+4.2%","d":"up"},{"l":"Satisfação (%)","v":"76.2%","t":"+1.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.931","8.364","5.972","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.699","2.592","1.634","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.235","7.830","2.592","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.839","5.361","962","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","464","2.737","9.019","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":730},{"label":"Mar","value":897},{"label":"Abr","value":570},{"label":"Mai","value":825},{"label":"Jun","value":793},{"label":"Jul","value":577},{"label":"Ago","value":877},{"label":"Set","value":716},{"label":"Out","value":708},{"label":"Nov","value":699},{"label":"Dez","value":625}];
const MX = 897;
