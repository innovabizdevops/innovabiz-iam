...
const PAGE = "SLA";
const KPIS = [{"l":"Tickets Abertos","v":"3.175","t":"+5.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"69.4%","t":"+9.7%","d":"up"},{"l":"MTTR (h)","v":"131h","t":"+11.7%","d":"up"},{"l":"Satisfação (%)","v":"81.9%","t":"+7.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","912","5.529","2.223","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","136","5.274","6.076","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.423","5.329","7.533","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.368","1.944","2.504","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.738","3.597","2.286","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":712},{"label":"Fev","value":566},{"label":"Mar","value":840},{"label":"Abr","value":614},{"label":"Mai","value":665},{"label":"Jun","value":768},{"label":"Jul","value":529},{"label":"Ago","value":780},{"label":"Set","value":636},{"label":"Out","value":605},{"label":"Nov","value":788},{"label":"Dez","value":558}];
const MX = 840;
