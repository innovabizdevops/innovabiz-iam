...
const PAGE = "Escalate";
const KPIS = [{"l":"Formulários Ativos","v":"933","t":"-4.5%","d":"down"},{"l":"Submissões/Dia","v":"299","t":"+12.0%","d":"up"},{"l":"Documentos Gerados","v":"4.270","t":"+3.2%","d":"up"},{"l":"Templates","v":"6.221","t":"-2.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","9.090","2026-03-14","3.804","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.148","2026-03-23","5.615","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.923","2026-03-05","1.201","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","460","2026-03-05","3.454","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.749","2026-01-24","4.742","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":759},{"label":"Mar","value":837},{"label":"Abr","value":998},{"label":"Mai","value":728},{"label":"Jun","value":986},{"label":"Jul","value":981},{"label":"Ago","value":751},{"label":"Set","value":626},{"label":"Out","value":633},{"label":"Nov","value":925},{"label":"Dez","value":732}];
const MX = 998;
