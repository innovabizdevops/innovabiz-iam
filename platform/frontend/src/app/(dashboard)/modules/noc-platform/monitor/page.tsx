...
const ACCENT = "#fb923c";
const MODULE = "NOC Platform";
const PAGE = "Monitor";
const KPIS = [{"l":"Formulários Ativos","v":"6.473","t":"+3.6%","d":"up"},{"l":"Submissões/Dia","v":"3833","t":"+9.0%","d":"up"},{"l":"Documentos Gerados","v":"5.696","t":"-0.1%","d":"down"},{"l":"Templates","v":"6.421","t":"+0.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.887","2026-02-02","4.417","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","399","2026-01-03","333","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.490","2026-03-14","120","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.871","2026-02-27","7.097","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.124","2026-01-04","1.532","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":265},{"label":"Fev","value":504},{"label":"Mar","value":323},{"label":"Abr","value":446},{"label":"Mai","value":331},{"label":"Jun","value":562},{"label":"Jul","value":286},{"label":"Ago","value":325},{"label":"Set","value":414},{"label":"Out","value":620},{"label":"Nov","value":534},{"label":"Dez","value":605}];
const MX = 620;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#fb923c'}}>RTM</span></h1>
                </div>
