...
const PAGE = "Alarm";
const KPIS = [{"l":"Formulários Ativos","v":"7.614","t":"-4.5%","d":"down"},{"l":"Submissões/Dia","v":"1138","t":"+16.1%","d":"up"},{"l":"Documentos Gerados","v":"2.692","t":"-4.0%","d":"down"},{"l":"Templates","v":"165","t":"+7.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.320","2026-01-14","3.844","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","732","2026-01-28","3.591","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.230","2026-02-17","1.922","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.960","2026-02-27","2.111","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.111","2026-02-10","5.726","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":851},{"label":"Mar","value":943},{"label":"Abr","value":591},{"label":"Mai","value":769},{"label":"Jun","value":580},{"label":"Jul","value":797},{"label":"Ago","value":659},{"label":"Set","value":836},{"label":"Out","value":630},{"label":"Nov","value":717},{"label":"Dez","value":865}];
const MX = 943;
