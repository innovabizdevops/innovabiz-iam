...
const KPIS = [{"l":"Total Litigation Mgmt","v":"406","t":"-5.8%","d":"down"},{"l":"Settlement Ativos","v":"4.824","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"75.9%","t":"+9.6%","d":"up"},{"l":"Score Performance","v":"82","t":"+0.6%","d":"up"}];
const COLS = ["ID","Settlement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Litigation Mgmt #001","Litigation Mgmt #002","688","6.607","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Litigation Mgmt #002","Litigation Mgmt #003","6.054","6.522","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Litigation Mgmt #003","Litigation Mgmt #004","4.473","8.621","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Litigation Mgmt #004","Litigation Mgmt #005","6.246","6.531","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Litigation Mgmt #005","Litigation Mgmt #001","6.761","5.470","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":639},{"label":"Mar","value":546},{"label":"Abr","value":818},{"label":"Mai","value":571},{"label":"Jun","value":806},{"label":"Jul","value":478},{"label":"Ago","value":667},{"label":"Set","value":711},{"label":"Out","value":678},{"label":"Nov","value":573},{"label":"Dez","value":763}];
const MX = 818;
