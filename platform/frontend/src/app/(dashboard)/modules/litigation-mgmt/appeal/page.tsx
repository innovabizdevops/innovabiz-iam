...
const PAGE = "Appeal Track";
const KPIS = [{"l":"Total Litigation Mgmt","v":"4.940","t":"+15.4%","d":"up"},{"l":"Appeal Track Ativos","v":"8.803","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"76.4%","t":"+12.8%","d":"up"},{"l":"Score Performance","v":"64","t":"-2.1%","d":"down"}];
const COLS = ["ID","Appeal Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Litigation Mgmt #001","Litigation Mgmt #002","2.926","1.336","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Litigation Mgmt #002","Litigation Mgmt #003","8.437","4.931","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Litigation Mgmt #003","Litigation Mgmt #004","3.838","8.043","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Litigation Mgmt #004","Litigation Mgmt #005","458","1.917","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Litigation Mgmt #005","Litigation Mgmt #001","3.700","2.427","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":713},{"label":"Mar","value":507},{"label":"Abr","value":673},{"label":"Mai","value":655},{"label":"Jun","value":521},{"label":"Jul","value":416},{"label":"Ago","value":617},{"label":"Set","value":441},{"label":"Out","value":542},{"label":"Nov","value":542},{"label":"Dez","value":374}];
const MX = 713;
