...
const KPIS = [{"l":"Formulários Ativos","v":"2.182","t":"+12.2%","d":"up"},{"l":"Submissões/Dia","v":"2385","t":"+2.1%","d":"up"},{"l":"Documentos Gerados","v":"979","t":"+13.9%","d":"up"},{"l":"Templates","v":"7.375","t":"+16.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.127","2026-03-06","8.164","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.065","2026-03-01","1.968","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.917","2026-02-28","5.228","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.144","2026-03-28","6.767","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.667","2026-01-14","7.368","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":740},{"label":"Mar","value":512},{"label":"Abr","value":451},{"label":"Mai","value":740},{"label":"Jun","value":735},{"label":"Jul","value":489},{"label":"Ago","value":695},{"label":"Set","value":587},{"label":"Out","value":692},{"label":"Nov","value":464},{"label":"Dez","value":648}];
const MX = 740;
