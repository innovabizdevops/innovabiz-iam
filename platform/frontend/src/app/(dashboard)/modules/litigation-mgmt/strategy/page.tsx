...
const PAGE = "Case Strategy";
const KPIS = [{"l":"Total Litigation Mgmt","v":"7.426","t":"+12.9%","d":"up"},{"l":"Case Strategy Ativos","v":"950","t":"+6.2%","d":"up"},{"l":"Eficiência (%)","v":"75.1%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"93","t":"+0.1%","d":"up"}];
const COLS = ["ID","Case Strategy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Litigation Mgmt #001","Litigation Mgmt #002","5.516","5.699","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Litigation Mgmt #002","Litigation Mgmt #003","7.256","5.168","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Litigation Mgmt #003","Litigation Mgmt #004","3.744","4.972","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Litigation Mgmt #004","Litigation Mgmt #005","2.015","7.536","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Litigation Mgmt #005","Litigation Mgmt #001","1.615","8.260","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":525},{"label":"Mar","value":774},{"label":"Abr","value":583},{"label":"Mai","value":800},{"label":"Jun","value":564},{"label":"Jul","value":480},{"label":"Ago","value":516},{"label":"Set","value":549},{"label":"Out","value":789},{"label":"Nov","value":503},{"label":"Dez","value":824}];
const MX = 824;
