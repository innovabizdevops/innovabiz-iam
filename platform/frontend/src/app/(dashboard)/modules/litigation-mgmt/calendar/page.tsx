...
const ACCENT = "#93c5fd";
const MODULE = "Litigation Management";
const PAGE = "Court Calendar";
const KPIS = [{"l":"Total Litigation Mgmt","v":"459","t":"+14.0%","d":"up"},{"l":"Court Calendar Ativos","v":"5.306","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"73.5%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"57","t":"+4.6%","d":"up"}];
const COLS = ["ID","Court Calendar","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Litigation Mgmt #001","Litigation Mgmt #002","5.743","1.434","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Litigation Mgmt #002","Litigation Mgmt #003","2.771","1.338","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Litigation Mgmt #003","Litigation Mgmt #004","6.658","8.216","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Litigation Mgmt #004","Litigation Mgmt #005","4.383","6.113","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Litigation Mgmt #005","Litigation Mgmt #001","1.924","2.954","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":553},{"label":"Mar","value":810},{"label":"Abr","value":829},{"label":"Mai","value":603},{"label":"Jun","value":793},{"label":"Jul","value":943},{"label":"Ago","value":719},{"label":"Set","value":838},{"label":"Out","value":867},{"label":"Nov","value":891},{"label":"Dez","value":688}];
const MX = 943;
