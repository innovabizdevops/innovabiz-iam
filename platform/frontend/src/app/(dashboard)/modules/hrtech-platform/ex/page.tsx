...
const KPIS = [{"l":"eNPS","v":"68","t":"+8.1%","d":"up"},{"l":"Engagement (%)","v":"92.6%","t":"+0.9%","d":"up"},{"l":"Turnover (%)","v":"93.7%","t":"+2.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.441","t":"+12.1%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.704","2026-02-13","85","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.105","2026-03-08","76","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.689","2026-01-02","77","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.995","2026-01-26","86","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.244","2026-01-19","81","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":651},{"label":"Mar","value":461},{"label":"Abr","value":429},{"label":"Mai","value":557},{"label":"Jun","value":723},{"label":"Jul","value":468},{"label":"Ago","value":559},{"label":"Set","value":456},{"label":"Out","value":516},{"label":"Nov","value":696},{"label":"Dez","value":692}];
const MX = 723;
