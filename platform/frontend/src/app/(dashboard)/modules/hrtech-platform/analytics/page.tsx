...
const ACCENT = "#7c3aed";
const MODULE = "HRTech Platform";
const PAGE = "People Analytics";
const KPIS = [{"l":"eNPS","v":"71","t":"+12.8%","d":"up"},{"l":"Engagement (%)","v":"76.2%","t":"+15.7%","d":"up"},{"l":"Turnover (%)","v":"75.9%","t":"+0.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.241","t":"+5.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.879","2026-01-25","55","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.029","2026-01-13","90","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.043","2026-01-25","69","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.644","2026-03-08","81","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.061","2026-01-05","68","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":856},{"label":"Fev","value":745},{"label":"Mar","value":933},{"label":"Abr","value":669},{"label":"Mai","value":628},{"label":"Jun","value":885},{"label":"Jul","value":664},{"label":"Ago","value":719},{"label":"Set","value":834},{"label":"Out","value":1008},{"label":"Nov","value":877},{"label":"Dez","value":775}];
const MX = 1008;
