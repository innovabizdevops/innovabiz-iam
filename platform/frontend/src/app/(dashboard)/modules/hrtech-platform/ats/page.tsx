...
const PAGE = "ATS (Recruiting)";
const KPIS = [{"l":"Formulários Ativos","v":"1.076","t":"-5.9%","d":"down"},{"l":"Submissões/Dia","v":"3806","t":"+7.8%","d":"up"},{"l":"Documentos Gerados","v":"8.211","t":"-5.0%","d":"down"},{"l":"Templates","v":"7.199","t":"+1.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.535","2026-02-12","177","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.355","2026-02-05","6.604","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.079","2026-02-24","7.703","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.135","2026-01-01","5.124","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.582","2026-01-14","3.049","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":721},{"label":"Mar","value":547},{"label":"Abr","value":636},{"label":"Mai","value":827},{"label":"Jun","value":597},{"label":"Jul","value":764},{"label":"Ago","value":822},{"label":"Set","value":577},{"label":"Out","value":665},{"label":"Nov","value":531},{"label":"Dez","value":664}];
const MX = 827;
