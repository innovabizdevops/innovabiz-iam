...
const KPIS = [{"l":"Formulários Ativos","v":"1.851","t":"+11.1%","d":"up"},{"l":"Submissões/Dia","v":"855","t":"-0.5%","d":"down"},{"l":"Documentos Gerados","v":"7.091","t":"+7.0%","d":"up"},{"l":"Templates","v":"7.041","t":"-1.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.674","2026-01-05","5.688","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.377","2026-02-12","2.228","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.780","2026-02-02","7.022","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.529","2026-03-24","6.436","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.797","2026-02-24","1.421","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":974},{"label":"Fev","value":684},{"label":"Mar","value":837},{"label":"Abr","value":876},{"label":"Mai","value":679},{"label":"Jun","value":940},{"label":"Jul","value":997},{"label":"Ago","value":697},{"label":"Set","value":626},{"label":"Out","value":644},{"label":"Nov","value":1020},{"label":"Dez","value":728}];
const MX = 1020;
