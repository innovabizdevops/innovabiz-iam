...
const PAGE = "Succession Plan";
const KPIS = [{"l":"eNPS","v":"61","t":"+16.6%","d":"up"},{"l":"Engagement (%)","v":"71.0%","t":"-4.4%","d":"down"},{"l":"Turnover (%)","v":"67.0%","t":"+17.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.965","t":"+11.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.219","2026-02-13","72","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.510","2026-03-25","88","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.528","2026-01-17","82","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","207","2026-02-02","91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","827","2026-03-16","86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":806},{"label":"Fev","value":583},{"label":"Mar","value":642},{"label":"Abr","value":835},{"label":"Mai","value":605},{"label":"Jun","value":621},{"label":"Jul","value":586},{"label":"Ago","value":447},{"label":"Set","value":551},{"label":"Out","value":536},{"label":"Nov","value":645},{"label":"Dez","value":525}];
const MX = 835;
