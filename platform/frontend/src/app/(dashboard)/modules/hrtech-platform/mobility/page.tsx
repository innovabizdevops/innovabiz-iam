...
const KPIS = [{"l":"Formulários Ativos","v":"7.485","t":"+14.1%","d":"up"},{"l":"Submissões/Dia","v":"1681","t":"+1.9%","d":"up"},{"l":"Documentos Gerados","v":"2.138","t":"+0.5%","d":"up"},{"l":"Templates","v":"5.049","t":"+6.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","812","2026-03-20","5.412","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.436","2026-01-15","600","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.533","2026-01-07","7.836","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.536","2026-01-12","8.192","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.924","2026-03-03","7.422","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":363},{"label":"Fev","value":504},{"label":"Mar","value":624},{"label":"Abr","value":482},{"label":"Mai","value":472},{"label":"Jun","value":392},{"label":"Jul","value":373},{"label":"Ago","value":613},{"label":"Set","value":543},{"label":"Out","value":542},{"label":"Nov","value":288},{"label":"Dez","value":421}];
const MX = 624;
