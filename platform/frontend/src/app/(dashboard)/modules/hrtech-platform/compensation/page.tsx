...
const PAGE = "Compensation Mgmt";
const KPIS = [{"l":"Formulários Ativos","v":"4.654","t":"+8.3%","d":"up"},{"l":"Submissões/Dia","v":"2203","t":"+1.6%","d":"up"},{"l":"Documentos Gerados","v":"5.314","t":"+8.4%","d":"up"},{"l":"Templates","v":"2.451","t":"+9.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.668","2026-03-08","6.163","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","574","2026-01-24","993","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.146","2026-03-12","1.018","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.488","2026-03-21","1.465","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.247","2026-03-06","4.125","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":697},{"label":"Mar","value":538},{"label":"Abr","value":777},{"label":"Mai","value":559},{"label":"Jun","value":503},{"label":"Jul","value":473},{"label":"Ago","value":485},{"label":"Set","value":780},{"label":"Out","value":482},{"label":"Nov","value":763},{"label":"Dez","value":463}];
const MX = 780;
