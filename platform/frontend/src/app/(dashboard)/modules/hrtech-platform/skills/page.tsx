...
const PAGE = "Skills Graph";
const KPIS = [{"l":"Formulários Ativos","v":"2.978","t":"-2.6%","d":"down"},{"l":"Submissões/Dia","v":"4042","t":"-1.4%","d":"down"},{"l":"Documentos Gerados","v":"4.914","t":"+4.2%","d":"up"},{"l":"Templates","v":"8.801","t":"+2.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","9.033","2026-01-04","7.400","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.023","2026-01-11","7.352","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.527","2026-03-03","3.218","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.931","2026-02-19","6.270","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.914","2026-01-21","3.995","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":450},{"label":"Fev","value":283},{"label":"Mar","value":595},{"label":"Abr","value":504},{"label":"Mai","value":505},{"label":"Jun","value":561},{"label":"Jul","value":578},{"label":"Ago","value":234},{"label":"Set","value":361},{"label":"Out","value":374},{"label":"Nov","value":435},{"label":"Dez","value":261}];
const MX = 595;
