...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.041","t":"+1.5%","d":"up"},{"l":"NC Abertas","v":"2.052","t":"-0.2%","d":"down"},{"l":"Conformidade (%)","v":"82.0%","t":"-0.6%","d":"down"},{"l":"CAPAs Pendentes","v":"5.457","t":"+16.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","553","92.7%","6.395","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","787","73.1%","8.365","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.224","72.2%","5.132","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.722","96.9%","2.238","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.093","72.9%","8.649","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":392},{"label":"Fev","value":608},{"label":"Mar","value":719},{"label":"Abr","value":576},{"label":"Mai","value":584},{"label":"Jun","value":407},{"label":"Jul","value":441},{"label":"Ago","value":621},{"label":"Set","value":542},{"label":"Out","value":401},{"label":"Nov","value":435},{"label":"Dez","value":415}];
const MX = 719;
