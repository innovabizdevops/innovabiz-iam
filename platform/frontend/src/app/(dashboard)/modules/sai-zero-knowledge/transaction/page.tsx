...
const KPIS = [{"l":"Artigos Publicados","v":"6.710","t":"-3.6%","d":"down"},{"l":"Views/Semana","v":"3542","t":"+17.0%","d":"up"},{"l":"Feedback Útil (%)","v":"88.0%","t":"+6.4%","d":"up"},{"l":"Artigos Desatualizados","v":"5.074","t":"-6.0%","d":"down"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","4.326","82.4%","4.425","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","5.968","77.0%","7.513","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","6.324","99.9%","364","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","6.927","81.3%","988","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","3.588","95.6%","8.489","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":730},{"label":"Mar","value":577},{"label":"Abr","value":434},{"label":"Mai","value":609},{"label":"Jun","value":685},{"label":"Jul","value":445},{"label":"Ago","value":526},{"label":"Set","value":545},{"label":"Out","value":691},{"label":"Nov","value":401},{"label":"Dez","value":549}];
const MX = 743;
