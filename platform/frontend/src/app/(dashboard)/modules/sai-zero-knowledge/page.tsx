...
/* ═══ S-AI Zero Knowledge Proofs — Dashboard ═══ */

const ACCENT = "#991b1b";

const KPIS = [
    { label: "Total Registos", value: "5178", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1512", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€387K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "904568078", cells: ["SAI-6078", "S-AI Zero Knowledge Proofs Item 1", "23/3/2026", "€18 178"], status: "active" as const },
    { id: "904571649", cells: ["SAI-9649", "S-AI Zero Knowledge Proofs Item 2", "10/10/2026", "€21 749"], status: "pending" as const },
    { id: "904575220", cells: ["SAI-4220", "S-AI Zero Knowledge Proofs Item 3", "25/5/2026", "€25 320"], status: "completed" as const },
    { id: "904578791", cells: ["SAI-7791", "S-AI Zero Knowledge Proofs Item 4", "12/12/2026", "€28 891"], status: "warning" as const },
    { id: "904582362", cells: ["SAI-2362", "S-AI Zero Knowledge Proofs Item 5", "27/7/2026", "€32 462"], status: "active" as const },
];
...
export default function SaiZeroKnowledgeProofsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">S-AI Zero Knowledge Proofs</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • S-AI Zero Knowledge Proofs</p>
                    </div>
                </div>
