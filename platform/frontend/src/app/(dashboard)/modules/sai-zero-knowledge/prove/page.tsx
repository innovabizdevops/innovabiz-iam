...
const ACCENT = "#991b1b";
const MODULE = "S-AI Zero Knowledge Proofs";
const PAGE = "Prove";
const KPIS = [{"l":"Artigos Publicados","v":"2.791","t":"+4.9%","d":"up"},{"l":"Views/Semana","v":"2712","t":"+1.0%","d":"up"},{"l":"Feedback Útil (%)","v":"66.9%","t":"+9.2%","d":"up"},{"l":"Artigos Desatualizados","v":"1.030","t":"+9.7%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","984","84.0%","4.299","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","2.740","94.9%","1.311","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","9.059","85.2%","4.239","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","5.769","86.2%","4.225","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","3.667","87.0%","5.705","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":795},{"label":"Mar","value":672},{"label":"Abr","value":823},{"label":"Mai","value":500},{"label":"Jun","value":485},{"label":"Jul","value":700},{"label":"Ago","value":680},{"label":"Set","value":494},{"label":"Out","value":655},{"label":"Nov","value":796},{"label":"Dez","value":674}];
const MX = 823;
