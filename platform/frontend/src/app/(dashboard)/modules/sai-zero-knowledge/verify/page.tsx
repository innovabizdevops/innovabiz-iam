...
const PAGE = "Verify";
const KPIS = [{"l":"Artigos Publicados","v":"1.836","t":"+6.2%","d":"up"},{"l":"Views/Semana","v":"1880","t":"+17.2%","d":"up"},{"l":"Feedback Útil (%)","v":"72.4%","t":"+12.6%","d":"up"},{"l":"Artigos Desatualizados","v":"1.665","t":"+17.2%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","6.151","75.2%","237","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","7.259","72.3%","4.901","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","3.837","91.0%","3.774","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","7.726","73.7%","8.796","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","8.927","87.4%","1.065","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":637},{"label":"Mar","value":652},{"label":"Abr","value":599},{"label":"Mai","value":469},{"label":"Jun","value":696},{"label":"Jul","value":430},{"label":"Ago","value":512},{"label":"Set","value":422},{"label":"Out","value":629},{"label":"Nov","value":464},{"label":"Dez","value":606}];
const MX = 696;
