...
const KPIS = [{"l":"Artigos Publicados","v":"5.862","t":"+2.2%","d":"up"},{"l":"Views/Semana","v":"4050","t":"-1.9%","d":"down"},{"l":"Feedback Útil (%)","v":"84.3%","t":"+4.9%","d":"up"},{"l":"Artigos Desatualizados","v":"8.620","t":"+7.7%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","7.877","78.6%","4.874","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","7.657","91.7%","3.733","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","1.986","72.1%","1.144","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","8.022","88.6%","7.929","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","4.249","79.2%","4.801","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":579},{"label":"Mar","value":873},{"label":"Abr","value":923},{"label":"Mai","value":738},{"label":"Jun","value":580},{"label":"Jul","value":849},{"label":"Ago","value":798},{"label":"Set","value":887},{"label":"Out","value":557},{"label":"Nov","value":816},{"label":"Dez","value":697}];
const MX = 923;
