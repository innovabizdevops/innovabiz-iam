...
const KPIS = [
    { label: "Total Registos", value: "1758", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "716", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€468K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2135352458", cells: ["AGE-4458", "AI Research Agent Item 1", "23/3/2026", "€2558"], status: "active" as const },
    { id: "2135356029", cells: ["AGE-8029", "AI Research Agent Item 2", "10/10/2026", "€6129"], status: "pending" as const },
    { id: "2135359600", cells: ["AGE-2600", "AI Research Agent Item 3", "25/5/2026", "€9700"], status: "completed" as const },
    { id: "2135363171", cells: ["AGE-6171", "AI Research Agent Item 4", "12/12/2026", "€13 271"], status: "warning" as const },
    { id: "2135366742", cells: ["AGE-9742", "AI Research Agent Item 5", "27/7/2026", "€16 842"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Research Agent</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Research Agent</p>
                    </div>
                </div>
