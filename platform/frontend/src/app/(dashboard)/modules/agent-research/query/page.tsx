...
const PAGE = "Query";
const KPIS = [{"l":"Ideias Submetidas","v":"4.016","t":"+15.8%","d":"up"},{"l":"Patentes (YTD)","v":"2.739","t":"+17.7%","d":"up"},{"l":"Projetos Innovation Lab","v":"6.478","t":"+0.6%","d":"up"},{"l":"Budget I&D (€M)","v":"€43.7M","t":"+8.7%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","3.780","74.0%","2.871","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.549","70.7%","7.765","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","3.997","70.6%","5.909","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","8.098","70.2%","4.968","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","5.752","73.3%","5.353","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":780},{"label":"Mar","value":814},{"label":"Abr","value":732},{"label":"Mai","value":623},{"label":"Jun","value":592},{"label":"Jul","value":800},{"label":"Ago","value":617},{"label":"Set","value":634},{"label":"Out","value":826},{"label":"Nov","value":794},{"label":"Dez","value":753}];
const MX = 826;
