...
const PAGE = "Synthesize";
const KPIS = [{"l":"Ideias Submetidas","v":"2.256","t":"+11.3%","d":"up"},{"l":"Patentes (YTD)","v":"6.154","t":"+2.1%","d":"up"},{"l":"Projetos Innovation Lab","v":"7.093","t":"+12.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€4.3M","t":"+2.2%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","4.492","84.8%","975","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","4.171","70.7%","1.986","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","8.449","87.1%","7.362","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.641","96.9%","6.157","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","229","92.9%","607","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":327},{"label":"Fev","value":292},{"label":"Mar","value":474},{"label":"Abr","value":458},{"label":"Mai","value":570},{"label":"Jun","value":359},{"label":"Jul","value":621},{"label":"Ago","value":438},{"label":"Set","value":289},{"label":"Out","value":423},{"label":"Nov","value":416},{"label":"Dez","value":378}];
const MX = 621;
