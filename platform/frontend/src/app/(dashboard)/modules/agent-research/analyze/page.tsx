...
const ACCENT = "#7c3aed";
const MODULE = "AI Research Agent";
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"4.487","t":"+2.0%","d":"up"},{"l":"Queries/Dia","v":"1348","t":"+13.3%","d":"up"},{"l":"Dados Processados (GB)","v":"460","t":"+17.3%","d":"up"},{"l":"Utilizadores Analytics","v":"5.977","t":"+5.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","613","2026-01-26","9.086","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2141","2026-01-04","7.135","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4622","2026-03-14","2.656","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4748","2026-02-05","6.979","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3620","2026-03-18","7.200","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":933},{"label":"Fev","value":824},{"label":"Mar","value":746},{"label":"Abr","value":741},{"label":"Mai","value":1055},{"label":"Jun","value":938},{"label":"Jul","value":788},{"label":"Ago","value":1023},{"label":"Set","value":1080},{"label":"Out","value":794},{"label":"Nov","value":870},{"label":"Dez","value":859}];
const MX = 1080;
