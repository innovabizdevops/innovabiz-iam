...
const PAGE = "Collect";
const KPIS = [{"l":"Ideias Submetidas","v":"2.307","t":"+8.6%","d":"up"},{"l":"Patentes (YTD)","v":"3.568","t":"+13.9%","d":"up"},{"l":"Projetos Innovation Lab","v":"334","t":"+3.1%","d":"up"},{"l":"Budget I&D (€M)","v":"€5.8M","t":"+1.5%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.807","74.9%","4.892","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.629","84.7%","4.171","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","5.438","81.5%","4.460","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","1.682","80.3%","1.162","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.311","80.1%","6.478","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":687},{"label":"Mar","value":637},{"label":"Abr","value":433},{"label":"Mai","value":467},{"label":"Jun","value":554},{"label":"Jul","value":537},{"label":"Ago","value":424},{"label":"Set","value":534},{"label":"Out","value":603},{"label":"Nov","value":727},{"label":"Dez","value":502}];
const MX = 727;
