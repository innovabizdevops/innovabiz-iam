...
const PAGE = "Report";
const KPIS = [{"l":"Ideias Submetidas","v":"3.135","t":"+1.8%","d":"up"},{"l":"Patentes (YTD)","v":"382","t":"+8.5%","d":"up"},{"l":"Projetos Innovation Lab","v":"7.648","t":"+10.7%","d":"up"},{"l":"Budget I&D (€M)","v":"€14.2M","t":"+12.5%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","8.080","90.7%","6.058","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.717","77.8%","8.255","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","754","83.7%","201","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","7.853","83.4%","1.612","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","5.438","92.1%","5.089","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":392},{"label":"Mar","value":555},{"label":"Abr","value":506},{"label":"Mai","value":541},{"label":"Jun","value":676},{"label":"Jul","value":748},{"label":"Ago","value":514},{"label":"Set","value":677},{"label":"Out","value":545},{"label":"Nov","value":523},{"label":"Dez","value":641}];
const MX = 748;
