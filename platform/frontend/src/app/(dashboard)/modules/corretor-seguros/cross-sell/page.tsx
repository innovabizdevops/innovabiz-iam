...
const PAGE = "Cross-Sell";
const KPIS = [{"l":"Total Corretor Seguros","v":"3.678","t":"+8.5%","d":"up"},{"l":"Cross Sell Ativos","v":"6.482","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"87.7%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"83","t":"+2.9%","d":"up"}];
const COLS = ["ID","Cross Sell","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Corretor Seguros #001","Corretor Seguros #002","4.537","3.383","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Corretor Seguros #002","Corretor Seguros #003","2.809","4.175","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Corretor Seguros #003","Corretor Seguros #004","1.310","3.930","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Corretor Seguros #004","Corretor Seguros #005","1.631","2.523","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Corretor Seguros #005","Corretor Seguros #001","1.223","7.088","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":704},{"label":"Mar","value":683},{"label":"Abr","value":760},{"label":"Mai","value":921},{"label":"Jun","value":910},{"label":"Jul","value":596},{"label":"Ago","value":725},{"label":"Set","value":812},{"label":"Out","value":667},{"label":"Nov","value":604},{"label":"Dez","value":605}];
const MX = 921;
