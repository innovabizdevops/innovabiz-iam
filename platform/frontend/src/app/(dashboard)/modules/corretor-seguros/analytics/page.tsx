...
const KPIS = [{"l":"Dashboards Ativos","v":"3.265","t":"+13.2%","d":"up"},{"l":"Queries/Dia","v":"2910","t":"-4.5%","d":"down"},{"l":"Dados Processados (GB)","v":"6.169","t":"+4.0%","d":"up"},{"l":"Utilizadores Analytics","v":"196","t":"+17.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","819","2026-02-16","7.599","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3803","2026-02-06","6.774","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3906","2026-03-23","2.352","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","282","2026-03-10","8.349","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","517","2026-03-17","5.795","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":940},{"label":"Fev","value":751},{"label":"Mar","value":803},{"label":"Abr","value":836},{"label":"Mai","value":656},{"label":"Jun","value":942},{"label":"Jul","value":681},{"label":"Ago","value":752},{"label":"Set","value":775},{"label":"Out","value":669},{"label":"Nov","value":958},{"label":"Dez","value":773}];
const MX = 958;
