...
const ACCENT = "#dc2626";
const MODULE = "Corretores de Seguros";
const PAGE = "Cotação Multi";
const KPIS = [{"l":"Total Corretor Seguros","v":"3.977","t":"+12.0%","d":"up"},{"l":"CotaçãO Multi Ativos","v":"3.888","t":"+6.8%","d":"up"},{"l":"Eficiência (%)","v":"79.8%","t":"+0.0%","d":"up"},{"l":"Score Performance","v":"76","t":"+13.4%","d":"up"}];
const COLS = ["ID","CotaçãO Multi","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Corretor Seguros #001","Corretor Seguros #002","7.565","7.034","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Corretor Seguros #002","Corretor Seguros #003","5.792","2.597","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Corretor Seguros #003","Corretor Seguros #004","8.764","3.788","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Corretor Seguros #004","Corretor Seguros #005","5.377","5.819","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Corretor Seguros #005","Corretor Seguros #001","4.061","1.275","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":318},{"label":"Fev","value":422},{"label":"Mar","value":621},{"label":"Abr","value":442},{"label":"Mai","value":292},{"label":"Jun","value":396},{"label":"Jul","value":454},{"label":"Ago","value":504},{"label":"Set","value":375},{"label":"Out","value":584},{"label":"Nov","value":339},{"label":"Dez","value":591}];
const MX = 621;
