...
const PAGE = "Comissões";
const KPIS = [{"l":"Vendas YTD (€)","v":"€68482","t":"-1.0%","d":"down"},{"l":"Pipeline (€)","v":"€39144","t":"+4.0%","d":"up"},{"l":"Atingimento Quota (%)","v":"74.9%","t":"+4.9%","d":"up"},{"l":"Win Rate (%)","v":"77.0%","t":"+4.5%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 13345.10","€ 44350.97","€ 37461.18","73.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 24035.04","€ 41919.07","€ 34043.24","95.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 33982.19","€ 42700.15","€ 50095.71","92.1%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 14244.10","€ 41671.74","€ 5593.21","73.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 44215.85","€ 43361.61","€ 23376.49","85.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":879},{"label":"Fev","value":952},{"label":"Mar","value":616},{"label":"Abr","value":900},{"label":"Mai","value":896},{"label":"Jun","value":645},{"label":"Jul","value":944},{"label":"Ago","value":840},{"label":"Set","value":629},{"label":"Out","value":928},{"label":"Nov","value":727},{"label":"Dez","value":685}];
const MX = 952;
