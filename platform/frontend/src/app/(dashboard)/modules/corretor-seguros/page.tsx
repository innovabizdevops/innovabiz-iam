...
export default function CorretorSegurosPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Corretor Seguros</h1><p className="text-sm text-muted-foreground">Corretor Seguros • iBOS Enterprise</p></div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {[{l:'Total',v:'3,847',t:'+16.2%',up:true},{l:'Ativos',v:'2,531',t:'+11.1%',up:true},{l:'Pendentes',v:'142',t:'-6.3%',up:false},{l:'Score',v:'97.8%',t:'+2.9%',up:true}].map((k,i) => (
