...
const PAGE = "Renovações";
const KPIS = [{"l":"Contratos Ativos","v":"227","t":"+6.6%","d":"up"},{"l":"Valor Total (€M)","v":"€10.5M","t":"-1.1%","d":"down"},{"l":"Renovações Próx. 30d","v":"5.734","t":"+9.8%","d":"up"},{"l":"Obrigações Pendentes","v":"2.262","t":"+1.5%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 20251.68","2026-03-19","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 41594.04","2026-01-06","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 7611.60","2026-03-01","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 29294.10","2026-01-02","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 8873.72","2026-03-17","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":774},{"label":"Fev","value":802},{"label":"Mar","value":747},{"label":"Abr","value":728},{"label":"Mai","value":834},{"label":"Jun","value":742},{"label":"Jul","value":794},{"label":"Ago","value":726},{"label":"Set","value":841},{"label":"Out","value":862},{"label":"Nov","value":607},{"label":"Dez","value":705}];
const MX = 862;
