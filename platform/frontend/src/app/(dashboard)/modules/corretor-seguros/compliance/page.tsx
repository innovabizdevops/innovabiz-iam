...
const PAGE = "Compliance ASF";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.210","t":"+7.3%","d":"up"},{"l":"NC Abertas","v":"5.985","t":"+0.2%","d":"up"},{"l":"Conformidade (%)","v":"74.4%","t":"+14.5%","d":"up"},{"l":"CAPAs Pendentes","v":"4.222","t":"-2.6%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.967","92.4%","6.099","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.338","71.1%","6.491","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.294","73.8%","1.588","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","9.080","75.7%","3.169","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.679","90.4%","2.605","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":474},{"label":"Fev","value":511},{"label":"Mar","value":414},{"label":"Abr","value":675},{"label":"Mai","value":540},{"label":"Jun","value":684},{"label":"Jul","value":521},{"label":"Ago","value":507},{"label":"Set","value":466},{"label":"Out","value":721},{"label":"Nov","value":662},{"label":"Dez","value":683}];
const MX = 721;
