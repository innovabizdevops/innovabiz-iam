...
const ACCENT = "#7c3aed";
const MODULE = "Rent Collection";
const PAGE = "NSF Handler";
const KPIS = [{"l":"Total Rent Collection","v":"1.493","t":"+3.2%","d":"up"},{"l":"NSF Handler Ativos","v":"885","t":"+11.9%","d":"up"},{"l":"Eficiência (%)","v":"80.1%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"94","t":"-1.5%","d":"down"}];
const COLS = ["ID","NSF Handler","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rent Collection #001","Rent Collection #002","7.505","4.976","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Rent Collection #002","Rent Collection #003","7.942","665","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Rent Collection #003","Rent Collection #004","6.631","880","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Rent Collection #004","Rent Collection #005","7.049","3.670","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rent Collection #005","Rent Collection #001","4.978","3.668","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":649},{"label":"Mar","value":773},{"label":"Abr","value":929},{"label":"Mai","value":929},{"label":"Jun","value":920},{"label":"Jul","value":687},{"label":"Ago","value":670},{"label":"Set","value":644},{"label":"Out","value":885},{"label":"Nov","value":907},{"label":"Dez","value":558}];
const MX = 929;
...
export default function NsfPage() {
    return (
