...
const PAGE = "Receipts";
const KPIS = [{"l":"Total Rent Collection","v":"741","t":"+13.2%","d":"up"},{"l":"Receipts Ativos","v":"7.381","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"90.5%","t":"+-0.0%","d":"up"},{"l":"Score Performance","v":"94","t":"+13.4%","d":"up"}];
const COLS = ["ID","Receipts","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rent Collection #001","Rent Collection #002","8.423","4.567","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Rent Collection #002","Rent Collection #003","3.260","1.930","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Rent Collection #003","Rent Collection #004","4.778","8.068","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Rent Collection #004","Rent Collection #005","2.309","4.139","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rent Collection #005","Rent Collection #001","5.467","5.394","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":727},{"label":"Mar","value":544},{"label":"Abr","value":417},{"label":"Mai","value":604},{"label":"Jun","value":396},{"label":"Jul","value":411},{"label":"Ago","value":738},{"label":"Set","value":611},{"label":"Out","value":729},{"label":"Nov","value":583},{"label":"Dez","value":736}];
const MX = 738;
