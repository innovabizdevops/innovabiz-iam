...
const PAGE = "Payment Plans";
const KPIS = [{"l":"Total Rent Collection","v":"3.027","t":"+12.1%","d":"up"},{"l":"Payment Plans Ativos","v":"2.929","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"84.2%","t":"+-0.0%","d":"up"},{"l":"Score Performance","v":"68","t":"+11.4%","d":"up"}];
const COLS = ["ID","Payment Plans","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rent Collection #001","Rent Collection #002","1.213","2.677","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Rent Collection #002","Rent Collection #003","8.049","1.997","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Rent Collection #003","Rent Collection #004","5.759","7.999","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Rent Collection #004","Rent Collection #005","1.037","283","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rent Collection #005","Rent Collection #001","7.326","7.880","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":476},{"label":"Mar","value":623},{"label":"Abr","value":813},{"label":"Mai","value":646},{"label":"Jun","value":597},{"label":"Jul","value":439},{"label":"Ago","value":807},{"label":"Set","value":460},{"label":"Out","value":772},{"label":"Nov","value":763},{"label":"Dez","value":680}];
const MX = 813;
