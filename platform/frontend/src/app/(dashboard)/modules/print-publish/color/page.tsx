...
const PAGE = "Color Management";
const KPIS = [{"l":"Projetos Melhoria","v":"4.411","t":"+2.7%","d":"up"},{"l":"Savings (€)","v":"€76854","t":"+15.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"70.7%","t":"+14.5%","d":"up"},{"l":"Ciclos PDCA","v":"8.804","t":"+9.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.046","€ 38047.00","5.743","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.052","€ 11656.42","2.056","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.407","€ 3503.40","5.927","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","321","€ 18104.41","1.329","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.765","€ 24828.50","2.612","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":718},{"label":"Mar","value":361},{"label":"Abr","value":654},{"label":"Mai","value":673},{"label":"Jun","value":678},{"label":"Jul","value":451},{"label":"Ago","value":732},{"label":"Set","value":500},{"label":"Out","value":683},{"label":"Nov","value":384},{"label":"Dez","value":461}];
const MX = 732;
