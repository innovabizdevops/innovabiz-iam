...
const PAGE = "Print Job Queue";
const KPIS = [{"l":"Total Print Publish","v":"1.303","t":"-5.4%","d":"down"},{"l":"Print Job Queue Ativos","v":"4.411","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"74.2%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"77","t":"+10.6%","d":"up"}];
const COLS = ["ID","Print Job Queue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Publish #001","Print Publish #002","3.991","5.861","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Print Publish #002","Print Publish #003","3.102","8.915","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Publish #003","Print Publish #004","6.872","5.184","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Print Publish #004","Print Publish #005","5.835","7.326","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Publish #005","Print Publish #001","636","2.138","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":598},{"label":"Mar","value":298},{"label":"Abr","value":290},{"label":"Mai","value":382},{"label":"Jun","value":582},{"label":"Jul","value":483},{"label":"Ago","value":359},{"label":"Set","value":549},{"label":"Out","value":492},{"label":"Nov","value":635},{"label":"Dez","value":359}];
const MX = 635;
