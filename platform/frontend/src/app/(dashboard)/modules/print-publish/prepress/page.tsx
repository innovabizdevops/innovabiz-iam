...
const ACCENT = "#6d28d9";
const MODULE = "Print & Digital Publish";
const PAGE = "Prepress Workflow";
const KPIS = [{"l":"Total Print Publish","v":"6.791","t":"-1.7%","d":"down"},{"l":"Prepress Workflow Ativos","v":"9.085","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"85.6%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"76","t":"+12.7%","d":"up"}];
const COLS = ["ID","Prepress Workflow","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Publish #001","Print Publish #002","3.187","7.058","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Print Publish #002","Print Publish #003","7.899","9.018","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Publish #003","Print Publish #004","6.755","4.252","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Print Publish #004","Print Publish #005","9.093","8.276","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Publish #005","Print Publish #001","4.224","6.841","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":661},{"label":"Mar","value":538},{"label":"Abr","value":406},{"label":"Mai","value":440},{"label":"Jun","value":506},{"label":"Jul","value":589},{"label":"Ago","value":562},{"label":"Set","value":715},{"label":"Out","value":525},{"label":"Nov","value":547},{"label":"Dez","value":608}];
const MX = 715;
