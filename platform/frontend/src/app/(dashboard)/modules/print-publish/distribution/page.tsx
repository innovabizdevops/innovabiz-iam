...
const KPIS = [{"l":"Total Print Publish","v":"1.877","t":"+16.8%","d":"up"},{"l":"Distribution Ativos","v":"5.997","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"80.9%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"70","t":"+0.7%","d":"up"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Publish #001","Print Publish #002","8.023","9.026","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Print Publish #002","Print Publish #003","6.436","2.469","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Publish #003","Print Publish #004","7.619","2.884","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Print Publish #004","Print Publish #005","7.773","3.145","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Publish #005","Print Publish #001","1.837","7.247","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":806},{"label":"Mar","value":593},{"label":"Abr","value":867},{"label":"Mai","value":741},{"label":"Jun","value":760},{"label":"Jul","value":707},{"label":"Ago","value":772},{"label":"Set","value":857},{"label":"Out","value":674},{"label":"Nov","value":893},{"label":"Dez","value":717}];
const MX = 893;
