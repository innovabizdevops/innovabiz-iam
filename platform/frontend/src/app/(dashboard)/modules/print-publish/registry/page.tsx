...
const PAGE = "ISBN/ISSN Registry";
const KPIS = [{"l":"Total Print Publish","v":"8.017","t":"+0.3%","d":"up"},{"l":"ISBN/ISSN Registry Ativos","v":"836","t":"+14.3%","d":"up"},{"l":"Eficiência (%)","v":"92.3%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"80","t":"-3.7%","d":"down"}];
const COLS = ["ID","ISBN/ISSN Registry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Publish #001","Print Publish #002","8.016","2.656","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Print Publish #002","Print Publish #003","1.485","5.797","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Publish #003","Print Publish #004","466","7.076","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Print Publish #004","Print Publish #005","5.004","6.287","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Publish #005","Print Publish #001","994","2.100","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":974},{"label":"Fev","value":766},{"label":"Mar","value":979},{"label":"Abr","value":941},{"label":"Mai","value":885},{"label":"Jun","value":851},{"label":"Jul","value":832},{"label":"Ago","value":831},{"label":"Set","value":780},{"label":"Out","value":749},{"label":"Nov","value":952},{"label":"Dez","value":661}];
const MX = 979;
