...
const PAGE = "Virtual Events";
const KPIS = [{"l":"Eventos Planeados","v":"423","t":"+4.2%","d":"up"},{"l":"Participantes","v":"5.622","t":"+7.2%","d":"up"},{"l":"NPS Evento","v":"92","t":"+15.2%","d":"up"},{"l":"Receita (€)","v":"€47536","t":"+9.2%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-13","3.819","4.069","€ 18332.64","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-02","5.949","4.609","€ 32595.98","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-15","8.235","2.739","€ 15035.49","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-01","3.345","8.299","€ 38200.53","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-19","6.324","2.952","€ 44135.41","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":472},{"label":"Fev","value":727},{"label":"Mar","value":640},{"label":"Abr","value":519},{"label":"Mai","value":534},{"label":"Jun","value":717},{"label":"Jul","value":407},{"label":"Ago","value":559},{"label":"Set","value":650},{"label":"Out","value":526},{"label":"Nov","value":453},{"label":"Dez","value":384}];
const MX = 727;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>XR</span></h1>
                </div>
