...
const KPIS = [{"l":"Eventos Planeados","v":"3.561","t":"+15.8%","d":"up"},{"l":"Participantes","v":"8.694","t":"+17.0%","d":"up"},{"l":"NPS Evento","v":"56","t":"-5.0%","d":"down"},{"l":"Receita (€)","v":"€93872","t":"+4.7%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-23","2.822","7.099","€ 18109.46","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-07","2.292","4.621","€ 8702.21","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-23","6.296","5.989","€ 30608.04","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-26","4.098","8.718","€ 15874.53","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-26","906","238","€ 33680.37","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":912},{"label":"Fev","value":692},{"label":"Mar","value":728},{"label":"Abr","value":872},{"label":"Mai","value":916},{"label":"Jun","value":756},{"label":"Jul","value":986},{"label":"Ago","value":906},{"label":"Set","value":775},{"label":"Out","value":628},{"label":"Nov","value":706},{"label":"Dez","value":669}];
const MX = 986;
