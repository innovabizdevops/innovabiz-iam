...
const PAGE = "Attendee App";
const KPIS = [{"l":"Eventos Planeados","v":"6.788","t":"-3.7%","d":"down"},{"l":"Participantes","v":"4.516","t":"-3.9%","d":"down"},{"l":"NPS Evento","v":"64","t":"+15.0%","d":"up"},{"l":"Receita (€)","v":"€20238","t":"+0.3%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-26","2.367","907","€ 6657.38","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-28","7.200","3.932","€ 9023.53","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-02","4.116","7.857","€ 21958.58","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-18","437","4.129","€ 2483.05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-05","219","3.932","€ 9346.96","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":341},{"label":"Mar","value":454},{"label":"Abr","value":354},{"label":"Mai","value":529},{"label":"Jun","value":520},{"label":"Jul","value":381},{"label":"Ago","value":585},{"label":"Set","value":501},{"label":"Out","value":382},{"label":"Nov","value":400},{"label":"Dez","value":453}];
const MX = 710;
...
export default function AttendeeAppEventMgmtPage() {
    return (
