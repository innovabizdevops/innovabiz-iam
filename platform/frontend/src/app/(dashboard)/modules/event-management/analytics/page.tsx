...
const ACCENT = "#6366f1";
const MODULE = "Event Management";
const PAGE = "Event Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"3.071","t":"+16.2%","d":"up"},{"l":"Queries/Dia","v":"3795","t":"+2.6%","d":"up"},{"l":"Dados Processados (GB)","v":"4.474","t":"+1.9%","d":"up"},{"l":"Utilizadores Analytics","v":"7.315","t":"-2.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1831","2026-01-04","4.520","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1534","2026-01-01","8.289","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","765","2026-02-26","2.854","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","948","2026-03-13","418","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4607","2026-03-05","5.116","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":426},{"label":"Fev","value":418},{"label":"Mar","value":730},{"label":"Abr","value":490},{"label":"Mai","value":602},{"label":"Jun","value":738},{"label":"Jul","value":566},{"label":"Ago","value":786},{"label":"Set","value":450},{"label":"Out","value":656},{"label":"Nov","value":699},{"label":"Dez","value":666}];
const MX = 786;
