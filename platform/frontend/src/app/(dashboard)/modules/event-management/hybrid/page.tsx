...
const PAGE = "Hybrid Events";
const KPIS = [{"l":"Eventos Planeados","v":"3.533","t":"+1.0%","d":"up"},{"l":"Participantes","v":"478","t":"+16.0%","d":"up"},{"l":"NPS Evento","v":"90","t":"+14.1%","d":"up"},{"l":"Receita (€)","v":"€92624","t":"-5.5%","d":"down"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-23","380","3.360","€ 16532.70","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-25","5.904","2.605","€ 19350.11","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-04","6.025","3.544","€ 10817.89","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-23","4.888","7.038","€ 35428.92","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-07","5.319","2.514","€ 21941.36","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":651},{"label":"Mar","value":560},{"label":"Abr","value":576},{"label":"Mai","value":442},{"label":"Jun","value":471},{"label":"Jul","value":337},{"label":"Ago","value":349},{"label":"Set","value":497},{"label":"Out","value":709},{"label":"Nov","value":440},{"label":"Dez","value":569}];
const MX = 709;
