...
const KPIS = [{"l":"Eventos Planeados","v":"5.354","t":"-2.1%","d":"down"},{"l":"Participantes","v":"3.828","t":"+7.4%","d":"up"},{"l":"NPS Evento","v":"76","t":"+1.7%","d":"up"},{"l":"Receita (€)","v":"€7354","t":"+0.3%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-22","5.756","2.936","€ 31970.03","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-09","6.612","6.489","€ 43387.24","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-12","2.512","8.392","€ 4790.12","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-21","7.503","5.116","€ 2524.15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-08","4.347","6.955","€ 35928.61","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":662},{"label":"Mar","value":487},{"label":"Abr","value":545},{"label":"Mai","value":453},{"label":"Jun","value":558},{"label":"Jul","value":475},{"label":"Ago","value":396},{"label":"Set","value":664},{"label":"Out","value":378},{"label":"Nov","value":542},{"label":"Dez","value":524}];
const MX = 664;
