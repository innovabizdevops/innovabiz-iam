...
const PAGE = "Event Planning";
const KPIS = [{"l":"Eventos Planeados","v":"4.846","t":"+5.6%","d":"up"},{"l":"Participantes","v":"475","t":"+7.9%","d":"up"},{"l":"NPS Evento","v":"87","t":"+6.2%","d":"up"},{"l":"Receita (€)","v":"€20741","t":"+6.3%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-07","2.310","4.034","€ 40601.42","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-15","4.433","1.075","€ 27023.98","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-26","4.307","5.406","€ 28821.29","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-15","6.814","7.485","€ 25422.52","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-26","7.476","4.634","€ 20418.37","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":607},{"label":"Mar","value":642},{"label":"Abr","value":373},{"label":"Mai","value":433},{"label":"Jun","value":586},{"label":"Jul","value":457},{"label":"Ago","value":550},{"label":"Set","value":596},{"label":"Out","value":548},{"label":"Nov","value":664},{"label":"Dez","value":416}];
const MX = 664;
