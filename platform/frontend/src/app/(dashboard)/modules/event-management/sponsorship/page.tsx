...
const PAGE = "Sponsorship Mgmt";
const KPIS = [{"l":"Eventos Planeados","v":"5.463","t":"+17.1%","d":"up"},{"l":"Participantes","v":"7.804","t":"+3.5%","d":"up"},{"l":"NPS Evento","v":"87","t":"+11.4%","d":"up"},{"l":"Receita (€)","v":"€85304","t":"-5.5%","d":"down"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-17","3.253","7.466","€ 25696.23","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-11","2.726","1.204","€ 13172.32","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-03","5.183","5.691","€ 29855.76","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-05","1.850","6.515","€ 21270.41","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-04","6.641","4.523","€ 22025.62","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":412},{"label":"Fev","value":538},{"label":"Mar","value":648},{"label":"Abr","value":569},{"label":"Mai","value":341},{"label":"Jun","value":518},{"label":"Jul","value":592},{"label":"Ago","value":341},{"label":"Set","value":574},{"label":"Out","value":340},{"label":"Nov","value":435},{"label":"Dez","value":495}];
const MX = 648;
