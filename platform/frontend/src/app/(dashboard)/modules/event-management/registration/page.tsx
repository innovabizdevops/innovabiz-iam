...
const KPIS = [{"l":"Eventos Planeados","v":"6.758","t":"+1.9%","d":"up"},{"l":"Participantes","v":"4.207","t":"-1.1%","d":"down"},{"l":"NPS Evento","v":"64","t":"+14.6%","d":"up"},{"l":"Receita (€)","v":"€64810","t":"+15.2%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-01","8.183","8.972","€ 12260.83","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-28","6.863","2.437","€ 45095.19","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-10","6.159","6.285","€ 2363.40","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-03","8.663","962","€ 17165.31","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-02","6.347","5.688","€ 20724.50","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":936},{"label":"Mar","value":970},{"label":"Abr","value":963},{"label":"Mai","value":875},{"label":"Jun","value":656},{"label":"Jul","value":657},{"label":"Ago","value":877},{"label":"Set","value":848},{"label":"Out","value":950},{"label":"Nov","value":973},{"label":"Dez","value":891}];
const MX = 973;
