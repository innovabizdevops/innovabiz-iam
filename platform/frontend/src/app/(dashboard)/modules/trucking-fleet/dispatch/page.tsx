...
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"1.558","t":"+10.9%","d":"up"},{"l":"Viagens/Dia","v":"3684","t":"+17.7%","d":"up"},{"l":"Pontualidade (%)","v":"69.4%","t":"+0.6%","d":"up"},{"l":"Passageiros/Dia","v":"2739","t":"-5.2%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-15","2026-01-26","5.178","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-05","2026-03-18","2.270","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-05","2026-02-06","2.267","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-04","2026-01-25","5.728","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-06","2026-03-01","2.045","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":849},{"label":"Mar","value":798},{"label":"Abr","value":772},{"label":"Mai","value":784},{"label":"Jun","value":779},{"label":"Jul","value":494},{"label":"Ago","value":684},{"label":"Set","value":608},{"label":"Out","value":594},{"label":"Nov","value":505},{"label":"Dez","value":800}];
const MX = 849;
