...
const ACCENT = "#6366f1";
const MODULE = "Telecom CRM";
const PAGE = "Churn";
const KPIS = [{"l":"ARR (€M)","v":"€6.6M","t":"+16.1%","d":"up"},{"l":"MRR (€)","v":"€49609","t":"+11.6%","d":"up"},{"l":"Churn (%)","v":"82.6%","t":"-4.6%","d":"down"},{"l":"ARPU (€)","v":"€61822","t":"+9.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 48437.48","6.851","€ 2094.81","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 14467.03","303","€ 8851.12","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 5646.08","1.255","€ 19819.64","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 7596.85","1.936","€ 13364.75","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 20206.48","8.916","€ 5973.12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":821},{"label":"Mar","value":777},{"label":"Abr","value":774},{"label":"Mai","value":734},{"label":"Jun","value":869},{"label":"Jul","value":497},{"label":"Ago","value":793},{"label":"Set","value":815},{"label":"Out","value":612},{"label":"Nov","value":868},{"label":"Dez","value":495}];
const MX = 869;
