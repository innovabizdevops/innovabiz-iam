...
const KPIS = [{"l":"Total Telecom Crm","v":"8.133","t":"+12.1%","d":"up"},{"l":"Self Service Ativos","v":"7.211","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"70.3%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"57","t":"+9.2%","d":"up"}];
const COLS = ["ID","Self Service","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Crm #001","Telecom Crm #002","1.815","6.386","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Crm #002","Telecom Crm #003","1.270","390","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Crm #003","Telecom Crm #004","5.368","8.096","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Crm #004","Telecom Crm #005","4.594","448","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Crm #005","Telecom Crm #001","1.937","6.448","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":499},{"label":"Mar","value":472},{"label":"Abr","value":461},{"label":"Mai","value":669},{"label":"Jun","value":618},{"label":"Jul","value":458},{"label":"Ago","value":709},{"label":"Set","value":356},{"label":"Out","value":685},{"label":"Nov","value":371},{"label":"Dez","value":354}];
const MX = 709;
