...
const PAGE = "Support";
const KPIS = [{"l":"Tickets Abertos","v":"3.179","t":"-5.4%","d":"down"},{"l":"SLA Cumprido (%)","v":"73.2%","t":"-3.5%","d":"down"},{"l":"MTTR (h)","v":"147h","t":"+14.5%","d":"up"},{"l":"Satisfação (%)","v":"82.1%","t":"-1.9%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.849","8.241","766","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.918","3.838","4.006","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.105","8.163","4.412","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","999","6.898","700","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.068","1.230","3.997","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":704},{"label":"Mar","value":947},{"label":"Abr","value":774},{"label":"Mai","value":826},{"label":"Jun","value":604},{"label":"Jul","value":863},{"label":"Ago","value":857},{"label":"Set","value":584},{"label":"Out","value":677},{"label":"Nov","value":847},{"label":"Dez","value":666}];
const MX = 947;
