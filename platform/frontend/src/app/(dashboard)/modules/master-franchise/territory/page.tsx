...
const KPIS = [{"l":"Vendas YTD (€)","v":"€90450","t":"+1.3%","d":"up"},{"l":"Pipeline (€)","v":"€32497","t":"+10.5%","d":"up"},{"l":"Atingimento Quota (%)","v":"89.5%","t":"+9.7%","d":"up"},{"l":"Win Rate (%)","v":"87.8%","t":"+16.5%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 30853.78","€ 29190.25","€ 12818.38","85.8%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 2120.93","€ 7722.11","€ 18007.92","84.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 13206.08","€ 5661.30","€ 24221.59","81.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 32994.85","€ 14035.33","€ 21176.21","99.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 30439.29","€ 20370.21","€ 30266.42","99.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":714},{"label":"Fev","value":473},{"label":"Mar","value":454},{"label":"Abr","value":665},{"label":"Mai","value":412},{"label":"Jun","value":605},{"label":"Jul","value":674},{"label":"Ago","value":362},{"label":"Set","value":713},{"label":"Out","value":558},{"label":"Nov","value":604},{"label":"Dez","value":642}];
const MX = 714;
