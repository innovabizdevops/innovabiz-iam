...
const KPIS = [
    { label: "Total Registos", value: "7107", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "488", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€119K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1009232807", cells: ["MAS-9807", "Master Franchise Item 1", "24/12/2026", "€32 907"], status: "active" as const },
    { id: "1009236378", cells: ["MAS-4378", "Master Franchise Item 2", "11/7/2026", "€36 478"], status: "pending" as const },
    { id: "1009239949", cells: ["MAS-7949", "Master Franchise Item 3", "26/2/2026", "€40 049"], status: "completed" as const },
    { id: "1009243520", cells: ["MAS-2520", "Master Franchise Item 4", "13/9/2026", "€43 620"], status: "warning" as const },
    { id: "1009247091", cells: ["MAS-6091", "Master Franchise Item 5", "28/4/2026", "€47 191"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Master Franchise</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Master Franchise</p>
                    </div>
                </div>
