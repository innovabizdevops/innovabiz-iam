...
const ACCENT = "#6366f1";
const MODULE = "Media";
const PAGE = "Content Moderation AI";
const KPIS = [{"l":"Integrações Ativas","v":"7.672","t":"-0.5%","d":"down"},{"l":"Chamadas/Hora","v":"712","t":"-5.7%","d":"down"},{"l":"Taxa Sucesso (%)","v":"85.9%","t":"+8.3%","d":"up"},{"l":"Latência Média (ms)","v":"18ms","t":"+8.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.081","8.158","79.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.969","933","70.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.004","6.795","76.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.392","4.526","98.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.326","2.031","77.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":886},{"label":"Fev","value":835},{"label":"Mar","value":824},{"label":"Abr","value":867},{"label":"Mai","value":738},{"label":"Jun","value":898},{"label":"Jul","value":770},{"label":"Ago","value":689},{"label":"Set","value":582},{"label":"Out","value":598},{"label":"Nov","value":884},{"label":"Dez","value":561}];
const MX = 898;
