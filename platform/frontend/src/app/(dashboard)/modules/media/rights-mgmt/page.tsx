...
const KPIS = [{"l":"Integrações Ativas","v":"4.848","t":"+6.3%","d":"up"},{"l":"Chamadas/Hora","v":"2933","t":"+10.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"75.2%","t":"-0.4%","d":"down"},{"l":"Latência Média (ms)","v":"124ms","t":"+16.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.906","3.013","78.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.621","8.665","93.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.434","5.463","94.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.859","1.644","73.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.672","2.506","76.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":929},{"label":"Mar","value":818},{"label":"Abr","value":867},{"label":"Mai","value":815},{"label":"Jun","value":776},{"label":"Jul","value":930},{"label":"Ago","value":907},{"label":"Set","value":873},{"label":"Out","value":920},{"label":"Nov","value":773},{"label":"Dez","value":1012}];
const MX = 1012;
...
export default function RightsMgmtPage() {
    return (
