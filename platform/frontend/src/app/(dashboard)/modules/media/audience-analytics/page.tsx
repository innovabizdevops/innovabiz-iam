...
const KPIS = [{"l":"Dashboards Ativos","v":"8.524","t":"+1.2%","d":"up"},{"l":"Queries/Dia","v":"2437","t":"+3.2%","d":"up"},{"l":"Dados Processados (GB)","v":"5.430","t":"+16.6%","d":"up"},{"l":"Utilizadores Analytics","v":"7.162","t":"-3.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4273","2026-01-28","5.124","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4538","2026-01-12","9.004","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2445","2026-02-16","3.463","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3270","2026-02-27","7.166","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4025","2026-03-26","1.174","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":795},{"label":"Mar","value":693},{"label":"Abr","value":994},{"label":"Mai","value":773},{"label":"Jun","value":783},{"label":"Jul","value":762},{"label":"Ago","value":688},{"label":"Set","value":1047},{"label":"Out","value":714},{"label":"Nov","value":687},{"label":"Dez","value":1051}];
const MX = 1051;
