...
const ACCENT = "#6366f1";
const MODULE = "Media";
const PAGE = "Live Streaming";
const KPIS = [{"l":"Integrações Ativas","v":"2.546","t":"-2.1%","d":"down"},{"l":"Chamadas/Hora","v":"401","t":"+17.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"94.8%","t":"-0.7%","d":"down"},{"l":"Latência Média (ms)","v":"35ms","t":"+6.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.827","7.926","78.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.530","6.177","95.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.476","8.799","92.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.065","8.525","98.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.826","5.025","83.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":418},{"label":"Mar","value":503},{"label":"Abr","value":423},{"label":"Mai","value":393},{"label":"Jun","value":401},{"label":"Jul","value":708},{"label":"Ago","value":449},{"label":"Set","value":692},{"label":"Out","value":660},{"label":"Nov","value":607},{"label":"Dez","value":366}];
const MX = 708;
