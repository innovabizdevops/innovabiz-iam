...
const ACCENT = "#6366f1";
const MODULE = "Media";
const PAGE = "Creator Economy";
const KPIS = [{"l":"Integrações Ativas","v":"7.047","t":"+16.8%","d":"up"},{"l":"Chamadas/Hora","v":"2896","t":"+14.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"94.1%","t":"-4.6%","d":"down"},{"l":"Latência Média (ms)","v":"128ms","t":"-1.1%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.148","2.873","88.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.284","1.793","97.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.922","2.131","94.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.758","723","84.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.931","1.043","88.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":594},{"label":"Mar","value":489},{"label":"Abr","value":716},{"label":"Mai","value":801},{"label":"Jun","value":618},{"label":"Jul","value":544},{"label":"Ago","value":705},{"label":"Set","value":713},{"label":"Out","value":598},{"label":"Nov","value":627},{"label":"Dez","value":640}];
const MX = 801;
