...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€50.4M","t":"+17.4%","d":"up"},{"l":"MRR (€)","v":"€20850","t":"+9.5%","d":"up"},{"l":"Churn (%)","v":"71.8%","t":"+15.7%","d":"up"},{"l":"ARPU (€)","v":"€38489","t":"+16.4%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 25261.92","7.711","€ 30492.51","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 22431.64","4.353","€ 11591.56","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 37519.00","176","€ 43537.70","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 34964.09","9.084","€ 11621.65","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 21614.31","4.389","€ 38792.72","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":651},{"label":"Mar","value":677},{"label":"Abr","value":812},{"label":"Mai","value":819},{"label":"Jun","value":960},{"label":"Jul","value":1033},{"label":"Ago","value":828},{"label":"Set","value":880},{"label":"Out","value":764},{"label":"Nov","value":835},{"label":"Dez","value":946}];
const MX = 1033;
