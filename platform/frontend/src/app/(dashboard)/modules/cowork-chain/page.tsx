...
/* ═══ Coworking Chain Mgmt — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "7612", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1559", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€227K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "-20%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1767909912", cells: ["COW-4912", "Coworking Chain Mgmt Item 1", "21/1/2026", "€10 012"], status: "active" as const },
    { id: "1767913483", cells: ["COW-8483", "Coworking Chain Mgmt Item 2", "8/8/2026", "€13 583"], status: "pending" as const },
    { id: "1767917054", cells: ["COW-3054", "Coworking Chain Mgmt Item 3", "23/3/2026", "€17 154"], status: "completed" as const },
    { id: "1767920625", cells: ["COW-6625", "Coworking Chain Mgmt Item 4", "10/10/2026", "€20 725"], status: "warning" as const },
    { id: "1767924196", cells: ["COW-1196", "Coworking Chain Mgmt Item 5", "25/5/2026", "€24 296"], status: "active" as const },
];
...
export default function CoworkingChainMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Coworking Chain Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Coworking Chain Mgmt</p>
                    </div>
                </div>
