...
/* ═══ Global Trade Management — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "5833", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1943", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€210K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "-16%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1504300833", cells: ["GLO-5833", "Global Trade Management Item 1", "22/10/2026", "€933"], status: "active" as const },
    { id: "1504304404", cells: ["GLO-9404", "Global Trade Management Item 2", "9/5/2026", "€4504"], status: "pending" as const },
    { id: "1504307975", cells: ["GLO-3975", "Global Trade Management Item 3", "24/12/2026", "€8075"], status: "completed" as const },
    { id: "1504311546", cells: ["GLO-7546", "Global Trade Management Item 4", "11/7/2026", "€11 646"], status: "warning" as const },
    { id: "1504315117", cells: ["GLO-2117", "Global Trade Management Item 5", "26/2/2026", "€15 217"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 53 }, { label: "Fev", value: 62 }, { label: "Mar", value: 71 }, { label: "Abr", value: 80 }, { label: "Mai", value: 89 }, { label: "Jun", value: 98 }];
...
export default function GlobalTradeManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Global Trade Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Global Trade Management</p>
                    </div>
                </div>
