...
const PAGE = "Document";
const KPIS = [{"l":"Formulários Ativos","v":"4.651","t":"-4.4%","d":"down"},{"l":"Submissões/Dia","v":"2678","t":"-1.7%","d":"down"},{"l":"Documentos Gerados","v":"8.490","t":"+9.0%","d":"up"},{"l":"Templates","v":"2.432","t":"+11.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.275","2026-02-09","4.226","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.766","2026-03-05","4.530","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.662","2026-03-06","1.793","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.143","2026-01-06","2.079","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.787","2026-02-14","5.894","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":703},{"label":"Mar","value":869},{"label":"Abr","value":760},{"label":"Mai","value":646},{"label":"Jun","value":712},{"label":"Jul","value":612},{"label":"Ago","value":588},{"label":"Set","value":727},{"label":"Out","value":884},{"label":"Nov","value":540},{"label":"Dez","value":719}];
const MX = 884;
