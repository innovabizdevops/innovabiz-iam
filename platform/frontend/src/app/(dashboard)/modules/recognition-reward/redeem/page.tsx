...
const PAGE = "Redeem";
const KPIS = [{"l":"Total Recognition Reward","v":"8.029","t":"+13.3%","d":"up"},{"l":"Redeem Ativos","v":"6.063","t":"+11.4%","d":"up"},{"l":"Eficiência (%)","v":"65.9%","t":"-2.6%","d":"down"},{"l":"Score Performance","v":"79","t":"+8.6%","d":"up"}];
const COLS = ["ID","Redeem","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recognition Reward #001","Recognition Reward #002","2.233","6.350","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Recognition Reward #002","Recognition Reward #003","7.403","4.222","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Recognition Reward #003","Recognition Reward #004","1.759","5.156","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Recognition Reward #004","Recognition Reward #005","4.149","5.247","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recognition Reward #005","Recognition Reward #001","5.774","1.591","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":780},{"label":"Fev","value":773},{"label":"Mar","value":749},{"label":"Abr","value":856},{"label":"Mai","value":491},{"label":"Jun","value":544},{"label":"Jul","value":601},{"label":"Ago","value":826},{"label":"Set","value":536},{"label":"Out","value":605},{"label":"Nov","value":528},{"label":"Dez","value":759}];
const MX = 856;
