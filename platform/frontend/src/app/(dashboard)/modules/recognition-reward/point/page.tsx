...
const ACCENT = "#0e7490";
const MODULE = "Recognition & Reward Deep";
const PAGE = "Point";
const KPIS = [{"l":"Total Recognition Reward","v":"7.882","t":"+8.1%","d":"up"},{"l":"Point Ativos","v":"3.882","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"74.8%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"75","t":"+15.4%","d":"up"}];
const COLS = ["ID","Point","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recognition Reward #001","Recognition Reward #002","5.989","2.002","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Recognition Reward #002","Recognition Reward #003","2.484","2.942","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Recognition Reward #003","Recognition Reward #004","6.077","1.230","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Recognition Reward #004","Recognition Reward #005","4.296","9.051","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recognition Reward #005","Recognition Reward #001","6.468","8.173","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1065},{"label":"Fev","value":713},{"label":"Mar","value":1086},{"label":"Abr","value":860},{"label":"Mai","value":1021},{"label":"Jun","value":1028},{"label":"Jul","value":1037},{"label":"Ago","value":980},{"label":"Set","value":1030},{"label":"Out","value":732},{"label":"Nov","value":973},{"label":"Dez","value":847}];
const MX = 1086;
