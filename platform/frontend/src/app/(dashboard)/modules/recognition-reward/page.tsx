...
/* ═══ Recognition & Reward Deep — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "4184", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1159", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€306K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "510764884", cells: ["REC-6884", "Recognition & Reward Deep Item 1", "1/5/2026", "€14 984"], status: "active" as const },
    { id: "510768455", cells: ["REC-1455", "Recognition & Reward Deep Item 2", "16/12/2026", "€18 555"], status: "pending" as const },
    { id: "510772026", cells: ["REC-5026", "Recognition & Reward Deep Item 3", "3/7/2026", "€22 126"], status: "completed" as const },
    { id: "510775597", cells: ["REC-8597", "Recognition & Reward Deep Item 4", "18/2/2026", "€25 697"], status: "warning" as const },
    { id: "510779168", cells: ["REC-3168", "Recognition & Reward Deep Item 5", "5/9/2026", "€29 268"], status: "active" as const },
];
...
export default function RecognitionRewardDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Recognition & Reward Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Recognition & Reward Deep</p>
                    </div>
                </div>
