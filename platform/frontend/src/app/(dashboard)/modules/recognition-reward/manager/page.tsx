...
const PAGE = "Manager";
const KPIS = [{"l":"Total Recognition Reward","v":"625","t":"+9.5%","d":"up"},{"l":"Manager Ativos","v":"5.860","t":"-1.3%","d":"down"},{"l":"Eficiência (%)","v":"89.8%","t":"+16.2%","d":"up"},{"l":"Score Performance","v":"60","t":"+4.5%","d":"up"}];
const COLS = ["ID","Manager","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recognition Reward #001","Recognition Reward #002","4.489","2.590","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Recognition Reward #002","Recognition Reward #003","4.792","714","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Recognition Reward #003","Recognition Reward #004","6.774","1.310","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Recognition Reward #004","Recognition Reward #005","6.878","3.803","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recognition Reward #005","Recognition Reward #001","7.867","354","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":526},{"label":"Fev","value":427},{"label":"Mar","value":507},{"label":"Abr","value":505},{"label":"Mai","value":684},{"label":"Jun","value":657},{"label":"Jul","value":519},{"label":"Ago","value":546},{"label":"Set","value":410},{"label":"Out","value":587},{"label":"Nov","value":391},{"label":"Dez","value":421}];
const MX = 684;
