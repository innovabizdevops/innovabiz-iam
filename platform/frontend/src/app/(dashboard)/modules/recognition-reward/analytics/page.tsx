...
const KPIS = [{"l":"Dashboards Ativos","v":"1.108","t":"+4.0%","d":"up"},{"l":"Queries/Dia","v":"1368","t":"+14.5%","d":"up"},{"l":"Dados Processados (GB)","v":"8.476","t":"+10.9%","d":"up"},{"l":"Utilizadores Analytics","v":"332","t":"+14.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","813","2026-01-15","977","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1277","2026-01-19","4.308","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","412","2026-02-12","718","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2679","2026-01-27","8.979","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4514","2026-01-22","1.990","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":415},{"label":"Fev","value":383},{"label":"Mar","value":554},{"label":"Abr","value":499},{"label":"Mai","value":541},{"label":"Jun","value":500},{"label":"Jul","value":526},{"label":"Ago","value":692},{"label":"Set","value":737},{"label":"Out","value":694},{"label":"Nov","value":717},{"label":"Dez","value":644}];
const MX = 737;
