...
const KPIS = [
    { label: "Total Registos", value: "7195", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4571", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€421K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "-3%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1911320895", cells: ["POR-9895", "Portfolio Strategy Item 1", "16/4/2026", "€20 995"], status: "active" as const },
    { id: "1911324466", cells: ["POR-4466", "Portfolio Strategy Item 2", "3/11/2026", "€24 566"], status: "pending" as const },
    { id: "1911328037", cells: ["POR-8037", "Portfolio Strategy Item 3", "18/6/2026", "€28 137"], status: "completed" as const },
    { id: "1911331608", cells: ["POR-2608", "Portfolio Strategy Item 4", "5/1/2026", "€31 708"], status: "warning" as const },
    { id: "1911335179", cells: ["POR-6179", "Portfolio Strategy Item 5", "20/8/2026", "€35 279"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Portfolio Strategy</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Portfolio Strategy</p>
                    </div>
                </div>
