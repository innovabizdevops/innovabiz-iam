...
const PAGE = "BCG Matrix";
const KPIS = [{"l":"Total Portfolio Strategy","v":"5.777","t":"+4.6%","d":"up"},{"l":"BCG Matrix Ativos","v":"1.925","t":"+8.0%","d":"up"},{"l":"Eficiência (%)","v":"83.7%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"58","t":"+0.3%","d":"up"}];
const COLS = ["ID","BCG Matrix","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Portfolio Strategy #001","Portfolio Strategy #002","2.579","8.195","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Portfolio Strategy #002","Portfolio Strategy #003","6.807","2.941","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Portfolio Strategy #003","Portfolio Strategy #004","3.232","7.407","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Portfolio Strategy #004","Portfolio Strategy #005","1.390","2.398","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Portfolio Strategy #005","Portfolio Strategy #001","3.452","3.408","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":592},{"label":"Mar","value":847},{"label":"Abr","value":952},{"label":"Mai","value":669},{"label":"Jun","value":732},{"label":"Jul","value":573},{"label":"Ago","value":733},{"label":"Set","value":743},{"label":"Out","value":836},{"label":"Nov","value":863},{"label":"Dez","value":697}];
const MX = 952;
