...
const ACCENT = "#3b82f6";
const MODULE = "Portfolio Strategy";
const PAGE = "Divest";
const KPIS = [{"l":"Total Portfolio Strategy","v":"3.979","t":"-2.3%","d":"down"},{"l":"Divest Ativos","v":"7.065","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"69.9%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"91","t":"+8.7%","d":"up"}];
const COLS = ["ID","Divest","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Portfolio Strategy #001","Portfolio Strategy #002","3.431","1.988","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Portfolio Strategy #002","Portfolio Strategy #003","3.745","9.058","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Portfolio Strategy #003","Portfolio Strategy #004","6.564","2.254","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Portfolio Strategy #004","Portfolio Strategy #005","8.557","6.281","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Portfolio Strategy #005","Portfolio Strategy #001","3.163","4.564","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":1033},{"label":"Mar","value":835},{"label":"Abr","value":1084},{"label":"Mai","value":904},{"label":"Jun","value":952},{"label":"Jul","value":689},{"label":"Ago","value":802},{"label":"Set","value":871},{"label":"Out","value":979},{"label":"Nov","value":834},{"label":"Dez","value":1025}];
const MX = 1084;
...
export default function DivestPage() {
    return (
