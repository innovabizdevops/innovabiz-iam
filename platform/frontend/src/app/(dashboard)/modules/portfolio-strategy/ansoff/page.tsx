...
const PAGE = "Ansoff";
const KPIS = [{"l":"Total Portfolio Strategy","v":"2.761","t":"+12.2%","d":"up"},{"l":"Ansoff Ativos","v":"7.620","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"70.5%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"83","t":"-5.1%","d":"down"}];
const COLS = ["ID","Ansoff","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Portfolio Strategy #001","Portfolio Strategy #002","5.272","308","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Portfolio Strategy #002","Portfolio Strategy #003","4.073","6.096","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Portfolio Strategy #003","Portfolio Strategy #004","4.015","6.180","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Portfolio Strategy #004","Portfolio Strategy #005","9.012","1.012","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Portfolio Strategy #005","Portfolio Strategy #001","4.161","3.533","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":524},{"label":"Mar","value":578},{"label":"Abr","value":548},{"label":"Mai","value":573},{"label":"Jun","value":441},{"label":"Jul","value":511},{"label":"Ago","value":807},{"label":"Set","value":556},{"label":"Out","value":537},{"label":"Nov","value":705},{"label":"Dez","value":450}];
const MX = 807;
