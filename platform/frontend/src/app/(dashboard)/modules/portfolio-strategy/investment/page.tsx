...
const KPIS = [{"l":"Total Portfolio Strategy","v":"3.967","t":"+1.5%","d":"up"},{"l":"Investment Ativos","v":"6.931","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"93.6%","t":"-3.0%","d":"down"},{"l":"Score Performance","v":"92","t":"+1.8%","d":"up"}];
const COLS = ["ID","Investment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Portfolio Strategy #001","Portfolio Strategy #002","209","5.954","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Portfolio Strategy #002","Portfolio Strategy #003","5.072","8.947","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Portfolio Strategy #003","Portfolio Strategy #004","7.874","1.839","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Portfolio Strategy #004","Portfolio Strategy #005","2.942","7.284","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Portfolio Strategy #005","Portfolio Strategy #001","6.031","4.710","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":889},{"label":"Fev","value":619},{"label":"Mar","value":799},{"label":"Abr","value":736},{"label":"Mai","value":605},{"label":"Jun","value":787},{"label":"Jul","value":655},{"label":"Ago","value":824},{"label":"Set","value":603},{"label":"Out","value":880},{"label":"Nov","value":556},{"label":"Dez","value":745}];
const MX = 889;
