...
const PAGE = "Merch Store";
const KPIS = [{"l":"Pedidos/Dia","v":"3728","t":"+16.8%","d":"up"},{"l":"GMV (€)","v":"€83683","t":"-2.7%","d":"down"},{"l":"Conversão (%)","v":"81.4%","t":"+13.4%","d":"up"},{"l":"AOV (€)","v":"€10307","t":"-3.9%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 868.49","8.574","4.639","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 25289.65","888","3.796","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 8518.32","8.861","3.372","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 40622.64","7.257","1.910","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 6831.11","3.515","6.383","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1007},{"label":"Fev","value":898},{"label":"Mar","value":929},{"label":"Abr","value":872},{"label":"Mai","value":749},{"label":"Jun","value":853},{"label":"Jul","value":885},{"label":"Ago","value":816},{"label":"Set","value":750},{"label":"Out","value":808},{"label":"Nov","value":1020},{"label":"Dez","value":1004}];
const MX = 1020;
