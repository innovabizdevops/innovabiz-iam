...
const KPIS = [{"l":"Atletas Registados","v":"4.998","t":"+8.2%","d":"up"},{"l":"Treinos/Semana","v":"3710","t":"+6.0%","d":"up"},{"l":"Competições","v":"6.060","t":"-5.1%","d":"down"},{"l":"Performance Score","v":"73","t":"+2.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.540","7.602","4.145","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.699","7.527","5.092","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.259","4.327","1.356","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.082","7.145","8.259","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.535","5.317","3.569","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":677},{"label":"Mar","value":692},{"label":"Abr","value":359},{"label":"Mai","value":689},{"label":"Jun","value":440},{"label":"Jul","value":564},{"label":"Ago","value":561},{"label":"Set","value":581},{"label":"Out","value":507},{"label":"Nov","value":506},{"label":"Dez","value":643}];
const MX = 692;
