...
const ACCENT = "#a855f7";
const MODULE = "School Transport";
const PAGE = "Track";
const KPIS = [{"l":"Atletas Registados","v":"4.273","t":"+8.9%","d":"up"},{"l":"Treinos/Semana","v":"2073","t":"+16.8%","d":"up"},{"l":"Competições","v":"8.533","t":"-0.7%","d":"down"},{"l":"Performance Score","v":"77","t":"+16.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.334","2.505","4.945","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.472","5.494","2.998","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","200","366","2.218","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.756","3.328","6.438","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.521","4.020","6.609","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":807},{"label":"Mar","value":736},{"label":"Abr","value":879},{"label":"Mai","value":889},{"label":"Jun","value":568},{"label":"Jul","value":646},{"label":"Ago","value":715},{"label":"Set","value":812},{"label":"Out","value":930},{"label":"Nov","value":803},{"label":"Dez","value":743}];
const MX = 930;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#a855f7'}}>IoT</span></h1>
                </div>
