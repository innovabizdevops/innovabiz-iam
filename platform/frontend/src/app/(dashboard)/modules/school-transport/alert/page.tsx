...
const PAGE = "Parent Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"5.383","t":"+4.8%","d":"up"},{"l":"Taxa Entrega (%)","v":"72.7%","t":"+13.0%","d":"up"},{"l":"Taxa Abertura (%)","v":"66.3%","t":"+10.7%","d":"up"},{"l":"Escalações","v":"4.702","t":"-6.0%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","3.157","85.7%","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","1.692","78.2%","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","6.307","87.3%","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","3.362","93.7%","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","7.302","92.0%","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":703},{"label":"Mar","value":841},{"label":"Abr","value":740},{"label":"Mai","value":934},{"label":"Jun","value":973},{"label":"Jul","value":920},{"label":"Ago","value":750},{"label":"Set","value":860},{"label":"Out","value":792},{"label":"Nov","value":950},{"label":"Dez","value":952}];
const MX = 973;
