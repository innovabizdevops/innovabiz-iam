...
const PAGE = "Safety";
const KPIS = [{"l":"Atletas Registados","v":"3.910","t":"+7.6%","d":"up"},{"l":"Treinos/Semana","v":"1389","t":"+1.8%","d":"up"},{"l":"Competições","v":"1.818","t":"+13.7%","d":"up"},{"l":"Performance Score","v":"67","t":"+6.5%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.470","479","8.937","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.639","7.777","8.389","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.404","2.876","926","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","3.797","3.479","6.563","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.626","4.875","8.501","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":574},{"label":"Mar","value":886},{"label":"Abr","value":554},{"label":"Mai","value":831},{"label":"Jun","value":684},{"label":"Jul","value":641},{"label":"Ago","value":893},{"label":"Set","value":816},{"label":"Out","value":776},{"label":"Nov","value":631},{"label":"Dez","value":667}];
const MX = 893;
