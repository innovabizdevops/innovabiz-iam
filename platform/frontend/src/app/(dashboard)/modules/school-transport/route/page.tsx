...
const PAGE = "Route";
const KPIS = [{"l":"Atletas Registados","v":"4.642","t":"+3.9%","d":"up"},{"l":"Treinos/Semana","v":"163","t":"+2.0%","d":"up"},{"l":"Competições","v":"2.192","t":"-1.6%","d":"down"},{"l":"Performance Score","v":"86","t":"+13.2%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.270","2.171","1.010","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.828","2.274","2.871","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","878","5.318","133","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.421","8.615","7.909","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.753","382","9.036","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":947},{"label":"Mar","value":720},{"label":"Abr","value":936},{"label":"Mai","value":852},{"label":"Jun","value":698},{"label":"Jul","value":606},{"label":"Ago","value":912},{"label":"Set","value":792},{"label":"Out","value":638},{"label":"Nov","value":878},{"label":"Dez","value":947}];
const MX = 947;
