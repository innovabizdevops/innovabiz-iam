...
const KPIS = [{"l":"Projetos Sociais","v":"2.188","t":"-3.7%","d":"down"},{"l":"Beneficiários","v":"4.947","t":"-4.7%","d":"down"},{"l":"Investimento CSR (€)","v":"€86258","t":"+10.7%","d":"up"},{"l":"Score Impacto","v":"71","t":"+13.5%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","8.264","€ 29164.28","7.228","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","5.716","€ 18416.07","7.023","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","4.328","€ 36681.23","1.303","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","6.958","€ 22752.61","2.204","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","2.927","€ 2304.81","6.931","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":417},{"label":"Fev","value":407},{"label":"Mar","value":490},{"label":"Abr","value":558},{"label":"Mai","value":481},{"label":"Jun","value":417},{"label":"Jul","value":426},{"label":"Ago","value":495},{"label":"Set","value":761},{"label":"Out","value":644},{"label":"Nov","value":406},{"label":"Dez","value":407}];
const MX = 761;
