...
const PAGE = "ISO 50001 Energy";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.028","t":"-1.0%","d":"down"},{"l":"NC Abertas","v":"278","t":"-2.5%","d":"down"},{"l":"Conformidade (%)","v":"70.0%","t":"+16.3%","d":"up"},{"l":"CAPAs Pendentes","v":"1.934","t":"-3.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.982","95.7%","5.903","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.604","83.9%","7.492","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.882","72.4%","509","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.661","97.6%","623","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.259","86.0%","2.422","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":534},{"label":"Mar","value":466},{"label":"Abr","value":745},{"label":"Mai","value":595},{"label":"Jun","value":539},{"label":"Jul","value":690},{"label":"Ago","value":532},{"label":"Set","value":488},{"label":"Out","value":576},{"label":"Nov","value":528},{"label":"Dez","value":839}];
const MX = 839;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#16a34a'}}>ISO</span></h1>
                </div>
