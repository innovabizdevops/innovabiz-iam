...
const PAGE = "Boarding";
const KPIS = [{"l":"Teams Ativos","v":"6.193","t":"+7.0%","d":"up"},{"l":"Reuniões/Semana","v":"3192","t":"+8.2%","d":"up"},{"l":"Mensagens/Dia","v":"2598","t":"-1.1%","d":"down"},{"l":"Ficheiros Partilhados","v":"2.982","t":"+3.7%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.039","1797","8.017","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","8.734","1034","3.526","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","438","1398","7.168","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","8.248","4212","1.663","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","6.704","1813","5.913","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":366},{"label":"Mar","value":387},{"label":"Abr","value":583},{"label":"Mai","value":490},{"label":"Jun","value":383},{"label":"Jul","value":419},{"label":"Ago","value":460},{"label":"Set","value":316},{"label":"Out","value":534},{"label":"Nov","value":506},{"label":"Dez","value":439}];
const MX = 583;
