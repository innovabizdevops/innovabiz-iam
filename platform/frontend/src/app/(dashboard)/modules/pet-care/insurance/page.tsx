...
const ACCENT = "#f97316";
const MODULE = "Pet Care Platform";
const PAGE = "Insurance";
const KPIS = [{"l":"Total Pet Care","v":"8.375","t":"+12.3%","d":"up"},{"l":"Insurance Ativos","v":"4.855","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"89.2%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"81","t":"+2.0%","d":"up"}];
const COLS = ["ID","Insurance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Care #001","Pet Care #002","254","3.080","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Care #002","Pet Care #003","2.677","5.294","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Care #003","Pet Care #004","5.600","7.332","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Care #004","Pet Care #005","302","1.852","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Care #005","Pet Care #001","4.575","4.965","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1060},{"label":"Fev","value":989},{"label":"Mar","value":784},{"label":"Abr","value":988},{"label":"Mai","value":790},{"label":"Jun","value":853},{"label":"Jul","value":737},{"label":"Ago","value":817},{"label":"Set","value":861},{"label":"Out","value":892},{"label":"Nov","value":762},{"label":"Dez","value":799}];
const MX = 1060;
