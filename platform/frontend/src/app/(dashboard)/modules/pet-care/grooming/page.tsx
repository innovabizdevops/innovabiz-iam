...
const PAGE = "Grooming";
const KPIS = [{"l":"Total Pet Care","v":"8.923","t":"+15.4%","d":"up"},{"l":"Grooming Ativos","v":"2.582","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"79.9%","t":"+10.8%","d":"up"},{"l":"Score Performance","v":"83","t":"+7.9%","d":"up"}];
const COLS = ["ID","Grooming","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Care #001","Pet Care #002","5.686","3.823","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Care #002","Pet Care #003","609","5.397","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Care #003","Pet Care #004","4.574","5.332","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Care #004","Pet Care #005","2.826","1.195","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Care #005","Pet Care #001","295","7.644","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":736},{"label":"Mar","value":689},{"label":"Abr","value":745},{"label":"Mai","value":367},{"label":"Jun","value":665},{"label":"Jul","value":637},{"label":"Ago","value":449},{"label":"Set","value":678},{"label":"Out","value":706},{"label":"Nov","value":622},{"label":"Dez","value":676}];
const MX = 745;
