...
const PAGE = "Vet";
const KPIS = [{"l":"Total Pet Care","v":"8.236","t":"+2.7%","d":"up"},{"l":"Vet Ativos","v":"5.729","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"80.4%","t":"+10.3%","d":"up"},{"l":"Score Performance","v":"69","t":"+10.8%","d":"up"}];
const COLS = ["ID","Vet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Care #001","Pet Care #002","2.118","3.052","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Care #002","Pet Care #003","6.305","4.261","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Care #003","Pet Care #004","1.465","227","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Care #004","Pet Care #005","4.397","7.623","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Care #005","Pet Care #001","3.113","7.476","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":405},{"label":"Mar","value":436},{"label":"Abr","value":290},{"label":"Mai","value":373},{"label":"Jun","value":650},{"label":"Jul","value":595},{"label":"Ago","value":406},{"label":"Set","value":520},{"label":"Out","value":425},{"label":"Nov","value":453},{"label":"Dez","value":266}];
const MX = 650;
