...
/* ═══ Demolition Recycling — Dashboard ═══ */

const ACCENT = "#065f46";

const KPIS = [
    { label: "Total Registos", value: "2751", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3486", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€150K", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "753541151", cells: ["DEM-8151", "Demolition Recycling Item 1", "28/12/2026", "€41 251"], status: "active" as const },
    { id: "753544722", cells: ["DEM-2722", "Demolition Recycling Item 2", "15/7/2026", "€44 822"], status: "pending" as const },
    { id: "753548293", cells: ["DEM-6293", "Demolition Recycling Item 3", "2/2/2026", "€48 393"], status: "completed" as const },
    { id: "753551864", cells: ["DEM-9864", "Demolition Recycling Item 4", "17/9/2026", "€1964"], status: "warning" as const },
    { id: "753555435", cells: ["DEM-4435", "Demolition Recycling Item 5", "4/4/2026", "€5535"], status: "active" as const },
];
...
export default function DemolitionRecyclingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Demolition Recycling</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Demolition Recycling</p>
                    </div>
                </div>
