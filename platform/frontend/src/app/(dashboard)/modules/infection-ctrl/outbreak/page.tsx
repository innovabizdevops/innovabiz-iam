...
const PAGE = "Outbreak";
const KPIS = [{"l":"Total Infection Ctrl","v":"585","t":"+14.3%","d":"up"},{"l":"Outbreak Ativos","v":"5.072","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"80.8%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"86","t":"+16.8%","d":"up"}];
const COLS = ["ID","Outbreak","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Infection Ctrl #001","Infection Ctrl #002","5.053","8.264","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Infection Ctrl #002","Infection Ctrl #003","2.655","2.549","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Infection Ctrl #003","Infection Ctrl #004","6.014","2.199","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Infection Ctrl #004","Infection Ctrl #005","276","3.533","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Infection Ctrl #005","Infection Ctrl #001","1.477","275","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":763},{"label":"Mar","value":625},{"label":"Abr","value":933},{"label":"Mai","value":888},{"label":"Jun","value":898},{"label":"Jul","value":611},{"label":"Ago","value":802},{"label":"Set","value":552},{"label":"Out","value":729},{"label":"Nov","value":750},{"label":"Dez","value":571}];
const MX = 933;
