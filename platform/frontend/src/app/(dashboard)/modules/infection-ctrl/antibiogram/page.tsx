...
const PAGE = "Antibiogram";
const KPIS = [{"l":"Total Infection Ctrl","v":"446","t":"+9.9%","d":"up"},{"l":"Antibiogram Ativos","v":"6.725","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"91.9%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"58","t":"-4.6%","d":"down"}];
const COLS = ["ID","Antibiogram","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Infection Ctrl #001","Infection Ctrl #002","5.028","1.804","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Infection Ctrl #002","Infection Ctrl #003","8.917","3.661","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Infection Ctrl #003","Infection Ctrl #004","7.998","1.961","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Infection Ctrl #004","Infection Ctrl #005","2.138","4.449","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Infection Ctrl #005","Infection Ctrl #001","1.916","5.561","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":361},{"label":"Mar","value":317},{"label":"Abr","value":495},{"label":"Mai","value":369},{"label":"Jun","value":479},{"label":"Jul","value":582},{"label":"Ago","value":311},{"label":"Set","value":522},{"label":"Out","value":260},{"label":"Nov","value":606},{"label":"Dez","value":635}];
const MX = 635;
