...
const ACCENT = "#6366f1";
const MODULE = "Infection Control";
const PAGE = "Surveillance";
const KPIS = [{"l":"Total Infection Ctrl","v":"8.751","t":"+18.0%","d":"up"},{"l":"Surveillance Ativos","v":"6.320","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"70.8%","t":"+9.9%","d":"up"},{"l":"Score Performance","v":"82","t":"+0.4%","d":"up"}];
const COLS = ["ID","Surveillance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Infection Ctrl #001","Infection Ctrl #002","5.185","5.323","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Infection Ctrl #002","Infection Ctrl #003","5.774","901","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Infection Ctrl #003","Infection Ctrl #004","8.133","3.790","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Infection Ctrl #004","Infection Ctrl #005","6.294","5.443","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Infection Ctrl #005","Infection Ctrl #001","658","6.470","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":375},{"label":"Mar","value":385},{"label":"Abr","value":445},{"label":"Mai","value":418},{"label":"Jun","value":698},{"label":"Jul","value":366},{"label":"Ago","value":729},{"label":"Set","value":493},{"label":"Out","value":615},{"label":"Nov","value":413},{"label":"Dez","value":687}];
const MX = 729;
