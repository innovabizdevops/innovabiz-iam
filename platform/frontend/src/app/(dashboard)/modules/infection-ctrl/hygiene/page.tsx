...
const PAGE = "Hand Hygiene";
const KPIS = [{"l":"Total Infection Ctrl","v":"2.143","t":"-0.5%","d":"down"},{"l":"Hand Hygiene Ativos","v":"8.365","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"71.0%","t":"-3.1%","d":"down"},{"l":"Score Performance","v":"69","t":"-1.1%","d":"down"}];
const COLS = ["ID","Hand Hygiene","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Infection Ctrl #001","Infection Ctrl #002","2.218","2.663","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Infection Ctrl #002","Infection Ctrl #003","7.161","6.050","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Infection Ctrl #003","Infection Ctrl #004","6.537","275","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Infection Ctrl #004","Infection Ctrl #005","1.592","287","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Infection Ctrl #005","Infection Ctrl #001","5.477","1.461","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":708},{"label":"Mar","value":556},{"label":"Abr","value":566},{"label":"Mai","value":684},{"label":"Jun","value":727},{"label":"Jul","value":906},{"label":"Ago","value":767},{"label":"Set","value":799},{"label":"Out","value":686},{"label":"Nov","value":534},{"label":"Dez","value":675}];
const MX = 906;
