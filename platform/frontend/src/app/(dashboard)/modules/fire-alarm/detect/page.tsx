...
const ACCENT = "#6366f1";
const MODULE = "Fire Alarm System";
const PAGE = "Detect";
const KPIS = [{"l":"Total Fire Alarm","v":"1.150","t":"+16.3%","d":"up"},{"l":"Detect Ativos","v":"4.714","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"77.7%","t":"+6.5%","d":"up"},{"l":"Score Performance","v":"59","t":"+1.1%","d":"up"}];
const COLS = ["ID","Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fire Alarm #001","Fire Alarm #002","3.071","513","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Fire Alarm #002","Fire Alarm #003","4.326","2.033","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Fire Alarm #003","Fire Alarm #004","4.878","8.512","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Fire Alarm #004","Fire Alarm #005","2.713","4.712","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fire Alarm #005","Fire Alarm #001","9.082","8.875","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":782},{"label":"Fev","value":748},{"label":"Mar","value":876},{"label":"Abr","value":811},{"label":"Mai","value":826},{"label":"Jun","value":834},{"label":"Jul","value":791},{"label":"Ago","value":740},{"label":"Set","value":755},{"label":"Out","value":1033},{"label":"Nov","value":828},{"label":"Dez","value":932}];
const MX = 1033;
