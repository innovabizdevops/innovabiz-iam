...
const KPIS = [{"l":"Dashboards Ativos","v":"6.753","t":"+2.5%","d":"up"},{"l":"Queries/Dia","v":"3304","t":"+11.8%","d":"up"},{"l":"Dados Processados (GB)","v":"6.284","t":"+10.6%","d":"up"},{"l":"Utilizadores Analytics","v":"8.106","t":"-0.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5097","2026-03-10","5.581","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1272","2026-01-07","5.801","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2473","2026-01-17","6.043","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4334","2026-03-24","8.932","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3911","2026-01-23","1.660","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":617},{"label":"Mar","value":581},{"label":"Abr","value":328},{"label":"Mai","value":292},{"label":"Jun","value":466},{"label":"Jul","value":556},{"label":"Ago","value":618},{"label":"Set","value":441},{"label":"Out","value":685},{"label":"Nov","value":292},{"label":"Dez","value":545}];
const MX = 685;
