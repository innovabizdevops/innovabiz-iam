...
const ACCENT = "#dc2626";
const MODULE = "Predictive Analytics";
const PAGE = "Explainability";
const KPIS = [{"l":"Dashboards Ativos","v":"5.708","t":"+17.7%","d":"up"},{"l":"Queries/Dia","v":"3057","t":"-0.7%","d":"down"},{"l":"Dados Processados (GB)","v":"5.181","t":"+13.5%","d":"up"},{"l":"Utilizadores Analytics","v":"1.501","t":"+16.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1329","2026-02-15","4.457","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4144","2026-02-04","7.140","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","819","2026-03-26","4.932","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2205","2026-01-13","129","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1227","2026-03-22","4.945","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":945},{"label":"Fev","value":911},{"label":"Mar","value":936},{"label":"Abr","value":736},{"label":"Mai","value":831},{"label":"Jun","value":1015},{"label":"Jul","value":876},{"label":"Ago","value":975},{"label":"Set","value":915},{"label":"Out","value":806},{"label":"Nov","value":812},{"label":"Dez","value":869}];
const MX = 1015;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>XAI</span></h1>
                </div>
