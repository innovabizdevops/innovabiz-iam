...
const PAGE = "AutoML Pipeline";
const KPIS = [{"l":"Dashboards Ativos","v":"6.053","t":"+3.0%","d":"up"},{"l":"Queries/Dia","v":"3625","t":"+17.6%","d":"up"},{"l":"Dados Processados (GB)","v":"707","t":"+11.0%","d":"up"},{"l":"Utilizadores Analytics","v":"7.503","t":"+15.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3177","2026-02-15","9.071","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","173","2026-03-18","4.927","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3583","2026-03-22","1.274","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4140","2026-02-18","2.667","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3856","2026-03-19","8.916","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":415},{"label":"Fev","value":593},{"label":"Mar","value":517},{"label":"Abr","value":464},{"label":"Mai","value":314},{"label":"Jun","value":565},{"label":"Jul","value":535},{"label":"Ago","value":340},{"label":"Set","value":436},{"label":"Out","value":262},{"label":"Nov","value":515},{"label":"Dez","value":510}];
const MX = 593;
