...
const PAGE = "Model Studio";
const KPIS = [{"l":"Dashboards Ativos","v":"5.147","t":"+1.1%","d":"up"},{"l":"Queries/Dia","v":"4435","t":"+14.3%","d":"up"},{"l":"Dados Processados (GB)","v":"5.618","t":"+2.4%","d":"up"},{"l":"Utilizadores Analytics","v":"9.009","t":"+16.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2639","2026-02-11","8.369","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2553","2026-03-15","2.092","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2996","2026-03-25","8.635","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4497","2026-02-23","6.203","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2551","2026-03-01","956","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":754},{"label":"Fev","value":646},{"label":"Mar","value":436},{"label":"Abr","value":459},{"label":"Mai","value":625},{"label":"Jun","value":706},{"label":"Jul","value":722},{"label":"Ago","value":483},{"label":"Set","value":564},{"label":"Out","value":623},{"label":"Nov","value":386},{"label":"Dez","value":511}];
const MX = 754;
