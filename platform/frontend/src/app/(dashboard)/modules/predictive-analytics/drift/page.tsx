...
const PAGE = "Drift Monitor";
const KPIS = [{"l":"Dashboards Ativos","v":"2.655","t":"+8.7%","d":"up"},{"l":"Queries/Dia","v":"2705","t":"+10.8%","d":"up"},{"l":"Dados Processados (GB)","v":"3.961","t":"+13.2%","d":"up"},{"l":"Utilizadores Analytics","v":"5.468","t":"-0.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4430","2026-01-21","8.932","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2366","2026-02-13","1.182","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4816","2026-02-02","6.793","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4223","2026-02-07","6.898","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1777","2026-03-01","3.342","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":841},{"label":"Fev","value":704},{"label":"Mar","value":828},{"label":"Abr","value":682},{"label":"Mai","value":1071},{"label":"Jun","value":855},{"label":"Jul","value":988},{"label":"Ago","value":793},{"label":"Set","value":942},{"label":"Out","value":941},{"label":"Nov","value":1002},{"label":"Dez","value":908}];
const MX = 1071;
