...
const PAGE = "Scoring Engine";
const KPIS = [{"l":"Dashboards Ativos","v":"5.890","t":"+12.7%","d":"up"},{"l":"Queries/Dia","v":"849","t":"+3.6%","d":"up"},{"l":"Dados Processados (GB)","v":"1.733","t":"+9.5%","d":"up"},{"l":"Utilizadores Analytics","v":"4.369","t":"+17.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4705","2026-03-21","139","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3114","2026-03-03","8.700","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4070","2026-02-11","6.583","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3046","2026-01-16","1.347","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3244","2026-03-19","4.906","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":1002},{"label":"Mar","value":865},{"label":"Abr","value":897},{"label":"Mai","value":746},{"label":"Jun","value":696},{"label":"Jul","value":765},{"label":"Ago","value":612},{"label":"Set","value":746},{"label":"Out","value":883},{"label":"Nov","value":619},{"label":"Dez","value":764}];
const MX = 1002;
