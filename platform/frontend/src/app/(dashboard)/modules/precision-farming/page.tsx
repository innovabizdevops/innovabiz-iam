...
/* ═══ Precision Farming Platform — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "1812", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3543", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€218K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "467054012", cells: ["PRE-9012", "Precision Farming Platform Item 1", "13/9/2026", "€4112"], status: "active" as const },
    { id: "467057583", cells: ["PRE-3583", "Precision Farming Platform Item 2", "28/4/2026", "€7683"], status: "pending" as const },
    { id: "467061154", cells: ["PRE-7154", "Precision Farming Platform Item 3", "15/11/2026", "€11 254"], status: "completed" as const },
    { id: "467064725", cells: ["PRE-1725", "Precision Farming Platform Item 4", "2/6/2026", "€14 825"], status: "warning" as const },
    { id: "467068296", cells: ["PRE-5296", "Precision Farming Platform Item 5", "17/1/2026", "€18 396"], status: "active" as const },
];
...
export default function PrecisionFarmingPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Precision Farming Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Precision Farming Platform</p>
                    </div>
                </div>
