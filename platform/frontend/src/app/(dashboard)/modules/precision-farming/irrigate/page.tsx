...
const ACCENT = "#166534";
const MODULE = "Precision Farming Platform";
const PAGE = "Irrigate";
const KPIS = [{"l":"Total Precision Farming","v":"2.360","t":"+5.8%","d":"up"},{"l":"Irrigate Ativos","v":"5.801","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"90.0%","t":"+2.0%","d":"up"},{"l":"Score Performance","v":"72","t":"-0.2%","d":"down"}];
const COLS = ["ID","Irrigate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Precision Farming #001","Precision Farming #002","3.287","591","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Precision Farming #002","Precision Farming #003","7.267","9.032","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Precision Farming #003","Precision Farming #004","5.193","6.056","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Precision Farming #004","Precision Farming #005","7.655","5.365","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Precision Farming #005","Precision Farming #001","5.425","4.231","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":555},{"label":"Mar","value":586},{"label":"Abr","value":439},{"label":"Mai","value":457},{"label":"Jun","value":457},{"label":"Jul","value":589},{"label":"Ago","value":405},{"label":"Set","value":537},{"label":"Out","value":395},{"label":"Nov","value":622},{"label":"Dez","value":452}];
const MX = 670;
...
export default function IrrigatePage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#166534'}}>AI</span></h1>
                </div>
