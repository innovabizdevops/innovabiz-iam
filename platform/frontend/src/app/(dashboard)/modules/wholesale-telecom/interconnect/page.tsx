...
const ACCENT = "#6366f1";
const MODULE = "Wholesale Telecom";
const PAGE = "Interconnect";
const KPIS = [{"l":"Total Wholesale Telecom","v":"7.369","t":"+0.7%","d":"up"},{"l":"Interconnect Ativos","v":"3.103","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"82.2%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"71","t":"+16.1%","d":"up"}];
const COLS = ["ID","Interconnect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wholesale Telecom #001","Wholesale Telecom #002","3.637","2.875","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Wholesale Telecom #002","Wholesale Telecom #003","248","2.358","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Wholesale Telecom #003","Wholesale Telecom #004","4.487","5.602","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Wholesale Telecom #004","Wholesale Telecom #005","8.831","1.624","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wholesale Telecom #005","Wholesale Telecom #001","1.286","167","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":654},{"label":"Mar","value":756},{"label":"Abr","value":804},{"label":"Mai","value":630},{"label":"Jun","value":659},{"label":"Jul","value":590},{"label":"Ago","value":766},{"label":"Set","value":458},{"label":"Out","value":753},{"label":"Nov","value":758},{"label":"Dez","value":459}];
const MX = 804;
