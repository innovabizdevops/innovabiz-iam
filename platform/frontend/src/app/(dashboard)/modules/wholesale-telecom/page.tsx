...
export default function WholesaleTelecomPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Wholesale Telecom</h1><p className="text-sm text-muted-foreground">Wholesale Telecom • iBOS Enterprise</p></div>
