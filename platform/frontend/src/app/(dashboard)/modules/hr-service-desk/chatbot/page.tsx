...
const ACCENT = "#6366f1";
const MODULE = "HR Service Desk";
const PAGE = "Chatbot";
const KPIS = [{"l":"Tickets Abertos","v":"8.192","t":"+3.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"91.1%","t":"+3.2%","d":"up"},{"l":"MTTR (h)","v":"127h","t":"-5.9%","d":"down"},{"l":"Satisfação (%)","v":"74.9%","t":"+14.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.322","161","2.129","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.036","5.788","924","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.190","2.267","8.459","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","480","7.527","3.510","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","248","6.409","8.291","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":812},{"label":"Fev","value":788},{"label":"Mar","value":893},{"label":"Abr","value":862},{"label":"Mai","value":1041},{"label":"Jun","value":922},{"label":"Jul","value":728},{"label":"Ago","value":868},{"label":"Set","value":748},{"label":"Out","value":997},{"label":"Nov","value":974},{"label":"Dez","value":1014}];
const MX = 1041;
