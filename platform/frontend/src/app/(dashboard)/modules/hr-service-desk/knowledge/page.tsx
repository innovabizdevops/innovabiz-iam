...
const KPIS = [{"l":"Tickets Abertos","v":"3.192","t":"+13.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"65.5%","t":"+5.1%","d":"up"},{"l":"MTTR (h)","v":"196h","t":"+2.9%","d":"up"},{"l":"Satisfação (%)","v":"94.3%","t":"+12.7%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.774","7.013","6.199","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.111","4.861","3.179","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.188","3.933","2.384","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.687","6.609","2.335","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.899","2.687","1.537","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":608},{"label":"Fev","value":428},{"label":"Mar","value":571},{"label":"Abr","value":424},{"label":"Mai","value":577},{"label":"Jun","value":415},{"label":"Jul","value":696},{"label":"Ago","value":423},{"label":"Set","value":750},{"label":"Out","value":412},{"label":"Nov","value":395},{"label":"Dez","value":365}];
const MX = 750;
