...
const PAGE = "SLA";
const KPIS = [{"l":"Tickets Abertos","v":"8.190","t":"+11.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"81.2%","t":"-2.3%","d":"down"},{"l":"MTTR (h)","v":"18h","t":"+2.2%","d":"up"},{"l":"Satisfação (%)","v":"81.6%","t":"+3.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.060","3.745","8.055","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.748","1.303","6.349","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.644","4.902","7.089","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.878","6.199","4.647","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.458","8.365","2.012","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":825},{"label":"Mar","value":674},{"label":"Abr","value":890},{"label":"Mai","value":662},{"label":"Jun","value":647},{"label":"Jul","value":517},{"label":"Ago","value":583},{"label":"Set","value":767},{"label":"Out","value":800},{"label":"Nov","value":864},{"label":"Dez","value":809}];
const MX = 890;
