...
const PAGE = "Ticket";
const KPIS = [{"l":"Tickets Abertos","v":"5.597","t":"+10.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"69.8%","t":"-2.2%","d":"down"},{"l":"MTTR (h)","v":"23h","t":"+14.0%","d":"up"},{"l":"Satisfação (%)","v":"88.9%","t":"-4.4%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.406","5.488","6.356","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","796","7.934","531","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.532","4.293","853","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.184","6.963","2.181","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.292","3.462","4.546","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":971},{"label":"Fev","value":709},{"label":"Mar","value":967},{"label":"Abr","value":640},{"label":"Mai","value":777},{"label":"Jun","value":670},{"label":"Jul","value":985},{"label":"Ago","value":771},{"label":"Set","value":862},{"label":"Out","value":671},{"label":"Nov","value":642},{"label":"Dez","value":945}];
const MX = 985;
