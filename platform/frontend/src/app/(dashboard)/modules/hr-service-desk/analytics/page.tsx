...
const KPIS = [{"l":"Tickets Abertos","v":"2.757","t":"+1.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"85.5%","t":"-0.1%","d":"down"},{"l":"MTTR (h)","v":"202h","t":"-1.3%","d":"down"},{"l":"Satisfação (%)","v":"94.3%","t":"+4.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.825","1.074","2.419","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.419","1.837","5.466","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.824","3.898","6.645","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.034","4.171","3.763","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.726","5.234","996","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":864},{"label":"Mar","value":869},{"label":"Abr","value":634},{"label":"Mai","value":859},{"label":"Jun","value":653},{"label":"Jul","value":697},{"label":"Ago","value":705},{"label":"Set","value":621},{"label":"Out","value":883},{"label":"Nov","value":557},{"label":"Dez","value":793}];
const MX = 883;
