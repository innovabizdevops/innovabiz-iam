...
const PAGE = "Simulation Run";
const KPIS = [{"l":"Twins Ativos","v":"6.054","t":"-0.1%","d":"down"},{"l":"Simulações/Dia","v":"4752","t":"+7.7%","d":"up"},{"l":"Precisão Modelo (%)","v":"74.3%","t":"+12.5%","d":"up"},{"l":"Latência Sync (ms)","v":"92ms","t":"+5.2%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","98.9%","2026-02-24","567","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","87.2%","2026-03-11","3.216","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","89.7%","2026-03-12","7.602","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","78.4%","2026-02-07","4.074","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","98.6%","2026-02-24","668","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":853},{"label":"Mar","value":988},{"label":"Abr","value":681},{"label":"Mai","value":688},{"label":"Jun","value":951},{"label":"Jul","value":841},{"label":"Ago","value":769},{"label":"Set","value":870},{"label":"Out","value":866},{"label":"Nov","value":707},{"label":"Dez","value":941}];
const MX = 988;
