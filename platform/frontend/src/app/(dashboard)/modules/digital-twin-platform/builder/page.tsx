...
const KPIS = [{"l":"Twins Ativos","v":"6.069","t":"+2.1%","d":"up"},{"l":"Simulações/Dia","v":"1610","t":"-4.2%","d":"down"},{"l":"Precisão Modelo (%)","v":"87.7%","t":"-0.5%","d":"down"},{"l":"Latência Sync (ms)","v":"12ms","t":"+8.3%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","93.0%","2026-01-11","2.492","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","71.9%","2026-03-04","2.218","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","74.1%","2026-03-23","5.417","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","96.6%","2026-01-02","1.952","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","84.7%","2026-02-10","6.002","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":745},{"label":"Mar","value":755},{"label":"Abr","value":760},{"label":"Mai","value":818},{"label":"Jun","value":855},{"label":"Jul","value":667},{"label":"Ago","value":828},{"label":"Set","value":839},{"label":"Out","value":972},{"label":"Nov","value":817},{"label":"Dez","value":848}];
const MX = 972;
