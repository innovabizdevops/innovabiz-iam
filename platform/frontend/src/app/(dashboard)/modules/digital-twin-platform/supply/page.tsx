...
const PAGE = "Supply Chain DT";
const KPIS = [{"l":"Twins Ativos","v":"7.987","t":"+9.4%","d":"up"},{"l":"Simulações/Dia","v":"3394","t":"-0.9%","d":"down"},{"l":"Precisão Modelo (%)","v":"92.0%","t":"+16.9%","d":"up"},{"l":"Latência Sync (ms)","v":"17ms","t":"-4.7%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","83.2%","2026-01-03","4.688","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","76.9%","2026-03-04","4.199","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","79.3%","2026-02-06","6.155","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","89.4%","2026-03-02","6.749","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","72.2%","2026-01-08","6.941","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":865},{"label":"Mar","value":827},{"label":"Abr","value":1017},{"label":"Mai","value":734},{"label":"Jun","value":931},{"label":"Jul","value":814},{"label":"Ago","value":1030},{"label":"Set","value":686},{"label":"Out","value":1016},{"label":"Nov","value":789},{"label":"Dez","value":860}];
const MX = 1030;
