...
const PAGE = "Data Sync";
const KPIS = [{"l":"Twins Ativos","v":"8.022","t":"-0.1%","d":"down"},{"l":"Simulações/Dia","v":"1708","t":"+1.3%","d":"up"},{"l":"Precisão Modelo (%)","v":"68.9%","t":"-4.6%","d":"down"},{"l":"Latência Sync (ms)","v":"72ms","t":"+4.8%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","85.4%","2026-02-13","1.540","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","87.4%","2026-02-07","1.461","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","90.6%","2026-03-03","6.281","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","94.7%","2026-01-26","8.907","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","82.5%","2026-03-04","1.147","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":532},{"label":"Mar","value":774},{"label":"Abr","value":873},{"label":"Mai","value":696},{"label":"Jun","value":823},{"label":"Jul","value":837},{"label":"Ago","value":506},{"label":"Set","value":601},{"label":"Out","value":783},{"label":"Nov","value":829},{"label":"Dez","value":526}];
const MX = 873;
