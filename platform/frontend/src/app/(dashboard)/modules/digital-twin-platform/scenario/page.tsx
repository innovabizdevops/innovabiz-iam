...
const PAGE = "Scenario Plan";
const KPIS = [{"l":"Twins Ativos","v":"6.067","t":"+8.8%","d":"up"},{"l":"Simulações/Dia","v":"3096","t":"-2.1%","d":"down"},{"l":"Precisão Modelo (%)","v":"88.7%","t":"+4.7%","d":"up"},{"l":"Latência Sync (ms)","v":"104ms","t":"+10.7%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","81.9%","2026-01-17","6.718","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","97.4%","2026-01-08","784","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","77.1%","2026-01-05","7.801","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","89.7%","2026-02-02","3.295","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","86.1%","2026-01-21","7.173","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":924},{"label":"Mar","value":614},{"label":"Abr","value":690},{"label":"Mai","value":612},{"label":"Jun","value":932},{"label":"Jul","value":773},{"label":"Ago","value":791},{"label":"Set","value":834},{"label":"Out","value":733},{"label":"Nov","value":867},{"label":"Dez","value":734}];
const MX = 932;
