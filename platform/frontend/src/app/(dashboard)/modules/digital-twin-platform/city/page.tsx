...
const PAGE = "City Scale";
const KPIS = [{"l":"Twins Ativos","v":"5.544","t":"+13.3%","d":"up"},{"l":"Simulações/Dia","v":"1071","t":"+3.5%","d":"up"},{"l":"Precisão Modelo (%)","v":"80.0%","t":"-4.0%","d":"down"},{"l":"Latência Sync (ms)","v":"172ms","t":"+12.8%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","87.3%","2026-01-20","5.533","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","76.0%","2026-02-03","1.511","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","95.3%","2026-01-21","7.013","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","92.1%","2026-01-22","340","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","75.0%","2026-03-14","7.719","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":714},{"label":"Mar","value":745},{"label":"Abr","value":575},{"label":"Mai","value":756},{"label":"Jun","value":536},{"label":"Jul","value":765},{"label":"Ago","value":440},{"label":"Set","value":493},{"label":"Out","value":723},{"label":"Nov","value":655},{"label":"Dez","value":477}];
const MX = 765;
