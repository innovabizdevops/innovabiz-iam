...
const PAGE = "Insight Engine";
const KPIS = [{"l":"Twins Ativos","v":"4.203","t":"-0.3%","d":"down"},{"l":"Simulações/Dia","v":"2504","t":"+6.0%","d":"up"},{"l":"Precisão Modelo (%)","v":"69.3%","t":"-5.6%","d":"down"},{"l":"Latência Sync (ms)","v":"191ms","t":"+0.2%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","89.2%","2026-01-19","7.612","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","93.3%","2026-01-17","3.921","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","82.0%","2026-03-27","247","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","82.8%","2026-01-19","7.763","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","75.5%","2026-02-06","2.388","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":644},{"label":"Mar","value":529},{"label":"Abr","value":409},{"label":"Mai","value":645},{"label":"Jun","value":652},{"label":"Jul","value":712},{"label":"Ago","value":574},{"label":"Set","value":744},{"label":"Out","value":754},{"label":"Nov","value":760},{"label":"Dez","value":751}];
const MX = 760;
