...
/* ═══ S-AI Key Management — Dashboard ═══ */

const ACCENT = "#991b1b";

const KPIS = [
    { label: "Total Registos", value: "5352", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2932", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€450K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "869373752", cells: ["SAI-1752", "S-AI Key Management Item 1", "17/9/2026", "€23 852"], status: "active" as const },
    { id: "869377323", cells: ["SAI-5323", "S-AI Key Management Item 2", "4/4/2026", "€27 423"], status: "pending" as const },
    { id: "869380894", cells: ["SAI-8894", "S-AI Key Management Item 3", "19/11/2026", "€30 994"], status: "completed" as const },
    { id: "869384465", cells: ["SAI-3465", "S-AI Key Management Item 4", "6/6/2026", "€34 565"], status: "warning" as const },
    { id: "869388036", cells: ["SAI-7036", "S-AI Key Management Item 5", "21/1/2026", "€38 136"], status: "active" as const },
];
...
export default function SaiKeyManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">S-AI Key Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • S-AI Key Management</p>
                    </div>
                </div>
