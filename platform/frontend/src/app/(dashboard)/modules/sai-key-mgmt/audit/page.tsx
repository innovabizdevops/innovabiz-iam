...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.828","t":"+13.1%","d":"up"},{"l":"NC Abertas","v":"7.572","t":"-2.0%","d":"down"},{"l":"Conformidade (%)","v":"81.9%","t":"-3.6%","d":"down"},{"l":"CAPAs Pendentes","v":"5.764","t":"-4.5%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.435","70.2%","7.295","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.613","87.9%","2.375","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.098","88.6%","6.667","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.782","76.3%","6.330","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.150","74.6%","5.207","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":504},{"label":"Mar","value":440},{"label":"Abr","value":489},{"label":"Mai","value":492},{"label":"Jun","value":733},{"label":"Jul","value":375},{"label":"Ago","value":744},{"label":"Set","value":467},{"label":"Out","value":402},{"label":"Nov","value":734},{"label":"Dez","value":533}];
const MX = 744;
