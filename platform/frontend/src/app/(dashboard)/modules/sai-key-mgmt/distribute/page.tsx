...
const ACCENT = "#991b1b";
const MODULE = "S-AI Key Management";
const PAGE = "Distribute";
const KPIS = [{"l":"Total Sai Key Mgmt","v":"7.822","t":"+15.0%","d":"up"},{"l":"Distribute Ativos","v":"6.172","t":"+10.5%","d":"up"},{"l":"Eficiência (%)","v":"70.8%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"90","t":"+6.7%","d":"up"}];
const COLS = ["ID","Distribute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sai Key Mgmt #001","Sai Key Mgmt #002","6.984","832","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Sai Key Mgmt #002","Sai Key Mgmt #003","3.086","5.713","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Sai Key Mgmt #003","Sai Key Mgmt #004","741","786","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Sai Key Mgmt #004","Sai Key Mgmt #005","1.549","1.962","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sai Key Mgmt #005","Sai Key Mgmt #001","2.456","619","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":737},{"label":"Fev","value":605},{"label":"Mar","value":436},{"label":"Abr","value":413},{"label":"Mai","value":423},{"label":"Jun","value":363},{"label":"Jul","value":541},{"label":"Ago","value":406},{"label":"Set","value":636},{"label":"Out","value":554},{"label":"Nov","value":600},{"label":"Dez","value":466}];
const MX = 737;
