...
const PAGE = "Rotate";
const KPIS = [{"l":"Total Sai Key Mgmt","v":"4.822","t":"+7.6%","d":"up"},{"l":"Rotate Ativos","v":"2.786","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"70.0%","t":"+1.7%","d":"up"},{"l":"Score Performance","v":"81","t":"-5.7%","d":"down"}];
const COLS = ["ID","Rotate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sai Key Mgmt #001","Sai Key Mgmt #002","6.233","7.265","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Sai Key Mgmt #002","Sai Key Mgmt #003","6.567","5.957","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Sai Key Mgmt #003","Sai Key Mgmt #004","619","3.048","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Sai Key Mgmt #004","Sai Key Mgmt #005","706","746","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sai Key Mgmt #005","Sai Key Mgmt #001","3.740","2.531","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":867},{"label":"Fev","value":908},{"label":"Mar","value":1002},{"label":"Abr","value":650},{"label":"Mai","value":860},{"label":"Jun","value":718},{"label":"Jul","value":770},{"label":"Ago","value":719},{"label":"Set","value":999},{"label":"Out","value":897},{"label":"Nov","value":658},{"label":"Dez","value":894}];
const MX = 1002;
