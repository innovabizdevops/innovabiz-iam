...
const PAGE = "Generate";
const KPIS = [{"l":"Total Sai Key Mgmt","v":"1.636","t":"+2.2%","d":"up"},{"l":"Generate Ativos","v":"7.215","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"90.0%","t":"+10.5%","d":"up"},{"l":"Score Performance","v":"59","t":"+5.5%","d":"up"}];
const COLS = ["ID","Generate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sai Key Mgmt #001","Sai Key Mgmt #002","2.270","4.616","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Sai Key Mgmt #002","Sai Key Mgmt #003","4.107","2.416","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Sai Key Mgmt #003","Sai Key Mgmt #004","4.714","7.367","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Sai Key Mgmt #004","Sai Key Mgmt #005","5.060","4.538","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sai Key Mgmt #005","Sai Key Mgmt #001","2.816","7.557","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":619},{"label":"Mar","value":551},{"label":"Abr","value":545},{"label":"Mai","value":655},{"label":"Jun","value":850},{"label":"Jul","value":832},{"label":"Ago","value":614},{"label":"Set","value":721},{"label":"Out","value":550},{"label":"Nov","value":744},{"label":"Dez","value":485}];
const MX = 850;
