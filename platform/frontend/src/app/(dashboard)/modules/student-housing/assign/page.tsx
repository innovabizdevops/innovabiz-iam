...
const ACCENT = "#6366f1";
const MODULE = "Student Housing";
const PAGE = "Assignment";
const KPIS = [{"l":"Total Student Housing","v":"5.634","t":"-1.0%","d":"down"},{"l":"Assignment Ativos","v":"1.339","t":"+14.8%","d":"up"},{"l":"Eficiência (%)","v":"90.3%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"83","t":"+3.9%","d":"up"}];
const COLS = ["ID","Assignment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Student Housing #001","Student Housing #002","1.980","3.197","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Student Housing #002","Student Housing #003","8.359","5.117","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Student Housing #003","Student Housing #004","3.567","3.955","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Student Housing #004","Student Housing #005","6.452","8.579","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Student Housing #005","Student Housing #001","6.120","1.655","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":786},{"label":"Fev","value":922},{"label":"Mar","value":861},{"label":"Abr","value":712},{"label":"Mai","value":1026},{"label":"Jun","value":951},{"label":"Jul","value":1031},{"label":"Ago","value":770},{"label":"Set","value":1036},{"label":"Out","value":908},{"label":"Nov","value":1000},{"label":"Dez","value":706}];
const MX = 1036;
