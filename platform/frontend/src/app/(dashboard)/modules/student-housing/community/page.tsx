...
const KPIS = [{"l":"Projetos Sociais","v":"4.150","t":"+16.2%","d":"up"},{"l":"Beneficiários","v":"2.570","t":"+0.6%","d":"up"},{"l":"Investimento CSR (€)","v":"€14700","t":"-1.7%","d":"down"},{"l":"Score Impacto","v":"87","t":"+1.3%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","5.433","€ 7679.79","8.659","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","3.109","€ 43371.17","235","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","8.495","€ 40777.22","8.043","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","2.969","€ 22238.63","4.257","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","8.448","€ 46431.12","6.919","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":480},{"label":"Mar","value":639},{"label":"Abr","value":514},{"label":"Mai","value":507},{"label":"Jun","value":359},{"label":"Jul","value":349},{"label":"Ago","value":697},{"label":"Set","value":560},{"label":"Out","value":622},{"label":"Nov","value":361},{"label":"Dez","value":681}];
const MX = 697;
