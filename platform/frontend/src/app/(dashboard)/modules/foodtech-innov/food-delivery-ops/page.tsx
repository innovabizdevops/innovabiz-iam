...
/* ═══ FoodTech Innovation — Food Delivery Ops ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "3225", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "66", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2335", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1275961070", cells: ["FOO-5070", "Food Delivery Ops Item 1", "7/3/2026", "€11 170"], status: "active" as const },
    { id: "1275964641", cells: ["FOO-8641", "Food Delivery Ops Item 2", "22/10/2026", "€14 741"], status: "pending" as const },
    { id: "1275968212", cells: ["FOO-3212", "Food Delivery Ops Item 3", "9/5/2026", "€18 312"], status: "completed" as const },
    { id: "1275971783", cells: ["FOO-6783", "Food Delivery Ops Item 4", "24/12/2026", "€21 883"], status: "warning" as const },
    { id: "1275975354", cells: ["FOO-1354", "Food Delivery Ops Item 5", "11/7/2026", "€25 454"], status: "active" as const },
];
...
export default function FoodtechInnovationFoodDeliveryOpsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Food Delivery Ops</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FoodTech Innovation • Food Delivery Ops</p>
                    </div>
                </div>
