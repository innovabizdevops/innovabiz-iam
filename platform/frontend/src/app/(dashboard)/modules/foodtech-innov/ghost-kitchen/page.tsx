...
/* ═══ FoodTech Innovation — Ghost Kitchen ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "361", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "439", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "525", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "301201411", cells: ["FOO-8411", "Ghost Kitchen Item 1", "8/8/2026", "€1511"], status: "active" as const },
    { id: "301204982", cells: ["FOO-2982", "Ghost Kitchen Item 2", "23/3/2026", "€5082"], status: "pending" as const },
    { id: "301208553", cells: ["FOO-6553", "Ghost Kitchen Item 3", "10/10/2026", "€8653"], status: "completed" as const },
    { id: "301212124", cells: ["FOO-1124", "Ghost Kitchen Item 4", "25/5/2026", "€12 224"], status: "warning" as const },
    { id: "301215695", cells: ["FOO-4695", "Ghost Kitchen Item 5", "12/12/2026", "€15 795"], status: "active" as const },
];
...
export default function FoodtechInnovationGhostKitchenPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ghost Kitchen</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FoodTech Innovation • Ghost Kitchen</p>
                    </div>
                </div>
