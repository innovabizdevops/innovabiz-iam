...
/* ═══ FoodTech Innovation — Alt Protein ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "2737", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "42", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "944", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "442898294", cells: ["FOO-9294", "Alt Protein Item 1", "7/3/2026", "€48 394"], status: "active" as const },
    { id: "442901865", cells: ["FOO-3865", "Alt Protein Item 2", "22/10/2026", "€1965"], status: "pending" as const },
    { id: "442905436", cells: ["FOO-7436", "Alt Protein Item 3", "9/5/2026", "€5536"], status: "completed" as const },
    { id: "442909007", cells: ["FOO-2007", "Alt Protein Item 4", "24/12/2026", "€9107"], status: "warning" as const },
    { id: "442912578", cells: ["FOO-5578", "Alt Protein Item 5", "11/7/2026", "€12 678"], status: "active" as const },
];
...
export default function FoodtechInnovationAltProteinPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Alt Protein</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FoodTech Innovation • Alt Protein</p>
                    </div>
                </div>
