...
/* ═══ FoodTech Innovation — Vertical Farm ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "1128", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "90", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3510", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "522936374", cells: ["FOO-1374", "Vertical Farm Item 1", "3/3/2026", "€36 474"], status: "active" as const },
    { id: "522939945", cells: ["FOO-4945", "Vertical Farm Item 2", "18/10/2026", "€40 045"], status: "pending" as const },
    { id: "522943516", cells: ["FOO-8516", "Vertical Farm Item 3", "5/5/2026", "€43 616"], status: "completed" as const },
    { id: "522947087", cells: ["FOO-3087", "Vertical Farm Item 4", "20/12/2026", "€47 187"], status: "warning" as const },
    { id: "522950658", cells: ["FOO-6658", "Vertical Farm Item 5", "7/7/2026", "€758"], status: "active" as const },
];
...
export default function FoodtechInnovationVerticalFarmPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Vertical Farm</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FoodTech Innovation • Vertical Farm</p>
                    </div>
                </div>
