...
/* ═══ FoodTech Innovation — Precision Ferment ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "1408", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "317", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2067", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "84%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "967157177", cells: ["FOO-9177", "Precision Ferment Item 1", "22/6/2026", "€7277"], status: "active" as const },
    { id: "967160748", cells: ["FOO-3748", "Precision Ferment Item 2", "9/1/2026", "€10 848"], status: "pending" as const },
    { id: "967164319", cells: ["FOO-7319", "Precision Ferment Item 3", "24/8/2026", "€14 419"], status: "completed" as const },
    { id: "967167890", cells: ["FOO-1890", "Precision Ferment Item 4", "11/3/2026", "€17 990"], status: "warning" as const },
    { id: "967171461", cells: ["FOO-5461", "Precision Ferment Item 5", "26/10/2026", "€21 561"], status: "active" as const },
];
...
export default function FoodtechInnovationPrecisionFermentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Precision Ferment</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FoodTech Innovation • Precision Ferment</p>
                    </div>
                </div>
