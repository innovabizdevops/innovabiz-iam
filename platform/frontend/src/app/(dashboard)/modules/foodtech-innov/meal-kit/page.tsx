...
/* ═══ FoodTech Innovation — Meal Kit ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "143", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "389", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1025", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1521705585", cells: ["FOO-4585", "Meal Kit Item 1", "2/10/2026", "€5685"], status: "active" as const },
    { id: "1521709156", cells: ["FOO-8156", "Meal Kit Item 2", "17/5/2026", "€9256"], status: "pending" as const },
    { id: "1521712727", cells: ["FOO-2727", "Meal Kit Item 3", "4/12/2026", "€12 827"], status: "completed" as const },
    { id: "1521716298", cells: ["FOO-6298", "Meal Kit Item 4", "19/7/2026", "€16 398"], status: "warning" as const },
    { id: "1521719869", cells: ["FOO-9869", "Meal Kit Item 5", "6/2/2026", "€19 969"], status: "active" as const },
];
...
export default function FoodtechInnovationMealKitPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Meal Kit</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FoodTech Innovation • Meal Kit</p>
                    </div>
                </div>
