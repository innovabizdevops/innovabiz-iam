...
/* ═══ FoodTech Innovation — Cultivated Meat ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "3416", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "408", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3553", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1413172868", cells: ["FOO-2868", "Cultivated Meat Item 1", "17/9/2026", "€22 968"], status: "active" as const },
    { id: "1413176439", cells: ["FOO-6439", "Cultivated Meat Item 2", "4/4/2026", "€26 539"], status: "pending" as const },
    { id: "1413180010", cells: ["FOO-1010", "Cultivated Meat Item 3", "19/11/2026", "€30 110"], status: "completed" as const },
    { id: "1413183581", cells: ["FOO-4581", "Cultivated Meat Item 4", "6/6/2026", "€33 681"], status: "warning" as const },
    { id: "1413187152", cells: ["FOO-8152", "Cultivated Meat Item 5", "21/1/2026", "€37 252"], status: "active" as const },
];
...
export default function FoodtechInnovationCultivatedMeatPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cultivated Meat</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FoodTech Innovation • Cultivated Meat</p>
                    </div>
                </div>
