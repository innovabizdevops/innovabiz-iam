...
/* ═══ FoodTech Innovation — Smart Kitchen ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "1361", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "427", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3927", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "702372151", cells: ["FOO-4151", "Smart Kitchen Item 1", "20/8/2026", "€22 251"], status: "active" as const },
    { id: "702375722", cells: ["FOO-7722", "Smart Kitchen Item 2", "7/3/2026", "€25 822"], status: "pending" as const },
    { id: "702379293", cells: ["FOO-2293", "Smart Kitchen Item 3", "22/10/2026", "€29 393"], status: "completed" as const },
    { id: "702382864", cells: ["FOO-5864", "Smart Kitchen Item 4", "9/5/2026", "€32 964"], status: "warning" as const },
    { id: "702386435", cells: ["FOO-9435", "Smart Kitchen Item 5", "24/12/2026", "€36 535"], status: "active" as const },
];
...
export default function FoodtechInnovationSmartKitchenPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Smart Kitchen</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FoodTech Innovation • Smart Kitchen</p>
                    </div>
                </div>
