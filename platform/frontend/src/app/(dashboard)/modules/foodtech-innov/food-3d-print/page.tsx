...
/* ═══ FoodTech Innovation — Food 3d Print ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "1786", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "74", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2036", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1605477686", cells: ["FOO-4686", "Food 3d Print Item 1", "23/3/2026", "€27 786"], status: "active" as const },
    { id: "1605481257", cells: ["FOO-8257", "Food 3d Print Item 2", "10/10/2026", "€31 357"], status: "pending" as const },
    { id: "1605484828", cells: ["FOO-2828", "Food 3d Print Item 3", "25/5/2026", "€34 928"], status: "completed" as const },
    { id: "1605488399", cells: ["FOO-6399", "Food 3d Print Item 4", "12/12/2026", "€38 499"], status: "warning" as const },
    { id: "1605491970", cells: ["FOO-9970", "Food 3d Print Item 5", "27/7/2026", "€42 070"], status: "active" as const },
];
...
export default function FoodtechInnovationFood3dPrintPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Food 3d Print</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FoodTech Innovation • Food 3d Print</p>
                    </div>
                </div>
