...
/* ═══ FoodTech Innovation — Insect Protein ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "981", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "483", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3049", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "166595487", cells: ["FOO-6487", "Insect Protein Item 1", "24/4/2026", "€45 587"], status: "active" as const },
    { id: "166599058", cells: ["FOO-1058", "Insect Protein Item 2", "11/11/2026", "€49 158"], status: "pending" as const },
    { id: "166602629", cells: ["FOO-4629", "Insect Protein Item 3", "26/6/2026", "€2729"], status: "completed" as const },
    { id: "166606200", cells: ["FOO-8200", "Insect Protein Item 4", "13/1/2026", "€6300"], status: "warning" as const },
    { id: "166609771", cells: ["FOO-2771", "Insect Protein Item 5", "28/8/2026", "€9871"], status: "active" as const },
];
...
export default function FoodtechInnovationInsectProteinPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Insect Protein</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FoodTech Innovation • Insect Protein</p>
                    </div>
                </div>
