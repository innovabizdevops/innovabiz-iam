...
const PAGE = "Service Channels";
const KPIS = [{"l":"Tickets Abertos","v":"810","t":"+11.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"88.6%","t":"+1.9%","d":"up"},{"l":"MTTR (h)","v":"208h","t":"-4.9%","d":"down"},{"l":"Satisfação (%)","v":"81.0%","t":"-3.7%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.063","2.029","4.666","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.035","4.156","1.036","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.628","7.491","3.346","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.974","8.312","6.382","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.025","5.040","8.828","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":930},{"label":"Fev","value":950},{"label":"Mar","value":912},{"label":"Abr","value":842},{"label":"Mai","value":804},{"label":"Jun","value":882},{"label":"Jul","value":1029},{"label":"Ago","value":971},{"label":"Set","value":998},{"label":"Out","value":935},{"label":"Nov","value":863},{"label":"Dez","value":1084}];
const MX = 1084;
