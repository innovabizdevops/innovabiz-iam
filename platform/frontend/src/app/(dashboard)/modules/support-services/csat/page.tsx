...
const PAGE = "CSAT &amp; NPS";
const KPIS = [{"l":"Tickets Abertos","v":"2.108","t":"-3.9%","d":"down"},{"l":"SLA Cumprido (%)","v":"70.2%","t":"+1.7%","d":"up"},{"l":"MTTR (h)","v":"46h","t":"+9.9%","d":"up"},{"l":"Satisfação (%)","v":"93.4%","t":"+16.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.965","5.072","7.380","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.057","3.399","3.392","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.598","8.606","5.075","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.504","943","701","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.594","3.848","4.439","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":720},{"label":"Mar","value":1050},{"label":"Abr","value":739},{"label":"Mai","value":773},{"label":"Jun","value":774},{"label":"Jul","value":809},{"label":"Ago","value":1065},{"label":"Set","value":1014},{"label":"Out","value":1014},{"label":"Nov","value":1043},{"label":"Dez","value":807}];
const MX = 1065;
