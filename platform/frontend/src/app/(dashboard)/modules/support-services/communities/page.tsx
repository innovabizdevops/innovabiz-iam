...
const PAGE = "Communities";
const KPIS = [{"l":"Tickets Abertos","v":"2.060","t":"+11.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"70.7%","t":"+12.4%","d":"up"},{"l":"MTTR (h)","v":"66h","t":"+4.2%","d":"up"},{"l":"Satisfação (%)","v":"90.1%","t":"+2.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","161","1.130","6.364","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.412","1.370","2.126","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.310","274","7.381","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.909","3.038","7.674","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.680","8.919","3.844","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":325},{"label":"Mar","value":353},{"label":"Abr","value":389},{"label":"Mai","value":584},{"label":"Jun","value":581},{"label":"Jul","value":573},{"label":"Ago","value":693},{"label":"Set","value":478},{"label":"Out","value":614},{"label":"Nov","value":369},{"label":"Dez","value":505}];
const MX = 693;
