...
const PAGE = "Remote Support";
const KPIS = [{"l":"Tickets Abertos","v":"1.521","t":"+1.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"67.5%","t":"-1.5%","d":"down"},{"l":"MTTR (h)","v":"182h","t":"-0.7%","d":"down"},{"l":"Satisfação (%)","v":"74.1%","t":"-5.4%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.074","7.944","7.094","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","270","3.064","179","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.599","4.880","8.673","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.727","2.151","1.261","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.858","405","4.919","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":749},{"label":"Fev","value":761},{"label":"Mar","value":754},{"label":"Abr","value":563},{"label":"Mai","value":718},{"label":"Jun","value":810},{"label":"Jul","value":498},{"label":"Ago","value":725},{"label":"Set","value":537},{"label":"Out","value":744},{"label":"Nov","value":624},{"label":"Dez","value":639}];
const MX = 810;
