...
const PAGE = "Warranty Claims";
const KPIS = [{"l":"Tickets Abertos","v":"7.510","t":"+15.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"81.1%","t":"+12.7%","d":"up"},{"l":"MTTR (h)","v":"51h","t":"+9.1%","d":"up"},{"l":"Satisfação (%)","v":"73.9%","t":"+8.7%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.389","8.101","6.632","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.659","5.785","9.047","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.610","6.801","6.126","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.365","4.788","6.044","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.837","4.903","1.223","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":804},{"label":"Mar","value":490},{"label":"Abr","value":634},{"label":"Mai","value":733},{"label":"Jun","value":702},{"label":"Jul","value":738},{"label":"Ago","value":799},{"label":"Set","value":738},{"label":"Out","value":676},{"label":"Nov","value":778},{"label":"Dez","value":476}];
const MX = 804;
