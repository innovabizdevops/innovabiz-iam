...
const KPIS = [{"l":"Tickets Abertos","v":"8.808","t":"+12.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"68.0%","t":"+14.5%","d":"up"},{"l":"MTTR (h)","v":"148h","t":"+1.3%","d":"up"},{"l":"Satisfação (%)","v":"91.9%","t":"+9.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.464","2.986","1.979","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.175","4.892","3.644","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.280","6.167","8.116","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.169","219","7.189","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.712","6.935","6.614","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":586},{"label":"Mar","value":766},{"label":"Abr","value":692},{"label":"Mai","value":453},{"label":"Jun","value":591},{"label":"Jul","value":563},{"label":"Ago","value":554},{"label":"Set","value":620},{"label":"Out","value":655},{"label":"Nov","value":490},{"label":"Dez","value":645}];
const MX = 805;
