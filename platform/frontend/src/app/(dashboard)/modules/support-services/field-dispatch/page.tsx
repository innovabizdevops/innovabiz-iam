...
const PAGE = "Field Dispatch";
const KPIS = [{"l":"Tickets Abertos","v":"2.128","t":"+14.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"79.7%","t":"-4.5%","d":"down"},{"l":"MTTR (h)","v":"119h","t":"+8.6%","d":"up"},{"l":"Satisfação (%)","v":"69.4%","t":"+13.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.783","3.853","8.252","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.871","371","473","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.385","6.860","8.538","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","198","8.586","2.318","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.683","6.184","2.595","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":982},{"label":"Fev","value":1056},{"label":"Mar","value":764},{"label":"Abr","value":963},{"label":"Mai","value":984},{"label":"Jun","value":784},{"label":"Jul","value":757},{"label":"Ago","value":819},{"label":"Set","value":879},{"label":"Out","value":1006},{"label":"Nov","value":998},{"label":"Dez","value":953}];
const MX = 1056;
