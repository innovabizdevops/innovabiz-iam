...
const PAGE = "Virtual Agent Builder";
const KPIS = [{"l":"Tickets Abertos","v":"7.514","t":"-3.1%","d":"down"},{"l":"SLA Cumprido (%)","v":"74.5%","t":"-2.8%","d":"down"},{"l":"MTTR (h)","v":"164h","t":"-6.0%","d":"down"},{"l":"Satisfação (%)","v":"91.1%","t":"+3.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","367","2.699","380","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.295","4.871","8.325","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.902","3.242","4.356","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.814","1.437","6.444","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.361","4.746","958","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":875},{"label":"Mar","value":652},{"label":"Abr","value":602},{"label":"Mai","value":688},{"label":"Jun","value":691},{"label":"Jul","value":600},{"label":"Ago","value":845},{"label":"Set","value":782},{"label":"Out","value":882},{"label":"Nov","value":717},{"label":"Dez","value":540}];
const MX = 882;
