...
const PAGE = "Sentiment Analysis AI";
const KPIS = [{"l":"Tickets Abertos","v":"8.381","t":"+15.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"91.5%","t":"+13.5%","d":"up"},{"l":"MTTR (h)","v":"90h","t":"+12.0%","d":"up"},{"l":"Satisfação (%)","v":"86.1%","t":"+15.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","356","6.858","1.111","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.335","8.606","6.197","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.017","2.643","1.139","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.091","2.173","7.889","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","764","5.434","5.156","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":234},{"label":"Fev","value":231},{"label":"Mar","value":608},{"label":"Abr","value":518},{"label":"Mai","value":262},{"label":"Jun","value":412},{"label":"Jul","value":389},{"label":"Ago","value":535},{"label":"Set","value":530},{"label":"Out","value":327},{"label":"Nov","value":229},{"label":"Dez","value":459}];
const MX = 608;
