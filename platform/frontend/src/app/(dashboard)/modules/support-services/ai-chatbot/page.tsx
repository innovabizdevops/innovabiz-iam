...
const PAGE = "AI Chatbot";
const KPIS = [{"l":"Tickets Abertos","v":"6.928","t":"+13.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"80.9%","t":"-5.9%","d":"down"},{"l":"MTTR (h)","v":"147h","t":"-0.2%","d":"down"},{"l":"Satisfação (%)","v":"87.5%","t":"+17.2%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","881","2.363","6.778","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","605","5.920","3.904","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.214","7.852","8.091","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.408","6.209","474","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","9.092","2.989","1.849","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":441},{"label":"Mar","value":489},{"label":"Abr","value":491},{"label":"Mai","value":527},{"label":"Jun","value":552},{"label":"Jul","value":493},{"label":"Ago","value":392},{"label":"Set","value":726},{"label":"Out","value":696},{"label":"Nov","value":596},{"label":"Dez","value":761}];
const MX = 761;
