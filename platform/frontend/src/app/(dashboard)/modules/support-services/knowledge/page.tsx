...
const PAGE = "Self-Service &amp; AI";
const KPIS = [{"l":"Tickets Abertos","v":"5.910","t":"-0.5%","d":"down"},{"l":"SLA Cumprido (%)","v":"72.6%","t":"+7.4%","d":"up"},{"l":"MTTR (h)","v":"123h","t":"+15.2%","d":"up"},{"l":"Satisfação (%)","v":"75.2%","t":"+10.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.710","6.861","7.696","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.160","1.754","7.154","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","485","3.223","1.439","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.551","2.597","2.772","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.742","1.916","7.546","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":474},{"label":"Fev","value":491},{"label":"Mar","value":721},{"label":"Abr","value":675},{"label":"Mai","value":360},{"label":"Jun","value":556},{"label":"Jul","value":591},{"label":"Ago","value":531},{"label":"Set","value":529},{"label":"Out","value":668},{"label":"Nov","value":694},{"label":"Dez","value":684}];
const MX = 721;
