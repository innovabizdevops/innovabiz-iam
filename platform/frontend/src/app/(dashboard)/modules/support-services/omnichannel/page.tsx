...
const PAGE = "Omnichannel Routing";
const KPIS = [{"l":"Tickets Abertos","v":"248","t":"-4.7%","d":"down"},{"l":"SLA Cumprido (%)","v":"78.7%","t":"+7.6%","d":"up"},{"l":"MTTR (h)","v":"142h","t":"+17.7%","d":"up"},{"l":"Satisfação (%)","v":"80.0%","t":"-1.1%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.051","6.416","1.000","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.151","6.900","1.843","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.399","5.983","7.737","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.819","8.468","4.562","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.164","5.808","1.411","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":818},{"label":"Fev","value":762},{"label":"Mar","value":656},{"label":"Abr","value":992},{"label":"Mai","value":806},{"label":"Jun","value":810},{"label":"Jul","value":872},{"label":"Ago","value":763},{"label":"Set","value":1004},{"label":"Out","value":964},{"label":"Nov","value":839},{"label":"Dez","value":974}];
const MX = 1004;
