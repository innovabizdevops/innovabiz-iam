...
const KPIS = [{"l":"Tickets Abertos","v":"1.511","t":"+1.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"93.9%","t":"+5.7%","d":"up"},{"l":"MTTR (h)","v":"46h","t":"+16.0%","d":"up"},{"l":"Satisfação (%)","v":"74.8%","t":"+10.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.993","5.553","8.900","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.179","1.238","7.335","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.987","7.734","6.557","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.126","7.321","6.585","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","108","6.442","5.820","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":561},{"label":"Mar","value":782},{"label":"Abr","value":540},{"label":"Mai","value":674},{"label":"Jun","value":669},{"label":"Jul","value":625},{"label":"Ago","value":751},{"label":"Set","value":544},{"label":"Out","value":821},{"label":"Nov","value":532},{"label":"Dez","value":602}];
const MX = 821;
...
export default function KnowledgeSupportPage() {
    return (
