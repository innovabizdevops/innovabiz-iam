...
const PAGE = "Self-Service Portal";
const KPIS = [{"l":"Tickets Abertos","v":"7.359","t":"+11.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"68.0%","t":"+17.0%","d":"up"},{"l":"MTTR (h)","v":"127h","t":"+10.1%","d":"up"},{"l":"Satisfação (%)","v":"77.0%","t":"+14.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.479","3.248","6.372","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.927","2.649","7.337","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.185","8.917","6.843","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.048","4.009","6.733","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.278","2.576","870","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":381},{"label":"Mar","value":529},{"label":"Abr","value":656},{"label":"Mai","value":468},{"label":"Jun","value":375},{"label":"Jul","value":438},{"label":"Ago","value":319},{"label":"Set","value":492},{"label":"Out","value":490},{"label":"Nov","value":266},{"label":"Dez","value":269}];
const MX = 656;
...
export default function SelfServiceSupportPage() {
    return (
