...
const PAGE = "Chatbot Builder AI";
const KPIS = [{"l":"Tickets Abertos","v":"5.021","t":"+7.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"74.4%","t":"+16.3%","d":"up"},{"l":"MTTR (h)","v":"127h","t":"-0.1%","d":"down"},{"l":"Satisfação (%)","v":"93.4%","t":"-1.5%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.183","7.182","5.500","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.199","3.515","498","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.208","4.688","7.198","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.205","1.555","2.250","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.637","325","1.553","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":633},{"label":"Mar","value":304},{"label":"Abr","value":373},{"label":"Mai","value":407},{"label":"Jun","value":396},{"label":"Jul","value":348},{"label":"Ago","value":596},{"label":"Set","value":324},{"label":"Out","value":392},{"label":"Nov","value":335},{"label":"Dez","value":451}];
const MX = 633;
