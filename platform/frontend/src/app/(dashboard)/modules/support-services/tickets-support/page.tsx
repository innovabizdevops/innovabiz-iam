...
const PAGE = "Tickets";
const KPIS = [{"l":"Tickets Abertos","v":"1.967","t":"+0.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"75.4%","t":"+8.2%","d":"up"},{"l":"MTTR (h)","v":"50h","t":"+9.5%","d":"up"},{"l":"Satisfação (%)","v":"76.8%","t":"+11.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.545","3.618","6.216","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.264","919","6.605","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.429","7.797","5.988","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.947","8.556","7.957","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.781","2.320","856","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":901},{"label":"Mar","value":887},{"label":"Abr","value":866},{"label":"Mai","value":946},{"label":"Jun","value":879},{"label":"Jul","value":888},{"label":"Ago","value":917},{"label":"Set","value":917},{"label":"Out","value":834},{"label":"Nov","value":881},{"label":"Dez","value":611}];
const MX = 946;
