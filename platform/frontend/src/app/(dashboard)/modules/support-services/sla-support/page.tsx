...
const KPIS = [{"l":"Tickets Abertos","v":"6.543","t":"+5.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"73.1%","t":"+1.6%","d":"up"},{"l":"MTTR (h)","v":"93h","t":"+8.4%","d":"up"},{"l":"Satisfação (%)","v":"75.5%","t":"-4.0%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.855","6.577","7.884","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.822","4.776","6.594","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.995","380","4.235","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","709","2.152","6.743","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","9.073","7.362","5.181","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":641},{"label":"Mar","value":629},{"label":"Abr","value":565},{"label":"Mai","value":408},{"label":"Jun","value":366},{"label":"Jul","value":558},{"label":"Ago","value":525},{"label":"Set","value":667},{"label":"Out","value":687},{"label":"Nov","value":315},{"label":"Dez","value":564}];
const MX = 687;
