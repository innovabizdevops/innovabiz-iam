...
const ACCENT = "#6366f1";
const MODULE = "Support Services";
const PAGE = "Case Swarm";
const KPIS = [{"l":"Tickets Abertos","v":"4.531","t":"+10.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"72.3%","t":"-4.9%","d":"down"},{"l":"MTTR (h)","v":"66h","t":"-1.6%","d":"down"},{"l":"Satisfação (%)","v":"66.8%","t":"+10.2%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.495","2.057","4.742","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.721","7.712","1.723","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.998","1.381","2.472","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.590","5.467","2.496","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.494","7.459","999","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":797},{"label":"Fev","value":647},{"label":"Mar","value":968},{"label":"Abr","value":850},{"label":"Mai","value":936},{"label":"Jun","value":917},{"label":"Jul","value":866},{"label":"Ago","value":943},{"label":"Set","value":963},{"label":"Out","value":800},{"label":"Nov","value":810},{"label":"Dez","value":691}];
const MX = 968;
...
export default function CaseSwarmPage() {
    return (
