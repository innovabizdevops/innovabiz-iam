...
const PAGE = "Proactive Service";
const KPIS = [{"l":"Tickets Abertos","v":"5.554","t":"+11.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"85.6%","t":"+9.2%","d":"up"},{"l":"MTTR (h)","v":"103h","t":"+9.3%","d":"up"},{"l":"Satisfação (%)","v":"87.4%","t":"-4.1%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.625","6.938","4.244","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.401","1.423","2.437","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.731","7.483","3.965","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.408","7.344","1.669","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.376","1.457","3.928","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":843},{"label":"Fev","value":804},{"label":"Mar","value":813},{"label":"Abr","value":850},{"label":"Mai","value":657},{"label":"Jun","value":924},{"label":"Jul","value":940},{"label":"Ago","value":1011},{"label":"Set","value":838},{"label":"Out","value":935},{"label":"Nov","value":815},{"label":"Dez","value":913}];
const MX = 1011;
