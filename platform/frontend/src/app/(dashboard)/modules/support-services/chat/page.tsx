...
const KPIS = [{"l":"Tickets Abertos","v":"1.596","t":"+10.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"88.0%","t":"+5.3%","d":"up"},{"l":"MTTR (h)","v":"156h","t":"-3.5%","d":"down"},{"l":"Satisfação (%)","v":"89.2%","t":"+0.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","626","5.547","988","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.742","4.809","2.963","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.828","5.980","1.265","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.342","1.727","6.887","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.909","7.164","4.630","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1028},{"label":"Fev","value":839},{"label":"Mar","value":1027},{"label":"Abr","value":996},{"label":"Mai","value":964},{"label":"Jun","value":686},{"label":"Jul","value":761},{"label":"Ago","value":805},{"label":"Set","value":962},{"label":"Out","value":686},{"label":"Nov","value":681},{"label":"Dez","value":771}];
const MX = 1028;
