...
const KPIS = [{"l":"Tickets Abertos","v":"8.008","t":"+7.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"77.7%","t":"+13.0%","d":"up"},{"l":"MTTR (h)","v":"145h","t":"+10.6%","d":"up"},{"l":"Satisfação (%)","v":"92.6%","t":"+10.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.224","1.014","4.501","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.066","7.869","2.799","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.723","6.948","5.468","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","9.088","655","2.862","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.785","5.067","5.177","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":585},{"label":"Mar","value":680},{"label":"Abr","value":503},{"label":"Mai","value":428},{"label":"Jun","value":464},{"label":"Jul","value":405},{"label":"Ago","value":321},{"label":"Set","value":446},{"label":"Out","value":467},{"label":"Nov","value":690},{"label":"Dez","value":347}];
const MX = 690;
