...
const PAGE = "Analytics &amp; SLA";
const KPIS = [{"l":"Tickets Abertos","v":"2.288","t":"-1.3%","d":"down"},{"l":"SLA Cumprido (%)","v":"65.2%","t":"+1.9%","d":"up"},{"l":"MTTR (h)","v":"61h","t":"+8.5%","d":"up"},{"l":"Satisfação (%)","v":"90.9%","t":"+14.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.239","2.508","3.219","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","525","2.178","8.649","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.471","7.768","2.524","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.630","4.217","6.029","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.759","2.695","3.734","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1004},{"label":"Fev","value":1051},{"label":"Mar","value":1006},{"label":"Abr","value":964},{"label":"Mai","value":1020},{"label":"Jun","value":971},{"label":"Jul","value":681},{"label":"Ago","value":1051},{"label":"Set","value":1021},{"label":"Out","value":799},{"label":"Nov","value":854},{"label":"Dez","value":758}];
const MX = 1051;
