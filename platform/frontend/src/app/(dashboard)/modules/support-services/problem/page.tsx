...
const KPIS = [{"l":"Tickets Abertos","v":"5.592","t":"+7.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"92.5%","t":"+17.2%","d":"up"},{"l":"MTTR (h)","v":"20h","t":"+6.5%","d":"up"},{"l":"Satisfação (%)","v":"86.8%","t":"+11.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.782","7.388","4.000","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.172","4.344","4.760","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.878","2.901","4.607","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.638","4.328","3.376","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.834","5.034","6.866","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":927},{"label":"Fev","value":962},{"label":"Mar","value":736},{"label":"Abr","value":735},{"label":"Mai","value":795},{"label":"Jun","value":800},{"label":"Jul","value":777},{"label":"Ago","value":1051},{"label":"Set","value":786},{"label":"Out","value":919},{"label":"Nov","value":798},{"label":"Dez","value":1034}];
const MX = 1051;
