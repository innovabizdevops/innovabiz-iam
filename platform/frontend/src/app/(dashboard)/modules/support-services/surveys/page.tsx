...
const PAGE = "Satisfaction Surveys";
const KPIS = [{"l":"Tickets Abertos","v":"1.295","t":"-2.4%","d":"down"},{"l":"SLA Cumprido (%)","v":"83.3%","t":"+16.9%","d":"up"},{"l":"MTTR (h)","v":"156h","t":"+5.6%","d":"up"},{"l":"Satisfação (%)","v":"71.6%","t":"-3.3%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.432","3.936","2.129","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","845","4.120","8.137","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.244","851","4.428","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.086","6.923","400","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.247","2.761","9.041","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":895},{"label":"Fev","value":849},{"label":"Mar","value":960},{"label":"Abr","value":892},{"label":"Mai","value":1017},{"label":"Jun","value":964},{"label":"Jul","value":1068},{"label":"Ago","value":707},{"label":"Set","value":1041},{"label":"Out","value":1049},{"label":"Nov","value":711},{"label":"Dez","value":1028}];
const MX = 1068;
