...
const PAGE = "Reseller";
const KPIS = [{"l":"Projetos Melhoria","v":"7.839","t":"-1.8%","d":"down"},{"l":"Savings (€)","v":"€74513","t":"+12.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"72.0%","t":"+15.7%","d":"up"},{"l":"Ciclos PDCA","v":"9.002","t":"+13.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.867","€ 21110.08","6.778","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.158","€ 21724.53","513","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","108","€ 14789.75","3.397","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.151","€ 41756.27","5.851","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.633","€ 46107.46","6.943","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":640},{"label":"Mar","value":602},{"label":"Abr","value":461},{"label":"Mai","value":589},{"label":"Jun","value":721},{"label":"Jul","value":595},{"label":"Ago","value":722},{"label":"Set","value":594},{"label":"Out","value":444},{"label":"Nov","value":730},{"label":"Dez","value":573}];
const MX = 730;
