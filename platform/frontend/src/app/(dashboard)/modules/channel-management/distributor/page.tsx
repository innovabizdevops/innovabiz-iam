...
const ACCENT = "#1d4ed8";
const MODULE = "Channel Management (APQC 3.5)";
const PAGE = "Distributor";
const KPIS = [{"l":"Projetos Melhoria","v":"2.094","t":"+14.4%","d":"up"},{"l":"Savings (€)","v":"€91622","t":"+8.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"93.9%","t":"+11.4%","d":"up"},{"l":"Ciclos PDCA","v":"3.045","t":"+9.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.156","€ 15463.91","2.045","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.668","€ 36154.95","6.295","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.501","€ 28522.89","5.517","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.669","€ 20241.90","7.940","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.296","€ 19292.39","5.167","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":289},{"label":"Fev","value":473},{"label":"Mar","value":648},{"label":"Abr","value":263},{"label":"Mai","value":320},{"label":"Jun","value":583},{"label":"Jul","value":344},{"label":"Ago","value":554},{"label":"Set","value":272},{"label":"Out","value":365},{"label":"Nov","value":355},{"label":"Dez","value":494}];
const MX = 648;
