...
const PAGE = "Conflict";
const KPIS = [{"l":"Projetos Melhoria","v":"3.019","t":"+9.5%","d":"up"},{"l":"Savings (€)","v":"€49115","t":"-2.5%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"87.2%","t":"+11.2%","d":"up"},{"l":"Ciclos PDCA","v":"7.736","t":"+7.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.151","€ 19280.77","3.293","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.242","€ 11244.96","5.357","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.317","€ 19188.41","6.503","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.929","€ 24286.87","6.725","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.846","€ 29382.77","8.621","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":644},{"label":"Mar","value":490},{"label":"Abr","value":472},{"label":"Mai","value":495},{"label":"Jun","value":441},{"label":"Jul","value":319},{"label":"Ago","value":485},{"label":"Set","value":417},{"label":"Out","value":285},{"label":"Nov","value":554},{"label":"Dez","value":581}];
const MX = 675;
