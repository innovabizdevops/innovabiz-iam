...
/* ═══ Channel Management (APQC 3.5) — Dashboard ═══ */

const ACCENT = "#1d4ed8";

const KPIS = [
    { label: "Total Registos", value: "5800", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4617", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€66K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "-8%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1848256500", cells: ["CHA-8500", "Channel Management (APQC 3.5) Item 1", "21/1/2026", "€6600"], status: "active" as const },
    { id: "1848260071", cells: ["CHA-3071", "Channel Management (APQC 3.5) Item 2", "8/8/2026", "€10 171"], status: "pending" as const },
    { id: "1848263642", cells: ["CHA-6642", "Channel Management (APQC 3.5) Item 3", "23/3/2026", "€13 742"], status: "completed" as const },
    { id: "1848267213", cells: ["CHA-1213", "Channel Management (APQC 3.5) Item 4", "10/10/2026", "€17 313"], status: "warning" as const },
    { id: "1848270784", cells: ["CHA-4784", "Channel Management (APQC 3.5) Item 5", "25/5/2026", "€20 884"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 40 }, { label: "Fev", value: 49 }, { label: "Mar", value: 58 }, { label: "Abr", value: 67 }, { label: "Mai", value: 76 }, { label: "Jun", value: 85 }];
...
export default function ChannelManagementApqc35Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Channel Management (APQC 3.5)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Channel Management (APQC 3.5)</p>
                    </div>
                </div>
