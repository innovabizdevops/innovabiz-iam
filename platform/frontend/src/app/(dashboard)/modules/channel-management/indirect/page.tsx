...
const PAGE = "Indirect";
const KPIS = [{"l":"Projetos Melhoria","v":"963","t":"+13.2%","d":"up"},{"l":"Savings (€)","v":"€61992","t":"+4.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"78.0%","t":"+3.4%","d":"up"},{"l":"Ciclos PDCA","v":"7.586","t":"-2.4%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.253","€ 4371.83","8.986","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.608","€ 36841.08","8.222","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.139","€ 9546.12","8.958","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","727","€ 14863.50","774","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.056","€ 48101.64","2.836","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":547},{"label":"Mar","value":538},{"label":"Abr","value":479},{"label":"Mai","value":480},{"label":"Jun","value":232},{"label":"Jul","value":532},{"label":"Ago","value":318},{"label":"Set","value":607},{"label":"Out","value":430},{"label":"Nov","value":564},{"label":"Dez","value":605}];
const MX = 607;
