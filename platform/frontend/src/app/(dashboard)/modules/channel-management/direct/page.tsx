...
const PAGE = "Direct";
const KPIS = [{"l":"Projetos Melhoria","v":"5.730","t":"+13.3%","d":"up"},{"l":"Savings (€)","v":"€52662","t":"+4.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"82.3%","t":"-3.6%","d":"down"},{"l":"Ciclos PDCA","v":"3.635","t":"+16.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.630","€ 44001.10","6.409","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.598","€ 40954.74","6.153","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.730","€ 31484.51","7.259","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.940","€ 23885.72","406","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.447","€ 5242.98","5.427","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":813},{"label":"Fev","value":803},{"label":"Mar","value":747},{"label":"Abr","value":814},{"label":"Mai","value":656},{"label":"Jun","value":670},{"label":"Jul","value":568},{"label":"Ago","value":676},{"label":"Set","value":553},{"label":"Out","value":771},{"label":"Nov","value":545},{"label":"Dez","value":741}];
const MX = 814;
