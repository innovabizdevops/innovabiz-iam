...
const PAGE = "Extension Hub";
const KPIS = [{"l":"Total Open Ecosystem","v":"5.992","t":"+7.9%","d":"up"},{"l":"Extension Hub Ativos","v":"3.276","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"65.2%","t":"+13.9%","d":"up"},{"l":"Score Performance","v":"70","t":"+12.9%","d":"up"}];
const COLS = ["ID","Extension Hub","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Open Ecosystem #001","Open Ecosystem #002","8.528","2.131","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Open Ecosystem #002","Open Ecosystem #003","8.395","5.398","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Open Ecosystem #003","Open Ecosystem #004","7.335","8.504","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Open Ecosystem #004","Open Ecosystem #005","2.560","3.820","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Open Ecosystem #005","Open Ecosystem #001","6.938","6.696","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1024},{"label":"Fev","value":823},{"label":"Mar","value":991},{"label":"Abr","value":1018},{"label":"Mai","value":737},{"label":"Jun","value":734},{"label":"Jul","value":751},{"label":"Ago","value":774},{"label":"Set","value":756},{"label":"Out","value":926},{"label":"Nov","value":705},{"label":"Dez","value":1006}];
const MX = 1024;
