...
const ACCENT = "#06b6d4";
const MODULE = "Open Ecosystem";
const PAGE = "Composable Architecture";
const KPIS = [{"l":"Pedidos/Dia","v":"3715","t":"+2.9%","d":"up"},{"l":"GMV (€)","v":"€22946","t":"-2.8%","d":"down"},{"l":"Conversão (%)","v":"90.2%","t":"+13.5%","d":"up"},{"l":"AOV (€)","v":"€72095","t":"-4.0%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 28855.48","4.883","6.125","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 39011.36","2.274","1.875","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 26520.12","8.820","829","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 48751.71","6.603","2.670","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 30291.03","3.506","4.061","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":990},{"label":"Fev","value":829},{"label":"Mar","value":868},{"label":"Abr","value":827},{"label":"Mai","value":781},{"label":"Jun","value":890},{"label":"Jul","value":904},{"label":"Ago","value":1023},{"label":"Set","value":959},{"label":"Out","value":744},{"label":"Nov","value":796},{"label":"Dez","value":760}];
const MX = 1023;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#06b6d4'}}>MACH</span></h1>
                </div>
