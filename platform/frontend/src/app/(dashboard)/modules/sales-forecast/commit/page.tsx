...
const PAGE = "Commit vs Best";
const KPIS = [{"l":"Vendas YTD (€)","v":"€8610","t":"+16.3%","d":"up"},{"l":"Pipeline (€)","v":"€64756","t":"+2.3%","d":"up"},{"l":"Atingimento Quota (%)","v":"69.4%","t":"+7.7%","d":"up"},{"l":"Win Rate (%)","v":"93.8%","t":"-5.2%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 15904.01","€ 34990.02","€ 32338.94","71.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 656.06","€ 29252.00","€ 37473.60","87.5%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 40392.26","€ 23638.79","€ 20878.89","81.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 22435.84","€ 20837.32","€ 38629.66","88.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 31998.77","€ 24451.54","€ 5586.47","96.3%"],"status":"active"}];
const CHART = [{"label":"Jan","value":913},{"label":"Fev","value":705},{"label":"Mar","value":966},{"label":"Abr","value":928},{"label":"Mai","value":985},{"label":"Jun","value":882},{"label":"Jul","value":1043},{"label":"Ago","value":1040},{"label":"Set","value":884},{"label":"Out","value":709},{"label":"Nov","value":954},{"label":"Dez","value":1000}];
const MX = 1043;
