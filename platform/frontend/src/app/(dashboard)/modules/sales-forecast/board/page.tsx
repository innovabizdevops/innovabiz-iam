...
const PAGE = "Forecast Board";
const KPIS = [{"l":"Vendas YTD (€)","v":"€64423","t":"-4.0%","d":"down"},{"l":"Pipeline (€)","v":"€91760","t":"+2.3%","d":"up"},{"l":"Atingimento Quota (%)","v":"95.0%","t":"+3.8%","d":"up"},{"l":"Win Rate (%)","v":"87.5%","t":"+5.6%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 26957.97","€ 8403.00","€ 2774.82","83.4%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 34916.20","€ 15346.89","€ 1872.89","91.0%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 35414.55","€ 37993.52","€ 48075.59","92.4%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 23288.78","€ 45696.76","€ 48778.05","75.2%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 3963.21","€ 28214.07","€ 25903.87","70.9%"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":395},{"label":"Mar","value":755},{"label":"Abr","value":751},{"label":"Mai","value":710},{"label":"Jun","value":741},{"label":"Jul","value":409},{"label":"Ago","value":413},{"label":"Set","value":651},{"label":"Out","value":592},{"label":"Nov","value":685},{"label":"Dez","value":401}];
const MX = 755;
