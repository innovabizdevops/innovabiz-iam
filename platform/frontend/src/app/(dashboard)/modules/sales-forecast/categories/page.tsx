...
const PAGE = "Category View";
const KPIS = [{"l":"Vendas YTD (€)","v":"€4318","t":"-1.0%","d":"down"},{"l":"Pipeline (€)","v":"€9849","t":"+9.7%","d":"up"},{"l":"Atingimento Quota (%)","v":"86.1%","t":"+15.4%","d":"up"},{"l":"Win Rate (%)","v":"74.0%","t":"+12.6%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 38483.12","€ 2055.93","€ 20491.86","92.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 48980.69","€ 12148.57","€ 8729.10","83.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 25836.66","€ 26919.04","€ 32108.61","96.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 38181.71","€ 5515.11","€ 8763.93","74.2%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 17928.53","€ 27900.30","€ 26258.84","94.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":559},{"label":"Mar","value":512},{"label":"Abr","value":695},{"label":"Mai","value":439},{"label":"Jun","value":491},{"label":"Jul","value":666},{"label":"Ago","value":493},{"label":"Set","value":648},{"label":"Out","value":575},{"label":"Nov","value":753},{"label":"Dez","value":570}];
const MX = 753;
