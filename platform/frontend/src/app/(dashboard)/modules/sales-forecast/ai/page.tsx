...
const ACCENT = "#0e7490";
const MODULE = "Sales Forecasting";
const PAGE = "AI Prediction";
const KPIS = [{"l":"Vendas YTD (€)","v":"€3683","t":"+9.2%","d":"up"},{"l":"Pipeline (€)","v":"€39184","t":"+13.6%","d":"up"},{"l":"Atingimento Quota (%)","v":"79.4%","t":"-1.8%","d":"down"},{"l":"Win Rate (%)","v":"66.5%","t":"+0.4%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 5648.30","€ 4019.73","€ 29835.56","83.7%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 22176.62","€ 26739.58","€ 919.38","72.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 28805.48","€ 15560.23","€ 17284.73","79.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 17637.12","€ 2087.36","€ 37035.04","86.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 18390.78","€ 45657.49","€ 46408.21","83.0%"],"status":"active"}];
const CHART = [{"label":"Jan","value":946},{"label":"Fev","value":941},{"label":"Mar","value":694},{"label":"Abr","value":765},{"label":"Mai","value":868},{"label":"Jun","value":620},{"label":"Jul","value":757},{"label":"Ago","value":642},{"label":"Set","value":952},{"label":"Out","value":728},{"label":"Nov","value":631},{"label":"Dez","value":719}];
const MX = 952;
