...
const PAGE = "Accuracy Track";
const KPIS = [{"l":"Vendas YTD (€)","v":"€2870","t":"+8.7%","d":"up"},{"l":"Pipeline (€)","v":"€92713","t":"+6.0%","d":"up"},{"l":"Atingimento Quota (%)","v":"81.1%","t":"+6.0%","d":"up"},{"l":"Win Rate (%)","v":"72.3%","t":"-5.4%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 11451.66","€ 25657.88","€ 37480.50","80.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 21565.56","€ 1850.91","€ 48291.62","92.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 12343.06","€ 9754.07","€ 15774.82","72.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 10488.34","€ 44985.12","€ 7450.41","89.1%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 6298.51","€ 529.08","€ 46857.45","98.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":548},{"label":"Mar","value":297},{"label":"Abr","value":290},{"label":"Mai","value":492},{"label":"Jun","value":312},{"label":"Jul","value":472},{"label":"Ago","value":616},{"label":"Set","value":601},{"label":"Out","value":294},{"label":"Nov","value":570},{"label":"Dez","value":456}];
const MX = 644;
