...
const PAGE = "Loan Origination";
const KPIS = [{"l":"Formulários Ativos","v":"6.197","t":"+3.2%","d":"up"},{"l":"Submissões/Dia","v":"1655","t":"+3.0%","d":"up"},{"l":"Documentos Gerados","v":"7.799","t":"+5.4%","d":"up"},{"l":"Templates","v":"1.277","t":"+16.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.659","2026-02-23","5.705","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.074","2026-02-07","8.004","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.649","2026-03-25","931","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.069","2026-03-25","5.056","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","313","2026-01-14","1.712","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":726},{"label":"Mar","value":473},{"label":"Abr","value":454},{"label":"Mai","value":637},{"label":"Jun","value":546},{"label":"Jul","value":676},{"label":"Ago","value":549},{"label":"Set","value":703},{"label":"Out","value":569},{"label":"Nov","value":519},{"label":"Dez","value":566}];
const MX = 811;
