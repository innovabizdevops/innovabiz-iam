...
const PAGE = "Islamic Finance";
const KPIS = [{"l":"Tickets Abertos","v":"3.279","t":"+1.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"93.1%","t":"-5.8%","d":"down"},{"l":"MTTR (h)","v":"156h","t":"+10.1%","d":"up"},{"l":"Satisfação (%)","v":"77.8%","t":"+14.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.823","2.931","5.064","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.242","2.816","2.361","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.702","7.154","8.918","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.712","9.040","6.603","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","9.005","8.338","267","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":811},{"label":"Mar","value":979},{"label":"Abr","value":623},{"label":"Mai","value":912},{"label":"Jun","value":973},{"label":"Jul","value":927},{"label":"Ago","value":893},{"label":"Set","value":684},{"label":"Out","value":740},{"label":"Nov","value":990},{"label":"Dez","value":740}];
const MX = 990;
