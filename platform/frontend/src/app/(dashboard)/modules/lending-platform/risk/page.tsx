...
const PAGE = "Portfolio Risk";
const KPIS = [{"l":"Riscos Identificados","v":"1.113","t":"+10.8%","d":"up"},{"l":"Mitigações Ativas","v":"4.193","t":"-1.5%","d":"down"},{"l":"Score Risco Geral","v":"81","t":"+17.3%","d":"up"},{"l":"Incidentes YTD","v":"3.590","t":"+15.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.553","2.405","381","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.721","971","1.872","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","9.014","2.235","1.164","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.436","912","4.555","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","844","4.188","1.852","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":386},{"label":"Fev","value":522},{"label":"Mar","value":348},{"label":"Abr","value":473},{"label":"Mai","value":445},{"label":"Jun","value":310},{"label":"Jul","value":477},{"label":"Ago","value":597},{"label":"Set","value":361},{"label":"Out","value":380},{"label":"Nov","value":582},{"label":"Dez","value":526}];
const MX = 597;
