...
const KPIS = [{"l":"Formulários Ativos","v":"5.262","t":"+10.4%","d":"up"},{"l":"Submissões/Dia","v":"1364","t":"-1.9%","d":"down"},{"l":"Documentos Gerados","v":"4.528","t":"-1.5%","d":"down"},{"l":"Templates","v":"3.895","t":"+12.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.707","2026-03-05","6.436","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.955","2026-01-09","4.843","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.225","2026-01-13","8.608","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.702","2026-02-05","2.131","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.067","2026-01-18","4.379","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":689},{"label":"Fev","value":723},{"label":"Mar","value":829},{"label":"Abr","value":770},{"label":"Mai","value":875},{"label":"Jun","value":805},{"label":"Jul","value":820},{"label":"Ago","value":788},{"label":"Set","value":836},{"label":"Out","value":811},{"label":"Nov","value":863},{"label":"Dez","value":868}];
const MX = 875;
