...
const ACCENT = "#b45309";
const MODULE = "Lending Platform";
const PAGE = "Underwriting";
const KPIS = [{"l":"Formulários Ativos","v":"6.939","t":"+3.9%","d":"up"},{"l":"Submissões/Dia","v":"2221","t":"+9.4%","d":"up"},{"l":"Documentos Gerados","v":"2.720","t":"+17.6%","d":"up"},{"l":"Templates","v":"4.424","t":"+0.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.497","2026-03-05","8.208","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.244","2026-02-07","363","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.565","2026-01-01","8.320","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.474","2026-03-03","7.335","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.687","2026-01-28","2.751","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":530},{"label":"Mar","value":555},{"label":"Abr","value":574},{"label":"Mai","value":705},{"label":"Jun","value":599},{"label":"Jul","value":477},{"label":"Ago","value":584},{"label":"Set","value":548},{"label":"Out","value":394},{"label":"Nov","value":404},{"label":"Dez","value":508}];
const MX = 705;
