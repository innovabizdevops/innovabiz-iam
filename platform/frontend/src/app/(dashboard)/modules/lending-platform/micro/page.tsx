...
const PAGE = "Micro-Lending";
const KPIS = [{"l":"Formulários Ativos","v":"1.966","t":"+9.4%","d":"up"},{"l":"Submissões/Dia","v":"4464","t":"-1.1%","d":"down"},{"l":"Documentos Gerados","v":"158","t":"+13.0%","d":"up"},{"l":"Templates","v":"6.427","t":"+7.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","9.078","2026-01-02","6.322","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.585","2026-03-07","7.790","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.101","2026-03-14","1.436","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.198","2026-03-16","2.096","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.818","2026-01-08","5.156","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":1018},{"label":"Mar","value":813},{"label":"Abr","value":867},{"label":"Mai","value":875},{"label":"Jun","value":664},{"label":"Jul","value":972},{"label":"Ago","value":842},{"label":"Set","value":1021},{"label":"Out","value":628},{"label":"Nov","value":871},{"label":"Dez","value":680}];
const MX = 1021;
