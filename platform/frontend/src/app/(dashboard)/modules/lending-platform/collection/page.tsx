...
const KPIS = [{"l":"Formulários Ativos","v":"8.969","t":"+10.7%","d":"up"},{"l":"Submissões/Dia","v":"445","t":"+8.4%","d":"up"},{"l":"Documentos Gerados","v":"8.614","t":"+12.2%","d":"up"},{"l":"Templates","v":"883","t":"+1.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.441","2026-03-05","265","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.016","2026-01-11","3.065","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","373","2026-01-18","3.537","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.740","2026-03-15","1.935","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.632","2026-03-15","5.296","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":262},{"label":"Fev","value":286},{"label":"Mar","value":443},{"label":"Abr","value":522},{"label":"Mai","value":306},{"label":"Jun","value":486},{"label":"Jul","value":272},{"label":"Ago","value":486},{"label":"Set","value":304},{"label":"Out","value":491},{"label":"Nov","value":299},{"label":"Dez","value":287}];
const MX = 522;
