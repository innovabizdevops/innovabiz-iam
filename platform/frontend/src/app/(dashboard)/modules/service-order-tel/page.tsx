...
export default function ServiceOrderTelPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Service Order Tel</h1><p className="text-sm text-muted-foreground">Service Order Tel • iBOS Enterprise</p></div>
