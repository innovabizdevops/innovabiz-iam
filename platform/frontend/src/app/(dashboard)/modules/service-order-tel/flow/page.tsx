...
const ACCENT = "#059669";
const MODULE = "Service Order";
const PAGE = "Order Flow";
const KPIS = [{"l":"Total Service Order Tel","v":"6.968","t":"+15.5%","d":"up"},{"l":"Order Flow Ativos","v":"1.320","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"75.2%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"90","t":"+17.0%","d":"up"}];
const COLS = ["ID","Order Flow","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Order Tel #001","Service Order Tel #002","8.743","5.350","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Service Order Tel #002","Service Order Tel #003","5.331","4.284","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Order Tel #003","Service Order Tel #004","8.962","1.361","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Service Order Tel #004","Service Order Tel #005","5.050","2.352","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Order Tel #005","Service Order Tel #001","8.319","5.059","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":420},{"label":"Mar","value":427},{"label":"Abr","value":471},{"label":"Mai","value":606},{"label":"Jun","value":701},{"label":"Jul","value":354},{"label":"Ago","value":522},{"label":"Set","value":555},{"label":"Out","value":354},{"label":"Nov","value":366},{"label":"Dez","value":654}];
const MX = 701;
