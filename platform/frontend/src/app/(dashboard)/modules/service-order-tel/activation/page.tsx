...
const KPIS = [{"l":"Total Service Order Tel","v":"7.147","t":"+7.5%","d":"up"},{"l":"Activation Ativos","v":"7.018","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"66.3%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"89","t":"+17.7%","d":"up"}];
const COLS = ["ID","Activation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Order Tel #001","Service Order Tel #002","4.422","2.678","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Service Order Tel #002","Service Order Tel #003","8.850","4.507","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Order Tel #003","Service Order Tel #004","4.442","8.128","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Service Order Tel #004","Service Order Tel #005","3.749","1.547","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Order Tel #005","Service Order Tel #001","3.358","7.526","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":705},{"label":"Mar","value":401},{"label":"Abr","value":498},{"label":"Mai","value":699},{"label":"Jun","value":524},{"label":"Jul","value":629},{"label":"Ago","value":680},{"label":"Set","value":655},{"label":"Out","value":720},{"label":"Nov","value":347},{"label":"Dez","value":647}];
const MX = 720;
