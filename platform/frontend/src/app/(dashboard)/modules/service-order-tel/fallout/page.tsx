...
const PAGE = "Fallout";
const KPIS = [{"l":"Total Service Order Tel","v":"3.981","t":"-6.0%","d":"down"},{"l":"Fallout Ativos","v":"6.452","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"94.6%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"57","t":"+12.6%","d":"up"}];
const COLS = ["ID","Fallout","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Order Tel #001","Service Order Tel #002","7.143","7.998","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Service Order Tel #002","Service Order Tel #003","8.947","6.142","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Order Tel #003","Service Order Tel #004","7.833","8.145","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Service Order Tel #004","Service Order Tel #005","8.056","7.609","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Order Tel #005","Service Order Tel #001","747","621","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":233},{"label":"Fev","value":369},{"label":"Mar","value":470},{"label":"Abr","value":585},{"label":"Mai","value":427},{"label":"Jun","value":232},{"label":"Jul","value":325},{"label":"Ago","value":363},{"label":"Set","value":283},{"label":"Out","value":406},{"label":"Nov","value":352},{"label":"Dez","value":576}];
const MX = 585;
