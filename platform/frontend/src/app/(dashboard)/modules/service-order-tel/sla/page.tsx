...
const PAGE = "SLA Bind";
const KPIS = [{"l":"Tickets Abertos","v":"6.899","t":"-1.6%","d":"down"},{"l":"SLA Cumprido (%)","v":"82.3%","t":"+7.8%","d":"up"},{"l":"MTTR (h)","v":"26h","t":"+12.6%","d":"up"},{"l":"Satisfação (%)","v":"77.2%","t":"+13.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.120","6.049","5.767","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.173","933","7.824","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.115","6.229","7.221","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.567","4.820","5.601","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.428","2.957","1.262","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1017},{"label":"Fev","value":784},{"label":"Mar","value":876},{"label":"Abr","value":1065},{"label":"Mai","value":903},{"label":"Jun","value":729},{"label":"Jul","value":951},{"label":"Ago","value":1013},{"label":"Set","value":981},{"label":"Out","value":862},{"label":"Nov","value":880},{"label":"Dez","value":983}];
const MX = 1065;
