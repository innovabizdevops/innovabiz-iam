...
const PAGE = "Provisioning";
const KPIS = [{"l":"Total Service Order Tel","v":"4.176","t":"+15.1%","d":"up"},{"l":"Provisioning Ativos","v":"4.823","t":"+10.6%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"60","t":"-3.3%","d":"down"}];
const COLS = ["ID","Provisioning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Order Tel #001","Service Order Tel #002","8.707","1.155","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Service Order Tel #002","Service Order Tel #003","7.550","4.467","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Order Tel #003","Service Order Tel #004","4.440","1.807","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Service Order Tel #004","Service Order Tel #005","4.833","5.638","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Order Tel #005","Service Order Tel #001","362","7.857","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":844},{"label":"Mar","value":985},{"label":"Abr","value":944},{"label":"Mai","value":790},{"label":"Jun","value":708},{"label":"Jul","value":742},{"label":"Ago","value":750},{"label":"Set","value":773},{"label":"Out","value":935},{"label":"Nov","value":837},{"label":"Dez","value":737}];
const MX = 985;
