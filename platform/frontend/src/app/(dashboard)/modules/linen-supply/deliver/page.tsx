...
const PAGE = "Deliver";
const KPIS = [{"l":"Total Linen Supply","v":"3.544","t":"+5.8%","d":"up"},{"l":"Deliver Ativos","v":"8.487","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"66.4%","t":"+7.4%","d":"up"},{"l":"Score Performance","v":"92","t":"+11.9%","d":"up"}];
const COLS = ["ID","Deliver","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Linen Supply #001","Linen Supply #002","933","7.863","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Linen Supply #002","Linen Supply #003","7.471","7.670","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Linen Supply #003","Linen Supply #004","2.097","2.671","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Linen Supply #004","Linen Supply #005","5.270","9.057","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Linen Supply #005","Linen Supply #001","564","4.821","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":900},{"label":"Mar","value":568},{"label":"Abr","value":549},{"label":"Mai","value":685},{"label":"Jun","value":645},{"label":"Jul","value":804},{"label":"Ago","value":737},{"label":"Set","value":863},{"label":"Out","value":862},{"label":"Nov","value":661},{"label":"Dez","value":910}];
const MX = 910;
