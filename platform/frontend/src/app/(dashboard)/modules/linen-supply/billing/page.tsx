...
const PAGE = "Billing";
const KPIS = [{"l":"Total Linen Supply","v":"2.327","t":"+13.1%","d":"up"},{"l":"Billing Ativos","v":"6.024","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"94.7%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"87","t":"+5.6%","d":"up"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Linen Supply #001","Linen Supply #002","441","699","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Linen Supply #002","Linen Supply #003","3.076","2.006","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Linen Supply #003","Linen Supply #004","8.477","230","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Linen Supply #004","Linen Supply #005","3.231","6.709","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Linen Supply #005","Linen Supply #001","3.841","5.349","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":673},{"label":"Mar","value":705},{"label":"Abr","value":830},{"label":"Mai","value":585},{"label":"Jun","value":802},{"label":"Jul","value":593},{"label":"Ago","value":530},{"label":"Set","value":482},{"label":"Out","value":585},{"label":"Nov","value":828},{"label":"Dez","value":539}];
const MX = 830;
