...
/* ═══ Linen Supply Company — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "1671", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2577", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€57K", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1802583671", cells: ["LIN-1671", "Linen Supply Company Item 1", "8/12/2026", "€33 771"], status: "active" as const },
    { id: "1802587242", cells: ["LIN-5242", "Linen Supply Company Item 2", "23/7/2026", "€37 342"], status: "pending" as const },
    { id: "1802590813", cells: ["LIN-8813", "Linen Supply Company Item 3", "10/2/2026", "€40 913"], status: "completed" as const },
    { id: "1802594384", cells: ["LIN-3384", "Linen Supply Company Item 4", "25/9/2026", "€44 484"], status: "warning" as const },
    { id: "1802597955", cells: ["LIN-6955", "Linen Supply Company Item 5", "12/4/2026", "€48 055"], status: "active" as const },
];
...
export default function LinenSupplyCompanyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Linen Supply Company</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Linen Supply Company</p>
                    </div>
                </div>
