...
const PAGE = "Route";
const KPIS = [{"l":"Total Linen Supply","v":"6.171","t":"-2.8%","d":"down"},{"l":"Route Ativos","v":"4.984","t":"+0.7%","d":"up"},{"l":"Eficiência (%)","v":"68.2%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"58","t":"+2.9%","d":"up"}];
const COLS = ["ID","Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Linen Supply #001","Linen Supply #002","5.099","208","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Linen Supply #002","Linen Supply #003","2.646","8.798","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Linen Supply #003","Linen Supply #004","3.698","4.094","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Linen Supply #004","Linen Supply #005","5.935","8.000","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Linen Supply #005","Linen Supply #001","6.875","6.446","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":828},{"label":"Mar","value":529},{"label":"Abr","value":559},{"label":"Mai","value":784},{"label":"Jun","value":559},{"label":"Jul","value":577},{"label":"Ago","value":779},{"label":"Set","value":747},{"label":"Out","value":752},{"label":"Nov","value":662},{"label":"Dez","value":682}];
const MX = 828;
