...
const ACCENT = "#0e7490";
const MODULE = "Linen Supply Company";
const PAGE = "Inventory";
const KPIS = [{"l":"Total Linen Supply","v":"7.129","t":"+5.2%","d":"up"},{"l":"Inventory Ativos","v":"8.309","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"94.8%","t":"-2.8%","d":"down"},{"l":"Score Performance","v":"59","t":"+12.0%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Linen Supply #001","Linen Supply #002","8.820","7.863","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Linen Supply #002","Linen Supply #003","2.793","4.783","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Linen Supply #003","Linen Supply #004","2.546","4.188","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Linen Supply #004","Linen Supply #005","6.142","365","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Linen Supply #005","Linen Supply #001","2.398","2.391","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":517},{"label":"Mar","value":451},{"label":"Abr","value":499},{"label":"Mai","value":490},{"label":"Jun","value":742},{"label":"Jul","value":632},{"label":"Ago","value":619},{"label":"Set","value":701},{"label":"Out","value":449},{"label":"Nov","value":783},{"label":"Dez","value":458}];
const MX = 783;
