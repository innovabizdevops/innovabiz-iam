...
const ACCENT = "#059669";
const MODULE = "Green Data Center";
const PAGE = "WUE Track";
const KPIS = [{"l":"Total Green Dc","v":"1.348","t":"+17.0%","d":"up"},{"l":"WUE Track Ativos","v":"2.087","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"67.0%","t":"+6.8%","d":"up"},{"l":"Score Performance","v":"87","t":"+4.4%","d":"up"}];
const COLS = ["ID","WUE Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Green Dc #001","Green Dc #002","3.511","7.825","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Green Dc #002","Green Dc #003","7.895","9.032","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Green Dc #003","Green Dc #004","6.692","8.875","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Green Dc #004","Green Dc #005","8.188","4.808","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Green Dc #005","Green Dc #001","6.634","4.040","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":864},{"label":"Mar","value":956},{"label":"Abr","value":868},{"label":"Mai","value":723},{"label":"Jun","value":1001},{"label":"Jul","value":791},{"label":"Ago","value":803},{"label":"Set","value":918},{"label":"Out","value":891},{"label":"Nov","value":870},{"label":"Dez","value":785}];
const MX = 1001;
...
export default function WuePage() {
    return (
