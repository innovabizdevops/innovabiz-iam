...
const PAGE = "Heat Reuse";
const KPIS = [{"l":"Total Green Dc","v":"4.522","t":"+3.7%","d":"up"},{"l":"Heat Reuse Ativos","v":"867","t":"+0.7%","d":"up"},{"l":"Eficiência (%)","v":"76.9%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"77","t":"+10.4%","d":"up"}];
const COLS = ["ID","Heat Reuse","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Green Dc #001","Green Dc #002","4.760","7.399","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Green Dc #002","Green Dc #003","4.404","6.211","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Green Dc #003","Green Dc #004","8.888","2.676","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Green Dc #004","Green Dc #005","8.542","5.927","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Green Dc #005","Green Dc #001","7.217","2.760","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":911},{"label":"Mar","value":855},{"label":"Abr","value":674},{"label":"Mai","value":794},{"label":"Jun","value":757},{"label":"Jul","value":724},{"label":"Ago","value":870},{"label":"Set","value":622},{"label":"Out","value":654},{"label":"Nov","value":722},{"label":"Dez","value":630}];
const MX = 911;
