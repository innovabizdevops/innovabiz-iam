...
export default function GreenDcPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Green Dc</h1><p className="text-sm text-muted-foreground">Green Dc • iBOS Enterprise</p></div>
