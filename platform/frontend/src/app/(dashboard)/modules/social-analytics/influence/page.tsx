...
const PAGE = "Influence";
const KPIS = [{"l":"Dashboards Ativos","v":"2.230","t":"-4.8%","d":"down"},{"l":"Queries/Dia","v":"3513","t":"+16.4%","d":"up"},{"l":"Dados Processados (GB)","v":"6.186","t":"+0.7%","d":"up"},{"l":"Utilizadores Analytics","v":"905","t":"+8.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2260","2026-03-15","4.623","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3597","2026-02-09","5.193","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","5051","2026-01-06","7.310","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","305","2026-01-25","5.441","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2294","2026-03-24","2.371","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":644},{"label":"Mar","value":710},{"label":"Abr","value":668},{"label":"Mai","value":562},{"label":"Jun","value":646},{"label":"Jul","value":399},{"label":"Ago","value":728},{"label":"Set","value":412},{"label":"Out","value":684},{"label":"Nov","value":586},{"label":"Dez","value":661}];
const MX = 733;
