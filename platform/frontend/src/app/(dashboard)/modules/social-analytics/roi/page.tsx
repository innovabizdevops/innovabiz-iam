...
const PAGE = "ROI";
const KPIS = [{"l":"Dashboards Ativos","v":"5.148","t":"+15.5%","d":"up"},{"l":"Queries/Dia","v":"397","t":"+15.9%","d":"up"},{"l":"Dados Processados (GB)","v":"4.206","t":"+14.2%","d":"up"},{"l":"Utilizadores Analytics","v":"3.531","t":"+2.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1264","2026-03-24","4.744","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3282","2026-01-23","8.517","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","420","2026-02-06","3.730","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4848","2026-01-06","4.879","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3558","2026-01-03","7.707","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1050},{"label":"Fev","value":933},{"label":"Mar","value":1057},{"label":"Abr","value":999},{"label":"Mai","value":1016},{"label":"Jun","value":722},{"label":"Jul","value":932},{"label":"Ago","value":991},{"label":"Set","value":851},{"label":"Out","value":768},{"label":"Nov","value":927},{"label":"Dez","value":782}];
const MX = 1057;
