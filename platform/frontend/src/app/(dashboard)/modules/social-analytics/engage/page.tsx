...
const PAGE = "Engage";
const KPIS = [{"l":"Dashboards Ativos","v":"338","t":"+6.5%","d":"up"},{"l":"Queries/Dia","v":"178","t":"+12.8%","d":"up"},{"l":"Dados Processados (GB)","v":"1.715","t":"-4.9%","d":"down"},{"l":"Utilizadores Analytics","v":"5.467","t":"+1.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4324","2026-01-07","2.744","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","207","2026-03-22","8.218","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4962","2026-02-28","4.774","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4857","2026-03-24","2.001","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5083","2026-02-11","4.371","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":934},{"label":"Fev","value":866},{"label":"Mar","value":938},{"label":"Abr","value":821},{"label":"Mai","value":808},{"label":"Jun","value":679},{"label":"Jul","value":885},{"label":"Ago","value":1004},{"label":"Set","value":841},{"label":"Out","value":962},{"label":"Nov","value":680},{"label":"Dez","value":795}];
const MX = 1004;
