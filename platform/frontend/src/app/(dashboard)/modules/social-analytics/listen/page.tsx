...
const ACCENT = "#4338ca";
const MODULE = "Social Media Analytics";
const PAGE = "Listen";
const KPIS = [{"l":"Dashboards Ativos","v":"3.068","t":"-5.3%","d":"down"},{"l":"Queries/Dia","v":"4372","t":"+2.9%","d":"up"},{"l":"Dados Processados (GB)","v":"7.147","t":"-4.0%","d":"down"},{"l":"Utilizadores Analytics","v":"924","t":"+12.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","146","2026-03-26","2.305","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","485","2026-03-13","2.795","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4874","2026-02-21","5.406","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1233","2026-02-18","8.192","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1989","2026-03-01","4.288","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":993},{"label":"Mar","value":853},{"label":"Abr","value":942},{"label":"Mai","value":815},{"label":"Jun","value":762},{"label":"Jul","value":865},{"label":"Ago","value":964},{"label":"Set","value":769},{"label":"Out","value":958},{"label":"Nov","value":676},{"label":"Dez","value":886}];
const MX = 993;
