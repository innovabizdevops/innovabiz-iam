...
const KPIS = [{"l":"Dashboards Ativos","v":"6.798","t":"+10.9%","d":"up"},{"l":"Queries/Dia","v":"4068","t":"-1.3%","d":"down"},{"l":"Dados Processados (GB)","v":"6.488","t":"-2.7%","d":"down"},{"l":"Utilizadores Analytics","v":"3.952","t":"+6.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4365","2026-01-21","6.142","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2494","2026-02-04","7.636","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4393","2026-01-26","7.464","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3134","2026-02-17","6.980","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3113","2026-01-22","4.224","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":373},{"label":"Mar","value":570},{"label":"Abr","value":407},{"label":"Mai","value":460},{"label":"Jun","value":684},{"label":"Jul","value":717},{"label":"Ago","value":604},{"label":"Set","value":406},{"label":"Out","value":738},{"label":"Nov","value":603},{"label":"Dez","value":549}];
const MX = 738;
