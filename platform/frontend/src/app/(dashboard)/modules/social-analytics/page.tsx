...
const KPIS = [
    { label: "Total Registos", value: "7767", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "941", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€98K", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "761911667", cells: ["SOC-8667", "Social Media Analytics Item 1", "28/12/2026", "€11 767"], status: "active" as const },
    { id: "761915238", cells: ["SOC-3238", "Social Media Analytics Item 2", "15/7/2026", "€15 338"], status: "pending" as const },
    { id: "761918809", cells: ["SOC-6809", "Social Media Analytics Item 3", "2/2/2026", "€18 909"], status: "completed" as const },
    { id: "761922380", cells: ["SOC-1380", "Social Media Analytics Item 4", "17/9/2026", "€22 480"], status: "warning" as const },
    { id: "761925951", cells: ["SOC-4951", "Social Media Analytics Item 5", "4/4/2026", "€26 051"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Social Media Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Social Media Analytics</p>
                    </div>
                </div>
