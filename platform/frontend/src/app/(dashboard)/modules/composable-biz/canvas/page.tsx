...
const PAGE = "Composition Canvas";
const KPIS = [{"l":"Pedidos/Dia","v":"680","t":"+10.1%","d":"up"},{"l":"GMV (€)","v":"€29375","t":"+3.5%","d":"up"},{"l":"Conversão (%)","v":"80.0%","t":"+7.5%","d":"up"},{"l":"AOV (€)","v":"€78384","t":"-5.0%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 40085.98","2.334","7.416","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 39604.80","5.690","2.665","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 37999.40","3.903","301","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 50055.85","5.555","3.648","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 39254.29","529","4.537","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":802},{"label":"Mar","value":876},{"label":"Abr","value":765},{"label":"Mai","value":867},{"label":"Jun","value":718},{"label":"Jul","value":642},{"label":"Ago","value":659},{"label":"Set","value":855},{"label":"Out","value":902},{"label":"Nov","value":792},{"label":"Dez","value":718}];
const MX = 902;
