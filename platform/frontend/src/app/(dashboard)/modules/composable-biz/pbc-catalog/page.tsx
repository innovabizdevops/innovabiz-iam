...
const ACCENT = "#0891b2";
const MODULE = "Composable Business";
const PAGE = "PBC Catalog";
const KPIS = [{"l":"Pedidos/Dia","v":"2676","t":"+1.1%","d":"up"},{"l":"GMV (€)","v":"€93981","t":"+16.0%","d":"up"},{"l":"Conversão (%)","v":"82.6%","t":"+4.3%","d":"up"},{"l":"AOV (€)","v":"€12651","t":"+16.5%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 42692.43","7.442","2.868","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 31929.04","3.899","5.173","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 13424.40","2.858","6.430","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 49707.35","2.849","785","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 2013.21","2.397","7.792","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":793},{"label":"Fev","value":868},{"label":"Mar","value":914},{"label":"Abr","value":998},{"label":"Mai","value":681},{"label":"Jun","value":1069},{"label":"Jul","value":703},{"label":"Ago","value":1040},{"label":"Set","value":969},{"label":"Out","value":809},{"label":"Nov","value":673},{"label":"Dez","value":703}];
const MX = 1069;
...
export default function PbcCatalogPage() {
    return (
