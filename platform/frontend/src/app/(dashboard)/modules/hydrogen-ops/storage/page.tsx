...
const PAGE = "Storage";
const KPIS = [{"l":"Total Hydrogen Ops","v":"4.479","t":"+15.9%","d":"up"},{"l":"Storage Ativos","v":"1.661","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"87.5%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"62","t":"+1.0%","d":"up"}];
const COLS = ["ID","Storage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hydrogen Ops #001","Hydrogen Ops #002","4.415","4.846","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Hydrogen Ops #002","Hydrogen Ops #003","919","8.201","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Hydrogen Ops #003","Hydrogen Ops #004","4.601","5.268","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Hydrogen Ops #004","Hydrogen Ops #005","7.003","1.565","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hydrogen Ops #005","Hydrogen Ops #001","3.632","6.727","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":309},{"label":"Mar","value":610},{"label":"Abr","value":571},{"label":"Mai","value":576},{"label":"Jun","value":571},{"label":"Jul","value":558},{"label":"Ago","value":521},{"label":"Set","value":266},{"label":"Out","value":443},{"label":"Nov","value":436},{"label":"Dez","value":369}];
const MX = 610;
