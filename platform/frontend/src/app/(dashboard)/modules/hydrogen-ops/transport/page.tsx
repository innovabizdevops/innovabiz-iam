...
const KPIS = [{"l":"Atletas Registados","v":"8.468","t":"+16.6%","d":"up"},{"l":"Treinos/Semana","v":"1963","t":"+3.1%","d":"up"},{"l":"Competições","v":"3.320","t":"-0.1%","d":"down"},{"l":"Performance Score","v":"82","t":"+8.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.983","912","8.275","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.254","3.864","727","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.161","1.938","1.907","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","119","7.068","1.952","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.602","7.711","2.767","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":636},{"label":"Mar","value":382},{"label":"Abr","value":765},{"label":"Mai","value":672},{"label":"Jun","value":707},{"label":"Jul","value":753},{"label":"Ago","value":578},{"label":"Set","value":444},{"label":"Out","value":474},{"label":"Nov","value":496},{"label":"Dez","value":634}];
const MX = 765;
