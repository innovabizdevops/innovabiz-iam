...
const PAGE = "Safety";
const KPIS = [{"l":"Total Hydrogen Ops","v":"3.090","t":"-3.8%","d":"down"},{"l":"Safety Ativos","v":"4.881","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"88.4%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"81","t":"+4.6%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hydrogen Ops #001","Hydrogen Ops #002","8.476","7.003","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Hydrogen Ops #002","Hydrogen Ops #003","1.470","2.562","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Hydrogen Ops #003","Hydrogen Ops #004","7.217","3.312","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Hydrogen Ops #004","Hydrogen Ops #005","4.373","5.134","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hydrogen Ops #005","Hydrogen Ops #001","224","2.983","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":512},{"label":"Mar","value":388},{"label":"Abr","value":595},{"label":"Mai","value":710},{"label":"Jun","value":627},{"label":"Jul","value":590},{"label":"Ago","value":404},{"label":"Set","value":439},{"label":"Out","value":404},{"label":"Nov","value":412},{"label":"Dez","value":340}];
const MX = 710;
