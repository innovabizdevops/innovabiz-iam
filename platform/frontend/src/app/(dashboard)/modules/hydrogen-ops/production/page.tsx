...
const ACCENT = "#6366f1";
const MODULE = "Hydrogen Operations";
const PAGE = "Production";
const KPIS = [{"l":"Total Hydrogen Ops","v":"8.611","t":"+17.0%","d":"up"},{"l":"Production Ativos","v":"9.041","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"72","t":"+16.2%","d":"up"}];
const COLS = ["ID","Production","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hydrogen Ops #001","Hydrogen Ops #002","6.080","8.687","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Hydrogen Ops #002","Hydrogen Ops #003","6.939","2.870","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Hydrogen Ops #003","Hydrogen Ops #004","8.905","3.969","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Hydrogen Ops #004","Hydrogen Ops #005","5.853","5.657","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hydrogen Ops #005","Hydrogen Ops #001","3.481","3.216","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":603},{"label":"Mar","value":258},{"label":"Abr","value":492},{"label":"Mai","value":637},{"label":"Jun","value":452},{"label":"Jul","value":343},{"label":"Ago","value":253},{"label":"Set","value":648},{"label":"Out","value":294},{"label":"Nov","value":448},{"label":"Dez","value":486}];
const MX = 648;
