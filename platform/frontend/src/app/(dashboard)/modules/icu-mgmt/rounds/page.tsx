...
const PAGE = "Rounds";
const KPIS = [{"l":"Total Icu Mgmt","v":"309","t":"-3.6%","d":"down"},{"l":"Rounds Ativos","v":"8.238","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"71.1%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"87","t":"+9.0%","d":"up"}];
const COLS = ["ID","Rounds","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Icu Mgmt #001","Icu Mgmt #002","324","6.009","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Icu Mgmt #002","Icu Mgmt #003","7.580","2.802","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Icu Mgmt #003","Icu Mgmt #004","7.973","4.739","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Icu Mgmt #004","Icu Mgmt #005","2.530","6.223","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Icu Mgmt #005","Icu Mgmt #001","8.575","4.451","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":501},{"label":"Mar","value":730},{"label":"Abr","value":743},{"label":"Mai","value":754},{"label":"Jun","value":866},{"label":"Jul","value":730},{"label":"Ago","value":643},{"label":"Set","value":680},{"label":"Out","value":599},{"label":"Nov","value":488},{"label":"Dez","value":538}];
const MX = 866;
