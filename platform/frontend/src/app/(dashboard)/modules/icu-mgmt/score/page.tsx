...
const PAGE = "Scoring";
const KPIS = [{"l":"Total Icu Mgmt","v":"489","t":"-2.9%","d":"down"},{"l":"Scoring Ativos","v":"5.927","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"57","t":"+14.3%","d":"up"}];
const COLS = ["ID","Scoring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Icu Mgmt #001","Icu Mgmt #002","1.020","6.969","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Icu Mgmt #002","Icu Mgmt #003","1.904","5.645","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Icu Mgmt #003","Icu Mgmt #004","2.891","7.833","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Icu Mgmt #004","Icu Mgmt #005","811","3.216","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Icu Mgmt #005","Icu Mgmt #001","3.408","477","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":340},{"label":"Fev","value":627},{"label":"Mar","value":438},{"label":"Abr","value":491},{"label":"Mai","value":408},{"label":"Jun","value":287},{"label":"Jul","value":403},{"label":"Ago","value":468},{"label":"Set","value":388},{"label":"Out","value":277},{"label":"Nov","value":497},{"label":"Dez","value":495}];
const MX = 627;
