...
const PAGE = "Infusion";
const KPIS = [{"l":"Total Icu Mgmt","v":"2.251","t":"+7.1%","d":"up"},{"l":"Infusion Ativos","v":"2.676","t":"+17.7%","d":"up"},{"l":"Eficiência (%)","v":"84.1%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"88","t":"+8.5%","d":"up"}];
const COLS = ["ID","Infusion","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Icu Mgmt #001","Icu Mgmt #002","950","4.202","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Icu Mgmt #002","Icu Mgmt #003","5.335","1.760","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Icu Mgmt #003","Icu Mgmt #004","2.666","8.582","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Icu Mgmt #004","Icu Mgmt #005","841","6.188","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Icu Mgmt #005","Icu Mgmt #001","2.082","8.113","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":349},{"label":"Fev","value":552},{"label":"Mar","value":599},{"label":"Abr","value":434},{"label":"Mai","value":664},{"label":"Jun","value":360},{"label":"Jul","value":320},{"label":"Ago","value":573},{"label":"Set","value":704},{"label":"Out","value":599},{"label":"Nov","value":694},{"label":"Dez","value":592}];
const MX = 704;
