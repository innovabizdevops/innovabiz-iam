...
const PAGE = "Ventilator";
const KPIS = [{"l":"Total Icu Mgmt","v":"1.844","t":"+10.9%","d":"up"},{"l":"Ventilator Ativos","v":"3.222","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"86.1%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"82","t":"-4.8%","d":"down"}];
const COLS = ["ID","Ventilator","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Icu Mgmt #001","Icu Mgmt #002","2.849","6.668","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Icu Mgmt #002","Icu Mgmt #003","8.010","2.236","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Icu Mgmt #003","Icu Mgmt #004","2.951","7.877","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Icu Mgmt #004","Icu Mgmt #005","6.188","9.075","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Icu Mgmt #005","Icu Mgmt #001","8.233","2.621","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":357},{"label":"Fev","value":575},{"label":"Mar","value":406},{"label":"Abr","value":370},{"label":"Mai","value":279},{"label":"Jun","value":337},{"label":"Jul","value":305},{"label":"Ago","value":561},{"label":"Set","value":271},{"label":"Out","value":407},{"label":"Nov","value":503},{"label":"Dez","value":456}];
const MX = 575;
