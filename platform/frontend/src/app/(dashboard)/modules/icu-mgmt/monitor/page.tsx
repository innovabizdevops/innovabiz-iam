...
const ACCENT = "#6366f1";
const MODULE = "ICU Management";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Icu Mgmt","v":"6.566","t":"+7.7%","d":"up"},{"l":"Monitor Ativos","v":"3.370","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"93.4%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"72","t":"+2.0%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Icu Mgmt #001","Icu Mgmt #002","8.137","4.390","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Icu Mgmt #002","Icu Mgmt #003","7.054","5.262","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Icu Mgmt #003","Icu Mgmt #004","7.576","3.791","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Icu Mgmt #004","Icu Mgmt #005","8.830","3.255","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Icu Mgmt #005","Icu Mgmt #001","2.844","4.884","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":737},{"label":"Fev","value":748},{"label":"Mar","value":989},{"label":"Abr","value":711},{"label":"Mai","value":876},{"label":"Jun","value":919},{"label":"Jul","value":804},{"label":"Ago","value":684},{"label":"Set","value":734},{"label":"Out","value":994},{"label":"Nov","value":836},{"label":"Dez","value":878}];
const MX = 994;
