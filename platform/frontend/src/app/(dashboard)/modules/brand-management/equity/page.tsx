...
const PAGE = "Equity";
const KPIS = [{"l":"Projetos Melhoria","v":"3.849","t":"-1.9%","d":"down"},{"l":"Savings (€)","v":"€17046","t":"-4.0%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"75.6%","t":"+8.2%","d":"up"},{"l":"Ciclos PDCA","v":"6.093","t":"+14.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.889","€ 37549.98","2.955","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.271","€ 37231.93","7.816","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.051","€ 36662.92","7.493","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.094","€ 1310.42","5.887","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.776","€ 4290.61","5.364","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":665},{"label":"Mar","value":779},{"label":"Abr","value":870},{"label":"Mai","value":717},{"label":"Jun","value":860},{"label":"Jul","value":750},{"label":"Ago","value":971},{"label":"Set","value":975},{"label":"Out","value":818},{"label":"Nov","value":691},{"label":"Dez","value":879}];
const MX = 975;
