...
const PAGE = "Protect";
const KPIS = [{"l":"Projetos Melhoria","v":"5.963","t":"+11.8%","d":"up"},{"l":"Savings (€)","v":"€46561","t":"-3.2%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"73.6%","t":"+6.6%","d":"up"},{"l":"Ciclos PDCA","v":"2.181","t":"+5.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.316","€ 32710.98","1.248","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.944","€ 29736.34","2.059","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.777","€ 8375.92","8.418","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.602","€ 38452.94","1.661","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.397","€ 12166.30","3.548","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":864},{"label":"Mar","value":758},{"label":"Abr","value":807},{"label":"Mai","value":714},{"label":"Jun","value":675},{"label":"Jul","value":560},{"label":"Ago","value":539},{"label":"Set","value":694},{"label":"Out","value":597},{"label":"Nov","value":811},{"label":"Dez","value":649}];
const MX = 864;
