...
/* ═══ Brand Management (APQC 3.3) — Dashboard ═══ */

const ACCENT = "#3b82f6";

const KPIS = [
    { label: "Total Registos", value: "1096", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3507", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€157K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1300474896", cells: ["BRA-2896", "Brand Management (APQC 3.3) Item 1", "1/1/2026", "€24 996"], status: "active" as const },
    { id: "1300478467", cells: ["BRA-6467", "Brand Management (APQC 3.3) Item 2", "16/8/2026", "€28 567"], status: "pending" as const },
    { id: "1300482038", cells: ["BRA-1038", "Brand Management (APQC 3.3) Item 3", "3/3/2026", "€32 138"], status: "completed" as const },
    { id: "1300485609", cells: ["BRA-4609", "Brand Management (APQC 3.3) Item 4", "18/10/2026", "€35 709"], status: "warning" as const },
    { id: "1300489180", cells: ["BRA-8180", "Brand Management (APQC 3.3) Item 5", "5/5/2026", "€39 280"], status: "active" as const },
];
...
export default function BrandManagementApqc33Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Brand Management (APQC 3.3)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Brand Management (APQC 3.3)</p>
                    </div>
                </div>
