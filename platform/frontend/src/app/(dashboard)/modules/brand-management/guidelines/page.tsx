...
const KPIS = [{"l":"Projetos Melhoria","v":"3.796","t":"+14.4%","d":"up"},{"l":"Savings (€)","v":"€9329","t":"+3.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"80.3%","t":"+11.5%","d":"up"},{"l":"Ciclos PDCA","v":"6.283","t":"+7.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.062","€ 43755.24","1.875","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.446","€ 28049.03","8.180","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.317","€ 27494.85","3.829","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.601","€ 20004.78","695","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.977","€ 40760.27","6.175","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":795},{"label":"Fev","value":733},{"label":"Mar","value":886},{"label":"Abr","value":753},{"label":"Mai","value":873},{"label":"Jun","value":741},{"label":"Jul","value":915},{"label":"Ago","value":977},{"label":"Set","value":1017},{"label":"Out","value":923},{"label":"Nov","value":665},{"label":"Dez","value":917}];
const MX = 1017;
