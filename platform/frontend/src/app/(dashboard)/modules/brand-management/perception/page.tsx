...
const ACCENT = "#3b82f6";
const MODULE = "Brand Management (APQC 3.3)";
const PAGE = "Perception";
const KPIS = [{"l":"Projetos Melhoria","v":"8.152","t":"+7.7%","d":"up"},{"l":"Savings (€)","v":"€65173","t":"+17.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"66.7%","t":"+0.0%","d":"up"},{"l":"Ciclos PDCA","v":"7.232","t":"+8.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.255","€ 2269.84","3.571","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","9.034","€ 5623.96","6.076","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.068","€ 45224.59","2.732","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.074","€ 19324.07","3.895","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","297","€ 25107.35","5.202","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":514},{"label":"Mar","value":475},{"label":"Abr","value":704},{"label":"Mai","value":726},{"label":"Jun","value":494},{"label":"Jul","value":700},{"label":"Ago","value":734},{"label":"Set","value":762},{"label":"Out","value":699},{"label":"Nov","value":613},{"label":"Dez","value":498}];
const MX = 762;
