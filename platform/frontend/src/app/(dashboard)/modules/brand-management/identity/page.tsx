...
const PAGE = "Brand Identity";
const KPIS = [{"l":"Utilizadores Ativos","v":"8.006","t":"+10.5%","d":"up"},{"l":"Sessões/Dia","v":"4006","t":"+2.2%","d":"up"},{"l":"MFA Adoção (%)","v":"94.2%","t":"+3.0%","d":"up"},{"l":"Tentativas Bloqueadas","v":"1.885","t":"-4.2%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.089","4.200","2.702","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","4.980","868","7.918","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","6.561","7.020","3.430","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.734","3.492","171","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.099","7.186","5.128","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":524},{"label":"Mar","value":800},{"label":"Abr","value":444},{"label":"Mai","value":665},{"label":"Jun","value":640},{"label":"Jul","value":717},{"label":"Ago","value":639},{"label":"Set","value":637},{"label":"Out","value":754},{"label":"Nov","value":514},{"label":"Dez","value":641}];
const MX = 800;
