...
const KPIS = [{"l":"Formulários Ativos","v":"835","t":"+2.9%","d":"up"},{"l":"Submissões/Dia","v":"3496","t":"+12.2%","d":"up"},{"l":"Documentos Gerados","v":"2.932","t":"+11.4%","d":"up"},{"l":"Templates","v":"195","t":"-4.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.598","2026-03-23","4.667","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.762","2026-03-07","5.115","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.685","2026-01-20","570","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","795","2026-02-14","786","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.868","2026-03-15","1.751","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":941},{"label":"Mar","value":942},{"label":"Abr","value":825},{"label":"Mai","value":767},{"label":"Jun","value":1035},{"label":"Jul","value":678},{"label":"Ago","value":885},{"label":"Set","value":650},{"label":"Out","value":738},{"label":"Nov","value":693},{"label":"Dez","value":665}];
const MX = 1035;
