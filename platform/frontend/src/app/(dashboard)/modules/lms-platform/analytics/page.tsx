...
const ACCENT = "#6366f1";
const MODULE = "LMS Platform";
const PAGE = "Analytics";
const KPIS = [{"l":"Formulários Ativos","v":"1.414","t":"+1.3%","d":"up"},{"l":"Submissões/Dia","v":"4089","t":"+5.9%","d":"up"},{"l":"Documentos Gerados","v":"7.866","t":"+6.2%","d":"up"},{"l":"Templates","v":"8.462","t":"+11.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.592","2026-01-21","7.435","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.747","2026-03-20","5.596","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.323","2026-03-28","7.039","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.708","2026-02-03","5.294","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.374","2026-01-03","8.158","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":543},{"label":"Mar","value":615},{"label":"Abr","value":528},{"label":"Mai","value":653},{"label":"Jun","value":424},{"label":"Jul","value":405},{"label":"Ago","value":371},{"label":"Set","value":396},{"label":"Out","value":623},{"label":"Nov","value":605},{"label":"Dez","value":456}];
const MX = 653;
