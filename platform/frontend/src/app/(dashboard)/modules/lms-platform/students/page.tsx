...
const PAGE = "Students";
const KPIS = [{"l":"Formulários Ativos","v":"1.472","t":"+12.7%","d":"up"},{"l":"Submissões/Dia","v":"360","t":"+11.8%","d":"up"},{"l":"Documentos Gerados","v":"5.298","t":"+0.6%","d":"up"},{"l":"Templates","v":"7.323","t":"+1.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.094","2026-03-02","8.802","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.367","2026-03-04","8.408","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.171","2026-03-17","5.468","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.961","2026-03-07","122","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.968","2026-02-08","1.731","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":930},{"label":"Fev","value":818},{"label":"Mar","value":668},{"label":"Abr","value":933},{"label":"Mai","value":726},{"label":"Jun","value":895},{"label":"Jul","value":754},{"label":"Ago","value":867},{"label":"Set","value":937},{"label":"Out","value":764},{"label":"Nov","value":849},{"label":"Dez","value":593}];
const MX = 937;
