...
const PAGE = "Courses";
const KPIS = [{"l":"Formulários Ativos","v":"287","t":"+12.3%","d":"up"},{"l":"Submissões/Dia","v":"972","t":"-0.8%","d":"down"},{"l":"Documentos Gerados","v":"1.729","t":"+9.7%","d":"up"},{"l":"Templates","v":"272","t":"+8.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.346","2026-01-08","4.043","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.215","2026-02-28","5.122","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.529","2026-01-10","3.477","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.803","2026-03-21","5.459","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.448","2026-02-28","1.176","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":831},{"label":"Mar","value":825},{"label":"Abr","value":755},{"label":"Mai","value":639},{"label":"Jun","value":675},{"label":"Jul","value":844},{"label":"Ago","value":899},{"label":"Set","value":744},{"label":"Out","value":795},{"label":"Nov","value":634},{"label":"Dez","value":777}];
const MX = 899;
