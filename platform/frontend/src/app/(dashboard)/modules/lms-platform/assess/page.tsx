...
const KPIS = [{"l":"Formulários Ativos","v":"3.244","t":"+11.4%","d":"up"},{"l":"Submissões/Dia","v":"1032","t":"+16.3%","d":"up"},{"l":"Documentos Gerados","v":"7.279","t":"+17.2%","d":"up"},{"l":"Templates","v":"8.772","t":"+14.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.487","2026-03-06","2.833","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.135","2026-01-25","982","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.258","2026-01-20","6.730","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.890","2026-02-28","5.246","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","979","2026-03-06","5.198","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":255},{"label":"Mar","value":335},{"label":"Abr","value":396},{"label":"Mai","value":421},{"label":"Jun","value":589},{"label":"Jul","value":597},{"label":"Ago","value":370},{"label":"Set","value":511},{"label":"Out","value":477},{"label":"Nov","value":528},{"label":"Dez","value":391}];
const MX = 597;
