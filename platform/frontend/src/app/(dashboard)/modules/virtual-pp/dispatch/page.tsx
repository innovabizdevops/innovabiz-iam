...
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"3.877","t":"+8.1%","d":"up"},{"l":"Viagens/Dia","v":"3398","t":"-3.6%","d":"down"},{"l":"Pontualidade (%)","v":"88.9%","t":"-0.3%","d":"down"},{"l":"Passageiros/Dia","v":"3660","t":"+12.8%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-26","2026-02-18","4.969","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-06","2026-01-09","622","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-02","2026-02-18","4.600","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-23","2026-01-18","930","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-13","2026-02-19","4.099","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":862},{"label":"Fev","value":777},{"label":"Mar","value":724},{"label":"Abr","value":711},{"label":"Mai","value":1010},{"label":"Jun","value":951},{"label":"Jul","value":957},{"label":"Ago","value":800},{"label":"Set","value":716},{"label":"Out","value":903},{"label":"Nov","value":980},{"label":"Dez","value":977}];
const MX = 1010;
