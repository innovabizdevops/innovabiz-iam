...
const KPIS = [{"l":"Total Virtual Pp","v":"1.392","t":"+1.9%","d":"up"},{"l":"Portfolio Ativos","v":"1.818","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"79.2%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"60","t":"+2.4%","d":"up"}];
const COLS = ["ID","Portfolio","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Virtual Pp #001","Virtual Pp #002","620","9.047","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Virtual Pp #002","Virtual Pp #003","861","6.175","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Virtual Pp #003","Virtual Pp #004","4.211","2.611","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Virtual Pp #004","Virtual Pp #005","5.820","2.181","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Virtual Pp #005","Virtual Pp #001","5.088","5.150","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":595},{"label":"Mar","value":733},{"label":"Abr","value":437},{"label":"Mai","value":741},{"label":"Jun","value":692},{"label":"Jul","value":695},{"label":"Ago","value":685},{"label":"Set","value":386},{"label":"Out","value":679},{"label":"Nov","value":401},{"label":"Dez","value":724}];
const MX = 741;
