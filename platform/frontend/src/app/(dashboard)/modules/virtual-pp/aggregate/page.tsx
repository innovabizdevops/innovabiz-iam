...
const KPIS = [{"l":"Total Virtual Pp","v":"5.797","t":"-5.7%","d":"down"},{"l":"Aggregate Ativos","v":"3.638","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"67.0%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"64","t":"+16.7%","d":"up"}];
const COLS = ["ID","Aggregate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Virtual Pp #001","Virtual Pp #002","7.313","284","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Virtual Pp #002","Virtual Pp #003","5.960","3.963","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Virtual Pp #003","Virtual Pp #004","5.321","2.218","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Virtual Pp #004","Virtual Pp #005","8.312","3.832","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Virtual Pp #005","Virtual Pp #001","2.857","6.137","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":695},{"label":"Mar","value":569},{"label":"Abr","value":733},{"label":"Mai","value":865},{"label":"Jun","value":627},{"label":"Jul","value":538},{"label":"Ago","value":847},{"label":"Set","value":613},{"label":"Out","value":555},{"label":"Nov","value":623},{"label":"Dez","value":679}];
const MX = 865;
