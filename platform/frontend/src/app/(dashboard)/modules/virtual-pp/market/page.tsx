...
const PAGE = "Market";
const KPIS = [{"l":"Total Virtual Pp","v":"4.860","t":"+2.7%","d":"up"},{"l":"Market Ativos","v":"2.590","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"94.2%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"79","t":"+6.1%","d":"up"}];
const COLS = ["ID","Market","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Virtual Pp #001","Virtual Pp #002","6.017","5.763","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Virtual Pp #002","Virtual Pp #003","3.592","4.639","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Virtual Pp #003","Virtual Pp #004","3.360","8.017","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Virtual Pp #004","Virtual Pp #005","6.341","6.810","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Virtual Pp #005","Virtual Pp #001","1.843","2.282","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":522},{"label":"Mar","value":390},{"label":"Abr","value":364},{"label":"Mai","value":462},{"label":"Jun","value":697},{"label":"Jul","value":490},{"label":"Ago","value":703},{"label":"Set","value":527},{"label":"Out","value":591},{"label":"Nov","value":331},{"label":"Dez","value":512}];
const MX = 703;
