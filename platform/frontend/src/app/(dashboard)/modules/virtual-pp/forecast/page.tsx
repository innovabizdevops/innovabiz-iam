...
const ACCENT = "#6366f1";
const MODULE = "Virtual Power Plant";
const PAGE = "Forecast";
const KPIS = [{"l":"Total Virtual Pp","v":"3.177","t":"+15.7%","d":"up"},{"l":"Forecast Ativos","v":"7.256","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"71.0%","t":"+15.4%","d":"up"},{"l":"Score Performance","v":"92","t":"+5.4%","d":"up"}];
const COLS = ["ID","Forecast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Virtual Pp #001","Virtual Pp #002","3.874","328","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Virtual Pp #002","Virtual Pp #003","1.063","2.993","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Virtual Pp #003","Virtual Pp #004","3.097","3.071","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Virtual Pp #004","Virtual Pp #005","8.866","3.308","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Virtual Pp #005","Virtual Pp #001","2.056","6.885","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":1084},{"label":"Mar","value":940},{"label":"Abr","value":910},{"label":"Mai","value":1047},{"label":"Jun","value":705},{"label":"Jul","value":1064},{"label":"Ago","value":1013},{"label":"Set","value":1048},{"label":"Out","value":840},{"label":"Nov","value":979},{"label":"Dez","value":976}];
const MX = 1084;
