...
export default function VirtualPpPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Virtual Pp</h1><p className="text-sm text-muted-foreground">Virtual Pp • iBOS Enterprise</p></div>
