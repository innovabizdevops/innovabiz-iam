...
const KPIS = [
    { label: "Total Registos", value: "8860", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4963", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€367K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "-18%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1142419260", cells: ["PRO-5260", "Property Development Item 1", "25/1/2026", "€19 360"], status: "active" as const },
    { id: "1142422831", cells: ["PRO-8831", "Property Development Item 2", "12/8/2026", "€22 931"], status: "pending" as const },
    { id: "1142426402", cells: ["PRO-3402", "Property Development Item 3", "27/3/2026", "€26 502"], status: "completed" as const },
    { id: "1142429973", cells: ["PRO-6973", "Property Development Item 4", "14/10/2026", "€30 073"], status: "warning" as const },
    { id: "1142433544", cells: ["PRO-1544", "Property Development Item 5", "1/5/2026", "€33 644"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Property Development</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Property Development</p>
                    </div>
                </div>
