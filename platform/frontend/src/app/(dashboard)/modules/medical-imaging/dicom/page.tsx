...
const PAGE = "DICOM Viewer";
const KPIS = [{"l":"Integrações Ativas","v":"2.238","t":"+15.8%","d":"up"},{"l":"Chamadas/Hora","v":"2593","t":"+15.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.1%","t":"+17.4%","d":"up"},{"l":"Latência Média (ms)","v":"22ms","t":"+14.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.443","5.830","98.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.238","1.113","91.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.393","7.158","75.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.036","7.777","81.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","651","1.054","78.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":511},{"label":"Mar","value":582},{"label":"Abr","value":517},{"label":"Mai","value":523},{"label":"Jun","value":658},{"label":"Jul","value":470},{"label":"Ago","value":529},{"label":"Set","value":625},{"label":"Out","value":457},{"label":"Nov","value":804},{"label":"Dez","value":825}];
const MX = 830;
