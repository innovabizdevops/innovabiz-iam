...
const PAGE = "3D Reconstruct";
const KPIS = [{"l":"Integrações Ativas","v":"2.349","t":"+3.0%","d":"up"},{"l":"Chamadas/Hora","v":"214","t":"-1.7%","d":"down"},{"l":"Taxa Sucesso (%)","v":"72.6%","t":"-1.8%","d":"down"},{"l":"Latência Média (ms)","v":"111ms","t":"+8.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.084","8.391","71.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.653","5.807","85.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.653","7.062","94.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.534","6.148","99.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.399","5.168","89.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":489},{"label":"Fev","value":625},{"label":"Mar","value":543},{"label":"Abr","value":273},{"label":"Mai","value":274},{"label":"Jun","value":252},{"label":"Jul","value":476},{"label":"Ago","value":420},{"label":"Set","value":507},{"label":"Out","value":280},{"label":"Nov","value":336},{"label":"Dez","value":444}];
const MX = 625;
