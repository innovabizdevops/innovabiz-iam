...
const ACCENT = "#1e40af";
const MODULE = "Medical Imaging AI";
const PAGE = "AI Detect";
const KPIS = [{"l":"Integrações Ativas","v":"5.040","t":"-0.2%","d":"down"},{"l":"Chamadas/Hora","v":"4989","t":"+5.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"84.0%","t":"-1.5%","d":"down"},{"l":"Latência Média (ms)","v":"164ms","t":"+15.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.996","1.093","73.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.660","8.028","89.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.574","549","89.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.062","4.297","72.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.287","1.288","81.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":712},{"label":"Fev","value":751},{"label":"Mar","value":464},{"label":"Abr","value":818},{"label":"Mai","value":857},{"label":"Jun","value":495},{"label":"Jul","value":785},{"label":"Ago","value":760},{"label":"Set","value":623},{"label":"Out","value":566},{"label":"Nov","value":544},{"label":"Dez","value":756}];
const MX = 857;
