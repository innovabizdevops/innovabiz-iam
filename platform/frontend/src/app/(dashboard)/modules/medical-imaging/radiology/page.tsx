...
const PAGE = "Radiology Work";
const KPIS = [{"l":"Integrações Ativas","v":"751","t":"-3.8%","d":"down"},{"l":"Chamadas/Hora","v":"4697","t":"+15.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"85.2%","t":"-1.7%","d":"down"},{"l":"Latência Média (ms)","v":"55ms","t":"+9.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.380","3.347","91.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.981","4.357","72.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.761","4.680","93.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.845","4.620","77.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.894","1.095","88.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":764},{"label":"Fev","value":437},{"label":"Mar","value":706},{"label":"Abr","value":581},{"label":"Mai","value":557},{"label":"Jun","value":615},{"label":"Jul","value":703},{"label":"Ago","value":610},{"label":"Set","value":463},{"label":"Out","value":429},{"label":"Nov","value":544},{"label":"Dez","value":459}];
const MX = 764;
