...
const PAGE = "Pathology Digi";
const KPIS = [{"l":"Integrações Ativas","v":"7.393","t":"-0.5%","d":"down"},{"l":"Chamadas/Hora","v":"2148","t":"+7.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"66.8%","t":"-0.6%","d":"down"},{"l":"Latência Média (ms)","v":"141ms","t":"+5.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.504","7.390","74.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.569","4.082","74.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.612","5.380","97.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.029","7.572","74.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.561","5.711","75.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":961},{"label":"Mar","value":832},{"label":"Abr","value":839},{"label":"Mai","value":736},{"label":"Jun","value":799},{"label":"Jul","value":740},{"label":"Ago","value":624},{"label":"Set","value":792},{"label":"Out","value":959},{"label":"Nov","value":999},{"label":"Dez","value":967}];
const MX = 999;
