...
const PAGE = "Escalate";
const KPIS = [{"l":"Aprovações Pendentes","v":"5.126","t":"+15.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"89.8%","t":"+16.4%","d":"up"},{"l":"Tempo Médio (h)","v":"98h","t":"+9.4%","d":"up"},{"l":"Rejeitadas (%)","v":"74.4%","t":"+6.3%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","3.608","€ 4899.07","7.134","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","713","€ 24341.81","7.556","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","4.320","€ 34008.78","6.575","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","8.958","€ 22001.13","6.027","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","6.858","€ 7722.34","952","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":626},{"label":"Mar","value":399},{"label":"Abr","value":678},{"label":"Mai","value":676},{"label":"Jun","value":498},{"label":"Jul","value":393},{"label":"Ago","value":452},{"label":"Set","value":542},{"label":"Out","value":655},{"label":"Nov","value":572},{"label":"Dez","value":447}];
const MX = 678;
