...
/* ═══ SOC Automation Platform — Dashboard ═══ */

const ACCENT = "#7f1d1d";

const KPIS = [
    { label: "Total Registos", value: "6944", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4947", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€186K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "695125444", cells: ["SOC-2444", "SOC Automation Platform Item 1", "21/5/2026", "€25 544"], status: "active" as const },
    { id: "695129015", cells: ["SOC-6015", "SOC Automation Platform Item 2", "8/12/2026", "€29 115"], status: "pending" as const },
    { id: "695132586", cells: ["SOC-9586", "SOC Automation Platform Item 3", "23/7/2026", "€32 686"], status: "completed" as const },
    { id: "695136157", cells: ["SOC-4157", "SOC Automation Platform Item 4", "10/2/2026", "€36 257"], status: "warning" as const },
    { id: "695139728", cells: ["SOC-7728", "SOC Automation Platform Item 5", "25/9/2026", "€39 828"], status: "active" as const },
];
...
export default function SocAutomationPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SOC Automation Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SOC Automation Platform</p>
                    </div>
                </div>
