...
/* ═══ Pharma R&D — Toxicology ═══ */

const ACCENT = "#ef4444";

const KPIS = [
    { label: "Total", value: "4887", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "252", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2508", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "14913000", cells: ["PHA-1000", "Toxicology Item 1", "5/1/2026", "€13 100"], status: "active" as const },
    { id: "14916571", cells: ["PHA-4571", "Toxicology Item 2", "20/8/2026", "€16 671"], status: "pending" as const },
    { id: "14920142", cells: ["PHA-8142", "Toxicology Item 3", "7/3/2026", "€20 242"], status: "completed" as const },
    { id: "14923713", cells: ["PHA-2713", "Toxicology Item 4", "22/10/2026", "€23 813"], status: "warning" as const },
    { id: "14927284", cells: ["PHA-6284", "Toxicology Item 5", "9/5/2026", "€27 384"], status: "active" as const },
];
...
export default function PharmaRdToxicologyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Toxicology</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pharma R&D • Toxicology</p>
                    </div>
                </div>
