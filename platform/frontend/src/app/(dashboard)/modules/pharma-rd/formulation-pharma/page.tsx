...
/* ═══ Pharma R&D — Formulation Pharma ═══ */

const ACCENT = "#ef4444";

const KPIS = [
    { label: "Total", value: "2952", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "34", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2432", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1992014414", cells: ["PHA-9414", "Formulation Pharma Item 1", "27/3/2026", "€14 514"], status: "active" as const },
    { id: "1992017985", cells: ["PHA-3985", "Formulation Pharma Item 2", "14/10/2026", "€18 085"], status: "pending" as const },
    { id: "1992021556", cells: ["PHA-7556", "Formulation Pharma Item 3", "1/5/2026", "€21 656"], status: "completed" as const },
    { id: "1992025127", cells: ["PHA-2127", "Formulation Pharma Item 4", "16/12/2026", "€25 227"], status: "warning" as const },
    { id: "1992028698", cells: ["PHA-5698", "Formulation Pharma Item 5", "3/7/2026", "€28 798"], status: "active" as const },
];
...
export default function PharmaRdFormulationPharmaPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Formulation Pharma</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pharma R&D • Formulation Pharma</p>
                    </div>
                </div>
