...
/* ═══ Pharma R&D — Lead Optimize ═══ */

const ACCENT = "#ef4444";

const KPIS = [
    { label: "Total", value: "1195", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "414", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3303", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1167582442", cells: ["PHA-4442", "Lead Optimize Item 1", "27/11/2026", "€32 542"], status: "active" as const },
    { id: "1167586013", cells: ["PHA-8013", "Lead Optimize Item 2", "14/6/2026", "€36 113"], status: "pending" as const },
    { id: "1167589584", cells: ["PHA-2584", "Lead Optimize Item 3", "1/1/2026", "€39 684"], status: "completed" as const },
    { id: "1167593155", cells: ["PHA-6155", "Lead Optimize Item 4", "16/8/2026", "€43 255"], status: "warning" as const },
    { id: "1167596726", cells: ["PHA-9726", "Lead Optimize Item 5", "3/3/2026", "€46 826"], status: "active" as const },
];
...
export default function PharmaRdLeadOptimizePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Lead Optimize</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pharma R&D • Lead Optimize</p>
                    </div>
                </div>
