...
/* ═══ Pharma R&D — Regulatory Path ═══ */

const ACCENT = "#ef4444";

const KPIS = [
    { label: "Total", value: "4565", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "386", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1302", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1929011358", cells: ["PHA-6358", "Regulatory Path Item 1", "23/7/2026", "€11 458"], status: "active" as const },
    { id: "1929014929", cells: ["PHA-9929", "Regulatory Path Item 2", "10/2/2026", "€15 029"], status: "pending" as const },
    { id: "1929018500", cells: ["PHA-4500", "Regulatory Path Item 3", "25/9/2026", "€18 600"], status: "completed" as const },
    { id: "1929022071", cells: ["PHA-8071", "Regulatory Path Item 4", "12/4/2026", "€22 171"], status: "warning" as const },
    { id: "1929025642", cells: ["PHA-2642", "Regulatory Path Item 5", "27/11/2026", "€25 742"], status: "active" as const },
];
...
export default function PharmaRdRegulatoryPathPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Regulatory Path</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pharma R&D • Regulatory Path</p>
                    </div>
                </div>
