...
/* ═══ Pharma R&D — Analytical Method ═══ */

const ACCENT = "#ef4444";

const KPIS = [
    { label: "Total", value: "86", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "198", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1807", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1699437570", cells: ["PHA-4570", "Analytical Method Item 1", "27/7/2026", "€37 670"], status: "active" as const },
    { id: "1699441141", cells: ["PHA-8141", "Analytical Method Item 2", "14/2/2026", "€41 241"], status: "pending" as const },
    { id: "1699444712", cells: ["PHA-2712", "Analytical Method Item 3", "1/9/2026", "€44 812"], status: "completed" as const },
    { id: "1699448283", cells: ["PHA-6283", "Analytical Method Item 4", "16/4/2026", "€48 383"], status: "warning" as const },
    { id: "1699451854", cells: ["PHA-9854", "Analytical Method Item 5", "3/11/2026", "€1954"], status: "active" as const },
];
...
export default function PharmaRdAnalyticalMethodPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Analytical Method</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pharma R&D • Analytical Method</p>
                    </div>
                </div>
