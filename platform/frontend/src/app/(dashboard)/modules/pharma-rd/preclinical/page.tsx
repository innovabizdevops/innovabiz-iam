...
/* ═══ Pharma R&D — Preclinical ═══ */

const ACCENT = "#ef4444";

const KPIS = [
    { label: "Total", value: "3645", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "473", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2174", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "816548917", cells: ["PHA-6917", "Preclinical Item 1", "10/2/2026", "€49 017"], status: "active" as const },
    { id: "816552488", cells: ["PHA-1488", "Preclinical Item 2", "25/9/2026", "€2588"], status: "pending" as const },
    { id: "816556059", cells: ["PHA-5059", "Preclinical Item 3", "12/4/2026", "€6159"], status: "completed" as const },
    { id: "816559630", cells: ["PHA-8630", "Preclinical Item 4", "27/11/2026", "€9730"], status: "warning" as const },
    { id: "816563201", cells: ["PHA-3201", "Preclinical Item 5", "14/6/2026", "€13 301"], status: "active" as const },
];
...
export default function PharmaRdPreclinicalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Preclinical</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pharma R&D • Preclinical</p>
                    </div>
                </div>
