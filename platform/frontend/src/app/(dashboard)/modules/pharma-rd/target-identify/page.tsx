...
/* ═══ Pharma R&D — Target Identify ═══ */

const ACCENT = "#ef4444";

const KPIS = [
    { label: "Total", value: "3587", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "340", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "657", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2010878096", cells: ["PHA-9096", "Target Identify Item 1", "25/9/2026", "€28 196"], status: "active" as const },
    { id: "2010881667", cells: ["PHA-3667", "Target Identify Item 2", "12/4/2026", "€31 767"], status: "pending" as const },
    { id: "2010885238", cells: ["PHA-7238", "Target Identify Item 3", "27/11/2026", "€35 338"], status: "completed" as const },
    { id: "2010888809", cells: ["PHA-1809", "Target Identify Item 4", "14/6/2026", "€38 909"], status: "warning" as const },
    { id: "2010892380", cells: ["PHA-5380", "Target Identify Item 5", "1/1/2026", "€42 480"], status: "active" as const },
];
...
export default function PharmaRdTargetIdentifyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Target Identify</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pharma R&D • Target Identify</p>
                    </div>
                </div>
