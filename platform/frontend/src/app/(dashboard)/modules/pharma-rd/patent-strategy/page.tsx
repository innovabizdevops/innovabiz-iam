...
/* ═══ Pharma R&D — Patent Strategy ═══ */

const ACCENT = "#ef4444";

const KPIS = [
    { label: "Total", value: "4894", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "356", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1787", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1660221984", cells: ["PHA-1984", "Patent Strategy Item 1", "9/1/2026", "€22 084"], status: "active" as const },
    { id: "1660225555", cells: ["PHA-5555", "Patent Strategy Item 2", "24/8/2026", "€25 655"], status: "pending" as const },
    { id: "1660229126", cells: ["PHA-9126", "Patent Strategy Item 3", "11/3/2026", "€29 226"], status: "completed" as const },
    { id: "1660232697", cells: ["PHA-3697", "Patent Strategy Item 4", "26/10/2026", "€32 797"], status: "warning" as const },
    { id: "1660236268", cells: ["PHA-7268", "Patent Strategy Item 5", "13/5/2026", "€36 368"], status: "active" as const },
];
...
export default function PharmaRdPatentStrategyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Patent Strategy</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pharma R&D • Patent Strategy</p>
                    </div>
                </div>
