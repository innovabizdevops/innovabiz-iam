...
/* ═══ Pharma R&D — Process Dev Pharma ═══ */

const ACCENT = "#ef4444";

const KPIS = [
    { label: "Total", value: "4800", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "8", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3910", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "75%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "739225028", cells: ["PHA-2028", "Process Dev Pharma Item 1", "25/9/2026", "€25 128"], status: "active" as const },
    { id: "739228599", cells: ["PHA-5599", "Process Dev Pharma Item 2", "12/4/2026", "€28 699"], status: "pending" as const },
    { id: "739232170", cells: ["PHA-9170", "Process Dev Pharma Item 3", "27/11/2026", "€32 270"], status: "completed" as const },
    { id: "739235741", cells: ["PHA-3741", "Process Dev Pharma Item 4", "14/6/2026", "€35 841"], status: "warning" as const },
    { id: "739239312", cells: ["PHA-7312", "Process Dev Pharma Item 5", "1/1/2026", "€39 412"], status: "active" as const },
];
...
export default function PharmaRdProcessDevPharmaPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Process Dev Pharma</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pharma R&D • Process Dev Pharma</p>
                    </div>
                </div>
