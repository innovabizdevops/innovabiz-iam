...
/* ═══ Pharma R&D — Pharmacokinetic ═══ */

const ACCENT = "#ef4444";

const KPIS = [
    { label: "Total", value: "898", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "441", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3377", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "64370341", cells: ["PHA-3341", "Pharmacokinetic Item 1", "22/2/2026", "€20 441"], status: "active" as const },
    { id: "64373912", cells: ["PHA-6912", "Pharmacokinetic Item 2", "9/9/2026", "€24 012"], status: "pending" as const },
    { id: "64377483", cells: ["PHA-1483", "Pharmacokinetic Item 3", "24/4/2026", "€27 583"], status: "completed" as const },
    { id: "64381054", cells: ["PHA-5054", "Pharmacokinetic Item 4", "11/11/2026", "€31 154"], status: "warning" as const },
    { id: "64384625", cells: ["PHA-8625", "Pharmacokinetic Item 5", "26/6/2026", "€34 725"], status: "active" as const },
];
...
export default function PharmaRdPharmacokineticPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pharmacokinetic</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Pharma R&D • Pharmacokinetic</p>
                    </div>
                </div>
