...
const KPIS = [{"l":"ARR (€M)","v":"€50.4M","t":"-1.3%","d":"down"},{"l":"MRR (€)","v":"€18616","t":"+15.4%","d":"up"},{"l":"Churn (%)","v":"68.4%","t":"+17.6%","d":"up"},{"l":"ARPU (€)","v":"€57927","t":"+5.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 30642.99","1.496","€ 39905.24","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 34316.26","7.472","€ 32611.28","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 10715.88","3.757","€ 48494.15","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 28151.53","1.471","€ 45853.55","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 46224.92","3.222","€ 27316.10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":708},{"label":"Mar","value":613},{"label":"Abr","value":917},{"label":"Mai","value":763},{"label":"Jun","value":625},{"label":"Jul","value":843},{"label":"Ago","value":880},{"label":"Set","value":917},{"label":"Out","value":953},{"label":"Nov","value":893},{"label":"Dez","value":600}];
const MX = 953;
