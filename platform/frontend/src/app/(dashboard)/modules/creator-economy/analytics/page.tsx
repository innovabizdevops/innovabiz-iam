...
const KPIS = [{"l":"Dashboards Ativos","v":"5.827","t":"-2.1%","d":"down"},{"l":"Queries/Dia","v":"2015","t":"+12.1%","d":"up"},{"l":"Dados Processados (GB)","v":"9.098","t":"-3.4%","d":"down"},{"l":"Utilizadores Analytics","v":"3.779","t":"+9.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","884","2026-02-28","6.877","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","500","2026-03-02","7.963","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2699","2026-01-21","5.929","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2421","2026-01-15","4.038","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2104","2026-03-27","5.353","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1045},{"label":"Fev","value":1016},{"label":"Mar","value":699},{"label":"Abr","value":783},{"label":"Mai","value":779},{"label":"Jun","value":672},{"label":"Jul","value":937},{"label":"Ago","value":979},{"label":"Set","value":654},{"label":"Out","value":895},{"label":"Nov","value":652},{"label":"Dez","value":982}];
const MX = 1045;
