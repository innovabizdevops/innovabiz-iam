...
const PAGE = "Monetize";
const KPIS = [{"l":"ARR (€M)","v":"€9.5M","t":"+17.0%","d":"up"},{"l":"MRR (€)","v":"€56039","t":"+0.5%","d":"up"},{"l":"Churn (%)","v":"82.5%","t":"+3.9%","d":"up"},{"l":"ARPU (€)","v":"€8493","t":"+15.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 13693.59","504","€ 39983.67","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 44750.66","5.268","€ 47504.82","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 17711.03","610","€ 44460.71","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 31861.06","5.742","€ 181.37","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 46876.34","5.713","€ 39879.85","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":501},{"label":"Fev","value":630},{"label":"Mar","value":360},{"label":"Abr","value":585},{"label":"Mai","value":581},{"label":"Jun","value":260},{"label":"Jul","value":316},{"label":"Ago","value":297},{"label":"Set","value":289},{"label":"Out","value":420},{"label":"Nov","value":612},{"label":"Dez","value":437}];
const MX = 630;
