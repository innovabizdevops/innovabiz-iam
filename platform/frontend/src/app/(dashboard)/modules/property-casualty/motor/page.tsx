...
const PAGE = "Motor";
const KPIS = [{"l":"Total Property Casualty","v":"530","t":"+1.8%","d":"up"},{"l":"Motor Ativos","v":"3.969","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"77.2%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"87","t":"+11.9%","d":"up"}];
const COLS = ["ID","Motor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Property Casualty #001","Property Casualty #002","5.309","8.140","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Property Casualty #002","Property Casualty #003","3.067","591","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Property Casualty #003","Property Casualty #004","3.163","6.740","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Property Casualty #004","Property Casualty #005","8.739","3.892","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Property Casualty #005","Property Casualty #001","4.138","7.766","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":521},{"label":"Mar","value":342},{"label":"Abr","value":295},{"label":"Mai","value":690},{"label":"Jun","value":493},{"label":"Jul","value":628},{"label":"Ago","value":370},{"label":"Set","value":693},{"label":"Out","value":672},{"label":"Nov","value":326},{"label":"Dez","value":300}];
const MX = 693;
