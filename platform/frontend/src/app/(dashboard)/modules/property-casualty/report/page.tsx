...
const PAGE = "Report";
const KPIS = [{"l":"Total Property Casualty","v":"2.479","t":"+16.3%","d":"up"},{"l":"Report Ativos","v":"3.386","t":"+14.9%","d":"up"},{"l":"Eficiência (%)","v":"65.7%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"89","t":"-0.1%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Property Casualty #001","Property Casualty #002","3.959","1.989","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Property Casualty #002","Property Casualty #003","1.995","8.467","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Property Casualty #003","Property Casualty #004","3.683","5.460","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Property Casualty #004","Property Casualty #005","8.798","8.690","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Property Casualty #005","Property Casualty #001","7.979","1.684","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":702},{"label":"Mar","value":860},{"label":"Abr","value":954},{"label":"Mai","value":870},{"label":"Jun","value":837},{"label":"Jul","value":933},{"label":"Ago","value":1006},{"label":"Set","value":920},{"label":"Out","value":941},{"label":"Nov","value":837},{"label":"Dez","value":964}];
const MX = 1006;
