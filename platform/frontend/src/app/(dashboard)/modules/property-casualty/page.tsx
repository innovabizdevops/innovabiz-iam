...
/* ═══ Property & Casualty Platform — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "8107", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4001", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€356K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "-15%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "841013007", cells: ["PRO-9007", "Property & Casualty Platform Item 1", "24/4/2026", "€13 107"], status: "active" as const },
    { id: "841016578", cells: ["PRO-3578", "Property & Casualty Platform Item 2", "11/11/2026", "€16 678"], status: "pending" as const },
    { id: "841020149", cells: ["PRO-7149", "Property & Casualty Platform Item 3", "26/6/2026", "€20 249"], status: "completed" as const },
    { id: "841023720", cells: ["PRO-1720", "Property & Casualty Platform Item 4", "13/1/2026", "€23 820"], status: "warning" as const },
    { id: "841027291", cells: ["PRO-5291", "Property & Casualty Platform Item 5", "28/8/2026", "€27 391"], status: "active" as const },
];
...
export default function PropertyCasualtyPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Property & Casualty Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Property & Casualty Platform</p>
                    </div>
                </div>
