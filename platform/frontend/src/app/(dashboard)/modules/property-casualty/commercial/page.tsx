...
const ACCENT = "#92400e";
const MODULE = "Property & Casualty Platform";
const PAGE = "Commercial";
const KPIS = [{"l":"Total Property Casualty","v":"461","t":"-0.5%","d":"down"},{"l":"Commercial Ativos","v":"739","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"82.7%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"93","t":"+11.1%","d":"up"}];
const COLS = ["ID","Commercial","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Property Casualty #001","Property Casualty #002","767","1.042","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Property Casualty #002","Property Casualty #003","1.512","2.725","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Property Casualty #003","Property Casualty #004","3.386","4.331","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Property Casualty #004","Property Casualty #005","6.489","3.515","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Property Casualty #005","Property Casualty #001","342","6.051","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":429},{"label":"Fev","value":501},{"label":"Mar","value":220},{"label":"Abr","value":425},{"label":"Mai","value":503},{"label":"Jun","value":336},{"label":"Jul","value":445},{"label":"Ago","value":569},{"label":"Set","value":546},{"label":"Out","value":522},{"label":"Nov","value":334},{"label":"Dez","value":541}];
const MX = 569;
