...
const PAGE = "Marine";
const KPIS = [{"l":"Total Property Casualty","v":"7.721","t":"+13.8%","d":"up"},{"l":"Marine Ativos","v":"8.204","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"87.8%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"60","t":"-2.4%","d":"down"}];
const COLS = ["ID","Marine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Property Casualty #001","Property Casualty #002","7.725","1.787","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Property Casualty #002","Property Casualty #003","5.736","8.880","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Property Casualty #003","Property Casualty #004","4.481","2.028","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Property Casualty #004","Property Casualty #005","2.573","6.241","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Property Casualty #005","Property Casualty #001","2.160","8.106","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":961},{"label":"Fev","value":1042},{"label":"Mar","value":684},{"label":"Abr","value":1030},{"label":"Mai","value":815},{"label":"Jun","value":795},{"label":"Jul","value":962},{"label":"Ago","value":992},{"label":"Set","value":710},{"label":"Out","value":689},{"label":"Nov","value":687},{"label":"Dez","value":910}];
const MX = 1042;
