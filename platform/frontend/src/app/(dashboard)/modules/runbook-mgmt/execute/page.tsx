...
const PAGE = "Execute";
const KPIS = [{"l":"BCP Plans Ativos","v":"7.704","t":"+16.0%","d":"up"},{"l":"RTO Médio (h)","v":"198h","t":"-4.0%","d":"down"},{"l":"RPO Médio (h)","v":"100h","t":"-2.0%","d":"down"},{"l":"Testes DR (YTD)","v":"6.682","t":"+11.4%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","148h","119h","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","171h","88h","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","206h","125h","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","117h","67h","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","37h","101h","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":875},{"label":"Mar","value":837},{"label":"Abr","value":800},{"label":"Mai","value":827},{"label":"Jun","value":950},{"label":"Jul","value":849},{"label":"Ago","value":986},{"label":"Set","value":670},{"label":"Out","value":644},{"label":"Nov","value":934},{"label":"Dez","value":974}];
const MX = 986;
