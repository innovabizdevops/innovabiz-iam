...
const PAGE = "Automate";
const KPIS = [{"l":"BCP Plans Ativos","v":"7.703","t":"-2.4%","d":"down"},{"l":"RTO Médio (h)","v":"207h","t":"-0.5%","d":"down"},{"l":"RPO Médio (h)","v":"42h","t":"+5.6%","d":"up"},{"l":"Testes DR (YTD)","v":"2.874","t":"-5.7%","d":"down"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","126h","15h","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","81h","67h","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","23h","32h","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","123h","61h","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","144h","106h","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":334},{"label":"Fev","value":417},{"label":"Mar","value":362},{"label":"Abr","value":627},{"label":"Mai","value":314},{"label":"Jun","value":378},{"label":"Jul","value":539},{"label":"Ago","value":594},{"label":"Set","value":301},{"label":"Out","value":594},{"label":"Nov","value":481},{"label":"Dez","value":300}];
const MX = 627;
