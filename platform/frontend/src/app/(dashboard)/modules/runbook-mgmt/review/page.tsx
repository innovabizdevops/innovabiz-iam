...
const PAGE = "Review";
const KPIS = [{"l":"BCP Plans Ativos","v":"1.943","t":"+5.6%","d":"up"},{"l":"RTO Médio (h)","v":"128h","t":"+11.2%","d":"up"},{"l":"RPO Médio (h)","v":"195h","t":"+10.0%","d":"up"},{"l":"Testes DR (YTD)","v":"873","t":"+10.3%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","10h","29h","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","85h","88h","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","19h","122h","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","187h","180h","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","190h","84h","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":873},{"label":"Mar","value":632},{"label":"Abr","value":809},{"label":"Mai","value":606},{"label":"Jun","value":652},{"label":"Jul","value":801},{"label":"Ago","value":778},{"label":"Set","value":523},{"label":"Out","value":739},{"label":"Nov","value":869},{"label":"Dez","value":496}];
const MX = 873;
