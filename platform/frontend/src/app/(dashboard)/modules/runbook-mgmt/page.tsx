...
const KPIS = [
    { label: "Total Registos", value: "3721", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3901", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€470K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1056660321", cells: ["RUN-7321", "Runbook Management Item 1", "18/10/2026", "€10 421"], status: "active" as const },
    { id: "1056663892", cells: ["RUN-1892", "Runbook Management Item 2", "5/5/2026", "€13 992"], status: "pending" as const },
    { id: "1056667463", cells: ["RUN-5463", "Runbook Management Item 3", "20/12/2026", "€17 563"], status: "completed" as const },
    { id: "1056671034", cells: ["RUN-9034", "Runbook Management Item 4", "7/7/2026", "€21 134"], status: "warning" as const },
    { id: "1056674605", cells: ["RUN-3605", "Runbook Management Item 5", "22/2/2026", "€24 705"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Runbook Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Runbook Management</p>
                    </div>
                </div>
