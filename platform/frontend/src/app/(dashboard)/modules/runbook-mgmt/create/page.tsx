...
const PAGE = "Create";
const KPIS = [{"l":"BCP Plans Ativos","v":"1.143","t":"+17.2%","d":"up"},{"l":"RTO Médio (h)","v":"177h","t":"+14.2%","d":"up"},{"l":"RPO Médio (h)","v":"44h","t":"+14.8%","d":"up"},{"l":"Testes DR (YTD)","v":"890","t":"+1.6%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","63h","26h","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","14h","190h","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","174h","74h","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","127h","32h","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","105h","146h","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":599},{"label":"Mar","value":755},{"label":"Abr","value":487},{"label":"Mai","value":550},{"label":"Jun","value":864},{"label":"Jul","value":809},{"label":"Ago","value":686},{"label":"Set","value":491},{"label":"Out","value":592},{"label":"Nov","value":566},{"label":"Dez","value":624}];
const MX = 864;
