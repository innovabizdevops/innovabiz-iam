...
const ACCENT = "#1e40af";
const MODULE = "Runbook Management";
const PAGE = "Version";
const KPIS = [{"l":"Formulários Ativos","v":"332","t":"+0.7%","d":"up"},{"l":"Submissões/Dia","v":"640","t":"+13.6%","d":"up"},{"l":"Documentos Gerados","v":"7.813","t":"-4.8%","d":"down"},{"l":"Templates","v":"6.929","t":"+16.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.049","2026-01-03","8.465","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","102","2026-02-25","6.584","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.216","2026-02-27","8.507","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.503","2026-01-13","959","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.854","2026-01-08","4.740","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":473},{"label":"Mar","value":563},{"label":"Abr","value":401},{"label":"Mai","value":636},{"label":"Jun","value":567},{"label":"Jul","value":397},{"label":"Ago","value":555},{"label":"Set","value":289},{"label":"Out","value":303},{"label":"Nov","value":474},{"label":"Dez","value":490}];
const MX = 675;
