...
const KPIS = [{"l":"Riscos Identificados","v":"1.882","t":"+10.1%","d":"up"},{"l":"Mitigações Ativas","v":"5.341","t":"-1.6%","d":"down"},{"l":"Score Risco Geral","v":"83","t":"+4.4%","d":"up"},{"l":"Incidentes YTD","v":"8.483","t":"-0.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.296","2.681","1.292","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.519","8.676","495","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.690","4.817","6.178","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.373","1.841","6.171","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.940","4.362","2.316","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":813},{"label":"Fev","value":960},{"label":"Mar","value":616},{"label":"Abr","value":809},{"label":"Mai","value":591},{"label":"Jun","value":771},{"label":"Jul","value":801},{"label":"Ago","value":958},{"label":"Set","value":908},{"label":"Out","value":852},{"label":"Nov","value":698},{"label":"Dez","value":937}];
const MX = 960;
