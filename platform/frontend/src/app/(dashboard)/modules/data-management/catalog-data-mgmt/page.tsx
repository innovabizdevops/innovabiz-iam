...
const KPIS = [{"l":"Dashboards Ativos","v":"3.189","t":"+5.0%","d":"up"},{"l":"Queries/Dia","v":"4366","t":"+10.3%","d":"up"},{"l":"Dados Processados (GB)","v":"2.237","t":"+9.9%","d":"up"},{"l":"Utilizadores Analytics","v":"464","t":"+12.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3846","2026-02-21","2.911","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1708","2026-03-07","8.587","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4046","2026-03-28","3.468","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","666","2026-02-14","2.867","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2619","2026-03-10","3.503","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":422},{"label":"Fev","value":654},{"label":"Mar","value":341},{"label":"Abr","value":296},{"label":"Mai","value":516},{"label":"Jun","value":390},{"label":"Jul","value":380},{"label":"Ago","value":654},{"label":"Set","value":307},{"label":"Out","value":355},{"label":"Nov","value":652},{"label":"Dez","value":378}];
const MX = 654;
...
export default function CatalogDataMgmtPage() {
    return (
