...
const KPIS = [{"l":"Dashboards Ativos","v":"1.048","t":"-5.4%","d":"down"},{"l":"Queries/Dia","v":"2281","t":"+6.9%","d":"up"},{"l":"Dados Processados (GB)","v":"4.789","t":"+15.3%","d":"up"},{"l":"Utilizadores Analytics","v":"3.503","t":"-3.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4203","2026-02-01","5.988","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1766","2026-03-05","5.348","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1207","2026-01-12","1.608","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1598","2026-01-19","2.012","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2158","2026-03-15","7.895","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":799},{"label":"Mar","value":717},{"label":"Abr","value":988},{"label":"Mai","value":732},{"label":"Jun","value":766},{"label":"Jul","value":746},{"label":"Ago","value":836},{"label":"Set","value":957},{"label":"Out","value":883},{"label":"Nov","value":976},{"label":"Dez","value":746}];
const MX = 988;
