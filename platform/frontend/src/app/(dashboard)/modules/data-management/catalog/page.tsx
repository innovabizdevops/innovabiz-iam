...
const KPIS = [{"l":"Dashboards Ativos","v":"1.952","t":"+13.7%","d":"up"},{"l":"Queries/Dia","v":"1281","t":"+13.5%","d":"up"},{"l":"Dados Processados (GB)","v":"6.129","t":"+11.6%","d":"up"},{"l":"Utilizadores Analytics","v":"8.729","t":"+9.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3133","2026-01-22","6.111","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","956","2026-03-10","1.213","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","5052","2026-03-13","4.477","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4287","2026-02-21","2.691","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","429","2026-02-04","3.359","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":635},{"label":"Mar","value":545},{"label":"Abr","value":811},{"label":"Mai","value":763},{"label":"Jun","value":721},{"label":"Jul","value":578},{"label":"Ago","value":584},{"label":"Set","value":570},{"label":"Out","value":736},{"label":"Nov","value":499},{"label":"Dez","value":782}];
const MX = 811;
