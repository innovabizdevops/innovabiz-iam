...
const PAGE = "AI Intelligence";
const KPIS = [{"l":"Dashboards Ativos","v":"5.783","t":"+9.2%","d":"up"},{"l":"Queries/Dia","v":"2986","t":"+13.4%","d":"up"},{"l":"Dados Processados (GB)","v":"405","t":"+14.2%","d":"up"},{"l":"Utilizadores Analytics","v":"5.071","t":"+14.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3082","2026-03-10","1.861","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2015","2026-02-17","5.489","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","611","2026-01-26","5.964","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","221","2026-02-06","715","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1756","2026-01-21","5.206","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":920},{"label":"Fev","value":646},{"label":"Mar","value":715},{"label":"Abr","value":955},{"label":"Mai","value":645},{"label":"Jun","value":866},{"label":"Jul","value":813},{"label":"Ago","value":934},{"label":"Set","value":954},{"label":"Out","value":818},{"label":"Nov","value":719},{"label":"Dez","value":609}];
const MX = 955;
