...
const PAGE = "DAMA-DMBOK";
const KPIS = [{"l":"Dashboards Ativos","v":"3.849","t":"+8.7%","d":"up"},{"l":"Queries/Dia","v":"4497","t":"+9.1%","d":"up"},{"l":"Dados Processados (GB)","v":"886","t":"+1.4%","d":"up"},{"l":"Utilizadores Analytics","v":"1.581","t":"+8.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1212","2026-01-15","8.522","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1910","2026-03-12","2.747","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1509","2026-01-27","1.383","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1582","2026-01-12","4.302","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","233","2026-02-28","7.564","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":862},{"label":"Fev","value":546},{"label":"Mar","value":680},{"label":"Abr","value":663},{"label":"Mai","value":810},{"label":"Jun","value":685},{"label":"Jul","value":843},{"label":"Ago","value":667},{"label":"Set","value":705},{"label":"Out","value":707},{"label":"Nov","value":710},{"label":"Dez","value":661}];
const MX = 862;
...
export default function DamaDmbokPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>DAMA</span></h1>
                </div>
