...
const PAGE = "Data Lineage";
const KPIS = [{"l":"Dashboards Ativos","v":"8.820","t":"+0.4%","d":"up"},{"l":"Queries/Dia","v":"3502","t":"+14.6%","d":"up"},{"l":"Dados Processados (GB)","v":"2.235","t":"+9.1%","d":"up"},{"l":"Utilizadores Analytics","v":"7.649","t":"-4.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4010","2026-01-08","832","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4074","2026-03-16","909","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3259","2026-03-16","3.834","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3872","2026-03-21","9.003","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3095","2026-01-07","5.982","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":285},{"label":"Mar","value":472},{"label":"Abr","value":511},{"label":"Mai","value":412},{"label":"Jun","value":606},{"label":"Jul","value":498},{"label":"Ago","value":332},{"label":"Set","value":327},{"label":"Out","value":606},{"label":"Nov","value":340},{"label":"Dez","value":338}];
const MX = 606;
