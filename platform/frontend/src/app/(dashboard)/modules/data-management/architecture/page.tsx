...
const KPIS = [{"l":"Dashboards Ativos","v":"6.075","t":"-5.6%","d":"down"},{"l":"Queries/Dia","v":"2206","t":"-5.7%","d":"down"},{"l":"Dados Processados (GB)","v":"2.258","t":"+9.8%","d":"up"},{"l":"Utilizadores Analytics","v":"1.422","t":"+8.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1706","2026-02-19","323","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2090","2026-02-17","5.525","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2146","2026-02-01","8.453","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2197","2026-03-06","4.785","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2109","2026-01-23","3.494","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":995},{"label":"Fev","value":1022},{"label":"Mar","value":1004},{"label":"Abr","value":986},{"label":"Mai","value":685},{"label":"Jun","value":1015},{"label":"Jul","value":966},{"label":"Ago","value":741},{"label":"Set","value":843},{"label":"Out","value":967},{"label":"Nov","value":975},{"label":"Dez","value":948}];
const MX = 1022;
