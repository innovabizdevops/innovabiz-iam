...
const ACCENT = "#6366f1";
const MODULE = "Data Management";
const PAGE = "DCAM Framework";
const KPIS = [{"l":"Dashboards Ativos","v":"973","t":"-1.2%","d":"down"},{"l":"Queries/Dia","v":"222","t":"-0.7%","d":"down"},{"l":"Dados Processados (GB)","v":"8.518","t":"+13.9%","d":"up"},{"l":"Utilizadores Analytics","v":"4.994","t":"+2.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2204","2026-01-03","7.181","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1250","2026-02-25","1.482","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4771","2026-03-23","5.371","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3396","2026-03-20","7.453","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4222","2026-01-10","3.810","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":499},{"label":"Mar","value":718},{"label":"Abr","value":563},{"label":"Mai","value":440},{"label":"Jun","value":440},{"label":"Jul","value":677},{"label":"Ago","value":789},{"label":"Set","value":479},{"label":"Out","value":777},{"label":"Nov","value":539},{"label":"Dez","value":459}];
const MX = 789;
...
export default function DcamPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>DCAM</span></h1>
                </div>
