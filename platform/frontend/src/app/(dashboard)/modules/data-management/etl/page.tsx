...
const KPIS = [{"l":"Dashboards Ativos","v":"908","t":"+17.8%","d":"up"},{"l":"Queries/Dia","v":"3926","t":"-3.9%","d":"down"},{"l":"Dados Processados (GB)","v":"2.336","t":"-0.2%","d":"down"},{"l":"Utilizadores Analytics","v":"568","t":"+2.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4631","2026-03-08","2.588","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","707","2026-03-11","4.426","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2656","2026-01-11","5.213","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","496","2026-03-25","3.393","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1675","2026-02-10","2.179","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":450},{"label":"Mar","value":266},{"label":"Abr","value":476},{"label":"Mai","value":584},{"label":"Jun","value":285},{"label":"Jul","value":298},{"label":"Ago","value":542},{"label":"Set","value":364},{"label":"Out","value":496},{"label":"Nov","value":396},{"label":"Dez","value":354}];
const MX = 584;
