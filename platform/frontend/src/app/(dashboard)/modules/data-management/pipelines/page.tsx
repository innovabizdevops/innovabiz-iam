...
const KPIS = [{"l":"Dashboards Ativos","v":"1.687","t":"+10.2%","d":"up"},{"l":"Queries/Dia","v":"3281","t":"+1.5%","d":"up"},{"l":"Dados Processados (GB)","v":"8.107","t":"+4.1%","d":"up"},{"l":"Utilizadores Analytics","v":"2.249","t":"+2.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","597","2026-01-05","1.782","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2845","2026-01-16","7.790","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2809","2026-03-13","7.759","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1982","2026-03-22","6.124","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3846","2026-03-21","2.271","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":796},{"label":"Fev","value":742},{"label":"Mar","value":677},{"label":"Abr","value":768},{"label":"Mai","value":667},{"label":"Jun","value":895},{"label":"Jul","value":740},{"label":"Ago","value":677},{"label":"Set","value":667},{"label":"Out","value":759},{"label":"Nov","value":874},{"label":"Dez","value":650}];
const MX = 895;
