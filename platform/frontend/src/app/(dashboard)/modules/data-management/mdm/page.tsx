...
const PAGE = "MDM";
const KPIS = [{"l":"Dashboards Ativos","v":"358","t":"+2.8%","d":"up"},{"l":"Queries/Dia","v":"3836","t":"+13.9%","d":"up"},{"l":"Dados Processados (GB)","v":"6.969","t":"-3.0%","d":"down"},{"l":"Utilizadores Analytics","v":"3.230","t":"+5.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1262","2026-02-08","792","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2815","2026-02-09","1.405","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1040","2026-03-11","8.405","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1001","2026-01-12","2.777","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2185","2026-03-05","7.584","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":841},{"label":"Mar","value":744},{"label":"Abr","value":813},{"label":"Mai","value":496},{"label":"Jun","value":673},{"label":"Jul","value":668},{"label":"Ago","value":527},{"label":"Set","value":784},{"label":"Out","value":598},{"label":"Nov","value":820},{"label":"Dez","value":484}];
const MX = 841;
