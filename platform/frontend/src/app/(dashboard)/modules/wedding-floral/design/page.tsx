...
const ACCENT = "#831843";
const MODULE = "Wedding Florist";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"1.108","t":"+1.8%","d":"up"},{"l":"Submissões/Dia","v":"1984","t":"+1.3%","d":"up"},{"l":"Documentos Gerados","v":"2.566","t":"+2.7%","d":"up"},{"l":"Templates","v":"7.815","t":"+13.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.031","2026-03-11","7.523","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.544","2026-03-15","3.071","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.335","2026-01-19","7.638","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.156","2026-02-20","776","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.885","2026-01-28","4.069","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":653},{"label":"Mar","value":630},{"label":"Abr","value":767},{"label":"Mai","value":466},{"label":"Jun","value":637},{"label":"Jul","value":673},{"label":"Ago","value":731},{"label":"Set","value":434},{"label":"Out","value":518},{"label":"Nov","value":723},{"label":"Dez","value":687}];
const MX = 767;
