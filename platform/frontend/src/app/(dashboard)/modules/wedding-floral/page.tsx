...
/* ═══ Wedding Florist — Dashboard ═══ */

const ACCENT = "#831843";

const KPIS = [
    { label: "Total Registos", value: "7232", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4814", trend: "-2%", trendDirection: "down" as const, icon: Users },
...
const TABLE_ROWS = [
    { id: "1515202132", cells: ["WED-8132", "Wedding Florist Item 1", "25/5/2026", "€2232"], status: "active" as const },
    { id: "1515205703", cells: ["WED-2703", "Wedding Florist Item 2", "12/12/2026", "€5803"], status: "pending" as const },
    { id: "1515209274", cells: ["WED-6274", "Wedding Florist Item 3", "27/7/2026", "€9374"], status: "completed" as const },
    { id: "1515212845", cells: ["WED-9845", "Wedding Florist Item 4", "14/2/2026", "€12 945"], status: "warning" as const },
    { id: "1515216416", cells: ["WED-4416", "Wedding Florist Item 5", "1/9/2026", "€16 516"], status: "active" as const },
];
...
export default function WeddingFloristPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wedding Florist</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Wedding Florist</p>
                    </div>
                </div>
