...
const KPIS = [
    ...
    { label: "Ativos", value: "4499", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€300K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1881280412", cells: ["HEA-2412", "Headless CMS Item 1", "5/9/2026", "€30 512"], status: "active" as const },
    { id: "1881283983", cells: ["HEA-5983", "Headless CMS Item 2", "20/4/2026", "€34 083"], status: "pending" as const },
    { id: "1881287554", cells: ["HEA-9554", "Headless CMS Item 3", "7/11/2026", "€37 654"], status: "completed" as const },
    { id: "1881291125", cells: ["HEA-4125", "Headless CMS Item 4", "22/6/2026", "€41 225"], status: "warning" as const },
    { id: "1881294696", cells: ["HEA-7696", "Headless CMS Item 5", "9/1/2026", "€44 796"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Headless CMS</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Headless CMS</p>
                    </div>
                </div>
