...
const ACCENT = "#f43f5e";
const MODULE = "Headless CMS";
const PAGE = "Content";
const KPIS = [{"l":"Pedidos/Dia","v":"2523","t":"-5.5%","d":"down"},{"l":"GMV (€)","v":"€19008","t":"+2.5%","d":"up"},{"l":"Conversão (%)","v":"72.0%","t":"+15.4%","d":"up"},{"l":"AOV (€)","v":"€16766","t":"-3.4%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 25097.17","8.447","4.993","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 35100.28","4.209","3.202","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 35053.35","1.259","7.536","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 26690.86","2.946","3.004","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 45084.80","1.493","1.018","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":331},{"label":"Fev","value":436},{"label":"Mar","value":546},{"label":"Abr","value":313},{"label":"Mai","value":380},{"label":"Jun","value":623},{"label":"Jul","value":480},{"label":"Ago","value":435},{"label":"Set","value":627},{"label":"Out","value":676},{"label":"Nov","value":428},{"label":"Dez","value":563}];
const MX = 676;
