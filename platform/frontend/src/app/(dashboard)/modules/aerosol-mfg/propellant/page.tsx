...
const ACCENT = "#eab308";
const MODULE = "Aerosol Manufacturing";
const PAGE = "Propellant";
const KPIS = [{"l":"Total Aerosol Mfg","v":"4.993","t":"+17.5%","d":"up"},{"l":"Propellant Ativos","v":"7.779","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"72.0%","t":"-2.3%","d":"down"},{"l":"Score Performance","v":"78","t":"+14.7%","d":"up"}];
const COLS = ["ID","Propellant","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aerosol Mfg #001","Aerosol Mfg #002","1.246","8.309","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Aerosol Mfg #002","Aerosol Mfg #003","4.589","286","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Aerosol Mfg #003","Aerosol Mfg #004","2.530","2.636","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Aerosol Mfg #004","Aerosol Mfg #005","881","3.849","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aerosol Mfg #005","Aerosol Mfg #001","6.730","233","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":852},{"label":"Fev","value":638},{"label":"Mar","value":870},{"label":"Abr","value":927},{"label":"Mai","value":719},{"label":"Jun","value":787},{"label":"Jul","value":776},{"label":"Ago","value":918},{"label":"Set","value":918},{"label":"Out","value":607},{"label":"Nov","value":645},{"label":"Dez","value":731}];
const MX = 927;
...
export default function PropellantPage() {
    return (
