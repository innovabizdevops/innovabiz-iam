...
/* ═══ Aerosol Manufacturing — Dashboard ═══ */

const ACCENT = "#eab308";

const KPIS = [
    { label: "Total Registos", value: "3779", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3428", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€288K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1367728279", cells: ["AER-8279", "Aerosol Manufacturing Item 1", "16/8/2026", "€28 379"], status: "active" as const },
    { id: "1367731850", cells: ["AER-2850", "Aerosol Manufacturing Item 2", "3/3/2026", "€31 950"], status: "pending" as const },
    { id: "1367735421", cells: ["AER-6421", "Aerosol Manufacturing Item 3", "18/10/2026", "€35 521"], status: "completed" as const },
    { id: "1367738992", cells: ["AER-9992", "Aerosol Manufacturing Item 4", "5/5/2026", "€39 092"], status: "warning" as const },
    { id: "1367742563", cells: ["AER-4563", "Aerosol Manufacturing Item 5", "20/12/2026", "€42 663"], status: "active" as const },
];
...
export default function AerosolManufacturingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Aerosol Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Aerosol Manufacturing</p>
                    </div>
                </div>
