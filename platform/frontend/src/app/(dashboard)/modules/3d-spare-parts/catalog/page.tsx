...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"3.176","t":"-4.9%","d":"down"},{"l":"Queries/Dia","v":"4958","t":"-0.5%","d":"down"},{"l":"Dados Processados (GB)","v":"830","t":"+3.2%","d":"up"},{"l":"Utilizadores Analytics","v":"5.917","t":"+8.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3040","2026-03-12","655","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2210","2026-01-24","1.040","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","836","2026-01-11","3.327","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2214","2026-01-20","6.484","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1473","2026-02-14","4.626","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":461},{"label":"Fev","value":663},{"label":"Mar","value":768},{"label":"Abr","value":686},{"label":"Mai","value":784},{"label":"Jun","value":557},{"label":"Jul","value":782},{"label":"Ago","value":668},{"label":"Set","value":693},{"label":"Out","value":521},{"label":"Nov","value":661},{"label":"Dez","value":775}];
const MX = 784;
