...
/* ═══ 3D Spare Parts — Dashboard ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total Registos", value: "8373", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "150", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€351K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1768257173", cells: ["3D-1173", "3D Spare Parts Item 1", "26/6/2026", "€7273"], status: "active" as const },
    { id: "1768260744", cells: ["3D-4744", "3D Spare Parts Item 2", "13/1/2026", "€10 844"], status: "pending" as const },
    { id: "1768264315", cells: ["3D-8315", "3D Spare Parts Item 3", "28/8/2026", "€14 415"], status: "completed" as const },
    { id: "1768267886", cells: ["3D-2886", "3D Spare Parts Item 4", "15/3/2026", "€17 986"], status: "warning" as const },
    { id: "1768271457", cells: ["3D-6457", "3D Spare Parts Item 5", "2/10/2026", "€21 557"], status: "active" as const },
];
...
export default function P3dSparePartsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">3D Spare Parts</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • 3D Spare Parts</p>
                    </div>
                </div>
