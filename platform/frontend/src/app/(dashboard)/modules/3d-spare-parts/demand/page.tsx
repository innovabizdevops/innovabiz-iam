...
const ACCENT = "#4338ca";
const MODULE = "3D Spare Parts";
const PAGE = "On-Demand";
const KPIS = [{"l":"Quartos Ocupados","v":"4.803","t":"+14.9%","d":"up"},{"l":"RevPAR (€)","v":"€65504","t":"-3.8%","d":"down"},{"l":"Ocupação (%)","v":"93.8%","t":"+1.1%","d":"up"},{"l":"Guest Satisfaction","v":"3.764","t":"+6.6%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.177","2026-01-05","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","293","2026-02-27","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.696","2026-01-26","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","8.272","2026-02-27","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.826","2026-02-18","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":307},{"label":"Mar","value":498},{"label":"Abr","value":533},{"label":"Mai","value":303},{"label":"Jun","value":597},{"label":"Jul","value":336},{"label":"Ago","value":220},{"label":"Set","value":445},{"label":"Out","value":595},{"label":"Nov","value":551},{"label":"Dez","value":407}];
const MX = 597;
