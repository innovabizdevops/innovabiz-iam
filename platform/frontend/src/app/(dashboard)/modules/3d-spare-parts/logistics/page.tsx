...
const KPIS = [{"l":"Quartos Ocupados","v":"4.730","t":"+4.5%","d":"up"},{"l":"RevPAR (€)","v":"€88542","t":"+3.0%","d":"up"},{"l":"Ocupação (%)","v":"93.6%","t":"+3.5%","d":"up"},{"l":"Guest Satisfaction","v":"942","t":"+11.2%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.868","2026-03-10","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.524","2026-03-12","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.185","2026-02-12","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","207","2026-03-04","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.177","2026-02-01","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":806},{"label":"Fev","value":629},{"label":"Mar","value":795},{"label":"Abr","value":756},{"label":"Mai","value":504},{"label":"Jun","value":768},{"label":"Jul","value":686},{"label":"Ago","value":518},{"label":"Set","value":717},{"label":"Out","value":807},{"label":"Nov","value":763},{"label":"Dez","value":831}];
const MX = 831;
