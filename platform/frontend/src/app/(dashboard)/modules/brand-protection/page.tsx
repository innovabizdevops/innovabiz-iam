...
const KPIS = [
    { label: "Total Registos", value: "170", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3156", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€403K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "847826170", cells: ["BRA-9170", "Brand Protection Item 1", "3/11/2026", "€26 270"], status: "active" as const },
    { id: "847829741", cells: ["BRA-3741", "Brand Protection Item 2", "18/6/2026", "€29 841"], status: "pending" as const },
    { id: "847833312", cells: ["BRA-7312", "Brand Protection Item 3", "5/1/2026", "€33 412"], status: "completed" as const },
    { id: "847836883", cells: ["BRA-1883", "Brand Protection Item 4", "20/8/2026", "€36 983"], status: "warning" as const },
    { id: "847840454", cells: ["BRA-5454", "Brand Protection Item 5", "7/3/2026", "€40 554"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Brand Protection</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Brand Protection</p>
                    </div>
                </div>
