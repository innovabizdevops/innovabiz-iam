...
const PAGE = "Legal";
const KPIS = [{"l":"Total Brand Protection","v":"6.171","t":"-0.8%","d":"down"},{"l":"Legal Ativos","v":"5.390","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"82.6%","t":"+4.3%","d":"up"},{"l":"Score Performance","v":"74","t":"-5.6%","d":"down"}];
const COLS = ["ID","Legal","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brand Protection #001","Brand Protection #002","2.038","5.594","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Brand Protection #002","Brand Protection #003","5.994","1.785","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Brand Protection #003","Brand Protection #004","6.432","2.218","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Brand Protection #004","Brand Protection #005","3.454","2.824","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brand Protection #005","Brand Protection #001","5.618","2.322","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":981},{"label":"Mar","value":856},{"label":"Abr","value":931},{"label":"Mai","value":748},{"label":"Jun","value":939},{"label":"Jul","value":723},{"label":"Ago","value":930},{"label":"Set","value":904},{"label":"Out","value":911},{"label":"Nov","value":957},{"label":"Dez","value":844}];
const MX = 981;
