...
const PAGE = "Documentary";
const KPIS = [{"l":"Formulários Ativos","v":"7.536","t":"+12.5%","d":"up"},{"l":"Submissões/Dia","v":"4771","t":"+14.7%","d":"up"},{"l":"Documentos Gerados","v":"6.451","t":"-2.1%","d":"down"},{"l":"Templates","v":"6.619","t":"+9.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.703","2026-01-05","7.169","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.703","2026-02-10","5.832","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","623","2026-03-25","2.254","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.834","2026-01-20","9.032","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.126","2026-02-14","520","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":449},{"label":"Fev","value":441},{"label":"Mar","value":541},{"label":"Abr","value":336},{"label":"Mai","value":317},{"label":"Jun","value":477},{"label":"Jul","value":326},{"label":"Ago","value":255},{"label":"Set","value":337},{"label":"Out","value":456},{"label":"Nov","value":387},{"label":"Dez","value":487}];
const MX = 541;
