...
const PAGE = "SWIFT";
const KPIS = [{"l":"Total Trade Finance Deep","v":"5.568","t":"+8.0%","d":"up"},{"l":"SWIFT Ativos","v":"6.224","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"88.7%","t":"+14.0%","d":"up"},{"l":"Score Performance","v":"83","t":"+4.5%","d":"up"}];
const COLS = ["ID","SWIFT","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Trade Finance Deep #001","Trade Finance Deep #002","6.839","6.006","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Trade Finance Deep #002","Trade Finance Deep #003","9.016","2.187","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Trade Finance Deep #003","Trade Finance Deep #004","1.285","4.196","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Trade Finance Deep #004","Trade Finance Deep #005","766","2.370","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Trade Finance Deep #005","Trade Finance Deep #001","7.619","2.867","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":718},{"label":"Fev","value":728},{"label":"Mar","value":785},{"label":"Abr","value":613},{"label":"Mai","value":605},{"label":"Jun","value":553},{"label":"Jul","value":913},{"label":"Ago","value":721},{"label":"Set","value":595},{"label":"Out","value":660},{"label":"Nov","value":760},{"label":"Dez","value":729}];
const MX = 913;
