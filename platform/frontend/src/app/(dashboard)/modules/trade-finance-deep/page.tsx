...
export default function TradeFinanceDeepPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Trade Finance Deep</h1><p className="text-sm text-muted-foreground">Trade Finance Deep • iBOS Enterprise</p></div>
