...
const ACCENT = "#6366f1";
const MODULE = "Trade Finance Deep";
const PAGE = "Supply Chain Finance";
const KPIS = [{"l":"Total Trade Finance Deep","v":"5.966","t":"+3.9%","d":"up"},{"l":"Supply Chain Finance Ativos","v":"1.459","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"84.5%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"79","t":"+11.1%","d":"up"}];
const COLS = ["ID","Supply Chain Finance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Trade Finance Deep #001","Trade Finance Deep #002","2.522","2.922","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Trade Finance Deep #002","Trade Finance Deep #003","3.172","136","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Trade Finance Deep #003","Trade Finance Deep #004","2.426","3.004","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Trade Finance Deep #004","Trade Finance Deep #005","1.502","830","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Trade Finance Deep #005","Trade Finance Deep #001","4.463","1.150","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":467},{"label":"Mar","value":734},{"label":"Abr","value":779},{"label":"Mai","value":497},{"label":"Jun","value":788},{"label":"Jul","value":668},{"label":"Ago","value":785},{"label":"Set","value":765},{"label":"Out","value":455},{"label":"Nov","value":720},{"label":"Dez","value":475}];
const MX = 788;
