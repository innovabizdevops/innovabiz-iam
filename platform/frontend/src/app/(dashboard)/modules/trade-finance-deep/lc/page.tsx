...
const PAGE = "Letter Credit";
const KPIS = [{"l":"Integrações Ativas","v":"8.207","t":"-5.3%","d":"down"},{"l":"Chamadas/Hora","v":"4416","t":"+8.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.5%","t":"+15.5%","d":"up"},{"l":"Latência Média (ms)","v":"127ms","t":"-0.2%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.115","8.681","90.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.621","4.174","86.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.141","7.401","94.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.756","8.057","71.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.516","1.095","83.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":515},{"label":"Fev","value":637},{"label":"Mar","value":745},{"label":"Abr","value":544},{"label":"Mai","value":432},{"label":"Jun","value":382},{"label":"Jul","value":581},{"label":"Ago","value":611},{"label":"Set","value":385},{"label":"Out","value":504},{"label":"Nov","value":718},{"label":"Dez","value":694}];
const MX = 745;
