...
const PAGE = "Cost";
const KPIS = [{"l":"Vendas YTD (€)","v":"€84393","t":"-5.5%","d":"down"},{"l":"Pipeline (€)","v":"€78496","t":"+5.1%","d":"up"},{"l":"Atingimento Quota (%)","v":"90.6%","t":"+6.0%","d":"up"},{"l":"Win Rate (%)","v":"89.0%","t":"+4.4%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 39246.10","€ 23653.99","€ 37916.88","90.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 14351.11","€ 16083.10","€ 7376.47","73.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 15998.58","€ 1618.50","€ 3283.28","76.1%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 6737.31","€ 37027.15","€ 7318.20","83.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 24578.17","€ 44959.23","€ 21516.96","78.0%"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":651},{"label":"Mar","value":635},{"label":"Abr","value":513},{"label":"Mai","value":552},{"label":"Jun","value":388},{"label":"Jul","value":433},{"label":"Ago","value":443},{"label":"Set","value":473},{"label":"Out","value":401},{"label":"Nov","value":429},{"label":"Dez","value":634}];
const MX = 651;
