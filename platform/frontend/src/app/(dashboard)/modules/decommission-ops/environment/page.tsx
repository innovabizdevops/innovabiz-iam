...
const KPIS = [{"l":"Vendas YTD (€)","v":"€65229","t":"+6.7%","d":"up"},{"l":"Pipeline (€)","v":"€90877","t":"+5.8%","d":"up"},{"l":"Atingimento Quota (%)","v":"71.9%","t":"+6.5%","d":"up"},{"l":"Win Rate (%)","v":"70.7%","t":"+15.9%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 42323.02","€ 9587.62","€ 48066.13","93.6%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 3294.27","€ 19435.84","€ 45157.34","70.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 42307.12","€ 37367.50","€ 15936.91","75.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 28792.15","€ 17107.56","€ 41202.51","81.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 5882.48","€ 6544.62","€ 32425.82","78.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":534},{"label":"Fev","value":360},{"label":"Mar","value":544},{"label":"Abr","value":627},{"label":"Mai","value":370},{"label":"Jun","value":633},{"label":"Jul","value":311},{"label":"Ago","value":386},{"label":"Set","value":284},{"label":"Out","value":615},{"label":"Nov","value":458},{"label":"Dez","value":346}];
const MX = 633;
