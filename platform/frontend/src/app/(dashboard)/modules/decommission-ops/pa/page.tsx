...
const PAGE = "Well P&amp;A";
const KPIS = [{"l":"Vendas YTD (€)","v":"€31772","t":"-3.3%","d":"down"},{"l":"Pipeline (€)","v":"€33883","t":"-1.1%","d":"down"},{"l":"Atingimento Quota (%)","v":"90.3%","t":"+10.1%","d":"up"},{"l":"Win Rate (%)","v":"65.4%","t":"+4.6%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 19825.80","€ 35135.56","€ 6463.49","92.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 19326.99","€ 1649.56","€ 3939.41","74.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 20051.82","€ 48810.73","€ 47991.77","72.4%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 25040.70","€ 24618.41","€ 41222.77","88.2%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 33154.42","€ 16732.91","€ 19494.01","94.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":719},{"label":"Mar","value":529},{"label":"Abr","value":485},{"label":"Mai","value":482},{"label":"Jun","value":585},{"label":"Jul","value":462},{"label":"Ago","value":766},{"label":"Set","value":544},{"label":"Out","value":653},{"label":"Nov","value":475},{"label":"Dez","value":617}];
const MX = 766;
