...
const ACCENT = "#6366f1";
const MODULE = "Decommissioning";
const PAGE = "Plan";
const KPIS = [{"l":"Vendas YTD (€)","v":"€16593","t":"+16.7%","d":"up"},{"l":"Pipeline (€)","v":"€52764","t":"-3.3%","d":"down"},{"l":"Atingimento Quota (%)","v":"81.3%","t":"-1.5%","d":"down"},{"l":"Win Rate (%)","v":"67.5%","t":"-2.8%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 26339.57","€ 43974.03","€ 37784.40","82.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 34675.02","€ 27467.82","€ 36266.39","99.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 22765.67","€ 12106.04","€ 30734.42","81.8%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 8301.19","€ 13097.89","€ 45126.34","91.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 33537.23","€ 16733.15","€ 47658.47","82.4%"],"status":"active"}];
const CHART = [{"label":"Jan","value":431},{"label":"Fev","value":591},{"label":"Mar","value":684},{"label":"Abr","value":623},{"label":"Mai","value":401},{"label":"Jun","value":413},{"label":"Jul","value":344},{"label":"Ago","value":571},{"label":"Set","value":702},{"label":"Out","value":635},{"label":"Nov","value":406},{"label":"Dez","value":385}];
const MX = 702;
