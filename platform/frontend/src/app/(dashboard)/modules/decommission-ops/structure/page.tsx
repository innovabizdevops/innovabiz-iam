...
const KPIS = [{"l":"Vendas YTD (€)","v":"€22370","t":"-3.3%","d":"down"},{"l":"Pipeline (€)","v":"€94425","t":"+5.9%","d":"up"},{"l":"Atingimento Quota (%)","v":"87.6%","t":"+13.6%","d":"up"},{"l":"Win Rate (%)","v":"84.2%","t":"+14.0%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 2475.68","€ 735.13","€ 45244.07","76.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 30029.58","€ 34472.61","€ 4132.70","92.4%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 3685.19","€ 30055.75","€ 10530.37","73.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 46607.60","€ 14495.53","€ 11435.64","96.1%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 34981.50","€ 42156.18","€ 35413.39","79.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":864},{"label":"Mar","value":828},{"label":"Abr","value":958},{"label":"Mai","value":668},{"label":"Jun","value":856},{"label":"Jul","value":837},{"label":"Ago","value":638},{"label":"Set","value":815},{"label":"Out","value":892},{"label":"Nov","value":684},{"label":"Dez","value":796}];
const MX = 958;
