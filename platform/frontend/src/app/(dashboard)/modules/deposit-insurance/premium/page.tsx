...
const PAGE = "Premium";
const KPIS = [{"l":"Pedidos/Dia","v":"2066","t":"+16.2%","d":"up"},{"l":"GMV (€)","v":"€7651","t":"+13.7%","d":"up"},{"l":"Conversão (%)","v":"89.8%","t":"+6.8%","d":"up"},{"l":"AOV (€)","v":"€93822","t":"-4.5%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 27321.83","5.347","1.524","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 22372.06","7.113","7.360","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 7140.19","748","1.906","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 31963.88","432","7.850","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 31947.41","1.484","6.903","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":976},{"label":"Mar","value":686},{"label":"Abr","value":907},{"label":"Mai","value":970},{"label":"Jun","value":877},{"label":"Jul","value":655},{"label":"Ago","value":776},{"label":"Set","value":897},{"label":"Out","value":964},{"label":"Nov","value":796},{"label":"Dez","value":774}];
const MX = 976;
