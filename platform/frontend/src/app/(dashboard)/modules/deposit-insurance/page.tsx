...
/* ═══ Fundo Garantia Depósitos — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "1762", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4385", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€139K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "-20%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1115919762", cells: ["DEP-1762", "Fundo Garantia Depósitos Item 1", "7/7/2026", "€19 862"], status: "active" as const },
    { id: "1115923333", cells: ["DEP-5333", "Fundo Garantia Depósitos Item 2", "22/2/2026", "€23 433"], status: "pending" as const },
    { id: "1115926904", cells: ["DEP-8904", "Fundo Garantia Depósitos Item 3", "9/9/2026", "€27 004"], status: "completed" as const },
    { id: "1115930475", cells: ["DEP-3475", "Fundo Garantia Depósitos Item 4", "24/4/2026", "€30 575"], status: "warning" as const },
    { id: "1115934046", cells: ["DEP-7046", "Fundo Garantia Depósitos Item 5", "11/11/2026", "€34 146"], status: "active" as const },
];
...
export default function FundoGarantiaDepsitosPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fundo Garantia Depósitos</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fundo Garantia Depósitos</p>
                    </div>
                </div>
