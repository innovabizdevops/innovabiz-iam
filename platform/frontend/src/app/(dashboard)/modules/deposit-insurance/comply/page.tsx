...
const KPIS = [{"l":"Auditorias Realizadas","v":"1.849","t":"-3.7%","d":"down"},{"l":"NC Abertas","v":"7.299","t":"+14.4%","d":"up"},{"l":"Conformidade (%)","v":"67.9%","t":"+17.0%","d":"up"},{"l":"CAPAs Pendentes","v":"4.327","t":"+9.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.752","89.8%","2.196","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.078","86.2%","4.260","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.895","79.0%","719","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.479","95.3%","504","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","932","98.9%","1.069","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":488},{"label":"Fev","value":436},{"label":"Mar","value":560},{"label":"Abr","value":461},{"label":"Mai","value":541},{"label":"Jun","value":705},{"label":"Jul","value":377},{"label":"Ago","value":627},{"label":"Set","value":597},{"label":"Out","value":509},{"label":"Nov","value":665},{"label":"Dez","value":590}];
const MX = 705;
