...
const ACCENT = "#059669";
const MODULE = "Fundo Garantia Depósitos";
const PAGE = "Resolution";
const KPIS = [{"l":"Pedidos/Dia","v":"4071","t":"+15.0%","d":"up"},{"l":"GMV (€)","v":"€53292","t":"+1.3%","d":"up"},{"l":"Conversão (%)","v":"77.4%","t":"+2.7%","d":"up"},{"l":"AOV (€)","v":"€89151","t":"-3.5%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 40643.62","8.438","551","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 34039.44","3.604","5.077","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 16181.52","8.236","3.643","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 40521.39","5.895","7.853","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 29053.71","1.803","7.013","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":392},{"label":"Fev","value":650},{"label":"Mar","value":429},{"label":"Abr","value":344},{"label":"Mai","value":336},{"label":"Jun","value":713},{"label":"Jul","value":685},{"label":"Ago","value":531},{"label":"Set","value":356},{"label":"Out","value":402},{"label":"Nov","value":494},{"label":"Dez","value":399}];
const MX = 713;
