...
const PAGE = "Simulation";
const KPIS = [{"l":"Twins Ativos","v":"198","t":"+16.2%","d":"up"},{"l":"Simulações/Dia","v":"2839","t":"+1.0%","d":"up"},{"l":"Precisão Modelo (%)","v":"66.8%","t":"-1.5%","d":"down"},{"l":"Latência Sync (ms)","v":"155ms","t":"+17.2%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","78.1%","2026-01-21","5.252","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","79.6%","2026-01-28","6.277","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","75.5%","2026-03-03","2.015","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","97.8%","2026-02-05","3.357","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","89.2%","2026-03-04","8.310","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":805},{"label":"Mar","value":522},{"label":"Abr","value":636},{"label":"Mai","value":675},{"label":"Jun","value":469},{"label":"Jul","value":631},{"label":"Ago","value":809},{"label":"Set","value":696},{"label":"Out","value":800},{"label":"Nov","value":728},{"label":"Dez","value":580}];
const MX = 809;
