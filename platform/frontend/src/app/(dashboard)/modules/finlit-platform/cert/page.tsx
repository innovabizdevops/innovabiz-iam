...
const KPIS = [{"l":"Formulários Ativos","v":"7.248","t":"+12.8%","d":"up"},{"l":"Submissões/Dia","v":"3399","t":"-5.9%","d":"down"},{"l":"Documentos Gerados","v":"7.811","t":"+1.8%","d":"up"},{"l":"Templates","v":"4.488","t":"+17.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.853","2026-03-26","8.532","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.032","2026-03-11","6.882","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.324","2026-02-06","5.896","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.435","2026-03-06","6.632","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.322","2026-01-07","5.915","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":712},{"label":"Mar","value":777},{"label":"Abr","value":836},{"label":"Mai","value":936},{"label":"Jun","value":825},{"label":"Jul","value":1030},{"label":"Ago","value":881},{"label":"Set","value":752},{"label":"Out","value":777},{"label":"Nov","value":1012},{"label":"Dez","value":903}];
const MX = 1030;
