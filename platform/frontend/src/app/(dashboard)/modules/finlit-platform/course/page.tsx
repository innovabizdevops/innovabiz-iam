...
const PAGE = "Course";
const KPIS = [{"l":"Formulários Ativos","v":"5.519","t":"+3.3%","d":"up"},{"l":"Submissões/Dia","v":"211","t":"+12.7%","d":"up"},{"l":"Documentos Gerados","v":"3.035","t":"+3.2%","d":"up"},{"l":"Templates","v":"7.443","t":"+6.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.901","2026-01-28","985","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.779","2026-03-28","7.237","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.495","2026-02-24","7.542","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.801","2026-03-20","1.450","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","328","2026-01-07","7.524","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":609},{"label":"Mar","value":479},{"label":"Abr","value":288},{"label":"Mai","value":529},{"label":"Jun","value":614},{"label":"Jul","value":406},{"label":"Ago","value":562},{"label":"Set","value":500},{"label":"Out","value":473},{"label":"Nov","value":427},{"label":"Dez","value":639}];
const MX = 639;
