...
const KPIS = [{"l":"Formulários Ativos","v":"6.752","t":"-1.7%","d":"down"},{"l":"Submissões/Dia","v":"2309","t":"+4.5%","d":"up"},{"l":"Documentos Gerados","v":"5.342","t":"+5.7%","d":"up"},{"l":"Templates","v":"2.846","t":"-0.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.939","2026-01-18","1.441","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.396","2026-03-25","1.877","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.858","2026-02-20","3.225","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.889","2026-01-15","928","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.293","2026-02-12","6.246","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":586},{"label":"Mar","value":360},{"label":"Abr","value":446},{"label":"Mai","value":590},{"label":"Jun","value":529},{"label":"Jul","value":287},{"label":"Ago","value":267},{"label":"Set","value":563},{"label":"Out","value":447},{"label":"Nov","value":417},{"label":"Dez","value":275}];
const MX = 590;
