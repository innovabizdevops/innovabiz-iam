...
const ACCENT = "#854d0e";
const MODULE = "Literacia Financeira";
const PAGE = "Gamification";
const KPIS = [{"l":"Formulários Ativos","v":"3.960","t":"+7.7%","d":"up"},{"l":"Submissões/Dia","v":"1203","t":"+3.2%","d":"up"},{"l":"Documentos Gerados","v":"642","t":"+13.7%","d":"up"},{"l":"Templates","v":"651","t":"-1.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.203","2026-01-15","6.236","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.888","2026-03-13","7.568","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","561","2026-01-23","3.351","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","683","2026-01-10","2.333","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.950","2026-01-01","6.317","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":656},{"label":"Mar","value":779},{"label":"Abr","value":606},{"label":"Mai","value":476},{"label":"Jun","value":720},{"label":"Jul","value":753},{"label":"Ago","value":791},{"label":"Set","value":769},{"label":"Out","value":558},{"label":"Nov","value":789},{"label":"Dez","value":517}];
const MX = 791;
