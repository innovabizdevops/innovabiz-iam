...
const PAGE = "Imaging";
const KPIS = [{"l":"Total Dental Mgmt","v":"2.500","t":"+6.6%","d":"up"},{"l":"Imaging Ativos","v":"4.191","t":"+1.5%","d":"up"},{"l":"Eficiência (%)","v":"74.6%","t":"+11.9%","d":"up"},{"l":"Score Performance","v":"68","t":"+8.6%","d":"up"}];
const COLS = ["ID","Imaging","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dental Mgmt #001","Dental Mgmt #002","5.369","4.246","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Dental Mgmt #002","Dental Mgmt #003","5.118","7.349","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Dental Mgmt #003","Dental Mgmt #004","5.496","2.285","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Dental Mgmt #004","Dental Mgmt #005","5.694","7.673","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dental Mgmt #005","Dental Mgmt #001","2.896","7.634","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":506},{"label":"Mar","value":476},{"label":"Abr","value":500},{"label":"Mai","value":515},{"label":"Jun","value":770},{"label":"Jul","value":440},{"label":"Ago","value":770},{"label":"Set","value":529},{"label":"Out","value":496},{"label":"Nov","value":661},{"label":"Dez","value":798}];
const MX = 798;
