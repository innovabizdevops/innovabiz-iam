...
const PAGE = "Recall";
const KPIS = [{"l":"Total Dental Mgmt","v":"1.943","t":"-3.5%","d":"down"},{"l":"Recall Ativos","v":"6.638","t":"+14.1%","d":"up"},{"l":"Eficiência (%)","v":"87.1%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"57","t":"-4.3%","d":"down"}];
const COLS = ["ID","Recall","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dental Mgmt #001","Dental Mgmt #002","3.671","2.247","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Dental Mgmt #002","Dental Mgmt #003","6.066","6.691","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Dental Mgmt #003","Dental Mgmt #004","5.603","9.064","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Dental Mgmt #004","Dental Mgmt #005","929","6.913","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dental Mgmt #005","Dental Mgmt #001","4.534","1.650","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":852},{"label":"Fev","value":761},{"label":"Mar","value":631},{"label":"Abr","value":603},{"label":"Mai","value":718},{"label":"Jun","value":821},{"label":"Jul","value":592},{"label":"Ago","value":571},{"label":"Set","value":542},{"label":"Out","value":709},{"label":"Nov","value":835},{"label":"Dez","value":760}];
const MX = 852;
