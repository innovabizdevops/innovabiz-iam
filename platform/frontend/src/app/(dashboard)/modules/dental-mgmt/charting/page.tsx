...
const ACCENT = "#4f46e5";
const MODULE = "Dental Management";
const PAGE = "Charting";
const KPIS = [{"l":"Total Dental Mgmt","v":"8.966","t":"+5.1%","d":"up"},{"l":"Charting Ativos","v":"4.064","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"80.7%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"70","t":"+16.8%","d":"up"}];
const COLS = ["ID","Charting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dental Mgmt #001","Dental Mgmt #002","6.247","6.975","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Dental Mgmt #002","Dental Mgmt #003","8.569","7.260","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Dental Mgmt #003","Dental Mgmt #004","5.760","1.832","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Dental Mgmt #004","Dental Mgmt #005","494","7.373","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dental Mgmt #005","Dental Mgmt #001","2.982","539","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":828},{"label":"Mar","value":822},{"label":"Abr","value":805},{"label":"Mai","value":710},{"label":"Jun","value":850},{"label":"Jul","value":524},{"label":"Ago","value":531},{"label":"Set","value":592},{"label":"Out","value":589},{"label":"Nov","value":786},{"label":"Dez","value":546}];
const MX = 850;
