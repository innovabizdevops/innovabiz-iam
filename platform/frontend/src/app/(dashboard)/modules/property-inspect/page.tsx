...
export default function PropertyInspectPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Property Inspect</h1><p className="text-sm text-muted-foreground">Property Inspect • iBOS Enterprise</p></div>
