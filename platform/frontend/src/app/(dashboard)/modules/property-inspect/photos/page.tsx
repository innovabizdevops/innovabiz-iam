...
const ACCENT = "#eab308";
const MODULE = "Property Inspection";
const PAGE = "Photo Evidence";
const KPIS = [{"l":"Total Property Inspect","v":"8.884","t":"+15.1%","d":"up"},{"l":"Photo Evidence Ativos","v":"7.559","t":"+0.7%","d":"up"},{"l":"Eficiência (%)","v":"72.3%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"81","t":"-1.3%","d":"down"}];
const COLS = ["ID","Photo Evidence","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Property Inspect #001","Property Inspect #002","5.216","7.345","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Property Inspect #002","Property Inspect #003","1.186","2.657","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Property Inspect #003","Property Inspect #004","4.520","6.526","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Property Inspect #004","Property Inspect #005","2.356","2.131","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Property Inspect #005","Property Inspect #001","7.886","4.221","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1039},{"label":"Fev","value":726},{"label":"Mar","value":716},{"label":"Abr","value":785},{"label":"Mai","value":827},{"label":"Jun","value":684},{"label":"Jul","value":802},{"label":"Ago","value":750},{"label":"Set","value":964},{"label":"Out","value":708},{"label":"Nov","value":756},{"label":"Dez","value":882}];
const MX = 1039;
