...
const PAGE = "Sample Tracking";
const KPIS = [{"l":"Dispositivos Online","v":"7.508","t":"+7.6%","d":"up"},{"l":"Dados/Min (MB)","v":"8.003","t":"+1.7%","d":"up"},{"l":"Alertas Ativos","v":"8.106","t":"+16.7%","d":"up"},{"l":"Uptime (%)","v":"82.2%","t":"+16.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.353","6.836","2.277","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.836","5.516","128","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.942","3.638","3.484","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.749","2.749","8.053","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.521","7.065","5.641","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":390},{"label":"Fev","value":580},{"label":"Mar","value":405},{"label":"Abr","value":478},{"label":"Mai","value":315},{"label":"Jun","value":631},{"label":"Jul","value":628},{"label":"Ago","value":282},{"label":"Set","value":525},{"label":"Out","value":543},{"label":"Nov","value":548},{"label":"Dez","value":378}];
const MX = 631;
