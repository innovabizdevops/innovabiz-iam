...
const KPIS = [{"l":"Dispositivos Online","v":"3.602","t":"-3.8%","d":"down"},{"l":"Dados/Min (MB)","v":"2.644","t":"+1.2%","d":"up"},{"l":"Alertas Ativos","v":"1.268","t":"+16.6%","d":"up"},{"l":"Uptime (%)","v":"90.5%","t":"+9.5%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.610","6.533","5.663","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","1.329","1.559","4.748","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.359","1.150","6.802","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.184","6.623","4.640","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.123","1.877","5.241","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":597},{"label":"Mar","value":587},{"label":"Abr","value":721},{"label":"Mai","value":656},{"label":"Jun","value":666},{"label":"Jul","value":753},{"label":"Ago","value":800},{"label":"Set","value":759},{"label":"Out","value":567},{"label":"Nov","value":923},{"label":"Dez","value":679}];
const MX = 923;
