...
const PAGE = "Genome Sequencing";
const KPIS = [{"l":"Dispositivos Online","v":"6.254","t":"+16.7%","d":"up"},{"l":"Dados/Min (MB)","v":"7.215","t":"+14.4%","d":"up"},{"l":"Alertas Ativos","v":"1.502","t":"+14.2%","d":"up"},{"l":"Uptime (%)","v":"91.1%","t":"+8.9%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.120","1.457","4.556","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.207","4.226","7.890","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.251","3.726","692","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.525","661","7.059","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","1.678","1.468","2.377","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":774},{"label":"Fev","value":550},{"label":"Mar","value":810},{"label":"Abr","value":710},{"label":"Mai","value":662},{"label":"Jun","value":510},{"label":"Jul","value":734},{"label":"Ago","value":712},{"label":"Set","value":819},{"label":"Out","value":810},{"label":"Nov","value":787},{"label":"Dez","value":719}];
const MX = 819;
