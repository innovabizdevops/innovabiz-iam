...
const PAGE = "CRISPR Mgmt";
const KPIS = [{"l":"Dispositivos Online","v":"5.650","t":"+4.8%","d":"up"},{"l":"Dados/Min (MB)","v":"5.396","t":"+6.2%","d":"up"},{"l":"Alertas Ativos","v":"6.168","t":"+0.6%","d":"up"},{"l":"Uptime (%)","v":"77.3%","t":"+3.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.876","7.241","3.619","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.332","8.986","2.045","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.044","1.349","3.921","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.669","4.046","2.454","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.513","5.094","7.133","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":496},{"label":"Fev","value":493},{"label":"Mar","value":675},{"label":"Abr","value":747},{"label":"Mai","value":738},{"label":"Jun","value":570},{"label":"Jul","value":463},{"label":"Ago","value":418},{"label":"Set","value":647},{"label":"Out","value":592},{"label":"Nov","value":690},{"label":"Dez","value":605}];
const MX = 747;
