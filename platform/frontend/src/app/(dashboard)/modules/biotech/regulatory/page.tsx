...
const KPIS = [{"l":"Dispositivos Online","v":"863","t":"+9.0%","d":"up"},{"l":"Dados/Min (MB)","v":"1.981","t":"-2.6%","d":"down"},{"l":"Alertas Ativos","v":"309","t":"-2.3%","d":"down"},{"l":"Uptime (%)","v":"71.7%","t":"+13.6%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.811","7.137","7.606","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.586","7.723","4.085","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.510","5.814","2.094","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.472","1.034","3.165","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.115","9.059","7.427","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":892},{"label":"Fev","value":665},{"label":"Mar","value":752},{"label":"Abr","value":780},{"label":"Mai","value":602},{"label":"Jun","value":615},{"label":"Jul","value":933},{"label":"Ago","value":686},{"label":"Set","value":758},{"label":"Out","value":619},{"label":"Nov","value":876},{"label":"Dez","value":979}];
const MX = 979;
