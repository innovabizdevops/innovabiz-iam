...
const ACCENT = "#dc2626";
const MODULE = "Biotech & Genomics";
const PAGE = "Bioinformatics";
const KPIS = [{"l":"Dispositivos Online","v":"7.936","t":"-4.8%","d":"down"},{"l":"Dados/Min (MB)","v":"116","t":"+10.8%","d":"up"},{"l":"Alertas Ativos","v":"3.550","t":"+2.1%","d":"up"},{"l":"Uptime (%)","v":"66.3%","t":"+14.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","445","3.531","9.073","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.937","7.139","5.371","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","3.734","8.474","4.109","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.727","2.082","444","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.660","1.666","6.244","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":535},{"label":"Mar","value":567},{"label":"Abr","value":840},{"label":"Mai","value":886},{"label":"Jun","value":600},{"label":"Jul","value":627},{"label":"Ago","value":595},{"label":"Set","value":746},{"label":"Out","value":667},{"label":"Nov","value":891},{"label":"Dez","value":563}];
const MX = 891;
