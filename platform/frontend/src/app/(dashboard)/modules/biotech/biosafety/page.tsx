...
const KPIS = [{"l":"Dispositivos Online","v":"3.794","t":"-3.5%","d":"down"},{"l":"Dados/Min (MB)","v":"7.105","t":"-3.1%","d":"down"},{"l":"Alertas Ativos","v":"4.751","t":"+11.0%","d":"up"},{"l":"Uptime (%)","v":"81.1%","t":"+8.6%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","8.636","4.317","1.615","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","644","6.239","1.582","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.887","7.157","2.708","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","244","3.665","5.578","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.525","7.822","706","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":717},{"label":"Mar","value":771},{"label":"Abr","value":852},{"label":"Mai","value":608},{"label":"Jun","value":666},{"label":"Jul","value":875},{"label":"Ago","value":859},{"label":"Set","value":728},{"label":"Out","value":891},{"label":"Nov","value":876},{"label":"Dez","value":659}];
const MX = 891;
