...
const PAGE = "LIMS Integration";
const KPIS = [{"l":"Dispositivos Online","v":"8.910","t":"+3.2%","d":"up"},{"l":"Dados/Min (MB)","v":"6.744","t":"-4.7%","d":"down"},{"l":"Alertas Ativos","v":"5.307","t":"+0.6%","d":"up"},{"l":"Uptime (%)","v":"89.4%","t":"+8.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","8.746","1.923","1.185","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.135","6.680","6.745","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.192","5.222","1.965","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.144","2.243","4.119","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.295","920","3.108","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":320},{"label":"Mar","value":443},{"label":"Abr","value":280},{"label":"Mai","value":339},{"label":"Jun","value":623},{"label":"Jul","value":485},{"label":"Ago","value":501},{"label":"Set","value":410},{"label":"Out","value":438},{"label":"Nov","value":408},{"label":"Dez","value":338}];
const MX = 623;
