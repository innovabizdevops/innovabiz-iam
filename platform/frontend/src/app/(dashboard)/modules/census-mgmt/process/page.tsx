...
const KPIS = [{"l":"Total Census Mgmt","v":"2.981","t":"+14.6%","d":"up"},{"l":"Data Process Ativos","v":"7.668","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"90.4%","t":"+7.6%","d":"up"},{"l":"Score Performance","v":"84","t":"+13.5%","d":"up"}];
const COLS = ["ID","Data Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Census Mgmt #001","2026-03-13","3.937","7.297","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Census Mgmt #002","2026-01-08","377","2.269","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Census Mgmt #003","2026-01-27","3.531","3.681","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Census Mgmt #004","2026-01-02","6.122","2.679","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Census Mgmt #005","2026-03-08","7.197","2.276","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":917},{"label":"Fev","value":622},{"label":"Mar","value":744},{"label":"Abr","value":982},{"label":"Mai","value":795},{"label":"Jun","value":668},{"label":"Jul","value":1003},{"label":"Ago","value":937},{"label":"Set","value":879},{"label":"Out","value":974},{"label":"Nov","value":858},{"label":"Dez","value":755}];
const MX = 1003;
