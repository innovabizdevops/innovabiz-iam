...
const KPIS = [{"l":"Total Census Mgmt","v":"2.672","t":"-2.4%","d":"down"},{"l":"Publication Ativos","v":"8.285","t":"+7.2%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"58","t":"-4.8%","d":"down"}];
const COLS = ["ID","Publication","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Census Mgmt #001","Census Mgmt #002","2.950","324","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Census Mgmt #002","Census Mgmt #003","762","2.054","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Census Mgmt #003","Census Mgmt #004","1.653","6.805","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Census Mgmt #004","Census Mgmt #005","4.846","5.734","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Census Mgmt #005","Census Mgmt #001","1.224","4.952","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":359},{"label":"Fev","value":383},{"label":"Mar","value":468},{"label":"Abr","value":461},{"label":"Mai","value":342},{"label":"Jun","value":479},{"label":"Jul","value":321},{"label":"Ago","value":328},{"label":"Set","value":405},{"label":"Out","value":378},{"label":"Nov","value":400},{"label":"Dez","value":595}];
const MX = 595;
