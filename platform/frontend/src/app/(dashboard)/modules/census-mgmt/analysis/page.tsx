...
const ACCENT = "#6366f1";
const MODULE = "Census Management";
const PAGE = "Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"993","t":"-4.2%","d":"down"},{"l":"Queries/Dia","v":"1220","t":"+15.1%","d":"up"},{"l":"Dados Processados (GB)","v":"8.838","t":"-5.9%","d":"down"},{"l":"Utilizadores Analytics","v":"6.666","t":"-2.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3183","2026-03-15","6.589","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","577","2026-02-12","3.261","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4792","2026-01-25","8.001","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","348","2026-03-06","1.791","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2717","2026-01-06","8.765","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":671},{"label":"Mar","value":959},{"label":"Abr","value":1010},{"label":"Mai","value":689},{"label":"Jun","value":912},{"label":"Jul","value":721},{"label":"Ago","value":744},{"label":"Set","value":727},{"label":"Out","value":804},{"label":"Nov","value":884},{"label":"Dez","value":768}];
const MX = 1010;
