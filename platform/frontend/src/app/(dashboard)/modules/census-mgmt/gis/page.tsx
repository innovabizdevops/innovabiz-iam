...
const PAGE = "GIS";
const KPIS = [{"l":"Total Census Mgmt","v":"3.763","t":"+3.2%","d":"up"},{"l":"GIS Ativos","v":"7.928","t":"+6.2%","d":"up"},{"l":"Eficiência (%)","v":"74.9%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"92","t":"+9.2%","d":"up"}];
const COLS = ["ID","GIS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Census Mgmt #001","Census Mgmt #002","8.817","5.783","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Census Mgmt #002","Census Mgmt #003","1.964","8.442","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Census Mgmt #003","Census Mgmt #004","1.175","8.437","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Census Mgmt #004","Census Mgmt #005","8.728","8.979","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Census Mgmt #005","Census Mgmt #001","7.044","1.330","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":751},{"label":"Mar","value":543},{"label":"Abr","value":618},{"label":"Mai","value":844},{"label":"Jun","value":660},{"label":"Jul","value":907},{"label":"Ago","value":707},{"label":"Set","value":576},{"label":"Out","value":726},{"label":"Nov","value":572},{"label":"Dez","value":855}];
const MX = 907;
