...
export default function CensusMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Census Mgmt</h1><p className="text-sm text-muted-foreground">Census Mgmt • iBOS Enterprise</p></div>
