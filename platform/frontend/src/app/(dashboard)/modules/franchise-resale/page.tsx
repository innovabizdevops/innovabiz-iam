...
/* ═══ Franchise Resale — Dashboard ═══ */

const ACCENT = "#60a5fa";

const KPIS = [
    { label: "Total Registos", value: "9981", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1573", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€265K", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "537876881", cells: ["FRA-1881", "Franchise Resale Item 1", "18/6/2026", "€26 981"], status: "active" as const },
    { id: "537880452", cells: ["FRA-5452", "Franchise Resale Item 2", "5/1/2026", "€30 552"], status: "pending" as const },
    { id: "537884023", cells: ["FRA-9023", "Franchise Resale Item 3", "20/8/2026", "€34 123"], status: "completed" as const },
    { id: "537887594", cells: ["FRA-3594", "Franchise Resale Item 4", "7/3/2026", "€37 694"], status: "warning" as const },
    { id: "537891165", cells: ["FRA-7165", "Franchise Resale Item 5", "22/10/2026", "€41 265"], status: "active" as const },
];
...
export default function FranchiseResalePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Franchise Resale</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Franchise Resale</p>
                    </div>
                </div>
