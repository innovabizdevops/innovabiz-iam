...
const PAGE = "Approve";
const KPIS = [{"l":"Aprovações Pendentes","v":"7.577","t":"+0.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"69.8%","t":"+14.8%","d":"up"},{"l":"Tempo Médio (h)","v":"114h","t":"+15.5%","d":"up"},{"l":"Rejeitadas (%)","v":"72.4%","t":"+10.3%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","7.300","€ 14730.42","5.166","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","1.684","€ 29105.12","5.531","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","7.330","€ 27438.97","2.192","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","6.222","€ 30755.34","3.407","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","2.900","€ 34341.78","972","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":836},{"label":"Mar","value":790},{"label":"Abr","value":561},{"label":"Mai","value":683},{"label":"Jun","value":676},{"label":"Jul","value":768},{"label":"Ago","value":847},{"label":"Set","value":500},{"label":"Out","value":568},{"label":"Nov","value":736},{"label":"Dez","value":608}];
const MX = 847;
