...
const KPIS = [{"l":"Notificações Enviadas","v":"8.660","t":"+5.1%","d":"up"},{"l":"Taxa Entrega (%)","v":"65.4%","t":"+7.4%","d":"up"},{"l":"Taxa Abertura (%)","v":"90.6%","t":"+4.5%","d":"up"},{"l":"Escalações","v":"1.897","t":"+3.4%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","4.625","96.0%","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","8.329","88.7%","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","984","96.9%","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","5.379","78.0%","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","6.679","77.0%","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":570},{"label":"Fev","value":752},{"label":"Mar","value":445},{"label":"Abr","value":600},{"label":"Mai","value":753},{"label":"Jun","value":582},{"label":"Jul","value":730},{"label":"Ago","value":645},{"label":"Set","value":412},{"label":"Out","value":742},{"label":"Nov","value":494},{"label":"Dez","value":566}];
const MX = 753;
