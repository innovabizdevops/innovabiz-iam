...
const PAGE = "OKR Bridge";
const KPIS = [{"l":"Total Kpi Mgmt","v":"3.022","t":"+14.7%","d":"up"},{"l":"OKR Bridge Ativos","v":"4.107","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"91.0%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"73","t":"+6.6%","d":"up"}];
const COLS = ["ID","OKR Bridge","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Kpi Mgmt #001","Kpi Mgmt #002","1.115","9.060","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Kpi Mgmt #002","Kpi Mgmt #003","6.224","2.342","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Kpi Mgmt #003","Kpi Mgmt #004","423","8.484","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Kpi Mgmt #004","Kpi Mgmt #005","4.982","1.674","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Kpi Mgmt #005","Kpi Mgmt #001","1.990","694","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":389},{"label":"Mar","value":473},{"label":"Abr","value":574},{"label":"Mai","value":690},{"label":"Jun","value":433},{"label":"Jul","value":617},{"label":"Ago","value":423},{"label":"Set","value":384},{"label":"Out","value":522},{"label":"Nov","value":532},{"label":"Dez","value":401}];
const MX = 755;
...
export default function OkrBridgePage() {
    return (
