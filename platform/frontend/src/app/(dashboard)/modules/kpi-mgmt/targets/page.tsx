...
const PAGE = "Targets &amp; Thresholds";
const KPIS = [{"l":"Total Kpi Mgmt","v":"5.054","t":"+8.2%","d":"up"},{"l":"Targets & Thresholds Ativos","v":"596","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"86.6%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"65","t":"+13.7%","d":"up"}];
const COLS = ["ID","Targets & Thresholds","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Kpi Mgmt #001","Kpi Mgmt #002","8.603","2.651","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Kpi Mgmt #002","Kpi Mgmt #003","1.976","5.659","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Kpi Mgmt #003","Kpi Mgmt #004","8.198","5.693","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Kpi Mgmt #004","Kpi Mgmt #005","320","2.145","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Kpi Mgmt #005","Kpi Mgmt #001","5.328","727","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":798},{"label":"Mar","value":647},{"label":"Abr","value":781},{"label":"Mai","value":913},{"label":"Jun","value":1003},{"label":"Jul","value":727},{"label":"Ago","value":764},{"label":"Set","value":995},{"label":"Out","value":636},{"label":"Nov","value":968},{"label":"Dez","value":993}];
const MX = 1003;
