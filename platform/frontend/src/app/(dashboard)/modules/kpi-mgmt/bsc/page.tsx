...
const KPIS = [{"l":"Total Kpi Mgmt","v":"8.285","t":"+11.6%","d":"up"},{"l":"Balanced Scorecard Ativos","v":"77","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"86.6%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"56","t":"+12.0%","d":"up"}];
const COLS = ["ID","Balanced Scorecard","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Kpi Mgmt #001","70.7%","1.432","8.231","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Kpi Mgmt #002","98.9%","581","7.390","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Kpi Mgmt #003","77.8%","1.922","6.125","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Kpi Mgmt #004","85.3%","6.319","6.112","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Kpi Mgmt #005","74.5%","895","4.012","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":600},{"label":"Mar","value":803},{"label":"Abr","value":719},{"label":"Mai","value":934},{"label":"Jun","value":661},{"label":"Jul","value":577},{"label":"Ago","value":563},{"label":"Set","value":580},{"label":"Out","value":954},{"label":"Nov","value":636},{"label":"Dez","value":886}];
const MX = 954;
