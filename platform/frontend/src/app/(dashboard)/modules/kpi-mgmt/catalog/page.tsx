...
const ACCENT = "#b45309";
const MODULE = "KPI Management";
const PAGE = "KPI Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"4.924","t":"+12.1%","d":"up"},{"l":"Queries/Dia","v":"1689","t":"+0.7%","d":"up"},{"l":"Dados Processados (GB)","v":"8.724","t":"-4.3%","d":"down"},{"l":"Utilizadores Analytics","v":"4.889","t":"+4.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1548","2026-01-28","1.595","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","982","2026-01-12","7.295","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4298","2026-02-19","1.840","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4962","2026-03-19","2.236","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1154","2026-03-22","7.286","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":954},{"label":"Fev","value":725},{"label":"Mar","value":834},{"label":"Abr","value":793},{"label":"Mai","value":802},{"label":"Jun","value":748},{"label":"Jul","value":971},{"label":"Ago","value":939},{"label":"Set","value":668},{"label":"Out","value":814},{"label":"Nov","value":669},{"label":"Dez","value":691}];
const MX = 971;
