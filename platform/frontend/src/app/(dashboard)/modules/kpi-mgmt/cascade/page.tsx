...
const PAGE = "Cascade View";
const KPIS = [{"l":"Total Kpi Mgmt","v":"6.285","t":"+17.6%","d":"up"},{"l":"Cascade View Ativos","v":"4.194","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"73.7%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"85","t":"+13.9%","d":"up"}];
const COLS = ["ID","Cascade View","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Kpi Mgmt #001","Kpi Mgmt #002","5.525","5.833","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Kpi Mgmt #002","Kpi Mgmt #003","7.198","8.157","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Kpi Mgmt #003","Kpi Mgmt #004","6.601","4.936","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Kpi Mgmt #004","Kpi Mgmt #005","4.578","1.481","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Kpi Mgmt #005","Kpi Mgmt #001","8.787","5.055","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":497},{"label":"Fev","value":565},{"label":"Mar","value":633},{"label":"Abr","value":673},{"label":"Mai","value":338},{"label":"Jun","value":494},{"label":"Jul","value":575},{"label":"Ago","value":394},{"label":"Set","value":456},{"label":"Out","value":532},{"label":"Nov","value":635},{"label":"Dez","value":407}];
const MX = 673;
