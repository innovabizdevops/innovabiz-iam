...
const PAGE = "Scorecards";
const KPIS = [{"l":"Total Kpi Mgmt","v":"1.678","t":"+17.5%","d":"up"},{"l":"Scorecards Ativos","v":"89","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"78.5%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"82","t":"-3.1%","d":"down"}];
const COLS = ["ID","Scorecards","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Kpi Mgmt #001","71.0%","1.672","5.164","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Kpi Mgmt #002","99.5%","3.837","4.920","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Kpi Mgmt #003","91.5%","8.394","3.730","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Kpi Mgmt #004","70.1%","8.225","5.969","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Kpi Mgmt #005","94.7%","1.317","8.585","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":308},{"label":"Fev","value":600},{"label":"Mar","value":320},{"label":"Abr","value":483},{"label":"Mai","value":604},{"label":"Jun","value":585},{"label":"Jul","value":297},{"label":"Ago","value":268},{"label":"Set","value":422},{"label":"Out","value":359},{"label":"Nov","value":521},{"label":"Dez","value":553}];
const MX = 604;
