...
const PAGE = "Unit";
const KPIS = [{"l":"Dashboards Ativos","v":"8.685","t":"+7.9%","d":"up"},{"l":"Queries/Dia","v":"173","t":"+1.9%","d":"up"},{"l":"Dados Processados (GB)","v":"9.051","t":"+9.4%","d":"up"},{"l":"Utilizadores Analytics","v":"3.101","t":"+17.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","198","2026-02-02","294","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4315","2026-01-24","3.114","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2115","2026-01-27","8.908","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1255","2026-01-26","3.363","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2096","2026-01-12","6.391","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":326},{"label":"Fev","value":505},{"label":"Mar","value":389},{"label":"Abr","value":490},{"label":"Mai","value":281},{"label":"Jun","value":227},{"label":"Jul","value":313},{"label":"Ago","value":233},{"label":"Set","value":593},{"label":"Out","value":561},{"label":"Nov","value":266},{"label":"Dez","value":252}];
const MX = 593;
