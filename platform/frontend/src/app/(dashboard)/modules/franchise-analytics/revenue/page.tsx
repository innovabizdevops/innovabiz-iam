...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€23.8M","t":"+15.5%","d":"up"},{"l":"MRR (€)","v":"€85092","t":"+5.1%","d":"up"},{"l":"Churn (%)","v":"91.7%","t":"+5.1%","d":"up"},{"l":"ARPU (€)","v":"€55696","t":"-2.0%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 33769.06","7.316","€ 32456.77","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 44311.68","8.017","€ 29935.88","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 23813.76","1.045","€ 5348.42","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 3190.05","6.945","€ 49624.55","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 7338.04","8.705","€ 10455.95","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":509},{"label":"Mar","value":685},{"label":"Abr","value":688},{"label":"Mai","value":662},{"label":"Jun","value":499},{"label":"Jul","value":713},{"label":"Ago","value":657},{"label":"Set","value":509},{"label":"Out","value":649},{"label":"Nov","value":586},{"label":"Dez","value":436}];
const MX = 713;
