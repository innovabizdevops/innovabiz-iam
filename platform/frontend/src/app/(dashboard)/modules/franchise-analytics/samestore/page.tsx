...
const PAGE = "SameStore";
const KPIS = [{"l":"Pedidos/Dia","v":"4805","t":"+8.8%","d":"up"},{"l":"GMV (€)","v":"€29992","t":"+15.7%","d":"up"},{"l":"Conversão (%)","v":"76.5%","t":"+1.9%","d":"up"},{"l":"AOV (€)","v":"€50067","t":"+0.2%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 17126.06","8.123","1.937","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 33530.60","7.412","6.834","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 39270.63","2.063","1.456","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 48289.45","8.799","4.407","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 39534.68","3.313","5.579","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":745},{"label":"Mar","value":752},{"label":"Abr","value":1047},{"label":"Mai","value":923},{"label":"Jun","value":931},{"label":"Jul","value":937},{"label":"Ago","value":955},{"label":"Set","value":767},{"label":"Out","value":891},{"label":"Nov","value":710},{"label":"Dez","value":1000}];
const MX = 1047;
...
export default function SamestorePage() {
    return (
