...
const KPIS = [{"l":"Dashboards Ativos","v":"779","t":"+17.8%","d":"up"},{"l":"Queries/Dia","v":"4013","t":"+9.1%","d":"up"},{"l":"Dados Processados (GB)","v":"3.356","t":"+15.3%","d":"up"},{"l":"Utilizadores Analytics","v":"778","t":"-1.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","352","2026-02-08","7.065","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4619","2026-03-10","3.840","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2161","2026-02-04","7.799","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3065","2026-02-21","5.569","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1725","2026-03-26","2.196","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":722},{"label":"Mar","value":483},{"label":"Abr","value":499},{"label":"Mai","value":789},{"label":"Jun","value":557},{"label":"Jul","value":665},{"label":"Ago","value":797},{"label":"Set","value":693},{"label":"Out","value":556},{"label":"Nov","value":650},{"label":"Dez","value":616}];
const MX = 797;
