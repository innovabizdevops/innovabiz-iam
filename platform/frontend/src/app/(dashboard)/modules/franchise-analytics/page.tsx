...
const KPIS = [
    { label: "Total Registos", value: "7781", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4743", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€35K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "183880381", cells: ["FRA-2381", "Franchise Analytics Item 1", "14/2/2026", "€30 481"], status: "active" as const },
    { id: "183883952", cells: ["FRA-5952", "Franchise Analytics Item 2", "1/9/2026", "€34 052"], status: "pending" as const },
    { id: "183887523", cells: ["FRA-9523", "Franchise Analytics Item 3", "16/4/2026", "€37 623"], status: "completed" as const },
    { id: "183891094", cells: ["FRA-4094", "Franchise Analytics Item 4", "3/11/2026", "€41 194"], status: "warning" as const },
    { id: "183894665", cells: ["FRA-7665", "Franchise Analytics Item 5", "18/6/2026", "€44 765"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Franchise Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Franchise Analytics</p>
                    </div>
                </div>
