...
const ACCENT = "#93c5fd";
const MODULE = "Franchise Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"182","t":"+-0.0%","d":"up"},{"l":"Queries/Dia","v":"3288","t":"+11.5%","d":"up"},{"l":"Dados Processados (GB)","v":"8.673","t":"+10.9%","d":"up"},{"l":"Utilizadores Analytics","v":"647","t":"+1.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4683","2026-02-20","1.479","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2341","2026-01-27","4.585","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4172","2026-03-10","3.707","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3886","2026-03-15","473","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1099","2026-02-08","2.166","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":800},{"label":"Fev","value":883},{"label":"Mar","value":743},{"label":"Abr","value":918},{"label":"Mai","value":863},{"label":"Jun","value":732},{"label":"Jul","value":745},{"label":"Ago","value":1037},{"label":"Set","value":939},{"label":"Out","value":838},{"label":"Nov","value":748},{"label":"Dez","value":860}];
const MX = 1037;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#93c5fd'}}>AI</span></h1>
                </div>
