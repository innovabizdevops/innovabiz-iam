...
/* ═══ Usage Metering Engine — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "8532", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2715", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€426K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "210571532", cells: ["USA-8532", "Usage Metering Engine Item 1", "25/9/2026", "€21 632"], status: "active" as const },
    { id: "210575103", cells: ["USA-3103", "Usage Metering Engine Item 2", "12/4/2026", "€25 203"], status: "pending" as const },
    { id: "210578674", cells: ["USA-6674", "Usage Metering Engine Item 3", "27/11/2026", "€28 774"], status: "completed" as const },
    { id: "210582245", cells: ["USA-1245", "Usage Metering Engine Item 4", "14/6/2026", "€32 345"], status: "warning" as const },
    { id: "210585816", cells: ["USA-4816", "Usage Metering Engine Item 5", "1/1/2026", "€35 916"], status: "active" as const },
];
...
export default function UsageMeteringEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Usage Metering Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Usage Metering Engine</p>
                    </div>
                </div>
