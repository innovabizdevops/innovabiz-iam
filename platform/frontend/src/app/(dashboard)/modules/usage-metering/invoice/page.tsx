...
const ACCENT = "#059669";
const MODULE = "Usage Metering Engine";
const PAGE = "Invoice";
const KPIS = [{"l":"Total Usage Metering","v":"4.236","t":"+0.4%","d":"up"},{"l":"Invoice Ativos","v":"7.269","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"81.6%","t":"+8.4%","d":"up"},{"l":"Score Performance","v":"77","t":"-2.2%","d":"down"}];
const COLS = ["ID","Invoice","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Usage Metering #001","Usage Metering #002","3.380","799","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Usage Metering #002","Usage Metering #003","5.150","801","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Usage Metering #003","Usage Metering #004","8.332","5.973","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Usage Metering #004","Usage Metering #005","1.334","4.883","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Usage Metering #005","Usage Metering #001","8.444","2.652","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":605},{"label":"Mar","value":593},{"label":"Abr","value":486},{"label":"Mai","value":653},{"label":"Jun","value":409},{"label":"Jul","value":548},{"label":"Ago","value":323},{"label":"Set","value":439},{"label":"Out","value":322},{"label":"Nov","value":576},{"label":"Dez","value":577}];
const MX = 653;
