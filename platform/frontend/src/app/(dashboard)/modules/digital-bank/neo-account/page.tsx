...
/* ═══ Digital Bank — Neo Account ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "1585", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "459", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3360", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "946560919", cells: ["DIG-4919", "Neo Account Item 1", "4/8/2026", "€11 019"], status: "active" as const },
    { id: "946564490", cells: ["DIG-8490", "Neo Account Item 2", "19/3/2026", "€14 590"], status: "pending" as const },
    { id: "946568061", cells: ["DIG-3061", "Neo Account Item 3", "6/10/2026", "€18 161"], status: "completed" as const },
    { id: "946571632", cells: ["DIG-6632", "Neo Account Item 4", "21/5/2026", "€21 732"], status: "warning" as const },
    { id: "946575203", cells: ["DIG-1203", "Neo Account Item 5", "8/12/2026", "€25 303"], status: "active" as const },
];
...
export default function DigitalBankNeoAccountPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Neo Account</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Digital Bank • Neo Account</p>
                    </div>
                </div>
