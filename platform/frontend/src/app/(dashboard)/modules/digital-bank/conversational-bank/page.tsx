...
/* ═══ Digital Bank — Conversational Bank ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "1011", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "470", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2302", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "91%", trend: "-2%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1519519794", cells: ["DIG-5794", "Conversational Bank Item 1", "3/7/2026", "€19 894"], status: "active" as const },
    { id: "1519523365", cells: ["DIG-9365", "Conversational Bank Item 2", "18/2/2026", "€23 465"], status: "pending" as const },
    { id: "1519526936", cells: ["DIG-3936", "Conversational Bank Item 3", "5/9/2026", "€27 036"], status: "completed" as const },
    { id: "1519530507", cells: ["DIG-7507", "Conversational Bank Item 4", "20/4/2026", "€30 607"], status: "warning" as const },
    { id: "1519534078", cells: ["DIG-2078", "Conversational Bank Item 5", "7/11/2026", "€34 178"], status: "active" as const },
];
...
export default function DigitalBankConversationalBankPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Conversational Bank</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Digital Bank • Conversational Bank</p>
                    </div>
                </div>
