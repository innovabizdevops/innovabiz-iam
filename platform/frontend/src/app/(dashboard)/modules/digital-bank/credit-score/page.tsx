...
/* ═══ Digital Bank — Credit Score ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "1113", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "317", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1664", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2015692249", cells: ["DIG-8249", "Credit Score Item 1", "26/2/2026", "€42 349"], status: "active" as const },
    { id: "2015695820", cells: ["DIG-2820", "Credit Score Item 2", "13/9/2026", "€45 920"], status: "pending" as const },
    { id: "2015699391", cells: ["DIG-6391", "Credit Score Item 3", "28/4/2026", "€49 491"], status: "completed" as const },
    { id: "2015702962", cells: ["DIG-9962", "Credit Score Item 4", "15/11/2026", "€3062"], status: "warning" as const },
    { id: "2015706533", cells: ["DIG-4533", "Credit Score Item 5", "2/6/2026", "€6633"], status: "active" as const },
];
...
export default function DigitalBankCreditScorePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Credit Score</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Digital Bank • Credit Score</p>
                    </div>
                </div>
