...
/* ═══ Digital Bank — Banking As Service ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "4498", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "145", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3496", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1510736797", cells: ["DIG-6797", "Banking As Service Item 1", "18/2/2026", "€36 897"], status: "active" as const },
    { id: "1510740368", cells: ["DIG-1368", "Banking As Service Item 2", "5/9/2026", "€40 468"], status: "pending" as const },
    { id: "1510743939", cells: ["DIG-4939", "Banking As Service Item 3", "20/4/2026", "€44 039"], status: "completed" as const },
    { id: "1510747510", cells: ["DIG-8510", "Banking As Service Item 4", "7/11/2026", "€47 610"], status: "warning" as const },
    { id: "1510751081", cells: ["DIG-3081", "Banking As Service Item 5", "22/6/2026", "€1181"], status: "active" as const },
];
...
export default function DigitalBankBankingAsServicePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Banking As Service</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Digital Bank • Banking As Service</p>
                    </div>
                </div>
