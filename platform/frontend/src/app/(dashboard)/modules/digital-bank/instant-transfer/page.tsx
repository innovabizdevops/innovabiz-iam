...
/* ═══ Digital Bank — Instant Transfer ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2980", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "74", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1427", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1141080326", cells: ["DIG-7326", "Instant Transfer Item 1", "23/3/2026", "€30 426"], status: "active" as const },
    { id: "1141083897", cells: ["DIG-1897", "Instant Transfer Item 2", "10/10/2026", "€33 997"], status: "pending" as const },
    { id: "1141087468", cells: ["DIG-5468", "Instant Transfer Item 3", "25/5/2026", "€37 568"], status: "completed" as const },
    { id: "1141091039", cells: ["DIG-9039", "Instant Transfer Item 4", "12/12/2026", "€41 139"], status: "warning" as const },
    { id: "1141094610", cells: ["DIG-3610", "Instant Transfer Item 5", "27/7/2026", "€44 710"], status: "active" as const },
];
...
export default function DigitalBankInstantTransferPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Instant Transfer</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Digital Bank • Instant Transfer</p>
                    </div>
                </div>
