...
/* ═══ Digital Bank — Savings Goal ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "250", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "298", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2657", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "544722390", cells: ["DIG-7390", "Savings Goal Item 1", "3/7/2026", "€22 490"], status: "active" as const },
    { id: "544725961", cells: ["DIG-1961", "Savings Goal Item 2", "18/2/2026", "€26 061"], status: "pending" as const },
    { id: "544729532", cells: ["DIG-5532", "Savings Goal Item 3", "5/9/2026", "€29 632"], status: "completed" as const },
    { id: "544733103", cells: ["DIG-9103", "Savings Goal Item 4", "20/4/2026", "€33 203"], status: "warning" as const },
    { id: "544736674", cells: ["DIG-3674", "Savings Goal Item 5", "7/11/2026", "€36 774"], status: "active" as const },
];
...
export default function DigitalBankSavingsGoalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Savings Goal</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Digital Bank • Savings Goal</p>
                    </div>
                </div>
