...
/* ═══ Digital Bank — Biometric Auth ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "1737", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "288", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2269", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1037778124", cells: ["DIG-7124", "Biometric Auth Item 1", "13/5/2026", "€28 224"], status: "active" as const },
    { id: "1037781695", cells: ["DIG-1695", "Biometric Auth Item 2", "28/12/2026", "€31 795"], status: "pending" as const },
    { id: "1037785266", cells: ["DIG-5266", "Biometric Auth Item 3", "15/7/2026", "€35 366"], status: "completed" as const },
    { id: "1037788837", cells: ["DIG-8837", "Biometric Auth Item 4", "2/2/2026", "€38 937"], status: "warning" as const },
    { id: "1037792408", cells: ["DIG-3408", "Biometric Auth Item 5", "17/9/2026", "€42 508"], status: "active" as const },
];
...
export default function DigitalBankBiometricAuthPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Biometric Auth</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Digital Bank • Biometric Auth</p>
                    </div>
                </div>
