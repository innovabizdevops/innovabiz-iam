...
/* ═══ Digital Bank — Kyc Digital ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "1226", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "451", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2009", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "728527247", cells: ["DIG-5247", "Kyc Digital Item 1", "8/12/2026", "€27 347"], status: "active" as const },
    { id: "728530818", cells: ["DIG-8818", "Kyc Digital Item 2", "23/7/2026", "€30 918"], status: "pending" as const },
    { id: "728534389", cells: ["DIG-3389", "Kyc Digital Item 3", "10/2/2026", "€34 489"], status: "completed" as const },
    { id: "728537960", cells: ["DIG-6960", "Kyc Digital Item 4", "25/9/2026", "€38 060"], status: "warning" as const },
    { id: "728541531", cells: ["DIG-1531", "Kyc Digital Item 5", "12/4/2026", "€41 631"], status: "active" as const },
];
...
export default function DigitalBankKycDigitalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Kyc Digital</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Digital Bank • Kyc Digital</p>
                    </div>
                </div>
