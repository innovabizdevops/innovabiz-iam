...
/* ═══ Digital Bank — Micro Invest ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "51", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "273", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1924", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "656645261", cells: ["DIG-6261", "Micro Invest Item 1", "14/6/2026", "€45 361"], status: "active" as const },
    { id: "656648832", cells: ["DIG-9832", "Micro Invest Item 2", "1/1/2026", "€48 932"], status: "pending" as const },
    { id: "656652403", cells: ["DIG-4403", "Micro Invest Item 3", "16/8/2026", "€2503"], status: "completed" as const },
    { id: "656655974", cells: ["DIG-7974", "Micro Invest Item 4", "3/3/2026", "€6074"], status: "warning" as const },
    { id: "656659545", cells: ["DIG-2545", "Micro Invest Item 5", "18/10/2026", "€9645"], status: "active" as const },
];
...
export default function DigitalBankMicroInvestPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Micro Invest</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Digital Bank • Micro Invest</p>
                    </div>
                </div>
