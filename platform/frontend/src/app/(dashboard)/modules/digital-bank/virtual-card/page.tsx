...
const KPIS = [
    { label: "Total", value: "2453", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "19", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3133", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "95667519", cells: ["DIG-7519", "Virtual Card Item 1", "4/4/2026", "€17 619"], status: "active" as const },
    { id: "95671090", cells: ["DIG-2090", "Virtual Card Item 2", "19/11/2026", "€21 190"], status: "pending" as const },
    { id: "95674661", cells: ["DIG-5661", "Virtual Card Item 3", "6/6/2026", "€24 761"], status: "completed" as const },
    { id: "95678232", cells: ["DIG-9232", "Virtual Card Item 4", "21/1/2026", "€28 332"], status: "warning" as const },
    { id: "95681803", cells: ["DIG-3803", "Virtual Card Item 5", "8/8/2026", "€31 903"], status: "active" as const },
];
...
export default function DigitalBankVirtualCardPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Virtual Card</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Digital Bank • Virtual Card</p>
                    </div>
                </div>
