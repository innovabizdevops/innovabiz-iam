...
const PAGE = "CDU";
const KPIS = [{"l":"Total Refinery Ops","v":"5.471","t":"+6.7%","d":"up"},{"l":"CDU Ativos","v":"4.479","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"90.5%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"67","t":"+1.1%","d":"up"}];
const COLS = ["ID","CDU","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Refinery Ops #001","Refinery Ops #002","7.719","5.624","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Refinery Ops #002","Refinery Ops #003","5.349","878","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Refinery Ops #003","Refinery Ops #004","6.101","8.914","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Refinery Ops #004","Refinery Ops #005","200","2.560","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Refinery Ops #005","Refinery Ops #001","8.196","7.223","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":648},{"label":"Mar","value":809},{"label":"Abr","value":578},{"label":"Mai","value":759},{"label":"Jun","value":532},{"label":"Jul","value":535},{"label":"Ago","value":570},{"label":"Set","value":770},{"label":"Out","value":658},{"label":"Nov","value":567},{"label":"Dez","value":864}];
const MX = 864;
...
export default function CduPage() {
    return (
