...
const PAGE = "Hydrotreater";
const KPIS = [{"l":"Total Refinery Ops","v":"7.197","t":"-3.0%","d":"down"},{"l":"Hydrotreater Ativos","v":"4.816","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"85.8%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"70","t":"+13.9%","d":"up"}];
const COLS = ["ID","Hydrotreater","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Refinery Ops #001","Refinery Ops #002","4.929","1.207","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Refinery Ops #002","Refinery Ops #003","5.593","3.480","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Refinery Ops #003","Refinery Ops #004","4.204","6.763","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Refinery Ops #004","Refinery Ops #005","3.825","8.294","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Refinery Ops #005","Refinery Ops #001","3.338","4.011","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":622},{"label":"Mar","value":694},{"label":"Abr","value":425},{"label":"Mai","value":685},{"label":"Jun","value":700},{"label":"Jul","value":610},{"label":"Ago","value":666},{"label":"Set","value":468},{"label":"Out","value":638},{"label":"Nov","value":658},{"label":"Dez","value":439}];
const MX = 700;
