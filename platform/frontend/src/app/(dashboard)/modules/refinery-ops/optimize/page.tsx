...
const ACCENT = "#6366f1";
const MODULE = "Refinery Operations";
const PAGE = "Optimize";
const KPIS = [{"l":"Total Refinery Ops","v":"6.825","t":"+9.9%","d":"up"},{"l":"Optimize Ativos","v":"9.045","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"68.8%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"73","t":"+6.6%","d":"up"}];
const COLS = ["ID","Optimize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Refinery Ops #001","Refinery Ops #002","3.026","8.246","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Refinery Ops #002","Refinery Ops #003","5.097","3.303","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Refinery Ops #003","Refinery Ops #004","2.925","4.679","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Refinery Ops #004","Refinery Ops #005","3.807","3.178","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Refinery Ops #005","Refinery Ops #001","8.483","1.462","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":636},{"label":"Mar","value":554},{"label":"Abr","value":579},{"label":"Mai","value":433},{"label":"Jun","value":401},{"label":"Jul","value":534},{"label":"Ago","value":460},{"label":"Set","value":649},{"label":"Out","value":554},{"label":"Nov","value":728},{"label":"Dez","value":778}];
const MX = 778;
