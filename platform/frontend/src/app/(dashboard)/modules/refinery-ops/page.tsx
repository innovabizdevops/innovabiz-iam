...
export default function RefineryOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Refinery Ops</h1><p className="text-sm text-muted-foreground">Refinery Ops • iBOS Enterprise</p></div>
