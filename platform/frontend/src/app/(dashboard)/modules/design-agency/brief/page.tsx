...
const PAGE = "Brief";
const KPIS = [{"l":"Formulários Ativos","v":"2.104","t":"+5.3%","d":"up"},{"l":"Submissões/Dia","v":"1183","t":"+7.9%","d":"up"},{"l":"Documentos Gerados","v":"2.800","t":"-1.6%","d":"down"},{"l":"Templates","v":"798","t":"+1.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.204","2026-01-20","370","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.126","2026-01-25","7.475","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.222","2026-02-01","8.812","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.278","2026-01-13","7.465","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.845","2026-01-22","1.142","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":687},{"label":"Mar","value":616},{"label":"Abr","value":811},{"label":"Mai","value":811},{"label":"Jun","value":669},{"label":"Jul","value":631},{"label":"Ago","value":731},{"label":"Set","value":623},{"label":"Out","value":466},{"label":"Nov","value":511},{"label":"Dez","value":689}];
const MX = 811;
