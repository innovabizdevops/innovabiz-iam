...
const ACCENT = "#6366f1";
const MODULE = "Design Agency";
const PAGE = "Deliver";
const KPIS = [{"l":"Formulários Ativos","v":"6.234","t":"+4.0%","d":"up"},{"l":"Submissões/Dia","v":"745","t":"+9.1%","d":"up"},{"l":"Documentos Gerados","v":"2.965","t":"-3.2%","d":"down"},{"l":"Templates","v":"7.257","t":"-6.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.311","2026-03-23","8.447","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.380","2026-03-18","4.774","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.642","2026-02-19","5.070","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","113","2026-03-07","2.880","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.641","2026-01-21","3.375","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":646},{"label":"Fev","value":675},{"label":"Mar","value":549},{"label":"Abr","value":741},{"label":"Mai","value":640},{"label":"Jun","value":774},{"label":"Jul","value":522},{"label":"Ago","value":699},{"label":"Set","value":479},{"label":"Out","value":489},{"label":"Nov","value":701},{"label":"Dez","value":771}];
const MX = 774;
