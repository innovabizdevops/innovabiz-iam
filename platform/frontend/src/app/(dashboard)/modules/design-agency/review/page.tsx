...
const PAGE = "Review";
const KPIS = [{"l":"Formulários Ativos","v":"4.427","t":"+2.0%","d":"up"},{"l":"Submissões/Dia","v":"3165","t":"+9.5%","d":"up"},{"l":"Documentos Gerados","v":"8.536","t":"+14.8%","d":"up"},{"l":"Templates","v":"3.815","t":"+-0.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","848","2026-02-17","321","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.273","2026-03-11","7.395","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.648","2026-03-06","4.158","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","757","2026-02-28","8.802","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.030","2026-01-10","3.373","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":454},{"label":"Mar","value":709},{"label":"Abr","value":530},{"label":"Mai","value":515},{"label":"Jun","value":645},{"label":"Jul","value":697},{"label":"Ago","value":622},{"label":"Set","value":452},{"label":"Out","value":455},{"label":"Nov","value":576},{"label":"Dez","value":449}];
const MX = 709;
