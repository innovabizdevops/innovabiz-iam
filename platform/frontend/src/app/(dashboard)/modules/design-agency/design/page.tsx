...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"1.133","t":"+16.0%","d":"up"},{"l":"Submissões/Dia","v":"2441","t":"+11.5%","d":"up"},{"l":"Documentos Gerados","v":"8.676","t":"+13.7%","d":"up"},{"l":"Templates","v":"667","t":"+10.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.454","2026-03-25","8.065","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.101","2026-03-04","3.103","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.474","2026-01-08","634","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.906","2026-01-25","2.289","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.634","2026-03-10","8.897","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":711},{"label":"Mar","value":852},{"label":"Abr","value":525},{"label":"Mai","value":565},{"label":"Jun","value":693},{"label":"Jul","value":669},{"label":"Ago","value":766},{"label":"Set","value":692},{"label":"Out","value":750},{"label":"Nov","value":861},{"label":"Dez","value":806}];
const MX = 861;
