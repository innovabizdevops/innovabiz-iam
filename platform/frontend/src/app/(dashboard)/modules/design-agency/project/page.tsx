...
const PAGE = "Project";
const KPIS = [{"l":"Formulários Ativos","v":"5.081","t":"+12.3%","d":"up"},{"l":"Submissões/Dia","v":"1059","t":"+12.1%","d":"up"},{"l":"Documentos Gerados","v":"5.600","t":"+12.6%","d":"up"},{"l":"Templates","v":"7.145","t":"+9.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","105","2026-03-10","850","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.205","2026-01-20","8.701","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.487","2026-01-26","7.799","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.472","2026-03-04","6.688","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.847","2026-01-26","5.153","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":396},{"label":"Fev","value":418},{"label":"Mar","value":439},{"label":"Abr","value":571},{"label":"Mai","value":501},{"label":"Jun","value":571},{"label":"Jul","value":741},{"label":"Ago","value":419},{"label":"Set","value":707},{"label":"Out","value":418},{"label":"Nov","value":652},{"label":"Dez","value":594}];
const MX = 741;
