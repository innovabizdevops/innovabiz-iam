...
const PAGE = "Act";
const KPIS = [{"l":"Aprovações Pendentes","v":"1.904","t":"+12.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"67.9%","t":"-2.2%","d":"down"},{"l":"Tempo Médio (h)","v":"201h","t":"+9.3%","d":"up"},{"l":"Rejeitadas (%)","v":"67.3%","t":"+4.7%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","7.678","€ 43063.28","2.414","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","4.618","€ 50020.53","6.848","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","2.107","€ 38286.77","1.125","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","8.947","€ 26542.35","271","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","8.291","€ 3953.83","3.099","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1047},{"label":"Fev","value":1035},{"label":"Mar","value":925},{"label":"Abr","value":955},{"label":"Mai","value":822},{"label":"Jun","value":767},{"label":"Jul","value":827},{"label":"Ago","value":999},{"label":"Set","value":823},{"label":"Out","value":907},{"label":"Nov","value":1006},{"label":"Dez","value":844}];
const MX = 1047;
