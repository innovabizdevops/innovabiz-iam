...
const PAGE = "Context";
const KPIS = [{"l":"Aprovações Pendentes","v":"2.691","t":"+12.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"85.8%","t":"+13.7%","d":"up"},{"l":"Tempo Médio (h)","v":"146h","t":"+6.5%","d":"up"},{"l":"Rejeitadas (%)","v":"84.7%","t":"+10.8%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","6.127","€ 43382.73","3.519","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","5.312","€ 20724.04","3.741","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","6.507","€ 28681.90","712","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","7.694","€ 33234.61","6.315","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","5.554","€ 49610.00","4.076","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":477},{"label":"Mar","value":624},{"label":"Abr","value":456},{"label":"Mai","value":532},{"label":"Jun","value":535},{"label":"Jul","value":537},{"label":"Ago","value":818},{"label":"Set","value":462},{"label":"Out","value":790},{"label":"Nov","value":796},{"label":"Dez","value":562}];
const MX = 818;
