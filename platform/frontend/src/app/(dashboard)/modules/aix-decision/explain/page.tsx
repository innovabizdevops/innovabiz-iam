...
const PAGE = "Explain";
const KPIS = [{"l":"Aprovações Pendentes","v":"5.590","t":"+8.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"86.0%","t":"+15.3%","d":"up"},{"l":"Tempo Médio (h)","v":"185h","t":"-3.5%","d":"down"},{"l":"Rejeitadas (%)","v":"70.7%","t":"+2.8%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","4.606","€ 40667.05","4.371","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","676","€ 5179.73","8.184","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","1.441","€ 8028.32","5.787","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","1.876","€ 25930.41","2.333","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","2.951","€ 5458.52","4.305","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":594},{"label":"Mar","value":508},{"label":"Abr","value":586},{"label":"Mai","value":801},{"label":"Jun","value":715},{"label":"Jul","value":464},{"label":"Ago","value":473},{"label":"Set","value":769},{"label":"Out","value":440},{"label":"Nov","value":703},{"label":"Dez","value":444}];
const MX = 801;
