...
const ACCENT = "#4f46e5";
const MODULE = "AIX Decision Support";
const PAGE = "Options";
const KPIS = [{"l":"Configurações","v":"817","t":"-5.5%","d":"down"},{"l":"Últimas Alterações","v":"7.808","t":"+7.5%","d":"up"},{"l":"Ambientes","v":"6.409","t":"+16.2%","d":"up"},{"l":"Versão Config","v":"8.876","t":"+15.5%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 9532.85","1.003","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 35378.73","6.441","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 3059.08","5.427","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 18291.08","4.602","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 12132.00","3.728","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":631},{"label":"Mar","value":770},{"label":"Abr","value":862},{"label":"Mai","value":836},{"label":"Jun","value":802},{"label":"Jul","value":573},{"label":"Ago","value":664},{"label":"Set","value":752},{"label":"Out","value":696},{"label":"Nov","value":596},{"label":"Dez","value":601}];
const MX = 862;
