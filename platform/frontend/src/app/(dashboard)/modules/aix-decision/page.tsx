...
/* ═══ AIX Decision Support — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "5248", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2980", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€261K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "-6%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1429278048", cells: ["AIX-7048", "AIX Decision Support Item 1", "17/1/2026", "€28 148"], status: "active" as const },
    { id: "1429281619", cells: ["AIX-1619", "AIX Decision Support Item 2", "4/8/2026", "€31 719"], status: "pending" as const },
    { id: "1429285190", cells: ["AIX-5190", "AIX Decision Support Item 3", "19/3/2026", "€35 290"], status: "completed" as const },
    { id: "1429288761", cells: ["AIX-8761", "AIX Decision Support Item 4", "6/10/2026", "€38 861"], status: "warning" as const },
    { id: "1429292332", cells: ["AIX-3332", "AIX Decision Support Item 5", "21/5/2026", "€42 432"], status: "active" as const },
];
...
export default function AixDecisionSupportPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AIX Decision Support</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AIX Decision Support</p>
                    </div>
                </div>
