...
const PAGE = "Simulate";
const KPIS = [{"l":"Twins Ativos","v":"5.387","t":"-1.7%","d":"down"},{"l":"Simulações/Dia","v":"729","t":"+8.3%","d":"up"},{"l":"Precisão Modelo (%)","v":"78.0%","t":"+5.4%","d":"up"},{"l":"Latência Sync (ms)","v":"22ms","t":"+6.1%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","86.9%","2026-01-03","2.173","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","73.2%","2026-01-25","2.105","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","98.4%","2026-03-23","5.924","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","81.0%","2026-01-08","378","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","97.0%","2026-01-24","2.728","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":603},{"label":"Mar","value":351},{"label":"Abr","value":585},{"label":"Mai","value":587},{"label":"Jun","value":430},{"label":"Jul","value":662},{"label":"Ago","value":566},{"label":"Set","value":654},{"label":"Out","value":559},{"label":"Nov","value":425},{"label":"Dez","value":554}];
const MX = 662;
