...
const ROWS = [
  { id: "001", c: ["Plumbing Sys-001", "Plumbing Sys Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Plumbing Sys-002", "Plumbing Sys Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Plumbing Sys-003", "Plumbing Sys Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Plumbing Sys-004", "Plumbing Sys Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Plumbing Sys-005", "Plumbing Sys Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Plumbing Sys", ts: "Há 2min", a: "Sistema" },
...
export default function PlumbingSysPage() {
  return (
