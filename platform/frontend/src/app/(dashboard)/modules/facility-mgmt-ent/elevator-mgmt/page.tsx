...
const ROWS = [
  { id: "001", c: ["Elevator Mgmt-001", "Elevator Mgmt Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Elevator Mgmt-002", "Elevator Mgmt Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Elevator Mgmt-003", "Elevator Mgmt Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Elevator Mgmt-004", "Elevator Mgmt Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Elevator Mgmt-005", "Elevator Mgmt Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Elevator Mgmt", ts: "Há 2min", a: "Sistema" },
...
export default function ElevatorMgmtPage() {
  return (
