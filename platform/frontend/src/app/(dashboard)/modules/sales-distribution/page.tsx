...
/* ═══ Sales & Distribution (SAP SD) — Dashboard ═══ */

const ACCENT = "#0070f3";

const KPIS = [
    { label: "Total Registos", value: "3628", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1771", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€335K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "-11%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1177083828", cells: ["SAL-1828", "Sales & Distribution (SAP SD) Item 1", "5/1/2026", "€33 928"], status: "active" as const },
    { id: "1177087399", cells: ["SAL-5399", "Sales & Distribution (SAP SD) Item 2", "20/8/2026", "€37 499"], status: "pending" as const },
    { id: "1177090970", cells: ["SAL-8970", "Sales & Distribution (SAP SD) Item 3", "7/3/2026", "€41 070"], status: "completed" as const },
    { id: "1177094541", cells: ["SAL-3541", "Sales & Distribution (SAP SD) Item 4", "22/10/2026", "€44 641"], status: "warning" as const },
    { id: "1177098112", cells: ["SAL-7112", "Sales & Distribution (SAP SD) Item 5", "9/5/2026", "€48 212"], status: "active" as const },
];
...
export default function SalesDistributionSapSdPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sales & Distribution (SAP SD)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Sales & Distribution (SAP SD)</p>
                    </div>
                </div>
