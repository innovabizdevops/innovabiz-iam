...
const PAGE = "Credit";
const KPIS = [{"l":"Vendas YTD (€)","v":"€91045","t":"+12.5%","d":"up"},{"l":"Pipeline (€)","v":"€81455","t":"+12.8%","d":"up"},{"l":"Atingimento Quota (%)","v":"76.9%","t":"-5.5%","d":"down"},{"l":"Win Rate (%)","v":"68.5%","t":"+17.1%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 34233.42","€ 17458.90","€ 34636.03","92.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 36124.96","€ 23231.47","€ 15010.06","85.0%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 12649.26","€ 29740.03","€ 46173.32","70.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 36371.66","€ 26026.39","€ 8234.01","90.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 37282.23","€ 34524.14","€ 40615.00","81.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":643},{"label":"Mar","value":779},{"label":"Abr","value":818},{"label":"Mai","value":857},{"label":"Jun","value":900},{"label":"Jul","value":859},{"label":"Ago","value":744},{"label":"Set","value":995},{"label":"Out","value":854},{"label":"Nov","value":1013},{"label":"Dez","value":846}];
const MX = 1013;
