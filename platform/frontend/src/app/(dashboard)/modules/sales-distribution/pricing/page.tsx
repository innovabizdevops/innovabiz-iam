...
const PAGE = "Pricing";
const KPIS = [{"l":"Vendas YTD (€)","v":"€14385","t":"-4.0%","d":"down"},{"l":"Pipeline (€)","v":"€82728","t":"+4.6%","d":"up"},{"l":"Atingimento Quota (%)","v":"89.9%","t":"+5.7%","d":"up"},{"l":"Win Rate (%)","v":"75.8%","t":"-2.0%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 41350.54","€ 2667.72","€ 20310.51","83.1%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 44691.00","€ 22662.21","€ 14646.55","76.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 13611.24","€ 8991.17","€ 1262.28","88.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 49832.74","€ 38703.00","€ 43335.78","80.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 36270.62","€ 23990.53","€ 2440.22","92.4%"],"status":"active"}];
const CHART = [{"label":"Jan","value":764},{"label":"Fev","value":779},{"label":"Mar","value":852},{"label":"Abr","value":778},{"label":"Mai","value":814},{"label":"Jun","value":866},{"label":"Jul","value":864},{"label":"Ago","value":937},{"label":"Set","value":700},{"label":"Out","value":880},{"label":"Nov","value":1012},{"label":"Dez","value":792}];
const MX = 1012;
