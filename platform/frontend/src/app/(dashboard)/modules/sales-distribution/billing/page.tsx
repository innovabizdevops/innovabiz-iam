...
const PAGE = "Billing";
const KPIS = [{"l":"Vendas YTD (€)","v":"€51580","t":"+0.1%","d":"up"},{"l":"Pipeline (€)","v":"€60563","t":"+12.8%","d":"up"},{"l":"Atingimento Quota (%)","v":"73.7%","t":"+13.7%","d":"up"},{"l":"Win Rate (%)","v":"87.6%","t":"+7.6%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 8034.54","€ 27983.04","€ 45411.43","85.6%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 29911.85","€ 33956.38","€ 26920.44","94.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 7343.63","€ 33700.12","€ 21258.34","78.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 42427.17","€ 4256.13","€ 5255.36","78.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 40811.70","€ 3771.68","€ 49490.68","88.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":417},{"label":"Mar","value":518},{"label":"Abr","value":448},{"label":"Mai","value":514},{"label":"Jun","value":581},{"label":"Jul","value":686},{"label":"Ago","value":490},{"label":"Set","value":705},{"label":"Out","value":637},{"label":"Nov","value":706},{"label":"Dez","value":344}];
const MX = 706;
