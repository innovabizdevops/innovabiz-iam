...
const ACCENT = "#0070f3";
const MODULE = "Sales & Distribution (SAP SD)";
const PAGE = "Order";
const KPIS = [{"l":"Vendas YTD (€)","v":"€18543","t":"-0.3%","d":"down"},{"l":"Pipeline (€)","v":"€22262","t":"-5.5%","d":"down"},{"l":"Atingimento Quota (%)","v":"80.7%","t":"+7.5%","d":"up"},{"l":"Win Rate (%)","v":"75.1%","t":"+9.1%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 27765.10","€ 21062.00","€ 5095.51","94.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 21777.25","€ 46844.36","€ 24070.30","96.0%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 28506.34","€ 7925.38","€ 9639.16","83.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 13034.82","€ 42241.19","€ 40862.04","96.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 14983.90","€ 23344.57","€ 6756.25","94.1%"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":614},{"label":"Mar","value":998},{"label":"Abr","value":828},{"label":"Mai","value":798},{"label":"Jun","value":791},{"label":"Jul","value":717},{"label":"Ago","value":999},{"label":"Set","value":981},{"label":"Out","value":1002},{"label":"Nov","value":1003},{"label":"Dez","value":760}];
const MX = 1003;
