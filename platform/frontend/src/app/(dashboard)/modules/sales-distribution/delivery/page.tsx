...
const PAGE = "Delivery";
const KPIS = [{"l":"Vendas YTD (€)","v":"€26562","t":"-5.1%","d":"down"},{"l":"Pipeline (€)","v":"€15160","t":"+2.0%","d":"up"},{"l":"Atingimento Quota (%)","v":"76.0%","t":"+12.6%","d":"up"},{"l":"Win Rate (%)","v":"86.7%","t":"+17.1%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 35740.00","€ 44845.54","€ 21894.93","96.7%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 18182.59","€ 43161.10","€ 26838.01","78.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 30932.64","€ 4269.87","€ 13981.40","96.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 987.56","€ 35749.56","€ 10757.36","91.1%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 2082.95","€ 17588.60","€ 39740.53","92.9%"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":862},{"label":"Mar","value":833},{"label":"Abr","value":795},{"label":"Mai","value":807},{"label":"Jun","value":860},{"label":"Jul","value":816},{"label":"Ago","value":723},{"label":"Set","value":844},{"label":"Out","value":624},{"label":"Nov","value":707},{"label":"Dez","value":619}];
const MX = 862;
