...
/* ═══ Rehabilitation Center — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "7197", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2611", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€408K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1520320397", cells: ["REH-5397", "Rehabilitation Center Item 1", "2/6/2026", "€20 497"], status: "active" as const },
    { id: "1520323968", cells: ["REH-8968", "Rehabilitation Center Item 2", "17/1/2026", "€24 068"], status: "pending" as const },
    { id: "1520327539", cells: ["REH-3539", "Rehabilitation Center Item 3", "4/8/2026", "€27 639"], status: "completed" as const },
    { id: "1520331110", cells: ["REH-7110", "Rehabilitation Center Item 4", "19/3/2026", "€31 210"], status: "warning" as const },
    { id: "1520334681", cells: ["REH-1681", "Rehabilitation Center Item 5", "6/10/2026", "€34 781"], status: "active" as const },
];
...
export default function RehabilitationCenterPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Rehabilitation Center</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Rehabilitation Center</p>
                    </div>
                </div>
