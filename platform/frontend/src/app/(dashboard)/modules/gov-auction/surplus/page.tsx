...
const PAGE = "Surplus";
const KPIS = [{"l":"Total Gov Auction","v":"8.671","t":"-3.4%","d":"down"},{"l":"Surplus Ativos","v":"2.053","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"88.2%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"93","t":"+13.9%","d":"up"}];
const COLS = ["ID","Surplus","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gov Auction #001","Gov Auction #002","4.636","2.121","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Gov Auction #002","Gov Auction #003","6.717","3.036","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Gov Auction #003","Gov Auction #004","4.714","4.535","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Gov Auction #004","Gov Auction #005","5.854","1.639","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gov Auction #005","Gov Auction #001","439","7.634","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":928},{"label":"Fev","value":850},{"label":"Mar","value":968},{"label":"Abr","value":990},{"label":"Mai","value":821},{"label":"Jun","value":669},{"label":"Jul","value":963},{"label":"Ago","value":841},{"label":"Set","value":730},{"label":"Out","value":791},{"label":"Nov","value":760},{"label":"Dez","value":1001}];
const MX = 1001;
