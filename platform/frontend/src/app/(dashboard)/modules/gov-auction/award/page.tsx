...
const ACCENT = "#713f12";
const MODULE = "Government Auction";
const PAGE = "Award";
const KPIS = [{"l":"Total Gov Auction","v":"8.753","t":"+10.7%","d":"up"},{"l":"Award Ativos","v":"7.831","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"68.9%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"75","t":"-4.4%","d":"down"}];
const COLS = ["ID","Award","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gov Auction #001","Gov Auction #002","7.064","4.076","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Gov Auction #002","Gov Auction #003","7.811","1.529","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Gov Auction #003","Gov Auction #004","7.416","8.596","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Gov Auction #004","Gov Auction #005","1.798","2.100","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gov Auction #005","Gov Auction #001","8.071","6.460","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":782},{"label":"Fev","value":477},{"label":"Mar","value":424},{"label":"Abr","value":752},{"label":"Mai","value":670},{"label":"Jun","value":715},{"label":"Jul","value":546},{"label":"Ago","value":758},{"label":"Set","value":540},{"label":"Out","value":539},{"label":"Nov","value":422},{"label":"Dez","value":695}];
const MX = 782;
