...
/* ═══ Government Auction — Dashboard ═══ */

const ACCENT = "#713f12";

const KPIS = [
    { label: "Total Registos", value: "1181", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4902", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€201K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "382428181", cells: ["GOV-1181", "Government Auction Item 1", "10/2/2026", "€28 281"], status: "active" as const },
    { id: "382431752", cells: ["GOV-4752", "Government Auction Item 2", "25/9/2026", "€31 852"], status: "pending" as const },
    { id: "382435323", cells: ["GOV-8323", "Government Auction Item 3", "12/4/2026", "€35 423"], status: "completed" as const },
    { id: "382438894", cells: ["GOV-2894", "Government Auction Item 4", "27/11/2026", "€38 994"], status: "warning" as const },
    { id: "382442465", cells: ["GOV-6465", "Government Auction Item 5", "14/6/2026", "€42 565"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Government Auction</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Government Auction</p>
                    </div>
                </div>
