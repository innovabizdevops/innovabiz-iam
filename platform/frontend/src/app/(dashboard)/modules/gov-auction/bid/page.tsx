...
const PAGE = "Bid";
const KPIS = [{"l":"Fornecedores Ativos","v":"5.757","t":"-1.1%","d":"down"},{"l":"Contratos (€M)","v":"€42.3M","t":"+9.2%","d":"up"},{"l":"On-Time Delivery (%)","v":"71.3%","t":"-2.2%","d":"down"},{"l":"Score Médio","v":"80","t":"+14.3%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","82.5%","€ 21675.39","3.345","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","95.9%","€ 18143.82","9.011","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","87.4%","€ 1104.44","7.785","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","92.3%","€ 38772.64","2.947","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","70.1%","€ 20353.56","8.760","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":410},{"label":"Mar","value":675},{"label":"Abr","value":604},{"label":"Mai","value":594},{"label":"Jun","value":573},{"label":"Jul","value":482},{"label":"Ago","value":398},{"label":"Set","value":593},{"label":"Out","value":704},{"label":"Nov","value":493},{"label":"Dez","value":540}];
const MX = 704;
