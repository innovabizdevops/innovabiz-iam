...
const PAGE = "Seized";
const KPIS = [{"l":"Total Gov Auction","v":"1.101","t":"+16.6%","d":"up"},{"l":"Seized Ativos","v":"412","t":"+7.2%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"64","t":"+13.9%","d":"up"}];
const COLS = ["ID","Seized","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gov Auction #001","Gov Auction #002","5.535","1.472","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Gov Auction #002","Gov Auction #003","5.442","179","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Gov Auction #003","Gov Auction #004","4.646","3.875","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Gov Auction #004","Gov Auction #005","1.513","1.786","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gov Auction #005","Gov Auction #001","4.768","6.965","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":436},{"label":"Fev","value":358},{"label":"Mar","value":496},{"label":"Abr","value":425},{"label":"Mai","value":642},{"label":"Jun","value":520},{"label":"Jul","value":640},{"label":"Ago","value":465},{"label":"Set","value":322},{"label":"Out","value":446},{"label":"Nov","value":353},{"label":"Dez","value":519}];
const MX = 642;
