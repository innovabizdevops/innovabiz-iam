...
const PAGE = "List";
const KPIS = [{"l":"Total Gov Auction","v":"4.716","t":"-2.4%","d":"down"},{"l":"List Ativos","v":"2.858","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"80.7%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"74","t":"+17.3%","d":"up"}];
const COLS = ["ID","List","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gov Auction #001","Gov Auction #002","2.204","1.483","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Gov Auction #002","Gov Auction #003","6.070","5.465","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Gov Auction #003","Gov Auction #004","5.064","6.544","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Gov Auction #004","Gov Auction #005","6.461","2.705","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gov Auction #005","Gov Auction #001","1.863","3.576","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":851},{"label":"Mar","value":767},{"label":"Abr","value":660},{"label":"Mai","value":765},{"label":"Jun","value":635},{"label":"Jul","value":808},{"label":"Ago","value":834},{"label":"Set","value":846},{"label":"Out","value":576},{"label":"Nov","value":779},{"label":"Dez","value":574}];
const MX = 851;
