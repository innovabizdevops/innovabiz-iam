...
/* ═══ Infrastructure Mgmt — Tunnel Monitor ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "3775", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "485", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1118", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1972868273", cells: ["INF-6273", "Tunnel Monitor Item 1", "6/6/2026", "€18 373"], status: "active" as const },
    { id: "1972871844", cells: ["INF-9844", "Tunnel Monitor Item 2", "21/1/2026", "€21 944"], status: "pending" as const },
    { id: "1972875415", cells: ["INF-4415", "Tunnel Monitor Item 3", "8/8/2026", "€25 515"], status: "completed" as const },
    { id: "1972878986", cells: ["INF-7986", "Tunnel Monitor Item 4", "23/3/2026", "€29 086"], status: "warning" as const },
    { id: "1972882557", cells: ["INF-2557", "Tunnel Monitor Item 5", "10/10/2026", "€32 657"], status: "active" as const },
];
...
export default function InfrastructureMgmtTunnelMonitorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tunnel Monitor</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Infrastructure Mgmt • Tunnel Monitor</p>
                    </div>
                </div>
