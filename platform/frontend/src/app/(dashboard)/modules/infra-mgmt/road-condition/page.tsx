...
/* ═══ Infrastructure Mgmt — Road Condition ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "2346", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "350", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3954", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "473416490", cells: ["INF-8490", "Road Condition Item 1", "23/3/2026", "€16 590"], status: "active" as const },
    { id: "473420061", cells: ["INF-3061", "Road Condition Item 2", "10/10/2026", "€20 161"], status: "pending" as const },
    { id: "473423632", cells: ["INF-6632", "Road Condition Item 3", "25/5/2026", "€23 732"], status: "completed" as const },
    { id: "473427203", cells: ["INF-1203", "Road Condition Item 4", "12/12/2026", "€27 303"], status: "warning" as const },
    { id: "473430774", cells: ["INF-4774", "Road Condition Item 5", "27/7/2026", "€30 874"], status: "active" as const },
];
...
export default function InfrastructureMgmtRoadConditionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Road Condition</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Infrastructure Mgmt • Road Condition</p>
                    </div>
                </div>
