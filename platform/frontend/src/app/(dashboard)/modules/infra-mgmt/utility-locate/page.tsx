...
/* ═══ Infrastructure Mgmt — Utility Locate ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "1298", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "473", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1970", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "90%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "555457493", cells: ["INF-5493", "Utility Locate Item 1", "18/6/2026", "€7593"], status: "active" as const },
    { id: "555461064", cells: ["INF-9064", "Utility Locate Item 2", "5/1/2026", "€11 164"], status: "pending" as const },
    { id: "555464635", cells: ["INF-3635", "Utility Locate Item 3", "20/8/2026", "€14 735"], status: "completed" as const },
    { id: "555468206", cells: ["INF-7206", "Utility Locate Item 4", "7/3/2026", "€18 306"], status: "warning" as const },
    { id: "555471777", cells: ["INF-1777", "Utility Locate Item 5", "22/10/2026", "€21 877"], status: "active" as const },
];
...
export default function InfrastructureMgmtUtilityLocatePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Utility Locate</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Infrastructure Mgmt • Utility Locate</p>
                    </div>
                </div>
