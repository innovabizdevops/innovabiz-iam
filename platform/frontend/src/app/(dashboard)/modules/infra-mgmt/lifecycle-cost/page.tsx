...
/* ═══ Infrastructure Mgmt — Lifecycle Cost ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "669", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "466", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1967", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "533251566", cells: ["INF-2566", "Lifecycle Cost Item 1", "23/7/2026", "€1666"], status: "active" as const },
    { id: "533255137", cells: ["INF-6137", "Lifecycle Cost Item 2", "10/2/2026", "€5237"], status: "pending" as const },
    { id: "533258708", cells: ["INF-9708", "Lifecycle Cost Item 3", "25/9/2026", "€8808"], status: "completed" as const },
    { id: "533262279", cells: ["INF-4279", "Lifecycle Cost Item 4", "12/4/2026", "€12 379"], status: "warning" as const },
    { id: "533265850", cells: ["INF-7850", "Lifecycle Cost Item 5", "27/11/2026", "€15 950"], status: "active" as const },
];
...
export default function InfrastructureMgmtLifecycleCostPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Lifecycle Cost</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Infrastructure Mgmt • Lifecycle Cost</p>
                    </div>
                </div>
