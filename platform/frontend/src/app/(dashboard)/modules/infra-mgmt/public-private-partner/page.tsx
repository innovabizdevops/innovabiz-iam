...
/* ═══ Infrastructure Mgmt — Public Private Partner ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "4888", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "215", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2705", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "74%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "2098893667", cells: ["INF-4667", "Public Private Partner Item 1", "4/8/2026", "€43 767"], status: "active" as const },
    { id: "2098897238", cells: ["INF-8238", "Public Private Partner Item 2", "19/3/2026", "€47 338"], status: "pending" as const },
    { id: "2098900809", cells: ["INF-2809", "Public Private Partner Item 3", "6/10/2026", "€909"], status: "completed" as const },
    { id: "2098904380", cells: ["INF-6380", "Public Private Partner Item 4", "21/5/2026", "€4480"], status: "warning" as const },
    { id: "2098907951", cells: ["INF-9951", "Public Private Partner Item 5", "8/12/2026", "€8051"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 87 }, { label: "Fev", value: 96 }, { label: "Mar", value: 25 }, { label: "Abr", value: 34 }, { label: "Mai", value: 43 }, { label: "Jun", value: 52 }];
...
export default function InfrastructureMgmtPublicPrivatePartnerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Public Private Partner</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Infrastructure Mgmt • Public Private Partner</p>
                    </div>
                </div>
