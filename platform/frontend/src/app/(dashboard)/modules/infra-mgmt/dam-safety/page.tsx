...
/* ═══ Infrastructure Mgmt — Dam Safety ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "1787", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "85", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2607", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "965130289", cells: ["INF-7289", "Dam Safety Item 1", "26/2/2026", "€30 389"], status: "active" as const },
    { id: "965133860", cells: ["INF-1860", "Dam Safety Item 2", "13/9/2026", "€33 960"], status: "pending" as const },
    { id: "965137431", cells: ["INF-5431", "Dam Safety Item 3", "28/4/2026", "€37 531"], status: "completed" as const },
    { id: "965141002", cells: ["INF-9002", "Dam Safety Item 4", "15/11/2026", "€41 102"], status: "warning" as const },
    { id: "965144573", cells: ["INF-3573", "Dam Safety Item 5", "2/6/2026", "€44 673"], status: "active" as const },
];
...
export default function InfrastructureMgmtDamSafetyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Dam Safety</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Infrastructure Mgmt • Dam Safety</p>
                    </div>
                </div>
