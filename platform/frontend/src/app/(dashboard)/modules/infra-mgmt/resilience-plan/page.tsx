...
/* ═══ Infrastructure Mgmt — Resilience Plan ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "146", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "59", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1345", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "276809239", cells: ["INF-6239", "Resilience Plan Item 1", "8/8/2026", "€9339"], status: "active" as const },
    { id: "276812810", cells: ["INF-9810", "Resilience Plan Item 2", "23/3/2026", "€12 910"], status: "pending" as const },
    { id: "276816381", cells: ["INF-4381", "Resilience Plan Item 3", "10/10/2026", "€16 481"], status: "completed" as const },
    { id: "276819952", cells: ["INF-7952", "Resilience Plan Item 4", "25/5/2026", "€20 052"], status: "warning" as const },
    { id: "276823523", cells: ["INF-2523", "Resilience Plan Item 5", "12/12/2026", "€23 623"], status: "active" as const },
];
...
export default function InfrastructureMgmtResiliencePlanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Resilience Plan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Infrastructure Mgmt • Resilience Plan</p>
                    </div>
                </div>
