...
/* ═══ Infrastructure Mgmt — Bridge Inspect ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "1634", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "264", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "148", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "89%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "692151412", cells: ["INF-7412", "Bridge Inspect Item 1", "9/5/2026", "€1512"], status: "active" as const },
    { id: "692154983", cells: ["INF-1983", "Bridge Inspect Item 2", "24/12/2026", "€5083"], status: "pending" as const },
    { id: "692158554", cells: ["INF-5554", "Bridge Inspect Item 3", "11/7/2026", "€8654"], status: "completed" as const },
    { id: "692162125", cells: ["INF-9125", "Bridge Inspect Item 4", "26/2/2026", "€12 225"], status: "warning" as const },
    { id: "692165696", cells: ["INF-3696", "Bridge Inspect Item 5", "13/9/2026", "€15 796"], status: "active" as const },
];
...
export default function InfrastructureMgmtBridgeInspectPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Bridge Inspect</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Infrastructure Mgmt • Bridge Inspect</p>
                    </div>
                </div>
