...
/* ═══ Infrastructure Mgmt — Rail Track ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "4850", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "192", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "336", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1386665420", cells: ["INF-9420", "Rail Track Item 1", "1/9/2026", "€15 520"], status: "active" as const },
    { id: "1386668991", cells: ["INF-3991", "Rail Track Item 2", "16/4/2026", "€19 091"], status: "pending" as const },
    { id: "1386672562", cells: ["INF-7562", "Rail Track Item 3", "3/11/2026", "€22 662"], status: "completed" as const },
    { id: "1386676133", cells: ["INF-2133", "Rail Track Item 4", "18/6/2026", "€26 233"], status: "warning" as const },
    { id: "1386679704", cells: ["INF-5704", "Rail Track Item 5", "5/1/2026", "€29 804"], status: "active" as const },
];
...
export default function InfrastructureMgmtRailTrackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Rail Track</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Infrastructure Mgmt • Rail Track</p>
                    </div>
                </div>
