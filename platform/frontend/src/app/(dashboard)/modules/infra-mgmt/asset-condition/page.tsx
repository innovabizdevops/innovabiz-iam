...
/* ═══ Infrastructure Mgmt — Asset Condition ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "69", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "128", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "801", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "814488188", cells: ["INF-7188", "Asset Condition Item 1", "25/9/2026", "€38 288"], status: "active" as const },
    { id: "814491759", cells: ["INF-1759", "Asset Condition Item 2", "12/4/2026", "€41 859"], status: "pending" as const },
    { id: "814495330", cells: ["INF-5330", "Asset Condition Item 3", "27/11/2026", "€45 430"], status: "completed" as const },
    { id: "814498901", cells: ["INF-8901", "Asset Condition Item 4", "14/6/2026", "€49 001"], status: "warning" as const },
    { id: "814502472", cells: ["INF-3472", "Asset Condition Item 5", "1/1/2026", "€2572"], status: "active" as const },
];
...
export default function InfrastructureMgmtAssetConditionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Asset Condition</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Infrastructure Mgmt • Asset Condition</p>
                    </div>
                </div>
