...
/* ═══ Auto Manufacturing — Paint Line ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "1778", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "295", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "599", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "106480595", cells: ["AUT-2595", "Paint Line Item 1", "12/12/2026", "€30 695"], status: "active" as const },
    { id: "106484166", cells: ["AUT-6166", "Paint Line Item 2", "27/7/2026", "€34 266"], status: "pending" as const },
    { id: "106487737", cells: ["AUT-9737", "Paint Line Item 3", "14/2/2026", "€37 837"], status: "completed" as const },
    { id: "106491308", cells: ["AUT-4308", "Paint Line Item 4", "1/9/2026", "€41 408"], status: "warning" as const },
    { id: "106494879", cells: ["AUT-7879", "Paint Line Item 5", "16/4/2026", "€44 979"], status: "active" as const },
];
...
export default function AutoManufacturingPaintLinePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Paint Line</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Auto Manufacturing • Paint Line</p>
                    </div>
                </div>
