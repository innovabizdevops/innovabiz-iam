...
/* ═══ Auto Manufacturing — Quality Gate ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "86", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "171", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3111", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "544966295", cells: ["AUT-8295", "Quality Gate Item 1", "28/12/2026", "€16 395"], status: "active" as const },
    { id: "544969866", cells: ["AUT-2866", "Quality Gate Item 2", "15/7/2026", "€19 966"], status: "pending" as const },
    { id: "544973437", cells: ["AUT-6437", "Quality Gate Item 3", "2/2/2026", "€23 537"], status: "completed" as const },
    { id: "544977008", cells: ["AUT-1008", "Quality Gate Item 4", "17/9/2026", "€27 108"], status: "warning" as const },
    { id: "544980579", cells: ["AUT-4579", "Quality Gate Item 5", "4/4/2026", "€30 679"], status: "active" as const },
];
...
export default function AutoManufacturingQualityGatePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Quality Gate</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Auto Manufacturing • Quality Gate</p>
                    </div>
                </div>
