...
/* ═══ Auto Manufacturing — Body Shop ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "3591", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "59", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1421", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1866105335", cells: ["AUT-1335", "Body Shop Item 1", "4/12/2026", "€5435"], status: "active" as const },
    { id: "1866108906", cells: ["AUT-4906", "Body Shop Item 2", "19/7/2026", "€9006"], status: "pending" as const },
    { id: "1866112477", cells: ["AUT-8477", "Body Shop Item 3", "6/2/2026", "€12 577"], status: "completed" as const },
    { id: "1866116048", cells: ["AUT-3048", "Body Shop Item 4", "21/9/2026", "€16 148"], status: "warning" as const },
    { id: "1866119619", cells: ["AUT-6619", "Body Shop Item 5", "8/4/2026", "€19 719"], status: "active" as const },
];
...
export default function AutoManufacturingBodyShopPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Body Shop</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Auto Manufacturing • Body Shop</p>
                    </div>
                </div>
