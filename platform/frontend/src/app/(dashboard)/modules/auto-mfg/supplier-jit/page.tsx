...
/* ═══ Auto Manufacturing — Supplier Jit ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "1174", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "130", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3904", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1683399838", cells: ["AUT-4838", "Supplier Jit Item 1", "23/11/2026", "€49 938"], status: "active" as const },
    { id: "1683403409", cells: ["AUT-8409", "Supplier Jit Item 2", "10/6/2026", "€3509"], status: "pending" as const },
    { id: "1683406980", cells: ["AUT-2980", "Supplier Jit Item 3", "25/1/2026", "€7080"], status: "completed" as const },
    { id: "1683410551", cells: ["AUT-6551", "Supplier Jit Item 4", "12/8/2026", "€10 651"], status: "warning" as const },
    { id: "1683414122", cells: ["AUT-1122", "Supplier Jit Item 5", "27/3/2026", "€14 222"], status: "active" as const },
];
...
export default function AutoManufacturingSupplierJitPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Supplier Jit</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Auto Manufacturing • Supplier Jit</p>
                    </div>
                </div>
