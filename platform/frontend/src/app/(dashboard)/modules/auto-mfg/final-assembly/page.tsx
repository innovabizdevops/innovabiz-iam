...
/* ═══ Auto Manufacturing — Final Assembly ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "3561", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "337", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3567", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "451361837", cells: ["AUT-3837", "Final Assembly Item 1", "18/6/2026", "€11 937"], status: "active" as const },
    { id: "451365408", cells: ["AUT-7408", "Final Assembly Item 2", "5/1/2026", "€15 508"], status: "pending" as const },
    { id: "451368979", cells: ["AUT-1979", "Final Assembly Item 3", "20/8/2026", "€19 079"], status: "completed" as const },
    { id: "451372550", cells: ["AUT-5550", "Final Assembly Item 4", "7/3/2026", "€22 650"], status: "warning" as const },
    { id: "451376121", cells: ["AUT-9121", "Final Assembly Item 5", "22/10/2026", "€26 221"], status: "active" as const },
];
...
export default function AutoManufacturingFinalAssemblyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Final Assembly</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Auto Manufacturing • Final Assembly</p>
                    </div>
                </div>
