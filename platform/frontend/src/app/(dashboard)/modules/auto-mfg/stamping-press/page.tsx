...
/* ═══ Auto Manufacturing — Stamping Press ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "2723", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "325", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3695", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "80%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1154847553", cells: ["AUT-4553", "Stamping Press Item 1", "14/2/2026", "€47 653"], status: "active" as const },
    { id: "1154851124", cells: ["AUT-8124", "Stamping Press Item 2", "1/9/2026", "€1224"], status: "pending" as const },
    { id: "1154854695", cells: ["AUT-2695", "Stamping Press Item 3", "16/4/2026", "€4795"], status: "completed" as const },
    { id: "1154858266", cells: ["AUT-6266", "Stamping Press Item 4", "3/11/2026", "€8366"], status: "warning" as const },
    { id: "1154861837", cells: ["AUT-9837", "Stamping Press Item 5", "18/6/2026", "€11 937"], status: "active" as const },
];
...
export default function AutoManufacturingStampingPressPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Stamping Press</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Auto Manufacturing • Stamping Press</p>
                    </div>
                </div>
