...
/* ═══ Auto Manufacturing — Engine Plant ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "1960", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "282", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2075", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "963018518", cells: ["AUT-1518", "Engine Plant Item 1", "15/3/2026", "€18 618"], status: "active" as const },
    { id: "963022089", cells: ["AUT-5089", "Engine Plant Item 2", "2/10/2026", "€22 189"], status: "pending" as const },
    { id: "963025660", cells: ["AUT-8660", "Engine Plant Item 3", "17/5/2026", "€25 760"], status: "completed" as const },
    { id: "963029231", cells: ["AUT-3231", "Engine Plant Item 4", "4/12/2026", "€29 331"], status: "warning" as const },
    { id: "963032802", cells: ["AUT-6802", "Engine Plant Item 5", "19/7/2026", "€32 902"], status: "active" as const },
];
...
export default function AutoManufacturingEnginePlantPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Engine Plant</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Auto Manufacturing • Engine Plant</p>
                    </div>
                </div>
