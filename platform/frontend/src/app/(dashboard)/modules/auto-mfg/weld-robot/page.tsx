...
/* ═══ Auto Manufacturing — Weld Robot ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "250", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "407", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1543", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1618272339", cells: ["AUT-1339", "Weld Robot Item 1", "20/4/2026", "€22 439"], status: "active" as const },
    { id: "1618275910", cells: ["AUT-4910", "Weld Robot Item 2", "7/11/2026", "€26 010"], status: "pending" as const },
    { id: "1618279481", cells: ["AUT-8481", "Weld Robot Item 3", "22/6/2026", "€29 581"], status: "completed" as const },
    { id: "1618283052", cells: ["AUT-3052", "Weld Robot Item 4", "9/1/2026", "€33 152"], status: "warning" as const },
    { id: "1618286623", cells: ["AUT-6623", "Weld Robot Item 5", "24/8/2026", "€36 723"], status: "active" as const },
];
...
export default function AutoManufacturingWeldRobotPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Weld Robot</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Auto Manufacturing • Weld Robot</p>
                    </div>
                </div>
