...
/* ═══ Auto Manufacturing — Sequencing ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "3298", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "121", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3427", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "799488645", cells: ["AUT-1645", "Sequencing Item 1", "26/10/2026", "€38 745"], status: "active" as const },
    { id: "799492216", cells: ["AUT-5216", "Sequencing Item 2", "13/5/2026", "€42 316"], status: "pending" as const },
    { id: "799495787", cells: ["AUT-8787", "Sequencing Item 3", "28/12/2026", "€45 887"], status: "completed" as const },
    { id: "799499358", cells: ["AUT-3358", "Sequencing Item 4", "15/7/2026", "€49 458"], status: "warning" as const },
    { id: "799502929", cells: ["AUT-6929", "Sequencing Item 5", "2/2/2026", "€3029"], status: "active" as const },
];
...
export default function AutoManufacturingSequencingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sequencing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Auto Manufacturing • Sequencing</p>
                    </div>
                </div>
