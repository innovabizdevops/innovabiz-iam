...
/* ═══ Auto Manufacturing — End Of Line Test ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "1490", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "93", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1573", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "78736137", cells: ["AUT-5137", "End Of Line Test Item 1", "26/10/2026", "€36 237"], status: "active" as const },
    { id: "78739708", cells: ["AUT-8708", "End Of Line Test Item 2", "13/5/2026", "€39 808"], status: "pending" as const },
    { id: "78743279", cells: ["AUT-3279", "End Of Line Test Item 3", "28/12/2026", "€43 379"], status: "completed" as const },
    { id: "78746850", cells: ["AUT-6850", "End Of Line Test Item 4", "15/7/2026", "€46 950"], status: "warning" as const },
    { id: "78750421", cells: ["AUT-1421", "End Of Line Test Item 5", "2/2/2026", "€521"], status: "active" as const },
];
...
export default function AutoManufacturingEndOfLineTestPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">End Of Line Test</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Auto Manufacturing • End Of Line Test</p>
                    </div>
                </div>
