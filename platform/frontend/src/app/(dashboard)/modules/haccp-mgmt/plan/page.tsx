...
const KPIS = [{"l":"Total Haccp Mgmt","v":"5.359","t":"+8.6%","d":"up"},{"l":"HACCP Plan Ativos","v":"7.748","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"83.5%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"70","t":"+11.4%","d":"up"}];
const COLS = ["ID","HACCP Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Haccp Mgmt #001","Haccp Mgmt #002","7.747","1.315","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Haccp Mgmt #002","Haccp Mgmt #003","5.956","1.493","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Haccp Mgmt #003","Haccp Mgmt #004","3.723","2.389","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Haccp Mgmt #004","Haccp Mgmt #005","3.044","680","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Haccp Mgmt #005","Haccp Mgmt #001","6.424","1.743","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":822},{"label":"Mar","value":870},{"label":"Abr","value":522},{"label":"Mai","value":577},{"label":"Jun","value":601},{"label":"Jul","value":825},{"label":"Ago","value":592},{"label":"Set","value":633},{"label":"Out","value":566},{"label":"Nov","value":491},{"label":"Dez","value":575}];
const MX = 870;
