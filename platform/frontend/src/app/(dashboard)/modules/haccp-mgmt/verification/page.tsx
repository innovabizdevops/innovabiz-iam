...
const KPIS = [{"l":"Total Haccp Mgmt","v":"4.437","t":"+13.9%","d":"up"},{"l":"Verification Ativos","v":"1.725","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"72.0%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"74","t":"+5.1%","d":"up"}];
const COLS = ["ID","Verification","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Haccp Mgmt #001","Haccp Mgmt #002","2.893","2.206","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Haccp Mgmt #002","Haccp Mgmt #003","6.855","4.288","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Haccp Mgmt #003","Haccp Mgmt #004","8.433","2.770","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Haccp Mgmt #004","Haccp Mgmt #005","4.050","7.366","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Haccp Mgmt #005","Haccp Mgmt #001","8.247","8.386","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":365},{"label":"Fev","value":635},{"label":"Mar","value":468},{"label":"Abr","value":515},{"label":"Mai","value":288},{"label":"Jun","value":556},{"label":"Jul","value":361},{"label":"Ago","value":305},{"label":"Set","value":393},{"label":"Out","value":634},{"label":"Nov","value":365},{"label":"Dez","value":546}];
const MX = 635;
