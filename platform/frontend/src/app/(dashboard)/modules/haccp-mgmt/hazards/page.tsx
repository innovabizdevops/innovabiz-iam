...
const ACCENT = "#dc2626";
const MODULE = "HACCP Management";
const PAGE = "Hazard Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"7.561","t":"-4.8%","d":"down"},{"l":"Queries/Dia","v":"2451","t":"+15.5%","d":"up"},{"l":"Dados Processados (GB)","v":"5.125","t":"+7.5%","d":"up"},{"l":"Utilizadores Analytics","v":"8.839","t":"+5.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3666","2026-02-19","3.961","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5051","2026-03-10","1.715","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4498","2026-03-21","662","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3576","2026-01-23","8.716","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4657","2026-03-14","3.114","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":752},{"label":"Mar","value":963},{"label":"Abr","value":652},{"label":"Mai","value":749},{"label":"Jun","value":863},{"label":"Jul","value":973},{"label":"Ago","value":1033},{"label":"Set","value":743},{"label":"Out","value":654},{"label":"Nov","value":844},{"label":"Dez","value":939}];
const MX = 1033;
