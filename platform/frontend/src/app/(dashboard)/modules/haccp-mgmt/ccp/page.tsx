...
const KPIS = [{"l":"Total Haccp Mgmt","v":"7.492","t":"+16.0%","d":"up"},{"l":"CCP Monitor Ativos","v":"1.562","t":"+13.5%","d":"up"},{"l":"Eficiência (%)","v":"86.8%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"60","t":"+10.0%","d":"up"}];
const COLS = ["ID","CCP Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Haccp Mgmt #001","Haccp Mgmt #002","4.094","8.962","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Haccp Mgmt #002","Haccp Mgmt #003","6.207","6.645","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Haccp Mgmt #003","Haccp Mgmt #004","4.716","8.942","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Haccp Mgmt #004","Haccp Mgmt #005","4.058","1.460","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Haccp Mgmt #005","Haccp Mgmt #001","1.105","2.376","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":367},{"label":"Fev","value":390},{"label":"Mar","value":523},{"label":"Abr","value":384},{"label":"Mai","value":588},{"label":"Jun","value":498},{"label":"Jul","value":543},{"label":"Ago","value":410},{"label":"Set","value":554},{"label":"Out","value":435},{"label":"Nov","value":500},{"label":"Dez","value":652}];
const MX = 652;
