...
const PAGE = "Corrective Acts";
const KPIS = [{"l":"Total Haccp Mgmt","v":"4.483","t":"+4.4%","d":"up"},{"l":"Corrective Acts Ativos","v":"1.603","t":"-5.7%","d":"down"},{"l":"Eficiência (%)","v":"91.1%","t":"+12.2%","d":"up"},{"l":"Score Performance","v":"86","t":"+1.3%","d":"up"}];
const COLS = ["ID","Corrective Acts","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Haccp Mgmt #001","Haccp Mgmt #002","6.227","2.042","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Haccp Mgmt #002","Haccp Mgmt #003","8.797","7.667","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Haccp Mgmt #003","Haccp Mgmt #004","6.201","1.982","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Haccp Mgmt #004","Haccp Mgmt #005","1.698","2.154","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Haccp Mgmt #005","Haccp Mgmt #001","7.503","2.609","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":865},{"label":"Mar","value":719},{"label":"Abr","value":776},{"label":"Mai","value":863},{"label":"Jun","value":798},{"label":"Jul","value":928},{"label":"Ago","value":949},{"label":"Set","value":662},{"label":"Out","value":1019},{"label":"Nov","value":990},{"label":"Dez","value":681}];
const MX = 1019;
