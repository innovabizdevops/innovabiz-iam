...
const PAGE = "Patrol";
const KPIS = [{"l":"Total Security Services","v":"3.238","t":"+7.2%","d":"up"},{"l":"Patrol Ativos","v":"8.165","t":"+15.0%","d":"up"},{"l":"Eficiência (%)","v":"67.2%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"66","t":"-0.2%","d":"down"}];
const COLS = ["ID","Patrol","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Security Services #001","Security Services #002","8.495","661","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Security Services #002","Security Services #003","5.391","991","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Security Services #003","Security Services #004","2.540","257","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Security Services #004","Security Services #005","2.240","2.978","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Security Services #005","Security Services #001","2.534","6.964","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":713},{"label":"Mar","value":543},{"label":"Abr","value":757},{"label":"Mai","value":609},{"label":"Jun","value":687},{"label":"Jul","value":537},{"label":"Ago","value":537},{"label":"Set","value":627},{"label":"Out","value":767},{"label":"Nov","value":755},{"label":"Dez","value":506}];
const MX = 767;
