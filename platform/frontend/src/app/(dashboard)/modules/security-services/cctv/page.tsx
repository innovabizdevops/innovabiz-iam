...
const ACCENT = "#1e293b";
const MODULE = "Security Services";
const PAGE = "CCTV";
const KPIS = [{"l":"Total Security Services","v":"170","t":"-2.8%","d":"down"},{"l":"CCTV Ativos","v":"7.063","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"86.4%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"75","t":"+3.3%","d":"up"}];
const COLS = ["ID","CCTV","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Security Services #001","Security Services #002","890","2.746","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Security Services #002","Security Services #003","8.291","7.920","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Security Services #003","Security Services #004","6.458","6.746","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Security Services #004","Security Services #005","6.679","8.424","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Security Services #005","Security Services #001","4.876","4.355","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":855},{"label":"Fev","value":1001},{"label":"Mar","value":787},{"label":"Abr","value":987},{"label":"Mai","value":962},{"label":"Jun","value":931},{"label":"Jul","value":1065},{"label":"Ago","value":1048},{"label":"Set","value":894},{"label":"Out","value":1049},{"label":"Nov","value":992},{"label":"Dez","value":698}];
const MX = 1065;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e293b'}}>AI</span></h1>
                </div>
