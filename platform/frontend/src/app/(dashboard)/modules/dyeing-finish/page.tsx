...
export default function DyeingFinishPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Dyeing Finish</h1><p className="text-sm text-muted-foreground">Dyeing Finish • iBOS Enterprise</p></div>
