...
const PAGE = "Report";
const KPIS = [{"l":"Total Nuclear Mgmt","v":"1.363","t":"+16.9%","d":"up"},{"l":"Report Ativos","v":"4.459","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"86.5%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"91","t":"-0.2%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nuclear Mgmt #001","Nuclear Mgmt #002","5.183","5.345","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Nuclear Mgmt #002","Nuclear Mgmt #003","208","8.448","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Nuclear Mgmt #003","Nuclear Mgmt #004","1.233","8.542","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Nuclear Mgmt #004","Nuclear Mgmt #005","1.846","4.784","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nuclear Mgmt #005","Nuclear Mgmt #001","912","5.460","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":665},{"label":"Mar","value":808},{"label":"Abr","value":764},{"label":"Mai","value":639},{"label":"Jun","value":684},{"label":"Jul","value":1003},{"label":"Ago","value":826},{"label":"Set","value":940},{"label":"Out","value":752},{"label":"Nov","value":969},{"label":"Dez","value":750}];
const MX = 1003;
