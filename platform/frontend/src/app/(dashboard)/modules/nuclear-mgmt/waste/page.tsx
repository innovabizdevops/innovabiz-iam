...
const PAGE = "Waste";
const KPIS = [{"l":"Total Nuclear Mgmt","v":"1.939","t":"+8.1%","d":"up"},{"l":"Waste Ativos","v":"2.032","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"82.6%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"70","t":"+6.7%","d":"up"}];
const COLS = ["ID","Waste","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nuclear Mgmt #001","Nuclear Mgmt #002","6.278","8.418","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Nuclear Mgmt #002","Nuclear Mgmt #003","606","8.789","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Nuclear Mgmt #003","Nuclear Mgmt #004","7.717","6.374","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Nuclear Mgmt #004","Nuclear Mgmt #005","8.550","2.072","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nuclear Mgmt #005","Nuclear Mgmt #001","5.716","6.779","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":584},{"label":"Fev","value":432},{"label":"Mar","value":763},{"label":"Abr","value":423},{"label":"Mai","value":644},{"label":"Jun","value":511},{"label":"Jul","value":464},{"label":"Ago","value":627},{"label":"Set","value":717},{"label":"Out","value":510},{"label":"Nov","value":480},{"label":"Dez","value":728}];
const MX = 763;
