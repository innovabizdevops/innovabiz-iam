...
const ACCENT = "#854d0e";
const MODULE = "Nuclear Management System";
const PAGE = "Safety";
const KPIS = [{"l":"Total Nuclear Mgmt","v":"4.067","t":"-4.5%","d":"down"},{"l":"Safety Ativos","v":"3.946","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"73.0%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"55","t":"+5.1%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nuclear Mgmt #001","Nuclear Mgmt #002","7.390","6.943","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Nuclear Mgmt #002","Nuclear Mgmt #003","1.933","353","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Nuclear Mgmt #003","Nuclear Mgmt #004","3.503","5.538","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Nuclear Mgmt #004","Nuclear Mgmt #005","8.481","7.828","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nuclear Mgmt #005","Nuclear Mgmt #001","8.046","4.144","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":306},{"label":"Fev","value":395},{"label":"Mar","value":557},{"label":"Abr","value":680},{"label":"Mai","value":636},{"label":"Jun","value":435},{"label":"Jul","value":320},{"label":"Ago","value":326},{"label":"Set","value":308},{"label":"Out","value":671},{"label":"Nov","value":319},{"label":"Dez","value":566}];
const MX = 680;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#854d0e'}}>RTM</span></h1>
                </div>
