...
/* ═══ Nuclear Management System — Dashboard ═══ */

const ACCENT = "#854d0e";

const KPIS = [
    { label: "Total Registos", value: "6067", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "108", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€216K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "-25%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1301816367", cells: ["NUC-3367", "Nuclear Management System Item 1", "20/4/2026", "€16 467"], status: "active" as const },
    { id: "1301819938", cells: ["NUC-6938", "Nuclear Management System Item 2", "7/11/2026", "€20 038"], status: "pending" as const },
    { id: "1301823509", cells: ["NUC-1509", "Nuclear Management System Item 3", "22/6/2026", "€23 609"], status: "completed" as const },
    { id: "1301827080", cells: ["NUC-5080", "Nuclear Management System Item 4", "9/1/2026", "€27 180"], status: "warning" as const },
    { id: "1301830651", cells: ["NUC-8651", "Nuclear Management System Item 5", "24/8/2026", "€30 751"], status: "active" as const },
];
...
export default function NuclearManagementSystemPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Nuclear Management System</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Nuclear Management System</p>
                    </div>
                </div>
