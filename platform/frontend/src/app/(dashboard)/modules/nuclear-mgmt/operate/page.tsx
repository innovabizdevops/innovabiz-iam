...
const PAGE = "Operate";
const KPIS = [{"l":"Total Nuclear Mgmt","v":"3.817","t":"-3.0%","d":"down"},{"l":"Operate Ativos","v":"1.335","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"78.2%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"57","t":"+8.8%","d":"up"}];
const COLS = ["ID","Operate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nuclear Mgmt #001","Nuclear Mgmt #002","1.815","4.621","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Nuclear Mgmt #002","Nuclear Mgmt #003","1.306","2.839","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Nuclear Mgmt #003","Nuclear Mgmt #004","5.354","5.597","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Nuclear Mgmt #004","Nuclear Mgmt #005","2.011","2.809","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nuclear Mgmt #005","Nuclear Mgmt #001","2.202","5.191","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":394},{"label":"Mar","value":556},{"label":"Abr","value":452},{"label":"Mai","value":527},{"label":"Jun","value":323},{"label":"Jul","value":416},{"label":"Ago","value":595},{"label":"Set","value":286},{"label":"Out","value":629},{"label":"Nov","value":461},{"label":"Dez","value":647}];
const MX = 647;
