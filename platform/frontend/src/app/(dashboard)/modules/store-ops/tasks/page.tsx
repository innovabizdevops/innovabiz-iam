...
const PAGE = "Task Mgmt";
const KPIS = [{"l":"Pedidos/Dia","v":"3228","t":"+14.8%","d":"up"},{"l":"GMV (€)","v":"€10616","t":"-1.9%","d":"down"},{"l":"Conversão (%)","v":"82.3%","t":"-1.8%","d":"down"},{"l":"AOV (€)","v":"€19455","t":"-3.7%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 10454.14","4.866","6.503","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 38492.33","1.467","8.970","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 50083.90","124","8.840","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 19521.99","7.591","2.641","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 20370.96","4.583","6.794","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1057},{"label":"Fev","value":1040},{"label":"Mar","value":836},{"label":"Abr","value":845},{"label":"Mai","value":1045},{"label":"Jun","value":829},{"label":"Jul","value":1068},{"label":"Ago","value":883},{"label":"Set","value":738},{"label":"Out","value":932},{"label":"Nov","value":813},{"label":"Dez","value":725}];
const MX = 1068;
