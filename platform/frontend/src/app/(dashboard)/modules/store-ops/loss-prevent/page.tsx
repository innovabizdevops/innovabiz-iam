...
const ACCENT = "#dc2626";
const MODULE = "Store Operations";
const PAGE = "Loss Prevention";
const KPIS = [{"l":"Pedidos/Dia","v":"1529","t":"+17.6%","d":"up"},{"l":"GMV (€)","v":"€14451","t":"+12.6%","d":"up"},{"l":"Conversão (%)","v":"87.3%","t":"+13.8%","d":"up"},{"l":"AOV (€)","v":"€44094","t":"+6.2%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 14395.32","2.337","8.225","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 36021.99","3.552","784","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 31763.57","8.682","2.516","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 14995.08","4.046","8.983","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 21165.90","1.501","161","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":447},{"label":"Mar","value":749},{"label":"Abr","value":592},{"label":"Mai","value":530},{"label":"Jun","value":650},{"label":"Jul","value":385},{"label":"Ago","value":467},{"label":"Set","value":368},{"label":"Out","value":482},{"label":"Nov","value":603},{"label":"Dez","value":650}];
const MX = 749;
...
export default function LossPreventPage() {
    return (
