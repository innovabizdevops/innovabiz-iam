...
const PAGE = "Traffic Count";
const KPIS = [{"l":"Pedidos/Dia","v":"114","t":"+13.2%","d":"up"},{"l":"GMV (€)","v":"€59712","t":"+5.8%","d":"up"},{"l":"Conversão (%)","v":"68.3%","t":"+1.4%","d":"up"},{"l":"AOV (€)","v":"€92727","t":"-4.1%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 35444.78","2.034","5.843","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 14811.45","8.534","7.896","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 38758.86","5.737","6.614","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 27134.82","6.664","7.479","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 625.86","8.832","8.644","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":476},{"label":"Mar","value":655},{"label":"Abr","value":634},{"label":"Mai","value":584},{"label":"Jun","value":315},{"label":"Jul","value":508},{"label":"Ago","value":661},{"label":"Set","value":654},{"label":"Out","value":506},{"label":"Nov","value":456},{"label":"Dez","value":564}];
const MX = 661;
