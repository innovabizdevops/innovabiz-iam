...
const PAGE = "Gender Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"916","t":"-1.9%","d":"down"},{"l":"NC Abertas","v":"5.602","t":"+17.9%","d":"up"},{"l":"Conformidade (%)","v":"77.3%","t":"+2.8%","d":"up"},{"l":"CAPAs Pendentes","v":"8.900","t":"+4.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.319","76.2%","4.574","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.235","81.6%","8.505","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.046","82.7%","4.749","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","9.048","70.2%","4.898","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.810","74.8%","5.765","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":976},{"label":"Mar","value":617},{"label":"Abr","value":828},{"label":"Mai","value":808},{"label":"Jun","value":950},{"label":"Jul","value":774},{"label":"Ago","value":715},{"label":"Set","value":889},{"label":"Out","value":834},{"label":"Nov","value":798},{"label":"Dez","value":591}];
const MX = 976;
