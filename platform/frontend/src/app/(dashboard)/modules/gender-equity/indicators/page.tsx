...
const ACCENT = "#ec4899";
const MODULE = "Gender Equity";
const PAGE = "Indicator Track";
const KPIS = [{"l":"Total Gender Equity","v":"7.217","t":"-3.1%","d":"down"},{"l":"Indicator Track Ativos","v":"5.341","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"81.1%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"73","t":"-1.6%","d":"down"}];
const COLS = ["ID","Indicator Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gender Equity #001","Gender Equity #002","4.307","4.222","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Gender Equity #002","Gender Equity #003","4.537","3.637","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Gender Equity #003","Gender Equity #004","9.007","4.521","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Gender Equity #004","Gender Equity #005","8.329","1.863","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gender Equity #005","Gender Equity #001","7.524","2.254","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":712},{"label":"Fev","value":839},{"label":"Mar","value":737},{"label":"Abr","value":671},{"label":"Mai","value":789},{"label":"Jun","value":690},{"label":"Jul","value":623},{"label":"Ago","value":649},{"label":"Set","value":687},{"label":"Out","value":872},{"label":"Nov","value":864},{"label":"Dez","value":617}];
const MX = 872;
