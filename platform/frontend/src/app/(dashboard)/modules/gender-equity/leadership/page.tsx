...
const PAGE = "Leadership";
const KPIS = [{"l":"Total Gender Equity","v":"6.212","t":"+14.7%","d":"up"},{"l":"Leadership Ativos","v":"8.465","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"72.8%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"61","t":"+2.5%","d":"up"}];
const COLS = ["ID","Leadership","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gender Equity #001","Gender Equity #002","2.959","5.060","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Gender Equity #002","Gender Equity #003","3.338","7.958","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Gender Equity #003","Gender Equity #004","8.415","3.363","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Gender Equity #004","Gender Equity #005","5.912","917","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gender Equity #005","Gender Equity #001","8.836","4.043","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":923},{"label":"Fev","value":910},{"label":"Mar","value":749},{"label":"Abr","value":624},{"label":"Mai","value":818},{"label":"Jun","value":617},{"label":"Jul","value":745},{"label":"Ago","value":926},{"label":"Set","value":896},{"label":"Out","value":690},{"label":"Nov","value":670},{"label":"Dez","value":722}];
const MX = 926;
