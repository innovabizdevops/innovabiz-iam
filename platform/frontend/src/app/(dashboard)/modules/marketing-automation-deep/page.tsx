...
/* ═══ Marketing Automation Deep — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "1098", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2880", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€494K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "884605598", cells: ["MAR-5598", "Marketing Automation Deep Item 1", "3/3/2026", "€5698"], status: "active" as const },
    { id: "884609169", cells: ["MAR-9169", "Marketing Automation Deep Item 2", "18/10/2026", "€9269"], status: "pending" as const },
    { id: "884612740", cells: ["MAR-3740", "Marketing Automation Deep Item 3", "5/5/2026", "€12 840"], status: "completed" as const },
    { id: "884616311", cells: ["MAR-7311", "Marketing Automation Deep Item 4", "20/12/2026", "€16 411"], status: "warning" as const },
    { id: "884619882", cells: ["MAR-1882", "Marketing Automation Deep Item 5", "7/7/2026", "€19 982"], status: "active" as const },
];
...
export default function MarketingAutomationDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Marketing Automation Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Marketing Automation Deep</p>
                    </div>
                </div>
