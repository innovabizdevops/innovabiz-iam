...
const ACCENT = "#be185d";
const MODULE = "Marketing Automation Deep";
const PAGE = "Execute";
const KPIS = [{"l":"Total Marketing Automation Deep","v":"7.434","t":"-2.7%","d":"down"},{"l":"Execute Ativos","v":"736","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+1.5%","d":"up"},{"l":"Score Performance","v":"66","t":"+13.4%","d":"up"}];
const COLS = ["ID","Execute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marketing Automation Deep #001","Marketing Automation Deep #002","8.878","5.064","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Marketing Automation Deep #002","Marketing Automation Deep #003","6.458","2.203","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Marketing Automation Deep #003","Marketing Automation Deep #004","3.434","7.518","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Marketing Automation Deep #004","Marketing Automation Deep #005","2.975","8.083","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marketing Automation Deep #005","Marketing Automation Deep #001","7.651","1.349","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":506},{"label":"Mar","value":538},{"label":"Abr","value":780},{"label":"Mai","value":846},{"label":"Jun","value":651},{"label":"Jul","value":687},{"label":"Ago","value":840},{"label":"Set","value":802},{"label":"Out","value":715},{"label":"Nov","value":635},{"label":"Dez","value":843}];
const MX = 846;
