...
const PAGE = "War Room";
const KPIS = [{"l":"Tickets Abertos","v":"2.732","t":"-2.0%","d":"down"},{"l":"SLA Cumprido (%)","v":"77.1%","t":"+1.2%","d":"up"},{"l":"MTTR (h)","v":"199h","t":"-4.4%","d":"down"},{"l":"Satisfação (%)","v":"67.2%","t":"+0.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.286","5.466","6.955","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.703","4.031","5.032","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.199","5.972","7.331","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.892","7.890","7.431","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.625","6.438","636","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":645},{"label":"Mar","value":771},{"label":"Abr","value":375},{"label":"Mai","value":670},{"label":"Jun","value":572},{"label":"Jul","value":681},{"label":"Ago","value":588},{"label":"Set","value":419},{"label":"Out","value":738},{"label":"Nov","value":545},{"label":"Dez","value":418}];
const MX = 771;
