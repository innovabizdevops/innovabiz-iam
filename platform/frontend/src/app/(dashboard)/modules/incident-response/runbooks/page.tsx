...
const PAGE = "Runbooks";
const KPIS = [{"l":"Tickets Abertos","v":"1.948","t":"-4.7%","d":"down"},{"l":"SLA Cumprido (%)","v":"66.9%","t":"+11.7%","d":"up"},{"l":"MTTR (h)","v":"177h","t":"-5.0%","d":"down"},{"l":"Satisfação (%)","v":"80.8%","t":"+5.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.227","7.547","1.773","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.762","408","8.743","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.113","2.693","3.787","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.240","731","5.505","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.769","5.166","3.510","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":851},{"label":"Fev","value":894},{"label":"Mar","value":888},{"label":"Abr","value":740},{"label":"Mai","value":834},{"label":"Jun","value":785},{"label":"Jul","value":968},{"label":"Ago","value":784},{"label":"Set","value":678},{"label":"Out","value":694},{"label":"Nov","value":817},{"label":"Dez","value":766}];
const MX = 968;
