...
const KPIS = [{"l":"Tickets Abertos","v":"5.477","t":"+3.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"70.5%","t":"+12.2%","d":"up"},{"l":"MTTR (h)","v":"64h","t":"+3.4%","d":"up"},{"l":"Satisfação (%)","v":"79.9%","t":"+12.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.357","1.971","7.333","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.188","5.450","4.674","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.079","2.461","8.612","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.391","7.063","8.584","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.375","8.384","7.758","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":634},{"label":"Mar","value":653},{"label":"Abr","value":535},{"label":"Mai","value":612},{"label":"Jun","value":495},{"label":"Jul","value":448},{"label":"Ago","value":553},{"label":"Set","value":689},{"label":"Out","value":413},{"label":"Nov","value":742},{"label":"Dez","value":704}];
const MX = 742;
