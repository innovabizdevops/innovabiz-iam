...
const ACCENT = "#dc2626";
const MODULE = "Incident Response";
const PAGE = "MTTR Track";
const KPIS = [{"l":"Tickets Abertos","v":"6.293","t":"+12.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"74.4%","t":"+16.2%","d":"up"},{"l":"MTTR (h)","v":"162h","t":"+7.3%","d":"up"},{"l":"Satisfação (%)","v":"79.9%","t":"-4.3%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.787","7.826","4.511","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.279","4.019","5.383","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.826","1.772","6.661","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.764","7.400","3.576","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.979","2.711","7.770","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":509},{"label":"Mar","value":379},{"label":"Abr","value":642},{"label":"Mai","value":592},{"label":"Jun","value":370},{"label":"Jul","value":673},{"label":"Ago","value":407},{"label":"Set","value":550},{"label":"Out","value":547},{"label":"Nov","value":400},{"label":"Dez","value":364}];
const MX = 707;
