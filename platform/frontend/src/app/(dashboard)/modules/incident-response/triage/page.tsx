...
const PAGE = "Triage";
const KPIS = [{"l":"Tickets Abertos","v":"3.233","t":"-5.9%","d":"down"},{"l":"SLA Cumprido (%)","v":"74.7%","t":"+10.8%","d":"up"},{"l":"MTTR (h)","v":"141h","t":"-1.5%","d":"down"},{"l":"Satisfação (%)","v":"76.6%","t":"-5.1%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.630","7.658","1.955","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.442","3.694","2.669","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.406","1.557","565","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.652","7.505","6.757","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.126","6.431","1.497","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":981},{"label":"Fev","value":676},{"label":"Mar","value":923},{"label":"Abr","value":685},{"label":"Mai","value":948},{"label":"Jun","value":903},{"label":"Jul","value":912},{"label":"Ago","value":625},{"label":"Set","value":826},{"label":"Out","value":780},{"label":"Nov","value":618},{"label":"Dez","value":816}];
const MX = 981;
