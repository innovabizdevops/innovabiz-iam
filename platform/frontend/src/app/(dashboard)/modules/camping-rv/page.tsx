...
export default function CampingRvPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Camping Rv</h1><p className="text-sm text-muted-foreground">Camping Rv • iBOS Enterprise</p></div>
