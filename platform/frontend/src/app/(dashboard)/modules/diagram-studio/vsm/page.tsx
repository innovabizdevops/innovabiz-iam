...
const ACCENT = "#2563eb";
const MODULE = "Diagram & Flow Studio";
const PAGE = "Value Stream Map";
const KPIS = [{"l":"Diagramas Criados","v":"5.418","t":"+16.0%","d":"up"},{"l":"Templates","v":"8.929","t":"-2.0%","d":"down"},{"l":"Colaboradores","v":"4.659","t":"+1.1%","d":"up"},{"l":"Comentários/Semana","v":"3881","t":"+10.3%","d":"up"}];
const COLS = ["Diagrama","Tipo","Criador","Última Edição","Partilhado","Estado"];
const ROWS = [{"id":"r0","cells":["Processo Onboarding BPMN","Org Chart 2026","8.147","2026-02-10","3.038","Ativo"],"status":"active"},{"id":"r1","cells":["Org Chart 2026","Network Topology","4.623","2026-03-26","8.241","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Topology","Data Flow ETL","6.137","2026-03-02","2.859","Concluído"],"status":"done"},{"id":"r3","cells":["Data Flow ETL","User Journey Map","3.310","2026-03-01","7.704","Em Análise"],"status":"risk"},{"id":"r4","cells":["User Journey Map","Processo Onboarding BPMN","7.215","2026-03-13","1.947","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":515},{"label":"Mar","value":505},{"label":"Abr","value":646},{"label":"Mai","value":551},{"label":"Jun","value":689},{"label":"Jul","value":624},{"label":"Ago","value":464},{"label":"Set","value":311},{"label":"Out","value":357},{"label":"Nov","value":342},{"label":"Dez","value":709}];
const MX = 709;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#2563eb'}}>Lean</span></h1>
                </div>
