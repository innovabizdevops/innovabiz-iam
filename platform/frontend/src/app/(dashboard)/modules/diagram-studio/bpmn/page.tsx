...
const PAGE = "BPMN Designer";
const KPIS = [{"l":"Formulários Ativos","v":"7.784","t":"+11.2%","d":"up"},{"l":"Submissões/Dia","v":"4122","t":"+11.1%","d":"up"},{"l":"Documentos Gerados","v":"4.572","t":"+2.6%","d":"up"},{"l":"Templates","v":"8.296","t":"+10.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.182","2026-03-01","2.900","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.336","2026-03-22","1.597","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.728","2026-03-17","8.490","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.155","2026-02-03","1.713","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.020","2026-02-18","7.788","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":889},{"label":"Fev","value":695},{"label":"Mar","value":812},{"label":"Abr","value":668},{"label":"Mai","value":596},{"label":"Jun","value":691},{"label":"Jul","value":549},{"label":"Ago","value":573},{"label":"Set","value":932},{"label":"Out","value":646},{"label":"Nov","value":744},{"label":"Dez","value":743}];
const MX = 932;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#2563eb'}}>BPMN</span></h1>
                </div>
