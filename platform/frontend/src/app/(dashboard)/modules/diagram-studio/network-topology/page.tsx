...
const PAGE = "Network Topology";
const KPIS = [{"l":"Diagramas Criados","v":"1.747","t":"-1.2%","d":"down"},{"l":"Templates","v":"3.666","t":"-3.8%","d":"down"},{"l":"Colaboradores","v":"823","t":"+1.9%","d":"up"},{"l":"Comentários/Semana","v":"3699","t":"+16.3%","d":"up"}];
const COLS = ["Diagrama","Tipo","Criador","Última Edição","Partilhado","Estado"];
const ROWS = [{"id":"r0","cells":["Processo Onboarding BPMN","Org Chart 2026","8.866","2026-01-01","1.365","Ativo"],"status":"active"},{"id":"r1","cells":["Org Chart 2026","Network Topology","6.272","2026-02-12","1.144","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Topology","Data Flow ETL","2.245","2026-01-03","7.149","Concluído"],"status":"done"},{"id":"r3","cells":["Data Flow ETL","User Journey Map","8.147","2026-01-20","7.333","Em Análise"],"status":"risk"},{"id":"r4","cells":["User Journey Map","Processo Onboarding BPMN","8.364","2026-01-28","1.657","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":355},{"label":"Mar","value":478},{"label":"Abr","value":568},{"label":"Mai","value":226},{"label":"Jun","value":330},{"label":"Jul","value":361},{"label":"Ago","value":278},{"label":"Set","value":452},{"label":"Out","value":295},{"label":"Nov","value":473},{"label":"Dez","value":505}];
const MX = 613;
