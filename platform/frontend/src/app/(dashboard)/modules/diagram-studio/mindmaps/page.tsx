...
const PAGE = "Mind Maps AI";
const KPIS = [{"l":"Diagramas Criados","v":"5.983","t":"-1.0%","d":"down"},{"l":"Templates","v":"4.483","t":"-5.6%","d":"down"},{"l":"Colaboradores","v":"3.405","t":"+1.8%","d":"up"},{"l":"Comentários/Semana","v":"4815","t":"+3.6%","d":"up"}];
const COLS = ["Diagrama","Tipo","Criador","Última Edição","Partilhado","Estado"];
const ROWS = [{"id":"r0","cells":["Processo Onboarding BPMN","Org Chart 2026","5.423","2026-02-09","6.363","Ativo"],"status":"active"},{"id":"r1","cells":["Org Chart 2026","Network Topology","5.137","2026-03-12","961","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Topology","Data Flow ETL","8.240","2026-01-08","2.211","Concluído"],"status":"done"},{"id":"r3","cells":["Data Flow ETL","User Journey Map","4.384","2026-02-13","3.158","Em Análise"],"status":"risk"},{"id":"r4","cells":["User Journey Map","Processo Onboarding BPMN","4.749","2026-01-28","9.048","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":812},{"label":"Fev","value":1056},{"label":"Mar","value":737},{"label":"Abr","value":928},{"label":"Mai","value":731},{"label":"Jun","value":859},{"label":"Jul","value":1043},{"label":"Ago","value":727},{"label":"Set","value":993},{"label":"Out","value":1085},{"label":"Nov","value":1085},{"label":"Dez","value":782}];
const MX = 1085;
