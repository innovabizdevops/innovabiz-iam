...
const PAGE = "Architecture Diagrams";
const KPIS = [{"l":"Diagramas Criados","v":"240","t":"-1.6%","d":"down"},{"l":"Templates","v":"4.469","t":"-0.4%","d":"down"},{"l":"Colaboradores","v":"3.553","t":"+4.8%","d":"up"},{"l":"Comentários/Semana","v":"4608","t":"+5.4%","d":"up"}];
const COLS = ["Diagrama","Tipo","Criador","Última Edição","Partilhado","Estado"];
const ROWS = [{"id":"r0","cells":["Processo Onboarding BPMN","Org Chart 2026","4.948","2026-01-23","5.982","Ativo"],"status":"active"},{"id":"r1","cells":["Org Chart 2026","Network Topology","4.213","2026-02-22","8.689","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Topology","Data Flow ETL","5.843","2026-01-14","909","Concluído"],"status":"done"},{"id":"r3","cells":["Data Flow ETL","User Journey Map","4.311","2026-03-11","6.897","Em Análise"],"status":"risk"},{"id":"r4","cells":["User Journey Map","Processo Onboarding BPMN","262","2026-01-23","2.763","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":765},{"label":"Mar","value":732},{"label":"Abr","value":662},{"label":"Mai","value":681},{"label":"Jun","value":542},{"label":"Jul","value":624},{"label":"Ago","value":775},{"label":"Set","value":511},{"label":"Out","value":604},{"label":"Nov","value":668},{"label":"Dez","value":778}];
const MX = 778;
