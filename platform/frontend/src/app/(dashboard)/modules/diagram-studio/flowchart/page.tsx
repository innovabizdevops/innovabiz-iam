...
const PAGE = "Flowchart Editor";
const KPIS = [{"l":"Integrações Ativas","v":"3.572","t":"+15.7%","d":"up"},{"l":"Chamadas/Hora","v":"3378","t":"-2.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"68.7%","t":"+18.0%","d":"up"},{"l":"Latência Média (ms)","v":"106ms","t":"+6.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.246","894","78.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.885","1.275","77.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.364","2.245","71.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.143","1.628","90.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.331","302","82.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":508},{"label":"Mar","value":760},{"label":"Abr","value":772},{"label":"Mai","value":552},{"label":"Jun","value":661},{"label":"Jul","value":698},{"label":"Ago","value":691},{"label":"Set","value":588},{"label":"Out","value":446},{"label":"Nov","value":566},{"label":"Dez","value":566}];
const MX = 772;
