...
const PAGE = "ER Diagrams";
const KPIS = [{"l":"Ideias Submetidas","v":"8.158","t":"+2.3%","d":"up"},{"l":"Patentes (YTD)","v":"8.408","t":"-0.4%","d":"down"},{"l":"Projetos Innovation Lab","v":"5.838","t":"+6.9%","d":"up"},{"l":"Budget I&D (€M)","v":"€47.7M","t":"-0.8%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","8.165","95.2%","357","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","4.350","83.3%","1.712","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","3.010","80.0%","561","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","8.295","71.0%","8.760","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","211","82.8%","3.991","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":572},{"label":"Mar","value":362},{"label":"Abr","value":404},{"label":"Mai","value":523},{"label":"Jun","value":434},{"label":"Jul","value":647},{"label":"Ago","value":542},{"label":"Set","value":289},{"label":"Out","value":365},{"label":"Nov","value":572},{"label":"Dez","value":267}];
const MX = 647;
