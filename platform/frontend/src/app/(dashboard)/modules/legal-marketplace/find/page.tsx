...
const ACCENT = "#6366f1";
const MODULE = "Legal Marketplace";
const PAGE = "Find Lawyer";
const KPIS = [{"l":"Pedidos/Dia","v":"1142","t":"+2.1%","d":"up"},{"l":"GMV (€)","v":"€80040","t":"+3.5%","d":"up"},{"l":"Conversão (%)","v":"90.4%","t":"+9.2%","d":"up"},{"l":"AOV (€)","v":"€9347","t":"-4.1%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 12954.40","122","3.597","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 44749.44","3.500","687","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 9584.67","4.875","1.636","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 41319.55","4.607","488","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 39077.18","4.051","5.482","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":290},{"label":"Fev","value":346},{"label":"Mar","value":287},{"label":"Abr","value":380},{"label":"Mai","value":295},{"label":"Jun","value":354},{"label":"Jul","value":607},{"label":"Ago","value":482},{"label":"Set","value":475},{"label":"Out","value":411},{"label":"Nov","value":366},{"label":"Dez","value":349}];
const MX = 607;
