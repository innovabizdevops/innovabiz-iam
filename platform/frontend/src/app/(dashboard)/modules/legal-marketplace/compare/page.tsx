...
const PAGE = "Compare";
const KPIS = [{"l":"Pedidos/Dia","v":"2265","t":"+9.8%","d":"up"},{"l":"GMV (€)","v":"€25471","t":"+1.9%","d":"up"},{"l":"Conversão (%)","v":"85.2%","t":"+0.7%","d":"up"},{"l":"AOV (€)","v":"€45220","t":"+5.6%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 21663.03","4.264","7.077","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 38244.71","7.868","8.976","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 20450.90","6.221","3.314","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 46470.14","113","2.891","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 46911.16","5.340","7.187","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":1033},{"label":"Mar","value":799},{"label":"Abr","value":766},{"label":"Mai","value":942},{"label":"Jun","value":931},{"label":"Jul","value":855},{"label":"Ago","value":841},{"label":"Set","value":726},{"label":"Out","value":950},{"label":"Nov","value":944},{"label":"Dez","value":697}];
const MX = 1033;
