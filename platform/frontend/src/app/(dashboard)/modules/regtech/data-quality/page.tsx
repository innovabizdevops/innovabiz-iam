...
const KPIS = [{"l":"Auditorias Realizadas","v":"4.597","t":"+10.9%","d":"up"},{"l":"NC Abertas","v":"1.723","t":"-5.2%","d":"down"},{"l":"Conformidade (%)","v":"77.7%","t":"+17.0%","d":"up"},{"l":"CAPAs Pendentes","v":"800","t":"-5.4%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.575","95.1%","5.186","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","381","72.2%","1.815","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.690","83.5%","1.664","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.013","95.8%","1.204","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.845","73.6%","7.153","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":479},{"label":"Mar","value":343},{"label":"Abr","value":396},{"label":"Mai","value":567},{"label":"Jun","value":658},{"label":"Jul","value":611},{"label":"Ago","value":365},{"label":"Set","value":345},{"label":"Out","value":447},{"label":"Nov","value":340},{"label":"Dez","value":572}];
const MX = 658;
