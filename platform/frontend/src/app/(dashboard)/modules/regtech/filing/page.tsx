...
const PAGE = "Report Filing";
const KPIS = [{"l":"Total Regtech","v":"6.012","t":"+17.9%","d":"up"},{"l":"Report Filing Ativos","v":"1.375","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"91.3%","t":"+1.5%","d":"up"},{"l":"Score Performance","v":"61","t":"+16.3%","d":"up"}];
const COLS = ["ID","Report Filing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Regtech #001","Regtech #002","6.372","5.787","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Regtech #002","Regtech #003","3.437","5.579","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Regtech #003","Regtech #004","6.338","8.120","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Regtech #004","Regtech #005","7.568","4.130","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Regtech #005","Regtech #001","9.076","3.498","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":420},{"label":"Fev","value":656},{"label":"Mar","value":475},{"label":"Abr","value":768},{"label":"Mai","value":586},{"label":"Jun","value":642},{"label":"Jul","value":706},{"label":"Ago","value":571},{"label":"Set","value":504},{"label":"Out","value":633},{"label":"Nov","value":733},{"label":"Dez","value":460}];
const MX = 768;
