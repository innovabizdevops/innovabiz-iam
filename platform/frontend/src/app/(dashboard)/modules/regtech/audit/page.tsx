...
const KPIS = [{"l":"Auditorias Realizadas","v":"4.180","t":"+13.0%","d":"up"},{"l":"NC Abertas","v":"4.035","t":"-5.6%","d":"down"},{"l":"Conformidade (%)","v":"75.8%","t":"+14.2%","d":"up"},{"l":"CAPAs Pendentes","v":"3.691","t":"+11.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.609","93.3%","2.622","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.767","78.1%","4.251","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.896","87.8%","7.856","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.588","80.3%","1.466","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.810","84.9%","2.425","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":654},{"label":"Mar","value":845},{"label":"Abr","value":697},{"label":"Mai","value":779},{"label":"Jun","value":661},{"label":"Jul","value":853},{"label":"Ago","value":702},{"label":"Set","value":600},{"label":"Out","value":836},{"label":"Nov","value":822},{"label":"Dez","value":812}];
const MX = 853;
