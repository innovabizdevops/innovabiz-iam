...
const KPIS = [{"l":"Dashboards Ativos","v":"4.697","t":"+3.6%","d":"up"},{"l":"Queries/Dia","v":"2445","t":"+8.6%","d":"up"},{"l":"Dados Processados (GB)","v":"6.776","t":"-5.3%","d":"down"},{"l":"Utilizadores Analytics","v":"886","t":"+7.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3238","2026-02-26","8.960","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4081","2026-01-26","7.439","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3354","2026-02-19","592","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2972","2026-02-23","3.503","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2364","2026-02-04","7.854","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":422},{"label":"Fev","value":450},{"label":"Mar","value":752},{"label":"Abr","value":575},{"label":"Mai","value":638},{"label":"Jun","value":661},{"label":"Jul","value":544},{"label":"Ago","value":455},{"label":"Set","value":491},{"label":"Out","value":796},{"label":"Nov","value":685},{"label":"Dez","value":416}];
const MX = 796;
