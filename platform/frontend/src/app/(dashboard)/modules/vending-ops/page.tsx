...
export default function VendingOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div><h1 className="text-2xl font-bold">Vending Ops</h1><p className="text-sm text-muted-foreground">Vending Ops • iBOS</p></div>
