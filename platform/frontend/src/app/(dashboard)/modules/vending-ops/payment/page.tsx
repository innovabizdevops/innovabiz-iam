...
const PAGE = "Payment";
const KPIS = [{"l":"Total Vending Ops","v":"2.287","t":"+17.6%","d":"up"},{"l":"Payment Ativos","v":"3.478","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"70.7%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"76","t":"-2.4%","d":"down"}];
const COLS = ["ID","Payment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vending Ops #001","Vending Ops #002","4.875","7.838","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Vending Ops #002","Vending Ops #003","669","8.698","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Vending Ops #003","Vending Ops #004","1.309","3.243","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Vending Ops #004","Vending Ops #005","8.151","7.525","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vending Ops #005","Vending Ops #001","4.986","7.734","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1008},{"label":"Fev","value":747},{"label":"Mar","value":726},{"label":"Abr","value":901},{"label":"Mai","value":848},{"label":"Jun","value":715},{"label":"Jul","value":655},{"label":"Ago","value":715},{"label":"Set","value":762},{"label":"Out","value":878},{"label":"Nov","value":704},{"label":"Dez","value":840}];
const MX = 1008;
