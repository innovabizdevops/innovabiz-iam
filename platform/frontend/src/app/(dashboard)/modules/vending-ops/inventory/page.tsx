...
const ACCENT = "#84cc16";
const MODULE = "Vending Operations";
const PAGE = "Inventory";
const KPIS = [{"l":"Total Vending Ops","v":"4.108","t":"+15.4%","d":"up"},{"l":"Inventory Ativos","v":"971","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"78.4%","t":"+8.4%","d":"up"},{"l":"Score Performance","v":"60","t":"-5.8%","d":"down"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vending Ops #001","Vending Ops #002","5.087","6.367","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Vending Ops #002","Vending Ops #003","3.719","3.912","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Vending Ops #003","Vending Ops #004","6.579","1.778","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Vending Ops #004","Vending Ops #005","8.882","3.581","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vending Ops #005","Vending Ops #001","6.568","5.700","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":849},{"label":"Mar","value":854},{"label":"Abr","value":884},{"label":"Mai","value":1008},{"label":"Jun","value":617},{"label":"Jul","value":774},{"label":"Ago","value":662},{"label":"Set","value":904},{"label":"Out","value":953},{"label":"Nov","value":675},{"label":"Dez","value":750}];
const MX = 1008;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#84cc16'}}>AI</span></h1>
                </div>
