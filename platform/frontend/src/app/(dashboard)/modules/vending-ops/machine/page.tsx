...
const PAGE = "Machine";
const KPIS = [{"l":"Total Vending Ops","v":"6.942","t":"+2.1%","d":"up"},{"l":"Machine Ativos","v":"4.471","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"87.4%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"55","t":"+13.7%","d":"up"}];
const COLS = ["ID","Machine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vending Ops #001","Vending Ops #002","8.939","2.438","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Vending Ops #002","Vending Ops #003","1.672","7.263","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Vending Ops #003","Vending Ops #004","6.404","9.041","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Vending Ops #004","Vending Ops #005","8.412","6.366","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vending Ops #005","Vending Ops #001","1.997","5.333","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":759},{"label":"Fev","value":534},{"label":"Mar","value":538},{"label":"Abr","value":591},{"label":"Mai","value":760},{"label":"Jun","value":768},{"label":"Jul","value":510},{"label":"Ago","value":712},{"label":"Set","value":799},{"label":"Out","value":784},{"label":"Nov","value":639},{"label":"Dez","value":578}];
const MX = 799;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#84cc16'}}>IoT</span></h1>
                </div>
