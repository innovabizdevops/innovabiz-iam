...
const KPIS = [{"l":"Atletas Registados","v":"3.388","t":"-5.5%","d":"down"},{"l":"Treinos/Semana","v":"1230","t":"+16.7%","d":"up"},{"l":"Competições","v":"5.321","t":"-2.7%","d":"down"},{"l":"Performance Score","v":"83","t":"+14.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.192","2.431","5.653","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.346","2.549","4.952","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.582","3.374","3.566","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.269","2.007","3.185","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.154","5.284","2.476","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":515},{"label":"Fev","value":317},{"label":"Mar","value":328},{"label":"Abr","value":336},{"label":"Mai","value":385},{"label":"Jun","value":404},{"label":"Jul","value":336},{"label":"Ago","value":215},{"label":"Set","value":507},{"label":"Out","value":585},{"label":"Nov","value":585},{"label":"Dez","value":271}];
const MX = 585;
