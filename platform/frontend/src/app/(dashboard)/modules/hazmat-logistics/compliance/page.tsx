...
const KPIS = [{"l":"Auditorias Realizadas","v":"1.035","t":"-1.8%","d":"down"},{"l":"NC Abertas","v":"6.219","t":"+2.8%","d":"up"},{"l":"Conformidade (%)","v":"71.6%","t":"+5.4%","d":"up"},{"l":"CAPAs Pendentes","v":"5.605","t":"+4.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.227","80.3%","2.482","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.941","95.8%","8.806","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.202","82.2%","8.658","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.300","94.2%","1.789","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.169","94.5%","8.563","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":440},{"label":"Fev","value":433},{"label":"Mar","value":343},{"label":"Abr","value":470},{"label":"Mai","value":355},{"label":"Jun","value":372},{"label":"Jul","value":323},{"label":"Ago","value":668},{"label":"Set","value":468},{"label":"Out","value":589},{"label":"Nov","value":436},{"label":"Dez","value":405}];
const MX = 668;
