...
const PAGE = "Commerce Analytics";
const KPIS = [{"l":"Pedidos/Dia","v":"1914","t":"+15.8%","d":"up"},{"l":"GMV (€)","v":"€55546","t":"+16.9%","d":"up"},{"l":"Conversão (%)","v":"91.3%","t":"-1.0%","d":"down"},{"l":"AOV (€)","v":"€64228","t":"+11.6%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 32809.30","8.451","5.002","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 4658.23","4.517","746","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 16033.52","5.894","3.109","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 5432.01","6.932","1.100","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 3821.47","5.183","6.821","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":567},{"label":"Mar","value":573},{"label":"Abr","value":485},{"label":"Mai","value":547},{"label":"Jun","value":479},{"label":"Jul","value":624},{"label":"Ago","value":622},{"label":"Set","value":636},{"label":"Out","value":522},{"label":"Nov","value":519},{"label":"Dez","value":761}];
const MX = 761;
