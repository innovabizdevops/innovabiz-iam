...
const PAGE = "Cart &amp; Checkout";
const KPIS = [{"l":"Pedidos/Dia","v":"4209","t":"-5.8%","d":"down"},{"l":"GMV (€)","v":"€44402","t":"+0.2%","d":"up"},{"l":"Conversão (%)","v":"73.9%","t":"+6.4%","d":"up"},{"l":"AOV (€)","v":"€60768","t":"+7.4%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 36510.62","5.350","3.129","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 1959.43","8.773","6.936","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 48021.52","1.406","3.738","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 43848.58","2.003","5.470","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 18607.55","6.209","5.862","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":855},{"label":"Fev","value":861},{"label":"Mar","value":624},{"label":"Abr","value":774},{"label":"Mai","value":784},{"label":"Jun","value":688},{"label":"Jul","value":762},{"label":"Ago","value":575},{"label":"Set","value":727},{"label":"Out","value":822},{"label":"Nov","value":751},{"label":"Dez","value":602}];
const MX = 861;
