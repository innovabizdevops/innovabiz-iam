...
const PAGE = "Channel Incentives";
const KPIS = [{"l":"Pedidos/Dia","v":"5075","t":"+8.6%","d":"up"},{"l":"GMV (€)","v":"€72144","t":"+17.5%","d":"up"},{"l":"Conversão (%)","v":"76.4%","t":"+6.2%","d":"up"},{"l":"AOV (€)","v":"€65140","t":"+3.5%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 6637.66","8.545","2.965","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 12125.44","1.728","4.676","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 18204.24","7.833","3.069","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 40024.46","5.277","7.144","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 45624.17","4.200","7.134","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":368},{"label":"Fev","value":685},{"label":"Mar","value":547},{"label":"Abr","value":423},{"label":"Mai","value":372},{"label":"Jun","value":671},{"label":"Jul","value":691},{"label":"Ago","value":365},{"label":"Set","value":355},{"label":"Out","value":691},{"label":"Nov","value":632},{"label":"Dez","value":319}];
const MX = 691;
...
export default function ChannelIncentivesPage() {
    return (
