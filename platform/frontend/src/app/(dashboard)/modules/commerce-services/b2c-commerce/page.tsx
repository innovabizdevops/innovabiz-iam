...
const PAGE = "B2C Storefront";
const KPIS = [{"l":"Pedidos/Dia","v":"388","t":"+2.5%","d":"up"},{"l":"GMV (€)","v":"€36358","t":"+3.6%","d":"up"},{"l":"Conversão (%)","v":"76.8%","t":"+16.0%","d":"up"},{"l":"AOV (€)","v":"€25408","t":"+5.5%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 11138.16","4.644","3.128","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 10707.25","6.676","734","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 29991.58","6.164","1.345","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 14030.55","5.049","3.562","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 31309.82","1.146","6.291","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":803},{"label":"Mar","value":726},{"label":"Abr","value":631},{"label":"Mai","value":699},{"label":"Jun","value":925},{"label":"Jul","value":694},{"label":"Ago","value":884},{"label":"Set","value":811},{"label":"Out","value":664},{"label":"Nov","value":692},{"label":"Dez","value":649}];
const MX = 925;
...
export default function B2cCommercePage() {
    return (
