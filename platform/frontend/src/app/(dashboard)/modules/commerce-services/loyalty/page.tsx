...
const PAGE = "Loyalty &amp; Rewards";
const KPIS = [{"l":"Pedidos/Dia","v":"2409","t":"+5.7%","d":"up"},{"l":"GMV (€)","v":"€19297","t":"+0.8%","d":"up"},{"l":"Conversão (%)","v":"92.9%","t":"+2.5%","d":"up"},{"l":"AOV (€)","v":"€18620","t":"-0.5%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 4445.46","671","7.198","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 836.92","2.813","4.116","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 33604.23","8.404","2.310","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 45896.84","3.589","3.208","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 39595.59","5.918","1.254","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":498},{"label":"Mar","value":620},{"label":"Abr","value":544},{"label":"Mai","value":807},{"label":"Jun","value":814},{"label":"Jul","value":576},{"label":"Ago","value":745},{"label":"Set","value":721},{"label":"Out","value":777},{"label":"Nov","value":563},{"label":"Dez","value":519}];
const MX = 814;
