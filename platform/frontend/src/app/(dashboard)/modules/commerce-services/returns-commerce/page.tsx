...
const ACCENT = "#6366f1";
const MODULE = "Commerce Services";
const PAGE = "Returns &amp; Reverse Logistics";
const KPIS = [{"l":"Pedidos/Dia","v":"2039","t":"+13.2%","d":"up"},{"l":"GMV (€)","v":"€21483","t":"+7.6%","d":"up"},{"l":"Conversão (%)","v":"74.0%","t":"+6.0%","d":"up"},{"l":"AOV (€)","v":"€34198","t":"+4.5%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 39401.35","3.368","2.481","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 16149.58","1.907","4.150","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 18759.54","4.487","5.196","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 5321.32","3.451","3.411","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 16608.84","8.859","6.466","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":297},{"label":"Fev","value":510},{"label":"Mar","value":263},{"label":"Abr","value":639},{"label":"Mai","value":345},{"label":"Jun","value":323},{"label":"Jul","value":394},{"label":"Ago","value":268},{"label":"Set","value":593},{"label":"Out","value":396},{"label":"Nov","value":546},{"label":"Dez","value":477}];
const MX = 639;
...
export default function ReturnsCommercePage() {
    return (
