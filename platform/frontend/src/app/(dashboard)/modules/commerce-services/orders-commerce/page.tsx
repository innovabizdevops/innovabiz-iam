...
const PAGE = "Orders";
const KPIS = [{"l":"Pedidos/Dia","v":"2833","t":"+6.4%","d":"up"},{"l":"GMV (€)","v":"€16621","t":"+7.1%","d":"up"},{"l":"Conversão (%)","v":"68.0%","t":"-4.5%","d":"down"},{"l":"AOV (€)","v":"€50539","t":"+11.9%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 11968.23","2.618","4.776","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 2144.16","2.656","761","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 37331.39","4.461","4.321","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 43243.74","825","6.095","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 13859.52","1.926","2.958","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":408},{"label":"Mar","value":391},{"label":"Abr","value":499},{"label":"Mai","value":506},{"label":"Jun","value":679},{"label":"Jul","value":601},{"label":"Ago","value":648},{"label":"Set","value":381},{"label":"Out","value":422},{"label":"Nov","value":472},{"label":"Dez","value":572}];
const MX = 679;
...
export default function OrdersCommercePage() {
    return (
