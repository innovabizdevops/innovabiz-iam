...
const PAGE = "Marketplace Platform";
const KPIS = [{"l":"Pedidos/Dia","v":"2469","t":"+17.1%","d":"up"},{"l":"GMV (€)","v":"€51851","t":"+11.9%","d":"up"},{"l":"Conversão (%)","v":"87.2%","t":"+8.8%","d":"up"},{"l":"AOV (€)","v":"€94451","t":"+15.0%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 1149.02","7.607","2.321","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 2705.74","2.304","2.535","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 3192.69","9.075","2.404","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 10368.22","6.487","7.854","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 16508.68","1.428","7.698","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":368},{"label":"Fev","value":449},{"label":"Mar","value":399},{"label":"Abr","value":587},{"label":"Mai","value":734},{"label":"Jun","value":599},{"label":"Jul","value":451},{"label":"Ago","value":594},{"label":"Set","value":726},{"label":"Out","value":734},{"label":"Nov","value":369},{"label":"Dez","value":387}];
const MX = 734;
...
export default function MarketplaceCommerceCommercePage() {
    return (
