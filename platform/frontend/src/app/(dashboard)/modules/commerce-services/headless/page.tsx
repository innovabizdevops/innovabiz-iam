...
const PAGE = "Headless Commerce";
const KPIS = [{"l":"Pedidos/Dia","v":"1952","t":"+11.2%","d":"up"},{"l":"GMV (€)","v":"€80181","t":"+14.1%","d":"up"},{"l":"Conversão (%)","v":"79.6%","t":"+10.5%","d":"up"},{"l":"AOV (€)","v":"€31269","t":"+5.4%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 1519.80","3.649","329","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 10957.32","3.056","4.839","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 46366.78","8.852","7.747","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 4248.67","5.479","5.390","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 31512.10","3.202","5.031","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":710},{"label":"Mar","value":654},{"label":"Abr","value":582},{"label":"Mai","value":569},{"label":"Jun","value":591},{"label":"Jul","value":760},{"label":"Ago","value":539},{"label":"Set","value":532},{"label":"Out","value":679},{"label":"Nov","value":697},{"label":"Dez","value":742}];
const MX = 760;
