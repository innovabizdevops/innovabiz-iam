...
const PAGE = "Pricing Engine";
const KPIS = [{"l":"Pedidos/Dia","v":"2788","t":"+5.4%","d":"up"},{"l":"GMV (€)","v":"€71373","t":"+6.6%","d":"up"},{"l":"Conversão (%)","v":"89.8%","t":"+1.2%","d":"up"},{"l":"AOV (€)","v":"€54311","t":"+8.2%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 29113.82","2.778","5.931","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 13830.12","2.022","5.635","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 13507.03","8.047","5.746","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 36226.11","6.120","8.454","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 24153.78","3.520","7.479","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":847},{"label":"Fev","value":566},{"label":"Mar","value":826},{"label":"Abr","value":534},{"label":"Mai","value":822},{"label":"Jun","value":747},{"label":"Jul","value":813},{"label":"Ago","value":800},{"label":"Set","value":829},{"label":"Out","value":586},{"label":"Nov","value":834},{"label":"Dez","value":841}];
const MX = 847;
