...
const ACCENT = "#6366f1";
const MODULE = "Bindery Operations";
const PAGE = "Perfect Bind";
const KPIS = [{"l":"Total Bindery Ops","v":"6.724","t":"+9.0%","d":"up"},{"l":"Perfect Bind Ativos","v":"5.516","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"70.0%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"75","t":"-2.0%","d":"down"}];
const COLS = ["ID","Perfect Bind","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bindery Ops #001","Bindery Ops #002","4.670","8.807","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Bindery Ops #002","Bindery Ops #003","8.510","8.951","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Bindery Ops #003","Bindery Ops #004","923","3.173","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Bindery Ops #004","Bindery Ops #005","2.498","4.442","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bindery Ops #005","Bindery Ops #001","8.588","4.359","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":461},{"label":"Mar","value":491},{"label":"Abr","value":688},{"label":"Mai","value":575},{"label":"Jun","value":369},{"label":"Jul","value":627},{"label":"Ago","value":512},{"label":"Set","value":674},{"label":"Out","value":538},{"label":"Nov","value":508},{"label":"Dez","value":642}];
const MX = 688;
