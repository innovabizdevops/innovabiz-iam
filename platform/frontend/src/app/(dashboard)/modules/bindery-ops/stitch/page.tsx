...
const PAGE = "Stitch";
const KPIS = [{"l":"Total Bindery Ops","v":"1.389","t":"+0.2%","d":"up"},{"l":"Stitch Ativos","v":"5.438","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"83.3%","t":"-5.2%","d":"down"},{"l":"Score Performance","v":"79","t":"+1.2%","d":"up"}];
const COLS = ["ID","Stitch","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bindery Ops #001","Bindery Ops #002","3.609","5.811","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Bindery Ops #002","Bindery Ops #003","1.825","5.814","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Bindery Ops #003","Bindery Ops #004","4.077","4.405","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Bindery Ops #004","Bindery Ops #005","6.971","9.050","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bindery Ops #005","Bindery Ops #001","6.918","1.292","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":522},{"label":"Mar","value":549},{"label":"Abr","value":435},{"label":"Mai","value":783},{"label":"Jun","value":660},{"label":"Jul","value":767},{"label":"Ago","value":731},{"label":"Set","value":705},{"label":"Out","value":759},{"label":"Nov","value":765},{"label":"Dez","value":779}];
const MX = 783;
