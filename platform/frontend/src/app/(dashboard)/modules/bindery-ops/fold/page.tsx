...
const PAGE = "Fold";
const KPIS = [{"l":"Total Bindery Ops","v":"3.877","t":"+9.2%","d":"up"},{"l":"Fold Ativos","v":"5.574","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"76.0%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"88","t":"+0.4%","d":"up"}];
const COLS = ["ID","Fold","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bindery Ops #001","Bindery Ops #002","3.716","1.630","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Bindery Ops #002","Bindery Ops #003","8.336","2.097","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Bindery Ops #003","Bindery Ops #004","1.903","3.780","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Bindery Ops #004","Bindery Ops #005","5.967","1.856","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bindery Ops #005","Bindery Ops #001","6.819","6.322","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":882},{"label":"Mar","value":620},{"label":"Abr","value":832},{"label":"Mai","value":652},{"label":"Jun","value":680},{"label":"Jul","value":737},{"label":"Ago","value":657},{"label":"Set","value":662},{"label":"Out","value":652},{"label":"Nov","value":642},{"label":"Dez","value":719}];
const MX = 882;
