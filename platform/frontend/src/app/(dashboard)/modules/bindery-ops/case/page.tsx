...
const PAGE = "Case";
const KPIS = [{"l":"Total Bindery Ops","v":"1.007","t":"+12.7%","d":"up"},{"l":"Case Ativos","v":"2.000","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"85.0%","t":"+13.3%","d":"up"},{"l":"Score Performance","v":"68","t":"+10.2%","d":"up"}];
const COLS = ["ID","Case","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bindery Ops #001","Bindery Ops #002","331","5.034","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Bindery Ops #002","Bindery Ops #003","1.652","8.215","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Bindery Ops #003","Bindery Ops #004","1.107","7.976","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Bindery Ops #004","Bindery Ops #005","9.064","7.704","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bindery Ops #005","Bindery Ops #001","7.866","7.932","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":958},{"label":"Mar","value":598},{"label":"Abr","value":708},{"label":"Mai","value":716},{"label":"Jun","value":635},{"label":"Jul","value":677},{"label":"Ago","value":792},{"label":"Set","value":775},{"label":"Out","value":839},{"label":"Nov","value":860},{"label":"Dez","value":703}];
const MX = 958;
