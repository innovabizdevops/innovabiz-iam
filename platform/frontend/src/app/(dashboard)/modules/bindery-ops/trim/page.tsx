...
const PAGE = "Trim";
const KPIS = [{"l":"Total Bindery Ops","v":"5.447","t":"+0.8%","d":"up"},{"l":"Trim Ativos","v":"1.071","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"71.0%","t":"+2.0%","d":"up"},{"l":"Score Performance","v":"63","t":"+17.2%","d":"up"}];
const COLS = ["ID","Trim","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bindery Ops #001","Bindery Ops #002","4.326","1.663","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Bindery Ops #002","Bindery Ops #003","2.410","8.960","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Bindery Ops #003","Bindery Ops #004","4.701","7.166","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Bindery Ops #004","Bindery Ops #005","8.164","8.782","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bindery Ops #005","Bindery Ops #001","7.471","8.464","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":1016},{"label":"Mar","value":660},{"label":"Abr","value":668},{"label":"Mai","value":978},{"label":"Jun","value":956},{"label":"Jul","value":720},{"label":"Ago","value":866},{"label":"Set","value":1020},{"label":"Out","value":949},{"label":"Nov","value":1001},{"label":"Dez","value":709}];
const MX = 1020;
