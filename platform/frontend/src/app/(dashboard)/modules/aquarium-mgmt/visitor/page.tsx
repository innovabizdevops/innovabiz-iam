...
const PAGE = "Visitor";
const KPIS = [{"l":"Total Aquarium Mgmt","v":"6.092","t":"+8.3%","d":"up"},{"l":"Visitor Ativos","v":"7.918","t":"+10.2%","d":"up"},{"l":"Eficiência (%)","v":"68.3%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"90","t":"+16.5%","d":"up"}];
const COLS = ["ID","Visitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aquarium Mgmt #001","Aquarium Mgmt #002","7.935","5.356","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Aquarium Mgmt #002","Aquarium Mgmt #003","4.950","8.159","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Aquarium Mgmt #003","Aquarium Mgmt #004","5.588","4.023","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Aquarium Mgmt #004","Aquarium Mgmt #005","2.565","6.026","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aquarium Mgmt #005","Aquarium Mgmt #001","1.095","4.736","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":518},{"label":"Fev","value":660},{"label":"Mar","value":618},{"label":"Abr","value":665},{"label":"Mai","value":523},{"label":"Jun","value":598},{"label":"Jul","value":515},{"label":"Ago","value":556},{"label":"Set","value":525},{"label":"Out","value":528},{"label":"Nov","value":400},{"label":"Dez","value":459}];
const MX = 665;
