...
/* ═══ Aquarium Management — Dashboard ═══ */

const ACCENT = "#fdba74";

const KPIS = [
    { label: "Total Registos", value: "9178", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3967", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€123K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "-11%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "127758678", cells: ["AQU-4678", "Aquarium Management Item 1", "27/7/2026", "€8778"], status: "active" as const },
    { id: "127762249", cells: ["AQU-8249", "Aquarium Management Item 2", "14/2/2026", "€12 349"], status: "pending" as const },
    { id: "127765820", cells: ["AQU-2820", "Aquarium Management Item 3", "1/9/2026", "€15 920"], status: "completed" as const },
    { id: "127769391", cells: ["AQU-6391", "Aquarium Management Item 4", "16/4/2026", "€19 491"], status: "warning" as const },
    { id: "127772962", cells: ["AQU-9962", "Aquarium Management Item 5", "3/11/2026", "€23 062"], status: "active" as const },
];
...
export default function AquariumManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Aquarium Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Aquarium Management</p>
                    </div>
                </div>
