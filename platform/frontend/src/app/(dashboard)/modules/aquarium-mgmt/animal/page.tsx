...
const PAGE = "Animal";
const KPIS = [{"l":"Total Aquarium Mgmt","v":"3.359","t":"+12.4%","d":"up"},{"l":"Animal Ativos","v":"6.418","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"84.1%","t":"+9.3%","d":"up"},{"l":"Score Performance","v":"86","t":"+12.4%","d":"up"}];
const COLS = ["ID","Animal","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aquarium Mgmt #001","Aquarium Mgmt #002","7.238","3.144","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Aquarium Mgmt #002","Aquarium Mgmt #003","7.827","3.132","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Aquarium Mgmt #003","Aquarium Mgmt #004","2.207","5.122","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Aquarium Mgmt #004","Aquarium Mgmt #005","8.525","1.624","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aquarium Mgmt #005","Aquarium Mgmt #001","6.174","7.704","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":706},{"label":"Mar","value":605},{"label":"Abr","value":383},{"label":"Mai","value":383},{"label":"Jun","value":385},{"label":"Jul","value":650},{"label":"Ago","value":562},{"label":"Set","value":668},{"label":"Out","value":705},{"label":"Nov","value":709},{"label":"Dez","value":436}];
const MX = 709;
