...
const ACCENT = "#fdba74";
const MODULE = "Aquarium Management";
const PAGE = "Water Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.992","t":"-4.8%","d":"down"},{"l":"NC Abertas","v":"3.114","t":"+16.4%","d":"up"},{"l":"Conformidade (%)","v":"86.6%","t":"+2.7%","d":"up"},{"l":"CAPAs Pendentes","v":"3.495","t":"+2.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.644","85.6%","6.680","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.778","80.7%","5.501","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.300","81.5%","8.827","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","549","92.3%","2.713","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.413","72.2%","5.462","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":531},{"label":"Mar","value":511},{"label":"Abr","value":719},{"label":"Mai","value":585},{"label":"Jun","value":495},{"label":"Jul","value":522},{"label":"Ago","value":558},{"label":"Set","value":433},{"label":"Out","value":399},{"label":"Nov","value":669},{"label":"Dez","value":350}];
const MX = 719;
