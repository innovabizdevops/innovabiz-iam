...
const KPIS = [{"l":"Total Aquarium Mgmt","v":"5.661","t":"-3.4%","d":"down"},{"l":"Conservation Ativos","v":"7.573","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"73.9%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"61","t":"+5.2%","d":"up"}];
const COLS = ["ID","Conservation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aquarium Mgmt #001","Aquarium Mgmt #002","7.815","7.026","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Aquarium Mgmt #002","Aquarium Mgmt #003","4.974","8.192","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Aquarium Mgmt #003","Aquarium Mgmt #004","3.053","422","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Aquarium Mgmt #004","Aquarium Mgmt #005","5.934","5.954","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aquarium Mgmt #005","Aquarium Mgmt #001","786","8.965","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":885},{"label":"Fev","value":685},{"label":"Mar","value":825},{"label":"Abr","value":765},{"label":"Mai","value":608},{"label":"Jun","value":747},{"label":"Jul","value":849},{"label":"Ago","value":784},{"label":"Set","value":634},{"label":"Out","value":697},{"label":"Nov","value":595},{"label":"Dez","value":580}];
const MX = 885;
