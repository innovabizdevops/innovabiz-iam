...
const ACCENT = "#1e40af";
const MODULE = "DevSecOps Deep";
const PAGE = "DAST";
const KPIS = [{"l":"Total Devsecops Deep","v":"7.621","t":"+16.2%","d":"up"},{"l":"DAST Ativos","v":"6.969","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"66.8%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"58","t":"+8.4%","d":"up"}];
const COLS = ["ID","DAST","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Devsecops Deep #001","Devsecops Deep #002","764","6.076","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Devsecops Deep #002","Devsecops Deep #003","2.060","8.595","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Devsecops Deep #003","Devsecops Deep #004","2.399","2.525","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Devsecops Deep #004","Devsecops Deep #005","8.484","4.752","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Devsecops Deep #005","Devsecops Deep #001","2.151","4.861","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":856},{"label":"Mar","value":721},{"label":"Abr","value":835},{"label":"Mai","value":564},{"label":"Jun","value":804},{"label":"Jul","value":804},{"label":"Ago","value":712},{"label":"Set","value":857},{"label":"Out","value":814},{"label":"Nov","value":659},{"label":"Dez","value":594}];
const MX = 857;
