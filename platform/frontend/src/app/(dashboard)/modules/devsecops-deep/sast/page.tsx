...
const PAGE = "SAST";
const KPIS = [{"l":"Total Devsecops Deep","v":"5.897","t":"-2.6%","d":"down"},{"l":"SAST Ativos","v":"7.943","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"89.5%","t":"+17.8%","d":"up"},{"l":"Score Performance","v":"73","t":"+3.5%","d":"up"}];
const COLS = ["ID","SAST","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Devsecops Deep #001","Devsecops Deep #002","1.438","1.587","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Devsecops Deep #002","Devsecops Deep #003","6.051","6.339","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Devsecops Deep #003","Devsecops Deep #004","5.654","1.253","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Devsecops Deep #004","Devsecops Deep #005","336","6.044","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Devsecops Deep #005","Devsecops Deep #001","1.189","7.148","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":505},{"label":"Mar","value":401},{"label":"Abr","value":455},{"label":"Mai","value":645},{"label":"Jun","value":353},{"label":"Jul","value":356},{"label":"Ago","value":370},{"label":"Set","value":509},{"label":"Out","value":426},{"label":"Nov","value":656},{"label":"Dez","value":662}];
const MX = 662;
