...
/* ═══ DevSecOps Deep — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "6706", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "296", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€438K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1655821206", cells: ["DEV-2206", "DevSecOps Deep Item 1", "19/7/2026", "€21 306"], status: "active" as const },
    { id: "1655824777", cells: ["DEV-5777", "DevSecOps Deep Item 2", "6/2/2026", "€24 877"], status: "pending" as const },
    { id: "1655828348", cells: ["DEV-9348", "DevSecOps Deep Item 3", "21/9/2026", "€28 448"], status: "completed" as const },
    { id: "1655831919", cells: ["DEV-3919", "DevSecOps Deep Item 4", "8/4/2026", "€32 019"], status: "warning" as const },
    { id: "1655835490", cells: ["DEV-7490", "DevSecOps Deep Item 5", "23/11/2026", "€35 590"], status: "active" as const },
];
...
export default function DevsecopsDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">DevSecOps Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • DevSecOps Deep</p>
                    </div>
                </div>
