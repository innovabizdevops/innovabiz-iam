...
const PAGE = "SCA";
const KPIS = [{"l":"Total Devsecops Deep","v":"8.577","t":"+2.5%","d":"up"},{"l":"SCA Ativos","v":"2.043","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"89.2%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"91","t":"+17.3%","d":"up"}];
const COLS = ["ID","SCA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Devsecops Deep #001","Devsecops Deep #002","7.028","737","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Devsecops Deep #002","Devsecops Deep #003","5.903","5.550","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Devsecops Deep #003","Devsecops Deep #004","3.394","945","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Devsecops Deep #004","Devsecops Deep #005","3.856","5.480","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Devsecops Deep #005","Devsecops Deep #001","6.813","7.188","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":490},{"label":"Mar","value":716},{"label":"Abr","value":529},{"label":"Mai","value":687},{"label":"Jun","value":394},{"label":"Jul","value":709},{"label":"Ago","value":466},{"label":"Set","value":673},{"label":"Out","value":630},{"label":"Nov","value":574},{"label":"Dez","value":421}];
const MX = 716;
