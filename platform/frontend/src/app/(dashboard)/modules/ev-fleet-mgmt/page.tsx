...
const KPIS = [
    { label: "Total Registos", value: "1449", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2310", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€233K", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "117237149", cells: ["EV-4149", "EV Fleet Management Item 1", "2/6/2026", "€37 249"], status: "active" as const },
    { id: "117240720", cells: ["EV-7720", "EV Fleet Management Item 2", "17/1/2026", "€40 820"], status: "pending" as const },
    { id: "117244291", cells: ["EV-2291", "EV Fleet Management Item 3", "4/8/2026", "€44 391"], status: "completed" as const },
    { id: "117247862", cells: ["EV-5862", "EV Fleet Management Item 4", "19/3/2026", "€47 962"], status: "warning" as const },
    { id: "117251433", cells: ["EV-9433", "EV Fleet Management Item 5", "6/10/2026", "€1533"], status: "active" as const },
];
...
export default function EvFleetManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EV Fleet Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EV Fleet Management</p>
                    </div>
                </div>
