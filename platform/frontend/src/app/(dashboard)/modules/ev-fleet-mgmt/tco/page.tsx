...
const PAGE = "TCO";
const KPIS = [{"l":"Total Ev Fleet Mgmt","v":"8.542","t":"+6.5%","d":"up"},{"l":"TCO Ativos","v":"2.886","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"71.3%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"57","t":"+10.2%","d":"up"}];
const COLS = ["ID","TCO","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Fleet Mgmt #001","Ev Fleet Mgmt #002","286","4.686","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Fleet Mgmt #002","Ev Fleet Mgmt #003","1.805","3.662","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Fleet Mgmt #003","Ev Fleet Mgmt #004","2.144","6.292","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Fleet Mgmt #004","Ev Fleet Mgmt #005","976","3.807","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Fleet Mgmt #005","Ev Fleet Mgmt #001","8.824","3.782","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":757},{"label":"Mar","value":905},{"label":"Abr","value":818},{"label":"Mai","value":883},{"label":"Jun","value":640},{"label":"Jul","value":776},{"label":"Ago","value":639},{"label":"Set","value":714},{"label":"Out","value":749},{"label":"Nov","value":722},{"label":"Dez","value":620}];
const MX = 905;
