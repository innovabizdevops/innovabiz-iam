...
const PAGE = "Fleet";
const KPIS = [{"l":"Total Ev Fleet Mgmt","v":"6.379","t":"+11.2%","d":"up"},{"l":"Fleet Ativos","v":"1.095","t":"+6.4%","d":"up"},{"l":"Eficiência (%)","v":"70.4%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"89","t":"+6.0%","d":"up"}];
const COLS = ["ID","Fleet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Fleet Mgmt #001","Ev Fleet Mgmt #002","2.745","8.060","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Fleet Mgmt #002","Ev Fleet Mgmt #003","5.089","4.133","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Fleet Mgmt #003","Ev Fleet Mgmt #004","6.253","1.297","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Fleet Mgmt #004","Ev Fleet Mgmt #005","471","4.219","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Fleet Mgmt #005","Ev Fleet Mgmt #001","5.401","5.546","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":932},{"label":"Fev","value":749},{"label":"Mar","value":754},{"label":"Abr","value":1046},{"label":"Mai","value":759},{"label":"Jun","value":860},{"label":"Jul","value":910},{"label":"Ago","value":885},{"label":"Set","value":1083},{"label":"Out","value":812},{"label":"Nov","value":919},{"label":"Dez","value":904}];
const MX = 1083;
