...
const ACCENT = "#1e3a5f";
const MODULE = "EV Fleet Management";
const PAGE = "Charge";
const KPIS = [{"l":"Total Ev Fleet Mgmt","v":"8.618","t":"+16.3%","d":"up"},{"l":"Charge Ativos","v":"3.061","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"79.1%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"81","t":"+15.9%","d":"up"}];
const COLS = ["ID","Charge","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Fleet Mgmt #001","Ev Fleet Mgmt #002","3.616","6.859","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Fleet Mgmt #002","Ev Fleet Mgmt #003","1.344","1.416","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Fleet Mgmt #003","Ev Fleet Mgmt #004","5.584","4.157","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Fleet Mgmt #004","Ev Fleet Mgmt #005","4.740","9.098","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Fleet Mgmt #005","Ev Fleet Mgmt #001","2.875","7.239","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":842},{"label":"Mar","value":806},{"label":"Abr","value":620},{"label":"Mai","value":639},{"label":"Jun","value":696},{"label":"Jul","value":572},{"label":"Ago","value":783},{"label":"Set","value":692},{"label":"Out","value":731},{"label":"Nov","value":704},{"label":"Dez","value":800}];
const MX = 842;
