...
const PAGE = "Route";
const KPIS = [{"l":"Total Ev Fleet Mgmt","v":"3.975","t":"+16.8%","d":"up"},{"l":"Route Ativos","v":"4.679","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"79.6%","t":"+15.4%","d":"up"},{"l":"Score Performance","v":"82","t":"+1.2%","d":"up"}];
const COLS = ["ID","Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Fleet Mgmt #001","Ev Fleet Mgmt #002","7.928","1.622","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Fleet Mgmt #002","Ev Fleet Mgmt #003","5.850","1.849","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Fleet Mgmt #003","Ev Fleet Mgmt #004","6.387","6.254","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Fleet Mgmt #004","Ev Fleet Mgmt #005","2.499","2.176","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Fleet Mgmt #005","Ev Fleet Mgmt #001","7.145","8.334","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":312},{"label":"Fev","value":465},{"label":"Mar","value":269},{"label":"Abr","value":382},{"label":"Mai","value":603},{"label":"Jun","value":455},{"label":"Jul","value":358},{"label":"Ago","value":371},{"label":"Set","value":573},{"label":"Out","value":254},{"label":"Nov","value":482},{"label":"Dez","value":462}];
const MX = 603;
