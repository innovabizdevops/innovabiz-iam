...
const PAGE = "Range";
const KPIS = [{"l":"Total Ev Fleet Mgmt","v":"9.054","t":"+0.7%","d":"up"},{"l":"Range Ativos","v":"8.953","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"92.8%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"66","t":"-4.2%","d":"down"}];
const COLS = ["ID","Range","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Fleet Mgmt #001","Ev Fleet Mgmt #002","7.180","4.846","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Fleet Mgmt #002","Ev Fleet Mgmt #003","5.958","1.461","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Fleet Mgmt #003","Ev Fleet Mgmt #004","282","6.886","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Fleet Mgmt #004","Ev Fleet Mgmt #005","3.883","8.253","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Fleet Mgmt #005","Ev Fleet Mgmt #001","825","1.749","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":288},{"label":"Mar","value":427},{"label":"Abr","value":500},{"label":"Mai","value":629},{"label":"Jun","value":489},{"label":"Jul","value":603},{"label":"Ago","value":569},{"label":"Set","value":635},{"label":"Out","value":492},{"label":"Nov","value":318},{"label":"Dez","value":363}];
const MX = 635;
