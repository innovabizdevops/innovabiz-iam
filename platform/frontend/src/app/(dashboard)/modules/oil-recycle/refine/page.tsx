...
const PAGE = "Re-Refine";
const KPIS = [{"l":"Total Oil Recycle","v":"5.909","t":"+1.6%","d":"up"},{"l":"Re Refine Ativos","v":"5.683","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"74.8%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"65","t":"+4.9%","d":"up"}];
const COLS = ["ID","Re Refine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Recycle #001","Oil Recycle #002","7.424","4.448","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Recycle #002","Oil Recycle #003","783","2.951","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Recycle #003","Oil Recycle #004","5.804","7.892","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Recycle #004","Oil Recycle #005","6.419","346","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Recycle #005","Oil Recycle #001","6.905","3.035","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":604},{"label":"Mar","value":759},{"label":"Abr","value":722},{"label":"Mai","value":555},{"label":"Jun","value":812},{"label":"Jul","value":743},{"label":"Ago","value":556},{"label":"Set","value":612},{"label":"Out","value":825},{"label":"Nov","value":751},{"label":"Dez","value":654}];
const MX = 825;
