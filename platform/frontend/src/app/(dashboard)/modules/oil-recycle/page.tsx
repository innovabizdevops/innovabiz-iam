...
/* ═══ Used Oil Recycling — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "689", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3177", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€430K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1730748289", cells: ["OIL-4289", "Used Oil Recycling Item 1", "26/2/2026", "€48 389"], status: "active" as const },
    { id: "1730751860", cells: ["OIL-7860", "Used Oil Recycling Item 2", "13/9/2026", "€1960"], status: "pending" as const },
    { id: "1730755431", cells: ["OIL-2431", "Used Oil Recycling Item 3", "28/4/2026", "€5531"], status: "completed" as const },
    { id: "1730759002", cells: ["OIL-6002", "Used Oil Recycling Item 4", "15/11/2026", "€9102"], status: "warning" as const },
    { id: "1730762573", cells: ["OIL-9573", "Used Oil Recycling Item 5", "2/6/2026", "€12 673"], status: "active" as const },
];
...
export default function UsedOilRecyclingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Used Oil Recycling</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Used Oil Recycling</p>
                    </div>
                </div>
