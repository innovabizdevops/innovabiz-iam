...
export default function GhgAccountingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Ghg Accounting</h1><p className="text-sm text-muted-foreground">Ghg Accounting • iBOS Enterprise</p></div>
