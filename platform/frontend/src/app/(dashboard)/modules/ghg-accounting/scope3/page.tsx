...
const ACCENT = "#6366f1";
const MODULE = "GHG Accounting";
const PAGE = "Scope 3";
const KPIS = [{"l":"Total Ghg Accounting","v":"760","t":"-1.8%","d":"down"},{"l":"Scope 3 Ativos","v":"9.001","t":"+6.0%","d":"up"},{"l":"Eficiência (%)","v":"79.9%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"64","t":"-5.0%","d":"down"}];
const COLS = ["ID","Scope 3","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ghg Accounting #001","Ghg Accounting #002","6.385","8.686","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Ghg Accounting #002","Ghg Accounting #003","8.271","1.232","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Ghg Accounting #003","Ghg Accounting #004","3.198","8.391","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Ghg Accounting #004","Ghg Accounting #005","5.023","6.911","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ghg Accounting #005","Ghg Accounting #001","2.872","222","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":750},{"label":"Mar","value":488},{"label":"Abr","value":485},{"label":"Mai","value":674},{"label":"Jun","value":572},{"label":"Jul","value":805},{"label":"Ago","value":623},{"label":"Set","value":803},{"label":"Out","value":526},{"label":"Nov","value":667},{"label":"Dez","value":770}];
const MX = 805;
