...
const PAGE = "Report";
const KPIS = [{"l":"Total Ghg Accounting","v":"1.364","t":"+9.7%","d":"up"},{"l":"Report Ativos","v":"7.387","t":"-3.8%","d":"down"},{"l":"Eficiência (%)","v":"93.5%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"81","t":"-1.8%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ghg Accounting #001","Ghg Accounting #002","1.449","1.152","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Ghg Accounting #002","Ghg Accounting #003","1.074","4.699","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Ghg Accounting #003","Ghg Accounting #004","1.558","2.060","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Ghg Accounting #004","Ghg Accounting #005","1.754","4.898","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ghg Accounting #005","Ghg Accounting #001","5.730","5.832","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":473},{"label":"Mar","value":781},{"label":"Abr","value":743},{"label":"Mai","value":531},{"label":"Jun","value":705},{"label":"Jul","value":667},{"label":"Ago","value":458},{"label":"Set","value":476},{"label":"Out","value":577},{"label":"Nov","value":444},{"label":"Dez","value":673}];
const MX = 781;
