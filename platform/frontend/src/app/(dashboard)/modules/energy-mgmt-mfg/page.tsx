...
export default function EnergyMgmtMfgPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Energy Mgmt Mfg</h1><p className="text-sm text-muted-foreground">Energy Mgmt Mfg • iBOS Enterprise</p></div>
