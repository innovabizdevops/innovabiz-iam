...
const ACCENT = "#6366f1";
const MODULE = "Energy Management";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Energy Mgmt Mfg","v":"1.055","t":"-1.5%","d":"down"},{"l":"Monitor Ativos","v":"3.584","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"88.7%","t":"+4.3%","d":"up"},{"l":"Score Performance","v":"75","t":"-2.4%","d":"down"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Mgmt Mfg #001","Energy Mgmt Mfg #002","5.719","4.812","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Mgmt Mfg #002","Energy Mgmt Mfg #003","7.795","5.861","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Mgmt Mfg #003","Energy Mgmt Mfg #004","8.870","7.442","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Mgmt Mfg #004","Energy Mgmt Mfg #005","6.510","2.497","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Mgmt Mfg #005","Energy Mgmt Mfg #001","2.986","2.374","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":679},{"label":"Mar","value":927},{"label":"Abr","value":778},{"label":"Mai","value":660},{"label":"Jun","value":775},{"label":"Jul","value":896},{"label":"Ago","value":887},{"label":"Set","value":834},{"label":"Out","value":547},{"label":"Nov","value":789},{"label":"Dez","value":929}];
const MX = 929;
