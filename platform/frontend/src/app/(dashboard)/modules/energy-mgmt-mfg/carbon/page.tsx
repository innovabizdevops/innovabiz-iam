...
const PAGE = "Carbon";
const KPIS = [{"l":"Total Energy Mgmt Mfg","v":"2.814","t":"+5.2%","d":"up"},{"l":"Carbon Ativos","v":"2.644","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"+7.4%","d":"up"},{"l":"Score Performance","v":"89","t":"+15.4%","d":"up"}];
const COLS = ["ID","Carbon","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Mgmt Mfg #001","Energy Mgmt Mfg #002","929","4.357","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Mgmt Mfg #002","Energy Mgmt Mfg #003","7.947","8.544","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Mgmt Mfg #003","Energy Mgmt Mfg #004","1.713","4.846","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Mgmt Mfg #004","Energy Mgmt Mfg #005","3.277","3.497","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Mgmt Mfg #005","Energy Mgmt Mfg #001","1.956","7.435","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":940},{"label":"Fev","value":638},{"label":"Mar","value":768},{"label":"Abr","value":875},{"label":"Mai","value":882},{"label":"Jun","value":925},{"label":"Jul","value":613},{"label":"Ago","value":882},{"label":"Set","value":808},{"label":"Out","value":870},{"label":"Nov","value":629},{"label":"Dez","value":749}];
const MX = 940;
