...
const PAGE = "Report";
const KPIS = [{"l":"Total Energy Mgmt Mfg","v":"2.998","t":"+1.8%","d":"up"},{"l":"Report Ativos","v":"3.099","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"86.9%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"88","t":"+17.1%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Mgmt Mfg #001","Energy Mgmt Mfg #002","285","9.005","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Mgmt Mfg #002","Energy Mgmt Mfg #003","8.067","1.575","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Mgmt Mfg #003","Energy Mgmt Mfg #004","1.808","5.539","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Mgmt Mfg #004","Energy Mgmt Mfg #005","4.585","6.256","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Mgmt Mfg #005","Energy Mgmt Mfg #001","5.915","2.735","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":777},{"label":"Mar","value":790},{"label":"Abr","value":695},{"label":"Mai","value":687},{"label":"Jun","value":771},{"label":"Jul","value":883},{"label":"Ago","value":754},{"label":"Set","value":705},{"label":"Out","value":603},{"label":"Nov","value":878},{"label":"Dez","value":621}];
const MX = 883;
