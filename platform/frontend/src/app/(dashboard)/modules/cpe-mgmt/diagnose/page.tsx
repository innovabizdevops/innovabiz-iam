...
const PAGE = "Diagnose";
const KPIS = [{"l":"Total Cpe Mgmt","v":"8.334","t":"-0.4%","d":"down"},{"l":"Diagnose Ativos","v":"9.079","t":"+4.0%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"85","t":"+3.2%","d":"up"}];
const COLS = ["ID","Diagnose","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cpe Mgmt #001","Cpe Mgmt #002","8.813","4.677","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Cpe Mgmt #002","Cpe Mgmt #003","7.890","5.637","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Cpe Mgmt #003","Cpe Mgmt #004","3.470","1.825","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Cpe Mgmt #004","Cpe Mgmt #005","661","5.795","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cpe Mgmt #005","Cpe Mgmt #001","2.130","6.185","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":494},{"label":"Mar","value":421},{"label":"Abr","value":569},{"label":"Mai","value":366},{"label":"Jun","value":558},{"label":"Jul","value":376},{"label":"Ago","value":421},{"label":"Set","value":630},{"label":"Out","value":429},{"label":"Nov","value":444},{"label":"Dez","value":347}];
const MX = 630;
