...
const PAGE = "Firmware";
const KPIS = [{"l":"Dispositivos Online","v":"9.087","t":"-1.1%","d":"down"},{"l":"Dados/Min (MB)","v":"6.544","t":"+1.2%","d":"up"},{"l":"Alertas Ativos","v":"4.951","t":"+0.3%","d":"up"},{"l":"Uptime (%)","v":"72.9%","t":"+4.4%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","8.286","754","3.449","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","1.680","6.932","4.892","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.202","6.683","4.962","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.889","2.397","3.180","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.743","6.378","8.815","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":886},{"label":"Fev","value":784},{"label":"Mar","value":694},{"label":"Abr","value":940},{"label":"Mai","value":701},{"label":"Jun","value":575},{"label":"Jul","value":842},{"label":"Ago","value":931},{"label":"Set","value":871},{"label":"Out","value":954},{"label":"Nov","value":799},{"label":"Dez","value":891}];
const MX = 954;
