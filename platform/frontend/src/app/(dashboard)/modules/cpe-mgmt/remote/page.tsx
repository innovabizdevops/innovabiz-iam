...
const ACCENT = "#6366f1";
const MODULE = "CPE Management";
const PAGE = "Remote";
const KPIS = [{"l":"Total Cpe Mgmt","v":"8.155","t":"+9.6%","d":"up"},{"l":"Remote Ativos","v":"1.103","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"85.0%","t":"+15.2%","d":"up"},{"l":"Score Performance","v":"78","t":"+1.3%","d":"up"}];
const COLS = ["ID","Remote","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cpe Mgmt #001","Cpe Mgmt #002","1.633","6.304","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Cpe Mgmt #002","Cpe Mgmt #003","3.863","6.623","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Cpe Mgmt #003","Cpe Mgmt #004","2.199","1.225","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Cpe Mgmt #004","Cpe Mgmt #005","1.913","6.841","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cpe Mgmt #005","Cpe Mgmt #001","7.381","127","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":605},{"label":"Mar","value":939},{"label":"Abr","value":948},{"label":"Mai","value":653},{"label":"Jun","value":919},{"label":"Jul","value":930},{"label":"Ago","value":631},{"label":"Set","value":790},{"label":"Out","value":886},{"label":"Nov","value":841},{"label":"Dez","value":864}];
const MX = 948;
