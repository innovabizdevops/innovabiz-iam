...
const KPIS = [{"l":"Total Cpe Mgmt","v":"8.073","t":"+2.6%","d":"up"},{"l":"Lifecycle Ativos","v":"7.879","t":"+7.0%","d":"up"},{"l":"Eficiência (%)","v":"69.1%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"82","t":"-3.4%","d":"down"}];
const COLS = ["ID","Lifecycle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cpe Mgmt #001","Cpe Mgmt #002","7.856","6.866","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Cpe Mgmt #002","Cpe Mgmt #003","3.731","7.601","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Cpe Mgmt #003","Cpe Mgmt #004","8.312","3.221","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Cpe Mgmt #004","Cpe Mgmt #005","2.819","3.191","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cpe Mgmt #005","Cpe Mgmt #001","3.095","8.697","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":485},{"label":"Fev","value":493},{"label":"Mar","value":467},{"label":"Abr","value":369},{"label":"Mai","value":496},{"label":"Jun","value":525},{"label":"Jul","value":335},{"label":"Ago","value":384},{"label":"Set","value":504},{"label":"Out","value":379},{"label":"Nov","value":483},{"label":"Dez","value":397}];
const MX = 525;
