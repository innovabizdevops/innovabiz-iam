...
const KPIS = [{"l":"Total Museum Collection","v":"5.880","t":"+13.4%","d":"up"},{"l":"Condition Ativos","v":"6.362","t":"+9.8%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"80","t":"+6.2%","d":"up"}];
const COLS = ["ID","Condition","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Museum Collection #001","Museum Collection #002","1.740","6.469","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Museum Collection #002","Museum Collection #003","1.544","4.777","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Museum Collection #003","Museum Collection #004","5.911","4.494","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Museum Collection #004","Museum Collection #005","522","3.036","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Museum Collection #005","Museum Collection #001","3.302","8.923","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":347},{"label":"Fev","value":508},{"label":"Mar","value":286},{"label":"Abr","value":518},{"label":"Mai","value":540},{"label":"Jun","value":610},{"label":"Jul","value":479},{"label":"Ago","value":660},{"label":"Set","value":584},{"label":"Out","value":488},{"label":"Nov","value":609},{"label":"Dez","value":650}];
const MX = 660;
