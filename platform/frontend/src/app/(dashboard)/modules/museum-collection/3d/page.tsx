...
const ACCENT = "#7c3aed";
const MODULE = "Museum Collection";
const PAGE = "3D Digitize";
const KPIS = [{"l":"Total Museum Collection","v":"1.463","t":"+17.5%","d":"up"},{"l":"3D Digitize Ativos","v":"5.730","t":"+3.3%","d":"up"},{"l":"Eficiência (%)","v":"81.3%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"92","t":"+5.7%","d":"up"}];
const COLS = ["ID","3D Digitize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Museum Collection #001","Museum Collection #002","231","7.949","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Museum Collection #002","Museum Collection #003","7.127","8.268","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Museum Collection #003","Museum Collection #004","3.815","4.934","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Museum Collection #004","Museum Collection #005","4.517","4.148","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Museum Collection #005","Museum Collection #001","9.094","6.394","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":910},{"label":"Mar","value":801},{"label":"Abr","value":829},{"label":"Mai","value":804},{"label":"Jun","value":653},{"label":"Jul","value":847},{"label":"Ago","value":612},{"label":"Set","value":819},{"label":"Out","value":795},{"label":"Nov","value":594},{"label":"Dez","value":885}];
const MX = 910;
