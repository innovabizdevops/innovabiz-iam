...
/* ═══ XAI Regulatory Compliance — Dashboard ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total Registos", value: "3830", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3322", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€249K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1141077730", cells: ["XAI-4730", "XAI Regulatory Compliance Item 1", "3/11/2026", "€27 830"], status: "active" as const },
    { id: "1141081301", cells: ["XAI-8301", "XAI Regulatory Compliance Item 2", "18/6/2026", "€31 401"], status: "pending" as const },
    { id: "1141084872", cells: ["XAI-2872", "XAI Regulatory Compliance Item 3", "5/1/2026", "€34 972"], status: "completed" as const },
    { id: "1141088443", cells: ["XAI-6443", "XAI Regulatory Compliance Item 4", "20/8/2026", "€38 543"], status: "warning" as const },
    { id: "1141092014", cells: ["XAI-1014", "XAI Regulatory Compliance Item 5", "7/3/2026", "€42 114"], status: "active" as const },
];
...
export default function XaiRegulatoryCompliancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">XAI Regulatory Compliance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • XAI Regulatory Compliance</p>
                    </div>
                </div>
