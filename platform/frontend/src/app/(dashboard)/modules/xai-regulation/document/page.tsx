...
const PAGE = "Document";
const KPIS = [{"l":"Formulários Ativos","v":"2.074","t":"+8.7%","d":"up"},{"l":"Submissões/Dia","v":"446","t":"+6.7%","d":"up"},{"l":"Documentos Gerados","v":"6.604","t":"+2.0%","d":"up"},{"l":"Templates","v":"3.882","t":"+15.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.475","2026-03-19","5.739","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.932","2026-02-02","5.097","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.139","2026-01-04","5.657","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.554","2026-02-27","2.773","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.081","2026-02-13","7.832","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":384},{"label":"Mar","value":719},{"label":"Abr","value":477},{"label":"Mai","value":574},{"label":"Jun","value":456},{"label":"Jul","value":374},{"label":"Ago","value":582},{"label":"Set","value":361},{"label":"Out","value":368},{"label":"Nov","value":464},{"label":"Dez","value":414}];
const MX = 719;
