...
const PAGE = "Impact";
const KPIS = [{"l":"Projetos Sociais","v":"841","t":"-1.9%","d":"down"},{"l":"Beneficiários","v":"3.112","t":"-1.2%","d":"down"},{"l":"Investimento CSR (€)","v":"€33526","t":"+16.9%","d":"up"},{"l":"Score Impacto","v":"57","t":"+1.5%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","2.631","€ 33592.49","2.047","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","6.886","€ 15536.03","208","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","7.166","€ 39833.82","7.495","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","8.438","€ 33243.48","2.235","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","691","€ 37676.27","3.503","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":460},{"label":"Mar","value":435},{"label":"Abr","value":562},{"label":"Mai","value":546},{"label":"Jun","value":622},{"label":"Jul","value":363},{"label":"Ago","value":622},{"label":"Set","value":235},{"label":"Out","value":570},{"label":"Nov","value":554},{"label":"Dez","value":289}];
const MX = 622;
