...
const PAGE = "Fish Stock";
const KPIS = [{"l":"Total Ocean Mgmt","v":"6.297","t":"+13.6%","d":"up"},{"l":"Fish Stock Ativos","v":"1.429","t":"+2.7%","d":"up"},{"l":"Eficiência (%)","v":"66.0%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"56","t":"+16.0%","d":"up"}];
const COLS = ["ID","Fish Stock","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ocean Mgmt #001","Ocean Mgmt #002","2.261","1.940","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Ocean Mgmt #002","Ocean Mgmt #003","4.223","1.760","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Ocean Mgmt #003","Ocean Mgmt #004","1.218","6.822","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Ocean Mgmt #004","Ocean Mgmt #005","2.118","2.807","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ocean Mgmt #005","Ocean Mgmt #001","3.215","3.540","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":549},{"label":"Fev","value":491},{"label":"Mar","value":679},{"label":"Abr","value":648},{"label":"Mai","value":464},{"label":"Jun","value":607},{"label":"Jul","value":569},{"label":"Ago","value":653},{"label":"Set","value":622},{"label":"Out","value":744},{"label":"Nov","value":414},{"label":"Dez","value":477}];
const MX = 744;
