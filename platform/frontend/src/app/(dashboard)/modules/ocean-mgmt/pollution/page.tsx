...
const ACCENT = "#6366f1";
const MODULE = "Ocean Management";
const PAGE = "Pollution";
const KPIS = [{"l":"Surveys Ativos","v":"8.941","t":"+4.5%","d":"up"},{"l":"Respostas/Semana","v":"1102","t":"+3.2%","d":"up"},{"l":"NPS Médio","v":"80","t":"-3.4%","d":"down"},{"l":"Taxa Resposta (%)","v":"74.9%","t":"+6.9%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","1.676","77","96.5%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","2.568","55","80.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","4.819","65","75.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","1.571","80","95.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","968","76","80.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":692},{"label":"Mar","value":519},{"label":"Abr","value":477},{"label":"Mai","value":617},{"label":"Jun","value":767},{"label":"Jul","value":648},{"label":"Ago","value":769},{"label":"Set","value":818},{"label":"Out","value":619},{"label":"Nov","value":648},{"label":"Dez","value":752}];
const MX = 823;
