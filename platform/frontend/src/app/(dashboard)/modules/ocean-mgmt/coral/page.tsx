...
const PAGE = "Coral";
const KPIS = [{"l":"Total Ocean Mgmt","v":"6.661","t":"+11.2%","d":"up"},{"l":"Coral Ativos","v":"3.038","t":"+11.4%","d":"up"},{"l":"Eficiência (%)","v":"94.2%","t":"-5.9%","d":"down"},{"l":"Score Performance","v":"81","t":"+13.5%","d":"up"}];
const COLS = ["ID","Coral","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ocean Mgmt #001","Ocean Mgmt #002","8.716","8.199","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Ocean Mgmt #002","Ocean Mgmt #003","145","7.267","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Ocean Mgmt #003","Ocean Mgmt #004","3.866","2.267","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Ocean Mgmt #004","Ocean Mgmt #005","5.621","8.302","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ocean Mgmt #005","Ocean Mgmt #001","8.346","6.338","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":796},{"label":"Mar","value":687},{"label":"Abr","value":704},{"label":"Mai","value":642},{"label":"Jun","value":712},{"label":"Jul","value":948},{"label":"Ago","value":608},{"label":"Set","value":817},{"label":"Out","value":893},{"label":"Nov","value":721},{"label":"Dez","value":764}];
const MX = 948;
