...
const PAGE = "Marine Park";
const KPIS = [{"l":"Total Ocean Mgmt","v":"1.432","t":"+5.8%","d":"up"},{"l":"Marine Park Ativos","v":"5.109","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"69.9%","t":"+6.8%","d":"up"},{"l":"Score Performance","v":"61","t":"+11.9%","d":"up"}];
const COLS = ["ID","Marine Park","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ocean Mgmt #001","Ocean Mgmt #002","1.001","7.366","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Ocean Mgmt #002","Ocean Mgmt #003","3.720","4.632","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Ocean Mgmt #003","Ocean Mgmt #004","6.480","1.521","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Ocean Mgmt #004","Ocean Mgmt #005","602","5.971","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ocean Mgmt #005","Ocean Mgmt #001","7.320","703","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":454},{"label":"Fev","value":483},{"label":"Mar","value":756},{"label":"Abr","value":691},{"label":"Mai","value":544},{"label":"Jun","value":851},{"label":"Jul","value":762},{"label":"Ago","value":798},{"label":"Set","value":525},{"label":"Out","value":657},{"label":"Nov","value":641},{"label":"Dez","value":829}];
const MX = 851;
