...
const PAGE = "Blue Economy";
const KPIS = [{"l":"Total Ocean Mgmt","v":"1.099","t":"+16.5%","d":"up"},{"l":"Blue Economy Ativos","v":"3.522","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"84.3%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"61","t":"+12.0%","d":"up"}];
const COLS = ["ID","Blue Economy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ocean Mgmt #001","Ocean Mgmt #002","5.194","4.992","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Ocean Mgmt #002","Ocean Mgmt #003","7.682","4.820","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Ocean Mgmt #003","Ocean Mgmt #004","2.151","474","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Ocean Mgmt #004","Ocean Mgmt #005","1.422","7.021","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ocean Mgmt #005","Ocean Mgmt #001","3.738","8.460","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":848},{"label":"Fev","value":861},{"label":"Mar","value":1058},{"label":"Abr","value":949},{"label":"Mai","value":976},{"label":"Jun","value":1035},{"label":"Jul","value":824},{"label":"Ago","value":869},{"label":"Set","value":795},{"label":"Out","value":848},{"label":"Nov","value":908},{"label":"Dez","value":1003}];
const MX = 1058;
