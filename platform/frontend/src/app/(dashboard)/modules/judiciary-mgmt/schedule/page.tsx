...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Judiciary Mgmt","v":"6.427","t":"-3.7%","d":"down"},{"l":"Schedule Ativos","v":"5.775","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"+2.5%","d":"up"},{"l":"Score Performance","v":"61","t":"-3.9%","d":"down"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Judiciary Mgmt #001","Judiciary Mgmt #002","2.453","7.111","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Judiciary Mgmt #002","Judiciary Mgmt #003","8.445","2.535","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Judiciary Mgmt #003","Judiciary Mgmt #004","7.867","9.061","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Judiciary Mgmt #004","Judiciary Mgmt #005","7.143","2.812","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Judiciary Mgmt #005","Judiciary Mgmt #001","3.606","252","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":511},{"label":"Mar","value":656},{"label":"Abr","value":799},{"label":"Mai","value":854},{"label":"Jun","value":719},{"label":"Jul","value":541},{"label":"Ago","value":764},{"label":"Set","value":876},{"label":"Out","value":708},{"label":"Nov","value":706},{"label":"Dez","value":636}];
const MX = 876;
