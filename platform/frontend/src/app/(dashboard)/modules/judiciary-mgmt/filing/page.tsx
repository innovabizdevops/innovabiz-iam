...
const PAGE = "Filing";
const KPIS = [{"l":"Total Judiciary Mgmt","v":"8.934","t":"+7.5%","d":"up"},{"l":"Filing Ativos","v":"5.717","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"79.0%","t":"+-0.0%","d":"up"},{"l":"Score Performance","v":"71","t":"+8.1%","d":"up"}];
const COLS = ["ID","Filing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Judiciary Mgmt #001","Judiciary Mgmt #002","2.961","4.967","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Judiciary Mgmt #002","Judiciary Mgmt #003","8.672","5.840","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Judiciary Mgmt #003","Judiciary Mgmt #004","7.813","148","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Judiciary Mgmt #004","Judiciary Mgmt #005","4.274","4.493","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Judiciary Mgmt #005","Judiciary Mgmt #001","2.415","6.668","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":470},{"label":"Fev","value":639},{"label":"Mar","value":576},{"label":"Abr","value":509},{"label":"Mai","value":600},{"label":"Jun","value":311},{"label":"Jul","value":618},{"label":"Ago","value":575},{"label":"Set","value":562},{"label":"Out","value":286},{"label":"Nov","value":321},{"label":"Dez","value":417}];
const MX = 639;
