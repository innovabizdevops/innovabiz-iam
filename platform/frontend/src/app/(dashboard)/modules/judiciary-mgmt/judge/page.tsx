...
const ACCENT = "#3b82f6";
const MODULE = "Judiciary Management";
const PAGE = "Judge";
const KPIS = [{"l":"Total Judiciary Mgmt","v":"1.930","t":"+3.6%","d":"up"},{"l":"Judge Ativos","v":"5.719","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"81.7%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"84","t":"-0.4%","d":"down"}];
const COLS = ["ID","Judge","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Judiciary Mgmt #001","Judiciary Mgmt #002","3.084","4.331","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Judiciary Mgmt #002","Judiciary Mgmt #003","5.238","2.201","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Judiciary Mgmt #003","Judiciary Mgmt #004","766","7.640","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Judiciary Mgmt #004","Judiciary Mgmt #005","5.022","4.119","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Judiciary Mgmt #005","Judiciary Mgmt #001","7.836","4.317","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":653},{"label":"Mar","value":420},{"label":"Abr","value":458},{"label":"Mai","value":686},{"label":"Jun","value":393},{"label":"Jul","value":700},{"label":"Ago","value":396},{"label":"Set","value":449},{"label":"Out","value":534},{"label":"Nov","value":567},{"label":"Dez","value":724}];
const MX = 724;
