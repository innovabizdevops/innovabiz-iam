...
const PAGE = "Enforce";
const KPIS = [{"l":"Total Judiciary Mgmt","v":"6.060","t":"+1.9%","d":"up"},{"l":"Enforce Ativos","v":"4.475","t":"+0.3%","d":"up"},{"l":"Eficiência (%)","v":"73.4%","t":"+6.5%","d":"up"},{"l":"Score Performance","v":"84","t":"-2.0%","d":"down"}];
const COLS = ["ID","Enforce","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Judiciary Mgmt #001","Judiciary Mgmt #002","8.533","8.271","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Judiciary Mgmt #002","Judiciary Mgmt #003","2.029","4.943","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Judiciary Mgmt #003","Judiciary Mgmt #004","692","6.493","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Judiciary Mgmt #004","Judiciary Mgmt #005","543","8.220","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Judiciary Mgmt #005","Judiciary Mgmt #001","3.469","8.604","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":888},{"label":"Mar","value":803},{"label":"Abr","value":882},{"label":"Mai","value":905},{"label":"Jun","value":848},{"label":"Jul","value":954},{"label":"Ago","value":1025},{"label":"Set","value":771},{"label":"Out","value":702},{"label":"Nov","value":899},{"label":"Dez","value":922}];
const MX = 1025;
