...
const PAGE = "Case";
const KPIS = [{"l":"Total Judiciary Mgmt","v":"1.063","t":"+9.4%","d":"up"},{"l":"Case Ativos","v":"1.172","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"74.0%","t":"+4.5%","d":"up"},{"l":"Score Performance","v":"62","t":"+15.6%","d":"up"}];
const COLS = ["ID","Case","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Judiciary Mgmt #001","Judiciary Mgmt #002","2.057","8.194","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Judiciary Mgmt #002","Judiciary Mgmt #003","6.532","513","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Judiciary Mgmt #003","Judiciary Mgmt #004","1.661","4.149","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Judiciary Mgmt #004","Judiciary Mgmt #005","2.707","2.962","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Judiciary Mgmt #005","Judiciary Mgmt #001","8.758","5.673","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":696},{"label":"Mar","value":872},{"label":"Abr","value":1038},{"label":"Mai","value":688},{"label":"Jun","value":1021},{"label":"Jul","value":805},{"label":"Ago","value":694},{"label":"Set","value":903},{"label":"Out","value":1020},{"label":"Nov","value":894},{"label":"Dez","value":1035}];
const MX = 1038;
