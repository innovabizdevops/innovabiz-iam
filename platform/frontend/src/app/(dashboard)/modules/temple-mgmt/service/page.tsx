...
const ACCENT = "#5b21b6";
const MODULE = "Temple Management";
const PAGE = "Service";
const KPIS = [{"l":"Total Temple Mgmt","v":"1.124","t":"-0.3%","d":"down"},{"l":"Service Ativos","v":"7.735","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"72.2%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"70","t":"+17.1%","d":"up"}];
const COLS = ["ID","Service","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Temple Mgmt #001","Temple Mgmt #002","6.099","3.083","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Temple Mgmt #002","Temple Mgmt #003","4.573","1.357","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Temple Mgmt #003","Temple Mgmt #004","7.485","5.536","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Temple Mgmt #004","Temple Mgmt #005","2.822","2.286","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Temple Mgmt #005","Temple Mgmt #001","6.212","6.698","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":682},{"label":"Mar","value":520},{"label":"Abr","value":581},{"label":"Mai","value":642},{"label":"Jun","value":532},{"label":"Jul","value":510},{"label":"Ago","value":819},{"label":"Set","value":555},{"label":"Out","value":613},{"label":"Nov","value":610},{"label":"Dez","value":630}];
const MX = 819;
