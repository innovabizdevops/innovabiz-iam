...
const KPIS = [
    { label: "Total Registos", value: "7772", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3802", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€273K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2053109272", cells: ["TEM-3272", "Temple Management Item 1", "5/5/2026", "€9372"], status: "active" as const },
    { id: "2053112843", cells: ["TEM-6843", "Temple Management Item 2", "20/12/2026", "€12 943"], status: "pending" as const },
    { id: "2053116414", cells: ["TEM-1414", "Temple Management Item 3", "7/7/2026", "€16 514"], status: "completed" as const },
    { id: "2053119985", cells: ["TEM-4985", "Temple Management Item 4", "22/2/2026", "€20 085"], status: "warning" as const },
    { id: "2053123556", cells: ["TEM-8556", "Temple Management Item 5", "9/9/2026", "€23 656"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Temple Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Temple Management</p>
                    </div>
                </div>
