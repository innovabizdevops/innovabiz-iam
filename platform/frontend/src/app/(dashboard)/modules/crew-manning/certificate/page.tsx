...
const KPIS = [{"l":"Total Crew Manning","v":"4.348","t":"+0.6%","d":"up"},{"l":"Certificate Ativos","v":"3.294","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"86.5%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"75","t":"+9.4%","d":"up"}];
const COLS = ["ID","Certificate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crew Manning #001","Crew Manning #002","2.317","1.364","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Crew Manning #002","Crew Manning #003","8.088","1.260","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Crew Manning #003","Crew Manning #004","271","5.399","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Crew Manning #004","Crew Manning #005","2.194","6.136","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crew Manning #005","Crew Manning #001","1.790","3.158","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":815},{"label":"Mar","value":889},{"label":"Abr","value":790},{"label":"Mai","value":668},{"label":"Jun","value":935},{"label":"Jul","value":714},{"label":"Ago","value":600},{"label":"Set","value":660},{"label":"Out","value":764},{"label":"Nov","value":949},{"label":"Dez","value":988}];
const MX = 988;
