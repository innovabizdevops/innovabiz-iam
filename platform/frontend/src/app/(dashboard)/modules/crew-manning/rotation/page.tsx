...
const PAGE = "Rotation Plan";
const KPIS = [{"l":"Total Crew Manning","v":"5.380","t":"+13.5%","d":"up"},{"l":"Rotation Plan Ativos","v":"8.286","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"91.0%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"62","t":"+11.6%","d":"up"}];
const COLS = ["ID","Rotation Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crew Manning #001","Crew Manning #002","4.122","1.340","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Crew Manning #002","Crew Manning #003","8.186","2.168","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Crew Manning #003","Crew Manning #004","6.786","1.316","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Crew Manning #004","Crew Manning #005","5.295","8.284","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crew Manning #005","Crew Manning #001","4.673","6.990","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":780},{"label":"Fev","value":782},{"label":"Mar","value":830},{"label":"Abr","value":977},{"label":"Mai","value":788},{"label":"Jun","value":930},{"label":"Jul","value":915},{"label":"Ago","value":989},{"label":"Set","value":1002},{"label":"Out","value":1047},{"label":"Nov","value":1048},{"label":"Dez","value":1054}];
const MX = 1054;
