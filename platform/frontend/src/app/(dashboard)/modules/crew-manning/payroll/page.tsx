...
const ACCENT = "#4338ca";
const MODULE = "Crew Manning";
const PAGE = "Payroll Ship";
const KPIS = [{"l":"Total Crew Manning","v":"5.935","t":"+14.2%","d":"up"},{"l":"Payroll Ship Ativos","v":"3.227","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"85.6%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"57","t":"+4.0%","d":"up"}];
const COLS = ["ID","Payroll Ship","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crew Manning #001","Crew Manning #002","8.993","4.596","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Crew Manning #002","Crew Manning #003","1.095","3.639","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Crew Manning #003","Crew Manning #004","407","4.488","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Crew Manning #004","Crew Manning #005","5.127","5.639","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crew Manning #005","Crew Manning #001","4.139","4.463","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":256},{"label":"Fev","value":555},{"label":"Mar","value":382},{"label":"Abr","value":253},{"label":"Mai","value":518},{"label":"Jun","value":423},{"label":"Jul","value":231},{"label":"Ago","value":324},{"label":"Set","value":470},{"label":"Out","value":437},{"label":"Nov","value":430},{"label":"Dez","value":321}];
const MX = 555;
