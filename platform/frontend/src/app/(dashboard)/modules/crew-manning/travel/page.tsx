...
const PAGE = "Travel Arrange";
const KPIS = [{"l":"ARR (€M)","v":"€31.5M","t":"+0.1%","d":"up"},{"l":"MRR (€)","v":"€53659","t":"+15.7%","d":"up"},{"l":"Churn (%)","v":"82.3%","t":"+0.6%","d":"up"},{"l":"ARPU (€)","v":"€57209","t":"+14.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 22351.39","3.560","€ 13526.67","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 13851.37","2.036","€ 36952.43","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 20155.08","7.910","€ 40033.39","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 37290.29","1.654","€ 22262.66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 25254.97","4.536","€ 14846.51","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":703},{"label":"Mar","value":589},{"label":"Abr","value":648},{"label":"Mai","value":757},{"label":"Jun","value":809},{"label":"Jul","value":512},{"label":"Ago","value":677},{"label":"Set","value":635},{"label":"Out","value":697},{"label":"Nov","value":572},{"label":"Dez","value":643}];
const MX = 809;
