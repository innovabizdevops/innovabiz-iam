...
const PAGE = "Medical Exam";
const KPIS = [{"l":"Integrações Ativas","v":"7.059","t":"+5.7%","d":"up"},{"l":"Chamadas/Hora","v":"3524","t":"+1.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.6%","t":"-2.3%","d":"down"},{"l":"Latência Média (ms)","v":"63ms","t":"+3.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.733","7.713","85.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.466","750","81.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.069","7.925","86.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.872","5.337","93.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.794","5.506","80.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":294},{"label":"Fev","value":408},{"label":"Mar","value":251},{"label":"Abr","value":534},{"label":"Mai","value":283},{"label":"Jun","value":246},{"label":"Jul","value":241},{"label":"Ago","value":291},{"label":"Set","value":276},{"label":"Out","value":222},{"label":"Nov","value":331},{"label":"Dez","value":550}];
const MX = 550;
