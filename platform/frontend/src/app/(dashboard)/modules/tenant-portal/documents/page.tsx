...
const ACCENT = "#b45309";
const MODULE = "Tenant Portal";
const PAGE = "Documents";
const KPIS = [{"l":"Formulários Ativos","v":"5.445","t":"+12.9%","d":"up"},{"l":"Submissões/Dia","v":"1007","t":"-4.8%","d":"down"},{"l":"Documentos Gerados","v":"8.245","t":"+0.8%","d":"up"},{"l":"Templates","v":"1.981","t":"+17.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.809","2026-03-10","6.385","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.372","2026-02-06","6.299","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.890","2026-02-26","5.327","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","700","2026-03-22","366","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.912","2026-02-18","1.941","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":782},{"label":"Fev","value":860},{"label":"Mar","value":735},{"label":"Abr","value":767},{"label":"Mai","value":600},{"label":"Jun","value":710},{"label":"Jul","value":724},{"label":"Ago","value":559},{"label":"Set","value":813},{"label":"Out","value":785},{"label":"Nov","value":747},{"label":"Dez","value":614}];
const MX = 860;
