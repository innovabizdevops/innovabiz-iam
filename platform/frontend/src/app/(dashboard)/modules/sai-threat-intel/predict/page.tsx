...
const PAGE = "Predict";
const KPIS = [{"l":"Integrações Ativas","v":"7.511","t":"-3.6%","d":"down"},{"l":"Chamadas/Hora","v":"2870","t":"+17.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"75.3%","t":"-3.3%","d":"down"},{"l":"Latência Média (ms)","v":"32ms","t":"-5.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.191","4.734","77.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.905","4.122","96.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.553","5.392","97.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","890","4.710","92.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.307","3.869","82.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":461},{"label":"Mar","value":420},{"label":"Abr","value":400},{"label":"Mai","value":621},{"label":"Jun","value":412},{"label":"Jul","value":472},{"label":"Ago","value":597},{"label":"Set","value":561},{"label":"Out","value":505},{"label":"Nov","value":385},{"label":"Dez","value":411}];
const MX = 621;
