...
const KPIS = [{"l":"Produtos Ativos","v":"1.620","t":"+1.1%","d":"up"},{"l":"SKUs","v":"2.444","t":"-0.2%","d":"down"},{"l":"ECNs Pendentes","v":"4.566","t":"+15.2%","d":"up"},{"l":"Time-to-Market (dias)","v":"6.632","t":"-4.7%","d":"down"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","5.113","9.092","8.150","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","8.537","6.430","5.733","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","4.937","6.204","1.188","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","5.551","3.191","3.133","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","8.148","5.925","6.769","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":752},{"label":"Mar","value":880},{"label":"Abr","value":554},{"label":"Mai","value":700},{"label":"Jun","value":789},{"label":"Jul","value":638},{"label":"Ago","value":635},{"label":"Set","value":610},{"label":"Out","value":731},{"label":"Nov","value":773},{"label":"Dez","value":618}];
const MX = 880;
