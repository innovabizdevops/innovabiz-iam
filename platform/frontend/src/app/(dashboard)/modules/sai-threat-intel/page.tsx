...
/* ═══ S-AI Threat Intelligence — Dashboard ═══ */

const ACCENT = "#991b1b";

const KPIS = [
    { label: "Total Registos", value: "8712", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3153", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€291K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1565812412", cells: ["SAI-2412", "S-AI Threat Intelligence Item 1", "25/9/2026", "€12 512"], status: "active" as const },
    { id: "1565815983", cells: ["SAI-5983", "S-AI Threat Intelligence Item 2", "12/4/2026", "€16 083"], status: "pending" as const },
    { id: "1565819554", cells: ["SAI-9554", "S-AI Threat Intelligence Item 3", "27/11/2026", "€19 654"], status: "completed" as const },
    { id: "1565823125", cells: ["SAI-4125", "S-AI Threat Intelligence Item 4", "14/6/2026", "€23 225"], status: "warning" as const },
    { id: "1565826696", cells: ["SAI-7696", "S-AI Threat Intelligence Item 5", "1/1/2026", "€26 796"], status: "active" as const },
];
...
export default function SaiThreatIntelligencePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">S-AI Threat Intelligence</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • S-AI Threat Intelligence</p>
                    </div>
                </div>
