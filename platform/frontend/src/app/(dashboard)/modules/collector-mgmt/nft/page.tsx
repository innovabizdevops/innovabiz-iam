...
const PAGE = "NFT Gallery";
const KPIS = [{"l":"Total Collector Mgmt","v":"723","t":"+8.5%","d":"up"},{"l":"NFT Gallery Ativos","v":"5.107","t":"+6.2%","d":"up"},{"l":"Eficiência (%)","v":"80.7%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"85","t":"+2.9%","d":"up"}];
const COLS = ["ID","NFT Gallery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Collector Mgmt #001","Collector Mgmt #002","6.915","6.956","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Collector Mgmt #002","Collector Mgmt #003","8.936","6.752","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Collector Mgmt #003","Collector Mgmt #004","2.959","5.768","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Collector Mgmt #004","Collector Mgmt #005","1.119","4.897","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Collector Mgmt #005","Collector Mgmt #001","533","4.284","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":648},{"label":"Mar","value":824},{"label":"Abr","value":675},{"label":"Mai","value":678},{"label":"Jun","value":821},{"label":"Jul","value":554},{"label":"Ago","value":628},{"label":"Set","value":746},{"label":"Out","value":524},{"label":"Nov","value":574},{"label":"Dez","value":796}];
const MX = 842;
