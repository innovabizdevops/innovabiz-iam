...
const PAGE = "Collection DB";
const KPIS = [{"l":"Total Collector Mgmt","v":"6.581","t":"+13.2%","d":"up"},{"l":"Collection DB Ativos","v":"8.332","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"73.4%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"68","t":"+5.1%","d":"up"}];
const COLS = ["ID","Collection DB","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Collector Mgmt #001","Collector Mgmt #002","5.360","7.508","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Collector Mgmt #002","Collector Mgmt #003","4.100","7.824","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Collector Mgmt #003","Collector Mgmt #004","5.347","8.471","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Collector Mgmt #004","Collector Mgmt #005","4.740","4.272","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Collector Mgmt #005","Collector Mgmt #001","7.963","1.075","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":496},{"label":"Fev","value":563},{"label":"Mar","value":498},{"label":"Abr","value":486},{"label":"Mai","value":308},{"label":"Jun","value":475},{"label":"Jul","value":437},{"label":"Ago","value":495},{"label":"Set","value":424},{"label":"Out","value":322},{"label":"Nov","value":415},{"label":"Dez","value":621}];
const MX = 621;
