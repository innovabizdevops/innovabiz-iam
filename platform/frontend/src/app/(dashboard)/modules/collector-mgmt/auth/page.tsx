...
const KPIS = [{"l":"Utilizadores Ativos","v":"7.100","t":"+9.0%","d":"up"},{"l":"Sessões/Dia","v":"1259","t":"+7.7%","d":"up"},{"l":"MFA Adoção (%)","v":"68.3%","t":"-4.3%","d":"down"},{"l":"Tentativas Bloqueadas","v":"2.127","t":"+12.0%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","4.185","2.757","8.595","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.070","1.098","3.080","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.790","3.827","8.661","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.791","4.466","1.428","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.276","7.063","7.144","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":255},{"label":"Fev","value":586},{"label":"Mar","value":244},{"label":"Abr","value":276},{"label":"Mai","value":570},{"label":"Jun","value":255},{"label":"Jul","value":449},{"label":"Ago","value":545},{"label":"Set","value":461},{"label":"Out","value":528},{"label":"Nov","value":364},{"label":"Dez","value":583}];
const MX = 586;
