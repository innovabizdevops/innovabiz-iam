...
const PAGE = "Classic Cars";
const KPIS = [{"l":"Total Collector Mgmt","v":"913","t":"-1.3%","d":"down"},{"l":"Classic Cars Ativos","v":"4.667","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"93.3%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"89","t":"+17.0%","d":"up"}];
const COLS = ["ID","Classic Cars","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Collector Mgmt #001","Collector Mgmt #002","4.925","5.441","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Collector Mgmt #002","Collector Mgmt #003","4.083","3.737","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Collector Mgmt #003","Collector Mgmt #004","1.008","6.469","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Collector Mgmt #004","Collector Mgmt #005","4.170","8.319","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Collector Mgmt #005","Collector Mgmt #001","8.042","2.118","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":477},{"label":"Fev","value":413},{"label":"Mar","value":668},{"label":"Abr","value":637},{"label":"Mai","value":627},{"label":"Jun","value":632},{"label":"Jul","value":339},{"label":"Ago","value":596},{"label":"Set","value":629},{"label":"Out","value":494},{"label":"Nov","value":490},{"label":"Dez","value":553}];
const MX = 668;
