...
const PAGE = "Storage";
const KPIS = [{"l":"Total Collector Mgmt","v":"1.492","t":"+7.2%","d":"up"},{"l":"Storage Ativos","v":"1.183","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"81.5%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"77","t":"+0.4%","d":"up"}];
const COLS = ["ID","Storage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Collector Mgmt #001","Collector Mgmt #002","138","480","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Collector Mgmt #002","Collector Mgmt #003","8.978","430","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Collector Mgmt #003","Collector Mgmt #004","8.189","5.892","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Collector Mgmt #004","Collector Mgmt #005","3.737","2.937","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Collector Mgmt #005","Collector Mgmt #001","4.288","6.737","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":267},{"label":"Mar","value":497},{"label":"Abr","value":406},{"label":"Mai","value":437},{"label":"Jun","value":568},{"label":"Jul","value":253},{"label":"Ago","value":536},{"label":"Set","value":276},{"label":"Out","value":567},{"label":"Nov","value":349},{"label":"Dez","value":417}];
const MX = 568;
