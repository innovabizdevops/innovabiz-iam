...
const ACCENT = "#dc2626";
const MODULE = "Collector Management";
const PAGE = "Insurance Val";
const KPIS = [{"l":"Total Collector Mgmt","v":"6.324","t":"+8.8%","d":"up"},{"l":"Insurance Val Ativos","v":"5.879","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"87.0%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"66","t":"-2.1%","d":"down"}];
const COLS = ["ID","Insurance Val","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Collector Mgmt #001","Collector Mgmt #002","1.097","5.706","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Collector Mgmt #002","Collector Mgmt #003","8.004","4.831","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Collector Mgmt #003","Collector Mgmt #004","5.794","7.151","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Collector Mgmt #004","Collector Mgmt #005","809","8.017","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Collector Mgmt #005","Collector Mgmt #001","4.814","8.618","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":574},{"label":"Mar","value":534},{"label":"Abr","value":672},{"label":"Mai","value":654},{"label":"Jun","value":596},{"label":"Jul","value":547},{"label":"Ago","value":455},{"label":"Set","value":598},{"label":"Out","value":799},{"label":"Nov","value":673},{"label":"Dez","value":707}];
const MX = 799;
