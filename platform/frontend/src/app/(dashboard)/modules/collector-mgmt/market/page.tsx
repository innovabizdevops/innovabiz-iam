...
const PAGE = "Market Track";
const KPIS = [{"l":"Total Collector Mgmt","v":"3.476","t":"+1.7%","d":"up"},{"l":"Market Track Ativos","v":"8.278","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"75.9%","t":"+14.1%","d":"up"},{"l":"Score Performance","v":"83","t":"-2.1%","d":"down"}];
const COLS = ["ID","Market Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Collector Mgmt #001","Collector Mgmt #002","4.124","7.626","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Collector Mgmt #002","Collector Mgmt #003","1.780","4.117","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Collector Mgmt #003","Collector Mgmt #004","2.340","4.426","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Collector Mgmt #004","Collector Mgmt #005","1.587","4.208","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Collector Mgmt #005","Collector Mgmt #001","7.671","8.427","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":721},{"label":"Fev","value":414},{"label":"Mar","value":476},{"label":"Abr","value":685},{"label":"Mai","value":727},{"label":"Jun","value":647},{"label":"Jul","value":598},{"label":"Ago","value":616},{"label":"Set","value":560},{"label":"Out","value":493},{"label":"Nov","value":372},{"label":"Dez","value":549}];
const MX = 727;
