...
const PAGE = "Cost";
const KPIS = [{"l":"Dashboards Ativos","v":"5.393","t":"+11.1%","d":"up"},{"l":"Queries/Dia","v":"3789","t":"+12.3%","d":"up"},{"l":"Dados Processados (GB)","v":"3.538","t":"+4.8%","d":"up"},{"l":"Utilizadores Analytics","v":"2.460","t":"+10.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4972","2026-03-08","1.542","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1955","2026-01-06","1.529","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1447","2026-03-22","3.700","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2784","2026-03-10","2.277","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4987","2026-01-08","8.924","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":582},{"label":"Mar","value":783},{"label":"Abr","value":466},{"label":"Mai","value":711},{"label":"Jun","value":681},{"label":"Jul","value":634},{"label":"Ago","value":744},{"label":"Set","value":602},{"label":"Out","value":535},{"label":"Nov","value":698},{"label":"Dez","value":649}];
const MX = 817;
