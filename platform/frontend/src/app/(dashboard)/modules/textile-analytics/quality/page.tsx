...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.923","t":"+10.0%","d":"up"},{"l":"NC Abertas","v":"4.674","t":"+8.3%","d":"up"},{"l":"Conformidade (%)","v":"86.4%","t":"+2.6%","d":"up"},{"l":"CAPAs Pendentes","v":"2.471","t":"+0.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","615","97.9%","798","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.199","80.0%","8.441","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","823","93.3%","281","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.452","72.2%","2.992","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.559","72.8%","1.898","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":558},{"label":"Mar","value":566},{"label":"Abr","value":787},{"label":"Mai","value":438},{"label":"Jun","value":815},{"label":"Jul","value":523},{"label":"Ago","value":553},{"label":"Set","value":696},{"label":"Out","value":751},{"label":"Nov","value":823},{"label":"Dez","value":472}];
const MX = 823;
