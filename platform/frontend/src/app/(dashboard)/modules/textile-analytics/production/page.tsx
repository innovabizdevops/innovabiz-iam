...
const KPIS = [{"l":"Dashboards Ativos","v":"1.474","t":"+13.2%","d":"up"},{"l":"Queries/Dia","v":"3337","t":"+11.2%","d":"up"},{"l":"Dados Processados (GB)","v":"332","t":"+16.2%","d":"up"},{"l":"Utilizadores Analytics","v":"8.432","t":"+1.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3201","2026-01-20","418","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4906","2026-03-22","8.656","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","723","2026-01-15","2.979","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2789","2026-02-14","8.703","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1724","2026-03-04","1.195","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":703},{"label":"Mar","value":703},{"label":"Abr","value":856},{"label":"Mai","value":846},{"label":"Jun","value":919},{"label":"Jul","value":834},{"label":"Ago","value":546},{"label":"Set","value":870},{"label":"Out","value":758},{"label":"Nov","value":558},{"label":"Dez","value":773}];
const MX = 919;
