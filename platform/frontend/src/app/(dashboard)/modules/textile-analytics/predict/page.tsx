...
const ACCENT = "#6366f1";
const MODULE = "Textile Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"8.802","t":"-4.5%","d":"down"},{"l":"Queries/Dia","v":"2460","t":"+14.5%","d":"up"},{"l":"Dados Processados (GB)","v":"2.116","t":"-4.4%","d":"down"},{"l":"Utilizadores Analytics","v":"8.652","t":"-4.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1485","2026-02-14","590","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3175","2026-03-16","6.983","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4293","2026-02-25","7.175","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2976","2026-01-25","2.809","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3855","2026-02-04","5.054","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":323},{"label":"Mar","value":649},{"label":"Abr","value":675},{"label":"Mai","value":481},{"label":"Jun","value":496},{"label":"Jul","value":616},{"label":"Ago","value":453},{"label":"Set","value":483},{"label":"Out","value":612},{"label":"Nov","value":346},{"label":"Dez","value":568}];
const MX = 675;
