...
const PAGE = "Order";
const KPIS = [{"l":"Dashboards Ativos","v":"460","t":"+11.6%","d":"up"},{"l":"Queries/Dia","v":"3245","t":"+4.5%","d":"up"},{"l":"Dados Processados (GB)","v":"2.732","t":"-3.4%","d":"down"},{"l":"Utilizadores Analytics","v":"1.258","t":"+2.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","829","2026-02-10","2.312","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","239","2026-02-02","3.995","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3027","2026-01-08","3.559","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","403","2026-03-05","6.757","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1412","2026-01-02","5.053","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":570},{"label":"Mar","value":528},{"label":"Abr","value":376},{"label":"Mai","value":470},{"label":"Jun","value":286},{"label":"Jul","value":520},{"label":"Ago","value":347},{"label":"Set","value":579},{"label":"Out","value":658},{"label":"Nov","value":473},{"label":"Dez","value":457}];
const MX = 658;
