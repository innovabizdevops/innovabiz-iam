...
/* ═══ LGPD Compliance (Brazil) — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "9600", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3315", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€468K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "376080800", cells: ["LGP-7800", "LGPD Compliance (Brazil) Item 1", "5/9/2026", "€30 900"], status: "active" as const },
    { id: "376084371", cells: ["LGP-2371", "LGPD Compliance (Brazil) Item 2", "20/4/2026", "€34 471"], status: "pending" as const },
    { id: "376087942", cells: ["LGP-5942", "LGPD Compliance (Brazil) Item 3", "7/11/2026", "€38 042"], status: "completed" as const },
    { id: "376091513", cells: ["LGP-9513", "LGPD Compliance (Brazil) Item 4", "22/6/2026", "€41 613"], status: "warning" as const },
    { id: "376095084", cells: ["LGP-4084", "LGPD Compliance (Brazil) Item 5", "9/1/2026", "€45 184"], status: "active" as const },
];
...
export default function LgpdComplianceBrazilPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">LGPD Compliance (Brazil)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • LGPD Compliance (Brazil)</p>
                    </div>
                </div>
