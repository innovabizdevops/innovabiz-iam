...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.588","t":"-5.3%","d":"down"},{"l":"NC Abertas","v":"5.658","t":"+1.5%","d":"up"},{"l":"Conformidade (%)","v":"78.7%","t":"+12.7%","d":"up"},{"l":"CAPAs Pendentes","v":"2.815","t":"+4.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.181","80.4%","2.126","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.497","86.5%","7.080","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.821","89.2%","106","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.066","91.7%","3.583","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.733","87.7%","5.790","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":533},{"label":"Mar","value":677},{"label":"Abr","value":729},{"label":"Mai","value":579},{"label":"Jun","value":496},{"label":"Jul","value":441},{"label":"Ago","value":512},{"label":"Set","value":759},{"label":"Out","value":408},{"label":"Nov","value":522},{"label":"Dez","value":640}];
const MX = 759;
