...
const PAGE = "DPIA";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.793","t":"+12.0%","d":"up"},{"l":"NC Abertas","v":"7.585","t":"+16.9%","d":"up"},{"l":"Conformidade (%)","v":"86.0%","t":"+7.6%","d":"up"},{"l":"CAPAs Pendentes","v":"6.444","t":"+15.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.863","77.5%","2.490","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.138","82.4%","4.318","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.585","80.9%","5.015","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.123","93.6%","775","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.394","87.1%","9.063","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":570},{"label":"Mar","value":882},{"label":"Abr","value":606},{"label":"Mai","value":733},{"label":"Jun","value":812},{"label":"Jul","value":852},{"label":"Ago","value":663},{"label":"Set","value":693},{"label":"Out","value":739},{"label":"Nov","value":837},{"label":"Dez","value":582}];
const MX = 882;
