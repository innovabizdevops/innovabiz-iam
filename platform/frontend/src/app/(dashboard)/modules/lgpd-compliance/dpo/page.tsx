...
const PAGE = "DPO";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.639","t":"-0.4%","d":"down"},{"l":"NC Abertas","v":"2.405","t":"+11.0%","d":"up"},{"l":"Conformidade (%)","v":"82.4%","t":"+0.3%","d":"up"},{"l":"CAPAs Pendentes","v":"2.060","t":"+4.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.369","77.2%","687","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.727","89.6%","567","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.471","95.9%","4.597","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.455","73.4%","8.401","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.875","72.6%","859","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":401},{"label":"Fev","value":562},{"label":"Mar","value":650},{"label":"Abr","value":655},{"label":"Mai","value":425},{"label":"Jun","value":542},{"label":"Jul","value":395},{"label":"Ago","value":397},{"label":"Set","value":642},{"label":"Out","value":535},{"label":"Nov","value":563},{"label":"Dez","value":293}];
const MX = 655;
