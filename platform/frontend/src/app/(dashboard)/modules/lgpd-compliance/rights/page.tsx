...
const ACCENT = "#dc2626";
const MODULE = "LGPD Compliance (Brazil)";
const PAGE = "Rights";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.972","t":"+10.9%","d":"up"},{"l":"NC Abertas","v":"3.799","t":"+15.9%","d":"up"},{"l":"Conformidade (%)","v":"78.4%","t":"+14.3%","d":"up"},{"l":"CAPAs Pendentes","v":"3.107","t":"+16.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.554","82.4%","8.538","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.436","74.7%","3.581","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.507","82.5%","230","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.174","83.6%","3.560","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.721","91.2%","1.062","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":792},{"label":"Mar","value":841},{"label":"Abr","value":990},{"label":"Mai","value":913},{"label":"Jun","value":851},{"label":"Jul","value":809},{"label":"Ago","value":803},{"label":"Set","value":759},{"label":"Out","value":917},{"label":"Nov","value":747},{"label":"Dez","value":765}];
const MX = 990;
