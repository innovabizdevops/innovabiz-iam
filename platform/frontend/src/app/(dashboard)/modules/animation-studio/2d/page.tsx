...
const PAGE = "2D Anim";
const KPIS = [{"l":"Total Animation Studio","v":"2.044","t":"+7.6%","d":"up"},{"l":"2D Anim Ativos","v":"4.712","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"81.9%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"67","t":"+0.8%","d":"up"}];
const COLS = ["ID","2D Anim","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Animation Studio #001","Animation Studio #002","1.260","4.451","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Animation Studio #002","Animation Studio #003","8.934","7.933","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Animation Studio #003","Animation Studio #004","3.926","8.734","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Animation Studio #004","Animation Studio #005","8.854","5.819","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Animation Studio #005","Animation Studio #001","4.238","5.906","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":956},{"label":"Mar","value":745},{"label":"Abr","value":898},{"label":"Mai","value":956},{"label":"Jun","value":791},{"label":"Jul","value":819},{"label":"Ago","value":740},{"label":"Set","value":662},{"label":"Out","value":841},{"label":"Nov","value":629},{"label":"Dez","value":597}];
const MX = 956;
...
export default function 2dPage() {
    return (
