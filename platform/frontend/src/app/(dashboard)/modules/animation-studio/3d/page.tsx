...
const ACCENT = "#6366f1";
const MODULE = "Animation Studio";
const PAGE = "3D Anim";
const KPIS = [{"l":"Total Animation Studio","v":"4.668","t":"+2.6%","d":"up"},{"l":"3D Anim Ativos","v":"5.557","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"87.7%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"93","t":"+1.8%","d":"up"}];
const COLS = ["ID","3D Anim","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Animation Studio #001","Animation Studio #002","3.665","5.279","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Animation Studio #002","Animation Studio #003","6.794","2.683","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Animation Studio #003","Animation Studio #004","4.714","5.730","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Animation Studio #004","Animation Studio #005","8.118","6.838","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Animation Studio #005","Animation Studio #001","6.320","7.832","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":347},{"label":"Fev","value":253},{"label":"Mar","value":539},{"label":"Abr","value":369},{"label":"Mai","value":244},{"label":"Jun","value":429},{"label":"Jul","value":379},{"label":"Ago","value":535},{"label":"Set","value":303},{"label":"Out","value":334},{"label":"Nov","value":335},{"label":"Dez","value":545}];
const MX = 545;
...
export default function 3dPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>3D</span></h1>
                </div>
