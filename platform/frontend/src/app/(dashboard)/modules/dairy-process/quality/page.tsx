...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.352","t":"-2.7%","d":"down"},{"l":"NC Abertas","v":"4.841","t":"-5.7%","d":"down"},{"l":"Conformidade (%)","v":"90.5%","t":"+13.4%","d":"up"},{"l":"CAPAs Pendentes","v":"2.031","t":"+5.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.499","82.3%","415","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.868","81.6%","2.594","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.500","96.6%","5.343","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.891","82.6%","996","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.319","89.0%","5.057","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":875},{"label":"Mar","value":830},{"label":"Abr","value":730},{"label":"Mai","value":989},{"label":"Jun","value":751},{"label":"Jul","value":1000},{"label":"Ago","value":805},{"label":"Set","value":761},{"label":"Out","value":813},{"label":"Nov","value":830},{"label":"Dez","value":816}];
const MX = 1000;
