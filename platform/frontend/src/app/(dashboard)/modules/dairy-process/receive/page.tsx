...
const PAGE = "Receive";
const KPIS = [{"l":"Total Dairy Process","v":"2.048","t":"+8.8%","d":"up"},{"l":"Receive Ativos","v":"7.041","t":"+5.3%","d":"up"},{"l":"Eficiência (%)","v":"76.8%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"63","t":"-5.6%","d":"down"}];
const COLS = ["ID","Receive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dairy Process #001","Dairy Process #002","6.463","5.749","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Dairy Process #002","Dairy Process #003","5.333","6.721","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Dairy Process #003","Dairy Process #004","2.781","3.318","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Dairy Process #004","Dairy Process #005","7.616","6.718","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dairy Process #005","Dairy Process #001","2.945","375","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":652},{"label":"Mar","value":933},{"label":"Abr","value":956},{"label":"Mai","value":684},{"label":"Jun","value":763},{"label":"Jul","value":955},{"label":"Ago","value":589},{"label":"Set","value":593},{"label":"Out","value":866},{"label":"Nov","value":610},{"label":"Dez","value":965}];
const MX = 965;
