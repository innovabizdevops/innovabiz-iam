...
const PAGE = "Process";
const KPIS = [{"l":"Total Dairy Process","v":"1.529","t":"-3.2%","d":"down"},{"l":"Process Ativos","v":"5.931","t":"+2.9%","d":"up"},{"l":"Eficiência (%)","v":"84.9%","t":"-3.4%","d":"down"},{"l":"Score Performance","v":"84","t":"-3.1%","d":"down"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dairy Process #001","Dairy Process #002","1.338","7.722","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Dairy Process #002","Dairy Process #003","2.722","3.455","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Dairy Process #003","Dairy Process #004","5.588","7.601","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Dairy Process #004","Dairy Process #005","4.103","1.008","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dairy Process #005","Dairy Process #001","4.074","8.095","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":263},{"label":"Fev","value":541},{"label":"Mar","value":358},{"label":"Abr","value":440},{"label":"Mai","value":516},{"label":"Jun","value":244},{"label":"Jul","value":266},{"label":"Ago","value":293},{"label":"Set","value":250},{"label":"Out","value":440},{"label":"Nov","value":448},{"label":"Dez","value":265}];
const MX = 541;
