...
const ACCENT = "#6366f1";
const MODULE = "Dairy Processing";
const PAGE = "Pasteurize";
const KPIS = [{"l":"Total Dairy Process","v":"1.529","t":"+6.9%","d":"up"},{"l":"Pasteurize Ativos","v":"6.581","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"76.4%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"88","t":"+14.3%","d":"up"}];
const COLS = ["ID","Pasteurize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dairy Process #001","Dairy Process #002","5.670","3.569","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Dairy Process #002","Dairy Process #003","7.305","905","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Dairy Process #003","Dairy Process #004","7.347","5.908","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Dairy Process #004","Dairy Process #005","3.294","7.690","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dairy Process #005","Dairy Process #001","4.588","7.713","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":657},{"label":"Mar","value":607},{"label":"Abr","value":494},{"label":"Mai","value":677},{"label":"Jun","value":644},{"label":"Jul","value":547},{"label":"Ago","value":500},{"label":"Set","value":450},{"label":"Out","value":329},{"label":"Nov","value":539},{"label":"Dez","value":599}];
const MX = 677;
...
export default function PasteurizePage() {
    return (
