...
const PAGE = "Proration Calculator";
const KPIS = [{"l":"ARR (€M)","v":"€25.4M","t":"-1.5%","d":"down"},{"l":"MRR (€)","v":"€87945","t":"-5.4%","d":"down"},{"l":"Churn (%)","v":"72.7%","t":"+14.7%","d":"up"},{"l":"ARPU (€)","v":"€19166","t":"+2.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 16180.99","4.753","€ 9656.59","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 30847.62","2.125","€ 41845.84","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 28071.47","8.137","€ 38130.41","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 36787.59","8.507","€ 4099.10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 9609.36","2.620","€ 6545.64","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":772},{"label":"Mar","value":601},{"label":"Abr","value":925},{"label":"Mai","value":933},{"label":"Jun","value":661},{"label":"Jul","value":938},{"label":"Ago","value":649},{"label":"Set","value":851},{"label":"Out","value":600},{"label":"Nov","value":582},{"label":"Dez","value":703}];
const MX = 938;
