...
const PAGE = "Upgrade/Downgrade Flow";
const KPIS = [{"l":"ARR (€M)","v":"€41.5M","t":"+16.0%","d":"up"},{"l":"MRR (€)","v":"€63449","t":"+15.2%","d":"up"},{"l":"Churn (%)","v":"67.7%","t":"-5.6%","d":"down"},{"l":"ARPU (€)","v":"€78263","t":"+1.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 39229.16","8.586","€ 18918.35","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 26259.25","5.541","€ 16269.03","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 25373.77","1.060","€ 45334.89","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 6138.69","6.074","€ 31885.34","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 2620.41","4.376","€ 31392.40","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":808},{"label":"Mar","value":747},{"label":"Abr","value":734},{"label":"Mai","value":756},{"label":"Jun","value":868},{"label":"Jul","value":640},{"label":"Ago","value":699},{"label":"Set","value":837},{"label":"Out","value":784},{"label":"Nov","value":491},{"label":"Dez","value":730}];
const MX = 868;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#8b5cf6'}}>Flow</span></h1>
                </div>
