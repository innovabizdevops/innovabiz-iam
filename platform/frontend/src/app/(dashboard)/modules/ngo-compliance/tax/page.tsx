...
const ACCENT = "#6366f1";
const MODULE = "NGO Compliance";
const PAGE = "Tax Exempt";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.212","t":"-3.6%","d":"down"},{"l":"NC Abertas","v":"8.707","t":"-5.0%","d":"down"},{"l":"Conformidade (%)","v":"69.0%","t":"+16.5%","d":"up"},{"l":"CAPAs Pendentes","v":"8.253","t":"+2.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.458","87.3%","3.874","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.168","82.1%","1.405","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.837","70.0%","6.084","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.571","98.6%","3.567","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.434","73.9%","6.024","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":422},{"label":"Fev","value":341},{"label":"Mar","value":432},{"label":"Abr","value":595},{"label":"Mai","value":304},{"label":"Jun","value":467},{"label":"Jul","value":571},{"label":"Ago","value":390},{"label":"Set","value":309},{"label":"Out","value":330},{"label":"Nov","value":363},{"label":"Dez","value":403}];
const MX = 595;
