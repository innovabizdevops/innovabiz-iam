...
const PAGE = "Report Gov";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.100","t":"+8.8%","d":"up"},{"l":"NC Abertas","v":"1.853","t":"+2.7%","d":"up"},{"l":"Conformidade (%)","v":"73.8%","t":"-2.3%","d":"down"},{"l":"CAPAs Pendentes","v":"3.576","t":"+10.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.274","87.1%","8.304","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.887","73.3%","2.787","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.945","87.0%","4.369","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.116","79.4%","3.307","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.505","76.2%","3.154","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":426},{"label":"Mar","value":621},{"label":"Abr","value":405},{"label":"Mai","value":382},{"label":"Jun","value":529},{"label":"Jul","value":694},{"label":"Ago","value":519},{"label":"Set","value":612},{"label":"Out","value":673},{"label":"Nov","value":441},{"label":"Dez","value":328}];
const MX = 694;
