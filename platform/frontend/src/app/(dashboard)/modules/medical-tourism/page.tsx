...
const KPIS = [
    { label: "Total Registos", value: "5538", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4092", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€346K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1418012138", cells: ["MED-9138", "Medical Tourism Item 1", "19/3/2026", "€12 238"], status: "active" as const },
    { id: "1418015709", cells: ["MED-3709", "Medical Tourism Item 2", "6/10/2026", "€15 809"], status: "pending" as const },
    { id: "1418019280", cells: ["MED-7280", "Medical Tourism Item 3", "21/5/2026", "€19 380"], status: "completed" as const },
    { id: "1418022851", cells: ["MED-1851", "Medical Tourism Item 4", "8/12/2026", "€22 951"], status: "warning" as const },
    { id: "1418026422", cells: ["MED-5422", "Medical Tourism Item 5", "23/7/2026", "€26 522"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Medical Tourism</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Medical Tourism</p>
                    </div>
                </div>
