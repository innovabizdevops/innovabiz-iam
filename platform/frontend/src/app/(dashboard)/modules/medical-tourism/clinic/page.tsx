...
const PAGE = "Clinic";
const KPIS = [{"l":"Integrações Ativas","v":"7.165","t":"+6.6%","d":"up"},{"l":"Chamadas/Hora","v":"4829","t":"+2.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.0%","t":"+14.2%","d":"up"},{"l":"Latência Média (ms)","v":"170ms","t":"-5.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.637","7.143","86.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.731","3.563","96.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.670","1.437","86.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.458","1.792","89.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.127","2.394","81.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":865},{"label":"Mar","value":773},{"label":"Abr","value":544},{"label":"Mai","value":645},{"label":"Jun","value":727},{"label":"Jul","value":540},{"label":"Ago","value":730},{"label":"Set","value":761},{"label":"Out","value":794},{"label":"Nov","value":857},{"label":"Dez","value":544}];
const MX = 865;
