...
const PAGE = "Package";
const KPIS = [{"l":"Integrações Ativas","v":"6.775","t":"+10.0%","d":"up"},{"l":"Chamadas/Hora","v":"1355","t":"+4.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.2%","t":"+16.7%","d":"up"},{"l":"Latência Média (ms)","v":"46ms","t":"-4.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.137","6.661","85.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","279","814","78.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","794","7.546","90.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.069","5.768","70.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.618","5.712","93.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":315},{"label":"Mar","value":250},{"label":"Abr","value":593},{"label":"Mai","value":500},{"label":"Jun","value":418},{"label":"Jul","value":330},{"label":"Ago","value":305},{"label":"Set","value":266},{"label":"Out","value":426},{"label":"Nov","value":304},{"label":"Dez","value":405}];
const MX = 593;
