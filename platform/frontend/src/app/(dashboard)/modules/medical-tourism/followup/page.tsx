...
const ACCENT = "#831843";
const MODULE = "Medical Tourism";
const PAGE = "Follow-Up";
const KPIS = [{"l":"Integrações Ativas","v":"5.325","t":"+11.1%","d":"up"},{"l":"Chamadas/Hora","v":"375","t":"+2.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"79.5%","t":"+7.0%","d":"up"},{"l":"Latência Média (ms)","v":"37ms","t":"+1.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.554","6.300","75.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.052","4.898","95.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.333","7.887","91.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.475","8.844","97.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.642","962","89.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":480},{"label":"Mar","value":653},{"label":"Abr","value":654},{"label":"Mai","value":678},{"label":"Jun","value":654},{"label":"Jul","value":597},{"label":"Ago","value":623},{"label":"Set","value":757},{"label":"Out","value":630},{"label":"Nov","value":543},{"label":"Dez","value":650}];
const MX = 757;
