...
const KPIS = [{"l":"Integrações Ativas","v":"3.725","t":"+11.6%","d":"up"},{"l":"Chamadas/Hora","v":"4062","t":"-5.5%","d":"down"},{"l":"Taxa Sucesso (%)","v":"88.8%","t":"+10.9%","d":"up"},{"l":"Latência Média (ms)","v":"177ms","t":"+7.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.009","2.463","87.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.040","4.164","92.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.197","4.793","86.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.406","2.031","98.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.343","7.210","71.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":688},{"label":"Mar","value":615},{"label":"Abr","value":679},{"label":"Mai","value":368},{"label":"Jun","value":728},{"label":"Jul","value":413},{"label":"Ago","value":414},{"label":"Set","value":445},{"label":"Out","value":394},{"label":"Nov","value":615},{"label":"Dez","value":527}];
const MX = 728;
