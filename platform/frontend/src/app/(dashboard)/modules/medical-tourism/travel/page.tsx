...
const PAGE = "Travel";
const KPIS = [{"l":"Integrações Ativas","v":"255","t":"+14.8%","d":"up"},{"l":"Chamadas/Hora","v":"430","t":"-3.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"69.4%","t":"-0.2%","d":"down"},{"l":"Latência Média (ms)","v":"80ms","t":"-2.7%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.948","162","94.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.716","7.178","77.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.180","2.852","95.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.030","698","88.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.331","724","82.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":671},{"label":"Mar","value":362},{"label":"Abr","value":496},{"label":"Mai","value":278},{"label":"Jun","value":486},{"label":"Jul","value":359},{"label":"Ago","value":587},{"label":"Set","value":572},{"label":"Out","value":357},{"label":"Nov","value":584},{"label":"Dez","value":277}];
const MX = 671;
