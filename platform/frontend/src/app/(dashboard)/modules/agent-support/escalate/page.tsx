...
const PAGE = "Escalate";
const KPIS = [{"l":"Tickets Abertos","v":"5.932","t":"+7.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"91.7%","t":"+9.0%","d":"up"},{"l":"MTTR (h)","v":"173h","t":"+13.6%","d":"up"},{"l":"Satisfação (%)","v":"70.2%","t":"+9.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.441","3.471","1.931","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.352","7.552","9.019","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.774","5.707","8.740","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.725","6.190","3.391","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.971","3.660","1.791","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1047},{"label":"Fev","value":1011},{"label":"Mar","value":679},{"label":"Abr","value":795},{"label":"Mai","value":1021},{"label":"Jun","value":794},{"label":"Jul","value":753},{"label":"Ago","value":1002},{"label":"Set","value":934},{"label":"Out","value":806},{"label":"Nov","value":953},{"label":"Dez","value":990}];
const MX = 1047;
