...
const ACCENT = "#7c3aed";
const MODULE = "AI Support Agent";
const PAGE = "Resolve";
const KPIS = [{"l":"Tickets Abertos","v":"3.661","t":"-3.9%","d":"down"},{"l":"SLA Cumprido (%)","v":"66.2%","t":"+11.2%","d":"up"},{"l":"MTTR (h)","v":"33h","t":"+10.5%","d":"up"},{"l":"Satisfação (%)","v":"76.3%","t":"+6.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.598","1.682","5.377","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.258","2.725","5.816","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.361","6.261","7.320","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.270","1.881","3.473","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.958","3.692","8.169","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":586},{"label":"Mar","value":640},{"label":"Abr","value":680},{"label":"Mai","value":847},{"label":"Jun","value":564},{"label":"Jul","value":758},{"label":"Ago","value":657},{"label":"Set","value":530},{"label":"Out","value":574},{"label":"Nov","value":717},{"label":"Dez","value":500}];
const MX = 847;
