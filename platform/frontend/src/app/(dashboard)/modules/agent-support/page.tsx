...
const KPIS = [
    ...
    { label: "Ativos", value: "1671", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€30K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1774674222", cells: ["AGE-1222", "AI Support Agent Item 1", "7/7/2026", "€24 322"], status: "active" as const },
    { id: "1774677793", cells: ["AGE-4793", "AI Support Agent Item 2", "22/2/2026", "€27 893"], status: "pending" as const },
    { id: "1774681364", cells: ["AGE-8364", "AI Support Agent Item 3", "9/9/2026", "€31 464"], status: "completed" as const },
    { id: "1774684935", cells: ["AGE-2935", "AI Support Agent Item 4", "24/4/2026", "€35 035"], status: "warning" as const },
    { id: "1774688506", cells: ["AGE-6506", "AI Support Agent Item 5", "11/11/2026", "€38 606"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Support Agent</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Support Agent</p>
                    </div>
                </div>
