...
const PAGE = "Classify";
const KPIS = [{"l":"Tickets Abertos","v":"6.225","t":"+13.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"67.0%","t":"+4.7%","d":"up"},{"l":"MTTR (h)","v":"160h","t":"+15.0%","d":"up"},{"l":"Satisfação (%)","v":"91.1%","t":"+5.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.489","5.535","5.603","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.954","1.060","8.754","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.362","3.245","9.074","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.648","4.297","5.570","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.704","867","3.076","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":846},{"label":"Fev","value":840},{"label":"Mar","value":681},{"label":"Abr","value":883},{"label":"Mai","value":661},{"label":"Jun","value":833},{"label":"Jul","value":695},{"label":"Ago","value":690},{"label":"Set","value":778},{"label":"Out","value":645},{"label":"Nov","value":635},{"label":"Dez","value":862}];
const MX = 883;
