...
const PAGE = "Learn";
const KPIS = [{"l":"Tickets Abertos","v":"5.916","t":"-0.7%","d":"down"},{"l":"SLA Cumprido (%)","v":"68.8%","t":"+5.5%","d":"up"},{"l":"MTTR (h)","v":"24h","t":"+12.3%","d":"up"},{"l":"Satisfação (%)","v":"68.3%","t":"-4.1%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.194","6.571","8.920","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.335","6.948","7.322","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.015","392","1.537","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.217","4.925","8.418","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.398","1.793","2.037","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":984},{"label":"Fev","value":1019},{"label":"Mar","value":773},{"label":"Abr","value":785},{"label":"Mai","value":839},{"label":"Jun","value":1003},{"label":"Jul","value":922},{"label":"Ago","value":807},{"label":"Set","value":897},{"label":"Out","value":650},{"label":"Nov","value":848},{"label":"Dez","value":733}];
const MX = 1019;
