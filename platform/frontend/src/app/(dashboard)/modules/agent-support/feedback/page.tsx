...
const PAGE = "Feedback";
const KPIS = [{"l":"Tickets Abertos","v":"2.848","t":"+-0.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"90.5%","t":"+13.9%","d":"up"},{"l":"MTTR (h)","v":"153h","t":"-3.4%","d":"down"},{"l":"Satisfação (%)","v":"83.3%","t":"+16.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.082","6.267","1.379","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.508","1.796","236","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.605","1.813","7.270","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.985","1.747","5.210","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.255","4.249","5.764","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":502},{"label":"Mar","value":577},{"label":"Abr","value":647},{"label":"Mai","value":464},{"label":"Jun","value":349},{"label":"Jul","value":518},{"label":"Ago","value":660},{"label":"Set","value":612},{"label":"Out","value":541},{"label":"Nov","value":400},{"label":"Dez","value":695}];
const MX = 695;
