...
/* ═══ IT Operations Mgmt (SNOW) — Dashboard ═══ */

const ACCENT = "#81b5a1";

const KPIS = [
    { label: "Total Registos", value: "9006", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2869", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€124K", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "384010106", cells: ["SNO-8106", "IT Operations Mgmt (SNOW) Item 1", "19/3/2026", "€10 206"], status: "active" as const },
    { id: "384013677", cells: ["SNO-2677", "IT Operations Mgmt (SNOW) Item 2", "6/10/2026", "€13 777"], status: "pending" as const },
    { id: "384017248", cells: ["SNO-6248", "IT Operations Mgmt (SNOW) Item 3", "21/5/2026", "€17 348"], status: "completed" as const },
    { id: "384020819", cells: ["SNO-9819", "IT Operations Mgmt (SNOW) Item 4", "8/12/2026", "€20 919"], status: "warning" as const },
    { id: "384024390", cells: ["SNO-4390", "IT Operations Mgmt (SNOW) Item 5", "23/7/2026", "€24 490"], status: "active" as const },
];
...
export default function ItOperationsMgmtSnowPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">IT Operations Mgmt (SNOW)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • IT Operations Mgmt (SNOW)</p>
                    </div>
                </div>
