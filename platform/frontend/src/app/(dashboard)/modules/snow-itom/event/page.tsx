...
const PAGE = "Event";
const KPIS = [{"l":"Total Snow Itom","v":"869","t":"+12.8%","d":"up"},{"l":"Event Ativos","v":"9.094","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"88.5%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"67","t":"-2.7%","d":"down"}];
const COLS = ["ID","Event","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snow Itom #001","Snow Itom #002","6.836","5.852","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Snow Itom #002","Snow Itom #003","8.570","3.958","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Snow Itom #003","Snow Itom #004","899","5.097","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Snow Itom #004","Snow Itom #005","1.069","8.473","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snow Itom #005","Snow Itom #001","7.308","5.443","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":897},{"label":"Fev","value":968},{"label":"Mar","value":971},{"label":"Abr","value":873},{"label":"Mai","value":906},{"label":"Jun","value":755},{"label":"Jul","value":642},{"label":"Ago","value":964},{"label":"Set","value":645},{"label":"Out","value":913},{"label":"Nov","value":771},{"label":"Dez","value":989}];
const MX = 989;
