...
const PAGE = "Cloud";
const KPIS = [{"l":"Total Snow Itom","v":"3.604","t":"+4.3%","d":"up"},{"l":"Cloud Ativos","v":"2.593","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"70.8%","t":"+5.8%","d":"up"},{"l":"Score Performance","v":"70","t":"-6.0%","d":"down"}];
const COLS = ["ID","Cloud","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snow Itom #001","Snow Itom #002","4.715","8.774","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Snow Itom #002","Snow Itom #003","5.947","4.246","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Snow Itom #003","Snow Itom #004","8.545","6.076","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Snow Itom #004","Snow Itom #005","1.770","5.581","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snow Itom #005","Snow Itom #001","6.762","433","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":360},{"label":"Mar","value":547},{"label":"Abr","value":618},{"label":"Mai","value":640},{"label":"Jun","value":704},{"label":"Jul","value":426},{"label":"Ago","value":327},{"label":"Set","value":600},{"label":"Out","value":600},{"label":"Nov","value":509},{"label":"Dez","value":620}];
const MX = 704;
