...
const ACCENT = "#81b5a1";
const MODULE = "IT Operations Mgmt (SNOW)";
const PAGE = "Health";
const KPIS = [{"l":"Total Snow Itom","v":"4.818","t":"+7.1%","d":"up"},{"l":"Health Ativos","v":"1.460","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"79.4%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"70","t":"-4.9%","d":"down"}];
const COLS = ["ID","Health","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snow Itom #001","Snow Itom #002","5.878","1.374","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Snow Itom #002","Snow Itom #003","7.904","839","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Snow Itom #003","Snow Itom #004","6.926","6.023","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Snow Itom #004","Snow Itom #005","5.714","6.139","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snow Itom #005","Snow Itom #001","1.867","7.268","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":454},{"label":"Fev","value":322},{"label":"Mar","value":593},{"label":"Abr","value":505},{"label":"Mai","value":541},{"label":"Jun","value":498},{"label":"Jul","value":601},{"label":"Ago","value":293},{"label":"Set","value":284},{"label":"Out","value":556},{"label":"Nov","value":493},{"label":"Dez","value":603}];
const MX = 603;
