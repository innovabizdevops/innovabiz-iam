...
const KPIS = [{"l":"Total Snow Itom","v":"7.932","t":"+13.9%","d":"up"},{"l":"Orchestrate Ativos","v":"3.754","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"83.7%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"84","t":"+9.8%","d":"up"}];
const COLS = ["ID","Orchestrate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snow Itom #001","Snow Itom #002","5.199","705","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Snow Itom #002","Snow Itom #003","7.812","1.877","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Snow Itom #003","Snow Itom #004","2.470","6.514","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Snow Itom #004","Snow Itom #005","6.840","6.437","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snow Itom #005","Snow Itom #001","6.660","7.123","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":581},{"label":"Fev","value":693},{"label":"Mar","value":742},{"label":"Abr","value":469},{"label":"Mai","value":564},{"label":"Jun","value":551},{"label":"Jul","value":618},{"label":"Ago","value":459},{"label":"Set","value":751},{"label":"Out","value":567},{"label":"Nov","value":527},{"label":"Dez","value":762}];
const MX = 762;
