...
const PAGE = "Discover";
const KPIS = [{"l":"Total Snow Itom","v":"3.689","t":"+0.9%","d":"up"},{"l":"Discover Ativos","v":"5.350","t":"+0.4%","d":"up"},{"l":"Eficiência (%)","v":"71.1%","t":"+13.9%","d":"up"},{"l":"Score Performance","v":"84","t":"+0.3%","d":"up"}];
const COLS = ["ID","Discover","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snow Itom #001","Snow Itom #002","820","3.883","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Snow Itom #002","Snow Itom #003","5.023","3.949","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Snow Itom #003","Snow Itom #004","5.262","4.481","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Snow Itom #004","Snow Itom #005","2.528","8.710","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snow Itom #005","Snow Itom #001","7.136","4.332","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":741},{"label":"Fev","value":622},{"label":"Mar","value":948},{"label":"Abr","value":579},{"label":"Mai","value":857},{"label":"Jun","value":565},{"label":"Jul","value":739},{"label":"Ago","value":606},{"label":"Set","value":841},{"label":"Out","value":860},{"label":"Nov","value":732},{"label":"Dez","value":816}];
const MX = 948;
