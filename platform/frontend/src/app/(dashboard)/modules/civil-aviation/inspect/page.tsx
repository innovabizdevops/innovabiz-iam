...
const PAGE = "Inspect";
const KPIS = [{"l":"Total Civil Aviation","v":"7.582","t":"-2.0%","d":"down"},{"l":"Inspect Ativos","v":"7.958","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"84","t":"-2.3%","d":"down"}];
const COLS = ["ID","Inspect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Civil Aviation #001","Civil Aviation #002","4.698","3.736","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Civil Aviation #002","Civil Aviation #003","3.714","3.447","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Civil Aviation #003","Civil Aviation #004","3.797","472","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Civil Aviation #004","Civil Aviation #005","2.903","8.869","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Civil Aviation #005","Civil Aviation #001","6.833","7.812","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1045},{"label":"Fev","value":766},{"label":"Mar","value":906},{"label":"Abr","value":1019},{"label":"Mai","value":746},{"label":"Jun","value":806},{"label":"Jul","value":759},{"label":"Ago","value":931},{"label":"Set","value":827},{"label":"Out","value":896},{"label":"Nov","value":969},{"label":"Dez","value":1063}];
const MX = 1063;
