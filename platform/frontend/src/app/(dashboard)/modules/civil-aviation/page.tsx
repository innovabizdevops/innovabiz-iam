...
/* ═══ Civil Aviation Authority — Dashboard ═══ */

const ACCENT = "#3b82f6";

const KPIS = [
    { label: "Total Registos", value: "1222", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "928", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€310K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "813355422", cells: ["CIV-8422", "Civil Aviation Authority Item 1", "27/7/2026", "€5522"], status: "active" as const },
    { id: "813358993", cells: ["CIV-2993", "Civil Aviation Authority Item 2", "14/2/2026", "€9093"], status: "pending" as const },
    { id: "813362564", cells: ["CIV-6564", "Civil Aviation Authority Item 3", "1/9/2026", "€12 664"], status: "completed" as const },
    { id: "813366135", cells: ["CIV-1135", "Civil Aviation Authority Item 4", "16/4/2026", "€16 235"], status: "warning" as const },
    { id: "813369706", cells: ["CIV-4706", "Civil Aviation Authority Item 5", "3/11/2026", "€19 806"], status: "active" as const },
];
...
export default function CivilAviationAuthorityPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Civil Aviation Authority</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Civil Aviation Authority</p>
                    </div>
                </div>
