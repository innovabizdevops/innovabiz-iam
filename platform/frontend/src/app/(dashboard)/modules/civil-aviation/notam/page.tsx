...
const ACCENT = "#3b82f6";
const MODULE = "Civil Aviation Authority";
const PAGE = "NOTAM";
const KPIS = [{"l":"Total Civil Aviation","v":"2.748","t":"+17.8%","d":"up"},{"l":"NOTAM Ativos","v":"5.770","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"82.3%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"78","t":"+11.5%","d":"up"}];
const COLS = ["ID","NOTAM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Civil Aviation #001","Civil Aviation #002","8.085","809","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Civil Aviation #002","Civil Aviation #003","1.947","7.032","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Civil Aviation #003","Civil Aviation #004","8.968","2.724","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Civil Aviation #004","Civil Aviation #005","8.891","5.652","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Civil Aviation #005","Civil Aviation #001","8.656","2.922","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":703},{"label":"Mar","value":487},{"label":"Abr","value":774},{"label":"Mai","value":720},{"label":"Jun","value":562},{"label":"Jul","value":688},{"label":"Ago","value":470},{"label":"Set","value":831},{"label":"Out","value":701},{"label":"Nov","value":599},{"label":"Dez","value":718}];
const MX = 831;
