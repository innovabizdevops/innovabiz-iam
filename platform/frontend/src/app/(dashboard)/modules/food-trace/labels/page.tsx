...
const PAGE = "Label Print";
const KPIS = [{"l":"Total Food Trace","v":"7.431","t":"+0.3%","d":"up"},{"l":"Label Print Ativos","v":"3.253","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"74.0%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"71","t":"+1.8%","d":"up"}];
const COLS = ["ID","Label Print","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Trace #001","Food Trace #002","7.647","7.489","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Food Trace #002","Food Trace #003","8.982","6.157","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Trace #003","Food Trace #004","8.382","2.501","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Food Trace #004","Food Trace #005","2.402","5.949","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Trace #005","Food Trace #001","2.959","4.858","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":526},{"label":"Fev","value":683},{"label":"Mar","value":436},{"label":"Abr","value":642},{"label":"Mai","value":331},{"label":"Jun","value":330},{"label":"Jul","value":581},{"label":"Ago","value":679},{"label":"Set","value":304},{"label":"Out","value":544},{"label":"Nov","value":643},{"label":"Dez","value":366}];
const MX = 683;
