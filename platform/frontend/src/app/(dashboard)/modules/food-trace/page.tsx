...
export default function FoodTracePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Food Trace</h1><p className="text-sm text-muted-foreground">Food Trace • iBOS Enterprise</p></div>
