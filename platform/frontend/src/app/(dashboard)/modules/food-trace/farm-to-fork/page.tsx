...
const KPIS = [{"l":"Total Food Trace","v":"6.027","t":"+15.6%","d":"up"},{"l":"Farm To Fork Ativos","v":"4.652","t":"+7.7%","d":"up"},{"l":"Eficiência (%)","v":"70.6%","t":"+4.6%","d":"up"},{"l":"Score Performance","v":"76","t":"+1.9%","d":"up"}];
const COLS = ["ID","Farm To Fork","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Trace #001","Food Trace #002","2.970","5.028","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Food Trace #002","Food Trace #003","8.441","2.653","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Trace #003","Food Trace #004","7.854","8.557","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Food Trace #004","Food Trace #005","6.757","210","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Trace #005","Food Trace #001","7.655","8.620","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":344},{"label":"Fev","value":602},{"label":"Mar","value":419},{"label":"Abr","value":728},{"label":"Mai","value":713},{"label":"Jun","value":642},{"label":"Jul","value":437},{"label":"Ago","value":368},{"label":"Set","value":529},{"label":"Out","value":743},{"label":"Nov","value":593},{"label":"Dez","value":665}];
const MX = 743;
