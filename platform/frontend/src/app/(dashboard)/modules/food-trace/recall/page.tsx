...
const KPIS = [{"l":"Total Food Trace","v":"2.180","t":"+9.3%","d":"up"},{"l":"Recall Mgmt Ativos","v":"7.844","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"91.2%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"87","t":"+6.0%","d":"up"}];
const COLS = ["ID","Recall Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Trace #001","Food Trace #002","2.477","2.525","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Food Trace #002","Food Trace #003","6.319","3.576","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Trace #003","Food Trace #004","2.331","6.152","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Food Trace #004","Food Trace #005","4.070","7.555","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Trace #005","Food Trace #001","572","5.817","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":628},{"label":"Mar","value":331},{"label":"Abr","value":646},{"label":"Mai","value":661},{"label":"Jun","value":595},{"label":"Jul","value":397},{"label":"Ago","value":282},{"label":"Set","value":290},{"label":"Out","value":641},{"label":"Nov","value":505},{"label":"Dez","value":495}];
const MX = 661;
