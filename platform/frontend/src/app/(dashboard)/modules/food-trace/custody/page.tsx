...
const PAGE = "Chain of Custody";
const KPIS = [{"l":"Total Food Trace","v":"7.586","t":"+10.0%","d":"up"},{"l":"Chain Of Custody Ativos","v":"€84641","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"86.4%","t":"+12.8%","d":"up"},{"l":"Score Performance","v":"94","t":"+9.8%","d":"up"}];
const COLS = ["ID","Chain Of Custody","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Trace #001","€ 46747.47","362","4.726","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Food Trace #002","€ 2197.21","1.827","1.108","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Trace #003","€ 17782.35","3.381","8.258","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Food Trace #004","€ 38156.99","7.661","2.607","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Trace #005","€ 27035.35","1.421","8.775","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":739},{"label":"Mar","value":973},{"label":"Abr","value":738},{"label":"Mai","value":960},{"label":"Jun","value":943},{"label":"Jul","value":686},{"label":"Ago","value":941},{"label":"Set","value":839},{"label":"Out","value":925},{"label":"Nov","value":791},{"label":"Dez","value":972}];
const MX = 973;
