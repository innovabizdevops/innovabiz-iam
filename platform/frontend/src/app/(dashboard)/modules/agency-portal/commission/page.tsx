...
const ACCENT = "#0e7490";
const MODULE = "Agency Portal";
const PAGE = "Commission";
const KPIS = [{"l":"Vendas YTD (€)","v":"€21870","t":"+10.4%","d":"up"},{"l":"Pipeline (€)","v":"€4737","t":"+0.2%","d":"up"},{"l":"Atingimento Quota (%)","v":"73.9%","t":"+12.9%","d":"up"},{"l":"Win Rate (%)","v":"78.5%","t":"+14.4%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 25222.66","€ 8040.72","€ 36276.49","80.7%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 4500.46","€ 36594.22","€ 18290.93","95.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 23574.32","€ 18962.33","€ 25779.03","91.1%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 45607.48","€ 42243.75","€ 9509.65","92.7%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 31887.09","€ 36748.02","€ 47679.65","93.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":817},{"label":"Mar","value":728},{"label":"Abr","value":603},{"label":"Mai","value":700},{"label":"Jun","value":658},{"label":"Jul","value":567},{"label":"Ago","value":715},{"label":"Set","value":683},{"label":"Out","value":667},{"label":"Nov","value":796},{"label":"Dez","value":896}];
const MX = 896;
