...
const PAGE = "Agent Onboard";
const KPIS = [{"l":"eNPS","v":"58","t":"-4.7%","d":"down"},{"l":"Engagement (%)","v":"65.6%","t":"+0.3%","d":"up"},{"l":"Turnover (%)","v":"69.9%","t":"+3.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.261","t":"+6.9%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.078","2026-02-11","95","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.170","2026-02-16","88","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.009","2026-03-28","82","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.853","2026-01-26","56","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.537","2026-01-05","71","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":424},{"label":"Fev","value":544},{"label":"Mar","value":359},{"label":"Abr","value":463},{"label":"Mai","value":364},{"label":"Jun","value":625},{"label":"Jul","value":617},{"label":"Ago","value":596},{"label":"Set","value":250},{"label":"Out","value":644},{"label":"Nov","value":318},{"label":"Dez","value":250}];
const MX = 644;
