...
const PAGE = "OEE Dashboard";
const KPIS = [{"l":"Teams Ativos","v":"6.162","t":"+5.8%","d":"up"},{"l":"Reuniões/Semana","v":"3180","t":"+16.8%","d":"up"},{"l":"Mensagens/Dia","v":"4145","t":"+11.5%","d":"up"},{"l":"Ficheiros Partilhados","v":"4.287","t":"+9.0%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","6.777","3065","7.950","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","6.113","865","1.548","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","7.223","860","8.210","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","6.451","4816","2.606","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","3.303","3607","7.849","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":814},{"label":"Mar","value":863},{"label":"Abr","value":533},{"label":"Mai","value":726},{"label":"Jun","value":625},{"label":"Jul","value":697},{"label":"Ago","value":688},{"label":"Set","value":813},{"label":"Out","value":655},{"label":"Nov","value":695},{"label":"Dez","value":649}];
const MX = 863;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#78716c'}}>Chart</span></h1>
                </div>
