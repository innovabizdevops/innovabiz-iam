...
const KPIS = [{"l":"Total Manufacturing","v":"8.472","t":"-4.3%","d":"down"},{"l":"Shop Floor Control Ativos","v":"2.936","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"79.9%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"92","t":"-2.3%","d":"down"}];
const COLS = ["ID","Shop Floor Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Manufacturing #001","Manufacturing #002","342","8.459","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Manufacturing #002","Manufacturing #003","2.167","4.338","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Manufacturing #003","Manufacturing #004","1.138","3.824","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Manufacturing #004","Manufacturing #005","2.746","377","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Manufacturing #005","Manufacturing #001","315","5.507","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":731},{"label":"Mar","value":751},{"label":"Abr","value":696},{"label":"Mai","value":692},{"label":"Jun","value":798},{"label":"Jul","value":963},{"label":"Ago","value":837},{"label":"Set","value":630},{"label":"Out","value":600},{"label":"Nov","value":776},{"label":"Dez","value":948}];
const MX = 963;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#78716c'}}>IoT</span></h1>
                </div>
