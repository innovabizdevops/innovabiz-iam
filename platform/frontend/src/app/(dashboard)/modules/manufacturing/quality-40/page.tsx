...
const PAGE = "Quality 4.0 AI";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.215","t":"+0.5%","d":"up"},{"l":"NC Abertas","v":"2.620","t":"-2.6%","d":"down"},{"l":"Conformidade (%)","v":"74.1%","t":"+11.0%","d":"up"},{"l":"CAPAs Pendentes","v":"7.044","t":"+11.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.622","99.9%","5.027","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.914","74.4%","8.567","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.558","96.9%","7.735","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.661","82.7%","561","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.301","95.2%","5.732","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":372},{"label":"Fev","value":562},{"label":"Mar","value":566},{"label":"Abr","value":598},{"label":"Mai","value":414},{"label":"Jun","value":382},{"label":"Jul","value":361},{"label":"Ago","value":581},{"label":"Set","value":700},{"label":"Out","value":343},{"label":"Nov","value":374},{"label":"Dez","value":482}];
const MX = 700;
...
export default function Quality40Page() {
    return (
