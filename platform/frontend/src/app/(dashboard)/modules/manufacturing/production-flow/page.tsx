...
const PAGE = "Production Flow";
const KPIS = [{"l":"Total Manufacturing","v":"8.339","t":"-1.5%","d":"down"},{"l":"Production Flow Ativos","v":"4.073","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"94.7%","t":"+2.0%","d":"up"},{"l":"Score Performance","v":"82","t":"-0.5%","d":"down"}];
const COLS = ["ID","Production Flow","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Manufacturing #001","Manufacturing #002","8.199","5.865","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Manufacturing #002","Manufacturing #003","6.139","6.639","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Manufacturing #003","Manufacturing #004","8.506","4.720","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Manufacturing #004","Manufacturing #005","1.443","4.169","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Manufacturing #005","Manufacturing #001","3.847","2.357","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":564},{"label":"Mar","value":668},{"label":"Abr","value":886},{"label":"Mai","value":906},{"label":"Jun","value":949},{"label":"Jul","value":664},{"label":"Ago","value":651},{"label":"Set","value":872},{"label":"Out","value":853},{"label":"Nov","value":620},{"label":"Dez","value":657}];
const MX = 949;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#78716c'}}>MES</span></h1>
                </div>
