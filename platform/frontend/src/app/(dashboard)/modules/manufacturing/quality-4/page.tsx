...
const PAGE = "Quality 4.0";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.979","t":"-5.1%","d":"down"},{"l":"NC Abertas","v":"7.413","t":"+1.4%","d":"up"},{"l":"Conformidade (%)","v":"92.5%","t":"+9.9%","d":"up"},{"l":"CAPAs Pendentes","v":"7.152","t":"+10.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.314","93.1%","2.627","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.112","99.0%","7.829","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.461","74.1%","4.615","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.842","87.4%","1.789","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.468","90.6%","2.279","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":880},{"label":"Fev","value":816},{"label":"Mar","value":676},{"label":"Abr","value":577},{"label":"Mai","value":503},{"label":"Jun","value":738},{"label":"Jul","value":817},{"label":"Ago","value":654},{"label":"Set","value":886},{"label":"Out","value":860},{"label":"Nov","value":549},{"label":"Dez","value":557}];
const MX = 886;
...
export default function Quality4Page() {
    return (
