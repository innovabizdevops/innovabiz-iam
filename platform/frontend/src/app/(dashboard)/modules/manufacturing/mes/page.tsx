...
const PAGE = "MES Integration";
const KPIS = [{"l":"Integrações Ativas","v":"395","t":"+13.6%","d":"up"},{"l":"Chamadas/Hora","v":"1594","t":"+16.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"83.1%","t":"+14.6%","d":"up"},{"l":"Latência Média (ms)","v":"193ms","t":"+13.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.253","3.498","98.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.861","3.343","86.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.079","4.385","95.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.603","8.120","80.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.233","4.100","86.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1077},{"label":"Fev","value":921},{"label":"Mar","value":965},{"label":"Abr","value":924},{"label":"Mai","value":935},{"label":"Jun","value":744},{"label":"Jul","value":975},{"label":"Ago","value":697},{"label":"Set","value":897},{"label":"Out","value":737},{"label":"Nov","value":915},{"label":"Dez","value":821}];
const MX = 1077;
