...
const PAGE = "BOM Editor";
const KPIS = [{"l":"Integrações Ativas","v":"5.801","t":"+12.3%","d":"up"},{"l":"Chamadas/Hora","v":"2611","t":"+9.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"69.7%","t":"+1.7%","d":"up"},{"l":"Latência Média (ms)","v":"194ms","t":"+6.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.788","7.325","90.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.706","4.473","90.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.741","3.684","92.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.374","4.174","82.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.525","4.724","77.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":602},{"label":"Mar","value":725},{"label":"Abr","value":835},{"label":"Mai","value":846},{"label":"Jun","value":812},{"label":"Jul","value":792},{"label":"Ago","value":866},{"label":"Set","value":806},{"label":"Out","value":859},{"label":"Nov","value":754},{"label":"Dez","value":877}];
const MX = 877;
