...
const PAGE = "Prevention";
const KPIS = [{"l":"Integrações Ativas","v":"5.110","t":"+4.7%","d":"up"},{"l":"Chamadas/Hora","v":"835","t":"+10.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"81.7%","t":"+10.8%","d":"up"},{"l":"Latência Média (ms)","v":"55ms","t":"+13.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.692","8.896","96.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","539","1.555","72.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.020","8.890","83.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.546","4.231","76.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.826","321","84.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":619},{"label":"Mar","value":753},{"label":"Abr","value":700},{"label":"Mai","value":678},{"label":"Jun","value":586},{"label":"Jul","value":665},{"label":"Ago","value":905},{"label":"Set","value":809},{"label":"Out","value":665},{"label":"Nov","value":685},{"label":"Dez","value":648}];
const MX = 905;
