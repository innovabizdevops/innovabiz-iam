...
const PAGE = "Concussion";
const KPIS = [{"l":"Integrações Ativas","v":"3.782","t":"+16.7%","d":"up"},{"l":"Chamadas/Hora","v":"3135","t":"-3.8%","d":"down"},{"l":"Taxa Sucesso (%)","v":"67.2%","t":"+17.7%","d":"up"},{"l":"Latência Média (ms)","v":"52ms","t":"+1.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.375","5.679","89.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.643","3.401","93.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.627","2.341","80.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.533","244","100.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.161","3.636","94.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":965},{"label":"Fev","value":835},{"label":"Mar","value":642},{"label":"Abr","value":792},{"label":"Mai","value":990},{"label":"Jun","value":772},{"label":"Jul","value":658},{"label":"Ago","value":709},{"label":"Set","value":928},{"label":"Out","value":714},{"label":"Nov","value":1022},{"label":"Dez","value":693}];
const MX = 1022;
