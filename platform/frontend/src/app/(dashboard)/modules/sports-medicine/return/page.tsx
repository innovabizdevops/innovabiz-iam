...
const ACCENT = "#6366f1";
const MODULE = "Sports Medicine";
const PAGE = "Return Play";
const KPIS = [{"l":"Integrações Ativas","v":"1.744","t":"+9.7%","d":"up"},{"l":"Chamadas/Hora","v":"1746","t":"+15.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"85.2%","t":"+13.4%","d":"up"},{"l":"Latência Média (ms)","v":"159ms","t":"+15.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.238","6.882","82.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.415","2.684","93.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","321","2.664","96.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.334","8.355","92.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.050","3.863","82.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":465},{"label":"Fev","value":286},{"label":"Mar","value":311},{"label":"Abr","value":348},{"label":"Mai","value":477},{"label":"Jun","value":336},{"label":"Jul","value":324},{"label":"Ago","value":599},{"label":"Set","value":543},{"label":"Out","value":259},{"label":"Nov","value":545},{"label":"Dez","value":408}];
const MX = 599;
