...
const PAGE = "Rehab";
const KPIS = [{"l":"Integrações Ativas","v":"403","t":"+15.1%","d":"up"},{"l":"Chamadas/Hora","v":"825","t":"+3.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"92.3%","t":"+1.8%","d":"up"},{"l":"Latência Média (ms)","v":"71ms","t":"+7.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.889","8.719","88.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.232","1.374","78.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.891","8.125","89.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.889","3.012","77.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.480","3.495","83.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":523},{"label":"Mar","value":719},{"label":"Abr","value":488},{"label":"Mai","value":501},{"label":"Jun","value":518},{"label":"Jul","value":617},{"label":"Ago","value":678},{"label":"Set","value":524},{"label":"Out","value":453},{"label":"Nov","value":724},{"label":"Dez","value":715}];
const MX = 724;
