...
const PAGE = "Injury";
const KPIS = [{"l":"Integrações Ativas","v":"3.693","t":"+10.7%","d":"up"},{"l":"Chamadas/Hora","v":"4187","t":"+6.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"84.5%","t":"+0.9%","d":"up"},{"l":"Latência Média (ms)","v":"68ms","t":"+13.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.383","1.050","98.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.715","6.042","92.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.212","6.762","97.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.378","3.288","91.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.284","4.887","99.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":383},{"label":"Mar","value":527},{"label":"Abr","value":555},{"label":"Mai","value":587},{"label":"Jun","value":542},{"label":"Jul","value":340},{"label":"Ago","value":561},{"label":"Set","value":562},{"label":"Out","value":424},{"label":"Nov","value":389},{"label":"Dez","value":429}];
const MX = 587;
