...
const PAGE = "Visit Plan";
const KPIS = [{"l":"Total Home Care","v":"8.976","t":"+2.1%","d":"up"},{"l":"Visit Plan Ativos","v":"6.675","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"92.5%","t":"+10.4%","d":"up"},{"l":"Score Performance","v":"62","t":"+15.7%","d":"up"}];
const COLS = ["ID","Visit Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Home Care #001","Home Care #002","6.782","4.721","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Home Care #002","Home Care #003","1.657","8.502","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Home Care #003","Home Care #004","2.539","5.914","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Home Care #004","Home Care #005","4.455","6.320","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Home Care #005","Home Care #001","7.297","6.359","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":939},{"label":"Fev","value":586},{"label":"Mar","value":698},{"label":"Abr","value":879},{"label":"Mai","value":815},{"label":"Jun","value":759},{"label":"Jul","value":887},{"label":"Ago","value":895},{"label":"Set","value":564},{"label":"Out","value":652},{"label":"Nov","value":744},{"label":"Dez","value":875}];
const MX = 939;
