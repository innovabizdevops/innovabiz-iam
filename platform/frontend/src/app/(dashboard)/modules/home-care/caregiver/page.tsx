...
const PAGE = "Caregiver";
const KPIS = [{"l":"Total Home Care","v":"3.605","t":"-2.1%","d":"down"},{"l":"Caregiver Ativos","v":"3.647","t":"+17.7%","d":"up"},{"l":"Eficiência (%)","v":"78.3%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"72","t":"-0.4%","d":"down"}];
const COLS = ["ID","Caregiver","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Home Care #001","Home Care #002","3.999","8.625","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Home Care #002","Home Care #003","405","2.198","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Home Care #003","Home Care #004","5.396","2.698","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Home Care #004","Home Care #005","4.897","2.749","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Home Care #005","Home Care #001","4.548","5.455","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":813},{"label":"Mar","value":757},{"label":"Abr","value":876},{"label":"Mai","value":781},{"label":"Jun","value":668},{"label":"Jul","value":908},{"label":"Ago","value":818},{"label":"Set","value":611},{"label":"Out","value":753},{"label":"Nov","value":668},{"label":"Dez","value":693}];
const MX = 908;
