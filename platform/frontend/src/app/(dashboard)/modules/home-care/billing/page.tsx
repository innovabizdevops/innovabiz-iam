...
const PAGE = "Billing";
const KPIS = [{"l":"Total Home Care","v":"4.951","t":"+1.8%","d":"up"},{"l":"Billing Ativos","v":"4.683","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"77.2%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"68","t":"-1.8%","d":"down"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Home Care #001","Home Care #002","2.339","1.054","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Home Care #002","Home Care #003","525","287","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Home Care #003","Home Care #004","6.747","2.910","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Home Care #004","Home Care #005","8.439","216","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Home Care #005","Home Care #001","1.503","5.483","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":596},{"label":"Mar","value":780},{"label":"Abr","value":508},{"label":"Mai","value":783},{"label":"Jun","value":601},{"label":"Jul","value":462},{"label":"Ago","value":551},{"label":"Set","value":544},{"label":"Out","value":609},{"label":"Nov","value":434},{"label":"Dez","value":631}];
const MX = 783;
