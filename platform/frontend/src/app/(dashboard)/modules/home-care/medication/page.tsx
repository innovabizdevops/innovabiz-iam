...
const KPIS = [{"l":"Integrações Ativas","v":"7.378","t":"-4.5%","d":"down"},{"l":"Chamadas/Hora","v":"3163","t":"+13.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"92.0%","t":"+14.2%","d":"up"},{"l":"Latência Média (ms)","v":"193ms","t":"+4.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.310","134","83.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.155","6.516","70.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.769","411","93.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.944","1.156","99.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.500","6.282","89.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":565},{"label":"Fev","value":703},{"label":"Mar","value":612},{"label":"Abr","value":858},{"label":"Mai","value":798},{"label":"Jun","value":704},{"label":"Jul","value":504},{"label":"Ago","value":695},{"label":"Set","value":890},{"label":"Out","value":527},{"label":"Nov","value":554},{"label":"Dez","value":694}];
const MX = 890;
