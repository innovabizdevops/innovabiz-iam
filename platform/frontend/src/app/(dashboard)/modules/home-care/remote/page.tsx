...
const ACCENT = "#6366f1";
const MODULE = "Home Care";
const PAGE = "Remote Mon";
const KPIS = [{"l":"Total Home Care","v":"5.165","t":"+9.7%","d":"up"},{"l":"Remote Mon Ativos","v":"1.350","t":"+15.3%","d":"up"},{"l":"Eficiência (%)","v":"70.4%","t":"-4.4%","d":"down"},{"l":"Score Performance","v":"75","t":"+3.7%","d":"up"}];
const COLS = ["ID","Remote Mon","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Home Care #001","Home Care #002","6.161","1.428","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Home Care #002","Home Care #003","5.071","4.187","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Home Care #003","Home Care #004","5.088","3.859","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Home Care #004","Home Care #005","7.590","1.540","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Home Care #005","Home Care #001","3.216","3.511","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":866},{"label":"Mar","value":831},{"label":"Abr","value":552},{"label":"Mai","value":824},{"label":"Jun","value":517},{"label":"Jul","value":846},{"label":"Ago","value":882},{"label":"Set","value":814},{"label":"Out","value":690},{"label":"Nov","value":860},{"label":"Dez","value":848}];
const MX = 882;
