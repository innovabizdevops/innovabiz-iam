...
const PAGE = "OSHA";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.498","t":"+9.7%","d":"up"},{"l":"NC Abertas","v":"4.096","t":"-1.6%","d":"down"},{"l":"Conformidade (%)","v":"85.5%","t":"+12.8%","d":"up"},{"l":"CAPAs Pendentes","v":"6.181","t":"-2.1%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.901","73.3%","5.439","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.805","88.5%","1.231","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.898","92.9%","2.683","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.154","97.8%","850","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.782","94.6%","7.314","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":749},{"label":"Mar","value":860},{"label":"Abr","value":920},{"label":"Mai","value":760},{"label":"Jun","value":765},{"label":"Jul","value":698},{"label":"Ago","value":745},{"label":"Set","value":856},{"label":"Out","value":591},{"label":"Nov","value":802},{"label":"Dez","value":882}];
const MX = 920;
