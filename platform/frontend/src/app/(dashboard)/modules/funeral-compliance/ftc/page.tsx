...
const PAGE = "FTC";
const KPIS = [{"l":"Auditorias Realizadas","v":"967","t":"+8.5%","d":"up"},{"l":"NC Abertas","v":"7.666","t":"-0.7%","d":"down"},{"l":"Conformidade (%)","v":"68.3%","t":"+3.1%","d":"up"},{"l":"CAPAs Pendentes","v":"8.878","t":"+14.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.329","71.1%","3.942","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.628","87.1%","3.575","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.732","89.3%","174","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.150","74.5%","4.708","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.741","95.8%","5.920","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1093},{"label":"Fev","value":841},{"label":"Mar","value":973},{"label":"Abr","value":965},{"label":"Mai","value":1052},{"label":"Jun","value":1026},{"label":"Jul","value":759},{"label":"Ago","value":1058},{"label":"Set","value":935},{"label":"Out","value":1015},{"label":"Nov","value":718},{"label":"Dez","value":1010}];
const MX = 1093;
