...
/* ═══ Funeral Compliance — Dashboard ═══ */

const ACCENT = "#334155";

const KPIS = [
    { label: "Total Registos", value: "1224", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1386", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€123K", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "421968824", cells: ["FUN-4824", "Funeral Compliance Item 1", "5/9/2026", "€18 924"], status: "active" as const },
    { id: "421972395", cells: ["FUN-8395", "Funeral Compliance Item 2", "20/4/2026", "€22 495"], status: "pending" as const },
    { id: "421975966", cells: ["FUN-2966", "Funeral Compliance Item 3", "7/11/2026", "€26 066"], status: "completed" as const },
    { id: "421979537", cells: ["FUN-6537", "Funeral Compliance Item 4", "22/6/2026", "€29 637"], status: "warning" as const },
    { id: "421983108", cells: ["FUN-1108", "Funeral Compliance Item 5", "9/1/2026", "€33 208"], status: "active" as const },
];
...
export default function FuneralCompliancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Funeral Compliance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Funeral Compliance</p>
                    </div>
                </div>
