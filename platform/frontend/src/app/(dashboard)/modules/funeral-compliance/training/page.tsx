...
const PAGE = "Training";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.552","t":"-0.3%","d":"down"},{"l":"NC Abertas","v":"3.055","t":"+3.8%","d":"up"},{"l":"Conformidade (%)","v":"83.1%","t":"+3.2%","d":"up"},{"l":"CAPAs Pendentes","v":"8.886","t":"+17.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.757","77.0%","5.759","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.599","98.3%","7.569","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.964","97.8%","1.659","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.318","71.2%","785","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","748","95.8%","7.469","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":813},{"label":"Mar","value":743},{"label":"Abr","value":649},{"label":"Mai","value":541},{"label":"Jun","value":489},{"label":"Jul","value":597},{"label":"Ago","value":686},{"label":"Set","value":547},{"label":"Out","value":614},{"label":"Nov","value":757},{"label":"Dez","value":448}];
const MX = 813;
