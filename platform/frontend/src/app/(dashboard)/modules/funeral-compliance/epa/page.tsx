...
const ACCENT = "#334155";
const MODULE = "Funeral Compliance";
const PAGE = "EPA";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.932","t":"+3.2%","d":"up"},{"l":"NC Abertas","v":"1.063","t":"+1.3%","d":"up"},{"l":"Conformidade (%)","v":"69.6%","t":"+15.0%","d":"up"},{"l":"CAPAs Pendentes","v":"473","t":"+1.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.504","98.2%","6.288","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.676","86.8%","2.619","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.316","82.5%","2.158","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.306","73.3%","7.394","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.250","85.1%","1.805","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1033},{"label":"Fev","value":1053},{"label":"Mar","value":1052},{"label":"Abr","value":925},{"label":"Mai","value":1066},{"label":"Jun","value":1053},{"label":"Jul","value":700},{"label":"Ago","value":842},{"label":"Set","value":959},{"label":"Out","value":821},{"label":"Nov","value":1044},{"label":"Dez","value":688}];
const MX = 1066;
