...
const KPIS = [
    { label: "Total Registos", value: "8587", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2596", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€274K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "-20%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1965148587", cells: ["PHA-8587", "Pharma Manufacturing Item 1", "4/4/2026", "€48 687"], status: "active" as const },
    { id: "1965152158", cells: ["PHA-3158", "Pharma Manufacturing Item 2", "19/11/2026", "€2258"], status: "pending" as const },
    { id: "1965155729", cells: ["PHA-6729", "Pharma Manufacturing Item 3", "6/6/2026", "€5829"], status: "completed" as const },
    { id: "1965159300", cells: ["PHA-1300", "Pharma Manufacturing Item 4", "21/1/2026", "€9400"], status: "warning" as const },
    { id: "1965162871", cells: ["PHA-4871", "Pharma Manufacturing Item 5", "8/8/2026", "€12 971"], status: "active" as const },
];
