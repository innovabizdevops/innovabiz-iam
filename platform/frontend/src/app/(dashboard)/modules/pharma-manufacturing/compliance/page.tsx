...
const KPIS = [{"l":"Auditorias Realizadas","v":"8.735","t":"+12.5%","d":"up"},{"l":"NC Abertas","v":"8.236","t":"+1.1%","d":"up"},{"l":"Conformidade (%)","v":"86.2%","t":"+9.0%","d":"up"},{"l":"CAPAs Pendentes","v":"6.121","t":"-5.5%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.320","86.3%","5.371","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.485","80.9%","4.268","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","345","87.9%","8.805","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.073","91.3%","2.120","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.141","81.1%","6.975","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":366},{"label":"Fev","value":360},{"label":"Mar","value":472},{"label":"Abr","value":289},{"label":"Mai","value":467},{"label":"Jun","value":636},{"label":"Jul","value":461},{"label":"Ago","value":657},{"label":"Set","value":420},{"label":"Out","value":624},{"label":"Nov","value":602},{"label":"Dez","value":407}];
const MX = 657;
