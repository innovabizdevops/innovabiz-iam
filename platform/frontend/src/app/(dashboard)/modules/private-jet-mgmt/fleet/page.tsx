...
const PAGE = "Fleet";
const KPIS = [{"l":"Total Private Jet Mgmt","v":"7.681","t":"+9.7%","d":"up"},{"l":"Fleet Ativos","v":"2.158","t":"+5.3%","d":"up"},{"l":"Eficiência (%)","v":"92.5%","t":"+10.6%","d":"up"},{"l":"Score Performance","v":"89","t":"+17.7%","d":"up"}];
const COLS = ["ID","Fleet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Private Jet Mgmt #001","Private Jet Mgmt #002","2.459","3.170","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Private Jet Mgmt #002","Private Jet Mgmt #003","8.463","4.097","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Private Jet Mgmt #003","Private Jet Mgmt #004","4.654","7.956","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Private Jet Mgmt #004","Private Jet Mgmt #005","1.030","3.781","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Private Jet Mgmt #005","Private Jet Mgmt #001","2.198","7.458","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":302},{"label":"Mar","value":388},{"label":"Abr","value":330},{"label":"Mai","value":382},{"label":"Jun","value":555},{"label":"Jul","value":555},{"label":"Ago","value":508},{"label":"Set","value":367},{"label":"Out","value":445},{"label":"Nov","value":684},{"label":"Dez","value":543}];
const MX = 684;
