...
/* ═══ Private Jet Mgmt — Dashboard ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total Registos", value: "4734", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2089", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€420K", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1220159834", cells: ["PRI-3834", "Private Jet Mgmt Item 1", "27/3/2026", "€9934"], status: "active" as const },
    { id: "1220163405", cells: ["PRI-7405", "Private Jet Mgmt Item 2", "14/10/2026", "€13 505"], status: "pending" as const },
    { id: "1220166976", cells: ["PRI-1976", "Private Jet Mgmt Item 3", "1/5/2026", "€17 076"], status: "completed" as const },
    { id: "1220170547", cells: ["PRI-5547", "Private Jet Mgmt Item 4", "16/12/2026", "€20 647"], status: "warning" as const },
    { id: "1220174118", cells: ["PRI-9118", "Private Jet Mgmt Item 5", "3/7/2026", "€24 218"], status: "active" as const },
];
...
export default function PrivateJetMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Private Jet Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Private Jet Mgmt</p>
                    </div>
                </div>
