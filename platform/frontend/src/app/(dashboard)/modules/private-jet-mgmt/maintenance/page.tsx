...
const ACCENT = "#b45309";
const MODULE = "Private Jet Mgmt";
const PAGE = "Maintenance";
const KPIS = [{"l":"Total Private Jet Mgmt","v":"8.028","t":"+6.6%","d":"up"},{"l":"Maintenance Ativos","v":"6.593","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"75.7%","t":"+1.4%","d":"up"},{"l":"Score Performance","v":"63","t":"-1.3%","d":"down"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Private Jet Mgmt #001","Private Jet Mgmt #002","2.440","3.833","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Private Jet Mgmt #002","Private Jet Mgmt #003","7.355","6.991","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Private Jet Mgmt #003","Private Jet Mgmt #004","1.974","2.087","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Private Jet Mgmt #004","Private Jet Mgmt #005","3.478","3.547","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Private Jet Mgmt #005","Private Jet Mgmt #001","1.361","2.406","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":734},{"label":"Mar","value":958},{"label":"Abr","value":872},{"label":"Mai","value":747},{"label":"Jun","value":871},{"label":"Jul","value":721},{"label":"Ago","value":876},{"label":"Set","value":794},{"label":"Out","value":699},{"label":"Nov","value":743},{"label":"Dez","value":990}];
const MX = 990;
