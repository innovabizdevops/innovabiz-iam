...
const PAGE = "Charter";
const KPIS = [{"l":"Total Private Jet Mgmt","v":"6.599","t":"+10.0%","d":"up"},{"l":"Charter Ativos","v":"8.383","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"83","t":"+12.5%","d":"up"}];
const COLS = ["ID","Charter","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Private Jet Mgmt #001","Private Jet Mgmt #002","1.113","2.676","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Private Jet Mgmt #002","Private Jet Mgmt #003","1.125","2.163","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Private Jet Mgmt #003","Private Jet Mgmt #004","6.515","8.449","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Private Jet Mgmt #004","Private Jet Mgmt #005","1.122","7.230","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Private Jet Mgmt #005","Private Jet Mgmt #001","3.725","7.286","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":406},{"label":"Mar","value":567},{"label":"Abr","value":273},{"label":"Mai","value":266},{"label":"Jun","value":589},{"label":"Jul","value":352},{"label":"Ago","value":433},{"label":"Set","value":350},{"label":"Out","value":429},{"label":"Nov","value":402},{"label":"Dez","value":597}];
const MX = 597;
