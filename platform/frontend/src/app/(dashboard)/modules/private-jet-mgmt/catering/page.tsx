...
const PAGE = "Catering";
const KPIS = [{"l":"Total Private Jet Mgmt","v":"8.868","t":"+0.3%","d":"up"},{"l":"Catering Ativos","v":"4.480","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"73.8%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"86","t":"+12.7%","d":"up"}];
const COLS = ["ID","Catering","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Private Jet Mgmt #001","Private Jet Mgmt #002","1.813","8.011","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Private Jet Mgmt #002","Private Jet Mgmt #003","7.412","3.982","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Private Jet Mgmt #003","Private Jet Mgmt #004","615","1.044","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Private Jet Mgmt #004","Private Jet Mgmt #005","5.801","3.126","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Private Jet Mgmt #005","Private Jet Mgmt #001","6.831","4.610","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":822},{"label":"Mar","value":826},{"label":"Abr","value":1041},{"label":"Mai","value":986},{"label":"Jun","value":996},{"label":"Jul","value":987},{"label":"Ago","value":820},{"label":"Set","value":790},{"label":"Out","value":668},{"label":"Nov","value":978},{"label":"Dez","value":789}];
const MX = 1041;
