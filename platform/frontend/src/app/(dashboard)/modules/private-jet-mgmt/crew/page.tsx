...
const PAGE = "Crew";
const KPIS = [{"l":"Total Private Jet Mgmt","v":"6.414","t":"+16.5%","d":"up"},{"l":"Crew Ativos","v":"8.500","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"81.9%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"74","t":"+6.7%","d":"up"}];
const COLS = ["ID","Crew","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Private Jet Mgmt #001","Private Jet Mgmt #002","3.349","2.517","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Private Jet Mgmt #002","Private Jet Mgmt #003","2.552","2.713","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Private Jet Mgmt #003","Private Jet Mgmt #004","8.795","8.093","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Private Jet Mgmt #004","Private Jet Mgmt #005","4.551","7.588","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Private Jet Mgmt #005","Private Jet Mgmt #001","1.698","7.398","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":670},{"label":"Mar","value":852},{"label":"Abr","value":574},{"label":"Mai","value":868},{"label":"Jun","value":590},{"label":"Jul","value":592},{"label":"Ago","value":651},{"label":"Set","value":809},{"label":"Out","value":626},{"label":"Nov","value":676},{"label":"Dez","value":818}];
const MX = 868;
