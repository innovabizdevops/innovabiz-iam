...
const PAGE = "Virtual Tour";
const KPIS = [{"l":"Total Proptech Deep","v":"4.673","t":"+5.2%","d":"up"},{"l":"Virtual Tour Ativos","v":"8.064","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"79.2%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"81","t":"+10.0%","d":"up"}];
const COLS = ["ID","Virtual Tour","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Proptech Deep #001","Proptech Deep #002","5.833","4.648","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Proptech Deep #002","Proptech Deep #003","2.952","4.956","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Proptech Deep #003","Proptech Deep #004","432","1.660","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Proptech Deep #004","Proptech Deep #005","6.392","8.909","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Proptech Deep #005","Proptech Deep #001","2.675","1.740","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":330},{"label":"Fev","value":641},{"label":"Mar","value":424},{"label":"Abr","value":452},{"label":"Mai","value":352},{"label":"Jun","value":395},{"label":"Jul","value":329},{"label":"Ago","value":453},{"label":"Set","value":399},{"label":"Out","value":484},{"label":"Nov","value":424},{"label":"Dez","value":473}];
const MX = 641;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0ea5e9'}}>XR</span></h1>
                </div>
