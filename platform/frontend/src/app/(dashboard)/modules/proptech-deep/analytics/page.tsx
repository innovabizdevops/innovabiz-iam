...
const ACCENT = "#0ea5e9";
const MODULE = "PropTech Platform Deep";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"7.409","t":"+3.3%","d":"up"},{"l":"Queries/Dia","v":"837","t":"+3.6%","d":"up"},{"l":"Dados Processados (GB)","v":"6.091","t":"+8.3%","d":"up"},{"l":"Utilizadores Analytics","v":"7.701","t":"+0.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2288","2026-03-19","3.839","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4586","2026-03-17","2.731","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4757","2026-03-20","5.852","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3417","2026-03-17","1.443","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4165","2026-01-24","227","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":411},{"label":"Fev","value":600},{"label":"Mar","value":381},{"label":"Abr","value":474},{"label":"Mai","value":407},{"label":"Jun","value":381},{"label":"Jul","value":458},{"label":"Ago","value":331},{"label":"Set","value":462},{"label":"Out","value":338},{"label":"Nov","value":646},{"label":"Dez","value":325}];
const MX = 646;
