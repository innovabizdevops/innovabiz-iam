...
/* ═══ PropTech Platform Deep — Dashboard ═══ */

const ACCENT = "#0ea5e9";

const KPIS = [
    { label: "Total Registos", value: "8627", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4066", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€225K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "889602727", cells: ["PRO-7727", "PropTech Platform Deep Item 1", "28/8/2026", "€2827"], status: "active" as const },
    { id: "889606298", cells: ["PRO-2298", "PropTech Platform Deep Item 2", "15/3/2026", "€6398"], status: "pending" as const },
    { id: "889609869", cells: ["PRO-5869", "PropTech Platform Deep Item 3", "2/10/2026", "€9969"], status: "completed" as const },
    { id: "889613440", cells: ["PRO-9440", "PropTech Platform Deep Item 4", "17/5/2026", "€13 540"], status: "warning" as const },
    { id: "889617011", cells: ["PRO-4011", "PropTech Platform Deep Item 5", "4/12/2026", "€17 111"], status: "active" as const },
];
...
export default function ProptechPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">PropTech Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • PropTech Platform Deep</p>
                    </div>
                </div>
