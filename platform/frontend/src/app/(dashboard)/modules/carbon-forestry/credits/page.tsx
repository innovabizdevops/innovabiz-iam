...
const PAGE = "Credits";
const KPIS = [{"l":"Integrações Ativas","v":"8.128","t":"-1.7%","d":"down"},{"l":"Chamadas/Hora","v":"1012","t":"-1.3%","d":"down"},{"l":"Taxa Sucesso (%)","v":"82.9%","t":"+0.2%","d":"up"},{"l":"Latência Média (ms)","v":"168ms","t":"+17.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.563","4.291","75.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","276","5.852","75.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.551","7.741","83.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.794","6.347","72.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.573","7.184","72.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":824},{"label":"Mar","value":1039},{"label":"Abr","value":911},{"label":"Mai","value":725},{"label":"Jun","value":885},{"label":"Jul","value":939},{"label":"Ago","value":746},{"label":"Set","value":851},{"label":"Out","value":713},{"label":"Nov","value":1037},{"label":"Dez","value":955}];
const MX = 1039;
