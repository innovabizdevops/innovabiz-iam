...
const PAGE = "Sample";
const KPIS = [{"l":"Fornecedores Ativos","v":"235","t":"-3.2%","d":"down"},{"l":"Contratos (€M)","v":"€41.5M","t":"-0.6%","d":"down"},{"l":"On-Time Delivery (%)","v":"72.6%","t":"+16.2%","d":"up"},{"l":"Score Médio","v":"93","t":"+7.6%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","89.7%","€ 16609.61","7.218","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","87.1%","€ 46837.12","5.462","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","76.8%","€ 14856.09","2.444","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","96.1%","€ 13716.70","2.969","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","86.6%","€ 16302.17","6.573","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":755},{"label":"Mar","value":485},{"label":"Abr","value":758},{"label":"Mai","value":737},{"label":"Jun","value":472},{"label":"Jul","value":742},{"label":"Ago","value":591},{"label":"Set","value":645},{"label":"Out","value":679},{"label":"Nov","value":730},{"label":"Dez","value":695}];
const MX = 758;
