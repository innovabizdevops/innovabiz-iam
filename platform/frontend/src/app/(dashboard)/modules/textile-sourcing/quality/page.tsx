...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.574","t":"+12.0%","d":"up"},{"l":"NC Abertas","v":"6.102","t":"-4.9%","d":"down"},{"l":"Conformidade (%)","v":"84.9%","t":"-0.4%","d":"down"},{"l":"CAPAs Pendentes","v":"6.618","t":"+9.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.192","86.9%","3.709","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.806","81.1%","7.369","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.484","85.9%","8.410","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.045","86.8%","1.975","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.233","92.1%","7.374","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":995},{"label":"Fev","value":705},{"label":"Mar","value":1002},{"label":"Abr","value":877},{"label":"Mai","value":832},{"label":"Jun","value":801},{"label":"Jul","value":1086},{"label":"Ago","value":798},{"label":"Set","value":1044},{"label":"Out","value":873},{"label":"Nov","value":700},{"label":"Dez","value":973}];
const MX = 1086;
