...
const PAGE = "Supplier";
const KPIS = [{"l":"Fornecedores Ativos","v":"4.578","t":"+16.0%","d":"up"},{"l":"Contratos (€M)","v":"€43.5M","t":"+7.0%","d":"up"},{"l":"On-Time Delivery (%)","v":"90.3%","t":"+7.8%","d":"up"},{"l":"Score Médio","v":"72","t":"+16.0%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","84.3%","€ 48500.55","3.664","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","98.9%","€ 18430.25","7.523","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","72.4%","€ 12974.02","622","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","74.9%","€ 11230.31","4.640","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","96.1%","€ 19343.64","1.180","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":844},{"label":"Fev","value":529},{"label":"Mar","value":658},{"label":"Abr","value":629},{"label":"Mai","value":785},{"label":"Jun","value":583},{"label":"Jul","value":712},{"label":"Ago","value":820},{"label":"Set","value":566},{"label":"Out","value":823},{"label":"Nov","value":669},{"label":"Dez","value":579}];
const MX = 844;
