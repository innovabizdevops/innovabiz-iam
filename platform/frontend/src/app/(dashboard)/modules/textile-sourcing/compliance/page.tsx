...
const KPIS = [{"l":"Auditorias Realizadas","v":"3.894","t":"+6.5%","d":"up"},{"l":"NC Abertas","v":"7.056","t":"+1.1%","d":"up"},{"l":"Conformidade (%)","v":"82.3%","t":"-0.6%","d":"down"},{"l":"CAPAs Pendentes","v":"2.737","t":"-6.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.471","93.4%","7.949","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.967","77.0%","8.870","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.157","95.3%","1.835","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.322","96.0%","6.262","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.316","77.2%","6.859","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":691},{"label":"Mar","value":954},{"label":"Abr","value":760},{"label":"Mai","value":1067},{"label":"Jun","value":805},{"label":"Jul","value":743},{"label":"Ago","value":789},{"label":"Set","value":841},{"label":"Out","value":833},{"label":"Nov","value":697},{"label":"Dez","value":971}];
const MX = 1067;
