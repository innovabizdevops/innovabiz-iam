...
const ACCENT = "#6366f1";
const MODULE = "Textile Sourcing";
const PAGE = "Negotiate";
const KPIS = [{"l":"Fornecedores Ativos","v":"6.931","t":"+11.9%","d":"up"},{"l":"Contratos (€M)","v":"€38.4M","t":"-5.4%","d":"down"},{"l":"On-Time Delivery (%)","v":"67.4%","t":"+14.2%","d":"up"},{"l":"Score Médio","v":"81","t":"+10.0%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","86.3%","€ 43499.05","1.588","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","84.9%","€ 16836.64","3.870","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","97.4%","€ 1803.03","1.319","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","87.6%","€ 930.96","6.791","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","71.3%","€ 41512.05","8.316","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":437},{"label":"Mar","value":685},{"label":"Abr","value":634},{"label":"Mai","value":751},{"label":"Jun","value":461},{"label":"Jul","value":704},{"label":"Ago","value":432},{"label":"Set","value":751},{"label":"Out","value":669},{"label":"Nov","value":749},{"label":"Dez","value":641}];
const MX = 751;
