...
export default function TextileSourcingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Textile Sourcing</h1><p className="text-sm text-muted-foreground">Textile Sourcing • iBOS Enterprise</p></div>
