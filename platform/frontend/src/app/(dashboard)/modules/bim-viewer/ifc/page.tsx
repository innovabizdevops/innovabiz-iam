...
const PAGE = "IFC Import";
const KPIS = [{"l":"Total Bim Viewer","v":"8.111","t":"+13.3%","d":"up"},{"l":"IFC Import Ativos","v":"3.568","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"72.5%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"80","t":"-3.5%","d":"down"}];
const COLS = ["ID","IFC Import","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bim Viewer #001","Bim Viewer #002","7.872","1.952","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Bim Viewer #002","Bim Viewer #003","4.713","8.024","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Bim Viewer #003","Bim Viewer #004","330","3.661","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Bim Viewer #004","Bim Viewer #005","546","2.932","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bim Viewer #005","Bim Viewer #001","5.262","6.556","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":656},{"label":"Mar","value":718},{"label":"Abr","value":755},{"label":"Mai","value":749},{"label":"Jun","value":667},{"label":"Jul","value":606},{"label":"Ago","value":430},{"label":"Set","value":490},{"label":"Out","value":597},{"label":"Nov","value":559},{"label":"Dez","value":746}];
const MX = 755;
