...
const PAGE = "3D Navigator";
const KPIS = [{"l":"Total Bim Viewer","v":"1.888","t":"+0.5%","d":"up"},{"l":"3D Navigator Ativos","v":"7.898","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"+3.3%","d":"up"},{"l":"Score Performance","v":"82","t":"-5.5%","d":"down"}];
const COLS = ["ID","3D Navigator","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bim Viewer #001","Bim Viewer #002","1.681","7.324","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Bim Viewer #002","Bim Viewer #003","1.970","5.648","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Bim Viewer #003","Bim Viewer #004","3.694","5.764","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Bim Viewer #004","Bim Viewer #005","7.683","8.174","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bim Viewer #005","Bim Viewer #001","4.836","6.490","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":768},{"label":"Mar","value":793},{"label":"Abr","value":819},{"label":"Mai","value":633},{"label":"Jun","value":687},{"label":"Jul","value":498},{"label":"Ago","value":565},{"label":"Set","value":706},{"label":"Out","value":439},{"label":"Nov","value":613},{"label":"Dez","value":678}];
const MX = 819;
