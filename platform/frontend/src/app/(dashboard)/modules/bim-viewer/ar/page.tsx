...
const PAGE = "AR Overlay";
const KPIS = [{"l":"Total Bim Viewer","v":"4.002","t":"+4.9%","d":"up"},{"l":"AR Overlay Ativos","v":"4.737","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"84.5%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"85","t":"+12.8%","d":"up"}];
const COLS = ["ID","AR Overlay","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bim Viewer #001","Bim Viewer #002","5.101","1.034","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Bim Viewer #002","Bim Viewer #003","2.199","2.078","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Bim Viewer #003","Bim Viewer #004","2.712","3.096","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Bim Viewer #004","Bim Viewer #005","1.570","8.645","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bim Viewer #005","Bim Viewer #001","6.590","7.911","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":914},{"label":"Mar","value":710},{"label":"Abr","value":653},{"label":"Mai","value":781},{"label":"Jun","value":759},{"label":"Jul","value":667},{"label":"Ago","value":806},{"label":"Set","value":523},{"label":"Out","value":728},{"label":"Nov","value":857},{"label":"Dez","value":540}];
const MX = 914;
