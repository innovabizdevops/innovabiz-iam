...
const ACCENT = "#0e7490";
const MODULE = "BIM Viewer";
const PAGE = "Progress Photo AI";
const KPIS = [{"l":"Total Bim Viewer","v":"8.611","t":"+2.0%","d":"up"},{"l":"Progress Photo AI Ativos","v":"8.329","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"93.3%","t":"+10.6%","d":"up"},{"l":"Score Performance","v":"83","t":"+0.2%","d":"up"}];
const COLS = ["ID","Progress Photo AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bim Viewer #001","Bim Viewer #002","8.280","1.666","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Bim Viewer #002","Bim Viewer #003","357","8.064","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Bim Viewer #003","Bim Viewer #004","8.558","6.345","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Bim Viewer #004","Bim Viewer #005","1.244","6.711","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bim Viewer #005","Bim Viewer #001","5.952","5.341","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":695},{"label":"Mar","value":847},{"label":"Abr","value":753},{"label":"Mai","value":845},{"label":"Jun","value":817},{"label":"Jul","value":858},{"label":"Ago","value":709},{"label":"Set","value":714},{"label":"Out","value":1062},{"label":"Nov","value":1039},{"label":"Dez","value":1015}];
const MX = 1062;
