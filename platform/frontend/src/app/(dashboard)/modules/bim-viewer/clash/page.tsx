...
const PAGE = "Clash Detect";
const KPIS = [{"l":"Total Bim Viewer","v":"2.785","t":"-1.3%","d":"down"},{"l":"Clash Detect Ativos","v":"3.676","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"77.2%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"68","t":"+13.4%","d":"up"}];
const COLS = ["ID","Clash Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bim Viewer #001","Bim Viewer #002","416","137","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Bim Viewer #002","Bim Viewer #003","5.764","5.147","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Bim Viewer #003","Bim Viewer #004","4.912","5.931","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Bim Viewer #004","Bim Viewer #005","743","1.705","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bim Viewer #005","Bim Viewer #001","8.455","8.173","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":438},{"label":"Fev","value":349},{"label":"Mar","value":327},{"label":"Abr","value":502},{"label":"Mai","value":497},{"label":"Jun","value":637},{"label":"Jul","value":471},{"label":"Ago","value":493},{"label":"Set","value":604},{"label":"Out","value":530},{"label":"Nov","value":339},{"label":"Dez","value":446}];
const MX = 637;
