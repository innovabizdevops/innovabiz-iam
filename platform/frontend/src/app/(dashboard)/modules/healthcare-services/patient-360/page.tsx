...
const KPIS = [{"l":"Total Healthcare Services","v":"8.796","t":"+15.6%","d":"up"},{"l":"Patient 360 Ativos","v":"8.579","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"91.1%","t":"+7.2%","d":"up"},{"l":"Score Performance","v":"62","t":"+3.1%","d":"up"}];
const COLS = ["ID","Patient 360","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Healthcare Services #001","Healthcare Services #002","9.014","4.954","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Healthcare Services #002","Healthcare Services #003","5.722","1.660","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Healthcare Services #003","Healthcare Services #004","5.538","4.750","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Healthcare Services #004","Healthcare Services #005","4.761","1.783","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Healthcare Services #005","Healthcare Services #001","8.745","417","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":442},{"label":"Fev","value":337},{"label":"Mar","value":333},{"label":"Abr","value":324},{"label":"Mai","value":566},{"label":"Jun","value":270},{"label":"Jul","value":619},{"label":"Ago","value":607},{"label":"Set","value":630},{"label":"Out","value":503},{"label":"Nov","value":345},{"label":"Dez","value":370}];
const MX = 630;
