...
const PAGE = "Telemedicine Platform";
const KPIS = [{"l":"Formulários Ativos","v":"4.767","t":"+1.1%","d":"up"},{"l":"Submissões/Dia","v":"1567","t":"+6.6%","d":"up"},{"l":"Documentos Gerados","v":"5.431","t":"+1.7%","d":"up"},{"l":"Templates","v":"4.900","t":"+17.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.565","2026-03-15","4.303","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.043","2026-03-28","8.941","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.296","2026-03-27","1.476","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.613","2026-03-11","8.898","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.099","2026-01-07","7.925","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":812},{"label":"Mar","value":790},{"label":"Abr","value":586},{"label":"Mai","value":820},{"label":"Jun","value":605},{"label":"Jul","value":554},{"label":"Ago","value":757},{"label":"Set","value":861},{"label":"Out","value":597},{"label":"Nov","value":739},{"label":"Dez","value":847}];
const MX = 861;
