...
const PAGE = "Population Health AI";
const KPIS = [{"l":"Total Healthcare Services","v":"3.131","t":"+5.2%","d":"up"},{"l":"Population Health AI Ativos","v":"3.646","t":"+9.8%","d":"up"},{"l":"Eficiência (%)","v":"81.3%","t":"+5.0%","d":"up"},{"l":"Score Performance","v":"77","t":"+8.8%","d":"up"}];
const COLS = ["ID","Population Health AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Healthcare Services #001","Healthcare Services #002","6.697","6.739","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Healthcare Services #002","Healthcare Services #003","8.572","5.464","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Healthcare Services #003","Healthcare Services #004","7.120","1.624","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Healthcare Services #004","Healthcare Services #005","968","7.546","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Healthcare Services #005","Healthcare Services #001","6.443","5.092","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":823},{"label":"Mar","value":909},{"label":"Abr","value":844},{"label":"Mai","value":655},{"label":"Jun","value":795},{"label":"Jul","value":833},{"label":"Ago","value":814},{"label":"Set","value":748},{"label":"Out","value":729},{"label":"Nov","value":923},{"label":"Dez","value":627}];
const MX = 923;
