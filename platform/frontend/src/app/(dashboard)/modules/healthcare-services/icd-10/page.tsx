...
const PAGE = "ICD-10 Coding AI";
const KPIS = [{"l":"Total Healthcare Services","v":"2.679","t":"-0.5%","d":"down"},{"l":"ICD 10 Coding AI Ativos","v":"1.439","t":"-1.4%","d":"down"},{"l":"Eficiência (%)","v":"94.4%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"93","t":"-0.3%","d":"down"}];
const COLS = ["ID","ICD 10 Coding AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Healthcare Services #001","Healthcare Services #002","4.334","6.694","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Healthcare Services #002","Healthcare Services #003","7.015","7.938","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Healthcare Services #003","Healthcare Services #004","6.966","8.946","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Healthcare Services #004","Healthcare Services #005","2.088","3.449","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Healthcare Services #005","Healthcare Services #001","8.799","1.346","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":371},{"label":"Fev","value":511},{"label":"Mar","value":736},{"label":"Abr","value":348},{"label":"Mai","value":399},{"label":"Jun","value":713},{"label":"Jul","value":383},{"label":"Ago","value":615},{"label":"Set","value":727},{"label":"Out","value":542},{"label":"Nov","value":392},{"label":"Dez","value":469}];
const MX = 736;
