...
const PAGE = "Care Pathways AI";
const KPIS = [{"l":"Total Healthcare Services","v":"8.918","t":"+7.6%","d":"up"},{"l":"Care Pathways AI Ativos","v":"4.772","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"82.9%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"67","t":"+8.5%","d":"up"}];
const COLS = ["ID","Care Pathways AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Healthcare Services #001","Healthcare Services #002","1.457","2.212","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Healthcare Services #002","Healthcare Services #003","6.598","4.087","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Healthcare Services #003","Healthcare Services #004","5.260","1.337","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Healthcare Services #004","Healthcare Services #005","4.945","7.313","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Healthcare Services #005","Healthcare Services #001","6.377","1.477","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":796},{"label":"Mar","value":693},{"label":"Abr","value":693},{"label":"Mai","value":831},{"label":"Jun","value":559},{"label":"Jul","value":560},{"label":"Ago","value":565},{"label":"Set","value":697},{"label":"Out","value":735},{"label":"Nov","value":500},{"label":"Dez","value":643}];
const MX = 831;
