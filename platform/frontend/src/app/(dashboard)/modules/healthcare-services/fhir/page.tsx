...
const PAGE = "FHIR Integration";
const KPIS = [{"l":"Integrações Ativas","v":"2.061","t":"+15.8%","d":"up"},{"l":"Chamadas/Hora","v":"2724","t":"-2.1%","d":"down"},{"l":"Taxa Sucesso (%)","v":"76.7%","t":"+15.8%","d":"up"},{"l":"Latência Média (ms)","v":"33ms","t":"-2.2%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.595","7.550","94.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.868","5.751","71.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.738","4.811","95.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.287","4.169","98.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.913","4.030","93.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":404},{"label":"Fev","value":443},{"label":"Mar","value":634},{"label":"Abr","value":649},{"label":"Mai","value":521},{"label":"Jun","value":679},{"label":"Jul","value":595},{"label":"Ago","value":654},{"label":"Set","value":521},{"label":"Out","value":602},{"label":"Nov","value":584},{"label":"Dez","value":591}];
const MX = 679;
