...
const PAGE = "DICOM Imaging";
const KPIS = [{"l":"Total Healthcare Services","v":"6.609","t":"-1.3%","d":"down"},{"l":"DICOM Imaging Ativos","v":"1.829","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"77.5%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"73","t":"-3.7%","d":"down"}];
const COLS = ["ID","DICOM Imaging","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Healthcare Services #001","Healthcare Services #002","5.347","5.789","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Healthcare Services #002","Healthcare Services #003","1.942","5.365","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Healthcare Services #003","Healthcare Services #004","8.439","4.049","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Healthcare Services #004","Healthcare Services #005","4.149","1.580","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Healthcare Services #005","Healthcare Services #001","6.080","5.067","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":543},{"label":"Mar","value":558},{"label":"Abr","value":731},{"label":"Mai","value":465},{"label":"Jun","value":367},{"label":"Jul","value":654},{"label":"Ago","value":493},{"label":"Set","value":627},{"label":"Out","value":366},{"label":"Nov","value":708},{"label":"Dez","value":741}];
const MX = 741;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>DICOM</span></h1>
                </div>
