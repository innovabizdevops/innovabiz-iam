...
const ACCENT = "#6366f1";
const MODULE = "Healthcare Services";
const PAGE = "Drug Interaction AI";
const KPIS = [{"l":"Total Healthcare Services","v":"5.694","t":"+8.6%","d":"up"},{"l":"Drug Interaction AI Ativos","v":"8.963","t":"+4.4%","d":"up"},{"l":"Eficiência (%)","v":"67.5%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"82","t":"+16.0%","d":"up"}];
const COLS = ["ID","Drug Interaction AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Healthcare Services #001","Healthcare Services #002","4.417","6.850","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Healthcare Services #002","Healthcare Services #003","9.058","5.424","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Healthcare Services #003","Healthcare Services #004","7.993","9.009","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Healthcare Services #004","Healthcare Services #005","5.158","8.924","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Healthcare Services #005","Healthcare Services #001","2.574","5.495","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":955},{"label":"Fev","value":1016},{"label":"Mar","value":826},{"label":"Abr","value":683},{"label":"Mai","value":1014},{"label":"Jun","value":989},{"label":"Jul","value":714},{"label":"Ago","value":772},{"label":"Set","value":954},{"label":"Out","value":624},{"label":"Nov","value":845},{"label":"Dez","value":907}];
const MX = 1016;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>AI</span></h1>
                </div>
