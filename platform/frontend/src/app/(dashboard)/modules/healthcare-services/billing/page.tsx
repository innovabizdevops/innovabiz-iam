...
const PAGE = "Billing &amp; Claims";
const KPIS = [{"l":"Total Healthcare Services","v":"3.249","t":"+5.0%","d":"up"},{"l":"Billing & Claims Ativos","v":"5.858","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"81.7%","t":"+3.3%","d":"up"},{"l":"Score Performance","v":"59","t":"-2.7%","d":"down"}];
const COLS = ["ID","Billing & Claims","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Healthcare Services #001","Healthcare Services #002","2.550","6.048","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Healthcare Services #002","Healthcare Services #003","7.731","3.172","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Healthcare Services #003","Healthcare Services #004","584","8.735","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Healthcare Services #004","Healthcare Services #005","3.727","8.963","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Healthcare Services #005","Healthcare Services #001","617","7.183","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":539},{"label":"Mar","value":681},{"label":"Abr","value":639},{"label":"Mai","value":487},{"label":"Jun","value":866},{"label":"Jul","value":536},{"label":"Ago","value":530},{"label":"Set","value":818},{"label":"Out","value":608},{"label":"Nov","value":730},{"label":"Dez","value":664}];
const MX = 866;
