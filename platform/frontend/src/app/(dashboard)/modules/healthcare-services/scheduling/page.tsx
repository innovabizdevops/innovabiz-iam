...
const KPIS = [{"l":"eNPS","v":"72","t":"+6.1%","d":"up"},{"l":"Engagement (%)","v":"66.3%","t":"+7.8%","d":"up"},{"l":"Turnover (%)","v":"91.3%","t":"+13.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.263","t":"+14.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.934","2026-03-09","72","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.489","2026-01-08","93","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.118","2026-02-09","87","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.308","2026-03-22","64","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.827","2026-01-05","74","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":958},{"label":"Fev","value":635},{"label":"Mar","value":733},{"label":"Abr","value":701},{"label":"Mai","value":731},{"label":"Jun","value":978},{"label":"Jul","value":789},{"label":"Ago","value":844},{"label":"Set","value":672},{"label":"Out","value":738},{"label":"Nov","value":853},{"label":"Dez","value":819}];
const MX = 978;
