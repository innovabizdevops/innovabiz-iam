...
const PAGE = "HIPAA Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.446","t":"-5.8%","d":"down"},{"l":"NC Abertas","v":"7.629","t":"+8.4%","d":"up"},{"l":"Conformidade (%)","v":"78.1%","t":"+4.9%","d":"up"},{"l":"CAPAs Pendentes","v":"3.524","t":"+17.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.544","97.5%","2.359","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.065","97.7%","7.815","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.982","90.9%","2.953","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.766","96.8%","2.155","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.079","91.6%","3.215","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":737},{"label":"Fev","value":946},{"label":"Mar","value":765},{"label":"Abr","value":842},{"label":"Mai","value":937},{"label":"Jun","value":641},{"label":"Jul","value":641},{"label":"Ago","value":886},{"label":"Set","value":654},{"label":"Out","value":898},{"label":"Nov","value":620},{"label":"Dez","value":863}];
const MX = 946;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>HIPAA</span></h1>
                </div>
