...
const PAGE = "Medical Device IoT";
const KPIS = [{"l":"Dispositivos Online","v":"4.842","t":"+3.4%","d":"up"},{"l":"Dados/Min (MB)","v":"6.530","t":"+5.1%","d":"up"},{"l":"Alertas Ativos","v":"549","t":"+15.2%","d":"up"},{"l":"Uptime (%)","v":"82.1%","t":"+2.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.646","407","8.363","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.788","1.751","2.548","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.664","2.724","1.194","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","125","792","102","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.637","3.766","1.311","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":667},{"label":"Mar","value":501},{"label":"Abr","value":624},{"label":"Mai","value":371},{"label":"Jun","value":438},{"label":"Jul","value":417},{"label":"Ago","value":507},{"label":"Set","value":416},{"label":"Out","value":681},{"label":"Nov","value":497},{"label":"Dez","value":363}];
const MX = 681;
