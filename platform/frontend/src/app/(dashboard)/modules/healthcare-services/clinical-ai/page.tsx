...
const PAGE = "Clinical AI";
const KPIS = [{"l":"Total Healthcare Services","v":"2.312","t":"-4.3%","d":"down"},{"l":"Clinical AI Ativos","v":"7.133","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"81.4%","t":"+12.2%","d":"up"},{"l":"Score Performance","v":"57","t":"+14.3%","d":"up"}];
const COLS = ["ID","Clinical AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Healthcare Services #001","Healthcare Services #002","8.143","969","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Healthcare Services #002","Healthcare Services #003","3.124","714","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Healthcare Services #003","Healthcare Services #004","4.978","5.854","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Healthcare Services #004","Healthcare Services #005","3.541","4.545","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Healthcare Services #005","Healthcare Services #001","2.239","3.903","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":244},{"label":"Fev","value":613},{"label":"Mar","value":483},{"label":"Abr","value":371},{"label":"Mai","value":329},{"label":"Jun","value":339},{"label":"Jul","value":503},{"label":"Ago","value":615},{"label":"Set","value":301},{"label":"Out","value":402},{"label":"Nov","value":261},{"label":"Dez","value":523}];
const MX = 615;
