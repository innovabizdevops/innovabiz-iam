...
const PAGE = "EHR Integration";
const KPIS = [{"l":"Integrações Ativas","v":"4.479","t":"-2.8%","d":"down"},{"l":"Chamadas/Hora","v":"4370","t":"+15.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.3%","t":"-3.9%","d":"down"},{"l":"Latência Média (ms)","v":"182ms","t":"+0.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","808","592","95.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","9.060","2.892","89.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.981","8.018","82.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.120","8.679","94.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.812","1.652","70.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":367},{"label":"Fev","value":466},{"label":"Mar","value":649},{"label":"Abr","value":561},{"label":"Mai","value":474},{"label":"Jun","value":593},{"label":"Jul","value":638},{"label":"Ago","value":560},{"label":"Set","value":526},{"label":"Out","value":580},{"label":"Nov","value":335},{"label":"Dez","value":460}];
const MX = 649;
