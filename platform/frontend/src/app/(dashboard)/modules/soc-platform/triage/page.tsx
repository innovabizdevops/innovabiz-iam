...
const ACCENT = "#6366f1";
const MODULE = "SOC Platform";
const PAGE = "Triage";
const KPIS = [{"l":"Formulários Ativos","v":"5.483","t":"+13.3%","d":"up"},{"l":"Submissões/Dia","v":"1176","t":"+5.6%","d":"up"},{"l":"Documentos Gerados","v":"5.654","t":"-5.8%","d":"down"},{"l":"Templates","v":"4.096","t":"-5.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.830","2026-03-23","1.466","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.331","2026-01-25","635","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.243","2026-03-10","6.615","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.708","2026-01-25","5.940","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.321","2026-02-18","2.914","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":429},{"label":"Fev","value":580},{"label":"Mar","value":673},{"label":"Abr","value":428},{"label":"Mai","value":648},{"label":"Jun","value":426},{"label":"Jul","value":487},{"label":"Ago","value":484},{"label":"Set","value":477},{"label":"Out","value":678},{"label":"Nov","value":491},{"label":"Dez","value":684}];
const MX = 684;
