...
const KPIS = [{"l":"Formulários Ativos","v":"1.571","t":"+12.1%","d":"up"},{"l":"Submissões/Dia","v":"3262","t":"-3.0%","d":"down"},{"l":"Documentos Gerados","v":"3.662","t":"+1.1%","d":"up"},{"l":"Templates","v":"8.614","t":"-3.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.601","2026-01-21","449","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.046","2026-03-20","6.852","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.723","2026-01-01","2.634","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.102","2026-01-16","661","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.653","2026-01-20","5.069","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":359},{"label":"Fev","value":600},{"label":"Mar","value":494},{"label":"Abr","value":441},{"label":"Mai","value":484},{"label":"Jun","value":510},{"label":"Jul","value":344},{"label":"Ago","value":558},{"label":"Set","value":550},{"label":"Out","value":271},{"label":"Nov","value":574},{"label":"Dez","value":232}];
const MX = 600;
