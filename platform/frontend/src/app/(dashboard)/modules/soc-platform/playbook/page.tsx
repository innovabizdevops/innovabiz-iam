...
const PAGE = "Playbook";
const KPIS = [{"l":"Formulários Ativos","v":"6.866","t":"+1.6%","d":"up"},{"l":"Submissões/Dia","v":"629","t":"+4.4%","d":"up"},{"l":"Documentos Gerados","v":"7.231","t":"+8.6%","d":"up"},{"l":"Templates","v":"8.695","t":"+8.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","527","2026-01-06","8.202","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.066","2026-01-08","8.536","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.816","2026-01-25","3.725","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.808","2026-03-15","2.637","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.076","2026-02-23","1.507","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":722},{"label":"Mar","value":741},{"label":"Abr","value":933},{"label":"Mai","value":767},{"label":"Jun","value":901},{"label":"Jul","value":699},{"label":"Ago","value":570},{"label":"Set","value":659},{"label":"Out","value":740},{"label":"Nov","value":796},{"label":"Dez","value":664}];
const MX = 933;
