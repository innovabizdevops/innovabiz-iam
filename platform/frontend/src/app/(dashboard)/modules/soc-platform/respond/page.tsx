...
const PAGE = "Respond";
const KPIS = [{"l":"Formulários Ativos","v":"144","t":"-5.5%","d":"down"},{"l":"Submissões/Dia","v":"4757","t":"+12.9%","d":"up"},{"l":"Documentos Gerados","v":"4.285","t":"-4.2%","d":"down"},{"l":"Templates","v":"7.195","t":"+7.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.627","2026-02-03","6.288","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.511","2026-01-28","8.124","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.551","2026-02-21","5.634","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.991","2026-01-09","2.500","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.013","2026-02-22","3.303","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":692},{"label":"Mar","value":765},{"label":"Abr","value":425},{"label":"Mai","value":767},{"label":"Jun","value":658},{"label":"Jul","value":446},{"label":"Ago","value":683},{"label":"Set","value":510},{"label":"Out","value":485},{"label":"Nov","value":614},{"label":"Dez","value":519}];
const MX = 767;
