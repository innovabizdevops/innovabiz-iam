...
const PAGE = "Monitor";
const KPIS = [{"l":"Formulários Ativos","v":"8.528","t":"+0.5%","d":"up"},{"l":"Submissões/Dia","v":"3454","t":"+9.8%","d":"up"},{"l":"Documentos Gerados","v":"6.198","t":"+2.5%","d":"up"},{"l":"Templates","v":"4.363","t":"+12.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.445","2026-01-20","1.913","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.213","2026-02-03","7.613","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.103","2026-03-02","6.243","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.261","2026-02-09","8.129","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.067","2026-02-08","5.892","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":397},{"label":"Fev","value":460},{"label":"Mar","value":536},{"label":"Abr","value":529},{"label":"Mai","value":777},{"label":"Jun","value":413},{"label":"Jul","value":631},{"label":"Ago","value":725},{"label":"Set","value":399},{"label":"Out","value":646},{"label":"Nov","value":716},{"label":"Dez","value":531}];
const MX = 777;
