...
const PAGE = "Fine";
const KPIS = [{"l":"Dashboards Ativos","v":"933","t":"+2.3%","d":"up"},{"l":"Queries/Dia","v":"2591","t":"+5.4%","d":"up"},{"l":"Dados Processados (GB)","v":"6.177","t":"+9.2%","d":"up"},{"l":"Utilizadores Analytics","v":"4.881","t":"-0.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1605","2026-02-21","5.064","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3395","2026-02-11","504","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1737","2026-02-02","4.753","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1167","2026-03-13","7.827","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","541","2026-02-22","7.497","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":758},{"label":"Mar","value":577},{"label":"Abr","value":793},{"label":"Mai","value":908},{"label":"Jun","value":945},{"label":"Jul","value":575},{"label":"Ago","value":698},{"label":"Set","value":695},{"label":"Out","value":946},{"label":"Nov","value":870},{"label":"Dez","value":632}];
const MX = 946;
