...
const PAGE = "Register";
const KPIS = [{"l":"Dashboards Ativos","v":"4.240","t":"+1.3%","d":"up"},{"l":"Queries/Dia","v":"500","t":"+2.7%","d":"up"},{"l":"Dados Processados (GB)","v":"7.362","t":"+9.6%","d":"up"},{"l":"Utilizadores Analytics","v":"4.884","t":"-2.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2420","2026-01-16","2.353","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4311","2026-02-23","4.686","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2155","2026-01-27","3.200","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3244","2026-01-28","4.410","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4721","2026-01-12","3.152","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":566},{"label":"Mar","value":657},{"label":"Abr","value":676},{"label":"Mai","value":737},{"label":"Jun","value":662},{"label":"Jul","value":707},{"label":"Ago","value":726},{"label":"Set","value":710},{"label":"Out","value":502},{"label":"Nov","value":534},{"label":"Dez","value":542}];
const MX = 737;
