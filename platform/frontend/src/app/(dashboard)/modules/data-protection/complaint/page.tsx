...
const ACCENT = "#1e293b";
const MODULE = "Data Protection Authority";
const PAGE = "Complaint";
const KPIS = [{"l":"Dashboards Ativos","v":"4.959","t":"+15.5%","d":"up"},{"l":"Queries/Dia","v":"4321","t":"+11.8%","d":"up"},{"l":"Dados Processados (GB)","v":"608","t":"-3.9%","d":"down"},{"l":"Utilizadores Analytics","v":"6.778","t":"-3.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","435","2026-01-01","6.330","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","653","2026-02-18","1.126","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4818","2026-03-21","7.584","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1986","2026-01-05","3.413","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4451","2026-01-18","4.196","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":359},{"label":"Mar","value":522},{"label":"Abr","value":658},{"label":"Mai","value":602},{"label":"Jun","value":400},{"label":"Jul","value":595},{"label":"Ago","value":513},{"label":"Set","value":364},{"label":"Out","value":509},{"label":"Nov","value":623},{"label":"Dez","value":329}];
const MX = 658;
