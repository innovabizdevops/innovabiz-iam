...
const PAGE = "Guidance";
const KPIS = [{"l":"Dashboards Ativos","v":"1.130","t":"+14.7%","d":"up"},{"l":"Queries/Dia","v":"2914","t":"+15.6%","d":"up"},{"l":"Dados Processados (GB)","v":"8.632","t":"+14.4%","d":"up"},{"l":"Utilizadores Analytics","v":"6.439","t":"+16.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3302","2026-02-02","923","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","215","2026-03-25","9.035","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1555","2026-03-09","1.355","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3768","2026-01-06","2.007","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1887","2026-03-02","2.320","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":426},{"label":"Mar","value":559},{"label":"Abr","value":409},{"label":"Mai","value":484},{"label":"Jun","value":599},{"label":"Jul","value":766},{"label":"Ago","value":697},{"label":"Set","value":639},{"label":"Out","value":392},{"label":"Nov","value":500},{"label":"Dez","value":533}];
const MX = 766;
