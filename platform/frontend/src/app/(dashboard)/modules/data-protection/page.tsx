...
/* ═══ Data Protection Authority — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "8035", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3958", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€110K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "-18%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "121213635", cells: ["DAT-2635", "Data Protection Authority Item 1", "12/4/2026", "€13 735"], status: "active" as const },
    { id: "121217206", cells: ["DAT-6206", "Data Protection Authority Item 2", "27/11/2026", "€17 306"], status: "pending" as const },
    { id: "121220777", cells: ["DAT-9777", "Data Protection Authority Item 3", "14/6/2026", "€20 877"], status: "completed" as const },
    { id: "121224348", cells: ["DAT-4348", "Data Protection Authority Item 4", "1/1/2026", "€24 448"], status: "warning" as const },
    { id: "121227919", cells: ["DAT-7919", "Data Protection Authority Item 5", "16/8/2026", "€28 019"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 55 }, { label: "Fev", value: 64 }, { label: "Mar", value: 73 }, { label: "Abr", value: 82 }, { label: "Mai", value: 91 }, { label: "Jun", value: 20 }];
...
export default function DataProtectionAuthorityPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Protection Authority</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Protection Authority</p>
                    </div>
                </div>
