...
/* ═══ Point-of-Sale Platform — Dashboard ═══ */

const ACCENT = "#ea580c";

const KPIS = [
    { label: "Total Registos", value: "8207", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2005", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€128K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "574109107", cells: ["POS-9107", "Point-of-Sale Platform Item 1", "20/8/2026", "€9207"], status: "active" as const },
    { id: "574112678", cells: ["POS-3678", "Point-of-Sale Platform Item 2", "7/3/2026", "€12 778"], status: "pending" as const },
    { id: "574116249", cells: ["POS-7249", "Point-of-Sale Platform Item 3", "22/10/2026", "€16 349"], status: "completed" as const },
    { id: "574119820", cells: ["POS-1820", "Point-of-Sale Platform Item 4", "9/5/2026", "€19 920"], status: "warning" as const },
    { id: "574123391", cells: ["POS-5391", "Point-of-Sale Platform Item 5", "24/12/2026", "€23 491"], status: "active" as const },
];
...
export default function PointofsalePlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Point-of-Sale Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Point-of-Sale Platform</p>
                    </div>
                </div>
