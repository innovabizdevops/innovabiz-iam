...
const ACCENT = "#ea580c";
const MODULE = "Point-of-Sale Platform";
const PAGE = "Pay";
const KPIS = [{"l":"Pedidos/Dia","v":"2927","t":"-0.4%","d":"down"},{"l":"GMV (€)","v":"€30963","t":"-1.4%","d":"down"},{"l":"Conversão (%)","v":"70.5%","t":"-1.9%","d":"down"},{"l":"AOV (€)","v":"€92236","t":"+16.7%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 38331.96","1.561","4.653","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 560.94","3.958","6.703","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 33509.72","676","5.532","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 28601.87","4.602","6.839","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 19259.65","1.823","9.026","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":476},{"label":"Mar","value":639},{"label":"Abr","value":559},{"label":"Mai","value":694},{"label":"Jun","value":475},{"label":"Jul","value":486},{"label":"Ago","value":447},{"label":"Set","value":711},{"label":"Out","value":654},{"label":"Nov","value":383},{"label":"Dez","value":588}];
const MX = 711;
