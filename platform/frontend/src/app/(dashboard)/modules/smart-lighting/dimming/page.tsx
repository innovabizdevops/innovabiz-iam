...
const ACCENT = "#b45309";
const MODULE = "Smart Street Lighting";
const PAGE = "Dimming Sched";
const KPIS = [{"l":"Total Smart Lighting","v":"168","t":"-0.3%","d":"down"},{"l":"Dimming Sched Ativos","v":"5.781","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"80.5%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"90","t":"-2.9%","d":"down"}];
const COLS = ["ID","Dimming Sched","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Smart Lighting #001","Smart Lighting #002","879","5.626","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Smart Lighting #002","Smart Lighting #003","2.586","1.071","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Lighting #003","Smart Lighting #004","6.968","8.277","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Smart Lighting #004","Smart Lighting #005","3.977","2.445","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Smart Lighting #005","Smart Lighting #001","894","8.690","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":437},{"label":"Mar","value":408},{"label":"Abr","value":354},{"label":"Mai","value":421},{"label":"Jun","value":468},{"label":"Jul","value":364},{"label":"Ago","value":486},{"label":"Set","value":674},{"label":"Out","value":468},{"label":"Nov","value":638},{"label":"Dez","value":545}];
const MX = 674;
