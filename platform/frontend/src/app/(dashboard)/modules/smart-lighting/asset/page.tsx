...
const PAGE = "Asset Track";
const KPIS = [{"l":"Ativos Registados","v":"6.164","t":"-4.9%","d":"down"},{"l":"Valor Total (€M)","v":"€6.4M","t":"+4.2%","d":"up"},{"l":"Depreciação Anual (€)","v":"€79133","t":"+15.6%","d":"up"},{"l":"Ativos em Garantia","v":"2.268","t":"+6.6%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 40484.64","3.622","€ 17371.10","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 21137.87","3.400","€ 46791.76","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 34187.35","6.132","€ 10874.39","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 38044.38","3.847","€ 8822.17","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 3130.28","6.712","€ 10051.68","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":857},{"label":"Mar","value":802},{"label":"Abr","value":844},{"label":"Mai","value":854},{"label":"Jun","value":679},{"label":"Jul","value":1002},{"label":"Ago","value":716},{"label":"Set","value":990},{"label":"Out","value":781},{"label":"Nov","value":828},{"label":"Dez","value":955}];
const MX = 1002;
