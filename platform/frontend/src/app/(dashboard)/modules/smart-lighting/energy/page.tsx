...
const PAGE = "Energy Save";
const KPIS = [{"l":"Total Smart Lighting","v":"1.711","t":"-2.0%","d":"down"},{"l":"Energy Save Ativos","v":"4.365","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"80.3%","t":"-5.1%","d":"down"},{"l":"Score Performance","v":"56","t":"+2.6%","d":"up"}];
const COLS = ["ID","Energy Save","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Smart Lighting #001","Smart Lighting #002","3.842","8.737","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Smart Lighting #002","Smart Lighting #003","2.688","8.137","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Lighting #003","Smart Lighting #004","6.939","4.156","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Smart Lighting #004","Smart Lighting #005","7.832","693","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Smart Lighting #005","Smart Lighting #001","7.704","3.764","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":486},{"label":"Fev","value":386},{"label":"Mar","value":644},{"label":"Abr","value":460},{"label":"Mai","value":389},{"label":"Jun","value":731},{"label":"Jul","value":623},{"label":"Ago","value":587},{"label":"Set","value":606},{"label":"Out","value":601},{"label":"Nov","value":692},{"label":"Dez","value":694}];
const MX = 731;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b45309'}}>ESG</span></h1>
                </div>
