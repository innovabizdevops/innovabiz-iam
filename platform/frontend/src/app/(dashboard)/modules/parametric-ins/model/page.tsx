...
const PAGE = "Model";
const KPIS = [{"l":"Configurações","v":"4.340","t":"+13.0%","d":"up"},{"l":"Últimas Alterações","v":"9.001","t":"-2.2%","d":"down"},{"l":"Ambientes","v":"2.384","t":"+15.2%","d":"up"},{"l":"Versão Config","v":"724","t":"+8.7%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 26742.69","8.320","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 23802.51","6.250","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 49278.40","1.199","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 18282.86","2.028","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 42012.50","1.967","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":807},{"label":"Mar","value":650},{"label":"Abr","value":620},{"label":"Mai","value":616},{"label":"Jun","value":823},{"label":"Jul","value":446},{"label":"Ago","value":448},{"label":"Set","value":818},{"label":"Out","value":680},{"label":"Nov","value":648},{"label":"Dez","value":713}];
const MX = 830;
