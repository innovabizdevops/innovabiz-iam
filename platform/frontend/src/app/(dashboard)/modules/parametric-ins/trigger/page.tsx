...
const ACCENT = "#6366f1";
const MODULE = "Parametric Insurance";
const PAGE = "Trigger";
const KPIS = [{"l":"Configurações","v":"1.533","t":"+17.3%","d":"up"},{"l":"Últimas Alterações","v":"5.902","t":"+7.9%","d":"up"},{"l":"Ambientes","v":"2.737","t":"-4.8%","d":"down"},{"l":"Versão Config","v":"4.940","t":"-0.9%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 45562.79","3.071","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 33230.92","3.958","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 29669.69","7.203","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 33322.14","6.772","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 39950.87","7.384","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":697},{"label":"Mar","value":439},{"label":"Abr","value":561},{"label":"Mai","value":469},{"label":"Jun","value":415},{"label":"Jul","value":570},{"label":"Ago","value":459},{"label":"Set","value":686},{"label":"Out","value":731},{"label":"Nov","value":535},{"label":"Dez","value":504}];
const MX = 731;
