...
const PAGE = "Oracle";
const KPIS = [{"l":"Configurações","v":"7.595","t":"+2.7%","d":"up"},{"l":"Últimas Alterações","v":"8.226","t":"+12.6%","d":"up"},{"l":"Ambientes","v":"8.277","t":"+8.4%","d":"up"},{"l":"Versão Config","v":"7.881","t":"-2.6%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 2343.26","312","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 1320.21","4.251","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 26768.65","1.305","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 23893.02","3.266","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 30247.17","598","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":492},{"label":"Mar","value":500},{"label":"Abr","value":530},{"label":"Mai","value":690},{"label":"Jun","value":782},{"label":"Jul","value":737},{"label":"Ago","value":471},{"label":"Set","value":832},{"label":"Out","value":572},{"label":"Nov","value":831},{"label":"Dez","value":811}];
const MX = 832;
