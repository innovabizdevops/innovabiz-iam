...
const PAGE = "Index";
const KPIS = [{"l":"Configurações","v":"7.728","t":"+3.9%","d":"up"},{"l":"Últimas Alterações","v":"8.481","t":"+16.6%","d":"up"},{"l":"Ambientes","v":"5.865","t":"+12.8%","d":"up"},{"l":"Versão Config","v":"638","t":"+14.5%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 9349.85","6.993","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 36444.05","8.774","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 43289.19","3.713","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 3136.02","1.992","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 44005.32","1.354","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":329},{"label":"Mar","value":362},{"label":"Abr","value":327},{"label":"Mai","value":234},{"label":"Jun","value":543},{"label":"Jul","value":333},{"label":"Ago","value":234},{"label":"Set","value":293},{"label":"Out","value":369},{"label":"Nov","value":582},{"label":"Dez","value":560}];
const MX = 582;
