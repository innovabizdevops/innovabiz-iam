...
const PAGE = "Payout";
const KPIS = [{"l":"Configurações","v":"3.268","t":"-4.2%","d":"down"},{"l":"Últimas Alterações","v":"6.000","t":"+2.5%","d":"up"},{"l":"Ambientes","v":"3.308","t":"+6.8%","d":"up"},{"l":"Versão Config","v":"4.362","t":"+6.9%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 18115.79","5.727","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 28431.54","1.887","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 49982.74","1.764","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 7277.94","2.951","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 21327.94","2.618","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":832},{"label":"Fev","value":553},{"label":"Mar","value":619},{"label":"Abr","value":808},{"label":"Mai","value":727},{"label":"Jun","value":655},{"label":"Jul","value":526},{"label":"Ago","value":526},{"label":"Set","value":667},{"label":"Out","value":608},{"label":"Nov","value":809},{"label":"Dez","value":856}];
const MX = 856;
