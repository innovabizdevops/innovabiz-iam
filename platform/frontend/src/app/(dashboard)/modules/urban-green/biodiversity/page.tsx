...
const KPIS = [{"l":"Total Urban Green","v":"1.672","t":"+5.7%","d":"up"},{"l":"Biodiversity Ativos","v":"433","t":"+14.1%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"65","t":"+9.4%","d":"up"}];
const COLS = ["ID","Biodiversity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Urban Green #001","Urban Green #002","5.835","7.710","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Urban Green #002","Urban Green #003","6.687","4.577","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Urban Green #003","Urban Green #004","2.933","8.277","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Urban Green #004","Urban Green #005","8.047","512","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Urban Green #005","Urban Green #001","6.223","4.741","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":774},{"label":"Fev","value":747},{"label":"Mar","value":682},{"label":"Abr","value":1001},{"label":"Mai","value":719},{"label":"Jun","value":840},{"label":"Jul","value":823},{"label":"Ago","value":1057},{"label":"Set","value":840},{"label":"Out","value":1008},{"label":"Nov","value":803},{"label":"Dez","value":826}];
const MX = 1057;
