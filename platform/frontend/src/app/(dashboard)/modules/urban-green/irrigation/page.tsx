...
const ACCENT = "#059669";
const MODULE = "Urban Green Space";
const PAGE = "Irrigation";
const KPIS = [{"l":"Total Urban Green","v":"895","t":"+11.5%","d":"up"},{"l":"Irrigation Ativos","v":"3.234","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"67.0%","t":"+4.5%","d":"up"},{"l":"Score Performance","v":"62","t":"+15.5%","d":"up"}];
const COLS = ["ID","Irrigation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Urban Green #001","Urban Green #002","6.354","562","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Urban Green #002","Urban Green #003","886","731","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Urban Green #003","Urban Green #004","8.529","3.327","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Urban Green #004","Urban Green #005","701","3.258","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Urban Green #005","Urban Green #001","3.099","4.855","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":535},{"label":"Mar","value":451},{"label":"Abr","value":770},{"label":"Mai","value":528},{"label":"Jun","value":760},{"label":"Jul","value":733},{"label":"Ago","value":783},{"label":"Set","value":593},{"label":"Out","value":540},{"label":"Nov","value":567},{"label":"Dez","value":606}];
const MX = 783;
