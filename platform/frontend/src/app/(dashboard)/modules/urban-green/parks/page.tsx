...
const PAGE = "Park Mgmt";
const KPIS = [{"l":"Total Urban Green","v":"3.693","t":"+6.8%","d":"up"},{"l":"Park Mgmt Ativos","v":"772","t":"+1.5%","d":"up"},{"l":"Eficiência (%)","v":"89.2%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"59","t":"+9.9%","d":"up"}];
const COLS = ["ID","Park Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Urban Green #001","Urban Green #002","4.332","8.052","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Urban Green #002","Urban Green #003","5.066","2.824","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Urban Green #003","Urban Green #004","5.920","5.751","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Urban Green #004","Urban Green #005","1.293","8.431","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Urban Green #005","Urban Green #001","5.314","6.808","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":759},{"label":"Fev","value":749},{"label":"Mar","value":591},{"label":"Abr","value":490},{"label":"Mai","value":472},{"label":"Jun","value":542},{"label":"Jul","value":517},{"label":"Ago","value":696},{"label":"Set","value":638},{"label":"Out","value":750},{"label":"Nov","value":779},{"label":"Dez","value":401}];
const MX = 779;
