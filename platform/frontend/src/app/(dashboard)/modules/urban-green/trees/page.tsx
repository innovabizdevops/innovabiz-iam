...
const PAGE = "Tree Inventory";
const KPIS = [{"l":"Total Urban Green","v":"3.361","t":"+11.0%","d":"up"},{"l":"Tree Inventory Ativos","v":"4.794","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"75.6%","t":"+-0.0%","d":"up"},{"l":"Score Performance","v":"84","t":"+3.7%","d":"up"}];
const COLS = ["ID","Tree Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Urban Green #001","Urban Green #002","8.859","1.760","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Urban Green #002","Urban Green #003","5.218","8.775","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Urban Green #003","Urban Green #004","5.572","6.924","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Urban Green #004","Urban Green #005","8.123","1.346","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Urban Green #005","Urban Green #001","6.640","5.669","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":628},{"label":"Mar","value":702},{"label":"Abr","value":544},{"label":"Mai","value":360},{"label":"Jun","value":441},{"label":"Jul","value":715},{"label":"Ago","value":551},{"label":"Set","value":656},{"label":"Out","value":599},{"label":"Nov","value":582},{"label":"Dez","value":511}];
const MX = 715;
