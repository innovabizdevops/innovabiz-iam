...
const KPIS = [{"l":"Vendas YTD (€)","v":"€18656","t":"+15.5%","d":"up"},{"l":"Pipeline (€)","v":"€93091","t":"+3.5%","d":"up"},{"l":"Atingimento Quota (%)","v":"80.8%","t":"+17.5%","d":"up"},{"l":"Win Rate (%)","v":"65.1%","t":"+7.6%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 17280.79","€ 12868.38","€ 49095.32","77.8%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 44785.43","€ 22549.89","€ 14969.70","82.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 8672.01","€ 15810.99","€ 18571.24","88.5%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 49737.36","€ 41462.43","€ 27248.19","84.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 4759.67","€ 43037.81","€ 37081.42","78.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":387},{"label":"Fev","value":477},{"label":"Mar","value":513},{"label":"Abr","value":356},{"label":"Mai","value":259},{"label":"Jun","value":497},{"label":"Jul","value":311},{"label":"Ago","value":486},{"label":"Set","value":517},{"label":"Out","value":254},{"label":"Nov","value":369},{"label":"Dez","value":343}];
const MX = 517;
...
export default function DecomPage() {
    return (
