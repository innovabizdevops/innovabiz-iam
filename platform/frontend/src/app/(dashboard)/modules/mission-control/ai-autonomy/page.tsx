...
const PAGE = "AI Autonomy";
const KPIS = [{"l":"Total Mission Control","v":"4.686","t":"-2.1%","d":"down"},{"l":"AI Autonomy Ativos","v":"4.606","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"82.0%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"85","t":"+16.1%","d":"up"}];
const COLS = ["ID","AI Autonomy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mission Control #001","Mission Control #002","4.279","3.735","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Mission Control #002","Mission Control #003","1.123","1.498","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Mission Control #003","Mission Control #004","1.383","7.563","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Mission Control #004","Mission Control #005","6.060","3.410","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mission Control #005","Mission Control #001","955","673","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":894},{"label":"Mar","value":596},{"label":"Abr","value":942},{"label":"Mai","value":894},{"label":"Jun","value":624},{"label":"Jul","value":850},{"label":"Ago","value":650},{"label":"Set","value":671},{"label":"Out","value":855},{"label":"Nov","value":837},{"label":"Dez","value":938}];
const MX = 942;
