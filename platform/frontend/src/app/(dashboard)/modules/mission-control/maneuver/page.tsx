...
const PAGE = "Orbit Maneuver";
const KPIS = [{"l":"Total Mission Control","v":"5.762","t":"-1.8%","d":"down"},{"l":"Orbit Maneuver Ativos","v":"7.164","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"81.2%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"74","t":"+11.7%","d":"up"}];
const COLS = ["ID","Orbit Maneuver","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mission Control #001","Mission Control #002","3.166","5.837","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Mission Control #002","Mission Control #003","3.822","8.904","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Mission Control #003","Mission Control #004","7.407","3.191","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Mission Control #004","Mission Control #005","7.285","4.860","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mission Control #005","Mission Control #001","5.586","943","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1032},{"label":"Fev","value":1063},{"label":"Mar","value":753},{"label":"Abr","value":958},{"label":"Mai","value":943},{"label":"Jun","value":954},{"label":"Jul","value":894},{"label":"Ago","value":905},{"label":"Set","value":759},{"label":"Out","value":1038},{"label":"Nov","value":754},{"label":"Dez","value":751}];
const MX = 1063;
...
export default function ManeuverPage() {
    return (
