...
const KPIS = [{"l":"Twins Ativos","v":"8.823","t":"+11.1%","d":"up"},{"l":"Simulações/Dia","v":"1988","t":"-2.7%","d":"down"},{"l":"Precisão Modelo (%)","v":"80.5%","t":"+3.2%","d":"up"},{"l":"Latência Sync (ms)","v":"41ms","t":"+2.3%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","75.0%","2026-03-14","8.392","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","84.8%","2026-01-15","1.334","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","97.4%","2026-03-18","7.912","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","80.5%","2026-01-07","2.222","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","81.9%","2026-02-04","3.475","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":531},{"label":"Mar","value":318},{"label":"Abr","value":594},{"label":"Mai","value":601},{"label":"Jun","value":526},{"label":"Jul","value":514},{"label":"Ago","value":228},{"label":"Set","value":388},{"label":"Out","value":512},{"label":"Nov","value":584},{"label":"Dez","value":466}];
const MX = 601;
