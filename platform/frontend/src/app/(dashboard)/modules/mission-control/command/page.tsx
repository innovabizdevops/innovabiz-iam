...
const PAGE = "Command";
const KPIS = [{"l":"Total Mission Control","v":"3.597","t":"-5.5%","d":"down"},{"l":"Command Ativos","v":"640","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"72.8%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"64","t":"+12.9%","d":"up"}];
const COLS = ["ID","Command","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mission Control #001","Mission Control #002","3.406","7.004","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Mission Control #002","Mission Control #003","9.008","4.462","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Mission Control #003","Mission Control #004","7.386","5.080","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Mission Control #004","Mission Control #005","5.188","980","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mission Control #005","Mission Control #001","7.638","5.121","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":366},{"label":"Mar","value":649},{"label":"Abr","value":339},{"label":"Mai","value":619},{"label":"Jun","value":649},{"label":"Jul","value":709},{"label":"Ago","value":664},{"label":"Set","value":348},{"label":"Out","value":724},{"label":"Nov","value":520},{"label":"Dez","value":607}];
const MX = 724;
