...
const KPIS = [{"l":"Total Mission Control","v":"8.545","t":"-5.2%","d":"down"},{"l":"Telemetry Ativos","v":"2.384","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"85.2%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"56","t":"+9.2%","d":"up"}];
const COLS = ["ID","Telemetry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mission Control #001","Mission Control #002","8.342","7.776","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Mission Control #002","Mission Control #003","8.356","3.989","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Mission Control #003","Mission Control #004","1.860","6.233","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Mission Control #004","Mission Control #005","1.973","8.489","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mission Control #005","Mission Control #001","4.736","6.530","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":215},{"label":"Fev","value":500},{"label":"Mar","value":539},{"label":"Abr","value":413},{"label":"Mai","value":240},{"label":"Jun","value":392},{"label":"Jul","value":520},{"label":"Ago","value":580},{"label":"Set","value":528},{"label":"Out","value":459},{"label":"Nov","value":273},{"label":"Dez","value":225}];
const MX = 580;
