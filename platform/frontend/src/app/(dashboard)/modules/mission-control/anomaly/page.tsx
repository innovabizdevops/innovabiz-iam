...
const KPIS = [{"l":"Total Mission Control","v":"5.324","t":"+7.6%","d":"up"},{"l":"Anomaly AI Ativos","v":"368","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"70.4%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"74","t":"-5.0%","d":"down"}];
const COLS = ["ID","Anomaly AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mission Control #001","Mission Control #002","5.713","1.513","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Mission Control #002","Mission Control #003","6.512","8.077","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Mission Control #003","Mission Control #004","3.452","3.838","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Mission Control #004","Mission Control #005","269","7.001","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mission Control #005","Mission Control #001","4.753","9.068","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":777},{"label":"Mar","value":657},{"label":"Abr","value":688},{"label":"Mai","value":715},{"label":"Jun","value":882},{"label":"Jul","value":722},{"label":"Ago","value":558},{"label":"Set","value":712},{"label":"Out","value":772},{"label":"Nov","value":625},{"label":"Dez","value":797}];
const MX = 882;
