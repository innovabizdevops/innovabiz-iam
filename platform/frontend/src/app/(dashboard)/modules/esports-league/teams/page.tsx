...
const ACCENT = "#1e40af";
const MODULE = "Esports League";
const PAGE = "Team Register";
const KPIS = [{"l":"Teams Ativos","v":"2.857","t":"+8.9%","d":"up"},{"l":"Reuniões/Semana","v":"2394","t":"+1.8%","d":"up"},{"l":"Mensagens/Dia","v":"365","t":"-3.3%","d":"down"},{"l":"Ficheiros Partilhados","v":"3.382","t":"+10.7%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.380","4306","6.093","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.068","4030","558","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","7.087","2269","7.730","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","387","2044","2.583","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","748","2114","3.770","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1066},{"label":"Fev","value":877},{"label":"Mar","value":748},{"label":"Abr","value":743},{"label":"Mai","value":843},{"label":"Jun","value":1000},{"label":"Jul","value":686},{"label":"Ago","value":947},{"label":"Set","value":855},{"label":"Out","value":894},{"label":"Nov","value":975},{"label":"Dez","value":726}];
const MX = 1066;
