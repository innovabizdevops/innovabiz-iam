...
const PAGE = "Bracket";
const KPIS = [{"l":"Atletas Registados","v":"7.403","t":"-2.4%","d":"down"},{"l":"Treinos/Semana","v":"2968","t":"+9.9%","d":"up"},{"l":"Competições","v":"9.002","t":"+5.3%","d":"up"},{"l":"Performance Score","v":"89","t":"+17.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.719","1.325","5.416","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","996","5.243","4.178","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.669","3.516","4.609","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.025","7.384","8.132","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","674","6.409","7.941","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":793},{"label":"Fev","value":607},{"label":"Mar","value":647},{"label":"Abr","value":765},{"label":"Mai","value":937},{"label":"Jun","value":660},{"label":"Jul","value":665},{"label":"Ago","value":774},{"label":"Set","value":815},{"label":"Out","value":860},{"label":"Nov","value":616},{"label":"Dez","value":768}];
const MX = 937;
