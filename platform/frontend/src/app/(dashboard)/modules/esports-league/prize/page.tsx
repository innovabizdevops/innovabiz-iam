...
const KPIS = [{"l":"Atletas Registados","v":"7.728","t":"-3.6%","d":"down"},{"l":"Treinos/Semana","v":"1776","t":"+6.9%","d":"up"},{"l":"Competições","v":"1.524","t":"+4.0%","d":"up"},{"l":"Performance Score","v":"92","t":"-0.9%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.361","1.855","8.748","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","366","3.569","2.452","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.347","8.913","2.578","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.901","3.591","3.642","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.237","6.209","3.447","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":834},{"label":"Mar","value":663},{"label":"Abr","value":706},{"label":"Mai","value":499},{"label":"Jun","value":692},{"label":"Jul","value":688},{"label":"Ago","value":757},{"label":"Set","value":502},{"label":"Out","value":597},{"label":"Nov","value":712},{"label":"Dez","value":574}];
const MX = 834;
