...
const KPIS = [{"l":"Atletas Registados","v":"161","t":"+9.5%","d":"up"},{"l":"Treinos/Semana","v":"4024","t":"-0.6%","d":"down"},{"l":"Competições","v":"3.625","t":"+10.3%","d":"up"},{"l":"Performance Score","v":"74","t":"+6.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.222","4.552","4.439","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.127","7.648","144","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.182","3.363","7.194","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.543","5.679","1.412","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.369","195","4.567","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":808},{"label":"Mar","value":751},{"label":"Abr","value":832},{"label":"Mai","value":793},{"label":"Jun","value":636},{"label":"Jul","value":559},{"label":"Ago","value":570},{"label":"Set","value":647},{"label":"Out","value":710},{"label":"Nov","value":720},{"label":"Dez","value":796}];
const MX = 832;
