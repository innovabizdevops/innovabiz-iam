...
const KPIS = [{"l":"Atletas Registados","v":"4.906","t":"+9.3%","d":"up"},{"l":"Treinos/Semana","v":"3993","t":"+4.2%","d":"up"},{"l":"Competições","v":"7.838","t":"-3.0%","d":"down"},{"l":"Performance Score","v":"78","t":"+15.2%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.829","6.826","2.631","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.484","2.146","3.373","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.974","5.746","5.674","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.353","499","1.754","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.383","3.697","5.753","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":817},{"label":"Mar","value":718},{"label":"Abr","value":616},{"label":"Mai","value":941},{"label":"Jun","value":829},{"label":"Jul","value":574},{"label":"Ago","value":875},{"label":"Set","value":843},{"label":"Out","value":647},{"label":"Nov","value":665},{"label":"Dez","value":723}];
const MX = 941;
