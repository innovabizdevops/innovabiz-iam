...
const PAGE = "Betting API";
const KPIS = [{"l":"Atletas Registados","v":"870","t":"+8.5%","d":"up"},{"l":"Treinos/Semana","v":"4191","t":"-0.2%","d":"down"},{"l":"Competições","v":"1.376","t":"+15.1%","d":"up"},{"l":"Performance Score","v":"90","t":"+3.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.478","355","6.926","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.015","1.581","5.577","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","341","8.593","273","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.604","8.034","5.463","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.678","592","5.100","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":760},{"label":"Mar","value":699},{"label":"Abr","value":746},{"label":"Mai","value":549},{"label":"Jun","value":600},{"label":"Jul","value":403},{"label":"Ago","value":531},{"label":"Set","value":682},{"label":"Out","value":620},{"label":"Nov","value":735},{"label":"Dez","value":455}];
const MX = 760;
