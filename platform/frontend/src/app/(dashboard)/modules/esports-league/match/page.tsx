...
const PAGE = "Match Schedule";
const KPIS = [{"l":"Atletas Registados","v":"2.960","t":"+5.3%","d":"up"},{"l":"Treinos/Semana","v":"1695","t":"+4.5%","d":"up"},{"l":"Competições","v":"6.810","t":"+9.8%","d":"up"},{"l":"Performance Score","v":"85","t":"+2.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.611","1.195","2.867","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","5.195","1.403","926","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.729","6.308","9.038","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.078","1.644","7.249","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.937","5.287","749","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":408},{"label":"Mar","value":634},{"label":"Abr","value":387},{"label":"Mai","value":393},{"label":"Jun","value":476},{"label":"Jul","value":628},{"label":"Ago","value":709},{"label":"Set","value":437},{"label":"Out","value":742},{"label":"Nov","value":598},{"label":"Dez","value":652}];
const MX = 742;
