...
const PAGE = "Certify";
const KPIS = [{"l":"Riscos Identificados","v":"4.887","t":"-1.0%","d":"down"},{"l":"Mitigações Ativas","v":"3.453","t":"+13.0%","d":"up"},{"l":"Score Risco Geral","v":"59","t":"+18.0%","d":"up"},{"l":"Incidentes YTD","v":"1.197","t":"+16.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.762","4.469","4.144","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.926","6.956","9.034","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","237","6.326","2.229","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.863","3.068","6.253","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.703","9.100","182","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":476},{"label":"Mar","value":574},{"label":"Abr","value":472},{"label":"Mai","value":369},{"label":"Jun","value":448},{"label":"Jul","value":409},{"label":"Ago","value":511},{"label":"Set","value":606},{"label":"Out","value":354},{"label":"Nov","value":683},{"label":"Dez","value":580}];
const MX = 683;
