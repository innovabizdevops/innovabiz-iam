...
/* ═══ XAI Governance Framework — Dashboard ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total Registos", value: "8482", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2668", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€435K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1894333782", cells: ["XAI-5782", "XAI Governance Framework Item 1", "27/7/2026", "€33 882"], status: "active" as const },
    { id: "1894337353", cells: ["XAI-9353", "XAI Governance Framework Item 2", "14/2/2026", "€37 453"], status: "pending" as const },
    { id: "1894340924", cells: ["XAI-3924", "XAI Governance Framework Item 3", "1/9/2026", "€41 024"], status: "completed" as const },
    { id: "1894344495", cells: ["XAI-7495", "XAI Governance Framework Item 4", "16/4/2026", "€44 595"], status: "warning" as const },
    { id: "1894348066", cells: ["XAI-2066", "XAI Governance Framework Item 5", "3/11/2026", "€48 166"], status: "active" as const },
];
...
export default function XaiGovernanceFrameworkPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">XAI Governance Framework</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • XAI Governance Framework</p>
                    </div>
                </div>
