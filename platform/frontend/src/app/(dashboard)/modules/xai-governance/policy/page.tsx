...
const PAGE = "Policy";
const KPIS = [{"l":"Riscos Identificados","v":"4.629","t":"+14.3%","d":"up"},{"l":"Mitigações Ativas","v":"1.144","t":"+2.1%","d":"up"},{"l":"Score Risco Geral","v":"78","t":"+1.0%","d":"up"},{"l":"Incidentes YTD","v":"5.533","t":"+15.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.007","5.523","158","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.811","2.536","7.240","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.957","2.591","633","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.408","7.213","2.990","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.901","7.369","3.806","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":893},{"label":"Fev","value":669},{"label":"Mar","value":907},{"label":"Abr","value":863},{"label":"Mai","value":858},{"label":"Jun","value":814},{"label":"Jul","value":638},{"label":"Ago","value":771},{"label":"Set","value":618},{"label":"Out","value":726},{"label":"Nov","value":665},{"label":"Dez","value":848}];
const MX = 907;
