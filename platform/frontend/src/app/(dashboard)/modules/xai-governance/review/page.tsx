...
const PAGE = "Review";
const KPIS = [{"l":"Riscos Identificados","v":"8.102","t":"-5.9%","d":"down"},{"l":"Mitigações Ativas","v":"762","t":"+16.7%","d":"up"},{"l":"Score Risco Geral","v":"88","t":"+0.1%","d":"up"},{"l":"Incidentes YTD","v":"3.490","t":"+13.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.477","6.765","8.376","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.064","2.156","2.390","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.710","6.801","175","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.282","2.453","1.439","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.069","4.082","3.943","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":794},{"label":"Fev","value":673},{"label":"Mar","value":592},{"label":"Abr","value":637},{"label":"Mai","value":786},{"label":"Jun","value":589},{"label":"Jul","value":968},{"label":"Ago","value":595},{"label":"Set","value":767},{"label":"Out","value":959},{"label":"Nov","value":858},{"label":"Dez","value":690}];
const MX = 968;
