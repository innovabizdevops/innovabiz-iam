...
const PAGE = "Standard";
const KPIS = [{"l":"Riscos Identificados","v":"8.375","t":"+16.2%","d":"up"},{"l":"Mitigações Ativas","v":"7.681","t":"+9.9%","d":"up"},{"l":"Score Risco Geral","v":"87","t":"+5.8%","d":"up"},{"l":"Incidentes YTD","v":"4.832","t":"+12.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.683","4.844","2.537","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.188","7.512","2.598","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.870","5.204","7.465","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","919","2.808","5.563","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.747","3.951","3.404","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":257},{"label":"Fev","value":240},{"label":"Mar","value":348},{"label":"Abr","value":451},{"label":"Mai","value":249},{"label":"Jun","value":368},{"label":"Jul","value":293},{"label":"Ago","value":585},{"label":"Set","value":253},{"label":"Out","value":338},{"label":"Nov","value":426},{"label":"Dez","value":207}];
const MX = 585;
