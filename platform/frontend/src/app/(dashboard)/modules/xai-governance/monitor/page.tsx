...
const ACCENT = "#d97706";
const MODULE = "XAI Governance Framework";
const PAGE = "Monitor";
const KPIS = [{"l":"Riscos Identificados","v":"3.969","t":"-2.1%","d":"down"},{"l":"Mitigações Ativas","v":"5.694","t":"+15.5%","d":"up"},{"l":"Score Risco Geral","v":"93","t":"+17.8%","d":"up"},{"l":"Incidentes YTD","v":"4.141","t":"+17.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.377","2.164","1.462","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.931","2.005","1.294","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.765","1.912","1.113","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.772","7.722","5.517","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.206","5.973","3.546","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":626},{"label":"Mar","value":356},{"label":"Abr","value":472},{"label":"Mai","value":498},{"label":"Jun","value":570},{"label":"Jul","value":283},{"label":"Ago","value":337},{"label":"Set","value":564},{"label":"Out","value":295},{"label":"Nov","value":371},{"label":"Dez","value":511}];
const MX = 667;
