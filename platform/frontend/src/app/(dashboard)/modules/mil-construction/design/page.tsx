...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"4.522","t":"-5.8%","d":"down"},{"l":"Submissões/Dia","v":"256","t":"+10.8%","d":"up"},{"l":"Documentos Gerados","v":"8.764","t":"+13.3%","d":"up"},{"l":"Templates","v":"6.068","t":"+2.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","9.096","2026-02-20","6.486","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.698","2026-01-22","3.294","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.753","2026-03-03","4.972","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.227","2026-02-28","7.990","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.087","2026-01-24","9.064","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":555},{"label":"Mar","value":489},{"label":"Abr","value":675},{"label":"Mai","value":390},{"label":"Jun","value":541},{"label":"Jul","value":472},{"label":"Ago","value":393},{"label":"Set","value":533},{"label":"Out","value":391},{"label":"Nov","value":669},{"label":"Dez","value":734}];
const MX = 734;
