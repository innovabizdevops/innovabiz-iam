...
/* ═══ Military Construction — Dashboard ═══ */

const ACCENT = "#64748b";

const KPIS = [
    { label: "Total Registos", value: "1421", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3589", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€62K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1065884821", cells: ["MIL-6821", "Military Construction Item 1", "2/2/2026", "€34 921"], status: "active" as const },
    { id: "1065888392", cells: ["MIL-1392", "Military Construction Item 2", "17/9/2026", "€38 492"], status: "pending" as const },
    { id: "1065891963", cells: ["MIL-4963", "Military Construction Item 3", "4/4/2026", "€42 063"], status: "completed" as const },
    { id: "1065895534", cells: ["MIL-8534", "Military Construction Item 4", "19/11/2026", "€45 634"], status: "warning" as const },
    { id: "1065899105", cells: ["MIL-3105", "Military Construction Item 5", "6/6/2026", "€49 205"], status: "active" as const },
];
...
export default function MilitaryConstructionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Military Construction</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Military Construction</p>
                    </div>
                </div>
