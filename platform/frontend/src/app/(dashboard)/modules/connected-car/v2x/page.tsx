...
const ACCENT = "#9a3412";
const MODULE = "Connected Car";
const PAGE = "V2X Communication";
const KPIS = [{"l":"Total Connected Car","v":"4.707","t":"+11.4%","d":"up"},{"l":"V2X Communication Ativos","v":"4.081","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"64","t":"+14.1%","d":"up"}];
const COLS = ["ID","V2X Communication","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Connected Car #001","Connected Car #002","6.556","8.116","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Connected Car #002","Connected Car #003","1.823","3.709","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Connected Car #003","Connected Car #004","6.310","1.908","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Connected Car #004","Connected Car #005","1.752","6.187","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Connected Car #005","Connected Car #001","3.531","3.676","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":796},{"label":"Fev","value":546},{"label":"Mar","value":810},{"label":"Abr","value":859},{"label":"Mai","value":675},{"label":"Jun","value":806},{"label":"Jul","value":832},{"label":"Ago","value":762},{"label":"Set","value":897},{"label":"Out","value":827},{"label":"Nov","value":714},{"label":"Dez","value":547}];
const MX = 897;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#9a3412'}}>IoT</span></h1>
                </div>
