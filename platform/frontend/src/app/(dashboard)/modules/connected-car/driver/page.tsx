...
const PAGE = "Driver Score";
const KPIS = [{"l":"Total Connected Car","v":"2.626","t":"-4.5%","d":"down"},{"l":"Driver Score Ativos","v":"77","t":"-3.7%","d":"down"},{"l":"Eficiência (%)","v":"69.3%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"82","t":"-2.0%","d":"down"}];
const COLS = ["ID","Driver Score","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Connected Car #001","92.2%","5.117","1.363","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Connected Car #002","80.1%","5.382","1.351","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Connected Car #003","88.9%","3.584","4.017","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Connected Car #004","88.3%","2.431","7.441","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Connected Car #005","75.6%","5.550","745","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":902},{"label":"Fev","value":760},{"label":"Mar","value":911},{"label":"Abr","value":634},{"label":"Mai","value":544},{"label":"Jun","value":638},{"label":"Jul","value":688},{"label":"Ago","value":932},{"label":"Set","value":930},{"label":"Out","value":700},{"label":"Nov","value":882},{"label":"Dez","value":769}];
const MX = 932;
