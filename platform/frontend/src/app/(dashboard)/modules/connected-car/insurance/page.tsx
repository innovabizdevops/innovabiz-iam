...
const PAGE = "Insurance Plugin";
const KPIS = [{"l":"Total Connected Car","v":"5.245","t":"+10.2%","d":"up"},{"l":"Insurance Plugin Ativos","v":"7.215","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"80.1%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"80","t":"-2.5%","d":"down"}];
const COLS = ["ID","Insurance Plugin","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Connected Car #001","Connected Car #002","7.452","5.787","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Connected Car #002","Connected Car #003","8.720","4.737","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Connected Car #003","Connected Car #004","4.875","5.786","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Connected Car #004","Connected Car #005","5.232","2.607","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Connected Car #005","Connected Car #001","7.760","3.036","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":526},{"label":"Mar","value":710},{"label":"Abr","value":728},{"label":"Mai","value":663},{"label":"Jun","value":625},{"label":"Jul","value":719},{"label":"Ago","value":748},{"label":"Set","value":658},{"label":"Out","value":595},{"label":"Nov","value":483},{"label":"Dez","value":677}];
const MX = 748;
