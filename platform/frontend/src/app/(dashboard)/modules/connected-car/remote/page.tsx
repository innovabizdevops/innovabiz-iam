...
const PAGE = "Remote Cmd";
const KPIS = [{"l":"Total Connected Car","v":"8.824","t":"+14.1%","d":"up"},{"l":"Remote Cmd Ativos","v":"3.557","t":"+8.0%","d":"up"},{"l":"Eficiência (%)","v":"75.3%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"90","t":"+15.5%","d":"up"}];
const COLS = ["ID","Remote Cmd","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Connected Car #001","Connected Car #002","6.019","2.942","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Connected Car #002","Connected Car #003","6.054","2.809","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Connected Car #003","Connected Car #004","1.101","5.047","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Connected Car #004","Connected Car #005","7.119","6.363","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Connected Car #005","Connected Car #001","4.931","4.282","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":360},{"label":"Fev","value":735},{"label":"Mar","value":544},{"label":"Abr","value":737},{"label":"Mai","value":556},{"label":"Jun","value":733},{"label":"Jul","value":737},{"label":"Ago","value":456},{"label":"Set","value":589},{"label":"Out","value":691},{"label":"Nov","value":486},{"label":"Dez","value":346}];
const MX = 737;
