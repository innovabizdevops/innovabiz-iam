...
const KPIS = [{"l":"Integrações Ativas","v":"1.058","t":"+10.3%","d":"up"},{"l":"Chamadas/Hora","v":"533","t":"-0.6%","d":"down"},{"l":"Taxa Sucesso (%)","v":"69.9%","t":"+8.8%","d":"up"},{"l":"Latência Média (ms)","v":"116ms","t":"+17.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.865","7.597","91.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.519","2.134","90.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.054","6.931","70.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.313","7.799","96.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.838","3.964","87.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":584},{"label":"Mar","value":595},{"label":"Abr","value":452},{"label":"Mai","value":556},{"label":"Jun","value":451},{"label":"Jul","value":308},{"label":"Ago","value":543},{"label":"Set","value":305},{"label":"Out","value":462},{"label":"Nov","value":416},{"label":"Dez","value":499}];
const MX = 595;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#9a3412'}}>AI</span></h1>
                </div>
