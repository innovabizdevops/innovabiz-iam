...
const KPIS = [
    { label: "Total Registos", value: "7639", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4553", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€167K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1055595039", cells: ["AUT-4039", "Autonomous Database Item 1", "24/4/2026", "€45 139"], status: "active" as const },
    { id: "1055598610", cells: ["AUT-7610", "Autonomous Database Item 2", "11/11/2026", "€48 710"], status: "pending" as const },
    { id: "1055602181", cells: ["AUT-2181", "Autonomous Database Item 3", "26/6/2026", "€2281"], status: "completed" as const },
    { id: "1055605752", cells: ["AUT-5752", "Autonomous Database Item 4", "13/1/2026", "€5852"], status: "warning" as const },
    { id: "1055609323", cells: ["AUT-9323", "Autonomous Database Item 5", "28/8/2026", "€9423"], status: "active" as const },
];
...
export default function AutonomousDatabasePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Autonomous Database</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Autonomous Database</p>
                    </div>
                </div>
