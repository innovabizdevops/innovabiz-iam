...
const PAGE = "Backup";
const KPIS = [{"l":"BCP Plans Ativos","v":"3.078","t":"+8.2%","d":"up"},{"l":"RTO Médio (h)","v":"186h","t":"-4.5%","d":"down"},{"l":"RPO Médio (h)","v":"40h","t":"+5.2%","d":"up"},{"l":"Testes DR (YTD)","v":"866","t":"-2.8%","d":"down"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","48h","65h","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","142h","30h","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","194h","20h","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","79h","144h","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","202h","34h","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":857},{"label":"Mar","value":716},{"label":"Abr","value":731},{"label":"Mai","value":932},{"label":"Jun","value":767},{"label":"Jul","value":659},{"label":"Ago","value":801},{"label":"Set","value":575},{"label":"Out","value":950},{"label":"Nov","value":691},{"label":"Dez","value":634}];
const MX = 950;
