...
const ACCENT = "#6366f1";
const MODULE = "Autonomous Database";
const PAGE = "Tune";
const KPIS = [{"l":"Total Autonomous Database","v":"4.905","t":"+10.5%","d":"up"},{"l":"Tune Ativos","v":"5.090","t":"-5.3%","d":"down"},{"l":"Eficiência (%)","v":"68.3%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"73","t":"+8.7%","d":"up"}];
const COLS = ["ID","Tune","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Autonomous Database #001","Autonomous Database #002","6.061","3.307","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Autonomous Database #002","Autonomous Database #003","3.525","8.008","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Autonomous Database #003","Autonomous Database #004","304","5.347","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Autonomous Database #004","Autonomous Database #005","5.928","7.243","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Autonomous Database #005","Autonomous Database #001","5.032","8.466","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":822},{"label":"Fev","value":640},{"label":"Mar","value":709},{"label":"Abr","value":517},{"label":"Mai","value":588},{"label":"Jun","value":634},{"label":"Jul","value":703},{"label":"Ago","value":565},{"label":"Set","value":627},{"label":"Out","value":629},{"label":"Nov","value":545},{"label":"Dez","value":630}];
const MX = 822;
