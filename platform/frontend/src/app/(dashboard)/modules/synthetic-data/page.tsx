...
const KPIS = [
    { label: "Total Registos", value: "8931", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3802", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€441K", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "520649831", cells: ["SYN-9831", "Synthetic Data Generator Item 1", "24/12/2026", "€49 931"], status: "active" as const },
    { id: "520653402", cells: ["SYN-4402", "Synthetic Data Generator Item 2", "11/7/2026", "€3502"], status: "pending" as const },
    { id: "520656973", cells: ["SYN-7973", "Synthetic Data Generator Item 3", "26/2/2026", "€7073"], status: "completed" as const },
    { id: "520660544", cells: ["SYN-2544", "Synthetic Data Generator Item 4", "13/9/2026", "€10 644"], status: "warning" as const },
    { id: "520664115", cells: ["SYN-6115", "Synthetic Data Generator Item 5", "28/4/2026", "€14 215"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Synthetic Data Generator</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Synthetic Data Generator</p>
                    </div>
                </div>
