...
const ACCENT = "#8b5cf6";
const MODULE = "BioTech Platform Deep";
const PAGE = "Manufacture";
const KPIS = [{"l":"Dispositivos Online","v":"1.781","t":"-2.8%","d":"down"},{"l":"Dados/Min (MB)","v":"1.907","t":"-1.3%","d":"down"},{"l":"Alertas Ativos","v":"771","t":"+2.3%","d":"up"},{"l":"Uptime (%)","v":"79.8%","t":"+5.9%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.744","8.297","6.710","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.160","7.270","1.457","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.184","7.439","3.355","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.657","8.719","2.498","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","1.806","3.843","4.689","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":606},{"label":"Mar","value":382},{"label":"Abr","value":453},{"label":"Mai","value":242},{"label":"Jun","value":496},{"label":"Jul","value":444},{"label":"Ago","value":324},{"label":"Set","value":440},{"label":"Out","value":543},{"label":"Nov","value":273},{"label":"Dez","value":461}];
const MX = 606;
