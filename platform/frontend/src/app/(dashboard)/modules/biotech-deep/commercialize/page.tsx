...
const PAGE = "Commercialize";
const KPIS = [{"l":"Dispositivos Online","v":"1.692","t":"+1.4%","d":"up"},{"l":"Dados/Min (MB)","v":"1.848","t":"+10.9%","d":"up"},{"l":"Alertas Ativos","v":"7.070","t":"-3.1%","d":"down"},{"l":"Uptime (%)","v":"80.2%","t":"+2.7%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.546","162","8.046","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.513","926","5.679","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","408","5.571","5.283","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.518","5.093","3.240","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.938","6.626","7.311","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":841},{"label":"Mar","value":956},{"label":"Abr","value":922},{"label":"Mai","value":645},{"label":"Jun","value":634},{"label":"Jul","value":753},{"label":"Ago","value":899},{"label":"Set","value":746},{"label":"Out","value":931},{"label":"Nov","value":882},{"label":"Dez","value":892}];
const MX = 956;
...
export default function CommercializePage() {
    return (
