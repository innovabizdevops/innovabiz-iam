...
const KPIS = [{"l":"Dispositivos Online","v":"8.621","t":"+13.9%","d":"up"},{"l":"Dados/Min (MB)","v":"7.379","t":"+2.3%","d":"up"},{"l":"Alertas Ativos","v":"4.598","t":"+17.2%","d":"up"},{"l":"Uptime (%)","v":"84.1%","t":"+14.9%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.613","6.993","1.691","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.972","1.566","3.898","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.945","6.782","6.212","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.363","1.667","6.738","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.658","3.103","8.196","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":803},{"label":"Mar","value":478},{"label":"Abr","value":812},{"label":"Mai","value":634},{"label":"Jun","value":760},{"label":"Jul","value":641},{"label":"Ago","value":772},{"label":"Set","value":771},{"label":"Out","value":666},{"label":"Nov","value":725},{"label":"Dez","value":551}];
const MX = 812;
