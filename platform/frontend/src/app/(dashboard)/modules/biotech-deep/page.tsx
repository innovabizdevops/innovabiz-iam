...
/* ═══ BioTech Platform Deep — Dashboard ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total Registos", value: "1126", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3450", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€239K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "-9%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "599782626", cells: ["BIO-5626", "BioTech Platform Deep Item 1", "3/7/2026", "€32 726"], status: "active" as const },
    { id: "599786197", cells: ["BIO-9197", "BioTech Platform Deep Item 2", "18/2/2026", "€36 297"], status: "pending" as const },
    { id: "599789768", cells: ["BIO-3768", "BioTech Platform Deep Item 3", "5/9/2026", "€39 868"], status: "completed" as const },
    { id: "599793339", cells: ["BIO-7339", "BioTech Platform Deep Item 4", "20/4/2026", "€43 439"], status: "warning" as const },
    { id: "599796910", cells: ["BIO-1910", "BioTech Platform Deep Item 5", "7/11/2026", "€47 010"], status: "active" as const },
];
...
export default function BiotechPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">BioTech Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • BioTech Platform Deep</p>
                    </div>
                </div>
