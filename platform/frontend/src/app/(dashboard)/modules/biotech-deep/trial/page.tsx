...
const PAGE = "Trial";
const KPIS = [{"l":"Dispositivos Online","v":"9.077","t":"+14.4%","d":"up"},{"l":"Dados/Min (MB)","v":"7.231","t":"+10.9%","d":"up"},{"l":"Alertas Ativos","v":"3.707","t":"+11.1%","d":"up"},{"l":"Uptime (%)","v":"67.5%","t":"+14.9%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.859","632","689","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.369","1.745","7.543","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.740","3.985","6.487","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.529","4.785","2.987","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.754","3.628","5.308","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":915},{"label":"Mar","value":872},{"label":"Abr","value":708},{"label":"Mai","value":666},{"label":"Jun","value":851},{"label":"Jul","value":646},{"label":"Ago","value":696},{"label":"Set","value":945},{"label":"Out","value":745},{"label":"Nov","value":584},{"label":"Dez","value":726}];
const MX = 945;
