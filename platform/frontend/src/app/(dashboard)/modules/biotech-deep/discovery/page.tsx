...
const KPIS = [{"l":"Dispositivos Online","v":"3.204","t":"+15.3%","d":"up"},{"l":"Dados/Min (MB)","v":"3.790","t":"+13.8%","d":"up"},{"l":"Alertas Ativos","v":"1.639","t":"-4.8%","d":"down"},{"l":"Uptime (%)","v":"81.9%","t":"-2.8%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.752","2.028","8.108","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","1.707","3.365","1.617","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.034","1.645","3.252","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.853","1.099","2.470","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","1.160","723","4.281","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":557},{"label":"Mar","value":916},{"label":"Abr","value":873},{"label":"Mai","value":767},{"label":"Jun","value":913},{"label":"Jul","value":703},{"label":"Ago","value":660},{"label":"Set","value":893},{"label":"Out","value":819},{"label":"Nov","value":675},{"label":"Dez","value":843}];
const MX = 916;
