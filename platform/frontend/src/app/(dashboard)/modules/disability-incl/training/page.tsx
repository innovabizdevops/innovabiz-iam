...
const PAGE = "Training";
const KPIS = [{"l":"Total Disability Incl","v":"4.537","t":"-2.6%","d":"down"},{"l":"Training Ativos","v":"8.624","t":"+2.7%","d":"up"},{"l":"Eficiência (%)","v":"90.3%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"58","t":"+12.7%","d":"up"}];
const COLS = ["ID","Training","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Disability Incl #001","Disability Incl #002","5.275","6.701","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Disability Incl #002","Disability Incl #003","7.309","8.073","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Disability Incl #003","Disability Incl #004","8.402","5.368","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Disability Incl #004","Disability Incl #005","7.007","3.331","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Disability Incl #005","Disability Incl #001","3.528","7.882","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":409},{"label":"Fev","value":204},{"label":"Mar","value":239},{"label":"Abr","value":441},{"label":"Mai","value":415},{"label":"Jun","value":353},{"label":"Jul","value":406},{"label":"Ago","value":236},{"label":"Set","value":388},{"label":"Out","value":360},{"label":"Nov","value":401},{"label":"Dez","value":483}];
const MX = 483;
