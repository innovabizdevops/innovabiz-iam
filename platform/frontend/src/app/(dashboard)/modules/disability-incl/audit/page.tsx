...
const PAGE = "Access Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.608","t":"+9.4%","d":"up"},{"l":"NC Abertas","v":"2.243","t":"+6.5%","d":"up"},{"l":"Conformidade (%)","v":"92.1%","t":"-0.8%","d":"down"},{"l":"CAPAs Pendentes","v":"2.110","t":"+17.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.954","99.6%","1.731","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.794","94.3%","386","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.014","82.6%","5.686","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.198","82.7%","6.625","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.567","94.9%","5.056","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":398},{"label":"Mar","value":595},{"label":"Abr","value":463},{"label":"Mai","value":621},{"label":"Jun","value":366},{"label":"Jul","value":418},{"label":"Ago","value":393},{"label":"Set","value":564},{"label":"Out","value":682},{"label":"Nov","value":434},{"label":"Dez","value":444}];
const MX = 711;
