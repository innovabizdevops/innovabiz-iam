...
export default function DisabilityInclPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Disability Incl</h1><p className="text-sm text-muted-foreground">Disability Incl • iBOS Enterprise</p></div>
