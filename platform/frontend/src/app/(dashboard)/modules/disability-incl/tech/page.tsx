...
const ACCENT = "#4338ca";
const MODULE = "Disability Inclusion";
const PAGE = "Assistive Tech";
const KPIS = [{"l":"Total Disability Incl","v":"7.126","t":"+2.9%","d":"up"},{"l":"Assistive Tech Ativos","v":"3.989","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"88.0%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"55","t":"+1.9%","d":"up"}];
const COLS = ["ID","Assistive Tech","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Disability Incl #001","Disability Incl #002","4.348","5.098","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Disability Incl #002","Disability Incl #003","6.323","3.014","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Disability Incl #003","Disability Incl #004","4.373","8.141","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Disability Incl #004","Disability Incl #005","2.605","5.628","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Disability Incl #005","Disability Incl #001","5.361","4.400","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":863},{"label":"Fev","value":907},{"label":"Mar","value":807},{"label":"Abr","value":1014},{"label":"Mai","value":714},{"label":"Jun","value":743},{"label":"Jul","value":674},{"label":"Ago","value":861},{"label":"Set","value":803},{"label":"Out","value":975},{"label":"Nov","value":946},{"label":"Dez","value":749}];
const MX = 1014;
