...
const ACCENT = "#78350f";
const MODULE = "Payroll Outsourcing";
const PAGE = "Multi-Country";
const KPIS = [{"l":"Total Payroll Outsource","v":"5.668","t":"+10.1%","d":"up"},{"l":"Multi Country Ativos","v":"2.583","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"91.3%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"74","t":"+11.5%","d":"up"}];
const COLS = ["ID","Multi Country","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll Outsource #001","Payroll Outsource #002","7.024","5.507","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll Outsource #002","Payroll Outsource #003","5.784","3.792","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll Outsource #003","Payroll Outsource #004","8.751","7.712","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll Outsource #004","Payroll Outsource #005","2.569","3.667","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll Outsource #005","Payroll Outsource #001","2.768","6.043","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":902},{"label":"Fev","value":728},{"label":"Mar","value":637},{"label":"Abr","value":818},{"label":"Mai","value":634},{"label":"Jun","value":786},{"label":"Jul","value":909},{"label":"Ago","value":560},{"label":"Set","value":656},{"label":"Out","value":667},{"label":"Nov","value":623},{"label":"Dez","value":902}];
const MX = 909;
