...
export default function PayrollOutsourcePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Payroll Outsource</h1><p className="text-sm text-muted-foreground">Payroll Outsource • iBOS Enterprise</p></div>
