...
const PAGE = "Tax Calc";
const KPIS = [{"l":"Total Payroll Outsource","v":"1.319","t":"-4.7%","d":"down"},{"l":"Tax Calc Ativos","v":"3.074","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"85.8%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"74","t":"+8.9%","d":"up"}];
const COLS = ["ID","Tax Calc","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll Outsource #001","Payroll Outsource #002","4.501","1.180","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll Outsource #002","Payroll Outsource #003","7.862","5.649","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll Outsource #003","Payroll Outsource #004","4.730","3.148","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll Outsource #004","Payroll Outsource #005","3.515","7.162","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll Outsource #005","Payroll Outsource #001","6.068","1.815","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":940},{"label":"Fev","value":793},{"label":"Mar","value":841},{"label":"Abr","value":688},{"label":"Mai","value":824},{"label":"Jun","value":804},{"label":"Jul","value":904},{"label":"Ago","value":951},{"label":"Set","value":657},{"label":"Out","value":883},{"label":"Nov","value":613},{"label":"Dez","value":645}];
const MX = 951;
