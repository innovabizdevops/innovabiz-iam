...
const PAGE = "Pay Slip";
const KPIS = [{"l":"Total Payroll Outsource","v":"8.568","t":"+8.7%","d":"up"},{"l":"Pay Slip Ativos","v":"800","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"66.8%","t":"-0.2%","d":"down"},{"l":"Score Performance","v":"75","t":"+3.8%","d":"up"}];
const COLS = ["ID","Pay Slip","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll Outsource #001","Payroll Outsource #002","3.073","8.753","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll Outsource #002","Payroll Outsource #003","4.527","3.621","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll Outsource #003","Payroll Outsource #004","1.688","2.017","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll Outsource #004","Payroll Outsource #005","8.286","1.658","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll Outsource #005","Payroll Outsource #001","5.038","3.164","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":288},{"label":"Fev","value":479},{"label":"Mar","value":585},{"label":"Abr","value":243},{"label":"Mai","value":284},{"label":"Jun","value":352},{"label":"Jul","value":467},{"label":"Ago","value":229},{"label":"Set","value":471},{"label":"Out","value":565},{"label":"Nov","value":402},{"label":"Dez","value":285}];
const MX = 585;
