...
const PAGE = "Exits";
const KPIS = [{"l":"Total Private Equity","v":"5.968","t":"+5.3%","d":"up"},{"l":"Exits Ativos","v":"8.797","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"65.1%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"91","t":"-1.7%","d":"down"}];
const COLS = ["ID","Exits","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Private Equity #001","Private Equity #002","7.055","5.339","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Private Equity #002","Private Equity #003","216","9.012","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Private Equity #003","Private Equity #004","3.267","3.765","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Private Equity #004","Private Equity #005","3.165","3.102","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Private Equity #005","Private Equity #001","7.007","507","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":661},{"label":"Mar","value":797},{"label":"Abr","value":426},{"label":"Mai","value":705},{"label":"Jun","value":539},{"label":"Jul","value":543},{"label":"Ago","value":552},{"label":"Set","value":630},{"label":"Out","value":637},{"label":"Nov","value":742},{"label":"Dez","value":443}];
const MX = 797;
