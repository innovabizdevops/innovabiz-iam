...
const ACCENT = "#6366f1";
const MODULE = "Private Equity";
const PAGE = "Portfolio Co";
const KPIS = [{"l":"Total Private Equity","v":"4.153","t":"+-0.0%","d":"up"},{"l":"Portfolio Co Ativos","v":"4.396","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"89.0%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"81","t":"+9.4%","d":"up"}];
const COLS = ["ID","Portfolio Co","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Private Equity #001","Private Equity #002","5.144","1.323","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Private Equity #002","Private Equity #003","2.761","6.545","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Private Equity #003","Private Equity #004","4.856","8.625","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Private Equity #004","Private Equity #005","7.517","3.143","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Private Equity #005","Private Equity #001","7.702","3.114","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":730},{"label":"Mar","value":834},{"label":"Abr","value":924},{"label":"Mai","value":901},{"label":"Jun","value":967},{"label":"Jul","value":894},{"label":"Ago","value":726},{"label":"Set","value":861},{"label":"Out","value":909},{"label":"Nov","value":932},{"label":"Dez","value":929}];
const MX = 967;
...
export default function PortcoPage() {
    return (
