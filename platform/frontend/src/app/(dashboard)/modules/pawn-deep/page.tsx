...
/* ═══ Pawn Shop Deep — Dashboard ═══ */

const ACCENT = "#713f12";

const KPIS = [
    { label: "Total Registos", value: "7568", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2367", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€482K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1483037368", cells: ["PAW-9368", "Pawn Shop Deep Item 1", "9/5/2026", "€37 468"], status: "active" as const },
    { id: "1483040939", cells: ["PAW-3939", "Pawn Shop Deep Item 2", "24/12/2026", "€41 039"], status: "pending" as const },
    { id: "1483044510", cells: ["PAW-7510", "Pawn Shop Deep Item 3", "11/7/2026", "€44 610"], status: "completed" as const },
    { id: "1483048081", cells: ["PAW-2081", "Pawn Shop Deep Item 4", "26/2/2026", "€48 181"], status: "warning" as const },
    { id: "1483051652", cells: ["PAW-5652", "Pawn Shop Deep Item 5", "13/9/2026", "€1752"], status: "active" as const },
];
...
export default function PawnShopDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pawn Shop Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pawn Shop Deep</p>
                    </div>
                </div>
