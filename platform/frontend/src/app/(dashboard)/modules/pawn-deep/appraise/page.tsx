...
const ACCENT = "#713f12";
const MODULE = "Pawn Shop Deep";
const PAGE = "Appraise";
const KPIS = [{"l":"Total Pawn Deep","v":"316","t":"+1.0%","d":"up"},{"l":"Appraise Ativos","v":"4.802","t":"+17.3%","d":"up"},{"l":"Eficiência (%)","v":"71.6%","t":"+11.5%","d":"up"},{"l":"Score Performance","v":"87","t":"+8.1%","d":"up"}];
const COLS = ["ID","Appraise","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pawn Deep #001","Pawn Deep #002","6.166","6.035","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Pawn Deep #002","Pawn Deep #003","1.632","8.636","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Pawn Deep #003","Pawn Deep #004","8.448","2.150","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Pawn Deep #004","Pawn Deep #005","8.826","388","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pawn Deep #005","Pawn Deep #001","3.789","3.322","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":831},{"label":"Fev","value":929},{"label":"Mar","value":903},{"label":"Abr","value":934},{"label":"Mai","value":891},{"label":"Jun","value":656},{"label":"Jul","value":904},{"label":"Ago","value":663},{"label":"Set","value":773},{"label":"Out","value":755},{"label":"Nov","value":763},{"label":"Dez","value":767}];
const MX = 934;
