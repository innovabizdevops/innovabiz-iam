...
const KPIS = [{"l":"Total Pawn Deep","v":"4.742","t":"+2.3%","d":"up"},{"l":"Inventory Ativos","v":"1.848","t":"-3.9%","d":"down"},{"l":"Eficiência (%)","v":"86.5%","t":"+16.7%","d":"up"},{"l":"Score Performance","v":"76","t":"-3.6%","d":"down"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pawn Deep #001","Pawn Deep #002","2.898","3.009","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Pawn Deep #002","Pawn Deep #003","6.310","3.547","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Pawn Deep #003","Pawn Deep #004","8.616","5.132","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Pawn Deep #004","Pawn Deep #005","7.247","8.192","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pawn Deep #005","Pawn Deep #001","7.332","3.919","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":353},{"label":"Mar","value":388},{"label":"Abr","value":572},{"label":"Mai","value":543},{"label":"Jun","value":668},{"label":"Jul","value":436},{"label":"Ago","value":544},{"label":"Set","value":348},{"label":"Out","value":479},{"label":"Nov","value":447},{"label":"Dez","value":492}];
const MX = 668;
