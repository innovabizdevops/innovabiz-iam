...
const PAGE = "Loan";
const KPIS = [{"l":"Total Pawn Deep","v":"798","t":"+4.9%","d":"up"},{"l":"Loan Ativos","v":"2.490","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"56","t":"+3.7%","d":"up"}];
const COLS = ["ID","Loan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pawn Deep #001","Pawn Deep #002","6.111","3.027","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Pawn Deep #002","Pawn Deep #003","6.166","2.464","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Pawn Deep #003","Pawn Deep #004","7.754","8.681","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Pawn Deep #004","Pawn Deep #005","3.934","6.435","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pawn Deep #005","Pawn Deep #001","1.087","2.471","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":454},{"label":"Mar","value":424},{"label":"Abr","value":518},{"label":"Mai","value":596},{"label":"Jun","value":688},{"label":"Jul","value":486},{"label":"Ago","value":679},{"label":"Set","value":474},{"label":"Out","value":728},{"label":"Nov","value":608},{"label":"Dez","value":628}];
const MX = 767;
