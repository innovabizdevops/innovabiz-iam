...
/* ═══ MD: Multi-Timezone Engine — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "3091", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3727", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€131K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "-24%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1010456391", cells: ["MD-9391", "MD: Multi-Timezone Engine Item 1", "8/4/2026", "€6491"], status: "active" as const },
    { id: "1010459962", cells: ["MD-3962", "MD: Multi-Timezone Engine Item 2", "23/11/2026", "€10 062"], status: "pending" as const },
    { id: "1010463533", cells: ["MD-7533", "MD: Multi-Timezone Engine Item 3", "10/6/2026", "€13 633"], status: "completed" as const },
    { id: "1010467104", cells: ["MD-2104", "MD: Multi-Timezone Engine Item 4", "25/1/2026", "€17 204"], status: "warning" as const },
    { id: "1010470675", cells: ["MD-5675", "MD: Multi-Timezone Engine Item 5", "12/8/2026", "€20 775"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 91 }, { label: "Fev", value: 20 }, { label: "Mar", value: 29 }, { label: "Abr", value: 38 }, { label: "Mai", value: 47 }, { label: "Jun", value: 56 }];
...
export default function MdMultitimezoneEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Timezone Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Timezone Engine</p>
                    </div>
                </div>
