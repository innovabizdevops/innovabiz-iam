...
/* ═══ Marketing Automation (SFMC) — Dashboard ═══ */

const ACCENT = "#00a1e0";

const KPIS = [
    { label: "Total Registos", value: "3199", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1785", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€268K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "-7%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "458808699", cells: ["MAR-7699", "Marketing Automation (SFMC) Item 1", "28/4/2026", "€8799"], status: "active" as const },
    { id: "458812270", cells: ["MAR-2270", "Marketing Automation (SFMC) Item 2", "15/11/2026", "€12 370"], status: "pending" as const },
    { id: "458815841", cells: ["MAR-5841", "Marketing Automation (SFMC) Item 3", "2/6/2026", "€15 941"], status: "completed" as const },
    { id: "458819412", cells: ["MAR-9412", "Marketing Automation (SFMC) Item 4", "17/1/2026", "€19 512"], status: "warning" as const },
    { id: "458822983", cells: ["MAR-3983", "Marketing Automation (SFMC) Item 5", "4/8/2026", "€23 083"], status: "active" as const },
];
...
export default function MarketingAutomationSfmcPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Marketing Automation (SFMC)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Marketing Automation (SFMC)</p>
                    </div>
                </div>
