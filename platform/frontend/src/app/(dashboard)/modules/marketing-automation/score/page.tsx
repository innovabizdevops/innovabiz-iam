...
const ACCENT = "#00a1e0";
const MODULE = "Marketing Automation (SFMC)";
const PAGE = "Score";
const KPIS = [{"l":"Total Marketing Automation","v":"5.090","t":"-4.6%","d":"down"},{"l":"Score Ativos","v":"85","t":"+0.0%","d":"up"},{"l":"Eficiência (%)","v":"82.6%","t":"+12.2%","d":"up"},{"l":"Score Performance","v":"57","t":"+8.5%","d":"up"}];
const COLS = ["ID","Score","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marketing Automation #001","88.1%","5.325","5.882","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Marketing Automation #002","91.4%","313","6.444","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Marketing Automation #003","74.4%","4.412","4.851","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Marketing Automation #004","72.6%","3.013","1.977","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marketing Automation #005","79.2%","7.677","8.683","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":302},{"label":"Fev","value":592},{"label":"Mar","value":633},{"label":"Abr","value":561},{"label":"Mai","value":440},{"label":"Jun","value":338},{"label":"Jul","value":405},{"label":"Ago","value":529},{"label":"Set","value":383},{"label":"Out","value":630},{"label":"Nov","value":369},{"label":"Dez","value":372}];
const MX = 633;
