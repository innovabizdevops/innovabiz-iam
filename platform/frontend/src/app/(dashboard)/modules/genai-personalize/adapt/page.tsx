...
const ACCENT = "#6d28d9";
const MODULE = "GenAI Personalization";
const PAGE = "Adapt";
const KPIS = [{"l":"Perfis Unificados","v":"8.138","t":"+13.7%","d":"up"},{"l":"Segmentos Ativos","v":"2.717","t":"+14.1%","d":"up"},{"l":"NPS Score","v":"56","t":"+13.3%","d":"up"},{"l":"Churn Previsto (%)","v":"79.4%","t":"-2.4%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","4.931","€ 39256.81","93.0%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","1.786","€ 44592.17","80.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","8.511","€ 22324.57","99.8%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","9.094","€ 26984.31","85.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","6.781","€ 36207.84","78.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":518},{"label":"Fev","value":361},{"label":"Mar","value":368},{"label":"Abr","value":657},{"label":"Mai","value":390},{"label":"Jun","value":647},{"label":"Jul","value":681},{"label":"Ago","value":676},{"label":"Set","value":368},{"label":"Out","value":531},{"label":"Nov","value":563},{"label":"Dez","value":372}];
const MX = 681;
