...
/* ═══ GenAI Personalization — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "6438", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3736", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€315K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1823843738", cells: ["GEN-3738", "GenAI Personalization Item 1", "11/3/2026", "€43 838"], status: "active" as const },
    { id: "1823847309", cells: ["GEN-7309", "GenAI Personalization Item 2", "26/10/2026", "€47 409"], status: "pending" as const },
    { id: "1823850880", cells: ["GEN-1880", "GenAI Personalization Item 3", "13/5/2026", "€980"], status: "completed" as const },
    { id: "1823854451", cells: ["GEN-5451", "GenAI Personalization Item 4", "28/12/2026", "€4551"], status: "warning" as const },
    { id: "1823858022", cells: ["GEN-9022", "GenAI Personalization Item 5", "15/7/2026", "€8122"], status: "active" as const },
];
...
export default function GenaiPersonalizationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Personalization</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Personalization</p>
                    </div>
                </div>
