...
const PAGE = "Spillway";
const KPIS = [{"l":"Total Dam Mgmt","v":"398","t":"+9.0%","d":"up"},{"l":"Spillway Ativos","v":"102","t":"+2.8%","d":"up"},{"l":"Eficiência (%)","v":"90.1%","t":"+5.6%","d":"up"},{"l":"Score Performance","v":"57","t":"+4.0%","d":"up"}];
const COLS = ["ID","Spillway","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dam Mgmt #001","Dam Mgmt #002","7.271","5.387","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Dam Mgmt #002","Dam Mgmt #003","7.652","1.492","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Dam Mgmt #003","Dam Mgmt #004","151","2.546","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Dam Mgmt #004","Dam Mgmt #005","5.027","6.988","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dam Mgmt #005","Dam Mgmt #001","6.279","8.182","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":619},{"label":"Mar","value":699},{"label":"Abr","value":685},{"label":"Mai","value":633},{"label":"Jun","value":798},{"label":"Jul","value":812},{"label":"Ago","value":559},{"label":"Set","value":658},{"label":"Out","value":781},{"label":"Nov","value":709},{"label":"Dez","value":739}];
const MX = 812;
...
export default function SpillwayPage() {
    return (
