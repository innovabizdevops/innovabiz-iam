...
const PAGE = "Hydro Gen";
const KPIS = [{"l":"Total Dam Mgmt","v":"6.756","t":"-5.7%","d":"down"},{"l":"Hydro Gen Ativos","v":"4.896","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"70.8%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"73","t":"-1.8%","d":"down"}];
const COLS = ["ID","Hydro Gen","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dam Mgmt #001","Dam Mgmt #002","5.519","4.733","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Dam Mgmt #002","Dam Mgmt #003","1.508","4.130","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Dam Mgmt #003","Dam Mgmt #004","8.732","622","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Dam Mgmt #004","Dam Mgmt #005","1.864","3.785","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dam Mgmt #005","Dam Mgmt #001","8.905","3.303","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":832},{"label":"Mar","value":529},{"label":"Abr","value":583},{"label":"Mai","value":649},{"label":"Jun","value":635},{"label":"Jul","value":806},{"label":"Ago","value":728},{"label":"Set","value":745},{"label":"Out","value":780},{"label":"Nov","value":628},{"label":"Dez","value":803}];
const MX = 832;
