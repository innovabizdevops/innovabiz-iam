...
const ACCENT = "#6366f1";
const MODULE = "Dam Management";
const PAGE = "Structural";
const KPIS = [{"l":"Total Dam Mgmt","v":"5.419","t":"-0.7%","d":"down"},{"l":"Structural Ativos","v":"2.662","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"66.8%","t":"+16.3%","d":"up"},{"l":"Score Performance","v":"59","t":"+11.0%","d":"up"}];
const COLS = ["ID","Structural","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dam Mgmt #001","Dam Mgmt #002","428","4.927","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Dam Mgmt #002","Dam Mgmt #003","1.637","6.654","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Dam Mgmt #003","Dam Mgmt #004","8.690","5.072","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Dam Mgmt #004","Dam Mgmt #005","1.404","5.837","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dam Mgmt #005","Dam Mgmt #001","5.439","2.599","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":563},{"label":"Mar","value":583},{"label":"Abr","value":447},{"label":"Mai","value":701},{"label":"Jun","value":369},{"label":"Jul","value":448},{"label":"Ago","value":522},{"label":"Set","value":541},{"label":"Out","value":577},{"label":"Nov","value":618},{"label":"Dez","value":470}];
const MX = 701;
