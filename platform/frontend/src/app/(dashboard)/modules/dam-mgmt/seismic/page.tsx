...
const PAGE = "Seismic";
const KPIS = [{"l":"Total Dam Mgmt","v":"7.137","t":"+4.6%","d":"up"},{"l":"Seismic Ativos","v":"5.073","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"82.1%","t":"+15.9%","d":"up"},{"l":"Score Performance","v":"79","t":"+17.0%","d":"up"}];
const COLS = ["ID","Seismic","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dam Mgmt #001","Dam Mgmt #002","8.962","5.004","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Dam Mgmt #002","Dam Mgmt #003","2.840","1.546","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Dam Mgmt #003","Dam Mgmt #004","1.206","4.061","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Dam Mgmt #004","Dam Mgmt #005","3.159","6.876","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dam Mgmt #005","Dam Mgmt #001","1.883","6.962","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":693},{"label":"Mar","value":724},{"label":"Abr","value":496},{"label":"Mai","value":681},{"label":"Jun","value":522},{"label":"Jul","value":779},{"label":"Ago","value":481},{"label":"Set","value":677},{"label":"Out","value":807},{"label":"Nov","value":711},{"label":"Dez","value":468}];
const MX = 807;
