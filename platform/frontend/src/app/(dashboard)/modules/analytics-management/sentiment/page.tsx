...
const PAGE = "Analytics &amp; Insights";
const KPIS = [{"l":"Dashboards Ativos","v":"2.753","t":"+1.4%","d":"up"},{"l":"Queries/Dia","v":"3926","t":"+0.8%","d":"up"},{"l":"Dados Processados (GB)","v":"8.247","t":"+3.9%","d":"up"},{"l":"Utilizadores Analytics","v":"6.134","t":"+8.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","760","2026-01-09","891","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1030","2026-02-20","1.673","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2962","2026-03-26","224","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","752","2026-01-15","8.865","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1806","2026-01-15","5.855","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":805},{"label":"Mar","value":848},{"label":"Abr","value":658},{"label":"Mai","value":775},{"label":"Jun","value":572},{"label":"Jul","value":905},{"label":"Ago","value":713},{"label":"Set","value":683},{"label":"Out","value":812},{"label":"Nov","value":547},{"label":"Dez","value":613}];
const MX = 905;
