...
const PAGE = "Data Visualization";
const KPIS = [{"l":"Dashboards Ativos","v":"1.946","t":"-0.7%","d":"down"},{"l":"Queries/Dia","v":"263","t":"+17.1%","d":"up"},{"l":"Dados Processados (GB)","v":"2.735","t":"+17.5%","d":"up"},{"l":"Utilizadores Analytics","v":"3.206","t":"+1.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","984","2026-02-06","698","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1367","2026-01-27","3.158","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","800","2026-02-14","5.692","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4830","2026-01-01","2.096","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","989","2026-01-22","4.941","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":463},{"label":"Mar","value":582},{"label":"Abr","value":380},{"label":"Mai","value":636},{"label":"Jun","value":613},{"label":"Jul","value":647},{"label":"Ago","value":428},{"label":"Set","value":395},{"label":"Out","value":703},{"label":"Nov","value":345},{"label":"Dez","value":503}];
const MX = 703;
