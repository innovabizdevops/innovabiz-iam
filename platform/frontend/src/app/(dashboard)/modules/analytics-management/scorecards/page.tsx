...
const PAGE = "KPI Scorecards";
const KPIS = [{"l":"Dashboards Ativos","v":"5.789","t":"-2.2%","d":"down"},{"l":"Queries/Dia","v":"2582","t":"+9.3%","d":"up"},{"l":"Dados Processados (GB)","v":"672","t":"+13.1%","d":"up"},{"l":"Utilizadores Analytics","v":"8.003","t":"+5.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1424","2026-02-28","8.021","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1484","2026-02-16","2.208","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","5028","2026-01-20","7.003","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3018","2026-03-15","3.893","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4195","2026-01-09","4.469","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":470},{"label":"Fev","value":559},{"label":"Mar","value":526},{"label":"Abr","value":747},{"label":"Mai","value":778},{"label":"Jun","value":470},{"label":"Jul","value":553},{"label":"Ago","value":690},{"label":"Set","value":408},{"label":"Out","value":586},{"label":"Nov","value":706},{"label":"Dez","value":453}];
const MX = 778;
