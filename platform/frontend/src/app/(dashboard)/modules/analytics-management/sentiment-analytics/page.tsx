...
const KPIS = [{"l":"Dashboards Ativos","v":"4.522","t":"+10.2%","d":"up"},{"l":"Queries/Dia","v":"703","t":"+11.3%","d":"up"},{"l":"Dados Processados (GB)","v":"4.751","t":"+10.0%","d":"up"},{"l":"Utilizadores Analytics","v":"252","t":"+4.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3785","2026-03-18","4.361","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1041","2026-03-04","5.561","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1556","2026-01-20","8.661","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1488","2026-01-08","1.693","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1573","2026-02-17","2.011","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":629},{"label":"Mar","value":616},{"label":"Abr","value":577},{"label":"Mai","value":459},{"label":"Jun","value":656},{"label":"Jul","value":608},{"label":"Ago","value":669},{"label":"Set","value":548},{"label":"Out","value":641},{"label":"Nov","value":586},{"label":"Dez","value":648}];
const MX = 669;
