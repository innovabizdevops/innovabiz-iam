...
const PAGE = "Self-Service BI";
const KPIS = [{"l":"Dashboards Ativos","v":"4.035","t":"-4.3%","d":"down"},{"l":"Queries/Dia","v":"4629","t":"-3.4%","d":"down"},{"l":"Dados Processados (GB)","v":"1.582","t":"+1.6%","d":"up"},{"l":"Utilizadores Analytics","v":"8.065","t":"+7.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","475","2026-03-09","4.933","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2567","2026-01-25","1.850","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3857","2026-03-02","2.617","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3276","2026-02-04","4.838","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","481","2026-01-14","1.596","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":852},{"label":"Mar","value":823},{"label":"Abr","value":800},{"label":"Mai","value":738},{"label":"Jun","value":636},{"label":"Jul","value":804},{"label":"Ago","value":719},{"label":"Set","value":527},{"label":"Out","value":570},{"label":"Nov","value":742},{"label":"Dez","value":709}];
const MX = 852;
