...
const KPIS = [{"l":"Dashboards Ativos","v":"9.059","t":"-3.4%","d":"down"},{"l":"Queries/Dia","v":"1322","t":"+2.4%","d":"up"},{"l":"Dados Processados (GB)","v":"4.084","t":"+2.6%","d":"up"},{"l":"Utilizadores Analytics","v":"2.089","t":"+11.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3144","2026-01-04","6.894","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4305","2026-02-01","7.584","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","385","2026-02-14","9.018","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","622","2026-02-10","107","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","813","2026-03-03","4.162","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":714},{"label":"Fev","value":522},{"label":"Mar","value":512},{"label":"Abr","value":599},{"label":"Mai","value":779},{"label":"Jun","value":591},{"label":"Jul","value":576},{"label":"Ago","value":693},{"label":"Set","value":550},{"label":"Out","value":625},{"label":"Nov","value":789},{"label":"Dez","value":763}];
const MX = 789;
