...
const PAGE = "Embedded Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"4.692","t":"+1.0%","d":"up"},{"l":"Queries/Dia","v":"4002","t":"+6.0%","d":"up"},{"l":"Dados Processados (GB)","v":"3.957","t":"+1.3%","d":"up"},{"l":"Utilizadores Analytics","v":"7.620","t":"+0.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3112","2026-03-11","4.408","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2387","2026-01-14","253","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3942","2026-01-24","9.061","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3941","2026-03-03","8.880","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2520","2026-02-22","3.684","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":387},{"label":"Fev","value":561},{"label":"Mar","value":551},{"label":"Abr","value":409},{"label":"Mai","value":601},{"label":"Jun","value":440},{"label":"Jul","value":317},{"label":"Ago","value":423},{"label":"Set","value":238},{"label":"Out","value":421},{"label":"Nov","value":260},{"label":"Dez","value":269}];
const MX = 601;
