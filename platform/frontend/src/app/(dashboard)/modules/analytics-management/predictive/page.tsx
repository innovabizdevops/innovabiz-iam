...
const PAGE = "Predictive Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"2.600","t":"+5.5%","d":"up"},{"l":"Queries/Dia","v":"3344","t":"+1.5%","d":"up"},{"l":"Dados Processados (GB)","v":"1.844","t":"+1.2%","d":"up"},{"l":"Utilizadores Analytics","v":"661","t":"+16.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1165","2026-02-14","2.478","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","754","2026-02-13","8.890","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2751","2026-02-09","7.776","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3880","2026-01-23","4.467","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4138","2026-02-08","5.596","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":595},{"label":"Mar","value":471},{"label":"Abr","value":508},{"label":"Mai","value":554},{"label":"Jun","value":429},{"label":"Jul","value":411},{"label":"Ago","value":436},{"label":"Set","value":461},{"label":"Out","value":505},{"label":"Nov","value":407},{"label":"Dez","value":660}];
const MX = 660;
