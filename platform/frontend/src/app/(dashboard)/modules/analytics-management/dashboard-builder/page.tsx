...
const KPIS = [{"l":"Dashboards Ativos","v":"4.133","t":"+3.3%","d":"up"},{"l":"Queries/Dia","v":"2511","t":"-5.2%","d":"down"},{"l":"Dados Processados (GB)","v":"3.005","t":"+12.5%","d":"up"},{"l":"Utilizadores Analytics","v":"4.347","t":"+17.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4245","2026-03-16","6.062","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1971","2026-01-08","6.423","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","589","2026-01-22","5.171","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2298","2026-03-15","3.103","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2613","2026-03-13","1.078","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":775},{"label":"Mar","value":806},{"label":"Abr","value":889},{"label":"Mai","value":895},{"label":"Jun","value":849},{"label":"Jul","value":682},{"label":"Ago","value":751},{"label":"Set","value":544},{"label":"Out","value":761},{"label":"Nov","value":736},{"label":"Dez","value":814}];
const MX = 895;
