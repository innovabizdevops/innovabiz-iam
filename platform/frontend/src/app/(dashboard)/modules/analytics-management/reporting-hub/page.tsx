...
const PAGE = "Reporting &amp; Exec";
const KPIS = [{"l":"Dashboards Ativos","v":"2.353","t":"+13.9%","d":"up"},{"l":"Queries/Dia","v":"4353","t":"+6.7%","d":"up"},{"l":"Dados Processados (GB)","v":"3.537","t":"+16.7%","d":"up"},{"l":"Utilizadores Analytics","v":"6.192","t":"-1.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","621","2026-01-23","4.807","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1020","2026-02-27","8.962","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1369","2026-03-08","232","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","756","2026-01-14","4.503","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1271","2026-01-14","339","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":636},{"label":"Mar","value":745},{"label":"Abr","value":912},{"label":"Mai","value":815},{"label":"Jun","value":726},{"label":"Jul","value":900},{"label":"Ago","value":828},{"label":"Set","value":640},{"label":"Out","value":665},{"label":"Nov","value":916},{"label":"Dez","value":884}];
const MX = 916;
