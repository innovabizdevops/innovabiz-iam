...
const PAGE = "Scheduled Reports";
const KPIS = [{"l":"Dashboards Ativos","v":"6.651","t":"+2.4%","d":"up"},{"l":"Queries/Dia","v":"5034","t":"+0.9%","d":"up"},{"l":"Dados Processados (GB)","v":"4.802","t":"+12.6%","d":"up"},{"l":"Utilizadores Analytics","v":"3.811","t":"+13.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4397","2026-02-17","7.067","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1584","2026-03-24","8.999","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2347","2026-02-15","5.763","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2045","2026-01-06","1.485","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3821","2026-03-27","6.239","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":837},{"label":"Fev","value":850},{"label":"Mar","value":771},{"label":"Abr","value":775},{"label":"Mai","value":694},{"label":"Jun","value":539},{"label":"Jul","value":523},{"label":"Ago","value":728},{"label":"Set","value":877},{"label":"Out","value":860},{"label":"Nov","value":521},{"label":"Dez","value":684}];
const MX = 877;
