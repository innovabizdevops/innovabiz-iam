...
const PAGE = "Data Export API";
const KPIS = [{"l":"Dashboards Ativos","v":"4.654","t":"+16.1%","d":"up"},{"l":"Queries/Dia","v":"2124","t":"-0.3%","d":"down"},{"l":"Dados Processados (GB)","v":"614","t":"+3.3%","d":"up"},{"l":"Utilizadores Analytics","v":"7.589","t":"+14.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","747","2026-03-17","4.522","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3375","2026-01-12","4.537","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","482","2026-01-09","5.872","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1883","2026-03-10","4.981","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1646","2026-01-17","6.896","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":436},{"label":"Fev","value":553},{"label":"Mar","value":478},{"label":"Abr","value":513},{"label":"Mai","value":513},{"label":"Jun","value":782},{"label":"Jul","value":773},{"label":"Ago","value":419},{"label":"Set","value":465},{"label":"Out","value":646},{"label":"Nov","value":778},{"label":"Dez","value":615}];
const MX = 782;
