...
const PAGE = "Report Hub";
const KPIS = [{"l":"Formulários Ativos","v":"7.936","t":"-0.4%","d":"down"},{"l":"Submissões/Dia","v":"4873","t":"+16.2%","d":"up"},{"l":"Documentos Gerados","v":"5.522","t":"+5.9%","d":"up"},{"l":"Templates","v":"2.533","t":"+11.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.983","2026-02-04","1.375","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.616","2026-01-08","941","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.675","2026-02-24","3.194","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.216","2026-02-26","6.530","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","304","2026-01-19","3.207","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":667},{"label":"Mar","value":668},{"label":"Abr","value":815},{"label":"Mai","value":731},{"label":"Jun","value":749},{"label":"Jul","value":726},{"label":"Ago","value":655},{"label":"Set","value":856},{"label":"Out","value":588},{"label":"Nov","value":642},{"label":"Dez","value":755}];
const MX = 856;
...
export default function ReportingHubPlatformKernelPage() {
    return (
