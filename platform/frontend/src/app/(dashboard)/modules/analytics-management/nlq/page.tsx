...
const ACCENT = "#6366f1";
const MODULE = "Analytics Management";
const PAGE = "Natural Language Query";
const KPIS = [{"l":"Dashboards Ativos","v":"5.866","t":"+7.8%","d":"up"},{"l":"Queries/Dia","v":"2758","t":"+10.1%","d":"up"},{"l":"Dados Processados (GB)","v":"4.533","t":"+15.8%","d":"up"},{"l":"Utilizadores Analytics","v":"2.695","t":"+5.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3379","2026-01-07","8.970","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1869","2026-03-23","7.926","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","618","2026-01-08","5.340","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","609","2026-02-24","8.527","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2681","2026-01-23","7.525","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":897},{"label":"Mar","value":742},{"label":"Abr","value":831},{"label":"Mai","value":847},{"label":"Jun","value":840},{"label":"Jul","value":793},{"label":"Ago","value":746},{"label":"Set","value":811},{"label":"Out","value":928},{"label":"Nov","value":836},{"label":"Dez","value":957}];
const MX = 957;
