...
const PAGE = "Embedded BI";
const KPIS = [{"l":"Dashboards Ativos","v":"1.056","t":"+12.6%","d":"up"},{"l":"Queries/Dia","v":"3014","t":"-4.7%","d":"down"},{"l":"Dados Processados (GB)","v":"3.978","t":"-4.2%","d":"down"},{"l":"Utilizadores Analytics","v":"4.021","t":"+5.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","487","2026-02-19","4.404","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1957","2026-03-13","6.550","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1256","2026-02-16","3.460","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","587","2026-02-08","5.479","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2878","2026-02-05","1.727","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":852},{"label":"Fev","value":661},{"label":"Mar","value":766},{"label":"Abr","value":765},{"label":"Mai","value":1001},{"label":"Jun","value":808},{"label":"Jul","value":972},{"label":"Ago","value":916},{"label":"Set","value":866},{"label":"Out","value":644},{"label":"Nov","value":979},{"label":"Dez","value":918}];
const MX = 1001;
...
export default function EmbeddedBiPage() {
    return (
