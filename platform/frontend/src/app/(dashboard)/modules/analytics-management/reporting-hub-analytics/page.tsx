...
const PAGE = "Reporting Hub";
const KPIS = [{"l":"Dashboards Ativos","v":"6.317","t":"+11.2%","d":"up"},{"l":"Queries/Dia","v":"713","t":"+9.0%","d":"up"},{"l":"Dados Processados (GB)","v":"8.562","t":"+4.4%","d":"up"},{"l":"Utilizadores Analytics","v":"2.869","t":"+17.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3548","2026-03-02","2.268","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3134","2026-01-01","5.662","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","533","2026-03-28","6.296","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1463","2026-02-22","1.478","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","707","2026-01-23","1.426","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":518},{"label":"Mar","value":684},{"label":"Abr","value":513},{"label":"Mai","value":531},{"label":"Jun","value":590},{"label":"Jul","value":790},{"label":"Ago","value":819},{"label":"Set","value":750},{"label":"Out","value":443},{"label":"Nov","value":827},{"label":"Dez","value":723}];
const MX = 827;
...
export default function ReportingHubAnalyticsPage() {
    return (
