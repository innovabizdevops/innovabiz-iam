...
const ACCENT = "#1e40af";
const MODULE = "Planogram Management";
const PAGE = "Space Optimize";
const KPIS = [{"l":"Pedidos/Dia","v":"1395","t":"+4.4%","d":"up"},{"l":"GMV (€)","v":"€7712","t":"+13.7%","d":"up"},{"l":"Conversão (%)","v":"83.2%","t":"+10.7%","d":"up"},{"l":"AOV (€)","v":"€26978","t":"+16.3%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 14621.54","6.651","4.199","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 10389.20","7.940","2.391","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 28779.06","3.337","1.219","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 24599.92","6.834","1.441","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 26209.53","4.302","2.246","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":924},{"label":"Mar","value":790},{"label":"Abr","value":566},{"label":"Mai","value":658},{"label":"Jun","value":877},{"label":"Jul","value":674},{"label":"Ago","value":564},{"label":"Set","value":821},{"label":"Out","value":607},{"label":"Nov","value":579},{"label":"Dez","value":872}];
const MX = 924;
