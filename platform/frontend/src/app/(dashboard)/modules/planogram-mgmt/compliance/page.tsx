...
const KPIS = [{"l":"Auditorias Realizadas","v":"4.056","t":"+4.5%","d":"up"},{"l":"NC Abertas","v":"8.084","t":"+4.2%","d":"up"},{"l":"Conformidade (%)","v":"69.5%","t":"+14.8%","d":"up"},{"l":"CAPAs Pendentes","v":"8.093","t":"-1.9%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.524","80.0%","3.307","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.212","87.0%","3.823","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.546","97.9%","5.767","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.259","74.7%","8.773","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.264","78.3%","8.023","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":895},{"label":"Mar","value":878},{"label":"Abr","value":676},{"label":"Mai","value":621},{"label":"Jun","value":622},{"label":"Jul","value":819},{"label":"Ago","value":689},{"label":"Set","value":574},{"label":"Out","value":849},{"label":"Nov","value":843},{"label":"Dez","value":925}];
const MX = 925;
