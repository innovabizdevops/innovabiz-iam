...
/* ═══ Shipping Ops — Bill Of Lading ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "1675", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "487", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3952", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "208785251", cells: ["SHI-4251", "Bill Of Lading Item 1", "4/12/2026", "€35 351"], status: "active" as const },
    { id: "208788822", cells: ["SHI-7822", "Bill Of Lading Item 2", "19/7/2026", "€38 922"], status: "pending" as const },
    { id: "208792393", cells: ["SHI-2393", "Bill Of Lading Item 3", "6/2/2026", "€42 493"], status: "completed" as const },
    { id: "208795964", cells: ["SHI-5964", "Bill Of Lading Item 4", "21/9/2026", "€46 064"], status: "warning" as const },
    { id: "208799535", cells: ["SHI-9535", "Bill Of Lading Item 5", "8/4/2026", "€49 635"], status: "active" as const },
];
...
export default function ShippingOpsBillOfLadingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Bill Of Lading</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Shipping Ops • Bill Of Lading</p>
                    </div>
                </div>
