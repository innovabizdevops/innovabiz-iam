...
/* ═══ Shipping Ops — Maintenance Vessel ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "649", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "7", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3435", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1864199651", cells: ["SHI-3651", "Maintenance Vessel Item 1", "28/12/2026", "€49 751"], status: "active" as const },
    { id: "1864203222", cells: ["SHI-7222", "Maintenance Vessel Item 2", "15/7/2026", "€3322"], status: "pending" as const },
    { id: "1864206793", cells: ["SHI-1793", "Maintenance Vessel Item 3", "2/2/2026", "€6893"], status: "completed" as const },
    { id: "1864210364", cells: ["SHI-5364", "Maintenance Vessel Item 4", "17/9/2026", "€10 464"], status: "warning" as const },
    { id: "1864213935", cells: ["SHI-8935", "Maintenance Vessel Item 5", "4/4/2026", "€14 035"], status: "active" as const },
];
...
export default function ShippingOpsMaintenanceVesselPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Maintenance Vessel</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Shipping Ops • Maintenance Vessel</p>
                    </div>
                </div>
