...
/* ═══ Shipping Ops — Cargo Insurance ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "2364", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "192", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3699", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1604780924", cells: ["SHI-9924", "Cargo Insurance Item 1", "13/9/2026", "€31 024"], status: "active" as const },
    { id: "1604784495", cells: ["SHI-4495", "Cargo Insurance Item 2", "28/4/2026", "€34 595"], status: "pending" as const },
    { id: "1604788066", cells: ["SHI-8066", "Cargo Insurance Item 3", "15/11/2026", "€38 166"], status: "completed" as const },
    { id: "1604791637", cells: ["SHI-2637", "Cargo Insurance Item 4", "2/6/2026", "€41 737"], status: "warning" as const },
    { id: "1604795208", cells: ["SHI-6208", "Cargo Insurance Item 5", "17/1/2026", "€45 308"], status: "active" as const },
];
...
export default function ShippingOpsCargoInsurancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cargo Insurance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Shipping Ops • Cargo Insurance</p>
                    </div>
                </div>
