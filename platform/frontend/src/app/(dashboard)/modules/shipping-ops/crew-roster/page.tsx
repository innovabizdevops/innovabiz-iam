...
/* ═══ Shipping Ops — Crew Roster ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "3080", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "292", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2148", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1249696112", cells: ["SHI-2112", "Crew Roster Item 1", "1/9/2026", "€46 212"], status: "active" as const },
    { id: "1249699683", cells: ["SHI-5683", "Crew Roster Item 2", "16/4/2026", "€49 783"], status: "pending" as const },
    { id: "1249703254", cells: ["SHI-9254", "Crew Roster Item 3", "3/11/2026", "€3354"], status: "completed" as const },
    { id: "1249706825", cells: ["SHI-3825", "Crew Roster Item 4", "18/6/2026", "€6925"], status: "warning" as const },
    { id: "1249710396", cells: ["SHI-7396", "Crew Roster Item 5", "5/1/2026", "€10 496"], status: "active" as const },
];
...
export default function ShippingOpsCrewRosterPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Crew Roster</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Shipping Ops • Crew Roster</p>
                    </div>
                </div>
