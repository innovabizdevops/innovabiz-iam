...
/* ═══ Shipping Ops — Freight Forward ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "2014", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "178", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2975", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1466508014", cells: ["SHI-4014", "Freight Forward Item 1", "7/3/2026", "€8114"], status: "active" as const },
    { id: "1466511585", cells: ["SHI-7585", "Freight Forward Item 2", "22/10/2026", "€11 685"], status: "pending" as const },
    { id: "1466515156", cells: ["SHI-2156", "Freight Forward Item 3", "9/5/2026", "€15 256"], status: "completed" as const },
    { id: "1466518727", cells: ["SHI-5727", "Freight Forward Item 4", "24/12/2026", "€18 827"], status: "warning" as const },
    { id: "1466522298", cells: ["SHI-9298", "Freight Forward Item 5", "11/7/2026", "€22 398"], status: "active" as const },
];
...
export default function ShippingOpsFreightForwardPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Freight Forward</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Shipping Ops • Freight Forward</p>
                    </div>
                </div>
