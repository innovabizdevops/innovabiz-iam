...
/* ═══ Shipping Ops — Charter Mgmt ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "3901", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "356", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "173", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2128101264", cells: ["SHI-7264", "Charter Mgmt Item 1", "17/1/2026", "€1364"], status: "active" as const },
    { id: "2128104835", cells: ["SHI-1835", "Charter Mgmt Item 2", "4/8/2026", "€4935"], status: "pending" as const },
    { id: "2128108406", cells: ["SHI-5406", "Charter Mgmt Item 3", "19/3/2026", "€8506"], status: "completed" as const },
    { id: "2128111977", cells: ["SHI-8977", "Charter Mgmt Item 4", "6/10/2026", "€12 077"], status: "warning" as const },
    { id: "2128115548", cells: ["SHI-3548", "Charter Mgmt Item 5", "21/5/2026", "€15 648"], status: "active" as const },
];
...
export default function ShippingOpsCharterMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Charter Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Shipping Ops • Charter Mgmt</p>
                    </div>
                </div>
