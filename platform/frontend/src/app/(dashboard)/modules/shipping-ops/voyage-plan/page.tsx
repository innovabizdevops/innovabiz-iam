...
/* ═══ Shipping Ops — Voyage Plan ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "4774", trend: "-5%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "116", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3111", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "361376304", cells: ["SHI-9304", "Voyage Plan Item 1", "17/1/2026", "€26 404"], status: "active" as const },
    { id: "361379875", cells: ["SHI-3875", "Voyage Plan Item 2", "4/8/2026", "€29 975"], status: "pending" as const },
    { id: "361383446", cells: ["SHI-7446", "Voyage Plan Item 3", "19/3/2026", "€33 546"], status: "completed" as const },
    { id: "361387017", cells: ["SHI-2017", "Voyage Plan Item 4", "6/10/2026", "€37 117"], status: "warning" as const },
    { id: "361390588", cells: ["SHI-5588", "Voyage Plan Item 5", "21/5/2026", "€40 688"], status: "active" as const },
];
...
export default function ShippingOpsVoyagePlanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Voyage Plan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Shipping Ops • Voyage Plan</p>
                    </div>
                </div>
