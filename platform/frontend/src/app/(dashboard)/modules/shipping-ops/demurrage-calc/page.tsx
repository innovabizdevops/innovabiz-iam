...
/* ═══ Shipping Ops — Demurrage Calc ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "1439", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "251", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1990", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1856659207", cells: ["SHI-5207", "Demurrage Calc Item 1", "12/8/2026", "€9307"], status: "active" as const },
    { id: "1856662778", cells: ["SHI-8778", "Demurrage Calc Item 2", "27/3/2026", "€12 878"], status: "pending" as const },
    { id: "1856666349", cells: ["SHI-3349", "Demurrage Calc Item 3", "14/10/2026", "€16 449"], status: "completed" as const },
    { id: "1856669920", cells: ["SHI-6920", "Demurrage Calc Item 4", "1/5/2026", "€20 020"], status: "warning" as const },
    { id: "1856673491", cells: ["SHI-1491", "Demurrage Calc Item 5", "16/12/2026", "€23 591"], status: "active" as const },
];
...
export default function ShippingOpsDemurrageCalcPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Demurrage Calc</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Shipping Ops • Demurrage Calc</p>
                    </div>
                </div>
