...
/* ═══ Shipping Ops — Bunker Fuel ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "3110", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "451", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2616", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1586078015", cells: ["SHI-9015", "Bunker Fuel Item 1", "12/12/2026", "€28 115"], status: "active" as const },
    { id: "1586081586", cells: ["SHI-3586", "Bunker Fuel Item 2", "27/7/2026", "€31 686"], status: "pending" as const },
    { id: "1586085157", cells: ["SHI-7157", "Bunker Fuel Item 3", "14/2/2026", "€35 257"], status: "completed" as const },
    { id: "1586088728", cells: ["SHI-1728", "Bunker Fuel Item 4", "1/9/2026", "€38 828"], status: "warning" as const },
    { id: "1586092299", cells: ["SHI-5299", "Bunker Fuel Item 5", "16/4/2026", "€42 399"], status: "active" as const },
];
...
export default function ShippingOpsBunkerFuelPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Bunker Fuel</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Shipping Ops • Bunker Fuel</p>
                    </div>
                </div>
