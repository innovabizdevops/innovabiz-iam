...
/* ═══ Shipping Ops — Container Track ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "1000", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "466", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "425", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "409409294", cells: ["SHI-9294", "Container Track Item 1", "15/3/2026", "€9394"], status: "active" as const },
    { id: "409412865", cells: ["SHI-3865", "Container Track Item 2", "2/10/2026", "€12 965"], status: "pending" as const },
    { id: "409416436", cells: ["SHI-7436", "Container Track Item 3", "17/5/2026", "€16 536"], status: "completed" as const },
    { id: "409420007", cells: ["SHI-2007", "Container Track Item 4", "4/12/2026", "€20 107"], status: "warning" as const },
    { id: "409423578", cells: ["SHI-5578", "Container Track Item 5", "19/7/2026", "€23 678"], status: "active" as const },
];
...
export default function ShippingOpsContainerTrackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Container Track</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Shipping Ops • Container Track</p>
                    </div>
                </div>
