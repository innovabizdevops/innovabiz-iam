...
const PAGE = "Racing Team";
const KPIS = [{"l":"Teams Ativos","v":"6.589","t":"+8.5%","d":"up"},{"l":"Reuniões/Semana","v":"4942","t":"+12.0%","d":"up"},{"l":"Mensagens/Dia","v":"2255","t":"-3.0%","d":"down"},{"l":"Ficheiros Partilhados","v":"1.764","t":"+8.7%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.631","669","931","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","561","4962","2.159","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","2.834","1330","8.206","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","8.998","4582","6.036","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","4.447","2355","5.523","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":737},{"label":"Fev","value":711},{"label":"Mar","value":605},{"label":"Abr","value":844},{"label":"Mai","value":646},{"label":"Jun","value":587},{"label":"Jul","value":607},{"label":"Ago","value":969},{"label":"Set","value":700},{"label":"Out","value":605},{"label":"Nov","value":641},{"label":"Dez","value":812}];
const MX = 969;
