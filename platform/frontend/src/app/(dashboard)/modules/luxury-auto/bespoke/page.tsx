...
const ACCENT = "#475569";
const MODULE = "Luxury Automotive";
const PAGE = "Bespoke Config";
const KPIS = [{"l":"Configurações","v":"1.859","t":"+5.5%","d":"up"},{"l":"Últimas Alterações","v":"321","t":"+0.0%","d":"up"},{"l":"Ambientes","v":"7.029","t":"-0.5%","d":"down"},{"l":"Versão Config","v":"4.229","t":"+8.7%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 3872.90","8.516","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 41682.14","7.631","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 11288.78","3.590","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 27821.99","1.615","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 42108.65","6.167","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":471},{"label":"Mar","value":673},{"label":"Abr","value":423},{"label":"Mai","value":510},{"label":"Jun","value":446},{"label":"Jul","value":595},{"label":"Ago","value":653},{"label":"Set","value":467},{"label":"Out","value":592},{"label":"Nov","value":633},{"label":"Dez","value":643}];
const MX = 673;
