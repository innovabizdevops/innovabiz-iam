...
const ACCENT = "#6366f1";
const MODULE = "MVNO Analytics";
const PAGE = "Churn AI";
const KPIS = [{"l":"ARR (€M)","v":"€6.7M","t":"+12.9%","d":"up"},{"l":"MRR (€)","v":"€36931","t":"+14.6%","d":"up"},{"l":"Churn (%)","v":"76.7%","t":"+1.7%","d":"up"},{"l":"ARPU (€)","v":"€78926","t":"+8.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 49181.88","8.720","€ 10294.55","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 48719.55","5.432","€ 38766.99","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 29276.65","4.230","€ 20999.37","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 45297.60","2.164","€ 45388.87","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 8347.95","8.179","€ 9190.44","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":697},{"label":"Mar","value":605},{"label":"Abr","value":827},{"label":"Mai","value":766},{"label":"Jun","value":783},{"label":"Jul","value":825},{"label":"Ago","value":836},{"label":"Set","value":916},{"label":"Out","value":810},{"label":"Nov","value":613},{"label":"Dez","value":823}];
const MX = 943;
