...
const PAGE = "Network Usage";
const KPIS = [{"l":"Dashboards Ativos","v":"5.857","t":"+4.7%","d":"up"},{"l":"Queries/Dia","v":"3713","t":"+7.1%","d":"up"},{"l":"Dados Processados (GB)","v":"2.347","t":"+2.4%","d":"up"},{"l":"Utilizadores Analytics","v":"4.216","t":"-0.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","326","2026-03-23","1.439","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3635","2026-02-12","6.913","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","162","2026-03-04","3.835","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3097","2026-03-04","4.491","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3317","2026-03-27","860","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":694},{"label":"Mar","value":609},{"label":"Abr","value":950},{"label":"Mai","value":701},{"label":"Jun","value":695},{"label":"Jul","value":975},{"label":"Ago","value":653},{"label":"Set","value":623},{"label":"Out","value":769},{"label":"Nov","value":874},{"label":"Dez","value":974}];
const MX = 975;
