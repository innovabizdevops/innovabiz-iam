...
const PAGE = "Customer 360";
const KPIS = [{"l":"Dashboards Ativos","v":"8.799","t":"+0.5%","d":"up"},{"l":"Queries/Dia","v":"1451","t":"+13.9%","d":"up"},{"l":"Dados Processados (GB)","v":"5.168","t":"+9.7%","d":"up"},{"l":"Utilizadores Analytics","v":"3.775","t":"+8.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1767","2026-01-19","3.565","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3528","2026-01-21","6.731","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1193","2026-03-14","8.409","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4512","2026-03-03","7.765","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3834","2026-02-04","2.658","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":529},{"label":"Mar","value":596},{"label":"Abr","value":471},{"label":"Mai","value":559},{"label":"Jun","value":563},{"label":"Jul","value":455},{"label":"Ago","value":701},{"label":"Set","value":764},{"label":"Out","value":471},{"label":"Nov","value":462},{"label":"Dez","value":554}];
const MX = 764;
