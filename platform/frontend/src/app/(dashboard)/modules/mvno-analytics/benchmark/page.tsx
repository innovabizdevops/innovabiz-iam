...
const KPIS = [{"l":"Dashboards Ativos","v":"1.469","t":"+17.0%","d":"up"},{"l":"Queries/Dia","v":"4309","t":"-2.7%","d":"down"},{"l":"Dados Processados (GB)","v":"7.625","t":"-2.8%","d":"down"},{"l":"Utilizadores Analytics","v":"3.526","t":"+13.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","290","2026-02-18","3.795","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3648","2026-03-21","2.071","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4123","2026-03-24","3.822","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2477","2026-01-24","747","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1716","2026-02-01","7.851","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":729},{"label":"Mar","value":628},{"label":"Abr","value":583},{"label":"Mai","value":879},{"label":"Jun","value":604},{"label":"Jul","value":853},{"label":"Ago","value":629},{"label":"Set","value":717},{"label":"Out","value":738},{"label":"Nov","value":719},{"label":"Dez","value":581}];
const MX = 879;
