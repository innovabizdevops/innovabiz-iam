...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€23.3M","t":"+7.7%","d":"up"},{"l":"MRR (€)","v":"€95744","t":"-3.9%","d":"down"},{"l":"Churn (%)","v":"78.4%","t":"+10.4%","d":"up"},{"l":"ARPU (€)","v":"€95718","t":"+11.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 21442.50","4.533","€ 29261.85","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 6399.45","8.268","€ 49093.88","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 40886.76","6.863","€ 49370.10","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 6812.70","6.562","€ 43955.02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 28740.25","5.726","€ 17526.42","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":278},{"label":"Fev","value":511},{"label":"Mar","value":413},{"label":"Abr","value":316},{"label":"Mai","value":481},{"label":"Jun","value":586},{"label":"Jul","value":316},{"label":"Ago","value":462},{"label":"Set","value":362},{"label":"Out","value":515},{"label":"Nov","value":394},{"label":"Dez","value":630}];
const MX = 630;
