...
const PAGE = "Conversion Track";
const KPIS = [{"l":"Formulários Ativos","v":"3.327","t":"-1.5%","d":"down"},{"l":"Submissões/Dia","v":"2137","t":"-5.6%","d":"down"},{"l":"Documentos Gerados","v":"5.815","t":"-3.3%","d":"down"},{"l":"Templates","v":"428","t":"+5.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.268","2026-02-07","5.294","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.681","2026-02-16","8.294","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.962","2026-01-15","3.869","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.410","2026-02-25","588","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.321","2026-03-07","4.009","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":251},{"label":"Fev","value":368},{"label":"Mar","value":585},{"label":"Abr","value":394},{"label":"Mai","value":313},{"label":"Jun","value":288},{"label":"Jul","value":366},{"label":"Ago","value":293},{"label":"Set","value":468},{"label":"Out","value":249},{"label":"Nov","value":278},{"label":"Dez","value":607}];
const MX = 607;
