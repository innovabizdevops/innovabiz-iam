...
const PAGE = "Routing Rules";
const KPIS = [{"l":"Total Lead Scoring","v":"948","t":"+14.3%","d":"up"},{"l":"Routing Rules Ativos","v":"3.584","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"79.4%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"79","t":"+2.8%","d":"up"}];
const COLS = ["ID","Routing Rules","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lead Scoring #001","Lead Scoring #002","1.858","427","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Lead Scoring #002","Lead Scoring #003","2.243","4.124","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Lead Scoring #003","Lead Scoring #004","3.068","4.631","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Lead Scoring #004","Lead Scoring #005","187","4.841","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lead Scoring #005","Lead Scoring #001","7.260","5.116","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":931},{"label":"Fev","value":792},{"label":"Mar","value":952},{"label":"Abr","value":954},{"label":"Mai","value":567},{"label":"Jun","value":747},{"label":"Jul","value":601},{"label":"Ago","value":627},{"label":"Set","value":867},{"label":"Out","value":624},{"label":"Nov","value":656},{"label":"Dez","value":568}];
const MX = 954;
