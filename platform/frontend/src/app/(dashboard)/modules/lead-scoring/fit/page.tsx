...
const PAGE = "Fit vs Intent";
const KPIS = [{"l":"Total Lead Scoring","v":"3.131","t":"+10.4%","d":"up"},{"l":"Fit Vs Intent Ativos","v":"4.099","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"75.1%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"82","t":"-5.8%","d":"down"}];
const COLS = ["ID","Fit Vs Intent","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lead Scoring #001","Lead Scoring #002","3.953","9.056","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Lead Scoring #002","Lead Scoring #003","1.392","2.443","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Lead Scoring #003","Lead Scoring #004","2.174","5.323","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Lead Scoring #004","Lead Scoring #005","1.068","4.050","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lead Scoring #005","Lead Scoring #001","5.916","3.246","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":785},{"label":"Fev","value":548},{"label":"Mar","value":573},{"label":"Abr","value":768},{"label":"Mai","value":628},{"label":"Jun","value":560},{"label":"Jul","value":517},{"label":"Ago","value":596},{"label":"Set","value":800},{"label":"Out","value":530},{"label":"Nov","value":840},{"label":"Dez","value":491}];
const MX = 840;
