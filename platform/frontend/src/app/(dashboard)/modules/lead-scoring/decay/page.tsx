...
const PAGE = "Decay Config";
const KPIS = [{"l":"Configurações","v":"2.269","t":"+17.0%","d":"up"},{"l":"Últimas Alterações","v":"557","t":"-5.2%","d":"down"},{"l":"Ambientes","v":"3.065","t":"+15.4%","d":"up"},{"l":"Versão Config","v":"6.283","t":"-0.7%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 426.55","8.778","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 35514.31","3.548","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 8578.17","4.869","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 46571.26","8.238","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 27902.69","4.827","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":557},{"label":"Mar","value":670},{"label":"Abr","value":388},{"label":"Mai","value":387},{"label":"Jun","value":291},{"label":"Jul","value":580},{"label":"Ago","value":461},{"label":"Set","value":410},{"label":"Out","value":377},{"label":"Nov","value":563},{"label":"Dez","value":354}];
const MX = 670;
