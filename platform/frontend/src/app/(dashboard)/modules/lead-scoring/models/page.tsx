...
const ACCENT = "#059669";
const MODULE = "Lead Scoring";
const PAGE = "Score Models";
const KPIS = [{"l":"Total Lead Scoring","v":"2.929","t":"+7.5%","d":"up"},{"l":"Score Models Ativos","v":"87","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"94.8%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"94","t":"+-0.0%","d":"up"}];
const COLS = ["ID","Score Models","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lead Scoring #001","99.7%","8.150","843","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Lead Scoring #002","98.9%","2.550","7.541","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Lead Scoring #003","93.9%","5.540","7.514","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Lead Scoring #004","93.8%","8.902","5.789","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lead Scoring #005","76.4%","369","4.996","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":766},{"label":"Mar","value":665},{"label":"Abr","value":815},{"label":"Mai","value":612},{"label":"Jun","value":832},{"label":"Jul","value":504},{"label":"Ago","value":794},{"label":"Set","value":657},{"label":"Out","value":543},{"label":"Nov","value":773},{"label":"Dez","value":680}];
const MX = 832;
