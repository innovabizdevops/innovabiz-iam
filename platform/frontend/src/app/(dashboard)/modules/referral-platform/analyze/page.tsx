...
const PAGE = "Analyze";
const KPIS = [{"l":"Formulários Ativos","v":"4.491","t":"+11.1%","d":"up"},{"l":"Submissões/Dia","v":"4059","t":"+13.8%","d":"up"},{"l":"Documentos Gerados","v":"8.202","t":"+9.6%","d":"up"},{"l":"Templates","v":"8.422","t":"+5.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.033","2026-01-10","6.965","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.088","2026-03-27","8.324","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.102","2026-02-22","2.359","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.705","2026-02-26","8.556","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.398","2026-02-15","8.778","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":760},{"label":"Mar","value":694},{"label":"Abr","value":402},{"label":"Mai","value":614},{"label":"Jun","value":748},{"label":"Jul","value":759},{"label":"Ago","value":697},{"label":"Set","value":423},{"label":"Out","value":775},{"label":"Nov","value":462},{"label":"Dez","value":412}];
const MX = 775;
