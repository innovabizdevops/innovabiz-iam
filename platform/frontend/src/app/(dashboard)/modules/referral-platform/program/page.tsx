...
const PAGE = "Program";
const KPIS = [{"l":"Formulários Ativos","v":"272","t":"+8.9%","d":"up"},{"l":"Submissões/Dia","v":"2729","t":"+5.2%","d":"up"},{"l":"Documentos Gerados","v":"3.688","t":"-2.8%","d":"down"},{"l":"Templates","v":"7.288","t":"+3.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","236","2026-03-17","2.224","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.754","2026-01-26","3.215","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.625","2026-03-08","7.021","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.151","2026-03-14","8.281","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.019","2026-03-13","1.740","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":721},{"label":"Mar","value":710},{"label":"Abr","value":653},{"label":"Mai","value":701},{"label":"Jun","value":735},{"label":"Jul","value":599},{"label":"Ago","value":737},{"label":"Set","value":470},{"label":"Out","value":452},{"label":"Nov","value":739},{"label":"Dez","value":700}];
const MX = 739;
