...
/* ═══ Referral Marketing Platform — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "4706", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "648", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€476K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1941770806", cells: ["REF-3806", "Referral Marketing Platform Item 1", "11/11/2026", "€20 906"], status: "active" as const },
    { id: "1941774377", cells: ["REF-7377", "Referral Marketing Platform Item 2", "26/6/2026", "€24 477"], status: "pending" as const },
    { id: "1941777948", cells: ["REF-1948", "Referral Marketing Platform Item 3", "13/1/2026", "€28 048"], status: "completed" as const },
    { id: "1941781519", cells: ["REF-5519", "Referral Marketing Platform Item 4", "28/8/2026", "€31 619"], status: "warning" as const },
    { id: "1941785090", cells: ["REF-9090", "Referral Marketing Platform Item 5", "15/3/2026", "€35 190"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 26 }, { label: "Fev", value: 35 }, { label: "Mar", value: 44 }, { label: "Abr", value: 53 }, { label: "Mai", value: 62 }, { label: "Jun", value: 71 }];
...
export default function ReferralMarketingPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Referral Marketing Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Referral Marketing Platform</p>
                    </div>
                </div>
