...
const PAGE = "Reward";
const KPIS = [{"l":"Formulários Ativos","v":"5.069","t":"+13.9%","d":"up"},{"l":"Submissões/Dia","v":"2098","t":"-5.4%","d":"down"},{"l":"Documentos Gerados","v":"6.690","t":"+12.2%","d":"up"},{"l":"Templates","v":"5.734","t":"+9.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.454","2026-01-04","3.933","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.021","2026-01-27","583","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.376","2026-01-14","409","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","856","2026-02-24","3.549","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.874","2026-02-27","7.667","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":699},{"label":"Mar","value":703},{"label":"Abr","value":404},{"label":"Mai","value":562},{"label":"Jun","value":478},{"label":"Jul","value":668},{"label":"Ago","value":710},{"label":"Set","value":604},{"label":"Out","value":495},{"label":"Nov","value":635},{"label":"Dez","value":345}];
const MX = 710;
