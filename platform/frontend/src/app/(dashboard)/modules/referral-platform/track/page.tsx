...
const PAGE = "Track";
const KPIS = [{"l":"Formulários Ativos","v":"4.539","t":"-0.9%","d":"down"},{"l":"Submissões/Dia","v":"3570","t":"+15.4%","d":"up"},{"l":"Documentos Gerados","v":"7.741","t":"+11.3%","d":"up"},{"l":"Templates","v":"170","t":"+5.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","381","2026-01-25","7.744","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.601","2026-01-21","1.457","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.091","2026-01-25","494","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.936","2026-03-09","393","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","907","2026-02-03","7.846","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":472},{"label":"Mar","value":651},{"label":"Abr","value":624},{"label":"Mai","value":439},{"label":"Jun","value":456},{"label":"Jul","value":319},{"label":"Ago","value":368},{"label":"Set","value":375},{"label":"Out","value":511},{"label":"Nov","value":617},{"label":"Dez","value":662}];
const MX = 662;
