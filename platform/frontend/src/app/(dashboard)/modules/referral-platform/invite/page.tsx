...
const ACCENT = "#be185d";
const MODULE = "Referral Marketing Platform";
const PAGE = "Invite";
const KPIS = [{"l":"Formulários Ativos","v":"1.164","t":"+9.1%","d":"up"},{"l":"Submissões/Dia","v":"2802","t":"+8.3%","d":"up"},{"l":"Documentos Gerados","v":"4.122","t":"+14.5%","d":"up"},{"l":"Templates","v":"2.281","t":"+17.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.263","2026-03-20","2.550","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.648","2026-02-27","5.603","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.733","2026-02-22","5.128","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.023","2026-03-18","2.016","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","869","2026-01-17","8.159","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":957},{"label":"Fev","value":965},{"label":"Mar","value":680},{"label":"Abr","value":1021},{"label":"Mai","value":720},{"label":"Jun","value":745},{"label":"Jul","value":839},{"label":"Ago","value":850},{"label":"Set","value":659},{"label":"Out","value":847},{"label":"Nov","value":843},{"label":"Dez","value":657}];
const MX = 1021;
