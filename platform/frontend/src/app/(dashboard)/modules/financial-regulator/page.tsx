...
export default function FinancialRegulatorPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Financial Regulator</h1><p className="text-sm text-muted-foreground">Financial Regulator • iBOS Enterprise</p></div>
