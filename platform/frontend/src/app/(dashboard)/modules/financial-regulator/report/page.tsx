...
const PAGE = "Report";
const KPIS = [{"l":"Total Financial Regulator","v":"211","t":"-3.2%","d":"down"},{"l":"Report Ativos","v":"5.869","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"82.4%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"78","t":"+18.0%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Regulator #001","Financial Regulator #002","5.581","7.371","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Regulator #002","Financial Regulator #003","762","5.512","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Regulator #003","Financial Regulator #004","4.964","6.456","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Regulator #004","Financial Regulator #005","2.816","4.503","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Regulator #005","Financial Regulator #001","8.105","6.471","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":470},{"label":"Fev","value":631},{"label":"Mar","value":313},{"label":"Abr","value":473},{"label":"Mai","value":460},{"label":"Jun","value":624},{"label":"Jul","value":324},{"label":"Ago","value":243},{"label":"Set","value":523},{"label":"Out","value":333},{"label":"Nov","value":267},{"label":"Dez","value":329}];
const MX = 631;
