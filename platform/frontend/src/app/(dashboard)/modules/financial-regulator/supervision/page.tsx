...
const PAGE = "Supervisão";
const KPIS = [{"l":"Total Financial Regulator","v":"1.184","t":"+15.8%","d":"up"},{"l":"SupervisãO Ativos","v":"7.088","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"75.6%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"89","t":"+1.4%","d":"up"}];
const COLS = ["ID","SupervisãO","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Regulator #001","Financial Regulator #002","7.076","7.309","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Regulator #002","Financial Regulator #003","7.262","7.373","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Regulator #003","Financial Regulator #004","372","937","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Regulator #004","Financial Regulator #005","6.434","8.136","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Regulator #005","Financial Regulator #001","4.059","342","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":448},{"label":"Mar","value":508},{"label":"Abr","value":485},{"label":"Mai","value":447},{"label":"Jun","value":778},{"label":"Jul","value":635},{"label":"Ago","value":555},{"label":"Set","value":663},{"label":"Out","value":650},{"label":"Nov","value":794},{"label":"Dez","value":784}];
const MX = 794;
