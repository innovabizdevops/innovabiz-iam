...
const PAGE = "Licenciamento";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.781","t":"+13.3%","d":"up"},{"l":"Sessões/Dia","v":"2581","t":"+11.5%","d":"up"},{"l":"MFA Adoção (%)","v":"80.5%","t":"-0.8%","d":"down"},{"l":"Tentativas Bloqueadas","v":"2.605","t":"-3.7%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","4.210","2.029","1.284","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","9.061","7.363","3.524","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.746","1.770","4.751","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.267","8.040","2.626","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.178","1.128","1.945","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":655},{"label":"Mar","value":693},{"label":"Abr","value":547},{"label":"Mai","value":631},{"label":"Jun","value":594},{"label":"Jul","value":432},{"label":"Ago","value":429},{"label":"Set","value":664},{"label":"Out","value":489},{"label":"Nov","value":635},{"label":"Dez","value":438}];
const MX = 693;
