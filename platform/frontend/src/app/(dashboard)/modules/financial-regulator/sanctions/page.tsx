...
const PAGE = "Sanções";
const KPIS = [{"l":"Total Financial Regulator","v":"7.637","t":"+14.7%","d":"up"},{"l":"SançõEs Ativos","v":"6.623","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"93.3%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"76","t":"-5.4%","d":"down"}];
const COLS = ["ID","SançõEs","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Regulator #001","Financial Regulator #002","4.962","2.254","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Regulator #002","Financial Regulator #003","6.015","5.197","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Regulator #003","Financial Regulator #004","789","2.906","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Regulator #004","Financial Regulator #005","1.135","3.921","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Regulator #005","Financial Regulator #001","4.320","7.156","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":725},{"label":"Mar","value":757},{"label":"Abr","value":769},{"label":"Mai","value":644},{"label":"Jun","value":792},{"label":"Jul","value":831},{"label":"Ago","value":572},{"label":"Set","value":707},{"label":"Out","value":575},{"label":"Nov","value":705},{"label":"Dez","value":708}];
const MX = 831;
