...
const ACCENT = "#6366f1";
const MODULE = "Regulador Financeiro";
const PAGE = "Consumidor";
const KPIS = [{"l":"Total Financial Regulator","v":"4.512","t":"+2.5%","d":"up"},{"l":"Consumidor Ativos","v":"5.913","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"81.9%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"73","t":"+4.7%","d":"up"}];
const COLS = ["ID","Consumidor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Regulator #001","Financial Regulator #002","8.942","1.030","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Regulator #002","Financial Regulator #003","8.384","8.356","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Regulator #003","Financial Regulator #004","7.496","2.534","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Regulator #004","Financial Regulator #005","5.787","8.236","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Regulator #005","Financial Regulator #001","626","2.201","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":606},{"label":"Mar","value":868},{"label":"Abr","value":832},{"label":"Mai","value":580},{"label":"Jun","value":765},{"label":"Jul","value":856},{"label":"Ago","value":783},{"label":"Set","value":548},{"label":"Out","value":711},{"label":"Nov","value":636},{"label":"Dez","value":865}];
const MX = 868;
