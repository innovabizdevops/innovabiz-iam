...
const KPIS = [{"l":"Total Child Care","v":"5.998","t":"+16.2%","d":"up"},{"l":"Enrollment Ativos","v":"4.630","t":"+7.2%","d":"up"},{"l":"Eficiência (%)","v":"81.2%","t":"+1.5%","d":"up"},{"l":"Score Performance","v":"80","t":"+16.2%","d":"up"}];
const COLS = ["ID","Enrollment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Child Care #001","Child Care #002","8.849","7.460","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Child Care #002","Child Care #003","6.931","2.542","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Child Care #003","Child Care #004","3.821","4.035","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Child Care #004","Child Care #005","3.582","1.704","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Child Care #005","Child Care #001","6.025","4.446","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":510},{"label":"Mar","value":658},{"label":"Abr","value":337},{"label":"Mai","value":510},{"label":"Jun","value":387},{"label":"Jul","value":469},{"label":"Ago","value":699},{"label":"Set","value":607},{"label":"Out","value":691},{"label":"Nov","value":668},{"label":"Dez","value":700}];
const MX = 700;
