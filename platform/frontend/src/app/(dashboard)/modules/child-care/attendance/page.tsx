...
const ACCENT = "#6366f1";
const MODULE = "Child Care";
const PAGE = "Attendance";
const KPIS = [{"l":"Total Child Care","v":"8.075","t":"-2.2%","d":"down"},{"l":"Attendance Ativos","v":"8.550","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"89.5%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"70","t":"+12.8%","d":"up"}];
const COLS = ["ID","Attendance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Child Care #001","Child Care #002","436","2.585","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Child Care #002","Child Care #003","473","8.009","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Child Care #003","Child Care #004","7.528","2.374","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Child Care #004","Child Care #005","7.511","4.926","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Child Care #005","Child Care #001","7.323","6.687","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":349},{"label":"Fev","value":475},{"label":"Mar","value":593},{"label":"Abr","value":460},{"label":"Mai","value":379},{"label":"Jun","value":588},{"label":"Jul","value":510},{"label":"Ago","value":731},{"label":"Set","value":601},{"label":"Out","value":373},{"label":"Nov","value":452},{"label":"Dez","value":659}];
const MX = 731;
