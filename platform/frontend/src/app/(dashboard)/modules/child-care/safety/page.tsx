...
const PAGE = "Safety";
const KPIS = [{"l":"Total Child Care","v":"5.793","t":"+7.9%","d":"up"},{"l":"Safety Ativos","v":"4.462","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"92.1%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"92","t":"+15.6%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Child Care #001","Child Care #002","7.957","8.882","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Child Care #002","Child Care #003","4.621","630","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Child Care #003","Child Care #004","3.199","8.652","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Child Care #004","Child Care #005","8.504","8.573","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Child Care #005","Child Care #001","8.572","2.247","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":299},{"label":"Fev","value":493},{"label":"Mar","value":524},{"label":"Abr","value":390},{"label":"Mai","value":509},{"label":"Jun","value":484},{"label":"Jul","value":389},{"label":"Ago","value":682},{"label":"Set","value":359},{"label":"Out","value":596},{"label":"Nov","value":607},{"label":"Dez","value":646}];
const MX = 682;
