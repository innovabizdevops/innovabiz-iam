...
const PAGE = "Learning";
const KPIS = [{"l":"Total Child Care","v":"6.540","t":"+16.8%","d":"up"},{"l":"Learning Ativos","v":"665","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"67.0%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"67","t":"+6.7%","d":"up"}];
const COLS = ["ID","Learning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Child Care #001","Child Care #002","3.850","2.533","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Child Care #002","Child Care #003","4.876","7.400","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Child Care #003","Child Care #004","5.852","4.841","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Child Care #004","Child Care #005","8.663","863","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Child Care #005","Child Care #001","5.809","7.798","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":578},{"label":"Mar","value":383},{"label":"Abr","value":668},{"label":"Mai","value":668},{"label":"Jun","value":421},{"label":"Jul","value":393},{"label":"Ago","value":596},{"label":"Set","value":762},{"label":"Out","value":741},{"label":"Nov","value":586},{"label":"Dez","value":435}];
const MX = 762;
