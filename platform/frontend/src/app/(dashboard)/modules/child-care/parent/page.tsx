...
const PAGE = "Parent";
const KPIS = [{"l":"Total Child Care","v":"1.023","t":"+15.2%","d":"up"},{"l":"Parent Ativos","v":"3.439","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"86.6%","t":"+13.2%","d":"up"},{"l":"Score Performance","v":"89","t":"+13.4%","d":"up"}];
const COLS = ["ID","Parent","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Child Care #001","Child Care #002","8.862","7.085","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Child Care #002","Child Care #003","1.176","6.965","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Child Care #003","Child Care #004","3.282","817","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Child Care #004","Child Care #005","6.845","7.742","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Child Care #005","Child Care #001","943","6.826","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":936},{"label":"Fev","value":801},{"label":"Mar","value":676},{"label":"Abr","value":1013},{"label":"Mai","value":945},{"label":"Jun","value":1009},{"label":"Jul","value":1060},{"label":"Ago","value":721},{"label":"Set","value":812},{"label":"Out","value":882},{"label":"Nov","value":961},{"label":"Dez","value":696}];
const MX = 1060;
