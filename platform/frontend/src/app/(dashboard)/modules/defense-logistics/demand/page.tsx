...
const PAGE = "Org Demand";
const KPIS = [{"l":"Total Defense Logistics","v":"7.940","t":"-1.8%","d":"down"},{"l":"Org Demand Ativos","v":"8.621","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"78.9%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"70","t":"-3.0%","d":"down"}];
const COLS = ["ID","Org Demand","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense Logistics #001","Defense Logistics #002","7.615","1.498","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Defense Logistics #002","Defense Logistics #003","5.990","5.347","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense Logistics #003","Defense Logistics #004","5.656","5.006","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Defense Logistics #004","Defense Logistics #005","6.257","5.872","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense Logistics #005","Defense Logistics #001","6.930","5.425","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":646},{"label":"Fev","value":633},{"label":"Mar","value":804},{"label":"Abr","value":871},{"label":"Mai","value":919},{"label":"Jun","value":997},{"label":"Jul","value":737},{"label":"Ago","value":813},{"label":"Set","value":753},{"label":"Out","value":871},{"label":"Nov","value":707},{"label":"Dez","value":661}];
const MX = 997;
