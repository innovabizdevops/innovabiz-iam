...
export default function DefenseLogisticsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Defense Logistics</h1><p className="text-sm text-muted-foreground">Defense Logistics • iBOS Enterprise</p></div>
