...
const ACCENT = "#8b5cf6";
const MODULE = "Cortex AI";
const PAGE = "Training Pipeline";
const KPIS = [{"l":"Total Cortex Ai","v":"3.084","t":"-1.2%","d":"down"},{"l":"Training Pipeline Ativos","v":"4.097","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"76.3%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"94","t":"-4.2%","d":"down"}];
const COLS = ["ID","Training Pipeline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cortex Ai #001","Cortex Ai #002","7.275","3.883","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Cortex Ai #002","Cortex Ai #003","6.974","2.662","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Cortex Ai #003","Cortex Ai #004","2.179","5.225","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Cortex Ai #004","Cortex Ai #005","7.952","1.806","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cortex Ai #005","Cortex Ai #001","4.050","8.262","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":627},{"label":"Mar","value":584},{"label":"Abr","value":476},{"label":"Mai","value":763},{"label":"Jun","value":541},{"label":"Jul","value":612},{"label":"Ago","value":639},{"label":"Set","value":580},{"label":"Out","value":770},{"label":"Nov","value":670},{"label":"Dez","value":462}];
const MX = 770;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#8b5cf6'}}>MLOps</span></h1>
                </div>
