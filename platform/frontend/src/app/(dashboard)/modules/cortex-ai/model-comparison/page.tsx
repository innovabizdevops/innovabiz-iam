...
const PAGE = "Model Comparison";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.314","t":"-3.9%","d":"down"},{"l":"NC Abertas","v":"8.646","t":"+1.4%","d":"up"},{"l":"Conformidade (%)","v":"80.9%","t":"+6.0%","d":"up"},{"l":"CAPAs Pendentes","v":"5.357","t":"+2.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.149","83.0%","4.305","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.487","87.1%","7.182","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.395","70.4%","4.171","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.358","93.1%","414","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.908","75.9%","2.470","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":728},{"label":"Mar","value":744},{"label":"Abr","value":1002},{"label":"Mai","value":973},{"label":"Jun","value":952},{"label":"Jul","value":706},{"label":"Ago","value":638},{"label":"Set","value":747},{"label":"Out","value":862},{"label":"Nov","value":761},{"label":"Dez","value":627}];
const MX = 1002;
