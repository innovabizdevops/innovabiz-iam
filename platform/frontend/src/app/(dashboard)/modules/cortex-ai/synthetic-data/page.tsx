...
const PAGE = "Synthetic Data Gen";
const KPIS = [{"l":"Total Cortex Ai","v":"669","t":"+11.8%","d":"up"},{"l":"Synthetic Data Gen Ativos","v":"2.489","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"72.6%","t":"+2.3%","d":"up"},{"l":"Score Performance","v":"66","t":"+9.7%","d":"up"}];
const COLS = ["ID","Synthetic Data Gen","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cortex Ai #001","2026-01-13","2.474","1.996","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Cortex Ai #002","2026-03-23","3.259","1.527","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Cortex Ai #003","2026-02-08","804","4.149","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Cortex Ai #004","2026-03-03","1.872","3.313","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cortex Ai #005","2026-03-15","5.132","4.308","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":341},{"label":"Fev","value":670},{"label":"Mar","value":346},{"label":"Abr","value":517},{"label":"Mai","value":460},{"label":"Jun","value":375},{"label":"Jul","value":355},{"label":"Ago","value":485},{"label":"Set","value":312},{"label":"Out","value":429},{"label":"Nov","value":521},{"label":"Dez","value":324}];
const MX = 670;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#8b5cf6'}}>GenAI</span></h1>
                </div>
