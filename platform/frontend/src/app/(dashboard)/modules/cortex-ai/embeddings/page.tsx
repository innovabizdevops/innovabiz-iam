...
const PAGE = "Embedding Studio";
const KPIS = [{"l":"Dashboards Ativos","v":"7.085","t":"+6.1%","d":"up"},{"l":"Queries/Dia","v":"1868","t":"+9.2%","d":"up"},{"l":"Dados Processados (GB)","v":"2.628","t":"+0.1%","d":"up"},{"l":"Utilizadores Analytics","v":"4.999","t":"+4.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","101","2026-02-26","7.010","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4742","2026-01-08","982","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3232","2026-02-17","5.648","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2183","2026-02-18","1.335","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4478","2026-02-02","8.580","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":585},{"label":"Mar","value":743},{"label":"Abr","value":568},{"label":"Mai","value":773},{"label":"Jun","value":466},{"label":"Jul","value":762},{"label":"Ago","value":520},{"label":"Set","value":601},{"label":"Out","value":643},{"label":"Nov","value":513},{"label":"Dez","value":719}];
const MX = 773;
