...
const PAGE = "Autonomous Agents";
const KPIS = [{"l":"Total Cortex Ai","v":"6.253","t":"+15.4%","d":"up"},{"l":"Autonomous Agents Ativos","v":"854","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"68.0%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"69","t":"-5.8%","d":"down"}];
const COLS = ["ID","Autonomous Agents","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cortex Ai #001","Cortex Ai #002","1.432","2.737","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Cortex Ai #002","Cortex Ai #003","3.235","2.683","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Cortex Ai #003","Cortex Ai #004","8.226","3.932","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Cortex Ai #004","Cortex Ai #005","1.726","9.073","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cortex Ai #005","Cortex Ai #001","3.356","318","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":681},{"label":"Mar","value":749},{"label":"Abr","value":958},{"label":"Mai","value":665},{"label":"Jun","value":669},{"label":"Jul","value":770},{"label":"Ago","value":859},{"label":"Set","value":681},{"label":"Out","value":852},{"label":"Nov","value":637},{"label":"Dez","value":760}];
const MX = 958;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#8b5cf6'}}>Agentic</span></h1>
                </div>
