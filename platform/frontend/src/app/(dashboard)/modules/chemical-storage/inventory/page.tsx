...
const KPIS = [{"l":"Total Chemical Storage","v":"946","t":"+13.6%","d":"up"},{"l":"Inventory Ativos","v":"8.901","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"85.3%","t":"-1.8%","d":"down"},{"l":"Score Performance","v":"67","t":"-0.5%","d":"down"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemical Storage #001","Chemical Storage #002","7.095","2.215","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Chemical Storage #002","Chemical Storage #003","7.999","2.581","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemical Storage #003","Chemical Storage #004","4.055","4.735","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Chemical Storage #004","Chemical Storage #005","4.464","2.120","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemical Storage #005","Chemical Storage #001","5.961","7.701","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":314},{"label":"Mar","value":424},{"label":"Abr","value":537},{"label":"Mai","value":286},{"label":"Jun","value":450},{"label":"Jul","value":596},{"label":"Ago","value":246},{"label":"Set","value":340},{"label":"Out","value":282},{"label":"Nov","value":365},{"label":"Dez","value":416}];
const MX = 596;
