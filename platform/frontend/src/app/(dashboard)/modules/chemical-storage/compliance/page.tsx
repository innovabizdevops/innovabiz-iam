...
const KPIS = [{"l":"Auditorias Realizadas","v":"3.275","t":"+0.9%","d":"up"},{"l":"NC Abertas","v":"6.723","t":"-3.9%","d":"down"},{"l":"Conformidade (%)","v":"74.5%","t":"+17.0%","d":"up"},{"l":"CAPAs Pendentes","v":"2.341","t":"+15.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.410","79.6%","7.961","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.522","77.1%","7.039","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.238","93.3%","2.935","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.936","96.4%","5.503","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.571","83.4%","7.545","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":630},{"label":"Mar","value":703},{"label":"Abr","value":848},{"label":"Mai","value":554},{"label":"Jun","value":800},{"label":"Jul","value":938},{"label":"Ago","value":885},{"label":"Set","value":858},{"label":"Out","value":866},{"label":"Nov","value":900},{"label":"Dez","value":677}];
const MX = 938;
