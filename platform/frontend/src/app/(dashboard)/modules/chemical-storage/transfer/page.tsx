...
const PAGE = "Transfer";
const KPIS = [{"l":"Total Chemical Storage","v":"7.110","t":"+12.9%","d":"up"},{"l":"Transfer Ativos","v":"5.531","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"65.7%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"72","t":"+13.8%","d":"up"}];
const COLS = ["ID","Transfer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemical Storage #001","Chemical Storage #002","8.867","6.681","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Chemical Storage #002","Chemical Storage #003","1.871","2.840","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemical Storage #003","Chemical Storage #004","5.366","4.091","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Chemical Storage #004","Chemical Storage #005","1.530","4.853","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemical Storage #005","Chemical Storage #001","980","4.670","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":518},{"label":"Mar","value":607},{"label":"Abr","value":330},{"label":"Mai","value":418},{"label":"Jun","value":568},{"label":"Jul","value":466},{"label":"Ago","value":322},{"label":"Set","value":506},{"label":"Out","value":438},{"label":"Nov","value":417},{"label":"Dez","value":630}];
const MX = 630;
