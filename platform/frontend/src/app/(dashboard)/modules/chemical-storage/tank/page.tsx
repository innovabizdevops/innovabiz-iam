...
const ACCENT = "#6366f1";
const MODULE = "Chemical Storage";
const PAGE = "Tank Farm";
const KPIS = [{"l":"Total Chemical Storage","v":"7.694","t":"-4.8%","d":"down"},{"l":"Tank Farm Ativos","v":"8.212","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"94.2%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"88","t":"+2.9%","d":"up"}];
const COLS = ["ID","Tank Farm","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemical Storage #001","Chemical Storage #002","1.335","3.414","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Chemical Storage #002","Chemical Storage #003","5.406","1.415","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemical Storage #003","Chemical Storage #004","6.220","4.258","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Chemical Storage #004","Chemical Storage #005","525","7.232","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemical Storage #005","Chemical Storage #001","2.583","1.525","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":728},{"label":"Mar","value":531},{"label":"Abr","value":751},{"label":"Mai","value":607},{"label":"Jun","value":825},{"label":"Jul","value":804},{"label":"Ago","value":574},{"label":"Set","value":570},{"label":"Out","value":604},{"label":"Nov","value":518},{"label":"Dez","value":791}];
const MX = 825;
