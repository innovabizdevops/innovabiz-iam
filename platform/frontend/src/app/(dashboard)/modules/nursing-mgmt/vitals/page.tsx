...
const ACCENT = "#6366f1";
const MODULE = "Nursing Management";
const PAGE = "Vitals";
const KPIS = [{"l":"Total Nursing Mgmt","v":"2.845","t":"+1.3%","d":"up"},{"l":"Vitals Ativos","v":"6.138","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"68.8%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"64","t":"+15.4%","d":"up"}];
const COLS = ["ID","Vitals","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nursing Mgmt #001","Nursing Mgmt #002","7.561","7.541","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Nursing Mgmt #002","Nursing Mgmt #003","2.514","3.247","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Nursing Mgmt #003","Nursing Mgmt #004","2.219","4.186","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Nursing Mgmt #004","Nursing Mgmt #005","3.891","417","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nursing Mgmt #005","Nursing Mgmt #001","6.643","1.506","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":496},{"label":"Mar","value":495},{"label":"Abr","value":725},{"label":"Mai","value":780},{"label":"Jun","value":681},{"label":"Jul","value":546},{"label":"Ago","value":520},{"label":"Set","value":406},{"label":"Out","value":780},{"label":"Nov","value":751},{"label":"Dez","value":796}];
const MX = 796;
