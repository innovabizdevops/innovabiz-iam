...
const KPIS = [{"l":"Total Nursing Mgmt","v":"5.953","t":"+18.0%","d":"up"},{"l":"Care Plan Ativos","v":"7.168","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"70.5%","t":"-3.1%","d":"down"},{"l":"Score Performance","v":"64","t":"+17.6%","d":"up"}];
const COLS = ["ID","Care Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nursing Mgmt #001","Nursing Mgmt #002","2.257","6.447","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Nursing Mgmt #002","Nursing Mgmt #003","2.587","2.888","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Nursing Mgmt #003","Nursing Mgmt #004","2.523","6.913","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Nursing Mgmt #004","Nursing Mgmt #005","4.515","2.842","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nursing Mgmt #005","Nursing Mgmt #001","6.708","644","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":804},{"label":"Mar","value":781},{"label":"Abr","value":680},{"label":"Mai","value":540},{"label":"Jun","value":505},{"label":"Jul","value":844},{"label":"Ago","value":556},{"label":"Set","value":841},{"label":"Out","value":900},{"label":"Nov","value":763},{"label":"Dez","value":806}];
const MX = 900;
