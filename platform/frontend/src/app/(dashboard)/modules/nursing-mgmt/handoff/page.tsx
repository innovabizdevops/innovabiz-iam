...
const PAGE = "Handoff";
const KPIS = [{"l":"Total Nursing Mgmt","v":"2.246","t":"+5.6%","d":"up"},{"l":"Handoff Ativos","v":"6.223","t":"+6.0%","d":"up"},{"l":"Eficiência (%)","v":"73.5%","t":"+5.0%","d":"up"},{"l":"Score Performance","v":"59","t":"-5.2%","d":"down"}];
const COLS = ["ID","Handoff","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nursing Mgmt #001","Nursing Mgmt #002","2.665","648","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Nursing Mgmt #002","Nursing Mgmt #003","3.092","5.073","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Nursing Mgmt #003","Nursing Mgmt #004","3.854","6.984","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Nursing Mgmt #004","Nursing Mgmt #005","6.877","8.173","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nursing Mgmt #005","Nursing Mgmt #001","8.647","3.177","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":341},{"label":"Mar","value":608},{"label":"Abr","value":309},{"label":"Mai","value":215},{"label":"Jun","value":313},{"label":"Jul","value":386},{"label":"Ago","value":343},{"label":"Set","value":504},{"label":"Out","value":508},{"label":"Nov","value":509},{"label":"Dez","value":323}];
const MX = 608;
