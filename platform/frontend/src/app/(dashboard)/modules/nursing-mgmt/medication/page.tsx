...
const KPIS = [{"l":"Integrações Ativas","v":"6.784","t":"+8.6%","d":"up"},{"l":"Chamadas/Hora","v":"3722","t":"-4.5%","d":"down"},{"l":"Taxa Sucesso (%)","v":"93.5%","t":"+0.6%","d":"up"},{"l":"Latência Média (ms)","v":"192ms","t":"+9.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.500","6.629","76.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.229","3.633","93.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","370","6.979","74.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.256","6.282","96.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.447","1.798","83.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":348},{"label":"Fev","value":395},{"label":"Mar","value":496},{"label":"Abr","value":356},{"label":"Mai","value":472},{"label":"Jun","value":483},{"label":"Jul","value":417},{"label":"Ago","value":444},{"label":"Set","value":465},{"label":"Out","value":659},{"label":"Nov","value":346},{"label":"Dez","value":639}];
const MX = 659;
