...
const KPIS = [{"l":"Total Nursing Mgmt","v":"444","t":"+15.0%","d":"up"},{"l":"Assessment Ativos","v":"7.218","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"84.8%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"93","t":"+7.3%","d":"up"}];
const COLS = ["ID","Assessment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nursing Mgmt #001","Nursing Mgmt #002","3.789","5.239","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Nursing Mgmt #002","Nursing Mgmt #003","489","538","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Nursing Mgmt #003","Nursing Mgmt #004","1.782","2.643","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Nursing Mgmt #004","Nursing Mgmt #005","982","1.068","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nursing Mgmt #005","Nursing Mgmt #001","8.457","9.081","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":774},{"label":"Mar","value":686},{"label":"Abr","value":474},{"label":"Mai","value":670},{"label":"Jun","value":784},{"label":"Jul","value":683},{"label":"Ago","value":521},{"label":"Set","value":768},{"label":"Out","value":512},{"label":"Nov","value":795},{"label":"Dez","value":800}];
const MX = 800;
