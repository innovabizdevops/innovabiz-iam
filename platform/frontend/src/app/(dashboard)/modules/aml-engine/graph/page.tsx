...
const PAGE = "Network Graph";
const KPIS = [{"l":"Total Aml Engine","v":"2.348","t":"+2.1%","d":"up"},{"l":"Network Graph Ativos","v":"5.234","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"79.2%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"72","t":"+13.5%","d":"up"}];
const COLS = ["ID","Network Graph","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aml Engine #001","Aml Engine #002","7.834","2.951","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Aml Engine #002","Aml Engine #003","8.223","3.123","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Aml Engine #003","Aml Engine #004","723","6.079","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Aml Engine #004","Aml Engine #005","6.436","4.647","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aml Engine #005","Aml Engine #001","1.881","577","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":341},{"label":"Mar","value":485},{"label":"Abr","value":252},{"label":"Mai","value":264},{"label":"Jun","value":342},{"label":"Jul","value":586},{"label":"Ago","value":597},{"label":"Set","value":472},{"label":"Out","value":238},{"label":"Nov","value":333},{"label":"Dez","value":313}];
const MX = 597;
