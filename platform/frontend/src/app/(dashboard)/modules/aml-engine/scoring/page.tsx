...
const PAGE = "Risk Scoring";
const KPIS = [{"l":"Riscos Identificados","v":"3.706","t":"-1.1%","d":"down"},{"l":"Mitigações Ativas","v":"6.544","t":"-3.6%","d":"down"},{"l":"Score Risco Geral","v":"74","t":"+12.7%","d":"up"},{"l":"Incidentes YTD","v":"4.020","t":"+14.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.787","1.331","3.962","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","962","3.875","4.482","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","744","8.992","7.029","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","631","594","5.457","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.015","5.935","8.026","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":752},{"label":"Mar","value":770},{"label":"Abr","value":741},{"label":"Mai","value":538},{"label":"Jun","value":771},{"label":"Jul","value":649},{"label":"Ago","value":796},{"label":"Set","value":581},{"label":"Out","value":528},{"label":"Nov","value":530},{"label":"Dez","value":722}];
const MX = 796;
