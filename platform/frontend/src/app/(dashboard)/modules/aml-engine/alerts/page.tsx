...
const PAGE = "Alert Mgmt";
const KPIS = [{"l":"Notificações Enviadas","v":"6.027","t":"+11.0%","d":"up"},{"l":"Taxa Entrega (%)","v":"86.0%","t":"+1.2%","d":"up"},{"l":"Taxa Abertura (%)","v":"82.3%","t":"+5.2%","d":"up"},{"l":"Escalações","v":"3.273","t":"+9.8%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","1.987","89.2%","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","6.126","91.9%","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","1.283","98.4%","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","3.212","95.1%","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","2.725","78.4%","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":769},{"label":"Fev","value":767},{"label":"Mar","value":614},{"label":"Abr","value":786},{"label":"Mai","value":751},{"label":"Jun","value":807},{"label":"Jul","value":837},{"label":"Ago","value":952},{"label":"Set","value":894},{"label":"Out","value":692},{"label":"Nov","value":909},{"label":"Dez","value":919}];
const MX = 952;
