...
const ACCENT = "#1e40af";
const MODULE = "AML Engine";
const PAGE = "Entity Resolution";
const KPIS = [{"l":"Total Aml Engine","v":"2.920","t":"+0.5%","d":"up"},{"l":"Entity Resolution Ativos","v":"7.014","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"68.1%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"62","t":"+8.5%","d":"up"}];
const COLS = ["ID","Entity Resolution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aml Engine #001","Aml Engine #002","6.852","2.171","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Aml Engine #002","Aml Engine #003","3.152","7.410","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Aml Engine #003","Aml Engine #004","8.287","5.407","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Aml Engine #004","Aml Engine #005","4.659","5.759","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aml Engine #005","Aml Engine #001","6.034","8.015","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":741},{"label":"Fev","value":782},{"label":"Mar","value":564},{"label":"Abr","value":557},{"label":"Mai","value":829},{"label":"Jun","value":720},{"label":"Jul","value":757},{"label":"Ago","value":723},{"label":"Set","value":776},{"label":"Out","value":616},{"label":"Nov","value":822},{"label":"Dez","value":705}];
const MX = 829;
