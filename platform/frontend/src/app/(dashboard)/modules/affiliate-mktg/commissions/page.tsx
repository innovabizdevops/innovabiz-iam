...
const PAGE = "Commission Rules";
const KPIS = [{"l":"Vendas YTD (€)","v":"€22957","t":"+8.9%","d":"up"},{"l":"Pipeline (€)","v":"€22280","t":"+6.5%","d":"up"},{"l":"Atingimento Quota (%)","v":"74.4%","t":"-5.1%","d":"down"},{"l":"Win Rate (%)","v":"78.4%","t":"+2.8%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 439.06","€ 42797.86","€ 44695.08","97.4%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 16586.81","€ 2107.24","€ 25041.76","73.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 12058.61","€ 16950.94","€ 34078.27","84.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 24650.35","€ 6962.63","€ 45625.03","82.1%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 25684.75","€ 12230.78","€ 10548.26","77.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":603},{"label":"Mar","value":412},{"label":"Abr","value":376},{"label":"Mai","value":553},{"label":"Jun","value":324},{"label":"Jul","value":395},{"label":"Ago","value":404},{"label":"Set","value":496},{"label":"Out","value":557},{"label":"Nov","value":395},{"label":"Dez","value":362}];
const MX = 628;
