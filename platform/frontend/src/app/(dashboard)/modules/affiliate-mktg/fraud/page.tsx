...
const ACCENT = "#7c3aed";
const MODULE = "Affiliate Marketing";
const PAGE = "Fraud Detect";
const KPIS = [{"l":"Total Affiliate Mktg","v":"8.534","t":"+7.0%","d":"up"},{"l":"Fraud Detect Ativos","v":"6.682","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"58","t":"-0.7%","d":"down"}];
const COLS = ["ID","Fraud Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Affiliate Mktg #001","Affiliate Mktg #002","1.375","1.820","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Affiliate Mktg #002","Affiliate Mktg #003","6.916","7.080","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Affiliate Mktg #003","Affiliate Mktg #004","3.114","1.443","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Affiliate Mktg #004","Affiliate Mktg #005","7.643","740","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Affiliate Mktg #005","Affiliate Mktg #001","404","6.912","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":776},{"label":"Mar","value":874},{"label":"Abr","value":837},{"label":"Mai","value":703},{"label":"Jun","value":791},{"label":"Jul","value":993},{"label":"Ago","value":832},{"label":"Set","value":1048},{"label":"Out","value":711},{"label":"Nov","value":805},{"label":"Dez","value":1025}];
const MX = 1048;
