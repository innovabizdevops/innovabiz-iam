...
const PAGE = "Pain Point";
const KPIS = [{"l":"Perfis Unificados","v":"8.957","t":"-3.7%","d":"down"},{"l":"Segmentos Ativos","v":"454","t":"+15.0%","d":"up"},{"l":"NPS Score","v":"78","t":"+10.4%","d":"up"},{"l":"Churn Previsto (%)","v":"69.6%","t":"-1.7%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","984","€ 41069.70","96.4%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","4.144","€ 2544.46","98.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","3.024","€ 3581.76","91.8%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","4.106","€ 45882.07","82.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","2.450","€ 30948.05","76.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":377},{"label":"Fev","value":484},{"label":"Mar","value":401},{"label":"Abr","value":677},{"label":"Mai","value":519},{"label":"Jun","value":470},{"label":"Jul","value":375},{"label":"Ago","value":379},{"label":"Set","value":513},{"label":"Out","value":395},{"label":"Nov","value":671},{"label":"Dez","value":342}];
const MX = 677;
