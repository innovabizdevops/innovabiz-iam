...
const ACCENT = "#60a5fa";
const MODULE = "Customer Journey Mapping";
const PAGE = "Optimize";
const KPIS = [{"l":"Perfis Unificados","v":"8.601","t":"+17.0%","d":"up"},{"l":"Segmentos Ativos","v":"1.016","t":"+6.9%","d":"up"},{"l":"NPS Score","v":"79","t":"+14.1%","d":"up"},{"l":"Churn Previsto (%)","v":"88.0%","t":"+11.8%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","6.957","€ 4023.75","92.2%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","3.208","€ 4861.58","98.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","5.011","€ 17825.70","80.9%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","1.254","€ 13682.48","80.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","1.717","€ 20993.22","87.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":654},{"label":"Mar","value":538},{"label":"Abr","value":480},{"label":"Mai","value":658},{"label":"Jun","value":440},{"label":"Jul","value":389},{"label":"Ago","value":502},{"label":"Set","value":398},{"label":"Out","value":374},{"label":"Nov","value":600},{"label":"Dez","value":492}];
const MX = 658;
