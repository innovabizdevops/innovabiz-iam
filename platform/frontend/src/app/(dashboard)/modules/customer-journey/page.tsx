...
const KPIS = [
    { label: "Total Registos", value: "6308", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2292", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€58K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "365375608", cells: ["CUS-3608", "Customer Journey Mapping Item 1", "25/5/2026", "€25 708"], status: "active" as const },
    { id: "365379179", cells: ["CUS-7179", "Customer Journey Mapping Item 2", "12/12/2026", "€29 279"], status: "pending" as const },
    { id: "365382750", cells: ["CUS-1750", "Customer Journey Mapping Item 3", "27/7/2026", "€32 850"], status: "completed" as const },
    { id: "365386321", cells: ["CUS-5321", "Customer Journey Mapping Item 4", "14/2/2026", "€36 421"], status: "warning" as const },
    { id: "365389892", cells: ["CUS-8892", "Customer Journey Mapping Item 5", "1/9/2026", "€39 992"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Customer Journey Mapping</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Customer Journey Mapping</p>
                    </div>
                </div>
