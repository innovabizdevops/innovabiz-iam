...
const KPIS = [{"l":"Auditorias Realizadas","v":"5.404","t":"+16.5%","d":"up"},{"l":"NC Abertas","v":"7.135","t":"+9.5%","d":"up"},{"l":"Conformidade (%)","v":"78.3%","t":"+0.0%","d":"up"},{"l":"CAPAs Pendentes","v":"7.112","t":"+12.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.812","93.9%","8.736","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.106","80.3%","2.818","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","300","94.9%","5.914","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.306","84.7%","2.849","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.524","92.0%","7.951","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":732},{"label":"Mar","value":760},{"label":"Abr","value":801},{"label":"Mai","value":516},{"label":"Jun","value":565},{"label":"Jul","value":521},{"label":"Ago","value":621},{"label":"Set","value":488},{"label":"Out","value":762},{"label":"Nov","value":786},{"label":"Dez","value":408}];
const MX = 801;
