...
const PAGE = "Privacy by Design";
const KPIS = [{"l":"Formulários Ativos","v":"1.221","t":"-2.8%","d":"down"},{"l":"Submissões/Dia","v":"3591","t":"-3.1%","d":"down"},{"l":"Documentos Gerados","v":"5.490","t":"-0.6%","d":"down"},{"l":"Templates","v":"2.538","t":"+4.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.216","2026-02-24","1.329","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.534","2026-02-06","8.674","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.839","2026-02-17","4.713","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.998","2026-02-08","1.405","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.532","2026-03-16","6.175","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":840},{"label":"Mar","value":682},{"label":"Abr","value":869},{"label":"Mai","value":626},{"label":"Jun","value":744},{"label":"Jul","value":837},{"label":"Ago","value":771},{"label":"Set","value":667},{"label":"Out","value":558},{"label":"Nov","value":717},{"label":"Dez","value":646}];
const MX = 869;
