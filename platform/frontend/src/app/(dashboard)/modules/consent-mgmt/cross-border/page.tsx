...
const PAGE = "Cross-Border Transfer";
const KPIS = [{"l":"Total Consent Mgmt","v":"487","t":"+4.0%","d":"up"},{"l":"Cross Border Transfer Ativos","v":"3.909","t":"+14.4%","d":"up"},{"l":"Eficiência (%)","v":"89.8%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"68","t":"+4.9%","d":"up"}];
const COLS = ["ID","Cross Border Transfer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Consent Mgmt #001","Consent Mgmt #002","386","4.859","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Consent Mgmt #002","Consent Mgmt #003","8.834","1.671","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Consent Mgmt #003","Consent Mgmt #004","1.162","7.846","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Consent Mgmt #004","Consent Mgmt #005","6.534","6.654","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Consent Mgmt #005","Consent Mgmt #001","1.498","1.953","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":686},{"label":"Mar","value":765},{"label":"Abr","value":746},{"label":"Mai","value":611},{"label":"Jun","value":637},{"label":"Jul","value":664},{"label":"Ago","value":835},{"label":"Set","value":778},{"label":"Out","value":791},{"label":"Nov","value":878},{"label":"Dez","value":880}];
const MX = 880;
