...
const PAGE = "Preference Center";
const KPIS = [{"l":"Configurações","v":"7.142","t":"+4.3%","d":"up"},{"l":"Últimas Alterações","v":"5.340","t":"+7.6%","d":"up"},{"l":"Ambientes","v":"1.479","t":"+7.8%","d":"up"},{"l":"Versão Config","v":"496","t":"+16.7%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 36465.48","5.704","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 26129.96","326","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 31189.51","4.409","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 41351.71","8.830","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 35680.03","2.003","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":804},{"label":"Mar","value":717},{"label":"Abr","value":776},{"label":"Mai","value":531},{"label":"Jun","value":689},{"label":"Jul","value":866},{"label":"Ago","value":751},{"label":"Set","value":567},{"label":"Out","value":542},{"label":"Nov","value":682},{"label":"Dez","value":611}];
const MX = 866;
