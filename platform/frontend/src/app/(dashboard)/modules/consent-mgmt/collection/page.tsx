...
const PAGE = "Consent Collection";
const KPIS = [{"l":"Total Consent Mgmt","v":"7.076","t":"+4.2%","d":"up"},{"l":"Consent Collection Ativos","v":"694","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"75.8%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"93","t":"+11.7%","d":"up"}];
const COLS = ["ID","Consent Collection","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Consent Mgmt #001","Consent Mgmt #002","1.308","3.776","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Consent Mgmt #002","Consent Mgmt #003","6.050","1.430","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Consent Mgmt #003","Consent Mgmt #004","4.272","8.623","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Consent Mgmt #004","Consent Mgmt #005","1.096","1.017","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Consent Mgmt #005","Consent Mgmt #001","3.261","2.333","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":772},{"label":"Mar","value":736},{"label":"Abr","value":736},{"label":"Mai","value":670},{"label":"Jun","value":752},{"label":"Jul","value":711},{"label":"Ago","value":738},{"label":"Set","value":505},{"label":"Out","value":465},{"label":"Nov","value":655},{"label":"Dez","value":742}];
const MX = 772;
