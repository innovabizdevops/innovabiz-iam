...
const ACCENT = "#059669";
const MODULE = "Consent & Preference";
const PAGE = "DSAR Management";
const KPIS = [{"l":"Projetos Melhoria","v":"571","t":"+5.8%","d":"up"},{"l":"Savings (€)","v":"€92317","t":"+4.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"73.4%","t":"+12.5%","d":"up"},{"l":"Ciclos PDCA","v":"3.305","t":"+14.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.451","€ 24539.35","5.344","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.423","€ 41473.27","3.241","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.685","€ 31915.16","8.839","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.221","€ 30789.57","4.951","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.938","€ 3708.44","2.326","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":358},{"label":"Fev","value":563},{"label":"Mar","value":676},{"label":"Abr","value":643},{"label":"Mai","value":369},{"label":"Jun","value":486},{"label":"Jul","value":367},{"label":"Ago","value":663},{"label":"Set","value":391},{"label":"Out","value":540},{"label":"Nov","value":588},{"label":"Dez","value":313}];
const MX = 676;
