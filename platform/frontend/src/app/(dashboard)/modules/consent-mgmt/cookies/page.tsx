...
const PAGE = "Cookie Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.405","t":"+9.2%","d":"up"},{"l":"NC Abertas","v":"8.984","t":"+4.0%","d":"up"},{"l":"Conformidade (%)","v":"81.9%","t":"-4.2%","d":"down"},{"l":"CAPAs Pendentes","v":"4.890","t":"-4.9%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.774","75.8%","8.725","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.169","87.9%","158","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.547","92.1%","2.262","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.195","75.6%","7.738","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.969","74.3%","3.877","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":804},{"label":"Mar","value":818},{"label":"Abr","value":713},{"label":"Mai","value":721},{"label":"Jun","value":753},{"label":"Jul","value":553},{"label":"Ago","value":578},{"label":"Set","value":530},{"label":"Out","value":771},{"label":"Nov","value":726},{"label":"Dez","value":858}];
const MX = 858;
