...
const PAGE = "E-Invoicing";
const KPIS = [{"l":"Projetos Melhoria","v":"3.092","t":"+4.4%","d":"up"},{"l":"Savings (€)","v":"€97355","t":"+11.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"94.0%","t":"+17.5%","d":"up"},{"l":"Ciclos PDCA","v":"5.092","t":"+11.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.263","€ 35792.18","456","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.306","€ 24667.90","8.741","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.262","€ 15086.89","4.496","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.149","€ 12999.97","3.919","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.399","€ 40503.04","169","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":808},{"label":"Fev","value":539},{"label":"Mar","value":713},{"label":"Abr","value":646},{"label":"Mai","value":861},{"label":"Jun","value":771},{"label":"Jul","value":819},{"label":"Ago","value":587},{"label":"Set","value":646},{"label":"Out","value":732},{"label":"Nov","value":761},{"label":"Dez","value":849}];
const MX = 861;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#a16207'}}>EU</span></h1>
                </div>
