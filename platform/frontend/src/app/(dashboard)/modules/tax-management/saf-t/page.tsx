...
const PAGE = "SAF-T Standard";
const KPIS = [{"l":"Projetos Melhoria","v":"2.449","t":"+2.9%","d":"up"},{"l":"Savings (€)","v":"€79587","t":"+15.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"77.2%","t":"+9.8%","d":"up"},{"l":"Ciclos PDCA","v":"585","t":"+13.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.161","€ 13551.08","3.327","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.827","€ 38644.34","7.424","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.571","€ 4608.98","2.244","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.720","€ 19611.75","3.977","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.337","€ 23942.19","2.029","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":779},{"label":"Mar","value":696},{"label":"Abr","value":754},{"label":"Mai","value":599},{"label":"Jun","value":607},{"label":"Jul","value":876},{"label":"Ago","value":540},{"label":"Set","value":845},{"label":"Out","value":741},{"label":"Nov","value":851},{"label":"Dez","value":802}];
const MX = 876;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#a16207'}}>SAF-T</span></h1>
                </div>
