...
const PAGE = "Tax Reporting";
const KPIS = [{"l":"Projetos Melhoria","v":"5.294","t":"+13.5%","d":"up"},{"l":"Savings (€)","v":"€35161","t":"-1.1%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"66.7%","t":"+13.0%","d":"up"},{"l":"Ciclos PDCA","v":"740","t":"+7.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","470","€ 9232.71","7.081","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.130","€ 37208.85","4.710","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.152","€ 28906.58","1.227","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.370","€ 26708.53","4.692","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.223","€ 21572.70","2.214","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":452},{"label":"Mar","value":776},{"label":"Abr","value":520},{"label":"Mai","value":743},{"label":"Jun","value":692},{"label":"Jul","value":699},{"label":"Ago","value":584},{"label":"Set","value":844},{"label":"Out","value":845},{"label":"Nov","value":563},{"label":"Dez","value":529}];
const MX = 845;
