...
const KPIS = [{"l":"Auditorias Realizadas","v":"4.477","t":"-0.6%","d":"down"},{"l":"NC Abertas","v":"643","t":"+11.5%","d":"up"},{"l":"Conformidade (%)","v":"69.8%","t":"+0.6%","d":"up"},{"l":"CAPAs Pendentes","v":"6.417","t":"+14.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.592","87.6%","2.117","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.944","83.8%","2.346","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","754","91.9%","2.280","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.616","97.3%","6.934","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.334","86.4%","3.143","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":252},{"label":"Fev","value":544},{"label":"Mar","value":349},{"label":"Abr","value":254},{"label":"Mai","value":592},{"label":"Jun","value":294},{"label":"Jul","value":522},{"label":"Ago","value":485},{"label":"Set","value":541},{"label":"Out","value":248},{"label":"Nov","value":362},{"label":"Dez","value":275}];
const MX = 592;
