...
const KPIS = [{"l":"ARR (€M)","v":"€5.4M","t":"+7.0%","d":"up"},{"l":"MRR (€)","v":"€21735","t":"+9.4%","d":"up"},{"l":"Churn (%)","v":"90.7%","t":"+2.3%","d":"up"},{"l":"ARPU (€)","v":"€21808","t":"+14.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 3749.30","2.800","€ 22714.63","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 40969.27","7.284","€ 22516.37","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 42027.75","7.566","€ 595.14","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 20606.95","7.008","€ 38494.37","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 25885.54","2.695","€ 8294.91","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":497},{"label":"Fev","value":658},{"label":"Mar","value":337},{"label":"Abr","value":406},{"label":"Mai","value":580},{"label":"Jun","value":516},{"label":"Jul","value":532},{"label":"Ago","value":356},{"label":"Set","value":485},{"label":"Out","value":630},{"label":"Nov","value":384},{"label":"Dez","value":606}];
const MX = 658;
