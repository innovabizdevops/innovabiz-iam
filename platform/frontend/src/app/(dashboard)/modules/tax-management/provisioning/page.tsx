...
const PAGE = "Tax Provisioning";
const KPIS = [{"l":"Projetos Melhoria","v":"1.090","t":"+0.7%","d":"up"},{"l":"Savings (€)","v":"€79408","t":"-4.7%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"94.9%","t":"-4.9%","d":"down"},{"l":"Ciclos PDCA","v":"4.868","t":"+16.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","373","€ 8782.61","5.373","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.000","€ 10552.43","5.799","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.006","€ 16295.91","8.439","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.193","€ 28649.88","9.049","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.968","€ 21198.19","1.992","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":836},{"label":"Mar","value":452},{"label":"Abr","value":735},{"label":"Mai","value":832},{"label":"Jun","value":814},{"label":"Jul","value":743},{"label":"Ago","value":770},{"label":"Set","value":683},{"label":"Out","value":643},{"label":"Nov","value":621},{"label":"Dez","value":693}];
const MX = 836;
