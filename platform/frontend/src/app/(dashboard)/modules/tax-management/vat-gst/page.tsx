...
const PAGE = "VAT / GST Engine";
const KPIS = [{"l":"Projetos Melhoria","v":"2.792","t":"+17.0%","d":"up"},{"l":"Savings (€)","v":"€5283","t":"+12.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"79.0%","t":"+5.0%","d":"up"},{"l":"Ciclos PDCA","v":"8.321","t":"+7.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.612","€ 35026.00","2.894","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.406","€ 49766.94","4.019","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.570","€ 9862.66","2.490","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.893","€ 31095.56","7.454","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.703","€ 44771.13","2.796","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":591},{"label":"Mar","value":765},{"label":"Abr","value":591},{"label":"Mai","value":745},{"label":"Jun","value":524},{"label":"Jul","value":850},{"label":"Ago","value":516},{"label":"Set","value":689},{"label":"Out","value":576},{"label":"Nov","value":607},{"label":"Dez","value":594}];
const MX = 850;
