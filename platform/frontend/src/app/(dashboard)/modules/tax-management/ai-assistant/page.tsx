...
const PAGE = "Tax AI Assistant";
const KPIS = [{"l":"Projetos Melhoria","v":"848","t":"-0.7%","d":"down"},{"l":"Savings (€)","v":"€18140","t":"+10.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"89.7%","t":"+1.3%","d":"up"},{"l":"Ciclos PDCA","v":"1.982","t":"+17.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.479","€ 9336.87","752","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.287","€ 14180.48","1.496","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.521","€ 5622.12","4.288","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.093","€ 23721.36","5.362","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.940","€ 19788.25","4.484","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":647},{"label":"Mar","value":726},{"label":"Abr","value":645},{"label":"Mai","value":581},{"label":"Jun","value":662},{"label":"Jul","value":795},{"label":"Ago","value":725},{"label":"Set","value":876},{"label":"Out","value":934},{"label":"Nov","value":694},{"label":"Dez","value":572}];
const MX = 934;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#a16207'}}>GenAI</span></h1>
                </div>
