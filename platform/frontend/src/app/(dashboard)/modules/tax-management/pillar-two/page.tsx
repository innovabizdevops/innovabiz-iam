...
const PAGE = "Pillar Two (GloBE)";
const KPIS = [{"l":"Projetos Melhoria","v":"6.797","t":"+15.8%","d":"up"},{"l":"Savings (€)","v":"€76354","t":"-4.2%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"69.0%","t":"-1.2%","d":"down"},{"l":"Ciclos PDCA","v":"7.588","t":"+15.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.742","€ 28821.90","6.901","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.271","€ 26735.13","3.613","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.350","€ 48480.92","6.492","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.397","€ 13623.67","7.657","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.357","€ 18163.12","3.435","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":916},{"label":"Fev","value":669},{"label":"Mar","value":800},{"label":"Abr","value":984},{"label":"Mai","value":674},{"label":"Jun","value":1007},{"label":"Jul","value":794},{"label":"Ago","value":657},{"label":"Set","value":1015},{"label":"Out","value":867},{"label":"Nov","value":801},{"label":"Dez","value":703}];
const MX = 1015;
