...
const PAGE = "Multi-Jurisdiction";
const KPIS = [{"l":"Projetos Melhoria","v":"3.135","t":"+2.8%","d":"up"},{"l":"Savings (€)","v":"€45365","t":"+17.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"66.2%","t":"+15.7%","d":"up"},{"l":"Ciclos PDCA","v":"748","t":"-5.6%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.018","€ 46840.89","2.243","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.539","€ 24374.35","3.504","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.482","€ 4312.01","4.198","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.784","€ 36059.87","4.713","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.933","€ 12816.31","3.796","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":911},{"label":"Mar","value":971},{"label":"Abr","value":894},{"label":"Mai","value":1065},{"label":"Jun","value":770},{"label":"Jul","value":872},{"label":"Ago","value":910},{"label":"Set","value":1064},{"label":"Out","value":1061},{"label":"Nov","value":1070},{"label":"Dez","value":987}];
const MX = 1070;
