...
const ACCENT = "#a16207";
const MODULE = "Tax Management";
const PAGE = "OECD BEPS Framework";
const KPIS = [{"l":"Projetos Melhoria","v":"8.866","t":"+1.1%","d":"up"},{"l":"Savings (€)","v":"€97683","t":"+3.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"82.3%","t":"-6.0%","d":"down"},{"l":"Ciclos PDCA","v":"6.912","t":"-3.1%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.223","€ 18491.94","6.981","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.317","€ 15163.62","8.311","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.691","€ 40080.78","2.731","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.998","€ 34667.29","5.131","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.144","€ 1605.75","7.603","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":742},{"label":"Mar","value":742},{"label":"Abr","value":523},{"label":"Mai","value":745},{"label":"Jun","value":601},{"label":"Jul","value":517},{"label":"Ago","value":605},{"label":"Set","value":668},{"label":"Out","value":576},{"label":"Nov","value":697},{"label":"Dez","value":379}];
const MX = 745;
...
export default function OecdBepsPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#a16207'}}>OECD</span></h1>
                </div>
