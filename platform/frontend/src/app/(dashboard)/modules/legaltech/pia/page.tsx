...
const PAGE = "Privacy Impact Assessment";
const KPIS = [{"l":"Projetos Sociais","v":"2.021","t":"+1.1%","d":"up"},{"l":"Beneficiários","v":"4.529","t":"+15.2%","d":"up"},{"l":"Investimento CSR (€)","v":"€22146","t":"+3.5%","d":"up"},{"l":"Score Impacto","v":"94","t":"+14.6%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","3.732","€ 34964.31","7.836","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.997","€ 1017.48","8.158","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","8.143","€ 32086.45","8.376","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","3.589","€ 9536.59","590","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","1.065","€ 15170.08","3.868","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":380},{"label":"Mar","value":312},{"label":"Abr","value":604},{"label":"Mai","value":409},{"label":"Jun","value":262},{"label":"Jul","value":265},{"label":"Ago","value":322},{"label":"Set","value":422},{"label":"Out","value":300},{"label":"Nov","value":394},{"label":"Dez","value":639}];
const MX = 639;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>GDPR</span></h1>
                </div>
