...
const KPIS = [{"l":"Formulários Ativos","v":"620","t":"+8.3%","d":"up"},{"l":"Submissões/Dia","v":"4241","t":"+0.5%","d":"up"},{"l":"Documentos Gerados","v":"969","t":"+1.9%","d":"up"},{"l":"Templates","v":"2.646","t":"+10.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.602","2026-03-12","6.524","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.868","2026-03-28","3.636","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.075","2026-03-15","2.677","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.873","2026-01-16","1.414","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.108","2026-01-22","5.984","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":268},{"label":"Fev","value":341},{"label":"Mar","value":396},{"label":"Abr","value":520},{"label":"Mai","value":367},{"label":"Jun","value":588},{"label":"Jul","value":607},{"label":"Ago","value":479},{"label":"Set","value":494},{"label":"Out","value":401},{"label":"Nov","value":438},{"label":"Dez","value":503}];
const MX = 607;
