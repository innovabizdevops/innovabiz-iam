...
const PAGE = "IP Management";
const KPIS = [{"l":"Projetos Melhoria","v":"2.204","t":"+6.8%","d":"up"},{"l":"Savings (€)","v":"€60634","t":"+14.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"87.9%","t":"-1.3%","d":"down"},{"l":"Ciclos PDCA","v":"1.715","t":"+7.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.249","€ 32905.71","9.096","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.795","€ 12608.61","207","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.801","€ 8367.98","8.392","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.036","€ 18557.15","8.943","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.692","€ 15542.42","614","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":431},{"label":"Mar","value":720},{"label":"Abr","value":747},{"label":"Mai","value":618},{"label":"Jun","value":436},{"label":"Jul","value":649},{"label":"Ago","value":692},{"label":"Set","value":523},{"label":"Out","value":736},{"label":"Nov","value":415},{"label":"Dez","value":572}];
const MX = 747;
