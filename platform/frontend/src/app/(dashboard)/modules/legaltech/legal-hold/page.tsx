...
const KPIS = [{"l":"Total Legaltech","v":"6.364","t":"+10.8%","d":"up"},{"l":"Legal Hold Ativos","v":"6.242","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"79.5%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"67","t":"+10.6%","d":"up"}];
const COLS = ["ID","Legal Hold","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legaltech #001","Legaltech #002","4.609","2.142","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Legaltech #002","Legaltech #003","127","2.681","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Legaltech #003","Legaltech #004","5.741","930","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Legaltech #004","Legaltech #005","5.233","3.885","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legaltech #005","Legaltech #001","3.673","7.492","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":457},{"label":"Fev","value":511},{"label":"Mar","value":576},{"label":"Abr","value":450},{"label":"Mai","value":601},{"label":"Jun","value":661},{"label":"Jul","value":313},{"label":"Ago","value":429},{"label":"Set","value":530},{"label":"Out","value":633},{"label":"Nov","value":398},{"label":"Dez","value":461}];
const MX = 661;
