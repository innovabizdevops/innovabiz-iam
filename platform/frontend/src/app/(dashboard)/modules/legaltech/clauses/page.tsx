...
const KPIS = [{"l":"Contratos Ativos","v":"7.450","t":"+4.0%","d":"up"},{"l":"Valor Total (€M)","v":"€7.5M","t":"+1.0%","d":"up"},{"l":"Renovações Próx. 30d","v":"4.791","t":"+2.3%","d":"up"},{"l":"Obrigações Pendentes","v":"8.863","t":"-4.2%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 15517.42","2026-01-24","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 2796.61","2026-03-08","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 19328.32","2026-01-18","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 27257.09","2026-02-08","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 34185.39","2026-01-10","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":476},{"label":"Mar","value":659},{"label":"Abr","value":358},{"label":"Mai","value":459},{"label":"Jun","value":453},{"label":"Jul","value":629},{"label":"Ago","value":390},{"label":"Set","value":313},{"label":"Out","value":475},{"label":"Nov","value":433},{"label":"Dez","value":385}];
const MX = 659;
