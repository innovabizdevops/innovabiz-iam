...
const KPIS = [{"l":"Auditorias Realizadas","v":"5.706","t":"+1.0%","d":"up"},{"l":"NC Abertas","v":"5.787","t":"+12.4%","d":"up"},{"l":"Conformidade (%)","v":"82.3%","t":"-4.3%","d":"down"},{"l":"CAPAs Pendentes","v":"718","t":"+4.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.378","74.4%","2.351","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.755","90.4%","8.610","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.530","74.7%","7.391","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.372","99.6%","8.781","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","516","81.8%","669","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":843},{"label":"Mar","value":893},{"label":"Abr","value":910},{"label":"Mai","value":783},{"label":"Jun","value":671},{"label":"Jul","value":735},{"label":"Ago","value":726},{"label":"Set","value":667},{"label":"Out","value":1017},{"label":"Nov","value":1026},{"label":"Dez","value":1056}];
const MX = 1056;
