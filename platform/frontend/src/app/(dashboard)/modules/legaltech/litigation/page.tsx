...
const PAGE = "Litigation Tracker";
const KPIS = [{"l":"Total Legaltech","v":"970","t":"+0.4%","d":"up"},{"l":"Litigation Tracker Ativos","v":"8.455","t":"-5.7%","d":"down"},{"l":"Eficiência (%)","v":"72.9%","t":"+17.5%","d":"up"},{"l":"Score Performance","v":"77","t":"+11.0%","d":"up"}];
const COLS = ["ID","Litigation Tracker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legaltech #001","Legaltech #002","8.265","5.319","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Legaltech #002","Legaltech #003","3.631","1.293","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Legaltech #003","Legaltech #004","5.966","1.409","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Legaltech #004","Legaltech #005","8.311","5.718","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legaltech #005","Legaltech #001","242","6.110","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":259},{"label":"Fev","value":512},{"label":"Mar","value":220},{"label":"Abr","value":545},{"label":"Mai","value":276},{"label":"Jun","value":446},{"label":"Jul","value":285},{"label":"Ago","value":556},{"label":"Set","value":283},{"label":"Out","value":490},{"label":"Nov","value":519},{"label":"Dez","value":563}];
const MX = 563;
