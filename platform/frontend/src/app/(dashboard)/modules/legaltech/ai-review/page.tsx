...
const ACCENT = "#4338ca";
const MODULE = "Legal & Contract Mgmt";
const PAGE = "Contract AI Review";
const KPIS = [{"l":"Contratos Ativos","v":"353","t":"+16.3%","d":"up"},{"l":"Valor Total (€M)","v":"€3.6M","t":"+2.5%","d":"up"},{"l":"Renovações Próx. 30d","v":"5.481","t":"+5.1%","d":"up"},{"l":"Obrigações Pendentes","v":"2.682","t":"+13.8%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 32307.68","2026-02-22","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 6424.39","2026-01-21","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 43582.52","2026-03-19","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 2426.90","2026-02-06","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 4197.42","2026-01-23","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":818},{"label":"Mar","value":693},{"label":"Abr","value":610},{"label":"Mai","value":652},{"label":"Jun","value":766},{"label":"Jul","value":879},{"label":"Ago","value":839},{"label":"Set","value":891},{"label":"Out","value":800},{"label":"Nov","value":664},{"label":"Dez","value":564}];
const MX = 891;
