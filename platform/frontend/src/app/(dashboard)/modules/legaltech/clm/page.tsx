...
const PAGE = "Contract Lifecycle";
const KPIS = [{"l":"Contratos Ativos","v":"1.884","t":"+10.0%","d":"up"},{"l":"Valor Total (€M)","v":"€15.3M","t":"+16.4%","d":"up"},{"l":"Renovações Próx. 30d","v":"4.937","t":"+16.9%","d":"up"},{"l":"Obrigações Pendentes","v":"6.476","t":"+11.1%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 29152.59","2026-01-18","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 2101.21","2026-01-04","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 29759.79","2026-02-18","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 34451.46","2026-01-23","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 11113.32","2026-02-03","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":663},{"label":"Mar","value":831},{"label":"Abr","value":736},{"label":"Mai","value":726},{"label":"Jun","value":871},{"label":"Jul","value":964},{"label":"Ago","value":772},{"label":"Set","value":768},{"label":"Out","value":812},{"label":"Nov","value":995},{"label":"Dez","value":857}];
const MX = 995;
