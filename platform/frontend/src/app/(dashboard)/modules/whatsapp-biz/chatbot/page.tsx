...
const ACCENT = "#059669";
const MODULE = "WhatsApp Business";
const PAGE = "Chat Bot";
const KPIS = [{"l":"Teams Ativos","v":"4.432","t":"+11.4%","d":"up"},{"l":"Reuniões/Semana","v":"4350","t":"+12.4%","d":"up"},{"l":"Mensagens/Dia","v":"5076","t":"+10.9%","d":"up"},{"l":"Ficheiros Partilhados","v":"1.138","t":"-0.1%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","3.868","170","8.119","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.580","3616","7.300","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","1.029","2946","1.035","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.180","2088","231","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","8.534","381","4.149","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":351},{"label":"Fev","value":540},{"label":"Mar","value":574},{"label":"Abr","value":424},{"label":"Mai","value":446},{"label":"Jun","value":350},{"label":"Jul","value":325},{"label":"Ago","value":312},{"label":"Set","value":553},{"label":"Out","value":318},{"label":"Nov","value":262},{"label":"Dez","value":616}];
const MX = 616;
