...
const PAGE = "Template Msg";
const KPIS = [{"l":"Formulários Ativos","v":"956","t":"+16.0%","d":"up"},{"l":"Submissões/Dia","v":"4065","t":"+6.4%","d":"up"},{"l":"Documentos Gerados","v":"9.046","t":"+9.7%","d":"up"},{"l":"Templates","v":"7.816","t":"-1.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.442","2026-02-06","6.323","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.459","2026-01-09","563","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.709","2026-01-11","4.730","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.635","2026-02-15","5.894","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","236","2026-03-18","5.747","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":383},{"label":"Mar","value":339},{"label":"Abr","value":486},{"label":"Mai","value":303},{"label":"Jun","value":479},{"label":"Jul","value":343},{"label":"Ago","value":381},{"label":"Set","value":356},{"label":"Out","value":354},{"label":"Nov","value":658},{"label":"Dez","value":427}];
const MX = 658;
