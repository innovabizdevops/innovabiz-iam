...
const PAGE = "Catalog Sync";
const KPIS = [{"l":"Dashboards Ativos","v":"6.901","t":"+13.3%","d":"up"},{"l":"Queries/Dia","v":"269","t":"+6.4%","d":"up"},{"l":"Dados Processados (GB)","v":"8.890","t":"+9.8%","d":"up"},{"l":"Utilizadores Analytics","v":"6.868","t":"+6.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1637","2026-03-17","4.187","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1242","2026-03-24","4.578","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","959","2026-02-14","6.954","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3306","2026-01-05","2.701","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2294","2026-03-10","6.609","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":832},{"label":"Fev","value":557},{"label":"Mar","value":753},{"label":"Abr","value":822},{"label":"Mai","value":707},{"label":"Jun","value":621},{"label":"Jul","value":870},{"label":"Ago","value":614},{"label":"Set","value":637},{"label":"Out","value":646},{"label":"Nov","value":536},{"label":"Dez","value":651}];
const MX = 870;
