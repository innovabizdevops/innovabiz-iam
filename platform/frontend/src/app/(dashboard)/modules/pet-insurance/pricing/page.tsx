...
const PAGE = "Pricing";
const KPIS = [{"l":"ARR (€M)","v":"€18.9M","t":"+9.6%","d":"up"},{"l":"MRR (€)","v":"€6238","t":"+12.8%","d":"up"},{"l":"Churn (%)","v":"78.7%","t":"+12.5%","d":"up"},{"l":"ARPU (€)","v":"€46617","t":"+2.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 17092.60","2.041","€ 3757.96","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 3980.70","5.242","€ 11642.34","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 4525.83","3.805","€ 34246.92","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 49461.65","7.962","€ 31258.37","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 10819.57","3.738","€ 42781.36","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":785},{"label":"Mar","value":885},{"label":"Abr","value":1029},{"label":"Mai","value":901},{"label":"Jun","value":838},{"label":"Jul","value":1024},{"label":"Ago","value":662},{"label":"Set","value":713},{"label":"Out","value":933},{"label":"Nov","value":922},{"label":"Dez","value":833}];
const MX = 1029;
