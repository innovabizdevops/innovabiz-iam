...
const ACCENT = "#6366f1";
const MODULE = "Pet Insurance";
const PAGE = "Network";
const KPIS = [{"l":"Total Pet Insurance","v":"1.735","t":"+0.0%","d":"up"},{"l":"Network Ativos","v":"6.591","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"75.3%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"74","t":"-2.1%","d":"down"}];
const COLS = ["ID","Network","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Insurance #001","Pet Insurance #002","7.385","7.198","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Insurance #002","Pet Insurance #003","3.588","6.788","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Insurance #003","Pet Insurance #004","2.423","4.889","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Insurance #004","Pet Insurance #005","1.243","3.977","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Insurance #005","Pet Insurance #001","5.943","3.621","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":675},{"label":"Mar","value":672},{"label":"Abr","value":809},{"label":"Mai","value":1014},{"label":"Jun","value":703},{"label":"Jul","value":785},{"label":"Ago","value":910},{"label":"Set","value":673},{"label":"Out","value":871},{"label":"Nov","value":791},{"label":"Dez","value":643}];
const MX = 1014;
