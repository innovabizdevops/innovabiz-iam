...
const PAGE = "Digital Twin BIM";
const KPIS = [{"l":"Twins Ativos","v":"5.570","t":"+8.6%","d":"up"},{"l":"Simulações/Dia","v":"3518","t":"+0.5%","d":"up"},{"l":"Precisão Modelo (%)","v":"72.4%","t":"-3.6%","d":"down"},{"l":"Latência Sync (ms)","v":"197ms","t":"-0.5%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","76.3%","2026-02-05","2.495","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","91.8%","2026-03-08","1.880","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","70.2%","2026-02-23","2.778","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","83.0%","2026-03-17","2.596","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","80.0%","2026-01-25","4.599","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":451},{"label":"Mar","value":431},{"label":"Abr","value":792},{"label":"Mai","value":672},{"label":"Jun","value":670},{"label":"Jul","value":635},{"label":"Ago","value":812},{"label":"Set","value":660},{"label":"Out","value":759},{"label":"Nov","value":473},{"label":"Dez","value":810}];
const MX = 812;
