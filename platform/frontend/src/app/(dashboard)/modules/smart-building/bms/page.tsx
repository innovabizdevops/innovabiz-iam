...
const ACCENT = "#c026d3";
const MODULE = "Smart Building";
const PAGE = "BMS Dashboard";
const KPIS = [{"l":"Teams Ativos","v":"4.456","t":"+4.7%","d":"up"},{"l":"Reuniões/Semana","v":"1788","t":"-2.6%","d":"down"},{"l":"Mensagens/Dia","v":"2926","t":"+0.8%","d":"up"},{"l":"Ficheiros Partilhados","v":"1.357","t":"-0.1%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.389","3835","2.562","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","4.651","1857","5.334","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","2.486","2614","8.192","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","714","2867","5.445","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","7.525","3408","6.705","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":619},{"label":"Mar","value":819},{"label":"Abr","value":655},{"label":"Mai","value":738},{"label":"Jun","value":687},{"label":"Jul","value":724},{"label":"Ago","value":680},{"label":"Set","value":790},{"label":"Out","value":628},{"label":"Nov","value":703},{"label":"Dez","value":568}];
const MX = 819;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#c026d3'}}>IoT</span></h1>
                </div>
