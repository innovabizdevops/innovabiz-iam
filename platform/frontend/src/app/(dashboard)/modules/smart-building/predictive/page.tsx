...
const PAGE = "Predictive Maint";
const KPIS = [{"l":"Integrações Ativas","v":"1.610","t":"-5.8%","d":"down"},{"l":"Chamadas/Hora","v":"549","t":"+8.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"77.4%","t":"+0.9%","d":"up"},{"l":"Latência Média (ms)","v":"77ms","t":"+14.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.572","8.914","89.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.819","1.634","78.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","776","3.154","87.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.406","2.458","93.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.586","2.446","79.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":877},{"label":"Mar","value":688},{"label":"Abr","value":597},{"label":"Mai","value":981},{"label":"Jun","value":733},{"label":"Jul","value":933},{"label":"Ago","value":979},{"label":"Set","value":649},{"label":"Out","value":827},{"label":"Nov","value":854},{"label":"Dez","value":683}];
const MX = 981;
