...
const PAGE = "Document";
const KPIS = [{"l":"Formulários Ativos","v":"5.729","t":"+9.8%","d":"up"},{"l":"Submissões/Dia","v":"2378","t":"+11.9%","d":"up"},{"l":"Documentos Gerados","v":"5.689","t":"+7.9%","d":"up"},{"l":"Templates","v":"4.691","t":"+15.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.745","2026-02-18","3.438","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.222","2026-03-14","3.444","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","494","2026-01-10","6.474","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.863","2026-01-14","3.616","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.396","2026-02-27","7.786","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":437},{"label":"Fev","value":431},{"label":"Mar","value":443},{"label":"Abr","value":600},{"label":"Mai","value":470},{"label":"Jun","value":574},{"label":"Jul","value":447},{"label":"Ago","value":642},{"label":"Set","value":625},{"label":"Out","value":589},{"label":"Nov","value":430},{"label":"Dez","value":506}];
const MX = 642;
