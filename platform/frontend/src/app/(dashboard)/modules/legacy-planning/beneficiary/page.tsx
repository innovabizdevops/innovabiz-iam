...
const ACCENT = "#475569";
const MODULE = "Legacy Planning";
const PAGE = "Beneficiary";
const KPIS = [{"l":"Total Legacy Planning","v":"6.924","t":"+6.9%","d":"up"},{"l":"Beneficiary Ativos","v":"2.794","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"93.4%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"77","t":"+8.4%","d":"up"}];
const COLS = ["ID","Beneficiary","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legacy Planning #001","Legacy Planning #002","7.784","8.059","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Legacy Planning #002","Legacy Planning #003","8.416","1.759","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Legacy Planning #003","Legacy Planning #004","8.434","4.454","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Legacy Planning #004","Legacy Planning #005","871","540","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legacy Planning #005","Legacy Planning #001","7.820","6.607","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":580},{"label":"Mar","value":476},{"label":"Abr","value":543},{"label":"Mai","value":424},{"label":"Jun","value":558},{"label":"Jul","value":513},{"label":"Ago","value":283},{"label":"Set","value":456},{"label":"Out","value":521},{"label":"Nov","value":478},{"label":"Dez","value":591}];
const MX = 591;
