...
const PAGE = "Review";
const KPIS = [{"l":"Total Legacy Planning","v":"5.880","t":"+4.0%","d":"up"},{"l":"Review Ativos","v":"415","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"83.6%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"95","t":"+13.9%","d":"up"}];
const COLS = ["ID","Review","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legacy Planning #001","Legacy Planning #002","6.390","3.971","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Legacy Planning #002","Legacy Planning #003","3.741","1.241","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Legacy Planning #003","Legacy Planning #004","6.972","7.648","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Legacy Planning #004","Legacy Planning #005","7.641","2.678","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legacy Planning #005","Legacy Planning #001","4.670","6.249","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":992},{"label":"Fev","value":705},{"label":"Mar","value":673},{"label":"Abr","value":1021},{"label":"Mai","value":694},{"label":"Jun","value":1021},{"label":"Jul","value":1044},{"label":"Ago","value":868},{"label":"Set","value":907},{"label":"Out","value":779},{"label":"Nov","value":907},{"label":"Dez","value":879}];
const MX = 1044;
