...
const PAGE = "Trust";
const KPIS = [{"l":"Total Legacy Planning","v":"8.048","t":"+17.6%","d":"up"},{"l":"Trust Ativos","v":"5.050","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"73.1%","t":"+9.9%","d":"up"},{"l":"Score Performance","v":"58","t":"+7.9%","d":"up"}];
const COLS = ["ID","Trust","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legacy Planning #001","Legacy Planning #002","3.224","4.757","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Legacy Planning #002","Legacy Planning #003","147","197","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Legacy Planning #003","Legacy Planning #004","2.704","107","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Legacy Planning #004","Legacy Planning #005","6.585","2.635","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legacy Planning #005","Legacy Planning #001","2.965","1.825","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":460},{"label":"Mar","value":682},{"label":"Abr","value":760},{"label":"Mai","value":778},{"label":"Jun","value":581},{"label":"Jul","value":454},{"label":"Ago","value":508},{"label":"Set","value":730},{"label":"Out","value":486},{"label":"Nov","value":405},{"label":"Dez","value":441}];
const MX = 778;
