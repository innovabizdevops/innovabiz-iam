...
const KPIS = [
    { label: "Total Registos", value: "8824", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4180", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€217K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "-7%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "494325624", cells: ["LEG-1624", "Legacy Planning Item 1", "17/1/2026", "€25 724"], status: "active" as const },
    { id: "494329195", cells: ["LEG-5195", "Legacy Planning Item 2", "4/8/2026", "€29 295"], status: "pending" as const },
    { id: "494332766", cells: ["LEG-8766", "Legacy Planning Item 3", "19/3/2026", "€32 866"], status: "completed" as const },
    { id: "494336337", cells: ["LEG-3337", "Legacy Planning Item 4", "6/10/2026", "€36 437"], status: "warning" as const },
    { id: "494339908", cells: ["LEG-6908", "Legacy Planning Item 5", "21/5/2026", "€40 008"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Legacy Planning</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Legacy Planning</p>
                    </div>
                </div>
