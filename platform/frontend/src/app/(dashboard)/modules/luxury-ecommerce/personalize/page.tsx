...
const ACCENT = "#b45309";
const MODULE = "Luxury E-Commerce";
const PAGE = "Personalize";
const KPIS = [{"l":"Pedidos/Dia","v":"2958","t":"+12.3%","d":"up"},{"l":"GMV (€)","v":"€37658","t":"+1.8%","d":"up"},{"l":"Conversão (%)","v":"66.6%","t":"+0.8%","d":"up"},{"l":"AOV (€)","v":"€37412","t":"-2.8%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 21380.49","7.910","1.981","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 2962.61","4.626","7.909","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 45289.33","2.825","8.722","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 39917.39","6.555","7.690","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 34771.63","5.802","5.847","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":922},{"label":"Mar","value":697},{"label":"Abr","value":738},{"label":"Mai","value":671},{"label":"Jun","value":532},{"label":"Jul","value":690},{"label":"Ago","value":676},{"label":"Set","value":540},{"label":"Out","value":789},{"label":"Nov","value":612},{"label":"Dez","value":895}];
const MX = 922;
