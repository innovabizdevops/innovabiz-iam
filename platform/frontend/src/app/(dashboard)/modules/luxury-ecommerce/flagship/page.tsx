...
const PAGE = "Digital Flagship";
const KPIS = [{"l":"Pedidos/Dia","v":"3237","t":"+4.8%","d":"up"},{"l":"GMV (€)","v":"€26951","t":"-5.9%","d":"down"},{"l":"Conversão (%)","v":"89.3%","t":"+6.3%","d":"up"},{"l":"AOV (€)","v":"€52219","t":"+1.5%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 36609.21","359","7.312","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 11863.40","6.834","7.709","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 45231.28","9.010","1.358","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 3037.45","2.532","427","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 19463.37","4.170","3.338","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":776},{"label":"Fev","value":940},{"label":"Mar","value":795},{"label":"Abr","value":675},{"label":"Mai","value":753},{"label":"Jun","value":784},{"label":"Jul","value":682},{"label":"Ago","value":984},{"label":"Set","value":788},{"label":"Out","value":935},{"label":"Nov","value":818},{"label":"Dez","value":736}];
const MX = 984;
