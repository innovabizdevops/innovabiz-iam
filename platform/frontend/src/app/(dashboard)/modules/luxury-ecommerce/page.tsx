...
/* ═══ Luxury E-Commerce — Dashboard ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total Registos", value: "2955", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2157", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€196K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1928522855", cells: ["LUX-3855", "Luxury E-Commerce Item 1", "8/12/2026", "€22 955"], status: "active" as const },
    { id: "1928526426", cells: ["LUX-7426", "Luxury E-Commerce Item 2", "23/7/2026", "€26 526"], status: "pending" as const },
    { id: "1928529997", cells: ["LUX-1997", "Luxury E-Commerce Item 3", "10/2/2026", "€30 097"], status: "completed" as const },
    { id: "1928533568", cells: ["LUX-5568", "Luxury E-Commerce Item 4", "25/9/2026", "€33 668"], status: "warning" as const },
    { id: "1928537139", cells: ["LUX-9139", "Luxury E-Commerce Item 5", "12/4/2026", "€37 239"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Luxury E-Commerce</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Luxury E-Commerce</p>
                    </div>
                </div>
