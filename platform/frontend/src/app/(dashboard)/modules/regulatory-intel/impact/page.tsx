...
const PAGE = "Impact Assess";
const KPIS = [{"l":"Projetos Sociais","v":"5.437","t":"-1.8%","d":"down"},{"l":"Beneficiários","v":"7.215","t":"+1.6%","d":"up"},{"l":"Investimento CSR (€)","v":"€9907","t":"-1.7%","d":"down"},{"l":"Score Impacto","v":"73","t":"+9.1%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","3.012","€ 8171.11","6.333","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.577","€ 24023.25","7.226","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","8.611","€ 31276.50","1.441","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","4.504","€ 10512.58","7.010","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","3.810","€ 24791.26","4.202","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":852},{"label":"Mar","value":717},{"label":"Abr","value":802},{"label":"Mai","value":864},{"label":"Jun","value":606},{"label":"Jul","value":558},{"label":"Ago","value":838},{"label":"Set","value":657},{"label":"Out","value":820},{"label":"Nov","value":744},{"label":"Dez","value":527}];
const MX = 864;
