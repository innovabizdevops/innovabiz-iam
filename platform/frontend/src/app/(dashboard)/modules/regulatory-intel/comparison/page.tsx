...
const KPIS = [{"l":"Auditorias Realizadas","v":"5.716","t":"-1.7%","d":"down"},{"l":"NC Abertas","v":"6.675","t":"+16.5%","d":"up"},{"l":"Conformidade (%)","v":"68.2%","t":"+0.7%","d":"up"},{"l":"CAPAs Pendentes","v":"3.054","t":"+3.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.007","89.3%","9.026","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","453","70.9%","5.835","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.545","91.6%","8.916","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.483","87.2%","6.571","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.279","81.7%","473","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":500},{"label":"Fev","value":816},{"label":"Mar","value":626},{"label":"Abr","value":665},{"label":"Mai","value":530},{"label":"Jun","value":759},{"label":"Jul","value":452},{"label":"Ago","value":587},{"label":"Set","value":557},{"label":"Out","value":594},{"label":"Nov","value":491},{"label":"Dez","value":705}];
const MX = 816;
