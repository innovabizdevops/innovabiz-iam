...
const PAGE = "Alert Service";
const KPIS = [{"l":"Notificações Enviadas","v":"8.836","t":"+9.1%","d":"up"},{"l":"Taxa Entrega (%)","v":"70.9%","t":"-5.5%","d":"down"},{"l":"Taxa Abertura (%)","v":"76.9%","t":"+0.2%","d":"up"},{"l":"Escalações","v":"3.574","t":"+2.3%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","4.606","82.1%","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","7.125","75.0%","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","3.425","78.0%","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","2.372","99.1%","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","7.979","97.4%","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":838},{"label":"Fev","value":780},{"label":"Mar","value":861},{"label":"Abr","value":751},{"label":"Mai","value":659},{"label":"Jun","value":682},{"label":"Jul","value":911},{"label":"Ago","value":732},{"label":"Set","value":800},{"label":"Out","value":942},{"label":"Nov","value":957},{"label":"Dez","value":817}];
const MX = 957;
