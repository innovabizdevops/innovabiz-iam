...
/* ═══ Anti-Aging Center — Dashboard ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total Registos", value: "240", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2214", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€271K", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "307147640", cells: ["ANT-5640", "Anti-Aging Center Item 1", "17/9/2026", "€47 740"], status: "active" as const },
    { id: "307151211", cells: ["ANT-9211", "Anti-Aging Center Item 2", "4/4/2026", "€1311"], status: "pending" as const },
    { id: "307154782", cells: ["ANT-3782", "Anti-Aging Center Item 3", "19/11/2026", "€4882"], status: "completed" as const },
    { id: "307158353", cells: ["ANT-7353", "Anti-Aging Center Item 4", "6/6/2026", "€8453"], status: "warning" as const },
    { id: "307161924", cells: ["ANT-1924", "Anti-Aging Center Item 5", "21/1/2026", "€12 024"], status: "active" as const },
];
...
export default function AntiagingCenterPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Anti-Aging Center</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Anti-Aging Center</p>
                    </div>
                </div>
