...
const ACCENT = "#ec4899";
const MODULE = "Anti-Aging Center";
const PAGE = "IV Therapy";
const KPIS = [{"l":"Total Anti Aging","v":"4.410","t":"+13.5%","d":"up"},{"l":"IV Therapy Ativos","v":"3.336","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"70.0%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"63","t":"+16.5%","d":"up"}];
const COLS = ["ID","IV Therapy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Anti Aging #001","Anti Aging #002","5.018","1.973","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Anti Aging #002","Anti Aging #003","6.467","6.284","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Anti Aging #003","Anti Aging #004","7.836","7.609","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Anti Aging #004","Anti Aging #005","8.538","3.809","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Anti Aging #005","Anti Aging #001","886","4.511","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":911},{"label":"Fev","value":810},{"label":"Mar","value":792},{"label":"Abr","value":878},{"label":"Mai","value":916},{"label":"Jun","value":762},{"label":"Jul","value":788},{"label":"Ago","value":812},{"label":"Set","value":1009},{"label":"Out","value":918},{"label":"Nov","value":956},{"label":"Dez","value":660}];
const MX = 1009;
