...
const ACCENT = "#4338ca";
const MODULE = "Flex Office Platform";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"5.737","t":"+12.4%","d":"up"},{"l":"Queries/Dia","v":"4603","t":"+16.8%","d":"up"},{"l":"Dados Processados (GB)","v":"4.752","t":"+4.1%","d":"up"},{"l":"Utilizadores Analytics","v":"3.635","t":"+2.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3412","2026-03-28","2.131","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","911","2026-02-14","7.315","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4679","2026-01-22","7.621","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1238","2026-02-25","1.615","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2061","2026-01-19","3.811","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":847},{"label":"Fev","value":857},{"label":"Mar","value":783},{"label":"Abr","value":639},{"label":"Mai","value":756},{"label":"Jun","value":971},{"label":"Jul","value":748},{"label":"Ago","value":928},{"label":"Set","value":726},{"label":"Out","value":644},{"label":"Nov","value":957},{"label":"Dez","value":817}];
const MX = 971;
