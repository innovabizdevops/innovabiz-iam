...
/* ═══ Flex Office Platform — Dashboard ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total Registos", value: "1281", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "779", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€350K", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2092316681", cells: ["FLE-6681", "Flex Office Platform Item 1", "22/6/2026", "€16 781"], status: "active" as const },
    { id: "2092320252", cells: ["FLE-1252", "Flex Office Platform Item 2", "9/1/2026", "€20 352"], status: "pending" as const },
    { id: "2092323823", cells: ["FLE-4823", "Flex Office Platform Item 3", "24/8/2026", "€23 923"], status: "completed" as const },
    { id: "2092327394", cells: ["FLE-8394", "Flex Office Platform Item 4", "11/3/2026", "€27 494"], status: "warning" as const },
    { id: "2092330965", cells: ["FLE-2965", "Flex Office Platform Item 5", "26/10/2026", "€31 065"], status: "active" as const },
];
...
export default function FlexOfficePlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Flex Office Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Flex Office Platform</p>
                    </div>
                </div>
