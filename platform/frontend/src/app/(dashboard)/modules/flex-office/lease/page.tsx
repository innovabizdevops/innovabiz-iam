...
const PAGE = "Lease";
const KPIS = [{"l":"Total Flex Office","v":"832","t":"+3.0%","d":"up"},{"l":"Lease Ativos","v":"8.186","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"75.4%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"84","t":"+10.3%","d":"up"}];
const COLS = ["ID","Lease","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Flex Office #001","Flex Office #002","3.064","827","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Flex Office #002","Flex Office #003","6.897","8.163","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Flex Office #003","Flex Office #004","8.822","8.081","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Flex Office #004","Flex Office #005","5.331","3.938","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Flex Office #005","Flex Office #001","627","3.086","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":559},{"label":"Mar","value":623},{"label":"Abr","value":588},{"label":"Mai","value":664},{"label":"Jun","value":366},{"label":"Jul","value":474},{"label":"Ago","value":380},{"label":"Set","value":383},{"label":"Out","value":671},{"label":"Nov","value":336},{"label":"Dez","value":505}];
const MX = 671;
