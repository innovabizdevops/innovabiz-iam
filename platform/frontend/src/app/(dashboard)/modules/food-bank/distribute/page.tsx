...
const ACCENT = "#be185d";
const MODULE = "Food Bank Operations";
const PAGE = "Distribute";
const KPIS = [{"l":"Total Food Bank","v":"4.361","t":"-4.2%","d":"down"},{"l":"Distribute Ativos","v":"5.932","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"72.1%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"56","t":"+14.0%","d":"up"}];
const COLS = ["ID","Distribute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Bank #001","Food Bank #002","7.546","2.601","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Food Bank #002","Food Bank #003","236","2.561","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Bank #003","Food Bank #004","6.313","4.316","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Food Bank #004","Food Bank #005","5.553","6.459","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Bank #005","Food Bank #001","4.017","1.839","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":469},{"label":"Mar","value":645},{"label":"Abr","value":385},{"label":"Mai","value":715},{"label":"Jun","value":584},{"label":"Jul","value":757},{"label":"Ago","value":541},{"label":"Set","value":383},{"label":"Out","value":489},{"label":"Nov","value":490},{"label":"Dez","value":589}];
const MX = 757;
