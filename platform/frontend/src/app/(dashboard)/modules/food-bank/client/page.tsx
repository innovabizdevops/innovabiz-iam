...
const PAGE = "Client";
const KPIS = [{"l":"Total Food Bank","v":"5.410","t":"+8.6%","d":"up"},{"l":"Client Ativos","v":"5.414","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"69","t":"-5.0%","d":"down"}];
const COLS = ["ID","Client","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Bank #001","Food Bank #002","6.853","8.062","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Food Bank #002","Food Bank #003","2.562","8.733","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Bank #003","Food Bank #004","4.238","6.875","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Food Bank #004","Food Bank #005","2.934","6.007","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Bank #005","Food Bank #001","4.570","5.585","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":508},{"label":"Mar","value":488},{"label":"Abr","value":695},{"label":"Mai","value":626},{"label":"Jun","value":581},{"label":"Jul","value":591},{"label":"Ago","value":449},{"label":"Set","value":607},{"label":"Out","value":515},{"label":"Nov","value":606},{"label":"Dez","value":741}];
const MX = 741;
