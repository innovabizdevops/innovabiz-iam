...
/* ═══ Food Bank Operations — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "4122", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3545", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€106K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1716129422", cells: ["FOO-1422", "Food Bank Operations Item 1", "15/3/2026", "€29 522"], status: "active" as const },
    { id: "1716132993", cells: ["FOO-4993", "Food Bank Operations Item 2", "2/10/2026", "€33 093"], status: "pending" as const },
    { id: "1716136564", cells: ["FOO-8564", "Food Bank Operations Item 3", "17/5/2026", "€36 664"], status: "completed" as const },
    { id: "1716140135", cells: ["FOO-3135", "Food Bank Operations Item 4", "4/12/2026", "€40 235"], status: "warning" as const },
    { id: "1716143706", cells: ["FOO-6706", "Food Bank Operations Item 5", "19/7/2026", "€43 806"], status: "active" as const },
];
...
export default function FoodBankOperationsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Food Bank Operations</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Food Bank Operations</p>
                    </div>
                </div>
