...
const ACCENT = "#6366f1";
const MODULE = "Load Optimization";
const PAGE = "3D Load";
const KPIS = [{"l":"Total Load Optimize","v":"4.158","t":"-1.2%","d":"down"},{"l":"3D Load Ativos","v":"2.532","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"84.9%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"64","t":"+2.8%","d":"up"}];
const COLS = ["ID","3D Load","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Load Optimize #001","Load Optimize #002","6.460","5.382","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Load Optimize #002","Load Optimize #003","5.759","7.161","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Load Optimize #003","Load Optimize #004","7.390","4.523","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Load Optimize #004","Load Optimize #005","2.434","8.575","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Load Optimize #005","Load Optimize #001","7.412","2.775","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":270},{"label":"Fev","value":499},{"label":"Mar","value":651},{"label":"Abr","value":589},{"label":"Mai","value":333},{"label":"Jun","value":318},{"label":"Jul","value":528},{"label":"Ago","value":595},{"label":"Set","value":455},{"label":"Out","value":262},{"label":"Nov","value":473},{"label":"Dez","value":650}];
const MX = 651;
