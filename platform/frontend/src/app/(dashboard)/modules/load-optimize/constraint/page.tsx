...
const KPIS = [{"l":"Total Load Optimize","v":"461","t":"+15.3%","d":"up"},{"l":"Constraint Ativos","v":"4.941","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"82.6%","t":"+10.6%","d":"up"},{"l":"Score Performance","v":"82","t":"+15.2%","d":"up"}];
const COLS = ["ID","Constraint","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Load Optimize #001","Load Optimize #002","1.551","2.369","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Load Optimize #002","Load Optimize #003","5.112","2.879","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Load Optimize #003","Load Optimize #004","8.153","6.222","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Load Optimize #004","Load Optimize #005","4.767","5.897","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Load Optimize #005","Load Optimize #001","4.728","3.368","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":353},{"label":"Fev","value":336},{"label":"Mar","value":275},{"label":"Abr","value":316},{"label":"Mai","value":415},{"label":"Jun","value":383},{"label":"Jul","value":446},{"label":"Ago","value":405},{"label":"Set","value":650},{"label":"Out","value":591},{"label":"Nov","value":412},{"label":"Dez","value":599}];
const MX = 650;
