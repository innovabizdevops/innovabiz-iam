...
export default function LoadOptimizePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Load Optimize</h1><p className="text-sm text-muted-foreground">Load Optimize • iBOS Enterprise</p></div>
