...
const PAGE = "Route";
const KPIS = [{"l":"Total Load Optimize","v":"1.324","t":"+14.0%","d":"up"},{"l":"Route Ativos","v":"170","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"84.5%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"59","t":"+8.1%","d":"up"}];
const COLS = ["ID","Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Load Optimize #001","Load Optimize #002","4.543","2.924","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Load Optimize #002","Load Optimize #003","7.008","5.562","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Load Optimize #003","Load Optimize #004","474","1.553","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Load Optimize #004","Load Optimize #005","8.297","3.613","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Load Optimize #005","Load Optimize #001","7.180","5.936","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":808},{"label":"Mar","value":724},{"label":"Abr","value":579},{"label":"Mai","value":674},{"label":"Jun","value":694},{"label":"Jul","value":767},{"label":"Ago","value":632},{"label":"Set","value":675},{"label":"Out","value":700},{"label":"Nov","value":574},{"label":"Dez","value":540}];
const MX = 808;
