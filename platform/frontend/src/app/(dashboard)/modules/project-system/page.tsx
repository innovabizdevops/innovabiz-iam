...
/* ═══ Project System (SAP PS) — Dashboard ═══ */

const ACCENT = "#0070f3";

const KPIS = [
    { label: "Total Registos", value: "4830", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1425", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€462K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "245178230", cells: ["PRO-1230", "Project System (SAP PS) Item 1", "11/3/2026", "€28 330"], status: "active" as const },
    { id: "245181801", cells: ["PRO-4801", "Project System (SAP PS) Item 2", "26/10/2026", "€31 901"], status: "pending" as const },
    { id: "245185372", cells: ["PRO-8372", "Project System (SAP PS) Item 3", "13/5/2026", "€35 472"], status: "completed" as const },
    { id: "245188943", cells: ["PRO-2943", "Project System (SAP PS) Item 4", "28/12/2026", "€39 043"], status: "warning" as const },
    { id: "245192514", cells: ["PRO-6514", "Project System (SAP PS) Item 5", "15/7/2026", "€42 614"], status: "active" as const },
];
...
export default function ProjectSystemSapPsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Project System (SAP PS)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Project System (SAP PS)</p>
                    </div>
                </div>
