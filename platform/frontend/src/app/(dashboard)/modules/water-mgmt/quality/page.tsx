...
const PAGE = "Quality Monitoring";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.674","t":"+2.5%","d":"up"},{"l":"NC Abertas","v":"903","t":"-0.3%","d":"down"},{"l":"Conformidade (%)","v":"87.0%","t":"+11.1%","d":"up"},{"l":"CAPAs Pendentes","v":"6.109","t":"+2.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.969","97.1%","4.796","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.729","83.8%","8.482","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.979","98.3%","3.074","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.636","87.0%","7.009","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.438","91.8%","8.669","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":924},{"label":"Fev","value":1050},{"label":"Mar","value":980},{"label":"Abr","value":1034},{"label":"Mai","value":1035},{"label":"Jun","value":758},{"label":"Jul","value":1046},{"label":"Ago","value":825},{"label":"Set","value":793},{"label":"Out","value":1077},{"label":"Nov","value":697},{"label":"Dez","value":810}];
const MX = 1077;
