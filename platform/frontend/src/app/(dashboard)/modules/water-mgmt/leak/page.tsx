...
const ACCENT = "#0284c7";
const MODULE = "Water Management";
const PAGE = "Leak Detection AI";
const KPIS = [{"l":"Total Water Mgmt","v":"539","t":"-3.6%","d":"down"},{"l":"Leak Detection AI Ativos","v":"5.419","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"92.3%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"63","t":"+2.4%","d":"up"}];
const COLS = ["ID","Leak Detection AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Mgmt #001","Water Mgmt #002","7.089","4.383","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Water Mgmt #002","Water Mgmt #003","4.559","8.884","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Mgmt #003","Water Mgmt #004","4.645","1.222","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Water Mgmt #004","Water Mgmt #005","8.743","8.823","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Mgmt #005","Water Mgmt #001","7.054","6.937","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":687},{"label":"Mar","value":800},{"label":"Abr","value":717},{"label":"Mai","value":541},{"label":"Jun","value":790},{"label":"Jul","value":566},{"label":"Ago","value":540},{"label":"Set","value":750},{"label":"Out","value":696},{"label":"Nov","value":623},{"label":"Dez","value":765}];
const MX = 800;
