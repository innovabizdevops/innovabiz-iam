...
const KPIS = [{"l":"Total Water Mgmt","v":"5.187","t":"+0.2%","d":"up"},{"l":"Billing & Metering Ativos","v":"4.164","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"89.2%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"78","t":"-0.3%","d":"down"}];
const COLS = ["ID","Billing & Metering","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Mgmt #001","Water Mgmt #002","1.445","5.269","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Water Mgmt #002","Water Mgmt #003","563","5.741","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Mgmt #003","Water Mgmt #004","4.069","2.347","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Water Mgmt #004","Water Mgmt #005","2.411","6.077","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Mgmt #005","Water Mgmt #001","524","7.815","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":664},{"label":"Mar","value":822},{"label":"Abr","value":602},{"label":"Mai","value":578},{"label":"Jun","value":617},{"label":"Jul","value":859},{"label":"Ago","value":817},{"label":"Set","value":648},{"label":"Out","value":657},{"label":"Nov","value":839},{"label":"Dez","value":749}];
const MX = 859;
