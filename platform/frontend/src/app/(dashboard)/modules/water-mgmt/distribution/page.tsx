...
const PAGE = "Distribution Network";
const KPIS = [{"l":"Total Water Mgmt","v":"2.132","t":"+4.7%","d":"up"},{"l":"Distribution Network Ativos","v":"8.678","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"56","t":"-4.0%","d":"down"}];
const COLS = ["ID","Distribution Network","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Mgmt #001","Water Mgmt #002","1.534","6.314","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Water Mgmt #002","Water Mgmt #003","4.831","5.963","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Mgmt #003","Water Mgmt #004","5.990","4.262","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Water Mgmt #004","Water Mgmt #005","6.479","942","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Mgmt #005","Water Mgmt #001","4.283","3.998","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":422},{"label":"Fev","value":438},{"label":"Mar","value":666},{"label":"Abr","value":460},{"label":"Mai","value":438},{"label":"Jun","value":383},{"label":"Jul","value":491},{"label":"Ago","value":564},{"label":"Set","value":578},{"label":"Out","value":357},{"label":"Nov","value":547},{"label":"Dez","value":517}];
const MX = 666;
