...
const PAGE = "Flood Prevention";
const KPIS = [{"l":"Total Water Mgmt","v":"533","t":"-5.0%","d":"down"},{"l":"Flood Prevention Ativos","v":"4.414","t":"+10.7%","d":"up"},{"l":"Eficiência (%)","v":"66.5%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"87","t":"+8.6%","d":"up"}];
const COLS = ["ID","Flood Prevention","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Mgmt #001","Water Mgmt #002","5.463","5.758","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Water Mgmt #002","Water Mgmt #003","3.457","8.507","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Mgmt #003","Water Mgmt #004","3.268","407","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Water Mgmt #004","Water Mgmt #005","6.221","1.693","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Mgmt #005","Water Mgmt #001","2.472","5.781","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":525},{"label":"Mar","value":576},{"label":"Abr","value":588},{"label":"Mai","value":400},{"label":"Jun","value":648},{"label":"Jul","value":510},{"label":"Ago","value":580},{"label":"Set","value":355},{"label":"Out","value":517},{"label":"Nov","value":396},{"label":"Dez","value":462}];
const MX = 648;
