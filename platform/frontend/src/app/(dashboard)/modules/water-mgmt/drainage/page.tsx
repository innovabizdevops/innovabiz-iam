...
const PAGE = "Drainage System";
const KPIS = [{"l":"Total Water Mgmt","v":"1.797","t":"+10.7%","d":"up"},{"l":"Drainage System Ativos","v":"1.779","t":"-1.4%","d":"down"},{"l":"Eficiência (%)","v":"73.1%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"93","t":"+17.6%","d":"up"}];
const COLS = ["ID","Drainage System","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Mgmt #001","Water Mgmt #002","939","1.806","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Water Mgmt #002","Water Mgmt #003","1.403","1.670","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Mgmt #003","Water Mgmt #004","2.315","9.067","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Water Mgmt #004","Water Mgmt #005","1.665","8.156","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Mgmt #005","Water Mgmt #001","6.473","8.770","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":431},{"label":"Fev","value":230},{"label":"Mar","value":532},{"label":"Abr","value":491},{"label":"Mai","value":227},{"label":"Jun","value":523},{"label":"Jul","value":548},{"label":"Ago","value":377},{"label":"Set","value":378},{"label":"Out","value":304},{"label":"Nov","value":524},{"label":"Dez","value":550}];
const MX = 550;
