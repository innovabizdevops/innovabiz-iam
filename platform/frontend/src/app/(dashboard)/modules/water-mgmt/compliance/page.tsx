...
const PAGE = "Compliance WWTP";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.619","t":"+6.0%","d":"up"},{"l":"NC Abertas","v":"2.722","t":"+7.9%","d":"up"},{"l":"Conformidade (%)","v":"76.1%","t":"+7.2%","d":"up"},{"l":"CAPAs Pendentes","v":"2.728","t":"+6.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.819","77.4%","5.154","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.422","73.2%","8.352","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.010","87.0%","2.993","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.887","88.1%","3.488","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.360","76.6%","2.115","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":881},{"label":"Fev","value":979},{"label":"Mar","value":657},{"label":"Abr","value":665},{"label":"Mai","value":748},{"label":"Jun","value":646},{"label":"Jul","value":731},{"label":"Ago","value":863},{"label":"Set","value":661},{"label":"Out","value":895},{"label":"Nov","value":827},{"label":"Dez","value":939}];
const MX = 979;
