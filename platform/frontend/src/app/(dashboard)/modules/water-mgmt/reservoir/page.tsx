...
const PAGE = "Reservoir Mgmt";
const KPIS = [{"l":"Total Water Mgmt","v":"3.942","t":"+1.1%","d":"up"},{"l":"Reservoir Mgmt Ativos","v":"3.402","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"67.7%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"63","t":"+6.8%","d":"up"}];
const COLS = ["ID","Reservoir Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Mgmt #001","Water Mgmt #002","7.042","8.251","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Water Mgmt #002","Water Mgmt #003","6.544","135","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Mgmt #003","Water Mgmt #004","7.877","890","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Water Mgmt #004","Water Mgmt #005","266","6.800","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Mgmt #005","Water Mgmt #001","5.414","1.442","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":899},{"label":"Fev","value":842},{"label":"Mar","value":852},{"label":"Abr","value":846},{"label":"Mai","value":947},{"label":"Jun","value":690},{"label":"Jul","value":737},{"label":"Ago","value":628},{"label":"Set","value":786},{"label":"Out","value":793},{"label":"Nov","value":589},{"label":"Dez","value":681}];
const MX = 947;
