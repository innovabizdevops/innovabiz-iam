...
const PAGE = "Plan";
const KPIS = [{"l":"Total Case Mgmt Deep","v":"3.637","t":"+7.8%","d":"up"},{"l":"Plan Ativos","v":"6.314","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"71.2%","t":"-4.9%","d":"down"},{"l":"Score Performance","v":"77","t":"+16.5%","d":"up"}];
const COLS = ["ID","Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Case Mgmt Deep #001","Case Mgmt Deep #002","8.977","1.453","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Case Mgmt Deep #002","Case Mgmt Deep #003","2.360","7.755","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Case Mgmt Deep #003","Case Mgmt Deep #004","3.994","587","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Case Mgmt Deep #004","Case Mgmt Deep #005","1.690","4.441","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Case Mgmt Deep #005","Case Mgmt Deep #001","2.388","4.732","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":982},{"label":"Fev","value":755},{"label":"Mar","value":763},{"label":"Abr","value":896},{"label":"Mai","value":933},{"label":"Jun","value":899},{"label":"Jul","value":620},{"label":"Ago","value":775},{"label":"Set","value":923},{"label":"Out","value":759},{"label":"Nov","value":757},{"label":"Dez","value":648}];
const MX = 982;
