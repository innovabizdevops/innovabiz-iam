...
const PAGE = "Track";
const KPIS = [{"l":"Total Case Mgmt Deep","v":"579","t":"-5.0%","d":"down"},{"l":"Track Ativos","v":"1.282","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"80.3%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"85","t":"-0.5%","d":"down"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Case Mgmt Deep #001","Case Mgmt Deep #002","4.925","9.044","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Case Mgmt Deep #002","Case Mgmt Deep #003","5.029","8.708","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Case Mgmt Deep #003","Case Mgmt Deep #004","6.711","2.303","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Case Mgmt Deep #004","Case Mgmt Deep #005","3.400","3.838","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Case Mgmt Deep #005","Case Mgmt Deep #001","2.551","8.673","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":682},{"label":"Mar","value":609},{"label":"Abr","value":638},{"label":"Mai","value":831},{"label":"Jun","value":940},{"label":"Jul","value":662},{"label":"Ago","value":944},{"label":"Set","value":720},{"label":"Out","value":702},{"label":"Nov","value":775},{"label":"Dez","value":603}];
const MX = 944;
