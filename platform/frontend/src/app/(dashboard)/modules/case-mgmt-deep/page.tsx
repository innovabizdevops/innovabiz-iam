...
/* ═══ Case Management Deep — Dashboard ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total Registos", value: "3066", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1348", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€94K", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1558035266", cells: ["CAS-1266", "Case Management Deep Item 1", "19/3/2026", "€35 366"], status: "active" as const },
    { id: "1558038837", cells: ["CAS-4837", "Case Management Deep Item 2", "6/10/2026", "€38 937"], status: "pending" as const },
    { id: "1558042408", cells: ["CAS-8408", "Case Management Deep Item 3", "21/5/2026", "€42 508"], status: "completed" as const },
    { id: "1558045979", cells: ["CAS-2979", "Case Management Deep Item 4", "8/12/2026", "€46 079"], status: "warning" as const },
    { id: "1558049550", cells: ["CAS-6550", "Case Management Deep Item 5", "23/7/2026", "€49 650"], status: "active" as const },
];
...
export default function CaseManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Case Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Case Management Deep</p>
                    </div>
                </div>
