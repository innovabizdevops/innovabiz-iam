...
const PAGE = "Close";
const KPIS = [{"l":"Total Case Mgmt Deep","v":"7.666","t":"+8.4%","d":"up"},{"l":"Close Ativos","v":"6.190","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"79.7%","t":"+6.1%","d":"up"},{"l":"Score Performance","v":"92","t":"+16.3%","d":"up"}];
const COLS = ["ID","Close","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Case Mgmt Deep #001","Case Mgmt Deep #002","4.094","414","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Case Mgmt Deep #002","Case Mgmt Deep #003","7.345","7.080","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Case Mgmt Deep #003","Case Mgmt Deep #004","7.463","6.055","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Case Mgmt Deep #004","Case Mgmt Deep #005","1.030","866","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Case Mgmt Deep #005","Case Mgmt Deep #001","1.265","6.656","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":753},{"label":"Mar","value":653},{"label":"Abr","value":624},{"label":"Mai","value":584},{"label":"Jun","value":595},{"label":"Jul","value":478},{"label":"Ago","value":539},{"label":"Set","value":543},{"label":"Out","value":485},{"label":"Nov","value":603},{"label":"Dez","value":519}];
const MX = 753;
