...
const PAGE = "Assess";
const KPIS = [{"l":"Total Case Mgmt Deep","v":"4.780","t":"+15.7%","d":"up"},{"l":"Assess Ativos","v":"213","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"90.4%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"70","t":"-5.7%","d":"down"}];
const COLS = ["ID","Assess","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Case Mgmt Deep #001","Case Mgmt Deep #002","330","6.368","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Case Mgmt Deep #002","Case Mgmt Deep #003","2.347","5.109","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Case Mgmt Deep #003","Case Mgmt Deep #004","527","5.467","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Case Mgmt Deep #004","Case Mgmt Deep #005","4.335","7.131","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Case Mgmt Deep #005","Case Mgmt Deep #001","7.076","4.072","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":358},{"label":"Fev","value":340},{"label":"Mar","value":518},{"label":"Abr","value":421},{"label":"Mai","value":650},{"label":"Jun","value":376},{"label":"Jul","value":550},{"label":"Ago","value":526},{"label":"Set","value":616},{"label":"Out","value":588},{"label":"Nov","value":605},{"label":"Dez","value":391}];
const MX = 650;
