...
const ACCENT = "#e11d48";
const MODULE = "Case Management Deep";
const PAGE = "Intake";
const KPIS = [{"l":"Total Case Mgmt Deep","v":"5.750","t":"-4.5%","d":"down"},{"l":"Intake Ativos","v":"1.612","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"68.7%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"91","t":"+0.6%","d":"up"}];
const COLS = ["ID","Intake","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Case Mgmt Deep #001","Case Mgmt Deep #002","3.855","6.051","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Case Mgmt Deep #002","Case Mgmt Deep #003","1.142","7.634","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Case Mgmt Deep #003","Case Mgmt Deep #004","5.054","4.907","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Case Mgmt Deep #004","Case Mgmt Deep #005","2.597","6.961","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Case Mgmt Deep #005","Case Mgmt Deep #001","7.313","2.237","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":659},{"label":"Mar","value":882},{"label":"Abr","value":700},{"label":"Mai","value":835},{"label":"Jun","value":886},{"label":"Jul","value":849},{"label":"Ago","value":624},{"label":"Set","value":573},{"label":"Out","value":920},{"label":"Nov","value":586},{"label":"Dez","value":837}];
const MX = 920;
