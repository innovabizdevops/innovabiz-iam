...
const ACCENT = "#6d28d9";
const MODULE = "GenAI Speech Engine";
const PAGE = "Real-Time";
const KPIS = [{"l":"Total Genai Speech","v":"8.942","t":"-3.6%","d":"down"},{"l":"Real Time Ativos","v":"6.956","t":"-5.9%","d":"down"},{"l":"Eficiência (%)","v":"73.7%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"80","t":"+10.5%","d":"up"}];
const COLS = ["ID","Real Time","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Speech #001","Genai Speech #002","524","8.926","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Speech #002","Genai Speech #003","7.112","1.137","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Speech #003","Genai Speech #004","902","2.443","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Speech #004","Genai Speech #005","550","5.160","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Speech #005","Genai Speech #001","5.254","5.125","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":769},{"label":"Fev","value":704},{"label":"Mar","value":538},{"label":"Abr","value":523},{"label":"Mai","value":586},{"label":"Jun","value":526},{"label":"Jul","value":613},{"label":"Ago","value":839},{"label":"Set","value":852},{"label":"Out","value":703},{"label":"Nov","value":826},{"label":"Dez","value":726}];
const MX = 852;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6d28d9'}}>RTM</span></h1>
                </div>
