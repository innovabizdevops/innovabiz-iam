...
const PAGE = "Voice Clone";
const KPIS = [{"l":"Total Genai Speech","v":"5.921","t":"+9.2%","d":"up"},{"l":"Voice Clone Ativos","v":"5.248","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"84.3%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"83","t":"-3.6%","d":"down"}];
const COLS = ["ID","Voice Clone","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Speech #001","Genai Speech #002","5.275","1.403","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Speech #002","Genai Speech #003","6.283","5.370","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Speech #003","Genai Speech #004","2.288","6.076","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Speech #004","Genai Speech #005","6.566","8.073","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Speech #005","Genai Speech #001","4.483","6.547","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":575},{"label":"Mar","value":736},{"label":"Abr","value":946},{"label":"Mai","value":934},{"label":"Jun","value":825},{"label":"Jul","value":948},{"label":"Ago","value":733},{"label":"Set","value":739},{"label":"Out","value":596},{"label":"Nov","value":591},{"label":"Dez","value":867}];
const MX = 948;
