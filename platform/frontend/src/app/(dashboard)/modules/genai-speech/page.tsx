...
/* ═══ GenAI Speech Engine — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "8746", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4499", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€334K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "-4%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "701849346", cells: ["GEN-3346", "GenAI Speech Engine Item 1", "3/7/2026", "€49 446"], status: "active" as const },
    { id: "701852917", cells: ["GEN-6917", "GenAI Speech Engine Item 2", "18/2/2026", "€3017"], status: "pending" as const },
    { id: "701856488", cells: ["GEN-1488", "GenAI Speech Engine Item 3", "5/9/2026", "€6588"], status: "completed" as const },
    { id: "701860059", cells: ["GEN-5059", "GenAI Speech Engine Item 4", "20/4/2026", "€10 159"], status: "warning" as const },
    { id: "701863630", cells: ["GEN-8630", "GenAI Speech Engine Item 5", "7/11/2026", "€13 730"], status: "active" as const },
];
...
export default function GenaiSpeechEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Speech Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Speech Engine</p>
                    </div>
                </div>
