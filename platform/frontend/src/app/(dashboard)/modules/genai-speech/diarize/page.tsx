...
const PAGE = "Diarize";
const KPIS = [{"l":"Total Genai Speech","v":"1.137","t":"+4.9%","d":"up"},{"l":"Diarize Ativos","v":"559","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"87.3%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"59","t":"+8.8%","d":"up"}];
const COLS = ["ID","Diarize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Speech #001","Genai Speech #002","5.749","555","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Speech #002","Genai Speech #003","350","213","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Speech #003","Genai Speech #004","4.910","5.900","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Speech #004","Genai Speech #005","6.245","7.588","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Speech #005","Genai Speech #001","7.080","7.055","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":398},{"label":"Fev","value":497},{"label":"Mar","value":388},{"label":"Abr","value":489},{"label":"Mai","value":597},{"label":"Jun","value":367},{"label":"Jul","value":700},{"label":"Ago","value":358},{"label":"Set","value":486},{"label":"Out","value":590},{"label":"Nov","value":599},{"label":"Dez","value":585}];
const MX = 700;
