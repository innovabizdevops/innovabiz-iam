...
const ACCENT = "#059669";
const MODULE = "Ship Brokerage";
const PAGE = "Market Report";
const KPIS = [{"l":"Total Ship Brokerage","v":"3.293","t":"+14.1%","d":"up"},{"l":"Market Report Ativos","v":"4.358","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"76.2%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"58","t":"+15.7%","d":"up"}];
const COLS = ["ID","Market Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ship Brokerage #001","Ship Brokerage #002","3.488","6.094","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Ship Brokerage #002","Ship Brokerage #003","5.481","996","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Ship Brokerage #003","Ship Brokerage #004","7.964","3.849","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Ship Brokerage #004","Ship Brokerage #005","2.055","2.718","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ship Brokerage #005","Ship Brokerage #001","3.090","7.554","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":961},{"label":"Fev","value":811},{"label":"Mar","value":851},{"label":"Abr","value":760},{"label":"Mai","value":976},{"label":"Jun","value":853},{"label":"Jul","value":999},{"label":"Ago","value":695},{"label":"Set","value":771},{"label":"Out","value":1051},{"label":"Nov","value":799},{"label":"Dez","value":669}];
const MX = 1051;
