...
const PAGE = "S&amp;P Market";
const KPIS = [{"l":"Total Ship Brokerage","v":"2.995","t":"+5.2%","d":"up"},{"l":"S&P Market Ativos","v":"8.519","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"84.9%","t":"-3.1%","d":"down"},{"l":"Score Performance","v":"57","t":"+11.2%","d":"up"}];
const COLS = ["ID","S&P Market","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ship Brokerage #001","Ship Brokerage #002","369","5.165","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Ship Brokerage #002","Ship Brokerage #003","2.214","3.261","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Ship Brokerage #003","Ship Brokerage #004","8.953","3.008","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Ship Brokerage #004","Ship Brokerage #005","6.060","3.413","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ship Brokerage #005","Ship Brokerage #001","7.029","8.895","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":588},{"label":"Mar","value":661},{"label":"Abr","value":368},{"label":"Mai","value":720},{"label":"Jun","value":368},{"label":"Jul","value":729},{"label":"Ago","value":480},{"label":"Set","value":365},{"label":"Out","value":464},{"label":"Nov","value":637},{"label":"Dez","value":375}];
const MX = 729;
