...
const PAGE = "Newbuilding";
const KPIS = [{"l":"Total Ship Brokerage","v":"7.728","t":"+4.0%","d":"up"},{"l":"Newbuilding Ativos","v":"4.290","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"92.6%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"63","t":"+11.7%","d":"up"}];
const COLS = ["ID","Newbuilding","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ship Brokerage #001","Ship Brokerage #002","4.142","4.591","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Ship Brokerage #002","Ship Brokerage #003","4.637","7.571","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Ship Brokerage #003","Ship Brokerage #004","8.992","2.011","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Ship Brokerage #004","Ship Brokerage #005","6.031","8.468","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ship Brokerage #005","Ship Brokerage #001","392","5.160","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":667},{"label":"Mar","value":699},{"label":"Abr","value":661},{"label":"Mai","value":485},{"label":"Jun","value":474},{"label":"Jul","value":521},{"label":"Ago","value":425},{"label":"Set","value":444},{"label":"Out","value":520},{"label":"Nov","value":416},{"label":"Dez","value":625}];
const MX = 756;
