...
export default function ShipBrokeragePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Ship Brokerage</h1><p className="text-sm text-muted-foreground">Ship Brokerage • iBOS Enterprise</p></div>
