...
const PAGE = "Demolition";
const KPIS = [{"l":"Total Ship Brokerage","v":"4.158","t":"-0.4%","d":"down"},{"l":"Demolition Ativos","v":"8.514","t":"-1.4%","d":"down"},{"l":"Eficiência (%)","v":"71.2%","t":"+7.6%","d":"up"},{"l":"Score Performance","v":"71","t":"+16.6%","d":"up"}];
const COLS = ["ID","Demolition","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ship Brokerage #001","Ship Brokerage #002","7.661","3.496","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Ship Brokerage #002","Ship Brokerage #003","1.720","4.891","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Ship Brokerage #003","Ship Brokerage #004","5.094","7.728","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Ship Brokerage #004","Ship Brokerage #005","7.388","3.190","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ship Brokerage #005","Ship Brokerage #001","2.948","6.634","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1040},{"label":"Fev","value":909},{"label":"Mar","value":977},{"label":"Abr","value":895},{"label":"Mai","value":803},{"label":"Jun","value":1067},{"label":"Jul","value":761},{"label":"Ago","value":1034},{"label":"Set","value":781},{"label":"Out","value":813},{"label":"Nov","value":766},{"label":"Dez","value":762}];
const MX = 1067;
