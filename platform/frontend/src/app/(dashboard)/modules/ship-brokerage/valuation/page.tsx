...
const KPIS = [{"l":"Total Ship Brokerage","v":"2.496","t":"-4.4%","d":"down"},{"l":"Valuation Ativos","v":"3.462","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"89.0%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"60","t":"+2.3%","d":"up"}];
const COLS = ["ID","Valuation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ship Brokerage #001","Ship Brokerage #002","1.135","6.178","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Ship Brokerage #002","Ship Brokerage #003","8.967","3.244","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Ship Brokerage #003","Ship Brokerage #004","5.898","6.428","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Ship Brokerage #004","Ship Brokerage #005","3.780","493","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ship Brokerage #005","Ship Brokerage #001","291","3.677","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":390},{"label":"Mar","value":564},{"label":"Abr","value":454},{"label":"Mai","value":685},{"label":"Jun","value":399},{"label":"Jul","value":514},{"label":"Ago","value":480},{"label":"Set","value":504},{"label":"Out","value":501},{"label":"Nov","value":570},{"label":"Dez","value":641}];
const MX = 685;
