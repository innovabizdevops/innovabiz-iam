...
const KPIS = [{"l":"Formulários Ativos","v":"3.604","t":"-2.3%","d":"down"},{"l":"Submissões/Dia","v":"3312","t":"+0.7%","d":"up"},{"l":"Documentos Gerados","v":"4.037","t":"+18.0%","d":"up"},{"l":"Templates","v":"8.422","t":"+15.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.548","2026-01-21","2.176","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.569","2026-02-02","4.272","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.234","2026-02-10","3.191","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.498","2026-02-01","1.022","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.420","2026-01-06","2.476","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":899},{"label":"Fev","value":873},{"label":"Mar","value":840},{"label":"Abr","value":809},{"label":"Mai","value":904},{"label":"Jun","value":742},{"label":"Jul","value":553},{"label":"Ago","value":889},{"label":"Set","value":536},{"label":"Out","value":758},{"label":"Nov","value":902},{"label":"Dez","value":906}];
const MX = 906;
