...
const PAGE = "App Mgmt";
const KPIS = [{"l":"Formulários Ativos","v":"5.173","t":"+4.4%","d":"up"},{"l":"Submissões/Dia","v":"404","t":"+3.9%","d":"up"},{"l":"Documentos Gerados","v":"4.895","t":"+0.7%","d":"up"},{"l":"Templates","v":"1.958","t":"-3.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.744","2026-02-05","6.043","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.094","2026-02-03","6.193","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.329","2026-02-22","7.612","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.151","2026-02-01","7.805","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","833","2026-02-18","5.535","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":420},{"label":"Fev","value":571},{"label":"Mar","value":633},{"label":"Abr","value":480},{"label":"Mai","value":450},{"label":"Jun","value":506},{"label":"Jul","value":360},{"label":"Ago","value":544},{"label":"Set","value":478},{"label":"Out","value":368},{"label":"Nov","value":398},{"label":"Dez","value":320}];
const MX = 633;
