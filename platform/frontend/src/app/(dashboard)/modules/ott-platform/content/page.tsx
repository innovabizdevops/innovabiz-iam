...
const PAGE = "Content";
const KPIS = [{"l":"Formulários Ativos","v":"1.918","t":"-5.4%","d":"down"},{"l":"Submissões/Dia","v":"4115","t":"-5.0%","d":"down"},{"l":"Documentos Gerados","v":"776","t":"+7.2%","d":"up"},{"l":"Templates","v":"1.252","t":"+17.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.825","2026-01-11","5.667","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.211","2026-03-24","1.522","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.962","2026-01-10","992","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.566","2026-02-24","3.775","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.972","2026-02-01","814","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":812},{"label":"Mar","value":625},{"label":"Abr","value":728},{"label":"Mai","value":694},{"label":"Jun","value":780},{"label":"Jul","value":724},{"label":"Ago","value":825},{"label":"Set","value":739},{"label":"Out","value":737},{"label":"Nov","value":761},{"label":"Dez","value":835}];
const MX = 835;
