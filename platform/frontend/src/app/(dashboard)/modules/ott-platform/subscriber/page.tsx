...
const ACCENT = "#6366f1";
const MODULE = "OTT Platform";
const PAGE = "Subscriber";
const KPIS = [{"l":"Formulários Ativos","v":"6.351","t":"-0.4%","d":"down"},{"l":"Submissões/Dia","v":"269","t":"+9.5%","d":"up"},{"l":"Documentos Gerados","v":"7.250","t":"+5.9%","d":"up"},{"l":"Templates","v":"2.734","t":"+1.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.732","2026-02-16","1.809","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.829","2026-03-12","7.297","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.050","2026-03-13","4.851","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.960","2026-03-05","6.980","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.491","2026-03-18","6.598","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":401},{"label":"Fev","value":609},{"label":"Mar","value":580},{"label":"Abr","value":500},{"label":"Mai","value":645},{"label":"Jun","value":483},{"label":"Jul","value":591},{"label":"Ago","value":646},{"label":"Set","value":488},{"label":"Out","value":460},{"label":"Nov","value":653},{"label":"Dez","value":543}];
const MX = 653;
