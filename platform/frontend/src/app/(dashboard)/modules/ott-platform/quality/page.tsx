...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.657","t":"+17.0%","d":"up"},{"l":"NC Abertas","v":"1.363","t":"+2.4%","d":"up"},{"l":"Conformidade (%)","v":"79.3%","t":"-1.3%","d":"down"},{"l":"CAPAs Pendentes","v":"8.728","t":"+0.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.827","82.9%","1.665","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","423","76.0%","8.025","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.836","83.1%","4.084","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.290","90.1%","8.986","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.416","92.6%","6.752","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":797},{"label":"Mar","value":572},{"label":"Abr","value":636},{"label":"Mai","value":796},{"label":"Jun","value":884},{"label":"Jul","value":768},{"label":"Ago","value":676},{"label":"Set","value":799},{"label":"Out","value":926},{"label":"Nov","value":681},{"label":"Dez","value":845}];
const MX = 926;
