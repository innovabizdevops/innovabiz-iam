...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"1.615","t":"+7.7%","d":"up"},{"l":"Queries/Dia","v":"1382","t":"+8.1%","d":"up"},{"l":"Dados Processados (GB)","v":"2.621","t":"+3.7%","d":"up"},{"l":"Utilizadores Analytics","v":"2.502","t":"+16.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4606","2026-02-18","3.832","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1442","2026-01-27","7.877","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3111","2026-03-08","2.602","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3914","2026-01-28","1.920","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1700","2026-03-14","1.939","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":315},{"label":"Mar","value":394},{"label":"Abr","value":381},{"label":"Mai","value":351},{"label":"Jun","value":285},{"label":"Jul","value":527},{"label":"Ago","value":359},{"label":"Set","value":277},{"label":"Out","value":506},{"label":"Nov","value":383},{"label":"Dez","value":375}];
const MX = 527;
