...
const PAGE = "Bid";
const KPIS = [{"l":"Fornecedores Ativos","v":"3.747","t":"+11.6%","d":"up"},{"l":"Contratos (€M)","v":"€25.4M","t":"+8.8%","d":"up"},{"l":"On-Time Delivery (%)","v":"89.8%","t":"-0.3%","d":"down"},{"l":"Score Médio","v":"64","t":"+15.5%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","78.8%","€ 33042.19","2.622","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","97.7%","€ 1009.40","6.027","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","98.3%","€ 5481.00","394","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","78.3%","€ 24591.84","6.674","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","75.2%","€ 37724.64","7.674","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":727},{"label":"Mar","value":616},{"label":"Abr","value":804},{"label":"Mai","value":753},{"label":"Jun","value":924},{"label":"Jul","value":611},{"label":"Ago","value":788},{"label":"Set","value":725},{"label":"Out","value":680},{"label":"Nov","value":781},{"label":"Dez","value":800}];
const MX = 924;
