...
/* ═══ Livestock Auction — Dashboard ═══ */

const ACCENT = "#a16207";

const KPIS = [
    { label: "Total Registos", value: "7831", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "301", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€191K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "-14%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "808154631", cells: ["LIV-9631", "Livestock Auction Item 1", "12/4/2026", "€4731"], status: "active" as const },
    { id: "808158202", cells: ["LIV-4202", "Livestock Auction Item 2", "27/11/2026", "€8302"], status: "pending" as const },
    { id: "808161773", cells: ["LIV-7773", "Livestock Auction Item 3", "14/6/2026", "€11 873"], status: "completed" as const },
    { id: "808165344", cells: ["LIV-2344", "Livestock Auction Item 4", "1/1/2026", "€15 444"], status: "warning" as const },
    { id: "808168915", cells: ["LIV-5915", "Livestock Auction Item 5", "16/8/2026", "€19 015"], status: "active" as const },
];
...
export default function LivestockAuctionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Livestock Auction</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Livestock Auction</p>
                    </div>
                </div>
