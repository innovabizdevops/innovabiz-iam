...
const KPIS = [{"l":"Atletas Registados","v":"7.891","t":"+17.8%","d":"up"},{"l":"Treinos/Semana","v":"2841","t":"+7.2%","d":"up"},{"l":"Competições","v":"8.576","t":"+2.1%","d":"up"},{"l":"Performance Score","v":"87","t":"+6.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.284","897","5.180","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.078","7.993","8.095","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.966","8.331","1.195","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.332","7.473","5.233","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.658","2.587","4.933","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":714},{"label":"Mar","value":666},{"label":"Abr","value":561},{"label":"Mai","value":675},{"label":"Jun","value":854},{"label":"Jul","value":656},{"label":"Ago","value":730},{"label":"Set","value":637},{"label":"Out","value":761},{"label":"Nov","value":576},{"label":"Dez","value":811}];
const MX = 854;
