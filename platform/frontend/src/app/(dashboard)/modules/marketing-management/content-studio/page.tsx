...
const PAGE = "Content Studio GenAI";
const KPIS = [{"l":"Projetos Melhoria","v":"7.841","t":"+3.4%","d":"up"},{"l":"Savings (€)","v":"€12657","t":"+11.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"88.0%","t":"+9.8%","d":"up"},{"l":"Ciclos PDCA","v":"3.081","t":"-0.3%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.030","€ 8016.62","2.799","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.355","€ 3527.07","3.626","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.627","€ 10324.65","3.230","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.725","€ 45962.71","3.795","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.968","€ 12179.79","6.944","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":924},{"label":"Mar","value":970},{"label":"Abr","value":968},{"label":"Mai","value":751},{"label":"Jun","value":679},{"label":"Jul","value":1068},{"label":"Ago","value":735},{"label":"Set","value":906},{"label":"Out","value":826},{"label":"Nov","value":895},{"label":"Dez","value":832}];
const MX = 1068;
