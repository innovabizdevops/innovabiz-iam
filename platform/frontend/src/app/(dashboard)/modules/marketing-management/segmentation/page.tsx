...
const PAGE = "Audience Segmentation AI";
const KPIS = [{"l":"Perfis Unificados","v":"6.483","t":"-0.4%","d":"down"},{"l":"Segmentos Ativos","v":"8.989","t":"+9.2%","d":"up"},{"l":"NPS Score","v":"81","t":"+17.8%","d":"up"},{"l":"Churn Previsto (%)","v":"92.2%","t":"+17.1%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","1.772","€ 16108.68","85.7%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","294","€ 34013.99","93.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","4.122","€ 43915.29","86.1%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","3.646","€ 4797.33","100.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","1.181","€ 12117.81","73.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":806},{"label":"Mar","value":622},{"label":"Abr","value":550},{"label":"Mai","value":847},{"label":"Jun","value":671},{"label":"Jul","value":640},{"label":"Ago","value":837},{"label":"Set","value":743},{"label":"Out","value":604},{"label":"Nov","value":582},{"label":"Dez","value":592}];
const MX = 847;
