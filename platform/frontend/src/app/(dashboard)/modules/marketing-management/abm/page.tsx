...
const PAGE = "ABM";
const KPIS = [{"l":"Projetos Melhoria","v":"1.305","t":"+2.4%","d":"up"},{"l":"Savings (€)","v":"€91996","t":"+12.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"68.6%","t":"+1.8%","d":"up"},{"l":"Ciclos PDCA","v":"563","t":"+0.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.318","€ 44200.44","3.328","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","983","€ 49198.66","4.715","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.164","€ 18130.06","4.036","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.041","€ 35320.07","2.263","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.400","€ 311.64","1.511","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":886},{"label":"Fev","value":966},{"label":"Mar","value":976},{"label":"Abr","value":671},{"label":"Mai","value":842},{"label":"Jun","value":710},{"label":"Jul","value":720},{"label":"Ago","value":641},{"label":"Set","value":982},{"label":"Out","value":934},{"label":"Nov","value":868},{"label":"Dez","value":879}];
const MX = 982;
