...
const PAGE = "Social Media";
const KPIS = [{"l":"Integrações Ativas","v":"2.621","t":"+1.2%","d":"up"},{"l":"Chamadas/Hora","v":"1603","t":"-2.7%","d":"down"},{"l":"Taxa Sucesso (%)","v":"68.4%","t":"+8.6%","d":"up"},{"l":"Latência Média (ms)","v":"163ms","t":"-5.3%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","651","1.182","86.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.360","6.695","83.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.354","1.206","75.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","726","7.047","92.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.359","7.914","71.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":362},{"label":"Fev","value":562},{"label":"Mar","value":583},{"label":"Abr","value":533},{"label":"Mai","value":321},{"label":"Jun","value":547},{"label":"Jul","value":438},{"label":"Ago","value":471},{"label":"Set","value":596},{"label":"Out","value":619},{"label":"Nov","value":330},{"label":"Dez","value":579}];
const MX = 619;
