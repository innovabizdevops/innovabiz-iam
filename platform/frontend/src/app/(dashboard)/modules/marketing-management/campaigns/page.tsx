...
const PAGE = "Campaigns &amp; Content";
const KPIS = [{"l":"Projetos Melhoria","v":"3.102","t":"+12.2%","d":"up"},{"l":"Savings (€)","v":"€76160","t":"+6.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"70.5%","t":"-3.2%","d":"down"},{"l":"Ciclos PDCA","v":"5.601","t":"-4.0%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.179","€ 7827.08","7.458","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.414","€ 22899.34","3.375","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","208","€ 38453.81","3.368","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.933","€ 47803.34","6.416","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.826","€ 32782.61","4.502","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":216},{"label":"Fev","value":522},{"label":"Mar","value":262},{"label":"Abr","value":499},{"label":"Mai","value":589},{"label":"Jun","value":263},{"label":"Jul","value":481},{"label":"Ago","value":227},{"label":"Set","value":387},{"label":"Out","value":519},{"label":"Nov","value":463},{"label":"Dez","value":308}];
const MX = 589;
