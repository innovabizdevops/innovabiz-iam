...
const PAGE = "Account-Based Marketing";
const KPIS = [{"l":"Projetos Melhoria","v":"3.387","t":"+5.2%","d":"up"},{"l":"Savings (€)","v":"€78174","t":"+0.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"71.8%","t":"+9.6%","d":"up"},{"l":"Ciclos PDCA","v":"3.024","t":"-5.2%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.955","€ 44546.04","1.191","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.213","€ 8716.64","668","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.628","€ 32285.43","8.962","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.488","€ 15948.95","3.520","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.342","€ 12230.32","6.114","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":302},{"label":"Fev","value":597},{"label":"Mar","value":387},{"label":"Abr","value":553},{"label":"Mai","value":439},{"label":"Jun","value":485},{"label":"Jul","value":339},{"label":"Ago","value":347},{"label":"Set","value":578},{"label":"Out","value":529},{"label":"Nov","value":503},{"label":"Dez","value":453}];
const MX = 597;
...
export default function AbmMarketingPage() {
    return (
