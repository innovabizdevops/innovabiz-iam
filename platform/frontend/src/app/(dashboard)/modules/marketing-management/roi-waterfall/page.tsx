...
const PAGE = "ROI Waterfall Chart";
const KPIS = [{"l":"Projetos Melhoria","v":"2.836","t":"+14.2%","d":"up"},{"l":"Savings (€)","v":"€47271","t":"-3.2%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"66.1%","t":"-5.1%","d":"down"},{"l":"Ciclos PDCA","v":"2.195","t":"-1.5%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.525","€ 16902.47","2.669","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.190","€ 29423.88","5.325","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.415","€ 45836.85","2.661","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.044","€ 16740.93","6.802","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.790","€ 13258.06","3.339","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":343},{"label":"Fev","value":374},{"label":"Mar","value":491},{"label":"Abr","value":528},{"label":"Mai","value":525},{"label":"Jun","value":227},{"label":"Jul","value":312},{"label":"Ago","value":606},{"label":"Set","value":522},{"label":"Out","value":619},{"label":"Nov","value":512},{"label":"Dez","value":273}];
const MX = 619;
...
export default function RoiWaterfallPage() {
    return (
