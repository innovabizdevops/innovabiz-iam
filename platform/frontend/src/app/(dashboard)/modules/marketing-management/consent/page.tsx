...
const PAGE = "Consent Mgmt";
const KPIS = [{"l":"Projetos Melhoria","v":"7.819","t":"+16.0%","d":"up"},{"l":"Savings (€)","v":"€80216","t":"+10.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"79.8%","t":"+17.7%","d":"up"},{"l":"Ciclos PDCA","v":"1.927","t":"+1.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.585","€ 37006.51","6.813","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.461","€ 1814.46","2.367","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.566","€ 42124.16","7.697","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","637","€ 11857.19","7.121","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.347","€ 29398.95","957","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":487},{"label":"Mar","value":848},{"label":"Abr","value":654},{"label":"Mai","value":619},{"label":"Jun","value":469},{"label":"Jul","value":596},{"label":"Ago","value":641},{"label":"Set","value":779},{"label":"Out","value":752},{"label":"Nov","value":700},{"label":"Dez","value":636}];
const MX = 848;
