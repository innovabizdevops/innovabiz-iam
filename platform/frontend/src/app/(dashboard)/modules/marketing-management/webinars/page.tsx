...
const PAGE = "Webinar Platform";
const KPIS = [{"l":"Formulários Ativos","v":"1.608","t":"+15.4%","d":"up"},{"l":"Submissões/Dia","v":"2429","t":"+1.7%","d":"up"},{"l":"Documentos Gerados","v":"4.462","t":"+6.9%","d":"up"},{"l":"Templates","v":"7.094","t":"+16.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.418","2026-01-27","8.489","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.070","2026-03-14","1.476","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.538","2026-03-25","7.499","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","853","2026-01-14","7.996","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.920","2026-03-21","657","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":831},{"label":"Fev","value":790},{"label":"Mar","value":643},{"label":"Abr","value":772},{"label":"Mai","value":841},{"label":"Jun","value":878},{"label":"Jul","value":637},{"label":"Ago","value":998},{"label":"Set","value":920},{"label":"Out","value":724},{"label":"Nov","value":885},{"label":"Dez","value":1002}];
const MX = 1002;
