...
const PAGE = "Social Listening AI";
const KPIS = [{"l":"Projetos Melhoria","v":"6.703","t":"+12.8%","d":"up"},{"l":"Savings (€)","v":"€48321","t":"+10.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"67.5%","t":"+4.2%","d":"up"},{"l":"Ciclos PDCA","v":"3.807","t":"+5.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.760","€ 7099.18","8.234","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.431","€ 45029.59","5.942","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.030","€ 35323.76","2.680","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.459","€ 46030.48","759","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","883","€ 32855.99","2.446","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":728},{"label":"Mar","value":751},{"label":"Abr","value":537},{"label":"Mai","value":709},{"label":"Jun","value":600},{"label":"Jul","value":723},{"label":"Ago","value":714},{"label":"Set","value":592},{"label":"Out","value":688},{"label":"Nov","value":437},{"label":"Dez","value":398}];
const MX = 770;
