...
const PAGE = "Audience Builder";
const KPIS = [{"l":"Projetos Melhoria","v":"2.176","t":"-0.6%","d":"down"},{"l":"Savings (€)","v":"€81237","t":"+6.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"87.4%","t":"-0.9%","d":"down"},{"l":"Ciclos PDCA","v":"8.739","t":"+2.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.844","€ 13504.26","8.915","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.769","€ 24335.62","7.476","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.727","€ 24285.24","5.380","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.842","€ 46375.49","2.473","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","9.000","€ 11146.57","1.900","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":817},{"label":"Mar","value":882},{"label":"Abr","value":688},{"label":"Mai","value":717},{"label":"Jun","value":928},{"label":"Jul","value":818},{"label":"Ago","value":1035},{"label":"Set","value":965},{"label":"Out","value":786},{"label":"Nov","value":937},{"label":"Dez","value":830}];
const MX = 1035;
