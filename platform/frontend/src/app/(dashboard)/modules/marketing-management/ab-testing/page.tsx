...
const PAGE = "A/B Testing Engine";
const KPIS = [{"l":"Projetos Melhoria","v":"8.530","t":"-5.8%","d":"down"},{"l":"Savings (€)","v":"€97748","t":"-1.5%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"70.9%","t":"+12.8%","d":"up"},{"l":"Ciclos PDCA","v":"1.344","t":"+7.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.915","€ 6891.44","6.596","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.358","€ 34818.24","3.122","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.581","€ 12132.70","2.182","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","9.014","€ 11998.58","2.574","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.190","€ 39805.34","8.032","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":815},{"label":"Mar","value":762},{"label":"Abr","value":789},{"label":"Mai","value":805},{"label":"Jun","value":753},{"label":"Jul","value":738},{"label":"Ago","value":856},{"label":"Set","value":700},{"label":"Out","value":693},{"label":"Nov","value":1058},{"label":"Dez","value":871}];
const MX = 1058;
