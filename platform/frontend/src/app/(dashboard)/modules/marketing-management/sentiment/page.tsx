...
const KPIS = [{"l":"Dashboards Ativos","v":"5.776","t":"+15.1%","d":"up"},{"l":"Queries/Dia","v":"5078","t":"+4.7%","d":"up"},{"l":"Dados Processados (GB)","v":"3.792","t":"-2.2%","d":"down"},{"l":"Utilizadores Analytics","v":"1.571","t":"+7.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4345","2026-03-28","5.049","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","449","2026-01-16","8.576","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","619","2026-01-19","8.132","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","421","2026-03-27","626","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2909","2026-01-07","3.790","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":918},{"label":"Fev","value":1048},{"label":"Mar","value":1015},{"label":"Abr","value":979},{"label":"Mai","value":794},{"label":"Jun","value":937},{"label":"Jul","value":824},{"label":"Ago","value":904},{"label":"Set","value":916},{"label":"Out","value":766},{"label":"Nov","value":1042},{"label":"Dez","value":925}];
const MX = 1048;
