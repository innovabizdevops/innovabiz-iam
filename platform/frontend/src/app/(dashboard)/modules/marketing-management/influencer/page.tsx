...
const PAGE = "Influencer Management";
const KPIS = [{"l":"Projetos Melhoria","v":"7.456","t":"-0.4%","d":"down"},{"l":"Savings (€)","v":"€57029","t":"+7.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"93.3%","t":"+6.5%","d":"up"},{"l":"Ciclos PDCA","v":"8.537","t":"+11.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.576","€ 21183.78","3.118","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.961","€ 11113.45","4.679","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.645","€ 39919.55","596","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.408","€ 25657.89","1.430","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.899","€ 7629.87","3.101","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":424},{"label":"Fev","value":556},{"label":"Mar","value":360},{"label":"Abr","value":635},{"label":"Mai","value":493},{"label":"Jun","value":506},{"label":"Jul","value":378},{"label":"Ago","value":236},{"label":"Set","value":412},{"label":"Out","value":460},{"label":"Nov","value":635},{"label":"Dez","value":297}];
const MX = 635;
