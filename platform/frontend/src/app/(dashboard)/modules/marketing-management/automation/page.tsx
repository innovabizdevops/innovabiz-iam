...
const PAGE = "Marketing Automation";
const KPIS = [{"l":"Projetos Melhoria","v":"4.013","t":"-3.2%","d":"down"},{"l":"Savings (€)","v":"€85105","t":"+8.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"71.9%","t":"+15.1%","d":"up"},{"l":"Ciclos PDCA","v":"4.307","t":"+1.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.236","€ 32856.68","4.986","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.438","€ 30535.85","6.999","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.296","€ 21211.19","7.189","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.206","€ 25362.93","7.510","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.385","€ 18444.08","8.429","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":406},{"label":"Fev","value":665},{"label":"Mar","value":714},{"label":"Abr","value":628},{"label":"Mai","value":584},{"label":"Jun","value":754},{"label":"Jul","value":484},{"label":"Ago","value":743},{"label":"Set","value":585},{"label":"Out","value":442},{"label":"Nov","value":613},{"label":"Dez","value":507}];
const MX = 754;
