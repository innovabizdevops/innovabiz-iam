...
const PAGE = "A/B Test Dashboard";
const KPIS = [{"l":"Projetos Melhoria","v":"3.931","t":"+6.9%","d":"up"},{"l":"Savings (€)","v":"€83723","t":"+7.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"71.9%","t":"+2.2%","d":"up"},{"l":"Ciclos PDCA","v":"8.311","t":"+14.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.227","€ 26908.19","967","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.785","€ 35584.01","2.789","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.329","€ 31500.24","5.390","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.773","€ 24003.68","8.904","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.664","€ 42065.21","7.714","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":339},{"label":"Mar","value":324},{"label":"Abr","value":625},{"label":"Mai","value":349},{"label":"Jun","value":490},{"label":"Jul","value":347},{"label":"Ago","value":548},{"label":"Set","value":581},{"label":"Out","value":527},{"label":"Nov","value":657},{"label":"Dez","value":548}];
const MX = 657;
