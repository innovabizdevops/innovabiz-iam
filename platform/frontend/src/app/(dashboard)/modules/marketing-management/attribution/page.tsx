...
const KPIS = [{"l":"Projetos Melhoria","v":"1.245","t":"+15.0%","d":"up"},{"l":"Savings (€)","v":"€51746","t":"+5.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"92.6%","t":"+11.6%","d":"up"},{"l":"Ciclos PDCA","v":"7.711","t":"-5.5%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.090","€ 43143.19","8.529","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.571","€ 49236.55","2.537","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.083","€ 33104.93","1.773","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.843","€ 9580.10","6.857","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.660","€ 7091.56","1.162","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":767},{"label":"Mar","value":828},{"label":"Abr","value":540},{"label":"Mai","value":517},{"label":"Jun","value":726},{"label":"Jul","value":553},{"label":"Ago","value":731},{"label":"Set","value":740},{"label":"Out","value":687},{"label":"Nov","value":842},{"label":"Dez","value":687}];
const MX = 842;
