...
const KPIS = [{"l":"Projetos Melhoria","v":"2.522","t":"+10.1%","d":"up"},{"l":"Savings (€)","v":"€98441","t":"+13.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"68.3%","t":"+2.4%","d":"up"},{"l":"Ciclos PDCA","v":"2.202","t":"+1.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.116","€ 8489.69","5.851","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.196","€ 5567.75","8.541","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.955","€ 10126.22","4.175","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.390","€ 25915.12","7.966","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.163","€ 20696.94","6.080","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":890},{"label":"Fev","value":675},{"label":"Mar","value":845},{"label":"Abr","value":606},{"label":"Mai","value":915},{"label":"Jun","value":579},{"label":"Jul","value":834},{"label":"Ago","value":792},{"label":"Set","value":749},{"label":"Out","value":929},{"label":"Nov","value":939},{"label":"Dez","value":878}];
const MX = 939;
