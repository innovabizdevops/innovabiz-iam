...
const PAGE = "Journey Builder";
const KPIS = [{"l":"Perfis Unificados","v":"7.015","t":"+4.0%","d":"up"},{"l":"Segmentos Ativos","v":"5.109","t":"+14.3%","d":"up"},{"l":"NPS Score","v":"83","t":"+5.4%","d":"up"},{"l":"Churn Previsto (%)","v":"94.0%","t":"+12.4%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","6.815","€ 47106.59","95.7%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","2.214","€ 32893.40","74.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","3.339","€ 22612.04","97.4%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","1.527","€ 29060.22","84.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","953","€ 14768.28","70.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":485},{"label":"Fev","value":464},{"label":"Mar","value":698},{"label":"Abr","value":452},{"label":"Mai","value":500},{"label":"Jun","value":551},{"label":"Jul","value":696},{"label":"Ago","value":734},{"label":"Set","value":574},{"label":"Out","value":501},{"label":"Nov","value":576},{"label":"Dez","value":717}];
const MX = 734;
