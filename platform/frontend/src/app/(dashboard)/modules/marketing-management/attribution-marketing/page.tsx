...
const ACCENT = "#6366f1";
const MODULE = "Marketing Management";
const PAGE = "Attribution AI";
const KPIS = [{"l":"Projetos Melhoria","v":"3.127","t":"+15.6%","d":"up"},{"l":"Savings (€)","v":"€82057","t":"+1.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"75.6%","t":"+17.6%","d":"up"},{"l":"Ciclos PDCA","v":"6.983","t":"+12.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.825","€ 1985.01","5.675","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.596","€ 27188.53","5.515","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.202","€ 34926.51","3.616","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.227","€ 34236.27","5.603","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.447","€ 37067.87","3.541","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":390},{"label":"Fev","value":467},{"label":"Mar","value":765},{"label":"Abr","value":598},{"label":"Mai","value":453},{"label":"Jun","value":500},{"label":"Jul","value":591},{"label":"Ago","value":442},{"label":"Set","value":411},{"label":"Out","value":384},{"label":"Nov","value":755},{"label":"Dez","value":475}];
const MX = 765;
...
export default function AttributionMarketingPage() {
    return (
