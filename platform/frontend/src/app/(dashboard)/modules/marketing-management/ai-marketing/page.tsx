...
const PAGE = "Marketing AI";
const KPIS = [{"l":"Projetos Melhoria","v":"7.307","t":"-0.1%","d":"down"},{"l":"Savings (€)","v":"€54248","t":"+4.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"85.7%","t":"+7.0%","d":"up"},{"l":"Ciclos PDCA","v":"7.376","t":"+11.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","104","€ 14208.72","7.323","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.770","€ 3751.38","7.257","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.959","€ 44074.83","3.791","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.118","€ 23729.77","3.074","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.866","€ 29856.96","2.967","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":786},{"label":"Fev","value":838},{"label":"Mar","value":684},{"label":"Abr","value":614},{"label":"Mai","value":803},{"label":"Jun","value":940},{"label":"Jul","value":589},{"label":"Ago","value":566},{"label":"Set","value":711},{"label":"Out","value":778},{"label":"Nov","value":944},{"label":"Dez","value":906}];
const MX = 944;
