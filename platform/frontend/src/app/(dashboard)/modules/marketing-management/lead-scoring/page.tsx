...
const PAGE = "Intelligence &amp; ABM";
const KPIS = [{"l":"Projetos Melhoria","v":"7.279","t":"+13.9%","d":"up"},{"l":"Savings (€)","v":"€44006","t":"+8.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"72.4%","t":"+10.1%","d":"up"},{"l":"Ciclos PDCA","v":"2.210","t":"+4.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","510","€ 39935.96","1.677","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.482","€ 49650.66","2.699","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.447","€ 4470.11","4.239","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.259","€ 26830.37","2.927","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.886","€ 36360.26","7.347","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":997},{"label":"Fev","value":993},{"label":"Mar","value":986},{"label":"Abr","value":713},{"label":"Mai","value":935},{"label":"Jun","value":885},{"label":"Jul","value":1043},{"label":"Ago","value":967},{"label":"Set","value":1040},{"label":"Out","value":744},{"label":"Nov","value":919},{"label":"Dez","value":1026}];
const MX = 1043;
