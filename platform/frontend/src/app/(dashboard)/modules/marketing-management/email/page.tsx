...
const PAGE = "Email Marketing";
const KPIS = [{"l":"Projetos Melhoria","v":"7.766","t":"+8.9%","d":"up"},{"l":"Savings (€)","v":"€69407","t":"+9.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"83.4%","t":"+5.7%","d":"up"},{"l":"Ciclos PDCA","v":"1.279","t":"+17.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.419","€ 49053.52","1.288","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.217","€ 35732.30","3.931","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.166","€ 3176.25","8.287","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.004","€ 13506.67","5.723","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.052","€ 343.63","4.781","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":664},{"label":"Mar","value":683},{"label":"Abr","value":586},{"label":"Mai","value":791},{"label":"Jun","value":833},{"label":"Jul","value":554},{"label":"Ago","value":538},{"label":"Set","value":796},{"label":"Out","value":607},{"label":"Nov","value":583},{"label":"Dez","value":491}];
const MX = 833;
