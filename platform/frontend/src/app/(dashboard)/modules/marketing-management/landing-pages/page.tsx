...
const PAGE = "Landing Page Builder";
const KPIS = [{"l":"Projetos Melhoria","v":"6.253","t":"+14.3%","d":"up"},{"l":"Savings (€)","v":"€35111","t":"+17.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"89.8%","t":"+11.8%","d":"up"},{"l":"Ciclos PDCA","v":"6.273","t":"-2.8%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.925","€ 5370.96","2.171","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.392","€ 43575.64","5.701","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.914","€ 6701.28","2.414","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.450","€ 17116.28","1.097","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.270","€ 13488.92","5.870","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":437},{"label":"Mar","value":478},{"label":"Abr","value":373},{"label":"Mai","value":453},{"label":"Jun","value":412},{"label":"Jul","value":233},{"label":"Ago","value":461},{"label":"Set","value":266},{"label":"Out","value":266},{"label":"Nov","value":443},{"label":"Dez","value":213}];
const MX = 593;
