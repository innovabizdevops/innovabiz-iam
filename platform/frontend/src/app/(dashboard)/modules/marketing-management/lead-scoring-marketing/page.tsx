...
const PAGE = "Lead Scoring";
const KPIS = [{"l":"Projetos Melhoria","v":"2.458","t":"+10.5%","d":"up"},{"l":"Savings (€)","v":"€93680","t":"+14.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"76.3%","t":"+5.5%","d":"up"},{"l":"Ciclos PDCA","v":"1.417","t":"+17.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.091","€ 36528.53","3.331","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.041","€ 41115.88","666","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.839","€ 14227.13","5.558","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.769","€ 6001.37","8.579","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.417","€ 10304.97","4.278","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":533},{"label":"Mar","value":525},{"label":"Abr","value":817},{"label":"Mai","value":719},{"label":"Jun","value":475},{"label":"Jul","value":622},{"label":"Ago","value":578},{"label":"Set","value":626},{"label":"Out","value":670},{"label":"Nov","value":819},{"label":"Dez","value":493}];
const MX = 819;
...
export default function LeadScoringMarketingPage() {
    return (
