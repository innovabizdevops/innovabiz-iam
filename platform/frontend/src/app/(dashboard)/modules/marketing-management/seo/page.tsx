...
const PAGE = "SEO &amp; Content";
const KPIS = [{"l":"Projetos Melhoria","v":"7.582","t":"+6.8%","d":"up"},{"l":"Savings (€)","v":"€31451","t":"+12.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"78.8%","t":"+14.0%","d":"up"},{"l":"Ciclos PDCA","v":"188","t":"+5.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.832","€ 18088.37","3.908","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.232","€ 37641.64","1.004","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.617","€ 14407.46","2.998","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.579","€ 45796.11","8.334","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.584","€ 11567.68","263","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":738},{"label":"Mar","value":666},{"label":"Abr","value":693},{"label":"Mai","value":861},{"label":"Jun","value":713},{"label":"Jul","value":687},{"label":"Ago","value":689},{"label":"Set","value":865},{"label":"Out","value":918},{"label":"Nov","value":889},{"label":"Dez","value":869}];
const MX = 918;
