...
const PAGE = "Campaign Flow Builder";
const KPIS = [{"l":"Projetos Melhoria","v":"7.435","t":"-2.1%","d":"down"},{"l":"Savings (€)","v":"€86589","t":"+1.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"92.8%","t":"-0.3%","d":"down"},{"l":"Ciclos PDCA","v":"2.195","t":"+12.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.177","€ 6928.66","4.142","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.957","€ 20285.12","5.673","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.427","€ 11080.80","4.020","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.852","€ 34579.39","2.888","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.092","€ 38896.03","900","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":323},{"label":"Mar","value":501},{"label":"Abr","value":284},{"label":"Mai","value":549},{"label":"Jun","value":307},{"label":"Jul","value":263},{"label":"Ago","value":598},{"label":"Set","value":288},{"label":"Out","value":313},{"label":"Nov","value":313},{"label":"Dez","value":591}];
const MX = 598;
