...
export default function RailOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Rail Ops</h1><p className="text-sm text-muted-foreground">Rail Ops • iBOS Enterprise</p></div>
