...
const PAGE = "Intermodal";
const KPIS = [{"l":"Riscos Identificados","v":"570","t":"-3.0%","d":"down"},{"l":"Mitigações Ativas","v":"4.670","t":"+15.5%","d":"up"},{"l":"Score Risco Geral","v":"76","t":"-3.9%","d":"down"},{"l":"Incidentes YTD","v":"3.916","t":"+14.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.073","6.728","3.341","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.725","8.853","6.355","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.022","274","8.546","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.966","4.776","6.561","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.092","8.486","272","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":812},{"label":"Mar","value":480},{"label":"Abr","value":429},{"label":"Mai","value":576},{"label":"Jun","value":565},{"label":"Jul","value":540},{"label":"Ago","value":467},{"label":"Set","value":591},{"label":"Out","value":660},{"label":"Nov","value":467},{"label":"Dez","value":638}];
const MX = 812;
