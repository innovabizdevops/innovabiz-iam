...
const ACCENT = "#4338ca";
const MODULE = "Rail Operations";
const PAGE = "ETD/ETA";
const KPIS = [{"l":"Veículos Operação","v":"7.265","t":"-4.1%","d":"down"},{"l":"Viagens/Dia","v":"2468","t":"+11.4%","d":"up"},{"l":"Pontualidade (%)","v":"70.0%","t":"-1.4%","d":"down"},{"l":"Passageiros/Dia","v":"2618","t":"+11.5%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-09","2026-01-24","3.921","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-03","2026-02-12","7.515","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-08","2026-03-02","5.089","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-26","2026-03-25","8.444","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-12","2026-01-16","5.297","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":605},{"label":"Mar","value":781},{"label":"Abr","value":641},{"label":"Mai","value":522},{"label":"Jun","value":788},{"label":"Jul","value":583},{"label":"Ago","value":457},{"label":"Set","value":677},{"label":"Out","value":613},{"label":"Nov","value":707},{"label":"Dez","value":798}];
const MX = 798;
