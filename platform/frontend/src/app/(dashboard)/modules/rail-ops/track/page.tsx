...
const PAGE = "Track Alloc";
const KPIS = [{"l":"Veículos Operação","v":"894","t":"-3.9%","d":"down"},{"l":"Viagens/Dia","v":"4660","t":"+0.0%","d":"up"},{"l":"Pontualidade (%)","v":"81.3%","t":"+4.2%","d":"up"},{"l":"Passageiros/Dia","v":"265","t":"+10.8%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-04","2026-03-02","3.443","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-27","2026-02-19","375","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-15","2026-02-16","2.338","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-09","2026-03-19","4.849","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-10","2026-03-18","2.266","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":358},{"label":"Fev","value":644},{"label":"Mar","value":486},{"label":"Abr","value":523},{"label":"Mai","value":533},{"label":"Jun","value":518},{"label":"Jul","value":432},{"label":"Ago","value":579},{"label":"Set","value":575},{"label":"Out","value":542},{"label":"Nov","value":574},{"label":"Dez","value":280}];
const MX = 644;
