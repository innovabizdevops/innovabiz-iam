...
const PAGE = "Consist Mgmt";
const KPIS = [{"l":"Veículos Operação","v":"1.465","t":"-0.5%","d":"down"},{"l":"Viagens/Dia","v":"4786","t":"+7.1%","d":"up"},{"l":"Pontualidade (%)","v":"69.1%","t":"+17.5%","d":"up"},{"l":"Passageiros/Dia","v":"4788","t":"-1.8%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-16","2026-02-01","697","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-07","2026-03-03","7.251","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-25","2026-03-15","780","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-21","2026-03-27","7.881","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-25","2026-02-13","6.217","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":818},{"label":"Mar","value":682},{"label":"Abr","value":785},{"label":"Mai","value":895},{"label":"Jun","value":986},{"label":"Jul","value":921},{"label":"Ago","value":987},{"label":"Set","value":977},{"label":"Out","value":716},{"label":"Nov","value":863},{"label":"Dez","value":646}];
const MX = 987;
