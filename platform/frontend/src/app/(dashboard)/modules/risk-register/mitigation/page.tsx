...
const PAGE = "Mitigation Plans";
const KPIS = [{"l":"Riscos Identificados","v":"3.725","t":"+2.1%","d":"up"},{"l":"Mitigações Ativas","v":"825","t":"+1.0%","d":"up"},{"l":"Score Risco Geral","v":"72","t":"+11.8%","d":"up"},{"l":"Incidentes YTD","v":"3.954","t":"-1.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.103","5.866","153","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","647","134","4.488","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.877","3.989","6.396","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.171","790","4.426","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.393","3.510","8.416","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":492},{"label":"Mar","value":713},{"label":"Abr","value":710},{"label":"Mai","value":669},{"label":"Jun","value":647},{"label":"Jul","value":760},{"label":"Ago","value":397},{"label":"Set","value":735},{"label":"Out","value":713},{"label":"Nov","value":461},{"label":"Dez","value":747}];
const MX = 760;
