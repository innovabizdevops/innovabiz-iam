...
const PAGE = "Risk Catalog";
const KPIS = [{"l":"Riscos Identificados","v":"7.485","t":"+11.0%","d":"up"},{"l":"Mitigações Ativas","v":"2.302","t":"+17.5%","d":"up"},{"l":"Score Risco Geral","v":"63","t":"+1.1%","d":"up"},{"l":"Incidentes YTD","v":"536","t":"+10.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.025","4.219","2.849","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.445","159","7.813","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.503","537","1.758","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.984","1.708","4.161","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.320","127","1.005","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":902},{"label":"Mar","value":791},{"label":"Abr","value":877},{"label":"Mai","value":766},{"label":"Jun","value":730},{"label":"Jul","value":734},{"label":"Ago","value":597},{"label":"Set","value":622},{"label":"Out","value":573},{"label":"Nov","value":558},{"label":"Dez","value":849}];
const MX = 902;
