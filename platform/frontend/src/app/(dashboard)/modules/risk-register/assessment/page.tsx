...
const KPIS = [{"l":"Riscos Identificados","v":"2.681","t":"+7.9%","d":"up"},{"l":"Mitigações Ativas","v":"4.619","t":"+17.1%","d":"up"},{"l":"Score Risco Geral","v":"64","t":"+16.2%","d":"up"},{"l":"Incidentes YTD","v":"8.987","t":"-3.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.025","4.759","4.675","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","116","5.033","7.028","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.817","162","1.201","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.575","4.868","2.264","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.509","7.382","4.766","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":408},{"label":"Fev","value":489},{"label":"Mar","value":404},{"label":"Abr","value":712},{"label":"Mai","value":505},{"label":"Jun","value":705},{"label":"Jul","value":718},{"label":"Ago","value":504},{"label":"Set","value":704},{"label":"Out","value":610},{"label":"Nov","value":648},{"label":"Dez","value":723}];
const MX = 723;
