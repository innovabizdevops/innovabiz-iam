...
const PAGE = "Heat Map";
const KPIS = [{"l":"Riscos Identificados","v":"3.190","t":"+2.5%","d":"up"},{"l":"Mitigações Ativas","v":"2.583","t":"-3.0%","d":"down"},{"l":"Score Risco Geral","v":"85","t":"+12.5%","d":"up"},{"l":"Incidentes YTD","v":"5.491","t":"+11.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","737","6.254","4.280","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.102","4.440","713","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.820","6.162","3.848","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.348","8.103","105","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.629","7.134","7.961","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":606},{"label":"Mar","value":634},{"label":"Abr","value":670},{"label":"Mai","value":784},{"label":"Jun","value":668},{"label":"Jul","value":709},{"label":"Ago","value":826},{"label":"Set","value":786},{"label":"Out","value":764},{"label":"Nov","value":831},{"label":"Dez","value":763}];
const MX = 831;
