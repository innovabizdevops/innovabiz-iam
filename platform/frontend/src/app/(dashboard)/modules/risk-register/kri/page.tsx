...
const PAGE = "KRI Monitor";
const KPIS = [{"l":"Riscos Identificados","v":"4.547","t":"+2.3%","d":"up"},{"l":"Mitigações Ativas","v":"8.761","t":"+1.1%","d":"up"},{"l":"Score Risco Geral","v":"91","t":"+9.3%","d":"up"},{"l":"Incidentes YTD","v":"245","t":"-2.4%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","360","3.936","4.389","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.261","5.285","418","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.491","2.449","2.086","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.569","143","7.418","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","859","7.242","857","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":372},{"label":"Mar","value":645},{"label":"Abr","value":553},{"label":"Mai","value":305},{"label":"Jun","value":308},{"label":"Jul","value":482},{"label":"Ago","value":580},{"label":"Set","value":285},{"label":"Out","value":662},{"label":"Nov","value":534},{"label":"Dez","value":658}];
const MX = 662;
