...
const ACCENT = "#dc2626";
const MODULE = "Risk Register";
const PAGE = "Bow-Tie Analysis";
const KPIS = [{"l":"Riscos Identificados","v":"5.656","t":"+7.9%","d":"up"},{"l":"Mitigações Ativas","v":"7.222","t":"-1.2%","d":"down"},{"l":"Score Risco Geral","v":"73","t":"+11.9%","d":"up"},{"l":"Incidentes YTD","v":"671","t":"-5.5%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.604","8.191","8.437","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.706","9.074","9.050","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","478","3.402","5.374","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","283","2.810","1.489","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.567","410","1.293","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":543},{"label":"Mar","value":514},{"label":"Abr","value":635},{"label":"Mai","value":689},{"label":"Jun","value":463},{"label":"Jul","value":618},{"label":"Ago","value":515},{"label":"Set","value":337},{"label":"Out","value":656},{"label":"Nov","value":508},{"label":"Dez","value":476}];
const MX = 689;
