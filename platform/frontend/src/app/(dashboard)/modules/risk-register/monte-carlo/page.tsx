...
const PAGE = "Monte Carlo";
const KPIS = [{"l":"Riscos Identificados","v":"8.183","t":"+8.7%","d":"up"},{"l":"Mitigações Ativas","v":"4.198","t":"-4.1%","d":"down"},{"l":"Score Risco Geral","v":"90","t":"+16.4%","d":"up"},{"l":"Incidentes YTD","v":"8.595","t":"+5.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.580","4.150","2.975","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.820","6.209","6.599","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.473","7.183","1.734","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.736","5.605","3.334","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.918","4.572","5.493","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":757},{"label":"Mar","value":725},{"label":"Abr","value":765},{"label":"Mai","value":702},{"label":"Jun","value":802},{"label":"Jul","value":514},{"label":"Ago","value":757},{"label":"Set","value":639},{"label":"Out","value":571},{"label":"Nov","value":611},{"label":"Dez","value":856}];
const MX = 856;
