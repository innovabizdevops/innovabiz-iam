...
const PAGE = "Yield Track";
const KPIS = [{"l":"Total Fiber Recycl","v":"3.461","t":"+6.0%","d":"up"},{"l":"Yield Track Ativos","v":"1.206","t":"+14.4%","d":"up"},{"l":"Eficiência (%)","v":"82.0%","t":"+5.6%","d":"up"},{"l":"Score Performance","v":"86","t":"-4.7%","d":"down"}];
const COLS = ["ID","Yield Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fiber Recycl #001","Fiber Recycl #002","2.922","1.791","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Fiber Recycl #002","Fiber Recycl #003","2.345","2.125","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Fiber Recycl #003","Fiber Recycl #004","1.509","458","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Fiber Recycl #004","Fiber Recycl #005","7.420","7.765","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fiber Recycl #005","Fiber Recycl #001","9.035","973","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":843},{"label":"Fev","value":791},{"label":"Mar","value":959},{"label":"Abr","value":766},{"label":"Mai","value":1019},{"label":"Jun","value":749},{"label":"Jul","value":1001},{"label":"Ago","value":951},{"label":"Set","value":872},{"label":"Out","value":816},{"label":"Nov","value":1059},{"label":"Dez","value":965}];
const MX = 1059;
