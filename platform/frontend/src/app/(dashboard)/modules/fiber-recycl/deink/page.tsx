...
const ACCENT = "#4338ca";
const MODULE = "Fiber Recycling";
const PAGE = "Deink Line";
const KPIS = [{"l":"Projetos Sociais","v":"5.770","t":"+13.3%","d":"up"},{"l":"Beneficiários","v":"3.193","t":"-0.8%","d":"down"},{"l":"Investimento CSR (€)","v":"€21499","t":"-2.5%","d":"down"},{"l":"Score Impacto","v":"83","t":"+11.1%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","7.950","€ 22028.62","1.037","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","194","€ 43819.12","8.617","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","8.115","€ 43792.88","3.290","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","2.372","€ 38329.20","3.424","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","181","€ 26674.75","6.571","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":754},{"label":"Fev","value":601},{"label":"Mar","value":664},{"label":"Abr","value":723},{"label":"Mai","value":834},{"label":"Jun","value":843},{"label":"Jul","value":986},{"label":"Ago","value":937},{"label":"Set","value":875},{"label":"Out","value":980},{"label":"Nov","value":717},{"label":"Dez","value":835}];
const MX = 986;
...
export default function DeinkPage() {
    return (
