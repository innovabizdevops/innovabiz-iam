...
export default function FiberRecyclPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Fiber Recycl</h1><p className="text-sm text-muted-foreground">Fiber Recycl • iBOS Enterprise</p></div>
