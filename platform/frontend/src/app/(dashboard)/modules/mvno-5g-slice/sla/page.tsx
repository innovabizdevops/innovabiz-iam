...
const PAGE = "SLA";
const KPIS = [{"l":"Tickets Abertos","v":"6.415","t":"+2.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"87.5%","t":"+3.4%","d":"up"},{"l":"MTTR (h)","v":"124h","t":"+5.0%","d":"up"},{"l":"Satisfação (%)","v":"65.5%","t":"-4.6%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.459","301","7.210","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.922","2.397","5.508","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.188","7.194","5.444","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.023","3.841","1.244","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.530","6.077","7.212","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":852},{"label":"Mar","value":787},{"label":"Abr","value":872},{"label":"Mai","value":878},{"label":"Jun","value":933},{"label":"Jul","value":1035},{"label":"Ago","value":844},{"label":"Set","value":865},{"label":"Out","value":923},{"label":"Nov","value":1031},{"label":"Dez","value":1031}];
const MX = 1035;
