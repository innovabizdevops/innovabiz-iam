...
export default function Mvno5gSlicePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Mvno 5g Slice</h1><p className="text-sm text-muted-foreground">Mvno 5g Slice • iBOS Enterprise</p></div>
