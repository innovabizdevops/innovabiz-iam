...
const PAGE = "Slice Design";
const KPIS = [{"l":"Formulários Ativos","v":"2.017","t":"+16.4%","d":"up"},{"l":"Submissões/Dia","v":"2659","t":"+6.0%","d":"up"},{"l":"Documentos Gerados","v":"8.243","t":"+12.3%","d":"up"},{"l":"Templates","v":"5.653","t":"+8.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.679","2026-03-24","989","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.003","2026-02-24","6.843","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.534","2026-01-24","230","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.751","2026-03-22","4.418","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.398","2026-02-16","8.777","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":597},{"label":"Mar","value":580},{"label":"Abr","value":455},{"label":"Mai","value":532},{"label":"Jun","value":790},{"label":"Jul","value":791},{"label":"Ago","value":582},{"label":"Set","value":623},{"label":"Out","value":446},{"label":"Nov","value":727},{"label":"Dez","value":463}];
const MX = 791;
