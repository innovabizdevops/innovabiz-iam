...
const ACCENT = "#6366f1";
const MODULE = "MVNO 5G Slicing";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Mvno 5g Slice","v":"3.917","t":"+8.6%","d":"up"},{"l":"Monitor Ativos","v":"8.655","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"69.0%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"77","t":"+13.7%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mvno 5g Slice #001","Mvno 5g Slice #002","1.863","3.318","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Mvno 5g Slice #002","Mvno 5g Slice #003","6.910","6.419","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Mvno 5g Slice #003","Mvno 5g Slice #004","2.627","8.023","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Mvno 5g Slice #004","Mvno 5g Slice #005","2.481","2.502","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mvno 5g Slice #005","Mvno 5g Slice #001","3.926","1.944","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":423},{"label":"Mar","value":427},{"label":"Abr","value":401},{"label":"Mai","value":603},{"label":"Jun","value":405},{"label":"Jul","value":380},{"label":"Ago","value":373},{"label":"Set","value":393},{"label":"Out","value":441},{"label":"Nov","value":589},{"label":"Dez","value":385}];
const MX = 603;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>RTM</span></h1>
                </div>
