...
const ACCENT = "#1e40af";
const MODULE = "Paper Machine";
const PAGE = "Dryer Section";
const KPIS = [{"l":"Total Paper Machine","v":"8.584","t":"+13.8%","d":"up"},{"l":"Dryer Section Ativos","v":"1.137","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"64","t":"+15.6%","d":"up"}];
const COLS = ["ID","Dryer Section","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Paper Machine #001","Paper Machine #002","3.662","1.450","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Paper Machine #002","Paper Machine #003","8.087","2.913","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Paper Machine #003","Paper Machine #004","4.183","1.884","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Paper Machine #004","Paper Machine #005","2.917","2.221","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Paper Machine #005","Paper Machine #001","159","3.100","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":574},{"label":"Mar","value":804},{"label":"Abr","value":708},{"label":"Mai","value":859},{"label":"Jun","value":565},{"label":"Jul","value":729},{"label":"Ago","value":656},{"label":"Set","value":725},{"label":"Out","value":607},{"label":"Nov","value":745},{"label":"Dez","value":816}];
const MX = 859;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e40af'}}>IoT</span></h1>
                </div>
