...
const PAGE = "Press Section";
const KPIS = [{"l":"Total Paper Machine","v":"6.618","t":"+8.3%","d":"up"},{"l":"Press Section Ativos","v":"2.905","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"80.7%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"64","t":"+16.4%","d":"up"}];
const COLS = ["ID","Press Section","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Paper Machine #001","Paper Machine #002","1.538","8.443","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Paper Machine #002","Paper Machine #003","5.050","1.934","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Paper Machine #003","Paper Machine #004","5.757","5.886","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Paper Machine #004","Paper Machine #005","3.191","5.695","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Paper Machine #005","Paper Machine #001","712","2.452","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":468},{"label":"Mar","value":337},{"label":"Abr","value":398},{"label":"Mai","value":665},{"label":"Jun","value":364},{"label":"Jul","value":554},{"label":"Ago","value":465},{"label":"Set","value":651},{"label":"Out","value":569},{"label":"Nov","value":653},{"label":"Dez","value":505}];
const MX = 665;
