...
const PAGE = "Headbox";
const KPIS = [{"l":"Total Paper Machine","v":"7.864","t":"+2.5%","d":"up"},{"l":"Headbox Ativos","v":"8.917","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"70.3%","t":"+9.9%","d":"up"},{"l":"Score Performance","v":"68","t":"+5.6%","d":"up"}];
const COLS = ["ID","Headbox","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Paper Machine #001","Paper Machine #002","8.726","5.505","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Paper Machine #002","Paper Machine #003","7.472","6.268","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Paper Machine #003","Paper Machine #004","2.362","629","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Paper Machine #004","Paper Machine #005","2.229","4.416","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Paper Machine #005","Paper Machine #001","1.181","6.966","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":377},{"label":"Mar","value":577},{"label":"Abr","value":572},{"label":"Mai","value":373},{"label":"Jun","value":548},{"label":"Jul","value":543},{"label":"Ago","value":315},{"label":"Set","value":402},{"label":"Out","value":383},{"label":"Nov","value":545},{"label":"Dez","value":409}];
const MX = 660;
...
export default function HeadboxPage() {
    return (
