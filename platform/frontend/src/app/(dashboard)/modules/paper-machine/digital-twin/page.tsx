...
const PAGE = "Digital Twin Paper";
const KPIS = [{"l":"Twins Ativos","v":"8.814","t":"+8.3%","d":"up"},{"l":"Simulações/Dia","v":"2327","t":"+17.6%","d":"up"},{"l":"Precisão Modelo (%)","v":"66.8%","t":"+5.4%","d":"up"},{"l":"Latência Sync (ms)","v":"182ms","t":"+0.2%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","94.9%","2026-03-19","7.042","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","81.7%","2026-02-02","8.622","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","83.1%","2026-03-18","1.724","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","92.6%","2026-02-16","5.296","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","88.8%","2026-03-04","1.626","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":656},{"label":"Mar","value":450},{"label":"Abr","value":486},{"label":"Mai","value":354},{"label":"Jun","value":562},{"label":"Jul","value":674},{"label":"Ago","value":338},{"label":"Set","value":559},{"label":"Out","value":707},{"label":"Nov","value":436},{"label":"Dez","value":554}];
const MX = 707;
