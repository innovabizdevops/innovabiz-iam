...
const PAGE = "AI Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.073","t":"-2.3%","d":"down"},{"l":"NC Abertas","v":"2.514","t":"-4.6%","d":"down"},{"l":"Conformidade (%)","v":"90.2%","t":"-4.2%","d":"down"},{"l":"CAPAs Pendentes","v":"7.677","t":"+14.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.686","80.7%","8.262","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.592","90.7%","5.280","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.525","76.2%","3.503","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.868","93.8%","1.110","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.968","84.2%","4.391","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":333},{"label":"Fev","value":674},{"label":"Mar","value":561},{"label":"Abr","value":588},{"label":"Mai","value":500},{"label":"Jun","value":670},{"label":"Jul","value":641},{"label":"Ago","value":635},{"label":"Set","value":726},{"label":"Out","value":664},{"label":"Nov","value":585},{"label":"Dez","value":482}];
const MX = 726;
