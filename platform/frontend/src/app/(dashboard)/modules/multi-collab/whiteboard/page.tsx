...
const KPIS = [{"l":"Teams Ativos","v":"8.762","t":"+14.5%","d":"up"},{"l":"Reuniões/Semana","v":"1487","t":"+15.6%","d":"up"},{"l":"Mensagens/Dia","v":"4788","t":"-2.3%","d":"down"},{"l":"Ficheiros Partilhados","v":"6.396","t":"+11.6%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.607","219","945","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","5.477","4772","8.233","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","4.775","1753","4.296","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.080","809","2.626","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","3.139","2233","5.472","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":458},{"label":"Mar","value":636},{"label":"Abr","value":690},{"label":"Mai","value":737},{"label":"Jun","value":604},{"label":"Jul","value":662},{"label":"Ago","value":722},{"label":"Set","value":604},{"label":"Out","value":612},{"label":"Nov","value":469},{"label":"Dez","value":574}];
const MX = 737;
