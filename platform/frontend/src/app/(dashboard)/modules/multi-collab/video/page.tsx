...
const ACCENT = "#0ea5e9";
const MODULE = "Multi-Collaboration Hub";
const PAGE = "Video";
const KPIS = [{"l":"Total Multi Collab","v":"6.850","t":"+4.6%","d":"up"},{"l":"Video Ativos","v":"6.682","t":"+6.2%","d":"up"},{"l":"Eficiência (%)","v":"89.0%","t":"+16.7%","d":"up"},{"l":"Score Performance","v":"88","t":"+1.3%","d":"up"}];
const COLS = ["ID","Video","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Multi Collab #001","Multi Collab #002","4.373","3.071","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Multi Collab #002","Multi Collab #003","7.166","3.279","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Multi Collab #003","Multi Collab #004","1.764","4.644","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Multi Collab #004","Multi Collab #005","3.313","5.292","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Multi Collab #005","Multi Collab #001","3.433","1.496","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":836},{"label":"Mar","value":938},{"label":"Abr","value":884},{"label":"Mai","value":843},{"label":"Jun","value":893},{"label":"Jul","value":993},{"label":"Ago","value":883},{"label":"Set","value":1032},{"label":"Out","value":851},{"label":"Nov","value":996},{"label":"Dez","value":1060}];
const MX = 1060;
