...
const PAGE = "Chat";
const KPIS = [{"l":"Teams Ativos","v":"7.893","t":"+7.1%","d":"up"},{"l":"Reuniões/Semana","v":"3655","t":"+1.9%","d":"up"},{"l":"Mensagens/Dia","v":"2584","t":"+8.7%","d":"up"},{"l":"Ficheiros Partilhados","v":"8.754","t":"-3.4%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","6.102","533","4.892","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.947","1783","2.072","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","5.070","429","8.207","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","9.003","2192","6.384","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","6.042","1020","5.620","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":816},{"label":"Mar","value":806},{"label":"Abr","value":904},{"label":"Mai","value":936},{"label":"Jun","value":752},{"label":"Jul","value":733},{"label":"Ago","value":639},{"label":"Set","value":750},{"label":"Out","value":810},{"label":"Nov","value":709},{"label":"Dez","value":945}];
const MX = 945;
