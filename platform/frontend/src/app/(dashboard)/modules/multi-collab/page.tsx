...
/* ═══ Multi-Collaboration Hub — Dashboard ═══ */

const ACCENT = "#0ea5e9";

const KPIS = [
    { label: "Total Registos", value: "3468", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "561", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€474K", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "299181368", cells: ["MUL-4368", "Multi-Collaboration Hub Item 1", "25/9/2026", "€31 468"], status: "active" as const },
    { id: "299184939", cells: ["MUL-7939", "Multi-Collaboration Hub Item 2", "12/4/2026", "€35 039"], status: "pending" as const },
    { id: "299188510", cells: ["MUL-2510", "Multi-Collaboration Hub Item 3", "27/11/2026", "€38 610"], status: "completed" as const },
    { id: "299192081", cells: ["MUL-6081", "Multi-Collaboration Hub Item 4", "14/6/2026", "€42 181"], status: "warning" as const },
    { id: "299195652", cells: ["MUL-9652", "Multi-Collaboration Hub Item 5", "1/1/2026", "€45 752"], status: "active" as const },
];
...
export default function MulticollaborationHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Multi-Collaboration Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Multi-Collaboration Hub</p>
                    </div>
                </div>
