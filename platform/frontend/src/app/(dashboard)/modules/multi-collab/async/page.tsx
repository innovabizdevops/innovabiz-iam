...
const PAGE = "Async";
const KPIS = [{"l":"Integrações Ativas","v":"4.216","t":"+9.5%","d":"up"},{"l":"Chamadas/Hora","v":"2268","t":"+16.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"89.9%","t":"-2.6%","d":"down"},{"l":"Latência Média (ms)","v":"33ms","t":"+17.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.481","6.168","88.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.269","6.973","88.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.463","4.293","91.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.660","1.990","97.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.705","7.310","85.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":268},{"label":"Fev","value":431},{"label":"Mar","value":621},{"label":"Abr","value":451},{"label":"Mai","value":265},{"label":"Jun","value":328},{"label":"Jul","value":577},{"label":"Ago","value":308},{"label":"Set","value":413},{"label":"Out","value":474},{"label":"Nov","value":333},{"label":"Dez","value":280}];
const MX = 621;
