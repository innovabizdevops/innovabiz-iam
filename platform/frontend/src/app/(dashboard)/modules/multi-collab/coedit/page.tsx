...
const PAGE = "Co-Edit";
const KPIS = [{"l":"Integrações Ativas","v":"1.300","t":"+6.9%","d":"up"},{"l":"Chamadas/Hora","v":"2418","t":"+16.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.7%","t":"-4.1%","d":"down"},{"l":"Latência Média (ms)","v":"16ms","t":"-2.5%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","106","7.778","79.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.201","7.296","92.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.791","8.963","81.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.956","2.346","89.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.673","5.190","97.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":964},{"label":"Fev","value":816},{"label":"Mar","value":722},{"label":"Abr","value":732},{"label":"Mai","value":644},{"label":"Jun","value":944},{"label":"Jul","value":816},{"label":"Ago","value":1033},{"label":"Set","value":907},{"label":"Out","value":893},{"label":"Nov","value":1035},{"label":"Dez","value":741}];
const MX = 1035;
