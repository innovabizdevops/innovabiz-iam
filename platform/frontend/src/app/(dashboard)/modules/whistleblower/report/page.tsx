...
const PAGE = "Secure Report";
const KPIS = [{"l":"Total Whistleblower","v":"2.389","t":"+1.9%","d":"up"},{"l":"Secure Report Ativos","v":"4.914","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"87.1%","t":"+11.9%","d":"up"},{"l":"Score Performance","v":"90","t":"+6.2%","d":"up"}];
const COLS = ["ID","Secure Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Whistleblower #001","Whistleblower #002","6.099","5.350","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Whistleblower #002","Whistleblower #003","7.912","8.567","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Whistleblower #003","Whistleblower #004","4.619","7.673","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Whistleblower #004","Whistleblower #005","4.718","5.736","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Whistleblower #005","Whistleblower #001","1.139","1.310","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":566},{"label":"Mar","value":704},{"label":"Abr","value":649},{"label":"Mai","value":567},{"label":"Jun","value":649},{"label":"Jul","value":775},{"label":"Ago","value":603},{"label":"Set","value":597},{"label":"Out","value":749},{"label":"Nov","value":707},{"label":"Dez","value":611}];
const MX = 805;
