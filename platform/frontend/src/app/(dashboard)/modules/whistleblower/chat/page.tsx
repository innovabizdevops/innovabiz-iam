...
const PAGE = "Anonymous Chat";
const KPIS = [{"l":"Teams Ativos","v":"4.167","t":"-2.2%","d":"down"},{"l":"Reuniões/Semana","v":"451","t":"+16.5%","d":"up"},{"l":"Mensagens/Dia","v":"452","t":"+16.2%","d":"up"},{"l":"Ficheiros Partilhados","v":"5.825","t":"+16.3%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.167","1257","4.612","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","7.732","2708","7.502","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","993","2176","6.828","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.701","4661","7.657","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","7.029","364","2.458","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":779},{"label":"Mar","value":829},{"label":"Abr","value":562},{"label":"Mai","value":883},{"label":"Jun","value":602},{"label":"Jul","value":835},{"label":"Ago","value":564},{"label":"Set","value":768},{"label":"Out","value":630},{"label":"Nov","value":616},{"label":"Dez","value":556}];
const MX = 883;
