...
const ACCENT = "#7c3aed";
const MODULE = "Whistleblower Portal";
const PAGE = "EU Directive";
const KPIS = [{"l":"Total Whistleblower","v":"7.491","t":"+4.4%","d":"up"},{"l":"EU Directive Ativos","v":"2.912","t":"+11.7%","d":"up"},{"l":"Eficiência (%)","v":"84.5%","t":"+14.1%","d":"up"},{"l":"Score Performance","v":"69","t":"-3.9%","d":"down"}];
const COLS = ["ID","EU Directive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Whistleblower #001","Whistleblower #002","6.081","5.904","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Whistleblower #002","Whistleblower #003","4.711","1.978","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Whistleblower #003","Whistleblower #004","1.174","2.606","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Whistleblower #004","Whistleblower #005","5.400","3.708","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Whistleblower #005","Whistleblower #001","4.379","6.613","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":986},{"label":"Fev","value":728},{"label":"Mar","value":990},{"label":"Abr","value":790},{"label":"Mai","value":1023},{"label":"Jun","value":1086},{"label":"Jul","value":966},{"label":"Ago","value":960},{"label":"Set","value":905},{"label":"Out","value":776},{"label":"Nov","value":845},{"label":"Dez","value":718}];
const MX = 1086;
...
export default function EuDirectivePage() {
    return (
