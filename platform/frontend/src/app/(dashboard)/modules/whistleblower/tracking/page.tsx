...
const PAGE = "Case Tracking";
const KPIS = [{"l":"Total Whistleblower","v":"3.633","t":"-2.3%","d":"down"},{"l":"Case Tracking Ativos","v":"8.508","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"93.4%","t":"+8.4%","d":"up"},{"l":"Score Performance","v":"74","t":"-1.2%","d":"down"}];
const COLS = ["ID","Case Tracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Whistleblower #001","Whistleblower #002","3.261","3.991","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Whistleblower #002","Whistleblower #003","3.182","1.306","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Whistleblower #003","Whistleblower #004","667","4.698","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Whistleblower #004","Whistleblower #005","2.991","376","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Whistleblower #005","Whistleblower #001","5.689","9.085","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":909},{"label":"Fev","value":856},{"label":"Mar","value":942},{"label":"Abr","value":909},{"label":"Mai","value":707},{"label":"Jun","value":863},{"label":"Jul","value":703},{"label":"Ago","value":743},{"label":"Set","value":988},{"label":"Out","value":744},{"label":"Nov","value":852},{"label":"Dez","value":865}];
const MX = 988;
