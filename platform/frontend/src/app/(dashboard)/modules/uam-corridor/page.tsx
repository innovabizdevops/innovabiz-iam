...
export default function UamCorridorPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Uam Corridor</h1><p className="text-sm text-muted-foreground">Uam Corridor • iBOS Enterprise</p></div>
