...
const KPIS = [{"l":"Projetos Sociais","v":"4.719","t":"+2.5%","d":"up"},{"l":"Beneficiários","v":"6.963","t":"-2.2%","d":"down"},{"l":"Investimento CSR (€)","v":"€17755","t":"+8.4%","d":"up"},{"l":"Score Impacto","v":"80","t":"+8.7%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","6.120","€ 15625.95","5.644","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","2.671","€ 7259.97","5.602","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","4.861","€ 10995.87","4.192","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","2.347","€ 48415.73","7.385","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","5.079","€ 40619.29","4.028","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":759},{"label":"Mar","value":607},{"label":"Abr","value":574},{"label":"Mai","value":708},{"label":"Jun","value":776},{"label":"Jul","value":919},{"label":"Ago","value":901},{"label":"Set","value":712},{"label":"Out","value":766},{"label":"Nov","value":558},{"label":"Dez","value":753}];
const MX = 919;
