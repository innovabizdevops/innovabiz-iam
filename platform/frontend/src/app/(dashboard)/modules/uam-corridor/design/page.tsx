...
const ACCENT = "#059669";
const MODULE = "UAM Corridor";
const PAGE = "Corridor Design";
const KPIS = [{"l":"Formulários Ativos","v":"4.150","t":"-5.4%","d":"down"},{"l":"Submissões/Dia","v":"481","t":"+0.5%","d":"up"},{"l":"Documentos Gerados","v":"8.285","t":"+1.9%","d":"up"},{"l":"Templates","v":"9.095","t":"+0.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.726","2026-03-15","1.123","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.072","2026-03-09","7.117","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.972","2026-03-26","7.222","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.515","2026-03-24","752","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.090","2026-02-23","3.557","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":939},{"label":"Mar","value":609},{"label":"Abr","value":871},{"label":"Mai","value":912},{"label":"Jun","value":966},{"label":"Jul","value":855},{"label":"Ago","value":726},{"label":"Set","value":782},{"label":"Out","value":865},{"label":"Nov","value":595},{"label":"Dez","value":719}];
const MX = 966;
