...
const PAGE = "Noise Zone";
const KPIS = [{"l":"Total Uam Corridor","v":"9.061","t":"+8.6%","d":"up"},{"l":"Noise Zone Ativos","v":"3.287","t":"+1.4%","d":"up"},{"l":"Eficiência (%)","v":"68.5%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"83","t":"-4.5%","d":"down"}];
const COLS = ["ID","Noise Zone","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Uam Corridor #001","Uam Corridor #002","647","3.000","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Uam Corridor #002","Uam Corridor #003","6.427","2.771","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Uam Corridor #003","Uam Corridor #004","3.585","1.762","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Uam Corridor #004","Uam Corridor #005","5.324","961","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Uam Corridor #005","Uam Corridor #001","4.616","8.169","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1039},{"label":"Fev","value":831},{"label":"Mar","value":1080},{"label":"Abr","value":769},{"label":"Mai","value":753},{"label":"Jun","value":1016},{"label":"Jul","value":1035},{"label":"Ago","value":833},{"label":"Set","value":920},{"label":"Out","value":822},{"label":"Nov","value":841},{"label":"Dez","value":1048}];
const MX = 1080;
