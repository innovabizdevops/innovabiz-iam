...
const KPIS = [{"l":"Integrações Ativas","v":"4.984","t":"+16.6%","d":"up"},{"l":"Chamadas/Hora","v":"544","t":"+9.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"76.2%","t":"+14.8%","d":"up"},{"l":"Latência Média (ms)","v":"161ms","t":"+9.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.643","6.303","71.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.273","7.804","74.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.039","7.235","86.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.518","3.368","76.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.422","8.141","77.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":698},{"label":"Mar","value":724},{"label":"Abr","value":712},{"label":"Mai","value":474},{"label":"Jun","value":711},{"label":"Jul","value":639},{"label":"Ago","value":738},{"label":"Set","value":543},{"label":"Out","value":800},{"label":"Nov","value":528},{"label":"Dez","value":479}];
const MX = 800;
