...
const PAGE = "Review Platform";
const KPIS = [{"l":"Formulários Ativos","v":"2.174","t":"-1.6%","d":"down"},{"l":"Submissões/Dia","v":"4596","t":"+6.4%","d":"up"},{"l":"Documentos Gerados","v":"5.722","t":"-5.0%","d":"down"},{"l":"Templates","v":"155","t":"+9.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.982","2026-02-16","259","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.511","2026-03-24","7.382","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.118","2026-03-09","4.278","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.891","2026-03-08","8.419","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.091","2026-01-25","2.593","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":631},{"label":"Mar","value":607},{"label":"Abr","value":582},{"label":"Mai","value":332},{"label":"Jun","value":371},{"label":"Jul","value":476},{"label":"Ago","value":703},{"label":"Set","value":575},{"label":"Out","value":635},{"label":"Nov","value":702},{"label":"Dez","value":332}];
const MX = 703;
