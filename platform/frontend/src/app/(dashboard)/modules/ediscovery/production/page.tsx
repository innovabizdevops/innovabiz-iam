...
const KPIS = [{"l":"Integrações Ativas","v":"5.346","t":"+16.0%","d":"up"},{"l":"Chamadas/Hora","v":"3035","t":"-4.8%","d":"down"},{"l":"Taxa Sucesso (%)","v":"72.9%","t":"+15.8%","d":"up"},{"l":"Latência Média (ms)","v":"77ms","t":"+1.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.873","3.887","70.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.856","4.079","80.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.458","4.619","74.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.092","3.976","87.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.171","8.163","88.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":457},{"label":"Fev","value":807},{"label":"Mar","value":668},{"label":"Abr","value":546},{"label":"Mai","value":556},{"label":"Jun","value":693},{"label":"Jul","value":560},{"label":"Ago","value":733},{"label":"Set","value":657},{"label":"Out","value":832},{"label":"Nov","value":687},{"label":"Dez","value":545}];
const MX = 832;
