...
const PAGE = "Privilege Log";
const KPIS = [{"l":"Integrações Ativas","v":"4.863","t":"-3.1%","d":"down"},{"l":"Chamadas/Hora","v":"4221","t":"-0.6%","d":"down"},{"l":"Taxa Sucesso (%)","v":"95.0%","t":"+0.4%","d":"up"},{"l":"Latência Média (ms)","v":"171ms","t":"+0.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","346","1.609","99.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.422","8.636","92.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.032","1.894","90.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.328","2.671","85.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.343","4.506","88.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":714},{"label":"Fev","value":818},{"label":"Mar","value":810},{"label":"Abr","value":874},{"label":"Mai","value":539},{"label":"Jun","value":625},{"label":"Jul","value":901},{"label":"Ago","value":730},{"label":"Set","value":747},{"label":"Out","value":911},{"label":"Nov","value":722},{"label":"Dez","value":724}];
const MX = 911;
