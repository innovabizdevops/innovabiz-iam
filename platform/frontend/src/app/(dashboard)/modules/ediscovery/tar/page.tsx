...
const PAGE = "TAR/CAL";
const KPIS = [{"l":"Integrações Ativas","v":"4.528","t":"+10.6%","d":"up"},{"l":"Chamadas/Hora","v":"1969","t":"+5.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"87.1%","t":"+4.0%","d":"up"},{"l":"Latência Média (ms)","v":"25ms","t":"+13.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.726","7.785","94.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.687","448","97.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","199","1.958","76.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.004","2.818","75.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.147","7.526","98.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":362},{"label":"Fev","value":511},{"label":"Mar","value":475},{"label":"Abr","value":615},{"label":"Mai","value":281},{"label":"Jun","value":609},{"label":"Jul","value":442},{"label":"Ago","value":666},{"label":"Set","value":483},{"label":"Out","value":358},{"label":"Nov","value":528},{"label":"Dez","value":333}];
const MX = 666;
