...
const KPIS = [{"l":"Integrações Ativas","v":"8.213","t":"+11.3%","d":"up"},{"l":"Chamadas/Hora","v":"402","t":"+0.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"89.8%","t":"+1.3%","d":"up"},{"l":"Latência Média (ms)","v":"119ms","t":"-4.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","594","5.573","94.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.154","4.484","80.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","468","5.705","89.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.261","5.758","93.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.130","673","90.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":288},{"label":"Fev","value":437},{"label":"Mar","value":373},{"label":"Abr","value":298},{"label":"Mai","value":534},{"label":"Jun","value":479},{"label":"Jul","value":458},{"label":"Ago","value":486},{"label":"Set","value":623},{"label":"Out","value":471},{"label":"Nov","value":444},{"label":"Dez","value":663}];
const MX = 663;
