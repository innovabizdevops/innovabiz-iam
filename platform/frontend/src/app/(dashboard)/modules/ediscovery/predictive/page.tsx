...
const ACCENT = "#6989af";
const MODULE = "E-Discovery";
const PAGE = "Predictive Code";
const KPIS = [{"l":"Integrações Ativas","v":"1.929","t":"-4.5%","d":"down"},{"l":"Chamadas/Hora","v":"3935","t":"+8.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"88.1%","t":"-1.6%","d":"down"},{"l":"Latência Média (ms)","v":"92ms","t":"+6.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","9.016","6.157","86.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.187","7.147","88.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.535","8.122","78.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.733","556","76.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","269","6.818","97.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":500},{"label":"Mar","value":747},{"label":"Abr","value":836},{"label":"Mai","value":706},{"label":"Jun","value":626},{"label":"Jul","value":713},{"label":"Ago","value":651},{"label":"Set","value":508},{"label":"Out","value":499},{"label":"Nov","value":593},{"label":"Dez","value":546}];
const MX = 836;
