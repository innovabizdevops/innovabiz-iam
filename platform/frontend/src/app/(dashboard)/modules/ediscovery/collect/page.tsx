...
const KPIS = [{"l":"Integrações Ativas","v":"6.351","t":"+3.8%","d":"up"},{"l":"Chamadas/Hora","v":"811","t":"+10.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.0%","t":"-4.2%","d":"down"},{"l":"Latência Média (ms)","v":"50ms","t":"+8.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.212","6.514","87.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.138","2.369","97.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.386","5.643","78.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.280","5.408","80.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.989","6.856","74.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":647},{"label":"Mar","value":514},{"label":"Abr","value":755},{"label":"Mai","value":666},{"label":"Jun","value":443},{"label":"Jul","value":366},{"label":"Ago","value":538},{"label":"Set","value":695},{"label":"Out","value":503},{"label":"Nov","value":578},{"label":"Dez","value":708}];
const MX = 755;
