...
const PAGE = "5S";
const KPIS = [{"l":"Projetos Melhoria","v":"5.777","t":"+10.2%","d":"up"},{"l":"Savings (€)","v":"€12822","t":"+10.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"87.2%","t":"+16.3%","d":"up"},{"l":"Ciclos PDCA","v":"5.926","t":"+5.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","9.061","€ 17720.71","3.736","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.045","€ 4204.74","1.948","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.955","€ 21932.18","693","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.109","€ 4534.29","3.907","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.522","€ 23605.45","475","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":488},{"label":"Fev","value":346},{"label":"Mar","value":349},{"label":"Abr","value":598},{"label":"Mai","value":324},{"label":"Jun","value":598},{"label":"Jul","value":344},{"label":"Ago","value":626},{"label":"Set","value":478},{"label":"Out","value":527},{"label":"Nov","value":667},{"label":"Dez","value":681}];
const MX = 681;
