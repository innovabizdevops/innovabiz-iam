...
const PAGE = "Waste";
const KPIS = [{"l":"Projetos Melhoria","v":"7.322","t":"-0.3%","d":"down"},{"l":"Savings (€)","v":"€73170","t":"+17.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"73.4%","t":"+15.2%","d":"up"},{"l":"Ciclos PDCA","v":"524","t":"+18.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.274","€ 11692.43","6.190","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.315","€ 25364.51","5.724","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.113","€ 16660.36","877","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","746","€ 426.03","6.639","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.756","€ 16293.40","2.179","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":843},{"label":"Fev","value":787},{"label":"Mar","value":791},{"label":"Abr","value":601},{"label":"Mai","value":634},{"label":"Jun","value":873},{"label":"Jul","value":690},{"label":"Ago","value":821},{"label":"Set","value":881},{"label":"Out","value":662},{"label":"Nov","value":558},{"label":"Dez","value":560}];
const MX = 881;
