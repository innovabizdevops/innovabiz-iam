...
const PAGE = "Metrics";
const KPIS = [{"l":"Projetos Melhoria","v":"2.466","t":"-0.4%","d":"down"},{"l":"Savings (€)","v":"€13702","t":"+15.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"82.4%","t":"+13.4%","d":"up"},{"l":"Ciclos PDCA","v":"2.965","t":"+6.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.612","€ 37420.88","7.829","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.233","€ 24060.08","4.312","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.339","€ 44979.01","310","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.635","€ 606.22","2.288","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.574","€ 48709.84","4.386","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":915},{"label":"Mar","value":892},{"label":"Abr","value":1003},{"label":"Mai","value":1047},{"label":"Jun","value":1088},{"label":"Jul","value":898},{"label":"Ago","value":861},{"label":"Set","value":746},{"label":"Out","value":928},{"label":"Nov","value":805},{"label":"Dez","value":875}];
const MX = 1088;
