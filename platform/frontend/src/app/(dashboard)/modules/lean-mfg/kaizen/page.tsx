...
const PAGE = "Kaizen";
const KPIS = [{"l":"Projetos Melhoria","v":"6.450","t":"+14.5%","d":"up"},{"l":"Savings (€)","v":"€20106","t":"-3.7%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"71.3%","t":"+7.9%","d":"up"},{"l":"Ciclos PDCA","v":"8.479","t":"+2.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.127","€ 28669.57","7.547","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.919","€ 14803.23","7.013","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","934","€ 30403.30","4.767","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","600","€ 46608.82","8.743","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.679","€ 24542.17","2.114","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":791},{"label":"Mar","value":800},{"label":"Abr","value":935},{"label":"Mai","value":911},{"label":"Jun","value":914},{"label":"Jul","value":578},{"label":"Ago","value":817},{"label":"Set","value":687},{"label":"Out","value":881},{"label":"Nov","value":918},{"label":"Dez","value":678}];
const MX = 935;
