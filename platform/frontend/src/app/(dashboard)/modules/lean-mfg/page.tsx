...
export default function LeanMfgPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Lean Mfg</h1><p className="text-sm text-muted-foreground">Lean Mfg • iBOS Enterprise</p></div>
