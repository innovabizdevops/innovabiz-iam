...
const ACCENT = "#6366f1";
const MODULE = "Lean Manufacturing";
const PAGE = "Value Stream";
const KPIS = [{"l":"Projetos Melhoria","v":"7.281","t":"+0.5%","d":"up"},{"l":"Savings (€)","v":"€20050","t":"+12.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"78.9%","t":"+16.3%","d":"up"},{"l":"Ciclos PDCA","v":"3.113","t":"+5.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","323","€ 515.47","4.741","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.261","€ 14592.42","4.904","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.061","€ 25272.76","759","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.510","€ 25093.29","8.704","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.885","€ 48987.31","3.928","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":939},{"label":"Fev","value":847},{"label":"Mar","value":769},{"label":"Abr","value":920},{"label":"Mai","value":616},{"label":"Jun","value":613},{"label":"Jul","value":658},{"label":"Ago","value":953},{"label":"Set","value":841},{"label":"Out","value":686},{"label":"Nov","value":750},{"label":"Dez","value":693}];
const MX = 953;
