...
const PAGE = "Author";
const KPIS = [{"l":"Utilizadores Ativos","v":"856","t":"+10.4%","d":"up"},{"l":"Sessões/Dia","v":"1165","t":"+2.6%","d":"up"},{"l":"MFA Adoção (%)","v":"88.2%","t":"+7.3%","d":"up"},{"l":"Tentativas Bloqueadas","v":"4.010","t":"-0.6%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","8.250","5.210","8.129","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.809","8.043","7.844","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.313","7.419","1.636","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.137","4.037","2.571","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","2.117","2.799","7.665","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":392},{"label":"Mar","value":297},{"label":"Abr","value":380},{"label":"Mai","value":343},{"label":"Jun","value":523},{"label":"Jul","value":353},{"label":"Ago","value":619},{"label":"Set","value":294},{"label":"Out","value":621},{"label":"Nov","value":449},{"label":"Dez","value":494}];
const MX = 621;
