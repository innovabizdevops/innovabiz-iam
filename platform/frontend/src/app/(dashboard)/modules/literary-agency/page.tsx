...
/* ═══ Literary Agency — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "3835", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3184", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€291K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "-18%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1687508235", cells: ["LIT-9235", "Literary Agency Item 1", "8/4/2026", "€8335"], status: "active" as const },
    { id: "1687511806", cells: ["LIT-3806", "Literary Agency Item 2", "23/11/2026", "€11 906"], status: "pending" as const },
    { id: "1687515377", cells: ["LIT-7377", "Literary Agency Item 3", "10/6/2026", "€15 477"], status: "completed" as const },
    { id: "1687518948", cells: ["LIT-1948", "Literary Agency Item 4", "25/1/2026", "€19 048"], status: "warning" as const },
    { id: "1687522519", cells: ["LIT-5519", "Literary Agency Item 5", "12/8/2026", "€22 619"], status: "active" as const },
];
...
export default function LiteraryAgencyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Literary Agency</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Literary Agency</p>
                    </div>
                </div>
