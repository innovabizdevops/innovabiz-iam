...
const PAGE = "Flight Plan";
const KPIS = [{"l":"Total Airline Ops","v":"8.332","t":"+2.3%","d":"up"},{"l":"Flight Plan Ativos","v":"8.719","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"65.4%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"57","t":"-0.3%","d":"down"}];
const COLS = ["ID","Flight Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airline Ops #001","Airline Ops #002","8.752","6.263","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Airline Ops #002","Airline Ops #003","4.357","2.341","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Airline Ops #003","Airline Ops #004","7.429","1.006","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Airline Ops #004","Airline Ops #005","5.796","3.333","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airline Ops #005","Airline Ops #001","3.146","5.020","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":714},{"label":"Fev","value":617},{"label":"Mar","value":691},{"label":"Abr","value":439},{"label":"Mai","value":370},{"label":"Jun","value":711},{"label":"Jul","value":333},{"label":"Ago","value":436},{"label":"Set","value":626},{"label":"Out","value":652},{"label":"Nov","value":377},{"label":"Dez","value":601}];
const MX = 714;
