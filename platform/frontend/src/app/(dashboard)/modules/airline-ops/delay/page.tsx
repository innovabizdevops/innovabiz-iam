...
const ACCENT = "#6366f1";
const MODULE = "Airline Operations";
const PAGE = "Delay";
const KPIS = [{"l":"Total Airline Ops","v":"4.797","t":"-3.7%","d":"down"},{"l":"Delay Ativos","v":"6.936","t":"+5.7%","d":"up"},{"l":"Eficiência (%)","v":"83.1%","t":"+1.5%","d":"up"},{"l":"Score Performance","v":"87","t":"+2.4%","d":"up"}];
const COLS = ["ID","Delay","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airline Ops #001","Airline Ops #002","3.855","4.878","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Airline Ops #002","Airline Ops #003","8.785","6.590","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Airline Ops #003","Airline Ops #004","5.333","4.900","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Airline Ops #004","Airline Ops #005","4.323","9.006","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airline Ops #005","Airline Ops #001","4.180","5.331","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":782},{"label":"Mar","value":735},{"label":"Abr","value":547},{"label":"Mai","value":579},{"label":"Jun","value":463},{"label":"Jul","value":663},{"label":"Ago","value":764},{"label":"Set","value":745},{"label":"Out","value":723},{"label":"Nov","value":770},{"label":"Dez","value":766}];
const MX = 782;
