...
const PAGE = "OCC";
const KPIS = [{"l":"Total Airline Ops","v":"3.072","t":"-2.3%","d":"down"},{"l":"OCC Ativos","v":"3.066","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"91.2%","t":"+4.3%","d":"up"},{"l":"Score Performance","v":"93","t":"+17.3%","d":"up"}];
const COLS = ["ID","OCC","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airline Ops #001","Airline Ops #002","4.647","2.657","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Airline Ops #002","Airline Ops #003","5.232","5.323","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Airline Ops #003","Airline Ops #004","205","4.399","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Airline Ops #004","Airline Ops #005","8.324","5.522","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airline Ops #005","Airline Ops #001","8.294","8.758","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":919},{"label":"Fev","value":687},{"label":"Mar","value":579},{"label":"Abr","value":943},{"label":"Mai","value":673},{"label":"Jun","value":623},{"label":"Jul","value":781},{"label":"Ago","value":796},{"label":"Set","value":856},{"label":"Out","value":869},{"label":"Nov","value":632},{"label":"Dez","value":843}];
const MX = 943;
