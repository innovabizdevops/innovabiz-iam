...
const PAGE = "Crew";
const KPIS = [{"l":"Total Airline Ops","v":"4.294","t":"+17.6%","d":"up"},{"l":"Crew Ativos","v":"8.359","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"82.7%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"74","t":"-0.7%","d":"down"}];
const COLS = ["ID","Crew","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airline Ops #001","Airline Ops #002","6.886","373","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Airline Ops #002","Airline Ops #003","3.811","465","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Airline Ops #003","Airline Ops #004","2.641","2.934","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Airline Ops #004","Airline Ops #005","2.792","1.295","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airline Ops #005","Airline Ops #001","8.258","8.125","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":429},{"label":"Fev","value":345},{"label":"Mar","value":533},{"label":"Abr","value":341},{"label":"Mai","value":572},{"label":"Jun","value":245},{"label":"Jul","value":376},{"label":"Ago","value":474},{"label":"Set","value":437},{"label":"Out","value":590},{"label":"Nov","value":489},{"label":"Dez","value":334}];
const MX = 590;
