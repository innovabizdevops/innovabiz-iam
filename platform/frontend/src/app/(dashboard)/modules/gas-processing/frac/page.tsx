...
const PAGE = "Fractionation";
const KPIS = [{"l":"Total Gas Processing","v":"5.297","t":"+11.1%","d":"up"},{"l":"Fractionation Ativos","v":"5.867","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"93.2%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"60","t":"-0.3%","d":"down"}];
const COLS = ["ID","Fractionation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gas Processing #001","Gas Processing #002","6.088","8.167","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Gas Processing #002","Gas Processing #003","3.519","5.803","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Gas Processing #003","Gas Processing #004","2.898","460","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Gas Processing #004","Gas Processing #005","6.446","8.395","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gas Processing #005","Gas Processing #001","2.390","8.656","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":737},{"label":"Mar","value":655},{"label":"Abr","value":389},{"label":"Mai","value":445},{"label":"Jun","value":642},{"label":"Jul","value":601},{"label":"Ago","value":564},{"label":"Set","value":539},{"label":"Out","value":702},{"label":"Nov","value":485},{"label":"Dez","value":516}];
const MX = 737;
