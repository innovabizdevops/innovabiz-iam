...
const PAGE = "NGL";
const KPIS = [{"l":"Total Gas Processing","v":"6.891","t":"+11.1%","d":"up"},{"l":"NGL Ativos","v":"3.887","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"88.9%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"73","t":"-3.8%","d":"down"}];
const COLS = ["ID","NGL","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gas Processing #001","Gas Processing #002","6.370","7.149","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Gas Processing #002","Gas Processing #003","4.051","5.385","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Gas Processing #003","Gas Processing #004","1.448","6.081","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Gas Processing #004","Gas Processing #005","6.348","3.747","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gas Processing #005","Gas Processing #001","1.031","1.768","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":909},{"label":"Fev","value":556},{"label":"Mar","value":594},{"label":"Abr","value":586},{"label":"Mai","value":866},{"label":"Jun","value":698},{"label":"Jul","value":821},{"label":"Ago","value":717},{"label":"Set","value":866},{"label":"Out","value":550},{"label":"Nov","value":642},{"label":"Dez","value":519}];
const MX = 909;
