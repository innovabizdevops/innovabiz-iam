...
const PAGE = "Dehydrate";
const KPIS = [{"l":"Total Gas Processing","v":"1.738","t":"+15.5%","d":"up"},{"l":"Dehydrate Ativos","v":"1.020","t":"-5.3%","d":"down"},{"l":"Eficiência (%)","v":"84.4%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"66","t":"+11.4%","d":"up"}];
const COLS = ["ID","Dehydrate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gas Processing #001","Gas Processing #002","5.776","668","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Gas Processing #002","Gas Processing #003","5.554","567","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Gas Processing #003","Gas Processing #004","1.467","197","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Gas Processing #004","Gas Processing #005","2.633","3.913","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gas Processing #005","Gas Processing #001","5.870","2.310","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":845},{"label":"Fev","value":853},{"label":"Mar","value":872},{"label":"Abr","value":559},{"label":"Mai","value":817},{"label":"Jun","value":541},{"label":"Jul","value":709},{"label":"Ago","value":614},{"label":"Set","value":547},{"label":"Out","value":622},{"label":"Nov","value":554},{"label":"Dez","value":553}];
const MX = 872;
...
export default function DehydratePage() {
    return (
