...
const ACCENT = "#6366f1";
const MODULE = "Gas Processing";
const PAGE = "Sweetening";
const KPIS = [{"l":"Total Gas Processing","v":"4.296","t":"-3.5%","d":"down"},{"l":"Sweetening Ativos","v":"8.607","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"68.2%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"78","t":"+4.3%","d":"up"}];
const COLS = ["ID","Sweetening","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gas Processing #001","Gas Processing #002","1.826","6.605","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Gas Processing #002","Gas Processing #003","7.105","705","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Gas Processing #003","Gas Processing #004","4.190","4.545","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Gas Processing #004","Gas Processing #005","1.373","6.283","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gas Processing #005","Gas Processing #001","2.145","1.395","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":509},{"label":"Mar","value":703},{"label":"Abr","value":758},{"label":"Mai","value":677},{"label":"Jun","value":694},{"label":"Jul","value":778},{"label":"Ago","value":782},{"label":"Set","value":863},{"label":"Out","value":864},{"label":"Nov","value":708},{"label":"Dez","value":574}];
const MX = 864;
...
export default function SweetenPage() {
    return (
