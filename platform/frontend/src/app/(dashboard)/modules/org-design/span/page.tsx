...
const ACCENT = "#6366f1";
const MODULE = "Org Design";
const PAGE = "Span Ctrl";
const KPIS = [{"l":"Formulários Ativos","v":"4.029","t":"+1.7%","d":"up"},{"l":"Submissões/Dia","v":"1953","t":"+14.3%","d":"up"},{"l":"Documentos Gerados","v":"2.943","t":"+3.0%","d":"up"},{"l":"Templates","v":"2.514","t":"+13.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.348","2026-01-26","8.727","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.423","2026-03-16","8.822","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.495","2026-02-17","1.200","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.494","2026-02-15","5.123","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.737","2026-03-19","4.179","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":617},{"label":"Mar","value":750},{"label":"Abr","value":700},{"label":"Mai","value":879},{"label":"Jun","value":693},{"label":"Jul","value":652},{"label":"Ago","value":931},{"label":"Set","value":809},{"label":"Out","value":826},{"label":"Nov","value":558},{"label":"Dez","value":920}];
const MX = 931;
