...
const KPIS = [{"l":"Formulários Ativos","v":"5.061","t":"+11.7%","d":"up"},{"l":"Submissões/Dia","v":"964","t":"-4.9%","d":"down"},{"l":"Documentos Gerados","v":"8.710","t":"+7.8%","d":"up"},{"l":"Templates","v":"4.363","t":"+12.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.783","2026-02-23","8.985","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.409","2026-02-23","5.100","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","207","2026-01-11","3.744","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.229","2026-02-26","3.494","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.726","2026-01-08","8.286","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":876},{"label":"Fev","value":787},{"label":"Mar","value":802},{"label":"Abr","value":797},{"label":"Mai","value":740},{"label":"Jun","value":957},{"label":"Jul","value":762},{"label":"Ago","value":1065},{"label":"Set","value":801},{"label":"Out","value":893},{"label":"Nov","value":896},{"label":"Dez","value":1031}];
const MX = 1065;
