...
const PAGE = "Job Arch";
const KPIS = [{"l":"Formulários Ativos","v":"4.718","t":"+16.3%","d":"up"},{"l":"Submissões/Dia","v":"405","t":"+11.3%","d":"up"},{"l":"Documentos Gerados","v":"2.939","t":"+2.8%","d":"up"},{"l":"Templates","v":"3.512","t":"+6.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.312","2026-03-24","2.724","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.542","2026-03-01","6.601","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.065","2026-01-28","7.738","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.498","2026-03-15","1.974","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.719","2026-02-10","6.207","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":846},{"label":"Mar","value":943},{"label":"Abr","value":739},{"label":"Mai","value":556},{"label":"Jun","value":848},{"label":"Jul","value":632},{"label":"Ago","value":825},{"label":"Set","value":648},{"label":"Out","value":799},{"label":"Nov","value":625},{"label":"Dez","value":922}];
const MX = 943;
