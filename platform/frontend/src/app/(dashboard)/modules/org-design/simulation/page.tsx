...
const KPIS = [{"l":"Twins Ativos","v":"958","t":"+17.8%","d":"up"},{"l":"Simulações/Dia","v":"2238","t":"+1.8%","d":"up"},{"l":"Precisão Modelo (%)","v":"68.4%","t":"+5.8%","d":"up"},{"l":"Latência Sync (ms)","v":"136ms","t":"+8.1%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","93.6%","2026-02-13","7.814","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","77.4%","2026-03-27","664","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","76.9%","2026-01-11","6.928","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","93.9%","2026-03-20","8.707","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","70.1%","2026-02-07","1.649","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":295},{"label":"Fev","value":466},{"label":"Mar","value":313},{"label":"Abr","value":269},{"label":"Mai","value":634},{"label":"Jun","value":393},{"label":"Jul","value":481},{"label":"Ago","value":284},{"label":"Set","value":470},{"label":"Out","value":632},{"label":"Nov","value":350},{"label":"Dez","value":361}];
const MX = 634;
