...
const KPIS = [{"l":"Formulários Ativos","v":"689","t":"+6.5%","d":"up"},{"l":"Submissões/Dia","v":"1604","t":"+7.4%","d":"up"},{"l":"Documentos Gerados","v":"3.041","t":"+10.3%","d":"up"},{"l":"Templates","v":"2.933","t":"+17.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.609","2026-01-17","1.395","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.131","2026-03-13","160","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.575","2026-01-23","5.179","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.430","2026-01-23","4.212","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.840","2026-03-16","6.496","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":216},{"label":"Mar","value":441},{"label":"Abr","value":550},{"label":"Mai","value":439},{"label":"Jun","value":330},{"label":"Jul","value":408},{"label":"Ago","value":411},{"label":"Set","value":390},{"label":"Out","value":406},{"label":"Nov","value":248},{"label":"Dez","value":367}];
const MX = 550;
