...
/* ═══ Vintage Car Collectible — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "5560", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1421", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€126K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "-18%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1501954260", cells: ["VIN-8260", "Vintage Car Collectible Item 1", "17/1/2026", "€4360"], status: "active" as const },
    { id: "1501957831", cells: ["VIN-2831", "Vintage Car Collectible Item 2", "4/8/2026", "€7931"], status: "pending" as const },
    { id: "1501961402", cells: ["VIN-6402", "Vintage Car Collectible Item 3", "19/3/2026", "€11 502"], status: "completed" as const },
    { id: "1501964973", cells: ["VIN-9973", "Vintage Car Collectible Item 4", "6/10/2026", "€15 073"], status: "warning" as const },
    { id: "1501968544", cells: ["VIN-4544", "Vintage Car Collectible Item 5", "21/5/2026", "€18 644"], status: "active" as const },
];
...
export default function VintageCarCollectiblePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Vintage Car Collectible</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Vintage Car Collectible</p>
                    </div>
                </div>
