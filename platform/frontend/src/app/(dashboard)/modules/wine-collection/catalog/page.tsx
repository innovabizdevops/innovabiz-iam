...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"8.755","t":"+0.7%","d":"up"},{"l":"Queries/Dia","v":"4404","t":"+11.7%","d":"up"},{"l":"Dados Processados (GB)","v":"8.837","t":"+11.8%","d":"up"},{"l":"Utilizadores Analytics","v":"1.169","t":"+1.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1883","2026-03-10","7.854","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4301","2026-03-20","466","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","600","2026-03-16","3.952","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4798","2026-03-19","5.325","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1735","2026-03-24","1.498","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":463},{"label":"Fev","value":403},{"label":"Mar","value":287},{"label":"Abr","value":456},{"label":"Mai","value":525},{"label":"Jun","value":570},{"label":"Jul","value":286},{"label":"Ago","value":288},{"label":"Set","value":479},{"label":"Out","value":447},{"label":"Nov","value":575},{"label":"Dez","value":501}];
const MX = 575;
