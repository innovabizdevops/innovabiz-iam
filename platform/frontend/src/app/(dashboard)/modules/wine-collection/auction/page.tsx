...
const ACCENT = "#713f12";
const MODULE = "Wine Collection";
const PAGE = "Auction";
const KPIS = [{"l":"Total Wine Collection","v":"3.418","t":"-1.1%","d":"down"},{"l":"Auction Ativos","v":"4.111","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"88.1%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"65","t":"+3.3%","d":"up"}];
const COLS = ["ID","Auction","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wine Collection #001","Wine Collection #002","236","8.236","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Wine Collection #002","Wine Collection #003","1.067","5.197","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Wine Collection #003","Wine Collection #004","7.445","3.655","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Wine Collection #004","Wine Collection #005","8.184","5.417","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wine Collection #005","Wine Collection #001","7.618","6.094","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":566},{"label":"Mar","value":676},{"label":"Abr","value":824},{"label":"Mai","value":600},{"label":"Jun","value":625},{"label":"Jul","value":510},{"label":"Ago","value":769},{"label":"Set","value":453},{"label":"Out","value":527},{"label":"Nov","value":726},{"label":"Dez","value":707}];
const MX = 824;
