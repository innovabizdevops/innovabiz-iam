...
const KPIS = [
    { label: "Total Registos", value: "7921", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3173", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€487K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "-4%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "344814921", cells: ["WIN-7921", "Wine Collection Item 1", "18/10/2026", "€15 021"], status: "active" as const },
    { id: "344818492", cells: ["WIN-2492", "Wine Collection Item 2", "5/5/2026", "€18 592"], status: "pending" as const },
    { id: "344822063", cells: ["WIN-6063", "Wine Collection Item 3", "20/12/2026", "€22 163"], status: "completed" as const },
    { id: "344825634", cells: ["WIN-9634", "Wine Collection Item 4", "7/7/2026", "€25 734"], status: "warning" as const },
    { id: "344829205", cells: ["WIN-4205", "Wine Collection Item 5", "22/2/2026", "€29 305"], status: "active" as const },
];
...
export default function WineCollectionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wine Collection</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Wine Collection</p>
                    </div>
                </div>
