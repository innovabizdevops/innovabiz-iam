...
const PAGE = "Acquire";
const KPIS = [{"l":"Total Wine Collection","v":"8.729","t":"-2.6%","d":"down"},{"l":"Acquire Ativos","v":"413","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"93.5%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"61","t":"-1.2%","d":"down"}];
const COLS = ["ID","Acquire","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wine Collection #001","Wine Collection #002","4.297","9.007","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Wine Collection #002","Wine Collection #003","704","6.066","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Wine Collection #003","Wine Collection #004","7.322","5.768","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Wine Collection #004","Wine Collection #005","996","3.824","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wine Collection #005","Wine Collection #001","5.666","426","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":899},{"label":"Fev","value":750},{"label":"Mar","value":973},{"label":"Abr","value":771},{"label":"Mai","value":676},{"label":"Jun","value":667},{"label":"Jul","value":749},{"label":"Ago","value":739},{"label":"Set","value":975},{"label":"Out","value":835},{"label":"Nov","value":794},{"label":"Dez","value":990}];
const MX = 990;
