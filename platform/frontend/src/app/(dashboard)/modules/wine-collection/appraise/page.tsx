...
const PAGE = "Appraise";
const KPIS = [{"l":"Total Wine Collection","v":"4.468","t":"-3.6%","d":"down"},{"l":"Appraise Ativos","v":"4.520","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"87.2%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"77","t":"-6.0%","d":"down"}];
const COLS = ["ID","Appraise","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wine Collection #001","Wine Collection #002","7.669","1.995","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Wine Collection #002","Wine Collection #003","8.523","7.151","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Wine Collection #003","Wine Collection #004","8.679","4.142","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Wine Collection #004","Wine Collection #005","3.353","1.355","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wine Collection #005","Wine Collection #001","3.606","6.709","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":609},{"label":"Mar","value":789},{"label":"Abr","value":730},{"label":"Mai","value":712},{"label":"Jun","value":861},{"label":"Jul","value":540},{"label":"Ago","value":799},{"label":"Set","value":646},{"label":"Out","value":756},{"label":"Nov","value":793},{"label":"Dez","value":859}];
const MX = 861;
