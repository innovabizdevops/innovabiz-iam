...
const PAGE = "Cellar";
const KPIS = [{"l":"Total Wine Collection","v":"1.232","t":"+17.8%","d":"up"},{"l":"Cellar Ativos","v":"6.010","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"82.4%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"70","t":"-2.5%","d":"down"}];
const COLS = ["ID","Cellar","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wine Collection #001","Wine Collection #002","3.659","2.771","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Wine Collection #002","Wine Collection #003","6.288","3.232","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Wine Collection #003","Wine Collection #004","5.666","5.906","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Wine Collection #004","Wine Collection #005","320","4.193","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wine Collection #005","Wine Collection #001","2.504","8.136","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":829},{"label":"Mar","value":859},{"label":"Abr","value":968},{"label":"Mai","value":925},{"label":"Jun","value":759},{"label":"Jul","value":852},{"label":"Ago","value":963},{"label":"Set","value":740},{"label":"Out","value":721},{"label":"Nov","value":804},{"label":"Dez","value":816}];
const MX = 968;
