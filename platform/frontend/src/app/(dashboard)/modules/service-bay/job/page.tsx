...
const PAGE = "Job Card";
const KPIS = [{"l":"Total Service Bay","v":"1.972","t":"+10.3%","d":"up"},{"l":"Job Card Ativos","v":"7.903","t":"+7.5%","d":"up"},{"l":"Eficiência (%)","v":"76.6%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"76","t":"+1.2%","d":"up"}];
const COLS = ["ID","Job Card","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Bay #001","Service Bay #002","5.963","1.019","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Service Bay #002","Service Bay #003","2.165","1.061","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Bay #003","Service Bay #004","8.081","4.270","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Service Bay #004","Service Bay #005","6.679","6.803","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Bay #005","Service Bay #001","4.934","3.488","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":633},{"label":"Mar","value":574},{"label":"Abr","value":600},{"label":"Mai","value":921},{"label":"Jun","value":556},{"label":"Jul","value":638},{"label":"Ago","value":692},{"label":"Set","value":857},{"label":"Out","value":769},{"label":"Nov","value":788},{"label":"Dez","value":690}];
const MX = 921;
