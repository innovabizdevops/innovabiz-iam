...
const PAGE = "Customer Comm";
const KPIS = [{"l":"Total Service Bay","v":"3.245","t":"+15.8%","d":"up"},{"l":"Customer Comm Ativos","v":"€26068","t":"+11.4%","d":"up"},{"l":"Eficiência (%)","v":"72.0%","t":"+6.5%","d":"up"},{"l":"Score Performance","v":"59","t":"+1.2%","d":"up"}];
const COLS = ["ID","Customer Comm","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Bay #001","€ 46035.12","4.792","3.017","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Service Bay #002","€ 42752.71","4.612","7.350","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Bay #003","€ 12940.06","5.407","6.321","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Service Bay #004","€ 30712.92","4.577","5.543","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Bay #005","€ 35570.29","5.286","8.211","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":461},{"label":"Fev","value":563},{"label":"Mar","value":690},{"label":"Abr","value":410},{"label":"Mai","value":711},{"label":"Jun","value":366},{"label":"Jul","value":553},{"label":"Ago","value":586},{"label":"Set","value":368},{"label":"Out","value":723},{"label":"Nov","value":526},{"label":"Dez","value":591}];
const MX = 723;
