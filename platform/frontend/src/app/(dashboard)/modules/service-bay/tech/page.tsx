...
const KPIS = [{"l":"Total Service Bay","v":"6.549","t":"+14.4%","d":"up"},{"l":"Technician Ativos","v":"4.458","t":"+17.7%","d":"up"},{"l":"Eficiência (%)","v":"88.6%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"91","t":"+3.1%","d":"up"}];
const COLS = ["ID","Technician","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Bay #001","Service Bay #002","9.058","8.312","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Service Bay #002","Service Bay #003","4.387","2.015","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Bay #003","Service Bay #004","8.568","7.934","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Service Bay #004","Service Bay #005","8.756","6.805","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Bay #005","Service Bay #001","4.196","9.007","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1033},{"label":"Fev","value":843},{"label":"Mar","value":790},{"label":"Abr","value":690},{"label":"Mai","value":1000},{"label":"Jun","value":870},{"label":"Jul","value":770},{"label":"Ago","value":989},{"label":"Set","value":1042},{"label":"Out","value":792},{"label":"Nov","value":945},{"label":"Dez","value":851}];
const MX = 1042;
