...
const ACCENT = "#4338ca";
const MODULE = "Service Bay Mgmt";
const PAGE = "Bay Schedule";
const KPIS = [{"l":"Total Service Bay","v":"8.340","t":"+15.6%","d":"up"},{"l":"Bay Schedule Ativos","v":"3.552","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"73.7%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"58","t":"+16.0%","d":"up"}];
const COLS = ["ID","Bay Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Bay #001","Service Bay #002","3.184","5.937","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Service Bay #002","Service Bay #003","8.357","9.071","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Bay #003","Service Bay #004","5.775","160","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Service Bay #004","Service Bay #005","7.724","7.329","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Bay #005","Service Bay #001","7.786","4.203","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":824},{"label":"Mar","value":896},{"label":"Abr","value":977},{"label":"Mai","value":731},{"label":"Jun","value":852},{"label":"Jul","value":836},{"label":"Ago","value":1008},{"label":"Set","value":1000},{"label":"Out","value":947},{"label":"Nov","value":1034},{"label":"Dez","value":1035}];
const MX = 1035;
