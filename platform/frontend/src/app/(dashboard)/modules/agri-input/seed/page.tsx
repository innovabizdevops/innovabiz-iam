...
const PAGE = "Seed";
const KPIS = [{"l":"Total Agri Input","v":"7.698","t":"+8.7%","d":"up"},{"l":"Seed Ativos","v":"5.001","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"80.7%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"77","t":"-4.0%","d":"down"}];
const COLS = ["ID","Seed","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Input #001","Agri Input #002","5.009","2.545","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Input #002","Agri Input #003","775","5.799","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Input #003","Agri Input #004","4.423","6.299","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Input #004","Agri Input #005","3.800","324","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Input #005","Agri Input #001","1.853","2.323","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":535},{"label":"Mar","value":696},{"label":"Abr","value":510},{"label":"Mai","value":440},{"label":"Jun","value":555},{"label":"Jul","value":533},{"label":"Ago","value":552},{"label":"Set","value":649},{"label":"Out","value":486},{"label":"Nov","value":795},{"label":"Dez","value":790}];
const MX = 795;
