...
const ACCENT = "#166534";
const MODULE = "Agriculture Input Management";
const PAGE = "Fertilizer";
const KPIS = [{"l":"Total Agri Input","v":"6.998","t":"+4.9%","d":"up"},{"l":"Fertilizer Ativos","v":"4.026","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"69.7%","t":"-4.4%","d":"down"},{"l":"Score Performance","v":"78","t":"+1.4%","d":"up"}];
const COLS = ["ID","Fertilizer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Input #001","Agri Input #002","3.461","5.750","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Input #002","Agri Input #003","4.988","1.832","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Input #003","Agri Input #004","2.772","4.092","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Input #004","Agri Input #005","7.517","6.148","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Input #005","Agri Input #001","8.361","8.433","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":581},{"label":"Fev","value":885},{"label":"Mar","value":638},{"label":"Abr","value":820},{"label":"Mai","value":695},{"label":"Jun","value":708},{"label":"Jul","value":870},{"label":"Ago","value":748},{"label":"Set","value":733},{"label":"Out","value":920},{"label":"Nov","value":754},{"label":"Dez","value":642}];
const MX = 920;
