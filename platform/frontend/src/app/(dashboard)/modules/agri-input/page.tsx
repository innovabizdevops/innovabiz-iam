...
/* ═══ Agriculture Input Management — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "949", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "221", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€106K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "-7%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "813424449", cells: ["AGR-5449", "Agriculture Input Management Item 1", "6/10/2026", "€24 549"], status: "active" as const },
    { id: "813428020", cells: ["AGR-9020", "Agriculture Input Management Item 2", "21/5/2026", "€28 120"], status: "pending" as const },
    { id: "813431591", cells: ["AGR-3591", "Agriculture Input Management Item 3", "8/12/2026", "€31 691"], status: "completed" as const },
    { id: "813435162", cells: ["AGR-7162", "Agriculture Input Management Item 4", "23/7/2026", "€35 262"], status: "warning" as const },
    { id: "813438733", cells: ["AGR-1733", "Agriculture Input Management Item 5", "10/2/2026", "€38 833"], status: "active" as const },
];
...
export default function AgricultureInputManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Agriculture Input Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Agriculture Input Management</p>
                    </div>
                </div>
