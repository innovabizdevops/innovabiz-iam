...
const KPIS = [{"l":"Total Agri Input","v":"5.668","t":"-2.2%","d":"down"},{"l":"Pesticide Ativos","v":"7.375","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"83.6%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"77","t":"+14.4%","d":"up"}];
const COLS = ["ID","Pesticide","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Input #001","Agri Input #002","1.259","3.714","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Input #002","Agri Input #003","6.435","8.411","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Input #003","Agri Input #004","3.398","7.812","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Input #004","Agri Input #005","5.428","7.213","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Input #005","Agri Input #001","5.877","2.552","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":786},{"label":"Fev","value":775},{"label":"Mar","value":832},{"label":"Abr","value":884},{"label":"Mai","value":961},{"label":"Jun","value":716},{"label":"Jul","value":932},{"label":"Ago","value":681},{"label":"Set","value":663},{"label":"Out","value":666},{"label":"Nov","value":807},{"label":"Dez","value":670}];
const MX = 961;
