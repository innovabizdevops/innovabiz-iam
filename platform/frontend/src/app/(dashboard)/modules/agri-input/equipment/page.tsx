...
const KPIS = [{"l":"Total Agri Input","v":"8.422","t":"+14.5%","d":"up"},{"l":"Equipment Ativos","v":"3.681","t":"-5.7%","d":"down"},{"l":"Eficiência (%)","v":"94.4%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"84","t":"+13.7%","d":"up"}];
const COLS = ["ID","Equipment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Input #001","Agri Input #002","6.639","7.016","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Input #002","Agri Input #003","7.614","5.083","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Input #003","Agri Input #004","1.257","3.248","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Input #004","Agri Input #005","1.544","8.015","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Input #005","Agri Input #001","2.814","5.535","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":465},{"label":"Mar","value":584},{"label":"Abr","value":724},{"label":"Mai","value":612},{"label":"Jun","value":410},{"label":"Jul","value":615},{"label":"Ago","value":635},{"label":"Set","value":511},{"label":"Out","value":678},{"label":"Nov","value":502},{"label":"Dez","value":686}];
const MX = 756;
