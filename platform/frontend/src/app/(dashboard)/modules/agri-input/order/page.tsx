...
const PAGE = "Order";
const KPIS = [{"l":"Total Agri Input","v":"8.103","t":"+14.9%","d":"up"},{"l":"Order Ativos","v":"2.420","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"92.1%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"88","t":"-3.8%","d":"down"}];
const COLS = ["ID","Order","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Input #001","Agri Input #002","3.343","6.919","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Input #002","Agri Input #003","8.516","1.887","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Input #003","Agri Input #004","4.839","5.571","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Input #004","Agri Input #005","2.690","5.388","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Input #005","Agri Input #001","3.933","6.983","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":766},{"label":"Mar","value":556},{"label":"Abr","value":725},{"label":"Mai","value":704},{"label":"Jun","value":853},{"label":"Jul","value":945},{"label":"Ago","value":781},{"label":"Set","value":559},{"label":"Out","value":829},{"label":"Nov","value":618},{"label":"Dez","value":943}];
const MX = 945;
