...
const PAGE = "Strategy";
const KPIS = [{"l":"Formulários Ativos","v":"4.068","t":"-5.2%","d":"down"},{"l":"Submissões/Dia","v":"1431","t":"+6.8%","d":"up"},{"l":"Documentos Gerados","v":"8.238","t":"+8.8%","d":"up"},{"l":"Templates","v":"5.159","t":"+13.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.844","2026-03-12","6.924","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.114","2026-01-02","1.828","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.426","2026-01-27","847","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.171","2026-02-01","3.662","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.489","2026-01-19","9.061","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":651},{"label":"Mar","value":638},{"label":"Abr","value":498},{"label":"Mai","value":494},{"label":"Jun","value":654},{"label":"Jul","value":477},{"label":"Ago","value":336},{"label":"Set","value":566},{"label":"Out","value":479},{"label":"Nov","value":589},{"label":"Dez","value":572}];
const MX = 654;
