...
const ACCENT = "#6366f1";
const MODULE = "CSR Platform";
const PAGE = "Stakeholder";
const KPIS = [{"l":"Formulários Ativos","v":"7.007","t":"+12.8%","d":"up"},{"l":"Submissões/Dia","v":"2835","t":"+15.9%","d":"up"},{"l":"Documentos Gerados","v":"1.260","t":"-0.4%","d":"down"},{"l":"Templates","v":"1.460","t":"+13.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.825","2026-03-28","3.746","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.996","2026-01-10","4.453","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.364","2026-02-17","1.380","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.342","2026-03-09","779","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.834","2026-03-17","7.550","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":381},{"label":"Fev","value":692},{"label":"Mar","value":354},{"label":"Abr","value":397},{"label":"Mai","value":472},{"label":"Jun","value":404},{"label":"Jul","value":681},{"label":"Ago","value":587},{"label":"Set","value":476},{"label":"Out","value":521},{"label":"Nov","value":596},{"label":"Dez","value":534}];
const MX = 692;
