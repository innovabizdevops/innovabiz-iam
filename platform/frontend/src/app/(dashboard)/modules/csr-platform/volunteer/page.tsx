...
const KPIS = [{"l":"Formulários Ativos","v":"5.139","t":"+7.7%","d":"up"},{"l":"Submissões/Dia","v":"3256","t":"-2.6%","d":"down"},{"l":"Documentos Gerados","v":"936","t":"+10.2%","d":"up"},{"l":"Templates","v":"7.186","t":"+9.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","927","2026-03-08","4.907","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","500","2026-02-07","7.523","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.212","2026-01-19","1.266","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.964","2026-01-28","8.965","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.893","2026-03-12","8.028","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":427},{"label":"Fev","value":802},{"label":"Mar","value":593},{"label":"Abr","value":608},{"label":"Mai","value":749},{"label":"Jun","value":738},{"label":"Jul","value":555},{"label":"Ago","value":743},{"label":"Set","value":697},{"label":"Out","value":816},{"label":"Nov","value":646},{"label":"Dez","value":509}];
const MX = 816;
