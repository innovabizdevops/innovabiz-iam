...
const PAGE = "Program";
const KPIS = [{"l":"Formulários Ativos","v":"3.624","t":"+3.1%","d":"up"},{"l":"Submissões/Dia","v":"2873","t":"+2.6%","d":"up"},{"l":"Documentos Gerados","v":"5.176","t":"+0.7%","d":"up"},{"l":"Templates","v":"1.063","t":"+12.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.814","2026-01-02","4.476","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.539","2026-01-24","2.544","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.709","2026-01-07","5.156","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.892","2026-03-08","6.913","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.882","2026-03-04","6.362","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":387},{"label":"Fev","value":281},{"label":"Mar","value":544},{"label":"Abr","value":448},{"label":"Mai","value":301},{"label":"Jun","value":301},{"label":"Jul","value":321},{"label":"Ago","value":429},{"label":"Set","value":457},{"label":"Out","value":503},{"label":"Nov","value":610},{"label":"Dez","value":401}];
const MX = 610;
