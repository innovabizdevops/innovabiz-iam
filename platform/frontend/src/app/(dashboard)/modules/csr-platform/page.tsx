...
export default function CsrPlatformPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Csr Platform</h1><p className="text-sm text-muted-foreground">Csr Platform • iBOS Enterprise</p></div>
