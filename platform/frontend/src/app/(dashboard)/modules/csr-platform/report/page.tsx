...
const PAGE = "Report";
const KPIS = [{"l":"Formulários Ativos","v":"3.322","t":"-4.4%","d":"down"},{"l":"Submissões/Dia","v":"2459","t":"-3.6%","d":"down"},{"l":"Documentos Gerados","v":"3.031","t":"-5.0%","d":"down"},{"l":"Templates","v":"1.219","t":"+12.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","161","2026-02-13","2.238","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.011","2026-03-09","592","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","9.031","2026-02-02","4.467","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.319","2026-01-08","3.987","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","253","2026-01-07","1.021","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":305},{"label":"Fev","value":602},{"label":"Mar","value":622},{"label":"Abr","value":388},{"label":"Mai","value":544},{"label":"Jun","value":304},{"label":"Jul","value":451},{"label":"Ago","value":677},{"label":"Set","value":471},{"label":"Out","value":305},{"label":"Nov","value":638},{"label":"Dez","value":450}];
const MX = 677;
