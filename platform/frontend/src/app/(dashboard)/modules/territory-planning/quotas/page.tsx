...
const PAGE = "Quota Assign";
const KPIS = [{"l":"Vendas YTD (€)","v":"€64196","t":"+9.7%","d":"up"},{"l":"Pipeline (€)","v":"€32660","t":"+2.7%","d":"up"},{"l":"Atingimento Quota (%)","v":"85.4%","t":"+8.0%","d":"up"},{"l":"Win Rate (%)","v":"79.3%","t":"-5.1%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 22176.71","€ 1870.86","€ 20371.31","80.1%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 33193.99","€ 5645.65","€ 10414.98","95.4%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 28114.58","€ 47420.61","€ 24213.94","97.2%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 1802.82","€ 45976.00","€ 48680.44","96.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 16663.30","€ 2270.68","€ 11955.77","98.8%"],"status":"active"}];
const CHART = [{"label":"Jan","value":277},{"label":"Fev","value":438},{"label":"Mar","value":343},{"label":"Abr","value":613},{"label":"Mai","value":303},{"label":"Jun","value":544},{"label":"Jul","value":226},{"label":"Ago","value":337},{"label":"Set","value":325},{"label":"Out","value":453},{"label":"Nov","value":441},{"label":"Dez","value":554}];
const MX = 613;
