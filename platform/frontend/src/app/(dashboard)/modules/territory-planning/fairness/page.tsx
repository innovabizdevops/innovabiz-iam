...
const PAGE = "Fairness Score";
const KPIS = [{"l":"Vendas YTD (€)","v":"€36954","t":"+14.5%","d":"up"},{"l":"Pipeline (€)","v":"€16109","t":"-1.9%","d":"down"},{"l":"Atingimento Quota (%)","v":"71.4%","t":"+14.1%","d":"up"},{"l":"Win Rate (%)","v":"65.3%","t":"+10.6%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 38813.19","€ 13494.67","€ 30894.22","70.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 29076.69","€ 45801.27","€ 5671.95","81.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 10233.00","€ 39477.35","€ 34991.00","75.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 21566.96","€ 40252.18","€ 26250.66","88.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 18698.34","€ 46109.80","€ 20308.31","93.3%"],"status":"active"}];
const CHART = [{"label":"Jan","value":549},{"label":"Fev","value":631},{"label":"Mar","value":605},{"label":"Abr","value":535},{"label":"Mai","value":416},{"label":"Jun","value":362},{"label":"Jul","value":340},{"label":"Ago","value":622},{"label":"Set","value":333},{"label":"Out","value":497},{"label":"Nov","value":643},{"label":"Dez","value":675}];
const MX = 675;
