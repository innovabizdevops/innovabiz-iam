...
const KPIS = [{"l":"Vendas YTD (€)","v":"€83479","t":"+7.5%","d":"up"},{"l":"Pipeline (€)","v":"€57576","t":"+10.0%","d":"up"},{"l":"Atingimento Quota (%)","v":"74.1%","t":"+10.3%","d":"up"},{"l":"Win Rate (%)","v":"83.7%","t":"-5.2%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 24350.21","€ 2791.53","€ 1085.30","97.5%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 6361.88","€ 29836.39","€ 24509.22","79.4%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 25485.79","€ 48825.27","€ 40599.09","86.5%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 48855.20","€ 2265.11","€ 24026.69","75.2%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 12405.92","€ 24167.11","€ 4075.71","84.1%"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":632},{"label":"Mar","value":479},{"label":"Abr","value":455},{"label":"Mai","value":522},{"label":"Jun","value":521},{"label":"Jul","value":662},{"label":"Ago","value":489},{"label":"Set","value":350},{"label":"Out","value":683},{"label":"Nov","value":470},{"label":"Dez","value":385}];
const MX = 683;
