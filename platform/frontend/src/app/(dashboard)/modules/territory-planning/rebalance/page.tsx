...
const ACCENT = "#7c3aed";
const MODULE = "Territory Planning";
const PAGE = "Rebalance AI";
const KPIS = [{"l":"Vendas YTD (€)","v":"€32712","t":"-2.0%","d":"down"},{"l":"Pipeline (€)","v":"€2089","t":"+3.0%","d":"up"},{"l":"Atingimento Quota (%)","v":"73.5%","t":"+17.3%","d":"up"},{"l":"Win Rate (%)","v":"68.6%","t":"+2.7%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 44976.07","€ 25452.39","€ 31690.60","83.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 35888.14","€ 14550.10","€ 28543.95","86.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 16195.88","€ 34471.30","€ 44862.33","76.6%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 4809.28","€ 22576.57","€ 13060.82","85.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 42620.05","€ 12504.96","€ 44513.40","99.1%"],"status":"active"}];
const CHART = [{"label":"Jan","value":225},{"label":"Fev","value":419},{"label":"Mar","value":283},{"label":"Abr","value":583},{"label":"Mai","value":391},{"label":"Jun","value":362},{"label":"Jul","value":505},{"label":"Ago","value":562},{"label":"Set","value":408},{"label":"Out","value":348},{"label":"Nov","value":455},{"label":"Dez","value":582}];
const MX = 583;
