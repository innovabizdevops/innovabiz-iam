...
const KPIS = [{"l":"Vendas YTD (€)","v":"€40639","t":"+0.3%","d":"up"},{"l":"Pipeline (€)","v":"€64944","t":"+15.4%","d":"up"},{"l":"Atingimento Quota (%)","v":"86.3%","t":"+12.5%","d":"up"},{"l":"Win Rate (%)","v":"80.6%","t":"-4.3%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 10643.40","€ 49609.38","€ 39698.28","96.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 43452.52","€ 6050.51","€ 25976.52","72.3%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 4451.73","€ 7466.65","€ 6035.83","76.8%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 12982.71","€ 4036.65","€ 5127.65","83.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 23292.10","€ 13854.33","€ 18290.13","90.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":730},{"label":"Mar","value":558},{"label":"Abr","value":431},{"label":"Mai","value":501},{"label":"Jun","value":487},{"label":"Jul","value":660},{"label":"Ago","value":603},{"label":"Set","value":770},{"label":"Out","value":778},{"label":"Nov","value":794},{"label":"Dez","value":564}];
const MX = 794;
