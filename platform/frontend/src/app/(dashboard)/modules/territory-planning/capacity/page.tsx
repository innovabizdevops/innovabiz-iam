...
const PAGE = "Rep Capacity";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.852","t":"+16.0%","d":"up"},{"l":"NC Abertas","v":"6.786","t":"-5.1%","d":"down"},{"l":"Conformidade (%)","v":"65.3%","t":"+9.5%","d":"up"},{"l":"CAPAs Pendentes","v":"8.182","t":"-2.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.610","95.3%","4.834","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.544","72.4%","6.248","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.994","91.5%","1.579","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.284","76.3%","5.759","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.148","75.4%","4.628","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":567},{"label":"Mar","value":406},{"label":"Abr","value":393},{"label":"Mai","value":552},{"label":"Jun","value":668},{"label":"Jul","value":538},{"label":"Ago","value":683},{"label":"Set","value":368},{"label":"Out","value":339},{"label":"Nov","value":500},{"label":"Dez","value":338}];
const MX = 683;
