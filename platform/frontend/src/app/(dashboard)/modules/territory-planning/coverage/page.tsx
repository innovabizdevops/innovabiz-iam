...
const PAGE = "Coverage Model";
const KPIS = [{"l":"Vendas YTD (€)","v":"€2088","t":"-4.3%","d":"down"},{"l":"Pipeline (€)","v":"€85368","t":"+7.0%","d":"up"},{"l":"Atingimento Quota (%)","v":"91.9%","t":"+10.7%","d":"up"},{"l":"Win Rate (%)","v":"71.2%","t":"-2.7%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 18944.34","€ 28974.90","€ 8501.39","74.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 16863.42","€ 46513.79","€ 25330.28","94.0%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 20913.91","€ 13699.50","€ 5598.81","99.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 7395.06","€ 40538.49","€ 15538.21","93.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 10152.98","€ 42812.71","€ 7497.23","77.8%"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":615},{"label":"Mar","value":963},{"label":"Abr","value":978},{"label":"Mai","value":720},{"label":"Jun","value":739},{"label":"Jul","value":859},{"label":"Ago","value":830},{"label":"Set","value":978},{"label":"Out","value":808},{"label":"Nov","value":823},{"label":"Dez","value":923}];
const MX = 978;
