...
const PAGE = "Rule";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.474","t":"+12.6%","d":"up"},{"l":"NC Abertas","v":"3.453","t":"+13.1%","d":"up"},{"l":"Conformidade (%)","v":"65.4%","t":"-3.2%","d":"down"},{"l":"CAPAs Pendentes","v":"1.714","t":"+5.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.020","77.3%","6.715","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.510","81.8%","537","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","404","92.6%","5.497","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.756","97.1%","3.822","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.290","79.7%","5.894","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":327},{"label":"Fev","value":270},{"label":"Mar","value":421},{"label":"Abr","value":482},{"label":"Mai","value":476},{"label":"Jun","value":637},{"label":"Jul","value":593},{"label":"Ago","value":451},{"label":"Set","value":440},{"label":"Out","value":582},{"label":"Nov","value":617},{"label":"Dez","value":610}];
const MX = 637;
