...
/* ═══ Data Quality Deep — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "6896", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3129", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€268K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1896391396", cells: ["DAT-2396", "Data Quality Deep Item 1", "5/5/2026", "€41 496"], status: "active" as const },
    { id: "1896394967", cells: ["DAT-5967", "Data Quality Deep Item 2", "20/12/2026", "€45 067"], status: "pending" as const },
    { id: "1896398538", cells: ["DAT-9538", "Data Quality Deep Item 3", "7/7/2026", "€48 638"], status: "completed" as const },
    { id: "1896402109", cells: ["DAT-4109", "Data Quality Deep Item 4", "22/2/2026", "€2209"], status: "warning" as const },
    { id: "1896405680", cells: ["DAT-7680", "Data Quality Deep Item 5", "9/9/2026", "€5780"], status: "active" as const },
];
...
export default function DataQualityDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Quality Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Quality Deep</p>
                    </div>
                </div>
