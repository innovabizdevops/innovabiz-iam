...
const ACCENT = "#1e3a5f";
const MODULE = "Data Quality Deep";
const PAGE = "Cleanse";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.905","t":"+15.6%","d":"up"},{"l":"NC Abertas","v":"7.165","t":"-5.8%","d":"down"},{"l":"Conformidade (%)","v":"70.5%","t":"+0.3%","d":"up"},{"l":"CAPAs Pendentes","v":"2.325","t":"+6.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.653","89.8%","6.519","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.130","82.2%","7.495","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.462","76.7%","2.429","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.641","93.1%","8.032","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.813","91.5%","3.649","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":544},{"label":"Mar","value":625},{"label":"Abr","value":710},{"label":"Mai","value":772},{"label":"Jun","value":581},{"label":"Jul","value":534},{"label":"Ago","value":465},{"label":"Set","value":545},{"label":"Out","value":828},{"label":"Nov","value":672},{"label":"Dez","value":460}];
const MX = 828;
