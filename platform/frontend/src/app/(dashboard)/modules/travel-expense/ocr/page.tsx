...
const PAGE = "Receipt OCR";
const KPIS = [{"l":"Total Travel Expense","v":"6.066","t":"+16.0%","d":"up"},{"l":"Receipt OCR Ativos","v":"1.435","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"77.9%","t":"+9.6%","d":"up"},{"l":"Score Performance","v":"70","t":"-1.5%","d":"down"}];
const COLS = ["ID","Receipt OCR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Travel Expense #001","Travel Expense #002","2.070","1.868","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Travel Expense #002","Travel Expense #003","6.038","5.239","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Travel Expense #003","Travel Expense #004","3.401","7.694","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Travel Expense #004","Travel Expense #005","3.433","2.691","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Travel Expense #005","Travel Expense #001","6.912","171","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":853},{"label":"Mar","value":894},{"label":"Abr","value":836},{"label":"Mai","value":767},{"label":"Jun","value":545},{"label":"Jul","value":686},{"label":"Ago","value":696},{"label":"Set","value":540},{"label":"Out","value":602},{"label":"Nov","value":901},{"label":"Dez","value":690}];
const MX = 901;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#f59e0b'}}>AI</span></h1>
                </div>
