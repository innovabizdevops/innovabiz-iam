...
const KPIS = [{"l":"Projetos Melhoria","v":"1.985","t":"+6.8%","d":"up"},{"l":"Savings (€)","v":"€47027","t":"+17.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"91.9%","t":"+10.1%","d":"up"},{"l":"Ciclos PDCA","v":"8.144","t":"+10.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.436","€ 33495.10","7.234","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","501","€ 25571.98","6.267","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.417","€ 29944.87","7.271","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.780","€ 40680.57","242","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.813","€ 46530.80","8.243","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":851},{"label":"Fev","value":886},{"label":"Mar","value":704},{"label":"Abr","value":790},{"label":"Mai","value":597},{"label":"Jun","value":834},{"label":"Jul","value":661},{"label":"Ago","value":534},{"label":"Set","value":625},{"label":"Out","value":545},{"label":"Nov","value":697},{"label":"Dez","value":690}];
const MX = 886;
