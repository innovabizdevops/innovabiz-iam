...
const PAGE = "Policy Engine";
const KPIS = [{"l":"Total Travel Expense","v":"4.887","t":"+2.7%","d":"up"},{"l":"Policy Engine Ativos","v":"6.515","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"70.9%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"72","t":"-3.2%","d":"down"}];
const COLS = ["ID","Policy Engine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Travel Expense #001","Travel Expense #002","6.228","5.389","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Travel Expense #002","Travel Expense #003","1.462","5.899","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Travel Expense #003","Travel Expense #004","8.367","8.837","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Travel Expense #004","Travel Expense #005","2.334","8.968","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Travel Expense #005","Travel Expense #001","3.941","7.708","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":426},{"label":"Fev","value":640},{"label":"Mar","value":433},{"label":"Abr","value":677},{"label":"Mai","value":617},{"label":"Jun","value":743},{"label":"Jul","value":565},{"label":"Ago","value":629},{"label":"Set","value":439},{"label":"Out","value":717},{"label":"Nov","value":582},{"label":"Dez","value":471}];
const MX = 743;
