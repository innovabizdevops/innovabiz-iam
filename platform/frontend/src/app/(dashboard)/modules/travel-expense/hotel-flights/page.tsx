...
const PAGE = "Hotel &amp; Flights";
const KPIS = [{"l":"Quartos Ocupados","v":"8.843","t":"-2.9%","d":"down"},{"l":"RevPAR (€)","v":"€26876","t":"+12.5%","d":"up"},{"l":"Ocupação (%)","v":"65.9%","t":"-0.9%","d":"down"},{"l":"Guest Satisfaction","v":"7.180","t":"+1.6%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.310","2026-01-27","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.494","2026-03-05","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","4.878","2026-02-24","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","2.031","2026-01-21","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.823","2026-02-12","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":317},{"label":"Fev","value":480},{"label":"Mar","value":540},{"label":"Abr","value":647},{"label":"Mai","value":397},{"label":"Jun","value":454},{"label":"Jul","value":321},{"label":"Ago","value":583},{"label":"Set","value":371},{"label":"Out","value":665},{"label":"Nov","value":376},{"label":"Dez","value":407}];
const MX = 665;
...
export default function HotelFlightsPage() {
    return (
