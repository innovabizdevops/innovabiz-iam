...
const KPIS = [{"l":"Aprovações Pendentes","v":"5.532","t":"+15.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"67.6%","t":"+14.4%","d":"up"},{"l":"Tempo Médio (h)","v":"29h","t":"+6.3%","d":"up"},{"l":"Rejeitadas (%)","v":"77.7%","t":"+0.7%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","1.687","€ 47724.25","3.380","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","8.604","€ 3355.50","7.121","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","1.550","€ 47441.62","8.800","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","467","€ 18020.96","4.480","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","5.811","€ 10600.59","2.645","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":363},{"label":"Fev","value":577},{"label":"Mar","value":472},{"label":"Abr","value":417},{"label":"Mai","value":238},{"label":"Jun","value":393},{"label":"Jul","value":325},{"label":"Ago","value":504},{"label":"Set","value":270},{"label":"Out","value":511},{"label":"Nov","value":585},{"label":"Dez","value":348}];
const MX = 585;
