...
const ACCENT = "#f59e0b";
const MODULE = "Travel & Expense";
const PAGE = "Mileage Tracker";
const KPIS = [{"l":"Total Travel Expense","v":"5.218","t":"+2.6%","d":"up"},{"l":"Mileage Tracker Ativos","v":"7.492","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"89.3%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"63","t":"+4.5%","d":"up"}];
const COLS = ["ID","Mileage Tracker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Travel Expense #001","Travel Expense #002","3.165","2.657","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Travel Expense #002","Travel Expense #003","5.068","5.569","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Travel Expense #003","Travel Expense #004","5.074","3.566","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Travel Expense #004","Travel Expense #005","3.244","6.976","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Travel Expense #005","Travel Expense #001","2.196","1.630","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":450},{"label":"Fev","value":596},{"label":"Mar","value":550},{"label":"Abr","value":586},{"label":"Mai","value":694},{"label":"Jun","value":696},{"label":"Jul","value":342},{"label":"Ago","value":405},{"label":"Set","value":392},{"label":"Out","value":338},{"label":"Nov","value":684},{"label":"Dez","value":600}];
const MX = 696;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#f59e0b'}}>GPS</span></h1>
                </div>
