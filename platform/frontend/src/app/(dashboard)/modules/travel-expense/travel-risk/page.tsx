...
const PAGE = "Travel Risk";
const KPIS = [{"l":"Riscos Identificados","v":"3.732","t":"-5.8%","d":"down"},{"l":"Mitigações Ativas","v":"8.192","t":"+15.4%","d":"up"},{"l":"Score Risco Geral","v":"60","t":"+17.1%","d":"up"},{"l":"Incidentes YTD","v":"6.829","t":"+10.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.728","550","7.527","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","965","5.250","2.733","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.463","6.806","7.908","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","383","6.814","4.848","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","865","462","7.890","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":796},{"label":"Fev","value":726},{"label":"Mar","value":597},{"label":"Abr","value":628},{"label":"Mai","value":528},{"label":"Jun","value":678},{"label":"Jul","value":657},{"label":"Ago","value":752},{"label":"Set","value":770},{"label":"Out","value":742},{"label":"Nov","value":522},{"label":"Dez","value":535}];
const MX = 796;
