...
const PAGE = "Per Diem";
const KPIS = [{"l":"Ideias Submetidas","v":"5.319","t":"+4.8%","d":"up"},{"l":"Patentes (YTD)","v":"6.686","t":"+13.9%","d":"up"},{"l":"Projetos Innovation Lab","v":"4.292","t":"+3.3%","d":"up"},{"l":"Budget I&D (€M)","v":"€2.3M","t":"+10.8%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","3.408","71.5%","2.718","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","4.292","70.9%","3.701","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","7.025","86.1%","7.960","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","1.283","86.6%","3.982","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","7.259","91.4%","4.988","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":755},{"label":"Mar","value":831},{"label":"Abr","value":856},{"label":"Mai","value":673},{"label":"Jun","value":782},{"label":"Jul","value":815},{"label":"Ago","value":667},{"label":"Set","value":884},{"label":"Out","value":880},{"label":"Nov","value":819},{"label":"Dez","value":748}];
const MX = 884;
