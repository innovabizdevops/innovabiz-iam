...
const PAGE = "Travel Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"3.327","t":"+8.8%","d":"up"},{"l":"RevPAR (€)","v":"€99474","t":"+4.3%","d":"up"},{"l":"Ocupação (%)","v":"76.6%","t":"+14.3%","d":"up"},{"l":"Guest Satisfaction","v":"8.229","t":"+3.8%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","1.321","2026-03-22","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.183","2026-03-19","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.707","2026-02-05","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","2.620","2026-03-21","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.523","2026-03-19","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":613},{"label":"Mar","value":575},{"label":"Abr","value":485},{"label":"Mai","value":703},{"label":"Jun","value":382},{"label":"Jul","value":710},{"label":"Ago","value":639},{"label":"Set","value":522},{"label":"Out","value":723},{"label":"Nov","value":533},{"label":"Dez","value":438}];
const MX = 723;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#f59e0b'}}>New</span></h1>
                </div>
