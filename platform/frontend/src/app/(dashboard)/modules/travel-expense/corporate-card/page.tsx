...
const PAGE = "Corporate Card Integration";
const KPIS = [{"l":"Integrações Ativas","v":"7.499","t":"+5.6%","d":"up"},{"l":"Chamadas/Hora","v":"3533","t":"+9.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"75.7%","t":"+10.7%","d":"up"},{"l":"Latência Média (ms)","v":"120ms","t":"+0.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.865","685","82.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.226","298","78.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.263","6.573","94.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.031","2.657","99.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.592","3.142","75.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":625},{"label":"Mar","value":840},{"label":"Abr","value":676},{"label":"Mai","value":911},{"label":"Jun","value":816},{"label":"Jul","value":706},{"label":"Ago","value":700},{"label":"Set","value":690},{"label":"Out","value":614},{"label":"Nov","value":812},{"label":"Dez","value":736}];
const MX = 911;
