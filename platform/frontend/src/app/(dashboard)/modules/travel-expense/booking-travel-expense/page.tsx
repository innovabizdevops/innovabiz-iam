...
const PAGE = "Trip Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"4.470","t":"+11.4%","d":"up"},{"l":"RevPAR (€)","v":"€16522","t":"+11.9%","d":"up"},{"l":"Ocupação (%)","v":"75.7%","t":"+0.4%","d":"up"},{"l":"Guest Satisfaction","v":"1.447","t":"+4.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.480","2026-03-21","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.866","2026-02-10","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","242","2026-01-15","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","150","2026-01-18","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.218","2026-02-28","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":389},{"label":"Fev","value":295},{"label":"Mar","value":356},{"label":"Abr","value":489},{"label":"Mai","value":429},{"label":"Jun","value":450},{"label":"Jul","value":457},{"label":"Ago","value":613},{"label":"Set","value":539},{"label":"Out","value":497},{"label":"Nov","value":299},{"label":"Dez","value":587}];
const MX = 613;
...
export default function BookingTravelExpensePage() {
    return (
