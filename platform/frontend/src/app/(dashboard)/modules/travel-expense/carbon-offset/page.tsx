...
const KPIS = [{"l":"Total Travel Expense","v":"6.679","t":"+17.5%","d":"up"},{"l":"Carbon Offset Ativos","v":"951","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"72.5%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"89","t":"+2.3%","d":"up"}];
const COLS = ["ID","Carbon Offset","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Travel Expense #001","Travel Expense #002","1.779","6.458","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Travel Expense #002","Travel Expense #003","2.142","6.854","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Travel Expense #003","Travel Expense #004","6.710","4.899","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Travel Expense #004","Travel Expense #005","7.979","5.565","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Travel Expense #005","Travel Expense #001","8.863","6.149","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":590},{"label":"Mar","value":508},{"label":"Abr","value":699},{"label":"Mai","value":578},{"label":"Jun","value":457},{"label":"Jul","value":434},{"label":"Ago","value":493},{"label":"Set","value":337},{"label":"Out","value":527},{"label":"Nov","value":572},{"label":"Dez","value":667}];
const MX = 699;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#f59e0b'}}>ESG</span></h1>
                </div>
