...
const PAGE = "Travel Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"6.554","t":"+3.3%","d":"up"},{"l":"Queries/Dia","v":"4314","t":"+7.5%","d":"up"},{"l":"Dados Processados (GB)","v":"2.206","t":"+12.2%","d":"up"},{"l":"Utilizadores Analytics","v":"7.977","t":"-1.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1078","2026-03-16","4.305","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1066","2026-02-16","8.003","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","424","2026-01-26","1.083","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2954","2026-02-21","380","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2288","2026-03-26","2.426","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":401},{"label":"Fev","value":399},{"label":"Mar","value":749},{"label":"Abr","value":672},{"label":"Mai","value":432},{"label":"Jun","value":665},{"label":"Jul","value":579},{"label":"Ago","value":505},{"label":"Set","value":474},{"label":"Out","value":443},{"label":"Nov","value":553},{"label":"Dez","value":690}];
const MX = 749;
