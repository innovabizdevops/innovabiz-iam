...
const PAGE = "Expense Reports";
const KPIS = [{"l":"Total Travel Expense","v":"4.849","t":"+4.5%","d":"up"},{"l":"Expense Reports Ativos","v":"869","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"77.9%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"86","t":"+6.2%","d":"up"}];
const COLS = ["ID","Expense Reports","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Travel Expense #001","Travel Expense #002","7.506","5.131","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Travel Expense #002","Travel Expense #003","1.512","1.071","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Travel Expense #003","Travel Expense #004","2.732","5.437","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Travel Expense #004","Travel Expense #005","4.023","496","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Travel Expense #005","Travel Expense #001","1.849","1.374","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":496},{"label":"Fev","value":682},{"label":"Mar","value":660},{"label":"Abr","value":457},{"label":"Mai","value":558},{"label":"Jun","value":533},{"label":"Jul","value":661},{"label":"Ago","value":425},{"label":"Set","value":445},{"label":"Out","value":383},{"label":"Nov","value":388},{"label":"Dez","value":507}];
const MX = 682;
...
export default function ReportsTravelExpensePage() {
    return (
