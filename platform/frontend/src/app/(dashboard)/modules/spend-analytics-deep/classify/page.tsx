...
const ACCENT = "#78350f";
const MODULE = "Spend Analytics Deep";
const PAGE = "Classify";
const KPIS = [{"l":"Dashboards Ativos","v":"9.046","t":"+14.3%","d":"up"},{"l":"Queries/Dia","v":"2599","t":"-1.3%","d":"down"},{"l":"Dados Processados (GB)","v":"3.228","t":"-0.7%","d":"down"},{"l":"Utilizadores Analytics","v":"2.123","t":"+9.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1720","2026-03-28","1.528","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3725","2026-01-05","1.122","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2266","2026-03-21","6.284","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2685","2026-03-25","665","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2280","2026-01-26","5.543","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":952},{"label":"Mar","value":814},{"label":"Abr","value":934},{"label":"Mai","value":941},{"label":"Jun","value":904},{"label":"Jul","value":785},{"label":"Ago","value":776},{"label":"Set","value":882},{"label":"Out","value":972},{"label":"Nov","value":879},{"label":"Dez","value":640}];
const MX = 972;
