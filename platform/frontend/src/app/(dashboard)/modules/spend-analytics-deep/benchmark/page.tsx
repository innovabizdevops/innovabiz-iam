...
const KPIS = [{"l":"Dashboards Ativos","v":"1.017","t":"+12.9%","d":"up"},{"l":"Queries/Dia","v":"3584","t":"+8.5%","d":"up"},{"l":"Dados Processados (GB)","v":"3.462","t":"-3.3%","d":"down"},{"l":"Utilizadores Analytics","v":"8.401","t":"+9.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1116","2026-03-06","381","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","569","2026-03-13","8.350","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4716","2026-03-15","626","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4951","2026-01-22","370","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2362","2026-03-18","8.656","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":288},{"label":"Fev","value":309},{"label":"Mar","value":430},{"label":"Abr","value":469},{"label":"Mai","value":275},{"label":"Jun","value":519},{"label":"Jul","value":284},{"label":"Ago","value":427},{"label":"Set","value":545},{"label":"Out","value":418},{"label":"Nov","value":333},{"label":"Dez","value":310}];
const MX = 545;
