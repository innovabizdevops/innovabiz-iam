...
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"1.241","t":"+2.8%","d":"up"},{"l":"Queries/Dia","v":"4688","t":"+9.2%","d":"up"},{"l":"Dados Processados (GB)","v":"8.569","t":"+4.6%","d":"up"},{"l":"Utilizadores Analytics","v":"622","t":"+1.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2738","2026-01-20","7.091","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2581","2026-01-03","4.590","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1679","2026-03-16","3.661","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","932","2026-02-12","6.811","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2716","2026-03-05","5.446","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":860},{"label":"Mar","value":907},{"label":"Abr","value":923},{"label":"Mai","value":923},{"label":"Jun","value":862},{"label":"Jul","value":716},{"label":"Ago","value":881},{"label":"Set","value":794},{"label":"Out","value":799},{"label":"Nov","value":676},{"label":"Dez","value":761}];
const MX = 923;
