...
const PAGE = "Savings";
const KPIS = [{"l":"Dashboards Ativos","v":"5.413","t":"+10.9%","d":"up"},{"l":"Queries/Dia","v":"647","t":"+1.0%","d":"up"},{"l":"Dados Processados (GB)","v":"1.517","t":"+12.8%","d":"up"},{"l":"Utilizadores Analytics","v":"6.820","t":"+16.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","520","2026-03-25","2.111","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","652","2026-02-06","336","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","945","2026-01-10","8.714","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2097","2026-03-13","9.009","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","160","2026-02-13","443","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":542},{"label":"Mar","value":766},{"label":"Abr","value":856},{"label":"Mai","value":566},{"label":"Jun","value":755},{"label":"Jul","value":811},{"label":"Ago","value":908},{"label":"Set","value":821},{"label":"Out","value":752},{"label":"Nov","value":851},{"label":"Dez","value":689}];
const MX = 908;
