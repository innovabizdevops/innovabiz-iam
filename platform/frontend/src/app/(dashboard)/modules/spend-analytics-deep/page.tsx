...
/* ═══ Spend Analytics Deep — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "2551", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4551", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€96K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "-9%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "369183351", cells: ["SPE-4351", "Spend Analytics Deep Item 1", "20/4/2026", "€33 451"], status: "active" as const },
    { id: "369186922", cells: ["SPE-7922", "Spend Analytics Deep Item 2", "7/11/2026", "€37 022"], status: "pending" as const },
    { id: "369190493", cells: ["SPE-2493", "Spend Analytics Deep Item 3", "22/6/2026", "€40 593"], status: "completed" as const },
    { id: "369194064", cells: ["SPE-6064", "Spend Analytics Deep Item 4", "9/1/2026", "€44 164"], status: "warning" as const },
    { id: "369197635", cells: ["SPE-9635", "Spend Analytics Deep Item 5", "24/8/2026", "€47 735"], status: "active" as const },
];
...
export default function SpendAnalyticsDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Spend Analytics Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Spend Analytics Deep</p>
                    </div>
                </div>
