...
const PAGE = "Report";
const KPIS = [{"l":"Dashboards Ativos","v":"6.699","t":"+16.2%","d":"up"},{"l":"Queries/Dia","v":"2988","t":"+13.0%","d":"up"},{"l":"Dados Processados (GB)","v":"5.383","t":"+7.5%","d":"up"},{"l":"Utilizadores Analytics","v":"3.644","t":"+4.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2001","2026-03-23","935","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1534","2026-01-04","1.831","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3185","2026-03-26","6.169","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4295","2026-02-07","5.211","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4213","2026-01-14","8.050","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":847},{"label":"Mar","value":844},{"label":"Abr","value":775},{"label":"Mai","value":611},{"label":"Jun","value":721},{"label":"Jul","value":876},{"label":"Ago","value":903},{"label":"Set","value":791},{"label":"Out","value":776},{"label":"Nov","value":606},{"label":"Dez","value":865}];
const MX = 903;
