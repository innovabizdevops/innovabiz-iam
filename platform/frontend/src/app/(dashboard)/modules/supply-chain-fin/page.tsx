...
/* ═══ Supply Chain FinTech — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "9364", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2885", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€139K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2132251464", cells: ["SUP-8464", "Supply Chain FinTech Item 1", "1/1/2026", "€1564"], status: "active" as const },
    { id: "2132255035", cells: ["SUP-3035", "Supply Chain FinTech Item 2", "16/8/2026", "€5135"], status: "pending" as const },
    { id: "2132258606", cells: ["SUP-6606", "Supply Chain FinTech Item 3", "3/3/2026", "€8706"], status: "completed" as const },
    { id: "2132262177", cells: ["SUP-1177", "Supply Chain FinTech Item 4", "18/10/2026", "€12 277"], status: "warning" as const },
    { id: "2132265748", cells: ["SUP-4748", "Supply Chain FinTech Item 5", "5/5/2026", "€15 848"], status: "active" as const },
];
...
export default function SupplyChainFintechPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Supply Chain FinTech</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Supply Chain FinTech</p>
                    </div>
                </div>
