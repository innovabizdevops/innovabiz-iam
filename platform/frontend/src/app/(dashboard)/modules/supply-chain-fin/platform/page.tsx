...
const PAGE = "Platform";
const KPIS = [{"l":"Formulários Ativos","v":"537","t":"+5.7%","d":"up"},{"l":"Submissões/Dia","v":"3189","t":"-4.9%","d":"down"},{"l":"Documentos Gerados","v":"1.954","t":"+2.0%","d":"up"},{"l":"Templates","v":"868","t":"+13.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.897","2026-02-18","762","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.847","2026-02-28","7.030","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.636","2026-03-07","3.230","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.277","2026-02-03","7.381","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.046","2026-01-04","4.011","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":751},{"label":"Mar","value":665},{"label":"Abr","value":867},{"label":"Mai","value":892},{"label":"Jun","value":827},{"label":"Jul","value":676},{"label":"Ago","value":655},{"label":"Set","value":738},{"label":"Out","value":523},{"label":"Nov","value":665},{"label":"Dez","value":811}];
const MX = 892;
