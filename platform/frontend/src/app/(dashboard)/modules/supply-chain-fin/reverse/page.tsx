...
const ACCENT = "#0891b2";
const MODULE = "Supply Chain FinTech";
const PAGE = "Reverse Factor";
const KPIS = [{"l":"Total Supply Chain Fin","v":"3.532","t":"+10.5%","d":"up"},{"l":"Reverse Factor Ativos","v":"8.875","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"65.9%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"71","t":"-1.6%","d":"down"}];
const COLS = ["ID","Reverse Factor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Supply Chain Fin #001","Supply Chain Fin #002","4.337","4.063","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Supply Chain Fin #002","Supply Chain Fin #003","1.957","7.735","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Supply Chain Fin #003","Supply Chain Fin #004","7.646","6.784","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Supply Chain Fin #004","Supply Chain Fin #005","1.075","2.408","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Supply Chain Fin #005","Supply Chain Fin #001","8.836","5.827","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1029},{"label":"Fev","value":876},{"label":"Mar","value":941},{"label":"Abr","value":959},{"label":"Mai","value":823},{"label":"Jun","value":907},{"label":"Jul","value":865},{"label":"Ago","value":830},{"label":"Set","value":863},{"label":"Out","value":637},{"label":"Nov","value":687},{"label":"Dez","value":1027}];
const MX = 1029;
