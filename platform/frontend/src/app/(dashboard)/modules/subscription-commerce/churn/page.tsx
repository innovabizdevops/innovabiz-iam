...
const ACCENT = "#881337";
const MODULE = "Subscription Commerce";
const PAGE = "Churn Analysis";
const KPIS = [{"l":"Pedidos/Dia","v":"2047","t":"+17.8%","d":"up"},{"l":"GMV (€)","v":"€53380","t":"-3.7%","d":"down"},{"l":"Conversão (%)","v":"93.1%","t":"+10.7%","d":"up"},{"l":"AOV (€)","v":"€22222","t":"+1.6%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 43827.99","510","1.889","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 42659.47","6.816","2.107","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 10868.38","1.031","6.596","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 31034.14","4.491","8.607","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 48630.34","6.139","7.172","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":655},{"label":"Mar","value":743},{"label":"Abr","value":544},{"label":"Mai","value":693},{"label":"Jun","value":605},{"label":"Jul","value":564},{"label":"Ago","value":513},{"label":"Set","value":818},{"label":"Out","value":610},{"label":"Nov","value":819},{"label":"Dez","value":824}];
const MX = 824;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#881337'}}>AI</span></h1>
                </div>
