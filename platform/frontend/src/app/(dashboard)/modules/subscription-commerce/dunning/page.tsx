...
const PAGE = "Dunning Mgmt";
const KPIS = [{"l":"Pedidos/Dia","v":"4242","t":"+12.2%","d":"up"},{"l":"GMV (€)","v":"€98488","t":"+4.9%","d":"up"},{"l":"Conversão (%)","v":"88.0%","t":"+5.6%","d":"up"},{"l":"AOV (€)","v":"€64742","t":"-0.5%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 14228.12","8.749","1.527","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 34788.79","6.880","1.611","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 2290.77","2.538","1.053","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 35546.50","614","4.617","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 37717.19","4.060","4.072","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":562},{"label":"Mar","value":683},{"label":"Abr","value":549},{"label":"Mai","value":751},{"label":"Jun","value":710},{"label":"Jul","value":637},{"label":"Ago","value":815},{"label":"Set","value":614},{"label":"Out","value":741},{"label":"Nov","value":770},{"label":"Dez","value":599}];
const MX = 815;
