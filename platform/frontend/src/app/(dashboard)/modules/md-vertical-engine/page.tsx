...
/* ═══ MD: Multi-Vertical Engine — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "7502", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "953", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€98K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "436567702", cells: ["MD-5702", "MD: Multi-Vertical Engine Item 1", "19/11/2026", "€17 802"], status: "active" as const },
    { id: "436571273", cells: ["MD-9273", "MD: Multi-Vertical Engine Item 2", "6/6/2026", "€21 373"], status: "pending" as const },
    { id: "436574844", cells: ["MD-3844", "MD: Multi-Vertical Engine Item 3", "21/1/2026", "€24 944"], status: "completed" as const },
    { id: "436578415", cells: ["MD-7415", "MD: Multi-Vertical Engine Item 4", "8/8/2026", "€28 515"], status: "warning" as const },
    { id: "436581986", cells: ["MD-1986", "MD: Multi-Vertical Engine Item 5", "23/3/2026", "€32 086"], status: "active" as const },
];
...
export default function MdMultiverticalEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Vertical Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Vertical Engine</p>
                    </div>
                </div>
