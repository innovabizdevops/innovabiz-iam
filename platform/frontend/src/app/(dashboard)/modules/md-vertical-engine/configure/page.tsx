...
const KPIS = [{"l":"Configurações","v":"4.569","t":"-0.6%","d":"down"},{"l":"Últimas Alterações","v":"3.119","t":"+13.3%","d":"up"},{"l":"Ambientes","v":"3.461","t":"+16.9%","d":"up"},{"l":"Versão Config","v":"2.124","t":"+1.3%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 8131.19","139","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 20377.85","3.335","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 20807.74","2.473","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 9245.42","1.799","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 2885.61","5.873","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":590},{"label":"Mar","value":561},{"label":"Abr","value":577},{"label":"Mai","value":680},{"label":"Jun","value":626},{"label":"Jul","value":872},{"label":"Ago","value":628},{"label":"Set","value":737},{"label":"Out","value":864},{"label":"Nov","value":826},{"label":"Dez","value":773}];
const MX = 872;
