...
const KPIS = [{"l":"Configurações","v":"5.546","t":"+6.3%","d":"up"},{"l":"Últimas Alterações","v":"6.909","t":"-0.1%","d":"down"},{"l":"Ambientes","v":"7.880","t":"+11.2%","d":"up"},{"l":"Versão Config","v":"7.628","t":"+4.7%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 39729.17","5.453","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 40342.68","6.945","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 359.57","1.770","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 37347.85","2.289","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 16926.27","3.580","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":916},{"label":"Fev","value":682},{"label":"Mar","value":848},{"label":"Abr","value":972},{"label":"Mai","value":851},{"label":"Jun","value":682},{"label":"Jul","value":637},{"label":"Ago","value":974},{"label":"Set","value":769},{"label":"Out","value":913},{"label":"Nov","value":1033},{"label":"Dez","value":794}];
const MX = 1033;
