...
const ACCENT = "#6366f1";
const MODULE = "BIM Platform";
const PAGE = "Model";
const KPIS = [{"l":"Formulários Ativos","v":"3.963","t":"+6.1%","d":"up"},{"l":"Submissões/Dia","v":"2684","t":"+5.9%","d":"up"},{"l":"Documentos Gerados","v":"1.460","t":"+13.9%","d":"up"},{"l":"Templates","v":"5.267","t":"+2.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.444","2026-02-26","1.974","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","157","2026-02-14","4.929","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","330","2026-03-14","246","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.169","2026-02-09","5.302","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.642","2026-02-11","4.412","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":836},{"label":"Fev","value":946},{"label":"Mar","value":631},{"label":"Abr","value":878},{"label":"Mai","value":807},{"label":"Jun","value":810},{"label":"Jul","value":905},{"label":"Ago","value":730},{"label":"Set","value":806},{"label":"Out","value":943},{"label":"Nov","value":806},{"label":"Dez","value":730}];
const MX = 946;
