...
const KPIS = [{"l":"Formulários Ativos","v":"3.845","t":"+10.1%","d":"up"},{"l":"Submissões/Dia","v":"1428","t":"+17.0%","d":"up"},{"l":"Documentos Gerados","v":"4.491","t":"+0.2%","d":"up"},{"l":"Templates","v":"2.708","t":"-5.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","9.038","2026-02-23","3.212","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.522","2026-01-09","8.440","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.726","2026-02-23","7.843","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.253","2026-03-10","8.901","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","139","2026-01-10","1.379","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":463},{"label":"Mar","value":767},{"label":"Abr","value":378},{"label":"Mai","value":456},{"label":"Jun","value":395},{"label":"Jul","value":477},{"label":"Ago","value":422},{"label":"Set","value":457},{"label":"Out","value":734},{"label":"Nov","value":703},{"label":"Dez","value":731}];
const MX = 767;
