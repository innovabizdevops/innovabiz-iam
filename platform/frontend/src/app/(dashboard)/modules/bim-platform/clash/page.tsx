...
const PAGE = "Clash";
const KPIS = [{"l":"Formulários Ativos","v":"139","t":"+13.4%","d":"up"},{"l":"Submissões/Dia","v":"2099","t":"+12.5%","d":"up"},{"l":"Documentos Gerados","v":"4.459","t":"-0.3%","d":"down"},{"l":"Templates","v":"5.231","t":"+14.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.525","2026-02-07","2.732","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.869","2026-03-25","4.196","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.392","2026-02-12","8.497","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.001","2026-02-23","3.876","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.801","2026-02-19","8.098","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":633},{"label":"Mar","value":534},{"label":"Abr","value":814},{"label":"Mai","value":663},{"label":"Jun","value":776},{"label":"Jul","value":627},{"label":"Ago","value":504},{"label":"Set","value":446},{"label":"Out","value":674},{"label":"Nov","value":509},{"label":"Dez","value":544}];
const MX = 816;
