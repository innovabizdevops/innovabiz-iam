...
const PAGE = "Handover";
const KPIS = [{"l":"Formulários Ativos","v":"8.961","t":"+0.0%","d":"up"},{"l":"Submissões/Dia","v":"2065","t":"-1.8%","d":"down"},{"l":"Documentos Gerados","v":"2.022","t":"+8.0%","d":"up"},{"l":"Templates","v":"1.817","t":"+13.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.200","2026-02-09","7.622","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.090","2026-03-02","8.997","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.846","2026-03-07","4.791","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.850","2026-03-17","2.848","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.435","2026-03-12","2.991","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":780},{"label":"Mar","value":922},{"label":"Abr","value":832},{"label":"Mai","value":1040},{"label":"Jun","value":929},{"label":"Jul","value":787},{"label":"Ago","value":822},{"label":"Set","value":921},{"label":"Out","value":705},{"label":"Nov","value":1008},{"label":"Dez","value":754}];
const MX = 1040;
