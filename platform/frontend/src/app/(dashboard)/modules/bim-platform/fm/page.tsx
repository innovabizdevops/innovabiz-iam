...
const PAGE = "FM Link";
const KPIS = [{"l":"Formulários Ativos","v":"8.934","t":"+8.9%","d":"up"},{"l":"Submissões/Dia","v":"926","t":"+0.7%","d":"up"},{"l":"Documentos Gerados","v":"961","t":"-4.8%","d":"down"},{"l":"Templates","v":"2.516","t":"+6.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.360","2026-01-14","7.704","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.928","2026-03-10","4.917","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.829","2026-01-02","1.825","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.020","2026-01-17","2.060","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.958","2026-02-05","1.533","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":612},{"label":"Mar","value":585},{"label":"Abr","value":858},{"label":"Mai","value":684},{"label":"Jun","value":908},{"label":"Jul","value":684},{"label":"Ago","value":889},{"label":"Set","value":646},{"label":"Out","value":600},{"label":"Nov","value":899},{"label":"Dez","value":582}];
const MX = 908;
