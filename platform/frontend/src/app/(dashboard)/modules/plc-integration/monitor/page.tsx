...
const ACCENT = "#b45309";
const MODULE = "PLC & OT Integration";
const PAGE = "Monitor";
const KPIS = [{"l":"Dispositivos Online","v":"1.142","t":"+0.8%","d":"up"},{"l":"Dados/Min (MB)","v":"6.036","t":"+3.7%","d":"up"},{"l":"Alertas Ativos","v":"3.017","t":"+7.5%","d":"up"},{"l":"Uptime (%)","v":"91.9%","t":"+12.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.166","4.439","2.841","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.018","7.681","8.642","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.941","3.086","7.966","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","8.861","4.013","3.774","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.702","8.163","4.394","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":788},{"label":"Mar","value":778},{"label":"Abr","value":906},{"label":"Mai","value":838},{"label":"Jun","value":690},{"label":"Jul","value":857},{"label":"Ago","value":777},{"label":"Set","value":828},{"label":"Out","value":708},{"label":"Nov","value":670},{"label":"Dez","value":873}];
const MX = 906;
