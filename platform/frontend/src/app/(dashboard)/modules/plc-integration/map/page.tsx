...
const PAGE = "Map";
const KPIS = [{"l":"Dispositivos Online","v":"8.235","t":"-3.1%","d":"down"},{"l":"Dados/Min (MB)","v":"4.403","t":"+6.1%","d":"up"},{"l":"Alertas Ativos","v":"495","t":"+17.1%","d":"up"},{"l":"Uptime (%)","v":"87.5%","t":"+4.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","8.425","4.990","8.980","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.303","5.722","3.509","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","174","5.379","145","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.824","6.939","7.551","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.821","1.672","1.621","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":663},{"label":"Mar","value":442},{"label":"Abr","value":671},{"label":"Mai","value":345},{"label":"Jun","value":474},{"label":"Jul","value":516},{"label":"Ago","value":585},{"label":"Set","value":585},{"label":"Out","value":601},{"label":"Nov","value":676},{"label":"Dez","value":431}];
const MX = 676;
