...
const PAGE = "Secure";
const KPIS = [{"l":"Dispositivos Online","v":"820","t":"+13.1%","d":"up"},{"l":"Dados/Min (MB)","v":"7.845","t":"-0.2%","d":"down"},{"l":"Alertas Ativos","v":"6.822","t":"+15.7%","d":"up"},{"l":"Uptime (%)","v":"88.7%","t":"+8.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.557","1.356","6.354","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.162","6.785","3.765","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.593","7.023","7.180","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.648","7.025","7.910","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.063","1.690","4.636","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1000},{"label":"Fev","value":724},{"label":"Mar","value":874},{"label":"Abr","value":755},{"label":"Mai","value":976},{"label":"Jun","value":697},{"label":"Jul","value":688},{"label":"Ago","value":946},{"label":"Set","value":871},{"label":"Out","value":709},{"label":"Nov","value":869},{"label":"Dez","value":983}];
const MX = 1000;
