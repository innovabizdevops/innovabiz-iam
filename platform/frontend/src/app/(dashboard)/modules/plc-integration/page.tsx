...
/* ═══ PLC & OT Integration — Dashboard ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total Registos", value: "8223", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4716", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€459K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2023607723", cells: ["PLC-3723", "PLC & OT Integration Item 1", "12/12/2026", "€7823"], status: "active" as const },
    { id: "2023611294", cells: ["PLC-7294", "PLC & OT Integration Item 2", "27/7/2026", "€11 394"], status: "pending" as const },
    { id: "2023614865", cells: ["PLC-1865", "PLC & OT Integration Item 3", "14/2/2026", "€14 965"], status: "completed" as const },
    { id: "2023618436", cells: ["PLC-5436", "PLC & OT Integration Item 4", "1/9/2026", "€18 536"], status: "warning" as const },
    { id: "2023622007", cells: ["PLC-9007", "PLC & OT Integration Item 5", "16/4/2026", "€22 107"], status: "active" as const },
];
...
export default function PlcOtIntegrationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">PLC & OT Integration</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • PLC & OT Integration</p>
                    </div>
                </div>
