...
const PAGE = "Protocol";
const KPIS = [{"l":"Dispositivos Online","v":"6.167","t":"-5.3%","d":"down"},{"l":"Dados/Min (MB)","v":"5.608","t":"+2.3%","d":"up"},{"l":"Alertas Ativos","v":"6.531","t":"+14.4%","d":"up"},{"l":"Uptime (%)","v":"92.1%","t":"+0.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","1.727","1.075","3.041","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.121","7.895","7.553","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.916","3.239","1.923","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","881","6.600","5.137","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.881","7.993","4.036","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":525},{"label":"Mar","value":893},{"label":"Abr","value":815},{"label":"Mai","value":686},{"label":"Jun","value":571},{"label":"Jul","value":545},{"label":"Ago","value":746},{"label":"Set","value":921},{"label":"Out","value":743},{"label":"Nov","value":665},{"label":"Dez","value":852}];
const MX = 921;
