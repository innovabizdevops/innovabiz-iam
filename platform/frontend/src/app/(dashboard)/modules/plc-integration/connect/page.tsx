...
const PAGE = "Connect";
const KPIS = [{"l":"Dispositivos Online","v":"1.335","t":"+12.4%","d":"up"},{"l":"Dados/Min (MB)","v":"3.838","t":"+10.9%","d":"up"},{"l":"Alertas Ativos","v":"4.175","t":"+5.1%","d":"up"},{"l":"Uptime (%)","v":"88.4%","t":"-5.5%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","1.831","2.741","8.688","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.911","5.308","5.424","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.641","251","7.798","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","411","3.744","4.327","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","1.518","3.484","3.644","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":597},{"label":"Fev","value":505},{"label":"Mar","value":444},{"label":"Abr","value":632},{"label":"Mai","value":542},{"label":"Jun","value":500},{"label":"Jul","value":701},{"label":"Ago","value":601},{"label":"Set","value":642},{"label":"Out","value":496},{"label":"Nov","value":721},{"label":"Dez","value":591}];
const MX = 721;
