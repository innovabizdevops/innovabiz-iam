...
const PAGE = "Validate";
const KPIS = [{"l":"Dashboards Ativos","v":"1.290","t":"+8.7%","d":"up"},{"l":"Queries/Dia","v":"3515","t":"-1.4%","d":"down"},{"l":"Dados Processados (GB)","v":"2.054","t":"-5.6%","d":"down"},{"l":"Utilizadores Analytics","v":"7.309","t":"+10.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1854","2026-03-08","7.729","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3196","2026-03-10","1.148","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","221","2026-02-24","4.997","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3089","2026-02-22","6.363","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","191","2026-01-03","5.892","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":614},{"label":"Mar","value":647},{"label":"Abr","value":795},{"label":"Mai","value":751},{"label":"Jun","value":969},{"label":"Jul","value":652},{"label":"Ago","value":785},{"label":"Set","value":1001},{"label":"Out","value":885},{"label":"Nov","value":937},{"label":"Dez","value":895}];
const MX = 1001;
