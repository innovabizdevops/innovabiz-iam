...
const PAGE = "Define";
const KPIS = [{"l":"Dashboards Ativos","v":"2.486","t":"-3.5%","d":"down"},{"l":"Queries/Dia","v":"1129","t":"+0.9%","d":"up"},{"l":"Dados Processados (GB)","v":"1.769","t":"+11.3%","d":"up"},{"l":"Utilizadores Analytics","v":"433","t":"+17.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1403","2026-02-22","7.297","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3063","2026-01-11","2.062","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3204","2026-01-07","3.264","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2815","2026-03-10","1.291","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","194","2026-02-01","1.488","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":1030},{"label":"Mar","value":795},{"label":"Abr","value":1058},{"label":"Mai","value":956},{"label":"Jun","value":747},{"label":"Jul","value":859},{"label":"Ago","value":951},{"label":"Set","value":1053},{"label":"Out","value":803},{"label":"Nov","value":690},{"label":"Dez","value":1054}];
const MX = 1058;
