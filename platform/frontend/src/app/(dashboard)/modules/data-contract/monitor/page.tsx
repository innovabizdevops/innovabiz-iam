...
const ACCENT = "#1e3a5f";
const MODULE = "Data Contract Platform";
const PAGE = "Monitor";
const KPIS = [{"l":"Dashboards Ativos","v":"5.462","t":"+10.2%","d":"up"},{"l":"Queries/Dia","v":"412","t":"-0.3%","d":"down"},{"l":"Dados Processados (GB)","v":"4.096","t":"+11.1%","d":"up"},{"l":"Utilizadores Analytics","v":"8.534","t":"-1.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","921","2026-01-17","7.914","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1647","2026-01-15","616","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1984","2026-03-17","5.954","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4701","2026-03-01","1.210","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","638","2026-02-03","6.318","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":339},{"label":"Mar","value":340},{"label":"Abr","value":385},{"label":"Mai","value":455},{"label":"Jun","value":573},{"label":"Jul","value":561},{"label":"Ago","value":447},{"label":"Set","value":532},{"label":"Out","value":301},{"label":"Nov","value":506},{"label":"Dez","value":393}];
const MX = 573;
