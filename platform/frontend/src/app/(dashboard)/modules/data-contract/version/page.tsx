...
const PAGE = "Version";
const KPIS = [{"l":"Formulários Ativos","v":"5.002","t":"+7.5%","d":"up"},{"l":"Submissões/Dia","v":"3747","t":"+17.1%","d":"up"},{"l":"Documentos Gerados","v":"7.956","t":"+15.2%","d":"up"},{"l":"Templates","v":"1.558","t":"+6.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.121","2026-01-26","6.675","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.362","2026-03-14","5.195","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.822","2026-01-01","7.968","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.870","2026-02-04","7.948","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.327","2026-02-21","6.719","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":977},{"label":"Fev","value":871},{"label":"Mar","value":1013},{"label":"Abr","value":716},{"label":"Mai","value":950},{"label":"Jun","value":858},{"label":"Jul","value":900},{"label":"Ago","value":799},{"label":"Set","value":687},{"label":"Out","value":790},{"label":"Nov","value":926},{"label":"Dez","value":1055}];
const MX = 1055;
