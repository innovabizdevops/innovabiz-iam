...
const PAGE = "Enforce";
const KPIS = [{"l":"Dashboards Ativos","v":"6.821","t":"-4.0%","d":"down"},{"l":"Queries/Dia","v":"2600","t":"+12.0%","d":"up"},{"l":"Dados Processados (GB)","v":"9.015","t":"+7.0%","d":"up"},{"l":"Utilizadores Analytics","v":"3.817","t":"-2.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","746","2026-01-25","5.771","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","249","2026-01-20","8.156","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4958","2026-02-27","6.386","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4918","2026-03-07","928","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4589","2026-01-06","8.037","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":342},{"label":"Fev","value":644},{"label":"Mar","value":485},{"label":"Abr","value":471},{"label":"Mai","value":641},{"label":"Jun","value":482},{"label":"Jul","value":541},{"label":"Ago","value":404},{"label":"Set","value":513},{"label":"Out","value":650},{"label":"Nov","value":470},{"label":"Dez","value":324}];
const MX = 650;
