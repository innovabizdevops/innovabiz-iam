...
/* ═══ Data Contract Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "116", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1250", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€427K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "965834116", cells: ["DAT-9116", "Data Contract Platform Item 1", "17/5/2026", "€34 216"], status: "active" as const },
    { id: "965837687", cells: ["DAT-3687", "Data Contract Platform Item 2", "4/12/2026", "€37 787"], status: "pending" as const },
    { id: "965841258", cells: ["DAT-7258", "Data Contract Platform Item 3", "19/7/2026", "€41 358"], status: "completed" as const },
    { id: "965844829", cells: ["DAT-1829", "Data Contract Platform Item 4", "6/2/2026", "€44 929"], status: "warning" as const },
    { id: "965848400", cells: ["DAT-5400", "Data Contract Platform Item 5", "21/9/2026", "€48 500"], status: "active" as const },
];
...
export default function DataContractPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Contract Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Contract Platform</p>
                    </div>
                </div>
