...
const KPIS = [{"l":"Dashboards Ativos","v":"3.084","t":"+7.8%","d":"up"},{"l":"Queries/Dia","v":"3106","t":"+5.2%","d":"up"},{"l":"Dados Processados (GB)","v":"489","t":"+8.3%","d":"up"},{"l":"Utilizadores Analytics","v":"7.389","t":"-1.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1322","2026-03-27","3.453","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","234","2026-03-20","1.632","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1519","2026-01-20","4.711","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","987","2026-03-12","8.799","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5068","2026-02-13","5.750","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":749},{"label":"Fev","value":792},{"label":"Mar","value":794},{"label":"Abr","value":602},{"label":"Mai","value":582},{"label":"Jun","value":568},{"label":"Jul","value":686},{"label":"Ago","value":743},{"label":"Set","value":794},{"label":"Out","value":784},{"label":"Nov","value":763},{"label":"Dez","value":545}];
const MX = 794;
