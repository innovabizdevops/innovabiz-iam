...
const PAGE = "Loss Ratio";
const KPIS = [{"l":"Dashboards Ativos","v":"4.776","t":"+5.1%","d":"up"},{"l":"Queries/Dia","v":"3410","t":"+1.9%","d":"up"},{"l":"Dados Processados (GB)","v":"7.276","t":"+3.3%","d":"up"},{"l":"Utilizadores Analytics","v":"3.643","t":"-4.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1066","2026-03-05","496","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1488","2026-03-19","5.376","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2533","2026-02-06","6.356","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3382","2026-03-09","2.030","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3907","2026-03-20","866","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":964},{"label":"Fev","value":1036},{"label":"Mar","value":794},{"label":"Abr","value":1025},{"label":"Mai","value":880},{"label":"Jun","value":783},{"label":"Jul","value":1036},{"label":"Ago","value":675},{"label":"Set","value":962},{"label":"Out","value":713},{"label":"Nov","value":696},{"label":"Dez","value":702}];
const MX = 1036;
