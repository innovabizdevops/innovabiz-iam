...
const KPIS = [{"l":"Dashboards Ativos","v":"6.607","t":"+2.0%","d":"up"},{"l":"Queries/Dia","v":"1972","t":"+17.6%","d":"up"},{"l":"Dados Processados (GB)","v":"7.728","t":"+16.5%","d":"up"},{"l":"Utilizadores Analytics","v":"2.389","t":"+5.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4662","2026-01-20","9.079","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3531","2026-03-02","7.822","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3918","2026-01-17","8.591","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1911","2026-02-01","5.837","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1585","2026-01-26","3.139","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1024},{"label":"Fev","value":1040},{"label":"Mar","value":974},{"label":"Abr","value":800},{"label":"Mai","value":802},{"label":"Jun","value":910},{"label":"Jul","value":916},{"label":"Ago","value":1028},{"label":"Set","value":1085},{"label":"Out","value":766},{"label":"Nov","value":962},{"label":"Dez","value":704}];
const MX = 1085;
