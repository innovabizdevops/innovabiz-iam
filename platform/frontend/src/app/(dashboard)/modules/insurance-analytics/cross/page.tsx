...
const ACCENT = "#6366f1";
const MODULE = "Insurance Analytics";
const PAGE = "Cross-Sell";
const KPIS = [{"l":"Dashboards Ativos","v":"775","t":"+15.2%","d":"up"},{"l":"Queries/Dia","v":"3214","t":"+7.0%","d":"up"},{"l":"Dados Processados (GB)","v":"1.228","t":"-5.8%","d":"down"},{"l":"Utilizadores Analytics","v":"1.570","t":"+8.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2478","2026-01-12","786","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3044","2026-03-04","3.502","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","760","2026-03-15","4.157","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3631","2026-02-20","7.970","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1553","2026-01-14","4.446","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":307},{"label":"Fev","value":515},{"label":"Mar","value":436},{"label":"Abr","value":312},{"label":"Mai","value":588},{"label":"Jun","value":529},{"label":"Jul","value":510},{"label":"Ago","value":661},{"label":"Set","value":469},{"label":"Out","value":351},{"label":"Nov","value":502},{"label":"Dez","value":370}];
const MX = 661;
