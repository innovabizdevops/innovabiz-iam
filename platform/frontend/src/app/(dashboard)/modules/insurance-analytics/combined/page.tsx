...
const PAGE = "Combined";
const KPIS = [{"l":"Dashboards Ativos","v":"126","t":"+10.4%","d":"up"},{"l":"Queries/Dia","v":"734","t":"+2.5%","d":"up"},{"l":"Dados Processados (GB)","v":"3.247","t":"+0.1%","d":"up"},{"l":"Utilizadores Analytics","v":"3.228","t":"+7.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3676","2026-01-13","4.186","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1823","2026-02-28","5.057","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","585","2026-03-09","4.203","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1064","2026-02-13","4.089","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2162","2026-01-11","4.590","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":416},{"label":"Fev","value":442},{"label":"Mar","value":427},{"label":"Abr","value":523},{"label":"Mai","value":562},{"label":"Jun","value":548},{"label":"Jul","value":359},{"label":"Ago","value":388},{"label":"Set","value":711},{"label":"Out","value":326},{"label":"Nov","value":400},{"label":"Dez","value":568}];
const MX = 711;
