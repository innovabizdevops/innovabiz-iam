...
const PAGE = "Sales";
const KPIS = [{"l":"Vendas YTD (€)","v":"€16432","t":"+11.2%","d":"up"},{"l":"Pipeline (€)","v":"€8002","t":"+11.6%","d":"up"},{"l":"Atingimento Quota (%)","v":"90.2%","t":"-1.2%","d":"down"},{"l":"Win Rate (%)","v":"66.9%","t":"-1.9%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 15156.93","€ 11790.95","€ 483.65","83.6%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 12279.59","€ 33984.80","€ 23514.87","84.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 12194.33","€ 16509.49","€ 30654.15","96.8%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 3913.43","€ 35856.04","€ 10156.47","73.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 24090.71","€ 36135.92","€ 10516.76","73.5%"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":917},{"label":"Mar","value":756},{"label":"Abr","value":640},{"label":"Mai","value":998},{"label":"Jun","value":778},{"label":"Jul","value":650},{"label":"Ago","value":839},{"label":"Set","value":1006},{"label":"Out","value":675},{"label":"Nov","value":659},{"label":"Dez","value":649}];
const MX = 1006;
