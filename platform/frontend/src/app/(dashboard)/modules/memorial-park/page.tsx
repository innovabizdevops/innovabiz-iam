...
/* ═══ Memorial Park — Dashboard ═══ */

const ACCENT = "#0f172a";

const KPIS = [
    { label: "Total Registos", value: "4758", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1889", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€203K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "882965858", cells: ["MEM-3858", "Memorial Park Item 1", "27/3/2026", "€15 958"], status: "active" as const },
    { id: "882969429", cells: ["MEM-7429", "Memorial Park Item 2", "14/10/2026", "€19 529"], status: "pending" as const },
    { id: "882973000", cells: ["MEM-2000", "Memorial Park Item 3", "1/5/2026", "€23 100"], status: "completed" as const },
    { id: "882976571", cells: ["MEM-5571", "Memorial Park Item 4", "16/12/2026", "€26 671"], status: "warning" as const },
    { id: "882980142", cells: ["MEM-9142", "Memorial Park Item 5", "3/7/2026", "€30 242"], status: "active" as const },
];
...
export default function MemorialParkPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Memorial Park</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Memorial Park</p>
                    </div>
                </div>
