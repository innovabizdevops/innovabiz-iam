...
const ACCENT = "#0f172a";
const MODULE = "Memorial Park";
const PAGE = "Interment";
const KPIS = [{"l":"Riscos Identificados","v":"2.266","t":"+9.0%","d":"up"},{"l":"Mitigações Ativas","v":"6.838","t":"+5.9%","d":"up"},{"l":"Score Risco Geral","v":"73","t":"-3.1%","d":"down"},{"l":"Incidentes YTD","v":"2.190","t":"+12.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.519","1.935","4.643","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.755","6.796","9.029","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.050","8.048","3.516","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.563","3.527","2.875","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.774","6.335","9.033","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":876},{"label":"Mar","value":821},{"label":"Abr","value":698},{"label":"Mai","value":779},{"label":"Jun","value":777},{"label":"Jul","value":735},{"label":"Ago","value":826},{"label":"Set","value":611},{"label":"Out","value":846},{"label":"Nov","value":801},{"label":"Dez","value":812}];
const MX = 876;
...
export default function IntermentPage() {
    return (
