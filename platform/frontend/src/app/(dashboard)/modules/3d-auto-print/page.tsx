...
/* ═══ Automotive 3D Printing — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "7290", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4415", trend: "+10%", trendDirection: "up" as const, icon: Users },
...
const TABLE_ROWS = [
    { id: "1460395790", cells: ["3D-2790", "Automotive 3D Printing Item 1", "15/3/2026", "€45 890"], status: "active" as const },
    { id: "1460399361", cells: ["3D-6361", "Automotive 3D Printing Item 2", "2/10/2026", "€49 461"], status: "pending" as const },
    { id: "1460402932", cells: ["3D-9932", "Automotive 3D Printing Item 3", "17/5/2026", "€3032"], status: "completed" as const },
    { id: "1460406503", cells: ["3D-4503", "Automotive 3D Printing Item 4", "4/12/2026", "€6603"], status: "warning" as const },
    { id: "1460410074", cells: ["3D-8074", "Automotive 3D Printing Item 5", "19/7/2026", "€10 174"], status: "active" as const },
];
...
export default function Automotive3dPrintingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Automotive 3D Printing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Automotive 3D Printing</p>
                    </div>
                </div>
