...
const KPIS = [{"l":"Atletas Registados","v":"1.093","t":"+11.3%","d":"up"},{"l":"Treinos/Semana","v":"2025","t":"+2.5%","d":"up"},{"l":"Competições","v":"3.160","t":"-5.1%","d":"down"},{"l":"Performance Score","v":"94","t":"+7.8%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.250","8.948","5.523","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","5.744","5.072","1.629","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.514","5.664","8.161","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.732","3.971","411","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.322","5.344","2.539","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":746},{"label":"Mar","value":481},{"label":"Abr","value":390},{"label":"Mai","value":776},{"label":"Jun","value":645},{"label":"Jul","value":481},{"label":"Ago","value":480},{"label":"Set","value":714},{"label":"Out","value":609},{"label":"Nov","value":416},{"label":"Dez","value":701}];
const MX = 776;
