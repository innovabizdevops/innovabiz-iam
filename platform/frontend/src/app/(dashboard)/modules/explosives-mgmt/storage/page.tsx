...
const PAGE = "Storage";
const KPIS = [{"l":"Total Explosives Mgmt","v":"8.059","t":"-4.3%","d":"down"},{"l":"Storage Ativos","v":"212","t":"+0.8%","d":"up"},{"l":"Eficiência (%)","v":"70.5%","t":"+8.3%","d":"up"},{"l":"Score Performance","v":"83","t":"+3.9%","d":"up"}];
const COLS = ["ID","Storage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Explosives Mgmt #001","Explosives Mgmt #002","3.024","8.268","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Explosives Mgmt #002","Explosives Mgmt #003","7.390","5.033","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Explosives Mgmt #003","Explosives Mgmt #004","1.382","8.343","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Explosives Mgmt #004","Explosives Mgmt #005","1.112","7.163","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Explosives Mgmt #005","Explosives Mgmt #001","2.949","1.581","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":935},{"label":"Mar","value":903},{"label":"Abr","value":758},{"label":"Mai","value":816},{"label":"Jun","value":626},{"label":"Jul","value":748},{"label":"Ago","value":611},{"label":"Set","value":911},{"label":"Out","value":834},{"label":"Nov","value":868},{"label":"Dez","value":986}];
const MX = 986;
