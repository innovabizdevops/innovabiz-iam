...
const ACCENT = "#6366f1";
const MODULE = "Explosives Mgmt";
const PAGE = "Blast Design";
const KPIS = [{"l":"Formulários Ativos","v":"5.514","t":"+14.6%","d":"up"},{"l":"Submissões/Dia","v":"3984","t":"+16.1%","d":"up"},{"l":"Documentos Gerados","v":"1.062","t":"+7.4%","d":"up"},{"l":"Templates","v":"7.392","t":"+15.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.107","2026-03-17","506","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.642","2026-02-26","2.238","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.719","2026-01-11","597","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.365","2026-01-16","1.597","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.934","2026-02-07","6.799","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":515},{"label":"Mar","value":642},{"label":"Abr","value":506},{"label":"Mai","value":556},{"label":"Jun","value":573},{"label":"Jul","value":577},{"label":"Ago","value":325},{"label":"Set","value":434},{"label":"Out","value":523},{"label":"Nov","value":435},{"label":"Dez","value":548}];
const MX = 642;
