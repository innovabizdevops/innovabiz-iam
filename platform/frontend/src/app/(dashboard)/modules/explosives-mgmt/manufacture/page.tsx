...
const KPIS = [{"l":"Total Explosives Mgmt","v":"5.319","t":"+1.9%","d":"up"},{"l":"Manufacture Ativos","v":"4.445","t":"+15.8%","d":"up"},{"l":"Eficiência (%)","v":"79.9%","t":"+0.1%","d":"up"},{"l":"Score Performance","v":"89","t":"+2.3%","d":"up"}];
const COLS = ["ID","Manufacture","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Explosives Mgmt #001","Explosives Mgmt #002","5.264","6.386","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Explosives Mgmt #002","Explosives Mgmt #003","5.095","810","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Explosives Mgmt #003","Explosives Mgmt #004","4.467","5.148","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Explosives Mgmt #004","Explosives Mgmt #005","2.760","4.708","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Explosives Mgmt #005","Explosives Mgmt #001","1.415","5.193","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":683},{"label":"Mar","value":826},{"label":"Abr","value":899},{"label":"Mai","value":754},{"label":"Jun","value":896},{"label":"Jul","value":592},{"label":"Ago","value":820},{"label":"Set","value":693},{"label":"Out","value":935},{"label":"Nov","value":729},{"label":"Dez","value":770}];
const MX = 935;
