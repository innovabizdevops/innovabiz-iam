...
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"7.560","t":"+12.6%","d":"up"},{"l":"Queries/Dia","v":"2813","t":"-3.1%","d":"down"},{"l":"Dados Processados (GB)","v":"110","t":"+3.2%","d":"up"},{"l":"Utilizadores Analytics","v":"6.222","t":"+11.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2859","2026-03-07","7.034","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1141","2026-03-06","702","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","412","2026-01-04","7.781","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4147","2026-03-22","4.827","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2963","2026-02-24","7.389","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":984},{"label":"Fev","value":1016},{"label":"Mar","value":750},{"label":"Abr","value":684},{"label":"Mai","value":1068},{"label":"Jun","value":777},{"label":"Jul","value":870},{"label":"Ago","value":1007},{"label":"Set","value":741},{"label":"Out","value":1052},{"label":"Nov","value":852},{"label":"Dez","value":939}];
const MX = 1068;
