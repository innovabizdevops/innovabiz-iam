...
/* ═══ Email Marketing Deep — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "1779", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1921", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€134K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1261865579", cells: ["EMA-3579", "Email Marketing Deep Item 1", "24/12/2026", "€15 679"], status: "active" as const },
    { id: "1261869150", cells: ["EMA-7150", "Email Marketing Deep Item 2", "11/7/2026", "€19 250"], status: "pending" as const },
    { id: "1261872721", cells: ["EMA-1721", "Email Marketing Deep Item 3", "26/2/2026", "€22 821"], status: "completed" as const },
    { id: "1261876292", cells: ["EMA-5292", "Email Marketing Deep Item 4", "13/9/2026", "€26 392"], status: "warning" as const },
    { id: "1261879863", cells: ["EMA-8863", "Email Marketing Deep Item 5", "28/4/2026", "€29 963"], status: "active" as const },
];
...
export default function EmailMarketingDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Email Marketing Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Email Marketing Deep</p>
                    </div>
                </div>
