...
const ACCENT = "#be185d";
const MODULE = "Email Marketing Deep";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"2.047","t":"+13.4%","d":"up"},{"l":"Submissões/Dia","v":"2206","t":"+8.1%","d":"up"},{"l":"Documentos Gerados","v":"7.876","t":"+1.6%","d":"up"},{"l":"Templates","v":"7.643","t":"+11.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.996","2026-02-07","4.387","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.404","2026-02-14","8.876","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","471","2026-01-16","1.127","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","813","2026-03-18","6.363","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.431","2026-03-15","2.389","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":867},{"label":"Mar","value":667},{"label":"Abr","value":701},{"label":"Mai","value":612},{"label":"Jun","value":779},{"label":"Jul","value":844},{"label":"Ago","value":597},{"label":"Set","value":676},{"label":"Out","value":728},{"label":"Nov","value":487},{"label":"Dez","value":853}];
const MX = 867;
