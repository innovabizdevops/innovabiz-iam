...
const PAGE = "Vaccination Track";
const KPIS = [{"l":"Total Pet Services","v":"3.212","t":"+4.3%","d":"up"},{"l":"Vaccination Track Ativos","v":"1.727","t":"+13.1%","d":"up"},{"l":"Eficiência (%)","v":"89.6%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"77","t":"+12.7%","d":"up"}];
const COLS = ["ID","Vaccination Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Services #001","Pet Services #002","1.708","4.908","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Services #002","Pet Services #003","8.714","8.277","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Services #003","Pet Services #004","4.184","4.860","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Services #004","Pet Services #005","1.981","6.629","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Services #005","Pet Services #001","3.313","3.562","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":829},{"label":"Mar","value":929},{"label":"Abr","value":779},{"label":"Mai","value":784},{"label":"Jun","value":736},{"label":"Jul","value":805},{"label":"Ago","value":926},{"label":"Set","value":804},{"label":"Out","value":1078},{"label":"Nov","value":939},{"label":"Dez","value":868}];
const MX = 1078;
