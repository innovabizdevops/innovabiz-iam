...
const PAGE = "Pet Daycare";
const KPIS = [{"l":"Total Pet Services","v":"6.367","t":"+13.6%","d":"up"},{"l":"Pet Daycare Ativos","v":"4.254","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"82.1%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"80","t":"+8.7%","d":"up"}];
const COLS = ["ID","Pet Daycare","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Services #001","Pet Services #002","4.298","1.941","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Services #002","Pet Services #003","4.846","7.649","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Services #003","Pet Services #004","3.145","5.688","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Services #004","Pet Services #005","9.071","5.031","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Services #005","Pet Services #001","8.079","7.507","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":507},{"label":"Mar","value":507},{"label":"Abr","value":613},{"label":"Mai","value":604},{"label":"Jun","value":710},{"label":"Jul","value":490},{"label":"Ago","value":613},{"label":"Set","value":781},{"label":"Out","value":794},{"label":"Nov","value":628},{"label":"Dez","value":634}];
const MX = 875;
