...
const PAGE = "Grooming Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"8.314","t":"+17.7%","d":"up"},{"l":"RevPAR (€)","v":"€80883","t":"+14.9%","d":"up"},{"l":"Ocupação (%)","v":"88.4%","t":"+4.6%","d":"up"},{"l":"Guest Satisfaction","v":"4.867","t":"+3.6%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.509","2026-01-09","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.830","2026-01-12","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.484","2026-03-21","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.803","2026-01-21","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.367","2026-01-13","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":994},{"label":"Fev","value":1060},{"label":"Mar","value":1013},{"label":"Abr","value":857},{"label":"Mai","value":760},{"label":"Jun","value":929},{"label":"Jul","value":994},{"label":"Ago","value":1032},{"label":"Set","value":1060},{"label":"Out","value":774},{"label":"Nov","value":818},{"label":"Dez","value":1004}];
const MX = 1060;
