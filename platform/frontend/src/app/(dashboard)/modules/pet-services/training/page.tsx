...
const ACCENT = "#a16207";
const MODULE = "Pet Services";
const PAGE = "Training Classes";
const KPIS = [{"l":"Total Pet Services","v":"1.372","t":"+13.9%","d":"up"},{"l":"Training Classes Ativos","v":"1.579","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"89.1%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"89","t":"-1.2%","d":"down"}];
const COLS = ["ID","Training Classes","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Services #001","Pet Services #002","7.853","389","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Services #002","Pet Services #003","1.358","8.585","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Services #003","Pet Services #004","1.241","6.333","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Services #004","Pet Services #005","8.146","6.452","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Services #005","Pet Services #001","3.733","6.813","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":895},{"label":"Mar","value":872},{"label":"Abr","value":876},{"label":"Mai","value":772},{"label":"Jun","value":1045},{"label":"Jul","value":925},{"label":"Ago","value":955},{"label":"Set","value":780},{"label":"Out","value":938},{"label":"Nov","value":793},{"label":"Dez","value":900}];
const MX = 1045;
