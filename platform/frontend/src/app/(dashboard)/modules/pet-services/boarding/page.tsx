...
const PAGE = "Boarding Mgmt";
const KPIS = [{"l":"Teams Ativos","v":"7.249","t":"+12.8%","d":"up"},{"l":"Reuniões/Semana","v":"4373","t":"+10.3%","d":"up"},{"l":"Mensagens/Dia","v":"1185","t":"+14.2%","d":"up"},{"l":"Ficheiros Partilhados","v":"5.936","t":"-3.1%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","8.764","2959","1.320","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","8.249","3493","434","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.572","433","8.882","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.571","1364","6.013","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","8.474","1704","3.741","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":514},{"label":"Mar","value":620},{"label":"Abr","value":393},{"label":"Mai","value":530},{"label":"Jun","value":453},{"label":"Jul","value":652},{"label":"Ago","value":743},{"label":"Set","value":522},{"label":"Out","value":485},{"label":"Nov","value":430},{"label":"Dez","value":735}];
const MX = 743;
