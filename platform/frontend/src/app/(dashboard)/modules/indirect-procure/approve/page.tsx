...
const ACCENT = "#78350f";
const MODULE = "Indirect Procurement Deep";
const PAGE = "Approve";
const KPIS = [{"l":"Aprovações Pendentes","v":"2.545","t":"+6.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"76.3%","t":"+10.4%","d":"up"},{"l":"Tempo Médio (h)","v":"76h","t":"+16.3%","d":"up"},{"l":"Rejeitadas (%)","v":"81.5%","t":"+10.1%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","5.818","€ 23341.74","5.780","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","2.339","€ 10092.00","7.386","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","2.420","€ 44906.50","7.324","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","8.501","€ 24443.03","1.409","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","3.004","€ 4787.01","4.862","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":991},{"label":"Fev","value":1045},{"label":"Mar","value":721},{"label":"Abr","value":1091},{"label":"Mai","value":770},{"label":"Jun","value":860},{"label":"Jul","value":1058},{"label":"Ago","value":968},{"label":"Set","value":940},{"label":"Out","value":785},{"label":"Nov","value":1089},{"label":"Dez","value":706}];
const MX = 1091;
