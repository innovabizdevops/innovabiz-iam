...
const PAGE = "Bill";
const KPIS = [{"l":"Fornecedores Ativos","v":"2.174","t":"+3.7%","d":"up"},{"l":"Contratos (€M)","v":"€10.2M","t":"+9.3%","d":"up"},{"l":"On-Time Delivery (%)","v":"66.5%","t":"+7.6%","d":"up"},{"l":"Score Médio","v":"94","t":"+2.0%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","73.0%","€ 36440.31","7.389","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","96.8%","€ 6853.67","3.277","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","75.0%","€ 10192.14","5.170","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","75.9%","€ 15708.54","1.322","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","76.2%","€ 17394.46","8.868","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":696},{"label":"Mar","value":568},{"label":"Abr","value":774},{"label":"Mai","value":606},{"label":"Jun","value":620},{"label":"Jul","value":832},{"label":"Ago","value":701},{"label":"Set","value":761},{"label":"Out","value":605},{"label":"Nov","value":836},{"label":"Dez","value":789}];
const MX = 836;
