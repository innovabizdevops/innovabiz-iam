...
/* ═══ Indirect Procurement Deep — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "6074", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2818", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€480K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "58247674", cells: ["IND-9674", "Indirect Procurement Deep Item 1", "3/11/2026", "€47 774"], status: "active" as const },
    { id: "58251245", cells: ["IND-4245", "Indirect Procurement Deep Item 2", "18/6/2026", "€1345"], status: "pending" as const },
    { id: "58254816", cells: ["IND-7816", "Indirect Procurement Deep Item 3", "5/1/2026", "€4916"], status: "completed" as const },
    { id: "58258387", cells: ["IND-2387", "Indirect Procurement Deep Item 4", "20/8/2026", "€8487"], status: "warning" as const },
    { id: "58261958", cells: ["IND-5958", "Indirect Procurement Deep Item 5", "7/3/2026", "€12 058"], status: "active" as const },
];
...
export default function IndirectProcurementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Indirect Procurement Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Indirect Procurement Deep</p>
                    </div>
                </div>
