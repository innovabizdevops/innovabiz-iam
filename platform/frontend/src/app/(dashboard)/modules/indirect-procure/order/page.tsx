...
const PAGE = "Order";
const KPIS = [{"l":"Fornecedores Ativos","v":"7.012","t":"-0.8%","d":"down"},{"l":"Contratos (€M)","v":"€40.7M","t":"+3.6%","d":"up"},{"l":"On-Time Delivery (%)","v":"92.5%","t":"+5.3%","d":"up"},{"l":"Score Médio","v":"85","t":"+12.7%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","82.8%","€ 30249.72","1.327","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","91.3%","€ 17410.42","5.435","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","95.5%","€ 17661.91","1.951","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","92.1%","€ 26222.98","6.331","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","93.3%","€ 38898.77","2.405","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":930},{"label":"Mar","value":872},{"label":"Abr","value":627},{"label":"Mai","value":748},{"label":"Jun","value":684},{"label":"Jul","value":893},{"label":"Ago","value":781},{"label":"Set","value":742},{"label":"Out","value":662},{"label":"Nov","value":778},{"label":"Dez","value":845}];
const MX = 930;
