...
const PAGE = "Category";
const KPIS = [{"l":"Fornecedores Ativos","v":"156","t":"-5.8%","d":"down"},{"l":"Contratos (€M)","v":"€14.0M","t":"+14.1%","d":"up"},{"l":"On-Time Delivery (%)","v":"81.7%","t":"+0.1%","d":"up"},{"l":"Score Médio","v":"78","t":"+2.2%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","87.8%","€ 39162.79","2.766","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","91.2%","€ 34233.04","8.065","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","93.7%","€ 26244.84","734","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","95.1%","€ 48211.38","3.526","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","90.3%","€ 7241.66","4.389","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":908},{"label":"Fev","value":920},{"label":"Mar","value":870},{"label":"Abr","value":771},{"label":"Mai","value":842},{"label":"Jun","value":755},{"label":"Jul","value":886},{"label":"Ago","value":1035},{"label":"Set","value":881},{"label":"Out","value":789},{"label":"Nov","value":1009},{"label":"Dez","value":955}];
const MX = 1035;
