...
const PAGE = "Request";
const KPIS = [{"l":"Fornecedores Ativos","v":"3.861","t":"+4.5%","d":"up"},{"l":"Contratos (€M)","v":"€42.4M","t":"+16.3%","d":"up"},{"l":"On-Time Delivery (%)","v":"90.6%","t":"-1.4%","d":"down"},{"l":"Score Médio","v":"71","t":"+7.5%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","89.2%","€ 45257.08","5.222","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","89.0%","€ 5271.84","8.251","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","77.9%","€ 32412.35","4.533","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","81.9%","€ 49006.19","5.011","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","94.7%","€ 43746.52","8.306","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":912},{"label":"Fev","value":971},{"label":"Mar","value":979},{"label":"Abr","value":997},{"label":"Mai","value":952},{"label":"Jun","value":698},{"label":"Jul","value":944},{"label":"Ago","value":739},{"label":"Set","value":880},{"label":"Out","value":841},{"label":"Nov","value":664},{"label":"Dez","value":850}];
const MX = 997;
