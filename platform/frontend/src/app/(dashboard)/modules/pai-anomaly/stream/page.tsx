...
const PAGE = "Stream";
const KPIS = [{"l":"Total Pai Anomaly","v":"6.242","t":"-3.6%","d":"down"},{"l":"Stream Ativos","v":"6.156","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"78.9%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"90","t":"-2.7%","d":"down"}];
const COLS = ["ID","Stream","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pai Anomaly #001","Pai Anomaly #002","1.601","3.133","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Pai Anomaly #002","Pai Anomaly #003","3.437","8.092","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Pai Anomaly #003","Pai Anomaly #004","1.598","1.692","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Pai Anomaly #004","Pai Anomaly #005","7.443","3.999","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pai Anomaly #005","Pai Anomaly #001","300","8.043","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":666},{"label":"Mar","value":582},{"label":"Abr","value":811},{"label":"Mai","value":834},{"label":"Jun","value":544},{"label":"Jul","value":524},{"label":"Ago","value":752},{"label":"Set","value":917},{"label":"Out","value":781},{"label":"Nov","value":677},{"label":"Dez","value":540}];
const MX = 917;
