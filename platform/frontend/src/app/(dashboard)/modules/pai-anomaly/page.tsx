...
/* ═══ P-AI Anomaly Detection — Dashboard ═══ */

const ACCENT = "#0c4a6e";

const KPIS = [
    { label: "Total Registos", value: "9495", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4294", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€277K", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "151617995", cells: ["PAI-4995", "P-AI Anomaly Detection Item 1", "12/12/2026", "€18 095"], status: "active" as const },
    { id: "151621566", cells: ["PAI-8566", "P-AI Anomaly Detection Item 2", "27/7/2026", "€21 666"], status: "pending" as const },
    { id: "151625137", cells: ["PAI-3137", "P-AI Anomaly Detection Item 3", "14/2/2026", "€25 237"], status: "completed" as const },
    { id: "151628708", cells: ["PAI-6708", "P-AI Anomaly Detection Item 4", "1/9/2026", "€28 808"], status: "warning" as const },
    { id: "151632279", cells: ["PAI-1279", "P-AI Anomaly Detection Item 5", "16/4/2026", "€32 379"], status: "active" as const },
];
...
export default function PaiAnomalyDetectionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">P-AI Anomaly Detection</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • P-AI Anomaly Detection</p>
                    </div>
                </div>
