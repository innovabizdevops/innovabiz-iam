...
const ACCENT = "#0c4a6e";
const MODULE = "P-AI Anomaly Detection";
const PAGE = "Deep";
const KPIS = [{"l":"Total Pai Anomaly","v":"4.299","t":"-0.2%","d":"down"},{"l":"Deep Ativos","v":"2.794","t":"-6.0%","d":"down"},{"l":"Eficiência (%)","v":"68.9%","t":"-5.1%","d":"down"},{"l":"Score Performance","v":"70","t":"-3.5%","d":"down"}];
const COLS = ["ID","Deep","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pai Anomaly #001","Pai Anomaly #002","8.736","3.881","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Pai Anomaly #002","Pai Anomaly #003","6.623","5.355","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Pai Anomaly #003","Pai Anomaly #004","2.341","896","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Pai Anomaly #004","Pai Anomaly #005","3.764","2.614","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pai Anomaly #005","Pai Anomaly #001","3.603","3.865","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":366},{"label":"Mar","value":586},{"label":"Abr","value":588},{"label":"Mai","value":617},{"label":"Jun","value":526},{"label":"Jul","value":653},{"label":"Ago","value":648},{"label":"Set","value":535},{"label":"Out","value":595},{"label":"Nov","value":337},{"label":"Dez","value":515}];
const MX = 653;
