...
const KPIS = [{"l":"Total Pai Anomaly","v":"3.440","t":"-0.5%","d":"down"},{"l":"Investigate Ativos","v":"122","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"71.3%","t":"+15.9%","d":"up"},{"l":"Score Performance","v":"66","t":"-1.0%","d":"down"}];
const COLS = ["ID","Investigate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pai Anomaly #001","Pai Anomaly #002","3.967","5.942","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Pai Anomaly #002","Pai Anomaly #003","7.697","2.841","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Pai Anomaly #003","Pai Anomaly #004","5.721","221","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Pai Anomaly #004","Pai Anomaly #005","8.129","6.095","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pai Anomaly #005","Pai Anomaly #001","2.421","5.209","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":736},{"label":"Mar","value":439},{"label":"Abr","value":442},{"label":"Mai","value":637},{"label":"Jun","value":431},{"label":"Jul","value":621},{"label":"Ago","value":576},{"label":"Set","value":662},{"label":"Out","value":774},{"label":"Nov","value":751},{"label":"Dez","value":646}];
const MX = 774;
