...
const PAGE = "ML";
const KPIS = [{"l":"Total Pai Anomaly","v":"1.312","t":"+3.4%","d":"up"},{"l":"ML Ativos","v":"1.523","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"69.6%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"77","t":"+2.3%","d":"up"}];
const COLS = ["ID","ML","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pai Anomaly #001","Pai Anomaly #002","6.614","2.532","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Pai Anomaly #002","Pai Anomaly #003","1.892","4.096","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Pai Anomaly #003","Pai Anomaly #004","3.145","6.882","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Pai Anomaly #004","Pai Anomaly #005","1.437","6.851","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pai Anomaly #005","Pai Anomaly #001","5.098","3.125","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":408},{"label":"Mar","value":556},{"label":"Abr","value":533},{"label":"Mai","value":316},{"label":"Jun","value":431},{"label":"Jul","value":558},{"label":"Ago","value":247},{"label":"Set","value":357},{"label":"Out","value":533},{"label":"Nov","value":431},{"label":"Dez","value":448}];
const MX = 568;
