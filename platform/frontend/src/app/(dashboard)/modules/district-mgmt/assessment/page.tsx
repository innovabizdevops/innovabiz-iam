...
const KPIS = [{"l":"Total District Mgmt","v":"3.105","t":"-5.4%","d":"down"},{"l":"Assessment Ativos","v":"5.430","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"88.7%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"69","t":"+14.2%","d":"up"}];
const COLS = ["ID","Assessment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["District Mgmt #001","District Mgmt #002","489","6.293","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["District Mgmt #002","District Mgmt #003","883","2.858","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["District Mgmt #003","District Mgmt #004","3.588","8.880","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["District Mgmt #004","District Mgmt #005","5.112","8.198","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["District Mgmt #005","District Mgmt #001","2.895","5.078","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":272},{"label":"Fev","value":615},{"label":"Mar","value":551},{"label":"Abr","value":415},{"label":"Mai","value":390},{"label":"Jun","value":482},{"label":"Jul","value":472},{"label":"Ago","value":620},{"label":"Set","value":556},{"label":"Out","value":426},{"label":"Nov","value":299},{"label":"Dez","value":592}];
const MX = 620;
