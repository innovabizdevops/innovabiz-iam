...
const PAGE = "Policy";
const KPIS = [{"l":"Total District Mgmt","v":"2.386","t":"+0.6%","d":"up"},{"l":"Policy Ativos","v":"9.050","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"87.3%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"83","t":"+9.5%","d":"up"}];
const COLS = ["ID","Policy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["District Mgmt #001","District Mgmt #002","368","7.618","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["District Mgmt #002","District Mgmt #003","3.548","4.415","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["District Mgmt #003","District Mgmt #004","4.215","4.818","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["District Mgmt #004","District Mgmt #005","8.789","8.987","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["District Mgmt #005","District Mgmt #001","6.914","9.074","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":608},{"label":"Mar","value":828},{"label":"Abr","value":699},{"label":"Mai","value":517},{"label":"Jun","value":514},{"label":"Jul","value":832},{"label":"Ago","value":525},{"label":"Set","value":658},{"label":"Out","value":724},{"label":"Nov","value":777},{"label":"Dez","value":702}];
const MX = 832;
