...
const PAGE = "School";
const KPIS = [{"l":"Total District Mgmt","v":"6.869","t":"+9.1%","d":"up"},{"l":"School Ativos","v":"6.959","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"80.4%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"78","t":"+17.7%","d":"up"}];
const COLS = ["ID","School","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["District Mgmt #001","District Mgmt #002","3.261","180","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["District Mgmt #002","District Mgmt #003","4.856","2.593","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["District Mgmt #003","District Mgmt #004","7.443","6.221","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["District Mgmt #004","District Mgmt #005","8.429","4.521","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["District Mgmt #005","District Mgmt #001","1.295","5.882","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":579},{"label":"Mar","value":392},{"label":"Abr","value":420},{"label":"Mai","value":433},{"label":"Jun","value":620},{"label":"Jul","value":491},{"label":"Ago","value":499},{"label":"Set","value":474},{"label":"Out","value":641},{"label":"Nov","value":664},{"label":"Dez","value":704}];
const MX = 744;
