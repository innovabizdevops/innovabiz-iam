...
const ACCENT = "#6366f1";
const MODULE = "District Management";
const PAGE = "Strategic";
const KPIS = [{"l":"Total District Mgmt","v":"1.870","t":"+1.2%","d":"up"},{"l":"Strategic Ativos","v":"7.999","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"93.5%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"76","t":"-1.8%","d":"down"}];
const COLS = ["ID","Strategic","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["District Mgmt #001","District Mgmt #002","7.476","5.123","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["District Mgmt #002","District Mgmt #003","6.760","1.125","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["District Mgmt #003","District Mgmt #004","8.047","2.126","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["District Mgmt #004","District Mgmt #005","7.295","3.199","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["District Mgmt #005","District Mgmt #001","1.086","3.070","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":427},{"label":"Mar","value":691},{"label":"Abr","value":542},{"label":"Mai","value":741},{"label":"Jun","value":610},{"label":"Jul","value":685},{"label":"Ago","value":516},{"label":"Set","value":521},{"label":"Out","value":773},{"label":"Nov","value":771},{"label":"Dez","value":494}];
const MX = 773;
