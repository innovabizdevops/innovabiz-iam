...
const PAGE = "Report Board";
const KPIS = [{"l":"Teams Ativos","v":"8.957","t":"+12.2%","d":"up"},{"l":"Reuniões/Semana","v":"936","t":"+9.2%","d":"up"},{"l":"Mensagens/Dia","v":"2938","t":"+0.6%","d":"up"},{"l":"Ficheiros Partilhados","v":"4.337","t":"-1.1%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.343","4484","7.234","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.506","2170","4.382","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","7.156","3012","7.832","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","7.624","1340","5.111","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.200","1967","2.585","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":981},{"label":"Fev","value":969},{"label":"Mar","value":932},{"label":"Abr","value":726},{"label":"Mai","value":676},{"label":"Jun","value":802},{"label":"Jul","value":779},{"label":"Ago","value":843},{"label":"Set","value":793},{"label":"Out","value":859},{"label":"Nov","value":709},{"label":"Dez","value":615}];
const MX = 981;
