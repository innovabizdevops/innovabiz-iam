...
const ACCENT = "#1e40af";
const MODULE = "AR Enterprise";
const PAGE = "Digital Overlay";
const KPIS = [{"l":"Total Ar Enterprise","v":"4.324","t":"+5.5%","d":"up"},{"l":"Digital Overlay Ativos","v":"6.816","t":"+13.8%","d":"up"},{"l":"Eficiência (%)","v":"85.8%","t":"+2.0%","d":"up"},{"l":"Score Performance","v":"93","t":"-3.6%","d":"down"}];
const COLS = ["ID","Digital Overlay","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ar Enterprise #001","Ar Enterprise #002","4.768","5.444","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Ar Enterprise #002","Ar Enterprise #003","3.001","8.961","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Ar Enterprise #003","Ar Enterprise #004","967","6.438","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Ar Enterprise #004","Ar Enterprise #005","3.781","1.507","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ar Enterprise #005","Ar Enterprise #001","5.756","497","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":620},{"label":"Mar","value":819},{"label":"Abr","value":866},{"label":"Mai","value":565},{"label":"Jun","value":832},{"label":"Jul","value":555},{"label":"Ago","value":616},{"label":"Set","value":929},{"label":"Out","value":927},{"label":"Nov","value":874},{"label":"Dez","value":816}];
const MX = 929;
