...
const PAGE = "Training AR";
const KPIS = [{"l":"Total Ar Enterprise","v":"7.207","t":"-3.8%","d":"down"},{"l":"Training AR Ativos","v":"5.603","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"88.7%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"67","t":"+9.9%","d":"up"}];
const COLS = ["ID","Training AR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ar Enterprise #001","Ar Enterprise #002","5.566","4.959","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Ar Enterprise #002","Ar Enterprise #003","5.131","4.752","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Ar Enterprise #003","Ar Enterprise #004","8.951","8.890","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Ar Enterprise #004","Ar Enterprise #005","6.117","7.889","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ar Enterprise #005","Ar Enterprise #001","3.176","6.388","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":254},{"label":"Fev","value":347},{"label":"Mar","value":429},{"label":"Abr","value":246},{"label":"Mai","value":536},{"label":"Jun","value":336},{"label":"Jul","value":555},{"label":"Ago","value":548},{"label":"Set","value":561},{"label":"Out","value":514},{"label":"Nov","value":427},{"label":"Dez","value":234}];
const MX = 561;
