...
const KPIS = [
    { label: "Total Registos", value: "5973", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2812", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€192K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "482155673", cells: ["SEC-8673", "Security Training Item 1", "14/6/2026", "€5773"], status: "active" as const },
    { id: "482159244", cells: ["SEC-3244", "Security Training Item 2", "1/1/2026", "€9344"], status: "pending" as const },
    { id: "482162815", cells: ["SEC-6815", "Security Training Item 3", "16/8/2026", "€12 915"], status: "completed" as const },
    { id: "482166386", cells: ["SEC-1386", "Security Training Item 4", "3/3/2026", "€16 486"], status: "warning" as const },
    { id: "482169957", cells: ["SEC-4957", "Security Training Item 5", "18/10/2026", "€20 057"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Security Training</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Security Training</p>
                    </div>
                </div>
