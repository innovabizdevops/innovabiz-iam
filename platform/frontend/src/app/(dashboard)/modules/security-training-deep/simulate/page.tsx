...
const PAGE = "Simulate";
const KPIS = [{"l":"Twins Ativos","v":"5.977","t":"+0.5%","d":"up"},{"l":"Simulações/Dia","v":"3783","t":"+16.4%","d":"up"},{"l":"Precisão Modelo (%)","v":"79.3%","t":"-5.3%","d":"down"},{"l":"Latência Sync (ms)","v":"184ms","t":"-3.2%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","89.1%","2026-01-18","3.744","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","86.1%","2026-01-15","7.141","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","89.5%","2026-03-13","7.308","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","97.4%","2026-03-18","8.309","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","81.4%","2026-01-24","7.851","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":377},{"label":"Mar","value":467},{"label":"Abr","value":695},{"label":"Mai","value":377},{"label":"Jun","value":684},{"label":"Jul","value":677},{"label":"Ago","value":377},{"label":"Set","value":667},{"label":"Out","value":512},{"label":"Nov","value":428},{"label":"Dez","value":529}];
const MX = 695;
