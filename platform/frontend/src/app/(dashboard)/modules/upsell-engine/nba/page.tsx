...
const KPIS = [{"l":"Total Upsell Engine","v":"7.636","t":"+8.3%","d":"up"},{"l":"Next Best Action Ativos","v":"8.833","t":"+7.2%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"73","t":"+2.6%","d":"up"}];
const COLS = ["ID","Next Best Action","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Upsell Engine #001","Upsell Engine #002","4.689","2.334","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Upsell Engine #002","Upsell Engine #003","1.003","7.177","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Upsell Engine #003","Upsell Engine #004","6.365","6.879","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Upsell Engine #004","Upsell Engine #005","1.101","575","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Upsell Engine #005","Upsell Engine #001","6.282","4.998","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":679},{"label":"Mar","value":609},{"label":"Abr","value":377},{"label":"Mai","value":397},{"label":"Jun","value":587},{"label":"Jul","value":599},{"label":"Ago","value":669},{"label":"Set","value":627},{"label":"Out","value":513},{"label":"Nov","value":697},{"label":"Dez","value":342}];
const MX = 697;
