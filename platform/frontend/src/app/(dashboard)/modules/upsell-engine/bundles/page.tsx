...
const PAGE = "Bundle Suggest";
const KPIS = [{"l":"Total Upsell Engine","v":"4.414","t":"-5.2%","d":"down"},{"l":"Bundle Suggest Ativos","v":"1.590","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"85.4%","t":"+14.0%","d":"up"},{"l":"Score Performance","v":"83","t":"-2.5%","d":"down"}];
const COLS = ["ID","Bundle Suggest","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Upsell Engine #001","Upsell Engine #002","7.511","7.337","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Upsell Engine #002","Upsell Engine #003","3.842","3.021","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Upsell Engine #003","Upsell Engine #004","4.050","573","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Upsell Engine #004","Upsell Engine #005","2.452","7.182","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Upsell Engine #005","Upsell Engine #001","5.343","2.154","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":334},{"label":"Fev","value":322},{"label":"Mar","value":392},{"label":"Abr","value":576},{"label":"Mai","value":397},{"label":"Jun","value":557},{"label":"Jul","value":636},{"label":"Ago","value":495},{"label":"Set","value":576},{"label":"Out","value":585},{"label":"Nov","value":458},{"label":"Dez","value":306}];
const MX = 636;
