...
const ACCENT = "#059669";
const MODULE = "Upsell & Cross-Sell";
const PAGE = "Recommendation AI";
const KPIS = [{"l":"Total Upsell Engine","v":"5.678","t":"+8.3%","d":"up"},{"l":"Recommendation AI Ativos","v":"5.134","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"72.9%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"59","t":"+16.5%","d":"up"}];
const COLS = ["ID","Recommendation AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Upsell Engine #001","Upsell Engine #002","8.193","4.496","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Upsell Engine #002","Upsell Engine #003","2.192","6.403","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Upsell Engine #003","Upsell Engine #004","7.895","3.713","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Upsell Engine #004","Upsell Engine #005","4.697","2.198","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Upsell Engine #005","Upsell Engine #001","210","7.543","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":655},{"label":"Mar","value":846},{"label":"Abr","value":462},{"label":"Mai","value":559},{"label":"Jun","value":478},{"label":"Jul","value":714},{"label":"Ago","value":576},{"label":"Set","value":545},{"label":"Out","value":690},{"label":"Nov","value":729},{"label":"Dez","value":835}];
const MX = 846;
