...
const PAGE = "Revenue Impact";
const KPIS = [{"l":"ARR (€M)","v":"€32.8M","t":"+12.0%","d":"up"},{"l":"MRR (€)","v":"€68737","t":"+10.6%","d":"up"},{"l":"Churn (%)","v":"70.4%","t":"-5.8%","d":"down"},{"l":"ARPU (€)","v":"€87232","t":"+3.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 15039.94","4.468","€ 41602.17","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 24194.41","461","€ 35783.98","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 4091.47","8.541","€ 30724.80","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 43399.99","832","€ 10528.93","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 40181.26","2.137","€ 48358.23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":842},{"label":"Mar","value":509},{"label":"Abr","value":722},{"label":"Mai","value":627},{"label":"Jun","value":710},{"label":"Jul","value":671},{"label":"Ago","value":663},{"label":"Set","value":835},{"label":"Out","value":581},{"label":"Nov","value":600},{"label":"Dez","value":741}];
const MX = 842;
