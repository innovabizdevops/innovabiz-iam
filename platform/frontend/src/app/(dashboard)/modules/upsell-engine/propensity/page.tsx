...
const PAGE = "Propensity Model";
const KPIS = [{"l":"Total Upsell Engine","v":"8.715","t":"-4.3%","d":"down"},{"l":"Propensity Model Ativos","v":"104","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"68.8%","t":"+8.4%","d":"up"},{"l":"Score Performance","v":"75","t":"+12.4%","d":"up"}];
const COLS = ["ID","Propensity Model","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Upsell Engine #001","Upsell Engine #002","767","3.951","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Upsell Engine #002","Upsell Engine #003","8.673","7.647","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Upsell Engine #003","Upsell Engine #004","3.855","5.245","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Upsell Engine #004","Upsell Engine #005","6.269","1.598","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Upsell Engine #005","Upsell Engine #001","5.675","5.845","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":491},{"label":"Fev","value":371},{"label":"Mar","value":419},{"label":"Abr","value":305},{"label":"Mai","value":494},{"label":"Jun","value":547},{"label":"Jul","value":324},{"label":"Ago","value":527},{"label":"Set","value":359},{"label":"Out","value":484},{"label":"Nov","value":370},{"label":"Dez","value":567}];
const MX = 567;
