...
const PAGE = "Produce";
const KPIS = [{"l":"Total Content Production","v":"8.813","t":"+14.5%","d":"up"},{"l":"Produce Ativos","v":"1.132","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"76.0%","t":"+7.6%","d":"up"},{"l":"Score Performance","v":"70","t":"+13.1%","d":"up"}];
const COLS = ["ID","Produce","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Content Production #001","Content Production #002","4.682","2.362","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Content Production #002","Content Production #003","7.542","7.304","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Content Production #003","Content Production #004","8.850","5.138","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Content Production #004","Content Production #005","3.272","7.429","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Content Production #005","Content Production #001","4.138","4.446","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":623},{"label":"Mar","value":523},{"label":"Abr","value":790},{"label":"Mai","value":578},{"label":"Jun","value":774},{"label":"Jul","value":587},{"label":"Ago","value":631},{"label":"Set","value":619},{"label":"Out","value":864},{"label":"Nov","value":729},{"label":"Dez","value":882}];
const MX = 882;
