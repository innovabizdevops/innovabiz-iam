...
const PAGE = "Publish";
const KPIS = [{"l":"Total Content Production","v":"7.990","t":"-5.2%","d":"down"},{"l":"Publish Ativos","v":"6.845","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"79.8%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"87","t":"+16.5%","d":"up"}];
const COLS = ["ID","Publish","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Content Production #001","Content Production #002","9.087","4.272","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Content Production #002","Content Production #003","5.101","8.514","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Content Production #003","Content Production #004","8.755","6.246","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Content Production #004","Content Production #005","5.664","4.326","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Content Production #005","Content Production #001","2.689","6.754","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":456},{"label":"Mar","value":681},{"label":"Abr","value":443},{"label":"Mai","value":437},{"label":"Jun","value":515},{"label":"Jul","value":379},{"label":"Ago","value":463},{"label":"Set","value":667},{"label":"Out","value":585},{"label":"Nov","value":571},{"label":"Dez","value":733}];
const MX = 733;
