...
const ACCENT = "#6d28d9";
const MODULE = "Content Production Platform";
const PAGE = "Edit";
const KPIS = [{"l":"Integrações Ativas","v":"8.940","t":"+16.7%","d":"up"},{"l":"Chamadas/Hora","v":"403","t":"+3.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"73.2%","t":"+12.6%","d":"up"},{"l":"Latência Média (ms)","v":"47ms","t":"+16.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.163","2.284","91.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","9.035","2.833","97.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.232","7.372","88.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.469","254","77.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.937","1.019","98.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":822},{"label":"Fev","value":630},{"label":"Mar","value":803},{"label":"Abr","value":781},{"label":"Mai","value":619},{"label":"Jun","value":677},{"label":"Jul","value":794},{"label":"Ago","value":744},{"label":"Set","value":905},{"label":"Out","value":934},{"label":"Nov","value":835},{"label":"Dez","value":961}];
const MX = 961;
