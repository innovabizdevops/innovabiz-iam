...
/* ═══ Content Production Platform — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "352", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2373", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€269K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1306899252", cells: ["CON-1252", "Content Production Platform Item 1", "9/1/2026", "€49 352"], status: "active" as const },
    { id: "1306902823", cells: ["CON-4823", "Content Production Platform Item 2", "24/8/2026", "€2923"], status: "pending" as const },
    { id: "1306906394", cells: ["CON-8394", "Content Production Platform Item 3", "11/3/2026", "€6494"], status: "completed" as const },
    { id: "1306909965", cells: ["CON-2965", "Content Production Platform Item 4", "26/10/2026", "€10 065"], status: "warning" as const },
    { id: "1306913536", cells: ["CON-6536", "Content Production Platform Item 5", "13/5/2026", "€13 636"], status: "active" as const },
];
...
export default function ContentProductionPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Content Production Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Content Production Platform</p>
                    </div>
                </div>
