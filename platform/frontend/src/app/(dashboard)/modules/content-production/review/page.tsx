...
const PAGE = "Review";
const KPIS = [{"l":"Total Content Production","v":"3.560","t":"+15.0%","d":"up"},{"l":"Review Ativos","v":"1.614","t":"-5.7%","d":"down"},{"l":"Eficiência (%)","v":"94.9%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"67","t":"+7.6%","d":"up"}];
const COLS = ["ID","Review","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Content Production #001","Content Production #002","2.857","3.377","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Content Production #002","Content Production #003","5.828","1.509","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Content Production #003","Content Production #004","3.682","4.902","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Content Production #004","Content Production #005","3.128","6.683","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Content Production #005","Content Production #001","4.604","2.601","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":854},{"label":"Fev","value":1052},{"label":"Mar","value":938},{"label":"Abr","value":671},{"label":"Mai","value":804},{"label":"Jun","value":695},{"label":"Jul","value":902},{"label":"Ago","value":863},{"label":"Set","value":850},{"label":"Out","value":862},{"label":"Nov","value":754},{"label":"Dez","value":846}];
const MX = 1052;
