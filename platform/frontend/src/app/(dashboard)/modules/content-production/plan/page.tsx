...
const PAGE = "Plan";
const KPIS = [{"l":"Total Content Production","v":"8.096","t":"-3.3%","d":"down"},{"l":"Plan Ativos","v":"2.046","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"68.4%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"68","t":"+16.5%","d":"up"}];
const COLS = ["ID","Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Content Production #001","Content Production #002","1.879","4.701","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Content Production #002","Content Production #003","882","5.824","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Content Production #003","Content Production #004","6.140","4.665","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Content Production #004","Content Production #005","8.997","1.147","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Content Production #005","Content Production #001","3.774","4.528","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":491},{"label":"Mar","value":385},{"label":"Abr","value":628},{"label":"Mai","value":553},{"label":"Jun","value":281},{"label":"Jul","value":294},{"label":"Ago","value":296},{"label":"Set","value":322},{"label":"Out","value":612},{"label":"Nov","value":453},{"label":"Dez","value":560}];
const MX = 655;
