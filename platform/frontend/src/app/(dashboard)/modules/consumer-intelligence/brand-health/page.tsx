...
/* ═══ Consumer Intel — Brand Health ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "4235", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "80", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1619", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1413019276", cells: ["CON-2276", "Brand Health Item 1", "5/5/2026", "€19 376"], status: "active" as const },
    { id: "1413022847", cells: ["CON-5847", "Brand Health Item 2", "20/12/2026", "€22 947"], status: "pending" as const },
    { id: "1413026418", cells: ["CON-9418", "Brand Health Item 3", "7/7/2026", "€26 518"], status: "completed" as const },
    { id: "1413029989", cells: ["CON-3989", "Brand Health Item 4", "22/2/2026", "€30 089"], status: "warning" as const },
    { id: "1413033560", cells: ["CON-7560", "Brand Health Item 5", "9/9/2026", "€33 660"], status: "active" as const },
];
...
export default function ConsumerIntelBrandHealthPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Brand Health</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Consumer Intel • Brand Health</p>
                    </div>
                </div>
