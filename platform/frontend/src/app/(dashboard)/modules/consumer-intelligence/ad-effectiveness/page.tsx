...
/* ═══ Consumer Intel — Ad Effectiveness ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "518", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "268", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1480", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "382770424", cells: ["CON-1424", "Ad Effectiveness Item 1", "9/5/2026", "€20 524"], status: "active" as const },
    { id: "382773995", cells: ["CON-4995", "Ad Effectiveness Item 2", "24/12/2026", "€24 095"], status: "pending" as const },
    { id: "382777566", cells: ["CON-8566", "Ad Effectiveness Item 3", "11/7/2026", "€27 666"], status: "completed" as const },
    { id: "382781137", cells: ["CON-3137", "Ad Effectiveness Item 4", "26/2/2026", "€31 237"], status: "warning" as const },
    { id: "382784708", cells: ["CON-6708", "Ad Effectiveness Item 5", "13/9/2026", "€34 808"], status: "active" as const },
];
...
export default function ConsumerIntelAdEffectivenessPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ad Effectiveness</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Consumer Intel • Ad Effectiveness</p>
                    </div>
                </div>
