...
/* ═══ Consumer Intel — Package Test ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "261", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "193", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "636", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1436102237", cells: ["CON-9237", "Package Test Item 1", "18/6/2026", "€2337"], status: "active" as const },
    { id: "1436105808", cells: ["CON-3808", "Package Test Item 2", "5/1/2026", "€5908"], status: "pending" as const },
    { id: "1436109379", cells: ["CON-7379", "Package Test Item 3", "20/8/2026", "€9479"], status: "completed" as const },
    { id: "1436112950", cells: ["CON-1950", "Package Test Item 4", "7/3/2026", "€13 050"], status: "warning" as const },
    { id: "1436116521", cells: ["CON-5521", "Package Test Item 5", "22/10/2026", "€16 621"], status: "active" as const },
];
...
export default function ConsumerIntelPackageTestPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Package Test</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Consumer Intel • Package Test</p>
                    </div>
                </div>
