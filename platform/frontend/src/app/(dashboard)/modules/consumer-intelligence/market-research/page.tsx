...
/* ═══ Consumer Intel — Market Research ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "4875", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "60", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "490", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1752744040", cells: ["CON-4040", "Market Research Item 1", "13/5/2026", "€44 140"], status: "active" as const },
    { id: "1752747611", cells: ["CON-7611", "Market Research Item 2", "28/12/2026", "€47 711"], status: "pending" as const },
    { id: "1752751182", cells: ["CON-2182", "Market Research Item 3", "15/7/2026", "€1282"], status: "completed" as const },
    { id: "1752754753", cells: ["CON-5753", "Market Research Item 4", "2/2/2026", "€4853"], status: "warning" as const },
    { id: "1752758324", cells: ["CON-9324", "Market Research Item 5", "17/9/2026", "€8424"], status: "active" as const },
];
...
export default function ConsumerIntelMarketResearchPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Market Research</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Consumer Intel • Market Research</p>
                    </div>
                </div>
