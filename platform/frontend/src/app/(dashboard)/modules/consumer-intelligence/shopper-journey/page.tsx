...
/* ═══ Consumer Intel — Shopper Journey ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "1043", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "20", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1536", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1159642576", cells: ["CON-2576", "Shopper Journey Item 1", "9/5/2026", "€42 676"], status: "active" as const },
    { id: "1159646147", cells: ["CON-6147", "Shopper Journey Item 2", "24/12/2026", "€46 247"], status: "pending" as const },
    { id: "1159649718", cells: ["CON-9718", "Shopper Journey Item 3", "11/7/2026", "€49 818"], status: "completed" as const },
    { id: "1159653289", cells: ["CON-4289", "Shopper Journey Item 4", "26/2/2026", "€3389"], status: "warning" as const },
    { id: "1159656860", cells: ["CON-7860", "Shopper Journey Item 5", "13/9/2026", "€6960"], status: "active" as const },
];
...
export default function ConsumerIntelShopperJourneyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Shopper Journey</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Consumer Intel • Shopper Journey</p>
                    </div>
                </div>
