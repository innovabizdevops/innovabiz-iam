...
/* ═══ Consumer Intel — Product Launch ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "4137", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "41", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "641", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1715619909", cells: ["CON-4909", "Product Launch Item 1", "18/10/2026", "€20 009"], status: "active" as const },
    { id: "1715623480", cells: ["CON-8480", "Product Launch Item 2", "5/5/2026", "€23 580"], status: "pending" as const },
    { id: "1715627051", cells: ["CON-3051", "Product Launch Item 3", "20/12/2026", "€27 151"], status: "completed" as const },
    { id: "1715630622", cells: ["CON-6622", "Product Launch Item 4", "7/7/2026", "€30 722"], status: "warning" as const },
    { id: "1715634193", cells: ["CON-1193", "Product Launch Item 5", "22/2/2026", "€34 293"], status: "active" as const },
];
...
export default function ConsumerIntelProductLaunchPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Product Launch</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Consumer Intel • Product Launch</p>
                    </div>
                </div>
