...
/* ═══ Consumer Intel — Trend Forecast ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "666", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "271", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2835", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2012728107", cells: ["CON-5107", "Trend Forecast Item 1", "20/4/2026", "€28 207"], status: "active" as const },
    { id: "2012731678", cells: ["CON-8678", "Trend Forecast Item 2", "7/11/2026", "€31 778"], status: "pending" as const },
    { id: "2012735249", cells: ["CON-3249", "Trend Forecast Item 3", "22/6/2026", "€35 349"], status: "completed" as const },
    { id: "2012738820", cells: ["CON-6820", "Trend Forecast Item 4", "9/1/2026", "€38 920"], status: "warning" as const },
    { id: "2012742391", cells: ["CON-1391", "Trend Forecast Item 5", "24/8/2026", "€42 491"], status: "active" as const },
];
...
export default function ConsumerIntelTrendForecastPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Trend Forecast</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Consumer Intel • Trend Forecast</p>
                    </div>
                </div>
