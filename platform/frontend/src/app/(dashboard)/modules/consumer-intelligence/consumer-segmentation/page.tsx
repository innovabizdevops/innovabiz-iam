...
/* ═══ Consumer Intel — Consumer Segmentation ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "3716", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "169", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2369", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "72%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "876106805", cells: ["CON-2805", "Consumer Segmentation Item 1", "22/6/2026", "€6905"], status: "active" as const },
    { id: "876110376", cells: ["CON-6376", "Consumer Segmentation Item 2", "9/1/2026", "€10 476"], status: "pending" as const },
    { id: "876113947", cells: ["CON-9947", "Consumer Segmentation Item 3", "24/8/2026", "€14 047"], status: "completed" as const },
    { id: "876117518", cells: ["CON-4518", "Consumer Segmentation Item 4", "11/3/2026", "€17 618"], status: "warning" as const },
    { id: "876121089", cells: ["CON-8089", "Consumer Segmentation Item 5", "26/10/2026", "€21 189"], status: "active" as const },
];
...
export default function ConsumerIntelConsumerSegmentationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Consumer Segmentation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Consumer Intel • Consumer Segmentation</p>
                    </div>
                </div>
