...
/* ═══ Consumer Intel — Competitive Intel ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "4523", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "210", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3663", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "53694702", cells: ["CON-1702", "Competitive Intel Item 1", "27/7/2026", "€44 802"], status: "active" as const },
    { id: "53698273", cells: ["CON-5273", "Competitive Intel Item 2", "14/2/2026", "€48 373"], status: "pending" as const },
    { id: "53701844", cells: ["CON-8844", "Competitive Intel Item 3", "1/9/2026", "€1944"], status: "completed" as const },
    { id: "53705415", cells: ["CON-3415", "Competitive Intel Item 4", "16/4/2026", "€5515"], status: "warning" as const },
    { id: "53708986", cells: ["CON-6986", "Competitive Intel Item 5", "3/11/2026", "€9086"], status: "active" as const },
];
...
export default function ConsumerIntelCompetitiveIntelPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Competitive Intel</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Consumer Intel • Competitive Intel</p>
                    </div>
                </div>
