...
/* ═══ Consumer Intel — Panel Analytics ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "1340", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "167", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2345", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "82%", trend: "-23%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "319258515", cells: ["CON-2515", "Panel Analytics Item 1", "24/4/2026", "€8615"], status: "active" as const },
    { id: "319262086", cells: ["CON-6086", "Panel Analytics Item 2", "11/11/2026", "€12 186"], status: "pending" as const },
    { id: "319265657", cells: ["CON-9657", "Panel Analytics Item 3", "26/6/2026", "€15 757"], status: "completed" as const },
    { id: "319269228", cells: ["CON-4228", "Panel Analytics Item 4", "13/1/2026", "€19 328"], status: "warning" as const },
    { id: "319272799", cells: ["CON-7799", "Panel Analytics Item 5", "28/8/2026", "€22 899"], status: "active" as const },
];
...
export default function ConsumerIntelPanelAnalyticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Panel Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Consumer Intel • Panel Analytics</p>
                    </div>
                </div>
