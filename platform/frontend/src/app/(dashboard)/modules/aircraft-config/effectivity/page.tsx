...
const ACCENT = "#6366f1";
const MODULE = "Aircraft Configuration";
const PAGE = "Effectivity";
const KPIS = [{"l":"Configurações","v":"8.978","t":"+2.0%","d":"up"},{"l":"Últimas Alterações","v":"7.699","t":"-1.8%","d":"down"},{"l":"Ambientes","v":"1.017","t":"+6.6%","d":"up"},{"l":"Versão Config","v":"4.571","t":"+9.5%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 32648.34","4.431","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 13413.66","2.571","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 38877.46","1.661","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 34474.85","8.679","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 45943.82","357","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":423},{"label":"Fev","value":336},{"label":"Mar","value":599},{"label":"Abr","value":363},{"label":"Mai","value":448},{"label":"Jun","value":691},{"label":"Jul","value":512},{"label":"Ago","value":597},{"label":"Set","value":686},{"label":"Out","value":323},{"label":"Nov","value":563},{"label":"Dez","value":586}];
const MX = 691;
...
export default function EffectivityPage() {
    return (
