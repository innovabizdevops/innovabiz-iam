...
const KPIS = [{"l":"Configurações","v":"8.758","t":"+2.2%","d":"up"},{"l":"Últimas Alterações","v":"8.026","t":"+9.0%","d":"up"},{"l":"Ambientes","v":"6.884","t":"+16.5%","d":"up"},{"l":"Versão Config","v":"7.035","t":"+2.5%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 34145.85","7.239","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 2093.29","2.379","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 16989.17","3.499","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 36159.43","732","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 17713.44","5.392","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":514},{"label":"Mar","value":562},{"label":"Abr","value":469},{"label":"Mai","value":650},{"label":"Jun","value":596},{"label":"Jul","value":485},{"label":"Ago","value":665},{"label":"Set","value":450},{"label":"Out","value":479},{"label":"Nov","value":755},{"label":"Dez","value":480}];
const MX = 755;
