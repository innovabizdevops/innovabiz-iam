...
const PAGE = "SB/AD";
const KPIS = [{"l":"Configurações","v":"3.376","t":"-5.3%","d":"down"},{"l":"Últimas Alterações","v":"8.953","t":"-1.5%","d":"down"},{"l":"Ambientes","v":"3.731","t":"+3.9%","d":"up"},{"l":"Versão Config","v":"8.399","t":"+5.2%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 9756.17","4.278","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 13363.02","1.450","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 454.28","2.482","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 19841.83","7.990","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 13608.21","8.487","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":525},{"label":"Mar","value":822},{"label":"Abr","value":805},{"label":"Mai","value":543},{"label":"Jun","value":459},{"label":"Jul","value":490},{"label":"Ago","value":687},{"label":"Set","value":783},{"label":"Out","value":788},{"label":"Nov","value":714},{"label":"Dez","value":537}];
const MX = 822;
