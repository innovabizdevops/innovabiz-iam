...
const PAGE = "Record";
const KPIS = [{"l":"Configurações","v":"7.563","t":"+16.1%","d":"up"},{"l":"Últimas Alterações","v":"925","t":"+1.2%","d":"up"},{"l":"Ambientes","v":"491","t":"+5.4%","d":"up"},{"l":"Versão Config","v":"715","t":"-6.0%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 42682.87","1.270","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 18139.13","5.504","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 15685.27","1.476","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 9076.26","2.577","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 10648.75","6.549","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":780},{"label":"Fev","value":921},{"label":"Mar","value":705},{"label":"Abr","value":968},{"label":"Mai","value":901},{"label":"Jun","value":749},{"label":"Jul","value":734},{"label":"Ago","value":907},{"label":"Set","value":906},{"label":"Out","value":766},{"label":"Nov","value":1056},{"label":"Dez","value":1054}];
const MX = 1056;
