...
const PAGE = "Mod";
const KPIS = [{"l":"Configurações","v":"7.103","t":"+0.9%","d":"up"},{"l":"Últimas Alterações","v":"5.446","t":"+12.2%","d":"up"},{"l":"Ambientes","v":"8.928","t":"+7.0%","d":"up"},{"l":"Versão Config","v":"3.803","t":"+5.4%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 40019.38","7.183","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 21684.80","113","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 28431.56","8.130","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 47667.04","6.608","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 11458.71","3.729","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":622},{"label":"Mar","value":621},{"label":"Abr","value":895},{"label":"Mai","value":578},{"label":"Jun","value":690},{"label":"Jul","value":956},{"label":"Ago","value":924},{"label":"Set","value":623},{"label":"Out","value":714},{"label":"Nov","value":929},{"label":"Dez","value":846}];
const MX = 956;
