...
export default function AircraftConfigPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Aircraft Config</h1><p className="text-sm text-muted-foreground">Aircraft Config • iBOS Enterprise</p></div>
