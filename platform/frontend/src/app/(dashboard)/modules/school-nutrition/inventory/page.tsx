...
const KPIS = [{"l":"Total School Nutrition","v":"6.556","t":"+7.0%","d":"up"},{"l":"Inventory Ativos","v":"1.627","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"73.8%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"84","t":"+5.7%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["School Nutrition #001","School Nutrition #002","2.205","3.922","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["School Nutrition #002","School Nutrition #003","1.301","4.852","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["School Nutrition #003","School Nutrition #004","584","1.272","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["School Nutrition #004","School Nutrition #005","702","7.520","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["School Nutrition #005","School Nutrition #001","2.526","4.255","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":714},{"label":"Mar","value":906},{"label":"Abr","value":542},{"label":"Mai","value":561},{"label":"Jun","value":854},{"label":"Jul","value":520},{"label":"Ago","value":744},{"label":"Set","value":808},{"label":"Out","value":662},{"label":"Nov","value":835},{"label":"Dez","value":719}];
const MX = 906;
