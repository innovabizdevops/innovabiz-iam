...
const ACCENT = "#6366f1";
const MODULE = "School Nutrition";
const PAGE = "Free/Reduced";
const KPIS = [{"l":"Total School Nutrition","v":"2.741","t":"+15.4%","d":"up"},{"l":"Free/Reduced Ativos","v":"2.972","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"89.5%","t":"+4.5%","d":"up"},{"l":"Score Performance","v":"91","t":"+16.4%","d":"up"}];
const COLS = ["ID","Free/Reduced","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["School Nutrition #001","School Nutrition #002","2.622","7.547","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["School Nutrition #002","School Nutrition #003","5.538","1.163","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["School Nutrition #003","School Nutrition #004","1.644","5.582","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["School Nutrition #004","School Nutrition #005","8.635","6.393","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["School Nutrition #005","School Nutrition #001","6.467","1.119","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":415},{"label":"Mar","value":282},{"label":"Abr","value":548},{"label":"Mai","value":232},{"label":"Jun","value":590},{"label":"Jul","value":339},{"label":"Ago","value":574},{"label":"Set","value":406},{"label":"Out","value":615},{"label":"Nov","value":267},{"label":"Dez","value":510}];
const MX = 615;
