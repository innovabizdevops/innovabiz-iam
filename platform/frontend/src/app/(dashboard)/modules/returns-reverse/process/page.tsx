...
const PAGE = "Process";
const KPIS = [{"l":"Total Returns Reverse","v":"5.710","t":"+13.9%","d":"up"},{"l":"Process Ativos","v":"6.454","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"77.5%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"79","t":"+16.2%","d":"up"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Returns Reverse #001","Returns Reverse #002","7.733","6.893","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Returns Reverse #002","Returns Reverse #003","4.976","2.150","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Returns Reverse #003","Returns Reverse #004","1.497","1.017","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Returns Reverse #004","Returns Reverse #005","3.843","4.805","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Returns Reverse #005","Returns Reverse #001","1.448","899","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":512},{"label":"Mar","value":707},{"label":"Abr","value":810},{"label":"Mai","value":785},{"label":"Jun","value":822},{"label":"Jul","value":560},{"label":"Ago","value":490},{"label":"Set","value":744},{"label":"Out","value":764},{"label":"Nov","value":493},{"label":"Dez","value":495}];
const MX = 822;
