...
const ACCENT = "#0891b2";
const MODULE = "Returns & Reverse Logistics";
const PAGE = "Insight";
const KPIS = [{"l":"Total Returns Reverse","v":"340","t":"-3.5%","d":"down"},{"l":"Insight Ativos","v":"1.793","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"90.7%","t":"+3.5%","d":"up"},{"l":"Score Performance","v":"75","t":"+17.6%","d":"up"}];
const COLS = ["ID","Insight","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Returns Reverse #001","Returns Reverse #002","5.304","1.065","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Returns Reverse #002","Returns Reverse #003","5.857","8.523","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Returns Reverse #003","Returns Reverse #004","2.585","8.911","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Returns Reverse #004","Returns Reverse #005","3.242","2.384","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Returns Reverse #005","Returns Reverse #001","3.626","7.498","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":624},{"label":"Mar","value":764},{"label":"Abr","value":743},{"label":"Mai","value":748},{"label":"Jun","value":726},{"label":"Jul","value":543},{"label":"Ago","value":804},{"label":"Set","value":549},{"label":"Out","value":757},{"label":"Nov","value":792},{"label":"Dez","value":897}];
const MX = 897;
