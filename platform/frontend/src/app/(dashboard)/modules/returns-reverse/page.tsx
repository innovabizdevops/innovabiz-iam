...
/* ═══ Returns & Reverse Logistics — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "5763", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "266", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€331K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2108230463", cells: ["RET-8463", "Returns & Reverse Logistics Item 1", "4/12/2026", "€30 563"], status: "active" as const },
    { id: "2108234034", cells: ["RET-3034", "Returns & Reverse Logistics Item 2", "19/7/2026", "€34 134"], status: "pending" as const },
    { id: "2108237605", cells: ["RET-6605", "Returns & Reverse Logistics Item 3", "6/2/2026", "€37 705"], status: "completed" as const },
    { id: "2108241176", cells: ["RET-1176", "Returns & Reverse Logistics Item 4", "21/9/2026", "€41 276"], status: "warning" as const },
    { id: "2108244747", cells: ["RET-4747", "Returns & Reverse Logistics Item 5", "8/4/2026", "€44 847"], status: "active" as const },
];
...
export default function ReturnsReverseLogisticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Returns & Reverse Logistics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Returns & Reverse Logistics</p>
                    </div>
                </div>
