...
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"8.602","t":"+12.5%","d":"up"},{"l":"Taxa Entrega (%)","v":"89.6%","t":"+10.5%","d":"up"},{"l":"Taxa Abertura (%)","v":"82.4%","t":"+9.7%","d":"up"},{"l":"Escalações","v":"3.530","t":"+14.4%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","2.230","78.7%","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","1.555","77.7%","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","8.138","77.4%","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","4.023","96.5%","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","5.551","79.6%","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":947},{"label":"Fev","value":803},{"label":"Mar","value":1016},{"label":"Abr","value":821},{"label":"Mai","value":910},{"label":"Jun","value":874},{"label":"Jul","value":751},{"label":"Ago","value":885},{"label":"Set","value":700},{"label":"Out","value":747},{"label":"Nov","value":806},{"label":"Dez","value":783}];
const MX = 1016;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4c1d95'}}>RTM</span></h1>
                </div>
