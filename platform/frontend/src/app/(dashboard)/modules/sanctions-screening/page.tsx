...
/* ═══ Sanctions Screening Deep — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "4512", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1497", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€248K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "929119412", cells: ["SAN-5412", "Sanctions Screening Deep Item 1", "5/9/2026", "€19 512"], status: "active" as const },
    { id: "929122983", cells: ["SAN-8983", "Sanctions Screening Deep Item 2", "20/4/2026", "€23 083"], status: "pending" as const },
    { id: "929126554", cells: ["SAN-3554", "Sanctions Screening Deep Item 3", "7/11/2026", "€26 654"], status: "completed" as const },
    { id: "929130125", cells: ["SAN-7125", "Sanctions Screening Deep Item 4", "22/6/2026", "€30 225"], status: "warning" as const },
    { id: "929133696", cells: ["SAN-1696", "Sanctions Screening Deep Item 5", "9/1/2026", "€33 796"], status: "active" as const },
];
...
export default function SanctionsScreeningDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sanctions Screening Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Sanctions Screening Deep</p>
                    </div>
                </div>
