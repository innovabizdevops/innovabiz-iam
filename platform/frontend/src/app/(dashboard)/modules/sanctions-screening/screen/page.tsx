...
const ACCENT = "#4c1d95";
const MODULE = "Sanctions Screening Deep";
const PAGE = "Screen";
const KPIS = [{"l":"Total Sanctions Screening","v":"3.652","t":"+14.0%","d":"up"},{"l":"Screen Ativos","v":"8.066","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"73.7%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"85","t":"+7.8%","d":"up"}];
const COLS = ["ID","Screen","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sanctions Screening #001","Sanctions Screening #002","8.283","2.658","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Sanctions Screening #002","Sanctions Screening #003","6.526","3.728","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Sanctions Screening #003","Sanctions Screening #004","3.818","2.006","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Sanctions Screening #004","Sanctions Screening #005","8.067","340","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sanctions Screening #005","Sanctions Screening #001","2.320","5.099","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":442},{"label":"Fev","value":463},{"label":"Mar","value":539},{"label":"Abr","value":614},{"label":"Mai","value":538},{"label":"Jun","value":484},{"label":"Jul","value":388},{"label":"Ago","value":352},{"label":"Set","value":328},{"label":"Out","value":425},{"label":"Nov","value":620},{"label":"Dez","value":668}];
const MX = 668;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4c1d95'}}>AI</span></h1>
                </div>
