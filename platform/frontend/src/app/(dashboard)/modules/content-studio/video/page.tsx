...
const PAGE = "Video Editor";
const KPIS = [{"l":"Integrações Ativas","v":"4.865","t":"+8.8%","d":"up"},{"l":"Chamadas/Hora","v":"3747","t":"+4.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.7%","t":"+8.0%","d":"up"},{"l":"Latência Média (ms)","v":"189ms","t":"+16.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.565","5.955","79.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.921","3.980","80.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","636","4.929","83.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","654","8.029","92.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","455","6.852","77.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":737},{"label":"Mar","value":776},{"label":"Abr","value":727},{"label":"Mai","value":553},{"label":"Jun","value":585},{"label":"Jul","value":682},{"label":"Ago","value":585},{"label":"Set","value":557},{"label":"Out","value":618},{"label":"Nov","value":705},{"label":"Dez","value":883}];
const MX = 883;
