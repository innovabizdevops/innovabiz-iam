...
const ACCENT = "#fb923c";
const MODULE = "Content Studio";
const PAGE = "Publish Flow";
const KPIS = [{"l":"Total Content Studio","v":"5.873","t":"-2.0%","d":"down"},{"l":"Publish Flow Ativos","v":"7.994","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"95.0%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"59","t":"+7.5%","d":"up"}];
const COLS = ["ID","Publish Flow","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Content Studio #001","Content Studio #002","2.126","5.897","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Content Studio #002","Content Studio #003","1.177","4.676","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Content Studio #003","Content Studio #004","305","8.924","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Content Studio #004","Content Studio #005","8.118","2.293","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Content Studio #005","Content Studio #001","752","3.805","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":968},{"label":"Mar","value":930},{"label":"Abr","value":900},{"label":"Mai","value":925},{"label":"Jun","value":803},{"label":"Jul","value":655},{"label":"Ago","value":984},{"label":"Set","value":718},{"label":"Out","value":741},{"label":"Nov","value":734},{"label":"Dez","value":819}];
const MX = 984;
