...
const PAGE = "Advance";
const KPIS = [{"l":"Total Invoice Finance","v":"347","t":"-3.8%","d":"down"},{"l":"Advance Ativos","v":"6.287","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"77.3%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"59","t":"+13.7%","d":"up"}];
const COLS = ["ID","Advance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Invoice Finance #001","Invoice Finance #002","2.929","7.351","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Invoice Finance #002","Invoice Finance #003","4.350","5.961","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Invoice Finance #003","Invoice Finance #004","8.333","2.267","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Invoice Finance #004","Invoice Finance #005","1.750","246","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Invoice Finance #005","Invoice Finance #001","8.789","8.995","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":689},{"label":"Fev","value":621},{"label":"Mar","value":485},{"label":"Abr","value":699},{"label":"Mai","value":463},{"label":"Jun","value":413},{"label":"Jul","value":689},{"label":"Ago","value":407},{"label":"Set","value":355},{"label":"Out","value":546},{"label":"Nov","value":581},{"label":"Dez","value":601}];
const MX = 699;
