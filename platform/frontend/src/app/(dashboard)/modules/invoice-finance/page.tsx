...
const KPIS = [
    { label: "Total Registos", value: "4079", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2977", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€140K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1351146079", cells: ["INV-4079", "Invoice Finance Item 1", "4/8/2026", "€46 179"], status: "active" as const },
    { id: "1351149650", cells: ["INV-7650", "Invoice Finance Item 2", "19/3/2026", "€49 750"], status: "pending" as const },
    { id: "1351153221", cells: ["INV-2221", "Invoice Finance Item 3", "6/10/2026", "€3321"], status: "completed" as const },
    { id: "1351156792", cells: ["INV-5792", "Invoice Finance Item 4", "21/5/2026", "€6892"], status: "warning" as const },
    { id: "1351160363", cells: ["INV-9363", "Invoice Finance Item 5", "8/12/2026", "€10 463"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Invoice Finance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Invoice Finance</p>
                    </div>
                </div>
