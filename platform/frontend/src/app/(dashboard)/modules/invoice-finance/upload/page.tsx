...
const PAGE = "Upload";
const KPIS = [{"l":"Total Invoice Finance","v":"8.021","t":"-2.4%","d":"down"},{"l":"Upload Ativos","v":"8.057","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"76.2%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"74","t":"-0.9%","d":"down"}];
const COLS = ["ID","Upload","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Invoice Finance #001","Invoice Finance #002","7.743","7.647","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Invoice Finance #002","Invoice Finance #003","8.727","6.051","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Invoice Finance #003","Invoice Finance #004","3.953","6.144","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Invoice Finance #004","Invoice Finance #005","4.758","5.856","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Invoice Finance #005","Invoice Finance #001","6.397","7.763","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":593},{"label":"Mar","value":597},{"label":"Abr","value":541},{"label":"Mai","value":536},{"label":"Jun","value":443},{"label":"Jul","value":678},{"label":"Ago","value":455},{"label":"Set","value":599},{"label":"Out","value":754},{"label":"Nov","value":613},{"label":"Dez","value":766}];
const MX = 766;
