...
const PAGE = "Report";
const KPIS = [{"l":"Total Invoice Finance","v":"5.822","t":"+10.8%","d":"up"},{"l":"Report Ativos","v":"6.204","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"75.0%","t":"-5.1%","d":"down"},{"l":"Score Performance","v":"67","t":"+5.8%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Invoice Finance #001","Invoice Finance #002","2.451","8.732","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Invoice Finance #002","Invoice Finance #003","1.847","3.357","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Invoice Finance #003","Invoice Finance #004","6.459","2.680","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Invoice Finance #004","Invoice Finance #005","1.950","7.597","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Invoice Finance #005","Invoice Finance #001","6.422","1.719","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":891},{"label":"Fev","value":790},{"label":"Mar","value":887},{"label":"Abr","value":828},{"label":"Mai","value":782},{"label":"Jun","value":586},{"label":"Jul","value":567},{"label":"Ago","value":587},{"label":"Set","value":770},{"label":"Out","value":823},{"label":"Nov","value":807},{"label":"Dez","value":663}];
const MX = 891;
