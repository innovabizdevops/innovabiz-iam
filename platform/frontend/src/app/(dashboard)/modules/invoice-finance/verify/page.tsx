...
const ACCENT = "#1d4ed8";
const MODULE = "Invoice Finance";
const PAGE = "Verify";
const KPIS = [{"l":"Total Invoice Finance","v":"1.406","t":"+5.8%","d":"up"},{"l":"Verify Ativos","v":"483","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"80.4%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"67","t":"+15.7%","d":"up"}];
const COLS = ["ID","Verify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Invoice Finance #001","Invoice Finance #002","6.115","326","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Invoice Finance #002","Invoice Finance #003","226","3.537","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Invoice Finance #003","Invoice Finance #004","8.754","6.613","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Invoice Finance #004","Invoice Finance #005","1.046","2.364","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Invoice Finance #005","Invoice Finance #001","5.633","7.470","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":800},{"label":"Mar","value":824},{"label":"Abr","value":885},{"label":"Mai","value":517},{"label":"Jun","value":586},{"label":"Jul","value":618},{"label":"Ago","value":553},{"label":"Set","value":686},{"label":"Out","value":605},{"label":"Nov","value":553},{"label":"Dez","value":515}];
const MX = 885;
