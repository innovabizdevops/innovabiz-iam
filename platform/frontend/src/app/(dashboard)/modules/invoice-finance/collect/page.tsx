...
const PAGE = "Collect";
const KPIS = [{"l":"Total Invoice Finance","v":"496","t":"+14.1%","d":"up"},{"l":"Collect Ativos","v":"2.755","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"73.0%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"65","t":"+6.4%","d":"up"}];
const COLS = ["ID","Collect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Invoice Finance #001","Invoice Finance #002","2.717","9.091","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Invoice Finance #002","Invoice Finance #003","2.220","6.180","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Invoice Finance #003","Invoice Finance #004","6.319","1.776","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Invoice Finance #004","Invoice Finance #005","1.116","7.163","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Invoice Finance #005","Invoice Finance #001","3.800","9.038","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1037},{"label":"Fev","value":752},{"label":"Mar","value":849},{"label":"Abr","value":1001},{"label":"Mai","value":862},{"label":"Jun","value":780},{"label":"Jul","value":1055},{"label":"Ago","value":929},{"label":"Set","value":791},{"label":"Out","value":814},{"label":"Nov","value":677},{"label":"Dez","value":699}];
const MX = 1055;
