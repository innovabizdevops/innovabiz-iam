...
const KPIS = [{"l":"Dashboards Ativos","v":"232","t":"+2.1%","d":"up"},{"l":"Queries/Dia","v":"588","t":"+15.9%","d":"up"},{"l":"Dados Processados (GB)","v":"179","t":"+8.5%","d":"up"},{"l":"Utilizadores Analytics","v":"2.120","t":"+13.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4959","2026-02-04","707","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4697","2026-01-18","1.471","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4321","2026-03-23","7.093","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1241","2026-01-15","7.047","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","143","2026-03-09","5.532","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":426},{"label":"Fev","value":412},{"label":"Mar","value":702},{"label":"Abr","value":356},{"label":"Mai","value":572},{"label":"Jun","value":653},{"label":"Jul","value":403},{"label":"Ago","value":362},{"label":"Set","value":346},{"label":"Out","value":382},{"label":"Nov","value":581},{"label":"Dez","value":418}];
const MX = 702;
