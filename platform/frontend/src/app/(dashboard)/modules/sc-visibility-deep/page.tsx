...
/* ═══ SC Visibility & Track Deep — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "7321", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3556", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€341K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1358732721", cells: ["SC-3721", "SC Visibility & Track Deep Item 1", "18/10/2026", "€32 821"], status: "active" as const },
    { id: "1358736292", cells: ["SC-7292", "SC Visibility & Track Deep Item 2", "5/5/2026", "€36 392"], status: "pending" as const },
    { id: "1358739863", cells: ["SC-1863", "SC Visibility & Track Deep Item 3", "20/12/2026", "€39 963"], status: "completed" as const },
    { id: "1358743434", cells: ["SC-5434", "SC Visibility & Track Deep Item 4", "7/7/2026", "€43 534"], status: "warning" as const },
    { id: "1358747005", cells: ["SC-9005", "SC Visibility & Track Deep Item 5", "22/2/2026", "€47 105"], status: "active" as const },
];
...
export default function ScVisibilityTrackDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC Visibility & Track Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC Visibility & Track Deep</p>
                    </div>
                </div>
