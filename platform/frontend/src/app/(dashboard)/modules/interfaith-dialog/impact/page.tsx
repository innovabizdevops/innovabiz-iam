...
const PAGE = "Impact";
const KPIS = [{"l":"Projetos Sociais","v":"2.090","t":"+15.0%","d":"up"},{"l":"Beneficiários","v":"7.757","t":"+1.4%","d":"up"},{"l":"Investimento CSR (€)","v":"€90107","t":"+5.6%","d":"up"},{"l":"Score Impacto","v":"66","t":"+17.1%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","1.420","€ 46062.51","5.078","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","335","€ 31317.34","6.828","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","5.562","€ 3528.02","3.043","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","1.528","€ 7532.90","2.714","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","571","€ 17743.57","6.238","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":886},{"label":"Mar","value":799},{"label":"Abr","value":655},{"label":"Mai","value":765},{"label":"Jun","value":846},{"label":"Jul","value":781},{"label":"Ago","value":594},{"label":"Set","value":795},{"label":"Out","value":592},{"label":"Nov","value":865},{"label":"Dez","value":818}];
const MX = 886;
