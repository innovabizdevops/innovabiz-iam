...
const ACCENT = "#5b21b6";
const MODULE = "Interfaith Dialogue";
const PAGE = "Resource";
const KPIS = [{"l":"Total Interfaith Dialog","v":"3.254","t":"-1.4%","d":"down"},{"l":"Resource Ativos","v":"8.203","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"83","t":"+5.1%","d":"up"}];
const COLS = ["ID","Resource","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Interfaith Dialog #001","Interfaith Dialog #002","620","5.720","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Interfaith Dialog #002","Interfaith Dialog #003","4.644","4.183","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Interfaith Dialog #003","Interfaith Dialog #004","6.565","6.201","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Interfaith Dialog #004","Interfaith Dialog #005","6.106","7.907","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Interfaith Dialog #005","Interfaith Dialog #001","5.387","2.205","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":797},{"label":"Mar","value":821},{"label":"Abr","value":674},{"label":"Mai","value":691},{"label":"Jun","value":830},{"label":"Jul","value":830},{"label":"Ago","value":769},{"label":"Set","value":705},{"label":"Out","value":604},{"label":"Nov","value":842},{"label":"Dez","value":593}];
const MX = 842;
