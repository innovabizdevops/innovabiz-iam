...
/* ═══ Interfaith Dialogue — Dashboard ═══ */

const ACCENT = "#5b21b6";

const KPIS = [
    { label: "Total Registos", value: "6614", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2613", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€287K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "647723914", cells: ["INT-3914", "Interfaith Dialogue Item 1", "27/11/2026", "€24 014"], status: "active" as const },
    { id: "647727485", cells: ["INT-7485", "Interfaith Dialogue Item 2", "14/6/2026", "€27 585"], status: "pending" as const },
    { id: "647731056", cells: ["INT-2056", "Interfaith Dialogue Item 3", "1/1/2026", "€31 156"], status: "completed" as const },
    { id: "647734627", cells: ["INT-5627", "Interfaith Dialogue Item 4", "16/8/2026", "€34 727"], status: "warning" as const },
    { id: "647738198", cells: ["INT-9198", "Interfaith Dialogue Item 5", "3/3/2026", "€38 298"], status: "active" as const },
];
...
export default function InterfaithDialoguePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Interfaith Dialogue</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Interfaith Dialogue</p>
                    </div>
                </div>
