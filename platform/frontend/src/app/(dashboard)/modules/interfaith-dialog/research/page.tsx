...
const PAGE = "Research";
const KPIS = [{"l":"Ideias Submetidas","v":"2.647","t":"+9.9%","d":"up"},{"l":"Patentes (YTD)","v":"2.863","t":"+0.1%","d":"up"},{"l":"Projetos Innovation Lab","v":"2.277","t":"+7.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€37.4M","t":"+16.6%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","5.149","71.2%","2.861","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.599","94.9%","4.910","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.434","70.4%","4.512","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","1.717","97.5%","702","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","337","90.3%","6.998","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":316},{"label":"Fev","value":684},{"label":"Mar","value":679},{"label":"Abr","value":560},{"label":"Mai","value":657},{"label":"Jun","value":475},{"label":"Jul","value":358},{"label":"Ago","value":612},{"label":"Set","value":525},{"label":"Out","value":624},{"label":"Nov","value":459},{"label":"Dez","value":394}];
const MX = 684;
