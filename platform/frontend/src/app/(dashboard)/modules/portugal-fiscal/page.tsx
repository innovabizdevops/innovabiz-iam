...
/* ═══ Portugal Fiscal (AT) — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "552", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3360", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€221K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1754557652", cells: ["POR-8652", "Portugal Fiscal (AT) Item 1", "9/9/2026", "€7752"], status: "active" as const },
    { id: "1754561223", cells: ["POR-3223", "Portugal Fiscal (AT) Item 2", "24/4/2026", "€11 323"], status: "pending" as const },
    { id: "1754564794", cells: ["POR-6794", "Portugal Fiscal (AT) Item 3", "11/11/2026", "€14 894"], status: "completed" as const },
    { id: "1754568365", cells: ["POR-1365", "Portugal Fiscal (AT) Item 4", "26/6/2026", "€18 465"], status: "warning" as const },
    { id: "1754571936", cells: ["POR-4936", "Portugal Fiscal (AT) Item 5", "13/1/2026", "€22 036"], status: "active" as const },
];
...
export default function PortugalFiscalAtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Portugal Fiscal (AT)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Portugal Fiscal (AT)</p>
                    </div>
                </div>
