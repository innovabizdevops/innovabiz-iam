...
const ACCENT = "#14532d";
const MODULE = "Portugal Fiscal (AT)";
const PAGE = "SAF-T PT";
const KPIS = [{"l":"Total Portugal Fiscal","v":"8.655","t":"+14.7%","d":"up"},{"l":"SAF T PT Ativos","v":"5.075","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"77.3%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"77","t":"+16.4%","d":"up"}];
const COLS = ["ID","SAF T PT","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Portugal Fiscal #001","Portugal Fiscal #002","3.705","3.263","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Portugal Fiscal #002","Portugal Fiscal #003","8.900","8.366","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Portugal Fiscal #003","Portugal Fiscal #004","6.481","1.352","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Portugal Fiscal #004","Portugal Fiscal #005","108","3.561","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Portugal Fiscal #005","Portugal Fiscal #001","4.592","7.640","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":472},{"label":"Fev","value":659},{"label":"Mar","value":474},{"label":"Abr","value":397},{"label":"Mai","value":604},{"label":"Jun","value":446},{"label":"Jul","value":434},{"label":"Ago","value":404},{"label":"Set","value":732},{"label":"Out","value":365},{"label":"Nov","value":457},{"label":"Dez","value":674}];
const MX = 732;
