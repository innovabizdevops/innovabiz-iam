...
const PAGE = "e-Fatura";
const KPIS = [{"l":"Total Portugal Fiscal","v":"991","t":"+9.7%","d":"up"},{"l":"E Fatura Ativos","v":"8.715","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"68.1%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"74","t":"+0.4%","d":"up"}];
const COLS = ["ID","E Fatura","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Portugal Fiscal #001","Portugal Fiscal #002","8.780","4.441","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Portugal Fiscal #002","Portugal Fiscal #003","480","4.716","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Portugal Fiscal #003","Portugal Fiscal #004","7.482","2.347","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Portugal Fiscal #004","Portugal Fiscal #005","8.877","1.664","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Portugal Fiscal #005","Portugal Fiscal #001","925","7.832","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":716},{"label":"Mar","value":846},{"label":"Abr","value":692},{"label":"Mai","value":858},{"label":"Jun","value":866},{"label":"Jul","value":915},{"label":"Ago","value":649},{"label":"Set","value":575},{"label":"Out","value":721},{"label":"Nov","value":684},{"label":"Dez","value":634}];
const MX = 915;
