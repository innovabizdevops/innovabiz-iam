...
const PAGE = "IVA";
const KPIS = [{"l":"Total Portugal Fiscal","v":"4.070","t":"+6.4%","d":"up"},{"l":"IVA Ativos","v":"7.979","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"90.7%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"74","t":"+17.5%","d":"up"}];
const COLS = ["ID","IVA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Portugal Fiscal #001","Portugal Fiscal #002","5.232","5.966","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Portugal Fiscal #002","Portugal Fiscal #003","6.762","6.407","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Portugal Fiscal #003","Portugal Fiscal #004","5.629","7.001","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Portugal Fiscal #004","Portugal Fiscal #005","4.023","4.537","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Portugal Fiscal #005","Portugal Fiscal #001","4.333","1.773","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":437},{"label":"Fev","value":734},{"label":"Mar","value":729},{"label":"Abr","value":613},{"label":"Mai","value":745},{"label":"Jun","value":490},{"label":"Jul","value":416},{"label":"Ago","value":560},{"label":"Set","value":475},{"label":"Out","value":561},{"label":"Nov","value":702},{"label":"Dez","value":497}];
const MX = 745;
