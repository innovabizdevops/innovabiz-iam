...
const PAGE = "Failover Strategy";
const KPIS = [{"l":"BCP Plans Ativos","v":"6.405","t":"+11.6%","d":"up"},{"l":"RTO Médio (h)","v":"137h","t":"-1.2%","d":"down"},{"l":"RPO Médio (h)","v":"115h","t":"-3.0%","d":"down"},{"l":"Testes DR (YTD)","v":"6.153","t":"+7.2%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","28h","144h","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","116h","166h","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","179h","207h","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","92h","179h","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","199h","103h","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":668},{"label":"Mar","value":909},{"label":"Abr","value":1031},{"label":"Mai","value":678},{"label":"Jun","value":721},{"label":"Jul","value":1045},{"label":"Ago","value":753},{"label":"Set","value":735},{"label":"Out","value":856},{"label":"Nov","value":661},{"label":"Dez","value":884}];
const MX = 1045;
