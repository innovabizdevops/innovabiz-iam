...
const PAGE = "Cross-Region Sync";
const KPIS = [{"l":"Integrações Ativas","v":"2.828","t":"-4.8%","d":"down"},{"l":"Chamadas/Hora","v":"1642","t":"+16.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"92.0%","t":"+17.6%","d":"up"},{"l":"Latência Média (ms)","v":"142ms","t":"+5.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.187","2.664","83.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.301","1.709","72.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.193","4.500","89.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.185","1.447","74.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.858","2.915","99.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":644},{"label":"Mar","value":657},{"label":"Abr","value":934},{"label":"Mai","value":748},{"label":"Jun","value":723},{"label":"Jul","value":887},{"label":"Ago","value":951},{"label":"Set","value":656},{"label":"Out","value":683},{"label":"Nov","value":837},{"label":"Dez","value":721}];
const MX = 951;
