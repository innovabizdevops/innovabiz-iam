...
const ACCENT = "#0369a1";
const MODULE = "Multi-Region Mgmt";
const PAGE = "Edge CDN";
const KPIS = [{"l":"Total Multi Region","v":"1.746","t":"+1.5%","d":"up"},{"l":"Edge CDN Ativos","v":"8.708","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"65.5%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"61","t":"+10.9%","d":"up"}];
const COLS = ["ID","Edge CDN","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Multi Region #001","Multi Region #002","3.613","4.929","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Multi Region #002","Multi Region #003","5.582","1.353","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Multi Region #003","Multi Region #004","4.373","1.793","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Multi Region #004","Multi Region #005","6.908","830","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Multi Region #005","Multi Region #001","370","6.699","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":602},{"label":"Mar","value":388},{"label":"Abr","value":485},{"label":"Mai","value":609},{"label":"Jun","value":655},{"label":"Jul","value":481},{"label":"Ago","value":690},{"label":"Set","value":433},{"label":"Out","value":542},{"label":"Nov","value":681},{"label":"Dez","value":359}];
const MX = 690;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0369a1'}}>Edge</span></h1>
                </div>
