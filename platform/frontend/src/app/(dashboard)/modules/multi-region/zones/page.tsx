...
const PAGE = "Compliance Zones";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.513","t":"+12.3%","d":"up"},{"l":"NC Abertas","v":"8.830","t":"+1.5%","d":"up"},{"l":"Conformidade (%)","v":"72.3%","t":"-3.9%","d":"down"},{"l":"CAPAs Pendentes","v":"5.518","t":"+3.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.494","90.1%","164","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.483","89.0%","5.412","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.515","74.3%","253","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.963","74.1%","6.691","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.739","85.4%","2.262","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":895},{"label":"Fev","value":1002},{"label":"Mar","value":839},{"label":"Abr","value":891},{"label":"Mai","value":837},{"label":"Jun","value":1070},{"label":"Jul","value":863},{"label":"Ago","value":708},{"label":"Set","value":858},{"label":"Out","value":839},{"label":"Nov","value":926},{"label":"Dez","value":883}];
const MX = 1070;
