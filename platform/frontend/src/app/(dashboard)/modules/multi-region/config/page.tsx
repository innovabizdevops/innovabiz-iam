...
const KPIS = [{"l":"Configurações","v":"352","t":"+14.8%","d":"up"},{"l":"Últimas Alterações","v":"1.098","t":"-1.2%","d":"down"},{"l":"Ambientes","v":"4.246","t":"+16.8%","d":"up"},{"l":"Versão Config","v":"6.729","t":"+9.4%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 32648.40","5.845","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 7343.53","3.840","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 23294.23","3.438","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 8072.36","1.544","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 12220.74","6.482","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":403},{"label":"Fev","value":377},{"label":"Mar","value":620},{"label":"Abr","value":509},{"label":"Mai","value":409},{"label":"Jun","value":509},{"label":"Jul","value":584},{"label":"Ago","value":576},{"label":"Set","value":232},{"label":"Out","value":465},{"label":"Nov","value":389},{"label":"Dez","value":571}];
const MX = 620;
