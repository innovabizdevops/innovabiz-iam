...
const KPIS = [{"l":"Total Health Insurance","v":"6.316","t":"-3.1%","d":"down"},{"l":"Eligibility Ativos","v":"8.611","t":"+10.0%","d":"up"},{"l":"Eficiência (%)","v":"66.1%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"65","t":"+0.4%","d":"up"}];
const COLS = ["ID","Eligibility","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Health Insurance #001","Health Insurance #002","1.136","3.505","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Health Insurance #002","Health Insurance #003","1.047","7.992","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Health Insurance #003","Health Insurance #004","6.467","7.415","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Health Insurance #004","Health Insurance #005","3.612","9.057","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Health Insurance #005","Health Insurance #001","7.782","8.089","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":816},{"label":"Mar","value":500},{"label":"Abr","value":804},{"label":"Mai","value":843},{"label":"Jun","value":832},{"label":"Jul","value":744},{"label":"Ago","value":478},{"label":"Set","value":765},{"label":"Out","value":560},{"label":"Nov","value":655},{"label":"Dez","value":724}];
const MX = 843;
