...
const PAGE = "Prior Auth";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.992","t":"+11.7%","d":"up"},{"l":"Sessões/Dia","v":"735","t":"+4.0%","d":"up"},{"l":"MFA Adoção (%)","v":"65.9%","t":"+16.4%","d":"up"},{"l":"Tentativas Bloqueadas","v":"4.399","t":"+14.9%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","8.074","5.252","7.196","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.039","8.727","7.411","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","6.081","5.486","460","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","5.160","2.794","820","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","588","1.743","4.055","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":286},{"label":"Fev","value":682},{"label":"Mar","value":353},{"label":"Abr","value":302},{"label":"Mai","value":602},{"label":"Jun","value":500},{"label":"Jul","value":495},{"label":"Ago","value":293},{"label":"Set","value":519},{"label":"Out","value":382},{"label":"Nov","value":379},{"label":"Dez","value":486}];
const MX = 682;
