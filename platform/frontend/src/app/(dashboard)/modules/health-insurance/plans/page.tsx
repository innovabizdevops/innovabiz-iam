...
const PAGE = "Plan Builder";
const KPIS = [{"l":"Total Health Insurance","v":"1.129","t":"+2.9%","d":"up"},{"l":"Plan Builder Ativos","v":"2.858","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"83.9%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"76","t":"+8.5%","d":"up"}];
const COLS = ["ID","Plan Builder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Health Insurance #001","Health Insurance #002","2.484","7.501","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Health Insurance #002","Health Insurance #003","3.293","2.274","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Health Insurance #003","Health Insurance #004","1.477","7.025","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Health Insurance #004","Health Insurance #005","4.354","5.155","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Health Insurance #005","Health Insurance #001","4.097","3.527","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":660},{"label":"Mar","value":738},{"label":"Abr","value":486},{"label":"Mai","value":537},{"label":"Jun","value":559},{"label":"Jul","value":708},{"label":"Ago","value":759},{"label":"Set","value":776},{"label":"Out","value":733},{"label":"Nov","value":517},{"label":"Dez","value":625}];
const MX = 776;
