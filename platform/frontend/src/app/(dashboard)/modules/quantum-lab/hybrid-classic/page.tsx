...
/* ═══ Quantum Lab — Hybrid Classic ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "1889", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "132", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3154", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "355002720", cells: ["QUA-7720", "Hybrid Classic Item 1", "17/1/2026", "€2820"], status: "active" as const },
    { id: "355006291", cells: ["QUA-2291", "Hybrid Classic Item 2", "4/8/2026", "€6391"], status: "pending" as const },
    { id: "355009862", cells: ["QUA-5862", "Hybrid Classic Item 3", "19/3/2026", "€9962"], status: "completed" as const },
    { id: "355013433", cells: ["QUA-9433", "Hybrid Classic Item 4", "6/10/2026", "€13 533"], status: "warning" as const },
    { id: "355017004", cells: ["QUA-4004", "Hybrid Classic Item 5", "21/5/2026", "€17 104"], status: "active" as const },
];
...
export default function QuantumLabHybridClassicPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Hybrid Classic</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Quantum Lab • Hybrid Classic</p>
                    </div>
                </div>
