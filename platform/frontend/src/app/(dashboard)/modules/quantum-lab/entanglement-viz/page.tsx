...
/* ═══ Quantum Lab — Entanglement Viz ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "3482", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "483", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "776", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1779879135", cells: ["QUA-4135", "Entanglement Viz Item 1", "28/4/2026", "€29 235"], status: "active" as const },
    { id: "1779882706", cells: ["QUA-7706", "Entanglement Viz Item 2", "15/11/2026", "€32 806"], status: "pending" as const },
    { id: "1779886277", cells: ["QUA-2277", "Entanglement Viz Item 3", "2/6/2026", "€36 377"], status: "completed" as const },
    { id: "1779889848", cells: ["QUA-5848", "Entanglement Viz Item 4", "17/1/2026", "€39 948"], status: "warning" as const },
    { id: "1779893419", cells: ["QUA-9419", "Entanglement Viz Item 5", "4/8/2026", "€43 519"], status: "active" as const },
];
...
export default function QuantumLabEntanglementVizPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Entanglement Viz</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Quantum Lab • Entanglement Viz</p>
                    </div>
                </div>
