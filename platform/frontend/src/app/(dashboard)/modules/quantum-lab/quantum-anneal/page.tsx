...
/* ═══ Quantum Lab — Quantum Anneal ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "3691", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "254", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3849", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "660957466", cells: ["QUA-7466", "Quantum Anneal Item 1", "23/11/2026", "€7566"], status: "active" as const },
    { id: "660961037", cells: ["QUA-2037", "Quantum Anneal Item 2", "10/6/2026", "€11 137"], status: "pending" as const },
    { id: "660964608", cells: ["QUA-5608", "Quantum Anneal Item 3", "25/1/2026", "€14 708"], status: "completed" as const },
    { id: "660968179", cells: ["QUA-9179", "Quantum Anneal Item 4", "12/8/2026", "€18 279"], status: "warning" as const },
    { id: "660971750", cells: ["QUA-3750", "Quantum Anneal Item 5", "27/3/2026", "€21 850"], status: "active" as const },
];
...
export default function QuantumLabQuantumAnnealPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Quantum Anneal</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Quantum Lab • Quantum Anneal</p>
                    </div>
                </div>
