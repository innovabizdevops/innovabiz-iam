...
/* ═══ Quantum Lab — Error Correct ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "252", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "260", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1730", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1250709408", cells: ["QUA-7408", "Error Correct Item 1", "5/1/2026", "€9508"], status: "active" as const },
    { id: "1250712979", cells: ["QUA-1979", "Error Correct Item 2", "20/8/2026", "€13 079"], status: "pending" as const },
    { id: "1250716550", cells: ["QUA-5550", "Error Correct Item 3", "7/3/2026", "€16 650"], status: "completed" as const },
    { id: "1250720121", cells: ["QUA-9121", "Error Correct Item 4", "22/10/2026", "€20 221"], status: "warning" as const },
    { id: "1250723692", cells: ["QUA-3692", "Error Correct Item 5", "9/5/2026", "€23 792"], status: "active" as const },
];
...
export default function QuantumLabErrorCorrectPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Error Correct</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Quantum Lab • Error Correct</p>
                    </div>
                </div>
