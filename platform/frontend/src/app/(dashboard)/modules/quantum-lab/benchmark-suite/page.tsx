...
/* ═══ Quantum Lab — Benchmark Suite ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "2285", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "407", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "17", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2116259811", cells: ["QUA-9811", "Benchmark Suite Item 1", "16/4/2026", "€9911"], status: "active" as const },
    { id: "2116263382", cells: ["QUA-4382", "Benchmark Suite Item 2", "3/11/2026", "€13 482"], status: "pending" as const },
    { id: "2116266953", cells: ["QUA-7953", "Benchmark Suite Item 3", "18/6/2026", "€17 053"], status: "completed" as const },
    { id: "2116270524", cells: ["QUA-2524", "Benchmark Suite Item 4", "5/1/2026", "€20 624"], status: "warning" as const },
    { id: "2116274095", cells: ["QUA-6095", "Benchmark Suite Item 5", "20/8/2026", "€24 195"], status: "active" as const },
];
...
export default function QuantumLabBenchmarkSuitePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Benchmark Suite</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Quantum Lab • Benchmark Suite</p>
                    </div>
                </div>
