...
/* ═══ Quantum Lab — Quantum Circuit ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "3514", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "290", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "456", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1674296910", cells: ["QUA-9910", "Quantum Circuit Item 1", "7/7/2026", "€47 010"], status: "active" as const },
    { id: "1674300481", cells: ["QUA-4481", "Quantum Circuit Item 2", "22/2/2026", "€581"], status: "pending" as const },
    { id: "1674304052", cells: ["QUA-8052", "Quantum Circuit Item 3", "9/9/2026", "€4152"], status: "completed" as const },
    { id: "1674307623", cells: ["QUA-2623", "Quantum Circuit Item 4", "24/4/2026", "€7723"], status: "warning" as const },
    { id: "1674311194", cells: ["QUA-6194", "Quantum Circuit Item 5", "11/11/2026", "€11 294"], status: "active" as const },
];
...
export default function QuantumLabQuantumCircuitPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Quantum Circuit</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Quantum Lab • Quantum Circuit</p>
                    </div>
                </div>
