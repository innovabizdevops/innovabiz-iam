...
/* ═══ Quantum Lab — Algorithm Lib ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "3597", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "146", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "305", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1351891806", cells: ["QUA-2806", "Algorithm Lib Item 1", "7/7/2026", "€41 906"], status: "active" as const },
    { id: "1351895377", cells: ["QUA-6377", "Algorithm Lib Item 2", "22/2/2026", "€45 477"], status: "pending" as const },
    { id: "1351898948", cells: ["QUA-9948", "Algorithm Lib Item 3", "9/9/2026", "€49 048"], status: "completed" as const },
    { id: "1351902519", cells: ["QUA-4519", "Algorithm Lib Item 4", "24/4/2026", "€2619"], status: "warning" as const },
    { id: "1351906090", cells: ["QUA-8090", "Algorithm Lib Item 5", "11/11/2026", "€6190"], status: "active" as const },
];
...
export default function QuantumLabAlgorithmLibPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Algorithm Lib</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Quantum Lab • Algorithm Lib</p>
                    </div>
                </div>
