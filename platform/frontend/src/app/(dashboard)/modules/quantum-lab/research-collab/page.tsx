...
/* ═══ Quantum Lab — Research Collab ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "2290", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "292", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3282", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1585763392", cells: ["QUA-9392", "Research Collab Item 1", "25/5/2026", "€13 492"], status: "active" as const },
    { id: "1585766963", cells: ["QUA-3963", "Research Collab Item 2", "12/12/2026", "€17 063"], status: "pending" as const },
    { id: "1585770534", cells: ["QUA-7534", "Research Collab Item 3", "27/7/2026", "€20 634"], status: "completed" as const },
    { id: "1585774105", cells: ["QUA-2105", "Research Collab Item 4", "14/2/2026", "€24 205"], status: "warning" as const },
    { id: "1585777676", cells: ["QUA-5676", "Research Collab Item 5", "1/9/2026", "€27 776"], status: "active" as const },
];
...
export default function QuantumLabResearchCollabPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Research Collab</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Quantum Lab • Research Collab</p>
                    </div>
                </div>
