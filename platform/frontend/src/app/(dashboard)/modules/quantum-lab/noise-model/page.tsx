...
/* ═══ Quantum Lab — Noise Model ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "2120", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "483", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "405", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1829259407", cells: ["QUA-1407", "Noise Model Item 1", "4/12/2026", "€9507"], status: "active" as const },
    { id: "1829262978", cells: ["QUA-4978", "Noise Model Item 2", "19/7/2026", "€13 078"], status: "pending" as const },
    { id: "1829266549", cells: ["QUA-8549", "Noise Model Item 3", "6/2/2026", "€16 649"], status: "completed" as const },
    { id: "1829270120", cells: ["QUA-3120", "Noise Model Item 4", "21/9/2026", "€20 220"], status: "warning" as const },
    { id: "1829273691", cells: ["QUA-6691", "Noise Model Item 5", "8/4/2026", "€23 791"], status: "active" as const },
];
...
export default function QuantumLabNoiseModelPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Noise Model</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Quantum Lab • Noise Model</p>
                    </div>
                </div>
