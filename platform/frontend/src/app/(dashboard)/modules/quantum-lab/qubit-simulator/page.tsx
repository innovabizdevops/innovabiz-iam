...
/* ═══ Quantum Lab — Qubit Simulator ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "4157", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "473", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "398", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1710658853", cells: ["QUA-2853", "Qubit Simulator Item 1", "2/6/2026", "€8953"], status: "active" as const },
    { id: "1710662424", cells: ["QUA-6424", "Qubit Simulator Item 2", "17/1/2026", "€12 524"], status: "pending" as const },
    { id: "1710665995", cells: ["QUA-9995", "Qubit Simulator Item 3", "4/8/2026", "€16 095"], status: "completed" as const },
    { id: "1710669566", cells: ["QUA-4566", "Qubit Simulator Item 4", "19/3/2026", "€19 666"], status: "warning" as const },
    { id: "1710673137", cells: ["QUA-8137", "Qubit Simulator Item 5", "6/10/2026", "€23 237"], status: "active" as const },
];
...
export default function QuantumLabQubitSimulatorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Qubit Simulator</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Quantum Lab • Qubit Simulator</p>
                    </div>
                </div>
