...
const ACCENT = "#0284c7";
const MODULE = "SC: Utils Validation";
const PAGE = "Rule";
const KPIS = [{"l":"Total Sc Utils Validation","v":"4.092","t":"+9.9%","d":"up"},{"l":"Rule Ativos","v":"6.133","t":"+0.9%","d":"up"},{"l":"Eficiência (%)","v":"75.2%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"76","t":"+16.1%","d":"up"}];
const COLS = ["ID","Rule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Utils Validation #001","Sc Utils Validation #002","3.720","4.381","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Utils Validation #002","Sc Utils Validation #003","6.207","8.160","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Utils Validation #003","Sc Utils Validation #004","6.377","341","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Utils Validation #004","Sc Utils Validation #005","335","2.497","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Utils Validation #005","Sc Utils Validation #001","7.295","4.175","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":790},{"label":"Fev","value":637},{"label":"Mar","value":746},{"label":"Abr","value":634},{"label":"Mai","value":647},{"label":"Jun","value":849},{"label":"Jul","value":660},{"label":"Ago","value":932},{"label":"Set","value":723},{"label":"Out","value":906},{"label":"Nov","value":878},{"label":"Dez","value":756}];
const MX = 932;
