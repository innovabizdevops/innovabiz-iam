...
const PAGE = "Custom";
const KPIS = [{"l":"Total Sc Utils Validation","v":"3.238","t":"+8.4%","d":"up"},{"l":"Custom Ativos","v":"€23278","t":"+13.1%","d":"up"},{"l":"Eficiência (%)","v":"74.2%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"77","t":"+0.6%","d":"up"}];
const COLS = ["ID","Custom","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Utils Validation #001","€ 46090.93","3.405","3.843","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Utils Validation #002","€ 23174.47","627","277","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Utils Validation #003","€ 38105.75","4.632","2.402","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Utils Validation #004","€ 32678.84","3.297","2.978","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Utils Validation #005","€ 34028.72","2.606","214","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":395},{"label":"Mar","value":663},{"label":"Abr","value":615},{"label":"Mai","value":629},{"label":"Jun","value":643},{"label":"Jul","value":460},{"label":"Ago","value":485},{"label":"Set","value":348},{"label":"Out","value":467},{"label":"Nov","value":390},{"label":"Dez","value":647}];
const MX = 663;
