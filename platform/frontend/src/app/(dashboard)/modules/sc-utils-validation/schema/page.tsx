...
const PAGE = "Schema";
const KPIS = [{"l":"Total Sc Utils Validation","v":"9.002","t":"+13.2%","d":"up"},{"l":"Schema Ativos","v":"5.437","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"83.8%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"59","t":"+13.0%","d":"up"}];
const COLS = ["ID","Schema","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Utils Validation #001","Sc Utils Validation #002","2.941","1.295","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Utils Validation #002","Sc Utils Validation #003","2.522","2.764","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Utils Validation #003","Sc Utils Validation #004","2.157","5.784","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Utils Validation #004","Sc Utils Validation #005","854","8.655","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Utils Validation #005","Sc Utils Validation #001","5.022","8.736","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":713},{"label":"Fev","value":701},{"label":"Mar","value":753},{"label":"Abr","value":624},{"label":"Mai","value":788},{"label":"Jun","value":914},{"label":"Jul","value":711},{"label":"Ago","value":660},{"label":"Set","value":621},{"label":"Out","value":894},{"label":"Nov","value":621},{"label":"Dez","value":680}];
const MX = 914;
