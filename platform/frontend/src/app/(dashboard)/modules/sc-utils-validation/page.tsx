...
/* ═══ SC: Utils Validation — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "6681", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3665", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€166K", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1419854681", cells: ["SC-6681", "SC: Utils Validation Item 1", "22/6/2026", "€4781"], status: "active" as const },
    { id: "1419858252", cells: ["SC-1252", "SC: Utils Validation Item 2", "9/1/2026", "€8352"], status: "pending" as const },
    { id: "1419861823", cells: ["SC-4823", "SC: Utils Validation Item 3", "24/8/2026", "€11 923"], status: "completed" as const },
    { id: "1419865394", cells: ["SC-8394", "SC: Utils Validation Item 4", "11/3/2026", "€15 494"], status: "warning" as const },
    { id: "1419868965", cells: ["SC-2965", "SC: Utils Validation Item 5", "26/10/2026", "€19 065"], status: "active" as const },
];
...
export default function ScUtilsValidationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: Utils Validation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: Utils Validation</p>
                    </div>
                </div>
