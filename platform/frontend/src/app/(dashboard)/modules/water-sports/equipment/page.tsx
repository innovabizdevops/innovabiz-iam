...
const KPIS = [{"l":"Atletas Registados","v":"5.001","t":"+9.6%","d":"up"},{"l":"Treinos/Semana","v":"1978","t":"+16.3%","d":"up"},{"l":"Competições","v":"7.677","t":"+14.7%","d":"up"},{"l":"Performance Score","v":"59","t":"+8.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.488","5.598","6.870","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.211","7.658","2.916","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.610","1.177","7.542","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.040","1.668","7.557","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.046","4.520","5.016","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":746},{"label":"Mar","value":772},{"label":"Abr","value":671},{"label":"Mai","value":556},{"label":"Jun","value":439},{"label":"Jul","value":748},{"label":"Ago","value":476},{"label":"Set","value":454},{"label":"Out","value":509},{"label":"Nov","value":434},{"label":"Dez","value":654}];
const MX = 772;
