...
const PAGE = "Safety";
const KPIS = [{"l":"Atletas Registados","v":"4.385","t":"+0.2%","d":"up"},{"l":"Treinos/Semana","v":"556","t":"+5.8%","d":"up"},{"l":"Competições","v":"134","t":"+13.1%","d":"up"},{"l":"Performance Score","v":"65","t":"+16.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.972","7.336","8.505","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","533","6.956","6.252","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.876","1.421","2.138","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","609","5.530","247","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.231","4.108","7.213","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":558},{"label":"Mar","value":874},{"label":"Abr","value":575},{"label":"Mai","value":647},{"label":"Jun","value":862},{"label":"Jul","value":821},{"label":"Ago","value":876},{"label":"Set","value":785},{"label":"Out","value":654},{"label":"Nov","value":519},{"label":"Dez","value":681}];
const MX = 876;
