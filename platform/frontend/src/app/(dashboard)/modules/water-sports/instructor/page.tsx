...
const KPIS = [{"l":"Atletas Registados","v":"5.305","t":"+7.5%","d":"up"},{"l":"Treinos/Semana","v":"1851","t":"+13.6%","d":"up"},{"l":"Competições","v":"4.348","t":"-1.0%","d":"down"},{"l":"Performance Score","v":"72","t":"+17.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","502","1.193","7.906","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.936","7.210","1.647","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.462","3.264","4.190","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.850","3.762","5.822","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.905","3.370","6.978","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":396},{"label":"Fev","value":392},{"label":"Mar","value":383},{"label":"Abr","value":333},{"label":"Mai","value":329},{"label":"Jun","value":626},{"label":"Jul","value":473},{"label":"Ago","value":572},{"label":"Set","value":541},{"label":"Out","value":386},{"label":"Nov","value":446},{"label":"Dez","value":641}];
const MX = 641;
