...
const ACCENT = "#166534";
const MODULE = "Water Sports Center";
const PAGE = "Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"6.948","t":"+13.9%","d":"up"},{"l":"RevPAR (€)","v":"€9710","t":"+7.4%","d":"up"},{"l":"Ocupação (%)","v":"68.8%","t":"+5.2%","d":"up"},{"l":"Guest Satisfaction","v":"7.337","t":"+3.4%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.956","2026-01-14","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","157","2026-01-02","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","586","2026-02-14","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.309","2026-03-20","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.976","2026-01-18","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":806},{"label":"Fev","value":827},{"label":"Mar","value":922},{"label":"Abr","value":854},{"label":"Mai","value":789},{"label":"Jun","value":854},{"label":"Jul","value":773},{"label":"Ago","value":763},{"label":"Set","value":956},{"label":"Out","value":699},{"label":"Nov","value":856},{"label":"Dez","value":906}];
const MX = 956;
