...
const PAGE = "Weather";
const KPIS = [{"l":"Atletas Registados","v":"3.351","t":"-3.2%","d":"down"},{"l":"Treinos/Semana","v":"4962","t":"+10.2%","d":"up"},{"l":"Competições","v":"5.329","t":"+14.1%","d":"up"},{"l":"Performance Score","v":"60","t":"+9.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.352","4.219","6.404","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.863","8.289","6.081","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.285","974","7.119","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.072","8.849","1.665","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.702","7.155","2.448","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":848},{"label":"Mar","value":902},{"label":"Abr","value":809},{"label":"Mai","value":510},{"label":"Jun","value":696},{"label":"Jul","value":673},{"label":"Ago","value":543},{"label":"Set","value":741},{"label":"Out","value":777},{"label":"Nov","value":733},{"label":"Dez","value":840}];
const MX = 902;
