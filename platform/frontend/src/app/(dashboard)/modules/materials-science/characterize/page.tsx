...
const PAGE = "Characterize";
const KPIS = [{"l":"Total Materials Science","v":"7.460","t":"+4.2%","d":"up"},{"l":"Characterize Ativos","v":"7.753","t":"-1.5%","d":"down"},{"l":"Eficiência (%)","v":"82.1%","t":"-3.1%","d":"down"},{"l":"Score Performance","v":"79","t":"+1.3%","d":"up"}];
const COLS = ["ID","Characterize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Materials Science #001","Materials Science #002","5.651","5.173","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Materials Science #002","Materials Science #003","7.849","7.447","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Materials Science #003","Materials Science #004","4.378","273","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Materials Science #004","Materials Science #005","976","7.945","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Materials Science #005","Materials Science #001","2.333","876","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":326},{"label":"Fev","value":278},{"label":"Mar","value":657},{"label":"Abr","value":333},{"label":"Mai","value":406},{"label":"Jun","value":324},{"label":"Jul","value":610},{"label":"Ago","value":656},{"label":"Set","value":282},{"label":"Out","value":621},{"label":"Nov","value":559},{"label":"Dez","value":493}];
const MX = 657;
...
export default function CharacterizePage() {
    return (
