...
const ACCENT = "#dc2626";
const MODULE = "Materials Science";
const PAGE = "Property Predict";
const KPIS = [{"l":"Integrações Ativas","v":"2.215","t":"+14.3%","d":"up"},{"l":"Chamadas/Hora","v":"2554","t":"+16.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"87.9%","t":"+14.3%","d":"up"},{"l":"Latência Média (ms)","v":"75ms","t":"+6.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.019","7.852","93.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.475","1.122","97.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","228","2.076","87.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.361","6.927","74.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","768","1.599","73.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1026},{"label":"Fev","value":899},{"label":"Mar","value":923},{"label":"Abr","value":645},{"label":"Mai","value":844},{"label":"Jun","value":772},{"label":"Jul","value":723},{"label":"Ago","value":866},{"label":"Set","value":982},{"label":"Out","value":828},{"label":"Nov","value":705},{"label":"Dez","value":810}];
const MX = 1026;
