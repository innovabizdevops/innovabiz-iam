...
const PAGE = "Synthesis";
const KPIS = [{"l":"Total Materials Science","v":"3.559","t":"+4.9%","d":"up"},{"l":"Synthesis Ativos","v":"1.856","t":"+10.6%","d":"up"},{"l":"Eficiência (%)","v":"72.4%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"83","t":"-4.8%","d":"down"}];
const COLS = ["ID","Synthesis","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Materials Science #001","Materials Science #002","7.195","3.415","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Materials Science #002","Materials Science #003","2.689","8.058","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Materials Science #003","Materials Science #004","8.612","9.042","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Materials Science #004","Materials Science #005","2.688","314","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Materials Science #005","Materials Science #001","8.503","4.098","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":390},{"label":"Fev","value":461},{"label":"Mar","value":571},{"label":"Abr","value":252},{"label":"Mai","value":213},{"label":"Jun","value":536},{"label":"Jul","value":531},{"label":"Ago","value":280},{"label":"Set","value":369},{"label":"Out","value":462},{"label":"Nov","value":444},{"label":"Dez","value":405}];
const MX = 571;
