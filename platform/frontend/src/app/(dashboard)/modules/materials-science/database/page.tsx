...
const PAGE = "Material DB";
const KPIS = [{"l":"Total Materials Science","v":"6.006","t":"+17.5%","d":"up"},{"l":"Material DB Ativos","v":"3.932","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"79.8%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"59","t":"+10.3%","d":"up"}];
const COLS = ["ID","Material DB","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Materials Science #001","Materials Science #002","199","8.457","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Materials Science #002","Materials Science #003","2.217","8.802","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Materials Science #003","Materials Science #004","1.657","5.554","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Materials Science #004","Materials Science #005","3.073","1.427","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Materials Science #005","Materials Science #001","6.846","950","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":629},{"label":"Mar","value":893},{"label":"Abr","value":527},{"label":"Mai","value":720},{"label":"Jun","value":568},{"label":"Jul","value":561},{"label":"Ago","value":738},{"label":"Set","value":702},{"label":"Out","value":652},{"label":"Nov","value":817},{"label":"Dez","value":612}];
const MX = 893;
