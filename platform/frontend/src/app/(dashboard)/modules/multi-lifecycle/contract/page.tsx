...
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"4.682","t":"+16.8%","d":"up"},{"l":"Valor Total (€M)","v":"€9.6M","t":"+0.2%","d":"up"},{"l":"Renovações Próx. 30d","v":"4.803","t":"+14.8%","d":"up"},{"l":"Obrigações Pendentes","v":"3.456","t":"+0.1%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 27649.97","2026-03-25","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 14723.07","2026-03-21","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 44036.71","2026-02-21","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 47432.19","2026-03-12","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 48052.34","2026-03-15","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":706},{"label":"Mar","value":841},{"label":"Abr","value":870},{"label":"Mai","value":537},{"label":"Jun","value":784},{"label":"Jul","value":574},{"label":"Ago","value":714},{"label":"Set","value":766},{"label":"Out","value":728},{"label":"Nov","value":850},{"label":"Dez","value":870}];
const MX = 870;
