...
const PAGE = "Employee";
const KPIS = [{"l":"eNPS","v":"90","t":"-0.8%","d":"down"},{"l":"Engagement (%)","v":"68.4%","t":"+4.8%","d":"up"},{"l":"Turnover (%)","v":"86.0%","t":"+11.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.767","t":"+3.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","115","2026-02-09","66","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.851","2026-02-01","60","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.973","2026-03-09","57","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.395","2026-03-11","75","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.380","2026-01-24","70","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":861},{"label":"Mar","value":672},{"label":"Abr","value":602},{"label":"Mai","value":581},{"label":"Jun","value":847},{"label":"Jul","value":702},{"label":"Ago","value":778},{"label":"Set","value":599},{"label":"Out","value":519},{"label":"Nov","value":629},{"label":"Dez","value":539}];
const MX = 861;
