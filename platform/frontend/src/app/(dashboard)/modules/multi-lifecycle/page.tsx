...
/* ═══ Multi-Lifecycle Manager — Dashboard ═══ */

const ACCENT = "#0ea5e9";

const KPIS = [
    { label: "Total Registos", value: "9361", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3445", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€137K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "-19%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "72992061", cells: ["MUL-3061", "Multi-Lifecycle Manager Item 1", "10/10/2026", "€42 161"], status: "active" as const },
    { id: "72995632", cells: ["MUL-6632", "Multi-Lifecycle Manager Item 2", "25/5/2026", "€45 732"], status: "pending" as const },
    { id: "72999203", cells: ["MUL-1203", "Multi-Lifecycle Manager Item 3", "12/12/2026", "€49 303"], status: "completed" as const },
    { id: "73002774", cells: ["MUL-4774", "Multi-Lifecycle Manager Item 4", "27/7/2026", "€2874"], status: "warning" as const },
    { id: "73006345", cells: ["MUL-8345", "Multi-Lifecycle Manager Item 5", "14/2/2026", "€6445"], status: "active" as const },
];
...
export default function MultilifecycleManagerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Multi-Lifecycle Manager</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Multi-Lifecycle Manager</p>
                    </div>
                </div>
