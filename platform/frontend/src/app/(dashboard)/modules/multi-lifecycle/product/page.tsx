...
const ACCENT = "#0ea5e9";
const MODULE = "Multi-Lifecycle Manager";
const PAGE = "Product";
const KPIS = [{"l":"Total Multi Lifecycle","v":"3.717","t":"-5.1%","d":"down"},{"l":"Product Ativos","v":"6.422","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"68.7%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"67","t":"-1.6%","d":"down"}];
const COLS = ["ID","Product","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Multi Lifecycle #001","Multi Lifecycle #002","566","9.084","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Multi Lifecycle #002","Multi Lifecycle #003","5.422","238","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Multi Lifecycle #003","Multi Lifecycle #004","6.226","5.830","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Multi Lifecycle #004","Multi Lifecycle #005","810","5.815","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Multi Lifecycle #005","Multi Lifecycle #001","5.610","5.646","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":392},{"label":"Fev","value":565},{"label":"Mar","value":582},{"label":"Abr","value":523},{"label":"Mai","value":399},{"label":"Jun","value":250},{"label":"Jul","value":517},{"label":"Ago","value":297},{"label":"Set","value":406},{"label":"Out","value":608},{"label":"Nov","value":487},{"label":"Dez","value":456}];
const MX = 608;
