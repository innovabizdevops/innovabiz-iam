...
const PAGE = "Asset";
const KPIS = [{"l":"Ativos Registados","v":"8.124","t":"+9.9%","d":"up"},{"l":"Valor Total (€M)","v":"€25.8M","t":"+12.1%","d":"up"},{"l":"Depreciação Anual (€)","v":"€78993","t":"+15.4%","d":"up"},{"l":"Ativos em Garantia","v":"1.553","t":"-3.9%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 32875.55","2.919","€ 13637.01","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 26616.25","853","€ 16802.29","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 20029.30","2.787","€ 28408.34","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 41446.51","4.582","€ 43780.40","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 30225.65","6.056","€ 43967.71","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":578},{"label":"Mar","value":548},{"label":"Abr","value":499},{"label":"Mai","value":695},{"label":"Jun","value":405},{"label":"Jul","value":763},{"label":"Ago","value":548},{"label":"Set","value":639},{"label":"Out","value":647},{"label":"Nov","value":478},{"label":"Dez","value":639}];
const MX = 763;
