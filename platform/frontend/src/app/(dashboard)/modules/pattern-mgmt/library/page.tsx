...
const ACCENT = "#7c3aed";
const MODULE = "Pattern Management";
const PAGE = "Pattern Library";
const KPIS = [{"l":"Total Pattern Mgmt","v":"8.011","t":"+12.8%","d":"up"},{"l":"Pattern Library Ativos","v":"4.390","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"80.0%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"71","t":"+11.2%","d":"up"}];
const COLS = ["ID","Pattern Library","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pattern Mgmt #001","Pattern Mgmt #002","3.501","4.242","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Pattern Mgmt #002","Pattern Mgmt #003","2.474","8.588","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Pattern Mgmt #003","Pattern Mgmt #004","6.337","3.413","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Pattern Mgmt #004","Pattern Mgmt #005","6.516","4.514","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pattern Mgmt #005","Pattern Mgmt #001","7.753","8.619","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":262},{"label":"Fev","value":413},{"label":"Mar","value":323},{"label":"Abr","value":311},{"label":"Mai","value":483},{"label":"Jun","value":588},{"label":"Jul","value":509},{"label":"Ago","value":581},{"label":"Set","value":476},{"label":"Out","value":631},{"label":"Nov","value":586},{"label":"Dez","value":362}];
const MX = 631;
