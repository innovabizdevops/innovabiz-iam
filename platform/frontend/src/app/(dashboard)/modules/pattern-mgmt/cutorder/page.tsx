...
const PAGE = "Cut Order";
const KPIS = [{"l":"Total Pattern Mgmt","v":"2.939","t":"-5.0%","d":"down"},{"l":"Cut Order Ativos","v":"1.328","t":"+6.2%","d":"up"},{"l":"Eficiência (%)","v":"68.4%","t":"-4.4%","d":"down"},{"l":"Score Performance","v":"75","t":"+17.3%","d":"up"}];
const COLS = ["ID","Cut Order","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pattern Mgmt #001","Pattern Mgmt #002","1.457","5.486","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Pattern Mgmt #002","Pattern Mgmt #003","3.784","905","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Pattern Mgmt #003","Pattern Mgmt #004","7.865","2.786","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Pattern Mgmt #004","Pattern Mgmt #005","1.497","7.725","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pattern Mgmt #005","Pattern Mgmt #001","6.728","2.980","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":730},{"label":"Mar","value":590},{"label":"Abr","value":547},{"label":"Mai","value":635},{"label":"Jun","value":604},{"label":"Jul","value":618},{"label":"Ago","value":540},{"label":"Set","value":638},{"label":"Out","value":839},{"label":"Nov","value":701},{"label":"Dez","value":598}];
const MX = 839;
