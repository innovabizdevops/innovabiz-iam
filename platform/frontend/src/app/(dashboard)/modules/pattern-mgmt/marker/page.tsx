...
const PAGE = "Marker Plan";
const KPIS = [{"l":"Total Pattern Mgmt","v":"918","t":"+15.9%","d":"up"},{"l":"Marker Plan Ativos","v":"8.263","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"68.9%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"66","t":"+1.1%","d":"up"}];
const COLS = ["ID","Marker Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pattern Mgmt #001","Pattern Mgmt #002","6.232","366","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Pattern Mgmt #002","Pattern Mgmt #003","597","2.042","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Pattern Mgmt #003","Pattern Mgmt #004","2.407","4.509","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Pattern Mgmt #004","Pattern Mgmt #005","5.993","2.493","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pattern Mgmt #005","Pattern Mgmt #001","4.295","4.938","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":905},{"label":"Fev","value":643},{"label":"Mar","value":927},{"label":"Abr","value":852},{"label":"Mai","value":769},{"label":"Jun","value":711},{"label":"Jul","value":691},{"label":"Ago","value":593},{"label":"Set","value":927},{"label":"Out","value":772},{"label":"Nov","value":815},{"label":"Dez","value":624}];
const MX = 927;
