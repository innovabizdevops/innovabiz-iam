...
const PAGE = "Nesting";
const KPIS = [{"l":"Total Pattern Mgmt","v":"3.061","t":"+5.5%","d":"up"},{"l":"Nesting Ativos","v":"5.980","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"67.9%","t":"+8.3%","d":"up"},{"l":"Score Performance","v":"91","t":"-1.3%","d":"down"}];
const COLS = ["ID","Nesting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pattern Mgmt #001","Pattern Mgmt #002","1.955","3.329","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Pattern Mgmt #002","Pattern Mgmt #003","4.951","2.276","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Pattern Mgmt #003","Pattern Mgmt #004","1.719","7.275","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Pattern Mgmt #004","Pattern Mgmt #005","7.497","4.265","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pattern Mgmt #005","Pattern Mgmt #001","5.720","7.377","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1049},{"label":"Fev","value":912},{"label":"Mar","value":692},{"label":"Abr","value":759},{"label":"Mai","value":1000},{"label":"Jun","value":1031},{"label":"Jul","value":943},{"label":"Ago","value":1066},{"label":"Set","value":701},{"label":"Out","value":808},{"label":"Nov","value":828},{"label":"Dez","value":872}];
const MX = 1066;
