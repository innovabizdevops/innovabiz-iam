...
const PAGE = "Talent";
const KPIS = [{"l":"eNPS","v":"74","t":"+17.3%","d":"up"},{"l":"Engagement (%)","v":"85.4%","t":"+16.8%","d":"up"},{"l":"Turnover (%)","v":"66.1%","t":"+5.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.898","t":"-2.9%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.233","2026-01-09","73","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.312","2026-01-15","57","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.614","2026-03-27","91","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.535","2026-02-16","84","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.183","2026-03-17","92","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":510},{"label":"Mar","value":444},{"label":"Abr","value":554},{"label":"Mai","value":688},{"label":"Jun","value":429},{"label":"Jul","value":414},{"label":"Ago","value":534},{"label":"Set","value":399},{"label":"Out","value":467},{"label":"Nov","value":645},{"label":"Dez","value":635}];
const MX = 716;
