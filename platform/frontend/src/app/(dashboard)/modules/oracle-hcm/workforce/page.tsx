...
const KPIS = [{"l":"eNPS","v":"95","t":"+10.7%","d":"up"},{"l":"Engagement (%)","v":"80.1%","t":"+2.1%","d":"up"},{"l":"Turnover (%)","v":"71.8%","t":"+10.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.756","t":"+17.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.810","2026-01-02","89","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.807","2026-03-08","80","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.358","2026-01-07","63","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","872","2026-03-23","73","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.007","2026-01-01","78","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":423},{"label":"Fev","value":636},{"label":"Mar","value":522},{"label":"Abr","value":465},{"label":"Mai","value":663},{"label":"Jun","value":290},{"label":"Jul","value":611},{"label":"Ago","value":569},{"label":"Set","value":371},{"label":"Out","value":669},{"label":"Nov","value":353},{"label":"Dez","value":515}];
const MX = 669;
