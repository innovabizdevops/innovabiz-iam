...
const PAGE = "Benefits";
const KPIS = [{"l":"eNPS","v":"65","t":"+2.5%","d":"up"},{"l":"Engagement (%)","v":"87.4%","t":"+1.1%","d":"up"},{"l":"Turnover (%)","v":"72.7%","t":"+0.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.358","t":"+15.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.023","2026-02-24","87","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","332","2026-02-21","68","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.040","2026-03-04","86","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.563","2026-02-13","87","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.436","2026-03-28","61","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":750},{"label":"Mar","value":854},{"label":"Abr","value":624},{"label":"Mai","value":904},{"label":"Jun","value":651},{"label":"Jul","value":864},{"label":"Ago","value":819},{"label":"Set","value":647},{"label":"Out","value":609},{"label":"Nov","value":568},{"label":"Dez","value":762}];
const MX = 904;
