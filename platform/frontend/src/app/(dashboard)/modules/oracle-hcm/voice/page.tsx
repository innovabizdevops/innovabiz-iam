...
const ACCENT = "#c74634";
const MODULE = "HCM Suite (Oracle)";
const PAGE = "Voice";
const KPIS = [{"l":"eNPS","v":"62","t":"+6.8%","d":"up"},{"l":"Engagement (%)","v":"78.6%","t":"+16.3%","d":"up"},{"l":"Turnover (%)","v":"77.6%","t":"-0.9%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"878","t":"-4.4%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.366","2026-02-04","86","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.210","2026-01-08","86","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.673","2026-03-21","80","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.605","2026-01-28","64","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.463","2026-01-01","65","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":864},{"label":"Mar","value":519},{"label":"Abr","value":719},{"label":"Mai","value":635},{"label":"Jun","value":617},{"label":"Jul","value":542},{"label":"Ago","value":796},{"label":"Set","value":635},{"label":"Out","value":776},{"label":"Nov","value":560},{"label":"Dez","value":735}];
const MX = 864;
