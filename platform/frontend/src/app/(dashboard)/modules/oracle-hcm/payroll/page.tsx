...
const PAGE = "Payroll";
const KPIS = [{"l":"eNPS","v":"83","t":"+9.9%","d":"up"},{"l":"Engagement (%)","v":"74.3%","t":"-1.6%","d":"down"},{"l":"Turnover (%)","v":"76.7%","t":"+15.5%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.165","t":"+1.4%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","973","2026-03-03","76","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","9.004","2026-01-05","65","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.678","2026-03-28","57","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.245","2026-01-14","86","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.275","2026-02-13","69","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":789},{"label":"Mar","value":630},{"label":"Abr","value":441},{"label":"Mai","value":609},{"label":"Jun","value":701},{"label":"Jul","value":468},{"label":"Ago","value":684},{"label":"Set","value":464},{"label":"Out","value":418},{"label":"Nov","value":484},{"label":"Dez","value":641}];
const MX = 789;
