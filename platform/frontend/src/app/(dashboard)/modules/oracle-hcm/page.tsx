...
/* ═══ HCM Suite (Oracle) — Dashboard ═══ */

const ACCENT = "#c74634";

const KPIS = [
    { label: "Total Registos", value: "2602", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "387", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€128K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1900911402", cells: ["ORA-4402", "HCM Suite (Oracle) Item 1", "27/7/2026", "€11 502"], status: "active" as const },
    { id: "1900914973", cells: ["ORA-7973", "HCM Suite (Oracle) Item 2", "14/2/2026", "€15 073"], status: "pending" as const },
    { id: "1900918544", cells: ["ORA-2544", "HCM Suite (Oracle) Item 3", "1/9/2026", "€18 644"], status: "completed" as const },
    { id: "1900922115", cells: ["ORA-6115", "HCM Suite (Oracle) Item 4", "16/4/2026", "€22 215"], status: "warning" as const },
    { id: "1900925686", cells: ["ORA-9686", "HCM Suite (Oracle) Item 5", "3/11/2026", "€25 786"], status: "active" as const },
];
...
export default function HcmSuiteOraclePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">HCM Suite (Oracle)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • HCM Suite (Oracle)</p>
                    </div>
                </div>
