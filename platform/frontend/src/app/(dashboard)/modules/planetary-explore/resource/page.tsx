...
const PAGE = "Resource Map";
const KPIS = [{"l":"Total Planetary Explore","v":"3.626","t":"+12.5%","d":"up"},{"l":"Resource Map Ativos","v":"5.413","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"90.9%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"69","t":"+11.3%","d":"up"}];
const COLS = ["ID","Resource Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Planetary Explore #001","Planetary Explore #002","2.760","9.054","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Planetary Explore #002","Planetary Explore #003","8.870","5.726","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Planetary Explore #003","Planetary Explore #004","3.388","2.935","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Planetary Explore #004","Planetary Explore #005","2.579","6.285","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Planetary Explore #005","Planetary Explore #001","5.199","8.981","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":595},{"label":"Mar","value":735},{"label":"Abr","value":514},{"label":"Mai","value":767},{"label":"Jun","value":520},{"label":"Jul","value":486},{"label":"Ago","value":690},{"label":"Set","value":584},{"label":"Out","value":392},{"label":"Nov","value":689},{"label":"Dez","value":535}];
const MX = 767;
