...
export default function PlanetaryExplorePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Planetary Explore</h1><p className="text-sm text-muted-foreground">Planetary Explore • iBOS Enterprise</p></div>
