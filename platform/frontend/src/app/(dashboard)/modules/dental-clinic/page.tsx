...
const KPIS = [
    { label: "Total Registos", value: "5094", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1141", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€469K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1600547894", cells: ["DEN-6894", "Dental Clinic Item 1", "23/3/2026", "€47 994"], status: "active" as const },
    { id: "1600551465", cells: ["DEN-1465", "Dental Clinic Item 2", "10/10/2026", "€1565"], status: "pending" as const },
    { id: "1600555036", cells: ["DEN-5036", "Dental Clinic Item 3", "25/5/2026", "€5136"], status: "completed" as const },
    { id: "1600558607", cells: ["DEN-8607", "Dental Clinic Item 4", "12/12/2026", "€8707"], status: "warning" as const },
    { id: "1600562178", cells: ["DEN-3178", "Dental Clinic Item 5", "27/7/2026", "€12 278"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Dental Clinic</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Dental Clinic</p>
                    </div>
                </div>
