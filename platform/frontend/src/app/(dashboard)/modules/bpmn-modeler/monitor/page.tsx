...
const PAGE = "Monitor";
const KPIS = [{"l":"Diagramas Criados","v":"8.508","t":"+5.0%","d":"up"},{"l":"Templates","v":"1.975","t":"+0.4%","d":"up"},{"l":"Colaboradores","v":"5.188","t":"+5.2%","d":"up"},{"l":"Comentários/Semana","v":"2242","t":"+6.9%","d":"up"}];
const COLS = ["Diagrama","Tipo","Criador","Última Edição","Partilhado","Estado"];
const ROWS = [{"id":"r0","cells":["Processo Onboarding BPMN","Org Chart 2026","2.913","2026-02-12","6.635","Ativo"],"status":"active"},{"id":"r1","cells":["Org Chart 2026","Network Topology","6.747","2026-01-09","2.893","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Topology","Data Flow ETL","6.631","2026-02-01","246","Concluído"],"status":"done"},{"id":"r3","cells":["Data Flow ETL","User Journey Map","216","2026-02-18","6.739","Em Análise"],"status":"risk"},{"id":"r4","cells":["User Journey Map","Processo Onboarding BPMN","4.244","2026-02-13","8.400","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":363},{"label":"Fev","value":403},{"label":"Mar","value":559},{"label":"Abr","value":644},{"label":"Mai","value":600},{"label":"Jun","value":522},{"label":"Jul","value":543},{"label":"Ago","value":574},{"label":"Set","value":503},{"label":"Out","value":359},{"label":"Nov","value":456},{"label":"Dez","value":622}];
const MX = 644;
