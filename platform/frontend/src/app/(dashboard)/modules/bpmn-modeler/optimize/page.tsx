...
const ACCENT = "#06b6d4";
const MODULE = "BPMN Process Modeler";
const PAGE = "Optimize";
const KPIS = [{"l":"Diagramas Criados","v":"8.084","t":"-1.9%","d":"down"},{"l":"Templates","v":"6.258","t":"+14.4%","d":"up"},{"l":"Colaboradores","v":"2.385","t":"+3.7%","d":"up"},{"l":"Comentários/Semana","v":"1792","t":"+15.8%","d":"up"}];
const COLS = ["Diagrama","Tipo","Criador","Última Edição","Partilhado","Estado"];
const ROWS = [{"id":"r0","cells":["Processo Onboarding BPMN","Org Chart 2026","2.092","2026-02-17","3.241","Ativo"],"status":"active"},{"id":"r1","cells":["Org Chart 2026","Network Topology","7.956","2026-02-17","7.834","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Topology","Data Flow ETL","3.615","2026-03-28","8.819","Concluído"],"status":"done"},{"id":"r3","cells":["Data Flow ETL","User Journey Map","5.879","2026-01-25","8.571","Em Análise"],"status":"risk"},{"id":"r4","cells":["User Journey Map","Processo Onboarding BPMN","5.480","2026-01-26","3.748","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":615},{"label":"Mar","value":1006},{"label":"Abr","value":857},{"label":"Mai","value":863},{"label":"Jun","value":927},{"label":"Jul","value":712},{"label":"Ago","value":682},{"label":"Set","value":755},{"label":"Out","value":638},{"label":"Nov","value":642},{"label":"Dez","value":751}];
const MX = 1006;
