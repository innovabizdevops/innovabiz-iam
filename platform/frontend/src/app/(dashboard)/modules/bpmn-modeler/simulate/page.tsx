...
const PAGE = "Simulate";
const KPIS = [{"l":"Twins Ativos","v":"8.736","t":"+16.4%","d":"up"},{"l":"Simulações/Dia","v":"3795","t":"+1.2%","d":"up"},{"l":"Precisão Modelo (%)","v":"85.5%","t":"+8.1%","d":"up"},{"l":"Latência Sync (ms)","v":"185ms","t":"-0.9%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","73.3%","2026-03-02","1.560","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","91.3%","2026-01-25","1.158","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","96.5%","2026-01-17","2.917","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","71.7%","2026-01-18","841","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","79.5%","2026-02-18","8.482","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":751},{"label":"Mar","value":598},{"label":"Abr","value":741},{"label":"Mai","value":646},{"label":"Jun","value":813},{"label":"Jul","value":669},{"label":"Ago","value":540},{"label":"Set","value":532},{"label":"Out","value":651},{"label":"Nov","value":617},{"label":"Dez","value":787}];
const MX = 827;
