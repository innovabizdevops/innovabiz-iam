...
/* ═══ BPMN Process Modeler — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "3335", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "654", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€297K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "197339935", cells: ["BPM-6935", "BPMN Process Modeler Item 1", "24/8/2026", "€40 035"], status: "active" as const },
    { id: "197343506", cells: ["BPM-1506", "BPMN Process Modeler Item 2", "11/3/2026", "€43 606"], status: "pending" as const },
    { id: "197347077", cells: ["BPM-5077", "BPMN Process Modeler Item 3", "26/10/2026", "€47 177"], status: "completed" as const },
    { id: "197350648", cells: ["BPM-8648", "BPMN Process Modeler Item 4", "13/5/2026", "€748"], status: "warning" as const },
    { id: "197354219", cells: ["BPM-3219", "BPMN Process Modeler Item 5", "28/12/2026", "€4319"], status: "active" as const },
];
...
export default function BpmnProcessModelerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">BPMN Process Modeler</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • BPMN Process Modeler</p>
                    </div>
                </div>
