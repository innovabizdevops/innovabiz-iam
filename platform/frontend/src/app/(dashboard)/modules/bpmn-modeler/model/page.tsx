...
const PAGE = "Model";
const KPIS = [{"l":"Diagramas Criados","v":"6.484","t":"-4.9%","d":"down"},{"l":"Templates","v":"4.089","t":"+3.3%","d":"up"},{"l":"Colaboradores","v":"7.357","t":"-1.0%","d":"down"},{"l":"Comentários/Semana","v":"1237","t":"+17.7%","d":"up"}];
const COLS = ["Diagrama","Tipo","Criador","Última Edição","Partilhado","Estado"];
const ROWS = [{"id":"r0","cells":["Processo Onboarding BPMN","Org Chart 2026","2.074","2026-01-07","4.552","Ativo"],"status":"active"},{"id":"r1","cells":["Org Chart 2026","Network Topology","2.186","2026-02-05","683","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Topology","Data Flow ETL","6.704","2026-02-22","2.227","Concluído"],"status":"done"},{"id":"r3","cells":["Data Flow ETL","User Journey Map","684","2026-02-09","1.583","Em Análise"],"status":"risk"},{"id":"r4","cells":["User Journey Map","Processo Onboarding BPMN","3.682","2026-03-06","3.451","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":615},{"label":"Mar","value":658},{"label":"Abr","value":769},{"label":"Mai","value":635},{"label":"Jun","value":776},{"label":"Jul","value":727},{"label":"Ago","value":827},{"label":"Set","value":655},{"label":"Out","value":608},{"label":"Nov","value":902},{"label":"Dez","value":878}];
const MX = 902;
