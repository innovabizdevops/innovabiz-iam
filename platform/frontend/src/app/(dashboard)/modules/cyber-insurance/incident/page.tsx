...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"1.589","t":"-2.4%","d":"down"},{"l":"SLA Cumprido (%)","v":"74.0%","t":"+0.7%","d":"up"},{"l":"MTTR (h)","v":"38h","t":"+14.9%","d":"up"},{"l":"Satisfação (%)","v":"73.3%","t":"-1.4%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.541","6.960","5.245","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.044","5.274","7.994","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.395","4.688","8.135","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.207","2.439","3.301","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.612","5.764","5.003","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":450},{"label":"Mar","value":495},{"label":"Abr","value":531},{"label":"Mai","value":600},{"label":"Jun","value":553},{"label":"Jul","value":446},{"label":"Ago","value":647},{"label":"Set","value":458},{"label":"Out","value":635},{"label":"Nov","value":615},{"label":"Dez","value":589}];
const MX = 647;
