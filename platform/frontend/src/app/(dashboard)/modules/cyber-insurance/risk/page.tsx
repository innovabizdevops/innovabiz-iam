...
const ACCENT = "#6366f1";
const MODULE = "Cyber Insurance";
const PAGE = "Risk Assess";
const KPIS = [{"l":"Riscos Identificados","v":"2.575","t":"+17.7%","d":"up"},{"l":"Mitigações Ativas","v":"6.993","t":"+14.5%","d":"up"},{"l":"Score Risco Geral","v":"80","t":"-3.8%","d":"down"},{"l":"Incidentes YTD","v":"5.002","t":"+4.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.906","7.617","545","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.829","5.149","2.645","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.389","2.267","8.009","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","207","7.263","8.382","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.328","1.185","2.034","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":368},{"label":"Fev","value":501},{"label":"Mar","value":695},{"label":"Abr","value":521},{"label":"Mai","value":575},{"label":"Jun","value":701},{"label":"Jul","value":456},{"label":"Ago","value":610},{"label":"Set","value":448},{"label":"Out","value":591},{"label":"Nov","value":547},{"label":"Dez","value":586}];
const MX = 701;
