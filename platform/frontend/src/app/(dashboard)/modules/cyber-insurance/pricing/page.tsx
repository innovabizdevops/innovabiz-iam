...
const PAGE = "Pricing";
const KPIS = [{"l":"ARR (€M)","v":"€28.6M","t":"+12.3%","d":"up"},{"l":"MRR (€)","v":"€57168","t":"+14.5%","d":"up"},{"l":"Churn (%)","v":"74.3%","t":"+10.1%","d":"up"},{"l":"ARPU (€)","v":"€57530","t":"+11.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 13902.13","4.782","€ 27450.36","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 20937.04","4.835","€ 2083.70","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 12628.45","5.493","€ 697.21","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 22025.73","7.399","€ 38907.53","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 17371.40","4.928","€ 44268.38","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":501},{"label":"Fev","value":717},{"label":"Mar","value":412},{"label":"Abr","value":499},{"label":"Mai","value":660},{"label":"Jun","value":561},{"label":"Jul","value":592},{"label":"Ago","value":361},{"label":"Set","value":640},{"label":"Out","value":532},{"label":"Nov","value":424},{"label":"Dez","value":561}];
const MX = 717;
