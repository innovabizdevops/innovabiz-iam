...
const PAGE = "Recovery";
const KPIS = [{"l":"BCP Plans Ativos","v":"3.051","t":"-0.1%","d":"down"},{"l":"RTO Médio (h)","v":"22h","t":"-1.5%","d":"down"},{"l":"RPO Médio (h)","v":"94h","t":"+16.1%","d":"up"},{"l":"Testes DR (YTD)","v":"5.949","t":"-2.7%","d":"down"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","30h","209h","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","120h","67h","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","29h","138h","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","210h","14h","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","104h","125h","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":794},{"label":"Mar","value":892},{"label":"Abr","value":659},{"label":"Mai","value":680},{"label":"Jun","value":765},{"label":"Jul","value":926},{"label":"Ago","value":944},{"label":"Set","value":942},{"label":"Out","value":943},{"label":"Nov","value":664},{"label":"Dez","value":952}];
const MX = 952;
