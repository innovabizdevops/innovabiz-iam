...
const PAGE = "Leak Detect";
const KPIS = [{"l":"Ideias Submetidas","v":"4.034","t":"-2.9%","d":"down"},{"l":"Patentes (YTD)","v":"1.104","t":"-1.4%","d":"down"},{"l":"Projetos Innovation Lab","v":"1.290","t":"+5.5%","d":"up"},{"l":"Budget I&D (€M)","v":"€40.2M","t":"+1.4%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","4.761","73.7%","1.756","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","5.103","82.4%","4.787","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","7.374","77.6%","1.278","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","7.510","83.6%","756","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","3.094","72.3%","6.516","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":854},{"label":"Mar","value":887},{"label":"Abr","value":672},{"label":"Mai","value":752},{"label":"Jun","value":865},{"label":"Jul","value":783},{"label":"Ago","value":689},{"label":"Set","value":824},{"label":"Out","value":632},{"label":"Nov","value":650},{"label":"Dez","value":868}];
const MX = 887;
