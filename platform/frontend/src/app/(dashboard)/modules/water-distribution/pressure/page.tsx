...
const ACCENT = "#dc2626";
const MODULE = "Water Distribution";
const PAGE = "Pressure Zone";
const KPIS = [{"l":"Ideias Submetidas","v":"7.719","t":"+2.3%","d":"up"},{"l":"Patentes (YTD)","v":"8.925","t":"+16.1%","d":"up"},{"l":"Projetos Innovation Lab","v":"851","t":"+11.6%","d":"up"},{"l":"Budget I&D (€M)","v":"€28.9M","t":"+9.9%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","8.115","93.6%","8.080","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","8.562","97.2%","3.810","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","2.634","82.4%","244","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","9.057","74.5%","7.777","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","3.052","96.4%","5.864","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":776},{"label":"Mar","value":763},{"label":"Abr","value":697},{"label":"Mai","value":623},{"label":"Jun","value":675},{"label":"Jul","value":729},{"label":"Ago","value":460},{"label":"Set","value":825},{"label":"Out","value":555},{"label":"Nov","value":687},{"label":"Dez","value":629}];
const MX = 825;
