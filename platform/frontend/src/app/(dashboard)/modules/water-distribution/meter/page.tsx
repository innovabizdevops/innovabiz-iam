...
const KPIS = [{"l":"Ideias Submetidas","v":"2.837","t":"-4.7%","d":"down"},{"l":"Patentes (YTD)","v":"3.779","t":"+0.1%","d":"up"},{"l":"Projetos Innovation Lab","v":"5.369","t":"+14.5%","d":"up"},{"l":"Budget I&D (€M)","v":"€27.7M","t":"+15.4%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","641","82.2%","6.456","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.487","93.5%","3.721","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.280","83.2%","2.738","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","6.744","94.0%","7.886","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.573","94.8%","929","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":824},{"label":"Fev","value":673},{"label":"Mar","value":781},{"label":"Abr","value":590},{"label":"Mai","value":482},{"label":"Jun","value":721},{"label":"Jul","value":567},{"label":"Ago","value":490},{"label":"Set","value":719},{"label":"Out","value":642},{"label":"Nov","value":558},{"label":"Dez","value":816}];
const MX = 824;
