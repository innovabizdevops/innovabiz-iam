...
const PAGE = "NRW Track";
const KPIS = [{"l":"Ideias Submetidas","v":"6.312","t":"+16.1%","d":"up"},{"l":"Patentes (YTD)","v":"6.257","t":"+1.0%","d":"up"},{"l":"Projetos Innovation Lab","v":"779","t":"-2.8%","d":"down"},{"l":"Budget I&D (€M)","v":"€15.6M","t":"+5.7%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","5.554","81.3%","7.178","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","182","78.8%","2.036","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","5.917","73.7%","8.837","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.069","72.8%","4.273","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","5.845","97.6%","2.880","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":613},{"label":"Mar","value":805},{"label":"Abr","value":911},{"label":"Mai","value":658},{"label":"Jun","value":617},{"label":"Jul","value":666},{"label":"Ago","value":959},{"label":"Set","value":742},{"label":"Out","value":934},{"label":"Nov","value":845},{"label":"Dez","value":635}];
const MX = 959;
