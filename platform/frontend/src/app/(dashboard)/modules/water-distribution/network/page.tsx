...
const PAGE = "Pipe Network";
const KPIS = [{"l":"Ideias Submetidas","v":"8.376","t":"-4.9%","d":"down"},{"l":"Patentes (YTD)","v":"121","t":"+4.6%","d":"up"},{"l":"Projetos Innovation Lab","v":"8.381","t":"+15.6%","d":"up"},{"l":"Budget I&D (€M)","v":"€1.6M","t":"+6.6%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","580","97.0%","5.660","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","470","82.1%","1.752","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.976","80.0%","7.234","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","7.577","99.8%","2.108","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.252","83.2%","8.774","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":295},{"label":"Fev","value":366},{"label":"Mar","value":568},{"label":"Abr","value":628},{"label":"Mai","value":587},{"label":"Jun","value":352},{"label":"Jul","value":433},{"label":"Ago","value":571},{"label":"Set","value":648},{"label":"Out","value":645},{"label":"Nov","value":387},{"label":"Dez","value":400}];
const MX = 648;
