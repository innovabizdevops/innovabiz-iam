...
const KPIS = [
    { label: "Total Registos", value: "4385", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4614", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€221K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "138020185", cells: ["MAR-6185", "Market Risk Management Item 1", "10/2/2026", "€20 285"], status: "active" as const },
    { id: "138023756", cells: ["MAR-9756", "Market Risk Management Item 2", "25/9/2026", "€23 856"], status: "pending" as const },
    { id: "138027327", cells: ["MAR-4327", "Market Risk Management Item 3", "12/4/2026", "€27 427"], status: "completed" as const },
    { id: "138030898", cells: ["MAR-7898", "Market Risk Management Item 4", "27/11/2026", "€30 998"], status: "warning" as const },
    { id: "138034469", cells: ["MAR-2469", "Market Risk Management Item 5", "14/6/2026", "€34 569"], status: "active" as const },
];
...
export default function MarketRiskManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Market Risk Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Market Risk Management</p>
                    </div>
                </div>
