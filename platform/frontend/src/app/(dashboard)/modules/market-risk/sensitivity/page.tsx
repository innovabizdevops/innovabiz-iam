...
const ACCENT = "#1e3a5f";
const MODULE = "Market Risk Management";
const PAGE = "Sensitivity";
const KPIS = [{"l":"Riscos Identificados","v":"3.241","t":"+2.5%","d":"up"},{"l":"Mitigações Ativas","v":"8.845","t":"+13.1%","d":"up"},{"l":"Score Risco Geral","v":"83","t":"+17.5%","d":"up"},{"l":"Incidentes YTD","v":"5.362","t":"-3.0%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.039","6.730","3.089","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.128","5.433","2.495","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.431","8.169","7.542","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.578","6.307","6.978","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.309","1.269","9.020","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":543},{"label":"Mar","value":683},{"label":"Abr","value":765},{"label":"Mai","value":739},{"label":"Jun","value":924},{"label":"Jul","value":735},{"label":"Ago","value":813},{"label":"Set","value":751},{"label":"Out","value":827},{"label":"Nov","value":551},{"label":"Dez","value":606}];
const MX = 924;
