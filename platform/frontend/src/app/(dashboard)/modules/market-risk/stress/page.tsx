...
const PAGE = "Stress";
const KPIS = [{"l":"Riscos Identificados","v":"987","t":"+15.6%","d":"up"},{"l":"Mitigações Ativas","v":"4.393","t":"+0.6%","d":"up"},{"l":"Score Risco Geral","v":"60","t":"+14.8%","d":"up"},{"l":"Incidentes YTD","v":"7.185","t":"+16.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.541","8.958","7.361","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.398","6.421","3.623","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.636","3.777","2.118","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.395","8.498","6.650","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.787","5.535","8.507","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":924},{"label":"Fev","value":801},{"label":"Mar","value":705},{"label":"Abr","value":931},{"label":"Mai","value":996},{"label":"Jun","value":868},{"label":"Jul","value":780},{"label":"Ago","value":952},{"label":"Set","value":918},{"label":"Out","value":774},{"label":"Nov","value":961},{"label":"Dez","value":741}];
const MX = 996;
