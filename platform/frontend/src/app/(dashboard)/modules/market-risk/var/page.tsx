...
const PAGE = "VaR";
const KPIS = [{"l":"Riscos Identificados","v":"1.698","t":"+10.2%","d":"up"},{"l":"Mitigações Ativas","v":"6.303","t":"+11.2%","d":"up"},{"l":"Score Risco Geral","v":"83","t":"+14.2%","d":"up"},{"l":"Incidentes YTD","v":"5.602","t":"-4.7%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.222","8.141","6.785","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.116","4.810","876","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.490","2.415","4.186","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.046","1.322","117","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","994","4.078","4.200","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1022},{"label":"Fev","value":704},{"label":"Mar","value":863},{"label":"Abr","value":771},{"label":"Mai","value":880},{"label":"Jun","value":892},{"label":"Jul","value":1006},{"label":"Ago","value":726},{"label":"Set","value":954},{"label":"Out","value":785},{"label":"Nov","value":831},{"label":"Dez","value":717}];
const MX = 1022;
