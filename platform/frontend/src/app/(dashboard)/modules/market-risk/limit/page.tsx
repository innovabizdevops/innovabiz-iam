...
const PAGE = "Limit";
const KPIS = [{"l":"Riscos Identificados","v":"1.187","t":"+6.4%","d":"up"},{"l":"Mitigações Ativas","v":"4.593","t":"-2.7%","d":"down"},{"l":"Score Risco Geral","v":"75","t":"+8.8%","d":"up"},{"l":"Incidentes YTD","v":"6.696","t":"+9.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.476","3.969","4.503","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.564","1.564","5.735","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.135","5.596","4.802","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.652","8.190","571","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","9.025","8.439","1.742","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":254},{"label":"Fev","value":414},{"label":"Mar","value":270},{"label":"Abr","value":308},{"label":"Mai","value":485},{"label":"Jun","value":263},{"label":"Jul","value":628},{"label":"Ago","value":300},{"label":"Set","value":388},{"label":"Out","value":637},{"label":"Nov","value":434},{"label":"Dez","value":609}];
const MX = 637;
