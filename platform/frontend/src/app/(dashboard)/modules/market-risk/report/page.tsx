...
const PAGE = "Report";
const KPIS = [{"l":"Riscos Identificados","v":"8.056","t":"+16.0%","d":"up"},{"l":"Mitigações Ativas","v":"3.913","t":"-0.6%","d":"down"},{"l":"Score Risco Geral","v":"63","t":"+16.2%","d":"up"},{"l":"Incidentes YTD","v":"228","t":"+1.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.731","6.747","6.075","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","613","1.816","4.142","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.724","5.948","4.557","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.613","5.510","8.138","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.825","2.237","3.313","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":321},{"label":"Fev","value":431},{"label":"Mar","value":558},{"label":"Abr","value":412},{"label":"Mai","value":538},{"label":"Jun","value":465},{"label":"Jul","value":510},{"label":"Ago","value":630},{"label":"Set","value":454},{"label":"Out","value":412},{"label":"Nov","value":302},{"label":"Dez","value":414}];
const MX = 630;
