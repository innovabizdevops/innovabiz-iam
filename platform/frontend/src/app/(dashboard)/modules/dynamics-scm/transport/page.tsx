...
const KPIS = [{"l":"Atletas Registados","v":"3.555","t":"+15.5%","d":"up"},{"l":"Treinos/Semana","v":"437","t":"+5.4%","d":"up"},{"l":"Competições","v":"6.075","t":"+15.5%","d":"up"},{"l":"Performance Score","v":"90","t":"-3.7%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.587","2.583","8.838","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.988","5.773","7.062","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.531","6.523","8.988","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.542","4.773","8.898","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.020","5.517","4.144","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":589},{"label":"Mar","value":566},{"label":"Abr","value":694},{"label":"Mai","value":696},{"label":"Jun","value":531},{"label":"Jul","value":797},{"label":"Ago","value":523},{"label":"Set","value":812},{"label":"Out","value":485},{"label":"Nov","value":656},{"label":"Dez","value":596}];
const MX = 812;
