...
/* ═══ Supply Chain Hub (D365) — Dashboard ═══ */

const ACCENT = "#00bcf2";

const KPIS = [
    { label: "Total Registos", value: "6137", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2576", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€159K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1204400437", cells: ["DYN-3437", "Supply Chain Hub (D365) Item 1", "10/2/2026", "€537"], status: "active" as const },
    { id: "1204404008", cells: ["DYN-7008", "Supply Chain Hub (D365) Item 2", "25/9/2026", "€4108"], status: "pending" as const },
    { id: "1204407579", cells: ["DYN-1579", "Supply Chain Hub (D365) Item 3", "12/4/2026", "€7679"], status: "completed" as const },
    { id: "1204411150", cells: ["DYN-5150", "Supply Chain Hub (D365) Item 4", "27/11/2026", "€11 250"], status: "warning" as const },
    { id: "1204414721", cells: ["DYN-8721", "Supply Chain Hub (D365) Item 5", "14/6/2026", "€14 821"], status: "active" as const },
];
...
export default function SupplyChainHubD365Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Supply Chain Hub (D365)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Supply Chain Hub (D365)</p>
                    </div>
                </div>
