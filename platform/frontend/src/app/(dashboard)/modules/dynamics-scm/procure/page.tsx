...
const PAGE = "Procure";
const KPIS = [{"l":"Fornecedores Ativos","v":"3.154","t":"+7.1%","d":"up"},{"l":"Contratos (€M)","v":"€37.4M","t":"+15.4%","d":"up"},{"l":"On-Time Delivery (%)","v":"70.1%","t":"+16.6%","d":"up"},{"l":"Score Médio","v":"71","t":"+8.4%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","95.4%","€ 36617.18","6.823","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","91.2%","€ 27851.78","832","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","89.0%","€ 148.81","6.486","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","80.8%","€ 30997.86","8.810","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","86.3%","€ 18056.71","7.202","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":568},{"label":"Mar","value":520},{"label":"Abr","value":757},{"label":"Mai","value":565},{"label":"Jun","value":697},{"label":"Jul","value":707},{"label":"Ago","value":604},{"label":"Set","value":647},{"label":"Out","value":725},{"label":"Nov","value":590},{"label":"Dez","value":678}];
const MX = 757;
