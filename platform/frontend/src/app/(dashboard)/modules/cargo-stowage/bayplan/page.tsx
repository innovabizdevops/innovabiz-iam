...
const PAGE = "Bay Plan";
const KPIS = [{"l":"Total Cargo Stowage","v":"7.538","t":"+10.3%","d":"up"},{"l":"Bay Plan Ativos","v":"600","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"76.3%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"79","t":"+8.6%","d":"up"}];
const COLS = ["ID","Bay Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cargo Stowage #001","Cargo Stowage #002","5.935","446","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Cargo Stowage #002","Cargo Stowage #003","4.216","4.374","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Cargo Stowage #003","Cargo Stowage #004","2.361","6.854","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Cargo Stowage #004","Cargo Stowage #005","6.052","4.439","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cargo Stowage #005","Cargo Stowage #001","3.831","1.446","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":548},{"label":"Mar","value":859},{"label":"Abr","value":663},{"label":"Mai","value":594},{"label":"Jun","value":910},{"label":"Jul","value":918},{"label":"Ago","value":609},{"label":"Set","value":627},{"label":"Out","value":708},{"label":"Nov","value":614},{"label":"Dez","value":816}];
const MX = 918;
...
export default function BayplanPage() {
    return (
