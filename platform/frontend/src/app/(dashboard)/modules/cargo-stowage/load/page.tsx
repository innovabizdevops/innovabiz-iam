...
const PAGE = "Load Calc";
const KPIS = [{"l":"Total Cargo Stowage","v":"3.353","t":"+11.0%","d":"up"},{"l":"Load Calc Ativos","v":"1.206","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"93.0%","t":"-2.3%","d":"down"},{"l":"Score Performance","v":"80","t":"+8.1%","d":"up"}];
const COLS = ["ID","Load Calc","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cargo Stowage #001","Cargo Stowage #002","4.687","6.828","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Cargo Stowage #002","Cargo Stowage #003","6.994","3.668","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Cargo Stowage #003","Cargo Stowage #004","8.523","8.025","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Cargo Stowage #004","Cargo Stowage #005","6.365","5.105","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cargo Stowage #005","Cargo Stowage #001","485","3.686","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":680},{"label":"Mar","value":579},{"label":"Abr","value":685},{"label":"Mai","value":621},{"label":"Jun","value":396},{"label":"Jul","value":658},{"label":"Ago","value":513},{"label":"Set","value":403},{"label":"Out","value":639},{"label":"Nov","value":408},{"label":"Dez","value":791}];
const MX = 791;
