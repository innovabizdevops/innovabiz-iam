...
const ACCENT = "#7c3aed";
const MODULE = "Cargo Stowage";
const PAGE = "Reefer Control";
const KPIS = [{"l":"Total Cargo Stowage","v":"4.440","t":"+6.5%","d":"up"},{"l":"Reefer Control Ativos","v":"5.424","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"72.9%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"69","t":"-2.8%","d":"down"}];
const COLS = ["ID","Reefer Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cargo Stowage #001","Cargo Stowage #002","290","9.018","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Cargo Stowage #002","Cargo Stowage #003","2.693","703","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Cargo Stowage #003","Cargo Stowage #004","5.635","5.863","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Cargo Stowage #004","Cargo Stowage #005","4.698","998","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cargo Stowage #005","Cargo Stowage #001","4.806","2.487","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":858},{"label":"Fev","value":933},{"label":"Mar","value":751},{"label":"Abr","value":584},{"label":"Mai","value":652},{"label":"Jun","value":815},{"label":"Jul","value":913},{"label":"Ago","value":599},{"label":"Set","value":570},{"label":"Out","value":690},{"label":"Nov","value":907},{"label":"Dez","value":773}];
const MX = 933;
