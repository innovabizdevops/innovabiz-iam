...
export default function CargoStowagePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Cargo Stowage</h1><p className="text-sm text-muted-foreground">Cargo Stowage • iBOS Enterprise</p></div>
