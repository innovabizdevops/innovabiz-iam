...
const PAGE = "DG Manifest";
const KPIS = [{"l":"Total Cargo Stowage","v":"4.574","t":"+16.6%","d":"up"},{"l":"DG Manifest Ativos","v":"6.301","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"78","t":"+4.6%","d":"up"}];
const COLS = ["ID","DG Manifest","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cargo Stowage #001","Cargo Stowage #002","1.154","6.258","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Cargo Stowage #002","Cargo Stowage #003","8.972","6.699","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Cargo Stowage #003","Cargo Stowage #004","5.155","2.074","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Cargo Stowage #004","Cargo Stowage #005","1.321","595","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cargo Stowage #005","Cargo Stowage #001","2.283","6.192","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":764},{"label":"Fev","value":722},{"label":"Mar","value":944},{"label":"Abr","value":882},{"label":"Mai","value":805},{"label":"Jun","value":969},{"label":"Jul","value":703},{"label":"Ago","value":684},{"label":"Set","value":890},{"label":"Out","value":952},{"label":"Nov","value":993},{"label":"Dez","value":849}];
const MX = 993;
