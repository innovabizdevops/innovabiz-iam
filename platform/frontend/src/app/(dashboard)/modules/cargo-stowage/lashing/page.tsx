...
const PAGE = "Lashing Plan";
const KPIS = [{"l":"Total Cargo Stowage","v":"6.233","t":"+8.3%","d":"up"},{"l":"Lashing Plan Ativos","v":"1.421","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"76.4%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"93","t":"-1.4%","d":"down"}];
const COLS = ["ID","Lashing Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cargo Stowage #001","Cargo Stowage #002","4.556","4.579","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Cargo Stowage #002","Cargo Stowage #003","748","6.111","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Cargo Stowage #003","Cargo Stowage #004","5.700","5.284","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Cargo Stowage #004","Cargo Stowage #005","7.176","8.307","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cargo Stowage #005","Cargo Stowage #001","6.535","5.937","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":569},{"label":"Mar","value":527},{"label":"Abr","value":756},{"label":"Mai","value":826},{"label":"Jun","value":609},{"label":"Jul","value":570},{"label":"Ago","value":803},{"label":"Set","value":691},{"label":"Out","value":492},{"label":"Nov","value":752},{"label":"Dez","value":785}];
const MX = 826;
