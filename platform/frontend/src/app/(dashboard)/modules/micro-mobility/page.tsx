...
/* ═══ Micro-Mobility Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "6561", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2928", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€368K", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "145001861", cells: ["MIC-3861", "Micro-Mobility Platform Item 1", "26/6/2026", "€1961"], status: "active" as const },
    { id: "145005432", cells: ["MIC-7432", "Micro-Mobility Platform Item 2", "13/1/2026", "€5532"], status: "pending" as const },
    { id: "145009003", cells: ["MIC-2003", "Micro-Mobility Platform Item 3", "28/8/2026", "€9103"], status: "completed" as const },
    { id: "145012574", cells: ["MIC-5574", "Micro-Mobility Platform Item 4", "15/3/2026", "€12 674"], status: "warning" as const },
    { id: "145016145", cells: ["MIC-9145", "Micro-Mobility Platform Item 5", "2/10/2026", "€16 245"], status: "active" as const },
];
...
export default function MicromobilityPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Micro-Mobility Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Micro-Mobility Platform</p>
                    </div>
                </div>
