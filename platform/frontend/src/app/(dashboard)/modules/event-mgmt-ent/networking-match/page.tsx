...
const ROWS = [
  { id: "001", c: ["Networking Match-001", "Networking Match Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Networking Match-002", "Networking Match Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Networking Match-003", "Networking Match Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Networking Match-004", "Networking Match Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Networking Match-005", "Networking Match Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Networking Match", ts: "Há 2min", a: "Sistema" },
...
export default function NetworkingMatchPage() {
  return (
