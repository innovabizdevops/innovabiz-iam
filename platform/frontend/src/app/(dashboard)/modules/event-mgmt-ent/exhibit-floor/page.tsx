...
const ROWS = [
  { id: "001", c: ["Exhibit Floor-001", "Exhibit Floor Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Exhibit Floor-002", "Exhibit Floor Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Exhibit Floor-003", "Exhibit Floor Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Exhibit Floor-004", "Exhibit Floor Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Exhibit Floor-005", "Exhibit Floor Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Exhibit Floor", ts: "Há 2min", a: "Sistema" },
...
export default function ExhibitFloorPage() {
  return (
