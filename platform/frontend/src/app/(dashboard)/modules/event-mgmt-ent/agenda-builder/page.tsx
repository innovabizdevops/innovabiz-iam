...
const ROWS = [
  { id: "001", c: ["Agenda Builder-001", "Agenda Builder Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Agenda Builder-002", "Agenda Builder Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Agenda Builder-003", "Agenda Builder Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Agenda Builder-004", "Agenda Builder Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Agenda Builder-005", "Agenda Builder Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Agenda Builder", ts: "Há 2min", a: "Sistema" },
