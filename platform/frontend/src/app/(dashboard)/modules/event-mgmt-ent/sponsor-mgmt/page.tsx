...
const ROWS = [
  { id: "001", c: ["Sponsor Mgmt-001", "Sponsor Mgmt Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Sponsor Mgmt-002", "Sponsor Mgmt Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Sponsor Mgmt-003", "Sponsor Mgmt Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Sponsor Mgmt-004", "Sponsor Mgmt Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Sponsor Mgmt-005", "Sponsor Mgmt Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Sponsor Mgmt", ts: "Há 2min", a: "Sistema" },
...
export default function SponsorMgmtPage() {
  return (
