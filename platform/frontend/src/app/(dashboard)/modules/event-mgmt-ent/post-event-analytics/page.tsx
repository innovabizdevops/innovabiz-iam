...
const PAGE = "Post Event Analytics";
const KPIS = [{"l":"Veículos Ativos","v":"1,247","d":"+4.2%","u":true},{"l":"Km/Mês (M)","v":"3.8","d":"+2.1%","u":true},{"l":"Custo/Km (€)","v":"0.32","d":"-5.1%","u":false},{"l":"Disponibilidade (%)","v":"96.4%","d":"+1.2%","u":true}];
const COLS = ["Veículo","Matrícula","Condutor","Km Acumulados","Próx. Revisão","Estado"];
const ROWS = [
  { id: "001", c: ["Post Event Analytics-001", "Post Event Analytics Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Post Event Analytics-002", "Post Event Analytics Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Post Event Analytics-003", "Post Event Analytics Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Post Event Analytics-004", "Post Event Analytics Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Post Event Analytics-005", "Post Event Analytics Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Post Event Analytics", ts: "Há 2min", a: "Sistema" },
...
export default function PostEventAnalyticsPage() {
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Event Mgmt — iBOS Enterprise</p>
        </div>
