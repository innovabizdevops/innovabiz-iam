...
const PAGE = "Registration Portal";
...
const ROWS = [
  { id: "001", c: ["Registration Portal-001", "Registration Portal Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Registration Portal-002", "Registration Portal Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Registration Portal-003", "Registration Portal Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Registration Portal-004", "Registration Portal Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Registration Portal-005", "Registration Portal Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Registration Portal", ts: "Há 2min", a: "Sistema" },
