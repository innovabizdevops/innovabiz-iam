...
const KPIS = [{"l":"eNPS","v":"82","t":"+1.8%","d":"up"},{"l":"Engagement (%)","v":"65.7%","t":"+11.0%","d":"up"},{"l":"Turnover (%)","v":"82.4%","t":"-2.7%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"7.133","t":"-2.8%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.212","2026-02-12","80","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.332","2026-01-17","56","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.503","2026-03-16","67","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","788","2026-02-15","56","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.652","2026-02-19","57","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":648},{"label":"Mar","value":898},{"label":"Abr","value":837},{"label":"Mai","value":717},{"label":"Jun","value":561},{"label":"Jul","value":850},{"label":"Ago","value":793},{"label":"Set","value":776},{"label":"Out","value":788},{"label":"Nov","value":635},{"label":"Dez","value":686}];
const MX = 898;
