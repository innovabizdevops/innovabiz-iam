...
const KPIS = [{"l":"eNPS","v":"68","t":"-4.5%","d":"down"},{"l":"Engagement (%)","v":"84.2%","t":"+8.8%","d":"up"},{"l":"Turnover (%)","v":"82.7%","t":"+9.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.125","t":"-1.3%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.157","2026-02-17","68","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.111","2026-01-03","59","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.346","2026-01-20","59","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","592","2026-01-18","91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.453","2026-01-27","72","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":479},{"label":"Mar","value":582},{"label":"Abr","value":447},{"label":"Mai","value":454},{"label":"Jun","value":390},{"label":"Jul","value":429},{"label":"Ago","value":268},{"label":"Set","value":455},{"label":"Out","value":564},{"label":"Nov","value":331},{"label":"Dez","value":421}];
const MX = 582;
