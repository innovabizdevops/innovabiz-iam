...
const KPIS = [
    { label: "Total Registos", value: "104", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3041", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€111K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "89862304", cells: ["WOR-7304", "Workspace Management Item 1", "1/5/2026", "€12 404"], status: "active" as const },
    { id: "89865875", cells: ["WOR-1875", "Workspace Management Item 2", "16/12/2026", "€15 975"], status: "pending" as const },
    { id: "89869446", cells: ["WOR-5446", "Workspace Management Item 3", "3/7/2026", "€19 546"], status: "completed" as const },
    { id: "89873017", cells: ["WOR-9017", "Workspace Management Item 4", "18/2/2026", "€23 117"], status: "warning" as const },
    { id: "89876588", cells: ["WOR-3588", "Workspace Management Item 5", "5/9/2026", "€26 688"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Workspace Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Workspace Management</p>
                    </div>
                </div>
