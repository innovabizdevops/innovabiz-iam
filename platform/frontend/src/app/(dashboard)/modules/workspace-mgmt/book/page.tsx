...
const PAGE = "Book";
const KPIS = [{"l":"eNPS","v":"79","t":"+0.3%","d":"up"},{"l":"Engagement (%)","v":"71.3%","t":"+9.5%","d":"up"},{"l":"Turnover (%)","v":"70.9%","t":"-3.9%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"1.723","t":"+16.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","9.068","2026-03-19","62","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.300","2026-03-13","73","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.663","2026-03-28","91","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.115","2026-03-10","92","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.559","2026-03-05","57","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":560},{"label":"Mar","value":571},{"label":"Abr","value":536},{"label":"Mai","value":604},{"label":"Jun","value":632},{"label":"Jul","value":762},{"label":"Ago","value":659},{"label":"Set","value":733},{"label":"Out","value":768},{"label":"Nov","value":712},{"label":"Dez","value":686}];
const MX = 768;
