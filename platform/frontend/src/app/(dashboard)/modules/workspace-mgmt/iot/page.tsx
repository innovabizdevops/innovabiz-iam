...
const ACCENT = "#92400e";
const MODULE = "Workspace Management";
const PAGE = "IoT";
const KPIS = [{"l":"Dispositivos Online","v":"4.203","t":"-5.7%","d":"down"},{"l":"Dados/Min (MB)","v":"6.623","t":"-3.1%","d":"down"},{"l":"Alertas Ativos","v":"149","t":"+17.2%","d":"up"},{"l":"Uptime (%)","v":"91.6%","t":"-1.3%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.644","4.910","4.148","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.858","5.514","7.119","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.921","8.950","7.668","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","4.731","8.558","544","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.473","2.398","3.115","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":688},{"label":"Mar","value":736},{"label":"Abr","value":728},{"label":"Mai","value":559},{"label":"Jun","value":904},{"label":"Jul","value":921},{"label":"Ago","value":823},{"label":"Set","value":743},{"label":"Out","value":886},{"label":"Nov","value":641},{"label":"Dez","value":557}];
const MX = 921;
