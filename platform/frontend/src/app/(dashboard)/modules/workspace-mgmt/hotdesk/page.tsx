...
const PAGE = "Hotdesk";
const KPIS = [{"l":"eNPS","v":"55","t":"+9.8%","d":"up"},{"l":"Engagement (%)","v":"91.3%","t":"+16.7%","d":"up"},{"l":"Turnover (%)","v":"81.6%","t":"+12.8%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.786","t":"+17.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.553","2026-01-24","84","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.192","2026-02-06","72","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","9.097","2026-02-07","65","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.926","2026-03-20","80","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.329","2026-03-10","83","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":605},{"label":"Mar","value":557},{"label":"Abr","value":625},{"label":"Mai","value":680},{"label":"Jun","value":579},{"label":"Jul","value":612},{"label":"Ago","value":567},{"label":"Set","value":686},{"label":"Out","value":645},{"label":"Nov","value":391},{"label":"Dez","value":571}];
const MX = 686;
