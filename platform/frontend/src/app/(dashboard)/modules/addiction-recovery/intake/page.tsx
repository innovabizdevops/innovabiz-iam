...
const PAGE = "Intake";
const KPIS = [{"l":"BCP Plans Ativos","v":"1.308","t":"+10.9%","d":"up"},{"l":"RTO Médio (h)","v":"94h","t":"+15.7%","d":"up"},{"l":"RPO Médio (h)","v":"128h","t":"+13.0%","d":"up"},{"l":"Testes DR (YTD)","v":"8.288","t":"+10.5%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","113h","92h","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","42h","195h","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","71h","35h","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","90h","150h","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","194h","87h","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":862},{"label":"Mar","value":605},{"label":"Abr","value":706},{"label":"Mai","value":590},{"label":"Jun","value":857},{"label":"Jul","value":690},{"label":"Ago","value":645},{"label":"Set","value":618},{"label":"Out","value":562},{"label":"Nov","value":755},{"label":"Dez","value":771}];
const MX = 862;
