...
const PAGE = "Monitor";
const KPIS = [{"l":"BCP Plans Ativos","v":"4.378","t":"+15.3%","d":"up"},{"l":"RTO Médio (h)","v":"28h","t":"+12.1%","d":"up"},{"l":"RPO Médio (h)","v":"40h","t":"-0.6%","d":"down"},{"l":"Testes DR (YTD)","v":"5.064","t":"+4.3%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","66h","135h","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","72h","83h","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","146h","29h","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","119h","137h","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","192h","201h","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":588},{"label":"Mar","value":516},{"label":"Abr","value":531},{"label":"Mai","value":631},{"label":"Jun","value":505},{"label":"Jul","value":588},{"label":"Ago","value":740},{"label":"Set","value":586},{"label":"Out","value":470},{"label":"Nov","value":477},{"label":"Dez","value":581}];
const MX = 740;
