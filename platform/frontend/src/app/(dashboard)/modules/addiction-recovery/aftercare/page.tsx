...
const ACCENT = "#6366f1";
const MODULE = "Addiction Recovery";
const PAGE = "Aftercare";
const KPIS = [{"l":"BCP Plans Ativos","v":"1.799","t":"+5.1%","d":"up"},{"l":"RTO Médio (h)","v":"97h","t":"+17.6%","d":"up"},{"l":"RPO Médio (h)","v":"178h","t":"+11.9%","d":"up"},{"l":"Testes DR (YTD)","v":"2.910","t":"+5.1%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","183h","65h","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","94h","31h","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","209h","73h","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","148h","128h","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","156h","54h","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":345},{"label":"Fev","value":491},{"label":"Mar","value":337},{"label":"Abr","value":330},{"label":"Mai","value":303},{"label":"Jun","value":567},{"label":"Jul","value":302},{"label":"Ago","value":567},{"label":"Set","value":482},{"label":"Out","value":492},{"label":"Nov","value":600},{"label":"Dez","value":474}];
const MX = 600;
