...
const PAGE = "Group";
const KPIS = [{"l":"BCP Plans Ativos","v":"7.047","t":"-1.3%","d":"down"},{"l":"RTO Médio (h)","v":"179h","t":"+5.9%","d":"up"},{"l":"RPO Médio (h)","v":"163h","t":"-1.1%","d":"down"},{"l":"Testes DR (YTD)","v":"7.460","t":"+17.1%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","151h","127h","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","161h","150h","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","149h","69h","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","166h","105h","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","46h","10h","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":713},{"label":"Mar","value":665},{"label":"Abr","value":866},{"label":"Mai","value":841},{"label":"Jun","value":715},{"label":"Jul","value":869},{"label":"Ago","value":811},{"label":"Set","value":919},{"label":"Out","value":696},{"label":"Nov","value":824},{"label":"Dez","value":826}];
const MX = 919;
