...
const KPIS = [{"l":"BCP Plans Ativos","v":"489","t":"+17.2%","d":"up"},{"l":"RTO Médio (h)","v":"31h","t":"+11.6%","d":"up"},{"l":"RPO Médio (h)","v":"14h","t":"-1.0%","d":"down"},{"l":"Testes DR (YTD)","v":"3.575","t":"+12.0%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","186h","136h","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","192h","166h","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","151h","113h","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","112h","126h","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","11h","192h","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":920},{"label":"Fev","value":836},{"label":"Mar","value":817},{"label":"Abr","value":831},{"label":"Mai","value":658},{"label":"Jun","value":591},{"label":"Jul","value":933},{"label":"Ago","value":750},{"label":"Set","value":726},{"label":"Out","value":935},{"label":"Nov","value":759},{"label":"Dez","value":700}];
const MX = 935;
