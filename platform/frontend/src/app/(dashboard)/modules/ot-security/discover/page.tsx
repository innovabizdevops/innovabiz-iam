...
const PAGE = "Asset Discover";
const KPIS = [{"l":"Ativos Registados","v":"4.960","t":"+8.6%","d":"up"},{"l":"Valor Total (€M)","v":"€34.7M","t":"-3.6%","d":"down"},{"l":"Depreciação Anual (€)","v":"€23451","t":"+1.3%","d":"up"},{"l":"Ativos em Garantia","v":"1.551","t":"+7.0%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 32623.10","4.908","€ 395.28","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 19263.27","4.049","€ 21907.20","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 1362.43","7.645","€ 38732.42","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 24630.93","8.380","€ 49387.95","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 43275.94","6.937","€ 3026.44","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":847},{"label":"Mar","value":815},{"label":"Abr","value":694},{"label":"Mai","value":1071},{"label":"Jun","value":1028},{"label":"Jul","value":824},{"label":"Ago","value":876},{"label":"Set","value":686},{"label":"Out","value":713},{"label":"Nov","value":675},{"label":"Dez","value":976}];
const MX = 1071;
