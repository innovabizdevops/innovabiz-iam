...
const ACCENT = "#475569";
const MODULE = "OT Security";
const PAGE = "Protocol Mon";
const KPIS = [{"l":"Integrações Ativas","v":"3.528","t":"-3.1%","d":"down"},{"l":"Chamadas/Hora","v":"545","t":"+15.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"80.4%","t":"+11.0%","d":"up"},{"l":"Latência Média (ms)","v":"157ms","t":"+2.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.670","7.771","78.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.182","6.302","89.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.239","904","88.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.665","996","80.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","831","5.844","77.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":500},{"label":"Fev","value":375},{"label":"Mar","value":642},{"label":"Abr","value":365},{"label":"Mai","value":403},{"label":"Jun","value":660},{"label":"Jul","value":268},{"label":"Ago","value":349},{"label":"Set","value":333},{"label":"Out","value":411},{"label":"Nov","value":446},{"label":"Dez","value":570}];
const MX = 660;
