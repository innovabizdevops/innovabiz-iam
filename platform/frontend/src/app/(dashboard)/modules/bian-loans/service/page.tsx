...
const PAGE = "Service";
const KPIS = [{"l":"BCP Plans Ativos","v":"7.679","t":"+14.2%","d":"up"},{"l":"RTO Médio (h)","v":"34h","t":"+13.5%","d":"up"},{"l":"RPO Médio (h)","v":"144h","t":"+4.7%","d":"up"},{"l":"Testes DR (YTD)","v":"7.339","t":"+12.6%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","202h","207h","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","12h","29h","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","39h","55h","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","108h","35h","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","108h","193h","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":520},{"label":"Mar","value":780},{"label":"Abr","value":556},{"label":"Mai","value":847},{"label":"Jun","value":747},{"label":"Jul","value":569},{"label":"Ago","value":806},{"label":"Set","value":842},{"label":"Out","value":626},{"label":"Nov","value":828},{"label":"Dez","value":589}];
const MX = 847;
