...
const PAGE = "Disburse";
const KPIS = [{"l":"BCP Plans Ativos","v":"8.005","t":"-4.1%","d":"down"},{"l":"RTO Médio (h)","v":"30h","t":"+11.3%","d":"up"},{"l":"RPO Médio (h)","v":"68h","t":"+16.4%","d":"up"},{"l":"Testes DR (YTD)","v":"2.969","t":"+8.1%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","18h","197h","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","209h","37h","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","33h","99h","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","19h","185h","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","147h","93h","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":954},{"label":"Fev","value":725},{"label":"Mar","value":934},{"label":"Abr","value":653},{"label":"Mai","value":753},{"label":"Jun","value":755},{"label":"Jul","value":692},{"label":"Ago","value":902},{"label":"Set","value":701},{"label":"Out","value":694},{"label":"Nov","value":752},{"label":"Dez","value":829}];
const MX = 954;
