...
const KPIS = [{"l":"BCP Plans Ativos","v":"8.342","t":"+4.1%","d":"up"},{"l":"RTO Médio (h)","v":"126h","t":"+14.3%","d":"up"},{"l":"RPO Médio (h)","v":"139h","t":"+2.3%","d":"up"},{"l":"Testes DR (YTD)","v":"704","t":"+2.9%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","12h","34h","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","66h","91h","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","80h","210h","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","113h","65h","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","192h","62h","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":383},{"label":"Fev","value":425},{"label":"Mar","value":462},{"label":"Abr","value":698},{"label":"Mai","value":470},{"label":"Jun","value":432},{"label":"Jul","value":344},{"label":"Ago","value":510},{"label":"Set","value":607},{"label":"Out","value":424},{"label":"Nov","value":495},{"label":"Dez","value":328}];
const MX = 698;
