...
/* ═══ Loan Lifecycle (BIAN) — Dashboard ═══ */

const ACCENT = "#155e75";

const KPIS = [
    { label: "Total Registos", value: "9529", trend: "-5%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1310", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€491K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "-12%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1679178129", cells: ["BIA-4129", "Loan Lifecycle (BIAN) Item 1", "14/10/2026", "€28 229"], status: "active" as const },
    { id: "1679181700", cells: ["BIA-7700", "Loan Lifecycle (BIAN) Item 2", "1/5/2026", "€31 800"], status: "pending" as const },
    { id: "1679185271", cells: ["BIA-2271", "Loan Lifecycle (BIAN) Item 3", "16/12/2026", "€35 371"], status: "completed" as const },
    { id: "1679188842", cells: ["BIA-5842", "Loan Lifecycle (BIAN) Item 4", "3/7/2026", "€38 942"], status: "warning" as const },
    { id: "1679192413", cells: ["BIA-9413", "Loan Lifecycle (BIAN) Item 5", "18/2/2026", "€42 513"], status: "active" as const },
];
...
export default function LoanLifecycleBianPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Loan Lifecycle (BIAN)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Loan Lifecycle (BIAN)</p>
                    </div>
                </div>
