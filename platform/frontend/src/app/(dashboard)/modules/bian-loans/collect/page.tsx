...
const PAGE = "Collect";
const KPIS = [{"l":"BCP Plans Ativos","v":"2.604","t":"+1.3%","d":"up"},{"l":"RTO Médio (h)","v":"23h","t":"+11.9%","d":"up"},{"l":"RPO Médio (h)","v":"91h","t":"+7.5%","d":"up"},{"l":"Testes DR (YTD)","v":"3.200","t":"-4.1%","d":"down"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","84h","94h","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","184h","167h","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","145h","147h","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","168h","173h","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","144h","39h","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":724},{"label":"Mar","value":619},{"label":"Abr","value":458},{"label":"Mai","value":584},{"label":"Jun","value":645},{"label":"Jul","value":423},{"label":"Ago","value":723},{"label":"Set","value":739},{"label":"Out","value":797},{"label":"Nov","value":807},{"label":"Dez","value":732}];
const MX = 807;
