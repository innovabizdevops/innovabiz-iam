...
const ACCENT = "#155e75";
const MODULE = "Loan Lifecycle (BIAN)";
const PAGE = "Underwrite";
const KPIS = [{"l":"BCP Plans Ativos","v":"5.681","t":"+1.6%","d":"up"},{"l":"RTO Médio (h)","v":"40h","t":"+11.8%","d":"up"},{"l":"RPO Médio (h)","v":"114h","t":"+6.3%","d":"up"},{"l":"Testes DR (YTD)","v":"4.821","t":"+13.5%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","174h","183h","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","87h","40h","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","55h","40h","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","85h","208h","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","102h","23h","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":486},{"label":"Fev","value":248},{"label":"Mar","value":611},{"label":"Abr","value":250},{"label":"Mai","value":442},{"label":"Jun","value":631},{"label":"Jul","value":462},{"label":"Ago","value":427},{"label":"Set","value":412},{"label":"Out","value":483},{"label":"Nov","value":399},{"label":"Dez","value":241}];
const MX = 631;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#155e75'}}>AI</span></h1>
                </div>
