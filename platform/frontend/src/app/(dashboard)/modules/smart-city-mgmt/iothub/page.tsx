...
const ACCENT = "#6366f1";
const MODULE = "Smart City Management";
const PAGE = "IoT Hub";
const KPIS = [{"l":"Dispositivos Online","v":"3.812","t":"+4.8%","d":"up"},{"l":"Dados/Min (MB)","v":"1.252","t":"+6.8%","d":"up"},{"l":"Alertas Ativos","v":"6.770","t":"+2.6%","d":"up"},{"l":"Uptime (%)","v":"71.7%","t":"+14.7%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.242","1.371","832","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.701","3.256","2.916","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.560","4.932","4.545","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.695","8.521","6.659","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.278","3.994","3.768","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":414},{"label":"Fev","value":474},{"label":"Mar","value":364},{"label":"Abr","value":521},{"label":"Mai","value":630},{"label":"Jun","value":460},{"label":"Jul","value":551},{"label":"Ago","value":426},{"label":"Set","value":501},{"label":"Out","value":564},{"label":"Nov","value":362},{"label":"Dez","value":491}];
const MX = 630;
