...
const PAGE = "Lighting";
const KPIS = [{"l":"Total Smart City Mgmt","v":"8.546","t":"+3.4%","d":"up"},{"l":"Lighting Ativos","v":"2.594","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"70.3%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"61","t":"-3.4%","d":"down"}];
const COLS = ["ID","Lighting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Smart City Mgmt #001","Smart City Mgmt #002","4.577","3.156","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Smart City Mgmt #002","Smart City Mgmt #003","5.733","163","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart City Mgmt #003","Smart City Mgmt #004","5.703","354","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Smart City Mgmt #004","Smart City Mgmt #005","6.351","8.751","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Smart City Mgmt #005","Smart City Mgmt #001","4.283","1.267","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":596},{"label":"Mar","value":491},{"label":"Abr","value":824},{"label":"Mai","value":589},{"label":"Jun","value":737},{"label":"Jul","value":537},{"label":"Ago","value":654},{"label":"Set","value":626},{"label":"Out","value":612},{"label":"Nov","value":630},{"label":"Dez","value":620}];
const MX = 824;
