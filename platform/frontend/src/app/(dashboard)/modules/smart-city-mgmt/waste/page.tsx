...
const PAGE = "Waste";
const KPIS = [{"l":"Total Smart City Mgmt","v":"4.000","t":"+12.5%","d":"up"},{"l":"Waste Ativos","v":"5.547","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"93.6%","t":"+5.5%","d":"up"},{"l":"Score Performance","v":"59","t":"+12.8%","d":"up"}];
const COLS = ["ID","Waste","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Smart City Mgmt #001","Smart City Mgmt #002","1.799","2.951","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Smart City Mgmt #002","Smart City Mgmt #003","3.690","1.726","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart City Mgmt #003","Smart City Mgmt #004","3.879","835","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Smart City Mgmt #004","Smart City Mgmt #005","2.023","4.086","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Smart City Mgmt #005","Smart City Mgmt #001","5.830","7.385","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":486},{"label":"Fev","value":717},{"label":"Mar","value":520},{"label":"Abr","value":799},{"label":"Mai","value":599},{"label":"Jun","value":722},{"label":"Jul","value":489},{"label":"Ago","value":512},{"label":"Set","value":779},{"label":"Out","value":792},{"label":"Nov","value":574},{"label":"Dez","value":521}];
const MX = 799;
