...
const PAGE = "Traffic";
const KPIS = [{"l":"Total Smart City Mgmt","v":"7.008","t":"-3.9%","d":"down"},{"l":"Traffic Ativos","v":"5.086","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"72.4%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"64","t":"+5.9%","d":"up"}];
const COLS = ["ID","Traffic","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Smart City Mgmt #001","Smart City Mgmt #002","1.357","2.577","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Smart City Mgmt #002","Smart City Mgmt #003","8.866","8.428","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart City Mgmt #003","Smart City Mgmt #004","322","7.114","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Smart City Mgmt #004","Smart City Mgmt #005","6.181","2.853","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Smart City Mgmt #005","Smart City Mgmt #001","5.426","3.152","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":597},{"label":"Mar","value":617},{"label":"Abr","value":291},{"label":"Mai","value":318},{"label":"Jun","value":531},{"label":"Jul","value":678},{"label":"Ago","value":318},{"label":"Set","value":498},{"label":"Out","value":508},{"label":"Nov","value":496},{"label":"Dez","value":588}];
const MX = 678;
