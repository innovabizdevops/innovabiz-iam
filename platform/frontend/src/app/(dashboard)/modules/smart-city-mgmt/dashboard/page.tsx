...
const KPIS = [{"l":"Teams Ativos","v":"5.502","t":"+14.7%","d":"up"},{"l":"Reuniões/Semana","v":"3733","t":"-1.4%","d":"down"},{"l":"Mensagens/Dia","v":"3346","t":"+10.9%","d":"up"},{"l":"Ficheiros Partilhados","v":"7.013","t":"+15.9%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","1.518","4093","4.763","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","8.787","236","7.808","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","2.712","2469","5.464","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","9.089","3854","4.333","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.033","2519","2.886","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":777},{"label":"Mar","value":834},{"label":"Abr","value":1011},{"label":"Mai","value":753},{"label":"Jun","value":760},{"label":"Jul","value":910},{"label":"Ago","value":1002},{"label":"Set","value":948},{"label":"Out","value":700},{"label":"Nov","value":1014},{"label":"Dez","value":1025}];
const MX = 1025;
