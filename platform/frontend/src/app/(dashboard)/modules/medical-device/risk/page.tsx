...
const ACCENT = "#4f46e5";
const MODULE = "Medical Device Mgmt";
const PAGE = "Risk File";
const KPIS = [{"l":"Riscos Identificados","v":"4.821","t":"+8.8%","d":"up"},{"l":"Mitigações Ativas","v":"1.448","t":"+2.3%","d":"up"},{"l":"Score Risco Geral","v":"55","t":"+1.0%","d":"up"},{"l":"Incidentes YTD","v":"6.223","t":"+13.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.452","4.010","8.458","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.062","560","8.126","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.455","9.003","2.323","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.016","5.453","3.780","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.652","3.003","5.394","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":677},{"label":"Mar","value":675},{"label":"Abr","value":330},{"label":"Mai","value":559},{"label":"Jun","value":315},{"label":"Jul","value":590},{"label":"Ago","value":303},{"label":"Set","value":563},{"label":"Out","value":546},{"label":"Nov","value":608},{"label":"Dez","value":604}];
const MX = 677;
