...
const PAGE = "510k/PMA";
const KPIS = [{"l":"Dispositivos Online","v":"4.655","t":"+16.5%","d":"up"},{"l":"Dados/Min (MB)","v":"5.326","t":"+14.5%","d":"up"},{"l":"Alertas Ativos","v":"8.829","t":"+9.4%","d":"up"},{"l":"Uptime (%)","v":"69.8%","t":"-5.0%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.537","7.382","2.348","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.319","8.667","7.728","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.024","7.488","3.923","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.193","5.375","2.611","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.399","8.505","7.823","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":861},{"label":"Fev","value":804},{"label":"Mar","value":670},{"label":"Abr","value":940},{"label":"Mai","value":1008},{"label":"Jun","value":1010},{"label":"Jul","value":862},{"label":"Ago","value":964},{"label":"Set","value":708},{"label":"Out","value":741},{"label":"Nov","value":902},{"label":"Dez","value":661}];
const MX = 1010;
