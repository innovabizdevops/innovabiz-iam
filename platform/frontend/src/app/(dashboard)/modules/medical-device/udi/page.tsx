...
const PAGE = "UDI Registry";
const KPIS = [{"l":"Dispositivos Online","v":"5.636","t":"+4.5%","d":"up"},{"l":"Dados/Min (MB)","v":"3.215","t":"-0.1%","d":"down"},{"l":"Alertas Ativos","v":"8.305","t":"-3.6%","d":"down"},{"l":"Uptime (%)","v":"66.9%","t":"+6.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.791","8.705","7.847","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.526","8.722","4.825","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","418","8.508","613","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","4.373","4.505","309","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","1.162","5.383","7.521","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":373},{"label":"Fev","value":431},{"label":"Mar","value":404},{"label":"Abr","value":620},{"label":"Mai","value":518},{"label":"Jun","value":584},{"label":"Jul","value":375},{"label":"Ago","value":550},{"label":"Set","value":699},{"label":"Out","value":442},{"label":"Nov","value":397},{"label":"Dez","value":459}];
const MX = 699;
