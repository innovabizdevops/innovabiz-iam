...
const PAGE = "Design Control";
const KPIS = [{"l":"Dispositivos Online","v":"2.122","t":"-5.0%","d":"down"},{"l":"Dados/Min (MB)","v":"6.278","t":"+12.8%","d":"up"},{"l":"Alertas Ativos","v":"2.969","t":"+7.1%","d":"up"},{"l":"Uptime (%)","v":"93.0%","t":"-3.0%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.335","1.616","5.617","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.677","5.800","8.501","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.624","6.994","7.238","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","8.519","3.611","1.872","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.642","7.925","1.268","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":704},{"label":"Mar","value":896},{"label":"Abr","value":694},{"label":"Mai","value":968},{"label":"Jun","value":931},{"label":"Jul","value":956},{"label":"Ago","value":938},{"label":"Set","value":730},{"label":"Out","value":773},{"label":"Nov","value":981},{"label":"Dez","value":625}];
const MX = 981;
