...
const PAGE = "DHF/DMR/DHR";
const KPIS = [{"l":"Dispositivos Online","v":"1.360","t":"-4.1%","d":"down"},{"l":"Dados/Min (MB)","v":"4.548","t":"-2.3%","d":"down"},{"l":"Alertas Ativos","v":"6.997","t":"+9.1%","d":"up"},{"l":"Uptime (%)","v":"78.3%","t":"+4.8%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","910","3.888","5.270","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.375","8.070","8.468","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.563","8.373","8.791","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.158","8.347","1.162","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.460","2.538","3.338","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":604},{"label":"Mar","value":574},{"label":"Abr","value":366},{"label":"Mai","value":498},{"label":"Jun","value":547},{"label":"Jul","value":264},{"label":"Ago","value":426},{"label":"Set","value":425},{"label":"Out","value":324},{"label":"Nov","value":354},{"label":"Dez","value":408}];
const MX = 604;
