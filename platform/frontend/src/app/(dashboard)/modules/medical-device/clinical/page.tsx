...
const PAGE = "Clinical Eval";
const KPIS = [{"l":"Dispositivos Online","v":"7.834","t":"+16.8%","d":"up"},{"l":"Dados/Min (MB)","v":"5.487","t":"-1.5%","d":"down"},{"l":"Alertas Ativos","v":"7.835","t":"+1.2%","d":"up"},{"l":"Uptime (%)","v":"85.3%","t":"-5.5%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.621","437","938","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","915","7.004","1.473","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","3.990","6.973","4.697","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","402","2.436","6.592","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.599","4.701","489","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":869},{"label":"Mar","value":679},{"label":"Abr","value":906},{"label":"Mai","value":713},{"label":"Jun","value":668},{"label":"Jul","value":596},{"label":"Ago","value":885},{"label":"Set","value":937},{"label":"Out","value":621},{"label":"Nov","value":555},{"label":"Dez","value":758}];
const MX = 937;
