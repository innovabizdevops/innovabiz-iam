...
const PAGE = "SOW";
const KPIS = [{"l":"Contratos Ativos","v":"4.486","t":"-1.1%","d":"down"},{"l":"Valor Total (€M)","v":"€25.4M","t":"+15.6%","d":"up"},{"l":"Renovações Próx. 30d","v":"8.720","t":"+14.2%","d":"up"},{"l":"Obrigações Pendentes","v":"838","t":"-5.5%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 23170.69","2026-02-05","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 19974.57","2026-02-04","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 28818.24","2026-01-08","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 13852.79","2026-02-20","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 21809.64","2026-02-05","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":756},{"label":"Mar","value":797},{"label":"Abr","value":744},{"label":"Mai","value":1002},{"label":"Jun","value":1037},{"label":"Jul","value":1017},{"label":"Ago","value":894},{"label":"Set","value":842},{"label":"Out","value":930},{"label":"Nov","value":793},{"label":"Dez","value":877}];
const MX = 1037;
