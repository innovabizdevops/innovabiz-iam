...
const PAGE = "Invoice";
const KPIS = [{"l":"Contratos Ativos","v":"3.098","t":"+15.9%","d":"up"},{"l":"Valor Total (€M)","v":"€39.7M","t":"-2.7%","d":"down"},{"l":"Renovações Próx. 30d","v":"414","t":"+11.5%","d":"up"},{"l":"Obrigações Pendentes","v":"657","t":"+7.2%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 17934.12","2026-01-20","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 42156.07","2026-02-26","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 1667.26","2026-01-04","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 38001.43","2026-03-01","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 5277.76","2026-02-24","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":597},{"label":"Fev","value":676},{"label":"Mar","value":597},{"label":"Abr","value":671},{"label":"Mai","value":658},{"label":"Jun","value":926},{"label":"Jul","value":662},{"label":"Ago","value":660},{"label":"Set","value":747},{"label":"Out","value":635},{"label":"Nov","value":597},{"label":"Dez","value":880}];
const MX = 926;
