...
const KPIS = [{"l":"Auditorias Realizadas","v":"2.389","t":"+3.7%","d":"up"},{"l":"NC Abertas","v":"8.335","t":"-0.8%","d":"down"},{"l":"Conformidade (%)","v":"94.5%","t":"+3.5%","d":"up"},{"l":"CAPAs Pendentes","v":"9.089","t":"+4.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.717","75.1%","4.785","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.852","98.1%","1.867","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","629","80.2%","1.711","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.279","100.0%","8.672","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.618","99.3%","2.268","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1070},{"label":"Fev","value":1001},{"label":"Mar","value":985},{"label":"Abr","value":1078},{"label":"Mai","value":998},{"label":"Jun","value":1002},{"label":"Jul","value":965},{"label":"Ago","value":737},{"label":"Set","value":716},{"label":"Out","value":842},{"label":"Nov","value":949},{"label":"Dez","value":1048}];
const MX = 1078;
