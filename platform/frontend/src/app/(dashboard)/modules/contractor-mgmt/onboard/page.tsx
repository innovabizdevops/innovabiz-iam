...
const PAGE = "Onboard";
const KPIS = [{"l":"eNPS","v":"77","t":"+16.0%","d":"up"},{"l":"Engagement (%)","v":"82.2%","t":"+5.8%","d":"up"},{"l":"Turnover (%)","v":"94.1%","t":"+12.4%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.457","t":"+6.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.067","2026-01-12","85","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.272","2026-03-05","65","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","503","2026-01-12","61","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.091","2026-01-10","91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","410","2026-01-21","56","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":432},{"label":"Fev","value":435},{"label":"Mar","value":478},{"label":"Abr","value":686},{"label":"Mai","value":674},{"label":"Jun","value":339},{"label":"Jul","value":616},{"label":"Ago","value":574},{"label":"Set","value":416},{"label":"Out","value":372},{"label":"Nov","value":429},{"label":"Dez","value":331}];
const MX = 686;
