...
const ACCENT = "#6366f1";
const MODULE = "Contractor Mgmt";
const PAGE = "Timesheet";
const KPIS = [{"l":"Contratos Ativos","v":"2.608","t":"+11.3%","d":"up"},{"l":"Valor Total (€M)","v":"€20.7M","t":"+0.9%","d":"up"},{"l":"Renovações Próx. 30d","v":"615","t":"-2.7%","d":"down"},{"l":"Obrigações Pendentes","v":"828","t":"+13.8%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 46779.57","2026-02-23","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 38215.46","2026-02-15","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 10856.85","2026-03-26","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 6829.42","2026-01-10","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 35979.60","2026-01-11","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":308},{"label":"Mar","value":437},{"label":"Abr","value":299},{"label":"Mai","value":337},{"label":"Jun","value":589},{"label":"Jul","value":436},{"label":"Ago","value":308},{"label":"Set","value":585},{"label":"Out","value":420},{"label":"Nov","value":261},{"label":"Dez","value":476}];
const MX = 589;
