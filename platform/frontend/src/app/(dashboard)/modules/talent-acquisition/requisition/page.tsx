...
const PAGE = "Job Requisition Form";
const KPIS = [{"l":"Formulários Ativos","v":"6.711","t":"+15.1%","d":"up"},{"l":"Submissões/Dia","v":"3437","t":"+2.5%","d":"up"},{"l":"Documentos Gerados","v":"8.027","t":"+3.1%","d":"up"},{"l":"Templates","v":"1.247","t":"+4.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.411","2026-03-18","3.222","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.383","2026-02-12","2.458","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.371","2026-03-11","5.778","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.416","2026-02-03","1.096","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.772","2026-02-19","179","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":573},{"label":"Mar","value":572},{"label":"Abr","value":677},{"label":"Mai","value":750},{"label":"Jun","value":872},{"label":"Jul","value":619},{"label":"Ago","value":525},{"label":"Set","value":660},{"label":"Out","value":863},{"label":"Nov","value":488},{"label":"Dez","value":778}];
const MX = 872;
