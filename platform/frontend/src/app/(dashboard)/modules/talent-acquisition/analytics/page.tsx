...
const PAGE = "Workforce Analytics AI";
const KPIS = [{"l":"eNPS","v":"68","t":"-0.3%","d":"down"},{"l":"Engagement (%)","v":"93.4%","t":"+12.8%","d":"up"},{"l":"Turnover (%)","v":"92.7%","t":"+10.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.992","t":"+16.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.579","2026-03-16","88","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.259","2026-03-08","84","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.712","2026-02-16","86","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.683","2026-03-24","85","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.527","2026-03-15","64","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":847},{"label":"Fev","value":768},{"label":"Mar","value":987},{"label":"Abr","value":747},{"label":"Mai","value":984},{"label":"Jun","value":722},{"label":"Jul","value":891},{"label":"Ago","value":775},{"label":"Set","value":745},{"label":"Out","value":977},{"label":"Nov","value":677},{"label":"Dez","value":937}];
const MX = 987;
