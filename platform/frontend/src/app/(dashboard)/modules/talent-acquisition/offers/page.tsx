...
const KPIS = [{"l":"Projetos Melhoria","v":"2.503","t":"+7.4%","d":"up"},{"l":"Savings (€)","v":"€75680","t":"+12.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"75.7%","t":"+1.8%","d":"up"},{"l":"Ciclos PDCA","v":"9.090","t":"-4.3%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.341","€ 32777.97","8.523","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.936","€ 14519.91","7.751","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","852","€ 29152.05","2.624","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.043","€ 46090.17","6.716","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.324","€ 9482.61","2.832","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":817},{"label":"Mar","value":756},{"label":"Abr","value":703},{"label":"Mai","value":880},{"label":"Jun","value":948},{"label":"Jul","value":869},{"label":"Ago","value":652},{"label":"Set","value":900},{"label":"Out","value":847},{"label":"Nov","value":554},{"label":"Dez","value":857}];
const MX = 948;
