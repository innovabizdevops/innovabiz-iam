...
const PAGE = "Onboarding Flow";
const KPIS = [{"l":"eNPS","v":"86","t":"-4.6%","d":"down"},{"l":"Engagement (%)","v":"78.5%","t":"-5.8%","d":"down"},{"l":"Turnover (%)","v":"71.4%","t":"+7.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.864","t":"+15.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.502","2026-01-15","61","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.566","2026-03-25","65","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.288","2026-01-26","73","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.251","2026-03-06","59","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.847","2026-03-26","90","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":783},{"label":"Mar","value":890},{"label":"Abr","value":619},{"label":"Mai","value":599},{"label":"Jun","value":744},{"label":"Jul","value":598},{"label":"Ago","value":922},{"label":"Set","value":759},{"label":"Out","value":730},{"label":"Nov","value":906},{"label":"Dez","value":800}];
const MX = 922;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ea580c'}}>Flow</span></h1>
                </div>
