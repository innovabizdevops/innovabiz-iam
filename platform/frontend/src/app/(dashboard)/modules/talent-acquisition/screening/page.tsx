...
const PAGE = "AI Resume Screening";
const KPIS = [{"l":"Total Talent Acquisition","v":"1.953","t":"-5.4%","d":"down"},{"l":"AI Resume Screening Ativos","v":"7.703","t":"-5.7%","d":"down"},{"l":"Eficiência (%)","v":"88.6%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"56","t":"-5.4%","d":"down"}];
const COLS = ["ID","AI Resume Screening","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Talent Acquisition #001","Talent Acquisition #002","7.180","4.319","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Talent Acquisition #002","Talent Acquisition #003","4.729","2.518","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Talent Acquisition #003","Talent Acquisition #004","4.110","2.438","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Talent Acquisition #004","Talent Acquisition #005","3.690","7.086","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Talent Acquisition #005","Talent Acquisition #001","1.692","5.454","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":714},{"label":"Mar","value":855},{"label":"Abr","value":843},{"label":"Mai","value":820},{"label":"Jun","value":929},{"label":"Jul","value":705},{"label":"Ago","value":949},{"label":"Set","value":711},{"label":"Out","value":722},{"label":"Nov","value":815},{"label":"Dez","value":896}];
const MX = 949;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ea580c'}}>AI</span></h1>
                </div>
