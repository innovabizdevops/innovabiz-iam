...
const ACCENT = "#ea580c";
const MODULE = "Talent Acquisition";
const PAGE = "Diversity Hiring";
const KPIS = [{"l":"Total Talent Acquisition","v":"8.985","t":"+6.7%","d":"up"},{"l":"Diversity Hiring Ativos","v":"1.796","t":"+-0.0%","d":"up"},{"l":"Eficiência (%)","v":"73.6%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"86","t":"-1.7%","d":"down"}];
const COLS = ["ID","Diversity Hiring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Talent Acquisition #001","Talent Acquisition #002","8.635","1.422","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Talent Acquisition #002","Talent Acquisition #003","1.527","1.013","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Talent Acquisition #003","Talent Acquisition #004","5.351","5.942","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Talent Acquisition #004","Talent Acquisition #005","8.345","5.954","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Talent Acquisition #005","Talent Acquisition #001","1.363","5.431","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":961},{"label":"Mar","value":880},{"label":"Abr","value":605},{"label":"Mai","value":883},{"label":"Jun","value":814},{"label":"Jul","value":973},{"label":"Ago","value":601},{"label":"Set","value":782},{"label":"Out","value":730},{"label":"Nov","value":894},{"label":"Dez","value":951}];
const MX = 973;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ea580c'}}>DEI</span></h1>
                </div>
