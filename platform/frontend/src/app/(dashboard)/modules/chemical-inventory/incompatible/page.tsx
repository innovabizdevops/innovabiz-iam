...
const PAGE = "Incompatible";
const KPIS = [{"l":"Total Chemical Inventory","v":"5.813","t":"-2.5%","d":"down"},{"l":"Incompatible Ativos","v":"9.076","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"70.6%","t":"-1.8%","d":"down"},{"l":"Score Performance","v":"68","t":"+0.8%","d":"up"}];
const COLS = ["ID","Incompatible","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemical Inventory #001","Chemical Inventory #002","6.348","2.273","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Chemical Inventory #002","Chemical Inventory #003","294","1.498","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemical Inventory #003","Chemical Inventory #004","5.227","4.196","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Chemical Inventory #004","Chemical Inventory #005","9.073","8.879","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemical Inventory #005","Chemical Inventory #001","6.815","1.058","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":502},{"label":"Mar","value":745},{"label":"Abr","value":475},{"label":"Mai","value":584},{"label":"Jun","value":543},{"label":"Jul","value":677},{"label":"Ago","value":721},{"label":"Set","value":818},{"label":"Out","value":686},{"label":"Nov","value":856},{"label":"Dez","value":617}];
const MX = 864;
