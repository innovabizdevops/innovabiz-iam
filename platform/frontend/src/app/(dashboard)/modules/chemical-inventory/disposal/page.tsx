...
const ACCENT = "#b45309";
const MODULE = "Chemical Inventory";
const PAGE = "Disposal";
const KPIS = [{"l":"Pedidos/Dia","v":"3554","t":"-3.9%","d":"down"},{"l":"GMV (€)","v":"€83610","t":"-2.7%","d":"down"},{"l":"Conversão (%)","v":"81.7%","t":"+3.1%","d":"up"},{"l":"AOV (€)","v":"€57508","t":"+3.4%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 43874.03","474","675","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 6966.12","1.528","3.541","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 44381.02","4.857","8.181","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 21626.63","2.552","6.516","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 4011.84","7.658","4.709","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":477},{"label":"Mar","value":266},{"label":"Abr","value":363},{"label":"Mai","value":574},{"label":"Jun","value":223},{"label":"Jul","value":363},{"label":"Ago","value":462},{"label":"Set","value":293},{"label":"Out","value":282},{"label":"Nov","value":516},{"label":"Dez","value":422}];
const MX = 574;
