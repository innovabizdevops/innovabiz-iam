...
const PAGE = "Storage Map";
const KPIS = [{"l":"Total Chemical Inventory","v":"3.998","t":"+8.2%","d":"up"},{"l":"Storage Map Ativos","v":"586","t":"+2.9%","d":"up"},{"l":"Eficiência (%)","v":"77.2%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"63","t":"+5.2%","d":"up"}];
const COLS = ["ID","Storage Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemical Inventory #001","Chemical Inventory #002","4.761","732","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Chemical Inventory #002","Chemical Inventory #003","3.286","1.780","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemical Inventory #003","Chemical Inventory #004","6.262","6.826","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Chemical Inventory #004","Chemical Inventory #005","189","4.828","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemical Inventory #005","Chemical Inventory #001","8.907","6.293","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":554},{"label":"Mar","value":368},{"label":"Abr","value":597},{"label":"Mai","value":298},{"label":"Jun","value":621},{"label":"Jul","value":603},{"label":"Ago","value":268},{"label":"Set","value":406},{"label":"Out","value":291},{"label":"Nov","value":325},{"label":"Dez","value":618}];
const MX = 621;
