...
const PAGE = "Expiry Track";
const KPIS = [{"l":"Total Chemical Inventory","v":"3.039","t":"-5.1%","d":"down"},{"l":"Expiry Track Ativos","v":"5.707","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"66.5%","t":"+17.1%","d":"up"},{"l":"Score Performance","v":"94","t":"+15.8%","d":"up"}];
const COLS = ["ID","Expiry Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemical Inventory #001","Chemical Inventory #002","4.632","184","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Chemical Inventory #002","Chemical Inventory #003","1.531","3.080","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemical Inventory #003","Chemical Inventory #004","4.806","6.213","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Chemical Inventory #004","Chemical Inventory #005","6.257","7.632","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemical Inventory #005","Chemical Inventory #001","1.510","5.784","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":532},{"label":"Mar","value":420},{"label":"Abr","value":297},{"label":"Mai","value":499},{"label":"Jun","value":231},{"label":"Jul","value":205},{"label":"Ago","value":427},{"label":"Set","value":221},{"label":"Out","value":525},{"label":"Nov","value":602},{"label":"Dez","value":312}];
const MX = 602;
