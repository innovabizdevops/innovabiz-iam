...
const PAGE = "Result";
const KPIS = [{"l":"Total Cosmetic Dental","v":"3.288","t":"+3.8%","d":"up"},{"l":"Result Ativos","v":"6.374","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"73.7%","t":"+17.2%","d":"up"},{"l":"Score Performance","v":"94","t":"+17.8%","d":"up"}];
const COLS = ["ID","Result","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmetic Dental #001","Cosmetic Dental #002","2.029","7.123","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmetic Dental #002","Cosmetic Dental #003","3.456","8.299","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmetic Dental #003","Cosmetic Dental #004","3.100","6.750","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmetic Dental #004","Cosmetic Dental #005","2.227","5.959","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmetic Dental #005","Cosmetic Dental #001","7.878","6.349","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":593},{"label":"Mar","value":689},{"label":"Abr","value":592},{"label":"Mai","value":639},{"label":"Jun","value":619},{"label":"Jul","value":573},{"label":"Ago","value":455},{"label":"Set","value":751},{"label":"Out","value":676},{"label":"Nov","value":806},{"label":"Dez","value":532}];
const MX = 806;
