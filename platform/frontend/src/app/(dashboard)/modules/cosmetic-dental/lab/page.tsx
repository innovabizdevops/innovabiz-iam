...
const PAGE = "Lab";
const KPIS = [{"l":"Total Cosmetic Dental","v":"3.443","t":"+4.0%","d":"up"},{"l":"Lab Ativos","v":"6.395","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"70.5%","t":"-0.2%","d":"down"},{"l":"Score Performance","v":"85","t":"-1.0%","d":"down"}];
const COLS = ["ID","Lab","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmetic Dental #001","Cosmetic Dental #002","2.180","1.601","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmetic Dental #002","Cosmetic Dental #003","5.500","616","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmetic Dental #003","Cosmetic Dental #004","7.186","2.858","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmetic Dental #004","Cosmetic Dental #005","6.542","3.264","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmetic Dental #005","Cosmetic Dental #001","5.894","2.937","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":395},{"label":"Mar","value":669},{"label":"Abr","value":582},{"label":"Mai","value":639},{"label":"Jun","value":348},{"label":"Jul","value":369},{"label":"Ago","value":551},{"label":"Set","value":556},{"label":"Out","value":485},{"label":"Nov","value":350},{"label":"Dez","value":415}];
const MX = 669;
