...
const ACCENT = "#831843";
const MODULE = "Cosmetic Dentistry";
const PAGE = "Consult";
const KPIS = [{"l":"Total Cosmetic Dental","v":"5.363","t":"+12.0%","d":"up"},{"l":"Consult Ativos","v":"5.535","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"93.1%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"78","t":"+8.3%","d":"up"}];
const COLS = ["ID","Consult","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmetic Dental #001","Cosmetic Dental #002","6.527","483","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmetic Dental #002","Cosmetic Dental #003","4.112","5.382","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmetic Dental #003","Cosmetic Dental #004","6.252","5.449","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmetic Dental #004","Cosmetic Dental #005","1.467","1.921","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmetic Dental #005","Cosmetic Dental #001","7.823","6.498","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":245},{"label":"Fev","value":587},{"label":"Mar","value":253},{"label":"Abr","value":508},{"label":"Mai","value":313},{"label":"Jun","value":350},{"label":"Jul","value":613},{"label":"Ago","value":390},{"label":"Set","value":521},{"label":"Out","value":581},{"label":"Nov","value":336},{"label":"Dez","value":270}];
const MX = 613;
