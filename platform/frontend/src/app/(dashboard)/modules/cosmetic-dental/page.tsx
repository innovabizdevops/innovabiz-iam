...
/* ═══ Cosmetic Dentistry — Dashboard ═══ */

const ACCENT = "#831843";

const KPIS = [
    { label: "Total Registos", value: "2543", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4682", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€74K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "257016343", cells: ["COS-4343", "Cosmetic Dentistry Item 1", "4/8/2026", "€16 443"], status: "active" as const },
    { id: "257019914", cells: ["COS-7914", "Cosmetic Dentistry Item 2", "19/3/2026", "€20 014"], status: "pending" as const },
    { id: "257023485", cells: ["COS-2485", "Cosmetic Dentistry Item 3", "6/10/2026", "€23 585"], status: "completed" as const },
    { id: "257027056", cells: ["COS-6056", "Cosmetic Dentistry Item 4", "21/5/2026", "€27 156"], status: "warning" as const },
    { id: "257030627", cells: ["COS-9627", "Cosmetic Dentistry Item 5", "8/12/2026", "€30 727"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cosmetic Dentistry</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cosmetic Dentistry</p>
                    </div>
                </div>
