...
export default function CabinInteriorPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Cabin Interior</h1><p className="text-sm text-muted-foreground">Cabin Interior • iBOS Enterprise</p></div>
