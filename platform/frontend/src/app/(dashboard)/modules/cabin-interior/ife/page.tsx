...
const ACCENT = "#6366f1";
const MODULE = "Cabin & Interior";
const PAGE = "IFE";
const KPIS = [{"l":"Total Cabin Interior","v":"3.370","t":"+1.6%","d":"up"},{"l":"IFE Ativos","v":"3.141","t":"+0.6%","d":"up"},{"l":"Eficiência (%)","v":"93.0%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"89","t":"+12.3%","d":"up"}];
const COLS = ["ID","IFE","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cabin Interior #001","Cabin Interior #002","7.792","709","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Cabin Interior #002","Cabin Interior #003","8.783","4.368","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Cabin Interior #003","Cabin Interior #004","5.674","1.090","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Cabin Interior #004","Cabin Interior #005","1.224","412","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cabin Interior #005","Cabin Interior #001","8.646","237","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":386},{"label":"Mar","value":452},{"label":"Abr","value":576},{"label":"Mai","value":243},{"label":"Jun","value":546},{"label":"Jul","value":500},{"label":"Ago","value":474},{"label":"Set","value":399},{"label":"Out","value":397},{"label":"Nov","value":348},{"label":"Dez","value":348}];
const MX = 576;
...
export default function IfePage() {
    return (
