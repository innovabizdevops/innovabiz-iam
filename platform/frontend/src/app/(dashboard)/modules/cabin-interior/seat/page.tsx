...
const PAGE = "Seat";
const KPIS = [{"l":"Total Cabin Interior","v":"8.257","t":"-3.4%","d":"down"},{"l":"Seat Ativos","v":"3.492","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"74.6%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"61","t":"+13.9%","d":"up"}];
const COLS = ["ID","Seat","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cabin Interior #001","Cabin Interior #002","5.751","4.920","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Cabin Interior #002","Cabin Interior #003","5.621","3.327","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Cabin Interior #003","Cabin Interior #004","105","2.001","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Cabin Interior #004","Cabin Interior #005","2.889","2.946","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cabin Interior #005","Cabin Interior #001","6.312","5.944","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":825},{"label":"Mar","value":684},{"label":"Abr","value":945},{"label":"Mai","value":910},{"label":"Jun","value":940},{"label":"Jul","value":689},{"label":"Ago","value":838},{"label":"Set","value":674},{"label":"Out","value":818},{"label":"Nov","value":814},{"label":"Dez","value":566}];
const MX = 945;
