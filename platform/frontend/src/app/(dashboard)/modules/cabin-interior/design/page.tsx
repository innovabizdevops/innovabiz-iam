...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"2.825","t":"-5.5%","d":"down"},{"l":"Submissões/Dia","v":"818","t":"+16.2%","d":"up"},{"l":"Documentos Gerados","v":"3.479","t":"-2.2%","d":"down"},{"l":"Templates","v":"1.091","t":"+17.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.432","2026-01-25","7.336","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.259","2026-02-18","6.026","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","861","2026-01-25","4.968","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.844","2026-01-13","4.213","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.584","2026-02-19","7.422","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":652},{"label":"Mar","value":706},{"label":"Abr","value":916},{"label":"Mai","value":610},{"label":"Jun","value":904},{"label":"Jul","value":627},{"label":"Ago","value":829},{"label":"Set","value":832},{"label":"Out","value":605},{"label":"Nov","value":833},{"label":"Dez","value":813}];
const MX = 916;
