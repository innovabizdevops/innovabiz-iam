...
const PAGE = "Patient Journey";
const KPIS = [{"l":"Perfis Unificados","v":"6.635","t":"-2.2%","d":"down"},{"l":"Segmentos Ativos","v":"740","t":"+9.9%","d":"up"},{"l":"NPS Score","v":"63","t":"-5.4%","d":"down"},{"l":"Churn Previsto (%)","v":"67.1%","t":"+3.9%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","4.851","€ 33856.81","72.4%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","7.804","€ 48354.18","79.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","6.081","€ 17730.89","75.2%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","6.780","€ 9283.19","90.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","2.968","€ 7479.55","90.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":298},{"label":"Fev","value":390},{"label":"Mar","value":297},{"label":"Abr","value":290},{"label":"Mai","value":506},{"label":"Jun","value":617},{"label":"Jul","value":580},{"label":"Ago","value":504},{"label":"Set","value":364},{"label":"Out","value":383},{"label":"Nov","value":284},{"label":"Dez","value":555}];
const MX = 617;
