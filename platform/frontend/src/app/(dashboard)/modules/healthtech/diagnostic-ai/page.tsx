...
const PAGE = "Diagnostic AI";
const KPIS = [{"l":"Total Healthtech","v":"250","t":"-2.4%","d":"down"},{"l":"Diagnostic AI Ativos","v":"8.202","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"70.4%","t":"+11.8%","d":"up"},{"l":"Score Performance","v":"70","t":"-0.6%","d":"down"}];
const COLS = ["ID","Diagnostic AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Healthtech #001","Healthtech #002","7.805","8.099","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Healthtech #002","Healthtech #003","2.201","7.560","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Healthtech #003","Healthtech #004","7.670","4.988","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Healthtech #004","Healthtech #005","7.719","4.557","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Healthtech #005","Healthtech #001","3.520","3.230","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":312},{"label":"Fev","value":459},{"label":"Mar","value":653},{"label":"Abr","value":603},{"label":"Mai","value":499},{"label":"Jun","value":592},{"label":"Jul","value":519},{"label":"Ago","value":566},{"label":"Set","value":393},{"label":"Out","value":411},{"label":"Nov","value":476},{"label":"Dez","value":584}];
const MX = 653;
