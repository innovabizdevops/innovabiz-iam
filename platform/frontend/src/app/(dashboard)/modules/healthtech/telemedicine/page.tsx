...
const KPIS = [{"l":"Integrações Ativas","v":"793","t":"+13.0%","d":"up"},{"l":"Chamadas/Hora","v":"1128","t":"+17.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.3%","t":"+4.9%","d":"up"},{"l":"Latência Média (ms)","v":"42ms","t":"+10.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.786","5.348","76.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.287","2.081","88.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.881","2.219","73.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","9.010","6.673","97.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.964","1.833","71.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":575},{"label":"Mar","value":483},{"label":"Abr","value":511},{"label":"Mai","value":513},{"label":"Jun","value":561},{"label":"Jul","value":528},{"label":"Ago","value":777},{"label":"Set","value":755},{"label":"Out","value":530},{"label":"Nov","value":560},{"label":"Dez","value":729}];
const MX = 777;
