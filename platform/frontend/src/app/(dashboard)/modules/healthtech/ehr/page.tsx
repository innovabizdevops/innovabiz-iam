...
const KPIS = [{"l":"Integrações Ativas","v":"2.109","t":"+13.0%","d":"up"},{"l":"Chamadas/Hora","v":"4603","t":"+0.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"85.1%","t":"+0.7%","d":"up"},{"l":"Latência Média (ms)","v":"176ms","t":"+8.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.995","8.097","92.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.021","4.087","92.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.711","623","77.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.667","592","78.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.152","8.749","87.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":868},{"label":"Fev","value":573},{"label":"Mar","value":516},{"label":"Abr","value":809},{"label":"Mai","value":560},{"label":"Jun","value":819},{"label":"Jul","value":807},{"label":"Ago","value":688},{"label":"Set","value":665},{"label":"Out","value":562},{"label":"Nov","value":639},{"label":"Dez","value":597}];
const MX = 868;
