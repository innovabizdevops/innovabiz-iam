...
const PAGE = "Wearable Integration";
const KPIS = [{"l":"Integrações Ativas","v":"6.061","t":"+16.4%","d":"up"},{"l":"Chamadas/Hora","v":"1620","t":"+16.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"87.6%","t":"+13.3%","d":"up"},{"l":"Latência Média (ms)","v":"119ms","t":"-1.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.136","8.150","70.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.001","6.724","98.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","733","806","80.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.780","7.084","97.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.886","7.488","99.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":814},{"label":"Fev","value":626},{"label":"Mar","value":681},{"label":"Abr","value":743},{"label":"Mai","value":672},{"label":"Jun","value":730},{"label":"Jul","value":755},{"label":"Ago","value":528},{"label":"Set","value":615},{"label":"Out","value":463},{"label":"Nov","value":742},{"label":"Dez","value":655}];
const MX = 814;
