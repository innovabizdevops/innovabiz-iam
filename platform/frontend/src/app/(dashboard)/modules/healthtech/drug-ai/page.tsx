...
const ACCENT = "#dc2626";
const MODULE = "HealthTech Platform";
const PAGE = "Drug Interaction AI";
const KPIS = [{"l":"Total Healthtech","v":"5.541","t":"-4.1%","d":"down"},{"l":"Drug Interaction AI Ativos","v":"2.164","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"80.5%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"84","t":"+13.7%","d":"up"}];
const COLS = ["ID","Drug Interaction AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Healthtech #001","Healthtech #002","4.230","3.595","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Healthtech #002","Healthtech #003","1.451","1.518","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Healthtech #003","Healthtech #004","1.088","2.465","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Healthtech #004","Healthtech #005","1.202","346","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Healthtech #005","Healthtech #001","3.517","8.470","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":930},{"label":"Fev","value":639},{"label":"Mar","value":699},{"label":"Abr","value":691},{"label":"Mai","value":886},{"label":"Jun","value":857},{"label":"Jul","value":820},{"label":"Ago","value":543},{"label":"Set","value":628},{"label":"Out","value":672},{"label":"Nov","value":925},{"label":"Dez","value":585}];
const MX = 930;
...
export default function DrugAiPage() {
    return (
