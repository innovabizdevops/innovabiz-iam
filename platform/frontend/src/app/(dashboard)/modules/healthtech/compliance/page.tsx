...
const PAGE = "HIPAA/RGPD Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.461","t":"-0.7%","d":"down"},{"l":"NC Abertas","v":"5.367","t":"+5.7%","d":"up"},{"l":"Conformidade (%)","v":"82.0%","t":"+2.6%","d":"up"},{"l":"CAPAs Pendentes","v":"7.433","t":"-5.7%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.863","94.3%","1.169","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.463","74.6%","7.303","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.076","87.5%","3.015","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.969","71.9%","7.248","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","820","80.2%","8.304","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":634},{"label":"Mar","value":748},{"label":"Abr","value":516},{"label":"Mai","value":697},{"label":"Jun","value":570},{"label":"Jul","value":619},{"label":"Ago","value":525},{"label":"Set","value":700},{"label":"Out","value":580},{"label":"Nov","value":681},{"label":"Dez","value":733}];
const MX = 763;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>HIPAA</span></h1>
                </div>
