...
/* ═══ PropTech Platform — Deal Pipeline ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "3645", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "388", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "849", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "516647888", cells: ["PRO-3888", "Deal Pipeline Item 1", "9/9/2026", "€47 988"], status: "active" as const },
    { id: "516651459", cells: ["PRO-7459", "Deal Pipeline Item 2", "24/4/2026", "€1559"], status: "pending" as const },
    { id: "516655030", cells: ["PRO-2030", "Deal Pipeline Item 3", "11/11/2026", "€5130"], status: "completed" as const },
    { id: "516658601", cells: ["PRO-5601", "Deal Pipeline Item 4", "26/6/2026", "€8701"], status: "warning" as const },
    { id: "516662172", cells: ["PRO-9172", "Deal Pipeline Item 5", "13/1/2026", "€12 272"], status: "active" as const },
];
...
export default function ProptechPlatformDealPipelinePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Deal Pipeline</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">PropTech Platform • Deal Pipeline</p>
                    </div>
                </div>
