...
/* ═══ PropTech Platform — Occupancy Sensor ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "1159", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "257", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3004", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "88%", trend: "-24%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1977667341", cells: ["PRO-8341", "Occupancy Sensor Item 1", "14/10/2026", "€17 441"], status: "active" as const },
    { id: "1977670912", cells: ["PRO-2912", "Occupancy Sensor Item 2", "1/5/2026", "€21 012"], status: "pending" as const },
    { id: "1977674483", cells: ["PRO-6483", "Occupancy Sensor Item 3", "16/12/2026", "€24 583"], status: "completed" as const },
    { id: "1977678054", cells: ["PRO-1054", "Occupancy Sensor Item 4", "3/7/2026", "€28 154"], status: "warning" as const },
    { id: "1977681625", cells: ["PRO-4625", "Occupancy Sensor Item 5", "18/2/2026", "€31 725"], status: "active" as const },
];
...
export default function ProptechPlatformOccupancySensorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Occupancy Sensor</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">PropTech Platform • Occupancy Sensor</p>
                    </div>
                </div>
