...
/* ═══ PropTech Platform — Sustainability Cert ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "3014", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "13", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3997", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "76%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "147415689", cells: ["PRO-5689", "Sustainability Cert Item 1", "2/10/2026", "€15 789"], status: "active" as const },
    { id: "147419260", cells: ["PRO-9260", "Sustainability Cert Item 2", "17/5/2026", "€19 360"], status: "pending" as const },
    { id: "147422831", cells: ["PRO-3831", "Sustainability Cert Item 3", "4/12/2026", "€22 931"], status: "completed" as const },
    { id: "147426402", cells: ["PRO-7402", "Sustainability Cert Item 4", "19/7/2026", "€26 502"], status: "warning" as const },
    { id: "147429973", cells: ["PRO-1973", "Sustainability Cert Item 5", "6/2/2026", "€30 073"], status: "active" as const },
];
...
export default function ProptechPlatformSustainabilityCertPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sustainability Cert</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">PropTech Platform • Sustainability Cert</p>
                    </div>
                </div>
