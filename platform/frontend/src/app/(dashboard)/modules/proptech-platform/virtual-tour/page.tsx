...
/* ═══ PropTech Platform — Virtual Tour ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "730", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "337", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3354", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1836729517", cells: ["PRO-1517", "Virtual Tour Item 1", "22/2/2026", "€29 617"], status: "active" as const },
    { id: "1836733088", cells: ["PRO-5088", "Virtual Tour Item 2", "9/9/2026", "€33 188"], status: "pending" as const },
    { id: "1836736659", cells: ["PRO-8659", "Virtual Tour Item 3", "24/4/2026", "€36 759"], status: "completed" as const },
    { id: "1836740230", cells: ["PRO-3230", "Virtual Tour Item 4", "11/11/2026", "€40 330"], status: "warning" as const },
    { id: "1836743801", cells: ["PRO-6801", "Virtual Tour Item 5", "26/6/2026", "€43 901"], status: "active" as const },
];
...
export default function ProptechPlatformVirtualTourPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Virtual Tour</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">PropTech Platform • Virtual Tour</p>
                    </div>
                </div>
