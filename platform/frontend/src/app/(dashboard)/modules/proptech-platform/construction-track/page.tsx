...
/* ═══ PropTech Platform — Construction Track ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "807", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "34", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3324", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "79%", trend: "-20%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "708174462", cells: ["PRO-1462", "Construction Track Item 1", "3/7/2026", "€24 562"], status: "active" as const },
    { id: "708178033", cells: ["PRO-5033", "Construction Track Item 2", "18/2/2026", "€28 133"], status: "pending" as const },
    { id: "708181604", cells: ["PRO-8604", "Construction Track Item 3", "5/9/2026", "€31 704"], status: "completed" as const },
    { id: "708185175", cells: ["PRO-3175", "Construction Track Item 4", "20/4/2026", "€35 275"], status: "warning" as const },
    { id: "708188746", cells: ["PRO-6746", "Construction Track Item 5", "7/11/2026", "€38 846"], status: "active" as const },
];
...
export default function ProptechPlatformConstructionTrackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Construction Track</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">PropTech Platform • Construction Track</p>
                    </div>
                </div>
