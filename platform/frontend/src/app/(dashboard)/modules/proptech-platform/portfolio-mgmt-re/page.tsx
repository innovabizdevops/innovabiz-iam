...
/* ═══ PropTech Platform — Portfolio Mgmt Re ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "3866", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "384", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3159", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "85%", trend: "-11%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1525295628", cells: ["PRO-3628", "Portfolio Mgmt Re Item 1", "25/1/2026", "€45 728"], status: "active" as const },
    { id: "1525299199", cells: ["PRO-7199", "Portfolio Mgmt Re Item 2", "12/8/2026", "€49 299"], status: "pending" as const },
    { id: "1525302770", cells: ["PRO-1770", "Portfolio Mgmt Re Item 3", "27/3/2026", "€2870"], status: "completed" as const },
    { id: "1525306341", cells: ["PRO-5341", "Portfolio Mgmt Re Item 4", "14/10/2026", "€6441"], status: "warning" as const },
    { id: "1525309912", cells: ["PRO-8912", "Portfolio Mgmt Re Item 5", "1/5/2026", "€10 012"], status: "active" as const },
];
...
export default function ProptechPlatformPortfolioMgmtRePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Portfolio Mgmt Re</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">PropTech Platform • Portfolio Mgmt Re</p>
                    </div>
                </div>
