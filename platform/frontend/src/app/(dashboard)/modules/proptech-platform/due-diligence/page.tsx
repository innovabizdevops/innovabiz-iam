...
/* ═══ PropTech Platform — Due Diligence ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "4938", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "134", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1133", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "115225410", cells: ["PRO-8410", "Due Diligence Item 1", "7/7/2026", "€25 510"], status: "active" as const },
    { id: "115228981", cells: ["PRO-2981", "Due Diligence Item 2", "22/2/2026", "€29 081"], status: "pending" as const },
    { id: "115232552", cells: ["PRO-6552", "Due Diligence Item 3", "9/9/2026", "€32 652"], status: "completed" as const },
    { id: "115236123", cells: ["PRO-1123", "Due Diligence Item 4", "24/4/2026", "€36 223"], status: "warning" as const },
    { id: "115239694", cells: ["PRO-4694", "Due Diligence Item 5", "11/11/2026", "€39 794"], status: "active" as const },
];
...
export default function ProptechPlatformDueDiligencePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Due Diligence</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">PropTech Platform • Due Diligence</p>
                    </div>
                </div>
