...
/* ═══ PropTech Platform — Market Analysis ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "3748", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "250", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2971", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "93%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "176121926", cells: ["PRO-1926", "Market Analysis Item 1", "23/3/2026", "€22 026"], status: "active" as const },
    { id: "176125497", cells: ["PRO-5497", "Market Analysis Item 2", "10/10/2026", "€25 597"], status: "pending" as const },
    { id: "176129068", cells: ["PRO-9068", "Market Analysis Item 3", "25/5/2026", "€29 168"], status: "completed" as const },
    { id: "176132639", cells: ["PRO-3639", "Market Analysis Item 4", "12/12/2026", "€32 739"], status: "warning" as const },
    { id: "176136210", cells: ["PRO-7210", "Market Analysis Item 5", "27/7/2026", "€36 310"], status: "active" as const },
];
...
export default function ProptechPlatformMarketAnalysisPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Market Analysis</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">PropTech Platform • Market Analysis</p>
                    </div>
                </div>
