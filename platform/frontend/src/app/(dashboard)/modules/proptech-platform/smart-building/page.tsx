...
/* ═══ PropTech Platform — Smart Building ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "1877", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "5", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1680", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2136731313", cells: ["PRO-6313", "Smart Building Item 1", "18/10/2026", "€31 413"], status: "active" as const },
    { id: "2136734884", cells: ["PRO-9884", "Smart Building Item 2", "5/5/2026", "€34 984"], status: "pending" as const },
    { id: "2136738455", cells: ["PRO-4455", "Smart Building Item 3", "20/12/2026", "€38 555"], status: "completed" as const },
    { id: "2136742026", cells: ["PRO-8026", "Smart Building Item 4", "7/7/2026", "€42 126"], status: "warning" as const },
    { id: "2136745597", cells: ["PRO-2597", "Smart Building Item 5", "22/2/2026", "€45 697"], status: "active" as const },
];
...
export default function ProptechPlatformSmartBuildingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Smart Building</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">PropTech Platform • Smart Building</p>
                    </div>
                </div>
