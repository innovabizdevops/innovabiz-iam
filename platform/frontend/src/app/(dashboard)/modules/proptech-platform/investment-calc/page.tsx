...
/* ═══ PropTech Platform — Investment Calc ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "2610", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "112", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2257", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "119417084", cells: ["PRO-6084", "Investment Calc Item 1", "25/9/2026", "€17 184"], status: "active" as const },
    { id: "119420655", cells: ["PRO-9655", "Investment Calc Item 2", "12/4/2026", "€20 755"], status: "pending" as const },
    { id: "119424226", cells: ["PRO-4226", "Investment Calc Item 3", "27/11/2026", "€24 326"], status: "completed" as const },
    { id: "119427797", cells: ["PRO-7797", "Investment Calc Item 4", "14/6/2026", "€27 897"], status: "warning" as const },
    { id: "119431368", cells: ["PRO-2368", "Investment Calc Item 5", "1/1/2026", "€31 468"], status: "active" as const },
];
...
export default function ProptechPlatformInvestmentCalcPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Investment Calc</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">PropTech Platform • Investment Calc</p>
                    </div>
                </div>
