...
const KPIS = [{"l":"Dashboards Ativos","v":"3.823","t":"-0.7%","d":"down"},{"l":"Queries/Dia","v":"4304","t":"-2.0%","d":"down"},{"l":"Dados Processados (GB)","v":"7.188","t":"-1.9%","d":"down"},{"l":"Utilizadores Analytics","v":"6.325","t":"+5.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3828","2026-02-21","6.452","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1424","2026-01-24","1.080","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","808","2026-02-10","2.080","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2192","2026-01-26","1.747","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3860","2026-01-07","3.359","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1008},{"label":"Fev","value":989},{"label":"Mar","value":855},{"label":"Abr","value":984},{"label":"Mai","value":930},{"label":"Jun","value":1059},{"label":"Jul","value":736},{"label":"Ago","value":920},{"label":"Set","value":829},{"label":"Out","value":1024},{"label":"Nov","value":989},{"label":"Dez","value":915}];
const MX = 1059;
