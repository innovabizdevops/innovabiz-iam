...
const PAGE = "Helpdesk";
const KPIS = [{"l":"Tickets Abertos","v":"2.404","t":"-5.7%","d":"down"},{"l":"SLA Cumprido (%)","v":"76.5%","t":"+1.3%","d":"up"},{"l":"MTTR (h)","v":"194h","t":"+0.3%","d":"up"},{"l":"Satisfação (%)","v":"82.2%","t":"-3.0%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","485","4.393","2.056","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.618","8.965","6.642","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","564","8.853","6.791","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.234","7.938","7.528","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.210","3.277","6.382","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":457},{"label":"Fev","value":437},{"label":"Mar","value":330},{"label":"Abr","value":601},{"label":"Mai","value":529},{"label":"Jun","value":391},{"label":"Jul","value":554},{"label":"Ago","value":410},{"label":"Set","value":589},{"label":"Out","value":544},{"label":"Nov","value":572},{"label":"Dez","value":655}];
const MX = 655;
...
export default function HelpdeskServiceMgmtPage() {
    return (
