...
const ACCENT = "#4338ca";
const MODULE = "Service Management";
const PAGE = "Knowledge Base AI";
const KPIS = [{"l":"Artigos Publicados","v":"232","t":"+6.0%","d":"up"},{"l":"Views/Semana","v":"1928","t":"+10.0%","d":"up"},{"l":"Feedback Útil (%)","v":"84.2%","t":"-2.8%","d":"down"},{"l":"Artigos Desatualizados","v":"8.254","t":"+13.3%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","947","91.3%","5.018","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","807","99.7%","5.388","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","732","86.4%","8.379","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","3.301","89.0%","1.907","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","1.689","98.4%","3.107","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":636},{"label":"Mar","value":827},{"label":"Abr","value":660},{"label":"Mai","value":850},{"label":"Jun","value":861},{"label":"Jul","value":785},{"label":"Ago","value":549},{"label":"Set","value":862},{"label":"Out","value":764},{"label":"Nov","value":769},{"label":"Dez","value":862}];
const MX = 862;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>GenAI</span></h1>
                </div>
