...
const ACCENT = "#6366f1";
const MODULE = "MVNO Regulatory";
const PAGE = "SIM Register";
const KPIS = [{"l":"Total Mvno Regulatory","v":"1.839","t":"+2.7%","d":"up"},{"l":"SIM Register Ativos","v":"2.506","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"88.6%","t":"-2.8%","d":"down"},{"l":"Score Performance","v":"63","t":"+12.6%","d":"up"}];
const COLS = ["ID","SIM Register","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mvno Regulatory #001","Mvno Regulatory #002","9.081","3.643","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Mvno Regulatory #002","Mvno Regulatory #003","6.353","4.805","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Mvno Regulatory #003","Mvno Regulatory #004","333","3.555","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Mvno Regulatory #004","Mvno Regulatory #005","3.689","1.288","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mvno Regulatory #005","Mvno Regulatory #001","7.742","4.277","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":820},{"label":"Mar","value":595},{"label":"Abr","value":947},{"label":"Mai","value":585},{"label":"Jun","value":742},{"label":"Jul","value":719},{"label":"Ago","value":872},{"label":"Set","value":657},{"label":"Out","value":670},{"label":"Nov","value":731},{"label":"Dez","value":859}];
const MX = 947;
...
export default function SimregPage() {
    return (
