...
const PAGE = "Lawful Intercept";
const KPIS = [{"l":"Total Mvno Regulatory","v":"1.386","t":"+15.4%","d":"up"},{"l":"Lawful Intercept Ativos","v":"8.641","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"93.9%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"63","t":"+17.0%","d":"up"}];
const COLS = ["ID","Lawful Intercept","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mvno Regulatory #001","Mvno Regulatory #002","8.704","8.725","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Mvno Regulatory #002","Mvno Regulatory #003","1.055","4.366","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Mvno Regulatory #003","Mvno Regulatory #004","6.915","3.247","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Mvno Regulatory #004","Mvno Regulatory #005","4.730","2.709","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mvno Regulatory #005","Mvno Regulatory #001","8.097","7.889","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":566},{"label":"Mar","value":425},{"label":"Abr","value":560},{"label":"Mai","value":456},{"label":"Jun","value":366},{"label":"Jul","value":648},{"label":"Ago","value":413},{"label":"Set","value":715},{"label":"Out","value":541},{"label":"Nov","value":489},{"label":"Dez","value":378}];
const MX = 715;
