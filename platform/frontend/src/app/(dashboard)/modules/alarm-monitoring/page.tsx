...
/* ═══ Alarm Monitoring Center — Dashboard ═══ */

const ACCENT = "#334155";

const KPIS = [
    { label: "Total Registos", value: "5213", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4728", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€25K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "900083413", cells: ["ALA-3413", "Alarm Monitoring Center Item 1", "6/2/2026", "€33 513"], status: "active" as const },
    { id: "900086984", cells: ["ALA-6984", "Alarm Monitoring Center Item 2", "21/9/2026", "€37 084"], status: "pending" as const },
    { id: "900090555", cells: ["ALA-1555", "Alarm Monitoring Center Item 3", "8/4/2026", "€40 655"], status: "completed" as const },
    { id: "900094126", cells: ["ALA-5126", "Alarm Monitoring Center Item 4", "23/11/2026", "€44 226"], status: "warning" as const },
    { id: "900097697", cells: ["ALA-8697", "Alarm Monitoring Center Item 5", "10/6/2026", "€47 797"], status: "active" as const },
];
...
export default function AlarmMonitoringCenterPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Alarm Monitoring Center</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Alarm Monitoring Center</p>
                    </div>
                </div>
