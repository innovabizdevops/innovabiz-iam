...
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"3.483","t":"-2.8%","d":"down"},{"l":"Viagens/Dia","v":"4245","t":"+1.3%","d":"up"},{"l":"Pontualidade (%)","v":"81.2%","t":"+17.7%","d":"up"},{"l":"Passageiros/Dia","v":"4684","t":"+14.8%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-11","2026-02-21","3.319","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-08","2026-02-26","5.654","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-01","2026-03-27","1.831","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-07","2026-03-27","6.187","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-19","2026-01-07","2.337","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":399},{"label":"Mar","value":516},{"label":"Abr","value":663},{"label":"Mai","value":631},{"label":"Jun","value":702},{"label":"Jul","value":663},{"label":"Ago","value":435},{"label":"Set","value":453},{"label":"Out","value":735},{"label":"Nov","value":571},{"label":"Dez","value":501}];
const MX = 735;
