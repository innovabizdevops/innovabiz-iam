...
const PAGE = "Billing";
const KPIS = [{"l":"Total Alarm Monitoring","v":"3.113","t":"+0.9%","d":"up"},{"l":"Billing Ativos","v":"7.491","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"76.0%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"84","t":"-3.0%","d":"down"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Alarm Monitoring #001","Alarm Monitoring #002","2.347","1.541","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Alarm Monitoring #002","Alarm Monitoring #003","4.138","3.721","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Alarm Monitoring #003","Alarm Monitoring #004","5.227","8.285","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Alarm Monitoring #004","Alarm Monitoring #005","4.590","6.265","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Alarm Monitoring #005","Alarm Monitoring #001","5.895","8.851","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":689},{"label":"Fev","value":672},{"label":"Mar","value":621},{"label":"Abr","value":469},{"label":"Mai","value":740},{"label":"Jun","value":540},{"label":"Jul","value":631},{"label":"Ago","value":581},{"label":"Set","value":414},{"label":"Out","value":682},{"label":"Nov","value":396},{"label":"Dez","value":395}];
const MX = 740;
