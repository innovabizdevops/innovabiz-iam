...
const ACCENT = "#334155";
const MODULE = "Alarm Monitoring Center";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Alarm Monitoring","v":"8.955","t":"+8.3%","d":"up"},{"l":"Monitor Ativos","v":"2.232","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"84.9%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"90","t":"-3.2%","d":"down"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Alarm Monitoring #001","Alarm Monitoring #002","428","7.032","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Alarm Monitoring #002","Alarm Monitoring #003","2.585","1.583","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Alarm Monitoring #003","Alarm Monitoring #004","7.248","1.410","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Alarm Monitoring #004","Alarm Monitoring #005","7.153","3.686","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Alarm Monitoring #005","Alarm Monitoring #001","6.457","5.474","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":795},{"label":"Mar","value":601},{"label":"Abr","value":656},{"label":"Mai","value":520},{"label":"Jun","value":692},{"label":"Jul","value":656},{"label":"Ago","value":728},{"label":"Set","value":664},{"label":"Out","value":504},{"label":"Nov","value":604},{"label":"Dez","value":844}];
const MX = 844;
