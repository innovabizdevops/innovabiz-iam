...
export default function UpstreamExplorePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Upstream Explore</h1><p className="text-sm text-muted-foreground">Upstream Explore • iBOS Enterprise</p></div>
