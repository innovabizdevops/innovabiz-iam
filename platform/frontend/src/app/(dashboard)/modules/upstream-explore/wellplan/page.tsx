...
const PAGE = "Well Plan";
const KPIS = [{"l":"Total Upstream Explore","v":"2.895","t":"+16.1%","d":"up"},{"l":"Well Plan Ativos","v":"7.983","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"91.8%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"56","t":"-1.8%","d":"down"}];
const COLS = ["ID","Well Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Upstream Explore #001","Upstream Explore #002","8.626","1.461","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Upstream Explore #002","Upstream Explore #003","1.255","8.931","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Upstream Explore #003","Upstream Explore #004","1.420","2.836","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Upstream Explore #004","Upstream Explore #005","3.042","8.367","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Upstream Explore #005","Upstream Explore #001","6.799","2.042","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":892},{"label":"Mar","value":685},{"label":"Abr","value":665},{"label":"Mai","value":744},{"label":"Jun","value":953},{"label":"Jul","value":874},{"label":"Ago","value":789},{"label":"Set","value":676},{"label":"Out","value":854},{"label":"Nov","value":924},{"label":"Dez","value":815}];
const MX = 953;
...
export default function WellplanPage() {
    return (
