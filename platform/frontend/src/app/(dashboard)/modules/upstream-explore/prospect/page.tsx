...
const PAGE = "Prospect";
const KPIS = [{"l":"Total Upstream Explore","v":"8.237","t":"+6.8%","d":"up"},{"l":"Prospect Ativos","v":"7.062","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"74.5%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"57","t":"+6.4%","d":"up"}];
const COLS = ["ID","Prospect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Upstream Explore #001","Upstream Explore #002","7.274","3.736","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Upstream Explore #002","Upstream Explore #003","873","2.167","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Upstream Explore #003","Upstream Explore #004","462","7.926","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Upstream Explore #004","Upstream Explore #005","2.129","5.333","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Upstream Explore #005","Upstream Explore #001","5.430","8.311","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":476},{"label":"Mar","value":447},{"label":"Abr","value":389},{"label":"Mai","value":603},{"label":"Jun","value":703},{"label":"Jul","value":590},{"label":"Ago","value":398},{"label":"Set","value":364},{"label":"Out","value":309},{"label":"Nov","value":678},{"label":"Dez","value":581}];
const MX = 703;
