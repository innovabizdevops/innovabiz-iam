...
const PAGE = "License";
const KPIS = [{"l":"Total Upstream Explore","v":"6.233","t":"-4.5%","d":"down"},{"l":"License Ativos","v":"5.424","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"77.2%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"62","t":"-0.5%","d":"down"}];
const COLS = ["ID","License","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Upstream Explore #001","Upstream Explore #002","8.856","3.060","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Upstream Explore #002","Upstream Explore #003","4.593","5.940","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Upstream Explore #003","Upstream Explore #004","1.223","8.632","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Upstream Explore #004","Upstream Explore #005","1.058","2.833","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Upstream Explore #005","Upstream Explore #001","8.909","4.642","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":756},{"label":"Mar","value":587},{"label":"Abr","value":723},{"label":"Mai","value":755},{"label":"Jun","value":661},{"label":"Jul","value":737},{"label":"Ago","value":758},{"label":"Set","value":595},{"label":"Out","value":582},{"label":"Nov","value":797},{"label":"Dez","value":785}];
const MX = 797;
