...
const ACCENT = "#6366f1";
const MODULE = "Upstream Exploration";
const PAGE = "Reservoir";
const KPIS = [{"l":"Total Upstream Explore","v":"6.337","t":"+18.0%","d":"up"},{"l":"Reservoir Ativos","v":"7.098","t":"+10.4%","d":"up"},{"l":"Eficiência (%)","v":"94.9%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"71","t":"-3.3%","d":"down"}];
const COLS = ["ID","Reservoir","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Upstream Explore #001","Upstream Explore #002","6.433","495","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Upstream Explore #002","Upstream Explore #003","1.437","4.999","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Upstream Explore #003","Upstream Explore #004","611","7.022","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Upstream Explore #004","Upstream Explore #005","648","7.387","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Upstream Explore #005","Upstream Explore #001","6.066","4.962","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":991},{"label":"Fev","value":709},{"label":"Mar","value":1048},{"label":"Abr","value":765},{"label":"Mai","value":836},{"label":"Jun","value":712},{"label":"Jul","value":931},{"label":"Ago","value":1005},{"label":"Set","value":956},{"label":"Out","value":762},{"label":"Nov","value":1059},{"label":"Dez","value":710}];
const MX = 1059;
