...
const PAGE = "Seismic";
const KPIS = [{"l":"Total Upstream Explore","v":"3.902","t":"-2.6%","d":"down"},{"l":"Seismic Ativos","v":"6.959","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"83.1%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"85","t":"+9.1%","d":"up"}];
const COLS = ["ID","Seismic","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Upstream Explore #001","Upstream Explore #002","1.696","3.877","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Upstream Explore #002","Upstream Explore #003","2.268","6.985","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Upstream Explore #003","Upstream Explore #004","1.657","6.153","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Upstream Explore #004","Upstream Explore #005","3.679","1.963","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Upstream Explore #005","Upstream Explore #001","8.272","8.789","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":721},{"label":"Fev","value":639},{"label":"Mar","value":732},{"label":"Abr","value":550},{"label":"Mai","value":752},{"label":"Jun","value":734},{"label":"Jul","value":695},{"label":"Ago","value":661},{"label":"Set","value":510},{"label":"Out","value":740},{"label":"Nov","value":604},{"label":"Dez","value":415}];
const MX = 752;
