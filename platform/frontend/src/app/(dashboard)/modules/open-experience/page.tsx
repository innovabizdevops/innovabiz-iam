...
export default function OpenExperiencePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Open Experience</h1><p className="text-sm text-muted-foreground">Open Experience • iBOS Enterprise</p></div>
