...
const KPIS = [
    { label: "Total Registos", value: "2538", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "416", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€195K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1728304838", cells: ["EVE-8838", "Event Analytics Item 1", "23/3/2026", "€4938"], status: "active" as const },
    { id: "1728308409", cells: ["EVE-3409", "Event Analytics Item 2", "10/10/2026", "€8509"], status: "pending" as const },
    { id: "1728311980", cells: ["EVE-6980", "Event Analytics Item 3", "25/5/2026", "€12 080"], status: "completed" as const },
    { id: "1728315551", cells: ["EVE-1551", "Event Analytics Item 4", "12/12/2026", "€15 651"], status: "warning" as const },
    { id: "1728319122", cells: ["EVE-5122", "Event Analytics Item 5", "27/7/2026", "€19 222"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Event Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Event Analytics</p>
                    </div>
                </div>
