...
const PAGE = "ROI";
const KPIS = [{"l":"Dashboards Ativos","v":"1.857","t":"+12.8%","d":"up"},{"l":"Queries/Dia","v":"2022","t":"-0.3%","d":"down"},{"l":"Dados Processados (GB)","v":"5.106","t":"+4.9%","d":"up"},{"l":"Utilizadores Analytics","v":"4.554","t":"+17.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4325","2026-02-28","9.058","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2188","2026-01-14","611","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3507","2026-03-26","630","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3821","2026-01-08","3.406","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2191","2026-03-20","8.700","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":397},{"label":"Fev","value":403},{"label":"Mar","value":411},{"label":"Abr","value":682},{"label":"Mai","value":642},{"label":"Jun","value":376},{"label":"Jul","value":475},{"label":"Ago","value":533},{"label":"Set","value":636},{"label":"Out","value":417},{"label":"Nov","value":549},{"label":"Dez","value":342}];
const MX = 682;
