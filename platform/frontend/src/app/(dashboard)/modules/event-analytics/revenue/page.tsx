...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€49.1M","t":"+0.9%","d":"up"},{"l":"MRR (€)","v":"€38363","t":"-3.8%","d":"down"},{"l":"Churn (%)","v":"84.0%","t":"+6.9%","d":"up"},{"l":"ARPU (€)","v":"€65666","t":"-4.7%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 5104.68","3.642","€ 39064.75","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 8642.98","6.519","€ 38512.97","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 4804.53","3.622","€ 32825.26","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 27873.21","4.488","€ 29386.04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 9203.13","1.447","€ 5902.31","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":503},{"label":"Mar","value":565},{"label":"Abr","value":663},{"label":"Mai","value":381},{"label":"Jun","value":629},{"label":"Jul","value":574},{"label":"Ago","value":365},{"label":"Set","value":347},{"label":"Out","value":563},{"label":"Nov","value":508},{"label":"Dez","value":517}];
const MX = 663;
