...
const ACCENT = "#831843";
const MODULE = "Event Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"3.871","t":"+8.9%","d":"up"},{"l":"Queries/Dia","v":"2152","t":"+16.0%","d":"up"},{"l":"Dados Processados (GB)","v":"5.006","t":"+13.4%","d":"up"},{"l":"Utilizadores Analytics","v":"8.182","t":"+14.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2979","2026-03-18","5.086","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","357","2026-03-15","178","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","103","2026-03-27","3.778","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4118","2026-01-28","7.143","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3827","2026-03-06","2.115","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":464},{"label":"Mar","value":605},{"label":"Abr","value":392},{"label":"Mai","value":528},{"label":"Jun","value":311},{"label":"Jul","value":439},{"label":"Ago","value":522},{"label":"Set","value":472},{"label":"Out","value":437},{"label":"Nov","value":485},{"label":"Dez","value":635}];
const MX = 642;
