...
const KPIS = [{"l":"Dashboards Ativos","v":"8.089","t":"-5.6%","d":"down"},{"l":"Queries/Dia","v":"1347","t":"+2.0%","d":"up"},{"l":"Dados Processados (GB)","v":"8.933","t":"+3.5%","d":"up"},{"l":"Utilizadores Analytics","v":"281","t":"+7.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","383","2026-02-04","5.127","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4606","2026-02-27","533","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4443","2026-02-13","6.320","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4610","2026-01-17","3.951","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2337","2026-02-09","7.556","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":336},{"label":"Mar","value":274},{"label":"Abr","value":515},{"label":"Mai","value":487},{"label":"Jun","value":367},{"label":"Jul","value":621},{"label":"Ago","value":657},{"label":"Set","value":332},{"label":"Out","value":311},{"label":"Nov","value":413},{"label":"Dez","value":512}];
const MX = 657;
