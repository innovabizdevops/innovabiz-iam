...
const PAGE = "Satisfaction";
const KPIS = [{"l":"Dashboards Ativos","v":"624","t":"+6.6%","d":"up"},{"l":"Queries/Dia","v":"2138","t":"+12.2%","d":"up"},{"l":"Dados Processados (GB)","v":"3.518","t":"-2.6%","d":"down"},{"l":"Utilizadores Analytics","v":"4.244","t":"+4.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3851","2026-01-05","6.786","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2671","2026-03-25","1.442","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1937","2026-03-27","4.039","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1934","2026-02-05","7.899","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2483","2026-02-08","7.688","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":818},{"label":"Mar","value":727},{"label":"Abr","value":749},{"label":"Mai","value":776},{"label":"Jun","value":792},{"label":"Jul","value":926},{"label":"Ago","value":679},{"label":"Set","value":654},{"label":"Out","value":774},{"label":"Nov","value":818},{"label":"Dez","value":668}];
const MX = 926;
