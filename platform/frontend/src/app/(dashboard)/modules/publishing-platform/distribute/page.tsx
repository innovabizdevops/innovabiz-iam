...
const KPIS = [{"l":"Formulários Ativos","v":"5.068","t":"+10.1%","d":"up"},{"l":"Submissões/Dia","v":"2584","t":"-0.1%","d":"down"},{"l":"Documentos Gerados","v":"1.868","t":"+2.6%","d":"up"},{"l":"Templates","v":"2.482","t":"-2.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.439","2026-02-15","3.860","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.378","2026-03-06","2.399","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.057","2026-03-12","3.663","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.790","2026-03-22","2.641","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.347","2026-03-02","3.518","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":866},{"label":"Mar","value":812},{"label":"Abr","value":1009},{"label":"Mai","value":767},{"label":"Jun","value":906},{"label":"Jul","value":1004},{"label":"Ago","value":1065},{"label":"Set","value":727},{"label":"Out","value":984},{"label":"Nov","value":924},{"label":"Dez","value":926}];
const MX = 1065;
