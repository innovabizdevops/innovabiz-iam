...
const ACCENT = "#6d28d9";
const MODULE = "Publishing Platform Deep";
const PAGE = "Edit";
const KPIS = [{"l":"Formulários Ativos","v":"3.208","t":"-4.0%","d":"down"},{"l":"Submissões/Dia","v":"2894","t":"-2.5%","d":"down"},{"l":"Documentos Gerados","v":"4.916","t":"+15.5%","d":"up"},{"l":"Templates","v":"728","t":"-2.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.645","2026-01-03","3.318","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.450","2026-03-19","248","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.745","2026-02-02","6.456","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.408","2026-01-21","6.053","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","9.075","2026-01-23","7.488","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":495},{"label":"Mar","value":412},{"label":"Abr","value":345},{"label":"Mai","value":660},{"label":"Jun","value":650},{"label":"Jul","value":599},{"label":"Ago","value":605},{"label":"Set","value":482},{"label":"Out","value":468},{"label":"Nov","value":485},{"label":"Dez","value":315}];
const MX = 660;
