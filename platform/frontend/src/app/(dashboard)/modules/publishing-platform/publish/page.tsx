...
const PAGE = "Publish";
const KPIS = [{"l":"Formulários Ativos","v":"1.406","t":"+0.7%","d":"up"},{"l":"Submissões/Dia","v":"1392","t":"+3.9%","d":"up"},{"l":"Documentos Gerados","v":"8.946","t":"+0.6%","d":"up"},{"l":"Templates","v":"6.640","t":"-1.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.834","2026-02-06","3.969","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.124","2026-03-26","7.805","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.182","2026-01-04","5.176","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.927","2026-01-06","6.029","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.942","2026-01-27","7.979","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":989},{"label":"Fev","value":891},{"label":"Mar","value":642},{"label":"Abr","value":740},{"label":"Mai","value":631},{"label":"Jun","value":828},{"label":"Jul","value":855},{"label":"Ago","value":860},{"label":"Set","value":631},{"label":"Out","value":713},{"label":"Nov","value":791},{"label":"Dez","value":791}];
const MX = 989;
