...
const PAGE = "Author";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.452","t":"-4.9%","d":"down"},{"l":"Sessões/Dia","v":"5006","t":"-2.1%","d":"down"},{"l":"MFA Adoção (%)","v":"85.7%","t":"+4.6%","d":"up"},{"l":"Tentativas Bloqueadas","v":"5.910","t":"+3.4%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.934","5.973","1.626","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","4.977","5.020","8.088","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","6.227","5.061","3.550","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.286","335","7.367","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","2.272","1.259","8.815","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":272},{"label":"Mar","value":412},{"label":"Abr","value":403},{"label":"Mai","value":250},{"label":"Jun","value":617},{"label":"Jul","value":315},{"label":"Ago","value":458},{"label":"Set","value":461},{"label":"Out","value":431},{"label":"Nov","value":516},{"label":"Dez","value":465}];
const MX = 634;
