...
const PAGE = "Royalty";
const KPIS = [{"l":"Formulários Ativos","v":"5.733","t":"+11.0%","d":"up"},{"l":"Submissões/Dia","v":"4822","t":"+15.3%","d":"up"},{"l":"Documentos Gerados","v":"3.206","t":"+9.9%","d":"up"},{"l":"Templates","v":"5.699","t":"+8.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.337","2026-02-03","5.718","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.244","2026-01-26","1.476","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.892","2026-01-25","8.906","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.437","2026-03-16","4.892","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.453","2026-01-02","6.952","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":592},{"label":"Mar","value":770},{"label":"Abr","value":731},{"label":"Mai","value":823},{"label":"Jun","value":610},{"label":"Jul","value":806},{"label":"Ago","value":553},{"label":"Set","value":507},{"label":"Out","value":715},{"label":"Nov","value":556},{"label":"Dez","value":606}];
const MX = 823;
