...
/* ═══ Publishing Platform Deep — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "3084", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2731", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€212K", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "130158284", cells: ["PUB-1284", "Publishing Platform Deep Item 1", "5/9/2026", "€8384"], status: "active" as const },
    { id: "130161855", cells: ["PUB-4855", "Publishing Platform Deep Item 2", "20/4/2026", "€11 955"], status: "pending" as const },
    { id: "130165426", cells: ["PUB-8426", "Publishing Platform Deep Item 3", "7/11/2026", "€15 526"], status: "completed" as const },
    { id: "130168997", cells: ["PUB-2997", "Publishing Platform Deep Item 4", "22/6/2026", "€19 097"], status: "warning" as const },
    { id: "130172568", cells: ["PUB-6568", "Publishing Platform Deep Item 5", "9/1/2026", "€22 668"], status: "active" as const },
];
...
export default function PublishingPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Publishing Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Publishing Platform Deep</p>
                    </div>
                </div>
