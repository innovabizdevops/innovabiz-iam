...
const PAGE = "Extrude";
const KPIS = [{"l":"Total Polymer Mgmt","v":"7.829","t":"+2.9%","d":"up"},{"l":"Extrude Ativos","v":"5.376","t":"+13.5%","d":"up"},{"l":"Eficiência (%)","v":"94.2%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"67","t":"-3.5%","d":"down"}];
const COLS = ["ID","Extrude","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Polymer Mgmt #001","Polymer Mgmt #002","168","700","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Polymer Mgmt #002","Polymer Mgmt #003","7.176","3.052","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Polymer Mgmt #003","Polymer Mgmt #004","8.012","4.557","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Polymer Mgmt #004","Polymer Mgmt #005","2.294","1.873","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Polymer Mgmt #005","Polymer Mgmt #001","6.631","7.924","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":648},{"label":"Mar","value":737},{"label":"Abr","value":682},{"label":"Mai","value":605},{"label":"Jun","value":573},{"label":"Jul","value":887},{"label":"Ago","value":684},{"label":"Set","value":650},{"label":"Out","value":827},{"label":"Nov","value":859},{"label":"Dez","value":546}];
const MX = 887;
