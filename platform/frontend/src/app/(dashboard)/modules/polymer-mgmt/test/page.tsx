...
const PAGE = "Test";
const KPIS = [{"l":"Total Polymer Mgmt","v":"6.010","t":"-2.0%","d":"down"},{"l":"Test Ativos","v":"6.285","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"78.4%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"60","t":"+8.2%","d":"up"}];
const COLS = ["ID","Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Polymer Mgmt #001","Polymer Mgmt #002","5.014","6.947","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Polymer Mgmt #002","Polymer Mgmt #003","6.440","1.175","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Polymer Mgmt #003","Polymer Mgmt #004","5.137","7.967","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Polymer Mgmt #004","Polymer Mgmt #005","3.517","4.092","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Polymer Mgmt #005","Polymer Mgmt #001","1.000","5.063","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":915},{"label":"Fev","value":849},{"label":"Mar","value":979},{"label":"Abr","value":826},{"label":"Mai","value":798},{"label":"Jun","value":702},{"label":"Jul","value":845},{"label":"Ago","value":960},{"label":"Set","value":726},{"label":"Out","value":877},{"label":"Nov","value":949},{"label":"Dez","value":995}];
const MX = 995;
