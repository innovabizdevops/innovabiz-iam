...
const PAGE = "Compound";
const KPIS = [{"l":"Total Polymer Mgmt","v":"4.159","t":"+15.3%","d":"up"},{"l":"Compound Ativos","v":"655","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"75.5%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"73","t":"+4.2%","d":"up"}];
const COLS = ["ID","Compound","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Polymer Mgmt #001","Polymer Mgmt #002","833","6.716","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Polymer Mgmt #002","Polymer Mgmt #003","7.967","5.121","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Polymer Mgmt #003","Polymer Mgmt #004","785","1.709","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Polymer Mgmt #004","Polymer Mgmt #005","6.411","5.757","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Polymer Mgmt #005","Polymer Mgmt #001","9.072","6.073","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":721},{"label":"Fev","value":680},{"label":"Mar","value":735},{"label":"Abr","value":654},{"label":"Mai","value":400},{"label":"Jun","value":718},{"label":"Jul","value":600},{"label":"Ago","value":633},{"label":"Set","value":564},{"label":"Out","value":757},{"label":"Nov","value":485},{"label":"Dez","value":612}];
const MX = 757;
