...
const PAGE = "Mold";
const KPIS = [{"l":"Total Polymer Mgmt","v":"5.138","t":"+14.0%","d":"up"},{"l":"Mold Ativos","v":"5.821","t":"+17.3%","d":"up"},{"l":"Eficiência (%)","v":"87.2%","t":"-4.4%","d":"down"},{"l":"Score Performance","v":"71","t":"-1.4%","d":"down"}];
const COLS = ["ID","Mold","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Polymer Mgmt #001","Polymer Mgmt #002","859","2.901","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Polymer Mgmt #002","Polymer Mgmt #003","5.133","4.147","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Polymer Mgmt #003","Polymer Mgmt #004","5.476","8.555","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Polymer Mgmt #004","Polymer Mgmt #005","3.639","2.995","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Polymer Mgmt #005","Polymer Mgmt #001","610","6.039","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":803},{"label":"Mar","value":778},{"label":"Abr","value":748},{"label":"Mai","value":927},{"label":"Jun","value":761},{"label":"Jul","value":983},{"label":"Ago","value":850},{"label":"Set","value":792},{"label":"Out","value":899},{"label":"Nov","value":1080},{"label":"Dez","value":854}];
const MX = 1080;
