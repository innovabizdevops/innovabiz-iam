...
const ACCENT = "#6366f1";
const MODULE = "Polymer Management";
const PAGE = "Polymerize";
const KPIS = [{"l":"Total Polymer Mgmt","v":"8.988","t":"+6.3%","d":"up"},{"l":"Polymerize Ativos","v":"8.385","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"82.8%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"58","t":"-5.3%","d":"down"}];
const COLS = ["ID","Polymerize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Polymer Mgmt #001","Polymer Mgmt #002","8.631","3.629","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Polymer Mgmt #002","Polymer Mgmt #003","7.032","2.378","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Polymer Mgmt #003","Polymer Mgmt #004","7.999","5.945","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Polymer Mgmt #004","Polymer Mgmt #005","1.541","7.950","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Polymer Mgmt #005","Polymer Mgmt #001","647","7.559","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":463},{"label":"Mar","value":669},{"label":"Abr","value":462},{"label":"Mai","value":655},{"label":"Jun","value":340},{"label":"Jul","value":330},{"label":"Ago","value":612},{"label":"Set","value":609},{"label":"Out","value":426},{"label":"Nov","value":382},{"label":"Dez","value":603}];
const MX = 669;
...
export default function PolymerizePage() {
    return (
