...
const PAGE = "Fund";
const KPIS = [{"l":"Total Faith Ngo","v":"8.330","t":"-1.0%","d":"down"},{"l":"Fund Ativos","v":"1.480","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"89.4%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"56","t":"+13.7%","d":"up"}];
const COLS = ["ID","Fund","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Faith Ngo #001","Faith Ngo #002","1.681","6.823","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Faith Ngo #002","Faith Ngo #003","6.580","3.716","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Faith Ngo #003","Faith Ngo #004","5.903","2.033","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Faith Ngo #004","Faith Ngo #005","6.366","1.097","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Faith Ngo #005","Faith Ngo #001","595","5.240","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":450},{"label":"Mar","value":588},{"label":"Abr","value":560},{"label":"Mai","value":433},{"label":"Jun","value":559},{"label":"Jul","value":591},{"label":"Ago","value":662},{"label":"Set","value":565},{"label":"Out","value":651},{"label":"Nov","value":628},{"label":"Dez","value":530}];
const MX = 662;
