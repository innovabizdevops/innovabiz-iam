...
const PAGE = "Partner";
const KPIS = [{"l":"Total Faith Ngo","v":"8.476","t":"-2.0%","d":"down"},{"l":"Partner Ativos","v":"8.423","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"87.4%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"92","t":"+13.2%","d":"up"}];
const COLS = ["ID","Partner","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Faith Ngo #001","Faith Ngo #002","6.169","3.432","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Faith Ngo #002","Faith Ngo #003","4.698","3.587","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Faith Ngo #003","Faith Ngo #004","5.572","2.640","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Faith Ngo #004","Faith Ngo #005","7.376","2.130","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Faith Ngo #005","Faith Ngo #001","4.046","8.808","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":825},{"label":"Mar","value":643},{"label":"Abr","value":903},{"label":"Mai","value":781},{"label":"Jun","value":624},{"label":"Jul","value":843},{"label":"Ago","value":783},{"label":"Set","value":728},{"label":"Out","value":691},{"label":"Nov","value":942},{"label":"Dez","value":611}];
const MX = 942;
