...
const PAGE = "Program";
const KPIS = [{"l":"Total Faith Ngo","v":"3.051","t":"+16.3%","d":"up"},{"l":"Program Ativos","v":"4.184","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"87.1%","t":"+7.6%","d":"up"},{"l":"Score Performance","v":"62","t":"+12.4%","d":"up"}];
const COLS = ["ID","Program","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Faith Ngo #001","Faith Ngo #002","2.422","4.859","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Faith Ngo #002","Faith Ngo #003","566","1.154","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Faith Ngo #003","Faith Ngo #004","4.980","8.606","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Faith Ngo #004","Faith Ngo #005","4.953","6.329","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Faith Ngo #005","Faith Ngo #001","3.661","2.163","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":510},{"label":"Mar","value":755},{"label":"Abr","value":868},{"label":"Mai","value":688},{"label":"Jun","value":522},{"label":"Jul","value":648},{"label":"Ago","value":814},{"label":"Set","value":825},{"label":"Out","value":639},{"label":"Nov","value":779},{"label":"Dez","value":654}];
const MX = 868;
