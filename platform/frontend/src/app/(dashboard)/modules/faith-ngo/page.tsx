...
/* ═══ Faith-Based NGO — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "294", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1651", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€23K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1004770994", cells: ["FAI-2994", "Faith-Based NGO Item 1", "11/3/2026", "€21 094"], status: "active" as const },
    { id: "1004774565", cells: ["FAI-6565", "Faith-Based NGO Item 2", "26/10/2026", "€24 665"], status: "pending" as const },
    { id: "1004778136", cells: ["FAI-1136", "Faith-Based NGO Item 3", "13/5/2026", "€28 236"], status: "completed" as const },
    { id: "1004781707", cells: ["FAI-4707", "Faith-Based NGO Item 4", "28/12/2026", "€31 807"], status: "warning" as const },
    { id: "1004785278", cells: ["FAI-8278", "Faith-Based NGO Item 5", "15/7/2026", "€35 378"], status: "active" as const },
];
...
export default function FaithbasedNgoPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Faith-Based NGO</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Faith-Based NGO</p>
                    </div>
                </div>
