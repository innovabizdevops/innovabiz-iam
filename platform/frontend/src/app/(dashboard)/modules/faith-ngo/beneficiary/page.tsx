...
const ACCENT = "#7c3aed";
const MODULE = "Faith-Based NGO";
const PAGE = "Beneficiary";
const KPIS = [{"l":"Total Faith Ngo","v":"8.424","t":"+0.2%","d":"up"},{"l":"Beneficiary Ativos","v":"625","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"83.3%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"61","t":"-5.9%","d":"down"}];
const COLS = ["ID","Beneficiary","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Faith Ngo #001","Faith Ngo #002","1.129","160","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Faith Ngo #002","Faith Ngo #003","7.920","7.091","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Faith Ngo #003","Faith Ngo #004","3.622","1.312","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Faith Ngo #004","Faith Ngo #005","1.828","2.663","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Faith Ngo #005","Faith Ngo #001","172","4.747","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":491},{"label":"Fev","value":374},{"label":"Mar","value":552},{"label":"Abr","value":347},{"label":"Mai","value":462},{"label":"Jun","value":567},{"label":"Jul","value":383},{"label":"Ago","value":518},{"label":"Set","value":702},{"label":"Out","value":446},{"label":"Nov","value":368},{"label":"Dez","value":351}];
const MX = 702;
