...
const PAGE = "Report";
const KPIS = [{"l":"Total Faith Ngo","v":"6.706","t":"+12.9%","d":"up"},{"l":"Report Ativos","v":"7.424","t":"+0.7%","d":"up"},{"l":"Eficiência (%)","v":"72.4%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"58","t":"+9.8%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Faith Ngo #001","Faith Ngo #002","4.028","3.841","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Faith Ngo #002","Faith Ngo #003","3.730","8.539","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Faith Ngo #003","Faith Ngo #004","2.186","2.931","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Faith Ngo #004","Faith Ngo #005","1.159","2.273","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Faith Ngo #005","Faith Ngo #001","5.039","8.370","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1054},{"label":"Fev","value":737},{"label":"Mar","value":733},{"label":"Abr","value":725},{"label":"Mai","value":717},{"label":"Jun","value":872},{"label":"Jul","value":769},{"label":"Ago","value":889},{"label":"Set","value":783},{"label":"Out","value":891},{"label":"Nov","value":948},{"label":"Dez","value":736}];
const MX = 1054;
