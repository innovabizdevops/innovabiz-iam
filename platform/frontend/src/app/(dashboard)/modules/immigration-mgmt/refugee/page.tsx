...
const PAGE = "Refugee";
const KPIS = [{"l":"Total Immigration Mgmt","v":"7.210","t":"+13.5%","d":"up"},{"l":"Refugee Ativos","v":"3.433","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"70.5%","t":"+10.8%","d":"up"},{"l":"Score Performance","v":"73","t":"+17.2%","d":"up"}];
const COLS = ["ID","Refugee","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Immigration Mgmt #001","Immigration Mgmt #002","5.722","7.822","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Immigration Mgmt #002","Immigration Mgmt #003","8.000","1.485","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Immigration Mgmt #003","Immigration Mgmt #004","534","235","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Immigration Mgmt #004","Immigration Mgmt #005","8.396","8.201","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Immigration Mgmt #005","Immigration Mgmt #001","336","6.939","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":626},{"label":"Mar","value":561},{"label":"Abr","value":573},{"label":"Mai","value":411},{"label":"Jun","value":478},{"label":"Jul","value":627},{"label":"Ago","value":590},{"label":"Set","value":642},{"label":"Out","value":267},{"label":"Nov","value":527},{"label":"Dez","value":265}];
const MX = 642;
