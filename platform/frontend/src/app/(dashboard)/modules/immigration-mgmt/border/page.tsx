...
const PAGE = "Border";
const KPIS = [{"l":"Total Immigration Mgmt","v":"7.375","t":"+5.1%","d":"up"},{"l":"Border Ativos","v":"1.201","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"89.4%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"76","t":"-1.3%","d":"down"}];
const COLS = ["ID","Border","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Immigration Mgmt #001","Immigration Mgmt #002","8.632","364","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Immigration Mgmt #002","Immigration Mgmt #003","8.103","1.135","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Immigration Mgmt #003","Immigration Mgmt #004","1.191","8.892","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Immigration Mgmt #004","Immigration Mgmt #005","179","4.844","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Immigration Mgmt #005","Immigration Mgmt #001","6.359","5.936","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":287},{"label":"Mar","value":478},{"label":"Abr","value":263},{"label":"Mai","value":535},{"label":"Jun","value":275},{"label":"Jul","value":337},{"label":"Ago","value":596},{"label":"Set","value":504},{"label":"Out","value":473},{"label":"Nov","value":230},{"label":"Dez","value":438}];
const MX = 596;
