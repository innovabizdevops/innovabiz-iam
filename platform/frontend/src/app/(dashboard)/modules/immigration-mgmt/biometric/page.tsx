...
const ACCENT = "#6366f1";
const MODULE = "Immigration Mgmt";
const PAGE = "Biometric";
const KPIS = [{"l":"Total Immigration Mgmt","v":"8.341","t":"-5.3%","d":"down"},{"l":"Biometric Ativos","v":"229","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"75.4%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"64","t":"+6.5%","d":"up"}];
const COLS = ["ID","Biometric","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Immigration Mgmt #001","Immigration Mgmt #002","1.885","5.741","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Immigration Mgmt #002","Immigration Mgmt #003","8.668","4.713","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Immigration Mgmt #003","Immigration Mgmt #004","3.857","8.518","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Immigration Mgmt #004","Immigration Mgmt #005","7.455","6.628","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Immigration Mgmt #005","Immigration Mgmt #001","3.293","8.605","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":350},{"label":"Fev","value":203},{"label":"Mar","value":424},{"label":"Abr","value":251},{"label":"Mai","value":517},{"label":"Jun","value":255},{"label":"Jul","value":594},{"label":"Ago","value":541},{"label":"Set","value":448},{"label":"Out","value":234},{"label":"Nov","value":555},{"label":"Dez","value":250}];
const MX = 594;
