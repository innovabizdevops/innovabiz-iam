...
const PAGE = "Permit";
const KPIS = [{"l":"Riscos Identificados","v":"488","t":"+11.7%","d":"up"},{"l":"Mitigações Ativas","v":"5.891","t":"+5.6%","d":"up"},{"l":"Score Risco Geral","v":"66","t":"-1.4%","d":"down"},{"l":"Incidentes YTD","v":"8.677","t":"+15.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.145","1.524","3.015","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","755","5.985","6.302","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.921","6.453","5.464","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.626","2.506","3.775","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","564","7.684","6.999","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":421},{"label":"Fev","value":270},{"label":"Mar","value":258},{"label":"Abr","value":370},{"label":"Mai","value":278},{"label":"Jun","value":579},{"label":"Jul","value":291},{"label":"Ago","value":397},{"label":"Set","value":360},{"label":"Out","value":424},{"label":"Nov","value":465},{"label":"Dez","value":546}];
const MX = 579;
