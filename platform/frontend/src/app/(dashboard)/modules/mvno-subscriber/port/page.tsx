...
const ACCENT = "#6366f1";
const MODULE = "MVNO Subscriber Mgmt";
const PAGE = "Number Port";
const KPIS = [{"l":"Total Mvno Subscriber","v":"1.971","t":"-4.9%","d":"down"},{"l":"Number Port Ativos","v":"6.880","t":"+0.1%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"78","t":"-0.7%","d":"down"}];
const COLS = ["ID","Number Port","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mvno Subscriber #001","Mvno Subscriber #002","7.227","1.585","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Mvno Subscriber #002","Mvno Subscriber #003","134","3.200","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Mvno Subscriber #003","Mvno Subscriber #004","567","3.181","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Mvno Subscriber #004","Mvno Subscriber #005","313","2.846","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mvno Subscriber #005","Mvno Subscriber #001","2.014","2.364","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":545},{"label":"Mar","value":422},{"label":"Abr","value":557},{"label":"Mai","value":622},{"label":"Jun","value":581},{"label":"Jul","value":316},{"label":"Ago","value":331},{"label":"Set","value":517},{"label":"Out","value":430},{"label":"Nov","value":334},{"label":"Dez","value":431}];
const MX = 628;
