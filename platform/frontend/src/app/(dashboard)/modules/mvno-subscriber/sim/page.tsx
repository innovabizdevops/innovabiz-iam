...
const PAGE = "SIM Mgmt";
const KPIS = [{"l":"Total Mvno Subscriber","v":"8.287","t":"+14.3%","d":"up"},{"l":"SIM Mgmt Ativos","v":"1.394","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"93.6%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"90","t":"+13.9%","d":"up"}];
const COLS = ["ID","SIM Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mvno Subscriber #001","Mvno Subscriber #002","7.146","7.931","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Mvno Subscriber #002","Mvno Subscriber #003","1.528","8.428","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Mvno Subscriber #003","Mvno Subscriber #004","2.913","9.030","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Mvno Subscriber #004","Mvno Subscriber #005","7.287","403","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mvno Subscriber #005","Mvno Subscriber #001","4.043","3.891","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":402},{"label":"Fev","value":311},{"label":"Mar","value":248},{"label":"Abr","value":500},{"label":"Mai","value":265},{"label":"Jun","value":579},{"label":"Jul","value":553},{"label":"Ago","value":351},{"label":"Set","value":598},{"label":"Out","value":229},{"label":"Nov","value":508},{"label":"Dez","value":325}];
const MX = 598;
