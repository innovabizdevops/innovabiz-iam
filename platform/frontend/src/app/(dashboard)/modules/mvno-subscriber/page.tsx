...
export default function MvnoSubscriberPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Mvno Subscriber</h1><p className="text-sm text-muted-foreground">Mvno Subscriber • iBOS Enterprise</p></div>
