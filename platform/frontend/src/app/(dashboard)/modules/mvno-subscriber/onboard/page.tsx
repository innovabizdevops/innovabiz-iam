...
const PAGE = "Onboard";
const KPIS = [{"l":"eNPS","v":"64","t":"+7.8%","d":"up"},{"l":"Engagement (%)","v":"89.0%","t":"-3.4%","d":"down"},{"l":"Turnover (%)","v":"73.2%","t":"+13.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.438","t":"+4.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.522","2026-03-27","68","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.221","2026-02-24","92","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.224","2026-02-03","61","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.172","2026-03-04","91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.735","2026-01-01","72","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":425},{"label":"Fev","value":628},{"label":"Mar","value":368},{"label":"Abr","value":464},{"label":"Mai","value":372},{"label":"Jun","value":437},{"label":"Jul","value":372},{"label":"Ago","value":583},{"label":"Set","value":279},{"label":"Out","value":551},{"label":"Nov","value":606},{"label":"Dez","value":499}];
const MX = 628;
