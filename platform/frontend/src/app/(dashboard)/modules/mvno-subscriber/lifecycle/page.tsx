...
const KPIS = [{"l":"Total Mvno Subscriber","v":"6.901","t":"+4.4%","d":"up"},{"l":"Lifecycle Ativos","v":"8.141","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"66.5%","t":"+17.2%","d":"up"},{"l":"Score Performance","v":"67","t":"-2.0%","d":"down"}];
const COLS = ["ID","Lifecycle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mvno Subscriber #001","Mvno Subscriber #002","2.403","6.527","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Mvno Subscriber #002","Mvno Subscriber #003","5.076","5.856","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Mvno Subscriber #003","Mvno Subscriber #004","3.972","6.266","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Mvno Subscriber #004","Mvno Subscriber #005","2.459","8.677","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mvno Subscriber #005","Mvno Subscriber #001","8.786","4.364","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":329},{"label":"Fev","value":632},{"label":"Mar","value":620},{"label":"Abr","value":445},{"label":"Mai","value":521},{"label":"Jun","value":383},{"label":"Jul","value":444},{"label":"Ago","value":460},{"label":"Set","value":495},{"label":"Out","value":321},{"label":"Nov","value":616},{"label":"Dez","value":493}];
const MX = 632;
