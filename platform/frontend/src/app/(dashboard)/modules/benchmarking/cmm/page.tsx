...
const PAGE = "Capability Maturity CMM";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.004","t":"+1.3%","d":"up"},{"l":"NC Abertas","v":"6.220","t":"-2.6%","d":"down"},{"l":"Conformidade (%)","v":"88.8%","t":"+9.7%","d":"up"},{"l":"CAPAs Pendentes","v":"1.063","t":"+3.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.912","93.2%","7.298","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.590","93.4%","4.499","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.555","80.2%","8.287","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.838","97.4%","2.033","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.273","73.4%","3.014","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":966},{"label":"Fev","value":894},{"label":"Mar","value":743},{"label":"Abr","value":1017},{"label":"Mai","value":847},{"label":"Jun","value":725},{"label":"Jul","value":959},{"label":"Ago","value":916},{"label":"Set","value":785},{"label":"Out","value":880},{"label":"Nov","value":787},{"label":"Dez","value":896}];
const MX = 1017;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#be185d'}}>CMMI</span></h1>
                </div>
