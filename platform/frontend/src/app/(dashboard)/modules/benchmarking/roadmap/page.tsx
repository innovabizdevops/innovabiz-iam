...
const PAGE = "Improvement Roadmap";
const KPIS = [{"l":"Projetos Melhoria","v":"8.206","t":"-2.3%","d":"down"},{"l":"Savings (€)","v":"€5290","t":"+14.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"86.7%","t":"+16.7%","d":"up"},{"l":"Ciclos PDCA","v":"1.226","t":"+17.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.699","€ 33547.17","250","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.660","€ 16819.12","8.709","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.801","€ 19806.77","6.184","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.610","€ 23398.17","4.709","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.929","€ 35002.01","8.544","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":357},{"label":"Mar","value":552},{"label":"Abr","value":438},{"label":"Mai","value":455},{"label":"Jun","value":719},{"label":"Jul","value":424},{"label":"Ago","value":597},{"label":"Set","value":626},{"label":"Out","value":608},{"label":"Nov","value":685},{"label":"Dez","value":562}];
const MX = 719;
