...
const KPIS = [{"l":"Total Benchmarking","v":"4.528","t":"+12.5%","d":"up"},{"l":"ROI Calculator Ativos","v":"944","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"66.4%","t":"+15.9%","d":"up"},{"l":"Score Performance","v":"94","t":"+10.9%","d":"up"}];
const COLS = ["ID","ROI Calculator","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Benchmarking #001","Benchmarking #002","1.960","1.951","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Benchmarking #002","Benchmarking #003","8.002","9.015","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Benchmarking #003","Benchmarking #004","6.204","2.690","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Benchmarking #004","Benchmarking #005","2.539","6.092","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Benchmarking #005","Benchmarking #001","6.537","5.332","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":508},{"label":"Fev","value":367},{"label":"Mar","value":369},{"label":"Abr","value":279},{"label":"Mai","value":420},{"label":"Jun","value":329},{"label":"Jul","value":498},{"label":"Ago","value":626},{"label":"Set","value":599},{"label":"Out","value":377},{"label":"Nov","value":456},{"label":"Dez","value":456}];
const MX = 626;
