...
const PAGE = "Gap Analysis Engine";
const KPIS = [{"l":"Dashboards Ativos","v":"4.030","t":"-2.4%","d":"down"},{"l":"Queries/Dia","v":"4334","t":"+11.4%","d":"up"},{"l":"Dados Processados (GB)","v":"5.666","t":"+1.5%","d":"up"},{"l":"Utilizadores Analytics","v":"5.948","t":"+17.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4740","2026-03-02","668","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3600","2026-01-06","5.661","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3348","2026-02-22","2.432","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4620","2026-02-15","8.840","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2204","2026-01-28","6.732","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":425},{"label":"Fev","value":437},{"label":"Mar","value":451},{"label":"Abr","value":571},{"label":"Mai","value":257},{"label":"Jun","value":255},{"label":"Jul","value":581},{"label":"Ago","value":386},{"label":"Set","value":342},{"label":"Out","value":638},{"label":"Nov","value":520},{"label":"Dez","value":539}];
const MX = 638;
