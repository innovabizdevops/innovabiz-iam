...
const ACCENT = "#be185d";
const MODULE = "Benchmarking & Maturity";
const PAGE = "Industry Benchmark";
const KPIS = [{"l":"Total Benchmarking","v":"4.696","t":"-5.0%","d":"down"},{"l":"Industry Benchmark Ativos","v":"8.398","t":"+4.8%","d":"up"},{"l":"Eficiência (%)","v":"83.9%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"81","t":"+11.6%","d":"up"}];
const COLS = ["ID","Industry Benchmark","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Benchmarking #001","Benchmarking #002","8.217","547","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Benchmarking #002","Benchmarking #003","3.838","980","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Benchmarking #003","Benchmarking #004","2.538","373","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Benchmarking #004","Benchmarking #005","2.471","6.613","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Benchmarking #005","Benchmarking #001","2.439","7.476","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":282},{"label":"Mar","value":263},{"label":"Abr","value":283},{"label":"Mai","value":409},{"label":"Jun","value":536},{"label":"Jul","value":381},{"label":"Ago","value":323},{"label":"Set","value":510},{"label":"Out","value":429},{"label":"Nov","value":440},{"label":"Dez","value":315}];
const MX = 620;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#be185d'}}>APQC</span></h1>
                </div>
