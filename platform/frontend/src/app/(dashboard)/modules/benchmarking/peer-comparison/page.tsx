...
const PAGE = "Peer Comparison AI";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.993","t":"+10.7%","d":"up"},{"l":"NC Abertas","v":"6.314","t":"-4.3%","d":"down"},{"l":"Conformidade (%)","v":"86.1%","t":"+14.1%","d":"up"},{"l":"CAPAs Pendentes","v":"7.922","t":"+5.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.708","91.8%","8.872","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","823","95.0%","4.488","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.404","83.1%","1.073","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.553","91.5%","4.618","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.752","81.2%","4.227","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":834},{"label":"Mar","value":821},{"label":"Abr","value":597},{"label":"Mai","value":906},{"label":"Jun","value":702},{"label":"Jul","value":669},{"label":"Ago","value":648},{"label":"Set","value":929},{"label":"Out","value":858},{"label":"Nov","value":614},{"label":"Dez","value":749}];
const MX = 929;
