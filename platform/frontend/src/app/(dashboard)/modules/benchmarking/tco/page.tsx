...
const PAGE = "TCO Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"575","t":"+14.7%","d":"up"},{"l":"Queries/Dia","v":"918","t":"-3.3%","d":"down"},{"l":"Dados Processados (GB)","v":"5.109","t":"-2.6%","d":"down"},{"l":"Utilizadores Analytics","v":"8.943","t":"+-0.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4886","2026-01-10","7.747","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1230","2026-03-08","6.232","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4962","2026-01-10","1.863","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1601","2026-01-24","8.457","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3738","2026-01-25","5.826","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":699},{"label":"Mar","value":453},{"label":"Abr","value":549},{"label":"Mai","value":411},{"label":"Jun","value":443},{"label":"Jul","value":732},{"label":"Ago","value":569},{"label":"Set","value":575},{"label":"Out","value":424},{"label":"Nov","value":705},{"label":"Dez","value":558}];
const MX = 732;
