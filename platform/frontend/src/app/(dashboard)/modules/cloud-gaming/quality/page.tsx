...
const PAGE = "Quality Adapt";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.437","t":"+15.2%","d":"up"},{"l":"NC Abertas","v":"696","t":"+10.0%","d":"up"},{"l":"Conformidade (%)","v":"84.2%","t":"+10.3%","d":"up"},{"l":"CAPAs Pendentes","v":"3.406","t":"-3.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.373","74.5%","3.231","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.874","88.6%","3.151","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","572","82.6%","5.722","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.501","86.1%","971","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.175","95.4%","6.797","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":781},{"label":"Mar","value":634},{"label":"Abr","value":533},{"label":"Mai","value":789},{"label":"Jun","value":582},{"label":"Jul","value":697},{"label":"Ago","value":819},{"label":"Set","value":602},{"label":"Out","value":434},{"label":"Nov","value":507},{"label":"Dez","value":529}];
const MX = 819;
