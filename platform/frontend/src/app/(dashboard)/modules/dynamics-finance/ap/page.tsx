...
const ACCENT = "#00bcf2";
const MODULE = "Finance Hub (D365)";
const PAGE = "AP";
const KPIS = [{"l":"Total Dynamics Finance","v":"8.519","t":"+5.1%","d":"up"},{"l":"AP Ativos","v":"7.327","t":"+6.0%","d":"up"},{"l":"Eficiência (%)","v":"81.2%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"75","t":"-2.9%","d":"down"}];
const COLS = ["ID","AP","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dynamics Finance #001","Dynamics Finance #002","2.386","7.586","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Dynamics Finance #002","Dynamics Finance #003","2.034","3.513","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Dynamics Finance #003","Dynamics Finance #004","628","2.222","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Dynamics Finance #004","Dynamics Finance #005","866","3.906","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dynamics Finance #005","Dynamics Finance #001","2.252","5.965","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1038},{"label":"Fev","value":818},{"label":"Mar","value":799},{"label":"Abr","value":1017},{"label":"Mai","value":785},{"label":"Jun","value":727},{"label":"Jul","value":964},{"label":"Ago","value":745},{"label":"Set","value":1045},{"label":"Out","value":708},{"label":"Nov","value":865},{"label":"Dez","value":943}];
const MX = 1045;
