...
const PAGE = "Budget";
const KPIS = [{"l":"Total Dynamics Finance","v":"1.021","t":"+13.2%","d":"up"},{"l":"Budget Ativos","v":"€95025","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"69.6%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"72","t":"-1.5%","d":"down"}];
const COLS = ["ID","Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dynamics Finance #001","€ 28875.45","3.602","5.489","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Dynamics Finance #002","€ 10404.09","7.979","2.197","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Dynamics Finance #003","€ 32219.69","3.435","4.294","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Dynamics Finance #004","€ 49823.94","8.949","4.028","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dynamics Finance #005","€ 4566.64","7.362","4.947","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":791},{"label":"Fev","value":991},{"label":"Mar","value":1046},{"label":"Abr","value":699},{"label":"Mai","value":719},{"label":"Jun","value":755},{"label":"Jul","value":865},{"label":"Ago","value":731},{"label":"Set","value":752},{"label":"Out","value":821},{"label":"Nov","value":681},{"label":"Dez","value":1063}];
const MX = 1063;
