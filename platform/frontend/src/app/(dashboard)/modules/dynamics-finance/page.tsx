...
/* ═══ Finance Hub (D365) — Dashboard ═══ */

const ACCENT = "#00bcf2";

const KPIS = [
    { label: "Total Registos", value: "4344", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1729", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€43K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "946553144", cells: ["DYN-6144", "Finance Hub (D365) Item 1", "13/9/2026", "€3244"], status: "active" as const },
    { id: "946556715", cells: ["DYN-9715", "Finance Hub (D365) Item 2", "28/4/2026", "€6815"], status: "pending" as const },
    { id: "946560286", cells: ["DYN-4286", "Finance Hub (D365) Item 3", "15/11/2026", "€10 386"], status: "completed" as const },
    { id: "946563857", cells: ["DYN-7857", "Finance Hub (D365) Item 4", "2/6/2026", "€13 957"], status: "warning" as const },
    { id: "946567428", cells: ["DYN-2428", "Finance Hub (D365) Item 5", "17/1/2026", "€17 528"], status: "active" as const },
];
...
export default function FinanceHubD365Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Finance Hub (D365)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Finance Hub (D365)</p>
                    </div>
                </div>
