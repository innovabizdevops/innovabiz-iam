...
const KPIS = [{"l":"Formulários Ativos","v":"140","t":"+3.6%","d":"up"},{"l":"Submissões/Dia","v":"4375","t":"+3.1%","d":"up"},{"l":"Documentos Gerados","v":"5.183","t":"+6.2%","d":"up"},{"l":"Templates","v":"8.138","t":"+13.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.504","2026-02-04","8.723","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","619","2026-02-21","970","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.745","2026-03-12","7.179","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.434","2026-03-09","5.161","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.488","2026-02-02","7.707","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":389},{"label":"Fev","value":363},{"label":"Mar","value":356},{"label":"Abr","value":614},{"label":"Mai","value":394},{"label":"Jun","value":346},{"label":"Jul","value":662},{"label":"Ago","value":696},{"label":"Set","value":425},{"label":"Out","value":564},{"label":"Nov","value":670},{"label":"Dez","value":676}];
const MX = 696;
