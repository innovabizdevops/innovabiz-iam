...
const ACCENT = "#7c3aed";
const MODULE = "E-Learning Platform";
const PAGE = "Course Builder";
const KPIS = [{"l":"Formulários Ativos","v":"1.023","t":"+0.1%","d":"up"},{"l":"Submissões/Dia","v":"4372","t":"-1.6%","d":"down"},{"l":"Documentos Gerados","v":"1.671","t":"+16.5%","d":"up"},{"l":"Templates","v":"7.685","t":"+2.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.917","2026-02-22","1.126","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.242","2026-01-25","5.341","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","288","2026-03-01","4.037","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.050","2026-02-11","6.688","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.176","2026-03-18","7.643","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":557},{"label":"Mar","value":566},{"label":"Abr","value":904},{"label":"Mai","value":679},{"label":"Jun","value":782},{"label":"Jul","value":643},{"label":"Ago","value":698},{"label":"Set","value":863},{"label":"Out","value":854},{"label":"Nov","value":855},{"label":"Dez","value":914}];
const MX = 914;
