...
const KPIS = [{"l":"Formulários Ativos","v":"3.770","t":"-1.3%","d":"down"},{"l":"Submissões/Dia","v":"2875","t":"+6.0%","d":"up"},{"l":"Documentos Gerados","v":"5.887","t":"+0.6%","d":"up"},{"l":"Templates","v":"5.828","t":"+3.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.615","2026-02-19","2.762","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.568","2026-03-18","8.968","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","767","2026-02-12","1.166","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.090","2026-02-10","3.231","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.822","2026-01-20","1.323","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":651},{"label":"Mar","value":675},{"label":"Abr","value":826},{"label":"Mai","value":793},{"label":"Jun","value":548},{"label":"Jul","value":493},{"label":"Ago","value":694},{"label":"Set","value":644},{"label":"Out","value":587},{"label":"Nov","value":798},{"label":"Dez","value":843}];
const MX = 843;
