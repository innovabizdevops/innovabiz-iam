...
const PAGE = "Video Lessons";
const KPIS = [{"l":"Utilizadores Ativos","v":"8.460","t":"-3.5%","d":"down"},{"l":"Sessões/Dia","v":"2826","t":"-3.5%","d":"down"},{"l":"MFA Adoção (%)","v":"94.9%","t":"+6.6%","d":"up"},{"l":"Tentativas Bloqueadas","v":"4.395","t":"+1.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.235","5.976","6.411","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","4.013","7.580","3.851","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.113","2.132","770","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.235","3.967","1.252","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","3.741","4.883","227","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":681},{"label":"Mar","value":614},{"label":"Abr","value":539},{"label":"Mai","value":492},{"label":"Jun","value":705},{"label":"Jul","value":674},{"label":"Ago","value":543},{"label":"Set","value":808},{"label":"Out","value":636},{"label":"Nov","value":830},{"label":"Dez","value":689}];
const MX = 830;
