...
const KPIS = [{"l":"Formulários Ativos","v":"3.808","t":"+13.1%","d":"up"},{"l":"Submissões/Dia","v":"1752","t":"+8.3%","d":"up"},{"l":"Documentos Gerados","v":"5.905","t":"+5.6%","d":"up"},{"l":"Templates","v":"2.423","t":"+13.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.518","2026-01-15","499","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.371","2026-03-19","2.319","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.611","2026-03-22","506","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.486","2026-01-27","2.928","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.961","2026-01-01","8.301","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":669},{"label":"Mar","value":386},{"label":"Abr","value":539},{"label":"Mai","value":663},{"label":"Jun","value":358},{"label":"Jul","value":607},{"label":"Ago","value":456},{"label":"Set","value":465},{"label":"Out","value":571},{"label":"Nov","value":538},{"label":"Dez","value":453}];
const MX = 669;
