...
const PAGE = "Rating";
const KPIS = [{"l":"Surveys Ativos","v":"203","t":"-2.2%","d":"down"},{"l":"Respostas/Semana","v":"2270","t":"+1.9%","d":"up"},{"l":"NPS Médio","v":"74","t":"+15.8%","d":"up"},{"l":"Taxa Resposta (%)","v":"92.2%","t":"-2.8%","d":"down"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","1.677","77","98.2%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","3.058","57","88.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","8.535","70","81.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","1.342","57","96.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","2.492","69","71.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":895},{"label":"Fev","value":647},{"label":"Mar","value":738},{"label":"Abr","value":1003},{"label":"Mai","value":1002},{"label":"Jun","value":809},{"label":"Jul","value":708},{"label":"Ago","value":938},{"label":"Set","value":889},{"label":"Out","value":898},{"label":"Nov","value":668},{"label":"Dez","value":1032}];
const MX = 1032;
