...
const PAGE = "Issuance";
const KPIS = [{"l":"Total Green Bond Mgmt","v":"4.400","t":"+8.0%","d":"up"},{"l":"Issuance Ativos","v":"7.496","t":"+11.4%","d":"up"},{"l":"Eficiência (%)","v":"73.6%","t":"+4.3%","d":"up"},{"l":"Score Performance","v":"90","t":"+17.6%","d":"up"}];
const COLS = ["ID","Issuance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Green Bond Mgmt #001","Green Bond Mgmt #002","3.560","1.464","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Green Bond Mgmt #002","Green Bond Mgmt #003","8.286","594","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Green Bond Mgmt #003","Green Bond Mgmt #004","6.893","1.073","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Green Bond Mgmt #004","Green Bond Mgmt #005","4.574","4.589","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Green Bond Mgmt #005","Green Bond Mgmt #001","862","8.896","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":614},{"label":"Mar","value":662},{"label":"Abr","value":464},{"label":"Mai","value":663},{"label":"Jun","value":463},{"label":"Jul","value":736},{"label":"Ago","value":479},{"label":"Set","value":642},{"label":"Out","value":467},{"label":"Nov","value":727},{"label":"Dez","value":581}];
const MX = 736;
