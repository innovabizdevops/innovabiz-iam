...
const PAGE = "Impact";
const KPIS = [{"l":"Projetos Sociais","v":"5.641","t":"+11.8%","d":"up"},{"l":"Beneficiários","v":"4.502","t":"-4.3%","d":"down"},{"l":"Investimento CSR (€)","v":"€84663","t":"+-0.0%","d":"up"},{"l":"Score Impacto","v":"79","t":"+3.9%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","3.370","€ 48035.60","1.981","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.522","€ 49385.45","5.327","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","8.396","€ 33602.75","969","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","8.963","€ 11227.10","2.561","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","7.344","€ 16294.07","1.840","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":548},{"label":"Mar","value":331},{"label":"Abr","value":222},{"label":"Mai","value":226},{"label":"Jun","value":593},{"label":"Jul","value":307},{"label":"Ago","value":573},{"label":"Set","value":274},{"label":"Out","value":564},{"label":"Nov","value":492},{"label":"Dez","value":276}];
const MX = 593;
