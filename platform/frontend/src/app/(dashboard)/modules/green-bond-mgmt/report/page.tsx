...
const PAGE = "Report";
const KPIS = [{"l":"Total Green Bond Mgmt","v":"5.632","t":"+14.9%","d":"up"},{"l":"Report Ativos","v":"7.719","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"93.0%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"66","t":"+14.8%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Green Bond Mgmt #001","Green Bond Mgmt #002","4.637","7.124","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Green Bond Mgmt #002","Green Bond Mgmt #003","2.403","369","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Green Bond Mgmt #003","Green Bond Mgmt #004","916","3.797","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Green Bond Mgmt #004","Green Bond Mgmt #005","8.304","1.995","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Green Bond Mgmt #005","Green Bond Mgmt #001","4.577","2.799","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":736},{"label":"Mar","value":612},{"label":"Abr","value":692},{"label":"Mai","value":850},{"label":"Jun","value":765},{"label":"Jul","value":730},{"label":"Ago","value":790},{"label":"Set","value":644},{"label":"Out","value":857},{"label":"Nov","value":689},{"label":"Dez","value":844}];
const MX = 857;
