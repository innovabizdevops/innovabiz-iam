...
const ACCENT = "#6366f1";
const MODULE = "Green Bond Mgmt";
const PAGE = "Use of Proc";
const KPIS = [{"l":"Total Green Bond Mgmt","v":"1.998","t":"+0.6%","d":"up"},{"l":"Use Of Proc Ativos","v":"510","t":"+3.3%","d":"up"},{"l":"Eficiência (%)","v":"80.8%","t":"-0.9%","d":"down"},{"l":"Score Performance","v":"58","t":"+17.1%","d":"up"}];
const COLS = ["ID","Use Of Proc","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Green Bond Mgmt #001","Green Bond Mgmt #002","3.275","4.629","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Green Bond Mgmt #002","Green Bond Mgmt #003","2.702","3.756","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Green Bond Mgmt #003","Green Bond Mgmt #004","5.867","8.593","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Green Bond Mgmt #004","Green Bond Mgmt #005","1.595","8.755","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Green Bond Mgmt #005","Green Bond Mgmt #001","8.492","3.216","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":846},{"label":"Fev","value":923},{"label":"Mar","value":1002},{"label":"Abr","value":706},{"label":"Mai","value":885},{"label":"Jun","value":705},{"label":"Jul","value":740},{"label":"Ago","value":987},{"label":"Set","value":888},{"label":"Out","value":793},{"label":"Nov","value":889},{"label":"Dez","value":1033}];
const MX = 1033;
