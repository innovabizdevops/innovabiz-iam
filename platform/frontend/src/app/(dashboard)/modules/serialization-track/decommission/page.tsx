...
const KPIS = [{"l":"Vendas YTD (€)","v":"€83742","t":"-1.6%","d":"down"},{"l":"Pipeline (€)","v":"€60409","t":"+7.6%","d":"up"},{"l":"Atingimento Quota (%)","v":"75.6%","t":"+11.9%","d":"up"},{"l":"Win Rate (%)","v":"93.5%","t":"+3.1%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 48029.38","€ 3537.96","€ 31917.44","95.1%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 20711.98","€ 9053.43","€ 21544.45","95.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 22307.69","€ 16064.96","€ 36002.09","92.5%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 49001.58","€ 10678.07","€ 35373.38","84.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 10685.14","€ 46638.30","€ 25164.82","83.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":981},{"label":"Fev","value":1019},{"label":"Mar","value":904},{"label":"Abr","value":657},{"label":"Mai","value":964},{"label":"Jun","value":740},{"label":"Jul","value":794},{"label":"Ago","value":781},{"label":"Set","value":1006},{"label":"Out","value":882},{"label":"Nov","value":836},{"label":"Dez","value":696}];
const MX = 1019;
