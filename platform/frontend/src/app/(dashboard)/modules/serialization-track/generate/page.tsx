...
const ACCENT = "#0e7490";
const MODULE = "Serialization Track";
const PAGE = "Serial Generate";
const KPIS = [{"l":"Total Serialization Track","v":"7.968","t":"+17.3%","d":"up"},{"l":"Serial Generate Ativos","v":"1.886","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"69.6%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"77","t":"+2.8%","d":"up"}];
const COLS = ["ID","Serial Generate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Serialization Track #001","Serialization Track #002","2.456","141","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Serialization Track #002","Serialization Track #003","4.407","8.742","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Serialization Track #003","Serialization Track #004","927","5.438","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Serialization Track #004","Serialization Track #005","277","3.845","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Serialization Track #005","Serialization Track #001","8.709","3.886","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":757},{"label":"Mar","value":784},{"label":"Abr","value":681},{"label":"Mai","value":632},{"label":"Jun","value":571},{"label":"Jul","value":585},{"label":"Ago","value":646},{"label":"Set","value":650},{"label":"Out","value":465},{"label":"Nov","value":729},{"label":"Dez","value":820}];
const MX = 820;
