...
const KPIS = [{"l":"Vendas YTD (€)","v":"€61336","t":"+4.0%","d":"up"},{"l":"Pipeline (€)","v":"€28925","t":"+14.8%","d":"up"},{"l":"Atingimento Quota (%)","v":"83.6%","t":"+9.4%","d":"up"},{"l":"Win Rate (%)","v":"87.3%","t":"-0.9%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 7858.95","€ 47398.70","€ 37670.38","94.8%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 15179.71","€ 16366.96","€ 47122.17","87.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 31398.25","€ 4800.21","€ 2465.52","75.4%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 46552.71","€ 44092.01","€ 27025.66","75.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 4595.28","€ 39949.63","€ 47636.54","77.1%"],"status":"active"}];
const CHART = [{"label":"Jan","value":838},{"label":"Fev","value":619},{"label":"Mar","value":575},{"label":"Abr","value":695},{"label":"Mai","value":620},{"label":"Jun","value":677},{"label":"Jul","value":738},{"label":"Ago","value":479},{"label":"Set","value":544},{"label":"Out","value":486},{"label":"Nov","value":740},{"label":"Dez","value":832}];
const MX = 838;
