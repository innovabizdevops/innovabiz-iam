...
const KPIS = [{"l":"ARR (€M)","v":"€12.0M","t":"+12.5%","d":"up"},{"l":"MRR (€)","v":"€51970","t":"+2.1%","d":"up"},{"l":"Churn (%)","v":"65.8%","t":"+17.6%","d":"up"},{"l":"ARPU (€)","v":"€27593","t":"-5.6%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 15956.71","2.927","€ 12556.44","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 14987.54","5.957","€ 14535.63","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 37203.40","1.754","€ 28397.82","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 48281.39","2.801","€ 8215.91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 31292.38","4.882","€ 21823.73","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":406},{"label":"Fev","value":514},{"label":"Mar","value":634},{"label":"Abr","value":690},{"label":"Mai","value":710},{"label":"Jun","value":663},{"label":"Jul","value":656},{"label":"Ago","value":541},{"label":"Set","value":351},{"label":"Out","value":335},{"label":"Nov","value":335},{"label":"Dez","value":485}];
const MX = 710;
