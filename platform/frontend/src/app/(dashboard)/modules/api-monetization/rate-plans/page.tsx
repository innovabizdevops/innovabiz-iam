...
const PAGE = "Rate Plans";
const KPIS = [{"l":"ARR (€M)","v":"€45.2M","t":"-0.4%","d":"down"},{"l":"MRR (€)","v":"€81435","t":"+0.6%","d":"up"},{"l":"Churn (%)","v":"83.9%","t":"-2.4%","d":"down"},{"l":"ARPU (€)","v":"€9091","t":"+6.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 8815.89","938","€ 47843.14","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 13157.72","1.941","€ 39433.18","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 33875.58","5.395","€ 30352.89","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 7336.72","8.230","€ 9425.31","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 30494.01","1.398","€ 49853.49","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":772},{"label":"Mar","value":718},{"label":"Abr","value":781},{"label":"Mai","value":573},{"label":"Jun","value":562},{"label":"Jul","value":438},{"label":"Ago","value":778},{"label":"Set","value":584},{"label":"Out","value":670},{"label":"Nov","value":473},{"label":"Dez","value":629}];
const MX = 781;
