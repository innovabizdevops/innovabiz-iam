...
const KPIS = [{"l":"ARR (€M)","v":"€18.0M","t":"-4.5%","d":"down"},{"l":"MRR (€)","v":"€40757","t":"+12.7%","d":"up"},{"l":"Churn (%)","v":"87.1%","t":"+8.2%","d":"up"},{"l":"ARPU (€)","v":"€46666","t":"+14.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 28825.57","6.960","€ 35665.26","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 24089.06","2.767","€ 25829.08","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 2571.05","361","€ 34428.07","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 37586.73","8.011","€ 34720.84","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 18385.75","1.372","€ 14008.18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":532},{"label":"Mar","value":545},{"label":"Abr","value":535},{"label":"Mai","value":741},{"label":"Jun","value":385},{"label":"Jul","value":734},{"label":"Ago","value":740},{"label":"Set","value":480},{"label":"Out","value":761},{"label":"Nov","value":618},{"label":"Dez","value":599}];
const MX = 761;
