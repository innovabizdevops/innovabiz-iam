...
const PAGE = "API Products";
const KPIS = [{"l":"ARR (€M)","v":"€11.0M","t":"+10.3%","d":"up"},{"l":"MRR (€)","v":"€89688","t":"+9.1%","d":"up"},{"l":"Churn (%)","v":"75.9%","t":"+7.9%","d":"up"},{"l":"ARPU (€)","v":"€80887","t":"+13.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 42574.61","4.186","€ 7393.19","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 19498.82","5.476","€ 24414.53","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 42837.00","8.943","€ 40046.90","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 33103.60","5.997","€ 46957.89","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 17705.60","8.230","€ 34828.18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":776},{"label":"Mar","value":780},{"label":"Abr","value":699},{"label":"Mai","value":664},{"label":"Jun","value":763},{"label":"Jul","value":939},{"label":"Ago","value":726},{"label":"Set","value":887},{"label":"Out","value":657},{"label":"Nov","value":916},{"label":"Dez","value":919}];
const MX = 939;
