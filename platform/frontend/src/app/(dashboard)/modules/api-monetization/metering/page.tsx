...
const KPIS = [{"l":"ARR (€M)","v":"€6.7M","t":"+12.9%","d":"up"},{"l":"MRR (€)","v":"€36850","t":"+15.8%","d":"up"},{"l":"Churn (%)","v":"93.7%","t":"-1.7%","d":"down"},{"l":"ARPU (€)","v":"€2104","t":"+4.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 46065.09","1.827","€ 44046.54","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 35145.35","6.606","€ 34282.05","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 44357.47","4.536","€ 42742.11","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 45034.47","6.101","€ 19754.08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 10352.89","7.924","€ 19819.41","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":892},{"label":"Fev","value":788},{"label":"Mar","value":623},{"label":"Abr","value":678},{"label":"Mai","value":613},{"label":"Jun","value":559},{"label":"Jul","value":825},{"label":"Ago","value":707},{"label":"Set","value":768},{"label":"Out","value":675},{"label":"Nov","value":545},{"label":"Dez","value":864}];
const MX = 892;
