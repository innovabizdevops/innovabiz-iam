...
const ACCENT = "#059669";
const MODULE = "API Monetization";
const PAGE = "Sandbox Environment";
const KPIS = [{"l":"ARR (€M)","v":"€24.2M","t":"-5.5%","d":"down"},{"l":"MRR (€)","v":"€31203","t":"+17.8%","d":"up"},{"l":"Churn (%)","v":"75.3%","t":"+12.7%","d":"up"},{"l":"ARPU (€)","v":"€58735","t":"-3.7%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 23396.27","8.987","€ 23553.11","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 47351.84","2.994","€ 39443.20","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 45316.93","4.367","€ 42585.19","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 3956.66","507","€ 49670.11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 40619.53","6.230","€ 41687.89","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":317},{"label":"Fev","value":365},{"label":"Mar","value":312},{"label":"Abr","value":509},{"label":"Mai","value":377},{"label":"Jun","value":313},{"label":"Jul","value":524},{"label":"Ago","value":618},{"label":"Set","value":323},{"label":"Out","value":325},{"label":"Nov","value":617},{"label":"Dez","value":366}];
const MX = 618;
