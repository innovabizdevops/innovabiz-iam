...
/* ═══ BioTech Research — Genome Editor ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "4089", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "7", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2962", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "268689171", cells: ["BIO-4171", "Genome Editor Item 1", "24/4/2026", "€39 271"], status: "active" as const },
    { id: "268692742", cells: ["BIO-7742", "Genome Editor Item 2", "11/11/2026", "€42 842"], status: "pending" as const },
    { id: "268696313", cells: ["BIO-2313", "Genome Editor Item 3", "26/6/2026", "€46 413"], status: "completed" as const },
    { id: "268699884", cells: ["BIO-5884", "Genome Editor Item 4", "13/1/2026", "€49 984"], status: "warning" as const },
    { id: "268703455", cells: ["BIO-9455", "Genome Editor Item 5", "28/8/2026", "€3555"], status: "active" as const },
];
...
export default function BiotechResearchGenomeEditorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Genome Editor</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">BioTech Research • Genome Editor</p>
                    </div>
                </div>
