...
/* ═══ BioTech Research — Antibody Eng ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "2214", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "127", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3572", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "474218299", cells: ["BIO-9299", "Antibody Eng Item 1", "24/8/2026", "€18 399"], status: "active" as const },
    { id: "474221870", cells: ["BIO-3870", "Antibody Eng Item 2", "11/3/2026", "€21 970"], status: "pending" as const },
    { id: "474225441", cells: ["BIO-7441", "Antibody Eng Item 3", "26/10/2026", "€25 541"], status: "completed" as const },
    { id: "474229012", cells: ["BIO-2012", "Antibody Eng Item 4", "13/5/2026", "€29 112"], status: "warning" as const },
    { id: "474232583", cells: ["BIO-5583", "Antibody Eng Item 5", "28/12/2026", "€32 683"], status: "active" as const },
];
...
export default function BiotechResearchAntibodyEngPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Antibody Eng</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">BioTech Research • Antibody Eng</p>
                    </div>
                </div>
