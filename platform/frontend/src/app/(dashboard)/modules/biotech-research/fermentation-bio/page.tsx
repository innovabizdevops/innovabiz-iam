...
/* ═══ BioTech Research — Fermentation Bio ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "1303", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "387", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3394", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "86%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1322137999", cells: ["BIO-2999", "Fermentation Bio Item 1", "8/8/2026", "€38 099"], status: "active" as const },
    { id: "1322141570", cells: ["BIO-6570", "Fermentation Bio Item 2", "23/3/2026", "€41 670"], status: "pending" as const },
    { id: "1322145141", cells: ["BIO-1141", "Fermentation Bio Item 3", "10/10/2026", "€45 241"], status: "completed" as const },
    { id: "1322148712", cells: ["BIO-4712", "Fermentation Bio Item 4", "25/5/2026", "€48 812"], status: "warning" as const },
    { id: "1322152283", cells: ["BIO-8283", "Fermentation Bio Item 5", "12/12/2026", "€2383"], status: "active" as const },
];
...
export default function BiotechResearchFermentationBioPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fermentation Bio</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">BioTech Research • Fermentation Bio</p>
                    </div>
                </div>
