...
/* ═══ BioTech Research — Stability Study ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "2128", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "85", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3254", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1661987473", cells: ["BIO-3473", "Stability Study Item 1", "14/2/2026", "€37 573"], status: "active" as const },
    { id: "1661991044", cells: ["BIO-7044", "Stability Study Item 2", "1/9/2026", "€41 144"], status: "pending" as const },
    { id: "1661994615", cells: ["BIO-1615", "Stability Study Item 3", "16/4/2026", "€44 715"], status: "completed" as const },
    { id: "1661998186", cells: ["BIO-5186", "Stability Study Item 4", "3/11/2026", "€48 286"], status: "warning" as const },
    { id: "1662001757", cells: ["BIO-8757", "Stability Study Item 5", "18/6/2026", "€1857"], status: "active" as const },
];
...
export default function BiotechResearchStabilityStudyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Stability Study</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">BioTech Research • Stability Study</p>
                    </div>
                </div>
