...
/* ═══ BioTech Research — Bioreactor Ctrl ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "1603", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "198", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2417", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "79%", trend: "-15%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1563432882", cells: ["BIO-7882", "Bioreactor Ctrl Item 1", "19/7/2026", "€32 982"], status: "active" as const },
    { id: "1563436453", cells: ["BIO-2453", "Bioreactor Ctrl Item 2", "6/2/2026", "€36 553"], status: "pending" as const },
    { id: "1563440024", cells: ["BIO-6024", "Bioreactor Ctrl Item 3", "21/9/2026", "€40 124"], status: "completed" as const },
    { id: "1563443595", cells: ["BIO-9595", "Bioreactor Ctrl Item 4", "8/4/2026", "€43 695"], status: "warning" as const },
    { id: "1563447166", cells: ["BIO-4166", "Bioreactor Ctrl Item 5", "23/11/2026", "€47 266"], status: "active" as const },
];
...
export default function BiotechResearchBioreactorCtrlPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Bioreactor Ctrl</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">BioTech Research • Bioreactor Ctrl</p>
                    </div>
                </div>
