...
/* ═══ BioTech Research — Analytical Dev ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "2063", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "260", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "585", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "709460816", cells: ["BIO-9816", "Analytical Dev Item 1", "9/9/2026", "€10 916"], status: "active" as const },
    { id: "709464387", cells: ["BIO-4387", "Analytical Dev Item 2", "24/4/2026", "€14 487"], status: "pending" as const },
    { id: "709467958", cells: ["BIO-7958", "Analytical Dev Item 3", "11/11/2026", "€18 058"], status: "completed" as const },
    { id: "709471529", cells: ["BIO-2529", "Analytical Dev Item 4", "26/6/2026", "€21 629"], status: "warning" as const },
    { id: "709475100", cells: ["BIO-6100", "Analytical Dev Item 5", "13/1/2026", "€25 200"], status: "active" as const },
];
...
export default function BiotechResearchAnalyticalDevPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Analytical Dev</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">BioTech Research • Analytical Dev</p>
                    </div>
                </div>
