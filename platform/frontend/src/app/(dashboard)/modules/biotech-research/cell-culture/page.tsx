...
/* ═══ BioTech Research — Cell Culture ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "1445", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "439", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2289", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "241769203", cells: ["BIO-3203", "Cell Culture Item 1", "12/8/2026", "€19 303"], status: "active" as const },
    { id: "241772774", cells: ["BIO-6774", "Cell Culture Item 2", "27/3/2026", "€22 874"], status: "pending" as const },
    { id: "241776345", cells: ["BIO-1345", "Cell Culture Item 3", "14/10/2026", "€26 445"], status: "completed" as const },
    { id: "241779916", cells: ["BIO-4916", "Cell Culture Item 4", "1/5/2026", "€30 016"], status: "warning" as const },
    { id: "241783487", cells: ["BIO-8487", "Cell Culture Item 5", "16/12/2026", "€33 587"], status: "active" as const },
];
...
export default function BiotechResearchCellCulturePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cell Culture</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">BioTech Research • Cell Culture</p>
                    </div>
                </div>
