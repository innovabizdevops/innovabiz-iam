...
/* ═══ BioTech Research — Downstream Process ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "4101", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "320", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3900", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "448289100", cells: ["BIO-9100", "Downstream Process Item 1", "1/1/2026", "€39 200"], status: "active" as const },
    { id: "448292671", cells: ["BIO-3671", "Downstream Process Item 2", "16/8/2026", "€42 771"], status: "pending" as const },
    { id: "448296242", cells: ["BIO-7242", "Downstream Process Item 3", "3/3/2026", "€46 342"], status: "completed" as const },
    { id: "448299813", cells: ["BIO-1813", "Downstream Process Item 4", "18/10/2026", "€49 913"], status: "warning" as const },
    { id: "448303384", cells: ["BIO-5384", "Downstream Process Item 5", "5/5/2026", "€3484"], status: "active" as const },
];
...
export default function BiotechResearchDownstreamProcessPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Downstream Process</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">BioTech Research • Downstream Process</p>
                    </div>
                </div>
