...
/* ═══ BioTech Research — Regulatory Submit ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "732", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "71", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2159", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "601142659", cells: ["BIO-6659", "Regulatory Submit Item 1", "20/8/2026", "€42 759"], status: "active" as const },
    { id: "601146230", cells: ["BIO-1230", "Regulatory Submit Item 2", "7/3/2026", "€46 330"], status: "pending" as const },
    { id: "601149801", cells: ["BIO-4801", "Regulatory Submit Item 3", "22/10/2026", "€49 901"], status: "completed" as const },
    { id: "601153372", cells: ["BIO-8372", "Regulatory Submit Item 4", "9/5/2026", "€3472"], status: "warning" as const },
    { id: "601156943", cells: ["BIO-2943", "Regulatory Submit Item 5", "24/12/2026", "€7043"], status: "active" as const },
];
...
export default function BiotechResearchRegulatorySubmitPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Regulatory Submit</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">BioTech Research • Regulatory Submit</p>
                    </div>
                </div>
