...
/* ═══ BioTech Research — Formulation Dev ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total", value: "4031", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "400", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3649", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1629612876", cells: ["BIO-1876", "Formulation Dev Item 1", "25/1/2026", "€12 976"], status: "active" as const },
    { id: "1629616447", cells: ["BIO-5447", "Formulation Dev Item 2", "12/8/2026", "€16 547"], status: "pending" as const },
    { id: "1629620018", cells: ["BIO-9018", "Formulation Dev Item 3", "27/3/2026", "€20 118"], status: "completed" as const },
    { id: "1629623589", cells: ["BIO-3589", "Formulation Dev Item 4", "14/10/2026", "€23 689"], status: "warning" as const },
    { id: "1629627160", cells: ["BIO-7160", "Formulation Dev Item 5", "1/5/2026", "€27 260"], status: "active" as const },
];
...
export default function BiotechResearchFormulationDevPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Formulation Dev</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">BioTech Research • Formulation Dev</p>
                    </div>
                </div>
