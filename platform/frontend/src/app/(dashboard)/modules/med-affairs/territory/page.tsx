...
const PAGE = "MSL Territory";
const KPIS = [{"l":"Vendas YTD (€)","v":"€95493","t":"+15.9%","d":"up"},{"l":"Pipeline (€)","v":"€37258","t":"+15.4%","d":"up"},{"l":"Atingimento Quota (%)","v":"81.5%","t":"+0.0%","d":"up"},{"l":"Win Rate (%)","v":"65.8%","t":"+6.5%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 29481.49","€ 3561.80","€ 26948.31","71.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 17974.17","€ 9865.90","€ 33501.02","70.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 5134.37","€ 44172.25","€ 20846.08","88.6%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 6419.55","€ 25732.95","€ 22487.47","78.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 37950.07","€ 28062.10","€ 23110.97","73.4%"],"status":"active"}];
const CHART = [{"label":"Jan","value":477},{"label":"Fev","value":551},{"label":"Mar","value":692},{"label":"Abr","value":392},{"label":"Mai","value":678},{"label":"Jun","value":434},{"label":"Jul","value":490},{"label":"Ago","value":746},{"label":"Set","value":370},{"label":"Out","value":395},{"label":"Nov","value":557},{"label":"Dez","value":436}];
const MX = 746;
