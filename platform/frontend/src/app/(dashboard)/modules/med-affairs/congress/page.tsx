...
const PAGE = "Congress Plan";
const KPIS = [{"l":"Total Med Affairs","v":"7.597","t":"+14.7%","d":"up"},{"l":"Congress Plan Ativos","v":"8.257","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"67.9%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"63","t":"+9.9%","d":"up"}];
const COLS = ["ID","Congress Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Med Affairs #001","Med Affairs #002","8.253","2.727","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Med Affairs #002","Med Affairs #003","8.779","6.856","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Med Affairs #003","Med Affairs #004","3.228","5.483","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Med Affairs #004","Med Affairs #005","1.650","6.900","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Med Affairs #005","Med Affairs #001","6.619","8.227","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":882},{"label":"Fev","value":687},{"label":"Mar","value":934},{"label":"Abr","value":792},{"label":"Mai","value":687},{"label":"Jun","value":722},{"label":"Jul","value":893},{"label":"Ago","value":751},{"label":"Set","value":962},{"label":"Out","value":702},{"label":"Nov","value":725},{"label":"Dez","value":874}];
const MX = 962;
