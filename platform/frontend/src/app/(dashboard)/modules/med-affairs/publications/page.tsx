...
const ACCENT = "#1e3a5f";
const MODULE = "Medical Affairs";
const PAGE = "Publication Plan";
const KPIS = [{"l":"Total Med Affairs","v":"3.344","t":"-5.4%","d":"down"},{"l":"Publication Plan Ativos","v":"2.384","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"86.2%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"56","t":"-0.8%","d":"down"}];
const COLS = ["ID","Publication Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Med Affairs #001","Med Affairs #002","8.026","4.762","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Med Affairs #002","Med Affairs #003","7.559","4.115","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Med Affairs #003","Med Affairs #004","6.403","6.360","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Med Affairs #004","Med Affairs #005","8.929","3.775","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Med Affairs #005","Med Affairs #001","1.980","5.949","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":870},{"label":"Mar","value":659},{"label":"Abr","value":861},{"label":"Mai","value":1002},{"label":"Jun","value":746},{"label":"Jul","value":888},{"label":"Ago","value":805},{"label":"Set","value":758},{"label":"Out","value":941},{"label":"Nov","value":682},{"label":"Dez","value":795}];
const MX = 1002;
