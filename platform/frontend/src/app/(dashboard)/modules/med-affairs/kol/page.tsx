...
const PAGE = "KOL Mapping";
const KPIS = [{"l":"Total Med Affairs","v":"5.870","t":"+15.6%","d":"up"},{"l":"KOL Mapping Ativos","v":"5.742","t":"+6.8%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"61","t":"-5.9%","d":"down"}];
const COLS = ["ID","KOL Mapping","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Med Affairs #001","Med Affairs #002","7.802","1.459","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Med Affairs #002","Med Affairs #003","8.723","1.342","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Med Affairs #003","Med Affairs #004","8.125","5.413","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Med Affairs #004","Med Affairs #005","1.975","5.331","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Med Affairs #005","Med Affairs #001","4.393","8.802","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":792},{"label":"Mar","value":650},{"label":"Abr","value":785},{"label":"Mai","value":783},{"label":"Jun","value":629},{"label":"Jul","value":506},{"label":"Ago","value":816},{"label":"Set","value":519},{"label":"Out","value":554},{"label":"Nov","value":788},{"label":"Dez","value":682}];
const MX = 816;
