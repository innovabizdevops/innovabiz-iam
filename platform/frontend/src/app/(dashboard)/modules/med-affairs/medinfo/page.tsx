...
const PAGE = "Med Info";
const KPIS = [{"l":"Integrações Ativas","v":"6.701","t":"+4.1%","d":"up"},{"l":"Chamadas/Hora","v":"2779","t":"+0.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"80.6%","t":"-0.8%","d":"down"},{"l":"Latência Média (ms)","v":"170ms","t":"+9.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.559","5.315","78.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.308","694","94.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.594","547","92.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.053","5.477","80.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","624","5.736","82.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":390},{"label":"Fev","value":595},{"label":"Mar","value":399},{"label":"Abr","value":626},{"label":"Mai","value":438},{"label":"Jun","value":460},{"label":"Jul","value":361},{"label":"Ago","value":450},{"label":"Set","value":556},{"label":"Out","value":306},{"label":"Nov","value":455},{"label":"Dez","value":452}];
const MX = 626;
