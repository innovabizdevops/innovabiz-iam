...
const PAGE = "Qualification";
const KPIS = [{"l":"Total Crew Schedule","v":"4.117","t":"-1.5%","d":"down"},{"l":"Qualification Ativos","v":"5.202","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"79.6%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"87","t":"+7.4%","d":"up"}];
const COLS = ["ID","Qualification","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crew Schedule #001","Crew Schedule #002","5.260","7.909","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Crew Schedule #002","Crew Schedule #003","1.706","4.775","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Crew Schedule #003","Crew Schedule #004","8.675","8.871","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Crew Schedule #004","Crew Schedule #005","4.245","8.006","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crew Schedule #005","Crew Schedule #001","4.700","7.848","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":396},{"label":"Fev","value":651},{"label":"Mar","value":625},{"label":"Abr","value":711},{"label":"Mai","value":647},{"label":"Jun","value":637},{"label":"Jul","value":507},{"label":"Ago","value":436},{"label":"Set","value":461},{"label":"Out","value":723},{"label":"Nov","value":549},{"label":"Dez","value":375}];
const MX = 723;
