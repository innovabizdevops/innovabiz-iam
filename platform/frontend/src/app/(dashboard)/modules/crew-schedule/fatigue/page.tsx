...
const ACCENT = "#1e40af";
const MODULE = "Crew Scheduling";
const PAGE = "Fatigue Risk";
const KPIS = [{"l":"Riscos Identificados","v":"560","t":"+15.4%","d":"up"},{"l":"Mitigações Ativas","v":"8.985","t":"-5.5%","d":"down"},{"l":"Score Risco Geral","v":"73","t":"-4.0%","d":"down"},{"l":"Incidentes YTD","v":"8.193","t":"+14.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.684","5.028","8.762","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.276","5.211","2.969","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","875","5.945","1.832","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","686","6.941","7.068","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.895","4.446","6.871","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":899},{"label":"Fev","value":735},{"label":"Mar","value":995},{"label":"Abr","value":859},{"label":"Mai","value":820},{"label":"Jun","value":847},{"label":"Jul","value":740},{"label":"Ago","value":791},{"label":"Set","value":941},{"label":"Out","value":876},{"label":"Nov","value":806},{"label":"Dez","value":773}];
const MX = 995;
