...
const PAGE = "Pairing";
const KPIS = [{"l":"Total Crew Schedule","v":"2.442","t":"+2.6%","d":"up"},{"l":"Pairing Ativos","v":"5.370","t":"+8.3%","d":"up"},{"l":"Eficiência (%)","v":"80.1%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"70","t":"-3.9%","d":"down"}];
const COLS = ["ID","Pairing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crew Schedule #001","Crew Schedule #002","6.926","1.680","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Crew Schedule #002","Crew Schedule #003","6.705","3.999","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Crew Schedule #003","Crew Schedule #004","5.806","7.850","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Crew Schedule #004","Crew Schedule #005","7.906","469","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crew Schedule #005","Crew Schedule #001","2.085","4.646","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":413},{"label":"Fev","value":574},{"label":"Mar","value":697},{"label":"Abr","value":585},{"label":"Mai","value":435},{"label":"Jun","value":519},{"label":"Jul","value":715},{"label":"Ago","value":481},{"label":"Set","value":591},{"label":"Out","value":681},{"label":"Nov","value":493},{"label":"Dez","value":580}];
const MX = 715;
