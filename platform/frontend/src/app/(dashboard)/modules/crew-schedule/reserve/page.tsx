...
const KPIS = [{"l":"Total Crew Schedule","v":"3.521","t":"+1.9%","d":"up"},{"l":"Reserve Mgmt Ativos","v":"2.092","t":"+13.5%","d":"up"},{"l":"Eficiência (%)","v":"77.7%","t":"+10.5%","d":"up"},{"l":"Score Performance","v":"73","t":"+2.9%","d":"up"}];
const COLS = ["ID","Reserve Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crew Schedule #001","Crew Schedule #002","8.220","3.570","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Crew Schedule #002","Crew Schedule #003","943","461","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Crew Schedule #003","Crew Schedule #004","2.356","5.301","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Crew Schedule #004","Crew Schedule #005","1.040","6.599","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crew Schedule #005","Crew Schedule #001","4.899","4.112","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":982},{"label":"Fev","value":699},{"label":"Mar","value":639},{"label":"Abr","value":884},{"label":"Mai","value":741},{"label":"Jun","value":734},{"label":"Jul","value":888},{"label":"Ago","value":733},{"label":"Set","value":818},{"label":"Out","value":608},{"label":"Nov","value":893},{"label":"Dez","value":929}];
const MX = 982;
