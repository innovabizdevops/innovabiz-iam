...
const PAGE = "Roster Build";
const KPIS = [{"l":"Total Crew Schedule","v":"7.118","t":"-3.9%","d":"down"},{"l":"Roster Build Ativos","v":"7.524","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"66.0%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"80","t":"+0.6%","d":"up"}];
const COLS = ["ID","Roster Build","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crew Schedule #001","Crew Schedule #002","3.936","363","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Crew Schedule #002","Crew Schedule #003","3.287","2.325","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Crew Schedule #003","Crew Schedule #004","5.430","3.174","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Crew Schedule #004","Crew Schedule #005","457","2.307","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crew Schedule #005","Crew Schedule #001","3.764","1.564","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":853},{"label":"Mar","value":681},{"label":"Abr","value":593},{"label":"Mai","value":742},{"label":"Jun","value":472},{"label":"Jul","value":612},{"label":"Ago","value":480},{"label":"Set","value":836},{"label":"Out","value":547},{"label":"Nov","value":732},{"label":"Dez","value":537}];
const MX = 853;
