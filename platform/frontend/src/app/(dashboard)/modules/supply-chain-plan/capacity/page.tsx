...
const PAGE = "Capacity";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.965","t":"+17.3%","d":"up"},{"l":"NC Abertas","v":"5.635","t":"+10.4%","d":"up"},{"l":"Conformidade (%)","v":"86.8%","t":"-3.6%","d":"down"},{"l":"CAPAs Pendentes","v":"759","t":"+5.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","9.083","90.5%","4.225","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.918","77.9%","6.170","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.901","86.7%","8.011","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.711","76.1%","6.238","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.068","86.2%","8.882","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":570},{"label":"Fev","value":711},{"label":"Mar","value":574},{"label":"Abr","value":717},{"label":"Mai","value":569},{"label":"Jun","value":738},{"label":"Jul","value":470},{"label":"Ago","value":435},{"label":"Set","value":652},{"label":"Out","value":488},{"label":"Nov","value":390},{"label":"Dez","value":422}];
const MX = 738;
