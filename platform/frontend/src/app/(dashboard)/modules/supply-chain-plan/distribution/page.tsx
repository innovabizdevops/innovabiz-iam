...
const ACCENT = "#065f46";
const MODULE = "Supply Chain Planning (APQC 4.3)";
const PAGE = "Distribution";
const KPIS = [{"l":"Total Supply Chain Plan","v":"3.533","t":"-0.8%","d":"down"},{"l":"Distribution Ativos","v":"5.419","t":"+14.5%","d":"up"},{"l":"Eficiência (%)","v":"85.4%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"85","t":"+14.1%","d":"up"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Supply Chain Plan #001","Supply Chain Plan #002","7.863","3.537","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Supply Chain Plan #002","Supply Chain Plan #003","2.577","8.340","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Supply Chain Plan #003","Supply Chain Plan #004","8.586","5.987","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Supply Chain Plan #004","Supply Chain Plan #005","8.575","1.926","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Supply Chain Plan #005","Supply Chain Plan #001","7.147","2.931","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":373},{"label":"Fev","value":527},{"label":"Mar","value":670},{"label":"Abr","value":708},{"label":"Mai","value":557},{"label":"Jun","value":552},{"label":"Jul","value":493},{"label":"Ago","value":654},{"label":"Set","value":595},{"label":"Out","value":654},{"label":"Nov","value":509},{"label":"Dez","value":350}];
const MX = 708;
