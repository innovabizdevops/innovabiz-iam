...
/* ═══ Supply Chain Planning (APQC 4.3) — Dashboard ═══ */

const ACCENT = "#065f46";

const KPIS = [
    { label: "Total Registos", value: "8482", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1015", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€34K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "-15%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1352962182", cells: ["SUP-2182", "Supply Chain Planning (APQC 4.3) Item 1", "27/7/2026", "€12 282"], status: "active" as const },
    { id: "1352965753", cells: ["SUP-5753", "Supply Chain Planning (APQC 4.3) Item 2", "14/2/2026", "€15 853"], status: "pending" as const },
    { id: "1352969324", cells: ["SUP-9324", "Supply Chain Planning (APQC 4.3) Item 3", "1/9/2026", "€19 424"], status: "completed" as const },
    { id: "1352972895", cells: ["SUP-3895", "Supply Chain Planning (APQC 4.3) Item 4", "16/4/2026", "€22 995"], status: "warning" as const },
    { id: "1352976466", cells: ["SUP-7466", "Supply Chain Planning (APQC 4.3) Item 5", "3/11/2026", "€26 566"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 42 }, { label: "Fev", value: 51 }, { label: "Mar", value: 60 }, { label: "Abr", value: 69 }, { label: "Mai", value: 78 }, { label: "Jun", value: 87 }];
...
export default function SupplyChainPlanningApqc43Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Supply Chain Planning (APQC 4.3)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Supply Chain Planning (APQC 4.3)</p>
                    </div>
                </div>
