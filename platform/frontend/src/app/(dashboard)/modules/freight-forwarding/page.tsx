...
/* ═══ Freight Forwarding Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "2302", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3199", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€134K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1978358802", cells: ["FRE-6802", "Freight Forwarding Platform Item 1", "15/7/2026", "€8902"], status: "active" as const },
    { id: "1978362373", cells: ["FRE-1373", "Freight Forwarding Platform Item 2", "2/2/2026", "€12 473"], status: "pending" as const },
    { id: "1978365944", cells: ["FRE-4944", "Freight Forwarding Platform Item 3", "17/9/2026", "€16 044"], status: "completed" as const },
    { id: "1978369515", cells: ["FRE-8515", "Freight Forwarding Platform Item 4", "4/4/2026", "€19 615"], status: "warning" as const },
    { id: "1978373086", cells: ["FRE-3086", "Freight Forwarding Platform Item 5", "19/11/2026", "€23 186"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 22 }, { label: "Fev", value: 31 }, { label: "Mar", value: 40 }, { label: "Abr", value: 49 }, { label: "Mai", value: 58 }, { label: "Jun", value: 67 }];
...
export default function FreightForwardingPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Freight Forwarding Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Freight Forwarding Platform</p>
                    </div>
                </div>
