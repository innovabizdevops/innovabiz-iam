...
const PAGE = "Bill";
const KPIS = [{"l":"Total Freight Forwarding","v":"5.121","t":"-2.8%","d":"down"},{"l":"Bill Ativos","v":"2.091","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"81.2%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"94","t":"+2.5%","d":"up"}];
const COLS = ["ID","Bill","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Freight Forwarding #001","Freight Forwarding #002","548","6.816","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Freight Forwarding #002","Freight Forwarding #003","6.848","7.778","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Freight Forwarding #003","Freight Forwarding #004","8.872","8.597","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Freight Forwarding #004","Freight Forwarding #005","5.477","1.930","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Freight Forwarding #005","Freight Forwarding #001","955","4.082","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":469},{"label":"Mar","value":440},{"label":"Abr","value":561},{"label":"Mai","value":619},{"label":"Jun","value":365},{"label":"Jul","value":318},{"label":"Ago","value":466},{"label":"Set","value":572},{"label":"Out","value":598},{"label":"Nov","value":441},{"label":"Dez","value":410}];
const MX = 619;
