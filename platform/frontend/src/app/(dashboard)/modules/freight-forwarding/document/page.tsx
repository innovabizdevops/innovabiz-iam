...
const PAGE = "Document";
const KPIS = [{"l":"Formulários Ativos","v":"5.799","t":"+2.4%","d":"up"},{"l":"Submissões/Dia","v":"625","t":"+16.6%","d":"up"},{"l":"Documentos Gerados","v":"107","t":"+3.1%","d":"up"},{"l":"Templates","v":"5.710","t":"+11.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.987","2026-01-12","189","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.251","2026-03-11","4.697","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.687","2026-02-06","9.081","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","633","2026-01-09","7.653","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.977","2026-01-10","7.999","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":424},{"label":"Mar","value":521},{"label":"Abr","value":608},{"label":"Mai","value":608},{"label":"Jun","value":440},{"label":"Jul","value":458},{"label":"Ago","value":677},{"label":"Set","value":646},{"label":"Out","value":459},{"label":"Nov","value":782},{"label":"Dez","value":646}];
const MX = 782;
