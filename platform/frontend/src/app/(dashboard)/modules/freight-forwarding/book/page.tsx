...
const PAGE = "Book";
const KPIS = [{"l":"Total Freight Forwarding","v":"4.862","t":"+6.5%","d":"up"},{"l":"Book Ativos","v":"8.283","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"58","t":"+15.8%","d":"up"}];
const COLS = ["ID","Book","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Freight Forwarding #001","Freight Forwarding #002","4.362","3.305","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Freight Forwarding #002","Freight Forwarding #003","2.254","7.486","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Freight Forwarding #003","Freight Forwarding #004","1.580","2.635","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Freight Forwarding #004","Freight Forwarding #005","6.356","8.911","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Freight Forwarding #005","Freight Forwarding #001","4.348","533","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":426},{"label":"Mar","value":495},{"label":"Abr","value":285},{"label":"Mai","value":299},{"label":"Jun","value":413},{"label":"Jul","value":214},{"label":"Ago","value":383},{"label":"Set","value":310},{"label":"Out","value":548},{"label":"Nov","value":593},{"label":"Dez","value":250}];
const MX = 603;
