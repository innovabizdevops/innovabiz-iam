...
const ACCENT = "#6366f1";
const MODULE = "Print & Mailing";
const PAGE = "Insert";
const KPIS = [{"l":"Total Print Mailing","v":"724","t":"-4.3%","d":"down"},{"l":"Insert Ativos","v":"4.201","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"70.7%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"72","t":"+0.9%","d":"up"}];
const COLS = ["ID","Insert","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Mailing #001","Print Mailing #002","6.715","2.338","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Print Mailing #002","Print Mailing #003","3.493","2.972","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Mailing #003","Print Mailing #004","4.893","6.767","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Print Mailing #004","Print Mailing #005","8.889","2.553","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Mailing #005","Print Mailing #001","3.665","2.963","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":719},{"label":"Mar","value":770},{"label":"Abr","value":475},{"label":"Mai","value":809},{"label":"Jun","value":773},{"label":"Jul","value":493},{"label":"Ago","value":816},{"label":"Set","value":717},{"label":"Out","value":778},{"label":"Nov","value":761},{"label":"Dez","value":811}];
const MX = 816;
