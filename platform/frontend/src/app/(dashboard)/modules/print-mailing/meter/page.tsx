...
const PAGE = "Meter";
const KPIS = [{"l":"Total Print Mailing","v":"4.829","t":"-3.8%","d":"down"},{"l":"Meter Ativos","v":"7.316","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"67.5%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"90","t":"-3.1%","d":"down"}];
const COLS = ["ID","Meter","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Mailing #001","Print Mailing #002","8.319","8.587","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Print Mailing #002","Print Mailing #003","2.856","4.557","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Mailing #003","Print Mailing #004","7.557","4.881","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Print Mailing #004","Print Mailing #005","6.616","5.984","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Mailing #005","Print Mailing #001","439","1.065","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":936},{"label":"Fev","value":774},{"label":"Mar","value":1060},{"label":"Abr","value":1005},{"label":"Mai","value":1020},{"label":"Jun","value":848},{"label":"Jul","value":1068},{"label":"Ago","value":755},{"label":"Set","value":1053},{"label":"Out","value":1045},{"label":"Nov","value":787},{"label":"Dez","value":863}];
const MX = 1068;
