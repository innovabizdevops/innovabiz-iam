...
export default function PrintMailingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Print Mailing</h1><p className="text-sm text-muted-foreground">Print Mailing • iBOS Enterprise</p></div>
