...
const PAGE = "Muster Drill";
const KPIS = [{"l":"Total Cruise Ops","v":"2.354","t":"-3.1%","d":"down"},{"l":"Muster Drill Ativos","v":"3.636","t":"+1.3%","d":"up"},{"l":"Eficiência (%)","v":"83.5%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"75","t":"+14.8%","d":"up"}];
const COLS = ["ID","Muster Drill","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cruise Ops #001","Cruise Ops #002","5.631","1.984","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Cruise Ops #002","Cruise Ops #003","831","3.229","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Cruise Ops #003","Cruise Ops #004","4.679","5.069","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Cruise Ops #004","Cruise Ops #005","133","910","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cruise Ops #005","Cruise Ops #001","503","8.682","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":933},{"label":"Fev","value":665},{"label":"Mar","value":917},{"label":"Abr","value":698},{"label":"Mai","value":1004},{"label":"Jun","value":666},{"label":"Jul","value":765},{"label":"Ago","value":962},{"label":"Set","value":650},{"label":"Out","value":855},{"label":"Nov","value":994},{"label":"Dez","value":733}];
const MX = 1004;
