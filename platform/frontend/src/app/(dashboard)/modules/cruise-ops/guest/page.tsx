...
const PAGE = "Guest Services";
const KPIS = [{"l":"Total Cruise Ops","v":"2.210","t":"-3.0%","d":"down"},{"l":"Guest Services Ativos","v":"1.615","t":"-3.7%","d":"down"},{"l":"Eficiência (%)","v":"75.5%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"92","t":"+0.7%","d":"up"}];
const COLS = ["ID","Guest Services","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cruise Ops #001","Cruise Ops #002","3.878","8.931","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Cruise Ops #002","Cruise Ops #003","7.413","4.816","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Cruise Ops #003","Cruise Ops #004","3.869","8.226","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Cruise Ops #004","Cruise Ops #005","8.115","4.225","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cruise Ops #005","Cruise Ops #001","2.707","5.374","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":572},{"label":"Mar","value":516},{"label":"Abr","value":691},{"label":"Mai","value":514},{"label":"Jun","value":401},{"label":"Jul","value":611},{"label":"Ago","value":324},{"label":"Set","value":470},{"label":"Out","value":692},{"label":"Nov","value":403},{"label":"Dez","value":597}];
const MX = 697;
