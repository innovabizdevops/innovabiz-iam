...
const KPIS = [{"l":"Total Cruise Ops","v":"4.416","t":"+9.3%","d":"up"},{"l":"Port Schedule Ativos","v":"6.601","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"79.8%","t":"+4.1%","d":"up"},{"l":"Score Performance","v":"83","t":"+13.8%","d":"up"}];
const COLS = ["ID","Port Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cruise Ops #001","Cruise Ops #002","2.040","1.974","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Cruise Ops #002","Cruise Ops #003","1.674","5.070","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Cruise Ops #003","Cruise Ops #004","8.060","6.138","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Cruise Ops #004","Cruise Ops #005","324","1.022","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cruise Ops #005","Cruise Ops #001","707","3.752","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":507},{"label":"Mar","value":627},{"label":"Abr","value":440},{"label":"Mai","value":724},{"label":"Jun","value":735},{"label":"Jul","value":739},{"label":"Ago","value":638},{"label":"Set","value":664},{"label":"Out","value":375},{"label":"Nov","value":677},{"label":"Dez","value":354}];
const MX = 739;
