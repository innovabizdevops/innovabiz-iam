...
const ACCENT = "#0e7490";
const MODULE = "Cruise Operations";
const PAGE = "Shore Excur";
const KPIS = [{"l":"Total Cruise Ops","v":"2.179","t":"+3.1%","d":"up"},{"l":"Shore Excur Ativos","v":"1.826","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"90.3%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"64","t":"-5.9%","d":"down"}];
const COLS = ["ID","Shore Excur","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cruise Ops #001","Cruise Ops #002","8.317","4.825","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Cruise Ops #002","Cruise Ops #003","7.791","7.136","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Cruise Ops #003","Cruise Ops #004","2.478","5.512","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Cruise Ops #004","Cruise Ops #005","2.624","7.152","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cruise Ops #005","Cruise Ops #001","1.942","900","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":421},{"label":"Fev","value":518},{"label":"Mar","value":491},{"label":"Abr","value":502},{"label":"Mai","value":310},{"label":"Jun","value":554},{"label":"Jul","value":536},{"label":"Ago","value":321},{"label":"Set","value":360},{"label":"Out","value":518},{"label":"Nov","value":569},{"label":"Dez","value":515}];
const MX = 569;
