...
const PAGE = "Cabin Mgmt";
const KPIS = [{"l":"Total Cruise Ops","v":"2.603","t":"+13.8%","d":"up"},{"l":"Cabin Mgmt Ativos","v":"5.140","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"79.9%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"95","t":"+7.8%","d":"up"}];
const COLS = ["ID","Cabin Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cruise Ops #001","Cruise Ops #002","6.876","1.273","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Cruise Ops #002","Cruise Ops #003","3.907","5.887","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Cruise Ops #003","Cruise Ops #004","1.916","7.399","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Cruise Ops #004","Cruise Ops #005","744","2.856","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cruise Ops #005","Cruise Ops #001","6.941","8.790","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":974},{"label":"Fev","value":1022},{"label":"Mar","value":716},{"label":"Abr","value":979},{"label":"Mai","value":1035},{"label":"Jun","value":931},{"label":"Jul","value":995},{"label":"Ago","value":719},{"label":"Set","value":1026},{"label":"Out","value":949},{"label":"Nov","value":735},{"label":"Dez","value":757}];
const MX = 1035;
