...
const PAGE = "Rate";
const KPIS = [{"l":"Total Freight Exchange","v":"3.107","t":"+17.7%","d":"up"},{"l":"Rate Ativos","v":"7.768","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"78.2%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"68","t":"-3.7%","d":"down"}];
const COLS = ["ID","Rate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Freight Exchange #001","Freight Exchange #002","5.363","2.088","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Freight Exchange #002","Freight Exchange #003","4.976","8.692","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Freight Exchange #003","Freight Exchange #004","8.343","7.933","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Freight Exchange #004","Freight Exchange #005","6.144","1.429","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Freight Exchange #005","Freight Exchange #001","4.381","3.942","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":689},{"label":"Fev","value":724},{"label":"Mar","value":682},{"label":"Abr","value":866},{"label":"Mai","value":726},{"label":"Jun","value":725},{"label":"Jul","value":910},{"label":"Ago","value":859},{"label":"Set","value":869},{"label":"Out","value":759},{"label":"Nov","value":686},{"label":"Dez","value":730}];
const MX = 910;
