...
const KPIS = [{"l":"Total Freight Exchange","v":"7.125","t":"+3.4%","d":"up"},{"l":"Settlement Ativos","v":"5.588","t":"+15.8%","d":"up"},{"l":"Eficiência (%)","v":"66.2%","t":"-0.2%","d":"down"},{"l":"Score Performance","v":"89","t":"+16.2%","d":"up"}];
const COLS = ["ID","Settlement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Freight Exchange #001","Freight Exchange #002","5.277","3.948","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Freight Exchange #002","Freight Exchange #003","5.500","2.521","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Freight Exchange #003","Freight Exchange #004","5.337","2.717","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Freight Exchange #004","Freight Exchange #005","4.858","5.072","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Freight Exchange #005","Freight Exchange #001","1.357","3.950","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":408},{"label":"Fev","value":411},{"label":"Mar","value":687},{"label":"Abr","value":533},{"label":"Mai","value":334},{"label":"Jun","value":513},{"label":"Jul","value":643},{"label":"Ago","value":534},{"label":"Set","value":574},{"label":"Out","value":554},{"label":"Nov","value":326},{"label":"Dez","value":534}];
const MX = 687;
