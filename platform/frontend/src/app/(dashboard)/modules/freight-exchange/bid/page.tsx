...
const PAGE = "Bid";
const KPIS = [{"l":"Fornecedores Ativos","v":"224","t":"+14.5%","d":"up"},{"l":"Contratos (€M)","v":"€10.6M","t":"+0.4%","d":"up"},{"l":"On-Time Delivery (%)","v":"66.5%","t":"-4.6%","d":"down"},{"l":"Score Médio","v":"55","t":"+10.8%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","88.7%","€ 19539.07","4.045","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","86.5%","€ 29577.94","5.710","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","89.3%","€ 8460.20","5.127","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","96.3%","€ 31055.46","6.958","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","94.4%","€ 7281.97","7.739","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":478},{"label":"Mar","value":524},{"label":"Abr","value":719},{"label":"Mai","value":588},{"label":"Jun","value":575},{"label":"Jul","value":592},{"label":"Ago","value":434},{"label":"Set","value":697},{"label":"Out","value":790},{"label":"Nov","value":727},{"label":"Dez","value":755}];
const MX = 790;
