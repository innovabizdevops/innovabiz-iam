...
const ACCENT = "#6366f1";
const MODULE = "Freight Exchange";
const PAGE = "Match";
const KPIS = [{"l":"Atletas Registados","v":"5.866","t":"+7.8%","d":"up"},{"l":"Treinos/Semana","v":"2801","t":"-1.2%","d":"down"},{"l":"Competições","v":"2.190","t":"+14.8%","d":"up"},{"l":"Performance Score","v":"74","t":"+11.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.105","7.352","4.694","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","5.825","3.568","4.149","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.632","8.850","7.880","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.019","8.355","8.253","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.456","5.992","4.508","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":526},{"label":"Fev","value":516},{"label":"Mar","value":383},{"label":"Abr","value":443},{"label":"Mai","value":509},{"label":"Jun","value":396},{"label":"Jul","value":718},{"label":"Ago","value":452},{"label":"Set","value":549},{"label":"Out","value":590},{"label":"Nov","value":580},{"label":"Dez","value":543}];
const MX = 718;
