...
const KPIS = [{"l":"Projetos Melhoria","v":"3.641","t":"+15.3%","d":"up"},{"l":"Savings (€)","v":"€84941","t":"-1.4%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"83.7%","t":"-5.9%","d":"down"},{"l":"Ciclos PDCA","v":"4.611","t":"+17.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.549","€ 46251.74","8.541","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.632","€ 35501.07","757","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.918","€ 12376.64","8.927","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","808","€ 3204.88","5.950","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.046","€ 13034.21","8.146","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":720},{"label":"Mar","value":706},{"label":"Abr","value":540},{"label":"Mai","value":498},{"label":"Jun","value":601},{"label":"Jul","value":723},{"label":"Ago","value":642},{"label":"Set","value":581},{"label":"Out","value":470},{"label":"Nov","value":787},{"label":"Dez","value":603}];
const MX = 787;
