...
const KPIS = [{"l":"eNPS","v":"72","t":"+17.6%","d":"up"},{"l":"Engagement (%)","v":"67.4%","t":"+0.3%","d":"up"},{"l":"Turnover (%)","v":"80.2%","t":"+15.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.150","t":"+12.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.306","2026-02-04","91","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.088","2026-03-08","94","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.858","2026-02-19","76","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.388","2026-01-27","65","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.497","2026-02-22","63","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":603},{"label":"Mar","value":320},{"label":"Abr","value":647},{"label":"Mai","value":490},{"label":"Jun","value":610},{"label":"Jul","value":364},{"label":"Ago","value":671},{"label":"Set","value":657},{"label":"Out","value":692},{"label":"Nov","value":552},{"label":"Dez","value":358}];
const MX = 692;
