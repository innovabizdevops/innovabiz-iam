...
const KPIS = [{"l":"Tickets Abertos","v":"6.588","t":"+4.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"85.5%","t":"+17.8%","d":"up"},{"l":"MTTR (h)","v":"204h","t":"+3.9%","d":"up"},{"l":"Satisfação (%)","v":"76.4%","t":"+0.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","141","4.968","8.632","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.234","5.617","1.512","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.462","1.228","2.492","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.997","7.118","3.271","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.197","6.651","7.030","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":515},{"label":"Fev","value":675},{"label":"Mar","value":690},{"label":"Abr","value":494},{"label":"Mai","value":685},{"label":"Jun","value":728},{"label":"Jul","value":671},{"label":"Ago","value":521},{"label":"Set","value":743},{"label":"Out","value":593},{"label":"Nov","value":715},{"label":"Dez","value":625}];
const MX = 743;
