...
const PAGE = "Asset Tracking";
const KPIS = [{"l":"Ativos Registados","v":"5.349","t":"-3.3%","d":"down"},{"l":"Valor Total (€M)","v":"€4.0M","t":"+9.3%","d":"up"},{"l":"Depreciação Anual (€)","v":"€50650","t":"+14.7%","d":"up"},{"l":"Ativos em Garantia","v":"4.946","t":"+13.3%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 7678.57","8.797","€ 46803.73","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 5410.58","3.630","€ 16036.69","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 19944.51","5.373","€ 37352.58","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 988.01","3.501","€ 27331.36","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 34503.43","5.922","€ 25187.90","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":963},{"label":"Fev","value":883},{"label":"Mar","value":632},{"label":"Abr","value":668},{"label":"Mai","value":775},{"label":"Jun","value":816},{"label":"Jul","value":623},{"label":"Ago","value":736},{"label":"Set","value":808},{"label":"Out","value":868},{"label":"Nov","value":626},{"label":"Dez","value":769}];
const MX = 963;
