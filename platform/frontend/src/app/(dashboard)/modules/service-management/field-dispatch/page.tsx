...
const PAGE = "Dispatch";
const KPIS = [{"l":"Projetos Melhoria","v":"1.987","t":"+17.1%","d":"up"},{"l":"Savings (€)","v":"€17521","t":"-1.4%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"67.5%","t":"-1.0%","d":"down"},{"l":"Ciclos PDCA","v":"8.956","t":"-1.0%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.205","€ 25552.91","1.050","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.456","€ 46286.09","8.410","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.036","€ 7437.81","2.947","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.774","€ 28138.43","6.836","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.954","€ 37601.19","6.808","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":491},{"label":"Mar","value":507},{"label":"Abr","value":431},{"label":"Mai","value":563},{"label":"Jun","value":588},{"label":"Jul","value":449},{"label":"Ago","value":549},{"label":"Set","value":554},{"label":"Out","value":673},{"label":"Nov","value":503},{"label":"Dez","value":588}];
const MX = 673;
