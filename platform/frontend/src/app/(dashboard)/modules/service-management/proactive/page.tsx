...
const PAGE = "Proactive Support AI";
const KPIS = [{"l":"Tickets Abertos","v":"5.955","t":"-3.5%","d":"down"},{"l":"SLA Cumprido (%)","v":"84.9%","t":"+17.4%","d":"up"},{"l":"MTTR (h)","v":"194h","t":"+9.8%","d":"up"},{"l":"Satisfação (%)","v":"85.3%","t":"-3.4%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.161","8.437","2.181","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.447","6.548","5.548","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.821","8.911","110","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.757","8.158","6.594","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.091","4.965","6.212","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":974},{"label":"Mar","value":1014},{"label":"Abr","value":961},{"label":"Mai","value":727},{"label":"Jun","value":842},{"label":"Jul","value":734},{"label":"Ago","value":839},{"label":"Set","value":696},{"label":"Out","value":999},{"label":"Nov","value":889},{"label":"Dez","value":970}];
const MX = 1014;
