...
const PAGE = "Mobile Workforce";
const KPIS = [{"l":"eNPS","v":"65","t":"+7.8%","d":"up"},{"l":"Engagement (%)","v":"76.4%","t":"+5.5%","d":"up"},{"l":"Turnover (%)","v":"75.9%","t":"+9.5%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.323","t":"+7.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.612","2026-03-26","60","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.308","2026-02-16","61","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.469","2026-01-01","72","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.660","2026-02-06","92","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.959","2026-01-04","57","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":868},{"label":"Fev","value":757},{"label":"Mar","value":1033},{"label":"Abr","value":679},{"label":"Mai","value":853},{"label":"Jun","value":913},{"label":"Jul","value":942},{"label":"Ago","value":876},{"label":"Set","value":865},{"label":"Out","value":1003},{"label":"Nov","value":878},{"label":"Dez","value":971}];
const MX = 1033;
