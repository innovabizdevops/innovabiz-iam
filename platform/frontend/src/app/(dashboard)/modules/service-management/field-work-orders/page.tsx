...
const KPIS = [{"l":"Projetos Melhoria","v":"3.037","t":"-5.4%","d":"down"},{"l":"Savings (€)","v":"€18960","t":"+10.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"94.2%","t":"+9.5%","d":"up"},{"l":"Ciclos PDCA","v":"2.620","t":"+11.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.533","€ 42978.31","1.412","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.281","€ 3333.64","1.956","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.252","€ 4849.07","5.841","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.933","€ 31731.42","3.717","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.675","€ 25044.81","8.574","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":957},{"label":"Fev","value":704},{"label":"Mar","value":801},{"label":"Abr","value":819},{"label":"Mai","value":958},{"label":"Jun","value":1029},{"label":"Jul","value":1012},{"label":"Ago","value":1019},{"label":"Set","value":958},{"label":"Out","value":653},{"label":"Nov","value":924},{"label":"Dez","value":977}];
const MX = 1029;
