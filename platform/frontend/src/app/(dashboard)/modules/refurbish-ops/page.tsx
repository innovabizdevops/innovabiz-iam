...
/* ═══ Refurbishment Operations — Dashboard ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total Registos", value: "8040", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "581", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€294K", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1224113240", cells: ["REF-6240", "Refurbishment Operations Item 1", "1/9/2026", "€13 340"], status: "active" as const },
    { id: "1224116811", cells: ["REF-9811", "Refurbishment Operations Item 2", "16/4/2026", "€16 911"], status: "pending" as const },
    { id: "1224120382", cells: ["REF-4382", "Refurbishment Operations Item 3", "3/11/2026", "€20 482"], status: "completed" as const },
    { id: "1224123953", cells: ["REF-7953", "Refurbishment Operations Item 4", "18/6/2026", "€24 053"], status: "warning" as const },
    { id: "1224127524", cells: ["REF-2524", "Refurbishment Operations Item 5", "5/1/2026", "€27 624"], status: "active" as const },
];
...
export default function RefurbishmentOperationsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Refurbishment Operations</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Refurbishment Operations</p>
                    </div>
                </div>
