...
const ACCENT = "#047857";
const MODULE = "Refurbishment Operations";
const PAGE = "Receive";
const KPIS = [{"l":"Total Refurbish Ops","v":"1.370","t":"+9.8%","d":"up"},{"l":"Receive Ativos","v":"5.398","t":"+13.5%","d":"up"},{"l":"Eficiência (%)","v":"89.0%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"72","t":"-2.6%","d":"down"}];
const COLS = ["ID","Receive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Refurbish Ops #001","Refurbish Ops #002","8.074","3.662","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Refurbish Ops #002","Refurbish Ops #003","6.233","3.978","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Refurbish Ops #003","Refurbish Ops #004","4.390","1.103","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Refurbish Ops #004","Refurbish Ops #005","3.851","462","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Refurbish Ops #005","Refurbish Ops #001","4.156","338","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":335},{"label":"Fev","value":541},{"label":"Mar","value":671},{"label":"Abr","value":501},{"label":"Mai","value":340},{"label":"Jun","value":546},{"label":"Jul","value":541},{"label":"Ago","value":676},{"label":"Set","value":682},{"label":"Out","value":562},{"label":"Nov","value":573},{"label":"Dez","value":388}];
const MX = 682;
