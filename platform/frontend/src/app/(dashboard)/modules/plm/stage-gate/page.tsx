...
const PAGE = "Stage-Gate Process";
const KPIS = [{"l":"Produtos Ativos","v":"1.582","t":"+13.2%","d":"up"},{"l":"SKUs","v":"3.131","t":"-2.8%","d":"down"},{"l":"ECNs Pendentes","v":"6.664","t":"+10.9%","d":"up"},{"l":"Time-to-Market (dias)","v":"3.176","t":"+3.7%","d":"up"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","4.392","8.864","670","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","430","5.917","8.208","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","1.220","976","4.213","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","4.034","8.887","8.165","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","7.326","4.722","5.712","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":341},{"label":"Mar","value":414},{"label":"Abr","value":253},{"label":"Mai","value":585},{"label":"Jun","value":495},{"label":"Jul","value":309},{"label":"Ago","value":244},{"label":"Set","value":340},{"label":"Out","value":407},{"label":"Nov","value":536},{"label":"Dez","value":502}];
const MX = 585;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0d9488'}}>APQC</span></h1>
                </div>
