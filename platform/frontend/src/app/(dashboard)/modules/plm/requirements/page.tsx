...
const PAGE = "Requirements Mgmt";
const KPIS = [{"l":"Produtos Ativos","v":"4.098","t":"-1.6%","d":"down"},{"l":"SKUs","v":"1.751","t":"+13.6%","d":"up"},{"l":"ECNs Pendentes","v":"7.183","t":"+10.4%","d":"up"},{"l":"Time-to-Market (dias)","v":"5.182","t":"+4.7%","d":"up"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","842","3.583","6.887","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","4.828","6.287","429","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","2.210","2.438","3.410","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","8.469","9.050","8.078","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","6.320","6.536","2.129","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":496},{"label":"Fev","value":429},{"label":"Mar","value":354},{"label":"Abr","value":625},{"label":"Mai","value":634},{"label":"Jun","value":510},{"label":"Jul","value":506},{"label":"Ago","value":370},{"label":"Set","value":289},{"label":"Out","value":313},{"label":"Nov","value":310},{"label":"Dez","value":301}];
const MX = 634;
