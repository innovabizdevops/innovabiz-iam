...
/* ═══ ESG Platform — Sdg Alignment ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "1310", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "7", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "808", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "157346099", cells: ["ESG-9099", "Sdg Alignment Item 1", "16/12/2026", "€46 199"], status: "active" as const },
    { id: "157349670", cells: ["ESG-3670", "Sdg Alignment Item 2", "3/7/2026", "€49 770"], status: "pending" as const },
    { id: "157353241", cells: ["ESG-7241", "Sdg Alignment Item 3", "18/2/2026", "€3341"], status: "completed" as const },
    { id: "157356812", cells: ["ESG-1812", "Sdg Alignment Item 4", "5/9/2026", "€6912"], status: "warning" as const },
    { id: "157360383", cells: ["ESG-5383", "Sdg Alignment Item 5", "20/4/2026", "€10 483"], status: "active" as const },
];
...
export default function EsgPlatformSdgAlignmentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sdg Alignment</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">ESG Platform • Sdg Alignment</p>
                    </div>
                </div>
