...
/* ═══ ESG Platform — Water Footprint ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "1279", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "404", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2348", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1531205488", cells: ["ESG-9488", "Water Footprint Item 1", "9/5/2026", "€5588"], status: "active" as const },
    { id: "1531209059", cells: ["ESG-4059", "Water Footprint Item 2", "24/12/2026", "€9159"], status: "pending" as const },
    { id: "1531212630", cells: ["ESG-7630", "Water Footprint Item 3", "11/7/2026", "€12 730"], status: "completed" as const },
    { id: "1531216201", cells: ["ESG-2201", "Water Footprint Item 4", "26/2/2026", "€16 301"], status: "warning" as const },
    { id: "1531219772", cells: ["ESG-5772", "Water Footprint Item 5", "13/9/2026", "€19 872"], status: "active" as const },
];
...
export default function EsgPlatformWaterFootprintPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Water Footprint</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">ESG Platform • Water Footprint</p>
                    </div>
                </div>
