...
/* ═══ ESG Platform — Scope Emissions ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "1690", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "270", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2210", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "822962490", cells: ["ESG-3490", "Scope Emissions Item 1", "15/7/2026", "€12 590"], status: "active" as const },
    { id: "822966061", cells: ["ESG-7061", "Scope Emissions Item 2", "2/2/2026", "€16 161"], status: "pending" as const },
    { id: "822969632", cells: ["ESG-1632", "Scope Emissions Item 3", "17/9/2026", "€19 732"], status: "completed" as const },
    { id: "822973203", cells: ["ESG-5203", "Scope Emissions Item 4", "4/4/2026", "€23 303"], status: "warning" as const },
    { id: "822976774", cells: ["ESG-8774", "Scope Emissions Item 5", "19/11/2026", "€26 874"], status: "active" as const },
];
...
export default function EsgPlatformScopeEmissionsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Scope Emissions</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">ESG Platform • Scope Emissions</p>
                    </div>
                </div>
