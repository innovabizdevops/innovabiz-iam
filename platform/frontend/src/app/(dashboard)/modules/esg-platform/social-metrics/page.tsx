...
/* ═══ ESG Platform — Social Metrics ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2878", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "138", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2726", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "879826774", cells: ["ESG-5774", "Social Metrics Item 1", "23/11/2026", "€26 874"], status: "active" as const },
    { id: "879830345", cells: ["ESG-9345", "Social Metrics Item 2", "10/6/2026", "€30 445"], status: "pending" as const },
    { id: "879833916", cells: ["ESG-3916", "Social Metrics Item 3", "25/1/2026", "€34 016"], status: "completed" as const },
    { id: "879837487", cells: ["ESG-7487", "Social Metrics Item 4", "12/8/2026", "€37 587"], status: "warning" as const },
    { id: "879841058", cells: ["ESG-2058", "Social Metrics Item 5", "27/3/2026", "€41 158"], status: "active" as const },
];
...
export default function EsgPlatformSocialMetricsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Social Metrics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">ESG Platform • Social Metrics</p>
                    </div>
                </div>
