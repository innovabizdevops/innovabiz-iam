...
/* ═══ ESG Platform — Esg Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "3137", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "397", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "758", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "909473945", cells: ["ESG-6945", "Esg Dashboard Item 1", "10/6/2026", "€24 045"], status: "active" as const },
    { id: "909477516", cells: ["ESG-1516", "Esg Dashboard Item 2", "25/1/2026", "€27 616"], status: "pending" as const },
    { id: "909481087", cells: ["ESG-5087", "Esg Dashboard Item 3", "12/8/2026", "€31 187"], status: "completed" as const },
    { id: "909484658", cells: ["ESG-8658", "Esg Dashboard Item 4", "27/3/2026", "€34 758"], status: "warning" as const },
    { id: "909488229", cells: ["ESG-3229", "Esg Dashboard Item 5", "14/10/2026", "€38 329"], status: "active" as const },
];
...
export default function EsgPlatformEsgDashboardPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Esg Dashboard</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">ESG Platform • Esg Dashboard</p>
                    </div>
                </div>
