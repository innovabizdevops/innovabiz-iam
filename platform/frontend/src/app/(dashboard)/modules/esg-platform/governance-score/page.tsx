...
/* ═══ ESG Platform — Governance Score ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "422", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "170", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2870", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1396294246", cells: ["ESG-8246", "Governance Score Item 1", "19/11/2026", "€44 346"], status: "active" as const },
    { id: "1396297817", cells: ["ESG-2817", "Governance Score Item 2", "6/6/2026", "€47 917"], status: "pending" as const },
    { id: "1396301388", cells: ["ESG-6388", "Governance Score Item 3", "21/1/2026", "€1488"], status: "completed" as const },
    { id: "1396304959", cells: ["ESG-9959", "Governance Score Item 4", "8/8/2026", "€5059"], status: "warning" as const },
    { id: "1396308530", cells: ["ESG-4530", "Governance Score Item 5", "23/3/2026", "€8630"], status: "active" as const },
];
...
export default function EsgPlatformGovernanceScorePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Governance Score</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">ESG Platform • Governance Score</p>
                    </div>
                </div>
