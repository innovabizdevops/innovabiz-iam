...
/* ═══ ESG Platform — Energy Intensity ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "3583", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "133", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3962", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1355303777", cells: ["ESG-3777", "Energy Intensity Item 1", "10/6/2026", "€3877"], status: "active" as const },
    { id: "1355307348", cells: ["ESG-7348", "Energy Intensity Item 2", "25/1/2026", "€7448"], status: "pending" as const },
    { id: "1355310919", cells: ["ESG-1919", "Energy Intensity Item 3", "12/8/2026", "€11 019"], status: "completed" as const },
    { id: "1355314490", cells: ["ESG-5490", "Energy Intensity Item 4", "27/3/2026", "€14 590"], status: "warning" as const },
    { id: "1355318061", cells: ["ESG-9061", "Energy Intensity Item 5", "14/10/2026", "€18 161"], status: "active" as const },
];
...
export default function EsgPlatformEnergyIntensityPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Energy Intensity</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">ESG Platform • Energy Intensity</p>
                    </div>
                </div>
