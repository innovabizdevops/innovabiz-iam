...
/* ═══ ESG Platform — Waste Diversion ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "3538", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "331", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1279", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "294425447", cells: ["ESG-9447", "Waste Diversion Item 1", "16/12/2026", "€25 547"], status: "active" as const },
    { id: "294429018", cells: ["ESG-4018", "Waste Diversion Item 2", "3/7/2026", "€29 118"], status: "pending" as const },
    { id: "294432589", cells: ["ESG-7589", "Waste Diversion Item 3", "18/2/2026", "€32 689"], status: "completed" as const },
    { id: "294436160", cells: ["ESG-2160", "Waste Diversion Item 4", "5/9/2026", "€36 260"], status: "warning" as const },
    { id: "294439731", cells: ["ESG-5731", "Waste Diversion Item 5", "20/4/2026", "€39 831"], status: "active" as const },
];
...
export default function EsgPlatformWasteDiversionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Waste Diversion</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">ESG Platform • Waste Diversion</p>
                    </div>
                </div>
