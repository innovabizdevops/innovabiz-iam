...
/* ═══ ESG Platform — Esg Reporting ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2605", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "51", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1305", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "214932735", cells: ["ESG-4735", "Esg Reporting Item 1", "4/4/2026", "€32 835"], status: "active" as const },
    { id: "214936306", cells: ["ESG-8306", "Esg Reporting Item 2", "19/11/2026", "€36 406"], status: "pending" as const },
    { id: "214939877", cells: ["ESG-2877", "Esg Reporting Item 3", "6/6/2026", "€39 977"], status: "completed" as const },
    { id: "214943448", cells: ["ESG-6448", "Esg Reporting Item 4", "21/1/2026", "€43 548"], status: "warning" as const },
    { id: "214947019", cells: ["ESG-1019", "Esg Reporting Item 5", "8/8/2026", "€47 119"], status: "active" as const },
];
...
export default function EsgPlatformEsgReportingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Esg Reporting</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">ESG Platform • Esg Reporting</p>
                    </div>
                </div>
