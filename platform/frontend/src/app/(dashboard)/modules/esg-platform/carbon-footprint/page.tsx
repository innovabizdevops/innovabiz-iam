...
/* ═══ ESG Platform — Carbon Footprint ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2950", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "118", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "163", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "563453650", cells: ["ESG-9650", "Carbon Footprint Item 1", "19/11/2026", "€3750"], status: "active" as const },
    { id: "563457221", cells: ["ESG-4221", "Carbon Footprint Item 2", "6/6/2026", "€7321"], status: "pending" as const },
    { id: "563460792", cells: ["ESG-7792", "Carbon Footprint Item 3", "21/1/2026", "€10 892"], status: "completed" as const },
    { id: "563464363", cells: ["ESG-2363", "Carbon Footprint Item 4", "8/8/2026", "€14 463"], status: "warning" as const },
    { id: "563467934", cells: ["ESG-5934", "Carbon Footprint Item 5", "23/3/2026", "€18 034"], status: "active" as const },
];
...
export default function EsgPlatformCarbonFootprintPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Carbon Footprint</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">ESG Platform • Carbon Footprint</p>
                    </div>
                </div>
