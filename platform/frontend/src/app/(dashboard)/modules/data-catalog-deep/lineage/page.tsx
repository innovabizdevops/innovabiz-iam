...
const PAGE = "Lineage";
const KPIS = [{"l":"Dashboards Ativos","v":"4.987","t":"+17.6%","d":"up"},{"l":"Queries/Dia","v":"2924","t":"+11.5%","d":"up"},{"l":"Dados Processados (GB)","v":"1.324","t":"-3.7%","d":"down"},{"l":"Utilizadores Analytics","v":"7.143","t":"-5.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3892","2026-02-24","7.092","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3752","2026-01-07","6.222","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3494","2026-02-16","8.844","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3614","2026-03-27","3.394","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2054","2026-03-07","3.503","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":431},{"label":"Mar","value":615},{"label":"Abr","value":616},{"label":"Mai","value":627},{"label":"Jun","value":421},{"label":"Jul","value":722},{"label":"Ago","value":618},{"label":"Set","value":690},{"label":"Out","value":645},{"label":"Nov","value":628},{"label":"Dez","value":443}];
const MX = 722;
