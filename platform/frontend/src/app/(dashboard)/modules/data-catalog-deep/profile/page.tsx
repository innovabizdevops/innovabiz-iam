...
const PAGE = "Profile";
const KPIS = [{"l":"Dashboards Ativos","v":"3.580","t":"+3.8%","d":"up"},{"l":"Queries/Dia","v":"4892","t":"-1.1%","d":"down"},{"l":"Dados Processados (GB)","v":"4.489","t":"+16.3%","d":"up"},{"l":"Utilizadores Analytics","v":"4.851","t":"+11.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3757","2026-02-22","7.768","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1629","2026-02-23","4.567","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2768","2026-02-07","5.176","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1906","2026-03-24","6.794","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2296","2026-02-04","4.199","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":391},{"label":"Fev","value":664},{"label":"Mar","value":426},{"label":"Abr","value":687},{"label":"Mai","value":731},{"label":"Jun","value":580},{"label":"Jul","value":406},{"label":"Ago","value":392},{"label":"Set","value":389},{"label":"Out","value":462},{"label":"Nov","value":724},{"label":"Dez","value":476}];
const MX = 731;
