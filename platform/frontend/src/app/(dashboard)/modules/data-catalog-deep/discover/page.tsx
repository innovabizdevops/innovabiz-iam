...
const PAGE = "Discover";
const KPIS = [{"l":"Dashboards Ativos","v":"5.077","t":"-3.9%","d":"down"},{"l":"Queries/Dia","v":"394","t":"+14.4%","d":"up"},{"l":"Dados Processados (GB)","v":"8.650","t":"+1.1%","d":"up"},{"l":"Utilizadores Analytics","v":"6.397","t":"-2.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5022","2026-03-01","4.046","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3939","2026-02-11","5.048","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2750","2026-03-23","5.651","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","5048","2026-02-25","6.505","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2478","2026-01-04","3.714","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":322},{"label":"Mar","value":603},{"label":"Abr","value":565},{"label":"Mai","value":362},{"label":"Jun","value":485},{"label":"Jul","value":467},{"label":"Ago","value":446},{"label":"Set","value":305},{"label":"Out","value":393},{"label":"Nov","value":421},{"label":"Dez","value":541}];
const MX = 603;
