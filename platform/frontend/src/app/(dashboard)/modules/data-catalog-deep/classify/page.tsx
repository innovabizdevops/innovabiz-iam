...
const ACCENT = "#1e3a5f";
const MODULE = "Data Catalog Deep";
const PAGE = "Classify";
const KPIS = [{"l":"Dashboards Ativos","v":"8.897","t":"+15.3%","d":"up"},{"l":"Queries/Dia","v":"4829","t":"-3.7%","d":"down"},{"l":"Dados Processados (GB)","v":"7.607","t":"+9.0%","d":"up"},{"l":"Utilizadores Analytics","v":"4.424","t":"-4.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2978","2026-03-12","6.044","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3751","2026-02-05","2.863","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","344","2026-02-15","7.209","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3572","2026-02-20","3.750","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4252","2026-01-24","3.727","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":713},{"label":"Fev","value":626},{"label":"Mar","value":510},{"label":"Abr","value":785},{"label":"Mai","value":654},{"label":"Jun","value":486},{"label":"Jul","value":559},{"label":"Ago","value":613},{"label":"Set","value":710},{"label":"Out","value":772},{"label":"Nov","value":726},{"label":"Dez","value":601}];
const MX = 785;
