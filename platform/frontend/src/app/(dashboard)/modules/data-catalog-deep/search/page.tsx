...
const PAGE = "Search";
const KPIS = [{"l":"Dashboards Ativos","v":"6.271","t":"+17.4%","d":"up"},{"l":"Queries/Dia","v":"1749","t":"+11.3%","d":"up"},{"l":"Dados Processados (GB)","v":"393","t":"+13.4%","d":"up"},{"l":"Utilizadores Analytics","v":"1.252","t":"+10.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1557","2026-01-28","7.937","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5056","2026-02-10","1.838","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3583","2026-03-17","8.245","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4497","2026-03-04","173","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1205","2026-02-08","1.294","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":553},{"label":"Mar","value":575},{"label":"Abr","value":670},{"label":"Mai","value":717},{"label":"Jun","value":383},{"label":"Jul","value":552},{"label":"Ago","value":423},{"label":"Set","value":532},{"label":"Out","value":714},{"label":"Nov","value":455},{"label":"Dez","value":431}];
const MX = 717;
