...
/* ═══ Data Catalog Deep — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "4754", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1207", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€465K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1385737354", cells: ["DAT-8354", "Data Catalog Deep Item 1", "23/11/2026", "€37 454"], status: "active" as const },
    { id: "1385740925", cells: ["DAT-2925", "Data Catalog Deep Item 2", "10/6/2026", "€41 025"], status: "pending" as const },
    { id: "1385744496", cells: ["DAT-6496", "Data Catalog Deep Item 3", "25/1/2026", "€44 596"], status: "completed" as const },
    { id: "1385748067", cells: ["DAT-1067", "Data Catalog Deep Item 4", "12/8/2026", "€48 167"], status: "warning" as const },
    { id: "1385751638", cells: ["DAT-4638", "Data Catalog Deep Item 5", "27/3/2026", "€1738"], status: "active" as const },
];
...
export default function DataCatalogDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Catalog Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Catalog Deep</p>
                    </div>
                </div>
