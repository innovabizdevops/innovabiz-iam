...
const PAGE = "HSE Management";
const KPIS = [{"l":"Projetos Melhoria","v":"5.931","t":"-1.0%","d":"down"},{"l":"Savings (€)","v":"€61884","t":"-0.6%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"70.9%","t":"+0.4%","d":"up"},{"l":"Ciclos PDCA","v":"5.089","t":"+4.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.355","€ 7604.40","3.173","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.377","€ 13571.09","7.567","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.781","€ 47344.13","343","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.085","€ 21968.80","211","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.264","€ 12987.64","6.860","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":417},{"label":"Mar","value":314},{"label":"Abr","value":490},{"label":"Mai","value":514},{"label":"Jun","value":629},{"label":"Jul","value":496},{"label":"Ago","value":632},{"label":"Set","value":534},{"label":"Out","value":425},{"label":"Nov","value":425},{"label":"Dez","value":495}];
const MX = 632;
