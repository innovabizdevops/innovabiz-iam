...
const PAGE = "Well Management";
const KPIS = [{"l":"Projetos Melhoria","v":"3.857","t":"+15.5%","d":"up"},{"l":"Savings (€)","v":"€83182","t":"-1.1%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"65.1%","t":"+6.3%","d":"up"},{"l":"Ciclos PDCA","v":"4.138","t":"-5.9%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.400","€ 32438.48","4.201","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.448","€ 6637.42","9.096","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.120","€ 19411.45","4.346","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.293","€ 4486.06","5.081","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.117","€ 42380.04","792","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":946},{"label":"Mar","value":818},{"label":"Abr","value":691},{"label":"Mai","value":908},{"label":"Jun","value":1004},{"label":"Jul","value":703},{"label":"Ago","value":778},{"label":"Set","value":666},{"label":"Out","value":783},{"label":"Nov","value":1044},{"label":"Dez","value":980}];
const MX = 1044;
