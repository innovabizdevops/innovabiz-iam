...
const PAGE = "Carbon Capture";
const KPIS = [{"l":"Total Oil Gas","v":"6.654","t":"+2.4%","d":"up"},{"l":"Carbon Capture Ativos","v":"7.729","t":"+0.8%","d":"up"},{"l":"Eficiência (%)","v":"81.9%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"60","t":"+10.1%","d":"up"}];
const COLS = ["ID","Carbon Capture","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Gas #001","Oil Gas #002","7.535","901","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Gas #002","Oil Gas #003","4.991","3.428","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Gas #003","Oil Gas #004","3.504","5.379","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Gas #004","Oil Gas #005","4.427","3.320","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Gas #005","Oil Gas #001","7.501","6.108","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":692},{"label":"Mar","value":652},{"label":"Abr","value":767},{"label":"Mai","value":623},{"label":"Jun","value":643},{"label":"Jul","value":507},{"label":"Ago","value":443},{"label":"Set","value":744},{"label":"Out","value":766},{"label":"Nov","value":627},{"label":"Dez","value":620}];
const MX = 767;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e3a5f'}}>ESG</span></h1>
                </div>
