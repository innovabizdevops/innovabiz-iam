...
const PAGE = "Midstream Pipeline";
const KPIS = [{"l":"Total Oil Gas","v":"2.093","t":"+14.2%","d":"up"},{"l":"Midstream Pipeline Ativos","v":"1.244","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"87.7%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"81","t":"+3.6%","d":"up"}];
const COLS = ["ID","Midstream Pipeline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Gas #001","Oil Gas #002","1.335","2.489","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Gas #002","Oil Gas #003","5.165","2.553","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Gas #003","Oil Gas #004","2.844","4.101","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Gas #004","Oil Gas #005","3.170","7.039","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Gas #005","Oil Gas #001","4.200","4.154","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":613},{"label":"Mar","value":715},{"label":"Abr","value":567},{"label":"Mai","value":613},{"label":"Jun","value":719},{"label":"Jul","value":559},{"label":"Ago","value":803},{"label":"Set","value":833},{"label":"Out","value":874},{"label":"Nov","value":883},{"label":"Dez","value":772}];
const MX = 883;
