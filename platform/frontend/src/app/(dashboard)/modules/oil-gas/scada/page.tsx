...
const ACCENT = "#1e3a5f";
const MODULE = "Oil & Gas Operations";
const PAGE = "SCADA Integration";
const KPIS = [{"l":"Dispositivos Online","v":"2.115","t":"+3.1%","d":"up"},{"l":"Dados/Min (MB)","v":"891","t":"-4.7%","d":"down"},{"l":"Alertas Ativos","v":"4.886","t":"+0.3%","d":"up"},{"l":"Uptime (%)","v":"85.1%","t":"+10.2%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.444","8.041","5.741","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","1.184","973","2.439","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.081","632","8.392","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","8.606","6.780","3.191","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.036","8.148","1.253","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":426},{"label":"Fev","value":552},{"label":"Mar","value":260},{"label":"Abr","value":263},{"label":"Mai","value":423},{"label":"Jun","value":458},{"label":"Jul","value":429},{"label":"Ago","value":219},{"label":"Set","value":600},{"label":"Out","value":420},{"label":"Nov","value":399},{"label":"Dez","value":308}];
const MX = 600;
