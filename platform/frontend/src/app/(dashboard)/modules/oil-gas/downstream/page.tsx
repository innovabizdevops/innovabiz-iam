...
const PAGE = "Downstream Refining";
const KPIS = [{"l":"Total Oil Gas","v":"1.740","t":"-2.8%","d":"down"},{"l":"Downstream Refining Ativos","v":"8.124","t":"-3.8%","d":"down"},{"l":"Eficiência (%)","v":"84.6%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"79","t":"+9.3%","d":"up"}];
const COLS = ["ID","Downstream Refining","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Gas #001","Oil Gas #002","8.712","1.798","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Gas #002","Oil Gas #003","6.163","6.211","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Gas #003","Oil Gas #004","1.960","5.281","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Gas #004","Oil Gas #005","4.976","5.362","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Gas #005","Oil Gas #001","818","4.628","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":776},{"label":"Mar","value":762},{"label":"Abr","value":576},{"label":"Mai","value":622},{"label":"Jun","value":725},{"label":"Jul","value":646},{"label":"Ago","value":638},{"label":"Set","value":655},{"label":"Out","value":742},{"label":"Nov","value":699},{"label":"Dez","value":765}];
const MX = 776;
