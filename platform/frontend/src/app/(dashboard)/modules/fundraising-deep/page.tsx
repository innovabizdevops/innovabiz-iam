...
/* ═══ Fundraising Platform Deep — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "2928", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1807", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€48K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "23703428", cells: ["FUN-7428", "Fundraising Platform Deep Item 1", "1/9/2026", "€3528"], status: "active" as const },
    { id: "23706999", cells: ["FUN-1999", "Fundraising Platform Deep Item 2", "16/4/2026", "€7099"], status: "pending" as const },
    { id: "23710570", cells: ["FUN-5570", "Fundraising Platform Deep Item 3", "3/11/2026", "€10 670"], status: "completed" as const },
    { id: "23714141", cells: ["FUN-9141", "Fundraising Platform Deep Item 4", "18/6/2026", "€14 241"], status: "warning" as const },
    { id: "23717712", cells: ["FUN-3712", "Fundraising Platform Deep Item 5", "5/1/2026", "€17 812"], status: "active" as const },
];
...
export default function FundraisingPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fundraising Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fundraising Platform Deep</p>
                    </div>
                </div>
