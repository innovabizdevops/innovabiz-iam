...
const PAGE = "e-Discovery";
const KPIS = [{"l":"Integrações Ativas","v":"8.648","t":"-5.4%","d":"down"},{"l":"Chamadas/Hora","v":"3617","t":"-4.1%","d":"down"},{"l":"Taxa Sucesso (%)","v":"69.1%","t":"+3.7%","d":"up"},{"l":"Latência Média (ms)","v":"197ms","t":"+14.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.380","8.845","89.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.547","8.185","98.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.003","187","93.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.219","4.380","77.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.308","1.642","85.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":806},{"label":"Fev","value":946},{"label":"Mar","value":1000},{"label":"Abr","value":1000},{"label":"Mai","value":935},{"label":"Jun","value":844},{"label":"Jul","value":680},{"label":"Ago","value":752},{"label":"Set","value":869},{"label":"Out","value":692},{"label":"Nov","value":850},{"label":"Dez","value":982}];
const MX = 1000;
