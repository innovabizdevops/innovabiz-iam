...
const KPIS = [{"l":"Projetos Melhoria","v":"7.596","t":"+12.3%","d":"up"},{"l":"Savings (€)","v":"€97470","t":"+17.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"88.3%","t":"+18.0%","d":"up"},{"l":"Ciclos PDCA","v":"7.596","t":"+1.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.801","€ 29706.97","3.987","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.795","€ 24557.87","2.765","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.916","€ 11943.40","444","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.863","€ 16913.37","4.791","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.726","€ 33816.50","5.877","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":394},{"label":"Mar","value":438},{"label":"Abr","value":453},{"label":"Mai","value":306},{"label":"Jun","value":444},{"label":"Jul","value":313},{"label":"Ago","value":394},{"label":"Set","value":405},{"label":"Out","value":378},{"label":"Nov","value":460},{"label":"Dez","value":605}];
const MX = 605;
