...
const PAGE = "Litigation Mgmt";
const KPIS = [{"l":"Projetos Melhoria","v":"2.475","t":"+5.3%","d":"up"},{"l":"Savings (€)","v":"€40329","t":"-5.0%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"79.2%","t":"-5.9%","d":"down"},{"l":"Ciclos PDCA","v":"5.684","t":"+13.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.557","€ 35075.85","7.225","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.272","€ 38576.92","3.036","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.765","€ 2973.70","8.994","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.535","€ 34955.36","3.225","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.301","€ 42395.55","2.874","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":689},{"label":"Mar","value":828},{"label":"Abr","value":687},{"label":"Mai","value":804},{"label":"Jun","value":783},{"label":"Jul","value":731},{"label":"Ago","value":731},{"label":"Set","value":731},{"label":"Out","value":845},{"label":"Nov","value":689},{"label":"Dez","value":681}];
const MX = 845;
