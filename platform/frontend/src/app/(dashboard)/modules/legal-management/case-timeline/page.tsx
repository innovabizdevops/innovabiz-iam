...
const PAGE = "Case Timeline";
const KPIS = [{"l":"Projetos Melhoria","v":"5.721","t":"+8.6%","d":"up"},{"l":"Savings (€)","v":"€38884","t":"+5.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"82.7%","t":"+7.6%","d":"up"},{"l":"Ciclos PDCA","v":"3.051","t":"+12.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.077","€ 34661.53","7.807","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.805","€ 8267.40","1.895","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","900","€ 6349.41","7.595","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","707","€ 40952.20","3.264","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.339","€ 29725.92","1.154","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":916},{"label":"Fev","value":975},{"label":"Mar","value":661},{"label":"Abr","value":788},{"label":"Mai","value":752},{"label":"Jun","value":890},{"label":"Jul","value":754},{"label":"Ago","value":796},{"label":"Set","value":1031},{"label":"Out","value":688},{"label":"Nov","value":1049},{"label":"Dez","value":800}];
const MX = 1049;
