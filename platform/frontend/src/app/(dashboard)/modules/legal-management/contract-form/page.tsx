...
const PAGE = "Contract Template Form";
const KPIS = [{"l":"Formulários Ativos","v":"2.136","t":"+4.8%","d":"up"},{"l":"Submissões/Dia","v":"1735","t":"+9.1%","d":"up"},{"l":"Documentos Gerados","v":"6.848","t":"+13.0%","d":"up"},{"l":"Templates","v":"4.234","t":"-3.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.832","2026-01-16","8.404","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.008","2026-01-06","1.029","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.865","2026-03-23","1.871","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.614","2026-02-11","8.078","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.647","2026-02-20","7.575","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":591},{"label":"Mar","value":555},{"label":"Abr","value":773},{"label":"Mai","value":742},{"label":"Jun","value":765},{"label":"Jul","value":527},{"label":"Ago","value":672},{"label":"Set","value":788},{"label":"Out","value":782},{"label":"Nov","value":537},{"label":"Dez","value":521}];
const MX = 788;
