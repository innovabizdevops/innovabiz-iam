...
const KPIS = [{"l":"Projetos Melhoria","v":"6.847","t":"+7.1%","d":"up"},{"l":"Savings (€)","v":"€95475","t":"+10.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"65.2%","t":"+11.1%","d":"up"},{"l":"Ciclos PDCA","v":"7.296","t":"+11.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.392","€ 40766.19","2.437","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.343","€ 22700.81","804","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.330","€ 21039.87","6.024","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","348","€ 33529.39","8.528","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.225","€ 22340.97","6.518","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":906},{"label":"Fev","value":726},{"label":"Mar","value":909},{"label":"Abr","value":748},{"label":"Mai","value":612},{"label":"Jun","value":871},{"label":"Jul","value":831},{"label":"Ago","value":745},{"label":"Set","value":654},{"label":"Out","value":583},{"label":"Nov","value":705},{"label":"Dez","value":877}];
const MX = 909;
