...
const PAGE = "Regulatory Filing";
const KPIS = [{"l":"Projetos Melhoria","v":"5.113","t":"+17.4%","d":"up"},{"l":"Savings (€)","v":"€73481","t":"+7.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"73.0%","t":"-0.2%","d":"down"},{"l":"Ciclos PDCA","v":"285","t":"+12.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","428","€ 19921.23","992","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.171","€ 27634.92","3.628","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.260","€ 43884.66","1.948","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.463","€ 11052.68","1.156","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.814","€ 3780.36","4.330","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":528},{"label":"Mar","value":456},{"label":"Abr","value":493},{"label":"Mai","value":461},{"label":"Jun","value":612},{"label":"Jul","value":656},{"label":"Ago","value":421},{"label":"Set","value":723},{"label":"Out","value":592},{"label":"Nov","value":682},{"label":"Dez","value":364}];
const MX = 723;
