...
const PAGE = "Legal Hold";
const KPIS = [{"l":"Projetos Melhoria","v":"7.784","t":"+5.3%","d":"up"},{"l":"Savings (€)","v":"€16947","t":"-0.5%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"76.2%","t":"+5.5%","d":"up"},{"l":"Ciclos PDCA","v":"7.456","t":"+9.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.491","€ 46774.70","6.530","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.886","€ 3059.07","3.318","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.414","€ 24582.46","5.089","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.340","€ 11895.83","4.778","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.453","€ 14427.21","6.777","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":623},{"label":"Mar","value":559},{"label":"Abr","value":768},{"label":"Mai","value":582},{"label":"Jun","value":768},{"label":"Jul","value":764},{"label":"Ago","value":623},{"label":"Set","value":472},{"label":"Out","value":680},{"label":"Nov","value":643},{"label":"Dez","value":654}];
const MX = 768;
