...
const ACCENT = "#6366f1";
const MODULE = "Legal Management";
const PAGE = "Outside Counsel";
const KPIS = [{"l":"Projetos Melhoria","v":"8.029","t":"-5.7%","d":"down"},{"l":"Savings (€)","v":"€48451","t":"+2.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"77.0%","t":"+9.7%","d":"up"},{"l":"Ciclos PDCA","v":"5.495","t":"+10.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.178","€ 4470.83","959","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.355","€ 6113.47","3.741","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.304","€ 5560.37","8.237","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.997","€ 45936.94","6.841","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.998","€ 41962.96","7.015","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":930},{"label":"Mar","value":653},{"label":"Abr","value":611},{"label":"Mai","value":862},{"label":"Jun","value":821},{"label":"Jul","value":995},{"label":"Ago","value":897},{"label":"Set","value":929},{"label":"Out","value":676},{"label":"Nov","value":984},{"label":"Dez","value":848}];
const MX = 995;
