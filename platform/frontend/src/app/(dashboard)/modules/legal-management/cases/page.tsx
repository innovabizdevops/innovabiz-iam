...
const PAGE = "Cases";
const KPIS = [{"l":"Projetos Melhoria","v":"5.302","t":"+1.7%","d":"up"},{"l":"Savings (€)","v":"€83473","t":"+9.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"76.3%","t":"-5.4%","d":"down"},{"l":"Ciclos PDCA","v":"3.130","t":"+0.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.981","€ 10860.21","8.575","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.684","€ 18373.01","6.466","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","755","€ 3956.59","1.277","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.822","€ 23221.40","6.931","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.408","€ 23604.48","2.938","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":486},{"label":"Fev","value":515},{"label":"Mar","value":598},{"label":"Abr","value":585},{"label":"Mai","value":419},{"label":"Jun","value":651},{"label":"Jul","value":618},{"label":"Ago","value":621},{"label":"Set","value":341},{"label":"Out","value":677},{"label":"Nov","value":365},{"label":"Dez","value":531}];
const MX = 677;
