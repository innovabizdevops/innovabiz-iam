...
const PAGE = "Decision";
const KPIS = [{"l":"Aprovações Pendentes","v":"754","t":"+17.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"94.9%","t":"+12.0%","d":"up"},{"l":"Tempo Médio (h)","v":"102h","t":"-4.3%","d":"down"},{"l":"Rejeitadas (%)","v":"77.2%","t":"-5.2%","d":"down"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","6.230","€ 47775.25","6.057","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","2.793","€ 35835.16","4.510","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","1.829","€ 32721.31","6.576","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","3.598","€ 41845.63","223","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","880","€ 26725.42","2.509","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":304},{"label":"Fev","value":571},{"label":"Mar","value":298},{"label":"Abr","value":644},{"label":"Mai","value":274},{"label":"Jun","value":436},{"label":"Jul","value":543},{"label":"Ago","value":527},{"label":"Set","value":371},{"label":"Out","value":399},{"label":"Nov","value":439},{"label":"Dez","value":499}];
const MX = 644;
