...
const ACCENT = "#dc2626";
const MODULE = "Certification Body";
const PAGE = "Surveillance";
const KPIS = [{"l":"Total Certification Body","v":"7.280","t":"-4.3%","d":"down"},{"l":"Surveillance Ativos","v":"3.065","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"79.5%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"85","t":"-5.1%","d":"down"}];
const COLS = ["ID","Surveillance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Certification Body #001","Certification Body #002","8.465","5.927","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Certification Body #002","Certification Body #003","117","1.989","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Certification Body #003","Certification Body #004","1.377","9.076","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Certification Body #004","Certification Body #005","334","7.871","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Certification Body #005","Certification Body #001","1.886","4.149","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":471},{"label":"Mar","value":557},{"label":"Abr","value":558},{"label":"Mai","value":664},{"label":"Jun","value":505},{"label":"Jul","value":748},{"label":"Ago","value":651},{"label":"Set","value":398},{"label":"Out","value":379},{"label":"Nov","value":610},{"label":"Dez","value":477}];
const MX = 748;
