...
const KPIS = [{"l":"Total Certification Body","v":"4.290","t":"+10.0%","d":"up"},{"l":"Assessment Ativos","v":"8.540","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"87.6%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"60","t":"+1.0%","d":"up"}];
const COLS = ["ID","Assessment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Certification Body #001","Certification Body #002","6.213","5.515","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Certification Body #002","Certification Body #003","8.894","1.593","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Certification Body #003","Certification Body #004","5.365","2.872","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Certification Body #004","Certification Body #005","638","6.357","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Certification Body #005","Certification Body #001","2.191","8.853","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":354},{"label":"Fev","value":265},{"label":"Mar","value":310},{"label":"Abr","value":534},{"label":"Mai","value":452},{"label":"Jun","value":530},{"label":"Jul","value":410},{"label":"Ago","value":593},{"label":"Set","value":571},{"label":"Out","value":428},{"label":"Nov","value":293},{"label":"Dez","value":498}];
const MX = 593;
