...
const PAGE = "Scheme Mgmt";
const KPIS = [{"l":"Total Certification Body","v":"6.747","t":"-4.1%","d":"down"},{"l":"Scheme Mgmt Ativos","v":"306","t":"+7.7%","d":"up"},{"l":"Eficiência (%)","v":"89.5%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"81","t":"+14.5%","d":"up"}];
const COLS = ["ID","Scheme Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Certification Body #001","Certification Body #002","2.838","3.622","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Certification Body #002","Certification Body #003","1.188","2.256","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Certification Body #003","Certification Body #004","4.985","6.050","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Certification Body #004","Certification Body #005","3.242","5.663","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Certification Body #005","Certification Body #001","2.648","4.919","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":594},{"label":"Mar","value":760},{"label":"Abr","value":712},{"label":"Mai","value":588},{"label":"Jun","value":497},{"label":"Jul","value":852},{"label":"Ago","value":761},{"label":"Set","value":715},{"label":"Out","value":489},{"label":"Nov","value":572},{"label":"Dez","value":768}];
const MX = 852;
