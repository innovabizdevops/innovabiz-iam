...
const KPIS = [{"l":"Total Certification Body","v":"3.780","t":"+12.7%","d":"up"},{"l":"Application Ativos","v":"7.392","t":"-5.4%","d":"down"},{"l":"Eficiência (%)","v":"79.0%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"65","t":"+1.6%","d":"up"}];
const COLS = ["ID","Application","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Certification Body #001","Certification Body #002","8.703","6.829","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Certification Body #002","Certification Body #003","4.528","6.541","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Certification Body #003","Certification Body #004","2.710","7.321","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Certification Body #004","Certification Body #005","2.929","2.935","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Certification Body #005","Certification Body #001","1.397","7.308","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":627},{"label":"Mar","value":634},{"label":"Abr","value":561},{"label":"Mai","value":815},{"label":"Jun","value":743},{"label":"Jul","value":799},{"label":"Ago","value":852},{"label":"Set","value":595},{"label":"Out","value":593},{"label":"Nov","value":682},{"label":"Dez","value":865}];
const MX = 865;
