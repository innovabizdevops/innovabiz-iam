...
/* ═══ AgriTech Deep (Precision) — Dashboard ═══ */

const ACCENT = "#22c55e";

const KPIS = [
    { label: "Total Registos", value: "7387", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "144", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€61K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "-20%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "457357587", cells: ["AGR-5587", "AgriTech Deep (Precision) Item 1", "16/4/2026", "€7687"], status: "active" as const },
    { id: "457361158", cells: ["AGR-9158", "AgriTech Deep (Precision) Item 2", "3/11/2026", "€11 258"], status: "pending" as const },
    { id: "457364729", cells: ["AGR-3729", "AgriTech Deep (Precision) Item 3", "18/6/2026", "€14 829"], status: "completed" as const },
    { id: "457368300", cells: ["AGR-7300", "AgriTech Deep (Precision) Item 4", "5/1/2026", "€18 400"], status: "warning" as const },
    { id: "457371871", cells: ["AGR-1871", "AgriTech Deep (Precision) Item 5", "20/8/2026", "€21 971"], status: "active" as const },
];
...
export default function AgritechDeepPrecisionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AgriTech Deep (Precision)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AgriTech Deep (Precision)</p>
                    </div>
                </div>
