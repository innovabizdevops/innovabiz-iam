...
const ACCENT = "#22c55e";
const MODULE = "AgriTech Deep (Precision)";
const PAGE = "Crop";
const KPIS = [{"l":"Total Agritech Deep","v":"7.991","t":"-5.0%","d":"down"},{"l":"Crop Ativos","v":"2.178","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"91.4%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"78","t":"+16.6%","d":"up"}];
const COLS = ["ID","Crop","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agritech Deep #001","Agritech Deep #002","7.861","4.682","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Agritech Deep #002","Agritech Deep #003","760","7.377","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Agritech Deep #003","Agritech Deep #004","8.940","6.290","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Agritech Deep #004","Agritech Deep #005","4.946","2.641","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agritech Deep #005","Agritech Deep #001","1.267","3.111","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1051},{"label":"Fev","value":1014},{"label":"Mar","value":817},{"label":"Abr","value":1029},{"label":"Mai","value":976},{"label":"Jun","value":981},{"label":"Jul","value":971},{"label":"Ago","value":711},{"label":"Set","value":751},{"label":"Out","value":883},{"label":"Nov","value":913},{"label":"Dez","value":725}];
const MX = 1051;
