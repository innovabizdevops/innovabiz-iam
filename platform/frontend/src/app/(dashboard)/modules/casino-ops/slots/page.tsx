...
const ACCENT = "#854d0e";
const MODULE = "Casino Operations";
const PAGE = "Slot Monitor";
const KPIS = [{"l":"Total Casino Ops","v":"4.454","t":"+15.4%","d":"up"},{"l":"Slot Monitor Ativos","v":"4.231","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"87.4%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"55","t":"+14.0%","d":"up"}];
const COLS = ["ID","Slot Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Casino Ops #001","Casino Ops #002","1.987","1.722","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Casino Ops #002","Casino Ops #003","4.035","5.466","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Casino Ops #003","Casino Ops #004","6.060","1.741","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Casino Ops #004","Casino Ops #005","1.820","135","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Casino Ops #005","Casino Ops #001","4.558","2.094","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":854},{"label":"Fev","value":670},{"label":"Mar","value":880},{"label":"Abr","value":770},{"label":"Mai","value":812},{"label":"Jun","value":666},{"label":"Jul","value":938},{"label":"Ago","value":940},{"label":"Set","value":1008},{"label":"Out","value":1000},{"label":"Nov","value":784},{"label":"Dez","value":986}];
const MX = 1008;
