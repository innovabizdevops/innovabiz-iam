...
const PAGE = "AML/CTR";
const KPIS = [{"l":"Total Casino Ops","v":"3.406","t":"+10.7%","d":"up"},{"l":"AML/CTR Ativos","v":"4.909","t":"+13.5%","d":"up"},{"l":"Eficiência (%)","v":"87.3%","t":"+14.1%","d":"up"},{"l":"Score Performance","v":"76","t":"+1.7%","d":"up"}];
const COLS = ["ID","AML/CTR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Casino Ops #001","Casino Ops #002","5.853","2.197","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Casino Ops #002","Casino Ops #003","5.194","6.642","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Casino Ops #003","Casino Ops #004","3.348","2.249","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Casino Ops #004","Casino Ops #005","2.911","2.654","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Casino Ops #005","Casino Ops #001","4.647","7.497","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":805},{"label":"Mar","value":869},{"label":"Abr","value":1010},{"label":"Mai","value":681},{"label":"Jun","value":692},{"label":"Jul","value":631},{"label":"Ago","value":632},{"label":"Set","value":800},{"label":"Out","value":630},{"label":"Nov","value":904},{"label":"Dez","value":820}];
const MX = 1010;
