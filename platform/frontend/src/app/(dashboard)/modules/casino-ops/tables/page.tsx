...
const KPIS = [{"l":"Total Casino Ops","v":"8.704","t":"+13.7%","d":"up"},{"l":"Table Mgmt Ativos","v":"4.458","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"86.6%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"66","t":"+8.4%","d":"up"}];
const COLS = ["ID","Table Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Casino Ops #001","Casino Ops #002","5.902","5.200","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Casino Ops #002","Casino Ops #003","4.567","3.160","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Casino Ops #003","Casino Ops #004","6.821","6.415","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Casino Ops #004","Casino Ops #005","6.455","9.095","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Casino Ops #005","Casino Ops #001","4.318","1.824","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":421},{"label":"Mar","value":288},{"label":"Abr","value":535},{"label":"Mai","value":589},{"label":"Jun","value":520},{"label":"Jul","value":318},{"label":"Ago","value":625},{"label":"Set","value":598},{"label":"Out","value":550},{"label":"Nov","value":427},{"label":"Dez","value":433}];
const MX = 625;
