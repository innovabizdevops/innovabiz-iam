...
const PAGE = "Cage Ops";
const KPIS = [{"l":"Total Casino Ops","v":"7.107","t":"+0.5%","d":"up"},{"l":"Cage Ops Ativos","v":"8.759","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"94.5%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"92","t":"+8.3%","d":"up"}];
const COLS = ["ID","Cage Ops","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Casino Ops #001","Casino Ops #002","3.504","8.150","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Casino Ops #002","Casino Ops #003","4.018","600","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Casino Ops #003","Casino Ops #004","8.968","8.000","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Casino Ops #004","Casino Ops #005","4.340","5.186","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Casino Ops #005","Casino Ops #001","169","1.671","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":304},{"label":"Fev","value":417},{"label":"Mar","value":296},{"label":"Abr","value":589},{"label":"Mai","value":574},{"label":"Jun","value":408},{"label":"Jul","value":633},{"label":"Ago","value":563},{"label":"Set","value":432},{"label":"Out","value":325},{"label":"Nov","value":334},{"label":"Dez","value":404}];
const MX = 633;
