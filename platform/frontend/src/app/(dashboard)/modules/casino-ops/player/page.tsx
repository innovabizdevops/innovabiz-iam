...
const PAGE = "Player Track";
const KPIS = [{"l":"Total Casino Ops","v":"4.777","t":"+16.2%","d":"up"},{"l":"Player Track Ativos","v":"5.629","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"72.4%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"80","t":"-1.5%","d":"down"}];
const COLS = ["ID","Player Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Casino Ops #001","Casino Ops #002","6.856","2.480","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Casino Ops #002","Casino Ops #003","3.163","5.156","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Casino Ops #003","Casino Ops #004","968","938","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Casino Ops #004","Casino Ops #005","3.439","1.960","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Casino Ops #005","Casino Ops #001","7.817","592","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":953},{"label":"Fev","value":705},{"label":"Mar","value":792},{"label":"Abr","value":750},{"label":"Mai","value":679},{"label":"Jun","value":829},{"label":"Jul","value":850},{"label":"Ago","value":626},{"label":"Set","value":568},{"label":"Out","value":705},{"label":"Nov","value":792},{"label":"Dez","value":848}];
const MX = 953;
