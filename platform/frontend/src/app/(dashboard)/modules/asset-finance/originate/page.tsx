...
const ACCENT = "#b45309";
const MODULE = "Asset Finance";
const PAGE = "Lease Originate";
const KPIS = [{"l":"Ativos Registados","v":"4.159","t":"-0.2%","d":"down"},{"l":"Valor Total (€M)","v":"€38.4M","t":"+11.4%","d":"up"},{"l":"Depreciação Anual (€)","v":"€73941","t":"+6.5%","d":"up"},{"l":"Ativos em Garantia","v":"7.565","t":"+9.8%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 40087.31","2.841","€ 27127.87","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 31750.13","2.155","€ 33201.83","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 22162.23","3.816","€ 16430.47","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 22131.82","7.898","€ 43358.43","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 12082.98","2.671","€ 36448.00","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":318},{"label":"Fev","value":401},{"label":"Mar","value":351},{"label":"Abr","value":440},{"label":"Mai","value":611},{"label":"Jun","value":601},{"label":"Jul","value":552},{"label":"Ago","value":368},{"label":"Set","value":263},{"label":"Out","value":366},{"label":"Nov","value":320},{"label":"Dez","value":519}];
const MX = 611;
