...
const PAGE = "Remarketing";
const KPIS = [{"l":"Ativos Registados","v":"4.017","t":"+0.2%","d":"up"},{"l":"Valor Total (€M)","v":"€42.8M","t":"+2.3%","d":"up"},{"l":"Depreciação Anual (€)","v":"€52041","t":"-2.5%","d":"down"},{"l":"Ativos em Garantia","v":"1.837","t":"-5.2%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 17072.21","7.198","€ 38363.42","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 20193.87","2.136","€ 19922.34","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 23250.81","3.860","€ 539.80","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 19172.98","2.764","€ 22278.73","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 12962.11","1.448","€ 35817.56","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":562},{"label":"Mar","value":602},{"label":"Abr","value":790},{"label":"Mai","value":807},{"label":"Jun","value":519},{"label":"Jul","value":427},{"label":"Ago","value":515},{"label":"Set","value":476},{"label":"Out","value":715},{"label":"Nov","value":741},{"label":"Dez","value":618}];
const MX = 807;
