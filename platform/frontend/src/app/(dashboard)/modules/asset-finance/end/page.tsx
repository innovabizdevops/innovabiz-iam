...
const PAGE = "End of Term";
const KPIS = [{"l":"Riscos Identificados","v":"2.721","t":"+5.3%","d":"up"},{"l":"Mitigações Ativas","v":"8.916","t":"+0.4%","d":"up"},{"l":"Score Risco Geral","v":"68","t":"-2.2%","d":"down"},{"l":"Incidentes YTD","v":"3.776","t":"+1.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","265","615","8.970","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","487","1.204","2.070","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.411","4.197","1.495","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.681","123","2.570","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","496","3.657","4.426","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":776},{"label":"Mar","value":561},{"label":"Abr","value":515},{"label":"Mai","value":687},{"label":"Jun","value":647},{"label":"Jul","value":602},{"label":"Ago","value":780},{"label":"Set","value":558},{"label":"Out","value":660},{"label":"Nov","value":817},{"label":"Dez","value":638}];
const MX = 817;
