...
const KPIS = [{"l":"Ativos Registados","v":"8.244","t":"+13.8%","d":"up"},{"l":"Valor Total (€M)","v":"€27.9M","t":"+11.8%","d":"up"},{"l":"Depreciação Anual (€)","v":"€32312","t":"+9.5%","d":"up"},{"l":"Ativos em Garantia","v":"3.671","t":"+9.9%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 24122.63","7.344","€ 10814.30","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 4220.03","6.109","€ 2612.82","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 1171.47","1.336","€ 18682.98","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 25713.73","7.353","€ 40244.24","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 11521.53","5.975","€ 15333.22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":504},{"label":"Fev","value":318},{"label":"Mar","value":290},{"label":"Abr","value":602},{"label":"Mai","value":304},{"label":"Jun","value":535},{"label":"Jul","value":290},{"label":"Ago","value":277},{"label":"Set","value":472},{"label":"Out","value":533},{"label":"Nov","value":246},{"label":"Dez","value":612}];
const MX = 612;
