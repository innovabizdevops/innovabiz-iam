...
const PAGE = "Billing";
const KPIS = [{"l":"Ativos Registados","v":"8.618","t":"+5.7%","d":"up"},{"l":"Valor Total (€M)","v":"€17.4M","t":"+2.1%","d":"up"},{"l":"Depreciação Anual (€)","v":"€83287","t":"+5.5%","d":"up"},{"l":"Ativos em Garantia","v":"1.500","t":"-5.4%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 13830.30","388","€ 9590.25","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 23054.14","7.033","€ 44883.71","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 37695.47","3.602","€ 32385.84","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 46912.52","2.698","€ 16118.40","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 32266.29","7.849","€ 47001.03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":930},{"label":"Mar","value":847},{"label":"Abr","value":865},{"label":"Mai","value":654},{"label":"Jun","value":926},{"label":"Jul","value":888},{"label":"Ago","value":777},{"label":"Set","value":716},{"label":"Out","value":750},{"label":"Nov","value":763},{"label":"Dez","value":962}];
const MX = 962;
