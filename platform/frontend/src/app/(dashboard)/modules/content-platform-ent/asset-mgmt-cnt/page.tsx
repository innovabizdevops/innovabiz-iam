...
const ROWS = [
  { id: "001", c: ["Asset Mgmt Cnt-001", "Asset Mgmt Cnt Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Asset Mgmt Cnt-002", "Asset Mgmt Cnt Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Asset Mgmt Cnt-003", "Asset Mgmt Cnt Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Asset Mgmt Cnt-004", "Asset Mgmt Cnt Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Asset Mgmt Cnt-005", "Asset Mgmt Cnt Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Asset Mgmt Cnt", ts: "Há 2min", a: "Sistema" },
...
export default function AssetMgmtCntPage() {
  return (
