...
const PAGE = "Personalization Cnt";
const KPIS = [{"l":"Artigos KB","v":"24,847","d":"+6.2%","u":true},{"l":"Visualizações/Dia","v":"8,423","d":"+12.3%","u":true},{"l":"Contribuidores","v":"342","d":"+5.1%","u":true},{"l":"Satisfação (%)","v":"88.4%","d":"+2.8%","u":true}];
const COLS = ["Conteúdo","Categoria","Autor","Views","Última Edição","Estado"];
const ROWS = [
  { id: "001", c: ["Personalization Cnt-001", "Personalization Cnt Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Personalization Cnt-002", "Personalization Cnt Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Personalization Cnt-003", "Personalization Cnt Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Personalization Cnt-004", "Personalization Cnt Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Personalization Cnt-005", "Personalization Cnt Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Personalization Cnt", ts: "Há 2min", a: "Sistema" },
...
export default function PersonalizationCntPage() {
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Content Platform — iBOS Enterprise</p>
        </div>
