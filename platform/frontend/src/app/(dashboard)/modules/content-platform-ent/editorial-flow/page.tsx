...
const ROWS = [
  { id: "001", c: ["Editorial Flow-001", "Editorial Flow Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Editorial Flow-002", "Editorial Flow Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Editorial Flow-003", "Editorial Flow Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Editorial Flow-004", "Editorial Flow Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Editorial Flow-005", "Editorial Flow Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Editorial Flow", ts: "Há 2min", a: "Sistema" },
...
export default function EditorialFlowPage() {
  return (
