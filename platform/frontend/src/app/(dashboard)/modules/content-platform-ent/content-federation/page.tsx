...
const ROWS = [
  { id: "001", c: ["Content Federation-001", "Content Federation Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Content Federation-002", "Content Federation Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Content Federation-003", "Content Federation Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Content Federation-004", "Content Federation Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Content Federation-005", "Content Federation Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Content Federation", ts: "Há 2min", a: "Sistema" },
...
export default function ContentFederationPage() {
  return (
