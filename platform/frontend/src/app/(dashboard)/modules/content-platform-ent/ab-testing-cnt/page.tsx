...
const ROWS = [
  { id: "001", c: ["Ab Testing Cnt-001", "Ab Testing Cnt Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Ab Testing Cnt-002", "Ab Testing Cnt Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Ab Testing Cnt-003", "Ab Testing Cnt Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Ab Testing Cnt-004", "Ab Testing Cnt Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Ab Testing Cnt-005", "Ab Testing Cnt Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Ab Testing Cnt", ts: "Há 2min", a: "Sistema" },
...
export default function AbTestingCntPage() {
  return (
