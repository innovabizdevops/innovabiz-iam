...
const PAGE = "Track";
const KPIS = [{"l":"Integrações Ativas","v":"2.701","t":"+8.6%","d":"up"},{"l":"Chamadas/Hora","v":"1961","t":"+14.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"82.5%","t":"+8.4%","d":"up"},{"l":"Latência Média (ms)","v":"39ms","t":"+8.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.752","3.339","75.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","546","387","85.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","665","7.928","74.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","587","261","94.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.266","6.727","89.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":619},{"label":"Mar","value":604},{"label":"Abr","value":649},{"label":"Mai","value":681},{"label":"Jun","value":579},{"label":"Jul","value":318},{"label":"Ago","value":655},{"label":"Set","value":509},{"label":"Out","value":696},{"label":"Nov","value":647},{"label":"Dez","value":459}];
const MX = 696;
