...
const PAGE = "Guide";
const KPIS = [{"l":"Integrações Ativas","v":"4.863","t":"+14.3%","d":"up"},{"l":"Chamadas/Hora","v":"3830","t":"+1.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"93.2%","t":"+16.6%","d":"up"},{"l":"Latência Média (ms)","v":"73ms","t":"-2.3%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.601","1.647","85.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.677","4.263","95.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.328","458","92.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","393","8.102","82.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.852","7.071","84.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":770},{"label":"Mar","value":624},{"label":"Abr","value":880},{"label":"Mai","value":708},{"label":"Jun","value":842},{"label":"Jul","value":942},{"label":"Ago","value":583},{"label":"Set","value":676},{"label":"Out","value":918},{"label":"Nov","value":603},{"label":"Dez","value":870}];
const MX = 942;
