...
const PAGE = "Content";
const KPIS = [{"l":"Integrações Ativas","v":"3.720","t":"+11.0%","d":"up"},{"l":"Chamadas/Hora","v":"1896","t":"+16.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.3%","t":"+7.1%","d":"up"},{"l":"Latência Média (ms)","v":"20ms","t":"+6.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.977","4.030","98.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.022","632","84.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","484","8.885","87.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.611","257","98.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.446","1.442","94.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":579},{"label":"Mar","value":389},{"label":"Abr","value":607},{"label":"Mai","value":390},{"label":"Jun","value":233},{"label":"Jul","value":367},{"label":"Ago","value":557},{"label":"Set","value":330},{"label":"Out","value":554},{"label":"Nov","value":506},{"label":"Dez","value":593}];
const MX = 607;
