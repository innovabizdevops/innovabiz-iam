...
const PAGE = "Session";
const KPIS = [{"l":"Integrações Ativas","v":"1.118","t":"+5.8%","d":"up"},{"l":"Chamadas/Hora","v":"696","t":"+0.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"83.9%","t":"+10.8%","d":"up"},{"l":"Latência Média (ms)","v":"28ms","t":"-5.4%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.436","2.807","93.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.825","6.110","85.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.898","5.086","94.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.045","7.618","90.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.943","8.694","72.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":870},{"label":"Fev","value":937},{"label":"Mar","value":827},{"label":"Abr","value":817},{"label":"Mai","value":689},{"label":"Jun","value":884},{"label":"Jul","value":680},{"label":"Ago","value":697},{"label":"Set","value":687},{"label":"Out","value":674},{"label":"Nov","value":903},{"label":"Dez","value":915}];
const MX = 937;
