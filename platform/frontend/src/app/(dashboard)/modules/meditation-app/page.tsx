...
export default function MeditationAppPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Meditation App</h1><p className="text-sm text-muted-foreground">Meditation App • iBOS Enterprise</p></div>
