...
const ACCENT = "#6366f1";
const MODULE = "Meditation App";
const PAGE = "Community";
const KPIS = [{"l":"Integrações Ativas","v":"1.080","t":"+0.2%","d":"up"},{"l":"Chamadas/Hora","v":"2834","t":"+0.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"80.1%","t":"+6.2%","d":"up"},{"l":"Latência Média (ms)","v":"74ms","t":"+7.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.691","4.318","80.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.051","4.441","90.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.534","3.118","94.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.531","6.458","92.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.894","7.106","88.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":715},{"label":"Fev","value":754},{"label":"Mar","value":934},{"label":"Abr","value":815},{"label":"Mai","value":1039},{"label":"Jun","value":900},{"label":"Jul","value":853},{"label":"Ago","value":836},{"label":"Set","value":947},{"label":"Out","value":742},{"label":"Nov","value":1015},{"label":"Dez","value":802}];
const MX = 1039;
