...
const ACCENT = "#c026d3";
const MODULE = "Gender Equality Office";
const PAGE = "Advocacy";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.353","t":"-4.4%","d":"down"},{"l":"NC Abertas","v":"4.419","t":"+13.5%","d":"up"},{"l":"Conformidade (%)","v":"86.2%","t":"-4.4%","d":"down"},{"l":"CAPAs Pendentes","v":"3.284","t":"+16.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.244","96.0%","689","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","9.042","95.7%","5.541","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.818","99.0%","526","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.219","96.9%","2.135","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.156","96.5%","6.755","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":565},{"label":"Fev","value":505},{"label":"Mar","value":234},{"label":"Abr","value":286},{"label":"Mai","value":518},{"label":"Jun","value":481},{"label":"Jul","value":592},{"label":"Ago","value":503},{"label":"Set","value":236},{"label":"Out","value":544},{"label":"Nov","value":535},{"label":"Dez","value":306}];
const MX = 592;
