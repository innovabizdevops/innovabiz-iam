...
/* ═══ Gender Equality Office — Dashboard ═══ */

const ACCENT = "#c026d3";

const KPIS = [
    { label: "Total Registos", value: "3319", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1177", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€409K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "-2%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1088844819", cells: ["GEN-7819", "Gender Equality Office Item 1", "28/4/2026", "€44 919"], status: "active" as const },
    { id: "1088848390", cells: ["GEN-2390", "Gender Equality Office Item 2", "15/11/2026", "€48 490"], status: "pending" as const },
    { id: "1088851961", cells: ["GEN-5961", "Gender Equality Office Item 3", "2/6/2026", "€2061"], status: "completed" as const },
    { id: "1088855532", cells: ["GEN-9532", "Gender Equality Office Item 4", "17/1/2026", "€5632"], status: "warning" as const },
    { id: "1088859103", cells: ["GEN-4103", "Gender Equality Office Item 5", "4/8/2026", "€9203"], status: "active" as const },
];
...
export default function GenderEqualityOfficePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Gender Equality Office</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Gender Equality Office</p>
                    </div>
                </div>
