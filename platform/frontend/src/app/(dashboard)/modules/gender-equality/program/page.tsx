...
const PAGE = "Program";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.053","t":"+9.2%","d":"up"},{"l":"NC Abertas","v":"6.195","t":"+5.4%","d":"up"},{"l":"Conformidade (%)","v":"74.5%","t":"-5.8%","d":"down"},{"l":"CAPAs Pendentes","v":"864","t":"+9.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.614","93.0%","5.492","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.394","90.5%","6.256","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.211","99.7%","330","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.190","79.2%","7.370","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.774","81.9%","2.020","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":813},{"label":"Fev","value":566},{"label":"Mar","value":615},{"label":"Abr","value":649},{"label":"Mai","value":511},{"label":"Jun","value":635},{"label":"Jul","value":536},{"label":"Ago","value":721},{"label":"Set","value":708},{"label":"Out","value":547},{"label":"Nov","value":591},{"label":"Dez","value":807}];
const MX = 813;
