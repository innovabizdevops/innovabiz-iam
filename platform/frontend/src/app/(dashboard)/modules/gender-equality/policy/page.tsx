...
const PAGE = "Policy";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.084","t":"+6.8%","d":"up"},{"l":"NC Abertas","v":"1.493","t":"+5.2%","d":"up"},{"l":"Conformidade (%)","v":"75.5%","t":"-2.8%","d":"down"},{"l":"CAPAs Pendentes","v":"5.275","t":"-4.7%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.753","91.2%","2.391","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.311","89.1%","4.026","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.277","90.7%","8.240","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.004","72.0%","4.629","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.563","78.7%","6.248","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":587},{"label":"Mar","value":672},{"label":"Abr","value":350},{"label":"Mai","value":348},{"label":"Jun","value":340},{"label":"Jul","value":546},{"label":"Ago","value":725},{"label":"Set","value":658},{"label":"Out","value":630},{"label":"Nov","value":599},{"label":"Dez","value":708}];
const MX = 725;
