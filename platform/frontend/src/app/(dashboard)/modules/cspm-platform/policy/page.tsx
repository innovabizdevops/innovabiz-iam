...
const PAGE = "Policy";
const KPIS = [{"l":"Formulários Ativos","v":"7.955","t":"+14.0%","d":"up"},{"l":"Submissões/Dia","v":"1116","t":"+2.9%","d":"up"},{"l":"Documentos Gerados","v":"1.961","t":"-0.2%","d":"down"},{"l":"Templates","v":"6.968","t":"+3.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.804","2026-01-18","3.770","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.736","2026-01-27","8.737","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.760","2026-01-06","3.427","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.851","2026-01-14","5.392","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.171","2026-03-11","8.446","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":714},{"label":"Fev","value":809},{"label":"Mar","value":669},{"label":"Abr","value":794},{"label":"Mai","value":608},{"label":"Jun","value":860},{"label":"Jul","value":758},{"label":"Ago","value":757},{"label":"Set","value":927},{"label":"Out","value":757},{"label":"Nov","value":842},{"label":"Dez","value":879}];
const MX = 927;
