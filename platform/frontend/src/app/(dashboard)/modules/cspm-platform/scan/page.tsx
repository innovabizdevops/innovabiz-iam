...
const PAGE = "Scan";
const KPIS = [{"l":"Formulários Ativos","v":"150","t":"-1.2%","d":"down"},{"l":"Submissões/Dia","v":"3416","t":"+14.8%","d":"up"},{"l":"Documentos Gerados","v":"2.414","t":"+14.8%","d":"up"},{"l":"Templates","v":"7.080","t":"+0.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.977","2026-01-28","5.027","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.297","2026-01-08","6.470","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.969","2026-03-07","1.542","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.403","2026-03-06","5.066","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","802","2026-03-17","1.347","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":550},{"label":"Fev","value":389},{"label":"Mar","value":484},{"label":"Abr","value":462},{"label":"Mai","value":666},{"label":"Jun","value":530},{"label":"Jul","value":417},{"label":"Ago","value":615},{"label":"Set","value":589},{"label":"Out","value":662},{"label":"Nov","value":366},{"label":"Dez","value":724}];
const MX = 724;
