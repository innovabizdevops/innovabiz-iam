...
const ACCENT = "#7f1d1d";
const MODULE = "CSPM Platform";
const PAGE = "Remediate";
const KPIS = [{"l":"Formulários Ativos","v":"7.645","t":"-2.0%","d":"down"},{"l":"Submissões/Dia","v":"836","t":"+3.7%","d":"up"},{"l":"Documentos Gerados","v":"906","t":"-0.6%","d":"down"},{"l":"Templates","v":"5.159","t":"+1.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.027","2026-01-03","2.170","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.231","2026-03-13","2.395","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.223","2026-03-07","3.898","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.596","2026-01-14","1.564","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.983","2026-01-07","455","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1067},{"label":"Fev","value":832},{"label":"Mar","value":1000},{"label":"Abr","value":724},{"label":"Mai","value":954},{"label":"Jun","value":875},{"label":"Jul","value":774},{"label":"Ago","value":816},{"label":"Set","value":971},{"label":"Out","value":1087},{"label":"Nov","value":908},{"label":"Dez","value":924}];
const MX = 1087;
