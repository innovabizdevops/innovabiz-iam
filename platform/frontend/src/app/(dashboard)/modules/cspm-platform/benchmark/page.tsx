...
const KPIS = [{"l":"Formulários Ativos","v":"8.188","t":"+6.3%","d":"up"},{"l":"Submissões/Dia","v":"2502","t":"-2.7%","d":"down"},{"l":"Documentos Gerados","v":"5.084","t":"+9.2%","d":"up"},{"l":"Templates","v":"151","t":"+2.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.303","2026-01-23","6.018","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","249","2026-03-15","992","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.732","2026-03-20","1.943","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.437","2026-03-01","2.827","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","672","2026-02-28","8.656","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":306},{"label":"Fev","value":570},{"label":"Mar","value":589},{"label":"Abr","value":330},{"label":"Mai","value":555},{"label":"Jun","value":633},{"label":"Jul","value":323},{"label":"Ago","value":544},{"label":"Set","value":584},{"label":"Out","value":583},{"label":"Nov","value":292},{"label":"Dez","value":621}];
const MX = 633;
