...
/* ═══ CSPM Platform — Dashboard ═══ */

const ACCENT = "#7f1d1d";

const KPIS = [
    { label: "Total Registos", value: "4034", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3171", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€459K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "96835834", cells: ["CSP-5834", "CSPM Platform Item 1", "19/11/2026", "€35 934"], status: "active" as const },
    { id: "96839405", cells: ["CSP-9405", "CSPM Platform Item 2", "6/6/2026", "€39 505"], status: "pending" as const },
    { id: "96842976", cells: ["CSP-3976", "CSPM Platform Item 3", "21/1/2026", "€43 076"], status: "completed" as const },
    { id: "96846547", cells: ["CSP-7547", "CSPM Platform Item 4", "8/8/2026", "€46 647"], status: "warning" as const },
    { id: "96850118", cells: ["CSP-2118", "CSPM Platform Item 5", "23/3/2026", "€218"], status: "active" as const },
];
...
export default function CspmPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CSPM Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CSPM Platform</p>
                    </div>
                </div>
