...
const PAGE = "Report";
const KPIS = [{"l":"Formulários Ativos","v":"3.096","t":"-3.1%","d":"down"},{"l":"Submissões/Dia","v":"3100","t":"-5.4%","d":"down"},{"l":"Documentos Gerados","v":"8.821","t":"+6.8%","d":"up"},{"l":"Templates","v":"3.400","t":"+16.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.628","2026-03-07","1.322","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.651","2026-01-18","8.567","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.634","2026-03-14","5.420","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.995","2026-03-04","6.747","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","288","2026-03-01","8.030","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":901},{"label":"Fev","value":669},{"label":"Mar","value":698},{"label":"Abr","value":816},{"label":"Mai","value":825},{"label":"Jun","value":964},{"label":"Jul","value":896},{"label":"Ago","value":921},{"label":"Set","value":751},{"label":"Out","value":950},{"label":"Nov","value":750},{"label":"Dez","value":782}];
const MX = 964;
