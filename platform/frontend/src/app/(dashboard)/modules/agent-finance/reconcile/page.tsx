...
const ACCENT = "#7c3aed";
const MODULE = "AI Finance Agent";
const PAGE = "Reconcile";
const KPIS = [{"l":"Total Agent Finance","v":"5.598","t":"+11.8%","d":"up"},{"l":"Reconcile Ativos","v":"4.389","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"68.2%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"86","t":"+12.5%","d":"up"}];
const COLS = ["ID","Reconcile","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agent Finance #001","Agent Finance #002","8.205","2.549","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Agent Finance #002","Agent Finance #003","3.065","8.311","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Agent Finance #003","Agent Finance #004","7.939","408","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Agent Finance #004","Agent Finance #005","7.214","7.289","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agent Finance #005","Agent Finance #001","7.019","5.358","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":342},{"label":"Fev","value":566},{"label":"Mar","value":256},{"label":"Abr","value":525},{"label":"Mai","value":486},{"label":"Jun","value":248},{"label":"Jul","value":310},{"label":"Ago","value":439},{"label":"Set","value":498},{"label":"Out","value":590},{"label":"Nov","value":626},{"label":"Dez","value":534}];
const MX = 626;
