...
const KPIS = [
    { label: "Total Registos", value: "631", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2313", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€374K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "-14%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1287069831", cells: ["AGE-7831", "AI Finance Agent Item 1", "20/4/2026", "€19 931"], status: "active" as const },
    { id: "1287073402", cells: ["AGE-2402", "AI Finance Agent Item 2", "7/11/2026", "€23 502"], status: "pending" as const },
    { id: "1287076973", cells: ["AGE-5973", "AI Finance Agent Item 3", "22/6/2026", "€27 073"], status: "completed" as const },
    { id: "1287080544", cells: ["AGE-9544", "AI Finance Agent Item 4", "9/1/2026", "€30 644"], status: "warning" as const },
    { id: "1287084115", cells: ["AGE-4115", "AI Finance Agent Item 5", "24/8/2026", "€34 215"], status: "active" as const },
];
...
export default function AiFinanceAgentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Finance Agent</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Finance Agent</p>
                    </div>
                </div>
