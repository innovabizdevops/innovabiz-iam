...
const PAGE = "Report";
const KPIS = [{"l":"Total Agent Finance","v":"8.249","t":"+9.4%","d":"up"},{"l":"Report Ativos","v":"4.126","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"75.1%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"69","t":"-0.8%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agent Finance #001","Agent Finance #002","3.392","5.606","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Agent Finance #002","Agent Finance #003","7.543","2.227","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Agent Finance #003","Agent Finance #004","6.496","3.641","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Agent Finance #004","Agent Finance #005","5.236","3.851","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agent Finance #005","Agent Finance #001","2.594","292","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":738},{"label":"Mar","value":706},{"label":"Abr","value":604},{"label":"Mai","value":947},{"label":"Jun","value":794},{"label":"Jul","value":589},{"label":"Ago","value":618},{"label":"Set","value":838},{"label":"Out","value":604},{"label":"Nov","value":624},{"label":"Dez","value":606}];
const MX = 947;
