...
/* ═══ iBOS Holographic Overseer — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "6843", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1696", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€180K", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1217380043", cells: ["IBO-5043", "iBOS Holographic Overseer Item 1", "20/12/2026", "€30 143"], status: "active" as const },
    { id: "1217383614", cells: ["IBO-8614", "iBOS Holographic Overseer Item 2", "7/7/2026", "€33 714"], status: "pending" as const },
    { id: "1217387185", cells: ["IBO-3185", "iBOS Holographic Overseer Item 3", "22/2/2026", "€37 285"], status: "completed" as const },
    { id: "1217390756", cells: ["IBO-6756", "iBOS Holographic Overseer Item 4", "9/9/2026", "€40 856"], status: "warning" as const },
    { id: "1217394327", cells: ["IBO-1327", "iBOS Holographic Overseer Item 5", "24/4/2026", "€44 427"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 63 }, { label: "Fev", value: 72 }, { label: "Mar", value: 81 }, { label: "Abr", value: 90 }, { label: "Mai", value: 99 }, { label: "Jun", value: 28 }];
...
export default function IbosHolographicOverseerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">iBOS Holographic Overseer</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • iBOS Holographic Overseer</p>
                    </div>
                </div>
