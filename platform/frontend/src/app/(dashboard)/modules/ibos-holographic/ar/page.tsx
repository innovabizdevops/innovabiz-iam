...
const PAGE = "AR View";
const KPIS = [{"l":"Total Ibos Holographic","v":"4.826","t":"-0.1%","d":"down"},{"l":"AR View Ativos","v":"4.193","t":"+1.2%","d":"up"},{"l":"Eficiência (%)","v":"81.7%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"62","t":"+12.8%","d":"up"}];
const COLS = ["ID","AR View","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ibos Holographic #001","Ibos Holographic #002","8.160","3.992","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Ibos Holographic #002","Ibos Holographic #003","1.204","349","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Ibos Holographic #003","Ibos Holographic #004","3.867","3.470","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Ibos Holographic #004","Ibos Holographic #005","8.703","6.642","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ibos Holographic #005","Ibos Holographic #001","3.322","4.459","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":391},{"label":"Fev","value":451},{"label":"Mar","value":527},{"label":"Abr","value":428},{"label":"Mai","value":555},{"label":"Jun","value":588},{"label":"Jul","value":430},{"label":"Ago","value":360},{"label":"Set","value":351},{"label":"Out","value":563},{"label":"Nov","value":642},{"label":"Dez","value":627}];
const MX = 642;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#312e81'}}>XR</span></h1>
                </div>
