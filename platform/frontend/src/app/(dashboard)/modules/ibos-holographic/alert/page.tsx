...
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"4.613","t":"+9.5%","d":"up"},{"l":"Taxa Entrega (%)","v":"75.9%","t":"+9.4%","d":"up"},{"l":"Taxa Abertura (%)","v":"73.9%","t":"+8.9%","d":"up"},{"l":"Escalações","v":"500","t":"+12.0%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","2.095","96.0%","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","8.450","88.4%","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","3.142","71.8%","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","2.037","77.4%","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","2.138","80.8%","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":818},{"label":"Fev","value":780},{"label":"Mar","value":769},{"label":"Abr","value":466},{"label":"Mai","value":608},{"label":"Jun","value":751},{"label":"Jul","value":496},{"label":"Ago","value":484},{"label":"Set","value":830},{"label":"Out","value":769},{"label":"Nov","value":459},{"label":"Dez","value":686}];
const MX = 830;
