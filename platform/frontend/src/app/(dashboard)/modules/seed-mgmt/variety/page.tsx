...
const PAGE = "Variety";
const KPIS = [{"l":"Total Seed Mgmt","v":"5.663","t":"+11.3%","d":"up"},{"l":"Variety Ativos","v":"8.136","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"80.4%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"91","t":"-5.9%","d":"down"}];
const COLS = ["ID","Variety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Seed Mgmt #001","Seed Mgmt #002","6.705","8.687","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Seed Mgmt #002","Seed Mgmt #003","8.167","5.686","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Seed Mgmt #003","Seed Mgmt #004","6.036","4.208","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Seed Mgmt #004","Seed Mgmt #005","7.476","2.600","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Seed Mgmt #005","Seed Mgmt #001","7.743","4.490","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":612},{"label":"Mar","value":789},{"label":"Abr","value":578},{"label":"Mai","value":841},{"label":"Jun","value":651},{"label":"Jul","value":825},{"label":"Ago","value":723},{"label":"Set","value":685},{"label":"Out","value":833},{"label":"Nov","value":636},{"label":"Dez","value":856}];
const MX = 856;
