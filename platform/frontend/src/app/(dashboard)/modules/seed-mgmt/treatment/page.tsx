...
const KPIS = [{"l":"Total Seed Mgmt","v":"8.181","t":"+6.2%","d":"up"},{"l":"Treatment Ativos","v":"3.394","t":"+0.6%","d":"up"},{"l":"Eficiência (%)","v":"91.4%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"57","t":"+2.3%","d":"up"}];
const COLS = ["ID","Treatment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Seed Mgmt #001","Seed Mgmt #002","4.244","2.543","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Seed Mgmt #002","Seed Mgmt #003","6.796","4.429","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Seed Mgmt #003","Seed Mgmt #004","4.495","3.277","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Seed Mgmt #004","Seed Mgmt #005","790","6.823","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Seed Mgmt #005","Seed Mgmt #001","4.695","4.910","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":896},{"label":"Mar","value":927},{"label":"Abr","value":757},{"label":"Mai","value":836},{"label":"Jun","value":626},{"label":"Jul","value":780},{"label":"Ago","value":590},{"label":"Set","value":955},{"label":"Out","value":878},{"label":"Nov","value":880},{"label":"Dez","value":784}];
const MX = 955;
