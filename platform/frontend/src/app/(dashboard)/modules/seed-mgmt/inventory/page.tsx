...
const ACCENT = "#6366f1";
const MODULE = "Seed Management";
const PAGE = "Inventory";
const KPIS = [{"l":"Total Seed Mgmt","v":"5.931","t":"+17.3%","d":"up"},{"l":"Inventory Ativos","v":"2.015","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"74.4%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"60","t":"+3.6%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Seed Mgmt #001","Seed Mgmt #002","1.329","3.736","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Seed Mgmt #002","Seed Mgmt #003","8.501","8.902","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Seed Mgmt #003","Seed Mgmt #004","6.975","4.004","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Seed Mgmt #004","Seed Mgmt #005","1.630","6.776","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Seed Mgmt #005","Seed Mgmt #001","8.300","6.846","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":262},{"label":"Fev","value":459},{"label":"Mar","value":400},{"label":"Abr","value":339},{"label":"Mai","value":563},{"label":"Jun","value":364},{"label":"Jul","value":360},{"label":"Ago","value":367},{"label":"Set","value":420},{"label":"Out","value":393},{"label":"Nov","value":338},{"label":"Dez","value":384}];
const MX = 563;
