...
const KPIS = [{"l":"Auditorias Realizadas","v":"6.495","t":"-5.6%","d":"down"},{"l":"NC Abertas","v":"8.939","t":"+16.4%","d":"up"},{"l":"Conformidade (%)","v":"71.3%","t":"-0.3%","d":"down"},{"l":"CAPAs Pendentes","v":"3.672","t":"+13.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","753","77.2%","4.251","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.293","89.7%","6.067","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.079","71.7%","8.087","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.352","78.8%","1.527","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.557","73.2%","8.760","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":1029},{"label":"Mar","value":832},{"label":"Abr","value":922},{"label":"Mai","value":922},{"label":"Jun","value":824},{"label":"Jul","value":1031},{"label":"Ago","value":876},{"label":"Set","value":779},{"label":"Out","value":811},{"label":"Nov","value":659},{"label":"Dez","value":782}];
const MX = 1031;
