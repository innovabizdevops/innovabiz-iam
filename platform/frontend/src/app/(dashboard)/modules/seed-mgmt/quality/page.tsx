...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.945","t":"+11.0%","d":"up"},{"l":"NC Abertas","v":"5.020","t":"-5.5%","d":"down"},{"l":"Conformidade (%)","v":"73.5%","t":"+11.4%","d":"up"},{"l":"CAPAs Pendentes","v":"3.713","t":"+11.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","999","86.2%","631","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.430","88.8%","6.193","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.546","82.3%","5.346","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.293","91.5%","431","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.266","75.9%","8.057","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":869},{"label":"Mar","value":641},{"label":"Abr","value":756},{"label":"Mai","value":841},{"label":"Jun","value":798},{"label":"Jul","value":822},{"label":"Ago","value":921},{"label":"Set","value":918},{"label":"Out","value":654},{"label":"Nov","value":706},{"label":"Dez","value":738}];
const MX = 921;
