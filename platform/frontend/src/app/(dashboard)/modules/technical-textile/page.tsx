...
export default function TechnicalTextilePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Technical Textile</h1><p className="text-sm text-muted-foreground">Technical Textile • iBOS Enterprise</p></div>
