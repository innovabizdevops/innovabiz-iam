...
const PAGE = "Medical";
const KPIS = [{"l":"Integrações Ativas","v":"4.153","t":"+6.0%","d":"up"},{"l":"Chamadas/Hora","v":"1943","t":"+10.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"89.7%","t":"-3.3%","d":"down"},{"l":"Latência Média (ms)","v":"174ms","t":"+6.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.090","7.259","94.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.572","8.248","78.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.215","7.417","76.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.386","7.608","71.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.398","6.892","78.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":741},{"label":"Fev","value":1051},{"label":"Mar","value":1015},{"label":"Abr","value":704},{"label":"Mai","value":827},{"label":"Jun","value":856},{"label":"Jul","value":828},{"label":"Ago","value":965},{"label":"Set","value":751},{"label":"Out","value":862},{"label":"Nov","value":1009},{"label":"Dez","value":895}];
const MX = 1051;
