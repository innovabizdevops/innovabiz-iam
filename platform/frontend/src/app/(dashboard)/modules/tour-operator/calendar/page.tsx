...
const PAGE = "Tour Calendar";
const KPIS = [{"l":"Total Tour Operator","v":"6.967","t":"+12.6%","d":"up"},{"l":"Tour Calendar Ativos","v":"1.164","t":"+6.4%","d":"up"},{"l":"Eficiência (%)","v":"66.4%","t":"+17.8%","d":"up"},{"l":"Score Performance","v":"69","t":"-0.6%","d":"down"}];
const COLS = ["ID","Tour Calendar","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tour Operator #001","Tour Operator #002","2.898","2.244","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Tour Operator #002","Tour Operator #003","7.820","167","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Tour Operator #003","Tour Operator #004","3.534","6.080","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Tour Operator #004","Tour Operator #005","2.623","7.955","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tour Operator #005","Tour Operator #001","4.586","9.004","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":965},{"label":"Fev","value":843},{"label":"Mar","value":884},{"label":"Abr","value":888},{"label":"Mai","value":704},{"label":"Jun","value":900},{"label":"Jul","value":940},{"label":"Ago","value":673},{"label":"Set","value":796},{"label":"Out","value":619},{"label":"Nov","value":920},{"label":"Dez","value":862}];
const MX = 965;
