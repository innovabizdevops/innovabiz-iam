...
const ACCENT = "#a16207";
const MODULE = "Tour Operator";
const PAGE = "Safety Brief";
const KPIS = [{"l":"Total Tour Operator","v":"7.439","t":"-3.5%","d":"down"},{"l":"Safety Brief Ativos","v":"7.011","t":"+10.2%","d":"up"},{"l":"Eficiência (%)","v":"88.9%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"66","t":"+2.5%","d":"up"}];
const COLS = ["ID","Safety Brief","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tour Operator #001","Tour Operator #002","8.190","1.647","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Tour Operator #002","Tour Operator #003","1.765","7.752","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Tour Operator #003","Tour Operator #004","5.767","1.791","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Tour Operator #004","Tour Operator #005","6.404","5.110","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tour Operator #005","Tour Operator #001","2.120","4.390","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":973},{"label":"Mar","value":768},{"label":"Abr","value":819},{"label":"Mai","value":648},{"label":"Jun","value":906},{"label":"Jul","value":682},{"label":"Ago","value":708},{"label":"Set","value":930},{"label":"Out","value":864},{"label":"Nov","value":872},{"label":"Dez","value":699}];
const MX = 973;
