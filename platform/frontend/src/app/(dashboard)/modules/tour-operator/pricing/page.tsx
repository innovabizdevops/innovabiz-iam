...
const PAGE = "Pricing Mgmt";
const KPIS = [{"l":"ARR (€M)","v":"€8.0M","t":"+15.6%","d":"up"},{"l":"MRR (€)","v":"€25311","t":"-5.2%","d":"down"},{"l":"Churn (%)","v":"69.8%","t":"-4.7%","d":"down"},{"l":"ARPU (€)","v":"€44786","t":"-3.3%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 7250.65","8.159","€ 44826.75","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 9268.07","6.840","€ 28589.44","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 27783.32","822","€ 3939.16","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 12252.30","6.314","€ 28833.09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 42181.07","6.227","€ 13940.25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":835},{"label":"Mar","value":670},{"label":"Abr","value":811},{"label":"Mai","value":634},{"label":"Jun","value":718},{"label":"Jul","value":736},{"label":"Ago","value":795},{"label":"Set","value":721},{"label":"Out","value":805},{"label":"Nov","value":508},{"label":"Dez","value":831}];
const MX = 835;
