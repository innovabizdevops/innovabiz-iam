...
const PAGE = "Guide Assign";
const KPIS = [{"l":"Artigos Publicados","v":"5.039","t":"-3.3%","d":"down"},{"l":"Views/Semana","v":"1518","t":"+7.2%","d":"up"},{"l":"Feedback Útil (%)","v":"71.6%","t":"+15.1%","d":"up"},{"l":"Artigos Desatualizados","v":"5.996","t":"+9.4%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","1.306","92.2%","5.656","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","6.597","82.7%","5.444","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","4.213","90.5%","2.092","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","8.658","72.6%","2.570","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","945","83.1%","5.548","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":438},{"label":"Mar","value":676},{"label":"Abr","value":622},{"label":"Mai","value":573},{"label":"Jun","value":621},{"label":"Jul","value":481},{"label":"Ago","value":575},{"label":"Set","value":642},{"label":"Out","value":473},{"label":"Nov","value":757},{"label":"Dez","value":505}];
const MX = 783;
