...
const ROWS = [
  { id: "001", c: ["Vendor Negotiate-001", "Vendor Negotiate Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Vendor Negotiate-002", "Vendor Negotiate Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Vendor Negotiate-003", "Vendor Negotiate Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Vendor Negotiate-004", "Vendor Negotiate Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Vendor Negotiate-005", "Vendor Negotiate Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Vendor Negotiate", ts: "Há 2min", a: "Sistema" },
...
export default function VendorNegotiatePage() {
  return (
