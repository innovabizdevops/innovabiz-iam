...
const ROWS = [
  { id: "001", c: ["Coalition Build-001", "Coalition Build Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Coalition Build-002", "Coalition Build Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Coalition Build-003", "Coalition Build Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Coalition Build-004", "Coalition Build Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Coalition Build-005", "Coalition Build Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Coalition Build", ts: "Há 2min", a: "Sistema" },
...
export default function CoalitionBuildPage() {
  return (
