...
const ROWS = [
  { id: "001", c: ["Volume Commit-001", "Volume Commit Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Volume Commit-002", "Volume Commit Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Volume Commit-003", "Volume Commit Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Volume Commit-004", "Volume Commit Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Volume Commit-005", "Volume Commit Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Volume Commit", ts: "Há 2min", a: "Sistema" },
...
export default function VolumeCommitPage() {
  return (
