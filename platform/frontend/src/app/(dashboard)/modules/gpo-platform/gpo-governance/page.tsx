...
const ROWS = [
  { id: "001", c: ["Gpo Governance-001", "Gpo Governance Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Gpo Governance-002", "Gpo Governance Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Gpo Governance-003", "Gpo Governance Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Gpo Governance-004", "Gpo Governance Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Gpo Governance-005", "Gpo Governance Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Gpo Governance", ts: "Há 2min", a: "Sistema" },
...
export default function GpoGovernancePage() {
  return (
