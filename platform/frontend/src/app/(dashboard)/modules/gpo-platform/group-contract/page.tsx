...
const ROWS = [
  { id: "001", c: ["Group Contract-001", "Group Contract Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Group Contract-002", "Group Contract Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Group Contract-003", "Group Contract Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Group Contract-004", "Group Contract Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Group Contract-005", "Group Contract Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Group Contract", ts: "Há 2min", a: "Sistema" },
...
export default function GroupContractPage() {
  return (
