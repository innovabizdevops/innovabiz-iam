...
const PAGE = "Security Zone";
const KPIS = [{"l":"Total Stadium Ops","v":"8.827","t":"+11.4%","d":"up"},{"l":"Security Zone Ativos","v":"903","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"85.0%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"58","t":"+11.7%","d":"up"}];
const COLS = ["ID","Security Zone","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stadium Ops #001","Stadium Ops #002","8.462","3.018","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Stadium Ops #002","Stadium Ops #003","7.068","2.147","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Stadium Ops #003","Stadium Ops #004","4.873","3.136","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Stadium Ops #004","Stadium Ops #005","1.140","1.124","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stadium Ops #005","Stadium Ops #001","6.114","4.520","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":422},{"label":"Fev","value":392},{"label":"Mar","value":518},{"label":"Abr","value":322},{"label":"Mai","value":490},{"label":"Jun","value":261},{"label":"Jul","value":290},{"label":"Ago","value":278},{"label":"Set","value":482},{"label":"Out","value":403},{"label":"Nov","value":590},{"label":"Dez","value":436}];
const MX = 590;
