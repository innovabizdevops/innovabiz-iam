...
const KPIS = [{"l":"Total Stadium Ops","v":"3.923","t":"+6.7%","d":"up"},{"l":"Maintenance Ativos","v":"7.576","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"87.4%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"93","t":"-5.8%","d":"down"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stadium Ops #001","Stadium Ops #002","2.035","4.921","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Stadium Ops #002","Stadium Ops #003","6.245","7.195","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Stadium Ops #003","Stadium Ops #004","3.365","1.406","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Stadium Ops #004","Stadium Ops #005","4.421","7.500","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stadium Ops #005","Stadium Ops #001","8.660","7.038","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":338},{"label":"Fev","value":386},{"label":"Mar","value":514},{"label":"Abr","value":650},{"label":"Mai","value":555},{"label":"Jun","value":447},{"label":"Jul","value":537},{"label":"Ago","value":636},{"label":"Set","value":701},{"label":"Out","value":320},{"label":"Nov","value":544},{"label":"Dez","value":445}];
const MX = 701;
