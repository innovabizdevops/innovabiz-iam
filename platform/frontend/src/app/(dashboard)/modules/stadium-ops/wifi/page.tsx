...
const ACCENT = "#1e40af";
const MODULE = "Stadium Operations";
const PAGE = "WiFi Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"6.047","t":"+16.8%","d":"up"},{"l":"Queries/Dia","v":"1908","t":"+15.9%","d":"up"},{"l":"Dados Processados (GB)","v":"1.141","t":"+0.7%","d":"up"},{"l":"Utilizadores Analytics","v":"1.135","t":"+3.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4622","2026-01-08","2.710","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2059","2026-02-12","1.619","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3184","2026-03-08","1.705","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3003","2026-01-22","4.254","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2178","2026-03-11","8.805","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":800},{"label":"Mar","value":808},{"label":"Abr","value":858},{"label":"Mai","value":741},{"label":"Jun","value":730},{"label":"Jul","value":668},{"label":"Ago","value":789},{"label":"Set","value":582},{"label":"Out","value":731},{"label":"Nov","value":900},{"label":"Dez","value":731}];
const MX = 900;
