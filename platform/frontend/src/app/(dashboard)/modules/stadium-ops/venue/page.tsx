...
const PAGE = "Venue Map";
const KPIS = [{"l":"Total Stadium Ops","v":"2.226","t":"+5.7%","d":"up"},{"l":"Venue Map Ativos","v":"6.354","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"81.3%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"86","t":"+8.1%","d":"up"}];
const COLS = ["ID","Venue Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stadium Ops #001","Stadium Ops #002","3.101","3.862","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Stadium Ops #002","Stadium Ops #003","6.839","5.856","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Stadium Ops #003","Stadium Ops #004","7.300","3.900","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Stadium Ops #004","Stadium Ops #005","524","6.406","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stadium Ops #005","Stadium Ops #001","8.176","8.737","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":834},{"label":"Mar","value":806},{"label":"Abr","value":762},{"label":"Mai","value":686},{"label":"Jun","value":901},{"label":"Jul","value":629},{"label":"Ago","value":944},{"label":"Set","value":914},{"label":"Out","value":702},{"label":"Nov","value":867},{"label":"Dez","value":896}];
const MX = 944;
