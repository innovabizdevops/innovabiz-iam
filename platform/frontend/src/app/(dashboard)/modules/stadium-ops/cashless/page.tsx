...
const PAGE = "Cashless Pay";
const KPIS = [{"l":"Total Stadium Ops","v":"3.167","t":"-2.0%","d":"down"},{"l":"Cashless Pay Ativos","v":"7.669","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"+11.9%","d":"up"},{"l":"Score Performance","v":"77","t":"+12.6%","d":"up"}];
const COLS = ["ID","Cashless Pay","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stadium Ops #001","Stadium Ops #002","8.537","4.230","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Stadium Ops #002","Stadium Ops #003","5.924","1.953","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Stadium Ops #003","Stadium Ops #004","3.297","2.112","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Stadium Ops #004","Stadium Ops #005","193","5.004","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stadium Ops #005","Stadium Ops #001","7.632","7.288","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":637},{"label":"Mar","value":612},{"label":"Abr","value":723},{"label":"Mai","value":901},{"label":"Jun","value":900},{"label":"Jul","value":784},{"label":"Ago","value":570},{"label":"Set","value":718},{"label":"Out","value":744},{"label":"Nov","value":900},{"label":"Dez","value":514}];
const MX = 901;
