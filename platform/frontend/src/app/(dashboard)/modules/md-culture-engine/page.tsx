...
/* ═══ MD: Multi-Culture Engine Deep — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "1118", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3867", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€389K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "479616418", cells: ["MD-7418", "MD: Multi-Culture Engine Deep Item 1", "23/11/2026", "€16 518"], status: "active" as const },
    { id: "479619989", cells: ["MD-1989", "MD: Multi-Culture Engine Deep Item 2", "10/6/2026", "€20 089"], status: "pending" as const },
    { id: "479623560", cells: ["MD-5560", "MD: Multi-Culture Engine Deep Item 3", "25/1/2026", "€23 660"], status: "completed" as const },
    { id: "479627131", cells: ["MD-9131", "MD: Multi-Culture Engine Deep Item 4", "12/8/2026", "€27 231"], status: "warning" as const },
    { id: "479630702", cells: ["MD-3702", "MD: Multi-Culture Engine Deep Item 5", "27/3/2026", "€30 802"], status: "active" as const },
];
...
export default function MdMulticultureEngineDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Culture Engine Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Culture Engine Deep</p>
                    </div>
                </div>
