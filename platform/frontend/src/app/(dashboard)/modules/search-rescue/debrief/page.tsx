...
const ACCENT = "#6366f1";
const MODULE = "Search & Rescue";
const PAGE = "Debrief";
const KPIS = [{"l":"Total Search Rescue","v":"7.510","t":"+11.4%","d":"up"},{"l":"Debrief Ativos","v":"7.354","t":"+11.9%","d":"up"},{"l":"Eficiência (%)","v":"94.2%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"74","t":"+17.7%","d":"up"}];
const COLS = ["ID","Debrief","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Search Rescue #001","Search Rescue #002","1.466","8.332","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Search Rescue #002","Search Rescue #003","7.915","6.486","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Search Rescue #003","Search Rescue #004","6.414","6.613","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Search Rescue #004","Search Rescue #005","2.137","3.390","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Search Rescue #005","Search Rescue #001","6.458","638","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":733},{"label":"Mar","value":399},{"label":"Abr","value":700},{"label":"Mai","value":485},{"label":"Jun","value":359},{"label":"Jul","value":572},{"label":"Ago","value":420},{"label":"Set","value":623},{"label":"Out","value":735},{"label":"Nov","value":509},{"label":"Dez","value":535}];
const MX = 735;
