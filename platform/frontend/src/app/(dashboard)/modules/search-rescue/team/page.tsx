...
const PAGE = "Team";
const KPIS = [{"l":"Teams Ativos","v":"4.098","t":"-5.4%","d":"down"},{"l":"Reuniões/Semana","v":"4119","t":"+14.7%","d":"up"},{"l":"Mensagens/Dia","v":"3996","t":"+5.2%","d":"up"},{"l":"Ficheiros Partilhados","v":"4.615","t":"+3.2%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","3.096","2320","6.131","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","609","811","4.418","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","8.697","3947","6.674","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","6.661","4207","1.346","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","6.393","1236","8.169","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":432},{"label":"Mar","value":597},{"label":"Abr","value":510},{"label":"Mai","value":507},{"label":"Jun","value":534},{"label":"Jul","value":294},{"label":"Ago","value":602},{"label":"Set","value":298},{"label":"Out","value":545},{"label":"Nov","value":412},{"label":"Dez","value":382}];
const MX = 602;
