...
const PAGE = "K9";
const KPIS = [{"l":"Total Search Rescue","v":"2.646","t":"-4.7%","d":"down"},{"l":"K9 Ativos","v":"3.659","t":"+14.5%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"74","t":"+8.3%","d":"up"}];
const COLS = ["ID","K9","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Search Rescue #001","Search Rescue #002","8.380","5.546","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Search Rescue #002","Search Rescue #003","4.047","6.028","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Search Rescue #003","Search Rescue #004","8.216","6.834","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Search Rescue #004","Search Rescue #005","2.682","2.599","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Search Rescue #005","Search Rescue #001","4.261","2.190","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":360},{"label":"Fev","value":481},{"label":"Mar","value":392},{"label":"Abr","value":478},{"label":"Mai","value":498},{"label":"Jun","value":644},{"label":"Jul","value":386},{"label":"Ago","value":664},{"label":"Set","value":346},{"label":"Out","value":653},{"label":"Nov","value":424},{"label":"Dez","value":642}];
const MX = 664;
