...
const PAGE = "Mission";
const KPIS = [{"l":"Total Search Rescue","v":"379","t":"+4.2%","d":"up"},{"l":"Mission Ativos","v":"8.995","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"85.7%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"88","t":"+14.6%","d":"up"}];
const COLS = ["ID","Mission","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Search Rescue #001","Search Rescue #002","2.608","3.359","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Search Rescue #002","Search Rescue #003","8.850","9.085","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Search Rescue #003","Search Rescue #004","1.560","1.240","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Search Rescue #004","Search Rescue #005","7.822","1.701","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Search Rescue #005","Search Rescue #001","7.251","8.390","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":618},{"label":"Mar","value":597},{"label":"Abr","value":666},{"label":"Mai","value":947},{"label":"Jun","value":717},{"label":"Jul","value":964},{"label":"Ago","value":821},{"label":"Set","value":569},{"label":"Out","value":922},{"label":"Nov","value":889},{"label":"Dez","value":935}];
const MX = 964;
