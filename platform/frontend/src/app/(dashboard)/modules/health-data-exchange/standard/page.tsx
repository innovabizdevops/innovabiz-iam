...
const PAGE = "Standard";
const KPIS = [{"l":"Dashboards Ativos","v":"190","t":"+14.9%","d":"up"},{"l":"Queries/Dia","v":"2073","t":"+4.6%","d":"up"},{"l":"Dados Processados (GB)","v":"6.095","t":"-1.3%","d":"down"},{"l":"Utilizadores Analytics","v":"312","t":"+9.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2642","2026-02-24","3.578","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3177","2026-03-07","9.067","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","960","2026-01-07","8.390","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3880","2026-02-08","6.334","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4048","2026-03-21","3.642","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":673},{"label":"Mar","value":694},{"label":"Abr","value":589},{"label":"Mai","value":592},{"label":"Jun","value":638},{"label":"Jul","value":766},{"label":"Ago","value":516},{"label":"Set","value":660},{"label":"Out","value":871},{"label":"Nov","value":707},{"label":"Dez","value":743}];
const MX = 871;
