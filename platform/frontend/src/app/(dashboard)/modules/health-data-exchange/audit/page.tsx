...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.079","t":"+5.2%","d":"up"},{"l":"NC Abertas","v":"2.391","t":"+5.9%","d":"up"},{"l":"Conformidade (%)","v":"87.2%","t":"+9.4%","d":"up"},{"l":"CAPAs Pendentes","v":"4.642","t":"+14.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.620","81.8%","3.964","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.227","71.2%","7.306","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.501","79.0%","3.895","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.700","95.7%","3.101","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.425","77.8%","6.949","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":1003},{"label":"Mar","value":985},{"label":"Abr","value":894},{"label":"Mai","value":650},{"label":"Jun","value":850},{"label":"Jul","value":709},{"label":"Ago","value":614},{"label":"Set","value":805},{"label":"Out","value":897},{"label":"Nov","value":714},{"label":"Dez","value":686}];
const MX = 1003;
