...
const ACCENT = "#65a30d";
const MODULE = "Health Data Exchange (HIE)";
const PAGE = "Consent";
const KPIS = [{"l":"Dashboards Ativos","v":"4.603","t":"-3.0%","d":"down"},{"l":"Queries/Dia","v":"1198","t":"+15.0%","d":"up"},{"l":"Dados Processados (GB)","v":"7.823","t":"+11.8%","d":"up"},{"l":"Utilizadores Analytics","v":"4.444","t":"-1.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1073","2026-02-28","849","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3639","2026-01-15","5.145","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1094","2026-02-13","8.160","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","493","2026-01-08","334","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3488","2026-01-22","1.406","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":920},{"label":"Fev","value":1064},{"label":"Mar","value":704},{"label":"Abr","value":979},{"label":"Mai","value":722},{"label":"Jun","value":718},{"label":"Jul","value":1037},{"label":"Ago","value":882},{"label":"Set","value":977},{"label":"Out","value":814},{"label":"Nov","value":1024},{"label":"Dez","value":817}];
const MX = 1064;
