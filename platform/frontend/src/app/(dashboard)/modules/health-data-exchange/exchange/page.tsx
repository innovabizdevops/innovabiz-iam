...
const PAGE = "Exchange";
const KPIS = [{"l":"Dashboards Ativos","v":"5.306","t":"+6.6%","d":"up"},{"l":"Queries/Dia","v":"639","t":"+14.5%","d":"up"},{"l":"Dados Processados (GB)","v":"3.934","t":"+10.7%","d":"up"},{"l":"Utilizadores Analytics","v":"4.496","t":"-2.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3969","2026-01-04","5.539","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","578","2026-01-19","952","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1007","2026-02-28","6.222","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3983","2026-03-20","5.806","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1129","2026-03-27","3.671","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":373},{"label":"Fev","value":419},{"label":"Mar","value":525},{"label":"Abr","value":508},{"label":"Mai","value":357},{"label":"Jun","value":296},{"label":"Jul","value":634},{"label":"Ago","value":522},{"label":"Set","value":622},{"label":"Out","value":665},{"label":"Nov","value":654},{"label":"Dez","value":400}];
const MX = 665;
