...
const PAGE = "Connect";
const KPIS = [{"l":"Dashboards Ativos","v":"7.421","t":"+15.4%","d":"up"},{"l":"Queries/Dia","v":"623","t":"+13.5%","d":"up"},{"l":"Dados Processados (GB)","v":"7.649","t":"+4.8%","d":"up"},{"l":"Utilizadores Analytics","v":"7.189","t":"-2.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2887","2026-03-16","4.801","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2154","2026-03-06","7.319","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","5028","2026-03-06","7.777","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3552","2026-01-16","1.635","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4995","2026-02-16","410","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":664},{"label":"Mar","value":711},{"label":"Abr","value":442},{"label":"Mai","value":461},{"label":"Jun","value":542},{"label":"Jul","value":493},{"label":"Ago","value":578},{"label":"Set","value":543},{"label":"Out","value":460},{"label":"Nov","value":417},{"label":"Dez","value":609}];
const MX = 711;
