...
/* ═══ Health Data Exchange (HIE) — Dashboard ═══ */

const ACCENT = "#65a30d";

const KPIS = [
    { label: "Total Registos", value: "9916", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "266", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€166K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "-24%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1766100516", cells: ["HEA-4516", "Health Data Exchange (HIE) Item 1", "13/1/2026", "€616"], status: "active" as const },
    { id: "1766104087", cells: ["HEA-8087", "Health Data Exchange (HIE) Item 2", "28/8/2026", "€4187"], status: "pending" as const },
    { id: "1766107658", cells: ["HEA-2658", "Health Data Exchange (HIE) Item 3", "15/3/2026", "€7758"], status: "completed" as const },
    { id: "1766111229", cells: ["HEA-6229", "Health Data Exchange (HIE) Item 4", "2/10/2026", "€11 329"], status: "warning" as const },
    { id: "1766114800", cells: ["HEA-9800", "Health Data Exchange (HIE) Item 5", "17/5/2026", "€14 900"], status: "active" as const },
];
...
export default function HealthDataExchangeHiePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Health Data Exchange (HIE)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Health Data Exchange (HIE)</p>
                    </div>
                </div>
