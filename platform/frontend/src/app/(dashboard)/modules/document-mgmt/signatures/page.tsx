...
const PAGE = "Digital Signatures";
const KPIS = [{"l":"Formulários Ativos","v":"8.925","t":"+17.9%","d":"up"},{"l":"Submissões/Dia","v":"457","t":"+17.5%","d":"up"},{"l":"Documentos Gerados","v":"6.097","t":"+16.0%","d":"up"},{"l":"Templates","v":"4.705","t":"+11.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.893","2026-01-18","2.025","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.950","2026-03-28","5.009","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.844","2026-01-22","4.059","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.187","2026-02-24","2.834","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.915","2026-03-27","3.197","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1029},{"label":"Fev","value":809},{"label":"Mar","value":734},{"label":"Abr","value":1018},{"label":"Mai","value":858},{"label":"Jun","value":772},{"label":"Jul","value":985},{"label":"Ago","value":794},{"label":"Set","value":785},{"label":"Out","value":849},{"label":"Nov","value":677},{"label":"Dez","value":785}];
const MX = 1029;
