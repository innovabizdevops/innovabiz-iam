...
const KPIS = [{"l":"Formulários Ativos","v":"3.980","t":"+17.3%","d":"up"},{"l":"Submissões/Dia","v":"873","t":"-6.0%","d":"down"},{"l":"Documentos Gerados","v":"4.682","t":"-3.3%","d":"down"},{"l":"Templates","v":"2.826","t":"+15.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.102","2026-03-03","3.214","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.702","2026-02-25","4.114","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.428","2026-02-24","5.129","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.413","2026-03-06","163","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.956","2026-03-13","767","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":922},{"label":"Fev","value":849},{"label":"Mar","value":907},{"label":"Abr","value":569},{"label":"Mai","value":793},{"label":"Jun","value":867},{"label":"Jul","value":801},{"label":"Ago","value":654},{"label":"Set","value":632},{"label":"Out","value":801},{"label":"Nov","value":650},{"label":"Dez","value":857}];
const MX = 922;
