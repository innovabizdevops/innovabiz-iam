...
const PAGE = "Retention Policies";
const KPIS = [{"l":"Formulários Ativos","v":"8.135","t":"+10.3%","d":"up"},{"l":"Submissões/Dia","v":"3137","t":"+10.8%","d":"up"},{"l":"Documentos Gerados","v":"1.897","t":"+9.1%","d":"up"},{"l":"Templates","v":"6.926","t":"+1.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.501","2026-02-11","775","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","954","2026-03-09","4.048","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.904","2026-03-03","3.528","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.355","2026-01-04","6.777","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.275","2026-03-02","3.934","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":820},{"label":"Mar","value":495},{"label":"Abr","value":604},{"label":"Mai","value":709},{"label":"Jun","value":580},{"label":"Jul","value":449},{"label":"Ago","value":455},{"label":"Set","value":450},{"label":"Out","value":733},{"label":"Nov","value":711},{"label":"Dez","value":695}];
const MX = 820;
