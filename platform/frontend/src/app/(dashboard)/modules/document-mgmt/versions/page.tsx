...
const KPIS = [{"l":"Formulários Ativos","v":"6.021","t":"-2.3%","d":"down"},{"l":"Submissões/Dia","v":"4111","t":"+0.5%","d":"up"},{"l":"Documentos Gerados","v":"2.645","t":"+5.2%","d":"up"},{"l":"Templates","v":"3.472","t":"-6.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.362","2026-03-14","5.246","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.828","2026-01-21","6.932","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.422","2026-02-09","4.683","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","303","2026-03-07","7.676","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.782","2026-03-05","3.805","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":545},{"label":"Fev","value":671},{"label":"Mar","value":564},{"label":"Abr","value":696},{"label":"Mai","value":735},{"label":"Jun","value":413},{"label":"Jul","value":389},{"label":"Ago","value":509},{"label":"Set","value":738},{"label":"Out","value":476},{"label":"Nov","value":608},{"label":"Dez","value":502}];
const MX = 738;
