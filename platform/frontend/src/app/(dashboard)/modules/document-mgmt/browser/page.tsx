...
const PAGE = "File Browser";
const KPIS = [{"l":"Formulários Ativos","v":"7.473","t":"+12.4%","d":"up"},{"l":"Submissões/Dia","v":"190","t":"+2.1%","d":"up"},{"l":"Documentos Gerados","v":"8.081","t":"+2.7%","d":"up"},{"l":"Templates","v":"7.746","t":"+2.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.538","2026-01-09","8.365","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.701","2026-01-25","3.824","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.489","2026-02-03","548","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","359","2026-01-04","7.616","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","9.010","2026-01-13","4.588","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":478},{"label":"Mar","value":431},{"label":"Abr","value":306},{"label":"Mai","value":391},{"label":"Jun","value":379},{"label":"Jul","value":452},{"label":"Ago","value":652},{"label":"Set","value":530},{"label":"Out","value":330},{"label":"Nov","value":467},{"label":"Dez","value":596}];
const MX = 652;
