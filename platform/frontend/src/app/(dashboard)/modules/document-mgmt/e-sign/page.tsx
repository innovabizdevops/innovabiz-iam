...
const KPIS = [{"l":"Formulários Ativos","v":"955","t":"+0.9%","d":"up"},{"l":"Submissões/Dia","v":"1150","t":"+10.6%","d":"up"},{"l":"Documentos Gerados","v":"7.100","t":"-1.0%","d":"down"},{"l":"Templates","v":"6.714","t":"+9.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.862","2026-01-13","1.848","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.017","2026-01-28","2.953","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.317","2026-01-26","8.257","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","398","2026-01-13","5.890","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.613","2026-03-19","8.677","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":514},{"label":"Mar","value":281},{"label":"Abr","value":574},{"label":"Mai","value":346},{"label":"Jun","value":345},{"label":"Jul","value":566},{"label":"Ago","value":461},{"label":"Set","value":480},{"label":"Out","value":548},{"label":"Nov","value":435},{"label":"Dez","value":402}];
const MX = 574;
