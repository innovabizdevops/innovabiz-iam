...
const PAGE = "Compliance Archive";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.014","t":"+5.0%","d":"up"},{"l":"NC Abertas","v":"7.407","t":"+3.0%","d":"up"},{"l":"Conformidade (%)","v":"79.9%","t":"+3.8%","d":"up"},{"l":"CAPAs Pendentes","v":"2.219","t":"-4.9%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.478","75.4%","5.805","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.918","75.0%","7.592","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.860","91.2%","6.812","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.248","92.4%","1.663","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.776","80.2%","6.697","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":710},{"label":"Mar","value":832},{"label":"Abr","value":689},{"label":"Mai","value":880},{"label":"Jun","value":769},{"label":"Jul","value":684},{"label":"Ago","value":837},{"label":"Set","value":680},{"label":"Out","value":803},{"label":"Nov","value":643},{"label":"Dez","value":800}];
const MX = 880;
