...
const PAGE = "Redaction AI";
const KPIS = [{"l":"Formulários Ativos","v":"747","t":"-4.8%","d":"down"},{"l":"Submissões/Dia","v":"2145","t":"+8.1%","d":"up"},{"l":"Documentos Gerados","v":"8.561","t":"+3.5%","d":"up"},{"l":"Templates","v":"2.766","t":"+5.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.083","2026-02-26","1.827","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.429","2026-01-13","9.087","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.307","2026-03-03","5.067","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.719","2026-02-18","7.153","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.379","2026-01-02","2.270","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":452},{"label":"Fev","value":360},{"label":"Mar","value":476},{"label":"Abr","value":534},{"label":"Mai","value":511},{"label":"Jun","value":247},{"label":"Jul","value":263},{"label":"Ago","value":437},{"label":"Set","value":635},{"label":"Out","value":324},{"label":"Nov","value":324},{"label":"Dez","value":440}];
const MX = 635;
