...
const PAGE = "AI Classification";
const KPIS = [{"l":"Formulários Ativos","v":"2.856","t":"+5.6%","d":"up"},{"l":"Submissões/Dia","v":"4032","t":"+5.1%","d":"up"},{"l":"Documentos Gerados","v":"7.299","t":"+15.1%","d":"up"},{"l":"Templates","v":"2.997","t":"+12.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.745","2026-03-12","6.148","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.399","2026-03-06","1.907","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.336","2026-03-01","2.610","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.759","2026-02-17","3.190","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.295","2026-03-11","3.673","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":975},{"label":"Mar","value":934},{"label":"Abr","value":621},{"label":"Mai","value":636},{"label":"Jun","value":619},{"label":"Jul","value":666},{"label":"Ago","value":651},{"label":"Set","value":966},{"label":"Out","value":873},{"label":"Nov","value":976},{"label":"Dez","value":905}];
const MX = 976;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7e22ce'}}>AI</span></h1>
                </div>
