...
const PAGE = "Secure Sharing";
const KPIS = [{"l":"Formulários Ativos","v":"6.683","t":"-0.5%","d":"down"},{"l":"Submissões/Dia","v":"4771","t":"+9.7%","d":"up"},{"l":"Documentos Gerados","v":"6.557","t":"+0.7%","d":"up"},{"l":"Templates","v":"2.062","t":"+12.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.651","2026-01-26","8.866","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.804","2026-01-13","7.038","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.640","2026-03-19","9.023","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.159","2026-01-20","8.370","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.636","2026-02-05","6.648","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":754},{"label":"Mar","value":561},{"label":"Abr","value":741},{"label":"Mai","value":465},{"label":"Jun","value":699},{"label":"Jul","value":630},{"label":"Ago","value":565},{"label":"Set","value":698},{"label":"Out","value":788},{"label":"Nov","value":630},{"label":"Dez","value":533}];
const MX = 788;
