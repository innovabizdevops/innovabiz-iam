...
const PAGE = "OCR &amp; AI Extract";
const KPIS = [{"l":"Formulários Ativos","v":"2.209","t":"+15.1%","d":"up"},{"l":"Submissões/Dia","v":"2847","t":"-3.9%","d":"down"},{"l":"Documentos Gerados","v":"2.680","t":"+9.4%","d":"up"},{"l":"Templates","v":"4.143","t":"+17.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.940","2026-01-10","4.038","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.823","2026-02-15","1.936","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.958","2026-03-10","2.678","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.117","2026-02-12","7.895","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.708","2026-02-03","4.847","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":476},{"label":"Fev","value":526},{"label":"Mar","value":639},{"label":"Abr","value":571},{"label":"Mai","value":575},{"label":"Jun","value":609},{"label":"Jul","value":564},{"label":"Ago","value":726},{"label":"Set","value":621},{"label":"Out","value":579},{"label":"Nov","value":719},{"label":"Dez","value":726}];
const MX = 726;
