...
const ACCENT = "#6366f1";
const MODULE = "Petrochemical Ops";
const PAGE = "Cracking";
const KPIS = [{"l":"Total Petrochem","v":"324","t":"+0.6%","d":"up"},{"l":"Cracking Ativos","v":"1.422","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"69.6%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"61","t":"+5.5%","d":"up"}];
const COLS = ["ID","Cracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Petrochem #001","Petrochem #002","6.362","1.565","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Petrochem #002","Petrochem #003","476","5.662","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Petrochem #003","Petrochem #004","7.661","4.805","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Petrochem #004","Petrochem #005","1.387","3.094","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Petrochem #005","Petrochem #001","5.110","2.421","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":678},{"label":"Mar","value":633},{"label":"Abr","value":701},{"label":"Mai","value":701},{"label":"Jun","value":837},{"label":"Jul","value":878},{"label":"Ago","value":837},{"label":"Set","value":712},{"label":"Out","value":878},{"label":"Nov","value":586},{"label":"Dez","value":888}];
const MX = 888;
