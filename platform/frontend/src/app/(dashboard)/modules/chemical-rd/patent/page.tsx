...
const PAGE = "Patent";
const KPIS = [{"l":"Ideias Submetidas","v":"7.054","t":"+2.9%","d":"up"},{"l":"Patentes (YTD)","v":"1.113","t":"+3.0%","d":"up"},{"l":"Projetos Innovation Lab","v":"1.562","t":"-3.9%","d":"down"},{"l":"Budget I&D (€M)","v":"€7.0M","t":"+11.4%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","1.711","77.6%","3.198","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.281","98.3%","6.668","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","8.489","73.4%","4.174","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.336","76.8%","6.485","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","4.241","89.8%","8.096","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":440},{"label":"Fev","value":315},{"label":"Mar","value":633},{"label":"Abr","value":401},{"label":"Mai","value":552},{"label":"Jun","value":673},{"label":"Jul","value":557},{"label":"Ago","value":642},{"label":"Set","value":484},{"label":"Out","value":573},{"label":"Nov","value":598},{"label":"Dez","value":390}];
const MX = 673;
