...
const ACCENT = "#6366f1";
const MODULE = "Chemical R&D";
const PAGE = "Lab Notebook";
const KPIS = [{"l":"Total Chemical Rd","v":"3.130","t":"+14.5%","d":"up"},{"l":"Lab Notebook Ativos","v":"3.016","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"79.6%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"85","t":"+6.7%","d":"up"}];
const COLS = ["ID","Lab Notebook","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemical Rd #001","Chemical Rd #002","355","131","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Chemical Rd #002","Chemical Rd #003","8.964","5.308","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemical Rd #003","Chemical Rd #004","8.934","1.871","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Chemical Rd #004","Chemical Rd #005","6.467","8.583","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemical Rd #005","Chemical Rd #001","2.897","8.702","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":794},{"label":"Fev","value":442},{"label":"Mar","value":651},{"label":"Abr","value":476},{"label":"Mai","value":701},{"label":"Jun","value":631},{"label":"Jul","value":703},{"label":"Ago","value":569},{"label":"Set","value":544},{"label":"Out","value":598},{"label":"Nov","value":706},{"label":"Dez","value":587}];
const MX = 794;
