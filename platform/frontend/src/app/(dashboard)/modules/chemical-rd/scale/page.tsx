...
const PAGE = "Scale Up";
const KPIS = [{"l":"Total Chemical Rd","v":"725","t":"+11.2%","d":"up"},{"l":"Scale Up Ativos","v":"2.614","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"83.5%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"88","t":"+11.3%","d":"up"}];
const COLS = ["ID","Scale Up","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemical Rd #001","Chemical Rd #002","7.930","8.027","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Chemical Rd #002","Chemical Rd #003","2.748","3.099","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemical Rd #003","Chemical Rd #004","1.367","4.976","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Chemical Rd #004","Chemical Rd #005","398","3.150","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemical Rd #005","Chemical Rd #001","1.850","920","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":786},{"label":"Mar","value":832},{"label":"Abr","value":601},{"label":"Mai","value":642},{"label":"Jun","value":900},{"label":"Jul","value":557},{"label":"Ago","value":628},{"label":"Set","value":642},{"label":"Out","value":856},{"label":"Nov","value":642},{"label":"Dez","value":913}];
const MX = 913;
