...
const PAGE = "Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"511","t":"-3.4%","d":"down"},{"l":"Queries/Dia","v":"2064","t":"+2.8%","d":"up"},{"l":"Dados Processados (GB)","v":"3.719","t":"+3.7%","d":"up"},{"l":"Utilizadores Analytics","v":"4.331","t":"-5.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","916","2026-01-18","3.327","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4743","2026-03-22","6.389","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1280","2026-02-08","7.599","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1348","2026-03-24","6.565","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","673","2026-01-05","1.606","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":443},{"label":"Mar","value":643},{"label":"Abr","value":467},{"label":"Mai","value":636},{"label":"Jun","value":720},{"label":"Jul","value":635},{"label":"Ago","value":635},{"label":"Set","value":638},{"label":"Out","value":442},{"label":"Nov","value":621},{"label":"Dez","value":615}];
const MX = 720;
