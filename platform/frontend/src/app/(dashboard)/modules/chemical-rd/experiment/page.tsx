...
const KPIS = [{"l":"Total Chemical Rd","v":"2.492","t":"+11.5%","d":"up"},{"l":"Experiment Ativos","v":"7.594","t":"+1.2%","d":"up"},{"l":"Eficiência (%)","v":"74.5%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"78","t":"+11.0%","d":"up"}];
const COLS = ["ID","Experiment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemical Rd #001","Chemical Rd #002","2.427","7.201","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Chemical Rd #002","Chemical Rd #003","2.927","6.776","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemical Rd #003","Chemical Rd #004","4.893","7.016","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Chemical Rd #004","Chemical Rd #005","5.600","8.325","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemical Rd #005","Chemical Rd #001","4.977","2.902","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":685},{"label":"Mar","value":910},{"label":"Abr","value":868},{"label":"Mai","value":843},{"label":"Jun","value":916},{"label":"Jul","value":674},{"label":"Ago","value":715},{"label":"Set","value":955},{"label":"Out","value":902},{"label":"Nov","value":870},{"label":"Dez","value":753}];
const MX = 955;
