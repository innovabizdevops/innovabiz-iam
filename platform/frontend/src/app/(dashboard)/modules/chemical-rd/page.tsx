...
export default function ChemicalRdPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Chemical Rd</h1><p className="text-sm text-muted-foreground">Chemical Rd • iBOS Enterprise</p></div>
