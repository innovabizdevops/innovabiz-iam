...
const KPIS = [{"l":"Riscos Identificados","v":"5.781","t":"+6.5%","d":"up"},{"l":"Mitigações Ativas","v":"447","t":"-2.1%","d":"down"},{"l":"Score Risco Geral","v":"89","t":"+9.7%","d":"up"},{"l":"Incidentes YTD","v":"2.166","t":"+1.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.266","6.141","3.093","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","351","6.506","1.846","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.542","1.265","8.997","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.898","1.186","5.097","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.629","750","2.831","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":906},{"label":"Fev","value":708},{"label":"Mar","value":597},{"label":"Abr","value":883},{"label":"Mai","value":794},{"label":"Jun","value":714},{"label":"Jul","value":697},{"label":"Ago","value":814},{"label":"Set","value":709},{"label":"Out","value":660},{"label":"Nov","value":835},{"label":"Dez","value":869}];
const MX = 906;
