...
const PAGE = "Board Portal";
const KPIS = [{"l":"Riscos Identificados","v":"2.121","t":"+16.1%","d":"up"},{"l":"Mitigações Ativas","v":"4.496","t":"+1.7%","d":"up"},{"l":"Score Risco Geral","v":"91","t":"+5.0%","d":"up"},{"l":"Incidentes YTD","v":"1.566","t":"-5.9%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","170","5.148","5.301","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.720","7.661","5.815","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.764","2.640","2.461","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","568","7.043","2.639","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.758","3.289","2.142","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":448},{"label":"Fev","value":529},{"label":"Mar","value":389},{"label":"Abr","value":736},{"label":"Mai","value":609},{"label":"Jun","value":426},{"label":"Jul","value":736},{"label":"Ago","value":458},{"label":"Set","value":462},{"label":"Out","value":573},{"label":"Nov","value":420},{"label":"Dez","value":508}];
const MX = 736;
