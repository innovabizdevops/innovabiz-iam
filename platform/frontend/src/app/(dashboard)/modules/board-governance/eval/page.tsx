...
const ACCENT = "#1e40af";
const MODULE = "Board Governance";
const PAGE = "Director Eval";
const KPIS = [{"l":"Riscos Identificados","v":"566","t":"+13.3%","d":"up"},{"l":"Mitigações Ativas","v":"4.183","t":"+11.8%","d":"up"},{"l":"Score Risco Geral","v":"80","t":"-5.1%","d":"down"},{"l":"Incidentes YTD","v":"6.434","t":"-3.3%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.428","289","3.314","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.242","3.004","5.401","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.169","3.942","8.329","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","685","2.779","6.220","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","9.040","8.035","2.372","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":782},{"label":"Mar","value":797},{"label":"Abr","value":693},{"label":"Mai","value":980},{"label":"Jun","value":850},{"label":"Jul","value":979},{"label":"Ago","value":834},{"label":"Set","value":714},{"label":"Out","value":906},{"label":"Nov","value":787},{"label":"Dez","value":631}];
const MX = 980;
