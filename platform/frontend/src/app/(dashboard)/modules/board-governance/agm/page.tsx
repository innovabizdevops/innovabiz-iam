...
const PAGE = "AGM Prep";
const KPIS = [{"l":"Riscos Identificados","v":"2.818","t":"-3.6%","d":"down"},{"l":"Mitigações Ativas","v":"1.164","t":"+10.0%","d":"up"},{"l":"Score Risco Geral","v":"73","t":"+3.8%","d":"up"},{"l":"Incidentes YTD","v":"4.374","t":"+11.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.462","1.416","6.060","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.807","7.001","2.425","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.303","1.095","8.265","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","292","936","3.130","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","195","8.439","6.605","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":889},{"label":"Fev","value":664},{"label":"Mar","value":863},{"label":"Abr","value":711},{"label":"Mai","value":626},{"label":"Jun","value":656},{"label":"Jul","value":611},{"label":"Ago","value":898},{"label":"Set","value":584},{"label":"Out","value":914},{"label":"Nov","value":627},{"label":"Dez","value":871}];
const MX = 914;
