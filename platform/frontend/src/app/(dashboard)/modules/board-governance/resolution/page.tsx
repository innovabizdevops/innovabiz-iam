...
const KPIS = [{"l":"Riscos Identificados","v":"5.850","t":"+12.6%","d":"up"},{"l":"Mitigações Ativas","v":"7.906","t":"+2.4%","d":"up"},{"l":"Score Risco Geral","v":"86","t":"+17.1%","d":"up"},{"l":"Incidentes YTD","v":"5.720","t":"+17.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.157","4.641","5.589","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.939","6.788","455","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.528","633","4.794","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.528","1.665","135","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.839","2.581","3.247","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":860},{"label":"Mar","value":825},{"label":"Abr","value":694},{"label":"Mai","value":806},{"label":"Jun","value":960},{"label":"Jul","value":663},{"label":"Ago","value":990},{"label":"Set","value":691},{"label":"Out","value":912},{"label":"Nov","value":789},{"label":"Dez","value":726}];
const MX = 990;
