...
const PAGE = "PWA Config";
const KPIS = [{"l":"Configurações","v":"1.041","t":"+3.5%","d":"up"},{"l":"Últimas Alterações","v":"1.953","t":"-4.9%","d":"down"},{"l":"Ambientes","v":"3.413","t":"+3.4%","d":"up"},{"l":"Versão Config","v":"6.288","t":"-2.7%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 16149.78","4.779","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 24138.20","5.718","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 6450.72","2.640","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 43201.18","213","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 39767.91","1.714","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":392},{"label":"Fev","value":732},{"label":"Mar","value":746},{"label":"Abr","value":382},{"label":"Mai","value":415},{"label":"Jun","value":653},{"label":"Jul","value":562},{"label":"Ago","value":595},{"label":"Set","value":379},{"label":"Out","value":357},{"label":"Nov","value":417},{"label":"Dez","value":545}];
const MX = 746;
