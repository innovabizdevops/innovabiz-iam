...
const ACCENT = "#9333ea";
const MODULE = "Interface Builder";
const PAGE = "Mobile Layout";
const KPIS = [{"l":"Total Interface Builder","v":"4.976","t":"-5.3%","d":"down"},{"l":"Mobile Layout Ativos","v":"7.127","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"72.3%","t":"-5.1%","d":"down"},{"l":"Score Performance","v":"73","t":"+11.4%","d":"up"}];
const COLS = ["ID","Mobile Layout","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Interface Builder #001","Interface Builder #002","8.233","4.108","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Interface Builder #002","Interface Builder #003","6.503","2.461","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Interface Builder #003","Interface Builder #004","7.222","4.995","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Interface Builder #004","Interface Builder #005","5.925","2.370","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Interface Builder #005","Interface Builder #001","4.771","780","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":599},{"label":"Mar","value":373},{"label":"Abr","value":422},{"label":"Mai","value":464},{"label":"Jun","value":374},{"label":"Jul","value":377},{"label":"Ago","value":404},{"label":"Set","value":463},{"label":"Out","value":737},{"label":"Nov","value":423},{"label":"Dez","value":690}];
const MX = 737;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#9333ea'}}>Mobile</span></h1>
                </div>
