...
const PAGE = "Theme Editor";
const KPIS = [{"l":"Integrações Ativas","v":"6.239","t":"+10.9%","d":"up"},{"l":"Chamadas/Hora","v":"1074","t":"+1.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.5%","t":"-0.5%","d":"down"},{"l":"Latência Média (ms)","v":"119ms","t":"+11.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.838","4.766","75.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","927","6.153","95.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.477","370","80.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.595","1.137","74.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.430","4.839","75.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":704},{"label":"Mar","value":741},{"label":"Abr","value":559},{"label":"Mai","value":632},{"label":"Jun","value":497},{"label":"Jul","value":559},{"label":"Ago","value":759},{"label":"Set","value":442},{"label":"Out","value":431},{"label":"Nov","value":807},{"label":"Dez","value":506}];
const MX = 807;
