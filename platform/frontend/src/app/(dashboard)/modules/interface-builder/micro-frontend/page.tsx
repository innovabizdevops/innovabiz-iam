...
const PAGE = "Micro-Frontend Config";
const KPIS = [{"l":"Configurações","v":"3.423","t":"-3.0%","d":"down"},{"l":"Últimas Alterações","v":"2.267","t":"+4.4%","d":"up"},{"l":"Ambientes","v":"4.168","t":"+10.4%","d":"up"},{"l":"Versão Config","v":"2.731","t":"-0.3%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 12707.78","4.197","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 32082.56","3.463","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 16985.83","4.019","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 37141.84","2.277","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 36872.90","5.614","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":335},{"label":"Fev","value":526},{"label":"Mar","value":440},{"label":"Abr","value":615},{"label":"Mai","value":481},{"label":"Jun","value":471},{"label":"Jul","value":380},{"label":"Ago","value":546},{"label":"Set","value":390},{"label":"Out","value":493},{"label":"Nov","value":375},{"label":"Dez","value":649}];
const MX = 649;
