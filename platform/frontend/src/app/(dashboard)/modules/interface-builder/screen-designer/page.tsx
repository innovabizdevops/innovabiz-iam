...
const PAGE = "Screen Designer";
const KPIS = [{"l":"Formulários Ativos","v":"4.140","t":"+11.3%","d":"up"},{"l":"Submissões/Dia","v":"3256","t":"-0.3%","d":"down"},{"l":"Documentos Gerados","v":"4.951","t":"-0.6%","d":"down"},{"l":"Templates","v":"8.094","t":"+17.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.333","2026-02-18","1.022","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.888","2026-02-22","4.780","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.482","2026-03-03","1.438","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.109","2026-02-04","5.424","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","765","2026-02-19","7.236","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":847},{"label":"Mar","value":761},{"label":"Abr","value":867},{"label":"Mai","value":554},{"label":"Jun","value":778},{"label":"Jul","value":848},{"label":"Ago","value":616},{"label":"Set","value":802},{"label":"Out","value":654},{"label":"Nov","value":849},{"label":"Dez","value":863}];
const MX = 867;
