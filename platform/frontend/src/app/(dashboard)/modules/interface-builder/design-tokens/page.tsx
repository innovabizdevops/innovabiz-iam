...
const KPIS = [{"l":"Formulários Ativos","v":"8.687","t":"-5.7%","d":"down"},{"l":"Submissões/Dia","v":"464","t":"+13.8%","d":"up"},{"l":"Documentos Gerados","v":"4.865","t":"+1.2%","d":"up"},{"l":"Templates","v":"3.826","t":"-5.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.644","2026-02-13","3.169","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.527","2026-02-19","4.264","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.966","2026-02-03","2.037","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.318","2026-03-04","8.920","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.458","2026-02-26","5.634","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":389},{"label":"Fev","value":356},{"label":"Mar","value":507},{"label":"Abr","value":585},{"label":"Mai","value":523},{"label":"Jun","value":443},{"label":"Jul","value":297},{"label":"Ago","value":231},{"label":"Set","value":495},{"label":"Out","value":591},{"label":"Nov","value":476},{"label":"Dez","value":316}];
const MX = 591;
