...
const PAGE = "Accessibility Checker";
const KPIS = [{"l":"Total Interface Builder","v":"648","t":"+10.2%","d":"up"},{"l":"Accessibility Checker Ativos","v":"9.076","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"66.4%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"68","t":"+11.9%","d":"up"}];
const COLS = ["ID","Accessibility Checker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Interface Builder #001","2026-01-24","1.901","2.390","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Interface Builder #002","2026-01-20","8.997","327","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Interface Builder #003","2026-01-02","1.621","8.890","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Interface Builder #004","2026-01-23","801","4.773","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Interface Builder #005","2026-03-10","8.052","7.192","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":722},{"label":"Mar","value":845},{"label":"Abr","value":907},{"label":"Mai","value":1033},{"label":"Jun","value":996},{"label":"Jul","value":948},{"label":"Ago","value":895},{"label":"Set","value":1016},{"label":"Out","value":970},{"label":"Nov","value":729},{"label":"Dez","value":740}];
const MX = 1033;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#9333ea'}}>WCAG</span></h1>
                </div>
