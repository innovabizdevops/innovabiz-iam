...
const ACCENT = "#6366f1";
const MODULE = "AR Commerce";
const PAGE = "Visualize";
const KPIS = [{"l":"Pedidos/Dia","v":"250","t":"-3.4%","d":"down"},{"l":"GMV (€)","v":"€38121","t":"-2.8%","d":"down"},{"l":"Conversão (%)","v":"65.2%","t":"+0.8%","d":"up"},{"l":"AOV (€)","v":"€30048","t":"+3.7%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 27906.37","2.167","1.867","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 16824.22","8.294","1.958","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 10105.59","3.576","8.093","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 26683.46","7.638","4.074","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 20413.79","7.282","7.858","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":384},{"label":"Fev","value":567},{"label":"Mar","value":470},{"label":"Abr","value":659},{"label":"Mai","value":431},{"label":"Jun","value":662},{"label":"Jul","value":528},{"label":"Ago","value":672},{"label":"Set","value":578},{"label":"Out","value":337},{"label":"Nov","value":693},{"label":"Dez","value":453}];
const MX = 693;
