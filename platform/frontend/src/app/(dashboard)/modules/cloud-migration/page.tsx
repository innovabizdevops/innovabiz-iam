...
/* ═══ Cloud Migration Platform — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "4927", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2619", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€358K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2073520227", cells: ["CLO-2227", "Cloud Migration Platform Item 1", "24/4/2026", "€20 327"], status: "active" as const },
    { id: "2073523798", cells: ["CLO-5798", "Cloud Migration Platform Item 2", "11/11/2026", "€23 898"], status: "pending" as const },
    { id: "2073527369", cells: ["CLO-9369", "Cloud Migration Platform Item 3", "26/6/2026", "€27 469"], status: "completed" as const },
    { id: "2073530940", cells: ["CLO-3940", "Cloud Migration Platform Item 4", "13/1/2026", "€31 040"], status: "warning" as const },
    { id: "2073534511", cells: ["CLO-7511", "Cloud Migration Platform Item 5", "28/8/2026", "€34 611"], status: "active" as const },
];
...
export default function CloudMigrationPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cloud Migration Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cloud Migration Platform</p>
                    </div>
                </div>
