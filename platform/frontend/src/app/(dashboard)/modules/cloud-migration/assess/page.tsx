...
const PAGE = "Assess";
const KPIS = [{"l":"Total Cloud Migration","v":"4.736","t":"+8.0%","d":"up"},{"l":"Assess Ativos","v":"5.627","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"81.5%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"88","t":"-5.5%","d":"down"}];
const COLS = ["ID","Assess","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cloud Migration #001","Cloud Migration #002","2.137","1.675","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Cloud Migration #002","Cloud Migration #003","5.547","7.064","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Cloud Migration #003","Cloud Migration #004","8.887","1.637","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Cloud Migration #004","Cloud Migration #005","3.916","2.395","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cloud Migration #005","Cloud Migration #001","2.225","3.765","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":448},{"label":"Fev","value":533},{"label":"Mar","value":494},{"label":"Abr","value":425},{"label":"Mai","value":730},{"label":"Jun","value":502},{"label":"Jul","value":731},{"label":"Ago","value":639},{"label":"Set","value":690},{"label":"Out","value":620},{"label":"Nov","value":413},{"label":"Dez","value":469}];
const MX = 731;
