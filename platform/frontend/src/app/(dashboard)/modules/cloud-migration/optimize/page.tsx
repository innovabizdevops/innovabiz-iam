...
const ACCENT = "#0d9488";
const MODULE = "Cloud Migration Platform";
const PAGE = "Optimize";
const KPIS = [{"l":"Total Cloud Migration","v":"8.561","t":"+0.4%","d":"up"},{"l":"Optimize Ativos","v":"5.594","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"72.7%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"77","t":"-2.2%","d":"down"}];
const COLS = ["ID","Optimize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cloud Migration #001","Cloud Migration #002","1.420","4.692","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Cloud Migration #002","Cloud Migration #003","1.542","7.502","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Cloud Migration #003","Cloud Migration #004","6.318","3.343","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Cloud Migration #004","Cloud Migration #005","6.353","2.992","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cloud Migration #005","Cloud Migration #001","8.987","6.386","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":965},{"label":"Mar","value":900},{"label":"Abr","value":761},{"label":"Mai","value":788},{"label":"Jun","value":1003},{"label":"Jul","value":908},{"label":"Ago","value":649},{"label":"Set","value":1008},{"label":"Out","value":686},{"label":"Nov","value":715},{"label":"Dez","value":701}];
const MX = 1008;
