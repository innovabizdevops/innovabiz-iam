...
const PAGE = "Plan";
const KPIS = [{"l":"Total Cloud Migration","v":"2.821","t":"+13.2%","d":"up"},{"l":"Plan Ativos","v":"6.611","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"70.0%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"63","t":"-5.4%","d":"down"}];
const COLS = ["ID","Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cloud Migration #001","Cloud Migration #002","7.859","8.330","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Cloud Migration #002","Cloud Migration #003","8.692","9.017","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Cloud Migration #003","Cloud Migration #004","7.918","211","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Cloud Migration #004","Cloud Migration #005","3.677","228","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cloud Migration #005","Cloud Migration #001","5.788","8.276","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":600},{"label":"Mar","value":679},{"label":"Abr","value":605},{"label":"Mai","value":732},{"label":"Jun","value":914},{"label":"Jul","value":940},{"label":"Ago","value":737},{"label":"Set","value":556},{"label":"Out","value":785},{"label":"Nov","value":616},{"label":"Dez","value":898}];
const MX = 940;
