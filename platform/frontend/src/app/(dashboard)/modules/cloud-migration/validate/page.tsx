...
const PAGE = "Validate";
const KPIS = [{"l":"Total Cloud Migration","v":"4.706","t":"-1.7%","d":"down"},{"l":"Validate Ativos","v":"2.471","t":"+17.7%","d":"up"},{"l":"Eficiência (%)","v":"93.9%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"66","t":"-3.7%","d":"down"}];
const COLS = ["ID","Validate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cloud Migration #001","Cloud Migration #002","5.455","4.681","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Cloud Migration #002","Cloud Migration #003","7.916","3.122","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Cloud Migration #003","Cloud Migration #004","7.282","3.659","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Cloud Migration #004","Cloud Migration #005","1.268","4.466","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cloud Migration #005","Cloud Migration #001","1.672","5.070","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":796},{"label":"Mar","value":852},{"label":"Abr","value":521},{"label":"Mai","value":840},{"label":"Jun","value":496},{"label":"Jul","value":712},{"label":"Ago","value":596},{"label":"Set","value":698},{"label":"Out","value":857},{"label":"Nov","value":582},{"label":"Dez","value":703}];
const MX = 857;
