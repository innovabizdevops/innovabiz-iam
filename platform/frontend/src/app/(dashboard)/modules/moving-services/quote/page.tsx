...
const PAGE = "Quote";
const KPIS = [{"l":"Total Moving Services","v":"5.133","t":"+13.7%","d":"up"},{"l":"Quote Ativos","v":"6.993","t":"+13.5%","d":"up"},{"l":"Eficiência (%)","v":"74.1%","t":"+6.8%","d":"up"},{"l":"Score Performance","v":"87","t":"+2.3%","d":"up"}];
const COLS = ["ID","Quote","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Moving Services #001","Moving Services #002","5.603","7.678","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Moving Services #002","Moving Services #003","1.849","6.402","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Moving Services #003","Moving Services #004","2.307","6.645","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Moving Services #004","Moving Services #005","413","8.770","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Moving Services #005","Moving Services #001","3.645","2.078","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":507},{"label":"Mar","value":652},{"label":"Abr","value":687},{"label":"Mai","value":633},{"label":"Jun","value":652},{"label":"Jul","value":513},{"label":"Ago","value":517},{"label":"Set","value":757},{"label":"Out","value":457},{"label":"Nov","value":526},{"label":"Dez","value":751}];
const MX = 757;
