...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Moving Services","v":"7.841","t":"+2.4%","d":"up"},{"l":"Schedule Ativos","v":"3.753","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"87.0%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"74","t":"+12.8%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Moving Services #001","Moving Services #002","3.598","3.386","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Moving Services #002","Moving Services #003","6.402","4.253","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Moving Services #003","Moving Services #004","7.064","9.011","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Moving Services #004","Moving Services #005","5.942","1.501","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Moving Services #005","Moving Services #001","6.869","8.774","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":617},{"label":"Mar","value":291},{"label":"Abr","value":343},{"label":"Mai","value":639},{"label":"Jun","value":325},{"label":"Jul","value":597},{"label":"Ago","value":458},{"label":"Set","value":393},{"label":"Out","value":525},{"label":"Nov","value":544},{"label":"Dez","value":606}];
const MX = 639;
