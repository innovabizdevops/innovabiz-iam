...
const KPIS = [{"l":"Total Moving Services","v":"2.532","t":"+6.2%","d":"up"},{"l":"Inventory Ativos","v":"3.986","t":"+5.9%","d":"up"},{"l":"Eficiência (%)","v":"92.2%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"89","t":"+12.8%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Moving Services #001","Moving Services #002","5.756","6.519","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Moving Services #002","Moving Services #003","3.414","8.076","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Moving Services #003","Moving Services #004","6.673","6.726","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Moving Services #004","Moving Services #005","2.546","1.188","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Moving Services #005","Moving Services #001","9.078","2.728","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1022},{"label":"Fev","value":858},{"label":"Mar","value":1044},{"label":"Abr","value":698},{"label":"Mai","value":907},{"label":"Jun","value":888},{"label":"Jul","value":831},{"label":"Ago","value":923},{"label":"Set","value":723},{"label":"Out","value":752},{"label":"Nov","value":1047},{"label":"Dez","value":947}];
const MX = 1047;
