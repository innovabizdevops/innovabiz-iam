...
const PAGE = "Claims";
const KPIS = [{"l":"Total Moving Services","v":"785","t":"+9.9%","d":"up"},{"l":"Claims Ativos","v":"3.131","t":"+4.4%","d":"up"},{"l":"Eficiência (%)","v":"74.9%","t":"-4.9%","d":"down"},{"l":"Score Performance","v":"62","t":"+17.4%","d":"up"}];
const COLS = ["ID","Claims","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Moving Services #001","Moving Services #002","596","3.047","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Moving Services #002","Moving Services #003","7.423","5.611","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Moving Services #003","Moving Services #004","7.461","8.951","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Moving Services #004","Moving Services #005","6.460","7.034","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Moving Services #005","Moving Services #001","7.873","3.932","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":546},{"label":"Mar","value":545},{"label":"Abr","value":394},{"label":"Mai","value":585},{"label":"Jun","value":388},{"label":"Jul","value":651},{"label":"Ago","value":633},{"label":"Set","value":697},{"label":"Out","value":392},{"label":"Nov","value":558},{"label":"Dez","value":717}];
const MX = 726;
