...
const ACCENT = "#0891b2";
const MODULE = "Moving Services";
const PAGE = "Track";
const KPIS = [{"l":"Total Moving Services","v":"4.343","t":"+4.8%","d":"up"},{"l":"Track Ativos","v":"136","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"68.9%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"76","t":"+0.5%","d":"up"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Moving Services #001","Moving Services #002","3.712","8.435","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Moving Services #002","Moving Services #003","3.679","6.474","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Moving Services #003","Moving Services #004","1.893","6.701","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Moving Services #004","Moving Services #005","5.622","2.030","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Moving Services #005","Moving Services #001","3.969","7.730","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":458},{"label":"Fev","value":483},{"label":"Mar","value":567},{"label":"Abr","value":609},{"label":"Mai","value":432},{"label":"Jun","value":481},{"label":"Jul","value":457},{"label":"Ago","value":264},{"label":"Set","value":321},{"label":"Out","value":303},{"label":"Nov","value":306},{"label":"Dez","value":455}];
const MX = 609;
