...
const PAGE = "Debt";
const KPIS = [{"l":"Teams Ativos","v":"2.429","t":"-2.5%","d":"down"},{"l":"Reuniões/Semana","v":"2556","t":"+5.6%","d":"up"},{"l":"Mensagens/Dia","v":"4088","t":"+9.0%","d":"up"},{"l":"Ficheiros Partilhados","v":"1.145","t":"-1.3%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.875","4207","4.974","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","7.831","2653","5.973","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","7.974","2117","5.263","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","8.051","1040","189","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","6.886","4907","483","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":622},{"label":"Mar","value":452},{"label":"Abr","value":630},{"label":"Mai","value":721},{"label":"Jun","value":782},{"label":"Jul","value":634},{"label":"Ago","value":748},{"label":"Set","value":744},{"label":"Out","value":837},{"label":"Nov","value":478},{"label":"Dez","value":711}];
const MX = 837;
