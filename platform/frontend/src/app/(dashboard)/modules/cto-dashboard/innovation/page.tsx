...
const KPIS = [{"l":"Ideias Submetidas","v":"6.605","t":"-0.9%","d":"down"},{"l":"Patentes (YTD)","v":"3.548","t":"+4.4%","d":"up"},{"l":"Projetos Innovation Lab","v":"3.044","t":"+11.9%","d":"up"},{"l":"Budget I&D (€M)","v":"€31.6M","t":"+1.4%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","8.601","96.5%","1.379","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.490","75.5%","194","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.558","95.9%","165","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.716","96.6%","8.490","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","5.763","79.0%","6.504","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":488},{"label":"Mar","value":611},{"label":"Abr","value":652},{"label":"Mai","value":482},{"label":"Jun","value":476},{"label":"Jul","value":716},{"label":"Ago","value":495},{"label":"Set","value":773},{"label":"Out","value":527},{"label":"Nov","value":735},{"label":"Dez","value":567}];
const MX = 773;
