...
const ACCENT = "#1e293b";
const MODULE = "CTO Dashboard";
const PAGE = "Performance";
const KPIS = [{"l":"Formulários Ativos","v":"7.457","t":"+8.5%","d":"up"},{"l":"Submissões/Dia","v":"3555","t":"+1.9%","d":"up"},{"l":"Documentos Gerados","v":"8.889","t":"+13.6%","d":"up"},{"l":"Templates","v":"2.526","t":"-0.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.241","2026-01-23","5.212","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","732","2026-02-28","1.798","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.927","2026-03-28","3.554","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.016","2026-03-05","1.387","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.242","2026-03-06","9.063","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":635},{"label":"Mar","value":793},{"label":"Abr","value":874},{"label":"Mai","value":582},{"label":"Jun","value":553},{"label":"Jul","value":668},{"label":"Ago","value":617},{"label":"Set","value":761},{"label":"Out","value":865},{"label":"Nov","value":797},{"label":"Dez","value":849}];
const MX = 874;
