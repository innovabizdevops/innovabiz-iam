...
/* ═══ CTO Dashboard — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "5108", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4928", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€293K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "99113908", cells: ["CTO-6908", "CTO Dashboard Item 1", "13/5/2026", "€14 008"], status: "active" as const },
    { id: "99117479", cells: ["CTO-1479", "CTO Dashboard Item 2", "28/12/2026", "€17 579"], status: "pending" as const },
    { id: "99121050", cells: ["CTO-5050", "CTO Dashboard Item 3", "15/7/2026", "€21 150"], status: "completed" as const },
    { id: "99124621", cells: ["CTO-8621", "CTO Dashboard Item 4", "2/2/2026", "€24 721"], status: "warning" as const },
    { id: "99128192", cells: ["CTO-3192", "CTO Dashboard Item 5", "17/9/2026", "€28 292"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CTO Dashboard</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CTO Dashboard</p>
                    </div>
                </div>
