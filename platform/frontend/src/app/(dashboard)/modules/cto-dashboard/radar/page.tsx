...
const PAGE = "Tech Radar";
const KPIS = [{"l":"Teams Ativos","v":"2.387","t":"+3.1%","d":"up"},{"l":"Reuniões/Semana","v":"4525","t":"-1.1%","d":"down"},{"l":"Mensagens/Dia","v":"1485","t":"+0.7%","d":"up"},{"l":"Ficheiros Partilhados","v":"2.305","t":"+17.8%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.068","687","1.793","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.381","2652","1.337","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","2.625","1711","4.835","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.476","1163","1.312","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.791","4088","5.877","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":890},{"label":"Fev","value":705},{"label":"Mar","value":875},{"label":"Abr","value":632},{"label":"Mai","value":900},{"label":"Jun","value":837},{"label":"Jul","value":790},{"label":"Ago","value":799},{"label":"Set","value":732},{"label":"Out","value":910},{"label":"Nov","value":642},{"label":"Dez","value":608}];
const MX = 910;
