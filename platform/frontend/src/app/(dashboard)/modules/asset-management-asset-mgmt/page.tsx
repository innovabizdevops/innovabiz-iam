...
export default function AssetManagementAssetMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Asset Management Asset Mgmt</h1><p className="text-sm text-muted-foreground">Asset Management Asset Mgmt • iBOS Enterprise</p></div>
