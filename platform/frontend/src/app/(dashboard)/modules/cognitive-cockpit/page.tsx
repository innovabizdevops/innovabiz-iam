...
/* ═══ Cognitive Cockpit (All Layers) — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "4181", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3576", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€302K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1106893381", cells: ["COG-2381", "Cognitive Cockpit (All Layers) Item 1", "14/2/2026", "€43 481"], status: "active" as const },
    { id: "1106896952", cells: ["COG-5952", "Cognitive Cockpit (All Layers) Item 2", "1/9/2026", "€47 052"], status: "pending" as const },
    { id: "1106900523", cells: ["COG-9523", "Cognitive Cockpit (All Layers) Item 3", "16/4/2026", "€623"], status: "completed" as const },
    { id: "1106904094", cells: ["COG-4094", "Cognitive Cockpit (All Layers) Item 4", "3/11/2026", "€4194"], status: "warning" as const },
    { id: "1106907665", cells: ["COG-7665", "Cognitive Cockpit (All Layers) Item 5", "18/6/2026", "€7765"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 41 }, { label: "Fev", value: 50 }, { label: "Mar", value: 59 }, { label: "Abr", value: 68 }, { label: "Mai", value: 77 }, { label: "Jun", value: 86 }];
...
export default function CognitiveCockpitAllLayersPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cognitive Cockpit (All Layers)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cognitive Cockpit (All Layers)</p>
                    </div>
                </div>
