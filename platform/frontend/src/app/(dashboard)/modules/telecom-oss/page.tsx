...
/* ═══ Telecom OSS Platform — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "8044", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "339", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€177K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1278236544", cells: ["TEL-3544", "Telecom OSS Platform Item 1", "5/1/2026", "€36 644"], status: "active" as const },
    { id: "1278240115", cells: ["TEL-7115", "Telecom OSS Platform Item 2", "20/8/2026", "€40 215"], status: "pending" as const },
    { id: "1278243686", cells: ["TEL-1686", "Telecom OSS Platform Item 3", "7/3/2026", "€43 786"], status: "completed" as const },
    { id: "1278247257", cells: ["TEL-5257", "Telecom OSS Platform Item 4", "22/10/2026", "€47 357"], status: "warning" as const },
    { id: "1278250828", cells: ["TEL-8828", "Telecom OSS Platform Item 5", "9/5/2026", "€928"], status: "active" as const },
];
...
export default function TelecomOssPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Telecom OSS Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Telecom OSS Platform</p>
                    </div>
                </div>
