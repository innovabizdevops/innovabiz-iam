...
const KPIS = [{"l":"Formulários Ativos","v":"7.914","t":"-4.3%","d":"down"},{"l":"Submissões/Dia","v":"962","t":"+11.2%","d":"up"},{"l":"Documentos Gerados","v":"980","t":"-3.3%","d":"down"},{"l":"Templates","v":"6.277","t":"+6.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.130","2026-03-17","798","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.144","2026-01-19","2.926","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.939","2026-01-18","5.257","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.263","2026-03-22","270","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.058","2026-01-24","7.191","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":760},{"label":"Fev","value":946},{"label":"Mar","value":682},{"label":"Abr","value":863},{"label":"Mai","value":728},{"label":"Jun","value":674},{"label":"Jul","value":737},{"label":"Ago","value":905},{"label":"Set","value":791},{"label":"Out","value":775},{"label":"Nov","value":826},{"label":"Dez","value":1052}];
const MX = 1052;
