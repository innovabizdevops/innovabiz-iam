...
const KPIS = [{"l":"Total Telecom Oss","v":"6.140","t":"-1.3%","d":"down"},{"l":"Inventory Ativos","v":"3.223","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"68.5%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"71","t":"-2.8%","d":"down"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Oss #001","Telecom Oss #002","2.784","6.068","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Oss #002","Telecom Oss #003","4.439","3.056","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Oss #003","Telecom Oss #004","2.651","923","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Oss #004","Telecom Oss #005","4.479","4.410","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Oss #005","Telecom Oss #001","1.433","5.069","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":475},{"label":"Mar","value":467},{"label":"Abr","value":456},{"label":"Mai","value":411},{"label":"Jun","value":765},{"label":"Jul","value":719},{"label":"Ago","value":695},{"label":"Set","value":788},{"label":"Out","value":557},{"label":"Nov","value":458},{"label":"Dez","value":615}];
const MX = 788;
