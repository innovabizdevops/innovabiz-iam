...
const ACCENT = "#6d28d9";
const MODULE = "Telecom OSS Platform";
const PAGE = "Fault";
const KPIS = [{"l":"Total Telecom Oss","v":"2.152","t":"-3.1%","d":"down"},{"l":"Fault Ativos","v":"2.453","t":"+14.5%","d":"up"},{"l":"Eficiência (%)","v":"78.0%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"57","t":"+0.2%","d":"up"}];
const COLS = ["ID","Fault","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Oss #001","Telecom Oss #002","2.585","2.637","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Oss #002","Telecom Oss #003","3.687","8.170","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Oss #003","Telecom Oss #004","8.427","5.719","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Oss #004","Telecom Oss #005","1.780","740","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Oss #005","Telecom Oss #001","4.482","814","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":373},{"label":"Mar","value":539},{"label":"Abr","value":371},{"label":"Mai","value":534},{"label":"Jun","value":530},{"label":"Jul","value":326},{"label":"Ago","value":436},{"label":"Set","value":349},{"label":"Out","value":344},{"label":"Nov","value":396},{"label":"Dez","value":574}];
const MX = 574;
