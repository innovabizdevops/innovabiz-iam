...
const PAGE = "Resource";
const KPIS = [{"l":"Dashboards Ativos","v":"8.118","t":"+4.7%","d":"up"},{"l":"Queries/Dia","v":"3815","t":"+11.7%","d":"up"},{"l":"Dados Processados (GB)","v":"209","t":"-4.9%","d":"down"},{"l":"Utilizadores Analytics","v":"5.446","t":"-4.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3046","2026-03-03","5.788","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4783","2026-03-13","640","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3971","2026-01-10","2.755","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2414","2026-03-11","8.190","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3691","2026-02-10","8.072","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":573},{"label":"Mar","value":662},{"label":"Abr","value":630},{"label":"Mai","value":516},{"label":"Jun","value":539},{"label":"Jul","value":835},{"label":"Ago","value":843},{"label":"Set","value":751},{"label":"Out","value":643},{"label":"Nov","value":692},{"label":"Dez","value":713}];
const MX = 843;
