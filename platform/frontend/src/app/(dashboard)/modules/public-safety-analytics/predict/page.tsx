...
const ACCENT = "#6366f1";
const MODULE = "Public Safety Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"9.094","t":"+10.2%","d":"up"},{"l":"Queries/Dia","v":"4069","t":"+1.7%","d":"up"},{"l":"Dados Processados (GB)","v":"5.344","t":"-2.8%","d":"down"},{"l":"Utilizadores Analytics","v":"1.696","t":"+7.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4469","2026-02-04","6.162","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1004","2026-01-11","1.063","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1277","2026-03-25","6.725","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3000","2026-02-13","1.889","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4488","2026-01-02","8.106","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":646},{"label":"Fev","value":816},{"label":"Mar","value":520},{"label":"Abr","value":542},{"label":"Mai","value":556},{"label":"Jun","value":764},{"label":"Jul","value":533},{"label":"Ago","value":734},{"label":"Set","value":804},{"label":"Out","value":753},{"label":"Nov","value":600},{"label":"Dez","value":578}];
const MX = 816;
