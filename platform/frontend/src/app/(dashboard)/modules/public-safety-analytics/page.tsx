...
export default function PublicSafetyAnalyticsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Public Safety Analytics</h1><p className="text-sm text-muted-foreground">Public Safety Analytics • iBOS Enterprise</p></div>
