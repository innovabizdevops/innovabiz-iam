...
const KPIS = [{"l":"Dashboards Ativos","v":"2.275","t":"+2.2%","d":"up"},{"l":"Queries/Dia","v":"2339","t":"+16.4%","d":"up"},{"l":"Dados Processados (GB)","v":"2.055","t":"+13.4%","d":"up"},{"l":"Utilizadores Analytics","v":"5.937","t":"-3.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4850","2026-02-07","3.061","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","930","2026-01-23","3.030","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2527","2026-02-10","6.311","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1256","2026-03-15","3.756","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","934","2026-01-13","7.005","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":863},{"label":"Fev","value":695},{"label":"Mar","value":745},{"label":"Abr","value":1016},{"label":"Mai","value":970},{"label":"Jun","value":797},{"label":"Jul","value":655},{"label":"Ago","value":1031},{"label":"Set","value":1003},{"label":"Out","value":963},{"label":"Nov","value":664},{"label":"Dez","value":854}];
const MX = 1031;
