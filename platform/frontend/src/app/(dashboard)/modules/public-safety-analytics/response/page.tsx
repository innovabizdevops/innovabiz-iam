...
const PAGE = "Response";
const KPIS = [{"l":"Dashboards Ativos","v":"496","t":"+16.3%","d":"up"},{"l":"Queries/Dia","v":"3381","t":"+1.9%","d":"up"},{"l":"Dados Processados (GB)","v":"264","t":"+3.2%","d":"up"},{"l":"Utilizadores Analytics","v":"1.062","t":"+0.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2495","2026-01-18","2.130","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4570","2026-03-05","4.741","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3569","2026-03-16","8.907","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1198","2026-03-09","5.857","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3253","2026-02-09","5.489","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1016},{"label":"Fev","value":932},{"label":"Mar","value":823},{"label":"Abr","value":967},{"label":"Mai","value":841},{"label":"Jun","value":931},{"label":"Jul","value":687},{"label":"Ago","value":758},{"label":"Set","value":749},{"label":"Out","value":941},{"label":"Nov","value":853},{"label":"Dez","value":765}];
const MX = 1016;
