...
const PAGE = "Crime";
const KPIS = [{"l":"Dashboards Ativos","v":"4.497","t":"+15.3%","d":"up"},{"l":"Queries/Dia","v":"1150","t":"+3.9%","d":"up"},{"l":"Dados Processados (GB)","v":"4.393","t":"+7.1%","d":"up"},{"l":"Utilizadores Analytics","v":"5.307","t":"+5.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4041","2026-01-01","2.003","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4818","2026-01-08","1.117","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1658","2026-03-03","6.746","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2106","2026-01-19","6.069","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","368","2026-02-18","2.765","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":806},{"label":"Mar","value":651},{"label":"Abr","value":562},{"label":"Mai","value":509},{"label":"Jun","value":432},{"label":"Jul","value":807},{"label":"Ago","value":753},{"label":"Set","value":503},{"label":"Out","value":473},{"label":"Nov","value":598},{"label":"Dez","value":520}];
const MX = 817;
