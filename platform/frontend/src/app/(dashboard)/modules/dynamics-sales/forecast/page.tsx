...
const ACCENT = "#00bcf2";
const MODULE = "Sales Hub (Dynamics 365)";
const PAGE = "Forecast";
const KPIS = [{"l":"Vendas YTD (€)","v":"€88639","t":"+3.5%","d":"up"},{"l":"Pipeline (€)","v":"€5424","t":"+7.7%","d":"up"},{"l":"Atingimento Quota (%)","v":"67.1%","t":"+8.2%","d":"up"},{"l":"Win Rate (%)","v":"68.7%","t":"-2.5%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 20093.18","€ 26495.46","€ 18332.95","71.4%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 46283.14","€ 20092.05","€ 48397.59","89.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 29546.20","€ 25211.61","€ 11100.57","76.4%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 29820.17","€ 29943.64","€ 23780.11","81.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 31781.92","€ 11963.67","€ 680.18","75.5%"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":712},{"label":"Mar","value":509},{"label":"Abr","value":675},{"label":"Mai","value":597},{"label":"Jun","value":755},{"label":"Jul","value":735},{"label":"Ago","value":394},{"label":"Set","value":632},{"label":"Out","value":452},{"label":"Nov","value":561},{"label":"Dez","value":695}];
const MX = 755;
