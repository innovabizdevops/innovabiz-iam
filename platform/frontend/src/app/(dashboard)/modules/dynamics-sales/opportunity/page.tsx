...
const KPIS = [{"l":"Vendas YTD (€)","v":"€85388","t":"+11.3%","d":"up"},{"l":"Pipeline (€)","v":"€58244","t":"-2.5%","d":"down"},{"l":"Atingimento Quota (%)","v":"84.6%","t":"+5.3%","d":"up"},{"l":"Win Rate (%)","v":"75.0%","t":"+3.5%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 21108.24","€ 32106.62","€ 20005.70","88.4%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 13832.44","€ 13733.18","€ 30621.16","82.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 26896.90","€ 29591.01","€ 41066.38","77.4%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 44036.92","€ 4857.65","€ 3850.12","74.7%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 36811.14","€ 27637.27","€ 3068.60","77.9%"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":847},{"label":"Mar","value":510},{"label":"Abr","value":775},{"label":"Mai","value":627},{"label":"Jun","value":776},{"label":"Jul","value":548},{"label":"Ago","value":820},{"label":"Set","value":675},{"label":"Out","value":607},{"label":"Nov","value":766},{"label":"Dez","value":473}];
const MX = 847;
