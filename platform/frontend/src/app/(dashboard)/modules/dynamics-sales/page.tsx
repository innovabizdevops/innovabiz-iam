...
/* ═══ Sales Hub (Dynamics 365) — Dashboard ═══ */

const ACCENT = "#00bcf2";

const KPIS = [
    { label: "Total Registos", value: "2470", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3363", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€280K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "-3%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1623632070", cells: ["DYN-6070", "Sales Hub (Dynamics 365) Item 1", "19/7/2026", "€32 170"], status: "active" as const },
    { id: "1623635641", cells: ["DYN-9641", "Sales Hub (Dynamics 365) Item 2", "6/2/2026", "€35 741"], status: "pending" as const },
    { id: "1623639212", cells: ["DYN-4212", "Sales Hub (Dynamics 365) Item 3", "21/9/2026", "€39 312"], status: "completed" as const },
    { id: "1623642783", cells: ["DYN-7783", "Sales Hub (Dynamics 365) Item 4", "8/4/2026", "€42 883"], status: "warning" as const },
    { id: "1623646354", cells: ["DYN-2354", "Sales Hub (Dynamics 365) Item 5", "23/11/2026", "€46 454"], status: "active" as const },
];
...
export default function SalesHubDynamics365Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sales Hub (Dynamics 365)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Sales Hub (Dynamics 365)</p>
                    </div>
                </div>
