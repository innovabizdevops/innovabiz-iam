...
const PAGE = "Insight";
const KPIS = [{"l":"Vendas YTD (€)","v":"€96598","t":"+12.1%","d":"up"},{"l":"Pipeline (€)","v":"€80314","t":"+7.4%","d":"up"},{"l":"Atingimento Quota (%)","v":"77.6%","t":"+1.0%","d":"up"},{"l":"Win Rate (%)","v":"66.0%","t":"+14.3%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 39358.73","€ 41923.96","€ 17797.74","88.1%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 43317.93","€ 27542.35","€ 35503.10","89.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 48636.03","€ 23313.22","€ 710.07","89.2%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 34956.19","€ 6621.13","€ 18551.19","80.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 26876.03","€ 47467.84","€ 9031.33","97.3%"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":769},{"label":"Mar","value":634},{"label":"Abr","value":661},{"label":"Mai","value":639},{"label":"Jun","value":535},{"label":"Jul","value":728},{"label":"Ago","value":425},{"label":"Set","value":436},{"label":"Out","value":500},{"label":"Nov","value":614},{"label":"Dez","value":684}];
const MX = 769;
