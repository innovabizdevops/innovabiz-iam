...
const PAGE = "Lead";
const KPIS = [{"l":"Vendas YTD (€)","v":"€89458","t":"+8.3%","d":"up"},{"l":"Pipeline (€)","v":"€65876","t":"+11.9%","d":"up"},{"l":"Atingimento Quota (%)","v":"68.0%","t":"-1.5%","d":"down"},{"l":"Win Rate (%)","v":"67.4%","t":"+8.8%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 24035.07","€ 36670.63","€ 3056.50","85.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 30126.60","€ 16599.77","€ 30709.85","79.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 29366.67","€ 27162.10","€ 15093.58","99.4%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 4011.76","€ 29466.36","€ 14085.62","71.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 33784.86","€ 21777.33","€ 32914.49","94.9%"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":616},{"label":"Mar","value":563},{"label":"Abr","value":819},{"label":"Mai","value":791},{"label":"Jun","value":771},{"label":"Jul","value":547},{"label":"Ago","value":881},{"label":"Set","value":699},{"label":"Out","value":793},{"label":"Nov","value":796},{"label":"Dez","value":733}];
const MX = 881;
