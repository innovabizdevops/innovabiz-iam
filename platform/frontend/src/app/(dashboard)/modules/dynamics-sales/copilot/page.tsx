...
const PAGE = "Copilot";
const KPIS = [{"l":"Vendas YTD (€)","v":"€62270","t":"-4.9%","d":"down"},{"l":"Pipeline (€)","v":"€5169","t":"-5.3%","d":"down"},{"l":"Atingimento Quota (%)","v":"80.5%","t":"+1.6%","d":"up"},{"l":"Win Rate (%)","v":"87.9%","t":"+8.4%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 11271.94","€ 13249.10","€ 17515.43","93.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 31232.96","€ 42723.19","€ 31717.06","78.5%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 10908.35","€ 48256.21","€ 4592.16","85.1%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 38480.53","€ 6706.06","€ 19160.07","85.7%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 19825.39","€ 37674.67","€ 37594.64","83.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":887},{"label":"Fev","value":808},{"label":"Mar","value":728},{"label":"Abr","value":876},{"label":"Mai","value":639},{"label":"Jun","value":618},{"label":"Jul","value":798},{"label":"Ago","value":769},{"label":"Set","value":599},{"label":"Out","value":850},{"label":"Nov","value":711},{"label":"Dez","value":912}];
const MX = 912;
