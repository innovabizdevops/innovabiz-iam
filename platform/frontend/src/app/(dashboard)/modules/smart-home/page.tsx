...
const KPIS = [
    { label: "Total Registos", value: "4854", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2542", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€475K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1669481354", cells: ["SMA-9354", "Smart Home Item 1", "3/3/2026", "€31 454"], status: "active" as const },
    { id: "1669484925", cells: ["SMA-3925", "Smart Home Item 2", "18/10/2026", "€35 025"], status: "pending" as const },
    { id: "1669488496", cells: ["SMA-7496", "Smart Home Item 3", "5/5/2026", "€38 596"], status: "completed" as const },
    { id: "1669492067", cells: ["SMA-2067", "Smart Home Item 4", "20/12/2026", "€42 167"], status: "warning" as const },
    { id: "1669495638", cells: ["SMA-5638", "Smart Home Item 5", "7/7/2026", "€45 738"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Smart Home</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Smart Home</p>
                    </div>
                </div>
