...
const ACCENT = "#6366f1";
const MODULE = "Oilfield Services";
const PAGE = "Wireline";
const KPIS = [{"l":"Total Oilfield Service","v":"2.958","t":"+18.0%","d":"up"},{"l":"Wireline Ativos","v":"5.760","t":"+6.4%","d":"up"},{"l":"Eficiência (%)","v":"76.9%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"58","t":"+1.0%","d":"up"}];
const COLS = ["ID","Wireline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oilfield Service #001","Oilfield Service #002","4.966","6.015","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Oilfield Service #002","Oilfield Service #003","148","6.465","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Oilfield Service #003","Oilfield Service #004","5.024","2.278","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Oilfield Service #004","Oilfield Service #005","8.627","1.372","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oilfield Service #005","Oilfield Service #001","1.489","377","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":776},{"label":"Mar","value":663},{"label":"Abr","value":906},{"label":"Mai","value":911},{"label":"Jun","value":669},{"label":"Jul","value":896},{"label":"Ago","value":664},{"label":"Set","value":687},{"label":"Out","value":686},{"label":"Nov","value":791},{"label":"Dez","value":680}];
const MX = 911;
...
export default function WirelinePage() {
    return (
