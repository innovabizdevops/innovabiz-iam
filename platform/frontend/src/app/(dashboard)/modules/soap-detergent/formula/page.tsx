...
const ACCENT = "#0ea5e9";
const MODULE = "Soap & Detergent";
const PAGE = "Formula";
const KPIS = [{"l":"Formulários Ativos","v":"3.070","t":"+5.9%","d":"up"},{"l":"Submissões/Dia","v":"2599","t":"+9.4%","d":"up"},{"l":"Documentos Gerados","v":"7.281","t":"-4.3%","d":"down"},{"l":"Templates","v":"1.764","t":"+16.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.606","2026-01-10","6.503","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.839","2026-03-28","4.962","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.680","2026-02-10","2.848","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.349","2026-01-26","1.247","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.170","2026-03-11","6.363","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":898},{"label":"Fev","value":815},{"label":"Mar","value":594},{"label":"Abr","value":550},{"label":"Mai","value":749},{"label":"Jun","value":531},{"label":"Jul","value":913},{"label":"Ago","value":664},{"label":"Set","value":710},{"label":"Out","value":837},{"label":"Nov","value":663},{"label":"Dez","value":669}];
const MX = 913;
