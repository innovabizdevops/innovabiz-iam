...
/* ═══ Soap & Detergent — Dashboard ═══ */

const ACCENT = "#0ea5e9";

const KPIS = [
    { label: "Total Registos", value: "1875", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1350", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€162K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "262213175", cells: ["SOA-8175", "Soap & Detergent Item 1", "8/12/2026", "€13 275"], status: "active" as const },
    { id: "262216746", cells: ["SOA-2746", "Soap & Detergent Item 2", "23/7/2026", "€16 846"], status: "pending" as const },
    { id: "262220317", cells: ["SOA-6317", "Soap & Detergent Item 3", "10/2/2026", "€20 417"], status: "completed" as const },
    { id: "262223888", cells: ["SOA-9888", "Soap & Detergent Item 4", "25/9/2026", "€23 988"], status: "warning" as const },
    { id: "262227459", cells: ["SOA-4459", "Soap & Detergent Item 5", "12/4/2026", "€27 559"], status: "active" as const },
];
...
export default function SoapDetergentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Soap & Detergent</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Soap & Detergent</p>
                    </div>
                </div>
