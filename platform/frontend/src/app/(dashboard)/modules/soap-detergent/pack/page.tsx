...
const PAGE = "Pack";
const KPIS = [{"l":"Total Soap Detergent","v":"8.121","t":"+7.3%","d":"up"},{"l":"Pack Ativos","v":"2.270","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"82.7%","t":"+1.7%","d":"up"},{"l":"Score Performance","v":"91","t":"+8.4%","d":"up"}];
const COLS = ["ID","Pack","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Soap Detergent #001","Soap Detergent #002","4.304","7.780","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Soap Detergent #002","Soap Detergent #003","1.668","2.451","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Soap Detergent #003","Soap Detergent #004","8.595","1.726","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Soap Detergent #004","Soap Detergent #005","4.429","592","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Soap Detergent #005","Soap Detergent #001","7.777","4.254","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":305},{"label":"Fev","value":324},{"label":"Mar","value":618},{"label":"Abr","value":457},{"label":"Mai","value":536},{"label":"Jun","value":542},{"label":"Jul","value":485},{"label":"Ago","value":296},{"label":"Set","value":536},{"label":"Out","value":406},{"label":"Nov","value":561},{"label":"Dez","value":382}];
const MX = 618;
