...
const PAGE = "Batch";
const KPIS = [{"l":"Total Soap Detergent","v":"2.992","t":"+10.0%","d":"up"},{"l":"Batch Ativos","v":"4.221","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"89.3%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"83","t":"+13.2%","d":"up"}];
const COLS = ["ID","Batch","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Soap Detergent #001","Soap Detergent #002","1.936","9.080","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Soap Detergent #002","Soap Detergent #003","2.842","7.705","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Soap Detergent #003","Soap Detergent #004","581","823","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Soap Detergent #004","Soap Detergent #005","8.872","687","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Soap Detergent #005","Soap Detergent #001","1.656","8.396","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":698},{"label":"Mar","value":685},{"label":"Abr","value":637},{"label":"Mai","value":860},{"label":"Jun","value":813},{"label":"Jul","value":757},{"label":"Ago","value":586},{"label":"Set","value":640},{"label":"Out","value":950},{"label":"Nov","value":710},{"label":"Dez","value":581}];
const MX = 950;
