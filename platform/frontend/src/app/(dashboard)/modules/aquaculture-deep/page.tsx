...
/* ═══ Aquaculture Deep — Dashboard ═══ */

const ACCENT = "#ea580c";

const KPIS = [
    { label: "Total Registos", value: "9778", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4833", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€418K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "-11%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1058280078", cells: ["AQU-7078", "Aquaculture Deep Item 1", "3/7/2026", "€30 178"], status: "active" as const },
    { id: "1058283649", cells: ["AQU-1649", "Aquaculture Deep Item 2", "18/2/2026", "€33 749"], status: "pending" as const },
    { id: "1058287220", cells: ["AQU-5220", "Aquaculture Deep Item 3", "5/9/2026", "€37 320"], status: "completed" as const },
    { id: "1058290791", cells: ["AQU-8791", "Aquaculture Deep Item 4", "20/4/2026", "€40 891"], status: "warning" as const },
    { id: "1058294362", cells: ["AQU-3362", "Aquaculture Deep Item 5", "7/11/2026", "€44 462"], status: "active" as const },
];
...
export default function AquacultureDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Aquaculture Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Aquaculture Deep</p>
                    </div>
                </div>
