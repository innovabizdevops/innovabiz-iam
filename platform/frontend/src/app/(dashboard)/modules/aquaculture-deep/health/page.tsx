...
const ACCENT = "#ea580c";
const MODULE = "Aquaculture Deep";
const PAGE = "Health";
const KPIS = [{"l":"Embarcações Ativas","v":"1.767","t":"+10.5%","d":"up"},{"l":"Capturas (ton)","v":"2091","t":"+13.8%","d":"up"},{"l":"Quota Utilizada (%)","v":"75.2%","t":"+13.0%","d":"up"},{"l":"Certificações","v":"8.313","t":"+3.9%","d":"up"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","1466","8.986","87.0%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","1005","2.517","77.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","2183","2.210","76.3%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","2419","403","76.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","4608","3.856","89.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":404},{"label":"Fev","value":387},{"label":"Mar","value":597},{"label":"Abr","value":745},{"label":"Mai","value":753},{"label":"Jun","value":433},{"label":"Jul","value":534},{"label":"Ago","value":583},{"label":"Set","value":408},{"label":"Out","value":372},{"label":"Nov","value":586},{"label":"Dez","value":453}];
const MX = 753;
