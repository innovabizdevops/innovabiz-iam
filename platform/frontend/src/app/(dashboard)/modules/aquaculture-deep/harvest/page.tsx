...
const PAGE = "Harvest";
const KPIS = [{"l":"Embarcações Ativas","v":"5.090","t":"-4.8%","d":"down"},{"l":"Capturas (ton)","v":"4685","t":"-0.6%","d":"down"},{"l":"Quota Utilizada (%)","v":"87.1%","t":"+9.7%","d":"up"},{"l":"Certificações","v":"2.949","t":"+8.2%","d":"up"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","4512","5.649","70.7%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","2971","2.345","77.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","2227","686","97.8%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","4355","8.277","88.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","247","7.574","76.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":570},{"label":"Mar","value":479},{"label":"Abr","value":684},{"label":"Mai","value":594},{"label":"Jun","value":546},{"label":"Jul","value":668},{"label":"Ago","value":465},{"label":"Set","value":405},{"label":"Out","value":544},{"label":"Nov","value":606},{"label":"Dez","value":603}];
const MX = 684;
