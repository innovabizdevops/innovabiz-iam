...
const PAGE = "Farm";
const KPIS = [{"l":"Embarcações Ativas","v":"3.111","t":"+1.1%","d":"up"},{"l":"Capturas (ton)","v":"2292","t":"-1.4%","d":"down"},{"l":"Quota Utilizada (%)","v":"73.4%","t":"+14.5%","d":"up"},{"l":"Certificações","v":"2.856","t":"-2.8%","d":"down"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","1980","5.301","99.5%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","772","4.340","84.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","3901","7.118","87.6%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","2716","3.108","90.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","1447","6.049","78.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":791},{"label":"Mar","value":523},{"label":"Abr","value":725},{"label":"Mai","value":822},{"label":"Jun","value":741},{"label":"Jul","value":560},{"label":"Ago","value":719},{"label":"Set","value":846},{"label":"Out","value":880},{"label":"Nov","value":843},{"label":"Dez","value":579}];
const MX = 880;
