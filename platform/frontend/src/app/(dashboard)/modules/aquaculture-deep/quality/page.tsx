...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"9.001","t":"+0.3%","d":"up"},{"l":"NC Abertas","v":"8.924","t":"-2.0%","d":"down"},{"l":"Conformidade (%)","v":"66.1%","t":"+15.1%","d":"up"},{"l":"CAPAs Pendentes","v":"2.266","t":"-3.1%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.189","71.7%","2.407","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.781","86.8%","5.033","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.990","76.9%","3.127","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.131","91.2%","5.562","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.478","88.1%","1.882","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":437},{"label":"Fev","value":670},{"label":"Mar","value":487},{"label":"Abr","value":522},{"label":"Mai","value":406},{"label":"Jun","value":409},{"label":"Jul","value":712},{"label":"Ago","value":585},{"label":"Set","value":701},{"label":"Out","value":628},{"label":"Nov","value":437},{"label":"Dez","value":355}];
const MX = 712;
