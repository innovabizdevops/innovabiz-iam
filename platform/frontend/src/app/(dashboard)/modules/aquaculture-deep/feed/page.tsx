...
const PAGE = "Feed";
const KPIS = [{"l":"Embarcações Ativas","v":"3.559","t":"+11.7%","d":"up"},{"l":"Capturas (ton)","v":"824","t":"+14.0%","d":"up"},{"l":"Quota Utilizada (%)","v":"70.1%","t":"+4.8%","d":"up"},{"l":"Certificações","v":"1.347","t":"+6.4%","d":"up"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","1509","8.104","73.3%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","3403","2.080","87.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","4581","2.133","70.9%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","266","6.634","79.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","435","5.009","94.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":633},{"label":"Mar","value":668},{"label":"Abr","value":807},{"label":"Mai","value":825},{"label":"Jun","value":901},{"label":"Jul","value":952},{"label":"Ago","value":628},{"label":"Set","value":685},{"label":"Out","value":755},{"label":"Nov","value":659},{"label":"Dez","value":599}];
const MX = 952;
