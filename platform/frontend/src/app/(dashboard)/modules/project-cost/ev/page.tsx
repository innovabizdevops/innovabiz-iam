...
const ACCENT = "#78350f";
const MODULE = "Project Costing";
const PAGE = "Earned Value";
const KPIS = [{"l":"Total Project Cost","v":"5.103","t":"+0.8%","d":"up"},{"l":"Earned Value Ativos","v":"5.264","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"92.0%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"61","t":"-4.4%","d":"down"}];
const COLS = ["ID","Earned Value","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Project Cost #001","Project Cost #002","5.042","3.751","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Project Cost #002","Project Cost #003","8.329","4.454","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Project Cost #003","Project Cost #004","8.374","5.658","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Project Cost #004","Project Cost #005","1.287","7.564","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Project Cost #005","Project Cost #001","3.584","2.374","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":570},{"label":"Fev","value":329},{"label":"Mar","value":451},{"label":"Abr","value":517},{"label":"Mai","value":341},{"label":"Jun","value":659},{"label":"Jul","value":444},{"label":"Ago","value":562},{"label":"Set","value":375},{"label":"Out","value":400},{"label":"Nov","value":374},{"label":"Dez","value":630}];
const MX = 659;
