...
const PAGE = "Forecast";
const KPIS = [{"l":"Total Project Cost","v":"2.810","t":"+14.3%","d":"up"},{"l":"Forecast Ativos","v":"1.430","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"71.6%","t":"+13.3%","d":"up"},{"l":"Score Performance","v":"72","t":"+3.4%","d":"up"}];
const COLS = ["ID","Forecast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Project Cost #001","Project Cost #002","2.699","8.543","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Project Cost #002","Project Cost #003","7.123","8.155","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Project Cost #003","Project Cost #004","809","5.232","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Project Cost #004","Project Cost #005","5.075","2.416","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Project Cost #005","Project Cost #001","5.658","5.503","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":962},{"label":"Mar","value":767},{"label":"Abr","value":733},{"label":"Mai","value":985},{"label":"Jun","value":842},{"label":"Jul","value":612},{"label":"Ago","value":898},{"label":"Set","value":717},{"label":"Out","value":806},{"label":"Nov","value":817},{"label":"Dez","value":976}];
const MX = 985;
