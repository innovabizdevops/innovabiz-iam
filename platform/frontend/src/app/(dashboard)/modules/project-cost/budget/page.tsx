...
const PAGE = "Budget Setup";
const KPIS = [{"l":"Total Project Cost","v":"6.439","t":"+6.5%","d":"up"},{"l":"Budget Setup Ativos","v":"€75034","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"89.0%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"60","t":"-5.9%","d":"down"}];
const COLS = ["ID","Budget Setup","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Project Cost #001","€ 25999.06","4.383","1.866","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Project Cost #002","€ 35004.07","3.161","8.867","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Project Cost #003","€ 17400.96","4.703","6.773","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Project Cost #004","€ 41429.66","1.087","7.786","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Project Cost #005","€ 49899.70","1.574","1.181","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":574},{"label":"Mar","value":497},{"label":"Abr","value":275},{"label":"Mai","value":531},{"label":"Jun","value":493},{"label":"Jul","value":407},{"label":"Ago","value":287},{"label":"Set","value":298},{"label":"Out","value":553},{"label":"Nov","value":468},{"label":"Dez","value":394}];
const MX = 617;
