...
const PAGE = "VoC Survey Engine";
const KPIS = [{"l":"Projetos Melhoria","v":"1.824","t":"-1.4%","d":"down"},{"l":"Savings (€)","v":"€31797","t":"+11.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"85.0%","t":"+7.7%","d":"up"},{"l":"Ciclos PDCA","v":"4.412","t":"+11.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.756","€ 12732.24","4.801","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.218","€ 40375.44","7.452","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.258","€ 18629.52","1.578","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.787","€ 13401.40","225","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.236","€ 24411.64","8.155","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":438},{"label":"Mar","value":752},{"label":"Abr","value":398},{"label":"Mai","value":601},{"label":"Jun","value":724},{"label":"Jul","value":369},{"label":"Ago","value":427},{"label":"Set","value":546},{"label":"Out","value":723},{"label":"Nov","value":697},{"label":"Dez","value":375}];
const MX = 752;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>CX</span></h1>
                </div>
