...
const KPIS = [{"l":"Projetos Melhoria","v":"4.976","t":"+14.3%","d":"up"},{"l":"Savings (€)","v":"€98261","t":"-0.1%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"77.2%","t":"+10.2%","d":"up"},{"l":"Ciclos PDCA","v":"4.098","t":"+12.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.877","€ 28010.25","7.979","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.831","€ 41076.38","6.700","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.809","€ 45867.33","2.360","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.844","€ 27793.51","3.337","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","244","€ 35820.03","7.750","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":589},{"label":"Mar","value":539},{"label":"Abr","value":634},{"label":"Mai","value":438},{"label":"Jun","value":521},{"label":"Jul","value":416},{"label":"Ago","value":599},{"label":"Set","value":551},{"label":"Out","value":391},{"label":"Nov","value":529},{"label":"Dez","value":656}];
const MX = 662;
