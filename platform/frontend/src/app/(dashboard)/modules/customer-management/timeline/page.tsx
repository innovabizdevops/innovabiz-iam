...
const PAGE = "Customer Timeline";
const KPIS = [{"l":"Projetos Melhoria","v":"7.633","t":"+1.2%","d":"up"},{"l":"Savings (€)","v":"€41547","t":"+15.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"72.3%","t":"-5.3%","d":"down"},{"l":"Ciclos PDCA","v":"7.719","t":"+14.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.606","€ 38272.68","2.212","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.932","€ 868.95","4.324","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.349","€ 44990.55","7.511","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.260","€ 30296.68","595","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.836","€ 28897.76","1.083","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":285},{"label":"Fev","value":318},{"label":"Mar","value":352},{"label":"Abr","value":325},{"label":"Mai","value":329},{"label":"Jun","value":576},{"label":"Jul","value":485},{"label":"Ago","value":263},{"label":"Set","value":550},{"label":"Out","value":377},{"label":"Nov","value":317},{"label":"Dez","value":213}];
const MX = 576;
