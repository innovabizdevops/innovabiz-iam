...
const PAGE = "Service Mgmt";
const KPIS = [{"l":"Projetos Melhoria","v":"6.412","t":"+8.9%","d":"up"},{"l":"Savings (€)","v":"€27125","t":"+11.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"67.3%","t":"+15.0%","d":"up"},{"l":"Ciclos PDCA","v":"156","t":"+13.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.470","€ 49682.36","4.366","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.777","€ 48123.48","4.996","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.703","€ 28751.13","5.023","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.443","€ 872.79","301","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.503","€ 10119.17","8.575","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":884},{"label":"Fev","value":871},{"label":"Mar","value":859},{"label":"Abr","value":894},{"label":"Mai","value":675},{"label":"Jun","value":652},{"label":"Jul","value":760},{"label":"Ago","value":965},{"label":"Set","value":853},{"label":"Out","value":598},{"label":"Nov","value":638},{"label":"Dez","value":747}];
const MX = 965;
