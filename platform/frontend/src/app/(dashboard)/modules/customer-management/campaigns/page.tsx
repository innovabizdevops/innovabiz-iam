...
const KPIS = [{"l":"Projetos Melhoria","v":"6.255","t":"+11.2%","d":"up"},{"l":"Savings (€)","v":"€30547","t":"-1.7%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"89.9%","t":"+13.3%","d":"up"},{"l":"Ciclos PDCA","v":"5.264","t":"+4.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.902","€ 41875.47","1.997","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.880","€ 5068.89","1.942","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","330","€ 45485.82","1.980","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","498","€ 45645.14","8.838","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","278","€ 17668.29","5.375","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":1032},{"label":"Mar","value":750},{"label":"Abr","value":970},{"label":"Mai","value":924},{"label":"Jun","value":1049},{"label":"Jul","value":943},{"label":"Ago","value":1051},{"label":"Set","value":940},{"label":"Out","value":852},{"label":"Nov","value":691},{"label":"Dez","value":731}];
const MX = 1051;
