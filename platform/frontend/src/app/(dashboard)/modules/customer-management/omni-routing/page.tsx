...
const PAGE = "Omni-Channel Routing";
const KPIS = [{"l":"Perfis Unificados","v":"3.032","t":"+14.5%","d":"up"},{"l":"Segmentos Ativos","v":"7.454","t":"+3.2%","d":"up"},{"l":"NPS Score","v":"75","t":"+8.7%","d":"up"},{"l":"Churn Previsto (%)","v":"75.7%","t":"+8.0%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","2.364","€ 31334.45","93.1%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","7.200","€ 26972.24","93.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","695","€ 30240.72","87.2%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","238","€ 13556.65","96.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","6.954","€ 241.91","85.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":783},{"label":"Mar","value":851},{"label":"Abr","value":537},{"label":"Mai","value":646},{"label":"Jun","value":569},{"label":"Jul","value":598},{"label":"Ago","value":522},{"label":"Set","value":848},{"label":"Out","value":863},{"label":"Nov","value":816},{"label":"Dez","value":864}];
const MX = 864;
...
export default function OmniRoutingPage() {
    return (
