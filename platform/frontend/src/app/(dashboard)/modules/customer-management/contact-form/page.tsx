...
const PAGE = "Contact Form Builder";
const KPIS = [{"l":"Formulários Ativos","v":"917","t":"-4.8%","d":"down"},{"l":"Submissões/Dia","v":"1352","t":"+8.0%","d":"up"},{"l":"Documentos Gerados","v":"8.215","t":"+17.3%","d":"up"},{"l":"Templates","v":"2.435","t":"+13.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.501","2026-02-22","2.847","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.649","2026-03-17","8.238","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","465","2026-03-28","917","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.695","2026-01-13","7.568","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.079","2026-02-12","5.585","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":467},{"label":"Fev","value":320},{"label":"Mar","value":471},{"label":"Abr","value":610},{"label":"Mai","value":495},{"label":"Jun","value":502},{"label":"Jul","value":273},{"label":"Ago","value":274},{"label":"Set","value":636},{"label":"Out","value":405},{"label":"Nov","value":480},{"label":"Dez","value":566}];
const MX = 636;
