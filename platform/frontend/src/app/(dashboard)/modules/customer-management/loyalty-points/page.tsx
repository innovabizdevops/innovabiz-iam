...
const PAGE = "Loyalty Points Engine";
const KPIS = [{"l":"Projetos Melhoria","v":"2.314","t":"+3.3%","d":"up"},{"l":"Savings (€)","v":"€27681","t":"+8.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"68.0%","t":"+6.2%","d":"up"},{"l":"Ciclos PDCA","v":"996","t":"+4.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.230","€ 13000.84","2.864","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.365","€ 44170.10","2.289","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.033","€ 44049.11","4.789","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.428","€ 49300.41","2.311","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.977","€ 41775.30","2.026","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":374},{"label":"Mar","value":435},{"label":"Abr","value":412},{"label":"Mai","value":535},{"label":"Jun","value":531},{"label":"Jul","value":479},{"label":"Ago","value":257},{"label":"Set","value":547},{"label":"Out","value":381},{"label":"Nov","value":446},{"label":"Dez","value":408}];
const MX = 562;
