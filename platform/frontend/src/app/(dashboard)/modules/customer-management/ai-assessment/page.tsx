...
const PAGE = "AI Assessment";
const KPIS = [{"l":"Projetos Melhoria","v":"1.084","t":"+2.3%","d":"up"},{"l":"Savings (€)","v":"€57865","t":"+4.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"72.6%","t":"+11.2%","d":"up"},{"l":"Ciclos PDCA","v":"2.905","t":"-1.7%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.798","€ 47687.89","8.198","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.740","€ 19713.90","2.868","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.245","€ 18900.67","5.205","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.710","€ 9571.44","8.264","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.952","€ 29074.35","6.756","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":814},{"label":"Fev","value":829},{"label":"Mar","value":765},{"label":"Abr","value":1028},{"label":"Mai","value":700},{"label":"Jun","value":1078},{"label":"Jul","value":951},{"label":"Ago","value":998},{"label":"Set","value":690},{"label":"Out","value":891},{"label":"Nov","value":719},{"label":"Dez","value":805}];
const MX = 1078;
