...
const PAGE = "Territory Mgmt";
const KPIS = [{"l":"Vendas YTD (€)","v":"€25260","t":"-1.6%","d":"down"},{"l":"Pipeline (€)","v":"€45437","t":"+15.1%","d":"up"},{"l":"Atingimento Quota (%)","v":"92.4%","t":"+7.0%","d":"up"},{"l":"Win Rate (%)","v":"72.3%","t":"+16.9%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 17561.05","€ 41406.53","€ 32863.98","74.4%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 24327.65","€ 1257.68","€ 33439.93","72.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 12267.70","€ 40127.45","€ 21943.82","95.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 42198.55","€ 45446.37","€ 41021.97","84.7%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 48717.01","€ 22950.86","€ 47057.83","86.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":436},{"label":"Fev","value":226},{"label":"Mar","value":534},{"label":"Abr","value":418},{"label":"Mai","value":517},{"label":"Jun","value":457},{"label":"Jul","value":511},{"label":"Ago","value":279},{"label":"Set","value":367},{"label":"Out","value":597},{"label":"Nov","value":616},{"label":"Dez","value":503}];
const MX = 616;
