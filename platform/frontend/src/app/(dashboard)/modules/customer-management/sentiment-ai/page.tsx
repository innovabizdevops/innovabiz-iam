...
const PAGE = "Sentiment AI";
const KPIS = [{"l":"Dashboards Ativos","v":"2.588","t":"-5.7%","d":"down"},{"l":"Queries/Dia","v":"4545","t":"-5.8%","d":"down"},{"l":"Dados Processados (GB)","v":"7.306","t":"+5.9%","d":"up"},{"l":"Utilizadores Analytics","v":"4.077","t":"-1.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4119","2026-02-04","6.291","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","614","2026-03-02","6.898","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2684","2026-03-10","388","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","567","2026-02-01","1.077","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3513","2026-02-05","6.850","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":915},{"label":"Mar","value":679},{"label":"Abr","value":787},{"label":"Mai","value":898},{"label":"Jun","value":744},{"label":"Jul","value":695},{"label":"Ago","value":730},{"label":"Set","value":735},{"label":"Out","value":597},{"label":"Nov","value":631},{"label":"Dez","value":910}];
const MX = 915;
