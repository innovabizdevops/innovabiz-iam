...
const PAGE = "Upsell/Cross-sell AI";
const KPIS = [{"l":"Projetos Melhoria","v":"7.125","t":"-5.8%","d":"down"},{"l":"Savings (€)","v":"€2153","t":"+15.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"67.1%","t":"+10.1%","d":"up"},{"l":"Ciclos PDCA","v":"2.668","t":"+7.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.893","€ 7068.66","7.723","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.977","€ 31466.20","8.601","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.171","€ 44745.46","4.509","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.668","€ 12194.47","1.059","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.024","€ 32704.00","2.827","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":705},{"label":"Mar","value":909},{"label":"Abr","value":763},{"label":"Mai","value":1039},{"label":"Jun","value":739},{"label":"Jul","value":769},{"label":"Ago","value":702},{"label":"Set","value":906},{"label":"Out","value":778},{"label":"Nov","value":788},{"label":"Dez","value":856}];
const MX = 1039;
