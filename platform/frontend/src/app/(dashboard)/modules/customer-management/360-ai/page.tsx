...
const ACCENT = "#6366f1";
const MODULE = "Customer Management";
const PAGE = "Customer 360 AI";
const KPIS = [{"l":"Projetos Melhoria","v":"912","t":"-2.3%","d":"down"},{"l":"Savings (€)","v":"€47310","t":"+15.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"74.4%","t":"+3.4%","d":"up"},{"l":"Ciclos PDCA","v":"3.374","t":"-4.9%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.223","€ 46672.38","8.694","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.149","€ 29155.81","9.064","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","586","€ 42584.86","6.575","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.192","€ 11278.94","7.002","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.173","€ 16331.19","7.237","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":665},{"label":"Mar","value":743},{"label":"Abr","value":762},{"label":"Mai","value":464},{"label":"Jun","value":465},{"label":"Jul","value":833},{"label":"Ago","value":824},{"label":"Set","value":490},{"label":"Out","value":832},{"label":"Nov","value":669},{"label":"Dez","value":498}];
const MX = 833;
...
export default function 360AiPage() {
    return (
