...
const PAGE = "Churn Prediction AI";
const KPIS = [{"l":"ARR (€M)","v":"€49.2M","t":"+0.5%","d":"up"},{"l":"MRR (€)","v":"€58238","t":"+9.6%","d":"up"},{"l":"Churn (%)","v":"87.1%","t":"+5.7%","d":"up"},{"l":"ARPU (€)","v":"€2949","t":"-5.1%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 38407.82","4.349","€ 24212.29","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 49824.86","4.893","€ 15201.09","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 9576.88","663","€ 30628.31","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 37721.95","4.037","€ 10656.30","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 31084.59","7.168","€ 12169.86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":949},{"label":"Mar","value":1002},{"label":"Abr","value":626},{"label":"Mai","value":816},{"label":"Jun","value":636},{"label":"Jul","value":720},{"label":"Ago","value":629},{"label":"Set","value":717},{"label":"Out","value":673},{"label":"Nov","value":802},{"label":"Dez","value":634}];
const MX = 1002;
