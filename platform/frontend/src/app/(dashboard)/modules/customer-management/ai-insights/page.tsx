...
const KPIS = [{"l":"Projetos Melhoria","v":"5.746","t":"+10.8%","d":"up"},{"l":"Savings (€)","v":"€5164","t":"+17.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"75.0%","t":"+17.2%","d":"up"},{"l":"Ciclos PDCA","v":"6.935","t":"-4.6%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.738","€ 15388.71","1.185","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.629","€ 6140.59","6.101","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.829","€ 40048.51","4.462","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.211","€ 39739.45","4.874","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.678","€ 10877.75","3.767","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":277},{"label":"Fev","value":362},{"label":"Mar","value":546},{"label":"Abr","value":324},{"label":"Mai","value":449},{"label":"Jun","value":562},{"label":"Jul","value":324},{"label":"Ago","value":302},{"label":"Set","value":484},{"label":"Out","value":551},{"label":"Nov","value":331},{"label":"Dez","value":422}];
const MX = 562;
