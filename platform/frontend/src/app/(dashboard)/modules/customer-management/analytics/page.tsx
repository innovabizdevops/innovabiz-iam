...
const PAGE = "Customer Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"7.278","t":"-0.2%","d":"down"},{"l":"Queries/Dia","v":"1572","t":"+8.6%","d":"up"},{"l":"Dados Processados (GB)","v":"5.092","t":"+11.6%","d":"up"},{"l":"Utilizadores Analytics","v":"1.162","t":"+8.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4293","2026-02-25","7.712","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1179","2026-01-16","4.322","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4514","2026-02-27","4.406","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4115","2026-03-15","3.563","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1448","2026-01-07","5.754","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":721},{"label":"Fev","value":731},{"label":"Mar","value":510},{"label":"Abr","value":807},{"label":"Mai","value":751},{"label":"Jun","value":491},{"label":"Jul","value":492},{"label":"Ago","value":730},{"label":"Set","value":516},{"label":"Out","value":840},{"label":"Nov","value":545},{"label":"Dez","value":635}];
const MX = 840;
