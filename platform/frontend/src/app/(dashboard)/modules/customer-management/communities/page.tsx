...
const PAGE = "Customer Communities";
const KPIS = [{"l":"Projetos Melhoria","v":"8.406","t":"+0.5%","d":"up"},{"l":"Savings (€)","v":"€13547","t":"+9.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"88.7%","t":"+15.3%","d":"up"},{"l":"Ciclos PDCA","v":"3.579","t":"-3.5%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","921","€ 39730.86","7.162","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.441","€ 21781.81","4.255","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.002","€ 5119.39","3.930","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","961","€ 34814.46","7.806","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.482","€ 46396.48","6.087","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":651},{"label":"Mar","value":382},{"label":"Abr","value":524},{"label":"Mai","value":719},{"label":"Jun","value":451},{"label":"Jul","value":647},{"label":"Ago","value":530},{"label":"Set","value":726},{"label":"Out","value":567},{"label":"Nov","value":361},{"label":"Dez","value":478}];
const MX = 726;
