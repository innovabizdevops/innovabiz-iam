...
const PAGE = "Customer Onboarding";
const KPIS = [{"l":"eNPS","v":"59","t":"+3.3%","d":"up"},{"l":"Engagement (%)","v":"71.4%","t":"+5.2%","d":"up"},{"l":"Turnover (%)","v":"78.4%","t":"+0.4%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.923","t":"+5.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.796","2026-03-23","78","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.632","2026-01-03","73","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.494","2026-01-07","63","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.898","2026-02-02","67","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.543","2026-02-06","79","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":498},{"label":"Mar","value":250},{"label":"Abr","value":540},{"label":"Mai","value":295},{"label":"Jun","value":215},{"label":"Jul","value":320},{"label":"Ago","value":530},{"label":"Set","value":323},{"label":"Out","value":573},{"label":"Nov","value":497},{"label":"Dez","value":557}];
const MX = 573;
