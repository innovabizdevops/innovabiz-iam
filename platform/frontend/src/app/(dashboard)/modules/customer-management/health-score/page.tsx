...
const KPIS = [{"l":"Projetos Melhoria","v":"496","t":"+9.1%","d":"up"},{"l":"Savings (€)","v":"€99298","t":"+11.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"94.7%","t":"-5.0%","d":"down"},{"l":"Ciclos PDCA","v":"3.007","t":"+8.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.207","€ 30525.58","5.810","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.366","€ 42266.33","7.954","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.765","€ 32336.02","5.872","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.345","€ 12067.08","3.368","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.643","€ 27572.37","1.929","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":646},{"label":"Fev","value":890},{"label":"Mar","value":720},{"label":"Abr","value":828},{"label":"Mai","value":758},{"label":"Jun","value":801},{"label":"Jul","value":614},{"label":"Ago","value":742},{"label":"Set","value":854},{"label":"Out","value":824},{"label":"Nov","value":591},{"label":"Dez","value":743}];
const MX = 890;
