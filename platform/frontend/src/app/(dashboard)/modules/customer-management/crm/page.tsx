...
const PAGE = "CRM Core";
const KPIS = [{"l":"Projetos Melhoria","v":"6.063","t":"+13.1%","d":"up"},{"l":"Savings (€)","v":"€12029","t":"+7.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"72.8%","t":"+6.7%","d":"up"},{"l":"Ciclos PDCA","v":"4.463","t":"-4.7%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.587","€ 26472.92","8.749","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.761","€ 13871.13","5.953","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.419","€ 903.48","4.686","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.227","€ 42754.07","289","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.766","€ 7616.21","1.000","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":446},{"label":"Fev","value":479},{"label":"Mar","value":453},{"label":"Abr","value":405},{"label":"Mai","value":360},{"label":"Jun","value":662},{"label":"Jul","value":503},{"label":"Ago","value":373},{"label":"Set","value":579},{"label":"Out","value":534},{"label":"Nov","value":342},{"label":"Dez","value":505}];
const MX = 662;
