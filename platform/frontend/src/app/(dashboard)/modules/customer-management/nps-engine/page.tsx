...
const PAGE = "NPS Survey Engine";
const KPIS = [{"l":"Perfis Unificados","v":"6.294","t":"+17.7%","d":"up"},{"l":"Segmentos Ativos","v":"7.924","t":"+17.6%","d":"up"},{"l":"NPS Score","v":"94","t":"+5.9%","d":"up"},{"l":"Churn Previsto (%)","v":"89.2%","t":"+1.4%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","1.424","€ 43200.88","70.2%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","8.195","€ 12055.56","96.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","4.236","€ 38991.44","95.1%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","4.096","€ 37404.34","97.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","8.112","€ 34629.82","80.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":545},{"label":"Mar","value":622},{"label":"Abr","value":658},{"label":"Mai","value":844},{"label":"Jun","value":692},{"label":"Jul","value":601},{"label":"Ago","value":538},{"label":"Set","value":877},{"label":"Out","value":720},{"label":"Nov","value":874},{"label":"Dez","value":666}];
const MX = 877;
...
export default function NpsEnginePage() {
    return (
