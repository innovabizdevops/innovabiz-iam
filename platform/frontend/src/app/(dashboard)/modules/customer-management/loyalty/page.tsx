...
const PAGE = "Loyalty Programs";
const KPIS = [{"l":"Projetos Melhoria","v":"1.329","t":"+2.9%","d":"up"},{"l":"Savings (€)","v":"€37683","t":"+13.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"83.8%","t":"+13.0%","d":"up"},{"l":"Ciclos PDCA","v":"2.243","t":"+5.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.687","€ 36584.51","785","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.686","€ 32616.23","7.946","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.758","€ 17611.76","5.035","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.993","€ 37558.43","9.042","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.553","€ 3392.41","4.219","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":626},{"label":"Mar","value":688},{"label":"Abr","value":605},{"label":"Mai","value":784},{"label":"Jun","value":933},{"label":"Jul","value":783},{"label":"Ago","value":564},{"label":"Set","value":782},{"label":"Out","value":810},{"label":"Nov","value":791},{"label":"Dez","value":778}];
const MX = 933;
