...
const PAGE = "Leads";
const KPIS = [{"l":"Projetos Melhoria","v":"5.014","t":"+6.9%","d":"up"},{"l":"Savings (€)","v":"€28057","t":"-0.2%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"66.4%","t":"+6.5%","d":"up"},{"l":"Ciclos PDCA","v":"1.913","t":"-0.4%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.881","€ 16575.58","4.031","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","873","€ 21868.15","7.252","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.142","€ 30995.79","2.757","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.874","€ 4610.21","6.010","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.743","€ 14290.99","3.432","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":300},{"label":"Fev","value":355},{"label":"Mar","value":566},{"label":"Abr","value":537},{"label":"Mai","value":565},{"label":"Jun","value":523},{"label":"Jul","value":565},{"label":"Ago","value":548},{"label":"Set","value":388},{"label":"Out","value":422},{"label":"Nov","value":216},{"label":"Dez","value":417}];
const MX = 566;
