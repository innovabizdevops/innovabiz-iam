...
const PAGE = "Lead Capture Forms";
const KPIS = [{"l":"Formulários Ativos","v":"6.156","t":"+3.8%","d":"up"},{"l":"Submissões/Dia","v":"1485","t":"+8.0%","d":"up"},{"l":"Documentos Gerados","v":"4.261","t":"+12.0%","d":"up"},{"l":"Templates","v":"158","t":"+16.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.121","2026-01-13","2.862","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.342","2026-01-27","1.639","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.807","2026-03-13","5.055","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.895","2026-02-23","545","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.001","2026-03-11","5.611","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":465},{"label":"Fev","value":613},{"label":"Mar","value":550},{"label":"Abr","value":284},{"label":"Mai","value":616},{"label":"Jun","value":487},{"label":"Jul","value":230},{"label":"Ago","value":390},{"label":"Set","value":397},{"label":"Out","value":281},{"label":"Nov","value":570},{"label":"Dez","value":304}];
const MX = 616;
