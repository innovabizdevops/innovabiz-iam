...
const PAGE = "Account Hierarchy";
const KPIS = [{"l":"Projetos Melhoria","v":"7.667","t":"+12.8%","d":"up"},{"l":"Savings (€)","v":"€16129","t":"+6.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"75.8%","t":"+1.9%","d":"up"},{"l":"Ciclos PDCA","v":"7.252","t":"+10.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.301","€ 18743.11","3.654","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.714","€ 26028.55","5.871","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.773","€ 38915.74","5.497","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.654","€ 47430.59","5.572","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.183","€ 35373.35","3.376","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":579},{"label":"Mar","value":338},{"label":"Abr","value":494},{"label":"Mai","value":273},{"label":"Jun","value":259},{"label":"Jul","value":592},{"label":"Ago","value":597},{"label":"Set","value":453},{"label":"Out","value":264},{"label":"Nov","value":416},{"label":"Dez","value":445}];
const MX = 597;
