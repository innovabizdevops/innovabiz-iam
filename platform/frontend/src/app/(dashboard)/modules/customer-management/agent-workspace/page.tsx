...
const PAGE = "Agent Workspace";
const KPIS = [{"l":"eNPS","v":"56","t":"+10.7%","d":"up"},{"l":"Engagement (%)","v":"88.0%","t":"+8.9%","d":"up"},{"l":"Turnover (%)","v":"70.4%","t":"+2.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.936","t":"+9.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.132","2026-03-03","66","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.989","2026-01-07","74","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.774","2026-01-02","59","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.375","2026-02-27","62","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.215","2026-01-14","67","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":749},{"label":"Mar","value":590},{"label":"Abr","value":619},{"label":"Mai","value":518},{"label":"Jun","value":508},{"label":"Jul","value":597},{"label":"Ago","value":636},{"label":"Set","value":524},{"label":"Out","value":515},{"label":"Nov","value":756},{"label":"Dez","value":523}];
const MX = 756;
