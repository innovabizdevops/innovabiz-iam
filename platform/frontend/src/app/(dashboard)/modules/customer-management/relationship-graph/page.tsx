...
const PAGE = "Relationship Graph";
const KPIS = [{"l":"Projetos Melhoria","v":"1.526","t":"+11.2%","d":"up"},{"l":"Savings (€)","v":"€35737","t":"+5.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"89.1%","t":"+11.9%","d":"up"},{"l":"Ciclos PDCA","v":"4.315","t":"+9.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.179","€ 41907.93","6.775","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.924","€ 18336.08","6.318","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.456","€ 43374.04","2.102","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.705","€ 8990.73","6.242","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","101","€ 6703.60","566","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":483},{"label":"Mar","value":636},{"label":"Abr","value":648},{"label":"Mai","value":754},{"label":"Jun","value":746},{"label":"Jul","value":683},{"label":"Ago","value":455},{"label":"Set","value":604},{"label":"Out","value":502},{"label":"Nov","value":696},{"label":"Dez","value":652}];
const MX = 754;
