...
const PAGE = "Self-Service Mgmt";
const KPIS = [{"l":"Projetos Melhoria","v":"6.804","t":"-0.1%","d":"down"},{"l":"Savings (€)","v":"€98209","t":"+14.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"92.8%","t":"+11.2%","d":"up"},{"l":"Ciclos PDCA","v":"7.551","t":"+12.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.027","€ 28201.11","4.732","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.351","€ 24672.03","7.449","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.699","€ 18183.67","7.300","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.722","€ 43149.40","6.283","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.428","€ 13350.30","2.961","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":526},{"label":"Fev","value":628},{"label":"Mar","value":877},{"label":"Abr","value":697},{"label":"Mai","value":728},{"label":"Jun","value":822},{"label":"Jul","value":763},{"label":"Ago","value":730},{"label":"Set","value":537},{"label":"Out","value":769},{"label":"Nov","value":818},{"label":"Dez","value":873}];
const MX = 877;
