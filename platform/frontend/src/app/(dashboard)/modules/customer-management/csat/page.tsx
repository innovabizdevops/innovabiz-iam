...
const PAGE = "CSAT/CES Tracker";
const KPIS = [{"l":"Projetos Melhoria","v":"6.156","t":"+12.1%","d":"up"},{"l":"Savings (€)","v":"€98504","t":"+4.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"79.8%","t":"+13.8%","d":"up"},{"l":"Ciclos PDCA","v":"745","t":"+12.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","963","€ 14166.61","7.058","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.031","€ 39394.08","2.521","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.896","€ 22712.94","2.394","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","126","€ 45559.59","3.319","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.796","€ 15798.38","7.887","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":446},{"label":"Fev","value":493},{"label":"Mar","value":624},{"label":"Abr","value":341},{"label":"Mai","value":469},{"label":"Jun","value":344},{"label":"Jul","value":473},{"label":"Ago","value":510},{"label":"Set","value":623},{"label":"Out","value":704},{"label":"Nov","value":358},{"label":"Dez","value":418}];
const MX = 704;
