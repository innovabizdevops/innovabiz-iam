...
const PAGE = "Tier Management";
const KPIS = [{"l":"ARR (€M)","v":"€3.0M","t":"-3.6%","d":"down"},{"l":"MRR (€)","v":"€2857","t":"+8.7%","d":"up"},{"l":"Churn (%)","v":"93.8%","t":"+1.7%","d":"up"},{"l":"ARPU (€)","v":"€83264","t":"+3.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 7116.86","1.605","€ 18475.97","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 19692.39","1.309","€ 42294.21","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 12446.31","353","€ 24572.92","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 6062.28","6.029","€ 25242.16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 11635.01","6.977","€ 17133.98","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":711},{"label":"Mar","value":930},{"label":"Abr","value":623},{"label":"Mai","value":834},{"label":"Jun","value":615},{"label":"Jul","value":929},{"label":"Ago","value":786},{"label":"Set","value":867},{"label":"Out","value":577},{"label":"Nov","value":789},{"label":"Dez","value":766}];
const MX = 930;
...
export default function TierMgmtPage() {
    return (
