...
const ACCENT = "#6366f1";
const MODULE = "Concrete Management";
const PAGE = "Mix Design";
const KPIS = [{"l":"Formulários Ativos","v":"4.161","t":"+5.4%","d":"up"},{"l":"Submissões/Dia","v":"4280","t":"-4.2%","d":"down"},{"l":"Documentos Gerados","v":"8.499","t":"+2.8%","d":"up"},{"l":"Templates","v":"7.196","t":"+5.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.558","2026-03-24","4.633","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.545","2026-03-17","6.725","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.296","2026-01-07","5.260","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.152","2026-02-14","6.834","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.959","2026-01-12","4.410","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":763},{"label":"Mar","value":833},{"label":"Abr","value":664},{"label":"Mai","value":787},{"label":"Jun","value":932},{"label":"Jul","value":614},{"label":"Ago","value":813},{"label":"Set","value":841},{"label":"Out","value":732},{"label":"Nov","value":643},{"label":"Dez","value":677}];
const MX = 943;
