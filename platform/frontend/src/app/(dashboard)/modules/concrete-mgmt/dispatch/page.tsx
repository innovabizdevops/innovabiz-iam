...
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"7.726","t":"-5.2%","d":"down"},{"l":"Viagens/Dia","v":"2951","t":"+14.3%","d":"up"},{"l":"Pontualidade (%)","v":"91.0%","t":"-2.2%","d":"down"},{"l":"Passageiros/Dia","v":"866","t":"+1.1%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-20","2026-01-09","3.342","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-17","2026-03-09","3.590","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-10","2026-01-19","143","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-20","2026-02-04","231","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-05","2026-02-16","3.815","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":978},{"label":"Fev","value":833},{"label":"Mar","value":949},{"label":"Abr","value":612},{"label":"Mai","value":888},{"label":"Jun","value":740},{"label":"Jul","value":793},{"label":"Ago","value":979},{"label":"Set","value":608},{"label":"Out","value":660},{"label":"Nov","value":740},{"label":"Dez","value":742}];
const MX = 979;
