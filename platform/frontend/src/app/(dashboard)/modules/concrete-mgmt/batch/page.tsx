...
const PAGE = "Batch";
const KPIS = [{"l":"Total Concrete Mgmt","v":"4.638","t":"-4.6%","d":"down"},{"l":"Batch Ativos","v":"4.683","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"91.7%","t":"-0.2%","d":"down"},{"l":"Score Performance","v":"67","t":"+7.8%","d":"up"}];
const COLS = ["ID","Batch","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Concrete Mgmt #001","Concrete Mgmt #002","2.166","3.272","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Concrete Mgmt #002","Concrete Mgmt #003","5.352","3.907","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Concrete Mgmt #003","Concrete Mgmt #004","1.490","2.262","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Concrete Mgmt #004","Concrete Mgmt #005","3.604","4.351","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Concrete Mgmt #005","Concrete Mgmt #001","7.830","5.207","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":504},{"label":"Fev","value":378},{"label":"Mar","value":313},{"label":"Abr","value":399},{"label":"Mai","value":615},{"label":"Jun","value":504},{"label":"Jul","value":654},{"label":"Ago","value":500},{"label":"Set","value":436},{"label":"Out","value":470},{"label":"Nov","value":420},{"label":"Dez","value":595}];
const MX = 654;
