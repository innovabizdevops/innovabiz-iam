...
const PAGE = "Test";
const KPIS = [{"l":"Total Concrete Mgmt","v":"4.771","t":"-3.1%","d":"down"},{"l":"Test Ativos","v":"7.993","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"65.9%","t":"+5.5%","d":"up"},{"l":"Score Performance","v":"66","t":"+10.0%","d":"up"}];
const COLS = ["ID","Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Concrete Mgmt #001","Concrete Mgmt #002","3.694","4.663","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Concrete Mgmt #002","Concrete Mgmt #003","6.706","4.377","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Concrete Mgmt #003","Concrete Mgmt #004","4.440","6.132","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Concrete Mgmt #004","Concrete Mgmt #005","7.199","5.798","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Concrete Mgmt #005","Concrete Mgmt #001","6.453","5.036","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":829},{"label":"Mar","value":689},{"label":"Abr","value":657},{"label":"Mai","value":790},{"label":"Jun","value":802},{"label":"Jul","value":673},{"label":"Ago","value":943},{"label":"Set","value":930},{"label":"Out","value":617},{"label":"Nov","value":652},{"label":"Dez","value":842}];
const MX = 943;
