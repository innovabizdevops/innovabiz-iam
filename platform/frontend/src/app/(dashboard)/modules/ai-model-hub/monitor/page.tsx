...
const ACCENT = "#6366f1";
const MODULE = "AI Model Hub";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Ai Model Hub","v":"3.292","t":"+17.5%","d":"up"},{"l":"Monitor Ativos","v":"6.258","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"80.6%","t":"+10.7%","d":"up"},{"l":"Score Performance","v":"67","t":"+17.9%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ai Model Hub #001","Ai Model Hub #002","8.817","1.913","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Ai Model Hub #002","Ai Model Hub #003","6.645","4.165","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Ai Model Hub #003","Ai Model Hub #004","1.648","2.357","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Ai Model Hub #004","Ai Model Hub #005","7.595","3.782","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ai Model Hub #005","Ai Model Hub #001","4.497","5.300","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":713},{"label":"Fev","value":802},{"label":"Mar","value":923},{"label":"Abr","value":694},{"label":"Mai","value":907},{"label":"Jun","value":852},{"label":"Jul","value":784},{"label":"Ago","value":770},{"label":"Set","value":819},{"label":"Out","value":771},{"label":"Nov","value":779},{"label":"Dez","value":719}];
const MX = 923;
