...
const KPIS = [
    { label: "Total Registos", value: "1375", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "408", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€257K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1475992275", cells: ["AI-2275", "AI Model Hub Item 1", "24/4/2026", "€42 375"], status: "active" as const },
    { id: "1475995846", cells: ["AI-5846", "AI Model Hub Item 2", "11/11/2026", "€45 946"], status: "pending" as const },
    { id: "1475999417", cells: ["AI-9417", "AI Model Hub Item 3", "26/6/2026", "€49 517"], status: "completed" as const },
    { id: "1476002988", cells: ["AI-3988", "AI Model Hub Item 4", "13/1/2026", "€3088"], status: "warning" as const },
    { id: "1476006559", cells: ["AI-7559", "AI Model Hub Item 5", "28/8/2026", "€6659"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Model Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Model Hub</p>
                    </div>
                </div>
