...
const ACCENT = "#059669";
const MODULE = "Smart Grid Platform";
const PAGE = "Battery Storage";
const KPIS = [{"l":"Total Smart Grid","v":"3.905","t":"+15.1%","d":"up"},{"l":"Battery Storage Ativos","v":"3.709","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"66.8%","t":"+10.6%","d":"up"},{"l":"Score Performance","v":"60","t":"+15.6%","d":"up"}];
const COLS = ["ID","Battery Storage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Smart Grid #001","Smart Grid #002","2.402","4.174","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Smart Grid #002","Smart Grid #003","8.875","4.543","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Grid #003","Smart Grid #004","5.114","3.560","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Smart Grid #004","Smart Grid #005","2.303","387","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Smart Grid #005","Smart Grid #001","8.610","715","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":714},{"label":"Mar","value":440},{"label":"Abr","value":550},{"label":"Mai","value":765},{"label":"Jun","value":489},{"label":"Jul","value":601},{"label":"Ago","value":447},{"label":"Set","value":431},{"label":"Out","value":641},{"label":"Nov","value":434},{"label":"Dez","value":440}];
const MX = 765;
