...
const PAGE = "Grid Balance";
const KPIS = [{"l":"Total Smart Grid","v":"5.392","t":"+4.2%","d":"up"},{"l":"Grid Balance Ativos","v":"3.137","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"72.5%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"78","t":"+9.4%","d":"up"}];
const COLS = ["ID","Grid Balance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Smart Grid #001","Smart Grid #002","2.429","454","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Smart Grid #002","Smart Grid #003","404","4.443","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Grid #003","Smart Grid #004","4.625","6.105","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Smart Grid #004","Smart Grid #005","2.933","1.062","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Smart Grid #005","Smart Grid #001","6.636","8.784","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":661},{"label":"Mar","value":925},{"label":"Abr","value":780},{"label":"Mai","value":872},{"label":"Jun","value":736},{"label":"Jul","value":803},{"label":"Ago","value":671},{"label":"Set","value":845},{"label":"Out","value":939},{"label":"Nov","value":743},{"label":"Dez","value":766}];
const MX = 939;
