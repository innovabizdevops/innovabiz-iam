...
const PAGE = "Locale";
const KPIS = [{"l":"Configurações","v":"2.263","t":"-5.0%","d":"down"},{"l":"Últimas Alterações","v":"7.025","t":"+14.0%","d":"up"},{"l":"Ambientes","v":"5.336","t":"-2.7%","d":"down"},{"l":"Versão Config","v":"8.779","t":"-4.6%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 28099.74","8.030","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 35470.40","7.304","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 4568.25","8.451","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 36253.36","8.701","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 29994.70","2.734","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":689},{"label":"Fev","value":603},{"label":"Mar","value":631},{"label":"Abr","value":591},{"label":"Mai","value":381},{"label":"Jun","value":628},{"label":"Jul","value":627},{"label":"Ago","value":556},{"label":"Set","value":412},{"label":"Out","value":407},{"label":"Nov","value":645},{"label":"Dez","value":525}];
const MX = 689;
