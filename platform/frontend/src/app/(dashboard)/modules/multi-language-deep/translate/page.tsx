...
const ACCENT = "#0d9488";
const MODULE = "Multi-Language Engine Deep";
const PAGE = "Translate";
const KPIS = [{"l":"Tickets Abertos","v":"7.932","t":"-4.9%","d":"down"},{"l":"SLA Cumprido (%)","v":"70.3%","t":"+0.7%","d":"up"},{"l":"MTTR (h)","v":"176h","t":"-0.4%","d":"down"},{"l":"Satisfação (%)","v":"72.9%","t":"+11.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.914","2.646","2.898","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.880","6.500","2.800","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.817","7.051","507","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.892","1.537","4.748","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.210","6.107","8.783","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":465},{"label":"Mar","value":598},{"label":"Abr","value":561},{"label":"Mai","value":305},{"label":"Jun","value":561},{"label":"Jul","value":549},{"label":"Ago","value":247},{"label":"Set","value":489},{"label":"Out","value":408},{"label":"Nov","value":216},{"label":"Dez","value":547}];
const MX = 598;
