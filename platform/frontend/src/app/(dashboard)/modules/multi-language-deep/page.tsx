...
/* ═══ Multi-Language Engine Deep — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "7720", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4971", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€272K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "-3%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1958267220", cells: ["MUL-3220", "Multi-Language Engine Deep Item 1", "1/1/2026", "€17 320"], status: "active" as const },
    { id: "1958270791", cells: ["MUL-6791", "Multi-Language Engine Deep Item 2", "16/8/2026", "€20 891"], status: "pending" as const },
    { id: "1958274362", cells: ["MUL-1362", "Multi-Language Engine Deep Item 3", "3/3/2026", "€24 462"], status: "completed" as const },
    { id: "1958277933", cells: ["MUL-4933", "Multi-Language Engine Deep Item 4", "18/10/2026", "€28 033"], status: "warning" as const },
    { id: "1958281504", cells: ["MUL-8504", "Multi-Language Engine Deep Item 5", "5/5/2026", "€31 604"], status: "active" as const },
];
...
export default function MultilanguageEngineDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Multi-Language Engine Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Multi-Language Engine Deep</p>
                    </div>
                </div>
