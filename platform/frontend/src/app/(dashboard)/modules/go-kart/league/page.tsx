...
const PAGE = "League";
const KPIS = [{"l":"Atletas Registados","v":"2.152","t":"+0.9%","d":"up"},{"l":"Treinos/Semana","v":"4857","t":"+10.8%","d":"up"},{"l":"Competições","v":"2.855","t":"+16.7%","d":"up"},{"l":"Performance Score","v":"76","t":"-1.0%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.174","1.093","1.806","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.492","5.215","5.625","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","554","6.040","2.365","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.866","8.569","1.588","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.542","8.225","9.006","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":848},{"label":"Fev","value":791},{"label":"Mar","value":573},{"label":"Abr","value":621},{"label":"Mai","value":690},{"label":"Jun","value":562},{"label":"Jul","value":738},{"label":"Ago","value":798},{"label":"Set","value":856},{"label":"Out","value":644},{"label":"Nov","value":556},{"label":"Dez","value":830}];
const MX = 856;
