...
const KPIS = [
    { label: "Total Registos", value: "852", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "599", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€345K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "467369852", cells: ["GO-9852", "Go-Kart Racing Item 1", "13/9/2026", "€19 952"], status: "active" as const },
    { id: "467373423", cells: ["GO-4423", "Go-Kart Racing Item 2", "28/4/2026", "€23 523"], status: "pending" as const },
    { id: "467376994", cells: ["GO-7994", "Go-Kart Racing Item 3", "15/11/2026", "€27 094"], status: "completed" as const },
    { id: "467380565", cells: ["GO-2565", "Go-Kart Racing Item 4", "2/6/2026", "€30 665"], status: "warning" as const },
    { id: "467384136", cells: ["GO-6136", "Go-Kart Racing Item 5", "17/1/2026", "€34 236"], status: "active" as const },
];
...
export default function GokartRacingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Go-Kart Racing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Go-Kart Racing</p>
                    </div>
                </div>
