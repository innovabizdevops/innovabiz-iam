...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€1.5M","t":"+1.2%","d":"up"},{"l":"MRR (€)","v":"€35098","t":"+17.8%","d":"up"},{"l":"Churn (%)","v":"79.0%","t":"+3.7%","d":"up"},{"l":"ARPU (€)","v":"€28250","t":"+13.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 17257.96","953","€ 6225.07","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 161.23","3.778","€ 29360.37","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 47728.62","1.199","€ 40193.05","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 3155.86","6.176","€ 45020.91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 17130.73","2.006","€ 19428.71","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":837},{"label":"Fev","value":799},{"label":"Mar","value":687},{"label":"Abr","value":815},{"label":"Mai","value":753},{"label":"Jun","value":740},{"label":"Jul","value":807},{"label":"Ago","value":966},{"label":"Set","value":717},{"label":"Out","value":919},{"label":"Nov","value":711},{"label":"Dez","value":777}];
const MX = 966;
