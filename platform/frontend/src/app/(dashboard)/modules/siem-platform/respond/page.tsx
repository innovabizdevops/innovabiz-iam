...
const PAGE = "Respond";
const KPIS = [{"l":"Formulários Ativos","v":"5.578","t":"+10.8%","d":"up"},{"l":"Submissões/Dia","v":"404","t":"-5.9%","d":"down"},{"l":"Documentos Gerados","v":"2.512","t":"+1.0%","d":"up"},{"l":"Templates","v":"2.497","t":"+5.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","364","2026-03-05","1.851","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.516","2026-01-08","6.650","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.404","2026-01-21","2.870","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.860","2026-02-12","921","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.364","2026-02-23","3.480","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":802},{"label":"Mar","value":771},{"label":"Abr","value":565},{"label":"Mai","value":776},{"label":"Jun","value":611},{"label":"Jul","value":480},{"label":"Ago","value":743},{"label":"Set","value":635},{"label":"Out","value":712},{"label":"Nov","value":796},{"label":"Dez","value":537}];
const MX = 802;
