...
const KPIS = [{"l":"Formulários Ativos","v":"2.956","t":"+4.4%","d":"up"},{"l":"Submissões/Dia","v":"3214","t":"+6.7%","d":"up"},{"l":"Documentos Gerados","v":"5.020","t":"+2.9%","d":"up"},{"l":"Templates","v":"7.895","t":"-1.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.268","2026-01-18","6.779","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.630","2026-02-03","8.634","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.180","2026-02-20","7.921","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.582","2026-02-22","5.223","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.642","2026-03-18","8.262","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":254},{"label":"Fev","value":304},{"label":"Mar","value":363},{"label":"Abr","value":344},{"label":"Mai","value":294},{"label":"Jun","value":370},{"label":"Jul","value":474},{"label":"Ago","value":283},{"label":"Set","value":445},{"label":"Out","value":546},{"label":"Nov","value":436},{"label":"Dez","value":326}];
const MX = 546;
