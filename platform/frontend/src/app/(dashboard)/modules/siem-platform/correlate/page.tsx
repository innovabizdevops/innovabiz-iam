...
const KPIS = [{"l":"Formulários Ativos","v":"1.472","t":"+17.2%","d":"up"},{"l":"Submissões/Dia","v":"423","t":"+10.9%","d":"up"},{"l":"Documentos Gerados","v":"1.761","t":"+4.2%","d":"up"},{"l":"Templates","v":"4.412","t":"+16.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.322","2026-02-15","8.887","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.737","2026-03-13","4.533","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.772","2026-02-02","8.575","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.259","2026-01-16","5.817","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.144","2026-03-08","2.986","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":563},{"label":"Mar","value":590},{"label":"Abr","value":510},{"label":"Mai","value":643},{"label":"Jun","value":700},{"label":"Jul","value":414},{"label":"Ago","value":372},{"label":"Set","value":683},{"label":"Out","value":575},{"label":"Nov","value":613},{"label":"Dez","value":393}];
const MX = 700;
