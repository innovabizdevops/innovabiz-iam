...
const ACCENT = "#7f1d1d";
const MODULE = "SIEM Platform Deep";
const PAGE = "Detect";
const KPIS = [{"l":"Formulários Ativos","v":"7.256","t":"+3.1%","d":"up"},{"l":"Submissões/Dia","v":"4484","t":"+10.8%","d":"up"},{"l":"Documentos Gerados","v":"5.220","t":"+5.9%","d":"up"},{"l":"Templates","v":"6.586","t":"+14.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.479","2026-01-20","8.771","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.929","2026-03-11","4.782","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.403","2026-01-17","8.833","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.937","2026-03-12","6.089","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","150","2026-02-04","2.586","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":640},{"label":"Mar","value":758},{"label":"Abr","value":392},{"label":"Mai","value":600},{"label":"Jun","value":646},{"label":"Jul","value":486},{"label":"Ago","value":626},{"label":"Set","value":578},{"label":"Out","value":453},{"label":"Nov","value":550},{"label":"Dez","value":505}];
const MX = 758;
