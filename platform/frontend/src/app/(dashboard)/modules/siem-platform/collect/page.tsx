...
const PAGE = "Collect";
const KPIS = [{"l":"Formulários Ativos","v":"1.857","t":"-0.8%","d":"down"},{"l":"Submissões/Dia","v":"1694","t":"+13.9%","d":"up"},{"l":"Documentos Gerados","v":"5.251","t":"+14.7%","d":"up"},{"l":"Templates","v":"9.091","t":"+14.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.091","2026-01-13","7.705","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.501","2026-02-13","2.421","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","9.026","2026-01-19","3.483","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.512","2026-02-04","5.379","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","135","2026-02-28","4.498","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":419},{"label":"Mar","value":519},{"label":"Abr","value":690},{"label":"Mai","value":682},{"label":"Jun","value":582},{"label":"Jul","value":410},{"label":"Ago","value":593},{"label":"Set","value":615},{"label":"Out","value":524},{"label":"Nov","value":409},{"label":"Dez","value":537}];
const MX = 690;
