...
/* ═══ SIEM Platform Deep — Dashboard ═══ */

const ACCENT = "#7f1d1d";

const KPIS = [
    { label: "Total Registos", value: "3887", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3291", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€82K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "585935287", cells: ["SIE-9287", "SIEM Platform Deep Item 1", "8/8/2026", "€35 387"], status: "active" as const },
    { id: "585938858", cells: ["SIE-3858", "SIEM Platform Deep Item 2", "23/3/2026", "€38 958"], status: "pending" as const },
    { id: "585942429", cells: ["SIE-7429", "SIEM Platform Deep Item 3", "10/10/2026", "€42 529"], status: "completed" as const },
    { id: "585946000", cells: ["SIE-2000", "SIEM Platform Deep Item 4", "25/5/2026", "€46 100"], status: "warning" as const },
    { id: "585949571", cells: ["SIE-5571", "SIEM Platform Deep Item 5", "12/12/2026", "€49 671"], status: "active" as const },
];
...
export default function SiemPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SIEM Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SIEM Platform Deep</p>
                    </div>
                </div>
