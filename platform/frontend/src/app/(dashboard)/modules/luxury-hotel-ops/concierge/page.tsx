...
const ACCENT = "#059669";
const MODULE = "Luxury Hotel Ops";
const PAGE = "Concierge AI";
const KPIS = [{"l":"Quartos Ocupados","v":"7.883","t":"+13.1%","d":"up"},{"l":"RevPAR (€)","v":"€19988","t":"-0.3%","d":"down"},{"l":"Ocupação (%)","v":"85.5%","t":"+2.9%","d":"up"},{"l":"Guest Satisfaction","v":"5.889","t":"-3.1%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","979","2026-01-10","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.242","2026-03-26","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.792","2026-01-27","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","8.046","2026-03-15","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.966","2026-03-09","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":865},{"label":"Fev","value":561},{"label":"Mar","value":760},{"label":"Abr","value":809},{"label":"Mai","value":764},{"label":"Jun","value":798},{"label":"Jul","value":752},{"label":"Ago","value":681},{"label":"Set","value":505},{"label":"Out","value":748},{"label":"Nov","value":743},{"label":"Dez","value":835}];
const MX = 865;
