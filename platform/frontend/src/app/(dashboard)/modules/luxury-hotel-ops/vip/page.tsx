...
const PAGE = "VIP Protocol";
const KPIS = [{"l":"Integrações Ativas","v":"3.608","t":"-2.6%","d":"down"},{"l":"Chamadas/Hora","v":"1341","t":"+8.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"70.5%","t":"+1.4%","d":"up"},{"l":"Latência Média (ms)","v":"37ms","t":"+13.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.783","7.165","93.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.652","6.184","79.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.936","4.010","74.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.505","6.724","88.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.559","4.754","88.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":344},{"label":"Fev","value":361},{"label":"Mar","value":490},{"label":"Abr","value":688},{"label":"Mai","value":673},{"label":"Jun","value":695},{"label":"Jul","value":339},{"label":"Ago","value":663},{"label":"Set","value":531},{"label":"Out","value":552},{"label":"Nov","value":504},{"label":"Dez","value":598}];
const MX = 695;
