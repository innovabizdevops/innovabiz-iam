...
const PAGE = "Butler Mgmt";
const KPIS = [{"l":"Quartos Ocupados","v":"4.230","t":"+3.8%","d":"up"},{"l":"RevPAR (€)","v":"€45666","t":"+17.7%","d":"up"},{"l":"Ocupação (%)","v":"89.6%","t":"+13.1%","d":"up"},{"l":"Guest Satisfaction","v":"7.113","t":"-2.5%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.388","2026-02-04","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.542","2026-03-12","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.673","2026-01-15","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.101","2026-01-21","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.363","2026-01-09","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":485},{"label":"Fev","value":518},{"label":"Mar","value":580},{"label":"Abr","value":579},{"label":"Mai","value":569},{"label":"Jun","value":661},{"label":"Jul","value":820},{"label":"Ago","value":630},{"label":"Set","value":700},{"label":"Out","value":780},{"label":"Nov","value":521},{"label":"Dez","value":799}];
const MX = 820;
