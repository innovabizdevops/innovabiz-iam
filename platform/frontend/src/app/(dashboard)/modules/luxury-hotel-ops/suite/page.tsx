...
const PAGE = "Suite Customize";
const KPIS = [{"l":"Configurações","v":"2.186","t":"+17.9%","d":"up"},{"l":"Últimas Alterações","v":"4.356","t":"+7.9%","d":"up"},{"l":"Ambientes","v":"7.592","t":"+14.3%","d":"up"},{"l":"Versão Config","v":"1.918","t":"+17.2%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 1946.19","915","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 9584.01","2.124","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 38852.39","8.884","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 1919.28","4.262","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 49587.31","3.480","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":620},{"label":"Mar","value":234},{"label":"Abr","value":545},{"label":"Mai","value":372},{"label":"Jun","value":615},{"label":"Jul","value":326},{"label":"Ago","value":580},{"label":"Set","value":341},{"label":"Out","value":355},{"label":"Nov","value":370},{"label":"Dez","value":324}];
const MX = 620;
