...
const PAGE = "Penalty Calculator";
const KPIS = [{"l":"Tickets Abertos","v":"4.313","t":"+4.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"74.9%","t":"+13.0%","d":"up"},{"l":"MTTR (h)","v":"95h","t":"+11.9%","d":"up"},{"l":"Satisfação (%)","v":"89.3%","t":"+3.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.410","5.297","6.194","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.460","6.813","5.720","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.785","1.574","3.556","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.009","1.455","4.032","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.695","8.558","1.718","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":566},{"label":"Mar","value":541},{"label":"Abr","value":595},{"label":"Mai","value":684},{"label":"Jun","value":431},{"label":"Jul","value":435},{"label":"Ago","value":672},{"label":"Set","value":454},{"label":"Out","value":571},{"label":"Nov","value":535},{"label":"Dez","value":541}];
const MX = 684;
