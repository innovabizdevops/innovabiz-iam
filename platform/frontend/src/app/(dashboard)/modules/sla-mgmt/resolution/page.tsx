...
const ACCENT = "#b45309";
const MODULE = "SLA Management";
const PAGE = "Resolution Tracking";
const KPIS = [{"l":"Tickets Abertos","v":"5.289","t":"+15.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"70.7%","t":"+14.6%","d":"up"},{"l":"MTTR (h)","v":"29h","t":"+9.9%","d":"up"},{"l":"Satisfação (%)","v":"75.9%","t":"+7.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","416","3.933","2.503","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.858","7.818","7.993","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.670","4.425","341","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.901","4.140","3.771","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.352","8.716","8.360","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1008},{"label":"Fev","value":980},{"label":"Mar","value":926},{"label":"Abr","value":938},{"label":"Mai","value":772},{"label":"Jun","value":1010},{"label":"Jul","value":913},{"label":"Ago","value":1045},{"label":"Set","value":947},{"label":"Out","value":836},{"label":"Nov","value":1060},{"label":"Dez","value":734}];
const MX = 1060;
