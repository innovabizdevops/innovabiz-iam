...
const PAGE = "Customer SLAs";
const KPIS = [{"l":"Tickets Abertos","v":"730","t":"+10.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"66.5%","t":"+10.7%","d":"up"},{"l":"MTTR (h)","v":"37h","t":"+3.5%","d":"up"},{"l":"Satisfação (%)","v":"85.9%","t":"+11.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.694","5.963","2.124","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.738","9.033","1.900","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.385","7.118","1.654","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.957","6.204","5.743","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.268","6.724","364","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":634},{"label":"Mar","value":788},{"label":"Abr","value":814},{"label":"Mai","value":469},{"label":"Jun","value":711},{"label":"Jul","value":763},{"label":"Ago","value":837},{"label":"Set","value":748},{"label":"Out","value":646},{"label":"Nov","value":765},{"label":"Dez","value":514}];
const MX = 837;
