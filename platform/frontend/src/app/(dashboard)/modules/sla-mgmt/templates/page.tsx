...
const PAGE = "SLA Templates";
const KPIS = [{"l":"Tickets Abertos","v":"149","t":"+7.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"89.7%","t":"+13.6%","d":"up"},{"l":"MTTR (h)","v":"79h","t":"+2.3%","d":"up"},{"l":"Satisfação (%)","v":"86.3%","t":"+11.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.821","6.026","4.640","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.889","2.743","1.531","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.207","2.737","2.153","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.600","407","4.113","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","217","1.766","8.199","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":619},{"label":"Mar","value":552},{"label":"Abr","value":790},{"label":"Mai","value":450},{"label":"Jun","value":633},{"label":"Jul","value":767},{"label":"Ago","value":527},{"label":"Set","value":619},{"label":"Out","value":566},{"label":"Nov","value":609},{"label":"Dez","value":728}];
const MX = 790;
