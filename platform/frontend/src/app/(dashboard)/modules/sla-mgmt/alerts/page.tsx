...
const PAGE = "Breach Alerts";
const KPIS = [{"l":"Tickets Abertos","v":"1.302","t":"+3.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"86.2%","t":"+1.6%","d":"up"},{"l":"MTTR (h)","v":"91h","t":"-0.3%","d":"down"},{"l":"Satisfação (%)","v":"81.1%","t":"-5.3%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.981","6.983","277","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.675","4.416","8.482","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.054","2.587","3.937","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","827","7.087","4.894","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.528","1.496","470","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":980},{"label":"Fev","value":856},{"label":"Mar","value":972},{"label":"Abr","value":900},{"label":"Mai","value":922},{"label":"Jun","value":837},{"label":"Jul","value":933},{"label":"Ago","value":845},{"label":"Set","value":797},{"label":"Out","value":896},{"label":"Nov","value":731},{"label":"Dez","value":945}];
const MX = 980;
