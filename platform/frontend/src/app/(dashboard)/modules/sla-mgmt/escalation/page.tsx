...
const PAGE = "Auto-Escalation";
const KPIS = [{"l":"Tickets Abertos","v":"5.609","t":"+16.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"72.3%","t":"+7.5%","d":"up"},{"l":"MTTR (h)","v":"158h","t":"-4.5%","d":"down"},{"l":"Satisfação (%)","v":"81.4%","t":"+5.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.804","8.199","7.596","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.023","3.479","393","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.363","4.514","3.263","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.669","482","4.537","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.477","2.793","490","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":874},{"label":"Mar","value":879},{"label":"Abr","value":779},{"label":"Mai","value":859},{"label":"Jun","value":657},{"label":"Jul","value":743},{"label":"Ago","value":962},{"label":"Set","value":975},{"label":"Out","value":753},{"label":"Nov","value":910},{"label":"Dez","value":771}];
const MX = 975;
