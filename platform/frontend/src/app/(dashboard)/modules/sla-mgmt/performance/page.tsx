...
const PAGE = "Performance Report";
const KPIS = [{"l":"Tickets Abertos","v":"7.744","t":"-3.1%","d":"down"},{"l":"SLA Cumprido (%)","v":"94.9%","t":"+3.2%","d":"up"},{"l":"MTTR (h)","v":"48h","t":"+16.0%","d":"up"},{"l":"Satisfação (%)","v":"89.8%","t":"+11.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.444","6.620","3.664","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.964","5.036","8.710","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.986","8.099","6.346","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.252","6.586","5.720","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","141","8.835","8.186","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":681},{"label":"Mar","value":599},{"label":"Abr","value":787},{"label":"Mai","value":766},{"label":"Jun","value":696},{"label":"Jul","value":649},{"label":"Ago","value":625},{"label":"Set","value":917},{"label":"Out","value":829},{"label":"Nov","value":729},{"label":"Dez","value":728}];
const MX = 917;
