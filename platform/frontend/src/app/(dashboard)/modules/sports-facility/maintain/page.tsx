...
const KPIS = [{"l":"Atletas Registados","v":"2.619","t":"+8.1%","d":"up"},{"l":"Treinos/Semana","v":"155","t":"+12.2%","d":"up"},{"l":"Competições","v":"1.910","t":"+6.4%","d":"up"},{"l":"Performance Score","v":"66","t":"-1.7%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.886","1.080","3.591","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","855","8.838","2.877","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.530","6.329","848","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.666","213","1.124","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.285","5.858","9.090","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":596},{"label":"Mar","value":599},{"label":"Abr","value":742},{"label":"Mai","value":484},{"label":"Jun","value":839},{"label":"Jul","value":602},{"label":"Ago","value":810},{"label":"Set","value":600},{"label":"Out","value":704},{"label":"Nov","value":657},{"label":"Dez","value":613}];
const MX = 839;
