...
const PAGE = "Turf";
const KPIS = [{"l":"Atletas Registados","v":"8.973","t":"+12.0%","d":"up"},{"l":"Treinos/Semana","v":"2759","t":"+7.4%","d":"up"},{"l":"Competições","v":"751","t":"+17.5%","d":"up"},{"l":"Performance Score","v":"86","t":"+8.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.590","7.218","149","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.551","1.489","5.196","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.228","3.627","5.801","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.129","2.592","6.940","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.701","4.121","6.108","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":888},{"label":"Mar","value":771},{"label":"Abr","value":956},{"label":"Mai","value":857},{"label":"Jun","value":835},{"label":"Jul","value":927},{"label":"Ago","value":931},{"label":"Set","value":832},{"label":"Out","value":770},{"label":"Nov","value":576},{"label":"Dez","value":632}];
const MX = 956;
