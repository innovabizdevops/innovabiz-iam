...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€45.4M","t":"+16.5%","d":"up"},{"l":"MRR (€)","v":"€94353","t":"+1.9%","d":"up"},{"l":"Churn (%)","v":"67.5%","t":"+15.6%","d":"up"},{"l":"ARPU (€)","v":"€31389","t":"+7.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 6847.61","2.214","€ 12406.11","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 28196.54","6.724","€ 48258.93","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 27997.23","4.542","€ 10651.92","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 18196.55","7.961","€ 20737.80","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 15820.84","7.751","€ 22493.67","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":658},{"label":"Mar","value":626},{"label":"Abr","value":738},{"label":"Mai","value":829},{"label":"Jun","value":648},{"label":"Jul","value":940},{"label":"Ago","value":594},{"label":"Set","value":889},{"label":"Out","value":915},{"label":"Nov","value":911},{"label":"Dez","value":782}];
const MX = 940;
