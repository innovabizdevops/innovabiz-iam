...
const KPIS = [{"l":"Atletas Registados","v":"263","t":"-2.8%","d":"down"},{"l":"Treinos/Semana","v":"4769","t":"+14.1%","d":"up"},{"l":"Competições","v":"384","t":"+9.3%","d":"up"},{"l":"Performance Score","v":"58","t":"+7.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.585","914","2.383","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.806","7.551","447","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.569","8.228","2.274","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.148","1.306","4.933","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.391","349","236","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":868},{"label":"Fev","value":732},{"label":"Mar","value":835},{"label":"Abr","value":706},{"label":"Mai","value":645},{"label":"Jun","value":651},{"label":"Jul","value":519},{"label":"Ago","value":646},{"label":"Set","value":667},{"label":"Out","value":649},{"label":"Nov","value":908},{"label":"Dez","value":582}];
const MX = 908;
