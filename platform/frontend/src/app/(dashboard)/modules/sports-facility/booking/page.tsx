...
const ACCENT = "#6366f1";
const MODULE = "Sports Facility";
const PAGE = "Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"8.881","t":"+2.7%","d":"up"},{"l":"RevPAR (€)","v":"€84910","t":"+5.5%","d":"up"},{"l":"Ocupação (%)","v":"68.5%","t":"+10.2%","d":"up"},{"l":"Guest Satisfaction","v":"2.834","t":"+8.0%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.990","2026-02-10","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.585","2026-01-07","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","843","2026-03-16","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.008","2026-03-05","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.470","2026-03-01","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":366},{"label":"Fev","value":715},{"label":"Mar","value":703},{"label":"Abr","value":503},{"label":"Mai","value":500},{"label":"Jun","value":432},{"label":"Jul","value":434},{"label":"Ago","value":531},{"label":"Set","value":375},{"label":"Out","value":454},{"label":"Nov","value":521},{"label":"Dez","value":427}];
const MX = 715;
