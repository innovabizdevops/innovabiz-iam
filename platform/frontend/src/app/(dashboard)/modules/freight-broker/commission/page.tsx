...
const KPIS = [{"l":"Vendas YTD (€)","v":"€67548","t":"-2.3%","d":"down"},{"l":"Pipeline (€)","v":"€18150","t":"-5.8%","d":"down"},{"l":"Atingimento Quota (%)","v":"68.4%","t":"+4.8%","d":"up"},{"l":"Win Rate (%)","v":"88.5%","t":"+17.3%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 42976.06","€ 28791.53","€ 28372.60","78.5%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 5686.38","€ 15554.69","€ 42885.41","97.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 19864.03","€ 31720.38","€ 10191.27","96.4%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 19955.49","€ 8419.01","€ 26703.85","74.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 38493.68","€ 47117.25","€ 40568.91","92.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":583},{"label":"Mar","value":735},{"label":"Abr","value":903},{"label":"Mai","value":869},{"label":"Jun","value":849},{"label":"Jul","value":697},{"label":"Ago","value":719},{"label":"Set","value":869},{"label":"Out","value":741},{"label":"Nov","value":724},{"label":"Dez","value":889}];
const MX = 903;
