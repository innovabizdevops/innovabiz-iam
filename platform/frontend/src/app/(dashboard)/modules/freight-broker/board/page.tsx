...
const PAGE = "Load Board";
const KPIS = [{"l":"Teams Ativos","v":"6.920","t":"+0.5%","d":"up"},{"l":"Reuniões/Semana","v":"3401","t":"+14.0%","d":"up"},{"l":"Mensagens/Dia","v":"495","t":"-6.0%","d":"down"},{"l":"Ficheiros Partilhados","v":"8.399","t":"+-0.0%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.479","4480","8.618","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.522","1172","6.805","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.656","1511","1.052","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","7.492","1684","2.772","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","545","2028","4.457","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":545},{"label":"Mar","value":516},{"label":"Abr","value":571},{"label":"Mai","value":638},{"label":"Jun","value":609},{"label":"Jul","value":439},{"label":"Ago","value":614},{"label":"Set","value":582},{"label":"Out","value":327},{"label":"Nov","value":576},{"label":"Dez","value":400}];
const MX = 638;
