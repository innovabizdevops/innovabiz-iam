...
const KPIS = [{"l":"Total Freight Broker","v":"363","t":"+6.8%","d":"up"},{"l":"Settlement Ativos","v":"2.716","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"66.9%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"87","t":"+15.7%","d":"up"}];
const COLS = ["ID","Settlement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Freight Broker #001","Freight Broker #002","555","2.794","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Freight Broker #002","Freight Broker #003","6.763","3.416","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Freight Broker #003","Freight Broker #004","7.542","177","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Freight Broker #004","Freight Broker #005","8.717","7.979","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Freight Broker #005","Freight Broker #001","4.113","5.167","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":376},{"label":"Fev","value":506},{"label":"Mar","value":384},{"label":"Abr","value":496},{"label":"Mai","value":575},{"label":"Jun","value":478},{"label":"Jul","value":468},{"label":"Ago","value":332},{"label":"Set","value":322},{"label":"Out","value":230},{"label":"Nov","value":573},{"label":"Dez","value":454}];
const MX = 575;
