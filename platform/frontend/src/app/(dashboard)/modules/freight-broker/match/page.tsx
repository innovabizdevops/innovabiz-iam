...
const ACCENT = "#2d4a6f";
const MODULE = "Freight Brokerage";
const PAGE = "Carrier Match";
const KPIS = [{"l":"ARR (€M)","v":"€42.1M","t":"-0.1%","d":"down"},{"l":"MRR (€)","v":"€51813","t":"+12.7%","d":"up"},{"l":"Churn (%)","v":"79.6%","t":"+9.8%","d":"up"},{"l":"ARPU (€)","v":"€87922","t":"+9.4%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 29391.77","7.990","€ 1145.41","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 23506.97","743","€ 40318.06","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 20878.12","4.816","€ 45078.56","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 47303.11","4.665","€ 24882.91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 35968.03","5.339","€ 19296.65","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":858},{"label":"Fev","value":760},{"label":"Mar","value":775},{"label":"Abr","value":892},{"label":"Mai","value":915},{"label":"Jun","value":784},{"label":"Jul","value":975},{"label":"Ago","value":717},{"label":"Set","value":939},{"label":"Out","value":907},{"label":"Nov","value":767},{"label":"Dez","value":994}];
const MX = 994;
