...
const PAGE = "Quote Engine";
const KPIS = [{"l":"Total Freight Broker","v":"4.609","t":"+9.7%","d":"up"},{"l":"Quote Engine Ativos","v":"278","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"71.8%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"78","t":"-0.7%","d":"down"}];
const COLS = ["ID","Quote Engine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Freight Broker #001","Freight Broker #002","4.599","5.441","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Freight Broker #002","Freight Broker #003","4.863","7.149","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Freight Broker #003","Freight Broker #004","538","1.684","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Freight Broker #004","Freight Broker #005","3.337","5.700","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Freight Broker #005","Freight Broker #001","2.932","6.154","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":633},{"label":"Mar","value":557},{"label":"Abr","value":634},{"label":"Mai","value":616},{"label":"Jun","value":569},{"label":"Jul","value":604},{"label":"Ago","value":600},{"label":"Set","value":409},{"label":"Out","value":514},{"label":"Nov","value":428},{"label":"Dez","value":505}];
const MX = 634;
