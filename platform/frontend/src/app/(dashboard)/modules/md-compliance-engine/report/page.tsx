...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.199","t":"+6.5%","d":"up"},{"l":"NC Abertas","v":"4.340","t":"-4.1%","d":"down"},{"l":"Conformidade (%)","v":"73.4%","t":"-1.9%","d":"down"},{"l":"CAPAs Pendentes","v":"3.597","t":"+4.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","677","73.3%","7.711","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.815","92.8%","8.659","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.586","88.0%","6.127","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.330","81.1%","7.456","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.303","86.1%","8.306","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":389},{"label":"Fev","value":337},{"label":"Mar","value":523},{"label":"Abr","value":279},{"label":"Mai","value":545},{"label":"Jun","value":510},{"label":"Jul","value":533},{"label":"Ago","value":296},{"label":"Set","value":433},{"label":"Out","value":261},{"label":"Nov","value":359},{"label":"Dez","value":561}];
const MX = 561;
