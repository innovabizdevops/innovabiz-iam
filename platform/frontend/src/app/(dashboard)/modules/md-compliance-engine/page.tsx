...
/* ═══ MD: Multi-Compliance Engine — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "3975", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "266", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€146K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "752661275", cells: ["MD-1275", "MD: Multi-Compliance Engine Item 1", "24/12/2026", "€11 375"], status: "active" as const },
    { id: "752664846", cells: ["MD-4846", "MD: Multi-Compliance Engine Item 2", "11/7/2026", "€14 946"], status: "pending" as const },
    { id: "752668417", cells: ["MD-8417", "MD: Multi-Compliance Engine Item 3", "26/2/2026", "€18 517"], status: "completed" as const },
    { id: "752671988", cells: ["MD-2988", "MD: Multi-Compliance Engine Item 4", "13/9/2026", "€22 088"], status: "warning" as const },
    { id: "752675559", cells: ["MD-6559", "MD: Multi-Compliance Engine Item 5", "28/4/2026", "€25 659"], status: "active" as const },
];
...
export default function MdMulticomplianceEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Compliance Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Compliance Engine</p>
                    </div>
                </div>
