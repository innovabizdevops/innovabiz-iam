...
const PAGE = "Enforce";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.407","t":"-2.0%","d":"down"},{"l":"NC Abertas","v":"5.286","t":"+1.3%","d":"up"},{"l":"Conformidade (%)","v":"66.7%","t":"-2.6%","d":"down"},{"l":"CAPAs Pendentes","v":"8.927","t":"+8.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.848","83.1%","6.586","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.794","73.7%","5.186","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.052","86.7%","2.606","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.087","81.4%","844","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.295","99.3%","1.456","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":427},{"label":"Fev","value":594},{"label":"Mar","value":390},{"label":"Abr","value":365},{"label":"Mai","value":652},{"label":"Jun","value":479},{"label":"Jul","value":479},{"label":"Ago","value":563},{"label":"Set","value":508},{"label":"Out","value":540},{"label":"Nov","value":488},{"label":"Dez","value":630}];
const MX = 652;
