...
const KPIS = [{"l":"Auditorias Realizadas","v":"388","t":"-3.8%","d":"down"},{"l":"NC Abertas","v":"108","t":"-4.1%","d":"down"},{"l":"Conformidade (%)","v":"68.2%","t":"+11.0%","d":"up"},{"l":"CAPAs Pendentes","v":"6.706","t":"+14.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.522","80.7%","6.178","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.934","87.4%","5.262","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.890","96.5%","2.010","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.493","81.5%","353","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.530","94.8%","1.613","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":665},{"label":"Mar","value":576},{"label":"Abr","value":606},{"label":"Mai","value":816},{"label":"Jun","value":819},{"label":"Jul","value":719},{"label":"Ago","value":826},{"label":"Set","value":667},{"label":"Out","value":643},{"label":"Nov","value":737},{"label":"Dez","value":646}];
const MX = 826;
