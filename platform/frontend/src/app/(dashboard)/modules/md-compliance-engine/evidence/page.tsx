...
const ACCENT = "#7c2d12";
const MODULE = "MD: Multi-Compliance Engine";
const PAGE = "Evidence";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.493","t":"-3.9%","d":"down"},{"l":"NC Abertas","v":"1.985","t":"+17.3%","d":"up"},{"l":"Conformidade (%)","v":"86.5%","t":"-4.9%","d":"down"},{"l":"CAPAs Pendentes","v":"8.527","t":"-3.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.326","94.5%","7.120","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.380","87.0%","1.564","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.290","87.1%","7.060","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.916","81.2%","6.643","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.083","82.7%","227","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":936},{"label":"Mar","value":951},{"label":"Abr","value":888},{"label":"Mai","value":807},{"label":"Jun","value":1068},{"label":"Jul","value":853},{"label":"Ago","value":769},{"label":"Set","value":959},{"label":"Out","value":755},{"label":"Nov","value":1045},{"label":"Dez","value":1007}];
const MX = 1068;
