...
const ACCENT = "#0284c7";
const MODULE = "Aircraft MRO";
const PAGE = "Work Package";
const KPIS = [{"l":"Total Aircraft Mro","v":"5.847","t":"+13.1%","d":"up"},{"l":"Work Package Ativos","v":"1.708","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"78.3%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"84","t":"+0.9%","d":"up"}];
const COLS = ["ID","Work Package","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aircraft Mro #001","Aircraft Mro #002","1.225","6.524","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Aircraft Mro #002","Aircraft Mro #003","8.990","3.963","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Aircraft Mro #003","Aircraft Mro #004","3.986","4.714","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Aircraft Mro #004","Aircraft Mro #005","7.600","4.869","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aircraft Mro #005","Aircraft Mro #001","1.329","5.944","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":658},{"label":"Mar","value":698},{"label":"Abr","value":732},{"label":"Mai","value":572},{"label":"Jun","value":730},{"label":"Jul","value":743},{"label":"Ago","value":735},{"label":"Set","value":510},{"label":"Out","value":518},{"label":"Nov","value":644},{"label":"Dez","value":668}];
const MX = 743;
