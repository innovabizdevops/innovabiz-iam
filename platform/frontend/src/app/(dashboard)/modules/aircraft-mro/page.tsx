...
export default function AircraftMroPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Aircraft Mro</h1><p className="text-sm text-muted-foreground">Aircraft Mro • iBOS Enterprise</p></div>
