...
const PAGE = "Engine LLP";
const KPIS = [{"l":"Total Aircraft Mro","v":"7.128","t":"-5.0%","d":"down"},{"l":"Engine LLP Ativos","v":"2.005","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"65.7%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"67","t":"+0.1%","d":"up"}];
const COLS = ["ID","Engine LLP","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aircraft Mro #001","Aircraft Mro #002","2.512","1.100","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Aircraft Mro #002","Aircraft Mro #003","3.011","7.590","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Aircraft Mro #003","Aircraft Mro #004","8.857","4.538","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Aircraft Mro #004","Aircraft Mro #005","1.803","2.393","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aircraft Mro #005","Aircraft Mro #001","1.065","5.734","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":429},{"label":"Fev","value":366},{"label":"Mar","value":715},{"label":"Abr","value":469},{"label":"Mai","value":718},{"label":"Jun","value":361},{"label":"Jul","value":627},{"label":"Ago","value":350},{"label":"Set","value":661},{"label":"Out","value":698},{"label":"Nov","value":494},{"label":"Dez","value":332}];
const MX = 718;
