...
const PAGE = "AD/SB Tracking";
const KPIS = [{"l":"Total Aircraft Mro","v":"870","t":"+4.7%","d":"up"},{"l":"AD/SB Tracking Ativos","v":"5.092","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"94.5%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"89","t":"+13.1%","d":"up"}];
const COLS = ["ID","AD/SB Tracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aircraft Mro #001","Aircraft Mro #002","7.772","3.937","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Aircraft Mro #002","Aircraft Mro #003","431","6.105","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Aircraft Mro #003","Aircraft Mro #004","4.979","6.109","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Aircraft Mro #004","Aircraft Mro #005","4.827","4.677","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aircraft Mro #005","Aircraft Mro #001","4.819","479","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":397},{"label":"Mar","value":710},{"label":"Abr","value":604},{"label":"Mai","value":512},{"label":"Jun","value":663},{"label":"Jul","value":367},{"label":"Ago","value":626},{"label":"Set","value":592},{"label":"Out","value":573},{"label":"Nov","value":487},{"label":"Dez","value":368}];
const MX = 710;
