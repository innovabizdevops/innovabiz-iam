...
const PAGE = "Task Cards";
const KPIS = [{"l":"Total Aircraft Mro","v":"3.822","t":"+12.0%","d":"up"},{"l":"Task Cards Ativos","v":"6.064","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"84.4%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"88","t":"+1.8%","d":"up"}];
const COLS = ["ID","Task Cards","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aircraft Mro #001","Aircraft Mro #002","7.615","4.655","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Aircraft Mro #002","Aircraft Mro #003","4.331","4.238","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Aircraft Mro #003","Aircraft Mro #004","5.955","4.672","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Aircraft Mro #004","Aircraft Mro #005","8.886","8.770","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aircraft Mro #005","Aircraft Mro #001","7.171","1.756","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":342},{"label":"Mar","value":482},{"label":"Abr","value":621},{"label":"Mai","value":499},{"label":"Jun","value":387},{"label":"Jul","value":589},{"label":"Ago","value":519},{"label":"Set","value":507},{"label":"Out","value":472},{"label":"Nov","value":577},{"label":"Dez","value":339}];
const MX = 621;
