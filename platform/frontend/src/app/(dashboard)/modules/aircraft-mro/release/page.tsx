...
const PAGE = "Release CRS";
const KPIS = [{"l":"Total Aircraft Mro","v":"6.579","t":"+3.6%","d":"up"},{"l":"Release CRS Ativos","v":"7.296","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"83.5%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"86","t":"+8.2%","d":"up"}];
const COLS = ["ID","Release CRS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aircraft Mro #001","Aircraft Mro #002","7.710","8.214","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Aircraft Mro #002","Aircraft Mro #003","8.614","7.106","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Aircraft Mro #003","Aircraft Mro #004","5.652","5.302","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Aircraft Mro #004","Aircraft Mro #005","4.139","1.892","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aircraft Mro #005","Aircraft Mro #001","8.001","2.441","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":736},{"label":"Mar","value":614},{"label":"Abr","value":744},{"label":"Mai","value":649},{"label":"Jun","value":701},{"label":"Jul","value":866},{"label":"Ago","value":580},{"label":"Set","value":825},{"label":"Out","value":665},{"label":"Nov","value":568},{"label":"Dez","value":678}];
const MX = 866;
