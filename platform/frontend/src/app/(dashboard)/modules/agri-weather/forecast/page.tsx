...
const PAGE = "Forecast";
const KPIS = [{"l":"Total Agri Weather","v":"8.512","t":"+14.2%","d":"up"},{"l":"Forecast Ativos","v":"8.146","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"81.3%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"79","t":"+3.8%","d":"up"}];
const COLS = ["ID","Forecast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Weather #001","Agri Weather #002","2.441","8.460","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Weather #002","Agri Weather #003","8.421","4.322","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Weather #003","Agri Weather #004","8.954","8.571","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Weather #004","Agri Weather #005","2.729","1.169","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Weather #005","Agri Weather #001","2.252","4.898","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":472},{"label":"Mar","value":512},{"label":"Abr","value":673},{"label":"Mai","value":729},{"label":"Jun","value":646},{"label":"Jul","value":720},{"label":"Ago","value":838},{"label":"Set","value":699},{"label":"Out","value":664},{"label":"Nov","value":680},{"label":"Dez","value":534}];
const MX = 838;
