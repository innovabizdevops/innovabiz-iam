...
const KPIS = [
    { label: "Total Registos", value: "7611", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3876", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€276K", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1627557611", cells: ["AGR-7611", "Weather Intelligence Item 1", "16/12/2026", "€7711"], status: "active" as const },
    { id: "1627561182", cells: ["AGR-2182", "Weather Intelligence Item 2", "3/7/2026", "€11 282"], status: "pending" as const },
    { id: "1627564753", cells: ["AGR-5753", "Weather Intelligence Item 3", "18/2/2026", "€14 853"], status: "completed" as const },
    { id: "1627568324", cells: ["AGR-9324", "Weather Intelligence Item 4", "5/9/2026", "€18 424"], status: "warning" as const },
    { id: "1627571895", cells: ["AGR-3895", "Weather Intelligence Item 5", "20/4/2026", "€21 995"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Weather Intelligence</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Weather Intelligence</p>
                    </div>
                </div>
