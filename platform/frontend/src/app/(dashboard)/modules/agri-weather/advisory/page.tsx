...
const PAGE = "Advisory";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.069","t":"+4.7%","d":"up"},{"l":"NC Abertas","v":"2.366","t":"+11.6%","d":"up"},{"l":"Conformidade (%)","v":"76.1%","t":"-5.5%","d":"down"},{"l":"CAPAs Pendentes","v":"4.999","t":"-5.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.397","81.3%","7.443","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.170","71.8%","7.238","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.418","76.3%","6.365","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.485","94.1%","7.064","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.263","71.5%","4.439","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":304},{"label":"Mar","value":596},{"label":"Abr","value":392},{"label":"Mai","value":519},{"label":"Jun","value":429},{"label":"Jul","value":631},{"label":"Ago","value":526},{"label":"Set","value":285},{"label":"Out","value":454},{"label":"Nov","value":527},{"label":"Dez","value":583}];
const MX = 631;
