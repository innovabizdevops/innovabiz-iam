...
const ACCENT = "#166534";
const MODULE = "Weather Intelligence";
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"7.119","t":"-4.3%","d":"down"},{"l":"Taxa Entrega (%)","v":"80.9%","t":"+13.8%","d":"up"},{"l":"Taxa Abertura (%)","v":"72.0%","t":"+14.3%","d":"up"},{"l":"Escalações","v":"5.297","t":"-4.1%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","1.613","78.8%","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","5.425","92.0%","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","3.861","81.7%","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","1.448","79.4%","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","1.769","85.4%","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":424},{"label":"Mar","value":416},{"label":"Abr","value":460},{"label":"Mai","value":513},{"label":"Jun","value":669},{"label":"Jul","value":351},{"label":"Ago","value":366},{"label":"Set","value":446},{"label":"Out","value":701},{"label":"Nov","value":364},{"label":"Dez","value":363}];
const MX = 701;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#166534'}}>RTM</span></h1>
                </div>
