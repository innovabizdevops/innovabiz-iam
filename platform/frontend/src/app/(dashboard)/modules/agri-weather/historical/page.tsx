...
const KPIS = [{"l":"Total Agri Weather","v":"1.213","t":"+6.4%","d":"up"},{"l":"Historical Ativos","v":"6.443","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"79.7%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"80","t":"+4.2%","d":"up"}];
const COLS = ["ID","Historical","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Weather #001","Agri Weather #002","2.611","7.001","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Weather #002","Agri Weather #003","2.712","935","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Weather #003","Agri Weather #004","4.121","638","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Weather #004","Agri Weather #005","4.322","3.138","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Weather #005","Agri Weather #001","3.602","3.202","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":927},{"label":"Fev","value":1087},{"label":"Mar","value":769},{"label":"Abr","value":909},{"label":"Mai","value":817},{"label":"Jun","value":975},{"label":"Jul","value":886},{"label":"Ago","value":859},{"label":"Set","value":1050},{"label":"Out","value":885},{"label":"Nov","value":833},{"label":"Dez","value":884}];
const MX = 1087;
