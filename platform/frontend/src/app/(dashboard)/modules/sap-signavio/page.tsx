...
/* ═══ Process Intelligence (Signavio) — Dashboard ═══ */

const ACCENT = "#0070f3";

const KPIS = [
    { label: "Total Registos", value: "2274", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4784", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€444K", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "649065974", cells: ["SAP-4974", "Process Intelligence (Signavio) Item 1", "19/3/2026", "€16 074"], status: "active" as const },
    { id: "649069545", cells: ["SAP-8545", "Process Intelligence (Signavio) Item 2", "6/10/2026", "€19 645"], status: "pending" as const },
    { id: "649073116", cells: ["SAP-3116", "Process Intelligence (Signavio) Item 3", "21/5/2026", "€23 216"], status: "completed" as const },
    { id: "649076687", cells: ["SAP-6687", "Process Intelligence (Signavio) Item 4", "8/12/2026", "€26 787"], status: "warning" as const },
    { id: "649080258", cells: ["SAP-1258", "Process Intelligence (Signavio) Item 5", "23/7/2026", "€30 358"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 74 }, { label: "Fev", value: 83 }, { label: "Mar", value: 92 }, { label: "Abr", value: 21 }, { label: "Mai", value: 30 }, { label: "Jun", value: 39 }];
...
export default function ProcessIntelligenceSignavioPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Process Intelligence (Signavio)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Process Intelligence (Signavio)</p>
                    </div>
                </div>
