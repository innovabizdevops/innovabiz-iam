...
const ACCENT = "#0070f3";
const MODULE = "Process Intelligence (Signavio)";
const PAGE = "Mine";
const KPIS = [{"l":"Total Sap Signavio","v":"3.727","t":"+12.3%","d":"up"},{"l":"Mine Ativos","v":"1.322","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"76.7%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"75","t":"+10.2%","d":"up"}];
const COLS = ["ID","Mine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sap Signavio #001","Sap Signavio #002","4.617","4.473","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Sap Signavio #002","Sap Signavio #003","580","2.806","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Sap Signavio #003","Sap Signavio #004","5.325","4.141","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Sap Signavio #004","Sap Signavio #005","7.773","1.628","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sap Signavio #005","Sap Signavio #001","7.237","6.369","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":361},{"label":"Fev","value":369},{"label":"Mar","value":548},{"label":"Abr","value":647},{"label":"Mai","value":640},{"label":"Jun","value":403},{"label":"Jul","value":357},{"label":"Ago","value":678},{"label":"Set","value":686},{"label":"Out","value":485},{"label":"Nov","value":399},{"label":"Dez","value":630}];
const MX = 686;
