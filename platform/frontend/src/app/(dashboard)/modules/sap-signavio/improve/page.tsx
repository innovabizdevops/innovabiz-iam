...
const PAGE = "Improve";
const KPIS = [{"l":"Projetos Melhoria","v":"6.383","t":"+11.7%","d":"up"},{"l":"Savings (€)","v":"€17547","t":"+-0.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"71.3%","t":"+2.4%","d":"up"},{"l":"Ciclos PDCA","v":"2.974","t":"+14.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","247","€ 28713.87","187","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.090","€ 27426.17","5.238","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.534","€ 40062.84","4.570","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.826","€ 1063.72","8.760","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","913","€ 27506.05","5.912","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":896},{"label":"Fev","value":857},{"label":"Mar","value":689},{"label":"Abr","value":931},{"label":"Mai","value":904},{"label":"Jun","value":669},{"label":"Jul","value":653},{"label":"Ago","value":903},{"label":"Set","value":655},{"label":"Out","value":799},{"label":"Nov","value":622},{"label":"Dez","value":728}];
const MX = 931;
