...
const PAGE = "Safety";
const KPIS = [{"l":"Total Embalming Ops","v":"6.893","t":"+10.0%","d":"up"},{"l":"Safety Ativos","v":"5.210","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"85.6%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"60","t":"+12.3%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Embalming Ops #001","Embalming Ops #002","4.892","2.938","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Embalming Ops #002","Embalming Ops #003","8.698","6.498","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Embalming Ops #003","Embalming Ops #004","3.938","1.026","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Embalming Ops #004","Embalming Ops #005","5.844","3.291","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Embalming Ops #005","Embalming Ops #001","8.754","1.591","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":522},{"label":"Mar","value":496},{"label":"Abr","value":777},{"label":"Mai","value":455},{"label":"Jun","value":618},{"label":"Jul","value":556},{"label":"Ago","value":698},{"label":"Set","value":636},{"label":"Out","value":776},{"label":"Nov","value":386},{"label":"Dez","value":732}];
const MX = 777;
