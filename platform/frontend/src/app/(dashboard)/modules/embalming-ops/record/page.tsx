...
const PAGE = "Record";
const KPIS = [{"l":"Total Embalming Ops","v":"5.314","t":"-1.9%","d":"down"},{"l":"Record Ativos","v":"231","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"78.2%","t":"+0.1%","d":"up"},{"l":"Score Performance","v":"73","t":"+14.4%","d":"up"}];
const COLS = ["ID","Record","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Embalming Ops #001","Embalming Ops #002","321","8.708","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Embalming Ops #002","Embalming Ops #003","2.405","2.562","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Embalming Ops #003","Embalming Ops #004","1.417","1.828","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Embalming Ops #004","Embalming Ops #005","9.015","7.054","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Embalming Ops #005","Embalming Ops #001","2.785","1.264","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":572},{"label":"Mar","value":656},{"label":"Abr","value":511},{"label":"Mai","value":556},{"label":"Jun","value":701},{"label":"Jul","value":811},{"label":"Ago","value":657},{"label":"Set","value":792},{"label":"Out","value":729},{"label":"Nov","value":692},{"label":"Dez","value":763}];
const MX = 827;
