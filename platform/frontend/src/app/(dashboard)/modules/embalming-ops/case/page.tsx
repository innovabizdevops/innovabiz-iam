...
const PAGE = "Case";
const KPIS = [{"l":"Total Embalming Ops","v":"1.699","t":"+8.2%","d":"up"},{"l":"Case Ativos","v":"2.117","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"77.3%","t":"+5.5%","d":"up"},{"l":"Score Performance","v":"94","t":"-5.9%","d":"down"}];
const COLS = ["ID","Case","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Embalming Ops #001","Embalming Ops #002","8.803","7.461","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Embalming Ops #002","Embalming Ops #003","4.013","4.899","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Embalming Ops #003","Embalming Ops #004","3.333","9.044","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Embalming Ops #004","Embalming Ops #005","9.045","2.037","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Embalming Ops #005","Embalming Ops #001","7.157","1.635","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":430},{"label":"Mar","value":515},{"label":"Abr","value":486},{"label":"Mai","value":744},{"label":"Jun","value":620},{"label":"Jul","value":780},{"label":"Ago","value":548},{"label":"Set","value":800},{"label":"Out","value":778},{"label":"Nov","value":765},{"label":"Dez","value":497}];
const MX = 800;
