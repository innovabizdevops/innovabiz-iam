...
const ACCENT = "#1e293b";
const MODULE = "Embalming Operations";
const PAGE = "Chemical";
const KPIS = [{"l":"Total Embalming Ops","v":"6.180","t":"+11.1%","d":"up"},{"l":"Chemical Ativos","v":"1.921","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"90.6%","t":"+1.7%","d":"up"},{"l":"Score Performance","v":"67","t":"+12.3%","d":"up"}];
const COLS = ["ID","Chemical","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Embalming Ops #001","Embalming Ops #002","145","2.691","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Embalming Ops #002","Embalming Ops #003","5.753","1.776","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Embalming Ops #003","Embalming Ops #004","4.083","5.203","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Embalming Ops #004","Embalming Ops #005","7.801","4.504","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Embalming Ops #005","Embalming Ops #001","3.353","3.173","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":843},{"label":"Fev","value":985},{"label":"Mar","value":836},{"label":"Abr","value":1025},{"label":"Mai","value":798},{"label":"Jun","value":905},{"label":"Jul","value":872},{"label":"Ago","value":983},{"label":"Set","value":785},{"label":"Out","value":879},{"label":"Nov","value":995},{"label":"Dez","value":943}];
const MX = 1025;
