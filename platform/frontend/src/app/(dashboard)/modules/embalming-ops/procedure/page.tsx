...
const KPIS = [{"l":"Total Embalming Ops","v":"2.585","t":"+0.5%","d":"up"},{"l":"Procedure Ativos","v":"6.070","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"86.5%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"68","t":"+4.0%","d":"up"}];
const COLS = ["ID","Procedure","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Embalming Ops #001","Embalming Ops #002","1.132","7.261","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Embalming Ops #002","Embalming Ops #003","2.380","8.249","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Embalming Ops #003","Embalming Ops #004","7.323","6.980","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Embalming Ops #004","Embalming Ops #005","3.860","6.997","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Embalming Ops #005","Embalming Ops #001","2.945","6.791","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":958},{"label":"Fev","value":640},{"label":"Mar","value":643},{"label":"Abr","value":658},{"label":"Mai","value":582},{"label":"Jun","value":950},{"label":"Jul","value":912},{"label":"Ago","value":876},{"label":"Set","value":876},{"label":"Out","value":716},{"label":"Nov","value":575},{"label":"Dez","value":656}];
const MX = 958;
