...
/* ═══ Embalming Operations — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "7414", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2871", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€377K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1277731014", cells: ["EMB-2014", "Embalming Operations Item 1", "15/7/2026", "€31 114"], status: "active" as const },
    { id: "1277734585", cells: ["EMB-5585", "Embalming Operations Item 2", "2/2/2026", "€34 685"], status: "pending" as const },
    { id: "1277738156", cells: ["EMB-9156", "Embalming Operations Item 3", "17/9/2026", "€38 256"], status: "completed" as const },
    { id: "1277741727", cells: ["EMB-3727", "Embalming Operations Item 4", "4/4/2026", "€41 827"], status: "warning" as const },
    { id: "1277745298", cells: ["EMB-7298", "Embalming Operations Item 5", "19/11/2026", "€45 398"], status: "active" as const },
];
...
export default function EmbalmingOperationsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Embalming Operations</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Embalming Operations</p>
                    </div>
                </div>
