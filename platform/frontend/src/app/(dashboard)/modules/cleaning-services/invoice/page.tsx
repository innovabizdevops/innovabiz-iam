...
const PAGE = "Invoice";
const KPIS = [{"l":"Projetos Melhoria","v":"8.670","t":"+8.5%","d":"up"},{"l":"Savings (€)","v":"€30098","t":"+2.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"89.4%","t":"+11.0%","d":"up"},{"l":"Ciclos PDCA","v":"2.712","t":"+9.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.316","€ 29353.02","663","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.289","€ 48445.30","697","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.974","€ 32123.68","314","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.348","€ 34052.63","7.336","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.967","€ 30585.97","2.903","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":447},{"label":"Mar","value":311},{"label":"Abr","value":474},{"label":"Mai","value":535},{"label":"Jun","value":430},{"label":"Jul","value":270},{"label":"Ago","value":253},{"label":"Set","value":560},{"label":"Out","value":595},{"label":"Nov","value":268},{"label":"Dez","value":403}];
const MX = 595;
