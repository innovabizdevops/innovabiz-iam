...
const PAGE = "Schedule";
const KPIS = [{"l":"Projetos Melhoria","v":"1.010","t":"-0.3%","d":"down"},{"l":"Savings (€)","v":"€57871","t":"+17.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"69.8%","t":"+7.7%","d":"up"},{"l":"Ciclos PDCA","v":"7.350","t":"+3.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","447","€ 32551.51","6.027","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.587","€ 21931.20","3.765","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.608","€ 38131.44","7.185","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.140","€ 5333.65","8.751","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","721","€ 1739.23","5.813","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":618},{"label":"Mar","value":839},{"label":"Abr","value":456},{"label":"Mai","value":465},{"label":"Jun","value":704},{"label":"Jul","value":796},{"label":"Ago","value":711},{"label":"Set","value":644},{"label":"Out","value":515},{"label":"Nov","value":731},{"label":"Dez","value":524}];
const MX = 842;
