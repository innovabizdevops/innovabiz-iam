...
const PAGE = "Booking";
const KPIS = [{"l":"Projetos Melhoria","v":"4.580","t":"-4.7%","d":"down"},{"l":"Savings (€)","v":"€95136","t":"+14.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"77.7%","t":"+11.8%","d":"up"},{"l":"Ciclos PDCA","v":"5.180","t":"+12.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.644","€ 1608.06","5.227","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.816","€ 16032.60","1.513","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.107","€ 18092.26","2.161","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.402","€ 5386.73","5.635","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.746","€ 33969.23","2.988","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":565},{"label":"Fev","value":673},{"label":"Mar","value":615},{"label":"Abr","value":749},{"label":"Mai","value":821},{"label":"Jun","value":823},{"label":"Jul","value":865},{"label":"Ago","value":542},{"label":"Set","value":606},{"label":"Out","value":785},{"label":"Nov","value":788},{"label":"Dez","value":766}];
const MX = 865;
