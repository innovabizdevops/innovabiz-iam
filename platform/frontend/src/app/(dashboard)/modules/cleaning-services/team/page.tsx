...
const PAGE = "Team";
const KPIS = [{"l":"Projetos Melhoria","v":"8.099","t":"+17.1%","d":"up"},{"l":"Savings (€)","v":"€28016","t":"-4.2%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"68.0%","t":"+5.6%","d":"up"},{"l":"Ciclos PDCA","v":"2.096","t":"+10.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.414","€ 43763.28","9.046","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.459","€ 3819.77","4.850","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","197","€ 18902.03","1.839","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","696","€ 628.56","4.174","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.114","€ 5140.30","4.744","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":499},{"label":"Mar","value":370},{"label":"Abr","value":601},{"label":"Mai","value":474},{"label":"Jun","value":529},{"label":"Jul","value":469},{"label":"Ago","value":600},{"label":"Set","value":546},{"label":"Out","value":615},{"label":"Nov","value":574},{"label":"Dez","value":296}];
const MX = 615;
