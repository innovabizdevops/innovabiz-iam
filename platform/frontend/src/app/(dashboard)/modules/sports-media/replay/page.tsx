...
const PAGE = "Replay";
const KPIS = [{"l":"Integrações Ativas","v":"8.964","t":"+7.6%","d":"up"},{"l":"Chamadas/Hora","v":"4844","t":"+2.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"76.4%","t":"+11.6%","d":"up"},{"l":"Latência Média (ms)","v":"132ms","t":"+11.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.251","6.469","94.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.611","1.706","78.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.972","240","95.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","156","8.538","85.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","732","943","76.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":237},{"label":"Fev","value":449},{"label":"Mar","value":585},{"label":"Abr","value":425},{"label":"Mai","value":412},{"label":"Jun","value":598},{"label":"Jul","value":571},{"label":"Ago","value":558},{"label":"Set","value":522},{"label":"Out","value":461},{"label":"Nov","value":595},{"label":"Dez","value":311}];
const MX = 598;
