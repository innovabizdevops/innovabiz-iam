...
const PAGE = "Live";
const KPIS = [{"l":"Integrações Ativas","v":"1.918","t":"-5.4%","d":"down"},{"l":"Chamadas/Hora","v":"2912","t":"+7.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"80.6%","t":"-4.3%","d":"down"},{"l":"Latência Média (ms)","v":"114ms","t":"+8.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.034","731","84.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.482","8.072","75.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.791","2.456","79.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.023","8.782","95.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.717","8.690","96.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":372},{"label":"Mar","value":487},{"label":"Abr","value":302},{"label":"Mai","value":607},{"label":"Jun","value":540},{"label":"Jul","value":412},{"label":"Ago","value":404},{"label":"Set","value":628},{"label":"Out","value":569},{"label":"Nov","value":417},{"label":"Dez","value":529}];
const MX = 628;
