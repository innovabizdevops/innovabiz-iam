...
const PAGE = "Fan";
const KPIS = [{"l":"Integrações Ativas","v":"3.512","t":"+1.3%","d":"up"},{"l":"Chamadas/Hora","v":"4680","t":"-5.6%","d":"down"},{"l":"Taxa Sucesso (%)","v":"75.6%","t":"-1.8%","d":"down"},{"l":"Latência Média (ms)","v":"60ms","t":"+12.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","741","7.933","99.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.933","1.487","84.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.410","8.279","91.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.649","5.271","97.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.717","4.388","97.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":780},{"label":"Fev","value":705},{"label":"Mar","value":606},{"label":"Abr","value":859},{"label":"Mai","value":705},{"label":"Jun","value":655},{"label":"Jul","value":874},{"label":"Ago","value":734},{"label":"Set","value":860},{"label":"Out","value":665},{"label":"Nov","value":817},{"label":"Dez","value":560}];
const MX = 874;
