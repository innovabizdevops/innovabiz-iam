...
/* ═══ Sports Media Platform — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "2385", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2657", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€328K", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "832354685", cells: ["SPO-8685", "Sports Media Platform Item 1", "2/6/2026", "€4785"], status: "active" as const },
    { id: "832358256", cells: ["SPO-3256", "Sports Media Platform Item 2", "17/1/2026", "€8356"], status: "pending" as const },
    { id: "832361827", cells: ["SPO-6827", "Sports Media Platform Item 3", "4/8/2026", "€11 927"], status: "completed" as const },
    { id: "832365398", cells: ["SPO-1398", "Sports Media Platform Item 4", "19/3/2026", "€15 498"], status: "warning" as const },
    { id: "832368969", cells: ["SPO-4969", "Sports Media Platform Item 5", "6/10/2026", "€19 069"], status: "active" as const },
];
...
export default function SportsMediaPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sports Media Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Sports Media Platform</p>
                    </div>
                </div>
