...
const PAGE = "Rights";
const KPIS = [{"l":"Integrações Ativas","v":"8.125","t":"+4.9%","d":"up"},{"l":"Chamadas/Hora","v":"515","t":"-2.9%","d":"down"},{"l":"Taxa Sucesso (%)","v":"65.9%","t":"+1.3%","d":"up"},{"l":"Latência Média (ms)","v":"176ms","t":"+13.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.142","6.206","73.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.603","1.021","87.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.099","3.260","92.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.667","7.099","93.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.206","6.710","86.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":359},{"label":"Mar","value":486},{"label":"Abr","value":334},{"label":"Mai","value":475},{"label":"Jun","value":493},{"label":"Jul","value":432},{"label":"Ago","value":371},{"label":"Set","value":491},{"label":"Out","value":662},{"label":"Nov","value":319},{"label":"Dez","value":608}];
const MX = 662;
