...
const ACCENT = "#6d28d9";
const MODULE = "Sports Media Platform";
const PAGE = "Stats";
const KPIS = [{"l":"Integrações Ativas","v":"6.378","t":"+7.2%","d":"up"},{"l":"Chamadas/Hora","v":"720","t":"+14.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"75.2%","t":"+12.7%","d":"up"},{"l":"Latência Média (ms)","v":"51ms","t":"+16.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.272","7.321","92.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.500","4.373","92.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.172","4.283","80.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.852","4.876","84.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.604","6.142","93.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":539},{"label":"Mar","value":511},{"label":"Abr","value":566},{"label":"Mai","value":454},{"label":"Jun","value":608},{"label":"Jul","value":739},{"label":"Ago","value":435},{"label":"Set","value":676},{"label":"Out","value":479},{"label":"Nov","value":419},{"label":"Dez","value":541}];
const MX = 739;
