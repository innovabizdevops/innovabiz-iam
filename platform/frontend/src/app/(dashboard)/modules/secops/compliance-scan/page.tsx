...
const PAGE = "Compliance Scan";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.868","t":"-1.2%","d":"down"},{"l":"NC Abertas","v":"107","t":"+2.1%","d":"up"},{"l":"Conformidade (%)","v":"85.8%","t":"+3.3%","d":"up"},{"l":"CAPAs Pendentes","v":"2.211","t":"+3.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.151","81.3%","6.527","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.724","96.1%","8.793","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","656","74.1%","6.078","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.081","94.8%","3.216","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","215","87.3%","3.150","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1005},{"label":"Fev","value":730},{"label":"Mar","value":805},{"label":"Abr","value":682},{"label":"Mai","value":948},{"label":"Jun","value":644},{"label":"Jul","value":794},{"label":"Ago","value":637},{"label":"Set","value":737},{"label":"Out","value":807},{"label":"Nov","value":916},{"label":"Dez","value":1023}];
const MX = 1023;
