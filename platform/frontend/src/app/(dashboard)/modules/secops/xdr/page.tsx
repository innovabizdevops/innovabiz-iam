...
const PAGE = "XDR Integration";
const KPIS = [{"l":"Integrações Ativas","v":"6.278","t":"+10.7%","d":"up"},{"l":"Chamadas/Hora","v":"2311","t":"-3.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"82.5%","t":"+13.8%","d":"up"},{"l":"Latência Média (ms)","v":"23ms","t":"+7.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.558","7.982","79.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.894","7.938","99.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.929","6.105","99.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.126","5.406","81.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.846","1.579","90.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":908},{"label":"Mar","value":561},{"label":"Abr","value":694},{"label":"Mai","value":782},{"label":"Jun","value":610},{"label":"Jul","value":812},{"label":"Ago","value":556},{"label":"Set","value":872},{"label":"Out","value":646},{"label":"Nov","value":734},{"label":"Dez","value":932}];
const MX = 932;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>XDR</span></h1>
                </div>
