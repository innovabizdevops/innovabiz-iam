...
const PAGE = "Cloud Security Posture";
const KPIS = [{"l":"Pedidos/Dia","v":"2680","t":"+16.1%","d":"up"},{"l":"GMV (€)","v":"€65935","t":"+1.5%","d":"up"},{"l":"Conversão (%)","v":"89.4%","t":"+6.1%","d":"up"},{"l":"AOV (€)","v":"€42776","t":"+12.2%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 5671.47","1.966","2.439","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 28348.35","8.033","774","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 32116.63","3.906","2.493","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 49358.42","4.116","9.028","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 24540.22","6.006","4.187","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":706},{"label":"Mar","value":628},{"label":"Abr","value":672},{"label":"Mai","value":447},{"label":"Jun","value":682},{"label":"Jul","value":660},{"label":"Ago","value":400},{"label":"Set","value":459},{"label":"Out","value":662},{"label":"Nov","value":578},{"label":"Dez","value":501}];
const MX = 706;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>CSPM</span></h1>
                </div>
