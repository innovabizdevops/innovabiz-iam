...
const PAGE = "Incident Response";
const KPIS = [{"l":"Tickets Abertos","v":"6.184","t":"+10.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"66.2%","t":"+13.0%","d":"up"},{"l":"MTTR (h)","v":"87h","t":"+3.2%","d":"up"},{"l":"Satisfação (%)","v":"69.0%","t":"-5.7%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.926","4.236","8.616","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.016","3.321","8.946","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.178","2.527","1.812","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.431","5.400","3.991","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.486","4.033","3.997","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":784},{"label":"Mar","value":729},{"label":"Abr","value":748},{"label":"Mai","value":497},{"label":"Jun","value":565},{"label":"Jul","value":621},{"label":"Ago","value":489},{"label":"Set","value":637},{"label":"Out","value":566},{"label":"Nov","value":569},{"label":"Dez","value":832}];
const MX = 832;
