...
const KPIS = [{"l":"Total Secops","v":"3.729","t":"+14.3%","d":"up"},{"l":"SOAR Playbooks Ativos","v":"5.126","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"89.4%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"66","t":"+9.6%","d":"up"}];
const COLS = ["ID","SOAR Playbooks","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Secops #001","Secops #002","1.907","5.149","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Secops #002","Secops #003","7.413","666","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Secops #003","Secops #004","5.825","8.866","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Secops #004","Secops #005","6.652","7.304","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Secops #005","Secops #001","8.288","1.575","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":337},{"label":"Fev","value":480},{"label":"Mar","value":244},{"label":"Abr","value":603},{"label":"Mai","value":322},{"label":"Jun","value":538},{"label":"Jul","value":545},{"label":"Ago","value":444},{"label":"Set","value":455},{"label":"Out","value":366},{"label":"Nov","value":457},{"label":"Dez","value":591}];
const MX = 603;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>Automation</span></h1>
                </div>
