...
const PAGE = "Forensics Console";
const KPIS = [{"l":"Total Secops","v":"4.502","t":"+13.4%","d":"up"},{"l":"Forensics Console Ativos","v":"5.929","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"74.6%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"93","t":"+6.1%","d":"up"}];
const COLS = ["ID","Forensics Console","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Secops #001","Secops #002","6.290","9.076","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Secops #002","Secops #003","2.234","2.325","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Secops #003","Secops #004","6.910","3.124","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Secops #004","Secops #005","6.606","3.988","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Secops #005","Secops #001","6.883","575","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":843},{"label":"Mar","value":824},{"label":"Abr","value":536},{"label":"Mai","value":572},{"label":"Jun","value":609},{"label":"Jul","value":625},{"label":"Ago","value":502},{"label":"Set","value":705},{"label":"Out","value":521},{"label":"Nov","value":673},{"label":"Dez","value":705}];
const MX = 843;
