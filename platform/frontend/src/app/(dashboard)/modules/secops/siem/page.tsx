...
const PAGE = "SIEM Integration";
const KPIS = [{"l":"Integrações Ativas","v":"6.276","t":"-2.4%","d":"down"},{"l":"Chamadas/Hora","v":"938","t":"+13.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.9%","t":"+14.0%","d":"up"},{"l":"Latência Média (ms)","v":"26ms","t":"+7.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.418","6.759","70.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.206","474","75.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.675","103","97.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.813","677","80.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.755","1.795","92.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":620},{"label":"Mar","value":714},{"label":"Abr","value":557},{"label":"Mai","value":460},{"label":"Jun","value":477},{"label":"Jul","value":502},{"label":"Ago","value":641},{"label":"Set","value":652},{"label":"Out","value":682},{"label":"Nov","value":782},{"label":"Dez","value":762}];
const MX = 782;
