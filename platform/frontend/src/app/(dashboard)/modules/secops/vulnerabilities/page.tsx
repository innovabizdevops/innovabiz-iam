...
const PAGE = "Vulnerability Mgmt";
const KPIS = [{"l":"Total Secops","v":"1.893","t":"-4.9%","d":"down"},{"l":"Vulnerability Mgmt Ativos","v":"2.159","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"74.4%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"85","t":"+8.2%","d":"up"}];
const COLS = ["ID","Vulnerability Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Secops #001","Secops #002","8.875","4.410","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Secops #002","Secops #003","9.047","8.001","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Secops #003","Secops #004","4.947","1.900","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Secops #004","Secops #005","8.435","6.512","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Secops #005","Secops #001","6.965","1.996","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":812},{"label":"Fev","value":543},{"label":"Mar","value":562},{"label":"Abr","value":842},{"label":"Mai","value":669},{"label":"Jun","value":634},{"label":"Jul","value":605},{"label":"Ago","value":545},{"label":"Set","value":698},{"label":"Out","value":771},{"label":"Nov","value":881},{"label":"Dez","value":814}];
const MX = 881;
