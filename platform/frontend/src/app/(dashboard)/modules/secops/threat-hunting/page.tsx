...
const PAGE = "Threat Hunting";
const KPIS = [{"l":"Total Secops","v":"6.727","t":"+8.9%","d":"up"},{"l":"Threat Hunting Ativos","v":"2.261","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"83.2%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"68","t":"+12.3%","d":"up"}];
const COLS = ["ID","Threat Hunting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Secops #001","Secops #002","5.810","115","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Secops #002","Secops #003","2.381","5.755","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Secops #003","Secops #004","2.670","3.255","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Secops #004","Secops #005","6.297","4.362","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Secops #005","Secops #001","2.810","8.037","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":755},{"label":"Mar","value":411},{"label":"Abr","value":399},{"label":"Mai","value":529},{"label":"Jun","value":456},{"label":"Jul","value":535},{"label":"Ago","value":392},{"label":"Set","value":376},{"label":"Out","value":461},{"label":"Nov","value":384},{"label":"Dez","value":692}];
const MX = 755;
