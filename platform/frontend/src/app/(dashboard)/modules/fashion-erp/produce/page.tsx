...
const ACCENT = "#be185d";
const MODULE = "Fashion ERP Platform";
const PAGE = "Produce";
const KPIS = [{"l":"Total Fashion Erp","v":"3.402","t":"+17.0%","d":"up"},{"l":"Produce Ativos","v":"2.563","t":"+14.3%","d":"up"},{"l":"Eficiência (%)","v":"91.1%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"63","t":"+11.3%","d":"up"}];
const COLS = ["ID","Produce","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fashion Erp #001","Fashion Erp #002","117","6.353","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Fashion Erp #002","Fashion Erp #003","3.220","7.992","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Fashion Erp #003","Fashion Erp #004","8.703","8.588","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Fashion Erp #004","Fashion Erp #005","3.432","2.783","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fashion Erp #005","Fashion Erp #001","1.538","5.632","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":918},{"label":"Fev","value":927},{"label":"Mar","value":572},{"label":"Abr","value":632},{"label":"Mai","value":692},{"label":"Jun","value":547},{"label":"Jul","value":599},{"label":"Ago","value":697},{"label":"Set","value":855},{"label":"Out","value":645},{"label":"Nov","value":539},{"label":"Dez","value":725}];
const MX = 927;
