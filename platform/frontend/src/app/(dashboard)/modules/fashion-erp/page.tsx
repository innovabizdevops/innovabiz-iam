...
/* ═══ Fashion ERP Platform — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "9933", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3858", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€413K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "285377333", cells: ["FAS-6333", "Fashion ERP Platform Item 1", "18/6/2026", "€27 433"], status: "active" as const },
    { id: "285380904", cells: ["FAS-9904", "Fashion ERP Platform Item 2", "5/1/2026", "€31 004"], status: "pending" as const },
    { id: "285384475", cells: ["FAS-4475", "Fashion ERP Platform Item 3", "20/8/2026", "€34 575"], status: "completed" as const },
    { id: "285388046", cells: ["FAS-8046", "Fashion ERP Platform Item 4", "7/3/2026", "€38 146"], status: "warning" as const },
    { id: "285391617", cells: ["FAS-2617", "Fashion ERP Platform Item 5", "22/10/2026", "€41 717"], status: "active" as const },
];
...
export default function FashionErpPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fashion ERP Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fashion ERP Platform</p>
                    </div>
                </div>
