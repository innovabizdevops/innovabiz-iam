...
/* ═══ MD: Multi-Region Engine Deep — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "3940", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3935", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€78K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "-23%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1059076140", cells: ["MD-2140", "MD: Multi-Region Engine Deep Item 1", "25/1/2026", "€26 240"], status: "active" as const },
    { id: "1059079711", cells: ["MD-5711", "MD: Multi-Region Engine Deep Item 2", "12/8/2026", "€29 811"], status: "pending" as const },
    { id: "1059083282", cells: ["MD-9282", "MD: Multi-Region Engine Deep Item 3", "27/3/2026", "€33 382"], status: "completed" as const },
    { id: "1059086853", cells: ["MD-3853", "MD: Multi-Region Engine Deep Item 4", "14/10/2026", "€36 953"], status: "warning" as const },
    { id: "1059090424", cells: ["MD-7424", "MD: Multi-Region Engine Deep Item 5", "1/5/2026", "€40 524"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 80 }, { label: "Fev", value: 89 }, { label: "Mar", value: 98 }, { label: "Abr", value: 27 }, { label: "Mai", value: 36 }, { label: "Jun", value: 45 }];
...
export default function MdMultiregionEngineDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Region Engine Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Region Engine Deep</p>
                    </div>
                </div>
