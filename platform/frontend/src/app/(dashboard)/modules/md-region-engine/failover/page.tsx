...
const PAGE = "Failover";
const KPIS = [{"l":"BCP Plans Ativos","v":"132","t":"-0.8%","d":"down"},{"l":"RTO Médio (h)","v":"187h","t":"+13.9%","d":"up"},{"l":"RPO Médio (h)","v":"124h","t":"+10.3%","d":"up"},{"l":"Testes DR (YTD)","v":"4.182","t":"+13.3%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","206h","146h","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","61h","191h","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","63h","68h","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","18h","106h","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","206h","74h","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":476},{"label":"Fev","value":456},{"label":"Mar","value":267},{"label":"Abr","value":478},{"label":"Mai","value":324},{"label":"Jun","value":337},{"label":"Jul","value":515},{"label":"Ago","value":442},{"label":"Set","value":570},{"label":"Out","value":510},{"label":"Nov","value":305},{"label":"Dez","value":342}];
const MX = 570;
