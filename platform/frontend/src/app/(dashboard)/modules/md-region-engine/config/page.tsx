...
const KPIS = [{"l":"Configurações","v":"7.988","t":"+6.7%","d":"up"},{"l":"Últimas Alterações","v":"2.803","t":"+14.7%","d":"up"},{"l":"Ambientes","v":"3.214","t":"+0.5%","d":"up"},{"l":"Versão Config","v":"8.930","t":"+16.4%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 45697.63","8.696","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 2108.15","6.052","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 45700.80","6.798","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 11906.77","1.942","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 8382.71","4.879","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":519},{"label":"Mar","value":632},{"label":"Abr","value":574},{"label":"Mai","value":737},{"label":"Jun","value":597},{"label":"Jul","value":579},{"label":"Ago","value":604},{"label":"Set","value":841},{"label":"Out","value":543},{"label":"Nov","value":668},{"label":"Dez","value":609}];
const MX = 841;
