...
const KPIS = [{"l":"Integrações Ativas","v":"6.790","t":"+14.2%","d":"up"},{"l":"Chamadas/Hora","v":"2774","t":"+3.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"85.9%","t":"+8.5%","d":"up"},{"l":"Latência Média (ms)","v":"78ms","t":"-5.7%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.818","8.205","72.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.761","7.873","73.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.000","5.213","72.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.275","7.866","76.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.501","6.860","89.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":728},{"label":"Mar","value":927},{"label":"Abr","value":943},{"label":"Mai","value":588},{"label":"Jun","value":704},{"label":"Jul","value":815},{"label":"Ago","value":750},{"label":"Set","value":848},{"label":"Out","value":754},{"label":"Nov","value":595},{"label":"Dez","value":658}];
const MX = 943;
