...
const PAGE = "Ingest";
const KPIS = [{"l":"Integrações Ativas","v":"1.550","t":"+1.7%","d":"up"},{"l":"Chamadas/Hora","v":"2027","t":"+16.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.0%","t":"+17.0%","d":"up"},{"l":"Latência Média (ms)","v":"17ms","t":"+16.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.540","6.770","78.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.000","1.359","84.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.306","3.318","97.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","946","7.101","80.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.292","5.418","75.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":568},{"label":"Mar","value":599},{"label":"Abr","value":422},{"label":"Mai","value":386},{"label":"Jun","value":467},{"label":"Jul","value":660},{"label":"Ago","value":476},{"label":"Set","value":574},{"label":"Out","value":533},{"label":"Nov","value":383},{"label":"Dez","value":483}];
const MX = 660;
