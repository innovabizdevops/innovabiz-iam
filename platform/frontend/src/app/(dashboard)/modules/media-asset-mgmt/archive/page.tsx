...
const PAGE = "Archive";
const KPIS = [{"l":"Integrações Ativas","v":"5.975","t":"+10.8%","d":"up"},{"l":"Chamadas/Hora","v":"2973","t":"+8.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"89.0%","t":"+14.3%","d":"up"},{"l":"Latência Média (ms)","v":"164ms","t":"+11.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.731","4.292","81.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.316","7.845","74.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.853","173","75.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.980","477","89.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.992","5.800","82.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":544},{"label":"Mar","value":246},{"label":"Abr","value":255},{"label":"Mai","value":330},{"label":"Jun","value":340},{"label":"Jul","value":575},{"label":"Ago","value":421},{"label":"Set","value":572},{"label":"Out","value":343},{"label":"Nov","value":317},{"label":"Dez","value":316}];
const MX = 575;
