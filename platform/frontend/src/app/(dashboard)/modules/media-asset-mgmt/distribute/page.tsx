...
const KPIS = [{"l":"Integrações Ativas","v":"216","t":"+16.1%","d":"up"},{"l":"Chamadas/Hora","v":"3116","t":"+12.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.2%","t":"+16.4%","d":"up"},{"l":"Latência Média (ms)","v":"165ms","t":"+7.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.621","3.577","70.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.511","2.962","91.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.046","995","85.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.620","5.678","86.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.108","4.308","77.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":365},{"label":"Fev","value":592},{"label":"Mar","value":445},{"label":"Abr","value":563},{"label":"Mai","value":377},{"label":"Jun","value":456},{"label":"Jul","value":502},{"label":"Ago","value":506},{"label":"Set","value":409},{"label":"Out","value":558},{"label":"Nov","value":492},{"label":"Dez","value":584}];
const MX = 592;
