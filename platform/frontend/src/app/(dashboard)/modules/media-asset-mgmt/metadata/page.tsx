...
const ACCENT = "#6366f1";
const MODULE = "Media Asset Mgmt";
const PAGE = "Metadata";
const KPIS = [{"l":"Integrações Ativas","v":"8.493","t":"+9.9%","d":"up"},{"l":"Chamadas/Hora","v":"1409","t":"-1.7%","d":"down"},{"l":"Taxa Sucesso (%)","v":"67.5%","t":"+17.9%","d":"up"},{"l":"Latência Média (ms)","v":"196ms","t":"-2.3%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.168","1.968","83.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.727","7.706","99.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.906","2.974","99.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.175","5.376","71.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.907","5.512","77.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":886},{"label":"Fev","value":940},{"label":"Mar","value":1057},{"label":"Abr","value":767},{"label":"Mai","value":1054},{"label":"Jun","value":1050},{"label":"Jul","value":1043},{"label":"Ago","value":953},{"label":"Set","value":1016},{"label":"Out","value":750},{"label":"Nov","value":961},{"label":"Dez","value":822}];
const MX = 1057;
