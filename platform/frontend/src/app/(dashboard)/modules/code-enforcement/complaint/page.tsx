...
const ACCENT = "#6366f1";
const MODULE = "Code Enforcement";
const PAGE = "Complaint";
const KPIS = [{"l":"Total Code Enforcement","v":"1.711","t":"-0.4%","d":"down"},{"l":"Complaint Ativos","v":"3.350","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"68.3%","t":"+9.7%","d":"up"},{"l":"Score Performance","v":"73","t":"+10.1%","d":"up"}];
const COLS = ["ID","Complaint","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Code Enforcement #001","Code Enforcement #002","2.466","1.748","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Code Enforcement #002","Code Enforcement #003","8.446","5.460","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Code Enforcement #003","Code Enforcement #004","761","7.993","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Code Enforcement #004","Code Enforcement #005","6.591","160","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Code Enforcement #005","Code Enforcement #001","3.443","8.750","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":632},{"label":"Mar","value":750},{"label":"Abr","value":851},{"label":"Mai","value":760},{"label":"Jun","value":747},{"label":"Jul","value":556},{"label":"Ago","value":653},{"label":"Set","value":715},{"label":"Out","value":746},{"label":"Nov","value":609},{"label":"Dez","value":763}];
const MX = 851;
