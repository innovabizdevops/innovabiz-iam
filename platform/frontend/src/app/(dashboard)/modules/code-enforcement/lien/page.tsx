...
const PAGE = "Lien";
const KPIS = [{"l":"Total Code Enforcement","v":"3.075","t":"-3.7%","d":"down"},{"l":"Lien Ativos","v":"3.675","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"66.5%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"84","t":"+3.8%","d":"up"}];
const COLS = ["ID","Lien","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Code Enforcement #001","Code Enforcement #002","1.661","386","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Code Enforcement #002","Code Enforcement #003","2.459","2.818","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Code Enforcement #003","Code Enforcement #004","6.030","1.606","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Code Enforcement #004","Code Enforcement #005","1.865","2.590","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Code Enforcement #005","Code Enforcement #001","8.475","6.149","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":371},{"label":"Fev","value":625},{"label":"Mar","value":684},{"label":"Abr","value":430},{"label":"Mai","value":666},{"label":"Jun","value":664},{"label":"Jul","value":438},{"label":"Ago","value":733},{"label":"Set","value":539},{"label":"Out","value":551},{"label":"Nov","value":476},{"label":"Dez","value":757}];
const MX = 757;
