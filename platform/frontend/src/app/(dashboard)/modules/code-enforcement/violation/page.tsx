...
const PAGE = "Violation";
const KPIS = [{"l":"Total Code Enforcement","v":"1.506","t":"-0.5%","d":"down"},{"l":"Violation Ativos","v":"7.537","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"72.1%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"67","t":"+2.3%","d":"up"}];
const COLS = ["ID","Violation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Code Enforcement #001","Code Enforcement #002","2.969","836","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Code Enforcement #002","Code Enforcement #003","8.234","8.172","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Code Enforcement #003","Code Enforcement #004","5.768","2.543","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Code Enforcement #004","Code Enforcement #005","5.895","1.525","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Code Enforcement #005","Code Enforcement #001","2.709","5.430","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":529},{"label":"Mar","value":677},{"label":"Abr","value":522},{"label":"Mai","value":381},{"label":"Jun","value":488},{"label":"Jul","value":393},{"label":"Ago","value":709},{"label":"Set","value":702},{"label":"Out","value":723},{"label":"Nov","value":472},{"label":"Dez","value":461}];
const MX = 723;
