...
const ACCENT = "#dc2626";
const MODULE = "Spice Trade & Processing";
const PAGE = "Process";
const KPIS = [{"l":"Total Spice Trade","v":"1.608","t":"+5.0%","d":"up"},{"l":"Process Ativos","v":"2.045","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"75.8%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"94","t":"+7.7%","d":"up"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Spice Trade #001","Spice Trade #002","3.667","6.804","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Spice Trade #002","Spice Trade #003","4.511","1.995","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Spice Trade #003","Spice Trade #004","8.443","8.565","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Spice Trade #004","Spice Trade #005","3.392","6.192","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Spice Trade #005","Spice Trade #001","4.246","2.930","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":521},{"label":"Mar","value":466},{"label":"Abr","value":483},{"label":"Mai","value":520},{"label":"Jun","value":304},{"label":"Jul","value":522},{"label":"Ago","value":565},{"label":"Set","value":277},{"label":"Out","value":314},{"label":"Nov","value":556},{"label":"Dez","value":629}];
const MX = 629;
