...
const PAGE = "Grade";
const KPIS = [{"l":"Total Spice Trade","v":"2.505","t":"-0.7%","d":"down"},{"l":"Grade Ativos","v":"7.138","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"80.6%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"82","t":"-2.0%","d":"down"}];
const COLS = ["ID","Grade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Spice Trade #001","Spice Trade #002","5.658","5.404","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Spice Trade #002","Spice Trade #003","1.597","6.046","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Spice Trade #003","Spice Trade #004","1.997","5.242","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Spice Trade #004","Spice Trade #005","4.556","3.300","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Spice Trade #005","Spice Trade #001","427","1.007","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":721},{"label":"Mar","value":572},{"label":"Abr","value":693},{"label":"Mai","value":644},{"label":"Jun","value":536},{"label":"Jul","value":636},{"label":"Ago","value":754},{"label":"Set","value":573},{"label":"Out","value":821},{"label":"Nov","value":770},{"label":"Dez","value":780}];
const MX = 840;
