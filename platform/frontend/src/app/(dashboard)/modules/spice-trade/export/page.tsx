...
const PAGE = "Export";
const KPIS = [{"l":"Total Spice Trade","v":"3.252","t":"+6.4%","d":"up"},{"l":"Export Ativos","v":"1.444","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"89.4%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"89","t":"+3.7%","d":"up"}];
const COLS = ["ID","Export","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Spice Trade #001","Spice Trade #002","6.813","8.576","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Spice Trade #002","Spice Trade #003","1.928","2.457","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Spice Trade #003","Spice Trade #004","513","6.314","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Spice Trade #004","Spice Trade #005","2.599","633","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Spice Trade #005","Spice Trade #001","8.375","2.000","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":643},{"label":"Mar","value":732},{"label":"Abr","value":517},{"label":"Mai","value":470},{"label":"Jun","value":544},{"label":"Jul","value":724},{"label":"Ago","value":748},{"label":"Set","value":420},{"label":"Out","value":722},{"label":"Nov","value":605},{"label":"Dez","value":718}];
const MX = 748;
