...
const PAGE = "Package";
const KPIS = [{"l":"Total Spice Trade","v":"6.948","t":"-5.0%","d":"down"},{"l":"Package Ativos","v":"2.112","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"69.8%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"64","t":"+7.3%","d":"up"}];
const COLS = ["ID","Package","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Spice Trade #001","Spice Trade #002","5.581","1.913","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Spice Trade #002","Spice Trade #003","351","8.790","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Spice Trade #003","Spice Trade #004","5.467","5.238","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Spice Trade #004","Spice Trade #005","6.713","7.316","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Spice Trade #005","Spice Trade #001","8.568","3.070","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":822},{"label":"Mar","value":930},{"label":"Abr","value":896},{"label":"Mai","value":893},{"label":"Jun","value":576},{"label":"Jul","value":675},{"label":"Ago","value":839},{"label":"Set","value":635},{"label":"Out","value":574},{"label":"Nov","value":936},{"label":"Dez","value":704}];
const MX = 936;
