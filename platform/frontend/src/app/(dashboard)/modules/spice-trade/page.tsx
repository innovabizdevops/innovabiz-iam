...
/* ═══ Spice Trade & Processing — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "8764", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3259", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€398K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1842586764", cells: ["SPI-8764", "Spice Trade & Processing Item 1", "5/1/2026", "€36 864"], status: "active" as const },
    { id: "1842590335", cells: ["SPI-3335", "Spice Trade & Processing Item 2", "20/8/2026", "€40 435"], status: "pending" as const },
    { id: "1842593906", cells: ["SPI-6906", "Spice Trade & Processing Item 3", "7/3/2026", "€44 006"], status: "completed" as const },
    { id: "1842597477", cells: ["SPI-1477", "Spice Trade & Processing Item 4", "22/10/2026", "€47 577"], status: "warning" as const },
    { id: "1842601048", cells: ["SPI-5048", "Spice Trade & Processing Item 5", "9/5/2026", "€1148"], status: "active" as const },
];
...
export default function SpiceTradeProcessingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Spice Trade & Processing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Spice Trade & Processing</p>
                    </div>
                </div>
