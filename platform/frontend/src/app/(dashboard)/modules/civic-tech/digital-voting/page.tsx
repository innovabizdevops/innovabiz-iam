...
/* ═══ Civic Tech — Digital Voting ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "1265", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "113", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2364", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1243258845", cells: ["CIV-8845", "Digital Voting Item 1", "18/10/2026", "€8945"], status: "active" as const },
    { id: "1243262416", cells: ["CIV-3416", "Digital Voting Item 2", "5/5/2026", "€12 516"], status: "pending" as const },
    { id: "1243265987", cells: ["CIV-6987", "Digital Voting Item 3", "20/12/2026", "€16 087"], status: "completed" as const },
    { id: "1243269558", cells: ["CIV-1558", "Digital Voting Item 4", "7/7/2026", "€19 658"], status: "warning" as const },
    { id: "1243273129", cells: ["CIV-5129", "Digital Voting Item 5", "22/2/2026", "€23 229"], status: "active" as const },
];
...
export default function CivicTechDigitalVotingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Digital Voting</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Civic Tech • Digital Voting</p>
                    </div>
                </div>
