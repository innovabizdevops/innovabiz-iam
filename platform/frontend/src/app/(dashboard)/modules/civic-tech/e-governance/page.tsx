...
const KPIS = [
    { label: "Total", value: "1862", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "5", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "237", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "31098225", cells: ["CIV-4225", "E Governance Item 1", "26/10/2026", "€48 325"], status: "active" as const },
    { id: "31101796", cells: ["CIV-7796", "E Governance Item 2", "13/5/2026", "€1896"], status: "pending" as const },
    { id: "31105367", cells: ["CIV-2367", "E Governance Item 3", "28/12/2026", "€5467"], status: "completed" as const },
    { id: "31108938", cells: ["CIV-5938", "E Governance Item 4", "15/7/2026", "€9038"], status: "warning" as const },
    { id: "31112509", cells: ["CIV-9509", "E Governance Item 5", "2/2/2026", "€12 609"], status: "active" as const },
];
...
export default function CivicTechEGovernancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">E Governance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Civic Tech • E Governance</p>
                    </div>
                </div>
