...
/* ═══ Civic Tech — Emergency Mgmt Civic ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "2159", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "402", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1602", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "99%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1397586062", cells: ["CIV-4062", "Emergency Mgmt Civic Item 1", "27/3/2026", "€36 162"], status: "active" as const },
    { id: "1397589633", cells: ["CIV-7633", "Emergency Mgmt Civic Item 2", "14/10/2026", "€39 733"], status: "pending" as const },
    { id: "1397593204", cells: ["CIV-2204", "Emergency Mgmt Civic Item 3", "1/5/2026", "€43 304"], status: "completed" as const },
    { id: "1397596775", cells: ["CIV-5775", "Emergency Mgmt Civic Item 4", "16/12/2026", "€46 875"], status: "warning" as const },
    { id: "1397600346", cells: ["CIV-9346", "Emergency Mgmt Civic Item 5", "3/7/2026", "€446"], status: "active" as const },
];
...
export default function CivicTechEmergencyMgmtCivicPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Emergency Mgmt Civic</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Civic Tech • Emergency Mgmt Civic</p>
                    </div>
                </div>
