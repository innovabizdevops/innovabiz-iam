...
/* ═══ Civic Tech — Civil Registry ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "1608", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "358", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2330", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "777944130", cells: ["CIV-3130", "Civil Registry Item 1", "27/7/2026", "€44 230"], status: "active" as const },
    { id: "777947701", cells: ["CIV-6701", "Civil Registry Item 2", "14/2/2026", "€47 801"], status: "pending" as const },
    { id: "777951272", cells: ["CIV-1272", "Civil Registry Item 3", "1/9/2026", "€1372"], status: "completed" as const },
    { id: "777954843", cells: ["CIV-4843", "Civil Registry Item 4", "16/4/2026", "€4943"], status: "warning" as const },
    { id: "777958414", cells: ["CIV-8414", "Civil Registry Item 5", "3/11/2026", "€8514"], status: "active" as const },
];
...
export default function CivicTechCivilRegistryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Civil Registry</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Civic Tech • Civil Registry</p>
                    </div>
                </div>
