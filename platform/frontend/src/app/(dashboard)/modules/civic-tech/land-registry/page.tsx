...
/* ═══ Civic Tech — Land Registry ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "1905", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "390", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "251", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1561171810", cells: ["CIV-5810", "Land Registry Item 1", "3/11/2026", "€21 910"], status: "active" as const },
    { id: "1561175381", cells: ["CIV-9381", "Land Registry Item 2", "18/6/2026", "€25 481"], status: "pending" as const },
    { id: "1561178952", cells: ["CIV-3952", "Land Registry Item 3", "5/1/2026", "€29 052"], status: "completed" as const },
    { id: "1561182523", cells: ["CIV-7523", "Land Registry Item 4", "20/8/2026", "€32 623"], status: "warning" as const },
    { id: "1561186094", cells: ["CIV-2094", "Land Registry Item 5", "7/3/2026", "€36 194"], status: "active" as const },
];
...
export default function CivicTechLandRegistryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Land Registry</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Civic Tech • Land Registry</p>
                    </div>
                </div>
