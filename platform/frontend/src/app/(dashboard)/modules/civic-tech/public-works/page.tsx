...
/* ═══ Civic Tech — Public Works ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "1329", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "357", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2025", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1879651393", cells: ["CIV-2393", "Public Works Item 1", "26/2/2026", "€1493"], status: "active" as const },
    { id: "1879654964", cells: ["CIV-5964", "Public Works Item 2", "13/9/2026", "€5064"], status: "pending" as const },
    { id: "1879658535", cells: ["CIV-9535", "Public Works Item 3", "28/4/2026", "€8635"], status: "completed" as const },
    { id: "1879662106", cells: ["CIV-4106", "Public Works Item 4", "15/11/2026", "€12 206"], status: "warning" as const },
    { id: "1879665677", cells: ["CIV-7677", "Public Works Item 5", "2/6/2026", "€15 777"], status: "active" as const },
];
...
export default function CivicTechPublicWorksPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Public Works</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Civic Tech • Public Works</p>
                    </div>
                </div>
