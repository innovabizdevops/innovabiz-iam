...
/* ═══ Civic Tech — Business License ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "2250", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "479", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "639", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1994638699", cells: ["CIV-5699", "Business License Item 1", "12/8/2026", "€38 799"], status: "active" as const },
    { id: "1994642270", cells: ["CIV-9270", "Business License Item 2", "27/3/2026", "€42 370"], status: "pending" as const },
    { id: "1994645841", cells: ["CIV-3841", "Business License Item 3", "14/10/2026", "€45 941"], status: "completed" as const },
    { id: "1994649412", cells: ["CIV-7412", "Business License Item 4", "1/5/2026", "€49 512"], status: "warning" as const },
    { id: "1994652983", cells: ["CIV-1983", "Business License Item 5", "16/12/2026", "€3083"], status: "active" as const },
];
...
export default function CivicTechBusinessLicensePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Business License</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Civic Tech • Business License</p>
                    </div>
                </div>
