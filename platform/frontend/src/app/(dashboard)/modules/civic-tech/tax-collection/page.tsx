...
/* ═══ Civic Tech — Tax Collection ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "2520", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "349", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3469", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1808309721", cells: ["CIV-3721", "Tax Collection Item 1", "2/10/2026", "€9821"], status: "active" as const },
    { id: "1808313292", cells: ["CIV-7292", "Tax Collection Item 2", "17/5/2026", "€13 392"], status: "pending" as const },
    { id: "1808316863", cells: ["CIV-1863", "Tax Collection Item 3", "4/12/2026", "€16 963"], status: "completed" as const },
    { id: "1808320434", cells: ["CIV-5434", "Tax Collection Item 4", "19/7/2026", "€20 534"], status: "warning" as const },
    { id: "1808324005", cells: ["CIV-9005", "Tax Collection Item 5", "6/2/2026", "€24 105"], status: "active" as const },
];
...
export default function CivicTechTaxCollectionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tax Collection</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Civic Tech • Tax Collection</p>
                    </div>
                </div>
