...
/* ═══ Civic Tech — Municipal Erp ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "1062", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "5", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1844", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1335163073", cells: ["CIV-5073", "Municipal Erp Item 1", "14/6/2026", "€13 173"], status: "active" as const },
    { id: "1335166644", cells: ["CIV-8644", "Municipal Erp Item 2", "1/1/2026", "€16 744"], status: "pending" as const },
    { id: "1335170215", cells: ["CIV-3215", "Municipal Erp Item 3", "16/8/2026", "€20 315"], status: "completed" as const },
    { id: "1335173786", cells: ["CIV-6786", "Municipal Erp Item 4", "3/3/2026", "€23 886"], status: "warning" as const },
    { id: "1335177357", cells: ["CIV-1357", "Municipal Erp Item 5", "18/10/2026", "€27 457"], status: "active" as const },
];
...
export default function CivicTechMunicipalErpPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Municipal Erp</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Civic Tech • Municipal Erp</p>
                    </div>
                </div>
