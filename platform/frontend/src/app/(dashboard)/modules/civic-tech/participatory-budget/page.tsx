...
/* ═══ Civic Tech — Participatory Budget ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "3653", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "202", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2169", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "87%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1248127670", cells: ["CIV-8670", "Participatory Budget Item 1", "7/3/2026", "€27 770"], status: "active" as const },
    { id: "1248131241", cells: ["CIV-3241", "Participatory Budget Item 2", "22/10/2026", "€31 341"], status: "pending" as const },
    { id: "1248134812", cells: ["CIV-6812", "Participatory Budget Item 3", "9/5/2026", "€34 912"], status: "completed" as const },
    { id: "1248138383", cells: ["CIV-1383", "Participatory Budget Item 4", "24/12/2026", "€38 483"], status: "warning" as const },
    { id: "1248141954", cells: ["CIV-4954", "Participatory Budget Item 5", "11/7/2026", "€42 054"], status: "active" as const },
];
...
export default function CivicTechParticipatoryBudgetPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Participatory Budget</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Civic Tech • Participatory Budget</p>
                    </div>
                </div>
