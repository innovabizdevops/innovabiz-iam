...
/* ═══ HealthTech AI — Genomics Ai ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total", value: "759", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "449", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "313", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1709808685", cells: ["HEA-7685", "Genomics Ai Item 1", "26/2/2026", "€8785"], status: "active" as const },
    { id: "1709812256", cells: ["HEA-2256", "Genomics Ai Item 2", "13/9/2026", "€12 356"], status: "pending" as const },
    { id: "1709815827", cells: ["HEA-5827", "Genomics Ai Item 3", "28/4/2026", "€15 927"], status: "completed" as const },
    { id: "1709819398", cells: ["HEA-9398", "Genomics Ai Item 4", "15/11/2026", "€19 498"], status: "warning" as const },
    { id: "1709822969", cells: ["HEA-3969", "Genomics Ai Item 5", "2/6/2026", "€23 069"], status: "active" as const },
];
...
export default function HealthtechAiGenomicsAiPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Genomics Ai</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">HealthTech AI • Genomics Ai</p>
                    </div>
                </div>
