...
/* ═══ HealthTech AI — Clinical Decision ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total", value: "911", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "163", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "559", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "98%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1818763231", cells: ["HEA-8231", "Clinical Decision Item 1", "20/8/2026", "€13 331"], status: "active" as const },
    { id: "1818766802", cells: ["HEA-2802", "Clinical Decision Item 2", "7/3/2026", "€16 902"], status: "pending" as const },
    { id: "1818770373", cells: ["HEA-6373", "Clinical Decision Item 3", "22/10/2026", "€20 473"], status: "completed" as const },
    { id: "1818773944", cells: ["HEA-9944", "Clinical Decision Item 4", "9/5/2026", "€24 044"], status: "warning" as const },
    { id: "1818777515", cells: ["HEA-4515", "Clinical Decision Item 5", "24/12/2026", "€27 615"], status: "active" as const },
];
...
export default function HealthtechAiClinicalDecisionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Clinical Decision</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">HealthTech AI • Clinical Decision</p>
                    </div>
                </div>
