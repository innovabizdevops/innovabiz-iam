...
/* ═══ HealthTech AI — Surgical Robot ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total", value: "3079", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "68", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2647", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1108938032", cells: ["HEA-4032", "Surgical Robot Item 1", "21/9/2026", "€38 132"], status: "active" as const },
    { id: "1108941603", cells: ["HEA-7603", "Surgical Robot Item 2", "8/4/2026", "€41 703"], status: "pending" as const },
    { id: "1108945174", cells: ["HEA-2174", "Surgical Robot Item 3", "23/11/2026", "€45 274"], status: "completed" as const },
    { id: "1108948745", cells: ["HEA-5745", "Surgical Robot Item 4", "10/6/2026", "€48 845"], status: "warning" as const },
    { id: "1108952316", cells: ["HEA-9316", "Surgical Robot Item 5", "25/1/2026", "€2416"], status: "active" as const },
];
...
export default function HealthtechAiSurgicalRobotPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Surgical Robot</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">HealthTech AI • Surgical Robot</p>
                    </div>
                </div>
