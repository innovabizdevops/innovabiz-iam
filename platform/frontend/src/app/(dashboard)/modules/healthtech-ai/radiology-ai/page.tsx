...
/* ═══ HealthTech AI — Radiology Ai ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total", value: "2024", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "262", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "494", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "666529538", cells: ["HEA-8538", "Radiology Ai Item 1", "11/3/2026", "€29 638"], status: "active" as const },
    { id: "666533109", cells: ["HEA-3109", "Radiology Ai Item 2", "26/10/2026", "€33 209"], status: "pending" as const },
    { id: "666536680", cells: ["HEA-6680", "Radiology Ai Item 3", "13/5/2026", "€36 780"], status: "completed" as const },
    { id: "666540251", cells: ["HEA-1251", "Radiology Ai Item 4", "28/12/2026", "€40 351"], status: "warning" as const },
    { id: "666543822", cells: ["HEA-4822", "Radiology Ai Item 5", "15/7/2026", "€43 922"], status: "active" as const },
];
...
export default function HealthtechAiRadiologyAiPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Radiology Ai</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">HealthTech AI • Radiology Ai</p>
                    </div>
                </div>
