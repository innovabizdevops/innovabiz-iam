...
/* ═══ HealthTech AI — Diagnostics Poc ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total", value: "1601", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "478", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "888", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2004321114", cells: ["HEA-4114", "Diagnostics Poc Item 1", "27/7/2026", "€21 214"], status: "active" as const },
    { id: "2004324685", cells: ["HEA-7685", "Diagnostics Poc Item 2", "14/2/2026", "€24 785"], status: "pending" as const },
    { id: "2004328256", cells: ["HEA-2256", "Diagnostics Poc Item 3", "1/9/2026", "€28 356"], status: "completed" as const },
    { id: "2004331827", cells: ["HEA-5827", "Diagnostics Poc Item 4", "16/4/2026", "€31 927"], status: "warning" as const },
    { id: "2004335398", cells: ["HEA-9398", "Diagnostics Poc Item 5", "3/11/2026", "€35 498"], status: "active" as const },
];
...
export default function HealthtechAiDiagnosticsPocPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Diagnostics Poc</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">HealthTech AI • Diagnostics Poc</p>
                    </div>
                </div>
