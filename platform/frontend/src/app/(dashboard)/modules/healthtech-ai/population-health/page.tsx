...
/* ═══ HealthTech AI — Population Health ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total", value: "1994", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "57", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "208", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "96%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "331313189", cells: ["HEA-6189", "Population Health Item 1", "26/6/2026", "€13 289"], status: "active" as const },
    { id: "331316760", cells: ["HEA-9760", "Population Health Item 2", "13/1/2026", "€16 860"], status: "pending" as const },
    { id: "331320331", cells: ["HEA-4331", "Population Health Item 3", "28/8/2026", "€20 431"], status: "completed" as const },
    { id: "331323902", cells: ["HEA-7902", "Population Health Item 4", "15/3/2026", "€24 002"], status: "warning" as const },
    { id: "331327473", cells: ["HEA-2473", "Population Health Item 5", "2/10/2026", "€27 573"], status: "active" as const },
];
...
export default function HealthtechAiPopulationHealthPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Population Health</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">HealthTech AI • Population Health</p>
                    </div>
                </div>
