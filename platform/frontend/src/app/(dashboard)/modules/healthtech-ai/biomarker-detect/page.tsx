...
/* ═══ HealthTech AI — Biomarker Detect ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total", value: "4866", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "255", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2312", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1094913323", cells: ["HEA-1323", "Biomarker Detect Item 1", "8/12/2026", "€13 423"], status: "active" as const },
    { id: "1094916894", cells: ["HEA-4894", "Biomarker Detect Item 2", "23/7/2026", "€16 994"], status: "pending" as const },
    { id: "1094920465", cells: ["HEA-8465", "Biomarker Detect Item 3", "10/2/2026", "€20 565"], status: "completed" as const },
    { id: "1094924036", cells: ["HEA-3036", "Biomarker Detect Item 4", "25/9/2026", "€24 136"], status: "warning" as const },
    { id: "1094927607", cells: ["HEA-6607", "Biomarker Detect Item 5", "12/4/2026", "€27 707"], status: "active" as const },
];
...
export default function HealthtechAiBiomarkerDetectPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Biomarker Detect</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">HealthTech AI • Biomarker Detect</p>
                    </div>
                </div>
