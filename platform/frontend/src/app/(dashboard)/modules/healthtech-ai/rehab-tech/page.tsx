...
/* ═══ HealthTech AI — Rehab Tech ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total", value: "1994", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "366", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "191", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "565385322", cells: ["HEA-6322", "Rehab Tech Item 1", "27/7/2026", "€35 422"], status: "active" as const },
    { id: "565388893", cells: ["HEA-9893", "Rehab Tech Item 2", "14/2/2026", "€38 993"], status: "pending" as const },
    { id: "565392464", cells: ["HEA-4464", "Rehab Tech Item 3", "1/9/2026", "€42 564"], status: "completed" as const },
    { id: "565396035", cells: ["HEA-8035", "Rehab Tech Item 4", "16/4/2026", "€46 135"], status: "warning" as const },
    { id: "565399606", cells: ["HEA-2606", "Rehab Tech Item 5", "3/11/2026", "€49 706"], status: "active" as const },
];
...
export default function HealthtechAiRehabTechPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Rehab Tech</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">HealthTech AI • Rehab Tech</p>
                    </div>
                </div>
