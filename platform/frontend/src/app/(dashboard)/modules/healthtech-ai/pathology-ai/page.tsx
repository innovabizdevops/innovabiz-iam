...
/* ═══ HealthTech AI — Pathology Ai ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total", value: "3890", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "81", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2999", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "928397517", cells: ["HEA-3517", "Pathology Ai Item 1", "6/10/2026", "€47 617"], status: "active" as const },
    { id: "928401088", cells: ["HEA-7088", "Pathology Ai Item 2", "21/5/2026", "€1188"], status: "pending" as const },
    { id: "928404659", cells: ["HEA-1659", "Pathology Ai Item 3", "8/12/2026", "€4759"], status: "completed" as const },
    { id: "928408230", cells: ["HEA-5230", "Pathology Ai Item 4", "23/7/2026", "€8330"], status: "warning" as const },
    { id: "928411801", cells: ["HEA-8801", "Pathology Ai Item 5", "10/2/2026", "€11 901"], status: "active" as const },
];
...
export default function HealthtechAiPathologyAiPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pathology Ai</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">HealthTech AI • Pathology Ai</p>
                    </div>
                </div>
