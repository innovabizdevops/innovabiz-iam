...
/* ═══ HealthTech AI — Drug Discovery Ai ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total", value: "572", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "194", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "762", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "77%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "988619470", cells: ["HEA-6470", "Drug Discovery Ai Item 1", "7/11/2026", "€19 570"], status: "active" as const },
    { id: "988623041", cells: ["HEA-1041", "Drug Discovery Ai Item 2", "22/6/2026", "€23 141"], status: "pending" as const },
    { id: "988626612", cells: ["HEA-4612", "Drug Discovery Ai Item 3", "9/1/2026", "€26 712"], status: "completed" as const },
    { id: "988630183", cells: ["HEA-8183", "Drug Discovery Ai Item 4", "24/8/2026", "€30 283"], status: "warning" as const },
    { id: "988633754", cells: ["HEA-2754", "Drug Discovery Ai Item 5", "11/3/2026", "€33 854"], status: "active" as const },
];
...
export default function HealthtechAiDrugDiscoveryAiPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Drug Discovery Ai</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">HealthTech AI • Drug Discovery Ai</p>
                    </div>
                </div>
