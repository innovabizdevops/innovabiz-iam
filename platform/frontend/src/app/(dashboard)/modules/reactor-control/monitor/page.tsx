...
const ACCENT = "#0e7490";
const MODULE = "Reactor Control";
const PAGE = "Reaction Monitor";
const KPIS = [{"l":"Total Reactor Control","v":"2.596","t":"-2.9%","d":"down"},{"l":"Reaction Monitor Ativos","v":"3.487","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"76.8%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"74","t":"+17.3%","d":"up"}];
const COLS = ["ID","Reaction Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reactor Control #001","Reactor Control #002","3.194","6.634","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Reactor Control #002","Reactor Control #003","5.711","4.687","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Reactor Control #003","Reactor Control #004","1.562","8.899","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Reactor Control #004","Reactor Control #005","5.874","6.244","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reactor Control #005","Reactor Control #001","1.642","3.613","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":778},{"label":"Fev","value":766},{"label":"Mar","value":596},{"label":"Abr","value":770},{"label":"Mai","value":512},{"label":"Jun","value":489},{"label":"Jul","value":564},{"label":"Ago","value":510},{"label":"Set","value":641},{"label":"Out","value":802},{"label":"Nov","value":714},{"label":"Dez","value":707}];
const MX = 802;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0e7490'}}>IoT</span></h1>
                </div>
