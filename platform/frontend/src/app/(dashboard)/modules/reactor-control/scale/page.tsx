...
const PAGE = "Scale Control";
const KPIS = [{"l":"Total Reactor Control","v":"1.534","t":"+10.6%","d":"up"},{"l":"Scale Control Ativos","v":"4.032","t":"+0.1%","d":"up"},{"l":"Eficiência (%)","v":"89.7%","t":"-2.3%","d":"down"},{"l":"Score Performance","v":"78","t":"-5.1%","d":"down"}];
const COLS = ["ID","Scale Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reactor Control #001","Reactor Control #002","7.786","8.166","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Reactor Control #002","Reactor Control #003","7.612","3.630","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Reactor Control #003","Reactor Control #004","5.690","4.709","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Reactor Control #004","Reactor Control #005","2.166","4.764","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reactor Control #005","Reactor Control #001","538","2.348","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1001},{"label":"Fev","value":1010},{"label":"Mar","value":716},{"label":"Abr","value":839},{"label":"Mai","value":729},{"label":"Jun","value":789},{"label":"Jul","value":874},{"label":"Ago","value":727},{"label":"Set","value":1029},{"label":"Out","value":750},{"label":"Nov","value":918},{"label":"Dez","value":750}];
const MX = 1029;
