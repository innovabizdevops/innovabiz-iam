...
const PAGE = "Temp Control";
const KPIS = [{"l":"Total Reactor Control","v":"3.550","t":"+13.8%","d":"up"},{"l":"Temp Control Ativos","v":"3.204","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"74.2%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"79","t":"-0.4%","d":"down"}];
const COLS = ["ID","Temp Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reactor Control #001","Reactor Control #002","8.700","6.657","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Reactor Control #002","Reactor Control #003","3.473","4.973","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Reactor Control #003","Reactor Control #004","5.983","8.394","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Reactor Control #004","Reactor Control #005","8.602","550","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reactor Control #005","Reactor Control #001","2.429","8.882","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":583},{"label":"Mar","value":471},{"label":"Abr","value":513},{"label":"Mai","value":454},{"label":"Jun","value":660},{"label":"Jul","value":752},{"label":"Ago","value":687},{"label":"Set","value":437},{"label":"Out","value":729},{"label":"Nov","value":762},{"label":"Dez","value":509}];
const MX = 762;
