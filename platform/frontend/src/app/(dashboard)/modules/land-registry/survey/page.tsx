...
const PAGE = "Survey Records";
const KPIS = [{"l":"Surveys Ativos","v":"7.833","t":"+13.9%","d":"up"},{"l":"Respostas/Semana","v":"1677","t":"+7.4%","d":"up"},{"l":"NPS Médio","v":"91","t":"-2.4%","d":"down"},{"l":"Taxa Resposta (%)","v":"86.7%","t":"+3.2%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","6.395","87","98.5%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","5.942","59","79.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","8.823","85","80.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","7.376","87","82.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","2.131","86","80.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":965},{"label":"Mar","value":920},{"label":"Abr","value":923},{"label":"Mai","value":983},{"label":"Jun","value":820},{"label":"Jul","value":892},{"label":"Ago","value":998},{"label":"Set","value":834},{"label":"Out","value":937},{"label":"Nov","value":875},{"label":"Dez","value":966}];
const MX = 998;
