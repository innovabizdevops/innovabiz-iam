...
const ACCENT = "#713f12";
const MODULE = "Land Registry";
const PAGE = "Parcel Register";
const KPIS = [{"l":"Total Land Registry","v":"531","t":"+3.9%","d":"up"},{"l":"Parcel Register Ativos","v":"5.432","t":"-1.8%","d":"down"},{"l":"Eficiência (%)","v":"68.5%","t":"+12.8%","d":"up"},{"l":"Score Performance","v":"87","t":"+17.1%","d":"up"}];
const COLS = ["ID","Parcel Register","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Land Registry #001","Land Registry #002","8.331","1.887","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Land Registry #002","Land Registry #003","533","3.801","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Land Registry #003","Land Registry #004","107","4.747","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Land Registry #004","Land Registry #005","3.521","3.611","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Land Registry #005","Land Registry #001","553","4.204","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":769},{"label":"Mar","value":895},{"label":"Abr","value":767},{"label":"Mai","value":639},{"label":"Jun","value":763},{"label":"Jul","value":621},{"label":"Ago","value":604},{"label":"Set","value":854},{"label":"Out","value":855},{"label":"Nov","value":650},{"label":"Dez","value":861}];
const MX = 895;
