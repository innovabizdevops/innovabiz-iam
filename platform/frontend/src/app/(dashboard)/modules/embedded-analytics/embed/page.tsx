...
const PAGE = "Embed Manager";
const KPIS = [{"l":"Dashboards Ativos","v":"4.117","t":"+10.8%","d":"up"},{"l":"Queries/Dia","v":"3069","t":"+12.5%","d":"up"},{"l":"Dados Processados (GB)","v":"3.965","t":"+7.1%","d":"up"},{"l":"Utilizadores Analytics","v":"5.042","t":"+5.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2641","2026-02-10","1.228","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4889","2026-02-06","7.259","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","991","2026-03-16","3.329","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3845","2026-02-10","194","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2350","2026-01-13","2.671","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":786},{"label":"Mar","value":513},{"label":"Abr","value":751},{"label":"Mai","value":706},{"label":"Jun","value":754},{"label":"Jul","value":789},{"label":"Ago","value":543},{"label":"Set","value":671},{"label":"Out","value":741},{"label":"Nov","value":693},{"label":"Dez","value":753}];
const MX = 789;
