...
const ACCENT = "#4338ca";
const MODULE = "Embedded Analytics";
const PAGE = "Report Builder";
const KPIS = [{"l":"Dashboards Ativos","v":"1.328","t":"+9.3%","d":"up"},{"l":"Queries/Dia","v":"1213","t":"+12.7%","d":"up"},{"l":"Dados Processados (GB)","v":"7.344","t":"+16.8%","d":"up"},{"l":"Utilizadores Analytics","v":"556","t":"+13.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2558","2026-03-28","7.050","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1842","2026-01-12","6.115","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1414","2026-03-07","342","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2791","2026-03-13","8.681","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3781","2026-03-13","6.462","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":670},{"label":"Mar","value":729},{"label":"Abr","value":533},{"label":"Mai","value":554},{"label":"Jun","value":467},{"label":"Jul","value":614},{"label":"Ago","value":578},{"label":"Set","value":459},{"label":"Out","value":597},{"label":"Nov","value":489},{"label":"Dez","value":683}];
const MX = 729;
