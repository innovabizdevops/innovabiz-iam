...
const KPIS = [{"l":"Dashboards Ativos","v":"3.804","t":"+10.4%","d":"up"},{"l":"Queries/Dia","v":"2888","t":"+13.3%","d":"up"},{"l":"Dados Processados (GB)","v":"8.693","t":"+2.9%","d":"up"},{"l":"Utilizadores Analytics","v":"8.737","t":"+12.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4451","2026-03-06","4.097","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4271","2026-01-12","7.847","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1093","2026-01-19","8.806","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1581","2026-03-12","7.240","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2990","2026-01-25","3.089","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":750},{"label":"Mar","value":684},{"label":"Abr","value":753},{"label":"Mai","value":765},{"label":"Jun","value":622},{"label":"Jul","value":440},{"label":"Ago","value":473},{"label":"Set","value":449},{"label":"Out","value":499},{"label":"Nov","value":771},{"label":"Dez","value":602}];
const MX = 771;
