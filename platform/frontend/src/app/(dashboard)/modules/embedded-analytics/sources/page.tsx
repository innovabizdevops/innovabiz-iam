...
const PAGE = "Data Sources";
const KPIS = [{"l":"Dashboards Ativos","v":"5.549","t":"+8.8%","d":"up"},{"l":"Queries/Dia","v":"859","t":"+10.9%","d":"up"},{"l":"Dados Processados (GB)","v":"7.888","t":"+11.2%","d":"up"},{"l":"Utilizadores Analytics","v":"3.057","t":"+7.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","633","2026-02-27","1.745","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","533","2026-03-24","8.428","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","432","2026-03-23","6.980","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2733","2026-02-18","8.171","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4595","2026-03-13","680","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":442},{"label":"Mar","value":530},{"label":"Abr","value":495},{"label":"Mai","value":493},{"label":"Jun","value":490},{"label":"Jul","value":427},{"label":"Ago","value":476},{"label":"Set","value":611},{"label":"Out","value":370},{"label":"Nov","value":469},{"label":"Dez","value":718}];
const MX = 718;
