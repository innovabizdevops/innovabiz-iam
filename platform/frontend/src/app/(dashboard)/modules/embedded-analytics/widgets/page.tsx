...
const PAGE = "Custom Widgets";
const KPIS = [{"l":"Dashboards Ativos","v":"6.446","t":"-4.2%","d":"down"},{"l":"Queries/Dia","v":"1281","t":"-4.8%","d":"down"},{"l":"Dados Processados (GB)","v":"874","t":"+16.5%","d":"up"},{"l":"Utilizadores Analytics","v":"5.398","t":"-2.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3678","2026-02-07","1.500","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4132","2026-02-16","8.322","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4478","2026-01-20","2.097","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3446","2026-03-12","5.799","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3381","2026-01-08","5.696","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":668},{"label":"Mar","value":919},{"label":"Abr","value":841},{"label":"Mai","value":567},{"label":"Jun","value":534},{"label":"Jul","value":765},{"label":"Ago","value":821},{"label":"Set","value":569},{"label":"Out","value":706},{"label":"Nov","value":586},{"label":"Dez","value":561}];
const MX = 919;
