...
const ACCENT = "#e11d48";
const MODULE = "Genealogy Services";
const PAGE = "Research";
const KPIS = [{"l":"Ideias Submetidas","v":"5.577","t":"+13.5%","d":"up"},{"l":"Patentes (YTD)","v":"298","t":"+9.7%","d":"up"},{"l":"Projetos Innovation Lab","v":"3.860","t":"+14.8%","d":"up"},{"l":"Budget I&D (€M)","v":"€46.9M","t":"-4.9%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.131","81.9%","405","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","5.851","72.0%","3.172","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","8.546","80.1%","9.044","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","1.377","77.2%","8.609","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","6.188","86.6%","5.023","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":445},{"label":"Mar","value":361},{"label":"Abr","value":303},{"label":"Mai","value":480},{"label":"Jun","value":284},{"label":"Jul","value":273},{"label":"Ago","value":537},{"label":"Set","value":231},{"label":"Out","value":293},{"label":"Nov","value":385},{"label":"Dez","value":384}];
const MX = 547;
