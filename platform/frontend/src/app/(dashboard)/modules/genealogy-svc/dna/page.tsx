...
const PAGE = "DNA";
const KPIS = [{"l":"Total Genealogy Svc","v":"5.211","t":"+9.2%","d":"up"},{"l":"DNA Ativos","v":"4.971","t":"+7.5%","d":"up"},{"l":"Eficiência (%)","v":"91.8%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"73","t":"+11.1%","d":"up"}];
const COLS = ["ID","DNA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genealogy Svc #001","Genealogy Svc #002","7.608","722","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Genealogy Svc #002","Genealogy Svc #003","6.879","5.602","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Genealogy Svc #003","Genealogy Svc #004","454","840","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Genealogy Svc #004","Genealogy Svc #005","1.096","2.489","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genealogy Svc #005","Genealogy Svc #001","135","2.296","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1018},{"label":"Fev","value":1071},{"label":"Mar","value":1056},{"label":"Abr","value":1014},{"label":"Mai","value":1010},{"label":"Jun","value":1055},{"label":"Jul","value":1087},{"label":"Ago","value":1042},{"label":"Set","value":707},{"label":"Out","value":961},{"label":"Nov","value":966},{"label":"Dez","value":759}];
const MX = 1087;
