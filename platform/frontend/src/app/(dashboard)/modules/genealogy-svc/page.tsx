...
/* ═══ Genealogy Services — Dashboard ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total Registos", value: "6517", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3608", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€103K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "343724517", cells: ["GEN-6517", "Genealogy Services Item 1", "18/10/2026", "€24 617"], status: "active" as const },
    { id: "343728088", cells: ["GEN-1088", "Genealogy Services Item 2", "5/5/2026", "€28 188"], status: "pending" as const },
    { id: "343731659", cells: ["GEN-4659", "Genealogy Services Item 3", "20/12/2026", "€31 759"], status: "completed" as const },
    { id: "343735230", cells: ["GEN-8230", "Genealogy Services Item 4", "7/7/2026", "€35 330"], status: "warning" as const },
    { id: "343738801", cells: ["GEN-2801", "Genealogy Services Item 5", "22/2/2026", "€38 901"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Genealogy Services</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Genealogy Services</p>
                    </div>
                </div>
