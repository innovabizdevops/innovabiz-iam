...
const PAGE = "Record";
const KPIS = [{"l":"Total Genealogy Svc","v":"8.172","t":"+11.8%","d":"up"},{"l":"Record Ativos","v":"3.960","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"71.8%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"76","t":"-1.6%","d":"down"}];
const COLS = ["ID","Record","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genealogy Svc #001","Genealogy Svc #002","5.954","7.742","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Genealogy Svc #002","Genealogy Svc #003","8.016","2.869","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Genealogy Svc #003","Genealogy Svc #004","5.359","8.508","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Genealogy Svc #004","Genealogy Svc #005","5.017","5.608","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genealogy Svc #005","Genealogy Svc #001","7.227","2.781","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":324},{"label":"Mar","value":411},{"label":"Abr","value":529},{"label":"Mai","value":632},{"label":"Jun","value":491},{"label":"Jul","value":436},{"label":"Ago","value":547},{"label":"Set","value":414},{"label":"Out","value":357},{"label":"Nov","value":600},{"label":"Dez","value":442}];
const MX = 632;
