...
const PAGE = "Tree";
const KPIS = [{"l":"Total Genealogy Svc","v":"5.696","t":"+1.9%","d":"up"},{"l":"Tree Ativos","v":"175","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"77.8%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"78","t":"+13.1%","d":"up"}];
const COLS = ["ID","Tree","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genealogy Svc #001","Genealogy Svc #002","923","716","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Genealogy Svc #002","Genealogy Svc #003","492","6.383","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Genealogy Svc #003","Genealogy Svc #004","4.066","2.309","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Genealogy Svc #004","Genealogy Svc #005","4.600","5.975","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genealogy Svc #005","Genealogy Svc #001","1.683","5.732","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":802},{"label":"Mar","value":757},{"label":"Abr","value":886},{"label":"Mai","value":664},{"label":"Jun","value":681},{"label":"Jul","value":635},{"label":"Ago","value":634},{"label":"Set","value":747},{"label":"Out","value":764},{"label":"Nov","value":808},{"label":"Dez","value":539}];
const MX = 886;
