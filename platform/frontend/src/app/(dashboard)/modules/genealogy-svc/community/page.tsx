...
const KPIS = [{"l":"Projetos Sociais","v":"4.473","t":"+3.6%","d":"up"},{"l":"Beneficiários","v":"131","t":"+5.2%","d":"up"},{"l":"Investimento CSR (€)","v":"€2964","t":"+7.7%","d":"up"},{"l":"Score Impacto","v":"86","t":"-5.5%","d":"down"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","2.043","€ 21306.43","6.465","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.967","€ 28190.44","6.429","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","5.436","€ 23172.51","195","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","8.849","€ 28388.67","6.850","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","6.562","€ 24154.39","7.066","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":378},{"label":"Fev","value":307},{"label":"Mar","value":546},{"label":"Abr","value":510},{"label":"Mai","value":581},{"label":"Jun","value":579},{"label":"Jul","value":609},{"label":"Ago","value":383},{"label":"Set","value":419},{"label":"Out","value":279},{"label":"Nov","value":523},{"label":"Dez","value":572}];
const MX = 609;
