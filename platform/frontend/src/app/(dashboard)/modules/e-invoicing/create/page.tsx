...
const PAGE = "Create";
const KPIS = [{"l":"Total E Invoicing","v":"6.242","t":"+16.5%","d":"up"},{"l":"Create Ativos","v":"5.024","t":"+1.8%","d":"up"},{"l":"Eficiência (%)","v":"94.8%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"63","t":"+16.7%","d":"up"}];
const COLS = ["ID","Create","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["E Invoicing #001","E Invoicing #002","848","1.211","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["E Invoicing #002","E Invoicing #003","4.394","6.724","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["E Invoicing #003","E Invoicing #004","151","1.854","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["E Invoicing #004","E Invoicing #005","1.972","7.128","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["E Invoicing #005","E Invoicing #001","3.109","2.088","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":716},{"label":"Mar","value":449},{"label":"Abr","value":484},{"label":"Mai","value":782},{"label":"Jun","value":475},{"label":"Jul","value":518},{"label":"Ago","value":806},{"label":"Set","value":736},{"label":"Out","value":734},{"label":"Nov","value":572},{"label":"Dez","value":546}];
const MX = 806;
