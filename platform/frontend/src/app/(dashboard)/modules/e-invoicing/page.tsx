...
/* ═══ E-Invoicing Platform — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "9275", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3927", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€139K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "441945175", cells: ["E-1175", "E-Invoicing Platform Item 1", "8/8/2026", "€45 275"], status: "active" as const },
    { id: "441948746", cells: ["E-4746", "E-Invoicing Platform Item 2", "23/3/2026", "€48 846"], status: "pending" as const },
    { id: "441952317", cells: ["E-8317", "E-Invoicing Platform Item 3", "10/10/2026", "€2417"], status: "completed" as const },
    { id: "441955888", cells: ["E-2888", "E-Invoicing Platform Item 4", "25/5/2026", "€5988"], status: "warning" as const },
    { id: "441959459", cells: ["E-6459", "E-Invoicing Platform Item 5", "12/12/2026", "€9559"], status: "active" as const },
];
...
export default function EinvoicingPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">E-Invoicing Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • E-Invoicing Platform</p>
                    </div>
                </div>
