...
const ACCENT = "#0d9488";
const MODULE = "E-Invoicing Platform";
const PAGE = "Validate";
const KPIS = [{"l":"Total E Invoicing","v":"4.278","t":"+10.7%","d":"up"},{"l":"Validate Ativos","v":"4.398","t":"-5.3%","d":"down"},{"l":"Eficiência (%)","v":"76.7%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"57","t":"+11.5%","d":"up"}];
const COLS = ["ID","Validate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["E Invoicing #001","E Invoicing #002","3.165","6.935","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["E Invoicing #002","E Invoicing #003","4.897","4.108","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["E Invoicing #003","E Invoicing #004","291","8.337","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["E Invoicing #004","E Invoicing #005","7.855","5.083","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["E Invoicing #005","E Invoicing #001","2.217","2.186","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":912},{"label":"Fev","value":953},{"label":"Mar","value":686},{"label":"Abr","value":917},{"label":"Mai","value":689},{"label":"Jun","value":1024},{"label":"Jul","value":804},{"label":"Ago","value":747},{"label":"Set","value":740},{"label":"Out","value":1045},{"label":"Nov","value":821},{"label":"Dez","value":945}];
const MX = 1045;
