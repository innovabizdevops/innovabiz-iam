...
const KPIS = [{"l":"eNPS","v":"79","t":"+10.6%","d":"up"},{"l":"Engagement (%)","v":"92.1%","t":"+2.8%","d":"up"},{"l":"Turnover (%)","v":"87.2%","t":"+7.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.203","t":"-4.6%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.164","2026-01-09","65","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.682","2026-02-21","74","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.841","2026-03-21","80","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","9.079","2026-01-11","60","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.266","2026-02-16","57","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":624},{"label":"Mar","value":395},{"label":"Abr","value":678},{"label":"Mai","value":388},{"label":"Jun","value":447},{"label":"Jul","value":624},{"label":"Ago","value":714},{"label":"Set","value":513},{"label":"Out","value":373},{"label":"Nov","value":609},{"label":"Dez","value":566}];
const MX = 714;
