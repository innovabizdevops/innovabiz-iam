...
const KPIS = [{"l":"eNPS","v":"74","t":"+0.7%","d":"up"},{"l":"Engagement (%)","v":"90.1%","t":"-5.8%","d":"down"},{"l":"Turnover (%)","v":"91.5%","t":"+15.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.748","t":"-0.6%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.047","2026-02-07","75","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","9.044","2026-01-07","64","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.842","2026-02-12","82","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","946","2026-01-16","91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","389","2026-02-07","86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":875},{"label":"Mar","value":890},{"label":"Abr","value":868},{"label":"Mai","value":819},{"label":"Jun","value":703},{"label":"Jul","value":699},{"label":"Ago","value":831},{"label":"Set","value":751},{"label":"Out","value":802},{"label":"Nov","value":858},{"label":"Dez","value":795}];
const MX = 890;
