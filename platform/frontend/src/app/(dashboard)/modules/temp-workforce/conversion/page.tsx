...
const ACCENT = "#0e7490";
const MODULE = "Temp Workforce Mgmt";
const PAGE = "Conversion";
const KPIS = [{"l":"eNPS","v":"74","t":"+14.0%","d":"up"},{"l":"Engagement (%)","v":"72.7%","t":"+10.0%","d":"up"},{"l":"Turnover (%)","v":"80.7%","t":"+0.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"726","t":"+10.1%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.880","2026-03-21","55","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.356","2026-03-04","77","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.622","2026-03-12","74","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.087","2026-03-20","84","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.628","2026-03-27","59","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":326},{"label":"Fev","value":433},{"label":"Mar","value":576},{"label":"Abr","value":561},{"label":"Mai","value":374},{"label":"Jun","value":641},{"label":"Jul","value":420},{"label":"Ago","value":430},{"label":"Set","value":586},{"label":"Out","value":413},{"label":"Nov","value":330},{"label":"Dez","value":405}];
const MX = 641;
