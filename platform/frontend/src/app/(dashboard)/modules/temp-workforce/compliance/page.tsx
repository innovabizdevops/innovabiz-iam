...
const KPIS = [{"l":"Auditorias Realizadas","v":"5.701","t":"-0.3%","d":"down"},{"l":"NC Abertas","v":"1.383","t":"+10.0%","d":"up"},{"l":"Conformidade (%)","v":"69.9%","t":"-2.9%","d":"down"},{"l":"CAPAs Pendentes","v":"2.158","t":"+2.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.010","94.8%","1.420","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.734","84.3%","769","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","774","87.3%","5.489","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.834","75.3%","5.263","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.837","87.1%","3.505","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":642},{"label":"Mar","value":855},{"label":"Abr","value":844},{"label":"Mai","value":689},{"label":"Jun","value":914},{"label":"Jul","value":742},{"label":"Ago","value":929},{"label":"Set","value":802},{"label":"Out","value":743},{"label":"Nov","value":665},{"label":"Dez","value":687}];
const MX = 929;
