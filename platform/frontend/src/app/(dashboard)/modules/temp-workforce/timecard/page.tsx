...
const PAGE = "Timecard";
const KPIS = [{"l":"eNPS","v":"92","t":"-0.5%","d":"down"},{"l":"Engagement (%)","v":"74.1%","t":"-0.5%","d":"down"},{"l":"Turnover (%)","v":"70.7%","t":"+13.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.960","t":"-3.2%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.703","2026-03-12","87","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.564","2026-01-18","88","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.276","2026-03-03","69","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.749","2026-03-07","84","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.881","2026-03-26","82","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":822},{"label":"Fev","value":1037},{"label":"Mar","value":691},{"label":"Abr","value":681},{"label":"Mai","value":792},{"label":"Jun","value":778},{"label":"Jul","value":1000},{"label":"Ago","value":867},{"label":"Set","value":954},{"label":"Out","value":1044},{"label":"Nov","value":836},{"label":"Dez","value":1015}];
const MX = 1044;
