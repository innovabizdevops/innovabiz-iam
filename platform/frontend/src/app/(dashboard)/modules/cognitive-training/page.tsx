...
/* ═══ Cognitive Training Hub — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "5572", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2997", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€106K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "-5%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1732356972", cells: ["COG-1972", "Cognitive Training Hub Item 1", "25/1/2026", "€7072"], status: "active" as const },
    { id: "1732360543", cells: ["COG-5543", "Cognitive Training Hub Item 2", "12/8/2026", "€10 643"], status: "pending" as const },
    { id: "1732364114", cells: ["COG-9114", "Cognitive Training Hub Item 3", "27/3/2026", "€14 214"], status: "completed" as const },
    { id: "1732367685", cells: ["COG-3685", "Cognitive Training Hub Item 4", "14/10/2026", "€17 785"], status: "warning" as const },
    { id: "1732371256", cells: ["COG-7256", "Cognitive Training Hub Item 5", "1/5/2026", "€21 356"], status: "active" as const },
];
...
export default function CognitiveTrainingHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cognitive Training Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cognitive Training Hub</p>
                    </div>
                </div>
