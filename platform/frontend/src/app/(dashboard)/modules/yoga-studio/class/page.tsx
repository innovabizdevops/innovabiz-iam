...
const PAGE = "Class";
const KPIS = [{"l":"Total Yoga Studio","v":"2.783","t":"-3.1%","d":"down"},{"l":"Class Ativos","v":"4.687","t":"+6.6%","d":"up"},{"l":"Eficiência (%)","v":"79.7%","t":"+13.2%","d":"up"},{"l":"Score Performance","v":"59","t":"+11.3%","d":"up"}];
const COLS = ["ID","Class","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Yoga Studio #001","Yoga Studio #002","4.541","710","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Yoga Studio #002","Yoga Studio #003","5.198","2.346","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Yoga Studio #003","Yoga Studio #004","5.161","106","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Yoga Studio #004","Yoga Studio #005","7.571","4.063","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Yoga Studio #005","Yoga Studio #001","5.073","2.706","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":698},{"label":"Mar","value":666},{"label":"Abr","value":753},{"label":"Mai","value":908},{"label":"Jun","value":543},{"label":"Jul","value":678},{"label":"Ago","value":779},{"label":"Set","value":810},{"label":"Out","value":899},{"label":"Nov","value":861},{"label":"Dez","value":662}];
const MX = 908;
