...
const PAGE = "Wellness";
const KPIS = [{"l":"Total Yoga Studio","v":"5.914","t":"+1.1%","d":"up"},{"l":"Wellness Ativos","v":"6.390","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"79.7%","t":"+4.8%","d":"up"},{"l":"Score Performance","v":"83","t":"+8.3%","d":"up"}];
const COLS = ["ID","Wellness","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Yoga Studio #001","Yoga Studio #002","7.157","5.465","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Yoga Studio #002","Yoga Studio #003","1.708","2.970","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Yoga Studio #003","Yoga Studio #004","6.363","2.200","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Yoga Studio #004","Yoga Studio #005","5.720","3.727","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Yoga Studio #005","Yoga Studio #001","7.930","6.561","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":413},{"label":"Mar","value":489},{"label":"Abr","value":220},{"label":"Mai","value":549},{"label":"Jun","value":271},{"label":"Jul","value":224},{"label":"Ago","value":493},{"label":"Set","value":248},{"label":"Out","value":393},{"label":"Nov","value":557},{"label":"Dez","value":377}];
const MX = 557;
