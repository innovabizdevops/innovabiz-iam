...
const ACCENT = "#6366f1";
const MODULE = "Yoga Studio";
const PAGE = "Retreats";
const KPIS = [{"l":"Total Yoga Studio","v":"4.533","t":"+8.8%","d":"up"},{"l":"Retreats Ativos","v":"5.094","t":"-1.8%","d":"down"},{"l":"Eficiência (%)","v":"74.9%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"74","t":"-2.1%","d":"down"}];
const COLS = ["ID","Retreats","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Yoga Studio #001","Yoga Studio #002","899","6.972","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Yoga Studio #002","Yoga Studio #003","7.545","6.670","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Yoga Studio #003","Yoga Studio #004","4.673","3.403","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Yoga Studio #004","Yoga Studio #005","6.635","3.385","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Yoga Studio #005","Yoga Studio #001","2.041","4.747","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":686},{"label":"Mar","value":644},{"label":"Abr","value":316},{"label":"Mai","value":538},{"label":"Jun","value":617},{"label":"Jul","value":440},{"label":"Ago","value":494},{"label":"Set","value":431},{"label":"Out","value":420},{"label":"Nov","value":502},{"label":"Dez","value":358}];
const MX = 686;
