...
const KPIS = [{"l":"Total Yoga Studio","v":"2.876","t":"+4.0%","d":"up"},{"l":"Instructor Ativos","v":"3.967","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"76.0%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"79","t":"+6.1%","d":"up"}];
const COLS = ["ID","Instructor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Yoga Studio #001","Yoga Studio #002","1.509","8.551","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Yoga Studio #002","Yoga Studio #003","6.058","6.706","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Yoga Studio #003","Yoga Studio #004","6.147","3.460","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Yoga Studio #004","Yoga Studio #005","4.455","6.872","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Yoga Studio #005","Yoga Studio #001","4.784","7.579","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":477},{"label":"Fev","value":751},{"label":"Mar","value":693},{"label":"Abr","value":486},{"label":"Mai","value":789},{"label":"Jun","value":555},{"label":"Jul","value":722},{"label":"Ago","value":733},{"label":"Set","value":692},{"label":"Out","value":639},{"label":"Nov","value":493},{"label":"Dez","value":793}];
const MX = 793;
