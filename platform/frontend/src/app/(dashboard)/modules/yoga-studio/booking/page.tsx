...
const PAGE = "Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"1.550","t":"-5.1%","d":"down"},{"l":"RevPAR (€)","v":"€95984","t":"+8.3%","d":"up"},{"l":"Ocupação (%)","v":"87.9%","t":"+4.3%","d":"up"},{"l":"Guest Satisfaction","v":"5.868","t":"+7.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","5.394","2026-01-10","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","2.614","2026-01-21","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.128","2026-02-10","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","8.870","2026-02-07","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","675","2026-01-13","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":985},{"label":"Fev","value":959},{"label":"Mar","value":904},{"label":"Abr","value":881},{"label":"Mai","value":728},{"label":"Jun","value":746},{"label":"Jul","value":915},{"label":"Ago","value":862},{"label":"Set","value":711},{"label":"Out","value":666},{"label":"Nov","value":1024},{"label":"Dez","value":706}];
const MX = 1024;
