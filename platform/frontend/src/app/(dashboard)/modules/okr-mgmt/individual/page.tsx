...
const PAGE = "Individual";
const KPIS = [{"l":"Total Okr Mgmt","v":"2.698","t":"+8.3%","d":"up"},{"l":"Individual Ativos","v":"8.610","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"85.0%","t":"+15.2%","d":"up"},{"l":"Score Performance","v":"89","t":"+15.1%","d":"up"}];
const COLS = ["ID","Individual","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Okr Mgmt #001","Okr Mgmt #002","4.552","8.595","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Okr Mgmt #002","Okr Mgmt #003","1.404","8.403","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Okr Mgmt #003","Okr Mgmt #004","6.480","2.744","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Okr Mgmt #004","Okr Mgmt #005","8.914","7.644","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Okr Mgmt #005","Okr Mgmt #001","8.415","4.279","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":315},{"label":"Mar","value":435},{"label":"Abr","value":540},{"label":"Mai","value":405},{"label":"Jun","value":438},{"label":"Jul","value":400},{"label":"Ago","value":543},{"label":"Set","value":517},{"label":"Out","value":551},{"label":"Nov","value":308},{"label":"Dez","value":459}];
const MX = 551;
