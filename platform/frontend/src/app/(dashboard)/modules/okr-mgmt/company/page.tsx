...
const PAGE = "Company OKRs";
const KPIS = [{"l":"Total Okr Mgmt","v":"1.491","t":"+10.9%","d":"up"},{"l":"Company OKRs Ativos","v":"3.745","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"94.2%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"72","t":"-3.8%","d":"down"}];
const COLS = ["ID","Company OKRs","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Okr Mgmt #001","Okr Mgmt #002","8.199","224","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Okr Mgmt #002","Okr Mgmt #003","183","7.618","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Okr Mgmt #003","Okr Mgmt #004","5.115","3.001","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Okr Mgmt #004","Okr Mgmt #005","6.088","888","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Okr Mgmt #005","Okr Mgmt #001","3.660","2.332","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":288},{"label":"Fev","value":463},{"label":"Mar","value":444},{"label":"Abr","value":475},{"label":"Mai","value":659},{"label":"Jun","value":592},{"label":"Jul","value":501},{"label":"Ago","value":350},{"label":"Set","value":562},{"label":"Out","value":432},{"label":"Nov","value":665},{"label":"Dez","value":369}];
const MX = 665;
