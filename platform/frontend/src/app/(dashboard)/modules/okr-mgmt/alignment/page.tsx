...
const ACCENT = "#dc2626";
const MODULE = "OKR Management";
const PAGE = "Alignment View";
const KPIS = [{"l":"Total Okr Mgmt","v":"2.568","t":"-1.4%","d":"down"},{"l":"Alignment View Ativos","v":"4.073","t":"+13.1%","d":"up"},{"l":"Eficiência (%)","v":"77.6%","t":"-2.3%","d":"down"},{"l":"Score Performance","v":"92","t":"+14.9%","d":"up"}];
const COLS = ["ID","Alignment View","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Okr Mgmt #001","Okr Mgmt #002","4.342","7.476","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Okr Mgmt #002","Okr Mgmt #003","2.237","4.755","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Okr Mgmt #003","Okr Mgmt #004","2.784","631","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Okr Mgmt #004","Okr Mgmt #005","9.096","7.659","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Okr Mgmt #005","Okr Mgmt #001","8.097","7.850","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":925},{"label":"Fev","value":623},{"label":"Mar","value":814},{"label":"Abr","value":771},{"label":"Mai","value":980},{"label":"Jun","value":922},{"label":"Jul","value":798},{"label":"Ago","value":611},{"label":"Set","value":742},{"label":"Out","value":948},{"label":"Nov","value":941},{"label":"Dez","value":669}];
const MX = 980;
