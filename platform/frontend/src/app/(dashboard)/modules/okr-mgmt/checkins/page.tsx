...
const PAGE = "Check-Ins";
const KPIS = [{"l":"Total Okr Mgmt","v":"8.496","t":"+3.3%","d":"up"},{"l":"Check Ins Ativos","v":"286","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"78.0%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"71","t":"+15.0%","d":"up"}];
const COLS = ["ID","Check Ins","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Okr Mgmt #001","2026-02-07","7.075","2.115","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Okr Mgmt #002","2026-01-06","8.050","2.150","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Okr Mgmt #003","2026-02-09","6.915","4.455","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Okr Mgmt #004","2026-02-03","5.609","8.766","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Okr Mgmt #005","2026-01-02","267","4.124","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":831},{"label":"Fev","value":733},{"label":"Mar","value":949},{"label":"Abr","value":905},{"label":"Mai","value":858},{"label":"Jun","value":813},{"label":"Jul","value":705},{"label":"Ago","value":868},{"label":"Set","value":752},{"label":"Out","value":900},{"label":"Nov","value":835},{"label":"Dez","value":697}];
const MX = 949;
