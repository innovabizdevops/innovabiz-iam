...
const PAGE = "Team OKRs";
const KPIS = [{"l":"Teams Ativos","v":"7.455","t":"+5.2%","d":"up"},{"l":"Reuniões/Semana","v":"973","t":"+13.9%","d":"up"},{"l":"Mensagens/Dia","v":"3267","t":"+1.0%","d":"up"},{"l":"Ficheiros Partilhados","v":"8.755","t":"+14.9%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.186","4154","5.270","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","200","2823","7.310","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","119","2973","1.032","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.052","4427","7.361","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","6.337","1007","8.783","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":818},{"label":"Mar","value":1061},{"label":"Abr","value":839},{"label":"Mai","value":968},{"label":"Jun","value":962},{"label":"Jul","value":892},{"label":"Ago","value":929},{"label":"Set","value":718},{"label":"Out","value":723},{"label":"Nov","value":989},{"label":"Dez","value":1018}];
const MX = 1061;
