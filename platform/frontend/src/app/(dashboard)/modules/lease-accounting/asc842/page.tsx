...
const PAGE = "ASC 842";
const KPIS = [{"l":"Total Lease Accounting","v":"7.167","t":"+15.3%","d":"up"},{"l":"ASC 842 Ativos","v":"282","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"77.4%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"72","t":"+12.8%","d":"up"}];
const COLS = ["ID","ASC 842","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lease Accounting #001","Lease Accounting #002","1.619","5.704","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Lease Accounting #002","Lease Accounting #003","5.165","8.741","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Lease Accounting #003","Lease Accounting #004","5.391","8.052","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Lease Accounting #004","Lease Accounting #005","4.544","3.252","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lease Accounting #005","Lease Accounting #001","8.679","1.200","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":785},{"label":"Mar","value":829},{"label":"Abr","value":846},{"label":"Mai","value":595},{"label":"Jun","value":710},{"label":"Jul","value":837},{"label":"Ago","value":931},{"label":"Set","value":591},{"label":"Out","value":671},{"label":"Nov","value":743},{"label":"Dez","value":787}];
const MX = 931;
...
export default function Asc842Page() {
    return (
