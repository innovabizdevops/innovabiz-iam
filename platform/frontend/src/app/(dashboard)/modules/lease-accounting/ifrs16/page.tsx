...
const ACCENT = "#ea580c";
const MODULE = "Lease Accounting";
const PAGE = "IFRS 16";
const KPIS = [{"l":"Total Lease Accounting","v":"6.845","t":"+4.3%","d":"up"},{"l":"IFRS 16 Ativos","v":"4.111","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"76.5%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"60","t":"+12.5%","d":"up"}];
const COLS = ["ID","IFRS 16","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lease Accounting #001","Lease Accounting #002","3.983","2.370","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Lease Accounting #002","Lease Accounting #003","7.806","237","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Lease Accounting #003","Lease Accounting #004","8.104","4.531","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Lease Accounting #004","Lease Accounting #005","5.340","1.876","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lease Accounting #005","Lease Accounting #001","3.247","4.208","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":376},{"label":"Mar","value":671},{"label":"Abr","value":466},{"label":"Mai","value":560},{"label":"Jun","value":585},{"label":"Jul","value":397},{"label":"Ago","value":577},{"label":"Set","value":636},{"label":"Out","value":686},{"label":"Nov","value":353},{"label":"Dez","value":528}];
const MX = 686;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ea580c'}}>IFRS</span></h1>
                </div>
