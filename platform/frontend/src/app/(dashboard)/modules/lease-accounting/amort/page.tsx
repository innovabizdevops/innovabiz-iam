...
const PAGE = "Amortization";
const KPIS = [{"l":"Ativos Registados","v":"974","t":"+15.7%","d":"up"},{"l":"Valor Total (€M)","v":"€49.4M","t":"+16.9%","d":"up"},{"l":"Depreciação Anual (€)","v":"€65929","t":"+0.5%","d":"up"},{"l":"Ativos em Garantia","v":"6.132","t":"+0.8%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 45447.09","5.364","€ 34300.27","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 16735.64","3.817","€ 37331.18","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 6663.46","5.073","€ 8266.84","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 11644.45","4.829","€ 42503.62","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 3345.66","4.819","€ 39408.06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":380},{"label":"Fev","value":524},{"label":"Mar","value":558},{"label":"Abr","value":337},{"label":"Mai","value":278},{"label":"Jun","value":514},{"label":"Jul","value":379},{"label":"Ago","value":631},{"label":"Set","value":507},{"label":"Out","value":425},{"label":"Nov","value":621},{"label":"Dez","value":283}];
const MX = 631;
