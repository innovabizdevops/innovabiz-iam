...
const PAGE = "ROU Assets";
const KPIS = [{"l":"Ativos Registados","v":"3.841","t":"+5.5%","d":"up"},{"l":"Valor Total (€M)","v":"€27.1M","t":"+14.4%","d":"up"},{"l":"Depreciação Anual (€)","v":"€1706","t":"+3.7%","d":"up"},{"l":"Ativos em Garantia","v":"206","t":"+4.4%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 48062.03","2.044","€ 25462.52","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 32549.03","7.073","€ 46828.58","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 39939.65","2.861","€ 4793.53","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 2314.23","4.994","€ 13228.21","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 15497.37","4.931","€ 32094.57","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":876},{"label":"Fev","value":563},{"label":"Mar","value":527},{"label":"Abr","value":782},{"label":"Mai","value":816},{"label":"Jun","value":632},{"label":"Jul","value":755},{"label":"Ago","value":539},{"label":"Set","value":672},{"label":"Out","value":851},{"label":"Nov","value":686},{"label":"Dez","value":835}];
const MX = 876;
...
export default function RouPage() {
    return (
