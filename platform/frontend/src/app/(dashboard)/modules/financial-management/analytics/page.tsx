...
const PAGE = "Financial Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"5.744","t":"+9.8%","d":"up"},{"l":"Queries/Dia","v":"1484","t":"-5.4%","d":"down"},{"l":"Dados Processados (GB)","v":"7.435","t":"+0.9%","d":"up"},{"l":"Utilizadores Analytics","v":"3.011","t":"+8.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2302","2026-03-14","5.027","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","817","2026-01-10","2.032","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1759","2026-03-24","1.773","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4929","2026-01-27","3.768","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3033","2026-03-04","6.909","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":720},{"label":"Mar","value":731},{"label":"Abr","value":634},{"label":"Mai","value":471},{"label":"Jun","value":709},{"label":"Jul","value":570},{"label":"Ago","value":591},{"label":"Set","value":768},{"label":"Out","value":534},{"label":"Nov","value":584},{"label":"Dez","value":640}];
const MX = 768;
