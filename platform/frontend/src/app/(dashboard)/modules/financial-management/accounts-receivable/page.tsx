...
const PAGE = "Accounts Receivable";
const KPIS = [{"l":"Projetos Melhoria","v":"4.233","t":"+14.6%","d":"up"},{"l":"Savings (€)","v":"€97794","t":"+7.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"85.9%","t":"+14.8%","d":"up"},{"l":"Ciclos PDCA","v":"4.310","t":"+8.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.769","€ 20031.74","6.425","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.170","€ 23479.75","8.297","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.467","€ 24049.36","7.147","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.568","€ 31414.37","3.174","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.189","€ 18700.19","6.206","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":594},{"label":"Mar","value":789},{"label":"Abr","value":664},{"label":"Mai","value":564},{"label":"Jun","value":792},{"label":"Jul","value":470},{"label":"Ago","value":746},{"label":"Set","value":552},{"label":"Out","value":724},{"label":"Nov","value":651},{"label":"Dez","value":612}];
const MX = 792;
