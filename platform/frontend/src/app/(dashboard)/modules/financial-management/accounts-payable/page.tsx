...
const PAGE = "Accounts Payable";
const KPIS = [{"l":"Projetos Melhoria","v":"2.036","t":"+17.3%","d":"up"},{"l":"Savings (€)","v":"€81655","t":"-3.3%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"87.3%","t":"+1.8%","d":"up"},{"l":"Ciclos PDCA","v":"1.240","t":"+12.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.913","€ 19959.45","4.106","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.980","€ 31991.78","3.555","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","807","€ 14639.26","2.445","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.738","€ 30649.51","3.478","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.097","€ 29540.29","5.102","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1011},{"label":"Fev","value":968},{"label":"Mar","value":673},{"label":"Abr","value":718},{"label":"Mai","value":769},{"label":"Jun","value":1023},{"label":"Jul","value":756},{"label":"Ago","value":724},{"label":"Set","value":801},{"label":"Out","value":703},{"label":"Nov","value":1030},{"label":"Dez","value":746}];
const MX = 1030;
