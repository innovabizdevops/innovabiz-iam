...
const KPIS = [{"l":"Auditorias Realizadas","v":"208","t":"+11.5%","d":"up"},{"l":"NC Abertas","v":"5.994","t":"+14.9%","d":"up"},{"l":"Conformidade (%)","v":"69.7%","t":"-3.8%","d":"down"},{"l":"CAPAs Pendentes","v":"1.166","t":"+17.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.960","80.9%","8.648","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.886","86.8%","7.136","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","9.037","85.3%","2.387","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.187","78.8%","4.082","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.416","77.7%","1.497","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":828},{"label":"Mar","value":464},{"label":"Abr","value":533},{"label":"Mai","value":458},{"label":"Jun","value":602},{"label":"Jul","value":564},{"label":"Ago","value":468},{"label":"Set","value":603},{"label":"Out","value":509},{"label":"Nov","value":458},{"label":"Dez","value":602}];
const MX = 839;
...
export default function AuditTrailFinancePage() {
    return (
