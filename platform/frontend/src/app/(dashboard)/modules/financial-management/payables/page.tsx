...
const PAGE = "Payables";
const KPIS = [{"l":"Projetos Melhoria","v":"3.429","t":"-3.5%","d":"down"},{"l":"Savings (€)","v":"€83903","t":"+12.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"70.1%","t":"+4.1%","d":"up"},{"l":"Ciclos PDCA","v":"6.711","t":"+17.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.336","€ 3962.06","8.311","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","328","€ 15028.94","1.148","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","837","€ 33717.49","2.519","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","871","€ 14693.77","5.905","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.838","€ 46277.83","4.498","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":759},{"label":"Fev","value":711},{"label":"Mar","value":676},{"label":"Abr","value":468},{"label":"Mai","value":502},{"label":"Jun","value":767},{"label":"Jul","value":475},{"label":"Ago","value":490},{"label":"Set","value":775},{"label":"Out","value":535},{"label":"Nov","value":470},{"label":"Dez","value":801}];
const MX = 801;
