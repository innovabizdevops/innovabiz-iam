...
const KPIS = [{"l":"Projetos Melhoria","v":"8.522","t":"+14.6%","d":"up"},{"l":"Savings (€)","v":"€94682","t":"+11.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"67.4%","t":"+12.3%","d":"up"},{"l":"Ciclos PDCA","v":"2.892","t":"+6.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.457","€ 45491.54","8.159","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.343","€ 1396.54","6.552","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.046","€ 11713.33","6.052","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.083","€ 5012.24","5.744","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.951","€ 36950.88","8.677","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":782},{"label":"Fev","value":633},{"label":"Mar","value":731},{"label":"Abr","value":751},{"label":"Mai","value":964},{"label":"Jun","value":888},{"label":"Jul","value":653},{"label":"Ago","value":682},{"label":"Set","value":725},{"label":"Out","value":620},{"label":"Nov","value":954},{"label":"Dez","value":768}];
const MX = 964;
