...
const KPIS = [{"l":"Projetos Melhoria","v":"7.139","t":"+3.4%","d":"up"},{"l":"Savings (€)","v":"€11308","t":"+9.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"78.1%","t":"-1.5%","d":"down"},{"l":"Ciclos PDCA","v":"3.737","t":"-5.3%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","681","€ 47349.91","5.473","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.326","€ 721.80","1.280","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.752","€ 15045.62","5.094","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.785","€ 45189.15","513","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.177","€ 35270.60","6.476","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":645},{"label":"Mar","value":575},{"label":"Abr","value":786},{"label":"Mai","value":902},{"label":"Jun","value":610},{"label":"Jul","value":577},{"label":"Ago","value":658},{"label":"Set","value":848},{"label":"Out","value":616},{"label":"Nov","value":634},{"label":"Dez","value":759}];
const MX = 902;
