...
const PAGE = "Cash Flow Forecast AI";
const KPIS = [{"l":"Projetos Melhoria","v":"1.839","t":"+13.0%","d":"up"},{"l":"Savings (€)","v":"€53707","t":"+11.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"74.2%","t":"-1.0%","d":"down"},{"l":"Ciclos PDCA","v":"5.736","t":"+6.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.409","€ 41060.63","738","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.672","€ 47827.66","4.319","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.251","€ 26671.99","6.132","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","981","€ 21183.56","8.044","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.001","€ 28760.58","8.704","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":369},{"label":"Mar","value":511},{"label":"Abr","value":738},{"label":"Mai","value":641},{"label":"Jun","value":542},{"label":"Jul","value":513},{"label":"Ago","value":402},{"label":"Set","value":451},{"label":"Out","value":603},{"label":"Nov","value":767},{"label":"Dez","value":471}];
const MX = 767;
