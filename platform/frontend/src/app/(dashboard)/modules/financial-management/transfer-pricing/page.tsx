...
const PAGE = "Transfer Pricing";
const KPIS = [{"l":"ARR (€M)","v":"€8.3M","t":"+8.4%","d":"up"},{"l":"MRR (€)","v":"€83946","t":"-5.3%","d":"down"},{"l":"Churn (%)","v":"89.5%","t":"+11.6%","d":"up"},{"l":"ARPU (€)","v":"€84240","t":"-0.9%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 8314.62","8.905","€ 46818.59","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 22634.50","1.173","€ 30301.43","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 17221.84","4.615","€ 29753.47","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 15599.80","6.749","€ 40377.59","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 16840.22","2.482","€ 35338.07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":871},{"label":"Fev","value":645},{"label":"Mar","value":874},{"label":"Abr","value":782},{"label":"Mai","value":942},{"label":"Jun","value":967},{"label":"Jul","value":958},{"label":"Ago","value":898},{"label":"Set","value":737},{"label":"Out","value":807},{"label":"Nov","value":1006},{"label":"Dez","value":620}];
const MX = 1006;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>OECD</span></h1>
                </div>
