...
const PAGE = "Receivables";
const KPIS = [{"l":"Projetos Melhoria","v":"3.677","t":"-4.6%","d":"down"},{"l":"Savings (€)","v":"€34639","t":"+14.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"69.2%","t":"+4.7%","d":"up"},{"l":"Ciclos PDCA","v":"3.872","t":"-2.5%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.235","€ 47888.24","7.197","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.270","€ 5345.63","3.493","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","9.025","€ 3667.63","8.789","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","777","€ 14625.28","6.894","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.368","€ 33472.01","526","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":314},{"label":"Fev","value":293},{"label":"Mar","value":330},{"label":"Abr","value":375},{"label":"Mai","value":387},{"label":"Jun","value":544},{"label":"Jul","value":455},{"label":"Ago","value":481},{"label":"Set","value":607},{"label":"Out","value":553},{"label":"Nov","value":394},{"label":"Dez","value":454}];
const MX = 607;
