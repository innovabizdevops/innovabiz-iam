...
const KPIS = [{"l":"ARR (€M)","v":"€43.5M","t":"+11.1%","d":"up"},{"l":"MRR (€)","v":"€50944","t":"-0.4%","d":"down"},{"l":"Churn (%)","v":"86.1%","t":"+15.6%","d":"up"},{"l":"ARPU (€)","v":"€60837","t":"+8.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 49161.61","3.829","€ 19281.89","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 284.61","6.518","€ 37227.05","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 34205.01","2.044","€ 48562.90","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 12576.66","4.431","€ 31813.30","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 4843.79","3.611","€ 33676.73","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":776},{"label":"Fev","value":852},{"label":"Mar","value":1019},{"label":"Abr","value":921},{"label":"Mai","value":891},{"label":"Jun","value":888},{"label":"Jul","value":855},{"label":"Ago","value":668},{"label":"Set","value":948},{"label":"Out","value":1007},{"label":"Nov","value":656},{"label":"Dez","value":870}];
const MX = 1019;
