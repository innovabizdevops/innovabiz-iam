...
const PAGE = "Monetization";
const KPIS = [{"l":"ARR (€M)","v":"€3.3M","t":"+7.0%","d":"up"},{"l":"MRR (€)","v":"€33360","t":"+6.0%","d":"up"},{"l":"Churn (%)","v":"93.1%","t":"+8.7%","d":"up"},{"l":"ARPU (€)","v":"€56069","t":"+12.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 14459.59","484","€ 48269.55","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 13621.23","2.780","€ 15629.16","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 38314.26","7.412","€ 15214.75","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 11367.82","1.494","€ 33728.94","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 13929.07","2.922","€ 9097.03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":233},{"label":"Fev","value":566},{"label":"Mar","value":565},{"label":"Abr","value":456},{"label":"Mai","value":596},{"label":"Jun","value":501},{"label":"Jul","value":583},{"label":"Ago","value":420},{"label":"Set","value":528},{"label":"Out","value":255},{"label":"Nov","value":430},{"label":"Dez","value":545}];
const MX = 596;
