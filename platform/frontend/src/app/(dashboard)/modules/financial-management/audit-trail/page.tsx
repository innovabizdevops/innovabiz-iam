...
const PAGE = "Compliance &amp; Close";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.760","t":"+10.5%","d":"up"},{"l":"NC Abertas","v":"7.058","t":"+10.7%","d":"up"},{"l":"Conformidade (%)","v":"75.1%","t":"+16.1%","d":"up"},{"l":"CAPAs Pendentes","v":"4.079","t":"+0.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.441","74.9%","5.578","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.564","87.8%","3.194","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.011","83.7%","509","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.437","91.6%","7.274","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.275","71.3%","8.151","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":799},{"label":"Mar","value":931},{"label":"Abr","value":813},{"label":"Mai","value":866},{"label":"Jun","value":837},{"label":"Jul","value":799},{"label":"Ago","value":851},{"label":"Set","value":1014},{"label":"Out","value":798},{"label":"Nov","value":828},{"label":"Dez","value":806}];
const MX = 1014;
