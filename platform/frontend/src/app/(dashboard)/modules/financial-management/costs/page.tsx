...
const PAGE = "Cost Mgmt";
const KPIS = [{"l":"Projetos Melhoria","v":"5.710","t":"+6.8%","d":"up"},{"l":"Savings (€)","v":"€79903","t":"-1.9%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"65.6%","t":"-4.5%","d":"down"},{"l":"Ciclos PDCA","v":"5.847","t":"+1.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.825","€ 49452.90","7.407","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.001","€ 32079.86","1.387","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.002","€ 21389.39","8.164","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.197","€ 13166.02","6.722","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.623","€ 32615.51","4.224","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":417},{"label":"Mar","value":459},{"label":"Abr","value":661},{"label":"Mai","value":325},{"label":"Jun","value":420},{"label":"Jul","value":689},{"label":"Ago","value":659},{"label":"Set","value":509},{"label":"Out","value":312},{"label":"Nov","value":316},{"label":"Dez","value":427}];
const MX = 689;
