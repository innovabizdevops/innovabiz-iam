...
const ACCENT = "#6366f1";
const MODULE = "Financial Management";
const PAGE = "AI &amp; Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"3.591","t":"+8.2%","d":"up"},{"l":"Queries/Dia","v":"2568","t":"+5.5%","d":"up"},{"l":"Dados Processados (GB)","v":"8.628","t":"-2.4%","d":"down"},{"l":"Utilizadores Analytics","v":"6.713","t":"-0.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4236","2026-01-08","7.466","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4705","2026-01-21","8.486","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2860","2026-01-20","2.234","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","933","2026-03-01","625","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4690","2026-03-21","8.957","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":906},{"label":"Fev","value":925},{"label":"Mar","value":707},{"label":"Abr","value":855},{"label":"Mai","value":814},{"label":"Jun","value":917},{"label":"Jul","value":686},{"label":"Ago","value":776},{"label":"Set","value":644},{"label":"Out","value":698},{"label":"Nov","value":564},{"label":"Dez","value":885}];
const MX = 925;
