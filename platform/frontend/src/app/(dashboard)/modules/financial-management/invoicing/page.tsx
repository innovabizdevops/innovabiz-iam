...
const KPIS = [{"l":"Projetos Melhoria","v":"7.827","t":"+5.5%","d":"up"},{"l":"Savings (€)","v":"€68817","t":"-2.9%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"84.8%","t":"-0.9%","d":"down"},{"l":"Ciclos PDCA","v":"6.626","t":"-4.8%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.649","€ 44625.64","2.898","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.140","€ 42963.20","3.696","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.191","€ 36759.74","1.712","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.069","€ 47141.80","8.144","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.088","€ 9607.31","1.892","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":807},{"label":"Mar","value":852},{"label":"Abr","value":902},{"label":"Mai","value":924},{"label":"Jun","value":756},{"label":"Jul","value":718},{"label":"Ago","value":635},{"label":"Set","value":849},{"label":"Out","value":735},{"label":"Nov","value":773},{"label":"Dez","value":867}];
const MX = 924;
