...
const PAGE = "Financial Close";
const KPIS = [{"l":"Projetos Melhoria","v":"7.967","t":"+4.9%","d":"up"},{"l":"Savings (€)","v":"€29488","t":"+5.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"65.8%","t":"-5.3%","d":"down"},{"l":"Ciclos PDCA","v":"4.018","t":"+4.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.673","€ 24426.31","6.866","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.199","€ 6823.84","1.181","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.178","€ 4691.22","5.932","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.386","€ 2275.55","436","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.870","€ 19914.96","8.738","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":691},{"label":"Mar","value":906},{"label":"Abr","value":976},{"label":"Mai","value":931},{"label":"Jun","value":872},{"label":"Jul","value":948},{"label":"Ago","value":1073},{"label":"Set","value":924},{"label":"Out","value":810},{"label":"Nov","value":887},{"label":"Dez","value":1022}];
const MX = 1073;
