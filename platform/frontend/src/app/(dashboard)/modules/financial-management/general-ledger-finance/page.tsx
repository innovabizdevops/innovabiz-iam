...
const PAGE = "GL &amp; Journals";
const KPIS = [{"l":"Projetos Melhoria","v":"5.640","t":"-1.1%","d":"down"},{"l":"Savings (€)","v":"€40268","t":"+5.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"89.2%","t":"+7.1%","d":"up"},{"l":"Ciclos PDCA","v":"3.658","t":"+0.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.214","€ 35705.06","6.388","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.988","€ 12343.86","8.945","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.067","€ 41384.93","4.924","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.843","€ 22698.67","2.675","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.082","€ 1802.06","2.300","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":635},{"label":"Mar","value":891},{"label":"Abr","value":643},{"label":"Mai","value":656},{"label":"Jun","value":824},{"label":"Jul","value":769},{"label":"Ago","value":951},{"label":"Set","value":950},{"label":"Out","value":601},{"label":"Nov","value":891},{"label":"Dez","value":626}];
const MX = 951;
...
export default function GeneralLedgerFinancePage() {
    return (
