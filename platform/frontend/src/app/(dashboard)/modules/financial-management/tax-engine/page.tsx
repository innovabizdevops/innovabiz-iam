...
const PAGE = "Tax Engine";
const KPIS = [{"l":"Projetos Melhoria","v":"4.867","t":"+1.0%","d":"up"},{"l":"Savings (€)","v":"€54261","t":"+15.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"77.3%","t":"+9.2%","d":"up"},{"l":"Ciclos PDCA","v":"5.574","t":"+14.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.526","€ 38078.59","3.983","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.941","€ 12732.15","6.004","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.490","€ 20502.69","6.337","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.224","€ 35232.63","2.533","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.988","€ 31600.47","7.102","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":915},{"label":"Mar","value":870},{"label":"Abr","value":807},{"label":"Mai","value":675},{"label":"Jun","value":648},{"label":"Jul","value":584},{"label":"Ago","value":928},{"label":"Set","value":672},{"label":"Out","value":652},{"label":"Nov","value":706},{"label":"Dez","value":893}];
const MX = 928;
