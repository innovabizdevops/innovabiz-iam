...
const KPIS = [{"l":"Ativos Registados","v":"3.448","t":"+9.8%","d":"up"},{"l":"Valor Total (€M)","v":"€7.8M","t":"+15.2%","d":"up"},{"l":"Depreciação Anual (€)","v":"€41174","t":"-0.9%","d":"down"},{"l":"Ativos em Garantia","v":"6.258","t":"+12.9%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 31416.84","1.771","€ 42373.13","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 26707.54","6.346","€ 44008.24","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 8153.37","1.690","€ 24641.92","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 8166.29","8.497","€ 42018.08","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 41839.76","4.380","€ 45069.57","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":969},{"label":"Mar","value":744},{"label":"Abr","value":882},{"label":"Mai","value":811},{"label":"Jun","value":815},{"label":"Jul","value":1031},{"label":"Ago","value":860},{"label":"Set","value":708},{"label":"Out","value":775},{"label":"Nov","value":897},{"label":"Dez","value":950}];
const MX = 1031;
