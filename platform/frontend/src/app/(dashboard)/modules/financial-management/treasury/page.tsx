...
const PAGE = "Treasury &amp; Assets";
const KPIS = [{"l":"Ativos Registados","v":"4.351","t":"+12.4%","d":"up"},{"l":"Valor Total (€M)","v":"€37.4M","t":"+5.6%","d":"up"},{"l":"Depreciação Anual (€)","v":"€1030","t":"+17.6%","d":"up"},{"l":"Ativos em Garantia","v":"7.827","t":"-1.1%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 1417.98","8.575","€ 6741.17","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 35027.71","3.018","€ 44540.38","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 26647.92","3.267","€ 39510.03","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 25946.04","6.606","€ 43743.27","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 35159.57","1.924","€ 35030.58","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":435},{"label":"Fev","value":664},{"label":"Mar","value":702},{"label":"Abr","value":474},{"label":"Mai","value":794},{"label":"Jun","value":442},{"label":"Jul","value":446},{"label":"Ago","value":527},{"label":"Set","value":465},{"label":"Out","value":698},{"label":"Nov","value":530},{"label":"Dez","value":808}];
const MX = 808;
