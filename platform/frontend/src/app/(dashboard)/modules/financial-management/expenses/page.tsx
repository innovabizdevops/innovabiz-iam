...
const PAGE = "Expenses";
const KPIS = [{"l":"Projetos Melhoria","v":"3.270","t":"+16.8%","d":"up"},{"l":"Savings (€)","v":"€20812","t":"+6.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"74.4%","t":"+11.1%","d":"up"},{"l":"Ciclos PDCA","v":"3.431","t":"+13.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.872","€ 10553.98","6.738","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.361","€ 38741.36","6.206","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.832","€ 13421.07","1.180","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.490","€ 46068.53","4.007","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.029","€ 24843.43","3.546","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":716},{"label":"Mar","value":670},{"label":"Abr","value":713},{"label":"Mai","value":545},{"label":"Jun","value":697},{"label":"Jul","value":555},{"label":"Ago","value":475},{"label":"Set","value":846},{"label":"Out","value":693},{"label":"Nov","value":775},{"label":"Dez","value":658}];
const MX = 846;
