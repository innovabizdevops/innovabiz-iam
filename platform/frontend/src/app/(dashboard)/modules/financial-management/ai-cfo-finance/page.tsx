...
const PAGE = "AI CFO";
const KPIS = [{"l":"Projetos Melhoria","v":"635","t":"-4.7%","d":"down"},{"l":"Savings (€)","v":"€94648","t":"+6.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"81.2%","t":"+7.0%","d":"up"},{"l":"Ciclos PDCA","v":"4.019","t":"+13.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.229","€ 22227.49","8.145","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.015","€ 5603.45","7.746","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.528","€ 23675.38","3.721","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.685","€ 14246.46","1.188","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.194","€ 19948.49","7.911","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":674},{"label":"Mar","value":704},{"label":"Abr","value":626},{"label":"Mai","value":529},{"label":"Jun","value":719},{"label":"Jul","value":780},{"label":"Ago","value":601},{"label":"Set","value":781},{"label":"Out","value":477},{"label":"Nov","value":727},{"label":"Dez","value":803}];
const MX = 803;
...
export default function AiCfoFinancePage() {
    return (
