...
const PAGE = "Budgets";
const KPIS = [{"l":"Projetos Melhoria","v":"3.547","t":"+8.6%","d":"up"},{"l":"Savings (€)","v":"€52258","t":"+11.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"71.6%","t":"+12.8%","d":"up"},{"l":"Ciclos PDCA","v":"7.897","t":"+0.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.364","€ 1912.21","8.098","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.147","€ 1026.38","2.737","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.128","€ 32869.87","2.971","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.308","€ 23751.13","5.913","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.807","€ 24723.34","4.089","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":806},{"label":"Mar","value":958},{"label":"Abr","value":892},{"label":"Mai","value":723},{"label":"Jun","value":812},{"label":"Jul","value":783},{"label":"Ago","value":848},{"label":"Set","value":924},{"label":"Out","value":643},{"label":"Nov","value":698},{"label":"Dez","value":598}];
const MX = 958;
