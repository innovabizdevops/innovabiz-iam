...
const KPIS = [{"l":"Projetos Melhoria","v":"5.682","t":"+8.5%","d":"up"},{"l":"Savings (€)","v":"€46000","t":"+12.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"90.3%","t":"+3.1%","d":"up"},{"l":"Ciclos PDCA","v":"1.974","t":"-3.0%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.909","€ 20315.58","4.834","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.349","€ 6693.40","7.926","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.642","€ 4481.18","8.057","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","745","€ 3055.94","9.086","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.171","€ 21813.29","4.686","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":958},{"label":"Fev","value":944},{"label":"Mar","value":633},{"label":"Abr","value":978},{"label":"Mai","value":850},{"label":"Jun","value":816},{"label":"Jul","value":824},{"label":"Ago","value":807},{"label":"Set","value":990},{"label":"Out","value":634},{"label":"Nov","value":1003},{"label":"Dez","value":780}];
const MX = 1003;
