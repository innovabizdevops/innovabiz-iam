...
const PAGE = "Core Accounting";
const KPIS = [{"l":"Projetos Melhoria","v":"7.072","t":"+4.5%","d":"up"},{"l":"Savings (€)","v":"€26606","t":"+2.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"80.8%","t":"+15.5%","d":"up"},{"l":"Ciclos PDCA","v":"5.588","t":"+6.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.667","€ 13812.50","3.005","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","894","€ 46415.75","7.512","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.517","€ 25184.99","6.243","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.916","€ 49899.99","1.611","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.464","€ 8160.61","8.389","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":428},{"label":"Fev","value":521},{"label":"Mar","value":616},{"label":"Abr","value":344},{"label":"Mai","value":617},{"label":"Jun","value":455},{"label":"Jul","value":608},{"label":"Ago","value":410},{"label":"Set","value":604},{"label":"Out","value":676},{"label":"Nov","value":453},{"label":"Dez","value":533}];
const MX = 676;
