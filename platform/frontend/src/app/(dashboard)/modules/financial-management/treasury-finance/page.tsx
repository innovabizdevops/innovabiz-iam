...
const PAGE = "Treasury Hub";
const KPIS = [{"l":"Projetos Melhoria","v":"355","t":"-0.6%","d":"down"},{"l":"Savings (€)","v":"€5052","t":"+5.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"69.7%","t":"+14.1%","d":"up"},{"l":"Ciclos PDCA","v":"5.607","t":"+11.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.605","€ 818.36","8.810","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.542","€ 24263.72","4.433","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.156","€ 10805.81","3.100","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.240","€ 12989.24","1.108","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.623","€ 49705.88","384","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":696},{"label":"Mar","value":851},{"label":"Abr","value":696},{"label":"Mai","value":827},{"label":"Jun","value":892},{"label":"Jul","value":540},{"label":"Ago","value":698},{"label":"Set","value":868},{"label":"Out","value":512},{"label":"Nov","value":817},{"label":"Dez","value":571}];
const MX = 892;
