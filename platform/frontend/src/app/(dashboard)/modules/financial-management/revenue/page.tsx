...
const PAGE = "Revenue &amp; Billing";
const KPIS = [{"l":"ARR (€M)","v":"€13.6M","t":"+14.6%","d":"up"},{"l":"MRR (€)","v":"€6701","t":"+15.1%","d":"up"},{"l":"Churn (%)","v":"76.7%","t":"+6.2%","d":"up"},{"l":"ARPU (€)","v":"€46761","t":"+4.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 20722.80","4.719","€ 38863.17","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 29723.41","6.129","€ 20999.46","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 38426.34","1.578","€ 5648.36","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 39527.91","1.271","€ 43523.17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 5442.39","2.887","€ 6818.79","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":297},{"label":"Fev","value":549},{"label":"Mar","value":626},{"label":"Abr","value":460},{"label":"Mai","value":486},{"label":"Jun","value":626},{"label":"Jul","value":492},{"label":"Ago","value":485},{"label":"Set","value":534},{"label":"Out","value":400},{"label":"Nov","value":514},{"label":"Dez","value":474}];
const MX = 626;
