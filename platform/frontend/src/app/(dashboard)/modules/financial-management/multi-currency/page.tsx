...
const KPIS = [{"l":"Projetos Melhoria","v":"2.338","t":"-3.0%","d":"down"},{"l":"Savings (€)","v":"€12500","t":"+10.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"72.6%","t":"+6.7%","d":"up"},{"l":"Ciclos PDCA","v":"6.064","t":"+17.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.289","€ 30259.73","4.347","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.248","€ 47469.26","3.625","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","464","€ 19340.76","1.634","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","985","€ 30888.09","8.387","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.411","€ 44943.05","4.295","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":414},{"label":"Mar","value":348},{"label":"Abr","value":528},{"label":"Mai","value":344},{"label":"Jun","value":445},{"label":"Jul","value":497},{"label":"Ago","value":643},{"label":"Set","value":421},{"label":"Out","value":655},{"label":"Nov","value":544},{"label":"Dez","value":396}];
const MX = 655;
