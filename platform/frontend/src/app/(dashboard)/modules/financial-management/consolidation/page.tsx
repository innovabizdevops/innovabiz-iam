...
const PAGE = "Consolidation";
const KPIS = [{"l":"Projetos Melhoria","v":"2.533","t":"-0.3%","d":"down"},{"l":"Savings (€)","v":"€35733","t":"+9.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"68.2%","t":"-3.9%","d":"down"},{"l":"Ciclos PDCA","v":"7.479","t":"+10.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.533","€ 29248.57","262","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.531","€ 4859.48","3.847","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.214","€ 14515.54","7.656","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.760","€ 40130.11","266","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.373","€ 31981.21","6.857","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":537},{"label":"Mar","value":672},{"label":"Abr","value":671},{"label":"Mai","value":715},{"label":"Jun","value":785},{"label":"Jul","value":785},{"label":"Ago","value":835},{"label":"Set","value":684},{"label":"Out","value":737},{"label":"Nov","value":903},{"label":"Dez","value":525}];
const MX = 903;
