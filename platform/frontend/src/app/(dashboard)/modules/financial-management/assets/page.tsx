...
const KPIS = [{"l":"Ativos Registados","v":"6.671","t":"+14.4%","d":"up"},{"l":"Valor Total (€M)","v":"€17.3M","t":"+10.7%","d":"up"},{"l":"Depreciação Anual (€)","v":"€50227","t":"-3.1%","d":"down"},{"l":"Ativos em Garantia","v":"2.743","t":"+10.0%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 29611.07","8.601","€ 3260.12","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 11279.14","6.136","€ 11390.48","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 2183.83","2.746","€ 36787.05","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 40829.45","381","€ 3582.86","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 11036.40","1.450","€ 40727.32","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":488},{"label":"Fev","value":600},{"label":"Mar","value":615},{"label":"Abr","value":570},{"label":"Mai","value":541},{"label":"Jun","value":856},{"label":"Jul","value":582},{"label":"Ago","value":802},{"label":"Set","value":736},{"label":"Out","value":716},{"label":"Nov","value":646},{"label":"Dez","value":809}];
const MX = 856;
