...
const PAGE = "Advanced Finance";
const KPIS = [{"l":"Projetos Melhoria","v":"207","t":"-3.7%","d":"down"},{"l":"Savings (€)","v":"€51510","t":"+2.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"92.2%","t":"-2.2%","d":"down"},{"l":"Ciclos PDCA","v":"8.796","t":"+10.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.372","€ 15106.35","3.007","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.742","€ 33207.84","5.197","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.832","€ 30261.25","6.574","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.724","€ 29212.57","8.939","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.906","€ 29132.89","6.649","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":499},{"label":"Mar","value":564},{"label":"Abr","value":588},{"label":"Mai","value":664},{"label":"Jun","value":618},{"label":"Jul","value":424},{"label":"Ago","value":420},{"label":"Set","value":405},{"label":"Out","value":417},{"label":"Nov","value":495},{"label":"Dez","value":686}];
const MX = 686;
