...
const PAGE = "Lease Accounting";
const KPIS = [{"l":"Projetos Melhoria","v":"4.632","t":"+1.4%","d":"up"},{"l":"Savings (€)","v":"€29679","t":"+17.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"81.6%","t":"+14.3%","d":"up"},{"l":"Ciclos PDCA","v":"8.656","t":"+7.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.442","€ 37733.41","1.725","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.080","€ 5171.92","2.003","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","311","€ 27669.82","1.244","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.769","€ 32987.93","1.135","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.340","€ 27023.62","9.062","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":489},{"label":"Mar","value":456},{"label":"Abr","value":360},{"label":"Mai","value":439},{"label":"Jun","value":581},{"label":"Jul","value":726},{"label":"Ago","value":677},{"label":"Set","value":507},{"label":"Out","value":578},{"label":"Nov","value":680},{"label":"Dez","value":417}];
const MX = 726;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>IFRS 16</span></h1>
                </div>
