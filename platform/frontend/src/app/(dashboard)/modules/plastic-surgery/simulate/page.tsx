...
const ACCENT = "#ec4899";
const MODULE = "Plastic Surgery Clinic";
const PAGE = "Simulate";
const KPIS = [{"l":"Twins Ativos","v":"1.445","t":"+5.6%","d":"up"},{"l":"Simulações/Dia","v":"1895","t":"+1.8%","d":"up"},{"l":"Precisão Modelo (%)","v":"92.7%","t":"-5.9%","d":"down"},{"l":"Latência Sync (ms)","v":"56ms","t":"+6.9%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","87.2%","2026-01-27","1.728","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","93.1%","2026-03-19","4.009","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","77.9%","2026-01-17","7.614","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","80.9%","2026-02-03","2.557","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","86.5%","2026-02-22","2.851","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":931},{"label":"Fev","value":864},{"label":"Mar","value":597},{"label":"Abr","value":601},{"label":"Mai","value":556},{"label":"Jun","value":883},{"label":"Jul","value":822},{"label":"Ago","value":560},{"label":"Set","value":782},{"label":"Out","value":595},{"label":"Nov","value":582},{"label":"Dez","value":574}];
const MX = 931;
