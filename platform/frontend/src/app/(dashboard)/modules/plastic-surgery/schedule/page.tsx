...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Plastic Surgery","v":"4.373","t":"-4.9%","d":"down"},{"l":"Schedule Ativos","v":"1.195","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"93.6%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"80","t":"+15.2%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Plastic Surgery #001","Plastic Surgery #002","1.716","4.038","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Plastic Surgery #002","Plastic Surgery #003","8.709","4.502","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Plastic Surgery #003","Plastic Surgery #004","7.090","1.956","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Plastic Surgery #004","Plastic Surgery #005","4.371","7.069","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Plastic Surgery #005","Plastic Surgery #001","644","4.132","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":539},{"label":"Fev","value":707},{"label":"Mar","value":827},{"label":"Abr","value":714},{"label":"Mai","value":858},{"label":"Jun","value":729},{"label":"Jul","value":863},{"label":"Ago","value":842},{"label":"Set","value":725},{"label":"Out","value":571},{"label":"Nov","value":853},{"label":"Dez","value":553}];
const MX = 863;
