...
/* ═══ Plastic Surgery Clinic — Dashboard ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total Registos", value: "6565", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4329", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€246K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "963197265", cells: ["PLA-9265", "Plastic Surgery Clinic Item 1", "10/10/2026", "€47 365"], status: "active" as const },
    { id: "963200836", cells: ["PLA-3836", "Plastic Surgery Clinic Item 2", "25/5/2026", "€936"], status: "pending" as const },
    { id: "963204407", cells: ["PLA-7407", "Plastic Surgery Clinic Item 3", "12/12/2026", "€4507"], status: "completed" as const },
    { id: "963207978", cells: ["PLA-1978", "Plastic Surgery Clinic Item 4", "27/7/2026", "€8078"], status: "warning" as const },
    { id: "963211549", cells: ["PLA-5549", "Plastic Surgery Clinic Item 5", "14/2/2026", "€11 649"], status: "active" as const },
];
...
export default function PlasticSurgeryClinicPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Plastic Surgery Clinic</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Plastic Surgery Clinic</p>
                    </div>
                </div>
