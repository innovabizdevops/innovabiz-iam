...
const KPIS = [{"l":"Total Plastic Surgery","v":"7.566","t":"-1.0%","d":"down"},{"l":"Follow Up Ativos","v":"2.141","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"78.0%","t":"-3.4%","d":"down"},{"l":"Score Performance","v":"78","t":"+9.2%","d":"up"}];
const COLS = ["ID","Follow Up","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Plastic Surgery #001","Plastic Surgery #002","4.941","2.157","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Plastic Surgery #002","Plastic Surgery #003","7.571","5.619","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Plastic Surgery #003","Plastic Surgery #004","5.703","7.455","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Plastic Surgery #004","Plastic Surgery #005","3.546","2.440","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Plastic Surgery #005","Plastic Surgery #001","7.200","5.676","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":583},{"label":"Mar","value":247},{"label":"Abr","value":379},{"label":"Mai","value":422},{"label":"Jun","value":356},{"label":"Jul","value":361},{"label":"Ago","value":346},{"label":"Set","value":434},{"label":"Out","value":480},{"label":"Nov","value":351},{"label":"Dez","value":538}];
const MX = 583;
