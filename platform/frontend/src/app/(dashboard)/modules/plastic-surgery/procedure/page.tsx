...
const KPIS = [{"l":"Total Plastic Surgery","v":"1.780","t":"-0.2%","d":"down"},{"l":"Procedure Ativos","v":"6.175","t":"+6.0%","d":"up"},{"l":"Eficiência (%)","v":"88.8%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"66","t":"+3.3%","d":"up"}];
const COLS = ["ID","Procedure","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Plastic Surgery #001","Plastic Surgery #002","9.088","6.014","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Plastic Surgery #002","Plastic Surgery #003","4.328","4.005","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Plastic Surgery #003","Plastic Surgery #004","7.302","8.584","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Plastic Surgery #004","Plastic Surgery #005","8.252","3.417","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Plastic Surgery #005","Plastic Surgery #001","5.301","5.874","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":465},{"label":"Mar","value":616},{"label":"Abr","value":516},{"label":"Mai","value":722},{"label":"Jun","value":496},{"label":"Jul","value":566},{"label":"Ago","value":603},{"label":"Set","value":527},{"label":"Out","value":689},{"label":"Nov","value":548},{"label":"Dez","value":413}];
const MX = 722;
