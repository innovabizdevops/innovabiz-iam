...
const PAGE = "Predict";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.637","t":"+6.9%","d":"up"},{"l":"NC Abertas","v":"8.985","t":"+15.9%","d":"up"},{"l":"Conformidade (%)","v":"70.8%","t":"+17.4%","d":"up"},{"l":"CAPAs Pendentes","v":"7.903","t":"+0.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.848","87.5%","4.235","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.765","94.9%","449","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.569","93.6%","6.524","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.669","97.8%","4.434","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.022","84.0%","2.496","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":450},{"label":"Fev","value":410},{"label":"Mar","value":552},{"label":"Abr","value":572},{"label":"Mai","value":627},{"label":"Jun","value":780},{"label":"Jul","value":634},{"label":"Ago","value":461},{"label":"Set","value":585},{"label":"Out","value":748},{"label":"Nov","value":611},{"label":"Dez","value":499}];
const MX = 780;
