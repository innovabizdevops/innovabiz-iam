...
const PAGE = "Plan";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.500","t":"+14.1%","d":"up"},{"l":"NC Abertas","v":"4.226","t":"+15.4%","d":"up"},{"l":"Conformidade (%)","v":"81.3%","t":"-5.8%","d":"down"},{"l":"CAPAs Pendentes","v":"4.145","t":"+14.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.455","78.7%","2.229","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.703","79.5%","8.793","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.741","86.1%","7.363","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.798","70.1%","5.630","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.666","94.9%","3.195","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":592},{"label":"Mar","value":446},{"label":"Abr","value":465},{"label":"Mai","value":523},{"label":"Jun","value":464},{"label":"Jul","value":490},{"label":"Ago","value":435},{"label":"Set","value":560},{"label":"Out","value":597},{"label":"Nov","value":483},{"label":"Dez","value":450}];
const MX = 597;
