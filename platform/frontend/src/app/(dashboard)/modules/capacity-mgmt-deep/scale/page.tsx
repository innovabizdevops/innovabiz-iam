...
const PAGE = "Scale";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.385","t":"-3.6%","d":"down"},{"l":"NC Abertas","v":"1.293","t":"+5.2%","d":"up"},{"l":"Conformidade (%)","v":"65.5%","t":"+6.6%","d":"up"},{"l":"CAPAs Pendentes","v":"6.434","t":"+8.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.440","70.6%","7.693","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.791","83.2%","1.601","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.898","79.8%","2.784","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.533","90.0%","6.986","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.408","75.5%","4.698","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":411},{"label":"Fev","value":403},{"label":"Mar","value":636},{"label":"Abr","value":621},{"label":"Mai","value":620},{"label":"Jun","value":550},{"label":"Jul","value":340},{"label":"Ago","value":593},{"label":"Set","value":573},{"label":"Out","value":545},{"label":"Nov","value":539},{"label":"Dez","value":411}];
const MX = 636;
