...
/* ═══ Capacity Management Deep — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "7416", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3471", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€234K", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "288216116", cells: ["CAP-1116", "Capacity Management Deep Item 1", "21/9/2026", "€16 216"], status: "active" as const },
    { id: "288219687", cells: ["CAP-4687", "Capacity Management Deep Item 2", "8/4/2026", "€19 787"], status: "pending" as const },
    { id: "288223258", cells: ["CAP-8258", "Capacity Management Deep Item 3", "23/11/2026", "€23 358"], status: "completed" as const },
    { id: "288226829", cells: ["CAP-2829", "Capacity Management Deep Item 4", "10/6/2026", "€26 929"], status: "warning" as const },
    { id: "288230400", cells: ["CAP-6400", "Capacity Management Deep Item 5", "25/1/2026", "€30 500"], status: "active" as const },
];
...
export default function CapacityManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Capacity Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Capacity Management Deep</p>
                    </div>
                </div>
