...
const ACCENT = "#1e40af";
const MODULE = "Capacity Management Deep";
const PAGE = "Monitor";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.261","t":"+6.8%","d":"up"},{"l":"NC Abertas","v":"1.725","t":"-1.9%","d":"down"},{"l":"Conformidade (%)","v":"81.7%","t":"+8.3%","d":"up"},{"l":"CAPAs Pendentes","v":"2.311","t":"+6.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.493","85.2%","984","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","711","97.0%","3.237","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.965","83.8%","3.860","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.292","77.2%","8.685","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.964","83.4%","9.089","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":699},{"label":"Mar","value":845},{"label":"Abr","value":730},{"label":"Mai","value":834},{"label":"Jun","value":762},{"label":"Jul","value":674},{"label":"Ago","value":557},{"label":"Set","value":857},{"label":"Out","value":911},{"label":"Nov","value":684},{"label":"Dez","value":727}];
const MX = 911;
