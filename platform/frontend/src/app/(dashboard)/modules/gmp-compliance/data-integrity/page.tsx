...
const PAGE = "Data Integrity";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.195","t":"+7.4%","d":"up"},{"l":"NC Abertas","v":"7.648","t":"-4.8%","d":"down"},{"l":"Conformidade (%)","v":"73.7%","t":"-2.8%","d":"down"},{"l":"CAPAs Pendentes","v":"6.600","t":"+6.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.573","85.0%","3.357","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.249","98.8%","4.183","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.748","82.7%","5.979","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","664","90.3%","5.255","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.672","85.7%","3.488","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":787},{"label":"Mar","value":576},{"label":"Abr","value":762},{"label":"Mai","value":511},{"label":"Jun","value":595},{"label":"Jul","value":509},{"label":"Ago","value":592},{"label":"Set","value":668},{"label":"Out","value":680},{"label":"Nov","value":756},{"label":"Dez","value":487}];
const MX = 839;
