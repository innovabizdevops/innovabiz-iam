...
const PAGE = "Annual Review";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.777","t":"-4.2%","d":"down"},{"l":"NC Abertas","v":"5.300","t":"-5.2%","d":"down"},{"l":"Conformidade (%)","v":"82.7%","t":"+6.9%","d":"up"},{"l":"CAPAs Pendentes","v":"1.493","t":"-3.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.622","93.9%","3.475","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","102","74.4%","2.991","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.451","79.0%","5.989","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.273","72.0%","8.404","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","492","89.3%","4.394","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":884},{"label":"Fev","value":926},{"label":"Mar","value":977},{"label":"Abr","value":978},{"label":"Mai","value":953},{"label":"Jun","value":748},{"label":"Jul","value":982},{"label":"Ago","value":780},{"label":"Set","value":873},{"label":"Out","value":934},{"label":"Nov","value":738},{"label":"Dez","value":965}];
const MX = 982;
