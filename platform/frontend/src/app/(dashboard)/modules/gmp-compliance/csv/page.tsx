...
const ACCENT = "#b45309";
const MODULE = "GMP Compliance";
const PAGE = "Computer Validation";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.500","t":"+17.1%","d":"up"},{"l":"NC Abertas","v":"7.400","t":"+17.8%","d":"up"},{"l":"Conformidade (%)","v":"72.3%","t":"+3.9%","d":"up"},{"l":"CAPAs Pendentes","v":"5.706","t":"+17.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.958","79.3%","3.770","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.316","98.3%","4.390","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","768","85.9%","8.743","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.461","99.3%","2.053","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.648","90.7%","5.333","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":394},{"label":"Fev","value":710},{"label":"Mar","value":704},{"label":"Abr","value":408},{"label":"Mai","value":468},{"label":"Jun","value":521},{"label":"Jul","value":632},{"label":"Ago","value":401},{"label":"Set","value":558},{"label":"Out","value":502},{"label":"Nov","value":588},{"label":"Dez","value":695}];
const MX = 710;
