...
const KPIS = [{"l":"Auditorias Realizadas","v":"2.537","t":"+17.1%","d":"up"},{"l":"NC Abertas","v":"6.668","t":"+2.4%","d":"up"},{"l":"Conformidade (%)","v":"84.0%","t":"+14.5%","d":"up"},{"l":"CAPAs Pendentes","v":"5.810","t":"-0.3%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.402","97.8%","5.657","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.466","72.2%","503","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.022","70.5%","7.378","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.293","91.2%","3.012","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.072","89.6%","2.439","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":740},{"label":"Mar","value":676},{"label":"Abr","value":632},{"label":"Mai","value":804},{"label":"Jun","value":788},{"label":"Jul","value":469},{"label":"Ago","value":612},{"label":"Set","value":469},{"label":"Out","value":608},{"label":"Nov","value":679},{"label":"Dez","value":660}];
const MX = 804;
