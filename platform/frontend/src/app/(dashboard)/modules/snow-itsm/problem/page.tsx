...
const PAGE = "Problem";
const KPIS = [{"l":"Tickets Abertos","v":"2.488","t":"-3.6%","d":"down"},{"l":"SLA Cumprido (%)","v":"68.2%","t":"+14.9%","d":"up"},{"l":"MTTR (h)","v":"75h","t":"+7.9%","d":"up"},{"l":"Satisfação (%)","v":"77.4%","t":"+0.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.874","5.296","3.594","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.973","6.493","7.415","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","720","7.630","930","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.999","2.672","3.682","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.735","7.603","643","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":437},{"label":"Mar","value":414},{"label":"Abr","value":342},{"label":"Mai","value":430},{"label":"Jun","value":412},{"label":"Jul","value":337},{"label":"Ago","value":419},{"label":"Set","value":568},{"label":"Out","value":487},{"label":"Nov","value":466},{"label":"Dez","value":232}];
const MX = 568;
