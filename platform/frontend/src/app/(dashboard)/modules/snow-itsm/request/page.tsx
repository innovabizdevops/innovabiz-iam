...
const PAGE = "Request";
const KPIS = [{"l":"Tickets Abertos","v":"8.827","t":"+4.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"80.4%","t":"-0.7%","d":"down"},{"l":"MTTR (h)","v":"161h","t":"+14.1%","d":"up"},{"l":"Satisfação (%)","v":"92.8%","t":"+3.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.297","1.246","7.711","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.371","4.979","5.176","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.905","9.064","6.818","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.502","967","7.342","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.066","2.318","3.260","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":668},{"label":"Mar","value":786},{"label":"Abr","value":771},{"label":"Mai","value":653},{"label":"Jun","value":668},{"label":"Jul","value":871},{"label":"Ago","value":825},{"label":"Set","value":992},{"label":"Out","value":824},{"label":"Nov","value":756},{"label":"Dez","value":922}];
const MX = 992;
