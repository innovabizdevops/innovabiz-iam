...
/* ═══ ITSM (ServiceNow) — Dashboard ═══ */

const ACCENT = "#81b5a1";

const KPIS = [
    { label: "Total Registos", value: "5382", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3285", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€310K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "900340982", cells: ["SNO-8982", "ITSM (ServiceNow) Item 1", "3/3/2026", "€41 082"], status: "active" as const },
    { id: "900344553", cells: ["SNO-3553", "ITSM (ServiceNow) Item 2", "18/10/2026", "€44 653"], status: "pending" as const },
    { id: "900348124", cells: ["SNO-7124", "ITSM (ServiceNow) Item 3", "5/5/2026", "€48 224"], status: "completed" as const },
    { id: "900351695", cells: ["SNO-1695", "ITSM (ServiceNow) Item 4", "20/12/2026", "€1795"], status: "warning" as const },
    { id: "900355266", cells: ["SNO-5266", "ITSM (ServiceNow) Item 5", "7/7/2026", "€5366"], status: "active" as const },
];
...
export default function ItsmServicenowPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">ITSM (ServiceNow)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • ITSM (ServiceNow)</p>
                    </div>
                </div>
