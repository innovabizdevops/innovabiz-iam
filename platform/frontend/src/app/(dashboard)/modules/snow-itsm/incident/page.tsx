...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"6.420","t":"+3.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"80.3%","t":"+9.1%","d":"up"},{"l":"MTTR (h)","v":"204h","t":"+13.9%","d":"up"},{"l":"Satisfação (%)","v":"68.9%","t":"-1.0%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","732","7.008","8.972","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.385","8.468","5.487","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.239","1.890","4.189","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.864","5.760","599","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.436","3.754","8.054","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":900},{"label":"Fev","value":815},{"label":"Mar","value":796},{"label":"Abr","value":754},{"label":"Mai","value":701},{"label":"Jun","value":660},{"label":"Jul","value":859},{"label":"Ago","value":886},{"label":"Set","value":956},{"label":"Out","value":1024},{"label":"Nov","value":873},{"label":"Dez","value":824}];
const MX = 1024;
