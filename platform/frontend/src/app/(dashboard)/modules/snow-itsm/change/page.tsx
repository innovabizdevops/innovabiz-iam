...
const PAGE = "Change";
const KPIS = [{"l":"Tickets Abertos","v":"2.272","t":"-4.8%","d":"down"},{"l":"SLA Cumprido (%)","v":"91.1%","t":"+9.2%","d":"up"},{"l":"MTTR (h)","v":"118h","t":"+14.3%","d":"up"},{"l":"Satisfação (%)","v":"92.6%","t":"+10.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.584","7.018","6.167","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.858","4.203","6.260","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.628","8.121","7.861","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.248","2.375","271","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.703","3.458","2.001","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":790},{"label":"Fev","value":946},{"label":"Mar","value":898},{"label":"Abr","value":795},{"label":"Mai","value":633},{"label":"Jun","value":776},{"label":"Jul","value":762},{"label":"Ago","value":838},{"label":"Set","value":844},{"label":"Out","value":698},{"label":"Nov","value":770},{"label":"Dez","value":662}];
const MX = 946;
