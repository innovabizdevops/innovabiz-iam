...
const ACCENT = "#81b5a1";
const MODULE = "ITSM (ServiceNow)";
const PAGE = "CMDB";
const KPIS = [{"l":"Tickets Abertos","v":"3.176","t":"+1.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"85.1%","t":"+7.5%","d":"up"},{"l":"MTTR (h)","v":"159h","t":"+17.7%","d":"up"},{"l":"Satisfação (%)","v":"74.4%","t":"-5.2%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.570","687","8.308","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","322","4.668","6.608","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.549","1.304","1.717","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.099","8.374","2.685","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.627","8.923","2.199","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":941},{"label":"Fev","value":691},{"label":"Mar","value":682},{"label":"Abr","value":1039},{"label":"Mai","value":727},{"label":"Jun","value":698},{"label":"Jul","value":868},{"label":"Ago","value":747},{"label":"Set","value":1001},{"label":"Out","value":1038},{"label":"Nov","value":999},{"label":"Dez","value":770}];
const MX = 1039;
