...
const ACCENT = "#6366f1";
const MODULE = "Geotechnical Eng";
const PAGE = "Ground Water";
const KPIS = [{"l":"Total Geotechnical","v":"6.599","t":"+11.9%","d":"up"},{"l":"Ground Water Ativos","v":"8.680","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"68.8%","t":"-3.4%","d":"down"},{"l":"Score Performance","v":"88","t":"+11.4%","d":"up"}];
const COLS = ["ID","Ground Water","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Geotechnical #001","Geotechnical #002","2.512","2.812","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Geotechnical #002","Geotechnical #003","5.153","1.232","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Geotechnical #003","Geotechnical #004","3.097","5.851","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Geotechnical #004","Geotechnical #005","1.796","8.806","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Geotechnical #005","Geotechnical #001","700","6.204","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":761},{"label":"Mar","value":801},{"label":"Abr","value":476},{"label":"Mai","value":762},{"label":"Jun","value":821},{"label":"Jul","value":475},{"label":"Ago","value":602},{"label":"Set","value":530},{"label":"Out","value":617},{"label":"Nov","value":768},{"label":"Dez","value":616}];
const MX = 821;
