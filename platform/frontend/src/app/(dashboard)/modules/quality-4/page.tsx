...
/* ═══ Quality 4.0 Platform — Dashboard ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total Registos", value: "1753", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2310", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€38K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "-11%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "180914253", cells: ["QUA-6253", "Quality 4.0 Platform Item 1", "10/10/2026", "€14 353"], status: "active" as const },
    { id: "180917824", cells: ["QUA-9824", "Quality 4.0 Platform Item 2", "25/5/2026", "€17 924"], status: "pending" as const },
    { id: "180921395", cells: ["QUA-4395", "Quality 4.0 Platform Item 3", "12/12/2026", "€21 495"], status: "completed" as const },
    { id: "180924966", cells: ["QUA-7966", "Quality 4.0 Platform Item 4", "27/7/2026", "€25 066"], status: "warning" as const },
    { id: "180928537", cells: ["QUA-2537", "Quality 4.0 Platform Item 5", "14/2/2026", "€28 637"], status: "active" as const },
];
...
export default function Quality40PlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Quality 4.0 Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Quality 4.0 Platform</p>
                    </div>
                </div>
