...
const PAGE = "CAPA";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.150","t":"+15.7%","d":"up"},{"l":"NC Abertas","v":"2.172","t":"+4.1%","d":"up"},{"l":"Conformidade (%)","v":"82.5%","t":"-3.4%","d":"down"},{"l":"CAPAs Pendentes","v":"6.594","t":"-5.7%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.095","85.7%","4.212","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.670","93.9%","7.000","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","706","95.3%","7.643","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.935","81.7%","5.333","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.414","95.0%","3.794","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":327},{"label":"Fev","value":589},{"label":"Mar","value":475},{"label":"Abr","value":455},{"label":"Mai","value":253},{"label":"Jun","value":550},{"label":"Jul","value":470},{"label":"Ago","value":402},{"label":"Set","value":508},{"label":"Out","value":396},{"label":"Nov","value":562},{"label":"Dez","value":620}];
const MX = 620;
