...
const PAGE = "SPC";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.024","t":"-5.2%","d":"down"},{"l":"NC Abertas","v":"8.559","t":"+4.3%","d":"up"},{"l":"Conformidade (%)","v":"73.1%","t":"-5.4%","d":"down"},{"l":"CAPAs Pendentes","v":"1.151","t":"-1.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.258","85.8%","5.692","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.986","91.9%","3.662","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.504","91.5%","1.424","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.399","80.7%","4.362","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.875","97.5%","4.882","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":958},{"label":"Fev","value":761},{"label":"Mar","value":803},{"label":"Abr","value":672},{"label":"Mai","value":999},{"label":"Jun","value":650},{"label":"Jul","value":969},{"label":"Ago","value":904},{"label":"Set","value":701},{"label":"Out","value":830},{"label":"Nov","value":974},{"label":"Dez","value":797}];
const MX = 999;
