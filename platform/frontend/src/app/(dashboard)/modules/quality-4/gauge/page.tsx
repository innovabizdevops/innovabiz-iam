...
const PAGE = "Gauge";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.669","t":"+12.9%","d":"up"},{"l":"NC Abertas","v":"7.579","t":"+4.0%","d":"up"},{"l":"Conformidade (%)","v":"69.1%","t":"+12.0%","d":"up"},{"l":"CAPAs Pendentes","v":"4.698","t":"-0.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.854","96.4%","6.957","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.319","97.8%","3.618","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.311","76.0%","4.547","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.179","78.0%","2.306","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.803","88.2%","8.034","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":953},{"label":"Mar","value":1015},{"label":"Abr","value":811},{"label":"Mai","value":913},{"label":"Jun","value":978},{"label":"Jul","value":1001},{"label":"Ago","value":847},{"label":"Set","value":848},{"label":"Out","value":1004},{"label":"Nov","value":950},{"label":"Dez","value":1071}];
const MX = 1071;
