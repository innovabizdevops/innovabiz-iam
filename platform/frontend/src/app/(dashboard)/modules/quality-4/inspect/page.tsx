...
const ACCENT = "#b45309";
const MODULE = "Quality 4.0 Platform";
const PAGE = "Inspect";
const KPIS = [{"l":"Auditorias Realizadas","v":"887","t":"+1.6%","d":"up"},{"l":"NC Abertas","v":"2.234","t":"+11.7%","d":"up"},{"l":"Conformidade (%)","v":"77.5%","t":"+9.8%","d":"up"},{"l":"CAPAs Pendentes","v":"6.451","t":"+15.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.709","84.6%","6.289","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.970","80.1%","8.280","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.793","91.9%","1.630","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.461","75.5%","2.295","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.768","76.9%","2.920","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":485},{"label":"Fev","value":356},{"label":"Mar","value":441},{"label":"Abr","value":352},{"label":"Mai","value":427},{"label":"Jun","value":457},{"label":"Jul","value":473},{"label":"Ago","value":475},{"label":"Set","value":457},{"label":"Out","value":628},{"label":"Nov","value":663},{"label":"Dez","value":392}];
const MX = 663;
