...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.417","t":"+6.3%","d":"up"},{"l":"NC Abertas","v":"4.097","t":"-0.8%","d":"down"},{"l":"Conformidade (%)","v":"80.7%","t":"+8.1%","d":"up"},{"l":"CAPAs Pendentes","v":"6.174","t":"+0.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.285","78.6%","5.521","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.867","81.1%","7.624","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.459","86.2%","895","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.041","79.8%","5.657","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.015","97.4%","3.930","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":323},{"label":"Fev","value":529},{"label":"Mar","value":379},{"label":"Abr","value":483},{"label":"Mai","value":646},{"label":"Jun","value":641},{"label":"Jul","value":292},{"label":"Ago","value":591},{"label":"Set","value":307},{"label":"Out","value":399},{"label":"Nov","value":519},{"label":"Dez","value":376}];
const MX = 646;
