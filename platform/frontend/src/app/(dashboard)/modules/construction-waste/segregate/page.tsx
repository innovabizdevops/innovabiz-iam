...
const ACCENT = "#6366f1";
const MODULE = "Construction Waste";
const PAGE = "Segregate";
const KPIS = [{"l":"Total Construction Waste","v":"7.775","t":"+13.8%","d":"up"},{"l":"Segregate Ativos","v":"451","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"75.0%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"61","t":"+11.6%","d":"up"}];
const COLS = ["ID","Segregate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Construction Waste #001","Construction Waste #002","7.871","2.248","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Construction Waste #002","Construction Waste #003","2.521","2.077","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Construction Waste #003","Construction Waste #004","2.187","2.674","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Construction Waste #004","Construction Waste #005","8.509","8.088","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Construction Waste #005","Construction Waste #001","1.839","7.131","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":383},{"label":"Fev","value":343},{"label":"Mar","value":339},{"label":"Abr","value":493},{"label":"Mai","value":489},{"label":"Jun","value":358},{"label":"Jul","value":587},{"label":"Ago","value":582},{"label":"Set","value":538},{"label":"Out","value":491},{"label":"Nov","value":591},{"label":"Dez","value":500}];
const MX = 591;
