...
const PAGE = "Plan";
const KPIS = [{"l":"Total Construction Waste","v":"5.128","t":"+9.4%","d":"up"},{"l":"Plan Ativos","v":"8.646","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"86.5%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"73","t":"+7.5%","d":"up"}];
const COLS = ["ID","Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Construction Waste #001","Construction Waste #002","1.743","3.187","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Construction Waste #002","Construction Waste #003","2.207","6.837","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Construction Waste #003","Construction Waste #004","4.106","7.355","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Construction Waste #004","Construction Waste #005","8.874","1.215","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Construction Waste #005","Construction Waste #001","705","7.810","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":1019},{"label":"Mar","value":976},{"label":"Abr","value":798},{"label":"Mai","value":943},{"label":"Jun","value":746},{"label":"Jul","value":799},{"label":"Ago","value":786},{"label":"Set","value":776},{"label":"Out","value":847},{"label":"Nov","value":999},{"label":"Dez","value":732}];
const MX = 1019;
