...
const KPIS = [{"l":"Auditorias Realizadas","v":"4.663","t":"+15.4%","d":"up"},{"l":"NC Abertas","v":"3.168","t":"+11.2%","d":"up"},{"l":"Conformidade (%)","v":"81.4%","t":"+5.4%","d":"up"},{"l":"CAPAs Pendentes","v":"1.561","t":"+6.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","203","91.2%","1.764","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.404","75.1%","7.666","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.353","99.9%","5.774","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.598","97.3%","7.812","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.315","94.0%","5.945","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":947},{"label":"Fev","value":943},{"label":"Mar","value":864},{"label":"Abr","value":736},{"label":"Mai","value":933},{"label":"Jun","value":720},{"label":"Jul","value":945},{"label":"Ago","value":809},{"label":"Set","value":1040},{"label":"Out","value":760},{"label":"Nov","value":811},{"label":"Dez","value":702}];
const MX = 1040;
