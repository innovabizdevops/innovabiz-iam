...
const PAGE = "Simulate";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.656","t":"+4.3%","d":"up"},{"l":"NC Abertas","v":"6.648","t":"+15.6%","d":"up"},{"l":"Conformidade (%)","v":"89.0%","t":"+10.1%","d":"up"},{"l":"CAPAs Pendentes","v":"7.075","t":"+10.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.102","86.7%","4.986","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.931","91.2%","2.805","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.687","82.0%","4.761","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.107","94.7%","4.086","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.833","95.7%","6.177","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":488},{"label":"Fev","value":548},{"label":"Mar","value":619},{"label":"Abr","value":710},{"label":"Mai","value":515},{"label":"Jun","value":476},{"label":"Jul","value":575},{"label":"Ago","value":524},{"label":"Set","value":633},{"label":"Out","value":847},{"label":"Nov","value":632},{"label":"Dez","value":795}];
const MX = 847;
