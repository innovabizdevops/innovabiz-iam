...
const ACCENT = "#1e1b4b";
const MODULE = "COSMOS Capacity Planning";
const PAGE = "Forecast";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.624","t":"+1.2%","d":"up"},{"l":"NC Abertas","v":"7.913","t":"+10.7%","d":"up"},{"l":"Conformidade (%)","v":"84.8%","t":"-1.3%","d":"down"},{"l":"CAPAs Pendentes","v":"4.474","t":"+12.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.970","76.8%","6.735","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","483","99.1%","218","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.221","73.7%","6.765","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.511","97.6%","8.505","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","9.019","81.1%","1.203","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":584},{"label":"Fev","value":796},{"label":"Mar","value":829},{"label":"Abr","value":835},{"label":"Mai","value":660},{"label":"Jun","value":945},{"label":"Jul","value":719},{"label":"Ago","value":566},{"label":"Set","value":808},{"label":"Out","value":663},{"label":"Nov","value":834},{"label":"Dez","value":725}];
const MX = 945;
