...
/* ═══ COSMOS Capacity Planning — Dashboard ═══ */

const ACCENT = "#1e1b4b";

const KPIS = [
    { label: "Total Registos", value: "6580", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3742", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€60K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "-13%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "759682980", cells: ["COS-2980", "COSMOS Capacity Planning Item 1", "1/1/2026", "€33 080"], status: "active" as const },
    { id: "759686551", cells: ["COS-6551", "COSMOS Capacity Planning Item 2", "16/8/2026", "€36 651"], status: "pending" as const },
    { id: "759690122", cells: ["COS-1122", "COSMOS Capacity Planning Item 3", "3/3/2026", "€40 222"], status: "completed" as const },
    { id: "759693693", cells: ["COS-4693", "COSMOS Capacity Planning Item 4", "18/10/2026", "€43 793"], status: "warning" as const },
    { id: "759697264", cells: ["COS-8264", "COSMOS Capacity Planning Item 5", "5/5/2026", "€47 364"], status: "active" as const },
];
...
export default function CosmosCapacityPlanningPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">COSMOS Capacity Planning</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • COSMOS Capacity Planning</p>
                    </div>
                </div>
