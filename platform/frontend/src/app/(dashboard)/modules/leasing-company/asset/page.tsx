...
const PAGE = "Ativo";
const KPIS = [{"l":"Ativos Registados","v":"5.273","t":"+10.9%","d":"up"},{"l":"Valor Total (€M)","v":"€33.3M","t":"+4.7%","d":"up"},{"l":"Depreciação Anual (€)","v":"€52219","t":"-1.1%","d":"down"},{"l":"Ativos em Garantia","v":"2.743","t":"+13.9%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 46524.83","2.320","€ 4439.59","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 1402.36","2.212","€ 8254.27","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 7800.39","7.264","€ 20952.16","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 36991.59","1.929","€ 4859.73","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 44983.97","6.547","€ 12073.32","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":810},{"label":"Mar","value":923},{"label":"Abr","value":1057},{"label":"Mai","value":1064},{"label":"Jun","value":747},{"label":"Jul","value":731},{"label":"Ago","value":793},{"label":"Set","value":1054},{"label":"Out","value":1032},{"label":"Nov","value":773},{"label":"Dez","value":750}];
const MX = 1064;
