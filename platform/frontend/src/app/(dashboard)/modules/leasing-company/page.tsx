...
export default function LeasingCompanyPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Leasing Company</h1><p className="text-sm text-muted-foreground">Leasing Company • iBOS Enterprise</p></div>
