...
const ACCENT = "#6366f1";
const MODULE = "Leasing & Renting";
const PAGE = "Contabilidade IFRS16";
const KPIS = [{"l":"Total Leasing Company","v":"7.811","t":"+12.0%","d":"up"},{"l":"Contabilidade IFRS16 Ativos","v":"4.892","t":"+4.0%","d":"up"},{"l":"Eficiência (%)","v":"74.4%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"67","t":"-0.8%","d":"down"}];
const COLS = ["ID","Contabilidade IFRS16","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Leasing Company #001","Leasing Company #002","6.902","580","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Leasing Company #002","Leasing Company #003","4.642","7.133","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Leasing Company #003","Leasing Company #004","2.672","1.987","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Leasing Company #004","Leasing Company #005","1.259","903","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Leasing Company #005","Leasing Company #001","1.698","253","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":445},{"label":"Mar","value":607},{"label":"Abr","value":704},{"label":"Mai","value":658},{"label":"Jun","value":748},{"label":"Jul","value":549},{"label":"Ago","value":682},{"label":"Set","value":558},{"label":"Out","value":404},{"label":"Nov","value":583},{"label":"Dez","value":678}];
const MX = 748;
