...
export default function SpaceLaunchPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Space Launch</h1><p className="text-sm text-muted-foreground">Space Launch • iBOS Enterprise</p></div>
