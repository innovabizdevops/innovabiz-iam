...
const PAGE = "Vehicle Prep";
const KPIS = [{"l":"Quartos Ocupados","v":"5.094","t":"-2.5%","d":"down"},{"l":"RevPAR (€)","v":"€35700","t":"+14.5%","d":"up"},{"l":"Ocupação (%)","v":"73.7%","t":"+16.9%","d":"up"},{"l":"Guest Satisfaction","v":"2.453","t":"-4.1%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","651","2026-02-18","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","2.850","2026-02-03","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.890","2026-01-27","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.933","2026-02-28","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.611","2026-02-02","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":386},{"label":"Fev","value":411},{"label":"Mar","value":582},{"label":"Abr","value":442},{"label":"Mai","value":618},{"label":"Jun","value":417},{"label":"Jul","value":557},{"label":"Ago","value":648},{"label":"Set","value":525},{"label":"Out","value":479},{"label":"Nov","value":532},{"label":"Dez","value":510}];
const MX = 648;
