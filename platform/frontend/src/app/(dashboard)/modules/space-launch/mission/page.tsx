...
const ACCENT = "#7c3aed";
const MODULE = "Space Launch";
const PAGE = "Mission Plan";
const KPIS = [{"l":"Quartos Ocupados","v":"4.566","t":"-1.4%","d":"down"},{"l":"RevPAR (€)","v":"€90620","t":"+5.9%","d":"up"},{"l":"Ocupação (%)","v":"81.8%","t":"-2.1%","d":"down"},{"l":"Guest Satisfaction","v":"6.631","t":"+14.7%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.147","2026-01-28","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.640","2026-03-03","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.004","2026-01-14","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.953","2026-02-07","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.196","2026-03-04","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":427},{"label":"Fev","value":228},{"label":"Mar","value":298},{"label":"Abr","value":521},{"label":"Mai","value":244},{"label":"Jun","value":229},{"label":"Jul","value":302},{"label":"Ago","value":616},{"label":"Set","value":514},{"label":"Out","value":488},{"label":"Nov","value":413},{"label":"Dez","value":545}];
const MX = 616;
