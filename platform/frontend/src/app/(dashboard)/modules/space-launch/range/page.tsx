...
const PAGE = "Range Safety";
const KPIS = [{"l":"Quartos Ocupados","v":"738","t":"-1.6%","d":"down"},{"l":"RevPAR (€)","v":"€58586","t":"-3.5%","d":"down"},{"l":"Ocupação (%)","v":"73.5%","t":"-5.1%","d":"down"},{"l":"Guest Satisfaction","v":"848","t":"-2.8%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.758","2026-02-01","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.578","2026-03-22","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.042","2026-03-23","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.547","2026-03-24","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","589","2026-01-25","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":569},{"label":"Mar","value":645},{"label":"Abr","value":780},{"label":"Mai","value":589},{"label":"Jun","value":714},{"label":"Jul","value":776},{"label":"Ago","value":609},{"label":"Set","value":846},{"label":"Out","value":935},{"label":"Nov","value":836},{"label":"Dez","value":691}];
const MX = 935;
