...
const PAGE = "Post-Flight";
const KPIS = [{"l":"Pedidos/Dia","v":"1079","t":"-2.9%","d":"down"},{"l":"GMV (€)","v":"€85717","t":"+3.6%","d":"up"},{"l":"Conversão (%)","v":"83.6%","t":"-4.2%","d":"down"},{"l":"AOV (€)","v":"€41656","t":"+12.7%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 23549.53","546","3.437","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 8744.64","3.600","978","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 460.87","5.559","8.054","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 6601.63","7.319","2.402","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 24692.38","769","7.735","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":416},{"label":"Mar","value":589},{"label":"Abr","value":404},{"label":"Mai","value":622},{"label":"Jun","value":474},{"label":"Jul","value":677},{"label":"Ago","value":438},{"label":"Set","value":760},{"label":"Out","value":566},{"label":"Nov","value":686},{"label":"Dez","value":500}];
const MX = 760;
