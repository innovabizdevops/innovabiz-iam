...
const PAGE = "Billing";
const KPIS = [{"l":"Teams Ativos","v":"4.278","t":"-4.3%","d":"down"},{"l":"Reuniões/Semana","v":"4909","t":"+5.2%","d":"up"},{"l":"Mensagens/Dia","v":"1247","t":"+2.5%","d":"up"},{"l":"Ficheiros Partilhados","v":"553","t":"-2.0%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.505","4807","4.398","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","3.434","162","2.679","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.058","261","2.533","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","7.682","1365","5.791","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","3.449","2492","8.876","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":768},{"label":"Fev","value":890},{"label":"Mar","value":932},{"label":"Abr","value":989},{"label":"Mai","value":959},{"label":"Jun","value":925},{"label":"Jul","value":615},{"label":"Ago","value":908},{"label":"Set","value":664},{"label":"Out","value":994},{"label":"Nov","value":993},{"label":"Dez","value":685}];
const MX = 994;
