...
const PAGE = "Room";
const KPIS = [{"l":"Teams Ativos","v":"3.783","t":"+12.2%","d":"up"},{"l":"Reuniões/Semana","v":"2633","t":"+13.7%","d":"up"},{"l":"Mensagens/Dia","v":"2309","t":"+7.3%","d":"up"},{"l":"Ficheiros Partilhados","v":"1.634","t":"+15.7%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","6.594","1979","8.492","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","5.236","952","3.006","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","7.348","500","5.568","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","3.035","4254","5.566","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","3.050","3616","992","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":939},{"label":"Fev","value":860},{"label":"Mar","value":871},{"label":"Abr","value":691},{"label":"Mai","value":646},{"label":"Jun","value":622},{"label":"Jul","value":610},{"label":"Ago","value":692},{"label":"Set","value":743},{"label":"Out","value":779},{"label":"Nov","value":760},{"label":"Dez","value":750}];
const MX = 939;
