...
const PAGE = "Catering";
const KPIS = [{"l":"Teams Ativos","v":"7.790","t":"+11.2%","d":"up"},{"l":"Reuniões/Semana","v":"1385","t":"+3.4%","d":"up"},{"l":"Mensagens/Dia","v":"3094","t":"+0.9%","d":"up"},{"l":"Ficheiros Partilhados","v":"6.283","t":"+2.9%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.485","3538","2.051","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","5.612","1008","6.569","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","5.351","2724","916","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","6.038","2170","1.922","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","6.803","1253","4.418","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":528},{"label":"Mar","value":518},{"label":"Abr","value":600},{"label":"Mai","value":621},{"label":"Jun","value":709},{"label":"Jul","value":594},{"label":"Ago","value":545},{"label":"Set","value":639},{"label":"Out","value":342},{"label":"Nov","value":451},{"label":"Dez","value":670}];
const MX = 709;
