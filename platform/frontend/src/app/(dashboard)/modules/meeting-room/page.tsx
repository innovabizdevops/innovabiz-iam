...
const KPIS = [
    { label: "Total Registos", value: "9984", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "910", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€466K", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1907581484", cells: ["MEE-5484", "Meeting Room Booking Item 1", "5/9/2026", "€31 584"], status: "active" as const },
    { id: "1907585055", cells: ["MEE-9055", "Meeting Room Booking Item 2", "20/4/2026", "€35 155"], status: "pending" as const },
    { id: "1907588626", cells: ["MEE-3626", "Meeting Room Booking Item 3", "7/11/2026", "€38 726"], status: "completed" as const },
    { id: "1907592197", cells: ["MEE-7197", "Meeting Room Booking Item 4", "22/6/2026", "€42 297"], status: "warning" as const },
    { id: "1907595768", cells: ["MEE-1768", "Meeting Room Booking Item 5", "9/1/2026", "€45 868"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Meeting Room Booking</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Meeting Room Booking</p>
                    </div>
                </div>
