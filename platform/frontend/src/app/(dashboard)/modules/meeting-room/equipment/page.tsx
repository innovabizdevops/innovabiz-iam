...
const KPIS = [{"l":"Teams Ativos","v":"3.641","t":"+0.7%","d":"up"},{"l":"Reuniões/Semana","v":"719","t":"+11.7%","d":"up"},{"l":"Mensagens/Dia","v":"2862","t":"+10.8%","d":"up"},{"l":"Ficheiros Partilhados","v":"7.295","t":"+7.3%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","2.006","1370","3.914","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","4.763","908","173","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","2.985","2439","1.104","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","6.021","3730","4.700","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","498","3415","6.835","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":667},{"label":"Mar","value":487},{"label":"Abr","value":459},{"label":"Mai","value":426},{"label":"Jun","value":654},{"label":"Jul","value":375},{"label":"Ago","value":527},{"label":"Set","value":341},{"label":"Out","value":345},{"label":"Nov","value":624},{"label":"Dez","value":367}];
const MX = 667;
