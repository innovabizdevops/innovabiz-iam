...
const PAGE = "Book";
const KPIS = [{"l":"Teams Ativos","v":"2.354","t":"-5.8%","d":"down"},{"l":"Reuniões/Semana","v":"2136","t":"-1.9%","d":"down"},{"l":"Mensagens/Dia","v":"2056","t":"+5.9%","d":"up"},{"l":"Ficheiros Partilhados","v":"6.275","t":"+17.7%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","2.687","2951","867","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","4.095","2405","8.048","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","1.270","4320","8.475","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","1.269","1796","6.585","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.257","3193","1.683","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":940},{"label":"Fev","value":827},{"label":"Mar","value":704},{"label":"Abr","value":847},{"label":"Mai","value":586},{"label":"Jun","value":829},{"label":"Jul","value":914},{"label":"Ago","value":851},{"label":"Set","value":741},{"label":"Out","value":852},{"label":"Nov","value":762},{"label":"Dez","value":812}];
const MX = 940;
