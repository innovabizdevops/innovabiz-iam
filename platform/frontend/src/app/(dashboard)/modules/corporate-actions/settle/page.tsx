...
const PAGE = "Settle";
const KPIS = [{"l":"Total Corporate Actions","v":"146","t":"+13.0%","d":"up"},{"l":"Settle Ativos","v":"4.424","t":"+14.6%","d":"up"},{"l":"Eficiência (%)","v":"70.0%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"75","t":"+2.6%","d":"up"}];
const COLS = ["ID","Settle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Corporate Actions #001","Corporate Actions #002","810","4.626","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Corporate Actions #002","Corporate Actions #003","7.147","1.086","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Corporate Actions #003","Corporate Actions #004","593","3.081","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Corporate Actions #004","Corporate Actions #005","5.348","5.784","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Corporate Actions #005","Corporate Actions #001","7.077","3.182","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":240},{"label":"Fev","value":443},{"label":"Mar","value":542},{"label":"Abr","value":242},{"label":"Mai","value":594},{"label":"Jun","value":247},{"label":"Jul","value":417},{"label":"Ago","value":355},{"label":"Set","value":284},{"label":"Out","value":495},{"label":"Nov","value":482},{"label":"Dez","value":289}];
const MX = 594;
