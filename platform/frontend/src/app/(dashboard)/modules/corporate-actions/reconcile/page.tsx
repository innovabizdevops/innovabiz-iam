...
const ACCENT = "#1e40af";
const MODULE = "Corporate Actions";
const PAGE = "Reconcile";
const KPIS = [{"l":"Total Corporate Actions","v":"8.844","t":"+7.7%","d":"up"},{"l":"Reconcile Ativos","v":"3.283","t":"+0.4%","d":"up"},{"l":"Eficiência (%)","v":"80.4%","t":"+12.0%","d":"up"},{"l":"Score Performance","v":"56","t":"+2.1%","d":"up"}];
const COLS = ["ID","Reconcile","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Corporate Actions #001","Corporate Actions #002","6.101","3.774","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Corporate Actions #002","Corporate Actions #003","3.359","3.898","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Corporate Actions #003","Corporate Actions #004","2.370","5.819","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Corporate Actions #004","Corporate Actions #005","1.898","7.496","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Corporate Actions #005","Corporate Actions #001","3.901","2.694","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":425},{"label":"Fev","value":649},{"label":"Mar","value":455},{"label":"Abr","value":332},{"label":"Mai","value":381},{"label":"Jun","value":655},{"label":"Jul","value":473},{"label":"Ago","value":461},{"label":"Set","value":420},{"label":"Out","value":414},{"label":"Nov","value":286},{"label":"Dez","value":429}];
const MX = 655;
