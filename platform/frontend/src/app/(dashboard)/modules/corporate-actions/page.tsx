...
const KPIS = [
    { label: "Total Registos", value: "5336", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1323", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€406K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2098448836", cells: ["COR-9836", "Corporate Actions Item 1", "9/5/2026", "€48 936"], status: "active" as const },
    { id: "2098452407", cells: ["COR-4407", "Corporate Actions Item 2", "24/12/2026", "€2507"], status: "pending" as const },
    { id: "2098455978", cells: ["COR-7978", "Corporate Actions Item 3", "11/7/2026", "€6078"], status: "completed" as const },
    { id: "2098459549", cells: ["COR-2549", "Corporate Actions Item 4", "26/2/2026", "€9649"], status: "warning" as const },
    { id: "2098463120", cells: ["COR-6120", "Corporate Actions Item 5", "13/9/2026", "€13 220"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Corporate Actions</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Corporate Actions</p>
                    </div>
                </div>
