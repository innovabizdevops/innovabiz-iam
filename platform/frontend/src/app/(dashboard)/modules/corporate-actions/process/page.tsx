...
const PAGE = "Process";
const KPIS = [{"l":"Total Corporate Actions","v":"7.792","t":"+8.7%","d":"up"},{"l":"Process Ativos","v":"4.473","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"89.8%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"77","t":"-5.8%","d":"down"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Corporate Actions #001","Corporate Actions #002","7.907","8.089","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Corporate Actions #002","Corporate Actions #003","767","5.046","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Corporate Actions #003","Corporate Actions #004","1.641","8.297","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Corporate Actions #004","Corporate Actions #005","1.666","3.176","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Corporate Actions #005","Corporate Actions #001","2.448","2.506","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":500},{"label":"Fev","value":339},{"label":"Mar","value":646},{"label":"Abr","value":364},{"label":"Mai","value":596},{"label":"Jun","value":658},{"label":"Jul","value":347},{"label":"Ago","value":309},{"label":"Set","value":664},{"label":"Out","value":513},{"label":"Nov","value":459},{"label":"Dez","value":426}];
const MX = 664;
