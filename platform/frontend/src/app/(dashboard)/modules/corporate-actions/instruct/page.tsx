...
const PAGE = "Instruct";
const KPIS = [{"l":"Total Corporate Actions","v":"8.549","t":"-5.1%","d":"down"},{"l":"Instruct Ativos","v":"2.539","t":"+0.3%","d":"up"},{"l":"Eficiência (%)","v":"85.3%","t":"+7.6%","d":"up"},{"l":"Score Performance","v":"89","t":"-3.6%","d":"down"}];
const COLS = ["ID","Instruct","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Corporate Actions #001","Corporate Actions #002","4.298","8.533","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Corporate Actions #002","Corporate Actions #003","6.905","5.658","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Corporate Actions #003","Corporate Actions #004","7.547","7.440","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Corporate Actions #004","Corporate Actions #005","7.729","6.320","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Corporate Actions #005","Corporate Actions #001","7.729","4.279","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":420},{"label":"Fev","value":571},{"label":"Mar","value":619},{"label":"Abr","value":590},{"label":"Mai","value":368},{"label":"Jun","value":362},{"label":"Jul","value":351},{"label":"Ago","value":595},{"label":"Set","value":379},{"label":"Out","value":419},{"label":"Nov","value":462},{"label":"Dez","value":637}];
const MX = 637;
