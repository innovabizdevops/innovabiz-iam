...
const PAGE = "Audit Calendar";
const KPIS = [{"l":"Riscos Identificados","v":"7.718","t":"+6.9%","d":"up"},{"l":"Mitigações Ativas","v":"7.265","t":"+3.0%","d":"up"},{"l":"Score Risco Geral","v":"85","t":"+8.1%","d":"up"},{"l":"Incidentes YTD","v":"7.550","t":"+14.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.554","5.114","3.555","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.492","7.060","3.349","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.976","9.053","6.272","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.566","8.118","4.766","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.331","5.666","3.166","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":849},{"label":"Fev","value":813},{"label":"Mar","value":747},{"label":"Abr","value":713},{"label":"Mai","value":850},{"label":"Jun","value":976},{"label":"Jul","value":692},{"label":"Ago","value":885},{"label":"Set","value":891},{"label":"Out","value":821},{"label":"Nov","value":673},{"label":"Dez","value":971}];
const MX = 976;
