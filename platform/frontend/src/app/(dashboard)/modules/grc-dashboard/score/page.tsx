...
const ACCENT = "#0e7490";
const MODULE = "GRC Dashboard";
const PAGE = "Compliance Score";
const KPIS = [{"l":"Riscos Identificados","v":"5.043","t":"-2.9%","d":"down"},{"l":"Mitigações Ativas","v":"3.041","t":"-3.2%","d":"down"},{"l":"Score Risco Geral","v":"72","t":"+13.1%","d":"up"},{"l":"Incidentes YTD","v":"8.546","t":"+12.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.306","7.705","5.325","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.751","4.569","7.331","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.743","3.452","5.009","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.600","2.023","5.336","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.145","649","177","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":328},{"label":"Mar","value":400},{"label":"Abr","value":427},{"label":"Mai","value":494},{"label":"Jun","value":518},{"label":"Jul","value":505},{"label":"Ago","value":422},{"label":"Set","value":271},{"label":"Out","value":336},{"label":"Nov","value":265},{"label":"Dez","value":463}];
const MX = 601;
