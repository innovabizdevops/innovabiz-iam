...
const PAGE = "Risk Overview";
const KPIS = [{"l":"Riscos Identificados","v":"3.599","t":"+1.7%","d":"up"},{"l":"Mitigações Ativas","v":"8.142","t":"-0.7%","d":"down"},{"l":"Score Risco Geral","v":"73","t":"+6.2%","d":"up"},{"l":"Incidentes YTD","v":"5.795","t":"-4.1%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.358","3.530","6.682","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.604","3.674","7.498","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","830","6.264","4.041","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.770","3.615","2.979","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.575","544","981","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":654},{"label":"Mar","value":618},{"label":"Abr","value":481},{"label":"Mai","value":725},{"label":"Jun","value":522},{"label":"Jul","value":345},{"label":"Ago","value":347},{"label":"Set","value":401},{"label":"Out","value":676},{"label":"Nov","value":579},{"label":"Dez","value":579}];
const MX = 725;
