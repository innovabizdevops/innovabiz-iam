...
const KPIS = [{"l":"Riscos Identificados","v":"2.191","t":"+1.7%","d":"up"},{"l":"Mitigações Ativas","v":"5.863","t":"+6.0%","d":"up"},{"l":"Score Risco Geral","v":"65","t":"+2.8%","d":"up"},{"l":"Incidentes YTD","v":"8.976","t":"-1.1%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.748","692","4.438","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.298","440","1.615","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.407","5.663","7.363","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.717","6.121","8.967","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.860","4.364","1.377","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":887},{"label":"Fev","value":651},{"label":"Mar","value":592},{"label":"Abr","value":818},{"label":"Mai","value":603},{"label":"Jun","value":606},{"label":"Jul","value":699},{"label":"Ago","value":783},{"label":"Set","value":731},{"label":"Out","value":719},{"label":"Nov","value":589},{"label":"Dez","value":930}];
const MX = 930;
