...
const PAGE = "Control Status";
const KPIS = [{"l":"Riscos Identificados","v":"6.988","t":"+3.5%","d":"up"},{"l":"Mitigações Ativas","v":"1.145","t":"+7.9%","d":"up"},{"l":"Score Risco Geral","v":"56","t":"-5.7%","d":"down"},{"l":"Incidentes YTD","v":"2.971","t":"+2.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.624","3.227","6.808","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.909","5.387","3.200","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","586","6.629","8.991","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.901","1.202","6.372","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.605","1.708","3.346","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":508},{"label":"Fev","value":566},{"label":"Mar","value":750},{"label":"Abr","value":532},{"label":"Mai","value":445},{"label":"Jun","value":703},{"label":"Jul","value":632},{"label":"Ago","value":517},{"label":"Set","value":469},{"label":"Out","value":658},{"label":"Nov","value":469},{"label":"Dez","value":571}];
const MX = 750;
