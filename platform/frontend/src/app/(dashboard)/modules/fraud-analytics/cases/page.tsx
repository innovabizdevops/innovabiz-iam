...
const KPIS = [{"l":"Dashboards Ativos","v":"920","t":"+10.3%","d":"up"},{"l":"Queries/Dia","v":"4575","t":"+1.2%","d":"up"},{"l":"Dados Processados (GB)","v":"5.799","t":"-4.3%","d":"down"},{"l":"Utilizadores Analytics","v":"3.214","t":"+2.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2119","2026-03-24","8.213","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1644","2026-03-26","1.756","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4009","2026-03-04","2.057","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1487","2026-01-02","7.051","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","805","2026-02-24","5.417","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":906},{"label":"Fev","value":634},{"label":"Mar","value":720},{"label":"Abr","value":584},{"label":"Mai","value":860},{"label":"Jun","value":926},{"label":"Jul","value":689},{"label":"Ago","value":832},{"label":"Set","value":953},{"label":"Out","value":602},{"label":"Nov","value":702},{"label":"Dez","value":766}];
const MX = 953;
