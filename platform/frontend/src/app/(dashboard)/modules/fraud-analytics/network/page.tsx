...
const PAGE = "Network Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"164","t":"+2.1%","d":"up"},{"l":"Queries/Dia","v":"997","t":"-1.6%","d":"down"},{"l":"Dados Processados (GB)","v":"5.624","t":"+2.6%","d":"up"},{"l":"Utilizadores Analytics","v":"3.216","t":"-0.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1689","2026-02-13","2.694","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1678","2026-03-03","4.429","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4537","2026-01-10","5.956","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4047","2026-01-22","2.248","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","433","2026-02-19","544","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":615},{"label":"Mar","value":379},{"label":"Abr","value":645},{"label":"Mai","value":510},{"label":"Jun","value":295},{"label":"Jul","value":637},{"label":"Ago","value":662},{"label":"Set","value":649},{"label":"Out","value":573},{"label":"Nov","value":450},{"label":"Dez","value":370}];
const MX = 662;
