...
const ACCENT = "#b45309";
const MODULE = "Fraud Analytics";
const PAGE = "Pattern Detection";
const KPIS = [{"l":"Dashboards Ativos","v":"8.145","t":"-5.3%","d":"down"},{"l":"Queries/Dia","v":"4013","t":"-1.7%","d":"down"},{"l":"Dados Processados (GB)","v":"2.133","t":"+4.2%","d":"up"},{"l":"Utilizadores Analytics","v":"3.900","t":"+8.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1039","2026-03-05","5.353","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2720","2026-02-06","6.655","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","389","2026-02-08","3.165","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4341","2026-01-22","7.852","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2787","2026-03-25","6.463","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":467},{"label":"Mar","value":303},{"label":"Abr","value":379},{"label":"Mai","value":664},{"label":"Jun","value":651},{"label":"Jul","value":344},{"label":"Ago","value":418},{"label":"Set","value":396},{"label":"Out","value":407},{"label":"Nov","value":271},{"label":"Dez","value":636}];
const MX = 664;
