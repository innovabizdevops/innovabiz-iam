...
const PAGE = "Loss Recovery";
const KPIS = [{"l":"Dashboards Ativos","v":"4.760","t":"+2.2%","d":"up"},{"l":"Queries/Dia","v":"4269","t":"-3.8%","d":"down"},{"l":"Dados Processados (GB)","v":"2.747","t":"+4.0%","d":"up"},{"l":"Utilizadores Analytics","v":"4.414","t":"+14.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2450","2026-01-19","7.984","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3989","2026-02-07","8.276","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","232","2026-03-01","1.965","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4442","2026-02-07","569","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2710","2026-02-13","439","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":877},{"label":"Mar","value":590},{"label":"Abr","value":782},{"label":"Mai","value":888},{"label":"Jun","value":667},{"label":"Jul","value":605},{"label":"Ago","value":818},{"label":"Set","value":668},{"label":"Out","value":574},{"label":"Nov","value":510},{"label":"Dez","value":747}];
const MX = 888;
