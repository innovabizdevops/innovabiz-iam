...
const KPIS = [{"l":"Dashboards Ativos","v":"225","t":"+7.8%","d":"up"},{"l":"Queries/Dia","v":"3219","t":"-2.1%","d":"down"},{"l":"Dados Processados (GB)","v":"6.850","t":"+5.4%","d":"up"},{"l":"Utilizadores Analytics","v":"1.627","t":"+12.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5070","2026-01-28","926","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","707","2026-02-16","5.301","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4644","2026-03-28","1.514","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3549","2026-01-08","4.461","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3605","2026-01-03","4.990","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":301},{"label":"Mar","value":562},{"label":"Abr","value":332},{"label":"Mai","value":332},{"label":"Jun","value":489},{"label":"Jul","value":302},{"label":"Ago","value":489},{"label":"Set","value":617},{"label":"Out","value":417},{"label":"Nov","value":443},{"label":"Dez","value":343}];
const MX = 617;
