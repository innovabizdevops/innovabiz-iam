...
const PAGE = "Experiment Mgmt";
const KPIS = [{"l":"Ativos Registados","v":"5.508","t":"-2.6%","d":"down"},{"l":"Valor Total (€M)","v":"€26.6M","t":"-2.8%","d":"down"},{"l":"Depreciação Anual (€)","v":"€75430","t":"+16.9%","d":"up"},{"l":"Ativos em Garantia","v":"6.489","t":"+12.2%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 41899.73","6.135","€ 5167.96","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 21936.94","5.915","€ 6615.94","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 34852.78","6.516","€ 31406.90","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 23535.51","5.833","€ 9794.92","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 48510.63","4.722","€ 35061.29","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":900},{"label":"Fev","value":731},{"label":"Mar","value":873},{"label":"Abr","value":791},{"label":"Mai","value":832},{"label":"Jun","value":710},{"label":"Jul","value":645},{"label":"Ago","value":635},{"label":"Set","value":642},{"label":"Out","value":639},{"label":"Nov","value":641},{"label":"Dez","value":917}];
const MX = 917;
