...
const PAGE = "Environment Config";
const KPIS = [{"l":"Ativos Registados","v":"5.327","t":"+16.3%","d":"up"},{"l":"Valor Total (€M)","v":"€37.2M","t":"+5.5%","d":"up"},{"l":"Depreciação Anual (€)","v":"€76133","t":"+17.5%","d":"up"},{"l":"Ativos em Garantia","v":"4.154","t":"+10.3%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 22008.49","8.515","€ 6127.07","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 40337.17","5.137","€ 38805.09","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 47853.59","424","€ 26957.35","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 22503.96","1.895","€ 42319.60","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 2915.22","5.388","€ 17149.42","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":424},{"label":"Fev","value":452},{"label":"Mar","value":439},{"label":"Abr","value":534},{"label":"Mai","value":604},{"label":"Jun","value":428},{"label":"Jul","value":398},{"label":"Ago","value":557},{"label":"Set","value":643},{"label":"Out","value":593},{"label":"Nov","value":635},{"label":"Dez","value":545}];
const MX = 643;
