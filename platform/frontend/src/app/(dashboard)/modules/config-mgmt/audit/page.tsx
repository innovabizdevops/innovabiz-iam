...
const KPIS = [{"l":"Auditorias Realizadas","v":"1.657","t":"+10.2%","d":"up"},{"l":"NC Abertas","v":"5.934","t":"+2.6%","d":"up"},{"l":"Conformidade (%)","v":"71.9%","t":"+15.6%","d":"up"},{"l":"CAPAs Pendentes","v":"1.642","t":"-1.9%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.787","90.1%","7.179","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.156","99.3%","6.699","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.403","91.0%","3.666","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.497","95.7%","5.619","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.630","94.8%","8.394","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":270},{"label":"Mar","value":225},{"label":"Abr","value":595},{"label":"Mai","value":348},{"label":"Jun","value":212},{"label":"Jul","value":590},{"label":"Ago","value":328},{"label":"Set","value":276},{"label":"Out","value":211},{"label":"Nov","value":415},{"label":"Dez","value":493}];
const MX = 595;
