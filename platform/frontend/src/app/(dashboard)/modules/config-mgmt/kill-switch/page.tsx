...
const PAGE = "Kill Switch";
const KPIS = [{"l":"Ativos Registados","v":"7.891","t":"+12.6%","d":"up"},{"l":"Valor Total (€M)","v":"€5.2M","t":"+5.8%","d":"up"},{"l":"Depreciação Anual (€)","v":"€73584","t":"+6.7%","d":"up"},{"l":"Ativos em Garantia","v":"1.293","t":"-3.6%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 10423.39","5.874","€ 34560.81","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 44518.53","5.934","€ 340.08","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 930.25","5.674","€ 44787.11","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 2349.08","4.533","€ 29816.49","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 227.55","6.503","€ 307.85","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":864},{"label":"Mar","value":870},{"label":"Abr","value":560},{"label":"Mai","value":523},{"label":"Jun","value":679},{"label":"Jul","value":754},{"label":"Ago","value":516},{"label":"Set","value":587},{"label":"Out","value":706},{"label":"Nov","value":669},{"label":"Dez","value":721}];
const MX = 870;
