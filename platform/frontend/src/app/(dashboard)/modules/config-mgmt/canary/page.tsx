...
const ACCENT = "#dc2626";
const MODULE = "Config & Feature Mgmt";
const PAGE = "Canary Releases";
const KPIS = [{"l":"Ativos Registados","v":"6.003","t":"+8.0%","d":"up"},{"l":"Valor Total (€M)","v":"€28.7M","t":"+14.3%","d":"up"},{"l":"Depreciação Anual (€)","v":"€52427","t":"+15.2%","d":"up"},{"l":"Ativos em Garantia","v":"298","t":"-0.5%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 17195.17","6.180","€ 18193.08","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 13276.08","7.110","€ 40953.33","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 15666.76","1.761","€ 19939.48","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 1049.92","7.168","€ 3126.70","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 7633.68","8.332","€ 31024.39","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1068},{"label":"Fev","value":1022},{"label":"Mar","value":1003},{"label":"Abr","value":719},{"label":"Mai","value":972},{"label":"Jun","value":711},{"label":"Jul","value":772},{"label":"Ago","value":1038},{"label":"Set","value":1021},{"label":"Out","value":999},{"label":"Nov","value":825},{"label":"Dez","value":707}];
const MX = 1068;
