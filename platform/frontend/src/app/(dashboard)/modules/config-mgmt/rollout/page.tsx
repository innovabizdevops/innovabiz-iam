...
const PAGE = "Rollout Strategy";
const KPIS = [{"l":"Ativos Registados","v":"7.589","t":"+12.1%","d":"up"},{"l":"Valor Total (€M)","v":"€8.0M","t":"+4.2%","d":"up"},{"l":"Depreciação Anual (€)","v":"€14986","t":"+13.9%","d":"up"},{"l":"Ativos em Garantia","v":"3.328","t":"+17.3%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 26779.74","6.017","€ 3572.42","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 7120.95","4.860","€ 32744.93","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 19206.79","6.038","€ 44401.45","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 36686.77","7.670","€ 37067.32","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 30856.96","458","€ 25190.68","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":689},{"label":"Fev","value":695},{"label":"Mar","value":851},{"label":"Abr","value":736},{"label":"Mai","value":860},{"label":"Jun","value":689},{"label":"Jul","value":809},{"label":"Ago","value":771},{"label":"Set","value":824},{"label":"Out","value":849},{"label":"Nov","value":776},{"label":"Dez","value":661}];
const MX = 860;
