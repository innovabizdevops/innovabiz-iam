...
const PAGE = "Feature Toggles";
const KPIS = [{"l":"Ativos Registados","v":"1.288","t":"+16.4%","d":"up"},{"l":"Valor Total (€M)","v":"€21.2M","t":"+17.1%","d":"up"},{"l":"Depreciação Anual (€)","v":"€84827","t":"-4.2%","d":"down"},{"l":"Ativos em Garantia","v":"737","t":"+8.0%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 32526.66","1.536","€ 41272.71","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 4868.85","8.157","€ 37805.66","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 26223.03","798","€ 46018.26","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 44982.84","7.363","€ 48821.98","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 21497.49","4.567","€ 20511.26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":608},{"label":"Mar","value":649},{"label":"Abr","value":836},{"label":"Mai","value":787},{"label":"Jun","value":597},{"label":"Jul","value":675},{"label":"Ago","value":849},{"label":"Set","value":625},{"label":"Out","value":770},{"label":"Nov","value":587},{"label":"Dez","value":685}];
const MX = 849;
