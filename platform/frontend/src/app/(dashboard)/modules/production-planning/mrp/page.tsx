...
const PAGE = "MRP";
const KPIS = [{"l":"Total Production Planning","v":"1.720","t":"+17.0%","d":"up"},{"l":"MRP Ativos","v":"5.217","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"82.4%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"73","t":"+12.3%","d":"up"}];
const COLS = ["ID","MRP","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Production Planning #001","Production Planning #002","2.010","440","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Production Planning #002","Production Planning #003","6.454","2.088","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Production Planning #003","Production Planning #004","8.103","8.472","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Production Planning #004","Production Planning #005","7.235","3.720","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Production Planning #005","Production Planning #001","6.442","5.804","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":478},{"label":"Mar","value":618},{"label":"Abr","value":552},{"label":"Mai","value":382},{"label":"Jun","value":481},{"label":"Jul","value":472},{"label":"Ago","value":390},{"label":"Set","value":543},{"label":"Out","value":368},{"label":"Nov","value":464},{"label":"Dez","value":531}];
const MX = 645;
