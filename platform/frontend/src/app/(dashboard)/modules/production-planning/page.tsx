...
/* ═══ Production Planning (SAP PP) — Dashboard ═══ */

const ACCENT = "#0070f3";

const KPIS = [
    { label: "Total Registos", value: "9824", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3199", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€320K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "255241624", cells: ["PRO-2624", "Production Planning (SAP PP) Item 1", "9/5/2026", "€41 724"], status: "active" as const },
    { id: "255245195", cells: ["PRO-6195", "Production Planning (SAP PP) Item 2", "24/12/2026", "€45 295"], status: "pending" as const },
    { id: "255248766", cells: ["PRO-9766", "Production Planning (SAP PP) Item 3", "11/7/2026", "€48 866"], status: "completed" as const },
    { id: "255252337", cells: ["PRO-4337", "Production Planning (SAP PP) Item 4", "26/2/2026", "€2437"], status: "warning" as const },
    { id: "255255908", cells: ["PRO-7908", "Production Planning (SAP PP) Item 5", "13/9/2026", "€6008"], status: "active" as const },
];
...
export default function ProductionPlanningSapPpPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Production Planning (SAP PP)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Production Planning (SAP PP)</p>
                    </div>
                </div>
