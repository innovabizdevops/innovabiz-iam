...
const ACCENT = "#0070f3";
const MODULE = "Production Planning (SAP PP)";
const PAGE = "Routing";
const KPIS = [{"l":"Total Production Planning","v":"4.834","t":"-0.8%","d":"down"},{"l":"Routing Ativos","v":"4.916","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"87.8%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"81","t":"+9.9%","d":"up"}];
const COLS = ["ID","Routing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Production Planning #001","Production Planning #002","2.743","5.289","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Production Planning #002","Production Planning #003","1.400","8.282","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Production Planning #003","Production Planning #004","5.350","357","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Production Planning #004","Production Planning #005","205","4.284","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Production Planning #005","Production Planning #001","2.190","7.265","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":350},{"label":"Fev","value":336},{"label":"Mar","value":338},{"label":"Abr","value":576},{"label":"Mai","value":355},{"label":"Jun","value":709},{"label":"Jul","value":615},{"label":"Ago","value":466},{"label":"Set","value":341},{"label":"Out","value":377},{"label":"Nov","value":707},{"label":"Dez","value":429}];
const MX = 709;
