...
const PAGE = "Order";
const KPIS = [{"l":"Total Production Planning","v":"2.213","t":"-4.5%","d":"down"},{"l":"Order Ativos","v":"4.695","t":"+5.7%","d":"up"},{"l":"Eficiência (%)","v":"81.5%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"61","t":"+16.8%","d":"up"}];
const COLS = ["ID","Order","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Production Planning #001","Production Planning #002","4.531","3.135","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Production Planning #002","Production Planning #003","6.642","2.950","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Production Planning #003","Production Planning #004","7.896","7.399","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Production Planning #004","Production Planning #005","8.846","461","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Production Planning #005","Production Planning #001","1.806","2.932","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":885},{"label":"Mar","value":808},{"label":"Abr","value":587},{"label":"Mai","value":767},{"label":"Jun","value":613},{"label":"Jul","value":926},{"label":"Ago","value":762},{"label":"Set","value":742},{"label":"Out","value":539},{"label":"Nov","value":791},{"label":"Dez","value":751}];
const MX = 926;
