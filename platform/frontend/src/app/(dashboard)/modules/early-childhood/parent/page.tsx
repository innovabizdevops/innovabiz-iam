...
const PAGE = "Parent";
const KPIS = [{"l":"Total Early Childhood","v":"3.366","t":"+17.2%","d":"up"},{"l":"Parent Ativos","v":"6.738","t":"+3.3%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"+7.4%","d":"up"},{"l":"Score Performance","v":"67","t":"+6.3%","d":"up"}];
const COLS = ["ID","Parent","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Early Childhood #001","Early Childhood #002","1.622","5.288","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Early Childhood #002","Early Childhood #003","3.774","6.438","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Early Childhood #003","Early Childhood #004","7.935","5.866","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Early Childhood #004","Early Childhood #005","6.635","8.330","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Early Childhood #005","Early Childhood #001","7.592","6.500","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":232},{"label":"Fev","value":431},{"label":"Mar","value":602},{"label":"Abr","value":362},{"label":"Mai","value":487},{"label":"Jun","value":612},{"label":"Jul","value":309},{"label":"Ago","value":437},{"label":"Set","value":352},{"label":"Out","value":303},{"label":"Nov","value":232},{"label":"Dez","value":562}];
const MX = 612;
