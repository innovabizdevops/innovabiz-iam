...
const KPIS = [{"l":"Total Early Childhood","v":"5.937","t":"-2.5%","d":"down"},{"l":"Assessment Ativos","v":"5.962","t":"-5.9%","d":"down"},{"l":"Eficiência (%)","v":"89.7%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"77","t":"+10.5%","d":"up"}];
const COLS = ["ID","Assessment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Early Childhood #001","Early Childhood #002","7.864","1.715","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Early Childhood #002","Early Childhood #003","5.669","8.446","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Early Childhood #003","Early Childhood #004","6.772","6.598","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Early Childhood #004","Early Childhood #005","8.603","283","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Early Childhood #005","Early Childhood #001","2.789","1.453","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":483},{"label":"Mar","value":694},{"label":"Abr","value":626},{"label":"Mai","value":640},{"label":"Jun","value":737},{"label":"Jul","value":445},{"label":"Ago","value":502},{"label":"Set","value":486},{"label":"Out","value":636},{"label":"Nov","value":668},{"label":"Dez","value":412}];
const MX = 737;
