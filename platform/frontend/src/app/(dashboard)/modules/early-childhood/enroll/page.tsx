...
const ACCENT = "#6366f1";
const MODULE = "Early Childhood";
const PAGE = "Enrollment";
const KPIS = [{"l":"Total Early Childhood","v":"6.360","t":"+14.2%","d":"up"},{"l":"Enrollment Ativos","v":"6.869","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"84.5%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"69","t":"+13.3%","d":"up"}];
const COLS = ["ID","Enrollment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Early Childhood #001","Early Childhood #002","1.260","8.970","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Early Childhood #002","Early Childhood #003","3.474","4.008","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Early Childhood #003","Early Childhood #004","907","1.175","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Early Childhood #004","Early Childhood #005","834","7.529","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Early Childhood #005","Early Childhood #001","8.650","6.227","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":555},{"label":"Mar","value":471},{"label":"Abr","value":666},{"label":"Mai","value":586},{"label":"Jun","value":638},{"label":"Jul","value":669},{"label":"Ago","value":754},{"label":"Set","value":729},{"label":"Out","value":670},{"label":"Nov","value":675},{"label":"Dez","value":701}];
const MX = 754;
