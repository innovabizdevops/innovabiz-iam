...
const PAGE = "Mock";
const KPIS = [{"l":"Integrações Ativas","v":"2.015","t":"-5.7%","d":"down"},{"l":"Chamadas/Hora","v":"3208","t":"+0.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.8%","t":"+4.4%","d":"up"},{"l":"Latência Média (ms)","v":"35ms","t":"-2.3%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.659","929","91.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.028","6.220","91.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.421","7.005","89.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","992","5.119","84.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.939","159","92.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":573},{"label":"Mar","value":641},{"label":"Abr","value":543},{"label":"Mai","value":703},{"label":"Jun","value":641},{"label":"Jul","value":572},{"label":"Ago","value":731},{"label":"Set","value":755},{"label":"Out","value":426},{"label":"Nov","value":679},{"label":"Dez","value":465}];
const MX = 755;
