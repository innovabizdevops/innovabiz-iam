...
/* ═══ API Testing Platform — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "2224", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2329", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€263K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "-7%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2061201924", cells: ["API-4924", "API Testing Platform Item 1", "13/1/2026", "€2024"], status: "active" as const },
    { id: "2061205495", cells: ["API-8495", "API Testing Platform Item 2", "28/8/2026", "€5595"], status: "pending" as const },
    { id: "2061209066", cells: ["API-3066", "API Testing Platform Item 3", "15/3/2026", "€9166"], status: "completed" as const },
    { id: "2061212637", cells: ["API-6637", "API Testing Platform Item 4", "2/10/2026", "€12 737"], status: "warning" as const },
    { id: "2061216208", cells: ["API-1208", "API Testing Platform Item 5", "17/5/2026", "€16 308"], status: "active" as const },
];
...
export default function ApiTestingPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">API Testing Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • API Testing Platform</p>
                    </div>
                </div>
