...
const PAGE = "Contract";
const KPIS = [{"l":"Integrações Ativas","v":"2.545","t":"+12.2%","d":"up"},{"l":"Chamadas/Hora","v":"474","t":"+3.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.0%","t":"+13.4%","d":"up"},{"l":"Latência Média (ms)","v":"143ms","t":"+13.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.271","924","96.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.631","1.128","91.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.160","3.694","96.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.643","8.591","78.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","335","4.833","98.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":343},{"label":"Fev","value":427},{"label":"Mar","value":474},{"label":"Abr","value":478},{"label":"Mai","value":416},{"label":"Jun","value":420},{"label":"Jul","value":344},{"label":"Ago","value":536},{"label":"Set","value":407},{"label":"Out","value":343},{"label":"Nov","value":385},{"label":"Dez","value":409}];
const MX = 536;
