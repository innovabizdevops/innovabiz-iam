...
const PAGE = "Test";
const KPIS = [{"l":"Integrações Ativas","v":"4.747","t":"-0.9%","d":"down"},{"l":"Chamadas/Hora","v":"3347","t":"-1.9%","d":"down"},{"l":"Taxa Sucesso (%)","v":"88.1%","t":"+16.8%","d":"up"},{"l":"Latência Média (ms)","v":"104ms","t":"+-0.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.885","5.117","75.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.588","3.105","94.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.474","4.123","79.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.933","6.950","73.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.482","8.762","89.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":764},{"label":"Mar","value":572},{"label":"Abr","value":816},{"label":"Mai","value":743},{"label":"Jun","value":598},{"label":"Jul","value":671},{"label":"Ago","value":672},{"label":"Set","value":523},{"label":"Out","value":794},{"label":"Nov","value":503},{"label":"Dez","value":590}];
const MX = 816;
