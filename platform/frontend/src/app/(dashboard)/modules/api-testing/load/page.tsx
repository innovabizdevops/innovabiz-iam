...
const PAGE = "Load";
const KPIS = [{"l":"Integrações Ativas","v":"2.178","t":"+7.2%","d":"up"},{"l":"Chamadas/Hora","v":"312","t":"+1.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"75.0%","t":"-5.8%","d":"down"},{"l":"Latência Média (ms)","v":"155ms","t":"-1.6%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.696","6.131","88.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.159","1.995","95.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.838","7.701","99.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.008","1.299","90.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.363","284","71.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":872},{"label":"Fev","value":756},{"label":"Mar","value":526},{"label":"Abr","value":538},{"label":"Mai","value":736},{"label":"Jun","value":863},{"label":"Jul","value":555},{"label":"Ago","value":855},{"label":"Set","value":830},{"label":"Out","value":744},{"label":"Nov","value":808},{"label":"Dez","value":510}];
const MX = 872;
