...
const ACCENT = "#0d9488";
const MODULE = "API Testing Platform";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"8.759","t":"+5.4%","d":"up"},{"l":"Submissões/Dia","v":"3837","t":"-3.6%","d":"down"},{"l":"Documentos Gerados","v":"3.443","t":"+4.5%","d":"up"},{"l":"Templates","v":"1.224","t":"+17.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.001","2026-03-25","6.608","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.497","2026-03-13","7.485","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.837","2026-01-14","8.616","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.830","2026-03-23","2.447","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.778","2026-02-11","8.973","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":813},{"label":"Mar","value":618},{"label":"Abr","value":841},{"label":"Mai","value":770},{"label":"Jun","value":793},{"label":"Jul","value":616},{"label":"Ago","value":547},{"label":"Set","value":475},{"label":"Out","value":683},{"label":"Nov","value":792},{"label":"Dez","value":732}];
const MX = 841;
