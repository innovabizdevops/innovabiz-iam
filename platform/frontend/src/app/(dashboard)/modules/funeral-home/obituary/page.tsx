...
const PAGE = "Obituary";
const KPIS = [{"l":"Total Funeral Home","v":"2.301","t":"+12.6%","d":"up"},{"l":"Obituary Ativos","v":"1.933","t":"+0.1%","d":"up"},{"l":"Eficiência (%)","v":"74.7%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"90","t":"+14.0%","d":"up"}];
const COLS = ["ID","Obituary","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Funeral Home #001","Funeral Home #002","561","7.213","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Funeral Home #002","Funeral Home #003","5.798","4.229","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Funeral Home #003","Funeral Home #004","6.233","7.291","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Funeral Home #004","Funeral Home #005","4.945","117","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Funeral Home #005","Funeral Home #001","430","6.817","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":546},{"label":"Mar","value":633},{"label":"Abr","value":777},{"label":"Mai","value":669},{"label":"Jun","value":840},{"label":"Jul","value":721},{"label":"Ago","value":555},{"label":"Set","value":528},{"label":"Out","value":748},{"label":"Nov","value":913},{"label":"Dez","value":911}];
const MX = 913;
