...
/* ═══ Funeral Home Mgmt — Dashboard ═══ */

const ACCENT = "#475569";

const KPIS = [
    { label: "Total Registos", value: "9160", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2417", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€480K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1896868860", cells: ["FUN-2860", "Funeral Home Mgmt Item 1", "13/1/2026", "€18 960"], status: "active" as const },
    { id: "1896872431", cells: ["FUN-6431", "Funeral Home Mgmt Item 2", "28/8/2026", "€22 531"], status: "pending" as const },
    { id: "1896876002", cells: ["FUN-1002", "Funeral Home Mgmt Item 3", "15/3/2026", "€26 102"], status: "completed" as const },
    { id: "1896879573", cells: ["FUN-4573", "Funeral Home Mgmt Item 4", "2/10/2026", "€29 673"], status: "warning" as const },
    { id: "1896883144", cells: ["FUN-8144", "Funeral Home Mgmt Item 5", "17/5/2026", "€33 244"], status: "active" as const },
];
...
export default function FuneralHomeMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Funeral Home Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Funeral Home Mgmt</p>
                    </div>
                </div>
