...
const ACCENT = "#475569";
const MODULE = "Funeral Home Mgmt";
const PAGE = "Service";
const KPIS = [{"l":"Total Funeral Home","v":"3.676","t":"+13.1%","d":"up"},{"l":"Service Ativos","v":"5.529","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"78.3%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"73","t":"+9.0%","d":"up"}];
const COLS = ["ID","Service","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Funeral Home #001","Funeral Home #002","4.588","8.841","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Funeral Home #002","Funeral Home #003","6.331","4.928","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Funeral Home #003","Funeral Home #004","1.198","8.107","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Funeral Home #004","Funeral Home #005","8.300","3.232","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Funeral Home #005","Funeral Home #001","3.575","8.390","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":900},{"label":"Mar","value":845},{"label":"Abr","value":969},{"label":"Mai","value":752},{"label":"Jun","value":933},{"label":"Jul","value":1005},{"label":"Ago","value":618},{"label":"Set","value":702},{"label":"Out","value":931},{"label":"Nov","value":778},{"label":"Dez","value":835}];
const MX = 1005;
