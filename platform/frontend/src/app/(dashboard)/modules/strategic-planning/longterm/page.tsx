...
const PAGE = "Long-Term Plan";
const KPIS = [{"l":"Riscos Identificados","v":"4.968","t":"+15.0%","d":"up"},{"l":"Mitigações Ativas","v":"1.393","t":"+14.7%","d":"up"},{"l":"Score Risco Geral","v":"89","t":"-0.4%","d":"down"},{"l":"Incidentes YTD","v":"2.989","t":"+5.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.168","1.561","1.561","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.541","6.987","1.340","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.166","2.854","1.028","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.487","3.506","5.517","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.268","4.134","4.352","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":869},{"label":"Fev","value":701},{"label":"Mar","value":917},{"label":"Abr","value":776},{"label":"Mai","value":918},{"label":"Jun","value":627},{"label":"Jul","value":787},{"label":"Ago","value":877},{"label":"Set","value":831},{"label":"Out","value":949},{"label":"Nov","value":808},{"label":"Dez","value":865}];
const MX = 949;
