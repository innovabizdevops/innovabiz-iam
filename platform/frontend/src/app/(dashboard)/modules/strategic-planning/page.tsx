...
/* ═══ Strategic Planning (APQC 1.1) — Dashboard ═══ */

const ACCENT = "#1d4ed8";

const KPIS = [
    { label: "Total Registos", value: "8123", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "441", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€423K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "396186223", cells: ["STR-7223", "Strategic Planning (APQC 1.1) Item 1", "28/8/2026", "€36 323"], status: "active" as const },
    { id: "396189794", cells: ["STR-1794", "Strategic Planning (APQC 1.1) Item 2", "15/3/2026", "€39 894"], status: "pending" as const },
    { id: "396193365", cells: ["STR-5365", "Strategic Planning (APQC 1.1) Item 3", "2/10/2026", "€43 465"], status: "completed" as const },
    { id: "396196936", cells: ["STR-8936", "Strategic Planning (APQC 1.1) Item 4", "17/5/2026", "€47 036"], status: "warning" as const },
    { id: "396200507", cells: ["STR-3507", "Strategic Planning (APQC 1.1) Item 5", "4/12/2026", "€607"], status: "active" as const },
];
...
export default function StrategicPlanningApqc11Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Strategic Planning (APQC 1.1)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Strategic Planning (APQC 1.1)</p>
                    </div>
                </div>
