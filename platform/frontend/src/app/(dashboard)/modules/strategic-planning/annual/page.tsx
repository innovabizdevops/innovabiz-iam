...
const ACCENT = "#1d4ed8";
const MODULE = "Strategic Planning (APQC 1.1)";
const PAGE = "Annual Plan";
const KPIS = [{"l":"Total Strategic Planning","v":"1.971","t":"-3.2%","d":"down"},{"l":"Annual Plan Ativos","v":"8.363","t":"+13.0%","d":"up"},{"l":"Eficiência (%)","v":"65.9%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"81","t":"-3.9%","d":"down"}];
const COLS = ["ID","Annual Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategic Planning #001","Strategic Planning #002","4.837","8.998","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Strategic Planning #002","Strategic Planning #003","6.056","4.075","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategic Planning #003","Strategic Planning #004","2.831","162","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Strategic Planning #004","Strategic Planning #005","3.032","7.641","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategic Planning #005","Strategic Planning #001","6.204","8.352","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":802},{"label":"Fev","value":1003},{"label":"Mar","value":971},{"label":"Abr","value":753},{"label":"Mai","value":628},{"label":"Jun","value":716},{"label":"Jul","value":612},{"label":"Ago","value":918},{"label":"Set","value":709},{"label":"Out","value":945},{"label":"Nov","value":909},{"label":"Dez","value":674}];
const MX = 1003;
