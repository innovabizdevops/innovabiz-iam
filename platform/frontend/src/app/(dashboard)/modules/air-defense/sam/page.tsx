...
const PAGE = "SAM";
const KPIS = [{"l":"Ideias Submetidas","v":"469","t":"+16.8%","d":"up"},{"l":"Patentes (YTD)","v":"4.638","t":"+0.7%","d":"up"},{"l":"Projetos Innovation Lab","v":"1.311","t":"-2.1%","d":"down"},{"l":"Budget I&D (€M)","v":"€34.7M","t":"-0.3%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","4.848","97.3%","5.555","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","8.923","92.4%","5.641","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","5.822","77.5%","1.418","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","8.125","98.4%","4.905","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","288","70.7%","3.086","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":780},{"label":"Fev","value":980},{"label":"Mar","value":773},{"label":"Abr","value":806},{"label":"Mai","value":964},{"label":"Jun","value":746},{"label":"Jul","value":762},{"label":"Ago","value":855},{"label":"Set","value":974},{"label":"Out","value":892},{"label":"Nov","value":825},{"label":"Dez","value":854}];
const MX = 980;
