...
const PAGE = "Track";
const KPIS = [{"l":"Ideias Submetidas","v":"2.342","t":"-0.8%","d":"down"},{"l":"Patentes (YTD)","v":"3.336","t":"-3.4%","d":"down"},{"l":"Projetos Innovation Lab","v":"8.414","t":"+14.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€39.7M","t":"+5.1%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.569","98.9%","2.240","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.677","84.4%","7.860","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","434","77.7%","4.732","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","8.527","99.9%","3.950","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","8.777","75.4%","385","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":556},{"label":"Mar","value":771},{"label":"Abr","value":480},{"label":"Mai","value":757},{"label":"Jun","value":644},{"label":"Jul","value":708},{"label":"Ago","value":502},{"label":"Set","value":728},{"label":"Out","value":498},{"label":"Nov","value":843},{"label":"Dez","value":791}];
const MX = 843;
