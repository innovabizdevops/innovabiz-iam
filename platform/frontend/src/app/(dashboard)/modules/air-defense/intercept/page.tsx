...
const PAGE = "Intercept";
const KPIS = [{"l":"Ideias Submetidas","v":"8.597","t":"+3.2%","d":"up"},{"l":"Patentes (YTD)","v":"3.268","t":"+17.6%","d":"up"},{"l":"Projetos Innovation Lab","v":"2.221","t":"+6.6%","d":"up"},{"l":"Budget I&D (€M)","v":"€30.3M","t":"+10.2%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","498","74.3%","8.104","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","5.916","85.1%","6.364","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","2.510","86.8%","4.001","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","6.909","81.9%","4.441","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","6.938","89.8%","3.444","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":892},{"label":"Fev","value":620},{"label":"Mar","value":704},{"label":"Abr","value":872},{"label":"Mai","value":928},{"label":"Jun","value":872},{"label":"Jul","value":838},{"label":"Ago","value":594},{"label":"Set","value":769},{"label":"Out","value":794},{"label":"Nov","value":828},{"label":"Dez","value":635}];
const MX = 928;
