...
const PAGE = "Radar Net";
const KPIS = [{"l":"Ideias Submetidas","v":"2.243","t":"-4.1%","d":"down"},{"l":"Patentes (YTD)","v":"6.263","t":"+4.0%","d":"up"},{"l":"Projetos Innovation Lab","v":"8.379","t":"-2.2%","d":"down"},{"l":"Budget I&D (€M)","v":"€50.3M","t":"+10.4%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","4.820","87.2%","4.585","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","7.365","72.6%","4.065","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","2.502","97.8%","5.529","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.842","90.0%","9.008","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","636","72.6%","2.391","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":552},{"label":"Mar","value":576},{"label":"Abr","value":514},{"label":"Mai","value":549},{"label":"Jun","value":677},{"label":"Jul","value":532},{"label":"Ago","value":571},{"label":"Set","value":439},{"label":"Out","value":486},{"label":"Nov","value":428},{"label":"Dez","value":709}];
const MX = 709;
