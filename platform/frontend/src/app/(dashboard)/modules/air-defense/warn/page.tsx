...
const ACCENT = "#6366f1";
const MODULE = "Air Defense";
const PAGE = "Early Warn";
const KPIS = [{"l":"Ideias Submetidas","v":"3.684","t":"+11.4%","d":"up"},{"l":"Patentes (YTD)","v":"8.494","t":"+7.0%","d":"up"},{"l":"Projetos Innovation Lab","v":"2.597","t":"-4.6%","d":"down"},{"l":"Budget I&D (€M)","v":"€3.5M","t":"-4.9%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","313","71.3%","4.658","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","1.712","78.0%","8.069","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.916","77.9%","6.567","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","7.316","74.3%","4.494","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","6.472","82.1%","5.029","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":983},{"label":"Mar","value":991},{"label":"Abr","value":1078},{"label":"Mai","value":943},{"label":"Jun","value":752},{"label":"Jul","value":917},{"label":"Ago","value":699},{"label":"Set","value":699},{"label":"Out","value":911},{"label":"Nov","value":820},{"label":"Dez","value":1075}];
const MX = 1078;
