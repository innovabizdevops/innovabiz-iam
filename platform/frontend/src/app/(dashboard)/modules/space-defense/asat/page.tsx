...
const ACCENT = "#6366f1";
const MODULE = "Space Defense";
const PAGE = "Anti-Sat";
const KPIS = [{"l":"Quartos Ocupados","v":"3.589","t":"+9.0%","d":"up"},{"l":"RevPAR (€)","v":"€4714","t":"-5.4%","d":"down"},{"l":"Ocupação (%)","v":"83.5%","t":"+14.1%","d":"up"},{"l":"Guest Satisfaction","v":"8.934","t":"+11.0%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.713","2026-03-15","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","5.690","2026-01-05","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.740","2026-03-23","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.759","2026-03-13","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.694","2026-01-08","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":717},{"label":"Mar","value":719},{"label":"Abr","value":933},{"label":"Mai","value":698},{"label":"Jun","value":577},{"label":"Jul","value":853},{"label":"Ago","value":672},{"label":"Set","value":541},{"label":"Out","value":745},{"label":"Nov","value":776},{"label":"Dez","value":758}];
const MX = 933;
...
export default function AsatPage() {
    return (
