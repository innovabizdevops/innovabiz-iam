...
const PAGE = "GPS Protect";
const KPIS = [{"l":"Quartos Ocupados","v":"5.756","t":"+13.7%","d":"up"},{"l":"RevPAR (€)","v":"€15167","t":"+11.5%","d":"up"},{"l":"Ocupação (%)","v":"86.2%","t":"+6.8%","d":"up"},{"l":"Guest Satisfaction","v":"6.261","t":"-4.4%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","860","2026-01-12","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.513","2026-01-23","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.051","2026-02-18","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","8.542","2026-02-07","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","884","2026-01-16","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":435},{"label":"Fev","value":334},{"label":"Mar","value":323},{"label":"Abr","value":458},{"label":"Mai","value":532},{"label":"Jun","value":572},{"label":"Jul","value":346},{"label":"Ago","value":470},{"label":"Set","value":595},{"label":"Out","value":622},{"label":"Nov","value":695},{"label":"Dez","value":416}];
const MX = 695;
