...
const ACCENT = "#0d9488";
const MODULE = "Multi-Currency Engine Deep";
const PAGE = "Revalue";
const KPIS = [{"l":"Total Multi Currency Deep","v":"2.524","t":"+9.2%","d":"up"},{"l":"Revalue Ativos","v":"1.821","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"78.0%","t":"+4.7%","d":"up"},{"l":"Score Performance","v":"64","t":"+5.0%","d":"up"}];
const COLS = ["ID","Revalue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Multi Currency Deep #001","Multi Currency Deep #002","4.686","7.718","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Multi Currency Deep #002","Multi Currency Deep #003","1.918","4.577","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Multi Currency Deep #003","Multi Currency Deep #004","6.511","5.206","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Multi Currency Deep #004","Multi Currency Deep #005","4.747","7.795","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Multi Currency Deep #005","Multi Currency Deep #001","7.058","8.195","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":876},{"label":"Mar","value":533},{"label":"Abr","value":768},{"label":"Mai","value":825},{"label":"Jun","value":690},{"label":"Jul","value":852},{"label":"Ago","value":822},{"label":"Set","value":685},{"label":"Out","value":709},{"label":"Nov","value":545},{"label":"Dez","value":809}];
const MX = 876;
