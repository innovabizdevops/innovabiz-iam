...
/* ═══ Multi-Currency Engine Deep — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "1657", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2598", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€409K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "-15%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "12237957", cells: ["MUL-7957", "Multi-Currency Engine Deep Item 1", "26/10/2026", "€38 057"], status: "active" as const },
    { id: "12241528", cells: ["MUL-2528", "Multi-Currency Engine Deep Item 2", "13/5/2026", "€41 628"], status: "pending" as const },
    { id: "12245099", cells: ["MUL-6099", "Multi-Currency Engine Deep Item 3", "28/12/2026", "€45 199"], status: "completed" as const },
    { id: "12248670", cells: ["MUL-9670", "Multi-Currency Engine Deep Item 4", "15/7/2026", "€48 770"], status: "warning" as const },
    { id: "12252241", cells: ["MUL-4241", "Multi-Currency Engine Deep Item 5", "2/2/2026", "€2341"], status: "active" as const },
];
...
export default function MulticurrencyEngineDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Multi-Currency Engine Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Multi-Currency Engine Deep</p>
                    </div>
                </div>
