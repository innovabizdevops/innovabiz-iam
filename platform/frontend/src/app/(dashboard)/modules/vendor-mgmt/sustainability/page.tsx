...
const KPIS = [{"l":"Fornecedores Ativos","v":"7.982","t":"+13.8%","d":"up"},{"l":"Contratos (€M)","v":"€29.1M","t":"+5.8%","d":"up"},{"l":"On-Time Delivery (%)","v":"78.6%","t":"+15.0%","d":"up"},{"l":"Score Médio","v":"58","t":"+7.1%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","94.0%","€ 1930.66","3.303","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","99.0%","€ 45449.56","3.928","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","94.4%","€ 31139.61","5.685","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","77.8%","€ 1917.79","7.156","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","94.5%","€ 31294.26","264","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":430},{"label":"Mar","value":457},{"label":"Abr","value":670},{"label":"Mai","value":311},{"label":"Jun","value":368},{"label":"Jul","value":358},{"label":"Ago","value":526},{"label":"Set","value":480},{"label":"Out","value":427},{"label":"Nov","value":356},{"label":"Dez","value":396}];
const MX = 670;
