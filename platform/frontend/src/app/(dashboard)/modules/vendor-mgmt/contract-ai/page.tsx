...
const ACCENT = "#7c3aed";
const MODULE = "Vendor Management";
const PAGE = "Contract AI Extract";
const KPIS = [{"l":"Contratos Ativos","v":"7.280","t":"+2.7%","d":"up"},{"l":"Valor Total (€M)","v":"€42.1M","t":"+8.5%","d":"up"},{"l":"Renovações Próx. 30d","v":"1.391","t":"-3.7%","d":"down"},{"l":"Obrigações Pendentes","v":"797","t":"+12.7%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 43395.79","2026-02-08","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 32599.63","2026-03-07","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 18722.76","2026-03-28","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 32149.96","2026-02-16","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 18985.09","2026-03-05","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":690},{"label":"Mar","value":714},{"label":"Abr","value":764},{"label":"Mai","value":885},{"label":"Jun","value":724},{"label":"Jul","value":817},{"label":"Ago","value":944},{"label":"Set","value":686},{"label":"Out","value":731},{"label":"Nov","value":973},{"label":"Dez","value":777}];
const MX = 973;
