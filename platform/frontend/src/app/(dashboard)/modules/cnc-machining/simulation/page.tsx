...
const KPIS = [{"l":"Twins Ativos","v":"2.563","t":"+2.4%","d":"up"},{"l":"Simulações/Dia","v":"1307","t":"+8.8%","d":"up"},{"l":"Precisão Modelo (%)","v":"94.7%","t":"+5.6%","d":"up"},{"l":"Latência Sync (ms)","v":"82ms","t":"-3.8%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","70.6%","2026-03-09","6.422","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","83.4%","2026-03-15","1.717","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","93.1%","2026-03-10","8.812","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","77.5%","2026-03-19","4.816","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","91.3%","2026-03-24","135","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":656},{"label":"Mar","value":487},{"label":"Abr","value":571},{"label":"Mai","value":652},{"label":"Jun","value":568},{"label":"Jul","value":518},{"label":"Ago","value":556},{"label":"Set","value":810},{"label":"Out","value":647},{"label":"Nov","value":481},{"label":"Dez","value":803}];
const MX = 810;
