...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.934","t":"+9.0%","d":"up"},{"l":"NC Abertas","v":"8.535","t":"-1.2%","d":"down"},{"l":"Conformidade (%)","v":"80.0%","t":"+16.5%","d":"up"},{"l":"CAPAs Pendentes","v":"1.547","t":"+10.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.454","82.9%","4.432","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.595","88.6%","8.834","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.686","98.4%","974","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.549","89.7%","438","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.112","74.7%","8.534","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1020},{"label":"Fev","value":900},{"label":"Mar","value":629},{"label":"Abr","value":974},{"label":"Mai","value":923},{"label":"Jun","value":1017},{"label":"Jul","value":725},{"label":"Ago","value":856},{"label":"Set","value":944},{"label":"Out","value":645},{"label":"Nov","value":657},{"label":"Dez","value":713}];
const MX = 1020;
