...
const PAGE = "Archive";
const KPIS = [{"l":"Total Radiology Info","v":"7.250","t":"+8.5%","d":"up"},{"l":"Archive Ativos","v":"2.603","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"+2.3%","d":"up"},{"l":"Score Performance","v":"72","t":"+2.5%","d":"up"}];
const COLS = ["ID","Archive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Radiology Info #001","Radiology Info #002","5.065","5.173","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Radiology Info #002","Radiology Info #003","5.001","4.845","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Radiology Info #003","Radiology Info #004","7.456","6.882","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Radiology Info #004","Radiology Info #005","1.042","6.435","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Radiology Info #005","Radiology Info #001","8.900","3.865","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":291},{"label":"Fev","value":425},{"label":"Mar","value":325},{"label":"Abr","value":537},{"label":"Mai","value":275},{"label":"Jun","value":562},{"label":"Jul","value":407},{"label":"Ago","value":559},{"label":"Set","value":564},{"label":"Out","value":306},{"label":"Nov","value":346},{"label":"Dez","value":299}];
const MX = 564;
