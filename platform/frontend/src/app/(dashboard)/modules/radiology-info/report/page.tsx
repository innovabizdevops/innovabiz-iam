...
const ACCENT = "#65a30d";
const MODULE = "Radiology Information System";
const PAGE = "Report";
const KPIS = [{"l":"Total Radiology Info","v":"5.981","t":"-5.4%","d":"down"},{"l":"Report Ativos","v":"7.850","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"69.1%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"67","t":"-3.1%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Radiology Info #001","Radiology Info #002","2.593","8.519","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Radiology Info #002","Radiology Info #003","7.226","6.924","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Radiology Info #003","Radiology Info #004","2.249","1.157","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Radiology Info #004","Radiology Info #005","4.081","8.786","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Radiology Info #005","Radiology Info #001","6.425","1.705","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":379},{"label":"Fev","value":546},{"label":"Mar","value":617},{"label":"Abr","value":407},{"label":"Mai","value":299},{"label":"Jun","value":367},{"label":"Jul","value":488},{"label":"Ago","value":327},{"label":"Set","value":616},{"label":"Out","value":294},{"label":"Nov","value":476},{"label":"Dez","value":596}];
const MX = 617;
