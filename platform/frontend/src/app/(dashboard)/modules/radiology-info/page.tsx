...
/* ═══ Radiology Information System — Dashboard ═══ */

const ACCENT = "#65a30d";

const KPIS = [
    { label: "Total Registos", value: "9562", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3940", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€52K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "-20%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1119630162", cells: ["RAD-4162", "Radiology Information System Item 1", "15/7/2026", "€30 262"], status: "active" as const },
    { id: "1119633733", cells: ["RAD-7733", "Radiology Information System Item 2", "2/2/2026", "€33 833"], status: "pending" as const },
    { id: "1119637304", cells: ["RAD-2304", "Radiology Information System Item 3", "17/9/2026", "€37 404"], status: "completed" as const },
    { id: "1119640875", cells: ["RAD-5875", "Radiology Information System Item 4", "4/4/2026", "€40 975"], status: "warning" as const },
    { id: "1119644446", cells: ["RAD-9446", "Radiology Information System Item 5", "19/11/2026", "€44 546"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Radiology Information System</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Radiology Information System</p>
                    </div>
                </div>
