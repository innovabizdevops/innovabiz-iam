...
const PAGE = "Acquire";
const KPIS = [{"l":"Total Radiology Info","v":"1.209","t":"+11.4%","d":"up"},{"l":"Acquire Ativos","v":"7.959","t":"+17.3%","d":"up"},{"l":"Eficiência (%)","v":"68.5%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"77","t":"+10.8%","d":"up"}];
const COLS = ["ID","Acquire","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Radiology Info #001","Radiology Info #002","3.882","6.615","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Radiology Info #002","Radiology Info #003","8.411","5.126","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Radiology Info #003","Radiology Info #004","5.530","3.004","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Radiology Info #004","Radiology Info #005","3.465","8.259","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Radiology Info #005","Radiology Info #001","428","951","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":604},{"label":"Mar","value":546},{"label":"Abr","value":398},{"label":"Mai","value":289},{"label":"Jun","value":617},{"label":"Jul","value":572},{"label":"Ago","value":615},{"label":"Set","value":602},{"label":"Out","value":516},{"label":"Nov","value":458},{"label":"Dez","value":622}];
const MX = 622;
