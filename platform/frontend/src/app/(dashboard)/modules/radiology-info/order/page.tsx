...
const PAGE = "Order";
const KPIS = [{"l":"Total Radiology Info","v":"8.431","t":"+9.8%","d":"up"},{"l":"Order Ativos","v":"3.953","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"91.7%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"90","t":"+17.0%","d":"up"}];
const COLS = ["ID","Order","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Radiology Info #001","Radiology Info #002","3.807","3.827","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Radiology Info #002","Radiology Info #003","2.696","2.592","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Radiology Info #003","Radiology Info #004","1.411","1.372","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Radiology Info #004","Radiology Info #005","1.570","6.455","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Radiology Info #005","Radiology Info #001","3.320","8.329","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":602},{"label":"Mar","value":513},{"label":"Abr","value":571},{"label":"Mai","value":729},{"label":"Jun","value":646},{"label":"Jul","value":582},{"label":"Ago","value":854},{"label":"Set","value":475},{"label":"Out","value":514},{"label":"Nov","value":823},{"label":"Dez","value":577}];
const MX = 854;
