...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Radiology Info","v":"8.637","t":"+3.3%","d":"up"},{"l":"Schedule Ativos","v":"3.189","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"94.2%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"72","t":"-4.6%","d":"down"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Radiology Info #001","Radiology Info #002","5.275","6.827","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Radiology Info #002","Radiology Info #003","5.576","2.978","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Radiology Info #003","Radiology Info #004","2.780","7.525","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Radiology Info #004","Radiology Info #005","6.475","7.252","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Radiology Info #005","Radiology Info #001","1.989","8.025","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":880},{"label":"Fev","value":815},{"label":"Mar","value":849},{"label":"Abr","value":928},{"label":"Mai","value":772},{"label":"Jun","value":653},{"label":"Jul","value":665},{"label":"Ago","value":795},{"label":"Set","value":579},{"label":"Out","value":542},{"label":"Nov","value":693},{"label":"Dez","value":628}];
const MX = 928;
