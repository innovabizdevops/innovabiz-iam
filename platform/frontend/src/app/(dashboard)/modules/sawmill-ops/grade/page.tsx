...
const PAGE = "Grade Mark";
const KPIS = [{"l":"Total Sawmill Ops","v":"8.830","t":"+9.0%","d":"up"},{"l":"Grade Mark Ativos","v":"1.721","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"89.9%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"66","t":"+3.8%","d":"up"}];
const COLS = ["ID","Grade Mark","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sawmill Ops #001","Sawmill Ops #002","245","1.995","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Sawmill Ops #002","Sawmill Ops #003","2.318","6.222","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Sawmill Ops #003","Sawmill Ops #004","4.211","6.287","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Sawmill Ops #004","Sawmill Ops #005","2.482","7.968","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sawmill Ops #005","Sawmill Ops #001","3.749","3.916","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":318},{"label":"Fev","value":377},{"label":"Mar","value":326},{"label":"Abr","value":450},{"label":"Mai","value":632},{"label":"Jun","value":478},{"label":"Jul","value":239},{"label":"Ago","value":484},{"label":"Set","value":459},{"label":"Out","value":387},{"label":"Nov","value":583},{"label":"Dez","value":498}];
const MX = 632;
