...
const PAGE = "Log Scanner";
const KPIS = [{"l":"Total Sawmill Ops","v":"1.493","t":"+3.7%","d":"up"},{"l":"Log Scanner Ativos","v":"4.804","t":"-1.3%","d":"down"},{"l":"Eficiência (%)","v":"67.0%","t":"+13.3%","d":"up"},{"l":"Score Performance","v":"84","t":"+5.0%","d":"up"}];
const COLS = ["ID","Log Scanner","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sawmill Ops #001","Sawmill Ops #002","391","1.054","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Sawmill Ops #002","Sawmill Ops #003","2.969","7.202","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Sawmill Ops #003","Sawmill Ops #004","587","681","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Sawmill Ops #004","Sawmill Ops #005","2.218","3.072","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sawmill Ops #005","Sawmill Ops #001","5.027","8.960","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":813},{"label":"Fev","value":817},{"label":"Mar","value":623},{"label":"Abr","value":436},{"label":"Mai","value":816},{"label":"Jun","value":655},{"label":"Jul","value":598},{"label":"Ago","value":657},{"label":"Set","value":771},{"label":"Out","value":723},{"label":"Nov","value":475},{"label":"Dez","value":625}];
const MX = 817;
