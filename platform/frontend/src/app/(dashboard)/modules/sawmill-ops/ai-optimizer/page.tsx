...
const PAGE = "AI Optimizer";
const KPIS = [{"l":"Total Sawmill Ops","v":"6.709","t":"-0.8%","d":"down"},{"l":"AI Optimizer Ativos","v":"1.313","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"85.5%","t":"+9.7%","d":"up"},{"l":"Score Performance","v":"89","t":"+9.7%","d":"up"}];
const COLS = ["ID","AI Optimizer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sawmill Ops #001","Sawmill Ops #002","920","2.695","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Sawmill Ops #002","Sawmill Ops #003","5.744","2.737","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Sawmill Ops #003","Sawmill Ops #004","1.019","1.530","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Sawmill Ops #004","Sawmill Ops #005","8.082","4.318","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sawmill Ops #005","Sawmill Ops #001","2.056","5.889","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":376},{"label":"Fev","value":610},{"label":"Mar","value":615},{"label":"Abr","value":723},{"label":"Mai","value":702},{"label":"Jun","value":689},{"label":"Jul","value":548},{"label":"Ago","value":684},{"label":"Set","value":519},{"label":"Out","value":467},{"label":"Nov","value":531},{"label":"Dez","value":643}];
const MX = 723;
