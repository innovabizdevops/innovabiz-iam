...
const PAGE = "Lumber Yard";
const KPIS = [{"l":"Total Sawmill Ops","v":"1.261","t":"-4.6%","d":"down"},{"l":"Lumber Yard Ativos","v":"601","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"84.8%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"85","t":"-3.3%","d":"down"}];
const COLS = ["ID","Lumber Yard","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sawmill Ops #001","Sawmill Ops #002","8.072","4.061","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Sawmill Ops #002","Sawmill Ops #003","1.414","7.802","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Sawmill Ops #003","Sawmill Ops #004","8.336","4.592","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Sawmill Ops #004","Sawmill Ops #005","6.101","8.361","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sawmill Ops #005","Sawmill Ops #001","5.568","3.158","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":516},{"label":"Mar","value":724},{"label":"Abr","value":651},{"label":"Mai","value":635},{"label":"Jun","value":501},{"label":"Jul","value":583},{"label":"Ago","value":401},{"label":"Set","value":698},{"label":"Out","value":465},{"label":"Nov","value":545},{"label":"Dez","value":500}];
const MX = 724;
