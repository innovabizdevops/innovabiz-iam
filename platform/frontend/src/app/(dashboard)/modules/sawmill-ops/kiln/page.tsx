...
const PAGE = "Kiln Dry";
const KPIS = [{"l":"Total Sawmill Ops","v":"4.511","t":"+11.7%","d":"up"},{"l":"Kiln Dry Ativos","v":"8.836","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"76.8%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"56","t":"-1.4%","d":"down"}];
const COLS = ["ID","Kiln Dry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sawmill Ops #001","Sawmill Ops #002","226","2.946","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Sawmill Ops #002","Sawmill Ops #003","5.323","6.837","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Sawmill Ops #003","Sawmill Ops #004","259","2.957","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Sawmill Ops #004","Sawmill Ops #005","3.365","8.500","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sawmill Ops #005","Sawmill Ops #001","5.560","7.069","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":578},{"label":"Mar","value":667},{"label":"Abr","value":811},{"label":"Mai","value":761},{"label":"Jun","value":626},{"label":"Jul","value":622},{"label":"Ago","value":655},{"label":"Set","value":614},{"label":"Out","value":741},{"label":"Nov","value":545},{"label":"Dez","value":616}];
const MX = 811;
