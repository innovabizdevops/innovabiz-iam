...
const PAGE = "Log Sort";
const KPIS = [{"l":"Total Sawmill Ops","v":"3.592","t":"-0.9%","d":"down"},{"l":"Log Sort Ativos","v":"8.566","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"84.5%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"94","t":"+2.9%","d":"up"}];
const COLS = ["ID","Log Sort","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sawmill Ops #001","Sawmill Ops #002","5.551","5.641","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Sawmill Ops #002","Sawmill Ops #003","8.448","288","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Sawmill Ops #003","Sawmill Ops #004","9.075","5.285","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Sawmill Ops #004","Sawmill Ops #005","6.874","9.048","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sawmill Ops #005","Sawmill Ops #001","2.373","9.020","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":759},{"label":"Fev","value":583},{"label":"Mar","value":453},{"label":"Abr","value":543},{"label":"Mai","value":532},{"label":"Jun","value":601},{"label":"Jul","value":591},{"label":"Ago","value":736},{"label":"Set","value":746},{"label":"Out","value":541},{"label":"Nov","value":441},{"label":"Dez","value":470}];
const MX = 759;
