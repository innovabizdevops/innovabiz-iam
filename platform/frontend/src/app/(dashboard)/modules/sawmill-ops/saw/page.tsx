...
const ACCENT = "#dc2626";
const MODULE = "Sawmill Operations";
const PAGE = "Saw Pattern";
const KPIS = [{"l":"Total Sawmill Ops","v":"6.747","t":"-5.8%","d":"down"},{"l":"Saw Pattern Ativos","v":"6.126","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"79.0%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"75","t":"+11.2%","d":"up"}];
const COLS = ["ID","Saw Pattern","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sawmill Ops #001","Sawmill Ops #002","1.671","1.707","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Sawmill Ops #002","Sawmill Ops #003","7.668","7.068","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Sawmill Ops #003","Sawmill Ops #004","556","3.253","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Sawmill Ops #004","Sawmill Ops #005","6.694","1.900","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sawmill Ops #005","Sawmill Ops #001","8.337","3.150","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":901},{"label":"Fev","value":671},{"label":"Mar","value":710},{"label":"Abr","value":967},{"label":"Mai","value":913},{"label":"Jun","value":753},{"label":"Jul","value":973},{"label":"Ago","value":859},{"label":"Set","value":720},{"label":"Out","value":984},{"label":"Nov","value":740},{"label":"Dez","value":924}];
const MX = 984;
