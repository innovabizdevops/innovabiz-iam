...
/* ═══ NGO Platform — Grant Writing ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "1120", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "489", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2472", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "58682261", cells: ["NGO-3261", "Grant Writing Item 1", "2/6/2026", "€32 361"], status: "active" as const },
    { id: "58685832", cells: ["NGO-6832", "Grant Writing Item 2", "17/1/2026", "€35 932"], status: "pending" as const },
    { id: "58689403", cells: ["NGO-1403", "Grant Writing Item 3", "4/8/2026", "€39 503"], status: "completed" as const },
    { id: "58692974", cells: ["NGO-4974", "Grant Writing Item 4", "19/3/2026", "€43 074"], status: "warning" as const },
    { id: "58696545", cells: ["NGO-8545", "Grant Writing Item 5", "6/10/2026", "€46 645"], status: "active" as const },
];
...
export default function NgoPlatformGrantWritingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Grant Writing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">NGO Platform • Grant Writing</p>
                    </div>
                </div>
