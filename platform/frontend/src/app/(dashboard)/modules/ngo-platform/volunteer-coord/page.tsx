...
/* ═══ NGO Platform — Volunteer Coord ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "4784", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "40", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2873", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "3710628", cells: ["NGO-3628", "Volunteer Coord Item 1", "13/1/2026", "€10 728"], status: "active" as const },
    { id: "3714199", cells: ["NGO-7199", "Volunteer Coord Item 2", "28/8/2026", "€14 299"], status: "pending" as const },
    { id: "3717770", cells: ["NGO-1770", "Volunteer Coord Item 3", "15/3/2026", "€17 870"], status: "completed" as const },
    { id: "3721341", cells: ["NGO-5341", "Volunteer Coord Item 4", "2/10/2026", "€21 441"], status: "warning" as const },
    { id: "3724912", cells: ["NGO-8912", "Volunteer Coord Item 5", "17/5/2026", "€25 012"], status: "active" as const },
];
...
export default function NgoPlatformVolunteerCoordPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Volunteer Coord</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">NGO Platform • Volunteer Coord</p>
                    </div>
                </div>
