...
/* ═══ NGO Platform — Fundraising Campaign ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2396", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "179", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "50", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "80%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1147360783", cells: ["NGO-5783", "Fundraising Campaign Item 1", "24/8/2026", "€10 883"], status: "active" as const },
    { id: "1147364354", cells: ["NGO-9354", "Fundraising Campaign Item 2", "11/3/2026", "€14 454"], status: "pending" as const },
    { id: "1147367925", cells: ["NGO-3925", "Fundraising Campaign Item 3", "26/10/2026", "€18 025"], status: "completed" as const },
    { id: "1147371496", cells: ["NGO-7496", "Fundraising Campaign Item 4", "13/5/2026", "€21 596"], status: "warning" as const },
    { id: "1147375067", cells: ["NGO-2067", "Fundraising Campaign Item 5", "28/12/2026", "€25 167"], status: "active" as const },
];
...
export default function NgoPlatformFundraisingCampaignPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fundraising Campaign</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">NGO Platform • Fundraising Campaign</p>
                    </div>
                </div>
