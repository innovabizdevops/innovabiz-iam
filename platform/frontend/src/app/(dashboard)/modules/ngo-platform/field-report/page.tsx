...
/* ═══ NGO Platform — Field Report ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "314", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "289", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "533", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "671175101", cells: ["NGO-1101", "Field Report Item 1", "10/6/2026", "€25 201"], status: "active" as const },
    { id: "671178672", cells: ["NGO-4672", "Field Report Item 2", "25/1/2026", "€28 772"], status: "pending" as const },
    { id: "671182243", cells: ["NGO-8243", "Field Report Item 3", "12/8/2026", "€32 343"], status: "completed" as const },
    { id: "671185814", cells: ["NGO-2814", "Field Report Item 4", "27/3/2026", "€35 914"], status: "warning" as const },
    { id: "671189385", cells: ["NGO-6385", "Field Report Item 5", "14/10/2026", "€39 485"], status: "active" as const },
];
...
export default function NgoPlatformFieldReportPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Field Report</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">NGO Platform • Field Report</p>
                    </div>
                </div>
