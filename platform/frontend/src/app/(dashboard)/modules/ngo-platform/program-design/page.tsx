...
/* ═══ NGO Platform — Program Design ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2479", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "369", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2789", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "791035069", cells: ["NGO-8069", "Program Design Item 1", "14/2/2026", "€35 169"], status: "active" as const },
    { id: "791038640", cells: ["NGO-2640", "Program Design Item 2", "1/9/2026", "€38 740"], status: "pending" as const },
    { id: "791042211", cells: ["NGO-6211", "Program Design Item 3", "16/4/2026", "€42 311"], status: "completed" as const },
    { id: "791045782", cells: ["NGO-9782", "Program Design Item 4", "3/11/2026", "€45 882"], status: "warning" as const },
    { id: "791049353", cells: ["NGO-4353", "Program Design Item 5", "18/6/2026", "€49 453"], status: "active" as const },
];
...
export default function NgoPlatformProgramDesignPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Program Design</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">NGO Platform • Program Design</p>
                    </div>
                </div>
