...
/* ═══ NGO Platform — Beneficiary Track ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "4200", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "423", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2404", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1865224307", cells: ["NGO-2307", "Beneficiary Track Item 1", "24/12/2026", "€24 407"], status: "active" as const },
    { id: "1865227878", cells: ["NGO-5878", "Beneficiary Track Item 2", "11/7/2026", "€27 978"], status: "pending" as const },
    { id: "1865231449", cells: ["NGO-9449", "Beneficiary Track Item 3", "26/2/2026", "€31 549"], status: "completed" as const },
    { id: "1865235020", cells: ["NGO-4020", "Beneficiary Track Item 4", "13/9/2026", "€35 120"], status: "warning" as const },
    { id: "1865238591", cells: ["NGO-7591", "Beneficiary Track Item 5", "28/4/2026", "€38 691"], status: "active" as const },
];
...
export default function NgoPlatformBeneficiaryTrackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Beneficiary Track</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">NGO Platform • Beneficiary Track</p>
                    </div>
                </div>
