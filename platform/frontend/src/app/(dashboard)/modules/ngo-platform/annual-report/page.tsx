...
/* ═══ NGO Platform — Annual Report ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "747", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "290", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2668", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "859895662", cells: ["NGO-9662", "Annual Report Item 1", "11/11/2026", "€45 762"], status: "active" as const },
    { id: "859899233", cells: ["NGO-4233", "Annual Report Item 2", "26/6/2026", "€49 333"], status: "pending" as const },
    { id: "859902804", cells: ["NGO-7804", "Annual Report Item 3", "13/1/2026", "€2904"], status: "completed" as const },
    { id: "859906375", cells: ["NGO-2375", "Annual Report Item 4", "28/8/2026", "€6475"], status: "warning" as const },
    { id: "859909946", cells: ["NGO-5946", "Annual Report Item 5", "15/3/2026", "€10 046"], status: "active" as const },
];
...
export default function NgoPlatformAnnualReportPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Annual Report</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">NGO Platform • Annual Report</p>
                    </div>
                </div>
