...
/* ═══ NGO Platform — Impact Measure ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "667", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "157", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "644", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "629648857", cells: ["NGO-9857", "Impact Measure Item 1", "6/2/2026", "€48 957"], status: "active" as const },
    { id: "629652428", cells: ["NGO-4428", "Impact Measure Item 2", "21/9/2026", "€2528"], status: "pending" as const },
    { id: "629655999", cells: ["NGO-7999", "Impact Measure Item 3", "8/4/2026", "€6099"], status: "completed" as const },
    { id: "629659570", cells: ["NGO-2570", "Impact Measure Item 4", "23/11/2026", "€9670"], status: "warning" as const },
    { id: "629663141", cells: ["NGO-6141", "Impact Measure Item 5", "10/6/2026", "€13 241"], status: "active" as const },
];
...
export default function NgoPlatformImpactMeasurePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Impact Measure</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">NGO Platform • Impact Measure</p>
                    </div>
                </div>
