...
/* ═══ NGO Platform — Board Governance Ngo ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2359", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "31", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1936", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "78%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "2751851", cells: ["NGO-7851", "Board Governance Ngo Item 1", "12/12/2026", "€1951"], status: "active" as const },
    { id: "2755422", cells: ["NGO-2422", "Board Governance Ngo Item 2", "27/7/2026", "€5522"], status: "pending" as const },
    { id: "2758993", cells: ["NGO-5993", "Board Governance Ngo Item 3", "14/2/2026", "€9093"], status: "completed" as const },
    { id: "2762564", cells: ["NGO-9564", "Board Governance Ngo Item 4", "1/9/2026", "€12 664"], status: "warning" as const },
    { id: "2766135", cells: ["NGO-4135", "Board Governance Ngo Item 5", "16/4/2026", "€16 235"], status: "active" as const },
];
...
export default function NgoPlatformBoardGovernanceNgoPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Board Governance Ngo</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">NGO Platform • Board Governance Ngo</p>
                    </div>
                </div>
