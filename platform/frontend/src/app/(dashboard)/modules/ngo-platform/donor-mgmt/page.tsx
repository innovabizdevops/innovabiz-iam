...
/* ═══ NGO Platform — Donor Mgmt ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "115", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "278", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2376", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "949453410", cells: ["NGO-8410", "Donor Mgmt Item 1", "11/7/2026", "€3510"], status: "active" as const },
    { id: "949456981", cells: ["NGO-2981", "Donor Mgmt Item 2", "26/2/2026", "€7081"], status: "pending" as const },
    { id: "949460552", cells: ["NGO-6552", "Donor Mgmt Item 3", "13/9/2026", "€10 652"], status: "completed" as const },
    { id: "949464123", cells: ["NGO-1123", "Donor Mgmt Item 4", "28/4/2026", "€14 223"], status: "warning" as const },
    { id: "949467694", cells: ["NGO-4694", "Donor Mgmt Item 5", "15/11/2026", "€17 794"], status: "active" as const },
];
...
export default function NgoPlatformDonorMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Donor Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">NGO Platform • Donor Mgmt</p>
                    </div>
                </div>
