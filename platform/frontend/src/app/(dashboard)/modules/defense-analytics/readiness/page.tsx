...
const KPIS = [{"l":"Dashboards Ativos","v":"3.516","t":"+8.7%","d":"up"},{"l":"Queries/Dia","v":"591","t":"+7.1%","d":"up"},{"l":"Dados Processados (GB)","v":"8.104","t":"+16.8%","d":"up"},{"l":"Utilizadores Analytics","v":"1.910","t":"+11.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2603","2026-02-27","6.056","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","749","2026-01-11","2.787","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","857","2026-02-27","2.923","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2201","2026-02-26","3.203","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3212","2026-02-22","3.063","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":906},{"label":"Fev","value":922},{"label":"Mar","value":841},{"label":"Abr","value":1014},{"label":"Mai","value":974},{"label":"Jun","value":936},{"label":"Jul","value":724},{"label":"Ago","value":663},{"label":"Set","value":694},{"label":"Out","value":918},{"label":"Nov","value":984},{"label":"Dez","value":990}];
const MX = 1014;
