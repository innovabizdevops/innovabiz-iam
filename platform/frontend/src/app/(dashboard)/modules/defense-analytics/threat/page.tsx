...
const ACCENT = "#0f172a";
const MODULE = "Defense Analytics";
const PAGE = "Threat";
const KPIS = [{"l":"Dashboards Ativos","v":"2.597","t":"+11.7%","d":"up"},{"l":"Queries/Dia","v":"2193","t":"-2.3%","d":"down"},{"l":"Dados Processados (GB)","v":"5.847","t":"-4.3%","d":"down"},{"l":"Utilizadores Analytics","v":"5.009","t":"+1.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2643","2026-01-13","4.451","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3865","2026-01-24","1.613","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1563","2026-01-27","4.519","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2958","2026-01-12","993","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3971","2026-03-26","4.727","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":371},{"label":"Mar","value":553},{"label":"Abr","value":408},{"label":"Mai","value":538},{"label":"Jun","value":620},{"label":"Jul","value":473},{"label":"Ago","value":506},{"label":"Set","value":671},{"label":"Out","value":599},{"label":"Nov","value":401},{"label":"Dez","value":329}];
const MX = 671;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0f172a'}}>AI</span></h1>
                </div>
