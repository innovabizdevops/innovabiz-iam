...
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"8.390","t":"+2.5%","d":"up"},{"l":"Queries/Dia","v":"4371","t":"+8.8%","d":"up"},{"l":"Dados Processados (GB)","v":"3.014","t":"+11.0%","d":"up"},{"l":"Utilizadores Analytics","v":"4.694","t":"+1.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1429","2026-02-11","7.704","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4602","2026-01-12","6.467","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4842","2026-01-08","8.892","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3877","2026-01-18","6.857","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5058","2026-01-28","4.295","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":738},{"label":"Mar","value":652},{"label":"Abr","value":616},{"label":"Mai","value":650},{"label":"Jun","value":605},{"label":"Jul","value":491},{"label":"Ago","value":725},{"label":"Set","value":852},{"label":"Out","value":795},{"label":"Nov","value":740},{"label":"Dez","value":829}];
const MX = 852;
