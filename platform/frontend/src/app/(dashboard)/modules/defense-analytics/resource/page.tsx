...
const PAGE = "Resource";
const KPIS = [{"l":"Dashboards Ativos","v":"7.557","t":"+7.7%","d":"up"},{"l":"Queries/Dia","v":"1302","t":"-2.7%","d":"down"},{"l":"Dados Processados (GB)","v":"5.776","t":"+3.5%","d":"up"},{"l":"Utilizadores Analytics","v":"5.831","t":"+6.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4697","2026-01-21","7.737","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3474","2026-01-20","6.921","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1803","2026-02-13","5.024","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3932","2026-01-15","5.575","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2118","2026-02-04","1.113","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":713},{"label":"Fev","value":414},{"label":"Mar","value":709},{"label":"Abr","value":576},{"label":"Mai","value":406},{"label":"Jun","value":680},{"label":"Jul","value":735},{"label":"Ago","value":686},{"label":"Set","value":519},{"label":"Out","value":576},{"label":"Nov","value":632},{"label":"Dez","value":613}];
const MX = 735;
