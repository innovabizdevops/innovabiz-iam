...
const KPIS = [
    { label: "Total Registos", value: "3896", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2711", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€343K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "18942496", cells: ["DEF-7496", "Defense Analytics Item 1", "21/5/2026", "€42 596"], status: "active" as const },
    { id: "18946067", cells: ["DEF-2067", "Defense Analytics Item 2", "8/12/2026", "€46 167"], status: "pending" as const },
    { id: "18949638", cells: ["DEF-5638", "Defense Analytics Item 3", "23/7/2026", "€49 738"], status: "completed" as const },
    { id: "18953209", cells: ["DEF-9209", "Defense Analytics Item 4", "10/2/2026", "€3309"], status: "warning" as const },
    { id: "18956780", cells: ["DEF-3780", "Defense Analytics Item 5", "25/9/2026", "€6880"], status: "active" as const },
];
...
export default function DefenseAnalyticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Defense Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Defense Analytics</p>
                    </div>
                </div>
