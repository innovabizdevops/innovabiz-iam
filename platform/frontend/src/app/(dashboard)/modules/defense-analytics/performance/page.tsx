...
const KPIS = [{"l":"Formulários Ativos","v":"2.220","t":"+16.7%","d":"up"},{"l":"Submissões/Dia","v":"221","t":"+11.8%","d":"up"},{"l":"Documentos Gerados","v":"1.402","t":"-2.2%","d":"down"},{"l":"Templates","v":"1.795","t":"+8.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.230","2026-03-08","6.624","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.155","2026-03-18","4.633","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.839","2026-02-04","1.327","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.280","2026-02-02","7.755","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.228","2026-02-23","4.658","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":576},{"label":"Mar","value":552},{"label":"Abr","value":678},{"label":"Mai","value":687},{"label":"Jun","value":488},{"label":"Jul","value":714},{"label":"Ago","value":727},{"label":"Set","value":613},{"label":"Out","value":852},{"label":"Nov","value":781},{"label":"Dez","value":787}];
const MX = 852;
