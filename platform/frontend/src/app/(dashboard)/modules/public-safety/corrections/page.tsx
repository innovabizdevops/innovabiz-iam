...
const PAGE = "Corrections Mgmt";
const KPIS = [{"l":"Total Public Safety","v":"7.802","t":"-0.9%","d":"down"},{"l":"Corrections Mgmt Ativos","v":"8.712","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"81.0%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"73","t":"+13.9%","d":"up"}];
const COLS = ["ID","Corrections Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Safety #001","Public Safety #002","4.914","4.796","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Public Safety #002","Public Safety #003","1.032","5.027","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Safety #003","Public Safety #004","547","7.432","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Public Safety #004","Public Safety #005","6.268","6.758","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Safety #005","Public Safety #001","6.202","6.360","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":881},{"label":"Fev","value":887},{"label":"Mar","value":512},{"label":"Abr","value":887},{"label":"Mai","value":589},{"label":"Jun","value":637},{"label":"Jul","value":589},{"label":"Ago","value":726},{"label":"Set","value":622},{"label":"Out","value":834},{"label":"Nov","value":587},{"label":"Dez","value":815}];
const MX = 887;
