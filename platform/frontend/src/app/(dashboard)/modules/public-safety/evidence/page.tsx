...
const PAGE = "Evidence Management";
const KPIS = [{"l":"Projetos Melhoria","v":"7.607","t":"-3.1%","d":"down"},{"l":"Savings (€)","v":"€34658","t":"+16.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"83.2%","t":"+16.9%","d":"up"},{"l":"Ciclos PDCA","v":"7.255","t":"+2.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.002","€ 23112.01","983","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.742","€ 22743.00","6.194","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.252","€ 17370.91","8.313","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.991","€ 15731.74","7.796","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.341","€ 14800.27","1.881","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":687},{"label":"Mar","value":370},{"label":"Abr","value":488},{"label":"Mai","value":401},{"label":"Jun","value":736},{"label":"Jul","value":672},{"label":"Ago","value":678},{"label":"Set","value":606},{"label":"Out","value":740},{"label":"Nov","value":624},{"label":"Dez","value":732}];
const MX = 742;
