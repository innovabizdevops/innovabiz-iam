...
const PAGE = "License &amp; Permits";
const KPIS = [{"l":"Riscos Identificados","v":"4.421","t":"+1.9%","d":"up"},{"l":"Mitigações Ativas","v":"4.982","t":"-3.9%","d":"down"},{"l":"Score Risco Geral","v":"72","t":"+16.8%","d":"up"},{"l":"Incidentes YTD","v":"7.108","t":"+2.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.986","3.359","4.499","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.585","3.075","7.181","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.595","1.098","7.071","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.890","3.200","6.600","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.161","4.970","5.387","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":983},{"label":"Mar","value":823},{"label":"Abr","value":754},{"label":"Mai","value":844},{"label":"Jun","value":909},{"label":"Jul","value":966},{"label":"Ago","value":725},{"label":"Set","value":1017},{"label":"Out","value":881},{"label":"Nov","value":1039},{"label":"Dez","value":787}];
const MX = 1039;
