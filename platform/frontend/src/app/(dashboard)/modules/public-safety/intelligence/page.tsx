...
const ACCENT = "#dc2626";
const MODULE = "Public Safety & Defense";
const PAGE = "Intelligence Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"1.868","t":"+14.5%","d":"up"},{"l":"Queries/Dia","v":"3868","t":"+17.5%","d":"up"},{"l":"Dados Processados (GB)","v":"2.227","t":"+1.1%","d":"up"},{"l":"Utilizadores Analytics","v":"1.586","t":"-4.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","711","2026-02-18","6.635","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4943","2026-02-14","3.783","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2199","2026-01-05","4.903","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2089","2026-03-27","4.555","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3281","2026-01-06","5.063","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":674},{"label":"Mar","value":595},{"label":"Abr","value":593},{"label":"Mai","value":770},{"label":"Jun","value":558},{"label":"Jul","value":922},{"label":"Ago","value":842},{"label":"Set","value":866},{"label":"Out","value":746},{"label":"Nov","value":537},{"label":"Dez","value":705}];
const MX = 922;
