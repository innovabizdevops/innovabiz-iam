...
const PAGE = "Interagency Comms";
const KPIS = [{"l":"Total Public Safety","v":"3.089","t":"-4.7%","d":"down"},{"l":"Interagency Comms Ativos","v":"3.679","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"92","t":"+6.1%","d":"up"}];
const COLS = ["ID","Interagency Comms","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Safety #001","Public Safety #002","4.897","3.107","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Public Safety #002","Public Safety #003","4.900","221","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Safety #003","Public Safety #004","2.711","5.824","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Public Safety #004","Public Safety #005","5.227","7.057","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Safety #005","Public Safety #001","1.808","2.128","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":435},{"label":"Fev","value":640},{"label":"Mar","value":607},{"label":"Abr","value":524},{"label":"Mai","value":585},{"label":"Jun","value":409},{"label":"Jul","value":324},{"label":"Ago","value":636},{"label":"Set","value":543},{"label":"Out","value":696},{"label":"Nov","value":330},{"label":"Dez","value":322}];
const MX = 696;
