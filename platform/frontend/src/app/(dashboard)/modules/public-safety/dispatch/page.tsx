...
const PAGE = "Emergency Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"1.999","t":"+0.1%","d":"up"},{"l":"Viagens/Dia","v":"320","t":"-4.8%","d":"down"},{"l":"Pontualidade (%)","v":"80.6%","t":"-4.1%","d":"down"},{"l":"Passageiros/Dia","v":"2185","t":"+11.4%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-11","2026-02-04","3.641","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-14","2026-02-13","5.336","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-05","2026-03-24","8.087","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-19","2026-01-13","2.534","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-15","2026-03-02","2.696","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":715},{"label":"Mar","value":578},{"label":"Abr","value":437},{"label":"Mai","value":575},{"label":"Jun","value":478},{"label":"Jul","value":689},{"label":"Ago","value":377},{"label":"Set","value":593},{"label":"Out","value":632},{"label":"Nov","value":662},{"label":"Dez","value":677}];
const MX = 715;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>CAD</span></h1>
                </div>
