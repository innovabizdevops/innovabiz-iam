...
const PAGE = "Body Cam Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"1.674","t":"+17.2%","d":"up"},{"l":"Queries/Dia","v":"4151","t":"-1.4%","d":"down"},{"l":"Dados Processados (GB)","v":"1.604","t":"+4.5%","d":"up"},{"l":"Utilizadores Analytics","v":"1.263","t":"+3.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3927","2026-02-01","8.083","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1469","2026-01-06","683","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3960","2026-02-14","1.135","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1081","2026-02-18","7.485","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","730","2026-03-21","2.456","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":305},{"label":"Mar","value":562},{"label":"Abr","value":485},{"label":"Mai","value":608},{"label":"Jun","value":476},{"label":"Jul","value":383},{"label":"Ago","value":520},{"label":"Set","value":414},{"label":"Out","value":316},{"label":"Nov","value":624},{"label":"Dez","value":528}];
const MX = 624;
