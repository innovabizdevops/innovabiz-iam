...
const PAGE = "GIS Mapping";
const KPIS = [{"l":"Total Public Safety","v":"3.016","t":"+12.5%","d":"up"},{"l":"GIS Mapping Ativos","v":"987","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"70.4%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"68","t":"+14.3%","d":"up"}];
const COLS = ["ID","GIS Mapping","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Safety #001","Public Safety #002","6.283","8.886","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Public Safety #002","Public Safety #003","3.964","2.902","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Safety #003","Public Safety #004","3.866","7.632","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Public Safety #004","Public Safety #005","1.150","8.757","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Safety #005","Public Safety #001","7.710","6.270","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":766},{"label":"Mar","value":485},{"label":"Abr","value":706},{"label":"Mai","value":519},{"label":"Jun","value":571},{"label":"Jul","value":669},{"label":"Ago","value":559},{"label":"Set","value":548},{"label":"Out","value":792},{"label":"Nov","value":609},{"label":"Dez","value":564}];
const MX = 792;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>GIS</span></h1>
                </div>
