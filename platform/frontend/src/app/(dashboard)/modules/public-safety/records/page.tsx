...
const PAGE = "Records Management";
const KPIS = [{"l":"Projetos Melhoria","v":"9.081","t":"+13.3%","d":"up"},{"l":"Savings (€)","v":"€28280","t":"+9.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"75.8%","t":"+3.2%","d":"up"},{"l":"Ciclos PDCA","v":"334","t":"+11.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.747","€ 23958.30","7.761","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.209","€ 47387.67","118","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.857","€ 43857.58","6.049","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.190","€ 25047.40","6.977","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.020","€ 16381.47","5.602","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":902},{"label":"Fev","value":649},{"label":"Mar","value":648},{"label":"Abr","value":850},{"label":"Mai","value":755},{"label":"Jun","value":998},{"label":"Jul","value":962},{"label":"Ago","value":628},{"label":"Set","value":859},{"label":"Out","value":742},{"label":"Nov","value":762},{"label":"Dez","value":692}];
const MX = 998;
