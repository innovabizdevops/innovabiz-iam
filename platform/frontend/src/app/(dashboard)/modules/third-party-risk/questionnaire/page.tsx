...
const PAGE = "Questionnaire";
const KPIS = [{"l":"Riscos Identificados","v":"1.442","t":"+7.2%","d":"up"},{"l":"Mitigações Ativas","v":"8.639","t":"+17.3%","d":"up"},{"l":"Score Risco Geral","v":"63","t":"+17.0%","d":"up"},{"l":"Incidentes YTD","v":"2.824","t":"+14.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.306","1.788","6.508","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.896","7.407","1.740","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.090","8.700","2.760","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.660","902","3.358","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.255","3.008","8.824","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":518},{"label":"Mar","value":640},{"label":"Abr","value":624},{"label":"Mai","value":498},{"label":"Jun","value":515},{"label":"Jul","value":670},{"label":"Ago","value":445},{"label":"Set","value":780},{"label":"Out","value":710},{"label":"Nov","value":761},{"label":"Dez","value":602}];
const MX = 780;
