...
const KPIS = [{"l":"Riscos Identificados","v":"5.284","t":"+17.5%","d":"up"},{"l":"Mitigações Ativas","v":"735","t":"-1.9%","d":"down"},{"l":"Score Risco Geral","v":"80","t":"+16.3%","d":"up"},{"l":"Incidentes YTD","v":"7.340","t":"+11.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.950","4.977","8.698","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.780","5.054","7.549","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.114","6.909","7.901","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.521","6.065","3.213","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.111","8.564","6.320","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":539},{"label":"Fev","value":423},{"label":"Mar","value":511},{"label":"Abr","value":439},{"label":"Mai","value":431},{"label":"Jun","value":598},{"label":"Jul","value":486},{"label":"Ago","value":533},{"label":"Set","value":357},{"label":"Out","value":554},{"label":"Nov","value":336},{"label":"Dez","value":470}];
const MX = 598;
