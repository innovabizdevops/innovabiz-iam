...
const ACCENT = "#4338ca";
const MODULE = "Third-Party Risk";
const PAGE = "Continuous Monitor";
const KPIS = [{"l":"Riscos Identificados","v":"4.480","t":"+13.2%","d":"up"},{"l":"Mitigações Ativas","v":"2.342","t":"+15.1%","d":"up"},{"l":"Score Risco Geral","v":"92","t":"+12.2%","d":"up"},{"l":"Incidentes YTD","v":"4.852","t":"-4.7%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.249","482","3.809","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.503","8.388","6.001","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.810","6.598","453","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.925","4.968","3.728","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.252","6.048","8.250","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":561},{"label":"Mar","value":650},{"label":"Abr","value":554},{"label":"Mai","value":887},{"label":"Jun","value":667},{"label":"Jul","value":830},{"label":"Ago","value":874},{"label":"Set","value":693},{"label":"Out","value":625},{"label":"Nov","value":532},{"label":"Dez","value":722}];
const MX = 887;
