...
const KPIS = [{"l":"Riscos Identificados","v":"2.458","t":"+16.6%","d":"up"},{"l":"Mitigações Ativas","v":"8.011","t":"+15.0%","d":"up"},{"l":"Score Risco Geral","v":"94","t":"-0.6%","d":"down"},{"l":"Incidentes YTD","v":"567","t":"+0.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.957","5.332","9.062","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.535","1.366","7.446","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.990","1.015","9.091","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.808","3.109","7.937","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.990","1.188","8.386","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":814},{"label":"Fev","value":557},{"label":"Mar","value":691},{"label":"Abr","value":724},{"label":"Mai","value":728},{"label":"Jun","value":908},{"label":"Jul","value":893},{"label":"Ago","value":725},{"label":"Set","value":821},{"label":"Out","value":559},{"label":"Nov","value":549},{"label":"Dez","value":626}];
const MX = 908;
