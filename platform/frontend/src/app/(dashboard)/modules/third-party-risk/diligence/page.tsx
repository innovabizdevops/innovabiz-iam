...
const KPIS = [{"l":"Riscos Identificados","v":"2.221","t":"+12.0%","d":"up"},{"l":"Mitigações Ativas","v":"6.135","t":"+0.5%","d":"up"},{"l":"Score Risco Geral","v":"72","t":"+3.8%","d":"up"},{"l":"Incidentes YTD","v":"4.879","t":"+0.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","386","6.415","697","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.044","6.086","216","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.447","7.520","7.491","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.850","6.832","8.218","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.166","4.909","477","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":671},{"label":"Mar","value":900},{"label":"Abr","value":516},{"label":"Mai","value":698},{"label":"Jun","value":738},{"label":"Jul","value":626},{"label":"Ago","value":741},{"label":"Set","value":867},{"label":"Out","value":874},{"label":"Nov","value":689},{"label":"Dez","value":843}];
const MX = 900;
