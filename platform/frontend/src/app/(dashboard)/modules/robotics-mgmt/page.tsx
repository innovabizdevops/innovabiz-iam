...
/* ═══ Robotics Management — Dashboard ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total Registos", value: "1282", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3631", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€367K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "-15%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "856677882", cells: ["ROB-4882", "Robotics Management Item 1", "19/7/2026", "€27 982"], status: "active" as const },
    { id: "856681453", cells: ["ROB-8453", "Robotics Management Item 2", "6/2/2026", "€31 553"], status: "pending" as const },
    { id: "856685024", cells: ["ROB-3024", "Robotics Management Item 3", "21/9/2026", "€35 124"], status: "completed" as const },
    { id: "856688595", cells: ["ROB-6595", "Robotics Management Item 4", "8/4/2026", "€38 695"], status: "warning" as const },
    { id: "856692166", cells: ["ROB-1166", "Robotics Management Item 5", "23/11/2026", "€42 266"], status: "active" as const },
];
...
export default function RoboticsManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Robotics Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Robotics Management</p>
                    </div>
                </div>
