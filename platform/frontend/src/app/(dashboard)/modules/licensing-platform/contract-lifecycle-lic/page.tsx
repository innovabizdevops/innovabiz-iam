...
/* ═══ Licensing Platform — Contract Lifecycle Lic ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "1151", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "487", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2406", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "98%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "437731411", cells: ["LIC-8411", "Contract Lifecycle Lic Item 1", "20/8/2026", "€31 511"], status: "active" as const },
    { id: "437734982", cells: ["LIC-2982", "Contract Lifecycle Lic Item 2", "7/3/2026", "€35 082"], status: "pending" as const },
    { id: "437738553", cells: ["LIC-6553", "Contract Lifecycle Lic Item 3", "22/10/2026", "€38 653"], status: "completed" as const },
    { id: "437742124", cells: ["LIC-1124", "Contract Lifecycle Lic Item 4", "9/5/2026", "€42 224"], status: "warning" as const },
    { id: "437745695", cells: ["LIC-4695", "Contract Lifecycle Lic Item 5", "24/12/2026", "€45 795"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 71 }, { label: "Fev", value: 80 }, { label: "Mar", value: 89 }, { label: "Abr", value: 98 }, { label: "Mai", value: 27 }, { label: "Jun", value: 36 }];
...
export default function LicensingPlatformContractLifecycleLicPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Contract Lifecycle Lic</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Licensing Platform • Contract Lifecycle Lic</p>
                    </div>
                </div>
