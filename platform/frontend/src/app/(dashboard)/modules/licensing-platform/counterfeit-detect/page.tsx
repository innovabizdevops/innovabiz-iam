...
/* ═══ Licensing Platform — Counterfeit Detect ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "1854", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "412", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3585", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "46255400", cells: ["LIC-5400", "Counterfeit Detect Item 1", "17/9/2026", "€5500"], status: "active" as const },
    { id: "46258971", cells: ["LIC-8971", "Counterfeit Detect Item 2", "4/4/2026", "€9071"], status: "pending" as const },
    { id: "46262542", cells: ["LIC-3542", "Counterfeit Detect Item 3", "19/11/2026", "€12 642"], status: "completed" as const },
    { id: "46266113", cells: ["LIC-7113", "Counterfeit Detect Item 4", "6/6/2026", "€16 213"], status: "warning" as const },
    { id: "46269684", cells: ["LIC-1684", "Counterfeit Detect Item 5", "21/1/2026", "€19 784"], status: "active" as const },
];
...
export default function LicensingPlatformCounterfeitDetectPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Counterfeit Detect</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Licensing Platform • Counterfeit Detect</p>
                    </div>
                </div>
