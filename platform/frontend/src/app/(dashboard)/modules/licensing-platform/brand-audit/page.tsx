...
/* ═══ Licensing Platform — Brand Audit ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "29", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "139", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2264", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "281914647", cells: ["LIC-8647", "Brand Audit Item 1", "8/4/2026", "€14 747"], status: "active" as const },
    { id: "281918218", cells: ["LIC-3218", "Brand Audit Item 2", "23/11/2026", "€18 318"], status: "pending" as const },
    { id: "281921789", cells: ["LIC-6789", "Brand Audit Item 3", "10/6/2026", "€21 889"], status: "completed" as const },
    { id: "281925360", cells: ["LIC-1360", "Brand Audit Item 4", "25/1/2026", "€25 460"], status: "warning" as const },
    { id: "281928931", cells: ["LIC-4931", "Brand Audit Item 5", "12/8/2026", "€29 031"], status: "active" as const },
];
...
export default function LicensingPlatformBrandAuditPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Brand Audit</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Licensing Platform • Brand Audit</p>
                    </div>
                </div>
