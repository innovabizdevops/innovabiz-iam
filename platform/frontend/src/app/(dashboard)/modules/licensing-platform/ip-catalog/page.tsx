...
/* ═══ Licensing Platform — Ip Catalog ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "1799", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "127", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3838", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "981019691", cells: ["LIC-2691", "Ip Catalog Item 1", "16/12/2026", "€19 791"], status: "active" as const },
    { id: "981023262", cells: ["LIC-6262", "Ip Catalog Item 2", "3/7/2026", "€23 362"], status: "pending" as const },
    { id: "981026833", cells: ["LIC-9833", "Ip Catalog Item 3", "18/2/2026", "€26 933"], status: "completed" as const },
    { id: "981030404", cells: ["LIC-4404", "Ip Catalog Item 4", "5/9/2026", "€30 504"], status: "warning" as const },
    { id: "981033975", cells: ["LIC-7975", "Ip Catalog Item 5", "20/4/2026", "€34 075"], status: "active" as const },
];
...
export default function LicensingPlatformIpCatalogPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ip Catalog</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Licensing Platform • Ip Catalog</p>
                    </div>
                </div>
