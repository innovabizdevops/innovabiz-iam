...
/* ═══ Licensing Platform — Product Approval ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "1569", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "35", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1482", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1286344799", cells: ["LIC-2799", "Product Approval Item 1", "20/12/2026", "€44 899"], status: "active" as const },
    { id: "1286348370", cells: ["LIC-6370", "Product Approval Item 2", "7/7/2026", "€48 470"], status: "pending" as const },
    { id: "1286351941", cells: ["LIC-9941", "Product Approval Item 3", "22/2/2026", "€2041"], status: "completed" as const },
    { id: "1286355512", cells: ["LIC-4512", "Product Approval Item 4", "9/9/2026", "€5612"], status: "warning" as const },
    { id: "1286359083", cells: ["LIC-8083", "Product Approval Item 5", "24/4/2026", "€9183"], status: "active" as const },
];
...
export default function LicensingPlatformProductApprovalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Product Approval</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Licensing Platform • Product Approval</p>
                    </div>
                </div>
