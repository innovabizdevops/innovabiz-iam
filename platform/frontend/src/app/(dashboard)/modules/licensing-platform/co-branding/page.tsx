...
/* ═══ Licensing Platform — Co Branding ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "3355", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "144", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2965", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1632182396", cells: ["LIC-6396", "Co Branding Item 1", "13/9/2026", "€32 496"], status: "active" as const },
    { id: "1632185967", cells: ["LIC-9967", "Co Branding Item 2", "28/4/2026", "€36 067"], status: "pending" as const },
    { id: "1632189538", cells: ["LIC-4538", "Co Branding Item 3", "15/11/2026", "€39 638"], status: "completed" as const },
    { id: "1632193109", cells: ["LIC-8109", "Co Branding Item 4", "2/6/2026", "€43 209"], status: "warning" as const },
    { id: "1632196680", cells: ["LIC-2680", "Co Branding Item 5", "17/1/2026", "€46 780"], status: "active" as const },
];
...
export default function LicensingPlatformCoBrandingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Co Branding</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Licensing Platform • Co Branding</p>
                    </div>
                </div>
