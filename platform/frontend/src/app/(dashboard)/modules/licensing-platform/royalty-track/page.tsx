...
/* ═══ Licensing Platform — Royalty Track ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "398", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "176", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3256", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "727834060", cells: ["LIC-5060", "Royalty Track Item 1", "17/5/2026", "€34 160"], status: "active" as const },
    { id: "727837631", cells: ["LIC-8631", "Royalty Track Item 2", "4/12/2026", "€37 731"], status: "pending" as const },
    { id: "727841202", cells: ["LIC-3202", "Royalty Track Item 3", "19/7/2026", "€41 302"], status: "completed" as const },
    { id: "727844773", cells: ["LIC-6773", "Royalty Track Item 4", "6/2/2026", "€44 873"], status: "warning" as const },
    { id: "727848344", cells: ["LIC-1344", "Royalty Track Item 5", "21/9/2026", "€48 444"], status: "active" as const },
];
...
export default function LicensingPlatformRoyaltyTrackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Royalty Track</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Licensing Platform • Royalty Track</p>
                    </div>
                </div>
