...
/* ═══ Licensing Platform — Territory Rights ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "1230", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "252", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1530", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "83%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "814125736", cells: ["LIC-4736", "Territory Rights Item 1", "5/5/2026", "€25 836"], status: "active" as const },
    { id: "814129307", cells: ["LIC-8307", "Territory Rights Item 2", "20/12/2026", "€29 407"], status: "pending" as const },
    { id: "814132878", cells: ["LIC-2878", "Territory Rights Item 3", "7/7/2026", "€32 978"], status: "completed" as const },
    { id: "814136449", cells: ["LIC-6449", "Territory Rights Item 4", "22/2/2026", "€36 549"], status: "warning" as const },
    { id: "814140020", cells: ["LIC-1020", "Territory Rights Item 5", "9/9/2026", "€40 120"], status: "active" as const },
];
...
export default function LicensingPlatformTerritoryRightsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Territory Rights</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Licensing Platform • Territory Rights</p>
                    </div>
                </div>
