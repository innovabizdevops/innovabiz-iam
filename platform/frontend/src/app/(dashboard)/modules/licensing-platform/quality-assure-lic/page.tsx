...
/* ═══ Licensing Platform — Quality Assure Lic ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "2868", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "11", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "253", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "96%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "11215079", cells: ["LIC-2079", "Quality Assure Lic Item 1", "16/12/2026", "€15 179"], status: "active" as const },
    { id: "11218650", cells: ["LIC-5650", "Quality Assure Lic Item 2", "3/7/2026", "€18 750"], status: "pending" as const },
    { id: "11222221", cells: ["LIC-9221", "Quality Assure Lic Item 3", "18/2/2026", "€22 321"], status: "completed" as const },
    { id: "11225792", cells: ["LIC-3792", "Quality Assure Lic Item 4", "5/9/2026", "€25 892"], status: "warning" as const },
    { id: "11229363", cells: ["LIC-7363", "Quality Assure Lic Item 5", "20/4/2026", "€29 463"], status: "active" as const },
];
...
export default function LicensingPlatformQualityAssureLicPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Quality Assure Lic</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Licensing Platform • Quality Assure Lic</p>
                    </div>
                </div>
