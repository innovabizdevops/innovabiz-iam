...
/* ═══ Licensing Platform — License Agreement ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "356", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "356", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3593", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "95%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1411177408", cells: ["LIC-5408", "License Agreement Item 1", "5/5/2026", "€27 508"], status: "active" as const },
    { id: "1411180979", cells: ["LIC-8979", "License Agreement Item 2", "20/12/2026", "€31 079"], status: "pending" as const },
    { id: "1411184550", cells: ["LIC-3550", "License Agreement Item 3", "7/7/2026", "€34 650"], status: "completed" as const },
    { id: "1411188121", cells: ["LIC-7121", "License Agreement Item 4", "22/2/2026", "€38 221"], status: "warning" as const },
    { id: "1411191692", cells: ["LIC-1692", "License Agreement Item 5", "9/9/2026", "€41 792"], status: "active" as const },
];
...
export default function LicensingPlatformLicenseAgreementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">License Agreement</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Licensing Platform • License Agreement</p>
                    </div>
                </div>
