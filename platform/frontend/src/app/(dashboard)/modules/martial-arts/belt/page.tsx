...
const ACCENT = "#14532d";
const MODULE = "Martial Arts Academy";
const PAGE = "Belt/Rank";
const KPIS = [{"l":"Total Martial Arts","v":"2.796","t":"+6.5%","d":"up"},{"l":"Belt/Rank Ativos","v":"6.405","t":"+15.3%","d":"up"},{"l":"Eficiência (%)","v":"66.3%","t":"+15.9%","d":"up"},{"l":"Score Performance","v":"91","t":"+0.7%","d":"up"}];
const COLS = ["ID","Belt/Rank","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Martial Arts #001","Martial Arts #002","7.864","2.116","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Martial Arts #002","Martial Arts #003","1.748","1.786","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Martial Arts #003","Martial Arts #004","7.479","625","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Martial Arts #004","Martial Arts #005","4.115","7.686","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Martial Arts #005","Martial Arts #001","3.134","8.918","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":858},{"label":"Mar","value":517},{"label":"Abr","value":536},{"label":"Mai","value":697},{"label":"Jun","value":689},{"label":"Jul","value":648},{"label":"Ago","value":762},{"label":"Set","value":662},{"label":"Out","value":519},{"label":"Nov","value":733},{"label":"Dez","value":658}];
const MX = 866;
