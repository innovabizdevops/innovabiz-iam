...
const KPIS = [{"l":"Atletas Registados","v":"7.808","t":"+1.3%","d":"up"},{"l":"Treinos/Semana","v":"2298","t":"+9.7%","d":"up"},{"l":"Competições","v":"6.884","t":"+3.3%","d":"up"},{"l":"Performance Score","v":"68","t":"-0.2%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.564","1.142","2.800","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.301","8.288","5.292","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.866","6.515","8.417","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.302","7.722","3.176","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.324","5.862","2.334","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":727},{"label":"Mar","value":548},{"label":"Abr","value":534},{"label":"Mai","value":603},{"label":"Jun","value":870},{"label":"Jul","value":610},{"label":"Ago","value":628},{"label":"Set","value":509},{"label":"Out","value":866},{"label":"Nov","value":566},{"label":"Dez","value":628}];
const MX = 870;
