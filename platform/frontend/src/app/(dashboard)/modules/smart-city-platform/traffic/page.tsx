...
const PAGE = "Traffic";
const KPIS = [{"l":"Formulários Ativos","v":"2.598","t":"+17.4%","d":"up"},{"l":"Submissões/Dia","v":"1972","t":"-4.3%","d":"down"},{"l":"Documentos Gerados","v":"2.495","t":"+4.7%","d":"up"},{"l":"Templates","v":"8.259","t":"+7.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.857","2026-03-10","8.601","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.155","2026-03-18","273","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.945","2026-02-09","3.920","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.058","2026-03-06","8.149","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.196","2026-01-06","5.125","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":944},{"label":"Fev","value":901},{"label":"Mar","value":722},{"label":"Abr","value":1037},{"label":"Mai","value":1065},{"label":"Jun","value":983},{"label":"Jul","value":863},{"label":"Ago","value":989},{"label":"Set","value":1009},{"label":"Out","value":697},{"label":"Nov","value":769},{"label":"Dez","value":996}];
const MX = 1065;
