...
const ACCENT = "#0369a1";
const MODULE = "Smart City Platform";
const PAGE = "Waste";
const KPIS = [{"l":"Formulários Ativos","v":"5.795","t":"+18.0%","d":"up"},{"l":"Submissões/Dia","v":"2106","t":"-2.0%","d":"down"},{"l":"Documentos Gerados","v":"3.951","t":"+9.8%","d":"up"},{"l":"Templates","v":"2.801","t":"+7.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","800","2026-03-21","2.001","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.570","2026-01-03","2.733","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.778","2026-01-11","4.293","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.188","2026-02-09","3.664","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.469","2026-02-25","334","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":997},{"label":"Fev","value":1060},{"label":"Mar","value":1023},{"label":"Abr","value":716},{"label":"Mai","value":892},{"label":"Jun","value":973},{"label":"Jul","value":681},{"label":"Ago","value":961},{"label":"Set","value":820},{"label":"Out","value":1069},{"label":"Nov","value":774},{"label":"Dez","value":685}];
const MX = 1069;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0369a1'}}>IoT</span></h1>
                </div>
