...
/* ═══ Smart City Platform — Dashboard ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total Registos", value: "6372", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4585", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€320K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1492035272", cells: ["SMA-7272", "Smart City Platform Item 1", "1/9/2026", "€35 372"], status: "active" as const },
    { id: "1492038843", cells: ["SMA-1843", "Smart City Platform Item 2", "16/4/2026", "€38 943"], status: "pending" as const },
    { id: "1492042414", cells: ["SMA-5414", "Smart City Platform Item 3", "3/11/2026", "€42 514"], status: "completed" as const },
    { id: "1492045985", cells: ["SMA-8985", "Smart City Platform Item 4", "18/6/2026", "€46 085"], status: "warning" as const },
    { id: "1492049556", cells: ["SMA-3556", "Smart City Platform Item 5", "5/1/2026", "€49 656"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Smart City Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Smart City Platform</p>
                    </div>
                </div>
