...
const PAGE = "Safety";
const KPIS = [{"l":"Formulários Ativos","v":"1.456","t":"-0.8%","d":"down"},{"l":"Submissões/Dia","v":"1500","t":"+14.7%","d":"up"},{"l":"Documentos Gerados","v":"8.878","t":"+5.4%","d":"up"},{"l":"Templates","v":"5.185","t":"-4.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.699","2026-02-03","1.839","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.400","2026-02-25","3.264","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.161","2026-01-03","6.685","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.667","2026-02-01","3.311","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","762","2026-01-08","2.696","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":325},{"label":"Fev","value":380},{"label":"Mar","value":499},{"label":"Abr","value":596},{"label":"Mai","value":345},{"label":"Jun","value":392},{"label":"Jul","value":330},{"label":"Ago","value":497},{"label":"Set","value":565},{"label":"Out","value":450},{"label":"Nov","value":444},{"label":"Dez","value":368}];
const MX = 596;
