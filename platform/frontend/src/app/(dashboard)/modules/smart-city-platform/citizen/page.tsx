...
const PAGE = "Citizen";
const KPIS = [{"l":"Formulários Ativos","v":"5.230","t":"+12.7%","d":"up"},{"l":"Submissões/Dia","v":"4695","t":"+5.1%","d":"up"},{"l":"Documentos Gerados","v":"608","t":"+16.2%","d":"up"},{"l":"Templates","v":"4.340","t":"+17.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","863","2026-02-15","292","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.807","2026-02-06","4.462","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.504","2026-01-28","573","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.599","2026-02-16","7.258","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.813","2026-02-11","5.632","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":352},{"label":"Mar","value":436},{"label":"Abr","value":548},{"label":"Mai","value":634},{"label":"Jun","value":657},{"label":"Jul","value":651},{"label":"Ago","value":357},{"label":"Set","value":634},{"label":"Out","value":653},{"label":"Nov","value":625},{"label":"Dez","value":586}];
const MX = 690;
