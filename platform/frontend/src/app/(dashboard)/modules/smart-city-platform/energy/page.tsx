...
const PAGE = "Energy";
const KPIS = [{"l":"Formulários Ativos","v":"1.978","t":"-0.8%","d":"down"},{"l":"Submissões/Dia","v":"1860","t":"+2.7%","d":"up"},{"l":"Documentos Gerados","v":"4.572","t":"+1.2%","d":"up"},{"l":"Templates","v":"5.511","t":"-0.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","831","2026-02-28","4.824","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.792","2026-02-08","205","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.669","2026-03-08","741","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.479","2026-01-02","1.595","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.763","2026-02-15","8.846","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":597},{"label":"Fev","value":645},{"label":"Mar","value":901},{"label":"Abr","value":648},{"label":"Mai","value":614},{"label":"Jun","value":722},{"label":"Jul","value":791},{"label":"Ago","value":935},{"label":"Set","value":718},{"label":"Out","value":934},{"label":"Nov","value":848},{"label":"Dez","value":721}];
const MX = 935;
