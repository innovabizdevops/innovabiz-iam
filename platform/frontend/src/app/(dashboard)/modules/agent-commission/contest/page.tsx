...
const ACCENT = "#6366f1";
const MODULE = "Agent Commission";
const PAGE = "Contest";
const KPIS = [{"l":"Vendas YTD (€)","v":"€80705","t":"-4.7%","d":"down"},{"l":"Pipeline (€)","v":"€66211","t":"+7.8%","d":"up"},{"l":"Atingimento Quota (%)","v":"75.3%","t":"-2.9%","d":"down"},{"l":"Win Rate (%)","v":"72.6%","t":"+2.0%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 3691.16","€ 27738.63","€ 40936.64","76.5%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 43424.72","€ 3280.47","€ 43590.86","85.3%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 35319.12","€ 41694.68","€ 48326.52","85.4%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 16758.50","€ 15709.64","€ 7508.33","92.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 31755.93","€ 49056.77","€ 49753.80","79.1%"],"status":"active"}];
const CHART = [{"label":"Jan","value":920},{"label":"Fev","value":857},{"label":"Mar","value":928},{"label":"Abr","value":959},{"label":"Mai","value":939},{"label":"Jun","value":984},{"label":"Jul","value":987},{"label":"Ago","value":798},{"label":"Set","value":858},{"label":"Out","value":830},{"label":"Nov","value":781},{"label":"Dez","value":1064}];
const MX = 1064;
