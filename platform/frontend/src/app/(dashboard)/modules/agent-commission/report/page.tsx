...
const PAGE = "Report";
const KPIS = [{"l":"Vendas YTD (€)","v":"€33913","t":"+12.0%","d":"up"},{"l":"Pipeline (€)","v":"€92399","t":"+0.8%","d":"up"},{"l":"Atingimento Quota (%)","v":"73.6%","t":"-1.6%","d":"down"},{"l":"Win Rate (%)","v":"70.9%","t":"-4.8%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 3710.89","€ 49581.86","€ 49152.30","92.1%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 16339.58","€ 6427.07","€ 11716.39","76.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 38170.84","€ 38522.06","€ 410.49","80.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 44368.77","€ 12778.09","€ 17384.12","96.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 2787.62","€ 29043.66","€ 39276.57","98.5%"],"status":"active"}];
const CHART = [{"label":"Jan","value":457},{"label":"Fev","value":259},{"label":"Mar","value":610},{"label":"Abr","value":481},{"label":"Mai","value":540},{"label":"Jun","value":451},{"label":"Jul","value":407},{"label":"Ago","value":381},{"label":"Set","value":477},{"label":"Out","value":453},{"label":"Nov","value":307},{"label":"Dez","value":521}];
const MX = 610;
