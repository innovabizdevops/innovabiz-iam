...
const PAGE = "Tracking";
const KPIS = [{"l":"Vendas YTD (€)","v":"€68821","t":"+9.4%","d":"up"},{"l":"Pipeline (€)","v":"€93969","t":"+8.4%","d":"up"},{"l":"Atingimento Quota (%)","v":"72.0%","t":"-4.6%","d":"down"},{"l":"Win Rate (%)","v":"72.6%","t":"+12.4%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 1860.69","€ 30556.15","€ 43413.79","74.1%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 48188.78","€ 44888.08","€ 11787.58","78.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 20043.42","€ 13373.30","€ 43707.38","87.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 13654.46","€ 13755.64","€ 22915.92","76.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 35785.80","€ 17158.22","€ 23201.21","76.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":936},{"label":"Mar","value":659},{"label":"Abr","value":609},{"label":"Mai","value":669},{"label":"Jun","value":842},{"label":"Jul","value":766},{"label":"Ago","value":911},{"label":"Set","value":708},{"label":"Out","value":732},{"label":"Nov","value":923},{"label":"Dez","value":948}];
const MX = 948;
