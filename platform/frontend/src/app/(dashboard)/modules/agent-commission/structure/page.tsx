...
const KPIS = [{"l":"Vendas YTD (€)","v":"€40671","t":"+15.4%","d":"up"},{"l":"Pipeline (€)","v":"€48037","t":"+1.0%","d":"up"},{"l":"Atingimento Quota (%)","v":"76.1%","t":"+2.8%","d":"up"},{"l":"Win Rate (%)","v":"65.1%","t":"+16.7%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 42835.03","€ 14726.56","€ 7788.78","71.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 25255.75","€ 12238.37","€ 45419.12","82.3%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 25201.04","€ 42670.85","€ 25614.55","81.5%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 24428.00","€ 23043.78","€ 24130.11","81.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 7584.38","€ 37755.37","€ 15379.94","87.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":865},{"label":"Fev","value":874},{"label":"Mar","value":587},{"label":"Abr","value":756},{"label":"Mai","value":793},{"label":"Jun","value":694},{"label":"Jul","value":674},{"label":"Ago","value":648},{"label":"Set","value":827},{"label":"Out","value":876},{"label":"Nov","value":617},{"label":"Dez","value":534}];
const MX = 876;
