...
const PAGE = "Override";
const KPIS = [{"l":"Vendas YTD (€)","v":"€31982","t":"+2.1%","d":"up"},{"l":"Pipeline (€)","v":"€36250","t":"-5.5%","d":"down"},{"l":"Atingimento Quota (%)","v":"73.2%","t":"+2.0%","d":"up"},{"l":"Win Rate (%)","v":"71.9%","t":"+2.3%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 13826.75","€ 33302.61","€ 302.17","100.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 28057.79","€ 1798.03","€ 5304.79","91.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 46413.86","€ 36898.49","€ 992.99","70.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 20445.18","€ 28123.22","€ 9121.44","71.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 4381.32","€ 21907.62","€ 43825.94","90.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":273},{"label":"Fev","value":498},{"label":"Mar","value":325},{"label":"Abr","value":487},{"label":"Mai","value":395},{"label":"Jun","value":441},{"label":"Jul","value":449},{"label":"Ago","value":337},{"label":"Set","value":634},{"label":"Out","value":365},{"label":"Nov","value":428},{"label":"Dez","value":609}];
const MX = 634;
