...
const PAGE = "Prevent";
const KPIS = [{"l":"Tickets Abertos","v":"544","t":"-0.1%","d":"down"},{"l":"SLA Cumprido (%)","v":"72.5%","t":"+6.2%","d":"up"},{"l":"MTTR (h)","v":"161h","t":"+15.6%","d":"up"},{"l":"Satisfação (%)","v":"85.5%","t":"+14.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.671","8.160","8.299","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.867","2.578","7.969","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","821","4.863","5.022","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.013","1.344","3.328","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.604","1.161","6.438","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1048},{"label":"Fev","value":919},{"label":"Mar","value":1041},{"label":"Abr","value":804},{"label":"Mai","value":942},{"label":"Jun","value":994},{"label":"Jul","value":983},{"label":"Ago","value":927},{"label":"Set","value":865},{"label":"Out","value":1026},{"label":"Nov","value":923},{"label":"Dez","value":1020}];
const MX = 1048;
