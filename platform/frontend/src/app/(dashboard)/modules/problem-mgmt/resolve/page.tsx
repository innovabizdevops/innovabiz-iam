...
const PAGE = "Resolve";
const KPIS = [{"l":"Tickets Abertos","v":"1.588","t":"+17.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"79.9%","t":"+13.7%","d":"up"},{"l":"MTTR (h)","v":"21h","t":"-3.8%","d":"down"},{"l":"Satisfação (%)","v":"74.6%","t":"+13.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.815","6.014","6.812","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.410","6.639","979","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.898","2.397","3.721","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.876","2.921","2.983","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.991","726","7.922","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":878},{"label":"Fev","value":670},{"label":"Mar","value":875},{"label":"Abr","value":732},{"label":"Mai","value":672},{"label":"Jun","value":646},{"label":"Jul","value":723},{"label":"Ago","value":843},{"label":"Set","value":550},{"label":"Out","value":698},{"label":"Nov","value":849},{"label":"Dez","value":713}];
const MX = 878;
