...
const PAGE = "Analyze";
const KPIS = [{"l":"Tickets Abertos","v":"8.277","t":"+14.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"82.3%","t":"+15.1%","d":"up"},{"l":"MTTR (h)","v":"182h","t":"+10.4%","d":"up"},{"l":"Satisfação (%)","v":"85.8%","t":"-2.0%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.880","3.647","8.696","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.693","8.483","5.970","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","949","8.125","283","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.735","731","1.081","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.740","4.287","2.438","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":680},{"label":"Mar","value":485},{"label":"Abr","value":763},{"label":"Mai","value":537},{"label":"Jun","value":600},{"label":"Jul","value":554},{"label":"Ago","value":784},{"label":"Set","value":495},{"label":"Out","value":686},{"label":"Nov","value":735},{"label":"Dez","value":513}];
const MX = 784;
