...
const ACCENT = "#1e293b";
const MODULE = "Problem Management (ITIL)";
const PAGE = "Known Error";
const KPIS = [{"l":"Tickets Abertos","v":"7.414","t":"+2.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"84.3%","t":"+0.4%","d":"up"},{"l":"MTTR (h)","v":"117h","t":"-5.0%","d":"down"},{"l":"Satisfação (%)","v":"82.1%","t":"+3.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.182","3.282","2.512","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.701","916","6.664","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.641","1.963","8.933","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.811","7.257","5.150","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.537","6.204","1.569","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":600},{"label":"Mar","value":666},{"label":"Abr","value":361},{"label":"Mai","value":669},{"label":"Jun","value":697},{"label":"Jul","value":392},{"label":"Ago","value":446},{"label":"Set","value":644},{"label":"Out","value":336},{"label":"Nov","value":561},{"label":"Dez","value":611}];
const MX = 697;
