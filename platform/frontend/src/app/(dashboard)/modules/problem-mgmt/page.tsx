...
/* ═══ Problem Management (ITIL) — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "3962", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "571", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€279K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1116882262", cells: ["PRO-1262", "Problem Management (ITIL) Item 1", "7/11/2026", "€32 362"], status: "active" as const },
    { id: "1116885833", cells: ["PRO-4833", "Problem Management (ITIL) Item 2", "22/6/2026", "€35 933"], status: "pending" as const },
    { id: "1116889404", cells: ["PRO-8404", "Problem Management (ITIL) Item 3", "9/1/2026", "€39 504"], status: "completed" as const },
    { id: "1116892975", cells: ["PRO-2975", "Problem Management (ITIL) Item 4", "24/8/2026", "€43 075"], status: "warning" as const },
    { id: "1116896546", cells: ["PRO-6546", "Problem Management (ITIL) Item 5", "11/3/2026", "€46 646"], status: "active" as const },
];
...
export default function ProblemManagementItilPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Problem Management (ITIL)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Problem Management (ITIL)</p>
                    </div>
                </div>
