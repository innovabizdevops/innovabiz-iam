...
const PAGE = "Detect";
const KPIS = [{"l":"Tickets Abertos","v":"8.382","t":"+4.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"87.3%","t":"+17.6%","d":"up"},{"l":"MTTR (h)","v":"60h","t":"-1.7%","d":"down"},{"l":"Satisfação (%)","v":"75.1%","t":"+11.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.457","4.663","4.769","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.448","1.668","224","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.128","2.454","3.048","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.380","5.670","5.636","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.221","2.552","2.114","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":776},{"label":"Fev","value":605},{"label":"Mar","value":557},{"label":"Abr","value":511},{"label":"Mai","value":563},{"label":"Jun","value":640},{"label":"Jul","value":548},{"label":"Ago","value":605},{"label":"Set","value":838},{"label":"Out","value":731},{"label":"Nov","value":576},{"label":"Dez","value":592}];
const MX = 838;
