...
const ACCENT = "#ca8a04";
const MODULE = "Restaurant POS";
const PAGE = "Daily Close";
const KPIS = [{"l":"Pedidos/Dia","v":"1999","t":"+18.0%","d":"up"},{"l":"GMV (€)","v":"€84022","t":"+10.2%","d":"up"},{"l":"Conversão (%)","v":"72.6%","t":"+1.9%","d":"up"},{"l":"AOV (€)","v":"€50169","t":"+0.3%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 26130.01","8.889","4.856","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 37529.15","9.085","6.812","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 14748.46","3.282","6.101","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 9231.18","7.905","5.431","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 44165.93","5.184","8.197","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":812},{"label":"Fev","value":732},{"label":"Mar","value":792},{"label":"Abr","value":668},{"label":"Mai","value":590},{"label":"Jun","value":692},{"label":"Jul","value":932},{"label":"Ago","value":650},{"label":"Set","value":882},{"label":"Out","value":622},{"label":"Nov","value":779},{"label":"Dez","value":894}];
const MX = 932;
