...
const PAGE = "Recover";
const KPIS = [{"l":"Total Critical Infra","v":"3.364","t":"-1.6%","d":"down"},{"l":"Recover Ativos","v":"6.973","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"82.3%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"59","t":"-1.4%","d":"down"}];
const COLS = ["ID","Recover","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Critical Infra #001","Critical Infra #002","697","5.848","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Critical Infra #002","Critical Infra #003","5.192","4.093","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Critical Infra #003","Critical Infra #004","7.383","1.276","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Critical Infra #004","Critical Infra #005","8.636","6.633","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Critical Infra #005","Critical Infra #001","3.751","5.493","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":813},{"label":"Fev","value":834},{"label":"Mar","value":886},{"label":"Abr","value":831},{"label":"Mai","value":892},{"label":"Jun","value":819},{"label":"Jul","value":921},{"label":"Ago","value":612},{"label":"Set","value":748},{"label":"Out","value":818},{"label":"Nov","value":977},{"label":"Dez","value":860}];
const MX = 977;
