...
const ACCENT = "#6366f1";
const MODULE = "Critical Infrastructure";
const PAGE = "Detect";
const KPIS = [{"l":"Total Critical Infra","v":"2.372","t":"+2.1%","d":"up"},{"l":"Detect Ativos","v":"8.354","t":"+6.0%","d":"up"},{"l":"Eficiência (%)","v":"76.7%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"67","t":"-1.6%","d":"down"}];
const COLS = ["ID","Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Critical Infra #001","Critical Infra #002","8.645","1.609","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Critical Infra #002","Critical Infra #003","3.609","2.264","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Critical Infra #003","Critical Infra #004","3.276","1.469","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Critical Infra #004","Critical Infra #005","3.819","2.831","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Critical Infra #005","Critical Infra #001","2.425","7.740","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":354},{"label":"Fev","value":547},{"label":"Mar","value":588},{"label":"Abr","value":334},{"label":"Mai","value":572},{"label":"Jun","value":228},{"label":"Jul","value":594},{"label":"Ago","value":580},{"label":"Set","value":462},{"label":"Out","value":357},{"label":"Nov","value":322},{"label":"Dez","value":262}];
const MX = 594;
