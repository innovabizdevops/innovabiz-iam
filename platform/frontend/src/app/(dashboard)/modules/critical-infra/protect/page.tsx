...
const PAGE = "Protect";
const KPIS = [{"l":"Total Critical Infra","v":"5.549","t":"+3.9%","d":"up"},{"l":"Protect Ativos","v":"1.546","t":"+1.4%","d":"up"},{"l":"Eficiência (%)","v":"66.3%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"88","t":"+14.4%","d":"up"}];
const COLS = ["ID","Protect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Critical Infra #001","Critical Infra #002","1.451","3.154","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Critical Infra #002","Critical Infra #003","568","3.464","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Critical Infra #003","Critical Infra #004","2.311","1.297","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Critical Infra #004","Critical Infra #005","6.492","8.614","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Critical Infra #005","Critical Infra #001","3.553","1.269","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":458},{"label":"Mar","value":441},{"label":"Abr","value":624},{"label":"Mai","value":574},{"label":"Jun","value":542},{"label":"Jul","value":556},{"label":"Ago","value":616},{"label":"Set","value":607},{"label":"Out","value":549},{"label":"Nov","value":545},{"label":"Dez","value":479}];
const MX = 679;
