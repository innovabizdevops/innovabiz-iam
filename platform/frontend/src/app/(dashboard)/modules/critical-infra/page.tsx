...
export default function CriticalInfraPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Critical Infra</h1><p className="text-sm text-muted-foreground">Critical Infra • iBOS Enterprise</p></div>
