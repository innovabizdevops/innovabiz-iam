...
const PAGE = "Assess";
const KPIS = [{"l":"Total Critical Infra","v":"1.051","t":"+1.6%","d":"up"},{"l":"Assess Ativos","v":"1.947","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"72","t":"-0.6%","d":"down"}];
const COLS = ["ID","Assess","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Critical Infra #001","Critical Infra #002","4.563","4.518","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Critical Infra #002","Critical Infra #003","3.645","8.516","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Critical Infra #003","Critical Infra #004","6.306","2.031","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Critical Infra #004","Critical Infra #005","7.847","7.414","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Critical Infra #005","Critical Infra #001","6.679","3.323","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":243},{"label":"Mar","value":366},{"label":"Abr","value":463},{"label":"Mai","value":528},{"label":"Jun","value":422},{"label":"Jul","value":426},{"label":"Ago","value":480},{"label":"Set","value":439},{"label":"Out","value":267},{"label":"Nov","value":602},{"label":"Dez","value":295}];
const MX = 602;
