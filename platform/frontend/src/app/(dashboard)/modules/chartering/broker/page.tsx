...
const PAGE = "Broker Comm";
const KPIS = [{"l":"Total Chartering","v":"2.981","t":"-4.6%","d":"down"},{"l":"Broker Comm Ativos","v":"4.667","t":"+15.9%","d":"up"},{"l":"Eficiência (%)","v":"84.9%","t":"+11.8%","d":"up"},{"l":"Score Performance","v":"82","t":"-3.8%","d":"down"}];
const COLS = ["ID","Broker Comm","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chartering #001","Chartering #002","5.721","2.382","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Chartering #002","Chartering #003","541","3.738","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Chartering #003","Chartering #004","2.727","4.337","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Chartering #004","Chartering #005","633","8.164","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chartering #005","Chartering #001","6.313","4.678","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":349},{"label":"Mar","value":342},{"label":"Abr","value":594},{"label":"Mai","value":587},{"label":"Jun","value":365},{"label":"Jul","value":445},{"label":"Ago","value":489},{"label":"Set","value":510},{"label":"Out","value":598},{"label":"Nov","value":301},{"label":"Dez","value":491}];
const MX = 598;
