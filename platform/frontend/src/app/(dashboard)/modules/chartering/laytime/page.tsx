...
const PAGE = "Laytime Calc";
const KPIS = [{"l":"Total Chartering","v":"4.066","t":"+2.3%","d":"up"},{"l":"Laytime Calc Ativos","v":"4.777","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"88.3%","t":"+9.9%","d":"up"},{"l":"Score Performance","v":"79","t":"+17.2%","d":"up"}];
const COLS = ["ID","Laytime Calc","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chartering #001","Chartering #002","4.564","6.957","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Chartering #002","Chartering #003","8.890","7.199","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Chartering #003","Chartering #004","2.929","2.210","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Chartering #004","Chartering #005","2.810","8.857","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chartering #005","Chartering #001","7.117","2.303","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":880},{"label":"Fev","value":591},{"label":"Mar","value":713},{"label":"Abr","value":703},{"label":"Mai","value":761},{"label":"Jun","value":526},{"label":"Jul","value":560},{"label":"Ago","value":812},{"label":"Set","value":769},{"label":"Out","value":747},{"label":"Nov","value":873},{"label":"Dez","value":781}];
const MX = 880;
