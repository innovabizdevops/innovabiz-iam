...
const ACCENT = "#dc2626";
const MODULE = "Chartering";
const PAGE = "Pool Agreement";
const KPIS = [{"l":"Total Chartering","v":"3.803","t":"+12.5%","d":"up"},{"l":"Pool Agreement Ativos","v":"4.322","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"74.4%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"56","t":"+16.3%","d":"up"}];
const COLS = ["ID","Pool Agreement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chartering #001","Chartering #002","888","6.433","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Chartering #002","Chartering #003","6.816","4.195","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Chartering #003","Chartering #004","4.481","5.729","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Chartering #004","Chartering #005","8.605","4.239","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chartering #005","Chartering #001","1.093","2.607","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":341},{"label":"Fev","value":338},{"label":"Mar","value":525},{"label":"Abr","value":393},{"label":"Mai","value":629},{"label":"Jun","value":334},{"label":"Jul","value":364},{"label":"Ago","value":517},{"label":"Set","value":310},{"label":"Out","value":670},{"label":"Nov","value":339},{"label":"Dez","value":480}];
const MX = 670;
