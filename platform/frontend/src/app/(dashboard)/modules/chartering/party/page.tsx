...
const PAGE = "Charter Party";
const KPIS = [{"l":"Total Chartering","v":"6.682","t":"+14.0%","d":"up"},{"l":"Charter Party Ativos","v":"4.387","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"79.6%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"87","t":"+16.6%","d":"up"}];
const COLS = ["ID","Charter Party","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chartering #001","Chartering #002","515","8.649","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Chartering #002","Chartering #003","8.924","7.560","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Chartering #003","Chartering #004","1.502","5.259","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Chartering #004","Chartering #005","819","4.100","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chartering #005","Chartering #001","5.339","7.164","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":515},{"label":"Mar","value":565},{"label":"Abr","value":459},{"label":"Mai","value":376},{"label":"Jun","value":650},{"label":"Jul","value":536},{"label":"Ago","value":453},{"label":"Set","value":459},{"label":"Out","value":614},{"label":"Nov","value":730},{"label":"Dez","value":715}];
const MX = 730;
