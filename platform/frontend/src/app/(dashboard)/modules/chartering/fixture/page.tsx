...
const PAGE = "Fixture Note";
const KPIS = [{"l":"Total Chartering","v":"2.802","t":"+5.4%","d":"up"},{"l":"Fixture Note Ativos","v":"4.474","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"76.2%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"85","t":"-5.1%","d":"down"}];
const COLS = ["ID","Fixture Note","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chartering #001","Chartering #002","2.019","6.196","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Chartering #002","Chartering #003","7.682","6.707","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Chartering #003","Chartering #004","4.544","2.199","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Chartering #004","Chartering #005","6.875","310","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chartering #005","Chartering #001","5.996","783","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1029},{"label":"Fev","value":900},{"label":"Mar","value":929},{"label":"Abr","value":811},{"label":"Mai","value":681},{"label":"Jun","value":877},{"label":"Jul","value":664},{"label":"Ago","value":942},{"label":"Set","value":799},{"label":"Out","value":779},{"label":"Nov","value":728},{"label":"Dez","value":971}];
const MX = 1029;
