...
const PAGE = "Tanker Market";
const KPIS = [{"l":"Total Chartering","v":"8.754","t":"+15.5%","d":"up"},{"l":"Tanker Market Ativos","v":"1.007","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"94.6%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"80","t":"+12.5%","d":"up"}];
const COLS = ["ID","Tanker Market","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chartering #001","Chartering #002","6.368","6.247","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Chartering #002","Chartering #003","6.493","333","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Chartering #003","Chartering #004","4.330","8.822","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Chartering #004","Chartering #005","3.870","6.813","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chartering #005","Chartering #001","5.138","6.060","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":375},{"label":"Fev","value":478},{"label":"Mar","value":339},{"label":"Abr","value":367},{"label":"Mai","value":388},{"label":"Jun","value":496},{"label":"Jul","value":328},{"label":"Ago","value":612},{"label":"Set","value":571},{"label":"Out","value":267},{"label":"Nov","value":478},{"label":"Dez","value":346}];
const MX = 612;
