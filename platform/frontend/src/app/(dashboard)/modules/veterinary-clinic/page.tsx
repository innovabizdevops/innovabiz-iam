...
const KPIS = [
    { label: "Total Registos", value: "297", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3519", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€167K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1262962997", cells: ["VET-2997", "Veterinary Clinic Item 1", "10/6/2026", "€13 097"], status: "active" as const },
    { id: "1262966568", cells: ["VET-6568", "Veterinary Clinic Item 2", "25/1/2026", "€16 668"], status: "pending" as const },
    { id: "1262970139", cells: ["VET-1139", "Veterinary Clinic Item 3", "12/8/2026", "€20 239"], status: "completed" as const },
    { id: "1262973710", cells: ["VET-4710", "Veterinary Clinic Item 4", "27/3/2026", "€23 810"], status: "warning" as const },
    { id: "1262977281", cells: ["VET-8281", "Veterinary Clinic Item 5", "14/10/2026", "€27 381"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Veterinary Clinic</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Veterinary Clinic</p>
                    </div>
                </div>
