...
const ACCENT = "#6366f1";
const MODULE = "Diplomatic Management";
const PAGE = "Travel";
const KPIS = [{"l":"Total Diplomatic Mgmt","v":"8.147","t":"+5.7%","d":"up"},{"l":"Travel Ativos","v":"8.613","t":"-1.5%","d":"down"},{"l":"Eficiência (%)","v":"79.6%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"59","t":"+10.2%","d":"up"}];
const COLS = ["ID","Travel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Diplomatic Mgmt #001","Diplomatic Mgmt #002","2.273","3.234","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Diplomatic Mgmt #002","Diplomatic Mgmt #003","7.922","5.590","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Diplomatic Mgmt #003","Diplomatic Mgmt #004","3.948","9.090","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Diplomatic Mgmt #004","Diplomatic Mgmt #005","3.339","5.543","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Diplomatic Mgmt #005","Diplomatic Mgmt #001","436","4.724","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":777},{"label":"Mar","value":621},{"label":"Abr","value":757},{"label":"Mai","value":626},{"label":"Jun","value":858},{"label":"Jul","value":654},{"label":"Ago","value":551},{"label":"Set","value":904},{"label":"Out","value":849},{"label":"Nov","value":861},{"label":"Dez","value":683}];
const MX = 904;
