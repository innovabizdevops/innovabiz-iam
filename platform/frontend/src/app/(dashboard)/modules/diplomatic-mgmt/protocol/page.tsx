...
const PAGE = "Protocol";
const KPIS = [{"l":"Integrações Ativas","v":"4.164","t":"+2.4%","d":"up"},{"l":"Chamadas/Hora","v":"4465","t":"-3.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"77.8%","t":"+16.6%","d":"up"},{"l":"Latência Média (ms)","v":"134ms","t":"+3.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.161","3.641","89.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","168","2.843","82.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.470","5.809","78.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.793","4.577","74.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.607","1.454","90.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":540},{"label":"Mar","value":456},{"label":"Abr","value":373},{"label":"Mai","value":657},{"label":"Jun","value":640},{"label":"Jul","value":669},{"label":"Ago","value":557},{"label":"Set","value":519},{"label":"Out","value":667},{"label":"Nov","value":575},{"label":"Dez","value":505}];
const MX = 669;
