...
const PAGE = "Embassy";
const KPIS = [{"l":"Total Diplomatic Mgmt","v":"2.381","t":"+8.8%","d":"up"},{"l":"Embassy Ativos","v":"8.732","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"65.6%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"75","t":"+2.9%","d":"up"}];
const COLS = ["ID","Embassy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Diplomatic Mgmt #001","Diplomatic Mgmt #002","8.274","7.171","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Diplomatic Mgmt #002","Diplomatic Mgmt #003","1.675","3.875","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Diplomatic Mgmt #003","Diplomatic Mgmt #004","8.760","1.754","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Diplomatic Mgmt #004","Diplomatic Mgmt #005","1.560","789","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Diplomatic Mgmt #005","Diplomatic Mgmt #001","1.662","4.051","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":280},{"label":"Fev","value":251},{"label":"Mar","value":552},{"label":"Abr","value":355},{"label":"Mai","value":521},{"label":"Jun","value":266},{"label":"Jul","value":327},{"label":"Ago","value":453},{"label":"Set","value":272},{"label":"Out","value":498},{"label":"Nov","value":324},{"label":"Dez","value":407}];
const MX = 552;
