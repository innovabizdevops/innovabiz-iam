...
const PAGE = "Treaty";
const KPIS = [{"l":"Total Diplomatic Mgmt","v":"6.402","t":"-0.3%","d":"down"},{"l":"Treaty Ativos","v":"7.812","t":"+2.3%","d":"up"},{"l":"Eficiência (%)","v":"72.3%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"93","t":"+5.7%","d":"up"}];
const COLS = ["ID","Treaty","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Diplomatic Mgmt #001","Diplomatic Mgmt #002","7.166","3.733","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Diplomatic Mgmt #002","Diplomatic Mgmt #003","7.805","1.054","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Diplomatic Mgmt #003","Diplomatic Mgmt #004","717","1.389","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Diplomatic Mgmt #004","Diplomatic Mgmt #005","6.200","1.328","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Diplomatic Mgmt #005","Diplomatic Mgmt #001","6.758","2.516","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":694},{"label":"Fev","value":711},{"label":"Mar","value":607},{"label":"Abr","value":611},{"label":"Mai","value":957},{"label":"Jun","value":893},{"label":"Jul","value":835},{"label":"Ago","value":583},{"label":"Set","value":832},{"label":"Out","value":734},{"label":"Nov","value":966},{"label":"Dez","value":702}];
const MX = 966;
