...
/* ═══ COSMOS Temporal Engine — Dashboard ═══ */

const ACCENT = "#1e1b4b";

const KPIS = [
    { label: "Total Registos", value: "5000", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4491", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€406K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "201766900", cells: ["COS-5900", "COSMOS Temporal Engine Item 1", "21/5/2026", "€17 000"], status: "active" as const },
    { id: "201770471", cells: ["COS-9471", "COSMOS Temporal Engine Item 2", "8/12/2026", "€20 571"], status: "pending" as const },
    { id: "201774042", cells: ["COS-4042", "COSMOS Temporal Engine Item 3", "23/7/2026", "€24 142"], status: "completed" as const },
    { id: "201777613", cells: ["COS-7613", "COSMOS Temporal Engine Item 4", "10/2/2026", "€27 713"], status: "warning" as const },
    { id: "201781184", cells: ["COS-2184", "COSMOS Temporal Engine Item 5", "25/9/2026", "€31 284"], status: "active" as const },
];
...
export default function CosmosTemporalEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">COSMOS Temporal Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • COSMOS Temporal Engine</p>
                    </div>
                </div>
