...
const PAGE = "Sequence";
const KPIS = [{"l":"Total Cosmos Temporal","v":"4.571","t":"+16.2%","d":"up"},{"l":"Sequence Ativos","v":"2.489","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"92.8%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"86","t":"+13.0%","d":"up"}];
const COLS = ["ID","Sequence","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Temporal #001","Cosmos Temporal #002","933","8.194","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Temporal #002","Cosmos Temporal #003","3.392","3.133","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Temporal #003","Cosmos Temporal #004","656","5.669","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Temporal #004","Cosmos Temporal #005","6.533","5.844","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Temporal #005","Cosmos Temporal #001","3.148","2.923","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":261},{"label":"Fev","value":535},{"label":"Mar","value":332},{"label":"Abr","value":209},{"label":"Mai","value":569},{"label":"Jun","value":388},{"label":"Jul","value":458},{"label":"Ago","value":577},{"label":"Set","value":533},{"label":"Out","value":284},{"label":"Nov","value":361},{"label":"Dez","value":244}];
const MX = 577;
