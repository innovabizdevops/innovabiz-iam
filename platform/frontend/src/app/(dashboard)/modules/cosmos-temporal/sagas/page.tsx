...
const PAGE = "Sagas";
const KPIS = [{"l":"Total Cosmos Temporal","v":"6.216","t":"+17.1%","d":"up"},{"l":"Sagas Ativos","v":"5.625","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"82.0%","t":"+16.2%","d":"up"},{"l":"Score Performance","v":"78","t":"-0.7%","d":"down"}];
const COLS = ["ID","Sagas","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Temporal #001","Cosmos Temporal #002","5.564","4.023","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Temporal #002","Cosmos Temporal #003","4.922","3.035","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Temporal #003","Cosmos Temporal #004","3.114","2.945","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Temporal #004","Cosmos Temporal #005","534","6.003","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Temporal #005","Cosmos Temporal #001","2.228","5.330","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":659},{"label":"Mar","value":551},{"label":"Abr","value":691},{"label":"Mai","value":838},{"label":"Jun","value":499},{"label":"Jul","value":617},{"label":"Ago","value":800},{"label":"Set","value":485},{"label":"Out","value":649},{"label":"Nov","value":651},{"label":"Dez","value":639}];
const MX = 838;
