...
const ACCENT = "#1e1b4b";
const MODULE = "COSMOS Temporal Engine";
const PAGE = "Compensate";
const KPIS = [{"l":"Total Cosmos Temporal","v":"6.534","t":"+4.0%","d":"up"},{"l":"Compensate Ativos","v":"1.240","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"80.7%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"92","t":"+4.0%","d":"up"}];
const COLS = ["ID","Compensate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Temporal #001","Cosmos Temporal #002","5.577","4.655","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Temporal #002","Cosmos Temporal #003","6.919","2.813","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Temporal #003","Cosmos Temporal #004","6.562","6.203","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Temporal #004","Cosmos Temporal #005","4.263","4.486","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Temporal #005","Cosmos Temporal #001","5.699","5.649","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":474},{"label":"Fev","value":372},{"label":"Mar","value":764},{"label":"Abr","value":460},{"label":"Mai","value":615},{"label":"Jun","value":424},{"label":"Jul","value":626},{"label":"Ago","value":439},{"label":"Set","value":581},{"label":"Out","value":406},{"label":"Nov","value":680},{"label":"Dez","value":664}];
const MX = 764;
