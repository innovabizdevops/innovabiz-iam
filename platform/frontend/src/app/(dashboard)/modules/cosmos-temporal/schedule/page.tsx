...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Cosmos Temporal","v":"2.941","t":"+3.9%","d":"up"},{"l":"Schedule Ativos","v":"2.167","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"85.8%","t":"+4.8%","d":"up"},{"l":"Score Performance","v":"68","t":"-1.2%","d":"down"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Temporal #001","Cosmos Temporal #002","8.632","1.442","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Temporal #002","Cosmos Temporal #003","145","8.878","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Temporal #003","Cosmos Temporal #004","4.463","7.724","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Temporal #004","Cosmos Temporal #005","7.547","553","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Temporal #005","Cosmos Temporal #001","1.598","4.888","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":232},{"label":"Mar","value":346},{"label":"Abr","value":237},{"label":"Mai","value":216},{"label":"Jun","value":560},{"label":"Jul","value":362},{"label":"Ago","value":461},{"label":"Set","value":391},{"label":"Out","value":437},{"label":"Nov","value":207},{"label":"Dez","value":495}];
const MX = 562;
