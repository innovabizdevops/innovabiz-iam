...
const KPIS = [{"l":"Total Lab Results","v":"8.300","t":"+3.0%","d":"up"},{"l":"Order Entry Ativos","v":"4.184","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"70.9%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"91","t":"+10.0%","d":"up"}];
const COLS = ["ID","Order Entry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lab Results #001","Lab Results #002","4.950","8.568","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Lab Results #002","Lab Results #003","7.144","4.146","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Lab Results #003","Lab Results #004","4.414","1.384","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Lab Results #004","Lab Results #005","8.666","8.324","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lab Results #005","Lab Results #001","3.088","6.420","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":349},{"label":"Fev","value":386},{"label":"Mar","value":492},{"label":"Abr","value":540},{"label":"Mai","value":252},{"label":"Jun","value":347},{"label":"Jul","value":456},{"label":"Ago","value":542},{"label":"Set","value":323},{"label":"Out","value":460},{"label":"Nov","value":578},{"label":"Dez","value":561}];
const MX = 578;
