...
const ACCENT = "#b45309";
const MODULE = "Lab Results";
const PAGE = "Trend Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"6.086","t":"-3.3%","d":"down"},{"l":"Queries/Dia","v":"1610","t":"+9.6%","d":"up"},{"l":"Dados Processados (GB)","v":"6.452","t":"+9.4%","d":"up"},{"l":"Utilizadores Analytics","v":"8.175","t":"+12.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1945","2026-01-20","7.019","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4218","2026-02-28","3.408","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1226","2026-03-06","567","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","379","2026-01-10","8.095","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1654","2026-01-23","6.360","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":617},{"label":"Mar","value":880},{"label":"Abr","value":920},{"label":"Mai","value":842},{"label":"Jun","value":975},{"label":"Jul","value":618},{"label":"Ago","value":934},{"label":"Set","value":681},{"label":"Out","value":980},{"label":"Nov","value":683},{"label":"Dez","value":762}];
const MX = 980;
