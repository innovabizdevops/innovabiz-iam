...
const ACCENT = "#312e81";
const MODULE = "MD: Context Mesh Engine";
const PAGE = "Correlate";
const KPIS = [{"l":"Total Md Context Mesh","v":"3.748","t":"-5.9%","d":"down"},{"l":"Correlate Ativos","v":"2.385","t":"-5.7%","d":"down"},{"l":"Eficiência (%)","v":"86.8%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"62","t":"+8.0%","d":"up"}];
const COLS = ["ID","Correlate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Md Context Mesh #001","Md Context Mesh #002","2.248","4.930","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Md Context Mesh #002","Md Context Mesh #003","7.312","6.747","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Md Context Mesh #003","Md Context Mesh #004","1.857","7.994","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Md Context Mesh #004","Md Context Mesh #005","2.520","6.635","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Md Context Mesh #005","Md Context Mesh #001","5.173","3.512","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":597},{"label":"Mar","value":316},{"label":"Abr","value":643},{"label":"Mai","value":658},{"label":"Jun","value":678},{"label":"Jul","value":358},{"label":"Ago","value":365},{"label":"Set","value":407},{"label":"Out","value":323},{"label":"Nov","value":549},{"label":"Dez","value":391}];
const MX = 678;
