...
/* ═══ MD: Context Mesh Engine — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "8808", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4792", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€427K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1203680408", cells: ["MD-3408", "MD: Context Mesh Engine Item 1", "1/9/2026", "€30 508"], status: "active" as const },
    { id: "1203683979", cells: ["MD-6979", "MD: Context Mesh Engine Item 2", "16/4/2026", "€34 079"], status: "pending" as const },
    { id: "1203687550", cells: ["MD-1550", "MD: Context Mesh Engine Item 3", "3/11/2026", "€37 650"], status: "completed" as const },
    { id: "1203691121", cells: ["MD-5121", "MD: Context Mesh Engine Item 4", "18/6/2026", "€41 221"], status: "warning" as const },
    { id: "1203694692", cells: ["MD-8692", "MD: Context Mesh Engine Item 5", "5/1/2026", "€44 792"], status: "active" as const },
];
...
export default function MdContextMeshEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Context Mesh Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Context Mesh Engine</p>
                    </div>
                </div>
