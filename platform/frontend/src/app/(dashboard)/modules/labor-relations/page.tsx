...
/* ═══ Labor Relations Platform — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "8689", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4082", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€97K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "336044289", cells: ["LAB-3289", "Labor Relations Platform Item 1", "22/10/2026", "€44 389"], status: "active" as const },
    { id: "336047860", cells: ["LAB-6860", "Labor Relations Platform Item 2", "9/5/2026", "€47 960"], status: "pending" as const },
    { id: "336051431", cells: ["LAB-1431", "Labor Relations Platform Item 3", "24/12/2026", "€1531"], status: "completed" as const },
    { id: "336055002", cells: ["LAB-5002", "Labor Relations Platform Item 4", "11/7/2026", "€5102"], status: "warning" as const },
    { id: "336058573", cells: ["LAB-8573", "Labor Relations Platform Item 5", "26/2/2026", "€8673"], status: "active" as const },
];
...
export default function LaborRelationsPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Labor Relations Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Labor Relations Platform</p>
                    </div>
                </div>
