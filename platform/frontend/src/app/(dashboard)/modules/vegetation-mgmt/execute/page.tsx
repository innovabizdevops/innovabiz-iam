...
const ACCENT = "#6366f1";
const MODULE = "Vegetation Management";
const PAGE = "Execute";
const KPIS = [{"l":"Total Vegetation Mgmt","v":"2.284","t":"+10.5%","d":"up"},{"l":"Execute Ativos","v":"3.442","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"80.2%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"63","t":"-3.3%","d":"down"}];
const COLS = ["ID","Execute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vegetation Mgmt #001","Vegetation Mgmt #002","1.503","406","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Vegetation Mgmt #002","Vegetation Mgmt #003","323","518","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Vegetation Mgmt #003","Vegetation Mgmt #004","5.714","5.545","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Vegetation Mgmt #004","Vegetation Mgmt #005","4.835","2.611","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vegetation Mgmt #005","Vegetation Mgmt #001","2.244","2.675","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":954},{"label":"Fev","value":683},{"label":"Mar","value":662},{"label":"Abr","value":959},{"label":"Mai","value":899},{"label":"Jun","value":654},{"label":"Jul","value":858},{"label":"Ago","value":880},{"label":"Set","value":945},{"label":"Out","value":871},{"label":"Nov","value":635},{"label":"Dez","value":830}];
const MX = 959;
