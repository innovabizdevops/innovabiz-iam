...
const PAGE = "Survey";
const KPIS = [{"l":"Surveys Ativos","v":"8.728","t":"+14.0%","d":"up"},{"l":"Respostas/Semana","v":"2387","t":"+17.1%","d":"up"},{"l":"NPS Médio","v":"86","t":"-0.7%","d":"down"},{"l":"Taxa Resposta (%)","v":"92.4%","t":"-2.8%","d":"down"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","5.811","87","92.2%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","6.193","90","98.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","4.463","90","78.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","1.713","86","84.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","3.880","61","92.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":874},{"label":"Mar","value":1029},{"label":"Abr","value":1031},{"label":"Mai","value":677},{"label":"Jun","value":907},{"label":"Jul","value":773},{"label":"Ago","value":890},{"label":"Set","value":642},{"label":"Out","value":727},{"label":"Nov","value":846},{"label":"Dez","value":987}];
const MX = 1031;
