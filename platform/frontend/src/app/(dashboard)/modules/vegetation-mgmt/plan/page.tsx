...
const PAGE = "Plan";
const KPIS = [{"l":"Total Vegetation Mgmt","v":"434","t":"-2.7%","d":"down"},{"l":"Plan Ativos","v":"2.253","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"69.2%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"95","t":"+3.4%","d":"up"}];
const COLS = ["ID","Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vegetation Mgmt #001","Vegetation Mgmt #002","2.614","3.022","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Vegetation Mgmt #002","Vegetation Mgmt #003","5.908","3.288","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Vegetation Mgmt #003","Vegetation Mgmt #004","5.851","2.283","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Vegetation Mgmt #004","Vegetation Mgmt #005","4.178","5.752","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vegetation Mgmt #005","Vegetation Mgmt #001","174","8.376","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":883},{"label":"Fev","value":551},{"label":"Mar","value":568},{"label":"Abr","value":633},{"label":"Mai","value":607},{"label":"Jun","value":781},{"label":"Jul","value":710},{"label":"Ago","value":523},{"label":"Set","value":643},{"label":"Out","value":745},{"label":"Nov","value":797},{"label":"Dez","value":869}];
const MX = 883;
