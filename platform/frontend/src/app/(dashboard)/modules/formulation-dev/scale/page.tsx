...
const PAGE = "Scale";
const KPIS = [{"l":"Formulários Ativos","v":"4.417","t":"+16.2%","d":"up"},{"l":"Submissões/Dia","v":"693","t":"+15.5%","d":"up"},{"l":"Documentos Gerados","v":"8.252","t":"+4.1%","d":"up"},{"l":"Templates","v":"6.382","t":"+1.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.840","2026-02-26","2.532","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.709","2026-02-17","104","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.143","2026-03-20","9.017","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.077","2026-01-18","6.353","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.397","2026-01-28","5.931","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":561},{"label":"Mar","value":384},{"label":"Abr","value":733},{"label":"Mai","value":607},{"label":"Jun","value":735},{"label":"Jul","value":624},{"label":"Ago","value":509},{"label":"Set","value":623},{"label":"Out","value":404},{"label":"Nov","value":355},{"label":"Dez","value":579}];
const MX = 735;
