...
const PAGE = "Screen";
const KPIS = [{"l":"Formulários Ativos","v":"8.762","t":"-3.3%","d":"down"},{"l":"Submissões/Dia","v":"1921","t":"+15.4%","d":"up"},{"l":"Documentos Gerados","v":"6.384","t":"+7.6%","d":"up"},{"l":"Templates","v":"5.411","t":"-2.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.386","2026-03-24","8.249","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.857","2026-02-16","6.890","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.152","2026-01-04","8.637","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.973","2026-03-20","1.256","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.831","2026-02-25","7.111","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":951},{"label":"Mar","value":836},{"label":"Abr","value":683},{"label":"Mai","value":841},{"label":"Jun","value":619},{"label":"Jul","value":985},{"label":"Ago","value":963},{"label":"Set","value":868},{"label":"Out","value":706},{"label":"Nov","value":930},{"label":"Dez","value":781}];
const MX = 985;
