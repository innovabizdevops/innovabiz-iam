...
const ACCENT = "#9333ea";
const MODULE = "Formulation Development";
const PAGE = "Optimize";
const KPIS = [{"l":"Formulários Ativos","v":"5.913","t":"+5.1%","d":"up"},{"l":"Submissões/Dia","v":"3032","t":"-4.7%","d":"down"},{"l":"Documentos Gerados","v":"5.632","t":"-2.0%","d":"down"},{"l":"Templates","v":"2.641","t":"-3.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.092","2026-03-01","2.849","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.624","2026-02-01","1.790","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.900","2026-01-03","9.055","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.884","2026-01-26","7.707","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.155","2026-01-19","3.127","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":867},{"label":"Fev","value":890},{"label":"Mar","value":641},{"label":"Abr","value":946},{"label":"Mai","value":922},{"label":"Jun","value":658},{"label":"Jul","value":666},{"label":"Ago","value":590},{"label":"Set","value":936},{"label":"Out","value":681},{"label":"Nov","value":853},{"label":"Dez","value":949}];
const MX = 949;
