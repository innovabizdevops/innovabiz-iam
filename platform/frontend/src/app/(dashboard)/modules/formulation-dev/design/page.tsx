...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"847","t":"+5.6%","d":"up"},{"l":"Submissões/Dia","v":"2150","t":"+14.1%","d":"up"},{"l":"Documentos Gerados","v":"1.035","t":"+14.6%","d":"up"},{"l":"Templates","v":"1.298","t":"+1.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.112","2026-03-24","8.330","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.900","2026-02-18","5.616","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.351","2026-02-19","3.547","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.433","2026-01-05","6.799","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.857","2026-03-16","3.221","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":496},{"label":"Fev","value":734},{"label":"Mar","value":425},{"label":"Abr","value":436},{"label":"Mai","value":422},{"label":"Jun","value":663},{"label":"Jul","value":538},{"label":"Ago","value":679},{"label":"Set","value":551},{"label":"Out","value":465},{"label":"Nov","value":557},{"label":"Dez","value":458}];
const MX = 734;
