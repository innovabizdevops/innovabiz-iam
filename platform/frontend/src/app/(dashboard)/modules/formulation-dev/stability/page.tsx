...
const PAGE = "Stability";
const KPIS = [{"l":"Formulários Ativos","v":"7.162","t":"+10.2%","d":"up"},{"l":"Submissões/Dia","v":"3916","t":"+8.1%","d":"up"},{"l":"Documentos Gerados","v":"8.804","t":"+6.1%","d":"up"},{"l":"Templates","v":"6.076","t":"-1.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.416","2026-03-16","9.007","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.540","2026-01-07","5.246","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","9.070","2026-02-13","2.205","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.965","2026-02-13","8.734","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","930","2026-03-12","8.842","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":510},{"label":"Mar","value":622},{"label":"Abr","value":597},{"label":"Mai","value":643},{"label":"Jun","value":617},{"label":"Jul","value":717},{"label":"Ago","value":472},{"label":"Set","value":610},{"label":"Out","value":718},{"label":"Nov","value":536},{"label":"Dez","value":484}];
const MX = 718;
