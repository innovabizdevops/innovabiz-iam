...
/* ═══ Formulation Development — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "8223", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1593", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€307K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "292622423", cells: ["FOR-6423", "Formulation Development Item 1", "24/12/2026", "€22 523"], status: "active" as const },
    { id: "292625994", cells: ["FOR-9994", "Formulation Development Item 2", "11/7/2026", "€26 094"], status: "pending" as const },
    { id: "292629565", cells: ["FOR-4565", "Formulation Development Item 3", "26/2/2026", "€29 665"], status: "completed" as const },
    { id: "292633136", cells: ["FOR-8136", "Formulation Development Item 4", "13/9/2026", "€33 236"], status: "warning" as const },
    { id: "292636707", cells: ["FOR-2707", "Formulation Development Item 5", "28/4/2026", "€36 807"], status: "active" as const },
];
...
export default function FormulationDevelopmentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Formulation Development</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Formulation Development</p>
                    </div>
                </div>
