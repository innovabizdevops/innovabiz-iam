...
const KPIS = [{"l":"Pedidos/Dia","v":"4248","t":"+17.1%","d":"up"},{"l":"GMV (€)","v":"€54056","t":"+17.1%","d":"up"},{"l":"Conversão (%)","v":"70.5%","t":"+9.0%","d":"up"},{"l":"AOV (€)","v":"€10126","t":"-0.7%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 19252.42","9.090","9.062","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 2441.73","955","8.908","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 6998.84","3.931","4.548","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 8583.48","8.171","917","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 38679.33","5.273","9.064","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":471},{"label":"Mar","value":576},{"label":"Abr","value":566},{"label":"Mai","value":548},{"label":"Jun","value":263},{"label":"Jul","value":454},{"label":"Ago","value":576},{"label":"Set","value":377},{"label":"Out","value":560},{"label":"Nov","value":536},{"label":"Dez","value":348}];
const MX = 610;
...
export default function MarketplaceAgenticAiPage() {
    return (
