...
const PAGE = "Multi-Agent Mesh";
const KPIS = [{"l":"Total Agentic Ai","v":"1.124","t":"+3.5%","d":"up"},{"l":"Multi Agent Mesh Ativos","v":"2.547","t":"+15.9%","d":"up"},{"l":"Eficiência (%)","v":"72.5%","t":"+5.6%","d":"up"},{"l":"Score Performance","v":"72","t":"-3.9%","d":"down"}];
const COLS = ["ID","Multi Agent Mesh","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agentic Ai #001","Agentic Ai #002","621","2.859","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Agentic Ai #002","Agentic Ai #003","4.073","4.230","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Agentic Ai #003","Agentic Ai #004","6.158","4.283","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Agentic Ai #004","Agentic Ai #005","8.904","9.017","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agentic Ai #005","Agentic Ai #001","9.059","594","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":682},{"label":"Mar","value":663},{"label":"Abr","value":572},{"label":"Mai","value":546},{"label":"Jun","value":634},{"label":"Jul","value":499},{"label":"Ago","value":768},{"label":"Set","value":612},{"label":"Out","value":649},{"label":"Nov","value":604},{"label":"Dez","value":475}];
const MX = 768;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>MAM</span></h1>
                </div>
