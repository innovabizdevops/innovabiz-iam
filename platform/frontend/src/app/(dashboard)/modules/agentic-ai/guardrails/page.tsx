...
const PAGE = "Guardrails &amp; Safety";
const KPIS = [{"l":"Veículos Operação","v":"2.718","t":"-1.0%","d":"down"},{"l":"Viagens/Dia","v":"1547","t":"-1.3%","d":"down"},{"l":"Pontualidade (%)","v":"89.5%","t":"-1.6%","d":"down"},{"l":"Passageiros/Dia","v":"3767","t":"+6.0%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-15","2026-02-09","725","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-17","2026-02-21","3.152","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-10","2026-02-22","6.415","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-04","2026-02-21","717","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-17","2026-01-28","5.473","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":442},{"label":"Mar","value":459},{"label":"Abr","value":393},{"label":"Mai","value":376},{"label":"Jun","value":365},{"label":"Jul","value":385},{"label":"Ago","value":662},{"label":"Set","value":566},{"label":"Out","value":608},{"label":"Nov","value":324},{"label":"Dez","value":501}];
const MX = 662;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>XAI</span></h1>
                </div>
