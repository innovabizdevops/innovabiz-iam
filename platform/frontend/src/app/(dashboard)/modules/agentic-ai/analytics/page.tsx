...
const PAGE = "Agent Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"2.070","t":"-0.7%","d":"down"},{"l":"Queries/Dia","v":"4685","t":"+4.6%","d":"up"},{"l":"Dados Processados (GB)","v":"4.217","t":"-1.6%","d":"down"},{"l":"Utilizadores Analytics","v":"5.529","t":"+8.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4195","2026-01-17","8.519","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3534","2026-02-03","6.624","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4055","2026-01-19","717","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1750","2026-01-01","420","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3489","2026-02-01","5.672","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":610},{"label":"Mar","value":654},{"label":"Abr","value":609},{"label":"Mai","value":719},{"label":"Jun","value":441},{"label":"Jul","value":649},{"label":"Ago","value":458},{"label":"Set","value":635},{"label":"Out","value":472},{"label":"Nov","value":658},{"label":"Dez","value":454}];
const MX = 742;
