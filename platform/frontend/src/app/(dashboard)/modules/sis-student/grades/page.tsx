...
const PAGE = "Grade Book";
const KPIS = [{"l":"Total Sis Student","v":"8.639","t":"+14.1%","d":"up"},{"l":"Grade Book Ativos","v":"9.044","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"65.3%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"61","t":"+3.3%","d":"up"}];
const COLS = ["ID","Grade Book","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sis Student #001","Sis Student #002","7.081","5.590","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Sis Student #002","Sis Student #003","5.102","8.622","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Sis Student #003","Sis Student #004","4.929","1.022","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Sis Student #004","Sis Student #005","1.330","7.755","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sis Student #005","Sis Student #001","667","2.918","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":756},{"label":"Mar","value":700},{"label":"Abr","value":503},{"label":"Mai","value":742},{"label":"Jun","value":490},{"label":"Jul","value":580},{"label":"Ago","value":665},{"label":"Set","value":603},{"label":"Out","value":796},{"label":"Nov","value":660},{"label":"Dez","value":815}];
const MX = 815;
