...
const KPIS = [{"l":"Total Sis Student","v":"6.659","t":"+10.4%","d":"up"},{"l":"Transcript Ativos","v":"195","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"71.1%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"56","t":"+8.8%","d":"up"}];
const COLS = ["ID","Transcript","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sis Student #001","Sis Student #002","1.313","1.090","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Sis Student #002","Sis Student #003","5.809","6.853","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Sis Student #003","Sis Student #004","1.332","8.215","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Sis Student #004","Sis Student #005","5.520","2.416","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sis Student #005","Sis Student #001","3.410","5.446","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":815},{"label":"Mar","value":794},{"label":"Abr","value":553},{"label":"Mai","value":589},{"label":"Jun","value":820},{"label":"Jul","value":542},{"label":"Ago","value":474},{"label":"Set","value":509},{"label":"Out","value":697},{"label":"Nov","value":690},{"label":"Dez","value":672}];
const MX = 820;
