...
export default function SisStudentPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Sis Student</h1><p className="text-sm text-muted-foreground">Sis Student • iBOS Enterprise</p></div>
