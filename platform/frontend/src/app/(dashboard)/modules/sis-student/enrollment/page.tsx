...
const KPIS = [{"l":"Total Sis Student","v":"4.372","t":"+6.1%","d":"up"},{"l":"Enrollment Ativos","v":"8.383","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"75.8%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"62","t":"+2.6%","d":"up"}];
const COLS = ["ID","Enrollment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sis Student #001","Sis Student #002","3.279","2.867","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Sis Student #002","Sis Student #003","6.138","1.049","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Sis Student #003","Sis Student #004","9.085","7.954","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Sis Student #004","Sis Student #005","8.398","4.740","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sis Student #005","Sis Student #001","218","1.066","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":574},{"label":"Mar","value":694},{"label":"Abr","value":890},{"label":"Mai","value":809},{"label":"Jun","value":603},{"label":"Jul","value":809},{"label":"Ago","value":812},{"label":"Set","value":657},{"label":"Out","value":762},{"label":"Nov","value":882},{"label":"Dez","value":909}];
const MX = 909;
