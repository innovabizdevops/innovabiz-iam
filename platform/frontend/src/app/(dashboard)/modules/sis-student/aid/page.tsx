...
const PAGE = "Financial Aid";
const KPIS = [{"l":"Total Sis Student","v":"7.505","t":"-1.5%","d":"down"},{"l":"Financial Aid Ativos","v":"2.111","t":"+17.8%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"83","t":"+14.6%","d":"up"}];
const COLS = ["ID","Financial Aid","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sis Student #001","Sis Student #002","4.500","2.791","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Sis Student #002","Sis Student #003","4.545","5.245","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Sis Student #003","Sis Student #004","7.496","9.068","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Sis Student #004","Sis Student #005","4.642","927","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sis Student #005","Sis Student #001","2.917","4.735","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":829},{"label":"Mar","value":717},{"label":"Abr","value":713},{"label":"Mai","value":953},{"label":"Jun","value":1000},{"label":"Jul","value":1057},{"label":"Ago","value":975},{"label":"Set","value":1034},{"label":"Out","value":1010},{"label":"Nov","value":995},{"label":"Dez","value":714}];
const MX = 1057;
