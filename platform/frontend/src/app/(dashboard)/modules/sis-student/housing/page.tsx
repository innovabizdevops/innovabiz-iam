...
const PAGE = "Housing Mgmt";
const KPIS = [{"l":"Total Sis Student","v":"6.403","t":"+5.6%","d":"up"},{"l":"Housing Mgmt Ativos","v":"4.613","t":"-1.4%","d":"down"},{"l":"Eficiência (%)","v":"90.9%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"88","t":"+16.4%","d":"up"}];
const COLS = ["ID","Housing Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sis Student #001","Sis Student #002","2.197","7.670","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Sis Student #002","Sis Student #003","7.137","939","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Sis Student #003","Sis Student #004","8.363","602","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Sis Student #004","Sis Student #005","3.600","548","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sis Student #005","Sis Student #001","339","5.732","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":501},{"label":"Mar","value":650},{"label":"Abr","value":359},{"label":"Mai","value":356},{"label":"Jun","value":351},{"label":"Jul","value":599},{"label":"Ago","value":547},{"label":"Set","value":462},{"label":"Out","value":408},{"label":"Nov","value":548},{"label":"Dez","value":658}];
const MX = 687;
