...
const ACCENT = "#1e40af";
const MODULE = "SIS Student";
const PAGE = "Discipline";
const KPIS = [{"l":"Total Sis Student","v":"6.504","t":"+2.6%","d":"up"},{"l":"Discipline Ativos","v":"5.328","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"66.5%","t":"+16.3%","d":"up"},{"l":"Score Performance","v":"60","t":"+13.4%","d":"up"}];
const COLS = ["ID","Discipline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sis Student #001","Sis Student #002","6.454","1.050","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Sis Student #002","Sis Student #003","670","3.983","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Sis Student #003","Sis Student #004","8.500","6.999","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Sis Student #004","Sis Student #005","2.904","7.070","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sis Student #005","Sis Student #001","8.556","3.942","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":589},{"label":"Mar","value":643},{"label":"Abr","value":552},{"label":"Mai","value":892},{"label":"Jun","value":907},{"label":"Jul","value":740},{"label":"Ago","value":901},{"label":"Set","value":571},{"label":"Out","value":665},{"label":"Nov","value":633},{"label":"Dez","value":635}];
const MX = 907;
