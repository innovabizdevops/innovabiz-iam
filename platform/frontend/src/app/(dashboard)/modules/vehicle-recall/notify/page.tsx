...
const PAGE = "Notify";
const KPIS = [{"l":"Notificações Enviadas","v":"2.771","t":"-0.6%","d":"down"},{"l":"Taxa Entrega (%)","v":"90.3%","t":"-0.8%","d":"down"},{"l":"Taxa Abertura (%)","v":"77.2%","t":"+15.4%","d":"up"},{"l":"Escalações","v":"6.708","t":"-2.8%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","5.429","96.6%","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","7.990","79.4%","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","1.268","82.4%","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","6.595","79.4%","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","8.132","79.3%","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":802},{"label":"Fev","value":802},{"label":"Mar","value":796},{"label":"Abr","value":710},{"label":"Mai","value":485},{"label":"Jun","value":563},{"label":"Jul","value":418},{"label":"Ago","value":463},{"label":"Set","value":778},{"label":"Out","value":652},{"label":"Nov","value":428},{"label":"Dez","value":479}];
const MX = 802;
