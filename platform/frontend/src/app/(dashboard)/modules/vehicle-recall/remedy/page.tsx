...
const PAGE = "Remedy";
const KPIS = [{"l":"Total Vehicle Recall","v":"6.632","t":"-3.0%","d":"down"},{"l":"Remedy Ativos","v":"275","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"77.8%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"93","t":"+10.4%","d":"up"}];
const COLS = ["ID","Remedy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vehicle Recall #001","Vehicle Recall #002","5.130","7.467","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Vehicle Recall #002","Vehicle Recall #003","6.641","5.456","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Vehicle Recall #003","Vehicle Recall #004","4.416","4.628","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Vehicle Recall #004","Vehicle Recall #005","2.962","9.094","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vehicle Recall #005","Vehicle Recall #001","7.717","7.007","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":462},{"label":"Fev","value":361},{"label":"Mar","value":324},{"label":"Abr","value":505},{"label":"Mai","value":337},{"label":"Jun","value":586},{"label":"Jul","value":582},{"label":"Ago","value":318},{"label":"Set","value":605},{"label":"Out","value":686},{"label":"Nov","value":485},{"label":"Dez","value":361}];
const MX = 686;
