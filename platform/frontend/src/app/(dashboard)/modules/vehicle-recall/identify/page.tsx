...
const PAGE = "Identify";
const KPIS = [{"l":"Total Vehicle Recall","v":"8.713","t":"+6.4%","d":"up"},{"l":"Identify Ativos","v":"4.582","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"81.3%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"79","t":"+6.2%","d":"up"}];
const COLS = ["ID","Identify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vehicle Recall #001","Vehicle Recall #002","6.002","3.854","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Vehicle Recall #002","Vehicle Recall #003","6.947","8.977","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Vehicle Recall #003","Vehicle Recall #004","7.905","3.438","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Vehicle Recall #004","Vehicle Recall #005","3.232","933","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vehicle Recall #005","Vehicle Recall #001","6.957","9.064","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":599},{"label":"Mar","value":823},{"label":"Abr","value":695},{"label":"Mai","value":832},{"label":"Jun","value":851},{"label":"Jul","value":767},{"label":"Ago","value":611},{"label":"Set","value":713},{"label":"Out","value":823},{"label":"Nov","value":796},{"label":"Dez","value":903}];
const MX = 903;
