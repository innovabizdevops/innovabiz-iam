...
const PAGE = "Report";
const KPIS = [{"l":"Total Vehicle Recall","v":"1.827","t":"+9.7%","d":"up"},{"l":"Report Ativos","v":"1.853","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"81.6%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"78","t":"+0.9%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vehicle Recall #001","Vehicle Recall #002","7.666","6.786","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Vehicle Recall #002","Vehicle Recall #003","4.051","6.417","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Vehicle Recall #003","Vehicle Recall #004","7.176","6.039","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Vehicle Recall #004","Vehicle Recall #005","7.410","5.135","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vehicle Recall #005","Vehicle Recall #001","4.821","4.089","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":996},{"label":"Fev","value":758},{"label":"Mar","value":767},{"label":"Abr","value":903},{"label":"Mai","value":661},{"label":"Jun","value":1012},{"label":"Jul","value":897},{"label":"Ago","value":766},{"label":"Set","value":630},{"label":"Out","value":901},{"label":"Nov","value":758},{"label":"Dez","value":867}];
const MX = 1012;
