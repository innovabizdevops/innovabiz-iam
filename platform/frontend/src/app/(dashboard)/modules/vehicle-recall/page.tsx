...
export default function VehicleRecallPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Vehicle Recall</h1><p className="text-sm text-muted-foreground">Vehicle Recall • iBOS Enterprise</p></div>
