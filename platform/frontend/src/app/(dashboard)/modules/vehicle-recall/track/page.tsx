...
const ACCENT = "#6366f1";
const MODULE = "Vehicle Recall";
const PAGE = "Track";
const KPIS = [{"l":"Total Vehicle Recall","v":"4.898","t":"-3.9%","d":"down"},{"l":"Track Ativos","v":"5.996","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"78.6%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"76","t":"+9.2%","d":"up"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vehicle Recall #001","Vehicle Recall #002","4.568","8.534","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Vehicle Recall #002","Vehicle Recall #003","4.538","2.588","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Vehicle Recall #003","Vehicle Recall #004","5.869","2.116","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Vehicle Recall #004","Vehicle Recall #005","2.158","8.942","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vehicle Recall #005","Vehicle Recall #001","5.963","2.127","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":348},{"label":"Mar","value":485},{"label":"Abr","value":436},{"label":"Mai","value":250},{"label":"Jun","value":636},{"label":"Jul","value":472},{"label":"Ago","value":331},{"label":"Set","value":551},{"label":"Out","value":317},{"label":"Nov","value":409},{"label":"Dez","value":246}];
const MX = 636;
