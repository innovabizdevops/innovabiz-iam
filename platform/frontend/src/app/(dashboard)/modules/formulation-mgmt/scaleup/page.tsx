...
const PAGE = "Scale-Up";
const KPIS = [{"l":"Formulários Ativos","v":"2.315","t":"+15.5%","d":"up"},{"l":"Submissões/Dia","v":"1853","t":"+6.1%","d":"up"},{"l":"Documentos Gerados","v":"5.041","t":"-3.5%","d":"down"},{"l":"Templates","v":"6.216","t":"-0.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.599","2026-02-25","2.307","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.992","2026-01-19","804","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.788","2026-01-11","721","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","880","2026-02-02","3.062","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.178","2026-03-08","1.510","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":910},{"label":"Mar","value":700},{"label":"Abr","value":767},{"label":"Mai","value":948},{"label":"Jun","value":780},{"label":"Jul","value":768},{"label":"Ago","value":689},{"label":"Set","value":751},{"label":"Out","value":919},{"label":"Nov","value":841},{"label":"Dez","value":599}];
const MX = 948;
