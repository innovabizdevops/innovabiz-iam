...
const PAGE = "Ingredient DB";
const KPIS = [{"l":"Formulários Ativos","v":"1.445","t":"+7.3%","d":"up"},{"l":"Submissões/Dia","v":"2525","t":"+5.7%","d":"up"},{"l":"Documentos Gerados","v":"3.758","t":"-3.5%","d":"down"},{"l":"Templates","v":"8.721","t":"-1.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.579","2026-02-19","5.912","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.158","2026-01-02","7.135","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.235","2026-01-25","1.914","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.024","2026-01-24","3.032","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.280","2026-02-10","1.521","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":295},{"label":"Fev","value":300},{"label":"Mar","value":657},{"label":"Abr","value":387},{"label":"Mai","value":431},{"label":"Jun","value":490},{"label":"Jul","value":426},{"label":"Ago","value":498},{"label":"Set","value":431},{"label":"Out","value":620},{"label":"Nov","value":410},{"label":"Dez","value":594}];
const MX = 657;
