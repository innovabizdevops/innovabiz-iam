...
const ACCENT = "#059669";
const MODULE = "Formulation Mgmt";
const PAGE = "Cost Optimize";
const KPIS = [{"l":"Formulários Ativos","v":"1.016","t":"+14.4%","d":"up"},{"l":"Submissões/Dia","v":"357","t":"+14.0%","d":"up"},{"l":"Documentos Gerados","v":"7.124","t":"-3.9%","d":"down"},{"l":"Templates","v":"786","t":"+10.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.054","2026-03-23","3.389","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.749","2026-02-28","5.757","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.669","2026-01-15","7.255","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.352","2026-01-06","8.756","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.357","2026-01-13","3.130","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":682},{"label":"Mar","value":686},{"label":"Abr","value":817},{"label":"Mai","value":993},{"label":"Jun","value":966},{"label":"Jul","value":696},{"label":"Ago","value":763},{"label":"Set","value":996},{"label":"Out","value":853},{"label":"Nov","value":841},{"label":"Dez","value":831}];
const MX = 996;
