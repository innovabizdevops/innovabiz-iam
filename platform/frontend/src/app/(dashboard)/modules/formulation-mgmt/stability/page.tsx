...
const KPIS = [{"l":"Formulários Ativos","v":"6.609","t":"-5.2%","d":"down"},{"l":"Submissões/Dia","v":"2622","t":"+3.5%","d":"up"},{"l":"Documentos Gerados","v":"8.920","t":"+7.3%","d":"up"},{"l":"Templates","v":"4.984","t":"+2.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.034","2026-03-09","335","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","185","2026-01-06","220","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.965","2026-02-10","1.649","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.377","2026-02-05","2.087","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.300","2026-03-07","1.676","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":477},{"label":"Fev","value":554},{"label":"Mar","value":341},{"label":"Abr","value":361},{"label":"Mai","value":484},{"label":"Jun","value":343},{"label":"Jul","value":644},{"label":"Ago","value":316},{"label":"Set","value":586},{"label":"Out","value":447},{"label":"Nov","value":393},{"label":"Dez","value":439}];
const MX = 644;
