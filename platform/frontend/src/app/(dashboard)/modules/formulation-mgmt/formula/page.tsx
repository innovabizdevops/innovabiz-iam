...
const PAGE = "Formula Builder";
const KPIS = [{"l":"Formulários Ativos","v":"3.464","t":"-4.4%","d":"down"},{"l":"Submissões/Dia","v":"3289","t":"+14.7%","d":"up"},{"l":"Documentos Gerados","v":"912","t":"-3.2%","d":"down"},{"l":"Templates","v":"7.690","t":"+0.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.324","2026-02-21","1.573","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.395","2026-01-26","488","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.957","2026-02-24","4.783","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","891","2026-02-18","4.600","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.814","2026-01-07","5.062","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":642},{"label":"Mar","value":678},{"label":"Abr","value":473},{"label":"Mai","value":501},{"label":"Jun","value":605},{"label":"Jul","value":639},{"label":"Ago","value":396},{"label":"Set","value":552},{"label":"Out","value":377},{"label":"Nov","value":455},{"label":"Dez","value":589}];
const MX = 697;
