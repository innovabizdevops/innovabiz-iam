...
/* ═══ Hair Transplant — Dashboard ═══ */

const ACCENT = "#9d174d";

const KPIS = [
    { label: "Total Registos", value: "6199", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4825", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€273K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1441861899", cells: ["HAI-8899", "Hair Transplant Item 1", "24/4/2026", "€11 999"], status: "active" as const },
    { id: "1441865470", cells: ["HAI-3470", "Hair Transplant Item 2", "11/11/2026", "€15 570"], status: "pending" as const },
    { id: "1441869041", cells: ["HAI-7041", "Hair Transplant Item 3", "26/6/2026", "€19 141"], status: "completed" as const },
    { id: "1441872612", cells: ["HAI-1612", "Hair Transplant Item 4", "13/1/2026", "€22 712"], status: "warning" as const },
    { id: "1441876183", cells: ["HAI-5183", "Hair Transplant Item 5", "28/8/2026", "€26 283"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Hair Transplant</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Hair Transplant</p>
                    </div>
                </div>
