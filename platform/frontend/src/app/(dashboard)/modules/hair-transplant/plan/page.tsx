...
const ACCENT = "#9d174d";
const MODULE = "Hair Transplant";
const PAGE = "Plan";
const KPIS = [{"l":"Total Hair Transplant","v":"6.112","t":"+11.6%","d":"up"},{"l":"Plan Ativos","v":"7.525","t":"-3.9%","d":"down"},{"l":"Eficiência (%)","v":"92.2%","t":"-1.8%","d":"down"},{"l":"Score Performance","v":"83","t":"+5.6%","d":"up"}];
const COLS = ["ID","Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hair Transplant #001","Hair Transplant #002","5.530","7.895","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Hair Transplant #002","Hair Transplant #003","6.515","7.271","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Hair Transplant #003","Hair Transplant #004","1.653","3.660","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Hair Transplant #004","Hair Transplant #005","6.431","7.822","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hair Transplant #005","Hair Transplant #001","6.994","8.013","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":449},{"label":"Fev","value":593},{"label":"Mar","value":422},{"label":"Abr","value":342},{"label":"Mai","value":444},{"label":"Jun","value":475},{"label":"Jul","value":569},{"label":"Ago","value":482},{"label":"Set","value":676},{"label":"Out","value":550},{"label":"Nov","value":610},{"label":"Dez","value":633}];
const MX = 676;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#9d174d'}}>AI</span></h1>
                </div>
