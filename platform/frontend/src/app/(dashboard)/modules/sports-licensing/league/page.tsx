...
const PAGE = "League";
const KPIS = [{"l":"Atletas Registados","v":"8.827","t":"+10.8%","d":"up"},{"l":"Treinos/Semana","v":"2868","t":"+13.1%","d":"up"},{"l":"Competições","v":"234","t":"-4.2%","d":"down"},{"l":"Performance Score","v":"77","t":"+14.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","889","290","3.499","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.749","6.315","4.141","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","276","6.267","2.516","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.482","4.290","1.980","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","830","1.839","1.300","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":247},{"label":"Mar","value":472},{"label":"Abr","value":463},{"label":"Mai","value":394},{"label":"Jun","value":281},{"label":"Jul","value":578},{"label":"Ago","value":410},{"label":"Set","value":299},{"label":"Out","value":424},{"label":"Nov","value":286},{"label":"Dez","value":410}];
const MX = 578;
