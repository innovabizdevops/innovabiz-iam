...
const PAGE = "Licensee";
const KPIS = [{"l":"Atletas Registados","v":"8.599","t":"+11.2%","d":"up"},{"l":"Treinos/Semana","v":"3311","t":"+4.2%","d":"up"},{"l":"Competições","v":"8.896","t":"+10.1%","d":"up"},{"l":"Performance Score","v":"79","t":"-0.2%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.964","6.481","2.487","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.656","9.088","8.407","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.042","5.042","6.629","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","554","7.104","8.607","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.587","770","341","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":350},{"label":"Fev","value":498},{"label":"Mar","value":497},{"label":"Abr","value":561},{"label":"Mai","value":367},{"label":"Jun","value":401},{"label":"Jul","value":671},{"label":"Ago","value":643},{"label":"Set","value":390},{"label":"Out","value":511},{"label":"Nov","value":524},{"label":"Dez","value":711}];
const MX = 711;
