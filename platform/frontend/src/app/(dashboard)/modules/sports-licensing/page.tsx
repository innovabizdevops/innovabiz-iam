...
/* ═══ Sports Licensing — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "6923", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2478", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€125K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "673246423", cells: ["SPO-2423", "Sports Licensing Item 1", "4/8/2026", "€46 523"], status: "active" as const },
    { id: "673249994", cells: ["SPO-5994", "Sports Licensing Item 2", "19/3/2026", "€50 094"], status: "pending" as const },
    { id: "673253565", cells: ["SPO-9565", "Sports Licensing Item 3", "6/10/2026", "€3665"], status: "completed" as const },
    { id: "673257136", cells: ["SPO-4136", "Sports Licensing Item 4", "21/5/2026", "€7236"], status: "warning" as const },
    { id: "673260707", cells: ["SPO-7707", "Sports Licensing Item 5", "8/12/2026", "€10 807"], status: "active" as const },
];
...
export default function SportsLicensingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sports Licensing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Sports Licensing</p>
                    </div>
                </div>
