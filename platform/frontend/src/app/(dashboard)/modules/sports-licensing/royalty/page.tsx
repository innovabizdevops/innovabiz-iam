...
const PAGE = "Royalty";
const KPIS = [{"l":"Atletas Registados","v":"629","t":"-2.9%","d":"down"},{"l":"Treinos/Semana","v":"3059","t":"+10.0%","d":"up"},{"l":"Competições","v":"708","t":"+0.1%","d":"up"},{"l":"Performance Score","v":"85","t":"+14.5%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","971","3.060","6.138","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.360","2.867","2.904","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.478","2.548","6.922","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.175","1.740","7.982","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.985","9.032","3.196","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":326},{"label":"Fev","value":475},{"label":"Mar","value":515},{"label":"Abr","value":660},{"label":"Mai","value":541},{"label":"Jun","value":458},{"label":"Jul","value":544},{"label":"Ago","value":622},{"label":"Set","value":716},{"label":"Out","value":500},{"label":"Nov","value":544},{"label":"Dez","value":710}];
const MX = 716;
