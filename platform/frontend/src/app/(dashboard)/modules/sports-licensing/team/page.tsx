...
const ACCENT = "#1e40af";
const MODULE = "Sports Licensing";
const PAGE = "Team";
const KPIS = [{"l":"Teams Ativos","v":"4.848","t":"+2.6%","d":"up"},{"l":"Reuniões/Semana","v":"2755","t":"+16.7%","d":"up"},{"l":"Mensagens/Dia","v":"2097","t":"+9.9%","d":"up"},{"l":"Ficheiros Partilhados","v":"4.131","t":"+14.4%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.213","1395","5.657","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","806","2627","2.007","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","5.956","4559","2.702","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.798","2403","4.826","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","3.565","4395","7.477","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":271},{"label":"Fev","value":378},{"label":"Mar","value":396},{"label":"Abr","value":453},{"label":"Mai","value":399},{"label":"Jun","value":320},{"label":"Jul","value":430},{"label":"Ago","value":533},{"label":"Set","value":621},{"label":"Out","value":617},{"label":"Nov","value":565},{"label":"Dez","value":303}];
const MX = 621;
