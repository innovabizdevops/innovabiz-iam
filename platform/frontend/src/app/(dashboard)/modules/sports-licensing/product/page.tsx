...
const PAGE = "Product";
const KPIS = [{"l":"Atletas Registados","v":"8.119","t":"+5.4%","d":"up"},{"l":"Treinos/Semana","v":"429","t":"+15.6%","d":"up"},{"l":"Competições","v":"7.752","t":"+9.4%","d":"up"},{"l":"Performance Score","v":"92","t":"+7.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.987","3.811","5.313","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.312","4.417","4.346","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.672","6.346","4.612","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.084","8.089","4.883","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","170","7.989","5.563","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":759},{"label":"Fev","value":551},{"label":"Mar","value":854},{"label":"Abr","value":742},{"label":"Mai","value":592},{"label":"Jun","value":476},{"label":"Jul","value":664},{"label":"Ago","value":698},{"label":"Set","value":831},{"label":"Out","value":635},{"label":"Nov","value":654},{"label":"Dez","value":769}];
const MX = 854;
