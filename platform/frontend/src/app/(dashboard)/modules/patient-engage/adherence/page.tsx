...
const PAGE = "Adherence";
const KPIS = [{"l":"Total Patient Engage","v":"3.539","t":"+11.0%","d":"up"},{"l":"Adherence Ativos","v":"170","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"81.4%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"61","t":"+4.3%","d":"up"}];
const COLS = ["ID","Adherence","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Patient Engage #001","Patient Engage #002","7.972","8.045","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Patient Engage #002","Patient Engage #003","4.318","3.006","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Patient Engage #003","Patient Engage #004","5.744","2.546","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Patient Engage #004","Patient Engage #005","9.016","5.663","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Patient Engage #005","Patient Engage #001","3.234","2.967","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":922},{"label":"Fev","value":863},{"label":"Mar","value":849},{"label":"Abr","value":788},{"label":"Mai","value":791},{"label":"Jun","value":830},{"label":"Jul","value":928},{"label":"Ago","value":809},{"label":"Set","value":990},{"label":"Out","value":869},{"label":"Nov","value":919},{"label":"Dez","value":690}];
const MX = 990;
