...
const KPIS = [{"l":"Integrações Ativas","v":"3.651","t":"+14.8%","d":"up"},{"l":"Chamadas/Hora","v":"3425","t":"-5.6%","d":"down"},{"l":"Taxa Sucesso (%)","v":"87.0%","t":"+11.6%","d":"up"},{"l":"Latência Média (ms)","v":"88ms","t":"+3.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.295","5.317","74.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.045","7.473","91.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.701","6.251","96.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.657","717","94.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.014","4.339","93.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":396},{"label":"Fev","value":673},{"label":"Mar","value":409},{"label":"Abr","value":552},{"label":"Mai","value":651},{"label":"Jun","value":561},{"label":"Jul","value":649},{"label":"Ago","value":562},{"label":"Set","value":400},{"label":"Out","value":404},{"label":"Nov","value":585},{"label":"Dez","value":531}];
const MX = 673;
