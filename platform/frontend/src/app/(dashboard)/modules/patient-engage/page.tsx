...
export default function PatientEngagePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Patient Engage</h1><p className="text-sm text-muted-foreground">Patient Engage • iBOS Enterprise</p></div>
