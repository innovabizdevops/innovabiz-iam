...
const ACCENT = "#854d0e";
const MODULE = "Energy Efficiency Platform";
const PAGE = "Optimize";
const KPIS = [{"l":"Total Energy Efficiency","v":"817","t":"-1.6%","d":"down"},{"l":"Optimize Ativos","v":"5.166","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"82.4%","t":"+4.1%","d":"up"},{"l":"Score Performance","v":"71","t":"+9.7%","d":"up"}];
const COLS = ["ID","Optimize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Efficiency #001","Energy Efficiency #002","1.666","3.352","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Efficiency #002","Energy Efficiency #003","6.672","6.434","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Efficiency #003","Energy Efficiency #004","898","4.838","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Efficiency #004","Energy Efficiency #005","1.402","2.025","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Efficiency #005","Energy Efficiency #001","2.915","2.484","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":728},{"label":"Mar","value":815},{"label":"Abr","value":745},{"label":"Mai","value":697},{"label":"Jun","value":860},{"label":"Jul","value":1022},{"label":"Ago","value":989},{"label":"Set","value":897},{"label":"Out","value":901},{"label":"Nov","value":759},{"label":"Dez","value":955}];
const MX = 1022;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#854d0e'}}>AI</span></h1>
                </div>
