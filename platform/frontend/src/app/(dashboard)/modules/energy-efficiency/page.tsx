...
/* ═══ Energy Efficiency Platform — Dashboard ═══ */

const ACCENT = "#854d0e";

const KPIS = [
    { label: "Total Registos", value: "7629", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3746", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€256K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1570315829", cells: ["ENE-5829", "Energy Efficiency Platform Item 1", "6/6/2026", "€15 929"], status: "active" as const },
    { id: "1570319400", cells: ["ENE-9400", "Energy Efficiency Platform Item 2", "21/1/2026", "€19 500"], status: "pending" as const },
    { id: "1570322971", cells: ["ENE-3971", "Energy Efficiency Platform Item 3", "8/8/2026", "€23 071"], status: "completed" as const },
    { id: "1570326542", cells: ["ENE-7542", "Energy Efficiency Platform Item 4", "23/3/2026", "€26 642"], status: "warning" as const },
    { id: "1570330113", cells: ["ENE-2113", "Energy Efficiency Platform Item 5", "10/10/2026", "€30 213"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 89 }, { label: "Fev", value: 98 }, { label: "Mar", value: 27 }, { label: "Abr", value: 36 }, { label: "Mai", value: 45 }, { label: "Jun", value: 54 }];
...
export default function EnergyEfficiencyPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Energy Efficiency Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Energy Efficiency Platform</p>
                    </div>
                </div>
