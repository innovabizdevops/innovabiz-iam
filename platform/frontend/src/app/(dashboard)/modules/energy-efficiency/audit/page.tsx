...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.407","t":"+16.0%","d":"up"},{"l":"NC Abertas","v":"7.952","t":"+5.1%","d":"up"},{"l":"Conformidade (%)","v":"81.5%","t":"+1.4%","d":"up"},{"l":"CAPAs Pendentes","v":"963","t":"-3.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.793","94.1%","1.652","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.856","97.5%","5.571","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.877","81.1%","3.505","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.723","71.8%","1.872","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.697","73.7%","918","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":581},{"label":"Fev","value":394},{"label":"Mar","value":419},{"label":"Abr","value":406},{"label":"Mai","value":439},{"label":"Jun","value":506},{"label":"Jul","value":364},{"label":"Ago","value":265},{"label":"Set","value":629},{"label":"Out","value":622},{"label":"Nov","value":532},{"label":"Dez","value":615}];
const MX = 629;
