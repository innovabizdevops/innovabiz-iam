...
const PAGE = "Certify";
const KPIS = [{"l":"Total Energy Efficiency","v":"881","t":"-2.7%","d":"down"},{"l":"Certify Ativos","v":"2.253","t":"+8.4%","d":"up"},{"l":"Eficiência (%)","v":"82.8%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"61","t":"+9.3%","d":"up"}];
const COLS = ["ID","Certify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Efficiency #001","Energy Efficiency #002","171","8.337","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Efficiency #002","Energy Efficiency #003","6.276","3.529","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Efficiency #003","Energy Efficiency #004","6.122","7.396","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Efficiency #004","Energy Efficiency #005","8.067","3.801","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Efficiency #005","Energy Efficiency #001","5.275","5.815","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":411},{"label":"Fev","value":485},{"label":"Mar","value":584},{"label":"Abr","value":486},{"label":"Mai","value":432},{"label":"Jun","value":524},{"label":"Jul","value":351},{"label":"Ago","value":647},{"label":"Set","value":557},{"label":"Out","value":653},{"label":"Nov","value":413},{"label":"Dez","value":626}];
const MX = 653;
