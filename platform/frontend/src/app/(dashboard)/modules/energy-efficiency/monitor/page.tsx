...
const PAGE = "Monitor";
const KPIS = [{"l":"Total Energy Efficiency","v":"2.768","t":"+7.1%","d":"up"},{"l":"Monitor Ativos","v":"246","t":"+14.1%","d":"up"},{"l":"Eficiência (%)","v":"74.5%","t":"+17.2%","d":"up"},{"l":"Score Performance","v":"72","t":"+7.1%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Efficiency #001","Energy Efficiency #002","3.630","1.567","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Efficiency #002","Energy Efficiency #003","6.694","3.895","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Efficiency #003","Energy Efficiency #004","7.861","337","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Efficiency #004","Energy Efficiency #005","8.253","2.490","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Efficiency #005","Energy Efficiency #001","1.135","7.412","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":657},{"label":"Mar","value":467},{"label":"Abr","value":763},{"label":"Mai","value":758},{"label":"Jun","value":429},{"label":"Jul","value":468},{"label":"Ago","value":535},{"label":"Set","value":419},{"label":"Out","value":520},{"label":"Nov","value":579},{"label":"Dez","value":698}];
const MX = 763;
