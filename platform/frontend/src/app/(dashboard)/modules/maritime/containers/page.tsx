...
const PAGE = "Container Mgmt";
const KPIS = [{"l":"Total Maritime","v":"7.207","t":"-4.6%","d":"down"},{"l":"Container Mgmt Ativos","v":"8.716","t":"-6.0%","d":"down"},{"l":"Eficiência (%)","v":"65.2%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"57","t":"+14.1%","d":"up"}];
const COLS = ["ID","Container Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Maritime #001","Maritime #002","5.220","2.664","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Maritime #002","Maritime #003","4.624","5.405","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Maritime #003","Maritime #004","848","1.500","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Maritime #004","Maritime #005","8.583","3.026","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Maritime #005","Maritime #001","1.251","8.210","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":922},{"label":"Fev","value":722},{"label":"Mar","value":971},{"label":"Abr","value":732},{"label":"Mai","value":740},{"label":"Jun","value":726},{"label":"Jul","value":876},{"label":"Ago","value":896},{"label":"Set","value":912},{"label":"Out","value":961},{"label":"Nov","value":843},{"label":"Dez","value":916}];
const MX = 971;
