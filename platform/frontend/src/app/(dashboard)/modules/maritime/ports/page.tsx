...
const PAGE = "Port Operations";
const KPIS = [{"l":"Total Maritime","v":"9.043","t":"+15.1%","d":"up"},{"l":"Port Operations Ativos","v":"2.535","t":"+14.1%","d":"up"},{"l":"Eficiência (%)","v":"93.7%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"89","t":"+2.8%","d":"up"}];
const COLS = ["ID","Port Operations","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Maritime #001","Maritime #002","6.842","8.777","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Maritime #002","Maritime #003","5.843","8.223","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Maritime #003","Maritime #004","4.807","6.665","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Maritime #004","Maritime #005","4.458","8.222","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Maritime #005","Maritime #001","5.399","4.118","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":646},{"label":"Mar","value":669},{"label":"Abr","value":312},{"label":"Mai","value":637},{"label":"Jun","value":429},{"label":"Jul","value":494},{"label":"Ago","value":305},{"label":"Set","value":597},{"label":"Out","value":435},{"label":"Nov","value":653},{"label":"Dez","value":430}];
const MX = 669;
