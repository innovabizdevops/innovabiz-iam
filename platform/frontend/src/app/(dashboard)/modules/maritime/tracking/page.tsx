...
const ACCENT = "#0369a1";
const MODULE = "Maritime & Shipping";
const PAGE = "Vessel Tracking";
const KPIS = [{"l":"Total Maritime","v":"462","t":"+10.9%","d":"up"},{"l":"Vessel Tracking Ativos","v":"1.908","t":"+5.8%","d":"up"},{"l":"Eficiência (%)","v":"83.5%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"90","t":"+16.4%","d":"up"}];
const COLS = ["ID","Vessel Tracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Maritime #001","Maritime #002","4.173","4.180","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Maritime #002","Maritime #003","8.519","2.592","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Maritime #003","Maritime #004","1.245","4.335","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Maritime #004","Maritime #005","6.218","4.318","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Maritime #005","Maritime #001","936","8.243","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":789},{"label":"Mar","value":462},{"label":"Abr","value":640},{"label":"Mai","value":678},{"label":"Jun","value":681},{"label":"Jul","value":444},{"label":"Ago","value":607},{"label":"Set","value":519},{"label":"Out","value":608},{"label":"Nov","value":690},{"label":"Dez","value":616}];
const MX = 789;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0369a1'}}>AIS</span></h1>
                </div>
