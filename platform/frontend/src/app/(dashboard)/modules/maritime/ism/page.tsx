...
const PAGE = "Compliance (ISM)";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.170","t":"-1.2%","d":"down"},{"l":"NC Abertas","v":"1.496","t":"+7.1%","d":"up"},{"l":"Conformidade (%)","v":"81.6%","t":"+11.5%","d":"up"},{"l":"CAPAs Pendentes","v":"5.717","t":"-3.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.846","77.8%","8.166","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.852","78.0%","871","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.596","96.4%","5.943","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.039","74.9%","4.372","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","200","78.6%","4.751","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":800},{"label":"Fev","value":683},{"label":"Mar","value":588},{"label":"Abr","value":568},{"label":"Mai","value":465},{"label":"Jun","value":568},{"label":"Jul","value":648},{"label":"Ago","value":815},{"label":"Set","value":496},{"label":"Out","value":626},{"label":"Nov","value":755},{"label":"Dez","value":632}];
const MX = 815;
