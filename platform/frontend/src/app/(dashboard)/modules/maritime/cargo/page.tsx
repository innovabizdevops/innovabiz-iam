...
const PAGE = "Cargo Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"7.663","t":"+2.6%","d":"up"},{"l":"RevPAR (€)","v":"€17685","t":"+15.4%","d":"up"},{"l":"Ocupação (%)","v":"67.0%","t":"+7.7%","d":"up"},{"l":"Guest Satisfaction","v":"2.036","t":"+0.5%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.450","2026-02-07","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.287","2026-02-25","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.894","2026-01-02","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.342","2026-03-23","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.603","2026-01-26","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":918},{"label":"Fev","value":952},{"label":"Mar","value":635},{"label":"Abr","value":732},{"label":"Mai","value":617},{"label":"Jun","value":738},{"label":"Jul","value":910},{"label":"Ago","value":729},{"label":"Set","value":764},{"label":"Out","value":928},{"label":"Nov","value":705},{"label":"Dez","value":707}];
const MX = 952;
