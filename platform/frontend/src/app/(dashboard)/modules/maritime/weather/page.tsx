...
const PAGE = "Weather Routing";
const KPIS = [{"l":"Total Maritime","v":"4.088","t":"+5.0%","d":"up"},{"l":"Weather Routing Ativos","v":"323","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"80.6%","t":"+12.0%","d":"up"},{"l":"Score Performance","v":"78","t":"+3.0%","d":"up"}];
const COLS = ["ID","Weather Routing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Maritime #001","Maritime #002","8.026","6.476","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Maritime #002","Maritime #003","427","1.449","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Maritime #003","Maritime #004","1.273","8.877","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Maritime #004","Maritime #005","6.644","7.812","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Maritime #005","Maritime #001","6.230","1.318","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":457},{"label":"Fev","value":361},{"label":"Mar","value":606},{"label":"Abr","value":508},{"label":"Mai","value":225},{"label":"Jun","value":446},{"label":"Jul","value":371},{"label":"Ago","value":367},{"label":"Set","value":290},{"label":"Out","value":490},{"label":"Nov","value":437},{"label":"Dez","value":483}];
const MX = 606;
