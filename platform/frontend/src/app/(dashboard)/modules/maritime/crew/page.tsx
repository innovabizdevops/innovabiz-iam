...
const PAGE = "Crew Management";
const KPIS = [{"l":"Projetos Melhoria","v":"4.456","t":"+4.3%","d":"up"},{"l":"Savings (€)","v":"€7489","t":"+3.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"80.6%","t":"+14.5%","d":"up"},{"l":"Ciclos PDCA","v":"7.861","t":"+10.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","775","€ 30278.91","2.422","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.629","€ 39055.59","1.818","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.465","€ 37240.61","7.793","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.921","€ 44200.31","8.993","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.877","€ 4438.30","5.028","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":543},{"label":"Mar","value":477},{"label":"Abr","value":286},{"label":"Mai","value":308},{"label":"Jun","value":261},{"label":"Jul","value":581},{"label":"Ago","value":588},{"label":"Set","value":500},{"label":"Out","value":384},{"label":"Nov","value":394},{"label":"Dez","value":358}];
const MX = 588;
