...
const PAGE = "Bunker Management";
const KPIS = [{"l":"Projetos Melhoria","v":"4.426","t":"+7.8%","d":"up"},{"l":"Savings (€)","v":"€86668","t":"+0.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"89.6%","t":"+3.4%","d":"up"},{"l":"Ciclos PDCA","v":"156","t":"+1.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.295","€ 30525.60","2.844","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.884","€ 44958.59","3.570","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.085","€ 20412.57","7.303","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.564","€ 18400.99","8.151","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.925","€ 38386.11","457","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":502},{"label":"Mar","value":842},{"label":"Abr","value":499},{"label":"Mai","value":586},{"label":"Jun","value":764},{"label":"Jul","value":798},{"label":"Ago","value":563},{"label":"Set","value":618},{"label":"Out","value":729},{"label":"Nov","value":594},{"label":"Dez","value":831}];
const MX = 842;
