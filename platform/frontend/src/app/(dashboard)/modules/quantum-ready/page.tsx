...
/* ═══ Quantum Computing Ready — Dashboard ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total Registos", value: "1348", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4113", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€82K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "-6%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1701276648", cells: ["QUA-7648", "Quantum Computing Ready Item 1", "9/1/2026", "€26 748"], status: "active" as const },
    { id: "1701280219", cells: ["QUA-2219", "Quantum Computing Ready Item 2", "24/8/2026", "€30 319"], status: "pending" as const },
    { id: "1701283790", cells: ["QUA-5790", "Quantum Computing Ready Item 3", "11/3/2026", "€33 890"], status: "completed" as const },
    { id: "1701287361", cells: ["QUA-9361", "Quantum Computing Ready Item 4", "26/10/2026", "€37 461"], status: "warning" as const },
    { id: "1701290932", cells: ["QUA-3932", "Quantum Computing Ready Item 5", "13/5/2026", "€41 032"], status: "active" as const },
];
...
export default function QuantumComputingReadyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Quantum Computing Ready</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Quantum Computing Ready</p>
                    </div>
                </div>
