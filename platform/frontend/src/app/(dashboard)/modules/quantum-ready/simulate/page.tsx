...
const ACCENT = "#8b5cf6";
const MODULE = "Quantum Computing Ready";
const PAGE = "Simulate";
const KPIS = [{"l":"Twins Ativos","v":"6.722","t":"-3.3%","d":"down"},{"l":"Simulações/Dia","v":"4290","t":"-1.6%","d":"down"},{"l":"Precisão Modelo (%)","v":"81.9%","t":"+14.6%","d":"up"},{"l":"Latência Sync (ms)","v":"152ms","t":"+12.5%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","89.2%","2026-02-20","843","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","92.3%","2026-01-17","1.863","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","87.2%","2026-02-27","5.643","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","99.1%","2026-03-06","2.078","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","70.0%","2026-02-13","4.632","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":644},{"label":"Mar","value":483},{"label":"Abr","value":258},{"label":"Mai","value":588},{"label":"Jun","value":351},{"label":"Jul","value":440},{"label":"Ago","value":558},{"label":"Set","value":517},{"label":"Out","value":578},{"label":"Nov","value":642},{"label":"Dez","value":636}];
const MX = 644;
