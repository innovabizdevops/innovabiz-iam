...
const PAGE = "Draft";
const KPIS = [{"l":"Atletas Registados","v":"1.537","t":"+12.5%","d":"up"},{"l":"Treinos/Semana","v":"766","t":"+12.9%","d":"up"},{"l":"Competições","v":"7.952","t":"+6.4%","d":"up"},{"l":"Performance Score","v":"88","t":"-3.7%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.990","2.180","4.431","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.717","8.522","9.076","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.451","1.453","2.228","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","468","7.029","7.681","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.163","3.333","8.100","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":402},{"label":"Fev","value":654},{"label":"Mar","value":640},{"label":"Abr","value":551},{"label":"Mai","value":362},{"label":"Jun","value":520},{"label":"Jul","value":687},{"label":"Ago","value":295},{"label":"Set","value":525},{"label":"Out","value":586},{"label":"Nov","value":552},{"label":"Dez","value":560}];
const MX = 687;
