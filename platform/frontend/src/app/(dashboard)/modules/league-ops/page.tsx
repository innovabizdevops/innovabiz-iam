...
export default function LeagueOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">League Ops</h1><p className="text-sm text-muted-foreground">League Ops • iBOS Enterprise</p></div>
