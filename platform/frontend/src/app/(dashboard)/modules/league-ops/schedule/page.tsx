...
const PAGE = "Schedule";
const KPIS = [{"l":"Atletas Registados","v":"5.586","t":"+5.5%","d":"up"},{"l":"Treinos/Semana","v":"1991","t":"+4.2%","d":"up"},{"l":"Competições","v":"8.998","t":"+3.0%","d":"up"},{"l":"Performance Score","v":"59","t":"+4.8%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.103","5.958","902","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.562","3.678","5.298","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.804","6.588","7.768","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.303","231","9.094","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.572","9.023","684","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":520},{"label":"Mar","value":494},{"label":"Abr","value":398},{"label":"Mai","value":501},{"label":"Jun","value":533},{"label":"Jul","value":462},{"label":"Ago","value":254},{"label":"Set","value":341},{"label":"Out","value":539},{"label":"Nov","value":515},{"label":"Dez","value":423}];
const MX = 561;
