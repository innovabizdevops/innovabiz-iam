...
const ACCENT = "#6366f1";
const MODULE = "League Operations";
const PAGE = "Discipline";
const KPIS = [{"l":"Atletas Registados","v":"2.650","t":"+3.2%","d":"up"},{"l":"Treinos/Semana","v":"2239","t":"+2.8%","d":"up"},{"l":"Competições","v":"6.281","t":"-4.2%","d":"down"},{"l":"Performance Score","v":"56","t":"+4.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.023","4.764","6.716","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.349","6.261","1.705","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.833","7.414","5.821","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","3.229","5.326","4.197","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.432","7.686","5.671","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":748},{"label":"Mar","value":855},{"label":"Abr","value":738},{"label":"Mai","value":673},{"label":"Jun","value":836},{"label":"Jul","value":766},{"label":"Ago","value":671},{"label":"Set","value":674},{"label":"Out","value":915},{"label":"Nov","value":763},{"label":"Dez","value":942}];
const MX = 942;
