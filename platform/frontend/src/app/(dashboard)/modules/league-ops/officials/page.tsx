...
const KPIS = [{"l":"Atletas Registados","v":"3.607","t":"+11.3%","d":"up"},{"l":"Treinos/Semana","v":"1157","t":"+14.8%","d":"up"},{"l":"Competições","v":"3.301","t":"-0.8%","d":"down"},{"l":"Performance Score","v":"94","t":"+16.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.201","6.263","8.746","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","192","5.558","1.640","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.478","8.891","1.108","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","184","8.917","5.328","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.821","9.058","7.661","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":842},{"label":"Mar","value":607},{"label":"Abr","value":527},{"label":"Mai","value":847},{"label":"Jun","value":597},{"label":"Jul","value":542},{"label":"Ago","value":751},{"label":"Set","value":823},{"label":"Out","value":812},{"label":"Nov","value":757},{"label":"Dez","value":521}];
const MX = 847;
