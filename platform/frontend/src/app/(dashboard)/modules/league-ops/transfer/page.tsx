...
const PAGE = "Transfer";
const KPIS = [{"l":"Atletas Registados","v":"1.823","t":"+16.4%","d":"up"},{"l":"Treinos/Semana","v":"2860","t":"+9.7%","d":"up"},{"l":"Competições","v":"3.845","t":"-2.2%","d":"down"},{"l":"Performance Score","v":"66","t":"-0.1%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.459","8.355","3.859","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","5.380","6.718","4.658","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.507","4.225","2.191","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.750","2.606","7.885","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.910","2.261","2.175","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":781},{"label":"Mar","value":699},{"label":"Abr","value":918},{"label":"Mai","value":600},{"label":"Jun","value":738},{"label":"Jul","value":678},{"label":"Ago","value":712},{"label":"Set","value":811},{"label":"Out","value":748},{"label":"Nov","value":550},{"label":"Dez","value":801}];
const MX = 918;
