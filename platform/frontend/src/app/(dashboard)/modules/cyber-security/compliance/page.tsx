...
const KPIS = [{"l":"Auditorias Realizadas","v":"6.160","t":"-1.4%","d":"down"},{"l":"NC Abertas","v":"3.191","t":"+11.4%","d":"up"},{"l":"Conformidade (%)","v":"77.6%","t":"-3.7%","d":"down"},{"l":"CAPAs Pendentes","v":"1.019","t":"+3.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.892","84.3%","5.505","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.956","70.2%","3.852","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.877","78.4%","8.727","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","173","84.7%","6.640","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.190","90.1%","4.013","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":991},{"label":"Fev","value":861},{"label":"Mar","value":782},{"label":"Abr","value":846},{"label":"Mai","value":831},{"label":"Jun","value":823},{"label":"Jul","value":701},{"label":"Ago","value":796},{"label":"Set","value":850},{"label":"Out","value":938},{"label":"Nov","value":984},{"label":"Dez","value":922}];
const MX = 991;
