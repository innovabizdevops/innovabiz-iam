...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"9.092","t":"+5.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"77.0%","t":"+0.5%","d":"up"},{"l":"MTTR (h)","v":"17h","t":"+9.2%","d":"up"},{"l":"Satisfação (%)","v":"88.4%","t":"+3.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.752","3.026","658","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.024","1.669","4.016","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.943","4.614","7.391","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.232","5.005","2.178","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.277","3.386","4.357","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":744},{"label":"Mar","value":833},{"label":"Abr","value":615},{"label":"Mai","value":823},{"label":"Jun","value":833},{"label":"Jul","value":707},{"label":"Ago","value":811},{"label":"Set","value":613},{"label":"Out","value":647},{"label":"Nov","value":765},{"label":"Dez","value":973}];
const MX = 973;
