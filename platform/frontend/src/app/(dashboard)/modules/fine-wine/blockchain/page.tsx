...
const ACCENT = "#dc2626";
const MODULE = "Fine Wine & Spirits";
const PAGE = "Blockchain Auth";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.084","t":"+9.1%","d":"up"},{"l":"Sessões/Dia","v":"2633","t":"-4.3%","d":"down"},{"l":"MFA Adoção (%)","v":"78.6%","t":"+1.6%","d":"up"},{"l":"Tentativas Bloqueadas","v":"102","t":"+6.1%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.686","7.815","4.117","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","567","5.577","7.621","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.953","1.093","345","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","6.702","2.424","6.627","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.335","7.205","5.409","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":638},{"label":"Mar","value":837},{"label":"Abr","value":763},{"label":"Mai","value":656},{"label":"Jun","value":601},{"label":"Jul","value":699},{"label":"Ago","value":760},{"label":"Set","value":770},{"label":"Out","value":565},{"label":"Nov","value":549},{"label":"Dez","value":656}];
const MX = 837;
