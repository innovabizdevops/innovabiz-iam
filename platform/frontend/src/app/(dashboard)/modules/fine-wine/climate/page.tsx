...
const PAGE = "Climate Vintage";
const KPIS = [{"l":"Total Fine Wine","v":"387","t":"+7.1%","d":"up"},{"l":"Climate Vintage Ativos","v":"2.382","t":"+15.8%","d":"up"},{"l":"Eficiência (%)","v":"66.6%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"93","t":"+2.1%","d":"up"}];
const COLS = ["ID","Climate Vintage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fine Wine #001","Fine Wine #002","723","6.839","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Fine Wine #002","Fine Wine #003","4.793","1.750","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Fine Wine #003","Fine Wine #004","4.290","1.425","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Fine Wine #004","Fine Wine #005","3.740","427","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fine Wine #005","Fine Wine #001","7.480","4.899","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":547},{"label":"Mar","value":439},{"label":"Abr","value":474},{"label":"Mai","value":451},{"label":"Jun","value":630},{"label":"Jul","value":474},{"label":"Ago","value":443},{"label":"Set","value":377},{"label":"Out","value":723},{"label":"Nov","value":521},{"label":"Dez","value":494}];
const MX = 723;
