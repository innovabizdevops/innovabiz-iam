...
const PAGE = "Auction";
const KPIS = [{"l":"Total Fine Wine","v":"8.664","t":"+1.2%","d":"up"},{"l":"Auction Ativos","v":"6.099","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"69.0%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"67","t":"-5.9%","d":"down"}];
const COLS = ["ID","Auction","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fine Wine #001","Fine Wine #002","4.139","621","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Fine Wine #002","Fine Wine #003","2.444","2.628","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Fine Wine #003","Fine Wine #004","8.309","1.412","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Fine Wine #004","Fine Wine #005","2.908","4.447","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fine Wine #005","Fine Wine #001","3.300","4.914","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":550},{"label":"Mar","value":601},{"label":"Abr","value":586},{"label":"Mai","value":583},{"label":"Jun","value":737},{"label":"Jul","value":748},{"label":"Ago","value":881},{"label":"Set","value":671},{"label":"Out","value":928},{"label":"Nov","value":891},{"label":"Dez","value":843}];
const MX = 928;
