...
const PAGE = "En Primeur";
const KPIS = [{"l":"Total Fine Wine","v":"1.336","t":"+14.4%","d":"up"},{"l":"En Primeur Ativos","v":"6.080","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"90.5%","t":"+5.8%","d":"up"},{"l":"Score Performance","v":"72","t":"-3.2%","d":"down"}];
const COLS = ["ID","En Primeur","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fine Wine #001","Fine Wine #002","5.124","165","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Fine Wine #002","Fine Wine #003","5.697","2.026","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Fine Wine #003","Fine Wine #004","4.990","7.985","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Fine Wine #004","Fine Wine #005","7.581","8.724","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fine Wine #005","Fine Wine #001","6.868","7.337","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":545},{"label":"Fev","value":526},{"label":"Mar","value":741},{"label":"Abr","value":827},{"label":"Mai","value":703},{"label":"Jun","value":794},{"label":"Jul","value":605},{"label":"Ago","value":717},{"label":"Set","value":670},{"label":"Out","value":756},{"label":"Nov","value":670},{"label":"Dez","value":871}];
const MX = 871;
...
export default function PrimeurPage() {
    return (
