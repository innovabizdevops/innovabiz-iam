...
const PAGE = "Tasting Note";
const KPIS = [{"l":"Total Fine Wine","v":"3.042","t":"+0.4%","d":"up"},{"l":"Tasting Note Ativos","v":"4.697","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"68.1%","t":"+6.8%","d":"up"},{"l":"Score Performance","v":"68","t":"+4.1%","d":"up"}];
const COLS = ["ID","Tasting Note","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fine Wine #001","Fine Wine #002","392","8.753","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Fine Wine #002","Fine Wine #003","6.011","8.176","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Fine Wine #003","Fine Wine #004","2.016","7.695","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Fine Wine #004","Fine Wine #005","6.981","6.692","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fine Wine #005","Fine Wine #001","1.260","8.595","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":390},{"label":"Fev","value":384},{"label":"Mar","value":321},{"label":"Abr","value":323},{"label":"Mai","value":507},{"label":"Jun","value":440},{"label":"Jul","value":624},{"label":"Ago","value":300},{"label":"Set","value":365},{"label":"Out","value":651},{"label":"Nov","value":356},{"label":"Dez","value":604}];
const MX = 651;
