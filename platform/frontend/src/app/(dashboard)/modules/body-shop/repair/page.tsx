...
const PAGE = "Repair";
const KPIS = [{"l":"Total Body Shop","v":"679","t":"+3.5%","d":"up"},{"l":"Repair Ativos","v":"6.506","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"85","t":"+17.2%","d":"up"}];
const COLS = ["ID","Repair","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Shop #001","Body Shop #002","7.631","3.559","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Body Shop #002","Body Shop #003","6.232","4.014","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Shop #003","Body Shop #004","8.798","4.084","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Body Shop #004","Body Shop #005","2.059","5.554","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Shop #005","Body Shop #001","4.528","2.171","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":725},{"label":"Mar","value":380},{"label":"Abr","value":663},{"label":"Mai","value":340},{"label":"Jun","value":602},{"label":"Jul","value":595},{"label":"Ago","value":721},{"label":"Set","value":456},{"label":"Out","value":377},{"label":"Nov","value":531},{"label":"Dez","value":658}];
const MX = 725;
