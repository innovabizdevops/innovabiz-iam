...
const PAGE = "Estimate";
const KPIS = [{"l":"Total Body Shop","v":"4.693","t":"+16.4%","d":"up"},{"l":"Estimate Ativos","v":"7.623","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"85.5%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"90","t":"+9.0%","d":"up"}];
const COLS = ["ID","Estimate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Shop #001","Body Shop #002","2.421","3.649","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Body Shop #002","Body Shop #003","5.950","4.162","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Shop #003","Body Shop #004","686","7.994","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Body Shop #004","Body Shop #005","3.764","4.607","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Shop #005","Body Shop #001","6.446","5.243","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":341},{"label":"Fev","value":384},{"label":"Mar","value":387},{"label":"Abr","value":276},{"label":"Mai","value":438},{"label":"Jun","value":328},{"label":"Jul","value":450},{"label":"Ago","value":434},{"label":"Set","value":499},{"label":"Out","value":545},{"label":"Nov","value":414},{"label":"Dez","value":321}];
const MX = 545;
