...
const PAGE = "Parts";
const KPIS = [{"l":"Total Body Shop","v":"1.326","t":"-5.8%","d":"down"},{"l":"Parts Ativos","v":"2.911","t":"+15.3%","d":"up"},{"l":"Eficiência (%)","v":"88.6%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"88","t":"+14.7%","d":"up"}];
const COLS = ["ID","Parts","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Shop #001","Body Shop #002","7.429","7.431","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Body Shop #002","Body Shop #003","2.741","3.417","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Shop #003","Body Shop #004","7.595","4.780","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Body Shop #004","Body Shop #005","437","5.652","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Shop #005","Body Shop #001","4.077","6.388","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":675},{"label":"Mar","value":638},{"label":"Abr","value":843},{"label":"Mai","value":945},{"label":"Jun","value":833},{"label":"Jul","value":1014},{"label":"Ago","value":664},{"label":"Set","value":660},{"label":"Out","value":666},{"label":"Nov","value":947},{"label":"Dez","value":993}];
const MX = 1014;
