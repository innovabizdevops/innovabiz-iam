...
const PAGE = "Paint";
const KPIS = [{"l":"Total Body Shop","v":"8.610","t":"+6.8%","d":"up"},{"l":"Paint Ativos","v":"3.033","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"94.8%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"56","t":"+1.4%","d":"up"}];
const COLS = ["ID","Paint","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Shop #001","Body Shop #002","1.295","4.055","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Body Shop #002","Body Shop #003","8.697","5.437","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Shop #003","Body Shop #004","9.035","1.260","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Body Shop #004","Body Shop #005","2.410","3.901","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Shop #005","Body Shop #001","5.342","7.939","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":394},{"label":"Fev","value":499},{"label":"Mar","value":501},{"label":"Abr","value":345},{"label":"Mai","value":508},{"label":"Jun","value":649},{"label":"Jul","value":525},{"label":"Ago","value":468},{"label":"Set","value":535},{"label":"Out","value":506},{"label":"Nov","value":655},{"label":"Dez","value":427}];
const MX = 655;
