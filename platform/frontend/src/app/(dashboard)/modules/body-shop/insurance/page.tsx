...
const ACCENT = "#6366f1";
const MODULE = "Body Shop";
const PAGE = "Insurance";
const KPIS = [{"l":"Total Body Shop","v":"5.730","t":"-3.2%","d":"down"},{"l":"Insurance Ativos","v":"6.223","t":"+13.1%","d":"up"},{"l":"Eficiência (%)","v":"79.8%","t":"+10.5%","d":"up"},{"l":"Score Performance","v":"63","t":"+7.4%","d":"up"}];
const COLS = ["ID","Insurance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Shop #001","Body Shop #002","4.361","1.121","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Body Shop #002","Body Shop #003","7.542","5.359","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Shop #003","Body Shop #004","5.896","4.703","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Body Shop #004","Body Shop #005","197","6.862","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Shop #005","Body Shop #001","8.361","7.452","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":314},{"label":"Fev","value":457},{"label":"Mar","value":349},{"label":"Abr","value":411},{"label":"Mai","value":295},{"label":"Jun","value":305},{"label":"Jul","value":426},{"label":"Ago","value":286},{"label":"Set","value":300},{"label":"Out","value":551},{"label":"Nov","value":342},{"label":"Dez","value":655}];
const MX = 655;
