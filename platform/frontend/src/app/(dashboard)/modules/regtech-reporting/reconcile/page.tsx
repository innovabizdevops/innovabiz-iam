...
const ACCENT = "#1e3a5f";
const MODULE = "RegTech Reporting Engine";
const PAGE = "Reconcile";
const KPIS = [{"l":"Total Regtech Reporting","v":"5.796","t":"-5.7%","d":"down"},{"l":"Reconcile Ativos","v":"6.815","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"93.3%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"85","t":"-3.8%","d":"down"}];
const COLS = ["ID","Reconcile","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Regtech Reporting #001","Regtech Reporting #002","7.118","8.389","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Regtech Reporting #002","Regtech Reporting #003","892","7.736","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Regtech Reporting #003","Regtech Reporting #004","4.709","8.015","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Regtech Reporting #004","Regtech Reporting #005","3.628","6.314","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Regtech Reporting #005","Regtech Reporting #001","2.077","410","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":609},{"label":"Mar","value":620},{"label":"Abr","value":426},{"label":"Mai","value":448},{"label":"Jun","value":255},{"label":"Jul","value":538},{"label":"Ago","value":646},{"label":"Set","value":546},{"label":"Out","value":608},{"label":"Nov","value":649},{"label":"Dez","value":512}];
const MX = 649;
