...
/* ═══ RegTech Reporting Engine — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "3258", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1399", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€451K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1911990158", cells: ["REG-4158", "RegTech Reporting Engine Item 1", "23/3/2026", "€40 258"], status: "active" as const },
    { id: "1911993729", cells: ["REG-7729", "RegTech Reporting Engine Item 2", "10/10/2026", "€43 829"], status: "pending" as const },
    { id: "1911997300", cells: ["REG-2300", "RegTech Reporting Engine Item 3", "25/5/2026", "€47 400"], status: "completed" as const },
    { id: "1912000871", cells: ["REG-5871", "RegTech Reporting Engine Item 4", "12/12/2026", "€971"], status: "warning" as const },
    { id: "1912004442", cells: ["REG-9442", "RegTech Reporting Engine Item 5", "27/7/2026", "€4542"], status: "active" as const },
];
...
export default function RegtechReportingEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">RegTech Reporting Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • RegTech Reporting Engine</p>
                    </div>
                </div>
