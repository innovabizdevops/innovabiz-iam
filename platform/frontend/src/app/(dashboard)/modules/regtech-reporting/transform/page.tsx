...
const KPIS = [{"l":"Formulários Ativos","v":"2.496","t":"+2.7%","d":"up"},{"l":"Submissões/Dia","v":"777","t":"+8.7%","d":"up"},{"l":"Documentos Gerados","v":"8.904","t":"-0.8%","d":"down"},{"l":"Templates","v":"3.277","t":"+14.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.514","2026-02-25","7.996","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","728","2026-01-02","4.892","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.564","2026-02-11","4.400","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.218","2026-03-22","4.870","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.502","2026-03-28","5.730","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":570},{"label":"Fev","value":660},{"label":"Mar","value":439},{"label":"Abr","value":542},{"label":"Mai","value":309},{"label":"Jun","value":483},{"label":"Jul","value":331},{"label":"Ago","value":471},{"label":"Set","value":358},{"label":"Out","value":463},{"label":"Nov","value":588},{"label":"Dez","value":507}];
const MX = 660;
