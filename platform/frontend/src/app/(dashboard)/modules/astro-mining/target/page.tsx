...
const ACCENT = "#4338ca";
const MODULE = "Asteroid Mining";
const PAGE = "Target Select";
const KPIS = [{"l":"Total Astro Mining","v":"3.499","t":"+5.0%","d":"up"},{"l":"Target Select Ativos","v":"6.491","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"78.3%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"79","t":"-4.8%","d":"down"}];
const COLS = ["ID","Target Select","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Astro Mining #001","Astro Mining #002","1.724","1.348","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Astro Mining #002","Astro Mining #003","5.534","1.357","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Astro Mining #003","Astro Mining #004","2.405","2.468","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Astro Mining #004","Astro Mining #005","5.401","8.910","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Astro Mining #005","Astro Mining #001","2.142","2.930","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":946},{"label":"Fev","value":947},{"label":"Mar","value":658},{"label":"Abr","value":563},{"label":"Mai","value":825},{"label":"Jun","value":815},{"label":"Jul","value":798},{"label":"Ago","value":832},{"label":"Set","value":855},{"label":"Out","value":842},{"label":"Nov","value":948},{"label":"Dez","value":624}];
const MX = 948;
