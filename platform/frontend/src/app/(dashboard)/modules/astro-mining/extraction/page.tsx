...
const KPIS = [{"l":"Total Astro Mining","v":"380","t":"+5.9%","d":"up"},{"l":"Extraction Ativos","v":"1.664","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"91.2%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"81","t":"+16.1%","d":"up"}];
const COLS = ["ID","Extraction","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Astro Mining #001","Astro Mining #002","2.452","8.093","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Astro Mining #002","Astro Mining #003","8.909","5.536","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Astro Mining #003","Astro Mining #004","6.355","7.545","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Astro Mining #004","Astro Mining #005","7.985","7.232","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Astro Mining #005","Astro Mining #001","8.132","7.277","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1017},{"label":"Fev","value":1019},{"label":"Mar","value":793},{"label":"Abr","value":647},{"label":"Mai","value":936},{"label":"Jun","value":868},{"label":"Jul","value":957},{"label":"Ago","value":641},{"label":"Set","value":885},{"label":"Out","value":661},{"label":"Nov","value":931},{"label":"Dez","value":850}];
const MX = 1019;
