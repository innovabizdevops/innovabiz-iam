...
export default function AstroMiningPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Astro Mining</h1><p className="text-sm text-muted-foreground">Astro Mining • iBOS Enterprise</p></div>
