...
const PAGE = "Rendezvous";
const KPIS = [{"l":"Total Astro Mining","v":"4.463","t":"+7.7%","d":"up"},{"l":"Rendezvous Ativos","v":"8.902","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"70.0%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"57","t":"-5.8%","d":"down"}];
const COLS = ["ID","Rendezvous","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Astro Mining #001","Astro Mining #002","5.934","5.402","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Astro Mining #002","Astro Mining #003","8.161","5.408","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Astro Mining #003","Astro Mining #004","3.881","5.808","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Astro Mining #004","Astro Mining #005","8.941","414","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Astro Mining #005","Astro Mining #001","7.432","4.038","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":713},{"label":"Fev","value":653},{"label":"Mar","value":673},{"label":"Abr","value":566},{"label":"Mai","value":353},{"label":"Jun","value":690},{"label":"Jul","value":615},{"label":"Ago","value":622},{"label":"Set","value":403},{"label":"Out","value":450},{"label":"Nov","value":630},{"label":"Dez","value":476}];
const MX = 713;
