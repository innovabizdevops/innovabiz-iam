...
const PAGE = "Return";
const KPIS = [{"l":"Total Astro Mining","v":"8.648","t":"-3.5%","d":"down"},{"l":"Return Ativos","v":"4.120","t":"+4.0%","d":"up"},{"l":"Eficiência (%)","v":"89.6%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"74","t":"+0.0%","d":"up"}];
const COLS = ["ID","Return","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Astro Mining #001","Astro Mining #002","8.806","2.522","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Astro Mining #002","Astro Mining #003","7.640","4.400","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Astro Mining #003","Astro Mining #004","5.748","3.756","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Astro Mining #004","Astro Mining #005","3.026","3.073","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Astro Mining #005","Astro Mining #001","3.948","5.675","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":365},{"label":"Mar","value":556},{"label":"Abr","value":331},{"label":"Mai","value":657},{"label":"Jun","value":580},{"label":"Jul","value":688},{"label":"Ago","value":639},{"label":"Set","value":310},{"label":"Out","value":391},{"label":"Nov","value":639},{"label":"Dez","value":534}];
const MX = 688;
