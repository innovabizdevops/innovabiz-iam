...
const KPIS = [{"l":"Total Astro Mining","v":"1.961","t":"+11.7%","d":"up"},{"l":"Processing Ativos","v":"7.914","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"82.2%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"94","t":"+3.1%","d":"up"}];
const COLS = ["ID","Processing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Astro Mining #001","Astro Mining #002","1.246","8.928","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Astro Mining #002","Astro Mining #003","5.946","220","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Astro Mining #003","Astro Mining #004","2.586","1.739","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Astro Mining #004","Astro Mining #005","4.189","5.232","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Astro Mining #005","Astro Mining #001","5.793","8.064","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":354},{"label":"Fev","value":675},{"label":"Mar","value":489},{"label":"Abr","value":661},{"label":"Mai","value":474},{"label":"Jun","value":422},{"label":"Jul","value":478},{"label":"Ago","value":344},{"label":"Set","value":575},{"label":"Out","value":368},{"label":"Nov","value":363},{"label":"Dez","value":703}];
const MX = 703;
