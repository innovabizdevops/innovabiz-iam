...
const PAGE = "Binding";
const KPIS = [{"l":"Total Print Production","v":"8.777","t":"-4.8%","d":"down"},{"l":"Binding Ativos","v":"781","t":"+6.4%","d":"up"},{"l":"Eficiência (%)","v":"79.4%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"57","t":"+0.1%","d":"up"}];
const COLS = ["ID","Binding","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Production #001","Print Production #002","3.563","1.871","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Print Production #002","Print Production #003","2.375","8.849","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Production #003","Print Production #004","7.560","1.703","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Print Production #004","Print Production #005","131","2.629","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Production #005","Print Production #001","6.999","3.473","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":309},{"label":"Mar","value":426},{"label":"Abr","value":570},{"label":"Mai","value":611},{"label":"Jun","value":544},{"label":"Jul","value":577},{"label":"Ago","value":408},{"label":"Set","value":594},{"label":"Out","value":535},{"label":"Nov","value":513},{"label":"Dez","value":457}];
const MX = 611;
