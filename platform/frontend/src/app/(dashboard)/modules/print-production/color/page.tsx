...
const PAGE = "Color";
const KPIS = [{"l":"Total Print Production","v":"5.570","t":"+0.0%","d":"up"},{"l":"Color Ativos","v":"1.532","t":"+14.3%","d":"up"},{"l":"Eficiência (%)","v":"85.1%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"57","t":"+2.8%","d":"up"}];
const COLS = ["ID","Color","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Production #001","Print Production #002","6.667","8.338","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Print Production #002","Print Production #003","1.437","3.392","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Production #003","Print Production #004","2.547","1.053","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Print Production #004","Print Production #005","9.070","3.988","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Production #005","Print Production #001","8.010","1.089","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":935},{"label":"Fev","value":916},{"label":"Mar","value":1004},{"label":"Abr","value":664},{"label":"Mai","value":925},{"label":"Jun","value":969},{"label":"Jul","value":817},{"label":"Ago","value":731},{"label":"Set","value":647},{"label":"Out","value":753},{"label":"Nov","value":814},{"label":"Dez","value":785}];
const MX = 1004;
