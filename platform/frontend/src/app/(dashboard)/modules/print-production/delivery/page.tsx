...
const ACCENT = "#6366f1";
const MODULE = "Print Production";
const PAGE = "Delivery";
const KPIS = [{"l":"Total Print Production","v":"7.052","t":"+10.4%","d":"up"},{"l":"Delivery Ativos","v":"8.964","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"67.4%","t":"+1.4%","d":"up"},{"l":"Score Performance","v":"57","t":"+1.2%","d":"up"}];
const COLS = ["ID","Delivery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Production #001","Print Production #002","6.282","4.788","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Print Production #002","Print Production #003","5.801","1.172","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Production #003","Print Production #004","8.636","7.008","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Print Production #004","Print Production #005","4.107","8.542","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Production #005","Print Production #001","2.352","6.512","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":955},{"label":"Mar","value":971},{"label":"Abr","value":823},{"label":"Mai","value":1011},{"label":"Jun","value":1037},{"label":"Jul","value":760},{"label":"Ago","value":811},{"label":"Set","value":818},{"label":"Out","value":846},{"label":"Nov","value":889},{"label":"Dez","value":667}];
const MX = 1037;
