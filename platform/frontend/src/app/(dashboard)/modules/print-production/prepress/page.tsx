...
const PAGE = "Prepress";
const KPIS = [{"l":"Total Print Production","v":"7.487","t":"-2.3%","d":"down"},{"l":"Prepress Ativos","v":"1.878","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"85.7%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"86","t":"+8.7%","d":"up"}];
const COLS = ["ID","Prepress","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Production #001","Print Production #002","3.764","4.295","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Print Production #002","Print Production #003","8.915","5.998","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Production #003","Print Production #004","2.972","181","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Print Production #004","Print Production #005","1.036","1.984","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Production #005","Print Production #001","4.218","5.446","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":877},{"label":"Mar","value":787},{"label":"Abr","value":931},{"label":"Mai","value":684},{"label":"Jun","value":680},{"label":"Jul","value":624},{"label":"Ago","value":702},{"label":"Set","value":690},{"label":"Out","value":711},{"label":"Nov","value":922},{"label":"Dez","value":860}];
const MX = 931;
