...
const ACCENT = "#059669";
const MODULE = "Digital Archive";
const PAGE = "Ingest Pipeline";
const KPIS = [{"l":"Total Digital Archive","v":"787","t":"+-0.0%","d":"up"},{"l":"Ingest Pipeline Ativos","v":"3.381","t":"+13.5%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"55","t":"+17.4%","d":"up"}];
const COLS = ["ID","Ingest Pipeline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Digital Archive #001","Digital Archive #002","2.498","497","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Digital Archive #002","Digital Archive #003","141","6.167","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Archive #003","Digital Archive #004","4.976","4.985","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Digital Archive #004","Digital Archive #005","3.416","8.163","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Archive #005","Digital Archive #001","6.311","1.098","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":663},{"label":"Mar","value":793},{"label":"Abr","value":658},{"label":"Mai","value":762},{"label":"Jun","value":771},{"label":"Jul","value":595},{"label":"Ago","value":668},{"label":"Set","value":643},{"label":"Out","value":795},{"label":"Nov","value":881},{"label":"Dez","value":623}];
const MX = 881;
