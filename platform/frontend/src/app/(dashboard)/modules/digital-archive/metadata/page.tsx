...
const PAGE = "Metadata";
const KPIS = [{"l":"Configurações","v":"4.828","t":"+0.7%","d":"up"},{"l":"Últimas Alterações","v":"5.748","t":"-1.8%","d":"down"},{"l":"Ambientes","v":"5.133","t":"+15.5%","d":"up"},{"l":"Versão Config","v":"1.142","t":"-5.9%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 47755.01","4.075","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 31885.94","4.072","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 37130.65","4.856","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 8804.62","3.100","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 13871.31","7.429","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":435},{"label":"Mar","value":571},{"label":"Abr","value":544},{"label":"Mai","value":658},{"label":"Jun","value":393},{"label":"Jul","value":455},{"label":"Ago","value":515},{"label":"Set","value":434},{"label":"Out","value":626},{"label":"Nov","value":331},{"label":"Dez","value":466}];
const MX = 685;
