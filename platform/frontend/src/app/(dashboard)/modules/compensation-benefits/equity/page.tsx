...
const ACCENT = "#6d28d9";
const MODULE = "Compensation & Benefits (APQC 6.5)";
const PAGE = "Equity";
const KPIS = [{"l":"Total Compensation Benefits","v":"9.083","t":"+4.0%","d":"up"},{"l":"Equity Ativos","v":"5.351","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"79.1%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"67","t":"+7.0%","d":"up"}];
const COLS = ["ID","Equity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Compensation Benefits #001","Compensation Benefits #002","4.185","1.292","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Compensation Benefits #002","Compensation Benefits #003","2.905","7.511","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Compensation Benefits #003","Compensation Benefits #004","8.896","5.838","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Compensation Benefits #004","Compensation Benefits #005","4.363","3.720","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Compensation Benefits #005","Compensation Benefits #001","7.809","3.551","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":764},{"label":"Mar","value":489},{"label":"Abr","value":708},{"label":"Mai","value":779},{"label":"Jun","value":770},{"label":"Jul","value":572},{"label":"Ago","value":616},{"label":"Set","value":472},{"label":"Out","value":577},{"label":"Nov","value":507},{"label":"Dez","value":631}];
const MX = 779;
