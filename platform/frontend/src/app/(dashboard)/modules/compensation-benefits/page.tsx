...
/* ═══ Compensation & Benefits (APQC 6.5) — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "758", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "456", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€249K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1484634358", cells: ["COM-4358", "Compensation & Benefits (APQC 6.5) Item 1", "19/11/2026", "€34 458"], status: "active" as const },
    { id: "1484637929", cells: ["COM-7929", "Compensation & Benefits (APQC 6.5) Item 2", "6/6/2026", "€38 029"], status: "pending" as const },
    { id: "1484641500", cells: ["COM-2500", "Compensation & Benefits (APQC 6.5) Item 3", "21/1/2026", "€41 600"], status: "completed" as const },
    { id: "1484645071", cells: ["COM-6071", "Compensation & Benefits (APQC 6.5) Item 4", "8/8/2026", "€45 171"], status: "warning" as const },
    { id: "1484648642", cells: ["COM-9642", "Compensation & Benefits (APQC 6.5) Item 5", "23/3/2026", "€48 742"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 58 }, { label: "Fev", value: 67 }, { label: "Mar", value: 76 }, { label: "Abr", value: 85 }, { label: "Mai", value: 94 }, { label: "Jun", value: 23 }];
...
export default function CompensationBenefitsApqc65Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Compensation & Benefits (APQC 6.5)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Compensation & Benefits (APQC 6.5)</p>
                    </div>
                </div>
