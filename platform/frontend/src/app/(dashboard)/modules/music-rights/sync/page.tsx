...
const PAGE = "Sync";
const KPIS = [{"l":"Integrações Ativas","v":"2.151","t":"-2.4%","d":"down"},{"l":"Chamadas/Hora","v":"3153","t":"+16.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.0%","t":"-0.4%","d":"down"},{"l":"Latência Média (ms)","v":"5ms","t":"+12.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.375","6.878","83.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.149","7.431","72.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.959","8.086","77.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.476","4.510","84.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.881","2.324","84.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":440},{"label":"Mar","value":620},{"label":"Abr","value":552},{"label":"Mai","value":580},{"label":"Jun","value":720},{"label":"Jul","value":514},{"label":"Ago","value":475},{"label":"Set","value":507},{"label":"Out","value":675},{"label":"Nov","value":552},{"label":"Dez","value":345}];
const MX = 720;
