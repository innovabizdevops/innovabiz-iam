...
const ACCENT = "#7c2d12";
const MODULE = "Music Rights Mgmt";
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"2.898","t":"+12.3%","d":"up"},{"l":"Queries/Dia","v":"2638","t":"+8.5%","d":"up"},{"l":"Dados Processados (GB)","v":"6.726","t":"+8.1%","d":"up"},{"l":"Utilizadores Analytics","v":"7.841","t":"+7.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1358","2026-03-15","8.495","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2846","2026-01-28","2.024","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","5000","2026-01-18","7.415","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2248","2026-02-11","155","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2902","2026-03-27","1.323","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":403},{"label":"Fev","value":502},{"label":"Mar","value":714},{"label":"Abr","value":615},{"label":"Mai","value":710},{"label":"Jun","value":766},{"label":"Jul","value":545},{"label":"Ago","value":705},{"label":"Set","value":635},{"label":"Out","value":734},{"label":"Nov","value":531},{"label":"Dez","value":585}];
const MX = 766;
