...
const PAGE = "Risk Plan";
const KPIS = [{"l":"Riscos Identificados","v":"9.051","t":"+14.8%","d":"up"},{"l":"Mitigações Ativas","v":"3.416","t":"-5.6%","d":"down"},{"l":"Score Risco Geral","v":"66","t":"+12.3%","d":"up"},{"l":"Incidentes YTD","v":"1.062","t":"-2.5%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.602","8.925","7.976","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.279","7.392","1.162","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.527","7.920","7.329","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.515","3.944","7.018","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.266","6.595","2.525","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":397},{"label":"Mar","value":638},{"label":"Abr","value":671},{"label":"Mai","value":362},{"label":"Jun","value":375},{"label":"Jul","value":687},{"label":"Ago","value":493},{"label":"Set","value":531},{"label":"Out","value":321},{"label":"Nov","value":709},{"label":"Dez","value":551}];
const MX = 709;
