...
const PAGE = "Social Media Monitor";
const KPIS = [{"l":"Integrações Ativas","v":"2.224","t":"-3.8%","d":"down"},{"l":"Chamadas/Hora","v":"3188","t":"+7.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"87.9%","t":"-4.4%","d":"down"},{"l":"Latência Média (ms)","v":"36ms","t":"+8.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.131","1.746","88.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.368","5.653","89.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.811","6.204","83.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","385","5.016","82.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.073","5.473","73.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":464},{"label":"Mar","value":641},{"label":"Abr","value":800},{"label":"Mai","value":497},{"label":"Jun","value":778},{"label":"Jul","value":738},{"label":"Ago","value":794},{"label":"Set","value":487},{"label":"Out","value":802},{"label":"Nov","value":770},{"label":"Dez","value":806}];
const MX = 806;
