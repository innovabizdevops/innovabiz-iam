...
const PAGE = "PSUR Report";
const KPIS = [{"l":"Total Pharmacovigilance","v":"594","t":"+16.5%","d":"up"},{"l":"PSUR Report Ativos","v":"1.277","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"84.1%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"78","t":"+15.5%","d":"up"}];
const COLS = ["ID","PSUR Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharmacovigilance #001","Pharmacovigilance #002","5.980","5.117","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Pharmacovigilance #002","Pharmacovigilance #003","4.061","337","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharmacovigilance #003","Pharmacovigilance #004","3.513","6.051","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Pharmacovigilance #004","Pharmacovigilance #005","7.975","8.485","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharmacovigilance #005","Pharmacovigilance #001","2.813","6.281","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":395},{"label":"Fev","value":541},{"label":"Mar","value":689},{"label":"Abr","value":330},{"label":"Mai","value":512},{"label":"Jun","value":440},{"label":"Jul","value":641},{"label":"Ago","value":418},{"label":"Set","value":326},{"label":"Out","value":589},{"label":"Nov","value":624},{"label":"Dez","value":691}];
const MX = 691;
...
export default function PsurPage() {
    return (
