...
const ACCENT = "#7c3aed";
const MODULE = "AI Agent Monitor & Control";
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"8.540","t":"+4.7%","d":"up"},{"l":"Taxa Entrega (%)","v":"85.4%","t":"-2.9%","d":"down"},{"l":"Taxa Abertura (%)","v":"75.1%","t":"+0.2%","d":"up"},{"l":"Escalações","v":"3.257","t":"+6.0%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","1.168","98.8%","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","176","79.2%","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","6.574","80.5%","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","1.845","70.6%","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","6.494","89.3%","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":643},{"label":"Mar","value":433},{"label":"Abr","value":432},{"label":"Mai","value":673},{"label":"Jun","value":490},{"label":"Jul","value":450},{"label":"Ago","value":382},{"label":"Set","value":543},{"label":"Out","value":510},{"label":"Nov","value":745},{"label":"Dez","value":409}];
const MX = 745;
