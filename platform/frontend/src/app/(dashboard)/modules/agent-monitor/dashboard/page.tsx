...
const KPIS = [{"l":"Teams Ativos","v":"3.031","t":"+8.6%","d":"up"},{"l":"Reuniões/Semana","v":"3853","t":"-1.2%","d":"down"},{"l":"Mensagens/Dia","v":"1369","t":"+2.8%","d":"up"},{"l":"Ficheiros Partilhados","v":"835","t":"-5.6%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.534","3896","5.496","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","3.958","3246","821","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","1.856","1658","7.413","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","990","3585","4.238","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","5.763","1519","6.009","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":613},{"label":"Mar","value":630},{"label":"Abr","value":549},{"label":"Mai","value":318},{"label":"Jun","value":315},{"label":"Jul","value":309},{"label":"Ago","value":576},{"label":"Set","value":415},{"label":"Out","value":668},{"label":"Nov","value":526},{"label":"Dez","value":378}];
const MX = 688;
