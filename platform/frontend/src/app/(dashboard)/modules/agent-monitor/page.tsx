...
/* ═══ AI Agent Monitor & Control — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "915", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "769", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€387K", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1018532615", cells: ["AGE-3615", "AI Agent Monitor & Control Item 1", "24/12/2026", "€32 715"], status: "active" as const },
    { id: "1018536186", cells: ["AGE-7186", "AI Agent Monitor & Control Item 2", "11/7/2026", "€36 286"], status: "pending" as const },
    { id: "1018539757", cells: ["AGE-1757", "AI Agent Monitor & Control Item 3", "26/2/2026", "€39 857"], status: "completed" as const },
    { id: "1018543328", cells: ["AGE-5328", "AI Agent Monitor & Control Item 4", "13/9/2026", "€43 428"], status: "warning" as const },
    { id: "1018546899", cells: ["AGE-8899", "AI Agent Monitor & Control Item 5", "28/4/2026", "€46 999"], status: "active" as const },
];
...
export default function AiAgentMonitorControlPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Agent Monitor & Control</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Agent Monitor & Control</p>
                    </div>
                </div>
