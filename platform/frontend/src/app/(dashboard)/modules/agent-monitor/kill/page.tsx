...
const PAGE = "Kill";
const KPIS = [{"l":"Total Agent Monitor","v":"1.099","t":"-2.8%","d":"down"},{"l":"Kill Ativos","v":"7.878","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"90.4%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"79","t":"+12.1%","d":"up"}];
const COLS = ["ID","Kill","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agent Monitor #001","Agent Monitor #002","5.851","7.905","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Agent Monitor #002","Agent Monitor #003","5.772","7.348","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Agent Monitor #003","Agent Monitor #004","3.020","699","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Agent Monitor #004","Agent Monitor #005","6.418","5.213","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agent Monitor #005","Agent Monitor #001","2.797","4.154","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":608},{"label":"Mar","value":813},{"label":"Abr","value":613},{"label":"Mai","value":740},{"label":"Jun","value":523},{"label":"Jul","value":791},{"label":"Ago","value":617},{"label":"Set","value":568},{"label":"Out","value":554},{"label":"Nov","value":858},{"label":"Dez","value":779}];
const MX = 858;
