...
const PAGE = "Cost";
const KPIS = [{"l":"Total Agent Monitor","v":"7.798","t":"+14.2%","d":"up"},{"l":"Cost Ativos","v":"5.736","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"91.3%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"58","t":"+14.9%","d":"up"}];
const COLS = ["ID","Cost","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agent Monitor #001","Agent Monitor #002","8.895","3.926","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Agent Monitor #002","Agent Monitor #003","6.980","7.196","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Agent Monitor #003","Agent Monitor #004","8.662","6.312","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Agent Monitor #004","Agent Monitor #005","8.261","1.391","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agent Monitor #005","Agent Monitor #001","6.216","3.012","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":646},{"label":"Mar","value":435},{"label":"Abr","value":382},{"label":"Mai","value":733},{"label":"Jun","value":516},{"label":"Jul","value":419},{"label":"Ago","value":610},{"label":"Set","value":644},{"label":"Out","value":412},{"label":"Nov","value":455},{"label":"Dez","value":769}];
const MX = 769;
