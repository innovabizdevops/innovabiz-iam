...
const PAGE = "Log";
const KPIS = [{"l":"Total Agent Monitor","v":"7.708","t":"+13.2%","d":"up"},{"l":"Log Ativos","v":"8.272","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"84.3%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"58","t":"+11.5%","d":"up"}];
const COLS = ["ID","Log","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agent Monitor #001","Agent Monitor #002","4.783","5.298","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Agent Monitor #002","Agent Monitor #003","6.864","5.668","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Agent Monitor #003","Agent Monitor #004","3.907","121","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Agent Monitor #004","Agent Monitor #005","8.156","7.243","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agent Monitor #005","Agent Monitor #001","1.225","5.244","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":562},{"label":"Mar","value":581},{"label":"Abr","value":452},{"label":"Mai","value":557},{"label":"Jun","value":572},{"label":"Jul","value":441},{"label":"Ago","value":289},{"label":"Set","value":441},{"label":"Out","value":480},{"label":"Nov","value":514},{"label":"Dez","value":637}];
const MX = 637;
