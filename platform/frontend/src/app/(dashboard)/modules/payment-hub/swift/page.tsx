...
const ACCENT = "#3c5a7f";
const MODULE = "Payment Hub";
const PAGE = "SWIFT/SEPA";
const KPIS = [{"l":"Total Payment Hub","v":"1.870","t":"-0.4%","d":"down"},{"l":"SWIFT/SEPA Ativos","v":"4.613","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"85.2%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"85","t":"+9.4%","d":"up"}];
const COLS = ["ID","SWIFT/SEPA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payment Hub #001","Payment Hub #002","7.231","2.897","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Payment Hub #002","Payment Hub #003","8.456","7.009","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Payment Hub #003","Payment Hub #004","4.683","3.957","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Payment Hub #004","Payment Hub #005","4.115","6.613","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payment Hub #005","Payment Hub #001","1.868","3.252","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":748},{"label":"Mar","value":628},{"label":"Abr","value":836},{"label":"Mai","value":603},{"label":"Jun","value":748},{"label":"Jul","value":599},{"label":"Ago","value":837},{"label":"Set","value":750},{"label":"Out","value":843},{"label":"Nov","value":917},{"label":"Dez","value":739}];
const MX = 917;
