...
const PAGE = "ACH/Wire";
const KPIS = [{"l":"Total Payment Hub","v":"5.086","t":"+13.0%","d":"up"},{"l":"ACH/Wire Ativos","v":"2.245","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"88.8%","t":"-2.3%","d":"down"},{"l":"Score Performance","v":"75","t":"+10.2%","d":"up"}];
const COLS = ["ID","ACH/Wire","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payment Hub #001","Payment Hub #002","1.352","8.298","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Payment Hub #002","Payment Hub #003","2.797","2.898","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Payment Hub #003","Payment Hub #004","7.534","5.626","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Payment Hub #004","Payment Hub #005","8.566","2.629","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payment Hub #005","Payment Hub #001","6.251","4.387","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":873},{"label":"Fev","value":887},{"label":"Mar","value":942},{"label":"Abr","value":859},{"label":"Mai","value":907},{"label":"Jun","value":845},{"label":"Jul","value":1048},{"label":"Ago","value":770},{"label":"Set","value":790},{"label":"Out","value":1029},{"label":"Nov","value":888},{"label":"Dez","value":943}];
const MX = 1048;
