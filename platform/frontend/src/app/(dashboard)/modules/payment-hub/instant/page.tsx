...
const PAGE = "Instant Pay";
const KPIS = [{"l":"Total Payment Hub","v":"7.130","t":"-3.5%","d":"down"},{"l":"Instant Pay Ativos","v":"3.458","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"69.1%","t":"+17.5%","d":"up"},{"l":"Score Performance","v":"83","t":"+9.4%","d":"up"}];
const COLS = ["ID","Instant Pay","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payment Hub #001","Payment Hub #002","6.468","5.800","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Payment Hub #002","Payment Hub #003","648","6.460","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Payment Hub #003","Payment Hub #004","2.200","7.412","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Payment Hub #004","Payment Hub #005","4.598","4.234","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payment Hub #005","Payment Hub #001","2.981","6.305","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":872},{"label":"Fev","value":714},{"label":"Mar","value":859},{"label":"Abr","value":862},{"label":"Mai","value":526},{"label":"Jun","value":814},{"label":"Jul","value":657},{"label":"Ago","value":507},{"label":"Set","value":625},{"label":"Out","value":579},{"label":"Nov","value":599},{"label":"Dez","value":889}];
const MX = 889;
