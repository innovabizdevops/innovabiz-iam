...
const PAGE = "Branch";
const KPIS = [{"l":"Total Genai Workflow","v":"3.981","t":"+17.1%","d":"up"},{"l":"Branch Ativos","v":"2.434","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"81.8%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"61","t":"-4.9%","d":"down"}];
const COLS = ["ID","Branch","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Workflow #001","Genai Workflow #002","7.707","128","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Workflow #002","Genai Workflow #003","1.215","5.948","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Workflow #003","Genai Workflow #004","1.292","4.396","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Workflow #004","Genai Workflow #005","289","5.200","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Workflow #005","Genai Workflow #001","1.284","6.663","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":457},{"label":"Mar","value":721},{"label":"Abr","value":429},{"label":"Mai","value":665},{"label":"Jun","value":520},{"label":"Jul","value":425},{"label":"Ago","value":463},{"label":"Set","value":690},{"label":"Out","value":514},{"label":"Nov","value":685},{"label":"Dez","value":531}];
const MX = 721;
