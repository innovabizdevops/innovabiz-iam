...
const PAGE = "Loop";
const KPIS = [{"l":"Total Genai Workflow","v":"2.013","t":"+5.5%","d":"up"},{"l":"Loop Ativos","v":"7.229","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"92.9%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"80","t":"+4.6%","d":"up"}];
const COLS = ["ID","Loop","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Workflow #001","Genai Workflow #002","1.758","981","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Workflow #002","Genai Workflow #003","5.542","7.316","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Workflow #003","Genai Workflow #004","7.727","711","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Workflow #004","Genai Workflow #005","726","1.536","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Workflow #005","Genai Workflow #001","8.554","4.336","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":302},{"label":"Mar","value":435},{"label":"Abr","value":442},{"label":"Mai","value":287},{"label":"Jun","value":448},{"label":"Jul","value":412},{"label":"Ago","value":326},{"label":"Set","value":427},{"label":"Out","value":571},{"label":"Nov","value":312},{"label":"Dez","value":523}];
const MX = 571;
