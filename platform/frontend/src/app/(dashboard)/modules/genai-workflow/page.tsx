...
/* ═══ GenAI Workflow Composer — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "2855", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "962", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€481K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "351512155", cells: ["GEN-9155", "GenAI Workflow Composer Item 1", "16/8/2026", "€12 255"], status: "active" as const },
    { id: "351515726", cells: ["GEN-3726", "GenAI Workflow Composer Item 2", "3/3/2026", "€15 826"], status: "pending" as const },
    { id: "351519297", cells: ["GEN-7297", "GenAI Workflow Composer Item 3", "18/10/2026", "€19 397"], status: "completed" as const },
    { id: "351522868", cells: ["GEN-1868", "GenAI Workflow Composer Item 4", "5/5/2026", "€22 968"], status: "warning" as const },
    { id: "351526439", cells: ["GEN-5439", "GenAI Workflow Composer Item 5", "20/12/2026", "€26 539"], status: "active" as const },
];
...
export default function GenaiWorkflowComposerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Workflow Composer</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Workflow Composer</p>
                    </div>
                </div>
