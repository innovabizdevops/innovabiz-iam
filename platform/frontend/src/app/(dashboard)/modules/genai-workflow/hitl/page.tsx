...
const ACCENT = "#6d28d9";
const MODULE = "GenAI Workflow Composer";
const PAGE = "Human-in-Loop";
const KPIS = [{"l":"Total Genai Workflow","v":"1.398","t":"+12.0%","d":"up"},{"l":"Human In Loop Ativos","v":"2.994","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"89.5%","t":"+17.5%","d":"up"},{"l":"Score Performance","v":"68","t":"-5.0%","d":"down"}];
const COLS = ["ID","Human In Loop","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Workflow #001","Genai Workflow #002","6.813","6.642","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Workflow #002","Genai Workflow #003","3.112","7.242","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Workflow #003","Genai Workflow #004","4.898","6.064","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Workflow #004","Genai Workflow #005","7.019","7.664","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Workflow #005","Genai Workflow #001","7.087","5.826","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":409},{"label":"Mar","value":722},{"label":"Abr","value":688},{"label":"Mai","value":552},{"label":"Jun","value":768},{"label":"Jul","value":691},{"label":"Ago","value":713},{"label":"Set","value":549},{"label":"Out","value":453},{"label":"Nov","value":707},{"label":"Dez","value":513}];
const MX = 768;
