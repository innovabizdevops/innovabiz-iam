...
const PAGE = "Chain";
const KPIS = [{"l":"Total Genai Workflow","v":"6.883","t":"+14.1%","d":"up"},{"l":"Chain Ativos","v":"3.330","t":"-5.9%","d":"down"},{"l":"Eficiência (%)","v":"77.2%","t":"+9.7%","d":"up"},{"l":"Score Performance","v":"59","t":"+7.4%","d":"up"}];
const COLS = ["ID","Chain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Workflow #001","Genai Workflow #002","715","2.464","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Workflow #002","Genai Workflow #003","4.304","494","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Workflow #003","Genai Workflow #004","287","3.790","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Workflow #004","Genai Workflow #005","2.406","3.257","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Workflow #005","Genai Workflow #001","8.537","3.302","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":561},{"label":"Mar","value":735},{"label":"Abr","value":627},{"label":"Mai","value":730},{"label":"Jun","value":565},{"label":"Jul","value":427},{"label":"Ago","value":440},{"label":"Set","value":693},{"label":"Out","value":520},{"label":"Nov","value":521},{"label":"Dez","value":754}];
const MX = 754;
