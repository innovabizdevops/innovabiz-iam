...
const PAGE = "Pipeline";
const KPIS = [{"l":"Total Hydrogen Prod","v":"3.820","t":"-2.2%","d":"down"},{"l":"Pipeline Ativos","v":"7.874","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"70.9%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"83","t":"+3.2%","d":"up"}];
const COLS = ["ID","Pipeline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hydrogen Prod #001","Hydrogen Prod #002","6.038","1.395","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Hydrogen Prod #002","Hydrogen Prod #003","8.892","946","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Hydrogen Prod #003","Hydrogen Prod #004","2.045","3.625","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Hydrogen Prod #004","Hydrogen Prod #005","5.035","6.735","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hydrogen Prod #005","Hydrogen Prod #001","1.106","5.782","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":605},{"label":"Mar","value":626},{"label":"Abr","value":517},{"label":"Mai","value":257},{"label":"Jun","value":505},{"label":"Jul","value":311},{"label":"Ago","value":453},{"label":"Set","value":630},{"label":"Out","value":567},{"label":"Nov","value":524},{"label":"Dez","value":481}];
const MX = 630;
