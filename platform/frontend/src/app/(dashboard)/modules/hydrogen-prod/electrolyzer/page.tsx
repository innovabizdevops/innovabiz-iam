...
const ACCENT = "#6366f1";
const MODULE = "Hydrogen Production";
const PAGE = "Electrolyzer";
const KPIS = [{"l":"Total Hydrogen Prod","v":"2.505","t":"-4.2%","d":"down"},{"l":"Electrolyzer Ativos","v":"3.193","t":"+15.0%","d":"up"},{"l":"Eficiência (%)","v":"85.2%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"56","t":"+9.3%","d":"up"}];
const COLS = ["ID","Electrolyzer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hydrogen Prod #001","Hydrogen Prod #002","7.258","3.571","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Hydrogen Prod #002","Hydrogen Prod #003","6.137","2.983","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Hydrogen Prod #003","Hydrogen Prod #004","2.311","4.098","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Hydrogen Prod #004","Hydrogen Prod #005","2.983","7.544","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hydrogen Prod #005","Hydrogen Prod #001","1.505","1.526","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1034},{"label":"Fev","value":1007},{"label":"Mar","value":901},{"label":"Abr","value":680},{"label":"Mai","value":954},{"label":"Jun","value":744},{"label":"Jul","value":1053},{"label":"Ago","value":847},{"label":"Set","value":833},{"label":"Out","value":862},{"label":"Nov","value":975},{"label":"Dez","value":871}];
const MX = 1053;
...
export default function ElectrolyzerPage() {
    return (
