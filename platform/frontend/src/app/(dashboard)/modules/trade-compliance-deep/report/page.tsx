...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.601","t":"-4.5%","d":"down"},{"l":"NC Abertas","v":"6.893","t":"+8.6%","d":"up"},{"l":"Conformidade (%)","v":"72.3%","t":"+17.0%","d":"up"},{"l":"CAPAs Pendentes","v":"4.545","t":"+11.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.370","97.0%","6.684","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.279","89.2%","3.606","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.032","73.9%","6.004","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","783","82.9%","2.234","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","495","85.6%","4.733","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":670},{"label":"Mar","value":759},{"label":"Abr","value":929},{"label":"Mai","value":851},{"label":"Jun","value":949},{"label":"Jul","value":645},{"label":"Ago","value":939},{"label":"Set","value":839},{"label":"Out","value":1026},{"label":"Nov","value":1005},{"label":"Dez","value":701}];
const MX = 1026;
