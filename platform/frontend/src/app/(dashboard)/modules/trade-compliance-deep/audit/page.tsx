...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.971","t":"-3.2%","d":"down"},{"l":"NC Abertas","v":"7.063","t":"+16.0%","d":"up"},{"l":"Conformidade (%)","v":"73.5%","t":"-5.7%","d":"down"},{"l":"CAPAs Pendentes","v":"1.175","t":"+10.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.010","95.4%","921","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.050","84.7%","5.665","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","187","98.4%","1.784","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.473","72.4%","7.138","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.685","75.9%","9.001","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":436},{"label":"Mar","value":337},{"label":"Abr","value":531},{"label":"Mai","value":525},{"label":"Jun","value":451},{"label":"Jul","value":437},{"label":"Ago","value":566},{"label":"Set","value":256},{"label":"Out","value":412},{"label":"Nov","value":431},{"label":"Dez","value":623}];
const MX = 623;
