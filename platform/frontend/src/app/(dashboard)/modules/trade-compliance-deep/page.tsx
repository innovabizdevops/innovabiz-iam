...
/* ═══ Trade Compliance Deep — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "7144", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3596", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€403K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "-2%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1580601444", cells: ["TRA-4444", "Trade Compliance Deep Item 1", "17/1/2026", "€1544"], status: "active" as const },
    { id: "1580605015", cells: ["TRA-8015", "Trade Compliance Deep Item 2", "4/8/2026", "€5115"], status: "pending" as const },
    { id: "1580608586", cells: ["TRA-2586", "Trade Compliance Deep Item 3", "19/3/2026", "€8686"], status: "completed" as const },
    { id: "1580612157", cells: ["TRA-6157", "Trade Compliance Deep Item 4", "6/10/2026", "€12 257"], status: "warning" as const },
    { id: "1580615728", cells: ["TRA-9728", "Trade Compliance Deep Item 5", "21/5/2026", "€15 828"], status: "active" as const },
];
...
export default function TradeComplianceDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Trade Compliance Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Trade Compliance Deep</p>
                    </div>
                </div>
