...
const PAGE = "Screen";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.622","t":"+16.7%","d":"up"},{"l":"NC Abertas","v":"8.788","t":"+16.2%","d":"up"},{"l":"Conformidade (%)","v":"70.3%","t":"-2.9%","d":"down"},{"l":"CAPAs Pendentes","v":"5.341","t":"+14.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.984","86.2%","8.205","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.456","73.9%","3.881","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.277","99.7%","3.758","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.594","93.6%","8.154","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.237","84.4%","8.540","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":885},{"label":"Fev","value":894},{"label":"Mar","value":803},{"label":"Abr","value":594},{"label":"Mai","value":829},{"label":"Jun","value":749},{"label":"Jul","value":738},{"label":"Ago","value":728},{"label":"Set","value":693},{"label":"Out","value":746},{"label":"Nov","value":700},{"label":"Dez","value":578}];
const MX = 894;
