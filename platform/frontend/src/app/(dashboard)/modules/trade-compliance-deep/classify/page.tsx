...
const ACCENT = "#4c1d95";
const MODULE = "Trade Compliance Deep";
const PAGE = "Classify";
const KPIS = [{"l":"Auditorias Realizadas","v":"743","t":"+3.2%","d":"up"},{"l":"NC Abertas","v":"8.618","t":"+14.1%","d":"up"},{"l":"Conformidade (%)","v":"74.4%","t":"+17.7%","d":"up"},{"l":"CAPAs Pendentes","v":"7.251","t":"+12.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.727","80.4%","3.386","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.121","79.9%","5.414","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.160","83.2%","4.839","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.180","71.6%","2.603","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.768","85.6%","6.340","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":821},{"label":"Mar","value":823},{"label":"Abr","value":676},{"label":"Mai","value":492},{"label":"Jun","value":718},{"label":"Jul","value":496},{"label":"Ago","value":802},{"label":"Set","value":549},{"label":"Out","value":463},{"label":"Nov","value":522},{"label":"Dez","value":749}];
const MX = 823;
