...
const PAGE = "Receive";
const KPIS = [{"l":"Fornecedores Ativos","v":"7.686","t":"+7.9%","d":"up"},{"l":"Contratos (€M)","v":"€40.2M","t":"+5.4%","d":"up"},{"l":"On-Time Delivery (%)","v":"70.6%","t":"-5.4%","d":"down"},{"l":"Score Médio","v":"57","t":"+7.5%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","89.3%","€ 13984.93","4.966","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","88.5%","€ 34240.58","3.020","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","85.7%","€ 607.77","4.660","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","95.3%","€ 4331.82","1.881","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","72.8%","€ 24929.62","2.221","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":715},{"label":"Mar","value":706},{"label":"Abr","value":515},{"label":"Mai","value":528},{"label":"Jun","value":527},{"label":"Jul","value":656},{"label":"Ago","value":517},{"label":"Set","value":622},{"label":"Out","value":897},{"label":"Nov","value":857},{"label":"Dez","value":655}];
const MX = 897;
