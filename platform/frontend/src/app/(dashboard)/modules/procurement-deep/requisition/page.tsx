...
const ACCENT = "#78350f";
const MODULE = "Procurement Platform Deep";
const PAGE = "Requisition";
const KPIS = [{"l":"Fornecedores Ativos","v":"541","t":"+10.1%","d":"up"},{"l":"Contratos (€M)","v":"€42.6M","t":"-5.2%","d":"down"},{"l":"On-Time Delivery (%)","v":"94.4%","t":"+9.5%","d":"up"},{"l":"Score Médio","v":"64","t":"+7.0%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","76.1%","€ 39476.47","542","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","98.7%","€ 49044.73","7.281","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","74.0%","€ 8281.59","202","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","84.8%","€ 9657.53","6.203","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","73.6%","€ 12853.58","1.013","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":868},{"label":"Fev","value":885},{"label":"Mar","value":598},{"label":"Abr","value":605},{"label":"Mai","value":673},{"label":"Jun","value":670},{"label":"Jul","value":809},{"label":"Ago","value":640},{"label":"Set","value":604},{"label":"Out","value":726},{"label":"Nov","value":612},{"label":"Dez","value":888}];
const MX = 888;
