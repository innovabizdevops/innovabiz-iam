...
const PAGE = "Approve";
const KPIS = [{"l":"Aprovações Pendentes","v":"3.107","t":"+4.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"69.0%","t":"+7.4%","d":"up"},{"l":"Tempo Médio (h)","v":"188h","t":"+13.5%","d":"up"},{"l":"Rejeitadas (%)","v":"66.3%","t":"+9.8%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","5.479","€ 25456.80","4.849","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","5.275","€ 25134.97","6.074","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","5.227","€ 41787.15","3.979","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","6.857","€ 23151.95","7.163","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","1.381","€ 45387.69","3.624","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":916},{"label":"Fev","value":617},{"label":"Mar","value":754},{"label":"Abr","value":704},{"label":"Mai","value":860},{"label":"Jun","value":920},{"label":"Jul","value":644},{"label":"Ago","value":842},{"label":"Set","value":931},{"label":"Out","value":954},{"label":"Nov","value":923},{"label":"Dez","value":854}];
const MX = 954;
