...
/* ═══ Procurement Platform Deep — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "3464", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3047", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€355K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1851313264", cells: ["PRO-5264", "Procurement Platform Deep Item 1", "25/5/2026", "€13 364"], status: "active" as const },
    { id: "1851316835", cells: ["PRO-8835", "Procurement Platform Deep Item 2", "12/12/2026", "€16 935"], status: "pending" as const },
    { id: "1851320406", cells: ["PRO-3406", "Procurement Platform Deep Item 3", "27/7/2026", "€20 506"], status: "completed" as const },
    { id: "1851323977", cells: ["PRO-6977", "Procurement Platform Deep Item 4", "14/2/2026", "€24 077"], status: "warning" as const },
    { id: "1851327548", cells: ["PRO-1548", "Procurement Platform Deep Item 5", "1/9/2026", "€27 648"], status: "active" as const },
];
...
export default function ProcurementPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Procurement Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Procurement Platform Deep</p>
                    </div>
                </div>
