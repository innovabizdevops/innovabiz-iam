...
const PAGE = "PO";
const KPIS = [{"l":"Fornecedores Ativos","v":"2.234","t":"-1.4%","d":"down"},{"l":"Contratos (€M)","v":"€47.3M","t":"-0.8%","d":"down"},{"l":"On-Time Delivery (%)","v":"71.7%","t":"+0.2%","d":"up"},{"l":"Score Médio","v":"93","t":"+7.1%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","98.2%","€ 7250.13","7.715","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","89.7%","€ 10977.20","6.207","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","89.2%","€ 19263.12","1.220","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","87.5%","€ 5813.32","847","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","96.2%","€ 34087.41","7.314","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":418},{"label":"Mar","value":529},{"label":"Abr","value":606},{"label":"Mai","value":530},{"label":"Jun","value":646},{"label":"Jul","value":773},{"label":"Ago","value":658},{"label":"Set","value":451},{"label":"Out","value":772},{"label":"Nov","value":427},{"label":"Dez","value":638}];
const MX = 773;
