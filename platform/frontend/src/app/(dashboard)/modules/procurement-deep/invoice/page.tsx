...
const PAGE = "Invoice";
const KPIS = [{"l":"Fornecedores Ativos","v":"3.858","t":"-3.2%","d":"down"},{"l":"Contratos (€M)","v":"€44.6M","t":"+16.1%","d":"up"},{"l":"On-Time Delivery (%)","v":"83.3%","t":"+14.8%","d":"up"},{"l":"Score Médio","v":"61","t":"+9.2%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","98.8%","€ 46745.12","5.192","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","92.8%","€ 41514.32","7.428","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","80.9%","€ 5281.88","8.570","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","96.1%","€ 13295.95","7.225","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","89.6%","€ 3259.26","8.984","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":470},{"label":"Fev","value":354},{"label":"Mar","value":406},{"label":"Abr","value":510},{"label":"Mai","value":550},{"label":"Jun","value":412},{"label":"Jul","value":604},{"label":"Ago","value":628},{"label":"Set","value":400},{"label":"Out","value":630},{"label":"Nov","value":251},{"label":"Dez","value":249}];
const MX = 630;
