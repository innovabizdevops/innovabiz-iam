...
const PAGE = "Segment";
const KPIS = [{"l":"Formulários Ativos","v":"8.237","t":"-5.1%","d":"down"},{"l":"Submissões/Dia","v":"4702","t":"+14.8%","d":"up"},{"l":"Documentos Gerados","v":"1.163","t":"+14.6%","d":"up"},{"l":"Templates","v":"8.102","t":"-2.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.504","2026-03-10","8.729","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.983","2026-02-15","2.853","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.461","2026-02-14","2.002","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.660","2026-01-20","272","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.889","2026-02-16","5.324","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":615},{"label":"Mar","value":634},{"label":"Abr","value":546},{"label":"Mai","value":604},{"label":"Jun","value":819},{"label":"Jul","value":691},{"label":"Ago","value":508},{"label":"Set","value":749},{"label":"Out","value":718},{"label":"Nov","value":734},{"label":"Dez","value":554}];
const MX = 819;
