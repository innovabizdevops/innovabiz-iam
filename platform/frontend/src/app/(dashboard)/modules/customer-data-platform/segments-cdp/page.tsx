...
const PAGE = "Segments";
const KPIS = [{"l":"Formulários Ativos","v":"8.218","t":"-2.2%","d":"down"},{"l":"Submissões/Dia","v":"2510","t":"+2.2%","d":"up"},{"l":"Documentos Gerados","v":"1.310","t":"-3.3%","d":"down"},{"l":"Templates","v":"7.790","t":"+14.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.559","2026-02-16","1.623","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","981","2026-03-06","5.489","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.786","2026-03-16","3.957","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.262","2026-01-27","1.141","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.141","2026-02-16","7.988","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":658},{"label":"Mar","value":853},{"label":"Abr","value":730},{"label":"Mai","value":569},{"label":"Jun","value":624},{"label":"Jul","value":678},{"label":"Ago","value":794},{"label":"Set","value":540},{"label":"Out","value":686},{"label":"Nov","value":720},{"label":"Dez","value":532}];
const MX = 853;
...
export default function SegmentsCdpPage() {
    return (
