...
const PAGE = "Data Unification";
const KPIS = [{"l":"Formulários Ativos","v":"4.404","t":"-3.7%","d":"down"},{"l":"Submissões/Dia","v":"2659","t":"-5.8%","d":"down"},{"l":"Documentos Gerados","v":"6.799","t":"+10.2%","d":"up"},{"l":"Templates","v":"6.265","t":"-5.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.010","2026-03-20","797","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.650","2026-01-12","4.438","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.431","2026-02-11","5.086","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.320","2026-03-26","5.476","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.655","2026-01-28","207","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":955},{"label":"Mar","value":680},{"label":"Abr","value":685},{"label":"Mai","value":670},{"label":"Jun","value":819},{"label":"Jul","value":827},{"label":"Ago","value":952},{"label":"Set","value":649},{"label":"Out","value":859},{"label":"Nov","value":1023},{"label":"Dez","value":859}];
const MX = 1023;
