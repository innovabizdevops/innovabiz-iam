...
const KPIS = [{"l":"Formulários Ativos","v":"103","t":"+6.4%","d":"up"},{"l":"Submissões/Dia","v":"3031","t":"+0.9%","d":"up"},{"l":"Documentos Gerados","v":"5.312","t":"+11.0%","d":"up"},{"l":"Templates","v":"7.265","t":"+10.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.368","2026-01-13","4.412","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.777","2026-01-10","564","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.724","2026-03-23","5.242","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.510","2026-01-25","1.544","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.641","2026-02-16","2.032","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":424},{"label":"Fev","value":556},{"label":"Mar","value":420},{"label":"Abr","value":482},{"label":"Mai","value":654},{"label":"Jun","value":520},{"label":"Jul","value":560},{"label":"Ago","value":394},{"label":"Set","value":448},{"label":"Out","value":582},{"label":"Nov","value":693},{"label":"Dez","value":657}];
const MX = 693;
