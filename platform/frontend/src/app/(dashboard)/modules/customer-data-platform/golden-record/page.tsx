...
const PAGE = "Golden Record";
const KPIS = [{"l":"Formulários Ativos","v":"6.904","t":"+11.0%","d":"up"},{"l":"Submissões/Dia","v":"2237","t":"+3.9%","d":"up"},{"l":"Documentos Gerados","v":"8.593","t":"+13.2%","d":"up"},{"l":"Templates","v":"5.341","t":"+6.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","9.006","2026-01-01","2.442","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.286","2026-02-21","6.126","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.750","2026-01-03","2.365","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.905","2026-03-20","2.828","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.215","2026-01-21","6.907","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":809},{"label":"Mar","value":770},{"label":"Abr","value":643},{"label":"Mai","value":949},{"label":"Jun","value":788},{"label":"Jul","value":876},{"label":"Ago","value":715},{"label":"Set","value":789},{"label":"Out","value":856},{"label":"Nov","value":859},{"label":"Dez","value":848}];
const MX = 949;
