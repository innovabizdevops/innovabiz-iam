...
const PAGE = "Activate";
const KPIS = [{"l":"Formulários Ativos","v":"5.250","t":"-1.8%","d":"down"},{"l":"Submissões/Dia","v":"1571","t":"-5.3%","d":"down"},{"l":"Documentos Gerados","v":"6.454","t":"+6.4%","d":"up"},{"l":"Templates","v":"6.556","t":"+4.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.202","2026-01-18","6.224","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.435","2026-02-03","1.128","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.178","2026-01-26","6.588","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.723","2026-03-22","8.225","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.097","2026-02-11","2.229","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":845},{"label":"Fev","value":695},{"label":"Mar","value":865},{"label":"Abr","value":733},{"label":"Mai","value":524},{"label":"Jun","value":737},{"label":"Jul","value":559},{"label":"Ago","value":861},{"label":"Set","value":844},{"label":"Out","value":600},{"label":"Nov","value":866},{"label":"Dez","value":548}];
const MX = 866;
