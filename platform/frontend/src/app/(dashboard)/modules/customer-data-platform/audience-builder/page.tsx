...
const ACCENT = "#6366f1";
const MODULE = "Customer Data Platform (CDP)";
const PAGE = "Audience Builder AI";
const KPIS = [{"l":"Formulários Ativos","v":"7.619","t":"-5.2%","d":"down"},{"l":"Submissões/Dia","v":"3076","t":"+4.6%","d":"up"},{"l":"Documentos Gerados","v":"2.468","t":"+10.8%","d":"up"},{"l":"Templates","v":"1.851","t":"+8.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.631","2026-03-01","2.904","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.924","2026-01-24","8.530","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","9.096","2026-01-13","2.992","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.168","2026-01-23","5.088","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.309","2026-02-25","6.203","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":990},{"label":"Fev","value":734},{"label":"Mar","value":754},{"label":"Abr","value":641},{"label":"Mai","value":633},{"label":"Jun","value":723},{"label":"Jul","value":805},{"label":"Ago","value":756},{"label":"Set","value":739},{"label":"Out","value":639},{"label":"Nov","value":852},{"label":"Dez","value":949}];
const MX = 990;
