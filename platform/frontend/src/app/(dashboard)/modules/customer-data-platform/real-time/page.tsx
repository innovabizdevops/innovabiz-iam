...
const PAGE = "Real-Time Decisioning";
const KPIS = [{"l":"Formulários Ativos","v":"6.249","t":"-1.3%","d":"down"},{"l":"Submissões/Dia","v":"2456","t":"+14.9%","d":"up"},{"l":"Documentos Gerados","v":"4.760","t":"+8.8%","d":"up"},{"l":"Templates","v":"3.651","t":"+17.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","589","2026-02-07","7.425","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.816","2026-03-05","1.833","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.079","2026-01-08","2.616","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.522","2026-02-20","3.758","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.376","2026-03-09","477","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":272},{"label":"Fev","value":604},{"label":"Mar","value":594},{"label":"Abr","value":337},{"label":"Mai","value":388},{"label":"Jun","value":273},{"label":"Jul","value":525},{"label":"Ago","value":357},{"label":"Set","value":591},{"label":"Out","value":427},{"label":"Nov","value":428},{"label":"Dez","value":571}];
const MX = 604;
