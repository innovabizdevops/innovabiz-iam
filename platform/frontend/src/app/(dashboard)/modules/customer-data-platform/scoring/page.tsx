...
const PAGE = "Predictive Scoring";
const KPIS = [{"l":"Formulários Ativos","v":"8.965","t":"-3.0%","d":"down"},{"l":"Submissões/Dia","v":"3358","t":"+9.9%","d":"up"},{"l":"Documentos Gerados","v":"5.170","t":"+10.3%","d":"up"},{"l":"Templates","v":"551","t":"+7.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.778","2026-02-28","3.425","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.479","2026-02-11","9.086","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.986","2026-02-08","1.597","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.789","2026-01-02","3.020","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.043","2026-02-26","7.446","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":557},{"label":"Mar","value":585},{"label":"Abr","value":741},{"label":"Mai","value":648},{"label":"Jun","value":755},{"label":"Jul","value":756},{"label":"Ago","value":800},{"label":"Set","value":731},{"label":"Out","value":585},{"label":"Nov","value":764},{"label":"Dez","value":586}];
const MX = 800;
