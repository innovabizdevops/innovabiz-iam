...
const PAGE = "Data Ingestion";
const KPIS = [{"l":"Formulários Ativos","v":"8.997","t":"+15.9%","d":"up"},{"l":"Submissões/Dia","v":"4782","t":"+3.0%","d":"up"},{"l":"Documentos Gerados","v":"4.508","t":"-3.5%","d":"down"},{"l":"Templates","v":"1.905","t":"+17.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.188","2026-03-21","8.403","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.842","2026-02-21","3.153","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.683","2026-02-28","2.360","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.357","2026-02-05","6.523","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.531","2026-02-27","7.674","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":500},{"label":"Fev","value":741},{"label":"Mar","value":681},{"label":"Abr","value":658},{"label":"Mai","value":511},{"label":"Jun","value":840},{"label":"Jul","value":615},{"label":"Ago","value":651},{"label":"Set","value":554},{"label":"Out","value":654},{"label":"Nov","value":805},{"label":"Dez","value":569}];
const MX = 840;
