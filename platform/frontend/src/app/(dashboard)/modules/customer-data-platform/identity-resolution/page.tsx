...
const KPIS = [{"l":"Utilizadores Ativos","v":"8.948","t":"+9.8%","d":"up"},{"l":"Sessões/Dia","v":"4844","t":"+6.5%","d":"up"},{"l":"MFA Adoção (%)","v":"85.0%","t":"+13.1%","d":"up"},{"l":"Tentativas Bloqueadas","v":"6.185","t":"+15.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.825","1.781","4.444","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","1.414","7.929","5.768","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.012","1.228","4.166","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","5.582","3.695","3.505","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","9.092","1.027","4.869","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":412},{"label":"Mar","value":651},{"label":"Abr","value":548},{"label":"Mai","value":685},{"label":"Jun","value":436},{"label":"Jul","value":651},{"label":"Ago","value":560},{"label":"Set","value":679},{"label":"Out","value":465},{"label":"Nov","value":760},{"label":"Dez","value":539}];
const MX = 760;
