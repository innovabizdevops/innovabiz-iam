...
const KPIS = [{"l":"Formulários Ativos","v":"6.550","t":"-3.6%","d":"down"},{"l":"Submissões/Dia","v":"4776","t":"+4.1%","d":"up"},{"l":"Documentos Gerados","v":"796","t":"+11.5%","d":"up"},{"l":"Templates","v":"2.377","t":"+14.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.283","2026-02-05","1.177","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.034","2026-03-20","340","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","699","2026-01-01","750","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.981","2026-01-04","3.070","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.003","2026-01-22","7.948","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":814},{"label":"Mar","value":750},{"label":"Abr","value":770},{"label":"Mai","value":830},{"label":"Jun","value":554},{"label":"Jul","value":704},{"label":"Ago","value":686},{"label":"Set","value":914},{"label":"Out","value":888},{"label":"Nov","value":616},{"label":"Dez","value":828}];
const MX = 914;
