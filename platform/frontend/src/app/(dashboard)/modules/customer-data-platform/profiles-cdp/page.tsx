...
const PAGE = "Unified Profiles";
const KPIS = [{"l":"Formulários Ativos","v":"3.023","t":"-3.7%","d":"down"},{"l":"Submissões/Dia","v":"4598","t":"+0.9%","d":"up"},{"l":"Documentos Gerados","v":"5.426","t":"+6.0%","d":"up"},{"l":"Templates","v":"1.081","t":"+11.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.322","2026-03-18","2.093","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.206","2026-03-13","8.197","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.960","2026-03-09","7.723","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.201","2026-01-22","4.825","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.484","2026-02-04","322","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":962},{"label":"Fev","value":967},{"label":"Mar","value":774},{"label":"Abr","value":952},{"label":"Mai","value":680},{"label":"Jun","value":945},{"label":"Jul","value":951},{"label":"Ago","value":912},{"label":"Set","value":698},{"label":"Out","value":784},{"label":"Nov","value":744},{"label":"Dez","value":806}];
const MX = 967;
...
export default function ProfilesCdpPage() {
    return (
