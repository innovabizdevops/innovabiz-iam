...
const PAGE = "Identity Resolution";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.335","t":"-1.1%","d":"down"},{"l":"Sessões/Dia","v":"2715","t":"+10.4%","d":"up"},{"l":"MFA Adoção (%)","v":"68.2%","t":"-1.1%","d":"down"},{"l":"Tentativas Bloqueadas","v":"5.260","t":"+0.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.174","2.624","1.413","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.706","5.864","5.572","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.439","4.676","3.127","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","3.892","4.312","2.118","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.040","2.556","7.471","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":766},{"label":"Mar","value":588},{"label":"Abr","value":699},{"label":"Mai","value":440},{"label":"Jun","value":562},{"label":"Jul","value":795},{"label":"Ago","value":746},{"label":"Set","value":422},{"label":"Out","value":452},{"label":"Nov","value":519},{"label":"Dez","value":600}];
const MX = 795;
