...
const PAGE = "Consent &amp; Privacy";
const KPIS = [{"l":"Formulários Ativos","v":"1.060","t":"+10.7%","d":"up"},{"l":"Submissões/Dia","v":"2936","t":"+5.1%","d":"up"},{"l":"Documentos Gerados","v":"7.995","t":"-5.1%","d":"down"},{"l":"Templates","v":"9.038","t":"-3.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.451","2026-01-23","6.997","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.114","2026-02-05","817","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.722","2026-02-26","2.264","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.677","2026-03-16","5.659","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.862","2026-03-15","1.201","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":391},{"label":"Fev","value":568},{"label":"Mar","value":593},{"label":"Abr","value":428},{"label":"Mai","value":682},{"label":"Jun","value":378},{"label":"Jul","value":556},{"label":"Ago","value":596},{"label":"Set","value":405},{"label":"Out","value":560},{"label":"Nov","value":684},{"label":"Dez","value":398}];
const MX = 684;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>GDPR</span></h1>
                </div>
