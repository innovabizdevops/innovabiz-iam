...
const PAGE = "Collect";
const KPIS = [{"l":"Formulários Ativos","v":"5.050","t":"-4.4%","d":"down"},{"l":"Submissões/Dia","v":"457","t":"+15.5%","d":"up"},{"l":"Documentos Gerados","v":"7.586","t":"-0.4%","d":"down"},{"l":"Templates","v":"7.359","t":"+9.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.405","2026-01-09","2.382","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.100","2026-02-22","6.898","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","108","2026-03-03","1.665","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.331","2026-01-19","4.959","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","320","2026-02-14","6.100","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":573},{"label":"Mar","value":682},{"label":"Abr","value":589},{"label":"Mai","value":531},{"label":"Jun","value":717},{"label":"Jul","value":552},{"label":"Ago","value":635},{"label":"Set","value":820},{"label":"Out","value":828},{"label":"Nov","value":473},{"label":"Dez","value":494}];
const MX = 828;
