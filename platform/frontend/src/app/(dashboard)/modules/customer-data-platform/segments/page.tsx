...
const PAGE = "Activation &amp; Insights";
const KPIS = [{"l":"Formulários Ativos","v":"6.839","t":"+8.9%","d":"up"},{"l":"Submissões/Dia","v":"165","t":"+7.4%","d":"up"},{"l":"Documentos Gerados","v":"7.132","t":"+14.9%","d":"up"},{"l":"Templates","v":"9.047","t":"-3.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.584","2026-01-14","3.028","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.953","2026-02-04","5.445","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.100","2026-03-22","7.682","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.303","2026-01-01","6.659","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.900","2026-02-17","5.871","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":539},{"label":"Fev","value":775},{"label":"Mar","value":650},{"label":"Abr","value":716},{"label":"Mai","value":720},{"label":"Jun","value":517},{"label":"Jul","value":762},{"label":"Ago","value":495},{"label":"Set","value":663},{"label":"Out","value":778},{"label":"Nov","value":497},{"label":"Dez","value":770}];
const MX = 778;
