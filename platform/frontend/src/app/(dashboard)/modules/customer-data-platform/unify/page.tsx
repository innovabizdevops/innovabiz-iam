...
const PAGE = "Unify";
const KPIS = [{"l":"Formulários Ativos","v":"2.753","t":"+1.1%","d":"up"},{"l":"Submissões/Dia","v":"2110","t":"-2.7%","d":"down"},{"l":"Documentos Gerados","v":"4.561","t":"-5.1%","d":"down"},{"l":"Templates","v":"5.373","t":"-3.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.107","2026-03-13","7.284","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.698","2026-01-22","7.525","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.722","2026-02-01","3.390","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.687","2026-01-13","3.738","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.591","2026-03-28","5.681","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":526},{"label":"Mar","value":379},{"label":"Abr","value":463},{"label":"Mai","value":481},{"label":"Jun","value":740},{"label":"Jul","value":582},{"label":"Ago","value":737},{"label":"Set","value":397},{"label":"Out","value":589},{"label":"Nov","value":732},{"label":"Dez","value":648}];
const MX = 740;
