...
const PAGE = "Measure";
const KPIS = [{"l":"Formulários Ativos","v":"5.940","t":"+11.5%","d":"up"},{"l":"Submissões/Dia","v":"3902","t":"+8.3%","d":"up"},{"l":"Documentos Gerados","v":"7.625","t":"+1.4%","d":"up"},{"l":"Templates","v":"3.654","t":"+8.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.665","2026-02-02","4.728","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.932","2026-01-10","1.710","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.011","2026-01-16","1.203","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.540","2026-01-18","8.894","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.872","2026-03-01","1.140","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":669},{"label":"Mar","value":709},{"label":"Abr","value":485},{"label":"Mai","value":505},{"label":"Jun","value":780},{"label":"Jul","value":579},{"label":"Ago","value":699},{"label":"Set","value":654},{"label":"Out","value":853},{"label":"Nov","value":733},{"label":"Dez","value":511}];
const MX = 853;
