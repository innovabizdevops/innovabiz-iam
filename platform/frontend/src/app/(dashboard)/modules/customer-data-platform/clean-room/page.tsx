...
const PAGE = "Data Clean Room";
const KPIS = [{"l":"Formulários Ativos","v":"5.807","t":"+16.5%","d":"up"},{"l":"Submissões/Dia","v":"1766","t":"+11.2%","d":"up"},{"l":"Documentos Gerados","v":"1.153","t":"+5.5%","d":"up"},{"l":"Templates","v":"5.315","t":"-5.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.971","2026-01-14","6.249","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.554","2026-02-10","5.811","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.222","2026-03-10","6.114","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.968","2026-01-08","4.248","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","660","2026-01-01","3.876","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":737},{"label":"Fev","value":739},{"label":"Mar","value":812},{"label":"Abr","value":653},{"label":"Mai","value":790},{"label":"Jun","value":882},{"label":"Jul","value":664},{"label":"Ago","value":891},{"label":"Set","value":760},{"label":"Out","value":688},{"label":"Nov","value":758},{"label":"Dez","value":906}];
const MX = 906;
