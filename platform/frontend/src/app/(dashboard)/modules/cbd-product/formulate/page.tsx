...
const ACCENT = "#166534";
const MODULE = "CBD Product Mfg";
const PAGE = "Formulate";
const KPIS = [{"l":"Formulários Ativos","v":"9.069","t":"+15.2%","d":"up"},{"l":"Submissões/Dia","v":"3662","t":"+1.5%","d":"up"},{"l":"Documentos Gerados","v":"4.107","t":"+1.1%","d":"up"},{"l":"Templates","v":"2.343","t":"+10.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.946","2026-03-24","6.879","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.593","2026-01-17","3.699","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.075","2026-02-17","8.038","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.267","2026-01-09","4.187","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.911","2026-02-11","2.296","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":584},{"label":"Fev","value":663},{"label":"Mar","value":743},{"label":"Abr","value":598},{"label":"Mai","value":487},{"label":"Jun","value":605},{"label":"Jul","value":805},{"label":"Ago","value":671},{"label":"Set","value":846},{"label":"Out","value":727},{"label":"Nov","value":495},{"label":"Dez","value":661}];
const MX = 846;
