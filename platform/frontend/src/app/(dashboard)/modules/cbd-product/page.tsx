...
/* ═══ CBD Product Mfg — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "8954", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2509", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€42K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "92959954", cells: ["CBD-8954", "CBD Product Mfg Item 1", "11/11/2026", "€10 054"], status: "active" as const },
    { id: "92963525", cells: ["CBD-3525", "CBD Product Mfg Item 2", "26/6/2026", "€13 625"], status: "pending" as const },
    { id: "92967096", cells: ["CBD-7096", "CBD Product Mfg Item 3", "13/1/2026", "€17 196"], status: "completed" as const },
    { id: "92970667", cells: ["CBD-1667", "CBD Product Mfg Item 4", "28/8/2026", "€20 767"], status: "warning" as const },
    { id: "92974238", cells: ["CBD-5238", "CBD Product Mfg Item 5", "15/3/2026", "€24 338"], status: "active" as const },
];
...
export default function CbdProductMfgPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CBD Product Mfg</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CBD Product Mfg</p>
                    </div>
                </div>
