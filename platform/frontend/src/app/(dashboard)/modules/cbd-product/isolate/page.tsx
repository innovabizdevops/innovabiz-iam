...
const PAGE = "Isolate";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.099","t":"+11.4%","d":"up"},{"l":"NC Abertas","v":"3.093","t":"-3.5%","d":"down"},{"l":"Conformidade (%)","v":"88.6%","t":"+17.5%","d":"up"},{"l":"CAPAs Pendentes","v":"4.710","t":"+8.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.757","86.9%","1.930","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.122","89.6%","3.903","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.003","90.8%","8.355","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.048","71.7%","1.191","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.265","99.2%","720","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":837},{"label":"Mar","value":639},{"label":"Abr","value":580},{"label":"Mai","value":704},{"label":"Jun","value":916},{"label":"Jul","value":869},{"label":"Ago","value":826},{"label":"Set","value":802},{"label":"Out","value":572},{"label":"Nov","value":746},{"label":"Dez","value":530}];
const MX = 916;
