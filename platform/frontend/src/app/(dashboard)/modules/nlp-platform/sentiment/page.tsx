...
const ACCENT = "#8b5cf6";
const MODULE = "NLP/NLU Platform";
const PAGE = "Sentiment";
const KPIS = [{"l":"Formulários Ativos","v":"8.489","t":"+1.9%","d":"up"},{"l":"Submissões/Dia","v":"330","t":"-4.8%","d":"down"},{"l":"Documentos Gerados","v":"2.921","t":"+7.3%","d":"up"},{"l":"Templates","v":"2.525","t":"-4.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.556","2026-01-02","1.308","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.534","2026-03-27","337","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","416","2026-01-02","844","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.199","2026-01-22","5.816","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.297","2026-02-13","4.289","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":242},{"label":"Fev","value":266},{"label":"Mar","value":271},{"label":"Abr","value":358},{"label":"Mai","value":462},{"label":"Jun","value":571},{"label":"Jul","value":422},{"label":"Ago","value":569},{"label":"Set","value":556},{"label":"Out","value":549},{"label":"Nov","value":434},{"label":"Dez","value":518}];
const MX = 571;
