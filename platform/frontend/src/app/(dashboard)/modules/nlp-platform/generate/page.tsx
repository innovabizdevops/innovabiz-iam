...
const PAGE = "Generate";
const KPIS = [{"l":"Formulários Ativos","v":"2.434","t":"+2.6%","d":"up"},{"l":"Submissões/Dia","v":"1793","t":"+14.4%","d":"up"},{"l":"Documentos Gerados","v":"3.175","t":"-4.3%","d":"down"},{"l":"Templates","v":"5.757","t":"+3.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.636","2026-02-16","6.939","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.388","2026-02-05","3.811","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.745","2026-02-25","4.734","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.078","2026-02-28","1.453","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","119","2026-02-21","5.789","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":636},{"label":"Mar","value":794},{"label":"Abr","value":793},{"label":"Mai","value":473},{"label":"Jun","value":589},{"label":"Jul","value":603},{"label":"Ago","value":800},{"label":"Set","value":847},{"label":"Out","value":730},{"label":"Nov","value":453},{"label":"Dez","value":481}];
const MX = 847;
