...
const KPIS = [{"l":"Tickets Abertos","v":"1.873","t":"+4.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"93.4%","t":"-0.3%","d":"down"},{"l":"MTTR (h)","v":"206h","t":"+5.5%","d":"up"},{"l":"Satisfação (%)","v":"94.9%","t":"+13.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.249","390","5.799","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.895","6.995","7.697","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.813","4.785","3.348","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.917","4.038","1.035","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.375","3.372","8.958","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":721},{"label":"Mar","value":814},{"label":"Abr","value":530},{"label":"Mai","value":441},{"label":"Jun","value":561},{"label":"Jul","value":465},{"label":"Ago","value":450},{"label":"Set","value":828},{"label":"Out","value":751},{"label":"Nov","value":478},{"label":"Dez","value":544}];
const MX = 828;
