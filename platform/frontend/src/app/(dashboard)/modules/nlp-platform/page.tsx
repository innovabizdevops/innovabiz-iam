...
/* ═══ NLP/NLU Platform — Dashboard ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total Registos", value: "6825", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2185", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€271K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "947674325", cells: ["NLP-2325", "NLP/NLU Platform Item 1", "18/6/2026", "€24 425"], status: "active" as const },
    { id: "947677896", cells: ["NLP-5896", "NLP/NLU Platform Item 2", "5/1/2026", "€27 996"], status: "pending" as const },
    { id: "947681467", cells: ["NLP-9467", "NLP/NLU Platform Item 3", "20/8/2026", "€31 567"], status: "completed" as const },
    { id: "947685038", cells: ["NLP-4038", "NLP/NLU Platform Item 4", "7/3/2026", "€35 138"], status: "warning" as const },
    { id: "947688609", cells: ["NLP-7609", "NLP/NLU Platform Item 5", "22/10/2026", "€38 709"], status: "active" as const },
];
...
export default function NlpnluPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">NLP/NLU Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • NLP/NLU Platform</p>
                    </div>
                </div>
