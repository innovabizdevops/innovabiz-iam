...
const PAGE = "Entity";
const KPIS = [{"l":"Formulários Ativos","v":"8.417","t":"+9.8%","d":"up"},{"l":"Submissões/Dia","v":"3875","t":"+3.5%","d":"up"},{"l":"Documentos Gerados","v":"6.217","t":"+13.1%","d":"up"},{"l":"Templates","v":"5.508","t":"-0.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.105","2026-02-18","1.227","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.470","2026-03-07","4.635","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.834","2026-01-14","5.317","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.939","2026-03-20","5.998","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.620","2026-03-06","689","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":690},{"label":"Mar","value":824},{"label":"Abr","value":797},{"label":"Mai","value":513},{"label":"Jun","value":658},{"label":"Jul","value":466},{"label":"Ago","value":521},{"label":"Set","value":650},{"label":"Out","value":652},{"label":"Nov","value":549},{"label":"Dez","value":548}];
const MX = 824;
