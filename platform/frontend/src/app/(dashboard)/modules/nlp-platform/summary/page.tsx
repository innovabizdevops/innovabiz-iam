...
const PAGE = "Summary";
const KPIS = [{"l":"Formulários Ativos","v":"686","t":"+17.3%","d":"up"},{"l":"Submissões/Dia","v":"3318","t":"+7.4%","d":"up"},{"l":"Documentos Gerados","v":"1.334","t":"-2.0%","d":"down"},{"l":"Templates","v":"6.557","t":"+0.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.080","2026-01-18","3.373","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","240","2026-01-22","6.638","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.664","2026-02-22","2.539","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.802","2026-03-05","3.824","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.492","2026-01-08","772","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":375},{"label":"Fev","value":591},{"label":"Mar","value":284},{"label":"Abr","value":467},{"label":"Mai","value":507},{"label":"Jun","value":561},{"label":"Jul","value":257},{"label":"Ago","value":376},{"label":"Set","value":492},{"label":"Out","value":516},{"label":"Nov","value":583},{"label":"Dez","value":598}];
const MX = 598;
