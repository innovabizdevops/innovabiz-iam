...
const PAGE = "Custom";
const KPIS = [{"l":"Total Foam Pack","v":"2.645","t":"+17.4%","d":"up"},{"l":"Custom Ativos","v":"€93468","t":"-3.9%","d":"down"},{"l":"Eficiência (%)","v":"80.4%","t":"+14.0%","d":"up"},{"l":"Score Performance","v":"84","t":"+17.4%","d":"up"}];
const COLS = ["ID","Custom","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Foam Pack #001","€ 12955.64","5.852","6.507","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Foam Pack #002","€ 41659.59","7.728","5.802","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Foam Pack #003","€ 21508.46","664","5.241","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Foam Pack #004","€ 17705.91","5.854","189","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Foam Pack #005","€ 31198.24","1.853","5.684","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":981},{"label":"Fev","value":715},{"label":"Mar","value":677},{"label":"Abr","value":733},{"label":"Mai","value":642},{"label":"Jun","value":786},{"label":"Jul","value":986},{"label":"Ago","value":623},{"label":"Set","value":826},{"label":"Out","value":833},{"label":"Nov","value":878},{"label":"Dez","value":1012}];
const MX = 1012;
