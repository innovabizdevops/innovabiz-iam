...
/* ═══ Foam Packaging — Dashboard ═══ */

const ACCENT = "#facc15";

const KPIS = [
    { label: "Total Registos", value: "3436", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4646", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€323K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "604734936", cells: ["FOA-7936", "Foam Packaging Item 1", "9/1/2026", "€35 036"], status: "active" as const },
    { id: "604738507", cells: ["FOA-2507", "Foam Packaging Item 2", "24/8/2026", "€38 607"], status: "pending" as const },
    { id: "604742078", cells: ["FOA-6078", "Foam Packaging Item 3", "11/3/2026", "€42 178"], status: "completed" as const },
    { id: "604745649", cells: ["FOA-9649", "Foam Packaging Item 4", "26/10/2026", "€45 749"], status: "warning" as const },
    { id: "604749220", cells: ["FOA-4220", "Foam Packaging Item 5", "13/5/2026", "€49 320"], status: "active" as const },
];
...
export default function FoamPackagingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Foam Packaging</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Foam Packaging</p>
                    </div>
                </div>
