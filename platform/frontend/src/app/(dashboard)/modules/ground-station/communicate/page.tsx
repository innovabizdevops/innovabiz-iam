...
const KPIS = [{"l":"Total Ground Station","v":"4.740","t":"+2.3%","d":"up"},{"l":"Communicate Ativos","v":"6.068","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"76.0%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"83","t":"+8.1%","d":"up"}];
const COLS = ["ID","Communicate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ground Station #001","Ground Station #002","657","9.007","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Ground Station #002","Ground Station #003","730","8.925","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Ground Station #003","Ground Station #004","4.534","4.234","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Ground Station #004","Ground Station #005","7.826","5.488","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ground Station #005","Ground Station #001","3.084","3.351","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":980},{"label":"Fev","value":773},{"label":"Mar","value":970},{"label":"Abr","value":714},{"label":"Mai","value":711},{"label":"Jun","value":1028},{"label":"Jul","value":908},{"label":"Ago","value":1043},{"label":"Set","value":910},{"label":"Out","value":799},{"label":"Nov","value":1059},{"label":"Dez","value":921}];
const MX = 1059;
