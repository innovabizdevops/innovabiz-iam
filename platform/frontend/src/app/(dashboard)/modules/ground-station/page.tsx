...
/* ═══ Ground Station Management — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "4757", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4458", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€188K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "357622357", cells: ["GRO-8357", "Ground Station Management Item 1", "2/2/2026", "€22 457"], status: "active" as const },
    { id: "357625928", cells: ["GRO-2928", "Ground Station Management Item 2", "17/9/2026", "€26 028"], status: "pending" as const },
    { id: "357629499", cells: ["GRO-6499", "Ground Station Management Item 3", "4/4/2026", "€29 599"], status: "completed" as const },
    { id: "357633070", cells: ["GRO-1070", "Ground Station Management Item 4", "19/11/2026", "€33 170"], status: "warning" as const },
    { id: "357636641", cells: ["GRO-4641", "Ground Station Management Item 5", "6/6/2026", "€36 741"], status: "active" as const },
];
...
export default function GroundStationManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ground Station Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Ground Station Management</p>
                    </div>
                </div>
