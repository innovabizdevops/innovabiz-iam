...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Ground Station","v":"5.874","t":"+18.0%","d":"up"},{"l":"Schedule Ativos","v":"7.690","t":"+0.3%","d":"up"},{"l":"Eficiência (%)","v":"67.5%","t":"+15.4%","d":"up"},{"l":"Score Performance","v":"64","t":"+3.2%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ground Station #001","Ground Station #002","7.465","1.905","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Ground Station #002","Ground Station #003","5.747","2.173","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Ground Station #003","Ground Station #004","3.442","3.530","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Ground Station #004","Ground Station #005","8.441","2.803","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ground Station #005","Ground Station #001","730","3.985","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":820},{"label":"Mar","value":493},{"label":"Abr","value":759},{"label":"Mai","value":546},{"label":"Jun","value":792},{"label":"Jul","value":531},{"label":"Ago","value":703},{"label":"Set","value":775},{"label":"Out","value":595},{"label":"Nov","value":524},{"label":"Dez","value":523}];
const MX = 820;
