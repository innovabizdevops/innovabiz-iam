...
const ACCENT = "#1e3a5f";
const MODULE = "Ground Station Management";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Ground Station","v":"2.915","t":"+1.9%","d":"up"},{"l":"Monitor Ativos","v":"988","t":"+10.7%","d":"up"},{"l":"Eficiência (%)","v":"65.9%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"64","t":"-3.4%","d":"down"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ground Station #001","Ground Station #002","2.580","1.846","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Ground Station #002","Ground Station #003","1.898","5.476","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Ground Station #003","Ground Station #004","4.954","3.200","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Ground Station #004","Ground Station #005","8.007","8.600","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ground Station #005","Ground Station #001","4.501","8.898","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":591},{"label":"Mar","value":541},{"label":"Abr","value":856},{"label":"Mai","value":654},{"label":"Jun","value":829},{"label":"Jul","value":830},{"label":"Ago","value":888},{"label":"Set","value":548},{"label":"Out","value":534},{"label":"Nov","value":748},{"label":"Dez","value":825}];
const MX = 888;
