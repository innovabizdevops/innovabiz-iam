...
const ACCENT = "#ca8a04";
const MODULE = "Grant Management";
const PAGE = "Renewals";
const KPIS = [{"l":"Contratos Ativos","v":"8.510","t":"+0.1%","d":"up"},{"l":"Valor Total (€M)","v":"€17.5M","t":"+17.8%","d":"up"},{"l":"Renovações Próx. 30d","v":"3.003","t":"-0.4%","d":"down"},{"l":"Obrigações Pendentes","v":"4.950","t":"+14.4%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 15265.14","2026-02-17","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 46513.00","2026-03-27","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 6622.01","2026-03-15","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 5923.86","2026-02-23","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 11030.58","2026-02-16","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":786},{"label":"Fev","value":940},{"label":"Mar","value":888},{"label":"Abr","value":918},{"label":"Mai","value":819},{"label":"Jun","value":837},{"label":"Jul","value":791},{"label":"Ago","value":782},{"label":"Set","value":664},{"label":"Out","value":1019},{"label":"Nov","value":751},{"label":"Dez","value":1029}];
const MX = 1029;
