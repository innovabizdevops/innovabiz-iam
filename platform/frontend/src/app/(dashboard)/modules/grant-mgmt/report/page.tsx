...
const PAGE = "Report";
const KPIS = [{"l":"Total Grant Mgmt","v":"5.511","t":"-2.3%","d":"down"},{"l":"Report Ativos","v":"4.118","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"76.6%","t":"+16.3%","d":"up"},{"l":"Score Performance","v":"76","t":"-3.8%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grant Mgmt #001","Grant Mgmt #002","5.565","6.695","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Grant Mgmt #002","Grant Mgmt #003","7.738","2.777","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Grant Mgmt #003","Grant Mgmt #004","103","3.920","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Grant Mgmt #004","Grant Mgmt #005","627","5.766","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grant Mgmt #005","Grant Mgmt #001","4.631","1.463","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":705},{"label":"Mar","value":631},{"label":"Abr","value":581},{"label":"Mai","value":390},{"label":"Jun","value":380},{"label":"Jul","value":392},{"label":"Ago","value":485},{"label":"Set","value":700},{"label":"Out","value":673},{"label":"Nov","value":428},{"label":"Dez","value":373}];
const MX = 705;
