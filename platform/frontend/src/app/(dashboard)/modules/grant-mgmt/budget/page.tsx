...
const PAGE = "Budget";
const KPIS = [{"l":"Total Grant Mgmt","v":"6.835","t":"+6.2%","d":"up"},{"l":"Budget Ativos","v":"€29376","t":"+0.7%","d":"up"},{"l":"Eficiência (%)","v":"76.1%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"60","t":"+5.0%","d":"up"}];
const COLS = ["ID","Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grant Mgmt #001","€ 27564.00","7.604","5.223","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Grant Mgmt #002","€ 19765.76","686","8.885","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Grant Mgmt #003","€ 26101.54","4.010","3.036","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Grant Mgmt #004","€ 37282.18","1.265","6.133","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grant Mgmt #005","€ 39412.51","8.045","8.411","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":342},{"label":"Fev","value":613},{"label":"Mar","value":574},{"label":"Abr","value":624},{"label":"Mai","value":585},{"label":"Jun","value":401},{"label":"Jul","value":594},{"label":"Ago","value":529},{"label":"Set","value":421},{"label":"Out","value":412},{"label":"Nov","value":546},{"label":"Dez","value":383}];
const MX = 624;
