...
const KPIS = [{"l":"Total Grant Mgmt","v":"5.827","t":"+17.1%","d":"up"},{"l":"Application Ativos","v":"1.637","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"90.6%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"60","t":"+6.7%","d":"up"}];
const COLS = ["ID","Application","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grant Mgmt #001","Grant Mgmt #002","4.792","8.660","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Grant Mgmt #002","Grant Mgmt #003","8.561","2.162","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Grant Mgmt #003","Grant Mgmt #004","2.264","584","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Grant Mgmt #004","Grant Mgmt #005","453","1.457","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grant Mgmt #005","Grant Mgmt #001","4.763","6.717","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":368},{"label":"Mar","value":494},{"label":"Abr","value":596},{"label":"Mai","value":647},{"label":"Jun","value":397},{"label":"Jul","value":500},{"label":"Ago","value":561},{"label":"Set","value":666},{"label":"Out","value":555},{"label":"Nov","value":519},{"label":"Dez","value":524}];
const MX = 666;
