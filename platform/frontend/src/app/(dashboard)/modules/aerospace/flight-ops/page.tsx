...
const KPIS = [{"l":"Quartos Ocupados","v":"1.109","t":"+17.9%","d":"up"},{"l":"RevPAR (€)","v":"€55861","t":"+4.2%","d":"up"},{"l":"Ocupação (%)","v":"94.7%","t":"+16.2%","d":"up"},{"l":"Guest Satisfaction","v":"8.966","t":"-3.1%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.909","2026-01-15","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.009","2026-01-02","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","925","2026-02-28","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","787","2026-03-11","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.576","2026-03-02","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":984},{"label":"Fev","value":701},{"label":"Mar","value":623},{"label":"Abr","value":966},{"label":"Mai","value":604},{"label":"Jun","value":719},{"label":"Jul","value":901},{"label":"Ago","value":593},{"label":"Set","value":890},{"label":"Out","value":942},{"label":"Nov","value":889},{"label":"Dez","value":985}];
const MX = 985;
