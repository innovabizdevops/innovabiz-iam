...
const ACCENT = "#1e3a5f";
const MODULE = "Aerospace & Defense";
const PAGE = "Defense Contracts";
const KPIS = [{"l":"Contratos Ativos","v":"7.464","t":"+3.3%","d":"up"},{"l":"Valor Total (€M)","v":"€20.1M","t":"-4.6%","d":"down"},{"l":"Renovações Próx. 30d","v":"1.095","t":"+15.0%","d":"up"},{"l":"Obrigações Pendentes","v":"6.825","t":"+4.1%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 13708.01","2026-01-13","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 20020.79","2026-03-11","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 20464.66","2026-02-09","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 35991.53","2026-03-18","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 27116.41","2026-02-23","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":647},{"label":"Mar","value":589},{"label":"Abr","value":887},{"label":"Mai","value":806},{"label":"Jun","value":970},{"label":"Jul","value":612},{"label":"Ago","value":730},{"label":"Set","value":925},{"label":"Out","value":814},{"label":"Nov","value":825},{"label":"Dez","value":691}];
const MX = 970;
...
export default function DefenseContractsPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e3a5f'}}>ITAR</span></h1>
                </div>
