...
const PAGE = "Parts Traceability";
const KPIS = [{"l":"Quartos Ocupados","v":"7.248","t":"+8.5%","d":"up"},{"l":"RevPAR (€)","v":"€75871","t":"-3.2%","d":"down"},{"l":"Ocupação (%)","v":"72.0%","t":"+10.9%","d":"up"},{"l":"Guest Satisfaction","v":"8.639","t":"+18.0%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.251","2026-02-09","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.137","2026-02-05","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.811","2026-02-13","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","2.336","2026-01-20","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.606","2026-03-16","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":873},{"label":"Mar","value":741},{"label":"Abr","value":810},{"label":"Mai","value":630},{"label":"Jun","value":727},{"label":"Jul","value":860},{"label":"Ago","value":896},{"label":"Set","value":1012},{"label":"Out","value":739},{"label":"Nov","value":749},{"label":"Dez","value":835}];
const MX = 1012;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e3a5f'}}>AS9100</span></h1>
                </div>
