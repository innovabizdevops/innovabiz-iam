...
const PAGE = "Manufacturing Execution";
const KPIS = [{"l":"Quartos Ocupados","v":"8.327","t":"-3.4%","d":"down"},{"l":"RevPAR (€)","v":"€43400","t":"+12.5%","d":"up"},{"l":"Ocupação (%)","v":"74.2%","t":"+14.2%","d":"up"},{"l":"Guest Satisfaction","v":"1.329","t":"+4.5%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","5.492","2026-01-25","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","5.077","2026-02-24","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","4.650","2026-03-24","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.232","2026-03-14","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.538","2026-02-24","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":899},{"label":"Mar","value":934},{"label":"Abr","value":858},{"label":"Mai","value":891},{"label":"Jun","value":1053},{"label":"Jul","value":965},{"label":"Ago","value":876},{"label":"Set","value":768},{"label":"Out","value":743},{"label":"Nov","value":802},{"label":"Dez","value":670}];
const MX = 1053;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e3a5f'}}>MES</span></h1>
                </div>
