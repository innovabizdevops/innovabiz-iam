...
const PAGE = "Program Management";
const KPIS = [{"l":"Projetos Melhoria","v":"1.255","t":"+5.3%","d":"up"},{"l":"Savings (€)","v":"€89470","t":"+8.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"80.2%","t":"-4.6%","d":"down"},{"l":"Ciclos PDCA","v":"8.261","t":"-4.7%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.257","€ 25418.60","8.480","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.138","€ 20410.68","8.776","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.603","€ 43378.07","1.247","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.282","€ 3234.54","8.135","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.396","€ 5162.98","4.666","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":834},{"label":"Mar","value":820},{"label":"Abr","value":831},{"label":"Mai","value":708},{"label":"Jun","value":1011},{"label":"Jul","value":698},{"label":"Ago","value":857},{"label":"Set","value":915},{"label":"Out","value":833},{"label":"Nov","value":983},{"label":"Dez","value":642}];
const MX = 1011;
