...
const PAGE = "Airworthiness";
const KPIS = [{"l":"Quartos Ocupados","v":"8.980","t":"+5.7%","d":"up"},{"l":"RevPAR (€)","v":"€71884","t":"+12.8%","d":"up"},{"l":"Ocupação (%)","v":"71.4%","t":"+10.0%","d":"up"},{"l":"Guest Satisfaction","v":"6.533","t":"+9.9%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.755","2026-01-12","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","5.805","2026-03-07","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.758","2026-02-26","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.523","2026-02-13","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.274","2026-03-25","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1086},{"label":"Fev","value":1003},{"label":"Mar","value":892},{"label":"Abr","value":985},{"label":"Mai","value":947},{"label":"Jun","value":966},{"label":"Jul","value":870},{"label":"Ago","value":914},{"label":"Set","value":919},{"label":"Out","value":1003},{"label":"Nov","value":958},{"label":"Dez","value":835}];
const MX = 1086;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e3a5f'}}>EASA</span></h1>
                </div>
