...
const PAGE = "Supply Chain Security";
const KPIS = [{"l":"Quartos Ocupados","v":"8.182","t":"+2.4%","d":"up"},{"l":"RevPAR (€)","v":"€56380","t":"+0.7%","d":"up"},{"l":"Ocupação (%)","v":"72.2%","t":"+10.6%","d":"up"},{"l":"Guest Satisfaction","v":"1.841","t":"+13.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.830","2026-01-18","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.216","2026-02-24","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.771","2026-01-07","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.156","2026-01-08","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","9.094","2026-03-27","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":389},{"label":"Mar","value":453},{"label":"Abr","value":718},{"label":"Mai","value":491},{"label":"Jun","value":458},{"label":"Jul","value":753},{"label":"Ago","value":431},{"label":"Set","value":701},{"label":"Out","value":548},{"label":"Nov","value":434},{"label":"Dez","value":760}];
const MX = 760;
...
export default function SupplySecurityPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e3a5f'}}>CMMC</span></h1>
                </div>
