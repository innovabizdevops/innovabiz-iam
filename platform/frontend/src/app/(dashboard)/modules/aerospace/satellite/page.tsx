...
const PAGE = "Satellite Operations";
const KPIS = [{"l":"Quartos Ocupados","v":"6.097","t":"-4.3%","d":"down"},{"l":"RevPAR (€)","v":"€55618","t":"+17.7%","d":"up"},{"l":"Ocupação (%)","v":"73.9%","t":"-5.3%","d":"down"},{"l":"Guest Satisfaction","v":"8.042","t":"-4.1%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.394","2026-01-20","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.856","2026-03-09","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.518","2026-03-03","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.662","2026-02-08","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.668","2026-01-05","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":689},{"label":"Mar","value":464},{"label":"Abr","value":637},{"label":"Mai","value":557},{"label":"Jun","value":646},{"label":"Jul","value":540},{"label":"Ago","value":586},{"label":"Set","value":774},{"label":"Out","value":396},{"label":"Nov","value":636},{"label":"Dez","value":560}];
const MX = 774;
