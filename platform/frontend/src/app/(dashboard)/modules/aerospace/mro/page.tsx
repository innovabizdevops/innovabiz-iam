...
const PAGE = "MRO Management";
const KPIS = [{"l":"Projetos Melhoria","v":"2.367","t":"+0.1%","d":"up"},{"l":"Savings (€)","v":"€66271","t":"-4.9%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"70.2%","t":"+15.8%","d":"up"},{"l":"Ciclos PDCA","v":"1.338","t":"+7.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.801","€ 49690.07","8.572","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.734","€ 8013.36","7.556","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.540","€ 34123.07","8.007","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.102","€ 25347.42","1.190","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","542","€ 2196.24","833","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":452},{"label":"Fev","value":675},{"label":"Mar","value":705},{"label":"Abr","value":723},{"label":"Mai","value":745},{"label":"Jun","value":553},{"label":"Jul","value":740},{"label":"Ago","value":622},{"label":"Set","value":550},{"label":"Out","value":410},{"label":"Nov","value":475},{"label":"Dez","value":466}];
const MX = 745;
