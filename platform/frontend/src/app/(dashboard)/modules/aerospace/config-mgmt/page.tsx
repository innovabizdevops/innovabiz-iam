...
const KPIS = [{"l":"Ativos Registados","v":"4.866","t":"-2.6%","d":"down"},{"l":"Valor Total (€M)","v":"€13.9M","t":"-2.7%","d":"down"},{"l":"Depreciação Anual (€)","v":"€35779","t":"-3.8%","d":"down"},{"l":"Ativos em Garantia","v":"1.078","t":"+8.2%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 48651.03","3.387","€ 5341.67","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 19558.46","5.741","€ 20289.93","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 10672.81","2.662","€ 41713.00","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 2272.79","7.322","€ 17103.68","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 164.70","4.773","€ 26009.21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":255},{"label":"Fev","value":482},{"label":"Mar","value":508},{"label":"Abr","value":247},{"label":"Mai","value":537},{"label":"Jun","value":439},{"label":"Jul","value":630},{"label":"Ago","value":310},{"label":"Set","value":614},{"label":"Out","value":349},{"label":"Nov","value":443},{"label":"Dez","value":426}];
const MX = 630;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e3a5f'}}>CM</span></h1>
                </div>
