...
const PAGE = "Suppression";
const KPIS = [{"l":"Total Wildfire Mgmt","v":"2.911","t":"-1.1%","d":"down"},{"l":"Suppression Ativos","v":"1.566","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"86.1%","t":"+11.5%","d":"up"},{"l":"Score Performance","v":"61","t":"+13.3%","d":"up"}];
const COLS = ["ID","Suppression","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wildfire Mgmt #001","Wildfire Mgmt #002","825","292","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Wildfire Mgmt #002","Wildfire Mgmt #003","3.475","7.689","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Wildfire Mgmt #003","Wildfire Mgmt #004","5.979","4.729","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Wildfire Mgmt #004","Wildfire Mgmt #005","7.690","6.625","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wildfire Mgmt #005","Wildfire Mgmt #001","2.831","4.449","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":573},{"label":"Mar","value":485},{"label":"Abr","value":561},{"label":"Mai","value":517},{"label":"Jun","value":469},{"label":"Jul","value":534},{"label":"Ago","value":677},{"label":"Set","value":511},{"label":"Out","value":635},{"label":"Nov","value":666},{"label":"Dez","value":588}];
const MX = 792;
