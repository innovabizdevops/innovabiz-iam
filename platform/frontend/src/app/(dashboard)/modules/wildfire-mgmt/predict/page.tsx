...
const PAGE = "AI Predict";
const KPIS = [{"l":"Integrações Ativas","v":"7.204","t":"+4.1%","d":"up"},{"l":"Chamadas/Hora","v":"2314","t":"+7.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"66.5%","t":"+17.8%","d":"up"},{"l":"Latência Média (ms)","v":"127ms","t":"+16.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.230","3.762","98.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.193","4.088","72.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.652","788","91.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.614","8.771","84.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.152","4.452","96.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":933},{"label":"Mar","value":583},{"label":"Abr","value":862},{"label":"Mai","value":623},{"label":"Jun","value":761},{"label":"Jul","value":659},{"label":"Ago","value":696},{"label":"Set","value":796},{"label":"Out","value":591},{"label":"Nov","value":607},{"label":"Dez","value":674}];
const MX = 933;
