...
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"1.535","t":"+15.5%","d":"up"},{"l":"Viagens/Dia","v":"4440","t":"+17.2%","d":"up"},{"l":"Pontualidade (%)","v":"70.3%","t":"+3.2%","d":"up"},{"l":"Passageiros/Dia","v":"4953","t":"+7.1%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-27","2026-01-13","2.968","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-26","2026-02-17","2.583","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-20","2026-01-05","7.845","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-26","2026-01-12","4.347","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-03","2026-01-16","417","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":608},{"label":"Fev","value":640},{"label":"Mar","value":612},{"label":"Abr","value":692},{"label":"Mai","value":883},{"label":"Jun","value":688},{"label":"Jul","value":693},{"label":"Ago","value":815},{"label":"Set","value":795},{"label":"Out","value":672},{"label":"Nov","value":714},{"label":"Dez","value":853}];
const MX = 883;
