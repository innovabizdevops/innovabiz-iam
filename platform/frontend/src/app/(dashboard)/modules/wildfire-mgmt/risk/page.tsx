...
const PAGE = "Risk Map";
const KPIS = [{"l":"Riscos Identificados","v":"1.474","t":"+14.7%","d":"up"},{"l":"Mitigações Ativas","v":"2.926","t":"+0.7%","d":"up"},{"l":"Score Risco Geral","v":"62","t":"+11.3%","d":"up"},{"l":"Incidentes YTD","v":"5.391","t":"+15.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.640","8.843","1.533","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.299","6.983","1.595","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.235","1.519","7.806","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.132","4.796","5.667","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.401","2.178","2.658","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":903},{"label":"Fev","value":951},{"label":"Mar","value":993},{"label":"Abr","value":841},{"label":"Mai","value":953},{"label":"Jun","value":921},{"label":"Jul","value":668},{"label":"Ago","value":673},{"label":"Set","value":1000},{"label":"Out","value":853},{"label":"Nov","value":730},{"label":"Dez","value":704}];
const MX = 1000;
