...
const PAGE = "Post-Fire";
const KPIS = [{"l":"Pedidos/Dia","v":"4167","t":"-1.1%","d":"down"},{"l":"GMV (€)","v":"€59819","t":"+14.3%","d":"up"},{"l":"Conversão (%)","v":"92.8%","t":"+12.3%","d":"up"},{"l":"AOV (€)","v":"€43870","t":"+4.4%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 37745.11","1.887","2.965","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 48656.29","2.827","6.938","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 36560.00","2.898","6.435","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 34147.47","186","8.075","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 20834.18","5.679","7.541","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":925},{"label":"Fev","value":844},{"label":"Mar","value":880},{"label":"Abr","value":837},{"label":"Mai","value":698},{"label":"Jun","value":884},{"label":"Jul","value":886},{"label":"Ago","value":725},{"label":"Set","value":899},{"label":"Out","value":765},{"label":"Nov","value":892},{"label":"Dez","value":655}];
const MX = 925;
...
export default function PostfirePage() {
    return (
