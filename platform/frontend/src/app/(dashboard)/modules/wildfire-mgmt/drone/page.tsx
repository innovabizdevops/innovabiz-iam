...
const PAGE = "Drone Survey";
const KPIS = [{"l":"Surveys Ativos","v":"7.591","t":"+13.6%","d":"up"},{"l":"Respostas/Semana","v":"1130","t":"+7.6%","d":"up"},{"l":"NPS Médio","v":"91","t":"-1.1%","d":"down"},{"l":"Taxa Resposta (%)","v":"86.6%","t":"-2.8%","d":"down"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","3.777","80","75.7%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","6.812","91","86.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","1.782","73","97.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","6.396","90","80.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","6.698","71","70.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":789},{"label":"Mar","value":729},{"label":"Abr","value":510},{"label":"Mai","value":534},{"label":"Jun","value":651},{"label":"Jul","value":811},{"label":"Ago","value":437},{"label":"Set","value":673},{"label":"Out","value":453},{"label":"Nov","value":532},{"label":"Dez","value":743}];
const MX = 811;
