...
const ACCENT = "#1d4ed8";
const MODULE = "Wildfire Management";
const PAGE = "Detection";
const KPIS = [{"l":"Total Wildfire Mgmt","v":"1.718","t":"+0.4%","d":"up"},{"l":"Detection Ativos","v":"3.878","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"72.8%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"71","t":"+12.3%","d":"up"}];
const COLS = ["ID","Detection","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wildfire Mgmt #001","Wildfire Mgmt #002","4.138","1.681","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Wildfire Mgmt #002","Wildfire Mgmt #003","1.422","6.420","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Wildfire Mgmt #003","Wildfire Mgmt #004","2.897","480","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Wildfire Mgmt #004","Wildfire Mgmt #005","1.719","7.449","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wildfire Mgmt #005","Wildfire Mgmt #001","2.760","1.018","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":484},{"label":"Mar","value":509},{"label":"Abr","value":563},{"label":"Mai","value":628},{"label":"Jun","value":455},{"label":"Jul","value":599},{"label":"Ago","value":658},{"label":"Set","value":413},{"label":"Out","value":560},{"label":"Nov","value":519},{"label":"Dez","value":449}];
const MX = 658;
