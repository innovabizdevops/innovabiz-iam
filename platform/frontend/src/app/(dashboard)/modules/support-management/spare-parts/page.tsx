...
const KPIS = [{"l":"Tickets Abertos","v":"123","t":"+3.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"91.2%","t":"+7.9%","d":"up"},{"l":"MTTR (h)","v":"51h","t":"+11.2%","d":"up"},{"l":"Satisfação (%)","v":"75.4%","t":"+8.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.682","5.512","6.581","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.839","8.972","2.677","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","336","851","1.183","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.395","3.093","8.916","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.515","1.129","4.230","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":473},{"label":"Mar","value":510},{"label":"Abr","value":546},{"label":"Mai","value":707},{"label":"Jun","value":486},{"label":"Jul","value":525},{"label":"Ago","value":556},{"label":"Set","value":455},{"label":"Out","value":667},{"label":"Nov","value":734},{"label":"Dez","value":419}];
const MX = 734;
