...
const ACCENT = "#6366f1";
const MODULE = "Support Management";
const PAGE = "Warranty Management";
const KPIS = [{"l":"Tickets Abertos","v":"4.109","t":"+12.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"78.4%","t":"+11.8%","d":"up"},{"l":"MTTR (h)","v":"11h","t":"-5.0%","d":"down"},{"l":"Satisfação (%)","v":"88.8%","t":"+16.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","750","2.959","6.643","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.954","3.161","1.887","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.465","6.257","684","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.065","3.567","3.562","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.714","135","3.822","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":312},{"label":"Fev","value":370},{"label":"Mar","value":485},{"label":"Abr","value":253},{"label":"Mai","value":522},{"label":"Jun","value":281},{"label":"Jul","value":485},{"label":"Ago","value":598},{"label":"Set","value":482},{"label":"Out","value":607},{"label":"Nov","value":538},{"label":"Dez","value":241}];
const MX = 607;
