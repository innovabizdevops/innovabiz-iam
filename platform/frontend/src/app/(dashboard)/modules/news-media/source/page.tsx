...
const PAGE = "Source";
const KPIS = [{"l":"Integrações Ativas","v":"6.402","t":"+12.4%","d":"up"},{"l":"Chamadas/Hora","v":"898","t":"+3.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"88.5%","t":"-0.5%","d":"down"},{"l":"Latência Média (ms)","v":"183ms","t":"+16.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.267","2.367","72.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","286","2.872","72.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.091","2.534","75.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.706","7.846","73.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.489","3.879","83.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":967},{"label":"Fev","value":911},{"label":"Mar","value":926},{"label":"Abr","value":741},{"label":"Mai","value":580},{"label":"Jun","value":931},{"label":"Jul","value":581},{"label":"Ago","value":878},{"label":"Set","value":821},{"label":"Out","value":579},{"label":"Nov","value":877},{"label":"Dez","value":911}];
const MX = 967;
