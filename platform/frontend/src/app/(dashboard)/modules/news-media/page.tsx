...
/* ═══ News & Media Platform — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "4357", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2669", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€148K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "889935057", cells: ["NEW-7057", "News & Media Platform Item 1", "26/10/2026", "€35 157"], status: "active" as const },
    { id: "889938628", cells: ["NEW-1628", "News & Media Platform Item 2", "13/5/2026", "€38 728"], status: "pending" as const },
    { id: "889942199", cells: ["NEW-5199", "News & Media Platform Item 3", "28/12/2026", "€42 299"], status: "completed" as const },
    { id: "889945770", cells: ["NEW-8770", "News & Media Platform Item 4", "15/7/2026", "€45 870"], status: "warning" as const },
    { id: "889949341", cells: ["NEW-3341", "News & Media Platform Item 5", "2/2/2026", "€49 441"], status: "active" as const },
];
...
export default function NewsMediaPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">News & Media Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • News & Media Platform</p>
                    </div>
                </div>
