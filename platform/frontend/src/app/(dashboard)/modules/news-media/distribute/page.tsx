...
const KPIS = [{"l":"Integrações Ativas","v":"8.675","t":"+2.1%","d":"up"},{"l":"Chamadas/Hora","v":"4603","t":"+4.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"66.6%","t":"+13.6%","d":"up"},{"l":"Latência Média (ms)","v":"138ms","t":"+3.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.374","8.742","87.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.835","8.206","79.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.012","2.609","79.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.950","4.605","86.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.712","7.671","82.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":465},{"label":"Mar","value":664},{"label":"Abr","value":459},{"label":"Mai","value":573},{"label":"Jun","value":713},{"label":"Jul","value":722},{"label":"Ago","value":650},{"label":"Set","value":503},{"label":"Out","value":681},{"label":"Nov","value":559},{"label":"Dez","value":698}];
const MX = 722;
