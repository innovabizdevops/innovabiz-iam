...
const ACCENT = "#6d28d9";
const MODULE = "News & Media Platform";
const PAGE = "Write";
const KPIS = [{"l":"Integrações Ativas","v":"5.258","t":"+13.2%","d":"up"},{"l":"Chamadas/Hora","v":"1270","t":"+7.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"77.5%","t":"+17.3%","d":"up"},{"l":"Latência Média (ms)","v":"24ms","t":"+8.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.255","6.863","91.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.632","3.785","88.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.600","5.554","71.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.603","5.026","74.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.878","2.638","77.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":857},{"label":"Mar","value":793},{"label":"Abr","value":927},{"label":"Mai","value":724},{"label":"Jun","value":863},{"label":"Jul","value":848},{"label":"Ago","value":984},{"label":"Set","value":867},{"label":"Out","value":1020},{"label":"Nov","value":1041},{"label":"Dez","value":938}];
const MX = 1041;
