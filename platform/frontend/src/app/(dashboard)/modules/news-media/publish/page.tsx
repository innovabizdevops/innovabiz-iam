...
const PAGE = "Publish";
const KPIS = [{"l":"Integrações Ativas","v":"128","t":"+11.8%","d":"up"},{"l":"Chamadas/Hora","v":"4221","t":"+14.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"74.5%","t":"+4.5%","d":"up"},{"l":"Latência Média (ms)","v":"167ms","t":"+3.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.117","4.068","70.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.178","7.778","83.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.291","5.545","80.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.258","5.671","81.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.226","3.919","75.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":773},{"label":"Mar","value":771},{"label":"Abr","value":798},{"label":"Mai","value":730},{"label":"Jun","value":588},{"label":"Jul","value":928},{"label":"Ago","value":553},{"label":"Set","value":751},{"label":"Out","value":634},{"label":"Nov","value":678},{"label":"Dez","value":847}];
const MX = 928;
