...
const PAGE = "Edit";
const KPIS = [{"l":"Integrações Ativas","v":"7.135","t":"-2.7%","d":"down"},{"l":"Chamadas/Hora","v":"4066","t":"+1.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"75.1%","t":"+12.0%","d":"up"},{"l":"Latência Média (ms)","v":"53ms","t":"+6.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.440","5.446","76.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.192","2.114","90.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.044","3.295","96.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","221","2.197","91.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","509","4.663","79.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":519},{"label":"Mar","value":740},{"label":"Abr","value":676},{"label":"Mai","value":554},{"label":"Jun","value":701},{"label":"Jul","value":519},{"label":"Ago","value":620},{"label":"Set","value":601},{"label":"Out","value":701},{"label":"Nov","value":568},{"label":"Dez","value":682}];
const MX = 740;
