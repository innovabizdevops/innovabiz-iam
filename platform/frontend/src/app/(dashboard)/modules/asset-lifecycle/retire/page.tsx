...
const PAGE = "Retire";
const KPIS = [{"l":"Ativos Registados","v":"8.483","t":"+13.8%","d":"up"},{"l":"Valor Total (€M)","v":"€25.2M","t":"+6.3%","d":"up"},{"l":"Depreciação Anual (€)","v":"€94210","t":"+6.7%","d":"up"},{"l":"Ativos em Garantia","v":"3.269","t":"-4.4%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 14994.57","3.370","€ 31790.03","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 3708.12","6.150","€ 17223.12","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 32145.16","4.961","€ 30671.75","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 16439.83","2.576","€ 23854.91","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 25901.27","5.191","€ 46837.64","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":501},{"label":"Fev","value":285},{"label":"Mar","value":388},{"label":"Abr","value":437},{"label":"Mai","value":294},{"label":"Jun","value":250},{"label":"Jul","value":251},{"label":"Ago","value":304},{"label":"Set","value":537},{"label":"Out","value":313},{"label":"Nov","value":276},{"label":"Dez","value":339}];
const MX = 537;
