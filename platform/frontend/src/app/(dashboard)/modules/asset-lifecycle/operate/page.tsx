...
const PAGE = "Operate";
const KPIS = [{"l":"Ativos Registados","v":"6.815","t":"+6.9%","d":"up"},{"l":"Valor Total (€M)","v":"€9.4M","t":"-0.4%","d":"down"},{"l":"Depreciação Anual (€)","v":"€60447","t":"+14.5%","d":"up"},{"l":"Ativos em Garantia","v":"6.962","t":"+10.4%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 27676.99","1.529","€ 5453.47","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 43761.78","7.226","€ 48509.32","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 35897.64","1.702","€ 39209.10","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 33296.47","7.429","€ 42724.94","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 11632.10","717","€ 27296.77","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":394},{"label":"Fev","value":549},{"label":"Mar","value":561},{"label":"Abr","value":370},{"label":"Mai","value":575},{"label":"Jun","value":352},{"label":"Jul","value":612},{"label":"Ago","value":697},{"label":"Set","value":471},{"label":"Out","value":471},{"label":"Nov","value":484},{"label":"Dez","value":417}];
const MX = 697;
