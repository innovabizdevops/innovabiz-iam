...
const ACCENT = "#06b6d4";
const MODULE = "Asset Lifecycle E2E";
const PAGE = "Acquire";
const KPIS = [{"l":"Ativos Registados","v":"3.232","t":"-2.2%","d":"down"},{"l":"Valor Total (€M)","v":"€26.8M","t":"-2.4%","d":"down"},{"l":"Depreciação Anual (€)","v":"€70513","t":"+10.6%","d":"up"},{"l":"Ativos em Garantia","v":"4.402","t":"+2.6%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 26376.01","3.636","€ 6618.41","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 6540.98","2.184","€ 39300.48","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 10483.73","4.957","€ 38167.73","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 46313.88","8.170","€ 27438.37","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 44158.51","3.823","€ 16910.88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":940},{"label":"Fev","value":814},{"label":"Mar","value":688},{"label":"Abr","value":721},{"label":"Mai","value":847},{"label":"Jun","value":911},{"label":"Jul","value":824},{"label":"Ago","value":659},{"label":"Set","value":753},{"label":"Out","value":791},{"label":"Nov","value":640},{"label":"Dez","value":639}];
const MX = 940;
