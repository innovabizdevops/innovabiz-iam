...
/* ═══ Asset Lifecycle E2E — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "2108", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2157", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€455K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1976903308", cells: ["ASS-9308", "Asset Lifecycle E2E Item 1", "17/5/2026", "€3408"], status: "active" as const },
    { id: "1976906879", cells: ["ASS-3879", "Asset Lifecycle E2E Item 2", "4/12/2026", "€6979"], status: "pending" as const },
    { id: "1976910450", cells: ["ASS-7450", "Asset Lifecycle E2E Item 3", "19/7/2026", "€10 550"], status: "completed" as const },
    { id: "1976914021", cells: ["ASS-2021", "Asset Lifecycle E2E Item 4", "6/2/2026", "€14 121"], status: "warning" as const },
    { id: "1976917592", cells: ["ASS-5592", "Asset Lifecycle E2E Item 5", "21/9/2026", "€17 692"], status: "active" as const },
];
...
export default function AssetLifecycleE2ePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Asset Lifecycle E2E</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Asset Lifecycle E2E</p>
                    </div>
                </div>
