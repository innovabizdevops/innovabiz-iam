...
const PAGE = "Plan";
const KPIS = [{"l":"Ativos Registados","v":"3.921","t":"+5.9%","d":"up"},{"l":"Valor Total (€M)","v":"€4.4M","t":"+14.9%","d":"up"},{"l":"Depreciação Anual (€)","v":"€68431","t":"-2.5%","d":"down"},{"l":"Ativos em Garantia","v":"7.923","t":"+16.1%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 36498.49","5.193","€ 37215.47","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 17950.82","7.260","€ 34374.72","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 2191.97","8.273","€ 14009.22","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 15459.99","7.282","€ 9110.34","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 48606.40","7.789","€ 38946.49","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":504},{"label":"Fev","value":620},{"label":"Mar","value":678},{"label":"Abr","value":595},{"label":"Mai","value":391},{"label":"Jun","value":350},{"label":"Jul","value":315},{"label":"Ago","value":364},{"label":"Set","value":633},{"label":"Out","value":425},{"label":"Nov","value":397},{"label":"Dez","value":622}];
const MX = 678;
