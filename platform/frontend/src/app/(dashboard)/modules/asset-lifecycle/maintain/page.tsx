...
const PAGE = "Maintain";
const KPIS = [{"l":"Ativos Registados","v":"7.203","t":"-4.1%","d":"down"},{"l":"Valor Total (€M)","v":"€10.5M","t":"+-0.0%","d":"up"},{"l":"Depreciação Anual (€)","v":"€66309","t":"+10.9%","d":"up"},{"l":"Ativos em Garantia","v":"4.950","t":"+10.1%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 46465.91","295","€ 1108.30","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 16288.93","7.252","€ 23175.65","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 15741.96","4.528","€ 44071.47","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 27587.29","3.318","€ 25351.25","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 12424.11","2.600","€ 29503.20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":495},{"label":"Mar","value":673},{"label":"Abr","value":501},{"label":"Mai","value":707},{"label":"Jun","value":387},{"label":"Jul","value":535},{"label":"Ago","value":720},{"label":"Set","value":349},{"label":"Out","value":650},{"label":"Nov","value":354},{"label":"Dez","value":704}];
const MX = 720;
