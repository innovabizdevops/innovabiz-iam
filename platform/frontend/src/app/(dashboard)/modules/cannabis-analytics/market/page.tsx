...
const PAGE = "Market";
const KPIS = [{"l":"Dashboards Ativos","v":"4.156","t":"-0.8%","d":"down"},{"l":"Queries/Dia","v":"335","t":"+16.7%","d":"up"},{"l":"Dados Processados (GB)","v":"6.585","t":"+17.0%","d":"up"},{"l":"Utilizadores Analytics","v":"2.195","t":"+9.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4777","2026-03-04","4.583","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3925","2026-01-06","3.597","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","884","2026-03-04","4.602","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3153","2026-02-02","3.172","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1290","2026-03-18","3.551","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":257},{"label":"Mar","value":375},{"label":"Abr","value":457},{"label":"Mai","value":598},{"label":"Jun","value":407},{"label":"Jul","value":535},{"label":"Ago","value":445},{"label":"Set","value":284},{"label":"Out","value":460},{"label":"Nov","value":483},{"label":"Dez","value":598}];
const MX = 616;
