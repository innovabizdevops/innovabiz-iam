...
const PAGE = "Sales";
const KPIS = [{"l":"Vendas YTD (€)","v":"€15761","t":"+0.6%","d":"up"},{"l":"Pipeline (€)","v":"€36370","t":"+5.2%","d":"up"},{"l":"Atingimento Quota (%)","v":"68.6%","t":"-4.8%","d":"down"},{"l":"Win Rate (%)","v":"91.7%","t":"-0.8%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 44056.73","€ 16946.17","€ 44383.87","79.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 19160.86","€ 14757.48","€ 25327.83","90.5%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 44756.45","€ 28285.38","€ 20390.34","97.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 15552.50","€ 9479.51","€ 8541.01","74.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 36280.87","€ 19001.04","€ 45257.79","72.4%"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":733},{"label":"Mar","value":611},{"label":"Abr","value":798},{"label":"Mai","value":484},{"label":"Jun","value":682},{"label":"Jul","value":494},{"label":"Ago","value":604},{"label":"Set","value":704},{"label":"Out","value":653},{"label":"Nov","value":776},{"label":"Dez","value":493}];
const MX = 809;
