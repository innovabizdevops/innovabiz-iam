...
const ACCENT = "#0d3b1e";
const MODULE = "Cannabis Analytics";
const PAGE = "Strain";
const KPIS = [{"l":"Dashboards Ativos","v":"5.378","t":"+8.9%","d":"up"},{"l":"Queries/Dia","v":"3433","t":"+7.6%","d":"up"},{"l":"Dados Processados (GB)","v":"2.013","t":"-1.0%","d":"down"},{"l":"Utilizadores Analytics","v":"5.566","t":"+14.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5022","2026-03-12","685","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1953","2026-01-08","4.799","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2796","2026-01-13","7.923","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1829","2026-03-02","913","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1089","2026-03-02","1.170","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":975},{"label":"Fev","value":841},{"label":"Mar","value":1049},{"label":"Abr","value":762},{"label":"Mai","value":786},{"label":"Jun","value":971},{"label":"Jul","value":844},{"label":"Ago","value":1036},{"label":"Set","value":792},{"label":"Out","value":829},{"label":"Nov","value":794},{"label":"Dez","value":845}];
const MX = 1049;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0d3b1e'}}>AI</span></h1>
                </div>
