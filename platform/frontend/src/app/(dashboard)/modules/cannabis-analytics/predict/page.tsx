...
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"8.340","t":"+5.6%","d":"up"},{"l":"Queries/Dia","v":"142","t":"-1.2%","d":"down"},{"l":"Dados Processados (GB)","v":"7.918","t":"+17.3%","d":"up"},{"l":"Utilizadores Analytics","v":"4.982","t":"-0.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1054","2026-03-17","4.148","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4205","2026-01-06","3.587","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2687","2026-01-11","5.315","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1506","2026-01-20","8.562","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","694","2026-03-15","3.830","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":961},{"label":"Fev","value":825},{"label":"Mar","value":790},{"label":"Abr","value":1075},{"label":"Mai","value":1038},{"label":"Jun","value":854},{"label":"Jul","value":741},{"label":"Ago","value":911},{"label":"Set","value":818},{"label":"Out","value":1014},{"label":"Nov","value":929},{"label":"Dez","value":794}];
const MX = 1075;
