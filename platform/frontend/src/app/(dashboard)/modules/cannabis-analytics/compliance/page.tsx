...
const KPIS = [{"l":"Auditorias Realizadas","v":"125","t":"+10.5%","d":"up"},{"l":"NC Abertas","v":"2.711","t":"-2.8%","d":"down"},{"l":"Conformidade (%)","v":"94.3%","t":"+12.3%","d":"up"},{"l":"CAPAs Pendentes","v":"5.878","t":"+1.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.654","90.7%","834","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.050","83.1%","1.949","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.643","84.7%","917","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.904","73.1%","9.062","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.138","75.9%","5.443","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":426},{"label":"Mar","value":720},{"label":"Abr","value":766},{"label":"Mai","value":791},{"label":"Jun","value":504},{"label":"Jul","value":507},{"label":"Ago","value":625},{"label":"Set","value":417},{"label":"Out","value":656},{"label":"Nov","value":438},{"label":"Dez","value":662}];
const MX = 791;
