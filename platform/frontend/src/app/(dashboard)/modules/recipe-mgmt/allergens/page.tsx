...
const PAGE = "Allergen Track";
const KPIS = [{"l":"Total Recipe Mgmt","v":"5.403","t":"+3.2%","d":"up"},{"l":"Allergen Track Ativos","v":"3.223","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"73.3%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"80","t":"+10.6%","d":"up"}];
const COLS = ["ID","Allergen Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recipe Mgmt #001","Recipe Mgmt #002","1.461","5.136","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Recipe Mgmt #002","Recipe Mgmt #003","205","8.040","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Recipe Mgmt #003","Recipe Mgmt #004","6.489","8.599","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Recipe Mgmt #004","Recipe Mgmt #005","8.412","4.998","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recipe Mgmt #005","Recipe Mgmt #001","557","7.597","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":769},{"label":"Mar","value":799},{"label":"Abr","value":761},{"label":"Mai","value":789},{"label":"Jun","value":823},{"label":"Jul","value":624},{"label":"Ago","value":564},{"label":"Set","value":557},{"label":"Out","value":803},{"label":"Nov","value":730},{"label":"Dez","value":783}];
const MX = 823;
