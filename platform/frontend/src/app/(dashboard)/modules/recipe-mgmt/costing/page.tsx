...
const ACCENT = "#ec4899";
const MODULE = "Recipe Management";
const PAGE = "Cost per Unit";
const KPIS = [{"l":"Total Recipe Mgmt","v":"3.010","t":"-4.5%","d":"down"},{"l":"Cost Per Unit Ativos","v":"7.408","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"70.4%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"92","t":"+9.2%","d":"up"}];
const COLS = ["ID","Cost Per Unit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recipe Mgmt #001","Recipe Mgmt #002","6.394","3.447","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Recipe Mgmt #002","Recipe Mgmt #003","7.678","6.978","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Recipe Mgmt #003","Recipe Mgmt #004","2.278","2.286","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Recipe Mgmt #004","Recipe Mgmt #005","7.912","2.806","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recipe Mgmt #005","Recipe Mgmt #001","4.977","4.947","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":796},{"label":"Fev","value":785},{"label":"Mar","value":893},{"label":"Abr","value":792},{"label":"Mai","value":870},{"label":"Jun","value":942},{"label":"Jul","value":711},{"label":"Ago","value":772},{"label":"Set","value":766},{"label":"Out","value":832},{"label":"Nov","value":760},{"label":"Dez","value":1011}];
const MX = 1011;
