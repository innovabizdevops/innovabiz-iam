...
const PAGE = "Scaling";
const KPIS = [{"l":"Total Recipe Mgmt","v":"2.685","t":"+10.8%","d":"up"},{"l":"Scaling Ativos","v":"2.804","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"89.9%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"62","t":"-2.1%","d":"down"}];
const COLS = ["ID","Scaling","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recipe Mgmt #001","Recipe Mgmt #002","3.999","3.573","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Recipe Mgmt #002","Recipe Mgmt #003","4.450","3.766","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Recipe Mgmt #003","Recipe Mgmt #004","6.711","3.114","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Recipe Mgmt #004","Recipe Mgmt #005","2.601","2.200","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recipe Mgmt #005","Recipe Mgmt #001","6.206","679","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":370},{"label":"Mar","value":738},{"label":"Abr","value":681},{"label":"Mai","value":413},{"label":"Jun","value":600},{"label":"Jul","value":480},{"label":"Ago","value":367},{"label":"Set","value":542},{"label":"Out","value":537},{"label":"Nov","value":661},{"label":"Dez","value":721}];
const MX = 738;
