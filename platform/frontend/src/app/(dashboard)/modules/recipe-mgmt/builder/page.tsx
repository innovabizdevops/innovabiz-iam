...
const PAGE = "Recipe Builder";
const KPIS = [{"l":"Total Recipe Mgmt","v":"3.965","t":"+1.9%","d":"up"},{"l":"Recipe Builder Ativos","v":"4.314","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"74.6%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"55","t":"+8.1%","d":"up"}];
const COLS = ["ID","Recipe Builder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recipe Mgmt #001","Recipe Mgmt #002","4.568","7.198","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Recipe Mgmt #002","Recipe Mgmt #003","1.856","4.284","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Recipe Mgmt #003","Recipe Mgmt #004","8.545","507","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Recipe Mgmt #004","Recipe Mgmt #005","4.613","8.788","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recipe Mgmt #005","Recipe Mgmt #001","5.682","6.219","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":958},{"label":"Mar","value":675},{"label":"Abr","value":904},{"label":"Mai","value":961},{"label":"Jun","value":974},{"label":"Jul","value":617},{"label":"Ago","value":799},{"label":"Set","value":772},{"label":"Out","value":632},{"label":"Nov","value":810},{"label":"Dez","value":962}];
const MX = 974;
