...
const KPIS = [{"l":"Formulários Ativos","v":"2.861","t":"+3.2%","d":"up"},{"l":"Submissões/Dia","v":"1352","t":"+9.9%","d":"up"},{"l":"Documentos Gerados","v":"5.029","t":"+7.3%","d":"up"},{"l":"Templates","v":"8.764","t":"+2.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.441","2026-01-11","4.994","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.236","2026-02-16","8.207","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.918","2026-02-08","5.052","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.546","2026-03-01","5.564","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.714","2026-03-24","1.716","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":870},{"label":"Fev","value":825},{"label":"Mar","value":570},{"label":"Abr","value":746},{"label":"Mai","value":636},{"label":"Jun","value":699},{"label":"Jul","value":882},{"label":"Ago","value":527},{"label":"Set","value":594},{"label":"Out","value":734},{"label":"Nov","value":679},{"label":"Dez","value":591}];
const MX = 882;
