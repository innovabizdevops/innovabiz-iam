...
const ACCENT = "#6366f1";
const MODULE = "Language School";
const PAGE = "Course";
const KPIS = [{"l":"Total Language School","v":"2.157","t":"-5.4%","d":"down"},{"l":"Course Ativos","v":"5.273","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"78.3%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"92","t":"+4.3%","d":"up"}];
const COLS = ["ID","Course","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Language School #001","Language School #002","6.704","7.959","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Language School #002","Language School #003","3.918","5.420","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Language School #003","Language School #004","2.838","521","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Language School #004","Language School #005","2.180","6.701","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Language School #005","Language School #001","577","7.183","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":658},{"label":"Mar","value":628},{"label":"Abr","value":649},{"label":"Mai","value":537},{"label":"Jun","value":584},{"label":"Jul","value":528},{"label":"Ago","value":501},{"label":"Set","value":322},{"label":"Out","value":614},{"label":"Nov","value":606},{"label":"Dez","value":440}];
const MX = 658;
