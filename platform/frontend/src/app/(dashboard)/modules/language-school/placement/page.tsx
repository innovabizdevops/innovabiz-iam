...
const KPIS = [{"l":"Total Language School","v":"282","t":"-2.0%","d":"down"},{"l":"Placement Ativos","v":"4.147","t":"+8.4%","d":"up"},{"l":"Eficiência (%)","v":"91.7%","t":"+7.2%","d":"up"},{"l":"Score Performance","v":"57","t":"+9.3%","d":"up"}];
const COLS = ["ID","Placement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Language School #001","Language School #002","5.304","5.926","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Language School #002","Language School #003","8.373","8.421","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Language School #003","Language School #004","7.429","7.263","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Language School #004","Language School #005","992","6.697","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Language School #005","Language School #001","2.576","4.015","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":889},{"label":"Fev","value":860},{"label":"Mar","value":831},{"label":"Abr","value":721},{"label":"Mai","value":816},{"label":"Jun","value":996},{"label":"Jul","value":985},{"label":"Ago","value":755},{"label":"Set","value":800},{"label":"Out","value":722},{"label":"Nov","value":713},{"label":"Dez","value":783}];
const MX = 996;
