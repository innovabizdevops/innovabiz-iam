...
const PAGE = "Level";
const KPIS = [{"l":"Total Language School","v":"941","t":"+7.0%","d":"up"},{"l":"Level Ativos","v":"2.014","t":"+14.4%","d":"up"},{"l":"Eficiência (%)","v":"86.0%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"84","t":"-0.4%","d":"down"}];
const COLS = ["ID","Level","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Language School #001","Language School #002","2.380","2.939","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Language School #002","Language School #003","6.391","3.336","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Language School #003","Language School #004","5.275","1.479","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Language School #004","Language School #005","1.414","6.886","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Language School #005","Language School #001","2.910","822","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":665},{"label":"Mar","value":757},{"label":"Abr","value":734},{"label":"Mai","value":711},{"label":"Jun","value":521},{"label":"Jul","value":510},{"label":"Ago","value":467},{"label":"Set","value":556},{"label":"Out","value":638},{"label":"Nov","value":615},{"label":"Dez","value":654}];
const MX = 757;
