...
const KPIS = [{"l":"Total Language School","v":"1.838","t":"-4.7%","d":"down"},{"l":"Certification Ativos","v":"1.537","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"74.6%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"68","t":"+10.2%","d":"up"}];
const COLS = ["ID","Certification","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Language School #001","Language School #002","1.278","2.643","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Language School #002","Language School #003","589","4.448","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Language School #003","Language School #004","1.584","8.433","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Language School #004","Language School #005","380","6.306","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Language School #005","Language School #001","8.208","8.399","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":440},{"label":"Fev","value":441},{"label":"Mar","value":435},{"label":"Abr","value":759},{"label":"Mai","value":695},{"label":"Jun","value":599},{"label":"Jul","value":730},{"label":"Ago","value":469},{"label":"Set","value":660},{"label":"Out","value":386},{"label":"Nov","value":509},{"label":"Dez","value":698}];
const MX = 759;
