...
const PAGE = "Test";
const KPIS = [{"l":"Total Language School","v":"4.082","t":"+7.4%","d":"up"},{"l":"Test Ativos","v":"788","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"80.8%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"60","t":"+4.2%","d":"up"}];
const COLS = ["ID","Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Language School #001","Language School #002","8.388","6.268","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Language School #002","Language School #003","2.346","5.138","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Language School #003","Language School #004","5.542","1.056","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Language School #004","Language School #005","5.608","938","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Language School #005","Language School #001","3.380","4.210","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":401},{"label":"Mar","value":477},{"label":"Abr","value":607},{"label":"Mai","value":641},{"label":"Jun","value":504},{"label":"Jul","value":509},{"label":"Ago","value":372},{"label":"Set","value":411},{"label":"Out","value":388},{"label":"Nov","value":612},{"label":"Dez","value":440}];
const MX = 641;
