...
const PAGE = "Quality Test";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.966","t":"+0.1%","d":"up"},{"l":"NC Abertas","v":"7.375","t":"+17.2%","d":"up"},{"l":"Conformidade (%)","v":"74.0%","t":"+10.6%","d":"up"},{"l":"CAPAs Pendentes","v":"525","t":"+8.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.147","86.8%","9.097","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","263","83.2%","3.067","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.722","93.7%","5.647","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.771","88.3%","4.429","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.252","86.4%","7.615","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":483},{"label":"Mar","value":444},{"label":"Abr","value":700},{"label":"Mai","value":428},{"label":"Jun","value":565},{"label":"Jul","value":437},{"label":"Ago","value":341},{"label":"Set","value":394},{"label":"Out","value":598},{"label":"Nov","value":499},{"label":"Dez","value":376}];
const MX = 700;
