...
export default function SmartWaterCityPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Smart Water City</h1><p className="text-sm text-muted-foreground">Smart Water City • iBOS Enterprise</p></div>
