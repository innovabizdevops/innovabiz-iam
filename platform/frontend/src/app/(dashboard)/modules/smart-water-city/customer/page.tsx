...
const PAGE = "Customer";
const KPIS = [{"l":"Total Smart Water City","v":"1.126","t":"+15.8%","d":"up"},{"l":"Customer Ativos","v":"€44732","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"82.6%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"64","t":"-5.5%","d":"down"}];
const COLS = ["ID","Customer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Smart Water City #001","€ 12234.17","1.439","1.979","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Smart Water City #002","€ 34948.34","2.434","8.962","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Water City #003","€ 31448.71","4.428","1.476","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Smart Water City #004","€ 22270.22","599","6.205","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Smart Water City #005","€ 30940.05","2.577","1.728","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":442},{"label":"Fev","value":416},{"label":"Mar","value":796},{"label":"Abr","value":663},{"label":"Mai","value":545},{"label":"Jun","value":410},{"label":"Jul","value":570},{"label":"Ago","value":743},{"label":"Set","value":581},{"label":"Out","value":513},{"label":"Nov","value":752},{"label":"Dez","value":740}];
const MX = 796;
