...
const ACCENT = "#4338ca";
const MODULE = "Smart Water City";
const PAGE = "Pipe Monitor";
const KPIS = [{"l":"Total Smart Water City","v":"2.217","t":"+17.5%","d":"up"},{"l":"Pipe Monitor Ativos","v":"1.534","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"66.5%","t":"+1.5%","d":"up"},{"l":"Score Performance","v":"89","t":"+3.3%","d":"up"}];
const COLS = ["ID","Pipe Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Smart Water City #001","Smart Water City #002","8.765","7.459","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Smart Water City #002","Smart Water City #003","4.857","5.708","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Water City #003","Smart Water City #004","6.508","3.840","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Smart Water City #004","Smart Water City #005","3.574","4.218","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Smart Water City #005","Smart Water City #001","1.161","3.854","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":725},{"label":"Mar","value":743},{"label":"Abr","value":720},{"label":"Mai","value":585},{"label":"Jun","value":619},{"label":"Jul","value":595},{"label":"Ago","value":846},{"label":"Set","value":570},{"label":"Out","value":648},{"label":"Nov","value":540},{"label":"Dez","value":663}];
const MX = 846;
