...
/* ═══ SCM Cloud (Oracle) — Dashboard ═══ */

const ACCENT = "#c74634";

const KPIS = [
    { label: "Total Registos", value: "975", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4637", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€368K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1326521675", cells: ["ORA-3675", "SCM Cloud (Oracle) Item 1", "4/12/2026", "€21 775"], status: "active" as const },
    { id: "1326525246", cells: ["ORA-7246", "SCM Cloud (Oracle) Item 2", "19/7/2026", "€25 346"], status: "pending" as const },
    { id: "1326528817", cells: ["ORA-1817", "SCM Cloud (Oracle) Item 3", "6/2/2026", "€28 917"], status: "completed" as const },
    { id: "1326532388", cells: ["ORA-5388", "SCM Cloud (Oracle) Item 4", "21/9/2026", "€32 488"], status: "warning" as const },
    { id: "1326535959", cells: ["ORA-8959", "SCM Cloud (Oracle) Item 5", "8/4/2026", "€36 059"], status: "active" as const },
];
...
export default function ScmCloudOraclePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SCM Cloud (Oracle)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SCM Cloud (Oracle)</p>
                    </div>
                </div>
