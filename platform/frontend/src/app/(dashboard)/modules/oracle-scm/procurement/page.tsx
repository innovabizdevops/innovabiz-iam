...
const KPIS = [{"l":"Fornecedores Ativos","v":"466","t":"-4.9%","d":"down"},{"l":"Contratos (€M)","v":"€27.8M","t":"-3.7%","d":"down"},{"l":"On-Time Delivery (%)","v":"76.0%","t":"-4.7%","d":"down"},{"l":"Score Médio","v":"63","t":"-1.2%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","72.0%","€ 45201.35","6.887","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","72.2%","€ 18462.05","3.804","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","76.1%","€ 42183.45","6.865","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","80.4%","€ 37576.36","1.905","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","80.5%","€ 31019.66","949","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":486},{"label":"Fev","value":716},{"label":"Mar","value":534},{"label":"Abr","value":420},{"label":"Mai","value":546},{"label":"Jun","value":369},{"label":"Jul","value":738},{"label":"Ago","value":414},{"label":"Set","value":649},{"label":"Out","value":564},{"label":"Nov","value":662},{"label":"Dez","value":609}];
const MX = 738;
