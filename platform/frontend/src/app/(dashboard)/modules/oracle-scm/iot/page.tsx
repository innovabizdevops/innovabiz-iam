...
const PAGE = "IoT";
const KPIS = [{"l":"Dispositivos Online","v":"2.845","t":"+7.9%","d":"up"},{"l":"Dados/Min (MB)","v":"6.373","t":"+8.1%","d":"up"},{"l":"Alertas Ativos","v":"6.456","t":"+16.3%","d":"up"},{"l":"Uptime (%)","v":"86.8%","t":"+9.2%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.105","6.224","7.714","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.578","2.587","2.728","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.011","4.392","2.089","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.704","7.609","3.260","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.631","8.117","5.481","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":406},{"label":"Mar","value":694},{"label":"Abr","value":667},{"label":"Mai","value":477},{"label":"Jun","value":422},{"label":"Jul","value":570},{"label":"Ago","value":676},{"label":"Set","value":390},{"label":"Out","value":728},{"label":"Nov","value":405},{"label":"Dez","value":500}];
const MX = 728;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#c74634'}}>IoT</span></h1>
                </div>
