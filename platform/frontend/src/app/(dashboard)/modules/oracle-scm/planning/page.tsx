...
const ACCENT = "#c74634";
const MODULE = "SCM Cloud (Oracle)";
const PAGE = "Planning";
const KPIS = [{"l":"Total Oracle Scm","v":"5.746","t":"+0.1%","d":"up"},{"l":"Planning Ativos","v":"7.553","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"80.4%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"68","t":"+9.5%","d":"up"}];
const COLS = ["ID","Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oracle Scm #001","Oracle Scm #002","2.762","8.806","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Oracle Scm #002","Oracle Scm #003","1.792","3.277","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Oracle Scm #003","Oracle Scm #004","4.630","7.220","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Scm #004","Oracle Scm #005","7.000","8.669","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oracle Scm #005","Oracle Scm #001","6.300","8.100","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":577},{"label":"Mar","value":760},{"label":"Abr","value":633},{"label":"Mai","value":748},{"label":"Jun","value":840},{"label":"Jul","value":835},{"label":"Ago","value":934},{"label":"Set","value":710},{"label":"Out","value":856},{"label":"Nov","value":701},{"label":"Dez","value":962}];
const MX = 962;
