...
const ACCENT = "#6366f1";
const MODULE = "Nutritionist Platform";
const PAGE = "Meal Plan";
const KPIS = [{"l":"Total Nutritionist","v":"4.604","t":"+14.8%","d":"up"},{"l":"Meal Plan Ativos","v":"4.749","t":"+6.6%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+1.4%","d":"up"},{"l":"Score Performance","v":"94","t":"+0.4%","d":"up"}];
const COLS = ["ID","Meal Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nutritionist #001","Nutritionist #002","650","3.663","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Nutritionist #002","Nutritionist #003","4.303","4.920","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Nutritionist #003","Nutritionist #004","5.328","6.338","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Nutritionist #004","Nutritionist #005","3.836","1.728","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nutritionist #005","Nutritionist #001","8.062","4.717","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":639},{"label":"Mar","value":599},{"label":"Abr","value":838},{"label":"Mai","value":868},{"label":"Jun","value":517},{"label":"Jul","value":808},{"label":"Ago","value":632},{"label":"Set","value":659},{"label":"Out","value":618},{"label":"Nov","value":718},{"label":"Dez","value":579}];
const MX = 868;
