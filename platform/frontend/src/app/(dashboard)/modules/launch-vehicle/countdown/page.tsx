...
const KPIS = [{"l":"Total Launch Vehicle","v":"2.527","t":"-5.3%","d":"down"},{"l":"Countdown Ativos","v":"245","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"92.6%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"63","t":"+10.3%","d":"up"}];
const COLS = ["ID","Countdown","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Launch Vehicle #001","Launch Vehicle #002","2.970","4.257","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Launch Vehicle #002","Launch Vehicle #003","2.629","7.499","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Launch Vehicle #003","Launch Vehicle #004","4.711","4.150","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Launch Vehicle #004","Launch Vehicle #005","8.766","6.369","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Launch Vehicle #005","Launch Vehicle #001","1.827","5.758","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":665},{"label":"Mar","value":833},{"label":"Abr","value":839},{"label":"Mai","value":693},{"label":"Jun","value":827},{"label":"Jul","value":575},{"label":"Ago","value":881},{"label":"Set","value":830},{"label":"Out","value":815},{"label":"Nov","value":819},{"label":"Dez","value":912}];
const MX = 912;
