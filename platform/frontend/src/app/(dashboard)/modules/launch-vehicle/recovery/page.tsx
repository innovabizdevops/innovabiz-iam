...
const PAGE = "Recovery";
const KPIS = [{"l":"BCP Plans Ativos","v":"4.461","t":"+12.0%","d":"up"},{"l":"RTO Médio (h)","v":"44h","t":"+7.3%","d":"up"},{"l":"RPO Médio (h)","v":"75h","t":"+9.7%","d":"up"},{"l":"Testes DR (YTD)","v":"3.278","t":"-3.2%","d":"down"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","113h","180h","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","97h","135h","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","157h","123h","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","79h","140h","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","178h","22h","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":550},{"label":"Fev","value":687},{"label":"Mar","value":737},{"label":"Abr","value":668},{"label":"Mai","value":559},{"label":"Jun","value":788},{"label":"Jul","value":691},{"label":"Ago","value":773},{"label":"Set","value":502},{"label":"Out","value":837},{"label":"Nov","value":853},{"label":"Dez","value":510}];
const MX = 853;
