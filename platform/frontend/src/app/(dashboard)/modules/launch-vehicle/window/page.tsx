...
const KPIS = [{"l":"Total Launch Vehicle","v":"3.971","t":"+13.8%","d":"up"},{"l":"Launch Window Ativos","v":"7.084","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"86.1%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"66","t":"+16.0%","d":"up"}];
const COLS = ["ID","Launch Window","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Launch Vehicle #001","Launch Vehicle #002","1.611","8.577","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Launch Vehicle #002","Launch Vehicle #003","8.982","6.573","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Launch Vehicle #003","Launch Vehicle #004","2.816","8.896","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Launch Vehicle #004","Launch Vehicle #005","8.744","393","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Launch Vehicle #005","Launch Vehicle #001","966","3.383","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":445},{"label":"Mar","value":441},{"label":"Abr","value":487},{"label":"Mai","value":422},{"label":"Jun","value":441},{"label":"Jul","value":358},{"label":"Ago","value":635},{"label":"Set","value":404},{"label":"Out","value":610},{"label":"Nov","value":386},{"label":"Dez","value":573}];
const MX = 635;
