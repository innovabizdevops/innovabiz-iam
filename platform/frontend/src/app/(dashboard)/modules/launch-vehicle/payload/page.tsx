...
const ACCENT = "#b45309";
const MODULE = "Launch Vehicle Mgmt";
const PAGE = "Payload Integ";
const KPIS = [{"l":"Total Launch Vehicle","v":"8.256","t":"-2.5%","d":"down"},{"l":"Payload Integ Ativos","v":"5.155","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"70.4%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"68","t":"+14.7%","d":"up"}];
const COLS = ["ID","Payload Integ","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Launch Vehicle #001","Launch Vehicle #002","6.188","8.585","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Launch Vehicle #002","Launch Vehicle #003","1.453","5.419","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Launch Vehicle #003","Launch Vehicle #004","407","3.041","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Launch Vehicle #004","Launch Vehicle #005","1.754","6.553","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Launch Vehicle #005","Launch Vehicle #001","4.587","7.344","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":261},{"label":"Mar","value":454},{"label":"Abr","value":355},{"label":"Mai","value":639},{"label":"Jun","value":570},{"label":"Jul","value":648},{"label":"Ago","value":276},{"label":"Set","value":371},{"label":"Out","value":610},{"label":"Nov","value":595},{"label":"Dez","value":614}];
const MX = 653;
