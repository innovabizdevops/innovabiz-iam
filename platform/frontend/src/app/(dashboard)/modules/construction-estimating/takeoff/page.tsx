...
const ACCENT = "#78350f";
const MODULE = "Construction Estimating";
const PAGE = "Takeoff";
const KPIS = [{"l":"Total Construction Estimating","v":"6.077","t":"+2.7%","d":"up"},{"l":"Takeoff Ativos","v":"7.697","t":"+4.9%","d":"up"},{"l":"Eficiência (%)","v":"91.4%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"63","t":"+0.2%","d":"up"}];
const COLS = ["ID","Takeoff","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Construction Estimating #001","Construction Estimating #002","3.856","1.920","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Construction Estimating #002","Construction Estimating #003","5.385","6.489","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Construction Estimating #003","Construction Estimating #004","8.866","4.737","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Construction Estimating #004","Construction Estimating #005","1.329","1.207","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Construction Estimating #005","Construction Estimating #001","8.968","2.721","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":469},{"label":"Mar","value":387},{"label":"Abr","value":545},{"label":"Mai","value":589},{"label":"Jun","value":686},{"label":"Jul","value":660},{"label":"Ago","value":751},{"label":"Set","value":444},{"label":"Out","value":698},{"label":"Nov","value":516},{"label":"Dez","value":424}];
const MX = 751;
