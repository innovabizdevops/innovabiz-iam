...
const PAGE = "Template";
const KPIS = [{"l":"Formulários Ativos","v":"5.906","t":"+15.0%","d":"up"},{"l":"Submissões/Dia","v":"1222","t":"+12.0%","d":"up"},{"l":"Documentos Gerados","v":"6.290","t":"+4.7%","d":"up"},{"l":"Templates","v":"6.591","t":"-5.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.060","2026-03-26","3.804","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","740","2026-01-18","1.213","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.349","2026-02-06","3.342","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","9.003","2026-01-08","7.334","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","834","2026-03-21","2.154","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":872},{"label":"Mar","value":711},{"label":"Abr","value":606},{"label":"Mai","value":627},{"label":"Jun","value":884},{"label":"Jul","value":646},{"label":"Ago","value":777},{"label":"Set","value":701},{"label":"Out","value":681},{"label":"Nov","value":863},{"label":"Dez","value":725}];
const MX = 884;
