...
const PAGE = "Bid";
const KPIS = [{"l":"Fornecedores Ativos","v":"2.531","t":"+18.0%","d":"up"},{"l":"Contratos (€M)","v":"€37.9M","t":"+3.0%","d":"up"},{"l":"On-Time Delivery (%)","v":"92.5%","t":"+1.7%","d":"up"},{"l":"Score Médio","v":"71","t":"+7.3%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","86.4%","€ 10068.90","3.443","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","97.7%","€ 27896.69","6.356","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","95.9%","€ 24578.30","5.684","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","94.7%","€ 37639.54","8.317","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","78.9%","€ 49920.52","5.509","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":930},{"label":"Mar","value":625},{"label":"Abr","value":617},{"label":"Mai","value":625},{"label":"Jun","value":705},{"label":"Jul","value":596},{"label":"Ago","value":641},{"label":"Set","value":687},{"label":"Out","value":688},{"label":"Nov","value":797},{"label":"Dez","value":739}];
const MX = 930;
