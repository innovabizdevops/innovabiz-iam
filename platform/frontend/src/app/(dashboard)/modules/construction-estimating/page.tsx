...
const KPIS = [
    { label: "Total Registos", value: "240", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1727", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€472K", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "476635640", cells: ["CON-5640", "Construction Estimating Item 1", "13/9/2026", "€35 740"], status: "active" as const },
    { id: "476639211", cells: ["CON-9211", "Construction Estimating Item 2", "28/4/2026", "€39 311"], status: "pending" as const },
    { id: "476642782", cells: ["CON-3782", "Construction Estimating Item 3", "15/11/2026", "€42 882"], status: "completed" as const },
    { id: "476646353", cells: ["CON-7353", "Construction Estimating Item 4", "2/6/2026", "€46 453"], status: "warning" as const },
    { id: "476649924", cells: ["CON-1924", "Construction Estimating Item 5", "17/1/2026", "€50 024"], status: "active" as const },
];
...
export default function ConstructionEstimatingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Construction Estimating</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Construction Estimating</p>
                    </div>
                </div>
