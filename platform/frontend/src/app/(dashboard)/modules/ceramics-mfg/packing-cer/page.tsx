...
/* ═══ Ceramics Manufacturing — Packing Cer ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "2242", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "270", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3373", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "676362250", cells: ["CER-4250", "Packing Cer Item 1", "19/11/2026", "€12 350"], status: "active" as const },
    { id: "676365821", cells: ["CER-7821", "Packing Cer Item 2", "6/6/2026", "€15 921"], status: "pending" as const },
    { id: "676369392", cells: ["CER-2392", "Packing Cer Item 3", "21/1/2026", "€19 492"], status: "completed" as const },
    { id: "676372963", cells: ["CER-5963", "Packing Cer Item 4", "8/8/2026", "€23 063"], status: "warning" as const },
    { id: "676376534", cells: ["CER-9534", "Packing Cer Item 5", "23/3/2026", "€26 634"], status: "active" as const },
];
...
export default function CeramicsManufacturingPackingCerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Packing Cer</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Ceramics Manufacturing • Packing Cer</p>
                    </div>
                </div>
