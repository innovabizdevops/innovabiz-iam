...
/* ═══ Ceramics Manufacturing — Decoration ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "4506", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "291", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3480", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1717239103", cells: ["CER-4103", "Decoration Item 1", "28/8/2026", "€39 203"], status: "active" as const },
    { id: "1717242674", cells: ["CER-7674", "Decoration Item 2", "15/3/2026", "€42 774"], status: "pending" as const },
    { id: "1717246245", cells: ["CER-2245", "Decoration Item 3", "2/10/2026", "€46 345"], status: "completed" as const },
    { id: "1717249816", cells: ["CER-5816", "Decoration Item 4", "17/5/2026", "€49 916"], status: "warning" as const },
    { id: "1717253387", cells: ["CER-9387", "Decoration Item 5", "4/12/2026", "€3487"], status: "active" as const },
];
...
export default function CeramicsManufacturingDecorationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Decoration</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Ceramics Manufacturing • Decoration</p>
                    </div>
                </div>
