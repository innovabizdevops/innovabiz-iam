...
/* ═══ Ceramics Manufacturing — Sorting Grade ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "161", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "184", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1660", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "578010324", cells: ["CER-4324", "Sorting Grade Item 1", "25/1/2026", "€10 424"], status: "active" as const },
    { id: "578013895", cells: ["CER-7895", "Sorting Grade Item 2", "12/8/2026", "€13 995"], status: "pending" as const },
    { id: "578017466", cells: ["CER-2466", "Sorting Grade Item 3", "27/3/2026", "€17 566"], status: "completed" as const },
    { id: "578021037", cells: ["CER-6037", "Sorting Grade Item 4", "14/10/2026", "€21 137"], status: "warning" as const },
    { id: "578024608", cells: ["CER-9608", "Sorting Grade Item 5", "1/5/2026", "€24 708"], status: "active" as const },
];
...
export default function CeramicsManufacturingSortingGradePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sorting Grade</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Ceramics Manufacturing • Sorting Grade</p>
                    </div>
                </div>
