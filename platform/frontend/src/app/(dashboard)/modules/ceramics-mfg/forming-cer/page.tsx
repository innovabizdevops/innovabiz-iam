...
/* ═══ Ceramics Manufacturing — Forming Cer ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "4548", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "355", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "781", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "858425087", cells: ["CER-6087", "Forming Cer Item 1", "24/12/2026", "€25 187"], status: "active" as const },
    { id: "858428658", cells: ["CER-9658", "Forming Cer Item 2", "11/7/2026", "€28 758"], status: "pending" as const },
    { id: "858432229", cells: ["CER-4229", "Forming Cer Item 3", "26/2/2026", "€32 329"], status: "completed" as const },
    { id: "858435800", cells: ["CER-7800", "Forming Cer Item 4", "13/9/2026", "€35 900"], status: "warning" as const },
    { id: "858439371", cells: ["CER-2371", "Forming Cer Item 5", "28/4/2026", "€39 471"], status: "active" as const },
];
...
export default function CeramicsManufacturingFormingCerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Forming Cer</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Ceramics Manufacturing • Forming Cer</p>
                    </div>
                </div>
