...
/* ═══ Ceramics Manufacturing — Body Prep ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "4246", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "16", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1258", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1552412572", cells: ["CER-3572", "Body Prep Item 1", "5/5/2026", "€12 672"], status: "active" as const },
    { id: "1552416143", cells: ["CER-7143", "Body Prep Item 2", "20/12/2026", "€16 243"], status: "pending" as const },
    { id: "1552419714", cells: ["CER-1714", "Body Prep Item 3", "7/7/2026", "€19 814"], status: "completed" as const },
    { id: "1552423285", cells: ["CER-5285", "Body Prep Item 4", "22/2/2026", "€23 385"], status: "warning" as const },
    { id: "1552426856", cells: ["CER-8856", "Body Prep Item 5", "9/9/2026", "€26 956"], status: "active" as const },
];
...
export default function CeramicsManufacturingBodyPrepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Body Prep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Ceramics Manufacturing • Body Prep</p>
                    </div>
                </div>
