...
/* ═══ Ceramics Manufacturing — Drying Kiln ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "1603", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "398", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1699", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1297128698", cells: ["CER-4698", "Drying Kiln Item 1", "27/3/2026", "€28 798"], status: "active" as const },
    { id: "1297132269", cells: ["CER-8269", "Drying Kiln Item 2", "14/10/2026", "€32 369"], status: "pending" as const },
    { id: "1297135840", cells: ["CER-2840", "Drying Kiln Item 3", "1/5/2026", "€35 940"], status: "completed" as const },
    { id: "1297139411", cells: ["CER-6411", "Drying Kiln Item 4", "16/12/2026", "€39 511"], status: "warning" as const },
    { id: "1297142982", cells: ["CER-9982", "Drying Kiln Item 5", "3/7/2026", "€43 082"], status: "active" as const },
];
...
export default function CeramicsManufacturingDryingKilnPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Drying Kiln</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Ceramics Manufacturing • Drying Kiln</p>
                    </div>
                </div>
