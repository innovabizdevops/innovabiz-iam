...
/* ═══ Ceramics Manufacturing — Raw Material Cer ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "3765", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "342", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2773", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "99%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1368369122", cells: ["CER-1122", "Raw Material Cer Item 1", "23/3/2026", "€19 222"], status: "active" as const },
    { id: "1368372693", cells: ["CER-4693", "Raw Material Cer Item 2", "10/10/2026", "€22 793"], status: "pending" as const },
    { id: "1368376264", cells: ["CER-8264", "Raw Material Cer Item 3", "25/5/2026", "€26 364"], status: "completed" as const },
    { id: "1368379835", cells: ["CER-2835", "Raw Material Cer Item 4", "12/12/2026", "€29 935"], status: "warning" as const },
    { id: "1368383406", cells: ["CER-6406", "Raw Material Cer Item 5", "27/7/2026", "€33 506"], status: "active" as const },
];
...
export default function CeramicsManufacturingRawMaterialCerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Raw Material Cer</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Ceramics Manufacturing • Raw Material Cer</p>
                    </div>
                </div>
