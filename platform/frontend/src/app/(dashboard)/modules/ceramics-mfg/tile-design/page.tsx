...
/* ═══ Ceramics Manufacturing — Tile Design ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "4231", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "99", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1326", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2012786463", cells: ["CER-9463", "Tile Design Item 1", "24/4/2026", "€36 563"], status: "active" as const },
    { id: "2012790034", cells: ["CER-4034", "Tile Design Item 2", "11/11/2026", "€40 134"], status: "pending" as const },
    { id: "2012793605", cells: ["CER-7605", "Tile Design Item 3", "26/6/2026", "€43 705"], status: "completed" as const },
    { id: "2012797176", cells: ["CER-2176", "Tile Design Item 4", "13/1/2026", "€47 276"], status: "warning" as const },
    { id: "2012800747", cells: ["CER-5747", "Tile Design Item 5", "28/8/2026", "€847"], status: "active" as const },
];
...
export default function CeramicsManufacturingTileDesignPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tile Design</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Ceramics Manufacturing • Tile Design</p>
                    </div>
                </div>
