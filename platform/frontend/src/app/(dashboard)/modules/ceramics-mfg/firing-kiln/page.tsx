...
/* ═══ Ceramics Manufacturing — Firing Kiln ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "487", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "182", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "829", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "760873122", cells: ["CER-5122", "Firing Kiln Item 1", "3/7/2026", "€23 222"], status: "active" as const },
    { id: "760876693", cells: ["CER-8693", "Firing Kiln Item 2", "18/2/2026", "€26 793"], status: "pending" as const },
    { id: "760880264", cells: ["CER-3264", "Firing Kiln Item 3", "5/9/2026", "€30 364"], status: "completed" as const },
    { id: "760883835", cells: ["CER-6835", "Firing Kiln Item 4", "20/4/2026", "€33 935"], status: "warning" as const },
    { id: "760887406", cells: ["CER-1406", "Firing Kiln Item 5", "7/11/2026", "€37 506"], status: "active" as const },
];
...
export default function CeramicsManufacturingFiringKilnPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Firing Kiln</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Ceramics Manufacturing • Firing Kiln</p>
                    </div>
                </div>
