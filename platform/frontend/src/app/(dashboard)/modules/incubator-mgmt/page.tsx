...
/* ═══ Business Incubator — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "7184", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1076", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€215K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "206639884", cells: ["INC-9884", "Business Incubator Item 1", "25/5/2026", "€39 984"], status: "active" as const },
    { id: "206643455", cells: ["INC-4455", "Business Incubator Item 2", "12/12/2026", "€43 555"], status: "pending" as const },
    { id: "206647026", cells: ["INC-8026", "Business Incubator Item 3", "27/7/2026", "€47 126"], status: "completed" as const },
    { id: "206650597", cells: ["INC-2597", "Business Incubator Item 4", "14/2/2026", "€697"], status: "warning" as const },
    { id: "206654168", cells: ["INC-6168", "Business Incubator Item 5", "1/9/2026", "€4268"], status: "active" as const },
];
...
export default function BusinessIncubatorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Business Incubator</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Business Incubator</p>
                    </div>
                </div>
