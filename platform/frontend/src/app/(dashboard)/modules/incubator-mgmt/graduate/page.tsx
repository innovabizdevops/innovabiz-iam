...
const ACCENT = "#4f46e5";
const MODULE = "Business Incubator";
const PAGE = "Graduate";
const KPIS = [{"l":"Total Incubator Mgmt","v":"8.619","t":"-1.4%","d":"down"},{"l":"Graduate Ativos","v":"2.729","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"94.0%","t":"+13.9%","d":"up"},{"l":"Score Performance","v":"70","t":"+7.5%","d":"up"}];
const COLS = ["ID","Graduate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Incubator Mgmt #001","Incubator Mgmt #002","307","7.366","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Incubator Mgmt #002","Incubator Mgmt #003","5.185","3.818","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Incubator Mgmt #003","Incubator Mgmt #004","1.569","4.340","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Incubator Mgmt #004","Incubator Mgmt #005","7.339","5.896","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incubator Mgmt #005","Incubator Mgmt #001","2.128","4.934","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":246},{"label":"Fev","value":435},{"label":"Mar","value":618},{"label":"Abr","value":304},{"label":"Mai","value":418},{"label":"Jun","value":276},{"label":"Jul","value":546},{"label":"Ago","value":394},{"label":"Set","value":497},{"label":"Out","value":414},{"label":"Nov","value":285},{"label":"Dez","value":265}];
const MX = 618;
