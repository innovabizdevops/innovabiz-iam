...
const PAGE = "Pack";
const KPIS = [{"l":"Total Dangerous Goods","v":"2.329","t":"+17.5%","d":"up"},{"l":"Pack Ativos","v":"2.443","t":"+1.8%","d":"up"},{"l":"Eficiência (%)","v":"75.8%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"92","t":"+10.9%","d":"up"}];
const COLS = ["ID","Pack","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dangerous Goods #001","Dangerous Goods #002","3.585","1.034","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Dangerous Goods #002","Dangerous Goods #003","8.739","6.469","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Dangerous Goods #003","Dangerous Goods #004","5.940","541","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Dangerous Goods #004","Dangerous Goods #005","6.297","8.477","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dangerous Goods #005","Dangerous Goods #001","7.965","4.561","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":862},{"label":"Fev","value":713},{"label":"Mar","value":768},{"label":"Abr","value":748},{"label":"Mai","value":651},{"label":"Jun","value":805},{"label":"Jul","value":844},{"label":"Ago","value":611},{"label":"Set","value":850},{"label":"Out","value":856},{"label":"Nov","value":900},{"label":"Dez","value":803}];
const MX = 900;
