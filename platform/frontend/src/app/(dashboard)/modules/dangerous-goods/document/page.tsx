...
const PAGE = "Document";
const KPIS = [{"l":"Formulários Ativos","v":"873","t":"+12.5%","d":"up"},{"l":"Submissões/Dia","v":"3397","t":"+2.8%","d":"up"},{"l":"Documentos Gerados","v":"8.701","t":"+16.2%","d":"up"},{"l":"Templates","v":"3.433","t":"-5.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.807","2026-02-13","6.789","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.623","2026-01-07","9.063","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.123","2026-03-17","6.870","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.853","2026-03-02","1.110","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.045","2026-03-20","8.187","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":622},{"label":"Mar","value":512},{"label":"Abr","value":608},{"label":"Mai","value":560},{"label":"Jun","value":528},{"label":"Jul","value":850},{"label":"Ago","value":748},{"label":"Set","value":860},{"label":"Out","value":655},{"label":"Nov","value":557},{"label":"Dez","value":808}];
const MX = 860;
