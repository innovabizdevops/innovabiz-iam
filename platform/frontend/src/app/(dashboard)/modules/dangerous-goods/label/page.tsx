...
const PAGE = "Label";
const KPIS = [{"l":"Total Dangerous Goods","v":"7.988","t":"+14.9%","d":"up"},{"l":"Label Ativos","v":"1.900","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"87.5%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"78","t":"+4.2%","d":"up"}];
const COLS = ["ID","Label","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dangerous Goods #001","Dangerous Goods #002","8.758","3.946","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Dangerous Goods #002","Dangerous Goods #003","3.518","8.038","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Dangerous Goods #003","Dangerous Goods #004","3.289","8.882","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Dangerous Goods #004","Dangerous Goods #005","5.174","4.049","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dangerous Goods #005","Dangerous Goods #001","7.435","8.263","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":511},{"label":"Mar","value":343},{"label":"Abr","value":512},{"label":"Mai","value":407},{"label":"Jun","value":326},{"label":"Jul","value":640},{"label":"Ago","value":337},{"label":"Set","value":295},{"label":"Out","value":414},{"label":"Nov","value":480},{"label":"Dez","value":539}];
const MX = 640;
