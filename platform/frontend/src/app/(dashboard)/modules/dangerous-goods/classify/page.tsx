...
const ACCENT = "#6366f1";
const MODULE = "Dangerous Goods";
const PAGE = "Classify";
const KPIS = [{"l":"Total Dangerous Goods","v":"5.154","t":"-2.4%","d":"down"},{"l":"Classify Ativos","v":"4.723","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"75.3%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"93","t":"+0.6%","d":"up"}];
const COLS = ["ID","Classify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dangerous Goods #001","Dangerous Goods #002","8.436","4.481","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Dangerous Goods #002","Dangerous Goods #003","4.070","4.761","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Dangerous Goods #003","Dangerous Goods #004","4.213","4.990","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Dangerous Goods #004","Dangerous Goods #005","7.348","981","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dangerous Goods #005","Dangerous Goods #001","683","7.325","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":818},{"label":"Fev","value":534},{"label":"Mar","value":726},{"label":"Abr","value":739},{"label":"Mai","value":485},{"label":"Jun","value":715},{"label":"Jul","value":824},{"label":"Ago","value":826},{"label":"Set","value":833},{"label":"Out","value":630},{"label":"Nov","value":767},{"label":"Dez","value":559}];
const MX = 833;
