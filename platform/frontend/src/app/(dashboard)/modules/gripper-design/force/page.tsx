...
const PAGE = "Force Model";
const KPIS = [{"l":"Formulários Ativos","v":"8.359","t":"+8.6%","d":"up"},{"l":"Submissões/Dia","v":"4261","t":"+2.7%","d":"up"},{"l":"Documentos Gerados","v":"5.444","t":"+7.6%","d":"up"},{"l":"Templates","v":"7.298","t":"-5.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.143","2026-01-25","4.181","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.808","2026-03-22","5.809","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.195","2026-01-05","1.325","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.916","2026-02-12","1.131","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.068","2026-03-24","8.241","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":534},{"label":"Mar","value":309},{"label":"Abr","value":357},{"label":"Mai","value":538},{"label":"Jun","value":584},{"label":"Jul","value":488},{"label":"Ago","value":449},{"label":"Set","value":621},{"label":"Out","value":311},{"label":"Nov","value":536},{"label":"Dez","value":458}];
const MX = 621;
