...
const ACCENT = "#6366f1";
const MODULE = "Gripper Design";
const PAGE = "3D Print";
const KPIS = [{"l":"Formulários Ativos","v":"5.969","t":"-5.6%","d":"down"},{"l":"Submissões/Dia","v":"2904","t":"+5.4%","d":"up"},{"l":"Documentos Gerados","v":"7.225","t":"+0.9%","d":"up"},{"l":"Templates","v":"8.072","t":"+17.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","951","2026-02-08","1.877","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.202","2026-01-13","5.171","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.898","2026-01-03","5.963","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.689","2026-01-04","8.902","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.102","2026-01-23","8.672","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":641},{"label":"Mar","value":552},{"label":"Abr","value":624},{"label":"Mai","value":548},{"label":"Jun","value":736},{"label":"Jul","value":801},{"label":"Ago","value":697},{"label":"Set","value":760},{"label":"Out","value":723},{"label":"Nov","value":703},{"label":"Dez","value":577}];
const MX = 801;
