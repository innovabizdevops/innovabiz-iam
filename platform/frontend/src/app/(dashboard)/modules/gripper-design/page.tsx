...
export default function GripperDesignPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Gripper Design</h1><p className="text-sm text-muted-foreground">Gripper Design • iBOS Enterprise</p></div>
