...
const PAGE = "Soft Gripper";
const KPIS = [{"l":"Formulários Ativos","v":"3.909","t":"-1.4%","d":"down"},{"l":"Submissões/Dia","v":"4646","t":"-3.0%","d":"down"},{"l":"Documentos Gerados","v":"371","t":"+16.6%","d":"up"},{"l":"Templates","v":"5.324","t":"+0.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.733","2026-03-26","6.417","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.934","2026-01-28","1.620","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.914","2026-01-27","4.772","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.958","2026-03-11","1.580","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.702","2026-03-28","3.471","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":926},{"label":"Mar","value":553},{"label":"Abr","value":862},{"label":"Mai","value":690},{"label":"Jun","value":785},{"label":"Jul","value":708},{"label":"Ago","value":611},{"label":"Set","value":806},{"label":"Out","value":816},{"label":"Nov","value":917},{"label":"Dez","value":789}];
const MX = 926;
