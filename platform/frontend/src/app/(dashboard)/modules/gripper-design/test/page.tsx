...
const PAGE = "Test Lab";
const KPIS = [{"l":"Formulários Ativos","v":"1.709","t":"-5.0%","d":"down"},{"l":"Submissões/Dia","v":"4896","t":"+12.2%","d":"up"},{"l":"Documentos Gerados","v":"4.006","t":"+1.9%","d":"up"},{"l":"Templates","v":"3.480","t":"-5.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.092","2026-01-15","6.103","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.117","2026-01-01","7.641","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.433","2026-03-11","1.348","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.567","2026-02-26","3.151","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.739","2026-02-04","7.517","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":812},{"label":"Mar","value":634},{"label":"Abr","value":605},{"label":"Mai","value":729},{"label":"Jun","value":610},{"label":"Jul","value":676},{"label":"Ago","value":492},{"label":"Set","value":521},{"label":"Out","value":591},{"label":"Nov","value":656},{"label":"Dez","value":483}];
const MX = 812;
