...
const PAGE = "Vacuum";
const KPIS = [{"l":"Formulários Ativos","v":"2.426","t":"+16.9%","d":"up"},{"l":"Submissões/Dia","v":"2887","t":"+2.4%","d":"up"},{"l":"Documentos Gerados","v":"3.274","t":"+8.6%","d":"up"},{"l":"Templates","v":"7.717","t":"+12.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","452","2026-01-02","8.619","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.559","2026-03-21","5.681","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.406","2026-02-19","7.685","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.370","2026-03-05","2.186","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.853","2026-01-25","1.259","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":458},{"label":"Mar","value":441},{"label":"Abr","value":643},{"label":"Mai","value":629},{"label":"Jun","value":499},{"label":"Jul","value":378},{"label":"Ago","value":668},{"label":"Set","value":717},{"label":"Out","value":479},{"label":"Nov","value":544},{"label":"Dez","value":458}];
const MX = 717;
