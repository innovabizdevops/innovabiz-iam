...
const PAGE = "Training";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.729","t":"+4.9%","d":"up"},{"l":"NC Abertas","v":"2.869","t":"+13.9%","d":"up"},{"l":"Conformidade (%)","v":"94.3%","t":"+8.5%","d":"up"},{"l":"CAPAs Pendentes","v":"7.624","t":"+8.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.146","72.0%","6.666","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","858","75.8%","8.263","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.331","77.5%","2.349","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.163","74.4%","2.073","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.189","85.2%","4.563","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":640},{"label":"Mar","value":603},{"label":"Abr","value":496},{"label":"Mai","value":515},{"label":"Jun","value":526},{"label":"Jul","value":416},{"label":"Ago","value":567},{"label":"Set","value":655},{"label":"Out","value":538},{"label":"Nov","value":786},{"label":"Dez","value":545}];
const MX = 786;
