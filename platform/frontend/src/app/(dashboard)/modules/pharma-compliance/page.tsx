...
const KPIS = [
    { label: "Total Registos", value: "4426", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2682", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€358K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1643938926", cells: ["PHA-8926", "Pharma Compliance Item 1", "15/7/2026", "€39 026"], status: "active" as const },
    { id: "1643942497", cells: ["PHA-3497", "Pharma Compliance Item 2", "2/2/2026", "€42 597"], status: "pending" as const },
    { id: "1643946068", cells: ["PHA-7068", "Pharma Compliance Item 3", "17/9/2026", "€46 168"], status: "completed" as const },
    { id: "1643949639", cells: ["PHA-1639", "Pharma Compliance Item 4", "4/4/2026", "€49 739"], status: "warning" as const },
    { id: "1643953210", cells: ["PHA-5210", "Pharma Compliance Item 5", "19/11/2026", "€3310"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pharma Compliance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pharma Compliance</p>
                    </div>
                </div>
