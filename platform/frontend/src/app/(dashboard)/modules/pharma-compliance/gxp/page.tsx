...
const PAGE = "GxP";
const KPIS = [{"l":"Auditorias Realizadas","v":"810","t":"+6.5%","d":"up"},{"l":"NC Abertas","v":"5.226","t":"+9.8%","d":"up"},{"l":"Conformidade (%)","v":"93.0%","t":"-5.4%","d":"down"},{"l":"CAPAs Pendentes","v":"1.660","t":"+4.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","142","81.9%","1.519","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.822","73.3%","5.184","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.943","85.2%","1.294","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.363","83.6%","5.219","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.907","92.9%","8.013","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":729},{"label":"Mar","value":646},{"label":"Abr","value":519},{"label":"Mai","value":769},{"label":"Jun","value":448},{"label":"Jul","value":713},{"label":"Ago","value":756},{"label":"Set","value":727},{"label":"Out","value":809},{"label":"Nov","value":450},{"label":"Dez","value":504}];
const MX = 809;
