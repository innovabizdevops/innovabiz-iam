...
const ACCENT = "#7c3aed";
const MODULE = "Pharma Compliance";
const PAGE = "DEA";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.020","t":"+3.1%","d":"up"},{"l":"NC Abertas","v":"4.081","t":"+16.9%","d":"up"},{"l":"Conformidade (%)","v":"68.1%","t":"+11.1%","d":"up"},{"l":"CAPAs Pendentes","v":"6.929","t":"-3.9%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.793","74.7%","5.445","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.026","73.2%","2.819","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.211","87.7%","6.709","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.318","79.7%","5.614","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.963","84.7%","6.302","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":428},{"label":"Fev","value":398},{"label":"Mar","value":333},{"label":"Abr","value":595},{"label":"Mai","value":621},{"label":"Jun","value":466},{"label":"Jul","value":462},{"label":"Ago","value":520},{"label":"Set","value":390},{"label":"Out","value":361},{"label":"Nov","value":256},{"label":"Dez","value":533}];
const MX = 621;
