...
const PAGE = "Budget";
const KPIS = [{"l":"Riscos Identificados","v":"3.039","t":"+16.2%","d":"up"},{"l":"Mitigações Ativas","v":"547","t":"+13.0%","d":"up"},{"l":"Score Risco Geral","v":"66","t":"+11.4%","d":"up"},{"l":"Incidentes YTD","v":"7.355","t":"-3.9%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.018","3.376","7.261","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.534","6.943","8.128","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.071","6.815","6.591","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.409","2.416","3.447","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.948","4.017","6.877","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":879},{"label":"Fev","value":889},{"label":"Mar","value":880},{"label":"Abr","value":1059},{"label":"Mai","value":984},{"label":"Jun","value":689},{"label":"Jul","value":847},{"label":"Ago","value":978},{"label":"Set","value":758},{"label":"Out","value":917},{"label":"Nov","value":1062},{"label":"Dez","value":739}];
const MX = 1062;
