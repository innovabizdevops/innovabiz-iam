...
const ACCENT = "#4f46e5";
const MODULE = "AX Agent Governance";
const PAGE = "Audit Trail";
const KPIS = [{"l":"Riscos Identificados","v":"541","t":"+12.5%","d":"up"},{"l":"Mitigações Ativas","v":"4.897","t":"+14.5%","d":"up"},{"l":"Score Risco Geral","v":"89","t":"-0.8%","d":"down"},{"l":"Incidentes YTD","v":"5.467","t":"+4.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.869","7.403","6.657","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.410","8.015","2.083","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.548","6.367","4.905","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.223","5.796","5.185","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.418","2.390","4.002","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":340},{"label":"Fev","value":356},{"label":"Mar","value":312},{"label":"Abr","value":500},{"label":"Mai","value":560},{"label":"Jun","value":393},{"label":"Jul","value":587},{"label":"Ago","value":476},{"label":"Set","value":547},{"label":"Out","value":353},{"label":"Nov","value":245},{"label":"Dez","value":460}];
const MX = 587;
