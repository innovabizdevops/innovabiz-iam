...
const KPIS = [{"l":"Riscos Identificados","v":"7.874","t":"+12.8%","d":"up"},{"l":"Mitigações Ativas","v":"3.344","t":"+1.4%","d":"up"},{"l":"Score Risco Geral","v":"85","t":"+8.5%","d":"up"},{"l":"Incidentes YTD","v":"8.331","t":"-4.5%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","489","6.989","6.168","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.060","8.013","1.151","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.428","1.416","5.540","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.164","246","1.821","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.621","8.766","332","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":870},{"label":"Fev","value":917},{"label":"Mar","value":690},{"label":"Abr","value":696},{"label":"Mai","value":695},{"label":"Jun","value":980},{"label":"Jul","value":996},{"label":"Ago","value":702},{"label":"Set","value":851},{"label":"Out","value":687},{"label":"Nov","value":892},{"label":"Dez","value":941}];
const MX = 996;
