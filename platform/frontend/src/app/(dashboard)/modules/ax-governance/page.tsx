...
/* ═══ AX Agent Governance — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "2487", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "137", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€238K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "839136287", cells: ["AX-4287", "AX Agent Governance Item 1", "4/12/2026", "€36 387"], status: "active" as const },
    { id: "839139858", cells: ["AX-7858", "AX Agent Governance Item 2", "19/7/2026", "€39 958"], status: "pending" as const },
    { id: "839143429", cells: ["AX-2429", "AX Agent Governance Item 3", "6/2/2026", "€43 529"], status: "completed" as const },
    { id: "839147000", cells: ["AX-6000", "AX Agent Governance Item 4", "21/9/2026", "€47 100"], status: "warning" as const },
    { id: "839150571", cells: ["AX-9571", "AX Agent Governance Item 5", "8/4/2026", "€671"], status: "active" as const },
];
...
export default function AxAgentGovernancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AX Agent Governance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AX Agent Governance</p>
                    </div>
                </div>
