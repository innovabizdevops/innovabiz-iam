...
const PAGE = "Policy";
const KPIS = [{"l":"Riscos Identificados","v":"5.465","t":"+11.6%","d":"up"},{"l":"Mitigações Ativas","v":"3.303","t":"+6.7%","d":"up"},{"l":"Score Risco Geral","v":"75","t":"+9.0%","d":"up"},{"l":"Incidentes YTD","v":"8.484","t":"-0.3%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.255","3.388","8.047","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.730","3.703","5.518","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.779","1.553","6.453","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.240","7.636","1.619","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.330","4.297","4.492","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1026},{"label":"Fev","value":1048},{"label":"Mar","value":741},{"label":"Abr","value":1013},{"label":"Mai","value":951},{"label":"Jun","value":872},{"label":"Jul","value":968},{"label":"Ago","value":899},{"label":"Set","value":665},{"label":"Out","value":760},{"label":"Nov","value":1025},{"label":"Dez","value":990}];
const MX = 1048;
