...
const KPIS = [{"l":"Riscos Identificados","v":"7.999","t":"+0.3%","d":"up"},{"l":"Mitigações Ativas","v":"7.484","t":"+17.8%","d":"up"},{"l":"Score Risco Geral","v":"63","t":"-0.2%","d":"down"},{"l":"Incidentes YTD","v":"8.563","t":"+12.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","9.044","2.042","6.237","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","930","4.877","6.776","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.661","5.535","5.375","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.544","2.943","7.310","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.348","7.752","1.472","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":751},{"label":"Mar","value":842},{"label":"Abr","value":653},{"label":"Mai","value":955},{"label":"Jun","value":706},{"label":"Jul","value":820},{"label":"Ago","value":815},{"label":"Set","value":892},{"label":"Out","value":949},{"label":"Nov","value":813},{"label":"Dez","value":615}];
const MX = 955;
