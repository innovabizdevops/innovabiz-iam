...
const PAGE = "Record";
const KPIS = [{"l":"Total Columbarium Mgmt","v":"3.110","t":"+3.0%","d":"up"},{"l":"Record Ativos","v":"5.298","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"85.7%","t":"-2.9%","d":"down"},{"l":"Score Performance","v":"56","t":"+13.7%","d":"up"}];
const COLS = ["ID","Record","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Columbarium Mgmt #001","Columbarium Mgmt #002","3.724","3.033","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Columbarium Mgmt #002","Columbarium Mgmt #003","4.318","7.800","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Columbarium Mgmt #003","Columbarium Mgmt #004","8.170","4.228","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Columbarium Mgmt #004","Columbarium Mgmt #005","2.071","656","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Columbarium Mgmt #005","Columbarium Mgmt #001","7.940","5.411","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":620},{"label":"Mar","value":959},{"label":"Abr","value":691},{"label":"Mai","value":859},{"label":"Jun","value":828},{"label":"Jul","value":684},{"label":"Ago","value":964},{"label":"Set","value":885},{"label":"Out","value":854},{"label":"Nov","value":747},{"label":"Dez","value":660}];
const MX = 964;
