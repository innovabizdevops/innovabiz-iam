...
const ACCENT = "#475569";
const MODULE = "Columbarium Mgmt";
const PAGE = "Inurnment";
const KPIS = [{"l":"Total Columbarium Mgmt","v":"3.495","t":"+3.6%","d":"up"},{"l":"Inurnment Ativos","v":"1.599","t":"+2.8%","d":"up"},{"l":"Eficiência (%)","v":"68.8%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"89","t":"+13.6%","d":"up"}];
const COLS = ["ID","Inurnment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Columbarium Mgmt #001","Columbarium Mgmt #002","5.748","6.334","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Columbarium Mgmt #002","Columbarium Mgmt #003","7.314","6.025","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Columbarium Mgmt #003","Columbarium Mgmt #004","1.852","6.882","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Columbarium Mgmt #004","Columbarium Mgmt #005","625","7.973","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Columbarium Mgmt #005","Columbarium Mgmt #001","3.233","6.509","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":790},{"label":"Fev","value":765},{"label":"Mar","value":750},{"label":"Abr","value":813},{"label":"Mai","value":507},{"label":"Jun","value":702},{"label":"Jul","value":717},{"label":"Ago","value":615},{"label":"Set","value":615},{"label":"Out","value":433},{"label":"Nov","value":693},{"label":"Dez","value":513}];
const MX = 813;
...
export default function InurnmentPage() {
    return (
