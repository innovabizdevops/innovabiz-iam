...
const KPIS = [{"l":"Total Columbarium Mgmt","v":"7.342","t":"+0.5%","d":"up"},{"l":"Maintenance Ativos","v":"8.889","t":"+17.7%","d":"up"},{"l":"Eficiência (%)","v":"75.7%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"65","t":"+5.2%","d":"up"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Columbarium Mgmt #001","Columbarium Mgmt #002","6.546","2.168","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Columbarium Mgmt #002","Columbarium Mgmt #003","1.565","4.766","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Columbarium Mgmt #003","Columbarium Mgmt #004","5.400","269","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Columbarium Mgmt #004","Columbarium Mgmt #005","744","1.709","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Columbarium Mgmt #005","Columbarium Mgmt #001","8.251","8.861","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":883},{"label":"Fev","value":866},{"label":"Mar","value":794},{"label":"Abr","value":950},{"label":"Mai","value":647},{"label":"Jun","value":892},{"label":"Jul","value":755},{"label":"Ago","value":788},{"label":"Set","value":619},{"label":"Out","value":729},{"label":"Nov","value":861},{"label":"Dez","value":653}];
const MX = 950;
