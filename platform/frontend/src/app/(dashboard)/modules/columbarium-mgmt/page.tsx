...
/* ═══ Columbarium Mgmt — Dashboard ═══ */

const ACCENT = "#475569";

const KPIS = [
    { label: "Total Registos", value: "1655", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1901", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€64K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "326513455", cells: ["COL-3455", "Columbarium Mgmt Item 1", "24/8/2026", "€13 555"], status: "active" as const },
    { id: "326517026", cells: ["COL-7026", "Columbarium Mgmt Item 2", "11/3/2026", "€17 126"], status: "pending" as const },
    { id: "326520597", cells: ["COL-1597", "Columbarium Mgmt Item 3", "26/10/2026", "€20 697"], status: "completed" as const },
    { id: "326524168", cells: ["COL-5168", "Columbarium Mgmt Item 4", "13/5/2026", "€24 268"], status: "warning" as const },
    { id: "326527739", cells: ["COL-8739", "Columbarium Mgmt Item 5", "28/12/2026", "€27 839"], status: "active" as const },
];
...
export default function ColumbariumMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Columbarium Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Columbarium Mgmt</p>
                    </div>
                </div>
