...
const PAGE = "Sales";
const KPIS = [{"l":"Vendas YTD (€)","v":"€75253","t":"+1.4%","d":"up"},{"l":"Pipeline (€)","v":"€72782","t":"+5.3%","d":"up"},{"l":"Atingimento Quota (%)","v":"67.5%","t":"+13.4%","d":"up"},{"l":"Win Rate (%)","v":"77.3%","t":"+0.8%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 29781.80","€ 18977.67","€ 21287.82","81.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 33601.36","€ 43143.24","€ 31678.57","84.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 6808.39","€ 10680.79","€ 25666.28","93.8%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 31891.23","€ 32642.70","€ 12344.86","81.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 36738.68","€ 20335.98","€ 9708.75","81.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":721},{"label":"Mar","value":779},{"label":"Abr","value":799},{"label":"Mai","value":455},{"label":"Jun","value":663},{"label":"Jul","value":440},{"label":"Ago","value":706},{"label":"Set","value":697},{"label":"Out","value":523},{"label":"Nov","value":718},{"label":"Dez","value":784}];
const MX = 799;
