...
const PAGE = "Niche";
const KPIS = [{"l":"Total Columbarium Mgmt","v":"3.687","t":"+15.1%","d":"up"},{"l":"Niche Ativos","v":"1.378","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"94.7%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"59","t":"+4.3%","d":"up"}];
const COLS = ["ID","Niche","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Columbarium Mgmt #001","Columbarium Mgmt #002","4.949","3.802","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Columbarium Mgmt #002","Columbarium Mgmt #003","6.856","1.429","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Columbarium Mgmt #003","Columbarium Mgmt #004","391","6.518","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Columbarium Mgmt #004","Columbarium Mgmt #005","1.605","415","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Columbarium Mgmt #005","Columbarium Mgmt #001","1.436","4.849","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":901},{"label":"Fev","value":828},{"label":"Mar","value":851},{"label":"Abr","value":992},{"label":"Mai","value":747},{"label":"Jun","value":726},{"label":"Jul","value":696},{"label":"Ago","value":960},{"label":"Set","value":843},{"label":"Out","value":1007},{"label":"Nov","value":899},{"label":"Dez","value":1026}];
const MX = 1026;
