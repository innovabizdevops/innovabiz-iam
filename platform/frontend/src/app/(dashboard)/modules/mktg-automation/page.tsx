...
export default function MktgAutomationPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Mktg Automation</h1><p className="text-sm text-muted-foreground">Mktg Automation • iBOS Enterprise</p></div>
