...
const PAGE = "Scoring Sync";
const KPIS = [{"l":"Integrações Ativas","v":"5.593","t":"+15.8%","d":"up"},{"l":"Chamadas/Hora","v":"1203","t":"+4.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.1%","t":"+3.2%","d":"up"},{"l":"Latência Média (ms)","v":"27ms","t":"+5.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.371","3.296","75.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.288","965","80.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.829","251","71.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.746","8.456","95.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.707","8.824","71.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":679},{"label":"Mar","value":654},{"label":"Abr","value":540},{"label":"Mai","value":666},{"label":"Jun","value":480},{"label":"Jul","value":642},{"label":"Ago","value":635},{"label":"Set","value":391},{"label":"Out","value":671},{"label":"Nov","value":769},{"label":"Dez","value":528}];
const MX = 769;
