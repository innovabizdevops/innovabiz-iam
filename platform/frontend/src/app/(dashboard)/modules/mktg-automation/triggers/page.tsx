...
const PAGE = "Trigger Rules";
const KPIS = [{"l":"Total Mktg Automation","v":"6.660","t":"+13.2%","d":"up"},{"l":"Trigger Rules Ativos","v":"5.918","t":"+18.0%","d":"up"},{"l":"Eficiência (%)","v":"72.7%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"57","t":"-0.5%","d":"down"}];
const COLS = ["ID","Trigger Rules","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mktg Automation #001","Mktg Automation #002","3.037","3.599","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Mktg Automation #002","Mktg Automation #003","1.796","5.584","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Mktg Automation #003","Mktg Automation #004","4.342","2.403","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Mktg Automation #004","Mktg Automation #005","251","2.817","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mktg Automation #005","Mktg Automation #001","5.487","1.734","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":873},{"label":"Mar","value":999},{"label":"Abr","value":1044},{"label":"Mai","value":867},{"label":"Jun","value":982},{"label":"Jul","value":756},{"label":"Ago","value":1011},{"label":"Set","value":857},{"label":"Out","value":730},{"label":"Nov","value":1053},{"label":"Dez","value":741}];
const MX = 1053;
