...
const PAGE = "CLV";
const KPIS = [{"l":"Dashboards Ativos","v":"2.788","t":"+5.1%","d":"up"},{"l":"Queries/Dia","v":"2223","t":"-5.0%","d":"down"},{"l":"Dados Processados (GB)","v":"7.162","t":"+4.6%","d":"up"},{"l":"Utilizadores Analytics","v":"7.139","t":"+14.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2222","2026-02-20","8.238","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1942","2026-01-07","1.807","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1346","2026-01-09","1.907","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","729","2026-02-17","8.947","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4807","2026-03-03","5.892","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":387},{"label":"Fev","value":658},{"label":"Mar","value":436},{"label":"Abr","value":421},{"label":"Mai","value":735},{"label":"Jun","value":457},{"label":"Jul","value":728},{"label":"Ago","value":508},{"label":"Set","value":417},{"label":"Out","value":375},{"label":"Nov","value":514},{"label":"Dez","value":635}];
const MX = 735;
