...
const PAGE = "Next Best";
const KPIS = [{"l":"Dashboards Ativos","v":"6.819","t":"+0.4%","d":"up"},{"l":"Queries/Dia","v":"3438","t":"+2.3%","d":"up"},{"l":"Dados Processados (GB)","v":"1.355","t":"+7.6%","d":"up"},{"l":"Utilizadores Analytics","v":"4.004","t":"+13.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3673","2026-02-02","8.051","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4792","2026-01-04","1.006","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2163","2026-01-21","7.485","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4247","2026-03-18","3.830","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4383","2026-03-09","7.772","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":411},{"label":"Fev","value":285},{"label":"Mar","value":334},{"label":"Abr","value":309},{"label":"Mai","value":573},{"label":"Jun","value":607},{"label":"Jul","value":388},{"label":"Ago","value":392},{"label":"Set","value":485},{"label":"Out","value":505},{"label":"Nov","value":576},{"label":"Dez","value":486}];
const MX = 607;
