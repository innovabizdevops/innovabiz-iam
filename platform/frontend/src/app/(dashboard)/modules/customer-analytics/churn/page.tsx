...
const PAGE = "Churn";
const KPIS = [{"l":"ARR (€M)","v":"€41.4M","t":"+5.9%","d":"up"},{"l":"MRR (€)","v":"€74813","t":"+9.6%","d":"up"},{"l":"Churn (%)","v":"83.6%","t":"+14.9%","d":"up"},{"l":"ARPU (€)","v":"€49304","t":"+4.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 29749.72","7.759","€ 25441.14","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 42163.23","2.499","€ 28547.91","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 45827.60","5.375","€ 40427.20","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 3486.18","2.400","€ 20640.74","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 34471.05","7.432","€ 49188.52","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":587},{"label":"Mar","value":758},{"label":"Abr","value":875},{"label":"Mai","value":882},{"label":"Jun","value":540},{"label":"Jul","value":585},{"label":"Ago","value":804},{"label":"Set","value":750},{"label":"Out","value":620},{"label":"Nov","value":734},{"label":"Dez","value":706}];
const MX = 882;
