...
const ACCENT = "#4338ca";
const MODULE = "Customer Analytics Deep";
const PAGE = "Segmentation";
const KPIS = [{"l":"Dashboards Ativos","v":"551","t":"+11.9%","d":"up"},{"l":"Queries/Dia","v":"3969","t":"+10.7%","d":"up"},{"l":"Dados Processados (GB)","v":"2.753","t":"+10.4%","d":"up"},{"l":"Utilizadores Analytics","v":"8.155","t":"-1.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1277","2026-02-13","7.274","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3378","2026-02-13","7.747","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1092","2026-01-16","1.576","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4005","2026-02-18","6.404","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1005","2026-01-01","7.416","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":771},{"label":"Fev","value":677},{"label":"Mar","value":1042},{"label":"Abr","value":814},{"label":"Mai","value":914},{"label":"Jun","value":1016},{"label":"Jul","value":683},{"label":"Ago","value":706},{"label":"Set","value":882},{"label":"Out","value":947},{"label":"Nov","value":852},{"label":"Dez","value":1018}];
const MX = 1042;
