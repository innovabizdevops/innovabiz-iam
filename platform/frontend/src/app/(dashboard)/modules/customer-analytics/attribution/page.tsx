...
const KPIS = [{"l":"Dashboards Ativos","v":"7.970","t":"+3.1%","d":"up"},{"l":"Queries/Dia","v":"596","t":"-1.3%","d":"down"},{"l":"Dados Processados (GB)","v":"348","t":"+14.8%","d":"up"},{"l":"Utilizadores Analytics","v":"6.871","t":"+3.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1509","2026-02-28","5.153","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3275","2026-03-20","6.737","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4243","2026-03-19","1.886","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2216","2026-03-02","8.069","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2319","2026-03-19","2.119","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":876},{"label":"Mar","value":572},{"label":"Abr","value":634},{"label":"Mai","value":788},{"label":"Jun","value":765},{"label":"Jul","value":595},{"label":"Ago","value":553},{"label":"Set","value":795},{"label":"Out","value":535},{"label":"Nov","value":573},{"label":"Dez","value":714}];
const MX = 876;
