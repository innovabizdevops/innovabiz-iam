...
const KPIS = [
    { label: "Total Registos", value: "2930", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "693", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€285K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "418376830", cells: ["CUS-3830", "Customer Analytics Deep Item 1", "19/11/2026", "€26 930"], status: "active" as const },
    { id: "418380401", cells: ["CUS-7401", "Customer Analytics Deep Item 2", "6/6/2026", "€30 501"], status: "pending" as const },
    { id: "418383972", cells: ["CUS-1972", "Customer Analytics Deep Item 3", "21/1/2026", "€34 072"], status: "completed" as const },
    { id: "418387543", cells: ["CUS-5543", "Customer Analytics Deep Item 4", "8/8/2026", "€37 643"], status: "warning" as const },
    { id: "418391114", cells: ["CUS-9114", "Customer Analytics Deep Item 5", "23/3/2026", "€41 214"], status: "active" as const },
];
...
export default function CustomerAnalyticsDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Customer Analytics Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Customer Analytics Deep</p>
                    </div>
                </div>
