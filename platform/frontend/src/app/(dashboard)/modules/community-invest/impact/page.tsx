...
const PAGE = "Impact Report";
const KPIS = [{"l":"Projetos Sociais","v":"461","t":"-0.7%","d":"down"},{"l":"Beneficiários","v":"5.458","t":"+9.8%","d":"up"},{"l":"Investimento CSR (€)","v":"€22967","t":"+4.7%","d":"up"},{"l":"Score Impacto","v":"56","t":"+7.3%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","1.771","€ 9830.78","3.254","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","7.105","€ 22606.38","2.977","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","3.019","€ 17749.46","2.019","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","4.456","€ 28970.52","8.374","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","2.801","€ 6429.72","5.140","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":972},{"label":"Fev","value":618},{"label":"Mar","value":758},{"label":"Abr","value":644},{"label":"Mai","value":853},{"label":"Jun","value":891},{"label":"Jul","value":699},{"label":"Ago","value":915},{"label":"Set","value":963},{"label":"Out","value":936},{"label":"Nov","value":710},{"label":"Dez","value":893}];
const MX = 972;
