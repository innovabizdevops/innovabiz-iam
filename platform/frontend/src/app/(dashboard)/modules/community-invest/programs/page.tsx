...
const PAGE = "Program Track";
const KPIS = [{"l":"Projetos Sociais","v":"4.774","t":"+5.3%","d":"up"},{"l":"Beneficiários","v":"560","t":"+2.4%","d":"up"},{"l":"Investimento CSR (€)","v":"€77454","t":"-0.8%","d":"down"},{"l":"Score Impacto","v":"78","t":"+0.6%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","942","€ 45495.56","4.590","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","3.124","€ 28727.07","2.698","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","4.122","€ 19620.40","7.863","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","5.053","€ 35091.57","1.981","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","3.250","€ 31030.21","1.044","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":725},{"label":"Mar","value":572},{"label":"Abr","value":763},{"label":"Mai","value":642},{"label":"Jun","value":830},{"label":"Jul","value":735},{"label":"Ago","value":598},{"label":"Set","value":851},{"label":"Out","value":685},{"label":"Nov","value":786},{"label":"Dez","value":682}];
const MX = 851;
