...
const ACCENT = "#b45309";
const MODULE = "Community Investment";
const PAGE = "LBG Method";
const KPIS = [{"l":"Projetos Sociais","v":"7.396","t":"-5.5%","d":"down"},{"l":"Beneficiários","v":"6.698","t":"+4.5%","d":"up"},{"l":"Investimento CSR (€)","v":"€86259","t":"-3.8%","d":"down"},{"l":"Score Impacto","v":"95","t":"+11.4%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","4.336","€ 31805.66","3.967","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.764","€ 35432.84","2.327","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","757","€ 17129.86","6.723","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","8.013","€ 32930.81","5.635","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","189","€ 27754.02","2.277","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":322},{"label":"Fev","value":282},{"label":"Mar","value":552},{"label":"Abr","value":212},{"label":"Mai","value":515},{"label":"Jun","value":213},{"label":"Jul","value":606},{"label":"Ago","value":245},{"label":"Set","value":350},{"label":"Out","value":269},{"label":"Nov","value":378},{"label":"Dez","value":507}];
const MX = 606;
...
export default function LbgPage() {
    return (
