...
const PAGE = "Donation Match";
const KPIS = [{"l":"Projetos Sociais","v":"503","t":"+15.9%","d":"up"},{"l":"Beneficiários","v":"4.695","t":"+17.2%","d":"up"},{"l":"Investimento CSR (€)","v":"€71795","t":"+8.4%","d":"up"},{"l":"Score Impacto","v":"64","t":"+2.5%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","1.354","€ 33286.14","3.662","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.920","€ 39249.79","981","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","1.624","€ 37175.67","8.326","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","6.082","€ 27466.33","8.516","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","7.129","€ 44915.04","2.097","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":257},{"label":"Fev","value":259},{"label":"Mar","value":426},{"label":"Abr","value":320},{"label":"Mai","value":390},{"label":"Jun","value":295},{"label":"Jul","value":486},{"label":"Ago","value":362},{"label":"Set","value":466},{"label":"Out","value":529},{"label":"Nov","value":340},{"label":"Dez","value":534}];
const MX = 534;
