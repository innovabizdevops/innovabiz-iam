...
const PAGE = "Volunteer Hours";
const KPIS = [{"l":"Projetos Sociais","v":"8.926","t":"+7.3%","d":"up"},{"l":"Beneficiários","v":"5.758","t":"+15.4%","d":"up"},{"l":"Investimento CSR (€)","v":"€22015","t":"+0.3%","d":"up"},{"l":"Score Impacto","v":"68","t":"+11.3%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","6.087","€ 42994.52","7.872","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","3.426","€ 13011.96","5.895","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","882","€ 36893.30","9.098","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","6.931","€ 32789.29","8.198","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","657","€ 15650.97","8.040","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":435},{"label":"Fev","value":244},{"label":"Mar","value":315},{"label":"Abr","value":490},{"label":"Mai","value":362},{"label":"Jun","value":253},{"label":"Jul","value":305},{"label":"Ago","value":328},{"label":"Set","value":541},{"label":"Out","value":351},{"label":"Nov","value":258},{"label":"Dez","value":563}];
const MX = 563;
