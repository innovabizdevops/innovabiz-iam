...
const ACCENT = "#ec4899";
const MODULE = "Social Benefits";
const PAGE = "Fraud Detect";
const KPIS = [{"l":"Total Social Benefits","v":"5.346","t":"+4.1%","d":"up"},{"l":"Fraud Detect Ativos","v":"1.820","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"83.4%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"87","t":"+13.6%","d":"up"}];
const COLS = ["ID","Fraud Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Social Benefits #001","Social Benefits #002","7.214","857","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Social Benefits #002","Social Benefits #003","2.808","6.973","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Social Benefits #003","Social Benefits #004","2.130","1.096","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Social Benefits #004","Social Benefits #005","7.004","2.349","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Social Benefits #005","Social Benefits #001","3.407","2.326","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":780},{"label":"Mar","value":790},{"label":"Abr","value":841},{"label":"Mai","value":835},{"label":"Jun","value":587},{"label":"Jul","value":541},{"label":"Ago","value":580},{"label":"Set","value":649},{"label":"Out","value":670},{"label":"Nov","value":879},{"label":"Dez","value":649}];
const MX = 879;
