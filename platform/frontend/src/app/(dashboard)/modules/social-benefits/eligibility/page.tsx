...
const PAGE = "Eligibility";
const KPIS = [{"l":"Total Social Benefits","v":"2.296","t":"-3.0%","d":"down"},{"l":"Eligibility Ativos","v":"5.911","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"80.6%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"77","t":"+9.1%","d":"up"}];
const COLS = ["ID","Eligibility","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Social Benefits #001","Social Benefits #002","3.691","4.055","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Social Benefits #002","Social Benefits #003","3.745","2.892","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Social Benefits #003","Social Benefits #004","4.601","5.880","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Social Benefits #004","Social Benefits #005","6.636","4.007","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Social Benefits #005","Social Benefits #001","5.297","530","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":966},{"label":"Mar","value":717},{"label":"Abr","value":905},{"label":"Mai","value":677},{"label":"Jun","value":1020},{"label":"Jul","value":806},{"label":"Ago","value":742},{"label":"Set","value":687},{"label":"Out","value":695},{"label":"Nov","value":906},{"label":"Dez","value":996}];
const MX = 1020;
