...
const PAGE = "Payment Distr";
const KPIS = [{"l":"Total Social Benefits","v":"8.724","t":"-5.6%","d":"down"},{"l":"Payment Distr Ativos","v":"6.402","t":"+2.3%","d":"up"},{"l":"Eficiência (%)","v":"78.3%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"79","t":"+4.3%","d":"up"}];
const COLS = ["ID","Payment Distr","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Social Benefits #001","Social Benefits #002","1.691","1.603","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Social Benefits #002","Social Benefits #003","960","6.174","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Social Benefits #003","Social Benefits #004","2.199","4.017","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Social Benefits #004","Social Benefits #005","4.378","2.829","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Social Benefits #005","Social Benefits #001","3.885","2.261","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":747},{"label":"Mar","value":695},{"label":"Abr","value":734},{"label":"Mai","value":555},{"label":"Jun","value":738},{"label":"Jul","value":587},{"label":"Ago","value":771},{"label":"Set","value":442},{"label":"Out","value":541},{"label":"Nov","value":826},{"label":"Dez","value":541}];
const MX = 826;
