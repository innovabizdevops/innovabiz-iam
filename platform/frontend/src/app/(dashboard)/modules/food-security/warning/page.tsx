...
const KPIS = [{"l":"Total Food Security","v":"8.262","t":"-3.3%","d":"down"},{"l":"Early Warning Ativos","v":"3.802","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"91.9%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"80","t":"-5.6%","d":"down"}];
const COLS = ["ID","Early Warning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Security #001","Food Security #002","638","3.069","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Food Security #002","Food Security #003","1.924","8.662","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Security #003","Food Security #004","4.351","5.556","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Food Security #004","Food Security #005","4.622","872","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Security #005","Food Security #001","6.858","5.698","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":1003},{"label":"Mar","value":913},{"label":"Abr","value":922},{"label":"Mai","value":782},{"label":"Jun","value":855},{"label":"Jul","value":769},{"label":"Ago","value":988},{"label":"Set","value":854},{"label":"Out","value":846},{"label":"Nov","value":645},{"label":"Dez","value":1027}];
const MX = 1027;
