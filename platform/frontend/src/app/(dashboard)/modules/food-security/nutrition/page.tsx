...
const ACCENT = "#b45309";
const MODULE = "Food Security";
const PAGE = "Nutrition Sur";
const KPIS = [{"l":"Total Food Security","v":"6.944","t":"+9.7%","d":"up"},{"l":"Nutrition Sur Ativos","v":"5.255","t":"-3.8%","d":"down"},{"l":"Eficiência (%)","v":"69.0%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"88","t":"+6.4%","d":"up"}];
const COLS = ["ID","Nutrition Sur","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Security #001","Food Security #002","6.024","6.164","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Food Security #002","Food Security #003","5.767","2.467","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Security #003","Food Security #004","1.921","1.901","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Food Security #004","Food Security #005","7.808","3.671","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Security #005","Food Security #001","8.381","6.944","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":622},{"label":"Mar","value":883},{"label":"Abr","value":756},{"label":"Mai","value":698},{"label":"Jun","value":870},{"label":"Jul","value":927},{"label":"Ago","value":841},{"label":"Set","value":905},{"label":"Out","value":808},{"label":"Nov","value":854},{"label":"Dez","value":913}];
const MX = 927;
