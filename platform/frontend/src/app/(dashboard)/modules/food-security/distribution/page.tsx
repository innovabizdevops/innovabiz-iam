...
const KPIS = [{"l":"Total Food Security","v":"6.949","t":"-0.7%","d":"down"},{"l":"Distribution Ativos","v":"8.724","t":"+15.2%","d":"up"},{"l":"Eficiência (%)","v":"93.2%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"84","t":"+2.1%","d":"up"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Security #001","Food Security #002","1.932","1.393","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Food Security #002","Food Security #003","6.223","523","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Security #003","Food Security #004","3.018","1.823","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Food Security #004","Food Security #005","5.719","2.170","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Security #005","Food Security #001","5.943","4.884","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":639},{"label":"Mar","value":487},{"label":"Abr","value":417},{"label":"Mai","value":352},{"label":"Jun","value":455},{"label":"Jul","value":387},{"label":"Ago","value":343},{"label":"Set","value":296},{"label":"Out","value":531},{"label":"Nov","value":558},{"label":"Dez","value":407}];
const MX = 645;
