...
const PAGE = "IPC Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"1.929","t":"+0.4%","d":"up"},{"l":"Queries/Dia","v":"2081","t":"-3.3%","d":"down"},{"l":"Dados Processados (GB)","v":"7.496","t":"+10.4%","d":"up"},{"l":"Utilizadores Analytics","v":"1.894","t":"+15.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3765","2026-03-27","3.848","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4908","2026-03-07","8.778","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","747","2026-01-10","670","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2260","2026-03-17","1.550","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1299","2026-02-25","6.708","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":496},{"label":"Mar","value":535},{"label":"Abr","value":479},{"label":"Mai","value":653},{"label":"Jun","value":565},{"label":"Jul","value":447},{"label":"Ago","value":658},{"label":"Set","value":447},{"label":"Out","value":777},{"label":"Nov","value":521},{"label":"Dez","value":538}];
const MX = 777;
