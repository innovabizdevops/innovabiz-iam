...
const PAGE = "Food Basket";
const KPIS = [{"l":"Total Food Security","v":"3.278","t":"-5.5%","d":"down"},{"l":"Food Basket Ativos","v":"7.895","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"76.0%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"79","t":"+5.0%","d":"up"}];
const COLS = ["ID","Food Basket","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Security #001","Food Security #002","8.762","2.970","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Food Security #002","Food Security #003","6.224","1.657","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Security #003","Food Security #004","8.816","2.681","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Food Security #004","Food Security #005","1.498","3.153","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Security #005","Food Security #001","5.560","816","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":427},{"label":"Mar","value":625},{"label":"Abr","value":628},{"label":"Mai","value":679},{"label":"Jun","value":490},{"label":"Jul","value":432},{"label":"Ago","value":701},{"label":"Set","value":658},{"label":"Out","value":772},{"label":"Nov","value":602},{"label":"Dez","value":454}];
const MX = 772;
