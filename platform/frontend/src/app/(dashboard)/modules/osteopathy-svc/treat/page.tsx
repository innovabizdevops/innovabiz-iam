...
const PAGE = "Treat";
const KPIS = [{"l":"Total Osteopathy Svc","v":"3.103","t":"-1.1%","d":"down"},{"l":"Treat Ativos","v":"7.093","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"75.2%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"91","t":"-1.0%","d":"down"}];
const COLS = ["ID","Treat","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Osteopathy Svc #001","Osteopathy Svc #002","381","8.043","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Osteopathy Svc #002","Osteopathy Svc #003","8.245","1.305","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Osteopathy Svc #003","Osteopathy Svc #004","3.390","2.879","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Osteopathy Svc #004","Osteopathy Svc #005","3.642","8.548","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Osteopathy Svc #005","Osteopathy Svc #001","7.156","8.161","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":541},{"label":"Mar","value":761},{"label":"Abr","value":573},{"label":"Mai","value":635},{"label":"Jun","value":776},{"label":"Jul","value":495},{"label":"Ago","value":532},{"label":"Set","value":544},{"label":"Out","value":744},{"label":"Nov","value":700},{"label":"Dez","value":710}];
const MX = 776;
