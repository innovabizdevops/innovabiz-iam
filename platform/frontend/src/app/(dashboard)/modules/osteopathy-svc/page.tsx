...
/* ═══ Osteopathy Services — Dashboard ═══ */

const ACCENT = "#0f172a";

const KPIS = [
    { label: "Total Registos", value: "3772", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1849", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€113K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "920990772", cells: ["OST-3772", "Osteopathy Services Item 1", "17/1/2026", "€40 872"], status: "active" as const },
    { id: "920994343", cells: ["OST-7343", "Osteopathy Services Item 2", "4/8/2026", "€44 443"], status: "pending" as const },
    { id: "920997914", cells: ["OST-1914", "Osteopathy Services Item 3", "19/3/2026", "€48 014"], status: "completed" as const },
    { id: "921001485", cells: ["OST-5485", "Osteopathy Services Item 4", "6/10/2026", "€1585"], status: "warning" as const },
    { id: "921005056", cells: ["OST-9056", "Osteopathy Services Item 5", "21/5/2026", "€5156"], status: "active" as const },
];
...
export default function OsteopathyServicesPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Osteopathy Services</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Osteopathy Services</p>
                    </div>
                </div>
