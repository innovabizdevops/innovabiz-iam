...
const ACCENT = "#0f172a";
const MODULE = "Osteopathy Services";
const PAGE = "Assess";
const KPIS = [{"l":"Total Osteopathy Svc","v":"3.416","t":"-5.3%","d":"down"},{"l":"Assess Ativos","v":"7.182","t":"+5.3%","d":"up"},{"l":"Eficiência (%)","v":"80.8%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"85","t":"-5.7%","d":"down"}];
const COLS = ["ID","Assess","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Osteopathy Svc #001","Osteopathy Svc #002","7.230","2.745","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Osteopathy Svc #002","Osteopathy Svc #003","1.654","6.043","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Osteopathy Svc #003","Osteopathy Svc #004","988","8.637","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Osteopathy Svc #004","Osteopathy Svc #005","6.089","556","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Osteopathy Svc #005","Osteopathy Svc #001","1.299","5.587","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":321},{"label":"Mar","value":591},{"label":"Abr","value":546},{"label":"Mai","value":544},{"label":"Jun","value":507},{"label":"Jul","value":483},{"label":"Ago","value":243},{"label":"Set","value":285},{"label":"Out","value":343},{"label":"Nov","value":583},{"label":"Dez","value":605}];
const MX = 605;
