...
const PAGE = "Mine Planning";
const KPIS = [{"l":"Total Mining","v":"6.277","t":"+1.5%","d":"up"},{"l":"Mine Planning Ativos","v":"1.663","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"91.0%","t":"+6.7%","d":"up"},{"l":"Score Performance","v":"86","t":"+17.8%","d":"up"}];
const COLS = ["ID","Mine Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mining #001","Mining #002","1.477","3.088","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Mining #002","Mining #003","6.404","8.221","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Mining #003","Mining #004","270","1.744","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Mining #004","Mining #005","4.148","773","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mining #005","Mining #001","1.961","4.658","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":381},{"label":"Mar","value":696},{"label":"Abr","value":643},{"label":"Mai","value":503},{"label":"Jun","value":585},{"label":"Jul","value":468},{"label":"Ago","value":660},{"label":"Set","value":593},{"label":"Out","value":450},{"label":"Nov","value":391},{"label":"Dez","value":587}];
const MX = 696;
