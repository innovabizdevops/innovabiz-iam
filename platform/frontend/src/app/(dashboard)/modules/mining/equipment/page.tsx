...
const PAGE = "Equipment Mgmt";
const KPIS = [{"l":"Total Mining","v":"8.912","t":"+17.1%","d":"up"},{"l":"Equipment Mgmt Ativos","v":"8.163","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"86.5%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"71","t":"+17.9%","d":"up"}];
const COLS = ["ID","Equipment Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mining #001","Mining #002","4.454","6.355","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Mining #002","Mining #003","3.489","7.811","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Mining #003","Mining #004","1.285","4.553","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Mining #004","Mining #005","449","3.543","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mining #005","Mining #001","6.568","8.069","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":838},{"label":"Mar","value":746},{"label":"Abr","value":924},{"label":"Mai","value":766},{"label":"Jun","value":862},{"label":"Jul","value":794},{"label":"Ago","value":657},{"label":"Set","value":632},{"label":"Out","value":642},{"label":"Nov","value":979},{"label":"Dez","value":831}];
const MX = 979;
