...
const KPIS = [{"l":"Total Mining","v":"8.068","t":"+5.0%","d":"up"},{"l":"Processing Ativos","v":"1.928","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"82.8%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"77","t":"+3.6%","d":"up"}];
const COLS = ["ID","Processing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mining #001","Mining #002","2.385","465","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Mining #002","Mining #003","6.811","9.027","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Mining #003","Mining #004","357","7.614","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Mining #004","Mining #005","2.862","7.202","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mining #005","Mining #001","7.941","8.086","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":345},{"label":"Fev","value":614},{"label":"Mar","value":555},{"label":"Abr","value":275},{"label":"Mai","value":648},{"label":"Jun","value":458},{"label":"Jul","value":320},{"label":"Ago","value":552},{"label":"Set","value":421},{"label":"Out","value":309},{"label":"Nov","value":430},{"label":"Dez","value":554}];
const MX = 648;
