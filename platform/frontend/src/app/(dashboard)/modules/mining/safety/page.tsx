...
const PAGE = "Safety &amp; Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.373","t":"+0.7%","d":"up"},{"l":"NC Abertas","v":"856","t":"+15.5%","d":"up"},{"l":"Conformidade (%)","v":"83.6%","t":"+2.1%","d":"up"},{"l":"CAPAs Pendentes","v":"2.460","t":"+1.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.323","88.7%","1.129","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.529","79.2%","5.428","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.394","93.1%","2.890","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.285","81.3%","8.449","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.421","86.2%","4.516","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":996},{"label":"Fev","value":709},{"label":"Mar","value":996},{"label":"Abr","value":1064},{"label":"Mai","value":742},{"label":"Jun","value":850},{"label":"Jul","value":679},{"label":"Ago","value":716},{"label":"Set","value":1035},{"label":"Out","value":705},{"label":"Nov","value":1036},{"label":"Dez","value":839}];
const MX = 1064;
