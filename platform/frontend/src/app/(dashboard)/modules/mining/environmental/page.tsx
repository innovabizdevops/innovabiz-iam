...
const KPIS = [{"l":"Total Mining","v":"1.827","t":"+13.1%","d":"up"},{"l":"Environmental Ativos","v":"515","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"84.6%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"85","t":"-3.6%","d":"down"}];
const COLS = ["ID","Environmental","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mining #001","Mining #002","1.042","3.145","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Mining #002","Mining #003","7.050","7.501","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Mining #003","Mining #004","5.401","5.439","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Mining #004","Mining #005","1.873","3.076","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mining #005","Mining #001","3.364","6.026","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":742},{"label":"Mar","value":924},{"label":"Abr","value":804},{"label":"Mai","value":760},{"label":"Jun","value":870},{"label":"Jul","value":843},{"label":"Ago","value":823},{"label":"Set","value":980},{"label":"Out","value":617},{"label":"Nov","value":741},{"label":"Dez","value":827}];
const MX = 980;
