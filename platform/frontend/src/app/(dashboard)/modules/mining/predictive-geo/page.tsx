...
const ACCENT = "#78350f";
const MODULE = "Mining & Resources";
const PAGE = "Predictive Geo AI";
const KPIS = [{"l":"Integrações Ativas","v":"7.010","t":"+5.6%","d":"up"},{"l":"Chamadas/Hora","v":"2743","t":"-1.6%","d":"down"},{"l":"Taxa Sucesso (%)","v":"75.5%","t":"+6.9%","d":"up"},{"l":"Latência Média (ms)","v":"70ms","t":"+17.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.682","3.360","89.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.878","6.614","92.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.937","5.653","71.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.783","3.936","96.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.005","8.437","84.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":449},{"label":"Fev","value":266},{"label":"Mar","value":309},{"label":"Abr","value":257},{"label":"Mai","value":350},{"label":"Jun","value":378},{"label":"Jul","value":610},{"label":"Ago","value":397},{"label":"Set","value":536},{"label":"Out","value":323},{"label":"Nov","value":558},{"label":"Dez","value":592}];
const MX = 610;
...
export default function PredictiveGeoPage() {
    return (
