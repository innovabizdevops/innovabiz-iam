...
const KPIS = [{"l":"Total Mining","v":"5.625","t":"+17.8%","d":"up"},{"l":"Geology & Exploration Ativos","v":"616","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"65.9%","t":"+8.9%","d":"up"},{"l":"Score Performance","v":"73","t":"-1.7%","d":"down"}];
const COLS = ["ID","Geology & Exploration","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mining #001","Mining #002","6.372","6.869","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Mining #002","Mining #003","694","2.882","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Mining #003","Mining #004","4.991","2.665","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Mining #004","Mining #005","2.687","5.352","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mining #005","Mining #001","1.396","5.040","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":382},{"label":"Mar","value":385},{"label":"Abr","value":453},{"label":"Mai","value":624},{"label":"Jun","value":664},{"label":"Jul","value":419},{"label":"Ago","value":713},{"label":"Set","value":459},{"label":"Out","value":643},{"label":"Nov","value":594},{"label":"Dez","value":706}];
const MX = 713;
