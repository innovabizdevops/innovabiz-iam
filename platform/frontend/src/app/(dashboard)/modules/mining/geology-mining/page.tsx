...
const PAGE = "Geology &amp; Exploration";
const KPIS = [{"l":"Total Mining","v":"783","t":"+0.7%","d":"up"},{"l":"Geology & Exploration Ativos","v":"4.955","t":"+17.3%","d":"up"},{"l":"Eficiência (%)","v":"70.7%","t":"+1.7%","d":"up"},{"l":"Score Performance","v":"87","t":"-0.5%","d":"down"}];
const COLS = ["ID","Geology & Exploration","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mining #001","Mining #002","2.565","8.631","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Mining #002","Mining #003","5.477","275","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Mining #003","Mining #004","985","6.813","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Mining #004","Mining #005","1.426","8.844","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mining #005","Mining #001","5.475","1.510","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":843},{"label":"Mar","value":731},{"label":"Abr","value":727},{"label":"Mai","value":863},{"label":"Jun","value":915},{"label":"Jul","value":679},{"label":"Ago","value":585},{"label":"Set","value":885},{"label":"Out","value":701},{"label":"Nov","value":537},{"label":"Dez","value":911}];
const MX = 915;
...
export default function GeologyMiningPage() {
    return (
