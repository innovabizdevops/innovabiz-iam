...
const KPIS = [{"l":"Projetos Melhoria","v":"8.244","t":"-0.2%","d":"down"},{"l":"Savings (€)","v":"€50306","t":"-3.2%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"66.8%","t":"+13.8%","d":"up"},{"l":"Ciclos PDCA","v":"1.545","t":"+17.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.955","€ 42916.45","7.346","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.760","€ 17896.69","2.519","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.150","€ 2454.15","4.542","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","798","€ 39227.17","4.767","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","892","€ 20624.95","6.567","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":942},{"label":"Mar","value":931},{"label":"Abr","value":938},{"label":"Mai","value":1027},{"label":"Jun","value":937},{"label":"Jul","value":949},{"label":"Ago","value":839},{"label":"Set","value":972},{"label":"Out","value":810},{"label":"Nov","value":1012},{"label":"Dez","value":972}];
const MX = 1027;
