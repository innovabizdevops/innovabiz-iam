...
const ACCENT = "#16a34a";
const MODULE = "Battery Manufacturing";
const PAGE = "Recycle";
const KPIS = [{"l":"Total Battery Mfg","v":"6.576","t":"+6.7%","d":"up"},{"l":"Recycle Ativos","v":"9.056","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"91.1%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"61","t":"-2.0%","d":"down"}];
const COLS = ["ID","Recycle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Battery Mfg #001","Battery Mfg #002","1.874","5.698","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Battery Mfg #002","Battery Mfg #003","4.020","5.117","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Battery Mfg #003","Battery Mfg #004","1.031","5.576","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Battery Mfg #004","Battery Mfg #005","5.335","8.042","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Battery Mfg #005","Battery Mfg #001","3.666","5.715","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":350},{"label":"Mar","value":514},{"label":"Abr","value":374},{"label":"Mai","value":480},{"label":"Jun","value":584},{"label":"Jul","value":292},{"label":"Ago","value":673},{"label":"Set","value":539},{"label":"Out","value":656},{"label":"Nov","value":347},{"label":"Dez","value":520}];
const MX = 673;
