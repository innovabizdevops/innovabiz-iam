...
const PAGE = "Module";
const KPIS = [{"l":"Total Battery Mfg","v":"7.544","t":"+15.1%","d":"up"},{"l":"Module Ativos","v":"1.807","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"69.5%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"68","t":"+7.3%","d":"up"}];
const COLS = ["ID","Module","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Battery Mfg #001","Battery Mfg #002","5.799","1.405","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Battery Mfg #002","Battery Mfg #003","1.867","5.147","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Battery Mfg #003","Battery Mfg #004","7.173","8.320","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Battery Mfg #004","Battery Mfg #005","1.045","5.564","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Battery Mfg #005","Battery Mfg #001","5.755","693","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":672},{"label":"Fev","value":579},{"label":"Mar","value":439},{"label":"Abr","value":437},{"label":"Mai","value":539},{"label":"Jun","value":805},{"label":"Jul","value":767},{"label":"Ago","value":568},{"label":"Set","value":739},{"label":"Out","value":503},{"label":"Nov","value":624},{"label":"Dez","value":561}];
const MX = 805;
