...
const KPIS = [
    { label: "Total Registos", value: "8691", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "469", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€364K", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "44726891", cells: ["BAT-6891", "Battery Manufacturing Item 1", "28/12/2026", "€26 991"], status: "active" as const },
    { id: "44730462", cells: ["BAT-1462", "Battery Manufacturing Item 2", "15/7/2026", "€30 562"], status: "pending" as const },
    { id: "44734033", cells: ["BAT-5033", "Battery Manufacturing Item 3", "2/2/2026", "€34 133"], status: "completed" as const },
    { id: "44737604", cells: ["BAT-8604", "Battery Manufacturing Item 4", "17/9/2026", "€37 704"], status: "warning" as const },
    { id: "44741175", cells: ["BAT-3175", "Battery Manufacturing Item 5", "4/4/2026", "€41 275"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Battery Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Battery Manufacturing</p>
                    </div>
                </div>
