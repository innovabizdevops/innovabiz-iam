...
const KPIS = [{"l":"Dashboards Ativos","v":"5.520","t":"-2.5%","d":"down"},{"l":"Queries/Dia","v":"1004","t":"+5.0%","d":"up"},{"l":"Dados Processados (GB)","v":"6.114","t":"-2.8%","d":"down"},{"l":"Utilizadores Analytics","v":"4.274","t":"+9.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3170","2026-01-03","7.047","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1647","2026-01-09","6.128","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1542","2026-03-16","6.578","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1165","2026-01-15","535","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","941","2026-01-27","2.447","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":564},{"label":"Mar","value":640},{"label":"Abr","value":389},{"label":"Mai","value":503},{"label":"Jun","value":652},{"label":"Jul","value":649},{"label":"Ago","value":707},{"label":"Set","value":755},{"label":"Out","value":575},{"label":"Nov","value":711},{"label":"Dez","value":760}];
const MX = 760;
