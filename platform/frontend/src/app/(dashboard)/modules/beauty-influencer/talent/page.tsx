...
const PAGE = "Talent";
const KPIS = [{"l":"Total Beauty Influencer","v":"1.434","t":"+1.8%","d":"up"},{"l":"Talent Ativos","v":"5.322","t":"-3.7%","d":"down"},{"l":"Eficiência (%)","v":"71.7%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"88","t":"+14.1%","d":"up"}];
const COLS = ["ID","Talent","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Beauty Influencer #001","Beauty Influencer #002","8.232","8.365","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Beauty Influencer #002","Beauty Influencer #003","6.009","2.527","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Beauty Influencer #003","Beauty Influencer #004","3.480","8.856","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Beauty Influencer #004","Beauty Influencer #005","5.475","7.819","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Beauty Influencer #005","Beauty Influencer #001","1.971","414","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":841},{"label":"Fev","value":593},{"label":"Mar","value":862},{"label":"Abr","value":663},{"label":"Mai","value":768},{"label":"Jun","value":815},{"label":"Jul","value":776},{"label":"Ago","value":537},{"label":"Set","value":502},{"label":"Out","value":475},{"label":"Nov","value":843},{"label":"Dez","value":669}];
const MX = 862;
