...
const PAGE = "Campaign";
const KPIS = [{"l":"Total Beauty Influencer","v":"3.811","t":"-4.8%","d":"down"},{"l":"Campaign Ativos","v":"690","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"83.2%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"61","t":"-2.5%","d":"down"}];
const COLS = ["ID","Campaign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Beauty Influencer #001","Beauty Influencer #002","4.044","5.850","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Beauty Influencer #002","Beauty Influencer #003","802","5.739","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Beauty Influencer #003","Beauty Influencer #004","4.032","2.370","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Beauty Influencer #004","Beauty Influencer #005","1.488","1.589","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Beauty Influencer #005","Beauty Influencer #001","6.304","5.737","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":537},{"label":"Mar","value":900},{"label":"Abr","value":812},{"label":"Mai","value":563},{"label":"Jun","value":611},{"label":"Jul","value":795},{"label":"Ago","value":613},{"label":"Set","value":635},{"label":"Out","value":855},{"label":"Nov","value":745},{"label":"Dez","value":589}];
const MX = 900;
