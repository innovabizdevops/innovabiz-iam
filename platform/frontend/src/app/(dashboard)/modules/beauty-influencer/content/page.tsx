...
const PAGE = "Content";
const KPIS = [{"l":"Total Beauty Influencer","v":"3.697","t":"+3.7%","d":"up"},{"l":"Content Ativos","v":"2.045","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"76.6%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"74","t":"+11.8%","d":"up"}];
const COLS = ["ID","Content","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Beauty Influencer #001","Beauty Influencer #002","7.584","493","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Beauty Influencer #002","Beauty Influencer #003","1.124","5.557","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Beauty Influencer #003","Beauty Influencer #004","2.395","1.899","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Beauty Influencer #004","Beauty Influencer #005","4.084","661","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Beauty Influencer #005","Beauty Influencer #001","7.186","5.303","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":760},{"label":"Fev","value":494},{"label":"Mar","value":774},{"label":"Abr","value":548},{"label":"Mai","value":689},{"label":"Jun","value":508},{"label":"Jul","value":730},{"label":"Ago","value":750},{"label":"Set","value":750},{"label":"Out","value":475},{"label":"Nov","value":617},{"label":"Dez","value":659}];
const MX = 774;
