...
/* ═══ Beauty Influencer Mgmt — Dashboard ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total Registos", value: "7597", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "658", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€235K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "-5%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1774414197", cells: ["BEA-2197", "Beauty Influencer Mgmt Item 1", "18/10/2026", "€14 297"], status: "active" as const },
    { id: "1774417768", cells: ["BEA-5768", "Beauty Influencer Mgmt Item 2", "5/5/2026", "€17 868"], status: "pending" as const },
    { id: "1774421339", cells: ["BEA-9339", "Beauty Influencer Mgmt Item 3", "20/12/2026", "€21 439"], status: "completed" as const },
    { id: "1774424910", cells: ["BEA-3910", "Beauty Influencer Mgmt Item 4", "7/7/2026", "€25 010"], status: "warning" as const },
    { id: "1774428481", cells: ["BEA-7481", "Beauty Influencer Mgmt Item 5", "22/2/2026", "€28 581"], status: "active" as const },
];
...
export default function BeautyInfluencerMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Beauty Influencer Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Beauty Influencer Mgmt</p>
                    </div>
                </div>
