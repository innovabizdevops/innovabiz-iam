...
const PAGE = "Revenue Chart";
const KPIS = [{"l":"ARR (€M)","v":"€2.3M","t":"-3.2%","d":"down"},{"l":"MRR (€)","v":"€28515","t":"+12.4%","d":"up"},{"l":"Churn (%)","v":"79.8%","t":"-0.8%","d":"down"},{"l":"ARPU (€)","v":"€86249","t":"+8.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 15417.34","3.065","€ 15245.49","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 17798.70","863","€ 5220.79","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 18327.39","814","€ 3042.56","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 27898.04","7.764","€ 32705.92","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 2303.75","574","€ 34462.87","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":636},{"label":"Mar","value":610},{"label":"Abr","value":666},{"label":"Mai","value":859},{"label":"Jun","value":916},{"label":"Jul","value":588},{"label":"Ago","value":626},{"label":"Set","value":656},{"label":"Out","value":654},{"label":"Nov","value":800},{"label":"Dez","value":870}];
const MX = 916;
