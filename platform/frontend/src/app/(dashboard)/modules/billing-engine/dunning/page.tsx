...
const PAGE = "Dunning Management";
const KPIS = [{"l":"Projetos Melhoria","v":"8.837","t":"+9.6%","d":"up"},{"l":"Savings (€)","v":"€49251","t":"+13.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"77.5%","t":"-4.4%","d":"down"},{"l":"Ciclos PDCA","v":"6.943","t":"-5.2%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.746","€ 14955.58","5.148","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.057","€ 24475.96","6.487","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.553","€ 47384.58","7.941","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.909","€ 29109.39","598","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.459","€ 34975.48","7.337","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":376},{"label":"Mar","value":617},{"label":"Abr","value":410},{"label":"Mai","value":386},{"label":"Jun","value":365},{"label":"Jul","value":451},{"label":"Ago","value":430},{"label":"Set","value":646},{"label":"Out","value":445},{"label":"Nov","value":468},{"label":"Dez","value":511}];
const MX = 646;
