...
const ACCENT = "#0d9488";
const MODULE = "Billing & Invoicing";
const PAGE = "E-Invoicing (PEPPOL)";
const KPIS = [{"l":"Total Billing Engine","v":"3.531","t":"+15.3%","d":"up"},{"l":"E Invoicing (PEPPOL) Ativos","v":"7.515","t":"+7.7%","d":"up"},{"l":"Eficiência (%)","v":"80.5%","t":"+5.5%","d":"up"},{"l":"Score Performance","v":"94","t":"+5.9%","d":"up"}];
const COLS = ["ID","E Invoicing (PEPPOL)","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Billing Engine #001","Billing Engine #002","980","5.777","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Billing Engine #002","Billing Engine #003","4.063","6.981","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Billing Engine #003","Billing Engine #004","7.819","1.301","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Billing Engine #004","Billing Engine #005","1.242","7.621","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Billing Engine #005","Billing Engine #001","4.851","7.007","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":832},{"label":"Fev","value":653},{"label":"Mar","value":720},{"label":"Abr","value":838},{"label":"Mai","value":829},{"label":"Jun","value":520},{"label":"Jul","value":738},{"label":"Ago","value":739},{"label":"Set","value":697},{"label":"Out","value":537},{"label":"Nov","value":819},{"label":"Dez","value":497}];
const MX = 838;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0d9488'}}>PEPPOL</span></h1>
                </div>
