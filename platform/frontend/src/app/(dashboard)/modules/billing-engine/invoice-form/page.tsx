...
const PAGE = "Invoice Template Form";
const KPIS = [{"l":"Formulários Ativos","v":"3.375","t":"+15.5%","d":"up"},{"l":"Submissões/Dia","v":"1946","t":"-3.6%","d":"down"},{"l":"Documentos Gerados","v":"4.034","t":"+7.9%","d":"up"},{"l":"Templates","v":"604","t":"+12.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.011","2026-03-14","928","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.670","2026-03-25","1.331","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.758","2026-02-27","4.573","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.322","2026-02-23","9.026","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","630","2026-02-27","3.028","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":654},{"label":"Mar","value":470},{"label":"Abr","value":600},{"label":"Mai","value":491},{"label":"Jun","value":542},{"label":"Jul","value":753},{"label":"Ago","value":624},{"label":"Set","value":541},{"label":"Out","value":761},{"label":"Nov","value":617},{"label":"Dez","value":765}];
const MX = 765;
