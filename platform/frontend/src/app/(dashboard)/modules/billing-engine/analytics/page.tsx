...
const PAGE = "Billing Analytics AI";
const KPIS = [{"l":"Dashboards Ativos","v":"2.806","t":"+17.7%","d":"up"},{"l":"Queries/Dia","v":"4417","t":"+8.8%","d":"up"},{"l":"Dados Processados (GB)","v":"2.685","t":"-2.2%","d":"down"},{"l":"Utilizadores Analytics","v":"8.951","t":"+2.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1256","2026-01-13","7.284","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4860","2026-03-25","6.938","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4515","2026-03-16","7.027","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4040","2026-02-28","1.462","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3635","2026-01-05","3.580","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":839},{"label":"Mar","value":568},{"label":"Abr","value":856},{"label":"Mai","value":667},{"label":"Jun","value":680},{"label":"Jul","value":672},{"label":"Ago","value":552},{"label":"Set","value":528},{"label":"Out","value":806},{"label":"Nov","value":686},{"label":"Dez","value":665}];
const MX = 856;
