...
const PAGE = "Payment Reconciliation";
const KPIS = [{"l":"Total Billing Engine","v":"3.112","t":"+5.2%","d":"up"},{"l":"Payment Reconciliation Ativos","v":"6.966","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"88.2%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"62","t":"+10.6%","d":"up"}];
const COLS = ["ID","Payment Reconciliation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Billing Engine #001","Billing Engine #002","8.291","5.115","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Billing Engine #002","Billing Engine #003","8.115","8.368","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Billing Engine #003","Billing Engine #004","3.292","832","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Billing Engine #004","Billing Engine #005","3.309","8.698","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Billing Engine #005","Billing Engine #001","3.398","1.690","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":447},{"label":"Mar","value":650},{"label":"Abr","value":561},{"label":"Mai","value":569},{"label":"Jun","value":362},{"label":"Jul","value":354},{"label":"Ago","value":377},{"label":"Set","value":366},{"label":"Out","value":331},{"label":"Nov","value":432},{"label":"Dez","value":340}];
const MX = 650;
