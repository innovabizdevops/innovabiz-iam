...
const PAGE = "Payment Gateway Config";
const KPIS = [{"l":"Integrações Ativas","v":"2.674","t":"+8.9%","d":"up"},{"l":"Chamadas/Hora","v":"1506","t":"+1.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"89.1%","t":"+14.5%","d":"up"},{"l":"Latência Média (ms)","v":"147ms","t":"+6.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","9.061","5.281","85.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.973","5.566","87.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.134","5.859","73.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.215","7.099","77.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.810","7.123","86.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":830},{"label":"Mar","value":622},{"label":"Abr","value":659},{"label":"Mai","value":640},{"label":"Jun","value":513},{"label":"Jul","value":562},{"label":"Ago","value":530},{"label":"Set","value":496},{"label":"Out","value":575},{"label":"Nov","value":725},{"label":"Dez","value":721}];
const MX = 830;
