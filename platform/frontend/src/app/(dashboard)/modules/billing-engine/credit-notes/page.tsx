...
const PAGE = "Credit Notes";
const KPIS = [{"l":"Integrações Ativas","v":"1.205","t":"+11.6%","d":"up"},{"l":"Chamadas/Hora","v":"719","t":"-5.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"73.0%","t":"+8.5%","d":"up"},{"l":"Latência Média (ms)","v":"189ms","t":"+4.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","156","7.177","92.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.808","8.905","75.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.480","6.642","81.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.364","6.537","83.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","839","7.578","95.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":900},{"label":"Fev","value":736},{"label":"Mar","value":1033},{"label":"Abr","value":926},{"label":"Mai","value":676},{"label":"Jun","value":711},{"label":"Jul","value":665},{"label":"Ago","value":731},{"label":"Set","value":768},{"label":"Out","value":871},{"label":"Nov","value":726},{"label":"Dez","value":779}];
const MX = 1033;
