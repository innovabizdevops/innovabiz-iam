...
const PAGE = "Alert";
const KPIS = [{"l":"Tickets Abertos","v":"2.366","t":"+1.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"76.7%","t":"+4.1%","d":"up"},{"l":"MTTR (h)","v":"22h","t":"+11.8%","d":"up"},{"l":"Satisfação (%)","v":"92.2%","t":"+15.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.277","2.836","2.502","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.949","658","3.644","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.127","9.005","3.216","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.151","5.981","5.303","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.929","3.627","5.809","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":933},{"label":"Fev","value":921},{"label":"Mar","value":590},{"label":"Abr","value":700},{"label":"Mai","value":612},{"label":"Jun","value":559},{"label":"Jul","value":874},{"label":"Ago","value":600},{"label":"Set","value":757},{"label":"Out","value":552},{"label":"Nov","value":886},{"label":"Dez","value":898}];
const MX = 933;
