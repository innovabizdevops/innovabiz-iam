...
const ACCENT = "#059669";
const MODULE = "SLA Management Platform";
const PAGE = "Monitor";
const KPIS = [{"l":"Tickets Abertos","v":"7.567","t":"+7.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"78.1%","t":"+0.9%","d":"up"},{"l":"MTTR (h)","v":"65h","t":"+10.1%","d":"up"},{"l":"Satisfação (%)","v":"76.0%","t":"+5.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.909","7.579","1.063","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.432","6.135","361","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.628","1.840","2.101","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.861","7.809","8.410","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.450","1.190","7.152","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1046},{"label":"Fev","value":878},{"label":"Mar","value":689},{"label":"Abr","value":733},{"label":"Mai","value":718},{"label":"Jun","value":1003},{"label":"Jul","value":807},{"label":"Ago","value":1017},{"label":"Set","value":743},{"label":"Out","value":685},{"label":"Nov","value":701},{"label":"Dez","value":999}];
const MX = 1046;
