...
const PAGE = "Define";
const KPIS = [{"l":"Tickets Abertos","v":"5.947","t":"+7.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"75.7%","t":"+15.2%","d":"up"},{"l":"MTTR (h)","v":"95h","t":"-4.9%","d":"down"},{"l":"Satisfação (%)","v":"74.1%","t":"-3.9%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.720","7.793","6.992","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.650","2.488","6.673","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.897","3.732","8.017","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.069","5.571","4.786","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.465","4.221","6.685","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":797},{"label":"Fev","value":626},{"label":"Mar","value":877},{"label":"Abr","value":638},{"label":"Mai","value":697},{"label":"Jun","value":900},{"label":"Jul","value":937},{"label":"Ago","value":593},{"label":"Set","value":933},{"label":"Out","value":868},{"label":"Nov","value":941},{"label":"Dez","value":705}];
const MX = 941;
