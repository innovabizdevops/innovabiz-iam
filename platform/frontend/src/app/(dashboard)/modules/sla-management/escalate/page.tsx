...
const PAGE = "Escalate";
const KPIS = [{"l":"Tickets Abertos","v":"5.515","t":"+16.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"83.4%","t":"+3.6%","d":"up"},{"l":"MTTR (h)","v":"97h","t":"+16.5%","d":"up"},{"l":"Satisfação (%)","v":"92.2%","t":"+14.7%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.960","4.994","4.207","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.476","2.924","8.861","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.296","7.881","7.919","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.243","8.708","4.861","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.836","7.653","3.961","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":606},{"label":"Mar","value":631},{"label":"Abr","value":509},{"label":"Mai","value":762},{"label":"Jun","value":848},{"label":"Jul","value":838},{"label":"Ago","value":867},{"label":"Set","value":753},{"label":"Out","value":593},{"label":"Nov","value":568},{"label":"Dez","value":492}];
const MX = 867;
