...
const PAGE = "Report";
const KPIS = [{"l":"Tickets Abertos","v":"107","t":"+4.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"72.8%","t":"+5.3%","d":"up"},{"l":"MTTR (h)","v":"50h","t":"+17.0%","d":"up"},{"l":"Satisfação (%)","v":"73.9%","t":"-3.1%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.680","7.029","1.441","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.843","6.753","1.587","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.553","3.831","7.260","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.133","1.525","7.234","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","9.047","4.134","2.019","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":369},{"label":"Fev","value":520},{"label":"Mar","value":529},{"label":"Abr","value":543},{"label":"Mai","value":634},{"label":"Jun","value":406},{"label":"Jul","value":313},{"label":"Ago","value":452},{"label":"Set","value":413},{"label":"Out","value":350},{"label":"Nov","value":546},{"label":"Dez","value":658}];
const MX = 658;
