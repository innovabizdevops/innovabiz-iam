...
/* ═══ SLA Management Platform — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "1909", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "535", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€335K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "-17%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1343233809", cells: ["SLA-2809", "SLA Management Platform Item 1", "2/10/2026", "€33 909"], status: "active" as const },
    { id: "1343237380", cells: ["SLA-6380", "SLA Management Platform Item 2", "17/5/2026", "€37 480"], status: "pending" as const },
    { id: "1343240951", cells: ["SLA-9951", "SLA Management Platform Item 3", "4/12/2026", "€41 051"], status: "completed" as const },
    { id: "1343244522", cells: ["SLA-4522", "SLA Management Platform Item 4", "19/7/2026", "€44 622"], status: "warning" as const },
    { id: "1343248093", cells: ["SLA-8093", "SLA Management Platform Item 5", "6/2/2026", "€48 193"], status: "active" as const },
];
...
export default function SlaManagementPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SLA Management Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SLA Management Platform</p>
                    </div>
                </div>
