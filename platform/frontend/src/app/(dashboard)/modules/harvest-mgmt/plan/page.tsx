...
const ACCENT = "#0ea5e9";
const MODULE = "Harvest Management";
const PAGE = "Harvest Plan";
const KPIS = [{"l":"Total Harvest Mgmt","v":"3.212","t":"+15.3%","d":"up"},{"l":"Harvest Plan Ativos","v":"5.563","t":"+17.3%","d":"up"},{"l":"Eficiência (%)","v":"81.7%","t":"+13.3%","d":"up"},{"l":"Score Performance","v":"86","t":"+8.8%","d":"up"}];
const COLS = ["ID","Harvest Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Harvest Mgmt #001","Harvest Mgmt #002","2.835","3.555","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Harvest Mgmt #002","Harvest Mgmt #003","4.606","1.308","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Harvest Mgmt #003","Harvest Mgmt #004","1.482","4.981","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Harvest Mgmt #004","Harvest Mgmt #005","6.417","5.079","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Harvest Mgmt #005","Harvest Mgmt #001","2.709","8.529","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":1018},{"label":"Mar","value":675},{"label":"Abr","value":949},{"label":"Mai","value":925},{"label":"Jun","value":961},{"label":"Jul","value":1000},{"label":"Ago","value":777},{"label":"Set","value":770},{"label":"Out","value":788},{"label":"Nov","value":672},{"label":"Dez","value":875}];
const MX = 1018;
