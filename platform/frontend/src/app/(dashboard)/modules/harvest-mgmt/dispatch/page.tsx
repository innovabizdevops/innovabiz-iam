...
const PAGE = "Machine Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"2.154","t":"+3.2%","d":"up"},{"l":"Viagens/Dia","v":"294","t":"+13.1%","d":"up"},{"l":"Pontualidade (%)","v":"93.7%","t":"+13.0%","d":"up"},{"l":"Passageiros/Dia","v":"1270","t":"-4.2%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-19","2026-01-03","6.429","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-21","2026-01-09","7.470","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-27","2026-01-24","4.085","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-13","2026-03-26","3.793","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-05","2026-01-26","3.446","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":440},{"label":"Mar","value":352},{"label":"Abr","value":326},{"label":"Mai","value":470},{"label":"Jun","value":579},{"label":"Jul","value":488},{"label":"Ago","value":653},{"label":"Set","value":631},{"label":"Out","value":478},{"label":"Nov","value":623},{"label":"Dez","value":651}];
const MX = 653;
