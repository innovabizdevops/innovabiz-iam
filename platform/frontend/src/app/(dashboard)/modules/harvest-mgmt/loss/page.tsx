...
const PAGE = "Loss Track";
const KPIS = [{"l":"Total Harvest Mgmt","v":"3.239","t":"+6.6%","d":"up"},{"l":"Loss Track Ativos","v":"8.494","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"71.8%","t":"+9.7%","d":"up"},{"l":"Score Performance","v":"93","t":"+11.7%","d":"up"}];
const COLS = ["ID","Loss Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Harvest Mgmt #001","Harvest Mgmt #002","4.355","945","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Harvest Mgmt #002","Harvest Mgmt #003","1.652","8.883","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Harvest Mgmt #003","Harvest Mgmt #004","6.822","5.928","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Harvest Mgmt #004","Harvest Mgmt #005","1.933","7.384","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Harvest Mgmt #005","Harvest Mgmt #001","4.446","436","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":434},{"label":"Fev","value":442},{"label":"Mar","value":428},{"label":"Abr","value":451},{"label":"Mai","value":462},{"label":"Jun","value":539},{"label":"Jul","value":726},{"label":"Ago","value":608},{"label":"Set","value":588},{"label":"Out","value":636},{"label":"Nov","value":671},{"label":"Dez","value":535}];
const MX = 726;
