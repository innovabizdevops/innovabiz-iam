...
const PAGE = "Yield Record";
const KPIS = [{"l":"Total Harvest Mgmt","v":"4.148","t":"+15.8%","d":"up"},{"l":"Yield Record Ativos","v":"5.201","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"88.6%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"91","t":"+15.8%","d":"up"}];
const COLS = ["ID","Yield Record","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Harvest Mgmt #001","Harvest Mgmt #002","7.782","902","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Harvest Mgmt #002","Harvest Mgmt #003","3.623","3.982","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Harvest Mgmt #003","Harvest Mgmt #004","4.916","6.845","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Harvest Mgmt #004","Harvest Mgmt #005","5.933","6.616","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Harvest Mgmt #005","Harvest Mgmt #001","2.155","7.930","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":948},{"label":"Mar","value":619},{"label":"Abr","value":668},{"label":"Mai","value":822},{"label":"Jun","value":641},{"label":"Jul","value":676},{"label":"Ago","value":677},{"label":"Set","value":907},{"label":"Out","value":920},{"label":"Nov","value":592},{"label":"Dez","value":749}];
const MX = 948;
