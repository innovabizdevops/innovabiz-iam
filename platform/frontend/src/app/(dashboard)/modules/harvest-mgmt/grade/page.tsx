...
const PAGE = "Quality Grade";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.645","t":"+9.9%","d":"up"},{"l":"NC Abertas","v":"8.093","t":"+7.6%","d":"up"},{"l":"Conformidade (%)","v":"67.8%","t":"+17.4%","d":"up"},{"l":"CAPAs Pendentes","v":"6.605","t":"+13.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.685","99.8%","2.331","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.220","97.5%","4.191","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.914","75.3%","8.339","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.116","76.9%","7.530","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.718","73.3%","775","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":477},{"label":"Fev","value":338},{"label":"Mar","value":520},{"label":"Abr","value":370},{"label":"Mai","value":470},{"label":"Jun","value":487},{"label":"Jul","value":426},{"label":"Ago","value":556},{"label":"Set","value":464},{"label":"Out","value":713},{"label":"Nov","value":587},{"label":"Dez","value":384}];
const MX = 713;
