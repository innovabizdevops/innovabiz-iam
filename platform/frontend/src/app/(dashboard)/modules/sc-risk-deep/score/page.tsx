...
const PAGE = "Score";
const KPIS = [{"l":"Riscos Identificados","v":"4.975","t":"+2.9%","d":"up"},{"l":"Mitigações Ativas","v":"2.963","t":"-5.8%","d":"down"},{"l":"Score Risco Geral","v":"83","t":"+12.5%","d":"up"},{"l":"Incidentes YTD","v":"6.733","t":"+16.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.119","7.376","5.319","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.388","530","5.235","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.921","8.010","2.798","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","927","501","5.839","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.552","323","7.097","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":905},{"label":"Fev","value":624},{"label":"Mar","value":863},{"label":"Abr","value":685},{"label":"Mai","value":656},{"label":"Jun","value":855},{"label":"Jul","value":874},{"label":"Ago","value":977},{"label":"Set","value":872},{"label":"Out","value":765},{"label":"Nov","value":951},{"label":"Dez","value":677}];
const MX = 977;
