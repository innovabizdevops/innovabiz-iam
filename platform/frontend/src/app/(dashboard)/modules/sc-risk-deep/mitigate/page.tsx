...
const PAGE = "Mitigate";
const KPIS = [{"l":"Riscos Identificados","v":"7.666","t":"+3.9%","d":"up"},{"l":"Mitigações Ativas","v":"1.793","t":"+16.3%","d":"up"},{"l":"Score Risco Geral","v":"74","t":"+10.4%","d":"up"},{"l":"Incidentes YTD","v":"6.798","t":"+4.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.081","1.912","8.476","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","833","7.021","7.636","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.096","6.198","7.813","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.502","2.308","935","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.053","7.725","7.713","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":499},{"label":"Mar","value":495},{"label":"Abr","value":544},{"label":"Mai","value":627},{"label":"Jun","value":524},{"label":"Jul","value":809},{"label":"Ago","value":615},{"label":"Set","value":733},{"label":"Out","value":770},{"label":"Nov","value":718},{"label":"Dez","value":774}];
const MX = 811;
