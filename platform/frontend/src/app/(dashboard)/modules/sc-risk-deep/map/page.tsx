...
const PAGE = "Map";
const KPIS = [{"l":"Riscos Identificados","v":"8.388","t":"+11.9%","d":"up"},{"l":"Mitigações Ativas","v":"4.907","t":"-1.8%","d":"down"},{"l":"Score Risco Geral","v":"88","t":"+2.7%","d":"up"},{"l":"Incidentes YTD","v":"3.330","t":"+14.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","114","1.434","8.933","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.472","2.806","2.180","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.438","1.600","4.436","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.199","1.686","824","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.618","591","6.783","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":319},{"label":"Fev","value":680},{"label":"Mar","value":400},{"label":"Abr","value":343},{"label":"Mai","value":464},{"label":"Jun","value":414},{"label":"Jul","value":661},{"label":"Ago","value":574},{"label":"Set","value":503},{"label":"Out","value":576},{"label":"Nov","value":611},{"label":"Dez","value":398}];
const MX = 680;
