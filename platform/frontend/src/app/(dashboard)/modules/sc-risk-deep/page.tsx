...
/* ═══ Supply Chain Risk Deep — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "4244", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4358", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€203K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "899191444", cells: ["SC-2444", "Supply Chain Risk Deep Item 1", "5/5/2026", "€41 544"], status: "active" as const },
    { id: "899195015", cells: ["SC-6015", "Supply Chain Risk Deep Item 2", "20/12/2026", "€45 115"], status: "pending" as const },
    { id: "899198586", cells: ["SC-9586", "Supply Chain Risk Deep Item 3", "7/7/2026", "€48 686"], status: "completed" as const },
    { id: "899202157", cells: ["SC-4157", "Supply Chain Risk Deep Item 4", "22/2/2026", "€2257"], status: "warning" as const },
    { id: "899205728", cells: ["SC-7728", "Supply Chain Risk Deep Item 5", "9/9/2026", "€5828"], status: "active" as const },
];
...
export default function SupplyChainRiskDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Supply Chain Risk Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Supply Chain Risk Deep</p>
                    </div>
                </div>
