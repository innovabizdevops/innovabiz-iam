...
const PAGE = "Report";
const KPIS = [{"l":"Riscos Identificados","v":"4.520","t":"+13.1%","d":"up"},{"l":"Mitigações Ativas","v":"8.378","t":"+2.2%","d":"up"},{"l":"Score Risco Geral","v":"78","t":"+17.4%","d":"up"},{"l":"Incidentes YTD","v":"5.141","t":"+8.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.855","5.823","1.190","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.449","7.689","4.386","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","827","1.528","3.023","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.124","111","1.780","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.695","8.774","5.302","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":818},{"label":"Fev","value":909},{"label":"Mar","value":729},{"label":"Abr","value":718},{"label":"Mai","value":666},{"label":"Jun","value":651},{"label":"Jul","value":693},{"label":"Ago","value":640},{"label":"Set","value":847},{"label":"Out","value":914},{"label":"Nov","value":603},{"label":"Dez","value":829}];
const MX = 914;
