...
const ACCENT = "#78350f";
const MODULE = "Supply Chain Risk Deep";
const PAGE = "Monitor";
const KPIS = [{"l":"Riscos Identificados","v":"211","t":"+3.7%","d":"up"},{"l":"Mitigações Ativas","v":"7.923","t":"+15.7%","d":"up"},{"l":"Score Risco Geral","v":"69","t":"+6.7%","d":"up"},{"l":"Incidentes YTD","v":"607","t":"+14.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.408","2.785","1.949","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.874","3.099","5.776","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.876","1.091","1.492","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.659","1.445","8.276","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.883","6.869","6.799","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":654},{"label":"Mar","value":481},{"label":"Abr","value":715},{"label":"Mai","value":744},{"label":"Jun","value":419},{"label":"Jul","value":570},{"label":"Ago","value":372},{"label":"Set","value":612},{"label":"Out","value":742},{"label":"Nov","value":593},{"label":"Dez","value":612}];
const MX = 744;
