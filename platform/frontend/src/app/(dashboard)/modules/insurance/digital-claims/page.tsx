...
const PAGE = "Digital Claims Portal";
const KPIS = [{"l":"Páginas Publicadas","v":"842","t":"-4.2%","d":"down"},{"l":"Visitantes/Dia","v":"5034","t":"-3.0%","d":"down"},{"l":"Conversão (%)","v":"67.8%","t":"+0.4%","d":"up"},{"l":"Performance Score","v":"81","t":"+2.8%","d":"up"}];
const COLS = ["Página","URL","Views/Dia","Bounce (%)","Conversão (%)","Estado"];
const ROWS = [{"id":"r0","cells":["/home","/products","1930","77.0%","82.6%","Ativo"],"status":"active"},{"id":"r1","cells":["/products","/pricing","1835","83.5%","73.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["/pricing","/about","3880","87.1%","73.6%","Concluído"],"status":"done"},{"id":"r3","cells":["/about","/contact","1373","96.0%","95.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["/contact","/home","4492","92.6%","79.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":997},{"label":"Fev","value":941},{"label":"Mar","value":926},{"label":"Abr","value":678},{"label":"Mai","value":814},{"label":"Jun","value":988},{"label":"Jul","value":783},{"label":"Ago","value":758},{"label":"Set","value":750},{"label":"Out","value":887},{"label":"Nov","value":831},{"label":"Dez","value":632}];
const MX = 997;
...
export default function DigitalClaimsPage() {
    return (
