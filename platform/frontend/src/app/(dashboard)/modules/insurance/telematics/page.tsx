...
const PAGE = "Telematics IoT";
const KPIS = [{"l":"Dispositivos Online","v":"7.665","t":"+4.8%","d":"up"},{"l":"Dados/Min (MB)","v":"4.485","t":"+15.0%","d":"up"},{"l":"Alertas Ativos","v":"2.176","t":"+15.2%","d":"up"},{"l":"Uptime (%)","v":"76.9%","t":"-0.8%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","1.858","233","4.411","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.420","7.796","1.946","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.080","7.203","3.205","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","939","2.480","3.259","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.799","1.221","8.882","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":803},{"label":"Mar","value":764},{"label":"Abr","value":822},{"label":"Mai","value":542},{"label":"Jun","value":881},{"label":"Jul","value":903},{"label":"Ago","value":544},{"label":"Set","value":607},{"label":"Out","value":869},{"label":"Nov","value":744},{"label":"Dez","value":831}];
const MX = 903;
