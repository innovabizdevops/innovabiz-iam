...
const PAGE = "Embedded Insurance";
const KPIS = [{"l":"Dashboards Ativos","v":"3.466","t":"-1.8%","d":"down"},{"l":"Queries/Dia","v":"3074","t":"+14.0%","d":"up"},{"l":"Dados Processados (GB)","v":"8.862","t":"+5.6%","d":"up"},{"l":"Utilizadores Analytics","v":"3.388","t":"-0.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4538","2026-02-22","3.102","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3117","2026-02-06","5.155","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3034","2026-03-21","2.346","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1806","2026-03-21","7.642","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","559","2026-02-22","5.849","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":357},{"label":"Fev","value":305},{"label":"Mar","value":678},{"label":"Abr","value":484},{"label":"Mai","value":478},{"label":"Jun","value":640},{"label":"Jul","value":495},{"label":"Ago","value":643},{"label":"Set","value":666},{"label":"Out","value":417},{"label":"Nov","value":437},{"label":"Dez","value":562}];
const MX = 678;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>New</span></h1>
                </div>
