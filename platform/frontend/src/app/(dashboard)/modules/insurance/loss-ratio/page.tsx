...
const PAGE = "Loss Ratio Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"607","t":"+3.4%","d":"up"},{"l":"Queries/Dia","v":"923","t":"-0.3%","d":"down"},{"l":"Dados Processados (GB)","v":"8.051","t":"-1.6%","d":"down"},{"l":"Utilizadores Analytics","v":"4.496","t":"+11.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2050","2026-03-16","7.413","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4311","2026-01-01","5.540","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2813","2026-02-19","3.938","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","522","2026-03-25","1.869","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1462","2026-02-02","2.499","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":893},{"label":"Mar","value":847},{"label":"Abr","value":655},{"label":"Mai","value":847},{"label":"Jun","value":662},{"label":"Jul","value":762},{"label":"Ago","value":919},{"label":"Set","value":965},{"label":"Out","value":732},{"label":"Nov","value":893},{"label":"Dez","value":912}];
const MX = 965;
