...
const ACCENT = "#0891b2";
const MODULE = "Insurance & InsurTech";
const PAGE = "Parametric Insurance";
const KPIS = [{"l":"Configurações","v":"8.091","t":"-3.8%","d":"down"},{"l":"Últimas Alterações","v":"5.379","t":"+9.8%","d":"up"},{"l":"Ambientes","v":"3.270","t":"+11.1%","d":"up"},{"l":"Versão Config","v":"225","t":"+15.6%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 45724.05","8.448","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 45850.06","3.106","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 11942.06","3.718","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 24871.90","1.220","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 31459.70","6.972","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":699},{"label":"Mar","value":639},{"label":"Abr","value":814},{"label":"Mai","value":629},{"label":"Jun","value":649},{"label":"Jul","value":604},{"label":"Ago","value":694},{"label":"Set","value":602},{"label":"Out","value":706},{"label":"Nov","value":865},{"label":"Dez","value":745}];
const MX = 865;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>Web3</span></h1>
                </div>
