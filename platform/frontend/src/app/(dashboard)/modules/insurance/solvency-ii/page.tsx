...
const PAGE = "Solvency II";
const KPIS = [{"l":"Total Insurance","v":"4.074","t":"+7.2%","d":"up"},{"l":"Solvency II Ativos","v":"4.141","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"88.1%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"78","t":"+17.8%","d":"up"}];
const COLS = ["ID","Solvency II","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurance #001","Insurance #002","9.080","3.117","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Insurance #002","Insurance #003","159","1.006","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurance #003","Insurance #004","762","2.945","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Insurance #004","Insurance #005","6.675","8.537","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurance #005","Insurance #001","8.379","6.601","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":255},{"label":"Mar","value":390},{"label":"Abr","value":370},{"label":"Mai","value":267},{"label":"Jun","value":501},{"label":"Jul","value":282},{"label":"Ago","value":494},{"label":"Set","value":410},{"label":"Out","value":492},{"label":"Nov","value":381},{"label":"Dez","value":261}];
const MX = 501;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>EU</span></h1>
                </div>
