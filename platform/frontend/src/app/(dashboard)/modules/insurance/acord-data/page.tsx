...
const PAGE = "ACORD Data Standards";
const KPIS = [{"l":"Total Insurance","v":"4.506","t":"+1.3%","d":"up"},{"l":"ACORD Data Standards Ativos","v":"4.238","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"74.3%","t":"-3.0%","d":"down"},{"l":"Score Performance","v":"75","t":"+7.5%","d":"up"}];
const COLS = ["ID","ACORD Data Standards","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurance #001","2026-01-25","8.485","5.958","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Insurance #002","2026-02-17","2.809","1.932","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurance #003","2026-03-20","5.943","4.601","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Insurance #004","2026-02-10","3.603","2.867","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurance #005","2026-01-11","5.839","6.667","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":467},{"label":"Fev","value":425},{"label":"Mar","value":433},{"label":"Abr","value":450},{"label":"Mai","value":406},{"label":"Jun","value":533},{"label":"Jul","value":399},{"label":"Ago","value":388},{"label":"Set","value":627},{"label":"Out","value":454},{"label":"Nov","value":305},{"label":"Dez","value":402}];
const MX = 627;
...
export default function AcordDataPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>ACORD</span></h1>
                </div>
