...
const PAGE = "Claims Flow";
const KPIS = [{"l":"Total Insurance","v":"8.227","t":"+0.8%","d":"up"},{"l":"Claims Flow Ativos","v":"5.824","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"94.6%","t":"+1.4%","d":"up"},{"l":"Score Performance","v":"64","t":"-2.4%","d":"down"}];
const COLS = ["ID","Claims Flow","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurance #001","Insurance #002","3.195","4.051","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Insurance #002","Insurance #003","3.491","4.461","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurance #003","Insurance #004","105","7.929","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Insurance #004","Insurance #005","6.841","4.541","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurance #005","Insurance #001","2.918","8.196","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":978},{"label":"Fev","value":985},{"label":"Mar","value":657},{"label":"Abr","value":803},{"label":"Mai","value":765},{"label":"Jun","value":977},{"label":"Jul","value":838},{"label":"Ago","value":729},{"label":"Set","value":916},{"label":"Out","value":900},{"label":"Nov","value":644},{"label":"Dez","value":839}];
const MX = 985;
...
export default function ClaimsFlowPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>Flow</span></h1>
                </div>
