...
const PAGE = "Actuarial Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"7.641","t":"+5.1%","d":"up"},{"l":"Queries/Dia","v":"2941","t":"+10.1%","d":"up"},{"l":"Dados Processados (GB)","v":"1.505","t":"+9.4%","d":"up"},{"l":"Utilizadores Analytics","v":"1.626","t":"+13.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1455","2026-03-16","8.548","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","345","2026-01-05","1.599","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","437","2026-03-21","3.168","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3143","2026-02-26","668","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3816","2026-03-22","2.907","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":747},{"label":"Mar","value":384},{"label":"Abr","value":400},{"label":"Mai","value":655},{"label":"Jun","value":731},{"label":"Jul","value":530},{"label":"Ago","value":706},{"label":"Set","value":577},{"label":"Out","value":638},{"label":"Nov","value":395},{"label":"Dez","value":382}];
const MX = 747;
