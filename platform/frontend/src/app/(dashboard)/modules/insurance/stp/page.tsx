...
const PAGE = "Straight-Through Processing";
const KPIS = [{"l":"Total Insurance","v":"4.879","t":"+13.2%","d":"up"},{"l":"Straight Through Processing Ativos","v":"7.545","t":"-0.2%","d":"down"},{"l":"Eficiência (%)","v":"83.5%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"69","t":"+13.1%","d":"up"}];
const COLS = ["ID","Straight Through Processing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurance #001","Insurance #002","2.780","2.493","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Insurance #002","Insurance #003","7.300","2.908","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurance #003","Insurance #004","4.896","8.171","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Insurance #004","Insurance #005","8.711","6.646","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurance #005","Insurance #001","7.333","1.032","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":447},{"label":"Mar","value":309},{"label":"Abr","value":349},{"label":"Mai","value":504},{"label":"Jun","value":431},{"label":"Jul","value":576},{"label":"Ago","value":449},{"label":"Set","value":568},{"label":"Out","value":631},{"label":"Nov","value":664},{"label":"Dez","value":547}];
const MX = 664;
