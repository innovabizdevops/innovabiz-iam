...
const PAGE = "ACORD Forms Engine";
const KPIS = [{"l":"Formulários Ativos","v":"620","t":"-5.3%","d":"down"},{"l":"Submissões/Dia","v":"2429","t":"+8.2%","d":"up"},{"l":"Documentos Gerados","v":"4.007","t":"-0.2%","d":"down"},{"l":"Templates","v":"7.125","t":"+4.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.130","2026-03-28","5.295","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.012","2026-01-06","8.713","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.630","2026-02-18","2.449","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.663","2026-03-24","5.547","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.942","2026-01-11","7.087","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":373},{"label":"Mar","value":327},{"label":"Abr","value":464},{"label":"Mai","value":342},{"label":"Jun","value":643},{"label":"Jul","value":511},{"label":"Ago","value":388},{"label":"Set","value":538},{"label":"Out","value":688},{"label":"Nov","value":599},{"label":"Dez","value":538}];
const MX = 688;
