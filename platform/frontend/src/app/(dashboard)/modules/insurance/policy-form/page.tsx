...
const PAGE = "Policy Form";
const KPIS = [{"l":"Formulários Ativos","v":"2.013","t":"-1.6%","d":"down"},{"l":"Submissões/Dia","v":"4390","t":"-5.3%","d":"down"},{"l":"Documentos Gerados","v":"8.288","t":"+4.3%","d":"up"},{"l":"Templates","v":"6.616","t":"+11.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.062","2026-03-06","6.645","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.502","2026-02-28","4.708","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.360","2026-02-15","4.621","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.158","2026-01-08","5.904","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.509","2026-02-10","535","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":646},{"label":"Mar","value":657},{"label":"Abr","value":664},{"label":"Mai","value":531},{"label":"Jun","value":555},{"label":"Jul","value":312},{"label":"Ago","value":329},{"label":"Set","value":309},{"label":"Out","value":351},{"label":"Nov","value":523},{"label":"Dez","value":431}];
const MX = 664;
