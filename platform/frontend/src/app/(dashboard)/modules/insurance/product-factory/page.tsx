...
const PAGE = "Product Factory";
const KPIS = [{"l":"Total Insurance","v":"3.403","t":"-3.4%","d":"down"},{"l":"Product Factory Ativos","v":"2.956","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"71.2%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"59","t":"+17.8%","d":"up"}];
const COLS = ["ID","Product Factory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurance #001","Insurance #002","6.912","3.650","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Insurance #002","Insurance #003","5.704","8.973","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurance #003","Insurance #004","6.879","840","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Insurance #004","Insurance #005","2.010","4.412","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurance #005","Insurance #001","6.980","2.264","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":403},{"label":"Mar","value":577},{"label":"Abr","value":398},{"label":"Mai","value":326},{"label":"Jun","value":273},{"label":"Jul","value":356},{"label":"Ago","value":308},{"label":"Set","value":588},{"label":"Out","value":524},{"label":"Nov","value":270},{"label":"Dez","value":469}];
const MX = 588;
