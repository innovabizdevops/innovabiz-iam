...
const KPIS = [{"l":"Total Insurance","v":"4.621","t":"+5.9%","d":"up"},{"l":"Underwriting AI Ativos","v":"7.013","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"74.4%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"88","t":"-0.6%","d":"down"}];
const COLS = ["ID","Underwriting AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurance #001","Insurance #002","3.827","7.357","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Insurance #002","Insurance #003","8.520","7.544","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurance #003","Insurance #004","7.202","6.745","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Insurance #004","Insurance #005","895","6.580","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurance #005","Insurance #001","3.445","3.399","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":791},{"label":"Fev","value":959},{"label":"Mar","value":934},{"label":"Abr","value":609},{"label":"Mai","value":857},{"label":"Jun","value":867},{"label":"Jul","value":826},{"label":"Ago","value":758},{"label":"Set","value":998},{"label":"Out","value":974},{"label":"Nov","value":808},{"label":"Dez","value":690}];
const MX = 998;
