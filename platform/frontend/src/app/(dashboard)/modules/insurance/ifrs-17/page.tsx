...
const PAGE = "IFRS 17 Reporting";
const KPIS = [{"l":"Total Insurance","v":"7.707","t":"-4.6%","d":"down"},{"l":"IFRS 17 Reporting Ativos","v":"4.207","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"75.7%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"93","t":"+14.3%","d":"up"}];
const COLS = ["ID","IFRS 17 Reporting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurance #001","Insurance #002","2.363","7.211","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Insurance #002","Insurance #003","5.734","3.108","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurance #003","Insurance #004","5.234","6.622","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Insurance #004","Insurance #005","2.143","2.968","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurance #005","Insurance #001","7.020","4.785","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":381},{"label":"Fev","value":328},{"label":"Mar","value":474},{"label":"Abr","value":433},{"label":"Mai","value":572},{"label":"Jun","value":407},{"label":"Jul","value":303},{"label":"Ago","value":339},{"label":"Set","value":284},{"label":"Out","value":382},{"label":"Nov","value":339},{"label":"Dez","value":354}];
const MX = 572;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>IFRS</span></h1>
                </div>
