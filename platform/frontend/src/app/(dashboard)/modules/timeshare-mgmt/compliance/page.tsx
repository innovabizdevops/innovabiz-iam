...
const KPIS = [{"l":"Auditorias Realizadas","v":"8.696","t":"-3.2%","d":"down"},{"l":"NC Abertas","v":"8.912","t":"-2.3%","d":"down"},{"l":"Conformidade (%)","v":"76.9%","t":"+8.1%","d":"up"},{"l":"CAPAs Pendentes","v":"5.984","t":"-3.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.335","80.5%","6.146","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","280","89.3%","7.096","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.961","74.2%","3.311","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.559","96.7%","5.806","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.514","84.8%","8.189","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":362},{"label":"Fev","value":485},{"label":"Mar","value":468},{"label":"Abr","value":354},{"label":"Mai","value":535},{"label":"Jun","value":517},{"label":"Jul","value":319},{"label":"Ago","value":266},{"label":"Set","value":291},{"label":"Out","value":385},{"label":"Nov","value":237},{"label":"Dez","value":596}];
const MX = 596;
