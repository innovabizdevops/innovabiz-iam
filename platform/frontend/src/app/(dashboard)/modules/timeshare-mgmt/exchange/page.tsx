...
const PAGE = "Exchange";
const KPIS = [{"l":"Total Timeshare Mgmt","v":"7.179","t":"-5.9%","d":"down"},{"l":"Exchange Ativos","v":"6.657","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"88.4%","t":"-6.0%","d":"down"},{"l":"Score Performance","v":"66","t":"+0.5%","d":"up"}];
const COLS = ["ID","Exchange","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Timeshare Mgmt #001","Timeshare Mgmt #002","8.757","2.481","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Timeshare Mgmt #002","Timeshare Mgmt #003","5.609","5.029","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Timeshare Mgmt #003","Timeshare Mgmt #004","3.749","3.776","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Timeshare Mgmt #004","Timeshare Mgmt #005","1.049","115","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Timeshare Mgmt #005","Timeshare Mgmt #001","7.859","7.834","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":366},{"label":"Fev","value":589},{"label":"Mar","value":626},{"label":"Abr","value":647},{"label":"Mai","value":596},{"label":"Jun","value":680},{"label":"Jul","value":359},{"label":"Ago","value":657},{"label":"Set","value":379},{"label":"Out","value":549},{"label":"Nov","value":553},{"label":"Dez","value":681}];
const MX = 681;
