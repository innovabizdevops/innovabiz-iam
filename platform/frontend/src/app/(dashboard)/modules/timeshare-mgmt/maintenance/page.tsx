...
const ACCENT = "#6366f1";
const MODULE = "Timeshare Mgmt";
const PAGE = "Maintenance";
const KPIS = [{"l":"Total Timeshare Mgmt","v":"2.446","t":"-0.3%","d":"down"},{"l":"Maintenance Ativos","v":"6.832","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"85.8%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"83","t":"-4.2%","d":"down"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Timeshare Mgmt #001","Timeshare Mgmt #002","5.563","2.358","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Timeshare Mgmt #002","Timeshare Mgmt #003","5.179","5.644","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Timeshare Mgmt #003","Timeshare Mgmt #004","4.798","1.831","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Timeshare Mgmt #004","Timeshare Mgmt #005","3.016","2.995","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Timeshare Mgmt #005","Timeshare Mgmt #001","8.503","8.497","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":712},{"label":"Fev","value":537},{"label":"Mar","value":492},{"label":"Abr","value":776},{"label":"Mai","value":737},{"label":"Jun","value":790},{"label":"Jul","value":526},{"label":"Ago","value":682},{"label":"Set","value":774},{"label":"Out","value":801},{"label":"Nov","value":800},{"label":"Dez","value":723}];
const MX = 801;
