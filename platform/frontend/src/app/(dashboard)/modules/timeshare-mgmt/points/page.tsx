...
const PAGE = "Points";
const KPIS = [{"l":"Total Timeshare Mgmt","v":"6.667","t":"+1.2%","d":"up"},{"l":"Points Ativos","v":"4.384","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"69.6%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"94","t":"+4.3%","d":"up"}];
const COLS = ["ID","Points","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Timeshare Mgmt #001","Timeshare Mgmt #002","1.959","4.006","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Timeshare Mgmt #002","Timeshare Mgmt #003","6.059","4.747","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Timeshare Mgmt #003","Timeshare Mgmt #004","4.779","3.174","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Timeshare Mgmt #004","Timeshare Mgmt #005","2.030","5.457","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Timeshare Mgmt #005","Timeshare Mgmt #001","1.740","6.183","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":619},{"label":"Mar","value":577},{"label":"Abr","value":706},{"label":"Mai","value":719},{"label":"Jun","value":502},{"label":"Jul","value":624},{"label":"Ago","value":730},{"label":"Set","value":400},{"label":"Out","value":761},{"label":"Nov","value":588},{"label":"Dez","value":536}];
const MX = 761;
