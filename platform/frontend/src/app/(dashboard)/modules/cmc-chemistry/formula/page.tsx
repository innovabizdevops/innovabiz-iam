...
const ACCENT = "#6366f1";
const MODULE = "CMC & Chemistry";
const PAGE = "Formulation";
const KPIS = [{"l":"Formulários Ativos","v":"7.458","t":"+4.3%","d":"up"},{"l":"Submissões/Dia","v":"3878","t":"+2.8%","d":"up"},{"l":"Documentos Gerados","v":"5.683","t":"+4.8%","d":"up"},{"l":"Templates","v":"6.690","t":"+0.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","188","2026-02-11","7.704","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","510","2026-02-08","5.171","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.572","2026-01-20","1.280","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.493","2026-01-15","8.359","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.730","2026-03-16","8.905","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":470},{"label":"Mar","value":307},{"label":"Abr","value":663},{"label":"Mai","value":650},{"label":"Jun","value":451},{"label":"Jul","value":480},{"label":"Ago","value":608},{"label":"Set","value":307},{"label":"Out","value":593},{"label":"Nov","value":323},{"label":"Dez","value":344}];
const MX = 663;
