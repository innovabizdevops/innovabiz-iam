...
export default function CmcChemistryPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Cmc Chemistry</h1><p className="text-sm text-muted-foreground">Cmc Chemistry • iBOS Enterprise</p></div>
