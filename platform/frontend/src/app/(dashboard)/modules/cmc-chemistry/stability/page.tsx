...
const KPIS = [{"l":"Total Cmc Chemistry","v":"6.825","t":"+8.3%","d":"up"},{"l":"Stability Ativos","v":"8.636","t":"+0.6%","d":"up"},{"l":"Eficiência (%)","v":"67.8%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"72","t":"+7.3%","d":"up"}];
const COLS = ["ID","Stability","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cmc Chemistry #001","Cmc Chemistry #002","101","4.183","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Cmc Chemistry #002","Cmc Chemistry #003","3.044","6.837","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Cmc Chemistry #003","Cmc Chemistry #004","4.670","2.986","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Cmc Chemistry #004","Cmc Chemistry #005","8.120","5.592","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cmc Chemistry #005","Cmc Chemistry #001","1.207","1.309","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":568},{"label":"Mar","value":405},{"label":"Abr","value":346},{"label":"Mai","value":248},{"label":"Jun","value":613},{"label":"Jul","value":574},{"label":"Ago","value":455},{"label":"Set","value":564},{"label":"Out","value":254},{"label":"Nov","value":303},{"label":"Dez","value":347}];
const MX = 613;
