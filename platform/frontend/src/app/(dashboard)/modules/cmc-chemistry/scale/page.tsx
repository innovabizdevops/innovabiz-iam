...
const PAGE = "Scale Up";
const KPIS = [{"l":"Total Cmc Chemistry","v":"2.738","t":"+11.8%","d":"up"},{"l":"Scale Up Ativos","v":"1.482","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"82","t":"+16.0%","d":"up"}];
const COLS = ["ID","Scale Up","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cmc Chemistry #001","Cmc Chemistry #002","1.518","6.780","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Cmc Chemistry #002","Cmc Chemistry #003","7.581","7.668","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Cmc Chemistry #003","Cmc Chemistry #004","5.096","1.263","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Cmc Chemistry #004","Cmc Chemistry #005","8.946","3.479","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cmc Chemistry #005","Cmc Chemistry #001","6.986","6.502","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":956},{"label":"Mar","value":825},{"label":"Abr","value":1028},{"label":"Mai","value":1060},{"label":"Jun","value":930},{"label":"Jul","value":702},{"label":"Ago","value":938},{"label":"Set","value":883},{"label":"Out","value":726},{"label":"Nov","value":897},{"label":"Dez","value":873}];
const MX = 1060;
