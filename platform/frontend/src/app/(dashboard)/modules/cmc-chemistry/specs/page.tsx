...
const PAGE = "Specs";
const KPIS = [{"l":"Total Cmc Chemistry","v":"7.656","t":"-3.4%","d":"down"},{"l":"Specs Ativos","v":"6.702","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"89.3%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"65","t":"+10.2%","d":"up"}];
const COLS = ["ID","Specs","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cmc Chemistry #001","Cmc Chemistry #002","3.069","6.650","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Cmc Chemistry #002","Cmc Chemistry #003","1.841","5.677","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Cmc Chemistry #003","Cmc Chemistry #004","3.426","5.808","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Cmc Chemistry #004","Cmc Chemistry #005","4.248","6.129","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cmc Chemistry #005","Cmc Chemistry #001","1.178","7.118","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":486},{"label":"Fev","value":561},{"label":"Mar","value":624},{"label":"Abr","value":489},{"label":"Mai","value":629},{"label":"Jun","value":395},{"label":"Jul","value":703},{"label":"Ago","value":470},{"label":"Set","value":593},{"label":"Out","value":675},{"label":"Nov","value":355},{"label":"Dez","value":491}];
const MX = 703;
