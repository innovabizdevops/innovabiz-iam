...
/* ═══ CHRO Dashboard — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "6468", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3968", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€203K", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "727814768", cells: ["CHR-3768", "CHRO Dashboard Item 1", "17/9/2026", "€14 868"], status: "active" as const },
    { id: "727818339", cells: ["CHR-7339", "CHRO Dashboard Item 2", "4/4/2026", "€18 439"], status: "pending" as const },
    { id: "727821910", cells: ["CHR-1910", "CHRO Dashboard Item 3", "19/11/2026", "€22 010"], status: "completed" as const },
    { id: "727825481", cells: ["CHR-5481", "CHRO Dashboard Item 4", "6/6/2026", "€25 581"], status: "warning" as const },
    { id: "727829052", cells: ["CHR-9052", "CHRO Dashboard Item 5", "21/1/2026", "€29 152"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CHRO Dashboard</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CHRO Dashboard</p>
                    </div>
                </div>
