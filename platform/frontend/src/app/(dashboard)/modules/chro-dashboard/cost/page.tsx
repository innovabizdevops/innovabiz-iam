...
const PAGE = "Cost";
const KPIS = [{"l":"Teams Ativos","v":"4.307","t":"-1.1%","d":"down"},{"l":"Reuniões/Semana","v":"1943","t":"-1.2%","d":"down"},{"l":"Mensagens/Dia","v":"1859","t":"+6.8%","d":"up"},{"l":"Ficheiros Partilhados","v":"2.216","t":"+12.4%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","2.807","1196","1.078","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","926","449","3.151","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.228","2456","5.525","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.972","3039","8.222","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","6.272","3921","6.622","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":275},{"label":"Mar","value":457},{"label":"Abr","value":443},{"label":"Mai","value":367},{"label":"Jun","value":430},{"label":"Jul","value":574},{"label":"Ago","value":555},{"label":"Set","value":378},{"label":"Out","value":286},{"label":"Nov","value":503},{"label":"Dez","value":576}];
const MX = 576;
