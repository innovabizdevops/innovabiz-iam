...
const KPIS = [{"l":"eNPS","v":"90","t":"-4.0%","d":"down"},{"l":"Engagement (%)","v":"87.1%","t":"+15.6%","d":"up"},{"l":"Turnover (%)","v":"76.6%","t":"+15.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.963","t":"+11.5%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.353","2026-02-19","58","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.186","2026-03-12","93","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.294","2026-03-21","80","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.532","2026-02-26","80","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.427","2026-02-17","84","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":303},{"label":"Fev","value":343},{"label":"Mar","value":589},{"label":"Abr","value":418},{"label":"Mai","value":465},{"label":"Jun","value":564},{"label":"Jul","value":629},{"label":"Ago","value":473},{"label":"Set","value":357},{"label":"Out","value":529},{"label":"Nov","value":491},{"label":"Dez","value":360}];
const MX = 629;
