...
const KPIS = [{"l":"eNPS","v":"72","t":"+7.2%","d":"up"},{"l":"Engagement (%)","v":"86.7%","t":"+5.2%","d":"up"},{"l":"Turnover (%)","v":"81.4%","t":"+8.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.278","t":"+3.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","581","2026-02-06","71","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.641","2026-02-23","71","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.592","2026-02-13","84","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.491","2026-02-28","57","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.203","2026-02-15","62","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":405},{"label":"Fev","value":620},{"label":"Mar","value":403},{"label":"Abr","value":387},{"label":"Mai","value":325},{"label":"Jun","value":452},{"label":"Jul","value":344},{"label":"Ago","value":277},{"label":"Set","value":609},{"label":"Out","value":396},{"label":"Nov","value":595},{"label":"Dez","value":548}];
const MX = 620;
