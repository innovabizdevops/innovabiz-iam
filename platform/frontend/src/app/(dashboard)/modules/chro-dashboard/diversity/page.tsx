...
const ACCENT = "#1e293b";
const MODULE = "CHRO Dashboard";
const PAGE = "Diversity";
const KPIS = [{"l":"Teams Ativos","v":"307","t":"-0.1%","d":"down"},{"l":"Reuniões/Semana","v":"1433","t":"+2.2%","d":"up"},{"l":"Mensagens/Dia","v":"4191","t":"+8.4%","d":"up"},{"l":"Ficheiros Partilhados","v":"4.170","t":"-1.7%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","3.588","1706","1.653","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.786","1999","6.428","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","8.657","2338","7.274","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.777","2610","9.054","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","4.939","4994","1.699","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":348},{"label":"Fev","value":527},{"label":"Mar","value":629},{"label":"Abr","value":500},{"label":"Mai","value":456},{"label":"Jun","value":408},{"label":"Jul","value":391},{"label":"Ago","value":611},{"label":"Set","value":289},{"label":"Out","value":287},{"label":"Nov","value":303},{"label":"Dez","value":439}];
const MX = 629;
