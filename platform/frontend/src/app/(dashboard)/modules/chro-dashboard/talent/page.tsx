...
const PAGE = "Talent";
const KPIS = [{"l":"Teams Ativos","v":"3.034","t":"+14.6%","d":"up"},{"l":"Reuniões/Semana","v":"332","t":"+0.2%","d":"up"},{"l":"Mensagens/Dia","v":"3752","t":"+0.6%","d":"up"},{"l":"Ficheiros Partilhados","v":"1.031","t":"+1.5%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.250","987","1.654","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","8.789","964","4.776","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","5.984","979","8.919","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.683","2171","4.989","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","8.078","122","2.610","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":764},{"label":"Fev","value":920},{"label":"Mar","value":686},{"label":"Abr","value":912},{"label":"Mai","value":796},{"label":"Jun","value":817},{"label":"Jul","value":869},{"label":"Ago","value":806},{"label":"Set","value":613},{"label":"Out","value":687},{"label":"Nov","value":861},{"label":"Dez","value":882}];
const MX = 920;
