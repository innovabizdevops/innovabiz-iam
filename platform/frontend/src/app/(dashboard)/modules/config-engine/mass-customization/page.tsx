...
const PAGE = "Mass Customization";
const KPIS = [{"l":"Configurações","v":"2.208","t":"+7.8%","d":"up"},{"l":"Últimas Alterações","v":"793","t":"+12.8%","d":"up"},{"l":"Ambientes","v":"1.304","t":"+12.8%","d":"up"},{"l":"Versão Config","v":"2.084","t":"+14.6%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 36393.83","3.116","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 9767.42","795","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 45443.81","3.349","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 11037.00","4.411","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 26906.16","7.001","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":586},{"label":"Mar","value":525},{"label":"Abr","value":557},{"label":"Mai","value":757},{"label":"Jun","value":555},{"label":"Jul","value":466},{"label":"Ago","value":742},{"label":"Set","value":554},{"label":"Out","value":594},{"label":"Nov","value":434},{"label":"Dez","value":585}];
const MX = 757;
...
export default function MassCustomizationPage() {
    return (
