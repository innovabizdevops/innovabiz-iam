...
const PAGE = "No-Code Configurator";
const KPIS = [{"l":"Configurações","v":"156","t":"+17.9%","d":"up"},{"l":"Últimas Alterações","v":"5.189","t":"-5.8%","d":"down"},{"l":"Ambientes","v":"8.311","t":"+12.4%","d":"up"},{"l":"Versão Config","v":"3.755","t":"-1.8%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 16747.09","7.137","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 3716.36","8.747","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 19591.42","2.599","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 44408.43","695","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 884.81","2.263","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":975},{"label":"Fev","value":1030},{"label":"Mar","value":806},{"label":"Abr","value":920},{"label":"Mai","value":922},{"label":"Jun","value":858},{"label":"Jul","value":991},{"label":"Ago","value":909},{"label":"Set","value":852},{"label":"Out","value":943},{"label":"Nov","value":764},{"label":"Dez","value":847}];
const MX = 1030;
