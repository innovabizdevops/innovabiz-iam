...
const PAGE = "Visualization 3D";
const KPIS = [{"l":"Dashboards Ativos","v":"5.242","t":"-0.5%","d":"down"},{"l":"Queries/Dia","v":"4859","t":"+8.3%","d":"up"},{"l":"Dados Processados (GB)","v":"3.388","t":"+17.8%","d":"up"},{"l":"Utilizadores Analytics","v":"7.044","t":"-0.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1794","2026-03-09","364","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4633","2026-01-12","5.623","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","897","2026-01-10","3.690","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4501","2026-02-01","7.592","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1560","2026-01-03","7.637","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":962},{"label":"Fev","value":931},{"label":"Mar","value":801},{"label":"Abr","value":818},{"label":"Mai","value":1001},{"label":"Jun","value":1015},{"label":"Jul","value":814},{"label":"Ago","value":856},{"label":"Set","value":675},{"label":"Out","value":822},{"label":"Nov","value":691},{"label":"Dez","value":865}];
const MX = 1015;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#c2410c'}}>3D</span></h1>
                </div>
