...
const ACCENT = "#c2410c";
const MODULE = "Configuration Engine";
const PAGE = "Constraint Solver AI";
const KPIS = [{"l":"Configurações","v":"8.547","t":"-2.3%","d":"down"},{"l":"Últimas Alterações","v":"4.236","t":"-5.3%","d":"down"},{"l":"Ambientes","v":"4.843","t":"+6.2%","d":"up"},{"l":"Versão Config","v":"6.824","t":"-1.8%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 40071.08","1.897","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 37246.85","519","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 41991.68","1.116","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 33374.51","1.115","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 45934.39","3.189","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":587},{"label":"Mar","value":469},{"label":"Abr","value":446},{"label":"Mai","value":613},{"label":"Jun","value":545},{"label":"Jul","value":236},{"label":"Ago","value":492},{"label":"Set","value":429},{"label":"Out","value":381},{"label":"Nov","value":228},{"label":"Dez","value":398}];
const MX = 613;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#c2410c'}}>AI</span></h1>
                </div>
