...
const PAGE = "BOM Generator";
const KPIS = [{"l":"Produtos Ativos","v":"2.572","t":"-4.2%","d":"down"},{"l":"SKUs","v":"2.555","t":"-3.9%","d":"down"},{"l":"ECNs Pendentes","v":"5.739","t":"-3.6%","d":"down"},{"l":"Time-to-Market (dias)","v":"4.639","t":"-1.2%","d":"down"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","5.566","3.212","1.084","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","5.250","8.015","3.138","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","5.001","1.990","2.954","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","2.967","9.076","5.550","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","1.558","5.327","1.396","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":471},{"label":"Fev","value":303},{"label":"Mar","value":424},{"label":"Abr","value":458},{"label":"Mai","value":226},{"label":"Jun","value":540},{"label":"Jul","value":531},{"label":"Ago","value":375},{"label":"Set","value":349},{"label":"Out","value":399},{"label":"Nov","value":321},{"label":"Dez","value":448}];
const MX = 540;
...
export default function BomGenPage() {
    return (
