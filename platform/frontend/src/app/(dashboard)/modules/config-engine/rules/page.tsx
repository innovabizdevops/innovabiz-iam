...
const PAGE = "Rules Engine";
const KPIS = [{"l":"Configurações","v":"3.174","t":"+1.5%","d":"up"},{"l":"Últimas Alterações","v":"8.477","t":"+4.3%","d":"up"},{"l":"Ambientes","v":"3.652","t":"-5.9%","d":"down"},{"l":"Versão Config","v":"8.078","t":"-0.9%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 13507.03","5.723","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 15835.79","2.814","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 12489.92","4.799","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 4084.68","4.605","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 34405.70","1.308","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":502},{"label":"Fev","value":302},{"label":"Mar","value":538},{"label":"Abr","value":284},{"label":"Mai","value":498},{"label":"Jun","value":394},{"label":"Jul","value":251},{"label":"Ago","value":312},{"label":"Set","value":533},{"label":"Out","value":246},{"label":"Nov","value":312},{"label":"Dez","value":563}];
const MX = 563;
