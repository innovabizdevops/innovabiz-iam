...
const PAGE = "Product Configurator";
const KPIS = [{"l":"Configurações","v":"6.822","t":"+3.3%","d":"up"},{"l":"Últimas Alterações","v":"2.074","t":"-5.2%","d":"down"},{"l":"Ambientes","v":"7.278","t":"-2.6%","d":"down"},{"l":"Versão Config","v":"117","t":"+14.5%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 699.32","5.597","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 24750.28","8.411","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 49660.74","4.699","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 13900.80","7.476","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 21818.66","6.502","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":462},{"label":"Fev","value":699},{"label":"Mar","value":537},{"label":"Abr","value":420},{"label":"Mai","value":608},{"label":"Jun","value":641},{"label":"Jul","value":706},{"label":"Ago","value":575},{"label":"Set","value":496},{"label":"Out","value":540},{"label":"Nov","value":460},{"label":"Dez","value":437}];
const MX = 706;
