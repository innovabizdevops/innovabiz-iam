...
const PAGE = "Variant Management";
const KPIS = [{"l":"Projetos Melhoria","v":"7.084","t":"+14.8%","d":"up"},{"l":"Savings (€)","v":"€94924","t":"-4.8%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"90.6%","t":"+6.6%","d":"up"},{"l":"Ciclos PDCA","v":"8.489","t":"+3.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.449","€ 21793.61","3.284","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.147","€ 398.57","710","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.802","€ 30872.83","8.399","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","613","€ 9953.92","3.294","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.630","€ 10992.35","5.222","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":778},{"label":"Mar","value":578},{"label":"Abr","value":553},{"label":"Mai","value":422},{"label":"Jun","value":482},{"label":"Jul","value":392},{"label":"Ago","value":774},{"label":"Set","value":502},{"label":"Out","value":704},{"label":"Nov","value":682},{"label":"Dez","value":510}];
const MX = 778;
