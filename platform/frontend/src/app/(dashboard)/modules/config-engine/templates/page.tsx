...
const PAGE = "Template Library";
const KPIS = [{"l":"Formulários Ativos","v":"746","t":"+1.6%","d":"up"},{"l":"Submissões/Dia","v":"238","t":"+5.1%","d":"up"},{"l":"Documentos Gerados","v":"7.377","t":"+7.2%","d":"up"},{"l":"Templates","v":"124","t":"+1.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.908","2026-03-20","3.027","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.918","2026-01-11","5.979","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.456","2026-02-23","3.927","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.646","2026-01-03","8.663","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.453","2026-02-25","6.355","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":452},{"label":"Fev","value":590},{"label":"Mar","value":687},{"label":"Abr","value":526},{"label":"Mai","value":450},{"label":"Jun","value":634},{"label":"Jul","value":518},{"label":"Ago","value":463},{"label":"Set","value":572},{"label":"Out","value":415},{"label":"Nov","value":751},{"label":"Dez","value":547}];
const MX = 751;
