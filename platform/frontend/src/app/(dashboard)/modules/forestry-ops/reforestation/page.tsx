...
/* ═══ Forestry Ops — Reforestation ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "1508", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "419", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "800", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1833741695", cells: ["FOR-1695", "Reforestation Item 1", "24/12/2026", "€41 795"], status: "active" as const },
    { id: "1833745266", cells: ["FOR-5266", "Reforestation Item 2", "11/7/2026", "€45 366"], status: "pending" as const },
    { id: "1833748837", cells: ["FOR-8837", "Reforestation Item 3", "26/2/2026", "€48 937"], status: "completed" as const },
    { id: "1833752408", cells: ["FOR-3408", "Reforestation Item 4", "13/9/2026", "€2508"], status: "warning" as const },
    { id: "1833755979", cells: ["FOR-6979", "Reforestation Item 5", "28/4/2026", "€6079"], status: "active" as const },
];
...
export default function ForestryOpsReforestationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Reforestation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Forestry Ops • Reforestation</p>
                    </div>
                </div>
