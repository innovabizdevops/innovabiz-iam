...
/* ═══ Forestry Ops — Road Infra ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "460", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "280", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3226", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1632074900", cells: ["FOR-6900", "Road Infra Item 1", "9/9/2026", "€25 000"], status: "active" as const },
    { id: "1632078471", cells: ["FOR-1471", "Road Infra Item 2", "24/4/2026", "€28 571"], status: "pending" as const },
    { id: "1632082042", cells: ["FOR-5042", "Road Infra Item 3", "11/11/2026", "€32 142"], status: "completed" as const },
    { id: "1632085613", cells: ["FOR-8613", "Road Infra Item 4", "26/6/2026", "€35 713"], status: "warning" as const },
    { id: "1632089184", cells: ["FOR-3184", "Road Infra Item 5", "13/1/2026", "€39 284"], status: "active" as const },
];
...
export default function ForestryOpsRoadInfraPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Road Infra</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Forestry Ops • Road Infra</p>
                    </div>
                </div>
