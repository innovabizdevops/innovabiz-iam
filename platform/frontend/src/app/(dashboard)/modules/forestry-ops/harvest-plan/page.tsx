...
/* ═══ Forestry Ops — Harvest Plan ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "345", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "248", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3671", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "358806660", cells: ["FOR-4660", "Harvest Plan Item 1", "17/1/2026", "€6760"], status: "active" as const },
    { id: "358810231", cells: ["FOR-8231", "Harvest Plan Item 2", "4/8/2026", "€10 331"], status: "pending" as const },
    { id: "358813802", cells: ["FOR-2802", "Harvest Plan Item 3", "19/3/2026", "€13 902"], status: "completed" as const },
    { id: "358817373", cells: ["FOR-6373", "Harvest Plan Item 4", "6/10/2026", "€17 473"], status: "warning" as const },
    { id: "358820944", cells: ["FOR-9944", "Harvest Plan Item 5", "21/5/2026", "€21 044"], status: "active" as const },
];
...
export default function ForestryOpsHarvestPlanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Harvest Plan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Forestry Ops • Harvest Plan</p>
                    </div>
                </div>
