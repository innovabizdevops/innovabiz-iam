...
/* ═══ Forestry Ops — Fire Mgmt ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "3712", trend: "-19%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "77", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1199", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "753733593", cells: ["FOR-2593", "Fire Mgmt Item 1", "26/10/2026", "€33 693"], status: "active" as const },
    { id: "753737164", cells: ["FOR-6164", "Fire Mgmt Item 2", "13/5/2026", "€37 264"], status: "pending" as const },
    { id: "753740735", cells: ["FOR-9735", "Fire Mgmt Item 3", "28/12/2026", "€40 835"], status: "completed" as const },
    { id: "753744306", cells: ["FOR-4306", "Fire Mgmt Item 4", "15/7/2026", "€44 406"], status: "warning" as const },
    { id: "753747877", cells: ["FOR-7877", "Fire Mgmt Item 5", "2/2/2026", "€47 977"], status: "active" as const },
];
...
export default function ForestryOpsFireMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fire Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Forestry Ops • Fire Mgmt</p>
                    </div>
                </div>
