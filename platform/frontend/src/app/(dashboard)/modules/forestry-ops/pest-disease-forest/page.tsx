...
/* ═══ Forestry Ops — Pest Disease Forest ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "4400", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "205", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2978", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "611955097", cells: ["FOR-1097", "Pest Disease Forest Item 1", "6/2/2026", "€5197"], status: "active" as const },
    { id: "611958668", cells: ["FOR-4668", "Pest Disease Forest Item 2", "21/9/2026", "€8768"], status: "pending" as const },
    { id: "611962239", cells: ["FOR-8239", "Pest Disease Forest Item 3", "8/4/2026", "€12 339"], status: "completed" as const },
    { id: "611965810", cells: ["FOR-2810", "Pest Disease Forest Item 4", "23/11/2026", "€15 910"], status: "warning" as const },
    { id: "611969381", cells: ["FOR-6381", "Pest Disease Forest Item 5", "10/6/2026", "€19 481"], status: "active" as const },
];
...
export default function ForestryOpsPestDiseaseForestPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pest Disease Forest</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Forestry Ops • Pest Disease Forest</p>
                    </div>
                </div>
