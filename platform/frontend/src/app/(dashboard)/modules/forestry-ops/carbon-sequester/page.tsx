...
/* ═══ Forestry Ops — Carbon Sequester ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "235", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "242", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1497", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "83%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1976117326", cells: ["FOR-6326", "Carbon Sequester Item 1", "23/11/2026", "€17 426"], status: "active" as const },
    { id: "1976120897", cells: ["FOR-9897", "Carbon Sequester Item 2", "10/6/2026", "€20 997"], status: "pending" as const },
    { id: "1976124468", cells: ["FOR-4468", "Carbon Sequester Item 3", "25/1/2026", "€24 568"], status: "completed" as const },
    { id: "1976128039", cells: ["FOR-8039", "Carbon Sequester Item 4", "12/8/2026", "€28 139"], status: "warning" as const },
    { id: "1976131610", cells: ["FOR-2610", "Carbon Sequester Item 5", "27/3/2026", "€31 710"], status: "active" as const },
];
...
export default function ForestryOpsCarbonSequesterPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Carbon Sequester</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Forestry Ops • Carbon Sequester</p>
                    </div>
                </div>
