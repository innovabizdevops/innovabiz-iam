...
/* ═══ Forestry Ops — Forest Inventory ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "2485", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "449", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2958", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "907640285", cells: ["FOR-9285", "Forest Inventory Item 1", "14/6/2026", "€40 385"], status: "active" as const },
    { id: "907643856", cells: ["FOR-3856", "Forest Inventory Item 2", "1/1/2026", "€43 956"], status: "pending" as const },
    { id: "907647427", cells: ["FOR-7427", "Forest Inventory Item 3", "16/8/2026", "€47 527"], status: "completed" as const },
    { id: "907650998", cells: ["FOR-1998", "Forest Inventory Item 4", "3/3/2026", "€1098"], status: "warning" as const },
    { id: "907654569", cells: ["FOR-5569", "Forest Inventory Item 5", "18/10/2026", "€4669"], status: "active" as const },
];
...
export default function ForestryOpsForestInventoryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Forest Inventory</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Forestry Ops • Forest Inventory</p>
                    </div>
                </div>
