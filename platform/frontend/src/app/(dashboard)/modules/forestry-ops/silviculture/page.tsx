...
/* ═══ Forestry Ops — Silviculture ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "2160", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "331", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1513", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1366863255", cells: ["FOR-7255", "Silviculture Item 1", "24/4/2026", "€13 355"], status: "active" as const },
    { id: "1366866826", cells: ["FOR-1826", "Silviculture Item 2", "11/11/2026", "€16 926"], status: "pending" as const },
    { id: "1366870397", cells: ["FOR-5397", "Silviculture Item 3", "26/6/2026", "€20 497"], status: "completed" as const },
    { id: "1366873968", cells: ["FOR-8968", "Silviculture Item 4", "13/1/2026", "€24 068"], status: "warning" as const },
    { id: "1366877539", cells: ["FOR-3539", "Silviculture Item 5", "28/8/2026", "€27 639"], status: "active" as const },
];
...
export default function ForestryOpsSilviculturePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Silviculture</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Forestry Ops • Silviculture</p>
                    </div>
                </div>
