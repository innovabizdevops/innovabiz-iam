...
/* ═══ Forestry Ops — Timber Sale ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "3135", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "72", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "990", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "555987316", cells: ["FOR-4316", "Timber Sale Item 1", "25/5/2026", "€37 416"], status: "active" as const },
    { id: "555990887", cells: ["FOR-7887", "Timber Sale Item 2", "12/12/2026", "€40 987"], status: "pending" as const },
    { id: "555994458", cells: ["FOR-2458", "Timber Sale Item 3", "27/7/2026", "€44 558"], status: "completed" as const },
    { id: "555998029", cells: ["FOR-6029", "Timber Sale Item 4", "14/2/2026", "€48 129"], status: "warning" as const },
    { id: "556001600", cells: ["FOR-9600", "Timber Sale Item 5", "1/9/2026", "€1700"], status: "active" as const },
];
...
export default function ForestryOpsTimberSalePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Timber Sale</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Forestry Ops • Timber Sale</p>
                    </div>
                </div>
