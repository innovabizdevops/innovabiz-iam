...
/* ═══ Forestry Ops — Biodiversity Forest ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "3565", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "12", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2624", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "85%", trend: "-21%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "964340088", cells: ["FOR-9088", "Biodiversity Forest Item 1", "13/1/2026", "€40 188"], status: "active" as const },
    { id: "964343659", cells: ["FOR-3659", "Biodiversity Forest Item 2", "28/8/2026", "€43 759"], status: "pending" as const },
    { id: "964347230", cells: ["FOR-7230", "Biodiversity Forest Item 3", "15/3/2026", "€47 330"], status: "completed" as const },
    { id: "964350801", cells: ["FOR-1801", "Biodiversity Forest Item 4", "2/10/2026", "€901"], status: "warning" as const },
    { id: "964354372", cells: ["FOR-5372", "Biodiversity Forest Item 5", "17/5/2026", "€4472"], status: "active" as const },
];
...
export default function ForestryOpsBiodiversityForestPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Biodiversity Forest</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Forestry Ops • Biodiversity Forest</p>
                    </div>
                </div>
