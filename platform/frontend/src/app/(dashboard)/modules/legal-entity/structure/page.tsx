...
const ACCENT = "#7c3aed";
const MODULE = "Legal Entity Mgmt";
const PAGE = "Entity Structure";
const KPIS = [{"l":"Total Legal Entity","v":"1.992","t":"+4.4%","d":"up"},{"l":"Entity Structure Ativos","v":"510","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"73.9%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"92","t":"+1.3%","d":"up"}];
const COLS = ["ID","Entity Structure","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legal Entity #001","Legal Entity #002","4.440","874","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Legal Entity #002","Legal Entity #003","5.961","4.372","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Legal Entity #003","Legal Entity #004","5.998","6.811","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Legal Entity #004","Legal Entity #005","623","1.166","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legal Entity #005","Legal Entity #001","2.698","3.041","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":341},{"label":"Fev","value":282},{"label":"Mar","value":532},{"label":"Abr","value":468},{"label":"Mai","value":478},{"label":"Jun","value":669},{"label":"Jul","value":580},{"label":"Ago","value":310},{"label":"Set","value":536},{"label":"Out","value":570},{"label":"Nov","value":646},{"label":"Dez","value":626}];
const MX = 669;
