...
const PAGE = "Annual Filing";
const KPIS = [{"l":"Total Legal Entity","v":"263","t":"-3.0%","d":"down"},{"l":"Annual Filing Ativos","v":"7.505","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"86.4%","t":"+15.7%","d":"up"},{"l":"Score Performance","v":"64","t":"+1.4%","d":"up"}];
const COLS = ["ID","Annual Filing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legal Entity #001","Legal Entity #002","3.200","3.079","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Legal Entity #002","Legal Entity #003","8.045","6.741","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Legal Entity #003","Legal Entity #004","7.074","1.497","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Legal Entity #004","Legal Entity #005","2.719","4.001","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legal Entity #005","Legal Entity #001","4.489","2.574","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":634},{"label":"Mar","value":771},{"label":"Abr","value":830},{"label":"Mai","value":628},{"label":"Jun","value":783},{"label":"Jul","value":806},{"label":"Ago","value":829},{"label":"Set","value":696},{"label":"Out","value":823},{"label":"Nov","value":537},{"label":"Dez","value":665}];
const MX = 830;
