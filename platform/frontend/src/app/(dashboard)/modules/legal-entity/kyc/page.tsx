...
const PAGE = "KYC Entity";
const KPIS = [{"l":"Total Legal Entity","v":"1.369","t":"+11.4%","d":"up"},{"l":"KYC Entity Ativos","v":"8.374","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"69.3%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"67","t":"-1.7%","d":"down"}];
const COLS = ["ID","KYC Entity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legal Entity #001","Legal Entity #002","8.869","6.755","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Legal Entity #002","Legal Entity #003","7.821","2.046","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Legal Entity #003","Legal Entity #004","3.726","1.058","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Legal Entity #004","Legal Entity #005","8.085","8.375","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legal Entity #005","Legal Entity #001","3.471","7.891","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":425},{"label":"Mar","value":351},{"label":"Abr","value":537},{"label":"Mai","value":575},{"label":"Jun","value":557},{"label":"Jul","value":490},{"label":"Ago","value":690},{"label":"Set","value":646},{"label":"Out","value":596},{"label":"Nov","value":342},{"label":"Dez","value":367}];
const MX = 690;
