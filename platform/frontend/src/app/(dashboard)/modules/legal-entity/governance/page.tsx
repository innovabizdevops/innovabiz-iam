...
const KPIS = [{"l":"Riscos Identificados","v":"5.692","t":"+5.9%","d":"up"},{"l":"Mitigações Ativas","v":"6.866","t":"-3.0%","d":"down"},{"l":"Score Risco Geral","v":"64","t":"+13.3%","d":"up"},{"l":"Incidentes YTD","v":"7.021","t":"-4.4%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.880","4.951","1.091","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.556","593","4.340","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.969","1.173","5.359","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.501","7.883","1.929","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.326","4.595","4.494","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":625},{"label":"Mar","value":345},{"label":"Abr","value":684},{"label":"Mai","value":393},{"label":"Jun","value":357},{"label":"Jul","value":458},{"label":"Ago","value":484},{"label":"Set","value":427},{"label":"Out","value":473},{"label":"Nov","value":390},{"label":"Dez","value":469}];
const MX = 684;
