...
const PAGE = "Member";
const KPIS = [{"l":"Dashboards Ativos","v":"4.671","t":"+17.2%","d":"up"},{"l":"Queries/Dia","v":"384","t":"+12.7%","d":"up"},{"l":"Dados Processados (GB)","v":"406","t":"+8.5%","d":"up"},{"l":"Utilizadores Analytics","v":"2.608","t":"-4.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3059","2026-03-25","3.135","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4864","2026-03-20","7.836","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1622","2026-01-16","2.874","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","850","2026-03-22","7.913","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1297","2026-01-25","3.211","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":351},{"label":"Mar","value":500},{"label":"Abr","value":507},{"label":"Mai","value":446},{"label":"Jun","value":419},{"label":"Jul","value":586},{"label":"Ago","value":617},{"label":"Set","value":698},{"label":"Out","value":565},{"label":"Nov","value":669},{"label":"Dez","value":425}];
const MX = 698;
