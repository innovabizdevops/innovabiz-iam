...
const ACCENT = "#312e81";
const MODULE = "Cowork Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"1.223","t":"+10.9%","d":"up"},{"l":"Queries/Dia","v":"3224","t":"+7.8%","d":"up"},{"l":"Dados Processados (GB)","v":"4.215","t":"-0.1%","d":"down"},{"l":"Utilizadores Analytics","v":"8.599","t":"+17.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4955","2026-01-27","2.164","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1320","2026-02-25","7.015","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","686","2026-02-05","1.009","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","5084","2026-02-11","187","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4344","2026-03-04","2.002","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":834},{"label":"Mar","value":1042},{"label":"Abr","value":843},{"label":"Mai","value":690},{"label":"Jun","value":1039},{"label":"Jul","value":799},{"label":"Ago","value":816},{"label":"Set","value":1041},{"label":"Out","value":1050},{"label":"Nov","value":738},{"label":"Dez","value":854}];
const MX = 1050;
