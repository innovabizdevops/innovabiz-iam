...
const KPIS = [{"l":"Dashboards Ativos","v":"1.376","t":"-1.0%","d":"down"},{"l":"Queries/Dia","v":"4907","t":"+2.8%","d":"up"},{"l":"Dados Processados (GB)","v":"5.879","t":"+7.2%","d":"up"},{"l":"Utilizadores Analytics","v":"8.476","t":"+4.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1552","2026-02-03","6.250","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4906","2026-03-28","8.191","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2282","2026-03-07","5.716","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4844","2026-02-26","2.559","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3898","2026-01-08","6.033","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":307},{"label":"Mar","value":492},{"label":"Abr","value":594},{"label":"Mai","value":437},{"label":"Jun","value":364},{"label":"Jul","value":408},{"label":"Ago","value":543},{"label":"Set","value":297},{"label":"Out","value":258},{"label":"Nov","value":515},{"label":"Dez","value":366}];
const MX = 594;
