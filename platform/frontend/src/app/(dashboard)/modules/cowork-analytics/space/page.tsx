...
const PAGE = "Space";
const KPIS = [{"l":"Dashboards Ativos","v":"8.363","t":"+12.8%","d":"up"},{"l":"Queries/Dia","v":"1799","t":"+6.8%","d":"up"},{"l":"Dados Processados (GB)","v":"9.035","t":"+13.9%","d":"up"},{"l":"Utilizadores Analytics","v":"7.029","t":"+3.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4454","2026-03-03","1.806","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2559","2026-03-18","7.133","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2899","2026-03-14","970","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1497","2026-01-11","8.664","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2311","2026-01-03","6.829","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":358},{"label":"Fev","value":709},{"label":"Mar","value":570},{"label":"Abr","value":493},{"label":"Mai","value":678},{"label":"Jun","value":358},{"label":"Jul","value":619},{"label":"Ago","value":379},{"label":"Set","value":364},{"label":"Out","value":457},{"label":"Nov","value":448},{"label":"Dez","value":672}];
const MX = 709;
