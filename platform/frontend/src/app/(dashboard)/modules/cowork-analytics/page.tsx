...
const KPIS = [
    { label: "Total Registos", value: "1193", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1975", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€285K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "76686493", cells: ["COW-7493", "Cowork Analytics Item 1", "10/2/2026", "€36 593"], status: "active" as const },
    { id: "76690064", cells: ["COW-2064", "Cowork Analytics Item 2", "25/9/2026", "€40 164"], status: "pending" as const },
    { id: "76693635", cells: ["COW-5635", "Cowork Analytics Item 3", "12/4/2026", "€43 735"], status: "completed" as const },
    { id: "76697206", cells: ["COW-9206", "Cowork Analytics Item 4", "27/11/2026", "€47 306"], status: "warning" as const },
    { id: "76700777", cells: ["COW-3777", "Cowork Analytics Item 5", "14/6/2026", "€877"], status: "active" as const },
];
...
export default function CoworkAnalyticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cowork Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cowork Analytics</p>
                    </div>
                </div>
