...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€9.4M","t":"+8.0%","d":"up"},{"l":"MRR (€)","v":"€47178","t":"+1.5%","d":"up"},{"l":"Churn (%)","v":"65.3%","t":"-4.3%","d":"down"},{"l":"ARPU (€)","v":"€90701","t":"+17.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 37938.25","4.496","€ 23146.84","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 8664.71","4.301","€ 16831.10","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 18742.12","8.499","€ 35493.26","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 24394.35","5.093","€ 15919.66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 26907.14","3.778","€ 1117.86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":231},{"label":"Fev","value":451},{"label":"Mar","value":317},{"label":"Abr","value":475},{"label":"Mai","value":355},{"label":"Jun","value":416},{"label":"Jul","value":241},{"label":"Ago","value":550},{"label":"Set","value":570},{"label":"Out","value":465},{"label":"Nov","value":600},{"label":"Dez","value":305}];
const MX = 600;
