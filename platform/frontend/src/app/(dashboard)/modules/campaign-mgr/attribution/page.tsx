...
const KPIS = [{"l":"Total Campaign Mgr","v":"4.409","t":"+4.8%","d":"up"},{"l":"Attribution Ativos","v":"6.863","t":"-1.3%","d":"down"},{"l":"Eficiência (%)","v":"80.2%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"82","t":"+14.3%","d":"up"}];
const COLS = ["ID","Attribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Campaign Mgr #001","Campaign Mgr #002","1.109","197","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Campaign Mgr #002","Campaign Mgr #003","1.110","782","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Campaign Mgr #003","Campaign Mgr #004","2.043","1.664","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Campaign Mgr #004","Campaign Mgr #005","3.793","3.163","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Campaign Mgr #005","Campaign Mgr #001","1.986","6.528","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":369},{"label":"Fev","value":443},{"label":"Mar","value":598},{"label":"Abr","value":742},{"label":"Mai","value":455},{"label":"Jun","value":616},{"label":"Jul","value":482},{"label":"Ago","value":383},{"label":"Set","value":707},{"label":"Out","value":539},{"label":"Nov","value":404},{"label":"Dez","value":519}];
const MX = 742;
