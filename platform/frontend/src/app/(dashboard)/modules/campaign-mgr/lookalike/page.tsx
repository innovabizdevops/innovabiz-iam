...
const ACCENT = "#1e40af";
const MODULE = "Campaign Manager";
const PAGE = "Lookalike AI";
const KPIS = [{"l":"Total Campaign Mgr","v":"7.401","t":"+8.7%","d":"up"},{"l":"Lookalike AI Ativos","v":"3.319","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"94.7%","t":"+6.5%","d":"up"},{"l":"Score Performance","v":"63","t":"+15.0%","d":"up"}];
const COLS = ["ID","Lookalike AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Campaign Mgr #001","Campaign Mgr #002","3.477","8.310","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Campaign Mgr #002","Campaign Mgr #003","5.482","4.945","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Campaign Mgr #003","Campaign Mgr #004","5.493","1.013","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Campaign Mgr #004","Campaign Mgr #005","2.003","1.867","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Campaign Mgr #005","Campaign Mgr #001","1.358","9.033","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":654},{"label":"Mar","value":455},{"label":"Abr","value":731},{"label":"Mai","value":456},{"label":"Jun","value":505},{"label":"Jul","value":622},{"label":"Ago","value":674},{"label":"Set","value":741},{"label":"Out","value":737},{"label":"Nov","value":824},{"label":"Dez","value":682}];
const MX = 824;
