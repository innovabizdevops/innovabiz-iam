...
const KPIS = [{"l":"Total Campaign Mgr","v":"2.548","t":"+16.9%","d":"up"},{"l":"Multi Channel Ativos","v":"6.802","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"79.1%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"57","t":"+2.1%","d":"up"}];
const COLS = ["ID","Multi Channel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Campaign Mgr #001","Campaign Mgr #002","2.278","4.906","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Campaign Mgr #002","Campaign Mgr #003","7.892","3.989","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Campaign Mgr #003","Campaign Mgr #004","6.874","789","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Campaign Mgr #004","Campaign Mgr #005","461","4.491","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Campaign Mgr #005","Campaign Mgr #001","349","5.380","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":341},{"label":"Mar","value":365},{"label":"Abr","value":325},{"label":"Mai","value":296},{"label":"Jun","value":294},{"label":"Jul","value":344},{"label":"Ago","value":613},{"label":"Set","value":466},{"label":"Out","value":299},{"label":"Nov","value":644},{"label":"Dez","value":506}];
const MX = 644;
