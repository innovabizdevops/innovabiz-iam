...
const PAGE = "Campaign Builder";
const KPIS = [{"l":"Total Campaign Mgr","v":"1.303","t":"+17.2%","d":"up"},{"l":"Campaign Builder Ativos","v":"7.421","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"69.1%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"61","t":"+5.3%","d":"up"}];
const COLS = ["ID","Campaign Builder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Campaign Mgr #001","Campaign Mgr #002","2.152","2.901","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Campaign Mgr #002","Campaign Mgr #003","5.387","8.180","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Campaign Mgr #003","Campaign Mgr #004","3.828","3.736","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Campaign Mgr #004","Campaign Mgr #005","5.026","4.369","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Campaign Mgr #005","Campaign Mgr #001","2.676","2.469","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":721},{"label":"Mar","value":685},{"label":"Abr","value":782},{"label":"Mai","value":809},{"label":"Jun","value":785},{"label":"Jul","value":652},{"label":"Ago","value":514},{"label":"Set","value":705},{"label":"Out","value":883},{"label":"Nov","value":733},{"label":"Dez","value":642}];
const MX = 883;
