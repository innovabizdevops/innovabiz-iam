...
const PAGE = "Geo Targeting";
const KPIS = [{"l":"Total Campaign Mgr","v":"6.810","t":"-0.9%","d":"down"},{"l":"Geo Targeting Ativos","v":"8.130","t":"+4.0%","d":"up"},{"l":"Eficiência (%)","v":"86.6%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"79","t":"+0.2%","d":"up"}];
const COLS = ["ID","Geo Targeting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Campaign Mgr #001","Campaign Mgr #002","3.944","6.782","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Campaign Mgr #002","Campaign Mgr #003","7.767","8.777","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Campaign Mgr #003","Campaign Mgr #004","805","8.815","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Campaign Mgr #004","Campaign Mgr #005","2.683","3.474","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Campaign Mgr #005","Campaign Mgr #001","4.319","356","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":798},{"label":"Mar","value":751},{"label":"Abr","value":944},{"label":"Mai","value":802},{"label":"Jun","value":984},{"label":"Jul","value":715},{"label":"Ago","value":950},{"label":"Set","value":1016},{"label":"Out","value":864},{"label":"Nov","value":872},{"label":"Dez","value":917}];
const MX = 1016;
