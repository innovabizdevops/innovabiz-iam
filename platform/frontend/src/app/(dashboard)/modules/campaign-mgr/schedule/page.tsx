...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Campaign Mgr","v":"4.865","t":"+16.9%","d":"up"},{"l":"Schedule Ativos","v":"4.847","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"86.6%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"89","t":"+12.1%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Campaign Mgr #001","Campaign Mgr #002","4.068","5.335","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Campaign Mgr #002","Campaign Mgr #003","3.611","6.509","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Campaign Mgr #003","Campaign Mgr #004","431","6.065","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Campaign Mgr #004","Campaign Mgr #005","584","8.895","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Campaign Mgr #005","Campaign Mgr #001","7.530","6.093","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":979},{"label":"Mar","value":832},{"label":"Abr","value":859},{"label":"Mai","value":840},{"label":"Jun","value":606},{"label":"Jul","value":626},{"label":"Ago","value":638},{"label":"Set","value":770},{"label":"Out","value":678},{"label":"Nov","value":751},{"label":"Dez","value":941}];
const MX = 979;
