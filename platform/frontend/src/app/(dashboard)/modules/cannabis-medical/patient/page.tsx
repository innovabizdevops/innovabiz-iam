...
const PAGE = "Patient";
const KPIS = [{"l":"Integrações Ativas","v":"5.142","t":"+16.8%","d":"up"},{"l":"Chamadas/Hora","v":"2257","t":"+8.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.2%","t":"+9.9%","d":"up"},{"l":"Latência Média (ms)","v":"145ms","t":"-3.7%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.209","381","70.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","359","272","95.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.390","7.952","99.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.895","2.443","80.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.287","1.772","73.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":533},{"label":"Mar","value":696},{"label":"Abr","value":633},{"label":"Mai","value":760},{"label":"Jun","value":791},{"label":"Jul","value":633},{"label":"Ago","value":789},{"label":"Set","value":632},{"label":"Out","value":889},{"label":"Nov","value":836},{"label":"Dez","value":693}];
const MX = 889;
