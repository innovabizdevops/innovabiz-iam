...
const PAGE = "Prescribe";
const KPIS = [{"l":"Integrações Ativas","v":"7.440","t":"-1.0%","d":"down"},{"l":"Chamadas/Hora","v":"4867","t":"+7.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"94.0%","t":"+2.2%","d":"up"},{"l":"Latência Média (ms)","v":"5ms","t":"-2.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.362","4.528","98.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.250","2.870","77.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.211","1.296","71.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.120","1.551","81.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.055","4.015","92.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":697},{"label":"Mar","value":1064},{"label":"Abr","value":1067},{"label":"Mai","value":894},{"label":"Jun","value":695},{"label":"Jul","value":789},{"label":"Ago","value":817},{"label":"Set","value":983},{"label":"Out","value":822},{"label":"Nov","value":789},{"label":"Dez","value":707}];
const MX = 1067;
