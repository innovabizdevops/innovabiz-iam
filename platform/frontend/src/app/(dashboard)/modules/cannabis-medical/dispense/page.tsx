...
const PAGE = "Dispense";
const KPIS = [{"l":"Integrações Ativas","v":"1.421","t":"+2.9%","d":"up"},{"l":"Chamadas/Hora","v":"2185","t":"+3.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"73.0%","t":"+9.2%","d":"up"},{"l":"Latência Média (ms)","v":"121ms","t":"+4.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","784","936","98.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","928","6.414","72.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.307","580","80.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.261","4.813","99.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.853","883","86.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":839},{"label":"Mar","value":875},{"label":"Abr","value":824},{"label":"Mai","value":924},{"label":"Jun","value":717},{"label":"Jul","value":863},{"label":"Ago","value":893},{"label":"Set","value":854},{"label":"Out","value":849},{"label":"Nov","value":778},{"label":"Dez","value":1032}];
const MX = 1032;
