...
/* ═══ Medical Cannabis — Dashboard ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total Registos", value: "2352", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3084", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€72K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "351887852", cells: ["CAN-6852", "Medical Cannabis Item 1", "9/9/2026", "€37 952"], status: "active" as const },
    { id: "351891423", cells: ["CAN-1423", "Medical Cannabis Item 2", "24/4/2026", "€41 523"], status: "pending" as const },
    { id: "351894994", cells: ["CAN-4994", "Medical Cannabis Item 3", "11/11/2026", "€45 094"], status: "completed" as const },
    { id: "351898565", cells: ["CAN-8565", "Medical Cannabis Item 4", "26/6/2026", "€48 665"], status: "warning" as const },
    { id: "351902136", cells: ["CAN-3136", "Medical Cannabis Item 5", "13/1/2026", "€2236"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Medical Cannabis</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Medical Cannabis</p>
                    </div>
                </div>
