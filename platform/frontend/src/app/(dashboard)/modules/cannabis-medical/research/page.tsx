...
const ACCENT = "#15803d";
const MODULE = "Medical Cannabis";
const PAGE = "Research";
const KPIS = [{"l":"Integrações Ativas","v":"6.279","t":"+1.5%","d":"up"},{"l":"Chamadas/Hora","v":"3872","t":"-5.3%","d":"down"},{"l":"Taxa Sucesso (%)","v":"82.4%","t":"+6.0%","d":"up"},{"l":"Latência Média (ms)","v":"41ms","t":"+2.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.225","6.621","93.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.347","5.627","94.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","402","7.187","96.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.693","7.240","98.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.139","4.697","93.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":682},{"label":"Mar","value":522},{"label":"Abr","value":727},{"label":"Mai","value":609},{"label":"Jun","value":821},{"label":"Jul","value":635},{"label":"Ago","value":763},{"label":"Set","value":782},{"label":"Out","value":499},{"label":"Nov","value":840},{"label":"Dez","value":493}];
const MX = 840;
