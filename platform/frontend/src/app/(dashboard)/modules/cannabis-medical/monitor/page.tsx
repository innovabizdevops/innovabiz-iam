...
const PAGE = "Monitor";
const KPIS = [{"l":"Integrações Ativas","v":"7.545","t":"-4.6%","d":"down"},{"l":"Chamadas/Hora","v":"973","t":"+6.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"82.5%","t":"+9.5%","d":"up"},{"l":"Latência Média (ms)","v":"110ms","t":"+6.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","577","2.802","71.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.535","3.878","89.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.902","2.282","93.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.286","3.748","86.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.862","1.297","88.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":754},{"label":"Fev","value":884},{"label":"Mar","value":859},{"label":"Abr","value":693},{"label":"Mai","value":697},{"label":"Jun","value":928},{"label":"Jul","value":714},{"label":"Ago","value":764},{"label":"Set","value":1022},{"label":"Out","value":790},{"label":"Nov","value":939},{"label":"Dez","value":821}];
const MX = 1022;
