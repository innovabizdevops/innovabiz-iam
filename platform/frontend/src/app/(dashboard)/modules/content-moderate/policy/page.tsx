...
const PAGE = "Policy";
const KPIS = [{"l":"Total Content Moderate","v":"210","t":"+1.4%","d":"up"},{"l":"Policy Ativos","v":"3.828","t":"+14.6%","d":"up"},{"l":"Eficiência (%)","v":"75.3%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"77","t":"-5.5%","d":"down"}];
const COLS = ["ID","Policy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Content Moderate #001","Content Moderate #002","4.777","1.586","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Content Moderate #002","Content Moderate #003","5.576","6.678","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Content Moderate #003","Content Moderate #004","2.602","280","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Content Moderate #004","Content Moderate #005","5.329","2.730","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Content Moderate #005","Content Moderate #001","2.056","5.959","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":992},{"label":"Fev","value":955},{"label":"Mar","value":804},{"label":"Abr","value":911},{"label":"Mai","value":1027},{"label":"Jun","value":1076},{"label":"Jul","value":809},{"label":"Ago","value":886},{"label":"Set","value":880},{"label":"Out","value":932},{"label":"Nov","value":903},{"label":"Dez","value":861}];
const MX = 1076;
