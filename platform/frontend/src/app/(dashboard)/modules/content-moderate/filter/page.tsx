...
const ACCENT = "#6366f1";
const MODULE = "Content Moderation";
const PAGE = "Auto Filter";
const KPIS = [{"l":"Total Content Moderate","v":"1.900","t":"+3.2%","d":"up"},{"l":"Auto Filter Ativos","v":"3.368","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"94.0%","t":"+7.6%","d":"up"},{"l":"Score Performance","v":"59","t":"-1.3%","d":"down"}];
const COLS = ["ID","Auto Filter","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Content Moderate #001","Content Moderate #002","5.882","340","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Content Moderate #002","Content Moderate #003","2.345","8.985","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Content Moderate #003","Content Moderate #004","8.958","2.880","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Content Moderate #004","Content Moderate #005","3.648","3.194","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Content Moderate #005","Content Moderate #001","5.389","2.822","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":576},{"label":"Mar","value":843},{"label":"Abr","value":822},{"label":"Mai","value":693},{"label":"Jun","value":847},{"label":"Jul","value":784},{"label":"Ago","value":906},{"label":"Set","value":936},{"label":"Out","value":578},{"label":"Nov","value":749},{"label":"Dez","value":863}];
const MX = 936;
