...
const PAGE = "Predict";
const KPIS = [{"l":"Integrações Ativas","v":"4.251","t":"+5.7%","d":"up"},{"l":"Chamadas/Hora","v":"2059","t":"+13.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"74.7%","t":"-1.4%","d":"down"},{"l":"Latência Média (ms)","v":"87ms","t":"+7.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.831","1.086","88.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.965","372","70.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.902","4.981","82.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.895","8.475","83.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.350","8.550","72.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":813},{"label":"Mar","value":620},{"label":"Abr","value":479},{"label":"Mai","value":572},{"label":"Jun","value":732},{"label":"Jul","value":688},{"label":"Ago","value":689},{"label":"Set","value":714},{"label":"Out","value":755},{"label":"Nov","value":503},{"label":"Dez","value":660}];
const MX = 815;
