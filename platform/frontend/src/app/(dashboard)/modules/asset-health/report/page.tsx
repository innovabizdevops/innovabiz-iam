...
const PAGE = "Report";
const KPIS = [{"l":"Ativos Registados","v":"5.895","t":"-1.7%","d":"down"},{"l":"Valor Total (€M)","v":"€10.6M","t":"+4.8%","d":"up"},{"l":"Depreciação Anual (€)","v":"€39763","t":"+6.4%","d":"up"},{"l":"Ativos em Garantia","v":"5.059","t":"+1.5%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 9128.09","5.150","€ 25632.25","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 7212.25","7.681","€ 17202.86","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 37821.98","450","€ 32972.74","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 19766.14","8.440","€ 17061.18","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 11081.85","3.536","€ 13853.66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":649},{"label":"Mar","value":696},{"label":"Abr","value":558},{"label":"Mai","value":732},{"label":"Jun","value":813},{"label":"Jul","value":629},{"label":"Ago","value":851},{"label":"Set","value":566},{"label":"Out","value":639},{"label":"Nov","value":568},{"label":"Dez","value":717}];
const MX = 851;
