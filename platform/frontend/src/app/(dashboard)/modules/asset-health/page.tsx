...
/* ═══ Asset Health Platform — Dashboard ═══ */

const ACCENT = "#854d0e";

const KPIS = [
    { label: "Total Registos", value: "5508", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3281", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€402K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2118843008", cells: ["ASS-1008", "Asset Health Platform Item 1", "17/9/2026", "€43 108"], status: "active" as const },
    { id: "2118846579", cells: ["ASS-4579", "Asset Health Platform Item 2", "4/4/2026", "€46 679"], status: "pending" as const },
    { id: "2118850150", cells: ["ASS-8150", "Asset Health Platform Item 3", "19/11/2026", "€250"], status: "completed" as const },
    { id: "2118853721", cells: ["ASS-2721", "Asset Health Platform Item 4", "6/6/2026", "€3821"], status: "warning" as const },
    { id: "2118857292", cells: ["ASS-6292", "Asset Health Platform Item 5", "21/1/2026", "€7392"], status: "active" as const },
];
...
export default function AssetHealthPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Asset Health Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Asset Health Platform</p>
                    </div>
                </div>
