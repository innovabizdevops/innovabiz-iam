...
const ACCENT = "#854d0e";
const MODULE = "Asset Health Platform";
const PAGE = "Monitor";
const KPIS = [{"l":"Ativos Registados","v":"5.851","t":"+17.6%","d":"up"},{"l":"Valor Total (€M)","v":"€40.2M","t":"+16.0%","d":"up"},{"l":"Depreciação Anual (€)","v":"€26507","t":"-1.8%","d":"down"},{"l":"Ativos em Garantia","v":"3.577","t":"+14.8%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 36957.56","1.204","€ 35205.35","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 10529.42","2.828","€ 1129.41","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 11380.90","8.070","€ 46661.92","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 30504.85","6.532","€ 30145.38","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 15591.01","7.905","€ 27378.98","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":785},{"label":"Fev","value":667},{"label":"Mar","value":595},{"label":"Abr","value":778},{"label":"Mai","value":728},{"label":"Jun","value":587},{"label":"Jul","value":736},{"label":"Ago","value":692},{"label":"Set","value":582},{"label":"Out","value":525},{"label":"Nov","value":636},{"label":"Dez","value":546}];
const MX = 785;
