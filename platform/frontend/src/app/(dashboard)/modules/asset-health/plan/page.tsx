...
const PAGE = "Plan";
const KPIS = [{"l":"Ativos Registados","v":"5.892","t":"+1.8%","d":"up"},{"l":"Valor Total (€M)","v":"€13.0M","t":"+12.5%","d":"up"},{"l":"Depreciação Anual (€)","v":"€69414","t":"+10.9%","d":"up"},{"l":"Ativos em Garantia","v":"7.706","t":"+3.4%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 44006.63","8.107","€ 34008.58","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 44194.94","7.754","€ 35254.01","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 28959.28","5.064","€ 9521.56","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 19273.34","518","€ 21549.45","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 48646.57","1.313","€ 45023.45","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":557},{"label":"Mar","value":751},{"label":"Abr","value":792},{"label":"Mai","value":699},{"label":"Jun","value":818},{"label":"Jul","value":769},{"label":"Ago","value":755},{"label":"Set","value":708},{"label":"Out","value":844},{"label":"Nov","value":804},{"label":"Dez","value":530}];
const MX = 844;
