...
const PAGE = "Execute";
const KPIS = [{"l":"Ativos Registados","v":"3.516","t":"-5.3%","d":"down"},{"l":"Valor Total (€M)","v":"€19.7M","t":"+2.0%","d":"up"},{"l":"Depreciação Anual (€)","v":"€72145","t":"-4.3%","d":"down"},{"l":"Ativos em Garantia","v":"7.901","t":"-0.2%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 8907.00","1.105","€ 8044.30","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 10074.73","8.897","€ 48400.26","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 40198.83","1.663","€ 40248.63","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 42191.81","6.662","€ 27249.97","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 30821.82","8.804","€ 3303.44","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":576},{"label":"Mar","value":416},{"label":"Abr","value":627},{"label":"Mai","value":343},{"label":"Jun","value":264},{"label":"Jul","value":399},{"label":"Ago","value":297},{"label":"Set","value":439},{"label":"Out","value":322},{"label":"Nov","value":543},{"label":"Dez","value":407}];
const MX = 627;
