...
/* ═══ COSMOS Multi-Cloud Fabric — Dashboard ═══ */

const ACCENT = "#1e1b4b";

const KPIS = [
    { label: "Total Registos", value: "265", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4542", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€290K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "-23%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1856923365", cells: ["COS-8365", "COSMOS Multi-Cloud Fabric Item 1", "18/10/2026", "€23 465"], status: "active" as const },
    { id: "1856926936", cells: ["COS-2936", "COSMOS Multi-Cloud Fabric Item 2", "5/5/2026", "€27 036"], status: "pending" as const },
    { id: "1856930507", cells: ["COS-6507", "COSMOS Multi-Cloud Fabric Item 3", "20/12/2026", "€30 607"], status: "completed" as const },
    { id: "1856934078", cells: ["COS-1078", "COSMOS Multi-Cloud Fabric Item 4", "7/7/2026", "€34 178"], status: "warning" as const },
    { id: "1856937649", cells: ["COS-4649", "COSMOS Multi-Cloud Fabric Item 5", "22/2/2026", "€37 749"], status: "active" as const },
];
...
export default function CosmosMulticloudFabricPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">COSMOS Multi-Cloud Fabric</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • COSMOS Multi-Cloud Fabric</p>
                    </div>
                </div>
