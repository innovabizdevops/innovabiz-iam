...
const PAGE = "Deploy";
const KPIS = [{"l":"Total Cosmos Multi Cloud","v":"5.250","t":"-4.3%","d":"down"},{"l":"Deploy Ativos","v":"648","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"91.4%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"61","t":"+14.1%","d":"up"}];
const COLS = ["ID","Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Multi Cloud #001","Cosmos Multi Cloud #002","8.483","1.172","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Multi Cloud #002","Cosmos Multi Cloud #003","914","1.481","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Multi Cloud #003","Cosmos Multi Cloud #004","311","5.334","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Multi Cloud #004","Cosmos Multi Cloud #005","5.748","8.827","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Multi Cloud #005","Cosmos Multi Cloud #001","3.611","3.854","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":824},{"label":"Mar","value":770},{"label":"Abr","value":668},{"label":"Mai","value":1012},{"label":"Jun","value":833},{"label":"Jul","value":714},{"label":"Ago","value":878},{"label":"Set","value":740},{"label":"Out","value":1005},{"label":"Nov","value":649},{"label":"Dez","value":770}];
const MX = 1012;
