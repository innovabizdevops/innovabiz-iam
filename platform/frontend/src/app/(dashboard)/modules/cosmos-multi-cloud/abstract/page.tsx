...
const ACCENT = "#1e1b4b";
const MODULE = "COSMOS Multi-Cloud Fabric";
const PAGE = "Abstract";
const KPIS = [{"l":"Total Cosmos Multi Cloud","v":"3.240","t":"+14.7%","d":"up"},{"l":"Abstract Ativos","v":"5.334","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"70.5%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"61","t":"-2.7%","d":"down"}];
const COLS = ["ID","Abstract","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Multi Cloud #001","Cosmos Multi Cloud #002","2.618","920","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Multi Cloud #002","Cosmos Multi Cloud #003","6.822","8.330","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Multi Cloud #003","Cosmos Multi Cloud #004","7.482","2.878","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Multi Cloud #004","Cosmos Multi Cloud #005","4.441","7.777","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Multi Cloud #005","Cosmos Multi Cloud #001","1.625","1.893","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":678},{"label":"Mar","value":708},{"label":"Abr","value":665},{"label":"Mai","value":786},{"label":"Jun","value":763},{"label":"Jul","value":728},{"label":"Ago","value":616},{"label":"Set","value":499},{"label":"Out","value":545},{"label":"Nov","value":639},{"label":"Dez","value":814}];
const MX = 814;
