...
const KPIS = [{"l":"Total Foundation Mgmt","v":"8.492","t":"+2.1%","d":"up"},{"l":"Scholarship Ativos","v":"5.288","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"87.8%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"58","t":"+13.3%","d":"up"}];
const COLS = ["ID","Scholarship","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Foundation Mgmt #001","Foundation Mgmt #002","6.389","6.476","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Foundation Mgmt #002","Foundation Mgmt #003","1.874","9.070","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Foundation Mgmt #003","Foundation Mgmt #004","3.246","4.912","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Foundation Mgmt #004","Foundation Mgmt #005","7.140","5.843","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Foundation Mgmt #005","Foundation Mgmt #001","5.475","1.771","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":359},{"label":"Fev","value":433},{"label":"Mar","value":454},{"label":"Abr","value":389},{"label":"Mai","value":242},{"label":"Jun","value":235},{"label":"Jul","value":479},{"label":"Ago","value":590},{"label":"Set","value":299},{"label":"Out","value":509},{"label":"Nov","value":614},{"label":"Dez","value":500}];
const MX = 614;
