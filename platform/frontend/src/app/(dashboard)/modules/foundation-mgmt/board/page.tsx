...
const PAGE = "Board Mgmt";
const KPIS = [{"l":"Teams Ativos","v":"2.638","t":"+2.9%","d":"up"},{"l":"Reuniões/Semana","v":"4945","t":"+13.7%","d":"up"},{"l":"Mensagens/Dia","v":"2973","t":"-1.2%","d":"down"},{"l":"Ficheiros Partilhados","v":"6.818","t":"+10.6%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.918","573","5.392","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","5.558","2056","3.531","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","5.893","1252","2.214","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","1.370","2236","5.821","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","4.273","421","848","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":591},{"label":"Mar","value":487},{"label":"Abr","value":436},{"label":"Mai","value":645},{"label":"Jun","value":683},{"label":"Jul","value":563},{"label":"Ago","value":593},{"label":"Set","value":358},{"label":"Out","value":477},{"label":"Nov","value":430},{"label":"Dez","value":518}];
const MX = 719;
