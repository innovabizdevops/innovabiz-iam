...
const KPIS = [{"l":"Total Foundation Mgmt","v":"1.305","t":"-4.5%","d":"down"},{"l":"Investment Ativos","v":"6.852","t":"+10.2%","d":"up"},{"l":"Eficiência (%)","v":"90.8%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"70","t":"+16.4%","d":"up"}];
const COLS = ["ID","Investment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Foundation Mgmt #001","Foundation Mgmt #002","5.164","3.166","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Foundation Mgmt #002","Foundation Mgmt #003","2.210","3.730","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Foundation Mgmt #003","Foundation Mgmt #004","1.423","2.973","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Foundation Mgmt #004","Foundation Mgmt #005","2.592","4.928","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Foundation Mgmt #005","Foundation Mgmt #001","3.998","2.503","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":696},{"label":"Mar","value":747},{"label":"Abr","value":799},{"label":"Mai","value":794},{"label":"Jun","value":763},{"label":"Jul","value":632},{"label":"Ago","value":803},{"label":"Set","value":695},{"label":"Out","value":861},{"label":"Nov","value":695},{"label":"Dez","value":850}];
const MX = 861;
