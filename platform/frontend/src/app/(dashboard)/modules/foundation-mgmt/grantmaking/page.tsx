...
const ACCENT = "#1e40af";
const MODULE = "Foundation Management";
const PAGE = "Grantmaking";
const KPIS = [{"l":"Total Foundation Mgmt","v":"5.454","t":"+1.5%","d":"up"},{"l":"Grantmaking Ativos","v":"8.529","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"83.4%","t":"+5.8%","d":"up"},{"l":"Score Performance","v":"57","t":"-2.9%","d":"down"}];
const COLS = ["ID","Grantmaking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Foundation Mgmt #001","Foundation Mgmt #002","7.729","5.857","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Foundation Mgmt #002","Foundation Mgmt #003","744","2.247","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Foundation Mgmt #003","Foundation Mgmt #004","3.870","5.367","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Foundation Mgmt #004","Foundation Mgmt #005","7.909","321","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Foundation Mgmt #005","Foundation Mgmt #001","8.572","1.668","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":749},{"label":"Fev","value":584},{"label":"Mar","value":756},{"label":"Abr","value":467},{"label":"Mai","value":431},{"label":"Jun","value":441},{"label":"Jul","value":715},{"label":"Ago","value":575},{"label":"Set","value":460},{"label":"Out","value":686},{"label":"Nov","value":455},{"label":"Dez","value":693}];
const MX = 756;
