...
const PAGE = "Endowment";
const KPIS = [{"l":"Total Foundation Mgmt","v":"8.444","t":"-4.1%","d":"down"},{"l":"Endowment Ativos","v":"1.309","t":"+7.5%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"+15.7%","d":"up"},{"l":"Score Performance","v":"76","t":"+7.7%","d":"up"}];
const COLS = ["ID","Endowment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Foundation Mgmt #001","Foundation Mgmt #002","865","7.121","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Foundation Mgmt #002","Foundation Mgmt #003","3.155","8.868","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Foundation Mgmt #003","Foundation Mgmt #004","586","7.972","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Foundation Mgmt #004","Foundation Mgmt #005","2.707","8.622","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Foundation Mgmt #005","Foundation Mgmt #001","2.483","4.534","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":583},{"label":"Mar","value":481},{"label":"Abr","value":817},{"label":"Mai","value":701},{"label":"Jun","value":555},{"label":"Jul","value":761},{"label":"Ago","value":692},{"label":"Set","value":492},{"label":"Out","value":675},{"label":"Nov","value":464},{"label":"Dez","value":740}];
const MX = 817;
