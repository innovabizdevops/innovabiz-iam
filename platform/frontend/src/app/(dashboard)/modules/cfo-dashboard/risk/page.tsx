...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"5.724","t":"+6.5%","d":"up"},{"l":"Mitigações Ativas","v":"999","t":"+1.0%","d":"up"},{"l":"Score Risco Geral","v":"69","t":"+9.0%","d":"up"},{"l":"Incidentes YTD","v":"4.636","t":"+14.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.756","2.660","7.577","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.939","2.863","7.594","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.848","218","3.530","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.696","3.478","2.901","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.569","8.242","967","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":310},{"label":"Fev","value":424},{"label":"Mar","value":455},{"label":"Abr","value":346},{"label":"Mai","value":668},{"label":"Jun","value":411},{"label":"Jul","value":375},{"label":"Ago","value":679},{"label":"Set","value":428},{"label":"Out","value":460},{"label":"Nov","value":663},{"label":"Dez","value":341}];
const MX = 679;
