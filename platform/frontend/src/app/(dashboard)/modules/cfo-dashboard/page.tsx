...
/* ═══ CFO Dashboard — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "2734", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1708", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€471K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "-17%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1631096934", cells: ["CFO-9934", "CFO Dashboard Item 1", "27/7/2026", "€47 034"], status: "active" as const },
    { id: "1631100505", cells: ["CFO-4505", "CFO Dashboard Item 2", "14/2/2026", "€605"], status: "pending" as const },
    { id: "1631104076", cells: ["CFO-8076", "CFO Dashboard Item 3", "1/9/2026", "€4176"], status: "completed" as const },
    { id: "1631107647", cells: ["CFO-2647", "CFO Dashboard Item 4", "16/4/2026", "€7747"], status: "warning" as const },
    { id: "1631111218", cells: ["CFO-6218", "CFO Dashboard Item 5", "3/11/2026", "€11 318"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CFO Dashboard</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CFO Dashboard</p>
                    </div>
                </div>
