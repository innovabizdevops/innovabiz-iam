...
const PAGE = "P&amp;L";
const KPIS = [{"l":"Teams Ativos","v":"1.906","t":"-4.1%","d":"down"},{"l":"Reuniões/Semana","v":"1059","t":"-4.4%","d":"down"},{"l":"Mensagens/Dia","v":"3445","t":"+3.3%","d":"up"},{"l":"Ficheiros Partilhados","v":"2.519","t":"-3.7%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","2.682","4963","7.046","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","6.294","2831","4.141","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","7.123","3286","502","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","372","4398","1.992","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","4.737","454","5.117","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":768},{"label":"Fev","value":829},{"label":"Mar","value":792},{"label":"Abr","value":980},{"label":"Mai","value":965},{"label":"Jun","value":761},{"label":"Jul","value":935},{"label":"Ago","value":928},{"label":"Set","value":737},{"label":"Out","value":869},{"label":"Nov","value":765},{"label":"Dez","value":962}];
const MX = 980;
