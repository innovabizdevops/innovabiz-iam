...
const PAGE = "Budget";
const KPIS = [{"l":"Teams Ativos","v":"2.313","t":"+0.2%","d":"up"},{"l":"Reuniões/Semana","v":"1060","t":"+1.0%","d":"up"},{"l":"Mensagens/Dia","v":"1763","t":"-0.1%","d":"down"},{"l":"Ficheiros Partilhados","v":"8.868","t":"-5.8%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","3.602","3222","202","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.398","3613","3.326","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","4.485","5004","6.487","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.058","926","4.408","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","674","407","7.204","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":802},{"label":"Fev","value":697},{"label":"Mar","value":673},{"label":"Abr","value":611},{"label":"Mai","value":847},{"label":"Jun","value":519},{"label":"Jul","value":511},{"label":"Ago","value":758},{"label":"Set","value":703},{"label":"Out","value":736},{"label":"Nov","value":840},{"label":"Dez","value":788}];
const MX = 847;
