...
const ACCENT = "#1e293b";
const MODULE = "CFO Dashboard";
const PAGE = "Forecast";
const KPIS = [{"l":"Teams Ativos","v":"533","t":"+5.5%","d":"up"},{"l":"Reuniões/Semana","v":"1288","t":"+1.1%","d":"up"},{"l":"Mensagens/Dia","v":"4628","t":"-3.1%","d":"down"},{"l":"Ficheiros Partilhados","v":"304","t":"+2.2%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.273","1412","1.602","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.039","1269","7.382","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","9.087","4655","587","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","8.832","323","4.998","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","8.537","3376","7.399","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":684},{"label":"Mar","value":665},{"label":"Abr","value":934},{"label":"Mai","value":884},{"label":"Jun","value":773},{"label":"Jul","value":893},{"label":"Ago","value":676},{"label":"Set","value":997},{"label":"Out","value":802},{"label":"Nov","value":657},{"label":"Dez","value":1007}];
const MX = 1007;
