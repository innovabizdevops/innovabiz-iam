...
const PAGE = "Cash Flow";
const KPIS = [{"l":"Teams Ativos","v":"3.098","t":"-2.8%","d":"down"},{"l":"Reuniões/Semana","v":"1085","t":"+16.9%","d":"up"},{"l":"Mensagens/Dia","v":"4534","t":"-0.1%","d":"down"},{"l":"Ficheiros Partilhados","v":"648","t":"+17.8%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","8.428","3840","5.095","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","8.095","658","3.209","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","1.840","2629","4.656","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","8.660","227","142","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","8.860","3831","5.660","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":772},{"label":"Mar","value":723},{"label":"Abr","value":746},{"label":"Mai","value":671},{"label":"Jun","value":563},{"label":"Jul","value":773},{"label":"Ago","value":713},{"label":"Set","value":848},{"label":"Out","value":730},{"label":"Nov","value":880},{"label":"Dez","value":596}];
const MX = 880;
