...
const PAGE = "Material";
const KPIS = [{"l":"Total 3d Print Farm","v":"6.145","t":"+3.8%","d":"up"},{"l":"Material Ativos","v":"3.549","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"75.2%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"87","t":"-2.9%","d":"down"}];
const COLS = ["ID","Material","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Print Farm #001","3d Print Farm #002","2.732","1.980","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["3d Print Farm #002","3d Print Farm #003","5.948","3.250","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Print Farm #003","3d Print Farm #004","6.798","1.452","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["3d Print Farm #004","3d Print Farm #005","2.677","6.461","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Print Farm #005","3d Print Farm #001","7.930","7.836","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":302},{"label":"Mar","value":599},{"label":"Abr","value":329},{"label":"Mai","value":365},{"label":"Jun","value":322},{"label":"Jul","value":579},{"label":"Ago","value":338},{"label":"Set","value":361},{"label":"Out","value":667},{"label":"Nov","value":584},{"label":"Dez","value":397}];
const MX = 667;
