...
const PAGE = "Maintain";
const KPIS = [{"l":"Total 3d Print Farm","v":"5.071","t":"+10.1%","d":"up"},{"l":"Maintain Ativos","v":"7.152","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"66.2%","t":"+4.8%","d":"up"},{"l":"Score Performance","v":"62","t":"+1.4%","d":"up"}];
const COLS = ["ID","Maintain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Print Farm #001","3d Print Farm #002","1.538","4.201","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["3d Print Farm #002","3d Print Farm #003","2.904","548","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Print Farm #003","3d Print Farm #004","801","2.984","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["3d Print Farm #004","3d Print Farm #005","2.576","5.627","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Print Farm #005","3d Print Farm #001","5.678","6.007","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":599},{"label":"Mar","value":519},{"label":"Abr","value":474},{"label":"Mai","value":477},{"label":"Jun","value":455},{"label":"Jul","value":482},{"label":"Ago","value":593},{"label":"Set","value":284},{"label":"Out","value":503},{"label":"Nov","value":306},{"label":"Dez","value":373}];
const MX = 645;
