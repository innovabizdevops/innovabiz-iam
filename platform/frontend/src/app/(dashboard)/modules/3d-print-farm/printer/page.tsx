...
const PAGE = "Printer";
const KPIS = [{"l":"Total 3d Print Farm","v":"6.127","t":"+17.3%","d":"up"},{"l":"Printer Ativos","v":"4.831","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"66.4%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"64","t":"-4.7%","d":"down"}];
const COLS = ["ID","Printer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Print Farm #001","3d Print Farm #002","5.110","5.983","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["3d Print Farm #002","3d Print Farm #003","7.800","7.592","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Print Farm #003","3d Print Farm #004","2.831","4.445","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["3d Print Farm #004","3d Print Farm #005","2.610","1.231","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Print Farm #005","3d Print Farm #001","8.330","7.092","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":526},{"label":"Mar","value":603},{"label":"Abr","value":844},{"label":"Mai","value":577},{"label":"Jun","value":667},{"label":"Jul","value":652},{"label":"Ago","value":667},{"label":"Set","value":803},{"label":"Out","value":806},{"label":"Nov","value":656},{"label":"Dez","value":602}];
const MX = 904;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>IoT</span></h1>
                </div>
