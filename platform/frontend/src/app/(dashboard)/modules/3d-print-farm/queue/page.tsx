...
const PAGE = "Queue";
const KPIS = [{"l":"Total 3d Print Farm","v":"751","t":"+1.9%","d":"up"},{"l":"Queue Ativos","v":"9.079","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"93.5%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"82","t":"+4.0%","d":"up"}];
const COLS = ["ID","Queue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Print Farm #001","3d Print Farm #002","1.593","8.832","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["3d Print Farm #002","3d Print Farm #003","7.877","4.148","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Print Farm #003","3d Print Farm #004","1.213","2.578","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["3d Print Farm #004","3d Print Farm #005","8.462","8.590","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Print Farm #005","3d Print Farm #001","5.019","5.705","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":960},{"label":"Fev","value":1003},{"label":"Mar","value":809},{"label":"Abr","value":1035},{"label":"Mai","value":747},{"label":"Jun","value":666},{"label":"Jul","value":724},{"label":"Ago","value":856},{"label":"Set","value":705},{"label":"Out","value":737},{"label":"Nov","value":965},{"label":"Dez","value":928}];
const MX = 1035;
