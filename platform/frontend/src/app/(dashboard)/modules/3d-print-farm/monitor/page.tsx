...
const ACCENT = "#4f46e5";
const MODULE = "3D Print Farm";
const PAGE = "Monitor";
const KPIS = [{"l":"Total 3d Print Farm","v":"782","t":"+13.8%","d":"up"},{"l":"Monitor Ativos","v":"1.687","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"93.4%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"77","t":"-5.4%","d":"down"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Print Farm #001","3d Print Farm #002","5.495","6.448","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["3d Print Farm #002","3d Print Farm #003","3.011","3.005","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Print Farm #003","3d Print Farm #004","4.518","994","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["3d Print Farm #004","3d Print Farm #005","7.288","2.967","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Print Farm #005","3d Print Farm #001","6.897","5.451","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":454},{"label":"Fev","value":564},{"label":"Mar","value":517},{"label":"Abr","value":517},{"label":"Mai","value":516},{"label":"Jun","value":258},{"label":"Jul","value":536},{"label":"Ago","value":305},{"label":"Set","value":544},{"label":"Out","value":524},{"label":"Nov","value":350},{"label":"Dez","value":577}];
const MX = 577;
