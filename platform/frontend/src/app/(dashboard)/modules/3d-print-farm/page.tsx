...
/* ═══ 3D Print Farm — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "4105", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3795", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€405K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "-13%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "479312505", cells: ["3D-9505", "3D Print Farm Item 1", "22/10/2026", "€12 605"], status: "active" as const },
    { id: "479316076", cells: ["3D-4076", "3D Print Farm Item 2", "9/5/2026", "€16 176"], status: "pending" as const },
    { id: "479319647", cells: ["3D-7647", "3D Print Farm Item 3", "24/12/2026", "€19 747"], status: "completed" as const },
    { id: "479323218", cells: ["3D-2218", "3D Print Farm Item 4", "11/7/2026", "€23 318"], status: "warning" as const },
    { id: "479326789", cells: ["3D-5789", "3D Print Farm Item 5", "26/2/2026", "€26 889"], status: "active" as const },
];
...
export default function P3dPrintFarmPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">3D Print Farm</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • 3D Print Farm</p>
                    </div>
                </div>
