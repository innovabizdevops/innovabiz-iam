...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.714","t":"-0.6%","d":"down"},{"l":"NC Abertas","v":"640","t":"+17.6%","d":"up"},{"l":"Conformidade (%)","v":"80.5%","t":"+12.0%","d":"up"},{"l":"CAPAs Pendentes","v":"4.904","t":"+5.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","575","88.1%","2.405","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.684","77.9%","439","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.480","95.0%","3.639","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","499","90.7%","3.647","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.722","70.5%","5.083","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":805},{"label":"Mar","value":695},{"label":"Abr","value":744},{"label":"Mai","value":731},{"label":"Jun","value":771},{"label":"Jul","value":491},{"label":"Ago","value":501},{"label":"Set","value":599},{"label":"Out","value":836},{"label":"Nov","value":632},{"label":"Dez","value":749}];
const MX = 836;
