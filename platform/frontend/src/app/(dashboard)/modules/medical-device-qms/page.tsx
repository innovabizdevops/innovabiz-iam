...
/* ═══ Medical Device QMS — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "6313", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "701", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€244K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "305183613", cells: ["MED-3613", "Medical Device QMS Item 1", "22/10/2026", "€33 713"], status: "active" as const },
    { id: "305187184", cells: ["MED-7184", "Medical Device QMS Item 2", "9/5/2026", "€37 284"], status: "pending" as const },
    { id: "305190755", cells: ["MED-1755", "Medical Device QMS Item 3", "24/12/2026", "€40 855"], status: "completed" as const },
    { id: "305194326", cells: ["MED-5326", "Medical Device QMS Item 4", "11/7/2026", "€44 426"], status: "warning" as const },
    { id: "305197897", cells: ["MED-8897", "Medical Device QMS Item 5", "26/2/2026", "€47 997"], status: "active" as const },
];
...
export default function MedicalDeviceQmsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Medical Device QMS</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Medical Device QMS</p>
                    </div>
                </div>
