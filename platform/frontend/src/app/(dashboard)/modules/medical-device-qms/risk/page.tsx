...
const ACCENT = "#9333ea";
const MODULE = "Medical Device QMS";
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"1.014","t":"+2.7%","d":"up"},{"l":"Mitigações Ativas","v":"3.908","t":"+12.1%","d":"up"},{"l":"Score Risco Geral","v":"82","t":"+15.3%","d":"up"},{"l":"Incidentes YTD","v":"7.084","t":"-1.6%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.043","1.121","8.343","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.890","305","4.055","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.365","8.569","1.138","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.601","1.761","972","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.236","8.202","7.026","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1010},{"label":"Fev","value":796},{"label":"Mar","value":888},{"label":"Abr","value":1045},{"label":"Mai","value":957},{"label":"Jun","value":969},{"label":"Jul","value":864},{"label":"Ago","value":718},{"label":"Set","value":687},{"label":"Out","value":764},{"label":"Nov","value":987},{"label":"Dez","value":815}];
const MX = 1045;
