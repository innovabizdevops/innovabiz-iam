...
const PAGE = "Design";
const KPIS = [{"l":"Dispositivos Online","v":"6.588","t":"+11.1%","d":"up"},{"l":"Dados/Min (MB)","v":"6.250","t":"+16.5%","d":"up"},{"l":"Alertas Ativos","v":"8.145","t":"+0.5%","d":"up"},{"l":"Uptime (%)","v":"83.4%","t":"+11.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","8.551","6.896","3.800","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.755","8.406","1.449","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.384","4.581","1.870","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","8.441","5.885","6.577","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.753","6.919","6.002","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":806},{"label":"Fev","value":791},{"label":"Mar","value":870},{"label":"Abr","value":628},{"label":"Mai","value":603},{"label":"Jun","value":625},{"label":"Jul","value":912},{"label":"Ago","value":832},{"label":"Set","value":930},{"label":"Out","value":872},{"label":"Nov","value":796},{"label":"Dez","value":750}];
const MX = 930;
