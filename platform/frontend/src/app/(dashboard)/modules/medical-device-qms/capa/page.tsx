...
const PAGE = "CAPA";
const KPIS = [{"l":"Auditorias Realizadas","v":"625","t":"+11.4%","d":"up"},{"l":"NC Abertas","v":"7.572","t":"+15.6%","d":"up"},{"l":"Conformidade (%)","v":"68.1%","t":"-3.1%","d":"down"},{"l":"CAPAs Pendentes","v":"2.129","t":"+15.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.766","71.4%","4.785","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.064","85.6%","4.152","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.089","82.1%","2.759","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.716","71.3%","1.270","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.192","77.4%","8.843","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":556},{"label":"Mar","value":612},{"label":"Abr","value":416},{"label":"Mai","value":415},{"label":"Jun","value":467},{"label":"Jul","value":396},{"label":"Ago","value":658},{"label":"Set","value":470},{"label":"Out","value":450},{"label":"Nov","value":621},{"label":"Dez","value":606}];
const MX = 658;
