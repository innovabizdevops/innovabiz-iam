...
const PAGE = "Validate";
const KPIS = [{"l":"Dispositivos Online","v":"486","t":"+0.6%","d":"up"},{"l":"Dados/Min (MB)","v":"7.703","t":"-1.3%","d":"down"},{"l":"Alertas Ativos","v":"7.544","t":"+5.0%","d":"up"},{"l":"Uptime (%)","v":"93.7%","t":"+10.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.464","5.876","4.646","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.774","7.427","3.978","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.649","8.015","4.368","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.026","7.266","3.232","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.957","635","8.935","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":559},{"label":"Mar","value":608},{"label":"Abr","value":674},{"label":"Mai","value":531},{"label":"Jun","value":809},{"label":"Jul","value":737},{"label":"Ago","value":466},{"label":"Set","value":501},{"label":"Out","value":747},{"label":"Nov","value":646},{"label":"Dez","value":779}];
const MX = 809;
