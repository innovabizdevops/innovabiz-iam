...
const KPIS = [
    { label: "Total Registos", value: "6919", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4815", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€182K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "143962719", cells: ["E-8719", "E-Waste Recycling Item 1", "20/4/2026", "€12 819"], status: "active" as const },
    { id: "143966290", cells: ["E-3290", "E-Waste Recycling Item 2", "7/11/2026", "€16 390"], status: "pending" as const },
    { id: "143969861", cells: ["E-6861", "E-Waste Recycling Item 3", "22/6/2026", "€19 961"], status: "completed" as const },
    { id: "143973432", cells: ["E-1432", "E-Waste Recycling Item 4", "9/1/2026", "€23 532"], status: "warning" as const },
    { id: "143977003", cells: ["E-5003", "E-Waste Recycling Item 5", "24/8/2026", "€27 103"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">E-Waste Recycling</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • E-Waste Recycling</p>
                    </div>
                </div>
