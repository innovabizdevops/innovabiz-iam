...
const KPIS = [{"l":"Total Mine Environ","v":"1.053","t":"-0.6%","d":"down"},{"l":"Biodiversity Ativos","v":"2.828","t":"+15.0%","d":"up"},{"l":"Eficiência (%)","v":"82.7%","t":"+13.3%","d":"up"},{"l":"Score Performance","v":"74","t":"-3.0%","d":"down"}];
const COLS = ["ID","Biodiversity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mine Environ #001","Mine Environ #002","2.768","4.087","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Mine Environ #002","Mine Environ #003","7.163","2.196","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Mine Environ #003","Mine Environ #004","5.398","847","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Mine Environ #004","Mine Environ #005","7.884","608","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mine Environ #005","Mine Environ #001","3.650","3.623","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":572},{"label":"Mar","value":621},{"label":"Abr","value":288},{"label":"Mai","value":584},{"label":"Jun","value":227},{"label":"Jul","value":497},{"label":"Ago","value":508},{"label":"Set","value":345},{"label":"Out","value":552},{"label":"Nov","value":487},{"label":"Dez","value":578}];
const MX = 621;
