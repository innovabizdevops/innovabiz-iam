...
const PAGE = "Dust";
const KPIS = [{"l":"Total Mine Environ","v":"4.811","t":"+4.8%","d":"up"},{"l":"Dust Ativos","v":"9.075","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"65.8%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"95","t":"+15.4%","d":"up"}];
const COLS = ["ID","Dust","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mine Environ #001","Mine Environ #002","1.681","4.731","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Mine Environ #002","Mine Environ #003","8.067","5.868","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Mine Environ #003","Mine Environ #004","6.862","6.032","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Mine Environ #004","Mine Environ #005","8.765","4.634","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mine Environ #005","Mine Environ #001","9.080","6.366","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":399},{"label":"Fev","value":464},{"label":"Mar","value":347},{"label":"Abr","value":377},{"label":"Mai","value":443},{"label":"Jun","value":399},{"label":"Jul","value":346},{"label":"Ago","value":518},{"label":"Set","value":329},{"label":"Out","value":696},{"label":"Nov","value":674},{"label":"Dez","value":490}];
const MX = 696;
