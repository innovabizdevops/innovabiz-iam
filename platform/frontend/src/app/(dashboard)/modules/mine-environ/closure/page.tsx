...
const ACCENT = "#6366f1";
const MODULE = "Mine Environment";
const PAGE = "Closure Plan";
const KPIS = [{"l":"Total Mine Environ","v":"7.804","t":"+6.3%","d":"up"},{"l":"Closure Plan Ativos","v":"8.920","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"81","t":"+4.0%","d":"up"}];
const COLS = ["ID","Closure Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mine Environ #001","Mine Environ #002","5.299","3.382","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Mine Environ #002","Mine Environ #003","1.010","1.529","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Mine Environ #003","Mine Environ #004","2.515","838","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Mine Environ #004","Mine Environ #005","6.200","1.337","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mine Environ #005","Mine Environ #001","8.651","5.992","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":367},{"label":"Mar","value":282},{"label":"Abr","value":433},{"label":"Mai","value":326},{"label":"Jun","value":473},{"label":"Jul","value":451},{"label":"Ago","value":211},{"label":"Set","value":281},{"label":"Out","value":589},{"label":"Nov","value":279},{"label":"Dez","value":382}];
const MX = 589;
