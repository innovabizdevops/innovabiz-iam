...
const KPIS = [{"l":"Total Mine Environ","v":"6.872","t":"+11.1%","d":"up"},{"l":"Water Mgmt Ativos","v":"320","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"+3.3%","d":"up"},{"l":"Score Performance","v":"82","t":"-4.6%","d":"down"}];
const COLS = ["ID","Water Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mine Environ #001","Mine Environ #002","919","3.733","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Mine Environ #002","Mine Environ #003","912","6.948","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Mine Environ #003","Mine Environ #004","2.734","8.353","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Mine Environ #004","Mine Environ #005","1.815","329","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mine Environ #005","Mine Environ #001","1.777","5.201","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":809},{"label":"Mar","value":491},{"label":"Abr","value":607},{"label":"Mai","value":762},{"label":"Jun","value":595},{"label":"Jul","value":552},{"label":"Ago","value":479},{"label":"Set","value":710},{"label":"Out","value":564},{"label":"Nov","value":489},{"label":"Dez","value":551}];
const MX = 809;
