...
const PAGE = "EIA";
const KPIS = [{"l":"Total Mine Environ","v":"329","t":"+3.9%","d":"up"},{"l":"EIA Ativos","v":"1.665","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"88.9%","t":"+13.9%","d":"up"},{"l":"Score Performance","v":"64","t":"+0.2%","d":"up"}];
const COLS = ["ID","EIA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mine Environ #001","Mine Environ #002","2.107","6.394","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Mine Environ #002","Mine Environ #003","3.968","1.733","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Mine Environ #003","Mine Environ #004","3.590","761","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Mine Environ #004","Mine Environ #005","2.829","1.120","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mine Environ #005","Mine Environ #001","8.292","7.616","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":874},{"label":"Fev","value":813},{"label":"Mar","value":998},{"label":"Abr","value":966},{"label":"Mai","value":821},{"label":"Jun","value":981},{"label":"Jul","value":822},{"label":"Ago","value":856},{"label":"Set","value":709},{"label":"Out","value":794},{"label":"Nov","value":962},{"label":"Dez","value":968}];
const MX = 998;
