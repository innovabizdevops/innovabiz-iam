...
/* ═══ Textile Care Chemical — Dashboard ═══ */

const ACCENT = "#083344";

const KPIS = [
    { label: "Total Registos", value: "4180", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "68", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€62K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "-13%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "826693680", cells: ["TEX-8680", "Textile Care Chemical Item 1", "9/1/2026", "€43 780"], status: "active" as const },
    { id: "826697251", cells: ["TEX-3251", "Textile Care Chemical Item 2", "24/8/2026", "€47 351"], status: "pending" as const },
    { id: "826700822", cells: ["TEX-6822", "Textile Care Chemical Item 3", "11/3/2026", "€922"], status: "completed" as const },
    { id: "826704393", cells: ["TEX-1393", "Textile Care Chemical Item 4", "26/10/2026", "€4493"], status: "warning" as const },
    { id: "826707964", cells: ["TEX-4964", "Textile Care Chemical Item 5", "13/5/2026", "€8064"], status: "active" as const },
];
...
export default function TextileCareChemicalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Textile Care Chemical</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Textile Care Chemical</p>
                    </div>
                </div>
