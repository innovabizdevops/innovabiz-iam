...
const KPIS = [{"l":"Teams Ativos","v":"1.736","t":"+4.6%","d":"up"},{"l":"Reuniões/Semana","v":"1662","t":"+17.5%","d":"up"},{"l":"Mensagens/Dia","v":"4646","t":"+3.0%","d":"up"},{"l":"Ficheiros Partilhados","v":"5.497","t":"-2.5%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","8.904","1145","582","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","6.683","1138","1.532","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","945","4504","3.633","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.539","3293","3.147","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","7.564","684","2.331","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":349},{"label":"Fev","value":562},{"label":"Mar","value":540},{"label":"Abr","value":645},{"label":"Mai","value":586},{"label":"Jun","value":658},{"label":"Jul","value":534},{"label":"Ago","value":574},{"label":"Set","value":499},{"label":"Out","value":423},{"label":"Nov","value":300},{"label":"Dez","value":436}];
const MX = 658;
