...
const PAGE = "Delegate";
const KPIS = [{"l":"Teams Ativos","v":"4.542","t":"-5.7%","d":"down"},{"l":"Reuniões/Semana","v":"718","t":"+16.1%","d":"up"},{"l":"Mensagens/Dia","v":"3981","t":"+1.8%","d":"up"},{"l":"Ficheiros Partilhados","v":"2.540","t":"+0.4%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","8.189","3781","9.076","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.073","4944","6.811","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.439","1595","4.159","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","212","1317","6.525","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","3.662","5019","8.817","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":439},{"label":"Mar","value":396},{"label":"Abr","value":664},{"label":"Mai","value":440},{"label":"Jun","value":731},{"label":"Jul","value":576},{"label":"Ago","value":463},{"label":"Set","value":671},{"label":"Out","value":731},{"label":"Nov","value":700},{"label":"Dez","value":481}];
const MX = 731;
