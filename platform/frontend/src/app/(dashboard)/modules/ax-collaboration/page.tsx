...
/* ═══ AX Multi-Agent Collaboration — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "2842", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2300", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€409K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "-25%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1355827542", cells: ["AX-5542", "AX Multi-Agent Collaboration Item 1", "7/7/2026", "€27 642"], status: "active" as const },
    { id: "1355831113", cells: ["AX-9113", "AX Multi-Agent Collaboration Item 2", "22/2/2026", "€31 213"], status: "pending" as const },
    { id: "1355834684", cells: ["AX-3684", "AX Multi-Agent Collaboration Item 3", "9/9/2026", "€34 784"], status: "completed" as const },
    { id: "1355838255", cells: ["AX-7255", "AX Multi-Agent Collaboration Item 4", "24/4/2026", "€38 355"], status: "warning" as const },
    { id: "1355841826", cells: ["AX-1826", "AX Multi-Agent Collaboration Item 5", "11/11/2026", "€41 926"], status: "active" as const },
];
...
export default function AxMultiagentCollaborationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AX Multi-Agent Collaboration</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AX Multi-Agent Collaboration</p>
                    </div>
                </div>
