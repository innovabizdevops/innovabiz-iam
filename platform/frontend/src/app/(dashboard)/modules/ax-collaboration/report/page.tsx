...
const PAGE = "Report";
const KPIS = [{"l":"Teams Ativos","v":"6.909","t":"+12.9%","d":"up"},{"l":"Reuniões/Semana","v":"3660","t":"+1.9%","d":"up"},{"l":"Mensagens/Dia","v":"404","t":"-3.1%","d":"down"},{"l":"Ficheiros Partilhados","v":"6.522","t":"+16.1%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.939","1846","286","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","6.737","993","2.530","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","7.067","1703","4.582","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","1.940","4311","3.023","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","8.671","3425","2.431","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":830},{"label":"Mar","value":775},{"label":"Abr","value":517},{"label":"Mai","value":788},{"label":"Jun","value":816},{"label":"Jul","value":699},{"label":"Ago","value":596},{"label":"Set","value":641},{"label":"Out","value":638},{"label":"Nov","value":485},{"label":"Dez","value":821}];
const MX = 830;
