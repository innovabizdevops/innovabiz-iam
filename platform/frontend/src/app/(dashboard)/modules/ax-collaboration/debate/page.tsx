...
const ACCENT = "#4f46e5";
const MODULE = "AX Multi-Agent Collaboration";
const PAGE = "Debate";
const KPIS = [{"l":"Teams Ativos","v":"2.596","t":"-5.4%","d":"down"},{"l":"Reuniões/Semana","v":"4855","t":"+4.2%","d":"up"},{"l":"Mensagens/Dia","v":"4115","t":"+6.2%","d":"up"},{"l":"Ficheiros Partilhados","v":"2.777","t":"+8.0%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.807","3070","4.055","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","3.646","3229","4.458","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","8.908","245","8.406","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","3.936","4507","2.586","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","7.140","418","1.121","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":427},{"label":"Fev","value":447},{"label":"Mar","value":406},{"label":"Abr","value":623},{"label":"Mai","value":312},{"label":"Jun","value":289},{"label":"Jul","value":591},{"label":"Ago","value":624},{"label":"Set","value":486},{"label":"Out","value":610},{"label":"Nov","value":658},{"label":"Dez","value":656}];
const MX = 658;
