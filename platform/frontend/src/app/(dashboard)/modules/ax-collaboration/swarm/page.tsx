...
const PAGE = "Swarm";
const KPIS = [{"l":"Teams Ativos","v":"315","t":"+1.1%","d":"up"},{"l":"Reuniões/Semana","v":"5053","t":"+5.1%","d":"up"},{"l":"Mensagens/Dia","v":"1100","t":"+15.1%","d":"up"},{"l":"Ficheiros Partilhados","v":"5.213","t":"+17.7%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","532","2892","676","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","5.499","940","803","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","8.501","3823","9.043","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","1.237","2524","5.321","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.976","4127","1.697","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":370},{"label":"Mar","value":509},{"label":"Abr","value":642},{"label":"Mai","value":663},{"label":"Jun","value":356},{"label":"Jul","value":526},{"label":"Ago","value":572},{"label":"Set","value":585},{"label":"Out","value":614},{"label":"Nov","value":617},{"label":"Dez","value":387}];
const MX = 663;
