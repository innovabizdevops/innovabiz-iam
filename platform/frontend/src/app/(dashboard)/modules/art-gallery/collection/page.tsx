...
const KPIS = [{"l":"Total Art Gallery","v":"4.646","t":"+7.0%","d":"up"},{"l":"Collection Ativos","v":"8.710","t":"+6.0%","d":"up"},{"l":"Eficiência (%)","v":"92.4%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"81","t":"+17.5%","d":"up"}];
const COLS = ["ID","Collection","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Art Gallery #001","Art Gallery #002","2.092","511","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Art Gallery #002","Art Gallery #003","3.991","840","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Art Gallery #003","Art Gallery #004","8.785","5.463","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Art Gallery #004","Art Gallery #005","7.774","3.052","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Art Gallery #005","Art Gallery #001","4.569","8.876","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":921},{"label":"Fev","value":844},{"label":"Mar","value":711},{"label":"Abr","value":1024},{"label":"Mai","value":787},{"label":"Jun","value":953},{"label":"Jul","value":715},{"label":"Ago","value":835},{"label":"Set","value":667},{"label":"Out","value":861},{"label":"Nov","value":728},{"label":"Dez","value":849}];
const MX = 1024;
