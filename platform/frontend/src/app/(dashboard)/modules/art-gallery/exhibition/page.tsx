...
const KPIS = [{"l":"Total Art Gallery","v":"3.124","t":"+7.6%","d":"up"},{"l":"Exhibition Ativos","v":"8.147","t":"+14.3%","d":"up"},{"l":"Eficiência (%)","v":"81.4%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"77","t":"+16.7%","d":"up"}];
const COLS = ["ID","Exhibition","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Art Gallery #001","Art Gallery #002","3.715","6.732","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Art Gallery #002","Art Gallery #003","7.975","912","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Art Gallery #003","Art Gallery #004","3.609","2.164","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Art Gallery #004","Art Gallery #005","5.209","5.240","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Art Gallery #005","Art Gallery #001","6.894","4.916","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":837},{"label":"Mar","value":626},{"label":"Abr","value":595},{"label":"Mai","value":866},{"label":"Jun","value":582},{"label":"Jul","value":723},{"label":"Ago","value":767},{"label":"Set","value":753},{"label":"Out","value":790},{"label":"Nov","value":729},{"label":"Dez","value":679}];
const MX = 866;
