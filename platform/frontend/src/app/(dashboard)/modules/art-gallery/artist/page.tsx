...
const ACCENT = "#7c3aed";
const MODULE = "Art Gallery";
const PAGE = "Artist Mgmt";
const KPIS = [{"l":"Total Art Gallery","v":"7.135","t":"+11.2%","d":"up"},{"l":"Artist Mgmt Ativos","v":"4.208","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"81.2%","t":"-4.4%","d":"down"},{"l":"Score Performance","v":"91","t":"+12.3%","d":"up"}];
const COLS = ["ID","Artist Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Art Gallery #001","Art Gallery #002","730","1.468","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Art Gallery #002","Art Gallery #003","798","1.507","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Art Gallery #003","Art Gallery #004","6.043","4.250","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Art Gallery #004","Art Gallery #005","4.354","1.709","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Art Gallery #005","Art Gallery #001","4.607","2.274","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":750},{"label":"Mar","value":700},{"label":"Abr","value":705},{"label":"Mai","value":820},{"label":"Jun","value":808},{"label":"Jul","value":655},{"label":"Ago","value":544},{"label":"Set","value":660},{"label":"Out","value":649},{"label":"Nov","value":858},{"label":"Dez","value":620}];
const MX = 858;
