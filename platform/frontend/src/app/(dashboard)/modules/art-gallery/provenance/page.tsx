...
const KPIS = [{"l":"Total Art Gallery","v":"5.992","t":"-0.2%","d":"down"},{"l":"Provenance Ativos","v":"1.581","t":"+2.0%","d":"up"},{"l":"Eficiência (%)","v":"84.1%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"60","t":"+9.4%","d":"up"}];
const COLS = ["ID","Provenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Art Gallery #001","Art Gallery #002","4.554","6.738","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Art Gallery #002","Art Gallery #003","1.365","7.660","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Art Gallery #003","Art Gallery #004","5.586","1.242","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Art Gallery #004","Art Gallery #005","8.652","2.525","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Art Gallery #005","Art Gallery #001","4.088","527","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":865},{"label":"Mar","value":735},{"label":"Abr","value":925},{"label":"Mai","value":951},{"label":"Jun","value":680},{"label":"Jul","value":850},{"label":"Ago","value":969},{"label":"Set","value":710},{"label":"Out","value":809},{"label":"Nov","value":1055},{"label":"Dez","value":1011}];
const MX = 1055;
