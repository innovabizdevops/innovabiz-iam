...
const PAGE = "Sales Mgmt";
const KPIS = [{"l":"Vendas YTD (€)","v":"€70006","t":"+15.1%","d":"up"},{"l":"Pipeline (€)","v":"€47581","t":"+14.2%","d":"up"},{"l":"Atingimento Quota (%)","v":"72.8%","t":"+0.1%","d":"up"},{"l":"Win Rate (%)","v":"66.5%","t":"-5.7%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 21376.95","€ 40019.80","€ 22444.98","81.1%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 36424.97","€ 6730.43","€ 19520.27","77.4%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 6656.77","€ 46121.88","€ 27136.04","96.1%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 20943.15","€ 12500.09","€ 46604.72","81.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 5572.84","€ 31400.53","€ 18978.72","82.0%"],"status":"active"}];
const CHART = [{"label":"Jan","value":973},{"label":"Fev","value":891},{"label":"Mar","value":1037},{"label":"Abr","value":740},{"label":"Mai","value":899},{"label":"Jun","value":687},{"label":"Jul","value":699},{"label":"Ago","value":924},{"label":"Set","value":1019},{"label":"Out","value":924},{"label":"Nov","value":926},{"label":"Dez","value":831}];
const MX = 1037;
