...
const PAGE = "Measure";
const KPIS = [{"l":"Eventos Planeados","v":"8.770","t":"+6.1%","d":"up"},{"l":"Participantes","v":"3.262","t":"+1.7%","d":"up"},{"l":"NPS Evento","v":"68","t":"+10.3%","d":"up"},{"l":"Receita (€)","v":"€20713","t":"+8.9%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-04","3.776","7.158","€ 26075.22","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-21","7.158","4.312","€ 16268.28","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-09","8.154","7.932","€ 12637.57","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-03","1.454","5.599","€ 19322.75","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-09","3.129","5.093","€ 47508.28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":550},{"label":"Mar","value":529},{"label":"Abr","value":707},{"label":"Mai","value":554},{"label":"Jun","value":641},{"label":"Jul","value":815},{"label":"Ago","value":564},{"label":"Set","value":514},{"label":"Out","value":489},{"label":"Nov","value":618},{"label":"Dez","value":788}];
const MX = 815;
