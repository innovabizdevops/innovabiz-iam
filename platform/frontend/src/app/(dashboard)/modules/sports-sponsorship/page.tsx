...
/* ═══ Sports Sponsorship Mgmt — Dashboard ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total Registos", value: "8901", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3261", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€169K", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1717738001", cells: ["SPO-8001", "Sports Sponsorship Mgmt Item 1", "22/6/2026", "€38 101"], status: "active" as const },
    { id: "1717741572", cells: ["SPO-2572", "Sports Sponsorship Mgmt Item 2", "9/1/2026", "€41 672"], status: "pending" as const },
    { id: "1717745143", cells: ["SPO-6143", "Sports Sponsorship Mgmt Item 3", "24/8/2026", "€45 243"], status: "completed" as const },
    { id: "1717748714", cells: ["SPO-9714", "Sports Sponsorship Mgmt Item 4", "11/3/2026", "€48 814"], status: "warning" as const },
    { id: "1717752285", cells: ["SPO-4285", "Sports Sponsorship Mgmt Item 5", "26/10/2026", "€2385"], status: "active" as const },
];
...
export default function SportsSponsorshipMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sports Sponsorship Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Sports Sponsorship Mgmt</p>
                    </div>
                </div>
