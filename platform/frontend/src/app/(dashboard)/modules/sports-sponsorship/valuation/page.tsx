...
const ACCENT = "#b91c1c";
const MODULE = "Sports Sponsorship Mgmt";
const PAGE = "Valuation";
const KPIS = [{"l":"Eventos Planeados","v":"4.669","t":"+6.4%","d":"up"},{"l":"Participantes","v":"8.302","t":"+3.0%","d":"up"},{"l":"NPS Evento","v":"85","t":"+17.7%","d":"up"},{"l":"Receita (€)","v":"€67026","t":"-2.0%","d":"down"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-18","1.013","317","€ 823.36","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-16","3.169","6.956","€ 12085.41","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-24","3.623","7.916","€ 46991.79","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-24","6.271","7.071","€ 24809.33","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-02","634","5.349","€ 38019.96","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":721},{"label":"Fev","value":638},{"label":"Mar","value":813},{"label":"Abr","value":542},{"label":"Mai","value":610},{"label":"Jun","value":723},{"label":"Jul","value":509},{"label":"Ago","value":441},{"label":"Set","value":460},{"label":"Out","value":586},{"label":"Nov","value":572},{"label":"Dez","value":551}];
const MX = 813;
