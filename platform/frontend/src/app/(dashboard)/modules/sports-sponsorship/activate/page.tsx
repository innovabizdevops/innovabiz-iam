...
const PAGE = "Activate";
const KPIS = [{"l":"Eventos Planeados","v":"7.249","t":"+17.0%","d":"up"},{"l":"Participantes","v":"3.013","t":"+6.4%","d":"up"},{"l":"NPS Evento","v":"68","t":"+1.5%","d":"up"},{"l":"Receita (€)","v":"€61300","t":"+11.4%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-15","969","6.029","€ 4437.68","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-14","6.045","4.348","€ 33883.90","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-06","2.729","2.032","€ 32034.76","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-25","1.668","6.157","€ 11293.70","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-26","4.561","2.563","€ 49897.12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1033},{"label":"Fev","value":696},{"label":"Mar","value":898},{"label":"Abr","value":974},{"label":"Mai","value":800},{"label":"Jun","value":1019},{"label":"Jul","value":810},{"label":"Ago","value":810},{"label":"Set","value":912},{"label":"Out","value":1017},{"label":"Nov","value":873},{"label":"Dez","value":916}];
const MX = 1033;
