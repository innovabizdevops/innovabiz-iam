...
const PAGE = "Report";
const KPIS = [{"l":"Eventos Planeados","v":"1.741","t":"+15.7%","d":"up"},{"l":"Participantes","v":"5.714","t":"+17.3%","d":"up"},{"l":"NPS Evento","v":"93","t":"+1.0%","d":"up"},{"l":"Receita (€)","v":"€1098","t":"+2.4%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-16","3.664","416","€ 42863.44","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-09","8.190","3.948","€ 8335.04","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-22","5.276","8.678","€ 16947.25","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-08","2.159","4.603","€ 12470.73","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-06","4.013","3.791","€ 41682.50","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":914},{"label":"Fev","value":906},{"label":"Mar","value":630},{"label":"Abr","value":766},{"label":"Mai","value":838},{"label":"Jun","value":824},{"label":"Jul","value":749},{"label":"Ago","value":837},{"label":"Set","value":651},{"label":"Out","value":716},{"label":"Nov","value":730},{"label":"Dez","value":885}];
const MX = 914;
