...
const PAGE = "SLA";
const KPIS = [{"l":"Tickets Abertos","v":"5.267","t":"+12.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"91.4%","t":"-0.1%","d":"down"},{"l":"MTTR (h)","v":"31h","t":"+7.9%","d":"up"},{"l":"Satisfação (%)","v":"91.0%","t":"+12.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.062","4.434","5.891","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.616","1.615","6.929","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.781","573","1.356","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.776","4.750","8.045","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.390","6.068","3.321","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":918},{"label":"Mar","value":954},{"label":"Abr","value":905},{"label":"Mai","value":782},{"label":"Jun","value":766},{"label":"Jul","value":746},{"label":"Ago","value":949},{"label":"Set","value":820},{"label":"Out","value":893},{"label":"Nov","value":673},{"label":"Dez","value":907}];
const MX = 954;
