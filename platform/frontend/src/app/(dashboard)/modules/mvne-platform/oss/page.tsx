...
const PAGE = "OSS Stack";
const KPIS = [{"l":"Formulários Ativos","v":"3.135","t":"+15.8%","d":"up"},{"l":"Submissões/Dia","v":"1637","t":"-2.0%","d":"down"},{"l":"Documentos Gerados","v":"7.926","t":"+9.7%","d":"up"},{"l":"Templates","v":"6.280","t":"+1.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.351","2026-01-25","117","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.036","2026-03-03","2.979","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.124","2026-01-27","146","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.457","2026-01-18","3.300","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.226","2026-01-13","1.790","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":778},{"label":"Fev","value":678},{"label":"Mar","value":669},{"label":"Abr","value":838},{"label":"Mai","value":889},{"label":"Jun","value":634},{"label":"Jul","value":769},{"label":"Ago","value":913},{"label":"Set","value":626},{"label":"Out","value":937},{"label":"Nov","value":842},{"label":"Dez","value":960}];
const MX = 960;
