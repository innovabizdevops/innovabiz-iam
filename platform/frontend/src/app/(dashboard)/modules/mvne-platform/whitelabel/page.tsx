...
const KPIS = [{"l":"Formulários Ativos","v":"7.405","t":"-2.7%","d":"down"},{"l":"Submissões/Dia","v":"2739","t":"-0.5%","d":"down"},{"l":"Documentos Gerados","v":"6.894","t":"+11.9%","d":"up"},{"l":"Templates","v":"478","t":"+1.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.635","2026-03-02","3.890","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.461","2026-01-06","1.637","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","332","2026-03-22","2.989","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.050","2026-02-16","5.499","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.130","2026-03-07","5.777","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":457},{"label":"Fev","value":675},{"label":"Mar","value":567},{"label":"Abr","value":518},{"label":"Mai","value":373},{"label":"Jun","value":647},{"label":"Jul","value":679},{"label":"Ago","value":401},{"label":"Set","value":372},{"label":"Out","value":440},{"label":"Nov","value":411},{"label":"Dez","value":495}];
const MX = 679;
