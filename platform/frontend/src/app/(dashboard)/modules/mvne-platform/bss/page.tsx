...
const ACCENT = "#6366f1";
const MODULE = "MVNE/MVNA Platform";
const PAGE = "BSS Stack";
const KPIS = [{"l":"Formulários Ativos","v":"6.688","t":"+5.8%","d":"up"},{"l":"Submissões/Dia","v":"3204","t":"+2.8%","d":"up"},{"l":"Documentos Gerados","v":"1.178","t":"+16.3%","d":"up"},{"l":"Templates","v":"2.917","t":"+11.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.252","2026-02-08","4.766","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.255","2026-01-26","1.857","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.051","2026-03-22","7.240","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.310","2026-03-19","3.257","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.830","2026-03-19","1.725","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":628},{"label":"Mar","value":586},{"label":"Abr","value":785},{"label":"Mai","value":604},{"label":"Jun","value":508},{"label":"Jul","value":745},{"label":"Ago","value":528},{"label":"Set","value":570},{"label":"Out","value":605},{"label":"Nov","value":729},{"label":"Dez","value":648}];
const MX = 785;
