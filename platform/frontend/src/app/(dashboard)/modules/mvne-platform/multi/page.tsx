...
const PAGE = "Multi-MVNO";
const KPIS = [{"l":"Formulários Ativos","v":"714","t":"+8.1%","d":"up"},{"l":"Submissões/Dia","v":"2663","t":"+14.0%","d":"up"},{"l":"Documentos Gerados","v":"6.932","t":"+11.0%","d":"up"},{"l":"Templates","v":"6.291","t":"+9.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.161","2026-03-15","7.268","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.084","2026-01-19","1.279","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.206","2026-02-02","6.862","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.727","2026-02-13","6.122","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.328","2026-03-24","5.794","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":353},{"label":"Mar","value":681},{"label":"Abr","value":448},{"label":"Mai","value":327},{"label":"Jun","value":469},{"label":"Jul","value":548},{"label":"Ago","value":468},{"label":"Set","value":329},{"label":"Out","value":426},{"label":"Nov","value":553},{"label":"Dez","value":412}];
const MX = 681;
