...
const KPIS = [{"l":"Quartos Ocupados","v":"763","t":"-6.0%","d":"down"},{"l":"RevPAR (€)","v":"€50955","t":"+13.5%","d":"up"},{"l":"Ocupação (%)","v":"74.8%","t":"+8.7%","d":"up"},{"l":"Guest Satisfaction","v":"6.850","t":"+14.7%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","1.353","2026-02-12","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.329","2026-02-13","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.173","2026-01-12","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.643","2026-03-16","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.963","2026-02-28","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":606},{"label":"Mar","value":663},{"label":"Abr","value":393},{"label":"Mai","value":394},{"label":"Jun","value":721},{"label":"Jul","value":508},{"label":"Ago","value":390},{"label":"Set","value":464},{"label":"Out","value":637},{"label":"Nov","value":771},{"label":"Dez","value":488}];
const MX = 771;
