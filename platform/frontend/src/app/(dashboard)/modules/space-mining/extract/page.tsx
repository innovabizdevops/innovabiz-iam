...
const PAGE = "Extract";
const KPIS = [{"l":"Quartos Ocupados","v":"1.087","t":"-1.1%","d":"down"},{"l":"RevPAR (€)","v":"€46421","t":"+16.4%","d":"up"},{"l":"Ocupação (%)","v":"79.1%","t":"+16.3%","d":"up"},{"l":"Guest Satisfaction","v":"616","t":"+11.4%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","1.024","2026-03-04","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.950","2026-01-27","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.491","2026-01-23","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.388","2026-03-24","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.861","2026-01-11","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":737},{"label":"Fev","value":691},{"label":"Mar","value":738},{"label":"Abr","value":564},{"label":"Mai","value":653},{"label":"Jun","value":625},{"label":"Jul","value":822},{"label":"Ago","value":928},{"label":"Set","value":932},{"label":"Out","value":645},{"label":"Nov","value":911},{"label":"Dez","value":630}];
const MX = 932;
