...
const ACCENT = "#6366f1";
const MODULE = "Space Mining";
const PAGE = "Process";
const KPIS = [{"l":"Quartos Ocupados","v":"4.507","t":"-3.3%","d":"down"},{"l":"RevPAR (€)","v":"€34901","t":"+17.8%","d":"up"},{"l":"Ocupação (%)","v":"94.8%","t":"+5.7%","d":"up"},{"l":"Guest Satisfaction","v":"4.260","t":"-3.3%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.783","2026-03-09","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.097","2026-02-08","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.960","2026-03-02","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.476","2026-02-24","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.682","2026-01-04","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":745},{"label":"Mar","value":566},{"label":"Abr","value":755},{"label":"Mai","value":383},{"label":"Jun","value":731},{"label":"Jul","value":401},{"label":"Ago","value":593},{"label":"Set","value":757},{"label":"Out","value":644},{"label":"Nov","value":416},{"label":"Dez","value":645}];
const MX = 757;
