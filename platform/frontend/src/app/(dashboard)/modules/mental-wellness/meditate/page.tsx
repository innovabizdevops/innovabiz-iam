...
const PAGE = "Meditate";
const KPIS = [{"l":"Integrações Ativas","v":"4.507","t":"+1.6%","d":"up"},{"l":"Chamadas/Hora","v":"1813","t":"+4.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.7%","t":"-3.2%","d":"down"},{"l":"Latência Média (ms)","v":"103ms","t":"+17.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.007","7.521","93.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.534","2.496","93.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.128","1.469","87.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.137","6.478","75.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.358","6.859","75.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":461},{"label":"Fev","value":652},{"label":"Mar","value":731},{"label":"Abr","value":652},{"label":"Mai","value":434},{"label":"Jun","value":647},{"label":"Jul","value":696},{"label":"Ago","value":484},{"label":"Set","value":604},{"label":"Out","value":826},{"label":"Nov","value":700},{"label":"Dez","value":828}];
const MX = 828;
