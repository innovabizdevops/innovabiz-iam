...
/* ═══ Mental Wellness Platform — Dashboard ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total Registos", value: "1340", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3807", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€472K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "497159440", cells: ["MEN-9440", "Mental Wellness Platform Item 1", "9/5/2026", "€9540"], status: "active" as const },
    { id: "497163011", cells: ["MEN-4011", "Mental Wellness Platform Item 2", "24/12/2026", "€13 111"], status: "pending" as const },
    { id: "497166582", cells: ["MEN-7582", "Mental Wellness Platform Item 3", "11/7/2026", "€16 682"], status: "completed" as const },
    { id: "497170153", cells: ["MEN-2153", "Mental Wellness Platform Item 4", "26/2/2026", "€20 253"], status: "warning" as const },
    { id: "497173724", cells: ["MEN-5724", "Mental Wellness Platform Item 5", "13/9/2026", "€23 824"], status: "active" as const },
];
...
export default function MentalWellnessPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mental Wellness Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Mental Wellness Platform</p>
                    </div>
                </div>
