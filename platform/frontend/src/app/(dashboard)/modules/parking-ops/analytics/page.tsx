...
const KPIS = [{"l":"Dashboards Ativos","v":"8.511","t":"+9.5%","d":"up"},{"l":"Queries/Dia","v":"1510","t":"+3.9%","d":"up"},{"l":"Dados Processados (GB)","v":"6.686","t":"+17.3%","d":"up"},{"l":"Utilizadores Analytics","v":"5.884","t":"+2.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","437","2026-01-08","913","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5012","2026-03-15","3.679","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3681","2026-03-28","8.879","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1192","2026-02-09","6.458","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3759","2026-03-19","3.684","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":996},{"label":"Fev","value":895},{"label":"Mar","value":805},{"label":"Abr","value":882},{"label":"Mai","value":993},{"label":"Jun","value":854},{"label":"Jul","value":993},{"label":"Ago","value":888},{"label":"Set","value":998},{"label":"Out","value":988},{"label":"Nov","value":812},{"label":"Dez","value":1012}];
const MX = 1012;
