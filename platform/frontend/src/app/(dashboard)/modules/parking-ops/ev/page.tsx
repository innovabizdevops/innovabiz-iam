...
const PAGE = "EV";
const KPIS = [{"l":"Total Parking Ops","v":"9.093","t":"+12.1%","d":"up"},{"l":"EV Ativos","v":"8.627","t":"+0.9%","d":"up"},{"l":"Eficiência (%)","v":"73.3%","t":"-2.3%","d":"down"},{"l":"Score Performance","v":"80","t":"-3.4%","d":"down"}];
const COLS = ["ID","EV","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Parking Ops #001","Parking Ops #002","6.905","5.820","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Parking Ops #002","Parking Ops #003","8.909","9.009","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Parking Ops #003","Parking Ops #004","2.060","5.908","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Parking Ops #004","Parking Ops #005","2.918","5.136","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Parking Ops #005","Parking Ops #001","1.894","3.445","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":762},{"label":"Mar","value":957},{"label":"Abr","value":787},{"label":"Mai","value":766},{"label":"Jun","value":674},{"label":"Jul","value":934},{"label":"Ago","value":646},{"label":"Set","value":583},{"label":"Out","value":932},{"label":"Nov","value":867},{"label":"Dez","value":744}];
const MX = 957;
