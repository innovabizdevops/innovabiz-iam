...
const ACCENT = "#64748b";
const MODULE = "Parking Operations";
const PAGE = "Enforcement";
const KPIS = [{"l":"Total Parking Ops","v":"8.398","t":"+2.8%","d":"up"},{"l":"Enforcement Ativos","v":"6.121","t":"-1.3%","d":"down"},{"l":"Eficiência (%)","v":"92.9%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"91","t":"-0.1%","d":"down"}];
const COLS = ["ID","Enforcement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Parking Ops #001","Parking Ops #002","8.616","6.907","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Parking Ops #002","Parking Ops #003","855","5.384","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Parking Ops #003","Parking Ops #004","2.915","8.039","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Parking Ops #004","Parking Ops #005","3.945","6.592","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Parking Ops #005","Parking Ops #001","1.932","8.487","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":415},{"label":"Fev","value":545},{"label":"Mar","value":686},{"label":"Abr","value":662},{"label":"Mai","value":637},{"label":"Jun","value":714},{"label":"Jul","value":769},{"label":"Ago","value":740},{"label":"Set","value":427},{"label":"Out","value":551},{"label":"Nov","value":380},{"label":"Dez","value":687}];
const MX = 769;
