...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€23.8M","t":"+1.0%","d":"up"},{"l":"MRR (€)","v":"€24463","t":"+10.8%","d":"up"},{"l":"Churn (%)","v":"82.3%","t":"-5.7%","d":"down"},{"l":"ARPU (€)","v":"€90397","t":"+10.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 12003.75","4.215","€ 18403.10","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 8644.73","1.635","€ 10891.36","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 39097.74","6.034","€ 4543.83","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 287.59","377","€ 33117.60","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 46397.00","7.605","€ 22432.38","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":389},{"label":"Mar","value":423},{"label":"Abr","value":246},{"label":"Mai","value":309},{"label":"Jun","value":511},{"label":"Jul","value":568},{"label":"Ago","value":513},{"label":"Set","value":278},{"label":"Out","value":596},{"label":"Nov","value":511},{"label":"Dez","value":563}];
const MX = 596;
