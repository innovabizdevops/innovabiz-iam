...
const PAGE = "Space";
const KPIS = [{"l":"Quartos Ocupados","v":"5.643","t":"-5.0%","d":"down"},{"l":"RevPAR (€)","v":"€76582","t":"+2.3%","d":"up"},{"l":"Ocupação (%)","v":"72.9%","t":"+17.9%","d":"up"},{"l":"Guest Satisfaction","v":"4.363","t":"+15.8%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.323","2026-02-04","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.790","2026-03-06","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.049","2026-03-06","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.275","2026-02-08","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.522","2026-01-06","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":917},{"label":"Mar","value":983},{"label":"Abr","value":934},{"label":"Mai","value":750},{"label":"Jun","value":776},{"label":"Jul","value":1015},{"label":"Ago","value":734},{"label":"Set","value":737},{"label":"Out","value":1004},{"label":"Nov","value":690},{"label":"Dez","value":739}];
const MX = 1015;
