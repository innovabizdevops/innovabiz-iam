...
const PAGE = "Report";
const KPIS = [{"l":"Riscos Identificados","v":"4.744","t":"+13.6%","d":"up"},{"l":"Mitigações Ativas","v":"4.388","t":"+16.6%","d":"up"},{"l":"Score Risco Geral","v":"63","t":"-2.4%","d":"down"},{"l":"Incidentes YTD","v":"5.504","t":"+16.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.608","8.846","2.008","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.840","3.588","3.569","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.624","1.514","3.507","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.773","1.077","2.974","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.224","2.200","242","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":301},{"label":"Fev","value":469},{"label":"Mar","value":341},{"label":"Abr","value":528},{"label":"Mai","value":308},{"label":"Jun","value":448},{"label":"Jul","value":580},{"label":"Ago","value":392},{"label":"Set","value":567},{"label":"Out","value":521},{"label":"Nov","value":328},{"label":"Dez","value":426}];
const MX = 580;
