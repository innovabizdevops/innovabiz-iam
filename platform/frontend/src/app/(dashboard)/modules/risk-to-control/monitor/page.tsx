...
const ACCENT = "#06b6d4";
const MODULE = "Risk-to-Control E2E";
const PAGE = "Monitor";
const KPIS = [{"l":"Riscos Identificados","v":"5.713","t":"+6.0%","d":"up"},{"l":"Mitigações Ativas","v":"5.775","t":"+12.2%","d":"up"},{"l":"Score Risco Geral","v":"55","t":"+4.5%","d":"up"},{"l":"Incidentes YTD","v":"696","t":"+11.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.003","5.780","7.495","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.114","2.085","3.320","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","742","5.973","7.678","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.121","519","6.282","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.189","2.057","3.351","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":362},{"label":"Fev","value":512},{"label":"Mar","value":434},{"label":"Abr","value":615},{"label":"Mai","value":358},{"label":"Jun","value":511},{"label":"Jul","value":714},{"label":"Ago","value":567},{"label":"Set","value":562},{"label":"Out","value":572},{"label":"Nov","value":461},{"label":"Dez","value":377}];
const MX = 714;
