...
/* ═══ Risk-to-Control E2E — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "4888", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1948", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€361K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "-21%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "713567088", cells: ["RIS-3088", "Risk-to-Control E2E Item 1", "25/1/2026", "€17 188"], status: "active" as const },
    { id: "713570659", cells: ["RIS-6659", "Risk-to-Control E2E Item 2", "12/8/2026", "€20 759"], status: "pending" as const },
    { id: "713574230", cells: ["RIS-1230", "Risk-to-Control E2E Item 3", "27/3/2026", "€24 330"], status: "completed" as const },
    { id: "713577801", cells: ["RIS-4801", "Risk-to-Control E2E Item 4", "14/10/2026", "€27 901"], status: "warning" as const },
    { id: "713581372", cells: ["RIS-8372", "Risk-to-Control E2E Item 5", "1/5/2026", "€31 472"], status: "active" as const },
];
...
export default function RisktocontrolE2ePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Risk-to-Control E2E</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Risk-to-Control E2E</p>
                    </div>
                </div>
