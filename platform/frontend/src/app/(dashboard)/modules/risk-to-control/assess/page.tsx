...
const PAGE = "Assess";
const KPIS = [{"l":"Riscos Identificados","v":"6.416","t":"-5.7%","d":"down"},{"l":"Mitigações Ativas","v":"2.539","t":"-1.6%","d":"down"},{"l":"Score Risco Geral","v":"77","t":"+10.2%","d":"up"},{"l":"Incidentes YTD","v":"834","t":"+15.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.256","420","1.043","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.323","4.956","7.030","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.034","7.582","6.277","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","800","7.265","1.307","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.784","6.208","2.809","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":795},{"label":"Mar","value":564},{"label":"Abr","value":580},{"label":"Mai","value":689},{"label":"Jun","value":604},{"label":"Jul","value":741},{"label":"Ago","value":720},{"label":"Set","value":716},{"label":"Out","value":762},{"label":"Nov","value":517},{"label":"Dez","value":828}];
const MX = 828;
