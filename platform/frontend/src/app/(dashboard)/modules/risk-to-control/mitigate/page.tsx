...
const PAGE = "Mitigate";
const KPIS = [{"l":"Riscos Identificados","v":"6.816","t":"+2.4%","d":"up"},{"l":"Mitigações Ativas","v":"4.056","t":"+12.3%","d":"up"},{"l":"Score Risco Geral","v":"82","t":"+15.5%","d":"up"},{"l":"Incidentes YTD","v":"4.061","t":"+9.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.745","7.650","3.458","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.864","6.423","2.637","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.881","4.642","2.899","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.000","291","7.186","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.223","2.562","1.888","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":482},{"label":"Fev","value":400},{"label":"Mar","value":571},{"label":"Abr","value":522},{"label":"Mai","value":658},{"label":"Jun","value":506},{"label":"Jul","value":430},{"label":"Ago","value":415},{"label":"Set","value":598},{"label":"Out","value":594},{"label":"Nov","value":723},{"label":"Dez","value":492}];
const MX = 723;
