...
const PAGE = "Identify";
const KPIS = [{"l":"Riscos Identificados","v":"4.205","t":"+8.9%","d":"up"},{"l":"Mitigações Ativas","v":"6.652","t":"-2.4%","d":"down"},{"l":"Score Risco Geral","v":"78","t":"+3.1%","d":"up"},{"l":"Incidentes YTD","v":"4.105","t":"+3.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.282","5.127","6.897","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.396","4.995","6.220","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.379","6.571","1.025","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.654","7.495","8.443","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.581","5.904","1.381","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":630},{"label":"Mar","value":602},{"label":"Abr","value":464},{"label":"Mai","value":519},{"label":"Jun","value":663},{"label":"Jul","value":509},{"label":"Ago","value":407},{"label":"Set","value":599},{"label":"Out","value":390},{"label":"Nov","value":414},{"label":"Dez","value":720}];
const MX = 720;
