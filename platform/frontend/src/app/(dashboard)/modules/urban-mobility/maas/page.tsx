...
const PAGE = "MaaS Platform";
const KPIS = [{"l":"Formulários Ativos","v":"2.875","t":"-2.7%","d":"down"},{"l":"Submissões/Dia","v":"2021","t":"+9.0%","d":"up"},{"l":"Documentos Gerados","v":"850","t":"+7.5%","d":"up"},{"l":"Templates","v":"5.380","t":"+12.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.468","2026-02-22","1.760","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.545","2026-01-20","1.551","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.117","2026-03-09","3.885","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.248","2026-03-16","1.330","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.556","2026-02-16","8.805","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":844},{"label":"Mar","value":755},{"label":"Abr","value":656},{"label":"Mai","value":624},{"label":"Jun","value":636},{"label":"Jul","value":704},{"label":"Ago","value":786},{"label":"Set","value":581},{"label":"Out","value":590},{"label":"Nov","value":845},{"label":"Dez","value":808}];
const MX = 845;
