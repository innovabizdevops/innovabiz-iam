...
const PAGE = "Zero Waste";
const KPIS = [{"l":"Total Waste Reduction","v":"6.732","t":"+6.4%","d":"up"},{"l":"Zero Waste Ativos","v":"7.038","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"91.8%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"91","t":"+9.9%","d":"up"}];
const COLS = ["ID","Zero Waste","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Reduction #001","Waste Reduction #002","8.029","8.811","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Reduction #002","Waste Reduction #003","5.201","6.056","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Reduction #003","Waste Reduction #004","2.641","4.447","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Reduction #004","Waste Reduction #005","961","8.928","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Reduction #005","Waste Reduction #001","5.381","834","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":406},{"label":"Mar","value":714},{"label":"Abr","value":348},{"label":"Mai","value":438},{"label":"Jun","value":402},{"label":"Jul","value":541},{"label":"Ago","value":639},{"label":"Set","value":447},{"label":"Out","value":407},{"label":"Nov","value":568},{"label":"Dez","value":422}];
const MX = 714;
