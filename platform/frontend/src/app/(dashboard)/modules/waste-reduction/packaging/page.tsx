...
const ACCENT = "#dc2626";
const MODULE = "Waste Reduction";
const PAGE = "Packaging";
const KPIS = [{"l":"Total Waste Reduction","v":"4.128","t":"+15.5%","d":"up"},{"l":"Packaging Ativos","v":"8.177","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"79.6%","t":"-0.9%","d":"down"},{"l":"Score Performance","v":"71","t":"+3.3%","d":"up"}];
const COLS = ["ID","Packaging","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Reduction #001","Waste Reduction #002","8.542","7.550","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Reduction #002","Waste Reduction #003","3.598","4.784","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Reduction #003","Waste Reduction #004","642","2.416","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Reduction #004","Waste Reduction #005","3.261","6.581","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Reduction #005","Waste Reduction #001","5.015","8.081","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":724},{"label":"Mar","value":642},{"label":"Abr","value":847},{"label":"Mai","value":586},{"label":"Jun","value":713},{"label":"Jul","value":574},{"label":"Ago","value":755},{"label":"Set","value":782},{"label":"Out","value":664},{"label":"Nov","value":561},{"label":"Dez","value":636}];
const MX = 847;
