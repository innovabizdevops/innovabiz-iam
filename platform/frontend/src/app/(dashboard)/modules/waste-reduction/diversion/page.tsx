...
const PAGE = "Diversion Rate";
const KPIS = [{"l":"Formulários Ativos","v":"4.137","t":"+12.5%","d":"up"},{"l":"Submissões/Dia","v":"5092","t":"+6.6%","d":"up"},{"l":"Documentos Gerados","v":"7.251","t":"-1.6%","d":"down"},{"l":"Templates","v":"3.037","t":"+6.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.390","2026-01-05","1.149","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.766","2026-03-03","2.046","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.202","2026-01-10","354","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.908","2026-02-16","7.042","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.269","2026-03-03","1.988","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":359},{"label":"Mar","value":594},{"label":"Abr","value":269},{"label":"Mai","value":333},{"label":"Jun","value":548},{"label":"Jul","value":385},{"label":"Ago","value":304},{"label":"Set","value":641},{"label":"Out","value":536},{"label":"Nov","value":271},{"label":"Dez","value":554}];
const MX = 641;
