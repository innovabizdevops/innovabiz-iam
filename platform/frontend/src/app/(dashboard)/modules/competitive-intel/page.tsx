...
const KPIS = [
    { label: "Total Registos", value: "8815", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4298", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€207K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "-23%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1241142015", cells: ["COM-7015", "Competitive Intelligence Item 1", "16/4/2026", "€42 115"], status: "active" as const },
    { id: "1241145586", cells: ["COM-1586", "Competitive Intelligence Item 2", "3/11/2026", "€45 686"], status: "pending" as const },
    { id: "1241149157", cells: ["COM-5157", "Competitive Intelligence Item 3", "18/6/2026", "€49 257"], status: "completed" as const },
    { id: "1241152728", cells: ["COM-8728", "Competitive Intelligence Item 4", "5/1/2026", "€2828"], status: "warning" as const },
    { id: "1241156299", cells: ["COM-3299", "Competitive Intelligence Item 5", "20/8/2026", "€6399"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Competitive Intelligence</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Competitive Intelligence</p>
                    </div>
                </div>
