...
const ACCENT = "#93c5fd";
const MODULE = "Competitive Intelligence";
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"5.766","t":"+7.7%","d":"up"},{"l":"Taxa Entrega (%)","v":"85.9%","t":"+5.0%","d":"up"},{"l":"Taxa Abertura (%)","v":"94.2%","t":"+13.9%","d":"up"},{"l":"Escalações","v":"5.190","t":"-4.7%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","7.012","89.9%","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","2.120","73.4%","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","5.937","71.6%","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","8.140","83.0%","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","5.218","86.0%","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":936},{"label":"Fev","value":854},{"label":"Mar","value":605},{"label":"Abr","value":651},{"label":"Mai","value":882},{"label":"Jun","value":904},{"label":"Jul","value":892},{"label":"Ago","value":662},{"label":"Set","value":845},{"label":"Out","value":685},{"label":"Nov","value":653},{"label":"Dez","value":881}];
const MX = 936;
