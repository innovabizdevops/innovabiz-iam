...
const KPIS = [{"l":"Auditorias Realizadas","v":"8.245","t":"+11.2%","d":"up"},{"l":"NC Abertas","v":"7.337","t":"+8.7%","d":"up"},{"l":"Conformidade (%)","v":"80.4%","t":"-1.7%","d":"down"},{"l":"CAPAs Pendentes","v":"7.091","t":"-1.1%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.515","97.9%","5.711","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.516","91.1%","1.093","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","516","75.8%","7.549","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.915","81.2%","1.072","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.897","70.0%","3.074","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":348},{"label":"Mar","value":604},{"label":"Abr","value":649},{"label":"Mai","value":328},{"label":"Jun","value":609},{"label":"Jul","value":462},{"label":"Ago","value":560},{"label":"Set","value":381},{"label":"Out","value":503},{"label":"Nov","value":431},{"label":"Dez","value":279}];
const MX = 649;
