...
const PAGE = "Welding Bot";
const KPIS = [{"l":"Total Industrial Robot","v":"4.148","t":"+4.2%","d":"up"},{"l":"Welding Bot Ativos","v":"5.686","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"74.3%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"85","t":"+15.6%","d":"up"}];
const COLS = ["ID","Welding Bot","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industrial Robot #001","Industrial Robot #002","353","2.974","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Industrial Robot #002","Industrial Robot #003","4.593","7.297","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Industrial Robot #003","Industrial Robot #004","2.736","1.711","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Industrial Robot #004","Industrial Robot #005","6.327","2.352","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industrial Robot #005","Industrial Robot #001","7.785","502","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":760},{"label":"Fev","value":694},{"label":"Mar","value":640},{"label":"Abr","value":677},{"label":"Mai","value":501},{"label":"Jun","value":734},{"label":"Jul","value":517},{"label":"Ago","value":472},{"label":"Set","value":719},{"label":"Out","value":749},{"label":"Nov","value":677},{"label":"Dez","value":733}];
const MX = 760;
