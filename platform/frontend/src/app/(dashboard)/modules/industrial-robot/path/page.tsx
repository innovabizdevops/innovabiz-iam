...
const ACCENT = "#6366f1";
const MODULE = "Industrial Robotics";
const PAGE = "Path Planning";
const KPIS = [{"l":"Total Industrial Robot","v":"2.678","t":"+9.8%","d":"up"},{"l":"Path Planning Ativos","v":"709","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"84.4%","t":"+11.9%","d":"up"},{"l":"Score Performance","v":"93","t":"+3.0%","d":"up"}];
const COLS = ["ID","Path Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industrial Robot #001","Industrial Robot #002","4.043","2.477","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Industrial Robot #002","Industrial Robot #003","3.188","1.572","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Industrial Robot #003","Industrial Robot #004","3.269","326","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Industrial Robot #004","Industrial Robot #005","4.372","7.926","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industrial Robot #005","Industrial Robot #001","6.147","2.679","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":360},{"label":"Mar","value":579},{"label":"Abr","value":417},{"label":"Mai","value":591},{"label":"Jun","value":495},{"label":"Jul","value":514},{"label":"Ago","value":656},{"label":"Set","value":645},{"label":"Out","value":642},{"label":"Nov","value":734},{"label":"Dez","value":572}];
const MX = 734;
