...
const PAGE = "Servo Control";
const KPIS = [{"l":"Total Industrial Robot","v":"8.432","t":"+10.1%","d":"up"},{"l":"Servo Control Ativos","v":"1.667","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"93.9%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"60","t":"+7.6%","d":"up"}];
const COLS = ["ID","Servo Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industrial Robot #001","Industrial Robot #002","4.166","3.528","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Industrial Robot #002","Industrial Robot #003","8.307","7.374","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Industrial Robot #003","Industrial Robot #004","8.175","6.743","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Industrial Robot #004","Industrial Robot #005","304","4.506","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industrial Robot #005","Industrial Robot #001","5.153","8.837","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":446},{"label":"Mar","value":733},{"label":"Abr","value":710},{"label":"Mai","value":738},{"label":"Jun","value":425},{"label":"Jul","value":582},{"label":"Ago","value":441},{"label":"Set","value":666},{"label":"Out","value":487},{"label":"Nov","value":475},{"label":"Dez","value":484}];
const MX = 738;
