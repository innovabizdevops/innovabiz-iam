...
export default function IndustrialRobotPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Industrial Robot</h1><p className="text-sm text-muted-foreground">Industrial Robot • iBOS Enterprise</p></div>
