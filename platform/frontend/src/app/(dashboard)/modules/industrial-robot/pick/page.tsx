...
const PAGE = "Pick &amp; Place";
const KPIS = [{"l":"Total Industrial Robot","v":"6.714","t":"+8.1%","d":"up"},{"l":"Pick & Place Ativos","v":"3.473","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"71.6%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"56","t":"-4.2%","d":"down"}];
const COLS = ["ID","Pick & Place","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industrial Robot #001","Industrial Robot #002","2.504","1.332","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Industrial Robot #002","Industrial Robot #003","5.540","7.442","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Industrial Robot #003","Industrial Robot #004","691","6.851","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Industrial Robot #004","Industrial Robot #005","4.308","2.461","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industrial Robot #005","Industrial Robot #001","1.903","4.887","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":970},{"label":"Mar","value":982},{"label":"Abr","value":886},{"label":"Mai","value":739},{"label":"Jun","value":1003},{"label":"Jul","value":1016},{"label":"Ago","value":841},{"label":"Set","value":1056},{"label":"Out","value":705},{"label":"Nov","value":1053},{"label":"Dez","value":729}];
const MX = 1056;
