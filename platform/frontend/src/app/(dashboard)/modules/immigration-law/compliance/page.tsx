...
const KPIS = [{"l":"Auditorias Realizadas","v":"5.509","t":"+12.1%","d":"up"},{"l":"NC Abertas","v":"8.485","t":"+2.7%","d":"up"},{"l":"Conformidade (%)","v":"67.6%","t":"-0.8%","d":"down"},{"l":"CAPAs Pendentes","v":"3.562","t":"+5.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","232","79.2%","8.041","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.269","73.4%","2.420","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.563","76.8%","6.561","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.702","80.2%","3.506","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.987","98.5%","5.764","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":331},{"label":"Fev","value":351},{"label":"Mar","value":582},{"label":"Abr","value":421},{"label":"Mai","value":652},{"label":"Jun","value":298},{"label":"Jul","value":324},{"label":"Ago","value":463},{"label":"Set","value":299},{"label":"Out","value":628},{"label":"Nov","value":551},{"label":"Dez","value":615}];
const MX = 652;
