...
const PAGE = "Visa";
const KPIS = [{"l":"Total Immigration Law","v":"618","t":"+15.4%","d":"up"},{"l":"Visa Ativos","v":"6.557","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"71.1%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"93","t":"+12.0%","d":"up"}];
const COLS = ["ID","Visa","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Immigration Law #001","Immigration Law #002","2.080","6.963","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Immigration Law #002","Immigration Law #003","4.348","8.616","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Immigration Law #003","Immigration Law #004","6.122","6.576","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Immigration Law #004","Immigration Law #005","4.679","5.450","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Immigration Law #005","Immigration Law #001","2.949","656","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":701},{"label":"Mar","value":680},{"label":"Abr","value":753},{"label":"Mai","value":612},{"label":"Jun","value":402},{"label":"Jul","value":651},{"label":"Ago","value":583},{"label":"Set","value":382},{"label":"Out","value":762},{"label":"Nov","value":756},{"label":"Dez","value":473}];
const MX = 762;
