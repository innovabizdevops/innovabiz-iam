...
export default function MunicipalGisPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Municipal Gis</h1><p className="text-sm text-muted-foreground">Municipal Gis • iBOS Enterprise</p></div>
