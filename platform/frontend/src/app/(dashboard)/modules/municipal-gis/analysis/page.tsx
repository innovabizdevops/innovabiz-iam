...
const ACCENT = "#059669";
const MODULE = "Municipal GIS";
const PAGE = "Analysis Tools";
const KPIS = [{"l":"Dashboards Ativos","v":"6.721","t":"+0.0%","d":"up"},{"l":"Queries/Dia","v":"2081","t":"-3.6%","d":"down"},{"l":"Dados Processados (GB)","v":"3.801","t":"+12.3%","d":"up"},{"l":"Utilizadores Analytics","v":"1.211","t":"+0.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","524","2026-03-20","870","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2169","2026-01-01","5.142","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4960","2026-03-17","8.484","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2060","2026-02-28","5.116","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1422","2026-03-08","4.872","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":549},{"label":"Mar","value":667},{"label":"Abr","value":607},{"label":"Mai","value":690},{"label":"Jun","value":533},{"label":"Jul","value":670},{"label":"Ago","value":510},{"label":"Set","value":504},{"label":"Out","value":785},{"label":"Nov","value":519},{"label":"Dez","value":796}];
const MX = 796;
