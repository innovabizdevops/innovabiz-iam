...
const PAGE = "Web Map";
const KPIS = [{"l":"Total Municipal Gis","v":"3.312","t":"-0.2%","d":"down"},{"l":"Web Map Ativos","v":"8.307","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"86.1%","t":"+11.5%","d":"up"},{"l":"Score Performance","v":"92","t":"-4.6%","d":"down"}];
const COLS = ["ID","Web Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Municipal Gis #001","Municipal Gis #002","8.965","3.010","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Municipal Gis #002","Municipal Gis #003","4.931","405","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Municipal Gis #003","Municipal Gis #004","1.266","2.240","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Municipal Gis #004","Municipal Gis #005","1.412","8.843","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Municipal Gis #005","Municipal Gis #001","3.553","4.176","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":416},{"label":"Fev","value":548},{"label":"Mar","value":299},{"label":"Abr","value":284},{"label":"Mai","value":421},{"label":"Jun","value":580},{"label":"Jul","value":524},{"label":"Ago","value":408},{"label":"Set","value":386},{"label":"Out","value":379},{"label":"Nov","value":591},{"label":"Dez","value":551}];
const MX = 591;
