...
const PAGE = "Asset Layer";
const KPIS = [{"l":"Ativos Registados","v":"3.738","t":"+2.9%","d":"up"},{"l":"Valor Total (€M)","v":"€43.7M","t":"-3.9%","d":"down"},{"l":"Depreciação Anual (€)","v":"€87346","t":"+17.0%","d":"up"},{"l":"Ativos em Garantia","v":"7.389","t":"+15.5%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 16561.67","8.640","€ 21560.42","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 14163.63","3.979","€ 21522.10","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 40922.99","4.047","€ 9451.42","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 36994.63","1.996","€ 21039.99","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 38444.12","2.637","€ 36477.99","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":737},{"label":"Mar","value":813},{"label":"Abr","value":826},{"label":"Mai","value":555},{"label":"Jun","value":474},{"label":"Jul","value":802},{"label":"Ago","value":784},{"label":"Set","value":663},{"label":"Out","value":709},{"label":"Nov","value":520},{"label":"Dez","value":678}];
const MX = 826;
