...
const ROWS = [
  { id: "001", c: ["Chart Of Accounts-001", "Chart Of Accounts Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Chart Of Accounts-002", "Chart Of Accounts Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Chart Of Accounts-003", "Chart Of Accounts Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Chart Of Accounts-004", "Chart Of Accounts Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Chart Of Accounts-005", "Chart Of Accounts Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Chart Of Accounts", ts: "Há 2min", a: "Sistema" },
