...
const ROWS = [
  { id: "001", c: ["Hierarchy Mgmt-001", "Hierarchy Mgmt Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Hierarchy Mgmt-002", "Hierarchy Mgmt Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Hierarchy Mgmt-003", "Hierarchy Mgmt Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Hierarchy Mgmt-004", "Hierarchy Mgmt Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Hierarchy Mgmt-005", "Hierarchy Mgmt Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Hierarchy Mgmt", ts: "Há 2min", a: "Sistema" },
...
export default function HierarchyMgmtPage() {
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">MDM Hub — iBOS Enterprise</p>
        </div>
