...
export default function SpillResponsePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Spill Response</h1><p className="text-sm text-muted-foreground">Spill Response • iBOS Enterprise</p></div>
