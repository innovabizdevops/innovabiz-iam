...
const PAGE = "Cleanup";
const KPIS = [{"l":"Projetos Melhoria","v":"4.020","t":"+11.5%","d":"up"},{"l":"Savings (€)","v":"€55349","t":"+9.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"89.1%","t":"+17.0%","d":"up"},{"l":"Ciclos PDCA","v":"8.879","t":"+9.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.046","€ 48599.83","266","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.700","€ 44170.93","4.383","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.634","€ 2290.86","1.369","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.457","€ 34966.36","5.886","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.513","€ 33331.46","7.832","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":873},{"label":"Fev","value":888},{"label":"Mar","value":759},{"label":"Abr","value":893},{"label":"Mai","value":664},{"label":"Jun","value":649},{"label":"Jul","value":805},{"label":"Ago","value":708},{"label":"Set","value":877},{"label":"Out","value":535},{"label":"Nov","value":733},{"label":"Dez","value":608}];
const MX = 893;
