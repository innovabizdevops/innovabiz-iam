...
const KPIS = [{"l":"Total Roaming Mgmt","v":"3.290","t":"+12.3%","d":"up"},{"l":"Agreement Ativos","v":"345","t":"+15.8%","d":"up"},{"l":"Eficiência (%)","v":"69.0%","t":"+7.2%","d":"up"},{"l":"Score Performance","v":"71","t":"-1.1%","d":"down"}];
const COLS = ["ID","Agreement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Roaming Mgmt #001","Roaming Mgmt #002","8.036","1.975","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Roaming Mgmt #002","Roaming Mgmt #003","1.001","4.842","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Roaming Mgmt #003","Roaming Mgmt #004","2.780","3.056","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Roaming Mgmt #004","Roaming Mgmt #005","6.453","8.290","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Roaming Mgmt #005","Roaming Mgmt #001","1.740","4.470","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":237},{"label":"Fev","value":363},{"label":"Mar","value":225},{"label":"Abr","value":536},{"label":"Mai","value":446},{"label":"Jun","value":535},{"label":"Jul","value":467},{"label":"Ago","value":531},{"label":"Set","value":417},{"label":"Out","value":436},{"label":"Nov","value":537},{"label":"Dez","value":230}];
const MX = 537;
