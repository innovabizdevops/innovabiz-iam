...
const PAGE = "IoT Roam";
const KPIS = [{"l":"Dispositivos Online","v":"2.752","t":"-5.0%","d":"down"},{"l":"Dados/Min (MB)","v":"4.022","t":"+4.3%","d":"up"},{"l":"Alertas Ativos","v":"1.008","t":"-4.4%","d":"down"},{"l":"Uptime (%)","v":"72.1%","t":"+13.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","1.504","8.326","6.628","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.673","2.052","9.034","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.474","7.667","8.772","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.330","2.707","1.474","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.950","4.470","3.952","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":657},{"label":"Mar","value":503},{"label":"Abr","value":519},{"label":"Mai","value":336},{"label":"Jun","value":456},{"label":"Jul","value":517},{"label":"Ago","value":509},{"label":"Set","value":366},{"label":"Out","value":617},{"label":"Nov","value":439},{"label":"Dez","value":408}];
const MX = 728;
