...
const ACCENT = "#fb923c";
const MODULE = "Roaming Management";
const PAGE = "Settlement";
const KPIS = [{"l":"Total Roaming Mgmt","v":"7.855","t":"-4.1%","d":"down"},{"l":"Settlement Ativos","v":"3.877","t":"-0.2%","d":"down"},{"l":"Eficiência (%)","v":"91.8%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"80","t":"+15.4%","d":"up"}];
const COLS = ["ID","Settlement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Roaming Mgmt #001","Roaming Mgmt #002","7.267","3.208","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Roaming Mgmt #002","Roaming Mgmt #003","6.515","2.111","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Roaming Mgmt #003","Roaming Mgmt #004","6.459","4.013","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Roaming Mgmt #004","Roaming Mgmt #005","3.296","6.135","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Roaming Mgmt #005","Roaming Mgmt #001","8.025","7.608","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":625},{"label":"Mar","value":619},{"label":"Abr","value":798},{"label":"Mai","value":872},{"label":"Jun","value":741},{"label":"Jul","value":806},{"label":"Ago","value":768},{"label":"Set","value":528},{"label":"Out","value":735},{"label":"Nov","value":680},{"label":"Dez","value":647}];
const MX = 872;
