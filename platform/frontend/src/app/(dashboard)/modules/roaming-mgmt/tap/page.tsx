...
const PAGE = "TAP/RAP";
const KPIS = [{"l":"Total Roaming Mgmt","v":"8.521","t":"-5.0%","d":"down"},{"l":"TAP/RAP Ativos","v":"2.159","t":"+1.3%","d":"up"},{"l":"Eficiência (%)","v":"83.0%","t":"+16.1%","d":"up"},{"l":"Score Performance","v":"88","t":"+0.6%","d":"up"}];
const COLS = ["ID","TAP/RAP","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Roaming Mgmt #001","Roaming Mgmt #002","1.510","963","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Roaming Mgmt #002","Roaming Mgmt #003","3.000","8.990","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Roaming Mgmt #003","Roaming Mgmt #004","6.721","6.044","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Roaming Mgmt #004","Roaming Mgmt #005","4.324","2.806","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Roaming Mgmt #005","Roaming Mgmt #001","1.566","3.676","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":586},{"label":"Mar","value":595},{"label":"Abr","value":571},{"label":"Mai","value":694},{"label":"Jun","value":447},{"label":"Jul","value":429},{"label":"Ago","value":449},{"label":"Set","value":475},{"label":"Out","value":759},{"label":"Nov","value":389},{"label":"Dez","value":500}];
const MX = 759;
