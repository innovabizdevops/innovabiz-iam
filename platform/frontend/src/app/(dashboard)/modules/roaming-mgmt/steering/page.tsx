...
const PAGE = "Steering";
const KPIS = [{"l":"Total Roaming Mgmt","v":"1.662","t":"-2.3%","d":"down"},{"l":"Steering Ativos","v":"2.701","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"77.5%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"58","t":"+2.1%","d":"up"}];
const COLS = ["ID","Steering","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Roaming Mgmt #001","Roaming Mgmt #002","4.228","3.591","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Roaming Mgmt #002","Roaming Mgmt #003","4.112","5.086","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Roaming Mgmt #003","Roaming Mgmt #004","481","2.750","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Roaming Mgmt #004","Roaming Mgmt #005","4.047","1.050","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Roaming Mgmt #005","Roaming Mgmt #001","8.602","6.452","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":712},{"label":"Mar","value":703},{"label":"Abr","value":710},{"label":"Mai","value":504},{"label":"Jun","value":652},{"label":"Jul","value":504},{"label":"Ago","value":692},{"label":"Set","value":483},{"label":"Out","value":523},{"label":"Nov","value":716},{"label":"Dez","value":626}];
const MX = 716;
