...
const KPIS = [{"l":"ARR (€M)","v":"€9.8M","t":"+12.7%","d":"up"},{"l":"MRR (€)","v":"€67447","t":"+6.7%","d":"up"},{"l":"Churn (%)","v":"77.8%","t":"+17.6%","d":"up"},{"l":"ARPU (€)","v":"€73857","t":"-0.8%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 26349.24","9.058","€ 14237.20","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 19865.33","460","€ 6760.57","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 6939.07","5.871","€ 2186.87","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 26486.67","8.953","€ 14223.49","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 46465.44","7.149","€ 4943.40","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":844},{"label":"Mar","value":953},{"label":"Abr","value":769},{"label":"Mai","value":908},{"label":"Jun","value":739},{"label":"Jul","value":763},{"label":"Ago","value":659},{"label":"Set","value":733},{"label":"Out","value":698},{"label":"Nov","value":717},{"label":"Dez","value":793}];
const MX = 953;
