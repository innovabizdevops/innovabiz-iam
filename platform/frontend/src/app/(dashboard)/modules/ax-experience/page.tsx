...
/* ═══ AX Experience Design — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "1937", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1527", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€336K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "931086937", cells: ["AX-1937", "AX Experience Design Item 1", "26/2/2026", "€37 037"], status: "active" as const },
    { id: "931090508", cells: ["AX-5508", "AX Experience Design Item 2", "13/9/2026", "€40 608"], status: "pending" as const },
    { id: "931094079", cells: ["AX-9079", "AX Experience Design Item 3", "28/4/2026", "€44 179"], status: "completed" as const },
    { id: "931097650", cells: ["AX-3650", "AX Experience Design Item 4", "15/11/2026", "€47 750"], status: "warning" as const },
    { id: "931101221", cells: ["AX-7221", "AX Experience Design Item 5", "2/6/2026", "€1321"], status: "active" as const },
];
...
export default function AxExperienceDesignPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AX Experience Design</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AX Experience Design</p>
                    </div>
                </div>
