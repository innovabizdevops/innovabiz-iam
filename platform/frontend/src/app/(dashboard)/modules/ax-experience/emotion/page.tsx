...
const ACCENT = "#4f46e5";
const MODULE = "AX Experience Design";
const PAGE = "Emotion";
const KPIS = [{"l":"Perfis Unificados","v":"2.781","t":"+3.6%","d":"up"},{"l":"Segmentos Ativos","v":"7.526","t":"+17.2%","d":"up"},{"l":"NPS Score","v":"73","t":"+12.3%","d":"up"},{"l":"Churn Previsto (%)","v":"85.6%","t":"-2.4%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","2.145","€ 36997.12","72.7%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","331","€ 20695.52","74.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","7.015","€ 26020.14","82.3%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","8.756","€ 26786.29","72.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","7.210","€ 39877.27","88.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":996},{"label":"Mar","value":651},{"label":"Abr","value":840},{"label":"Mai","value":983},{"label":"Jun","value":953},{"label":"Jul","value":950},{"label":"Ago","value":944},{"label":"Set","value":677},{"label":"Out","value":895},{"label":"Nov","value":888},{"label":"Dez","value":653}];
const MX = 996;
