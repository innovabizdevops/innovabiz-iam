...
const PAGE = "Persona Design";
const KPIS = [{"l":"Formulários Ativos","v":"6.279","t":"+16.4%","d":"up"},{"l":"Submissões/Dia","v":"4013","t":"+0.8%","d":"up"},{"l":"Documentos Gerados","v":"432","t":"+16.0%","d":"up"},{"l":"Templates","v":"1.295","t":"+1.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.749","2026-03-12","8.136","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.722","2026-02-20","872","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.417","2026-01-01","2.467","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.684","2026-02-09","8.597","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","370","2026-03-18","5.464","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":573},{"label":"Mar","value":596},{"label":"Abr","value":527},{"label":"Mai","value":502},{"label":"Jun","value":505},{"label":"Jul","value":516},{"label":"Ago","value":585},{"label":"Set","value":429},{"label":"Out","value":389},{"label":"Nov","value":364},{"label":"Dez","value":327}];
const MX = 679;
