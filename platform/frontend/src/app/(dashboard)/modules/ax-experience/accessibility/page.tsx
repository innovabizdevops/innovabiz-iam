...
const KPIS = [{"l":"Perfis Unificados","v":"2.895","t":"+3.0%","d":"up"},{"l":"Segmentos Ativos","v":"8.377","t":"-1.2%","d":"down"},{"l":"NPS Score","v":"81","t":"+17.0%","d":"up"},{"l":"Churn Previsto (%)","v":"86.3%","t":"-1.2%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","2.351","€ 13623.34","84.6%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","8.684","€ 34630.57","92.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","5.445","€ 26123.71","77.4%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","5.556","€ 40670.85","77.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","8.642","€ 30193.07","89.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":638},{"label":"Mar","value":431},{"label":"Abr","value":398},{"label":"Mai","value":617},{"label":"Jun","value":682},{"label":"Jul","value":601},{"label":"Ago","value":696},{"label":"Set","value":397},{"label":"Out","value":504},{"label":"Nov","value":728},{"label":"Dez","value":372}];
const MX = 757;
