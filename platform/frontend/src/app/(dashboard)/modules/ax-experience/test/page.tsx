...
const PAGE = "Test";
const KPIS = [{"l":"Perfis Unificados","v":"5.992","t":"+11.4%","d":"up"},{"l":"Segmentos Ativos","v":"5.444","t":"+8.1%","d":"up"},{"l":"NPS Score","v":"61","t":"-1.1%","d":"down"},{"l":"Churn Previsto (%)","v":"81.9%","t":"+9.8%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","6.000","€ 2615.51","87.3%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","2.392","€ 41761.45","98.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","5.007","€ 4079.57","79.8%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","2.476","€ 24623.11","98.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","1.739","€ 12714.78","95.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":895},{"label":"Fev","value":881},{"label":"Mar","value":977},{"label":"Abr","value":715},{"label":"Mai","value":844},{"label":"Jun","value":874},{"label":"Jul","value":1078},{"label":"Ago","value":778},{"label":"Set","value":1033},{"label":"Out","value":706},{"label":"Nov","value":952},{"label":"Dez","value":913}];
const MX = 1078;
