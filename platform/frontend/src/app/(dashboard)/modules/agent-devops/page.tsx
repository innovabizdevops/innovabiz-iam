...
/* ═══ AI DevOps Agent — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "1748", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4745", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€443K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1909622548", cells: ["AGE-3548", "AI DevOps Agent Item 1", "9/5/2026", "€22 648"], status: "active" as const },
    { id: "1909626119", cells: ["AGE-7119", "AI DevOps Agent Item 2", "24/12/2026", "€26 219"], status: "pending" as const },
    { id: "1909629690", cells: ["AGE-1690", "AI DevOps Agent Item 3", "11/7/2026", "€29 790"], status: "completed" as const },
    { id: "1909633261", cells: ["AGE-5261", "AI DevOps Agent Item 4", "26/2/2026", "€33 361"], status: "warning" as const },
    { id: "1909636832", cells: ["AGE-8832", "AI DevOps Agent Item 5", "13/9/2026", "€36 932"], status: "active" as const },
];
...
export default function AiDevopsAgentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI DevOps Agent</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI DevOps Agent</p>
                    </div>
                </div>
