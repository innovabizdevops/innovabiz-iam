...
const ACCENT = "#7c3aed";
const MODULE = "AI DevOps Agent";
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"3.817","t":"+6.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"94.1%","t":"+17.7%","d":"up"},{"l":"MTTR (h)","v":"174h","t":"+5.6%","d":"up"},{"l":"Satisfação (%)","v":"93.1%","t":"+13.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.397","4.015","567","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.837","1.279","7.336","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.839","443","5.777","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.174","679","4.553","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.345","9.018","7.505","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":800},{"label":"Fev","value":943},{"label":"Mar","value":859},{"label":"Abr","value":849},{"label":"Mai","value":570},{"label":"Jun","value":587},{"label":"Jul","value":590},{"label":"Ago","value":862},{"label":"Set","value":578},{"label":"Out","value":908},{"label":"Nov","value":925},{"label":"Dez","value":853}];
const MX = 943;
