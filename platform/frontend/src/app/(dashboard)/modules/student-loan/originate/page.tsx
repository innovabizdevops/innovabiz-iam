...
const KPIS = [{"l":"Total Student Loan","v":"5.339","t":"+8.4%","d":"up"},{"l":"Originate Ativos","v":"8.083","t":"+3.3%","d":"up"},{"l":"Eficiência (%)","v":"89.8%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"56","t":"-0.3%","d":"down"}];
const COLS = ["ID","Originate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Student Loan #001","Student Loan #002","1.003","821","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Student Loan #002","Student Loan #003","3.150","7.879","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Student Loan #003","Student Loan #004","3.084","6.645","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Student Loan #004","Student Loan #005","2.904","7.173","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Student Loan #005","Student Loan #001","2.650","2.909","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":893},{"label":"Mar","value":848},{"label":"Abr","value":785},{"label":"Mai","value":941},{"label":"Jun","value":990},{"label":"Jul","value":700},{"label":"Ago","value":750},{"label":"Set","value":999},{"label":"Out","value":910},{"label":"Nov","value":874},{"label":"Dez","value":1009}];
const MX = 1009;
