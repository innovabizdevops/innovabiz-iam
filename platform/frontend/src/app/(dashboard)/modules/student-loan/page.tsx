...
const KPIS = [
    { label: "Total Registos", value: "141", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2604", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€334K", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1375228841", cells: ["STU-2841", "Student Loan Item 1", "22/6/2026", "€28 941"], status: "active" as const },
    { id: "1375232412", cells: ["STU-6412", "Student Loan Item 2", "9/1/2026", "€32 512"], status: "pending" as const },
    { id: "1375235983", cells: ["STU-9983", "Student Loan Item 3", "24/8/2026", "€36 083"], status: "completed" as const },
    { id: "1375239554", cells: ["STU-4554", "Student Loan Item 4", "11/3/2026", "€39 654"], status: "warning" as const },
    { id: "1375243125", cells: ["STU-8125", "Student Loan Item 5", "26/10/2026", "€43 225"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Student Loan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Student Loan</p>
                    </div>
                </div>
