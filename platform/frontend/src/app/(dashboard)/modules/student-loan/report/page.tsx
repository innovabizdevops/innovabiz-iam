...
const PAGE = "Report";
const KPIS = [{"l":"Total Student Loan","v":"8.123","t":"+17.0%","d":"up"},{"l":"Report Ativos","v":"2.797","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"90.9%","t":"+9.6%","d":"up"},{"l":"Score Performance","v":"67","t":"+8.1%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Student Loan #001","Student Loan #002","6.975","5.699","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Student Loan #002","Student Loan #003","2.669","1.159","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Student Loan #003","Student Loan #004","776","417","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Student Loan #004","Student Loan #005","6.528","2.204","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Student Loan #005","Student Loan #001","5.130","4.159","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":664},{"label":"Mar","value":672},{"label":"Abr","value":643},{"label":"Mai","value":687},{"label":"Jun","value":1037},{"label":"Jul","value":679},{"label":"Ago","value":1041},{"label":"Set","value":838},{"label":"Out","value":735},{"label":"Nov","value":1010},{"label":"Dez","value":847}];
const MX = 1041;
