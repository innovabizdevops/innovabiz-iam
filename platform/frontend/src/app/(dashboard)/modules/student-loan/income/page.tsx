...
const ACCENT = "#7c3aed";
const MODULE = "Student Loan";
const PAGE = "Income Plan";
const KPIS = [{"l":"Total Student Loan","v":"4.729","t":"+17.4%","d":"up"},{"l":"Income Plan Ativos","v":"2.840","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"82.4%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"63","t":"+13.7%","d":"up"}];
const COLS = ["ID","Income Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Student Loan #001","Student Loan #002","928","3.467","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Student Loan #002","Student Loan #003","5.457","7.442","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Student Loan #003","Student Loan #004","1.986","5.381","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Student Loan #004","Student Loan #005","3.251","2.690","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Student Loan #005","Student Loan #001","8.997","1.634","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":421},{"label":"Mar","value":592},{"label":"Abr","value":512},{"label":"Mai","value":580},{"label":"Jun","value":626},{"label":"Jul","value":347},{"label":"Ago","value":455},{"label":"Set","value":607},{"label":"Out","value":416},{"label":"Nov","value":640},{"label":"Dez","value":657}];
const MX = 657;
