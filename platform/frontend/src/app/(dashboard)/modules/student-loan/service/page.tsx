...
const PAGE = "Service";
const KPIS = [{"l":"Total Student Loan","v":"7.598","t":"+16.4%","d":"up"},{"l":"Service Ativos","v":"2.141","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"76.3%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"64","t":"+14.7%","d":"up"}];
const COLS = ["ID","Service","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Student Loan #001","Student Loan #002","3.099","4.901","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Student Loan #002","Student Loan #003","8.611","5.041","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Student Loan #003","Student Loan #004","7.049","1.583","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Student Loan #004","Student Loan #005","7.302","1.095","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Student Loan #005","Student Loan #001","4.034","3.041","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":453},{"label":"Mar","value":493},{"label":"Abr","value":497},{"label":"Mai","value":507},{"label":"Jun","value":595},{"label":"Jul","value":659},{"label":"Ago","value":695},{"label":"Set","value":423},{"label":"Out","value":771},{"label":"Nov","value":748},{"label":"Dez","value":775}];
const MX = 775;
