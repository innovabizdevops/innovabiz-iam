...
const PAGE = "History Track";
const KPIS = [{"l":"Dashboards Ativos","v":"4.639","t":"+0.7%","d":"up"},{"l":"Queries/Dia","v":"4486","t":"+5.4%","d":"up"},{"l":"Dados Processados (GB)","v":"6.134","t":"+7.6%","d":"up"},{"l":"Utilizadores Analytics","v":"3.469","t":"+15.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","836","2026-03-12","4.564","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3785","2026-03-28","2.399","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3673","2026-03-23","3.830","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1250","2026-03-12","132","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1787","2026-03-11","7.052","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":412},{"label":"Mar","value":731},{"label":"Abr","value":479},{"label":"Mai","value":569},{"label":"Jun","value":356},{"label":"Jul","value":479},{"label":"Ago","value":452},{"label":"Set","value":385},{"label":"Out","value":737},{"label":"Nov","value":735},{"label":"Dez","value":697}];
const MX = 737;
