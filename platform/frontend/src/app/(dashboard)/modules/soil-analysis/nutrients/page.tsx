...
const PAGE = "Nutrient Map";
const KPIS = [{"l":"Dashboards Ativos","v":"5.353","t":"+0.8%","d":"up"},{"l":"Queries/Dia","v":"4484","t":"+13.6%","d":"up"},{"l":"Dados Processados (GB)","v":"3.141","t":"-1.4%","d":"down"},{"l":"Utilizadores Analytics","v":"802","t":"+3.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1048","2026-02-04","8.330","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2826","2026-02-02","6.688","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","376","2026-03-20","2.364","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3671","2026-03-10","7.377","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3897","2026-03-19","3.544","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":798},{"label":"Mar","value":693},{"label":"Abr","value":1000},{"label":"Mai","value":667},{"label":"Jun","value":803},{"label":"Jul","value":633},{"label":"Ago","value":842},{"label":"Set","value":716},{"label":"Out","value":724},{"label":"Nov","value":812},{"label":"Dez","value":869}];
const MX = 1000;
