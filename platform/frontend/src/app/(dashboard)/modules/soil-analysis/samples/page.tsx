...
const PAGE = "Sample Mgmt";
const KPIS = [{"l":"Dashboards Ativos","v":"8.234","t":"+10.8%","d":"up"},{"l":"Queries/Dia","v":"4325","t":"+10.5%","d":"up"},{"l":"Dados Processados (GB)","v":"5.205","t":"+14.6%","d":"up"},{"l":"Utilizadores Analytics","v":"2.604","t":"+13.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4176","2026-02-07","2.368","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3017","2026-01-14","5.412","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","5069","2026-01-06","6.375","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3649","2026-02-25","225","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3639","2026-01-26","1.337","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":586},{"label":"Mar","value":592},{"label":"Abr","value":612},{"label":"Mai","value":495},{"label":"Jun","value":406},{"label":"Jul","value":394},{"label":"Ago","value":465},{"label":"Set","value":719},{"label":"Out","value":717},{"label":"Nov","value":646},{"label":"Dez","value":507}];
const MX = 719;
