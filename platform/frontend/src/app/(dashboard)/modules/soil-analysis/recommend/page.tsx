...
const ACCENT = "#b45309";
const MODULE = "Soil Analysis";
const PAGE = "Recommendations";
const KPIS = [{"l":"Dashboards Ativos","v":"7.905","t":"+8.4%","d":"up"},{"l":"Queries/Dia","v":"4681","t":"+2.5%","d":"up"},{"l":"Dados Processados (GB)","v":"3.944","t":"-1.0%","d":"down"},{"l":"Utilizadores Analytics","v":"4.387","t":"-3.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","149","2026-01-13","4.239","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","580","2026-03-07","6.424","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","654","2026-03-08","1.100","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1880","2026-01-06","3.903","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3295","2026-01-13","7.869","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":841},{"label":"Mar","value":863},{"label":"Abr","value":745},{"label":"Mai","value":994},{"label":"Jun","value":896},{"label":"Jul","value":953},{"label":"Ago","value":902},{"label":"Set","value":959},{"label":"Out","value":979},{"label":"Nov","value":947},{"label":"Dez","value":681}];
const MX = 994;
