...
const PAGE = "pH Monitor";
const KPIS = [{"l":"Dashboards Ativos","v":"4.831","t":"+15.8%","d":"up"},{"l":"Queries/Dia","v":"598","t":"+7.7%","d":"up"},{"l":"Dados Processados (GB)","v":"1.761","t":"+17.6%","d":"up"},{"l":"Utilizadores Analytics","v":"5.093","t":"-1.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2057","2026-03-04","5.869","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3455","2026-02-14","8.501","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2854","2026-03-07","7.687","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","136","2026-03-14","5.303","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3788","2026-01-07","1.362","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":596},{"label":"Mar","value":543},{"label":"Abr","value":619},{"label":"Mai","value":522},{"label":"Jun","value":546},{"label":"Jul","value":712},{"label":"Ago","value":696},{"label":"Set","value":528},{"label":"Out","value":494},{"label":"Nov","value":573},{"label":"Dez","value":662}];
const MX = 712;
