...
export default function OpenHealthPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Open Health</h1><p className="text-sm text-muted-foreground">Open Health • iBOS Enterprise</p></div>
