...
const ACCENT = "#475569";
const MODULE = "IoT Connectivity";
const PAGE = "Device Mgmt";
const KPIS = [{"l":"Dispositivos Online","v":"3.263","t":"-0.1%","d":"down"},{"l":"Dados/Min (MB)","v":"4.815","t":"+9.2%","d":"up"},{"l":"Alertas Ativos","v":"3.427","t":"+6.7%","d":"up"},{"l":"Uptime (%)","v":"77.3%","t":"-4.5%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","910","2.496","1.813","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.885","6.658","5.894","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.421","5.765","269","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.270","7.376","5.856","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","806","8.082","3.010","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":539},{"label":"Fev","value":796},{"label":"Mar","value":672},{"label":"Abr","value":806},{"label":"Mai","value":540},{"label":"Jun","value":662},{"label":"Jul","value":587},{"label":"Ago","value":863},{"label":"Set","value":739},{"label":"Out","value":709},{"label":"Nov","value":757},{"label":"Dez","value":773}];
const MX = 863;
