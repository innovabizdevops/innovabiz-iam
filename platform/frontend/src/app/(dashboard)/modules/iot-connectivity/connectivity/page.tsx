...
const KPIS = [{"l":"Dispositivos Online","v":"6.574","t":"+3.4%","d":"up"},{"l":"Dados/Min (MB)","v":"7.844","t":"+13.2%","d":"up"},{"l":"Alertas Ativos","v":"1.277","t":"-2.3%","d":"down"},{"l":"Uptime (%)","v":"81.6%","t":"-4.6%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","701","5.975","8.759","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.994","5.032","2.973","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.142","7.418","7.752","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","116","8.646","6.791","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.832","6.683","7.900","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":859},{"label":"Fev","value":929},{"label":"Mar","value":644},{"label":"Abr","value":761},{"label":"Mai","value":967},{"label":"Jun","value":702},{"label":"Jul","value":978},{"label":"Ago","value":714},{"label":"Set","value":966},{"label":"Out","value":973},{"label":"Nov","value":1003},{"label":"Dez","value":906}];
const MX = 1003;
