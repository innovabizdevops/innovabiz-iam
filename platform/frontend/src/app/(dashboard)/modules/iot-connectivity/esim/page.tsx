...
const PAGE = "eSIM/iSIM";
const KPIS = [{"l":"Dispositivos Online","v":"3.028","t":"+11.4%","d":"up"},{"l":"Dados/Min (MB)","v":"5.467","t":"+10.8%","d":"up"},{"l":"Alertas Ativos","v":"997","t":"+8.1%","d":"up"},{"l":"Uptime (%)","v":"86.5%","t":"-4.8%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","9.064","6.029","6.455","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.270","4.402","625","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.260","8.145","5.647","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","8.190","2.304","8.145","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.632","8.275","8.489","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":466},{"label":"Mar","value":606},{"label":"Abr","value":316},{"label":"Mai","value":419},{"label":"Jun","value":330},{"label":"Jul","value":522},{"label":"Ago","value":607},{"label":"Set","value":407},{"label":"Out","value":410},{"label":"Nov","value":435},{"label":"Dez","value":560}];
const MX = 607;
