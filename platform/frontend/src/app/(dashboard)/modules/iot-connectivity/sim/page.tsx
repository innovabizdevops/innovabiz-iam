...
const PAGE = "SIM Mgmt";
const KPIS = [{"l":"Dispositivos Online","v":"8.708","t":"+8.5%","d":"up"},{"l":"Dados/Min (MB)","v":"1.372","t":"-5.7%","d":"down"},{"l":"Alertas Ativos","v":"5.083","t":"-3.2%","d":"down"},{"l":"Uptime (%)","v":"65.6%","t":"-0.1%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.981","5.426","6.986","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.189","4.465","3.891","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.371","8.299","1.283","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.081","3.850","2.420","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.627","7.751","6.127","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":581},{"label":"Mar","value":654},{"label":"Abr","value":870},{"label":"Mai","value":777},{"label":"Jun","value":804},{"label":"Jul","value":895},{"label":"Ago","value":815},{"label":"Set","value":854},{"label":"Out","value":573},{"label":"Nov","value":903},{"label":"Dez","value":787}];
const MX = 903;
