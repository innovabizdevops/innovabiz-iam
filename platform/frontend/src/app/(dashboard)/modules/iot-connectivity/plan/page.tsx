...
const KPIS = [{"l":"Dispositivos Online","v":"4.484","t":"+12.5%","d":"up"},{"l":"Dados/Min (MB)","v":"3.469","t":"-5.1%","d":"down"},{"l":"Alertas Ativos","v":"753","t":"+6.8%","d":"up"},{"l":"Uptime (%)","v":"79.7%","t":"+2.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.187","7.674","5.737","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.646","6.497","599","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.787","3.171","3.401","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","459","3.049","1.502","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.711","8.828","5.925","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":664},{"label":"Mar","value":497},{"label":"Abr","value":548},{"label":"Mai","value":575},{"label":"Jun","value":487},{"label":"Jul","value":567},{"label":"Ago","value":403},{"label":"Set","value":527},{"label":"Out","value":475},{"label":"Nov","value":353},{"label":"Dez","value":554}];
const MX = 664;
