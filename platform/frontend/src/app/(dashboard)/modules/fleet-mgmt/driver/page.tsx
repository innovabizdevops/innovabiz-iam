...
const KPIS = [{"l":"Total Fleet Mgmt","v":"1.439","t":"+12.4%","d":"up"},{"l":"Driver Score Ativos","v":"58","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"68.7%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"56","t":"+0.5%","d":"up"}];
const COLS = ["ID","Driver Score","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fleet Mgmt #001","85.3%","3.379","2.286","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Fleet Mgmt #002","84.5%","5.571","3.138","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Fleet Mgmt #003","76.7%","2.006","1.722","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Fleet Mgmt #004","73.1%","3.762","4.344","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fleet Mgmt #005","70.2%","7.513","6.149","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":554},{"label":"Mar","value":586},{"label":"Abr","value":261},{"label":"Mai","value":423},{"label":"Jun","value":338},{"label":"Jul","value":563},{"label":"Ago","value":531},{"label":"Set","value":463},{"label":"Out","value":385},{"label":"Nov","value":347},{"label":"Dez","value":416}];
const MX = 637;
