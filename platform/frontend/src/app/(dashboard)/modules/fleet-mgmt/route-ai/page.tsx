...
const KPIS = [{"l":"Total Fleet Mgmt","v":"873","t":"+14.5%","d":"up"},{"l":"Route Optimize Ativos","v":"6.851","t":"+1.2%","d":"up"},{"l":"Eficiência (%)","v":"91.9%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"65","t":"-4.1%","d":"down"}];
const COLS = ["ID","Route Optimize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fleet Mgmt #001","Fleet Mgmt #002","5.976","3.745","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Fleet Mgmt #002","Fleet Mgmt #003","8.532","808","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Fleet Mgmt #003","Fleet Mgmt #004","2.864","6.307","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Fleet Mgmt #004","Fleet Mgmt #005","6.116","3.341","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fleet Mgmt #005","Fleet Mgmt #001","498","4.930","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":388},{"label":"Mar","value":433},{"label":"Abr","value":380},{"label":"Mai","value":406},{"label":"Jun","value":504},{"label":"Jul","value":666},{"label":"Ago","value":639},{"label":"Set","value":458},{"label":"Out","value":404},{"label":"Nov","value":374},{"label":"Dez","value":324}];
const MX = 666;
