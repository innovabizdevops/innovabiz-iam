...
const ACCENT = "#1e40af";
const MODULE = "Fleet Management";
const PAGE = "Vehicle Tracker";
const KPIS = [{"l":"Total Fleet Mgmt","v":"344","t":"+16.0%","d":"up"},{"l":"Vehicle Tracker Ativos","v":"400","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"65.8%","t":"+15.2%","d":"up"},{"l":"Score Performance","v":"61","t":"+17.5%","d":"up"}];
const COLS = ["ID","Vehicle Tracker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fleet Mgmt #001","Fleet Mgmt #002","7.565","7.710","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Fleet Mgmt #002","Fleet Mgmt #003","3.998","3.478","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Fleet Mgmt #003","Fleet Mgmt #004","3.134","4.025","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Fleet Mgmt #004","Fleet Mgmt #005","1.014","9.069","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fleet Mgmt #005","Fleet Mgmt #001","323","4.498","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":387},{"label":"Mar","value":651},{"label":"Abr","value":454},{"label":"Mai","value":554},{"label":"Jun","value":577},{"label":"Jul","value":647},{"label":"Ago","value":391},{"label":"Set","value":685},{"label":"Out","value":697},{"label":"Nov","value":653},{"label":"Dez","value":649}];
const MX = 697;
