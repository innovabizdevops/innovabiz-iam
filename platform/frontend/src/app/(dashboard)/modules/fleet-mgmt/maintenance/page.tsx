...
const KPIS = [{"l":"Total Fleet Mgmt","v":"710","t":"+3.3%","d":"up"},{"l":"Maintenance Ativos","v":"7.382","t":"+6.8%","d":"up"},{"l":"Eficiência (%)","v":"89.7%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"80","t":"+2.5%","d":"up"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fleet Mgmt #001","Fleet Mgmt #002","4.303","7.355","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Fleet Mgmt #002","Fleet Mgmt #003","8.163","7.240","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Fleet Mgmt #003","Fleet Mgmt #004","4.203","6.117","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Fleet Mgmt #004","Fleet Mgmt #005","8.556","8.119","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fleet Mgmt #005","Fleet Mgmt #001","2.677","6.509","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":537},{"label":"Mar","value":393},{"label":"Abr","value":380},{"label":"Mai","value":432},{"label":"Jun","value":490},{"label":"Jul","value":741},{"label":"Ago","value":476},{"label":"Set","value":403},{"label":"Out","value":625},{"label":"Nov","value":408},{"label":"Dez","value":716}];
const MX = 741;
