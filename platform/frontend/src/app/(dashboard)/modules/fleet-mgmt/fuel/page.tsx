...
const KPIS = [{"l":"Total Fleet Mgmt","v":"6.769","t":"+1.0%","d":"up"},{"l":"Fuel Mgmt Ativos","v":"4.511","t":"+11.4%","d":"up"},{"l":"Eficiência (%)","v":"82.8%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"89","t":"+6.5%","d":"up"}];
const COLS = ["ID","Fuel Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fleet Mgmt #001","Fleet Mgmt #002","1.468","6.462","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Fleet Mgmt #002","Fleet Mgmt #003","1.982","3.589","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Fleet Mgmt #003","Fleet Mgmt #004","7.002","2.201","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Fleet Mgmt #004","Fleet Mgmt #005","1.362","5.903","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fleet Mgmt #005","Fleet Mgmt #001","7.154","2.870","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":438},{"label":"Fev","value":387},{"label":"Mar","value":696},{"label":"Abr","value":546},{"label":"Mai","value":519},{"label":"Jun","value":475},{"label":"Jul","value":365},{"label":"Ago","value":343},{"label":"Set","value":658},{"label":"Out","value":707},{"label":"Nov","value":654},{"label":"Dez","value":660}];
const MX = 707;
