...
const PAGE = "ELD Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.800","t":"+5.5%","d":"up"},{"l":"NC Abertas","v":"4.322","t":"-0.6%","d":"down"},{"l":"Conformidade (%)","v":"86.2%","t":"+7.4%","d":"up"},{"l":"CAPAs Pendentes","v":"8.115","t":"-5.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.573","88.1%","3.801","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.611","94.1%","7.981","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.415","96.6%","8.637","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.684","85.5%","8.682","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","111","75.5%","7.261","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":438},{"label":"Mar","value":683},{"label":"Abr","value":356},{"label":"Mai","value":685},{"label":"Jun","value":591},{"label":"Jul","value":639},{"label":"Ago","value":439},{"label":"Set","value":343},{"label":"Out","value":653},{"label":"Nov","value":460},{"label":"Dez","value":501}];
const MX = 685;
