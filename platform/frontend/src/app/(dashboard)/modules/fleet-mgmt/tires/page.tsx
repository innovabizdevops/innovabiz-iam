...
const PAGE = "Tire Pressure IoT";
const KPIS = [{"l":"Dispositivos Online","v":"1.439","t":"+3.9%","d":"up"},{"l":"Dados/Min (MB)","v":"3.863","t":"+12.4%","d":"up"},{"l":"Alertas Ativos","v":"3.009","t":"+14.9%","d":"up"},{"l":"Uptime (%)","v":"73.0%","t":"+10.2%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.371","700","5.786","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.723","6.650","3.330","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.049","8.329","4.877","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","8.421","7.688","3.092","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.450","234","6.849","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":806},{"label":"Fev","value":743},{"label":"Mar","value":684},{"label":"Abr","value":960},{"label":"Mai","value":931},{"label":"Jun","value":902},{"label":"Jul","value":692},{"label":"Ago","value":669},{"label":"Set","value":1037},{"label":"Out","value":764},{"label":"Nov","value":725},{"label":"Dez","value":949}];
const MX = 1037;
