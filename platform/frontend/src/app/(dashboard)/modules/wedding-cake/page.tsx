...
/* ═══ Wedding Cake & Pastry — Dashboard ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total Registos", value: "8972", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "195", trend: "-17%", trendDirection: "down" as const, icon: Users },
...
const TABLE_ROWS = [
    { id: "2662072", cells: ["WED-8072", "Wedding Cake & Pastry Item 1", "1/5/2026", "€12 172"], status: "active" as const },
    { id: "2665643", cells: ["WED-2643", "Wedding Cake & Pastry Item 2", "16/12/2026", "€15 743"], status: "pending" as const },
    { id: "2669214", cells: ["WED-6214", "Wedding Cake & Pastry Item 3", "3/7/2026", "€19 314"], status: "completed" as const },
    { id: "2672785", cells: ["WED-9785", "Wedding Cake & Pastry Item 4", "18/2/2026", "€22 885"], status: "warning" as const },
    { id: "2676356", cells: ["WED-4356", "Wedding Cake & Pastry Item 5", "5/9/2026", "€26 456"], status: "active" as const },
];
...
export default function WeddingCakePastryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wedding Cake & Pastry</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Wedding Cake & Pastry</p>
                    </div>
                </div>
