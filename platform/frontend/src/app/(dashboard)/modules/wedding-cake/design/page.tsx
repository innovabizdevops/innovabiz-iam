...
const ACCENT = "#ec4899";
const MODULE = "Wedding Cake & Pastry";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"806","t":"+6.7%","d":"up"},{"l":"Submissões/Dia","v":"3331","t":"-3.8%","d":"down"},{"l":"Documentos Gerados","v":"1.885","t":"+8.8%","d":"up"},{"l":"Templates","v":"4.289","t":"+0.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.822","2026-01-20","727","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.747","2026-02-11","1.376","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.815","2026-01-05","3.721","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.576","2026-03-22","7.509","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.974","2026-03-20","1.647","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":594},{"label":"Mar","value":420},{"label":"Abr","value":685},{"label":"Mai","value":620},{"label":"Jun","value":588},{"label":"Jul","value":664},{"label":"Ago","value":361},{"label":"Set","value":444},{"label":"Out","value":564},{"label":"Nov","value":509},{"label":"Dez","value":434}];
const MX = 685;
