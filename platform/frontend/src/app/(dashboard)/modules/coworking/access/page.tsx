...
const ACCENT = "#7c3aed";
const MODULE = "Coworking & Flex Space";
const PAGE = "Access Control";
const KPIS = [{"l":"Total Coworking","v":"4.815","t":"-3.3%","d":"down"},{"l":"Access Control Ativos","v":"8.087","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"81.0%","t":"+1.4%","d":"up"},{"l":"Score Performance","v":"71","t":"+14.3%","d":"up"}];
const COLS = ["ID","Access Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coworking #001","Coworking #002","3.523","401","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Coworking #002","Coworking #003","7.453","3.282","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Coworking #003","Coworking #004","2.083","3.613","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Coworking #004","Coworking #005","2.265","8.074","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coworking #005","Coworking #001","2.067","6.255","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":467},{"label":"Fev","value":296},{"label":"Mar","value":453},{"label":"Abr","value":390},{"label":"Mai","value":601},{"label":"Jun","value":476},{"label":"Jul","value":219},{"label":"Ago","value":612},{"label":"Set","value":255},{"label":"Out","value":545},{"label":"Nov","value":236},{"label":"Dez","value":402}];
const MX = 612;
