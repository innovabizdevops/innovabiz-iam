...
const PAGE = "Membership Plans";
const KPIS = [{"l":"Total Coworking","v":"6.005","t":"+1.1%","d":"up"},{"l":"Membership Plans Ativos","v":"8.476","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"85.1%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"79","t":"+4.8%","d":"up"}];
const COLS = ["ID","Membership Plans","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coworking #001","Coworking #002","7.814","8.113","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Coworking #002","Coworking #003","8.138","4.832","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Coworking #003","Coworking #004","7.497","985","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Coworking #004","Coworking #005","3.052","8.678","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coworking #005","Coworking #001","2.828","7.337","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":536},{"label":"Mar","value":595},{"label":"Abr","value":495},{"label":"Mai","value":416},{"label":"Jun","value":623},{"label":"Jul","value":345},{"label":"Ago","value":654},{"label":"Set","value":284},{"label":"Out","value":330},{"label":"Nov","value":310},{"label":"Dez","value":514}];
const MX = 654;
