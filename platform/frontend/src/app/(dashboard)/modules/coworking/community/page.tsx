...
const PAGE = "Community Hub";
const KPIS = [{"l":"Projetos Sociais","v":"1.107","t":"-3.1%","d":"down"},{"l":"Beneficiários","v":"1.583","t":"+10.5%","d":"up"},{"l":"Investimento CSR (€)","v":"€39919","t":"+17.5%","d":"up"},{"l":"Score Impacto","v":"60","t":"-1.6%","d":"down"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","8.455","€ 31208.94","1.344","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","5.573","€ 42143.16","2.608","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","6.873","€ 6430.52","6.440","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","7.779","€ 11983.56","5.334","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","6.793","€ 23826.94","867","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":734},{"label":"Mar","value":732},{"label":"Abr","value":660},{"label":"Mai","value":730},{"label":"Jun","value":471},{"label":"Jul","value":533},{"label":"Ago","value":686},{"label":"Set","value":527},{"label":"Out","value":517},{"label":"Nov","value":548},{"label":"Dez","value":572}];
const MX = 734;
