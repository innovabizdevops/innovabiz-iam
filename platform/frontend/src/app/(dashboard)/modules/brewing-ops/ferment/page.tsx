...
const PAGE = "Fermentation";
const KPIS = [{"l":"Riscos Identificados","v":"2.795","t":"+11.3%","d":"up"},{"l":"Mitigações Ativas","v":"1.641","t":"+12.3%","d":"up"},{"l":"Score Risco Geral","v":"81","t":"+0.1%","d":"up"},{"l":"Incidentes YTD","v":"2.449","t":"+17.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.632","3.546","3.188","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.063","1.920","5.669","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.604","5.784","2.659","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.469","121","7.227","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.044","3.027","3.682","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":569},{"label":"Mar","value":629},{"label":"Abr","value":595},{"label":"Mai","value":293},{"label":"Jun","value":501},{"label":"Jul","value":456},{"label":"Ago","value":463},{"label":"Set","value":623},{"label":"Out","value":279},{"label":"Nov","value":369},{"label":"Dez","value":611}];
const MX = 629;
...
export default function FermentPage() {
    return (
