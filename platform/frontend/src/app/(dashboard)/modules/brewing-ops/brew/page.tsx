...
const PAGE = "Brew Sheet";
const KPIS = [{"l":"Total Brewing Ops","v":"1.305","t":"-2.4%","d":"down"},{"l":"Brew Sheet Ativos","v":"140","t":"+17.8%","d":"up"},{"l":"Eficiência (%)","v":"68.8%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"85","t":"+2.5%","d":"up"}];
const COLS = ["ID","Brew Sheet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brewing Ops #001","Brewing Ops #002","5.803","305","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Brewing Ops #002","Brewing Ops #003","4.829","2.429","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Brewing Ops #003","Brewing Ops #004","6.490","6.739","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Brewing Ops #004","Brewing Ops #005","6.675","7.594","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brewing Ops #005","Brewing Ops #001","4.684","8.288","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":207},{"label":"Mar","value":593},{"label":"Abr","value":338},{"label":"Mai","value":381},{"label":"Jun","value":413},{"label":"Jul","value":337},{"label":"Ago","value":542},{"label":"Set","value":407},{"label":"Out","value":600},{"label":"Nov","value":347},{"label":"Dez","value":433}];
const MX = 600;
