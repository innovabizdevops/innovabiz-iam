...
const PAGE = "Filtration";
const KPIS = [{"l":"Total Brewing Ops","v":"6.414","t":"-2.8%","d":"down"},{"l":"Filtration Ativos","v":"607","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"65.5%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"70","t":"+5.7%","d":"up"}];
const COLS = ["ID","Filtration","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brewing Ops #001","Brewing Ops #002","2.919","7.990","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Brewing Ops #002","Brewing Ops #003","3.565","1.670","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Brewing Ops #003","Brewing Ops #004","5.548","2.334","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Brewing Ops #004","Brewing Ops #005","3.257","3.336","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brewing Ops #005","Brewing Ops #001","8.596","7.202","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":760},{"label":"Mar","value":916},{"label":"Abr","value":634},{"label":"Mai","value":909},{"label":"Jun","value":799},{"label":"Jul","value":700},{"label":"Ago","value":743},{"label":"Set","value":771},{"label":"Out","value":692},{"label":"Nov","value":884},{"label":"Dez","value":605}];
const MX = 916;
