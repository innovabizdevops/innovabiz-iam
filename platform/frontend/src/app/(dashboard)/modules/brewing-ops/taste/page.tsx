...
const PAGE = "Taste Panel";
const KPIS = [{"l":"Total Brewing Ops","v":"4.986","t":"-0.3%","d":"down"},{"l":"Taste Panel Ativos","v":"8.519","t":"+2.0%","d":"up"},{"l":"Eficiência (%)","v":"74.2%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"78","t":"+13.6%","d":"up"}];
const COLS = ["ID","Taste Panel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brewing Ops #001","Brewing Ops #002","7.578","4.940","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Brewing Ops #002","Brewing Ops #003","939","3.586","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Brewing Ops #003","Brewing Ops #004","588","1.123","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Brewing Ops #004","Brewing Ops #005","3.790","3.349","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brewing Ops #005","Brewing Ops #001","1.498","2.063","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":622},{"label":"Mar","value":550},{"label":"Abr","value":567},{"label":"Mai","value":513},{"label":"Jun","value":327},{"label":"Jul","value":528},{"label":"Ago","value":460},{"label":"Set","value":313},{"label":"Out","value":241},{"label":"Nov","value":544},{"label":"Dez","value":566}];
const MX = 622;
