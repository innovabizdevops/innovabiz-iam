...
const PAGE = "Craft Beer";
const KPIS = [{"l":"Total Brewing Ops","v":"8.939","t":"+0.7%","d":"up"},{"l":"Craft Beer Ativos","v":"8.597","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"82.6%","t":"+6.1%","d":"up"},{"l":"Score Performance","v":"57","t":"-2.5%","d":"down"}];
const COLS = ["ID","Craft Beer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brewing Ops #001","Brewing Ops #002","5.655","6.011","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Brewing Ops #002","Brewing Ops #003","3.048","6.987","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Brewing Ops #003","Brewing Ops #004","588","1.904","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Brewing Ops #004","Brewing Ops #005","2.462","8.775","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brewing Ops #005","Brewing Ops #001","6.026","7.474","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":467},{"label":"Mar","value":314},{"label":"Abr","value":379},{"label":"Mai","value":548},{"label":"Jun","value":464},{"label":"Jul","value":528},{"label":"Ago","value":340},{"label":"Set","value":331},{"label":"Out","value":524},{"label":"Nov","value":415},{"label":"Dez","value":602}];
const MX = 602;
