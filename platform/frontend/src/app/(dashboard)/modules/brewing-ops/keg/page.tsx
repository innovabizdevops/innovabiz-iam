...
const ACCENT = "#78350f";
const MODULE = "Brewing Operations";
const PAGE = "Keg Track";
const KPIS = [{"l":"Total Brewing Ops","v":"4.180","t":"+17.5%","d":"up"},{"l":"Keg Track Ativos","v":"7.894","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"86.4%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"62","t":"+13.5%","d":"up"}];
const COLS = ["ID","Keg Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brewing Ops #001","Brewing Ops #002","8.711","3.580","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Brewing Ops #002","Brewing Ops #003","6.252","4.091","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Brewing Ops #003","Brewing Ops #004","1.630","2.813","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Brewing Ops #004","Brewing Ops #005","5.881","7.088","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brewing Ops #005","Brewing Ops #001","8.376","4.076","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":894},{"label":"Mar","value":640},{"label":"Abr","value":708},{"label":"Mai","value":798},{"label":"Jun","value":931},{"label":"Jul","value":815},{"label":"Ago","value":811},{"label":"Set","value":602},{"label":"Out","value":736},{"label":"Nov","value":811},{"label":"Dez","value":570}];
const MX = 931;
