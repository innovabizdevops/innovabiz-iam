...
const PAGE = "Campaign Create";
const KPIS = [{"l":"Total Fundraising","v":"1.541","t":"+8.4%","d":"up"},{"l":"Campaign Create Ativos","v":"8.882","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"86.3%","t":"+4.6%","d":"up"},{"l":"Score Performance","v":"55","t":"+8.7%","d":"up"}];
const COLS = ["ID","Campaign Create","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fundraising #001","Fundraising #002","7.775","7.226","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Fundraising #002","Fundraising #003","4.755","6.503","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Fundraising #003","Fundraising #004","4.508","3.396","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Fundraising #004","Fundraising #005","1.210","6.580","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fundraising #005","Fundraising #001","8.639","8.144","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":846},{"label":"Fev","value":642},{"label":"Mar","value":639},{"label":"Abr","value":580},{"label":"Mai","value":628},{"label":"Jun","value":787},{"label":"Jul","value":715},{"label":"Ago","value":806},{"label":"Set","value":851},{"label":"Out","value":756},{"label":"Nov","value":739},{"label":"Dez","value":545}];
const MX = 851;
