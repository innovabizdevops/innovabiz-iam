...
const PAGE = "Event Fund";
const KPIS = [{"l":"Total Fundraising","v":"2.784","t":"-1.1%","d":"down"},{"l":"Event Fund Ativos","v":"5.230","t":"+1.8%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"62","t":"+6.8%","d":"up"}];
const COLS = ["ID","Event Fund","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fundraising #001","Fundraising #002","1.965","6.962","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Fundraising #002","Fundraising #003","6.311","5.365","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Fundraising #003","Fundraising #004","1.327","3.336","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Fundraising #004","Fundraising #005","1.460","1.284","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fundraising #005","Fundraising #001","1.929","7.716","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":422},{"label":"Fev","value":615},{"label":"Mar","value":583},{"label":"Abr","value":478},{"label":"Mai","value":400},{"label":"Jun","value":673},{"label":"Jul","value":352},{"label":"Ago","value":412},{"label":"Set","value":690},{"label":"Out","value":701},{"label":"Nov","value":460},{"label":"Dez","value":532}];
const MX = 701;
