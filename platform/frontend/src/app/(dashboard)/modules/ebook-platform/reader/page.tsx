...
const PAGE = "Reader App";
const KPIS = [{"l":"Formulários Ativos","v":"575","t":"-4.0%","d":"down"},{"l":"Submissões/Dia","v":"2419","t":"+8.2%","d":"up"},{"l":"Documentos Gerados","v":"6.995","t":"+3.3%","d":"up"},{"l":"Templates","v":"1.847","t":"+-0.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.046","2026-02-03","565","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.072","2026-01-20","2.812","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.455","2026-02-11","7.820","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.309","2026-01-07","2.012","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","863","2026-01-22","3.023","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":766},{"label":"Mar","value":825},{"label":"Abr","value":608},{"label":"Mai","value":580},{"label":"Jun","value":943},{"label":"Jul","value":946},{"label":"Ago","value":894},{"label":"Set","value":586},{"label":"Out","value":808},{"label":"Nov","value":930},{"label":"Dez","value":619}];
const MX = 946;
