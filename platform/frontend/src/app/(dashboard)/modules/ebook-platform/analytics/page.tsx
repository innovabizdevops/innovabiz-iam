...
const KPIS = [{"l":"Formulários Ativos","v":"6.168","t":"+9.4%","d":"up"},{"l":"Submissões/Dia","v":"4963","t":"+0.2%","d":"up"},{"l":"Documentos Gerados","v":"6.226","t":"+1.9%","d":"up"},{"l":"Templates","v":"8.271","t":"-3.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.461","2026-01-02","8.543","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.847","2026-02-08","2.326","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.061","2026-01-04","6.317","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.180","2026-02-16","2.101","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.310","2026-03-27","3.047","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":488},{"label":"Fev","value":411},{"label":"Mar","value":336},{"label":"Abr","value":211},{"label":"Mai","value":595},{"label":"Jun","value":420},{"label":"Jul","value":395},{"label":"Ago","value":267},{"label":"Set","value":275},{"label":"Out","value":246},{"label":"Nov","value":422},{"label":"Dez","value":350}];
const MX = 595;
