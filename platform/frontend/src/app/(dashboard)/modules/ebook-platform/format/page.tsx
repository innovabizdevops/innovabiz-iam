...
const PAGE = "Format Convert";
const KPIS = [{"l":"Formulários Ativos","v":"5.189","t":"+17.1%","d":"up"},{"l":"Submissões/Dia","v":"1993","t":"+1.9%","d":"up"},{"l":"Documentos Gerados","v":"7.165","t":"+5.3%","d":"up"},{"l":"Templates","v":"3.394","t":"+10.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.859","2026-03-05","1.531","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.123","2026-02-23","6.881","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.097","2026-02-09","3.562","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.868","2026-02-09","439","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","748","2026-01-27","8.493","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":708},{"label":"Mar","value":699},{"label":"Abr","value":764},{"label":"Mai","value":848},{"label":"Jun","value":688},{"label":"Jul","value":565},{"label":"Ago","value":556},{"label":"Set","value":614},{"label":"Out","value":703},{"label":"Nov","value":474},{"label":"Dez","value":593}];
const MX = 848;
