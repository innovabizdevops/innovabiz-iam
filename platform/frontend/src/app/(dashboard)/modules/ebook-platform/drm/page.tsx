...
const ACCENT = "#7c3aed";
const MODULE = "E-Book Platform";
const PAGE = "DRM Apply";
const KPIS = [{"l":"Formulários Ativos","v":"1.723","t":"+12.1%","d":"up"},{"l":"Submissões/Dia","v":"2344","t":"+13.1%","d":"up"},{"l":"Documentos Gerados","v":"4.559","t":"+11.7%","d":"up"},{"l":"Templates","v":"8.945","t":"-5.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.652","2026-01-08","6.445","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.949","2026-01-10","7.393","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.645","2026-01-18","6.807","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.296","2026-01-15","6.193","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","174","2026-01-21","2.476","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":948},{"label":"Fev","value":750},{"label":"Mar","value":790},{"label":"Abr","value":871},{"label":"Mai","value":810},{"label":"Jun","value":1004},{"label":"Jul","value":752},{"label":"Ago","value":960},{"label":"Set","value":804},{"label":"Out","value":991},{"label":"Nov","value":718},{"label":"Dez","value":966}];
const MX = 1004;
