...
const KPIS = [{"l":"Formulários Ativos","v":"8.492","t":"+5.4%","d":"up"},{"l":"Submissões/Dia","v":"4780","t":"+-0.0%","d":"up"},{"l":"Documentos Gerados","v":"3.552","t":"+6.9%","d":"up"},{"l":"Templates","v":"3.633","t":"+17.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.378","2026-02-18","4.816","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.177","2026-03-15","2.293","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","471","2026-03-23","4.259","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.232","2026-02-01","2.275","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.574","2026-03-23","6.672","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":737},{"label":"Mar","value":518},{"label":"Abr","value":433},{"label":"Mai","value":451},{"label":"Jun","value":467},{"label":"Jul","value":402},{"label":"Ago","value":457},{"label":"Set","value":573},{"label":"Out","value":532},{"label":"Nov","value":692},{"label":"Dez","value":760}];
const MX = 762;
