...
/* ═══ MD: Multi-Payment Engine — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "1658", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "500", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€214K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "872349958", cells: ["MD-7958", "MD: Multi-Payment Engine Item 1", "19/11/2026", "€50 058"], status: "active" as const },
    { id: "872353529", cells: ["MD-2529", "MD: Multi-Payment Engine Item 2", "6/6/2026", "€3629"], status: "pending" as const },
    { id: "872357100", cells: ["MD-6100", "MD: Multi-Payment Engine Item 3", "21/1/2026", "€7200"], status: "completed" as const },
    { id: "872360671", cells: ["MD-9671", "MD: Multi-Payment Engine Item 4", "8/8/2026", "€10 771"], status: "warning" as const },
    { id: "872364242", cells: ["MD-4242", "MD: Multi-Payment Engine Item 5", "23/3/2026", "€14 342"], status: "active" as const },
];
...
export default function MdMultipaymentEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Payment Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Payment Engine</p>
                    </div>
                </div>
