...
const PAGE = "Gateway";
const KPIS = [{"l":"Integrações Ativas","v":"6.850","t":"+4.6%","d":"up"},{"l":"Chamadas/Hora","v":"1187","t":"-1.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"85.1%","t":"-5.6%","d":"down"},{"l":"Latência Média (ms)","v":"34ms","t":"+10.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.622","5.169","89.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.545","410","99.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","391","3.378","93.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.300","6.088","88.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.479","1.466","99.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":387},{"label":"Mar","value":371},{"label":"Abr","value":405},{"label":"Mai","value":714},{"label":"Jun","value":330},{"label":"Jul","value":600},{"label":"Ago","value":680},{"label":"Set","value":556},{"label":"Out","value":635},{"label":"Nov","value":347},{"label":"Dez","value":700}];
const MX = 714;
