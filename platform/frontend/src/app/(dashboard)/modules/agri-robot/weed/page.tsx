...
const ACCENT = "#6366f1";
const MODULE = "Agricultural Robots";
const PAGE = "Weed Control";
const KPIS = [{"l":"Total Agri Robot","v":"2.009","t":"+2.6%","d":"up"},{"l":"Weed Control Ativos","v":"2.941","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"69.5%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"79","t":"+11.8%","d":"up"}];
const COLS = ["ID","Weed Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Robot #001","Agri Robot #002","2.373","6.600","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Robot #002","Agri Robot #003","6.651","4.487","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Robot #003","Agri Robot #004","5.298","2.158","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Robot #004","Agri Robot #005","6.050","3.199","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Robot #005","Agri Robot #001","2.578","7.022","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":461},{"label":"Fev","value":714},{"label":"Mar","value":785},{"label":"Abr","value":650},{"label":"Mai","value":418},{"label":"Jun","value":516},{"label":"Jul","value":444},{"label":"Ago","value":694},{"label":"Set","value":773},{"label":"Out","value":435},{"label":"Nov","value":744},{"label":"Dez","value":526}];
const MX = 785;
