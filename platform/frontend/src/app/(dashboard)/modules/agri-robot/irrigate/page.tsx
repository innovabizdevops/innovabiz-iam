...
const KPIS = [{"l":"Total Agri Robot","v":"1.535","t":"+8.6%","d":"up"},{"l":"Irrigation Ativos","v":"7.759","t":"+15.0%","d":"up"},{"l":"Eficiência (%)","v":"77.7%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"75","t":"+13.3%","d":"up"}];
const COLS = ["ID","Irrigation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Robot #001","Agri Robot #002","2.800","175","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Robot #002","Agri Robot #003","1.268","4.686","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Robot #003","Agri Robot #004","1.414","6.603","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Robot #004","Agri Robot #005","8.135","2.554","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Robot #005","Agri Robot #001","7.246","5.585","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":771},{"label":"Fev","value":851},{"label":"Mar","value":702},{"label":"Abr","value":627},{"label":"Mai","value":575},{"label":"Jun","value":599},{"label":"Jul","value":745},{"label":"Ago","value":586},{"label":"Set","value":793},{"label":"Out","value":633},{"label":"Nov","value":672},{"label":"Dez","value":734}];
const MX = 851;
