...
const PAGE = "Plant Sensor";
const KPIS = [{"l":"Dispositivos Online","v":"8.512","t":"+14.8%","d":"up"},{"l":"Dados/Min (MB)","v":"3.350","t":"+3.0%","d":"up"},{"l":"Alertas Ativos","v":"148","t":"+16.7%","d":"up"},{"l":"Uptime (%)","v":"76.9%","t":"+16.5%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","124","5.639","233","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.307","6.979","6.677","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.099","2.700","6.234","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.023","7.183","4.813","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.874","2.762","8.478","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":303},{"label":"Fev","value":440},{"label":"Mar","value":486},{"label":"Abr","value":378},{"label":"Mai","value":382},{"label":"Jun","value":457},{"label":"Jul","value":383},{"label":"Ago","value":300},{"label":"Set","value":433},{"label":"Out","value":293},{"label":"Nov","value":362},{"label":"Dez","value":487}];
const MX = 487;
