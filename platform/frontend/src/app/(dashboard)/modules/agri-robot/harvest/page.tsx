...
const PAGE = "Harvest Bot";
const KPIS = [{"l":"Total Agri Robot","v":"5.158","t":"+8.6%","d":"up"},{"l":"Harvest Bot Ativos","v":"2.591","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"74","t":"+14.9%","d":"up"}];
const COLS = ["ID","Harvest Bot","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Robot #001","Agri Robot #002","4.419","3.631","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Robot #002","Agri Robot #003","5.519","6.229","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Robot #003","Agri Robot #004","1.388","7.685","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Robot #004","Agri Robot #005","366","2.449","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Robot #005","Agri Robot #001","2.536","3.780","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":848},{"label":"Fev","value":675},{"label":"Mar","value":969},{"label":"Abr","value":675},{"label":"Mai","value":835},{"label":"Jun","value":996},{"label":"Jul","value":698},{"label":"Ago","value":871},{"label":"Set","value":808},{"label":"Out","value":626},{"label":"Nov","value":847},{"label":"Dez","value":742}];
const MX = 996;
