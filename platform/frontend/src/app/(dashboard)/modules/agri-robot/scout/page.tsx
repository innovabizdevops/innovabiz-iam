...
const KPIS = [{"l":"Total Agri Robot","v":"2.705","t":"+8.4%","d":"up"},{"l":"Drone Scout Ativos","v":"7.391","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"75.8%","t":"+13.2%","d":"up"},{"l":"Score Performance","v":"74","t":"-3.5%","d":"down"}];
const COLS = ["ID","Drone Scout","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Robot #001","Agri Robot #002","740","2.376","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Robot #002","Agri Robot #003","7.235","2.588","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Robot #003","Agri Robot #004","2.198","5.223","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Robot #004","Agri Robot #005","4.871","285","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Robot #005","Agri Robot #001","3.820","1.809","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":946},{"label":"Fev","value":736},{"label":"Mar","value":884},{"label":"Abr","value":1065},{"label":"Mai","value":1055},{"label":"Jun","value":731},{"label":"Jul","value":1074},{"label":"Ago","value":742},{"label":"Set","value":1062},{"label":"Out","value":947},{"label":"Nov","value":1003},{"label":"Dez","value":1010}];
const MX = 1074;
