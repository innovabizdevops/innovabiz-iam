...
/* ═══ Film Studio — Distribution Film ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "3784", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "498", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "582", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1998869102", cells: ["FIL-6102", "Distribution Film Item 1", "7/3/2026", "€19 202"], status: "active" as const },
    { id: "1998872673", cells: ["FIL-9673", "Distribution Film Item 2", "22/10/2026", "€22 773"], status: "pending" as const },
    { id: "1998876244", cells: ["FIL-4244", "Distribution Film Item 3", "9/5/2026", "€26 344"], status: "completed" as const },
    { id: "1998879815", cells: ["FIL-7815", "Distribution Film Item 4", "24/12/2026", "€29 915"], status: "warning" as const },
    { id: "1998883386", cells: ["FIL-2386", "Distribution Film Item 5", "11/7/2026", "€33 486"], status: "active" as const },
];
...
export default function FilmStudioDistributionFilmPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Distribution Film</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Film Studio • Distribution Film</p>
                    </div>
                </div>
