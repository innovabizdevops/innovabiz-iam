...
const KPIS = [
    { label: "Total", value: "2320", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "305", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3328", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1839052253", cells: ["FIL-2253", "Set Construction Item 1", "18/6/2026", "€2353"], status: "active" as const },
    { id: "1839055824", cells: ["FIL-5824", "Set Construction Item 2", "5/1/2026", "€5924"], status: "pending" as const },
    { id: "1839059395", cells: ["FIL-9395", "Set Construction Item 3", "20/8/2026", "€9495"], status: "completed" as const },
    { id: "1839062966", cells: ["FIL-3966", "Set Construction Item 4", "7/3/2026", "€13 066"], status: "warning" as const },
    { id: "1839066537", cells: ["FIL-7537", "Set Construction Item 5", "22/10/2026", "€16 637"], status: "active" as const },
];
...
export default function FilmStudioSetConstructionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Set Construction</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Film Studio • Set Construction</p>
                    </div>
                </div>
