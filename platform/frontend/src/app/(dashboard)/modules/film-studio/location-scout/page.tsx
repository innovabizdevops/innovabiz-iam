...
/* ═══ Film Studio — Location Scout ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "2430", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "195", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2749", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "161949663", cells: ["FIL-4663", "Location Scout Item 1", "16/4/2026", "€49 763"], status: "active" as const },
    { id: "161953234", cells: ["FIL-8234", "Location Scout Item 2", "3/11/2026", "€3334"], status: "pending" as const },
    { id: "161956805", cells: ["FIL-2805", "Location Scout Item 3", "18/6/2026", "€6905"], status: "completed" as const },
    { id: "161960376", cells: ["FIL-6376", "Location Scout Item 4", "5/1/2026", "€10 476"], status: "warning" as const },
    { id: "161963947", cells: ["FIL-9947", "Location Scout Item 5", "20/8/2026", "€14 047"], status: "active" as const },
];
...
export default function FilmStudioLocationScoutPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Location Scout</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Film Studio • Location Scout</p>
                    </div>
                </div>
