...
/* ═══ Film Studio — Vfx Pipeline ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "1794", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "28", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1787", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1260643064", cells: ["FIL-5064", "Vfx Pipeline Item 1", "17/9/2026", "€43 164"], status: "active" as const },
    { id: "1260646635", cells: ["FIL-8635", "Vfx Pipeline Item 2", "4/4/2026", "€46 735"], status: "pending" as const },
    { id: "1260650206", cells: ["FIL-3206", "Vfx Pipeline Item 3", "19/11/2026", "€306"], status: "completed" as const },
    { id: "1260653777", cells: ["FIL-6777", "Vfx Pipeline Item 4", "6/6/2026", "€3877"], status: "warning" as const },
    { id: "1260657348", cells: ["FIL-1348", "Vfx Pipeline Item 5", "21/1/2026", "€7448"], status: "active" as const },
];
...
export default function FilmStudioVfxPipelinePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Vfx Pipeline</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Film Studio • Vfx Pipeline</p>
                    </div>
                </div>
