...
/* ═══ Film Studio — Costume Design ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "4283", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "440", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1380", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "461568628", cells: ["FIL-4628", "Costume Design Item 1", "25/5/2026", "€18 728"], status: "active" as const },
    { id: "461572199", cells: ["FIL-8199", "Costume Design Item 2", "12/12/2026", "€22 299"], status: "pending" as const },
    { id: "461575770", cells: ["FIL-2770", "Costume Design Item 3", "27/7/2026", "€25 870"], status: "completed" as const },
    { id: "461579341", cells: ["FIL-6341", "Costume Design Item 4", "14/2/2026", "€29 441"], status: "warning" as const },
    { id: "461582912", cells: ["FIL-9912", "Costume Design Item 5", "1/9/2026", "€33 012"], status: "active" as const },
];
...
export default function FilmStudioCostumeDesignPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Costume Design</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Film Studio • Costume Design</p>
                    </div>
                </div>
