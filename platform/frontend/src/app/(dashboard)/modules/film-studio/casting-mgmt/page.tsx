...
/* ═══ Film Studio — Casting Mgmt ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "2610", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "112", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "670", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "897648524", cells: ["FIL-7524", "Casting Mgmt Item 1", "25/9/2026", "€48 624"], status: "active" as const },
    { id: "897652095", cells: ["FIL-2095", "Casting Mgmt Item 2", "12/4/2026", "€2195"], status: "pending" as const },
    { id: "897655666", cells: ["FIL-5666", "Casting Mgmt Item 3", "27/11/2026", "€5766"], status: "completed" as const },
    { id: "897659237", cells: ["FIL-9237", "Casting Mgmt Item 4", "14/6/2026", "€9337"], status: "warning" as const },
    { id: "897662808", cells: ["FIL-3808", "Casting Mgmt Item 5", "1/1/2026", "€12 908"], status: "active" as const },
];
...
export default function FilmStudioCastingMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Casting Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Film Studio • Casting Mgmt</p>
                    </div>
                </div>
