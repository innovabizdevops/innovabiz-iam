...
/* ═══ Film Studio — Pre Production ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "2861", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "320", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2230", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "93%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "407523356", cells: ["FIL-4356", "Pre Production Item 1", "17/9/2026", "€23 456"], status: "active" as const },
    { id: "407526927", cells: ["FIL-7927", "Pre Production Item 2", "4/4/2026", "€27 027"], status: "pending" as const },
    { id: "407530498", cells: ["FIL-2498", "Pre Production Item 3", "19/11/2026", "€30 598"], status: "completed" as const },
    { id: "407534069", cells: ["FIL-6069", "Pre Production Item 4", "6/6/2026", "€34 169"], status: "warning" as const },
    { id: "407537640", cells: ["FIL-9640", "Pre Production Item 5", "21/1/2026", "€37 740"], status: "active" as const },
];
...
export default function FilmStudioPreProductionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pre Production</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Film Studio • Pre Production</p>
                    </div>
                </div>
