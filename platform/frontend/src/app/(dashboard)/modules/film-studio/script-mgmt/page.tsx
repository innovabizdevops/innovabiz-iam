...
/* ═══ Film Studio — Script Mgmt ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "2913", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "364", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "389", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1781044120", cells: ["FIL-8120", "Script Mgmt Item 1", "17/5/2026", "€44 220"], status: "active" as const },
    { id: "1781047691", cells: ["FIL-2691", "Script Mgmt Item 2", "4/12/2026", "€47 791"], status: "pending" as const },
    { id: "1781051262", cells: ["FIL-6262", "Script Mgmt Item 3", "19/7/2026", "€1362"], status: "completed" as const },
    { id: "1781054833", cells: ["FIL-9833", "Script Mgmt Item 4", "6/2/2026", "€4933"], status: "warning" as const },
    { id: "1781058404", cells: ["FIL-4404", "Script Mgmt Item 5", "21/9/2026", "€8504"], status: "active" as const },
];
...
export default function FilmStudioScriptMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Script Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Film Studio • Script Mgmt</p>
                    </div>
                </div>
