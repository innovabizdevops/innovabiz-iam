...
/* ═══ Film Studio — Production Schedule ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "4353", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "116", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2892", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "79%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1449470352", cells: ["FIL-3352", "Production Schedule Item 1", "9/1/2026", "€20 452"], status: "active" as const },
    { id: "1449473923", cells: ["FIL-6923", "Production Schedule Item 2", "24/8/2026", "€24 023"], status: "pending" as const },
    { id: "1449477494", cells: ["FIL-1494", "Production Schedule Item 3", "11/3/2026", "€27 594"], status: "completed" as const },
    { id: "1449481065", cells: ["FIL-5065", "Production Schedule Item 4", "26/10/2026", "€31 165"], status: "warning" as const },
    { id: "1449484636", cells: ["FIL-8636", "Production Schedule Item 5", "13/5/2026", "€34 736"], status: "active" as const },
];
...
export default function FilmStudioProductionSchedulePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Production Schedule</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Film Studio • Production Schedule</p>
                    </div>
                </div>
