...
/* ═══ Film Studio — Post Production ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "1396", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "159", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1178", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1815471275", cells: ["FIL-1275", "Post Production Item 1", "24/12/2026", "€21 375"], status: "active" as const },
    { id: "1815474846", cells: ["FIL-4846", "Post Production Item 2", "11/7/2026", "€24 946"], status: "pending" as const },
    { id: "1815478417", cells: ["FIL-8417", "Post Production Item 3", "26/2/2026", "€28 517"], status: "completed" as const },
    { id: "1815481988", cells: ["FIL-2988", "Post Production Item 4", "13/9/2026", "€32 088"], status: "warning" as const },
    { id: "1815485559", cells: ["FIL-6559", "Post Production Item 5", "28/4/2026", "€35 659"], status: "active" as const },
];
...
export default function FilmStudioPostProductionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Post Production</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Film Studio • Post Production</p>
                    </div>
                </div>
