...
const ACCENT = "#dc2626";
const MODULE = "Record-to-Report (APQC 7.1)";
const PAGE = "Consolidate";
const KPIS = [{"l":"Total Record To Report","v":"1.420","t":"+9.6%","d":"up"},{"l":"Consolidate Ativos","v":"9.047","t":"+15.0%","d":"up"},{"l":"Eficiência (%)","v":"70.0%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"82","t":"+2.1%","d":"up"}];
const COLS = ["ID","Consolidate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Record To Report #001","Record To Report #002","2.994","6.940","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Record To Report #002","Record To Report #003","7.873","4.723","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Record To Report #003","Record To Report #004","2.880","6.681","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Record To Report #004","Record To Report #005","3.112","1.145","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Record To Report #005","Record To Report #001","7.471","4.374","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":865},{"label":"Fev","value":744},{"label":"Mar","value":906},{"label":"Abr","value":671},{"label":"Mai","value":914},{"label":"Jun","value":887},{"label":"Jul","value":954},{"label":"Ago","value":671},{"label":"Set","value":676},{"label":"Out","value":662},{"label":"Nov","value":693},{"label":"Dez","value":857}];
const MX = 954;
