...
const PAGE = "Journal";
const KPIS = [{"l":"Total Record To Report","v":"5.178","t":"+1.0%","d":"up"},{"l":"Journal Ativos","v":"6.585","t":"+18.0%","d":"up"},{"l":"Eficiência (%)","v":"81.5%","t":"+11.8%","d":"up"},{"l":"Score Performance","v":"65","t":"+10.7%","d":"up"}];
const COLS = ["ID","Journal","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Record To Report #001","Record To Report #002","4.419","5.169","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Record To Report #002","Record To Report #003","4.039","4.217","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Record To Report #003","Record To Report #004","8.456","9.000","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Record To Report #004","Record To Report #005","8.231","1.057","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Record To Report #005","Record To Report #001","8.077","1.808","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":643},{"label":"Mar","value":675},{"label":"Abr","value":836},{"label":"Mai","value":771},{"label":"Jun","value":759},{"label":"Jul","value":833},{"label":"Ago","value":770},{"label":"Set","value":903},{"label":"Out","value":921},{"label":"Nov","value":597},{"label":"Dez","value":631}];
const MX = 921;
