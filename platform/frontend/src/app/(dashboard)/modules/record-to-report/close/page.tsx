...
const PAGE = "Close";
const KPIS = [{"l":"Total Record To Report","v":"4.331","t":"+5.5%","d":"up"},{"l":"Close Ativos","v":"5.826","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"66.1%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"93","t":"+14.3%","d":"up"}];
const COLS = ["ID","Close","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Record To Report #001","Record To Report #002","6.543","4.768","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Record To Report #002","Record To Report #003","5.338","2.535","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Record To Report #003","Record To Report #004","4.798","6.393","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Record To Report #004","Record To Report #005","6.732","1.521","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Record To Report #005","Record To Report #001","4.127","648","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":975},{"label":"Fev","value":746},{"label":"Mar","value":1052},{"label":"Abr","value":751},{"label":"Mai","value":1047},{"label":"Jun","value":827},{"label":"Jul","value":789},{"label":"Ago","value":737},{"label":"Set","value":1054},{"label":"Out","value":734},{"label":"Nov","value":773},{"label":"Dez","value":683}];
const MX = 1054;
