...
const PAGE = "Report";
const KPIS = [{"l":"Total Record To Report","v":"2.477","t":"+17.8%","d":"up"},{"l":"Report Ativos","v":"8.345","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"76.2%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"60","t":"+12.6%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Record To Report #001","Record To Report #002","1.757","4.995","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Record To Report #002","Record To Report #003","2.651","673","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Record To Report #003","Record To Report #004","5.747","2.542","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Record To Report #004","Record To Report #005","6.371","3.637","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Record To Report #005","Record To Report #001","7.177","2.977","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":947},{"label":"Fev","value":802},{"label":"Mar","value":852},{"label":"Abr","value":730},{"label":"Mai","value":971},{"label":"Jun","value":766},{"label":"Jul","value":872},{"label":"Ago","value":1018},{"label":"Set","value":661},{"label":"Out","value":768},{"label":"Nov","value":652},{"label":"Dez","value":736}];
const MX = 1018;
