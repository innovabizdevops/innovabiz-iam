...
/* ═══ Record-to-Report (APQC 7.1) — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "3899", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "297", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€82K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "268273999", cells: ["REC-2999", "Record-to-Report (APQC 7.1) Item 1", "8/8/2026", "€24 099"], status: "active" as const },
    { id: "268277570", cells: ["REC-6570", "Record-to-Report (APQC 7.1) Item 2", "23/3/2026", "€27 670"], status: "pending" as const },
    { id: "268281141", cells: ["REC-1141", "Record-to-Report (APQC 7.1) Item 3", "10/10/2026", "€31 241"], status: "completed" as const },
    { id: "268284712", cells: ["REC-4712", "Record-to-Report (APQC 7.1) Item 4", "25/5/2026", "€34 812"], status: "warning" as const },
    { id: "268288283", cells: ["REC-8283", "Record-to-Report (APQC 7.1) Item 5", "12/12/2026", "€38 383"], status: "active" as const },
];
...
export default function RecordtoreportApqc71Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Record-to-Report (APQC 7.1)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Record-to-Report (APQC 7.1)</p>
                    </div>
                </div>
