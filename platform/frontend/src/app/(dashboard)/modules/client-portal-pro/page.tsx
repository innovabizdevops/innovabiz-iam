...
export default function ClientPortalProPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Client Portal Pro</h1><p className="text-sm text-muted-foreground">Client Portal Pro • iBOS Enterprise</p></div>
