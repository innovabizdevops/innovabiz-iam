...
const PAGE = "Real Time Analytics";
...
const ROWS = [
  { id: "001", c: ["Real Time Analytics-001", "Real Time Analytics Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Real Time Analytics-002", "Real Time Analytics Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Real Time Analytics-003", "Real Time Analytics Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Real Time Analytics-004", "Real Time Analytics Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Real Time Analytics-005", "Real Time Analytics Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Real Time Analytics", ts: "Há 2min", a: "Sistema" },
