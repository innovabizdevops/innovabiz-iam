...
const ROWS = [
  { id: "001", c: ["Report Scheduler-001", "Report Scheduler Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Report Scheduler-002", "Report Scheduler Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Report Scheduler-003", "Report Scheduler Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Report Scheduler-004", "Report Scheduler Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Report Scheduler-005", "Report Scheduler Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Report Scheduler", ts: "Há 2min", a: "Sistema" },
