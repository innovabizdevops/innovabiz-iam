...
const ROWS = [
  { id: "001", c: ["Self Service Bi-001", "Self Service Bi Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Self Service Bi-002", "Self Service Bi Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Self Service Bi-003", "Self Service Bi Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Self Service Bi-004", "Self Service Bi Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Self Service Bi-005", "Self Service Bi Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Self Service Bi", ts: "Há 2min", a: "Sistema" },
...
export default function SelfServiceBiPage() {
  return (
