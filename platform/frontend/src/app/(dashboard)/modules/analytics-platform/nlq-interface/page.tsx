...
const ROWS = [
  { id: "001", c: ["Nlq Interface-001", "Nlq Interface Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Nlq Interface-002", "Nlq Interface Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Nlq Interface-003", "Nlq Interface Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Nlq Interface-004", "Nlq Interface Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Nlq Interface-005", "Nlq Interface Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Nlq Interface", ts: "Há 2min", a: "Sistema" },
...
export default function NlqInterfacePage() {
  return (
