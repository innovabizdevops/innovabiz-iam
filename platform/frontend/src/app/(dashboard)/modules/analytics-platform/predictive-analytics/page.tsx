...
const ROWS = [
  { id: "001", c: ["Predictive Analytics-001", "Predictive Analytics Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Predictive Analytics-002", "Predictive Analytics Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Predictive Analytics-003", "Predictive Analytics Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Predictive Analytics-004", "Predictive Analytics Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Predictive Analytics-005", "Predictive Analytics Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Predictive Analytics", ts: "Há 2min", a: "Sistema" },
