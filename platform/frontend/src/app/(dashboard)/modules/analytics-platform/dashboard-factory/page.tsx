...
const PAGE = "Dashboard Factory";
const KPIS = [{"l":"Acionistas","v":"12,847","d":"+2.1%","u":true},{"l":"Reuniões Board","v":"24","d":"+0%","u":true},{"l":"Resoluções","v":"156","d":"+8.4%","u":true},{"l":"ESG Score","v":"A+","d":"+1 nível","u":true}];
const COLS = ["Tipo","Data","Participantes","Deliberação","Prazo","Estado"];
const ROWS = [
  { id: "001", c: ["Dashboard Factory-001", "Dashboard Factory Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Dashboard Factory-002", "Dashboard Factory Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Dashboard Factory-003", "Dashboard Factory Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Dashboard Factory-004", "Dashboard Factory Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Dashboard Factory-005", "Dashboard Factory Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Dashboard Factory", ts: "Há 2min", a: "Sistema" },
...
export default function DashboardFactoryPage() {
  return (
