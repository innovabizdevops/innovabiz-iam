...
const ROWS = [
  { id: "001", c: ["Analytics Govern-001", "Analytics Govern Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Analytics Govern-002", "Analytics Govern Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Analytics Govern-003", "Analytics Govern Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Analytics Govern-004", "Analytics Govern Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Analytics Govern-005", "Analytics Govern Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Analytics Govern", ts: "Há 2min", a: "Sistema" },
...
export default function AnalyticsGovernPage() {
  return (
