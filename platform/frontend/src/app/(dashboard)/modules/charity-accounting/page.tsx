...
/* ═══ Charity Accounting Platform — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "7757", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2397", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€107K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1300927057", cells: ["CHA-5057", "Charity Accounting Platform Item 1", "18/2/2026", "€27 157"], status: "active" as const },
    { id: "1300930628", cells: ["CHA-8628", "Charity Accounting Platform Item 2", "5/9/2026", "€30 728"], status: "pending" as const },
    { id: "1300934199", cells: ["CHA-3199", "Charity Accounting Platform Item 3", "20/4/2026", "€34 299"], status: "completed" as const },
    { id: "1300937770", cells: ["CHA-6770", "Charity Accounting Platform Item 4", "7/11/2026", "€37 870"], status: "warning" as const },
    { id: "1300941341", cells: ["CHA-1341", "Charity Accounting Platform Item 5", "22/6/2026", "€41 441"], status: "active" as const },
];
...
export default function CharityAccountingPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Charity Accounting Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Charity Accounting Platform</p>
                    </div>
                </div>
