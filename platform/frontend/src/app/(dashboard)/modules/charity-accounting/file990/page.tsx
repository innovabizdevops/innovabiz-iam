...
const ACCENT = "#9333ea";
const MODULE = "Charity Accounting Platform";
const PAGE = "990 File";
const KPIS = [{"l":"Total Charity Accounting","v":"2.301","t":"-1.6%","d":"down"},{"l":"990 File Ativos","v":"5.903","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"82.0%","t":"-2.9%","d":"down"},{"l":"Score Performance","v":"71","t":"+12.8%","d":"up"}];
const COLS = ["ID","990 File","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Charity Accounting #001","Charity Accounting #002","1.842","1.326","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Charity Accounting #002","Charity Accounting #003","5.960","8.003","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Charity Accounting #003","Charity Accounting #004","8.800","2.731","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Charity Accounting #004","Charity Accounting #005","7.731","8.049","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Charity Accounting #005","Charity Accounting #001","8.698","5.399","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":565},{"label":"Fev","value":483},{"label":"Mar","value":445},{"label":"Abr","value":368},{"label":"Mai","value":529},{"label":"Jun","value":541},{"label":"Jul","value":381},{"label":"Ago","value":314},{"label":"Set","value":378},{"label":"Out","value":347},{"label":"Nov","value":635},{"label":"Dez","value":609}];
const MX = 635;
...
export default function File990Page() {
    return (
