...
const PAGE = "Federated Query";
const KPIS = [{"l":"Dashboards Ativos","v":"1.534","t":"+10.6%","d":"up"},{"l":"Queries/Dia","v":"3699","t":"+9.6%","d":"up"},{"l":"Dados Processados (GB)","v":"5.067","t":"-4.3%","d":"down"},{"l":"Utilizadores Analytics","v":"6.747","t":"+8.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1513","2026-02-14","3.935","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","463","2026-03-21","1.403","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2886","2026-03-24","6.794","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4583","2026-03-08","3.947","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2826","2026-03-02","1.635","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":877},{"label":"Mar","value":676},{"label":"Abr","value":710},{"label":"Mai","value":797},{"label":"Jun","value":944},{"label":"Jul","value":920},{"label":"Ago","value":590},{"label":"Set","value":667},{"label":"Out","value":931},{"label":"Nov","value":956},{"label":"Dez","value":860}];
const MX = 956;
...
export default function FederatedQueryPage() {
    return (
