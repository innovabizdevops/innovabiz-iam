...
const KPIS = [{"l":"Dashboards Ativos","v":"2.434","t":"+0.6%","d":"up"},{"l":"Queries/Dia","v":"4855","t":"+6.1%","d":"up"},{"l":"Dados Processados (GB)","v":"5.918","t":"-5.1%","d":"down"},{"l":"Utilizadores Analytics","v":"1.908","t":"+6.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","879","2026-03-08","7.722","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1714","2026-03-13","7.237","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1374","2026-01-17","3.276","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2547","2026-03-01","394","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","550","2026-02-26","1.982","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":780},{"label":"Mar","value":633},{"label":"Abr","value":597},{"label":"Mai","value":575},{"label":"Jun","value":463},{"label":"Jul","value":759},{"label":"Ago","value":414},{"label":"Set","value":708},{"label":"Out","value":466},{"label":"Nov","value":468},{"label":"Dez","value":494}];
const MX = 780;
