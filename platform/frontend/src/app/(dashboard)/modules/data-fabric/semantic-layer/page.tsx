...
const PAGE = "Semantic Layer";
const KPIS = [{"l":"Dashboards Ativos","v":"7.998","t":"+13.3%","d":"up"},{"l":"Queries/Dia","v":"3384","t":"+16.5%","d":"up"},{"l":"Dados Processados (GB)","v":"6.653","t":"+14.9%","d":"up"},{"l":"Utilizadores Analytics","v":"7.012","t":"+11.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3182","2026-02-15","8.870","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4519","2026-03-09","2.191","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2681","2026-01-21","483","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","595","2026-03-12","5.539","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1428","2026-01-24","8.956","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":235},{"label":"Fev","value":581},{"label":"Mar","value":262},{"label":"Abr","value":285},{"label":"Mai","value":247},{"label":"Jun","value":552},{"label":"Jul","value":529},{"label":"Ago","value":396},{"label":"Set","value":392},{"label":"Out","value":583},{"label":"Nov","value":627},{"label":"Dez","value":233}];
const MX = 627;
