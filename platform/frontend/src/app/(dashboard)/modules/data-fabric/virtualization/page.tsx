...
const PAGE = "Data Virtualization";
const KPIS = [{"l":"Dashboards Ativos","v":"5.823","t":"+2.4%","d":"up"},{"l":"Queries/Dia","v":"5023","t":"+11.8%","d":"up"},{"l":"Dados Processados (GB)","v":"4.002","t":"+15.5%","d":"up"},{"l":"Utilizadores Analytics","v":"447","t":"-5.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4457","2026-01-27","1.078","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4215","2026-02-28","6.191","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1261","2026-03-21","4.405","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1082","2026-03-11","1.223","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2269","2026-03-26","6.097","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":459},{"label":"Fev","value":596},{"label":"Mar","value":696},{"label":"Abr","value":599},{"label":"Mai","value":507},{"label":"Jun","value":704},{"label":"Jul","value":671},{"label":"Ago","value":392},{"label":"Set","value":547},{"label":"Out","value":522},{"label":"Nov","value":628},{"label":"Dez","value":373}];
const MX = 704;
