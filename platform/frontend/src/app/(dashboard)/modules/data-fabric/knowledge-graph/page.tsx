...
const PAGE = "Knowledge Graph AI";
const KPIS = [{"l":"Dashboards Ativos","v":"442","t":"-2.8%","d":"down"},{"l":"Queries/Dia","v":"2918","t":"+5.1%","d":"up"},{"l":"Dados Processados (GB)","v":"7.807","t":"+12.6%","d":"up"},{"l":"Utilizadores Analytics","v":"1.561","t":"+16.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","619","2026-02-07","8.221","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4072","2026-02-05","5.559","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3082","2026-03-03","1.952","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3895","2026-01-02","619","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4278","2026-01-17","4.314","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":319},{"label":"Fev","value":602},{"label":"Mar","value":273},{"label":"Abr","value":295},{"label":"Mai","value":455},{"label":"Jun","value":597},{"label":"Jul","value":388},{"label":"Ago","value":514},{"label":"Set","value":410},{"label":"Out","value":622},{"label":"Nov","value":609},{"label":"Dez","value":474}];
const MX = 622;
