...
const PAGE = "Data Mesh Domains";
const KPIS = [{"l":"Dashboards Ativos","v":"5.391","t":"-5.6%","d":"down"},{"l":"Queries/Dia","v":"1150","t":"+9.1%","d":"up"},{"l":"Dados Processados (GB)","v":"8.005","t":"+10.8%","d":"up"},{"l":"Utilizadores Analytics","v":"4.031","t":"+1.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2536","2026-01-01","7.262","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2687","2026-02-28","4.848","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2802","2026-02-27","6.794","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2490","2026-01-19","1.411","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1302","2026-01-07","2.057","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":578},{"label":"Mar","value":685},{"label":"Abr","value":609},{"label":"Mai","value":673},{"label":"Jun","value":455},{"label":"Jul","value":752},{"label":"Ago","value":739},{"label":"Set","value":713},{"label":"Out","value":469},{"label":"Nov","value":643},{"label":"Dez","value":445}];
const MX = 805;
...
export default function MeshDomainsPage() {
    return (
