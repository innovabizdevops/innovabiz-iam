...
const PAGE = "Data Product Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"2.170","t":"+5.3%","d":"up"},{"l":"Queries/Dia","v":"161","t":"-2.9%","d":"down"},{"l":"Dados Processados (GB)","v":"6.057","t":"+11.7%","d":"up"},{"l":"Utilizadores Analytics","v":"932","t":"-5.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3643","2026-02-24","1.724","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2305","2026-03-18","2.337","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2404","2026-02-18","701","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1976","2026-01-21","3.852","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1841","2026-03-23","3.216","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":818},{"label":"Mar","value":886},{"label":"Abr","value":772},{"label":"Mai","value":789},{"label":"Jun","value":557},{"label":"Jul","value":735},{"label":"Ago","value":709},{"label":"Set","value":610},{"label":"Out","value":871},{"label":"Nov","value":847},{"label":"Dez","value":706}];
const MX = 886;
