...
const ACCENT = "#7c3aed";
const MODULE = "Data Fabric & Mesh";
const PAGE = "Active Metadata";
const KPIS = [{"l":"Dashboards Ativos","v":"4.527","t":"+14.9%","d":"up"},{"l":"Queries/Dia","v":"1188","t":"+4.9%","d":"up"},{"l":"Dados Processados (GB)","v":"4.645","t":"+14.9%","d":"up"},{"l":"Utilizadores Analytics","v":"3.833","t":"+5.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2667","2026-02-03","438","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","684","2026-03-03","6.644","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4117","2026-01-03","8.391","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","263","2026-02-09","5.114","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4950","2026-03-08","6.964","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1033},{"label":"Fev","value":874},{"label":"Mar","value":955},{"label":"Abr","value":956},{"label":"Mai","value":990},{"label":"Jun","value":763},{"label":"Jul","value":749},{"label":"Ago","value":779},{"label":"Set","value":655},{"label":"Out","value":923},{"label":"Nov","value":1015},{"label":"Dez","value":749}];
const MX = 1033;
...
export default function ActiveMetadataPage() {
    return (
