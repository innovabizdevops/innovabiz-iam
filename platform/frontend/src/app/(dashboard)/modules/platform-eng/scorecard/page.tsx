...
const PAGE = "Score Card";
const KPIS = [{"l":"Formulários Ativos","v":"6.193","t":"+5.8%","d":"up"},{"l":"Submissões/Dia","v":"2875","t":"+6.3%","d":"up"},{"l":"Documentos Gerados","v":"6.963","t":"+0.9%","d":"up"},{"l":"Templates","v":"4.561","t":"+14.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","128","2026-01-25","628","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.733","2026-02-01","1.586","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.194","2026-02-12","320","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.717","2026-01-09","4.116","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","430","2026-02-17","5.272","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":591},{"label":"Mar","value":715},{"label":"Abr","value":643},{"label":"Mai","value":698},{"label":"Jun","value":865},{"label":"Jul","value":821},{"label":"Ago","value":539},{"label":"Set","value":837},{"label":"Out","value":704},{"label":"Nov","value":727},{"label":"Dez","value":881}];
const MX = 881;
