...
const PAGE = "Backstage";
const KPIS = [{"l":"Formulários Ativos","v":"702","t":"-5.7%","d":"down"},{"l":"Submissões/Dia","v":"4047","t":"+1.2%","d":"up"},{"l":"Documentos Gerados","v":"1.972","t":"+14.1%","d":"up"},{"l":"Templates","v":"2.719","t":"+16.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.702","2026-01-09","6.779","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.414","2026-03-15","899","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.667","2026-01-22","8.174","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.518","2026-01-16","1.698","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.867","2026-02-28","4.369","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":914},{"label":"Fev","value":614},{"label":"Mar","value":614},{"label":"Abr","value":634},{"label":"Mai","value":691},{"label":"Jun","value":799},{"label":"Jul","value":669},{"label":"Ago","value":725},{"label":"Set","value":674},{"label":"Out","value":643},{"label":"Nov","value":680},{"label":"Dez","value":780}];
const MX = 914;
