...
const KPIS = [{"l":"Formulários Ativos","v":"8.872","t":"+15.4%","d":"up"},{"l":"Submissões/Dia","v":"780","t":"+5.0%","d":"up"},{"l":"Documentos Gerados","v":"8.356","t":"+8.5%","d":"up"},{"l":"Templates","v":"2.029","t":"+2.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.001","2026-03-08","7.798","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.007","2026-01-28","8.958","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.460","2026-02-25","6.846","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.193","2026-01-10","3.894","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.286","2026-02-25","3.639","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":684},{"label":"Mar","value":863},{"label":"Abr","value":780},{"label":"Mai","value":807},{"label":"Jun","value":781},{"label":"Jul","value":886},{"label":"Ago","value":558},{"label":"Set","value":759},{"label":"Out","value":554},{"label":"Nov","value":735},{"label":"Dez","value":831}];
const MX = 886;
