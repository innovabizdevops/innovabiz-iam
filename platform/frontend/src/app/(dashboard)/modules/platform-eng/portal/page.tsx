...
const PAGE = "IDP Portal";
const KPIS = [{"l":"Formulários Ativos","v":"263","t":"+13.1%","d":"up"},{"l":"Submissões/Dia","v":"1098","t":"-0.6%","d":"down"},{"l":"Documentos Gerados","v":"8.593","t":"+15.4%","d":"up"},{"l":"Templates","v":"3.722","t":"+1.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.592","2026-02-13","3.756","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.763","2026-03-25","2.633","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.812","2026-01-20","3.219","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","760","2026-01-11","6.781","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.256","2026-01-27","8.268","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":570},{"label":"Mar","value":393},{"label":"Abr","value":476},{"label":"Mai","value":530},{"label":"Jun","value":439},{"label":"Jul","value":673},{"label":"Ago","value":329},{"label":"Set","value":553},{"label":"Out","value":398},{"label":"Nov","value":430},{"label":"Dez","value":379}];
const MX = 683;
