...
const ACCENT = "#1e40af";
const MODULE = "Platform Engineering";
const PAGE = "Golden Path";
const KPIS = [{"l":"Formulários Ativos","v":"4.967","t":"-2.4%","d":"down"},{"l":"Submissões/Dia","v":"2424","t":"+1.5%","d":"up"},{"l":"Documentos Gerados","v":"3.556","t":"+5.5%","d":"up"},{"l":"Templates","v":"4.836","t":"-1.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.342","2026-02-10","4.391","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.456","2026-02-02","7.437","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","9.041","2026-03-23","7.148","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.634","2026-03-07","8.521","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","852","2026-03-15","7.103","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":707},{"label":"Mar","value":716},{"label":"Abr","value":673},{"label":"Mai","value":792},{"label":"Jun","value":769},{"label":"Jul","value":853},{"label":"Ago","value":639},{"label":"Set","value":562},{"label":"Out","value":567},{"label":"Nov","value":562},{"label":"Dez","value":715}];
const MX = 853;
