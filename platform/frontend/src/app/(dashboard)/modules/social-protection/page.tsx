...
/* ═══ Social Protection Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "5232", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4190", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€404K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "902558432", cells: ["SOC-3432", "Social Protection Platform Item 1", "21/9/2026", "€8532"], status: "active" as const },
    { id: "902562003", cells: ["SOC-7003", "Social Protection Platform Item 2", "8/4/2026", "€12 103"], status: "pending" as const },
    { id: "902565574", cells: ["SOC-1574", "Social Protection Platform Item 3", "23/11/2026", "€15 674"], status: "completed" as const },
    { id: "902569145", cells: ["SOC-5145", "Social Protection Platform Item 4", "10/6/2026", "€19 245"], status: "warning" as const },
    { id: "902572716", cells: ["SOC-8716", "Social Protection Platform Item 5", "25/1/2026", "€22 816"], status: "active" as const },
];
...
export default function SocialProtectionPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Social Protection Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Social Protection Platform</p>
                    </div>
                </div>
