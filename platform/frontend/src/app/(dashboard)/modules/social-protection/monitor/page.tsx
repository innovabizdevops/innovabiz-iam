...
const PAGE = "Monitor";
const KPIS = [{"l":"Total Social Protection","v":"2.705","t":"+14.9%","d":"up"},{"l":"Monitor Ativos","v":"5.281","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"72.0%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"93","t":"-0.7%","d":"down"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Social Protection #001","Social Protection #002","2.852","144","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Social Protection #002","Social Protection #003","3.878","1.377","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Social Protection #003","Social Protection #004","4.583","8.782","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Social Protection #004","Social Protection #005","1.792","6.345","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Social Protection #005","Social Protection #001","327","2.459","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":681},{"label":"Mar","value":460},{"label":"Abr","value":362},{"label":"Mai","value":457},{"label":"Jun","value":428},{"label":"Jul","value":702},{"label":"Ago","value":552},{"label":"Set","value":632},{"label":"Out","value":525},{"label":"Nov","value":362},{"label":"Dez","value":698}];
const MX = 702;
