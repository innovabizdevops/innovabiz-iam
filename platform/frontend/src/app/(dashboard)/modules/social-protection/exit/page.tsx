...
const PAGE = "Exit";
const KPIS = [{"l":"Total Social Protection","v":"1.836","t":"-1.7%","d":"down"},{"l":"Exit Ativos","v":"4.569","t":"+2.8%","d":"up"},{"l":"Eficiência (%)","v":"69.1%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"90","t":"+1.4%","d":"up"}];
const COLS = ["ID","Exit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Social Protection #001","Social Protection #002","5.599","231","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Social Protection #002","Social Protection #003","4.445","6.165","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Social Protection #003","Social Protection #004","5.179","4.940","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Social Protection #004","Social Protection #005","1.210","899","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Social Protection #005","Social Protection #001","7.583","2.899","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":640},{"label":"Mar","value":664},{"label":"Abr","value":403},{"label":"Mai","value":498},{"label":"Jun","value":504},{"label":"Jul","value":536},{"label":"Ago","value":617},{"label":"Set","value":763},{"label":"Out","value":401},{"label":"Nov","value":553},{"label":"Dez","value":618}];
const MX = 763;
