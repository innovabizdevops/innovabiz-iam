...
const PAGE = "Identify";
const KPIS = [{"l":"Total Social Protection","v":"7.738","t":"+10.9%","d":"up"},{"l":"Identify Ativos","v":"7.848","t":"-1.4%","d":"down"},{"l":"Eficiência (%)","v":"75.0%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"75","t":"+3.6%","d":"up"}];
const COLS = ["ID","Identify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Social Protection #001","Social Protection #002","5.651","2.502","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Social Protection #002","Social Protection #003","9.041","5.199","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Social Protection #003","Social Protection #004","6.739","2.750","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Social Protection #004","Social Protection #005","230","8.358","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Social Protection #005","Social Protection #001","1.893","2.772","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":526},{"label":"Fev","value":417},{"label":"Mar","value":680},{"label":"Abr","value":414},{"label":"Mai","value":544},{"label":"Jun","value":626},{"label":"Jul","value":400},{"label":"Ago","value":454},{"label":"Set","value":505},{"label":"Out","value":368},{"label":"Nov","value":646},{"label":"Dez","value":619}];
const MX = 680;
