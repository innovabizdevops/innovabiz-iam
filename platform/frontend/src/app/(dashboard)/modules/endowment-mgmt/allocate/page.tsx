...
const ACCENT = "#9333ea";
const MODULE = "Endowment Management";
const PAGE = "Allocate";
const KPIS = [{"l":"Total Endowment Mgmt","v":"3.765","t":"+7.5%","d":"up"},{"l":"Allocate Ativos","v":"3.269","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"81.1%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"82","t":"-4.5%","d":"down"}];
const COLS = ["ID","Allocate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Endowment Mgmt #001","Endowment Mgmt #002","8.120","1.359","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Endowment Mgmt #002","Endowment Mgmt #003","6.872","9.002","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Endowment Mgmt #003","Endowment Mgmt #004","1.018","2.114","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Endowment Mgmt #004","Endowment Mgmt #005","6.434","4.931","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Endowment Mgmt #005","Endowment Mgmt #001","8.027","1.465","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":827},{"label":"Mar","value":539},{"label":"Abr","value":747},{"label":"Mai","value":593},{"label":"Jun","value":609},{"label":"Jul","value":665},{"label":"Ago","value":771},{"label":"Set","value":671},{"label":"Out","value":789},{"label":"Nov","value":580},{"label":"Dez","value":706}];
const MX = 827;
