...
const PAGE = "Spend";
const KPIS = [{"l":"Total Endowment Mgmt","v":"8.277","t":"+8.2%","d":"up"},{"l":"Spend Ativos","v":"6.059","t":"+4.8%","d":"up"},{"l":"Eficiência (%)","v":"85.5%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"58","t":"+8.4%","d":"up"}];
const COLS = ["ID","Spend","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Endowment Mgmt #001","Endowment Mgmt #002","2.265","1.846","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Endowment Mgmt #002","Endowment Mgmt #003","7.944","3.506","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Endowment Mgmt #003","Endowment Mgmt #004","7.741","5.554","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Endowment Mgmt #004","Endowment Mgmt #005","732","2.427","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Endowment Mgmt #005","Endowment Mgmt #001","1.843","7.492","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":903},{"label":"Fev","value":977},{"label":"Mar","value":951},{"label":"Abr","value":684},{"label":"Mai","value":641},{"label":"Jun","value":978},{"label":"Jul","value":713},{"label":"Ago","value":886},{"label":"Set","value":674},{"label":"Out","value":790},{"label":"Nov","value":917},{"label":"Dez","value":908}];
const MX = 978;
