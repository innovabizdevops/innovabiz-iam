...
/* ═══ Endowment Management — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "5080", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3413", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€330K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "-13%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "792103980", cells: ["END-5980", "Endowment Management Item 1", "25/1/2026", "€4080"], status: "active" as const },
    { id: "792107551", cells: ["END-9551", "Endowment Management Item 2", "12/8/2026", "€7651"], status: "pending" as const },
    { id: "792111122", cells: ["END-4122", "Endowment Management Item 3", "27/3/2026", "€11 222"], status: "completed" as const },
    { id: "792114693", cells: ["END-7693", "Endowment Management Item 4", "14/10/2026", "€14 793"], status: "warning" as const },
    { id: "792118264", cells: ["END-2264", "Endowment Management Item 5", "1/5/2026", "€18 364"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Endowment Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Endowment Management</p>
                    </div>
                </div>
