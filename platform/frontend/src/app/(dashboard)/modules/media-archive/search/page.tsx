...
const ACCENT = "#6366f1";
const MODULE = "Media Archive (MAM)";
const PAGE = "Search";
const KPIS = [{"l":"Integrações Ativas","v":"5.620","t":"-3.7%","d":"down"},{"l":"Chamadas/Hora","v":"3549","t":"+2.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"85.8%","t":"+13.0%","d":"up"},{"l":"Latência Média (ms)","v":"133ms","t":"+14.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.149","6.999","75.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.199","8.710","96.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.175","700","76.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.105","3.526","72.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.179","5.192","75.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":405},{"label":"Mar","value":701},{"label":"Abr","value":776},{"label":"Mai","value":651},{"label":"Jun","value":786},{"label":"Jul","value":720},{"label":"Ago","value":643},{"label":"Set","value":620},{"label":"Out","value":648},{"label":"Nov","value":388},{"label":"Dez","value":531}];
const MX = 786;
