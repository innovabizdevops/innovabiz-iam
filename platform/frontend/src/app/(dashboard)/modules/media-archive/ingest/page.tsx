...
const PAGE = "Ingest";
const KPIS = [{"l":"Integrações Ativas","v":"3.933","t":"-5.2%","d":"down"},{"l":"Chamadas/Hora","v":"103","t":"-5.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"92.9%","t":"+4.6%","d":"up"},{"l":"Latência Média (ms)","v":"202ms","t":"+5.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.436","1.843","91.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.708","2.552","73.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","9.067","4.855","70.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.976","8.122","73.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.437","1.991","77.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":450},{"label":"Fev","value":725},{"label":"Mar","value":647},{"label":"Abr","value":799},{"label":"Mai","value":759},{"label":"Jun","value":529},{"label":"Jul","value":440},{"label":"Ago","value":534},{"label":"Set","value":569},{"label":"Out","value":753},{"label":"Nov","value":746},{"label":"Dez","value":635}];
const MX = 799;
