...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"1.017","t":"+6.8%","d":"up"},{"l":"Queries/Dia","v":"3320","t":"+6.0%","d":"up"},{"l":"Dados Processados (GB)","v":"7.330","t":"+15.1%","d":"up"},{"l":"Utilizadores Analytics","v":"367","t":"-4.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3352","2026-03-03","2.070","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2363","2026-01-01","4.467","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3914","2026-01-12","7.279","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2065","2026-01-13","5.192","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4721","2026-02-09","8.863","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":483},{"label":"Mar","value":717},{"label":"Abr","value":580},{"label":"Mai","value":637},{"label":"Jun","value":495},{"label":"Jul","value":454},{"label":"Ago","value":600},{"label":"Set","value":797},{"label":"Out","value":552},{"label":"Nov","value":527},{"label":"Dez","value":553}];
const MX = 797;
