...
const PAGE = "Deliver";
const KPIS = [{"l":"Integrações Ativas","v":"4.552","t":"+16.3%","d":"up"},{"l":"Chamadas/Hora","v":"1102","t":"+10.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"74.5%","t":"-5.9%","d":"down"},{"l":"Latência Média (ms)","v":"203ms","t":"+6.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.646","2.850","80.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.544","3.026","70.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.047","4.780","85.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.948","2.879","81.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.921","4.624","71.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":887},{"label":"Fev","value":612},{"label":"Mar","value":693},{"label":"Abr","value":583},{"label":"Mai","value":796},{"label":"Jun","value":741},{"label":"Jul","value":815},{"label":"Ago","value":734},{"label":"Set","value":857},{"label":"Out","value":512},{"label":"Nov","value":547},{"label":"Dez","value":804}];
const MX = 887;
