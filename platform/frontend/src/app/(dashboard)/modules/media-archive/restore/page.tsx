...
const PAGE = "Restore";
const KPIS = [{"l":"Pedidos/Dia","v":"2607","t":"+0.7%","d":"up"},{"l":"GMV (€)","v":"€71137","t":"-1.0%","d":"down"},{"l":"Conversão (%)","v":"65.9%","t":"+17.4%","d":"up"},{"l":"AOV (€)","v":"€89915","t":"+3.3%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 25475.36","2.517","5.011","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 27172.71","2.257","3.973","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 13127.14","2.533","4.237","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 1069.13","8.090","5.160","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 32807.96","3.295","3.203","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":855},{"label":"Fev","value":712},{"label":"Mar","value":904},{"label":"Abr","value":746},{"label":"Mai","value":867},{"label":"Jun","value":1008},{"label":"Jul","value":758},{"label":"Ago","value":874},{"label":"Set","value":743},{"label":"Out","value":690},{"label":"Nov","value":703},{"label":"Dez","value":1015}];
const MX = 1015;
