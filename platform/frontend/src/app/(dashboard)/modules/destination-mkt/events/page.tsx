...
const PAGE = "Events";
const KPIS = [{"l":"Total Destination Mkt","v":"4.863","t":"+12.1%","d":"up"},{"l":"Events Ativos","v":"2.198","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"91.8%","t":"+5.0%","d":"up"},{"l":"Score Performance","v":"80","t":"-3.8%","d":"down"}];
const COLS = ["ID","Events","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Destination Mkt #001","Destination Mkt #002","5.816","3.873","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Destination Mkt #002","Destination Mkt #003","6.748","3.779","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Destination Mkt #003","Destination Mkt #004","1.091","6.147","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Destination Mkt #004","Destination Mkt #005","7.349","2.892","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Destination Mkt #005","Destination Mkt #001","3.692","7.276","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":946},{"label":"Fev","value":930},{"label":"Mar","value":807},{"label":"Abr","value":834},{"label":"Mai","value":1002},{"label":"Jun","value":993},{"label":"Jul","value":737},{"label":"Ago","value":983},{"label":"Set","value":794},{"label":"Out","value":702},{"label":"Nov","value":646},{"label":"Dez","value":673}];
const MX = 1002;
