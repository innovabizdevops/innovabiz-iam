...
const ACCENT = "#6366f1";
const MODULE = "Destination Marketing";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"3.309","t":"+17.1%","d":"up"},{"l":"Queries/Dia","v":"1098","t":"+17.1%","d":"up"},{"l":"Dados Processados (GB)","v":"4.994","t":"+5.1%","d":"up"},{"l":"Utilizadores Analytics","v":"8.243","t":"+13.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4192","2026-03-27","4.744","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2378","2026-03-24","4.532","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4239","2026-01-22","8.532","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1569","2026-03-06","5.821","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2045","2026-03-21","8.408","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":566},{"label":"Mar","value":236},{"label":"Abr","value":558},{"label":"Mai","value":383},{"label":"Jun","value":603},{"label":"Jul","value":609},{"label":"Ago","value":614},{"label":"Set","value":412},{"label":"Out","value":448},{"label":"Nov","value":309},{"label":"Dez","value":395}];
const MX = 614;
