...
export default function DestinationMktPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Destination Mkt</h1><p className="text-sm text-muted-foreground">Destination Mkt • iBOS Enterprise</p></div>
