...
const PAGE = "Campaign";
const KPIS = [{"l":"Total Destination Mkt","v":"575","t":"-3.3%","d":"down"},{"l":"Campaign Ativos","v":"4.914","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"71.0%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"85","t":"+0.6%","d":"up"}];
const COLS = ["ID","Campaign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Destination Mkt #001","Destination Mkt #002","7.785","2.909","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Destination Mkt #002","Destination Mkt #003","8.343","369","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Destination Mkt #003","Destination Mkt #004","5.243","3.447","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Destination Mkt #004","Destination Mkt #005","1.433","2.412","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Destination Mkt #005","Destination Mkt #001","6.293","9.081","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":528},{"label":"Mar","value":729},{"label":"Abr","value":630},{"label":"Mai","value":543},{"label":"Jun","value":679},{"label":"Jul","value":538},{"label":"Ago","value":621},{"label":"Set","value":563},{"label":"Out","value":573},{"label":"Nov","value":620},{"label":"Dez","value":719}];
const MX = 729;
