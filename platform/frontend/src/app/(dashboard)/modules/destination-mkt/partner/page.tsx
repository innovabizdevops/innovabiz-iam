...
const PAGE = "Partner";
const KPIS = [{"l":"Total Destination Mkt","v":"8.565","t":"+13.8%","d":"up"},{"l":"Partner Ativos","v":"4.617","t":"+13.8%","d":"up"},{"l":"Eficiência (%)","v":"81.3%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"58","t":"-3.1%","d":"down"}];
const COLS = ["ID","Partner","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Destination Mkt #001","Destination Mkt #002","6.184","6.989","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Destination Mkt #002","Destination Mkt #003","7.368","632","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Destination Mkt #003","Destination Mkt #004","3.945","5.544","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Destination Mkt #004","Destination Mkt #005","1.793","3.999","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Destination Mkt #005","Destination Mkt #001","6.986","6.695","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":501},{"label":"Mar","value":745},{"label":"Abr","value":635},{"label":"Mai","value":758},{"label":"Jun","value":713},{"label":"Jul","value":671},{"label":"Ago","value":840},{"label":"Set","value":710},{"label":"Out","value":767},{"label":"Nov","value":703},{"label":"Dez","value":652}];
const MX = 840;
