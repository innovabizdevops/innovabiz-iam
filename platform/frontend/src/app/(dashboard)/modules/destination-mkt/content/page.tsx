...
const PAGE = "Content";
const KPIS = [{"l":"Total Destination Mkt","v":"1.092","t":"-0.8%","d":"down"},{"l":"Content Ativos","v":"6.365","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"70.0%","t":"-6.0%","d":"down"},{"l":"Score Performance","v":"61","t":"-3.7%","d":"down"}];
const COLS = ["ID","Content","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Destination Mkt #001","Destination Mkt #002","1.618","1.478","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Destination Mkt #002","Destination Mkt #003","3.514","7.054","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Destination Mkt #003","Destination Mkt #004","7.637","2.717","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Destination Mkt #004","Destination Mkt #005","2.029","3.975","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Destination Mkt #005","Destination Mkt #001","4.159","5.393","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":920},{"label":"Mar","value":744},{"label":"Abr","value":885},{"label":"Mai","value":599},{"label":"Jun","value":872},{"label":"Jul","value":630},{"label":"Ago","value":851},{"label":"Set","value":887},{"label":"Out","value":788},{"label":"Nov","value":665},{"label":"Dez","value":746}];
const MX = 920;
