...
const ACCENT = "#1e293b";
const MODULE = "Coroner Operations";
const PAGE = "Statistics";
const KPIS = [{"l":"Total Coroner Ops","v":"5.032","t":"+7.5%","d":"up"},{"l":"Statistics Ativos","v":"7.893","t":"+1.2%","d":"up"},{"l":"Eficiência (%)","v":"83.6%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"62","t":"+3.8%","d":"up"}];
const COLS = ["ID","Statistics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coroner Ops #001","Coroner Ops #002","923","6.786","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Coroner Ops #002","Coroner Ops #003","7.165","1.938","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Coroner Ops #003","Coroner Ops #004","8.790","4.883","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Coroner Ops #004","Coroner Ops #005","3.784","4.459","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coroner Ops #005","Coroner Ops #001","7.640","6.253","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":880},{"label":"Mar","value":912},{"label":"Abr","value":758},{"label":"Mai","value":921},{"label":"Jun","value":991},{"label":"Jul","value":860},{"label":"Ago","value":815},{"label":"Set","value":928},{"label":"Out","value":857},{"label":"Nov","value":838},{"label":"Dez","value":766}];
const MX = 991;
