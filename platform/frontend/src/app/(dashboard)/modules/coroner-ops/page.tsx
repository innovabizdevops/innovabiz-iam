...
/* ═══ Coroner Operations — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "5846", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "117", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€118K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1406766046", cells: ["COR-4046", "Coroner Operations Item 1", "15/11/2026", "€16 146"], status: "active" as const },
    { id: "1406769617", cells: ["COR-7617", "Coroner Operations Item 2", "2/6/2026", "€19 717"], status: "pending" as const },
    { id: "1406773188", cells: ["COR-2188", "Coroner Operations Item 3", "17/1/2026", "€23 288"], status: "completed" as const },
    { id: "1406776759", cells: ["COR-5759", "Coroner Operations Item 4", "4/8/2026", "€26 859"], status: "warning" as const },
    { id: "1406780330", cells: ["COR-9330", "Coroner Operations Item 5", "19/3/2026", "€30 430"], status: "active" as const },
];
...
export default function CoronerOperationsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Coroner Operations</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Coroner Operations</p>
                    </div>
                </div>
