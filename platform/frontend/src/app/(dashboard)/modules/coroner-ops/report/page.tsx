...
const PAGE = "Report";
const KPIS = [{"l":"Total Coroner Ops","v":"1.406","t":"-1.8%","d":"down"},{"l":"Report Ativos","v":"3.693","t":"+11.9%","d":"up"},{"l":"Eficiência (%)","v":"80.5%","t":"+17.1%","d":"up"},{"l":"Score Performance","v":"88","t":"+11.6%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coroner Ops #001","Coroner Ops #002","7.917","2.735","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Coroner Ops #002","Coroner Ops #003","6.229","2.966","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Coroner Ops #003","Coroner Ops #004","669","1.287","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Coroner Ops #004","Coroner Ops #005","810","2.636","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coroner Ops #005","Coroner Ops #001","3.312","8.793","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":737},{"label":"Mar","value":699},{"label":"Abr","value":669},{"label":"Mai","value":566},{"label":"Jun","value":588},{"label":"Jul","value":820},{"label":"Ago","value":765},{"label":"Set","value":820},{"label":"Out","value":690},{"label":"Nov","value":755},{"label":"Dez","value":726}];
const MX = 820;
