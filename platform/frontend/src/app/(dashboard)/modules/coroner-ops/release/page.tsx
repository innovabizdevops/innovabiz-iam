...
const PAGE = "Release";
const KPIS = [{"l":"Total Coroner Ops","v":"8.209","t":"-3.3%","d":"down"},{"l":"Release Ativos","v":"6.208","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"92.1%","t":"+17.5%","d":"up"},{"l":"Score Performance","v":"74","t":"+11.4%","d":"up"}];
const COLS = ["ID","Release","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coroner Ops #001","Coroner Ops #002","8.063","7.654","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Coroner Ops #002","Coroner Ops #003","4.842","3.207","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Coroner Ops #003","Coroner Ops #004","4.113","2.532","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Coroner Ops #004","Coroner Ops #005","4.176","8.036","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coroner Ops #005","Coroner Ops #001","3.360","4.313","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":541},{"label":"Mar","value":649},{"label":"Abr","value":527},{"label":"Mai","value":486},{"label":"Jun","value":768},{"label":"Jul","value":722},{"label":"Ago","value":495},{"label":"Set","value":678},{"label":"Out","value":626},{"label":"Nov","value":621},{"label":"Dez","value":763}];
const MX = 768;
