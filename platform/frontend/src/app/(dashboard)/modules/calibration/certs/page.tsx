...
const KPIS = [{"l":"Total Calibration","v":"7.007","t":"+8.3%","d":"up"},{"l":"Certificates Ativos","v":"2.916","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"87.3%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"62","t":"+16.1%","d":"up"}];
const COLS = ["ID","Certificates","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Calibration #001","Calibration #002","1.755","3.617","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Calibration #002","Calibration #003","7.653","8.181","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Calibration #003","Calibration #004","3.159","4.240","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Calibration #004","Calibration #005","1.384","835","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Calibration #005","Calibration #001","3.847","6.588","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":878},{"label":"Mar","value":618},{"label":"Abr","value":544},{"label":"Mai","value":679},{"label":"Jun","value":739},{"label":"Jul","value":818},{"label":"Ago","value":795},{"label":"Set","value":585},{"label":"Out","value":919},{"label":"Nov","value":723},{"label":"Dez","value":818}];
const MX = 919;
