...
const ACCENT = "#0e7490";
const MODULE = "Calibration Mgmt";
const PAGE = "Asset Register";
const KPIS = [{"l":"Ativos Registados","v":"4.331","t":"+16.1%","d":"up"},{"l":"Valor Total (€M)","v":"€30.9M","t":"+11.8%","d":"up"},{"l":"Depreciação Anual (€)","v":"€96736","t":"-5.1%","d":"down"},{"l":"Ativos em Garantia","v":"696","t":"+5.3%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 16806.99","7.675","€ 44758.07","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 1506.63","9.041","€ 43249.67","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 1684.50","7.862","€ 27314.89","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 35754.02","6.078","€ 37788.36","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 21053.10","6.774","€ 13780.00","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":941},{"label":"Fev","value":817},{"label":"Mar","value":856},{"label":"Abr","value":1037},{"label":"Mai","value":815},{"label":"Jun","value":736},{"label":"Jul","value":1074},{"label":"Ago","value":795},{"label":"Set","value":937},{"label":"Out","value":788},{"label":"Nov","value":952},{"label":"Dez","value":815}];
const MX = 1074;
