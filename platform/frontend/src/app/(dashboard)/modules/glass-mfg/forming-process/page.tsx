...
/* ═══ Glass Manufacturing — Forming Process ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "745", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "193", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2969", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "76%", trend: "-17%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1706810109", cells: ["GLA-6109", "Forming Process Item 1", "26/10/2026", "€10 209"], status: "active" as const },
    { id: "1706813680", cells: ["GLA-9680", "Forming Process Item 2", "13/5/2026", "€13 780"], status: "pending" as const },
    { id: "1706817251", cells: ["GLA-4251", "Forming Process Item 3", "28/12/2026", "€17 351"], status: "completed" as const },
    { id: "1706820822", cells: ["GLA-7822", "Forming Process Item 4", "15/7/2026", "€20 922"], status: "warning" as const },
    { id: "1706824393", cells: ["GLA-2393", "Forming Process Item 5", "2/2/2026", "€24 493"], status: "active" as const },
];
...
export default function GlassManufacturingFormingProcessPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Forming Process</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Glass Manufacturing • Forming Process</p>
                    </div>
                </div>
