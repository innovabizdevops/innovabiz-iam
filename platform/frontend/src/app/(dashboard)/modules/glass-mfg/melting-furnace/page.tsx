...
const KPIS = [
    { label: "Total", value: "4228", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "474", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "33", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1691701238", cells: ["GLA-8238", "Melting Furnace Item 1", "11/3/2026", "€1338"], status: "active" as const },
    { id: "1691704809", cells: ["GLA-2809", "Melting Furnace Item 2", "26/10/2026", "€4909"], status: "pending" as const },
    { id: "1691708380", cells: ["GLA-6380", "Melting Furnace Item 3", "13/5/2026", "€8480"], status: "completed" as const },
    { id: "1691711951", cells: ["GLA-9951", "Melting Furnace Item 4", "28/12/2026", "€12 051"], status: "warning" as const },
    { id: "1691715522", cells: ["GLA-4522", "Melting Furnace Item 5", "15/7/2026", "€15 622"], status: "active" as const },
];
...
export default function GlassManufacturingMeltingFurnacePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Melting Furnace</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Glass Manufacturing • Melting Furnace</p>
                    </div>
                </div>
