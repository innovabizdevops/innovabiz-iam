...
/* ═══ Glass Manufacturing — Energy Glass ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "1220", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "392", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3477", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "891102100", cells: ["GLA-4100", "Energy Glass Item 1", "1/5/2026", "€2200"], status: "active" as const },
    { id: "891105671", cells: ["GLA-7671", "Energy Glass Item 2", "16/12/2026", "€5771"], status: "pending" as const },
    { id: "891109242", cells: ["GLA-2242", "Energy Glass Item 3", "3/7/2026", "€9342"], status: "completed" as const },
    { id: "891112813", cells: ["GLA-5813", "Energy Glass Item 4", "18/2/2026", "€12 913"], status: "warning" as const },
    { id: "891116384", cells: ["GLA-9384", "Energy Glass Item 5", "5/9/2026", "€16 484"], status: "active" as const },
];
...
export default function GlassManufacturingEnergyGlassPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Energy Glass</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Glass Manufacturing • Energy Glass</p>
                    </div>
                </div>
