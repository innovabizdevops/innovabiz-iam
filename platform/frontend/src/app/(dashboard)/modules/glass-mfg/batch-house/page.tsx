...
/* ═══ Glass Manufacturing — Batch House ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "1569", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "350", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3485", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2143709386", cells: ["GLA-9386", "Batch House Item 1", "15/11/2026", "€9486"], status: "active" as const },
    { id: "2143712957", cells: ["GLA-3957", "Batch House Item 2", "2/6/2026", "€13 057"], status: "pending" as const },
    { id: "2143716528", cells: ["GLA-7528", "Batch House Item 3", "17/1/2026", "€16 628"], status: "completed" as const },
    { id: "2143720099", cells: ["GLA-2099", "Batch House Item 4", "4/8/2026", "€20 199"], status: "warning" as const },
    { id: "2143723670", cells: ["GLA-5670", "Batch House Item 5", "19/3/2026", "€23 770"], status: "active" as const },
];
...
export default function GlassManufacturingBatchHousePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Batch House</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Glass Manufacturing • Batch House</p>
                    </div>
                </div>
