...
/* ═══ Glass Manufacturing — Cullet Recycle ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "2842", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "120", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1715", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1222888132", cells: ["GLA-5132", "Cullet Recycle Item 1", "5/5/2026", "€38 232"], status: "active" as const },
    { id: "1222891703", cells: ["GLA-8703", "Cullet Recycle Item 2", "20/12/2026", "€41 803"], status: "pending" as const },
    { id: "1222895274", cells: ["GLA-3274", "Cullet Recycle Item 3", "7/7/2026", "€45 374"], status: "completed" as const },
    { id: "1222898845", cells: ["GLA-6845", "Cullet Recycle Item 4", "22/2/2026", "€48 945"], status: "warning" as const },
    { id: "1222902416", cells: ["GLA-1416", "Cullet Recycle Item 5", "9/9/2026", "€2516"], status: "active" as const },
];
...
export default function GlassManufacturingCulletRecyclePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cullet Recycle</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Glass Manufacturing • Cullet Recycle</p>
                    </div>
                </div>
