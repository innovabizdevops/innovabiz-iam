...
/* ═══ Glass Manufacturing — Mold Mgmt ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "4981", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "365", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3858", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1142088489", cells: ["GLA-7489", "Mold Mgmt Item 1", "18/10/2026", "€38 589"], status: "active" as const },
    { id: "1142092060", cells: ["GLA-2060", "Mold Mgmt Item 2", "5/5/2026", "€42 160"], status: "pending" as const },
    { id: "1142095631", cells: ["GLA-5631", "Mold Mgmt Item 3", "20/12/2026", "€45 731"], status: "completed" as const },
    { id: "1142099202", cells: ["GLA-9202", "Mold Mgmt Item 4", "7/7/2026", "€49 302"], status: "warning" as const },
    { id: "1142102773", cells: ["GLA-3773", "Mold Mgmt Item 5", "22/2/2026", "€2873"], status: "active" as const },
];
...
export default function GlassManufacturingMoldMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mold Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Glass Manufacturing • Mold Mgmt</p>
                    </div>
                </div>
