...
/* ═══ Glass Manufacturing — Coating Glass ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "1020", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "467", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1366", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1196930319", cells: ["GLA-3319", "Coating Glass Item 1", "12/4/2026", "€30 419"], status: "active" as const },
    { id: "1196933890", cells: ["GLA-6890", "Coating Glass Item 2", "27/11/2026", "€33 990"], status: "pending" as const },
    { id: "1196937461", cells: ["GLA-1461", "Coating Glass Item 3", "14/6/2026", "€37 561"], status: "completed" as const },
    { id: "1196941032", cells: ["GLA-5032", "Coating Glass Item 4", "1/1/2026", "€41 132"], status: "warning" as const },
    { id: "1196944603", cells: ["GLA-8603", "Coating Glass Item 5", "16/8/2026", "€44 703"], status: "active" as const },
];
...
export default function GlassManufacturingCoatingGlassPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Coating Glass</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Glass Manufacturing • Coating Glass</p>
                    </div>
                </div>
