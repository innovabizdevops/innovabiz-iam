...
const KPIS = [
    { label: "Total", value: "4217", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "401", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3677", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "805690909", cells: ["GLA-2909", "Annealing Item 1", "10/2/2026", "€41 009"], status: "active" as const },
    { id: "805694480", cells: ["GLA-6480", "Annealing Item 2", "25/9/2026", "€44 580"], status: "pending" as const },
    { id: "805698051", cells: ["GLA-1051", "Annealing Item 3", "12/4/2026", "€48 151"], status: "completed" as const },
    { id: "805701622", cells: ["GLA-4622", "Annealing Item 4", "27/11/2026", "€1722"], status: "warning" as const },
    { id: "805705193", cells: ["GLA-8193", "Annealing Item 5", "14/6/2026", "€5293"], status: "active" as const },
];
...
export default function GlassManufacturingAnnealingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Annealing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Glass Manufacturing • Annealing</p>
                    </div>
                </div>
