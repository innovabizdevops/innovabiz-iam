...
/* ═══ Glass Manufacturing — Cold End Process ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "187", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "390", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2805", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "75%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1977810818", cells: ["GLA-7818", "Cold End Process Item 1", "19/3/2026", "€10 918"], status: "active" as const },
    { id: "1977814389", cells: ["GLA-2389", "Cold End Process Item 2", "6/10/2026", "€14 489"], status: "pending" as const },
    { id: "1977817960", cells: ["GLA-5960", "Cold End Process Item 3", "21/5/2026", "€18 060"], status: "completed" as const },
    { id: "1977821531", cells: ["GLA-9531", "Cold End Process Item 4", "8/12/2026", "€21 631"], status: "warning" as const },
    { id: "1977825102", cells: ["GLA-4102", "Cold End Process Item 5", "23/7/2026", "€25 202"], status: "active" as const },
];
...
export default function GlassManufacturingColdEndProcessPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cold End Process</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Glass Manufacturing • Cold End Process</p>
                    </div>
                </div>
