...
/* ═══ Glass Manufacturing — Inspection Glass ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "4510", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "436", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2235", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1392921216", cells: ["GLA-1216", "Inspection Glass Item 1", "9/1/2026", "€21 316"], status: "active" as const },
    { id: "1392924787", cells: ["GLA-4787", "Inspection Glass Item 2", "24/8/2026", "€24 887"], status: "pending" as const },
    { id: "1392928358", cells: ["GLA-8358", "Inspection Glass Item 3", "11/3/2026", "€28 458"], status: "completed" as const },
    { id: "1392931929", cells: ["GLA-2929", "Inspection Glass Item 4", "26/10/2026", "€32 029"], status: "warning" as const },
    { id: "1392935500", cells: ["GLA-6500", "Inspection Glass Item 5", "13/5/2026", "€35 600"], status: "active" as const },
];
...
export default function GlassManufacturingInspectionGlassPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Inspection Glass</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Glass Manufacturing • Inspection Glass</p>
                    </div>
                </div>
