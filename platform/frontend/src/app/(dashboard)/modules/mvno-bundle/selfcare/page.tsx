...
const PAGE = "Self-Care";
const KPIS = [{"l":"Total Mvno Bundle","v":"5.000","t":"-5.4%","d":"down"},{"l":"Self Care Ativos","v":"7.577","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"83.0%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"66","t":"+13.3%","d":"up"}];
const COLS = ["ID","Self Care","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mvno Bundle #001","Mvno Bundle #002","8.765","3.079","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Mvno Bundle #002","Mvno Bundle #003","3.947","4.972","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Mvno Bundle #003","Mvno Bundle #004","3.388","4.016","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Mvno Bundle #004","Mvno Bundle #005","8.379","4.674","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mvno Bundle #005","Mvno Bundle #001","3.514","4.067","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":877},{"label":"Mar","value":631},{"label":"Abr","value":711},{"label":"Mai","value":847},{"label":"Jun","value":677},{"label":"Jul","value":868},{"label":"Ago","value":702},{"label":"Set","value":571},{"label":"Out","value":782},{"label":"Nov","value":731},{"label":"Dez","value":657}];
const MX = 877;
