...
const PAGE = "Promo";
const KPIS = [{"l":"Total Mvno Bundle","v":"199","t":"+0.4%","d":"up"},{"l":"Promo Ativos","v":"2.990","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"92.1%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"82","t":"+16.7%","d":"up"}];
const COLS = ["ID","Promo","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mvno Bundle #001","Mvno Bundle #002","4.650","8.468","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Mvno Bundle #002","Mvno Bundle #003","3.167","8.604","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Mvno Bundle #003","Mvno Bundle #004","3.026","5.565","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Mvno Bundle #004","Mvno Bundle #005","4.845","623","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mvno Bundle #005","Mvno Bundle #001","539","529","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":568},{"label":"Mar","value":708},{"label":"Abr","value":861},{"label":"Mai","value":707},{"label":"Jun","value":852},{"label":"Jul","value":642},{"label":"Ago","value":761},{"label":"Set","value":546},{"label":"Out","value":548},{"label":"Nov","value":584},{"label":"Dez","value":468}];
const MX = 861;
