...
const ACCENT = "#6366f1";
const MODULE = "MVNO Bundle & Plans";
const PAGE = "Plan Design";
const KPIS = [{"l":"Formulários Ativos","v":"8.179","t":"+0.2%","d":"up"},{"l":"Submissões/Dia","v":"3374","t":"+17.6%","d":"up"},{"l":"Documentos Gerados","v":"4.759","t":"+2.3%","d":"up"},{"l":"Templates","v":"8.869","t":"+4.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","724","2026-02-09","4.171","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.005","2026-03-14","1.973","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.923","2026-02-14","5.112","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.604","2026-03-19","5.413","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.713","2026-01-27","2.996","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":591},{"label":"Mar","value":801},{"label":"Abr","value":632},{"label":"Mai","value":802},{"label":"Jun","value":616},{"label":"Jul","value":551},{"label":"Ago","value":725},{"label":"Set","value":598},{"label":"Out","value":777},{"label":"Nov","value":811},{"label":"Dez","value":709}];
const MX = 811;
