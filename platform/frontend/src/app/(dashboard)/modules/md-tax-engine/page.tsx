...
/* ═══ MD: Multi-Tax Engine — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "9357", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "352", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€95K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "346291457", cells: ["MD-8457", "MD: Multi-Tax Engine Item 1", "2/6/2026", "€41 557"], status: "active" as const },
    { id: "346295028", cells: ["MD-3028", "MD: Multi-Tax Engine Item 2", "17/1/2026", "€45 128"], status: "pending" as const },
    { id: "346298599", cells: ["MD-6599", "MD: Multi-Tax Engine Item 3", "4/8/2026", "€48 699"], status: "completed" as const },
    { id: "346302170", cells: ["MD-1170", "MD: Multi-Tax Engine Item 4", "19/3/2026", "€2270"], status: "warning" as const },
    { id: "346305741", cells: ["MD-4741", "MD: Multi-Tax Engine Item 5", "6/10/2026", "€5841"], status: "active" as const },
];
...
export default function MdMultitaxEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Tax Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Tax Engine</p>
                    </div>
                </div>
