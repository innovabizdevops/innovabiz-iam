...
const PAGE = "Progress";
const KPIS = [{"l":"Formulários Ativos","v":"245","t":"+17.5%","d":"up"},{"l":"Submissões/Dia","v":"4287","t":"+5.0%","d":"up"},{"l":"Documentos Gerados","v":"8.127","t":"+6.0%","d":"up"},{"l":"Templates","v":"7.264","t":"+1.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","923","2026-01-26","3.034","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.090","2026-01-08","3.867","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","955","2026-01-23","396","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.970","2026-02-20","4.480","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.646","2026-01-07","2.453","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":301},{"label":"Fev","value":594},{"label":"Mar","value":256},{"label":"Abr","value":428},{"label":"Mai","value":312},{"label":"Jun","value":297},{"label":"Jul","value":594},{"label":"Ago","value":551},{"label":"Set","value":519},{"label":"Out","value":622},{"label":"Nov","value":314},{"label":"Dez","value":447}];
const MX = 622;
