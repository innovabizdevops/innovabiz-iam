...
const PAGE = "Workout";
const KPIS = [{"l":"Formulários Ativos","v":"3.796","t":"+4.6%","d":"up"},{"l":"Submissões/Dia","v":"297","t":"+13.9%","d":"up"},{"l":"Documentos Gerados","v":"2.785","t":"+12.7%","d":"up"},{"l":"Templates","v":"4.217","t":"+15.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.544","2026-03-17","3.423","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.242","2026-03-23","7.380","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","920","2026-02-09","7.617","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","9.015","2026-01-22","2.601","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","313","2026-01-19","1.821","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":582},{"label":"Mar","value":819},{"label":"Abr","value":580},{"label":"Mai","value":690},{"label":"Jun","value":567},{"label":"Jul","value":634},{"label":"Ago","value":763},{"label":"Set","value":656},{"label":"Out","value":515},{"label":"Nov","value":836},{"label":"Dez","value":519}];
const MX = 836;
