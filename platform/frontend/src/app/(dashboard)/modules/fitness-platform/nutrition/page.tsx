...
const KPIS = [{"l":"Formulários Ativos","v":"121","t":"-3.1%","d":"down"},{"l":"Submissões/Dia","v":"1480","t":"+11.9%","d":"up"},{"l":"Documentos Gerados","v":"1.481","t":"-4.9%","d":"down"},{"l":"Templates","v":"2.895","t":"+11.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.751","2026-03-15","7.681","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.390","2026-02-12","1.595","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.428","2026-03-08","5.038","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","257","2026-01-25","7.702","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.166","2026-02-11","560","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":966},{"label":"Fev","value":1048},{"label":"Mar","value":870},{"label":"Abr","value":942},{"label":"Mai","value":698},{"label":"Jun","value":1025},{"label":"Jul","value":923},{"label":"Ago","value":885},{"label":"Set","value":1021},{"label":"Out","value":728},{"label":"Nov","value":794},{"label":"Dez","value":858}];
const MX = 1048;
