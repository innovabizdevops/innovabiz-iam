...
const ACCENT = "#b91c1c";
const MODULE = "Fitness Platform Deep";
const PAGE = "Track";
const KPIS = [{"l":"Formulários Ativos","v":"5.046","t":"+9.7%","d":"up"},{"l":"Submissões/Dia","v":"681","t":"+8.4%","d":"up"},{"l":"Documentos Gerados","v":"3.568","t":"-0.5%","d":"down"},{"l":"Templates","v":"6.975","t":"+6.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.351","2026-03-24","6.584","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.235","2026-01-24","2.406","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.545","2026-01-04","3.496","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.637","2026-03-21","6.544","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.813","2026-03-16","8.705","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":337},{"label":"Mar","value":221},{"label":"Abr","value":300},{"label":"Mai","value":547},{"label":"Jun","value":302},{"label":"Jul","value":554},{"label":"Ago","value":517},{"label":"Set","value":283},{"label":"Out","value":392},{"label":"Nov","value":245},{"label":"Dez","value":468}];
const MX = 601;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b91c1c'}}>IoT</span></h1>
                </div>
