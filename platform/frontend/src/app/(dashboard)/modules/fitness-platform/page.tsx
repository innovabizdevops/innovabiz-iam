...
/* ═══ Fitness Platform Deep — Dashboard ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total Registos", value: "1157", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2568", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€82K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1823977057", cells: ["FIT-2057", "Fitness Platform Deep Item 1", "22/2/2026", "€27 157"], status: "active" as const },
    { id: "1823980628", cells: ["FIT-5628", "Fitness Platform Deep Item 2", "9/9/2026", "€30 728"], status: "pending" as const },
    { id: "1823984199", cells: ["FIT-9199", "Fitness Platform Deep Item 3", "24/4/2026", "€34 299"], status: "completed" as const },
    { id: "1823987770", cells: ["FIT-3770", "Fitness Platform Deep Item 4", "11/11/2026", "€37 870"], status: "warning" as const },
    { id: "1823991341", cells: ["FIT-7341", "Fitness Platform Deep Item 5", "26/6/2026", "€41 441"], status: "active" as const },
];
...
export default function FitnessPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fitness Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fitness Platform Deep</p>
                    </div>
                </div>
