...
const PAGE = "Social";
const KPIS = [{"l":"Formulários Ativos","v":"1.552","t":"-0.6%","d":"down"},{"l":"Submissões/Dia","v":"1730","t":"-5.4%","d":"down"},{"l":"Documentos Gerados","v":"7.841","t":"-0.4%","d":"down"},{"l":"Templates","v":"5.976","t":"+0.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.095","2026-02-07","7.757","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.443","2026-01-15","2.697","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.429","2026-02-04","2.360","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.496","2026-01-03","1.571","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.454","2026-03-23","7.912","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":355},{"label":"Mar","value":564},{"label":"Abr","value":376},{"label":"Mai","value":415},{"label":"Jun","value":535},{"label":"Jul","value":365},{"label":"Ago","value":557},{"label":"Set","value":410},{"label":"Out","value":528},{"label":"Nov","value":311},{"label":"Dez","value":379}];
const MX = 663;
