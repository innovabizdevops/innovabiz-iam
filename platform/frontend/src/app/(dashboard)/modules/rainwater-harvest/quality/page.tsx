...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.082","t":"-0.5%","d":"down"},{"l":"NC Abertas","v":"3.284","t":"-2.9%","d":"down"},{"l":"Conformidade (%)","v":"69.1%","t":"+1.2%","d":"up"},{"l":"CAPAs Pendentes","v":"6.672","t":"+8.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.056","85.4%","6.678","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.672","95.2%","2.513","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.500","75.3%","1.610","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.454","73.8%","2.582","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.252","96.0%","8.246","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":597},{"label":"Mar","value":847},{"label":"Abr","value":695},{"label":"Mai","value":867},{"label":"Jun","value":650},{"label":"Jul","value":925},{"label":"Ago","value":623},{"label":"Set","value":661},{"label":"Out","value":953},{"label":"Nov","value":770},{"label":"Dez","value":868}];
const MX = 953;
