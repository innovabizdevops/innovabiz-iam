...
const PAGE = "Storage";
const KPIS = [{"l":"Total Rainwater Harvest","v":"3.031","t":"+12.0%","d":"up"},{"l":"Storage Ativos","v":"2.879","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"78.6%","t":"+8.9%","d":"up"},{"l":"Score Performance","v":"71","t":"+13.2%","d":"up"}];
const COLS = ["ID","Storage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rainwater Harvest #001","Rainwater Harvest #002","2.799","3.454","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Rainwater Harvest #002","Rainwater Harvest #003","4.616","5.898","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Rainwater Harvest #003","Rainwater Harvest #004","6.621","3.550","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Rainwater Harvest #004","Rainwater Harvest #005","3.554","3.251","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rainwater Harvest #005","Rainwater Harvest #001","9.071","3.548","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":797},{"label":"Fev","value":888},{"label":"Mar","value":721},{"label":"Abr","value":988},{"label":"Mai","value":798},{"label":"Jun","value":984},{"label":"Jul","value":653},{"label":"Ago","value":939},{"label":"Set","value":785},{"label":"Out","value":1013},{"label":"Nov","value":839},{"label":"Dez","value":716}];
const MX = 1013;
