...
export default function RainwaterHarvestPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Rainwater Harvest</h1><p className="text-sm text-muted-foreground">Rainwater Harvest • iBOS Enterprise</p></div>
            </div>
