...
const ACCENT = "#0891b2";
const MODULE = "Rainwater Harvesting";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Rainwater Harvest","v":"3.969","t":"-3.8%","d":"down"},{"l":"Monitor Ativos","v":"2.530","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"69.6%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"65","t":"+3.8%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rainwater Harvest #001","Rainwater Harvest #002","5.098","8.244","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Rainwater Harvest #002","Rainwater Harvest #003","6.529","8.331","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Rainwater Harvest #003","Rainwater Harvest #004","7.391","7.450","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Rainwater Harvest #004","Rainwater Harvest #005","4.430","6.253","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rainwater Harvest #005","Rainwater Harvest #001","2.626","401","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":574},{"label":"Mar","value":697},{"label":"Abr","value":785},{"label":"Mai","value":685},{"label":"Jun","value":624},{"label":"Jul","value":751},{"label":"Ago","value":404},{"label":"Set","value":750},{"label":"Out","value":621},{"label":"Nov","value":504},{"label":"Dez","value":696}];
const MX = 785;
