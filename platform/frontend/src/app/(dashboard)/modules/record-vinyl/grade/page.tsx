...
const PAGE = "Grade";
const KPIS = [{"l":"Total Record Vinyl","v":"6.075","t":"-5.0%","d":"down"},{"l":"Grade Ativos","v":"3.056","t":"+13.4%","d":"up"},{"l":"Eficiência (%)","v":"90.3%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"58","t":"+9.4%","d":"up"}];
const COLS = ["ID","Grade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Record Vinyl #001","Record Vinyl #002","7.812","8.924","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Record Vinyl #002","Record Vinyl #003","5.940","6.254","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Record Vinyl #003","Record Vinyl #004","5.171","3.630","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Record Vinyl #004","Record Vinyl #005","807","2.510","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Record Vinyl #005","Record Vinyl #001","3.456","748","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":792},{"label":"Mar","value":549},{"label":"Abr","value":728},{"label":"Mai","value":532},{"label":"Jun","value":724},{"label":"Jul","value":509},{"label":"Ago","value":763},{"label":"Set","value":768},{"label":"Out","value":555},{"label":"Nov","value":655},{"label":"Dez","value":434}];
const MX = 792;
