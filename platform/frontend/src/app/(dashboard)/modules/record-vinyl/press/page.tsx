...
const PAGE = "Press";
const KPIS = [{"l":"Total Record Vinyl","v":"1.091","t":"+12.9%","d":"up"},{"l":"Press Ativos","v":"2.293","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"93.5%","t":"+8.9%","d":"up"},{"l":"Score Performance","v":"63","t":"-2.0%","d":"down"}];
const COLS = ["ID","Press","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Record Vinyl #001","Record Vinyl #002","1.639","3.076","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Record Vinyl #002","Record Vinyl #003","976","900","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Record Vinyl #003","Record Vinyl #004","7.186","8.715","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Record Vinyl #004","Record Vinyl #005","4.226","4.790","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Record Vinyl #005","Record Vinyl #001","5.308","436","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":309},{"label":"Fev","value":561},{"label":"Mar","value":438},{"label":"Abr","value":676},{"label":"Mai","value":476},{"label":"Jun","value":366},{"label":"Jul","value":549},{"label":"Ago","value":320},{"label":"Set","value":470},{"label":"Out","value":440},{"label":"Nov","value":514},{"label":"Dez","value":643}];
const MX = 676;
