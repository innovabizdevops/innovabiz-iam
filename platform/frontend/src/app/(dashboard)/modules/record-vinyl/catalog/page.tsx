...
const ACCENT = "#ca8a04";
const MODULE = "Record & Vinyl";
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"5.049","t":"-2.5%","d":"down"},{"l":"Queries/Dia","v":"162","t":"+15.3%","d":"up"},{"l":"Dados Processados (GB)","v":"3.224","t":"-3.8%","d":"down"},{"l":"Utilizadores Analytics","v":"3.390","t":"+13.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1143","2026-03-07","6.490","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4838","2026-03-19","8.765","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3211","2026-03-14","3.402","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1941","2026-01-01","8.929","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4844","2026-01-15","431","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":1019},{"label":"Mar","value":847},{"label":"Abr","value":1000},{"label":"Mai","value":976},{"label":"Jun","value":910},{"label":"Jul","value":1025},{"label":"Ago","value":744},{"label":"Set","value":733},{"label":"Out","value":1004},{"label":"Nov","value":900},{"label":"Dez","value":887}];
const MX = 1025;
