...
/* ═══ Record & Vinyl — Dashboard ═══ */

const ACCENT = "#ca8a04";

const KPIS = [
    { label: "Total Registos", value: "9341", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2193", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€177K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2064753241", cells: ["REC-1241", "Record & Vinyl Item 1", "6/2/2026", "€3341"], status: "active" as const },
    { id: "2064756812", cells: ["REC-4812", "Record & Vinyl Item 2", "21/9/2026", "€6912"], status: "pending" as const },
    { id: "2064760383", cells: ["REC-8383", "Record & Vinyl Item 3", "8/4/2026", "€10 483"], status: "completed" as const },
    { id: "2064763954", cells: ["REC-2954", "Record & Vinyl Item 4", "23/11/2026", "€14 054"], status: "warning" as const },
    { id: "2064767525", cells: ["REC-6525", "Record & Vinyl Item 5", "10/6/2026", "€17 625"], status: "active" as const },
];
...
export default function RecordVinylPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Record & Vinyl</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Record & Vinyl</p>
                    </div>
                </div>
