...
const PAGE = "Trade";
const KPIS = [{"l":"Total Record Vinyl","v":"7.608","t":"+2.3%","d":"up"},{"l":"Trade Ativos","v":"6.737","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"94","t":"-2.2%","d":"down"}];
const COLS = ["ID","Trade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Record Vinyl #001","Record Vinyl #002","6.556","3.154","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Record Vinyl #002","Record Vinyl #003","6.027","2.637","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Record Vinyl #003","Record Vinyl #004","688","4.309","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Record Vinyl #004","Record Vinyl #005","6.444","3.619","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Record Vinyl #005","Record Vinyl #001","3.852","4.313","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":324},{"label":"Fev","value":319},{"label":"Mar","value":436},{"label":"Abr","value":578},{"label":"Mai","value":605},{"label":"Jun","value":564},{"label":"Jul","value":237},{"label":"Ago","value":288},{"label":"Set","value":434},{"label":"Out","value":485},{"label":"Nov","value":467},{"label":"Dez","value":474}];
const MX = 605;
