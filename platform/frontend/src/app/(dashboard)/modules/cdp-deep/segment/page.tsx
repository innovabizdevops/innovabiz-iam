...
const ACCENT = "#be185d";
const MODULE = "CDP Platform Deep";
const PAGE = "Segment";
const KPIS = [{"l":"Perfis Unificados","v":"238","t":"+7.7%","d":"up"},{"l":"Segmentos Ativos","v":"7.507","t":"+0.3%","d":"up"},{"l":"NPS Score","v":"88","t":"+11.2%","d":"up"},{"l":"Churn Previsto (%)","v":"69.1%","t":"+8.1%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","2.696","€ 21472.02","71.9%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","1.693","€ 360.63","86.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","1.843","€ 38459.25","88.6%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","8.738","€ 18503.68","78.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","4.025","€ 19155.87","85.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":937},{"label":"Mar","value":562},{"label":"Abr","value":742},{"label":"Mai","value":818},{"label":"Jun","value":795},{"label":"Jul","value":564},{"label":"Ago","value":581},{"label":"Set","value":821},{"label":"Out","value":848},{"label":"Nov","value":686},{"label":"Dez","value":884}];
const MX = 937;
