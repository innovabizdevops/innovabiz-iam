...
/* ═══ CDP Platform Deep — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "3819", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3144", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€155K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1383687119", cells: ["CDP-1119", "CDP Platform Deep Item 1", "4/12/2026", "€37 219"], status: "active" as const },
    { id: "1383690690", cells: ["CDP-4690", "CDP Platform Deep Item 2", "19/7/2026", "€40 790"], status: "pending" as const },
    { id: "1383694261", cells: ["CDP-8261", "CDP Platform Deep Item 3", "6/2/2026", "€44 361"], status: "completed" as const },
    { id: "1383697832", cells: ["CDP-2832", "CDP Platform Deep Item 4", "21/9/2026", "€47 932"], status: "warning" as const },
    { id: "1383701403", cells: ["CDP-6403", "CDP Platform Deep Item 5", "8/4/2026", "€1503"], status: "active" as const },
];
...
export default function CdpPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CDP Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CDP Platform Deep</p>
                    </div>
                </div>
