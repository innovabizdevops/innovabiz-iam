...
const PAGE = "Pricing";
const KPIS = [{"l":"ARR (€M)","v":"€27.6M","t":"+9.7%","d":"up"},{"l":"MRR (€)","v":"€59399","t":"-5.6%","d":"down"},{"l":"Churn (%)","v":"92.4%","t":"+8.4%","d":"up"},{"l":"ARPU (€)","v":"€91829","t":"+16.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 43333.44","5.589","€ 469.17","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 28397.68","8.692","€ 28598.09","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 20983.05","1.174","€ 4850.77","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 42075.63","3.155","€ 12781.02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 10124.19","4.624","€ 6830.23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":844},{"label":"Fev","value":913},{"label":"Mar","value":785},{"label":"Abr","value":972},{"label":"Mai","value":855},{"label":"Jun","value":847},{"label":"Jul","value":882},{"label":"Ago","value":880},{"label":"Set","value":1027},{"label":"Out","value":846},{"label":"Nov","value":1066},{"label":"Dez","value":1053}];
const MX = 1066;
