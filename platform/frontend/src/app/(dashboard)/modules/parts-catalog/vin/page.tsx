...
const PAGE = "VIN Lookup";
const KPIS = [{"l":"Dashboards Ativos","v":"7.638","t":"-3.3%","d":"down"},{"l":"Queries/Dia","v":"153","t":"-3.7%","d":"down"},{"l":"Dados Processados (GB)","v":"4.453","t":"+16.6%","d":"up"},{"l":"Utilizadores Analytics","v":"5.376","t":"+5.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3859","2026-03-27","2.506","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4605","2026-01-27","6.211","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3404","2026-03-22","3.071","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1897","2026-01-23","6.870","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2484","2026-02-11","8.397","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":630},{"label":"Mar","value":559},{"label":"Abr","value":489},{"label":"Mai","value":772},{"label":"Jun","value":660},{"label":"Jul","value":603},{"label":"Ago","value":619},{"label":"Set","value":761},{"label":"Out","value":521},{"label":"Nov","value":637},{"label":"Dez","value":670}];
const MX = 772;
