...
const PAGE = "Parts Search";
const KPIS = [{"l":"Dashboards Ativos","v":"635","t":"+14.5%","d":"up"},{"l":"Queries/Dia","v":"1703","t":"-3.5%","d":"down"},{"l":"Dados Processados (GB)","v":"8.944","t":"+17.8%","d":"up"},{"l":"Utilizadores Analytics","v":"3.333","t":"+4.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","437","2026-02-04","5.637","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1692","2026-01-26","482","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4343","2026-02-05","1.421","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4449","2026-03-12","2.513","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2955","2026-02-20","2.001","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":450},{"label":"Fev","value":453},{"label":"Mar","value":557},{"label":"Abr","value":583},{"label":"Mai","value":559},{"label":"Jun","value":802},{"label":"Jul","value":665},{"label":"Ago","value":497},{"label":"Set","value":502},{"label":"Out","value":528},{"label":"Nov","value":563},{"label":"Dez","value":642}];
const MX = 802;
