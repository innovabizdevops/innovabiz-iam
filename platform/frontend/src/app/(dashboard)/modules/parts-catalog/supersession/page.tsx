...
const ACCENT = "#78350f";
const MODULE = "Parts Catalog";
const PAGE = "Supersession";
const KPIS = [{"l":"Dashboards Ativos","v":"685","t":"+12.4%","d":"up"},{"l":"Queries/Dia","v":"4045","t":"+14.7%","d":"up"},{"l":"Dados Processados (GB)","v":"8.607","t":"+5.9%","d":"up"},{"l":"Utilizadores Analytics","v":"247","t":"+13.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2155","2026-01-05","4.808","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4154","2026-01-27","1.594","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2109","2026-02-18","7.815","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4075","2026-02-12","5.316","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3829","2026-01-01","2.608","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":606},{"label":"Mar","value":652},{"label":"Abr","value":733},{"label":"Mai","value":564},{"label":"Jun","value":571},{"label":"Jul","value":661},{"label":"Ago","value":901},{"label":"Set","value":931},{"label":"Out","value":872},{"label":"Nov","value":662},{"label":"Dez","value":584}];
const MX = 931;
