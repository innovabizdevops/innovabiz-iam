...
const PAGE = "Cross-Ref";
const KPIS = [{"l":"Dashboards Ativos","v":"655","t":"-5.2%","d":"down"},{"l":"Queries/Dia","v":"4711","t":"+17.5%","d":"up"},{"l":"Dados Processados (GB)","v":"418","t":"-4.5%","d":"down"},{"l":"Utilizadores Analytics","v":"2.346","t":"+8.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2349","2026-01-18","3.793","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3188","2026-03-01","171","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","134","2026-01-16","3.751","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1541","2026-01-15","6.059","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4313","2026-01-24","1.219","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":835},{"label":"Fev","value":755},{"label":"Mar","value":594},{"label":"Abr","value":541},{"label":"Mai","value":844},{"label":"Jun","value":862},{"label":"Jul","value":629},{"label":"Ago","value":679},{"label":"Set","value":561},{"label":"Out","value":737},{"label":"Nov","value":508},{"label":"Dez","value":629}];
const MX = 862;
