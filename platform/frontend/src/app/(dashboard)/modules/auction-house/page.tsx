...
/* ═══ Auction House Mgmt — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "8317", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1385", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€298K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "-25%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "558318717", cells: ["AUC-4717", "Auction House Mgmt Item 1", "6/10/2026", "€18 817"], status: "active" as const },
    { id: "558322288", cells: ["AUC-8288", "Auction House Mgmt Item 2", "21/5/2026", "€22 388"], status: "pending" as const },
    { id: "558325859", cells: ["AUC-2859", "Auction House Mgmt Item 3", "8/12/2026", "€25 959"], status: "completed" as const },
    { id: "558329430", cells: ["AUC-6430", "Auction House Mgmt Item 4", "23/7/2026", "€29 530"], status: "warning" as const },
    { id: "558333001", cells: ["AUC-1001", "Auction House Mgmt Item 5", "10/2/2026", "€33 101"], status: "active" as const },
];
...
export default function AuctionHouseMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Auction House Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Auction House Mgmt</p>
                    </div>
                </div>
