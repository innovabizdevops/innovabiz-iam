...
const PAGE = "Report";
const KPIS = [{"l":"Total Auction House","v":"1.741","t":"+5.1%","d":"up"},{"l":"Report Ativos","v":"2.349","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"73.4%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"74","t":"+17.6%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Auction House #001","Auction House #002","3.872","5.090","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Auction House #002","Auction House #003","4.031","2.443","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Auction House #003","Auction House #004","1.287","5.690","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Auction House #004","Auction House #005","6.079","6.844","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Auction House #005","Auction House #001","3.297","8.513","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":731},{"label":"Mar","value":715},{"label":"Abr","value":725},{"label":"Mai","value":599},{"label":"Jun","value":706},{"label":"Jul","value":590},{"label":"Ago","value":697},{"label":"Set","value":856},{"label":"Out","value":558},{"label":"Nov","value":578},{"label":"Dez","value":854}];
const MX = 856;
