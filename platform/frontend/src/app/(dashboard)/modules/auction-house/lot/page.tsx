...
const ACCENT = "#92400e";
const MODULE = "Auction House Mgmt";
const PAGE = "Lot";
const KPIS = [{"l":"Total Auction House","v":"5.269","t":"+1.8%","d":"up"},{"l":"Lot Ativos","v":"2.204","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"85.5%","t":"-5.2%","d":"down"},{"l":"Score Performance","v":"66","t":"+17.1%","d":"up"}];
const COLS = ["ID","Lot","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Auction House #001","Auction House #002","7.002","6.831","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Auction House #002","Auction House #003","6.746","4.396","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Auction House #003","Auction House #004","7.722","6.373","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Auction House #004","Auction House #005","5.334","8.476","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Auction House #005","Auction House #001","1.886","5.882","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":770},{"label":"Mar","value":780},{"label":"Abr","value":804},{"label":"Mai","value":713},{"label":"Jun","value":472},{"label":"Jul","value":648},{"label":"Ago","value":606},{"label":"Set","value":555},{"label":"Out","value":637},{"label":"Nov","value":556},{"label":"Dez","value":541}];
const MX = 828;
