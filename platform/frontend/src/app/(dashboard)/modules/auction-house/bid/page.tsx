...
const PAGE = "Bid";
const KPIS = [{"l":"Fornecedores Ativos","v":"4.264","t":"-2.5%","d":"down"},{"l":"Contratos (€M)","v":"€49.8M","t":"+10.1%","d":"up"},{"l":"On-Time Delivery (%)","v":"90.4%","t":"+17.7%","d":"up"},{"l":"Score Médio","v":"70","t":"+5.9%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","99.5%","€ 39371.06","6.436","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","85.0%","€ 43820.07","1.736","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","80.1%","€ 42536.77","7.322","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","70.6%","€ 3465.54","8.935","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","96.9%","€ 21123.57","3.198","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":471},{"label":"Fev","value":515},{"label":"Mar","value":775},{"label":"Abr","value":737},{"label":"Mai","value":430},{"label":"Jun","value":723},{"label":"Jul","value":498},{"label":"Ago","value":786},{"label":"Set","value":503},{"label":"Out","value":559},{"label":"Nov","value":526},{"label":"Dez","value":628}];
const MX = 786;
