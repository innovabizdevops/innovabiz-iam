...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"8.319","t":"+4.5%","d":"up"},{"l":"Queries/Dia","v":"1682","t":"+3.2%","d":"up"},{"l":"Dados Processados (GB)","v":"4.749","t":"+13.6%","d":"up"},{"l":"Utilizadores Analytics","v":"8.472","t":"+8.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","768","2026-03-09","5.982","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2315","2026-03-16","6.949","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","520","2026-02-09","3.435","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4695","2026-02-21","4.678","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2858","2026-02-04","2.454","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":415},{"label":"Mar","value":452},{"label":"Abr","value":778},{"label":"Mai","value":743},{"label":"Jun","value":433},{"label":"Jul","value":770},{"label":"Ago","value":422},{"label":"Set","value":662},{"label":"Out","value":629},{"label":"Nov","value":483},{"label":"Dez","value":532}];
const MX = 778;
