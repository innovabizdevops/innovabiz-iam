...
/* ═══ Group Benefits Platform — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "9623", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4319", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€281K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "793484623", cells: ["GRO-9623", "Group Benefits Platform Item 1", "16/8/2026", "€34 723"], status: "active" as const },
    { id: "793488194", cells: ["GRO-4194", "Group Benefits Platform Item 2", "3/3/2026", "€38 294"], status: "pending" as const },
    { id: "793491765", cells: ["GRO-7765", "Group Benefits Platform Item 3", "18/10/2026", "€41 865"], status: "completed" as const },
    { id: "793495336", cells: ["GRO-2336", "Group Benefits Platform Item 4", "5/5/2026", "€45 436"], status: "warning" as const },
    { id: "793498907", cells: ["GRO-5907", "Group Benefits Platform Item 5", "20/12/2026", "€49 007"], status: "active" as const },
];
...
export default function GroupBenefitsPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Group Benefits Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Group Benefits Platform</p>
                    </div>
                </div>
