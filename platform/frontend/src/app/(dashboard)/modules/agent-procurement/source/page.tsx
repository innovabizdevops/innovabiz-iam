...
const PAGE = "Source";
const KPIS = [{"l":"Fornecedores Ativos","v":"4.239","t":"+0.4%","d":"up"},{"l":"Contratos (€M)","v":"€19.9M","t":"+2.7%","d":"up"},{"l":"On-Time Delivery (%)","v":"72.4%","t":"+7.2%","d":"up"},{"l":"Score Médio","v":"71","t":"-2.6%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","73.2%","€ 36219.95","3.611","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","78.1%","€ 22888.74","2.633","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","82.8%","€ 11773.77","1.936","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","89.7%","€ 36116.29","9.055","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","94.1%","€ 23195.35","2.982","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":674},{"label":"Mar","value":518},{"label":"Abr","value":710},{"label":"Mai","value":461},{"label":"Jun","value":731},{"label":"Jul","value":651},{"label":"Ago","value":454},{"label":"Set","value":400},{"label":"Out","value":780},{"label":"Nov","value":634},{"label":"Dez","value":613}];
const MX = 780;
