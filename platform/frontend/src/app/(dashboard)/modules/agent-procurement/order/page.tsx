...
const PAGE = "Order";
const KPIS = [{"l":"Fornecedores Ativos","v":"5.467","t":"+0.9%","d":"up"},{"l":"Contratos (€M)","v":"€37.2M","t":"+12.5%","d":"up"},{"l":"On-Time Delivery (%)","v":"90.3%","t":"+14.6%","d":"up"},{"l":"Score Médio","v":"59","t":"+7.1%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","98.5%","€ 44529.87","8.278","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","95.9%","€ 27704.17","830","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","71.8%","€ 29572.30","7.707","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","82.2%","€ 19160.06","5.886","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","77.1%","€ 9159.21","6.594","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":572},{"label":"Mar","value":663},{"label":"Abr","value":579},{"label":"Mai","value":814},{"label":"Jun","value":596},{"label":"Jul","value":604},{"label":"Ago","value":683},{"label":"Set","value":666},{"label":"Out","value":798},{"label":"Nov","value":880},{"label":"Dez","value":844}];
const MX = 880;
