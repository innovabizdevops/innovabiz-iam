...
const ACCENT = "#7c3aed";
const MODULE = "AI Procurement Agent";
const PAGE = "Negotiate";
const KPIS = [{"l":"Fornecedores Ativos","v":"7.903","t":"+9.7%","d":"up"},{"l":"Contratos (€M)","v":"€34.5M","t":"+1.4%","d":"up"},{"l":"On-Time Delivery (%)","v":"93.6%","t":"-1.5%","d":"down"},{"l":"Score Médio","v":"73","t":"+1.7%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","73.3%","€ 45020.81","5.830","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","75.2%","€ 9378.60","4.210","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","92.2%","€ 5121.00","5.704","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","90.5%","€ 17015.98","855","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","74.1%","€ 40892.04","3.083","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":455},{"label":"Mar","value":369},{"label":"Abr","value":404},{"label":"Mai","value":518},{"label":"Jun","value":709},{"label":"Jul","value":756},{"label":"Ago","value":683},{"label":"Set","value":704},{"label":"Out","value":661},{"label":"Nov","value":559},{"label":"Dez","value":562}];
const MX = 756;
