...
/* ═══ AI Procurement Agent — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "1781", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3356", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€94K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "45541681", cells: ["AGE-2681", "AI Procurement Agent Item 1", "18/2/2026", "€41 781"], status: "active" as const },
    { id: "45545252", cells: ["AGE-6252", "AI Procurement Agent Item 2", "5/9/2026", "€45 352"], status: "pending" as const },
    { id: "45548823", cells: ["AGE-9823", "AI Procurement Agent Item 3", "20/4/2026", "€48 923"], status: "completed" as const },
    { id: "45552394", cells: ["AGE-4394", "AI Procurement Agent Item 4", "7/11/2026", "€2494"], status: "warning" as const },
    { id: "45555965", cells: ["AGE-7965", "AI Procurement Agent Item 5", "22/6/2026", "€6065"], status: "active" as const },
];
...
export default function AiProcurementAgentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Procurement Agent</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Procurement Agent</p>
                    </div>
                </div>
