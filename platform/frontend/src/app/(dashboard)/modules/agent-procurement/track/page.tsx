...
const PAGE = "Track";
const KPIS = [{"l":"Fornecedores Ativos","v":"7.752","t":"+14.2%","d":"up"},{"l":"Contratos (€M)","v":"€4.7M","t":"+1.8%","d":"up"},{"l":"On-Time Delivery (%)","v":"75.2%","t":"+5.4%","d":"up"},{"l":"Score Médio","v":"59","t":"-5.9%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","88.2%","€ 9945.30","4.286","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","96.1%","€ 20505.46","8.919","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","80.7%","€ 27874.28","2.859","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","75.6%","€ 15398.69","9.100","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","76.7%","€ 47331.38","3.912","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":458},{"label":"Mar","value":641},{"label":"Abr","value":493},{"label":"Mai","value":604},{"label":"Jun","value":515},{"label":"Jul","value":629},{"label":"Ago","value":581},{"label":"Set","value":350},{"label":"Out","value":705},{"label":"Nov","value":700},{"label":"Dez","value":581}];
const MX = 722;
