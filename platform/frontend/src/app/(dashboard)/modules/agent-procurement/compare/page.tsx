...
const PAGE = "Compare";
const KPIS = [{"l":"Fornecedores Ativos","v":"1.755","t":"+2.1%","d":"up"},{"l":"Contratos (€M)","v":"€24.9M","t":"-3.5%","d":"down"},{"l":"On-Time Delivery (%)","v":"90.3%","t":"+13.5%","d":"up"},{"l":"Score Médio","v":"75","t":"+15.1%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","80.8%","€ 37399.87","6.130","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","91.6%","€ 2035.53","6.548","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","79.9%","€ 3992.23","6.948","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","84.7%","€ 11334.45","4.061","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","78.6%","€ 16158.04","9.029","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1000},{"label":"Fev","value":726},{"label":"Mar","value":639},{"label":"Abr","value":698},{"label":"Mai","value":786},{"label":"Jun","value":976},{"label":"Jul","value":825},{"label":"Ago","value":789},{"label":"Set","value":834},{"label":"Out","value":859},{"label":"Nov","value":764},{"label":"Dez","value":678}];
const MX = 1000;
