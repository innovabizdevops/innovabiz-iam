...
const PAGE = "Profile";
const KPIS = [{"l":"Perfis Unificados","v":"7.189","t":"-1.3%","d":"down"},{"l":"Segmentos Ativos","v":"1.709","t":"+5.1%","d":"up"},{"l":"NPS Score","v":"62","t":"+2.6%","d":"up"},{"l":"Churn Previsto (%)","v":"94.2%","t":"+17.8%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","773","€ 44582.09","93.8%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","3.242","€ 33702.34","74.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","7.865","€ 40626.50","99.8%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","3.635","€ 29100.07","90.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","6.250","€ 9172.79","99.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":820},{"label":"Mar","value":920},{"label":"Abr","value":838},{"label":"Mai","value":862},{"label":"Jun","value":794},{"label":"Jul","value":814},{"label":"Ago","value":896},{"label":"Set","value":653},{"label":"Out","value":981},{"label":"Nov","value":775},{"label":"Dez","value":915}];
const MX = 981;
