...
const PAGE = "Error";
const KPIS = [{"l":"Total Apm Deep","v":"8.603","t":"+12.8%","d":"up"},{"l":"Error Ativos","v":"1.652","t":"+4.4%","d":"up"},{"l":"Eficiência (%)","v":"72.3%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"88","t":"+17.5%","d":"up"}];
const COLS = ["ID","Error","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Apm Deep #001","Apm Deep #002","8.719","3.778","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Apm Deep #002","Apm Deep #003","1.628","5.919","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Apm Deep #003","Apm Deep #004","8.016","9.016","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Apm Deep #004","Apm Deep #005","5.964","8.336","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Apm Deep #005","Apm Deep #001","2.074","8.591","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":667},{"label":"Mar","value":393},{"label":"Abr","value":561},{"label":"Mai","value":411},{"label":"Jun","value":573},{"label":"Jul","value":418},{"label":"Ago","value":509},{"label":"Set","value":496},{"label":"Out","value":654},{"label":"Nov","value":611},{"label":"Dez","value":366}];
const MX = 688;
