...
/* ═══ APM Platform Deep — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "7798", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4918", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€318K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1201907298", cells: ["APM-3298", "APM Platform Deep Item 1", "19/7/2026", "€7398"], status: "active" as const },
    { id: "1201910869", cells: ["APM-6869", "APM Platform Deep Item 2", "6/2/2026", "€10 969"], status: "pending" as const },
    { id: "1201914440", cells: ["APM-1440", "APM Platform Deep Item 3", "21/9/2026", "€14 540"], status: "completed" as const },
    { id: "1201918011", cells: ["APM-5011", "APM Platform Deep Item 4", "8/4/2026", "€18 111"], status: "warning" as const },
    { id: "1201921582", cells: ["APM-8582", "APM Platform Deep Item 5", "23/11/2026", "€21 682"], status: "active" as const },
];
...
export default function ApmPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">APM Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • APM Platform Deep</p>
                    </div>
                </div>
