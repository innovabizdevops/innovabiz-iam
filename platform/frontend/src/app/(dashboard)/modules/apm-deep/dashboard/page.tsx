...
const ACCENT = "#1e40af";
const MODULE = "APM Platform Deep";
const PAGE = "Dashboard";
const KPIS = [{"l":"Teams Ativos","v":"6.710","t":"-4.8%","d":"down"},{"l":"Reuniões/Semana","v":"520","t":"-2.8%","d":"down"},{"l":"Mensagens/Dia","v":"3673","t":"+12.6%","d":"up"},{"l":"Ficheiros Partilhados","v":"6.671","t":"+10.0%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.501","2197","265","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.768","3023","2.725","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","5.781","4748","9.095","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","6.795","2962","2.651","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.945","269","1.875","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":789},{"label":"Mar","value":754},{"label":"Abr","value":696},{"label":"Mai","value":746},{"label":"Jun","value":774},{"label":"Jul","value":1002},{"label":"Ago","value":792},{"label":"Set","value":695},{"label":"Out","value":792},{"label":"Nov","value":667},{"label":"Dez","value":668}];
const MX = 1002;
