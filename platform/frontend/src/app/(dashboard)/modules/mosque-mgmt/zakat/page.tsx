...
const PAGE = "Zakat";
const KPIS = [{"l":"Total Mosque Mgmt","v":"4.141","t":"+14.7%","d":"up"},{"l":"Zakat Ativos","v":"5.111","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"77.3%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"65","t":"+1.2%","d":"up"}];
const COLS = ["ID","Zakat","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mosque Mgmt #001","Mosque Mgmt #002","2.861","5.141","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Mosque Mgmt #002","Mosque Mgmt #003","8.948","942","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Mosque Mgmt #003","Mosque Mgmt #004","1.491","2.464","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Mosque Mgmt #004","Mosque Mgmt #005","1.125","2.529","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mosque Mgmt #005","Mosque Mgmt #001","4.078","1.562","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":232},{"label":"Fev","value":226},{"label":"Mar","value":395},{"label":"Abr","value":499},{"label":"Mai","value":332},{"label":"Jun","value":259},{"label":"Jul","value":624},{"label":"Ago","value":506},{"label":"Set","value":450},{"label":"Out","value":336},{"label":"Nov","value":326},{"label":"Dez","value":524}];
const MX = 624;
