...
const PAGE = "Prayer";
const KPIS = [{"l":"Total Mosque Mgmt","v":"4.218","t":"+16.7%","d":"up"},{"l":"Prayer Ativos","v":"7.186","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"74.9%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"93","t":"+12.1%","d":"up"}];
const COLS = ["ID","Prayer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mosque Mgmt #001","Mosque Mgmt #002","5.662","3.836","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Mosque Mgmt #002","Mosque Mgmt #003","6.718","3.804","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Mosque Mgmt #003","Mosque Mgmt #004","3.951","2.303","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Mosque Mgmt #004","Mosque Mgmt #005","5.980","6.770","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mosque Mgmt #005","Mosque Mgmt #001","2.061","3.412","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":251},{"label":"Mar","value":579},{"label":"Abr","value":445},{"label":"Mai","value":325},{"label":"Jun","value":367},{"label":"Jul","value":417},{"label":"Ago","value":455},{"label":"Set","value":302},{"label":"Out","value":456},{"label":"Nov","value":490},{"label":"Dez","value":557}];
const MX = 579;
