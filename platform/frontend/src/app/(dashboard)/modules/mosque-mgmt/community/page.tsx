...
const ACCENT = "#6d28d9";
const MODULE = "Mosque Management";
const PAGE = "Community";
const KPIS = [{"l":"Projetos Sociais","v":"2.848","t":"+3.1%","d":"up"},{"l":"Beneficiários","v":"623","t":"+15.0%","d":"up"},{"l":"Investimento CSR (€)","v":"€9782","t":"-0.8%","d":"down"},{"l":"Score Impacto","v":"59","t":"+4.4%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","818","€ 10278.07","2.365","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","4.098","€ 19227.42","1.176","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","4.456","€ 11662.09","7.019","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","1.019","€ 47197.15","2.731","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","1.127","€ 17055.83","4.073","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":474},{"label":"Mar","value":431},{"label":"Abr","value":672},{"label":"Mai","value":762},{"label":"Jun","value":794},{"label":"Jul","value":464},{"label":"Ago","value":475},{"label":"Set","value":516},{"label":"Out","value":444},{"label":"Nov","value":511},{"label":"Dez","value":654}];
const MX = 794;
