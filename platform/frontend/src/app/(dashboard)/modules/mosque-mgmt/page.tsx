...
const KPIS = [
    { label: "Total Registos", value: "5519", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2704", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€26K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1504924219", cells: ["MOS-8219", "Mosque Management Item 1", "16/8/2026", "€24 319"], status: "active" as const },
    { id: "1504927790", cells: ["MOS-2790", "Mosque Management Item 2", "3/3/2026", "€27 890"], status: "pending" as const },
    { id: "1504931361", cells: ["MOS-6361", "Mosque Management Item 3", "18/10/2026", "€31 461"], status: "completed" as const },
    { id: "1504934932", cells: ["MOS-9932", "Mosque Management Item 4", "5/5/2026", "€35 032"], status: "warning" as const },
    { id: "1504938503", cells: ["MOS-4503", "Mosque Management Item 5", "20/12/2026", "€38 603"], status: "active" as const },
];
...
export default function MosqueManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mosque Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Mosque Management</p>
                    </div>
                </div>
