...
const PAGE = "Inject";
const KPIS = [{"l":"Total Secret Mgmt Deep","v":"846","t":"-2.7%","d":"down"},{"l":"Inject Ativos","v":"2.570","t":"+13.5%","d":"up"},{"l":"Eficiência (%)","v":"68.8%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"87","t":"+11.1%","d":"up"}];
const COLS = ["ID","Inject","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Secret Mgmt Deep #001","Secret Mgmt Deep #002","7.396","7.339","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Secret Mgmt Deep #002","Secret Mgmt Deep #003","3.672","7.285","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Secret Mgmt Deep #003","Secret Mgmt Deep #004","6.253","3.343","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Secret Mgmt Deep #004","Secret Mgmt Deep #005","7.245","701","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Secret Mgmt Deep #005","Secret Mgmt Deep #001","3.232","977","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":873},{"label":"Mar","value":899},{"label":"Abr","value":664},{"label":"Mai","value":631},{"label":"Jun","value":570},{"label":"Jul","value":856},{"label":"Ago","value":930},{"label":"Set","value":669},{"label":"Out","value":576},{"label":"Nov","value":928},{"label":"Dez","value":933}];
const MX = 933;
