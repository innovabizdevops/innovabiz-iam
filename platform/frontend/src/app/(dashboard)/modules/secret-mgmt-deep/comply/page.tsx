...
const ACCENT = "#1e40af";
const MODULE = "Secret Management Deep";
const PAGE = "Comply";
const KPIS = [{"l":"Total Secret Mgmt Deep","v":"1.865","t":"+13.2%","d":"up"},{"l":"Comply Ativos","v":"4.687","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"94","t":"+16.7%","d":"up"}];
const COLS = ["ID","Comply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Secret Mgmt Deep #001","Secret Mgmt Deep #002","9.037","960","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Secret Mgmt Deep #002","Secret Mgmt Deep #003","2.395","1.214","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Secret Mgmt Deep #003","Secret Mgmt Deep #004","7.419","2.661","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Secret Mgmt Deep #004","Secret Mgmt Deep #005","5.399","6.387","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Secret Mgmt Deep #005","Secret Mgmt Deep #001","3.127","537","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":937},{"label":"Fev","value":641},{"label":"Mar","value":753},{"label":"Abr","value":593},{"label":"Mai","value":975},{"label":"Jun","value":738},{"label":"Jul","value":625},{"label":"Ago","value":704},{"label":"Set","value":892},{"label":"Out","value":721},{"label":"Nov","value":685},{"label":"Dez","value":980}];
const MX = 980;
