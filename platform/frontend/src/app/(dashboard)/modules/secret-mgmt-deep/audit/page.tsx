...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.837","t":"+8.1%","d":"up"},{"l":"NC Abertas","v":"5.030","t":"-3.5%","d":"down"},{"l":"Conformidade (%)","v":"71.3%","t":"+8.9%","d":"up"},{"l":"CAPAs Pendentes","v":"3.866","t":"+10.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.330","75.4%","9.099","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.122","94.3%","769","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.305","75.7%","3.164","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.158","89.9%","6.596","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.773","97.6%","6.809","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":595},{"label":"Mar","value":462},{"label":"Abr","value":689},{"label":"Mai","value":441},{"label":"Jun","value":744},{"label":"Jul","value":639},{"label":"Ago","value":637},{"label":"Set","value":719},{"label":"Out","value":748},{"label":"Nov","value":692},{"label":"Dez","value":531}];
const MX = 748;
