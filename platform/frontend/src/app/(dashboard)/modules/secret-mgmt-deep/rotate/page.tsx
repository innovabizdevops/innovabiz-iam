...
const PAGE = "Rotate";
const KPIS = [{"l":"Total Secret Mgmt Deep","v":"7.457","t":"-0.2%","d":"down"},{"l":"Rotate Ativos","v":"6.778","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"65.7%","t":"+9.3%","d":"up"},{"l":"Score Performance","v":"77","t":"-5.9%","d":"down"}];
const COLS = ["ID","Rotate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Secret Mgmt Deep #001","Secret Mgmt Deep #002","281","2.383","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Secret Mgmt Deep #002","Secret Mgmt Deep #003","1.616","6.997","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Secret Mgmt Deep #003","Secret Mgmt Deep #004","8.299","5.386","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Secret Mgmt Deep #004","Secret Mgmt Deep #005","5.571","529","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Secret Mgmt Deep #005","Secret Mgmt Deep #001","9.025","4.463","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":954},{"label":"Fev","value":916},{"label":"Mar","value":915},{"label":"Abr","value":945},{"label":"Mai","value":937},{"label":"Jun","value":939},{"label":"Jul","value":753},{"label":"Ago","value":891},{"label":"Set","value":911},{"label":"Out","value":991},{"label":"Nov","value":969},{"label":"Dez","value":1007}];
const MX = 1007;
