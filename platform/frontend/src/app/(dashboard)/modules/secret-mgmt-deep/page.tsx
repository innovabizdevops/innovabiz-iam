...
/* ═══ Secret Management Deep — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "6594", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4494", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€58K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1484927294", cells: ["SEC-9294", "Secret Management Deep Item 1", "19/3/2026", "€27 394"], status: "active" as const },
    { id: "1484930865", cells: ["SEC-3865", "Secret Management Deep Item 2", "6/10/2026", "€30 965"], status: "pending" as const },
    { id: "1484934436", cells: ["SEC-7436", "Secret Management Deep Item 3", "21/5/2026", "€34 536"], status: "completed" as const },
    { id: "1484938007", cells: ["SEC-2007", "Secret Management Deep Item 4", "8/12/2026", "€38 107"], status: "warning" as const },
    { id: "1484941578", cells: ["SEC-5578", "Secret Management Deep Item 5", "23/7/2026", "€41 678"], status: "active" as const },
];
...
export default function SecretManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Secret Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Secret Management Deep</p>
                    </div>
                </div>
