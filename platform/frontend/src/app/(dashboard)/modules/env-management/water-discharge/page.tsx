...
/* ═══ Env Management — Water Discharge ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "3001", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "259", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1292", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1708057615", cells: ["ENV-2615", "Water Discharge Item 1", "20/8/2026", "€7715"], status: "active" as const },
    { id: "1708061186", cells: ["ENV-6186", "Water Discharge Item 2", "7/3/2026", "€11 286"], status: "pending" as const },
    { id: "1708064757", cells: ["ENV-9757", "Water Discharge Item 3", "22/10/2026", "€14 857"], status: "completed" as const },
    { id: "1708068328", cells: ["ENV-4328", "Water Discharge Item 4", "9/5/2026", "€18 428"], status: "warning" as const },
    { id: "1708071899", cells: ["ENV-7899", "Water Discharge Item 5", "24/12/2026", "€21 999"], status: "active" as const },
];
...
export default function EnvManagementWaterDischargePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Water Discharge</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Env Management • Water Discharge</p>
                    </div>
                </div>
