...
/* ═══ Env Management — Env Incident ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "578", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "211", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3179", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "94%", trend: "-15%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "522153807", cells: ["ENV-1807", "Env Incident Item 1", "8/4/2026", "€3907"], status: "active" as const },
    { id: "522157378", cells: ["ENV-5378", "Env Incident Item 2", "23/11/2026", "€7478"], status: "pending" as const },
    { id: "522160949", cells: ["ENV-8949", "Env Incident Item 3", "10/6/2026", "€11 049"], status: "completed" as const },
    { id: "522164520", cells: ["ENV-3520", "Env Incident Item 4", "25/1/2026", "€14 620"], status: "warning" as const },
    { id: "522168091", cells: ["ENV-7091", "Env Incident Item 5", "12/8/2026", "€18 191"], status: "active" as const },
];
...
export default function EnvManagementEnvIncidentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Env Incident</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Env Management • Env Incident</p>
                    </div>
                </div>
