...
/* ═══ Env Management — Noise Impact ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "2732", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "430", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2479", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1240281674", cells: ["ENV-1674", "Noise Impact Item 1", "3/3/2026", "€31 774"], status: "active" as const },
    { id: "1240285245", cells: ["ENV-5245", "Noise Impact Item 2", "18/10/2026", "€35 345"], status: "pending" as const },
    { id: "1240288816", cells: ["ENV-8816", "Noise Impact Item 3", "5/5/2026", "€38 916"], status: "completed" as const },
    { id: "1240292387", cells: ["ENV-3387", "Noise Impact Item 4", "20/12/2026", "€42 487"], status: "warning" as const },
    { id: "1240295958", cells: ["ENV-6958", "Noise Impact Item 5", "7/7/2026", "€46 058"], status: "active" as const },
];
...
export default function EnvManagementNoiseImpactPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Noise Impact</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Env Management • Noise Impact</p>
                    </div>
                </div>
