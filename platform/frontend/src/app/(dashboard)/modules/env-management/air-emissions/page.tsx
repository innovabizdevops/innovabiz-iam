...
/* ═══ Env Management — Air Emissions ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "2255", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "384", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1193", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "655327500", cells: ["ENV-2500", "Air Emissions Item 1", "17/1/2026", "€27 600"], status: "active" as const },
    { id: "655331071", cells: ["ENV-6071", "Air Emissions Item 2", "4/8/2026", "€31 171"], status: "pending" as const },
    { id: "655334642", cells: ["ENV-9642", "Air Emissions Item 3", "19/3/2026", "€34 742"], status: "completed" as const },
    { id: "655338213", cells: ["ENV-4213", "Air Emissions Item 4", "6/10/2026", "€38 313"], status: "warning" as const },
    { id: "655341784", cells: ["ENV-7784", "Air Emissions Item 5", "21/5/2026", "€41 884"], status: "active" as const },
];
...
export default function EnvManagementAirEmissionsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Air Emissions</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Env Management • Air Emissions</p>
                    </div>
                </div>
