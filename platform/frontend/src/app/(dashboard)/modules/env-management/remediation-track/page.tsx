...
/* ═══ Env Management — Remediation Track ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "4323", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "42", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3388", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "91%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "266642214", cells: ["ENV-9214", "Remediation Track Item 1", "7/7/2026", "€42 314"], status: "active" as const },
    { id: "266645785", cells: ["ENV-3785", "Remediation Track Item 2", "22/2/2026", "€45 885"], status: "pending" as const },
    { id: "266649356", cells: ["ENV-7356", "Remediation Track Item 3", "9/9/2026", "€49 456"], status: "completed" as const },
    { id: "266652927", cells: ["ENV-1927", "Remediation Track Item 4", "24/4/2026", "€3027"], status: "warning" as const },
    { id: "266656498", cells: ["ENV-5498", "Remediation Track Item 5", "11/11/2026", "€6598"], status: "active" as const },
];
...
export default function EnvManagementRemediationTrackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Remediation Track</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Env Management • Remediation Track</p>
                    </div>
                </div>
