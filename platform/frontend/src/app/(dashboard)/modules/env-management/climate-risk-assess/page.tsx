...
/* ═══ Env Management — Climate Risk Assess ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "3840", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "340", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "58", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "91%", trend: "-7%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "912941424", cells: ["ENV-9424", "Climate Risk Assess Item 1", "25/1/2026", "€41 524"], status: "active" as const },
    { id: "912944995", cells: ["ENV-3995", "Climate Risk Assess Item 2", "12/8/2026", "€45 095"], status: "pending" as const },
    { id: "912948566", cells: ["ENV-7566", "Climate Risk Assess Item 3", "27/3/2026", "€48 666"], status: "completed" as const },
    { id: "912952137", cells: ["ENV-2137", "Climate Risk Assess Item 4", "14/10/2026", "€2237"], status: "warning" as const },
    { id: "912955708", cells: ["ENV-5708", "Climate Risk Assess Item 5", "1/5/2026", "€5808"], status: "active" as const },
];
...
export default function EnvManagementClimateRiskAssessPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Climate Risk Assess</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Env Management • Climate Risk Assess</p>
                    </div>
                </div>
