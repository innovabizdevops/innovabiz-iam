...
/* ═══ Env Management — Biodiversity Assess ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "193", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "125", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "560", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "98%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "563988841", cells: ["ENV-4841", "Biodiversity Assess Item 1", "18/2/2026", "€38 941"], status: "active" as const },
    { id: "563992412", cells: ["ENV-8412", "Biodiversity Assess Item 2", "5/9/2026", "€42 512"], status: "pending" as const },
    { id: "563995983", cells: ["ENV-2983", "Biodiversity Assess Item 3", "20/4/2026", "€46 083"], status: "completed" as const },
    { id: "563999554", cells: ["ENV-6554", "Biodiversity Assess Item 4", "7/11/2026", "€49 654"], status: "warning" as const },
    { id: "564003125", cells: ["ENV-1125", "Biodiversity Assess Item 5", "22/6/2026", "€3225"], status: "active" as const },
];
...
export default function EnvManagementBiodiversityAssessPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Biodiversity Assess</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Env Management • Biodiversity Assess</p>
                    </div>
                </div>
