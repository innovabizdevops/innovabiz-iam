...
/* ═══ Env Management — Soil Contam ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "3210", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "361", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2423", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "179334133", cells: ["ENV-1133", "Soil Contam Item 1", "14/2/2026", "€34 233"], status: "active" as const },
    { id: "179337704", cells: ["ENV-4704", "Soil Contam Item 2", "1/9/2026", "€37 804"], status: "pending" as const },
    { id: "179341275", cells: ["ENV-8275", "Soil Contam Item 3", "16/4/2026", "€41 375"], status: "completed" as const },
    { id: "179344846", cells: ["ENV-2846", "Soil Contam Item 4", "3/11/2026", "€44 946"], status: "warning" as const },
    { id: "179348417", cells: ["ENV-6417", "Soil Contam Item 5", "18/6/2026", "€48 517"], status: "active" as const },
];
...
export default function EnvManagementSoilContamPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Soil Contam</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Env Management • Soil Contam</p>
                    </div>
                </div>
