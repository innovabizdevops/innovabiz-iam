...
/* ═══ Env Management — Env Permits ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "4323", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "473", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1720", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "941682277", cells: ["ENV-4277", "Env Permits Item 1", "26/2/2026", "€32 377"], status: "active" as const },
    { id: "941685848", cells: ["ENV-7848", "Env Permits Item 2", "13/9/2026", "€35 948"], status: "pending" as const },
    { id: "941689419", cells: ["ENV-2419", "Env Permits Item 3", "28/4/2026", "€39 519"], status: "completed" as const },
    { id: "941692990", cells: ["ENV-5990", "Env Permits Item 4", "15/11/2026", "€43 090"], status: "warning" as const },
    { id: "941696561", cells: ["ENV-9561", "Env Permits Item 5", "2/6/2026", "€46 661"], status: "active" as const },
];
...
export default function EnvManagementEnvPermitsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Env Permits</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Env Management • Env Permits</p>
                    </div>
                </div>
