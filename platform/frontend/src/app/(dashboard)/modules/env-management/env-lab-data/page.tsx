...
/* ═══ Env Management — Env Lab Data ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "166", trend: "-19%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "410", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2107", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1588998918", cells: ["ENV-4918", "Env Lab Data Item 1", "11/7/2026", "€49 018"], status: "active" as const },
    { id: "1589002489", cells: ["ENV-8489", "Env Lab Data Item 2", "26/2/2026", "€2589"], status: "pending" as const },
    { id: "1589006060", cells: ["ENV-3060", "Env Lab Data Item 3", "13/9/2026", "€6160"], status: "completed" as const },
    { id: "1589009631", cells: ["ENV-6631", "Env Lab Data Item 4", "28/4/2026", "€9731"], status: "warning" as const },
    { id: "1589013202", cells: ["ENV-1202", "Env Lab Data Item 5", "15/11/2026", "€13 302"], status: "active" as const },
];
...
export default function EnvManagementEnvLabDataPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Env Lab Data</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Env Management • Env Lab Data</p>
                    </div>
                </div>
