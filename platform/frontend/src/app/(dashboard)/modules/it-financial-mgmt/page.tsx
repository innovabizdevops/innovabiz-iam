...
/* ═══ IT Financial Mgmt (COBIT APO06) — Dashboard ═══ */

const ACCENT = "#334155";

const KPIS = [
    { label: "Total Registos", value: "4906", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4822", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€158K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "-14%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1067838606", cells: ["IT-7606", "IT Financial Mgmt (COBIT APO06) Item 1", "3/7/2026", "€38 706"], status: "active" as const },
    { id: "1067842177", cells: ["IT-2177", "IT Financial Mgmt (COBIT APO06) Item 2", "18/2/2026", "€42 277"], status: "pending" as const },
    { id: "1067845748", cells: ["IT-5748", "IT Financial Mgmt (COBIT APO06) Item 3", "5/9/2026", "€45 848"], status: "completed" as const },
    { id: "1067849319", cells: ["IT-9319", "IT Financial Mgmt (COBIT APO06) Item 4", "20/4/2026", "€49 419"], status: "warning" as const },
    { id: "1067852890", cells: ["IT-3890", "IT Financial Mgmt (COBIT APO06) Item 5", "7/11/2026", "€2990"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 66 }, { label: "Fev", value: 75 }, { label: "Mar", value: 84 }, { label: "Abr", value: 93 }, { label: "Mai", value: 22 }, { label: "Jun", value: 31 }];
...
export default function ItFinancialMgmtCobitApo06Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">IT Financial Mgmt (COBIT APO06)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • IT Financial Mgmt (COBIT APO06)</p>
                    </div>
                </div>
