...
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"6.645","t":"+17.1%","d":"up"},{"l":"Valor Total (€M)","v":"€25.1M","t":"+9.1%","d":"up"},{"l":"Renovações Próx. 30d","v":"3.291","t":"+9.3%","d":"up"},{"l":"Obrigações Pendentes","v":"1.887","t":"+7.2%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 9510.81","2026-03-04","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 1892.48","2026-03-20","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 49917.34","2026-02-25","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 27088.55","2026-03-15","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 33292.18","2026-01-11","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":675},{"label":"Mar","value":670},{"label":"Abr","value":1000},{"label":"Mai","value":1029},{"label":"Jun","value":943},{"label":"Jul","value":688},{"label":"Ago","value":817},{"label":"Set","value":768},{"label":"Out","value":1053},{"label":"Nov","value":718},{"label":"Dez","value":838}];
const MX = 1053;
