...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"1.370","t":"+6.5%","d":"up"},{"l":"Mitigações Ativas","v":"662","t":"+8.1%","d":"up"},{"l":"Score Risco Geral","v":"81","t":"+15.1%","d":"up"},{"l":"Incidentes YTD","v":"2.900","t":"-2.8%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.094","4.436","7.539","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.710","196","4.401","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.925","8.882","1.564","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","353","3.937","6.718","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.786","6.785","5.011","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":918},{"label":"Mar","value":808},{"label":"Abr","value":675},{"label":"Mai","value":874},{"label":"Jun","value":718},{"label":"Jul","value":847},{"label":"Ago","value":716},{"label":"Set","value":989},{"label":"Out","value":956},{"label":"Nov","value":1018},{"label":"Dez","value":959}];
const MX = 1018;
