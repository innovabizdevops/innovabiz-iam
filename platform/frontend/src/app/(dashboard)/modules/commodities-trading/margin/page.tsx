...
const PAGE = "Margin";
const KPIS = [{"l":"ARR (€M)","v":"€22.9M","t":"-1.4%","d":"down"},{"l":"MRR (€)","v":"€60136","t":"+2.6%","d":"up"},{"l":"Churn (%)","v":"69.3%","t":"+1.3%","d":"up"},{"l":"ARPU (€)","v":"€3417","t":"-4.5%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 5122.34","5.489","€ 16078.90","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 23659.11","3.700","€ 8682.73","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 17569.89","1.414","€ 17183.30","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 38712.63","3.167","€ 13980.87","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 35502.87","910","€ 6027.43","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":984},{"label":"Mar","value":972},{"label":"Abr","value":973},{"label":"Mai","value":838},{"label":"Jun","value":942},{"label":"Jul","value":788},{"label":"Ago","value":749},{"label":"Set","value":993},{"label":"Out","value":753},{"label":"Nov","value":720},{"label":"Dez","value":856}];
const MX = 993;
