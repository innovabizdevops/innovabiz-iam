...
const KPIS = [
    { label: "Total Registos", value: "2742", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4877", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€207K", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1283022842", cells: ["COM-1842", "Commodities Trading Item 1", "11/3/2026", "€22 942"], status: "active" as const },
    { id: "1283026413", cells: ["COM-5413", "Commodities Trading Item 2", "26/10/2026", "€26 513"], status: "pending" as const },
    { id: "1283029984", cells: ["COM-8984", "Commodities Trading Item 3", "13/5/2026", "€30 084"], status: "completed" as const },
    { id: "1283033555", cells: ["COM-3555", "Commodities Trading Item 4", "28/12/2026", "€33 655"], status: "warning" as const },
    { id: "1283037126", cells: ["COM-7126", "Commodities Trading Item 5", "15/7/2026", "€37 226"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Commodities Trading</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Commodities Trading</p>
                    </div>
                </div>
