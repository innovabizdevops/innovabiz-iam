...
const ACCENT = "#6366f1";
const MODULE = "ISR Platform";
const PAGE = "Fusion";
const KPIS = [{"l":"Formulários Ativos","v":"5.197","t":"+15.8%","d":"up"},{"l":"Submissões/Dia","v":"4270","t":"+17.8%","d":"up"},{"l":"Documentos Gerados","v":"8.196","t":"+2.8%","d":"up"},{"l":"Templates","v":"2.950","t":"+15.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.505","2026-01-15","6.246","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.260","2026-02-22","8.279","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.159","2026-03-19","5.243","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","666","2026-01-01","9.012","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","9.065","2026-01-26","8.570","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":351},{"label":"Fev","value":346},{"label":"Mar","value":320},{"label":"Abr","value":513},{"label":"Mai","value":372},{"label":"Jun","value":446},{"label":"Jul","value":467},{"label":"Ago","value":399},{"label":"Set","value":496},{"label":"Out","value":515},{"label":"Nov","value":526},{"label":"Dez","value":660}];
const MX = 660;
