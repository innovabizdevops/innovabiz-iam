...
const PAGE = "HUMINT";
const KPIS = [{"l":"Formulários Ativos","v":"5.421","t":"+13.2%","d":"up"},{"l":"Submissões/Dia","v":"3558","t":"+6.5%","d":"up"},{"l":"Documentos Gerados","v":"5.896","t":"+4.9%","d":"up"},{"l":"Templates","v":"2.992","t":"+1.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.637","2026-02-02","8.760","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.121","2026-02-03","6.018","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.672","2026-03-26","3.259","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.745","2026-03-04","7.924","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.290","2026-02-01","3.821","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":501},{"label":"Mar","value":705},{"label":"Abr","value":642},{"label":"Mai","value":371},{"label":"Jun","value":675},{"label":"Jul","value":341},{"label":"Ago","value":510},{"label":"Set","value":471},{"label":"Out","value":491},{"label":"Nov","value":359},{"label":"Dez","value":458}];
const MX = 705;
