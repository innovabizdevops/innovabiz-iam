...
const PAGE = "IMINT";
const KPIS = [{"l":"Formulários Ativos","v":"3.169","t":"-5.2%","d":"down"},{"l":"Submissões/Dia","v":"1828","t":"-3.1%","d":"down"},{"l":"Documentos Gerados","v":"8.598","t":"+2.5%","d":"up"},{"l":"Templates","v":"4.505","t":"+7.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.382","2026-03-16","5.522","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.389","2026-03-15","6.480","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.166","2026-03-07","3.864","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.875","2026-01-10","3.889","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.240","2026-01-12","2.780","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":708},{"label":"Mar","value":546},{"label":"Abr","value":607},{"label":"Mai","value":504},{"label":"Jun","value":757},{"label":"Jul","value":475},{"label":"Ago","value":462},{"label":"Set","value":634},{"label":"Out","value":577},{"label":"Nov","value":680},{"label":"Dez","value":657}];
const MX = 757;
