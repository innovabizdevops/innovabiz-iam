...
const PAGE = "SIGINT";
const KPIS = [{"l":"Formulários Ativos","v":"280","t":"+0.3%","d":"up"},{"l":"Submissões/Dia","v":"1635","t":"+5.6%","d":"up"},{"l":"Documentos Gerados","v":"3.851","t":"+17.7%","d":"up"},{"l":"Templates","v":"4.299","t":"+0.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.245","2026-03-21","7.557","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.874","2026-01-06","7.564","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","720","2026-03-22","8.092","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.570","2026-02-22","8.317","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.451","2026-02-28","795","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":642},{"label":"Mar","value":815},{"label":"Abr","value":552},{"label":"Mai","value":589},{"label":"Jun","value":744},{"label":"Jul","value":863},{"label":"Ago","value":830},{"label":"Set","value":721},{"label":"Out","value":555},{"label":"Nov","value":913},{"label":"Dez","value":752}];
const MX = 913;
