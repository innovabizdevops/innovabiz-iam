...
const KPIS = [{"l":"Formulários Ativos","v":"1.380","t":"-5.8%","d":"down"},{"l":"Submissões/Dia","v":"451","t":"+0.3%","d":"up"},{"l":"Documentos Gerados","v":"7.290","t":"+6.8%","d":"up"},{"l":"Templates","v":"3.723","t":"+5.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.451","2026-02-26","3.013","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.221","2026-01-28","2.109","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.056","2026-02-19","5.489","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","752","2026-01-28","325","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.601","2026-02-14","8.180","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":356},{"label":"Fev","value":414},{"label":"Mar","value":618},{"label":"Abr","value":460},{"label":"Mai","value":282},{"label":"Jun","value":420},{"label":"Jul","value":254},{"label":"Ago","value":418},{"label":"Set","value":565},{"label":"Out","value":394},{"label":"Nov","value":596},{"label":"Dez","value":341}];
const MX = 618;
