...
const PAGE = "Certify";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.120","t":"+14.6%","d":"up"},{"l":"Sessões/Dia","v":"1563","t":"+11.8%","d":"up"},{"l":"MFA Adoção (%)","v":"75.0%","t":"+11.1%","d":"up"},{"l":"Tentativas Bloqueadas","v":"3.830","t":"+15.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.544","4.004","4.250","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.530","5.144","3.314","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.899","4.504","1.840","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","5.564","683","718","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.160","3.047","3.502","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":647},{"label":"Mar","value":640},{"label":"Abr","value":480},{"label":"Mai","value":712},{"label":"Jun","value":505},{"label":"Jul","value":622},{"label":"Ago","value":654},{"label":"Set","value":678},{"label":"Out","value":756},{"label":"Nov","value":735},{"label":"Dez","value":485}];
const MX = 756;
