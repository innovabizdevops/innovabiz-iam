...
const PAGE = "Database";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.402","t":"+15.5%","d":"up"},{"l":"Sessões/Dia","v":"4373","t":"+1.6%","d":"up"},{"l":"MFA Adoção (%)","v":"71.9%","t":"+14.6%","d":"up"},{"l":"Tentativas Bloqueadas","v":"5.177","t":"+6.5%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.023","4.403","8.601","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.269","5.960","1.274","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.225","7.363","5.105","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","9.063","2.828","7.215","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.514","7.084","3.719","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":405},{"label":"Fev","value":472},{"label":"Mar","value":364},{"label":"Abr","value":341},{"label":"Mai","value":363},{"label":"Jun","value":467},{"label":"Jul","value":369},{"label":"Ago","value":402},{"label":"Set","value":643},{"label":"Out","value":494},{"label":"Nov","value":392},{"label":"Dez","value":463}];
const MX = 643;
