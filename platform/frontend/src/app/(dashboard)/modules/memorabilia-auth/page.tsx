...
/* ═══ Autograph & Memorabilia — Dashboard ═══ */

const ACCENT = "#eab308";

const KPIS = [
    { label: "Total Registos", value: "7036", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "745", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€410K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "-19%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "509698536", cells: ["MEM-2536", "Autograph & Memorabilia Item 1", "5/1/2026", "€48 636"], status: "active" as const },
    { id: "509702107", cells: ["MEM-6107", "Autograph & Memorabilia Item 2", "20/8/2026", "€2207"], status: "pending" as const },
    { id: "509705678", cells: ["MEM-9678", "Autograph & Memorabilia Item 3", "7/3/2026", "€5778"], status: "completed" as const },
    { id: "509709249", cells: ["MEM-4249", "Autograph & Memorabilia Item 4", "22/10/2026", "€9349"], status: "warning" as const },
    { id: "509712820", cells: ["MEM-7820", "Autograph & Memorabilia Item 5", "9/5/2026", "€12 920"], status: "active" as const },
];
...
export default function AutographMemorabiliaPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Autograph & Memorabilia</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Autograph & Memorabilia</p>
                    </div>
                </div>
