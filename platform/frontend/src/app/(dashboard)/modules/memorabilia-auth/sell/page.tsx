...
const PAGE = "Sell";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.092","t":"-4.0%","d":"down"},{"l":"Sessões/Dia","v":"3634","t":"+5.2%","d":"up"},{"l":"MFA Adoção (%)","v":"72.2%","t":"-1.2%","d":"down"},{"l":"Tentativas Bloqueadas","v":"2.108","t":"+12.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.746","7.387","4.982","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","2.414","2.652","371","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","2.005","7.159","595","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","3.599","2.612","2.513","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","2.259","5.467","1.150","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":908},{"label":"Fev","value":902},{"label":"Mar","value":932},{"label":"Abr","value":826},{"label":"Mai","value":938},{"label":"Jun","value":950},{"label":"Jul","value":835},{"label":"Ago","value":625},{"label":"Set","value":705},{"label":"Out","value":833},{"label":"Nov","value":854},{"label":"Dez","value":674}];
const MX = 950;
