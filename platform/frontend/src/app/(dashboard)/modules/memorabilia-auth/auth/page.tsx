...
const ACCENT = "#eab308";
const MODULE = "Autograph & Memorabilia";
const PAGE = "Authenticate";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.381","t":"-4.5%","d":"down"},{"l":"Sessões/Dia","v":"4550","t":"+11.0%","d":"up"},{"l":"MFA Adoção (%)","v":"75.8%","t":"-3.8%","d":"down"},{"l":"Tentativas Bloqueadas","v":"7.660","t":"+7.4%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","4.387","4.397","8.879","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.778","840","1.093","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.556","4.749","1.052","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.618","1.518","7.383","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","2.448","7.034","8.575","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":863},{"label":"Mar","value":695},{"label":"Abr","value":918},{"label":"Mai","value":776},{"label":"Jun","value":714},{"label":"Jul","value":754},{"label":"Ago","value":859},{"label":"Set","value":715},{"label":"Out","value":859},{"label":"Nov","value":821},{"label":"Dez","value":735}];
const MX = 918;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#eab308'}}>AI</span></h1>
                </div>
