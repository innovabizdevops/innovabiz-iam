...
const PAGE = "Catalog";
const KPIS = [{"l":"Utilizadores Ativos","v":"4.140","t":"+7.0%","d":"up"},{"l":"Sessões/Dia","v":"1861","t":"+14.4%","d":"up"},{"l":"MFA Adoção (%)","v":"74.0%","t":"-5.5%","d":"down"},{"l":"Tentativas Bloqueadas","v":"3.510","t":"-0.7%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","5.257","2.500","8.491","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","848","3.380","3.988","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.581","4.399","702","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.516","2.832","3.154","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","5.397","4.101","7.298","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":709},{"label":"Mar","value":758},{"label":"Abr","value":614},{"label":"Mai","value":637},{"label":"Jun","value":821},{"label":"Jul","value":592},{"label":"Ago","value":661},{"label":"Set","value":963},{"label":"Out","value":810},{"label":"Nov","value":934},{"label":"Dez","value":815}];
const MX = 963;
