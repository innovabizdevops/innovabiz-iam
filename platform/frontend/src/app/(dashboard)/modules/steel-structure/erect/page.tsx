...
const ACCENT = "#6366f1";
const MODULE = "Steel & Structure";
const PAGE = "Erect";
const KPIS = [{"l":"Total Steel Structure","v":"3.565","t":"+15.0%","d":"up"},{"l":"Erect Ativos","v":"7.634","t":"+1.2%","d":"up"},{"l":"Eficiência (%)","v":"72.9%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"70","t":"-5.4%","d":"down"}];
const COLS = ["ID","Erect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Steel Structure #001","Steel Structure #002","1.661","4.051","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Steel Structure #002","Steel Structure #003","2.191","3.723","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Steel Structure #003","Steel Structure #004","7.911","6.643","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Steel Structure #004","Steel Structure #005","6.312","1.408","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Steel Structure #005","Steel Structure #001","6.933","2.902","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":860},{"label":"Mar","value":871},{"label":"Abr","value":718},{"label":"Mai","value":918},{"label":"Jun","value":645},{"label":"Jul","value":631},{"label":"Ago","value":879},{"label":"Set","value":824},{"label":"Out","value":651},{"label":"Nov","value":608},{"label":"Dez","value":920}];
const MX = 920;
...
export default function ErectPage() {
    return (
