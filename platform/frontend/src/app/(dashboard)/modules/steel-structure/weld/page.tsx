...
const PAGE = "Weld Inspect";
const KPIS = [{"l":"Total Steel Structure","v":"455","t":"+15.5%","d":"up"},{"l":"Weld Inspect Ativos","v":"2.230","t":"+15.2%","d":"up"},{"l":"Eficiência (%)","v":"82.6%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"66","t":"+8.5%","d":"up"}];
const COLS = ["ID","Weld Inspect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Steel Structure #001","Steel Structure #002","4.298","1.354","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Steel Structure #002","Steel Structure #003","7.066","7.624","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Steel Structure #003","Steel Structure #004","7.055","7.128","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Steel Structure #004","Steel Structure #005","912","5.921","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Steel Structure #005","Steel Structure #001","5.956","2.055","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":748},{"label":"Mar","value":729},{"label":"Abr","value":433},{"label":"Mai","value":670},{"label":"Jun","value":769},{"label":"Jul","value":609},{"label":"Ago","value":668},{"label":"Set","value":475},{"label":"Out","value":682},{"label":"Nov","value":693},{"label":"Dez","value":475}];
const MX = 769;
