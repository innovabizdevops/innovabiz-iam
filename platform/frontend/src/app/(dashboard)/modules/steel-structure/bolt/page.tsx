...
const PAGE = "Bolt Track";
const KPIS = [{"l":"Total Steel Structure","v":"3.600","t":"+14.0%","d":"up"},{"l":"Bolt Track Ativos","v":"4.627","t":"+14.4%","d":"up"},{"l":"Eficiência (%)","v":"76.3%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"79","t":"+5.5%","d":"up"}];
const COLS = ["ID","Bolt Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Steel Structure #001","Steel Structure #002","6.857","7.797","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Steel Structure #002","Steel Structure #003","8.089","4.223","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Steel Structure #003","Steel Structure #004","2.648","7.411","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Steel Structure #004","Steel Structure #005","3.407","6.428","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Steel Structure #005","Steel Structure #001","6.769","2.143","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":799},{"label":"Mar","value":674},{"label":"Abr","value":973},{"label":"Mai","value":668},{"label":"Jun","value":696},{"label":"Jul","value":838},{"label":"Ago","value":795},{"label":"Set","value":591},{"label":"Out","value":759},{"label":"Nov","value":800},{"label":"Dez","value":881}];
const MX = 973;
