...
const PAGE = "Fabricate";
const KPIS = [{"l":"Total Steel Structure","v":"957","t":"+13.8%","d":"up"},{"l":"Fabricate Ativos","v":"4.016","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"67.4%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"64","t":"+6.5%","d":"up"}];
const COLS = ["ID","Fabricate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Steel Structure #001","Steel Structure #002","3.164","1.732","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Steel Structure #002","Steel Structure #003","8.351","5.780","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Steel Structure #003","Steel Structure #004","2.095","3.922","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Steel Structure #004","Steel Structure #005","816","8.508","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Steel Structure #005","Steel Structure #001","2.879","6.640","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":465},{"label":"Fev","value":454},{"label":"Mar","value":485},{"label":"Abr","value":702},{"label":"Mai","value":505},{"label":"Jun","value":647},{"label":"Jul","value":682},{"label":"Ago","value":634},{"label":"Set","value":384},{"label":"Out","value":573},{"label":"Nov","value":573},{"label":"Dez","value":461}];
const MX = 702;
