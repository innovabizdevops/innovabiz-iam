...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"841","t":"+7.7%","d":"up"},{"l":"Submissões/Dia","v":"3332","t":"+3.2%","d":"up"},{"l":"Documentos Gerados","v":"6.399","t":"+9.0%","d":"up"},{"l":"Templates","v":"4.936","t":"+12.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","153","2026-02-08","7.548","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.270","2026-03-19","7.373","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.911","2026-02-27","3.483","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.167","2026-01-25","3.602","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.610","2026-02-08","8.011","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":487},{"label":"Mar","value":552},{"label":"Abr","value":497},{"label":"Mai","value":459},{"label":"Jun","value":521},{"label":"Jul","value":502},{"label":"Ago","value":625},{"label":"Set","value":516},{"label":"Out","value":511},{"label":"Nov","value":750},{"label":"Dez","value":481}];
const MX = 750;
