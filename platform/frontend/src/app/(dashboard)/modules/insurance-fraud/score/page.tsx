...
const PAGE = "Score";
const KPIS = [{"l":"Total Insurance Fraud","v":"2.686","t":"+15.5%","d":"up"},{"l":"Score Ativos","v":"73","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"84.8%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"82","t":"+15.1%","d":"up"}];
const COLS = ["ID","Score","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurance Fraud #001","80.1%","4.798","4.649","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Insurance Fraud #002","80.8%","6.094","7.810","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurance Fraud #003","74.8%","3.663","8.183","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Insurance Fraud #004","75.8%","1.014","3.254","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurance Fraud #005","97.4%","8.331","2.380","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":284},{"label":"Fev","value":546},{"label":"Mar","value":487},{"label":"Abr","value":573},{"label":"Mai","value":329},{"label":"Jun","value":378},{"label":"Jul","value":318},{"label":"Ago","value":355},{"label":"Set","value":322},{"label":"Out","value":603},{"label":"Nov","value":571},{"label":"Dez","value":624}];
const MX = 624;
