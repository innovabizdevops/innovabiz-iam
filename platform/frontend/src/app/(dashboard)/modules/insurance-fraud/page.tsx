...
const KPIS = [
    { label: "Total Registos", value: "2072", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1607", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€285K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "651926872", cells: ["INS-3872", "Insurance Fraud Detection Item 1", "17/5/2026", "€26 972"], status: "active" as const },
    { id: "651930443", cells: ["INS-7443", "Insurance Fraud Detection Item 2", "4/12/2026", "€30 543"], status: "pending" as const },
    { id: "651934014", cells: ["INS-2014", "Insurance Fraud Detection Item 3", "19/7/2026", "€34 114"], status: "completed" as const },
    { id: "651937585", cells: ["INS-5585", "Insurance Fraud Detection Item 4", "6/2/2026", "€37 685"], status: "warning" as const },
    { id: "651941156", cells: ["INS-9156", "Insurance Fraud Detection Item 5", "21/9/2026", "€41 256"], status: "active" as const },
];
...
export default function InsuranceFraudDetectionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Insurance Fraud Detection</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Insurance Fraud Detection</p>
                    </div>
                </div>
