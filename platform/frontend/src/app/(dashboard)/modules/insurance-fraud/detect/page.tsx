...
const ACCENT = "#92400e";
const MODULE = "Insurance Fraud Detection";
const PAGE = "Detect";
const KPIS = [{"l":"Total Insurance Fraud","v":"7.070","t":"+10.6%","d":"up"},{"l":"Detect Ativos","v":"2.779","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"73.6%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"65","t":"+13.7%","d":"up"}];
const COLS = ["ID","Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurance Fraud #001","Insurance Fraud #002","4.721","4.800","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Insurance Fraud #002","Insurance Fraud #003","8.466","2.698","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurance Fraud #003","Insurance Fraud #004","6.309","7.133","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Insurance Fraud #004","Insurance Fraud #005","4.679","7.647","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurance Fraud #005","Insurance Fraud #001","3.932","3.028","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":989},{"label":"Fev","value":658},{"label":"Mar","value":685},{"label":"Abr","value":814},{"label":"Mai","value":633},{"label":"Jun","value":995},{"label":"Jul","value":788},{"label":"Ago","value":707},{"label":"Set","value":1003},{"label":"Out","value":639},{"label":"Nov","value":795},{"label":"Dez","value":646}];
const MX = 1003;
