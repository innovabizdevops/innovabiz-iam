...
const PAGE = "Reliability";
const KPIS = [{"l":"Formulários Ativos","v":"3.008","t":"-5.2%","d":"down"},{"l":"Submissões/Dia","v":"3162","t":"+3.4%","d":"up"},{"l":"Documentos Gerados","v":"8.150","t":"+9.5%","d":"up"},{"l":"Templates","v":"7.145","t":"+5.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.478","2026-03-25","3.791","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.588","2026-03-23","1.008","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.439","2026-01-16","1.172","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.182","2026-03-23","2.208","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.336","2026-01-27","2.430","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":362},{"label":"Fev","value":568},{"label":"Mar","value":358},{"label":"Abr","value":512},{"label":"Mai","value":653},{"label":"Jun","value":389},{"label":"Jul","value":375},{"label":"Ago","value":541},{"label":"Set","value":513},{"label":"Out","value":623},{"label":"Nov","value":500},{"label":"Dez","value":295}];
const MX = 653;
