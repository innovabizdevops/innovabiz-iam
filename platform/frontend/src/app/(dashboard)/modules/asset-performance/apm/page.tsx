...
const PAGE = "APM Dashboard";
const KPIS = [{"l":"Formulários Ativos","v":"6.786","t":"+6.1%","d":"up"},{"l":"Submissões/Dia","v":"151","t":"+-0.0%","d":"up"},{"l":"Documentos Gerados","v":"8.672","t":"+6.9%","d":"up"},{"l":"Templates","v":"2.263","t":"+11.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.921","2026-01-24","5.260","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.649","2026-02-08","8.104","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.715","2026-02-21","5.282","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.398","2026-03-13","3.130","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.537","2026-03-19","8.832","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":713},{"label":"Fev","value":765},{"label":"Mar","value":939},{"label":"Abr","value":858},{"label":"Mai","value":709},{"label":"Jun","value":833},{"label":"Jul","value":999},{"label":"Ago","value":964},{"label":"Set","value":741},{"label":"Out","value":838},{"label":"Nov","value":969},{"label":"Dez","value":666}];
const MX = 999;
