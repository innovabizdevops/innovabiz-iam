...
const PAGE = "MTBF/MTTR";
const KPIS = [{"l":"Formulários Ativos","v":"5.478","t":"+1.1%","d":"up"},{"l":"Submissões/Dia","v":"210","t":"+5.6%","d":"up"},{"l":"Documentos Gerados","v":"7.036","t":"+17.1%","d":"up"},{"l":"Templates","v":"2.701","t":"+14.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.211","2026-03-04","1.947","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.267","2026-01-16","3.886","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.094","2026-02-19","383","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.489","2026-02-18","4.201","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.462","2026-02-26","836","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":458},{"label":"Mar","value":692},{"label":"Abr","value":460},{"label":"Mai","value":396},{"label":"Jun","value":451},{"label":"Jul","value":603},{"label":"Ago","value":497},{"label":"Set","value":602},{"label":"Out","value":697},{"label":"Nov","value":499},{"label":"Dez","value":652}];
const MX = 697;
