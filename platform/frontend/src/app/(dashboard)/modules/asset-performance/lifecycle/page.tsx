...
const ACCENT = "#b45309";
const MODULE = "Asset Performance";
const PAGE = "Life Cycle Cost";
const KPIS = [{"l":"Formulários Ativos","v":"7.070","t":"+6.7%","d":"up"},{"l":"Submissões/Dia","v":"662","t":"-2.0%","d":"down"},{"l":"Documentos Gerados","v":"4.550","t":"+13.2%","d":"up"},{"l":"Templates","v":"3.460","t":"+6.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.237","2026-03-28","4.775","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.866","2026-01-10","6.136","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.719","2026-01-22","4.735","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.147","2026-01-05","6.752","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.052","2026-02-08","241","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":898},{"label":"Fev","value":717},{"label":"Mar","value":914},{"label":"Abr","value":708},{"label":"Mai","value":789},{"label":"Jun","value":760},{"label":"Jul","value":1056},{"label":"Ago","value":976},{"label":"Set","value":795},{"label":"Out","value":846},{"label":"Nov","value":1070},{"label":"Dez","value":976}];
const MX = 1070;
