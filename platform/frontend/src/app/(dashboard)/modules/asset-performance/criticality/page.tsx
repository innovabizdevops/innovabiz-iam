...
const PAGE = "Criticality";
const KPIS = [{"l":"Formulários Ativos","v":"9.018","t":"-2.8%","d":"down"},{"l":"Submissões/Dia","v":"325","t":"+5.4%","d":"up"},{"l":"Documentos Gerados","v":"2.460","t":"+12.1%","d":"up"},{"l":"Templates","v":"4.393","t":"+5.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.504","2026-02-22","252","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.956","2026-03-03","268","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.130","2026-01-15","7.796","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.679","2026-03-27","7.733","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","191","2026-02-07","2.681","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":604},{"label":"Mar","value":508},{"label":"Abr","value":505},{"label":"Mai","value":568},{"label":"Jun","value":478},{"label":"Jul","value":697},{"label":"Ago","value":771},{"label":"Set","value":788},{"label":"Out","value":542},{"label":"Nov","value":645},{"label":"Dez","value":755}];
const MX = 788;
