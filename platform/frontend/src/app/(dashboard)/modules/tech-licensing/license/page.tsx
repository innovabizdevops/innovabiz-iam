...
const ACCENT = "#2563eb";
const MODULE = "Technology Licensing";
const PAGE = "License";
const KPIS = [{"l":"Total Tech Licensing","v":"6.070","t":"+9.3%","d":"up"},{"l":"License Ativos","v":"4.950","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"87.7%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"57","t":"+10.8%","d":"up"}];
const COLS = ["ID","License","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tech Licensing #001","Tech Licensing #002","1.365","6.429","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Tech Licensing #002","Tech Licensing #003","6.701","8.726","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Tech Licensing #003","Tech Licensing #004","3.396","5.958","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Tech Licensing #004","Tech Licensing #005","9.003","2.001","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tech Licensing #005","Tech Licensing #001","6.603","2.271","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":329},{"label":"Fev","value":469},{"label":"Mar","value":369},{"label":"Abr","value":631},{"label":"Mai","value":415},{"label":"Jun","value":623},{"label":"Jul","value":678},{"label":"Ago","value":392},{"label":"Set","value":551},{"label":"Out","value":343},{"label":"Nov","value":693},{"label":"Dez","value":667}];
const MX = 693;
