...
/* ═══ Technology Licensing — Dashboard ═══ */

const ACCENT = "#2563eb";

const KPIS = [
    { label: "Total Registos", value: "3414", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "322", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€356K", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "745404014", cells: ["TEC-7014", "Technology Licensing Item 1", "27/3/2026", "€4114"], status: "active" as const },
    { id: "745407585", cells: ["TEC-1585", "Technology Licensing Item 2", "14/10/2026", "€7685"], status: "pending" as const },
    { id: "745411156", cells: ["TEC-5156", "Technology Licensing Item 3", "1/5/2026", "€11 256"], status: "completed" as const },
    { id: "745414727", cells: ["TEC-8727", "Technology Licensing Item 4", "16/12/2026", "€14 827"], status: "warning" as const },
    { id: "745418298", cells: ["TEC-3298", "Technology Licensing Item 5", "3/7/2026", "€18 398"], status: "active" as const },
];
...
export default function TechnologyLicensingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Technology Licensing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Technology Licensing</p>
                    </div>
                </div>
