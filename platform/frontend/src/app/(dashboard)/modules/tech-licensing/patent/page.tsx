...
const PAGE = "Patent";
const KPIS = [{"l":"Ideias Submetidas","v":"2.633","t":"+4.4%","d":"up"},{"l":"Patentes (YTD)","v":"2.742","t":"-2.9%","d":"down"},{"l":"Projetos Innovation Lab","v":"836","t":"+9.8%","d":"up"},{"l":"Budget I&D (€M)","v":"€13.5M","t":"-4.8%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","3.259","91.0%","1.413","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","4.625","88.5%","7.626","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","2.433","71.8%","4.531","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","3.645","76.8%","5.670","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.366","87.7%","7.302","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":535},{"label":"Mar","value":508},{"label":"Abr","value":578},{"label":"Mai","value":754},{"label":"Jun","value":639},{"label":"Jul","value":842},{"label":"Ago","value":813},{"label":"Set","value":802},{"label":"Out","value":672},{"label":"Nov","value":549},{"label":"Dez","value":473}];
const MX = 842;
