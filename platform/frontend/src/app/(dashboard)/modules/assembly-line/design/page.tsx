...
const PAGE = "Line Design";
const KPIS = [{"l":"Formulários Ativos","v":"6.912","t":"+17.9%","d":"up"},{"l":"Submissões/Dia","v":"1375","t":"+1.1%","d":"up"},{"l":"Documentos Gerados","v":"7.430","t":"+6.1%","d":"up"},{"l":"Templates","v":"6.924","t":"-2.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.204","2026-02-06","1.645","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.802","2026-03-20","7.997","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.820","2026-03-21","7.049","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.617","2026-02-04","595","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.380","2026-02-24","1.260","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":357},{"label":"Fev","value":484},{"label":"Mar","value":462},{"label":"Abr","value":293},{"label":"Mai","value":291},{"label":"Jun","value":387},{"label":"Jul","value":313},{"label":"Ago","value":595},{"label":"Set","value":593},{"label":"Out","value":438},{"label":"Nov","value":412},{"label":"Dez","value":317}];
const MX = 595;
