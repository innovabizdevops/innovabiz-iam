...
const ACCENT = "#6366f1";
const MODULE = "Assembly Line";
const PAGE = "Torque";
const KPIS = [{"l":"Total Assembly Line","v":"4.747","t":"-1.3%","d":"down"},{"l":"Torque Ativos","v":"8.813","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"90.7%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"75","t":"+7.5%","d":"up"}];
const COLS = ["ID","Torque","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Assembly Line #001","Assembly Line #002","5.323","3.168","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Assembly Line #002","Assembly Line #003","1.510","4.565","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Assembly Line #003","Assembly Line #004","7.475","2.358","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Assembly Line #004","Assembly Line #005","6.267","1.685","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Assembly Line #005","Assembly Line #001","8.650","7.488","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":843},{"label":"Fev","value":955},{"label":"Mar","value":708},{"label":"Abr","value":776},{"label":"Mai","value":893},{"label":"Jun","value":805},{"label":"Jul","value":748},{"label":"Ago","value":828},{"label":"Set","value":776},{"label":"Out","value":932},{"label":"Nov","value":779},{"label":"Dez","value":928}];
const MX = 955;
