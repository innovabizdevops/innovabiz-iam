...
const PAGE = "Balance";
const KPIS = [{"l":"Total Assembly Line","v":"3.034","t":"+5.5%","d":"up"},{"l":"Balance Ativos","v":"1.432","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"72.9%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"82","t":"+10.4%","d":"up"}];
const COLS = ["ID","Balance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Assembly Line #001","Assembly Line #002","1.818","932","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Assembly Line #002","Assembly Line #003","7.517","6.327","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Assembly Line #003","Assembly Line #004","2.039","154","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Assembly Line #004","Assembly Line #005","8.364","365","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Assembly Line #005","Assembly Line #001","6.294","6.830","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":980},{"label":"Fev","value":823},{"label":"Mar","value":672},{"label":"Abr","value":781},{"label":"Mai","value":800},{"label":"Jun","value":733},{"label":"Jul","value":809},{"label":"Ago","value":883},{"label":"Set","value":682},{"label":"Out","value":1003},{"label":"Nov","value":1015},{"label":"Dez","value":852}];
const MX = 1015;
