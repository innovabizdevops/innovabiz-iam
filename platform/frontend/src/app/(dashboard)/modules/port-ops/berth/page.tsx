...
const PAGE = "Berth Plan";
const KPIS = [{"l":"Total Port Ops","v":"2.477","t":"+9.4%","d":"up"},{"l":"Berth Plan Ativos","v":"574","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"84.4%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"56","t":"+9.7%","d":"up"}];
const COLS = ["ID","Berth Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Port Ops #001","Port Ops #002","5.536","1.166","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Port Ops #002","Port Ops #003","2.888","4.106","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Port Ops #003","Port Ops #004","4.366","6.035","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Port Ops #004","Port Ops #005","6.759","3.795","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Port Ops #005","Port Ops #001","8.781","4.136","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":298},{"label":"Mar","value":425},{"label":"Abr","value":426},{"label":"Mai","value":678},{"label":"Jun","value":518},{"label":"Jul","value":575},{"label":"Ago","value":648},{"label":"Set","value":495},{"label":"Out","value":333},{"label":"Nov","value":382},{"label":"Dez","value":615}];
const MX = 678;
