...
const ACCENT = "#78350f";
const MODULE = "Port Operations";
const PAGE = "Gate Control";
const KPIS = [{"l":"Total Port Ops","v":"2.263","t":"+15.5%","d":"up"},{"l":"Gate Control Ativos","v":"7.523","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"90.2%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"82","t":"-6.0%","d":"down"}];
const COLS = ["ID","Gate Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Port Ops #001","Port Ops #002","1.200","928","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Port Ops #002","Port Ops #003","8.203","4.617","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Port Ops #003","Port Ops #004","3.208","8.446","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Port Ops #004","Port Ops #005","6.460","4.497","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Port Ops #005","Port Ops #001","5.630","2.948","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":720},{"label":"Mar","value":777},{"label":"Abr","value":629},{"label":"Mai","value":645},{"label":"Jun","value":636},{"label":"Jul","value":758},{"label":"Ago","value":684},{"label":"Set","value":738},{"label":"Out","value":633},{"label":"Nov","value":562},{"label":"Dez","value":795}];
const MX = 795;
