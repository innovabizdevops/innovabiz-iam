...
const PAGE = "Crane Assign";
const KPIS = [{"l":"Total Port Ops","v":"1.589","t":"-2.5%","d":"down"},{"l":"Crane Assign Ativos","v":"1.070","t":"+0.6%","d":"up"},{"l":"Eficiência (%)","v":"75.4%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"67","t":"+12.8%","d":"up"}];
const COLS = ["ID","Crane Assign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Port Ops #001","Port Ops #002","5.567","219","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Port Ops #002","Port Ops #003","6.713","1.383","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Port Ops #003","Port Ops #004","7.252","1.018","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Port Ops #004","Port Ops #005","7.303","8.533","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Port Ops #005","Port Ops #001","2.325","2.792","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":715},{"label":"Fev","value":655},{"label":"Mar","value":891},{"label":"Abr","value":847},{"label":"Mai","value":851},{"label":"Jun","value":866},{"label":"Jul","value":938},{"label":"Ago","value":1046},{"label":"Set","value":655},{"label":"Out","value":749},{"label":"Nov","value":964},{"label":"Dez","value":757}];
const MX = 1046;
