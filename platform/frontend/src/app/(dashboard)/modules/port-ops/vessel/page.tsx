...
const PAGE = "Vessel Track";
const KPIS = [{"l":"Total Port Ops","v":"2.571","t":"-4.5%","d":"down"},{"l":"Vessel Track Ativos","v":"7.966","t":"-5.9%","d":"down"},{"l":"Eficiência (%)","v":"79.4%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"80","t":"+15.1%","d":"up"}];
const COLS = ["ID","Vessel Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Port Ops #001","Port Ops #002","5.585","2.432","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Port Ops #002","Port Ops #003","4.640","3.666","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Port Ops #003","Port Ops #004","6.135","1.386","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Port Ops #004","Port Ops #005","8.653","500","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Port Ops #005","Port Ops #001","359","3.711","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":390},{"label":"Mar","value":404},{"label":"Abr","value":339},{"label":"Mai","value":495},{"label":"Jun","value":601},{"label":"Jul","value":383},{"label":"Ago","value":362},{"label":"Set","value":431},{"label":"Out","value":508},{"label":"Nov","value":554},{"label":"Dez","value":394}];
const MX = 601;
