...
const PAGE = "Storytelling";
const KPIS = [{"l":"Dashboards Ativos","v":"8.563","t":"+8.0%","d":"up"},{"l":"Queries/Dia","v":"4678","t":"-2.6%","d":"down"},{"l":"Dados Processados (GB)","v":"2.029","t":"+9.2%","d":"up"},{"l":"Utilizadores Analytics","v":"3.335","t":"+15.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1977","2026-01-09","126","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1553","2026-03-22","6.709","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2418","2026-01-16","2.349","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1240","2026-01-16","9.019","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4594","2026-01-19","590","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1029},{"label":"Fev","value":953},{"label":"Mar","value":1030},{"label":"Abr","value":886},{"label":"Mai","value":1023},{"label":"Jun","value":844},{"label":"Jul","value":789},{"label":"Ago","value":931},{"label":"Set","value":774},{"label":"Out","value":914},{"label":"Nov","value":1045},{"label":"Dez","value":731}];
const MX = 1045;
