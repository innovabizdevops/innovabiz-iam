...
const PAGE = "Chart Gallery";
const KPIS = [{"l":"Dashboards Ativos","v":"3.978","t":"-4.5%","d":"down"},{"l":"Queries/Dia","v":"2594","t":"+15.0%","d":"up"},{"l":"Dados Processados (GB)","v":"6.949","t":"-3.2%","d":"down"},{"l":"Utilizadores Analytics","v":"2.532","t":"+4.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","132","2026-03-13","9.033","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4499","2026-01-22","7.097","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3544","2026-03-21","8.843","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2757","2026-03-05","5.815","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3543","2026-01-14","228","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":394},{"label":"Fev","value":512},{"label":"Mar","value":639},{"label":"Abr","value":650},{"label":"Mai","value":677},{"label":"Jun","value":638},{"label":"Jul","value":560},{"label":"Ago","value":361},{"label":"Set","value":474},{"label":"Out","value":612},{"label":"Nov","value":576},{"label":"Dez","value":340}];
const MX = 677;
