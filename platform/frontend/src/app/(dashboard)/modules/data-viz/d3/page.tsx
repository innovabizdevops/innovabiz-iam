...
const PAGE = "Custom D3";
const KPIS = [{"l":"Dashboards Ativos","v":"8.344","t":"+3.1%","d":"up"},{"l":"Queries/Dia","v":"610","t":"+4.2%","d":"up"},{"l":"Dados Processados (GB)","v":"6.597","t":"+13.4%","d":"up"},{"l":"Utilizadores Analytics","v":"3.476","t":"+5.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","349","2026-03-07","5.387","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4199","2026-03-25","3.748","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2814","2026-03-26","1.920","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3569","2026-03-15","3.546","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2100","2026-02-05","6.504","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":915},{"label":"Fev","value":554},{"label":"Mar","value":544},{"label":"Abr","value":599},{"label":"Mai","value":888},{"label":"Jun","value":815},{"label":"Jul","value":619},{"label":"Ago","value":591},{"label":"Set","value":826},{"label":"Out","value":780},{"label":"Nov","value":863},{"label":"Dez","value":828}];
const MX = 915;
