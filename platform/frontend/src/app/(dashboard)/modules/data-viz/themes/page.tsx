...
const PAGE = "Theme Designer";
const KPIS = [{"l":"Formulários Ativos","v":"7.154","t":"-5.6%","d":"down"},{"l":"Submissões/Dia","v":"355","t":"+15.7%","d":"up"},{"l":"Documentos Gerados","v":"3.728","t":"+17.1%","d":"up"},{"l":"Templates","v":"7.542","t":"-2.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.288","2026-03-18","5.553","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.011","2026-01-24","7.521","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.889","2026-01-14","4.527","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.880","2026-01-08","2.466","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.775","2026-01-04","8.752","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":814},{"label":"Mar","value":605},{"label":"Abr","value":670},{"label":"Mai","value":762},{"label":"Jun","value":710},{"label":"Jul","value":623},{"label":"Ago","value":500},{"label":"Set","value":614},{"label":"Out","value":468},{"label":"Nov","value":709},{"label":"Dez","value":461}];
const MX = 814;
