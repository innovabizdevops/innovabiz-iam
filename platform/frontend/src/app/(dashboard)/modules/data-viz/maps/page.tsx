...
const PAGE = "Map Visuals";
const KPIS = [{"l":"Dashboards Ativos","v":"4.070","t":"+4.1%","d":"up"},{"l":"Queries/Dia","v":"2409","t":"+10.9%","d":"up"},{"l":"Dados Processados (GB)","v":"4.797","t":"-5.3%","d":"down"},{"l":"Utilizadores Analytics","v":"939","t":"+2.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5075","2026-02-01","152","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3761","2026-03-17","3.072","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1020","2026-01-23","636","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4844","2026-01-11","8.013","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2875","2026-02-25","1.559","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":361},{"label":"Mar","value":562},{"label":"Abr","value":608},{"label":"Mai","value":314},{"label":"Jun","value":403},{"label":"Jul","value":562},{"label":"Ago","value":251},{"label":"Set","value":379},{"label":"Out","value":525},{"label":"Nov","value":606},{"label":"Dez","value":565}];
const MX = 608;
