...
const PAGE = "Noise Level";
const KPIS = [{"l":"Total Env Monitor","v":"7.135","t":"+17.8%","d":"up"},{"l":"Noise Level Ativos","v":"8.378","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"86.4%","t":"+17.1%","d":"up"},{"l":"Score Performance","v":"79","t":"+7.8%","d":"up"}];
const COLS = ["ID","Noise Level","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Env Monitor #001","Env Monitor #002","8.204","4.242","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Env Monitor #002","Env Monitor #003","7.770","3.798","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Env Monitor #003","Env Monitor #004","5.405","2.965","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Env Monitor #004","Env Monitor #005","7.074","3.030","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Env Monitor #005","Env Monitor #001","700","1.654","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":808},{"label":"Mar","value":535},{"label":"Abr","value":562},{"label":"Mai","value":743},{"label":"Jun","value":719},{"label":"Jul","value":433},{"label":"Ago","value":785},{"label":"Set","value":792},{"label":"Out","value":491},{"label":"Nov","value":792},{"label":"Dez","value":796}];
const MX = 808;
