...
const KPIS = [{"l":"Total Env Monitor","v":"6.765","t":"+2.6%","d":"up"},{"l":"Biodiversity Ativos","v":"4.749","t":"-3.7%","d":"down"},{"l":"Eficiência (%)","v":"70.8%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"73","t":"+0.8%","d":"up"}];
const COLS = ["ID","Biodiversity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Env Monitor #001","Env Monitor #002","8.144","6.964","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Env Monitor #002","Env Monitor #003","8.928","272","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Env Monitor #003","Env Monitor #004","8.047","5.841","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Env Monitor #004","Env Monitor #005","4.324","675","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Env Monitor #005","Env Monitor #001","7.377","4.091","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":687},{"label":"Mar","value":798},{"label":"Abr","value":542},{"label":"Mai","value":747},{"label":"Jun","value":681},{"label":"Jul","value":511},{"label":"Ago","value":569},{"label":"Set","value":792},{"label":"Out","value":774},{"label":"Nov","value":598},{"label":"Dez","value":607}];
const MX = 798;
