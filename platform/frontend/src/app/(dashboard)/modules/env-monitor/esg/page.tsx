...
const PAGE = "ESG Report";
const KPIS = [{"l":"Total Env Monitor","v":"5.319","t":"-5.0%","d":"down"},{"l":"ESG Report Ativos","v":"8.915","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"73.5%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"86","t":"-4.0%","d":"down"}];
const COLS = ["ID","ESG Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Env Monitor #001","Env Monitor #002","2.286","2.058","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Env Monitor #002","Env Monitor #003","8.507","1.392","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Env Monitor #003","Env Monitor #004","6.229","1.466","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Env Monitor #004","Env Monitor #005","1.389","1.722","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Env Monitor #005","Env Monitor #001","8.714","3.372","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":795},{"label":"Fev","value":645},{"label":"Mar","value":534},{"label":"Abr","value":682},{"label":"Mai","value":682},{"label":"Jun","value":743},{"label":"Jul","value":810},{"label":"Ago","value":537},{"label":"Set","value":544},{"label":"Out","value":450},{"label":"Nov","value":491},{"label":"Dez","value":556}];
const MX = 810;
