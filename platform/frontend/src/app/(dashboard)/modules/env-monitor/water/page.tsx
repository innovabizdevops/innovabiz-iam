...
const PAGE = "Water Monitor";
const KPIS = [{"l":"Total Env Monitor","v":"7.140","t":"+14.9%","d":"up"},{"l":"Water Monitor Ativos","v":"7.751","t":"+10.0%","d":"up"},{"l":"Eficiência (%)","v":"84.3%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"69","t":"-0.7%","d":"down"}];
const COLS = ["ID","Water Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Env Monitor #001","Env Monitor #002","4.802","237","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Env Monitor #002","Env Monitor #003","6.140","6.241","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Env Monitor #003","Env Monitor #004","6.546","4.009","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Env Monitor #004","Env Monitor #005","6.418","6.540","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Env Monitor #005","Env Monitor #001","645","6.155","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":736},{"label":"Mar","value":840},{"label":"Abr","value":729},{"label":"Mai","value":910},{"label":"Jun","value":702},{"label":"Jul","value":875},{"label":"Ago","value":901},{"label":"Set","value":819},{"label":"Out","value":658},{"label":"Nov","value":589},{"label":"Dez","value":658}];
const MX = 910;
