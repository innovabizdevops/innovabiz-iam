...
const PAGE = "Terminal Load";
const KPIS = [{"l":"Riscos Identificados","v":"2.532","t":"+8.4%","d":"up"},{"l":"Mitigações Ativas","v":"1.410","t":"-0.7%","d":"down"},{"l":"Score Risco Geral","v":"87","t":"+13.0%","d":"up"},{"l":"Incidentes YTD","v":"8.903","t":"+13.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.694","2.065","3.093","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.726","1.311","3.491","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.288","8.020","6.009","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.828","2.713","396","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.964","6.271","5.561","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":937},{"label":"Fev","value":739},{"label":"Mar","value":733},{"label":"Abr","value":731},{"label":"Mai","value":937},{"label":"Jun","value":688},{"label":"Jul","value":646},{"label":"Ago","value":726},{"label":"Set","value":640},{"label":"Out","value":764},{"label":"Nov","value":750},{"label":"Dez","value":973}];
const MX = 973;
