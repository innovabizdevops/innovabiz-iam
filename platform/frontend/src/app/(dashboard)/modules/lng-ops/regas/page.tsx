...
const ACCENT = "#0e7490";
const MODULE = "LNG Operations";
const PAGE = "Regasification";
const KPIS = [{"l":"Total Lng Ops","v":"4.329","t":"+4.0%","d":"up"},{"l":"Regasification Ativos","v":"8.448","t":"+1.8%","d":"up"},{"l":"Eficiência (%)","v":"85.2%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"74","t":"+3.4%","d":"up"}];
const COLS = ["ID","Regasification","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lng Ops #001","Lng Ops #002","5.803","9.012","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Lng Ops #002","Lng Ops #003","4.513","5.870","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Lng Ops #003","Lng Ops #004","5.090","1.943","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Lng Ops #004","Lng Ops #005","4.268","966","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lng Ops #005","Lng Ops #001","4.891","4.421","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":365},{"label":"Fev","value":619},{"label":"Mar","value":551},{"label":"Abr","value":535},{"label":"Mai","value":746},{"label":"Jun","value":578},{"label":"Jul","value":647},{"label":"Ago","value":544},{"label":"Set","value":383},{"label":"Out","value":744},{"label":"Nov","value":671},{"label":"Dez","value":591}];
const MX = 746;
...
export default function RegasPage() {
    return (
