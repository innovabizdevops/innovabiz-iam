...
const PAGE = "Boil-Off";
const KPIS = [{"l":"Total Lng Ops","v":"2.704","t":"+5.3%","d":"up"},{"l":"Boil Off Ativos","v":"848","t":"-5.3%","d":"down"},{"l":"Eficiência (%)","v":"78.4%","t":"+2.0%","d":"up"},{"l":"Score Performance","v":"55","t":"+7.5%","d":"up"}];
const COLS = ["ID","Boil Off","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lng Ops #001","Lng Ops #002","2.260","1.043","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Lng Ops #002","Lng Ops #003","2.473","3.947","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Lng Ops #003","Lng Ops #004","6.915","4.755","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Lng Ops #004","Lng Ops #005","3.963","3.586","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lng Ops #005","Lng Ops #001","2.138","3.958","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":813},{"label":"Fev","value":813},{"label":"Mar","value":755},{"label":"Abr","value":706},{"label":"Mai","value":763},{"label":"Jun","value":801},{"label":"Jul","value":823},{"label":"Ago","value":575},{"label":"Set","value":589},{"label":"Out","value":643},{"label":"Nov","value":579},{"label":"Dez","value":731}];
const MX = 823;
...
export default function BoiloffPage() {
    return (
