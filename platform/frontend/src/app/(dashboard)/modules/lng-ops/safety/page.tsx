...
const KPIS = [{"l":"Total Lng Ops","v":"8.023","t":"+2.3%","d":"up"},{"l":"Safety Zone Ativos","v":"4.227","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"69.3%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"92","t":"+9.2%","d":"up"}];
const COLS = ["ID","Safety Zone","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lng Ops #001","Lng Ops #002","6.114","2.062","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Lng Ops #002","Lng Ops #003","3.315","6.281","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Lng Ops #003","Lng Ops #004","8.198","1.154","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Lng Ops #004","Lng Ops #005","4.088","364","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lng Ops #005","Lng Ops #001","8.594","5.990","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":344},{"label":"Mar","value":375},{"label":"Abr","value":682},{"label":"Mai","value":303},{"label":"Jun","value":304},{"label":"Jul","value":424},{"label":"Ago","value":432},{"label":"Set","value":564},{"label":"Out","value":464},{"label":"Nov","value":510},{"label":"Dez","value":623}];
const MX = 682;
