...
const PAGE = "Cargo Mgmt";
const KPIS = [{"l":"Total Lng Ops","v":"7.505","t":"+4.9%","d":"up"},{"l":"Cargo Mgmt Ativos","v":"6.377","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"92.7%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"89","t":"-3.2%","d":"down"}];
const COLS = ["ID","Cargo Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lng Ops #001","Lng Ops #002","4.158","7.939","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Lng Ops #002","Lng Ops #003","691","2.180","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Lng Ops #003","Lng Ops #004","2.268","8.621","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Lng Ops #004","Lng Ops #005","8.353","8.468","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lng Ops #005","Lng Ops #001","8.522","6.067","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":404},{"label":"Fev","value":583},{"label":"Mar","value":576},{"label":"Abr","value":416},{"label":"Mai","value":517},{"label":"Jun","value":588},{"label":"Jul","value":473},{"label":"Ago","value":386},{"label":"Set","value":271},{"label":"Out","value":378},{"label":"Nov","value":619},{"label":"Dez","value":328}];
const MX = 619;
