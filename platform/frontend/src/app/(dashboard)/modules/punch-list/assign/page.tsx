...
const ACCENT = "#b45309";
const MODULE = "Punch List";
const PAGE = "Assign &amp; Due";
const KPIS = [{"l":"Total Punch List","v":"2.194","t":"+2.2%","d":"up"},{"l":"Assign & Due Ativos","v":"3.223","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"91.0%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"56","t":"+8.7%","d":"up"}];
const COLS = ["ID","Assign & Due","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Punch List #001","Punch List #002","3.611","2.744","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Punch List #002","Punch List #003","2.860","4.424","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Punch List #003","Punch List #004","436","6.538","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Punch List #004","Punch List #005","7.004","1.546","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Punch List #005","Punch List #001","8.480","5.202","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":725},{"label":"Mar","value":841},{"label":"Abr","value":945},{"label":"Mai","value":741},{"label":"Jun","value":977},{"label":"Jul","value":837},{"label":"Ago","value":812},{"label":"Set","value":677},{"label":"Out","value":857},{"label":"Nov","value":763},{"label":"Dez","value":759}];
const MX = 977;
