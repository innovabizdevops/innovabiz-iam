...
/* ═══ NEURA Continuous Learning — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "5713", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1256", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€312K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "-21%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2123971413", cells: ["NEU-8413", "NEURA Continuous Learning Item 1", "26/10/2026", "€21 513"], status: "active" as const },
    { id: "2123974984", cells: ["NEU-2984", "NEURA Continuous Learning Item 2", "13/5/2026", "€25 084"], status: "pending" as const },
    { id: "2123978555", cells: ["NEU-6555", "NEURA Continuous Learning Item 3", "28/12/2026", "€28 655"], status: "completed" as const },
    { id: "2123982126", cells: ["NEU-1126", "NEURA Continuous Learning Item 4", "15/7/2026", "€32 226"], status: "warning" as const },
    { id: "2123985697", cells: ["NEU-4697", "NEURA Continuous Learning Item 5", "2/2/2026", "€35 797"], status: "active" as const },
];
...
export default function NeuraContinuousLearningPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">NEURA Continuous Learning</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • NEURA Continuous Learning</p>
                    </div>
                </div>
