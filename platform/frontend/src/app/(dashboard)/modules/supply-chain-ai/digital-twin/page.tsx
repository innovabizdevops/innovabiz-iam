...
const ACCENT = "#b45309";
const MODULE = "Supply Chain AI";
const PAGE = "Digital Twin SC";
const KPIS = [{"l":"Twins Ativos","v":"3.968","t":"+12.6%","d":"up"},{"l":"Simulações/Dia","v":"233","t":"+9.0%","d":"up"},{"l":"Precisão Modelo (%)","v":"69.9%","t":"+2.6%","d":"up"},{"l":"Latência Sync (ms)","v":"164ms","t":"+15.7%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","87.2%","2026-03-10","7.074","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","85.9%","2026-02-11","158","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","94.0%","2026-01-01","8.150","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","95.2%","2026-01-27","5.447","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","89.3%","2026-03-14","8.754","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":860},{"label":"Fev","value":739},{"label":"Mar","value":883},{"label":"Abr","value":857},{"label":"Mai","value":606},{"label":"Jun","value":614},{"label":"Jul","value":850},{"label":"Ago","value":618},{"label":"Set","value":890},{"label":"Out","value":540},{"label":"Nov","value":758},{"label":"Dez","value":571}];
const MX = 890;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b45309'}}>DT</span></h1>
                </div>
