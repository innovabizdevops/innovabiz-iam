...
const PAGE = "Risk Prediction";
const KPIS = [{"l":"Riscos Identificados","v":"3.742","t":"+5.8%","d":"up"},{"l":"Mitigações Ativas","v":"5.143","t":"+7.7%","d":"up"},{"l":"Score Risco Geral","v":"58","t":"+11.8%","d":"up"},{"l":"Incidentes YTD","v":"7.413","t":"-2.7%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.418","3.873","3.892","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","165","5.129","4.610","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.890","5.873","4.388","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.868","2.751","6.317","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.693","2.308","2.249","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":732},{"label":"Mar","value":639},{"label":"Abr","value":543},{"label":"Mai","value":701},{"label":"Jun","value":717},{"label":"Jul","value":560},{"label":"Ago","value":706},{"label":"Set","value":734},{"label":"Out","value":883},{"label":"Nov","value":589},{"label":"Dez","value":647}];
const MX = 883;
