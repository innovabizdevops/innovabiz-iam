...
const PAGE = "Nearshoring Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"6.811","t":"+2.6%","d":"up"},{"l":"Queries/Dia","v":"4517","t":"-1.2%","d":"down"},{"l":"Dados Processados (GB)","v":"2.785","t":"+2.4%","d":"up"},{"l":"Utilizadores Analytics","v":"1.123","t":"+4.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3515","2026-01-09","1.194","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","617","2026-02-02","3.620","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1159","2026-03-18","4.193","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4087","2026-03-09","8.349","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3452","2026-02-17","8.697","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":639},{"label":"Mar","value":659},{"label":"Abr","value":638},{"label":"Mai","value":747},{"label":"Jun","value":602},{"label":"Jul","value":647},{"label":"Ago","value":409},{"label":"Set","value":599},{"label":"Out","value":723},{"label":"Nov","value":704},{"label":"Dez","value":498}];
const MX = 747;
