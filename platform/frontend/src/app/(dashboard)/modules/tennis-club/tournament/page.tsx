...
const KPIS = [{"l":"Atletas Registados","v":"5.970","t":"+3.3%","d":"up"},{"l":"Treinos/Semana","v":"3037","t":"+6.5%","d":"up"},{"l":"Competições","v":"2.974","t":"+4.6%","d":"up"},{"l":"Performance Score","v":"57","t":"+14.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.972","2.831","837","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.992","8.568","2.135","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.880","6.711","1.870","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.632","3.627","5.537","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","725","4.659","7.999","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":593},{"label":"Mar","value":903},{"label":"Abr","value":775},{"label":"Mai","value":577},{"label":"Jun","value":804},{"label":"Jul","value":700},{"label":"Ago","value":597},{"label":"Set","value":786},{"label":"Out","value":788},{"label":"Nov","value":574},{"label":"Dez","value":914}];
const MX = 914;
