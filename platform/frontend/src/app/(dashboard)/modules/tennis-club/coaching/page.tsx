...
const ACCENT = "#166534";
const MODULE = "Tennis Club Mgmt";
const PAGE = "Coaching";
const KPIS = [{"l":"Total Tennis Club","v":"1.798","t":"+8.9%","d":"up"},{"l":"Coaching Ativos","v":"102","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"71.2%","t":"+5.0%","d":"up"},{"l":"Score Performance","v":"64","t":"+9.9%","d":"up"}];
const COLS = ["ID","Coaching","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tennis Club #001","Tennis Club #002","3.731","1.319","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Tennis Club #002","Tennis Club #003","2.725","6.825","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Tennis Club #003","Tennis Club #004","2.117","6.277","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Tennis Club #004","Tennis Club #005","6.876","7.905","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tennis Club #005","Tennis Club #001","6.931","7.644","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":637},{"label":"Mar","value":656},{"label":"Abr","value":888},{"label":"Mai","value":660},{"label":"Jun","value":601},{"label":"Jul","value":551},{"label":"Ago","value":628},{"label":"Set","value":663},{"label":"Out","value":809},{"label":"Nov","value":602},{"label":"Dez","value":751}];
const MX = 888;
