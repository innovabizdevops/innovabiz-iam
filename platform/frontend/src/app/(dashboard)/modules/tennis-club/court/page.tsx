...
const PAGE = "Court";
const KPIS = [{"l":"Total Tennis Club","v":"6.928","t":"+9.8%","d":"up"},{"l":"Court Ativos","v":"7.006","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"84.1%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"93","t":"+10.3%","d":"up"}];
const COLS = ["ID","Court","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tennis Club #001","Tennis Club #002","4.460","2.416","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Tennis Club #002","Tennis Club #003","7.000","7.044","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Tennis Club #003","Tennis Club #004","215","8.630","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Tennis Club #004","Tennis Club #005","1.869","1.466","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tennis Club #005","Tennis Club #001","6.686","6.212","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":555},{"label":"Mar","value":865},{"label":"Abr","value":647},{"label":"Mai","value":718},{"label":"Jun","value":644},{"label":"Jul","value":610},{"label":"Ago","value":602},{"label":"Set","value":591},{"label":"Out","value":590},{"label":"Nov","value":749},{"label":"Dez","value":609}];
const MX = 865;
