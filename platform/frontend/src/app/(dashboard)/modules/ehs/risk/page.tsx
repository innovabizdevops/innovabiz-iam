...
const KPIS = [{"l":"Riscos Identificados","v":"3.021","t":"-0.7%","d":"down"},{"l":"Mitigações Ativas","v":"4.462","t":"+14.5%","d":"up"},{"l":"Score Risco Geral","v":"57","t":"-1.6%","d":"down"},{"l":"Incidentes YTD","v":"3.552","t":"+14.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.394","5.402","6.373","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.180","6.753","5.367","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.525","2.295","969","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.694","1.494","8.036","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.815","675","6.288","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":818},{"label":"Mar","value":654},{"label":"Abr","value":946},{"label":"Mai","value":944},{"label":"Jun","value":588},{"label":"Jul","value":945},{"label":"Ago","value":675},{"label":"Set","value":741},{"label":"Out","value":875},{"label":"Nov","value":597},{"label":"Dez","value":650}];
const MX = 946;
