...
const PAGE = "Occupational Health";
const KPIS = [{"l":"Incidentes (YTD)","v":"4.190","t":"-1.3%","d":"down"},{"l":"LTIR","v":"8.525","t":"+7.6%","d":"up"},{"l":"Formações HSE","v":"8.156","t":"+16.5%","d":"up"},{"l":"Inspeções Realizadas","v":"520","t":"+17.0%","d":"up"}];
const COLS = ["Incidente","Local","Tipo","Gravidade","Investigador","Estado"];
const ROWS = [{"id":"r0","cells":["EHS-INC-4521","EHS-NM-3214","6.804","2.215","1.316","Ativo"],"status":"active"},{"id":"r1","cells":["EHS-NM-3214","EHS-INSP-7891","2.015","5.671","2.307","Pendente"],"status":"pending"},{"id":"r2","cells":["EHS-INSP-7891","EHS-FORM-1098","6.080","1.152","4.544","Concluído"],"status":"done"},{"id":"r3","cells":["EHS-FORM-1098","EHS-AUD-5623","3.737","3.225","472","Em Análise"],"status":"risk"},{"id":"r4","cells":["EHS-AUD-5623","EHS-INC-4521","6.013","8.735","2.099","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":677},{"label":"Mar","value":967},{"label":"Abr","value":841},{"label":"Mai","value":916},{"label":"Jun","value":830},{"label":"Jul","value":748},{"label":"Ago","value":906},{"label":"Set","value":699},{"label":"Out","value":1028},{"label":"Nov","value":651},{"label":"Dez","value":758}];
const MX = 1028;
...
export default function HealthEhsPage() {
    return (
