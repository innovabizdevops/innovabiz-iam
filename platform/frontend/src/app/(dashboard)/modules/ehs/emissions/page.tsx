...
const PAGE = "Emissions Tracking";
const KPIS = [{"l":"Incidentes (YTD)","v":"1.188","t":"+11.8%","d":"up"},{"l":"LTIR","v":"1.306","t":"+0.7%","d":"up"},{"l":"Formações HSE","v":"7.939","t":"+4.2%","d":"up"},{"l":"Inspeções Realizadas","v":"7.492","t":"+17.8%","d":"up"}];
const COLS = ["Incidente","Local","Tipo","Gravidade","Investigador","Estado"];
const ROWS = [{"id":"r0","cells":["EHS-INC-4521","EHS-NM-3214","7.487","3.731","7.404","Ativo"],"status":"active"},{"id":"r1","cells":["EHS-NM-3214","EHS-INSP-7891","4.625","7.341","6.685","Pendente"],"status":"pending"},{"id":"r2","cells":["EHS-INSP-7891","EHS-FORM-1098","3.841","4.400","6.179","Concluído"],"status":"done"},{"id":"r3","cells":["EHS-FORM-1098","EHS-AUD-5623","6.200","7.610","4.766","Em Análise"],"status":"risk"},{"id":"r4","cells":["EHS-AUD-5623","EHS-INC-4521","5.584","1.998","4.390","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":591},{"label":"Mar","value":873},{"label":"Abr","value":892},{"label":"Mai","value":712},{"label":"Jun","value":668},{"label":"Jul","value":959},{"label":"Ago","value":803},{"label":"Set","value":798},{"label":"Out","value":878},{"label":"Nov","value":877},{"label":"Dez","value":709}];
const MX = 959;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#65a30d'}}>ESG</span></h1>
                </div>
