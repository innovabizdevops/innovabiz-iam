...
const PAGE = "ISO 45001 OHS";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.661","t":"+5.6%","d":"up"},{"l":"NC Abertas","v":"5.924","t":"-3.2%","d":"down"},{"l":"Conformidade (%)","v":"72.9%","t":"+8.7%","d":"up"},{"l":"CAPAs Pendentes","v":"7.366","t":"+9.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.886","90.7%","4.216","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","514","95.5%","4.095","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.515","94.7%","8.290","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.368","75.7%","2.903","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.135","85.0%","7.340","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":404},{"label":"Fev","value":497},{"label":"Mar","value":672},{"label":"Abr","value":548},{"label":"Mai","value":667},{"label":"Jun","value":398},{"label":"Jul","value":495},{"label":"Ago","value":704},{"label":"Set","value":724},{"label":"Out","value":502},{"label":"Nov","value":681},{"label":"Dez","value":469}];
const MX = 724;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#65a30d'}}>ISO</span></h1>
                </div>
