...
const PAGE = "OSHA Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.193","t":"-3.9%","d":"down"},{"l":"NC Abertas","v":"7.559","t":"+1.0%","d":"up"},{"l":"Conformidade (%)","v":"74.3%","t":"+7.8%","d":"up"},{"l":"CAPAs Pendentes","v":"1.348","t":"+1.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.271","88.9%","712","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.146","78.0%","8.441","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.856","87.7%","5.845","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.224","92.9%","8.685","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.331","80.1%","7.579","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":287},{"label":"Fev","value":550},{"label":"Mar","value":393},{"label":"Abr","value":289},{"label":"Mai","value":405},{"label":"Jun","value":259},{"label":"Jul","value":475},{"label":"Ago","value":501},{"label":"Set","value":244},{"label":"Out","value":319},{"label":"Nov","value":319},{"label":"Dez","value":492}];
const MX = 550;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#65a30d'}}>OSHA</span></h1>
                </div>
