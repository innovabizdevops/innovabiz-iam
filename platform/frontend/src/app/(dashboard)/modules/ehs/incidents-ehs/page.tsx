...
const PAGE = "Incident Reporting";
const KPIS = [{"l":"Tickets Abertos","v":"3.462","t":"+5.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"66.7%","t":"-2.0%","d":"down"},{"l":"MTTR (h)","v":"157h","t":"+6.1%","d":"up"},{"l":"Satisfação (%)","v":"92.1%","t":"+14.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.590","1.425","728","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.336","6.614","2.578","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.923","5.940","4.702","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.093","688","6.055","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.787","3.672","2.523","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":979},{"label":"Fev","value":741},{"label":"Mar","value":1059},{"label":"Abr","value":750},{"label":"Mai","value":996},{"label":"Jun","value":1066},{"label":"Jul","value":947},{"label":"Ago","value":827},{"label":"Set","value":872},{"label":"Out","value":727},{"label":"Nov","value":971},{"label":"Dez","value":787}];
const MX = 1066;
...
export default function IncidentsEhsPage() {
    return (
