...
const PAGE = "Permit to Work";
const KPIS = [{"l":"Riscos Identificados","v":"5.249","t":"+6.4%","d":"up"},{"l":"Mitigações Ativas","v":"6.742","t":"+11.9%","d":"up"},{"l":"Score Risco Geral","v":"92","t":"+12.2%","d":"up"},{"l":"Incidentes YTD","v":"8.807","t":"+15.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.652","6.849","6.139","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.951","6.720","3.881","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.262","2.540","4.658","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","447","3.598","6.745","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.664","513","6.586","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":422},{"label":"Fev","value":621},{"label":"Mar","value":598},{"label":"Abr","value":462},{"label":"Mai","value":619},{"label":"Jun","value":438},{"label":"Jul","value":685},{"label":"Ago","value":591},{"label":"Set","value":539},{"label":"Out","value":538},{"label":"Nov","value":615},{"label":"Dez","value":526}];
const MX = 685;
