...
const PAGE = "Health &amp; Environment";
const KPIS = [{"l":"Incidentes (YTD)","v":"2.580","t":"+1.7%","d":"up"},{"l":"LTIR","v":"579","t":"+12.1%","d":"up"},{"l":"Formações HSE","v":"1.083","t":"+7.1%","d":"up"},{"l":"Inspeções Realizadas","v":"5.862","t":"+0.9%","d":"up"}];
const COLS = ["Incidente","Local","Tipo","Gravidade","Investigador","Estado"];
const ROWS = [{"id":"r0","cells":["EHS-INC-4521","EHS-NM-3214","746","7.569","5.537","Ativo"],"status":"active"},{"id":"r1","cells":["EHS-NM-3214","EHS-INSP-7891","3.215","5.834","7.853","Pendente"],"status":"pending"},{"id":"r2","cells":["EHS-INSP-7891","EHS-FORM-1098","8.800","264","6.278","Concluído"],"status":"done"},{"id":"r3","cells":["EHS-FORM-1098","EHS-AUD-5623","2.088","2.381","462","Em Análise"],"status":"risk"},{"id":"r4","cells":["EHS-AUD-5623","EHS-INC-4521","679","5.909","5.959","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":341},{"label":"Mar","value":480},{"label":"Abr","value":604},{"label":"Mai","value":621},{"label":"Jun","value":512},{"label":"Jul","value":457},{"label":"Ago","value":512},{"label":"Set","value":406},{"label":"Out","value":452},{"label":"Nov","value":601},{"label":"Dez","value":602}];
const MX = 621;
