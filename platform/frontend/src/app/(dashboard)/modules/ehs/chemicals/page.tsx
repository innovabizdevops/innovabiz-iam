...
const PAGE = "Chemical Mgmt";
const KPIS = [{"l":"Incidentes (YTD)","v":"1.794","t":"+1.6%","d":"up"},{"l":"LTIR","v":"8.699","t":"+9.8%","d":"up"},{"l":"Formações HSE","v":"5.486","t":"+1.2%","d":"up"},{"l":"Inspeções Realizadas","v":"2.777","t":"+11.8%","d":"up"}];
const COLS = ["Incidente","Local","Tipo","Gravidade","Investigador","Estado"];
const ROWS = [{"id":"r0","cells":["EHS-INC-4521","EHS-NM-3214","7.508","3.612","6.635","Ativo"],"status":"active"},{"id":"r1","cells":["EHS-NM-3214","EHS-INSP-7891","1.001","2.122","2.591","Pendente"],"status":"pending"},{"id":"r2","cells":["EHS-INSP-7891","EHS-FORM-1098","2.684","3.039","4.943","Concluído"],"status":"done"},{"id":"r3","cells":["EHS-FORM-1098","EHS-AUD-5623","3.113","2.000","1.783","Em Análise"],"status":"risk"},{"id":"r4","cells":["EHS-AUD-5623","EHS-INC-4521","283","133","8.551","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":546},{"label":"Mar","value":814},{"label":"Abr","value":741},{"label":"Mai","value":802},{"label":"Jun","value":599},{"label":"Jul","value":533},{"label":"Ago","value":596},{"label":"Set","value":813},{"label":"Out","value":471},{"label":"Nov","value":667},{"label":"Dez","value":704}];
const MX = 814;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#65a30d'}}>REACH</span></h1>
                </div>
