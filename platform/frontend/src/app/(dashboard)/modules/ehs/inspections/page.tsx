...
const PAGE = "Safety Inspections";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.051","t":"+17.2%","d":"up"},{"l":"NC Abertas","v":"1.690","t":"-0.5%","d":"down"},{"l":"Conformidade (%)","v":"73.0%","t":"+17.7%","d":"up"},{"l":"CAPAs Pendentes","v":"5.417","t":"+15.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.698","75.0%","145","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.472","97.0%","4.544","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.699","86.3%","8.388","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.710","95.2%","1.036","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.889","88.9%","3.076","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":735},{"label":"Mar","value":618},{"label":"Abr","value":639},{"label":"Mai","value":623},{"label":"Jun","value":816},{"label":"Jul","value":676},{"label":"Ago","value":738},{"label":"Set","value":786},{"label":"Out","value":660},{"label":"Nov","value":911},{"label":"Dez","value":757}];
const MX = 911;
