...
const PAGE = "COSHH Assessment";
const KPIS = [{"l":"Incidentes (YTD)","v":"8.785","t":"+5.8%","d":"up"},{"l":"LTIR","v":"8.255","t":"+10.6%","d":"up"},{"l":"Formações HSE","v":"8.888","t":"+17.1%","d":"up"},{"l":"Inspeções Realizadas","v":"1.312","t":"-2.1%","d":"down"}];
const COLS = ["Incidente","Local","Tipo","Gravidade","Investigador","Estado"];
const ROWS = [{"id":"r0","cells":["EHS-INC-4521","EHS-NM-3214","8.041","5.098","6.306","Ativo"],"status":"active"},{"id":"r1","cells":["EHS-NM-3214","EHS-INSP-7891","3.075","5.838","1.847","Pendente"],"status":"pending"},{"id":"r2","cells":["EHS-INSP-7891","EHS-FORM-1098","7.957","8.147","8.010","Concluído"],"status":"done"},{"id":"r3","cells":["EHS-FORM-1098","EHS-AUD-5623","8.017","6.139","1.534","Em Análise"],"status":"risk"},{"id":"r4","cells":["EHS-AUD-5623","EHS-INC-4521","8.912","6.254","7.572","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":546},{"label":"Mar","value":521},{"label":"Abr","value":269},{"label":"Mai","value":579},{"label":"Jun","value":577},{"label":"Jul","value":501},{"label":"Ago","value":338},{"label":"Set","value":380},{"label":"Out","value":569},{"label":"Nov","value":549},{"label":"Dez","value":346}];
const MX = 579;
