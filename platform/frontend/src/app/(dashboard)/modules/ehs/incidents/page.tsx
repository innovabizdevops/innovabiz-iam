...
const KPIS = [{"l":"Tickets Abertos","v":"2.520","t":"+17.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"76.6%","t":"+16.0%","d":"up"},{"l":"MTTR (h)","v":"94h","t":"+8.2%","d":"up"},{"l":"Satisfação (%)","v":"72.2%","t":"+15.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.825","5.662","492","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.351","1.603","6.074","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.627","2.350","7.250","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.579","4.251","941","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","343","4.050","1.033","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":731},{"label":"Mar","value":750},{"label":"Abr","value":449},{"label":"Mai","value":704},{"label":"Jun","value":547},{"label":"Jul","value":689},{"label":"Ago","value":617},{"label":"Set","value":616},{"label":"Out","value":793},{"label":"Nov","value":519},{"label":"Dez","value":539}];
const MX = 793;
