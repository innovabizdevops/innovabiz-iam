...
const ACCENT = "#65a30d";
const MODULE = "Environment Health & Safety";
const PAGE = "EHS Analytics AI";
const KPIS = [{"l":"Dashboards Ativos","v":"3.590","t":"+13.2%","d":"up"},{"l":"Queries/Dia","v":"1122","t":"+5.3%","d":"up"},{"l":"Dados Processados (GB)","v":"8.438","t":"+6.2%","d":"up"},{"l":"Utilizadores Analytics","v":"893","t":"+12.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2734","2026-02-07","6.296","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3524","2026-01-12","1.939","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2997","2026-03-15","4.369","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4268","2026-01-19","4.381","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1777","2026-01-10","2.884","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":415},{"label":"Fev","value":566},{"label":"Mar","value":436},{"label":"Abr","value":312},{"label":"Mai","value":563},{"label":"Jun","value":408},{"label":"Jul","value":593},{"label":"Ago","value":319},{"label":"Set","value":659},{"label":"Out","value":606},{"label":"Nov","value":398},{"label":"Dez","value":636}];
const MX = 659;
