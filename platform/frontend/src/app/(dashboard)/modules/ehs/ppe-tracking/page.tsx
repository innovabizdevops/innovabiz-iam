...
const PAGE = "PPE Tracking";
const KPIS = [{"l":"Incidentes (YTD)","v":"8.642","t":"-5.7%","d":"down"},{"l":"LTIR","v":"3.236","t":"+14.3%","d":"up"},{"l":"Formações HSE","v":"5.237","t":"+3.6%","d":"up"},{"l":"Inspeções Realizadas","v":"3.152","t":"-1.0%","d":"down"}];
const COLS = ["Incidente","Local","Tipo","Gravidade","Investigador","Estado"];
const ROWS = [{"id":"r0","cells":["EHS-INC-4521","EHS-NM-3214","7.541","4.265","6.609","Ativo"],"status":"active"},{"id":"r1","cells":["EHS-NM-3214","EHS-INSP-7891","1.769","2.608","8.487","Pendente"],"status":"pending"},{"id":"r2","cells":["EHS-INSP-7891","EHS-FORM-1098","7.500","1.194","169","Concluído"],"status":"done"},{"id":"r3","cells":["EHS-FORM-1098","EHS-AUD-5623","927","3.701","4.499","Em Análise"],"status":"risk"},{"id":"r4","cells":["EHS-AUD-5623","EHS-INC-4521","2.173","5.673","1.481","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":368},{"label":"Mar","value":345},{"label":"Abr","value":307},{"label":"Mai","value":240},{"label":"Jun","value":235},{"label":"Jul","value":543},{"label":"Ago","value":439},{"label":"Set","value":507},{"label":"Out","value":410},{"label":"Nov","value":224},{"label":"Dez","value":332}];
const MX = 543;
