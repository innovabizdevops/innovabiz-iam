...
const ACCENT = "#0284c7";
const MODULE = "SC: Core Queue Manager";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Sc Core Queue","v":"936","t":"-2.8%","d":"down"},{"l":"Monitor Ativos","v":"2.354","t":"+2.7%","d":"up"},{"l":"Eficiência (%)","v":"72.5%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"89","t":"+16.1%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Queue #001","Sc Core Queue #002","6.686","7.447","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Queue #002","Sc Core Queue #003","2.249","941","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Queue #003","Sc Core Queue #004","1.816","6.124","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Queue #004","Sc Core Queue #005","7.355","1.108","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Queue #005","Sc Core Queue #001","1.570","4.473","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":292},{"label":"Fev","value":403},{"label":"Mar","value":515},{"label":"Abr","value":403},{"label":"Mai","value":523},{"label":"Jun","value":331},{"label":"Jul","value":355},{"label":"Ago","value":571},{"label":"Set","value":535},{"label":"Out","value":635},{"label":"Nov","value":592},{"label":"Dez","value":614}];
const MX = 635;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0284c7'}}>RTM</span></h1>
                </div>
