...
const PAGE = "Process";
const KPIS = [{"l":"Total Sc Core Queue","v":"2.508","t":"+10.6%","d":"up"},{"l":"Process Ativos","v":"5.701","t":"+0.4%","d":"up"},{"l":"Eficiência (%)","v":"87.5%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"94","t":"+3.4%","d":"up"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Queue #001","Sc Core Queue #002","861","158","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Queue #002","Sc Core Queue #003","3.050","5.487","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Queue #003","Sc Core Queue #004","5.266","5.876","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Queue #004","Sc Core Queue #005","1.631","3.154","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Queue #005","Sc Core Queue #001","915","8.054","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":908},{"label":"Fev","value":797},{"label":"Mar","value":930},{"label":"Abr","value":678},{"label":"Mai","value":842},{"label":"Jun","value":683},{"label":"Jul","value":721},{"label":"Ago","value":714},{"label":"Set","value":857},{"label":"Out","value":699},{"label":"Nov","value":961},{"label":"Dez","value":785}];
const MX = 961;
