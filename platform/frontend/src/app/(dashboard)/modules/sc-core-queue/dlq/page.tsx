...
const PAGE = "DLQ";
const KPIS = [{"l":"Total Sc Core Queue","v":"1.318","t":"-3.0%","d":"down"},{"l":"DLQ Ativos","v":"7.748","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"86.1%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"77","t":"-3.0%","d":"down"}];
const COLS = ["ID","DLQ","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Queue #001","Sc Core Queue #002","6.332","7.838","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Queue #002","Sc Core Queue #003","4.760","7.758","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Queue #003","Sc Core Queue #004","5.567","7.744","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Queue #004","Sc Core Queue #005","2.286","4.953","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Queue #005","Sc Core Queue #001","8.734","6.515","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":640},{"label":"Mar","value":833},{"label":"Abr","value":502},{"label":"Mai","value":855},{"label":"Jun","value":632},{"label":"Jul","value":685},{"label":"Ago","value":740},{"label":"Set","value":676},{"label":"Out","value":883},{"label":"Nov","value":558},{"label":"Dez","value":550}];
const MX = 883;
