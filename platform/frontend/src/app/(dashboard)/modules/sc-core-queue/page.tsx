...
/* ═══ SC: Core Queue Manager — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "2129", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4313", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€411K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1104059929", cells: ["SC-3929", "SC: Core Queue Manager Item 1", "22/2/2026", "€10 029"], status: "active" as const },
    { id: "1104063500", cells: ["SC-7500", "SC: Core Queue Manager Item 2", "9/9/2026", "€13 600"], status: "pending" as const },
    { id: "1104067071", cells: ["SC-2071", "SC: Core Queue Manager Item 3", "24/4/2026", "€17 171"], status: "completed" as const },
    { id: "1104070642", cells: ["SC-5642", "SC: Core Queue Manager Item 4", "11/11/2026", "€20 742"], status: "warning" as const },
    { id: "1104074213", cells: ["SC-9213", "SC: Core Queue Manager Item 5", "26/6/2026", "€24 313"], status: "active" as const },
];
...
export default function ScCoreQueueManagerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: Core Queue Manager</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: Core Queue Manager</p>
                    </div>
                </div>
