...
const PAGE = "Retry";
const KPIS = [{"l":"Total Sc Core Queue","v":"5.638","t":"+4.2%","d":"up"},{"l":"Retry Ativos","v":"5.616","t":"+15.9%","d":"up"},{"l":"Eficiência (%)","v":"83.7%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"84","t":"+4.4%","d":"up"}];
const COLS = ["ID","Retry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Queue #001","Sc Core Queue #002","7.436","7.865","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Queue #002","Sc Core Queue #003","985","7.331","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Queue #003","Sc Core Queue #004","6.607","5.762","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Queue #004","Sc Core Queue #005","6.910","6.078","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Queue #005","Sc Core Queue #001","9.015","8.450","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":845},{"label":"Mar","value":841},{"label":"Abr","value":666},{"label":"Mai","value":763},{"label":"Jun","value":838},{"label":"Jul","value":709},{"label":"Ago","value":857},{"label":"Set","value":509},{"label":"Out","value":779},{"label":"Nov","value":566},{"label":"Dez","value":591}];
const MX = 857;
