...
const PAGE = "Enqueue";
const KPIS = [{"l":"Total Sc Core Queue","v":"193","t":"+15.4%","d":"up"},{"l":"Enqueue Ativos","v":"2.206","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"79.2%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"71","t":"+15.6%","d":"up"}];
const COLS = ["ID","Enqueue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Queue #001","Sc Core Queue #002","2.171","8.513","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Queue #002","Sc Core Queue #003","7.434","4.959","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Queue #003","Sc Core Queue #004","890","2.175","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Queue #004","Sc Core Queue #005","5.089","3.006","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Queue #005","Sc Core Queue #001","4.600","1.625","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":724},{"label":"Mar","value":978},{"label":"Abr","value":966},{"label":"Mai","value":1023},{"label":"Jun","value":928},{"label":"Jul","value":699},{"label":"Ago","value":836},{"label":"Set","value":750},{"label":"Out","value":841},{"label":"Nov","value":997},{"label":"Dez","value":753}];
const MX = 1023;
