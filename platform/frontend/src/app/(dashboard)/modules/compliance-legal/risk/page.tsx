...
const ACCENT = "#6366f1";
const MODULE = "Legal Compliance";
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"1.312","t":"+7.8%","d":"up"},{"l":"Mitigações Ativas","v":"7.637","t":"+14.3%","d":"up"},{"l":"Score Risco Geral","v":"90","t":"+15.6%","d":"up"},{"l":"Incidentes YTD","v":"8.826","t":"-1.1%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.584","691","7.555","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.665","8.266","1.053","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.567","1.012","8.777","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.845","6.097","1.755","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.595","8.678","8.836","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":771},{"label":"Fev","value":619},{"label":"Mar","value":673},{"label":"Abr","value":935},{"label":"Mai","value":716},{"label":"Jun","value":867},{"label":"Jul","value":837},{"label":"Ago","value":710},{"label":"Set","value":720},{"label":"Out","value":928},{"label":"Nov","value":728},{"label":"Dez","value":819}];
const MX = 935;
