...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.771","t":"-6.0%","d":"down"},{"l":"NC Abertas","v":"5.058","t":"+15.9%","d":"up"},{"l":"Conformidade (%)","v":"81.1%","t":"-2.4%","d":"down"},{"l":"CAPAs Pendentes","v":"7.755","t":"-3.1%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.176","78.7%","4.291","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.276","72.9%","6.365","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","9.037","98.8%","5.022","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.309","70.8%","5.067","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.820","80.5%","3.476","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":873},{"label":"Fev","value":1032},{"label":"Mar","value":1046},{"label":"Abr","value":790},{"label":"Mai","value":844},{"label":"Jun","value":1041},{"label":"Jul","value":972},{"label":"Ago","value":714},{"label":"Set","value":988},{"label":"Out","value":1009},{"label":"Nov","value":1045},{"label":"Dez","value":980}];
const MX = 1046;
