...
const KPIS = [{"l":"Auditorias Realizadas","v":"8.510","t":"+13.7%","d":"up"},{"l":"NC Abertas","v":"2.141","t":"-5.4%","d":"down"},{"l":"Conformidade (%)","v":"67.2%","t":"+13.4%","d":"up"},{"l":"CAPAs Pendentes","v":"441","t":"+14.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.797","89.6%","9.040","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.853","91.3%","6.358","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.391","90.8%","5.923","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.757","71.5%","1.495","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.790","90.4%","3.466","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":897},{"label":"Mar","value":607},{"label":"Abr","value":972},{"label":"Mai","value":783},{"label":"Jun","value":889},{"label":"Jul","value":955},{"label":"Ago","value":777},{"label":"Set","value":909},{"label":"Out","value":648},{"label":"Nov","value":877},{"label":"Dez","value":636}];
const MX = 972;
