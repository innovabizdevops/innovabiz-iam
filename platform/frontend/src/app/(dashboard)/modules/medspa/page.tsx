...
/* ═══ Medical Spa (MedSpa) — Dashboard ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total Registos", value: "5473", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2403", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€387K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "-6%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "797895873", cells: ["MED-1873", "Medical Spa (MedSpa) Item 1", "6/10/2026", "€45 973"], status: "active" as const },
    { id: "797899444", cells: ["MED-5444", "Medical Spa (MedSpa) Item 2", "21/5/2026", "€49 544"], status: "pending" as const },
    { id: "797903015", cells: ["MED-9015", "Medical Spa (MedSpa) Item 3", "8/12/2026", "€3115"], status: "completed" as const },
    { id: "797906586", cells: ["MED-3586", "Medical Spa (MedSpa) Item 4", "23/7/2026", "€6686"], status: "warning" as const },
    { id: "797910157", cells: ["MED-7157", "Medical Spa (MedSpa) Item 5", "10/2/2026", "€10 257"], status: "active" as const },
];
...
export default function MedicalSpaMedspaPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Medical Spa (MedSpa)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Medical Spa (MedSpa)</p>
                    </div>
                </div>
