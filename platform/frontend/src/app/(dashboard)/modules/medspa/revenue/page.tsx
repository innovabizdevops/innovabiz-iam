...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€44.5M","t":"+15.6%","d":"up"},{"l":"MRR (€)","v":"€16422","t":"+1.2%","d":"up"},{"l":"Churn (%)","v":"80.5%","t":"+11.8%","d":"up"},{"l":"ARPU (€)","v":"€97906","t":"-1.2%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 38833.44","3.091","€ 17809.02","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 22930.82","3.275","€ 5708.07","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 7073.20","5.626","€ 6607.59","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 38692.46","7.460","€ 32496.16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 1881.70","2.070","€ 45574.13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":922},{"label":"Mar","value":791},{"label":"Abr","value":826},{"label":"Mai","value":710},{"label":"Jun","value":671},{"label":"Jul","value":659},{"label":"Ago","value":786},{"label":"Set","value":691},{"label":"Out","value":746},{"label":"Nov","value":889},{"label":"Dez","value":596}];
const MX = 922;
