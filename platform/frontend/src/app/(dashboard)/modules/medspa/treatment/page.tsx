...
const KPIS = [{"l":"Quartos Ocupados","v":"6.896","t":"+0.5%","d":"up"},{"l":"RevPAR (€)","v":"€68731","t":"+10.4%","d":"up"},{"l":"Ocupação (%)","v":"77.3%","t":"+16.6%","d":"up"},{"l":"Guest Satisfaction","v":"328","t":"-1.0%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","1.431","2026-02-23","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.363","2026-02-03","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.635","2026-03-16","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.966","2026-01-15","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.188","2026-01-08","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":905},{"label":"Fev","value":982},{"label":"Mar","value":775},{"label":"Abr","value":725},{"label":"Mai","value":787},{"label":"Jun","value":802},{"label":"Jul","value":625},{"label":"Ago","value":959},{"label":"Set","value":827},{"label":"Out","value":930},{"label":"Nov","value":647},{"label":"Dez","value":992}];
const MX = 992;
