...
const PAGE = "Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"195","t":"+1.3%","d":"up"},{"l":"RevPAR (€)","v":"€63955","t":"-0.1%","d":"down"},{"l":"Ocupação (%)","v":"69.4%","t":"+8.2%","d":"up"},{"l":"Guest Satisfaction","v":"3.743","t":"+8.2%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.772","2026-03-24","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","5.985","2026-03-09","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.352","2026-02-16","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.651","2026-01-05","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.794","2026-02-12","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":479},{"label":"Mar","value":395},{"label":"Abr","value":504},{"label":"Mai","value":511},{"label":"Jun","value":531},{"label":"Jul","value":539},{"label":"Ago","value":590},{"label":"Set","value":449},{"label":"Out","value":403},{"label":"Nov","value":690},{"label":"Dez","value":638}];
const MX = 690;
