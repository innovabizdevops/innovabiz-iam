...
const PAGE = "Laser";
const KPIS = [{"l":"Quartos Ocupados","v":"831","t":"-5.6%","d":"down"},{"l":"RevPAR (€)","v":"€83102","t":"+9.4%","d":"up"},{"l":"Ocupação (%)","v":"83.4%","t":"+4.1%","d":"up"},{"l":"Guest Satisfaction","v":"6.786","t":"-4.2%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","464","2026-03-03","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.482","2026-02-02","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.590","2026-01-02","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.870","2026-02-06","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.379","2026-03-01","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":848},{"label":"Mar","value":743},{"label":"Abr","value":1000},{"label":"Mai","value":973},{"label":"Jun","value":999},{"label":"Jul","value":1053},{"label":"Ago","value":954},{"label":"Set","value":863},{"label":"Out","value":855},{"label":"Nov","value":1066},{"label":"Dez","value":917}];
const MX = 1066;
