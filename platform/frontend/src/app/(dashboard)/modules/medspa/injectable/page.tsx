...
const ACCENT = "#db2777";
const MODULE = "Medical Spa (MedSpa)";
const PAGE = "Injectable";
const KPIS = [{"l":"Quartos Ocupados","v":"3.554","t":"-1.7%","d":"down"},{"l":"RevPAR (€)","v":"€5438","t":"+6.9%","d":"up"},{"l":"Ocupação (%)","v":"77.3%","t":"-2.4%","d":"down"},{"l":"Guest Satisfaction","v":"3.436","t":"-2.3%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.057","2026-01-02","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.929","2026-02-26","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.622","2026-01-27","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.063","2026-02-24","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.964","2026-03-14","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":757},{"label":"Mar","value":591},{"label":"Abr","value":697},{"label":"Mai","value":509},{"label":"Jun","value":502},{"label":"Jul","value":767},{"label":"Ago","value":694},{"label":"Set","value":645},{"label":"Out","value":723},{"label":"Nov","value":660},{"label":"Dez","value":536}];
const MX = 767;
...
export default function InjectablePage() {
    return (
