...
const PAGE = "Course Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"104","t":"+17.8%","d":"up"},{"l":"Queries/Dia","v":"230","t":"+15.1%","d":"up"},{"l":"Dados Processados (GB)","v":"8.437","t":"+6.4%","d":"up"},{"l":"Utilizadores Analytics","v":"7.106","t":"+9.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2634","2026-01-15","5.965","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3899","2026-03-15","1.241","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4148","2026-02-15","3.345","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3137","2026-01-16","7.932","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3813","2026-03-16","9.008","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":429},{"label":"Fev","value":427},{"label":"Mar","value":428},{"label":"Abr","value":418},{"label":"Mai","value":357},{"label":"Jun","value":379},{"label":"Jul","value":556},{"label":"Ago","value":739},{"label":"Set","value":510},{"label":"Out","value":576},{"label":"Nov","value":396},{"label":"Dez","value":531}];
const MX = 739;
