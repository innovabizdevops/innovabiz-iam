...
/* ═══ Defense Systems — Cyber Ops ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "4510", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "121", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2100", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2042607989", cells: ["DEF-4989", "Cyber Ops Item 1", "10/6/2026", "€8089"], status: "active" as const },
    { id: "2042611560", cells: ["DEF-8560", "Cyber Ops Item 2", "25/1/2026", "€11 660"], status: "pending" as const },
    { id: "2042615131", cells: ["DEF-3131", "Cyber Ops Item 3", "12/8/2026", "€15 231"], status: "completed" as const },
    { id: "2042618702", cells: ["DEF-6702", "Cyber Ops Item 4", "27/3/2026", "€18 802"], status: "warning" as const },
    { id: "2042622273", cells: ["DEF-1273", "Cyber Ops Item 5", "14/10/2026", "€22 373"], status: "active" as const },
];
...
export default function DefenseSystemsCyberOpsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cyber Ops</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Defense Systems • Cyber Ops</p>
                    </div>
                </div>
