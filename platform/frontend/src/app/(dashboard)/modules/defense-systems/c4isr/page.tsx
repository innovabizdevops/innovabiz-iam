...
/* ═══ Defense Systems — C4isr ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "3955", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "117", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3737", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "483569377", cells: ["DEF-9377", "C4isr Item 1", "26/2/2026", "€19 477"], status: "active" as const },
    { id: "483572948", cells: ["DEF-3948", "C4isr Item 2", "13/9/2026", "€23 048"], status: "pending" as const },
    { id: "483576519", cells: ["DEF-7519", "C4isr Item 3", "28/4/2026", "€26 619"], status: "completed" as const },
    { id: "483580090", cells: ["DEF-2090", "C4isr Item 4", "15/11/2026", "€30 190"], status: "warning" as const },
    { id: "483583661", cells: ["DEF-5661", "C4isr Item 5", "2/6/2026", "€33 761"], status: "active" as const },
];
...
export default function DefenseSystemsC4isrPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">C4isr</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Defense Systems • C4isr</p>
                    </div>
                </div>
