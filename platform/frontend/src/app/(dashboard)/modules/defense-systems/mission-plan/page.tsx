...
/* ═══ Defense Systems — Mission Plan ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "658", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "343", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2914", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1040516595", cells: ["DEF-9595", "Mission Plan Item 1", "28/4/2026", "€16 695"], status: "active" as const },
    { id: "1040520166", cells: ["DEF-4166", "Mission Plan Item 2", "15/11/2026", "€20 266"], status: "pending" as const },
    { id: "1040523737", cells: ["DEF-7737", "Mission Plan Item 3", "2/6/2026", "€23 837"], status: "completed" as const },
    { id: "1040527308", cells: ["DEF-2308", "Mission Plan Item 4", "17/1/2026", "€27 408"], status: "warning" as const },
    { id: "1040530879", cells: ["DEF-5879", "Mission Plan Item 5", "4/8/2026", "€30 979"], status: "active" as const },
];
...
export default function DefenseSystemsMissionPlanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mission Plan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Defense Systems • Mission Plan</p>
                    </div>
                </div>
