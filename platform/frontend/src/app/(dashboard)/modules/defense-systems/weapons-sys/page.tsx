...
/* ═══ Defense Systems — Weapons Sys ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "1789", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "370", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "255", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1602135438", cells: ["DEF-1438", "Weapons Sys Item 1", "23/7/2026", "€35 538"], status: "active" as const },
    { id: "1602139009", cells: ["DEF-5009", "Weapons Sys Item 2", "10/2/2026", "€39 109"], status: "pending" as const },
    { id: "1602142580", cells: ["DEF-8580", "Weapons Sys Item 3", "25/9/2026", "€42 680"], status: "completed" as const },
    { id: "1602146151", cells: ["DEF-3151", "Weapons Sys Item 4", "12/4/2026", "€46 251"], status: "warning" as const },
    { id: "1602149722", cells: ["DEF-6722", "Weapons Sys Item 5", "27/11/2026", "€49 822"], status: "active" as const },
];
...
export default function DefenseSystemsWeaponsSysPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Weapons Sys</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Defense Systems • Weapons Sys</p>
                    </div>
                </div>
