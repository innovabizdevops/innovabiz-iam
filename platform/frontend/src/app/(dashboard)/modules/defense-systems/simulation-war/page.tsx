...
/* ═══ Defense Systems — Simulation War ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "508", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "255", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1652", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1835115451", cells: ["DEF-7451", "Simulation War Item 1", "16/8/2026", "€15 551"], status: "active" as const },
    { id: "1835119022", cells: ["DEF-2022", "Simulation War Item 2", "3/3/2026", "€19 122"], status: "pending" as const },
    { id: "1835122593", cells: ["DEF-5593", "Simulation War Item 3", "18/10/2026", "€22 693"], status: "completed" as const },
    { id: "1835126164", cells: ["DEF-9164", "Simulation War Item 4", "5/5/2026", "€26 264"], status: "warning" as const },
    { id: "1835129735", cells: ["DEF-3735", "Simulation War Item 5", "20/12/2026", "€29 835"], status: "active" as const },
];
...
export default function DefenseSystemsSimulationWarPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Simulation War</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Defense Systems • Simulation War</p>
                    </div>
                </div>
