...
const KPIS = [
    { label: "Total", value: "1992", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "428", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1936", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1962217112", cells: ["DEF-2112", "Electronic Warfare Item 1", "17/9/2026", "€17 212"], status: "active" as const },
    { id: "1962220683", cells: ["DEF-5683", "Electronic Warfare Item 2", "4/4/2026", "€20 783"], status: "pending" as const },
    { id: "1962224254", cells: ["DEF-9254", "Electronic Warfare Item 3", "19/11/2026", "€24 354"], status: "completed" as const },
    { id: "1962227825", cells: ["DEF-3825", "Electronic Warfare Item 4", "6/6/2026", "€27 925"], status: "warning" as const },
    { id: "1962231396", cells: ["DEF-7396", "Electronic Warfare Item 5", "21/1/2026", "€31 496"], status: "active" as const },
];
...
export default function DefenseSystemsElectronicWarfarePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Electronic Warfare</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Defense Systems • Electronic Warfare</p>
                    </div>
                </div>
