...
/* ═══ Defense Systems — Readiness Report ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "1710", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "164", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "32", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2026103136", cells: ["DEF-6136", "Readiness Report Item 1", "9/1/2026", "€3236"], status: "active" as const },
    { id: "2026106707", cells: ["DEF-9707", "Readiness Report Item 2", "24/8/2026", "€6807"], status: "pending" as const },
    { id: "2026110278", cells: ["DEF-4278", "Readiness Report Item 3", "11/3/2026", "€10 378"], status: "completed" as const },
    { id: "2026113849", cells: ["DEF-7849", "Readiness Report Item 4", "26/10/2026", "€13 949"], status: "warning" as const },
    { id: "2026117420", cells: ["DEF-2420", "Readiness Report Item 5", "13/5/2026", "€17 520"], status: "active" as const },
];
...
export default function DefenseSystemsReadinessReportPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Readiness Report</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Defense Systems • Readiness Report</p>
                    </div>
                </div>
