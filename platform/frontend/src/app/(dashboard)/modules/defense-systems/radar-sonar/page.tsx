...
/* ═══ Defense Systems — Radar Sonar ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "2052", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "55", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "475", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1685527603", cells: ["DEF-8603", "Radar Sonar Item 1", "12/8/2026", "€27 703"], status: "active" as const },
    { id: "1685531174", cells: ["DEF-3174", "Radar Sonar Item 2", "27/3/2026", "€31 274"], status: "pending" as const },
    { id: "1685534745", cells: ["DEF-6745", "Radar Sonar Item 3", "14/10/2026", "€34 845"], status: "completed" as const },
    { id: "1685538316", cells: ["DEF-1316", "Radar Sonar Item 4", "1/5/2026", "€38 416"], status: "warning" as const },
    { id: "1685541887", cells: ["DEF-4887", "Radar Sonar Item 5", "16/12/2026", "€41 987"], status: "active" as const },
];
...
export default function DefenseSystemsRadarSonarPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Radar Sonar</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Defense Systems • Radar Sonar</p>
                    </div>
                </div>
