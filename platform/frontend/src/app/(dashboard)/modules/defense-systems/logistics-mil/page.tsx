...
/* ═══ Defense Systems — Logistics Mil ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "4833", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "497", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3257", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2052973773", cells: ["DEF-2773", "Logistics Mil Item 1", "26/10/2026", "€23 873"], status: "active" as const },
    { id: "2052977344", cells: ["DEF-6344", "Logistics Mil Item 2", "13/5/2026", "€27 444"], status: "pending" as const },
    { id: "2052980915", cells: ["DEF-9915", "Logistics Mil Item 3", "28/12/2026", "€31 015"], status: "completed" as const },
    { id: "2052984486", cells: ["DEF-4486", "Logistics Mil Item 4", "15/7/2026", "€34 586"], status: "warning" as const },
    { id: "2052988057", cells: ["DEF-8057", "Logistics Mil Item 5", "2/2/2026", "€38 157"], status: "active" as const },
];
...
export default function DefenseSystemsLogisticsMilPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Logistics Mil</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Defense Systems • Logistics Mil</p>
                    </div>
                </div>
