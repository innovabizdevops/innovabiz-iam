...
/* ═══ Defense Systems — Threat Assess Def ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "1137", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "253", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3932", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1414027321", cells: ["DEF-2321", "Threat Assess Def Item 1", "22/2/2026", "€27 421"], status: "active" as const },
    { id: "1414030892", cells: ["DEF-5892", "Threat Assess Def Item 2", "9/9/2026", "€30 992"], status: "pending" as const },
    { id: "1414034463", cells: ["DEF-9463", "Threat Assess Def Item 3", "24/4/2026", "€34 563"], status: "completed" as const },
    { id: "1414038034", cells: ["DEF-4034", "Threat Assess Def Item 4", "11/11/2026", "€38 134"], status: "warning" as const },
    { id: "1414041605", cells: ["DEF-7605", "Threat Assess Def Item 5", "26/6/2026", "€41 705"], status: "active" as const },
];
...
export default function DefenseSystemsThreatAssessDefPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Threat Assess Def</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Defense Systems • Threat Assess Def</p>
                    </div>
                </div>
