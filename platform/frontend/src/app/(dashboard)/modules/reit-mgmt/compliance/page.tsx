...
const KPIS = [{"l":"Auditorias Realizadas","v":"396","t":"+12.3%","d":"up"},{"l":"NC Abertas","v":"884","t":"-2.1%","d":"down"},{"l":"Conformidade (%)","v":"65.0%","t":"-2.7%","d":"down"},{"l":"CAPAs Pendentes","v":"7.802","t":"+9.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.493","70.9%","2.143","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.130","92.4%","3.875","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.552","78.3%","6.670","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.411","75.2%","5.265","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.382","95.8%","8.788","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":339},{"label":"Fev","value":346},{"label":"Mar","value":604},{"label":"Abr","value":542},{"label":"Mai","value":303},{"label":"Jun","value":509},{"label":"Jul","value":448},{"label":"Ago","value":447},{"label":"Set","value":560},{"label":"Out","value":452},{"label":"Nov","value":405},{"label":"Dez","value":519}];
const MX = 604;
