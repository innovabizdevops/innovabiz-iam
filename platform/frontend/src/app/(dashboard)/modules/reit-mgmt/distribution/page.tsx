...
const ACCENT = "#6366f1";
const MODULE = "REIT Management";
const PAGE = "Distribution";
const KPIS = [{"l":"Total Reit Mgmt","v":"3.651","t":"+6.3%","d":"up"},{"l":"Distribution Ativos","v":"704","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"84.1%","t":"-1.8%","d":"down"},{"l":"Score Performance","v":"77","t":"+17.8%","d":"up"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reit Mgmt #001","Reit Mgmt #002","5.010","922","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Reit Mgmt #002","Reit Mgmt #003","3.882","3.448","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Reit Mgmt #003","Reit Mgmt #004","3.789","875","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Reit Mgmt #004","Reit Mgmt #005","7.989","4.905","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reit Mgmt #005","Reit Mgmt #001","3.207","545","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":774},{"label":"Fev","value":520},{"label":"Mar","value":560},{"label":"Abr","value":701},{"label":"Mai","value":438},{"label":"Jun","value":704},{"label":"Jul","value":450},{"label":"Ago","value":786},{"label":"Set","value":427},{"label":"Out","value":507},{"label":"Nov","value":426},{"label":"Dez","value":480}];
const MX = 786;
