...
const KPIS = [
    { label: "Total Registos", value: "2638", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4601", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€146K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1217831238", cells: ["APP-6238", "Approval Center Item 1", "23/7/2026", "€31 338"], status: "active" as const },
    { id: "1217834809", cells: ["APP-9809", "Approval Center Item 2", "10/2/2026", "€34 909"], status: "pending" as const },
    { id: "1217838380", cells: ["APP-4380", "Approval Center Item 3", "25/9/2026", "€38 480"], status: "completed" as const },
    { id: "1217841951", cells: ["APP-7951", "Approval Center Item 4", "12/4/2026", "€42 051"], status: "warning" as const },
    { id: "1217845522", cells: ["APP-2522", "Approval Center Item 5", "27/11/2026", "€45 622"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Approval Center</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Approval Center</p>
                    </div>
                </div>
