...
const PAGE = "Queue";
const KPIS = [{"l":"Aprovações Pendentes","v":"4.582","t":"+13.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"68.1%","t":"-5.6%","d":"down"},{"l":"Tempo Médio (h)","v":"73h","t":"-1.5%","d":"down"},{"l":"Rejeitadas (%)","v":"65.7%","t":"+6.2%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","4.534","€ 1886.85","8.420","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","2.890","€ 11249.03","3.650","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","7.782","€ 21351.84","2.049","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","3.023","€ 31697.20","2.742","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","5.951","€ 17583.38","7.666","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":926},{"label":"Fev","value":580},{"label":"Mar","value":750},{"label":"Abr","value":747},{"label":"Mai","value":535},{"label":"Jun","value":837},{"label":"Jul","value":676},{"label":"Ago","value":929},{"label":"Set","value":597},{"label":"Out","value":635},{"label":"Nov","value":598},{"label":"Dez","value":541}];
const MX = 929;
