...
const PAGE = "Delegate";
const KPIS = [{"l":"Aprovações Pendentes","v":"1.163","t":"+11.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"65.5%","t":"-1.0%","d":"down"},{"l":"Tempo Médio (h)","v":"149h","t":"+8.3%","d":"up"},{"l":"Rejeitadas (%)","v":"93.2%","t":"+6.8%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","3.694","€ 9744.26","6.998","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","1.834","€ 44292.70","5.591","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","8.429","€ 20111.37","8.176","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","4.500","€ 11602.63","8.870","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","8.066","€ 20181.78","651","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":571},{"label":"Mar","value":492},{"label":"Abr","value":489},{"label":"Mai","value":562},{"label":"Jun","value":618},{"label":"Jul","value":796},{"label":"Ago","value":574},{"label":"Set","value":514},{"label":"Out","value":431},{"label":"Nov","value":497},{"label":"Dez","value":492}];
const MX = 796;
