...
const ACCENT = "#06b6d4";
const MODULE = "Approval Center";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"5.204","t":"+2.0%","d":"up"},{"l":"Queries/Dia","v":"3742","t":"+12.1%","d":"up"},{"l":"Dados Processados (GB)","v":"859","t":"-2.6%","d":"down"},{"l":"Utilizadores Analytics","v":"1.838","t":"-3.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1521","2026-03-12","7.523","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","542","2026-02-07","5.114","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","5088","2026-01-01","8.755","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2704","2026-02-18","8.031","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","167","2026-02-20","1.065","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":956},{"label":"Fev","value":604},{"label":"Mar","value":942},{"label":"Abr","value":929},{"label":"Mai","value":570},{"label":"Jun","value":576},{"label":"Jul","value":676},{"label":"Ago","value":681},{"label":"Set","value":781},{"label":"Out","value":577},{"label":"Nov","value":897},{"label":"Dez","value":946}];
const MX = 956;
