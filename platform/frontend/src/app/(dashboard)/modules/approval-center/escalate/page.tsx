...
const PAGE = "Escalate";
const KPIS = [{"l":"Aprovações Pendentes","v":"1.048","t":"+6.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"67.2%","t":"-4.1%","d":"down"},{"l":"Tempo Médio (h)","v":"208h","t":"+13.7%","d":"up"},{"l":"Rejeitadas (%)","v":"87.5%","t":"-4.2%","d":"down"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","2.029","€ 12158.01","1.326","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","1.494","€ 8509.86","3.252","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","4.754","€ 46288.37","4.380","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","6.812","€ 41692.26","1.586","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","4.612","€ 1394.38","3.753","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":929},{"label":"Fev","value":594},{"label":"Mar","value":881},{"label":"Abr","value":953},{"label":"Mai","value":954},{"label":"Jun","value":872},{"label":"Jul","value":893},{"label":"Ago","value":806},{"label":"Set","value":696},{"label":"Out","value":634},{"label":"Nov","value":918},{"label":"Dez","value":844}];
const MX = 954;
