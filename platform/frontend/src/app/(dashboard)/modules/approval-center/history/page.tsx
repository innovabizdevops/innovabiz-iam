...
const PAGE = "History";
const KPIS = [{"l":"Aprovações Pendentes","v":"6.105","t":"-4.1%","d":"down"},{"l":"SLA Cumprido (%)","v":"88.9%","t":"+16.5%","d":"up"},{"l":"Tempo Médio (h)","v":"176h","t":"-4.3%","d":"down"},{"l":"Rejeitadas (%)","v":"91.4%","t":"-4.9%","d":"down"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","5.178","€ 29049.69","5.182","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","780","€ 3572.05","5.165","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","2.478","€ 24943.95","5.706","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","3.500","€ 34906.31","3.755","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","4.340","€ 7853.28","1.259","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":409},{"label":"Fev","value":667},{"label":"Mar","value":574},{"label":"Abr","value":753},{"label":"Mai","value":705},{"label":"Jun","value":498},{"label":"Jul","value":447},{"label":"Ago","value":706},{"label":"Set","value":442},{"label":"Out","value":476},{"label":"Nov","value":453},{"label":"Dez","value":569}];
const MX = 753;
