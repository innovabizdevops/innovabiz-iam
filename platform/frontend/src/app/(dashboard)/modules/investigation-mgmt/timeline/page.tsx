...
const PAGE = "Timeline";
const KPIS = [{"l":"Total Investigation Mgmt","v":"3.083","t":"+0.6%","d":"up"},{"l":"Timeline Ativos","v":"2.153","t":"+2.7%","d":"up"},{"l":"Eficiência (%)","v":"73.9%","t":"+4.3%","d":"up"},{"l":"Score Performance","v":"69","t":"-1.6%","d":"down"}];
const COLS = ["ID","Timeline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Investigation Mgmt #001","Investigation Mgmt #002","1.909","3.823","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Investigation Mgmt #002","Investigation Mgmt #003","7.605","6.600","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Investigation Mgmt #003","Investigation Mgmt #004","4.645","6.188","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Investigation Mgmt #004","Investigation Mgmt #005","9.006","5.971","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Investigation Mgmt #005","Investigation Mgmt #001","6.915","5.013","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":776},{"label":"Fev","value":902},{"label":"Mar","value":884},{"label":"Abr","value":801},{"label":"Mai","value":851},{"label":"Jun","value":904},{"label":"Jul","value":986},{"label":"Ago","value":1049},{"label":"Set","value":756},{"label":"Out","value":846},{"label":"Nov","value":696},{"label":"Dez","value":975}];
const MX = 1049;
