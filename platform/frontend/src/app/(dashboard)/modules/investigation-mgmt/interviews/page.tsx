...
const PAGE = "Interview Notes";
const KPIS = [{"l":"Total Investigation Mgmt","v":"4.399","t":"+9.8%","d":"up"},{"l":"Interview Notes Ativos","v":"2.269","t":"+3.3%","d":"up"},{"l":"Eficiência (%)","v":"77.2%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"59","t":"+17.0%","d":"up"}];
const COLS = ["ID","Interview Notes","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Investigation Mgmt #001","Investigation Mgmt #002","6.046","375","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Investigation Mgmt #002","Investigation Mgmt #003","7.079","2.564","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Investigation Mgmt #003","Investigation Mgmt #004","3.141","4.690","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Investigation Mgmt #004","Investigation Mgmt #005","419","5.606","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Investigation Mgmt #005","Investigation Mgmt #001","2.847","7.080","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":443},{"label":"Mar","value":750},{"label":"Abr","value":731},{"label":"Mai","value":437},{"label":"Jun","value":566},{"label":"Jul","value":419},{"label":"Ago","value":561},{"label":"Set","value":572},{"label":"Out","value":398},{"label":"Nov","value":540},{"label":"Dez","value":600}];
const MX = 750;
