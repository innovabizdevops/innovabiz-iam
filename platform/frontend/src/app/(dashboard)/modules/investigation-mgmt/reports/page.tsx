...
const PAGE = "Reports";
const KPIS = [{"l":"Total Investigation Mgmt","v":"1.796","t":"-3.7%","d":"down"},{"l":"Reports Ativos","v":"9.098","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"70.5%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"91","t":"+7.0%","d":"up"}];
const COLS = ["ID","Reports","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Investigation Mgmt #001","Investigation Mgmt #002","7.528","3.397","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Investigation Mgmt #002","Investigation Mgmt #003","3.000","8.688","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Investigation Mgmt #003","Investigation Mgmt #004","6.568","571","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Investigation Mgmt #004","Investigation Mgmt #005","4.842","1.031","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Investigation Mgmt #005","Investigation Mgmt #001","5.090","5.389","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":548},{"label":"Mar","value":723},{"label":"Abr","value":348},{"label":"Mai","value":705},{"label":"Jun","value":590},{"label":"Jul","value":641},{"label":"Ago","value":459},{"label":"Set","value":480},{"label":"Out","value":710},{"label":"Nov","value":376},{"label":"Dez","value":631}];
const MX = 723;
