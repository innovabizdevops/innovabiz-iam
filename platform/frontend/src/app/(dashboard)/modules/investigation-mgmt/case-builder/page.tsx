...
const PAGE = "Case Builder";
const KPIS = [{"l":"Total Investigation Mgmt","v":"6.674","t":"+2.0%","d":"up"},{"l":"Case Builder Ativos","v":"3.227","t":"+0.3%","d":"up"},{"l":"Eficiência (%)","v":"75.3%","t":"+17.2%","d":"up"},{"l":"Score Performance","v":"72","t":"+10.4%","d":"up"}];
const COLS = ["ID","Case Builder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Investigation Mgmt #001","Investigation Mgmt #002","7.414","4.474","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Investigation Mgmt #002","Investigation Mgmt #003","6.834","7.872","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Investigation Mgmt #003","Investigation Mgmt #004","4.710","5.689","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Investigation Mgmt #004","Investigation Mgmt #005","330","3.901","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Investigation Mgmt #005","Investigation Mgmt #001","1.246","7.367","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":395},{"label":"Fev","value":609},{"label":"Mar","value":440},{"label":"Abr","value":303},{"label":"Mai","value":387},{"label":"Jun","value":284},{"label":"Jul","value":390},{"label":"Ago","value":640},{"label":"Set","value":625},{"label":"Out","value":517},{"label":"Nov","value":578},{"label":"Dez","value":546}];
const MX = 640;
