...
const ACCENT = "#78350f";
const MODULE = "Investigation Management";
const PAGE = "Evidence Chain";
const KPIS = [{"l":"Total Investigation Mgmt","v":"1.200","t":"+2.6%","d":"up"},{"l":"Evidence Chain Ativos","v":"3.510","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"92.4%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"62","t":"-4.6%","d":"down"}];
const COLS = ["ID","Evidence Chain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Investigation Mgmt #001","Investigation Mgmt #002","2.857","7.460","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Investigation Mgmt #002","Investigation Mgmt #003","5.521","8.744","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Investigation Mgmt #003","Investigation Mgmt #004","1.674","7.481","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Investigation Mgmt #004","Investigation Mgmt #005","8.920","6.104","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Investigation Mgmt #005","Investigation Mgmt #001","483","175","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1006},{"label":"Fev","value":1057},{"label":"Mar","value":1007},{"label":"Abr","value":660},{"label":"Mai","value":732},{"label":"Jun","value":871},{"label":"Jul","value":789},{"label":"Ago","value":790},{"label":"Set","value":1046},{"label":"Out","value":889},{"label":"Nov","value":1010},{"label":"Dez","value":803}];
const MX = 1057;
