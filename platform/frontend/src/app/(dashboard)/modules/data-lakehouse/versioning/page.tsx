...
const PAGE = "Data Versioning";
const KPIS = [{"l":"Formulários Ativos","v":"7.144","t":"-4.3%","d":"down"},{"l":"Submissões/Dia","v":"1701","t":"+3.1%","d":"up"},{"l":"Documentos Gerados","v":"3.182","t":"+14.5%","d":"up"},{"l":"Templates","v":"2.744","t":"-2.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","913","2026-03-17","8.344","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.262","2026-02-23","7.143","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.589","2026-01-01","1.970","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.558","2026-02-09","7.349","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.918","2026-02-09","800","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":270},{"label":"Fev","value":264},{"label":"Mar","value":582},{"label":"Abr","value":410},{"label":"Mai","value":303},{"label":"Jun","value":603},{"label":"Jul","value":477},{"label":"Ago","value":574},{"label":"Set","value":255},{"label":"Out","value":495},{"label":"Nov","value":502},{"label":"Dez","value":565}];
const MX = 603;
