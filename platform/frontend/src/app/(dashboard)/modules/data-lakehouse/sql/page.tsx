...
const PAGE = "SQL Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"3.155","t":"+2.3%","d":"up"},{"l":"Queries/Dia","v":"1578","t":"+5.3%","d":"up"},{"l":"Dados Processados (GB)","v":"7.511","t":"+7.0%","d":"up"},{"l":"Utilizadores Analytics","v":"5.568","t":"-1.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1209","2026-03-17","5.118","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1057","2026-02-03","7.683","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3352","2026-02-02","5.544","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3679","2026-01-26","684","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1529","2026-03-19","4.794","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":250},{"label":"Fev","value":515},{"label":"Mar","value":338},{"label":"Abr","value":358},{"label":"Mai","value":599},{"label":"Jun","value":548},{"label":"Jul","value":573},{"label":"Ago","value":598},{"label":"Set","value":389},{"label":"Out","value":409},{"label":"Nov","value":445},{"label":"Dez","value":278}];
const MX = 599;
