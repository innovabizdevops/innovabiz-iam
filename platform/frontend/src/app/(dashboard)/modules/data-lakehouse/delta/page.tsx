...
const PAGE = "Delta Tables";
const KPIS = [{"l":"Dashboards Ativos","v":"7.276","t":"+8.1%","d":"up"},{"l":"Queries/Dia","v":"325","t":"+16.0%","d":"up"},{"l":"Dados Processados (GB)","v":"1.724","t":"-2.6%","d":"down"},{"l":"Utilizadores Analytics","v":"6.055","t":"+4.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4533","2026-02-15","5.796","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4808","2026-03-17","1.362","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2931","2026-03-10","4.238","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3088","2026-01-20","4.338","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4547","2026-02-07","4.551","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":990},{"label":"Fev","value":981},{"label":"Mar","value":974},{"label":"Abr","value":839},{"label":"Mai","value":688},{"label":"Jun","value":677},{"label":"Jul","value":840},{"label":"Ago","value":811},{"label":"Set","value":734},{"label":"Out","value":850},{"label":"Nov","value":983},{"label":"Dez","value":894}];
const MX = 990;
