...
const ACCENT = "#059669";
const MODULE = "Data Lakehouse";
const PAGE = "ML Feature Store";
const KPIS = [{"l":"Pedidos/Dia","v":"3879","t":"+12.7%","d":"up"},{"l":"GMV (€)","v":"€95070","t":"+3.9%","d":"up"},{"l":"Conversão (%)","v":"73.3%","t":"+5.5%","d":"up"},{"l":"AOV (€)","v":"€55379","t":"+8.1%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 43703.32","8.008","3.729","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 15685.21","4.447","4.951","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 43613.29","1.095","3.601","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 24283.76","7.057","1.487","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 31558.36","8.914","5.149","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":929},{"label":"Fev","value":713},{"label":"Mar","value":935},{"label":"Abr","value":780},{"label":"Mai","value":748},{"label":"Jun","value":957},{"label":"Jul","value":1088},{"label":"Ago","value":1074},{"label":"Set","value":781},{"label":"Out","value":963},{"label":"Nov","value":961},{"label":"Dez","value":884}];
const MX = 1088;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#059669'}}>ML</span></h1>
                </div>
