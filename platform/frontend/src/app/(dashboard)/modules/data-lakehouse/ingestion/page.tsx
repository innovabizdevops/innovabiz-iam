...
const PAGE = "Ingestion Pipeline";
const KPIS = [{"l":"Dashboards Ativos","v":"1.060","t":"-0.6%","d":"down"},{"l":"Queries/Dia","v":"4606","t":"+12.8%","d":"up"},{"l":"Dados Processados (GB)","v":"2.728","t":"-4.4%","d":"down"},{"l":"Utilizadores Analytics","v":"2.526","t":"+5.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3978","2026-02-26","5.045","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","541","2026-01-15","3.255","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2131","2026-01-23","5.524","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2777","2026-01-22","6.588","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2447","2026-01-13","1.305","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":847},{"label":"Fev","value":705},{"label":"Mar","value":788},{"label":"Abr","value":670},{"label":"Mai","value":818},{"label":"Jun","value":923},{"label":"Jul","value":719},{"label":"Ago","value":1002},{"label":"Set","value":913},{"label":"Out","value":862},{"label":"Nov","value":825},{"label":"Dez","value":929}];
const MX = 1002;
