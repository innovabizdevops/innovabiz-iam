...
const ACCENT = "#dc2626";
const MODULE = "EHR Core";
const PAGE = "CDS Alerts";
const KPIS = [{"l":"Notificações Enviadas","v":"7.216","t":"+16.5%","d":"up"},{"l":"Taxa Entrega (%)","v":"78.1%","t":"+5.4%","d":"up"},{"l":"Taxa Abertura (%)","v":"72.7%","t":"+0.5%","d":"up"},{"l":"Escalações","v":"2.449","t":"+13.7%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","3.138","78.6%","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","5.101","75.5%","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","1.703","96.0%","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","5.984","76.7%","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","1.957","70.1%","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":566},{"label":"Mar","value":649},{"label":"Abr","value":577},{"label":"Mai","value":637},{"label":"Jun","value":530},{"label":"Jul","value":740},{"label":"Ago","value":548},{"label":"Set","value":832},{"label":"Out","value":613},{"label":"Nov","value":728},{"label":"Dez","value":769}];
const MX = 832;
