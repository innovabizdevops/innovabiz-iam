...
const KPIS = [{"l":"Total Ehr Core","v":"834","t":"+7.1%","d":"up"},{"l":"Care Plans Ativos","v":"234","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"69.5%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"84","t":"+4.9%","d":"up"}];
const COLS = ["ID","Care Plans","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ehr Core #001","Ehr Core #002","6.618","899","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Ehr Core #002","Ehr Core #003","6.120","2.302","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Ehr Core #003","Ehr Core #004","7.559","2.918","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Ehr Core #004","Ehr Core #005","5.426","4.064","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ehr Core #005","Ehr Core #001","8.523","4.164","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":659},{"label":"Mar","value":442},{"label":"Abr","value":547},{"label":"Mai","value":545},{"label":"Jun","value":470},{"label":"Jul","value":748},{"label":"Ago","value":540},{"label":"Set","value":769},{"label":"Out","value":463},{"label":"Nov","value":468},{"label":"Dez","value":612}];
const MX = 769;
