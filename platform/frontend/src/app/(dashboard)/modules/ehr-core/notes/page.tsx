...
const KPIS = [{"l":"Total Ehr Core","v":"7.517","t":"+13.3%","d":"up"},{"l":"Clinical Notes Ativos","v":"404","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"93.6%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"72","t":"+17.6%","d":"up"}];
const COLS = ["ID","Clinical Notes","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ehr Core #001","Ehr Core #002","4.764","4.928","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Ehr Core #002","Ehr Core #003","3.504","4.788","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Ehr Core #003","Ehr Core #004","1.188","7.009","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Ehr Core #004","Ehr Core #005","9.080","8.682","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ehr Core #005","Ehr Core #001","2.704","2.352","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":565},{"label":"Mar","value":884},{"label":"Abr","value":944},{"label":"Mai","value":654},{"label":"Jun","value":738},{"label":"Jul","value":772},{"label":"Ago","value":733},{"label":"Set","value":688},{"label":"Out","value":717},{"label":"Nov","value":776},{"label":"Dez","value":628}];
const MX = 944;
