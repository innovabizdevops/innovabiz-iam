...
const PAGE = "HL7 FHIR";
const KPIS = [{"l":"Total Ehr Core","v":"3.178","t":"+11.9%","d":"up"},{"l":"HL7 FHIR Ativos","v":"2.817","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"84.4%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"80","t":"+13.0%","d":"up"}];
const COLS = ["ID","HL7 FHIR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ehr Core #001","Ehr Core #002","4.666","5.362","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Ehr Core #002","Ehr Core #003","5.938","7.915","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Ehr Core #003","Ehr Core #004","8.928","7.120","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Ehr Core #004","Ehr Core #005","128","8.003","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ehr Core #005","Ehr Core #001","509","8.078","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":583},{"label":"Mar","value":712},{"label":"Abr","value":490},{"label":"Mai","value":539},{"label":"Jun","value":710},{"label":"Jul","value":707},{"label":"Ago","value":680},{"label":"Set","value":510},{"label":"Out","value":598},{"label":"Nov","value":770},{"label":"Dez","value":661}];
const MX = 770;
