...
const PAGE = "Allergies";
const KPIS = [{"l":"Total Ehr Core","v":"8.454","t":"+17.8%","d":"up"},{"l":"Allergies Ativos","v":"929","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"76.4%","t":"-2.3%","d":"down"},{"l":"Score Performance","v":"77","t":"-0.8%","d":"down"}];
const COLS = ["ID","Allergies","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ehr Core #001","Ehr Core #002","8.216","3.173","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Ehr Core #002","Ehr Core #003","435","4.616","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Ehr Core #003","Ehr Core #004","3.519","5.921","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Ehr Core #004","Ehr Core #005","7.704","2.344","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ehr Core #005","Ehr Core #001","1.557","6.834","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":456},{"label":"Mar","value":677},{"label":"Abr","value":395},{"label":"Mai","value":496},{"label":"Jun","value":548},{"label":"Jul","value":629},{"label":"Ago","value":351},{"label":"Set","value":654},{"label":"Out","value":485},{"label":"Nov","value":325},{"label":"Dez","value":308}];
const MX = 677;
