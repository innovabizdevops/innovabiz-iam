...
const KPIS = [{"l":"Integrações Ativas","v":"5.999","t":"+17.1%","d":"up"},{"l":"Chamadas/Hora","v":"4303","t":"+14.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"91.1%","t":"-4.4%","d":"down"},{"l":"Latência Média (ms)","v":"58ms","t":"-1.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.113","1.354","97.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.979","4.934","87.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.636","5.456","75.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.605","1.363","84.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.232","3.859","87.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":515},{"label":"Mar","value":533},{"label":"Abr","value":350},{"label":"Mai","value":407},{"label":"Jun","value":424},{"label":"Jul","value":491},{"label":"Ago","value":490},{"label":"Set","value":442},{"label":"Out","value":659},{"label":"Nov","value":362},{"label":"Dez","value":632}];
const MX = 659;
