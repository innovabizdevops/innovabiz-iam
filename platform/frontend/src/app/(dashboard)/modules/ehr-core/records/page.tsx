...
const KPIS = [{"l":"Total Ehr Core","v":"267","t":"+6.9%","d":"up"},{"l":"Patient Records Ativos","v":"1.543","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"86.4%","t":"+2.3%","d":"up"},{"l":"Score Performance","v":"58","t":"-3.2%","d":"down"}];
const COLS = ["ID","Patient Records","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ehr Core #001","Ehr Core #002","5.212","7.735","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Ehr Core #002","Ehr Core #003","4.228","3.473","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Ehr Core #003","Ehr Core #004","3.119","4.010","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Ehr Core #004","Ehr Core #005","1.996","4.283","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ehr Core #005","Ehr Core #001","8.382","1.869","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":489},{"label":"Fev","value":418},{"label":"Mar","value":319},{"label":"Abr","value":503},{"label":"Mai","value":512},{"label":"Jun","value":534},{"label":"Jul","value":393},{"label":"Ago","value":671},{"label":"Set","value":594},{"label":"Out","value":547},{"label":"Nov","value":324},{"label":"Dez","value":632}];
const MX = 671;
