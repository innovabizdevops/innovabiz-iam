...
const ACCENT = "#6366f1";
const MODULE = "Corporate Secretary";
const PAGE = "Resolution";
const KPIS = [{"l":"Total Corporate Secretary","v":"2.039","t":"+5.0%","d":"up"},{"l":"Resolution Ativos","v":"5.585","t":"+2.8%","d":"up"},{"l":"Eficiência (%)","v":"71.7%","t":"+11.3%","d":"up"},{"l":"Score Performance","v":"75","t":"+2.0%","d":"up"}];
const COLS = ["ID","Resolution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Corporate Secretary #001","Corporate Secretary #002","8.384","7.782","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Corporate Secretary #002","Corporate Secretary #003","2.075","6.546","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Corporate Secretary #003","Corporate Secretary #004","8.938","2.107","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Corporate Secretary #004","Corporate Secretary #005","5.264","5.468","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Corporate Secretary #005","Corporate Secretary #001","4.351","3.301","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":851},{"label":"Mar","value":517},{"label":"Abr","value":615},{"label":"Mai","value":842},{"label":"Jun","value":634},{"label":"Jul","value":644},{"label":"Ago","value":706},{"label":"Set","value":557},{"label":"Out","value":603},{"label":"Nov","value":777},{"label":"Dez","value":764}];
const MX = 851;
