...
const PAGE = "Board";
const KPIS = [{"l":"Teams Ativos","v":"6.554","t":"-3.3%","d":"down"},{"l":"Reuniões/Semana","v":"4844","t":"+1.1%","d":"up"},{"l":"Mensagens/Dia","v":"3660","t":"+4.0%","d":"up"},{"l":"Ficheiros Partilhados","v":"5.250","t":"+4.9%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","2.394","302","8.631","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","7.617","3752","4.473","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","7.607","3829","7.881","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","6.406","204","3.168","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","3.542","3771","4.297","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":424},{"label":"Fev","value":503},{"label":"Mar","value":585},{"label":"Abr","value":654},{"label":"Mai","value":305},{"label":"Jun","value":549},{"label":"Jul","value":301},{"label":"Ago","value":693},{"label":"Set","value":458},{"label":"Out","value":487},{"label":"Nov","value":596},{"label":"Dez","value":561}];
const MX = 693;
