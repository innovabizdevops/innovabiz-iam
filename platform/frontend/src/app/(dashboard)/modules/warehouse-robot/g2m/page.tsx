...
const ACCENT = "#6366f1";
const MODULE = "Warehouse Robotics";
const PAGE = "Goods-to-Man";
const KPIS = [{"l":"Total Warehouse Robot","v":"5.816","t":"+7.0%","d":"up"},{"l":"Goods To Man Ativos","v":"6.326","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"74.7%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"86","t":"+5.5%","d":"up"}];
const COLS = ["ID","Goods To Man","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Warehouse Robot #001","Warehouse Robot #002","5.575","6.023","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Warehouse Robot #002","Warehouse Robot #003","3.834","5.034","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Warehouse Robot #003","Warehouse Robot #004","8.240","1.821","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Warehouse Robot #004","Warehouse Robot #005","4.319","1.980","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Warehouse Robot #005","Warehouse Robot #001","811","385","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":901},{"label":"Fev","value":941},{"label":"Mar","value":913},{"label":"Abr","value":910},{"label":"Mai","value":677},{"label":"Jun","value":758},{"label":"Jul","value":651},{"label":"Ago","value":968},{"label":"Set","value":648},{"label":"Out","value":920},{"label":"Nov","value":674},{"label":"Dez","value":633}];
const MX = 968;
...
export default function G2mPage() {
    return (
