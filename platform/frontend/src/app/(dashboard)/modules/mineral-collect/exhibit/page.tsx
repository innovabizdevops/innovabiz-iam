...
const ACCENT = "#facc15";
const MODULE = "Mineral Collecting";
const PAGE = "Exhibit";
const KPIS = [{"l":"Total Mineral Collect","v":"4.630","t":"+11.9%","d":"up"},{"l":"Exhibit Ativos","v":"6.878","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"79.4%","t":"+4.2%","d":"up"},{"l":"Score Performance","v":"80","t":"+7.4%","d":"up"}];
const COLS = ["ID","Exhibit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mineral Collect #001","Mineral Collect #002","3.197","1.910","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Mineral Collect #002","Mineral Collect #003","7.836","5.620","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Mineral Collect #003","Mineral Collect #004","375","2.148","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Mineral Collect #004","Mineral Collect #005","4.574","8.194","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mineral Collect #005","Mineral Collect #001","6.460","1.073","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":713},{"label":"Mar","value":536},{"label":"Abr","value":669},{"label":"Mai","value":644},{"label":"Jun","value":603},{"label":"Jul","value":392},{"label":"Ago","value":404},{"label":"Set","value":735},{"label":"Out","value":590},{"label":"Nov","value":358},{"label":"Dez","value":471}];
const MX = 735;
