...
const PAGE = "Source";
const KPIS = [{"l":"Total Mineral Collect","v":"5.490","t":"+16.1%","d":"up"},{"l":"Source Ativos","v":"8.670","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"66.3%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"61","t":"+0.1%","d":"up"}];
const COLS = ["ID","Source","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mineral Collect #001","Mineral Collect #002","1.940","2.301","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Mineral Collect #002","Mineral Collect #003","5.662","4.406","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Mineral Collect #003","Mineral Collect #004","3.121","2.762","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Mineral Collect #004","Mineral Collect #005","5.585","4.275","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mineral Collect #005","Mineral Collect #001","1.721","8.570","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":793},{"label":"Fev","value":785},{"label":"Mar","value":948},{"label":"Abr","value":930},{"label":"Mai","value":808},{"label":"Jun","value":954},{"label":"Jul","value":811},{"label":"Ago","value":973},{"label":"Set","value":777},{"label":"Out","value":720},{"label":"Nov","value":693},{"label":"Dez","value":865}];
const MX = 973;
