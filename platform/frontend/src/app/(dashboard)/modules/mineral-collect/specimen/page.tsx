...
const PAGE = "Specimen";
const KPIS = [{"l":"Total Mineral Collect","v":"7.219","t":"+11.9%","d":"up"},{"l":"Specimen Ativos","v":"5.132","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"76.1%","t":"+15.9%","d":"up"},{"l":"Score Performance","v":"87","t":"-0.5%","d":"down"}];
const COLS = ["ID","Specimen","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mineral Collect #001","Mineral Collect #002","6.164","420","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Mineral Collect #002","Mineral Collect #003","3.460","772","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Mineral Collect #003","Mineral Collect #004","5.174","7.862","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Mineral Collect #004","Mineral Collect #005","4.797","2.095","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mineral Collect #005","Mineral Collect #001","2.295","7.397","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":677},{"label":"Mar","value":845},{"label":"Abr","value":616},{"label":"Mai","value":738},{"label":"Jun","value":824},{"label":"Jul","value":790},{"label":"Ago","value":687},{"label":"Set","value":579},{"label":"Out","value":482},{"label":"Nov","value":542},{"label":"Dez","value":709}];
const MX = 845;
