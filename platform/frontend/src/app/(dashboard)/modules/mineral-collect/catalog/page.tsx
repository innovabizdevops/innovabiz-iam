...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"1.134","t":"+13.9%","d":"up"},{"l":"Queries/Dia","v":"4199","t":"+9.6%","d":"up"},{"l":"Dados Processados (GB)","v":"2.076","t":"+16.7%","d":"up"},{"l":"Utilizadores Analytics","v":"8.901","t":"+10.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5048","2026-02-02","6.456","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","756","2026-02-22","4.873","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2539","2026-01-04","7.443","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4458","2026-02-10","2.598","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4759","2026-03-25","2.944","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":977},{"label":"Fev","value":996},{"label":"Mar","value":718},{"label":"Abr","value":734},{"label":"Mai","value":873},{"label":"Jun","value":827},{"label":"Jul","value":864},{"label":"Ago","value":995},{"label":"Set","value":788},{"label":"Out","value":930},{"label":"Nov","value":1026},{"label":"Dez","value":974}];
const MX = 1026;
