...
const PAGE = "Trade";
const KPIS = [{"l":"Total Mineral Collect","v":"8.307","t":"+4.4%","d":"up"},{"l":"Trade Ativos","v":"5.794","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"88.9%","t":"+6.5%","d":"up"},{"l":"Score Performance","v":"83","t":"+15.1%","d":"up"}];
const COLS = ["ID","Trade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mineral Collect #001","Mineral Collect #002","7.290","4.277","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Mineral Collect #002","Mineral Collect #003","4.283","419","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Mineral Collect #003","Mineral Collect #004","8.562","6.590","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Mineral Collect #004","Mineral Collect #005","2.330","7.393","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mineral Collect #005","Mineral Collect #001","8.224","5.212","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":930},{"label":"Mar","value":829},{"label":"Abr","value":697},{"label":"Mai","value":802},{"label":"Jun","value":751},{"label":"Jul","value":661},{"label":"Ago","value":667},{"label":"Set","value":842},{"label":"Out","value":679},{"label":"Nov","value":697},{"label":"Dez","value":971}];
const MX = 971;
