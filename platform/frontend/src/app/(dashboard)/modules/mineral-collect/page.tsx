...
/* ═══ Mineral Collecting — Dashboard ═══ */

const ACCENT = "#facc15";

const KPIS = [
    { label: "Total Registos", value: "9518", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "163", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€237K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "842647918", cells: ["MIN-5918", "Mineral Collecting Item 1", "15/11/2026", "€48 018"], status: "active" as const },
    { id: "842651489", cells: ["MIN-9489", "Mineral Collecting Item 2", "2/6/2026", "€1589"], status: "pending" as const },
    { id: "842655060", cells: ["MIN-4060", "Mineral Collecting Item 3", "17/1/2026", "€5160"], status: "completed" as const },
    { id: "842658631", cells: ["MIN-7631", "Mineral Collecting Item 4", "4/8/2026", "€8731"], status: "warning" as const },
    { id: "842662202", cells: ["MIN-2202", "Mineral Collecting Item 5", "19/3/2026", "€12 302"], status: "active" as const },
];
...
export default function MineralCollectingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mineral Collecting</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Mineral Collecting</p>
                    </div>
                </div>
