...
const KPIS = [{"l":"Dashboards Ativos","v":"7.850","t":"+1.5%","d":"up"},{"l":"Queries/Dia","v":"2142","t":"+9.9%","d":"up"},{"l":"Dados Processados (GB)","v":"4.955","t":"-5.7%","d":"down"},{"l":"Utilizadores Analytics","v":"1.654","t":"+12.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1783","2026-02-17","6.400","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3299","2026-03-16","7.603","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4097","2026-03-06","8.341","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1389","2026-01-07","3.498","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3265","2026-02-28","358","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":916},{"label":"Mar","value":843},{"label":"Abr","value":922},{"label":"Mai","value":908},{"label":"Jun","value":887},{"label":"Jul","value":1000},{"label":"Ago","value":749},{"label":"Set","value":964},{"label":"Out","value":941},{"label":"Nov","value":770},{"label":"Dez","value":912}];
const MX = 1000;
