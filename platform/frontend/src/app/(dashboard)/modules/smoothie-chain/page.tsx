...
/* ═══ Smoothie Chain — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "9749", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3980", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€455K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1607205349", cells: ["SMO-4349", "Smoothie Chain Item 1", "2/2/2026", "€5449"], status: "active" as const },
    { id: "1607208920", cells: ["SMO-7920", "Smoothie Chain Item 2", "17/9/2026", "€9020"], status: "pending" as const },
    { id: "1607212491", cells: ["SMO-2491", "Smoothie Chain Item 3", "4/4/2026", "€12 591"], status: "completed" as const },
    { id: "1607216062", cells: ["SMO-6062", "Smoothie Chain Item 4", "19/11/2026", "€16 162"], status: "warning" as const },
    { id: "1607219633", cells: ["SMO-9633", "Smoothie Chain Item 5", "6/6/2026", "€19 733"], status: "active" as const },
];
...
export default function SmoothieChainPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Smoothie Chain</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Smoothie Chain</p>
                    </div>
                </div>
