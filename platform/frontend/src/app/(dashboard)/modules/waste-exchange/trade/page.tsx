...
const PAGE = "Trade";
const KPIS = [{"l":"Total Waste Exchange","v":"357","t":"-4.4%","d":"down"},{"l":"Trade Ativos","v":"5.081","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"67.0%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"91","t":"-1.7%","d":"down"}];
const COLS = ["ID","Trade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Exchange #001","Waste Exchange #002","7.145","4.273","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Exchange #002","Waste Exchange #003","1.561","7.193","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Exchange #003","Waste Exchange #004","8.161","688","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Exchange #004","Waste Exchange #005","5.244","6.087","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Exchange #005","Waste Exchange #001","4.126","8.983","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":379},{"label":"Fev","value":679},{"label":"Mar","value":729},{"label":"Abr","value":758},{"label":"Mai","value":683},{"label":"Jun","value":711},{"label":"Jul","value":567},{"label":"Ago","value":765},{"label":"Set","value":669},{"label":"Out","value":604},{"label":"Nov","value":730},{"label":"Dez","value":692}];
const MX = 765;
