...
const ACCENT = "#065f46";
const MODULE = "Waste Exchange Platform";
const PAGE = "Match";
const KPIS = [{"l":"Atletas Registados","v":"2.918","t":"+7.1%","d":"up"},{"l":"Treinos/Semana","v":"2125","t":"+15.4%","d":"up"},{"l":"Competições","v":"2.604","t":"+6.5%","d":"up"},{"l":"Performance Score","v":"57","t":"+15.6%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.784","2.136","4.226","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.785","2.544","4.144","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.578","8.812","7.819","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.692","5.764","1.656","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.670","1.578","3.661","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":546},{"label":"Mar","value":743},{"label":"Abr","value":809},{"label":"Mai","value":792},{"label":"Jun","value":608},{"label":"Jul","value":457},{"label":"Ago","value":573},{"label":"Set","value":638},{"label":"Out","value":530},{"label":"Nov","value":732},{"label":"Dez","value":685}];
const MX = 809;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#065f46'}}>AI</span></h1>
                </div>
