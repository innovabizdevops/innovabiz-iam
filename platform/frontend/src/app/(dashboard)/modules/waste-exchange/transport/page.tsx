...
const KPIS = [{"l":"Atletas Registados","v":"8.493","t":"+8.1%","d":"up"},{"l":"Treinos/Semana","v":"4038","t":"+14.4%","d":"up"},{"l":"Competições","v":"8.933","t":"-1.9%","d":"down"},{"l":"Performance Score","v":"61","t":"-4.5%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.577","3.315","552","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.878","3.599","4.140","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.505","8.728","250","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.765","437","5.101","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.854","3.611","3.857","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":585},{"label":"Mar","value":474},{"label":"Abr","value":541},{"label":"Mai","value":604},{"label":"Jun","value":660},{"label":"Jul","value":757},{"label":"Ago","value":374},{"label":"Set","value":423},{"label":"Out","value":581},{"label":"Nov","value":559},{"label":"Dez","value":722}];
const MX = 757;
