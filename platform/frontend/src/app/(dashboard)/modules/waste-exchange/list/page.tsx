...
const PAGE = "List";
const KPIS = [{"l":"Total Waste Exchange","v":"547","t":"+3.5%","d":"up"},{"l":"List Ativos","v":"5.485","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"85.1%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"69","t":"+6.3%","d":"up"}];
const COLS = ["ID","List","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Exchange #001","Waste Exchange #002","6.731","8.903","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Exchange #002","Waste Exchange #003","1.396","7.243","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Exchange #003","Waste Exchange #004","3.560","7.594","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Exchange #004","Waste Exchange #005","3.377","6.245","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Exchange #005","Waste Exchange #001","802","4.303","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":665},{"label":"Mar","value":446},{"label":"Abr","value":669},{"label":"Mai","value":324},{"label":"Jun","value":582},{"label":"Jul","value":512},{"label":"Ago","value":649},{"label":"Set","value":656},{"label":"Out","value":557},{"label":"Nov","value":647},{"label":"Dez","value":327}];
const MX = 669;
