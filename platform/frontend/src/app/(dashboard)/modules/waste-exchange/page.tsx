...
/* ═══ Waste Exchange Platform — Dashboard ═══ */

const ACCENT = "#065f46";

const KPIS = [
    { label: "Total Registos", value: "9013", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1123", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€211K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "-21%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "442350813", cells: ["WAS-1813", "Waste Exchange Platform Item 1", "10/10/2026", "€913"], status: "active" as const },
    { id: "442354384", cells: ["WAS-5384", "Waste Exchange Platform Item 2", "25/5/2026", "€4484"], status: "pending" as const },
    { id: "442357955", cells: ["WAS-8955", "Waste Exchange Platform Item 3", "12/12/2026", "€8055"], status: "completed" as const },
    { id: "442361526", cells: ["WAS-3526", "Waste Exchange Platform Item 4", "27/7/2026", "€11 626"], status: "warning" as const },
    { id: "442365097", cells: ["WAS-7097", "Waste Exchange Platform Item 5", "14/2/2026", "€15 197"], status: "active" as const },
];
...
export default function WasteExchangePlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Waste Exchange Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Waste Exchange Platform</p>
                    </div>
                </div>
