...
/* ═══ Compensation & Benefits Deep — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "9330", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4170", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€205K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "791870630", cells: ["COM-6630", "Compensation & Benefits Deep Item 1", "27/3/2026", "€20 730"], status: "active" as const },
    { id: "791874201", cells: ["COM-1201", "Compensation & Benefits Deep Item 2", "14/10/2026", "€24 301"], status: "pending" as const },
    { id: "791877772", cells: ["COM-4772", "Compensation & Benefits Deep Item 3", "1/5/2026", "€27 872"], status: "completed" as const },
    { id: "791881343", cells: ["COM-8343", "Compensation & Benefits Deep Item 4", "16/12/2026", "€31 443"], status: "warning" as const },
    { id: "791884914", cells: ["COM-2914", "Compensation & Benefits Deep Item 5", "3/7/2026", "€35 014"], status: "active" as const },
];
...
export default function CompensationBenefitsDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Compensation & Benefits Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Compensation & Benefits Deep</p>
                    </div>
                </div>
