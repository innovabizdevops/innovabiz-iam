...
const ACCENT = "#94a3b8";
const MODULE = "Video Analytics Platform";
const PAGE = "Face";
const KPIS = [{"l":"Dashboards Ativos","v":"6.264","t":"+17.5%","d":"up"},{"l":"Queries/Dia","v":"2223","t":"-2.4%","d":"down"},{"l":"Dados Processados (GB)","v":"1.865","t":"-5.0%","d":"down"},{"l":"Utilizadores Analytics","v":"4.845","t":"+7.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","226","2026-01-07","4.307","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","306","2026-01-02","969","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3533","2026-01-17","6.465","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2546","2026-03-08","2.989","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2033","2026-02-05","3.665","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":607},{"label":"Mar","value":769},{"label":"Abr","value":584},{"label":"Mai","value":768},{"label":"Jun","value":623},{"label":"Jul","value":793},{"label":"Ago","value":409},{"label":"Set","value":544},{"label":"Out","value":795},{"label":"Nov","value":457},{"label":"Dez","value":729}];
const MX = 795;
