...
const PAGE = "Behavior";
const KPIS = [{"l":"Dashboards Ativos","v":"6.257","t":"+14.4%","d":"up"},{"l":"Queries/Dia","v":"3001","t":"+15.0%","d":"up"},{"l":"Dados Processados (GB)","v":"2.247","t":"+2.3%","d":"up"},{"l":"Utilizadores Analytics","v":"5.066","t":"+15.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2353","2026-03-19","3.388","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3262","2026-01-07","8.707","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4477","2026-03-04","4.657","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","253","2026-01-12","4.005","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1551","2026-01-17","824","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":533},{"label":"Mar","value":656},{"label":"Abr","value":626},{"label":"Mai","value":470},{"label":"Jun","value":439},{"label":"Jul","value":643},{"label":"Ago","value":433},{"label":"Set","value":601},{"label":"Out","value":377},{"label":"Nov","value":551},{"label":"Dez","value":423}];
const MX = 656;
