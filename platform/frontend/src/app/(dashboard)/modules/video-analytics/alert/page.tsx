...
const PAGE = "Alert";
const KPIS = [{"l":"Dashboards Ativos","v":"6.548","t":"-0.1%","d":"down"},{"l":"Queries/Dia","v":"1284","t":"+17.4%","d":"up"},{"l":"Dados Processados (GB)","v":"8.634","t":"-3.8%","d":"down"},{"l":"Utilizadores Analytics","v":"7.296","t":"+13.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3454","2026-01-18","1.560","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1277","2026-01-01","8.632","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2183","2026-02-07","8.611","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2428","2026-02-27","2.560","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4969","2026-02-10","4.304","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":937},{"label":"Fev","value":778},{"label":"Mar","value":738},{"label":"Abr","value":699},{"label":"Mai","value":902},{"label":"Jun","value":705},{"label":"Jul","value":932},{"label":"Ago","value":860},{"label":"Set","value":750},{"label":"Out","value":966},{"label":"Nov","value":774},{"label":"Dez","value":931}];
const MX = 966;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#94a3b8'}}>RTM</span></h1>
                </div>
