...
const PAGE = "Search";
const KPIS = [{"l":"Dashboards Ativos","v":"7.117","t":"-3.4%","d":"down"},{"l":"Queries/Dia","v":"3243","t":"+4.5%","d":"up"},{"l":"Dados Processados (GB)","v":"3.726","t":"-0.1%","d":"down"},{"l":"Utilizadores Analytics","v":"1.171","t":"+4.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3812","2026-02-02","3.815","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","166","2026-03-01","8.561","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4056","2026-03-21","4.576","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4717","2026-01-01","5.635","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2996","2026-02-21","7.887","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":422},{"label":"Fev","value":544},{"label":"Mar","value":400},{"label":"Abr","value":741},{"label":"Mai","value":500},{"label":"Jun","value":610},{"label":"Jul","value":429},{"label":"Ago","value":581},{"label":"Set","value":480},{"label":"Out","value":366},{"label":"Nov","value":560},{"label":"Dez","value":609}];
const MX = 741;
