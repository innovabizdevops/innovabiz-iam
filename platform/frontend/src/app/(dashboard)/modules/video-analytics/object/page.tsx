...
const PAGE = "Object";
const KPIS = [{"l":"Dashboards Ativos","v":"8.863","t":"-5.8%","d":"down"},{"l":"Queries/Dia","v":"2226","t":"+1.1%","d":"up"},{"l":"Dados Processados (GB)","v":"7.880","t":"+14.1%","d":"up"},{"l":"Utilizadores Analytics","v":"6.016","t":"+7.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3537","2026-01-17","2.787","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","111","2026-02-24","3.169","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1845","2026-02-19","8.373","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1375","2026-02-14","5.544","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4173","2026-02-09","3.990","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":260},{"label":"Fev","value":470},{"label":"Mar","value":634},{"label":"Abr","value":424},{"label":"Mai","value":407},{"label":"Jun","value":468},{"label":"Jul","value":391},{"label":"Ago","value":528},{"label":"Set","value":524},{"label":"Out","value":364},{"label":"Nov","value":541},{"label":"Dez","value":447}];
const MX = 634;
