...
/* ═══ Video Analytics Platform — Dashboard ═══ */

const ACCENT = "#94a3b8";

const KPIS = [
    { label: "Total Registos", value: "4655", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "616", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€269K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1346048155", cells: ["VID-9155", "Video Analytics Platform Item 1", "12/8/2026", "€48 255"], status: "active" as const },
    { id: "1346051726", cells: ["VID-3726", "Video Analytics Platform Item 2", "27/3/2026", "€1826"], status: "pending" as const },
    { id: "1346055297", cells: ["VID-7297", "Video Analytics Platform Item 3", "14/10/2026", "€5397"], status: "completed" as const },
    { id: "1346058868", cells: ["VID-1868", "Video Analytics Platform Item 4", "1/5/2026", "€8968"], status: "warning" as const },
    { id: "1346062439", cells: ["VID-5439", "Video Analytics Platform Item 5", "16/12/2026", "€12 539"], status: "active" as const },
];
...
export default function VideoAnalyticsPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Video Analytics Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Video Analytics Platform</p>
                    </div>
                </div>
