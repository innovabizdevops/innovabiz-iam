...
/* ═══ S-AI Deception Technology — Dashboard ═══ */

const ACCENT = "#991b1b";

const KPIS = [
    { label: "Total Registos", value: "9394", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4268", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€371K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "-2%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "971615094", cells: ["SAI-3094", "S-AI Deception Technology Item 1", "3/7/2026", "€15 194"], status: "active" as const },
    { id: "971618665", cells: ["SAI-6665", "S-AI Deception Technology Item 2", "18/2/2026", "€18 765"], status: "pending" as const },
    { id: "971622236", cells: ["SAI-1236", "S-AI Deception Technology Item 3", "5/9/2026", "€22 336"], status: "completed" as const },
    { id: "971625807", cells: ["SAI-4807", "S-AI Deception Technology Item 4", "20/4/2026", "€25 907"], status: "warning" as const },
    { id: "971629378", cells: ["SAI-8378", "S-AI Deception Technology Item 5", "7/11/2026", "€29 478"], status: "active" as const },
];
...
export default function SaiDeceptionTechnologyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">S-AI Deception Technology</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • S-AI Deception Technology</p>
                    </div>
                </div>
