...
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"3.274","t":"+9.4%","d":"up"},{"l":"Taxa Entrega (%)","v":"82.4%","t":"+8.8%","d":"up"},{"l":"Taxa Abertura (%)","v":"75.1%","t":"+11.4%","d":"up"},{"l":"Escalações","v":"2.233","t":"+4.4%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","4.176","91.9%","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","5.628","78.8%","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","8.483","94.2%","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","5.933","75.3%","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","2.717","71.2%","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":590},{"label":"Mar","value":605},{"label":"Abr","value":371},{"label":"Mai","value":245},{"label":"Jun","value":553},{"label":"Jul","value":409},{"label":"Ago","value":385},{"label":"Set","value":515},{"label":"Out","value":601},{"label":"Nov","value":301},{"label":"Dez","value":356}];
const MX = 605;
