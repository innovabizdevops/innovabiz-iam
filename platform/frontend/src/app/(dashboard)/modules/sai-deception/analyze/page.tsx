...
const ACCENT = "#991b1b";
const MODULE = "S-AI Deception Technology";
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"8.200","t":"+0.5%","d":"up"},{"l":"Queries/Dia","v":"4082","t":"+3.9%","d":"up"},{"l":"Dados Processados (GB)","v":"3.155","t":"+3.7%","d":"up"},{"l":"Utilizadores Analytics","v":"1.534","t":"+12.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3437","2026-03-02","8.925","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4188","2026-02-18","409","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3703","2026-02-07","1.037","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","579","2026-02-19","3.241","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3151","2026-01-25","5.802","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":818},{"label":"Mar","value":655},{"label":"Abr","value":534},{"label":"Mai","value":811},{"label":"Jun","value":561},{"label":"Jul","value":600},{"label":"Ago","value":746},{"label":"Set","value":791},{"label":"Out","value":817},{"label":"Nov","value":596},{"label":"Dez","value":848}];
const MX = 848;
