...
/* ═══ Packaging Analytics — Dashboard ═══ */

const ACCENT = "#854d0e";

const KPIS = [
    { label: "Total Registos", value: "433", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4565", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€177K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "-16%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1954775133", cells: ["PAC-3133", "Packaging Analytics Item 1", "18/10/2026", "€25 233"], status: "active" as const },
    { id: "1954778704", cells: ["PAC-6704", "Packaging Analytics Item 2", "5/5/2026", "€28 804"], status: "pending" as const },
    { id: "1954782275", cells: ["PAC-1275", "Packaging Analytics Item 3", "20/12/2026", "€32 375"], status: "completed" as const },
    { id: "1954785846", cells: ["PAC-4846", "Packaging Analytics Item 4", "7/7/2026", "€35 946"], status: "warning" as const },
    { id: "1954789417", cells: ["PAC-8417", "Packaging Analytics Item 5", "22/2/2026", "€39 517"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Packaging Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Packaging Analytics</p>
                    </div>
                </div>
