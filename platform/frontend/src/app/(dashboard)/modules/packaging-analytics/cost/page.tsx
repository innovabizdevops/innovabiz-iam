...
const PAGE = "Cost";
const KPIS = [{"l":"Dashboards Ativos","v":"205","t":"+6.3%","d":"up"},{"l":"Queries/Dia","v":"2818","t":"+9.4%","d":"up"},{"l":"Dados Processados (GB)","v":"8.495","t":"+10.8%","d":"up"},{"l":"Utilizadores Analytics","v":"4.091","t":"+16.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1865","2026-03-25","5.017","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1918","2026-01-11","4.090","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2735","2026-02-10","6.767","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","958","2026-01-16","2.617","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","939","2026-02-01","7.674","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":355},{"label":"Fev","value":666},{"label":"Mar","value":488},{"label":"Abr","value":555},{"label":"Mai","value":607},{"label":"Jun","value":365},{"label":"Jul","value":542},{"label":"Ago","value":635},{"label":"Set","value":653},{"label":"Out","value":396},{"label":"Nov","value":455},{"label":"Dez","value":653}];
const MX = 666;
