...
const ACCENT = "#854d0e";
const MODULE = "Packaging Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"7.791","t":"-3.3%","d":"down"},{"l":"Queries/Dia","v":"2473","t":"+12.8%","d":"up"},{"l":"Dados Processados (GB)","v":"8.290","t":"-0.1%","d":"down"},{"l":"Utilizadores Analytics","v":"8.629","t":"-4.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1634","2026-02-10","3.366","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1444","2026-01-25","1.937","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1271","2026-01-11","4.442","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3907","2026-03-18","824","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1999","2026-02-24","6.883","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":375},{"label":"Fev","value":445},{"label":"Mar","value":310},{"label":"Abr","value":385},{"label":"Mai","value":540},{"label":"Jun","value":582},{"label":"Jul","value":424},{"label":"Ago","value":508},{"label":"Set","value":421},{"label":"Out","value":526},{"label":"Nov","value":521},{"label":"Dez","value":410}];
const MX = 582;
