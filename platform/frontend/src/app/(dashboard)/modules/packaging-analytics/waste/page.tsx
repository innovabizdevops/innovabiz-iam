...
const PAGE = "Waste";
const KPIS = [{"l":"Dashboards Ativos","v":"1.403","t":"+9.5%","d":"up"},{"l":"Queries/Dia","v":"3289","t":"-1.2%","d":"down"},{"l":"Dados Processados (GB)","v":"1.143","t":"+15.4%","d":"up"},{"l":"Utilizadores Analytics","v":"7.727","t":"-1.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1040","2026-02-26","8.519","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2740","2026-03-28","4.163","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3258","2026-01-14","3.102","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","831","2026-01-24","188","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4778","2026-02-19","4.820","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":804},{"label":"Mar","value":807},{"label":"Abr","value":941},{"label":"Mai","value":705},{"label":"Jun","value":935},{"label":"Jul","value":673},{"label":"Ago","value":838},{"label":"Set","value":824},{"label":"Out","value":667},{"label":"Nov","value":941},{"label":"Dez","value":884}];
const MX = 941;
