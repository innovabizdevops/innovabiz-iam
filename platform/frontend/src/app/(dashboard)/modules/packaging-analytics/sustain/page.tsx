...
const PAGE = "Sustain";
const KPIS = [{"l":"Dashboards Ativos","v":"7.248","t":"+13.5%","d":"up"},{"l":"Queries/Dia","v":"4581","t":"+9.6%","d":"up"},{"l":"Dados Processados (GB)","v":"3.955","t":"+5.7%","d":"up"},{"l":"Utilizadores Analytics","v":"5.671","t":"+8.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4788","2026-03-19","3.241","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","153","2026-02-23","7.698","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4248","2026-01-07","4.373","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3101","2026-01-24","6.319","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2915","2026-01-13","8.057","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":537},{"label":"Mar","value":347},{"label":"Abr","value":298},{"label":"Mai","value":577},{"label":"Jun","value":354},{"label":"Jul","value":478},{"label":"Ago","value":332},{"label":"Set","value":507},{"label":"Out","value":636},{"label":"Nov","value":512},{"label":"Dez","value":565}];
const MX = 636;
