...
const PAGE = "Material";
const KPIS = [{"l":"Dashboards Ativos","v":"3.573","t":"+9.8%","d":"up"},{"l":"Queries/Dia","v":"2551","t":"-2.5%","d":"down"},{"l":"Dados Processados (GB)","v":"2.856","t":"+7.2%","d":"up"},{"l":"Utilizadores Analytics","v":"2.371","t":"+0.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2632","2026-02-17","3.123","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4851","2026-03-27","2.434","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","115","2026-01-07","6.504","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3359","2026-01-21","5.064","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2160","2026-03-09","1.262","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":860},{"label":"Mar","value":747},{"label":"Abr","value":633},{"label":"Mai","value":617},{"label":"Jun","value":802},{"label":"Jul","value":564},{"label":"Ago","value":891},{"label":"Set","value":841},{"label":"Out","value":843},{"label":"Nov","value":659},{"label":"Dez","value":819}];
const MX = 891;
