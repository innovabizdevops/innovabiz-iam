...
const KPIS = [{"l":"Riscos Identificados","v":"1.632","t":"+16.8%","d":"up"},{"l":"Mitigações Ativas","v":"3.709","t":"-2.9%","d":"down"},{"l":"Score Risco Geral","v":"92","t":"+5.2%","d":"up"},{"l":"Incidentes YTD","v":"5.231","t":"+2.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","486","6.626","5.903","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","735","2.225","446","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.996","2.305","8.400","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.670","6.946","5.466","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","229","1.906","8.795","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":750},{"label":"Mar","value":792},{"label":"Abr","value":588},{"label":"Mai","value":598},{"label":"Jun","value":771},{"label":"Jul","value":678},{"label":"Ago","value":509},{"label":"Set","value":506},{"label":"Out","value":475},{"label":"Nov","value":481},{"label":"Dez","value":455}];
const MX = 815;
