...
const PAGE = "Compliance Scans";
const KPIS = [{"l":"Riscos Identificados","v":"4.562","t":"+4.8%","d":"up"},{"l":"Mitigações Ativas","v":"2.662","t":"-2.4%","d":"down"},{"l":"Score Risco Geral","v":"56","t":"-3.1%","d":"down"},{"l":"Incidentes YTD","v":"2.613","t":"+11.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.038","7.814","2.027","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.977","2.550","4.903","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.647","1.509","8.693","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.278","4.912","5.670","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","9.077","562","7.951","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":387},{"label":"Fev","value":305},{"label":"Mar","value":463},{"label":"Abr","value":533},{"label":"Mai","value":631},{"label":"Jun","value":644},{"label":"Jul","value":428},{"label":"Ago","value":430},{"label":"Set","value":357},{"label":"Out","value":496},{"label":"Nov","value":570},{"label":"Dez","value":434}];
const MX = 644;
...
export default function ComplianceScansPage() {
    return (
