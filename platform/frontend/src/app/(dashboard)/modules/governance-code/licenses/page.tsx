...
const PAGE = "License Compliance";
const KPIS = [{"l":"Riscos Identificados","v":"4.240","t":"+9.1%","d":"up"},{"l":"Mitigações Ativas","v":"6.787","t":"+15.9%","d":"up"},{"l":"Score Risco Geral","v":"73","t":"+12.1%","d":"up"},{"l":"Incidentes YTD","v":"5.273","t":"+6.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.961","4.496","7.481","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.447","8.561","9.075","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","181","477","8.713","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.327","1.862","6.705","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.153","2.185","1.247","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":583},{"label":"Mar","value":510},{"label":"Abr","value":464},{"label":"Mai","value":684},{"label":"Jun","value":646},{"label":"Jul","value":717},{"label":"Ago","value":543},{"label":"Set","value":698},{"label":"Out","value":497},{"label":"Nov","value":526},{"label":"Dez","value":592}];
const MX = 717;
