...
const KPIS = [{"l":"Riscos Identificados","v":"497","t":"+13.2%","d":"up"},{"l":"Mitigações Ativas","v":"6.296","t":"+6.4%","d":"up"},{"l":"Score Risco Geral","v":"61","t":"-1.8%","d":"down"},{"l":"Incidentes YTD","v":"3.877","t":"+15.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.364","792","5.427","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.990","2.647","7.718","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.617","7.610","2.331","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.376","8.215","6.770","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.908","3.401","3.275","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":917},{"label":"Fev","value":810},{"label":"Mar","value":692},{"label":"Abr","value":808},{"label":"Mai","value":910},{"label":"Jun","value":967},{"label":"Jul","value":893},{"label":"Ago","value":735},{"label":"Set","value":627},{"label":"Out","value":722},{"label":"Nov","value":746},{"label":"Dez","value":895}];
const MX = 967;
