...
const PAGE = "ArchiMate Models";
const KPIS = [{"l":"Riscos Identificados","v":"1.513","t":"-2.5%","d":"down"},{"l":"Mitigações Ativas","v":"7.676","t":"+6.5%","d":"up"},{"l":"Score Risco Geral","v":"82","t":"+14.3%","d":"up"},{"l":"Incidentes YTD","v":"3.644","t":"+10.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.759","7.329","8.246","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.716","972","8.111","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.142","2.728","8.956","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","905","1.085","3.732","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.021","1.572","3.319","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":806},{"label":"Mar","value":912},{"label":"Abr","value":916},{"label":"Mai","value":934},{"label":"Jun","value":678},{"label":"Jul","value":944},{"label":"Ago","value":731},{"label":"Set","value":882},{"label":"Out","value":898},{"label":"Nov","value":815},{"label":"Dez","value":618}];
const MX = 944;
