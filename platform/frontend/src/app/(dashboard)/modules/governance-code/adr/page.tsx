...
const PAGE = "ADR Repository";
const KPIS = [{"l":"Riscos Identificados","v":"7.553","t":"+8.2%","d":"up"},{"l":"Mitigações Ativas","v":"1.482","t":"+6.2%","d":"up"},{"l":"Score Risco Geral","v":"94","t":"+11.5%","d":"up"},{"l":"Incidentes YTD","v":"5.902","t":"+0.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.759","8.968","7.621","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.107","2.065","3.120","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.248","4.985","4.852","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.646","2.378","6.000","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.568","1.305","5.011","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":255},{"label":"Mar","value":582},{"label":"Abr","value":548},{"label":"Mai","value":543},{"label":"Jun","value":417},{"label":"Jul","value":297},{"label":"Ago","value":494},{"label":"Set","value":387},{"label":"Out","value":387},{"label":"Nov","value":367},{"label":"Dez","value":261}];
const MX = 617;
