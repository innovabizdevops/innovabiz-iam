...
const ACCENT = "#4338ca";
const MODULE = "Governance as Code";
const PAGE = "Auto-Remediation";
const KPIS = [{"l":"Riscos Identificados","v":"8.725","t":"+11.6%","d":"up"},{"l":"Mitigações Ativas","v":"8.952","t":"+17.1%","d":"up"},{"l":"Score Risco Geral","v":"72","t":"+7.6%","d":"up"},{"l":"Incidentes YTD","v":"6.269","t":"+12.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.013","1.171","2.883","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.101","1.700","8.909","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.009","8.112","7.635","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.095","4.705","7.154","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.810","6.359","7.795","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":655},{"label":"Mar","value":842},{"label":"Abr","value":504},{"label":"Mai","value":729},{"label":"Jun","value":610},{"label":"Jul","value":604},{"label":"Ago","value":700},{"label":"Set","value":535},{"label":"Out","value":539},{"label":"Nov","value":742},{"label":"Dez","value":749}];
const MX = 842;
