...
const KPIS = [{"l":"Riscos Identificados","v":"8.960","t":"+6.5%","d":"up"},{"l":"Mitigações Ativas","v":"3.387","t":"+5.6%","d":"up"},{"l":"Score Risco Geral","v":"75","t":"+15.5%","d":"up"},{"l":"Incidentes YTD","v":"6.103","t":"+3.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.591","1.898","4.526","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.925","2.394","3.473","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.708","1.021","8.105","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.577","599","6.947","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.653","741","2.285","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":367},{"label":"Mar","value":458},{"label":"Abr","value":538},{"label":"Mai","value":477},{"label":"Jun","value":626},{"label":"Jul","value":641},{"label":"Ago","value":533},{"label":"Set","value":491},{"label":"Out","value":503},{"label":"Nov","value":358},{"label":"Dez","value":347}];
const MX = 666;
