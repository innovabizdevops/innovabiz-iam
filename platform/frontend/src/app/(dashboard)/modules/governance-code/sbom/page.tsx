...
const PAGE = "SBOM Manager";
const KPIS = [{"l":"Riscos Identificados","v":"918","t":"+17.5%","d":"up"},{"l":"Mitigações Ativas","v":"1.578","t":"+15.7%","d":"up"},{"l":"Score Risco Geral","v":"95","t":"+17.2%","d":"up"},{"l":"Incidentes YTD","v":"8.287","t":"-2.7%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.283","5.705","983","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.379","207","1.914","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","992","5.808","4.208","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","292","1.540","1.098","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.659","7.187","425","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":640},{"label":"Mar","value":753},{"label":"Abr","value":721},{"label":"Mai","value":750},{"label":"Jun","value":770},{"label":"Jul","value":594},{"label":"Ago","value":863},{"label":"Set","value":560},{"label":"Out","value":543},{"label":"Nov","value":870},{"label":"Dez","value":668}];
const MX = 870;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>SBOM</span></h1>
                </div>
