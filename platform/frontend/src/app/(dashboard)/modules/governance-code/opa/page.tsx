...
const PAGE = "OPA Rego Editor";
const KPIS = [{"l":"Riscos Identificados","v":"4.354","t":"+10.3%","d":"up"},{"l":"Mitigações Ativas","v":"2.091","t":"+3.7%","d":"up"},{"l":"Score Risco Geral","v":"67","t":"+10.9%","d":"up"},{"l":"Incidentes YTD","v":"842","t":"+15.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.647","4.182","423","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.857","948","2.528","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","890","249","9.007","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.429","3.044","8.648","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.606","7.178","8.775","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":996},{"label":"Fev","value":988},{"label":"Mar","value":913},{"label":"Abr","value":686},{"label":"Mai","value":856},{"label":"Jun","value":993},{"label":"Jul","value":611},{"label":"Ago","value":741},{"label":"Set","value":893},{"label":"Out","value":682},{"label":"Nov","value":784},{"label":"Dez","value":715}];
const MX = 996;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>OPA</span></h1>
                </div>
