...
const ACCENT = "#ec4899";
const MODULE = "PLM Fashion";
const PAGE = "Circular Design";
const KPIS = [{"l":"Formulários Ativos","v":"6.769","t":"+2.8%","d":"up"},{"l":"Submissões/Dia","v":"4381","t":"+13.7%","d":"up"},{"l":"Documentos Gerados","v":"4.214","t":"+3.8%","d":"up"},{"l":"Templates","v":"6.716","t":"+12.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.389","2026-01-19","733","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.112","2026-03-06","4.971","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.144","2026-01-25","4.802","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.128","2026-01-07","2.165","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.139","2026-02-21","2.267","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":869},{"label":"Fev","value":836},{"label":"Mar","value":583},{"label":"Abr","value":959},{"label":"Mai","value":639},{"label":"Jun","value":705},{"label":"Jul","value":823},{"label":"Ago","value":662},{"label":"Set","value":730},{"label":"Out","value":581},{"label":"Nov","value":909},{"label":"Dez","value":865}];
const MX = 959;
