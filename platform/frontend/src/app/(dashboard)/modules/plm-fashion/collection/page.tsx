...
const PAGE = "Collection Plan";
const KPIS = [{"l":"Produtos Ativos","v":"5.315","t":"+5.8%","d":"up"},{"l":"SKUs","v":"2.264","t":"+4.7%","d":"up"},{"l":"ECNs Pendentes","v":"5.154","t":"+6.2%","d":"up"},{"l":"Time-to-Market (dias)","v":"1.363","t":"+1.3%","d":"up"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","5.285","8.051","5.166","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","7.062","5.177","4.994","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","4.430","5.907","1.913","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","7.012","5.944","8.662","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","5.438","885","8.182","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":600},{"label":"Mar","value":544},{"label":"Abr","value":871},{"label":"Mai","value":781},{"label":"Jun","value":554},{"label":"Jul","value":706},{"label":"Ago","value":783},{"label":"Set","value":811},{"label":"Out","value":672},{"label":"Nov","value":719},{"label":"Dez","value":645}];
const MX = 871;
