...
const PAGE = "Season Mgmt";
const KPIS = [{"l":"Produtos Ativos","v":"2.870","t":"+5.7%","d":"up"},{"l":"SKUs","v":"8.676","t":"+1.1%","d":"up"},{"l":"ECNs Pendentes","v":"6.343","t":"+17.3%","d":"up"},{"l":"Time-to-Market (dias)","v":"1.788","t":"+8.7%","d":"up"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","7.395","6.370","6.595","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","1.318","5.539","7.195","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","6.088","8.010","2.443","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","4.362","5.986","1.647","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","7.944","3.292","1.377","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":845},{"label":"Mar","value":768},{"label":"Abr","value":1015},{"label":"Mai","value":633},{"label":"Jun","value":699},{"label":"Jul","value":991},{"label":"Ago","value":1000},{"label":"Set","value":818},{"label":"Out","value":840},{"label":"Nov","value":780},{"label":"Dez","value":976}];
const MX = 1015;
