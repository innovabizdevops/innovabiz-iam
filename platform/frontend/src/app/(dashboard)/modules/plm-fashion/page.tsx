...
export default function PlmFashionPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Plm Fashion</h1><p className="text-sm text-muted-foreground">Plm Fashion • iBOS Enterprise</p></div>
