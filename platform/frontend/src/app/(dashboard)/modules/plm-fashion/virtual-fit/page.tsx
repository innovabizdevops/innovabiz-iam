...
const PAGE = "Virtual Fitting";
const KPIS = [{"l":"Produtos Ativos","v":"3.350","t":"+10.3%","d":"up"},{"l":"SKUs","v":"2.365","t":"-5.9%","d":"down"},{"l":"ECNs Pendentes","v":"8.921","t":"+13.0%","d":"up"},{"l":"Time-to-Market (dias)","v":"1.083","t":"+6.7%","d":"up"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","6.475","4.106","658","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","3.823","4.741","4.153","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","2.370","7.536","3.295","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","7.450","8.821","2.648","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","4.720","2.672","7.172","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":702},{"label":"Mar","value":577},{"label":"Abr","value":819},{"label":"Mai","value":843},{"label":"Jun","value":787},{"label":"Jul","value":553},{"label":"Ago","value":673},{"label":"Set","value":718},{"label":"Out","value":685},{"label":"Nov","value":617},{"label":"Dez","value":823}];
const MX = 843;
