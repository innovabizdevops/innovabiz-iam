...
const PAGE = "Colorway";
const KPIS = [{"l":"Produtos Ativos","v":"5.057","t":"+15.7%","d":"up"},{"l":"SKUs","v":"6.639","t":"-4.3%","d":"down"},{"l":"ECNs Pendentes","v":"5.181","t":"+12.8%","d":"up"},{"l":"Time-to-Market (dias)","v":"1.918","t":"+2.9%","d":"up"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","1.602","3.992","5.357","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","1.120","2.330","5.386","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","5.023","2.825","7.304","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","7.968","8.598","6.991","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","3.714","351","3.861","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":426},{"label":"Fev","value":319},{"label":"Mar","value":474},{"label":"Abr","value":516},{"label":"Mai","value":493},{"label":"Jun","value":462},{"label":"Jul","value":421},{"label":"Ago","value":216},{"label":"Set","value":433},{"label":"Out","value":483},{"label":"Nov","value":320},{"label":"Dez","value":227}];
const MX = 516;
...
export default function ColorwayPage() {
    return (
