...
const KPIS = [{"l":"Formulários Ativos","v":"1.791","t":"+12.9%","d":"up"},{"l":"Submissões/Dia","v":"1056","t":"-3.0%","d":"down"},{"l":"Documentos Gerados","v":"9.050","t":"+4.5%","d":"up"},{"l":"Templates","v":"4.325","t":"+5.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.527","2026-03-17","359","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.941","2026-02-06","4.616","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.567","2026-03-07","7.281","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.409","2026-03-11","7.526","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.650","2026-02-26","5.279","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":899},{"label":"Mar","value":684},{"label":"Abr","value":765},{"label":"Mai","value":705},{"label":"Jun","value":817},{"label":"Jul","value":833},{"label":"Ago","value":588},{"label":"Set","value":730},{"label":"Out","value":714},{"label":"Nov","value":632},{"label":"Dez","value":809}];
const MX = 899;
