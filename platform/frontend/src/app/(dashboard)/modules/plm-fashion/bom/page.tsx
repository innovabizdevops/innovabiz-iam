...
const PAGE = "BOM Builder";
const KPIS = [{"l":"Produtos Ativos","v":"1.493","t":"+6.0%","d":"up"},{"l":"SKUs","v":"7.666","t":"-5.9%","d":"down"},{"l":"ECNs Pendentes","v":"3.177","t":"+9.8%","d":"up"},{"l":"Time-to-Market (dias)","v":"8.879","t":"-0.9%","d":"down"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","6.690","4.152","3.003","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","5.896","7.017","1.507","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","7.971","6.574","5.736","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","1.882","4.239","160","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","2.154","5.588","7.699","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":614},{"label":"Mar","value":529},{"label":"Abr","value":620},{"label":"Mai","value":525},{"label":"Jun","value":447},{"label":"Jul","value":678},{"label":"Ago","value":312},{"label":"Set","value":410},{"label":"Out","value":456},{"label":"Nov","value":440},{"label":"Dez","value":639}];
const MX = 678;
