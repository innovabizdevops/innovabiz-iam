...
const KPIS = [{"l":"Total Public Works","v":"4.105","t":"+10.7%","d":"up"},{"l":"Maintenance Ativos","v":"2.158","t":"+9.8%","d":"up"},{"l":"Eficiência (%)","v":"91.9%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"80","t":"+17.9%","d":"up"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Works #001","Public Works #002","8.839","8.304","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Public Works #002","Public Works #003","2.437","8.966","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Works #003","Public Works #004","6.736","7.685","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Public Works #004","Public Works #005","7.410","887","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Works #005","Public Works #001","6.040","135","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":376},{"label":"Fev","value":534},{"label":"Mar","value":343},{"label":"Abr","value":571},{"label":"Mai","value":530},{"label":"Jun","value":672},{"label":"Jul","value":566},{"label":"Ago","value":436},{"label":"Set","value":462},{"label":"Out","value":613},{"label":"Nov","value":720},{"label":"Dez","value":685}];
const MX = 720;
