...
const ACCENT = "#475569";
const MODULE = "Public Works";
const PAGE = "Asset Registry";
const KPIS = [{"l":"Ativos Registados","v":"8.616","t":"+2.9%","d":"up"},{"l":"Valor Total (€M)","v":"€26.5M","t":"-3.2%","d":"down"},{"l":"Depreciação Anual (€)","v":"€43453","t":"-1.6%","d":"down"},{"l":"Ativos em Garantia","v":"7.545","t":"-5.2%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 36061.16","1.223","€ 5240.26","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 10506.06","5.861","€ 46374.02","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 36200.51","7.008","€ 29022.55","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 19736.13","5.108","€ 13767.25","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 547.74","3.457","€ 47969.78","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":477},{"label":"Mar","value":558},{"label":"Abr","value":519},{"label":"Mai","value":386},{"label":"Jun","value":429},{"label":"Jul","value":463},{"label":"Ago","value":398},{"label":"Set","value":278},{"label":"Out","value":382},{"label":"Nov","value":562},{"label":"Dez","value":489}];
const MX = 580;
