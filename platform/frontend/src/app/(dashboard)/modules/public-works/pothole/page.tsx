...
const PAGE = "Pothole Track";
const KPIS = [{"l":"Total Public Works","v":"6.767","t":"-3.1%","d":"down"},{"l":"Pothole Track Ativos","v":"2.364","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"83.8%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"93","t":"-0.5%","d":"down"}];
const COLS = ["ID","Pothole Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Works #001","Public Works #002","4.887","2.400","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Public Works #002","Public Works #003","1.384","8.893","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Works #003","Public Works #004","534","557","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Public Works #004","Public Works #005","7.190","5.324","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Works #005","Public Works #001","3.678","1.421","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":383},{"label":"Mar","value":436},{"label":"Abr","value":376},{"label":"Mai","value":427},{"label":"Jun","value":735},{"label":"Jul","value":662},{"label":"Ago","value":626},{"label":"Set","value":677},{"label":"Out","value":680},{"label":"Nov","value":415},{"label":"Dez","value":398}];
const MX = 735;
