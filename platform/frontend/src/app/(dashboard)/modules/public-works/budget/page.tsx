...
const KPIS = [{"l":"Total Public Works","v":"5.454","t":"+10.9%","d":"up"},{"l":"Budget Track Ativos","v":"€17048","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"93.1%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"66","t":"+15.2%","d":"up"}];
const COLS = ["ID","Budget Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Works #001","€ 3069.13","3.064","650","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Public Works #002","€ 12539.93","4.548","3.657","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Works #003","€ 40977.76","7.347","3.802","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Public Works #004","€ 39412.60","7.136","6.849","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Works #005","€ 26287.36","2.801","4.452","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":779},{"label":"Mar","value":815},{"label":"Abr","value":804},{"label":"Mai","value":462},{"label":"Jun","value":654},{"label":"Jul","value":696},{"label":"Ago","value":812},{"label":"Set","value":626},{"label":"Out","value":525},{"label":"Nov","value":747},{"label":"Dez","value":679}];
const MX = 815;
