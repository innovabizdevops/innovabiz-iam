...
const PAGE = "CIP Clean";
const KPIS = [{"l":"Projetos Melhoria","v":"6.173","t":"+2.9%","d":"up"},{"l":"Savings (€)","v":"€74045","t":"+10.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"82.8%","t":"-3.9%","d":"down"},{"l":"Ciclos PDCA","v":"385","t":"+6.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.442","€ 24339.85","6.136","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.667","€ 23905.58","474","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.085","€ 43170.62","4.727","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.335","€ 20407.65","5.315","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.299","€ 27684.32","3.270","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":847},{"label":"Fev","value":816},{"label":"Mar","value":584},{"label":"Abr","value":663},{"label":"Mai","value":811},{"label":"Jun","value":642},{"label":"Jul","value":629},{"label":"Ago","value":818},{"label":"Set","value":610},{"label":"Out","value":668},{"label":"Nov","value":928},{"label":"Dez","value":695}];
const MX = 928;
