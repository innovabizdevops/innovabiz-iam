...
const ACCENT = "#059669";
const MODULE = "Beverage Filling";
const PAGE = "Carbonation";
const KPIS = [{"l":"Total Beverage Fill","v":"8.899","t":"+14.5%","d":"up"},{"l":"Carbonation Ativos","v":"2.619","t":"+1.8%","d":"up"},{"l":"Eficiência (%)","v":"74.9%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"64","t":"+8.2%","d":"up"}];
const COLS = ["ID","Carbonation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Beverage Fill #001","Beverage Fill #002","5.775","1.817","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Beverage Fill #002","Beverage Fill #003","1.585","6.960","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Beverage Fill #003","Beverage Fill #004","1.925","2.880","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Beverage Fill #004","Beverage Fill #005","1.508","4.939","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Beverage Fill #005","Beverage Fill #001","4.864","1.153","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1065},{"label":"Fev","value":1033},{"label":"Mar","value":766},{"label":"Abr","value":982},{"label":"Mai","value":985},{"label":"Jun","value":747},{"label":"Jul","value":763},{"label":"Ago","value":1012},{"label":"Set","value":996},{"label":"Out","value":750},{"label":"Nov","value":867},{"label":"Dez","value":1004}];
const MX = 1065;
...
export default function CarbonationPage() {
    return (
