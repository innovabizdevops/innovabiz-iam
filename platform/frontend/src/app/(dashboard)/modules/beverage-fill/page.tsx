...
export default function BeverageFillPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Beverage Fill</h1><p className="text-sm text-muted-foreground">Beverage Fill • iBOS Enterprise</p></div>
