...
const ACCENT = "#92400e";
const MODULE = "Hotel Revenue Mgmt";
const PAGE = "Rate Strategy";
const KPIS = [{"l":"ARR (€M)","v":"€15.7M","t":"+13.9%","d":"up"},{"l":"MRR (€)","v":"€44388","t":"-2.9%","d":"down"},{"l":"Churn (%)","v":"90.7%","t":"+7.0%","d":"up"},{"l":"ARPU (€)","v":"€70832","t":"-1.0%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 46141.62","7.791","€ 25363.70","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 41692.29","8.451","€ 30978.96","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 9193.38","5.647","€ 1830.33","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 11397.82","2.460","€ 24113.19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 3264.21","1.073","€ 308.52","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":932},{"label":"Fev","value":659},{"label":"Mar","value":886},{"label":"Abr","value":865},{"label":"Mai","value":670},{"label":"Jun","value":741},{"label":"Jul","value":715},{"label":"Ago","value":843},{"label":"Set","value":661},{"label":"Out","value":859},{"label":"Nov","value":839},{"label":"Dez","value":659}];
const MX = 932;
