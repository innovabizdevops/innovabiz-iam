...
const PAGE = "Channel";
const KPIS = [{"l":"ARR (€M)","v":"€21.4M","t":"-2.0%","d":"down"},{"l":"MRR (€)","v":"€67547","t":"-3.2%","d":"down"},{"l":"Churn (%)","v":"73.3%","t":"-2.9%","d":"down"},{"l":"ARPU (€)","v":"€4799","t":"+3.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 9382.71","7.933","€ 24710.82","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 12063.06","886","€ 24757.18","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 39563.60","6.586","€ 1042.26","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 46222.36","7.871","€ 35092.19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 48724.10","7.787","€ 37377.87","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":619},{"label":"Mar","value":935},{"label":"Abr","value":683},{"label":"Mai","value":645},{"label":"Jun","value":910},{"label":"Jul","value":779},{"label":"Ago","value":560},{"label":"Set","value":828},{"label":"Out","value":595},{"label":"Nov","value":706},{"label":"Dez","value":609}];
const MX = 935;
