...
const PAGE = "Forecast";
const KPIS = [{"l":"ARR (€M)","v":"€32.3M","t":"+2.6%","d":"up"},{"l":"MRR (€)","v":"€55725","t":"-3.6%","d":"down"},{"l":"Churn (%)","v":"74.8%","t":"+3.1%","d":"up"},{"l":"ARPU (€)","v":"€2095","t":"+16.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 37073.31","3.666","€ 46223.74","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 5905.84","6.126","€ 26148.59","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 13344.38","5.935","€ 7624.33","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 25607.80","5.913","€ 34090.90","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 14852.88","4.046","€ 23697.80","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":627},{"label":"Mar","value":684},{"label":"Abr","value":667},{"label":"Mai","value":604},{"label":"Jun","value":321},{"label":"Jul","value":654},{"label":"Ago","value":534},{"label":"Set","value":658},{"label":"Out","value":365},{"label":"Nov","value":355},{"label":"Dez","value":701}];
const MX = 701;
