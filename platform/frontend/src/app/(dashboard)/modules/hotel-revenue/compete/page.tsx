...
const PAGE = "Compete";
const KPIS = [{"l":"ARR (€M)","v":"€24.9M","t":"+2.1%","d":"up"},{"l":"MRR (€)","v":"€65550","t":"+11.3%","d":"up"},{"l":"Churn (%)","v":"90.1%","t":"+7.2%","d":"up"},{"l":"ARPU (€)","v":"€89559","t":"+1.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 40313.04","8.323","€ 33883.93","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 496.28","1.897","€ 40814.78","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 21921.54","6.335","€ 26577.48","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 31094.39","7.031","€ 3019.29","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 6178.91","1.557","€ 2160.23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":712},{"label":"Fev","value":694},{"label":"Mar","value":646},{"label":"Abr","value":831},{"label":"Mai","value":595},{"label":"Jun","value":753},{"label":"Jul","value":823},{"label":"Ago","value":822},{"label":"Set","value":780},{"label":"Out","value":567},{"label":"Nov","value":777},{"label":"Dez","value":901}];
const MX = 901;
