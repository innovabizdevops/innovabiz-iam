...
const PAGE = "Report";
const KPIS = [{"l":"ARR (€M)","v":"€26.1M","t":"+17.3%","d":"up"},{"l":"MRR (€)","v":"€62507","t":"+10.7%","d":"up"},{"l":"Churn (%)","v":"74.6%","t":"-2.8%","d":"down"},{"l":"ARPU (€)","v":"€99148","t":"-3.2%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 46905.98","6.570","€ 40119.82","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 17177.82","2.219","€ 21261.03","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 43898.24","4.518","€ 45215.75","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 33251.43","1.562","€ 27497.42","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 18617.80","8.081","€ 44621.41","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":975},{"label":"Mar","value":847},{"label":"Abr","value":992},{"label":"Mai","value":713},{"label":"Jun","value":1018},{"label":"Jul","value":720},{"label":"Ago","value":870},{"label":"Set","value":693},{"label":"Out","value":842},{"label":"Nov","value":927},{"label":"Dez","value":681}];
const MX = 1018;
