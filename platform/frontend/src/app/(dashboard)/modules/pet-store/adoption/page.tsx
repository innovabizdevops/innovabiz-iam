...
const ACCENT = "#ea580c";
const MODULE = "Pet Store Chain";
const PAGE = "Adoption";
const KPIS = [{"l":"Pedidos/Dia","v":"4836","t":"+6.7%","d":"up"},{"l":"GMV (€)","v":"€70941","t":"+14.1%","d":"up"},{"l":"Conversão (%)","v":"76.3%","t":"+12.2%","d":"up"},{"l":"AOV (€)","v":"€38793","t":"-2.9%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 25086.53","4.821","1.243","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 18296.14","2.513","2.366","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 23927.14","4.588","1.068","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 19359.45","7.864","3.681","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 48879.01","6.932","8.938","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":769},{"label":"Fev","value":744},{"label":"Mar","value":691},{"label":"Abr","value":894},{"label":"Mai","value":654},{"label":"Jun","value":743},{"label":"Jul","value":769},{"label":"Ago","value":927},{"label":"Set","value":819},{"label":"Out","value":927},{"label":"Nov","value":703},{"label":"Dez","value":611}];
const MX = 927;
