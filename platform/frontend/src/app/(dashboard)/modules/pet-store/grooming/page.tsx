...
const PAGE = "Grooming";
const KPIS = [{"l":"Pedidos/Dia","v":"468","t":"+7.7%","d":"up"},{"l":"GMV (€)","v":"€71724","t":"-5.2%","d":"down"},{"l":"Conversão (%)","v":"91.3%","t":"-6.0%","d":"down"},{"l":"AOV (€)","v":"€59924","t":"+0.3%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 25026.70","6.314","2.009","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 18721.32","2.079","1.961","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 1818.73","2.495","2.284","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 43172.23","2.198","4.529","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 34006.72","8.430","6.227","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":238},{"label":"Fev","value":485},{"label":"Mar","value":366},{"label":"Abr","value":497},{"label":"Mai","value":552},{"label":"Jun","value":465},{"label":"Jul","value":217},{"label":"Ago","value":564},{"label":"Set","value":278},{"label":"Out","value":297},{"label":"Nov","value":352},{"label":"Dez","value":419}];
const MX = 564;
