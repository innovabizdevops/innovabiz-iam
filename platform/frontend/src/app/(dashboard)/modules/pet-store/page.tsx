...
/* ═══ Pet Store Chain — Dashboard ═══ */

const ACCENT = "#ea580c";

const KPIS = [
    { label: "Total Registos", value: "1158", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4635", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€96K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "835818458", cells: ["PET-7458", "Pet Store Chain Item 1", "7/3/2026", "€18 558"], status: "active" as const },
    { id: "835822029", cells: ["PET-2029", "Pet Store Chain Item 2", "22/10/2026", "€22 129"], status: "pending" as const },
    { id: "835825600", cells: ["PET-5600", "Pet Store Chain Item 3", "9/5/2026", "€25 700"], status: "completed" as const },
    { id: "835829171", cells: ["PET-9171", "Pet Store Chain Item 4", "24/12/2026", "€29 271"], status: "warning" as const },
    { id: "835832742", cells: ["PET-3742", "Pet Store Chain Item 5", "11/7/2026", "€32 842"], status: "active" as const },
];
...
export default function PetStoreChainPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pet Store Chain</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pet Store Chain</p>
                    </div>
                </div>
