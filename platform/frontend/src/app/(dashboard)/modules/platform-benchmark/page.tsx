...
/* ═══ Platform Benchmark Suite — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "8830", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4373", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€25K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "-13%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1088424630", cells: ["PLA-1630", "Platform Benchmark Suite Item 1", "7/7/2026", "€24 730"], status: "active" as const },
    { id: "1088428201", cells: ["PLA-5201", "Platform Benchmark Suite Item 2", "22/2/2026", "€28 301"], status: "pending" as const },
    { id: "1088431772", cells: ["PLA-8772", "Platform Benchmark Suite Item 3", "9/9/2026", "€31 872"], status: "completed" as const },
    { id: "1088435343", cells: ["PLA-3343", "Platform Benchmark Suite Item 4", "24/4/2026", "€35 443"], status: "warning" as const },
    { id: "1088438914", cells: ["PLA-6914", "Platform Benchmark Suite Item 5", "11/11/2026", "€39 014"], status: "active" as const },
];
...
export default function PlatformBenchmarkSuitePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Platform Benchmark Suite</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Platform Benchmark Suite</p>
                    </div>
                </div>
