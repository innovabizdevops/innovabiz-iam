...
const PAGE = "Report";
const KPIS = [{"l":"Formulários Ativos","v":"7.313","t":"+16.0%","d":"up"},{"l":"Submissões/Dia","v":"2062","t":"+13.7%","d":"up"},{"l":"Documentos Gerados","v":"301","t":"+14.5%","d":"up"},{"l":"Templates","v":"5.506","t":"+6.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.021","2026-02-12","5.846","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.054","2026-01-06","5.937","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.143","2026-02-10","2.140","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.749","2026-02-27","3.240","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.423","2026-01-25","1.126","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":785},{"label":"Fev","value":914},{"label":"Mar","value":768},{"label":"Abr","value":818},{"label":"Mai","value":700},{"label":"Jun","value":885},{"label":"Jul","value":1006},{"label":"Ago","value":658},{"label":"Set","value":942},{"label":"Out","value":825},{"label":"Nov","value":747},{"label":"Dez","value":790}];
const MX = 1006;
