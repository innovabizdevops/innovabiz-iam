...
const PAGE = "Scale";
const KPIS = [{"l":"Formulários Ativos","v":"858","t":"+0.5%","d":"up"},{"l":"Submissões/Dia","v":"2238","t":"+6.1%","d":"up"},{"l":"Documentos Gerados","v":"7.639","t":"-4.0%","d":"down"},{"l":"Templates","v":"3.454","t":"+10.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","9.028","2026-01-14","3.848","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.686","2026-01-10","2.330","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.952","2026-01-06","8.815","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.917","2026-03-16","5.131","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.134","2026-03-17","2.297","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":581},{"label":"Fev","value":598},{"label":"Mar","value":799},{"label":"Abr","value":859},{"label":"Mai","value":954},{"label":"Jun","value":811},{"label":"Jul","value":933},{"label":"Ago","value":956},{"label":"Set","value":596},{"label":"Out","value":892},{"label":"Nov","value":678},{"label":"Dez","value":814}];
const MX = 956;
