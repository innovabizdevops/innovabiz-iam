...
const KPIS = [{"l":"Formulários Ativos","v":"5.274","t":"-1.8%","d":"down"},{"l":"Submissões/Dia","v":"1678","t":"-0.8%","d":"down"},{"l":"Documentos Gerados","v":"1.134","t":"+6.0%","d":"up"},{"l":"Templates","v":"3.061","t":"+9.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.562","2026-01-02","3.965","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.523","2026-03-15","6.573","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.522","2026-01-08","1.039","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.685","2026-02-19","5.924","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","487","2026-02-15","839","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1005},{"label":"Fev","value":615},{"label":"Mar","value":744},{"label":"Abr","value":829},{"label":"Mai","value":805},{"label":"Jun","value":632},{"label":"Jul","value":723},{"label":"Ago","value":853},{"label":"Set","value":910},{"label":"Out","value":936},{"label":"Nov","value":900},{"label":"Dez","value":962}];
const MX = 1005;
