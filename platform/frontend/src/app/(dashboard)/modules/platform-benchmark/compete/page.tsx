...
const PAGE = "Compete";
const KPIS = [{"l":"Formulários Ativos","v":"6.288","t":"-1.2%","d":"down"},{"l":"Submissões/Dia","v":"1148","t":"-3.4%","d":"down"},{"l":"Documentos Gerados","v":"4.855","t":"+15.1%","d":"up"},{"l":"Templates","v":"2.103","t":"-0.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.330","2026-03-09","6.273","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.963","2026-02-17","7.639","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.528","2026-02-11","5.140","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.870","2026-01-17","3.029","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.232","2026-01-06","3.307","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":761},{"label":"Mar","value":616},{"label":"Abr","value":504},{"label":"Mai","value":533},{"label":"Jun","value":550},{"label":"Jul","value":569},{"label":"Ago","value":704},{"label":"Set","value":658},{"label":"Out","value":492},{"label":"Nov","value":610},{"label":"Dez","value":754}];
const MX = 761;
