...
const ACCENT = "#312e81";
const MODULE = "Platform Benchmark Suite";
const PAGE = "Improve";
const KPIS = [{"l":"Formulários Ativos","v":"9.041","t":"+11.3%","d":"up"},{"l":"Submissões/Dia","v":"4848","t":"-1.9%","d":"down"},{"l":"Documentos Gerados","v":"7.315","t":"-1.0%","d":"down"},{"l":"Templates","v":"3.196","t":"+12.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.129","2026-02-01","4.656","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","627","2026-01-10","6.149","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.151","2026-03-23","195","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.740","2026-03-24","605","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.425","2026-03-28","1.095","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":434},{"label":"Mar","value":573},{"label":"Abr","value":394},{"label":"Mai","value":664},{"label":"Jun","value":368},{"label":"Jul","value":528},{"label":"Ago","value":692},{"label":"Set","value":547},{"label":"Out","value":687},{"label":"Nov","value":328},{"label":"Dez","value":541}];
const MX = 692;
