...
const PAGE = "Takaful";
const KPIS = [{"l":"Tickets Abertos","v":"3.263","t":"+7.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"92.2%","t":"+13.5%","d":"up"},{"l":"MTTR (h)","v":"126h","t":"+3.4%","d":"up"},{"l":"Satisfação (%)","v":"92.5%","t":"+1.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.040","2.012","3.073","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.274","4.880","1.578","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.665","7.146","704","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.980","2.264","6.792","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.774","8.083","1.755","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":814},{"label":"Mar","value":860},{"label":"Abr","value":824},{"label":"Mai","value":792},{"label":"Jun","value":691},{"label":"Jul","value":656},{"label":"Ago","value":841},{"label":"Set","value":700},{"label":"Out","value":899},{"label":"Nov","value":662},{"label":"Dez","value":793}];
const MX = 899;
