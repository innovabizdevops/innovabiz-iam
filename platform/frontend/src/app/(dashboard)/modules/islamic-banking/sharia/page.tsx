...
const PAGE = "Sharia Board";
const KPIS = [{"l":"Tickets Abertos","v":"2.179","t":"-5.5%","d":"down"},{"l":"SLA Cumprido (%)","v":"83.9%","t":"+17.0%","d":"up"},{"l":"MTTR (h)","v":"50h","t":"+1.3%","d":"up"},{"l":"Satisfação (%)","v":"80.7%","t":"+17.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.345","686","7.522","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.362","5.969","8.125","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.565","2.595","190","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.730","4.439","1.641","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.288","6.756","2.715","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":919},{"label":"Fev","value":717},{"label":"Mar","value":856},{"label":"Abr","value":774},{"label":"Mai","value":915},{"label":"Jun","value":1004},{"label":"Jul","value":827},{"label":"Ago","value":693},{"label":"Set","value":968},{"label":"Out","value":776},{"label":"Nov","value":689},{"label":"Dez","value":655}];
const MX = 1004;
