...
const PAGE = "Sukuk";
const KPIS = [{"l":"Tickets Abertos","v":"5.993","t":"+7.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"67.3%","t":"+17.9%","d":"up"},{"l":"MTTR (h)","v":"196h","t":"+8.5%","d":"up"},{"l":"Satisfação (%)","v":"80.5%","t":"+6.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.885","1.700","7.595","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.983","5.033","612","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","537","8.389","3.872","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.377","4.312","994","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.171","5.306","4.814","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":785},{"label":"Fev","value":827},{"label":"Mar","value":766},{"label":"Abr","value":507},{"label":"Mai","value":636},{"label":"Jun","value":561},{"label":"Jul","value":588},{"label":"Ago","value":508},{"label":"Set","value":622},{"label":"Out","value":646},{"label":"Nov","value":799},{"label":"Dez","value":587}];
const MX = 827;
