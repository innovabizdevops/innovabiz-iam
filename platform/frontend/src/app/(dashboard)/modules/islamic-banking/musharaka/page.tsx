...
const ACCENT = "#6366f1";
const MODULE = "Islamic Banking";
const PAGE = "Musharaka";
const KPIS = [{"l":"Tickets Abertos","v":"5.501","t":"+14.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"85.8%","t":"+12.7%","d":"up"},{"l":"MTTR (h)","v":"205h","t":"+2.0%","d":"up"},{"l":"Satisfação (%)","v":"84.1%","t":"+5.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","713","8.336","1.770","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.826","1.126","8.970","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","721","5.131","9.043","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.630","9.022","8.554","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.128","6.573","6.363","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":918},{"label":"Fev","value":1038},{"label":"Mar","value":982},{"label":"Abr","value":1078},{"label":"Mai","value":804},{"label":"Jun","value":993},{"label":"Jul","value":727},{"label":"Ago","value":919},{"label":"Set","value":964},{"label":"Out","value":959},{"label":"Nov","value":1089},{"label":"Dez","value":1085}];
const MX = 1089;
