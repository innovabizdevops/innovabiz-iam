...
const PAGE = "Murabaha";
const KPIS = [{"l":"Tickets Abertos","v":"5.850","t":"+14.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"80.9%","t":"+12.4%","d":"up"},{"l":"MTTR (h)","v":"132h","t":"+0.4%","d":"up"},{"l":"Satisfação (%)","v":"90.1%","t":"+5.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.575","650","2.638","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.968","255","3.480","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.627","893","5.492","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.109","2.881","7.247","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.835","6.166","8.952","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":720},{"label":"Mar","value":595},{"label":"Abr","value":492},{"label":"Mai","value":520},{"label":"Jun","value":533},{"label":"Jul","value":720},{"label":"Ago","value":372},{"label":"Set","value":346},{"label":"Out","value":621},{"label":"Nov","value":372},{"label":"Dez","value":346}];
const MX = 720;
