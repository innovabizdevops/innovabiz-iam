...
const PAGE = "Sponsorship";
const KPIS = [{"l":"Eventos Planeados","v":"4.065","t":"+11.8%","d":"up"},{"l":"Participantes","v":"8.601","t":"-3.8%","d":"down"},{"l":"NPS Evento","v":"68","t":"+1.3%","d":"up"},{"l":"Receita (€)","v":"€73330","t":"-3.1%","d":"down"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-07","3.052","6.265","€ 20467.85","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-12","1.935","4.558","€ 24150.33","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-22","2.411","7.100","€ 47182.45","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-25","8.245","3.925","€ 32770.86","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-21","6.494","1.374","€ 35426.03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":500},{"label":"Fev","value":502},{"label":"Mar","value":765},{"label":"Abr","value":494},{"label":"Mai","value":554},{"label":"Jun","value":734},{"label":"Jul","value":855},{"label":"Ago","value":763},{"label":"Set","value":685},{"label":"Out","value":636},{"label":"Nov","value":520},{"label":"Dez","value":733}];
const MX = 855;
