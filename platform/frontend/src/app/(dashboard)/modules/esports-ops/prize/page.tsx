...
const PAGE = "Prize Pool";
const KPIS = [{"l":"Atletas Registados","v":"9.060","t":"+2.6%","d":"up"},{"l":"Treinos/Semana","v":"4979","t":"+15.3%","d":"up"},{"l":"Competições","v":"6.000","t":"-0.6%","d":"down"},{"l":"Performance Score","v":"70","t":"-0.1%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.019","7.594","7.003","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","922","3.602","8.648","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.979","1.519","1.487","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.259","7.572","2.444","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.576","5.556","8.979","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":534},{"label":"Fev","value":863},{"label":"Mar","value":855},{"label":"Abr","value":834},{"label":"Mai","value":657},{"label":"Jun","value":541},{"label":"Jul","value":782},{"label":"Ago","value":773},{"label":"Set","value":694},{"label":"Out","value":588},{"label":"Nov","value":587},{"label":"Dez","value":867}];
const MX = 867;
