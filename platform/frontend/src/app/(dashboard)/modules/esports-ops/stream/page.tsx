...
const KPIS = [{"l":"Atletas Registados","v":"5.378","t":"+15.5%","d":"up"},{"l":"Treinos/Semana","v":"2886","t":"+1.7%","d":"up"},{"l":"Competições","v":"7.225","t":"-4.3%","d":"down"},{"l":"Performance Score","v":"88","t":"+5.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.429","450","6.138","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.655","6.638","5.195","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.123","3.525","6.989","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.083","9.016","3.125","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.497","3.502","4.200","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":459},{"label":"Fev","value":434},{"label":"Mar","value":360},{"label":"Abr","value":313},{"label":"Mai","value":277},{"label":"Jun","value":599},{"label":"Jul","value":398},{"label":"Ago","value":283},{"label":"Set","value":367},{"label":"Out","value":288},{"label":"Nov","value":553},{"label":"Dez","value":358}];
const MX = 599;
