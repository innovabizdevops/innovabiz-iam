...
const ACCENT = "#0e7490";
const MODULE = "Esports Operations";
const PAGE = "Team Roster";
const KPIS = [{"l":"Teams Ativos","v":"4.100","t":"-5.9%","d":"down"},{"l":"Reuniões/Semana","v":"2822","t":"-3.7%","d":"down"},{"l":"Mensagens/Dia","v":"5085","t":"-1.7%","d":"down"},{"l":"Ficheiros Partilhados","v":"7.322","t":"-0.9%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","6.482","2605","2.561","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","5.890","392","554","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","4.775","3202","1.208","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","7.235","1121","7.291","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","5.950","4779","560","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":683},{"label":"Mar","value":578},{"label":"Abr","value":384},{"label":"Mai","value":582},{"label":"Jun","value":491},{"label":"Jul","value":545},{"label":"Ago","value":563},{"label":"Set","value":728},{"label":"Out","value":428},{"label":"Nov","value":376},{"label":"Dez","value":393}];
const MX = 728;
