...
const KPIS = [{"l":"Atletas Registados","v":"1.182","t":"+9.1%","d":"up"},{"l":"Treinos/Semana","v":"3520","t":"+5.0%","d":"up"},{"l":"Competições","v":"2.306","t":"+14.7%","d":"up"},{"l":"Performance Score","v":"57","t":"-3.0%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.904","8.799","4.683","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.732","6.431","6.023","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.410","8.961","7.919","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.582","4.931","8.277","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.069","1.930","4.901","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":813},{"label":"Mar","value":658},{"label":"Abr","value":518},{"label":"Mai","value":701},{"label":"Jun","value":765},{"label":"Jul","value":559},{"label":"Ago","value":575},{"label":"Set","value":747},{"label":"Out","value":577},{"label":"Nov","value":742},{"label":"Dez","value":599}];
const MX = 813;
