...
const KPIS = [{"l":"Formulários Ativos","v":"7.108","t":"+17.1%","d":"up"},{"l":"Submissões/Dia","v":"3006","t":"-4.0%","d":"down"},{"l":"Documentos Gerados","v":"6.051","t":"+14.8%","d":"up"},{"l":"Templates","v":"7.306","t":"+0.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.013","2026-02-25","3.129","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.507","2026-02-04","2.012","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.061","2026-03-08","5.219","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","156","2026-03-20","3.633","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.287","2026-02-15","3.354","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":372},{"label":"Mar","value":487},{"label":"Abr","value":310},{"label":"Mai","value":298},{"label":"Jun","value":337},{"label":"Jul","value":360},{"label":"Ago","value":433},{"label":"Set","value":381},{"label":"Out","value":597},{"label":"Nov","value":385},{"label":"Dez","value":464}];
const MX = 597;
