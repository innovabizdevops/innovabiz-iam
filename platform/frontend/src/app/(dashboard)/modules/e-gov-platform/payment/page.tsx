...
const PAGE = "Payment";
const KPIS = [{"l":"Formulários Ativos","v":"5.217","t":"+9.0%","d":"up"},{"l":"Submissões/Dia","v":"1433","t":"+14.5%","d":"up"},{"l":"Documentos Gerados","v":"6.447","t":"+12.6%","d":"up"},{"l":"Templates","v":"4.396","t":"-3.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.372","2026-01-24","8.477","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.812","2026-03-25","8.622","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.416","2026-02-21","260","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.730","2026-02-04","4.089","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","799","2026-02-23","944","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":683},{"label":"Mar","value":659},{"label":"Abr","value":503},{"label":"Mai","value":445},{"label":"Jun","value":593},{"label":"Jul","value":560},{"label":"Ago","value":669},{"label":"Set","value":775},{"label":"Out","value":728},{"label":"Nov","value":726},{"label":"Dez","value":591}];
const MX = 775;
