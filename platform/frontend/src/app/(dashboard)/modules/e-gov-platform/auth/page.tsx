...
const PAGE = "Auth";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.520","t":"-1.1%","d":"down"},{"l":"Sessões/Dia","v":"2291","t":"+15.1%","d":"up"},{"l":"MFA Adoção (%)","v":"86.2%","t":"-1.4%","d":"down"},{"l":"Tentativas Bloqueadas","v":"4.473","t":"+1.6%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.554","353","2.142","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.399","8.146","8.712","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","1.815","8.093","7.188","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.856","5.273","3.647","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","1.984","8.764","3.698","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":444},{"label":"Mar","value":348},{"label":"Abr","value":524},{"label":"Mai","value":619},{"label":"Jun","value":559},{"label":"Jul","value":598},{"label":"Ago","value":689},{"label":"Set","value":336},{"label":"Out","value":612},{"label":"Nov","value":544},{"label":"Dez","value":476}];
const MX = 689;
