...
const ACCENT = "#2d4a6f";
const MODULE = "E-Government Platform";
const PAGE = "Interop";
const KPIS = [{"l":"Formulários Ativos","v":"6.991","t":"+12.0%","d":"up"},{"l":"Submissões/Dia","v":"4183","t":"-0.9%","d":"down"},{"l":"Documentos Gerados","v":"6.321","t":"+13.5%","d":"up"},{"l":"Templates","v":"6.080","t":"-2.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.885","2026-02-18","4.216","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.073","2026-02-01","6.250","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.021","2026-02-15","438","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.427","2026-02-10","2.272","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.823","2026-03-08","8.965","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":863},{"label":"Mar","value":796},{"label":"Abr","value":624},{"label":"Mai","value":846},{"label":"Jun","value":925},{"label":"Jul","value":891},{"label":"Ago","value":936},{"label":"Set","value":856},{"label":"Out","value":629},{"label":"Nov","value":727},{"label":"Dez","value":836}];
const MX = 936;
