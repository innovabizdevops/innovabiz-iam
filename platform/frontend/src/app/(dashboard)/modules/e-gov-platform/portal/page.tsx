...
const PAGE = "Portal";
const KPIS = [{"l":"Formulários Ativos","v":"8.809","t":"-1.4%","d":"down"},{"l":"Submissões/Dia","v":"851","t":"+6.8%","d":"up"},{"l":"Documentos Gerados","v":"4.191","t":"+2.7%","d":"up"},{"l":"Templates","v":"3.372","t":"+17.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.656","2026-01-03","2.808","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","627","2026-03-17","4.404","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.812","2026-01-15","4.477","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.480","2026-02-27","1.696","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.792","2026-03-28","3.170","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":354},{"label":"Fev","value":329},{"label":"Mar","value":376},{"label":"Abr","value":603},{"label":"Mai","value":435},{"label":"Jun","value":502},{"label":"Jul","value":437},{"label":"Ago","value":603},{"label":"Set","value":378},{"label":"Out","value":393},{"label":"Nov","value":613},{"label":"Dez","value":626}];
const MX = 626;
