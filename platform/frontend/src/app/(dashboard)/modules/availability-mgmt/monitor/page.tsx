...
const ACCENT = "#334155";
const MODULE = "Availability Management (ITIL)";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Availability Mgmt","v":"1.633","t":"+16.2%","d":"up"},{"l":"Monitor Ativos","v":"7.156","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"76.7%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"91","t":"+1.9%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Availability Mgmt #001","Availability Mgmt #002","3.885","667","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Availability Mgmt #002","Availability Mgmt #003","325","7.405","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Availability Mgmt #003","Availability Mgmt #004","4.931","450","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Availability Mgmt #004","Availability Mgmt #005","920","2.305","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Availability Mgmt #005","Availability Mgmt #001","2.121","2.326","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1001},{"label":"Fev","value":715},{"label":"Mar","value":732},{"label":"Abr","value":883},{"label":"Mai","value":1037},{"label":"Jun","value":1060},{"label":"Jul","value":867},{"label":"Ago","value":668},{"label":"Set","value":954},{"label":"Out","value":783},{"label":"Nov","value":723},{"label":"Dez","value":729}];
const MX = 1060;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#334155'}}>RTM</span></h1>
                </div>
