...
const PAGE = "Improve";
const KPIS = [{"l":"Projetos Melhoria","v":"5.286","t":"+6.1%","d":"up"},{"l":"Savings (€)","v":"€84218","t":"-0.5%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"65.3%","t":"+2.9%","d":"up"},{"l":"Ciclos PDCA","v":"3.404","t":"-3.7%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.085","€ 15605.74","3.151","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","9.088","€ 47776.82","1.591","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.091","€ 24288.86","3.259","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.354","€ 11375.45","7.610","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.599","€ 3665.54","7.649","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":613},{"label":"Mar","value":509},{"label":"Abr","value":731},{"label":"Mai","value":805},{"label":"Jun","value":774},{"label":"Jul","value":818},{"label":"Ago","value":608},{"label":"Set","value":696},{"label":"Out","value":687},{"label":"Nov","value":712},{"label":"Dez","value":759}];
const MX = 818;
