...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"6.531","t":"+16.3%","d":"up"},{"l":"Submissões/Dia","v":"2788","t":"+9.4%","d":"up"},{"l":"Documentos Gerados","v":"6.988","t":"+10.8%","d":"up"},{"l":"Templates","v":"7.013","t":"-4.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.984","2026-01-12","8.319","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.912","2026-02-08","8.195","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.424","2026-02-07","1.799","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","260","2026-01-17","2.966","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","936","2026-01-09","6.057","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":312},{"label":"Fev","value":594},{"label":"Mar","value":707},{"label":"Abr","value":452},{"label":"Mai","value":391},{"label":"Jun","value":630},{"label":"Jul","value":416},{"label":"Ago","value":482},{"label":"Set","value":393},{"label":"Out","value":514},{"label":"Nov","value":424},{"label":"Dez","value":548}];
const MX = 707;
