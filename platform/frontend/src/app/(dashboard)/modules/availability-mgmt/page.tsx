...
/* ═══ Availability Management (ITIL) — Dashboard ═══ */

const ACCENT = "#334155";

const KPIS = [
    { label: "Total Registos", value: "7734", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3556", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€115K", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2099272934", cells: ["AVA-5934", "Availability Management (ITIL) Item 1", "11/3/2026", "€23 034"], status: "active" as const },
    { id: "2099276505", cells: ["AVA-9505", "Availability Management (ITIL) Item 2", "26/10/2026", "€26 605"], status: "pending" as const },
    { id: "2099280076", cells: ["AVA-4076", "Availability Management (ITIL) Item 3", "13/5/2026", "€30 176"], status: "completed" as const },
    { id: "2099283647", cells: ["AVA-7647", "Availability Management (ITIL) Item 4", "28/12/2026", "€33 747"], status: "warning" as const },
    { id: "2099287218", cells: ["AVA-2218", "Availability Management (ITIL) Item 5", "15/7/2026", "€37 318"], status: "active" as const },
];
...
export default function AvailabilityManagementItilPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Availability Management (ITIL)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Availability Management (ITIL)</p>
                    </div>
                </div>
