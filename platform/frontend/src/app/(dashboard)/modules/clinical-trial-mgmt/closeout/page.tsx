...
const PAGE = "Closeout";
const KPIS = [{"l":"Total Clinical Trial Mgmt","v":"3.923","t":"-2.9%","d":"down"},{"l":"Closeout Ativos","v":"3.122","t":"+10.5%","d":"up"},{"l":"Eficiência (%)","v":"74.8%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"76","t":"+12.8%","d":"up"}];
const COLS = ["ID","Closeout","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Clinical Trial Mgmt #001","Clinical Trial Mgmt #002","6.569","3.513","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Clinical Trial Mgmt #002","Clinical Trial Mgmt #003","8.742","3.384","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Clinical Trial Mgmt #003","Clinical Trial Mgmt #004","5.245","5.242","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Clinical Trial Mgmt #004","Clinical Trial Mgmt #005","1.399","4.970","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Clinical Trial Mgmt #005","Clinical Trial Mgmt #001","8.502","208","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":468},{"label":"Mar","value":728},{"label":"Abr","value":390},{"label":"Mai","value":693},{"label":"Jun","value":624},{"label":"Jul","value":409},{"label":"Ago","value":467},{"label":"Set","value":758},{"label":"Out","value":553},{"label":"Nov","value":626},{"label":"Dez","value":577}];
const MX = 758;
