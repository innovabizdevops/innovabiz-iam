...
const KPIS = [{"l":"Total Clinical Trial Mgmt","v":"5.259","t":"-4.5%","d":"down"},{"l":"Monitoring Ativos","v":"2.845","t":"-6.0%","d":"down"},{"l":"Eficiência (%)","v":"68.2%","t":"+9.7%","d":"up"},{"l":"Score Performance","v":"56","t":"-1.6%","d":"down"}];
const COLS = ["ID","Monitoring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Clinical Trial Mgmt #001","Clinical Trial Mgmt #002","8.605","443","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Clinical Trial Mgmt #002","Clinical Trial Mgmt #003","8.366","7.178","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Clinical Trial Mgmt #003","Clinical Trial Mgmt #004","9.039","6.166","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Clinical Trial Mgmt #004","Clinical Trial Mgmt #005","7.082","3.294","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Clinical Trial Mgmt #005","Clinical Trial Mgmt #001","4.206","7.045","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":553},{"label":"Mar","value":360},{"label":"Abr","value":378},{"label":"Mai","value":470},{"label":"Jun","value":634},{"label":"Jul","value":633},{"label":"Ago","value":601},{"label":"Set","value":520},{"label":"Out","value":565},{"label":"Nov","value":640},{"label":"Dez","value":410}];
const MX = 640;
