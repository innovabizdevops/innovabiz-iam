...
const ACCENT = "#6366f1";
const MODULE = "Clinical Trial Mgmt";
const PAGE = "Adverse Event";
const KPIS = [{"l":"Total Clinical Trial Mgmt","v":"3.290","t":"-0.6%","d":"down"},{"l":"Adverse Event Ativos","v":"7.587","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"79.1%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"61","t":"+16.3%","d":"up"}];
const COLS = ["ID","Adverse Event","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Clinical Trial Mgmt #001","Clinical Trial Mgmt #002","6.168","6.274","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Clinical Trial Mgmt #002","Clinical Trial Mgmt #003","3.735","3.263","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Clinical Trial Mgmt #003","Clinical Trial Mgmt #004","4.936","6.503","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Clinical Trial Mgmt #004","Clinical Trial Mgmt #005","8.016","7.842","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Clinical Trial Mgmt #005","Clinical Trial Mgmt #001","4.428","7.166","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":736},{"label":"Mar","value":616},{"label":"Abr","value":687},{"label":"Mai","value":716},{"label":"Jun","value":433},{"label":"Jul","value":644},{"label":"Ago","value":666},{"label":"Set","value":741},{"label":"Out","value":620},{"label":"Nov","value":802},{"label":"Dez","value":501}];
const MX = 802;
