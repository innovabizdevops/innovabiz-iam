...
const PAGE = "Protocol";
const KPIS = [{"l":"Integrações Ativas","v":"3.820","t":"+10.5%","d":"up"},{"l":"Chamadas/Hora","v":"4462","t":"+4.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.4%","t":"+10.1%","d":"up"},{"l":"Latência Média (ms)","v":"31ms","t":"-2.7%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.237","6.373","96.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.250","5.021","88.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.999","764","92.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.227","7.281","70.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.829","798","89.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":603},{"label":"Mar","value":696},{"label":"Abr","value":660},{"label":"Mai","value":864},{"label":"Jun","value":928},{"label":"Jul","value":903},{"label":"Ago","value":859},{"label":"Set","value":597},{"label":"Out","value":787},{"label":"Nov","value":537},{"label":"Dez","value":696}];
const MX = 928;
