...
export default function ClinicalTrialMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Clinical Trial Mgmt</h1><p className="text-sm text-muted-foreground">Clinical Trial Mgmt • iBOS Enterprise</p></div>
