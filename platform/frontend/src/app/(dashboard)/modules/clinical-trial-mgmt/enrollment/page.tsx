...
const KPIS = [{"l":"Total Clinical Trial Mgmt","v":"794","t":"-2.4%","d":"down"},{"l":"Enrollment Ativos","v":"7.121","t":"-5.4%","d":"down"},{"l":"Eficiência (%)","v":"68.6%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"86","t":"+1.4%","d":"up"}];
const COLS = ["ID","Enrollment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Clinical Trial Mgmt #001","Clinical Trial Mgmt #002","7.120","4.506","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Clinical Trial Mgmt #002","Clinical Trial Mgmt #003","7.066","7.124","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Clinical Trial Mgmt #003","Clinical Trial Mgmt #004","7.921","7.462","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Clinical Trial Mgmt #004","Clinical Trial Mgmt #005","4.438","162","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Clinical Trial Mgmt #005","Clinical Trial Mgmt #001","7.119","2.143","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":529},{"label":"Mar","value":823},{"label":"Abr","value":824},{"label":"Mai","value":597},{"label":"Jun","value":691},{"label":"Jul","value":523},{"label":"Ago","value":723},{"label":"Set","value":654},{"label":"Out","value":692},{"label":"Nov","value":445},{"label":"Dez","value":709}];
const MX = 824;
