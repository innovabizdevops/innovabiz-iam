...
/* ═══ Cognitive Compose Studio — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "6602", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2244", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€455K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1324626502", cells: ["COG-7502", "Cognitive Compose Studio Item 1", "11/11/2026", "€26 602"], status: "active" as const },
    { id: "1324630073", cells: ["COG-2073", "Cognitive Compose Studio Item 2", "26/6/2026", "€30 173"], status: "pending" as const },
    { id: "1324633644", cells: ["COG-5644", "Cognitive Compose Studio Item 3", "13/1/2026", "€33 744"], status: "completed" as const },
    { id: "1324637215", cells: ["COG-9215", "Cognitive Compose Studio Item 4", "28/8/2026", "€37 315"], status: "warning" as const },
    { id: "1324640786", cells: ["COG-3786", "Cognitive Compose Studio Item 5", "15/3/2026", "€40 886"], status: "active" as const },
];
...
export default function CognitiveComposeStudioPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cognitive Compose Studio</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cognitive Compose Studio</p>
                    </div>
                </div>
