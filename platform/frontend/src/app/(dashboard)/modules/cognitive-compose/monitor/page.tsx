...
const ACCENT = "#312e81";
const MODULE = "Cognitive Compose Studio";
const PAGE = "Monitor";
const KPIS = [{"l":"Pedidos/Dia","v":"3691","t":"+6.3%","d":"up"},{"l":"GMV (€)","v":"€86212","t":"-1.8%","d":"down"},{"l":"Conversão (%)","v":"72.3%","t":"+2.3%","d":"up"},{"l":"AOV (€)","v":"€8781","t":"+8.4%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 30634.16","539","2.775","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 12081.17","1.694","7.848","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 6749.95","5.771","5.056","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 31434.43","7.324","6.974","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 18201.56","6.944","7.547","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":800},{"label":"Fev","value":817},{"label":"Mar","value":614},{"label":"Abr","value":812},{"label":"Mai","value":677},{"label":"Jun","value":860},{"label":"Jul","value":663},{"label":"Ago","value":512},{"label":"Set","value":671},{"label":"Out","value":608},{"label":"Nov","value":757},{"label":"Dez","value":601}];
const MX = 860;
