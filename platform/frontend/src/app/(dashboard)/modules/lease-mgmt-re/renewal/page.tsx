...
const ACCENT = "#059669";
const MODULE = "Lease Management";
const PAGE = "Renewal Track";
const KPIS = [{"l":"Contratos Ativos","v":"5.329","t":"-1.7%","d":"down"},{"l":"Valor Total (€M)","v":"€19.8M","t":"+4.1%","d":"up"},{"l":"Renovações Próx. 30d","v":"6.123","t":"+14.9%","d":"up"},{"l":"Obrigações Pendentes","v":"5.738","t":"+9.7%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 41181.78","2026-02-04","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 25420.21","2026-03-22","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 25053.90","2026-03-27","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 5438.95","2026-01-12","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 28440.91","2026-02-19","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":812},{"label":"Fev","value":713},{"label":"Mar","value":962},{"label":"Abr","value":713},{"label":"Mai","value":817},{"label":"Jun","value":823},{"label":"Jul","value":784},{"label":"Ago","value":1055},{"label":"Set","value":1005},{"label":"Out","value":958},{"label":"Nov","value":830},{"label":"Dez","value":774}];
const MX = 1055;
