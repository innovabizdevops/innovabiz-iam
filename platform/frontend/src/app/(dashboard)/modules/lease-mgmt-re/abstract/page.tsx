...
const PAGE = "Abstract";
const KPIS = [{"l":"Total Lease Mgmt Re","v":"3.314","t":"+5.1%","d":"up"},{"l":"Abstract Ativos","v":"4.152","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"80.5%","t":"+14.1%","d":"up"},{"l":"Score Performance","v":"64","t":"+15.2%","d":"up"}];
const COLS = ["ID","Abstract","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lease Mgmt Re #001","Lease Mgmt Re #002","6.997","5.150","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Lease Mgmt Re #002","Lease Mgmt Re #003","6.550","2.033","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Lease Mgmt Re #003","Lease Mgmt Re #004","3.715","2.554","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Lease Mgmt Re #004","Lease Mgmt Re #005","5.598","7.942","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lease Mgmt Re #005","Lease Mgmt Re #001","8.251","8.468","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":677},{"label":"Mar","value":883},{"label":"Abr","value":837},{"label":"Mai","value":708},{"label":"Jun","value":840},{"label":"Jul","value":753},{"label":"Ago","value":795},{"label":"Set","value":548},{"label":"Out","value":643},{"label":"Nov","value":550},{"label":"Dez","value":863}];
const MX = 883;
