...
const KPIS = [{"l":"Notificações Enviadas","v":"4.023","t":"-0.9%","d":"down"},{"l":"Taxa Entrega (%)","v":"89.2%","t":"+5.5%","d":"up"},{"l":"Taxa Abertura (%)","v":"80.0%","t":"+15.0%","d":"up"},{"l":"Escalações","v":"8.694","t":"+17.6%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","5.070","97.7%","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","520","87.7%","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","4.525","71.4%","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","3.383","89.5%","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","1.436","86.5%","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":876},{"label":"Fev","value":928},{"label":"Mar","value":736},{"label":"Abr","value":846},{"label":"Mai","value":748},{"label":"Jun","value":735},{"label":"Jul","value":885},{"label":"Ago","value":572},{"label":"Set","value":853},{"label":"Out","value":882},{"label":"Nov","value":859},{"label":"Dez","value":595}];
const MX = 928;
