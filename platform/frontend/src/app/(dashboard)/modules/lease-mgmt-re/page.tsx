...
export default function LeaseMgmtRePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Lease Mgmt Re</h1><p className="text-sm text-muted-foreground">Lease Mgmt Re • iBOS Enterprise</p></div>
