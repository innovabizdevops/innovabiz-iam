...
const KPIS = [{"l":"Total Lease Mgmt Re","v":"9.064","t":"+11.0%","d":"up"},{"l":"Lease Admin Ativos","v":"5.179","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"92.6%","t":"+3.5%","d":"up"},{"l":"Score Performance","v":"75","t":"+-0.0%","d":"up"}];
const COLS = ["ID","Lease Admin","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lease Mgmt Re #001","Lease Mgmt Re #002","847","8.479","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Lease Mgmt Re #002","Lease Mgmt Re #003","5.680","1.002","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Lease Mgmt Re #003","Lease Mgmt Re #004","6.673","8.828","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Lease Mgmt Re #004","Lease Mgmt Re #005","1.052","2.089","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lease Mgmt Re #005","Lease Mgmt Re #001","6.110","2.378","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":292},{"label":"Mar","value":441},{"label":"Abr","value":559},{"label":"Mai","value":353},{"label":"Jun","value":278},{"label":"Jul","value":622},{"label":"Ago","value":447},{"label":"Set","value":449},{"label":"Out","value":403},{"label":"Nov","value":601},{"label":"Dez","value":344}];
const MX = 622;
