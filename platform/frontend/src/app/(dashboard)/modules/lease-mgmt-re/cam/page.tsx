...
const PAGE = "CAM Charges";
const KPIS = [{"l":"Total Lease Mgmt Re","v":"6.020","t":"-2.6%","d":"down"},{"l":"CAM Charges Ativos","v":"8.103","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"71.0%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"58","t":"+10.1%","d":"up"}];
const COLS = ["ID","CAM Charges","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lease Mgmt Re #001","Lease Mgmt Re #002","7.702","4.630","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Lease Mgmt Re #002","Lease Mgmt Re #003","2.451","7.619","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Lease Mgmt Re #003","Lease Mgmt Re #004","6.010","838","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Lease Mgmt Re #004","Lease Mgmt Re #005","3.643","5.112","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lease Mgmt Re #005","Lease Mgmt Re #001","1.800","4.908","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":800},{"label":"Fev","value":613},{"label":"Mar","value":620},{"label":"Abr","value":843},{"label":"Mai","value":618},{"label":"Jun","value":533},{"label":"Jul","value":655},{"label":"Ago","value":863},{"label":"Set","value":619},{"label":"Out","value":624},{"label":"Nov","value":788},{"label":"Dez","value":759}];
const MX = 863;
