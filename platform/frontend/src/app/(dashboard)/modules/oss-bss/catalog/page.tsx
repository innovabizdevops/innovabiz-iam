...
const KPIS = [{"l":"Dashboards Ativos","v":"8.077","t":"+17.4%","d":"up"},{"l":"Queries/Dia","v":"1468","t":"+2.5%","d":"up"},{"l":"Dados Processados (GB)","v":"5.402","t":"+11.7%","d":"up"},{"l":"Utilizadores Analytics","v":"8.753","t":"-1.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4815","2026-02-12","5.514","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","784","2026-02-16","5.211","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3043","2026-02-10","8.891","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1522","2026-01-02","7.134","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4277","2026-03-16","1.368","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":388},{"label":"Mar","value":609},{"label":"Abr","value":336},{"label":"Mai","value":451},{"label":"Jun","value":359},{"label":"Jul","value":586},{"label":"Ago","value":496},{"label":"Set","value":371},{"label":"Out","value":674},{"label":"Nov","value":456},{"label":"Dez","value":526}];
const MX = 674;
