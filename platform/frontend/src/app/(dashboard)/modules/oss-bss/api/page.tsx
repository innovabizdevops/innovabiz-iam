...
const PAGE = "API Economy";
const KPIS = [{"l":"Total Oss Bss","v":"164","t":"+14.4%","d":"up"},{"l":"API Economy Ativos","v":"173","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"87.8%","t":"+10.6%","d":"up"},{"l":"Score Performance","v":"70","t":"+16.2%","d":"up"}];
const COLS = ["ID","API Economy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oss Bss #001","Oss Bss #002","5.002","6.111","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Oss Bss #002","Oss Bss #003","3.310","6.750","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Oss Bss #003","Oss Bss #004","3.521","7.476","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Oss Bss #004","Oss Bss #005","3.352","187","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oss Bss #005","Oss Bss #001","8.874","1.993","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":397},{"label":"Fev","value":481},{"label":"Mar","value":347},{"label":"Abr","value":640},{"label":"Mai","value":521},{"label":"Jun","value":509},{"label":"Jul","value":365},{"label":"Ago","value":610},{"label":"Set","value":326},{"label":"Out","value":391},{"label":"Nov","value":379},{"label":"Dez","value":392}];
const MX = 640;
