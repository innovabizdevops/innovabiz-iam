...
const PAGE = "Revenue Assure";
const KPIS = [{"l":"ARR (€M)","v":"€28.0M","t":"+9.7%","d":"up"},{"l":"MRR (€)","v":"€57302","t":"-5.4%","d":"down"},{"l":"Churn (%)","v":"70.9%","t":"-6.0%","d":"down"},{"l":"ARPU (€)","v":"€67680","t":"+11.4%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 1369.50","3.348","€ 21865.95","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 33079.28","6.609","€ 38585.04","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 6580.56","7.681","€ 26821.90","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 23339.42","5.921","€ 9537.50","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 37113.04","453","€ 30330.12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":361},{"label":"Mar","value":544},{"label":"Abr","value":266},{"label":"Mai","value":577},{"label":"Jun","value":446},{"label":"Jul","value":599},{"label":"Ago","value":414},{"label":"Set","value":325},{"label":"Out","value":562},{"label":"Nov","value":427},{"label":"Dez","value":564}];
const MX = 599;
