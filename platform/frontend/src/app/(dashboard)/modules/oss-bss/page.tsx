...
export default function OssBssPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Oss Bss</h1><p className="text-sm text-muted-foreground">Oss Bss • iBOS Enterprise</p></div>
