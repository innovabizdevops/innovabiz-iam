...
const KPIS = [{"l":"Total Oss Bss","v":"554","t":"+2.1%","d":"up"},{"l":"Order Mgmt Ativos","v":"1.495","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"72.0%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"83","t":"-1.5%","d":"down"}];
const COLS = ["ID","Order Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oss Bss #001","Oss Bss #002","3.690","7.811","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Oss Bss #002","Oss Bss #003","4.911","5.609","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Oss Bss #003","Oss Bss #004","6.943","8.210","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Oss Bss #004","Oss Bss #005","279","1.803","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oss Bss #005","Oss Bss #001","4.429","6.497","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1035},{"label":"Fev","value":877},{"label":"Mar","value":776},{"label":"Abr","value":847},{"label":"Mai","value":1015},{"label":"Jun","value":1028},{"label":"Jul","value":981},{"label":"Ago","value":898},{"label":"Set","value":859},{"label":"Out","value":969},{"label":"Nov","value":789},{"label":"Dez","value":841}];
const MX = 1035;
