...
const KPIS = [{"l":"Surveys Ativos","v":"4.282","t":"-3.7%","d":"down"},{"l":"Respostas/Semana","v":"4224","t":"+0.7%","d":"up"},{"l":"NPS Médio","v":"60","t":"+13.1%","d":"up"},{"l":"Taxa Resposta (%)","v":"80.4%","t":"+4.3%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","272","91","78.2%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","6.648","83","96.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","3.449","79","98.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","3.506","58","77.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","2.559","62","75.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":411},{"label":"Fev","value":569},{"label":"Mar","value":718},{"label":"Abr","value":640},{"label":"Mai","value":750},{"label":"Jun","value":488},{"label":"Jul","value":628},{"label":"Ago","value":362},{"label":"Set","value":402},{"label":"Out","value":390},{"label":"Nov","value":498},{"label":"Dez","value":564}];
const MX = 750;
