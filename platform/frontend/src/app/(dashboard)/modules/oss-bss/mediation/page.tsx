...
const PAGE = "Mediation";
const KPIS = [{"l":"Integrações Ativas","v":"8.718","t":"+6.6%","d":"up"},{"l":"Chamadas/Hora","v":"973","t":"+10.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"94.2%","t":"+7.4%","d":"up"},{"l":"Latência Média (ms)","v":"130ms","t":"+13.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.601","2.631","98.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.888","8.099","91.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.751","7.155","78.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.317","7.140","92.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.500","2.679","97.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":742},{"label":"Mar","value":773},{"label":"Abr","value":680},{"label":"Mai","value":642},{"label":"Jun","value":527},{"label":"Jul","value":831},{"label":"Ago","value":816},{"label":"Set","value":634},{"label":"Out","value":659},{"label":"Nov","value":655},{"label":"Dez","value":498}];
const MX = 831;
