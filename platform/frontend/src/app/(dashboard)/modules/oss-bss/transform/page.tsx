...
const ACCENT = "#7c3aed";
const MODULE = "OSS/BSS Platform";
const PAGE = "BSS Transform";
const KPIS = [{"l":"Formulários Ativos","v":"8.645","t":"-0.1%","d":"down"},{"l":"Submissões/Dia","v":"1743","t":"+14.0%","d":"up"},{"l":"Documentos Gerados","v":"3.777","t":"+4.6%","d":"up"},{"l":"Templates","v":"5.284","t":"-2.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.663","2026-01-05","3.322","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.107","2026-01-01","5.607","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.456","2026-03-03","4.505","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.580","2026-01-15","8.504","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.580","2026-02-19","5.909","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":458},{"label":"Fev","value":380},{"label":"Mar","value":461},{"label":"Abr","value":526},{"label":"Mai","value":451},{"label":"Jun","value":577},{"label":"Jul","value":474},{"label":"Ago","value":459},{"label":"Set","value":377},{"label":"Out","value":316},{"label":"Nov","value":496},{"label":"Dez","value":535}];
const MX = 577;
