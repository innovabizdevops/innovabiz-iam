...
const PAGE = "Ticketing Engine";
const KPIS = [{"l":"Tickets Abertos","v":"3.778","t":"-4.1%","d":"down"},{"l":"SLA Cumprido (%)","v":"83.4%","t":"+4.4%","d":"up"},{"l":"MTTR (h)","v":"102h","t":"-4.5%","d":"down"},{"l":"Satisfação (%)","v":"72.4%","t":"+0.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.606","5.208","2.972","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","349","1.538","3.007","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.367","2.876","7.432","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.409","7.995","4.980","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.275","7.125","330","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":453},{"label":"Fev","value":443},{"label":"Mar","value":589},{"label":"Abr","value":599},{"label":"Mai","value":215},{"label":"Jun","value":287},{"label":"Jul","value":343},{"label":"Ago","value":361},{"label":"Set","value":357},{"label":"Out","value":312},{"label":"Nov","value":282},{"label":"Dez","value":595}];
const MX = 599;
