...
const PAGE = "Sponsorship CRM";
const KPIS = [{"l":"Eventos Planeados","v":"1.626","t":"+4.8%","d":"up"},{"l":"Participantes","v":"7.525","t":"+10.1%","d":"up"},{"l":"NPS Evento","v":"72","t":"+13.2%","d":"up"},{"l":"Receita (€)","v":"€79157","t":"-5.9%","d":"down"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-25","4.464","4.230","€ 35338.58","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-14","3.918","2.078","€ 36652.79","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-17","718","2.426","€ 45072.31","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-11","3.933","2.838","€ 48771.30","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-12","1.385","3.283","€ 46063.36","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":802},{"label":"Mar","value":558},{"label":"Abr","value":522},{"label":"Mai","value":815},{"label":"Jun","value":587},{"label":"Jul","value":554},{"label":"Ago","value":804},{"label":"Set","value":486},{"label":"Out","value":833},{"label":"Nov","value":591},{"label":"Dez","value":786}];
const MX = 833;
