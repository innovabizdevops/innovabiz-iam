...
const PAGE = "Venue Management";
const KPIS = [{"l":"Projetos Melhoria","v":"961","t":"+8.4%","d":"up"},{"l":"Savings (€)","v":"€54772","t":"-0.1%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"75.8%","t":"+13.1%","d":"up"},{"l":"Ciclos PDCA","v":"8.685","t":"+2.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.937","€ 48528.46","478","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.777","€ 3678.46","7.041","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.065","€ 16110.00","3.524","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.961","€ 11361.01","5.987","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","938","€ 8806.38","4.269","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":462},{"label":"Fev","value":436},{"label":"Mar","value":433},{"label":"Abr","value":583},{"label":"Mai","value":456},{"label":"Jun","value":516},{"label":"Jul","value":463},{"label":"Ago","value":723},{"label":"Set","value":407},{"label":"Out","value":419},{"label":"Nov","value":574},{"label":"Dez","value":563}];
const MX = 723;
