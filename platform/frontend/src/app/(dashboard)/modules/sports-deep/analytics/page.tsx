...
const ACCENT = "#ea580c";
const MODULE = "Sports & Entertainment";
const PAGE = "Player Analytics AI";
const KPIS = [{"l":"Dashboards Ativos","v":"9.092","t":"-1.8%","d":"down"},{"l":"Queries/Dia","v":"839","t":"-1.0%","d":"down"},{"l":"Dados Processados (GB)","v":"124","t":"+17.0%","d":"up"},{"l":"Utilizadores Analytics","v":"5.657","t":"+2.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4600","2026-03-19","2.323","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3317","2026-02-28","7.704","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","223","2026-02-26","4.636","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3143","2026-02-26","6.591","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3571","2026-02-17","3.443","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":439},{"label":"Mar","value":467},{"label":"Abr","value":401},{"label":"Mai","value":692},{"label":"Jun","value":485},{"label":"Jul","value":439},{"label":"Ago","value":661},{"label":"Set","value":435},{"label":"Out","value":620},{"label":"Nov","value":572},{"label":"Dez","value":441}];
const MX = 692;
