...
const PAGE = "Fan Engagement";
const KPIS = [{"l":"eNPS","v":"61","t":"+12.5%","d":"up"},{"l":"Engagement (%)","v":"73.4%","t":"-1.8%","d":"down"},{"l":"Turnover (%)","v":"66.5%","t":"+9.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.637","t":"+12.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.726","2026-01-27","86","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.859","2026-03-26","93","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.357","2026-01-06","85","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.752","2026-03-02","68","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.664","2026-01-16","64","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":302},{"label":"Mar","value":237},{"label":"Abr","value":409},{"label":"Mai","value":575},{"label":"Jun","value":586},{"label":"Jul","value":325},{"label":"Ago","value":496},{"label":"Set","value":272},{"label":"Out","value":505},{"label":"Nov","value":274},{"label":"Dez","value":220}];
const MX = 586;
