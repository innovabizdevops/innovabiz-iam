...
const KPIS = [
    { label: "Total Registos", value: "9940", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1037", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€270K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "-23%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1280020440", cells: ["SMA-5440", "Smart Greenhouse Item 1", "21/1/2026", "€20 540"], status: "active" as const },
    { id: "1280024011", cells: ["SMA-9011", "Smart Greenhouse Item 2", "8/8/2026", "€24 111"], status: "pending" as const },
    { id: "1280027582", cells: ["SMA-3582", "Smart Greenhouse Item 3", "23/3/2026", "€27 682"], status: "completed" as const },
    { id: "1280031153", cells: ["SMA-7153", "Smart Greenhouse Item 4", "10/10/2026", "€31 253"], status: "warning" as const },
    { id: "1280034724", cells: ["SMA-1724", "Smart Greenhouse Item 5", "25/5/2026", "€34 824"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Smart Greenhouse</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Smart Greenhouse</p>
                    </div>
                </div>
