...
const PAGE = "Inspection Plans";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.367","t":"+11.1%","d":"up"},{"l":"NC Abertas","v":"5.181","t":"-2.6%","d":"down"},{"l":"Conformidade (%)","v":"93.5%","t":"+14.1%","d":"up"},{"l":"CAPAs Pendentes","v":"4.583","t":"+3.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.244","90.6%","3.597","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.204","72.6%","1.645","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.944","96.6%","1.497","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.191","83.6%","8.418","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.829","75.7%","5.643","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":758},{"label":"Mar","value":838},{"label":"Abr","value":952},{"label":"Mai","value":657},{"label":"Jun","value":903},{"label":"Jul","value":630},{"label":"Ago","value":866},{"label":"Set","value":816},{"label":"Out","value":716},{"label":"Nov","value":864},{"label":"Dez","value":909}];
const MX = 952;
