...
const PAGE = "CAPA Process";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.221","t":"+5.4%","d":"up"},{"l":"NC Abertas","v":"7.984","t":"+12.0%","d":"up"},{"l":"Conformidade (%)","v":"77.3%","t":"+9.2%","d":"up"},{"l":"CAPAs Pendentes","v":"302","t":"+4.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.692","86.7%","7.759","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.149","76.8%","6.763","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.807","89.1%","7.327","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.480","72.7%","121","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.147","94.5%","5.572","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":613},{"label":"Mar","value":602},{"label":"Abr","value":334},{"label":"Mai","value":601},{"label":"Jun","value":655},{"label":"Jul","value":697},{"label":"Ago","value":417},{"label":"Set","value":674},{"label":"Out","value":699},{"label":"Nov","value":699},{"label":"Dez","value":359}];
const MX = 699;
