...
const PAGE = "8D Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.358","t":"+13.6%","d":"up"},{"l":"NC Abertas","v":"3.828","t":"+3.0%","d":"up"},{"l":"Conformidade (%)","v":"89.7%","t":"+13.3%","d":"up"},{"l":"CAPAs Pendentes","v":"3.159","t":"+1.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.994","70.4%","3.122","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.685","71.2%","4.623","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.536","73.5%","3.912","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.751","87.3%","5.022","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.223","98.1%","8.698","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":737},{"label":"Mar","value":799},{"label":"Abr","value":574},{"label":"Mai","value":436},{"label":"Jun","value":539},{"label":"Jul","value":436},{"label":"Ago","value":563},{"label":"Set","value":585},{"label":"Out","value":568},{"label":"Nov","value":738},{"label":"Dez","value":616}];
const MX = 810;
...
export default function 8dPage() {
    return (
