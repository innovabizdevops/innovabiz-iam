...
const PAGE = "NCR Tracking";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.980","t":"+17.5%","d":"up"},{"l":"NC Abertas","v":"8.384","t":"+9.2%","d":"up"},{"l":"Conformidade (%)","v":"85.0%","t":"+5.3%","d":"up"},{"l":"CAPAs Pendentes","v":"8.468","t":"+16.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.583","84.5%","5.639","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","304","93.5%","572","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.511","77.1%","3.648","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.000","79.4%","3.108","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.073","70.8%","1.141","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":640},{"label":"Mar","value":629},{"label":"Abr","value":373},{"label":"Mai","value":609},{"label":"Jun","value":602},{"label":"Jul","value":495},{"label":"Ago","value":670},{"label":"Set","value":441},{"label":"Out","value":541},{"label":"Nov","value":358},{"label":"Dez","value":493}];
const MX = 670;
