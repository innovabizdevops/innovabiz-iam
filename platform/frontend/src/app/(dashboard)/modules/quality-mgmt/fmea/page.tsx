...
const PAGE = "FMEA Analysis";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.685","t":"+11.4%","d":"up"},{"l":"NC Abertas","v":"6.191","t":"+2.3%","d":"up"},{"l":"Conformidade (%)","v":"65.5%","t":"+9.7%","d":"up"},{"l":"CAPAs Pendentes","v":"7.872","t":"-2.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.072","92.6%","6.558","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.855","96.4%","8.287","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.870","85.9%","5.359","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.314","89.3%","5.653","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.646","84.3%","8.579","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1042},{"label":"Fev","value":749},{"label":"Mar","value":916},{"label":"Abr","value":678},{"label":"Mai","value":909},{"label":"Jun","value":770},{"label":"Jul","value":775},{"label":"Ago","value":818},{"label":"Set","value":734},{"label":"Out","value":1020},{"label":"Nov","value":764},{"label":"Dez","value":929}];
const MX = 1042;
