...
const PAGE = "SPC Charts";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.461","t":"+17.1%","d":"up"},{"l":"NC Abertas","v":"3.002","t":"-0.4%","d":"down"},{"l":"Conformidade (%)","v":"66.9%","t":"+0.5%","d":"up"},{"l":"CAPAs Pendentes","v":"1.694","t":"-1.4%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.865","83.4%","2.476","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","299","90.2%","3.388","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.108","72.1%","8.541","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.778","96.9%","7.178","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.993","95.6%","2.515","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":646},{"label":"Mar","value":848},{"label":"Abr","value":778},{"label":"Mai","value":932},{"label":"Jun","value":1042},{"label":"Jul","value":1039},{"label":"Ago","value":768},{"label":"Set","value":977},{"label":"Out","value":743},{"label":"Nov","value":1030},{"label":"Dez","value":734}];
const MX = 1042;
