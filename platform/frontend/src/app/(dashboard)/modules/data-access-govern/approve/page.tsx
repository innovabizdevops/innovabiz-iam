...
const PAGE = "Approve";
const KPIS = [{"l":"Dashboards Ativos","v":"1.625","t":"+14.4%","d":"up"},{"l":"Queries/Dia","v":"3597","t":"-3.9%","d":"down"},{"l":"Dados Processados (GB)","v":"3.804","t":"+16.0%","d":"up"},{"l":"Utilizadores Analytics","v":"1.089","t":"+0.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3440","2026-01-08","5.743","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3986","2026-02-16","6.728","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2187","2026-01-20","8.224","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4008","2026-03-24","8.043","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3283","2026-03-13","4.347","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":917},{"label":"Mar","value":770},{"label":"Abr","value":708},{"label":"Mai","value":781},{"label":"Jun","value":849},{"label":"Jul","value":817},{"label":"Ago","value":754},{"label":"Set","value":919},{"label":"Out","value":934},{"label":"Nov","value":693},{"label":"Dez","value":747}];
const MX = 934;
