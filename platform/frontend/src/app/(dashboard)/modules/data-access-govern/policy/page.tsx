...
const PAGE = "Policy";
const KPIS = [{"l":"Dashboards Ativos","v":"1.874","t":"+4.8%","d":"up"},{"l":"Queries/Dia","v":"3449","t":"+3.3%","d":"up"},{"l":"Dados Processados (GB)","v":"2.332","t":"+11.3%","d":"up"},{"l":"Utilizadores Analytics","v":"7.899","t":"+11.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","112","2026-03-14","6.428","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1129","2026-02-12","6.982","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2456","2026-03-05","902","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4601","2026-02-13","5.076","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3969","2026-02-24","7.174","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":653},{"label":"Mar","value":755},{"label":"Abr","value":582},{"label":"Mai","value":610},{"label":"Jun","value":779},{"label":"Jul","value":826},{"label":"Ago","value":676},{"label":"Set","value":844},{"label":"Out","value":823},{"label":"Nov","value":650},{"label":"Dez","value":700}];
const MX = 844;
