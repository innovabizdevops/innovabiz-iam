...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.592","t":"-2.3%","d":"down"},{"l":"NC Abertas","v":"5.304","t":"+17.7%","d":"up"},{"l":"Conformidade (%)","v":"87.6%","t":"+1.1%","d":"up"},{"l":"CAPAs Pendentes","v":"442","t":"+6.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.858","77.7%","2.931","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.597","94.5%","1.234","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","236","91.5%","4.924","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.748","89.1%","2.152","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.811","77.2%","7.156","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":383},{"label":"Fev","value":417},{"label":"Mar","value":404},{"label":"Abr","value":501},{"label":"Mai","value":510},{"label":"Jun","value":440},{"label":"Jul","value":623},{"label":"Ago","value":533},{"label":"Set","value":405},{"label":"Out","value":478},{"label":"Nov","value":631},{"label":"Dez","value":444}];
const MX = 631;
