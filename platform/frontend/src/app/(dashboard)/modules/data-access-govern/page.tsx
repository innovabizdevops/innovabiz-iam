...
/* ═══ Data Access Governance — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "5952", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4038", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€314K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "991777952", cells: ["DAT-5952", "Data Access Governance Item 1", "5/9/2026", "€28 052"], status: "active" as const },
    { id: "991781523", cells: ["DAT-9523", "Data Access Governance Item 2", "20/4/2026", "€31 623"], status: "pending" as const },
    { id: "991785094", cells: ["DAT-4094", "Data Access Governance Item 3", "7/11/2026", "€35 194"], status: "completed" as const },
    { id: "991788665", cells: ["DAT-7665", "Data Access Governance Item 4", "22/6/2026", "€38 765"], status: "warning" as const },
    { id: "991792236", cells: ["DAT-2236", "Data Access Governance Item 5", "9/1/2026", "€42 336"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Access Governance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Access Governance</p>
                    </div>
                </div>
