...
const PAGE = "Monitor";
const KPIS = [{"l":"Dashboards Ativos","v":"1.606","t":"+16.4%","d":"up"},{"l":"Queries/Dia","v":"4573","t":"-1.9%","d":"down"},{"l":"Dados Processados (GB)","v":"6.162","t":"+1.3%","d":"up"},{"l":"Utilizadores Analytics","v":"6.460","t":"+6.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2619","2026-02-18","7.970","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3528","2026-03-06","3.613","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1390","2026-01-11","6.202","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2634","2026-03-21","7.396","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1772","2026-02-02","2.877","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":431},{"label":"Fev","value":513},{"label":"Mar","value":216},{"label":"Abr","value":545},{"label":"Mai","value":594},{"label":"Jun","value":509},{"label":"Jul","value":467},{"label":"Ago","value":276},{"label":"Set","value":411},{"label":"Out","value":431},{"label":"Nov","value":570},{"label":"Dez","value":273}];
const MX = 594;
