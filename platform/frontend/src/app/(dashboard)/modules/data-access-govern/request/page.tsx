...
const ACCENT = "#1e3a5f";
const MODULE = "Data Access Governance";
const PAGE = "Request";
const KPIS = [{"l":"Dashboards Ativos","v":"1.666","t":"+2.9%","d":"up"},{"l":"Queries/Dia","v":"344","t":"-4.1%","d":"down"},{"l":"Dados Processados (GB)","v":"6.202","t":"-3.4%","d":"down"},{"l":"Utilizadores Analytics","v":"1.989","t":"+3.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","601","2026-01-06","1.305","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3417","2026-03-20","2.895","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1182","2026-03-27","3.698","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3937","2026-01-08","4.536","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4893","2026-01-21","2.859","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":449},{"label":"Mar","value":638},{"label":"Abr","value":677},{"label":"Mai","value":438},{"label":"Jun","value":413},{"label":"Jul","value":672},{"label":"Ago","value":445},{"label":"Set","value":476},{"label":"Out","value":495},{"label":"Nov","value":686},{"label":"Dez","value":405}];
const MX = 686;
