...
const PAGE = "License";
const KPIS = [{"l":"Formulários Ativos","v":"3.139","t":"+7.8%","d":"up"},{"l":"Submissões/Dia","v":"4442","t":"+12.8%","d":"up"},{"l":"Documentos Gerados","v":"2.263","t":"+11.6%","d":"up"},{"l":"Templates","v":"5.499","t":"+7.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","393","2026-03-21","6.872","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.031","2026-02-12","7.530","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.860","2026-02-01","6.071","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","946","2026-03-02","896","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.581","2026-02-27","8.817","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":576},{"label":"Mar","value":299},{"label":"Abr","value":523},{"label":"Mai","value":435},{"label":"Jun","value":505},{"label":"Jul","value":552},{"label":"Ago","value":413},{"label":"Set","value":676},{"label":"Out","value":383},{"label":"Nov","value":613},{"label":"Dez","value":653}];
const MX = 676;
