...
const ACCENT = "#6d28d9";
const MODULE = "DRM & Rights Management";
const PAGE = "Track";
const KPIS = [{"l":"Formulários Ativos","v":"2.054","t":"-3.4%","d":"down"},{"l":"Submissões/Dia","v":"4751","t":"+4.3%","d":"up"},{"l":"Documentos Gerados","v":"6.288","t":"-3.7%","d":"down"},{"l":"Templates","v":"3.058","t":"+1.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.667","2026-02-12","4.264","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.837","2026-03-03","832","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.116","2026-03-07","3.929","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","448","2026-03-22","7.155","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.468","2026-03-10","6.845","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":318},{"label":"Fev","value":605},{"label":"Mar","value":386},{"label":"Abr","value":343},{"label":"Mai","value":320},{"label":"Jun","value":404},{"label":"Jul","value":476},{"label":"Ago","value":629},{"label":"Set","value":465},{"label":"Out","value":646},{"label":"Nov","value":605},{"label":"Dez","value":406}];
const MX = 646;
