...
const PAGE = "Enforce";
const KPIS = [{"l":"Formulários Ativos","v":"1.346","t":"-5.7%","d":"down"},{"l":"Submissões/Dia","v":"2504","t":"+17.5%","d":"up"},{"l":"Documentos Gerados","v":"2.212","t":"+3.2%","d":"up"},{"l":"Templates","v":"800","t":"+4.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","709","2026-03-09","3.738","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.826","2026-01-21","8.247","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.491","2026-01-03","1.291","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.490","2026-02-07","4.004","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.044","2026-02-06","1.257","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":478},{"label":"Mar","value":584},{"label":"Abr","value":478},{"label":"Mai","value":524},{"label":"Jun","value":638},{"label":"Jul","value":574},{"label":"Ago","value":482},{"label":"Set","value":440},{"label":"Out","value":748},{"label":"Nov","value":428},{"label":"Dez","value":722}];
const MX = 748;
