...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€28.5M","t":"+13.9%","d":"up"},{"l":"MRR (€)","v":"€17834","t":"-4.1%","d":"down"},{"l":"Churn (%)","v":"94.6%","t":"-1.3%","d":"down"},{"l":"ARPU (€)","v":"€87781","t":"-5.6%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 33079.06","6.495","€ 32916.24","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 37874.81","4.233","€ 36542.00","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 302.34","2.506","€ 33558.60","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 4779.04","1.608","€ 4864.80","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 4149.96","248","€ 25496.52","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":963},{"label":"Mar","value":887},{"label":"Abr","value":1016},{"label":"Mai","value":779},{"label":"Jun","value":819},{"label":"Jul","value":875},{"label":"Ago","value":994},{"label":"Set","value":782},{"label":"Out","value":886},{"label":"Nov","value":829},{"label":"Dez","value":761}];
const MX = 1016;
