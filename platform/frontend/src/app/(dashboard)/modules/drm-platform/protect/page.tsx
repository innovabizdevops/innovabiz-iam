...
const PAGE = "Protect";
const KPIS = [{"l":"Formulários Ativos","v":"991","t":"+4.4%","d":"up"},{"l":"Submissões/Dia","v":"3897","t":"+7.1%","d":"up"},{"l":"Documentos Gerados","v":"8.913","t":"+16.8%","d":"up"},{"l":"Templates","v":"3.793","t":"+7.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.336","2026-01-22","2.159","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.720","2026-03-17","1.239","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.738","2026-03-15","7.791","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.848","2026-03-22","3.383","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.761","2026-01-11","5.006","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":376},{"label":"Fev","value":567},{"label":"Mar","value":641},{"label":"Abr","value":556},{"label":"Mai","value":661},{"label":"Jun","value":509},{"label":"Jul","value":564},{"label":"Ago","value":378},{"label":"Set","value":516},{"label":"Out","value":454},{"label":"Nov","value":500},{"label":"Dez","value":416}];
const MX = 661;
