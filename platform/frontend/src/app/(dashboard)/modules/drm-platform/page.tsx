...
/* ═══ DRM & Rights Management — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "5008", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3143", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€221K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1946988408", cells: ["DRM-1408", "DRM & Rights Management Item 1", "9/1/2026", "€38 508"], status: "active" as const },
    { id: "1946991979", cells: ["DRM-4979", "DRM & Rights Management Item 2", "24/8/2026", "€42 079"], status: "pending" as const },
    { id: "1946995550", cells: ["DRM-8550", "DRM & Rights Management Item 3", "11/3/2026", "€45 650"], status: "completed" as const },
    { id: "1946999121", cells: ["DRM-3121", "DRM & Rights Management Item 4", "26/10/2026", "€49 221"], status: "warning" as const },
    { id: "1947002692", cells: ["DRM-6692", "DRM & Rights Management Item 5", "13/5/2026", "€2792"], status: "active" as const },
];
...
export default function DrmRightsManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">DRM & Rights Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • DRM & Rights Management</p>
                    </div>
                </div>
