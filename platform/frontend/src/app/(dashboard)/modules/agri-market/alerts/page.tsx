...
const PAGE = "Price Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"7.772","t":"+12.8%","d":"up"},{"l":"Taxa Entrega (%)","v":"73.1%","t":"+13.5%","d":"up"},{"l":"Taxa Abertura (%)","v":"87.0%","t":"+10.2%","d":"up"},{"l":"Escalações","v":"1.380","t":"+5.7%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","6.388","77.5%","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","1.143","91.4%","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","3.381","95.2%","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","6.659","87.3%","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","2.561","80.6%","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":858},{"label":"Mar","value":1018},{"label":"Abr","value":710},{"label":"Mai","value":741},{"label":"Jun","value":850},{"label":"Jul","value":972},{"label":"Ago","value":1070},{"label":"Set","value":891},{"label":"Out","value":873},{"label":"Nov","value":927},{"label":"Dez","value":712}];
const MX = 1070;
