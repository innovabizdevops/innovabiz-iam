...
const PAGE = "Auction";
const KPIS = [{"l":"Total Agri Market","v":"6.258","t":"+0.7%","d":"up"},{"l":"Auction Ativos","v":"1.557","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"86.7%","t":"+17.2%","d":"up"},{"l":"Score Performance","v":"63","t":"+3.9%","d":"up"}];
const COLS = ["ID","Auction","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Market #001","Agri Market #002","6.598","5.329","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Market #002","Agri Market #003","1.932","1.469","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Market #003","Agri Market #004","1.472","7.552","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Market #004","Agri Market #005","562","3.197","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Market #005","Agri Market #001","5.695","1.246","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":300},{"label":"Fev","value":557},{"label":"Mar","value":487},{"label":"Abr","value":579},{"label":"Mai","value":338},{"label":"Jun","value":630},{"label":"Jul","value":614},{"label":"Ago","value":533},{"label":"Set","value":481},{"label":"Out","value":337},{"label":"Nov","value":628},{"label":"Dez","value":411}];
const MX = 630;
