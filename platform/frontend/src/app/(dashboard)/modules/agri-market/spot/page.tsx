...
const PAGE = "Spot Price";
const KPIS = [{"l":"Total Agri Market","v":"4.737","t":"-3.1%","d":"down"},{"l":"Spot Price Ativos","v":"8.180","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"68.5%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"66","t":"+6.9%","d":"up"}];
const COLS = ["ID","Spot Price","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Market #001","Agri Market #002","2.097","7.075","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Market #002","Agri Market #003","476","2.663","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Market #003","Agri Market #004","1.735","1.604","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Market #004","Agri Market #005","1.144","4.852","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Market #005","Agri Market #001","7.213","2.902","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":726},{"label":"Mar","value":715},{"label":"Abr","value":671},{"label":"Mai","value":725},{"label":"Jun","value":901},{"label":"Jul","value":965},{"label":"Ago","value":984},{"label":"Set","value":794},{"label":"Out","value":952},{"label":"Nov","value":949},{"label":"Dez","value":861}];
const MX = 984;
