...
const ACCENT = "#0369a1";
const MODULE = "AgriMarket Exchange";
const PAGE = "Forward Contract";
const KPIS = [{"l":"Contratos Ativos","v":"4.017","t":"+6.4%","d":"up"},{"l":"Valor Total (€M)","v":"€11.8M","t":"+10.2%","d":"up"},{"l":"Renovações Próx. 30d","v":"398","t":"-0.3%","d":"down"},{"l":"Obrigações Pendentes","v":"1.488","t":"+2.0%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 30192.75","2026-01-23","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 27685.25","2026-03-28","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 26134.68","2026-02-12","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 32517.99","2026-03-15","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 40188.24","2026-02-06","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":967},{"label":"Fev","value":920},{"label":"Mar","value":695},{"label":"Abr","value":933},{"label":"Mai","value":746},{"label":"Jun","value":961},{"label":"Jul","value":714},{"label":"Ago","value":778},{"label":"Set","value":751},{"label":"Out","value":976},{"label":"Nov","value":631},{"label":"Dez","value":1014}];
const MX = 1014;
