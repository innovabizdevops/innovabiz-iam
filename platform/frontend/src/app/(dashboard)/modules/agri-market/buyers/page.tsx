...
const PAGE = "Buyer Connect";
const KPIS = [{"l":"Total Agri Market","v":"8.716","t":"+10.8%","d":"up"},{"l":"Buyer Connect Ativos","v":"6.481","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"65.6%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"84","t":"+0.4%","d":"up"}];
const COLS = ["ID","Buyer Connect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Market #001","Agri Market #002","1.236","1.910","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Market #002","Agri Market #003","7.843","5.916","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Market #003","Agri Market #004","3.183","1.989","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Market #004","Agri Market #005","7.243","8.923","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Market #005","Agri Market #001","3.026","8.882","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":714},{"label":"Mar","value":814},{"label":"Abr","value":714},{"label":"Mai","value":805},{"label":"Jun","value":624},{"label":"Jul","value":786},{"label":"Ago","value":703},{"label":"Set","value":781},{"label":"Out","value":656},{"label":"Nov","value":915},{"label":"Dez","value":610}];
const MX = 915;
