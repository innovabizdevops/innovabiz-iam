...
const KPIS = [{"l":"ARR (€M)","v":"€13.7M","t":"+17.4%","d":"up"},{"l":"MRR (€)","v":"€91852","t":"-3.1%","d":"down"},{"l":"Churn (%)","v":"68.1%","t":"-3.1%","d":"down"},{"l":"ARPU (€)","v":"€5316","t":"-0.7%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 1596.14","132","€ 33782.55","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 5153.32","5.196","€ 33816.80","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 11421.22","8.729","€ 8457.89","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 38202.83","5.520","€ 29321.18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 43629.65","7.558","€ 34804.24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":548},{"label":"Mar","value":312},{"label":"Abr","value":535},{"label":"Mai","value":328},{"label":"Jun","value":449},{"label":"Jul","value":489},{"label":"Ago","value":501},{"label":"Set","value":339},{"label":"Out","value":425},{"label":"Nov","value":497},{"label":"Dez","value":626}];
const MX = 636;
