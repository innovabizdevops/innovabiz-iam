...
const ACCENT = "#b45309";
const MODULE = "Carrier Management";
const PAGE = "Rate Mgmt";
const KPIS = [{"l":"ARR (€M)","v":"€44.5M","t":"-5.7%","d":"down"},{"l":"MRR (€)","v":"€73792","t":"+1.0%","d":"up"},{"l":"Churn (%)","v":"88.8%","t":"-2.1%","d":"down"},{"l":"ARPU (€)","v":"€78925","t":"-3.6%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 27825.53","8.084","€ 1107.05","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 36037.55","1.818","€ 38634.45","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 26018.77","5.024","€ 39871.73","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 11489.66","8.154","€ 4860.43","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 1267.07","7.210","€ 21221.56","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":293},{"label":"Fev","value":605},{"label":"Mar","value":294},{"label":"Abr","value":416},{"label":"Mai","value":617},{"label":"Jun","value":587},{"label":"Jul","value":620},{"label":"Ago","value":344},{"label":"Set","value":253},{"label":"Out","value":610},{"label":"Nov","value":628},{"label":"Dez","value":566}];
const MX = 628;
