...
const KPIS = [{"l":"Auditorias Realizadas","v":"5.415","t":"-0.6%","d":"down"},{"l":"NC Abertas","v":"8.384","t":"+2.0%","d":"up"},{"l":"Conformidade (%)","v":"67.8%","t":"+8.0%","d":"up"},{"l":"CAPAs Pendentes","v":"694","t":"+2.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.804","86.3%","864","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.309","96.6%","4.104","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.423","96.2%","7.800","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","249","78.3%","5.980","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.272","85.2%","3.965","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":395},{"label":"Fev","value":416},{"label":"Mar","value":656},{"label":"Abr","value":395},{"label":"Mai","value":469},{"label":"Jun","value":698},{"label":"Jul","value":707},{"label":"Ago","value":651},{"label":"Set","value":440},{"label":"Out","value":682},{"label":"Nov","value":629},{"label":"Dez","value":696}];
const MX = 707;
