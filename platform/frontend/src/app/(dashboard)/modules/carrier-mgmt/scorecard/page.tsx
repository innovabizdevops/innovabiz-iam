...
const KPIS = [{"l":"ARR (€M)","v":"€7.2M","t":"+6.6%","d":"up"},{"l":"MRR (€)","v":"€44213","t":"+8.2%","d":"up"},{"l":"Churn (%)","v":"72.1%","t":"+2.4%","d":"up"},{"l":"ARPU (€)","v":"€60848","t":"+7.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 18892.48","525","€ 26510.41","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 33139.87","5.186","€ 9132.43","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 12788.96","3.859","€ 35917.57","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 21610.55","1.422","€ 21671.04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 23959.61","5.657","€ 9046.63","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":871},{"label":"Fev","value":959},{"label":"Mar","value":694},{"label":"Abr","value":635},{"label":"Mai","value":759},{"label":"Jun","value":950},{"label":"Jul","value":885},{"label":"Ago","value":571},{"label":"Set","value":698},{"label":"Out","value":568},{"label":"Nov","value":901},{"label":"Dez","value":866}];
const MX = 959;
