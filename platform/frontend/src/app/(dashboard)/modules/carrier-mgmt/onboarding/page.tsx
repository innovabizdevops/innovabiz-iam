...
const KPIS = [{"l":"eNPS","v":"78","t":"+6.8%","d":"up"},{"l":"Engagement (%)","v":"66.7%","t":"+7.1%","d":"up"},{"l":"Turnover (%)","v":"94.3%","t":"+3.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.621","t":"+12.9%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.478","2026-03-03","64","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.967","2026-02-13","84","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","252","2026-02-02","60","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.998","2026-03-27","66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.781","2026-02-13","81","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":1036},{"label":"Mar","value":834},{"label":"Abr","value":762},{"label":"Mai","value":967},{"label":"Jun","value":830},{"label":"Jul","value":762},{"label":"Ago","value":882},{"label":"Set","value":906},{"label":"Out","value":859},{"label":"Nov","value":702},{"label":"Dez","value":697}];
const MX = 1036;
