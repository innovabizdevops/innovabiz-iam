...
const ACCENT = "#b45309";
const MODULE = "Port Management";
const PAGE = "Tug Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"3.235","t":"+1.5%","d":"up"},{"l":"Viagens/Dia","v":"1355","t":"-3.4%","d":"down"},{"l":"Pontualidade (%)","v":"93.6%","t":"+14.2%","d":"up"},{"l":"Passageiros/Dia","v":"2367","t":"+11.8%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-19","2026-03-04","4.924","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-06","2026-03-09","4.502","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-01","2026-02-10","6.020","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-11","2026-02-18","6.549","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-28","2026-03-25","1.769","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":1034},{"label":"Mar","value":1004},{"label":"Abr","value":905},{"label":"Mai","value":817},{"label":"Jun","value":944},{"label":"Jul","value":750},{"label":"Ago","value":768},{"label":"Set","value":859},{"label":"Out","value":888},{"label":"Nov","value":908},{"label":"Dez","value":888}];
const MX = 1034;
