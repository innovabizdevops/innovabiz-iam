...
const PAGE = "Port Clearance";
const KPIS = [{"l":"Total Port Mgmt","v":"3.527","t":"+3.6%","d":"up"},{"l":"Port Clearance Ativos","v":"8.048","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"82.4%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"67","t":"+16.7%","d":"up"}];
const COLS = ["ID","Port Clearance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Port Mgmt #001","Port Mgmt #002","5.686","5.431","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Port Mgmt #002","Port Mgmt #003","577","2.875","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Port Mgmt #003","Port Mgmt #004","4.028","5.640","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Port Mgmt #004","Port Mgmt #005","4.413","1.187","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Port Mgmt #005","Port Mgmt #001","8.556","2.202","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":438},{"label":"Mar","value":528},{"label":"Abr","value":416},{"label":"Mai","value":568},{"label":"Jun","value":435},{"label":"Jul","value":501},{"label":"Ago","value":499},{"label":"Set","value":411},{"label":"Out","value":359},{"label":"Nov","value":539},{"label":"Dez","value":423}];
const MX = 589;
