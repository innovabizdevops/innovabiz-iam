...
const PAGE = "Pilot Schedule";
const KPIS = [{"l":"Total Port Mgmt","v":"6.814","t":"+14.3%","d":"up"},{"l":"Pilot Schedule Ativos","v":"3.226","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"93","t":"-5.7%","d":"down"}];
const COLS = ["ID","Pilot Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Port Mgmt #001","Port Mgmt #002","7.914","1.134","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Port Mgmt #002","Port Mgmt #003","3.350","1.704","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Port Mgmt #003","Port Mgmt #004","8.941","8.853","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Port Mgmt #004","Port Mgmt #005","368","8.707","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Port Mgmt #005","Port Mgmt #001","2.081","7.806","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":461},{"label":"Fev","value":482},{"label":"Mar","value":365},{"label":"Abr","value":474},{"label":"Mai","value":471},{"label":"Jun","value":233},{"label":"Jul","value":520},{"label":"Ago","value":485},{"label":"Set","value":511},{"label":"Out","value":333},{"label":"Nov","value":609},{"label":"Dez","value":468}];
const MX = 609;
