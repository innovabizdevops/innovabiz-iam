...
const PAGE = "Tariff Mgmt";
const KPIS = [{"l":"Total Port Mgmt","v":"1.696","t":"+4.7%","d":"up"},{"l":"Tariff Mgmt Ativos","v":"6.620","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"83.7%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"94","t":"+3.1%","d":"up"}];
const COLS = ["ID","Tariff Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Port Mgmt #001","Port Mgmt #002","4.581","694","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Port Mgmt #002","Port Mgmt #003","8.924","6.179","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Port Mgmt #003","Port Mgmt #004","3.032","6.110","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Port Mgmt #004","Port Mgmt #005","6.797","8.820","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Port Mgmt #005","Port Mgmt #001","2.681","3.616","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1035},{"label":"Fev","value":725},{"label":"Mar","value":824},{"label":"Abr","value":1016},{"label":"Mai","value":957},{"label":"Jun","value":883},{"label":"Jul","value":1062},{"label":"Ago","value":888},{"label":"Set","value":872},{"label":"Out","value":889},{"label":"Nov","value":894},{"label":"Dez","value":900}];
const MX = 1062;
