...
const PAGE = "Berth Planning";
const KPIS = [{"l":"Total Port Mgmt","v":"2.419","t":"+15.1%","d":"up"},{"l":"Berth Planning Ativos","v":"4.584","t":"+2.9%","d":"up"},{"l":"Eficiência (%)","v":"80.2%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"70","t":"+0.1%","d":"up"}];
const COLS = ["ID","Berth Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Port Mgmt #001","Port Mgmt #002","7.911","3.698","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Port Mgmt #002","Port Mgmt #003","5.490","5.164","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Port Mgmt #003","Port Mgmt #004","6.802","3.394","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Port Mgmt #004","Port Mgmt #005","8.690","9.046","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Port Mgmt #005","Port Mgmt #001","3.406","4.545","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":474},{"label":"Fev","value":639},{"label":"Mar","value":674},{"label":"Abr","value":520},{"label":"Mai","value":537},{"label":"Jun","value":444},{"label":"Jul","value":547},{"label":"Ago","value":658},{"label":"Set","value":546},{"label":"Out","value":586},{"label":"Nov","value":624},{"label":"Dez","value":795}];
const MX = 795;
