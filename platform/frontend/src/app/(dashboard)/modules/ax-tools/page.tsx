...
/* ═══ AX Tool Integration — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "3780", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "163", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€208K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1317347180", cells: ["AX-9180", "AX Tool Integration Item 1", "17/9/2026", "€47 280"], status: "active" as const },
    { id: "1317350751", cells: ["AX-3751", "AX Tool Integration Item 2", "4/4/2026", "€851"], status: "pending" as const },
    { id: "1317354322", cells: ["AX-7322", "AX Tool Integration Item 3", "19/11/2026", "€4422"], status: "completed" as const },
    { id: "1317357893", cells: ["AX-1893", "AX Tool Integration Item 4", "6/6/2026", "€7993"], status: "warning" as const },
    { id: "1317361464", cells: ["AX-5464", "AX Tool Integration Item 5", "21/1/2026", "€11 564"], status: "active" as const },
];
...
export default function AxToolIntegrationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AX Tool Integration</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AX Tool Integration</p>
                    </div>
                </div>
