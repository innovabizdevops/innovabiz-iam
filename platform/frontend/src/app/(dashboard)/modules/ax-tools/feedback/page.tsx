...
const ACCENT = "#4f46e5";
const MODULE = "AX Tool Integration";
const PAGE = "Feedback";
const KPIS = [{"l":"Surveys Ativos","v":"7.464","t":"-5.4%","d":"down"},{"l":"Respostas/Semana","v":"2381","t":"+6.4%","d":"up"},{"l":"NPS Médio","v":"59","t":"+16.7%","d":"up"},{"l":"Taxa Resposta (%)","v":"87.8%","t":"+16.3%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","3.020","55","72.0%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","6.798","94","71.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","6.016","87","98.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","8.312","74","96.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","3.564","57","79.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":936},{"label":"Fev","value":833},{"label":"Mar","value":679},{"label":"Abr","value":947},{"label":"Mai","value":897},{"label":"Jun","value":583},{"label":"Jul","value":647},{"label":"Ago","value":751},{"label":"Set","value":723},{"label":"Out","value":957},{"label":"Nov","value":812},{"label":"Dez","value":652}];
const MX = 957;
