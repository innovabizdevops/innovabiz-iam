...
const PAGE = "Execute";
const KPIS = [{"l":"Total Ax Tools","v":"700","t":"+10.1%","d":"up"},{"l":"Execute Ativos","v":"4.215","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"65.9%","t":"+12.2%","d":"up"},{"l":"Score Performance","v":"65","t":"+12.3%","d":"up"}];
const COLS = ["ID","Execute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Tools #001","Ax Tools #002","3.814","4.571","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Tools #002","Ax Tools #003","1.119","2.712","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Tools #003","Ax Tools #004","3.720","3.804","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Tools #004","Ax Tools #005","7.440","2.333","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Tools #005","Ax Tools #001","1.389","6.803","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":600},{"label":"Mar","value":640},{"label":"Abr","value":468},{"label":"Mai","value":750},{"label":"Jun","value":642},{"label":"Jul","value":809},{"label":"Ago","value":755},{"label":"Set","value":747},{"label":"Out","value":694},{"label":"Nov","value":523},{"label":"Dez","value":539}];
const MX = 809;
