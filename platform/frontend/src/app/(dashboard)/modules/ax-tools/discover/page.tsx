...
const PAGE = "Discover";
const KPIS = [{"l":"Total Ax Tools","v":"8.191","t":"+14.1%","d":"up"},{"l":"Discover Ativos","v":"7.071","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"66","t":"+3.9%","d":"up"}];
const COLS = ["ID","Discover","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Tools #001","Ax Tools #002","7.989","7.702","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Tools #002","Ax Tools #003","4.966","4.733","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Tools #003","Ax Tools #004","3.039","5.235","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Tools #004","Ax Tools #005","1.107","8.351","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Tools #005","Ax Tools #001","2.392","6.438","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":955},{"label":"Fev","value":666},{"label":"Mar","value":651},{"label":"Abr","value":590},{"label":"Mai","value":807},{"label":"Jun","value":666},{"label":"Jul","value":945},{"label":"Ago","value":865},{"label":"Set","value":953},{"label":"Out","value":785},{"label":"Nov","value":898},{"label":"Dez","value":674}];
const MX = 955;
