...
const PAGE = "Bind";
const KPIS = [{"l":"Total Ax Tools","v":"4.854","t":"-0.8%","d":"down"},{"l":"Bind Ativos","v":"2.445","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"79.5%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"91","t":"-5.3%","d":"down"}];
const COLS = ["ID","Bind","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Tools #001","Ax Tools #002","5.954","4.489","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Tools #002","Ax Tools #003","1.290","6.496","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Tools #003","Ax Tools #004","3.701","8.873","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Tools #004","Ax Tools #005","7.966","7.921","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Tools #005","Ax Tools #001","8.542","1.657","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":756},{"label":"Mar","value":900},{"label":"Abr","value":626},{"label":"Mai","value":656},{"label":"Jun","value":834},{"label":"Jul","value":890},{"label":"Ago","value":853},{"label":"Set","value":582},{"label":"Out","value":874},{"label":"Nov","value":793},{"label":"Dez","value":832}];
const MX = 900;
