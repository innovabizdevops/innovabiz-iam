...
export default function AdasAutonomousPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Adas Autonomous</h1><p className="text-sm text-muted-foreground">Adas Autonomous • iBOS Enterprise</p></div>
