...
const PAGE = "Sensor";
const KPIS = [{"l":"Dispositivos Online","v":"3.266","t":"+3.6%","d":"up"},{"l":"Dados/Min (MB)","v":"1.972","t":"+16.7%","d":"up"},{"l":"Alertas Ativos","v":"6.612","t":"-3.6%","d":"down"},{"l":"Uptime (%)","v":"90.8%","t":"+0.5%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.178","116","8.227","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.373","211","2.008","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.218","4.855","8.477","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","8.085","2.575","1.394","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.131","7.166","7.118","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":569},{"label":"Mar","value":715},{"label":"Abr","value":494},{"label":"Mai","value":490},{"label":"Jun","value":651},{"label":"Jul","value":338},{"label":"Ago","value":372},{"label":"Set","value":480},{"label":"Out","value":637},{"label":"Nov","value":417},{"label":"Dez","value":673}];
const MX = 715;
