...
const PAGE = "Query";
const KPIS = [{"l":"Dashboards Ativos","v":"288","t":"+5.2%","d":"up"},{"l":"Queries/Dia","v":"3218","t":"-1.8%","d":"down"},{"l":"Dados Processados (GB)","v":"8.536","t":"-3.2%","d":"down"},{"l":"Utilizadores Analytics","v":"5.871","t":"+16.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3866","2026-01-28","2.348","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2875","2026-01-16","7.687","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4979","2026-02-09","739","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1595","2026-02-08","6.289","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3748","2026-03-06","4.803","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":304},{"label":"Mar","value":262},{"label":"Abr","value":618},{"label":"Mai","value":305},{"label":"Jun","value":429},{"label":"Jul","value":270},{"label":"Ago","value":573},{"label":"Set","value":334},{"label":"Out","value":443},{"label":"Nov","value":403},{"label":"Dez","value":579}];
const MX = 618;
