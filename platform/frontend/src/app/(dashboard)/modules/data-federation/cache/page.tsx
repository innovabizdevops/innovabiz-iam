...
const PAGE = "Cache";
const KPIS = [{"l":"Dashboards Ativos","v":"6.788","t":"+4.0%","d":"up"},{"l":"Queries/Dia","v":"2637","t":"+6.1%","d":"up"},{"l":"Dados Processados (GB)","v":"1.434","t":"-3.2%","d":"down"},{"l":"Utilizadores Analytics","v":"1.531","t":"+9.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1378","2026-02-13","8.811","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4218","2026-01-07","8.337","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3049","2026-01-06","6.122","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2872","2026-01-23","3.847","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","798","2026-03-19","6.008","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":722},{"label":"Mar","value":726},{"label":"Abr","value":630},{"label":"Mai","value":349},{"label":"Jun","value":397},{"label":"Jul","value":524},{"label":"Ago","value":593},{"label":"Set","value":706},{"label":"Out","value":703},{"label":"Nov","value":546},{"label":"Dez","value":365}];
const MX = 726;
