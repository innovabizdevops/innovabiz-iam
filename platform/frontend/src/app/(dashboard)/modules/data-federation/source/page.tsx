...
const ACCENT = "#0d9488";
const MODULE = "Data Federation Engine";
const PAGE = "Source";
const KPIS = [{"l":"Dashboards Ativos","v":"7.359","t":"-5.0%","d":"down"},{"l":"Queries/Dia","v":"3872","t":"-1.3%","d":"down"},{"l":"Dados Processados (GB)","v":"3.128","t":"+10.6%","d":"up"},{"l":"Utilizadores Analytics","v":"8.178","t":"+6.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4429","2026-02-07","1.770","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1460","2026-01-18","4.819","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4793","2026-03-08","1.922","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","5084","2026-03-25","3.620","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4101","2026-01-11","1.487","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":755},{"label":"Mar","value":722},{"label":"Abr","value":777},{"label":"Mai","value":737},{"label":"Jun","value":728},{"label":"Jul","value":415},{"label":"Ago","value":469},{"label":"Set","value":668},{"label":"Out","value":795},{"label":"Nov","value":539},{"label":"Dez","value":480}];
const MX = 795;
