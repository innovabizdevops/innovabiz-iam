...
/* ═══ Data Federation Engine — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "7013", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "118", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€58K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "498660013", cells: ["DAT-7013", "Data Federation Engine Item 1", "6/2/2026", "€10 113"], status: "active" as const },
    { id: "498663584", cells: ["DAT-1584", "Data Federation Engine Item 2", "21/9/2026", "€13 684"], status: "pending" as const },
    { id: "498667155", cells: ["DAT-5155", "Data Federation Engine Item 3", "8/4/2026", "€17 255"], status: "completed" as const },
    { id: "498670726", cells: ["DAT-8726", "Data Federation Engine Item 4", "23/11/2026", "€20 826"], status: "warning" as const },
    { id: "498674297", cells: ["DAT-3297", "Data Federation Engine Item 5", "10/6/2026", "€24 397"], status: "active" as const },
];
...
export default function DataFederationEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Federation Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Federation Engine</p>
                    </div>
                </div>
