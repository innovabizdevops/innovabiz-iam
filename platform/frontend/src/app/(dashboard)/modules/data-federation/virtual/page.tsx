...
const PAGE = "Virtual";
const KPIS = [{"l":"Dashboards Ativos","v":"1.645","t":"-2.2%","d":"down"},{"l":"Queries/Dia","v":"2045","t":"+7.6%","d":"up"},{"l":"Dados Processados (GB)","v":"382","t":"+8.0%","d":"up"},{"l":"Utilizadores Analytics","v":"4.017","t":"+5.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","326","2026-02-14","6.830","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4132","2026-01-22","2.555","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1196","2026-02-12","631","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2216","2026-01-20","7.575","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3003","2026-01-27","3.723","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":867},{"label":"Fev","value":692},{"label":"Mar","value":857},{"label":"Abr","value":889},{"label":"Mai","value":885},{"label":"Jun","value":796},{"label":"Jul","value":980},{"label":"Ago","value":845},{"label":"Set","value":886},{"label":"Out","value":738},{"label":"Nov","value":945},{"label":"Dez","value":913}];
const MX = 980;
