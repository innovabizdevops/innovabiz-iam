...
const PAGE = "Govern";
const KPIS = [{"l":"Dashboards Ativos","v":"5.460","t":"+5.5%","d":"up"},{"l":"Queries/Dia","v":"1079","t":"+3.4%","d":"up"},{"l":"Dados Processados (GB)","v":"4.764","t":"+4.1%","d":"up"},{"l":"Utilizadores Analytics","v":"1.817","t":"-4.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2337","2026-03-21","2.598","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2910","2026-03-16","1.101","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3494","2026-03-21","3.697","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","961","2026-02-10","4.739","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4680","2026-03-16","7.738","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":318},{"label":"Mar","value":523},{"label":"Abr","value":352},{"label":"Mai","value":265},{"label":"Jun","value":530},{"label":"Jul","value":606},{"label":"Ago","value":618},{"label":"Set","value":292},{"label":"Out","value":358},{"label":"Nov","value":304},{"label":"Dez","value":603}];
const MX = 618;
