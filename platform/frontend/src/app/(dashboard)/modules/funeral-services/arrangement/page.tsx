...
const PAGE = "Arrangement";
const KPIS = [{"l":"ARR (€M)","v":"€29.2M","t":"-3.2%","d":"down"},{"l":"MRR (€)","v":"€61323","t":"+7.1%","d":"up"},{"l":"Churn (%)","v":"82.1%","t":"-0.2%","d":"down"},{"l":"ARPU (€)","v":"€53140","t":"-0.9%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 23353.07","5.424","€ 11592.15","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 14253.45","213","€ 38222.79","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 49394.39","4.760","€ 21073.37","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 45443.43","8.072","€ 33445.91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 37030.24","5.489","€ 10232.54","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":710},{"label":"Mar","value":834},{"label":"Abr","value":840},{"label":"Mai","value":784},{"label":"Jun","value":729},{"label":"Jul","value":552},{"label":"Ago","value":740},{"label":"Set","value":866},{"label":"Out","value":682},{"label":"Nov","value":730},{"label":"Dez","value":606}];
const MX = 866;
