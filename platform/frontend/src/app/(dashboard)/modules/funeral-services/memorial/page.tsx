...
const PAGE = "Memorial";
const KPIS = [{"l":"Total Funeral Services","v":"3.932","t":"+15.9%","d":"up"},{"l":"Memorial Ativos","v":"8.848","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"91.3%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"94","t":"+3.1%","d":"up"}];
const COLS = ["ID","Memorial","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Funeral Services #001","Funeral Services #002","1.992","1.131","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Funeral Services #002","Funeral Services #003","7.047","2.809","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Funeral Services #003","Funeral Services #004","4.934","1.618","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Funeral Services #004","Funeral Services #005","4.955","3.292","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Funeral Services #005","Funeral Services #001","3.363","5.399","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":487},{"label":"Mar","value":616},{"label":"Abr","value":441},{"label":"Mai","value":338},{"label":"Jun","value":348},{"label":"Jul","value":523},{"label":"Ago","value":377},{"label":"Set","value":406},{"label":"Out","value":642},{"label":"Nov","value":585},{"label":"Dez","value":557}];
const MX = 642;
