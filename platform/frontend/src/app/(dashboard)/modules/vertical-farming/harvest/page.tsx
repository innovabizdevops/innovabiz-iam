...
const PAGE = "Harvest";
const KPIS = [{"l":"Total Vertical Farming","v":"4.158","t":"-3.3%","d":"down"},{"l":"Harvest Ativos","v":"2.678","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"66.1%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"75","t":"-3.2%","d":"down"}];
const COLS = ["ID","Harvest","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vertical Farming #001","Vertical Farming #002","7.033","8.917","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Vertical Farming #002","Vertical Farming #003","1.281","8.252","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Vertical Farming #003","Vertical Farming #004","1.008","7.280","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Vertical Farming #004","Vertical Farming #005","3.350","1.500","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vertical Farming #005","Vertical Farming #001","5.484","6.198","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":874},{"label":"Mar","value":716},{"label":"Abr","value":692},{"label":"Mai","value":649},{"label":"Jun","value":802},{"label":"Jul","value":836},{"label":"Ago","value":653},{"label":"Set","value":640},{"label":"Out","value":726},{"label":"Nov","value":741},{"label":"Dez","value":572}];
const MX = 874;
