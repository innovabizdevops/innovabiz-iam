...
/* ═══ Vertical Farming Platform — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "1252", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4901", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€102K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "112019652", cells: ["VER-6652", "Vertical Farming Platform Item 1", "25/1/2026", "€19 752"], status: "active" as const },
    { id: "112023223", cells: ["VER-1223", "Vertical Farming Platform Item 2", "12/8/2026", "€23 323"], status: "pending" as const },
    { id: "112026794", cells: ["VER-4794", "Vertical Farming Platform Item 3", "27/3/2026", "€26 894"], status: "completed" as const },
    { id: "112030365", cells: ["VER-8365", "Vertical Farming Platform Item 4", "14/10/2026", "€30 465"], status: "warning" as const },
    { id: "112033936", cells: ["VER-2936", "Vertical Farming Platform Item 5", "1/5/2026", "€34 036"], status: "active" as const },
];
...
export default function VerticalFarmingPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Vertical Farming Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Vertical Farming Platform</p>
                    </div>
                </div>
