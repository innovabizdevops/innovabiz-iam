...
const ACCENT = "#166534";
const MODULE = "Vertical Farming Platform";
const PAGE = "Environment";
const KPIS = [{"l":"Total Vertical Farming","v":"2.665","t":"+14.3%","d":"up"},{"l":"Environment Ativos","v":"2.382","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"70.1%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"75","t":"+1.3%","d":"up"}];
const COLS = ["ID","Environment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vertical Farming #001","Vertical Farming #002","3.731","358","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Vertical Farming #002","Vertical Farming #003","2.240","317","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Vertical Farming #003","Vertical Farming #004","2.435","2.595","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Vertical Farming #004","Vertical Farming #005","8.882","8.552","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vertical Farming #005","Vertical Farming #001","2.564","3.479","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":627},{"label":"Mar","value":619},{"label":"Abr","value":346},{"label":"Mai","value":561},{"label":"Jun","value":681},{"label":"Jul","value":676},{"label":"Ago","value":643},{"label":"Set","value":473},{"label":"Out","value":613},{"label":"Nov","value":409},{"label":"Dez","value":385}];
const MX = 681;
