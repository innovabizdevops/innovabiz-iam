...
const ACCENT = "#166534";
const MODULE = "Camping & RV Park";
const PAGE = "Activity";
const KPIS = [{"l":"Total Camping Ground","v":"6.468","t":"+9.7%","d":"up"},{"l":"Activity Ativos","v":"3.472","t":"+7.0%","d":"up"},{"l":"Eficiência (%)","v":"68.5%","t":"-5.9%","d":"down"},{"l":"Score Performance","v":"63","t":"+5.6%","d":"up"}];
const COLS = ["ID","Activity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Camping Ground #001","Camping Ground #002","1.765","6.555","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Camping Ground #002","Camping Ground #003","7.780","8.676","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Camping Ground #003","Camping Ground #004","3.402","5.546","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Camping Ground #004","Camping Ground #005","5.804","3.128","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Camping Ground #005","Camping Ground #001","6.772","4.863","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":806},{"label":"Fev","value":799},{"label":"Mar","value":873},{"label":"Abr","value":934},{"label":"Mai","value":604},{"label":"Jun","value":843},{"label":"Jul","value":906},{"label":"Ago","value":873},{"label":"Set","value":924},{"label":"Out","value":926},{"label":"Nov","value":616},{"label":"Dez","value":843}];
const MX = 934;
