...
const PAGE = "Site";
const KPIS = [{"l":"Total Camping Ground","v":"4.504","t":"+17.1%","d":"up"},{"l":"Site Ativos","v":"1.345","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"67.9%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"94","t":"-3.1%","d":"down"}];
const COLS = ["ID","Site","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Camping Ground #001","Camping Ground #002","5.542","3.233","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Camping Ground #002","Camping Ground #003","7.453","5.560","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Camping Ground #003","Camping Ground #004","3.274","8.148","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Camping Ground #004","Camping Ground #005","1.887","7.326","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Camping Ground #005","Camping Ground #001","3.281","2.843","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":372},{"label":"Fev","value":466},{"label":"Mar","value":690},{"label":"Abr","value":657},{"label":"Mai","value":614},{"label":"Jun","value":628},{"label":"Jul","value":611},{"label":"Ago","value":532},{"label":"Set","value":352},{"label":"Out","value":384},{"label":"Nov","value":391},{"label":"Dez","value":315}];
const MX = 690;
