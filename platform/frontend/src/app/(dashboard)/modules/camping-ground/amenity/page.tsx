...
const PAGE = "Amenity";
const KPIS = [{"l":"Total Camping Ground","v":"1.505","t":"+1.7%","d":"up"},{"l":"Amenity Ativos","v":"307","t":"-1.5%","d":"down"},{"l":"Eficiência (%)","v":"81.3%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"61","t":"+12.6%","d":"up"}];
const COLS = ["ID","Amenity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Camping Ground #001","Camping Ground #002","158","5.548","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Camping Ground #002","Camping Ground #003","2.675","1.975","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Camping Ground #003","Camping Ground #004","3.853","7.385","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Camping Ground #004","Camping Ground #005","5.375","4.029","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Camping Ground #005","Camping Ground #001","238","3.096","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":819},{"label":"Mar","value":788},{"label":"Abr","value":713},{"label":"Mai","value":592},{"label":"Jun","value":576},{"label":"Jul","value":723},{"label":"Ago","value":804},{"label":"Set","value":783},{"label":"Out","value":811},{"label":"Nov","value":802},{"label":"Dez","value":548}];
const MX = 819;
