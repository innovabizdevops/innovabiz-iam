...
const PAGE = "Season";
const KPIS = [{"l":"Total Camping Ground","v":"8.425","t":"+13.1%","d":"up"},{"l":"Season Ativos","v":"835","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"91.0%","t":"+8.3%","d":"up"},{"l":"Score Performance","v":"94","t":"-4.9%","d":"down"}];
const COLS = ["ID","Season","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Camping Ground #001","Camping Ground #002","7.943","5.909","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Camping Ground #002","Camping Ground #003","4.311","8.332","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Camping Ground #003","Camping Ground #004","3.051","3.241","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Camping Ground #004","Camping Ground #005","2.103","1.279","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Camping Ground #005","Camping Ground #001","2.440","728","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":533},{"label":"Mar","value":462},{"label":"Abr","value":631},{"label":"Mai","value":369},{"label":"Jun","value":617},{"label":"Jul","value":546},{"label":"Ago","value":652},{"label":"Set","value":346},{"label":"Out","value":552},{"label":"Nov","value":308},{"label":"Dez","value":319}];
const MX = 652;
