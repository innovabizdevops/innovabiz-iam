...
const ACCENT = "#22c55e";
const MODULE = "Energy Optimization";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Energy Optimization","v":"8.740","t":"-0.1%","d":"down"},{"l":"Monitor Ativos","v":"6.906","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"72.2%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"83","t":"+3.3%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Optimization #001","Energy Optimization #002","3.802","2.473","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Optimization #002","Energy Optimization #003","1.207","6.834","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Optimization #003","Energy Optimization #004","1.248","5.111","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Optimization #004","Energy Optimization #005","4.694","765","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Optimization #005","Energy Optimization #001","1.303","744","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":503},{"label":"Fev","value":597},{"label":"Mar","value":754},{"label":"Abr","value":396},{"label":"Mai","value":399},{"label":"Jun","value":732},{"label":"Jul","value":694},{"label":"Ago","value":738},{"label":"Set","value":542},{"label":"Out","value":651},{"label":"Nov","value":422},{"label":"Dez","value":382}];
const MX = 754;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#22c55e'}}>IoT</span></h1>
                </div>
