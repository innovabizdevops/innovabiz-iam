...
const KPIS = [
    { label: "Total Registos", value: "2075", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3815", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€299K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1376141575", cells: ["ENE-6575", "Energy Optimization Item 1", "12/8/2026", "€41 675"], status: "active" as const },
    { id: "1376145146", cells: ["ENE-1146", "Energy Optimization Item 2", "27/3/2026", "€45 246"], status: "pending" as const },
    { id: "1376148717", cells: ["ENE-4717", "Energy Optimization Item 3", "14/10/2026", "€48 817"], status: "completed" as const },
    { id: "1376152288", cells: ["ENE-8288", "Energy Optimization Item 4", "1/5/2026", "€2388"], status: "warning" as const },
    { id: "1376155859", cells: ["ENE-2859", "Energy Optimization Item 5", "16/12/2026", "€5959"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Energy Optimization</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Energy Optimization</p>
                    </div>
                </div>
