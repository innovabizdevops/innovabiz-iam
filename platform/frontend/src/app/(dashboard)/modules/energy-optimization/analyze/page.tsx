...
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"6.569","t":"+14.0%","d":"up"},{"l":"Queries/Dia","v":"4311","t":"-5.7%","d":"down"},{"l":"Dados Processados (GB)","v":"642","t":"+14.9%","d":"up"},{"l":"Utilizadores Analytics","v":"4.412","t":"+17.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1296","2026-02-09","1.917","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3231","2026-03-15","6.491","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1042","2026-03-19","4.443","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2591","2026-03-02","6.126","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","284","2026-03-05","6.221","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":861},{"label":"Fev","value":683},{"label":"Mar","value":795},{"label":"Abr","value":1053},{"label":"Mai","value":900},{"label":"Jun","value":1060},{"label":"Jul","value":967},{"label":"Ago","value":871},{"label":"Set","value":811},{"label":"Out","value":696},{"label":"Nov","value":799},{"label":"Dez","value":925}];
const MX = 1060;
