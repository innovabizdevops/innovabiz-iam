...
const PAGE = "Documentation Hub";
const KPIS = [{"l":"Formulários Ativos","v":"3.446","t":"-2.0%","d":"down"},{"l":"Submissões/Dia","v":"5036","t":"+13.3%","d":"up"},{"l":"Documentos Gerados","v":"1.477","t":"+7.1%","d":"up"},{"l":"Templates","v":"1.074","t":"+1.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.004","2026-03-27","6.904","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.593","2026-03-25","7.812","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.357","2026-01-01","3.411","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.018","2026-02-02","4.252","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.149","2026-03-10","7.190","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":922},{"label":"Fev","value":867},{"label":"Mar","value":761},{"label":"Abr","value":770},{"label":"Mai","value":907},{"label":"Jun","value":741},{"label":"Jul","value":604},{"label":"Ago","value":590},{"label":"Set","value":638},{"label":"Out","value":755},{"label":"Nov","value":577},{"label":"Dez","value":551}];
const MX = 922;
