...
const ACCENT = "#0369a1";
const MODULE = "Knowledge Management";
const PAGE = "RAG Pipeline AI";
const KPIS = [{"l":"Artigos Publicados","v":"2.397","t":"+15.6%","d":"up"},{"l":"Views/Semana","v":"2049","t":"+8.5%","d":"up"},{"l":"Feedback Útil (%)","v":"77.1%","t":"-5.7%","d":"down"},{"l":"Artigos Desatualizados","v":"3.548","t":"-4.3%","d":"down"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","5.321","71.2%","8.433","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","8.149","75.6%","7.347","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","4.601","82.1%","5.751","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","2.832","93.3%","2.539","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","4.790","92.9%","8.919","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":794},{"label":"Fev","value":836},{"label":"Mar","value":844},{"label":"Abr","value":810},{"label":"Mai","value":809},{"label":"Jun","value":565},{"label":"Jul","value":758},{"label":"Ago","value":537},{"label":"Set","value":771},{"label":"Out","value":604},{"label":"Nov","value":594},{"label":"Dez","value":774}];
const MX = 844;
