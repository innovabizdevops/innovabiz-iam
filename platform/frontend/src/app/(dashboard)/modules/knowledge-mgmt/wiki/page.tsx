...
const PAGE = "Wiki Builder";
const KPIS = [{"l":"Artigos Publicados","v":"4.750","t":"+5.7%","d":"up"},{"l":"Views/Semana","v":"101","t":"+5.2%","d":"up"},{"l":"Feedback Útil (%)","v":"91.4%","t":"+11.3%","d":"up"},{"l":"Artigos Desatualizados","v":"4.558","t":"+6.7%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","8.486","97.0%","3.466","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","3.783","83.2%","2.749","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","4.080","84.7%","8.795","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","2.199","80.8%","4.283","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","8.934","97.3%","1.446","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":536},{"label":"Mar","value":623},{"label":"Abr","value":754},{"label":"Mai","value":628},{"label":"Jun","value":373},{"label":"Jul","value":740},{"label":"Ago","value":753},{"label":"Set","value":622},{"label":"Out","value":568},{"label":"Nov","value":469},{"label":"Dez","value":486}];
const MX = 754;
