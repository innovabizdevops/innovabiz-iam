...
const PAGE = "Search AI";
const KPIS = [{"l":"Artigos Publicados","v":"8.289","t":"+9.7%","d":"up"},{"l":"Views/Semana","v":"4236","t":"+2.9%","d":"up"},{"l":"Feedback Útil (%)","v":"84.4%","t":"-1.9%","d":"down"},{"l":"Artigos Desatualizados","v":"5.748","t":"+9.0%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","3.882","72.8%","753","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","7.136","98.4%","5.913","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","6.219","80.3%","4.822","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","4.906","80.8%","8.847","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","2.639","85.4%","7.518","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":646},{"label":"Mar","value":840},{"label":"Abr","value":692},{"label":"Mai","value":639},{"label":"Jun","value":863},{"label":"Jul","value":820},{"label":"Ago","value":914},{"label":"Set","value":921},{"label":"Out","value":816},{"label":"Nov","value":946},{"label":"Dez","value":650}];
const MX = 946;
