...
const PAGE = "Expert Network";
const KPIS = [{"l":"Artigos Publicados","v":"2.122","t":"+15.8%","d":"up"},{"l":"Views/Semana","v":"3782","t":"+11.7%","d":"up"},{"l":"Feedback Útil (%)","v":"75.5%","t":"+7.7%","d":"up"},{"l":"Artigos Desatualizados","v":"1.170","t":"+6.0%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","8.840","81.6%","4.868","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","264","99.9%","3.066","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","5.841","88.3%","7.881","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","7.182","87.1%","6.040","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","1.388","80.4%","639","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":413},{"label":"Fev","value":500},{"label":"Mar","value":652},{"label":"Abr","value":339},{"label":"Mai","value":649},{"label":"Jun","value":368},{"label":"Jul","value":415},{"label":"Ago","value":512},{"label":"Set","value":654},{"label":"Out","value":679},{"label":"Nov","value":436},{"label":"Dez","value":324}];
const MX = 679;
