...
const KPIS = [{"l":"Artigos Publicados","v":"5.271","t":"-4.5%","d":"down"},{"l":"Views/Semana","v":"1909","t":"+3.0%","d":"up"},{"l":"Feedback Útil (%)","v":"87.0%","t":"+1.2%","d":"up"},{"l":"Artigos Desatualizados","v":"4.051","t":"+12.7%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","9.007","81.7%","7.210","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","6.289","99.3%","6.426","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","489","73.4%","1.583","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","6.927","99.8%","7.156","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","4.486","99.3%","4.529","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":812},{"label":"Fev","value":888},{"label":"Mar","value":700},{"label":"Abr","value":672},{"label":"Mai","value":898},{"label":"Jun","value":910},{"label":"Jul","value":803},{"label":"Ago","value":803},{"label":"Set","value":753},{"label":"Out","value":545},{"label":"Nov","value":828},{"label":"Dez","value":599}];
const MX = 910;
