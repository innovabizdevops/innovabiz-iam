...
const KPIS = [{"l":"Formulários Ativos","v":"8.504","t":"+8.3%","d":"up"},{"l":"Submissões/Dia","v":"4096","t":"+12.4%","d":"up"},{"l":"Documentos Gerados","v":"7.190","t":"+17.2%","d":"up"},{"l":"Templates","v":"8.084","t":"-3.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.118","2026-01-21","4.502","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.022","2026-01-23","7.653","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.302","2026-03-17","8.771","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","541","2026-01-05","514","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.481","2026-01-19","3.533","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":557},{"label":"Mar","value":423},{"label":"Abr","value":669},{"label":"Mai","value":610},{"label":"Jun","value":589},{"label":"Jul","value":663},{"label":"Ago","value":428},{"label":"Set","value":476},{"label":"Out","value":718},{"label":"Nov","value":713},{"label":"Dez","value":681}];
const MX = 718;
