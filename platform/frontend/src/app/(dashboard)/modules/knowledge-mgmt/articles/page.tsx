...
const PAGE = "Knowledge Base";
const KPIS = [{"l":"Artigos Publicados","v":"2.827","t":"-3.4%","d":"down"},{"l":"Views/Semana","v":"939","t":"+16.1%","d":"up"},{"l":"Feedback Útil (%)","v":"84.0%","t":"+15.9%","d":"up"},{"l":"Artigos Desatualizados","v":"2.611","t":"-5.6%","d":"down"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","459","93.3%","4.654","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","8.227","93.6%","5.514","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","1.620","92.5%","2.840","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","4.670","86.9%","7.830","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","749","96.8%","6.576","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":1012},{"label":"Mar","value":912},{"label":"Abr","value":833},{"label":"Mai","value":927},{"label":"Jun","value":807},{"label":"Jul","value":966},{"label":"Ago","value":943},{"label":"Set","value":921},{"label":"Out","value":737},{"label":"Nov","value":1023},{"label":"Dez","value":1014}];
const MX = 1023;
