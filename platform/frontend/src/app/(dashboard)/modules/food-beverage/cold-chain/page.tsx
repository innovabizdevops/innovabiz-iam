...
const PAGE = "Cold Chain IoT";
const KPIS = [{"l":"Dispositivos Online","v":"3.859","t":"+16.9%","d":"up"},{"l":"Dados/Min (MB)","v":"3.211","t":"+15.5%","d":"up"},{"l":"Alertas Ativos","v":"3.804","t":"-1.2%","d":"down"},{"l":"Uptime (%)","v":"67.5%","t":"+6.2%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","465","6.875","1.608","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","262","2.891","1.257","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.080","2.048","134","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.866","2.487","1.631","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.762","7.791","7.571","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":449},{"label":"Fev","value":679},{"label":"Mar","value":591},{"label":"Abr","value":428},{"label":"Mai","value":415},{"label":"Jun","value":409},{"label":"Jul","value":514},{"label":"Ago","value":777},{"label":"Set","value":715},{"label":"Out","value":744},{"label":"Nov","value":522},{"label":"Dez","value":739}];
const MX = 777;
