...
const PAGE = "Supply Chain Map";
const KPIS = [{"l":"Total Food Beverage","v":"1.168","t":"+10.7%","d":"up"},{"l":"Supply Chain Map Ativos","v":"4.965","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"67.4%","t":"+16.1%","d":"up"},{"l":"Score Performance","v":"80","t":"-2.0%","d":"down"}];
const COLS = ["ID","Supply Chain Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Beverage #001","Food Beverage #002","3.158","2.950","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Food Beverage #002","Food Beverage #003","3.745","6.698","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Beverage #003","Food Beverage #004","8.005","5.011","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Food Beverage #004","Food Beverage #005","4.915","8.485","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Beverage #005","Food Beverage #001","4.214","868","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":461},{"label":"Mar","value":815},{"label":"Abr","value":571},{"label":"Mai","value":817},{"label":"Jun","value":479},{"label":"Jul","value":541},{"label":"Ago","value":670},{"label":"Set","value":657},{"label":"Out","value":614},{"label":"Nov","value":657},{"label":"Dez","value":498}];
const MX = 817;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ea580c'}}>Diagram</span></h1>
                </div>
