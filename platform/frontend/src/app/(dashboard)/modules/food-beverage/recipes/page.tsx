...
const PAGE = "Recipe Management";
const KPIS = [{"l":"Projetos Melhoria","v":"1.720","t":"+17.8%","d":"up"},{"l":"Savings (€)","v":"€58405","t":"+7.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"93.3%","t":"+7.6%","d":"up"},{"l":"Ciclos PDCA","v":"4.347","t":"+12.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.212","€ 22848.31","9.009","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.415","€ 39954.01","2.524","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.871","€ 48693.62","5.591","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.807","€ 29392.74","8.006","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.988","€ 45366.18","7.538","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":550},{"label":"Fev","value":482},{"label":"Mar","value":510},{"label":"Abr","value":417},{"label":"Mai","value":473},{"label":"Jun","value":286},{"label":"Jul","value":429},{"label":"Ago","value":328},{"label":"Set","value":334},{"label":"Out","value":255},{"label":"Nov","value":565},{"label":"Dez","value":545}];
const MX = 565;
