...
const PAGE = "Allergen Control";
const KPIS = [{"l":"Total Food Beverage","v":"5.518","t":"-2.1%","d":"down"},{"l":"Allergen Control Ativos","v":"3.313","t":"+6.6%","d":"up"},{"l":"Eficiência (%)","v":"77.2%","t":"+6.5%","d":"up"},{"l":"Score Performance","v":"88","t":"-0.1%","d":"down"}];
const COLS = ["ID","Allergen Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Beverage #001","Food Beverage #002","8.185","3.028","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Food Beverage #002","Food Beverage #003","5.998","2.521","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Beverage #003","Food Beverage #004","6.422","3.722","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Food Beverage #004","Food Beverage #005","2.179","3.600","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Beverage #005","Food Beverage #001","1.318","5.125","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":719},{"label":"Mar","value":814},{"label":"Abr","value":724},{"label":"Mai","value":677},{"label":"Jun","value":569},{"label":"Jul","value":438},{"label":"Ago","value":630},{"label":"Set","value":648},{"label":"Out","value":684},{"label":"Nov","value":711},{"label":"Dez","value":569}];
const MX = 814;
