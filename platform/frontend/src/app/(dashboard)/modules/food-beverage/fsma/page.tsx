...
const PAGE = "FSMA Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.429","t":"+12.4%","d":"up"},{"l":"NC Abertas","v":"5.165","t":"+8.1%","d":"up"},{"l":"Conformidade (%)","v":"69.9%","t":"-1.3%","d":"down"},{"l":"CAPAs Pendentes","v":"4.787","t":"+11.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.484","90.7%","3.705","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.673","82.9%","1.124","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.720","96.2%","4.417","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.951","75.9%","6.290","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","575","70.5%","738","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":254},{"label":"Fev","value":510},{"label":"Mar","value":385},{"label":"Abr","value":532},{"label":"Mai","value":552},{"label":"Jun","value":432},{"label":"Jul","value":390},{"label":"Ago","value":301},{"label":"Set","value":365},{"label":"Out","value":610},{"label":"Nov","value":315},{"label":"Dez","value":525}];
const MX = 610;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ea580c'}}>FDA</span></h1>
                </div>
