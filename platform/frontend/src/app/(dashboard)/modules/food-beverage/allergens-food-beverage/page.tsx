...
const PAGE = "Allergen Tracking";
const KPIS = [{"l":"Total Food Beverage","v":"5.059","t":"+16.0%","d":"up"},{"l":"Allergen Tracking Ativos","v":"3.525","t":"+2.7%","d":"up"},{"l":"Eficiência (%)","v":"81.9%","t":"+11.8%","d":"up"},{"l":"Score Performance","v":"62","t":"-2.7%","d":"down"}];
const COLS = ["ID","Allergen Tracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Beverage #001","Food Beverage #002","2.643","6.382","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Food Beverage #002","Food Beverage #003","8.924","4.286","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Beverage #003","Food Beverage #004","6.956","1.126","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Food Beverage #004","Food Beverage #005","2.998","111","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Beverage #005","Food Beverage #001","636","533","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":315},{"label":"Mar","value":426},{"label":"Abr","value":642},{"label":"Mai","value":527},{"label":"Jun","value":533},{"label":"Jul","value":620},{"label":"Ago","value":360},{"label":"Set","value":427},{"label":"Out","value":584},{"label":"Nov","value":450},{"label":"Dez","value":397}];
const MX = 651;
...
export default function AllergensFoodBeveragePage() {
    return (
