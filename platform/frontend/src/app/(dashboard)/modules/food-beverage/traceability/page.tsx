...
const ACCENT = "#ea580c";
const MODULE = "Food & Beverage";
const PAGE = "Batch Traceability";
const KPIS = [{"l":"Total Food Beverage","v":"8.571","t":"+16.6%","d":"up"},{"l":"Batch Traceability Ativos","v":"7.236","t":"-3.7%","d":"down"},{"l":"Eficiência (%)","v":"84.6%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"57","t":"+2.7%","d":"up"}];
const COLS = ["ID","Batch Traceability","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Beverage #001","Food Beverage #002","3.419","1.394","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Food Beverage #002","Food Beverage #003","6.661","7.136","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Beverage #003","Food Beverage #004","2.242","7.320","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Food Beverage #004","Food Beverage #005","4.769","1.222","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Beverage #005","Food Beverage #001","3.269","2.426","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1056},{"label":"Fev","value":909},{"label":"Mar","value":835},{"label":"Abr","value":835},{"label":"Mai","value":845},{"label":"Jun","value":1065},{"label":"Jul","value":761},{"label":"Ago","value":994},{"label":"Set","value":850},{"label":"Out","value":977},{"label":"Nov","value":940},{"label":"Dez","value":1041}];
const MX = 1065;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ea580c'}}>HACCP</span></h1>
                </div>
