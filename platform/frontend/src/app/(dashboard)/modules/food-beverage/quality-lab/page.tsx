...
const PAGE = "Quality Lab";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.095","t":"+7.5%","d":"up"},{"l":"NC Abertas","v":"7.222","t":"-2.1%","d":"down"},{"l":"Conformidade (%)","v":"77.8%","t":"+2.5%","d":"up"},{"l":"CAPAs Pendentes","v":"2.473","t":"+11.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.856","80.2%","4.617","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","583","85.3%","5.688","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.765","94.6%","6.806","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.380","99.0%","2.880","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.822","87.1%","147","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":697},{"label":"Mar","value":875},{"label":"Abr","value":656},{"label":"Mai","value":975},{"label":"Jun","value":720},{"label":"Jul","value":758},{"label":"Ago","value":891},{"label":"Set","value":797},{"label":"Out","value":607},{"label":"Nov","value":773},{"label":"Dez","value":788}];
const MX = 975;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ea580c'}}>ISO 22000</span></h1>
                </div>
