...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.670","t":"-5.5%","d":"down"},{"l":"NC Abertas","v":"6.664","t":"-2.7%","d":"down"},{"l":"Conformidade (%)","v":"71.5%","t":"+5.8%","d":"up"},{"l":"CAPAs Pendentes","v":"3.283","t":"+12.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.331","80.1%","404","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.168","77.5%","664","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.696","81.2%","1.482","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","275","86.9%","7.614","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.362","95.8%","2.887","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":506},{"label":"Mar","value":672},{"label":"Abr","value":780},{"label":"Mai","value":670},{"label":"Jun","value":577},{"label":"Jul","value":521},{"label":"Ago","value":849},{"label":"Set","value":600},{"label":"Out","value":497},{"label":"Nov","value":697},{"label":"Dez","value":816}];
const MX = 849;
