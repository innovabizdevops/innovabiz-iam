...
const KPIS = [{"l":"Total Water Reuse","v":"3.660","t":"+8.4%","d":"up"},{"l":"Treatment Ativos","v":"2.271","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"85.8%","t":"+11.5%","d":"up"},{"l":"Score Performance","v":"85","t":"+13.1%","d":"up"}];
const COLS = ["ID","Treatment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Reuse #001","Water Reuse #002","4.760","1.285","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Water Reuse #002","Water Reuse #003","6.454","8.536","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Reuse #003","Water Reuse #004","3.424","7.692","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Water Reuse #004","Water Reuse #005","1.308","3.742","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Reuse #005","Water Reuse #001","6.523","6.130","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":598},{"label":"Mar","value":588},{"label":"Abr","value":691},{"label":"Mai","value":617},{"label":"Jun","value":572},{"label":"Jul","value":674},{"label":"Ago","value":539},{"label":"Set","value":570},{"label":"Out","value":730},{"label":"Nov","value":907},{"label":"Dez","value":761}];
const MX = 907;
