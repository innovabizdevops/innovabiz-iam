...
const ACCENT = "#0891b2";
const MODULE = "Water Reuse";
const PAGE = "Distribution";
const KPIS = [{"l":"Total Water Reuse","v":"6.851","t":"+2.1%","d":"up"},{"l":"Distribution Ativos","v":"5.639","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"89.7%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"87","t":"+5.4%","d":"up"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Reuse #001","Water Reuse #002","371","6.009","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Water Reuse #002","Water Reuse #003","1.873","812","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Reuse #003","Water Reuse #004","1.348","4.880","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Water Reuse #004","Water Reuse #005","7.902","4.856","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Reuse #005","Water Reuse #001","7.604","2.208","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":712},{"label":"Fev","value":832},{"label":"Mar","value":645},{"label":"Abr","value":711},{"label":"Mai","value":638},{"label":"Jun","value":727},{"label":"Jul","value":632},{"label":"Ago","value":809},{"label":"Set","value":665},{"label":"Out","value":694},{"label":"Nov","value":689},{"label":"Dez","value":844}];
const MX = 844;
