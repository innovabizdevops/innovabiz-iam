...
const ACCENT = "#f43f5e";
const MODULE = "FashionTech Platform";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"6.447","t":"+15.0%","d":"up"},{"l":"Submissões/Dia","v":"3761","t":"-2.3%","d":"down"},{"l":"Documentos Gerados","v":"8.508","t":"+12.6%","d":"up"},{"l":"Templates","v":"1.856","t":"-3.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.710","2026-01-06","8.913","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.400","2026-02-16","942","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.055","2026-02-07","4.311","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.143","2026-03-20","1.211","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.588","2026-01-04","8.969","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":490},{"label":"Mar","value":784},{"label":"Abr","value":573},{"label":"Mai","value":562},{"label":"Jun","value":626},{"label":"Jul","value":818},{"label":"Ago","value":654},{"label":"Set","value":657},{"label":"Out","value":663},{"label":"Nov","value":845},{"label":"Dez","value":747}];
const MX = 845;
