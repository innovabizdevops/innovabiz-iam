...
const PAGE = "PLM";
const KPIS = [{"l":"Produtos Ativos","v":"1.899","t":"+12.1%","d":"up"},{"l":"SKUs","v":"8.595","t":"-1.2%","d":"down"},{"l":"ECNs Pendentes","v":"5.811","t":"-1.0%","d":"down"},{"l":"Time-to-Market (dias)","v":"5.596","t":"+1.7%","d":"up"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","2.210","2.319","1.572","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","3.359","4.624","2.507","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","4.602","816","5.005","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","3.266","6.125","5.849","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","1.103","2.556","1.218","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":579},{"label":"Mar","value":489},{"label":"Abr","value":590},{"label":"Mai","value":756},{"label":"Jun","value":686},{"label":"Jul","value":667},{"label":"Ago","value":530},{"label":"Set","value":535},{"label":"Out","value":499},{"label":"Nov","value":747},{"label":"Dez","value":791}];
const MX = 791;
