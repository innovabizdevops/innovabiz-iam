...
/* ═══ FashionTech Platform — Dashboard ═══ */

const ACCENT = "#f43f5e";

const KPIS = [
    { label: "Total Registos", value: "575", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2304", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€293K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1695078475", cells: ["FAS-1475", "FashionTech Platform Item 1", "28/8/2026", "€28 575"], status: "active" as const },
    { id: "1695082046", cells: ["FAS-5046", "FashionTech Platform Item 2", "15/3/2026", "€32 146"], status: "pending" as const },
    { id: "1695085617", cells: ["FAS-8617", "FashionTech Platform Item 3", "2/10/2026", "€35 717"], status: "completed" as const },
    { id: "1695089188", cells: ["FAS-3188", "FashionTech Platform Item 4", "17/5/2026", "€39 288"], status: "warning" as const },
    { id: "1695092759", cells: ["FAS-6759", "FashionTech Platform Item 5", "4/12/2026", "€42 859"], status: "active" as const },
];
...
export default function FashiontechPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">FashionTech Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • FashionTech Platform</p>
                    </div>
                </div>
