...
const PAGE = "Retail";
const KPIS = [{"l":"Pedidos/Dia","v":"878","t":"-4.1%","d":"down"},{"l":"GMV (€)","v":"€38580","t":"+2.6%","d":"up"},{"l":"Conversão (%)","v":"72.4%","t":"+10.0%","d":"up"},{"l":"AOV (€)","v":"€65165","t":"+6.2%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 48486.85","4.548","1.986","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 4917.36","2.655","8.602","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 7721.00","1.379","767","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 36292.30","7.726","836","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 11076.20","4.356","4.349","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":812},{"label":"Fev","value":858},{"label":"Mar","value":770},{"label":"Abr","value":721},{"label":"Mai","value":803},{"label":"Jun","value":781},{"label":"Jul","value":501},{"label":"Ago","value":536},{"label":"Set","value":802},{"label":"Out","value":734},{"label":"Nov","value":757},{"label":"Dez","value":546}];
const MX = 858;
