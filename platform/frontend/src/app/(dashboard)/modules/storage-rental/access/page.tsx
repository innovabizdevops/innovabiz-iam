...
const ACCENT = "#0284c7";
const MODULE = "Storage Unit Rental";
const PAGE = "Access";
const KPIS = [{"l":"Total Storage Rental","v":"596","t":"+13.2%","d":"up"},{"l":"Access Ativos","v":"6.135","t":"-3.7%","d":"down"},{"l":"Eficiência (%)","v":"89.4%","t":"+9.3%","d":"up"},{"l":"Score Performance","v":"71","t":"+5.1%","d":"up"}];
const COLS = ["ID","Access","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Storage Rental #001","Storage Rental #002","610","5.565","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Storage Rental #002","Storage Rental #003","6.643","2.850","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Storage Rental #003","Storage Rental #004","5.192","3.944","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Storage Rental #004","Storage Rental #005","2.102","8.592","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Storage Rental #005","Storage Rental #001","4.811","1.816","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":370},{"label":"Fev","value":316},{"label":"Mar","value":531},{"label":"Abr","value":330},{"label":"Mai","value":409},{"label":"Jun","value":537},{"label":"Jul","value":633},{"label":"Ago","value":368},{"label":"Set","value":427},{"label":"Out","value":365},{"label":"Nov","value":675},{"label":"Dez","value":480}];
const MX = 675;
