...
const PAGE = "Billing";
const KPIS = [{"l":"Total Storage Rental","v":"2.272","t":"+5.2%","d":"up"},{"l":"Billing Ativos","v":"7.440","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"68.2%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"56","t":"+12.6%","d":"up"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Storage Rental #001","Storage Rental #002","2.848","6.580","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Storage Rental #002","Storage Rental #003","5.810","2.210","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Storage Rental #003","Storage Rental #004","104","4.932","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Storage Rental #004","Storage Rental #005","2.756","4.457","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Storage Rental #005","Storage Rental #001","8.931","6.882","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":858},{"label":"Mar","value":675},{"label":"Abr","value":507},{"label":"Mai","value":815},{"label":"Jun","value":820},{"label":"Jul","value":672},{"label":"Ago","value":548},{"label":"Set","value":857},{"label":"Out","value":636},{"label":"Nov","value":723},{"label":"Dez","value":768}];
const MX = 858;
