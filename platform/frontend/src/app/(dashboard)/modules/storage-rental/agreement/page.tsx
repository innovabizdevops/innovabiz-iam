...
const KPIS = [{"l":"Total Storage Rental","v":"8.808","t":"-0.3%","d":"down"},{"l":"Agreement Ativos","v":"5.319","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"85.5%","t":"+4.5%","d":"up"},{"l":"Score Performance","v":"62","t":"-5.0%","d":"down"}];
const COLS = ["ID","Agreement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Storage Rental #001","Storage Rental #002","2.815","9.031","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Storage Rental #002","Storage Rental #003","7.403","3.908","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Storage Rental #003","Storage Rental #004","4.969","9.061","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Storage Rental #004","Storage Rental #005","4.096","354","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Storage Rental #005","Storage Rental #001","6.446","4.027","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":649},{"label":"Mar","value":326},{"label":"Abr","value":372},{"label":"Mai","value":361},{"label":"Jun","value":579},{"label":"Jul","value":524},{"label":"Ago","value":661},{"label":"Set","value":526},{"label":"Out","value":367},{"label":"Nov","value":389},{"label":"Dez","value":358}];
const MX = 661;
