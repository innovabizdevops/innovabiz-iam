...
const PAGE = "Auction";
const KPIS = [{"l":"Total Storage Rental","v":"5.982","t":"+18.0%","d":"up"},{"l":"Auction Ativos","v":"6.335","t":"+10.5%","d":"up"},{"l":"Eficiência (%)","v":"66.3%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"60","t":"-5.8%","d":"down"}];
const COLS = ["ID","Auction","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Storage Rental #001","Storage Rental #002","6.929","4.492","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Storage Rental #002","Storage Rental #003","7.739","4.342","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Storage Rental #003","Storage Rental #004","6.365","3.875","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Storage Rental #004","Storage Rental #005","8.388","1.114","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Storage Rental #005","Storage Rental #001","4.032","8.677","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":537},{"label":"Mar","value":676},{"label":"Abr","value":597},{"label":"Mai","value":785},{"label":"Jun","value":798},{"label":"Jul","value":525},{"label":"Ago","value":815},{"label":"Set","value":696},{"label":"Out","value":922},{"label":"Nov","value":766},{"label":"Dez","value":670}];
const MX = 922;
