...
/* ═══ Storage Unit Rental — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "6315", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2724", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€11K", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "294521315", cells: ["STO-6315", "Storage Unit Rental Item 1", "12/12/2026", "€21 415"], status: "active" as const },
    { id: "294524886", cells: ["STO-9886", "Storage Unit Rental Item 2", "27/7/2026", "€24 986"], status: "pending" as const },
    { id: "294528457", cells: ["STO-4457", "Storage Unit Rental Item 3", "14/2/2026", "€28 557"], status: "completed" as const },
    { id: "294532028", cells: ["STO-8028", "Storage Unit Rental Item 4", "1/9/2026", "€32 128"], status: "warning" as const },
    { id: "294535599", cells: ["STO-2599", "Storage Unit Rental Item 5", "16/4/2026", "€35 699"], status: "active" as const },
];
...
export default function StorageUnitRentalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Storage Unit Rental</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Storage Unit Rental</p>
                    </div>
                </div>
