...
const PAGE = "Unit";
const KPIS = [{"l":"Total Storage Rental","v":"8.634","t":"+2.0%","d":"up"},{"l":"Unit Ativos","v":"5.598","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"84.5%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"63","t":"-3.2%","d":"down"}];
const COLS = ["ID","Unit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Storage Rental #001","Storage Rental #002","8.404","1.520","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Storage Rental #002","Storage Rental #003","4.983","6.307","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Storage Rental #003","Storage Rental #004","5.785","8.136","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Storage Rental #004","Storage Rental #005","5.034","1.443","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Storage Rental #005","Storage Rental #001","372","279","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":684},{"label":"Mar","value":552},{"label":"Abr","value":535},{"label":"Mai","value":605},{"label":"Jun","value":807},{"label":"Jul","value":532},{"label":"Ago","value":607},{"label":"Set","value":626},{"label":"Out","value":609},{"label":"Nov","value":797},{"label":"Dez","value":859}];
const MX = 859;
