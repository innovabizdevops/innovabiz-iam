...
const KPIS = [
    { label: "Total Registos", value: "9682", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4799", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€354K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "-15%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1945884282", cells: ["MIL-4282", "Military Logistics Item 1", "7/7/2026", "€34 382"], status: "active" as const },
    { id: "1945887853", cells: ["MIL-7853", "Military Logistics Item 2", "22/2/2026", "€37 953"], status: "pending" as const },
    { id: "1945891424", cells: ["MIL-2424", "Military Logistics Item 3", "9/9/2026", "€41 524"], status: "completed" as const },
    { id: "1945894995", cells: ["MIL-5995", "Military Logistics Item 4", "24/4/2026", "€45 095"], status: "warning" as const },
    { id: "1945898566", cells: ["MIL-9566", "Military Logistics Item 5", "11/11/2026", "€48 666"], status: "active" as const },
];
...
export default function MilitaryLogisticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Military Logistics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Military Logistics</p>
                    </div>
                </div>
