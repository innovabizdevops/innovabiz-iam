...
const KPIS = [{"l":"Atletas Registados","v":"2.316","t":"+6.2%","d":"up"},{"l":"Treinos/Semana","v":"395","t":"+16.9%","d":"up"},{"l":"Competições","v":"4.553","t":"+5.8%","d":"up"},{"l":"Performance Score","v":"81","t":"+2.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","848","8.434","8.769","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.862","4.382","4.890","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.004","4.776","2.776","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","3.283","7.273","1.180","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.759","4.596","6.408","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":598},{"label":"Mar","value":654},{"label":"Abr","value":772},{"label":"Mai","value":730},{"label":"Jun","value":779},{"label":"Jul","value":715},{"label":"Ago","value":684},{"label":"Set","value":774},{"label":"Out","value":579},{"label":"Nov","value":482},{"label":"Dez","value":867}];
const MX = 867;
