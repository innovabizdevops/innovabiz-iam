...
const ACCENT = "#6366f1";
const MODULE = "Hotel Spa & Wellness";
const PAGE = "Therapist";
const KPIS = [{"l":"Quartos Ocupados","v":"3.078","t":"-3.8%","d":"down"},{"l":"RevPAR (€)","v":"€22916","t":"-4.8%","d":"down"},{"l":"Ocupação (%)","v":"89.1%","t":"+14.7%","d":"up"},{"l":"Guest Satisfaction","v":"1.168","t":"+16.9%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.088","2026-02-09","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.635","2026-01-23","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.126","2026-02-23","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.093","2026-01-22","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.425","2026-03-16","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":973},{"label":"Mar","value":984},{"label":"Abr","value":928},{"label":"Mai","value":878},{"label":"Jun","value":880},{"label":"Jul","value":880},{"label":"Ago","value":831},{"label":"Set","value":657},{"label":"Out","value":930},{"label":"Nov","value":671},{"label":"Dez","value":860}];
const MX = 984;
