...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€34.2M","t":"-4.3%","d":"down"},{"l":"MRR (€)","v":"€80103","t":"+4.7%","d":"up"},{"l":"Churn (%)","v":"67.7%","t":"+12.8%","d":"up"},{"l":"ARPU (€)","v":"€42464","t":"+9.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 8328.64","7.864","€ 25934.72","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 19418.43","3.872","€ 32298.33","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 46012.34","6.230","€ 21067.47","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 1408.70","4.722","€ 21232.97","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 30998.23","7.651","€ 22749.83","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":794},{"label":"Mar","value":649},{"label":"Abr","value":654},{"label":"Mai","value":605},{"label":"Jun","value":841},{"label":"Jul","value":760},{"label":"Ago","value":790},{"label":"Set","value":597},{"label":"Out","value":875},{"label":"Nov","value":718},{"label":"Dez","value":787}];
const MX = 875;
