...
const PAGE = "Product";
const KPIS = [{"l":"Quartos Ocupados","v":"3.461","t":"-4.9%","d":"down"},{"l":"RevPAR (€)","v":"€27434","t":"+2.8%","d":"up"},{"l":"Ocupação (%)","v":"85.9%","t":"+2.9%","d":"up"},{"l":"Guest Satisfaction","v":"5.270","t":"-1.4%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.693","2026-01-28","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.214","2026-02-21","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.282","2026-01-08","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","8.990","2026-03-17","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.056","2026-01-02","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":688},{"label":"Mar","value":534},{"label":"Abr","value":560},{"label":"Mai","value":501},{"label":"Jun","value":487},{"label":"Jul","value":365},{"label":"Ago","value":600},{"label":"Set","value":724},{"label":"Out","value":499},{"label":"Nov","value":336},{"label":"Dez","value":363}];
const MX = 724;
