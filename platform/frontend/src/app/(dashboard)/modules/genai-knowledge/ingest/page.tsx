...
const PAGE = "Ingest";
const KPIS = [{"l":"Artigos Publicados","v":"6.054","t":"+14.8%","d":"up"},{"l":"Views/Semana","v":"747","t":"+5.2%","d":"up"},{"l":"Feedback Útil (%)","v":"84.7%","t":"-3.2%","d":"down"},{"l":"Artigos Desatualizados","v":"1.159","t":"+9.8%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","2.244","70.5%","8.524","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","3.878","87.0%","4.022","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","721","95.7%","1.009","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","8.482","73.8%","365","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","6.725","86.6%","3.725","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":428},{"label":"Mar","value":412},{"label":"Abr","value":801},{"label":"Mai","value":549},{"label":"Jun","value":746},{"label":"Jul","value":449},{"label":"Ago","value":751},{"label":"Set","value":448},{"label":"Out","value":483},{"label":"Nov","value":591},{"label":"Dez","value":746}];
const MX = 801;
