...
const PAGE = "Query";
const KPIS = [{"l":"Artigos Publicados","v":"3.952","t":"+13.3%","d":"up"},{"l":"Views/Semana","v":"3511","t":"+1.0%","d":"up"},{"l":"Feedback Útil (%)","v":"80.4%","t":"+10.7%","d":"up"},{"l":"Artigos Desatualizados","v":"4.621","t":"+13.8%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","3.288","82.6%","8.898","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","2.719","86.9%","3.076","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","5.721","94.6%","5.015","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","6.404","76.2%","1.658","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","1.267","79.9%","4.981","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":784},{"label":"Mar","value":806},{"label":"Abr","value":717},{"label":"Mai","value":649},{"label":"Jun","value":858},{"label":"Jul","value":627},{"label":"Ago","value":820},{"label":"Set","value":674},{"label":"Out","value":632},{"label":"Nov","value":595},{"label":"Dez","value":671}];
const MX = 858;
