...
const ACCENT = "#6d28d9";
const MODULE = "GenAI Knowledge Engine";
const PAGE = "Structure";
const KPIS = [{"l":"Artigos Publicados","v":"6.448","t":"+12.9%","d":"up"},{"l":"Views/Semana","v":"4941","t":"+15.5%","d":"up"},{"l":"Feedback Útil (%)","v":"86.0%","t":"-2.9%","d":"down"},{"l":"Artigos Desatualizados","v":"5.266","t":"+12.1%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","2.833","82.0%","8.640","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","5.166","96.7%","5.204","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","7.391","97.2%","4.937","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","4.864","96.5%","4.100","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","3.989","76.3%","2.439","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":408},{"label":"Fev","value":520},{"label":"Mar","value":738},{"label":"Abr","value":698},{"label":"Mai","value":499},{"label":"Jun","value":720},{"label":"Jul","value":542},{"label":"Ago","value":699},{"label":"Set","value":494},{"label":"Out","value":757},{"label":"Nov","value":502},{"label":"Dez","value":665}];
const MX = 757;
