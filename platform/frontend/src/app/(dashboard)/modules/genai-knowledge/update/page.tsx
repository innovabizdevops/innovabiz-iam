...
const PAGE = "Update";
const KPIS = [{"l":"Artigos Publicados","v":"6.070","t":"+5.3%","d":"up"},{"l":"Views/Semana","v":"2036","t":"+3.7%","d":"up"},{"l":"Feedback Útil (%)","v":"90.3%","t":"-1.6%","d":"down"},{"l":"Artigos Desatualizados","v":"8.073","t":"+6.6%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","5.938","99.9%","4.346","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","1.936","98.3%","1.467","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","5.273","77.8%","6.823","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","620","88.9%","1.618","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","8.669","88.2%","7.770","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":657},{"label":"Mar","value":626},{"label":"Abr","value":593},{"label":"Mai","value":584},{"label":"Jun","value":750},{"label":"Jul","value":700},{"label":"Ago","value":484},{"label":"Set","value":396},{"label":"Out","value":395},{"label":"Nov","value":443},{"label":"Dez","value":582}];
const MX = 750;
