...
const PAGE = "Graph";
const KPIS = [{"l":"Artigos Publicados","v":"7.039","t":"+12.1%","d":"up"},{"l":"Views/Semana","v":"232","t":"+8.8%","d":"up"},{"l":"Feedback Útil (%)","v":"73.2%","t":"+10.4%","d":"up"},{"l":"Artigos Desatualizados","v":"7.499","t":"-5.0%","d":"down"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","1.998","72.2%","880","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","8.131","93.7%","6.206","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","1.716","71.7%","1.274","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","4.123","96.9%","7.703","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","105","77.0%","6.571","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":621},{"label":"Mar","value":345},{"label":"Abr","value":355},{"label":"Mai","value":531},{"label":"Jun","value":579},{"label":"Jul","value":639},{"label":"Ago","value":363},{"label":"Set","value":283},{"label":"Out","value":566},{"label":"Nov","value":391},{"label":"Dez","value":430}];
const MX = 639;
