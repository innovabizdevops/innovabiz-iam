...
/* ═══ GenAI Knowledge Engine — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "1736", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3958", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€376K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "898852336", cells: ["GEN-5336", "GenAI Knowledge Engine Item 1", "5/5/2026", "€2436"], status: "active" as const },
    { id: "898855907", cells: ["GEN-8907", "GenAI Knowledge Engine Item 2", "20/12/2026", "€6007"], status: "pending" as const },
    { id: "898859478", cells: ["GEN-3478", "GenAI Knowledge Engine Item 3", "7/7/2026", "€9578"], status: "completed" as const },
    { id: "898863049", cells: ["GEN-7049", "GenAI Knowledge Engine Item 4", "22/2/2026", "€13 149"], status: "warning" as const },
    { id: "898866620", cells: ["GEN-1620", "GenAI Knowledge Engine Item 5", "9/9/2026", "€16 720"], status: "active" as const },
];
...
export default function GenaiKnowledgeEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Knowledge Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Knowledge Engine</p>
                    </div>
                </div>
