...
const ACCENT = "#4c1d95";
const MODULE = "Theater Company";
const PAGE = "Perform";
const KPIS = [{"l":"Formulários Ativos","v":"3.745","t":"+11.4%","d":"up"},{"l":"Submissões/Dia","v":"4224","t":"+0.0%","d":"up"},{"l":"Documentos Gerados","v":"5.522","t":"+11.9%","d":"up"},{"l":"Templates","v":"8.032","t":"+2.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.092","2026-01-28","3.532","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.865","2026-03-15","2.370","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.789","2026-01-21","194","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","457","2026-02-19","1.157","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.601","2026-03-24","246","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":1017},{"label":"Mar","value":859},{"label":"Abr","value":774},{"label":"Mai","value":1077},{"label":"Jun","value":860},{"label":"Jul","value":759},{"label":"Ago","value":1004},{"label":"Set","value":960},{"label":"Out","value":864},{"label":"Nov","value":976},{"label":"Dez","value":832}];
const MX = 1077;
