...
/* ═══ Theater Company — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "1020", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4395", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€76K", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "197961320", cells: ["THE-7320", "Theater Company Item 1", "5/9/2026", "€11 420"], status: "active" as const },
    { id: "197964891", cells: ["THE-1891", "Theater Company Item 2", "20/4/2026", "€14 991"], status: "pending" as const },
    { id: "197968462", cells: ["THE-5462", "Theater Company Item 3", "7/11/2026", "€18 562"], status: "completed" as const },
    { id: "197972033", cells: ["THE-9033", "Theater Company Item 4", "22/6/2026", "€22 133"], status: "warning" as const },
    { id: "197975604", cells: ["THE-3604", "Theater Company Item 5", "9/1/2026", "€25 704"], status: "active" as const },
];
...
export default function TheaterCompanyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Theater Company</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Theater Company</p>
                    </div>
                </div>
