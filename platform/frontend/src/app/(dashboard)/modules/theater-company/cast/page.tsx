...
const PAGE = "Cast";
const KPIS = [{"l":"Total Theater Company","v":"4.501","t":"+17.5%","d":"up"},{"l":"Cast Ativos","v":"2.962","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"64","t":"+9.3%","d":"up"}];
const COLS = ["ID","Cast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Theater Company #001","Theater Company #002","5.546","6.110","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Theater Company #002","Theater Company #003","1.441","6.359","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Theater Company #003","Theater Company #004","4.131","3.027","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Theater Company #004","Theater Company #005","6.356","5.246","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Theater Company #005","Theater Company #001","5.925","3.606","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":536},{"label":"Mar","value":841},{"label":"Abr","value":797},{"label":"Mai","value":749},{"label":"Jun","value":606},{"label":"Jul","value":720},{"label":"Ago","value":624},{"label":"Set","value":581},{"label":"Out","value":576},{"label":"Nov","value":701},{"label":"Dez","value":827}];
const MX = 841;
