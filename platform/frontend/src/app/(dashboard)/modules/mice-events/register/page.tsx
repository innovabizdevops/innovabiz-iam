...
const KPIS = [{"l":"Eventos Planeados","v":"2.544","t":"-4.6%","d":"down"},{"l":"Participantes","v":"9.017","t":"+13.7%","d":"up"},{"l":"NPS Evento","v":"74","t":"+1.5%","d":"up"},{"l":"Receita (€)","v":"€16300","t":"+15.5%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-22","9.003","7.427","€ 33389.98","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-06","5.064","6.089","€ 44488.23","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-22","3.200","1.077","€ 46162.90","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-09","2.610","5.187","€ 24088.69","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-26","1.413","8.615","€ 22565.27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":232},{"label":"Fev","value":406},{"label":"Mar","value":216},{"label":"Abr","value":489},{"label":"Mai","value":336},{"label":"Jun","value":412},{"label":"Jul","value":446},{"label":"Ago","value":212},{"label":"Set","value":467},{"label":"Out","value":604},{"label":"Nov","value":370},{"label":"Dez","value":348}];
const MX = 604;
