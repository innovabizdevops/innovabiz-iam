...
const ACCENT = "#3b82f6";
const MODULE = "MICE & Events";
const PAGE = "Exhibit";
const KPIS = [{"l":"Total Mice Events","v":"596","t":"+15.5%","d":"up"},{"l":"Exhibit Ativos","v":"1.896","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"74.1%","t":"-4.4%","d":"down"},{"l":"Score Performance","v":"64","t":"+2.4%","d":"up"}];
const COLS = ["ID","Exhibit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mice Events #001","Mice Events #002","531","2.066","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Mice Events #002","Mice Events #003","1.145","1.739","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Mice Events #003","Mice Events #004","3.596","4.703","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Mice Events #004","Mice Events #005","5.681","7.946","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mice Events #005","Mice Events #001","8.614","4.533","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":849},{"label":"Fev","value":1035},{"label":"Mar","value":776},{"label":"Abr","value":760},{"label":"Mai","value":864},{"label":"Jun","value":1021},{"label":"Jul","value":736},{"label":"Ago","value":785},{"label":"Set","value":709},{"label":"Out","value":864},{"label":"Nov","value":964},{"label":"Dez","value":1034}];
const MX = 1035;
