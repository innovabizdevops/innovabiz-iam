...
const PAGE = "Venue";
const KPIS = [{"l":"Total Mice Events","v":"8.044","t":"+3.5%","d":"up"},{"l":"Venue Ativos","v":"1.329","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"74.8%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"59","t":"+3.9%","d":"up"}];
const COLS = ["ID","Venue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mice Events #001","Mice Events #002","6.045","3.180","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Mice Events #002","Mice Events #003","8.343","8.884","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Mice Events #003","Mice Events #004","5.748","7.794","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Mice Events #004","Mice Events #005","4.964","7.680","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mice Events #005","Mice Events #001","7.275","3.440","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":928},{"label":"Mar","value":983},{"label":"Abr","value":958},{"label":"Mai","value":924},{"label":"Jun","value":962},{"label":"Jul","value":866},{"label":"Ago","value":954},{"label":"Set","value":1068},{"label":"Out","value":749},{"label":"Nov","value":754},{"label":"Dez","value":967}];
const MX = 1068;
