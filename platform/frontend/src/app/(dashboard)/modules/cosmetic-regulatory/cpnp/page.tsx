...
const ACCENT = "#9d174d";
const MODULE = "Cosmetic Regulatory";
const PAGE = "CPNP";
const KPIS = [{"l":"Total Cosmetic Regulatory","v":"100","t":"+5.3%","d":"up"},{"l":"CPNP Ativos","v":"9.021","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"81.6%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"76","t":"+17.6%","d":"up"}];
const COLS = ["ID","CPNP","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmetic Regulatory #001","Cosmetic Regulatory #002","5.677","9.092","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmetic Regulatory #002","Cosmetic Regulatory #003","4.189","2.573","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmetic Regulatory #003","Cosmetic Regulatory #004","7.332","4.451","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmetic Regulatory #004","Cosmetic Regulatory #005","7.350","6.789","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmetic Regulatory #005","Cosmetic Regulatory #001","8.646","8.684","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":244},{"label":"Fev","value":514},{"label":"Mar","value":588},{"label":"Abr","value":604},{"label":"Mai","value":334},{"label":"Jun","value":441},{"label":"Jul","value":472},{"label":"Ago","value":528},{"label":"Set","value":251},{"label":"Out","value":356},{"label":"Nov","value":233},{"label":"Dez","value":614}];
const MX = 614;
...
export default function CpnpPage() {
    return (
