...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.882","t":"-1.2%","d":"down"},{"l":"NC Abertas","v":"7.589","t":"+9.8%","d":"up"},{"l":"Conformidade (%)","v":"76.0%","t":"+8.6%","d":"up"},{"l":"CAPAs Pendentes","v":"8.895","t":"+7.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.351","81.3%","7.584","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.654","88.0%","5.910","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","957","71.0%","7.129","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.784","86.4%","4.836","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.670","99.6%","1.462","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":729},{"label":"Mar","value":726},{"label":"Abr","value":694},{"label":"Mai","value":796},{"label":"Jun","value":877},{"label":"Jul","value":575},{"label":"Ago","value":574},{"label":"Set","value":869},{"label":"Out","value":938},{"label":"Nov","value":828},{"label":"Dez","value":597}];
const MX = 938;
