...
/* ═══ Cosmetic Regulatory — Dashboard ═══ */

const ACCENT = "#9d174d";

const KPIS = [
    { label: "Total Registos", value: "6861", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1607", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€364K", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "518281661", cells: ["COS-8661", "Cosmetic Regulatory Item 1", "10/6/2026", "€31 761"], status: "active" as const },
    { id: "518285232", cells: ["COS-3232", "Cosmetic Regulatory Item 2", "25/1/2026", "€35 332"], status: "pending" as const },
    { id: "518288803", cells: ["COS-6803", "Cosmetic Regulatory Item 3", "12/8/2026", "€38 903"], status: "completed" as const },
    { id: "518292374", cells: ["COS-1374", "Cosmetic Regulatory Item 4", "27/3/2026", "€42 474"], status: "warning" as const },
    { id: "518295945", cells: ["COS-4945", "Cosmetic Regulatory Item 5", "14/10/2026", "€46 045"], status: "active" as const },
];
...
export default function CosmeticRegulatoryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cosmetic Regulatory</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cosmetic Regulatory</p>
                    </div>
                </div>
