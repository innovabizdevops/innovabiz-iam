...
const PAGE = "Proctor";
const KPIS = [{"l":"Total Exam Mgmt","v":"7.270","t":"-1.6%","d":"down"},{"l":"Proctor Ativos","v":"4.063","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"88.4%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"74","t":"+7.8%","d":"up"}];
const COLS = ["ID","Proctor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Exam Mgmt #001","Exam Mgmt #002","789","1.856","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Exam Mgmt #002","Exam Mgmt #003","8.237","1.755","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Exam Mgmt #003","Exam Mgmt #004","8.200","3.557","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Exam Mgmt #004","Exam Mgmt #005","3.221","4.695","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Exam Mgmt #005","Exam Mgmt #001","8.609","3.637","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":704},{"label":"Mar","value":837},{"label":"Abr","value":896},{"label":"Mai","value":707},{"label":"Jun","value":820},{"label":"Jul","value":771},{"label":"Ago","value":711},{"label":"Set","value":623},{"label":"Out","value":730},{"label":"Nov","value":803},{"label":"Dez","value":537}];
const MX = 896;
