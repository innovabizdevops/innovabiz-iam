...
const ACCENT = "#6366f1";
const MODULE = "Exam Management";
const PAGE = "Grade";
const KPIS = [{"l":"Total Exam Mgmt","v":"4.099","t":"+5.8%","d":"up"},{"l":"Grade Ativos","v":"5.677","t":"+11.9%","d":"up"},{"l":"Eficiência (%)","v":"68.5%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"69","t":"+5.9%","d":"up"}];
const COLS = ["ID","Grade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Exam Mgmt #001","Exam Mgmt #002","8.857","8.387","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Exam Mgmt #002","Exam Mgmt #003","7.106","2.782","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Exam Mgmt #003","Exam Mgmt #004","1.979","2.591","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Exam Mgmt #004","Exam Mgmt #005","2.837","7.298","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Exam Mgmt #005","Exam Mgmt #001","6.226","5.966","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":706},{"label":"Mar","value":694},{"label":"Abr","value":589},{"label":"Mai","value":649},{"label":"Jun","value":675},{"label":"Jul","value":724},{"label":"Ago","value":586},{"label":"Set","value":714},{"label":"Out","value":569},{"label":"Nov","value":640},{"label":"Dez","value":665}];
const MX = 819;
