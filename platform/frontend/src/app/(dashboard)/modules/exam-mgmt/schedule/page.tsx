...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Exam Mgmt","v":"4.934","t":"+3.7%","d":"up"},{"l":"Schedule Ativos","v":"2.553","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"76.8%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"74","t":"+11.9%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Exam Mgmt #001","Exam Mgmt #002","2.947","6.044","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Exam Mgmt #002","Exam Mgmt #003","6.856","2.322","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Exam Mgmt #003","Exam Mgmt #004","8.927","4.559","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Exam Mgmt #004","Exam Mgmt #005","8.139","5.833","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Exam Mgmt #005","Exam Mgmt #001","5.900","6.298","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":536},{"label":"Mar","value":855},{"label":"Abr","value":633},{"label":"Mai","value":869},{"label":"Jun","value":845},{"label":"Jul","value":637},{"label":"Ago","value":891},{"label":"Set","value":756},{"label":"Out","value":857},{"label":"Nov","value":666},{"label":"Dez","value":838}];
const MX = 891;
