...
export default function PrintEstimatingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Print Estimating</h1><p className="text-sm text-muted-foreground">Print Estimating • iBOS Enterprise</p></div>
