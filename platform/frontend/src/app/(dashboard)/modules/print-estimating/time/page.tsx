...
const PAGE = "Time";
const KPIS = [{"l":"Total Print Estimating","v":"5.090","t":"-6.0%","d":"down"},{"l":"Time Ativos","v":"8.152","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"75.6%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"73","t":"+13.6%","d":"up"}];
const COLS = ["ID","Time","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Estimating #001","Print Estimating #002","2.565","8.612","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Print Estimating #002","Print Estimating #003","4.951","1.221","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Estimating #003","Print Estimating #004","1.958","6.568","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Print Estimating #004","Print Estimating #005","4.946","7.784","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Estimating #005","Print Estimating #001","1.082","2.115","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":362},{"label":"Fev","value":462},{"label":"Mar","value":630},{"label":"Abr","value":358},{"label":"Mai","value":433},{"label":"Jun","value":661},{"label":"Jul","value":495},{"label":"Ago","value":525},{"label":"Set","value":379},{"label":"Out","value":638},{"label":"Nov","value":332},{"label":"Dez","value":657}];
const MX = 661;
