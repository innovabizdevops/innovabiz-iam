...
const PAGE = "Job Cost";
const KPIS = [{"l":"Total Print Estimating","v":"6.387","t":"+6.5%","d":"up"},{"l":"Job Cost Ativos","v":"3.143","t":"+1.5%","d":"up"},{"l":"Eficiência (%)","v":"77.4%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"78","t":"+14.8%","d":"up"}];
const COLS = ["ID","Job Cost","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Estimating #001","Print Estimating #002","1.283","8.925","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Print Estimating #002","Print Estimating #003","2.869","3.969","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Estimating #003","Print Estimating #004","6.385","1.447","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Print Estimating #004","Print Estimating #005","5.433","2.609","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Estimating #005","Print Estimating #001","121","8.655","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":862},{"label":"Fev","value":692},{"label":"Mar","value":907},{"label":"Abr","value":780},{"label":"Mai","value":775},{"label":"Jun","value":696},{"label":"Jul","value":1022},{"label":"Ago","value":717},{"label":"Set","value":905},{"label":"Out","value":685},{"label":"Nov","value":769},{"label":"Dez","value":634}];
const MX = 1022;
