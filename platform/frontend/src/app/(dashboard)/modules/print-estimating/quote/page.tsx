...
const PAGE = "Quote";
const KPIS = [{"l":"Total Print Estimating","v":"5.765","t":"+13.5%","d":"up"},{"l":"Quote Ativos","v":"3.219","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"67.3%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"77","t":"-2.1%","d":"down"}];
const COLS = ["ID","Quote","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Estimating #001","Print Estimating #002","3.282","4.848","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Print Estimating #002","Print Estimating #003","3.864","5.239","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Estimating #003","Print Estimating #004","8.802","7.575","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Print Estimating #004","Print Estimating #005","4.748","4.984","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Estimating #005","Print Estimating #001","4.928","2.715","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":453},{"label":"Mar","value":304},{"label":"Abr","value":308},{"label":"Mai","value":460},{"label":"Jun","value":584},{"label":"Jul","value":643},{"label":"Ago","value":606},{"label":"Set","value":609},{"label":"Out","value":398},{"label":"Nov","value":348},{"label":"Dez","value":649}];
const MX = 666;
