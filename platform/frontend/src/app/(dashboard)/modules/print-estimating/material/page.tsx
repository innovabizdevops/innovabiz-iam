...
const ACCENT = "#6366f1";
const MODULE = "Print Estimating";
const PAGE = "Material";
const KPIS = [{"l":"Total Print Estimating","v":"5.347","t":"-3.6%","d":"down"},{"l":"Material Ativos","v":"2.931","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"79.5%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"59","t":"+10.7%","d":"up"}];
const COLS = ["ID","Material","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Estimating #001","Print Estimating #002","1.234","7.295","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Print Estimating #002","Print Estimating #003","5.737","1.004","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Estimating #003","Print Estimating #004","505","7.413","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Print Estimating #004","Print Estimating #005","3.599","1.725","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Estimating #005","Print Estimating #001","7.676","5.006","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":594},{"label":"Mar","value":576},{"label":"Abr","value":559},{"label":"Mai","value":520},{"label":"Jun","value":847},{"label":"Jul","value":731},{"label":"Ago","value":614},{"label":"Set","value":546},{"label":"Out","value":741},{"label":"Nov","value":871},{"label":"Dez","value":695}];
const MX = 871;
