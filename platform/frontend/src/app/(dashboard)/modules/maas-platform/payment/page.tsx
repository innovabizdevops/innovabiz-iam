...
const PAGE = "Payment";
const KPIS = [{"l":"Formulários Ativos","v":"1.736","t":"-2.4%","d":"down"},{"l":"Submissões/Dia","v":"696","t":"+1.5%","d":"up"},{"l":"Documentos Gerados","v":"2.079","t":"-3.0%","d":"down"},{"l":"Templates","v":"5.946","t":"+3.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.393","2026-02-05","7.851","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","427","2026-02-02","2.170","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.340","2026-01-27","5.579","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.758","2026-03-12","614","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.882","2026-01-05","8.166","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":727},{"label":"Mar","value":436},{"label":"Abr","value":433},{"label":"Mai","value":665},{"label":"Jun","value":579},{"label":"Jul","value":674},{"label":"Ago","value":377},{"label":"Set","value":348},{"label":"Out","value":629},{"label":"Nov","value":730},{"label":"Dez","value":741}];
const MX = 741;
