...
const KPIS = [{"l":"ARR (€M)","v":"€38.1M","t":"+2.1%","d":"up"},{"l":"MRR (€)","v":"€46410","t":"+16.8%","d":"up"},{"l":"Churn (%)","v":"67.7%","t":"-4.3%","d":"down"},{"l":"ARPU (€)","v":"€80357","t":"+3.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 42442.56","4.284","€ 42444.98","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 23606.50","1.325","€ 32108.67","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 37176.01","8.983","€ 46569.15","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 29172.06","2.130","€ 9668.34","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 9622.65","7.425","€ 9494.81","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":383},{"label":"Fev","value":440},{"label":"Mar","value":344},{"label":"Abr","value":530},{"label":"Mai","value":663},{"label":"Jun","value":408},{"label":"Jul","value":285},{"label":"Ago","value":585},{"label":"Set","value":306},{"label":"Out","value":405},{"label":"Nov","value":441},{"label":"Dez","value":464}];
const MX = 663;
