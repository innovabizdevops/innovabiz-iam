...
const ACCENT = "#6366f1";
const MODULE = "MaaS Platform";
const PAGE = "Multi-Modal";
const KPIS = [{"l":"Formulários Ativos","v":"1.538","t":"+16.0%","d":"up"},{"l":"Submissões/Dia","v":"4718","t":"-1.1%","d":"down"},{"l":"Documentos Gerados","v":"2.000","t":"-3.0%","d":"down"},{"l":"Templates","v":"2.018","t":"+7.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","240","2026-01-06","7.331","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.562","2026-01-18","2.299","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.144","2026-02-05","2.182","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.116","2026-03-22","8.005","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.564","2026-03-26","1.105","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":796},{"label":"Fev","value":669},{"label":"Mar","value":930},{"label":"Abr","value":964},{"label":"Mai","value":824},{"label":"Jun","value":1033},{"label":"Jul","value":909},{"label":"Ago","value":957},{"label":"Set","value":925},{"label":"Out","value":1060},{"label":"Nov","value":887},{"label":"Dez","value":676}];
const MX = 1060;
