...
const KPIS = [{"l":"Formulários Ativos","v":"7.348","t":"+13.1%","d":"up"},{"l":"Submissões/Dia","v":"1025","t":"+14.7%","d":"up"},{"l":"Documentos Gerados","v":"174","t":"+7.9%","d":"up"},{"l":"Templates","v":"5.162","t":"-0.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.177","2026-02-03","2.836","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.849","2026-02-26","3.917","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.210","2026-02-19","4.529","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.431","2026-01-10","3.462","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.717","2026-03-06","459","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":705},{"label":"Mar","value":593},{"label":"Abr","value":508},{"label":"Mai","value":753},{"label":"Jun","value":461},{"label":"Jul","value":528},{"label":"Ago","value":432},{"label":"Set","value":462},{"label":"Out","value":539},{"label":"Nov","value":455},{"label":"Dez","value":482}];
const MX = 753;
