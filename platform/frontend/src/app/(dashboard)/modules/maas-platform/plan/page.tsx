...
const PAGE = "Trip Plan";
const KPIS = [{"l":"Formulários Ativos","v":"3.233","t":"+13.1%","d":"up"},{"l":"Submissões/Dia","v":"1544","t":"+13.6%","d":"up"},{"l":"Documentos Gerados","v":"9.025","t":"+12.4%","d":"up"},{"l":"Templates","v":"1.970","t":"+3.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.299","2026-01-18","6.040","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","851","2026-03-22","3.565","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.640","2026-03-26","7.466","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.074","2026-03-18","3.365","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.837","2026-03-25","1.035","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":541},{"label":"Mar","value":738},{"label":"Abr","value":636},{"label":"Mai","value":753},{"label":"Jun","value":648},{"label":"Jul","value":738},{"label":"Ago","value":565},{"label":"Set","value":489},{"label":"Out","value":453},{"label":"Nov","value":779},{"label":"Dez","value":781}];
const MX = 781;
