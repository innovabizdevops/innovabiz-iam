...
const PAGE = "MPCI";
const KPIS = [{"l":"Total Crop Insurance","v":"6.764","t":"+14.6%","d":"up"},{"l":"MPCI Ativos","v":"1.525","t":"+2.8%","d":"up"},{"l":"Eficiência (%)","v":"84.8%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"76","t":"+17.5%","d":"up"}];
const COLS = ["ID","MPCI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crop Insurance #001","Crop Insurance #002","2.622","5.885","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Crop Insurance #002","Crop Insurance #003","1.208","628","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Crop Insurance #003","Crop Insurance #004","8.791","1.177","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Crop Insurance #004","Crop Insurance #005","1.325","7.402","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crop Insurance #005","Crop Insurance #001","7.571","3.769","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1002},{"label":"Fev","value":911},{"label":"Mar","value":725},{"label":"Abr","value":831},{"label":"Mai","value":710},{"label":"Jun","value":954},{"label":"Jul","value":679},{"label":"Ago","value":824},{"label":"Set","value":1042},{"label":"Out","value":1000},{"label":"Nov","value":861},{"label":"Dez","value":838}];
const MX = 1042;
