...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€28.8M","t":"-4.1%","d":"down"},{"l":"MRR (€)","v":"€13295","t":"+12.1%","d":"up"},{"l":"Churn (%)","v":"83.5%","t":"+13.9%","d":"up"},{"l":"ARPU (€)","v":"€88450","t":"+13.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 33988.77","429","€ 38682.12","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 49466.46","1.280","€ 7378.04","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 9986.98","3.931","€ 49829.98","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 49273.55","6.869","€ 24016.17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 38669.28","4.296","€ 25102.09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":734},{"label":"Mar","value":627},{"label":"Abr","value":403},{"label":"Mai","value":561},{"label":"Jun","value":563},{"label":"Jul","value":665},{"label":"Ago","value":568},{"label":"Set","value":663},{"label":"Out","value":695},{"label":"Nov","value":634},{"label":"Dez","value":566}];
const MX = 734;
