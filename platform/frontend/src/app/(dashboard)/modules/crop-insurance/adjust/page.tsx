...
const PAGE = "Adjusting";
const KPIS = [{"l":"Total Crop Insurance","v":"5.282","t":"+10.1%","d":"up"},{"l":"Adjusting Ativos","v":"3.957","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"66.1%","t":"+4.6%","d":"up"},{"l":"Score Performance","v":"87","t":"+6.9%","d":"up"}];
const COLS = ["ID","Adjusting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crop Insurance #001","Crop Insurance #002","6.008","2.066","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Crop Insurance #002","Crop Insurance #003","591","3.916","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Crop Insurance #003","Crop Insurance #004","6.028","4.305","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Crop Insurance #004","Crop Insurance #005","465","5.805","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crop Insurance #005","Crop Insurance #001","3.407","4.617","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":628},{"label":"Mar","value":519},{"label":"Abr","value":580},{"label":"Mai","value":604},{"label":"Jun","value":512},{"label":"Jul","value":485},{"label":"Ago","value":662},{"label":"Set","value":594},{"label":"Out","value":440},{"label":"Nov","value":615},{"label":"Dez","value":610}];
const MX = 810;
