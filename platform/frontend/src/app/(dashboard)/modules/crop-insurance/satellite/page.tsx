...
const ACCENT = "#6366f1";
const MODULE = "Crop Insurance";
const PAGE = "Satellite";
const KPIS = [{"l":"Total Crop Insurance","v":"8.617","t":"+3.2%","d":"up"},{"l":"Satellite Ativos","v":"3.388","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"92.4%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"63","t":"+9.6%","d":"up"}];
const COLS = ["ID","Satellite","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crop Insurance #001","Crop Insurance #002","8.539","2.179","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Crop Insurance #002","Crop Insurance #003","7.233","1.417","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Crop Insurance #003","Crop Insurance #004","2.081","8.247","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Crop Insurance #004","Crop Insurance #005","8.369","5.617","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crop Insurance #005","Crop Insurance #001","5.516","4.901","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":538},{"label":"Mar","value":616},{"label":"Abr","value":518},{"label":"Mai","value":742},{"label":"Jun","value":675},{"label":"Jul","value":658},{"label":"Ago","value":433},{"label":"Set","value":483},{"label":"Out","value":601},{"label":"Nov","value":624},{"label":"Dez","value":789}];
const MX = 789;
