...
const ACCENT = "#78350f";
const MODULE = "Kubernetes Management";
const PAGE = "Resource Quota";
const KPIS = [{"l":"Vendas YTD (€)","v":"€33095","t":"-2.2%","d":"down"},{"l":"Pipeline (€)","v":"€75244","t":"+11.3%","d":"up"},{"l":"Atingimento Quota (%)","v":"93.9%","t":"-3.7%","d":"down"},{"l":"Win Rate (%)","v":"76.4%","t":"+5.6%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 14255.21","€ 20154.63","€ 36063.68","82.5%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 22269.27","€ 30916.01","€ 42554.41","87.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 47391.40","€ 31570.95","€ 22502.59","72.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 20603.98","€ 39283.17","€ 6670.22","93.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 10607.62","€ 27148.98","€ 26526.12","86.0%"],"status":"active"}];
const CHART = [{"label":"Jan","value":890},{"label":"Fev","value":954},{"label":"Mar","value":944},{"label":"Abr","value":860},{"label":"Mai","value":631},{"label":"Jun","value":772},{"label":"Jul","value":966},{"label":"Ago","value":871},{"label":"Set","value":1008},{"label":"Out","value":797},{"label":"Nov","value":885},{"label":"Dez","value":722}];
const MX = 1008;
