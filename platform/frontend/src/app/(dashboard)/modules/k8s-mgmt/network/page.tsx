...
const PAGE = "Network Policy";
const KPIS = [{"l":"Total K8s Mgmt","v":"4.236","t":"+4.1%","d":"up"},{"l":"Network Policy Ativos","v":"7.475","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"85.4%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"67","t":"-1.4%","d":"down"}];
const COLS = ["ID","Network Policy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["K8s Mgmt #001","K8s Mgmt #002","2.676","1.864","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["K8s Mgmt #002","K8s Mgmt #003","3.496","362","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["K8s Mgmt #003","K8s Mgmt #004","8.284","2.791","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["K8s Mgmt #004","K8s Mgmt #005","1.955","7.557","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["K8s Mgmt #005","K8s Mgmt #001","3.187","3.020","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":779},{"label":"Mar","value":668},{"label":"Abr","value":876},{"label":"Mai","value":832},{"label":"Jun","value":740},{"label":"Jul","value":548},{"label":"Ago","value":891},{"label":"Set","value":600},{"label":"Out","value":730},{"label":"Nov","value":593},{"label":"Dez","value":566}];
const MX = 891;
