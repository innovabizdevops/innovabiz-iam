...
const PAGE = "Cluster Ops";
const KPIS = [{"l":"Total K8s Mgmt","v":"8.137","t":"+14.8%","d":"up"},{"l":"Cluster Ops Ativos","v":"7.568","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"91.5%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"79","t":"-3.6%","d":"down"}];
const COLS = ["ID","Cluster Ops","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["K8s Mgmt #001","K8s Mgmt #002","8.378","8.778","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["K8s Mgmt #002","K8s Mgmt #003","1.710","1.091","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["K8s Mgmt #003","K8s Mgmt #004","2.473","8.708","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["K8s Mgmt #004","K8s Mgmt #005","8.251","2.375","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["K8s Mgmt #005","K8s Mgmt #001","5.192","2.171","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":440},{"label":"Fev","value":561},{"label":"Mar","value":676},{"label":"Abr","value":657},{"label":"Mai","value":306},{"label":"Jun","value":389},{"label":"Jul","value":340},{"label":"Ago","value":594},{"label":"Set","value":626},{"label":"Out","value":500},{"label":"Nov","value":358},{"label":"Dez","value":511}];
const MX = 676;
