...
export default function K8sMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">K8s Mgmt</h1><p className="text-sm text-muted-foreground">K8s Mgmt • iBOS Enterprise</p></div>
