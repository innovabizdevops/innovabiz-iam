...
const PAGE = "Helm Deploy";
const KPIS = [{"l":"Total K8s Mgmt","v":"5.446","t":"+15.3%","d":"up"},{"l":"Helm Deploy Ativos","v":"6.624","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"66.5%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"83","t":"+4.8%","d":"up"}];
const COLS = ["ID","Helm Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["K8s Mgmt #001","K8s Mgmt #002","495","7.083","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["K8s Mgmt #002","K8s Mgmt #003","8.083","2.561","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["K8s Mgmt #003","K8s Mgmt #004","6.861","8.949","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["K8s Mgmt #004","K8s Mgmt #005","7.913","8.988","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["K8s Mgmt #005","K8s Mgmt #001","661","7.404","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":372},{"label":"Fev","value":610},{"label":"Mar","value":305},{"label":"Abr","value":671},{"label":"Mai","value":455},{"label":"Jun","value":554},{"label":"Jul","value":481},{"label":"Ago","value":401},{"label":"Set","value":324},{"label":"Out","value":376},{"label":"Nov","value":596},{"label":"Dez","value":608}];
const MX = 671;
