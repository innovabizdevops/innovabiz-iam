...
/* ═══ SC: Package Manager — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "3843", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2951", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€453K", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "471451643", cells: ["SC-5643", "SC: Package Manager Item 1", "20/12/2026", "€1743"], status: "active" as const },
    { id: "471455214", cells: ["SC-9214", "SC: Package Manager Item 2", "7/7/2026", "€5314"], status: "pending" as const },
    { id: "471458785", cells: ["SC-3785", "SC: Package Manager Item 3", "22/2/2026", "€8885"], status: "completed" as const },
    { id: "471462356", cells: ["SC-7356", "SC: Package Manager Item 4", "9/9/2026", "€12 456"], status: "warning" as const },
    { id: "471465927", cells: ["SC-1927", "SC: Package Manager Item 5", "24/4/2026", "€16 027"], status: "active" as const },
];
...
export default function ScPackageManagerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: Package Manager</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: Package Manager</p>
                    </div>
                </div>
