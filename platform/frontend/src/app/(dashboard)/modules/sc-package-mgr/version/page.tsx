...
const PAGE = "Version";
const KPIS = [{"l":"Formulários Ativos","v":"3.413","t":"+14.3%","d":"up"},{"l":"Submissões/Dia","v":"4203","t":"+11.8%","d":"up"},{"l":"Documentos Gerados","v":"6.987","t":"+3.2%","d":"up"},{"l":"Templates","v":"2.463","t":"+8.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.412","2026-02-16","4.836","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.464","2026-03-27","5.930","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.755","2026-03-07","2.415","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.966","2026-02-01","4.980","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.241","2026-03-28","800","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":416},{"label":"Fev","value":548},{"label":"Mar","value":410},{"label":"Abr","value":649},{"label":"Mai","value":597},{"label":"Jun","value":367},{"label":"Jul","value":396},{"label":"Ago","value":425},{"label":"Set","value":360},{"label":"Out","value":654},{"label":"Nov","value":489},{"label":"Dez","value":318}];
const MX = 654;
