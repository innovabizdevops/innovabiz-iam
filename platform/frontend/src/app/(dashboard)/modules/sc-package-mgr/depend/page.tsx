...
const ACCENT = "#0284c7";
const MODULE = "SC: Package Manager";
const PAGE = "Depend";
const KPIS = [{"l":"Total Sc Package Mgr","v":"9.008","t":"-0.4%","d":"down"},{"l":"Depend Ativos","v":"290","t":"+0.3%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"63","t":"-1.2%","d":"down"}];
const COLS = ["ID","Depend","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Package Mgr #001","Sc Package Mgr #002","140","6.051","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Package Mgr #002","Sc Package Mgr #003","8.799","867","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Package Mgr #003","Sc Package Mgr #004","3.352","3.171","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Package Mgr #004","Sc Package Mgr #005","5.027","5.259","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Package Mgr #005","Sc Package Mgr #001","8.709","8.034","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":691},{"label":"Mar","value":819},{"label":"Abr","value":548},{"label":"Mai","value":607},{"label":"Jun","value":810},{"label":"Jul","value":739},{"label":"Ago","value":739},{"label":"Set","value":731},{"label":"Out","value":775},{"label":"Nov","value":698},{"label":"Dez","value":607}];
const MX = 864;
