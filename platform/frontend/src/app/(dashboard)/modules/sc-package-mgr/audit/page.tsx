...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"715","t":"+7.6%","d":"up"},{"l":"NC Abertas","v":"5.827","t":"-1.9%","d":"down"},{"l":"Conformidade (%)","v":"88.8%","t":"+2.6%","d":"up"},{"l":"CAPAs Pendentes","v":"8.905","t":"+6.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.791","97.8%","2.214","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.779","96.3%","1.979","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.596","75.0%","6.298","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.418","80.1%","6.807","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.657","99.0%","3.555","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":448},{"label":"Mar","value":779},{"label":"Abr","value":668},{"label":"Mai","value":508},{"label":"Jun","value":710},{"label":"Jul","value":609},{"label":"Ago","value":514},{"label":"Set","value":492},{"label":"Out","value":813},{"label":"Nov","value":570},{"label":"Dez","value":495}];
const MX = 813;
