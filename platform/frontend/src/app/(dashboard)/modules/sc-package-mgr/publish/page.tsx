...
const PAGE = "Publish";
const KPIS = [{"l":"Total Sc Package Mgr","v":"4.282","t":"+8.6%","d":"up"},{"l":"Publish Ativos","v":"4.554","t":"+1.4%","d":"up"},{"l":"Eficiência (%)","v":"91.3%","t":"+17.8%","d":"up"},{"l":"Score Performance","v":"59","t":"+0.1%","d":"up"}];
const COLS = ["ID","Publish","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Package Mgr #001","Sc Package Mgr #002","3.832","8.231","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Package Mgr #002","Sc Package Mgr #003","8.853","1.953","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Package Mgr #003","Sc Package Mgr #004","7.393","6.042","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Package Mgr #004","Sc Package Mgr #005","9.072","6.497","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Package Mgr #005","Sc Package Mgr #001","1.236","2.686","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":550},{"label":"Fev","value":713},{"label":"Mar","value":575},{"label":"Abr","value":625},{"label":"Mai","value":519},{"label":"Jun","value":532},{"label":"Jul","value":821},{"label":"Ago","value":878},{"label":"Set","value":535},{"label":"Out","value":870},{"label":"Nov","value":518},{"label":"Dez","value":816}];
const MX = 878;
