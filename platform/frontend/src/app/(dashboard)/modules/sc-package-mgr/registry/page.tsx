...
const PAGE = "Registry";
const KPIS = [{"l":"Total Sc Package Mgr","v":"6.628","t":"+6.2%","d":"up"},{"l":"Registry Ativos","v":"3.419","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"84.0%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"88","t":"-5.4%","d":"down"}];
const COLS = ["ID","Registry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Package Mgr #001","Sc Package Mgr #002","2.532","6.244","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Package Mgr #002","Sc Package Mgr #003","7.254","8.906","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Package Mgr #003","Sc Package Mgr #004","5.902","5.410","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Package Mgr #004","Sc Package Mgr #005","488","5.194","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Package Mgr #005","Sc Package Mgr #001","3.380","5.747","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":732},{"label":"Mar","value":735},{"label":"Abr","value":747},{"label":"Mai","value":529},{"label":"Jun","value":427},{"label":"Jul","value":714},{"label":"Ago","value":566},{"label":"Set","value":692},{"label":"Out","value":575},{"label":"Nov","value":587},{"label":"Dez","value":404}];
const MX = 747;
