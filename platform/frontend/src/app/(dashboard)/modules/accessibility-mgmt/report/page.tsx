...
const PAGE = "Report";
const KPIS = [{"l":"Total Accessibility Mgmt","v":"3.250","t":"+13.9%","d":"up"},{"l":"Report Ativos","v":"5.097","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"80.5%","t":"+13.2%","d":"up"},{"l":"Score Performance","v":"95","t":"+0.3%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Accessibility Mgmt #001","Accessibility Mgmt #002","2.002","2.781","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Accessibility Mgmt #002","Accessibility Mgmt #003","8.907","381","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Accessibility Mgmt #003","Accessibility Mgmt #004","3.520","8.952","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Accessibility Mgmt #004","Accessibility Mgmt #005","8.502","858","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Accessibility Mgmt #005","Accessibility Mgmt #001","4.167","777","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":677},{"label":"Mar","value":749},{"label":"Abr","value":778},{"label":"Mai","value":783},{"label":"Jun","value":484},{"label":"Jul","value":686},{"label":"Ago","value":719},{"label":"Set","value":822},{"label":"Out","value":779},{"label":"Nov","value":473},{"label":"Dez","value":749}];
const MX = 822;
