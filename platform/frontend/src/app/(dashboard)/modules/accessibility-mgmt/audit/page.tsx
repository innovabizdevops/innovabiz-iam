...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.045","t":"+8.1%","d":"up"},{"l":"NC Abertas","v":"2.320","t":"+11.2%","d":"up"},{"l":"Conformidade (%)","v":"86.7%","t":"-1.3%","d":"down"},{"l":"CAPAs Pendentes","v":"2.906","t":"+6.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.052","78.2%","4.722","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.323","90.0%","2.618","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.408","97.6%","6.074","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.236","89.0%","175","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.357","73.7%","6.591","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":914},{"label":"Mar","value":728},{"label":"Abr","value":725},{"label":"Mai","value":634},{"label":"Jun","value":652},{"label":"Jul","value":609},{"label":"Ago","value":974},{"label":"Set","value":896},{"label":"Out","value":898},{"label":"Nov","value":764},{"label":"Dez","value":611}];
const MX = 974;
