...
const ACCENT = "#f43f5e";
const MODULE = "Accessibility (WCAG 2.2)";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Accessibility Mgmt","v":"639","t":"+16.2%","d":"up"},{"l":"Monitor Ativos","v":"1.060","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"77.6%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"72","t":"-2.4%","d":"down"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Accessibility Mgmt #001","Accessibility Mgmt #002","6.875","2.694","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Accessibility Mgmt #002","Accessibility Mgmt #003","3.700","8.327","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Accessibility Mgmt #003","Accessibility Mgmt #004","3.887","6.124","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Accessibility Mgmt #004","Accessibility Mgmt #005","1.688","591","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Accessibility Mgmt #005","Accessibility Mgmt #001","1.744","3.683","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":1042},{"label":"Mar","value":745},{"label":"Abr","value":894},{"label":"Mai","value":886},{"label":"Jun","value":732},{"label":"Jul","value":966},{"label":"Ago","value":699},{"label":"Set","value":963},{"label":"Out","value":951},{"label":"Nov","value":1076},{"label":"Dez","value":947}];
const MX = 1076;
