...
const PAGE = "Test";
const KPIS = [{"l":"Total Accessibility Mgmt","v":"8.499","t":"+16.7%","d":"up"},{"l":"Test Ativos","v":"4.764","t":"+2.0%","d":"up"},{"l":"Eficiência (%)","v":"75.7%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"85","t":"+0.0%","d":"up"}];
const COLS = ["ID","Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Accessibility Mgmt #001","Accessibility Mgmt #002","4.634","5.911","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Accessibility Mgmt #002","Accessibility Mgmt #003","8.224","7.371","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Accessibility Mgmt #003","Accessibility Mgmt #004","2.773","1.362","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Accessibility Mgmt #004","Accessibility Mgmt #005","6.286","7.693","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Accessibility Mgmt #005","Accessibility Mgmt #001","8.339","8.428","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":643},{"label":"Mar","value":664},{"label":"Abr","value":530},{"label":"Mai","value":370},{"label":"Jun","value":601},{"label":"Jul","value":559},{"label":"Ago","value":466},{"label":"Set","value":364},{"label":"Out","value":402},{"label":"Nov","value":630},{"label":"Dez","value":589}];
const MX = 664;
