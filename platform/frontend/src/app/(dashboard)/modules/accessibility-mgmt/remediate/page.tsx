...
const KPIS = [{"l":"Integrações Ativas","v":"2.907","t":"-0.9%","d":"down"},{"l":"Chamadas/Hora","v":"3500","t":"+16.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"83.7%","t":"+8.5%","d":"up"},{"l":"Latência Média (ms)","v":"184ms","t":"-0.3%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.382","5.578","83.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.554","5.206","91.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.222","2.706","98.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","201","8.557","80.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.922","7.882","79.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":563},{"label":"Mar","value":548},{"label":"Abr","value":482},{"label":"Mai","value":642},{"label":"Jun","value":511},{"label":"Jul","value":353},{"label":"Ago","value":643},{"label":"Set","value":665},{"label":"Out","value":599},{"label":"Nov","value":659},{"label":"Dez","value":623}];
const MX = 665;
