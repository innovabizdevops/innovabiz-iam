...
/* ═══ Accessibility (WCAG 2.2) — Dashboard ═══ */

const ACCENT = "#f43f5e";

const KPIS = [
    { label: "Total Registos", value: "2515", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2342", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€135K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "-23%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "904803015", cells: ["ACC-7015", "Accessibility (WCAG 2.2) Item 1", "12/4/2026", "€3115"], status: "active" as const },
    { id: "904806586", cells: ["ACC-1586", "Accessibility (WCAG 2.2) Item 2", "27/11/2026", "€6686"], status: "pending" as const },
    { id: "904810157", cells: ["ACC-5157", "Accessibility (WCAG 2.2) Item 3", "14/6/2026", "€10 257"], status: "completed" as const },
    { id: "904813728", cells: ["ACC-8728", "Accessibility (WCAG 2.2) Item 4", "1/1/2026", "€13 828"], status: "warning" as const },
    { id: "904817299", cells: ["ACC-3299", "Accessibility (WCAG 2.2) Item 5", "16/8/2026", "€17 399"], status: "active" as const },
];
...
export default function AccessibilityWcag22Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Accessibility (WCAG 2.2)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Accessibility (WCAG 2.2)</p>
                    </div>
                </div>
