...
const KPIS = [{"l":"Dashboards Ativos","v":"2.332","t":"+3.4%","d":"up"},{"l":"Queries/Dia","v":"3814","t":"+4.8%","d":"up"},{"l":"Dados Processados (GB)","v":"6.498","t":"+2.8%","d":"up"},{"l":"Utilizadores Analytics","v":"5.913","t":"+3.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3255","2026-03-03","1.161","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1252","2026-02-01","3.264","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4070","2026-03-26","5.042","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2721","2026-02-16","8.297","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3771","2026-03-20","2.359","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":779},{"label":"Mar","value":468},{"label":"Abr","value":639},{"label":"Mai","value":707},{"label":"Jun","value":703},{"label":"Jul","value":546},{"label":"Ago","value":511},{"label":"Set","value":785},{"label":"Out","value":810},{"label":"Nov","value":678},{"label":"Dez","value":728}];
const MX = 810;
