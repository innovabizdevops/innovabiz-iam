...
const ACCENT = "#059669";
const MODULE = "Payroll FinTech";
const PAGE = "Earned Wage";
const KPIS = [{"l":"Total Payroll Fintech","v":"7.241","t":"+1.2%","d":"up"},{"l":"Earned Wage Ativos","v":"4.386","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"84.1%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"86","t":"+8.7%","d":"up"}];
const COLS = ["ID","Earned Wage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll Fintech #001","Payroll Fintech #002","4.246","8.668","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll Fintech #002","Payroll Fintech #003","1.709","2.938","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll Fintech #003","Payroll Fintech #004","7.715","4.382","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll Fintech #004","Payroll Fintech #005","2.763","4.465","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll Fintech #005","Payroll Fintech #001","2.833","765","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":270},{"label":"Fev","value":283},{"label":"Mar","value":417},{"label":"Abr","value":644},{"label":"Mai","value":308},{"label":"Jun","value":500},{"label":"Jul","value":452},{"label":"Ago","value":578},{"label":"Set","value":634},{"label":"Out","value":397},{"label":"Nov","value":378},{"label":"Dez","value":388}];
const MX = 644;
