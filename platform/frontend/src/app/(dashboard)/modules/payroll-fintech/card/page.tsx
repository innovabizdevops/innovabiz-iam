...
const PAGE = "Card";
const KPIS = [{"l":"Total Payroll Fintech","v":"7.056","t":"+1.9%","d":"up"},{"l":"Card Ativos","v":"3.110","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"80.9%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"73","t":"+1.4%","d":"up"}];
const COLS = ["ID","Card","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll Fintech #001","Payroll Fintech #002","3.799","5.491","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll Fintech #002","Payroll Fintech #003","4.467","6.406","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll Fintech #003","Payroll Fintech #004","7.486","3.738","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll Fintech #004","Payroll Fintech #005","3.285","7.634","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll Fintech #005","Payroll Fintech #001","1.063","8.955","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":502},{"label":"Mar","value":410},{"label":"Abr","value":342},{"label":"Mai","value":684},{"label":"Jun","value":462},{"label":"Jul","value":365},{"label":"Ago","value":439},{"label":"Set","value":515},{"label":"Out","value":417},{"label":"Nov","value":529},{"label":"Dez","value":378}];
const MX = 710;
