...
const ACCENT = "#dc2626";
const MODULE = "ATC System";
const PAGE = "Conflict Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"5.361","t":"-3.4%","d":"down"},{"l":"Taxa Entrega (%)","v":"81.3%","t":"-1.7%","d":"down"},{"l":"Taxa Abertura (%)","v":"81.9%","t":"+15.7%","d":"up"},{"l":"Escalações","v":"8.761","t":"+10.8%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","1.717","75.5%","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","3.871","75.5%","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","1.238","83.2%","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","3.142","89.5%","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","5.807","81.8%","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":785},{"label":"Fev","value":654},{"label":"Mar","value":775},{"label":"Abr","value":618},{"label":"Mai","value":537},{"label":"Jun","value":484},{"label":"Jul","value":527},{"label":"Ago","value":544},{"label":"Set","value":708},{"label":"Out","value":580},{"label":"Nov","value":513},{"label":"Dez","value":432}];
const MX = 785;
