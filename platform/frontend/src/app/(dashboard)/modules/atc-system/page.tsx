...
export default function AtcSystemPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Atc System</h1><p className="text-sm text-muted-foreground">Atc System • iBOS Enterprise</p></div>
