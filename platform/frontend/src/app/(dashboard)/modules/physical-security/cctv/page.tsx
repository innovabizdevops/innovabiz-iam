...
const ACCENT = "#475569";
const MODULE = "Physical Security";
const PAGE = "CCTV Monitor";
const KPIS = [{"l":"Total Physical Security","v":"7.311","t":"+12.4%","d":"up"},{"l":"CCTV Monitor Ativos","v":"1.495","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"75.1%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"84","t":"-5.2%","d":"down"}];
const COLS = ["ID","CCTV Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Physical Security #001","Physical Security #002","8.448","7.745","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Physical Security #002","Physical Security #003","1.207","4.955","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Physical Security #003","Physical Security #004","3.335","3.391","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Physical Security #004","Physical Security #005","2.445","1.560","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Physical Security #005","Physical Security #001","2.782","2.536","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":386},{"label":"Fev","value":561},{"label":"Mar","value":264},{"label":"Abr","value":277},{"label":"Mai","value":593},{"label":"Jun","value":305},{"label":"Jul","value":370},{"label":"Ago","value":632},{"label":"Set","value":253},{"label":"Out","value":304},{"label":"Nov","value":590},{"label":"Dez","value":524}];
const MX = 632;
