...
const PAGE = "Patrol Route";
const KPIS = [{"l":"Total Physical Security","v":"2.327","t":"-4.4%","d":"down"},{"l":"Patrol Route Ativos","v":"8.775","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"83.9%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"60","t":"+8.6%","d":"up"}];
const COLS = ["ID","Patrol Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Physical Security #001","Physical Security #002","1.304","8.999","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Physical Security #002","Physical Security #003","5.414","3.254","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Physical Security #003","Physical Security #004","2.732","4.416","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Physical Security #004","Physical Security #005","4.464","7.476","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Physical Security #005","Physical Security #001","4.682","1.061","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":760},{"label":"Fev","value":697},{"label":"Mar","value":606},{"label":"Abr","value":700},{"label":"Mai","value":514},{"label":"Jun","value":377},{"label":"Jul","value":634},{"label":"Ago","value":434},{"label":"Set","value":434},{"label":"Out","value":366},{"label":"Nov","value":383},{"label":"Dez","value":707}];
const MX = 760;
