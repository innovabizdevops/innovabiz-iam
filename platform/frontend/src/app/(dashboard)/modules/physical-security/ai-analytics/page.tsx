...
const PAGE = "AI Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"4.110","t":"+7.8%","d":"up"},{"l":"Queries/Dia","v":"4183","t":"-3.8%","d":"down"},{"l":"Dados Processados (GB)","v":"6.063","t":"+2.2%","d":"up"},{"l":"Utilizadores Analytics","v":"3.606","t":"+16.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1935","2026-02-12","8.288","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1450","2026-03-17","5.813","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3518","2026-01-07","3.447","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4691","2026-03-05","7.642","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","959","2026-01-05","7.172","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":418},{"label":"Mar","value":510},{"label":"Abr","value":440},{"label":"Mai","value":704},{"label":"Jun","value":493},{"label":"Jul","value":548},{"label":"Ago","value":788},{"label":"Set","value":692},{"label":"Out","value":500},{"label":"Nov","value":554},{"label":"Dez","value":628}];
const MX = 788;
