...
/* ═══ Deep Tech Hub — Brain Interface ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "3284", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "53", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3157", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1796176769", cells: ["DEE-2769", "Brain Interface Item 1", "10/6/2026", "€26 869"], status: "active" as const },
    { id: "1796180340", cells: ["DEE-6340", "Brain Interface Item 2", "25/1/2026", "€30 440"], status: "pending" as const },
    { id: "1796183911", cells: ["DEE-9911", "Brain Interface Item 3", "12/8/2026", "€34 011"], status: "completed" as const },
    { id: "1796187482", cells: ["DEE-4482", "Brain Interface Item 4", "27/3/2026", "€37 582"], status: "warning" as const },
    { id: "1796191053", cells: ["DEE-8053", "Brain Interface Item 5", "14/10/2026", "€41 153"], status: "active" as const },
];
...
export default function DeepTechHubBrainInterfacePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Brain Interface</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Deep Tech Hub • Brain Interface</p>
                    </div>
                </div>
