...
/* ═══ Deep Tech Hub — Photonic Chip ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "4352", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "268", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2440", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1445271368", cells: ["DEE-7368", "Photonic Chip Item 1", "17/9/2026", "€21 468"], status: "active" as const },
    { id: "1445274939", cells: ["DEE-1939", "Photonic Chip Item 2", "4/4/2026", "€25 039"], status: "pending" as const },
    { id: "1445278510", cells: ["DEE-5510", "Photonic Chip Item 3", "19/11/2026", "€28 610"], status: "completed" as const },
    { id: "1445282081", cells: ["DEE-9081", "Photonic Chip Item 4", "6/6/2026", "€32 181"], status: "warning" as const },
    { id: "1445285652", cells: ["DEE-3652", "Photonic Chip Item 5", "21/1/2026", "€35 752"], status: "active" as const },
];
...
export default function DeepTechHubPhotonicChipPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Photonic Chip</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Deep Tech Hub • Photonic Chip</p>
                    </div>
                </div>
