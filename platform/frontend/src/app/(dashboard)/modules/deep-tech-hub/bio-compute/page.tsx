...
/* ═══ Deep Tech Hub — Bio Compute ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "1553", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "35", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1667", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "893762287", cells: ["DEE-9287", "Bio Compute Item 1", "20/8/2026", "€12 387"], status: "active" as const },
    { id: "893765858", cells: ["DEE-3858", "Bio Compute Item 2", "7/3/2026", "€15 958"], status: "pending" as const },
    { id: "893769429", cells: ["DEE-7429", "Bio Compute Item 3", "22/10/2026", "€19 529"], status: "completed" as const },
    { id: "893773000", cells: ["DEE-2000", "Bio Compute Item 4", "9/5/2026", "€23 100"], status: "warning" as const },
    { id: "893776571", cells: ["DEE-5571", "Bio Compute Item 5", "24/12/2026", "€26 671"], status: "active" as const },
];
...
export default function DeepTechHubBioComputePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Bio Compute</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Deep Tech Hub • Bio Compute</p>
                    </div>
                </div>
