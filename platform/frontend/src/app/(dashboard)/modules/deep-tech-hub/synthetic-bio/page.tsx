...
/* ═══ Deep Tech Hub — Synthetic Bio ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "4075", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "133", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3027", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1366481633", cells: ["DEE-3633", "Synthetic Bio Item 1", "14/6/2026", "€31 733"], status: "active" as const },
    { id: "1366485204", cells: ["DEE-7204", "Synthetic Bio Item 2", "1/1/2026", "€35 304"], status: "pending" as const },
    { id: "1366488775", cells: ["DEE-1775", "Synthetic Bio Item 3", "16/8/2026", "€38 875"], status: "completed" as const },
    { id: "1366492346", cells: ["DEE-5346", "Synthetic Bio Item 4", "3/3/2026", "€42 446"], status: "warning" as const },
    { id: "1366495917", cells: ["DEE-8917", "Synthetic Bio Item 5", "18/10/2026", "€46 017"], status: "active" as const },
];
...
export default function DeepTechHubSyntheticBioPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Synthetic Bio</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Deep Tech Hub • Synthetic Bio</p>
                    </div>
                </div>
