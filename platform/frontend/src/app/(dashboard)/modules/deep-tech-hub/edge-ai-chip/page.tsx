...
/* ═══ Deep Tech Hub — Edge Ai Chip ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "784", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "307", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "800", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1322829839", cells: ["DEE-1839", "Edge Ai Chip Item 1", "24/12/2026", "€29 939"], status: "active" as const },
    { id: "1322833410", cells: ["DEE-5410", "Edge Ai Chip Item 2", "11/7/2026", "€33 510"], status: "pending" as const },
    { id: "1322836981", cells: ["DEE-8981", "Edge Ai Chip Item 3", "26/2/2026", "€37 081"], status: "completed" as const },
    { id: "1322840552", cells: ["DEE-3552", "Edge Ai Chip Item 4", "13/9/2026", "€40 652"], status: "warning" as const },
    { id: "1322844123", cells: ["DEE-7123", "Edge Ai Chip Item 5", "28/4/2026", "€44 223"], status: "active" as const },
];
...
export default function DeepTechHubEdgeAiChipPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Edge Ai Chip</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Deep Tech Hub • Edge Ai Chip</p>
                    </div>
                </div>
