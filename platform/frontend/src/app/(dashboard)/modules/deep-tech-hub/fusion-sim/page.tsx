...
/* ═══ Deep Tech Hub — Fusion Sim ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "2446", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "91", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3769", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "197215159", cells: ["DEE-8159", "Fusion Sim Item 1", "16/8/2026", "€15 259"], status: "active" as const },
    { id: "197218730", cells: ["DEE-2730", "Fusion Sim Item 2", "3/3/2026", "€18 830"], status: "pending" as const },
    { id: "197222301", cells: ["DEE-6301", "Fusion Sim Item 3", "18/10/2026", "€22 401"], status: "completed" as const },
    { id: "197225872", cells: ["DEE-9872", "Fusion Sim Item 4", "5/5/2026", "€25 972"], status: "warning" as const },
    { id: "197229443", cells: ["DEE-4443", "Fusion Sim Item 5", "20/12/2026", "€29 543"], status: "active" as const },
];
...
export default function DeepTechHubFusionSimPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fusion Sim</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Deep Tech Hub • Fusion Sim</p>
                    </div>
                </div>
