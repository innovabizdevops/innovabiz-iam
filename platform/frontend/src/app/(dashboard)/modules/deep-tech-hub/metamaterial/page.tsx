...
/* ═══ Deep Tech Hub — Metamaterial ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "1076", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "254", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1185", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "706516058", cells: ["DEE-8058", "Metamaterial Item 1", "11/3/2026", "€16 158"], status: "active" as const },
    { id: "706519629", cells: ["DEE-2629", "Metamaterial Item 2", "26/10/2026", "€19 729"], status: "pending" as const },
    { id: "706523200", cells: ["DEE-6200", "Metamaterial Item 3", "13/5/2026", "€23 300"], status: "completed" as const },
    { id: "706526771", cells: ["DEE-9771", "Metamaterial Item 4", "28/12/2026", "€26 871"], status: "warning" as const },
    { id: "706530342", cells: ["DEE-4342", "Metamaterial Item 5", "15/7/2026", "€30 442"], status: "active" as const },
];
...
export default function DeepTechHubMetamaterialPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Metamaterial</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Deep Tech Hub • Metamaterial</p>
                    </div>
                </div>
