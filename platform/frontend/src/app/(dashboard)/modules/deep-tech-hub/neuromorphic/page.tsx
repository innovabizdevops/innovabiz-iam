...
/* ═══ Deep Tech Hub — Neuromorphic ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "1486", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "425", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2144", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1096693141", cells: ["DEE-8141", "Neuromorphic Item 1", "6/2/2026", "€43 241"], status: "active" as const },
    { id: "1096696712", cells: ["DEE-2712", "Neuromorphic Item 2", "21/9/2026", "€46 812"], status: "pending" as const },
    { id: "1096700283", cells: ["DEE-6283", "Neuromorphic Item 3", "8/4/2026", "€383"], status: "completed" as const },
    { id: "1096703854", cells: ["DEE-9854", "Neuromorphic Item 4", "23/11/2026", "€3954"], status: "warning" as const },
    { id: "1096707425", cells: ["DEE-4425", "Neuromorphic Item 5", "10/6/2026", "€7525"], status: "active" as const },
];
...
export default function DeepTechHubNeuromorphicPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Neuromorphic</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Deep Tech Hub • Neuromorphic</p>
                    </div>
                </div>
