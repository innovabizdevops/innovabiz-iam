...
/* ═══ Deep Tech Hub — Nano Fabricate ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "4486", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "357", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2274", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1044674577", cells: ["DEE-9577", "Nano Fabricate Item 1", "10/10/2026", "€24 677"], status: "active" as const },
    { id: "1044678148", cells: ["DEE-4148", "Nano Fabricate Item 2", "25/5/2026", "€28 248"], status: "pending" as const },
    { id: "1044681719", cells: ["DEE-7719", "Nano Fabricate Item 3", "12/12/2026", "€31 819"], status: "completed" as const },
    { id: "1044685290", cells: ["DEE-2290", "Nano Fabricate Item 4", "27/7/2026", "€35 390"], status: "warning" as const },
    { id: "1044688861", cells: ["DEE-5861", "Nano Fabricate Item 5", "14/2/2026", "€38 961"], status: "active" as const },
];
...
export default function DeepTechHubNanoFabricatePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Nano Fabricate</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Deep Tech Hub • Nano Fabricate</p>
                    </div>
                </div>
