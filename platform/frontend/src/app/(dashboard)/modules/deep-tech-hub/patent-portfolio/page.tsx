...
/* ═══ Deep Tech Hub — Patent Portfolio ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "4266", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "354", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3739", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1706016670", cells: ["DEE-4670", "Patent Portfolio Item 1", "23/11/2026", "€16 770"], status: "active" as const },
    { id: "1706020241", cells: ["DEE-8241", "Patent Portfolio Item 2", "10/6/2026", "€20 341"], status: "pending" as const },
    { id: "1706023812", cells: ["DEE-2812", "Patent Portfolio Item 3", "25/1/2026", "€23 912"], status: "completed" as const },
    { id: "1706027383", cells: ["DEE-6383", "Patent Portfolio Item 4", "12/8/2026", "€27 483"], status: "warning" as const },
    { id: "1706030954", cells: ["DEE-9954", "Patent Portfolio Item 5", "27/3/2026", "€31 054"], status: "active" as const },
];
...
export default function DeepTechHubPatentPortfolioPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Patent Portfolio</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Deep Tech Hub • Patent Portfolio</p>
                    </div>
                </div>
