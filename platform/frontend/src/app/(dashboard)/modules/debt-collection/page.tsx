...
const KPIS = [
    { label: "Total Registos", value: "8161", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2028", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€60K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "-19%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1133231361", cells: ["DEB-6361", "Debt Collection Item 1", "18/10/2026", "€31 461"], status: "active" as const },
    { id: "1133234932", cells: ["DEB-9932", "Debt Collection Item 2", "5/5/2026", "€35 032"], status: "pending" as const },
    { id: "1133238503", cells: ["DEB-4503", "Debt Collection Item 3", "20/12/2026", "€38 603"], status: "completed" as const },
    { id: "1133242074", cells: ["DEB-8074", "Debt Collection Item 4", "7/7/2026", "€42 174"], status: "warning" as const },
    { id: "1133245645", cells: ["DEB-2645", "Debt Collection Item 5", "22/2/2026", "€45 745"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Debt Collection</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Debt Collection</p>
                    </div>
                </div>
