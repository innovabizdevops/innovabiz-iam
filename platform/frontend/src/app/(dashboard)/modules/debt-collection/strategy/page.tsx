...
const ACCENT = "#b91c1c";
const MODULE = "Debt Collection";
const PAGE = "Strategy";
const KPIS = [{"l":"Total Debt Collection","v":"6.682","t":"+14.8%","d":"up"},{"l":"Strategy Ativos","v":"3.338","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"72.1%","t":"+14.1%","d":"up"},{"l":"Score Performance","v":"75","t":"-4.3%","d":"down"}];
const COLS = ["ID","Strategy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Debt Collection #001","Debt Collection #002","925","6.430","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Debt Collection #002","Debt Collection #003","4.537","4.624","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Debt Collection #003","Debt Collection #004","144","4.648","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Debt Collection #004","Debt Collection #005","3.663","8.212","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Debt Collection #005","Debt Collection #001","7.863","8.156","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":378},{"label":"Fev","value":355},{"label":"Mar","value":541},{"label":"Abr","value":535},{"label":"Mai","value":563},{"label":"Jun","value":464},{"label":"Jul","value":430},{"label":"Ago","value":539},{"label":"Set","value":474},{"label":"Out","value":384},{"label":"Nov","value":408},{"label":"Dez","value":686}];
const MX = 686;
