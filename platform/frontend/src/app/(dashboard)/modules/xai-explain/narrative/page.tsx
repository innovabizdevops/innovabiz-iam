...
const ACCENT = "#d97706";
const MODULE = "XAI Explanation Engine";
const PAGE = "Narrative";
const KPIS = [{"l":"ARR (€M)","v":"€27.4M","t":"-0.7%","d":"down"},{"l":"MRR (€)","v":"€15193","t":"-4.1%","d":"down"},{"l":"Churn (%)","v":"68.6%","t":"+13.3%","d":"up"},{"l":"ARPU (€)","v":"€93286","t":"+10.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 1452.94","880","€ 1354.46","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 49727.98","2.298","€ 31120.79","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 44766.43","1.502","€ 10227.13","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 21523.13","2.470","€ 24930.89","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 17458.65","6.051","€ 2802.87","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":760},{"label":"Fev","value":592},{"label":"Mar","value":647},{"label":"Abr","value":841},{"label":"Mai","value":567},{"label":"Jun","value":630},{"label":"Jul","value":732},{"label":"Ago","value":840},{"label":"Set","value":802},{"label":"Out","value":702},{"label":"Nov","value":568},{"label":"Dez","value":836}];
const MX = 841;
