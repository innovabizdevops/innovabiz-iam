...
/* ═══ XAI Explanation Engine — Dashboard ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total Registos", value: "1173", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1009", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€296K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1764577073", cells: ["XAI-2073", "XAI Explanation Engine Item 1", "22/6/2026", "€27 173"], status: "active" as const },
    { id: "1764580644", cells: ["XAI-5644", "XAI Explanation Engine Item 2", "9/1/2026", "€30 744"], status: "pending" as const },
    { id: "1764584215", cells: ["XAI-9215", "XAI Explanation Engine Item 3", "24/8/2026", "€34 315"], status: "completed" as const },
    { id: "1764587786", cells: ["XAI-3786", "XAI Explanation Engine Item 4", "11/3/2026", "€37 886"], status: "warning" as const },
    { id: "1764591357", cells: ["XAI-7357", "XAI Explanation Engine Item 5", "26/10/2026", "€41 457"], status: "active" as const },
];
...
export default function XaiExplanationEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">XAI Explanation Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • XAI Explanation Engine</p>
                    </div>
                </div>
