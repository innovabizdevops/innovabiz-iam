...
export default function VocationalTrainPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Vocational Train</h1><p className="text-sm text-muted-foreground">Vocational Train • iBOS Enterprise</p></div>
