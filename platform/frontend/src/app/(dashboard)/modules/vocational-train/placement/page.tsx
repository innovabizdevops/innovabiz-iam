...
const ACCENT = "#d8b4fe";
const MODULE = "Vocational Training";
const PAGE = "Placement";
const KPIS = [{"l":"Total Vocational Train","v":"776","t":"+2.5%","d":"up"},{"l":"Placement Ativos","v":"243","t":"+13.4%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"91","t":"-3.3%","d":"down"}];
const COLS = ["ID","Placement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vocational Train #001","Vocational Train #002","2.867","1.918","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Vocational Train #002","Vocational Train #003","8.296","7.074","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Vocational Train #003","Vocational Train #004","6.987","8.623","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Vocational Train #004","Vocational Train #005","8.939","7.724","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vocational Train #005","Vocational Train #001","7.718","3.194","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1024},{"label":"Fev","value":773},{"label":"Mar","value":779},{"label":"Abr","value":999},{"label":"Mai","value":916},{"label":"Jun","value":818},{"label":"Jul","value":845},{"label":"Ago","value":745},{"label":"Set","value":803},{"label":"Out","value":876},{"label":"Nov","value":850},{"label":"Dez","value":806}];
const MX = 1024;
