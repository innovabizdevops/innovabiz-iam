...
const PAGE = "Program";
const KPIS = [{"l":"Total Vocational Train","v":"300","t":"+6.5%","d":"up"},{"l":"Program Ativos","v":"4.124","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"89.1%","t":"+10.4%","d":"up"},{"l":"Score Performance","v":"58","t":"-1.5%","d":"down"}];
const COLS = ["ID","Program","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vocational Train #001","Vocational Train #002","3.184","1.997","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Vocational Train #002","Vocational Train #003","6.812","3.058","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Vocational Train #003","Vocational Train #004","1.758","6.908","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Vocational Train #004","Vocational Train #005","8.906","6.618","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vocational Train #005","Vocational Train #001","788","6.819","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":730},{"label":"Mar","value":797},{"label":"Abr","value":729},{"label":"Mai","value":733},{"label":"Jun","value":745},{"label":"Jul","value":663},{"label":"Ago","value":880},{"label":"Set","value":670},{"label":"Out","value":606},{"label":"Nov","value":605},{"label":"Dez","value":674}];
const MX = 880;
