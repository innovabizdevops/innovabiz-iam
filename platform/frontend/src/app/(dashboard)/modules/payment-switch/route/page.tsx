...
const PAGE = "Route";
const KPIS = [{"l":"Total Payment Switch","v":"1.602","t":"-4.9%","d":"down"},{"l":"Route Ativos","v":"8.205","t":"+0.4%","d":"up"},{"l":"Eficiência (%)","v":"85.6%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"93","t":"+11.0%","d":"up"}];
const COLS = ["ID","Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payment Switch #001","Payment Switch #002","4.605","4.120","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Payment Switch #002","Payment Switch #003","3.774","8.269","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Payment Switch #003","Payment Switch #004","2.306","3.242","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Payment Switch #004","Payment Switch #005","5.252","7.830","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payment Switch #005","Payment Switch #001","7.793","3.520","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":357},{"label":"Fev","value":565},{"label":"Mar","value":369},{"label":"Abr","value":679},{"label":"Mai","value":311},{"label":"Jun","value":629},{"label":"Jul","value":684},{"label":"Ago","value":480},{"label":"Set","value":583},{"label":"Out","value":568},{"label":"Nov","value":529},{"label":"Dez","value":616}];
const MX = 684;
