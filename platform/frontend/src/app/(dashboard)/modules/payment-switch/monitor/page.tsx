...
const ACCENT = "#d97706";
const MODULE = "Switch Pagamentos";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Payment Switch","v":"5.576","t":"+8.5%","d":"up"},{"l":"Monitor Ativos","v":"7.785","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"78.1%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"80","t":"+7.7%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payment Switch #001","Payment Switch #002","2.437","1.771","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Payment Switch #002","Payment Switch #003","2.674","7.824","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Payment Switch #003","Payment Switch #004","444","8.449","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Payment Switch #004","Payment Switch #005","2.342","8.489","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payment Switch #005","Payment Switch #001","1.058","352","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":936},{"label":"Fev","value":821},{"label":"Mar","value":606},{"label":"Abr","value":673},{"label":"Mai","value":909},{"label":"Jun","value":701},{"label":"Jul","value":662},{"label":"Ago","value":606},{"label":"Set","value":852},{"label":"Out","value":846},{"label":"Nov","value":865},{"label":"Dez","value":610}];
const MX = 936;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#d97706'}}>RTM</span></h1>
                </div>
