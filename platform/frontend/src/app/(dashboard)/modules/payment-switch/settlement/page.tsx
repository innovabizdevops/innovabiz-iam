...
const KPIS = [{"l":"Total Payment Switch","v":"8.887","t":"+0.9%","d":"up"},{"l":"Settlement Ativos","v":"8.765","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"73.9%","t":"+7.4%","d":"up"},{"l":"Score Performance","v":"57","t":"+5.4%","d":"up"}];
const COLS = ["ID","Settlement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payment Switch #001","Payment Switch #002","6.776","8.648","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Payment Switch #002","Payment Switch #003","4.039","2.519","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Payment Switch #003","Payment Switch #004","3.324","2.547","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Payment Switch #004","Payment Switch #005","5.007","2.280","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payment Switch #005","Payment Switch #001","6.446","7.635","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":629},{"label":"Mar","value":479},{"label":"Abr","value":544},{"label":"Mai","value":704},{"label":"Jun","value":511},{"label":"Jul","value":506},{"label":"Ago","value":552},{"label":"Set","value":729},{"label":"Out","value":725},{"label":"Nov","value":741},{"label":"Dez","value":546}];
const MX = 741;
