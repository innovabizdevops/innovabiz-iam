...
const KPIS = [{"l":"Utilizadores Ativos","v":"7.395","t":"+13.5%","d":"up"},{"l":"Sessões/Dia","v":"1191","t":"-0.5%","d":"down"},{"l":"MFA Adoção (%)","v":"87.4%","t":"+7.1%","d":"up"},{"l":"Tentativas Bloqueadas","v":"8.788","t":"+14.7%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","7.264","1.386","3.501","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.164","1.835","1.522","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.004","8.723","5.598","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","5.535","938","1.698","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","2.323","917","2.685","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":950},{"label":"Mar","value":942},{"label":"Abr","value":647},{"label":"Mai","value":815},{"label":"Jun","value":962},{"label":"Jul","value":962},{"label":"Ago","value":669},{"label":"Set","value":957},{"label":"Out","value":732},{"label":"Nov","value":923},{"label":"Dez","value":935}];
const MX = 962;
