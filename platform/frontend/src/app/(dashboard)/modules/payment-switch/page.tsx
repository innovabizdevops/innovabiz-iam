...
/* ═══ Switch Pagamentos — Dashboard ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total Registos", value: "9486", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4587", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€405K", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1020095486", cells: ["PAY-9486", "Switch Pagamentos Item 1", "19/3/2026", "€45 586"], status: "active" as const },
    { id: "1020099057", cells: ["PAY-4057", "Switch Pagamentos Item 2", "6/10/2026", "€49 157"], status: "pending" as const },
    { id: "1020102628", cells: ["PAY-7628", "Switch Pagamentos Item 3", "21/5/2026", "€2728"], status: "completed" as const },
    { id: "1020106199", cells: ["PAY-2199", "Switch Pagamentos Item 4", "8/12/2026", "€6299"], status: "warning" as const },
    { id: "1020109770", cells: ["PAY-5770", "Switch Pagamentos Item 5", "23/7/2026", "€9870"], status: "active" as const },
];
...
export default function SwitchPagamentosPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Switch Pagamentos</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Switch Pagamentos</p>
                    </div>
                </div>
