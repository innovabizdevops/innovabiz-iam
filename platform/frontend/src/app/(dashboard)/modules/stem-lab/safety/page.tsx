...
const PAGE = "Safety";
const KPIS = [{"l":"Total Stem Lab","v":"1.336","t":"+13.9%","d":"up"},{"l":"Safety Ativos","v":"4.168","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"93.3%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"69","t":"+12.2%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stem Lab #001","Stem Lab #002","6.040","482","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Stem Lab #002","Stem Lab #003","2.864","2.528","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Stem Lab #003","Stem Lab #004","1.650","4.817","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Stem Lab #004","Stem Lab #005","8.678","3.080","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stem Lab #005","Stem Lab #001","900","5.764","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":467},{"label":"Fev","value":786},{"label":"Mar","value":728},{"label":"Abr","value":788},{"label":"Mai","value":736},{"label":"Jun","value":603},{"label":"Jul","value":687},{"label":"Ago","value":485},{"label":"Set","value":691},{"label":"Out","value":447},{"label":"Nov","value":650},{"label":"Dez","value":553}];
const MX = 788;
