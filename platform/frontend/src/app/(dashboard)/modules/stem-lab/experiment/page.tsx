...
const KPIS = [{"l":"Total Stem Lab","v":"174","t":"+16.6%","d":"up"},{"l":"Experiment Ativos","v":"6.019","t":"+-0.0%","d":"up"},{"l":"Eficiência (%)","v":"67.4%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"83","t":"+9.9%","d":"up"}];
const COLS = ["ID","Experiment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stem Lab #001","Stem Lab #002","498","3.885","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Stem Lab #002","Stem Lab #003","5.841","4.793","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Stem Lab #003","Stem Lab #004","878","7.647","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Stem Lab #004","Stem Lab #005","8.393","3.430","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stem Lab #005","Stem Lab #001","7.439","2.526","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":566},{"label":"Mar","value":938},{"label":"Abr","value":711},{"label":"Mai","value":618},{"label":"Jun","value":723},{"label":"Jul","value":567},{"label":"Ago","value":597},{"label":"Set","value":640},{"label":"Out","value":551},{"label":"Nov","value":693},{"label":"Dez","value":731}];
const MX = 938;
