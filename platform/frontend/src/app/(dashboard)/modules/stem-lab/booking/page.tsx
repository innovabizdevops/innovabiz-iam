...
const ACCENT = "#6366f1";
const MODULE = "STEM Laboratory";
const PAGE = "Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"5.386","t":"+15.0%","d":"up"},{"l":"RevPAR (€)","v":"€97335","t":"+1.9%","d":"up"},{"l":"Ocupação (%)","v":"91.8%","t":"+4.3%","d":"up"},{"l":"Guest Satisfaction","v":"3.906","t":"+9.2%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.386","2026-03-11","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","559","2026-02-17","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.001","2026-02-05","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.582","2026-03-03","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.634","2026-01-28","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":600},{"label":"Mar","value":636},{"label":"Abr","value":459},{"label":"Mai","value":559},{"label":"Jun","value":527},{"label":"Jul","value":756},{"label":"Ago","value":425},{"label":"Set","value":411},{"label":"Out","value":553},{"label":"Nov","value":564},{"label":"Dez","value":603}];
const MX = 767;
