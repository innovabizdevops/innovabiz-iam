...
const PAGE = "Tenant";
const KPIS = [{"l":"Configurações","v":"7.955","t":"-1.7%","d":"down"},{"l":"Últimas Alterações","v":"4.133","t":"+5.8%","d":"up"},{"l":"Ambientes","v":"8.120","t":"+15.9%","d":"up"},{"l":"Versão Config","v":"2.709","t":"+1.4%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 22907.52","167","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 39914.42","3.427","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 1505.96","8.067","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 44957.09","365","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 2062.41","1.721","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":694},{"label":"Fev","value":956},{"label":"Mar","value":928},{"label":"Abr","value":676},{"label":"Mai","value":896},{"label":"Jun","value":689},{"label":"Jul","value":765},{"label":"Ago","value":764},{"label":"Set","value":935},{"label":"Out","value":799},{"label":"Nov","value":670},{"label":"Dez","value":965}];
const MX = 965;
