...
const KPIS = [{"l":"Dashboards Ativos","v":"6.658","t":"+17.2%","d":"up"},{"l":"Queries/Dia","v":"3616","t":"+11.8%","d":"up"},{"l":"Dados Processados (GB)","v":"7.375","t":"+15.2%","d":"up"},{"l":"Utilizadores Analytics","v":"7.462","t":"-2.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1500","2026-01-26","5.431","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","903","2026-03-03","1.206","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4122","2026-01-26","6.086","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","878","2026-03-08","7.005","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2259","2026-02-04","2.651","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":472},{"label":"Mar","value":607},{"label":"Abr","value":642},{"label":"Mai","value":797},{"label":"Jun","value":581},{"label":"Jul","value":533},{"label":"Ago","value":537},{"label":"Set","value":661},{"label":"Out","value":542},{"label":"Nov","value":687},{"label":"Dez","value":601}];
const MX = 797;
