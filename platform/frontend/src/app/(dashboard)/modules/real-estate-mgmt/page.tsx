...
const KPIS = [
    { label: "Total Registos", value: "2662", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4124", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€267K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "-20%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2093595162", cells: ["REA-7162", "Real Estate Management Item 1", "23/7/2026", "€45 262"], status: "active" as const },
    { id: "2093598733", cells: ["REA-1733", "Real Estate Management Item 2", "10/2/2026", "€48 833"], status: "pending" as const },
    { id: "2093602304", cells: ["REA-5304", "Real Estate Management Item 3", "25/9/2026", "€2404"], status: "completed" as const },
    { id: "2093605875", cells: ["REA-8875", "Real Estate Management Item 4", "12/4/2026", "€5975"], status: "warning" as const },
    { id: "2093609446", cells: ["REA-3446", "Real Estate Management Item 5", "27/11/2026", "€9546"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Real Estate Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Real Estate Management</p>
                    </div>
                </div>
