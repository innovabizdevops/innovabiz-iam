...
const PAGE = "Queue";
const KPIS = [{"l":"Total Ev Charging Net","v":"4.500","t":"+15.6%","d":"up"},{"l":"Queue Ativos","v":"5.560","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"83.6%","t":"+6.8%","d":"up"},{"l":"Score Performance","v":"75","t":"+2.7%","d":"up"}];
const COLS = ["ID","Queue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Charging Net #001","Ev Charging Net #002","6.270","7.245","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Charging Net #002","Ev Charging Net #003","5.217","8.227","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Charging Net #003","Ev Charging Net #004","2.366","5.564","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Charging Net #004","Ev Charging Net #005","1.586","1.026","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Charging Net #005","Ev Charging Net #001","4.870","6.185","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":242},{"label":"Fev","value":351},{"label":"Mar","value":373},{"label":"Abr","value":329},{"label":"Mai","value":216},{"label":"Jun","value":238},{"label":"Jul","value":600},{"label":"Ago","value":443},{"label":"Set","value":503},{"label":"Out","value":444},{"label":"Nov","value":387},{"label":"Dez","value":573}];
const MX = 600;
