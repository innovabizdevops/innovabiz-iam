...
const PAGE = "V2G";
const KPIS = [{"l":"Total Ev Charging Net","v":"5.534","t":"+4.4%","d":"up"},{"l":"V2G Ativos","v":"8.864","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"75.8%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"93","t":"+11.0%","d":"up"}];
const COLS = ["ID","V2G","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Charging Net #001","Ev Charging Net #002","6.007","181","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Charging Net #002","Ev Charging Net #003","4.527","5.208","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Charging Net #003","Ev Charging Net #004","2.473","6.626","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Charging Net #004","Ev Charging Net #005","5.760","1.439","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Charging Net #005","Ev Charging Net #001","4.088","2.868","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":550},{"label":"Fev","value":379},{"label":"Mar","value":484},{"label":"Abr","value":459},{"label":"Mai","value":293},{"label":"Jun","value":441},{"label":"Jul","value":446},{"label":"Ago","value":479},{"label":"Set","value":360},{"label":"Out","value":432},{"label":"Nov","value":411},{"label":"Dez","value":611}];
const MX = 611;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#eab308'}}>Smart</span></h1>
                </div>
