...
const KPIS = [{"l":"Total Ev Charging Net","v":"1.594","t":"+2.5%","d":"up"},{"l":"Station Map Ativos","v":"995","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"87.4%","t":"+0.0%","d":"up"},{"l":"Score Performance","v":"65","t":"+13.1%","d":"up"}];
const COLS = ["ID","Station Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Charging Net #001","Ev Charging Net #002","5.537","4.075","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Charging Net #002","Ev Charging Net #003","7.185","6.322","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Charging Net #003","Ev Charging Net #004","4.970","1.852","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Charging Net #004","Ev Charging Net #005","2.743","7.802","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Charging Net #005","Ev Charging Net #001","5.565","4.472","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":642},{"label":"Mar","value":669},{"label":"Abr","value":775},{"label":"Mai","value":663},{"label":"Jun","value":906},{"label":"Jul","value":792},{"label":"Ago","value":922},{"label":"Set","value":751},{"label":"Out","value":839},{"label":"Nov","value":709},{"label":"Dez","value":651}];
const MX = 922;
