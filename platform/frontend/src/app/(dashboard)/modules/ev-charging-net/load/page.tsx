...
const KPIS = [{"l":"Total Ev Charging Net","v":"4.957","t":"+2.6%","d":"up"},{"l":"Load Balance Ativos","v":"6.986","t":"+0.7%","d":"up"},{"l":"Eficiência (%)","v":"82.8%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"56","t":"+15.2%","d":"up"}];
const COLS = ["ID","Load Balance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Charging Net #001","Ev Charging Net #002","3.713","3.244","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Charging Net #002","Ev Charging Net #003","8.266","1.908","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Charging Net #003","Ev Charging Net #004","4.213","4.092","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Charging Net #004","Ev Charging Net #005","3.279","5.643","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Charging Net #005","Ev Charging Net #001","4.182","5.204","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":791},{"label":"Mar","value":978},{"label":"Abr","value":830},{"label":"Mai","value":630},{"label":"Jun","value":935},{"label":"Jul","value":642},{"label":"Ago","value":623},{"label":"Set","value":837},{"label":"Out","value":829},{"label":"Nov","value":939},{"label":"Dez","value":983}];
const MX = 983;
