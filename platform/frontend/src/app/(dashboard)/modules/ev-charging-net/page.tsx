...
export default function EvChargingNetPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Ev Charging Net</h1><p className="text-sm text-muted-foreground">Ev Charging Net • iBOS Enterprise</p></div>
