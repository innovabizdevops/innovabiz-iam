...
const KPIS = [{"l":"Formulários Ativos","v":"3.136","t":"+12.1%","d":"up"},{"l":"Submissões/Dia","v":"4958","t":"+14.4%","d":"up"},{"l":"Documentos Gerados","v":"3.779","t":"+12.0%","d":"up"},{"l":"Templates","v":"8.171","t":"-1.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.113","2026-02-07","6.620","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.021","2026-03-11","3.803","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.099","2026-01-05","5.220","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.122","2026-02-09","8.489","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.927","2026-03-28","599","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":479},{"label":"Mar","value":488},{"label":"Abr","value":467},{"label":"Mai","value":284},{"label":"Jun","value":484},{"label":"Jul","value":414},{"label":"Ago","value":355},{"label":"Set","value":655},{"label":"Out","value":322},{"label":"Nov","value":597},{"label":"Dez","value":550}];
const MX = 655;
