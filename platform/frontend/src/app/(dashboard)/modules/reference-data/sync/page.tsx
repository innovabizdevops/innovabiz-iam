...
const PAGE = "Cross-System Sync";
const KPIS = [{"l":"Integrações Ativas","v":"312","t":"+5.8%","d":"up"},{"l":"Chamadas/Hora","v":"2712","t":"+12.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.4%","t":"-3.3%","d":"down"},{"l":"Latência Média (ms)","v":"194ms","t":"+12.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.341","7.946","78.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.591","9.100","91.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.197","3.336","79.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.205","162","98.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.398","8.474","93.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":543},{"label":"Mar","value":603},{"label":"Abr","value":682},{"label":"Mai","value":479},{"label":"Jun","value":759},{"label":"Jul","value":398},{"label":"Ago","value":640},{"label":"Set","value":415},{"label":"Out","value":643},{"label":"Nov","value":747},{"label":"Dez","value":695}];
const MX = 775;
