...
const ACCENT = "#1e40af";
const MODULE = "Space Finance";
const PAGE = "Mission Insure";
const KPIS = [{"l":"Quartos Ocupados","v":"896","t":"+4.0%","d":"up"},{"l":"RevPAR (€)","v":"€17514","t":"+10.1%","d":"up"},{"l":"Ocupação (%)","v":"65.4%","t":"-3.8%","d":"down"},{"l":"Guest Satisfaction","v":"6.874","t":"-5.2%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.465","2026-03-13","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","2.287","2026-02-24","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.974","2026-01-05","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","8.905","2026-03-06","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.374","2026-02-28","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":432},{"label":"Fev","value":529},{"label":"Mar","value":588},{"label":"Abr","value":369},{"label":"Mai","value":474},{"label":"Jun","value":518},{"label":"Jul","value":492},{"label":"Ago","value":394},{"label":"Set","value":631},{"label":"Out","value":524},{"label":"Nov","value":360},{"label":"Dez","value":436}];
const MX = 631;
