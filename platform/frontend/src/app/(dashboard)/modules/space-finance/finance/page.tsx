...
const PAGE = "Launch Finance";
const KPIS = [{"l":"Quartos Ocupados","v":"1.190","t":"+15.5%","d":"up"},{"l":"RevPAR (€)","v":"€77100","t":"+10.6%","d":"up"},{"l":"Ocupação (%)","v":"85.5%","t":"+6.1%","d":"up"},{"l":"Guest Satisfaction","v":"4.734","t":"+15.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.934","2026-03-25","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.291","2026-02-15","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","4.392","2026-02-14","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.956","2026-01-10","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.092","2026-02-27","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":691},{"label":"Mar","value":793},{"label":"Abr","value":813},{"label":"Mai","value":735},{"label":"Jun","value":651},{"label":"Jul","value":753},{"label":"Ago","value":459},{"label":"Set","value":772},{"label":"Out","value":664},{"label":"Nov","value":473},{"label":"Dez","value":577}];
const MX = 813;
