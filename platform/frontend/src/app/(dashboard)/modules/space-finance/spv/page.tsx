...
const PAGE = "SPV Structure";
const KPIS = [{"l":"Quartos Ocupados","v":"947","t":"+3.7%","d":"up"},{"l":"RevPAR (€)","v":"€50247","t":"+9.7%","d":"up"},{"l":"Ocupação (%)","v":"92.9%","t":"-2.2%","d":"down"},{"l":"Guest Satisfaction","v":"4.744","t":"+10.6%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.734","2026-01-23","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.897","2026-03-17","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.897","2026-01-27","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.812","2026-01-06","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.054","2026-03-05","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":431},{"label":"Fev","value":514},{"label":"Mar","value":548},{"label":"Abr","value":710},{"label":"Mai","value":456},{"label":"Jun","value":603},{"label":"Jul","value":423},{"label":"Ago","value":770},{"label":"Set","value":730},{"label":"Out","value":779},{"label":"Nov","value":537},{"label":"Dez","value":569}];
const MX = 779;
