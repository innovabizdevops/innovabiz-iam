...
const PAGE = "VC Deal";
const KPIS = [{"l":"Quartos Ocupados","v":"2.939","t":"-1.7%","d":"down"},{"l":"RevPAR (€)","v":"€18061","t":"+12.8%","d":"up"},{"l":"Ocupação (%)","v":"66.3%","t":"+13.9%","d":"up"},{"l":"Guest Satisfaction","v":"6.281","t":"+16.0%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.003","2026-03-22","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","5.084","2026-03-15","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.956","2026-03-13","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","232","2026-02-19","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","290","2026-02-26","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":925},{"label":"Mar","value":733},{"label":"Abr","value":935},{"label":"Mai","value":936},{"label":"Jun","value":682},{"label":"Jul","value":925},{"label":"Ago","value":775},{"label":"Set","value":937},{"label":"Out","value":604},{"label":"Nov","value":628},{"label":"Dez","value":654}];
const MX = 937;
