...
const KPIS = [{"l":"ARR (€M)","v":"€34.8M","t":"+9.8%","d":"up"},{"l":"MRR (€)","v":"€42877","t":"+9.5%","d":"up"},{"l":"Churn (%)","v":"90.8%","t":"+16.9%","d":"up"},{"l":"ARPU (€)","v":"€28149","t":"+4.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 2678.18","7.168","€ 11387.69","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 24070.47","5.407","€ 37098.74","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 28583.57","6.474","€ 29671.10","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 21723.67","7.896","€ 37711.39","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 29583.43","7.264","€ 23924.82","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":625},{"label":"Mar","value":665},{"label":"Abr","value":714},{"label":"Mai","value":711},{"label":"Jun","value":519},{"label":"Jul","value":812},{"label":"Ago","value":530},{"label":"Set","value":696},{"label":"Out","value":531},{"label":"Nov","value":753},{"label":"Dez","value":554}];
const MX = 812;
