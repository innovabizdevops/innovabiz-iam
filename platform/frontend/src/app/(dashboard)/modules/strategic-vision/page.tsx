...
/* ═══ Strategic Vision & Mission — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "5888", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2730", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€400K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1426239388", cells: ["STR-1388", "Strategic Vision & Mission Item 1", "1/5/2026", "€39 488"], status: "active" as const },
    { id: "1426242959", cells: ["STR-4959", "Strategic Vision & Mission Item 2", "16/12/2026", "€43 059"], status: "pending" as const },
    { id: "1426246530", cells: ["STR-8530", "Strategic Vision & Mission Item 3", "3/7/2026", "€46 630"], status: "completed" as const },
    { id: "1426250101", cells: ["STR-3101", "Strategic Vision & Mission Item 4", "18/2/2026", "€201"], status: "warning" as const },
    { id: "1426253672", cells: ["STR-6672", "Strategic Vision & Mission Item 5", "5/9/2026", "€3772"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 48 }, { label: "Fev", value: 57 }, { label: "Mar", value: 66 }, { label: "Abr", value: 75 }, { label: "Mai", value: 84 }, { label: "Jun", value: 93 }];
...
export default function StrategicVisionMissionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Strategic Vision & Mission</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Strategic Vision & Mission</p>
                    </div>
                </div>
