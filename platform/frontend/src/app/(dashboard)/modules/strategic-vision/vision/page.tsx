...
const PAGE = "Vision Board";
const KPIS = [{"l":"Teams Ativos","v":"7.129","t":"+5.7%","d":"up"},{"l":"Reuniões/Semana","v":"3256","t":"-2.3%","d":"down"},{"l":"Mensagens/Dia","v":"3056","t":"+11.4%","d":"up"},{"l":"Ficheiros Partilhados","v":"157","t":"-1.3%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","402","3805","8.962","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.572","1704","9.074","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","3.058","1550","4.795","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.637","2908","5.419","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","7.918","2203","7.232","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":811},{"label":"Mar","value":982},{"label":"Abr","value":718},{"label":"Mai","value":698},{"label":"Jun","value":716},{"label":"Jul","value":656},{"label":"Ago","value":823},{"label":"Set","value":911},{"label":"Out","value":722},{"label":"Nov","value":721},{"label":"Dez","value":753}];
const MX = 982;
