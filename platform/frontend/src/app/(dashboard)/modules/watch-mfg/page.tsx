...
/* ═══ Watch Manufacturing — Dashboard ═══ */

const ACCENT = "#713f12";

const KPIS = [
    { label: "Total Registos", value: "4753", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2849", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€425K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "-11%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1015635753", cells: ["WAT-4753", "Watch Manufacturing Item 1", "14/10/2026", "€35 853"], status: "active" as const },
    { id: "1015639324", cells: ["WAT-8324", "Watch Manufacturing Item 2", "1/5/2026", "€39 424"], status: "pending" as const },
    { id: "1015642895", cells: ["WAT-2895", "Watch Manufacturing Item 3", "16/12/2026", "€42 995"], status: "completed" as const },
    { id: "1015646466", cells: ["WAT-6466", "Watch Manufacturing Item 4", "3/7/2026", "€46 566"], status: "warning" as const },
    { id: "1015650037", cells: ["WAT-1037", "Watch Manufacturing Item 5", "18/2/2026", "€137"], status: "active" as const },
];
...
export default function WatchManufacturingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Watch Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Watch Manufacturing</p>
                    </div>
                </div>
