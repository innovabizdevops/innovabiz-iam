...
const ACCENT = "#713f12";
const MODULE = "Watch Manufacturing";
const PAGE = "Movement";
const KPIS = [{"l":"Total Watch Mfg","v":"7.322","t":"+11.0%","d":"up"},{"l":"Movement Ativos","v":"6.279","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"83.6%","t":"-0.2%","d":"down"},{"l":"Score Performance","v":"81","t":"+2.9%","d":"up"}];
const COLS = ["ID","Movement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Watch Mfg #001","Watch Mfg #002","7.915","2.910","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Watch Mfg #002","Watch Mfg #003","2.573","7.650","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Watch Mfg #003","Watch Mfg #004","347","4.453","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Watch Mfg #004","Watch Mfg #005","8.133","4.953","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Watch Mfg #005","Watch Mfg #001","331","1.869","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":580},{"label":"Mar","value":608},{"label":"Abr","value":299},{"label":"Mai","value":493},{"label":"Jun","value":483},{"label":"Jul","value":642},{"label":"Ago","value":612},{"label":"Set","value":578},{"label":"Out","value":440},{"label":"Nov","value":488},{"label":"Dez","value":341}];
const MX = 647;
