...
export default function PoliceRmsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Police Rms</h1><p className="text-sm text-muted-foreground">Police Rms • iBOS Enterprise</p></div>
