...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"8.436","t":"+3.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"69.6%","t":"+14.6%","d":"up"},{"l":"MTTR (h)","v":"205h","t":"+10.8%","d":"up"},{"l":"Satisfação (%)","v":"93.5%","t":"+12.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.280","7.587","6.739","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.700","3.455","5.541","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.566","1.394","5.400","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.679","8.592","5.245","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.637","2.773","8.798","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":252},{"label":"Mar","value":367},{"label":"Abr","value":530},{"label":"Mai","value":555},{"label":"Jun","value":257},{"label":"Jul","value":418},{"label":"Ago","value":616},{"label":"Set","value":305},{"label":"Out","value":479},{"label":"Nov","value":309},{"label":"Dez","value":587}];
const MX = 616;
