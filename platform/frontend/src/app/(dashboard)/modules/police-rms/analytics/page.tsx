...
const ACCENT = "#6366f1";
const MODULE = "Police RMS";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"7.773","t":"+15.1%","d":"up"},{"l":"Queries/Dia","v":"1058","t":"+3.5%","d":"up"},{"l":"Dados Processados (GB)","v":"7.773","t":"+4.5%","d":"up"},{"l":"Utilizadores Analytics","v":"5.772","t":"+12.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1877","2026-01-17","5.523","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3665","2026-02-18","6.129","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2803","2026-02-12","8.149","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2935","2026-02-20","7.376","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","773","2026-01-27","7.990","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":558},{"label":"Mar","value":517},{"label":"Abr","value":357},{"label":"Mai","value":546},{"label":"Jun","value":321},{"label":"Jul","value":281},{"label":"Ago","value":425},{"label":"Set","value":418},{"label":"Out","value":266},{"label":"Nov","value":449},{"label":"Dez","value":613}];
const MX = 613;
