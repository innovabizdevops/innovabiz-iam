...
const ACCENT = "#ec4899";
const MODULE = "Aircraft Leasing";
const PAGE = "Lease Contract";
const KPIS = [{"l":"Contratos Ativos","v":"3.772","t":"+17.8%","d":"up"},{"l":"Valor Total (€M)","v":"€35.6M","t":"-3.6%","d":"down"},{"l":"Renovações Próx. 30d","v":"8.688","t":"+13.0%","d":"up"},{"l":"Obrigações Pendentes","v":"6.285","t":"-0.4%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 27545.54","2026-01-21","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 43494.15","2026-03-04","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 1567.23","2026-02-26","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 33216.75","2026-03-06","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 47463.89","2026-03-06","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":741},{"label":"Mar","value":544},{"label":"Abr","value":881},{"label":"Mai","value":564},{"label":"Jun","value":732},{"label":"Jul","value":800},{"label":"Ago","value":690},{"label":"Set","value":852},{"label":"Out","value":869},{"label":"Nov","value":904},{"label":"Dez","value":925}];
const MX = 925;
