...
const PAGE = "Maintenance Reserve";
const KPIS = [{"l":"Total Aircraft Lease","v":"840","t":"+16.7%","d":"up"},{"l":"Maintenance Reserve Ativos","v":"6.746","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"93.1%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"64","t":"+3.4%","d":"up"}];
const COLS = ["ID","Maintenance Reserve","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aircraft Lease #001","Aircraft Lease #002","4.476","2.245","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Aircraft Lease #002","Aircraft Lease #003","1.677","3.115","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Aircraft Lease #003","Aircraft Lease #004","907","1.813","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Aircraft Lease #004","Aircraft Lease #005","2.726","549","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aircraft Lease #005","Aircraft Lease #001","2.978","6.535","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":375},{"label":"Mar","value":348},{"label":"Abr","value":240},{"label":"Mai","value":373},{"label":"Jun","value":321},{"label":"Jul","value":399},{"label":"Ago","value":613},{"label":"Set","value":364},{"label":"Out","value":240},{"label":"Nov","value":425},{"label":"Dez","value":274}];
const MX = 613;
