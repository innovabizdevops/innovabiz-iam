...
const PAGE = "Redelivery";
const KPIS = [{"l":"Total Aircraft Lease","v":"7.584","t":"+13.0%","d":"up"},{"l":"Redelivery Ativos","v":"642","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"94.9%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"82","t":"-3.2%","d":"down"}];
const COLS = ["ID","Redelivery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aircraft Lease #001","Aircraft Lease #002","2.001","4.086","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Aircraft Lease #002","Aircraft Lease #003","6.408","5.230","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Aircraft Lease #003","Aircraft Lease #004","849","6.518","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Aircraft Lease #004","Aircraft Lease #005","7.864","8.329","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aircraft Lease #005","Aircraft Lease #001","4.732","2.279","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":958},{"label":"Fev","value":689},{"label":"Mar","value":810},{"label":"Abr","value":1029},{"label":"Mai","value":938},{"label":"Jun","value":766},{"label":"Jul","value":692},{"label":"Ago","value":1030},{"label":"Set","value":1056},{"label":"Out","value":1009},{"label":"Nov","value":1020},{"label":"Dez","value":1026}];
const MX = 1056;
...
export default function RedeliverPage() {
    return (
