...
const KPIS = [{"l":"Total Telecom Field","v":"6.729","t":"-4.0%","d":"down"},{"l":"Inventory Ativos","v":"3.174","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"77.0%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"59","t":"+11.5%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Field #001","Telecom Field #002","7.516","6.998","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Field #002","Telecom Field #003","2.227","7.876","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Field #003","Telecom Field #004","4.641","246","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Field #004","Telecom Field #005","1.494","6.695","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Field #005","Telecom Field #001","3.767","8.221","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":879},{"label":"Fev","value":858},{"label":"Mar","value":786},{"label":"Abr","value":762},{"label":"Mai","value":968},{"label":"Jun","value":988},{"label":"Jul","value":899},{"label":"Ago","value":953},{"label":"Set","value":746},{"label":"Out","value":1051},{"label":"Nov","value":735},{"label":"Dez","value":1013}];
const MX = 1051;
