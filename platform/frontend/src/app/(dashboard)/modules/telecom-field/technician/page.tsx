...
const ACCENT = "#c2410c";
const MODULE = "Telecom Field Service";
const PAGE = "Technician";
const KPIS = [{"l":"Total Telecom Field","v":"6.330","t":"-2.0%","d":"down"},{"l":"Technician Ativos","v":"9.063","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"80.5%","t":"+4.3%","d":"up"},{"l":"Score Performance","v":"80","t":"+1.7%","d":"up"}];
const COLS = ["ID","Technician","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Field #001","Telecom Field #002","5.608","4.769","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Field #002","Telecom Field #003","2.315","4.626","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Field #003","Telecom Field #004","1.479","3.622","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Field #004","Telecom Field #005","2.398","2.350","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Field #005","Telecom Field #001","848","1.632","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":727},{"label":"Mar","value":647},{"label":"Abr","value":683},{"label":"Mai","value":578},{"label":"Jun","value":528},{"label":"Jul","value":836},{"label":"Ago","value":485},{"label":"Set","value":772},{"label":"Out","value":700},{"label":"Nov","value":587},{"label":"Dez","value":506}];
const MX = 836;
