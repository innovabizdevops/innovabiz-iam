...
const KPIS = [{"l":"Total Telecom Field","v":"3.982","t":"-4.6%","d":"down"},{"l":"Work Order Ativos","v":"4.866","t":"+1.2%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"63","t":"+0.4%","d":"up"}];
const COLS = ["ID","Work Order","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Field #001","Telecom Field #002","2.421","3.579","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Field #002","Telecom Field #003","5.969","8.390","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Field #003","Telecom Field #004","949","246","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Field #004","Telecom Field #005","1.027","4.352","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Field #005","Telecom Field #001","1.847","2.069","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":544},{"label":"Mar","value":534},{"label":"Abr","value":613},{"label":"Mai","value":864},{"label":"Jun","value":504},{"label":"Jul","value":653},{"label":"Ago","value":836},{"label":"Set","value":716},{"label":"Out","value":610},{"label":"Nov","value":710},{"label":"Dez","value":737}];
const MX = 864;
