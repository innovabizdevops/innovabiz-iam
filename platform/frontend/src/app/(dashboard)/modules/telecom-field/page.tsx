...
export default function TelecomFieldPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Telecom Field</h1><p className="text-sm text-muted-foreground">Telecom Field • iBOS Enterprise</p></div>
            </div>
