...
const ACCENT = "#d97706";
const MODULE = "XAI Model Audit Platform";
const PAGE = "Robustness";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.138","t":"+3.9%","d":"up"},{"l":"NC Abertas","v":"1.757","t":"+8.0%","d":"up"},{"l":"Conformidade (%)","v":"93.5%","t":"+10.1%","d":"up"},{"l":"CAPAs Pendentes","v":"855","t":"+15.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.715","85.0%","5.840","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.576","73.3%","6.341","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.233","89.4%","7.366","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","138","85.8%","5.411","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.935","89.4%","5.900","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":805},{"label":"Mar","value":727},{"label":"Abr","value":455},{"label":"Mai","value":562},{"label":"Jun","value":777},{"label":"Jul","value":411},{"label":"Ago","value":679},{"label":"Set","value":447},{"label":"Out","value":606},{"label":"Nov","value":695},{"label":"Dez","value":806}];
const MX = 806;
