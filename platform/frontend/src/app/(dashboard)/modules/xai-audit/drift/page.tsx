...
const PAGE = "Drift";
const KPIS = [{"l":"Auditorias Realizadas","v":"219","t":"-5.3%","d":"down"},{"l":"NC Abertas","v":"4.285","t":"+16.5%","d":"up"},{"l":"Conformidade (%)","v":"81.0%","t":"-5.1%","d":"down"},{"l":"CAPAs Pendentes","v":"5.441","t":"+6.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.102","83.8%","4.511","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.563","95.3%","8.193","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.535","85.7%","7.550","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.007","87.0%","2.895","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.259","88.6%","6.656","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":411},{"label":"Fev","value":641},{"label":"Mar","value":562},{"label":"Abr","value":620},{"label":"Mai","value":669},{"label":"Jun","value":496},{"label":"Jul","value":625},{"label":"Ago","value":510},{"label":"Set","value":396},{"label":"Out","value":711},{"label":"Nov","value":527},{"label":"Dez","value":454}];
const MX = 711;
