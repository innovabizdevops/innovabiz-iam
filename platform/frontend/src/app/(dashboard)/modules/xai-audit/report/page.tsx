...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.351","t":"-4.7%","d":"down"},{"l":"NC Abertas","v":"7.351","t":"+8.2%","d":"up"},{"l":"Conformidade (%)","v":"91.5%","t":"+11.3%","d":"up"},{"l":"CAPAs Pendentes","v":"2.694","t":"+0.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.837","86.6%","4.898","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.764","88.6%","1.219","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.348","89.7%","5.650","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.335","85.7%","4.424","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.871","97.9%","3.334","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":310},{"label":"Fev","value":400},{"label":"Mar","value":505},{"label":"Abr","value":595},{"label":"Mai","value":443},{"label":"Jun","value":510},{"label":"Jul","value":394},{"label":"Ago","value":481},{"label":"Set","value":266},{"label":"Out","value":388},{"label":"Nov","value":487},{"label":"Dez","value":389}];
const MX = 595;
