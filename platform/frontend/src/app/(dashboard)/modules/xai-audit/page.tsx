...
/* ═══ XAI Model Audit Platform — Dashboard ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total Registos", value: "295", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1019", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€114K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "-3%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "628669995", cells: ["XAI-2995", "XAI Model Audit Platform Item 1", "24/4/2026", "€20 095"], status: "active" as const },
    { id: "628673566", cells: ["XAI-6566", "XAI Model Audit Platform Item 2", "11/11/2026", "€23 666"], status: "pending" as const },
    { id: "628677137", cells: ["XAI-1137", "XAI Model Audit Platform Item 3", "26/6/2026", "€27 237"], status: "completed" as const },
    { id: "628680708", cells: ["XAI-4708", "XAI Model Audit Platform Item 4", "13/1/2026", "€30 808"], status: "warning" as const },
    { id: "628684279", cells: ["XAI-8279", "XAI Model Audit Platform Item 5", "28/8/2026", "€34 379"], status: "active" as const },
];
...
export default function XaiModelAuditPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">XAI Model Audit Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • XAI Model Audit Platform</p>
                    </div>
                </div>
