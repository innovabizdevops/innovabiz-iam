...
const PAGE = "Fairness";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.044","t":"-2.2%","d":"down"},{"l":"NC Abertas","v":"3.190","t":"-4.4%","d":"down"},{"l":"Conformidade (%)","v":"91.0%","t":"+8.7%","d":"up"},{"l":"CAPAs Pendentes","v":"8.568","t":"+1.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","606","89.8%","372","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.028","76.9%","6.152","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.095","99.1%","1.452","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.915","97.4%","1.068","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.514","81.9%","7.058","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":678},{"label":"Mar","value":737},{"label":"Abr","value":591},{"label":"Mai","value":562},{"label":"Jun","value":652},{"label":"Jul","value":573},{"label":"Ago","value":821},{"label":"Set","value":478},{"label":"Out","value":579},{"label":"Nov","value":841},{"label":"Dez","value":762}];
const MX = 841;
