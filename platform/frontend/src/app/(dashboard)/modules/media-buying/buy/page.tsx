...
const PAGE = "Buy";
const KPIS = [{"l":"Integrações Ativas","v":"8.861","t":"+17.9%","d":"up"},{"l":"Chamadas/Hora","v":"4605","t":"-1.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"93.0%","t":"+5.4%","d":"up"},{"l":"Latência Média (ms)","v":"170ms","t":"+13.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.705","4.232","78.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.020","5.685","89.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.310","5.538","82.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.258","1.362","76.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","586","7.596","97.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":863},{"label":"Mar","value":812},{"label":"Abr","value":585},{"label":"Mai","value":589},{"label":"Jun","value":826},{"label":"Jul","value":899},{"label":"Ago","value":655},{"label":"Set","value":677},{"label":"Out","value":615},{"label":"Nov","value":557},{"label":"Dez","value":718}];
const MX = 899;
