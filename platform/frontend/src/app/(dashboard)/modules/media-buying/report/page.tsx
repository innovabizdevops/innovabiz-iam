...
const PAGE = "Report";
const KPIS = [{"l":"Integrações Ativas","v":"2.934","t":"+6.4%","d":"up"},{"l":"Chamadas/Hora","v":"1183","t":"+13.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.1%","t":"+3.0%","d":"up"},{"l":"Latência Média (ms)","v":"153ms","t":"-2.5%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.522","7.580","85.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.888","8.860","74.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","605","5.615","79.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.124","5.640","74.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.923","8.299","95.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":901},{"label":"Fev","value":736},{"label":"Mar","value":852},{"label":"Abr","value":903},{"label":"Mai","value":898},{"label":"Jun","value":991},{"label":"Jul","value":754},{"label":"Ago","value":761},{"label":"Set","value":752},{"label":"Out","value":715},{"label":"Nov","value":722},{"label":"Dez","value":1049}];
const MX = 1049;
