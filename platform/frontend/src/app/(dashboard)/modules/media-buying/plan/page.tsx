...
const PAGE = "Plan";
const KPIS = [{"l":"Integrações Ativas","v":"8.488","t":"+0.7%","d":"up"},{"l":"Chamadas/Hora","v":"1072","t":"+10.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"89.9%","t":"+15.2%","d":"up"},{"l":"Latência Média (ms)","v":"107ms","t":"+5.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.143","7.597","81.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.736","1.772","97.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.120","1.635","86.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.006","2.640","70.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.001","5.719","71.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":337},{"label":"Mar","value":488},{"label":"Abr","value":308},{"label":"Mai","value":555},{"label":"Jun","value":674},{"label":"Jul","value":379},{"label":"Ago","value":311},{"label":"Set","value":612},{"label":"Out","value":464},{"label":"Nov","value":538},{"label":"Dez","value":360}];
const MX = 674;
