...
const ACCENT = "#6366f1";
const MODULE = "Media Buying";
const PAGE = "Optimize";
const KPIS = [{"l":"Integrações Ativas","v":"8.056","t":"-2.9%","d":"down"},{"l":"Chamadas/Hora","v":"2403","t":"+12.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"92.1%","t":"+7.5%","d":"up"},{"l":"Latência Média (ms)","v":"141ms","t":"-3.4%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.098","5.885","74.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","230","8.393","70.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.147","3.281","80.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.500","1.309","85.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.100","6.651","82.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":459},{"label":"Mar","value":598},{"label":"Abr","value":375},{"label":"Mai","value":363},{"label":"Jun","value":439},{"label":"Jul","value":217},{"label":"Ago","value":327},{"label":"Set","value":209},{"label":"Out","value":506},{"label":"Nov","value":547},{"label":"Dez","value":401}];
const MX = 598;
