...
const KPIS = [{"l":"Integrações Ativas","v":"4.416","t":"+8.7%","d":"up"},{"l":"Chamadas/Hora","v":"3615","t":"+0.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"88.3%","t":"+17.4%","d":"up"},{"l":"Latência Média (ms)","v":"62ms","t":"+0.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.099","5.965","84.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.317","1.095","96.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.415","1.008","95.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.630","8.526","93.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.594","3.196","76.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":704},{"label":"Mar","value":812},{"label":"Abr","value":944},{"label":"Mai","value":729},{"label":"Jun","value":686},{"label":"Jul","value":951},{"label":"Ago","value":771},{"label":"Set","value":844},{"label":"Out","value":660},{"label":"Nov","value":792},{"label":"Dez","value":677}];
const MX = 951;
