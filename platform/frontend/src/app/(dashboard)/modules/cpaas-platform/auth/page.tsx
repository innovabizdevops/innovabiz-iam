...
const PAGE = "Auth";
const KPIS = [{"l":"Utilizadores Ativos","v":"548","t":"-4.2%","d":"down"},{"l":"Sessões/Dia","v":"132","t":"+10.8%","d":"up"},{"l":"MFA Adoção (%)","v":"90.8%","t":"+14.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"2.883","t":"+9.3%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.505","3.174","9.095","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.612","5.542","3.818","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","6.382","984","5.716","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.775","2.009","1.328","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","3.199","8.073","1.336","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":399},{"label":"Mar","value":458},{"label":"Abr","value":643},{"label":"Mai","value":389},{"label":"Jun","value":616},{"label":"Jul","value":462},{"label":"Ago","value":603},{"label":"Set","value":740},{"label":"Out","value":398},{"label":"Nov","value":481},{"label":"Dez","value":463}];
const MX = 740;
