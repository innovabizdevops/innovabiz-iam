...
const PAGE = "Video";
const KPIS = [{"l":"Formulários Ativos","v":"4.612","t":"+5.8%","d":"up"},{"l":"Submissões/Dia","v":"247","t":"+12.9%","d":"up"},{"l":"Documentos Gerados","v":"4.699","t":"+11.2%","d":"up"},{"l":"Templates","v":"7.234","t":"-2.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.619","2026-01-02","4.709","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.355","2026-02-19","812","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.867","2026-03-13","2.904","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.732","2026-02-17","5.371","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.293","2026-01-21","759","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":871},{"label":"Mar","value":766},{"label":"Abr","value":589},{"label":"Mai","value":792},{"label":"Jun","value":684},{"label":"Jul","value":888},{"label":"Ago","value":648},{"label":"Set","value":942},{"label":"Out","value":722},{"label":"Nov","value":889},{"label":"Dez","value":710}];
const MX = 942;
