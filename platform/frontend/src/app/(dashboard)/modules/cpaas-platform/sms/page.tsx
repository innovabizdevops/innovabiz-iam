...
const PAGE = "SMS";
const KPIS = [{"l":"Formulários Ativos","v":"8.582","t":"+11.3%","d":"up"},{"l":"Submissões/Dia","v":"4165","t":"-2.2%","d":"down"},{"l":"Documentos Gerados","v":"3.493","t":"+16.2%","d":"up"},{"l":"Templates","v":"6.913","t":"+4.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.926","2026-02-05","355","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.971","2026-03-15","674","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.409","2026-02-15","6.505","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.941","2026-03-14","6.685","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.288","2026-02-09","5.119","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":950},{"label":"Fev","value":809},{"label":"Mar","value":953},{"label":"Abr","value":672},{"label":"Mai","value":758},{"label":"Jun","value":872},{"label":"Jul","value":891},{"label":"Ago","value":1001},{"label":"Set","value":1008},{"label":"Out","value":1051},{"label":"Nov","value":921},{"label":"Dez","value":738}];
const MX = 1051;
