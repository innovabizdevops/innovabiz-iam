...
const PAGE = "Voice";
const KPIS = [{"l":"Formulários Ativos","v":"3.657","t":"+0.8%","d":"up"},{"l":"Submissões/Dia","v":"4445","t":"+10.1%","d":"up"},{"l":"Documentos Gerados","v":"3.131","t":"+10.7%","d":"up"},{"l":"Templates","v":"754","t":"+10.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.183","2026-02-22","904","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.164","2026-01-26","2.768","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.315","2026-02-06","4.824","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.771","2026-01-13","8.342","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.073","2026-03-20","2.876","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":857},{"label":"Mar","value":941},{"label":"Abr","value":797},{"label":"Mai","value":887},{"label":"Jun","value":767},{"label":"Jul","value":828},{"label":"Ago","value":639},{"label":"Set","value":665},{"label":"Out","value":876},{"label":"Nov","value":845},{"label":"Dez","value":903}];
const MX = 941;
