...
const ACCENT = "#f97316";
const MODULE = "CPaaS Platform";
const PAGE = "Analytics";
const KPIS = [{"l":"Formulários Ativos","v":"1.233","t":"+10.2%","d":"up"},{"l":"Submissões/Dia","v":"917","t":"+14.6%","d":"up"},{"l":"Documentos Gerados","v":"7.255","t":"-0.1%","d":"down"},{"l":"Templates","v":"8.907","t":"+4.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.640","2026-03-12","2.492","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.558","2026-03-05","3.806","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.765","2026-03-17","7.985","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.893","2026-01-22","7.365","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.943","2026-01-24","3.350","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":502},{"label":"Fev","value":789},{"label":"Mar","value":748},{"label":"Abr","value":619},{"label":"Mai","value":820},{"label":"Jun","value":557},{"label":"Jul","value":691},{"label":"Ago","value":495},{"label":"Set","value":578},{"label":"Out","value":481},{"label":"Nov","value":788},{"label":"Dez","value":705}];
const MX = 820;
