...
const PAGE = "SIEM";
const KPIS = [{"l":"Projetos Melhoria","v":"4.728","t":"-1.9%","d":"down"},{"l":"Savings (€)","v":"€15673","t":"-4.0%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"69.3%","t":"+2.7%","d":"up"},{"l":"Ciclos PDCA","v":"3.051","t":"+11.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.708","€ 24650.47","7.119","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.073","€ 33974.72","3.336","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.000","€ 33824.47","6.847","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.352","€ 31862.46","5.518","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.911","€ 49626.61","5.926","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1032},{"label":"Fev","value":687},{"label":"Mar","value":714},{"label":"Abr","value":731},{"label":"Mai","value":719},{"label":"Jun","value":960},{"label":"Jul","value":716},{"label":"Ago","value":941},{"label":"Set","value":1036},{"label":"Out","value":921},{"label":"Nov","value":807},{"label":"Dez","value":1061}];
const MX = 1061;
