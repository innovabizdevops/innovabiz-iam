...
const PAGE = "Compliance Automation";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.294","t":"+0.1%","d":"up"},{"l":"NC Abertas","v":"2.011","t":"+14.5%","d":"up"},{"l":"Conformidade (%)","v":"65.9%","t":"+7.8%","d":"up"},{"l":"CAPAs Pendentes","v":"7.052","t":"+2.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.853","75.1%","1.017","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.618","89.8%","5.333","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.995","81.2%","5.151","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.746","99.6%","5.620","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.704","81.8%","2.076","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":623},{"label":"Mar","value":831},{"label":"Abr","value":809},{"label":"Mai","value":728},{"label":"Jun","value":594},{"label":"Jul","value":590},{"label":"Ago","value":765},{"label":"Set","value":682},{"label":"Out","value":517},{"label":"Nov","value":598},{"label":"Dez","value":630}];
const MX = 853;
