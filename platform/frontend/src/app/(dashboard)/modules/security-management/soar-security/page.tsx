...
const ACCENT = "#6366f1";
const MODULE = "Security Management";
const PAGE = "SOAR";
const KPIS = [{"l":"Projetos Melhoria","v":"6.070","t":"-1.0%","d":"down"},{"l":"Savings (€)","v":"€32381","t":"-5.5%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"91.6%","t":"+12.6%","d":"up"},{"l":"Ciclos PDCA","v":"5.667","t":"+16.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.973","€ 10760.75","8.790","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.066","€ 23530.78","664","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.146","€ 32941.83","4.146","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.570","€ 36691.38","600","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.505","€ 38189.11","6.627","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":916},{"label":"Fev","value":599},{"label":"Mar","value":703},{"label":"Abr","value":731},{"label":"Mai","value":753},{"label":"Jun","value":872},{"label":"Jul","value":528},{"label":"Ago","value":810},{"label":"Set","value":620},{"label":"Out","value":607},{"label":"Nov","value":552},{"label":"Dez","value":692}];
const MX = 916;
...
export default function SoarSecurityPage() {
    return (
