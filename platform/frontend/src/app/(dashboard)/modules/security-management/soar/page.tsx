...
const PAGE = "Response &amp; Automation";
const KPIS = [{"l":"Projetos Melhoria","v":"5.824","t":"+10.0%","d":"up"},{"l":"Savings (€)","v":"€4790","t":"+1.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"94.0%","t":"+0.7%","d":"up"},{"l":"Ciclos PDCA","v":"411","t":"-4.1%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.143","€ 810.39","7.389","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.585","€ 14132.13","4.289","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.484","€ 34175.76","6.935","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.976","€ 30458.15","6.220","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.206","€ 41832.43","1.140","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":847},{"label":"Mar","value":757},{"label":"Abr","value":673},{"label":"Mai","value":1024},{"label":"Jun","value":942},{"label":"Jul","value":1015},{"label":"Ago","value":971},{"label":"Set","value":714},{"label":"Out","value":1000},{"label":"Nov","value":895},{"label":"Dez","value":874}];
const MX = 1024;
