...
const PAGE = "Cloud Security";
const KPIS = [{"l":"Projetos Melhoria","v":"4.308","t":"+12.5%","d":"up"},{"l":"Savings (€)","v":"€85984","t":"-2.4%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"81.3%","t":"+3.3%","d":"up"},{"l":"Ciclos PDCA","v":"3.201","t":"+3.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.613","€ 21540.65","1.422","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.862","€ 19628.70","7.935","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.792","€ 16994.15","7.413","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.206","€ 498.11","6.698","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.174","€ 43035.61","3.145","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":672},{"label":"Fev","value":751},{"label":"Mar","value":820},{"label":"Abr","value":697},{"label":"Mai","value":844},{"label":"Jun","value":647},{"label":"Jul","value":684},{"label":"Ago","value":614},{"label":"Set","value":820},{"label":"Out","value":507},{"label":"Nov","value":820},{"label":"Dez","value":499}];
const MX = 844;
