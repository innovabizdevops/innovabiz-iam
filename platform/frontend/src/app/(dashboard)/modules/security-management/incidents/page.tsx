...
const KPIS = [{"l":"Tickets Abertos","v":"2.465","t":"+1.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"85.3%","t":"+13.6%","d":"up"},{"l":"MTTR (h)","v":"155h","t":"+16.7%","d":"up"},{"l":"Satisfação (%)","v":"67.2%","t":"-1.8%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.338","8.418","2.886","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.728","6.442","3.750","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.215","3.270","704","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.078","2.413","2.474","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.424","2.624","998","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":929},{"label":"Fev","value":805},{"label":"Mar","value":676},{"label":"Abr","value":630},{"label":"Mai","value":639},{"label":"Jun","value":897},{"label":"Jul","value":857},{"label":"Ago","value":780},{"label":"Set","value":873},{"label":"Out","value":796},{"label":"Nov","value":837},{"label":"Dez","value":925}];
const MX = 929;
