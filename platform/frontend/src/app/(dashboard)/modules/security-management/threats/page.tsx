...
const PAGE = "Threat &amp; Detection";
const KPIS = [{"l":"Projetos Melhoria","v":"3.120","t":"-2.6%","d":"down"},{"l":"Savings (€)","v":"€34743","t":"+12.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"80.8%","t":"+4.7%","d":"up"},{"l":"Ciclos PDCA","v":"7.398","t":"-3.3%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.678","€ 28653.00","9.073","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.593","€ 14615.23","7.113","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.016","€ 19631.17","5.016","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.270","€ 22827.60","4.052","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.187","€ 24043.39","4.572","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":400},{"label":"Mar","value":451},{"label":"Abr","value":442},{"label":"Mai","value":516},{"label":"Jun","value":407},{"label":"Jul","value":399},{"label":"Ago","value":447},{"label":"Set","value":309},{"label":"Out","value":627},{"label":"Nov","value":439},{"label":"Dez","value":379}];
const MX = 627;
