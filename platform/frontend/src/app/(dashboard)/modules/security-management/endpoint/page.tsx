...
const PAGE = "Endpoint Protection";
const KPIS = [{"l":"Projetos Melhoria","v":"7.287","t":"+11.1%","d":"up"},{"l":"Savings (€)","v":"€85946","t":"+2.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"94.3%","t":"+9.7%","d":"up"},{"l":"Ciclos PDCA","v":"3.034","t":"+15.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.153","€ 26299.76","7.497","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.794","€ 9630.52","8.371","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.872","€ 9552.12","3.082","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.225","€ 36053.45","1.779","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.962","€ 22040.06","923","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":704},{"label":"Mar","value":544},{"label":"Abr","value":732},{"label":"Mai","value":672},{"label":"Jun","value":819},{"label":"Jul","value":686},{"label":"Ago","value":697},{"label":"Set","value":686},{"label":"Out","value":654},{"label":"Nov","value":604},{"label":"Dez","value":504}];
const MX = 819;
