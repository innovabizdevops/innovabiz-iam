...
const KPIS = [{"l":"Projetos Melhoria","v":"4.306","t":"+6.7%","d":"up"},{"l":"Savings (€)","v":"€16515","t":"+1.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"74.1%","t":"+8.4%","d":"up"},{"l":"Ciclos PDCA","v":"178","t":"+8.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.529","€ 17539.11","5.316","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.639","€ 2978.15","3.524","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","797","€ 29302.07","7.212","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.374","€ 21528.92","7.551","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.721","€ 44920.22","4.097","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":714},{"label":"Fev","value":730},{"label":"Mar","value":696},{"label":"Abr","value":756},{"label":"Mai","value":686},{"label":"Jun","value":691},{"label":"Jul","value":716},{"label":"Ago","value":592},{"label":"Set","value":649},{"label":"Out","value":619},{"label":"Nov","value":855},{"label":"Dez","value":771}];
const MX = 855;
