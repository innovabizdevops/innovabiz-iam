...
const KPIS = [{"l":"Projetos Melhoria","v":"2.799","t":"+9.4%","d":"up"},{"l":"Savings (€)","v":"€99794","t":"-1.5%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"86.4%","t":"-2.1%","d":"down"},{"l":"Ciclos PDCA","v":"1.288","t":"-2.4%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.307","€ 35254.19","131","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","163","€ 12245.27","1.327","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.951","€ 30367.64","7.531","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.113","€ 46018.35","2.949","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.839","€ 31378.94","5.569","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":486},{"label":"Mar","value":355},{"label":"Abr","value":648},{"label":"Mai","value":394},{"label":"Jun","value":639},{"label":"Jul","value":377},{"label":"Ago","value":427},{"label":"Set","value":508},{"label":"Out","value":494},{"label":"Nov","value":496},{"label":"Dez","value":554}];
const MX = 648;
...
export default function ThreatsSecurityPage() {
    return (
