...
const KPIS = [{"l":"Integrações Ativas","v":"662","t":"+2.9%","d":"up"},{"l":"Chamadas/Hora","v":"1606","t":"+16.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.4%","t":"+14.2%","d":"up"},{"l":"Latência Média (ms)","v":"202ms","t":"-5.5%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.352","909","75.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.678","3.746","95.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.823","2.846","73.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.867","545","81.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","275","7.141","82.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":761},{"label":"Mar","value":624},{"label":"Abr","value":878},{"label":"Mai","value":658},{"label":"Jun","value":787},{"label":"Jul","value":535},{"label":"Ago","value":865},{"label":"Set","value":573},{"label":"Out","value":515},{"label":"Nov","value":621},{"label":"Dez","value":531}];
const MX = 878;
