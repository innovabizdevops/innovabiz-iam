...
/* ═══ FATCA/CRS Compliance — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "331", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1981", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€435K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1407968331", cells: ["FAT-9331", "FATCA/CRS Compliance Item 1", "8/4/2026", "€18 431"], status: "active" as const },
    { id: "1407971902", cells: ["FAT-3902", "FATCA/CRS Compliance Item 2", "23/11/2026", "€22 002"], status: "pending" as const },
    { id: "1407975473", cells: ["FAT-7473", "FATCA/CRS Compliance Item 3", "10/6/2026", "€25 573"], status: "completed" as const },
    { id: "1407979044", cells: ["FAT-2044", "FATCA/CRS Compliance Item 4", "25/1/2026", "€29 144"], status: "warning" as const },
    { id: "1407982615", cells: ["FAT-5615", "FATCA/CRS Compliance Item 5", "12/8/2026", "€32 715"], status: "active" as const },
];
...
export default function FatcacrsCompliancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">FATCA/CRS Compliance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • FATCA/CRS Compliance</p>
                    </div>
                </div>
