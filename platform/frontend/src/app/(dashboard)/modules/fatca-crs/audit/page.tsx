...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.469","t":"+12.1%","d":"up"},{"l":"NC Abertas","v":"6.617","t":"+11.5%","d":"up"},{"l":"Conformidade (%)","v":"81.3%","t":"-5.3%","d":"down"},{"l":"CAPAs Pendentes","v":"2.222","t":"+15.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.103","84.5%","714","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.648","80.2%","6.990","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.393","75.1%","3.042","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.510","75.9%","4.516","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.575","96.9%","5.079","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":299},{"label":"Fev","value":369},{"label":"Mar","value":358},{"label":"Abr","value":576},{"label":"Mai","value":272},{"label":"Jun","value":561},{"label":"Jul","value":654},{"label":"Ago","value":459},{"label":"Set","value":455},{"label":"Out","value":461},{"label":"Nov","value":280},{"label":"Dez","value":468}];
const MX = 654;
