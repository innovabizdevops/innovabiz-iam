...
const ACCENT = "#dc2626";
const MODULE = "FATCA/CRS Compliance";
const PAGE = "Classify";
const KPIS = [{"l":"Total Fatca Crs","v":"8.999","t":"+16.5%","d":"up"},{"l":"Classify Ativos","v":"2.424","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"72.3%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"72","t":"-0.8%","d":"down"}];
const COLS = ["ID","Classify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fatca Crs #001","Fatca Crs #002","2.938","5.289","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Fatca Crs #002","Fatca Crs #003","8.580","5.000","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Fatca Crs #003","Fatca Crs #004","679","1.128","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Fatca Crs #004","Fatca Crs #005","5.811","2.942","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fatca Crs #005","Fatca Crs #001","3.270","2.463","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":911},{"label":"Fev","value":743},{"label":"Mar","value":709},{"label":"Abr","value":961},{"label":"Mai","value":939},{"label":"Jun","value":902},{"label":"Jul","value":961},{"label":"Ago","value":972},{"label":"Set","value":910},{"label":"Out","value":634},{"label":"Nov","value":801},{"label":"Dez","value":953}];
const MX = 972;
