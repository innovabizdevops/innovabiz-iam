...
const PAGE = "Onboard";
const KPIS = [{"l":"eNPS","v":"90","t":"+4.4%","d":"up"},{"l":"Engagement (%)","v":"81.5%","t":"+12.7%","d":"up"},{"l":"Turnover (%)","v":"82.3%","t":"+8.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.020","t":"+6.4%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.404","2026-03-27","85","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.523","2026-03-07","75","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","550","2026-01-01","73","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.749","2026-01-03","94","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.440","2026-02-19","71","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":672},{"label":"Fev","value":494},{"label":"Mar","value":686},{"label":"Abr","value":370},{"label":"Mai","value":440},{"label":"Jun","value":428},{"label":"Jul","value":629},{"label":"Ago","value":345},{"label":"Set","value":689},{"label":"Out","value":582},{"label":"Nov","value":632},{"label":"Dez","value":423}];
const MX = 689;
