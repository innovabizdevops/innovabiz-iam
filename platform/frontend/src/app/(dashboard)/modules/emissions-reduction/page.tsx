...
/* ═══ Emissions Reduction Engine — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "1913", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3846", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€312K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1737996313", cells: ["EMI-7313", "Emissions Reduction Engine Item 1", "26/2/2026", "€46 413"], status: "active" as const },
    { id: "1737999884", cells: ["EMI-1884", "Emissions Reduction Engine Item 2", "13/9/2026", "€49 984"], status: "pending" as const },
    { id: "1738003455", cells: ["EMI-5455", "Emissions Reduction Engine Item 3", "28/4/2026", "€3555"], status: "completed" as const },
    { id: "1738007026", cells: ["EMI-9026", "Emissions Reduction Engine Item 4", "15/11/2026", "€7126"], status: "warning" as const },
    { id: "1738010597", cells: ["EMI-3597", "Emissions Reduction Engine Item 5", "2/6/2026", "€10 697"], status: "active" as const },
];
...
export default function EmissionsReductionEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Emissions Reduction Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Emissions Reduction Engine</p>
                    </div>
                </div>
