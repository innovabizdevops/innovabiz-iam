...
const PAGE = "Baseline";
const KPIS = [{"l":"Total Emissions Reduction","v":"8.561","t":"+9.3%","d":"up"},{"l":"Baseline Ativos","v":"6.384","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"84.1%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"67","t":"+12.1%","d":"up"}];
const COLS = ["ID","Baseline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Emissions Reduction #001","Emissions Reduction #002","6.422","152","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Emissions Reduction #002","Emissions Reduction #003","1.581","8.697","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Emissions Reduction #003","Emissions Reduction #004","6.301","2.718","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Emissions Reduction #004","Emissions Reduction #005","8.163","890","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Emissions Reduction #005","Emissions Reduction #001","2.943","6.671","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":442},{"label":"Fev","value":551},{"label":"Mar","value":607},{"label":"Abr","value":433},{"label":"Mai","value":349},{"label":"Jun","value":340},{"label":"Jul","value":247},{"label":"Ago","value":447},{"label":"Set","value":531},{"label":"Out","value":481},{"label":"Nov","value":227},{"label":"Dez","value":591}];
const MX = 607;
