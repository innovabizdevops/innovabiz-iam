...
const PAGE = "Action";
const KPIS = [{"l":"Total Emissions Reduction","v":"1.979","t":"-1.4%","d":"down"},{"l":"Action Ativos","v":"5.740","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"90.9%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"64","t":"+16.2%","d":"up"}];
const COLS = ["ID","Action","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Emissions Reduction #001","Emissions Reduction #002","7.926","4.718","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Emissions Reduction #002","Emissions Reduction #003","8.205","8.102","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Emissions Reduction #003","Emissions Reduction #004","3.966","1.275","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Emissions Reduction #004","Emissions Reduction #005","4.582","1.305","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Emissions Reduction #005","Emissions Reduction #001","8.098","406","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":563},{"label":"Mar","value":440},{"label":"Abr","value":365},{"label":"Mai","value":480},{"label":"Jun","value":551},{"label":"Jul","value":485},{"label":"Ago","value":386},{"label":"Set","value":621},{"label":"Out","value":459},{"label":"Nov","value":295},{"label":"Dez","value":604}];
const MX = 621;
