...
/* ═══ University System — Enrollment Mgmt ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "292", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "470", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1671", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1670159458", cells: ["UNI-3458", "Enrollment Mgmt Item 1", "3/11/2026", "€9558"], status: "active" as const },
    { id: "1670163029", cells: ["UNI-7029", "Enrollment Mgmt Item 2", "18/6/2026", "€13 129"], status: "pending" as const },
    { id: "1670166600", cells: ["UNI-1600", "Enrollment Mgmt Item 3", "5/1/2026", "€16 700"], status: "completed" as const },
    { id: "1670170171", cells: ["UNI-5171", "Enrollment Mgmt Item 4", "20/8/2026", "€20 271"], status: "warning" as const },
    { id: "1670173742", cells: ["UNI-8742", "Enrollment Mgmt Item 5", "7/3/2026", "€23 842"], status: "active" as const },
];
...
export default function UniversitySystemEnrollmentMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Enrollment Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">University System • Enrollment Mgmt</p>
                    </div>
                </div>
