...
/* ═══ University System — Course Catalog ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "2036", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "177", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2978", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1800618573", cells: ["UNI-7573", "Course Catalog Item 1", "6/10/2026", "€18 673"], status: "active" as const },
    { id: "1800622144", cells: ["UNI-2144", "Course Catalog Item 2", "21/5/2026", "€22 244"], status: "pending" as const },
    { id: "1800625715", cells: ["UNI-5715", "Course Catalog Item 3", "8/12/2026", "€25 815"], status: "completed" as const },
    { id: "1800629286", cells: ["UNI-9286", "Course Catalog Item 4", "23/7/2026", "€29 386"], status: "warning" as const },
    { id: "1800632857", cells: ["UNI-3857", "Course Catalog Item 5", "10/2/2026", "€32 957"], status: "active" as const },
];
...
export default function UniversitySystemCourseCatalogPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Course Catalog</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">University System • Course Catalog</p>
                    </div>
                </div>
