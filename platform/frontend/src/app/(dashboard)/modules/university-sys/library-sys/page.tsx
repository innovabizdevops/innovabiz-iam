...
/* ═══ University System — Library Sys ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "449", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "365", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2099", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "42458473", cells: ["UNI-6473", "Library Sys Item 1", "2/2/2026", "€8573"], status: "active" as const },
    { id: "42462044", cells: ["UNI-1044", "Library Sys Item 2", "17/9/2026", "€12 144"], status: "pending" as const },
    { id: "42465615", cells: ["UNI-4615", "Library Sys Item 3", "4/4/2026", "€15 715"], status: "completed" as const },
    { id: "42469186", cells: ["UNI-8186", "Library Sys Item 4", "19/11/2026", "€19 286"], status: "warning" as const },
    { id: "42472757", cells: ["UNI-2757", "Library Sys Item 5", "6/6/2026", "€22 857"], status: "active" as const },
];
...
export default function UniversitySystemLibrarySysPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Library Sys</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">University System • Library Sys</p>
                    </div>
                </div>
