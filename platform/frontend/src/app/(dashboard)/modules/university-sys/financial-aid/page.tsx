...
/* ═══ University System — Financial Aid ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "732", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "298", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1173", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1037194342", cells: ["UNI-8342", "Financial Aid Item 1", "3/11/2026", "€44 442"], status: "active" as const },
    { id: "1037197913", cells: ["UNI-2913", "Financial Aid Item 2", "18/6/2026", "€48 013"], status: "pending" as const },
    { id: "1037201484", cells: ["UNI-6484", "Financial Aid Item 3", "5/1/2026", "€1584"], status: "completed" as const },
    { id: "1037205055", cells: ["UNI-1055", "Financial Aid Item 4", "20/8/2026", "€5155"], status: "warning" as const },
    { id: "1037208626", cells: ["UNI-4626", "Financial Aid Item 5", "7/3/2026", "€8726"], status: "active" as const },
];
...
export default function UniversitySystemFinancialAidPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Financial Aid</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">University System • Financial Aid</p>
                    </div>
                </div>
