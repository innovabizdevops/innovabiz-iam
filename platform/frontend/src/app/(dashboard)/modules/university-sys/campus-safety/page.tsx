...
/* ═══ University System — Campus Safety ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "2944", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "456", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "340", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1309766836", cells: ["UNI-6836", "Campus Safety Item 1", "1/5/2026", "€16 936"], status: "active" as const },
    { id: "1309770407", cells: ["UNI-1407", "Campus Safety Item 2", "16/12/2026", "€20 507"], status: "pending" as const },
    { id: "1309773978", cells: ["UNI-4978", "Campus Safety Item 3", "3/7/2026", "€24 078"], status: "completed" as const },
    { id: "1309777549", cells: ["UNI-8549", "Campus Safety Item 4", "18/2/2026", "€27 649"], status: "warning" as const },
    { id: "1309781120", cells: ["UNI-3120", "Campus Safety Item 5", "5/9/2026", "€31 220"], status: "active" as const },
];
...
export default function UniversitySystemCampusSafetyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Campus Safety</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">University System • Campus Safety</p>
                    </div>
                </div>
