...
/* ═══ University System — Research Grants ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "1783", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "337", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2722", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "936838205", cells: ["UNI-2205", "Research Grants Item 1", "10/6/2026", "€38 305"], status: "active" as const },
    { id: "936841776", cells: ["UNI-5776", "Research Grants Item 2", "25/1/2026", "€41 876"], status: "pending" as const },
    { id: "936845347", cells: ["UNI-9347", "Research Grants Item 3", "12/8/2026", "€45 447"], status: "completed" as const },
    { id: "936848918", cells: ["UNI-3918", "Research Grants Item 4", "27/3/2026", "€49 018"], status: "warning" as const },
    { id: "936852489", cells: ["UNI-7489", "Research Grants Item 5", "14/10/2026", "€2589"], status: "active" as const },
];
...
export default function UniversitySystemResearchGrantsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Research Grants</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">University System • Research Grants</p>
                    </div>
                </div>
