...
/* ═══ University System — Alumni Relations ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "3683", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "40", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1526", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2030901812", cells: ["UNI-7812", "Alumni Relations Item 1", "17/9/2026", "€1912"], status: "active" as const },
    { id: "2030905383", cells: ["UNI-2383", "Alumni Relations Item 2", "4/4/2026", "€5483"], status: "pending" as const },
    { id: "2030908954", cells: ["UNI-5954", "Alumni Relations Item 3", "19/11/2026", "€9054"], status: "completed" as const },
    { id: "2030912525", cells: ["UNI-9525", "Alumni Relations Item 4", "6/6/2026", "€12 625"], status: "warning" as const },
    { id: "2030916096", cells: ["UNI-4096", "Alumni Relations Item 5", "21/1/2026", "€16 196"], status: "active" as const },
];
...
export default function UniversitySystemAlumniRelationsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Alumni Relations</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">University System • Alumni Relations</p>
                    </div>
                </div>
