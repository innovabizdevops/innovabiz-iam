...
/* ═══ University System — Transcript Mgmt ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "3873", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "184", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1022", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "206311892", cells: ["UNI-5892", "Transcript Mgmt Item 1", "25/9/2026", "€11 992"], status: "active" as const },
    { id: "206315463", cells: ["UNI-9463", "Transcript Mgmt Item 2", "12/4/2026", "€15 563"], status: "pending" as const },
    { id: "206319034", cells: ["UNI-4034", "Transcript Mgmt Item 3", "27/11/2026", "€19 134"], status: "completed" as const },
    { id: "206322605", cells: ["UNI-7605", "Transcript Mgmt Item 4", "14/6/2026", "€22 705"], status: "warning" as const },
    { id: "206326176", cells: ["UNI-2176", "Transcript Mgmt Item 5", "1/1/2026", "€26 276"], status: "active" as const },
];
...
export default function UniversitySystemTranscriptMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Transcript Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">University System • Transcript Mgmt</p>
                    </div>
                </div>
