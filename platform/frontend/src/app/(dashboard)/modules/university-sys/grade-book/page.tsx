...
/* ═══ University System — Grade Book ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "100", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "131", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1098", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1981416975", cells: ["UNI-4975", "Grade Book Item 1", "28/4/2026", "€17 075"], status: "active" as const },
    { id: "1981420546", cells: ["UNI-8546", "Grade Book Item 2", "15/11/2026", "€20 646"], status: "pending" as const },
    { id: "1981424117", cells: ["UNI-3117", "Grade Book Item 3", "2/6/2026", "€24 217"], status: "completed" as const },
    { id: "1981427688", cells: ["UNI-6688", "Grade Book Item 4", "17/1/2026", "€27 788"], status: "warning" as const },
    { id: "1981431259", cells: ["UNI-1259", "Grade Book Item 5", "4/8/2026", "€31 359"], status: "active" as const },
];
...
export default function UniversitySystemGradeBookPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Grade Book</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">University System • Grade Book</p>
                    </div>
                </div>
