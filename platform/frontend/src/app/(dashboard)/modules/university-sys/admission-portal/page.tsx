...
/* ═══ University System — Admission Portal ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "1528", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "470", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1843", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "580696450", cells: ["UNI-8450", "Admission Portal Item 1", "27/11/2026", "€46 550"], status: "active" as const },
    { id: "580700021", cells: ["UNI-3021", "Admission Portal Item 2", "14/6/2026", "€121"], status: "pending" as const },
    { id: "580703592", cells: ["UNI-6592", "Admission Portal Item 3", "1/1/2026", "€3692"], status: "completed" as const },
    { id: "580707163", cells: ["UNI-1163", "Admission Portal Item 4", "16/8/2026", "€7263"], status: "warning" as const },
    { id: "580710734", cells: ["UNI-4734", "Admission Portal Item 5", "3/3/2026", "€10 834"], status: "active" as const },
];
...
export default function UniversitySystemAdmissionPortalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Admission Portal</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">University System • Admission Portal</p>
                    </div>
                </div>
