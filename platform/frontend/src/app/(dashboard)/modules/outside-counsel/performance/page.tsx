...
const KPIS = [{"l":"Formulários Ativos","v":"6.976","t":"+12.9%","d":"up"},{"l":"Submissões/Dia","v":"654","t":"+15.8%","d":"up"},{"l":"Documentos Gerados","v":"6.209","t":"+15.8%","d":"up"},{"l":"Templates","v":"1.120","t":"+0.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.966","2026-02-05","5.519","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.833","2026-03-05","6.822","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.788","2026-02-07","3.466","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.562","2026-03-12","8.383","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.576","2026-03-19","8.504","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":455},{"label":"Mar","value":459},{"label":"Abr","value":799},{"label":"Mai","value":501},{"label":"Jun","value":685},{"label":"Jul","value":536},{"label":"Ago","value":631},{"label":"Set","value":617},{"label":"Out","value":645},{"label":"Nov","value":643},{"label":"Dez","value":758}];
const MX = 799;
