...
const PAGE = "Panel Mgmt";
const KPIS = [{"l":"Total Outside Counsel","v":"8.431","t":"+16.9%","d":"up"},{"l":"Panel Mgmt Ativos","v":"604","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"71.1%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"81","t":"+9.4%","d":"up"}];
const COLS = ["ID","Panel Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Outside Counsel #001","Outside Counsel #002","2.355","7.140","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Outside Counsel #002","Outside Counsel #003","1.197","4.263","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Outside Counsel #003","Outside Counsel #004","3.870","3.903","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Outside Counsel #004","Outside Counsel #005","3.239","4.298","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Outside Counsel #005","Outside Counsel #001","8.030","6.863","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":725},{"label":"Mar","value":809},{"label":"Abr","value":635},{"label":"Mai","value":854},{"label":"Jun","value":697},{"label":"Jul","value":898},{"label":"Ago","value":746},{"label":"Set","value":818},{"label":"Out","value":644},{"label":"Nov","value":558},{"label":"Dez","value":900}];
const MX = 900;
