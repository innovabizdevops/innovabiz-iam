...
const PAGE = "Diversity";
const KPIS = [{"l":"Total Outside Counsel","v":"9.056","t":"+7.4%","d":"up"},{"l":"Diversity Ativos","v":"4.459","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"92.1%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"57","t":"+4.6%","d":"up"}];
const COLS = ["ID","Diversity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Outside Counsel #001","Outside Counsel #002","990","5.515","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Outside Counsel #002","Outside Counsel #003","1.905","7.458","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Outside Counsel #003","Outside Counsel #004","1.198","6.569","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Outside Counsel #004","Outside Counsel #005","5.445","262","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Outside Counsel #005","Outside Counsel #001","6.723","5.787","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":597},{"label":"Fev","value":309},{"label":"Mar","value":500},{"label":"Abr","value":556},{"label":"Mai","value":261},{"label":"Jun","value":486},{"label":"Jul","value":534},{"label":"Ago","value":622},{"label":"Set","value":336},{"label":"Out","value":398},{"label":"Nov","value":317},{"label":"Dez","value":499}];
const MX = 622;
