...
const PAGE = "RFP Process";
const KPIS = [{"l":"Fornecedores Ativos","v":"9.076","t":"-4.9%","d":"down"},{"l":"Contratos (€M)","v":"€6.5M","t":"+16.6%","d":"up"},{"l":"On-Time Delivery (%)","v":"86.5%","t":"+16.4%","d":"up"},{"l":"Score Médio","v":"89","t":"+17.6%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","71.3%","€ 49062.27","3.842","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","81.8%","€ 4640.37","2.336","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","96.9%","€ 5857.59","5.608","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","94.5%","€ 32935.54","8.938","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","92.3%","€ 22654.67","5.303","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":690},{"label":"Mar","value":963},{"label":"Abr","value":699},{"label":"Mai","value":842},{"label":"Jun","value":876},{"label":"Jul","value":963},{"label":"Ago","value":880},{"label":"Set","value":773},{"label":"Out","value":780},{"label":"Nov","value":924},{"label":"Dez","value":965}];
const MX = 965;
