...
const PAGE = "5G Slice";
const KPIS = [{"l":"Total Network Inventory","v":"8.699","t":"-4.2%","d":"down"},{"l":"5G Slice Ativos","v":"8.479","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"89.0%","t":"+6.7%","d":"up"},{"l":"Score Performance","v":"63","t":"+3.8%","d":"up"}];
const COLS = ["ID","5G Slice","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Network Inventory #001","Network Inventory #002","7.791","6.011","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Network Inventory #002","Network Inventory #003","4.020","387","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Inventory #003","Network Inventory #004","7.354","7.970","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Network Inventory #004","Network Inventory #005","7.455","7.885","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Network Inventory #005","Network Inventory #001","1.062","5.431","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":484},{"label":"Mar","value":463},{"label":"Abr","value":377},{"label":"Mai","value":449},{"label":"Jun","value":604},{"label":"Jul","value":405},{"label":"Ago","value":478},{"label":"Set","value":347},{"label":"Out","value":348},{"label":"Nov","value":499},{"label":"Dez","value":633}];
const MX = 633;
...
export default function 5gSlicePage() {
    return (
