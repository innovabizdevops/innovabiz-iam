...
const PAGE = "Asset Map";
const KPIS = [{"l":"Ativos Registados","v":"8.862","t":"+9.5%","d":"up"},{"l":"Valor Total (€M)","v":"€48.3M","t":"-3.8%","d":"down"},{"l":"Depreciação Anual (€)","v":"€63491","t":"+3.0%","d":"up"},{"l":"Ativos em Garantia","v":"7.572","t":"+7.5%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 24769.28","3.330","€ 7972.98","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 38164.29","239","€ 24467.65","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 35689.16","8.741","€ 2057.39","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 25227.66","360","€ 19893.54","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 18045.39","2.035","€ 48455.45","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":714},{"label":"Fev","value":530},{"label":"Mar","value":589},{"label":"Abr","value":590},{"label":"Mai","value":434},{"label":"Jun","value":384},{"label":"Jul","value":405},{"label":"Ago","value":635},{"label":"Set","value":496},{"label":"Out","value":652},{"label":"Nov","value":699},{"label":"Dez","value":588}];
const MX = 714;
