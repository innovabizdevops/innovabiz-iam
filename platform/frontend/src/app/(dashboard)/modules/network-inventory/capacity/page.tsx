...
const PAGE = "Capacity";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.981","t":"+10.8%","d":"up"},{"l":"NC Abertas","v":"8.584","t":"+1.1%","d":"up"},{"l":"Conformidade (%)","v":"90.6%","t":"+4.8%","d":"up"},{"l":"CAPAs Pendentes","v":"5.743","t":"-1.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","320","92.6%","8.532","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.748","82.2%","7.544","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.517","86.6%","4.972","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.313","99.8%","3.470","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.621","80.8%","4.270","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":568},{"label":"Mar","value":693},{"label":"Abr","value":711},{"label":"Mai","value":636},{"label":"Jun","value":765},{"label":"Jul","value":499},{"label":"Ago","value":509},{"label":"Set","value":539},{"label":"Out","value":570},{"label":"Nov","value":821},{"label":"Dez","value":536}];
const MX = 823;
