...
const ACCENT = "#1e40af";
const MODULE = "Network Inventory";
const PAGE = "NFV Orchestration";
const KPIS = [{"l":"Total Network Inventory","v":"7.677","t":"+15.5%","d":"up"},{"l":"NFV Orchestration Ativos","v":"679","t":"+10.0%","d":"up"},{"l":"Eficiência (%)","v":"69.4%","t":"+9.7%","d":"up"},{"l":"Score Performance","v":"75","t":"+1.1%","d":"up"}];
const COLS = ["ID","NFV Orchestration","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Network Inventory #001","Network Inventory #002","7.791","2.432","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Network Inventory #002","Network Inventory #003","6.957","3.570","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Inventory #003","Network Inventory #004","406","6.330","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Network Inventory #004","Network Inventory #005","5.176","143","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Network Inventory #005","Network Inventory #001","2.645","2.535","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":605},{"label":"Mar","value":748},{"label":"Abr","value":797},{"label":"Mai","value":561},{"label":"Jun","value":846},{"label":"Jul","value":731},{"label":"Ago","value":544},{"label":"Set","value":817},{"label":"Out","value":595},{"label":"Nov","value":692},{"label":"Dez","value":563}];
const MX = 846;
...
export default function NfvPage() {
    return (
