...
const PAGE = "Fiber Map";
const KPIS = [{"l":"Total Network Inventory","v":"727","t":"+15.8%","d":"up"},{"l":"Fiber Map Ativos","v":"2.063","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"87.0%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"74","t":"+5.8%","d":"up"}];
const COLS = ["ID","Fiber Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Network Inventory #001","Network Inventory #002","7.196","1.526","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Network Inventory #002","Network Inventory #003","1.672","5.466","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Inventory #003","Network Inventory #004","2.916","6.819","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Network Inventory #004","Network Inventory #005","3.436","6.467","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Network Inventory #005","Network Inventory #001","7.558","670","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":871},{"label":"Fev","value":1016},{"label":"Mar","value":750},{"label":"Abr","value":901},{"label":"Mai","value":940},{"label":"Jun","value":1076},{"label":"Jul","value":1032},{"label":"Ago","value":1056},{"label":"Set","value":892},{"label":"Out","value":821},{"label":"Nov","value":1028},{"label":"Dez","value":999}];
const MX = 1076;
