...
const ACCENT = "#dc2626";
const MODULE = "Secret Management";
const PAGE = "Rotation Policy";
const KPIS = [{"l":"Total Secret Mgmt","v":"680","t":"+4.4%","d":"up"},{"l":"Rotation Policy Ativos","v":"7.224","t":"-3.8%","d":"down"},{"l":"Eficiência (%)","v":"84.4%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"63","t":"+14.2%","d":"up"}];
const COLS = ["ID","Rotation Policy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Secret Mgmt #001","Secret Mgmt #002","9.070","1.742","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Secret Mgmt #002","Secret Mgmt #003","2.470","377","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Secret Mgmt #003","Secret Mgmt #004","3.674","4.068","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Secret Mgmt #004","Secret Mgmt #005","7.867","2.499","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Secret Mgmt #005","Secret Mgmt #001","5.609","3.122","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":761},{"label":"Mar","value":784},{"label":"Abr","value":822},{"label":"Mai","value":610},{"label":"Jun","value":551},{"label":"Jul","value":880},{"label":"Ago","value":689},{"label":"Set","value":597},{"label":"Out","value":588},{"label":"Nov","value":654},{"label":"Dez","value":623}];
const MX = 880;
