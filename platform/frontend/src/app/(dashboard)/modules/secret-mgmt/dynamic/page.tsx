...
const PAGE = "Dynamic Secrets";
const KPIS = [{"l":"Total Secret Mgmt","v":"557","t":"+15.2%","d":"up"},{"l":"Dynamic Secrets Ativos","v":"632","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"82.2%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"92","t":"-3.1%","d":"down"}];
const COLS = ["ID","Dynamic Secrets","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Secret Mgmt #001","Secret Mgmt #002","3.496","6.932","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Secret Mgmt #002","Secret Mgmt #003","6.302","4.776","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Secret Mgmt #003","Secret Mgmt #004","3.470","6.609","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Secret Mgmt #004","Secret Mgmt #005","8.749","5.811","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Secret Mgmt #005","Secret Mgmt #001","7.311","4.087","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":485},{"label":"Mar","value":566},{"label":"Abr","value":673},{"label":"Mai","value":486},{"label":"Jun","value":635},{"label":"Jul","value":393},{"label":"Ago","value":488},{"label":"Set","value":464},{"label":"Out","value":517},{"label":"Nov","value":591},{"label":"Dez","value":646}];
const MX = 673;
