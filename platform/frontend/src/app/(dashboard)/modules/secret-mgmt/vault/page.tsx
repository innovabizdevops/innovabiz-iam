...
const PAGE = "Vault";
const KPIS = [{"l":"Total Secret Mgmt","v":"3.522","t":"-1.2%","d":"down"},{"l":"Vault Ativos","v":"8.773","t":"+5.3%","d":"up"},{"l":"Eficiência (%)","v":"66.2%","t":"+15.3%","d":"up"},{"l":"Score Performance","v":"67","t":"+8.5%","d":"up"}];
const COLS = ["ID","Vault","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Secret Mgmt #001","Secret Mgmt #002","3.854","6.819","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Secret Mgmt #002","Secret Mgmt #003","6.796","4.162","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Secret Mgmt #003","Secret Mgmt #004","8.763","619","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Secret Mgmt #004","Secret Mgmt #005","1.814","7.421","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Secret Mgmt #005","Secret Mgmt #001","7.942","1.062","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":689},{"label":"Fev","value":653},{"label":"Mar","value":670},{"label":"Abr","value":874},{"label":"Mai","value":930},{"label":"Jun","value":899},{"label":"Jul","value":549},{"label":"Ago","value":566},{"label":"Set","value":907},{"label":"Out","value":772},{"label":"Nov","value":872},{"label":"Dez","value":758}];
const MX = 930;
