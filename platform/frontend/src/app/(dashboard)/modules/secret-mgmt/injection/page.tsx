...
const KPIS = [{"l":"Total Secret Mgmt","v":"6.826","t":"+1.7%","d":"up"},{"l":"Injection Ativos","v":"4.313","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"68.5%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"71","t":"+11.8%","d":"up"}];
const COLS = ["ID","Injection","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Secret Mgmt #001","Secret Mgmt #002","5.012","6.607","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Secret Mgmt #002","Secret Mgmt #003","9.014","6.082","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Secret Mgmt #003","Secret Mgmt #004","6.257","7.434","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Secret Mgmt #004","Secret Mgmt #005","6.060","1.283","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Secret Mgmt #005","Secret Mgmt #001","3.922","7.482","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":472},{"label":"Mar","value":485},{"label":"Abr","value":489},{"label":"Mai","value":689},{"label":"Jun","value":432},{"label":"Jul","value":432},{"label":"Ago","value":620},{"label":"Set","value":691},{"label":"Out","value":469},{"label":"Nov","value":586},{"label":"Dez","value":500}];
const MX = 744;
