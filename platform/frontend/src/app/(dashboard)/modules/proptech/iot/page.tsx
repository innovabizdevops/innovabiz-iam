...
const PAGE = "Smart Building IoT";
const KPIS = [{"l":"Dispositivos Online","v":"6.572","t":"+2.0%","d":"up"},{"l":"Dados/Min (MB)","v":"1.823","t":"-5.1%","d":"down"},{"l":"Alertas Ativos","v":"8.351","t":"+17.8%","d":"up"},{"l":"Uptime (%)","v":"83.0%","t":"+0.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.188","2.574","3.903","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.247","6.814","4.873","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.575","3.381","4.999","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.577","1.801","4.009","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","1.028","1.884","5.641","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":802},{"label":"Fev","value":891},{"label":"Mar","value":877},{"label":"Abr","value":748},{"label":"Mai","value":685},{"label":"Jun","value":809},{"label":"Jul","value":532},{"label":"Ago","value":730},{"label":"Set","value":670},{"label":"Out","value":842},{"label":"Nov","value":730},{"label":"Dez","value":651}];
const MX = 891;
