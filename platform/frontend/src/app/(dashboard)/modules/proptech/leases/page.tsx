...
const PAGE = "Lease Management";
const KPIS = [{"l":"Projetos Melhoria","v":"4.690","t":"+6.2%","d":"up"},{"l":"Savings (€)","v":"€3764","t":"+17.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"70.6%","t":"+10.4%","d":"up"},{"l":"Ciclos PDCA","v":"5.868","t":"+5.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.153","€ 45440.46","4.528","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.855","€ 9793.17","6.723","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.730","€ 37075.09","3.902","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.017","€ 33282.42","5.085","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.361","€ 11862.49","5.078","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":440},{"label":"Mar","value":386},{"label":"Abr","value":476},{"label":"Mai","value":422},{"label":"Jun","value":706},{"label":"Jul","value":621},{"label":"Ago","value":608},{"label":"Set","value":609},{"label":"Out","value":694},{"label":"Nov","value":456},{"label":"Dez","value":532}];
const MX = 706;
