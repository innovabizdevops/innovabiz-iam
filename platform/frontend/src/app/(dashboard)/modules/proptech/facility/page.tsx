...
const PAGE = "Facility Management";
const KPIS = [{"l":"Projetos Melhoria","v":"8.151","t":"+7.5%","d":"up"},{"l":"Savings (€)","v":"€89138","t":"+6.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"73.3%","t":"+2.2%","d":"up"},{"l":"Ciclos PDCA","v":"4.573","t":"+10.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.625","€ 43037.34","867","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","762","€ 33166.66","3.589","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.287","€ 17323.40","6.555","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.381","€ 5410.80","3.739","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","811","€ 15458.09","2.594","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":679},{"label":"Mar","value":832},{"label":"Abr","value":806},{"label":"Mai","value":752},{"label":"Jun","value":954},{"label":"Jul","value":795},{"label":"Ago","value":900},{"label":"Set","value":761},{"label":"Out","value":969},{"label":"Nov","value":743},{"label":"Dez","value":695}];
const MX = 969;
