...
const ACCENT = "#0e7490";
const MODULE = "Real Estate & PropTech";
const PAGE = "CRE Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"3.287","t":"+10.8%","d":"up"},{"l":"Queries/Dia","v":"2402","t":"+17.7%","d":"up"},{"l":"Dados Processados (GB)","v":"1.667","t":"+13.0%","d":"up"},{"l":"Utilizadores Analytics","v":"1.427","t":"+5.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3333","2026-03-26","3.744","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","467","2026-01-03","511","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2478","2026-03-26","735","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2236","2026-03-02","1.014","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","235","2026-02-14","6.643","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":423},{"label":"Fev","value":450},{"label":"Mar","value":744},{"label":"Abr","value":638},{"label":"Mai","value":630},{"label":"Jun","value":651},{"label":"Jul","value":797},{"label":"Ago","value":443},{"label":"Set","value":725},{"label":"Out","value":516},{"label":"Nov","value":535},{"label":"Dez","value":703}];
const MX = 797;
...
export default function CreAnalyticsPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0e7490'}}>Chart</span></h1>
                </div>
