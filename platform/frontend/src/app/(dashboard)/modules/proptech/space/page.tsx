...
const PAGE = "Space Planning";
const KPIS = [{"l":"Quartos Ocupados","v":"8.115","t":"+10.9%","d":"up"},{"l":"RevPAR (€)","v":"€54143","t":"+17.4%","d":"up"},{"l":"Ocupação (%)","v":"74.5%","t":"+15.9%","d":"up"},{"l":"Guest Satisfaction","v":"4.072","t":"+6.5%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","372","2026-02-08","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.469","2026-03-01","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.234","2026-02-13","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.907","2026-01-13","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.033","2026-02-21","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":773},{"label":"Mar","value":771},{"label":"Abr","value":554},{"label":"Mai","value":698},{"label":"Jun","value":569},{"label":"Jul","value":640},{"label":"Ago","value":684},{"label":"Set","value":461},{"label":"Out","value":511},{"label":"Nov","value":520},{"label":"Dez","value":759}];
const MX = 773;
