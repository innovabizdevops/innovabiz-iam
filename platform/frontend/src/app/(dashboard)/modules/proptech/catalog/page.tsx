...
const PAGE = "Property Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"6.994","t":"+3.6%","d":"up"},{"l":"Queries/Dia","v":"145","t":"+8.4%","d":"up"},{"l":"Dados Processados (GB)","v":"5.376","t":"+4.5%","d":"up"},{"l":"Utilizadores Analytics","v":"4.817","t":"+8.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2571","2026-01-13","7.930","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4221","2026-01-27","2.127","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3295","2026-02-03","8.460","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4955","2026-02-27","7.351","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5007","2026-03-25","2.828","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":706},{"label":"Mar","value":837},{"label":"Abr","value":743},{"label":"Mai","value":748},{"label":"Jun","value":788},{"label":"Jul","value":551},{"label":"Ago","value":709},{"label":"Set","value":804},{"label":"Out","value":673},{"label":"Nov","value":694},{"label":"Dez","value":756}];
const MX = 857;
