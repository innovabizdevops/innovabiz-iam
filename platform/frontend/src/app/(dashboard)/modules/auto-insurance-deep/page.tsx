...
/* ═══ Auto Insurance Deep — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "8752", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3615", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€375K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1487800452", cells: ["AUT-2452", "Auto Insurance Deep Item 1", "13/1/2026", "€552"], status: "active" as const },
    { id: "1487804023", cells: ["AUT-6023", "Auto Insurance Deep Item 2", "28/8/2026", "€4123"], status: "pending" as const },
    { id: "1487807594", cells: ["AUT-9594", "Auto Insurance Deep Item 3", "15/3/2026", "€7694"], status: "completed" as const },
    { id: "1487811165", cells: ["AUT-4165", "Auto Insurance Deep Item 4", "2/10/2026", "€11 265"], status: "warning" as const },
    { id: "1487814736", cells: ["AUT-7736", "Auto Insurance Deep Item 5", "17/5/2026", "€14 836"], status: "active" as const },
];
...
export default function AutoInsuranceDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Auto Insurance Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Auto Insurance Deep</p>
                    </div>
                </div>
