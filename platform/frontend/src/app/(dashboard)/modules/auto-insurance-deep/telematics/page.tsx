...
const ACCENT = "#1e3a5f";
const MODULE = "Auto Insurance Deep";
const PAGE = "Telematics";
const KPIS = [{"l":"Total Auto Insurance Deep","v":"1.584","t":"-4.6%","d":"down"},{"l":"Telematics Ativos","v":"4.274","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"80.9%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"94","t":"-4.9%","d":"down"}];
const COLS = ["ID","Telematics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Auto Insurance Deep #001","Auto Insurance Deep #002","1.941","6.562","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Auto Insurance Deep #002","Auto Insurance Deep #003","4.848","3.760","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Auto Insurance Deep #003","Auto Insurance Deep #004","992","2.056","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Auto Insurance Deep #004","Auto Insurance Deep #005","1.462","8.770","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Auto Insurance Deep #005","Auto Insurance Deep #001","7.839","687","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":766},{"label":"Mar","value":534},{"label":"Abr","value":484},{"label":"Mai","value":853},{"label":"Jun","value":730},{"label":"Jul","value":637},{"label":"Ago","value":487},{"label":"Set","value":488},{"label":"Out","value":719},{"label":"Nov","value":685},{"label":"Dez","value":803}];
const MX = 853;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e3a5f'}}>IoT</span></h1>
                </div>
