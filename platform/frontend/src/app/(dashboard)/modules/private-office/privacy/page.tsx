...
const PAGE = "Privacy";
const KPIS = [{"l":"Total Private Office","v":"4.698","t":"+4.7%","d":"up"},{"l":"Privacy Ativos","v":"8.717","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"87.1%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"82","t":"+8.5%","d":"up"}];
const COLS = ["ID","Privacy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Private Office #001","Private Office #002","7.427","7.266","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Private Office #002","Private Office #003","1.227","4.602","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Private Office #003","Private Office #004","1.327","1.261","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Private Office #004","Private Office #005","1.029","8.106","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Private Office #005","Private Office #001","188","1.901","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":483},{"label":"Mar","value":611},{"label":"Abr","value":610},{"label":"Mai","value":845},{"label":"Jun","value":568},{"label":"Jul","value":517},{"label":"Ago","value":598},{"label":"Set","value":779},{"label":"Out","value":622},{"label":"Nov","value":842},{"label":"Dez","value":561}];
const MX = 845;
