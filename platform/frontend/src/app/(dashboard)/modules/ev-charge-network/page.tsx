...
export default function EvChargeNetworkPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Ev Charge Network</h1><p className="text-sm text-muted-foreground">Ev Charge Network • iBOS Enterprise</p></div>
