...
const KPIS = [{"l":"Dashboards Ativos","v":"5.941","t":"+3.0%","d":"up"},{"l":"Queries/Dia","v":"4826","t":"+13.9%","d":"up"},{"l":"Dados Processados (GB)","v":"2.005","t":"-1.0%","d":"down"},{"l":"Utilizadores Analytics","v":"2.899","t":"+-0.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4486","2026-03-24","4.399","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4213","2026-02-27","5.122","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1126","2026-02-14","4.389","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1287","2026-01-20","1.045","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4578","2026-01-08","5.271","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":490},{"label":"Mar","value":756},{"label":"Abr","value":489},{"label":"Mai","value":495},{"label":"Jun","value":735},{"label":"Jul","value":570},{"label":"Ago","value":727},{"label":"Set","value":559},{"label":"Out","value":747},{"label":"Nov","value":480},{"label":"Dez","value":522}];
const MX = 756;
