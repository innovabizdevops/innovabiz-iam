...
const PAGE = "Payment";
const KPIS = [{"l":"Total Ev Charge Network","v":"2.246","t":"-2.9%","d":"down"},{"l":"Payment Ativos","v":"1.997","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"76.3%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"74","t":"+17.6%","d":"up"}];
const COLS = ["ID","Payment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Charge Network #001","Ev Charge Network #002","9.070","9.013","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Charge Network #002","Ev Charge Network #003","3.689","9.079","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Charge Network #003","Ev Charge Network #004","7.590","1.300","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Charge Network #004","Ev Charge Network #005","8.881","5.465","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Charge Network #005","Ev Charge Network #001","1.852","4.859","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":810},{"label":"Mar","value":765},{"label":"Abr","value":808},{"label":"Mai","value":747},{"label":"Jun","value":583},{"label":"Jul","value":775},{"label":"Ago","value":862},{"label":"Set","value":740},{"label":"Out","value":546},{"label":"Nov","value":760},{"label":"Dez","value":866}];
const MX = 866;
