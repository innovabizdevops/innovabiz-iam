...
const PAGE = "Network";
const KPIS = [{"l":"Total Ev Charge Network","v":"4.811","t":"+13.6%","d":"up"},{"l":"Network Ativos","v":"2.448","t":"+7.5%","d":"up"},{"l":"Eficiência (%)","v":"70.6%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"83","t":"-1.0%","d":"down"}];
const COLS = ["ID","Network","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Charge Network #001","Ev Charge Network #002","1.242","2.236","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Charge Network #002","Ev Charge Network #003","7.720","5.951","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Charge Network #003","Ev Charge Network #004","3.811","8.903","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Charge Network #004","Ev Charge Network #005","6.540","2.908","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Charge Network #005","Ev Charge Network #001","2.751","7.091","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":709},{"label":"Mar","value":817},{"label":"Abr","value":558},{"label":"Mai","value":664},{"label":"Jun","value":596},{"label":"Jul","value":641},{"label":"Ago","value":756},{"label":"Set","value":837},{"label":"Out","value":726},{"label":"Nov","value":635},{"label":"Dez","value":585}];
const MX = 837;
