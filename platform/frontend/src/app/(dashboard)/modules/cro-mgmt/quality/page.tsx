...
const KPIS = [{"l":"Auditorias Realizadas","v":"4.762","t":"+10.4%","d":"up"},{"l":"NC Abertas","v":"4.530","t":"+10.7%","d":"up"},{"l":"Conformidade (%)","v":"77.6%","t":"+2.1%","d":"up"},{"l":"CAPAs Pendentes","v":"3.520","t":"+6.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.257","88.6%","5.931","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.645","98.7%","2.683","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","9.075","90.5%","2.070","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.964","87.9%","6.537","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.125","81.2%","7.735","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":513},{"label":"Fev","value":447},{"label":"Mar","value":730},{"label":"Abr","value":553},{"label":"Mai","value":462},{"label":"Jun","value":735},{"label":"Jul","value":557},{"label":"Ago","value":809},{"label":"Set","value":674},{"label":"Out","value":797},{"label":"Nov","value":786},{"label":"Dez","value":498}];
const MX = 809;
