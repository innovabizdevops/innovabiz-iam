...
const PAGE = "Milestone Pay";
const KPIS = [{"l":"Total Cro Mgmt","v":"8.399","t":"+5.1%","d":"up"},{"l":"Milestone Pay Ativos","v":"8.193","t":"+2.9%","d":"up"},{"l":"Eficiência (%)","v":"80.6%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"82","t":"+15.3%","d":"up"}];
const COLS = ["ID","Milestone Pay","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cro Mgmt #001","Cro Mgmt #002","266","7.671","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Cro Mgmt #002","Cro Mgmt #003","3.793","7.100","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Cro Mgmt #003","Cro Mgmt #004","7.649","6.379","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Cro Mgmt #004","Cro Mgmt #005","124","1.341","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cro Mgmt #005","Cro Mgmt #001","3.479","5.463","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":401},{"label":"Fev","value":497},{"label":"Mar","value":367},{"label":"Abr","value":638},{"label":"Mai","value":494},{"label":"Jun","value":359},{"label":"Jul","value":420},{"label":"Ago","value":489},{"label":"Set","value":366},{"label":"Out","value":620},{"label":"Nov","value":366},{"label":"Dez","value":654}];
const MX = 654;
