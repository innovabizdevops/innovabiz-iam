...
const KPIS = [{"l":"Total Cro Mgmt","v":"6.550","t":"+7.5%","d":"up"},{"l":"Data Transfer Ativos","v":"7.608","t":"+8.0%","d":"up"},{"l":"Eficiência (%)","v":"76.6%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"67","t":"+16.1%","d":"up"}];
const COLS = ["ID","Data Transfer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cro Mgmt #001","2026-03-19","2.225","5.262","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Cro Mgmt #002","2026-02-06","881","4.302","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Cro Mgmt #003","2026-01-03","8.606","1.110","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Cro Mgmt #004","2026-01-25","4.255","7.505","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cro Mgmt #005","2026-03-11","4.457","6.495","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":896},{"label":"Fev","value":658},{"label":"Mar","value":955},{"label":"Abr","value":693},{"label":"Mai","value":1002},{"label":"Jun","value":944},{"label":"Jul","value":706},{"label":"Ago","value":874},{"label":"Set","value":935},{"label":"Out","value":825},{"label":"Nov","value":920},{"label":"Dez","value":993}];
const MX = 1002;
