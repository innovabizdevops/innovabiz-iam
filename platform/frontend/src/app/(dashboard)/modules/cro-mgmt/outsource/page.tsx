...
const ACCENT = "#4338ca";
const MODULE = "CRO Management";
const PAGE = "Study Outsource";
const KPIS = [{"l":"Total Cro Mgmt","v":"403","t":"+17.9%","d":"up"},{"l":"Study Outsource Ativos","v":"4.332","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"-0.9%","d":"down"},{"l":"Score Performance","v":"89","t":"+11.5%","d":"up"}];
const COLS = ["ID","Study Outsource","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cro Mgmt #001","Cro Mgmt #002","8.411","2.445","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Cro Mgmt #002","Cro Mgmt #003","1.320","8.972","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Cro Mgmt #003","Cro Mgmt #004","9.013","521","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Cro Mgmt #004","Cro Mgmt #005","5.559","4.848","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cro Mgmt #005","Cro Mgmt #001","602","3.208","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":677},{"label":"Mar","value":577},{"label":"Abr","value":778},{"label":"Mai","value":426},{"label":"Jun","value":634},{"label":"Jul","value":633},{"label":"Ago","value":716},{"label":"Set","value":761},{"label":"Out","value":595},{"label":"Nov","value":427},{"label":"Dez","value":650}];
const MX = 778;
