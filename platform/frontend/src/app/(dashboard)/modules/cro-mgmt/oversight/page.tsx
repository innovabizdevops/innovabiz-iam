...
const PAGE = "Oversight";
const KPIS = [{"l":"Total Cro Mgmt","v":"3.737","t":"+13.6%","d":"up"},{"l":"Oversight Ativos","v":"7.216","t":"+7.2%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"85","t":"+12.3%","d":"up"}];
const COLS = ["ID","Oversight","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cro Mgmt #001","Cro Mgmt #002","308","6.702","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Cro Mgmt #002","Cro Mgmt #003","4.483","9.096","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Cro Mgmt #003","Cro Mgmt #004","1.495","912","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Cro Mgmt #004","Cro Mgmt #005","5.341","8.316","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cro Mgmt #005","Cro Mgmt #001","8.102","1.566","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":226},{"label":"Fev","value":334},{"label":"Mar","value":508},{"label":"Abr","value":516},{"label":"Mai","value":388},{"label":"Jun","value":534},{"label":"Jul","value":484},{"label":"Ago","value":240},{"label":"Set","value":600},{"label":"Out","value":399},{"label":"Nov","value":477},{"label":"Dez","value":231}];
const MX = 600;
