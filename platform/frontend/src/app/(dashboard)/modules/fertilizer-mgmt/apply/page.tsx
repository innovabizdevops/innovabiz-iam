...
const KPIS = [{"l":"Total Fertilizer Mgmt","v":"2.990","t":"-3.9%","d":"down"},{"l":"Application Ativos","v":"3.158","t":"+0.8%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"85","t":"+5.5%","d":"up"}];
const COLS = ["ID","Application","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fertilizer Mgmt #001","Fertilizer Mgmt #002","5.272","1.636","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Fertilizer Mgmt #002","Fertilizer Mgmt #003","2.575","8.211","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Fertilizer Mgmt #003","Fertilizer Mgmt #004","3.759","582","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Fertilizer Mgmt #004","Fertilizer Mgmt #005","232","4.220","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fertilizer Mgmt #005","Fertilizer Mgmt #001","7.867","4.735","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":874},{"label":"Fev","value":771},{"label":"Mar","value":611},{"label":"Abr","value":515},{"label":"Mai","value":789},{"label":"Jun","value":607},{"label":"Jul","value":761},{"label":"Ago","value":764},{"label":"Set","value":591},{"label":"Out","value":844},{"label":"Nov","value":817},{"label":"Dez","value":796}];
const MX = 874;
