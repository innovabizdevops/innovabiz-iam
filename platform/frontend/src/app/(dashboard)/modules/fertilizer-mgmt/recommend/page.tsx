...
const ACCENT = "#6366f1";
const MODULE = "Fertilizer Management";
const PAGE = "Recommend";
const KPIS = [{"l":"Total Fertilizer Mgmt","v":"8.250","t":"+5.5%","d":"up"},{"l":"Recommend Ativos","v":"5.236","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"83.7%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"58","t":"+1.7%","d":"up"}];
const COLS = ["ID","Recommend","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fertilizer Mgmt #001","Fertilizer Mgmt #002","3.054","6.985","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Fertilizer Mgmt #002","Fertilizer Mgmt #003","8.433","799","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Fertilizer Mgmt #003","Fertilizer Mgmt #004","2.679","1.117","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Fertilizer Mgmt #004","Fertilizer Mgmt #005","566","4.952","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fertilizer Mgmt #005","Fertilizer Mgmt #001","5.308","6.664","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":886},{"label":"Fev","value":680},{"label":"Mar","value":552},{"label":"Abr","value":806},{"label":"Mai","value":661},{"label":"Jun","value":905},{"label":"Jul","value":882},{"label":"Ago","value":801},{"label":"Set","value":806},{"label":"Out","value":688},{"label":"Nov","value":867},{"label":"Dez","value":711}];
const MX = 905;
