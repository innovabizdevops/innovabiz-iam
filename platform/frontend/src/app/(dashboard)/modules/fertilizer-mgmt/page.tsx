...
export default function FertilizerMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Fertilizer Mgmt</h1><p className="text-sm text-muted-foreground">Fertilizer Mgmt • iBOS Enterprise</p></div>
