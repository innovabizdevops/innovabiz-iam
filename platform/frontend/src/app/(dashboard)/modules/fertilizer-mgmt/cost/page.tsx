...
const PAGE = "Cost";
const KPIS = [{"l":"Total Fertilizer Mgmt","v":"7.490","t":"+12.0%","d":"up"},{"l":"Cost Ativos","v":"3.595","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"72.7%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"82","t":"+15.6%","d":"up"}];
const COLS = ["ID","Cost","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fertilizer Mgmt #001","Fertilizer Mgmt #002","6.479","2.789","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Fertilizer Mgmt #002","Fertilizer Mgmt #003","2.806","8.172","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Fertilizer Mgmt #003","Fertilizer Mgmt #004","6.761","743","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Fertilizer Mgmt #004","Fertilizer Mgmt #005","5.793","4.867","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fertilizer Mgmt #005","Fertilizer Mgmt #001","621","4.972","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":925},{"label":"Fev","value":753},{"label":"Mar","value":1092},{"label":"Abr","value":931},{"label":"Mai","value":875},{"label":"Jun","value":875},{"label":"Jul","value":1019},{"label":"Ago","value":698},{"label":"Set","value":792},{"label":"Out","value":773},{"label":"Nov","value":974},{"label":"Dez","value":1055}];
const MX = 1092;
