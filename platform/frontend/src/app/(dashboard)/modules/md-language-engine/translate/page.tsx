...
const ACCENT = "#7c2d12";
const MODULE = "MD: Multi-Language Deep";
const PAGE = "Translate";
const KPIS = [{"l":"Tickets Abertos","v":"241","t":"+0.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"78.8%","t":"+10.6%","d":"up"},{"l":"MTTR (h)","v":"121h","t":"-1.0%","d":"down"},{"l":"Satisfação (%)","v":"73.2%","t":"+17.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.248","5.240","5.877","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.857","6.673","3.719","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.817","6.131","5.906","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.191","280","5.709","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.300","7.676","8.822","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":887},{"label":"Fev","value":769},{"label":"Mar","value":648},{"label":"Abr","value":647},{"label":"Mai","value":527},{"label":"Jun","value":527},{"label":"Jul","value":794},{"label":"Ago","value":816},{"label":"Set","value":636},{"label":"Out","value":819},{"label":"Nov","value":714},{"label":"Dez","value":791}];
const MX = 887;
