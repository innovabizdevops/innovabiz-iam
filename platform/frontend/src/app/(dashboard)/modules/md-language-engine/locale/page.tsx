...
const PAGE = "Locale";
const KPIS = [{"l":"Configurações","v":"5.050","t":"-3.6%","d":"down"},{"l":"Últimas Alterações","v":"2.056","t":"-0.8%","d":"down"},{"l":"Ambientes","v":"8.074","t":"+5.5%","d":"up"},{"l":"Versão Config","v":"2.122","t":"-0.6%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 15132.94","8.553","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 25799.42","1.073","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 20655.37","6.436","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 10656.07","7.315","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 34236.38","3.598","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":462},{"label":"Mar","value":609},{"label":"Abr","value":603},{"label":"Mai","value":372},{"label":"Jun","value":346},{"label":"Jul","value":319},{"label":"Ago","value":368},{"label":"Set","value":419},{"label":"Out","value":553},{"label":"Nov","value":626},{"label":"Dez","value":425}];
const MX = 627;
