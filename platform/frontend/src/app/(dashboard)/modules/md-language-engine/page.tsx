...
/* ═══ MD: Multi-Language Deep — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "6468", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2234", trend: "+13%", trendDirection: "up" as const, icon: Users },
...
const TABLE_ROWS = [
    { id: "141120968", cells: ["MD-1968", "MD: Multi-Language Deep Item 1", "17/9/2026", "€21 068"], status: "active" as const },
    { id: "141124539", cells: ["MD-5539", "MD: Multi-Language Deep Item 2", "4/4/2026", "€24 639"], status: "pending" as const },
    { id: "141128110", cells: ["MD-9110", "MD: Multi-Language Deep Item 3", "19/11/2026", "€28 210"], status: "completed" as const },
    { id: "141131681", cells: ["MD-3681", "MD: Multi-Language Deep Item 4", "6/6/2026", "€31 781"], status: "warning" as const },
    { id: "141135252", cells: ["MD-7252", "MD: Multi-Language Deep Item 5", "21/1/2026", "€35 352"], status: "active" as const },
];
...
export default function MdMultilanguageDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Language Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Language Deep</p>
                    </div>
                </div>
