...
const PAGE = "Renewable Integration";
const KPIS = [{"l":"Integrações Ativas","v":"7.373","t":"+17.6%","d":"up"},{"l":"Chamadas/Hora","v":"4938","t":"+1.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.8%","t":"+14.4%","d":"up"},{"l":"Latência Média (ms)","v":"50ms","t":"+1.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","624","7.799","91.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.671","8.513","96.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","305","6.318","97.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.394","158","91.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.611","2.737","72.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":335},{"label":"Fev","value":480},{"label":"Mar","value":671},{"label":"Abr","value":543},{"label":"Mai","value":336},{"label":"Jun","value":669},{"label":"Jul","value":343},{"label":"Ago","value":696},{"label":"Set","value":339},{"label":"Out","value":438},{"label":"Nov","value":570},{"label":"Dez","value":309}];
const MX = 696;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ca8a04'}}>ESG</span></h1>
                </div>
