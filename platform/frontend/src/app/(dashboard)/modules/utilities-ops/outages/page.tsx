...
const KPIS = [{"l":"Projetos Melhoria","v":"2.358","t":"+12.6%","d":"up"},{"l":"Savings (€)","v":"€29031","t":"+17.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"91.0%","t":"-0.4%","d":"down"},{"l":"Ciclos PDCA","v":"915","t":"-1.6%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","916","€ 21054.32","2.555","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.026","€ 14258.29","7.714","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.059","€ 48608.27","4.770","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","152","€ 36774.76","3.768","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.917","€ 38914.96","1.514","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":622},{"label":"Mar","value":686},{"label":"Abr","value":368},{"label":"Mai","value":520},{"label":"Jun","value":384},{"label":"Jul","value":439},{"label":"Ago","value":679},{"label":"Set","value":708},{"label":"Out","value":702},{"label":"Nov","value":513},{"label":"Dez","value":384}];
const MX = 708;
