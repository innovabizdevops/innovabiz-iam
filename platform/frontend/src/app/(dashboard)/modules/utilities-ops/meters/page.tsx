...
const PAGE = "Meter Management";
const KPIS = [{"l":"Projetos Melhoria","v":"8.474","t":"+8.6%","d":"up"},{"l":"Savings (€)","v":"€4894","t":"+16.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"84.5%","t":"+6.1%","d":"up"},{"l":"Ciclos PDCA","v":"6.637","t":"+4.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","510","€ 45932.66","1.896","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.969","€ 6507.20","7.876","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.507","€ 48929.28","2.784","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.723","€ 37428.58","1.987","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.894","€ 26734.04","461","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":844},{"label":"Fev","value":868},{"label":"Mar","value":652},{"label":"Abr","value":927},{"label":"Mai","value":601},{"label":"Jun","value":754},{"label":"Jul","value":888},{"label":"Ago","value":569},{"label":"Set","value":775},{"label":"Out","value":817},{"label":"Nov","value":646},{"label":"Dez","value":894}];
const MX = 927;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ca8a04'}}>IoT</span></h1>
                </div>
