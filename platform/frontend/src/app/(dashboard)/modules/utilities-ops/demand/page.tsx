...
const PAGE = "Demand Response";
const KPIS = [{"l":"Total Utilities Ops","v":"4.127","t":"+14.4%","d":"up"},{"l":"Demand Response Ativos","v":"3.759","t":"+3.3%","d":"up"},{"l":"Eficiência (%)","v":"89.0%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"70","t":"+9.4%","d":"up"}];
const COLS = ["ID","Demand Response","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Utilities Ops #001","Utilities Ops #002","5.689","3.011","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Utilities Ops #002","Utilities Ops #003","8.445","5.709","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Utilities Ops #003","Utilities Ops #004","6.010","4.706","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Utilities Ops #004","Utilities Ops #005","4.892","2.897","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Utilities Ops #005","Utilities Ops #001","5.443","7.442","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":876},{"label":"Fev","value":657},{"label":"Mar","value":502},{"label":"Abr","value":568},{"label":"Mai","value":512},{"label":"Jun","value":863},{"label":"Jul","value":579},{"label":"Ago","value":863},{"label":"Set","value":711},{"label":"Out","value":828},{"label":"Nov","value":771},{"label":"Dez","value":693}];
const MX = 876;
