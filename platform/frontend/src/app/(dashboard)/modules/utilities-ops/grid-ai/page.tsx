...
const ACCENT = "#ca8a04";
const MODULE = "Utilities Operations";
const PAGE = "Grid Analytics AI";
const KPIS = [{"l":"Dashboards Ativos","v":"4.609","t":"+6.1%","d":"up"},{"l":"Queries/Dia","v":"1584","t":"-0.9%","d":"down"},{"l":"Dados Processados (GB)","v":"1.391","t":"+11.1%","d":"up"},{"l":"Utilizadores Analytics","v":"241","t":"-3.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4660","2026-02-08","5.667","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3873","2026-01-27","6.091","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","845","2026-01-15","4.392","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3595","2026-01-17","8.498","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3699","2026-03-04","740","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":354},{"label":"Fev","value":539},{"label":"Mar","value":402},{"label":"Abr","value":253},{"label":"Mai","value":473},{"label":"Jun","value":391},{"label":"Jul","value":539},{"label":"Ago","value":293},{"label":"Set","value":432},{"label":"Out","value":345},{"label":"Nov","value":476},{"label":"Dez","value":369}];
const MX = 539;
...
export default function GridAiPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ca8a04'}}>AI</span></h1>
                </div>
