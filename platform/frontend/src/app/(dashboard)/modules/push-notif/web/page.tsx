...
const PAGE = "Web Push";
const KPIS = [{"l":"Notificações Enviadas","v":"6.661","t":"+15.4%","d":"up"},{"l":"Taxa Entrega (%)","v":"89.6%","t":"+4.3%","d":"up"},{"l":"Taxa Abertura (%)","v":"84.7%","t":"+1.4%","d":"up"},{"l":"Escalações","v":"5.865","t":"+4.2%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","5.551","85.8%","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","7.944","83.7%","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","4.642","88.9%","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","3.495","70.5%","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","610","84.7%","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":341},{"label":"Fev","value":388},{"label":"Mar","value":452},{"label":"Abr","value":372},{"label":"Mai","value":426},{"label":"Jun","value":292},{"label":"Jul","value":505},{"label":"Ago","value":506},{"label":"Set","value":446},{"label":"Out","value":597},{"label":"Nov","value":348},{"label":"Dez","value":278}];
const MX = 597;
