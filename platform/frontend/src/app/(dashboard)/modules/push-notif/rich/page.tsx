...
const PAGE = "Rich Media";
const KPIS = [{"l":"Integrações Ativas","v":"3.189","t":"+11.0%","d":"up"},{"l":"Chamadas/Hora","v":"4993","t":"+0.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.3%","t":"+-0.0%","d":"up"},{"l":"Latência Média (ms)","v":"33ms","t":"+6.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.348","4.098","96.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.050","3.994","77.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.859","4.267","96.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.576","1.196","81.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.810","836","73.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":786},{"label":"Mar","value":664},{"label":"Abr","value":654},{"label":"Mai","value":825},{"label":"Jun","value":632},{"label":"Jul","value":530},{"label":"Ago","value":898},{"label":"Set","value":897},{"label":"Out","value":691},{"label":"Nov","value":714},{"label":"Dez","value":577}];
const MX = 898;
