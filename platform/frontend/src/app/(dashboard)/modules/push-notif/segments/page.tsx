...
const KPIS = [{"l":"Perfis Unificados","v":"3.943","t":"-5.6%","d":"down"},{"l":"Segmentos Ativos","v":"3.759","t":"+16.8%","d":"up"},{"l":"NPS Score","v":"61","t":"+7.3%","d":"up"},{"l":"Churn Previsto (%)","v":"72.8%","t":"-0.1%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","4.516","€ 3712.57","75.9%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","6.173","€ 35033.63","71.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","4.903","€ 39249.45","94.5%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","1.024","€ 10505.03","96.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","8.698","€ 35775.11","87.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":248},{"label":"Fev","value":393},{"label":"Mar","value":544},{"label":"Abr","value":631},{"label":"Mai","value":331},{"label":"Jun","value":469},{"label":"Jul","value":628},{"label":"Ago","value":534},{"label":"Set","value":423},{"label":"Out","value":604},{"label":"Nov","value":571},{"label":"Dez","value":312}];
const MX = 631;
