...
const PAGE = "Mobile Push";
const KPIS = [{"l":"Notificações Enviadas","v":"4.596","t":"+17.9%","d":"up"},{"l":"Taxa Entrega (%)","v":"86.6%","t":"-5.9%","d":"down"},{"l":"Taxa Abertura (%)","v":"94.2%","t":"-3.5%","d":"down"},{"l":"Escalações","v":"8.231","t":"+1.8%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","4.974","83.4%","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","3.298","99.1%","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","2.806","73.0%","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","7.590","88.4%","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","7.128","84.0%","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":322},{"label":"Mar","value":379},{"label":"Abr","value":471},{"label":"Mai","value":499},{"label":"Jun","value":380},{"label":"Jul","value":377},{"label":"Ago","value":477},{"label":"Set","value":451},{"label":"Out","value":564},{"label":"Nov","value":497},{"label":"Dez","value":482}];
const MX = 564;
