...
const ACCENT = "#b45309";
const MODULE = "Push Notifications";
const PAGE = "Frequency Cap";
const KPIS = [{"l":"Notificações Enviadas","v":"5.565","t":"+15.2%","d":"up"},{"l":"Taxa Entrega (%)","v":"65.2%","t":"+9.3%","d":"up"},{"l":"Taxa Abertura (%)","v":"69.4%","t":"+17.0%","d":"up"},{"l":"Escalações","v":"1.388","t":"+1.6%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","3.702","86.9%","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","6.567","82.3%","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","6.664","97.0%","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","7.833","72.9%","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","4.471","87.7%","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":801},{"label":"Mar","value":839},{"label":"Abr","value":644},{"label":"Mai","value":734},{"label":"Jun","value":977},{"label":"Jul","value":751},{"label":"Ago","value":811},{"label":"Set","value":784},{"label":"Out","value":994},{"label":"Nov","value":974},{"label":"Dez","value":922}];
const MX = 994;
