...
const ACCENT = "#6366f1";
const MODULE = "Vertical Mobility";
const PAGE = "Vertiport";
const KPIS = [{"l":"Total Vertical Mobility","v":"4.651","t":"+8.3%","d":"up"},{"l":"Vertiport Ativos","v":"2.873","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"82.0%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"74","t":"-5.9%","d":"down"}];
const COLS = ["ID","Vertiport","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vertical Mobility #001","Vertical Mobility #002","5.189","3.359","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Vertical Mobility #002","Vertical Mobility #003","639","678","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Vertical Mobility #003","Vertical Mobility #004","250","5.504","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Vertical Mobility #004","Vertical Mobility #005","7.663","952","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vertical Mobility #005","Vertical Mobility #001","7.930","1.994","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":501},{"label":"Fev","value":524},{"label":"Mar","value":605},{"label":"Abr","value":603},{"label":"Mai","value":606},{"label":"Jun","value":632},{"label":"Jul","value":860},{"label":"Ago","value":872},{"label":"Set","value":665},{"label":"Out","value":725},{"label":"Nov","value":830},{"label":"Dez","value":874}];
const MX = 874;
...
export default function VertiportPage() {
    return (
