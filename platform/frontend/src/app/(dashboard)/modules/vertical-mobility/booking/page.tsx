...
const PAGE = "Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"4.618","t":"+11.3%","d":"up"},{"l":"RevPAR (€)","v":"€88928","t":"-3.2%","d":"down"},{"l":"Ocupação (%)","v":"81.0%","t":"-3.0%","d":"down"},{"l":"Guest Satisfaction","v":"2.234","t":"-5.3%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.116","2026-01-27","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","5.252","2026-01-10","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.290","2026-01-19","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.747","2026-01-14","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.835","2026-03-18","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":716},{"label":"Mar","value":379},{"label":"Abr","value":615},{"label":"Mai","value":520},{"label":"Jun","value":445},{"label":"Jul","value":633},{"label":"Ago","value":442},{"label":"Set","value":679},{"label":"Out","value":561},{"label":"Nov","value":473},{"label":"Dez","value":745}];
const MX = 745;
