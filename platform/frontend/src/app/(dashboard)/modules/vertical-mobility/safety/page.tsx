...
const PAGE = "Safety";
const KPIS = [{"l":"Total Vertical Mobility","v":"5.156","t":"-1.5%","d":"down"},{"l":"Safety Ativos","v":"199","t":"+4.8%","d":"up"},{"l":"Eficiência (%)","v":"65.7%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"87","t":"+17.5%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vertical Mobility #001","Vertical Mobility #002","3.555","4.520","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Vertical Mobility #002","Vertical Mobility #003","8.966","1.866","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Vertical Mobility #003","Vertical Mobility #004","6.754","4.487","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Vertical Mobility #004","Vertical Mobility #005","1.213","2.844","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vertical Mobility #005","Vertical Mobility #001","7.988","3.715","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":895},{"label":"Fev","value":954},{"label":"Mar","value":941},{"label":"Abr","value":872},{"label":"Mai","value":922},{"label":"Jun","value":832},{"label":"Jul","value":925},{"label":"Ago","value":1028},{"label":"Set","value":650},{"label":"Out","value":1031},{"label":"Nov","value":871},{"label":"Dez","value":983}];
const MX = 1031;
