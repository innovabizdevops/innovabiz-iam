...
const KPIS = [
    ...
    { label: "Ativos", value: "3645", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€205K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1781749216", cells: ["WED-2216", "Wedding Photography Item 1", "17/5/2026", "€49 316"], status: "active" as const },
    { id: "1781752787", cells: ["WED-5787", "Wedding Photography Item 2", "4/12/2026", "€2887"], status: "pending" as const },
    { id: "1781756358", cells: ["WED-9358", "Wedding Photography Item 3", "19/7/2026", "€6458"], status: "completed" as const },
    { id: "1781759929", cells: ["WED-3929", "Wedding Photography Item 4", "6/2/2026", "€10 029"], status: "warning" as const },
    { id: "1781763500", cells: ["WED-7500", "Wedding Photography Item 5", "21/9/2026", "€13 600"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wedding Photography</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Wedding Photography</p>
                    </div>
                </div>
