...
const ACCENT = "#be185d";
const MODULE = "Wedding Photography";
const PAGE = "Deliver";
const KPIS = [{"l":"Total Wedding Photo","v":"5.091","t":"+5.3%","d":"up"},{"l":"Deliver Ativos","v":"7.053","t":"-5.7%","d":"down"},{"l":"Eficiência (%)","v":"85.1%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"68","t":"-0.2%","d":"down"}];
const COLS = ["ID","Deliver","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wedding Photo #001","Wedding Photo #002","1.480","3.203","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Wedding Photo #002","Wedding Photo #003","2.994","1.432","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Wedding Photo #003","Wedding Photo #004","8.873","7.009","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Wedding Photo #004","Wedding Photo #005","5.382","6.649","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wedding Photo #005","Wedding Photo #001","1.977","7.868","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":365},{"label":"Mar","value":724},{"label":"Abr","value":692},{"label":"Mai","value":669},{"label":"Jun","value":481},{"label":"Jul","value":680},{"label":"Ago","value":583},{"label":"Set","value":552},{"label":"Out","value":504},{"label":"Nov","value":760},{"label":"Dez","value":718}];
const MX = 760;
