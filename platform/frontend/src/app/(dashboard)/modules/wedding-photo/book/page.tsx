...
const PAGE = "Book";
const KPIS = [{"l":"Total Wedding Photo","v":"617","t":"+17.3%","d":"up"},{"l":"Book Ativos","v":"2.286","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"87.1%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"66","t":"+9.0%","d":"up"}];
const COLS = ["ID","Book","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wedding Photo #001","Wedding Photo #002","2.223","2.182","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Wedding Photo #002","Wedding Photo #003","4.569","1.097","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Wedding Photo #003","Wedding Photo #004","6.748","6.320","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Wedding Photo #004","Wedding Photo #005","1.357","7.570","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wedding Photo #005","Wedding Photo #001","6.925","4.961","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":462},{"label":"Fev","value":761},{"label":"Mar","value":424},{"label":"Abr","value":525},{"label":"Mai","value":787},{"label":"Jun","value":548},{"label":"Jul","value":660},{"label":"Ago","value":792},{"label":"Set","value":731},{"label":"Out","value":646},{"label":"Nov","value":548},{"label":"Dez","value":649}];
const MX = 792;
