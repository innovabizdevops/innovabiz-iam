...
const PAGE = "Edit";
const KPIS = [{"l":"Integrações Ativas","v":"3.912","t":"+1.3%","d":"up"},{"l":"Chamadas/Hora","v":"1880","t":"-2.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"75.8%","t":"+15.2%","d":"up"},{"l":"Latência Média (ms)","v":"106ms","t":"-5.1%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.275","4.665","87.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.956","3.529","79.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.932","1.879","83.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.131","7.002","72.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.347","257","87.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":836},{"label":"Mar","value":576},{"label":"Abr","value":652},{"label":"Mai","value":742},{"label":"Jun","value":894},{"label":"Jul","value":852},{"label":"Ago","value":622},{"label":"Set","value":632},{"label":"Out","value":852},{"label":"Nov","value":572},{"label":"Dez","value":635}];
const MX = 894;
