...
const PAGE = "Parental";
const KPIS = [{"l":"Total Game Safety","v":"5.339","t":"+8.2%","d":"up"},{"l":"Parental Ativos","v":"3.928","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"94.1%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"68","t":"+17.1%","d":"up"}];
const COLS = ["ID","Parental","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Game Safety #001","Game Safety #002","3.227","8.236","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Game Safety #002","Game Safety #003","3.822","2.825","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Game Safety #003","Game Safety #004","1.009","1.055","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Game Safety #004","Game Safety #005","5.969","8.189","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Game Safety #005","Game Safety #001","5.814","3.919","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":537},{"label":"Fev","value":440},{"label":"Mar","value":257},{"label":"Abr","value":499},{"label":"Mai","value":460},{"label":"Jun","value":418},{"label":"Jul","value":596},{"label":"Ago","value":608},{"label":"Set","value":279},{"label":"Out","value":484},{"label":"Nov","value":475},{"label":"Dez","value":367}];
const MX = 608;
