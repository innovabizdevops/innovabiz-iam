...
const ACCENT = "#ec4899";
const MODULE = "Game Safety";
const PAGE = "Content Mod";
const KPIS = [{"l":"Total Game Safety","v":"2.882","t":"+17.0%","d":"up"},{"l":"Content Mod Ativos","v":"8.567","t":"+4.0%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"84","t":"+12.4%","d":"up"}];
const COLS = ["ID","Content Mod","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Game Safety #001","Game Safety #002","6.679","5.155","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Game Safety #002","Game Safety #003","6.430","7.602","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Game Safety #003","Game Safety #004","3.729","2.405","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Game Safety #004","Game Safety #005","7.075","6.046","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Game Safety #005","Game Safety #001","5.440","1.841","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":374},{"label":"Mar","value":442},{"label":"Abr","value":549},{"label":"Mai","value":641},{"label":"Jun","value":399},{"label":"Jul","value":517},{"label":"Ago","value":373},{"label":"Set","value":475},{"label":"Out","value":583},{"label":"Nov","value":457},{"label":"Dez","value":452}];
const MX = 650;
