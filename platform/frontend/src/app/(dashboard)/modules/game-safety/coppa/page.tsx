...
const PAGE = "COPPA Comply";
const KPIS = [{"l":"Total Game Safety","v":"4.592","t":"+11.6%","d":"up"},{"l":"COPPA Comply Ativos","v":"4.488","t":"+5.7%","d":"up"},{"l":"Eficiência (%)","v":"67.0%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"73","t":"+10.0%","d":"up"}];
const COLS = ["ID","COPPA Comply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Game Safety #001","Game Safety #002","1.336","2.175","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Game Safety #002","Game Safety #003","4.587","1.024","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Game Safety #003","Game Safety #004","8.110","4.124","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Game Safety #004","Game Safety #005","6.478","5.544","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Game Safety #005","Game Safety #001","6.164","644","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":832},{"label":"Fev","value":644},{"label":"Mar","value":695},{"label":"Abr","value":591},{"label":"Mai","value":548},{"label":"Jun","value":576},{"label":"Jul","value":497},{"label":"Ago","value":869},{"label":"Set","value":754},{"label":"Out","value":755},{"label":"Nov","value":485},{"label":"Dez","value":836}];
const MX = 869;
