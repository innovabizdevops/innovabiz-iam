...
const PAGE = "Report Track";
const KPIS = [{"l":"Total Game Safety","v":"1.417","t":"+11.7%","d":"up"},{"l":"Report Track Ativos","v":"716","t":"+7.2%","d":"up"},{"l":"Eficiência (%)","v":"79.6%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"92","t":"+8.5%","d":"up"}];
const COLS = ["ID","Report Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Game Safety #001","Game Safety #002","7.477","5.737","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Game Safety #002","Game Safety #003","2.284","6.889","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Game Safety #003","Game Safety #004","237","3.080","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Game Safety #004","Game Safety #005","2.112","9.011","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Game Safety #005","Game Safety #001","8.428","4.082","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":459},{"label":"Fev","value":547},{"label":"Mar","value":278},{"label":"Abr","value":297},{"label":"Mai","value":460},{"label":"Jun","value":546},{"label":"Jul","value":396},{"label":"Ago","value":494},{"label":"Set","value":613},{"label":"Out","value":230},{"label":"Nov","value":619},{"label":"Dez","value":537}];
const MX = 619;
