...
const KPIS = [{"l":"Total Game Safety","v":"2.760","t":"+2.5%","d":"up"},{"l":"Age Verify Ativos","v":"8.872","t":"-3.8%","d":"down"},{"l":"Eficiência (%)","v":"78.5%","t":"+17.8%","d":"up"},{"l":"Score Performance","v":"64","t":"+7.7%","d":"up"}];
const COLS = ["ID","Age Verify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Game Safety #001","Game Safety #002","2.301","3.456","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Game Safety #002","Game Safety #003","3.174","5.269","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Game Safety #003","Game Safety #004","5.784","2.049","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Game Safety #004","Game Safety #005","1.183","612","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Game Safety #005","Game Safety #001","5.265","224","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":274},{"label":"Mar","value":404},{"label":"Abr","value":637},{"label":"Mai","value":358},{"label":"Jun","value":312},{"label":"Jul","value":569},{"label":"Ago","value":577},{"label":"Set","value":404},{"label":"Out","value":573},{"label":"Nov","value":512},{"label":"Dez","value":293}];
const MX = 637;
