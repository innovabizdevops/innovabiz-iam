...
/* ═══ Luxury Brand — Concierge Digital ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "707", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "175", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "859", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "305057051", cells: ["LUX-3051", "Concierge Digital Item 1", "20/12/2026", "€7151"], status: "active" as const },
    { id: "305060622", cells: ["LUX-6622", "Concierge Digital Item 2", "7/7/2026", "€10 722"], status: "pending" as const },
    { id: "305064193", cells: ["LUX-1193", "Concierge Digital Item 3", "22/2/2026", "€14 293"], status: "completed" as const },
    { id: "305067764", cells: ["LUX-4764", "Concierge Digital Item 4", "9/9/2026", "€17 864"], status: "warning" as const },
    { id: "305071335", cells: ["LUX-8335", "Concierge Digital Item 5", "24/4/2026", "€21 435"], status: "active" as const },
];
...
export default function LuxuryBrandConciergeDigitalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Concierge Digital</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Luxury Brand • Concierge Digital</p>
                    </div>
                </div>
