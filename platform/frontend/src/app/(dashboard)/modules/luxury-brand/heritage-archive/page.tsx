...
/* ═══ Luxury Brand — Heritage Archive ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "1912", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "77", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1164", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "76%", trend: "-2%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1647801369", cells: ["LUX-1369", "Heritage Archive Item 1", "26/10/2026", "€1469"], status: "active" as const },
    { id: "1647804940", cells: ["LUX-4940", "Heritage Archive Item 2", "13/5/2026", "€5040"], status: "pending" as const },
    { id: "1647808511", cells: ["LUX-8511", "Heritage Archive Item 3", "28/12/2026", "€8611"], status: "completed" as const },
    { id: "1647812082", cells: ["LUX-3082", "Heritage Archive Item 4", "15/7/2026", "€12 182"], status: "warning" as const },
    { id: "1647815653", cells: ["LUX-6653", "Heritage Archive Item 5", "2/2/2026", "€15 753"], status: "active" as const },
];
...
export default function LuxuryBrandHeritageArchivePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Heritage Archive</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Luxury Brand • Heritage Archive</p>
                    </div>
                </div>
