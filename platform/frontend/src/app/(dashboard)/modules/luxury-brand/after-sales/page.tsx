...
/* ═══ Luxury Brand — After Sales ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "4664", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "418", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3436", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "32769662", cells: ["LUX-1662", "After Sales Item 1", "3/3/2026", "€19 762"], status: "active" as const },
    { id: "32773233", cells: ["LUX-5233", "After Sales Item 2", "18/10/2026", "€23 333"], status: "pending" as const },
    { id: "32776804", cells: ["LUX-8804", "After Sales Item 3", "5/5/2026", "€26 904"], status: "completed" as const },
    { id: "32780375", cells: ["LUX-3375", "After Sales Item 4", "20/12/2026", "€30 475"], status: "warning" as const },
    { id: "32783946", cells: ["LUX-6946", "After Sales Item 5", "7/7/2026", "€34 046"], status: "active" as const },
];
...
export default function LuxuryBrandAfterSalesPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">After Sales</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Luxury Brand • After Sales</p>
                    </div>
                </div>
