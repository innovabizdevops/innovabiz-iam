...
/* ═══ Luxury Brand — Vip Experience ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "3600", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "423", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3083", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1861836627", cells: ["LUX-7627", "Vip Experience Item 1", "8/4/2026", "€36 727"], status: "active" as const },
    { id: "1861840198", cells: ["LUX-2198", "Vip Experience Item 2", "23/11/2026", "€40 298"], status: "pending" as const },
    { id: "1861843769", cells: ["LUX-5769", "Vip Experience Item 3", "10/6/2026", "€43 869"], status: "completed" as const },
    { id: "1861847340", cells: ["LUX-9340", "Vip Experience Item 4", "25/1/2026", "€47 440"], status: "warning" as const },
    { id: "1861850911", cells: ["LUX-3911", "Vip Experience Item 5", "12/8/2026", "€1011"], status: "active" as const },
];
...
export default function LuxuryBrandVipExperiencePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Vip Experience</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Luxury Brand • Vip Experience</p>
                    </div>
                </div>
