...
/* ═══ Luxury Brand — Brand Ambassador ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "568", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "356", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1600", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "181368720", cells: ["LUX-1720", "Brand Ambassador Item 1", "9/1/2026", "€18 820"], status: "active" as const },
    { id: "181372291", cells: ["LUX-5291", "Brand Ambassador Item 2", "24/8/2026", "€22 391"], status: "pending" as const },
    { id: "181375862", cells: ["LUX-8862", "Brand Ambassador Item 3", "11/3/2026", "€25 962"], status: "completed" as const },
    { id: "181379433", cells: ["LUX-3433", "Brand Ambassador Item 4", "26/10/2026", "€29 533"], status: "warning" as const },
    { id: "181383004", cells: ["LUX-7004", "Brand Ambassador Item 5", "13/5/2026", "€33 104"], status: "active" as const },
];
...
export default function LuxuryBrandBrandAmbassadorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Brand Ambassador</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Luxury Brand • Brand Ambassador</p>
                    </div>
                </div>
