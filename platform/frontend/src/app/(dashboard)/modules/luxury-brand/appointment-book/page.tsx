...
/* ═══ Luxury Brand — Appointment Book ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "3766", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "276", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1106", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1288000688", cells: ["LUX-2688", "Appointment Book Item 1", "17/9/2026", "€788"], status: "active" as const },
    { id: "1288004259", cells: ["LUX-6259", "Appointment Book Item 2", "4/4/2026", "€4359"], status: "pending" as const },
    { id: "1288007830", cells: ["LUX-9830", "Appointment Book Item 3", "19/11/2026", "€7930"], status: "completed" as const },
    { id: "1288011401", cells: ["LUX-4401", "Appointment Book Item 4", "6/6/2026", "€11 501"], status: "warning" as const },
    { id: "1288014972", cells: ["LUX-7972", "Appointment Book Item 5", "21/1/2026", "€15 072"], status: "active" as const },
];
...
export default function LuxuryBrandAppointmentBookPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Appointment Book</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Luxury Brand • Appointment Book</p>
                    </div>
                </div>
