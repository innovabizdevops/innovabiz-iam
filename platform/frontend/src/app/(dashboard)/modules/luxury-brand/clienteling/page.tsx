...
const KPIS = [
    { label: "Total", value: "1522", trend: "-19%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "302", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3522", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1063126218", cells: ["LUX-2218", "Clienteling Item 1", "15/7/2026", "€26 318"], status: "active" as const },
    { id: "1063129789", cells: ["LUX-5789", "Clienteling Item 2", "2/2/2026", "€29 889"], status: "pending" as const },
    { id: "1063133360", cells: ["LUX-9360", "Clienteling Item 3", "17/9/2026", "€33 460"], status: "completed" as const },
    { id: "1063136931", cells: ["LUX-3931", "Clienteling Item 4", "4/4/2026", "€37 031"], status: "warning" as const },
    { id: "1063140502", cells: ["LUX-7502", "Clienteling Item 5", "19/11/2026", "€40 602"], status: "active" as const },
];
...
export default function LuxuryBrandClientelingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Clienteling</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Luxury Brand • Clienteling</p>
                    </div>
                </div>
