...
/* ═══ Luxury Brand — Authentication Cert ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "4964", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "126", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3374", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "77%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "725567290", cells: ["LUX-6290", "Authentication Cert Item 1", "15/11/2026", "€17 390"], status: "active" as const },
    { id: "725570861", cells: ["LUX-9861", "Authentication Cert Item 2", "2/6/2026", "€20 961"], status: "pending" as const },
    { id: "725574432", cells: ["LUX-4432", "Authentication Cert Item 3", "17/1/2026", "€24 532"], status: "completed" as const },
    { id: "725578003", cells: ["LUX-8003", "Authentication Cert Item 4", "4/8/2026", "€28 103"], status: "warning" as const },
    { id: "725581574", cells: ["LUX-2574", "Authentication Cert Item 5", "19/3/2026", "€31 674"], status: "active" as const },
];
...
export default function LuxuryBrandAuthenticationCertPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Authentication Cert</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Luxury Brand • Authentication Cert</p>
                    </div>
                </div>
