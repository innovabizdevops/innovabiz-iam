...
/* ═══ Luxury Brand — Haute Couture ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "1291", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "328", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3009", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "835658660", cells: ["LUX-9660", "Haute Couture Item 1", "5/9/2026", "€8760"], status: "active" as const },
    { id: "835662231", cells: ["LUX-4231", "Haute Couture Item 2", "20/4/2026", "€12 331"], status: "pending" as const },
    { id: "835665802", cells: ["LUX-7802", "Haute Couture Item 3", "7/11/2026", "€15 902"], status: "completed" as const },
    { id: "835669373", cells: ["LUX-2373", "Haute Couture Item 4", "22/6/2026", "€19 473"], status: "warning" as const },
    { id: "835672944", cells: ["LUX-5944", "Haute Couture Item 5", "9/1/2026", "€23 044"], status: "active" as const },
];
...
export default function LuxuryBrandHauteCouturePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Haute Couture</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Luxury Brand • Haute Couture</p>
                    </div>
                </div>
