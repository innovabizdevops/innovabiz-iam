...
/* ═══ Luxury Brand — Bespoke Order ═══ */

const ACCENT = "#be123c";

const KPIS = [
    { label: "Total", value: "3785", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "133", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3185", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1977958865", cells: ["LUX-2865", "Bespoke Order Item 1", "2/6/2026", "€8965"], status: "active" as const },
    { id: "1977962436", cells: ["LUX-6436", "Bespoke Order Item 2", "17/1/2026", "€12 536"], status: "pending" as const },
    { id: "1977966007", cells: ["LUX-1007", "Bespoke Order Item 3", "4/8/2026", "€16 107"], status: "completed" as const },
    { id: "1977969578", cells: ["LUX-4578", "Bespoke Order Item 4", "19/3/2026", "€19 678"], status: "warning" as const },
    { id: "1977973149", cells: ["LUX-8149", "Bespoke Order Item 5", "6/10/2026", "€23 249"], status: "active" as const },
];
...
export default function LuxuryBrandBespokeOrderPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Bespoke Order</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Luxury Brand • Bespoke Order</p>
                    </div>
                </div>
