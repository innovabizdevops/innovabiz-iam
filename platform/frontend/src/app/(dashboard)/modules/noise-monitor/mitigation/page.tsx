...
const PAGE = "Mitigation";
const KPIS = [{"l":"Total Noise Monitor","v":"2.274","t":"-0.2%","d":"down"},{"l":"Mitigation Ativos","v":"3.717","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"82.6%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"60","t":"+15.3%","d":"up"}];
const COLS = ["ID","Mitigation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Noise Monitor #001","Noise Monitor #002","7.758","8.213","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Noise Monitor #002","Noise Monitor #003","4.214","645","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Noise Monitor #003","Noise Monitor #004","3.058","4.872","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Noise Monitor #004","Noise Monitor #005","7.544","6.842","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Noise Monitor #005","Noise Monitor #001","7.276","7.960","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":275},{"label":"Fev","value":282},{"label":"Mar","value":479},{"label":"Abr","value":559},{"label":"Mai","value":317},{"label":"Jun","value":411},{"label":"Jul","value":403},{"label":"Ago","value":410},{"label":"Set","value":460},{"label":"Out","value":346},{"label":"Nov","value":453},{"label":"Dez","value":570}];
const MX = 570;
