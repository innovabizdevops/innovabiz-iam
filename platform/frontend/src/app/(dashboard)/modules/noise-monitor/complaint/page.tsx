...
const KPIS = [{"l":"Total Noise Monitor","v":"2.567","t":"+10.9%","d":"up"},{"l":"Complaint Ativos","v":"8.700","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"66.0%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"74","t":"-5.4%","d":"down"}];
const COLS = ["ID","Complaint","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Noise Monitor #001","Noise Monitor #002","8.795","6.275","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Noise Monitor #002","Noise Monitor #003","1.851","4.897","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Noise Monitor #003","Noise Monitor #004","6.814","1.166","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Noise Monitor #004","Noise Monitor #005","6.612","8.965","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Noise Monitor #005","Noise Monitor #001","5.461","8.304","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":448},{"label":"Fev","value":666},{"label":"Mar","value":586},{"label":"Abr","value":798},{"label":"Mai","value":515},{"label":"Jun","value":491},{"label":"Jul","value":474},{"label":"Ago","value":763},{"label":"Set","value":579},{"label":"Out","value":708},{"label":"Nov","value":757},{"label":"Dez","value":788}];
const MX = 798;
