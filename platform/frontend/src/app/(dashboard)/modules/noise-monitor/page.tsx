...
export default function NoiseMonitorPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Noise Monitor</h1><p className="text-sm text-muted-foreground">Noise Monitor • iBOS Enterprise</p></div>
