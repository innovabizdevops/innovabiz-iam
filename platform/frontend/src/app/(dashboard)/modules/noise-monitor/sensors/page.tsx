...
const ACCENT = "#78350f";
const MODULE = "Noise Monitoring";
const PAGE = "Sensor Deploy";
const KPIS = [{"l":"Dispositivos Online","v":"3.599","t":"-4.4%","d":"down"},{"l":"Dados/Min (MB)","v":"215","t":"+12.6%","d":"up"},{"l":"Alertas Ativos","v":"5.540","t":"-1.4%","d":"down"},{"l":"Uptime (%)","v":"72.6%","t":"+4.7%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.449","5.806","3.704","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","478","525","4.839","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.540","8.066","5.427","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.023","1.104","8.481","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.010","2.894","5.063","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":430},{"label":"Mar","value":524},{"label":"Abr","value":567},{"label":"Mai","value":405},{"label":"Jun","value":511},{"label":"Jul","value":596},{"label":"Ago","value":439},{"label":"Set","value":453},{"label":"Out","value":675},{"label":"Nov","value":451},{"label":"Dez","value":686}];
const MX = 686;
