...
const PAGE = "Health";
const KPIS = [{"l":"Total Poultry Mgmt","v":"1.696","t":"-3.0%","d":"down"},{"l":"Health Ativos","v":"1.808","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"73.6%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"86","t":"+11.4%","d":"up"}];
const COLS = ["ID","Health","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Poultry Mgmt #001","Poultry Mgmt #002","6.127","865","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Poultry Mgmt #002","Poultry Mgmt #003","5.048","6.565","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Poultry Mgmt #003","Poultry Mgmt #004","2.373","523","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Poultry Mgmt #004","Poultry Mgmt #005","1.784","6.616","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Poultry Mgmt #005","Poultry Mgmt #001","5.514","9.064","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":900},{"label":"Fev","value":926},{"label":"Mar","value":964},{"label":"Abr","value":646},{"label":"Mai","value":633},{"label":"Jun","value":905},{"label":"Jul","value":710},{"label":"Ago","value":768},{"label":"Set","value":869},{"label":"Out","value":670},{"label":"Nov","value":793},{"label":"Dez","value":820}];
const MX = 964;
