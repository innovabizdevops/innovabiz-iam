...
const PAGE = "Egg Track";
const KPIS = [{"l":"Total Poultry Mgmt","v":"761","t":"+4.6%","d":"up"},{"l":"Egg Track Ativos","v":"6.800","t":"+11.4%","d":"up"},{"l":"Eficiência (%)","v":"86.4%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"84","t":"+12.3%","d":"up"}];
const COLS = ["ID","Egg Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Poultry Mgmt #001","Poultry Mgmt #002","6.845","2.222","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Poultry Mgmt #002","Poultry Mgmt #003","8.160","2.112","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Poultry Mgmt #003","Poultry Mgmt #004","2.623","3.381","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Poultry Mgmt #004","Poultry Mgmt #005","4.525","468","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Poultry Mgmt #005","Poultry Mgmt #001","5.437","9.059","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":996},{"label":"Mar","value":808},{"label":"Abr","value":880},{"label":"Mai","value":830},{"label":"Jun","value":704},{"label":"Jul","value":1049},{"label":"Ago","value":1058},{"label":"Set","value":813},{"label":"Out","value":1031},{"label":"Nov","value":922},{"label":"Dez","value":879}];
const MX = 1058;
