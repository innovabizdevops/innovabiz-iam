...
const PAGE = "Flock";
const KPIS = [{"l":"Total Poultry Mgmt","v":"6.704","t":"+12.5%","d":"up"},{"l":"Flock Ativos","v":"8.155","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"66.7%","t":"+9.6%","d":"up"},{"l":"Score Performance","v":"93","t":"+11.0%","d":"up"}];
const COLS = ["ID","Flock","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Poultry Mgmt #001","Poultry Mgmt #002","7.466","5.193","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Poultry Mgmt #002","Poultry Mgmt #003","8.997","6.657","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Poultry Mgmt #003","Poultry Mgmt #004","424","3.312","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Poultry Mgmt #004","Poultry Mgmt #005","8.364","5.275","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Poultry Mgmt #005","Poultry Mgmt #001","1.660","6.024","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":645},{"label":"Mar","value":403},{"label":"Abr","value":362},{"label":"Mai","value":420},{"label":"Jun","value":430},{"label":"Jul","value":487},{"label":"Ago","value":625},{"label":"Set","value":669},{"label":"Out","value":675},{"label":"Nov","value":386},{"label":"Dez","value":459}];
const MX = 675;
