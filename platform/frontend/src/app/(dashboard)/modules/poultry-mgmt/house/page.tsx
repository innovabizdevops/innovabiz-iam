...
const ACCENT = "#6366f1";
const MODULE = "Poultry Management";
const PAGE = "House Env";
const KPIS = [{"l":"Total Poultry Mgmt","v":"7.656","t":"-3.4%","d":"down"},{"l":"House Env Ativos","v":"6.148","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"66.9%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"89","t":"-5.3%","d":"down"}];
const COLS = ["ID","House Env","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Poultry Mgmt #001","Poultry Mgmt #002","5.435","8.917","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Poultry Mgmt #002","Poultry Mgmt #003","8.974","3.788","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Poultry Mgmt #003","Poultry Mgmt #004","763","8.351","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Poultry Mgmt #004","Poultry Mgmt #005","7.618","5.041","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Poultry Mgmt #005","Poultry Mgmt #001","1.403","6.498","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":635},{"label":"Mar","value":831},{"label":"Abr","value":841},{"label":"Mai","value":748},{"label":"Jun","value":678},{"label":"Jul","value":843},{"label":"Ago","value":623},{"label":"Set","value":891},{"label":"Out","value":709},{"label":"Nov","value":691},{"label":"Dez","value":986}];
const MX = 986;
