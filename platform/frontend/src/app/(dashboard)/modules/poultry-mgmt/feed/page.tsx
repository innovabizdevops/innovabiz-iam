...
const PAGE = "Feed";
const KPIS = [{"l":"Total Poultry Mgmt","v":"3.145","t":"+3.0%","d":"up"},{"l":"Feed Ativos","v":"3.044","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"77.9%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"93","t":"+12.5%","d":"up"}];
const COLS = ["ID","Feed","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Poultry Mgmt #001","Poultry Mgmt #002","6.852","1.312","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Poultry Mgmt #002","Poultry Mgmt #003","1.098","1.519","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Poultry Mgmt #003","Poultry Mgmt #004","1.106","9.070","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Poultry Mgmt #004","Poultry Mgmt #005","8.369","3.643","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Poultry Mgmt #005","Poultry Mgmt #001","2.411","3.500","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":476},{"label":"Fev","value":531},{"label":"Mar","value":522},{"label":"Abr","value":555},{"label":"Mai","value":649},{"label":"Jun","value":543},{"label":"Jul","value":648},{"label":"Ago","value":606},{"label":"Set","value":532},{"label":"Out","value":514},{"label":"Nov","value":518},{"label":"Dez","value":637}];
const MX = 649;
