...
const PAGE = "Sink Connectors";
const KPIS = [{"l":"Dashboards Ativos","v":"7.719","t":"+1.0%","d":"up"},{"l":"Queries/Dia","v":"4543","t":"+6.6%","d":"up"},{"l":"Dados Processados (GB)","v":"1.349","t":"+16.7%","d":"up"},{"l":"Utilizadores Analytics","v":"1.793","t":"+3.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2980","2026-03-18","6.335","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2330","2026-01-16","4.680","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2827","2026-02-09","240","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3952","2026-01-21","8.122","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4232","2026-03-22","5.870","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":681},{"label":"Mar","value":655},{"label":"Abr","value":699},{"label":"Mai","value":509},{"label":"Jun","value":733},{"label":"Jul","value":495},{"label":"Ago","value":720},{"label":"Set","value":665},{"label":"Out","value":748},{"label":"Nov","value":606},{"label":"Dez","value":464}];
const MX = 748;
