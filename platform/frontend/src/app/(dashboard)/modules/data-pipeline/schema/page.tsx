...
const PAGE = "Schema Registry";
const KPIS = [{"l":"Dashboards Ativos","v":"5.448","t":"+13.1%","d":"up"},{"l":"Queries/Dia","v":"4411","t":"-4.2%","d":"down"},{"l":"Dados Processados (GB)","v":"417","t":"+3.0%","d":"up"},{"l":"Utilizadores Analytics","v":"2.697","t":"+8.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","392","2026-01-20","4.712","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1587","2026-02-21","2.088","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1500","2026-01-21","2.751","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3822","2026-02-14","988","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3880","2026-01-08","8.596","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":286},{"label":"Mar","value":624},{"label":"Abr","value":243},{"label":"Mai","value":319},{"label":"Jun","value":607},{"label":"Jul","value":531},{"label":"Ago","value":429},{"label":"Set","value":567},{"label":"Out","value":293},{"label":"Nov","value":355},{"label":"Dez","value":622}];
const MX = 624;
