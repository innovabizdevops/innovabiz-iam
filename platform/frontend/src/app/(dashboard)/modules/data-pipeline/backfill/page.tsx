...
const PAGE = "Backfill Mgmt";
const KPIS = [{"l":"Dashboards Ativos","v":"8.580","t":"+15.9%","d":"up"},{"l":"Queries/Dia","v":"3926","t":"+0.1%","d":"up"},{"l":"Dados Processados (GB)","v":"6.154","t":"+9.9%","d":"up"},{"l":"Utilizadores Analytics","v":"1.290","t":"-2.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2366","2026-03-22","3.154","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2890","2026-02-22","5.295","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3689","2026-03-22","442","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2737","2026-02-14","2.107","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4218","2026-02-18","3.968","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":876},{"label":"Fev","value":861},{"label":"Mar","value":688},{"label":"Abr","value":622},{"label":"Mai","value":882},{"label":"Jun","value":866},{"label":"Jul","value":776},{"label":"Ago","value":876},{"label":"Set","value":847},{"label":"Out","value":783},{"label":"Nov","value":803},{"label":"Dez","value":650}];
const MX = 882;
