...
const ACCENT = "#7c3aed";
const MODULE = "Data Pipeline";
const PAGE = "Source Connectors";
const KPIS = [{"l":"Dashboards Ativos","v":"1.754","t":"-1.9%","d":"down"},{"l":"Queries/Dia","v":"1188","t":"-4.0%","d":"down"},{"l":"Dados Processados (GB)","v":"5.481","t":"+13.9%","d":"up"},{"l":"Utilizadores Analytics","v":"5.181","t":"+6.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4576","2026-03-16","5.506","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2667","2026-03-14","922","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3413","2026-01-10","4.932","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2360","2026-03-27","5.837","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3657","2026-02-26","8.383","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":588},{"label":"Mar","value":632},{"label":"Abr","value":426},{"label":"Mai","value":767},{"label":"Jun","value":498},{"label":"Jul","value":500},{"label":"Ago","value":468},{"label":"Set","value":430},{"label":"Out","value":713},{"label":"Nov","value":458},{"label":"Dez","value":553}];
const MX = 767;
