...
const PAGE = "DAG Builder";
const KPIS = [{"l":"Dashboards Ativos","v":"4.143","t":"+4.9%","d":"up"},{"l":"Queries/Dia","v":"420","t":"+3.2%","d":"up"},{"l":"Dados Processados (GB)","v":"5.502","t":"+10.3%","d":"up"},{"l":"Utilizadores Analytics","v":"8.266","t":"+8.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2195","2026-01-03","2.125","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4056","2026-02-26","285","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3630","2026-02-01","6.887","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4171","2026-02-09","4.202","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3345","2026-02-11","1.948","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":1026},{"label":"Mar","value":917},{"label":"Abr","value":872},{"label":"Mai","value":799},{"label":"Jun","value":977},{"label":"Jul","value":967},{"label":"Ago","value":853},{"label":"Set","value":941},{"label":"Out","value":684},{"label":"Nov","value":722},{"label":"Dez","value":1064}];
const MX = 1064;
