...
const PAGE = "NPS Correlation";
const KPIS = [{"l":"ARR (€M)","v":"€38.9M","t":"+14.7%","d":"up"},{"l":"MRR (€)","v":"€83504","t":"+17.3%","d":"up"},{"l":"Churn (%)","v":"77.4%","t":"+3.4%","d":"up"},{"l":"ARPU (€)","v":"€67544","t":"+7.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 45664.90","4.308","€ 35391.92","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 12680.58","3.834","€ 12142.64","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 23242.14","7.253","€ 6027.28","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 14537.10","3.727","€ 12304.68","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 46631.89","3.529","€ 3615.38","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":532},{"label":"Mar","value":446},{"label":"Abr","value":502},{"label":"Mai","value":471},{"label":"Jun","value":482},{"label":"Jul","value":356},{"label":"Ago","value":484},{"label":"Set","value":516},{"label":"Out","value":498},{"label":"Nov","value":616},{"label":"Dez","value":377}];
const MX = 616;
