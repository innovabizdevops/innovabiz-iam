...
const ACCENT = "#dc2626";
const MODULE = "Churn Prediction";
const PAGE = "Risk Scores";
const KPIS = [{"l":"Riscos Identificados","v":"4.289","t":"-5.3%","d":"down"},{"l":"Mitigações Ativas","v":"4.639","t":"+17.4%","d":"up"},{"l":"Score Risco Geral","v":"66","t":"-0.1%","d":"down"},{"l":"Incidentes YTD","v":"4.511","t":"-3.5%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.741","1.278","7.595","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.538","1.535","2.580","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.568","6.831","4.806","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.123","7.768","6.961","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.388","1.416","2.819","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":236},{"label":"Fev","value":261},{"label":"Mar","value":287},{"label":"Abr","value":440},{"label":"Mai","value":520},{"label":"Jun","value":252},{"label":"Jul","value":466},{"label":"Ago","value":516},{"label":"Set","value":231},{"label":"Out","value":328},{"label":"Nov","value":419},{"label":"Dez","value":350}];
const MX = 520;
