...
const KPIS = [{"l":"ARR (€M)","v":"€41.7M","t":"+3.6%","d":"up"},{"l":"MRR (€)","v":"€73335","t":"-5.2%","d":"down"},{"l":"Churn (%)","v":"78.6%","t":"+4.4%","d":"up"},{"l":"ARPU (€)","v":"€80128","t":"+16.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 18387.53","165","€ 49354.99","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 43742.50","4.126","€ 33162.97","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 2255.82","3.731","€ 23630.65","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 33415.48","5.226","€ 7156.73","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 32311.13","8.094","€ 4842.17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":658},{"label":"Mar","value":772},{"label":"Abr","value":750},{"label":"Mai","value":622},{"label":"Jun","value":664},{"label":"Jul","value":650},{"label":"Ago","value":438},{"label":"Set","value":721},{"label":"Out","value":458},{"label":"Nov","value":721},{"label":"Dez","value":504}];
const MX = 772;
