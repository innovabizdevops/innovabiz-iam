...
const PAGE = "Save Playbooks";
const KPIS = [{"l":"ARR (€M)","v":"€43.5M","t":"+-0.0%","d":"up"},{"l":"MRR (€)","v":"€79650","t":"+11.3%","d":"up"},{"l":"Churn (%)","v":"71.6%","t":"+9.0%","d":"up"},{"l":"ARPU (€)","v":"€44679","t":"+9.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 3928.38","1.744","€ 13924.01","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 23247.07","3.164","€ 11189.96","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 29223.74","2.709","€ 42369.10","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 5006.54","1.676","€ 45547.91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 37173.66","457","€ 9384.17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":649},{"label":"Mar","value":385},{"label":"Abr","value":441},{"label":"Mai","value":634},{"label":"Jun","value":506},{"label":"Jul","value":388},{"label":"Ago","value":448},{"label":"Set","value":489},{"label":"Out","value":616},{"label":"Nov","value":354},{"label":"Dez","value":358}];
const MX = 649;
