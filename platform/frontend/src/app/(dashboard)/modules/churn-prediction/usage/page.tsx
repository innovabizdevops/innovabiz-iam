...
const PAGE = "Usage Decay";
const KPIS = [{"l":"ARR (€M)","v":"€29.7M","t":"+12.8%","d":"up"},{"l":"MRR (€)","v":"€59262","t":"+12.5%","d":"up"},{"l":"Churn (%)","v":"90.6%","t":"-1.7%","d":"down"},{"l":"ARPU (€)","v":"€55525","t":"+11.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 13726.10","7.132","€ 39417.92","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 25756.88","4.830","€ 3747.80","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 37648.62","8.503","€ 47029.19","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 6804.39","1.373","€ 26374.47","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 1196.23","1.091","€ 26968.81","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":811},{"label":"Mar","value":870},{"label":"Abr","value":875},{"label":"Mai","value":728},{"label":"Jun","value":708},{"label":"Jul","value":746},{"label":"Ago","value":750},{"label":"Set","value":888},{"label":"Out","value":914},{"label":"Nov","value":713},{"label":"Dez","value":941}];
const MX = 941;
