...
const PAGE = "Early Warnings";
const KPIS = [{"l":"ARR (€M)","v":"€10.8M","t":"-2.3%","d":"down"},{"l":"MRR (€)","v":"€98931","t":"-0.2%","d":"down"},{"l":"Churn (%)","v":"92.6%","t":"+1.3%","d":"up"},{"l":"ARPU (€)","v":"€20756","t":"+14.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 30705.52","1.912","€ 30993.99","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 2577.74","5.369","€ 29575.31","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 11729.06","6.987","€ 8376.89","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 13410.36","6.218","€ 6398.97","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 30663.88","4.347","€ 32784.48","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":916},{"label":"Mar","value":649},{"label":"Abr","value":635},{"label":"Mai","value":610},{"label":"Jun","value":679},{"label":"Jul","value":673},{"label":"Ago","value":904},{"label":"Set","value":748},{"label":"Out","value":599},{"label":"Nov","value":756},{"label":"Dez","value":805}];
const MX = 916;
