...
const PAGE = "Policy Issue";
const KPIS = [{"l":"Total Policy Admin","v":"234","t":"+3.4%","d":"up"},{"l":"Policy Issue Ativos","v":"1.046","t":"-4.8%","d":"down"},{"l":"Eficiência (%)","v":"66.8%","t":"+11.9%","d":"up"},{"l":"Score Performance","v":"76","t":"+1.0%","d":"up"}];
const COLS = ["ID","Policy Issue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Policy Admin #001","Policy Admin #002","5.152","3.422","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Policy Admin #002","Policy Admin #003","2.076","4.998","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Policy Admin #003","Policy Admin #004","8.851","7.244","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Policy Admin #004","Policy Admin #005","3.190","4.446","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Policy Admin #005","Policy Admin #001","7.482","4.202","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":680},{"label":"Mar","value":667},{"label":"Abr","value":764},{"label":"Mai","value":836},{"label":"Jun","value":571},{"label":"Jul","value":825},{"label":"Ago","value":531},{"label":"Set","value":712},{"label":"Out","value":790},{"label":"Nov","value":790},{"label":"Dez","value":695}];
const MX = 836;
