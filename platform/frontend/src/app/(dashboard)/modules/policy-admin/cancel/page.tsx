...
const KPIS = [{"l":"Total Policy Admin","v":"618","t":"+12.8%","d":"up"},{"l":"Cancellation Ativos","v":"1.552","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"87.1%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"74","t":"-5.9%","d":"down"}];
const COLS = ["ID","Cancellation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Policy Admin #001","Policy Admin #002","8.311","7.561","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Policy Admin #002","Policy Admin #003","272","598","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Policy Admin #003","Policy Admin #004","4.071","6.803","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Policy Admin #004","Policy Admin #005","2.621","3.204","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Policy Admin #005","Policy Admin #001","3.860","3.303","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":509},{"label":"Mar","value":375},{"label":"Abr","value":615},{"label":"Mai","value":314},{"label":"Jun","value":539},{"label":"Jul","value":491},{"label":"Ago","value":605},{"label":"Set","value":273},{"label":"Out","value":555},{"label":"Nov","value":347},{"label":"Dez","value":261}];
const MX = 615;
