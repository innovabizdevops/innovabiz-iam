...
const PAGE = "Multi-Line";
const KPIS = [{"l":"Total Policy Admin","v":"2.014","t":"+12.5%","d":"up"},{"l":"Multi Line Ativos","v":"5.707","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"69.0%","t":"-5.2%","d":"down"},{"l":"Score Performance","v":"57","t":"+1.3%","d":"up"}];
const COLS = ["ID","Multi Line","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Policy Admin #001","Policy Admin #002","7.397","5.348","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Policy Admin #002","Policy Admin #003","2.255","698","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Policy Admin #003","Policy Admin #004","650","4.804","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Policy Admin #004","Policy Admin #005","5.781","1.551","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Policy Admin #005","Policy Admin #001","6.282","8.966","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":278},{"label":"Fev","value":500},{"label":"Mar","value":576},{"label":"Abr","value":589},{"label":"Mai","value":254},{"label":"Jun","value":523},{"label":"Jul","value":323},{"label":"Ago","value":526},{"label":"Set","value":317},{"label":"Out","value":225},{"label":"Nov","value":500},{"label":"Dez","value":255}];
const MX = 589;
