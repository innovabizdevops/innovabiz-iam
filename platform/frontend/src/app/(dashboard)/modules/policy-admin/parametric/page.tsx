...
const ACCENT = "#ca8a04";
const MODULE = "Policy Administration";
const PAGE = "Parametric AI";
const KPIS = [{"l":"Configurações","v":"3.406","t":"-4.7%","d":"down"},{"l":"Últimas Alterações","v":"7.662","t":"-2.2%","d":"down"},{"l":"Ambientes","v":"2.883","t":"+16.7%","d":"up"},{"l":"Versão Config","v":"468","t":"+12.8%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 38171.92","1.593","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 49418.77","143","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 9091.79","4.174","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 20023.91","5.879","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 15098.00","519","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":336},{"label":"Mar","value":357},{"label":"Abr","value":492},{"label":"Mai","value":635},{"label":"Jun","value":343},{"label":"Jul","value":689},{"label":"Ago","value":381},{"label":"Set","value":619},{"label":"Out","value":343},{"label":"Nov","value":407},{"label":"Dez","value":594}];
const MX = 689;
