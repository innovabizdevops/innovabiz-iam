...
const PAGE = "Endorsement";
const KPIS = [{"l":"Total Policy Admin","v":"1.562","t":"+6.0%","d":"up"},{"l":"Endorsement Ativos","v":"3.640","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"95.0%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"55","t":"+16.9%","d":"up"}];
const COLS = ["ID","Endorsement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Policy Admin #001","Policy Admin #002","5.486","3.078","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Policy Admin #002","Policy Admin #003","1.350","7.113","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Policy Admin #003","Policy Admin #004","2.989","323","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Policy Admin #004","Policy Admin #005","1.087","508","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Policy Admin #005","Policy Admin #001","8.805","5.539","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":327},{"label":"Fev","value":601},{"label":"Mar","value":506},{"label":"Abr","value":410},{"label":"Mai","value":622},{"label":"Jun","value":336},{"label":"Jul","value":643},{"label":"Ago","value":538},{"label":"Set","value":621},{"label":"Out","value":444},{"label":"Nov","value":621},{"label":"Dez","value":360}];
const MX = 643;
