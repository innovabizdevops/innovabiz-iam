...
const PAGE = "Renewal";
const KPIS = [{"l":"Contratos Ativos","v":"6.774","t":"+4.0%","d":"up"},{"l":"Valor Total (€M)","v":"€24.2M","t":"+14.6%","d":"up"},{"l":"Renovações Próx. 30d","v":"5.344","t":"+16.9%","d":"up"},{"l":"Obrigações Pendentes","v":"6.120","t":"+2.0%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 12515.89","2026-02-13","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 35411.40","2026-02-11","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 6236.83","2026-01-08","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 4825.07","2026-03-18","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 31878.92","2026-03-16","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":383},{"label":"Fev","value":724},{"label":"Mar","value":448},{"label":"Abr","value":408},{"label":"Mai","value":642},{"label":"Jun","value":433},{"label":"Jul","value":501},{"label":"Ago","value":479},{"label":"Set","value":391},{"label":"Out","value":444},{"label":"Nov","value":617},{"label":"Dez","value":576}];
const MX = 724;
