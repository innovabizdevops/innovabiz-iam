...
const PAGE = "Rating Engine";
const KPIS = [{"l":"Surveys Ativos","v":"8.860","t":"-3.2%","d":"down"},{"l":"Respostas/Semana","v":"1998","t":"-3.3%","d":"down"},{"l":"NPS Médio","v":"81","t":"-2.6%","d":"down"},{"l":"Taxa Resposta (%)","v":"78.5%","t":"+1.0%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","5.141","92","73.5%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","4.175","65","95.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","3.659","63","78.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","8.850","78","70.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","6.456","73","86.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":714},{"label":"Fev","value":761},{"label":"Mar","value":717},{"label":"Abr","value":841},{"label":"Mai","value":857},{"label":"Jun","value":880},{"label":"Jul","value":844},{"label":"Ago","value":921},{"label":"Set","value":561},{"label":"Out","value":738},{"label":"Nov","value":699},{"label":"Dez","value":582}];
const MX = 921;
