...
const ACCENT = "#6366f1";
const MODULE = "Collections Mgmt";
const PAGE = "Strategy";
const KPIS = [{"l":"Total Collections Mgmt","v":"265","t":"+12.7%","d":"up"},{"l":"Strategy Ativos","v":"7.388","t":"+17.3%","d":"up"},{"l":"Eficiência (%)","v":"66.9%","t":"-3.0%","d":"down"},{"l":"Score Performance","v":"85","t":"+11.5%","d":"up"}];
const COLS = ["ID","Strategy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Collections Mgmt #001","Collections Mgmt #002","3.478","6.427","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Collections Mgmt #002","Collections Mgmt #003","823","1.133","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Collections Mgmt #003","Collections Mgmt #004","4.912","2.037","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Collections Mgmt #004","Collections Mgmt #005","1.386","7.870","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Collections Mgmt #005","Collections Mgmt #001","8.653","8.670","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":407},{"label":"Mar","value":420},{"label":"Abr","value":408},{"label":"Mai","value":606},{"label":"Jun","value":427},{"label":"Jul","value":220},{"label":"Ago","value":321},{"label":"Set","value":322},{"label":"Out","value":382},{"label":"Nov","value":409},{"label":"Dez","value":510}];
const MX = 606;
