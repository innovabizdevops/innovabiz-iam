...
const PAGE = "Queue";
const KPIS = [{"l":"Total Collections Mgmt","v":"5.431","t":"+15.2%","d":"up"},{"l":"Queue Ativos","v":"6.592","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"71.7%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"67","t":"+17.5%","d":"up"}];
const COLS = ["ID","Queue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Collections Mgmt #001","Collections Mgmt #002","579","1.591","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Collections Mgmt #002","Collections Mgmt #003","3.536","441","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Collections Mgmt #003","Collections Mgmt #004","3.588","2.663","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Collections Mgmt #004","Collections Mgmt #005","2.359","4.169","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Collections Mgmt #005","Collections Mgmt #001","5.940","6.501","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":917},{"label":"Fev","value":842},{"label":"Mar","value":762},{"label":"Abr","value":828},{"label":"Mai","value":611},{"label":"Jun","value":748},{"label":"Jul","value":606},{"label":"Ago","value":594},{"label":"Set","value":857},{"label":"Out","value":796},{"label":"Nov","value":675},{"label":"Dez","value":857}];
const MX = 917;
