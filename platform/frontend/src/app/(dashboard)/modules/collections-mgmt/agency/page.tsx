...
const PAGE = "Agency";
const KPIS = [{"l":"Total Collections Mgmt","v":"5.853","t":"+10.6%","d":"up"},{"l":"Agency Ativos","v":"2.294","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"70.2%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"69","t":"+1.3%","d":"up"}];
const COLS = ["ID","Agency","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Collections Mgmt #001","Collections Mgmt #002","7.045","2.468","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Collections Mgmt #002","Collections Mgmt #003","277","8.128","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Collections Mgmt #003","Collections Mgmt #004","2.767","5.465","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Collections Mgmt #004","Collections Mgmt #005","6.228","1.918","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Collections Mgmt #005","Collections Mgmt #001","6.107","147","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":537},{"label":"Mar","value":517},{"label":"Abr","value":601},{"label":"Mai","value":722},{"label":"Jun","value":508},{"label":"Jul","value":511},{"label":"Ago","value":779},{"label":"Set","value":813},{"label":"Out","value":708},{"label":"Nov","value":706},{"label":"Dez","value":493}];
const MX = 813;
