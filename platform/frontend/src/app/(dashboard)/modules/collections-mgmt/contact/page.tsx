...
const PAGE = "Contact";
const KPIS = [{"l":"Total Collections Mgmt","v":"6.828","t":"+16.9%","d":"up"},{"l":"Contact Ativos","v":"9.082","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"78.4%","t":"+8.3%","d":"up"},{"l":"Score Performance","v":"92","t":"+3.8%","d":"up"}];
const COLS = ["ID","Contact","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Collections Mgmt #001","Collections Mgmt #002","1.542","3.663","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Collections Mgmt #002","Collections Mgmt #003","8.219","4.237","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Collections Mgmt #003","Collections Mgmt #004","2.703","7.378","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Collections Mgmt #004","Collections Mgmt #005","3.061","6.483","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Collections Mgmt #005","Collections Mgmt #001","8.239","5.334","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":650},{"label":"Mar","value":606},{"label":"Abr","value":557},{"label":"Mai","value":540},{"label":"Jun","value":754},{"label":"Jul","value":770},{"label":"Ago","value":637},{"label":"Set","value":664},{"label":"Out","value":787},{"label":"Nov","value":555},{"label":"Dez","value":768}];
const MX = 787;
