...
const PAGE = "Promise";
const KPIS = [{"l":"Total Collections Mgmt","v":"3.486","t":"+7.1%","d":"up"},{"l":"Promise Ativos","v":"5.436","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"66.9%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"71","t":"-4.3%","d":"down"}];
const COLS = ["ID","Promise","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Collections Mgmt #001","Collections Mgmt #002","7.830","6.998","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Collections Mgmt #002","Collections Mgmt #003","196","357","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Collections Mgmt #003","Collections Mgmt #004","6.009","1.742","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Collections Mgmt #004","Collections Mgmt #005","385","3.374","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Collections Mgmt #005","Collections Mgmt #001","640","4.213","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":887},{"label":"Fev","value":838},{"label":"Mar","value":900},{"label":"Abr","value":558},{"label":"Mai","value":607},{"label":"Jun","value":579},{"label":"Jul","value":858},{"label":"Ago","value":689},{"label":"Set","value":644},{"label":"Out","value":541},{"label":"Nov","value":782},{"label":"Dez","value":709}];
const MX = 900;
