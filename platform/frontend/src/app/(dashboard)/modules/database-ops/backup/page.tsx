...
const PAGE = "Backup";
const KPIS = [{"l":"BCP Plans Ativos","v":"3.919","t":"+15.8%","d":"up"},{"l":"RTO Médio (h)","v":"163h","t":"+0.1%","d":"up"},{"l":"RPO Médio (h)","v":"136h","t":"+15.2%","d":"up"},{"l":"Testes DR (YTD)","v":"2.954","t":"+0.6%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","107h","189h","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","55h","174h","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","153h","168h","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","36h","127h","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","12h","205h","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":516},{"label":"Mar","value":682},{"label":"Abr","value":454},{"label":"Mai","value":598},{"label":"Jun","value":673},{"label":"Jul","value":412},{"label":"Ago","value":655},{"label":"Set","value":751},{"label":"Out","value":543},{"label":"Nov","value":447},{"label":"Dez","value":653}];
const MX = 751;
