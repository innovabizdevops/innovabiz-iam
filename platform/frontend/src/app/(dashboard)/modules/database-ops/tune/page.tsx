...
const PAGE = "Tune";
const KPIS = [{"l":"Total Database Ops","v":"1.133","t":"+1.5%","d":"up"},{"l":"Tune Ativos","v":"8.631","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"87","t":"-3.6%","d":"down"}];
const COLS = ["ID","Tune","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Database Ops #001","Database Ops #002","2.860","4.991","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Database Ops #002","Database Ops #003","8.268","2.575","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Database Ops #003","Database Ops #004","3.709","5.006","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Database Ops #004","Database Ops #005","475","6.480","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Database Ops #005","Database Ops #001","881","5.086","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":545},{"label":"Fev","value":403},{"label":"Mar","value":440},{"label":"Abr","value":294},{"label":"Mai","value":523},{"label":"Jun","value":521},{"label":"Jul","value":461},{"label":"Ago","value":501},{"label":"Set","value":476},{"label":"Out","value":644},{"label":"Nov","value":577},{"label":"Dez","value":362}];
const MX = 644;
