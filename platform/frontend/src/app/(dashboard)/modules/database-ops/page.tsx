...
/* ═══ Database Operations (DBOps) — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "3627", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4138", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€261K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1451897927", cells: ["DAT-9927", "Database Operations (DBOps) Item 1", "12/12/2026", "€48 027"], status: "active" as const },
    { id: "1451901498", cells: ["DAT-4498", "Database Operations (DBOps) Item 2", "27/7/2026", "€1598"], status: "pending" as const },
    { id: "1451905069", cells: ["DAT-8069", "Database Operations (DBOps) Item 3", "14/2/2026", "€5169"], status: "completed" as const },
    { id: "1451908640", cells: ["DAT-2640", "Database Operations (DBOps) Item 4", "1/9/2026", "€8740"], status: "warning" as const },
    { id: "1451912211", cells: ["DAT-6211", "Database Operations (DBOps) Item 5", "16/4/2026", "€12 311"], status: "active" as const },
];
...
export default function DatabaseOperationsDbopsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Database Operations (DBOps)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Database Operations (DBOps)</p>
                    </div>
                </div>
