...
const PAGE = "Migrate";
const KPIS = [{"l":"Total Database Ops","v":"4.724","t":"-5.7%","d":"down"},{"l":"Migrate Ativos","v":"3.753","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"67.5%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"80","t":"-1.0%","d":"down"}];
const COLS = ["ID","Migrate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Database Ops #001","Database Ops #002","729","609","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Database Ops #002","Database Ops #003","1.602","3.151","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Database Ops #003","Database Ops #004","3.946","2.652","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Database Ops #004","Database Ops #005","1.404","2.104","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Database Ops #005","Database Ops #001","2.899","8.501","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":508},{"label":"Fev","value":431},{"label":"Mar","value":375},{"label":"Abr","value":497},{"label":"Mai","value":431},{"label":"Jun","value":703},{"label":"Jul","value":585},{"label":"Ago","value":488},{"label":"Set","value":333},{"label":"Out","value":388},{"label":"Nov","value":705},{"label":"Dez","value":432}];
const MX = 705;
