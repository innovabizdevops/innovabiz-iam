...
const ACCENT = "#1e40af";
const MODULE = "Database Operations (DBOps)";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Database Ops","v":"5.232","t":"-5.3%","d":"down"},{"l":"Monitor Ativos","v":"175","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"87.7%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"58","t":"+12.8%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Database Ops #001","Database Ops #002","2.842","6.067","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Database Ops #002","Database Ops #003","7.442","2.532","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Database Ops #003","Database Ops #004","4.626","940","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Database Ops #004","Database Ops #005","1.888","622","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Database Ops #005","Database Ops #001","645","7.094","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":406},{"label":"Mar","value":687},{"label":"Abr","value":601},{"label":"Mai","value":573},{"label":"Jun","value":766},{"label":"Jul","value":669},{"label":"Ago","value":493},{"label":"Set","value":749},{"label":"Out","value":671},{"label":"Nov","value":670},{"label":"Dez","value":519}];
const MX = 766;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e40af'}}>RTM</span></h1>
                </div>
