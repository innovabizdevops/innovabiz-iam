...
const KPIS = [{"l":"Dashboards Ativos","v":"6.964","t":"-3.9%","d":"down"},{"l":"Queries/Dia","v":"3015","t":"+6.7%","d":"up"},{"l":"Dados Processados (GB)","v":"1.471","t":"+11.4%","d":"up"},{"l":"Utilizadores Analytics","v":"3.589","t":"-0.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","343","2026-02-17","3.270","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2715","2026-03-20","6.346","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3341","2026-02-23","8.934","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4565","2026-02-10","1.993","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3776","2026-02-16","1.238","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":758},{"label":"Mar","value":808},{"label":"Abr","value":720},{"label":"Mai","value":856},{"label":"Jun","value":640},{"label":"Jul","value":732},{"label":"Ago","value":869},{"label":"Set","value":662},{"label":"Out","value":965},{"label":"Nov","value":667},{"label":"Dez","value":970}];
const MX = 970;
