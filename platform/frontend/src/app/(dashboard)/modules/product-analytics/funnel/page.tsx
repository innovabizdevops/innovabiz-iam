...
const PAGE = "Funnel";
const KPIS = [{"l":"Dashboards Ativos","v":"3.026","t":"+0.8%","d":"up"},{"l":"Queries/Dia","v":"731","t":"+11.1%","d":"up"},{"l":"Dados Processados (GB)","v":"3.938","t":"+13.1%","d":"up"},{"l":"Utilizadores Analytics","v":"7.814","t":"-2.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1807","2026-03-28","5.444","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1444","2026-03-11","8.468","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3933","2026-03-09","7.392","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","800","2026-02-17","4.613","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","662","2026-02-03","8.701","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":778},{"label":"Fev","value":992},{"label":"Mar","value":832},{"label":"Abr","value":726},{"label":"Mai","value":993},{"label":"Jun","value":952},{"label":"Jul","value":923},{"label":"Ago","value":876},{"label":"Set","value":612},{"label":"Out","value":802},{"label":"Nov","value":654},{"label":"Dez","value":667}];
const MX = 993;
