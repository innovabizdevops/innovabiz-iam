...
/* ═══ Product Analytics Deep — Dashboard ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total Registos", value: "5513", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1893", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€19K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "866384113", cells: ["PRO-9113", "Product Analytics Deep Item 1", "22/2/2026", "€34 213"], status: "active" as const },
    { id: "866387684", cells: ["PRO-3684", "Product Analytics Deep Item 2", "9/9/2026", "€37 784"], status: "pending" as const },
    { id: "866391255", cells: ["PRO-7255", "Product Analytics Deep Item 3", "24/4/2026", "€41 355"], status: "completed" as const },
    { id: "866394826", cells: ["PRO-1826", "Product Analytics Deep Item 4", "11/11/2026", "€44 926"], status: "warning" as const },
    { id: "866398397", cells: ["PRO-5397", "Product Analytics Deep Item 5", "26/6/2026", "€48 497"], status: "active" as const },
];
...
export default function ProductAnalyticsDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Product Analytics Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Product Analytics Deep</p>
                    </div>
                </div>
