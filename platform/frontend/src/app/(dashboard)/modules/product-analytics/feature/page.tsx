...
const PAGE = "Feature";
const KPIS = [{"l":"Dashboards Ativos","v":"4.948","t":"+9.8%","d":"up"},{"l":"Queries/Dia","v":"299","t":"+10.5%","d":"up"},{"l":"Dados Processados (GB)","v":"2.975","t":"-5.2%","d":"down"},{"l":"Utilizadores Analytics","v":"7.263","t":"+17.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3441","2026-02-09","694","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1430","2026-02-08","586","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2304","2026-03-09","8.926","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","563","2026-02-16","3.378","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1014","2026-03-24","2.982","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":687},{"label":"Mar","value":684},{"label":"Abr","value":515},{"label":"Mai","value":609},{"label":"Jun","value":632},{"label":"Jul","value":669},{"label":"Ago","value":657},{"label":"Set","value":389},{"label":"Out","value":390},{"label":"Nov","value":719},{"label":"Dez","value":686}];
const MX = 719;
