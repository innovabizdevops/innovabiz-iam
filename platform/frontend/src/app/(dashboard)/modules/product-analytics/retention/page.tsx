...
const ACCENT = "#8b5cf6";
const MODULE = "Product Analytics Deep";
const PAGE = "Retention";
const KPIS = [{"l":"Dashboards Ativos","v":"6.351","t":"-4.6%","d":"down"},{"l":"Queries/Dia","v":"1141","t":"-0.1%","d":"down"},{"l":"Dados Processados (GB)","v":"4.969","t":"-1.3%","d":"down"},{"l":"Utilizadores Analytics","v":"7.503","t":"-5.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1595","2026-01-01","8.286","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3097","2026-02-10","5.823","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4582","2026-01-13","5.849","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","502","2026-02-27","2.913","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","707","2026-03-01","6.055","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":565},{"label":"Fev","value":674},{"label":"Mar","value":345},{"label":"Abr","value":434},{"label":"Mai","value":564},{"label":"Jun","value":381},{"label":"Jul","value":609},{"label":"Ago","value":543},{"label":"Set","value":619},{"label":"Out","value":503},{"label":"Nov","value":432},{"label":"Dez","value":314}];
const MX = 674;
