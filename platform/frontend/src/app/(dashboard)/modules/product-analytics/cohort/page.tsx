...
const PAGE = "Cohort";
const KPIS = [{"l":"Dashboards Ativos","v":"4.509","t":"+13.7%","d":"up"},{"l":"Queries/Dia","v":"486","t":"+0.5%","d":"up"},{"l":"Dados Processados (GB)","v":"2.830","t":"-5.8%","d":"down"},{"l":"Utilizadores Analytics","v":"8.606","t":"+9.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3042","2026-01-17","7.764","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4277","2026-03-06","5.154","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1824","2026-01-19","5.697","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2016","2026-03-04","4.516","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5003","2026-02-17","5.609","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":705},{"label":"Mar","value":1035},{"label":"Abr","value":770},{"label":"Mai","value":654},{"label":"Jun","value":745},{"label":"Jul","value":673},{"label":"Ago","value":777},{"label":"Set","value":966},{"label":"Out","value":1021},{"label":"Nov","value":720},{"label":"Dez","value":788}];
const MX = 1035;
