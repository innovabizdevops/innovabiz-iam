...
const ACCENT = "#6366f1";
const MODULE = "Snack & Confection";
const PAGE = "Package";
const KPIS = [{"l":"Total Snack Confection","v":"3.602","t":"+7.3%","d":"up"},{"l":"Package Ativos","v":"1.597","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"82.9%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"85","t":"+9.9%","d":"up"}];
const COLS = ["ID","Package","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snack Confection #001","Snack Confection #002","6.193","3.458","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Snack Confection #002","Snack Confection #003","1.807","4.731","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Snack Confection #003","Snack Confection #004","4.979","6.797","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Snack Confection #004","Snack Confection #005","8.660","188","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snack Confection #005","Snack Confection #001","4.095","1.395","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":522},{"label":"Mar","value":798},{"label":"Abr","value":683},{"label":"Mai","value":583},{"label":"Jun","value":645},{"label":"Jul","value":497},{"label":"Ago","value":735},{"label":"Set","value":698},{"label":"Out","value":569},{"label":"Nov","value":861},{"label":"Dez","value":614}];
const MX = 861;
