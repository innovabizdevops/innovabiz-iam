...
export default function SnackConfectionPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Snack Confection</h1><p className="text-sm text-muted-foreground">Snack Confection • iBOS Enterprise</p></div>
