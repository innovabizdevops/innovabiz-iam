...
const PAGE = "Class";
const KPIS = [{"l":"Atletas Registados","v":"3.164","t":"+13.2%","d":"up"},{"l":"Treinos/Semana","v":"1029","t":"+3.5%","d":"up"},{"l":"Competições","v":"3.516","t":"-0.7%","d":"down"},{"l":"Performance Score","v":"58","t":"+10.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.041","2.782","8.670","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.049","4.861","7.713","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.664","2.986","1.956","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.815","6.426","3.505","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.663","3.777","1.656","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":478},{"label":"Mar","value":415},{"label":"Abr","value":652},{"label":"Mai","value":440},{"label":"Jun","value":796},{"label":"Jul","value":549},{"label":"Ago","value":637},{"label":"Set","value":402},{"label":"Out","value":658},{"label":"Nov","value":414},{"label":"Dez","value":448}];
const MX = 796;
