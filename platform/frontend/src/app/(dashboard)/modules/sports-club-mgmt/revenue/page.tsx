...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€14.6M","t":"+4.1%","d":"up"},{"l":"MRR (€)","v":"€44812","t":"+4.9%","d":"up"},{"l":"Churn (%)","v":"81.8%","t":"+5.0%","d":"up"},{"l":"ARPU (€)","v":"€64289","t":"-5.0%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 3074.11","6.082","€ 21073.60","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 19079.77","729","€ 9527.23","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 19065.46","7.764","€ 21328.16","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 31359.24","3.433","€ 17823.41","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 24219.71","2.777","€ 49524.21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":586},{"label":"Mar","value":814},{"label":"Abr","value":682},{"label":"Mai","value":880},{"label":"Jun","value":828},{"label":"Jul","value":734},{"label":"Ago","value":814},{"label":"Set","value":781},{"label":"Out","value":657},{"label":"Nov","value":725},{"label":"Dez","value":716}];
const MX = 880;
