...
const KPIS = [
    { label: "Total Registos", value: "4207", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2352", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€417K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "787361007", cells: ["SPO-6007", "Sports Club Management Item 1", "28/4/2026", "€11 107"], status: "active" as const },
    { id: "787364578", cells: ["SPO-9578", "Sports Club Management Item 2", "15/11/2026", "€14 678"], status: "pending" as const },
    { id: "787368149", cells: ["SPO-4149", "Sports Club Management Item 3", "2/6/2026", "€18 249"], status: "completed" as const },
    { id: "787371720", cells: ["SPO-7720", "Sports Club Management Item 4", "17/1/2026", "€21 820"], status: "warning" as const },
    { id: "787375291", cells: ["SPO-2291", "Sports Club Management Item 5", "4/8/2026", "€25 391"], status: "active" as const },
];
...
export default function SportsClubManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sports Club Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Sports Club Management</p>
                    </div>
                </div>
