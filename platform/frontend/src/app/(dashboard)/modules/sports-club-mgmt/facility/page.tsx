...
const ACCENT = "#b91c1c";
const MODULE = "Sports Club Management";
const PAGE = "Facility";
const KPIS = [{"l":"Atletas Registados","v":"5.305","t":"-5.9%","d":"down"},{"l":"Treinos/Semana","v":"2980","t":"-6.0%","d":"down"},{"l":"Competições","v":"6.223","t":"+1.7%","d":"up"},{"l":"Performance Score","v":"74","t":"+15.8%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.696","5.140","4.752","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.606","6.029","5.750","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.462","6.467","950","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.384","5.963","7.167","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.421","5.991","2.780","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":702},{"label":"Mar","value":544},{"label":"Abr","value":505},{"label":"Mai","value":633},{"label":"Jun","value":669},{"label":"Jul","value":715},{"label":"Ago","value":787},{"label":"Set","value":476},{"label":"Out","value":687},{"label":"Nov","value":610},{"label":"Dez","value":705}];
const MX = 787;
