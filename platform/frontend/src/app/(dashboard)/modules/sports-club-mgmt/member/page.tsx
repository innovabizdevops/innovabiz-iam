...
const PAGE = "Member";
const KPIS = [{"l":"Atletas Registados","v":"4.419","t":"+11.9%","d":"up"},{"l":"Treinos/Semana","v":"1916","t":"+0.1%","d":"up"},{"l":"Competições","v":"304","t":"+13.7%","d":"up"},{"l":"Performance Score","v":"62","t":"+6.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.266","2.306","2.974","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.987","7.055","8.162","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.523","5.559","3.870","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.759","6.004","1.711","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.564","6.820","372","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":854},{"label":"Mar","value":674},{"label":"Abr","value":622},{"label":"Mai","value":749},{"label":"Jun","value":755},{"label":"Jul","value":784},{"label":"Ago","value":641},{"label":"Set","value":753},{"label":"Out","value":643},{"label":"Nov","value":595},{"label":"Dez","value":508}];
const MX = 854;
