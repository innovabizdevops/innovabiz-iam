...
const PAGE = "Coach";
const KPIS = [{"l":"Atletas Registados","v":"8.137","t":"+10.5%","d":"up"},{"l":"Treinos/Semana","v":"1788","t":"+12.5%","d":"up"},{"l":"Competições","v":"5.004","t":"+4.8%","d":"up"},{"l":"Performance Score","v":"69","t":"-1.3%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.866","7.413","4.897","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","499","1.424","5.532","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.691","1.186","1.785","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","3.588","5.891","4.641","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.897","6.245","5.385","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":741},{"label":"Fev","value":698},{"label":"Mar","value":497},{"label":"Abr","value":688},{"label":"Mai","value":749},{"label":"Jun","value":560},{"label":"Jul","value":840},{"label":"Ago","value":769},{"label":"Set","value":596},{"label":"Out","value":852},{"label":"Nov","value":699},{"label":"Dez","value":634}];
const MX = 852;
