...
/* ═══ Investment Ops — Transfer Agency ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "3642", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "137", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "695", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "78120645", cells: ["INV-1645", "Transfer Agency Item 1", "2/10/2026", "€20 745"], status: "active" as const },
    { id: "78124216", cells: ["INV-5216", "Transfer Agency Item 2", "17/5/2026", "€24 316"], status: "pending" as const },
    { id: "78127787", cells: ["INV-8787", "Transfer Agency Item 3", "4/12/2026", "€27 887"], status: "completed" as const },
    { id: "78131358", cells: ["INV-3358", "Transfer Agency Item 4", "19/7/2026", "€31 458"], status: "warning" as const },
    { id: "78134929", cells: ["INV-6929", "Transfer Agency Item 5", "6/2/2026", "€35 029"], status: "active" as const },
];
...
export default function InvestmentOpsTransferAgencyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Transfer Agency</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Investment Ops • Transfer Agency</p>
                    </div>
                </div>
