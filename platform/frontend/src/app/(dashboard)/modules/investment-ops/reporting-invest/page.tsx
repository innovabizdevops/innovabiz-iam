...
/* ═══ Investment Ops — Reporting Invest ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "3804", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "216", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "179", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "812803364", cells: ["INV-5364", "Reporting Invest Item 1", "17/9/2026", "€3464"], status: "active" as const },
    { id: "812806935", cells: ["INV-8935", "Reporting Invest Item 2", "4/4/2026", "€7035"], status: "pending" as const },
    { id: "812810506", cells: ["INV-3506", "Reporting Invest Item 3", "19/11/2026", "€10 606"], status: "completed" as const },
    { id: "812814077", cells: ["INV-7077", "Reporting Invest Item 4", "6/6/2026", "€14 177"], status: "warning" as const },
    { id: "812817648", cells: ["INV-1648", "Reporting Invest Item 5", "21/1/2026", "€17 748"], status: "active" as const },
];
...
export default function InvestmentOpsReportingInvestPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Reporting Invest</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Investment Ops • Reporting Invest</p>
                    </div>
                </div>
