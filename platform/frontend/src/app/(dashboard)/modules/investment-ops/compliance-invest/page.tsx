...
/* ═══ Investment Ops — Compliance Invest ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2554", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "9", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3307", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1871279557", cells: ["INV-9557", "Compliance Invest Item 1", "22/2/2026", "€29 657"], status: "active" as const },
    { id: "1871283128", cells: ["INV-4128", "Compliance Invest Item 2", "9/9/2026", "€33 228"], status: "pending" as const },
    { id: "1871286699", cells: ["INV-7699", "Compliance Invest Item 3", "24/4/2026", "€36 799"], status: "completed" as const },
    { id: "1871290270", cells: ["INV-2270", "Compliance Invest Item 4", "11/11/2026", "€40 370"], status: "warning" as const },
    { id: "1871293841", cells: ["INV-5841", "Compliance Invest Item 5", "26/6/2026", "€43 941"], status: "active" as const },
];
...
export default function InvestmentOpsComplianceInvestPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Compliance Invest</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Investment Ops • Compliance Invest</p>
                    </div>
                </div>
