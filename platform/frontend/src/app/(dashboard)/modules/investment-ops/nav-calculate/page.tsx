...
/* ═══ Investment Ops — Nav Calculate ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "90", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "408", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3958", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1735250964", cells: ["INV-6964", "Nav Calculate Item 1", "21/1/2026", "€1064"], status: "active" as const },
    { id: "1735254535", cells: ["INV-1535", "Nav Calculate Item 2", "8/8/2026", "€4635"], status: "pending" as const },
    { id: "1735258106", cells: ["INV-5106", "Nav Calculate Item 3", "23/3/2026", "€8206"], status: "completed" as const },
    { id: "1735261677", cells: ["INV-8677", "Nav Calculate Item 4", "10/10/2026", "€11 777"], status: "warning" as const },
    { id: "1735265248", cells: ["INV-3248", "Nav Calculate Item 5", "25/5/2026", "€15 348"], status: "active" as const },
];
...
export default function InvestmentOpsNavCalculatePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Nav Calculate</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Investment Ops • Nav Calculate</p>
                    </div>
                </div>
