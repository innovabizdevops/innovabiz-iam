...
/* ═══ Investment Ops — Data Vendor Mgmt ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "3755", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "364", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1019", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "815438264", cells: ["INV-3264", "Data Vendor Mgmt Item 1", "5/9/2026", "€38 364"], status: "active" as const },
    { id: "815441835", cells: ["INV-6835", "Data Vendor Mgmt Item 2", "20/4/2026", "€41 935"], status: "pending" as const },
    { id: "815445406", cells: ["INV-1406", "Data Vendor Mgmt Item 3", "7/11/2026", "€45 506"], status: "completed" as const },
    { id: "815448977", cells: ["INV-4977", "Data Vendor Mgmt Item 4", "22/6/2026", "€49 077"], status: "warning" as const },
    { id: "815452548", cells: ["INV-8548", "Data Vendor Mgmt Item 5", "9/1/2026", "€2648"], status: "active" as const },
];
...
export default function InvestmentOpsDataVendorMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Vendor Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Investment Ops • Data Vendor Mgmt</p>
                    </div>
                </div>
