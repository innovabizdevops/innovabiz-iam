...
/* ═══ Investment Ops — Fund Accounting ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2827", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "367", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "164", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1756124091", cells: ["INV-9091", "Fund Accounting Item 1", "16/4/2026", "€24 191"], status: "active" as const },
    { id: "1756127662", cells: ["INV-3662", "Fund Accounting Item 2", "3/11/2026", "€27 762"], status: "pending" as const },
    { id: "1756131233", cells: ["INV-7233", "Fund Accounting Item 3", "18/6/2026", "€31 333"], status: "completed" as const },
    { id: "1756134804", cells: ["INV-1804", "Fund Accounting Item 4", "5/1/2026", "€34 904"], status: "warning" as const },
    { id: "1756138375", cells: ["INV-5375", "Fund Accounting Item 5", "20/8/2026", "€38 475"], status: "active" as const },
];
...
export default function InvestmentOpsFundAccountingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fund Accounting</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Investment Ops • Fund Accounting</p>
                    </div>
                </div>
