...
/* ═══ Investment Ops — Corporate Action ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "3482", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "494", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3680", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2059527418", cells: ["INV-4418", "Corporate Action Item 1", "19/11/2026", "€27 518"], status: "active" as const },
    { id: "2059530989", cells: ["INV-7989", "Corporate Action Item 2", "6/6/2026", "€31 089"], status: "pending" as const },
    { id: "2059534560", cells: ["INV-2560", "Corporate Action Item 3", "21/1/2026", "€34 660"], status: "completed" as const },
    { id: "2059538131", cells: ["INV-6131", "Corporate Action Item 4", "8/8/2026", "€38 231"], status: "warning" as const },
    { id: "2059541702", cells: ["INV-9702", "Corporate Action Item 5", "23/3/2026", "€41 802"], status: "active" as const },
];
...
export default function InvestmentOpsCorporateActionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Corporate Action</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Investment Ops • Corporate Action</p>
                    </div>
                </div>
