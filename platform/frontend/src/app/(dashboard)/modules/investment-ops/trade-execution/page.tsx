...
/* ═══ Investment Ops — Trade Execution ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "4014", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "219", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3163", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "716754951", cells: ["INV-4951", "Trade Execution Item 1", "4/4/2026", "€5051"], status: "active" as const },
    { id: "716758522", cells: ["INV-8522", "Trade Execution Item 2", "19/11/2026", "€8622"], status: "pending" as const },
    { id: "716762093", cells: ["INV-3093", "Trade Execution Item 3", "6/6/2026", "€12 193"], status: "completed" as const },
    { id: "716765664", cells: ["INV-6664", "Trade Execution Item 4", "21/1/2026", "€15 764"], status: "warning" as const },
    { id: "716769235", cells: ["INV-1235", "Trade Execution Item 5", "8/8/2026", "€19 335"], status: "active" as const },
];
...
export default function InvestmentOpsTradeExecutionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Trade Execution</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Investment Ops • Trade Execution</p>
                    </div>
                </div>
