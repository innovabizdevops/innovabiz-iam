...
const KPIS = [
    { label: "Total", value: "1039", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "156", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2521", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "394620744", cells: ["INV-7744", "Reconciliation Item 1", "1/1/2026", "€20 844"], status: "active" as const },
    { id: "394624315", cells: ["INV-2315", "Reconciliation Item 2", "16/8/2026", "€24 415"], status: "pending" as const },
    { id: "394627886", cells: ["INV-5886", "Reconciliation Item 3", "3/3/2026", "€27 986"], status: "completed" as const },
    { id: "394631457", cells: ["INV-9457", "Reconciliation Item 4", "18/10/2026", "€31 557"], status: "warning" as const },
    { id: "394635028", cells: ["INV-4028", "Reconciliation Item 5", "5/5/2026", "€35 128"], status: "active" as const },
];
...
export default function InvestmentOpsReconciliationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Reconciliation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Investment Ops • Reconciliation</p>
                    </div>
                </div>
