...
/* ═══ Investment Ops — Settlement Ops ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "3081", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "372", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2035", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1405596432", cells: ["INV-4432", "Settlement Ops Item 1", "17/1/2026", "€46 532"], status: "active" as const },
    { id: "1405600003", cells: ["INV-8003", "Settlement Ops Item 2", "4/8/2026", "€103"], status: "pending" as const },
    { id: "1405603574", cells: ["INV-2574", "Settlement Ops Item 3", "19/3/2026", "€3674"], status: "completed" as const },
    { id: "1405607145", cells: ["INV-6145", "Settlement Ops Item 4", "6/10/2026", "€7245"], status: "warning" as const },
    { id: "1405610716", cells: ["INV-9716", "Settlement Ops Item 5", "21/5/2026", "€10 816"], status: "active" as const },
];
...
export default function InvestmentOpsSettlementOpsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Settlement Ops</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Investment Ops • Settlement Ops</p>
                    </div>
                </div>
