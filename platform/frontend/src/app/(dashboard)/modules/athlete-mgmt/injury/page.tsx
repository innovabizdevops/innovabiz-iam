...
const PAGE = "Injury";
const KPIS = [{"l":"Atletas Registados","v":"8.817","t":"+2.7%","d":"up"},{"l":"Treinos/Semana","v":"314","t":"+2.4%","d":"up"},{"l":"Competições","v":"3.961","t":"+17.7%","d":"up"},{"l":"Performance Score","v":"74","t":"+5.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.555","3.835","4.610","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.464","3.085","7.466","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.062","7.304","3.193","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.532","3.589","6.496","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.927","1.553","6.923","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":842},{"label":"Mar","value":604},{"label":"Abr","value":944},{"label":"Mai","value":642},{"label":"Jun","value":613},{"label":"Jul","value":656},{"label":"Ago","value":645},{"label":"Set","value":654},{"label":"Out","value":662},{"label":"Nov","value":735},{"label":"Dez","value":813}];
const MX = 944;
