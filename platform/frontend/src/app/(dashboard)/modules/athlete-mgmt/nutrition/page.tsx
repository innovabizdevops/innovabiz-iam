...
const KPIS = [{"l":"Atletas Registados","v":"245","t":"+0.4%","d":"up"},{"l":"Treinos/Semana","v":"1300","t":"-0.7%","d":"down"},{"l":"Competições","v":"8.713","t":"+11.2%","d":"up"},{"l":"Performance Score","v":"71","t":"+4.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.596","5.492","1.148","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.505","2.865","484","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.056","2.976","3.403","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","380","1.390","4.879","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.089","8.147","5.762","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":631},{"label":"Mar","value":468},{"label":"Abr","value":299},{"label":"Mai","value":645},{"label":"Jun","value":501},{"label":"Jul","value":540},{"label":"Ago","value":361},{"label":"Set","value":322},{"label":"Out","value":419},{"label":"Nov","value":632},{"label":"Dez","value":596}];
const MX = 645;
