...
const ACCENT = "#14532d";
const MODULE = "Athlete Management";
const PAGE = "Performance";
const KPIS = [{"l":"Formulários Ativos","v":"3.101","t":"+11.8%","d":"up"},{"l":"Submissões/Dia","v":"2356","t":"+10.3%","d":"up"},{"l":"Documentos Gerados","v":"4.591","t":"+0.5%","d":"up"},{"l":"Templates","v":"3.179","t":"+3.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.325","2026-01-07","8.863","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.898","2026-01-26","7.965","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.951","2026-02-05","3.338","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.446","2026-02-06","6.002","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.565","2026-03-27","8.488","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":894},{"label":"Fev","value":665},{"label":"Mar","value":663},{"label":"Abr","value":678},{"label":"Mai","value":643},{"label":"Jun","value":907},{"label":"Jul","value":952},{"label":"Ago","value":961},{"label":"Set","value":633},{"label":"Out","value":971},{"label":"Nov","value":612},{"label":"Dez","value":625}];
const MX = 971;
