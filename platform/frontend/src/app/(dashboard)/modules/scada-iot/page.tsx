...
export default function ScadaIotPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Scada Iot</h1><p className="text-sm text-muted-foreground">Scada Iot • iBOS Enterprise</p></div>
