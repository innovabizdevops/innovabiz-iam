...
const PAGE = "Historian";
const KPIS = [{"l":"Dispositivos Online","v":"7.937","t":"+2.0%","d":"up"},{"l":"Dados/Min (MB)","v":"5.343","t":"+12.3%","d":"up"},{"l":"Alertas Ativos","v":"6.880","t":"+16.2%","d":"up"},{"l":"Uptime (%)","v":"84.6%","t":"+12.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","502","1.888","7.173","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.886","5.529","5.853","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.041","2.370","5.128","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.547","7.997","3.706","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.331","8.253","6.497","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":245},{"label":"Fev","value":582},{"label":"Mar","value":555},{"label":"Abr","value":360},{"label":"Mai","value":311},{"label":"Jun","value":366},{"label":"Jul","value":451},{"label":"Ago","value":254},{"label":"Set","value":594},{"label":"Out","value":424},{"label":"Nov","value":437},{"label":"Dez","value":363}];
const MX = 594;
