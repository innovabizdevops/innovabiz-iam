...
const PAGE = "Tag Browser";
const KPIS = [{"l":"Dispositivos Online","v":"7.822","t":"+5.7%","d":"up"},{"l":"Dados/Min (MB)","v":"7.002","t":"+7.7%","d":"up"},{"l":"Alertas Ativos","v":"2.891","t":"+16.4%","d":"up"},{"l":"Uptime (%)","v":"93.8%","t":"+0.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.237","6.027","4.988","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.673","8.244","2.365","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.364","5.699","8.128","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","4.313","881","7.658","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.872","4.835","6.029","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":499},{"label":"Mar","value":597},{"label":"Abr","value":673},{"label":"Mai","value":541},{"label":"Jun","value":719},{"label":"Jul","value":581},{"label":"Ago","value":481},{"label":"Set","value":777},{"label":"Out","value":736},{"label":"Nov","value":496},{"label":"Dez","value":535}];
const MX = 777;
