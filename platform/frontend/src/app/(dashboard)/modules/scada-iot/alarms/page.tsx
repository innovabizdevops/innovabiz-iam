...
const KPIS = [{"l":"Dispositivos Online","v":"2.309","t":"+13.4%","d":"up"},{"l":"Dados/Min (MB)","v":"164","t":"-5.6%","d":"down"},{"l":"Alertas Ativos","v":"675","t":"-0.4%","d":"down"},{"l":"Uptime (%)","v":"86.2%","t":"+9.9%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.536","7.493","3.119","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.304","5.425","3.206","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.115","3.118","4.931","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.986","4.261","8.482","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.559","1.350","6.256","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":656},{"label":"Mar","value":599},{"label":"Abr","value":761},{"label":"Mai","value":682},{"label":"Jun","value":751},{"label":"Jul","value":530},{"label":"Ago","value":770},{"label":"Set","value":466},{"label":"Out","value":581},{"label":"Nov","value":682},{"label":"Dez","value":582}];
const MX = 770;
