...
const PAGE = "Edge Gateway";
const KPIS = [{"l":"Dispositivos Online","v":"5.085","t":"+15.1%","d":"up"},{"l":"Dados/Min (MB)","v":"7.321","t":"-5.7%","d":"down"},{"l":"Alertas Ativos","v":"1.769","t":"-1.6%","d":"down"},{"l":"Uptime (%)","v":"93.0%","t":"+6.5%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.071","2.593","2.151","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.266","1.532","3.985","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","100","1.127","4.934","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.063","8.712","5.174","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.524","522","5.059","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":417},{"label":"Fev","value":492},{"label":"Mar","value":645},{"label":"Abr","value":561},{"label":"Mai","value":377},{"label":"Jun","value":664},{"label":"Jul","value":471},{"label":"Ago","value":723},{"label":"Set","value":540},{"label":"Out","value":672},{"label":"Nov","value":569},{"label":"Dez","value":735}];
const MX = 735;
