...
const ACCENT = "#dc2626";
const MODULE = "SCADA & IoT";
const PAGE = "Device Registry";
const KPIS = [{"l":"Dispositivos Online","v":"2.986","t":"+16.8%","d":"up"},{"l":"Dados/Min (MB)","v":"2.867","t":"-0.2%","d":"down"},{"l":"Alertas Ativos","v":"6.888","t":"+1.2%","d":"up"},{"l":"Uptime (%)","v":"67.2%","t":"+11.4%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.815","3.370","8.518","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.974","4.602","6.677","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.920","4.451","8.541","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.133","8.332","5.108","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","1.353","4.839","7.064","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":483},{"label":"Mar","value":551},{"label":"Abr","value":456},{"label":"Mai","value":626},{"label":"Jun","value":449},{"label":"Jul","value":455},{"label":"Ago","value":294},{"label":"Set","value":368},{"label":"Out","value":349},{"label":"Nov","value":286},{"label":"Dez","value":512}];
const MX = 626;
