...
const KPIS = [{"l":"Dispositivos Online","v":"4.041","t":"-0.2%","d":"down"},{"l":"Dados/Min (MB)","v":"1.713","t":"+16.4%","d":"up"},{"l":"Alertas Ativos","v":"4.608","t":"+16.4%","d":"up"},{"l":"Uptime (%)","v":"70.9%","t":"+13.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","1.979","2.941","4.798","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.837","2.925","3.207","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.397","6.619","1.190","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","114","1.878","2.794","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.866","6.160","1.439","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":379},{"label":"Mar","value":638},{"label":"Abr","value":454},{"label":"Mai","value":592},{"label":"Jun","value":562},{"label":"Jul","value":421},{"label":"Ago","value":553},{"label":"Set","value":667},{"label":"Out","value":442},{"label":"Nov","value":413},{"label":"Dez","value":692}];
const MX = 692;
