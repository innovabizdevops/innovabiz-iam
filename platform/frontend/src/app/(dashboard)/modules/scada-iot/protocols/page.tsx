...
const PAGE = "Protocol Bridge";
const KPIS = [{"l":"Dispositivos Online","v":"356","t":"+7.8%","d":"up"},{"l":"Dados/Min (MB)","v":"3.141","t":"+10.4%","d":"up"},{"l":"Alertas Ativos","v":"5.158","t":"+12.4%","d":"up"},{"l":"Uptime (%)","v":"89.9%","t":"-1.4%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","1.471","8.645","1.377","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.914","2.508","5.905","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.068","5.680","5.454","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.821","5.163","7.246","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.074","3.306","6.854","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":749},{"label":"Fev","value":710},{"label":"Mar","value":807},{"label":"Abr","value":578},{"label":"Mai","value":903},{"label":"Jun","value":822},{"label":"Jul","value":596},{"label":"Ago","value":779},{"label":"Set","value":565},{"label":"Out","value":645},{"label":"Nov","value":951},{"label":"Dez","value":563}];
const MX = 951;
