...
const PAGE = "Train";
const KPIS = [{"l":"Total Agri Extension","v":"5.697","t":"+12.0%","d":"up"},{"l":"Train Ativos","v":"260","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"93.9%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"80","t":"+1.3%","d":"up"}];
const COLS = ["ID","Train","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Extension #001","Agri Extension #002","6.334","6.504","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Extension #002","Agri Extension #003","8.549","2.808","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Extension #003","Agri Extension #004","2.992","820","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Extension #004","Agri Extension #005","2.588","3.482","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Extension #005","Agri Extension #001","3.891","1.810","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":794},{"label":"Mar","value":573},{"label":"Abr","value":776},{"label":"Mai","value":641},{"label":"Jun","value":613},{"label":"Jul","value":685},{"label":"Ago","value":941},{"label":"Set","value":713},{"label":"Out","value":835},{"label":"Nov","value":839},{"label":"Dez","value":588}];
const MX = 941;
