...
const KPIS = [{"l":"Artigos Publicados","v":"6.636","t":"-1.5%","d":"down"},{"l":"Views/Semana","v":"488","t":"-4.1%","d":"down"},{"l":"Feedback Útil (%)","v":"73.2%","t":"+5.5%","d":"up"},{"l":"Artigos Desatualizados","v":"2.401","t":"+10.7%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","1.260","95.2%","7.483","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","5.095","76.1%","5.024","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","2.460","74.4%","326","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","8.586","75.8%","8.657","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","4.460","86.5%","205","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":550},{"label":"Fev","value":629},{"label":"Mar","value":644},{"label":"Abr","value":391},{"label":"Mai","value":540},{"label":"Jun","value":375},{"label":"Jul","value":477},{"label":"Ago","value":454},{"label":"Set","value":254},{"label":"Out","value":322},{"label":"Nov","value":442},{"label":"Dez","value":631}];
const MX = 644;
