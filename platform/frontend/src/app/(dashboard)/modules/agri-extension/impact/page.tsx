...
const PAGE = "Impact";
const KPIS = [{"l":"Projetos Sociais","v":"3.105","t":"+0.5%","d":"up"},{"l":"Beneficiários","v":"2.983","t":"+8.5%","d":"up"},{"l":"Investimento CSR (€)","v":"€36588","t":"+3.1%","d":"up"},{"l":"Score Impacto","v":"87","t":"+-0.0%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","1.242","€ 10298.89","2.414","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","7.619","€ 2436.86","5.723","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","923","€ 29911.10","370","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","4.734","€ 32472.69","5.517","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","817","€ 33777.60","266","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":749},{"label":"Fev","value":742},{"label":"Mar","value":739},{"label":"Abr","value":826},{"label":"Mai","value":1063},{"label":"Jun","value":936},{"label":"Jul","value":896},{"label":"Ago","value":768},{"label":"Set","value":783},{"label":"Out","value":933},{"label":"Nov","value":976},{"label":"Dez","value":679}];
const MX = 1063;
