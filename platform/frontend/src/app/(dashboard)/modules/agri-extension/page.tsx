...
/* ═══ Extension Services Platform — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "4794", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1245", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€31K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1430277494", cells: ["AGR-7494", "Extension Services Platform Item 1", "3/3/2026", "€27 594"], status: "active" as const },
    { id: "1430281065", cells: ["AGR-2065", "Extension Services Platform Item 2", "18/10/2026", "€31 165"], status: "pending" as const },
    { id: "1430284636", cells: ["AGR-5636", "Extension Services Platform Item 3", "5/5/2026", "€34 736"], status: "completed" as const },
    { id: "1430288207", cells: ["AGR-9207", "Extension Services Platform Item 4", "20/12/2026", "€38 307"], status: "warning" as const },
    { id: "1430291778", cells: ["AGR-3778", "Extension Services Platform Item 5", "7/7/2026", "€41 878"], status: "active" as const },
];
...
export default function ExtensionServicesPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Extension Services Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Extension Services Platform</p>
                    </div>
                </div>
