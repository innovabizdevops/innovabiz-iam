...
const ACCENT = "#166534";
const MODULE = "Extension Services Platform";
const PAGE = "Advisory";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.124","t":"+4.1%","d":"up"},{"l":"NC Abertas","v":"3.329","t":"+5.0%","d":"up"},{"l":"Conformidade (%)","v":"78.3%","t":"+9.1%","d":"up"},{"l":"CAPAs Pendentes","v":"4.515","t":"+16.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","351","84.7%","3.641","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","462","84.8%","6.507","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.552","75.7%","1.573","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.777","93.0%","6.503","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.670","99.4%","3.236","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":754},{"label":"Mar","value":621},{"label":"Abr","value":609},{"label":"Mai","value":798},{"label":"Jun","value":541},{"label":"Jul","value":582},{"label":"Ago","value":513},{"label":"Set","value":863},{"label":"Out","value":818},{"label":"Nov","value":828},{"label":"Dez","value":887}];
const MX = 887;
