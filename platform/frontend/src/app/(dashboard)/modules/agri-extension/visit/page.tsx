...
const PAGE = "Field Visit";
const KPIS = [{"l":"Total Agri Extension","v":"5.124","t":"-4.6%","d":"down"},{"l":"Field Visit Ativos","v":"3.345","t":"+6.6%","d":"up"},{"l":"Eficiência (%)","v":"86.4%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"80","t":"+7.2%","d":"up"}];
const COLS = ["ID","Field Visit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Extension #001","Agri Extension #002","6.084","5.577","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Extension #002","Agri Extension #003","8.804","1.352","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Extension #003","Agri Extension #004","1.443","6.448","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Extension #004","Agri Extension #005","6.744","6.156","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Extension #005","Agri Extension #001","5.563","9.077","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":563},{"label":"Mar","value":562},{"label":"Abr","value":671},{"label":"Mai","value":789},{"label":"Jun","value":485},{"label":"Jul","value":701},{"label":"Ago","value":492},{"label":"Set","value":673},{"label":"Out","value":556},{"label":"Nov","value":584},{"label":"Dez","value":803}];
const MX = 803;
