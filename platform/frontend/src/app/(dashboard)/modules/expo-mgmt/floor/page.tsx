...
const KPIS = [{"l":"Total Expo Mgmt","v":"4.330","t":"+14.9%","d":"up"},{"l":"Floor Plan Ativos","v":"928","t":"+4.9%","d":"up"},{"l":"Eficiência (%)","v":"70.0%","t":"-3.0%","d":"down"},{"l":"Score Performance","v":"74","t":"+4.4%","d":"up"}];
const COLS = ["ID","Floor Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Expo Mgmt #001","Expo Mgmt #002","529","9.033","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Expo Mgmt #002","Expo Mgmt #003","3.699","1.228","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Expo Mgmt #003","Expo Mgmt #004","8.912","8.285","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Expo Mgmt #004","Expo Mgmt #005","1.391","7.070","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Expo Mgmt #005","Expo Mgmt #001","2.788","2.329","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":461},{"label":"Fev","value":527},{"label":"Mar","value":651},{"label":"Abr","value":593},{"label":"Mai","value":388},{"label":"Jun","value":354},{"label":"Jul","value":655},{"label":"Ago","value":561},{"label":"Set","value":440},{"label":"Out","value":602},{"label":"Nov","value":316},{"label":"Dez","value":650}];
const MX = 655;
