...
/* ═══ Expo & Trade Show — Dashboard ═══ */

const ACCENT = "#831843";

const KPIS = [
    { label: "Total Registos", value: "2419", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3928", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€400K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "-2%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "923622819", cells: ["EXP-7819", "Expo & Trade Show Item 1", "8/4/2026", "€22 919"], status: "active" as const },
    { id: "923626390", cells: ["EXP-2390", "Expo & Trade Show Item 2", "23/11/2026", "€26 490"], status: "pending" as const },
    { id: "923629961", cells: ["EXP-5961", "Expo & Trade Show Item 3", "10/6/2026", "€30 061"], status: "completed" as const },
    { id: "923633532", cells: ["EXP-9532", "Expo & Trade Show Item 4", "25/1/2026", "€33 632"], status: "warning" as const },
    { id: "923637103", cells: ["EXP-4103", "Expo & Trade Show Item 5", "12/8/2026", "€37 203"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Expo & Trade Show</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Expo & Trade Show</p>
                    </div>
                </div>
