...
const ACCENT = "#831843";
const MODULE = "Expo & Trade Show";
const PAGE = "Lead";
const KPIS = [{"l":"Total Expo Mgmt","v":"8.245","t":"+0.2%","d":"up"},{"l":"Lead Ativos","v":"3.406","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"86.0%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"85","t":"-4.8%","d":"down"}];
const COLS = ["ID","Lead","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Expo Mgmt #001","Expo Mgmt #002","7.429","3.555","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Expo Mgmt #002","Expo Mgmt #003","7.749","7.055","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Expo Mgmt #003","Expo Mgmt #004","8.725","7.672","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Expo Mgmt #004","Expo Mgmt #005","8.542","8.517","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Expo Mgmt #005","Expo Mgmt #001","5.472","1.462","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":473},{"label":"Mar","value":575},{"label":"Abr","value":621},{"label":"Mai","value":462},{"label":"Jun","value":515},{"label":"Jul","value":665},{"label":"Ago","value":671},{"label":"Set","value":538},{"label":"Out","value":614},{"label":"Nov","value":428},{"label":"Dez","value":523}];
const MX = 671;
