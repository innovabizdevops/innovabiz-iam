...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€3.3M","t":"-1.5%","d":"down"},{"l":"MRR (€)","v":"€24876","t":"-2.8%","d":"down"},{"l":"Churn (%)","v":"89.8%","t":"-2.6%","d":"down"},{"l":"ARPU (€)","v":"€49777","t":"-5.4%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 10899.09","8.413","€ 35051.32","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 6218.68","4.475","€ 27842.13","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 9615.67","3.090","€ 42569.29","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 40939.64","1.189","€ 36788.19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 9051.11","6.149","€ 19453.71","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":823},{"label":"Mar","value":799},{"label":"Abr","value":633},{"label":"Mai","value":649},{"label":"Jun","value":845},{"label":"Jul","value":751},{"label":"Ago","value":631},{"label":"Set","value":598},{"label":"Out","value":569},{"label":"Nov","value":520},{"label":"Dez","value":650}];
const MX = 845;
