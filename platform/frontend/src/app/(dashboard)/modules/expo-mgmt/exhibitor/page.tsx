...
const PAGE = "Exhibitor";
const KPIS = [{"l":"Total Expo Mgmt","v":"7.855","t":"-4.2%","d":"down"},{"l":"Exhibitor Ativos","v":"7.332","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"80.7%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"59","t":"-5.8%","d":"down"}];
const COLS = ["ID","Exhibitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Expo Mgmt #001","Expo Mgmt #002","4.767","5.184","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Expo Mgmt #002","Expo Mgmt #003","850","8.658","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Expo Mgmt #003","Expo Mgmt #004","4.243","5.826","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Expo Mgmt #004","Expo Mgmt #005","2.000","3.104","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Expo Mgmt #005","Expo Mgmt #001","1.294","5.709","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":764},{"label":"Fev","value":738},{"label":"Mar","value":706},{"label":"Abr","value":698},{"label":"Mai","value":526},{"label":"Jun","value":496},{"label":"Jul","value":831},{"label":"Ago","value":779},{"label":"Set","value":625},{"label":"Out","value":819},{"label":"Nov","value":787},{"label":"Dez","value":746}];
const MX = 831;
