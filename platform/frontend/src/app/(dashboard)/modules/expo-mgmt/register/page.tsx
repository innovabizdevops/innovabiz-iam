...
const PAGE = "Register";
const KPIS = [{"l":"Total Expo Mgmt","v":"7.548","t":"+2.3%","d":"up"},{"l":"Register Ativos","v":"1.107","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"90.3%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"73","t":"+14.2%","d":"up"}];
const COLS = ["ID","Register","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Expo Mgmt #001","Expo Mgmt #002","115","4.973","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Expo Mgmt #002","Expo Mgmt #003","3.561","5.957","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Expo Mgmt #003","Expo Mgmt #004","6.472","1.898","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Expo Mgmt #004","Expo Mgmt #005","7.032","6.489","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Expo Mgmt #005","Expo Mgmt #001","1.575","7.818","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":397},{"label":"Fev","value":539},{"label":"Mar","value":503},{"label":"Abr","value":487},{"label":"Mai","value":602},{"label":"Jun","value":333},{"label":"Jul","value":579},{"label":"Ago","value":339},{"label":"Set","value":565},{"label":"Out","value":492},{"label":"Nov","value":312},{"label":"Dez","value":674}];
const MX = 674;
