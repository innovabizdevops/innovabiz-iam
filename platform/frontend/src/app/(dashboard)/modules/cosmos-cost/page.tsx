...
/* ═══ COSMOS Cost Intelligence — Dashboard ═══ */

const ACCENT = "#1e1b4b";

const KPIS = [
    { label: "Total Registos", value: "1199", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1139", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€75K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1470279799", cells: ["COS-4799", "COSMOS Cost Intelligence Item 1", "24/8/2026", "€29 899"], status: "active" as const },
    { id: "1470283370", cells: ["COS-8370", "COSMOS Cost Intelligence Item 2", "11/3/2026", "€33 470"], status: "pending" as const },
    { id: "1470286941", cells: ["COS-2941", "COSMOS Cost Intelligence Item 3", "26/10/2026", "€37 041"], status: "completed" as const },
    { id: "1470290512", cells: ["COS-6512", "COSMOS Cost Intelligence Item 4", "13/5/2026", "€40 612"], status: "warning" as const },
    { id: "1470294083", cells: ["COS-1083", "COSMOS Cost Intelligence Item 5", "28/12/2026", "€44 183"], status: "active" as const },
];
...
export default function CosmosCostIntelligencePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">COSMOS Cost Intelligence</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • COSMOS Cost Intelligence</p>
                    </div>
                </div>
