...
const ACCENT = "#6366f1";
const MODULE = "Autonomous Vehicles";
const PAGE = "V2X Comms";
const KPIS = [{"l":"Total Av Fleet","v":"5.707","t":"+2.9%","d":"up"},{"l":"V2X Comms Ativos","v":"7.966","t":"+0.9%","d":"up"},{"l":"Eficiência (%)","v":"84.8%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"74","t":"+1.6%","d":"up"}];
const COLS = ["ID","V2X Comms","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Av Fleet #001","Av Fleet #002","7.186","5.489","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Av Fleet #002","Av Fleet #003","5.364","818","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Av Fleet #003","Av Fleet #004","3.417","6.773","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Av Fleet #004","Av Fleet #005","3.101","5.922","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Av Fleet #005","Av Fleet #001","6.614","7.153","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":329},{"label":"Fev","value":487},{"label":"Mar","value":457},{"label":"Abr","value":482},{"label":"Mai","value":360},{"label":"Jun","value":590},{"label":"Jul","value":471},{"label":"Ago","value":406},{"label":"Set","value":241},{"label":"Out","value":420},{"label":"Nov","value":386},{"label":"Dez","value":594}];
const MX = 594;
