...
const PAGE = "Fleet OTA";
const KPIS = [{"l":"Total Av Fleet","v":"1.930","t":"+6.6%","d":"up"},{"l":"Fleet OTA Ativos","v":"7.499","t":"+1.4%","d":"up"},{"l":"Eficiência (%)","v":"68.8%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"83","t":"-5.0%","d":"down"}];
const COLS = ["ID","Fleet OTA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Av Fleet #001","Av Fleet #002","6.969","5.514","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Av Fleet #002","Av Fleet #003","696","5.328","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Av Fleet #003","Av Fleet #004","3.159","1.501","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Av Fleet #004","Av Fleet #005","3.439","8.158","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Av Fleet #005","Av Fleet #001","3.068","4.568","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":521},{"label":"Mar","value":483},{"label":"Abr","value":780},{"label":"Mai","value":663},{"label":"Jun","value":805},{"label":"Jul","value":576},{"label":"Ago","value":616},{"label":"Set","value":499},{"label":"Out","value":780},{"label":"Nov","value":727},{"label":"Dez","value":802}];
const MX = 805;
