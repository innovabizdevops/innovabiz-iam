...
export default function AvFleetPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Av Fleet</h1><p className="text-sm text-muted-foreground">Av Fleet • iBOS Enterprise</p></div>
