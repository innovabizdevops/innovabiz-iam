...
const KPIS = [{"l":"Total Av Fleet","v":"3.068","t":"+0.2%","d":"up"},{"l":"Safety Case Ativos","v":"8.427","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"83.9%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"93","t":"+4.0%","d":"up"}];
const COLS = ["ID","Safety Case","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Av Fleet #001","Av Fleet #002","957","8.822","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Av Fleet #002","Av Fleet #003","717","1.471","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Av Fleet #003","Av Fleet #004","8.896","7.656","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Av Fleet #004","Av Fleet #005","1.450","7.657","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Av Fleet #005","Av Fleet #001","204","7.896","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":731},{"label":"Mar","value":851},{"label":"Abr","value":854},{"label":"Mai","value":901},{"label":"Jun","value":975},{"label":"Jul","value":826},{"label":"Ago","value":915},{"label":"Set","value":871},{"label":"Out","value":756},{"label":"Nov","value":928},{"label":"Dez","value":933}];
const MX = 975;
