...
/* ═══ Skills Taxonomy Platform — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "4455", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2409", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€60K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "134406755", cells: ["SKI-1755", "Skills Taxonomy Platform Item 1", "8/12/2026", "€6855"], status: "active" as const },
    { id: "134410326", cells: ["SKI-5326", "Skills Taxonomy Platform Item 2", "23/7/2026", "€10 426"], status: "pending" as const },
    { id: "134413897", cells: ["SKI-8897", "Skills Taxonomy Platform Item 3", "10/2/2026", "€13 997"], status: "completed" as const },
    { id: "134417468", cells: ["SKI-3468", "Skills Taxonomy Platform Item 4", "25/9/2026", "€17 568"], status: "warning" as const },
    { id: "134421039", cells: ["SKI-7039", "Skills Taxonomy Platform Item 5", "12/4/2026", "€21 139"], status: "active" as const },
];
...
export default function SkillsTaxonomyPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Skills Taxonomy Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Skills Taxonomy Platform</p>
                    </div>
                </div>
