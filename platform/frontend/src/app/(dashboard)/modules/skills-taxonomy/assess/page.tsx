...
const ACCENT = "#0e7490";
const MODULE = "Skills Taxonomy Platform";
const PAGE = "Assess";
const KPIS = [{"l":"Total Skills Taxonomy","v":"8.685","t":"-5.9%","d":"down"},{"l":"Assess Ativos","v":"5.874","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"79.1%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"60","t":"+0.8%","d":"up"}];
const COLS = ["ID","Assess","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Skills Taxonomy #001","Skills Taxonomy #002","5.076","6.095","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Skills Taxonomy #002","Skills Taxonomy #003","6.683","323","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Skills Taxonomy #003","Skills Taxonomy #004","1.594","2.948","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Skills Taxonomy #004","Skills Taxonomy #005","3.196","3.282","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Skills Taxonomy #005","Skills Taxonomy #001","7.989","5.456","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":891},{"label":"Mar","value":745},{"label":"Abr","value":704},{"label":"Mai","value":746},{"label":"Jun","value":843},{"label":"Jul","value":653},{"label":"Ago","value":632},{"label":"Set","value":705},{"label":"Out","value":873},{"label":"Nov","value":698},{"label":"Dez","value":542}];
const MX = 891;
