...
const PAGE = "Funnel View";
const KPIS = [{"l":"Dashboards Ativos","v":"4.959","t":"-0.3%","d":"down"},{"l":"Queries/Dia","v":"941","t":"+16.1%","d":"up"},{"l":"Dados Processados (GB)","v":"2.656","t":"-5.9%","d":"down"},{"l":"Utilizadores Analytics","v":"4.911","t":"+17.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4287","2026-01-18","8.477","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","242","2026-02-21","2.341","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4320","2026-03-01","6.923","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1487","2026-02-04","4.176","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1043","2026-03-08","8.149","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":953},{"label":"Fev","value":725},{"label":"Mar","value":821},{"label":"Abr","value":955},{"label":"Mai","value":935},{"label":"Jun","value":953},{"label":"Jul","value":984},{"label":"Ago","value":903},{"label":"Set","value":842},{"label":"Out","value":1028},{"label":"Nov","value":843},{"label":"Dez","value":813}];
const MX = 1028;
