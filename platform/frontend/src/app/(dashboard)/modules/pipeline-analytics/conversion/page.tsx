...
const PAGE = "Conversion Rate";
const KPIS = [{"l":"Formulários Ativos","v":"5.404","t":"+6.2%","d":"up"},{"l":"Submissões/Dia","v":"1760","t":"+11.5%","d":"up"},{"l":"Documentos Gerados","v":"7.844","t":"+8.3%","d":"up"},{"l":"Templates","v":"6.418","t":"+7.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.848","2026-03-27","128","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.327","2026-03-18","3.688","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.871","2026-01-13","7.024","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.624","2026-02-23","4.975","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.058","2026-01-27","1.681","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":488},{"label":"Fev","value":497},{"label":"Mar","value":383},{"label":"Abr","value":622},{"label":"Mai","value":619},{"label":"Jun","value":613},{"label":"Jul","value":532},{"label":"Ago","value":599},{"label":"Set","value":579},{"label":"Out","value":467},{"label":"Nov","value":550},{"label":"Dez","value":275}];
const MX = 622;
