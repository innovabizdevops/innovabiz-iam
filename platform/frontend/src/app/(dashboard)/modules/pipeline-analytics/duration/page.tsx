...
const PAGE = "Stage Duration";
const KPIS = [{"l":"Dashboards Ativos","v":"4.615","t":"+3.2%","d":"up"},{"l":"Queries/Dia","v":"1613","t":"+6.1%","d":"up"},{"l":"Dados Processados (GB)","v":"7.882","t":"+8.7%","d":"up"},{"l":"Utilizadores Analytics","v":"8.392","t":"+11.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4272","2026-01-22","1.499","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4117","2026-03-20","6.394","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4879","2026-01-16","3.859","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2859","2026-01-01","8.274","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1479","2026-02-08","6.949","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":347},{"label":"Fev","value":601},{"label":"Mar","value":283},{"label":"Abr","value":484},{"label":"Mai","value":428},{"label":"Jun","value":245},{"label":"Jul","value":320},{"label":"Ago","value":419},{"label":"Set","value":400},{"label":"Out","value":438},{"label":"Nov","value":419},{"label":"Dez","value":293}];
const MX = 601;
