...
const PAGE = "Velocity Metrics";
const KPIS = [{"l":"Dashboards Ativos","v":"284","t":"+14.8%","d":"up"},{"l":"Queries/Dia","v":"501","t":"-5.3%","d":"down"},{"l":"Dados Processados (GB)","v":"8.277","t":"+2.5%","d":"up"},{"l":"Utilizadores Analytics","v":"7.657","t":"+1.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4645","2026-01-09","669","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2939","2026-03-12","4.461","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2293","2026-01-03","8.806","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4251","2026-03-16","6.015","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","859","2026-03-23","1.869","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":608},{"label":"Mar","value":608},{"label":"Abr","value":698},{"label":"Mai","value":529},{"label":"Jun","value":691},{"label":"Jul","value":603},{"label":"Ago","value":653},{"label":"Set","value":760},{"label":"Out","value":740},{"label":"Nov","value":574},{"label":"Dez","value":748}];
const MX = 760;
