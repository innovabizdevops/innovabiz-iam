...
const ACCENT = "#78350f";
const MODULE = "Pipeline Analytics";
const PAGE = "Bottleneck AI";
const KPIS = [{"l":"Dashboards Ativos","v":"4.381","t":"+8.2%","d":"up"},{"l":"Queries/Dia","v":"577","t":"+17.3%","d":"up"},{"l":"Dados Processados (GB)","v":"3.863","t":"-3.6%","d":"down"},{"l":"Utilizadores Analytics","v":"2.788","t":"+14.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2265","2026-02-13","9.066","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4072","2026-02-13","6.369","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","118","2026-03-09","7.965","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3763","2026-03-09","3.525","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","878","2026-01-13","4.068","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":795},{"label":"Mar","value":880},{"label":"Abr","value":543},{"label":"Mai","value":539},{"label":"Jun","value":691},{"label":"Jul","value":490},{"label":"Ago","value":739},{"label":"Set","value":833},{"label":"Out","value":679},{"label":"Nov","value":843},{"label":"Dez","value":838}];
const MX = 880;
