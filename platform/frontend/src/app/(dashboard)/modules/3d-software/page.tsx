...
/* ═══ 3D Print Software — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "6422", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1014", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€128K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1235714422", cells: ["3D-6422", "3D Print Software Item 1", "27/11/2026", "€14 522"], status: "active" as const },
    { id: "1235717993", cells: ["3D-9993", "3D Print Software Item 2", "14/6/2026", "€18 093"], status: "pending" as const },
    { id: "1235721564", cells: ["3D-4564", "3D Print Software Item 3", "1/1/2026", "€21 664"], status: "completed" as const },
    { id: "1235725135", cells: ["3D-8135", "3D Print Software Item 4", "16/8/2026", "€25 235"], status: "warning" as const },
    { id: "1235728706", cells: ["3D-2706", "3D Print Software Item 5", "3/3/2026", "€28 806"], status: "active" as const },
];
...
export default function P3dPrintSoftwarePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">3D Print Software</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • 3D Print Software</p>
                    </div>
                </div>
