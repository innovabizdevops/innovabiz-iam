...
const PAGE = "Simulate";
const KPIS = [{"l":"Twins Ativos","v":"581","t":"-0.8%","d":"down"},{"l":"Simulações/Dia","v":"3198","t":"+6.6%","d":"up"},{"l":"Precisão Modelo (%)","v":"78.3%","t":"+6.2%","d":"up"},{"l":"Latência Sync (ms)","v":"15ms","t":"-3.7%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","80.0%","2026-03-26","4.813","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","70.3%","2026-01-05","1.093","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","98.3%","2026-03-16","7.995","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","98.4%","2026-03-07","7.431","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","98.3%","2026-03-20","1.926","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":356},{"label":"Fev","value":379},{"label":"Mar","value":405},{"label":"Abr","value":461},{"label":"Mai","value":311},{"label":"Jun","value":597},{"label":"Jul","value":307},{"label":"Ago","value":387},{"label":"Set","value":597},{"label":"Out","value":619},{"label":"Nov","value":547},{"label":"Dez","value":227}];
const MX = 619;
