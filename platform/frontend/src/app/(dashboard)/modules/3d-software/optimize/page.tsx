...
const ACCENT = "#4f46e5";
const MODULE = "3D Print Software";
const PAGE = "Optimize";
const KPIS = [{"l":"Total 3d Software","v":"4.047","t":"-2.8%","d":"down"},{"l":"Optimize Ativos","v":"6.189","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"81.7%","t":"+15.7%","d":"up"},{"l":"Score Performance","v":"84","t":"+0.5%","d":"up"}];
const COLS = ["ID","Optimize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Software #001","3d Software #002","763","2.754","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["3d Software #002","3d Software #003","3.884","5.031","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Software #003","3d Software #004","4.299","4.459","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["3d Software #004","3d Software #005","8.353","9.099","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Software #005","3d Software #001","1.958","4.463","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":718},{"label":"Fev","value":581},{"label":"Mar","value":580},{"label":"Abr","value":640},{"label":"Mai","value":553},{"label":"Jun","value":759},{"label":"Jul","value":647},{"label":"Ago","value":640},{"label":"Set","value":749},{"label":"Out","value":737},{"label":"Nov","value":802},{"label":"Dez","value":736}];
const MX = 802;
