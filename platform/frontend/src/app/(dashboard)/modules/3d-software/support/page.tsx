...
const PAGE = "Support";
const KPIS = [{"l":"Tickets Abertos","v":"1.149","t":"+14.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"73.8%","t":"+6.6%","d":"up"},{"l":"MTTR (h)","v":"202h","t":"+9.0%","d":"up"},{"l":"Satisfação (%)","v":"70.5%","t":"+8.2%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.875","8.745","2.620","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.491","7.193","589","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.643","7.431","7.654","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.079","9.097","697","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.063","8.360","7.993","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":541},{"label":"Mar","value":657},{"label":"Abr","value":802},{"label":"Mai","value":651},{"label":"Jun","value":493},{"label":"Jul","value":754},{"label":"Ago","value":408},{"label":"Set","value":641},{"label":"Out","value":632},{"label":"Nov","value":478},{"label":"Dez","value":766}];
const MX = 802;
