...
const PAGE = "Product Catalog";
const KPIS = [{"l":"Formulários Ativos","v":"8.481","t":"+2.7%","d":"up"},{"l":"Submissões/Dia","v":"2471","t":"+16.3%","d":"up"},{"l":"Documentos Gerados","v":"1.235","t":"+17.1%","d":"up"},{"l":"Templates","v":"4.332","t":"-0.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.513","2026-01-15","4.049","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.945","2026-02-28","7.094","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.431","2026-01-02","891","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.677","2026-01-13","688","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","949","2026-02-01","3.069","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":948},{"label":"Mar","value":988},{"label":"Abr","value":889},{"label":"Mai","value":720},{"label":"Jun","value":960},{"label":"Jul","value":970},{"label":"Ago","value":1010},{"label":"Set","value":909},{"label":"Out","value":961},{"label":"Nov","value":663},{"label":"Dez","value":794}];
const MX = 1010;
...
export default function CatalogPimPage() {
    return (
