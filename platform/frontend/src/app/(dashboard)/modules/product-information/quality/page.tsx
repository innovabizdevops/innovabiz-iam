...
const KPIS = [{"l":"Auditorias Realizadas","v":"1.200","t":"+7.5%","d":"up"},{"l":"NC Abertas","v":"5.855","t":"-2.0%","d":"down"},{"l":"Conformidade (%)","v":"84.4%","t":"+10.5%","d":"up"},{"l":"CAPAs Pendentes","v":"6.114","t":"+10.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.604","71.1%","1.117","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.838","90.7%","7.452","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.972","82.3%","6.497","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.556","93.1%","3.763","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","376","84.3%","3.178","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":621},{"label":"Mar","value":891},{"label":"Abr","value":750},{"label":"Mai","value":798},{"label":"Jun","value":848},{"label":"Jul","value":919},{"label":"Ago","value":790},{"label":"Set","value":851},{"label":"Out","value":891},{"label":"Nov","value":767},{"label":"Dez","value":604}];
const MX = 919;
