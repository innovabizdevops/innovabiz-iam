...
const KPIS = [{"l":"Formulários Ativos","v":"1.385","t":"+6.8%","d":"up"},{"l":"Submissões/Dia","v":"4331","t":"+9.7%","d":"up"},{"l":"Documentos Gerados","v":"5.939","t":"+1.2%","d":"up"},{"l":"Templates","v":"8.779","t":"+10.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.475","2026-02-11","2.451","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.190","2026-03-11","6.575","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.417","2026-01-14","1.118","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.104","2026-03-16","6.103","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.383","2026-03-18","6.077","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":648},{"label":"Mar","value":928},{"label":"Abr","value":654},{"label":"Mai","value":749},{"label":"Jun","value":615},{"label":"Jul","value":604},{"label":"Ago","value":560},{"label":"Set","value":950},{"label":"Out","value":946},{"label":"Nov","value":785},{"label":"Dez","value":708}];
const MX = 950;
