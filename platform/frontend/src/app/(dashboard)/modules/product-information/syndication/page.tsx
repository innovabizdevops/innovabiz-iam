...
const PAGE = "Syndication &amp; Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.913","t":"-2.0%","d":"down"},{"l":"NC Abertas","v":"1.083","t":"-1.3%","d":"down"},{"l":"Conformidade (%)","v":"94.3%","t":"-2.8%","d":"down"},{"l":"CAPAs Pendentes","v":"3.756","t":"-0.3%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.575","82.7%","3.510","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.276","89.6%","2.166","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.301","95.4%","7.402","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","432","92.6%","1.801","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","708","97.8%","3.334","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":358},{"label":"Fev","value":374},{"label":"Mar","value":688},{"label":"Abr","value":617},{"label":"Mai","value":676},{"label":"Jun","value":520},{"label":"Jul","value":435},{"label":"Ago","value":524},{"label":"Set","value":542},{"label":"Out","value":627},{"label":"Nov","value":445},{"label":"Dez","value":426}];
const MX = 688;
