...
const PAGE = "Data Enrichment AI";
const KPIS = [{"l":"Formulários Ativos","v":"2.801","t":"+8.2%","d":"up"},{"l":"Submissões/Dia","v":"5087","t":"+6.1%","d":"up"},{"l":"Documentos Gerados","v":"8.740","t":"+14.4%","d":"up"},{"l":"Templates","v":"393","t":"+3.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.629","2026-03-15","5.945","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.171","2026-02-01","1.084","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.317","2026-03-22","3.416","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.756","2026-02-07","7.364","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.235","2026-01-08","6.940","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":328},{"label":"Mar","value":660},{"label":"Abr","value":701},{"label":"Mai","value":534},{"label":"Jun","value":346},{"label":"Jul","value":450},{"label":"Ago","value":427},{"label":"Set","value":652},{"label":"Out","value":506},{"label":"Nov","value":379},{"label":"Dez","value":698}];
const MX = 701;
