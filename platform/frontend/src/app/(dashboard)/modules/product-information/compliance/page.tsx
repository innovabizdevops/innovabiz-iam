...
const PAGE = "Compliance Labels";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.281","t":"+15.2%","d":"up"},{"l":"NC Abertas","v":"8.404","t":"+5.0%","d":"up"},{"l":"Conformidade (%)","v":"84.7%","t":"+12.1%","d":"up"},{"l":"CAPAs Pendentes","v":"3.228","t":"+2.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.794","98.9%","1.622","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.837","81.5%","8.191","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.244","72.5%","4.935","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.784","73.7%","1.780","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.915","86.8%","4.331","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":397},{"label":"Mar","value":553},{"label":"Abr","value":370},{"label":"Mai","value":543},{"label":"Jun","value":333},{"label":"Jul","value":471},{"label":"Ago","value":413},{"label":"Set","value":344},{"label":"Out","value":659},{"label":"Nov","value":340},{"label":"Dez","value":304}];
const MX = 659;
