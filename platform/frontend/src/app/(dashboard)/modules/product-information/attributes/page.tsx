...
const PAGE = "Attribute Mgmt";
const KPIS = [{"l":"Formulários Ativos","v":"515","t":"+8.7%","d":"up"},{"l":"Submissões/Dia","v":"4611","t":"+9.6%","d":"up"},{"l":"Documentos Gerados","v":"8.579","t":"+6.9%","d":"up"},{"l":"Templates","v":"5.364","t":"-0.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.953","2026-03-12","4.424","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.869","2026-03-25","5.678","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.875","2026-01-17","6.768","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.692","2026-02-13","6.242","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.968","2026-03-15","2.611","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":276},{"label":"Fev","value":369},{"label":"Mar","value":220},{"label":"Abr","value":282},{"label":"Mai","value":445},{"label":"Jun","value":306},{"label":"Jul","value":218},{"label":"Ago","value":541},{"label":"Set","value":216},{"label":"Out","value":512},{"label":"Nov","value":324},{"label":"Dez","value":444}];
const MX = 541;
