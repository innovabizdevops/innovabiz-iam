...
const PAGE = "Channel Syndication";
const KPIS = [{"l":"Formulários Ativos","v":"1.434","t":"+5.7%","d":"up"},{"l":"Submissões/Dia","v":"169","t":"+1.9%","d":"up"},{"l":"Documentos Gerados","v":"4.136","t":"+0.7%","d":"up"},{"l":"Templates","v":"791","t":"+1.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.725","2026-02-03","8.812","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.702","2026-02-13","461","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.535","2026-01-05","5.449","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.660","2026-03-25","8.923","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.072","2026-02-04","871","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":810},{"label":"Mar","value":734},{"label":"Abr","value":761},{"label":"Mai","value":783},{"label":"Jun","value":774},{"label":"Jul","value":803},{"label":"Ago","value":822},{"label":"Set","value":802},{"label":"Out","value":861},{"label":"Nov","value":782},{"label":"Dez","value":708}];
const MX = 861;
...
export default function SyndicationPimPage() {
    return (
