...
const PAGE = "Digital Assets";
const KPIS = [{"l":"Formulários Ativos","v":"568","t":"+16.2%","d":"up"},{"l":"Submissões/Dia","v":"252","t":"-0.4%","d":"down"},{"l":"Documentos Gerados","v":"5.612","t":"+17.1%","d":"up"},{"l":"Templates","v":"1.509","t":"+0.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.977","2026-01-21","1.186","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.446","2026-02-23","1.842","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","192","2026-01-02","2.184","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.045","2026-02-22","1.113","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.707","2026-01-08","5.000","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":614},{"label":"Mar","value":925},{"label":"Abr","value":565},{"label":"Mai","value":836},{"label":"Jun","value":677},{"label":"Jul","value":721},{"label":"Ago","value":936},{"label":"Set","value":728},{"label":"Out","value":646},{"label":"Nov","value":647},{"label":"Dez","value":696}];
const MX = 936;
