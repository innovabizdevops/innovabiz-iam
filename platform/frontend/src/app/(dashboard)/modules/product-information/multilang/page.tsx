...
const ACCENT = "#6366f1";
const MODULE = "Product Information";
const PAGE = "Multi-Language";
const KPIS = [{"l":"Formulários Ativos","v":"8.307","t":"-5.9%","d":"down"},{"l":"Submissões/Dia","v":"2746","t":"+2.2%","d":"up"},{"l":"Documentos Gerados","v":"7.917","t":"+7.6%","d":"up"},{"l":"Templates","v":"623","t":"-1.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.244","2026-01-28","7.142","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.321","2026-03-21","7.994","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.430","2026-02-02","1.338","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.580","2026-02-05","2.308","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.313","2026-01-05","6.776","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":988},{"label":"Fev","value":731},{"label":"Mar","value":948},{"label":"Abr","value":1017},{"label":"Mai","value":892},{"label":"Jun","value":949},{"label":"Jul","value":785},{"label":"Ago","value":921},{"label":"Set","value":992},{"label":"Out","value":724},{"label":"Nov","value":949},{"label":"Dez","value":900}];
const MX = 1017;
