...
const PAGE = "Harvest";
const KPIS = [{"l":"Total Cannabis Cultivate","v":"3.094","t":"+15.9%","d":"up"},{"l":"Harvest Ativos","v":"5.403","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"73.0%","t":"+12.0%","d":"up"},{"l":"Score Performance","v":"58","t":"-0.8%","d":"down"}];
const COLS = ["ID","Harvest","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Cultivate #001","Cannabis Cultivate #002","5.158","5.374","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Cultivate #002","Cannabis Cultivate #003","6.551","6.461","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Cultivate #003","Cannabis Cultivate #004","2.744","8.413","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Cultivate #004","Cannabis Cultivate #005","5.450","7.133","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Cultivate #005","Cannabis Cultivate #001","7.736","3.276","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":685},{"label":"Mar","value":757},{"label":"Abr","value":867},{"label":"Mai","value":703},{"label":"Jun","value":843},{"label":"Jul","value":847},{"label":"Ago","value":675},{"label":"Set","value":523},{"label":"Out","value":486},{"label":"Nov","value":721},{"label":"Dez","value":596}];
const MX = 867;
