...
const PAGE = "Strain";
const KPIS = [{"l":"Total Cannabis Cultivate","v":"6.807","t":"-0.2%","d":"down"},{"l":"Strain Ativos","v":"3.524","t":"+6.0%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"75","t":"+16.3%","d":"up"}];
const COLS = ["ID","Strain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Cultivate #001","Cannabis Cultivate #002","1.012","8.562","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Cultivate #002","Cannabis Cultivate #003","5.082","6.214","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Cultivate #003","Cannabis Cultivate #004","4.918","1.921","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Cultivate #004","Cannabis Cultivate #005","108","4.701","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Cultivate #005","Cannabis Cultivate #001","388","7.190","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":376},{"label":"Fev","value":624},{"label":"Mar","value":437},{"label":"Abr","value":595},{"label":"Mai","value":358},{"label":"Jun","value":520},{"label":"Jul","value":445},{"label":"Ago","value":293},{"label":"Set","value":418},{"label":"Out","value":265},{"label":"Nov","value":265},{"label":"Dez","value":289}];
const MX = 624;
