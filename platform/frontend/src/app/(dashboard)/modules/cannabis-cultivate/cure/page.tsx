...
const PAGE = "Cure";
const KPIS = [{"l":"Total Cannabis Cultivate","v":"1.337","t":"-1.6%","d":"down"},{"l":"Cure Ativos","v":"8.974","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"86.8%","t":"+13.9%","d":"up"},{"l":"Score Performance","v":"83","t":"+0.6%","d":"up"}];
const COLS = ["ID","Cure","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Cultivate #001","Cannabis Cultivate #002","2.724","1.956","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Cultivate #002","Cannabis Cultivate #003","4.486","5.774","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Cultivate #003","Cannabis Cultivate #004","2.973","8.665","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Cultivate #004","Cannabis Cultivate #005","8.870","936","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Cultivate #005","Cannabis Cultivate #001","1.486","498","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":341},{"label":"Fev","value":371},{"label":"Mar","value":427},{"label":"Abr","value":312},{"label":"Mai","value":508},{"label":"Jun","value":478},{"label":"Jul","value":638},{"label":"Ago","value":329},{"label":"Set","value":631},{"label":"Out","value":635},{"label":"Nov","value":427},{"label":"Dez","value":467}];
const MX = 638;
