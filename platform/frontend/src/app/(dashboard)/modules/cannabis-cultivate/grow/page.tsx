...
const ACCENT = "#166534";
const MODULE = "Cannabis Cultivation";
const PAGE = "Grow Room";
const KPIS = [{"l":"Total Cannabis Cultivate","v":"3.156","t":"+13.3%","d":"up"},{"l":"Grow Room Ativos","v":"5.356","t":"+3.3%","d":"up"},{"l":"Eficiência (%)","v":"65.2%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"64","t":"-3.2%","d":"down"}];
const COLS = ["ID","Grow Room","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Cultivate #001","Cannabis Cultivate #002","7.656","8.077","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Cultivate #002","Cannabis Cultivate #003","5.543","3.294","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Cultivate #003","Cannabis Cultivate #004","4.385","2.120","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Cultivate #004","Cannabis Cultivate #005","3.177","5.956","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Cultivate #005","Cannabis Cultivate #001","8.741","5.196","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":760},{"label":"Mar","value":549},{"label":"Abr","value":735},{"label":"Mai","value":381},{"label":"Jun","value":517},{"label":"Jul","value":687},{"label":"Ago","value":680},{"label":"Set","value":397},{"label":"Out","value":456},{"label":"Nov","value":466},{"label":"Dez","value":700}];
const MX = 760;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#166534'}}>IoT</span></h1>
                </div>
