...
/* ═══ Cannabis Cultivation — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "1550", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2667", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€404K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "974587150", cells: ["CAN-5150", "Cannabis Cultivation Item 1", "27/11/2026", "€37 250"], status: "active" as const },
    { id: "974590721", cells: ["CAN-8721", "Cannabis Cultivation Item 2", "14/6/2026", "€40 821"], status: "pending" as const },
    { id: "974594292", cells: ["CAN-3292", "Cannabis Cultivation Item 3", "1/1/2026", "€44 392"], status: "completed" as const },
    { id: "974597863", cells: ["CAN-6863", "Cannabis Cultivation Item 4", "16/8/2026", "€47 963"], status: "warning" as const },
    { id: "974601434", cells: ["CAN-1434", "Cannabis Cultivation Item 5", "3/3/2026", "€1534"], status: "active" as const },
];
...
export default function CannabisCultivationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cannabis Cultivation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cannabis Cultivation</p>
                    </div>
                </div>
