...
const PAGE = "Create";
const KPIS = [{"l":"Tickets Abertos","v":"5.950","t":"+14.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"71.4%","t":"+11.5%","d":"up"},{"l":"MTTR (h)","v":"202h","t":"+6.2%","d":"up"},{"l":"Satisfação (%)","v":"79.9%","t":"-0.9%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.314","6.013","1.610","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.615","2.116","8.864","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.935","3.412","752","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.440","2.449","3.771","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.485","4.340","6.161","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1028},{"label":"Fev","value":986},{"label":"Mar","value":953},{"label":"Abr","value":843},{"label":"Mai","value":757},{"label":"Jun","value":944},{"label":"Jul","value":686},{"label":"Ago","value":895},{"label":"Set","value":947},{"label":"Out","value":1059},{"label":"Nov","value":728},{"label":"Dez","value":789}];
const MX = 1059;
