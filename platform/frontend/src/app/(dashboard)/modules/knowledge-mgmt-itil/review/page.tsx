...
const PAGE = "Review";
const KPIS = [{"l":"Tickets Abertos","v":"5.000","t":"+13.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"76.7%","t":"+4.9%","d":"up"},{"l":"MTTR (h)","v":"40h","t":"+2.4%","d":"up"},{"l":"Satisfação (%)","v":"86.8%","t":"+11.2%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.295","1.421","2.599","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.511","3.476","4.055","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.200","2.100","8.901","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.957","2.092","7.954","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.647","8.331","2.359","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":676},{"label":"Mar","value":753},{"label":"Abr","value":677},{"label":"Mai","value":577},{"label":"Jun","value":679},{"label":"Jul","value":643},{"label":"Ago","value":435},{"label":"Set","value":528},{"label":"Out","value":468},{"label":"Nov","value":672},{"label":"Dez","value":438}];
const MX = 753;
