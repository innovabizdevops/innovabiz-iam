...
const PAGE = "Publish";
const KPIS = [{"l":"Tickets Abertos","v":"8.936","t":"-5.3%","d":"down"},{"l":"SLA Cumprido (%)","v":"74.2%","t":"+13.5%","d":"up"},{"l":"MTTR (h)","v":"131h","t":"+0.5%","d":"up"},{"l":"Satisfação (%)","v":"71.9%","t":"+2.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","220","4.367","8.530","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.859","9.011","3.672","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.206","2.872","5.296","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.187","6.143","2.671","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.500","8.516","7.095","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":660},{"label":"Mar","value":564},{"label":"Abr","value":716},{"label":"Mai","value":493},{"label":"Jun","value":567},{"label":"Jul","value":701},{"label":"Ago","value":366},{"label":"Set","value":409},{"label":"Out","value":453},{"label":"Nov","value":464},{"label":"Dez","value":540}];
const MX = 716;
