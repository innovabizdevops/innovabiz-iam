...
const ACCENT = "#94a3b8";
const MODULE = "Knowledge Management (ITIL)";
const PAGE = "Search";
const KPIS = [{"l":"Tickets Abertos","v":"8.233","t":"+8.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"81.3%","t":"+2.0%","d":"up"},{"l":"MTTR (h)","v":"107h","t":"+16.9%","d":"up"},{"l":"Satisfação (%)","v":"69.9%","t":"+17.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","718","7.021","8.999","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.629","6.410","8.599","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.431","7.209","6.537","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.046","337","2.749","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.347","4.449","1.241","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":549},{"label":"Fev","value":423},{"label":"Mar","value":506},{"label":"Abr","value":579},{"label":"Mai","value":571},{"label":"Jun","value":323},{"label":"Jul","value":523},{"label":"Ago","value":323},{"label":"Set","value":469},{"label":"Out","value":398},{"label":"Nov","value":471},{"label":"Dez","value":493}];
const MX = 579;
