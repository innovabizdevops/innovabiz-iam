...
/* ═══ Knowledge Management (ITIL) — Dashboard ═══ */

const ACCENT = "#94a3b8";

const KPIS = [
    { label: "Total Registos", value: "6622", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1893", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€316K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "-5%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1277759922", cells: ["KNO-3922", "Knowledge Management (ITIL) Item 1", "27/7/2026", "€10 022"], status: "active" as const },
    { id: "1277763493", cells: ["KNO-7493", "Knowledge Management (ITIL) Item 2", "14/2/2026", "€13 593"], status: "pending" as const },
    { id: "1277767064", cells: ["KNO-2064", "Knowledge Management (ITIL) Item 3", "1/9/2026", "€17 164"], status: "completed" as const },
    { id: "1277770635", cells: ["KNO-5635", "Knowledge Management (ITIL) Item 4", "16/4/2026", "€20 735"], status: "warning" as const },
    { id: "1277774206", cells: ["KNO-9206", "Knowledge Management (ITIL) Item 5", "3/11/2026", "€24 306"], status: "active" as const },
];
...
export default function KnowledgeManagementItilPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Knowledge Management (ITIL)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Knowledge Management (ITIL)</p>
                    </div>
                </div>
