...
const PAGE = "ID Track";
const KPIS = [{"l":"Total Crematory Ops","v":"8.211","t":"-5.4%","d":"down"},{"l":"ID Track Ativos","v":"5.418","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"73.1%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"67","t":"+12.3%","d":"up"}];
const COLS = ["ID","ID Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crematory Ops #001","Crematory Ops #002","8.226","5.072","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Crematory Ops #002","Crematory Ops #003","5.732","5.414","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Crematory Ops #003","Crematory Ops #004","925","175","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Crematory Ops #004","Crematory Ops #005","7.499","8.777","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crematory Ops #005","Crematory Ops #001","7.453","5.399","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":343},{"label":"Mar","value":452},{"label":"Abr","value":381},{"label":"Mai","value":501},{"label":"Jun","value":400},{"label":"Jul","value":688},{"label":"Ago","value":464},{"label":"Set","value":494},{"label":"Out","value":648},{"label":"Nov","value":501},{"label":"Dez","value":366}];
const MX = 688;
