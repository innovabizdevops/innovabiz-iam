...
/* ═══ Crematory Operations — Dashboard ═══ */

const ACCENT = "#334155";

const KPIS = [
    { label: "Total Registos", value: "4088", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3783", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€95K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1625415688", cells: ["CRE-7688", "Crematory Operations Item 1", "9/5/2026", "€15 788"], status: "active" as const },
    { id: "1625419259", cells: ["CRE-2259", "Crematory Operations Item 2", "24/12/2026", "€19 359"], status: "pending" as const },
    { id: "1625422830", cells: ["CRE-5830", "Crematory Operations Item 3", "11/7/2026", "€22 930"], status: "completed" as const },
    { id: "1625426401", cells: ["CRE-9401", "Crematory Operations Item 4", "26/2/2026", "€26 501"], status: "warning" as const },
    { id: "1625429972", cells: ["CRE-3972", "Crematory Operations Item 5", "13/9/2026", "€30 072"], status: "active" as const },
];
...
export default function CrematoryOperationsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Crematory Operations</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Crematory Operations</p>
                    </div>
                </div>
