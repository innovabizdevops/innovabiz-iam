...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Crematory Ops","v":"5.852","t":"+16.2%","d":"up"},{"l":"Schedule Ativos","v":"7.164","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"81.0%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"82","t":"+17.9%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crematory Ops #001","Crematory Ops #002","6.672","3.049","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Crematory Ops #002","Crematory Ops #003","187","900","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Crematory Ops #003","Crematory Ops #004","4.160","3.926","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Crematory Ops #004","Crematory Ops #005","7.795","2.772","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crematory Ops #005","Crematory Ops #001","5.504","7.354","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":912},{"label":"Fev","value":845},{"label":"Mar","value":793},{"label":"Abr","value":748},{"label":"Mai","value":790},{"label":"Jun","value":884},{"label":"Jul","value":629},{"label":"Ago","value":767},{"label":"Set","value":621},{"label":"Out","value":595},{"label":"Nov","value":953},{"label":"Dez","value":690}];
const MX = 953;
