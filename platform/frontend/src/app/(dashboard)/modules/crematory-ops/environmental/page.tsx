...
const ACCENT = "#334155";
const MODULE = "Crematory Operations";
const PAGE = "Environmental";
const KPIS = [{"l":"Total Crematory Ops","v":"6.346","t":"+6.6%","d":"up"},{"l":"Environmental Ativos","v":"808","t":"+11.7%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"+10.4%","d":"up"},{"l":"Score Performance","v":"90","t":"+7.1%","d":"up"}];
const COLS = ["ID","Environmental","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crematory Ops #001","Crematory Ops #002","128","1.281","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Crematory Ops #002","Crematory Ops #003","2.955","3.765","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Crematory Ops #003","Crematory Ops #004","5.916","4.795","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Crematory Ops #004","Crematory Ops #005","1.112","3.018","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crematory Ops #005","Crematory Ops #001","6.816","5.375","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":682},{"label":"Mar","value":588},{"label":"Abr","value":521},{"label":"Mai","value":595},{"label":"Jun","value":527},{"label":"Jul","value":532},{"label":"Ago","value":692},{"label":"Set","value":565},{"label":"Out","value":497},{"label":"Nov","value":443},{"label":"Dez","value":500}];
const MX = 763;
