...
/* ═══ Cosmetic Training Academy — Dashboard ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total Registos", value: "8755", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4541", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€225K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "-13%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1470950655", cells: ["COS-9655", "Cosmetic Training Academy Item 1", "28/4/2026", "€755"], status: "active" as const },
    { id: "1470954226", cells: ["COS-4226", "Cosmetic Training Academy Item 2", "15/11/2026", "€4326"], status: "pending" as const },
    { id: "1470957797", cells: ["COS-7797", "Cosmetic Training Academy Item 3", "2/6/2026", "€7897"], status: "completed" as const },
    { id: "1470961368", cells: ["COS-2368", "Cosmetic Training Academy Item 4", "17/1/2026", "€11 468"], status: "warning" as const },
    { id: "1470964939", cells: ["COS-5939", "Cosmetic Training Academy Item 5", "4/8/2026", "€15 039"], status: "active" as const },
];
...
export default function CosmeticTrainingAcademyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cosmetic Training Academy</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cosmetic Training Academy</p>
                    </div>
                </div>
