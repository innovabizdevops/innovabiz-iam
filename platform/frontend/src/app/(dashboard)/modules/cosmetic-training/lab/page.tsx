...
const ACCENT = "#db2777";
const MODULE = "Cosmetic Training Academy";
const PAGE = "Cadaver Lab";
const KPIS = [{"l":"Total Cosmetic Training","v":"1.208","t":"+7.4%","d":"up"},{"l":"Cadaver Lab Ativos","v":"5.478","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"83.0%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"69","t":"-5.8%","d":"down"}];
const COLS = ["ID","Cadaver Lab","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmetic Training #001","Cosmetic Training #002","8.576","6.072","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmetic Training #002","Cosmetic Training #003","5.335","8.047","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmetic Training #003","Cosmetic Training #004","7.471","6.384","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmetic Training #004","Cosmetic Training #005","8.258","6.660","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmetic Training #005","Cosmetic Training #001","1.004","5.531","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":788},{"label":"Mar","value":792},{"label":"Abr","value":772},{"label":"Mai","value":817},{"label":"Jun","value":575},{"label":"Jul","value":517},{"label":"Ago","value":681},{"label":"Set","value":550},{"label":"Out","value":482},{"label":"Nov","value":512},{"label":"Dez","value":471}];
const MX = 817;
