...
const ACCENT = "#db2777";
const MODULE = "Cosmetic Lab";
const PAGE = "Formulate";
const KPIS = [{"l":"Formulários Ativos","v":"6.324","t":"+13.7%","d":"up"},{"l":"Submissões/Dia","v":"2456","t":"+0.5%","d":"up"},{"l":"Documentos Gerados","v":"7.552","t":"+2.8%","d":"up"},{"l":"Templates","v":"2.621","t":"+8.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.964","2026-03-01","5.935","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.962","2026-02-05","5.165","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.836","2026-02-09","2.745","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.604","2026-01-25","432","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","323","2026-01-22","3.696","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":380},{"label":"Fev","value":409},{"label":"Mar","value":311},{"label":"Abr","value":562},{"label":"Mai","value":302},{"label":"Jun","value":336},{"label":"Jul","value":390},{"label":"Ago","value":333},{"label":"Set","value":363},{"label":"Out","value":529},{"label":"Nov","value":362},{"label":"Dez","value":608}];
const MX = 608;
