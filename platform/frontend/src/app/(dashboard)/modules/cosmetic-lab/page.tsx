...
/* ═══ Cosmetic Lab — Dashboard ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total Registos", value: "9106", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1307", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€95K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "511532106", cells: ["COS-9106", "Cosmetic Lab Item 1", "23/7/2026", "€32 206"], status: "active" as const },
    { id: "511535677", cells: ["COS-3677", "Cosmetic Lab Item 2", "10/2/2026", "€35 777"], status: "pending" as const },
    { id: "511539248", cells: ["COS-7248", "Cosmetic Lab Item 3", "25/9/2026", "€39 348"], status: "completed" as const },
    { id: "511542819", cells: ["COS-1819", "Cosmetic Lab Item 4", "12/4/2026", "€42 919"], status: "warning" as const },
    { id: "511546390", cells: ["COS-5390", "Cosmetic Lab Item 5", "27/11/2026", "€46 490"], status: "active" as const },
];
...
export default function CosmeticLabPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cosmetic Lab</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cosmetic Lab</p>
                    </div>
                </div>
