...
/* ═══ Telecom Core — Interconnect ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "3592", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "58", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3244", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "68113766", cells: ["TEL-2766", "Interconnect Item 1", "15/3/2026", "€13 866"], status: "active" as const },
    { id: "68117337", cells: ["TEL-6337", "Interconnect Item 2", "2/10/2026", "€17 437"], status: "pending" as const },
    { id: "68120908", cells: ["TEL-9908", "Interconnect Item 3", "17/5/2026", "€21 008"], status: "completed" as const },
    { id: "68124479", cells: ["TEL-4479", "Interconnect Item 4", "4/12/2026", "€24 579"], status: "warning" as const },
    { id: "68128050", cells: ["TEL-8050", "Interconnect Item 5", "19/7/2026", "€28 150"], status: "active" as const },
];
...
export default function TelecomCoreInterconnectPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Interconnect</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Core • Interconnect</p>
                    </div>
                </div>
