...
/* ═══ Telecom Core — Subscriber Mgmt ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2048", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "373", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2798", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1067136449", cells: ["TEL-7449", "Subscriber Mgmt Item 1", "2/6/2026", "€36 549"], status: "active" as const },
    { id: "1067140020", cells: ["TEL-2020", "Subscriber Mgmt Item 2", "17/1/2026", "€40 120"], status: "pending" as const },
    { id: "1067143591", cells: ["TEL-5591", "Subscriber Mgmt Item 3", "4/8/2026", "€43 691"], status: "completed" as const },
    { id: "1067147162", cells: ["TEL-9162", "Subscriber Mgmt Item 4", "19/3/2026", "€47 262"], status: "warning" as const },
    { id: "1067150733", cells: ["TEL-3733", "Subscriber Mgmt Item 5", "6/10/2026", "€833"], status: "active" as const },
];
...
export default function TelecomCoreSubscriberMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Subscriber Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Core • Subscriber Mgmt</p>
                    </div>
                </div>
