...
/* ═══ Telecom Core — Partner Settle ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "4058", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "479", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2088", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "986804891", cells: ["TEL-9891", "Partner Settle Item 1", "24/12/2026", "€4991"], status: "active" as const },
    { id: "986808462", cells: ["TEL-4462", "Partner Settle Item 2", "11/7/2026", "€8562"], status: "pending" as const },
    { id: "986812033", cells: ["TEL-8033", "Partner Settle Item 3", "26/2/2026", "€12 133"], status: "completed" as const },
    { id: "986815604", cells: ["TEL-2604", "Partner Settle Item 4", "13/9/2026", "€15 704"], status: "warning" as const },
    { id: "986819175", cells: ["TEL-6175", "Partner Settle Item 5", "28/4/2026", "€19 275"], status: "active" as const },
];
...
export default function TelecomCorePartnerSettlePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Partner Settle</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Core • Partner Settle</p>
                    </div>
                </div>
