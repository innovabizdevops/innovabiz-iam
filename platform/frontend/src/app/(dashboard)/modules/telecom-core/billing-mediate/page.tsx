...
/* ═══ Telecom Core — Billing Mediate ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "669", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "284", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1086", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2138259272", cells: ["TEL-4272", "Billing Mediate Item 1", "17/9/2026", "€9372"], status: "active" as const },
    { id: "2138262843", cells: ["TEL-7843", "Billing Mediate Item 2", "4/4/2026", "€12 943"], status: "pending" as const },
    { id: "2138266414", cells: ["TEL-2414", "Billing Mediate Item 3", "19/11/2026", "€16 514"], status: "completed" as const },
    { id: "2138269985", cells: ["TEL-5985", "Billing Mediate Item 4", "6/6/2026", "€20 085"], status: "warning" as const },
    { id: "2138273556", cells: ["TEL-9556", "Billing Mediate Item 5", "21/1/2026", "€23 656"], status: "active" as const },
];
...
export default function TelecomCoreBillingMediatePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Billing Mediate</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Core • Billing Mediate</p>
                    </div>
                </div>
