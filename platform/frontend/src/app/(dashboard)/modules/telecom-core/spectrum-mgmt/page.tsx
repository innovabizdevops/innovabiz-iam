...
/* ═══ Telecom Core — Spectrum Mgmt ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "3788", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "364", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3285", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1300722184", cells: ["TEL-7184", "Spectrum Mgmt Item 1", "21/5/2026", "€22 284"], status: "active" as const },
    { id: "1300725755", cells: ["TEL-1755", "Spectrum Mgmt Item 2", "8/12/2026", "€25 855"], status: "pending" as const },
    { id: "1300729326", cells: ["TEL-5326", "Spectrum Mgmt Item 3", "23/7/2026", "€29 426"], status: "completed" as const },
    { id: "1300732897", cells: ["TEL-8897", "Spectrum Mgmt Item 4", "10/2/2026", "€32 997"], status: "warning" as const },
    { id: "1300736468", cells: ["TEL-3468", "Spectrum Mgmt Item 5", "25/9/2026", "€36 568"], status: "active" as const },
];
...
export default function TelecomCoreSpectrumMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Spectrum Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Core • Spectrum Mgmt</p>
                    </div>
                </div>
