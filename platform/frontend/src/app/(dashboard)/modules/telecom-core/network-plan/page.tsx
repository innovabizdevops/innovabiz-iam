...
/* ═══ Telecom Core — Network Plan ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "3322", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "71", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "576", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "838529747", cells: ["TEL-9747", "Network Plan Item 1", "28/12/2026", "€29 847"], status: "active" as const },
    { id: "838533318", cells: ["TEL-4318", "Network Plan Item 2", "15/7/2026", "€33 418"], status: "pending" as const },
    { id: "838536889", cells: ["TEL-7889", "Network Plan Item 3", "2/2/2026", "€36 989"], status: "completed" as const },
    { id: "838540460", cells: ["TEL-2460", "Network Plan Item 4", "17/9/2026", "€40 560"], status: "warning" as const },
    { id: "838544031", cells: ["TEL-6031", "Network Plan Item 5", "4/4/2026", "€44 131"], status: "active" as const },
];
...
export default function TelecomCoreNetworkPlanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Network Plan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Core • Network Plan</p>
                    </div>
                </div>
