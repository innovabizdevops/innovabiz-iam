...
/* ═══ Telecom Core — Roaming Mgmt ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "3230", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "308", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2166", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "337904288", cells: ["TEL-9288", "Roaming Mgmt Item 1", "9/9/2026", "€4388"], status: "active" as const },
    { id: "337907859", cells: ["TEL-3859", "Roaming Mgmt Item 2", "24/4/2026", "€7959"], status: "pending" as const },
    { id: "337911430", cells: ["TEL-7430", "Roaming Mgmt Item 3", "11/11/2026", "€11 530"], status: "completed" as const },
    { id: "337915001", cells: ["TEL-2001", "Roaming Mgmt Item 4", "26/6/2026", "€15 101"], status: "warning" as const },
    { id: "337918572", cells: ["TEL-5572", "Roaming Mgmt Item 5", "13/1/2026", "€18 672"], status: "active" as const },
];
...
export default function TelecomCoreRoamingMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Roaming Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Core • Roaming Mgmt</p>
                    </div>
                </div>
