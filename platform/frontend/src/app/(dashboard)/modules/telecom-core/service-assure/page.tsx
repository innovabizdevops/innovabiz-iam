...
/* ═══ Telecom Core — Service Assure ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "349", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "334", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1257", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1910936074", cells: ["TEL-3074", "Service Assure Item 1", "27/11/2026", "€36 174"], status: "active" as const },
    { id: "1910939645", cells: ["TEL-6645", "Service Assure Item 2", "14/6/2026", "€39 745"], status: "pending" as const },
    { id: "1910943216", cells: ["TEL-1216", "Service Assure Item 3", "1/1/2026", "€43 316"], status: "completed" as const },
    { id: "1910946787", cells: ["TEL-4787", "Service Assure Item 4", "16/8/2026", "€46 887"], status: "warning" as const },
    { id: "1910950358", cells: ["TEL-8358", "Service Assure Item 5", "3/3/2026", "€458"], status: "active" as const },
];
...
export default function TelecomCoreServiceAssurePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Service Assure</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Core • Service Assure</p>
                    </div>
                </div>
