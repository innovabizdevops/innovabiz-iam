...
/* ═══ Telecom Core — Capacity Forecast ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2878", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "299", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1743", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "132103959", cells: ["TEL-2959", "Capacity Forecast Item 1", "16/4/2026", "€4059"], status: "active" as const },
    { id: "132107530", cells: ["TEL-6530", "Capacity Forecast Item 2", "3/11/2026", "€7630"], status: "pending" as const },
    { id: "132111101", cells: ["TEL-1101", "Capacity Forecast Item 3", "18/6/2026", "€11 201"], status: "completed" as const },
    { id: "132114672", cells: ["TEL-4672", "Capacity Forecast Item 4", "5/1/2026", "€14 772"], status: "warning" as const },
    { id: "132118243", cells: ["TEL-8243", "Capacity Forecast Item 5", "20/8/2026", "€18 343"], status: "active" as const },
];
...
export default function TelecomCoreCapacityForecastPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Capacity Forecast</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Core • Capacity Forecast</p>
                    </div>
                </div>
