...
/* ═══ Telecom Core — Number Port ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "3784", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "324", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3071", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1785652416", cells: ["TEL-8416", "Number Port Item 1", "17/1/2026", "€2516"], status: "active" as const },
    { id: "1785655987", cells: ["TEL-2987", "Number Port Item 2", "4/8/2026", "€6087"], status: "pending" as const },
    { id: "1785659558", cells: ["TEL-6558", "Number Port Item 3", "19/3/2026", "€9658"], status: "completed" as const },
    { id: "1785663129", cells: ["TEL-1129", "Number Port Item 4", "6/10/2026", "€13 229"], status: "warning" as const },
    { id: "1785666700", cells: ["TEL-4700", "Number Port Item 5", "21/5/2026", "€16 800"], status: "active" as const },
];
...
export default function TelecomCoreNumberPortPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Number Port</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Telecom Core • Number Port</p>
                    </div>
                </div>
