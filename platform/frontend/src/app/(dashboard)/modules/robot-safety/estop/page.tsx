...
const PAGE = "E-Stop";
const KPIS = [{"l":"Total Robot Safety","v":"2.420","t":"+6.1%","d":"up"},{"l":"E Stop Ativos","v":"3.039","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"75.8%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"71","t":"+14.7%","d":"up"}];
const COLS = ["ID","E Stop","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Robot Safety #001","Robot Safety #002","7.312","2.012","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Robot Safety #002","Robot Safety #003","390","4.191","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Robot Safety #003","Robot Safety #004","6.173","617","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Robot Safety #004","Robot Safety #005","6.179","6.062","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Robot Safety #005","Robot Safety #001","278","7.764","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":348},{"label":"Mar","value":485},{"label":"Abr","value":269},{"label":"Mai","value":269},{"label":"Jun","value":327},{"label":"Jul","value":306},{"label":"Ago","value":432},{"label":"Set","value":470},{"label":"Out","value":494},{"label":"Nov","value":458},{"label":"Dez","value":514}];
const MX = 625;
...
export default function EstopPage() {
    return (
