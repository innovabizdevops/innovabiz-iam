...
const KPIS = [{"l":"Riscos Identificados","v":"9.065","t":"+10.0%","d":"up"},{"l":"Mitigações Ativas","v":"6.532","t":"+6.1%","d":"up"},{"l":"Score Risco Geral","v":"78","t":"-1.0%","d":"down"},{"l":"Incidentes YTD","v":"1.496","t":"+4.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.262","3.837","7.206","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.186","3.493","574","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.200","3.784","1.051","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.201","1.357","2.112","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.667","3.395","8.353","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":761},{"label":"Mar","value":693},{"label":"Abr","value":547},{"label":"Mai","value":886},{"label":"Jun","value":653},{"label":"Jul","value":880},{"label":"Ago","value":699},{"label":"Set","value":888},{"label":"Out","value":575},{"label":"Nov","value":781},{"label":"Dez","value":923}];
const MX = 923;
