...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"3.462","t":"+9.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"94.4%","t":"+11.7%","d":"up"},{"l":"MTTR (h)","v":"85h","t":"+16.6%","d":"up"},{"l":"Satisfação (%)","v":"69.7%","t":"+3.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.293","554","6.569","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","782","1.405","191","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.542","4.442","3.186","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.695","690","5.445","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.544","7.706","2.569","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":448},{"label":"Fev","value":599},{"label":"Mar","value":377},{"label":"Abr","value":681},{"label":"Mai","value":578},{"label":"Jun","value":563},{"label":"Jul","value":497},{"label":"Ago","value":443},{"label":"Set","value":660},{"label":"Out","value":674},{"label":"Nov","value":650},{"label":"Dez","value":458}];
const MX = 681;
