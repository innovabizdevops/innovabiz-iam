...
const ACCENT = "#6366f1";
const MODULE = "Robot Safety";
const PAGE = "Zone Monitor";
const KPIS = [{"l":"Total Robot Safety","v":"3.207","t":"-2.3%","d":"down"},{"l":"Zone Monitor Ativos","v":"2.041","t":"+17.8%","d":"up"},{"l":"Eficiência (%)","v":"70.1%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"86","t":"+1.5%","d":"up"}];
const COLS = ["ID","Zone Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Robot Safety #001","Robot Safety #002","2.611","642","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Robot Safety #002","Robot Safety #003","1.600","3.962","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Robot Safety #003","Robot Safety #004","7.291","2.622","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Robot Safety #004","Robot Safety #005","606","620","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Robot Safety #005","Robot Safety #001","697","6.972","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":874},{"label":"Mar","value":956},{"label":"Abr","value":851},{"label":"Mai","value":934},{"label":"Jun","value":992},{"label":"Jul","value":895},{"label":"Ago","value":752},{"label":"Set","value":935},{"label":"Out","value":819},{"label":"Nov","value":764},{"label":"Dez","value":850}];
const MX = 992;
