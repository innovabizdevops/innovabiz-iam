...
/* ═══ MD: Multi-Warehouse Engine — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "5031", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2934", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€450K", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "900340631", cells: ["MD-8631", "MD: Multi-Warehouse Engine Item 1", "16/12/2026", "€40 731"], status: "active" as const },
    { id: "900344202", cells: ["MD-3202", "MD: Multi-Warehouse Engine Item 2", "3/7/2026", "€44 302"], status: "pending" as const },
    { id: "900347773", cells: ["MD-6773", "MD: Multi-Warehouse Engine Item 3", "18/2/2026", "€47 873"], status: "completed" as const },
    { id: "900351344", cells: ["MD-1344", "MD: Multi-Warehouse Engine Item 4", "5/9/2026", "€1444"], status: "warning" as const },
    { id: "900354915", cells: ["MD-4915", "MD: Multi-Warehouse Engine Item 5", "20/4/2026", "€5015"], status: "active" as const },
];
...
export default function MdMultiwarehouseEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Warehouse Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Warehouse Engine</p>
                    </div>
                </div>
