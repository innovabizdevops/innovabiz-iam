...
const ACCENT = "#7c2d12";
const MODULE = "MD: Multi-Warehouse Engine";
const PAGE = "Optimize";
const KPIS = [{"l":"Total Md Warehouse Engine","v":"4.498","t":"+13.7%","d":"up"},{"l":"Optimize Ativos","v":"2.686","t":"+15.3%","d":"up"},{"l":"Eficiência (%)","v":"82.1%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"60","t":"-0.9%","d":"down"}];
const COLS = ["ID","Optimize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Md Warehouse Engine #001","Md Warehouse Engine #002","7.612","4.486","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Md Warehouse Engine #002","Md Warehouse Engine #003","8.241","8.420","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Md Warehouse Engine #003","Md Warehouse Engine #004","6.728","1.703","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Md Warehouse Engine #004","Md Warehouse Engine #005","4.937","1.905","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Md Warehouse Engine #005","Md Warehouse Engine #001","5.581","8.678","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":368},{"label":"Fev","value":415},{"label":"Mar","value":336},{"label":"Abr","value":584},{"label":"Mai","value":328},{"label":"Jun","value":475},{"label":"Jul","value":406},{"label":"Ago","value":625},{"label":"Set","value":336},{"label":"Out","value":332},{"label":"Nov","value":645},{"label":"Dez","value":435}];
const MX = 645;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c2d12'}}>AI</span></h1>
                </div>
