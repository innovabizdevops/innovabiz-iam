...
const KPIS = [{"l":"Auditorias Realizadas","v":"3.871","t":"-3.5%","d":"down"},{"l":"NC Abertas","v":"5.906","t":"-5.3%","d":"down"},{"l":"Conformidade (%)","v":"80.7%","t":"+6.3%","d":"up"},{"l":"CAPAs Pendentes","v":"2.765","t":"+3.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.391","83.1%","3.958","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.662","88.0%","2.778","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.006","90.2%","1.825","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.249","90.3%","4.548","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.627","96.5%","5.578","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":774},{"label":"Fev","value":840},{"label":"Mar","value":858},{"label":"Abr","value":912},{"label":"Mai","value":712},{"label":"Jun","value":679},{"label":"Jul","value":658},{"label":"Ago","value":713},{"label":"Set","value":987},{"label":"Out","value":660},{"label":"Nov","value":913},{"label":"Dez","value":970}];
const MX = 987;
