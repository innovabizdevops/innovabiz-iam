...
const PAGE = "Custody";
const KPIS = [{"l":"Total Crypto Exchange","v":"8.846","t":"+9.7%","d":"up"},{"l":"Custody Ativos","v":"€98376","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"82.2%","t":"+1.7%","d":"up"},{"l":"Score Performance","v":"68","t":"-0.7%","d":"down"}];
const COLS = ["ID","Custody","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crypto Exchange #001","€ 49673.67","1.391","3.000","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Crypto Exchange #002","€ 23987.06","3.695","341","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Crypto Exchange #003","€ 40290.07","3.771","4.564","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Crypto Exchange #004","€ 18609.10","437","5.582","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crypto Exchange #005","€ 19521.84","1.847","6.979","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":448},{"label":"Fev","value":710},{"label":"Mar","value":611},{"label":"Abr","value":684},{"label":"Mai","value":490},{"label":"Jun","value":462},{"label":"Jul","value":536},{"label":"Ago","value":520},{"label":"Set","value":699},{"label":"Out","value":597},{"label":"Nov","value":410},{"label":"Dez","value":439}];
const MX = 710;
