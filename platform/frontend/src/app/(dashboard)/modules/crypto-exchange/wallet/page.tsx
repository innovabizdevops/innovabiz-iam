...
const ACCENT = "#6366f1";
const MODULE = "Crypto Exchange";
const PAGE = "Wallet Mgmt";
const KPIS = [{"l":"Total Crypto Exchange","v":"1.379","t":"-5.3%","d":"down"},{"l":"Wallet Mgmt Ativos","v":"1.294","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"69.8%","t":"+15.9%","d":"up"},{"l":"Score Performance","v":"89","t":"+4.4%","d":"up"}];
const COLS = ["ID","Wallet Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crypto Exchange #001","Crypto Exchange #002","2.635","3.673","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Crypto Exchange #002","Crypto Exchange #003","8.100","6.256","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Crypto Exchange #003","Crypto Exchange #004","1.534","4.635","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Crypto Exchange #004","Crypto Exchange #005","5.935","8.024","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crypto Exchange #005","Crypto Exchange #001","3.659","1.428","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":860},{"label":"Fev","value":992},{"label":"Mar","value":703},{"label":"Abr","value":1010},{"label":"Mai","value":749},{"label":"Jun","value":1001},{"label":"Jul","value":742},{"label":"Ago","value":1087},{"label":"Set","value":1036},{"label":"Out","value":700},{"label":"Nov","value":1047},{"label":"Dez","value":892}];
const MX = 1087;
