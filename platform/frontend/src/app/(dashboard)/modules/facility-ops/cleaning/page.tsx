...
const PAGE = "Cleaning";
const KPIS = [{"l":"Projetos Melhoria","v":"4.548","t":"+0.3%","d":"up"},{"l":"Savings (€)","v":"€95838","t":"+5.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"90.9%","t":"+15.5%","d":"up"},{"l":"Ciclos PDCA","v":"1.801","t":"+1.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.312","€ 41090.74","7.021","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","210","€ 8911.01","6.812","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.981","€ 18058.21","2.261","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.862","€ 17283.99","2.338","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.175","€ 3538.11","2.391","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":984},{"label":"Fev","value":1000},{"label":"Mar","value":919},{"label":"Abr","value":875},{"label":"Mai","value":787},{"label":"Jun","value":902},{"label":"Jul","value":1041},{"label":"Ago","value":1035},{"label":"Set","value":925},{"label":"Out","value":776},{"label":"Nov","value":1053},{"label":"Dez","value":1081}];
const MX = 1081;
