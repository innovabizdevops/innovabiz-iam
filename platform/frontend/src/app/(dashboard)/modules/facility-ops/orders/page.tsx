...
const PAGE = "Work Orders";
const KPIS = [{"l":"Total Facility Ops","v":"4.612","t":"-3.8%","d":"down"},{"l":"Work Orders Ativos","v":"5.303","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"71.6%","t":"+-0.0%","d":"up"},{"l":"Score Performance","v":"62","t":"+17.7%","d":"up"}];
const COLS = ["ID","Work Orders","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Facility Ops #001","Facility Ops #002","8.909","7.674","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Facility Ops #002","Facility Ops #003","6.963","6.618","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Facility Ops #003","Facility Ops #004","8.594","8.087","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Facility Ops #004","Facility Ops #005","728","7.629","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Facility Ops #005","Facility Ops #001","1.954","6.437","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":712},{"label":"Fev","value":621},{"label":"Mar","value":780},{"label":"Abr","value":736},{"label":"Mai","value":815},{"label":"Jun","value":519},{"label":"Jul","value":543},{"label":"Ago","value":757},{"label":"Set","value":629},{"label":"Out","value":886},{"label":"Nov","value":576},{"label":"Dez","value":857}];
const MX = 886;
