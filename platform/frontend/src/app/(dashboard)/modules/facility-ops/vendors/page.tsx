...
const PAGE = "Vendor Mgmt";
const KPIS = [{"l":"Fornecedores Ativos","v":"7.636","t":"+10.4%","d":"up"},{"l":"Contratos (€M)","v":"€7.0M","t":"-4.8%","d":"down"},{"l":"On-Time Delivery (%)","v":"70.1%","t":"-2.1%","d":"down"},{"l":"Score Médio","v":"87","t":"+7.9%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","93.0%","€ 36834.63","5.711","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","73.2%","€ 48163.69","124","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","71.9%","€ 47413.98","442","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","92.5%","€ 40181.43","5.511","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","75.0%","€ 41634.99","899","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":630},{"label":"Mar","value":586},{"label":"Abr","value":315},{"label":"Mai","value":679},{"label":"Jun","value":696},{"label":"Jul","value":659},{"label":"Ago","value":647},{"label":"Set","value":525},{"label":"Out","value":373},{"label":"Nov","value":646},{"label":"Dez","value":575}];
const MX = 696;
