...
const KPIS = [{"l":"Total Facility Ops","v":"4.067","t":"+6.4%","d":"up"},{"l":"Floor Plans Ativos","v":"4.444","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"86.5%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"74","t":"+13.6%","d":"up"}];
const COLS = ["ID","Floor Plans","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Facility Ops #001","Facility Ops #002","4.806","1.735","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Facility Ops #002","Facility Ops #003","8.995","975","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Facility Ops #003","Facility Ops #004","693","8.363","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Facility Ops #004","Facility Ops #005","2.211","6.584","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Facility Ops #005","Facility Ops #001","4.020","6.691","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":887},{"label":"Mar","value":854},{"label":"Abr","value":699},{"label":"Mai","value":805},{"label":"Jun","value":735},{"label":"Jul","value":847},{"label":"Ago","value":1093},{"label":"Set","value":712},{"label":"Out","value":895},{"label":"Nov","value":773},{"label":"Dez","value":742}];
const MX = 1093;
