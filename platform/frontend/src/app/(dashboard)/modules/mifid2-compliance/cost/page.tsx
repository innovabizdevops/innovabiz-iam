...
const PAGE = "Cost Disclosure";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.347","t":"-3.4%","d":"down"},{"l":"NC Abertas","v":"4.555","t":"+1.2%","d":"up"},{"l":"Conformidade (%)","v":"89.2%","t":"+1.3%","d":"up"},{"l":"CAPAs Pendentes","v":"1.961","t":"+12.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.251","73.5%","8.349","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.683","91.1%","3.316","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","9.048","83.3%","1.312","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","912","74.6%","1.865","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.397","79.8%","4.057","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":323},{"label":"Mar","value":614},{"label":"Abr","value":550},{"label":"Mai","value":302},{"label":"Jun","value":616},{"label":"Jul","value":351},{"label":"Ago","value":340},{"label":"Set","value":593},{"label":"Out","value":318},{"label":"Nov","value":306},{"label":"Dez","value":536}];
const MX = 620;
