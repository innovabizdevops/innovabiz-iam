...
const PAGE = "Transaction Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.192","t":"+3.1%","d":"up"},{"l":"NC Abertas","v":"3.581","t":"+7.6%","d":"up"},{"l":"Conformidade (%)","v":"67.7%","t":"+5.2%","d":"up"},{"l":"CAPAs Pendentes","v":"8.679","t":"+15.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.034","99.5%","6.606","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.055","70.8%","2.000","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.893","77.4%","4.834","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.283","89.3%","6.896","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.788","91.7%","903","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":474},{"label":"Mar","value":357},{"label":"Abr","value":549},{"label":"Mai","value":453},{"label":"Jun","value":503},{"label":"Jul","value":349},{"label":"Ago","value":334},{"label":"Set","value":551},{"label":"Out","value":591},{"label":"Nov","value":306},{"label":"Dez","value":419}];
const MX = 662;
...
export default function TxnreportPage() {
    return (
