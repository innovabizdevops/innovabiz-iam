...
/* ═══ MiFID II Compliance — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "7010", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2410", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€418K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1585541410", cells: ["MIF-3410", "MiFID II Compliance Item 1", "27/11/2026", "€41 510"], status: "active" as const },
    { id: "1585544981", cells: ["MIF-6981", "MiFID II Compliance Item 2", "14/6/2026", "€45 081"], status: "pending" as const },
    { id: "1585548552", cells: ["MIF-1552", "MiFID II Compliance Item 3", "1/1/2026", "€48 652"], status: "completed" as const },
    { id: "1585552123", cells: ["MIF-5123", "MiFID II Compliance Item 4", "16/8/2026", "€2223"], status: "warning" as const },
    { id: "1585555694", cells: ["MIF-8694", "MiFID II Compliance Item 5", "3/3/2026", "€5794"], status: "active" as const },
];
...
export default function MifidIiCompliancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MiFID II Compliance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MiFID II Compliance</p>
                    </div>
                </div>
