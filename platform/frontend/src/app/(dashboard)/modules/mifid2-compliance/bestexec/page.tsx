...
const ACCENT = "#dc2626";
const MODULE = "MiFID II Compliance";
const PAGE = "Best Execution";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.836","t":"+11.8%","d":"up"},{"l":"NC Abertas","v":"1.056","t":"+9.6%","d":"up"},{"l":"Conformidade (%)","v":"87.7%","t":"+3.9%","d":"up"},{"l":"CAPAs Pendentes","v":"8.324","t":"+0.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.572","71.9%","6.784","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.359","71.7%","1.743","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.585","74.6%","4.844","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.329","81.3%","8.452","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.471","90.3%","6.461","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":593},{"label":"Mar","value":689},{"label":"Abr","value":759},{"label":"Mai","value":747},{"label":"Jun","value":518},{"label":"Jul","value":563},{"label":"Ago","value":584},{"label":"Set","value":649},{"label":"Out","value":761},{"label":"Nov","value":680},{"label":"Dez","value":594}];
const MX = 761;
...
export default function BestexecPage() {
    return (
