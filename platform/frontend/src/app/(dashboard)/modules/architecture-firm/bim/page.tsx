...
const ACCENT = "#6366f1";
const MODULE = "Architecture Firm";
const PAGE = "BIM";
const KPIS = [{"l":"Total Architecture Firm","v":"677","t":"-4.6%","d":"down"},{"l":"BIM Ativos","v":"6.717","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"80.6%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"90","t":"+16.8%","d":"up"}];
const COLS = ["ID","BIM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Architecture Firm #001","Architecture Firm #002","1.895","2.572","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Architecture Firm #002","Architecture Firm #003","8.918","7.614","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Architecture Firm #003","Architecture Firm #004","5.720","479","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Architecture Firm #004","Architecture Firm #005","789","8.002","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Architecture Firm #005","Architecture Firm #001","8.722","2.052","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":545},{"label":"Mar","value":378},{"label":"Abr","value":418},{"label":"Mai","value":301},{"label":"Jun","value":621},{"label":"Jul","value":593},{"label":"Ago","value":428},{"label":"Set","value":575},{"label":"Out","value":295},{"label":"Nov","value":639},{"label":"Dez","value":623}];
const MX = 639;
