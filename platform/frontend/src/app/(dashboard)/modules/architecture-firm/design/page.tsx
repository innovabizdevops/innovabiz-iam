...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"3.065","t":"+7.2%","d":"up"},{"l":"Submissões/Dia","v":"4090","t":"-2.9%","d":"down"},{"l":"Documentos Gerados","v":"8.771","t":"+14.1%","d":"up"},{"l":"Templates","v":"408","t":"+16.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.537","2026-03-15","6.183","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.425","2026-03-17","458","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","527","2026-03-15","3.145","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.081","2026-02-22","6.722","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.302","2026-02-03","6.363","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":964},{"label":"Mar","value":599},{"label":"Abr","value":645},{"label":"Mai","value":825},{"label":"Jun","value":906},{"label":"Jul","value":808},{"label":"Ago","value":885},{"label":"Set","value":941},{"label":"Out","value":869},{"label":"Nov","value":724},{"label":"Dez","value":967}];
const MX = 967;
