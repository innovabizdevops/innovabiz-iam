...
const PAGE = "Compliance Reports";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.541","t":"+5.4%","d":"up"},{"l":"NC Abertas","v":"6.360","t":"+9.3%","d":"up"},{"l":"Conformidade (%)","v":"81.9%","t":"-3.3%","d":"down"},{"l":"CAPAs Pendentes","v":"2.984","t":"+8.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.140","95.2%","1.715","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.135","86.5%","4.305","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.848","88.1%","8.742","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.518","97.0%","1.247","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.560","84.4%","2.138","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":415},{"label":"Mar","value":468},{"label":"Abr","value":511},{"label":"Mai","value":647},{"label":"Jun","value":556},{"label":"Jul","value":442},{"label":"Ago","value":503},{"label":"Set","value":312},{"label":"Out","value":271},{"label":"Nov","value":346},{"label":"Dez","value":639}];
const MX = 647;
