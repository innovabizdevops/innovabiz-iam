...
const ACCENT = "#4338ca";
const MODULE = "Audit Trail & Logging";
const PAGE = "Immutable Ledger";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.427","t":"+1.7%","d":"up"},{"l":"NC Abertas","v":"3.684","t":"+0.5%","d":"up"},{"l":"Conformidade (%)","v":"81.8%","t":"+10.3%","d":"up"},{"l":"CAPAs Pendentes","v":"8.199","t":"+1.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.263","96.1%","9.096","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","9.010","100.0%","8.607","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.517","79.5%","8.299","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.167","94.9%","5.587","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.967","98.9%","6.227","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":576},{"label":"Mar","value":374},{"label":"Abr","value":250},{"label":"Mai","value":256},{"label":"Jun","value":505},{"label":"Jul","value":430},{"label":"Ago","value":577},{"label":"Set","value":233},{"label":"Out","value":404},{"label":"Nov","value":432},{"label":"Dez","value":428}];
const MX = 577;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>Chain</span></h1>
                </div>
