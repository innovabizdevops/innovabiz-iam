...
const KPIS = [{"l":"Auditorias Realizadas","v":"4.600","t":"+15.8%","d":"up"},{"l":"NC Abertas","v":"7.499","t":"+14.0%","d":"up"},{"l":"Conformidade (%)","v":"71.1%","t":"-0.5%","d":"down"},{"l":"CAPAs Pendentes","v":"2.461","t":"+13.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.731","98.7%","2.794","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.718","96.9%","8.813","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.174","85.3%","1.282","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","953","92.0%","6.059","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.860","86.4%","4.176","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":826},{"label":"Mar","value":702},{"label":"Abr","value":859},{"label":"Mai","value":848},{"label":"Jun","value":843},{"label":"Jul","value":585},{"label":"Ago","value":582},{"label":"Set","value":766},{"label":"Out","value":890},{"label":"Nov","value":767},{"label":"Dez","value":711}];
const MX = 890;
