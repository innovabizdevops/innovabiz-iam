...
const PAGE = "Forensic Analysis";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.820","t":"-3.5%","d":"down"},{"l":"NC Abertas","v":"1.385","t":"+13.2%","d":"up"},{"l":"Conformidade (%)","v":"79.9%","t":"-2.3%","d":"down"},{"l":"CAPAs Pendentes","v":"4.346","t":"+17.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.857","91.8%","2.599","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","855","71.2%","1.914","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.872","98.8%","5.679","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","788","83.6%","6.960","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.129","93.0%","6.146","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":462},{"label":"Mar","value":651},{"label":"Abr","value":492},{"label":"Mai","value":681},{"label":"Jun","value":603},{"label":"Jul","value":454},{"label":"Ago","value":436},{"label":"Set","value":466},{"label":"Out","value":440},{"label":"Nov","value":540},{"label":"Dez","value":433}];
const MX = 681;
