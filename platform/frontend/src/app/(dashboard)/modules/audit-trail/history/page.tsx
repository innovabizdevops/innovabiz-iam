...
const PAGE = "Change History";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.477","t":"-1.1%","d":"down"},{"l":"NC Abertas","v":"4.628","t":"-5.3%","d":"down"},{"l":"Conformidade (%)","v":"94.6%","t":"+7.3%","d":"up"},{"l":"CAPAs Pendentes","v":"612","t":"+16.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.196","91.2%","8.168","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.216","93.2%","2.758","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.256","71.4%","3.438","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.386","94.4%","1.709","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.000","87.3%","8.031","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":289},{"label":"Fev","value":600},{"label":"Mar","value":615},{"label":"Abr","value":266},{"label":"Mai","value":453},{"label":"Jun","value":240},{"label":"Jul","value":317},{"label":"Ago","value":447},{"label":"Set","value":381},{"label":"Out","value":603},{"label":"Nov","value":408},{"label":"Dez","value":527}];
const MX = 615;
