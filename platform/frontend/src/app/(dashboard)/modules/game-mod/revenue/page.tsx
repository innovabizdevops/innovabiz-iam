...
const PAGE = "Rev Share";
const KPIS = [{"l":"ARR (€M)","v":"€4.4M","t":"+2.1%","d":"up"},{"l":"MRR (€)","v":"€55237","t":"+6.0%","d":"up"},{"l":"Churn (%)","v":"81.2%","t":"+8.8%","d":"up"},{"l":"ARPU (€)","v":"€70872","t":"+5.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 3114.04","840","€ 1816.36","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 38367.11","1.650","€ 32542.04","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 27094.18","691","€ 25235.01","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 14529.17","1.102","€ 47482.55","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 8604.32","2.543","€ 1022.93","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":459},{"label":"Fev","value":695},{"label":"Mar","value":506},{"label":"Abr","value":481},{"label":"Mai","value":564},{"label":"Jun","value":554},{"label":"Jul","value":819},{"label":"Ago","value":681},{"label":"Set","value":598},{"label":"Out","value":672},{"label":"Nov","value":787},{"label":"Dez","value":689}];
const MX = 819;
