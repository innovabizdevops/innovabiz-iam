...
const ACCENT = "#4338ca";
const MODULE = "Endpoint Protection";
const PAGE = "Quarantine";
const KPIS = [{"l":"Total Endpoint Protect","v":"5.749","t":"+7.2%","d":"up"},{"l":"Quarantine Ativos","v":"4.033","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"80.7%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"72","t":"+4.4%","d":"up"}];
const COLS = ["ID","Quarantine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Endpoint Protect #001","Endpoint Protect #002","1.077","4.242","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Endpoint Protect #002","Endpoint Protect #003","1.083","2.875","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Endpoint Protect #003","Endpoint Protect #004","1.350","5.569","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Endpoint Protect #004","Endpoint Protect #005","8.497","8.014","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Endpoint Protect #005","Endpoint Protect #001","1.813","1.876","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":462},{"label":"Fev","value":628},{"label":"Mar","value":286},{"label":"Abr","value":603},{"label":"Mai","value":621},{"label":"Jun","value":538},{"label":"Jul","value":271},{"label":"Ago","value":511},{"label":"Set","value":613},{"label":"Out","value":527},{"label":"Nov","value":382},{"label":"Dez","value":498}];
const MX = 628;
