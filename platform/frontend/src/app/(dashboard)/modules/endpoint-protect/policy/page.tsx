...
const PAGE = "Policy Push";
const KPIS = [{"l":"Notificações Enviadas","v":"5.615","t":"+7.3%","d":"up"},{"l":"Taxa Entrega (%)","v":"92.6%","t":"+15.5%","d":"up"},{"l":"Taxa Abertura (%)","v":"66.5%","t":"-1.9%","d":"down"},{"l":"Escalações","v":"271","t":"-1.5%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","6.841","81.7%","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","2.538","99.5%","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","6.636","78.5%","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","1.015","84.2%","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","8.852","85.0%","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":894},{"label":"Mar","value":643},{"label":"Abr","value":501},{"label":"Mai","value":642},{"label":"Jun","value":598},{"label":"Jul","value":851},{"label":"Ago","value":790},{"label":"Set","value":831},{"label":"Out","value":577},{"label":"Nov","value":816},{"label":"Dez","value":737}];
const MX = 894;
