...
export default function EndpointProtectPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Endpoint Protect</h1><p className="text-sm text-muted-foreground">Endpoint Protect • iBOS Enterprise</p></div>
