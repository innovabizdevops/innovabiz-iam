...
const KPIS = [{"l":"Total Endpoint Protect","v":"3.385","t":"+10.3%","d":"up"},{"l":"Encryption Ativos","v":"8.523","t":"+6.4%","d":"up"},{"l":"Eficiência (%)","v":"71.8%","t":"+15.7%","d":"up"},{"l":"Score Performance","v":"61","t":"+10.0%","d":"up"}];
const COLS = ["ID","Encryption","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Endpoint Protect #001","Endpoint Protect #002","733","8.402","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Endpoint Protect #002","Endpoint Protect #003","3.648","2.468","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Endpoint Protect #003","Endpoint Protect #004","3.922","8.639","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Endpoint Protect #004","Endpoint Protect #005","7.671","2.892","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Endpoint Protect #005","Endpoint Protect #001","7.862","3.025","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":581},{"label":"Fev","value":878},{"label":"Mar","value":601},{"label":"Abr","value":863},{"label":"Mai","value":915},{"label":"Jun","value":579},{"label":"Jul","value":589},{"label":"Ago","value":715},{"label":"Set","value":716},{"label":"Out","value":620},{"label":"Nov","value":770},{"label":"Dez","value":604}];
const MX = 915;
