...
const PAGE = "Predictive Models";
const KPIS = [{"l":"Twins Ativos","v":"5.720","t":"+11.7%","d":"up"},{"l":"Simulações/Dia","v":"3902","t":"-3.7%","d":"down"},{"l":"Precisão Modelo (%)","v":"93.8%","t":"+2.5%","d":"up"},{"l":"Latência Sync (ms)","v":"101ms","t":"+16.8%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","88.8%","2026-01-15","2.463","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","75.6%","2026-02-26","7.674","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","87.2%","2026-02-14","2.285","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","79.6%","2026-03-26","1.162","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","88.3%","2026-02-14","7.815","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":721},{"label":"Fev","value":691},{"label":"Mar","value":852},{"label":"Abr","value":646},{"label":"Mai","value":877},{"label":"Jun","value":883},{"label":"Jul","value":988},{"label":"Ago","value":676},{"label":"Set","value":971},{"label":"Out","value":861},{"label":"Nov","value":899},{"label":"Dez","value":999}];
const MX = 999;
