...
const KPIS = [{"l":"Twins Ativos","v":"4.178","t":"+3.6%","d":"up"},{"l":"Simulações/Dia","v":"4319","t":"+1.9%","d":"up"},{"l":"Precisão Modelo (%)","v":"72.5%","t":"+2.3%","d":"up"},{"l":"Latência Sync (ms)","v":"45ms","t":"+6.3%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","97.9%","2026-02-03","8.633","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","70.4%","2026-01-11","3.048","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","90.7%","2026-03-18","7.645","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","76.8%","2026-01-14","5.028","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","84.5%","2026-01-25","3.838","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":861},{"label":"Mar","value":1026},{"label":"Abr","value":972},{"label":"Mai","value":804},{"label":"Jun","value":793},{"label":"Jul","value":1039},{"label":"Ago","value":964},{"label":"Set","value":765},{"label":"Out","value":1020},{"label":"Nov","value":1082},{"label":"Dez","value":887}];
const MX = 1082;
