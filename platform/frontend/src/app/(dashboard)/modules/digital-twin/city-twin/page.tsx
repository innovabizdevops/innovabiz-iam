...
const PAGE = "City Twin";
const KPIS = [{"l":"Twins Ativos","v":"2.436","t":"+10.0%","d":"up"},{"l":"Simulações/Dia","v":"4254","t":"-2.9%","d":"down"},{"l":"Precisão Modelo (%)","v":"72.5%","t":"+16.0%","d":"up"},{"l":"Latência Sync (ms)","v":"87ms","t":"+3.0%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","88.0%","2026-02-08","5.490","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","71.8%","2026-03-05","8.299","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","83.7%","2026-02-17","7.114","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","74.6%","2026-01-11","3.889","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","78.0%","2026-03-23","1.818","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":531},{"label":"Mar","value":538},{"label":"Abr","value":663},{"label":"Mai","value":410},{"label":"Jun","value":421},{"label":"Jul","value":391},{"label":"Ago","value":515},{"label":"Set","value":592},{"label":"Out","value":569},{"label":"Nov","value":633},{"label":"Dez","value":661}];
const MX = 663;
