...
const ACCENT = "#0891b2";
const MODULE = "Digital Twin Platform";
const PAGE = "Simulation Engine";
const KPIS = [{"l":"Twins Ativos","v":"9.022","t":"-5.7%","d":"down"},{"l":"Simulações/Dia","v":"4871","t":"+0.4%","d":"up"},{"l":"Precisão Modelo (%)","v":"72.4%","t":"+4.2%","d":"up"},{"l":"Latência Sync (ms)","v":"39ms","t":"-5.5%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","83.3%","2026-01-19","3.075","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","100.0%","2026-01-23","3.244","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","94.4%","2026-03-17","3.805","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","95.4%","2026-02-06","8.509","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","70.7%","2026-03-19","312","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":589},{"label":"Mar","value":631},{"label":"Abr","value":351},{"label":"Mai","value":484},{"label":"Jun","value":568},{"label":"Jul","value":506},{"label":"Ago","value":327},{"label":"Set","value":289},{"label":"Out","value":283},{"label":"Nov","value":371},{"label":"Dez","value":301}];
const MX = 631;
...
export default function SimulationDigitalTwinPage() {
    return (
