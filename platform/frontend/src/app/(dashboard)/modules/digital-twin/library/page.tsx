...
const PAGE = "Asset Twin Library";
const KPIS = [{"l":"Twins Ativos","v":"5.012","t":"+3.8%","d":"up"},{"l":"Simulações/Dia","v":"1468","t":"+7.1%","d":"up"},{"l":"Precisão Modelo (%)","v":"69.6%","t":"+0.9%","d":"up"},{"l":"Latência Sync (ms)","v":"164ms","t":"+2.8%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","94.9%","2026-03-14","3.276","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","80.5%","2026-01-10","7.370","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","79.9%","2026-02-01","6.049","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","82.9%","2026-03-12","4.223","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","74.0%","2026-03-18","411","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":645},{"label":"Mar","value":712},{"label":"Abr","value":614},{"label":"Mai","value":710},{"label":"Jun","value":931},{"label":"Jul","value":767},{"label":"Ago","value":735},{"label":"Set","value":654},{"label":"Out","value":615},{"label":"Nov","value":747},{"label":"Dez","value":924}];
const MX = 931;
