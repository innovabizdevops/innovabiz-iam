...
const PAGE = "Real-Time Sync";
const KPIS = [{"l":"Twins Ativos","v":"400","t":"+7.8%","d":"up"},{"l":"Simulações/Dia","v":"1323","t":"-0.4%","d":"down"},{"l":"Precisão Modelo (%)","v":"67.2%","t":"+14.9%","d":"up"},{"l":"Latência Sync (ms)","v":"18ms","t":"+8.7%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","89.3%","2026-01-01","2.614","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","71.9%","2026-03-03","2.348","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","81.5%","2026-02-19","5.831","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","72.2%","2026-02-06","4.276","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","79.9%","2026-01-14","1.485","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":966},{"label":"Fev","value":655},{"label":"Mar","value":735},{"label":"Abr","value":656},{"label":"Mai","value":925},{"label":"Jun","value":996},{"label":"Jul","value":994},{"label":"Ago","value":835},{"label":"Set","value":958},{"label":"Out","value":937},{"label":"Nov","value":666},{"label":"Dez","value":968}];
const MX = 996;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>Edge</span></h1>
                </div>
