...
const PAGE = "Predictive Failure";
const KPIS = [{"l":"Twins Ativos","v":"3.832","t":"+2.5%","d":"up"},{"l":"Simulações/Dia","v":"2331","t":"+5.4%","d":"up"},{"l":"Precisão Modelo (%)","v":"67.9%","t":"+17.1%","d":"up"},{"l":"Latência Sync (ms)","v":"83ms","t":"-0.6%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","87.6%","2026-01-04","615","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","82.0%","2026-01-07","7.820","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","96.2%","2026-03-21","7.981","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","97.4%","2026-03-10","7.822","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","92.3%","2026-02-16","7.909","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":489},{"label":"Fev","value":653},{"label":"Mar","value":618},{"label":"Abr","value":583},{"label":"Mai","value":538},{"label":"Jun","value":709},{"label":"Jul","value":604},{"label":"Ago","value":697},{"label":"Set","value":568},{"label":"Out","value":319},{"label":"Nov","value":706},{"label":"Dez","value":698}];
const MX = 709;
...
export default function PredictiveDigitalTwinPage() {
    return (
