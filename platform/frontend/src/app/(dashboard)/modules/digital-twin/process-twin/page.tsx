...
const PAGE = "Process Twins";
const KPIS = [{"l":"Twins Ativos","v":"7.438","t":"+16.9%","d":"up"},{"l":"Simulações/Dia","v":"2892","t":"-5.6%","d":"down"},{"l":"Precisão Modelo (%)","v":"72.7%","t":"+17.6%","d":"up"},{"l":"Latência Sync (ms)","v":"200ms","t":"-3.1%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","85.1%","2026-01-15","2.220","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","85.2%","2026-03-16","5.757","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","93.6%","2026-02-25","7.199","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","84.7%","2026-01-27","8.173","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","81.9%","2026-03-03","2.671","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":312},{"label":"Fev","value":583},{"label":"Mar","value":242},{"label":"Abr","value":487},{"label":"Mai","value":391},{"label":"Jun","value":524},{"label":"Jul","value":326},{"label":"Ago","value":546},{"label":"Set","value":345},{"label":"Out","value":478},{"label":"Nov","value":233},{"label":"Dez","value":469}];
const MX = 583;
...
export default function ProcessTwinPage() {
    return (
