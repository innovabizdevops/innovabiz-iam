...
const PAGE = "City-Scale Twin";
const KPIS = [{"l":"Twins Ativos","v":"678","t":"-5.7%","d":"down"},{"l":"Simulações/Dia","v":"4748","t":"+11.9%","d":"up"},{"l":"Precisão Modelo (%)","v":"68.6%","t":"+11.1%","d":"up"},{"l":"Latência Sync (ms)","v":"59ms","t":"+0.9%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","70.5%","2026-03-22","4.413","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","92.6%","2026-01-11","754","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","98.0%","2026-01-28","856","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","84.9%","2026-02-15","2.575","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","72.3%","2026-01-22","4.648","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":835},{"label":"Fev","value":984},{"label":"Mar","value":965},{"label":"Abr","value":913},{"label":"Mai","value":735},{"label":"Jun","value":806},{"label":"Jul","value":876},{"label":"Ago","value":894},{"label":"Set","value":735},{"label":"Out","value":794},{"label":"Nov","value":874},{"label":"Dez","value":681}];
const MX = 984;
...
export default function CityScalePage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>Smart City</span></h1>
                </div>
