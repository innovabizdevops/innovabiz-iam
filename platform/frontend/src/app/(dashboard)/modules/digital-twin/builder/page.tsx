...
const PAGE = "Twin Builder";
const KPIS = [{"l":"Twins Ativos","v":"370","t":"+7.3%","d":"up"},{"l":"Simulações/Dia","v":"2937","t":"-0.7%","d":"down"},{"l":"Precisão Modelo (%)","v":"78.6%","t":"+6.0%","d":"up"},{"l":"Latência Sync (ms)","v":"40ms","t":"-0.7%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","95.2%","2026-02-07","6.286","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","89.7%","2026-02-12","3.732","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","75.9%","2026-03-09","3.473","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","71.8%","2026-01-09","5.157","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","70.9%","2026-02-11","6.343","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":652},{"label":"Mar","value":638},{"label":"Abr","value":385},{"label":"Mai","value":696},{"label":"Jun","value":513},{"label":"Jul","value":321},{"label":"Ago","value":390},{"label":"Set","value":542},{"label":"Out","value":423},{"label":"Nov","value":528},{"label":"Dez","value":687}];
const MX = 696;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>3D</span></h1>
                </div>
