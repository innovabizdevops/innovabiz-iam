...
const PAGE = "Scenario What-If";
const KPIS = [{"l":"Twins Ativos","v":"4.628","t":"-4.9%","d":"down"},{"l":"Simulações/Dia","v":"2384","t":"+16.6%","d":"up"},{"l":"Precisão Modelo (%)","v":"86.4%","t":"+2.9%","d":"up"},{"l":"Latência Sync (ms)","v":"91ms","t":"-4.7%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","94.2%","2026-01-27","6.182","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","74.3%","2026-02-07","4.450","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","70.2%","2026-01-09","1.691","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","92.7%","2026-03-25","6.740","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","90.3%","2026-03-12","5.667","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":765},{"label":"Mar","value":583},{"label":"Abr","value":875},{"label":"Mai","value":926},{"label":"Jun","value":805},{"label":"Jul","value":838},{"label":"Ago","value":791},{"label":"Set","value":684},{"label":"Out","value":736},{"label":"Nov","value":777},{"label":"Dez","value":579}];
const MX = 926;
