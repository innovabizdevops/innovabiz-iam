...
const PAGE = "What-If Scenarios";
const KPIS = [{"l":"Twins Ativos","v":"5.644","t":"+5.1%","d":"up"},{"l":"Simulações/Dia","v":"4776","t":"+12.2%","d":"up"},{"l":"Precisão Modelo (%)","v":"90.8%","t":"+16.4%","d":"up"},{"l":"Latência Sync (ms)","v":"122ms","t":"+0.8%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","80.0%","2026-01-18","3.441","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","70.7%","2026-01-24","7.083","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","76.3%","2026-01-03","6.607","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","74.0%","2026-02-08","4.456","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","95.1%","2026-02-23","5.251","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":557},{"label":"Mar","value":477},{"label":"Abr","value":430},{"label":"Mai","value":720},{"label":"Jun","value":578},{"label":"Jul","value":766},{"label":"Ago","value":553},{"label":"Set","value":649},{"label":"Out","value":477},{"label":"Nov","value":402},{"label":"Dez","value":596}];
const MX = 766;
...
export default function WhatIfDigitalTwinPage() {
    return (
