...
const PAGE = "Real-Time Sync IoT";
const KPIS = [{"l":"Dispositivos Online","v":"294","t":"+16.6%","d":"up"},{"l":"Dados/Min (MB)","v":"4.164","t":"+11.5%","d":"up"},{"l":"Alertas Ativos","v":"1.691","t":"+4.7%","d":"up"},{"l":"Uptime (%)","v":"68.7%","t":"+12.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.474","1.262","1.389","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","919","761","4.840","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.254","7.616","738","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","4.773","4.999","4.812","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","9.030","5.931","2.519","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":885},{"label":"Mar","value":759},{"label":"Abr","value":693},{"label":"Mai","value":833},{"label":"Jun","value":615},{"label":"Jul","value":651},{"label":"Ago","value":818},{"label":"Set","value":813},{"label":"Out","value":930},{"label":"Nov","value":650},{"label":"Dez","value":804}];
const MX = 930;
