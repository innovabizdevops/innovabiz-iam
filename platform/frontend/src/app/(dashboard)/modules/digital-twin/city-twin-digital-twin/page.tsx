...
const PAGE = "City Twins";
const KPIS = [{"l":"Twins Ativos","v":"4.995","t":"-0.1%","d":"down"},{"l":"Simulações/Dia","v":"919","t":"+3.3%","d":"up"},{"l":"Precisão Modelo (%)","v":"75.5%","t":"+17.4%","d":"up"},{"l":"Latência Sync (ms)","v":"35ms","t":"+13.3%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","80.9%","2026-03-05","781","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","94.2%","2026-02-22","6.527","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","80.2%","2026-02-18","8.183","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","89.8%","2026-01-05","7.344","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","91.7%","2026-02-16","7.366","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":685},{"label":"Mar","value":478},{"label":"Abr","value":711},{"label":"Mai","value":508},{"label":"Jun","value":703},{"label":"Jul","value":570},{"label":"Ago","value":412},{"label":"Set","value":563},{"label":"Out","value":715},{"label":"Nov","value":558},{"label":"Dez","value":431}];
const MX = 715;
...
export default function CityTwinDigitalTwinPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>Smart</span></h1>
                </div>
