...
const PAGE = "Asset Twins";
const KPIS = [{"l":"Twins Ativos","v":"4.758","t":"-4.6%","d":"down"},{"l":"Simulações/Dia","v":"1148","t":"+6.6%","d":"up"},{"l":"Precisão Modelo (%)","v":"81.8%","t":"+4.7%","d":"up"},{"l":"Latência Sync (ms)","v":"36ms","t":"+14.0%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","76.9%","2026-01-11","2.623","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","91.1%","2026-01-17","6.296","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","95.3%","2026-03-06","1.760","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","96.4%","2026-03-08","3.203","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","72.2%","2026-02-04","3.002","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":997},{"label":"Fev","value":1011},{"label":"Mar","value":688},{"label":"Abr","value":676},{"label":"Mai","value":698},{"label":"Jun","value":821},{"label":"Jul","value":1054},{"label":"Ago","value":732},{"label":"Set","value":913},{"label":"Out","value":718},{"label":"Nov","value":954},{"label":"Dez","value":805}];
const MX = 1054;
