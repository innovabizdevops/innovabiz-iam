...
const PAGE = "Supply Chain Twin";
const KPIS = [{"l":"Twins Ativos","v":"4.432","t":"-0.5%","d":"down"},{"l":"Simulações/Dia","v":"3579","t":"+15.1%","d":"up"},{"l":"Precisão Modelo (%)","v":"78.3%","t":"+10.7%","d":"up"},{"l":"Latência Sync (ms)","v":"171ms","t":"+1.5%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","87.4%","2026-02-21","3.918","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","74.3%","2026-03-13","4.378","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","70.5%","2026-01-25","1.885","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","97.2%","2026-02-07","5.811","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","74.7%","2026-01-02","5.791","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":978},{"label":"Fev","value":915},{"label":"Mar","value":1057},{"label":"Abr","value":762},{"label":"Mai","value":778},{"label":"Jun","value":901},{"label":"Jul","value":960},{"label":"Ago","value":761},{"label":"Set","value":736},{"label":"Out","value":949},{"label":"Nov","value":859},{"label":"Dez","value":818}];
const MX = 1057;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>SCM</span></h1>
                </div>
