...
const PAGE = "Print";
const KPIS = [{"l":"Total 3d Food Print","v":"8.072","t":"+8.6%","d":"up"},{"l":"Print Ativos","v":"3.184","t":"+14.4%","d":"up"},{"l":"Eficiência (%)","v":"75.5%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"72","t":"+8.9%","d":"up"}];
const COLS = ["ID","Print","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Food Print #001","3d Food Print #002","2.178","2.622","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["3d Food Print #002","3d Food Print #003","1.616","682","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Food Print #003","3d Food Print #004","3.086","6.408","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["3d Food Print #004","3d Food Print #005","9.036","7.778","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Food Print #005","3d Food Print #001","7.690","5.746","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":927},{"label":"Mar","value":596},{"label":"Abr","value":572},{"label":"Mai","value":840},{"label":"Jun","value":757},{"label":"Jul","value":529},{"label":"Ago","value":782},{"label":"Set","value":915},{"label":"Out","value":600},{"label":"Nov","value":843},{"label":"Dez","value":907}];
const MX = 927;
