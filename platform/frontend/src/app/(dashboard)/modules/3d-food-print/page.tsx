...
/* ═══ 3D Food Printing — Dashboard ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total Registos", value: "1501", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "186", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€190K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "251204001", cells: ["3D-6001", "3D Food Printing Item 1", "14/10/2026", "€4101"], status: "active" as const },
    { id: "251207572", cells: ["3D-9572", "3D Food Printing Item 2", "1/5/2026", "€7672"], status: "pending" as const },
    { id: "251211143", cells: ["3D-4143", "3D Food Printing Item 3", "16/12/2026", "€11 243"], status: "completed" as const },
    { id: "251214714", cells: ["3D-7714", "3D Food Printing Item 4", "3/7/2026", "€14 814"], status: "warning" as const },
    { id: "251218285", cells: ["3D-2285", "3D Food Printing Item 5", "18/2/2026", "€18 385"], status: "active" as const },
];
...
export default function P3dFoodPrintingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">3D Food Printing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • 3D Food Printing</p>
                    </div>
                </div>
