...
export default function SpaResortPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Spa Resort</h1><p className="text-sm text-muted-foreground">Spa Resort • iBOS Enterprise</p></div>
