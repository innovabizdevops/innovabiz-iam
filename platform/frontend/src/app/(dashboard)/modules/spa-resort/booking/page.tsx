...
const PAGE = "Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"773","t":"+8.2%","d":"up"},{"l":"RevPAR (€)","v":"€53269","t":"-5.7%","d":"down"},{"l":"Ocupação (%)","v":"87.9%","t":"+4.0%","d":"up"},{"l":"Guest Satisfaction","v":"8.931","t":"+12.0%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.978","2026-03-05","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.489","2026-01-02","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","870","2026-01-18","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.742","2026-01-01","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.716","2026-02-08","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":684},{"label":"Mar","value":530},{"label":"Abr","value":469},{"label":"Mai","value":438},{"label":"Jun","value":680},{"label":"Jul","value":448},{"label":"Ago","value":537},{"label":"Set","value":643},{"label":"Out","value":438},{"label":"Nov","value":546},{"label":"Dez","value":487}];
const MX = 684;
