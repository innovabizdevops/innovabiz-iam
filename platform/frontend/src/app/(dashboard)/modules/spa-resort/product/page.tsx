...
const PAGE = "Product";
const KPIS = [{"l":"Quartos Ocupados","v":"1.540","t":"-3.3%","d":"down"},{"l":"RevPAR (€)","v":"€68073","t":"-3.2%","d":"down"},{"l":"Ocupação (%)","v":"73.9%","t":"+13.7%","d":"up"},{"l":"Guest Satisfaction","v":"6.289","t":"+17.8%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","829","2026-03-04","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","369","2026-03-16","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.766","2026-02-09","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.406","2026-03-15","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.493","2026-02-05","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":856},{"label":"Fev","value":888},{"label":"Mar","value":787},{"label":"Abr","value":926},{"label":"Mai","value":743},{"label":"Jun","value":710},{"label":"Jul","value":564},{"label":"Ago","value":925},{"label":"Set","value":681},{"label":"Out","value":695},{"label":"Nov","value":691},{"label":"Dez","value":766}];
const MX = 926;
