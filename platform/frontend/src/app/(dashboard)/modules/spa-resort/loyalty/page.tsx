...
const ACCENT = "#6366f1";
const MODULE = "Spa & Resort";
const PAGE = "Loyalty";
const KPIS = [{"l":"Quartos Ocupados","v":"4.936","t":"+1.2%","d":"up"},{"l":"RevPAR (€)","v":"€40115","t":"+10.7%","d":"up"},{"l":"Ocupação (%)","v":"86.3%","t":"+8.4%","d":"up"},{"l":"Guest Satisfaction","v":"2.238","t":"+9.3%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.626","2026-01-28","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","400","2026-03-09","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.309","2026-03-05","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","2.806","2026-02-17","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.277","2026-01-04","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":388},{"label":"Fev","value":587},{"label":"Mar","value":454},{"label":"Abr","value":368},{"label":"Mai","value":337},{"label":"Jun","value":635},{"label":"Jul","value":474},{"label":"Ago","value":434},{"label":"Set","value":350},{"label":"Out","value":643},{"label":"Nov","value":612},{"label":"Dez","value":556}];
const MX = 643;
