...
const KPIS = [{"l":"Quartos Ocupados","v":"1.631","t":"+14.4%","d":"up"},{"l":"RevPAR (€)","v":"€44174","t":"+8.0%","d":"up"},{"l":"Ocupação (%)","v":"78.6%","t":"+1.5%","d":"up"},{"l":"Guest Satisfaction","v":"2.890","t":"+13.2%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.195","2026-01-11","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","5.022","2026-02-12","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.808","2026-01-26","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.870","2026-01-18","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.568","2026-01-23","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":490},{"label":"Mar","value":585},{"label":"Abr","value":473},{"label":"Mai","value":376},{"label":"Jun","value":493},{"label":"Jul","value":275},{"label":"Ago","value":608},{"label":"Set","value":490},{"label":"Out","value":534},{"label":"Nov","value":343},{"label":"Dez","value":359}];
const MX = 608;
