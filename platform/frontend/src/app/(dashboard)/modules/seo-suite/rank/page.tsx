...
const PAGE = "Rank Tracker";
const KPIS = [{"l":"Total Seo Suite","v":"3.351","t":"+11.4%","d":"up"},{"l":"Rank Tracker Ativos","v":"6.693","t":"+4.9%","d":"up"},{"l":"Eficiência (%)","v":"67.2%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"63","t":"+8.5%","d":"up"}];
const COLS = ["ID","Rank Tracker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Seo Suite #001","Seo Suite #002","7.884","6.598","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Seo Suite #002","Seo Suite #003","7.823","2.967","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Seo Suite #003","Seo Suite #004","8.807","4.412","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Seo Suite #004","Seo Suite #005","4.119","572","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Seo Suite #005","Seo Suite #001","3.973","1.884","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":535},{"label":"Mar","value":796},{"label":"Abr","value":873},{"label":"Mai","value":746},{"label":"Jun","value":790},{"label":"Jul","value":687},{"label":"Ago","value":571},{"label":"Set","value":613},{"label":"Out","value":810},{"label":"Nov","value":900},{"label":"Dez","value":848}];
const MX = 900;
