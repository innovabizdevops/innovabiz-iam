...
const PAGE = "Technical SEO";
const KPIS = [{"l":"Total Seo Suite","v":"1.509","t":"+2.7%","d":"up"},{"l":"Technical SEO Ativos","v":"3.262","t":"+0.7%","d":"up"},{"l":"Eficiência (%)","v":"92.6%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"62","t":"+14.3%","d":"up"}];
const COLS = ["ID","Technical SEO","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Seo Suite #001","Seo Suite #002","1.487","8.473","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Seo Suite #002","Seo Suite #003","1.093","4.212","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Seo Suite #003","Seo Suite #004","2.242","8.021","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Seo Suite #004","Seo Suite #005","3.899","2.061","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Seo Suite #005","Seo Suite #001","8.920","7.049","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":405},{"label":"Fev","value":538},{"label":"Mar","value":357},{"label":"Abr","value":283},{"label":"Mai","value":472},{"label":"Jun","value":581},{"label":"Jul","value":481},{"label":"Ago","value":449},{"label":"Set","value":560},{"label":"Out","value":630},{"label":"Nov","value":588},{"label":"Dez","value":483}];
const MX = 630;
