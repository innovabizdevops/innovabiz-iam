...
const ACCENT = "#475569";
const MODULE = "SEO Suite";
const PAGE = "Content Optimizer";
const KPIS = [{"l":"Total Seo Suite","v":"5.984","t":"+0.5%","d":"up"},{"l":"Content Optimizer Ativos","v":"8.183","t":"+10.2%","d":"up"},{"l":"Eficiência (%)","v":"81.7%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"58","t":"+7.4%","d":"up"}];
const COLS = ["ID","Content Optimizer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Seo Suite #001","Seo Suite #002","5.244","5.212","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Seo Suite #002","Seo Suite #003","7.972","2.753","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Seo Suite #003","Seo Suite #004","4.782","8.871","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Seo Suite #004","Seo Suite #005","2.739","8.426","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Seo Suite #005","Seo Suite #001","880","2.001","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":355},{"label":"Mar","value":292},{"label":"Abr","value":505},{"label":"Mai","value":244},{"label":"Jun","value":229},{"label":"Jul","value":282},{"label":"Ago","value":448},{"label":"Set","value":367},{"label":"Out","value":591},{"label":"Nov","value":332},{"label":"Dez","value":458}];
const MX = 591;
