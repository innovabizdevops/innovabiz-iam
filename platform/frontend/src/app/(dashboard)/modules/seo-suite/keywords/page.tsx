...
const PAGE = "Keyword Research";
const KPIS = [{"l":"Ideias Submetidas","v":"5.537","t":"+11.6%","d":"up"},{"l":"Patentes (YTD)","v":"2.302","t":"+10.7%","d":"up"},{"l":"Projetos Innovation Lab","v":"4.753","t":"+5.7%","d":"up"},{"l":"Budget I&D (€M)","v":"€25.1M","t":"+9.7%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.661","83.8%","1.567","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.439","77.0%","7.189","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","3.607","79.3%","6.966","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","8.989","79.6%","624","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","4.478","89.9%","2.778","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":505},{"label":"Mar","value":679},{"label":"Abr","value":689},{"label":"Mai","value":808},{"label":"Jun","value":472},{"label":"Jul","value":427},{"label":"Ago","value":769},{"label":"Set","value":675},{"label":"Out","value":755},{"label":"Nov","value":538},{"label":"Dez","value":445}];
const MX = 808;
