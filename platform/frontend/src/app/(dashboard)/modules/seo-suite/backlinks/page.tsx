...
const PAGE = "Backlink Monitor";
const KPIS = [{"l":"Total Seo Suite","v":"750","t":"+14.6%","d":"up"},{"l":"Backlink Monitor Ativos","v":"538","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"80.5%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"66","t":"+17.2%","d":"up"}];
const COLS = ["ID","Backlink Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Seo Suite #001","Seo Suite #002","6.078","5.291","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Seo Suite #002","Seo Suite #003","8.336","7.402","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Seo Suite #003","Seo Suite #004","5.382","5.272","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Seo Suite #004","Seo Suite #005","8.836","4.410","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Seo Suite #005","Seo Suite #001","4.993","4.620","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":677},{"label":"Mar","value":813},{"label":"Abr","value":506},{"label":"Mai","value":537},{"label":"Jun","value":606},{"label":"Jul","value":681},{"label":"Ago","value":698},{"label":"Set","value":583},{"label":"Out","value":853},{"label":"Nov","value":490},{"label":"Dez","value":806}];
const MX = 853;
