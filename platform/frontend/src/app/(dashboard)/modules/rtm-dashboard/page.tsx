...
/* ═══ RTM Real-Time Dashboard — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "8097", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4479", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€477K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "969782297", cells: ["RTM-6297", "RTM Real-Time Dashboard Item 1", "2/6/2026", "€32 397"], status: "active" as const },
    { id: "969785868", cells: ["RTM-9868", "RTM Real-Time Dashboard Item 2", "17/1/2026", "€35 968"], status: "pending" as const },
    { id: "969789439", cells: ["RTM-4439", "RTM Real-Time Dashboard Item 3", "4/8/2026", "€39 539"], status: "completed" as const },
    { id: "969793010", cells: ["RTM-8010", "RTM Real-Time Dashboard Item 4", "19/3/2026", "€43 110"], status: "warning" as const },
    { id: "969796581", cells: ["RTM-2581", "RTM Real-Time Dashboard Item 5", "6/10/2026", "€46 681"], status: "active" as const },
];
...
export default function RtmRealtimeDashboardPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">RTM Real-Time Dashboard</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • RTM Real-Time Dashboard</p>
                    </div>
                </div>
