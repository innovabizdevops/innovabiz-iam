...
const PAGE = "Drill";
const KPIS = [{"l":"Teams Ativos","v":"5.949","t":"+10.2%","d":"up"},{"l":"Reuniões/Semana","v":"1828","t":"+11.0%","d":"up"},{"l":"Mensagens/Dia","v":"977","t":"+10.9%","d":"up"},{"l":"Ficheiros Partilhados","v":"1.795","t":"-4.8%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.777","1381","6.435","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","3.009","2866","997","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","3.374","2365","2.281","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.012","2245","6.905","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.577","4952","7.816","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":380},{"label":"Fev","value":297},{"label":"Mar","value":391},{"label":"Abr","value":653},{"label":"Mai","value":566},{"label":"Jun","value":529},{"label":"Jul","value":469},{"label":"Ago","value":328},{"label":"Set","value":628},{"label":"Out","value":401},{"label":"Nov","value":427},{"label":"Dez","value":341}];
const MX = 653;
