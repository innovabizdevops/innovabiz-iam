...
const PAGE = "KPI";
const KPIS = [{"l":"Teams Ativos","v":"636","t":"+11.8%","d":"up"},{"l":"Reuniões/Semana","v":"604","t":"+6.5%","d":"up"},{"l":"Mensagens/Dia","v":"2798","t":"-5.0%","d":"down"},{"l":"Ficheiros Partilhados","v":"7.004","t":"+1.9%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.696","2777","6.424","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","4.252","1394","7.034","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","568","3348","5.972","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","666","3075","4.386","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.499","3048","5.962","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":702},{"label":"Mar","value":822},{"label":"Abr","value":785},{"label":"Mai","value":638},{"label":"Jun","value":807},{"label":"Jul","value":912},{"label":"Ago","value":763},{"label":"Set","value":590},{"label":"Out","value":747},{"label":"Nov","value":629},{"label":"Dez","value":693}];
const MX = 912;
