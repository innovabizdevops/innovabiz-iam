...
const PAGE = "Share";
const KPIS = [{"l":"Teams Ativos","v":"8.958","t":"+13.5%","d":"up"},{"l":"Reuniões/Semana","v":"3109","t":"+7.6%","d":"up"},{"l":"Mensagens/Dia","v":"1715","t":"+14.5%","d":"up"},{"l":"Ficheiros Partilhados","v":"4.547","t":"+5.7%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.474","4244","9.032","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","4.807","3886","6.844","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.455","1039","8.770","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.850","867","9.054","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","5.541","4626","2.631","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":317},{"label":"Fev","value":489},{"label":"Mar","value":556},{"label":"Abr","value":434},{"label":"Mai","value":336},{"label":"Jun","value":385},{"label":"Jul","value":628},{"label":"Ago","value":244},{"label":"Set","value":554},{"label":"Out","value":572},{"label":"Nov","value":254},{"label":"Dez","value":236}];
const MX = 628;
