...
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"7.731","t":"+14.5%","d":"up"},{"l":"Taxa Entrega (%)","v":"73.9%","t":"+7.9%","d":"up"},{"l":"Taxa Abertura (%)","v":"68.8%","t":"+14.4%","d":"up"},{"l":"Escalações","v":"8.742","t":"+15.2%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","3.615","92.1%","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","3.938","89.7%","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","375","75.1%","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","3.250","94.5%","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","1.311","81.1%","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":552},{"label":"Mar","value":581},{"label":"Abr","value":471},{"label":"Mai","value":571},{"label":"Jun","value":730},{"label":"Jul","value":741},{"label":"Ago","value":435},{"label":"Set","value":694},{"label":"Out","value":541},{"label":"Nov","value":587},{"label":"Dez","value":755}];
const MX = 755;
