...
const ACCENT = "#dc2626";
const MODULE = "RTM Real-Time Dashboard";
const PAGE = "Live Feed";
const KPIS = [{"l":"Teams Ativos","v":"8.277","t":"-5.2%","d":"down"},{"l":"Reuniões/Semana","v":"398","t":"+12.9%","d":"up"},{"l":"Mensagens/Dia","v":"286","t":"+2.1%","d":"up"},{"l":"Ficheiros Partilhados","v":"717","t":"+2.7%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","3.484","4419","5.342","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","5.943","3626","7.256","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","2.562","180","848","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.265","3798","6.247","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","3.548","3882","3.619","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":578},{"label":"Mar","value":499},{"label":"Abr","value":672},{"label":"Mai","value":687},{"label":"Jun","value":607},{"label":"Jul","value":782},{"label":"Ago","value":547},{"label":"Set","value":588},{"label":"Out","value":755},{"label":"Nov","value":800},{"label":"Dez","value":590}];
const MX = 800;
