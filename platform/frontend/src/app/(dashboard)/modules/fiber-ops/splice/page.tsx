...
const PAGE = "Splice";
const KPIS = [{"l":"Total Fiber Ops","v":"7.718","t":"-3.0%","d":"down"},{"l":"Splice Ativos","v":"3.990","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"67.6%","t":"+15.3%","d":"up"},{"l":"Score Performance","v":"93","t":"-3.1%","d":"down"}];
const COLS = ["ID","Splice","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fiber Ops #001","Fiber Ops #002","7.224","635","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Fiber Ops #002","Fiber Ops #003","7.868","7.239","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Fiber Ops #003","Fiber Ops #004","6.171","2.993","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Fiber Ops #004","Fiber Ops #005","4.029","3.611","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fiber Ops #005","Fiber Ops #001","4.566","5.382","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":326},{"label":"Mar","value":609},{"label":"Abr","value":534},{"label":"Mai","value":412},{"label":"Jun","value":540},{"label":"Jul","value":585},{"label":"Ago","value":592},{"label":"Set","value":593},{"label":"Out","value":435},{"label":"Nov","value":385},{"label":"Dez","value":463}];
const MX = 609;
