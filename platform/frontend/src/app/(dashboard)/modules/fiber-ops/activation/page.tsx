...
const KPIS = [{"l":"Total Fiber Ops","v":"3.957","t":"+9.7%","d":"up"},{"l":"Activation Ativos","v":"5.512","t":"-5.3%","d":"down"},{"l":"Eficiência (%)","v":"88.4%","t":"+1.7%","d":"up"},{"l":"Score Performance","v":"80","t":"+7.8%","d":"up"}];
const COLS = ["ID","Activation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fiber Ops #001","Fiber Ops #002","2.434","330","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Fiber Ops #002","Fiber Ops #003","3.867","138","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Fiber Ops #003","Fiber Ops #004","4.822","7.112","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Fiber Ops #004","Fiber Ops #005","5.182","7.314","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fiber Ops #005","Fiber Ops #001","3.699","1.316","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":489},{"label":"Fev","value":620},{"label":"Mar","value":398},{"label":"Abr","value":757},{"label":"Mai","value":499},{"label":"Jun","value":742},{"label":"Jul","value":440},{"label":"Ago","value":575},{"label":"Set","value":740},{"label":"Out","value":367},{"label":"Nov","value":401},{"label":"Dez","value":727}];
const MX = 757;
