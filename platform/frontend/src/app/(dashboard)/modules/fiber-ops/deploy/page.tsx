...
const PAGE = "Deploy";
const KPIS = [{"l":"Total Fiber Ops","v":"6.717","t":"-4.3%","d":"down"},{"l":"Deploy Ativos","v":"3.593","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"88.2%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"58","t":"+9.8%","d":"up"}];
const COLS = ["ID","Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fiber Ops #001","Fiber Ops #002","4.392","5.534","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Fiber Ops #002","Fiber Ops #003","4.561","4.559","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Fiber Ops #003","Fiber Ops #004","7.894","1.457","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Fiber Ops #004","Fiber Ops #005","1.960","6.590","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fiber Ops #005","Fiber Ops #001","5.641","258","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":465},{"label":"Fev","value":478},{"label":"Mar","value":497},{"label":"Abr","value":625},{"label":"Mai","value":718},{"label":"Jun","value":452},{"label":"Jul","value":572},{"label":"Ago","value":369},{"label":"Set","value":568},{"label":"Out","value":637},{"label":"Nov","value":736},{"label":"Dez","value":631}];
const MX = 736;
