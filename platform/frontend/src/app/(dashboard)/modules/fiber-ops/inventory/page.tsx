...
const ACCENT = "#6366f1";
const MODULE = "Fiber Operations";
const PAGE = "Inventory";
const KPIS = [{"l":"Total Fiber Ops","v":"7.777","t":"+17.7%","d":"up"},{"l":"Inventory Ativos","v":"1.928","t":"+2.7%","d":"up"},{"l":"Eficiência (%)","v":"88.8%","t":"-2.8%","d":"down"},{"l":"Score Performance","v":"62","t":"+1.9%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fiber Ops #001","Fiber Ops #002","6.964","6.216","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Fiber Ops #002","Fiber Ops #003","7.249","3.309","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Fiber Ops #003","Fiber Ops #004","8.034","753","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Fiber Ops #004","Fiber Ops #005","3.015","3.786","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fiber Ops #005","Fiber Ops #001","2.509","5.495","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":560},{"label":"Mar","value":377},{"label":"Abr","value":658},{"label":"Mai","value":662},{"label":"Jun","value":568},{"label":"Jul","value":584},{"label":"Ago","value":405},{"label":"Set","value":357},{"label":"Out","value":608},{"label":"Nov","value":665},{"label":"Dez","value":352}];
const MX = 665;
