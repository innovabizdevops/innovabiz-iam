...
export default function FiberOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Fiber Ops</h1><p className="text-sm text-muted-foreground">Fiber Ops • iBOS Enterprise</p></div>
