...
const PAGE = "Program";
const KPIS = [{"l":"Ideias Submetidas","v":"883","t":"+8.0%","d":"up"},{"l":"Patentes (YTD)","v":"6.988","t":"+13.7%","d":"up"},{"l":"Projetos Innovation Lab","v":"8.044","t":"+8.6%","d":"up"},{"l":"Budget I&D (€M)","v":"€34.2M","t":"-0.1%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","2.780","84.4%","950","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.667","83.8%","7.822","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","2.351","71.0%","3.941","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.489","92.5%","4.250","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","9.036","96.3%","5.980","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":283},{"label":"Fev","value":581},{"label":"Mar","value":235},{"label":"Abr","value":607},{"label":"Mai","value":328},{"label":"Jun","value":561},{"label":"Jul","value":470},{"label":"Ago","value":356},{"label":"Set","value":361},{"label":"Out","value":358},{"label":"Nov","value":471},{"label":"Dez","value":248}];
const MX = 607;
