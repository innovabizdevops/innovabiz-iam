...
/* ═══ Defense Research — Dashboard ═══ */

const ACCENT = "#0f172a";

const KPIS = [
    { label: "Total Registos", value: "6923", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2862", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€101K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "504570223", cells: ["DEF-4223", "Defense Research Item 1", "4/8/2026", "€20 323"], status: "active" as const },
    { id: "504573794", cells: ["DEF-7794", "Defense Research Item 2", "19/3/2026", "€23 894"], status: "pending" as const },
    { id: "504577365", cells: ["DEF-2365", "Defense Research Item 3", "6/10/2026", "€27 465"], status: "completed" as const },
    { id: "504580936", cells: ["DEF-5936", "Defense Research Item 4", "21/5/2026", "€31 036"], status: "warning" as const },
    { id: "504584507", cells: ["DEF-9507", "Defense Research Item 5", "8/12/2026", "€34 607"], status: "active" as const },
];
...
export default function DefenseResearchPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Defense Research</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Defense Research</p>
                    </div>
                </div>
