...
const KPIS = [{"l":"Ideias Submetidas","v":"7.160","t":"+6.3%","d":"up"},{"l":"Patentes (YTD)","v":"8.075","t":"+11.9%","d":"up"},{"l":"Projetos Innovation Lab","v":"366","t":"+3.8%","d":"up"},{"l":"Budget I&D (€M)","v":"€10.8M","t":"+7.6%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","3.875","75.7%","7.848","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","5.192","99.4%","6.940","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","3.486","85.2%","9.025","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.764","86.2%","2.033","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","8.552","77.5%","2.587","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":520},{"label":"Mar","value":710},{"label":"Abr","value":787},{"label":"Mai","value":698},{"label":"Jun","value":473},{"label":"Jul","value":713},{"label":"Ago","value":708},{"label":"Set","value":419},{"label":"Out","value":636},{"label":"Nov","value":454},{"label":"Dez","value":751}];
const MX = 787;
