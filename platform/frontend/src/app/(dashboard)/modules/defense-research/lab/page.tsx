...
const PAGE = "Lab";
const KPIS = [{"l":"Ideias Submetidas","v":"4.717","t":"+7.8%","d":"up"},{"l":"Patentes (YTD)","v":"6.341","t":"+15.4%","d":"up"},{"l":"Projetos Innovation Lab","v":"5.561","t":"+11.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€26.9M","t":"+7.3%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","5.935","76.4%","6.337","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.635","77.8%","4.033","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","4.587","72.3%","7.528","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.394","72.8%","5.276","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","8.354","71.7%","425","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":689},{"label":"Fev","value":647},{"label":"Mar","value":748},{"label":"Abr","value":974},{"label":"Mai","value":946},{"label":"Jun","value":892},{"label":"Jul","value":946},{"label":"Ago","value":674},{"label":"Set","value":668},{"label":"Out","value":728},{"label":"Nov","value":703},{"label":"Dez","value":896}];
const MX = 974;
