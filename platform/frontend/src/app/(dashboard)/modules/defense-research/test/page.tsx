...
const ACCENT = "#0f172a";
const MODULE = "Defense Research";
const PAGE = "Test";
const KPIS = [{"l":"Ideias Submetidas","v":"7.242","t":"-3.6%","d":"down"},{"l":"Patentes (YTD)","v":"3.664","t":"-0.7%","d":"down"},{"l":"Projetos Innovation Lab","v":"241","t":"+15.9%","d":"up"},{"l":"Budget I&D (€M)","v":"€19.2M","t":"-5.9%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","5.045","81.8%","191","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.902","73.8%","7.299","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","5.001","75.4%","2.613","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.662","94.9%","5.856","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.378","75.3%","8.564","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":704},{"label":"Mar","value":931},{"label":"Abr","value":854},{"label":"Mai","value":898},{"label":"Jun","value":762},{"label":"Jul","value":743},{"label":"Ago","value":627},{"label":"Set","value":620},{"label":"Out","value":627},{"label":"Nov","value":958},{"label":"Dez","value":898}];
const MX = 958;
