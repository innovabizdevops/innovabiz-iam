...
const PAGE = "Transfer";
const KPIS = [{"l":"Ideias Submetidas","v":"1.618","t":"+14.6%","d":"up"},{"l":"Patentes (YTD)","v":"7.507","t":"-0.8%","d":"down"},{"l":"Projetos Innovation Lab","v":"6.921","t":"+7.9%","d":"up"},{"l":"Budget I&D (€M)","v":"€9.4M","t":"+4.2%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.098","88.8%","666","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","1.764","81.1%","3.889","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.469","91.3%","7.710","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.312","77.5%","8.320","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","3.493","95.4%","2.157","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":892},{"label":"Fev","value":682},{"label":"Mar","value":778},{"label":"Abr","value":701},{"label":"Mai","value":978},{"label":"Jun","value":978},{"label":"Jul","value":754},{"label":"Ago","value":601},{"label":"Set","value":724},{"label":"Out","value":683},{"label":"Nov","value":757},{"label":"Dez","value":691}];
const MX = 978;
