...
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"5.419","t":"+0.3%","d":"up"},{"l":"Valor Total (€M)","v":"€25.6M","t":"+16.7%","d":"up"},{"l":"Renovações Próx. 30d","v":"8.208","t":"+2.8%","d":"up"},{"l":"Obrigações Pendentes","v":"3.282","t":"-1.5%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 11001.97","2026-03-16","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 39356.40","2026-02-21","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 38112.89","2026-02-02","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 4308.99","2026-01-24","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 38142.25","2026-01-25","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":941},{"label":"Mar","value":857},{"label":"Abr","value":864},{"label":"Mai","value":747},{"label":"Jun","value":684},{"label":"Jul","value":813},{"label":"Ago","value":629},{"label":"Set","value":660},{"label":"Out","value":990},{"label":"Nov","value":977},{"label":"Dez","value":960}];
const MX = 990;
