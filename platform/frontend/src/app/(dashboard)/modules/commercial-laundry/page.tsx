...
/* ═══ Commercial Laundry — Dashboard ═══ */

const ACCENT = "#155e75";

const KPIS = [
    { label: "Total Registos", value: "6899", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1838", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€332K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1964998399", cells: ["COM-2399", "Commercial Laundry Item 1", "8/8/2026", "€48 499"], status: "active" as const },
    { id: "1965001970", cells: ["COM-5970", "Commercial Laundry Item 2", "23/3/2026", "€2070"], status: "pending" as const },
    { id: "1965005541", cells: ["COM-9541", "Commercial Laundry Item 3", "10/10/2026", "€5641"], status: "completed" as const },
    { id: "1965009112", cells: ["COM-4112", "Commercial Laundry Item 4", "25/5/2026", "€9212"], status: "warning" as const },
    { id: "1965012683", cells: ["COM-7683", "Commercial Laundry Item 5", "12/12/2026", "€12 783"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Commercial Laundry</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Commercial Laundry</p>
                    </div>
                </div>
