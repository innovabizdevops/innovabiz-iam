...
const PAGE = "IC Matching";
const KPIS = [{"l":"Atletas Registados","v":"6.966","t":"-2.9%","d":"down"},{"l":"Treinos/Semana","v":"4795","t":"-0.8%","d":"down"},{"l":"Competições","v":"9.076","t":"-4.9%","d":"down"},{"l":"Performance Score","v":"86","t":"+13.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.236","7.862","8.919","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","5.803","6.414","5.080","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.505","5.956","5.861","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.635","6.883","1.161","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.922","6.366","7.198","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":907},{"label":"Mar","value":882},{"label":"Abr","value":830},{"label":"Mai","value":728},{"label":"Jun","value":715},{"label":"Jul","value":744},{"label":"Ago","value":952},{"label":"Set","value":1032},{"label":"Out","value":658},{"label":"Nov","value":772},{"label":"Dez","value":944}];
const MX = 1032;
