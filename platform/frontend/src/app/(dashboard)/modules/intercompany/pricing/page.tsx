...
const KPIS = [{"l":"ARR (€M)","v":"€50.3M","t":"+9.5%","d":"up"},{"l":"MRR (€)","v":"€90104","t":"-4.8%","d":"down"},{"l":"Churn (%)","v":"87.8%","t":"+12.6%","d":"up"},{"l":"ARPU (€)","v":"€45538","t":"-1.7%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 26902.15","775","€ 12128.93","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 47125.07","5.503","€ 13130.14","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 4003.20","951","€ 27921.53","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 17321.73","4.131","€ 14711.59","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 39805.60","4.756","€ 18724.29","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":472},{"label":"Fev","value":572},{"label":"Mar","value":834},{"label":"Abr","value":678},{"label":"Mai","value":680},{"label":"Jun","value":818},{"label":"Jul","value":770},{"label":"Ago","value":674},{"label":"Set","value":753},{"label":"Out","value":664},{"label":"Nov","value":752},{"label":"Dez","value":715}];
const MX = 834;
