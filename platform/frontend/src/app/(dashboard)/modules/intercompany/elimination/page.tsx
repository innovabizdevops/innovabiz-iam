...
const PAGE = "Elimination";
const KPIS = [{"l":"Total Intercompany","v":"1.235","t":"+12.5%","d":"up"},{"l":"Elimination Ativos","v":"3.183","t":"+11.4%","d":"up"},{"l":"Eficiência (%)","v":"71.0%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"74","t":"+15.8%","d":"up"}];
const COLS = ["ID","Elimination","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Intercompany #001","Intercompany #002","3.992","4.651","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Intercompany #002","Intercompany #003","202","7.669","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Intercompany #003","Intercompany #004","189","1.804","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Intercompany #004","Intercompany #005","4.294","4.057","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Intercompany #005","Intercompany #001","5.126","1.256","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":797},{"label":"Mar","value":881},{"label":"Abr","value":638},{"label":"Mai","value":686},{"label":"Jun","value":831},{"label":"Jul","value":856},{"label":"Ago","value":672},{"label":"Set","value":500},{"label":"Out","value":710},{"label":"Nov","value":590},{"label":"Dez","value":874}];
const MX = 881;
