...
const PAGE = "Rule";
const KPIS = [{"l":"Aprovações Pendentes","v":"2.353","t":"+1.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"73.0%","t":"+12.2%","d":"up"},{"l":"Tempo Médio (h)","v":"169h","t":"+7.3%","d":"up"},{"l":"Rejeitadas (%)","v":"80.3%","t":"-5.8%","d":"down"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","1.227","€ 8334.55","8.108","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","5.864","€ 23343.30","6.551","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","2.811","€ 20229.00","1.371","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","8.050","€ 21381.04","779","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","828","€ 2479.85","2.285","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":260},{"label":"Fev","value":335},{"label":"Mar","value":572},{"label":"Abr","value":569},{"label":"Mai","value":617},{"label":"Jun","value":441},{"label":"Jul","value":453},{"label":"Ago","value":327},{"label":"Set","value":438},{"label":"Out","value":301},{"label":"Nov","value":397},{"label":"Dez","value":416}];
const MX = 617;
