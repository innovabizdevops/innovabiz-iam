...
const ACCENT = "#06b6d4";
const MODULE = "Decision Table Engine";
const PAGE = "Version";
const KPIS = [{"l":"Formulários Ativos","v":"5.200","t":"+15.4%","d":"up"},{"l":"Submissões/Dia","v":"4425","t":"+0.5%","d":"up"},{"l":"Documentos Gerados","v":"9.058","t":"+7.4%","d":"up"},{"l":"Templates","v":"280","t":"-1.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.963","2026-02-21","2.037","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","290","2026-02-16","6.384","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.653","2026-03-27","7.080","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.203","2026-03-25","7.887","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.407","2026-02-18","7.824","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":329},{"label":"Fev","value":385},{"label":"Mar","value":516},{"label":"Abr","value":322},{"label":"Mai","value":294},{"label":"Jun","value":453},{"label":"Jul","value":590},{"label":"Ago","value":479},{"label":"Set","value":442},{"label":"Out","value":464},{"label":"Nov","value":252},{"label":"Dez","value":274}];
const MX = 590;
