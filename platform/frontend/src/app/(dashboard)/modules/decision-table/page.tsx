...
/* ═══ Decision Table Engine — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "4932", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3245", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€408K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1681311932", cells: ["DEC-4932", "Decision Table Engine Item 1", "21/9/2026", "€12 032"], status: "active" as const },
    { id: "1681315503", cells: ["DEC-8503", "Decision Table Engine Item 2", "8/4/2026", "€15 603"], status: "pending" as const },
    { id: "1681319074", cells: ["DEC-3074", "Decision Table Engine Item 3", "23/11/2026", "€19 174"], status: "completed" as const },
    { id: "1681322645", cells: ["DEC-6645", "Decision Table Engine Item 4", "10/6/2026", "€22 745"], status: "warning" as const },
    { id: "1681326216", cells: ["DEC-1216", "Decision Table Engine Item 5", "25/1/2026", "€26 316"], status: "active" as const },
];
...
export default function DecisionTableEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Decision Table Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Decision Table Engine</p>
                    </div>
                </div>
