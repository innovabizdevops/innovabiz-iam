...
const PAGE = "Monitor";
const KPIS = [{"l":"Aprovações Pendentes","v":"3.926","t":"+11.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"85.1%","t":"-1.8%","d":"down"},{"l":"Tempo Médio (h)","v":"197h","t":"+11.7%","d":"up"},{"l":"Rejeitadas (%)","v":"66.2%","t":"+1.3%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","5.588","€ 29340.47","8.181","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","7.615","€ 20205.78","4.914","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","4.635","€ 13300.25","8.169","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","8.290","€ 21284.38","6.238","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","614","€ 42562.67","1.422","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":204},{"label":"Fev","value":218},{"label":"Mar","value":317},{"label":"Abr","value":255},{"label":"Mai","value":440},{"label":"Jun","value":415},{"label":"Jul","value":574},{"label":"Ago","value":467},{"label":"Set","value":420},{"label":"Out","value":318},{"label":"Nov","value":339},{"label":"Dez","value":289}];
const MX = 574;
