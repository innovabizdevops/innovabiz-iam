...
const PAGE = "Deploy";
const KPIS = [{"l":"Aprovações Pendentes","v":"6.200","t":"+5.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"89.1%","t":"+0.1%","d":"up"},{"l":"Tempo Médio (h)","v":"22h","t":"+13.6%","d":"up"},{"l":"Rejeitadas (%)","v":"74.3%","t":"+17.4%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","8.381","€ 13911.70","7.374","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","706","€ 42459.47","7.140","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","4.942","€ 16314.73","6.646","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","5.970","€ 43157.73","1.442","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","3.557","€ 6525.47","8.087","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":603},{"label":"Mar","value":422},{"label":"Abr","value":492},{"label":"Mai","value":510},{"label":"Jun","value":648},{"label":"Jul","value":403},{"label":"Ago","value":593},{"label":"Set","value":347},{"label":"Out","value":511},{"label":"Nov","value":395},{"label":"Dez","value":520}];
const MX = 650;
