...
const PAGE = "Test";
const KPIS = [{"l":"Aprovações Pendentes","v":"3.621","t":"+10.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"68.7%","t":"+6.3%","d":"up"},{"l":"Tempo Médio (h)","v":"44h","t":"+14.4%","d":"up"},{"l":"Rejeitadas (%)","v":"79.3%","t":"+17.8%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","3.518","€ 21553.21","6.467","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","5.212","€ 28267.05","1.864","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","655","€ 11286.84","579","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","4.177","€ 42075.59","5.874","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","2.365","€ 27786.41","327","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":621},{"label":"Mar","value":623},{"label":"Abr","value":468},{"label":"Mai","value":455},{"label":"Jun","value":421},{"label":"Jul","value":484},{"label":"Ago","value":389},{"label":"Set","value":465},{"label":"Out","value":654},{"label":"Nov","value":537},{"label":"Dez","value":515}];
const MX = 732;
