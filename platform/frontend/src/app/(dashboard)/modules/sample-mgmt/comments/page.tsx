...
const PAGE = "Comment Log";
const KPIS = [{"l":"Total Sample Mgmt","v":"159","t":"-4.2%","d":"down"},{"l":"Comment Log Ativos","v":"3.312","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"92.9%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"68","t":"-3.7%","d":"down"}];
const COLS = ["ID","Comment Log","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sample Mgmt #001","Sample Mgmt #002","4.400","487","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Sample Mgmt #002","Sample Mgmt #003","4.635","2.830","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Sample Mgmt #003","Sample Mgmt #004","2.416","639","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Sample Mgmt #004","Sample Mgmt #005","4.723","5.728","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sample Mgmt #005","Sample Mgmt #001","8.758","3.073","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":790},{"label":"Fev","value":665},{"label":"Mar","value":440},{"label":"Abr","value":526},{"label":"Mai","value":517},{"label":"Jun","value":444},{"label":"Jul","value":458},{"label":"Ago","value":593},{"label":"Set","value":589},{"label":"Out","value":632},{"label":"Nov","value":449},{"label":"Dez","value":607}];
const MX = 790;
