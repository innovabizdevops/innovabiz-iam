...
const PAGE = "Approval";
const KPIS = [{"l":"Aprovações Pendentes","v":"5.284","t":"+5.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"71.6%","t":"+9.2%","d":"up"},{"l":"Tempo Médio (h)","v":"54h","t":"+8.3%","d":"up"},{"l":"Rejeitadas (%)","v":"80.5%","t":"+11.2%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","3.029","€ 38009.75","4.745","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","1.664","€ 9553.50","3.585","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","8.284","€ 6254.62","1.276","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","3.219","€ 39844.22","7.686","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","3.070","€ 22099.52","5.352","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":498},{"label":"Mar","value":686},{"label":"Abr","value":530},{"label":"Mai","value":339},{"label":"Jun","value":460},{"label":"Jul","value":592},{"label":"Ago","value":356},{"label":"Set","value":496},{"label":"Out","value":607},{"label":"Nov","value":486},{"label":"Dez","value":710}];
const MX = 710;
