...
const PAGE = "Photo Studio";
const KPIS = [{"l":"Total Sample Mgmt","v":"2.427","t":"-3.9%","d":"down"},{"l":"Photo Studio Ativos","v":"7.561","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"66.9%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"90","t":"+15.2%","d":"up"}];
const COLS = ["ID","Photo Studio","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sample Mgmt #001","Sample Mgmt #002","7.472","405","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Sample Mgmt #002","Sample Mgmt #003","5.484","2.517","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Sample Mgmt #003","Sample Mgmt #004","4.187","4.014","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Sample Mgmt #004","Sample Mgmt #005","6.399","7.911","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sample Mgmt #005","Sample Mgmt #001","968","7.509","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":496},{"label":"Mar","value":514},{"label":"Abr","value":652},{"label":"Mai","value":817},{"label":"Jun","value":545},{"label":"Jul","value":531},{"label":"Ago","value":441},{"label":"Set","value":791},{"label":"Out","value":729},{"label":"Nov","value":535},{"label":"Dez","value":748}];
const MX = 817;
