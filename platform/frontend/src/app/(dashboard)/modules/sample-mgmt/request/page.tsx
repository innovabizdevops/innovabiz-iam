...
const ACCENT = "#0e7490";
const MODULE = "Sample Management";
const PAGE = "Sample Request";
const KPIS = [{"l":"Total Sample Mgmt","v":"8.268","t":"+16.2%","d":"up"},{"l":"Sample Request Ativos","v":"4.591","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"70.1%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"92","t":"+4.1%","d":"up"}];
const COLS = ["ID","Sample Request","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sample Mgmt #001","Sample Mgmt #002","7.853","3.668","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Sample Mgmt #002","Sample Mgmt #003","8.083","3.804","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Sample Mgmt #003","Sample Mgmt #004","7.973","5.137","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Sample Mgmt #004","Sample Mgmt #005","2.751","5.393","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sample Mgmt #005","Sample Mgmt #001","816","4.929","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":371},{"label":"Fev","value":472},{"label":"Mar","value":465},{"label":"Abr","value":610},{"label":"Mai","value":573},{"label":"Jun","value":608},{"label":"Jul","value":643},{"label":"Ago","value":363},{"label":"Set","value":564},{"label":"Out","value":418},{"label":"Nov","value":451},{"label":"Dez","value":592}];
const MX = 643;
