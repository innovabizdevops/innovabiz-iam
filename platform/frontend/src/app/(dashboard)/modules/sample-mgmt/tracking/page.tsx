...
const PAGE = "Tracking";
const KPIS = [{"l":"Total Sample Mgmt","v":"7.345","t":"+7.2%","d":"up"},{"l":"Tracking Ativos","v":"6.376","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"81.9%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"63","t":"-4.6%","d":"down"}];
const COLS = ["ID","Tracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sample Mgmt #001","Sample Mgmt #002","4.706","145","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Sample Mgmt #002","Sample Mgmt #003","4.880","4.090","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Sample Mgmt #003","Sample Mgmt #004","7.510","7.607","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Sample Mgmt #004","Sample Mgmt #005","118","3.527","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sample Mgmt #005","Sample Mgmt #001","7.507","3.781","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":501},{"label":"Mar","value":584},{"label":"Abr","value":371},{"label":"Mai","value":358},{"label":"Jun","value":347},{"label":"Jul","value":333},{"label":"Ago","value":655},{"label":"Set","value":317},{"label":"Out","value":649},{"label":"Nov","value":508},{"label":"Dez","value":485}];
const MX = 655;
