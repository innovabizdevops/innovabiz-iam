...
const ACCENT = "#78350f";
const MODULE = "Gene Therapy Platform";
const PAGE = "Vector Design";
const KPIS = [{"l":"Formulários Ativos","v":"8.239","t":"-5.3%","d":"down"},{"l":"Submissões/Dia","v":"4027","t":"-4.7%","d":"down"},{"l":"Documentos Gerados","v":"667","t":"+14.9%","d":"up"},{"l":"Templates","v":"8.011","t":"-5.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.651","2026-03-26","8.335","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","102","2026-01-18","3.584","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.257","2026-01-21","5.337","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","225","2026-02-19","5.238","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.243","2026-02-17","3.890","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":851},{"label":"Mar","value":795},{"label":"Abr","value":667},{"label":"Mai","value":883},{"label":"Jun","value":940},{"label":"Jul","value":896},{"label":"Ago","value":669},{"label":"Set","value":1041},{"label":"Out","value":681},{"label":"Nov","value":1017},{"label":"Dez","value":997}];
const MX = 1041;
