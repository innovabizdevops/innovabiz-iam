...
const KPIS = [{"l":"Total Gene Therapy","v":"3.938","t":"+16.0%","d":"up"},{"l":"Patient Select Ativos","v":"1.944","t":"+6.6%","d":"up"},{"l":"Eficiência (%)","v":"66.4%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"67","t":"+5.7%","d":"up"}];
const COLS = ["ID","Patient Select","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gene Therapy #001","Gene Therapy #002","7.924","1.030","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Gene Therapy #002","Gene Therapy #003","4.896","3.474","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Gene Therapy #003","Gene Therapy #004","4.666","7.447","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Gene Therapy #004","Gene Therapy #005","6.877","397","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gene Therapy #005","Gene Therapy #001","4.892","6.524","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1043},{"label":"Fev","value":693},{"label":"Mar","value":849},{"label":"Abr","value":809},{"label":"Mai","value":923},{"label":"Jun","value":998},{"label":"Jul","value":828},{"label":"Ago","value":709},{"label":"Set","value":959},{"label":"Out","value":890},{"label":"Nov","value":840},{"label":"Dez","value":978}];
const MX = 1043;
