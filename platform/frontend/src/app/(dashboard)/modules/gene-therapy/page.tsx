...
export default function GeneTherapyPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Gene Therapy</h1><p className="text-sm text-muted-foreground">Gene Therapy • iBOS Enterprise</p></div>
