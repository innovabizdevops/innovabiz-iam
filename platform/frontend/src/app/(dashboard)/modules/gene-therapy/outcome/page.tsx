...
const PAGE = "Outcome Track";
const KPIS = [{"l":"Total Gene Therapy","v":"844","t":"+16.2%","d":"up"},{"l":"Outcome Track Ativos","v":"5.065","t":"-4.0%","d":"down"},{"l":"Eficiência (%)","v":"81.4%","t":"+7.2%","d":"up"},{"l":"Score Performance","v":"74","t":"+12.5%","d":"up"}];
const COLS = ["ID","Outcome Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gene Therapy #001","Gene Therapy #002","1.155","2.811","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Gene Therapy #002","Gene Therapy #003","8.655","4.800","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Gene Therapy #003","Gene Therapy #004","6.392","1.504","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Gene Therapy #004","Gene Therapy #005","5.119","9.062","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gene Therapy #005","Gene Therapy #001","6.852","6.433","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":442},{"label":"Fev","value":671},{"label":"Mar","value":387},{"label":"Abr","value":438},{"label":"Mai","value":686},{"label":"Jun","value":677},{"label":"Jul","value":541},{"label":"Ago","value":655},{"label":"Set","value":676},{"label":"Out","value":533},{"label":"Nov","value":560},{"label":"Dez","value":611}];
const MX = 686;
