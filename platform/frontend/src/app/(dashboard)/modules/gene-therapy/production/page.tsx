...
const KPIS = [{"l":"Total Gene Therapy","v":"634","t":"-2.0%","d":"down"},{"l":"Production Ativos","v":"5.667","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"70.8%","t":"+4.3%","d":"up"},{"l":"Score Performance","v":"76","t":"+8.8%","d":"up"}];
const COLS = ["ID","Production","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gene Therapy #001","Gene Therapy #002","4.361","4.547","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Gene Therapy #002","Gene Therapy #003","973","8.982","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Gene Therapy #003","Gene Therapy #004","195","6.960","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Gene Therapy #004","Gene Therapy #005","8.118","328","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gene Therapy #005","Gene Therapy #001","594","7.992","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":905},{"label":"Mar","value":803},{"label":"Abr","value":615},{"label":"Mai","value":693},{"label":"Jun","value":917},{"label":"Jul","value":678},{"label":"Ago","value":875},{"label":"Set","value":932},{"label":"Out","value":836},{"label":"Nov","value":775},{"label":"Dez","value":642}];
const MX = 932;
