...
const PAGE = "Stylist Schedule";
const KPIS = [{"l":"Quartos Ocupados","v":"6.837","t":"+3.9%","d":"up"},{"l":"RevPAR (€)","v":"€77183","t":"+3.4%","d":"up"},{"l":"Ocupação (%)","v":"75.1%","t":"+1.9%","d":"up"},{"l":"Guest Satisfaction","v":"3.138","t":"+15.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.041","2026-02-15","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","930","2026-03-16","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.083","2026-01-04","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.315","2026-01-26","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.169","2026-01-15","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":390},{"label":"Mar","value":690},{"label":"Abr","value":561},{"label":"Mai","value":626},{"label":"Jun","value":438},{"label":"Jul","value":425},{"label":"Ago","value":730},{"label":"Set","value":450},{"label":"Out","value":558},{"label":"Nov","value":476},{"label":"Dez","value":513}];
const MX = 730;
