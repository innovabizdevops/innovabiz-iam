...
const KPIS = [{"l":"Vendas YTD (€)","v":"€92196","t":"+8.9%","d":"up"},{"l":"Pipeline (€)","v":"€5081","t":"+3.5%","d":"up"},{"l":"Atingimento Quota (%)","v":"80.8%","t":"+7.0%","d":"up"},{"l":"Win Rate (%)","v":"78.7%","t":"-2.5%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 22093.61","€ 30570.10","€ 36404.10","94.1%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 4391.37","€ 20502.95","€ 4704.63","85.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 11402.46","€ 35188.50","€ 18685.29","87.1%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 27645.54","€ 33352.40","€ 3213.62","82.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 43038.81","€ 42466.54","€ 35038.94","77.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":673},{"label":"Mar","value":443},{"label":"Abr","value":588},{"label":"Mai","value":479},{"label":"Jun","value":599},{"label":"Jul","value":642},{"label":"Ago","value":505},{"label":"Set","value":545},{"label":"Out","value":716},{"label":"Nov","value":730},{"label":"Dez","value":502}];
const MX = 730;
