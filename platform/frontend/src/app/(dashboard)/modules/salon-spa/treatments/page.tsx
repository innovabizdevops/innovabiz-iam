...
const PAGE = "Treatment Menu";
const KPIS = [{"l":"Quartos Ocupados","v":"8.088","t":"-1.8%","d":"down"},{"l":"RevPAR (€)","v":"€79695","t":"+13.1%","d":"up"},{"l":"Ocupação (%)","v":"68.0%","t":"+9.6%","d":"up"},{"l":"Guest Satisfaction","v":"2.732","t":"+13.9%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.489","2026-02-03","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.584","2026-01-20","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.012","2026-02-07","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.900","2026-03-07","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.964","2026-01-28","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":915},{"label":"Fev","value":1085},{"label":"Mar","value":1031},{"label":"Abr","value":869},{"label":"Mai","value":1081},{"label":"Jun","value":968},{"label":"Jul","value":805},{"label":"Ago","value":980},{"label":"Set","value":848},{"label":"Out","value":926},{"label":"Nov","value":703},{"label":"Dez","value":873}];
const MX = 1085;
