...
const KPIS = [{"l":"Quartos Ocupados","v":"3.866","t":"+9.0%","d":"up"},{"l":"RevPAR (€)","v":"€61257","t":"-1.8%","d":"down"},{"l":"Ocupação (%)","v":"87.9%","t":"+1.5%","d":"up"},{"l":"Guest Satisfaction","v":"5.016","t":"+15.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","5.646","2026-02-07","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.212","2026-02-17","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","4.847","2026-02-23","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.074","2026-02-01","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.255","2026-02-28","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":832},{"label":"Mar","value":867},{"label":"Abr","value":624},{"label":"Mai","value":595},{"label":"Jun","value":920},{"label":"Jul","value":675},{"label":"Ago","value":558},{"label":"Set","value":658},{"label":"Out","value":621},{"label":"Nov","value":760},{"label":"Dez","value":585}];
const MX = 920;
