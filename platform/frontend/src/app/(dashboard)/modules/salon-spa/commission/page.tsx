...
const ACCENT = "#c026d3";
const MODULE = "Salon & Spa";
const PAGE = "Commission Calc";
const KPIS = [{"l":"Vendas YTD (€)","v":"€82622","t":"+8.5%","d":"up"},{"l":"Pipeline (€)","v":"€85208","t":"+0.8%","d":"up"},{"l":"Atingimento Quota (%)","v":"91.2%","t":"-5.0%","d":"down"},{"l":"Win Rate (%)","v":"74.3%","t":"+13.1%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 9183.98","€ 2413.01","€ 11244.67","95.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 36527.91","€ 21880.09","€ 18342.32","79.3%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 42284.54","€ 48010.46","€ 48326.13","99.1%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 15595.96","€ 1908.16","€ 8172.71","81.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 5766.09","€ 2683.61","€ 46764.42","84.3%"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":955},{"label":"Mar","value":892},{"label":"Abr","value":1061},{"label":"Mai","value":910},{"label":"Jun","value":967},{"label":"Jul","value":837},{"label":"Ago","value":985},{"label":"Set","value":852},{"label":"Out","value":1064},{"label":"Nov","value":827},{"label":"Dez","value":976}];
const MX = 1064;
