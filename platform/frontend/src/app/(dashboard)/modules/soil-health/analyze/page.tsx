...
const ACCENT = "#166534";
const MODULE = "Soil Health Platform";
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"4.961","t":"+11.1%","d":"up"},{"l":"Queries/Dia","v":"4612","t":"+7.5%","d":"up"},{"l":"Dados Processados (GB)","v":"6.793","t":"+10.0%","d":"up"},{"l":"Utilizadores Analytics","v":"8.426","t":"+0.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","159","2026-01-06","7.135","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","742","2026-02-12","6.808","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1981","2026-01-16","1.605","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2144","2026-03-09","2.037","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3272","2026-01-13","8.825","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":715},{"label":"Fev","value":550},{"label":"Mar","value":844},{"label":"Abr","value":595},{"label":"Mai","value":580},{"label":"Jun","value":819},{"label":"Jul","value":648},{"label":"Ago","value":727},{"label":"Set","value":916},{"label":"Out","value":631},{"label":"Nov","value":701},{"label":"Dez","value":859}];
const MX = 916;
