...
const PAGE = "Test";
const KPIS = [{"l":"Total Soil Health","v":"1.814","t":"+9.9%","d":"up"},{"l":"Test Ativos","v":"5.147","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"77.6%","t":"+6.8%","d":"up"},{"l":"Score Performance","v":"64","t":"+12.0%","d":"up"}];
const COLS = ["ID","Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Soil Health #001","Soil Health #002","4.961","737","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Soil Health #002","Soil Health #003","433","4.955","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Soil Health #003","Soil Health #004","6.750","1.905","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Soil Health #004","Soil Health #005","1.668","3.270","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Soil Health #005","Soil Health #001","5.789","756","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":452},{"label":"Fev","value":648},{"label":"Mar","value":534},{"label":"Abr","value":460},{"label":"Mai","value":503},{"label":"Jun","value":490},{"label":"Jul","value":374},{"label":"Ago","value":560},{"label":"Set","value":627},{"label":"Out","value":381},{"label":"Nov","value":368},{"label":"Dez","value":622}];
const MX = 648;
