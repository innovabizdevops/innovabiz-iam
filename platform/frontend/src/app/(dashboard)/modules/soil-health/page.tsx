...
/* ═══ Soil Health Platform — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "2047", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2490", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€474K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "56857647", cells: ["SOI-5647", "Soil Health Platform Item 1", "8/4/2026", "€7747"], status: "active" as const },
    { id: "56861218", cells: ["SOI-9218", "Soil Health Platform Item 2", "23/11/2026", "€11 318"], status: "pending" as const },
    { id: "56864789", cells: ["SOI-3789", "Soil Health Platform Item 3", "10/6/2026", "€14 889"], status: "completed" as const },
    { id: "56868360", cells: ["SOI-7360", "Soil Health Platform Item 4", "25/1/2026", "€18 460"], status: "warning" as const },
    { id: "56871931", cells: ["SOI-1931", "Soil Health Platform Item 5", "12/8/2026", "€22 031"], status: "active" as const },
];
...
export default function SoilHealthPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Soil Health Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Soil Health Platform</p>
                    </div>
                </div>
