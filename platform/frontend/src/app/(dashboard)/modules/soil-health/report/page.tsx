...
const PAGE = "Report";
const KPIS = [{"l":"Total Soil Health","v":"8.690","t":"+1.8%","d":"up"},{"l":"Report Ativos","v":"6.957","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"93.8%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"90","t":"+4.6%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Soil Health #001","Soil Health #002","1.590","548","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Soil Health #002","Soil Health #003","2.098","2.089","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Soil Health #003","Soil Health #004","2.333","7.719","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Soil Health #004","Soil Health #005","6.530","6.535","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Soil Health #005","Soil Health #001","256","5.486","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":470},{"label":"Mar","value":543},{"label":"Abr","value":482},{"label":"Mai","value":629},{"label":"Jun","value":787},{"label":"Jul","value":639},{"label":"Ago","value":623},{"label":"Set","value":781},{"label":"Out","value":700},{"label":"Nov","value":595},{"label":"Dez","value":564}];
const MX = 787;
