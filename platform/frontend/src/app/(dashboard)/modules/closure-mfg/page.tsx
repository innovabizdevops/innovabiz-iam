...
/* ═══ Closure Manufacturing — Dashboard ═══ */

const ACCENT = "#facc15";

const KPIS = [
    { label: "Total Registos", value: "419", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2200", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€242K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "980842819", cells: ["CLO-5819", "Closure Manufacturing Item 1", "20/8/2026", "€42 919"], status: "active" as const },
    { id: "980846390", cells: ["CLO-9390", "Closure Manufacturing Item 2", "7/3/2026", "€46 490"], status: "pending" as const },
    { id: "980849961", cells: ["CLO-3961", "Closure Manufacturing Item 3", "22/10/2026", "€50 061"], status: "completed" as const },
    { id: "980853532", cells: ["CLO-7532", "Closure Manufacturing Item 4", "9/5/2026", "€3632"], status: "warning" as const },
    { id: "980857103", cells: ["CLO-2103", "Closure Manufacturing Item 5", "24/12/2026", "€7203"], status: "active" as const },
];
...
export default function ClosureManufacturingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Closure Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Closure Manufacturing</p>
                    </div>
                </div>
