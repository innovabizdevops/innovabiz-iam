...
const ACCENT = "#ec4899";
const MODULE = "Ice Cream Manufacturing";
const PAGE = "Pack";
const KPIS = [{"l":"Total Ice Cream Mfg","v":"127","t":"+15.7%","d":"up"},{"l":"Pack Ativos","v":"9.093","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"75.5%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"91","t":"-0.1%","d":"down"}];
const COLS = ["ID","Pack","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ice Cream Mfg #001","Ice Cream Mfg #002","2.705","7.315","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Ice Cream Mfg #002","Ice Cream Mfg #003","2.045","4.220","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Ice Cream Mfg #003","Ice Cream Mfg #004","1.794","4.209","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Ice Cream Mfg #004","Ice Cream Mfg #005","5.443","4.988","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ice Cream Mfg #005","Ice Cream Mfg #001","5.187","7.772","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":359},{"label":"Mar","value":532},{"label":"Abr","value":632},{"label":"Mai","value":380},{"label":"Jun","value":552},{"label":"Jul","value":405},{"label":"Ago","value":502},{"label":"Set","value":472},{"label":"Out","value":491},{"label":"Nov","value":329},{"label":"Dez","value":541}];
const MX = 632;
