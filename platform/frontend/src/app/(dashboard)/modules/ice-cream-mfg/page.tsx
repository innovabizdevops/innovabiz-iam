...
const KPIS = [
    { label: "Total Registos", value: "1716", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2767", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€416K", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "669182216", cells: ["ICE-6216", "Ice Cream Manufacturing Item 1", "25/9/2026", "€32 316"], status: "active" as const },
    { id: "669185787", cells: ["ICE-9787", "Ice Cream Manufacturing Item 2", "12/4/2026", "€35 887"], status: "pending" as const },
    { id: "669189358", cells: ["ICE-4358", "Ice Cream Manufacturing Item 3", "27/11/2026", "€39 458"], status: "completed" as const },
    { id: "669192929", cells: ["ICE-7929", "Ice Cream Manufacturing Item 4", "14/6/2026", "€43 029"], status: "warning" as const },
    { id: "669196500", cells: ["ICE-2500", "Ice Cream Manufacturing Item 5", "1/1/2026", "€46 600"], status: "active" as const },
];
...
export default function IceCreamManufacturingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ice Cream Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Ice Cream Manufacturing</p>
                    </div>
                </div>
