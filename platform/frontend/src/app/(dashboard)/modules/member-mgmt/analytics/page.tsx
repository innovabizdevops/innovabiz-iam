...
const ACCENT = "#e11d48";
const MODULE = "Membership Management";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"8.124","t":"+3.3%","d":"up"},{"l":"Queries/Dia","v":"2837","t":"+5.7%","d":"up"},{"l":"Dados Processados (GB)","v":"4.038","t":"-1.3%","d":"down"},{"l":"Utilizadores Analytics","v":"7.001","t":"+1.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2335","2026-01-18","8.436","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2621","2026-02-20","4.355","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1842","2026-01-26","6.439","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4413","2026-02-05","7.421","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4072","2026-03-18","3.523","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":489},{"label":"Fev","value":475},{"label":"Mar","value":461},{"label":"Abr","value":348},{"label":"Mai","value":272},{"label":"Jun","value":295},{"label":"Jul","value":216},{"label":"Ago","value":305},{"label":"Set","value":525},{"label":"Out","value":287},{"label":"Nov","value":241},{"label":"Dez","value":354}];
const MX = 525;
