...
const KPIS = [
    { label: "Total Registos", value: "4905", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2744", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€477K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1388697605", cells: ["MEM-7605", "Membership Management Item 1", "2/6/2026", "€47 705"], status: "active" as const },
    { id: "1388701176", cells: ["MEM-2176", "Membership Management Item 2", "17/1/2026", "€1276"], status: "pending" as const },
    { id: "1388704747", cells: ["MEM-5747", "Membership Management Item 3", "4/8/2026", "€4847"], status: "completed" as const },
    { id: "1388708318", cells: ["MEM-9318", "Membership Management Item 4", "19/3/2026", "€8418"], status: "warning" as const },
    { id: "1388711889", cells: ["MEM-3889", "Membership Management Item 5", "6/10/2026", "€11 989"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Membership Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Membership Management</p>
                    </div>
                </div>
