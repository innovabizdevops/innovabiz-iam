...
const PAGE = "Join";
const KPIS = [{"l":"Total Member Mgmt","v":"6.248","t":"+4.6%","d":"up"},{"l":"Join Ativos","v":"4.813","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"73.1%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"67","t":"+15.2%","d":"up"}];
const COLS = ["ID","Join","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Member Mgmt #001","Member Mgmt #002","4.520","397","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Member Mgmt #002","Member Mgmt #003","4.352","1.177","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Member Mgmt #003","Member Mgmt #004","1.469","2.133","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Member Mgmt #004","Member Mgmt #005","1.110","8.737","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Member Mgmt #005","Member Mgmt #001","6.238","8.751","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":369},{"label":"Mar","value":346},{"label":"Abr","value":289},{"label":"Mai","value":629},{"label":"Jun","value":263},{"label":"Jul","value":587},{"label":"Ago","value":485},{"label":"Set","value":581},{"label":"Out","value":513},{"label":"Nov","value":547},{"label":"Dez","value":456}];
const MX = 629;
