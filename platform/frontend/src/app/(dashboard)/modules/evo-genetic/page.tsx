...
/* ═══ EVO Genetic Algorithm Engine — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "4583", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "740", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€486K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1665748783", cells: ["EVO-2783", "EVO Genetic Algorithm Engine Item 1", "28/8/2026", "€48 883"], status: "active" as const },
    { id: "1665752354", cells: ["EVO-6354", "EVO Genetic Algorithm Engine Item 2", "15/3/2026", "€2454"], status: "pending" as const },
    { id: "1665755925", cells: ["EVO-9925", "EVO Genetic Algorithm Engine Item 3", "2/10/2026", "€6025"], status: "completed" as const },
    { id: "1665759496", cells: ["EVO-4496", "EVO Genetic Algorithm Engine Item 4", "17/5/2026", "€9596"], status: "warning" as const },
    { id: "1665763067", cells: ["EVO-8067", "EVO Genetic Algorithm Engine Item 5", "4/12/2026", "€13 167"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 83 }, { label: "Fev", value: 92 }, { label: "Mar", value: 21 }, { label: "Abr", value: 30 }, { label: "Mai", value: 39 }, { label: "Jun", value: 48 }];
...
export default function EvoGeneticAlgorithmEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EVO Genetic Algorithm Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EVO Genetic Algorithm Engine</p>
                    </div>
                </div>
