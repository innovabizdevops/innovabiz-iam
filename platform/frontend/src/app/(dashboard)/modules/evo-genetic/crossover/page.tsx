...
const PAGE = "Crossover";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.461","t":"+14.5%","d":"up"},{"l":"Sessões/Dia","v":"4496","t":"+17.3%","d":"up"},{"l":"MFA Adoção (%)","v":"91.8%","t":"+14.6%","d":"up"},{"l":"Tentativas Bloqueadas","v":"6.906","t":"+12.9%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","5.440","3.524","6.077","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","4.953","1.309","8.999","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","1.039","1.142","5.885","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.472","450","8.116","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","710","5.971","3.055","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":988},{"label":"Mar","value":926},{"label":"Abr","value":1045},{"label":"Mai","value":720},{"label":"Jun","value":812},{"label":"Jul","value":694},{"label":"Ago","value":702},{"label":"Set","value":921},{"label":"Out","value":843},{"label":"Nov","value":954},{"label":"Dez","value":699}];
const MX = 1045;
