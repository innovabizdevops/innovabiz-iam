...
const KPIS = [{"l":"Auditorias Realizadas","v":"4.472","t":"+11.4%","d":"up"},{"l":"NC Abertas","v":"235","t":"+11.8%","d":"up"},{"l":"Conformidade (%)","v":"80.8%","t":"-1.6%","d":"down"},{"l":"CAPAs Pendentes","v":"1.168","t":"+14.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.959","90.3%","8.801","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.647","78.5%","5.193","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.538","99.5%","5.060","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.799","79.3%","138","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.895","95.0%","5.309","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":779},{"label":"Fev","value":568},{"label":"Mar","value":597},{"label":"Abr","value":643},{"label":"Mai","value":633},{"label":"Jun","value":731},{"label":"Jul","value":853},{"label":"Ago","value":838},{"label":"Set","value":774},{"label":"Out","value":585},{"label":"Nov","value":585},{"label":"Dez","value":856}];
const MX = 856;
