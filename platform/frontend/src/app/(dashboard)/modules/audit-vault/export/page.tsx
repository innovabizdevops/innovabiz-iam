...
const PAGE = "Export &amp; Archive";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.881","t":"+17.4%","d":"up"},{"l":"NC Abertas","v":"8.968","t":"+2.8%","d":"up"},{"l":"Conformidade (%)","v":"91.7%","t":"+2.2%","d":"up"},{"l":"CAPAs Pendentes","v":"2.006","t":"-2.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.255","80.2%","6.582","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.815","90.7%","2.444","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","775","99.3%","6.000","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.730","95.5%","774","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.160","73.1%","4.357","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":885},{"label":"Mar","value":657},{"label":"Abr","value":777},{"label":"Mai","value":854},{"label":"Jun","value":555},{"label":"Jul","value":593},{"label":"Ago","value":580},{"label":"Set","value":777},{"label":"Out","value":778},{"label":"Nov","value":780},{"label":"Dez","value":820}];
const MX = 885;
