...
const ACCENT = "#1e3a5f";
const MODULE = "Audit Vault";
const PAGE = "Retention Policy";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.220","t":"-0.6%","d":"down"},{"l":"NC Abertas","v":"2.433","t":"+16.9%","d":"up"},{"l":"Conformidade (%)","v":"72.9%","t":"+3.2%","d":"up"},{"l":"CAPAs Pendentes","v":"2.240","t":"+8.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","9.077","97.8%","2.724","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.793","87.7%","2.538","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.018","97.9%","8.751","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.265","78.4%","8.871","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.148","73.3%","3.750","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":766},{"label":"Mar","value":507},{"label":"Abr","value":663},{"label":"Mai","value":737},{"label":"Jun","value":500},{"label":"Jul","value":502},{"label":"Ago","value":668},{"label":"Set","value":473},{"label":"Out","value":559},{"label":"Nov","value":589},{"label":"Dez","value":666}];
const MX = 766;
