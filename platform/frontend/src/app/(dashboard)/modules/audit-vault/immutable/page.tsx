...
const PAGE = "Immutable Log";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.500","t":"+17.5%","d":"up"},{"l":"NC Abertas","v":"1.966","t":"-1.2%","d":"down"},{"l":"Conformidade (%)","v":"81.3%","t":"-1.9%","d":"down"},{"l":"CAPAs Pendentes","v":"8.301","t":"+3.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.700","86.7%","6.967","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.847","98.7%","6.522","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.978","78.4%","6.934","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","861","77.2%","1.385","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.785","84.2%","319","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":785},{"label":"Fev","value":830},{"label":"Mar","value":641},{"label":"Abr","value":701},{"label":"Mai","value":499},{"label":"Jun","value":779},{"label":"Jul","value":726},{"label":"Ago","value":699},{"label":"Set","value":770},{"label":"Out","value":824},{"label":"Nov","value":784},{"label":"Dez","value":743}];
const MX = 830;
