...
const PAGE = "Rights";
const KPIS = [{"l":"Total Syndication","v":"1.249","t":"+2.1%","d":"up"},{"l":"Rights Ativos","v":"3.786","t":"+0.4%","d":"up"},{"l":"Eficiência (%)","v":"79.5%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"92","t":"+14.9%","d":"up"}];
const COLS = ["ID","Rights","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Syndication #001","Syndication #002","2.076","2.263","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Syndication #002","Syndication #003","814","5.069","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Syndication #003","Syndication #004","1.676","2.947","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Syndication #004","Syndication #005","5.960","3.465","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Syndication #005","Syndication #001","590","1.314","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":837},{"label":"Fev","value":941},{"label":"Mar","value":629},{"label":"Abr","value":879},{"label":"Mai","value":904},{"label":"Jun","value":870},{"label":"Jul","value":608},{"label":"Ago","value":656},{"label":"Set","value":588},{"label":"Out","value":977},{"label":"Nov","value":882},{"label":"Dez","value":904}];
const MX = 977;
