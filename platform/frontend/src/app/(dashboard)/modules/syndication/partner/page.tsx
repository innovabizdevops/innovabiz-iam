...
const PAGE = "Partner";
const KPIS = [{"l":"Total Syndication","v":"8.229","t":"-2.5%","d":"down"},{"l":"Partner Ativos","v":"7.845","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"84.2%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"56","t":"+4.1%","d":"up"}];
const COLS = ["ID","Partner","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Syndication #001","Syndication #002","4.858","9.006","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Syndication #002","Syndication #003","186","1.675","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Syndication #003","Syndication #004","5.346","2.924","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Syndication #004","Syndication #005","6.148","5.643","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Syndication #005","Syndication #001","743","5.292","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":446},{"label":"Fev","value":511},{"label":"Mar","value":640},{"label":"Abr","value":492},{"label":"Mai","value":333},{"label":"Jun","value":654},{"label":"Jul","value":401},{"label":"Ago","value":539},{"label":"Set","value":717},{"label":"Out","value":619},{"label":"Nov","value":341},{"label":"Dez","value":484}];
const MX = 717;
