...
const ACCENT = "#6366f1";
const MODULE = "Content Syndication";
const PAGE = "Feed Mgmt";
const KPIS = [{"l":"Total Syndication","v":"2.754","t":"+15.1%","d":"up"},{"l":"Feed Mgmt Ativos","v":"8.484","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"66.8%","t":"+13.2%","d":"up"},{"l":"Score Performance","v":"55","t":"+10.7%","d":"up"}];
const COLS = ["ID","Feed Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Syndication #001","Syndication #002","1.888","6.489","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Syndication #002","Syndication #003","258","6.587","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Syndication #003","Syndication #004","8.787","8.441","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Syndication #004","Syndication #005","8.308","1.896","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Syndication #005","Syndication #001","3.796","2.225","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":683},{"label":"Mar","value":614},{"label":"Abr","value":655},{"label":"Mai","value":702},{"label":"Jun","value":546},{"label":"Jul","value":657},{"label":"Ago","value":372},{"label":"Set","value":466},{"label":"Out","value":511},{"label":"Nov","value":447},{"label":"Dez","value":675}];
const MX = 702;
