...
const PAGE = "Report";
const KPIS = [{"l":"Total Syndication","v":"643","t":"+14.4%","d":"up"},{"l":"Report Ativos","v":"2.934","t":"+14.5%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"75","t":"+10.7%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Syndication #001","Syndication #002","3.301","6.165","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Syndication #002","Syndication #003","8.389","2.914","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Syndication #003","Syndication #004","5.901","7.242","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Syndication #004","Syndication #005","4.297","2.652","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Syndication #005","Syndication #001","421","4.611","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":712},{"label":"Fev","value":609},{"label":"Mar","value":672},{"label":"Abr","value":581},{"label":"Mai","value":612},{"label":"Jun","value":559},{"label":"Jul","value":710},{"label":"Ago","value":565},{"label":"Set","value":331},{"label":"Out","value":397},{"label":"Nov","value":506},{"label":"Dez","value":504}];
const MX = 712;
