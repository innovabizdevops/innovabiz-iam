...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€1.1M","t":"+12.6%","d":"up"},{"l":"MRR (€)","v":"€66054","t":"+6.8%","d":"up"},{"l":"Churn (%)","v":"84.2%","t":"+2.7%","d":"up"},{"l":"ARPU (€)","v":"€99756","t":"+5.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 9628.01","7.079","€ 21297.32","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 16806.33","2.948","€ 46513.47","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 29088.01","1.104","€ 36696.25","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 38479.94","8.702","€ 38524.32","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 29268.35","1.744","€ 20312.23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":484},{"label":"Mar","value":492},{"label":"Abr","value":443},{"label":"Mai","value":699},{"label":"Jun","value":435},{"label":"Jul","value":556},{"label":"Ago","value":543},{"label":"Set","value":595},{"label":"Out","value":455},{"label":"Nov","value":394},{"label":"Dez","value":545}];
const MX = 699;
