...
const PAGE = "Mission Planning";
const KPIS = [{"l":"Total Defense Security","v":"7.712","t":"+0.7%","d":"up"},{"l":"Mission Planning Ativos","v":"5.922","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"94.9%","t":"+4.5%","d":"up"},{"l":"Score Performance","v":"80","t":"+0.7%","d":"up"}];
const COLS = ["ID","Mission Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense Security #001","Defense Security #002","8.689","6.817","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Defense Security #002","Defense Security #003","2.341","1.678","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense Security #003","Defense Security #004","7.527","4.672","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Defense Security #004","Defense Security #005","1.221","7.537","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense Security #005","Defense Security #001","4.676","1.342","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":314},{"label":"Fev","value":333},{"label":"Mar","value":342},{"label":"Abr","value":616},{"label":"Mai","value":529},{"label":"Jun","value":470},{"label":"Jul","value":251},{"label":"Ago","value":553},{"label":"Set","value":477},{"label":"Out","value":444},{"label":"Nov","value":480},{"label":"Dez","value":313}];
const MX = 616;
