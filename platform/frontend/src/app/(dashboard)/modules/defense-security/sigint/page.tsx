...
const PAGE = "SIGINT Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"7.342","t":"+10.0%","d":"up"},{"l":"Queries/Dia","v":"4331","t":"+12.5%","d":"up"},{"l":"Dados Processados (GB)","v":"4.192","t":"-1.3%","d":"down"},{"l":"Utilizadores Analytics","v":"1.428","t":"+1.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2911","2026-02-14","4.106","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1617","2026-02-06","3.262","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","946","2026-03-22","277","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4773","2026-01-27","7.212","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3213","2026-02-13","8.052","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":264},{"label":"Mar","value":355},{"label":"Abr","value":265},{"label":"Mai","value":235},{"label":"Jun","value":409},{"label":"Jul","value":446},{"label":"Ago","value":343},{"label":"Set","value":370},{"label":"Out","value":540},{"label":"Nov","value":228},{"label":"Dez","value":401}];
const MX = 571;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e3a5f'}}>Intel</span></h1>
                </div>
