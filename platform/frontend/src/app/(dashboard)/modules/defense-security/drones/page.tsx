...
const ACCENT = "#1e3a5f";
const MODULE = "Defense & Security";
const PAGE = "Drone Fleet";
const KPIS = [{"l":"Total Defense Security","v":"3.521","t":"+16.5%","d":"up"},{"l":"Drone Fleet Ativos","v":"3.805","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"84.6%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"83","t":"-4.3%","d":"down"}];
const COLS = ["ID","Drone Fleet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense Security #001","Defense Security #002","7.463","5.413","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Defense Security #002","Defense Security #003","2.681","5.374","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense Security #003","Defense Security #004","5.211","1.834","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Defense Security #004","Defense Security #005","7.592","1.746","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense Security #005","Defense Security #001","6.083","1.677","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":496},{"label":"Fev","value":258},{"label":"Mar","value":548},{"label":"Abr","value":371},{"label":"Mai","value":342},{"label":"Jun","value":434},{"label":"Jul","value":520},{"label":"Ago","value":500},{"label":"Set","value":254},{"label":"Out","value":606},{"label":"Nov","value":443},{"label":"Dez","value":317}];
const MX = 606;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e3a5f'}}>UAS</span></h1>
                </div>
