...
const PAGE = "C4ISR Systems";
const KPIS = [{"l":"Total Defense Security","v":"8.724","t":"+8.4%","d":"up"},{"l":"C4ISR Systems Ativos","v":"2.113","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"71.6%","t":"+8.9%","d":"up"},{"l":"Score Performance","v":"68","t":"+17.3%","d":"up"}];
const COLS = ["ID","C4ISR Systems","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense Security #001","Defense Security #002","4.292","1.894","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Defense Security #002","Defense Security #003","3.045","1.037","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense Security #003","Defense Security #004","4.108","1.327","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Defense Security #004","Defense Security #005","3.061","462","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense Security #005","Defense Security #001","2.705","4.056","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":1063},{"label":"Mar","value":699},{"label":"Abr","value":1078},{"label":"Mai","value":699},{"label":"Jun","value":1025},{"label":"Jul","value":691},{"label":"Ago","value":870},{"label":"Set","value":756},{"label":"Out","value":949},{"label":"Nov","value":1064},{"label":"Dez","value":971}];
const MX = 1078;
