...
const PAGE = "Personnel Mgmt";
const KPIS = [{"l":"Total Defense Security","v":"459","t":"+-0.0%","d":"up"},{"l":"Personnel Mgmt Ativos","v":"5.140","t":"+14.9%","d":"up"},{"l":"Eficiência (%)","v":"78.7%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"69","t":"+17.2%","d":"up"}];
const COLS = ["ID","Personnel Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense Security #001","Defense Security #002","354","7.269","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Defense Security #002","Defense Security #003","5.433","7.045","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense Security #003","Defense Security #004","4.884","2.833","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Defense Security #004","Defense Security #005","1.758","3.483","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense Security #005","Defense Security #001","764","2.486","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":483},{"label":"Mar","value":582},{"label":"Abr","value":276},{"label":"Mai","value":263},{"label":"Jun","value":359},{"label":"Jul","value":290},{"label":"Ago","value":552},{"label":"Set","value":406},{"label":"Out","value":435},{"label":"Nov","value":215},{"label":"Dez","value":230}];
const MX = 582;
