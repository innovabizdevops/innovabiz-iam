...
const KPIS = [{"l":"Total Defense Security","v":"7.819","t":"+10.4%","d":"up"},{"l":"Threat Intelligence Ativos","v":"7.727","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"67.5%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"57","t":"+15.5%","d":"up"}];
const COLS = ["ID","Threat Intelligence","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense Security #001","Defense Security #002","5.401","4.814","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Defense Security #002","Defense Security #003","7.097","2.445","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense Security #003","Defense Security #004","664","8.167","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Defense Security #004","Defense Security #005","9.054","6.215","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense Security #005","Defense Security #001","1.661","6.896","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":496},{"label":"Mar","value":392},{"label":"Abr","value":394},{"label":"Mai","value":305},{"label":"Jun","value":628},{"label":"Jul","value":429},{"label":"Ago","value":529},{"label":"Set","value":588},{"label":"Out","value":338},{"label":"Nov","value":450},{"label":"Dez","value":482}];
const MX = 665;
