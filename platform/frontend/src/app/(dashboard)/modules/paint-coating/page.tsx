...
export default function PaintCoatingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Paint Coating</h1><p className="text-sm text-muted-foreground">Paint Coating • iBOS Enterprise</p></div>
