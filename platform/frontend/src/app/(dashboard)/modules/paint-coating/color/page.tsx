...
const PAGE = "Color Match";
const KPIS = [{"l":"Atletas Registados","v":"5.190","t":"+11.7%","d":"up"},{"l":"Treinos/Semana","v":"3919","t":"+13.6%","d":"up"},{"l":"Competições","v":"8.765","t":"+9.3%","d":"up"},{"l":"Performance Score","v":"74","t":"-0.7%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.234","2.007","3.186","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.327","4.697","5.548","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.155","5.205","3.989","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.779","6.830","6.473","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.735","4.060","8.261","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":628},{"label":"Mar","value":646},{"label":"Abr","value":913},{"label":"Mai","value":845},{"label":"Jun","value":878},{"label":"Jul","value":668},{"label":"Ago","value":827},{"label":"Set","value":884},{"label":"Out","value":905},{"label":"Nov","value":892},{"label":"Dez","value":699}];
const MX = 913;
