...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.918","t":"+10.3%","d":"up"},{"l":"NC Abertas","v":"1.552","t":"+14.4%","d":"up"},{"l":"Conformidade (%)","v":"84.5%","t":"+11.9%","d":"up"},{"l":"CAPAs Pendentes","v":"9.023","t":"+4.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.363","72.2%","8.197","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.970","87.5%","4.332","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.595","72.2%","3.884","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.246","72.1%","3.179","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.341","96.0%","2.657","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":602},{"label":"Mar","value":470},{"label":"Abr","value":408},{"label":"Mai","value":489},{"label":"Jun","value":550},{"label":"Jul","value":395},{"label":"Ago","value":587},{"label":"Set","value":457},{"label":"Out","value":626},{"label":"Nov","value":393},{"label":"Dez","value":346}];
const MX = 657;
