...
const ACCENT = "#6366f1";
const MODULE = "Paint & Coating";
const PAGE = "Formulate";
const KPIS = [{"l":"Formulários Ativos","v":"3.304","t":"-3.4%","d":"down"},{"l":"Submissões/Dia","v":"2164","t":"-3.3%","d":"down"},{"l":"Documentos Gerados","v":"1.874","t":"-4.9%","d":"down"},{"l":"Templates","v":"7.427","t":"+6.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.426","2026-03-20","6.567","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","210","2026-01-05","7.488","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.845","2026-02-26","1.464","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.466","2026-02-25","7.622","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.723","2026-03-07","7.215","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":488},{"label":"Fev","value":479},{"label":"Mar","value":620},{"label":"Abr","value":629},{"label":"Mai","value":709},{"label":"Jun","value":682},{"label":"Jul","value":558},{"label":"Ago","value":346},{"label":"Set","value":602},{"label":"Out","value":405},{"label":"Nov","value":385},{"label":"Dez","value":555}];
const MX = 709;
