...
const PAGE = "FSC Certification";
const KPIS = [{"l":"Total Forestry","v":"4.794","t":"+2.2%","d":"up"},{"l":"FSC Certification Ativos","v":"332","t":"+1.3%","d":"up"},{"l":"Eficiência (%)","v":"67.9%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"89","t":"-4.1%","d":"down"}];
const COLS = ["ID","FSC Certification","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forestry #001","Forestry #002","2.022","7.374","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Forestry #002","Forestry #003","8.919","606","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Forestry #003","Forestry #004","2.624","5.422","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Forestry #004","Forestry #005","3.446","6.066","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forestry #005","Forestry #001","4.279","6.176","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":751},{"label":"Mar","value":729},{"label":"Abr","value":784},{"label":"Mai","value":912},{"label":"Jun","value":793},{"label":"Jul","value":797},{"label":"Ago","value":729},{"label":"Set","value":597},{"label":"Out","value":603},{"label":"Nov","value":870},{"label":"Dez","value":903}];
const MX = 912;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#166534'}}>FSC</span></h1>
                </div>
