...
const PAGE = "Wildlife Monitor";
const KPIS = [{"l":"Total Forestry","v":"1.966","t":"+17.8%","d":"up"},{"l":"Wildlife Monitor Ativos","v":"5.989","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"68.9%","t":"-1.4%","d":"down"},{"l":"Score Performance","v":"73","t":"-1.0%","d":"down"}];
const COLS = ["ID","Wildlife Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forestry #001","Forestry #002","4.730","8.406","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Forestry #002","Forestry #003","127","3.647","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Forestry #003","Forestry #004","7.222","8.999","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Forestry #004","Forestry #005","2.909","877","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forestry #005","Forestry #001","1.896","3.290","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":919},{"label":"Fev","value":942},{"label":"Mar","value":756},{"label":"Abr","value":715},{"label":"Mai","value":732},{"label":"Jun","value":878},{"label":"Jul","value":1018},{"label":"Ago","value":886},{"label":"Set","value":1045},{"label":"Out","value":1007},{"label":"Nov","value":997},{"label":"Dez","value":1010}];
const MX = 1045;
