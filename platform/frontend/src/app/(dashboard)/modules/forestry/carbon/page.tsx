...
const ACCENT = "#166534";
const MODULE = "Forestry & Timber";
const PAGE = "Carbon Sequestration";
const KPIS = [{"l":"Total Forestry","v":"1.796","t":"+6.5%","d":"up"},{"l":"Carbon Sequestration Ativos","v":"9.039","t":"+10.6%","d":"up"},{"l":"Eficiência (%)","v":"71.7%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"65","t":"+2.7%","d":"up"}];
const COLS = ["ID","Carbon Sequestration","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forestry #001","Forestry #002","8.564","4.400","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Forestry #002","Forestry #003","3.274","3.971","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Forestry #003","Forestry #004","7.045","6.847","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Forestry #004","Forestry #005","8.475","6.119","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forestry #005","Forestry #001","6.692","3.101","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":656},{"label":"Mar","value":735},{"label":"Abr","value":784},{"label":"Mai","value":702},{"label":"Jun","value":773},{"label":"Jul","value":756},{"label":"Ago","value":605},{"label":"Set","value":553},{"label":"Out","value":692},{"label":"Nov","value":494},{"label":"Dez","value":831}];
const MX = 831;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#166534'}}>ESG</span></h1>
                </div>
