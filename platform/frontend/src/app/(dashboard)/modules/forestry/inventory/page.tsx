...
const PAGE = "Forest Inventory";
const KPIS = [{"l":"Total Forestry","v":"6.066","t":"+11.1%","d":"up"},{"l":"Forest Inventory Ativos","v":"8.530","t":"+0.3%","d":"up"},{"l":"Eficiência (%)","v":"76.5%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"57","t":"+3.4%","d":"up"}];
const COLS = ["ID","Forest Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forestry #001","Forestry #002","4.844","7.440","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Forestry #002","Forestry #003","7.673","1.851","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Forestry #003","Forestry #004","3.291","7.328","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Forestry #004","Forestry #005","5.721","7.775","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forestry #005","Forestry #001","4.719","3.265","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":513},{"label":"Mar","value":770},{"label":"Abr","value":886},{"label":"Mai","value":613},{"label":"Jun","value":827},{"label":"Jul","value":502},{"label":"Ago","value":609},{"label":"Set","value":607},{"label":"Out","value":528},{"label":"Nov","value":642},{"label":"Dez","value":664}];
const MX = 886;
