...
export default function VrGamingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Vr Gaming</h1><p className="text-sm text-muted-foreground">Vr Gaming • iBOS Enterprise</p></div>
