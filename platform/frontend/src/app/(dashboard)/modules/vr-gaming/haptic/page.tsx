...
const PAGE = "Haptic";
const KPIS = [{"l":"Total Vr Gaming","v":"8.599","t":"+9.3%","d":"up"},{"l":"Haptic Ativos","v":"1.473","t":"+4.0%","d":"up"},{"l":"Eficiência (%)","v":"90.8%","t":"-1.8%","d":"down"},{"l":"Score Performance","v":"66","t":"-2.5%","d":"down"}];
const COLS = ["ID","Haptic","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vr Gaming #001","Vr Gaming #002","4.944","9.001","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Vr Gaming #002","Vr Gaming #003","4.026","6.487","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Vr Gaming #003","Vr Gaming #004","1.633","7.280","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Vr Gaming #004","Vr Gaming #005","1.942","7.863","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vr Gaming #005","Vr Gaming #001","4.648","1.602","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":605},{"label":"Mar","value":694},{"label":"Abr","value":564},{"label":"Mai","value":692},{"label":"Jun","value":509},{"label":"Jul","value":342},{"label":"Ago","value":484},{"label":"Set","value":609},{"label":"Out","value":509},{"label":"Nov","value":351},{"label":"Dez","value":453}];
const MX = 694;
