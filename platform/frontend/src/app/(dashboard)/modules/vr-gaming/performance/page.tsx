...
const ACCENT = "#1e40af";
const MODULE = "VR Gaming";
const PAGE = "Performance";
const KPIS = [{"l":"Formulários Ativos","v":"1.562","t":"-3.0%","d":"down"},{"l":"Submissões/Dia","v":"3089","t":"+12.3%","d":"up"},{"l":"Documentos Gerados","v":"8.990","t":"+5.4%","d":"up"},{"l":"Templates","v":"7.756","t":"+0.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.808","2026-02-05","7.240","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.426","2026-01-03","6.923","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.464","2026-01-13","4.737","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.934","2026-02-22","1.197","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.995","2026-01-06","5.719","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":530},{"label":"Mar","value":671},{"label":"Abr","value":883},{"label":"Mai","value":561},{"label":"Jun","value":661},{"label":"Jul","value":740},{"label":"Ago","value":852},{"label":"Set","value":484},{"label":"Out","value":767},{"label":"Nov","value":822},{"label":"Dez","value":629}];
const MX = 883;
