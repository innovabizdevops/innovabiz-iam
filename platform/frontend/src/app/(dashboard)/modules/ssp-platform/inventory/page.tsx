...
const ACCENT = "#059669";
const MODULE = "SSP Platform";
const PAGE = "Inventory Mgmt";
const KPIS = [{"l":"Formulários Ativos","v":"1.695","t":"+17.2%","d":"up"},{"l":"Submissões/Dia","v":"3054","t":"+7.9%","d":"up"},{"l":"Documentos Gerados","v":"3.430","t":"+11.3%","d":"up"},{"l":"Templates","v":"8.003","t":"-0.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.922","2026-03-06","5.775","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.684","2026-03-06","7.719","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.584","2026-01-10","2.757","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.652","2026-01-23","3.482","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.166","2026-02-27","8.193","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":671},{"label":"Mar","value":636},{"label":"Abr","value":871},{"label":"Mai","value":621},{"label":"Jun","value":720},{"label":"Jul","value":528},{"label":"Ago","value":809},{"label":"Set","value":860},{"label":"Out","value":821},{"label":"Nov","value":821},{"label":"Dez","value":496}];
const MX = 871;
