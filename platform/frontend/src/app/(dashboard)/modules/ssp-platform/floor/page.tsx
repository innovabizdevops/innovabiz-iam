...
const PAGE = "Floor Price";
const KPIS = [{"l":"Formulários Ativos","v":"3.106","t":"+6.8%","d":"up"},{"l":"Submissões/Dia","v":"1042","t":"+0.9%","d":"up"},{"l":"Documentos Gerados","v":"246","t":"+8.6%","d":"up"},{"l":"Templates","v":"6.729","t":"+2.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.378","2026-01-15","546","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.405","2026-02-27","1.673","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.248","2026-02-10","8.485","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.905","2026-03-14","1.839","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","225","2026-01-10","1.480","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":861},{"label":"Mar","value":613},{"label":"Abr","value":662},{"label":"Mai","value":651},{"label":"Jun","value":723},{"label":"Jul","value":570},{"label":"Ago","value":642},{"label":"Set","value":622},{"label":"Out","value":725},{"label":"Nov","value":566},{"label":"Dez","value":561}];
const MX = 861;
