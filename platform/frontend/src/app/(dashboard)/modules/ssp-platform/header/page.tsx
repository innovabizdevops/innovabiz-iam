...
const PAGE = "Header Bidding";
const KPIS = [{"l":"Formulários Ativos","v":"6.180","t":"+5.2%","d":"up"},{"l":"Submissões/Dia","v":"4225","t":"+2.8%","d":"up"},{"l":"Documentos Gerados","v":"6.808","t":"+1.9%","d":"up"},{"l":"Templates","v":"4.074","t":"+3.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.691","2026-03-12","1.520","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.027","2026-01-25","5.404","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.045","2026-03-08","2.938","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.311","2026-01-21","1.828","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.430","2026-03-20","464","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":539},{"label":"Fev","value":452},{"label":"Mar","value":696},{"label":"Abr","value":338},{"label":"Mai","value":611},{"label":"Jun","value":360},{"label":"Jul","value":654},{"label":"Ago","value":603},{"label":"Set","value":377},{"label":"Out","value":523},{"label":"Nov","value":401},{"label":"Dez","value":365}];
const MX = 696;
