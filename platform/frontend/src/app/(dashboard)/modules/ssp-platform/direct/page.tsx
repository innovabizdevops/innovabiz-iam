...
const PAGE = "Direct Deal";
const KPIS = [{"l":"Formulários Ativos","v":"1.073","t":"-1.3%","d":"down"},{"l":"Submissões/Dia","v":"649","t":"+5.0%","d":"up"},{"l":"Documentos Gerados","v":"1.543","t":"+17.1%","d":"up"},{"l":"Templates","v":"633","t":"+14.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.974","2026-01-25","8.076","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","329","2026-02-20","7.386","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.185","2026-01-19","5.498","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.449","2026-01-18","5.460","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","568","2026-03-07","8.665","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":422},{"label":"Fev","value":637},{"label":"Mar","value":430},{"label":"Abr","value":738},{"label":"Mai","value":463},{"label":"Jun","value":569},{"label":"Jul","value":776},{"label":"Ago","value":775},{"label":"Set","value":386},{"label":"Out","value":548},{"label":"Nov","value":453},{"label":"Dez","value":655}];
const MX = 776;
