...
const PAGE = "Fill Rate";
const KPIS = [{"l":"Formulários Ativos","v":"2.634","t":"+5.0%","d":"up"},{"l":"Submissões/Dia","v":"2773","t":"+6.5%","d":"up"},{"l":"Documentos Gerados","v":"5.834","t":"+17.5%","d":"up"},{"l":"Templates","v":"6.073","t":"+13.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.572","2026-03-16","8.079","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.643","2026-01-06","8.640","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.903","2026-02-02","3.268","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","445","2026-02-11","489","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.199","2026-03-05","7.044","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":938},{"label":"Mar","value":910},{"label":"Abr","value":935},{"label":"Mai","value":619},{"label":"Jun","value":704},{"label":"Jul","value":708},{"label":"Ago","value":905},{"label":"Set","value":924},{"label":"Out","value":871},{"label":"Nov","value":789},{"label":"Dez","value":809}];
const MX = 938;
