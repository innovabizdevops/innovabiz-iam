...
export default function WellCompletionPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Well Completion</h1><p className="text-sm text-muted-foreground">Well Completion • iBOS Enterprise</p></div>
