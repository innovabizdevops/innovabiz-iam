...
const ACCENT = "#6366f1";
const MODULE = "Well Completion";
const PAGE = "Perforate";
const KPIS = [{"l":"Total Well Completion","v":"5.059","t":"+11.3%","d":"up"},{"l":"Perforate Ativos","v":"8.338","t":"+7.5%","d":"up"},{"l":"Eficiência (%)","v":"94.8%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"92","t":"+4.3%","d":"up"}];
const COLS = ["ID","Perforate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Well Completion #001","Well Completion #002","6.361","8.506","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Well Completion #002","Well Completion #003","4.704","2.840","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Well Completion #003","Well Completion #004","5.918","8.496","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Well Completion #004","Well Completion #005","6.153","1.191","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Well Completion #005","Well Completion #001","1.773","4.724","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":360},{"label":"Fev","value":597},{"label":"Mar","value":295},{"label":"Abr","value":428},{"label":"Mai","value":619},{"label":"Jun","value":235},{"label":"Jul","value":264},{"label":"Ago","value":497},{"label":"Set","value":276},{"label":"Out","value":557},{"label":"Nov","value":614},{"label":"Dez","value":461}];
const MX = 619;
...
export default function PerforatePage() {
    return (
