...
/* ═══ Funeral Live Stream — Dashboard ═══ */

const ACCENT = "#334155";

const KPIS = [
    { label: "Total Registos", value: "9078", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3990", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€257K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1259526578", cells: ["LIV-4578", "Funeral Live Stream Item 1", "3/3/2026", "€26 678"], status: "active" as const },
    { id: "1259530149", cells: ["LIV-8149", "Funeral Live Stream Item 2", "18/10/2026", "€30 249"], status: "pending" as const },
    { id: "1259533720", cells: ["LIV-2720", "Funeral Live Stream Item 3", "5/5/2026", "€33 820"], status: "completed" as const },
    { id: "1259537291", cells: ["LIV-6291", "Funeral Live Stream Item 4", "20/12/2026", "€37 391"], status: "warning" as const },
    { id: "1259540862", cells: ["LIV-9862", "Funeral Live Stream Item 5", "7/7/2026", "€40 962"], status: "active" as const },
];
...
export default function FuneralLiveStreamPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Funeral Live Stream</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Funeral Live Stream</p>
                    </div>
                </div>
