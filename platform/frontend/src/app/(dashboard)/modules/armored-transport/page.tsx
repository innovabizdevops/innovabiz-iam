...
/* ═══ Armored Transport — Dashboard ═══ */

const ACCENT = "#334155";

const KPIS = [
    { label: "Total Registos", value: "6927", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3953", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€312K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1224191327", cells: ["ARM-3327", "Armored Transport Item 1", "24/12/2026", "€41 427"], status: "active" as const },
    { id: "1224194898", cells: ["ARM-6898", "Armored Transport Item 2", "11/7/2026", "€44 998"], status: "pending" as const },
    { id: "1224198469", cells: ["ARM-1469", "Armored Transport Item 3", "26/2/2026", "€48 569"], status: "completed" as const },
    { id: "1224202040", cells: ["ARM-5040", "Armored Transport Item 4", "13/9/2026", "€2140"], status: "warning" as const },
    { id: "1224205611", cells: ["ARM-8611", "Armored Transport Item 5", "28/4/2026", "€5711"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Armored Transport</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Armored Transport</p>
                    </div>
                </div>
