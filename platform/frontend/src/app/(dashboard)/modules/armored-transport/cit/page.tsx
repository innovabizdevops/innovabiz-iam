...
const PAGE = "CIT";
const KPIS = [{"l":"Atletas Registados","v":"529","t":"+0.3%","d":"up"},{"l":"Treinos/Semana","v":"4659","t":"+9.4%","d":"up"},{"l":"Competições","v":"6.174","t":"+7.1%","d":"up"},{"l":"Performance Score","v":"82","t":"+6.2%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.887","1.794","701","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.386","3.861","3.212","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.040","4.090","8.076","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.700","128","7.864","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.036","4.369","8.531","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":906},{"label":"Fev","value":698},{"label":"Mar","value":929},{"label":"Abr","value":659},{"label":"Mai","value":946},{"label":"Jun","value":828},{"label":"Jul","value":743},{"label":"Ago","value":780},{"label":"Set","value":684},{"label":"Out","value":640},{"label":"Nov","value":656},{"label":"Dez","value":694}];
const MX = 946;
