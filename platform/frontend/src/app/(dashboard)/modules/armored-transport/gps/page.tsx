...
const ACCENT = "#334155";
const MODULE = "Armored Transport";
const PAGE = "GPS";
const KPIS = [{"l":"Atletas Registados","v":"8.005","t":"+4.0%","d":"up"},{"l":"Treinos/Semana","v":"3067","t":"+1.6%","d":"up"},{"l":"Competições","v":"1.460","t":"+7.2%","d":"up"},{"l":"Performance Score","v":"63","t":"+6.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.006","7.607","9.056","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.899","7.633","6.063","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.037","215","850","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.375","5.313","4.353","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","651","5.263","2.060","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":596},{"label":"Mar","value":472},{"label":"Abr","value":563},{"label":"Mai","value":483},{"label":"Jun","value":592},{"label":"Jul","value":758},{"label":"Ago","value":553},{"label":"Set","value":762},{"label":"Out","value":700},{"label":"Nov","value":502},{"label":"Dez","value":785}];
const MX = 785;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#334155'}}>IoT</span></h1>
                </div>
