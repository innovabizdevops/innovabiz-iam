...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"7.389","t":"-3.1%","d":"down"},{"l":"SLA Cumprido (%)","v":"70.3%","t":"+11.9%","d":"up"},{"l":"MTTR (h)","v":"44h","t":"-1.0%","d":"down"},{"l":"Satisfação (%)","v":"72.2%","t":"+5.2%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.407","4.888","8.572","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.183","4.180","828","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","749","1.235","4.981","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.698","6.244","5.226","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.420","4.964","1.032","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":459},{"label":"Fev","value":722},{"label":"Mar","value":654},{"label":"Abr","value":455},{"label":"Mai","value":448},{"label":"Jun","value":654},{"label":"Jul","value":619},{"label":"Ago","value":628},{"label":"Set","value":486},{"label":"Out","value":380},{"label":"Nov","value":495},{"label":"Dez","value":570}];
const MX = 722;
