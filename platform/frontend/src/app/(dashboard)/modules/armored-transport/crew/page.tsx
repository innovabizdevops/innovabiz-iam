...
const PAGE = "Crew";
const KPIS = [{"l":"Atletas Registados","v":"7.547","t":"+17.3%","d":"up"},{"l":"Treinos/Semana","v":"174","t":"+8.5%","d":"up"},{"l":"Competições","v":"1.800","t":"+16.3%","d":"up"},{"l":"Performance Score","v":"92","t":"-1.1%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.329","2.856","6.056","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.049","5.039","5.073","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.315","8.332","8.578","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.582","1.733","5.073","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.167","3.392","5.474","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":704},{"label":"Mar","value":945},{"label":"Abr","value":756},{"label":"Mai","value":888},{"label":"Jun","value":853},{"label":"Jul","value":893},{"label":"Ago","value":805},{"label":"Set","value":825},{"label":"Out","value":887},{"label":"Nov","value":698},{"label":"Dez","value":614}];
const MX = 945;
