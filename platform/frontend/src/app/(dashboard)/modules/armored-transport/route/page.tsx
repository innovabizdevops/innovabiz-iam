...
const PAGE = "Route";
const KPIS = [{"l":"Atletas Registados","v":"8.884","t":"+14.5%","d":"up"},{"l":"Treinos/Semana","v":"3922","t":"+3.1%","d":"up"},{"l":"Competições","v":"3.847","t":"+9.0%","d":"up"},{"l":"Performance Score","v":"58","t":"+7.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.123","8.977","1.494","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","609","8.451","1.695","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.742","1.426","8.014","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.891","2.741","4.362","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.082","2.670","543","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":351},{"label":"Fev","value":646},{"label":"Mar","value":672},{"label":"Abr","value":397},{"label":"Mai","value":417},{"label":"Jun","value":712},{"label":"Jul","value":343},{"label":"Ago","value":363},{"label":"Set","value":673},{"label":"Out","value":493},{"label":"Nov","value":708},{"label":"Dez","value":675}];
const MX = 712;
