...
const ACCENT = "#6366f1";
const MODULE = "Fashion Design";
const PAGE = "CAD";
const KPIS = [{"l":"Formulários Ativos","v":"2.840","t":"+3.0%","d":"up"},{"l":"Submissões/Dia","v":"1584","t":"+11.2%","d":"up"},{"l":"Documentos Gerados","v":"1.772","t":"-5.4%","d":"down"},{"l":"Templates","v":"9.052","t":"+3.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.764","2026-01-17","7.418","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.181","2026-01-04","791","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.003","2026-03-18","7.843","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.694","2026-03-24","7.792","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.472","2026-03-09","1.662","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":542},{"label":"Mar","value":448},{"label":"Abr","value":669},{"label":"Mai","value":588},{"label":"Jun","value":651},{"label":"Jul","value":440},{"label":"Ago","value":406},{"label":"Set","value":455},{"label":"Out","value":509},{"label":"Nov","value":456},{"label":"Dez","value":413}];
const MX = 669;
