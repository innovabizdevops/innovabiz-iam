...
const PAGE = "Sampling";
const KPIS = [{"l":"Formulários Ativos","v":"2.953","t":"+5.4%","d":"up"},{"l":"Submissões/Dia","v":"3052","t":"+0.2%","d":"up"},{"l":"Documentos Gerados","v":"4.882","t":"+14.3%","d":"up"},{"l":"Templates","v":"5.905","t":"+14.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.392","2026-03-06","6.288","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.676","2026-03-14","6.146","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.870","2026-03-13","561","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.689","2026-03-27","8.957","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.649","2026-03-04","5.920","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":741},{"label":"Fev","value":705},{"label":"Mar","value":956},{"label":"Abr","value":1073},{"label":"Mai","value":992},{"label":"Jun","value":863},{"label":"Jul","value":781},{"label":"Ago","value":915},{"label":"Set","value":870},{"label":"Out","value":841},{"label":"Nov","value":794},{"label":"Dez","value":694}];
const MX = 1073;
