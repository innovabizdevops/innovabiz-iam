...
const PAGE = "Costing";
const KPIS = [{"l":"Formulários Ativos","v":"3.965","t":"-3.6%","d":"down"},{"l":"Submissões/Dia","v":"3954","t":"+13.2%","d":"up"},{"l":"Documentos Gerados","v":"8.826","t":"+16.3%","d":"up"},{"l":"Templates","v":"6.656","t":"+10.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.906","2026-03-10","1.349","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","359","2026-01-17","860","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.693","2026-02-01","6.068","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.345","2026-03-10","5.696","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.341","2026-01-17","3.654","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":638},{"label":"Mar","value":703},{"label":"Abr","value":907},{"label":"Mai","value":700},{"label":"Jun","value":700},{"label":"Jul","value":899},{"label":"Ago","value":662},{"label":"Set","value":579},{"label":"Out","value":926},{"label":"Nov","value":600},{"label":"Dez","value":810}];
const MX = 926;
