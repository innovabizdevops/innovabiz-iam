...
const PAGE = "Sketch";
const KPIS = [{"l":"Formulários Ativos","v":"1.313","t":"+17.7%","d":"up"},{"l":"Submissões/Dia","v":"2108","t":"-1.9%","d":"down"},{"l":"Documentos Gerados","v":"1.417","t":"+12.0%","d":"up"},{"l":"Templates","v":"4.980","t":"+10.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.341","2026-03-12","4.981","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.624","2026-01-15","1.872","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.367","2026-02-26","8.902","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.135","2026-03-11","8.653","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","396","2026-03-09","3.390","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":429},{"label":"Fev","value":595},{"label":"Mar","value":685},{"label":"Abr","value":669},{"label":"Mai","value":454},{"label":"Jun","value":412},{"label":"Jul","value":754},{"label":"Ago","value":677},{"label":"Set","value":655},{"label":"Out","value":365},{"label":"Nov","value":491},{"label":"Dez","value":678}];
const MX = 754;
