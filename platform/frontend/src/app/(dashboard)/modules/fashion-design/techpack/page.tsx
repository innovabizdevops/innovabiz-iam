...
const PAGE = "Tech Pack";
const KPIS = [{"l":"Formulários Ativos","v":"8.925","t":"+10.8%","d":"up"},{"l":"Submissões/Dia","v":"306","t":"+0.6%","d":"up"},{"l":"Documentos Gerados","v":"1.170","t":"-0.8%","d":"down"},{"l":"Templates","v":"1.382","t":"+9.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.527","2026-01-21","1.159","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.069","2026-02-26","6.218","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.471","2026-03-27","585","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.571","2026-01-15","4.317","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.365","2026-02-09","4.453","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":461},{"label":"Mar","value":613},{"label":"Abr","value":581},{"label":"Mai","value":508},{"label":"Jun","value":464},{"label":"Jul","value":263},{"label":"Ago","value":585},{"label":"Set","value":303},{"label":"Out","value":607},{"label":"Nov","value":464},{"label":"Dez","value":639}];
const MX = 639;
