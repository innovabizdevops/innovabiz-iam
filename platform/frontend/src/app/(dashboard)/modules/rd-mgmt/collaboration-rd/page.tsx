...
const PAGE = "Collaboration Rd";
const KPIS = [{"l":"Total Rd Mgmt","v":"2149","d":"+10.1%","u":true},{"l":"Rd Mgmt Ativos","v":"2499","d":"+1.9%","u":true},{"l":"Pendentes","v":"233","d":"-2.3%","u":false},{"l":"Performance (%)","v":"85.5%","d":"+1.8%","u":true}];
const COLS = ["ID","Rd Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [
  { id: "001", c: ["Collaboration Rd-001", "Collaboration Rd Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Collaboration Rd-002", "Collaboration Rd Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Collaboration Rd-003", "Collaboration Rd Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Collaboration Rd-004", "Collaboration Rd Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Collaboration Rd-005", "Collaboration Rd Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Collaboration Rd", ts: "Há 2min", a: "Sistema" },
...
export default function CollaborationRdPage() {
  return (
