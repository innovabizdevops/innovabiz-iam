...
const ROWS = [
  { id: "001", c: ["Lab Notebook-001", "Lab Notebook Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Lab Notebook-002", "Lab Notebook Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Lab Notebook-003", "Lab Notebook Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Lab Notebook-004", "Lab Notebook Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Lab Notebook-005", "Lab Notebook Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Lab Notebook", ts: "Há 2min", a: "Sistema" },
