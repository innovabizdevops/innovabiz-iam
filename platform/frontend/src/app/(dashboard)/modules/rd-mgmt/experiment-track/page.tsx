...
const PAGE = "Experiment Track";
const KPIS = [{"l":"Ideias Submetidas","v":"1,247","d":"+15.2%","u":true},{"l":"Projetos I&D Ativos","v":"48","d":"+4.2%","u":true},{"l":"Patentes","v":"127","d":"+8.3%","u":true},{"l":"ROI Inovação (%)","v":"340%","d":"+12.1%","u":true}];
const COLS = ["Projeto","Fase","Equipa","Investimento (€)","TRL","Estado"];
const ROWS = [
  { id: "001", c: ["Experiment Track-001", "Experiment Track Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Experiment Track-002", "Experiment Track Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Experiment Track-003", "Experiment Track Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Experiment Track-004", "Experiment Track Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Experiment Track-005", "Experiment Track Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Experiment Track", ts: "Há 2min", a: "Sistema" },
...
export default function ExperimentTrackPage() {
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">R&D Mgmt — iBOS Enterprise</p>
        </div>
