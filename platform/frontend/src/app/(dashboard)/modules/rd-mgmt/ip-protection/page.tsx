...
const KPIS = [{"l":"Total Rd Mgmt","v":"4916","d":"+10.9%","u":true},{"l":"Rd Mgmt Ativos","v":"1540","d":"+1.1%","u":true},{"l":"Pendentes","v":"160","d":"-8.3%","u":false},{"l":"Performance (%)","v":"87.3%","d":"+1.2%","u":true}];
const COLS = ["ID","Rd Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [
  { id: "001", c: ["Ip Protection-001", "Ip Protection Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Ip Protection-002", "Ip Protection Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Ip Protection-003", "Ip Protection Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Ip Protection-004", "Ip Protection Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Ip Protection-005", "Ip Protection Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Ip Protection", ts: "Há 2min", a: "Sistema" },
