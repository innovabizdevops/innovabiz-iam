...
const ROWS = [
  { id: "001", c: ["Rd Portfolio-001", "Rd Portfolio Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Rd Portfolio-002", "Rd Portfolio Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Rd Portfolio-003", "Rd Portfolio Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Rd Portfolio-004", "Rd Portfolio Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Rd Portfolio-005", "Rd Portfolio Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Rd Portfolio", ts: "Há 2min", a: "Sistema" },
...
export default function RdPortfolioPage() {
  return (
