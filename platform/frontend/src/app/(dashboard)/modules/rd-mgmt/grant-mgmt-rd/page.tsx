...
const PAGE = "Grant Mgmt Rd";
const KPIS = [{"l":"Investimento Social (€M)","v":"4.7","d":"+8.2%","u":true},{"l":"Voluntários Ativos","v":"847","d":"+12.3%","u":true},{"l":"Projetos Apoiados","v":"124","d":"+5.1%","u":true},{"l":"Impacto Beneficiários","v":"24.7K","d":"+15.2%","u":true}];
const COLS = ["Programa","Tipo","Orçamento (€)","Beneficiários","Impacto","Estado"];
const ROWS = [
  { id: "001", c: ["Grant Mgmt Rd-001", "Grant Mgmt Rd Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Grant Mgmt Rd-002", "Grant Mgmt Rd Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Grant Mgmt Rd-003", "Grant Mgmt Rd Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Grant Mgmt Rd-004", "Grant Mgmt Rd Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Grant Mgmt Rd-005", "Grant Mgmt Rd Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Grant Mgmt Rd", ts: "Há 2min", a: "Sistema" },
...
export default function GrantMgmtRdPage() {
  return (
