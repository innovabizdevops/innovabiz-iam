...
const PAGE = "Publication Mgmt";
const KPIS = [{"l":"Total Rd Mgmt","v":"1167","d":"+5.0%","u":true},{"l":"Rd Mgmt Ativos","v":"857","d":"+5.7%","u":true},{"l":"Pendentes","v":"243","d":"-6.5%","u":false},{"l":"Performance (%)","v":"91.5%","d":"+4.6%","u":true}];
const COLS = ["ID","Rd Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [
  { id: "001", c: ["Publication Mgmt-001", "Publication Mgmt Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Publication Mgmt-002", "Publication Mgmt Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Publication Mgmt-003", "Publication Mgmt Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Publication Mgmt-004", "Publication Mgmt Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Publication Mgmt-005", "Publication Mgmt Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Publication Mgmt", ts: "Há 2min", a: "Sistema" },
...
export default function PublicationMgmtPage() {
  return (
