...
const PAGE = "Policy";
const KPIS = [{"l":"Riscos Identificados","v":"4.843","t":"+16.8%","d":"up"},{"l":"Mitigações Ativas","v":"4.175","t":"+5.1%","d":"up"},{"l":"Score Risco Geral","v":"94","t":"+8.0%","d":"up"},{"l":"Incidentes YTD","v":"8.983","t":"+4.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.178","7.319","5.495","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.275","1.941","5.281","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.105","2.759","6.942","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.647","4.584","3.881","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","544","1.805","2.358","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":893},{"label":"Fev","value":867},{"label":"Mar","value":751},{"label":"Abr","value":889},{"label":"Mai","value":610},{"label":"Jun","value":884},{"label":"Jul","value":825},{"label":"Ago","value":632},{"label":"Set","value":861},{"label":"Out","value":923},{"label":"Nov","value":952},{"label":"Dez","value":876}];
const MX = 952;
