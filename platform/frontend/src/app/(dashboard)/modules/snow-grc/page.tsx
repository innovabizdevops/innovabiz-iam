...
/* ═══ GRC (ServiceNow) — Dashboard ═══ */

const ACCENT = "#81b5a1";

const KPIS = [
    { label: "Total Registos", value: "6169", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2881", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€189K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "-2%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1609191669", cells: ["SNO-1669", "GRC (ServiceNow) Item 1", "2/10/2026", "€41 769"], status: "active" as const },
    { id: "1609195240", cells: ["SNO-5240", "GRC (ServiceNow) Item 2", "17/5/2026", "€45 340"], status: "pending" as const },
    { id: "1609198811", cells: ["SNO-8811", "GRC (ServiceNow) Item 3", "4/12/2026", "€48 911"], status: "completed" as const },
    { id: "1609202382", cells: ["SNO-3382", "GRC (ServiceNow) Item 4", "19/7/2026", "€2482"], status: "warning" as const },
    { id: "1609205953", cells: ["SNO-6953", "GRC (ServiceNow) Item 5", "6/2/2026", "€6053"], status: "active" as const },
];
...
export default function GrcServicenowPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GRC (ServiceNow)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GRC (ServiceNow)</p>
                    </div>
                </div>
