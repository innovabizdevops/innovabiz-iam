...
const PAGE = "Audit";
const KPIS = [{"l":"Riscos Identificados","v":"2.869","t":"+2.3%","d":"up"},{"l":"Mitigações Ativas","v":"8.318","t":"+3.2%","d":"up"},{"l":"Score Risco Geral","v":"90","t":"+8.2%","d":"up"},{"l":"Incidentes YTD","v":"6.443","t":"-0.6%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.575","3.152","978","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.948","7.827","8.809","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.190","545","1.044","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.022","5.747","3.807","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.624","8.610","1.808","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":775},{"label":"Mar","value":733},{"label":"Abr","value":871},{"label":"Mai","value":878},{"label":"Jun","value":573},{"label":"Jul","value":638},{"label":"Ago","value":699},{"label":"Set","value":844},{"label":"Out","value":864},{"label":"Nov","value":765},{"label":"Dez","value":552}];
const MX = 878;
