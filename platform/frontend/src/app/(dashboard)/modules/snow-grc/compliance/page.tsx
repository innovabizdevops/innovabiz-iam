...
const KPIS = [{"l":"Riscos Identificados","v":"7.451","t":"-1.3%","d":"down"},{"l":"Mitigações Ativas","v":"3.137","t":"-4.8%","d":"down"},{"l":"Score Risco Geral","v":"89","t":"+0.8%","d":"up"},{"l":"Incidentes YTD","v":"3.649","t":"+11.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","532","4.510","6.008","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.491","451","103","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.660","889","4.532","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.375","4.814","1.705","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.622","2.435","1.231","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":458},{"label":"Fev","value":443},{"label":"Mar","value":645},{"label":"Abr","value":620},{"label":"Mai","value":488},{"label":"Jun","value":545},{"label":"Jul","value":354},{"label":"Ago","value":598},{"label":"Set","value":595},{"label":"Out","value":683},{"label":"Nov","value":674},{"label":"Dez","value":404}];
const MX = 683;
