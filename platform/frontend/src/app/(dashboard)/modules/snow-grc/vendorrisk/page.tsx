...
const ACCENT = "#81b5a1";
const MODULE = "GRC (ServiceNow)";
const PAGE = "Vendor Risk";
const KPIS = [{"l":"Riscos Identificados","v":"8.491","t":"+7.6%","d":"up"},{"l":"Mitigações Ativas","v":"7.077","t":"+2.7%","d":"up"},{"l":"Score Risco Geral","v":"90","t":"+10.3%","d":"up"},{"l":"Incidentes YTD","v":"5.865","t":"+16.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.929","262","5.186","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.933","8.040","5.914","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.609","8.269","2.871","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.354","4.106","7.143","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.999","3.143","5.441","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":566},{"label":"Mar","value":329},{"label":"Abr","value":376},{"label":"Mai","value":527},{"label":"Jun","value":400},{"label":"Jul","value":558},{"label":"Ago","value":571},{"label":"Set","value":440},{"label":"Out","value":386},{"label":"Nov","value":268},{"label":"Dez","value":512}];
const MX = 571;
