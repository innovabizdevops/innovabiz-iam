...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"5.841","t":"+14.3%","d":"up"},{"l":"Mitigações Ativas","v":"4.575","t":"+11.7%","d":"up"},{"l":"Score Risco Geral","v":"60","t":"+10.2%","d":"up"},{"l":"Incidentes YTD","v":"7.776","t":"+13.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.624","8.213","6.843","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.316","2.559","7.727","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.019","4.158","8.812","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.807","887","2.151","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.317","3.434","5.146","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":818},{"label":"Fev","value":900},{"label":"Mar","value":787},{"label":"Abr","value":1014},{"label":"Mai","value":973},{"label":"Jun","value":749},{"label":"Jul","value":789},{"label":"Ago","value":1025},{"label":"Set","value":908},{"label":"Out","value":825},{"label":"Nov","value":873},{"label":"Dez","value":769}];
const MX = 1025;
