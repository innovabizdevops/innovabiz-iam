...
const PAGE = "Early Warning";
const KPIS = [{"l":"Total Climate Adapt","v":"4.335","t":"+8.2%","d":"up"},{"l":"Early Warning Ativos","v":"332","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"86.0%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"82","t":"-3.5%","d":"down"}];
const COLS = ["ID","Early Warning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Climate Adapt #001","Climate Adapt #002","8.238","5.943","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Climate Adapt #002","Climate Adapt #003","2.571","7.138","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Climate Adapt #003","Climate Adapt #004","8.693","4.066","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Climate Adapt #004","Climate Adapt #005","404","3.255","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Climate Adapt #005","Climate Adapt #001","1.041","8.544","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":496},{"label":"Fev","value":412},{"label":"Mar","value":649},{"label":"Abr","value":313},{"label":"Mai","value":579},{"label":"Jun","value":567},{"label":"Jul","value":475},{"label":"Ago","value":365},{"label":"Set","value":523},{"label":"Out","value":657},{"label":"Nov","value":313},{"label":"Dez","value":475}];
const MX = 657;
