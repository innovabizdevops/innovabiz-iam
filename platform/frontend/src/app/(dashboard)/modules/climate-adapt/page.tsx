...
export default function ClimateAdaptPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Climate Adapt</h1><p className="text-sm text-muted-foreground">Climate Adapt • iBOS Enterprise</p></div>
