...
const KPIS = [{"l":"Total Climate Adapt","v":"3.830","t":"+10.4%","d":"up"},{"l":"Resilience Ativos","v":"1.379","t":"-5.4%","d":"down"},{"l":"Eficiência (%)","v":"76.4%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"65","t":"-1.6%","d":"down"}];
const COLS = ["ID","Resilience","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Climate Adapt #001","Climate Adapt #002","7.038","1.744","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Climate Adapt #002","Climate Adapt #003","5.407","3.936","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Climate Adapt #003","Climate Adapt #004","6.215","2.123","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Climate Adapt #004","Climate Adapt #005","7.047","3.201","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Climate Adapt #005","Climate Adapt #001","1.818","4.528","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":766},{"label":"Mar","value":801},{"label":"Abr","value":744},{"label":"Mai","value":855},{"label":"Jun","value":825},{"label":"Jul","value":800},{"label":"Ago","value":799},{"label":"Set","value":614},{"label":"Out","value":740},{"label":"Nov","value":883},{"label":"Dez","value":533}];
const MX = 883;
