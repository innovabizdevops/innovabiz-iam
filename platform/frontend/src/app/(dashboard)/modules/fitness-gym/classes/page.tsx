...
const PAGE = "Class Schedule";
const KPIS = [{"l":"Atletas Registados","v":"4.150","t":"+16.4%","d":"up"},{"l":"Treinos/Semana","v":"3309","t":"-1.1%","d":"down"},{"l":"Competições","v":"5.342","t":"+12.9%","d":"up"},{"l":"Performance Score","v":"91","t":"-2.3%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.830","6.351","3.941","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","5.479","5.691","6.481","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.599","926","5.180","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","774","3.736","3.382","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.258","7.392","1.269","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":373},{"label":"Fev","value":355},{"label":"Mar","value":408},{"label":"Abr","value":258},{"label":"Mai","value":334},{"label":"Jun","value":365},{"label":"Jul","value":248},{"label":"Ago","value":533},{"label":"Set","value":345},{"label":"Out","value":471},{"label":"Nov","value":584},{"label":"Dez","value":533}];
const MX = 584;
