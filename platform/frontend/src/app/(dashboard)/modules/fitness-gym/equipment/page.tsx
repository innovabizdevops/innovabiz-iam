...
const PAGE = "Equipment Track";
const KPIS = [{"l":"Atletas Registados","v":"513","t":"+12.0%","d":"up"},{"l":"Treinos/Semana","v":"3850","t":"+13.7%","d":"up"},{"l":"Competições","v":"8.518","t":"+15.9%","d":"up"},{"l":"Performance Score","v":"59","t":"+6.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.910","927","5.089","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","434","4.686","6.899","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.303","1.000","7.740","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.317","6.339","3.508","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.677","8.802","133","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":395},{"label":"Mar","value":422},{"label":"Abr","value":581},{"label":"Mai","value":394},{"label":"Jun","value":467},{"label":"Jul","value":399},{"label":"Ago","value":478},{"label":"Set","value":235},{"label":"Out","value":543},{"label":"Nov","value":488},{"label":"Dez","value":579}];
const MX = 581;
