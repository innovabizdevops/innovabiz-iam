...
const PAGE = "Nutrition Plans";
const KPIS = [{"l":"Atletas Registados","v":"4.121","t":"-1.2%","d":"down"},{"l":"Treinos/Semana","v":"3597","t":"+11.0%","d":"up"},{"l":"Competições","v":"2.204","t":"-0.8%","d":"down"},{"l":"Performance Score","v":"79","t":"+6.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","221","1.140","5.837","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.638","7.936","217","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.146","4.613","2.960","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.201","5.060","4.775","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.250","7.634","2.181","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":440},{"label":"Mar","value":564},{"label":"Abr","value":533},{"label":"Mai","value":213},{"label":"Jun","value":239},{"label":"Jul","value":205},{"label":"Ago","value":471},{"label":"Set","value":456},{"label":"Out","value":446},{"label":"Nov","value":588},{"label":"Dez","value":327}];
const MX = 590;
