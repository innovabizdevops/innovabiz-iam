...
const KPIS = [{"l":"Integrações Ativas","v":"2.775","t":"+10.9%","d":"up"},{"l":"Chamadas/Hora","v":"3034","t":"+0.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.4%","t":"-1.8%","d":"down"},{"l":"Latência Média (ms)","v":"173ms","t":"+11.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.957","8.088","75.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.392","9.029","87.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.415","8.037","70.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.645","5.267","91.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","226","4.912","95.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":646},{"label":"Fev","value":884},{"label":"Mar","value":762},{"label":"Abr","value":969},{"label":"Mai","value":891},{"label":"Jun","value":942},{"label":"Jul","value":835},{"label":"Ago","value":840},{"label":"Set","value":779},{"label":"Out","value":643},{"label":"Nov","value":879},{"label":"Dez","value":947}];
const MX = 969;
