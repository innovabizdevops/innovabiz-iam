...
const PAGE = "Progress Tracker";
const KPIS = [{"l":"Atletas Registados","v":"4.936","t":"+4.1%","d":"up"},{"l":"Treinos/Semana","v":"3697","t":"+5.5%","d":"up"},{"l":"Competições","v":"5.644","t":"+4.8%","d":"up"},{"l":"Performance Score","v":"85","t":"-2.4%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.061","8.506","7.834","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","5.220","3.990","1.534","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.082","8.832","1.259","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.943","7.975","2.306","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.514","2.390","3.742","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":698},{"label":"Mar","value":698},{"label":"Abr","value":786},{"label":"Mai","value":568},{"label":"Jun","value":894},{"label":"Jul","value":615},{"label":"Ago","value":773},{"label":"Set","value":811},{"label":"Out","value":590},{"label":"Nov","value":814},{"label":"Dez","value":732}];
const MX = 894;
