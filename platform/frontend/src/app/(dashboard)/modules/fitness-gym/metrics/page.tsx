...
const ACCENT = "#dc2626";
const MODULE = "Fitness & Gym";
const PAGE = "Body Metrics AI";
const KPIS = [{"l":"Atletas Registados","v":"2.930","t":"+14.3%","d":"up"},{"l":"Treinos/Semana","v":"3473","t":"+2.2%","d":"up"},{"l":"Competições","v":"1.301","t":"-2.8%","d":"down"},{"l":"Performance Score","v":"82","t":"+4.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.387","6.486","6.424","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.988","1.042","900","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.314","7.268","5.384","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.593","4.160","4.175","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.117","4.153","5.802","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":916},{"label":"Mar","value":909},{"label":"Abr","value":709},{"label":"Mai","value":825},{"label":"Jun","value":786},{"label":"Jul","value":806},{"label":"Ago","value":725},{"label":"Set","value":804},{"label":"Out","value":820},{"label":"Nov","value":901},{"label":"Dez","value":627}];
const MX = 916;
