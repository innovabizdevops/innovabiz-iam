...
const PAGE = "Membership Mgmt";
const KPIS = [{"l":"Atletas Registados","v":"3.672","t":"+17.4%","d":"up"},{"l":"Treinos/Semana","v":"3347","t":"+2.9%","d":"up"},{"l":"Competições","v":"7.361","t":"+4.1%","d":"up"},{"l":"Performance Score","v":"69","t":"+2.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.040","645","8.967","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","638","6.676","3.790","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.349","2.163","4.536","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.701","4.895","7.998","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.730","4.509","4.778","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":862},{"label":"Fev","value":906},{"label":"Mar","value":734},{"label":"Abr","value":650},{"label":"Mai","value":745},{"label":"Jun","value":857},{"label":"Jul","value":759},{"label":"Ago","value":708},{"label":"Set","value":717},{"label":"Out","value":637},{"label":"Nov","value":746},{"label":"Dez","value":650}];
const MX = 906;
