...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.891","t":"+16.4%","d":"up"},{"l":"NC Abertas","v":"3.323","t":"+8.0%","d":"up"},{"l":"Conformidade (%)","v":"69.2%","t":"-4.9%","d":"down"},{"l":"CAPAs Pendentes","v":"1.410","t":"+9.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.313","96.1%","2.788","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.882","77.7%","9.012","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.094","71.3%","6.252","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.160","77.2%","2.122","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.615","72.1%","8.563","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":978},{"label":"Fev","value":707},{"label":"Mar","value":660},{"label":"Abr","value":671},{"label":"Mai","value":773},{"label":"Jun","value":969},{"label":"Jul","value":805},{"label":"Ago","value":960},{"label":"Set","value":837},{"label":"Out","value":806},{"label":"Nov","value":775},{"label":"Dez","value":726}];
const MX = 978;
