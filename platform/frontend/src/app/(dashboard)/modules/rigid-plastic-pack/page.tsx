...
/* ═══ Rigid Plastic Packaging — Dashboard ═══ */

const ACCENT = "#713f12";

const KPIS = [
    { label: "Total Registos", value: "6795", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3961", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€297K", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1114410095", cells: ["RIG-4095", "Rigid Plastic Packaging Item 1", "16/12/2026", "€10 195"], status: "active" as const },
    { id: "1114413666", cells: ["RIG-7666", "Rigid Plastic Packaging Item 2", "3/7/2026", "€13 766"], status: "pending" as const },
    { id: "1114417237", cells: ["RIG-2237", "Rigid Plastic Packaging Item 3", "18/2/2026", "€17 337"], status: "completed" as const },
    { id: "1114420808", cells: ["RIG-5808", "Rigid Plastic Packaging Item 4", "5/9/2026", "€20 908"], status: "warning" as const },
    { id: "1114424379", cells: ["RIG-9379", "Rigid Plastic Packaging Item 5", "20/4/2026", "€24 479"], status: "active" as const },
];
...
export default function RigidPlasticPackagingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Rigid Plastic Packaging</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Rigid Plastic Packaging</p>
                    </div>
                </div>
