...
const PAGE = "Thermoform";
const KPIS = [{"l":"Riscos Identificados","v":"2.624","t":"+11.1%","d":"up"},{"l":"Mitigações Ativas","v":"3.541","t":"+15.1%","d":"up"},{"l":"Score Risco Geral","v":"56","t":"+9.5%","d":"up"},{"l":"Incidentes YTD","v":"6.333","t":"+14.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.909","2.571","1.777","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.449","6.854","4.447","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.945","1.931","7.582","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.697","6.790","7.195","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.851","6.193","2.038","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":447},{"label":"Mar","value":485},{"label":"Abr","value":514},{"label":"Mai","value":408},{"label":"Jun","value":316},{"label":"Jul","value":565},{"label":"Ago","value":384},{"label":"Set","value":537},{"label":"Out","value":520},{"label":"Nov","value":434},{"label":"Dez","value":337}];
const MX = 662;
