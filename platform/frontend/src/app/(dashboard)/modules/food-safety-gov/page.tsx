...
/* ═══ Food Safety Authority — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "8777", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "380", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€34K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2043477577", cells: ["FOO-1577", "Food Safety Authority Item 1", "2/2/2026", "€27 677"], status: "active" as const },
    { id: "2043481148", cells: ["FOO-5148", "Food Safety Authority Item 2", "17/9/2026", "€31 248"], status: "pending" as const },
    { id: "2043484719", cells: ["FOO-8719", "Food Safety Authority Item 3", "4/4/2026", "€34 819"], status: "completed" as const },
    { id: "2043488290", cells: ["FOO-3290", "Food Safety Authority Item 4", "19/11/2026", "€38 390"], status: "warning" as const },
    { id: "2043491861", cells: ["FOO-6861", "Food Safety Authority Item 5", "6/6/2026", "€41 961"], status: "active" as const },
];
...
export default function FoodSafetyAuthorityPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Food Safety Authority</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Food Safety Authority</p>
                    </div>
                </div>
