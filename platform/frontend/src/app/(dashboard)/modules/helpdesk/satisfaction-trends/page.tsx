...
const ACCENT = "#0d9488";
const MODULE = "Help Desk & Case Mgmt";
const PAGE = "Satisfaction Trends";
const KPIS = [{"l":"Tickets Abertos","v":"6.288","t":"-4.2%","d":"down"},{"l":"SLA Cumprido (%)","v":"65.0%","t":"-6.0%","d":"down"},{"l":"MTTR (h)","v":"14h","t":"-3.6%","d":"down"},{"l":"Satisfação (%)","v":"77.3%","t":"+16.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.554","2.976","303","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.963","4.549","6.949","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.407","961","5.379","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.040","6.340","2.058","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.622","8.248","1.392","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":989},{"label":"Fev","value":835},{"label":"Mar","value":1077},{"label":"Abr","value":755},{"label":"Mai","value":1023},{"label":"Jun","value":776},{"label":"Jul","value":942},{"label":"Ago","value":841},{"label":"Set","value":924},{"label":"Out","value":993},{"label":"Nov","value":940},{"label":"Dez","value":1038}];
const MX = 1077;
...
export default function SatisfactionTrendsPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0d9488'}}>Chart</span></h1>
                </div>
