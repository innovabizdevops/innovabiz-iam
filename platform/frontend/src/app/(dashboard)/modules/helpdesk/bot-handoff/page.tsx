...
const PAGE = "Bot Handoff";
const KPIS = [{"l":"Tickets Abertos","v":"4.341","t":"+14.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"76.1%","t":"+3.4%","d":"up"},{"l":"MTTR (h)","v":"57h","t":"-3.2%","d":"down"},{"l":"Satisfação (%)","v":"82.8%","t":"-5.1%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.865","4.233","1.651","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","890","5.458","5.956","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.343","722","299","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.096","6.990","1.321","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.665","3.301","7.954","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":515},{"label":"Fev","value":431},{"label":"Mar","value":698},{"label":"Abr","value":554},{"label":"Mai","value":786},{"label":"Jun","value":724},{"label":"Jul","value":578},{"label":"Ago","value":522},{"label":"Set","value":660},{"label":"Out","value":770},{"label":"Nov","value":412},{"label":"Dez","value":707}];
const MX = 786;
...
export default function BotHandoffPage() {
    return (
