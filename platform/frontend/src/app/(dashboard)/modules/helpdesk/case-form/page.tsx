...
const PAGE = "Case Form";
const KPIS = [{"l":"Tickets Abertos","v":"8.734","t":"+11.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"77.7%","t":"+11.8%","d":"up"},{"l":"MTTR (h)","v":"175h","t":"-4.9%","d":"down"},{"l":"Satisfação (%)","v":"83.1%","t":"-5.6%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.742","8.191","6.892","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","570","4.919","8.994","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.966","9.092","5.313","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.936","652","5.106","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.482","167","8.514","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":645},{"label":"Mar","value":317},{"label":"Abr","value":383},{"label":"Mai","value":589},{"label":"Jun","value":493},{"label":"Jul","value":513},{"label":"Ago","value":584},{"label":"Set","value":538},{"label":"Out","value":637},{"label":"Nov","value":532},{"label":"Dez","value":480}];
const MX = 645;
