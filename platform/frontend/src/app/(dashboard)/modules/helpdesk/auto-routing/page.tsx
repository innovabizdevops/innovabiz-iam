...
const PAGE = "Auto-Routing AI";
const KPIS = [{"l":"Tickets Abertos","v":"6.686","t":"-1.6%","d":"down"},{"l":"SLA Cumprido (%)","v":"94.3%","t":"-5.1%","d":"down"},{"l":"MTTR (h)","v":"33h","t":"-5.1%","d":"down"},{"l":"Satisfação (%)","v":"82.6%","t":"-0.4%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.084","1.279","6.776","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.490","6.243","7.604","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.142","6.922","5.758","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.181","7.672","5.792","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.518","252","7.418","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":845},{"label":"Mar","value":952},{"label":"Abr","value":816},{"label":"Mai","value":596},{"label":"Jun","value":756},{"label":"Jul","value":873},{"label":"Ago","value":747},{"label":"Set","value":836},{"label":"Out","value":664},{"label":"Nov","value":596},{"label":"Dez","value":788}];
const MX = 952;
