...
const PAGE = "Agent Performance";
const KPIS = [{"l":"Tickets Abertos","v":"6.886","t":"+1.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"70.6%","t":"+3.1%","d":"up"},{"l":"MTTR (h)","v":"28h","t":"+16.5%","d":"up"},{"l":"Satisfação (%)","v":"85.0%","t":"+1.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.605","1.251","8.018","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","9.030","6.041","1.298","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.679","1.778","4.083","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.076","6.306","7.178","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.128","4.106","7.964","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":849},{"label":"Fev","value":857},{"label":"Mar","value":883},{"label":"Abr","value":774},{"label":"Mai","value":773},{"label":"Jun","value":926},{"label":"Jul","value":803},{"label":"Ago","value":1014},{"label":"Set","value":665},{"label":"Out","value":959},{"label":"Nov","value":913},{"label":"Dez","value":689}];
const MX = 1014;
...
export default function AgentPerfPage() {
    return (
