...
const PAGE = "Omnichannel Inbox";
const KPIS = [{"l":"Tickets Abertos","v":"5.597","t":"+4.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"65.8%","t":"+2.8%","d":"up"},{"l":"MTTR (h)","v":"196h","t":"-0.4%","d":"down"},{"l":"Satisfação (%)","v":"70.9%","t":"-2.5%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.824","600","8.260","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.153","8.796","5.166","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.833","1.900","4.220","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.479","7.243","695","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","139","3.313","4.262","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":629},{"label":"Mar","value":613},{"label":"Abr","value":288},{"label":"Mai","value":304},{"label":"Jun","value":497},{"label":"Jul","value":617},{"label":"Ago","value":325},{"label":"Set","value":633},{"label":"Out","value":534},{"label":"Nov","value":485},{"label":"Dez","value":648}];
const MX = 648;
