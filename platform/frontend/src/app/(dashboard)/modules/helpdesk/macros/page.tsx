...
const PAGE = "Macro Library";
const KPIS = [{"l":"Tickets Abertos","v":"7.917","t":"+5.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"88.8%","t":"+15.1%","d":"up"},{"l":"MTTR (h)","v":"30h","t":"+7.6%","d":"up"},{"l":"Satisfação (%)","v":"86.1%","t":"-0.3%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.586","5.167","6.148","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.158","4.617","6.401","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.577","7.247","4.537","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.215","4.612","6.573","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.608","5.685","8.415","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":544},{"label":"Mar","value":854},{"label":"Abr","value":623},{"label":"Mai","value":603},{"label":"Jun","value":819},{"label":"Jul","value":593},{"label":"Ago","value":869},{"label":"Set","value":671},{"label":"Out","value":679},{"label":"Nov","value":503},{"label":"Dez","value":705}];
const MX = 869;
