...
const PAGE = "CSAT Feedback";
const KPIS = [{"l":"Tickets Abertos","v":"3.538","t":"+5.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"85.7%","t":"+1.3%","d":"up"},{"l":"MTTR (h)","v":"142h","t":"-2.7%","d":"down"},{"l":"Satisfação (%)","v":"87.5%","t":"+9.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.354","6.898","8.677","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.669","2.282","3.169","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.826","6.711","5.905","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.973","2.693","7.644","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.329","2.765","6.455","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":865},{"label":"Mar","value":930},{"label":"Abr","value":788},{"label":"Mai","value":1051},{"label":"Jun","value":858},{"label":"Jul","value":947},{"label":"Ago","value":887},{"label":"Set","value":946},{"label":"Out","value":866},{"label":"Nov","value":835},{"label":"Dez","value":1001}];
const MX = 1051;
