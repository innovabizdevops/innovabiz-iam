...
const PAGE = "SLA Tracker";
const KPIS = [{"l":"Tickets Abertos","v":"2.725","t":"+15.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"82.5%","t":"+17.9%","d":"up"},{"l":"MTTR (h)","v":"86h","t":"+13.7%","d":"up"},{"l":"Satisfação (%)","v":"65.7%","t":"+14.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.189","5.248","7.701","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","116","1.826","2.812","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","645","8.137","920","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.431","8.558","1.587","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.784","8.021","5.994","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":475},{"label":"Mar","value":692},{"label":"Abr","value":648},{"label":"Mai","value":403},{"label":"Jun","value":535},{"label":"Jul","value":403},{"label":"Ago","value":517},{"label":"Set","value":586},{"label":"Out","value":655},{"label":"Nov","value":648},{"label":"Dez","value":411}];
const MX = 739;
