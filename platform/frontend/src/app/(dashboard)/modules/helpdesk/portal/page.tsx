...
const KPIS = [{"l":"Tickets Abertos","v":"2.436","t":"+4.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"89.8%","t":"+2.5%","d":"up"},{"l":"MTTR (h)","v":"94h","t":"+17.5%","d":"up"},{"l":"Satisfação (%)","v":"75.9%","t":"+0.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.328","3.686","5.586","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.304","3.858","5.470","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.784","7.637","7.989","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.941","453","6.682","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.085","5.616","463","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":472},{"label":"Fev","value":791},{"label":"Mar","value":629},{"label":"Abr","value":512},{"label":"Mai","value":550},{"label":"Jun","value":759},{"label":"Jul","value":448},{"label":"Ago","value":571},{"label":"Set","value":597},{"label":"Out","value":781},{"label":"Nov","value":641},{"label":"Dez","value":684}];
const MX = 791;
