...
const KPIS = [{"l":"Tickets Abertos","v":"5.126","t":"-4.3%","d":"down"},{"l":"SLA Cumprido (%)","v":"79.2%","t":"-0.4%","d":"down"},{"l":"MTTR (h)","v":"110h","t":"+14.4%","d":"up"},{"l":"Satisfação (%)","v":"67.5%","t":"-2.6%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","547","6.988","605","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.699","4.588","1.946","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.416","4.433","8.860","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.136","5.585","435","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.427","5.261","2.455","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":367},{"label":"Mar","value":596},{"label":"Abr","value":531},{"label":"Mai","value":366},{"label":"Jun","value":542},{"label":"Jul","value":682},{"label":"Ago","value":615},{"label":"Set","value":722},{"label":"Out","value":529},{"label":"Nov","value":497},{"label":"Dez","value":722}];
const MX = 722;
