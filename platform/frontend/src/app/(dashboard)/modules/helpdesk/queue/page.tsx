...
const KPIS = [{"l":"Tickets Abertos","v":"7.203","t":"-4.5%","d":"down"},{"l":"SLA Cumprido (%)","v":"72.5%","t":"+5.2%","d":"up"},{"l":"MTTR (h)","v":"62h","t":"+4.3%","d":"up"},{"l":"Satisfação (%)","v":"81.5%","t":"+5.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","232","1.677","3.507","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","824","3.765","5.419","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.925","4.392","1.159","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","300","6.813","5.243","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.596","1.731","7.305","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":861},{"label":"Fev","value":691},{"label":"Mar","value":982},{"label":"Abr","value":708},{"label":"Mai","value":1036},{"label":"Jun","value":698},{"label":"Jul","value":853},{"label":"Ago","value":694},{"label":"Set","value":988},{"label":"Out","value":760},{"label":"Nov","value":679},{"label":"Dez","value":713}];
const MX = 1036;
