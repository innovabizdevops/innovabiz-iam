...
const PAGE = "Knowledge Suggest AI";
const KPIS = [{"l":"Tickets Abertos","v":"2.532","t":"+5.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"78.6%","t":"-0.2%","d":"down"},{"l":"MTTR (h)","v":"84h","t":"-2.5%","d":"down"},{"l":"Satisfação (%)","v":"70.7%","t":"+7.7%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.634","3.730","3.323","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.697","6.378","5.434","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.456","3.422","5.220","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.695","8.583","8.716","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.619","2.921","3.413","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":962},{"label":"Fev","value":713},{"label":"Mar","value":688},{"label":"Abr","value":848},{"label":"Mai","value":739},{"label":"Jun","value":709},{"label":"Jul","value":687},{"label":"Ago","value":815},{"label":"Set","value":668},{"label":"Out","value":1014},{"label":"Nov","value":968},{"label":"Dez","value":690}];
const MX = 1014;
