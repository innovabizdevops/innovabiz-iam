...
const PAGE = "Approve Vendor";
const KPIS = [{"l":"Aprovações Pendentes","v":"6.744","t":"-3.2%","d":"down"},{"l":"SLA Cumprido (%)","v":"72.3%","t":"-5.7%","d":"down"},{"l":"Tempo Médio (h)","v":"135h","t":"+9.1%","d":"up"},{"l":"Rejeitadas (%)","v":"69.2%","t":"+6.0%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","1.246","€ 21121.45","3.354","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","7.122","€ 43682.69","5.424","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","2.196","€ 48514.95","2.770","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","5.457","€ 21067.91","4.778","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","4.221","€ 41075.37","2.128","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":900},{"label":"Fev","value":658},{"label":"Mar","value":747},{"label":"Abr","value":841},{"label":"Mai","value":619},{"label":"Jun","value":865},{"label":"Jul","value":623},{"label":"Ago","value":766},{"label":"Set","value":857},{"label":"Out","value":844},{"label":"Nov","value":874},{"label":"Dez","value":615}];
const MX = 900;
