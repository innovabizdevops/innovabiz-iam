...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.788","t":"+9.7%","d":"up"},{"l":"NC Abertas","v":"6.820","t":"+14.6%","d":"up"},{"l":"Conformidade (%)","v":"72.1%","t":"-1.6%","d":"down"},{"l":"CAPAs Pendentes","v":"1.617","t":"-0.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.828","96.4%","6.993","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.376","98.5%","2.931","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.130","70.9%","6.992","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.186","71.3%","2.757","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.852","72.7%","8.823","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":897},{"label":"Fev","value":896},{"label":"Mar","value":619},{"label":"Abr","value":575},{"label":"Mai","value":652},{"label":"Jun","value":668},{"label":"Jul","value":750},{"label":"Ago","value":661},{"label":"Set","value":941},{"label":"Out","value":937},{"label":"Nov","value":804},{"label":"Dez","value":571}];
const MX = 941;
