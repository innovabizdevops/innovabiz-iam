...
/* ═══ Franchise Supply Chain — Dashboard ═══ */

const ACCENT = "#2563eb";

const KPIS = [
    { label: "Total Registos", value: "6974", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "21", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€21K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1790322874", cells: ["FRA-7874", "Franchise Supply Chain Item 1", "19/11/2026", "€22 974"], status: "active" as const },
    { id: "1790326445", cells: ["FRA-2445", "Franchise Supply Chain Item 2", "6/6/2026", "€26 545"], status: "pending" as const },
    { id: "1790330016", cells: ["FRA-6016", "Franchise Supply Chain Item 3", "21/1/2026", "€30 116"], status: "completed" as const },
    { id: "1790333587", cells: ["FRA-9587", "Franchise Supply Chain Item 4", "8/8/2026", "€33 687"], status: "warning" as const },
    { id: "1790337158", cells: ["FRA-4158", "Franchise Supply Chain Item 5", "23/3/2026", "€37 258"], status: "active" as const },
];
...
export default function FranchiseSupplyChainPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Franchise Supply Chain</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Franchise Supply Chain</p>
                    </div>
                </div>
