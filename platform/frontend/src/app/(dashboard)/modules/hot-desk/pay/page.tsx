...
const PAGE = "Pay";
const KPIS = [{"l":"Total Hot Desk","v":"490","t":"+0.1%","d":"up"},{"l":"Pay Ativos","v":"3.048","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"77.8%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"62","t":"+13.4%","d":"up"}];
const COLS = ["ID","Pay","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hot Desk #001","Hot Desk #002","5.196","4.932","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Hot Desk #002","Hot Desk #003","3.596","2.119","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Hot Desk #003","Hot Desk #004","1.790","7.831","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Hot Desk #004","Hot Desk #005","4.579","2.198","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hot Desk #005","Hot Desk #001","678","1.009","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":945},{"label":"Mar","value":590},{"label":"Abr","value":790},{"label":"Mai","value":895},{"label":"Jun","value":859},{"label":"Jul","value":703},{"label":"Ago","value":868},{"label":"Set","value":837},{"label":"Out","value":577},{"label":"Nov","value":877},{"label":"Dez","value":921}];
const MX = 945;
