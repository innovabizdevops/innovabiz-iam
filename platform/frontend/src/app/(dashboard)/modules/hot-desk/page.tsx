...
/* ═══ Hot Desk App — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "8252", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2590", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€476K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "87266752", cells: ["HOT-3752", "Hot Desk App Item 1", "21/5/2026", "€16 852"], status: "active" as const },
    { id: "87270323", cells: ["HOT-7323", "Hot Desk App Item 2", "8/12/2026", "€20 423"], status: "pending" as const },
    { id: "87273894", cells: ["HOT-1894", "Hot Desk App Item 3", "23/7/2026", "€23 994"], status: "completed" as const },
    { id: "87277465", cells: ["HOT-5465", "Hot Desk App Item 4", "10/2/2026", "€27 565"], status: "warning" as const },
    { id: "87281036", cells: ["HOT-9036", "Hot Desk App Item 5", "25/9/2026", "€31 136"], status: "active" as const },
];
...
export default function HotDeskAppPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Hot Desk App</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Hot Desk App</p>
                    </div>
                </div>
