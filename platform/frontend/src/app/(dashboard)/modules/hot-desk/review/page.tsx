...
const PAGE = "Review";
const KPIS = [{"l":"Total Hot Desk","v":"290","t":"+4.1%","d":"up"},{"l":"Review Ativos","v":"3.206","t":"+1.8%","d":"up"},{"l":"Eficiência (%)","v":"76.8%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"61","t":"+8.1%","d":"up"}];
const COLS = ["ID","Review","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hot Desk #001","Hot Desk #002","2.405","6.416","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Hot Desk #002","Hot Desk #003","7.967","6.720","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Hot Desk #003","Hot Desk #004","3.145","3.764","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Hot Desk #004","Hot Desk #005","4.926","780","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hot Desk #005","Hot Desk #001","5.072","1.943","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":680},{"label":"Mar","value":582},{"label":"Abr","value":436},{"label":"Mai","value":383},{"label":"Jun","value":558},{"label":"Jul","value":628},{"label":"Ago","value":704},{"label":"Set","value":566},{"label":"Out","value":649},{"label":"Nov","value":595},{"label":"Dez","value":371}];
const MX = 704;
