...
const ACCENT = "#4f46e5";
const MODULE = "Hot Desk App";
const PAGE = "Check In";
const KPIS = [{"l":"Total Hot Desk","v":"3.435","t":"-0.9%","d":"down"},{"l":"Check In Ativos","v":"2.937","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"70.8%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"58","t":"+1.8%","d":"up"}];
const COLS = ["ID","Check In","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hot Desk #001","2026-02-07","4.369","8.803","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Hot Desk #002","2026-03-03","506","7.210","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Hot Desk #003","2026-03-17","7.550","5.776","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Hot Desk #004","2026-01-28","5.777","3.827","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hot Desk #005","2026-01-08","7.896","8.666","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":639},{"label":"Mar","value":599},{"label":"Abr","value":768},{"label":"Mai","value":703},{"label":"Jun","value":609},{"label":"Jul","value":485},{"label":"Ago","value":650},{"label":"Set","value":518},{"label":"Out","value":688},{"label":"Nov","value":586},{"label":"Dez","value":551}];
const MX = 768;
