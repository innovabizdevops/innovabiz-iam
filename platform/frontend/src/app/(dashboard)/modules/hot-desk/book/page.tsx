...
const PAGE = "Book";
const KPIS = [{"l":"Total Hot Desk","v":"3.429","t":"+7.3%","d":"up"},{"l":"Book Ativos","v":"6.466","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"87.4%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"65","t":"-2.4%","d":"down"}];
const COLS = ["ID","Book","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hot Desk #001","Hot Desk #002","5.608","2.449","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Hot Desk #002","Hot Desk #003","3.826","2.023","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Hot Desk #003","Hot Desk #004","4.017","3.787","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Hot Desk #004","Hot Desk #005","7.921","3.942","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hot Desk #005","Hot Desk #001","3.022","5.138","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":570},{"label":"Fev","value":701},{"label":"Mar","value":580},{"label":"Abr","value":689},{"label":"Mai","value":910},{"label":"Jun","value":739},{"label":"Jul","value":592},{"label":"Ago","value":833},{"label":"Set","value":701},{"label":"Out","value":857},{"label":"Nov","value":930},{"label":"Dez","value":672}];
const MX = 930;
