...
const PAGE = "Find";
const KPIS = [{"l":"Total Hot Desk","v":"5.135","t":"+1.6%","d":"up"},{"l":"Find Ativos","v":"7.707","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"83.0%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"86","t":"+3.9%","d":"up"}];
const COLS = ["ID","Find","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hot Desk #001","Hot Desk #002","621","3.750","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Hot Desk #002","Hot Desk #003","7.331","4.809","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Hot Desk #003","Hot Desk #004","8.988","4.843","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Hot Desk #004","Hot Desk #005","2.292","6.513","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hot Desk #005","Hot Desk #001","5.059","5.761","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":579},{"label":"Mar","value":713},{"label":"Abr","value":717},{"label":"Mai","value":835},{"label":"Jun","value":657},{"label":"Jul","value":476},{"label":"Ago","value":668},{"label":"Set","value":636},{"label":"Out","value":569},{"label":"Nov","value":553},{"label":"Dez","value":684}];
const MX = 835;
