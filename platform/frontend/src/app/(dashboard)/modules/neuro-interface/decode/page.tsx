...
const ACCENT = "#ea580c";
const MODULE = "Neuro Interface";
const PAGE = "Neural Decode";
const KPIS = [{"l":"Total Neuro Interface","v":"8.596","t":"+7.9%","d":"up"},{"l":"Neural Decode Ativos","v":"5.553","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"81.3%","t":"+1.4%","d":"up"},{"l":"Score Performance","v":"61","t":"-3.2%","d":"down"}];
const COLS = ["ID","Neural Decode","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Neuro Interface #001","Neuro Interface #002","484","7.693","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Neuro Interface #002","Neuro Interface #003","2.290","1.727","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Neuro Interface #003","Neuro Interface #004","8.673","6.141","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Neuro Interface #004","Neuro Interface #005","5.464","4.716","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Neuro Interface #005","Neuro Interface #001","5.797","2.868","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":835},{"label":"Fev","value":632},{"label":"Mar","value":870},{"label":"Abr","value":614},{"label":"Mai","value":851},{"label":"Jun","value":727},{"label":"Jul","value":610},{"label":"Ago","value":974},{"label":"Set","value":708},{"label":"Out","value":875},{"label":"Nov","value":872},{"label":"Dez","value":792}];
const MX = 974;
