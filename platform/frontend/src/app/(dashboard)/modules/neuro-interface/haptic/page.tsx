...
const KPIS = [{"l":"Surveys Ativos","v":"304","t":"+17.5%","d":"up"},{"l":"Respostas/Semana","v":"555","t":"-4.7%","d":"down"},{"l":"NPS Médio","v":"85","t":"+9.5%","d":"up"},{"l":"Taxa Resposta (%)","v":"78.0%","t":"-4.0%","d":"down"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","5.541","65","77.0%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","3.274","90","84.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","3.137","60","84.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","7.473","84","97.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","5.086","66","93.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":911},{"label":"Mar","value":577},{"label":"Abr","value":745},{"label":"Mai","value":745},{"label":"Jun","value":876},{"label":"Jul","value":868},{"label":"Ago","value":534},{"label":"Set","value":763},{"label":"Out","value":888},{"label":"Nov","value":571},{"label":"Dez","value":778}];
const MX = 911;
