...
const PAGE = "BCI Design";
const KPIS = [{"l":"Formulários Ativos","v":"2.119","t":"+7.8%","d":"up"},{"l":"Submissões/Dia","v":"993","t":"-4.6%","d":"down"},{"l":"Documentos Gerados","v":"6.471","t":"+5.5%","d":"up"},{"l":"Templates","v":"1.724","t":"+13.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.210","2026-02-04","6.900","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.212","2026-02-24","1.898","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.046","2026-02-06","3.751","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.187","2026-02-19","6.882","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","249","2026-02-10","7.859","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":439},{"label":"Mar","value":461},{"label":"Abr","value":342},{"label":"Mai","value":339},{"label":"Jun","value":301},{"label":"Jul","value":353},{"label":"Ago","value":430},{"label":"Set","value":524},{"label":"Out","value":331},{"label":"Nov","value":282},{"label":"Dez","value":420}];
const MX = 573;
