...
export default function CarpetRugPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Carpet Rug</h1><p className="text-sm text-muted-foreground">Carpet Rug • iBOS Enterprise</p></div>
