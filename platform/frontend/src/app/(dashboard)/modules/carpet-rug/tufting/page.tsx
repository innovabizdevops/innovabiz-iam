...
const PAGE = "Tufting";
const KPIS = [{"l":"Total Carpet Rug","v":"8.772","t":"+8.9%","d":"up"},{"l":"Tufting Ativos","v":"3.378","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"90","t":"+1.4%","d":"up"}];
const COLS = ["ID","Tufting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Carpet Rug #001","Carpet Rug #002","8.320","7.080","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Carpet Rug #002","Carpet Rug #003","6.961","4.307","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Carpet Rug #003","Carpet Rug #004","7.802","260","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Carpet Rug #004","Carpet Rug #005","2.006","3.288","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carpet Rug #005","Carpet Rug #001","1.835","6.016","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":895},{"label":"Mar","value":1020},{"label":"Abr","value":1051},{"label":"Mai","value":977},{"label":"Jun","value":946},{"label":"Jul","value":765},{"label":"Ago","value":841},{"label":"Set","value":853},{"label":"Out","value":765},{"label":"Nov","value":862},{"label":"Dez","value":763}];
const MX = 1051;
...
export default function TuftingPage() {
    return (
