...
const ACCENT = "#6366f1";
const MODULE = "Carpet & Rug";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"7.790","t":"-5.9%","d":"down"},{"l":"Submissões/Dia","v":"225","t":"+1.5%","d":"up"},{"l":"Documentos Gerados","v":"564","t":"+15.3%","d":"up"},{"l":"Templates","v":"6.777","t":"+15.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.783","2026-01-01","7.907","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.796","2026-01-21","6.477","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.216","2026-01-14","996","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.354","2026-02-19","6.377","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.610","2026-03-13","8.973","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":662},{"label":"Mar","value":983},{"label":"Abr","value":875},{"label":"Mai","value":694},{"label":"Jun","value":942},{"label":"Jul","value":673},{"label":"Ago","value":632},{"label":"Set","value":770},{"label":"Out","value":851},{"label":"Nov","value":958},{"label":"Dez","value":754}];
const MX = 983;
