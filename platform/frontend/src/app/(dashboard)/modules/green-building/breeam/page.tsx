...
const PAGE = "BREEAM";
const KPIS = [{"l":"Total Green Building","v":"5.534","t":"+13.9%","d":"up"},{"l":"BREEAM Ativos","v":"5.914","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"88.7%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"81","t":"+4.4%","d":"up"}];
const COLS = ["ID","BREEAM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Green Building #001","Green Building #002","6.400","3.170","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Green Building #002","Green Building #003","6.577","155","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Green Building #003","Green Building #004","7.206","731","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Green Building #004","Green Building #005","1.746","1.013","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Green Building #005","Green Building #001","6.338","7.534","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":761},{"label":"Mar","value":603},{"label":"Abr","value":532},{"label":"Mai","value":796},{"label":"Jun","value":777},{"label":"Jul","value":523},{"label":"Ago","value":877},{"label":"Set","value":640},{"label":"Out","value":540},{"label":"Nov","value":573},{"label":"Dez","value":654}];
const MX = 877;
