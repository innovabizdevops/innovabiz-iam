...
const PAGE = "LEED Cert";
const KPIS = [{"l":"Total Green Building","v":"7.492","t":"+18.0%","d":"up"},{"l":"LEED Cert Ativos","v":"4.833","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"65.6%","t":"+5.0%","d":"up"},{"l":"Score Performance","v":"57","t":"-0.4%","d":"down"}];
const COLS = ["ID","LEED Cert","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Green Building #001","Green Building #002","3.339","2.368","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Green Building #002","Green Building #003","4.031","1.098","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Green Building #003","Green Building #004","8.237","6.666","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Green Building #004","Green Building #005","6.052","3.208","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Green Building #005","Green Building #001","686","1.291","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":724},{"label":"Mar","value":728},{"label":"Abr","value":619},{"label":"Mai","value":513},{"label":"Jun","value":716},{"label":"Jul","value":759},{"label":"Ago","value":585},{"label":"Set","value":557},{"label":"Out","value":550},{"label":"Nov","value":503},{"label":"Dez","value":760}];
const MX = 760;
