...
const ACCENT = "#facc15";
const MODULE = "Green Building";
const PAGE = "Energy Star";
const KPIS = [{"l":"Total Green Building","v":"1.388","t":"-5.5%","d":"down"},{"l":"Energy Star Ativos","v":"2.576","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"65.7%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"90","t":"+0.7%","d":"up"}];
const COLS = ["ID","Energy Star","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Green Building #001","Green Building #002","1.063","3.858","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Green Building #002","Green Building #003","8.076","5.678","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Green Building #003","Green Building #004","2.406","6.486","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Green Building #004","Green Building #005","2.202","7.687","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Green Building #005","Green Building #001","4.689","6.817","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":769},{"label":"Mar","value":866},{"label":"Abr","value":699},{"label":"Mai","value":772},{"label":"Jun","value":897},{"label":"Jul","value":961},{"label":"Ago","value":599},{"label":"Set","value":643},{"label":"Out","value":651},{"label":"Nov","value":821},{"label":"Dez","value":833}];
const MX = 961;
