...
const PAGE = "Net Zero";
const KPIS = [{"l":"Total Green Building","v":"8.788","t":"-5.4%","d":"down"},{"l":"Net Zero Ativos","v":"1.011","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"87.2%","t":"-2.3%","d":"down"},{"l":"Score Performance","v":"78","t":"-3.2%","d":"down"}];
const COLS = ["ID","Net Zero","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Green Building #001","Green Building #002","3.560","5.437","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Green Building #002","Green Building #003","2.150","6.654","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Green Building #003","Green Building #004","806","2.335","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Green Building #004","Green Building #005","3.422","7.520","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Green Building #005","Green Building #001","5.720","3.592","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":957},{"label":"Mar","value":968},{"label":"Abr","value":791},{"label":"Mai","value":832},{"label":"Jun","value":950},{"label":"Jul","value":773},{"label":"Ago","value":776},{"label":"Set","value":689},{"label":"Out","value":884},{"label":"Nov","value":735},{"label":"Dez","value":887}];
const MX = 968;
