...
const PAGE = "Deploy";
const KPIS = [{"l":"ARR (€M)","v":"€44.6M","t":"+16.8%","d":"up"},{"l":"MRR (€)","v":"€90349","t":"+6.6%","d":"up"},{"l":"Churn (%)","v":"87.8%","t":"-0.8%","d":"down"},{"l":"ARPU (€)","v":"€27988","t":"+5.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 3212.50","3.846","€ 45087.34","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 40984.57","6.774","€ 13780.23","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 6591.16","829","€ 13843.26","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 13469.72","626","€ 27948.91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 19969.37","1.232","€ 41356.88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":391},{"label":"Fev","value":325},{"label":"Mar","value":386},{"label":"Abr","value":229},{"label":"Mai","value":396},{"label":"Jun","value":552},{"label":"Jul","value":597},{"label":"Ago","value":444},{"label":"Set","value":619},{"label":"Out","value":473},{"label":"Nov","value":288},{"label":"Dez","value":489}];
const MX = 619;
