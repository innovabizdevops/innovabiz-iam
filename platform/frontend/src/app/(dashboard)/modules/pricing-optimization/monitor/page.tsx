...
const PAGE = "Monitor";
const KPIS = [{"l":"ARR (€M)","v":"€34.4M","t":"-3.5%","d":"down"},{"l":"MRR (€)","v":"€12631","t":"+17.5%","d":"up"},{"l":"Churn (%)","v":"87.6%","t":"+8.8%","d":"up"},{"l":"ARPU (€)","v":"€27580","t":"-2.0%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 35633.36","5.845","€ 15393.17","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 747.47","2.793","€ 31825.12","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 5513.02","7.085","€ 9209.75","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 35665.02","5.302","€ 32663.22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 9040.59","160","€ 10619.07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":802},{"label":"Mar","value":775},{"label":"Abr","value":925},{"label":"Mai","value":989},{"label":"Jun","value":911},{"label":"Jul","value":850},{"label":"Ago","value":1003},{"label":"Set","value":946},{"label":"Out","value":863},{"label":"Nov","value":1037},{"label":"Dez","value":800}];
const MX = 1037;
