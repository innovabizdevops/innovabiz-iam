...
const PAGE = "Test";
const KPIS = [{"l":"ARR (€M)","v":"€21.4M","t":"+13.2%","d":"up"},{"l":"MRR (€)","v":"€65977","t":"+7.3%","d":"up"},{"l":"Churn (%)","v":"86.3%","t":"+7.1%","d":"up"},{"l":"ARPU (€)","v":"€88753","t":"+8.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 10424.12","5.517","€ 48375.12","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 9928.60","4.135","€ 8403.46","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 33120.26","1.460","€ 18824.92","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 30356.82","244","€ 31233.13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 36167.66","3.654","€ 26825.23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":421},{"label":"Fev","value":593},{"label":"Mar","value":442},{"label":"Abr","value":565},{"label":"Mai","value":614},{"label":"Jun","value":559},{"label":"Jul","value":332},{"label":"Ago","value":397},{"label":"Set","value":286},{"label":"Out","value":435},{"label":"Nov","value":621},{"label":"Dez","value":628}];
const MX = 628;
