...
const ACCENT = "#0891b2";
const MODULE = "Pricing Optimization (AI)";
const PAGE = "Model";
const KPIS = [{"l":"ARR (€M)","v":"€1.6M","t":"-1.2%","d":"down"},{"l":"MRR (€)","v":"€3488","t":"+11.6%","d":"up"},{"l":"Churn (%)","v":"95.0%","t":"+7.5%","d":"up"},{"l":"ARPU (€)","v":"€40010","t":"-4.7%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 11130.84","5.259","€ 47527.38","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 24374.77","4.286","€ 23665.25","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 24122.25","1.586","€ 30989.24","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 5683.24","1.629","€ 18361.95","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 39731.24","7.607","€ 21501.16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":795},{"label":"Fev","value":723},{"label":"Mar","value":880},{"label":"Abr","value":773},{"label":"Mai","value":800},{"label":"Jun","value":754},{"label":"Jul","value":692},{"label":"Ago","value":554},{"label":"Set","value":654},{"label":"Out","value":725},{"label":"Nov","value":908},{"label":"Dez","value":553}];
const MX = 908;
