...
const PAGE = "Simulate";
const KPIS = [{"l":"Twins Ativos","v":"6.926","t":"+3.9%","d":"up"},{"l":"Simulações/Dia","v":"1851","t":"+4.6%","d":"up"},{"l":"Precisão Modelo (%)","v":"66.2%","t":"+3.7%","d":"up"},{"l":"Latência Sync (ms)","v":"36ms","t":"+6.3%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","80.5%","2026-03-16","5.544","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","74.5%","2026-03-10","6.450","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","74.9%","2026-01-26","3.121","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","70.1%","2026-03-22","210","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","94.5%","2026-03-04","3.094","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":897},{"label":"Fev","value":1056},{"label":"Mar","value":1081},{"label":"Abr","value":1029},{"label":"Mai","value":926},{"label":"Jun","value":755},{"label":"Jul","value":1065},{"label":"Ago","value":805},{"label":"Set","value":716},{"label":"Out","value":997},{"label":"Nov","value":1071},{"label":"Dez","value":844}];
const MX = 1081;
