...
/* ═══ Pricing Optimization (AI) — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "6313", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4575", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€174K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1066513413", cells: ["PRI-5413", "Pricing Optimization (AI) Item 1", "22/10/2026", "€13 513"], status: "active" as const },
    { id: "1066516984", cells: ["PRI-8984", "Pricing Optimization (AI) Item 2", "9/5/2026", "€17 084"], status: "pending" as const },
    { id: "1066520555", cells: ["PRI-3555", "Pricing Optimization (AI) Item 3", "24/12/2026", "€20 655"], status: "completed" as const },
    { id: "1066524126", cells: ["PRI-7126", "Pricing Optimization (AI) Item 4", "11/7/2026", "€24 226"], status: "warning" as const },
    { id: "1066527697", cells: ["PRI-1697", "Pricing Optimization (AI) Item 5", "26/2/2026", "€27 797"], status: "active" as const },
];
...
export default function PricingOptimizationAiPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pricing Optimization (AI)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pricing Optimization (AI)</p>
                    </div>
                </div>
