...
const PAGE = "Database";
const KPIS = [{"l":"Total License Plate","v":"8.744","t":"+10.1%","d":"up"},{"l":"Database Ativos","v":"6.599","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"70.6%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"58","t":"+11.5%","d":"up"}];
const COLS = ["ID","Database","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["License Plate #001","2026-03-19","5.870","7.347","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["License Plate #002","2026-02-05","7.264","6.534","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["License Plate #003","2026-02-07","453","7.660","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["License Plate #004","2026-02-10","1.796","3.879","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["License Plate #005","2026-03-12","3.459","758","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":609},{"label":"Mar","value":687},{"label":"Abr","value":475},{"label":"Mai","value":768},{"label":"Jun","value":849},{"label":"Jul","value":703},{"label":"Ago","value":788},{"label":"Set","value":661},{"label":"Out","value":785},{"label":"Nov","value":598},{"label":"Dez","value":840}];
const MX = 849;
