...
const KPIS = [{"l":"Dashboards Ativos","v":"1.671","t":"-0.3%","d":"down"},{"l":"Queries/Dia","v":"2544","t":"+4.4%","d":"up"},{"l":"Dados Processados (GB)","v":"1.289","t":"-4.2%","d":"down"},{"l":"Utilizadores Analytics","v":"2.442","t":"+2.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2858","2026-01-06","2.962","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2035","2026-01-01","6.831","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2937","2026-03-09","3.710","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3777","2026-03-25","6.832","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4105","2026-02-07","7.348","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":638},{"label":"Mar","value":921},{"label":"Abr","value":739},{"label":"Mai","value":618},{"label":"Jun","value":855},{"label":"Jul","value":750},{"label":"Ago","value":870},{"label":"Set","value":919},{"label":"Out","value":550},{"label":"Nov","value":863},{"label":"Dez","value":587}];
const MX = 921;
