...
const ACCENT = "#6366f1";
const MODULE = "License Plate Recognition";
const PAGE = "Recognize";
const KPIS = [{"l":"Total License Plate","v":"7.576","t":"-1.7%","d":"down"},{"l":"Recognize Ativos","v":"2.591","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"81.3%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"72","t":"+1.3%","d":"up"}];
const COLS = ["ID","Recognize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["License Plate #001","License Plate #002","7.686","7.668","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["License Plate #002","License Plate #003","920","3.477","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["License Plate #003","License Plate #004","4.687","5.160","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["License Plate #004","License Plate #005","6.429","8.785","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["License Plate #005","License Plate #001","6.532","8.982","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":471},{"label":"Fev","value":696},{"label":"Mar","value":622},{"label":"Abr","value":673},{"label":"Mai","value":676},{"label":"Jun","value":483},{"label":"Jul","value":530},{"label":"Ago","value":685},{"label":"Set","value":715},{"label":"Out","value":689},{"label":"Nov","value":492},{"label":"Dez","value":540}];
const MX = 715;
