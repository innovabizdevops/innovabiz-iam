...
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"7.550","t":"+14.7%","d":"up"},{"l":"Taxa Entrega (%)","v":"83.4%","t":"+1.7%","d":"up"},{"l":"Taxa Abertura (%)","v":"88.0%","t":"+4.7%","d":"up"},{"l":"Escalações","v":"1.423","t":"+2.8%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","2.620","95.9%","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","5.291","74.8%","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","2.518","86.1%","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","8.684","99.8%","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","6.577","79.1%","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":338},{"label":"Fev","value":365},{"label":"Mar","value":510},{"label":"Abr","value":446},{"label":"Mai","value":543},{"label":"Jun","value":633},{"label":"Jul","value":526},{"label":"Ago","value":634},{"label":"Set","value":523},{"label":"Out","value":622},{"label":"Nov","value":598},{"label":"Dez","value":359}];
const MX = 634;
