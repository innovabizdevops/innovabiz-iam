...
const ACCENT = "#4f46e5";
const MODULE = "Spectrum Management";
const PAGE = "Auction Mgmt";
const KPIS = [{"l":"Total Spectrum Mgmt","v":"1.965","t":"+12.8%","d":"up"},{"l":"Auction Mgmt Ativos","v":"6.267","t":"+7.7%","d":"up"},{"l":"Eficiência (%)","v":"67.3%","t":"+17.1%","d":"up"},{"l":"Score Performance","v":"58","t":"+12.8%","d":"up"}];
const COLS = ["ID","Auction Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Spectrum Mgmt #001","Spectrum Mgmt #002","2.548","6.599","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Spectrum Mgmt #002","Spectrum Mgmt #003","5.759","2.646","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Spectrum Mgmt #003","Spectrum Mgmt #004","6.355","7.854","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Spectrum Mgmt #004","Spectrum Mgmt #005","8.017","6.720","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Spectrum Mgmt #005","Spectrum Mgmt #001","3.463","1.447","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1016},{"label":"Fev","value":652},{"label":"Mar","value":1015},{"label":"Abr","value":994},{"label":"Mai","value":904},{"label":"Jun","value":1019},{"label":"Jul","value":688},{"label":"Ago","value":740},{"label":"Set","value":834},{"label":"Out","value":683},{"label":"Nov","value":781},{"label":"Dez","value":1005}];
const MX = 1019;
