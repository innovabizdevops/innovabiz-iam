...
const ACCENT = "#6366f1";
const MODULE = "Rare Earth Elements";
const PAGE = "Separation";
const KPIS = [{"l":"Total Rare Earth","v":"1.851","t":"+7.7%","d":"up"},{"l":"Separation Ativos","v":"6.894","t":"-4.8%","d":"down"},{"l":"Eficiência (%)","v":"81.1%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"80","t":"+4.9%","d":"up"}];
const COLS = ["ID","Separation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rare Earth #001","Rare Earth #002","3.452","7.586","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Rare Earth #002","Rare Earth #003","5.651","5.798","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Rare Earth #003","Rare Earth #004","2.925","5.614","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Rare Earth #004","Rare Earth #005","8.031","4.715","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rare Earth #005","Rare Earth #001","1.082","2.440","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":589},{"label":"Mar","value":410},{"label":"Abr","value":517},{"label":"Mai","value":375},{"label":"Jun","value":612},{"label":"Jul","value":528},{"label":"Ago","value":599},{"label":"Set","value":391},{"label":"Out","value":511},{"label":"Nov","value":377},{"label":"Dez","value":590}];
const MX = 650;
