...
const KPIS = [{"l":"Total Rare Earth","v":"7.987","t":"+9.8%","d":"up"},{"l":"Supply Chain Ativos","v":"399","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"82.6%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"75","t":"+5.3%","d":"up"}];
const COLS = ["ID","Supply Chain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rare Earth #001","Rare Earth #002","5.281","5.283","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Rare Earth #002","Rare Earth #003","1.866","3.004","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Rare Earth #003","Rare Earth #004","1.798","3.924","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Rare Earth #004","Rare Earth #005","7.609","7.205","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rare Earth #005","Rare Earth #001","6.386","1.670","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":887},{"label":"Fev","value":826},{"label":"Mar","value":663},{"label":"Abr","value":763},{"label":"Mai","value":839},{"label":"Jun","value":691},{"label":"Jul","value":601},{"label":"Ago","value":640},{"label":"Set","value":927},{"label":"Out","value":813},{"label":"Nov","value":599},{"label":"Dez","value":935}];
const MX = 935;
