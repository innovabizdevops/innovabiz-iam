...
/* ═══ RAG Architecture Deep — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "607", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3786", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€33K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "-15%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1209681507", cells: ["GEN-1507", "RAG Architecture Deep Item 1", "28/4/2026", "€31 607"], status: "active" as const },
    { id: "1209685078", cells: ["GEN-5078", "RAG Architecture Deep Item 2", "15/11/2026", "€35 178"], status: "pending" as const },
    { id: "1209688649", cells: ["GEN-8649", "RAG Architecture Deep Item 3", "2/6/2026", "€38 749"], status: "completed" as const },
    { id: "1209692220", cells: ["GEN-3220", "RAG Architecture Deep Item 4", "17/1/2026", "€42 320"], status: "warning" as const },
    { id: "1209695791", cells: ["GEN-6791", "RAG Architecture Deep Item 5", "4/8/2026", "€45 891"], status: "active" as const },
];
...
export default function RagArchitectureDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">RAG Architecture Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • RAG Architecture Deep</p>
                    </div>
                </div>
