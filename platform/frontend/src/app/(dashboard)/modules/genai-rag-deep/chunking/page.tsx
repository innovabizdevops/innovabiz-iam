...
const PAGE = "Chunking Engine";
const KPIS = [{"l":"Total Genai Rag Deep","v":"4.975","t":"+5.0%","d":"up"},{"l":"Chunking Engine Ativos","v":"6.721","t":"-1.7%","d":"down"},{"l":"Eficiência (%)","v":"78.3%","t":"+4.1%","d":"up"},{"l":"Score Performance","v":"87","t":"+17.9%","d":"up"}];
const COLS = ["ID","Chunking Engine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Rag Deep #001","Genai Rag Deep #002","2.628","6.282","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Rag Deep #002","Genai Rag Deep #003","3.512","8.743","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Rag Deep #003","Genai Rag Deep #004","7.532","7.021","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Rag Deep #004","Genai Rag Deep #005","732","4.989","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Rag Deep #005","Genai Rag Deep #001","7.992","1.649","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":687},{"label":"Mar","value":478},{"label":"Abr","value":626},{"label":"Mai","value":624},{"label":"Jun","value":714},{"label":"Jul","value":590},{"label":"Ago","value":474},{"label":"Set","value":827},{"label":"Out","value":770},{"label":"Nov","value":590},{"label":"Dez","value":785}];
const MX = 827;
