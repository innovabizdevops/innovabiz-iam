...
const ACCENT = "#6d28d9";
const MODULE = "RAG Architecture Deep";
const PAGE = "Embedding Pipeline";
const KPIS = [{"l":"Dashboards Ativos","v":"3.286","t":"+14.4%","d":"up"},{"l":"Queries/Dia","v":"116","t":"+7.5%","d":"up"},{"l":"Dados Processados (GB)","v":"6.450","t":"+3.6%","d":"up"},{"l":"Utilizadores Analytics","v":"1.070","t":"-4.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3953","2026-01-27","8.687","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2357","2026-01-08","6.874","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3996","2026-02-10","524","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3453","2026-02-12","2.999","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2023","2026-01-19","375","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":821},{"label":"Mar","value":628},{"label":"Abr","value":904},{"label":"Mai","value":688},{"label":"Jun","value":775},{"label":"Jul","value":914},{"label":"Ago","value":934},{"label":"Set","value":809},{"label":"Out","value":747},{"label":"Nov","value":920},{"label":"Dez","value":921}];
const MX = 934;
