...
export default function FlexoPrintPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Flexo Print</h1><p className="text-sm text-muted-foreground">Flexo Print • iBOS Enterprise</p></div>
