...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.179","t":"-1.0%","d":"down"},{"l":"NC Abertas","v":"2.012","t":"+0.6%","d":"up"},{"l":"Conformidade (%)","v":"91.9%","t":"+2.8%","d":"up"},{"l":"CAPAs Pendentes","v":"3.943","t":"-4.1%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.402","83.2%","874","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.523","88.7%","2.342","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.482","85.8%","2.775","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","653","73.1%","2.889","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.712","78.9%","2.927","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":455},{"label":"Mar","value":528},{"label":"Abr","value":394},{"label":"Mai","value":597},{"label":"Jun","value":531},{"label":"Jul","value":456},{"label":"Ago","value":524},{"label":"Set","value":231},{"label":"Out","value":249},{"label":"Nov","value":420},{"label":"Dez","value":556}];
const MX = 597;
