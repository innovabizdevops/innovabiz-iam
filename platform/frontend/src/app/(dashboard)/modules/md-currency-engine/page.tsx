...
/* ═══ MD: Multi-Currency Deep — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "2907", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1228", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€379K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "566223407", cells: ["MD-7407", "MD: Multi-Currency Deep Item 1", "16/12/2026", "€23 507"], status: "active" as const },
    { id: "566226978", cells: ["MD-1978", "MD: Multi-Currency Deep Item 2", "3/7/2026", "€27 078"], status: "pending" as const },
    { id: "566230549", cells: ["MD-5549", "MD: Multi-Currency Deep Item 3", "18/2/2026", "€30 649"], status: "completed" as const },
    { id: "566234120", cells: ["MD-9120", "MD: Multi-Currency Deep Item 4", "5/9/2026", "€34 220"], status: "warning" as const },
    { id: "566237691", cells: ["MD-3691", "MD: Multi-Currency Deep Item 5", "20/4/2026", "€37 791"], status: "active" as const },
];
...
export default function MdMulticurrencyDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Currency Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Currency Deep</p>
                    </div>
                </div>
