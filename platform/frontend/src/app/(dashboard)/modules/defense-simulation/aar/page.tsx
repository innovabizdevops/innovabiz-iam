...
const PAGE = "AAR";
const KPIS = [{"l":"Twins Ativos","v":"5.958","t":"+2.6%","d":"up"},{"l":"Simulações/Dia","v":"2773","t":"+15.4%","d":"up"},{"l":"Precisão Modelo (%)","v":"84.6%","t":"+7.5%","d":"up"},{"l":"Latência Sync (ms)","v":"120ms","t":"+0.7%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","93.7%","2026-03-13","2.660","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","93.5%","2026-01-13","6.737","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","76.9%","2026-02-10","2.633","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","79.8%","2026-03-10","3.452","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","95.9%","2026-02-11","7.042","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":870},{"label":"Mar","value":519},{"label":"Abr","value":765},{"label":"Mai","value":621},{"label":"Jun","value":542},{"label":"Jul","value":534},{"label":"Ago","value":632},{"label":"Set","value":606},{"label":"Out","value":539},{"label":"Nov","value":821},{"label":"Dez","value":500}];
const MX = 870;
