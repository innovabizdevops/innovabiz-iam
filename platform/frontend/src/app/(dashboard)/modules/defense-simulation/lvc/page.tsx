...
const ACCENT = "#6366f1";
const MODULE = "Defense Simulation";
const PAGE = "Live/Virtual";
const KPIS = [{"l":"Twins Ativos","v":"894","t":"+5.9%","d":"up"},{"l":"Simulações/Dia","v":"3828","t":"+0.7%","d":"up"},{"l":"Precisão Modelo (%)","v":"75.2%","t":"+13.6%","d":"up"},{"l":"Latência Sync (ms)","v":"57ms","t":"+5.7%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","82.6%","2026-01-14","4.810","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","98.4%","2026-02-19","4.327","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","84.7%","2026-01-22","3.851","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","80.9%","2026-02-16","1.150","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","70.9%","2026-01-22","6.656","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":474},{"label":"Fev","value":470},{"label":"Mar","value":517},{"label":"Abr","value":276},{"label":"Mai","value":445},{"label":"Jun","value":627},{"label":"Jul","value":442},{"label":"Ago","value":326},{"label":"Set","value":550},{"label":"Out","value":466},{"label":"Nov","value":533},{"label":"Dez","value":609}];
const MX = 627;
