...
const PAGE = "Wargame";
const KPIS = [{"l":"Twins Ativos","v":"4.882","t":"+12.2%","d":"up"},{"l":"Simulações/Dia","v":"1763","t":"+8.4%","d":"up"},{"l":"Precisão Modelo (%)","v":"67.7%","t":"+7.3%","d":"up"},{"l":"Latência Sync (ms)","v":"31ms","t":"+6.5%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","88.8%","2026-01-02","1.856","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","85.2%","2026-03-03","3.578","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","95.3%","2026-01-08","6.104","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","96.8%","2026-03-26","4.744","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","97.2%","2026-03-08","6.084","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":837},{"label":"Fev","value":1064},{"label":"Mar","value":878},{"label":"Abr","value":998},{"label":"Mai","value":730},{"label":"Jun","value":921},{"label":"Jul","value":989},{"label":"Ago","value":760},{"label":"Set","value":698},{"label":"Out","value":830},{"label":"Nov","value":745},{"label":"Dez","value":695}];
const MX = 1064;
