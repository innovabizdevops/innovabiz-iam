...
const PAGE = "Analysis";
const KPIS = [{"l":"Twins Ativos","v":"2.397","t":"+14.5%","d":"up"},{"l":"Simulações/Dia","v":"930","t":"+5.4%","d":"up"},{"l":"Precisão Modelo (%)","v":"87.0%","t":"+9.1%","d":"up"},{"l":"Latência Sync (ms)","v":"117ms","t":"-2.7%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","87.9%","2026-03-09","2.757","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","87.0%","2026-03-23","2.930","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","85.8%","2026-03-20","6.410","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","84.9%","2026-01-21","2.145","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","78.6%","2026-03-10","1.979","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":539},{"label":"Mar","value":272},{"label":"Abr","value":393},{"label":"Mai","value":244},{"label":"Jun","value":513},{"label":"Jul","value":343},{"label":"Ago","value":423},{"label":"Set","value":464},{"label":"Out","value":521},{"label":"Nov","value":290},{"label":"Dez","value":431}];
const MX = 561;
