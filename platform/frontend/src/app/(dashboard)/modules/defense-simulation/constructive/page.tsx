...
const PAGE = "Constructive";
const KPIS = [{"l":"Twins Ativos","v":"6.778","t":"+0.2%","d":"up"},{"l":"Simulações/Dia","v":"1122","t":"+4.6%","d":"up"},{"l":"Precisão Modelo (%)","v":"91.0%","t":"+10.1%","d":"up"},{"l":"Latência Sync (ms)","v":"63ms","t":"-5.3%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","96.6%","2026-01-11","7.339","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","97.7%","2026-02-27","5.941","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","77.7%","2026-02-19","4.221","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","85.2%","2026-02-17","9.025","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","74.8%","2026-03-13","5.097","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":849},{"label":"Fev","value":714},{"label":"Mar","value":847},{"label":"Abr","value":790},{"label":"Mai","value":719},{"label":"Jun","value":508},{"label":"Jul","value":834},{"label":"Ago","value":512},{"label":"Set","value":890},{"label":"Out","value":635},{"label":"Nov","value":852},{"label":"Dez","value":514}];
const MX = 890;
