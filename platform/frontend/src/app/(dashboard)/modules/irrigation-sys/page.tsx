...
export default function IrrigationSysPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Irrigation Sys</h1><p className="text-sm text-muted-foreground">Irrigation Sys • iBOS</p></div>
            </div>
