...
const ACCENT = "#6366f1";
const MODULE = "Irrigation Systems";
const PAGE = "Schedule";
const KPIS = [{"l":"Total Irrigation Sys","v":"4.794","t":"+6.7%","d":"up"},{"l":"Schedule Ativos","v":"7.165","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"91.7%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"71","t":"-2.3%","d":"down"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Irrigation Sys #001","Irrigation Sys #002","4.075","1.594","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Irrigation Sys #002","Irrigation Sys #003","218","113","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Irrigation Sys #003","Irrigation Sys #004","3.113","1.772","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Irrigation Sys #004","Irrigation Sys #005","4.986","4.608","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Irrigation Sys #005","Irrigation Sys #001","8.261","629","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":413},{"label":"Fev","value":514},{"label":"Mar","value":703},{"label":"Abr","value":416},{"label":"Mai","value":735},{"label":"Jun","value":643},{"label":"Jul","value":554},{"label":"Ago","value":409},{"label":"Set","value":389},{"label":"Out","value":402},{"label":"Nov","value":440},{"label":"Dez","value":613}];
const MX = 735;
