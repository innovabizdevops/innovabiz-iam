...
const PAGE = "Pivot";
const KPIS = [{"l":"Dashboards Ativos","v":"7.247","t":"+14.2%","d":"up"},{"l":"Queries/Dia","v":"135","t":"+5.4%","d":"up"},{"l":"Dados Processados (GB)","v":"299","t":"+6.2%","d":"up"},{"l":"Utilizadores Analytics","v":"6.221","t":"+8.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","446","2026-02-19","8.999","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1329","2026-02-13","4.194","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3957","2026-01-02","6.588","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3235","2026-03-15","2.389","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1908","2026-01-05","4.170","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":596},{"label":"Mar","value":900},{"label":"Abr","value":523},{"label":"Mai","value":872},{"label":"Jun","value":828},{"label":"Jul","value":714},{"label":"Ago","value":863},{"label":"Set","value":634},{"label":"Out","value":797},{"label":"Nov","value":689},{"label":"Dez","value":550}];
const MX = 900;
