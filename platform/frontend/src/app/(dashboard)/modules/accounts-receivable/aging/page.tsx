...
const PAGE = "Customer Aging";
const KPIS = [{"l":"Total Accounts Receivable","v":"4.915","t":"+14.0%","d":"up"},{"l":"Customer Aging Ativos","v":"€87428","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"80.2%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"89","t":"+8.8%","d":"up"}];
const COLS = ["ID","Customer Aging","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Accounts Receivable #001","€ 47441.48","8.638","4.858","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Accounts Receivable #002","€ 12126.52","7.170","713","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Accounts Receivable #003","€ 25852.95","6.199","5.587","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Accounts Receivable #004","€ 48312.26","1.584","5.040","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Accounts Receivable #005","€ 44586.80","5.116","4.851","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":774},{"label":"Mar","value":668},{"label":"Abr","value":957},{"label":"Mai","value":651},{"label":"Jun","value":683},{"label":"Jul","value":871},{"label":"Ago","value":956},{"label":"Set","value":1033},{"label":"Out","value":970},{"label":"Nov","value":877},{"label":"Dez","value":866}];
const MX = 1033;
