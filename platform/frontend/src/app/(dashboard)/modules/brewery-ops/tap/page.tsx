...
const PAGE = "Tap Room";
const KPIS = [{"l":"Total Brewery Ops","v":"8.115","t":"+5.3%","d":"up"},{"l":"Tap Room Ativos","v":"5.948","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"86.0%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"73","t":"+12.7%","d":"up"}];
const COLS = ["ID","Tap Room","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brewery Ops #001","Brewery Ops #002","486","6.834","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Brewery Ops #002","Brewery Ops #003","4.705","7.499","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Brewery Ops #003","Brewery Ops #004","3.961","3.599","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Brewery Ops #004","Brewery Ops #005","8.720","7.913","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brewery Ops #005","Brewery Ops #001","4.931","3.838","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":913},{"label":"Mar","value":619},{"label":"Abr","value":627},{"label":"Mai","value":619},{"label":"Jun","value":927},{"label":"Jul","value":818},{"label":"Ago","value":756},{"label":"Set","value":978},{"label":"Out","value":818},{"label":"Nov","value":836},{"label":"Dez","value":646}];
const MX = 978;
