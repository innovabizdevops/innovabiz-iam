...
const ACCENT = "#6366f1";
const MODULE = "Brewery Operations";
const PAGE = "Ferment";
const KPIS = [{"l":"Riscos Identificados","v":"1.078","t":"+10.8%","d":"up"},{"l":"Mitigações Ativas","v":"1.669","t":"-5.2%","d":"down"},{"l":"Score Risco Geral","v":"67","t":"+12.3%","d":"up"},{"l":"Incidentes YTD","v":"2.669","t":"+4.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.649","2.963","3.351","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.709","1.105","4.928","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.667","9.010","8.195","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.587","8.890","1.908","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.233","4.753","3.243","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":374},{"label":"Mar","value":448},{"label":"Abr","value":403},{"label":"Mai","value":539},{"label":"Jun","value":430},{"label":"Jul","value":290},{"label":"Ago","value":452},{"label":"Set","value":470},{"label":"Out","value":582},{"label":"Nov","value":262},{"label":"Dez","value":530}];
const MX = 582;
