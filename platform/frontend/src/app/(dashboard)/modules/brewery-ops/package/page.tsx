...
const PAGE = "Package";
const KPIS = [{"l":"Total Brewery Ops","v":"1.937","t":"+13.5%","d":"up"},{"l":"Package Ativos","v":"3.084","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"91.4%","t":"-1.8%","d":"down"},{"l":"Score Performance","v":"87","t":"+14.9%","d":"up"}];
const COLS = ["ID","Package","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brewery Ops #001","Brewery Ops #002","8.793","4.675","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Brewery Ops #002","Brewery Ops #003","1.715","5.143","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Brewery Ops #003","Brewery Ops #004","2.283","435","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Brewery Ops #004","Brewery Ops #005","323","2.485","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brewery Ops #005","Brewery Ops #001","4.197","3.202","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":832},{"label":"Mar","value":594},{"label":"Abr","value":756},{"label":"Mai","value":729},{"label":"Jun","value":789},{"label":"Jul","value":892},{"label":"Ago","value":926},{"label":"Set","value":611},{"label":"Out","value":923},{"label":"Nov","value":672},{"label":"Dez","value":826}];
const MX = 926;
