...
const PAGE = "Brew";
const KPIS = [{"l":"Total Brewery Ops","v":"4.042","t":"+0.6%","d":"up"},{"l":"Brew Ativos","v":"667","t":"+11.7%","d":"up"},{"l":"Eficiência (%)","v":"79.5%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"91","t":"+7.1%","d":"up"}];
const COLS = ["ID","Brew","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brewery Ops #001","Brewery Ops #002","1.804","5.368","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Brewery Ops #002","Brewery Ops #003","3.342","2.322","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Brewery Ops #003","Brewery Ops #004","6.781","5.557","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Brewery Ops #004","Brewery Ops #005","380","3.012","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brewery Ops #005","Brewery Ops #001","8.917","7.951","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":529},{"label":"Mar","value":462},{"label":"Abr","value":368},{"label":"Mai","value":366},{"label":"Jun","value":495},{"label":"Jul","value":489},{"label":"Ago","value":439},{"label":"Set","value":656},{"label":"Out","value":337},{"label":"Nov","value":614},{"label":"Dez","value":364}];
const MX = 656;
