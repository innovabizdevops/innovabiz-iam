...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.616","t":"-5.4%","d":"down"},{"l":"NC Abertas","v":"7.716","t":"+12.0%","d":"up"},{"l":"Conformidade (%)","v":"68.9%","t":"+10.3%","d":"up"},{"l":"CAPAs Pendentes","v":"8.702","t":"+8.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.582","87.4%","7.912","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","853","95.9%","5.107","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.056","91.2%","4.114","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.734","75.6%","2.236","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.040","75.2%","1.494","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":476},{"label":"Fev","value":710},{"label":"Mar","value":440},{"label":"Abr","value":736},{"label":"Mai","value":759},{"label":"Jun","value":709},{"label":"Jul","value":616},{"label":"Ago","value":657},{"label":"Set","value":617},{"label":"Out","value":405},{"label":"Nov","value":746},{"label":"Dez","value":515}];
const MX = 759;
