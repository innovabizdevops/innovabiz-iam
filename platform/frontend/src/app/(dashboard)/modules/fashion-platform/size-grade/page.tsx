...
/* ═══ Fashion Platform — Size Grade ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "3048", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "439", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3230", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "494212867", cells: ["FAS-5867", "Size Grade Item 1", "16/8/2026", "€12 967"], status: "active" as const },
    { id: "494216438", cells: ["FAS-9438", "Size Grade Item 2", "3/3/2026", "€16 538"], status: "pending" as const },
    { id: "494220009", cells: ["FAS-4009", "Size Grade Item 3", "18/10/2026", "€20 109"], status: "completed" as const },
    { id: "494223580", cells: ["FAS-7580", "Size Grade Item 4", "5/5/2026", "€23 680"], status: "warning" as const },
    { id: "494227151", cells: ["FAS-2151", "Size Grade Item 5", "20/12/2026", "€27 251"], status: "active" as const },
];
...
export default function FashionPlatformSizeGradePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Size Grade</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Fashion Platform • Size Grade</p>
                    </div>
                </div>
