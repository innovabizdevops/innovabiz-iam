...
/* ═══ Fashion Platform — Showroom Digital ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "4564", trend: "-5%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "329", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3256", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "76%", trend: "-12%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "396417429", cells: ["FAS-4429", "Showroom Digital Item 1", "10/10/2026", "€17 529"], status: "active" as const },
    { id: "396421000", cells: ["FAS-8000", "Showroom Digital Item 2", "25/5/2026", "€21 100"], status: "pending" as const },
    { id: "396424571", cells: ["FAS-2571", "Showroom Digital Item 3", "12/12/2026", "€24 671"], status: "completed" as const },
    { id: "396428142", cells: ["FAS-6142", "Showroom Digital Item 4", "27/7/2026", "€28 242"], status: "warning" as const },
    { id: "396431713", cells: ["FAS-9713", "Showroom Digital Item 5", "14/2/2026", "€31 813"], status: "active" as const },
];
...
export default function FashionPlatformShowroomDigitalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Showroom Digital</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Fashion Platform • Showroom Digital</p>
                    </div>
                </div>
