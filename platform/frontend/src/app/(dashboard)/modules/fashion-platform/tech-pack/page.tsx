...
/* ═══ Fashion Platform — Tech Pack ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "1710", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "86", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "274", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1411617090", cells: ["FAS-4090", "Tech Pack Item 1", "3/7/2026", "€17 190"], status: "active" as const },
    { id: "1411620661", cells: ["FAS-7661", "Tech Pack Item 2", "18/2/2026", "€20 761"], status: "pending" as const },
    { id: "1411624232", cells: ["FAS-2232", "Tech Pack Item 3", "5/9/2026", "€24 332"], status: "completed" as const },
    { id: "1411627803", cells: ["FAS-5803", "Tech Pack Item 4", "20/4/2026", "€27 903"], status: "warning" as const },
    { id: "1411631374", cells: ["FAS-9374", "Tech Pack Item 5", "7/11/2026", "€31 474"], status: "active" as const },
];
...
export default function FashionPlatformTechPackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tech Pack</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Fashion Platform • Tech Pack</p>
                    </div>
                </div>
