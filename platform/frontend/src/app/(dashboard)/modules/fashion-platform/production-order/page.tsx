...
/* ═══ Fashion Platform — Production Order ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "2052", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "384", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "385", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "283141996", cells: ["FAS-2996", "Production Order Item 1", "5/5/2026", "€42 096"], status: "active" as const },
    { id: "283145567", cells: ["FAS-6567", "Production Order Item 2", "20/12/2026", "€45 667"], status: "pending" as const },
    { id: "283149138", cells: ["FAS-1138", "Production Order Item 3", "7/7/2026", "€49 238"], status: "completed" as const },
    { id: "283152709", cells: ["FAS-4709", "Production Order Item 4", "22/2/2026", "€2809"], status: "warning" as const },
    { id: "283156280", cells: ["FAS-8280", "Production Order Item 5", "9/9/2026", "€6380"], status: "active" as const },
];
...
export default function FashionPlatformProductionOrderPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Production Order</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Fashion Platform • Production Order</p>
                    </div>
                </div>
