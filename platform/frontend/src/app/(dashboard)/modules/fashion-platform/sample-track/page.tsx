...
/* ═══ Fashion Platform — Sample Track ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "1095", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "174", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3720", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "951785498", cells: ["FAS-9498", "Sample Track Item 1", "7/3/2026", "€35 598"], status: "active" as const },
    { id: "951789069", cells: ["FAS-4069", "Sample Track Item 2", "22/10/2026", "€39 169"], status: "pending" as const },
    { id: "951792640", cells: ["FAS-7640", "Sample Track Item 3", "9/5/2026", "€42 740"], status: "completed" as const },
    { id: "951796211", cells: ["FAS-2211", "Sample Track Item 4", "24/12/2026", "€46 311"], status: "warning" as const },
    { id: "951799782", cells: ["FAS-5782", "Sample Track Item 5", "11/7/2026", "€49 882"], status: "active" as const },
];
...
export default function FashionPlatformSampleTrackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sample Track</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Fashion Platform • Sample Track</p>
                    </div>
                </div>
