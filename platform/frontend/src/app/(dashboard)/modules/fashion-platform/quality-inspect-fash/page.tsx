...
/* ═══ Fashion Platform — Quality Inspect Fash ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "4747", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "146", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2579", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "81%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "116096894", cells: ["FAS-6894", "Quality Inspect Fash Item 1", "19/3/2026", "€46 994"], status: "active" as const },
    { id: "116100465", cells: ["FAS-1465", "Quality Inspect Fash Item 2", "6/10/2026", "€565"], status: "pending" as const },
    { id: "116104036", cells: ["FAS-5036", "Quality Inspect Fash Item 3", "21/5/2026", "€4136"], status: "completed" as const },
    { id: "116107607", cells: ["FAS-8607", "Quality Inspect Fash Item 4", "8/12/2026", "€7707"], status: "warning" as const },
    { id: "116111178", cells: ["FAS-3178", "Quality Inspect Fash Item 5", "23/7/2026", "€11 278"], status: "active" as const },
];
...
export default function FashionPlatformQualityInspectFashPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Quality Inspect Fash</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Fashion Platform • Quality Inspect Fash</p>
                    </div>
                </div>
