...
/* ═══ Fashion Platform — Material Source ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "392", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "485", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "586", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1842138545", cells: ["FAS-1545", "Material Source Item 1", "10/6/2026", "€38 645"], status: "active" as const },
    { id: "1842142116", cells: ["FAS-5116", "Material Source Item 2", "25/1/2026", "€42 216"], status: "pending" as const },
    { id: "1842145687", cells: ["FAS-8687", "Material Source Item 3", "12/8/2026", "€45 787"], status: "completed" as const },
    { id: "1842149258", cells: ["FAS-3258", "Material Source Item 4", "27/3/2026", "€49 358"], status: "warning" as const },
    { id: "1842152829", cells: ["FAS-6829", "Material Source Item 5", "14/10/2026", "€2929"], status: "active" as const },
];
...
export default function FashionPlatformMaterialSourcePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Material Source</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Fashion Platform • Material Source</p>
                    </div>
                </div>
