...
/* ═══ Fashion Platform — Collection Plan ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "3070", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "458", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3705", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "676681862", cells: ["FAS-8862", "Collection Plan Item 1", "11/3/2026", "€31 962"], status: "active" as const },
    { id: "676685433", cells: ["FAS-3433", "Collection Plan Item 2", "26/10/2026", "€35 533"], status: "pending" as const },
    { id: "676689004", cells: ["FAS-7004", "Collection Plan Item 3", "13/5/2026", "€39 104"], status: "completed" as const },
    { id: "676692575", cells: ["FAS-1575", "Collection Plan Item 4", "28/12/2026", "€42 675"], status: "warning" as const },
    { id: "676696146", cells: ["FAS-5146", "Collection Plan Item 5", "15/7/2026", "€46 246"], status: "active" as const },
];
...
export default function FashionPlatformCollectionPlanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Collection Plan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Fashion Platform • Collection Plan</p>
                    </div>
                </div>
