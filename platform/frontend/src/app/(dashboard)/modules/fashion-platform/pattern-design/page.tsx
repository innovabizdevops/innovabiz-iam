...
/* ═══ Fashion Platform — Pattern Design ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "1605", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "199", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2974", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1295669267", cells: ["FAS-3267", "Pattern Design Item 1", "12/12/2026", "€19 367"], status: "active" as const },
    { id: "1295672838", cells: ["FAS-6838", "Pattern Design Item 2", "27/7/2026", "€22 938"], status: "pending" as const },
    { id: "1295676409", cells: ["FAS-1409", "Pattern Design Item 3", "14/2/2026", "€26 509"], status: "completed" as const },
    { id: "1295679980", cells: ["FAS-4980", "Pattern Design Item 4", "1/9/2026", "€30 080"], status: "warning" as const },
    { id: "1295683551", cells: ["FAS-8551", "Pattern Design Item 5", "16/4/2026", "€33 651"], status: "active" as const },
];
...
export default function FashionPlatformPatternDesignPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pattern Design</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Fashion Platform • Pattern Design</p>
                    </div>
                </div>
