...
/* ═══ Fashion Platform — Lookbook Creator ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "1493", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "493", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3020", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1781645401", cells: ["FAS-6401", "Lookbook Creator Item 1", "26/2/2026", "€45 501"], status: "active" as const },
    { id: "1781648972", cells: ["FAS-9972", "Lookbook Creator Item 2", "13/9/2026", "€49 072"], status: "pending" as const },
    { id: "1781652543", cells: ["FAS-4543", "Lookbook Creator Item 3", "28/4/2026", "€2643"], status: "completed" as const },
    { id: "1781656114", cells: ["FAS-8114", "Lookbook Creator Item 4", "15/11/2026", "€6214"], status: "warning" as const },
    { id: "1781659685", cells: ["FAS-2685", "Lookbook Creator Item 5", "2/6/2026", "€9785"], status: "active" as const },
];
...
export default function FashionPlatformLookbookCreatorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Lookbook Creator</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Fashion Platform • Lookbook Creator</p>
                    </div>
                </div>
