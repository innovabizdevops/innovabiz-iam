...
export default function RealEstateAuctionPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Real Estate Auction</h1><p className="text-sm text-muted-foreground">Real Estate Auction • iBOS Enterprise</p></div>
