...
const PAGE = "Bid";
const KPIS = [{"l":"Fornecedores Ativos","v":"3.501","t":"+6.8%","d":"up"},{"l":"Contratos (€M)","v":"€17.0M","t":"+4.5%","d":"up"},{"l":"On-Time Delivery (%)","v":"78.7%","t":"+0.0%","d":"up"},{"l":"Score Médio","v":"88","t":"-5.8%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","93.3%","€ 17637.38","5.018","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","82.4%","€ 48192.91","5.210","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","82.8%","€ 20906.88","3.207","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","78.5%","€ 36928.26","2.371","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","92.9%","€ 21647.07","6.924","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":293},{"label":"Fev","value":246},{"label":"Mar","value":550},{"label":"Abr","value":283},{"label":"Mai","value":501},{"label":"Jun","value":377},{"label":"Jul","value":354},{"label":"Ago","value":257},{"label":"Set","value":494},{"label":"Out","value":390},{"label":"Nov","value":211},{"label":"Dez","value":289}];
const MX = 550;
