...
const PAGE = "EEXI Comply";
const KPIS = [{"l":"Total Voyage Planning","v":"4.122","t":"+17.0%","d":"up"},{"l":"EEXI Comply Ativos","v":"8.814","t":"+13.8%","d":"up"},{"l":"Eficiência (%)","v":"90.5%","t":"+4.1%","d":"up"},{"l":"Score Performance","v":"77","t":"-5.6%","d":"down"}];
const COLS = ["ID","EEXI Comply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Voyage Planning #001","Voyage Planning #002","250","2.405","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Voyage Planning #002","Voyage Planning #003","4.004","4.245","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Voyage Planning #003","Voyage Planning #004","2.125","3.773","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Voyage Planning #004","Voyage Planning #005","3.260","8.447","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Voyage Planning #005","Voyage Planning #001","382","9.003","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":555},{"label":"Mar","value":419},{"label":"Abr","value":585},{"label":"Mai","value":427},{"label":"Jun","value":290},{"label":"Jul","value":499},{"label":"Ago","value":636},{"label":"Set","value":339},{"label":"Out","value":483},{"label":"Nov","value":515},{"label":"Dez","value":638}];
const MX = 655;
...
export default function EexiPage() {
    return (
