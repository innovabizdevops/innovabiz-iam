...
const PAGE = "ETA Predict";
const KPIS = [{"l":"Integrações Ativas","v":"3.139","t":"+13.9%","d":"up"},{"l":"Chamadas/Hora","v":"3859","t":"+8.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"78.8%","t":"-0.9%","d":"down"},{"l":"Latência Média (ms)","v":"123ms","t":"+4.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.631","313","78.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.031","4.945","91.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.280","1.168","99.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.901","5.651","76.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.370","6.699","92.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":647},{"label":"Mar","value":453},{"label":"Abr","value":445},{"label":"Mai","value":794},{"label":"Jun","value":592},{"label":"Jul","value":568},{"label":"Ago","value":601},{"label":"Set","value":439},{"label":"Out","value":505},{"label":"Nov","value":689},{"label":"Dez","value":735}];
const MX = 794;
