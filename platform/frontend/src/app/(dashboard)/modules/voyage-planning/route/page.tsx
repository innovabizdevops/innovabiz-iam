...
const PAGE = "Route Chart";
const KPIS = [{"l":"Total Voyage Planning","v":"2.565","t":"+8.0%","d":"up"},{"l":"Route Chart Ativos","v":"1.708","t":"+2.3%","d":"up"},{"l":"Eficiência (%)","v":"88.4%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"88","t":"-0.7%","d":"down"}];
const COLS = ["ID","Route Chart","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Voyage Planning #001","Voyage Planning #002","5.611","3.394","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Voyage Planning #002","Voyage Planning #003","7.862","3.354","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Voyage Planning #003","Voyage Planning #004","4.624","2.947","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Voyage Planning #004","Voyage Planning #005","8.723","7.159","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Voyage Planning #005","Voyage Planning #001","3.468","2.073","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1060},{"label":"Fev","value":829},{"label":"Mar","value":996},{"label":"Abr","value":999},{"label":"Mai","value":799},{"label":"Jun","value":803},{"label":"Jul","value":790},{"label":"Ago","value":774},{"label":"Set","value":764},{"label":"Out","value":772},{"label":"Nov","value":798},{"label":"Dez","value":831}];
const MX = 1060;
