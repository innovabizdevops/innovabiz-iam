...
const PAGE = "Bunker Plan";
const KPIS = [{"l":"Total Voyage Planning","v":"5.273","t":"+2.1%","d":"up"},{"l":"Bunker Plan Ativos","v":"5.716","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"79.4%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"79","t":"-5.2%","d":"down"}];
const COLS = ["ID","Bunker Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Voyage Planning #001","Voyage Planning #002","3.675","1.504","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Voyage Planning #002","Voyage Planning #003","997","8.677","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Voyage Planning #003","Voyage Planning #004","407","7.952","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Voyage Planning #004","Voyage Planning #005","4.364","837","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Voyage Planning #005","Voyage Planning #001","5.640","4.958","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":895},{"label":"Fev","value":735},{"label":"Mar","value":1006},{"label":"Abr","value":720},{"label":"Mai","value":801},{"label":"Jun","value":846},{"label":"Jul","value":918},{"label":"Ago","value":808},{"label":"Set","value":954},{"label":"Out","value":966},{"label":"Nov","value":899},{"label":"Dez","value":986}];
const MX = 1006;
