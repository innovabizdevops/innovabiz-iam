...
const PAGE = "Port Schedule";
const KPIS = [{"l":"Total Voyage Planning","v":"2.479","t":"+13.9%","d":"up"},{"l":"Port Schedule Ativos","v":"1.882","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"79.9%","t":"+16.3%","d":"up"},{"l":"Score Performance","v":"60","t":"-3.9%","d":"down"}];
const COLS = ["ID","Port Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Voyage Planning #001","Voyage Planning #002","1.631","4.115","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Voyage Planning #002","Voyage Planning #003","506","8.874","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Voyage Planning #003","Voyage Planning #004","4.125","281","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Voyage Planning #004","Voyage Planning #005","2.964","4.082","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Voyage Planning #005","Voyage Planning #001","952","3.626","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":640},{"label":"Mar","value":657},{"label":"Abr","value":595},{"label":"Mai","value":715},{"label":"Jun","value":714},{"label":"Jul","value":693},{"label":"Ago","value":696},{"label":"Set","value":523},{"label":"Out","value":538},{"label":"Nov","value":870},{"label":"Dez","value":870}];
const MX = 870;
