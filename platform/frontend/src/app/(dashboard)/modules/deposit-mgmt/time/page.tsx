...
const ACCENT = "#6366f1";
const MODULE = "Deposit Management";
const PAGE = "Time Deposit";
const KPIS = [{"l":"Pedidos/Dia","v":"2513","t":"+11.2%","d":"up"},{"l":"GMV (€)","v":"€22317","t":"-3.1%","d":"down"},{"l":"Conversão (%)","v":"82.6%","t":"+15.7%","d":"up"},{"l":"AOV (€)","v":"€98588","t":"+1.2%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 32323.14","5.579","4.359","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 20704.21","3.101","5.415","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 410.73","2.645","7.499","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 812.82","6.535","7.278","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 36100.10","2.559","3.128","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":787},{"label":"Mar","value":851},{"label":"Abr","value":828},{"label":"Mai","value":600},{"label":"Jun","value":888},{"label":"Jul","value":834},{"label":"Ago","value":844},{"label":"Set","value":663},{"label":"Out","value":749},{"label":"Nov","value":602},{"label":"Dez","value":902}];
const MX = 902;
