...
const ACCENT = "#6366f1";
const MODULE = "Talent Agency";
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"5.221","t":"+8.1%","d":"up"},{"l":"Valor Total (€M)","v":"€2.6M","t":"-4.4%","d":"down"},{"l":"Renovações Próx. 30d","v":"9.032","t":"+14.5%","d":"up"},{"l":"Obrigações Pendentes","v":"8.200","t":"+7.1%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 18487.99","2026-01-02","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 17685.91","2026-02-25","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 42318.25","2026-01-25","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 1334.82","2026-01-01","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 13675.81","2026-02-19","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":885},{"label":"Mar","value":802},{"label":"Abr","value":915},{"label":"Mai","value":902},{"label":"Jun","value":788},{"label":"Jul","value":577},{"label":"Ago","value":941},{"label":"Set","value":757},{"label":"Out","value":660},{"label":"Nov","value":876},{"label":"Dez","value":827}];
const MX = 941;
