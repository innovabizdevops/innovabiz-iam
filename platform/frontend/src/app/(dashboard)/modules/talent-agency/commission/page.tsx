...
const KPIS = [{"l":"Vendas YTD (€)","v":"€55758","t":"+14.2%","d":"up"},{"l":"Pipeline (€)","v":"€47251","t":"+17.2%","d":"up"},{"l":"Atingimento Quota (%)","v":"75.2%","t":"+17.7%","d":"up"},{"l":"Win Rate (%)","v":"94.5%","t":"+0.4%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 27457.33","€ 13213.25","€ 16801.66","80.8%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 10123.33","€ 26897.69","€ 9203.37","96.5%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 10146.26","€ 4764.00","€ 5636.52","94.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 47385.77","€ 18757.47","€ 49233.95","73.4%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 4015.66","€ 28782.87","€ 26455.73","73.4%"],"status":"active"}];
const CHART = [{"label":"Jan","value":303},{"label":"Fev","value":540},{"label":"Mar","value":319},{"label":"Abr","value":543},{"label":"Mai","value":571},{"label":"Jun","value":596},{"label":"Jul","value":555},{"label":"Ago","value":332},{"label":"Set","value":282},{"label":"Out","value":454},{"label":"Nov","value":485},{"label":"Dez","value":326}];
const MX = 596;
