...
const KPIS = [{"l":"Vendas YTD (€)","v":"€88767","t":"-2.8%","d":"down"},{"l":"Pipeline (€)","v":"€64776","t":"+0.9%","d":"up"},{"l":"Atingimento Quota (%)","v":"94.3%","t":"+13.9%","d":"up"},{"l":"Win Rate (%)","v":"83.7%","t":"+10.5%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 24725.73","€ 19504.21","€ 30916.64","71.7%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 457.71","€ 24575.82","€ 44900.12","92.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 1028.11","€ 15249.88","€ 25681.27","94.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 26095.39","€ 23173.81","€ 17607.19","91.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 24918.35","€ 12025.08","€ 20205.08","97.0%"],"status":"active"}];
const CHART = [{"label":"Jan","value":230},{"label":"Fev","value":467},{"label":"Mar","value":380},{"label":"Abr","value":282},{"label":"Mai","value":261},{"label":"Jun","value":575},{"label":"Jul","value":467},{"label":"Ago","value":307},{"label":"Set","value":306},{"label":"Out","value":332},{"label":"Nov","value":417},{"label":"Dez","value":393}];
const MX = 575;
