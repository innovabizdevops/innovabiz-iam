...
const PAGE = "Reversion";
const KPIS = [{"l":"Formulários Ativos","v":"2.637","t":"-3.9%","d":"down"},{"l":"Submissões/Dia","v":"3934","t":"+4.2%","d":"up"},{"l":"Documentos Gerados","v":"6.659","t":"+0.1%","d":"up"},{"l":"Templates","v":"280","t":"+14.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","541","2026-03-26","360","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.650","2026-03-27","6.292","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.170","2026-03-18","4.636","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.150","2026-03-01","7.768","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.050","2026-02-06","1.465","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":542},{"label":"Mar","value":480},{"label":"Abr","value":562},{"label":"Mai","value":385},{"label":"Jun","value":582},{"label":"Jul","value":363},{"label":"Ago","value":509},{"label":"Set","value":588},{"label":"Out","value":356},{"label":"Nov","value":447},{"label":"Dez","value":562}];
const MX = 588;
