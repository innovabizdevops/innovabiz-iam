...
const PAGE = "Rights Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"4.510","t":"+10.7%","d":"up"},{"l":"Queries/Dia","v":"3781","t":"+2.2%","d":"up"},{"l":"Dados Processados (GB)","v":"2.135","t":"-2.7%","d":"down"},{"l":"Utilizadores Analytics","v":"5.921","t":"+16.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5034","2026-03-19","4.790","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4638","2026-02-15","911","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3734","2026-03-12","7.787","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","628","2026-02-27","3.870","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1505","2026-03-19","6.545","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":560},{"label":"Mar","value":438},{"label":"Abr","value":322},{"label":"Mai","value":699},{"label":"Jun","value":680},{"label":"Jul","value":617},{"label":"Ago","value":660},{"label":"Set","value":592},{"label":"Out","value":351},{"label":"Nov","value":615},{"label":"Dez","value":497}];
const MX = 699;
