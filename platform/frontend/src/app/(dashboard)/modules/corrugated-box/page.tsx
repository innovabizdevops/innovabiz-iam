...
/* ═══ Corrugated Box Mfg — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "9557", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3831", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€104K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "772872757", cells: ["COR-7757", "Corrugated Box Mfg Item 1", "14/2/2026", "€22 857"], status: "active" as const },
    { id: "772876328", cells: ["COR-2328", "Corrugated Box Mfg Item 2", "1/9/2026", "€26 428"], status: "pending" as const },
    { id: "772879899", cells: ["COR-5899", "Corrugated Box Mfg Item 3", "16/4/2026", "€29 999"], status: "completed" as const },
    { id: "772883470", cells: ["COR-9470", "Corrugated Box Mfg Item 4", "3/11/2026", "€33 570"], status: "warning" as const },
    { id: "772887041", cells: ["COR-4041", "Corrugated Box Mfg Item 5", "18/6/2026", "€37 141"], status: "active" as const },
];
...
export default function CorrugatedBoxMfgPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Corrugated Box Mfg</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Corrugated Box Mfg</p>
                    </div>
                </div>
