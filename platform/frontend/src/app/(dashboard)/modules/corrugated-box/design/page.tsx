...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"4.412","t":"+9.0%","d":"up"},{"l":"Submissões/Dia","v":"4811","t":"+6.1%","d":"up"},{"l":"Documentos Gerados","v":"5.879","t":"+1.7%","d":"up"},{"l":"Templates","v":"2.768","t":"-0.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.649","2026-02-03","163","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.148","2026-01-19","3.458","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.262","2026-01-19","2.451","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.422","2026-03-18","9.066","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","799","2026-01-04","3.768","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":656},{"label":"Mar","value":601},{"label":"Abr","value":617},{"label":"Mai","value":956},{"label":"Jun","value":802},{"label":"Jul","value":736},{"label":"Ago","value":612},{"label":"Set","value":622},{"label":"Out","value":862},{"label":"Nov","value":979},{"label":"Dez","value":752}];
const MX = 979;
