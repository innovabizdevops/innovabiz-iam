...
const ACCENT = "#92400e";
const MODULE = "Corrugated Box Mfg";
const PAGE = "Die Cut";
const KPIS = [{"l":"Total Corrugated Box","v":"8.477","t":"-4.0%","d":"down"},{"l":"Die Cut Ativos","v":"6.403","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"88.7%","t":"+11.9%","d":"up"},{"l":"Score Performance","v":"58","t":"+4.4%","d":"up"}];
const COLS = ["ID","Die Cut","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Corrugated Box #001","Corrugated Box #002","4.273","4.852","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Corrugated Box #002","Corrugated Box #003","7.319","8.959","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Corrugated Box #003","Corrugated Box #004","6.958","3.884","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Corrugated Box #004","Corrugated Box #005","6.477","7.664","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Corrugated Box #005","Corrugated Box #001","7.457","5.602","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":319},{"label":"Mar","value":548},{"label":"Abr","value":311},{"label":"Mai","value":335},{"label":"Jun","value":273},{"label":"Jul","value":518},{"label":"Ago","value":402},{"label":"Set","value":374},{"label":"Out","value":335},{"label":"Nov","value":273},{"label":"Dez","value":551}];
const MX = 551;
