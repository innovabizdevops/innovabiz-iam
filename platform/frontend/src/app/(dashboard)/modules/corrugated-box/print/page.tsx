...
const PAGE = "Print";
const KPIS = [{"l":"Total Corrugated Box","v":"3.134","t":"-4.4%","d":"down"},{"l":"Print Ativos","v":"6.088","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"85.2%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"89","t":"+8.3%","d":"up"}];
const COLS = ["ID","Print","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Corrugated Box #001","Corrugated Box #002","5.459","6.547","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Corrugated Box #002","Corrugated Box #003","4.403","7.426","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Corrugated Box #003","Corrugated Box #004","6.679","3.749","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Corrugated Box #004","Corrugated Box #005","2.268","7.545","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Corrugated Box #005","Corrugated Box #001","3.990","2.934","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":481},{"label":"Mar","value":396},{"label":"Abr","value":606},{"label":"Mai","value":504},{"label":"Jun","value":351},{"label":"Jul","value":359},{"label":"Ago","value":370},{"label":"Set","value":716},{"label":"Out","value":662},{"label":"Nov","value":495},{"label":"Dez","value":436}];
const MX = 716;
