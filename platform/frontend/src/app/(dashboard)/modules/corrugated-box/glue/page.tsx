...
const PAGE = "Glue";
const KPIS = [{"l":"Total Corrugated Box","v":"2.875","t":"+4.8%","d":"up"},{"l":"Glue Ativos","v":"3.080","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"93","t":"+14.9%","d":"up"}];
const COLS = ["ID","Glue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Corrugated Box #001","Corrugated Box #002","8.818","4.380","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Corrugated Box #002","Corrugated Box #003","4.493","4.423","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Corrugated Box #003","Corrugated Box #004","8.955","6.869","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Corrugated Box #004","Corrugated Box #005","765","6.538","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Corrugated Box #005","Corrugated Box #001","1.731","5.772","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":608},{"label":"Fev","value":733},{"label":"Mar","value":750},{"label":"Abr","value":536},{"label":"Mai","value":771},{"label":"Jun","value":555},{"label":"Jul","value":517},{"label":"Ago","value":667},{"label":"Set","value":506},{"label":"Out","value":649},{"label":"Nov","value":613},{"label":"Dez","value":787}];
const MX = 787;
