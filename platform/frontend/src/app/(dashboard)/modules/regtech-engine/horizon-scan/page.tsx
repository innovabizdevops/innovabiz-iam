...
/* ═══ RegTech Engine — Horizon Scan ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "4394", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "110", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1598", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2087103146", cells: ["REG-4146", "Horizon Scan Item 1", "3/3/2026", "€3246"], status: "active" as const },
    { id: "2087106717", cells: ["REG-7717", "Horizon Scan Item 2", "18/10/2026", "€6817"], status: "pending" as const },
    { id: "2087110288", cells: ["REG-2288", "Horizon Scan Item 3", "5/5/2026", "€10 388"], status: "completed" as const },
    { id: "2087113859", cells: ["REG-5859", "Horizon Scan Item 4", "20/12/2026", "€13 959"], status: "warning" as const },
    { id: "2087117430", cells: ["REG-9430", "Horizon Scan Item 5", "7/7/2026", "€17 530"], status: "active" as const },
];
...
export default function RegtechEngineHorizonScanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Horizon Scan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">RegTech Engine • Horizon Scan</p>
                    </div>
                </div>
