...
/* ═══ RegTech Engine — Compliance Automat ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "4712", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "48", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3036", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "73%", trend: "-4%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "375492396", cells: ["REG-4396", "Compliance Automat Item 1", "21/1/2026", "€42 496"], status: "active" as const },
    { id: "375495967", cells: ["REG-7967", "Compliance Automat Item 2", "8/8/2026", "€46 067"], status: "pending" as const },
    { id: "375499538", cells: ["REG-2538", "Compliance Automat Item 3", "23/3/2026", "€49 638"], status: "completed" as const },
    { id: "375503109", cells: ["REG-6109", "Compliance Automat Item 4", "10/10/2026", "€3209"], status: "warning" as const },
    { id: "375506680", cells: ["REG-9680", "Compliance Automat Item 5", "25/5/2026", "€6780"], status: "active" as const },
];
...
export default function RegtechEngineComplianceAutomatPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Compliance Automat</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">RegTech Engine • Compliance Automat</p>
                    </div>
                </div>
