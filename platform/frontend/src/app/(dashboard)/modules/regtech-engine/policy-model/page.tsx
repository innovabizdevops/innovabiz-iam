...
/* ═══ RegTech Engine — Policy Model ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "661", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "327", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "280", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "963336003", cells: ["REG-4003", "Policy Model Item 1", "8/4/2026", "€36 103"], status: "active" as const },
    { id: "963339574", cells: ["REG-7574", "Policy Model Item 2", "23/11/2026", "€39 674"], status: "pending" as const },
    { id: "963343145", cells: ["REG-2145", "Policy Model Item 3", "10/6/2026", "€43 245"], status: "completed" as const },
    { id: "963346716", cells: ["REG-5716", "Policy Model Item 4", "25/1/2026", "€46 816"], status: "warning" as const },
    { id: "963350287", cells: ["REG-9287", "Policy Model Item 5", "12/8/2026", "€387"], status: "active" as const },
];
...
export default function RegtechEnginePolicyModelPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Policy Model</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">RegTech Engine • Policy Model</p>
                    </div>
                </div>
