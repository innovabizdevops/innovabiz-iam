...
/* ═══ RegTech Engine — Regulatory Radar ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "3450", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "254", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2420", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "87%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1619127290", cells: ["REG-1290", "Regulatory Radar Item 1", "19/3/2026", "€27 390"], status: "active" as const },
    { id: "1619130861", cells: ["REG-4861", "Regulatory Radar Item 2", "6/10/2026", "€30 961"], status: "pending" as const },
    { id: "1619134432", cells: ["REG-8432", "Regulatory Radar Item 3", "21/5/2026", "€34 532"], status: "completed" as const },
    { id: "1619138003", cells: ["REG-3003", "Regulatory Radar Item 4", "8/12/2026", "€38 103"], status: "warning" as const },
    { id: "1619141574", cells: ["REG-6574", "Regulatory Radar Item 5", "23/7/2026", "€41 674"], status: "active" as const },
];
...
export default function RegtechEngineRegulatoryRadarPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Regulatory Radar</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">RegTech Engine • Regulatory Radar</p>
                    </div>
                </div>
