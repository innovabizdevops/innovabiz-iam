...
/* ═══ RegTech Engine — Cross Border Reg ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "4108", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "364", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1842", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "68064472", cells: ["REG-7472", "Cross Border Reg Item 1", "1/5/2026", "€14 572"], status: "active" as const },
    { id: "68068043", cells: ["REG-2043", "Cross Border Reg Item 2", "16/12/2026", "€18 143"], status: "pending" as const },
    { id: "68071614", cells: ["REG-5614", "Cross Border Reg Item 3", "3/7/2026", "€21 714"], status: "completed" as const },
    { id: "68075185", cells: ["REG-9185", "Cross Border Reg Item 4", "18/2/2026", "€25 285"], status: "warning" as const },
    { id: "68078756", cells: ["REG-3756", "Cross Border Reg Item 5", "5/9/2026", "€28 856"], status: "active" as const },
];
...
export default function RegtechEngineCrossBorderRegPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cross Border Reg</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">RegTech Engine • Cross Border Reg</p>
                    </div>
                </div>
