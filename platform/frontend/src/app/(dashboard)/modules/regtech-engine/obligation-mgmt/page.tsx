...
/* ═══ RegTech Engine — Obligation Mgmt ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "2808", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "9", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3919", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1656867685", cells: ["REG-4685", "Obligation Mgmt Item 1", "26/2/2026", "€17 785"], status: "active" as const },
    { id: "1656871256", cells: ["REG-8256", "Obligation Mgmt Item 2", "13/9/2026", "€21 356"], status: "pending" as const },
    { id: "1656874827", cells: ["REG-2827", "Obligation Mgmt Item 3", "28/4/2026", "€24 927"], status: "completed" as const },
    { id: "1656878398", cells: ["REG-6398", "Obligation Mgmt Item 4", "15/11/2026", "€28 498"], status: "warning" as const },
    { id: "1656881969", cells: ["REG-9969", "Obligation Mgmt Item 5", "2/6/2026", "€32 069"], status: "active" as const },
];
...
export default function RegtechEngineObligationMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Obligation Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">RegTech Engine • Obligation Mgmt</p>
                    </div>
                </div>
