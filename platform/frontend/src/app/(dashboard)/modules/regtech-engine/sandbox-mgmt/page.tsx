...
/* ═══ RegTech Engine — Sandbox Mgmt ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "4573", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "86", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1749", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1241294658", cells: ["REG-6658", "Sandbox Mgmt Item 1", "3/7/2026", "€44 758"], status: "active" as const },
    { id: "1241298229", cells: ["REG-1229", "Sandbox Mgmt Item 2", "18/2/2026", "€48 329"], status: "pending" as const },
    { id: "1241301800", cells: ["REG-4800", "Sandbox Mgmt Item 3", "5/9/2026", "€1900"], status: "completed" as const },
    { id: "1241305371", cells: ["REG-8371", "Sandbox Mgmt Item 4", "20/4/2026", "€5471"], status: "warning" as const },
    { id: "1241308942", cells: ["REG-2942", "Sandbox Mgmt Item 5", "7/11/2026", "€9042"], status: "active" as const },
];
...
export default function RegtechEngineSandboxMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sandbox Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">RegTech Engine • Sandbox Mgmt</p>
                    </div>
                </div>
