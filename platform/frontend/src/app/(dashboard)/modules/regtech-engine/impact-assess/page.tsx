...
/* ═══ RegTech Engine — Impact Assess ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "4667", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "462", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3321", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "189955082", cells: ["REG-2082", "Impact Assess Item 1", "3/3/2026", "€5182"], status: "active" as const },
    { id: "189958653", cells: ["REG-5653", "Impact Assess Item 2", "18/10/2026", "€8753"], status: "pending" as const },
    { id: "189962224", cells: ["REG-9224", "Impact Assess Item 3", "5/5/2026", "€12 324"], status: "completed" as const },
    { id: "189965795", cells: ["REG-3795", "Impact Assess Item 4", "20/12/2026", "€15 895"], status: "warning" as const },
    { id: "189969366", cells: ["REG-7366", "Impact Assess Item 5", "7/7/2026", "€19 466"], status: "active" as const },
];
...
export default function RegtechEngineImpactAssessPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Impact Assess</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">RegTech Engine • Impact Assess</p>
                    </div>
                </div>
