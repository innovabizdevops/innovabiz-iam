...
/* ═══ RegTech Engine — Supervisory Tech ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "4206", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "241", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3146", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1231182861", cells: ["REG-1861", "Supervisory Tech Item 1", "14/10/2026", "€32 961"], status: "active" as const },
    { id: "1231186432", cells: ["REG-5432", "Supervisory Tech Item 2", "1/5/2026", "€36 532"], status: "pending" as const },
    { id: "1231190003", cells: ["REG-9003", "Supervisory Tech Item 3", "16/12/2026", "€40 103"], status: "completed" as const },
    { id: "1231193574", cells: ["REG-3574", "Supervisory Tech Item 4", "3/7/2026", "€43 674"], status: "warning" as const },
    { id: "1231197145", cells: ["REG-7145", "Supervisory Tech Item 5", "18/2/2026", "€47 245"], status: "active" as const },
];
...
export default function RegtechEngineSupervisoryTechPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Supervisory Tech</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">RegTech Engine • Supervisory Tech</p>
                    </div>
                </div>
