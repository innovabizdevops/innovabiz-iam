...
/* ═══ RegTech Engine — Reporting Engine ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "4248", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "136", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3976", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "87%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "2031614660", cells: ["REG-9660", "Reporting Engine Item 1", "13/9/2026", "€14 760"], status: "active" as const },
    { id: "2031618231", cells: ["REG-4231", "Reporting Engine Item 2", "28/4/2026", "€18 331"], status: "pending" as const },
    { id: "2031621802", cells: ["REG-7802", "Reporting Engine Item 3", "15/11/2026", "€21 902"], status: "completed" as const },
    { id: "2031625373", cells: ["REG-2373", "Reporting Engine Item 4", "2/6/2026", "€25 473"], status: "warning" as const },
    { id: "2031628944", cells: ["REG-5944", "Reporting Engine Item 5", "17/1/2026", "€29 044"], status: "active" as const },
];
...
export default function RegtechEngineReportingEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Reporting Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">RegTech Engine • Reporting Engine</p>
                    </div>
                </div>
