...
const PAGE = "Salary Cap";
const KPIS = [{"l":"Teams Ativos","v":"6.931","t":"+3.5%","d":"up"},{"l":"Reuniões/Semana","v":"1740","t":"+10.5%","d":"up"},{"l":"Mensagens/Dia","v":"1259","t":"+0.3%","d":"up"},{"l":"Ficheiros Partilhados","v":"6.933","t":"-4.0%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.123","2878","4.415","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","3.948","100","8.259","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","5.061","1172","6.618","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","3.254","4826","6.630","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","4.916","2796","4.834","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":650},{"label":"Mar","value":650},{"label":"Abr","value":602},{"label":"Mai","value":642},{"label":"Jun","value":485},{"label":"Jul","value":644},{"label":"Ago","value":662},{"label":"Set","value":803},{"label":"Out","value":531},{"label":"Nov","value":590},{"label":"Dez","value":599}];
const MX = 803;
