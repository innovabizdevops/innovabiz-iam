...
const ACCENT = "#166534";
const MODULE = "Sports Team Mgmt";
const PAGE = "Scouting";
const KPIS = [{"l":"Teams Ativos","v":"557","t":"+15.9%","d":"up"},{"l":"Reuniões/Semana","v":"1137","t":"+2.3%","d":"up"},{"l":"Mensagens/Dia","v":"990","t":"+13.7%","d":"up"},{"l":"Ficheiros Partilhados","v":"8.731","t":"+15.5%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.572","2997","2.834","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.419","2876","8.987","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","8.503","3382","3.578","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","195","3400","5.841","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","299","1713","3.104","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":923},{"label":"Fev","value":771},{"label":"Mar","value":749},{"label":"Abr","value":728},{"label":"Mai","value":966},{"label":"Jun","value":935},{"label":"Jul","value":970},{"label":"Ago","value":938},{"label":"Set","value":1043},{"label":"Out","value":701},{"label":"Nov","value":853},{"label":"Dez","value":1026}];
const MX = 1043;
