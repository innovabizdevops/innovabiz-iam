...
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"5.163","t":"+1.2%","d":"up"},{"l":"Valor Total (€M)","v":"€5.0M","t":"+17.1%","d":"up"},{"l":"Renovações Próx. 30d","v":"4.437","t":"-1.2%","d":"down"},{"l":"Obrigações Pendentes","v":"5.425","t":"+4.7%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 35555.31","2026-01-02","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 43194.72","2026-01-04","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 31586.85","2026-01-23","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 47501.81","2026-02-09","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 25900.59","2026-02-07","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":712},{"label":"Fev","value":967},{"label":"Mar","value":916},{"label":"Abr","value":896},{"label":"Mai","value":741},{"label":"Jun","value":945},{"label":"Jul","value":827},{"label":"Ago","value":617},{"label":"Set","value":777},{"label":"Out","value":849},{"label":"Nov","value":650},{"label":"Dez","value":997}];
const MX = 997;
