...
const PAGE = "Roster";
const KPIS = [{"l":"Teams Ativos","v":"3.647","t":"+3.6%","d":"up"},{"l":"Reuniões/Semana","v":"2676","t":"+5.4%","d":"up"},{"l":"Mensagens/Dia","v":"1103","t":"+2.9%","d":"up"},{"l":"Ficheiros Partilhados","v":"4.834","t":"-2.5%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","8.691","2533","2.823","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.597","2918","1.514","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","707","1336","1.887","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","3.314","3910","2.769","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","8.499","245","8.991","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":938},{"label":"Mar","value":608},{"label":"Abr","value":744},{"label":"Mai","value":761},{"label":"Jun","value":625},{"label":"Jul","value":947},{"label":"Ago","value":942},{"label":"Set","value":869},{"label":"Out","value":744},{"label":"Nov","value":832},{"label":"Dez","value":734}];
const MX = 947;
