...
const ACCENT = "#1e40af";
const MODULE = "FinTech Sandbox";
const PAGE = "License";
const KPIS = [{"l":"Total Fintech Sandbox","v":"5.891","t":"-1.9%","d":"down"},{"l":"License Ativos","v":"1.920","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"67","t":"-2.5%","d":"down"}];
const COLS = ["ID","License","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fintech Sandbox #001","Fintech Sandbox #002","2.797","1.273","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Fintech Sandbox #002","Fintech Sandbox #003","3.819","937","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Fintech Sandbox #003","Fintech Sandbox #004","6.631","3.605","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Fintech Sandbox #004","Fintech Sandbox #005","8.705","7.714","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fintech Sandbox #005","Fintech Sandbox #001","1.882","480","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":515},{"label":"Fev","value":527},{"label":"Mar","value":487},{"label":"Abr","value":502},{"label":"Mai","value":493},{"label":"Jun","value":453},{"label":"Jul","value":491},{"label":"Ago","value":481},{"label":"Set","value":722},{"label":"Out","value":508},{"label":"Nov","value":722},{"label":"Dez","value":522}];
const MX = 722;
