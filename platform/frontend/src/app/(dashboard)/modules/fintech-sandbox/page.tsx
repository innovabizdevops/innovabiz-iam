...
/* ═══ FinTech Sandbox — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "2674", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2979", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€153K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "-7%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1453520574", cells: ["FIN-3574", "FinTech Sandbox Item 1", "3/7/2026", "€20 674"], status: "active" as const },
    { id: "1453524145", cells: ["FIN-7145", "FinTech Sandbox Item 2", "18/2/2026", "€24 245"], status: "pending" as const },
    { id: "1453527716", cells: ["FIN-1716", "FinTech Sandbox Item 3", "5/9/2026", "€27 816"], status: "completed" as const },
    { id: "1453531287", cells: ["FIN-5287", "FinTech Sandbox Item 4", "20/4/2026", "€31 387"], status: "warning" as const },
    { id: "1453534858", cells: ["FIN-8858", "FinTech Sandbox Item 5", "7/11/2026", "€34 958"], status: "active" as const },
];
...
export default function FintechSandboxPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">FinTech Sandbox</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • FinTech Sandbox</p>
                    </div>
                </div>
