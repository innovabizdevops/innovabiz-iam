...
const KPIS = [{"l":"Auditorias Realizadas","v":"4.781","t":"-1.4%","d":"down"},{"l":"NC Abertas","v":"2.878","t":"-5.9%","d":"down"},{"l":"Conformidade (%)","v":"75.6%","t":"-0.7%","d":"down"},{"l":"CAPAs Pendentes","v":"6.569","t":"+9.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.760","75.1%","8.156","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.314","95.5%","2.466","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.116","86.5%","1.262","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.014","92.5%","6.366","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","790","97.0%","7.553","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":939},{"label":"Mar","value":625},{"label":"Abr","value":773},{"label":"Mai","value":785},{"label":"Jun","value":900},{"label":"Jul","value":740},{"label":"Ago","value":888},{"label":"Set","value":675},{"label":"Out","value":689},{"label":"Nov","value":812},{"label":"Dez","value":893}];
const MX = 939;
