...
const PAGE = "Scan";
const KPIS = [{"l":"Pedidos/Dia","v":"2573","t":"-4.0%","d":"down"},{"l":"GMV (€)","v":"€59254","t":"+1.2%","d":"up"},{"l":"Conversão (%)","v":"79.8%","t":"+0.1%","d":"up"},{"l":"AOV (€)","v":"€76754","t":"-5.2%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 36324.33","5.811","3.103","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 27758.30","3.798","1.442","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 11589.47","1.136","5.630","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 42881.34","4.721","825","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 41058.54","967","5.647","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":707},{"label":"Mar","value":916},{"label":"Abr","value":858},{"label":"Mai","value":1003},{"label":"Jun","value":818},{"label":"Jul","value":750},{"label":"Ago","value":704},{"label":"Set","value":891},{"label":"Out","value":984},{"label":"Nov","value":1033},{"label":"Dez","value":691}];
const MX = 1033;
