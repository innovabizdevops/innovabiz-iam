...
/* ═══ Cloud Security (CSPM) — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "5982", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "429", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€489K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "396639482", cells: ["CLO-1482", "Cloud Security (CSPM) Item 1", "23/3/2026", "€39 582"], status: "active" as const },
    { id: "396643053", cells: ["CLO-5053", "Cloud Security (CSPM) Item 2", "10/10/2026", "€43 153"], status: "pending" as const },
    { id: "396646624", cells: ["CLO-8624", "Cloud Security (CSPM) Item 3", "25/5/2026", "€46 724"], status: "completed" as const },
    { id: "396650195", cells: ["CLO-3195", "Cloud Security (CSPM) Item 4", "12/12/2026", "€295"], status: "warning" as const },
    { id: "396653766", cells: ["CLO-6766", "Cloud Security (CSPM) Item 5", "27/7/2026", "€3866"], status: "active" as const },
];
...
export default function CloudSecurityCspmPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cloud Security (CSPM)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cloud Security (CSPM)</p>
                    </div>
                </div>
