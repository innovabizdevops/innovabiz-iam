...
const ACCENT = "#dc2626";
const MODULE = "Cloud Security (CSPM)";
const PAGE = "Remediate";
const KPIS = [{"l":"Pedidos/Dia","v":"2773","t":"+8.6%","d":"up"},{"l":"GMV (€)","v":"€73038","t":"+13.3%","d":"up"},{"l":"Conversão (%)","v":"80.7%","t":"-0.7%","d":"down"},{"l":"AOV (€)","v":"€5666","t":"+9.4%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 7530.83","3.758","7.767","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 41133.57","6.992","3.829","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 30079.65","995","149","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 16736.98","2.513","3.647","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 20040.29","4.911","523","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":817},{"label":"Mar","value":823},{"label":"Abr","value":575},{"label":"Mai","value":880},{"label":"Jun","value":581},{"label":"Jul","value":822},{"label":"Ago","value":634},{"label":"Set","value":601},{"label":"Out","value":748},{"label":"Nov","value":733},{"label":"Dez","value":611}];
const MX = 880;
