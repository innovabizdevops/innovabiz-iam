...
const PAGE = "Knowledge Base HR";
const KPIS = [{"l":"Artigos Publicados","v":"2.611","t":"+9.2%","d":"up"},{"l":"Views/Semana","v":"212","t":"+12.9%","d":"up"},{"l":"Feedback Útil (%)","v":"72.3%","t":"-3.8%","d":"down"},{"l":"Artigos Desatualizados","v":"8.673","t":"+2.7%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","4.181","95.4%","2.472","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","3.638","84.5%","6.419","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","6.478","91.9%","3.405","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","1.633","77.1%","9.070","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","8.861","83.0%","3.074","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":836},{"label":"Mar","value":522},{"label":"Abr","value":652},{"label":"Mai","value":551},{"label":"Jun","value":651},{"label":"Jul","value":778},{"label":"Ago","value":573},{"label":"Set","value":528},{"label":"Out","value":764},{"label":"Nov","value":611},{"label":"Dez","value":715}];
const MX = 836;
