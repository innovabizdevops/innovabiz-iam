...
const PAGE = "Employee Portal";
const KPIS = [{"l":"eNPS","v":"65","t":"-2.4%","d":"down"},{"l":"Engagement (%)","v":"79.8%","t":"-3.4%","d":"down"},{"l":"Turnover (%)","v":"78.0%","t":"+8.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.435","t":"+3.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.017","2026-03-27","67","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.301","2026-02-19","79","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.614","2026-03-02","76","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.109","2026-03-23","56","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.618","2026-02-12","67","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":658},{"label":"Mar","value":632},{"label":"Abr","value":537},{"label":"Mai","value":730},{"label":"Jun","value":609},{"label":"Jul","value":420},{"label":"Ago","value":442},{"label":"Set","value":513},{"label":"Out","value":625},{"label":"Nov","value":540},{"label":"Dez","value":718}];
const MX = 730;
