...
const ACCENT = "#be185d";
const MODULE = "HR Service Delivery";
const PAGE = "Exit Interview AI";
const KPIS = [{"l":"Total Hr Service Delivery","v":"1.459","t":"+7.5%","d":"up"},{"l":"Exit Interview AI Ativos","v":"6.029","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"80.8%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"78","t":"-3.9%","d":"down"}];
const COLS = ["ID","Exit Interview AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hr Service Delivery #001","Hr Service Delivery #002","8.834","4.894","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Hr Service Delivery #002","Hr Service Delivery #003","7.233","1.775","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Hr Service Delivery #003","Hr Service Delivery #004","1.220","7.746","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Hr Service Delivery #004","Hr Service Delivery #005","2.576","4.431","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hr Service Delivery #005","Hr Service Delivery #001","8.666","4.082","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":897},{"label":"Mar","value":579},{"label":"Abr","value":639},{"label":"Mai","value":583},{"label":"Jun","value":857},{"label":"Jul","value":884},{"label":"Ago","value":637},{"label":"Set","value":733},{"label":"Out","value":781},{"label":"Nov","value":693},{"label":"Dez","value":641}];
const MX = 897;
...
export default function ExitAiPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#be185d'}}>AI</span></h1>
                </div>
