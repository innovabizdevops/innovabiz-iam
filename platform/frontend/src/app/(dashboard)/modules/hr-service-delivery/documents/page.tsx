...
const PAGE = "Employee Docs";
const KPIS = [{"l":"eNPS","v":"88","t":"+4.1%","d":"up"},{"l":"Engagement (%)","v":"83.1%","t":"-1.3%","d":"down"},{"l":"Turnover (%)","v":"67.7%","t":"-1.8%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"2.834","t":"+11.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.151","2026-01-02","77","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.341","2026-03-23","60","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.635","2026-02-19","89","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.797","2026-03-23","94","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.324","2026-03-04","55","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":458},{"label":"Mar","value":646},{"label":"Abr","value":598},{"label":"Mai","value":598},{"label":"Jun","value":316},{"label":"Jul","value":447},{"label":"Ago","value":308},{"label":"Set","value":605},{"label":"Out","value":504},{"label":"Nov","value":389},{"label":"Dez","value":476}];
const MX = 646;
