...
const PAGE = "Workplace Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"6.259","t":"+2.6%","d":"up"},{"l":"Queries/Dia","v":"3867","t":"-4.1%","d":"down"},{"l":"Dados Processados (GB)","v":"692","t":"+6.3%","d":"up"},{"l":"Utilizadores Analytics","v":"7.760","t":"+11.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1974","2026-01-15","5.861","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5039","2026-03-19","6.919","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1527","2026-01-23","5.577","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","617","2026-01-07","1.246","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4517","2026-03-23","5.498","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":381},{"label":"Fev","value":387},{"label":"Mar","value":294},{"label":"Abr","value":460},{"label":"Mai","value":282},{"label":"Jun","value":490},{"label":"Jul","value":266},{"label":"Ago","value":514},{"label":"Set","value":239},{"label":"Out","value":538},{"label":"Nov","value":370},{"label":"Dez","value":349}];
const MX = 538;
