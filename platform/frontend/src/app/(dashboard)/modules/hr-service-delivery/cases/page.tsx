...
const KPIS = [{"l":"Projetos Melhoria","v":"8.011","t":"+10.8%","d":"up"},{"l":"Savings (€)","v":"€54729","t":"+6.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"89.6%","t":"+0.1%","d":"up"},{"l":"Ciclos PDCA","v":"1.137","t":"-2.7%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.150","€ 33588.76","8.595","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.601","€ 44323.27","7.914","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.113","€ 27848.35","6.439","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","177","€ 46307.22","8.020","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.065","€ 9652.63","3.144","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":668},{"label":"Mar","value":635},{"label":"Abr","value":733},{"label":"Mai","value":488},{"label":"Jun","value":506},{"label":"Jul","value":616},{"label":"Ago","value":485},{"label":"Set","value":732},{"label":"Out","value":779},{"label":"Nov","value":479},{"label":"Dez","value":562}];
const MX = 779;
