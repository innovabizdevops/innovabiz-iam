...
const PAGE = "Sign";
const KPIS = [{"l":"Formulários Ativos","v":"265","t":"+13.9%","d":"up"},{"l":"Submissões/Dia","v":"1309","t":"+12.5%","d":"up"},{"l":"Documentos Gerados","v":"2.622","t":"-5.8%","d":"down"},{"l":"Templates","v":"7.014","t":"+11.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.725","2026-02-05","1.722","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","673","2026-01-25","6.260","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.406","2026-03-14","7.491","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.839","2026-01-09","5.369","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.361","2026-02-11","8.458","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":633},{"label":"Mar","value":608},{"label":"Abr","value":459},{"label":"Mai","value":785},{"label":"Jun","value":484},{"label":"Jul","value":774},{"label":"Ago","value":540},{"label":"Set","value":809},{"label":"Out","value":656},{"label":"Nov","value":448},{"label":"Dez","value":753}];
const MX = 815;
