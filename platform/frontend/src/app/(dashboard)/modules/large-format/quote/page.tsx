...
const PAGE = "Quote";
const KPIS = [{"l":"Formulários Ativos","v":"4.317","t":"-5.9%","d":"down"},{"l":"Submissões/Dia","v":"1127","t":"+7.1%","d":"up"},{"l":"Documentos Gerados","v":"8.409","t":"-5.4%","d":"down"},{"l":"Templates","v":"7.990","t":"+10.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.356","2026-01-24","4.808","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","473","2026-01-19","3.290","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","268","2026-01-06","7.244","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","474","2026-02-06","5.425","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.293","2026-02-07","3.109","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":541},{"label":"Mar","value":669},{"label":"Abr","value":581},{"label":"Mai","value":864},{"label":"Jun","value":830},{"label":"Jul","value":571},{"label":"Ago","value":554},{"label":"Set","value":874},{"label":"Out","value":826},{"label":"Nov","value":891},{"label":"Dez","value":865}];
const MX = 891;
