...
const PAGE = "Install";
const KPIS = [{"l":"Formulários Ativos","v":"961","t":"+14.9%","d":"up"},{"l":"Submissões/Dia","v":"2110","t":"+6.1%","d":"up"},{"l":"Documentos Gerados","v":"5.288","t":"+10.6%","d":"up"},{"l":"Templates","v":"6.299","t":"-2.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.568","2026-01-23","8.463","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.283","2026-01-11","5.476","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","550","2026-01-24","1.290","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.631","2026-02-13","3.225","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.651","2026-01-11","7.286","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":752},{"label":"Fev","value":527},{"label":"Mar","value":819},{"label":"Abr","value":762},{"label":"Mai","value":472},{"label":"Jun","value":769},{"label":"Jul","value":684},{"label":"Ago","value":685},{"label":"Set","value":869},{"label":"Out","value":646},{"label":"Nov","value":828},{"label":"Dez","value":848}];
const MX = 869;
