...
const PAGE = "Banner";
const KPIS = [{"l":"Formulários Ativos","v":"4.111","t":"-1.2%","d":"down"},{"l":"Submissões/Dia","v":"1804","t":"+11.0%","d":"up"},{"l":"Documentos Gerados","v":"648","t":"+7.6%","d":"up"},{"l":"Templates","v":"4.050","t":"-1.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.029","2026-01-22","8.445","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.757","2026-01-25","2.052","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","305","2026-02-23","7.810","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.451","2026-02-25","2.681","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.210","2026-02-07","6.496","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":779},{"label":"Fev","value":769},{"label":"Mar","value":934},{"label":"Abr","value":909},{"label":"Mai","value":747},{"label":"Jun","value":838},{"label":"Jul","value":694},{"label":"Ago","value":710},{"label":"Set","value":983},{"label":"Out","value":736},{"label":"Nov","value":1017},{"label":"Dez","value":886}];
const MX = 1017;
