...
const ACCENT = "#6366f1";
const MODULE = "Large Format Print";
const PAGE = "Vehicle Wrap";
const KPIS = [{"l":"Formulários Ativos","v":"7.159","t":"-4.4%","d":"down"},{"l":"Submissões/Dia","v":"556","t":"+13.5%","d":"up"},{"l":"Documentos Gerados","v":"6.816","t":"-4.1%","d":"down"},{"l":"Templates","v":"1.815","t":"+10.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.665","2026-03-14","3.185","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.365","2026-01-14","8.154","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.904","2026-02-19","4.014","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.901","2026-02-09","3.278","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","617","2026-01-06","4.745","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":672},{"label":"Fev","value":727},{"label":"Mar","value":597},{"label":"Abr","value":611},{"label":"Mai","value":697},{"label":"Jun","value":610},{"label":"Jul","value":532},{"label":"Ago","value":607},{"label":"Set","value":719},{"label":"Out","value":569},{"label":"Nov","value":694},{"label":"Dez","value":653}];
const MX = 727;
