...
const PAGE = "Topic";
const KPIS = [{"l":"Eventos Planeados","v":"8.707","t":"+17.6%","d":"up"},{"l":"Participantes","v":"1.320","t":"-1.9%","d":"down"},{"l":"NPS Evento","v":"91","t":"+1.4%","d":"up"},{"l":"Receita (€)","v":"€15346","t":"+0.9%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-17","7.640","5.304","€ 42106.59","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-09","2.855","5.033","€ 6121.26","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-03","656","3.588","€ 25925.54","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-16","5.104","2.153","€ 34218.79","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-28","3.769","336","€ 37298.27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":536},{"label":"Mar","value":420},{"label":"Abr","value":546},{"label":"Mai","value":505},{"label":"Jun","value":488},{"label":"Jul","value":499},{"label":"Ago","value":411},{"label":"Set","value":493},{"label":"Out","value":728},{"label":"Nov","value":580},{"label":"Dez","value":613}];
const MX = 728;
