...
const PAGE = "Schema";
const KPIS = [{"l":"Eventos Planeados","v":"3.293","t":"+6.5%","d":"up"},{"l":"Participantes","v":"558","t":"-3.5%","d":"down"},{"l":"NPS Evento","v":"57","t":"+17.3%","d":"up"},{"l":"Receita (€)","v":"€29674","t":"+10.1%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-05","3.809","3.699","€ 41008.94","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-28","5.128","2.118","€ 13859.19","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-03","9.074","7.827","€ 30319.01","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-04","3.326","2.298","€ 35770.37","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-27","5.350","1.412","€ 30665.53","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":533},{"label":"Mar","value":223},{"label":"Abr","value":398},{"label":"Mai","value":479},{"label":"Jun","value":502},{"label":"Jul","value":242},{"label":"Ago","value":581},{"label":"Set","value":558},{"label":"Out","value":324},{"label":"Nov","value":598},{"label":"Dez","value":387}];
const MX = 598;
