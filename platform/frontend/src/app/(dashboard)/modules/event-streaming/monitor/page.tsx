...
const ACCENT = "#0d9488";
const MODULE = "Event Streaming Platform";
const PAGE = "Monitor";
const KPIS = [{"l":"Eventos Planeados","v":"6.179","t":"-0.9%","d":"down"},{"l":"Participantes","v":"1.831","t":"+7.2%","d":"up"},{"l":"NPS Evento","v":"85","t":"-5.3%","d":"down"},{"l":"Receita (€)","v":"€55072","t":"+4.4%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-19","6.371","5.469","€ 41978.95","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-21","7.338","1.356","€ 14699.21","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-02","5.405","3.000","€ 15899.61","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-28","7.195","2.385","€ 39417.82","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-02","4.016","7.561","€ 11372.49","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":538},{"label":"Mar","value":598},{"label":"Abr","value":438},{"label":"Mai","value":423},{"label":"Jun","value":469},{"label":"Jul","value":714},{"label":"Ago","value":721},{"label":"Set","value":403},{"label":"Out","value":510},{"label":"Nov","value":512},{"label":"Dez","value":749}];
const MX = 749;
