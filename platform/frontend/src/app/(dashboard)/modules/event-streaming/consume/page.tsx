...
const PAGE = "Consume";
const KPIS = [{"l":"Eventos Planeados","v":"6.636","t":"+16.7%","d":"up"},{"l":"Participantes","v":"7.862","t":"+10.1%","d":"up"},{"l":"NPS Evento","v":"82","t":"+13.9%","d":"up"},{"l":"Receita (€)","v":"€16384","t":"+6.0%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-09","6.946","3.837","€ 24226.71","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-11","6.779","7.885","€ 1762.39","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-24","1.526","8.524","€ 4561.76","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-08","5.637","8.001","€ 42608.32","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-09","4.887","4.288","€ 22195.56","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":342},{"label":"Mar","value":502},{"label":"Abr","value":386},{"label":"Mai","value":556},{"label":"Jun","value":627},{"label":"Jul","value":624},{"label":"Ago","value":646},{"label":"Set","value":518},{"label":"Out","value":346},{"label":"Nov","value":318},{"label":"Dez","value":500}];
const MX = 646;
