...
/* ═══ Event Streaming Platform — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "2074", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2625", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€366K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "-7%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1695268074", cells: ["EVE-2074", "Event Streaming Platform Item 1", "11/7/2026", "€18 174"], status: "active" as const },
    { id: "1695271645", cells: ["EVE-5645", "Event Streaming Platform Item 2", "26/2/2026", "€21 745"], status: "pending" as const },
    { id: "1695275216", cells: ["EVE-9216", "Event Streaming Platform Item 3", "13/9/2026", "€25 316"], status: "completed" as const },
    { id: "1695278787", cells: ["EVE-3787", "Event Streaming Platform Item 4", "28/4/2026", "€28 887"], status: "warning" as const },
    { id: "1695282358", cells: ["EVE-7358", "Event Streaming Platform Item 5", "15/11/2026", "€32 458"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 94 }, { label: "Fev", value: 23 }, { label: "Mar", value: 32 }, { label: "Abr", value: 41 }, { label: "Mai", value: 50 }, { label: "Jun", value: 59 }];
...
export default function EventStreamingPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Event Streaming Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Event Streaming Platform</p>
                    </div>
                </div>
