...
const ACCENT = "#78350f";
const MODULE = "Human Rights Due Diligence";
const PAGE = "UNGP Report";
const KPIS = [{"l":"Total Human Rights","v":"8.934","t":"+8.1%","d":"up"},{"l":"UNGP Report Ativos","v":"3.554","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"85.4%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"81","t":"+13.4%","d":"up"}];
const COLS = ["ID","UNGP Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Human Rights #001","Human Rights #002","6.923","8.014","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Human Rights #002","Human Rights #003","5.652","4.591","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Human Rights #003","Human Rights #004","5.598","5.870","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Human Rights #004","Human Rights #005","2.722","8.524","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Human Rights #005","Human Rights #001","8.855","8.891","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":777},{"label":"Mar","value":755},{"label":"Abr","value":684},{"label":"Mai","value":928},{"label":"Jun","value":651},{"label":"Jul","value":930},{"label":"Ago","value":662},{"label":"Set","value":610},{"label":"Out","value":940},{"label":"Nov","value":643},{"label":"Dez","value":738}];
const MX = 940;
...
export default function UngpPage() {
    return (
