...
const PAGE = "Risk Map";
const KPIS = [{"l":"Riscos Identificados","v":"3.477","t":"+3.5%","d":"up"},{"l":"Mitigações Ativas","v":"4.904","t":"+11.5%","d":"up"},{"l":"Score Risco Geral","v":"77","t":"+3.7%","d":"up"},{"l":"Incidentes YTD","v":"4.494","t":"+6.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.775","5.771","4.326","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.931","2.072","6.641","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.216","3.924","4.957","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.192","6.359","829","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.189","8.130","4.734","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":782},{"label":"Fev","value":715},{"label":"Mar","value":913},{"label":"Abr","value":905},{"label":"Mai","value":822},{"label":"Jun","value":995},{"label":"Jul","value":612},{"label":"Ago","value":656},{"label":"Set","value":753},{"label":"Out","value":905},{"label":"Nov","value":864},{"label":"Dez","value":752}];
const MX = 995;
