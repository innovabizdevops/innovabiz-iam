...
const PAGE = "Salient Issues";
const KPIS = [{"l":"Total Human Rights","v":"8.561","t":"-2.0%","d":"down"},{"l":"Salient Issues Ativos","v":"8.693","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"69.4%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"79","t":"-1.8%","d":"down"}];
const COLS = ["ID","Salient Issues","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Human Rights #001","Human Rights #002","3.078","8.806","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Human Rights #002","Human Rights #003","9.025","1.032","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Human Rights #003","Human Rights #004","8.974","1.138","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Human Rights #004","Human Rights #005","1.231","4.709","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Human Rights #005","Human Rights #001","7.488","5.990","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":597},{"label":"Mar","value":295},{"label":"Abr","value":293},{"label":"Mai","value":476},{"label":"Jun","value":593},{"label":"Jul","value":403},{"label":"Ago","value":602},{"label":"Set","value":486},{"label":"Out","value":374},{"label":"Nov","value":299},{"label":"Dez","value":313}];
const MX = 602;
