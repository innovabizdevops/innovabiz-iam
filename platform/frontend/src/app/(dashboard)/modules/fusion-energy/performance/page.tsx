...
const KPIS = [{"l":"Formulários Ativos","v":"1.362","t":"+9.9%","d":"up"},{"l":"Submissões/Dia","v":"2537","t":"+5.8%","d":"up"},{"l":"Documentos Gerados","v":"4.966","t":"+6.1%","d":"up"},{"l":"Templates","v":"8.637","t":"+8.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.471","2026-02-16","5.223","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.134","2026-02-11","1.243","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.150","2026-03-25","8.595","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.035","2026-03-23","1.384","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.974","2026-02-11","6.007","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":774},{"label":"Fev","value":936},{"label":"Mar","value":877},{"label":"Abr","value":637},{"label":"Mai","value":670},{"label":"Jun","value":791},{"label":"Jul","value":1006},{"label":"Ago","value":659},{"label":"Set","value":894},{"label":"Out","value":664},{"label":"Nov","value":882},{"label":"Dez","value":996}];
const MX = 1006;
