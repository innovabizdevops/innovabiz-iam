...
const ACCENT = "#b45309";
const MODULE = "Fusion Energy";
const PAGE = "Plasma Monitor";
const KPIS = [{"l":"Total Fusion Energy","v":"7.117","t":"+7.3%","d":"up"},{"l":"Plasma Monitor Ativos","v":"8.870","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"87.3%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"79","t":"-2.3%","d":"down"}];
const COLS = ["ID","Plasma Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fusion Energy #001","Fusion Energy #002","3.569","7.026","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Fusion Energy #002","Fusion Energy #003","318","7.250","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Fusion Energy #003","Fusion Energy #004","8.473","2.061","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Fusion Energy #004","Fusion Energy #005","8.098","4.553","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fusion Energy #005","Fusion Energy #001","5.316","6.395","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":670},{"label":"Mar","value":578},{"label":"Abr","value":590},{"label":"Mai","value":418},{"label":"Jun","value":425},{"label":"Jul","value":619},{"label":"Ago","value":580},{"label":"Set","value":580},{"label":"Out","value":449},{"label":"Nov","value":348},{"label":"Dez","value":683}];
const MX = 709;
