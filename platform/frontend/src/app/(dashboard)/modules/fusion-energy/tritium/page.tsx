...
const PAGE = "Tritium Mgmt";
const KPIS = [{"l":"Total Fusion Energy","v":"680","t":"+6.9%","d":"up"},{"l":"Tritium Mgmt Ativos","v":"8.134","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"77.3%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"86","t":"+13.4%","d":"up"}];
const COLS = ["ID","Tritium Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fusion Energy #001","Fusion Energy #002","5.204","2.062","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Fusion Energy #002","Fusion Energy #003","4.097","8.347","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Fusion Energy #003","Fusion Energy #004","2.697","5.177","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Fusion Energy #004","Fusion Energy #005","7.547","2.524","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fusion Energy #005","Fusion Energy #001","3.466","3.369","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":305},{"label":"Mar","value":474},{"label":"Abr","value":540},{"label":"Mai","value":530},{"label":"Jun","value":437},{"label":"Jul","value":340},{"label":"Ago","value":372},{"label":"Set","value":446},{"label":"Out","value":515},{"label":"Nov","value":339},{"label":"Dez","value":346}];
const MX = 540;
...
export default function TritiumPage() {
    return (
