...
const KPIS = [{"l":"Atletas Registados","v":"4.012","t":"+2.9%","d":"up"},{"l":"Treinos/Semana","v":"4724","t":"-3.8%","d":"down"},{"l":"Competições","v":"4.316","t":"+7.6%","d":"up"},{"l":"Performance Score","v":"93","t":"-4.9%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.215","535","7.195","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.492","8.326","9.099","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.769","1.768","604","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.738","4.529","2.649","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.415","8.611","5.478","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":626},{"label":"Mar","value":257},{"label":"Abr","value":541},{"label":"Mai","value":419},{"label":"Jun","value":429},{"label":"Jul","value":627},{"label":"Ago","value":327},{"label":"Set","value":341},{"label":"Out","value":284},{"label":"Nov","value":480},{"label":"Dez","value":236}];
const MX = 627;
