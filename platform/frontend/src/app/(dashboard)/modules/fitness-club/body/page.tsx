...
const PAGE = "Body Track";
const KPIS = [{"l":"Atletas Registados","v":"5.940","t":"+5.6%","d":"up"},{"l":"Treinos/Semana","v":"3983","t":"-5.6%","d":"down"},{"l":"Competições","v":"2.185","t":"-4.8%","d":"down"},{"l":"Performance Score","v":"69","t":"+13.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.514","8.601","1.043","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.612","809","1.725","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.627","7.062","1.637","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.789","7.333","4.216","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.538","4.559","2.171","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":970},{"label":"Fev","value":641},{"label":"Mar","value":828},{"label":"Abr","value":785},{"label":"Mai","value":980},{"label":"Jun","value":883},{"label":"Jul","value":956},{"label":"Ago","value":612},{"label":"Set","value":952},{"label":"Out","value":718},{"label":"Nov","value":883},{"label":"Dez","value":881}];
const MX = 980;
