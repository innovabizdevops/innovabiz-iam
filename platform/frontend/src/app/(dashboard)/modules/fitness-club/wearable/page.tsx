...
const PAGE = "Wearable Sync";
const KPIS = [{"l":"Integrações Ativas","v":"3.033","t":"+0.1%","d":"up"},{"l":"Chamadas/Hora","v":"3207","t":"+12.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.8%","t":"+11.4%","d":"up"},{"l":"Latência Média (ms)","v":"149ms","t":"+0.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.781","4.882","77.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.740","4.253","81.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.274","2.235","94.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.740","7.146","97.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.345","4.990","96.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":659},{"label":"Mar","value":454},{"label":"Abr","value":350},{"label":"Mai","value":609},{"label":"Jun","value":564},{"label":"Jul","value":439},{"label":"Ago","value":596},{"label":"Set","value":343},{"label":"Out","value":318},{"label":"Nov","value":262},{"label":"Dez","value":474}];
const MX = 659;
