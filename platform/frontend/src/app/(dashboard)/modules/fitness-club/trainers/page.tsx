...
const PAGE = "Trainer Assign";
const KPIS = [{"l":"Atletas Registados","v":"6.620","t":"-3.7%","d":"down"},{"l":"Treinos/Semana","v":"1393","t":"-4.9%","d":"down"},{"l":"Competições","v":"4.174","t":"+9.9%","d":"up"},{"l":"Performance Score","v":"84","t":"-3.5%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.031","7.890","6.592","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.996","3.539","1.031","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.500","3.246","8.375","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.328","5.104","7.413","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.102","8.365","5.685","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":1059},{"label":"Mar","value":1054},{"label":"Abr","value":949},{"label":"Mai","value":843},{"label":"Jun","value":819},{"label":"Jul","value":918},{"label":"Ago","value":1044},{"label":"Set","value":734},{"label":"Out","value":957},{"label":"Nov","value":703},{"label":"Dez","value":964}];
const MX = 1059;
