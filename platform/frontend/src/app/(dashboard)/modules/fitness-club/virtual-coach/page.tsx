...
const ACCENT = "#16a34a";
const MODULE = "Fitness Club";
const PAGE = "Virtual Coach";
const KPIS = [{"l":"Atletas Registados","v":"1.031","t":"+1.7%","d":"up"},{"l":"Treinos/Semana","v":"3993","t":"+14.5%","d":"up"},{"l":"Competições","v":"6.042","t":"+17.7%","d":"up"},{"l":"Performance Score","v":"83","t":"-5.9%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.458","7.191","8.566","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.233","4.348","7.823","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.416","4.671","4.682","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.461","3.213","2.172","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.253","1.274","6.980","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":595},{"label":"Mar","value":607},{"label":"Abr","value":373},{"label":"Mai","value":273},{"label":"Jun","value":344},{"label":"Jul","value":645},{"label":"Ago","value":326},{"label":"Set","value":597},{"label":"Out","value":478},{"label":"Nov","value":619},{"label":"Dez","value":473}];
const MX = 645;
...
export default function VirtualCoachPage() {
    return (
