...
const KPIS = [{"l":"Atletas Registados","v":"6.411","t":"-2.3%","d":"down"},{"l":"Treinos/Semana","v":"4013","t":"+12.5%","d":"up"},{"l":"Competições","v":"2.212","t":"+1.0%","d":"up"},{"l":"Performance Score","v":"55","t":"+13.9%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.906","5.639","2.771","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.693","4.596","7.707","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.963","223","5.343","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.807","5.571","2.502","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.531","843","4.818","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":822},{"label":"Fev","value":721},{"label":"Mar","value":617},{"label":"Abr","value":924},{"label":"Mai","value":733},{"label":"Jun","value":741},{"label":"Jul","value":810},{"label":"Ago","value":764},{"label":"Set","value":652},{"label":"Out","value":677},{"label":"Nov","value":592},{"label":"Dez","value":709}];
const MX = 924;
