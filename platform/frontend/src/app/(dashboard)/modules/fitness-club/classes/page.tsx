...
const KPIS = [{"l":"Atletas Registados","v":"7.910","t":"+6.3%","d":"up"},{"l":"Treinos/Semana","v":"4706","t":"+6.3%","d":"up"},{"l":"Competições","v":"3.581","t":"+5.9%","d":"up"},{"l":"Performance Score","v":"64","t":"+2.9%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.271","668","5.731","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.104","8.943","3.130","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.927","8.323","2.369","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.882","3.806","2.600","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.305","9.038","3.301","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":672},{"label":"Fev","value":681},{"label":"Mar","value":510},{"label":"Abr","value":514},{"label":"Mai","value":514},{"label":"Jun","value":512},{"label":"Jul","value":507},{"label":"Ago","value":656},{"label":"Set","value":756},{"label":"Out","value":561},{"label":"Nov","value":623},{"label":"Dez","value":586}];
const MX = 756;
