...
const PAGE = "Action Plans";
const KPIS = [{"l":"Integrações Ativas","v":"4.639","t":"+12.7%","d":"up"},{"l":"Chamadas/Hora","v":"3778","t":"+4.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"92.1%","t":"+14.6%","d":"up"},{"l":"Latência Média (ms)","v":"198ms","t":"+0.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.483","6.999","90.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.314","1.242","87.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.705","4.590","79.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.173","5.212","77.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.891","3.468","86.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":415},{"label":"Fev","value":503},{"label":"Mar","value":424},{"label":"Abr","value":611},{"label":"Mai","value":689},{"label":"Jun","value":615},{"label":"Jul","value":744},{"label":"Ago","value":579},{"label":"Set","value":701},{"label":"Out","value":712},{"label":"Nov","value":676},{"label":"Dez","value":514}];
const MX = 744;
