...
const ACCENT = "#7dd3fc";
const MODULE = "Accreditation Management";
const PAGE = "Site Visit";
const KPIS = [{"l":"Integrações Ativas","v":"7.221","t":"+10.9%","d":"up"},{"l":"Chamadas/Hora","v":"443","t":"+7.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"76.3%","t":"-0.8%","d":"down"},{"l":"Latência Média (ms)","v":"104ms","t":"+0.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.248","1.318","73.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.280","4.449","95.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.208","7.104","81.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.566","1.174","72.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.501","1.186","95.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":885},{"label":"Mar","value":533},{"label":"Abr","value":625},{"label":"Mai","value":753},{"label":"Jun","value":700},{"label":"Jul","value":530},{"label":"Ago","value":688},{"label":"Set","value":856},{"label":"Out","value":525},{"label":"Nov","value":816},{"label":"Dez","value":874}];
const MX = 885;
