...
const PAGE = "Standards Map";
const KPIS = [{"l":"Integrações Ativas","v":"7.081","t":"+5.7%","d":"up"},{"l":"Chamadas/Hora","v":"2972","t":"+13.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.5%","t":"+8.4%","d":"up"},{"l":"Latência Média (ms)","v":"95ms","t":"+12.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.529","618","91.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.963","6.339","91.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.900","1.812","72.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.577","1.911","93.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.502","2.621","85.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":896},{"label":"Fev","value":748},{"label":"Mar","value":785},{"label":"Abr","value":941},{"label":"Mai","value":796},{"label":"Jun","value":842},{"label":"Jul","value":756},{"label":"Ago","value":928},{"label":"Set","value":823},{"label":"Out","value":917},{"label":"Nov","value":805},{"label":"Dez","value":653}];
const MX = 941;
