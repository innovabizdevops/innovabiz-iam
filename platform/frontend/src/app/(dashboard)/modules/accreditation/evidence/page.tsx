...
const PAGE = "Evidence Collect";
const KPIS = [{"l":"Integrações Ativas","v":"1.149","t":"+11.5%","d":"up"},{"l":"Chamadas/Hora","v":"3590","t":"+10.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"82.1%","t":"+8.9%","d":"up"},{"l":"Latência Média (ms)","v":"76ms","t":"+4.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.450","2.420","80.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.098","1.376","70.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.241","391","82.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.616","502","76.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.883","297","88.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":324},{"label":"Fev","value":380},{"label":"Mar","value":408},{"label":"Abr","value":533},{"label":"Mai","value":347},{"label":"Jun","value":415},{"label":"Jul","value":333},{"label":"Ago","value":452},{"label":"Set","value":449},{"label":"Out","value":549},{"label":"Nov","value":325},{"label":"Dez","value":300}];
const MX = 549;
