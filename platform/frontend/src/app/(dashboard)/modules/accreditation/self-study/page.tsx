...
const PAGE = "Self-Study";
const KPIS = [{"l":"Integrações Ativas","v":"3.004","t":"+8.7%","d":"up"},{"l":"Chamadas/Hora","v":"3456","t":"-1.1%","d":"down"},{"l":"Taxa Sucesso (%)","v":"86.8%","t":"+5.0%","d":"up"},{"l":"Latência Média (ms)","v":"191ms","t":"+10.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.956","7.855","93.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","692","8.009","96.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.733","3.204","82.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.614","7.227","87.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.699","8.763","87.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":599},{"label":"Mar","value":764},{"label":"Abr","value":866},{"label":"Mai","value":797},{"label":"Jun","value":666},{"label":"Jul","value":728},{"label":"Ago","value":537},{"label":"Set","value":828},{"label":"Out","value":865},{"label":"Nov","value":807},{"label":"Dez","value":547}];
const MX = 866;
