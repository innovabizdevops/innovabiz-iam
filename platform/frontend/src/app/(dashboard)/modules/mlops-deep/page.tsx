...
/* ═══ MLOps Platform Deep — Dashboard ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total Registos", value: "7939", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1963", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€352K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1261257939", cells: ["MLO-7939", "MLOps Platform Deep Item 1", "12/4/2026", "€8039"], status: "active" as const },
    { id: "1261261510", cells: ["MLO-2510", "MLOps Platform Deep Item 2", "27/11/2026", "€11 610"], status: "pending" as const },
    { id: "1261265081", cells: ["MLO-6081", "MLOps Platform Deep Item 3", "14/6/2026", "€15 181"], status: "completed" as const },
    { id: "1261268652", cells: ["MLO-9652", "MLOps Platform Deep Item 4", "1/1/2026", "€18 752"], status: "warning" as const },
    { id: "1261272223", cells: ["MLO-4223", "MLOps Platform Deep Item 5", "16/8/2026", "€22 323"], status: "active" as const },
];
...
export default function MlopsPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MLOps Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MLOps Platform Deep</p>
                    </div>
                </div>
