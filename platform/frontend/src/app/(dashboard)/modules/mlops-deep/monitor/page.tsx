...
const ACCENT = "#8b5cf6";
const MODULE = "MLOps Platform Deep";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Mlops Deep","v":"5.531","t":"+7.6%","d":"up"},{"l":"Monitor Ativos","v":"3.562","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"77.1%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"60","t":"+7.5%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mlops Deep #001","Mlops Deep #002","3.724","3.865","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Mlops Deep #002","Mlops Deep #003","2.437","1.688","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Mlops Deep #003","Mlops Deep #004","2.265","8.439","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Mlops Deep #004","Mlops Deep #005","8.728","1.249","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mlops Deep #005","Mlops Deep #001","6.001","567","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":661},{"label":"Mar","value":569},{"label":"Abr","value":652},{"label":"Mai","value":548},{"label":"Jun","value":614},{"label":"Jul","value":638},{"label":"Ago","value":691},{"label":"Set","value":674},{"label":"Out","value":689},{"label":"Nov","value":318},{"label":"Dez","value":672}];
const MX = 691;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#8b5cf6'}}>RTM</span></h1>
                </div>
