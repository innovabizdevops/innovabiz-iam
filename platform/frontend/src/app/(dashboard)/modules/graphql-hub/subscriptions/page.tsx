...
const KPIS = [{"l":"ARR (€M)","v":"€29.3M","t":"+10.1%","d":"up"},{"l":"MRR (€)","v":"€38098","t":"-4.8%","d":"down"},{"l":"Churn (%)","v":"69.3%","t":"-3.5%","d":"down"},{"l":"ARPU (€)","v":"€91795","t":"+0.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 9987.94","6.101","€ 49104.88","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 14573.49","8.325","€ 40754.93","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 1363.66","5.654","€ 30269.17","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 16052.98","2.869","€ 34708.62","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 37837.47","6.570","€ 29825.99","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":396},{"label":"Fev","value":381},{"label":"Mar","value":554},{"label":"Abr","value":432},{"label":"Mai","value":430},{"label":"Jun","value":325},{"label":"Jul","value":529},{"label":"Ago","value":639},{"label":"Set","value":517},{"label":"Out","value":306},{"label":"Nov","value":361},{"label":"Dez","value":585}];
const MX = 639;
