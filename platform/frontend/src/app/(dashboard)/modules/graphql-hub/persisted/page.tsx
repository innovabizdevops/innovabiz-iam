...
const ACCENT = "#e10098";
const MODULE = "GraphQL Hub";
const PAGE = "Persisted Query";
const KPIS = [{"l":"Total Graphql Hub","v":"3.141","t":"+0.1%","d":"up"},{"l":"Persisted Query Ativos","v":"5.684","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"93.2%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"81","t":"+5.6%","d":"up"}];
const COLS = ["ID","Persisted Query","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Graphql Hub #001","Graphql Hub #002","5.396","514","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Graphql Hub #002","Graphql Hub #003","7.973","3.840","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Graphql Hub #003","Graphql Hub #004","8.701","6.262","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Graphql Hub #004","Graphql Hub #005","6.623","1.783","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Graphql Hub #005","Graphql Hub #001","4.570","1.527","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":505},{"label":"Mar","value":584},{"label":"Abr","value":426},{"label":"Mai","value":337},{"label":"Jun","value":268},{"label":"Jul","value":410},{"label":"Ago","value":504},{"label":"Set","value":237},{"label":"Out","value":339},{"label":"Nov","value":465},{"label":"Dez","value":259}];
const MX = 584;
...
export default function PersistedPage() {
    return (
