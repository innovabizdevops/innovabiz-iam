...
/* ═══ Water Stewardship Platform — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "5633", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3001", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€199K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1793608333", cells: ["WAT-8333", "Water Stewardship Platform Item 1", "14/2/2026", "€8433"], status: "active" as const },
    { id: "1793611904", cells: ["WAT-2904", "Water Stewardship Platform Item 2", "1/9/2026", "€12 004"], status: "pending" as const },
    { id: "1793615475", cells: ["WAT-6475", "Water Stewardship Platform Item 3", "16/4/2026", "€15 575"], status: "completed" as const },
    { id: "1793619046", cells: ["WAT-1046", "Water Stewardship Platform Item 4", "3/11/2026", "€19 146"], status: "warning" as const },
    { id: "1793622617", cells: ["WAT-4617", "Water Stewardship Platform Item 5", "18/6/2026", "€22 717"], status: "active" as const },
];
...
export default function WaterStewardshipPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Water Stewardship Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Water Stewardship Platform</p>
                    </div>
                </div>
