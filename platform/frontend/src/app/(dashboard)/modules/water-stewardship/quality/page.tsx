...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.279","t":"+9.1%","d":"up"},{"l":"NC Abertas","v":"5.875","t":"-0.4%","d":"down"},{"l":"Conformidade (%)","v":"86.2%","t":"-1.0%","d":"down"},{"l":"CAPAs Pendentes","v":"2.480","t":"-5.1%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.635","94.5%","4.768","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.465","86.8%","2.532","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.698","92.0%","6.155","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.000","91.4%","4.765","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.215","96.1%","8.102","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":474},{"label":"Fev","value":562},{"label":"Mar","value":327},{"label":"Abr","value":603},{"label":"Mai","value":417},{"label":"Jun","value":334},{"label":"Jul","value":238},{"label":"Ago","value":430},{"label":"Set","value":286},{"label":"Out","value":290},{"label":"Nov","value":457},{"label":"Dez","value":531}];
const MX = 603;
