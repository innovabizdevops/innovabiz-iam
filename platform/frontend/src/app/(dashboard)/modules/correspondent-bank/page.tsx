...
export default function CorrespondentBankPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Correspondent Bank</h1><p className="text-sm text-muted-foreground">Correspondent Bank • iBOS Enterprise</p></div>
