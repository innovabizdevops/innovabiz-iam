...
const PAGE = "Buddy";
const KPIS = [{"l":"eNPS","v":"57","t":"+1.5%","d":"up"},{"l":"Engagement (%)","v":"70.8%","t":"+11.3%","d":"up"},{"l":"Turnover (%)","v":"91.6%","t":"+17.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.567","t":"+6.5%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.300","2026-02-08","67","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.561","2026-01-18","69","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.956","2026-02-02","75","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","159","2026-02-25","83","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.337","2026-02-02","68","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":373},{"label":"Fev","value":573},{"label":"Mar","value":407},{"label":"Abr","value":462},{"label":"Mai","value":488},{"label":"Jun","value":668},{"label":"Jul","value":523},{"label":"Ago","value":661},{"label":"Set","value":358},{"label":"Out","value":716},{"label":"Nov","value":731},{"label":"Dez","value":595}];
const MX = 731;
