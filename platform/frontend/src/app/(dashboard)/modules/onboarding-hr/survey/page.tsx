...
const PAGE = "Survey";
const KPIS = [{"l":"eNPS","v":"89","t":"-6.0%","d":"down"},{"l":"Engagement (%)","v":"90.3%","t":"+15.7%","d":"up"},{"l":"Turnover (%)","v":"84.3%","t":"+10.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.353","t":"+12.5%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.941","2026-02-21","71","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.196","2026-03-25","61","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.883","2026-02-08","93","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.083","2026-03-02","89","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.681","2026-03-08","72","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":473},{"label":"Mar","value":373},{"label":"Abr","value":626},{"label":"Mai","value":531},{"label":"Jun","value":272},{"label":"Jul","value":474},{"label":"Ago","value":343},{"label":"Set","value":557},{"label":"Out","value":415},{"label":"Nov","value":406},{"label":"Dez","value":605}];
const MX = 626;
