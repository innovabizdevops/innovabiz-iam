...
const PAGE = "Document";
const KPIS = [{"l":"eNPS","v":"89","t":"+7.1%","d":"up"},{"l":"Engagement (%)","v":"92.5%","t":"-4.7%","d":"down"},{"l":"Turnover (%)","v":"81.5%","t":"+2.4%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.566","t":"+8.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.971","2026-03-02","69","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","280","2026-02-16","68","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.015","2026-02-26","63","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.737","2026-01-16","66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.111","2026-02-17","94","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":735},{"label":"Mar","value":710},{"label":"Abr","value":628},{"label":"Mai","value":474},{"label":"Jun","value":658},{"label":"Jul","value":660},{"label":"Ago","value":818},{"label":"Set","value":571},{"label":"Out","value":570},{"label":"Nov","value":627},{"label":"Dez","value":704}];
const MX = 818;
