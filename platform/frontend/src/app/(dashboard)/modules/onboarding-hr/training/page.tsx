...
const ACCENT = "#6366f1";
const MODULE = "Employee Onboarding";
const PAGE = "Training";
const KPIS = [{"l":"eNPS","v":"57","t":"+4.3%","d":"up"},{"l":"Engagement (%)","v":"65.6%","t":"+17.1%","d":"up"},{"l":"Turnover (%)","v":"94.9%","t":"+10.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.514","t":"+4.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.216","2026-03-02","69","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.761","2026-01-16","63","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","9.000","2026-03-28","62","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.767","2026-03-10","57","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","763","2026-02-15","74","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":449},{"label":"Mar","value":439},{"label":"Abr","value":375},{"label":"Mai","value":645},{"label":"Jun","value":643},{"label":"Jul","value":450},{"label":"Ago","value":512},{"label":"Set","value":392},{"label":"Out","value":442},{"label":"Nov","value":567},{"label":"Dez","value":415}];
const MX = 645;
