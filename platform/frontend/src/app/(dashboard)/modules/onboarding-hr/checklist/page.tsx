...
const KPIS = [{"l":"eNPS","v":"80","t":"+7.9%","d":"up"},{"l":"Engagement (%)","v":"82.5%","t":"+1.5%","d":"up"},{"l":"Turnover (%)","v":"81.4%","t":"+16.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.747","t":"-1.8%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.461","2026-02-26","61","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.070","2026-01-18","79","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.383","2026-03-09","94","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.121","2026-02-03","67","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.152","2026-01-27","73","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":391},{"label":"Fev","value":619},{"label":"Mar","value":591},{"label":"Abr","value":562},{"label":"Mai","value":458},{"label":"Jun","value":652},{"label":"Jul","value":605},{"label":"Ago","value":594},{"label":"Set","value":587},{"label":"Out","value":520},{"label":"Nov","value":457},{"label":"Dez","value":484}];
const MX = 652;
