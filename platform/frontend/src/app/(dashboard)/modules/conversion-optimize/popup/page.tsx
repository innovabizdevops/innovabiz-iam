...
const PAGE = "Popup";
const KPIS = [{"l":"Formulários Ativos","v":"116","t":"+1.4%","d":"up"},{"l":"Submissões/Dia","v":"140","t":"+13.9%","d":"up"},{"l":"Documentos Gerados","v":"1.119","t":"-3.5%","d":"down"},{"l":"Templates","v":"5.731","t":"+8.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","315","2026-02-23","1.953","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.165","2026-03-02","5.678","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.767","2026-03-15","4.014","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.383","2026-01-20","5.540","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.101","2026-01-25","5.922","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":886},{"label":"Mar","value":784},{"label":"Abr","value":910},{"label":"Mai","value":577},{"label":"Jun","value":756},{"label":"Jul","value":619},{"label":"Ago","value":610},{"label":"Set","value":885},{"label":"Out","value":662},{"label":"Nov","value":650},{"label":"Dez","value":663}];
const MX = 910;
