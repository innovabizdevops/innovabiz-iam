...
export default function ConversionOptimizePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Conversion Optimize</h1><p className="text-sm text-muted-foreground">Conversion Optimize • iBOS Enterprise</p></div>
