...
const PAGE = "Funnel";
const KPIS = [{"l":"Formulários Ativos","v":"5.232","t":"+14.5%","d":"up"},{"l":"Submissões/Dia","v":"2735","t":"-2.2%","d":"down"},{"l":"Documentos Gerados","v":"2.936","t":"+17.2%","d":"up"},{"l":"Templates","v":"1.339","t":"-3.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.306","2026-02-26","5.420","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.237","2026-01-25","7.676","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.557","2026-02-16","4.987","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.908","2026-02-07","5.521","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.429","2026-02-25","1.139","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":805},{"label":"Mar","value":561},{"label":"Abr","value":549},{"label":"Mai","value":701},{"label":"Jun","value":754},{"label":"Jul","value":730},{"label":"Ago","value":786},{"label":"Set","value":513},{"label":"Out","value":489},{"label":"Nov","value":727},{"label":"Dez","value":478}];
const MX = 805;
