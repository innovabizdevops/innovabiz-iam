...
const PAGE = "Form";
const KPIS = [{"l":"Formulários Ativos","v":"1.219","t":"+5.8%","d":"up"},{"l":"Submissões/Dia","v":"413","t":"+11.4%","d":"up"},{"l":"Documentos Gerados","v":"7.208","t":"+12.1%","d":"up"},{"l":"Templates","v":"191","t":"+7.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.562","2026-02-09","3.351","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","764","2026-03-24","1.104","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.293","2026-03-27","5.181","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.819","2026-03-26","4.662","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.330","2026-01-19","1.295","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":669},{"label":"Mar","value":911},{"label":"Abr","value":666},{"label":"Mai","value":620},{"label":"Jun","value":894},{"label":"Jul","value":596},{"label":"Ago","value":549},{"label":"Set","value":843},{"label":"Out","value":872},{"label":"Nov","value":646},{"label":"Dez","value":800}];
const MX = 911;
