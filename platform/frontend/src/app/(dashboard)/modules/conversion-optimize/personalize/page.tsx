...
const ACCENT = "#6366f1";
const MODULE = "Conversion Optimization";
const PAGE = "Personalize";
const KPIS = [{"l":"Formulários Ativos","v":"7.398","t":"+11.0%","d":"up"},{"l":"Submissões/Dia","v":"1163","t":"+5.0%","d":"up"},{"l":"Documentos Gerados","v":"7.600","t":"+10.2%","d":"up"},{"l":"Templates","v":"8.679","t":"-2.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.825","2026-02-03","5.231","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.828","2026-03-07","5.890","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.684","2026-01-10","2.886","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.162","2026-02-07","2.561","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.170","2026-01-25","6.963","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":585},{"label":"Mar","value":858},{"label":"Abr","value":614},{"label":"Mai","value":644},{"label":"Jun","value":866},{"label":"Jul","value":776},{"label":"Ago","value":685},{"label":"Set","value":725},{"label":"Out","value":865},{"label":"Nov","value":727},{"label":"Dez","value":864}];
const MX = 866;
