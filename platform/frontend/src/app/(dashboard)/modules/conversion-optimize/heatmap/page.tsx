...
const PAGE = "Heatmap";
const KPIS = [{"l":"Formulários Ativos","v":"1.411","t":"+6.1%","d":"up"},{"l":"Submissões/Dia","v":"3707","t":"-4.0%","d":"down"},{"l":"Documentos Gerados","v":"2.355","t":"+17.1%","d":"up"},{"l":"Templates","v":"8.834","t":"+0.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.415","2026-02-12","4.197","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.424","2026-02-26","294","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.416","2026-02-14","3.486","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.648","2026-03-07","6.197","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.741","2026-03-02","801","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":841},{"label":"Fev","value":812},{"label":"Mar","value":1024},{"label":"Abr","value":855},{"label":"Mai","value":1052},{"label":"Jun","value":855},{"label":"Jul","value":1050},{"label":"Ago","value":746},{"label":"Set","value":1052},{"label":"Out","value":807},{"label":"Nov","value":1043},{"label":"Dez","value":726}];
const MX = 1052;
