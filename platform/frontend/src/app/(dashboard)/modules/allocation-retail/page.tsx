...
export default function AllocationRetailPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Allocation Retail</h1><p className="text-sm text-muted-foreground">Allocation Retail • iBOS Enterprise</p></div>
