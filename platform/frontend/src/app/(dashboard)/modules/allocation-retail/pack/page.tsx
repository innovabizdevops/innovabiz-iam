...
const PAGE = "Pack Config";
const KPIS = [{"l":"Pedidos/Dia","v":"1747","t":"+7.5%","d":"up"},{"l":"GMV (€)","v":"€92604","t":"-2.8%","d":"down"},{"l":"Conversão (%)","v":"65.1%","t":"+6.3%","d":"up"},{"l":"AOV (€)","v":"€6347","t":"-0.7%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 10313.91","1.824","1.980","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 20795.51","3.589","2.941","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 31574.24","2.337","5.926","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 20456.73","2.436","8.235","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 37257.12","1.856","1.817","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":425},{"label":"Fev","value":606},{"label":"Mar","value":460},{"label":"Abr","value":804},{"label":"Mai","value":730},{"label":"Jun","value":466},{"label":"Jul","value":487},{"label":"Ago","value":424},{"label":"Set","value":543},{"label":"Out","value":639},{"label":"Nov","value":767},{"label":"Dez","value":806}];
const MX = 806;
