...
const ACCENT = "#ec4899";
const MODULE = "Allocation & Replenish";
const PAGE = "Auto-Replen";
const KPIS = [{"l":"Pedidos/Dia","v":"1117","t":"+8.5%","d":"up"},{"l":"GMV (€)","v":"€65071","t":"-2.7%","d":"down"},{"l":"Conversão (%)","v":"88.4%","t":"-0.9%","d":"down"},{"l":"AOV (€)","v":"€42593","t":"-3.5%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 685.65","4.842","8.672","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 35057.94","306","8.991","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 5929.80","2.081","3.608","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 38700.47","1.661","8.154","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 39330.35","5.251","3.784","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":380},{"label":"Fev","value":510},{"label":"Mar","value":336},{"label":"Abr","value":649},{"label":"Mai","value":509},{"label":"Jun","value":703},{"label":"Jul","value":502},{"label":"Ago","value":331},{"label":"Set","value":681},{"label":"Out","value":503},{"label":"Nov","value":542},{"label":"Dez","value":542}];
const MX = 703;
...
export default function ReplenPage() {
    return (
