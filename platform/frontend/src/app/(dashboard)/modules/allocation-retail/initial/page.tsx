...
const PAGE = "Initial Alloc";
const KPIS = [{"l":"Pedidos/Dia","v":"431","t":"-2.3%","d":"down"},{"l":"GMV (€)","v":"€65049","t":"+5.1%","d":"up"},{"l":"Conversão (%)","v":"87.0%","t":"+11.2%","d":"up"},{"l":"AOV (€)","v":"€79848","t":"+7.3%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 48085.34","3.590","912","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 20542.93","6.536","1.997","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 8237.74","8.782","4.706","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 17989.97","5.773","4.852","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 18717.05","2.044","3.094","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":896},{"label":"Mar","value":903},{"label":"Abr","value":774},{"label":"Mai","value":820},{"label":"Jun","value":945},{"label":"Jul","value":804},{"label":"Ago","value":876},{"label":"Set","value":607},{"label":"Out","value":721},{"label":"Nov","value":863},{"label":"Dez","value":912}];
const MX = 945;
