...
/* ═══ Sports Mgmt — Scouting Hub ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "3336", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "123", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1756", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1795828151", cells: ["SPO-5151", "Scouting Hub Item 1", "20/12/2026", "€28 251"], status: "active" as const },
    { id: "1795831722", cells: ["SPO-8722", "Scouting Hub Item 2", "7/7/2026", "€31 822"], status: "pending" as const },
    { id: "1795835293", cells: ["SPO-3293", "Scouting Hub Item 3", "22/2/2026", "€35 393"], status: "completed" as const },
    { id: "1795838864", cells: ["SPO-6864", "Scouting Hub Item 4", "9/9/2026", "€38 964"], status: "warning" as const },
    { id: "1795842435", cells: ["SPO-1435", "Scouting Hub Item 5", "24/4/2026", "€42 535"], status: "active" as const },
];
...
export default function SportsMgmtScoutingHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Scouting Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Sports Mgmt • Scouting Hub</p>
                    </div>
                </div>
