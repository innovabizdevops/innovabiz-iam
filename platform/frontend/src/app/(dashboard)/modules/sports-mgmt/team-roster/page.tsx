...
/* ═══ Sports Mgmt — Team Roster ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "1064", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "36", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2076", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "386586416", cells: ["SPO-1416", "Team Roster Item 1", "21/9/2026", "€36 516"], status: "active" as const },
    { id: "386589987", cells: ["SPO-4987", "Team Roster Item 2", "8/4/2026", "€40 087"], status: "pending" as const },
    { id: "386593558", cells: ["SPO-8558", "Team Roster Item 3", "23/11/2026", "€43 658"], status: "completed" as const },
    { id: "386597129", cells: ["SPO-3129", "Team Roster Item 4", "10/6/2026", "€47 229"], status: "warning" as const },
    { id: "386600700", cells: ["SPO-6700", "Team Roster Item 5", "25/1/2026", "€800"], status: "active" as const },
];
...
export default function SportsMgmtTeamRosterPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Team Roster</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Sports Mgmt • Team Roster</p>
                    </div>
                </div>
