...
/* ═══ Sports Mgmt — Injury Tracker ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "731", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "113", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "754", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1827499725", cells: ["SPO-5725", "Injury Tracker Item 1", "10/10/2026", "€49 825"], status: "active" as const },
    { id: "1827503296", cells: ["SPO-9296", "Injury Tracker Item 2", "25/5/2026", "€3396"], status: "pending" as const },
    { id: "1827506867", cells: ["SPO-3867", "Injury Tracker Item 3", "12/12/2026", "€6967"], status: "completed" as const },
    { id: "1827510438", cells: ["SPO-7438", "Injury Tracker Item 4", "27/7/2026", "€10 538"], status: "warning" as const },
    { id: "1827514009", cells: ["SPO-2009", "Injury Tracker Item 5", "14/2/2026", "€14 109"], status: "active" as const },
];
...
export default function SportsMgmtInjuryTrackerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Injury Tracker</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Sports Mgmt • Injury Tracker</p>
                    </div>
                </div>
