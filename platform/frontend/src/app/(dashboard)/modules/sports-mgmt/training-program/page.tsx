...
/* ═══ Sports Mgmt — Training Program ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "3360", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "368", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2713", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "869885180", cells: ["SPO-9180", "Training Program Item 1", "25/9/2026", "€35 280"], status: "active" as const },
    { id: "869888751", cells: ["SPO-3751", "Training Program Item 2", "12/4/2026", "€38 851"], status: "pending" as const },
    { id: "869892322", cells: ["SPO-7322", "Training Program Item 3", "27/11/2026", "€42 422"], status: "completed" as const },
    { id: "869895893", cells: ["SPO-1893", "Training Program Item 4", "14/6/2026", "€45 993"], status: "warning" as const },
    { id: "869899464", cells: ["SPO-5464", "Training Program Item 5", "1/1/2026", "€49 564"], status: "active" as const },
];
...
export default function SportsMgmtTrainingProgramPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Training Program</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Sports Mgmt • Training Program</p>
                    </div>
                </div>
