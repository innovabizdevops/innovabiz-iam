...
/* ═══ Sports Mgmt — Fan Engagement ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "2369", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "238", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "852", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1984318186", cells: ["SPO-8186", "Fan Engagement Item 1", "19/11/2026", "€18 286"], status: "active" as const },
    { id: "1984321757", cells: ["SPO-2757", "Fan Engagement Item 2", "6/6/2026", "€21 857"], status: "pending" as const },
    { id: "1984325328", cells: ["SPO-6328", "Fan Engagement Item 3", "21/1/2026", "€25 428"], status: "completed" as const },
    { id: "1984328899", cells: ["SPO-9899", "Fan Engagement Item 4", "8/8/2026", "€28 999"], status: "warning" as const },
    { id: "1984332470", cells: ["SPO-4470", "Fan Engagement Item 5", "23/3/2026", "€32 570"], status: "active" as const },
];
...
export default function SportsMgmtFanEngagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fan Engagement</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Sports Mgmt • Fan Engagement</p>
                    </div>
                </div>
