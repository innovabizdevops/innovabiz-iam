...
/* ═══ Sports Mgmt — Player Stats ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "2249", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "310", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "883", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "991544994", cells: ["SPO-6994", "Player Stats Item 1", "7/7/2026", "€45 094"], status: "active" as const },
    { id: "991548565", cells: ["SPO-1565", "Player Stats Item 2", "22/2/2026", "€48 665"], status: "pending" as const },
    { id: "991552136", cells: ["SPO-5136", "Player Stats Item 3", "9/9/2026", "€2236"], status: "completed" as const },
    { id: "991555707", cells: ["SPO-8707", "Player Stats Item 4", "24/4/2026", "€5807"], status: "warning" as const },
    { id: "991559278", cells: ["SPO-3278", "Player Stats Item 5", "11/11/2026", "€9378"], status: "active" as const },
];
...
export default function SportsMgmtPlayerStatsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Player Stats</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Sports Mgmt • Player Stats</p>
                    </div>
                </div>
