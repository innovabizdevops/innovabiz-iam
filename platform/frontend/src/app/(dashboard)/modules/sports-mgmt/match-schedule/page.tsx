...
/* ═══ Sports Mgmt — Match Schedule ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "244", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "260", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3425", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1349651984", cells: ["SPO-3984", "Match Schedule Item 1", "17/9/2026", "€2084"], status: "active" as const },
    { id: "1349655555", cells: ["SPO-7555", "Match Schedule Item 2", "4/4/2026", "€5655"], status: "pending" as const },
    { id: "1349659126", cells: ["SPO-2126", "Match Schedule Item 3", "19/11/2026", "€9226"], status: "completed" as const },
    { id: "1349662697", cells: ["SPO-5697", "Match Schedule Item 4", "6/6/2026", "€12 797"], status: "warning" as const },
    { id: "1349666268", cells: ["SPO-9268", "Match Schedule Item 5", "21/1/2026", "€16 368"], status: "active" as const },
];
...
export default function SportsMgmtMatchSchedulePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Match Schedule</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Sports Mgmt • Match Schedule</p>
                    </div>
                </div>
