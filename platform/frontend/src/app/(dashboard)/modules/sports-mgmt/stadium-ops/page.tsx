...
/* ═══ Sports Mgmt — Stadium Ops ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "3415", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "117", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "18", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2091336017", cells: ["SPO-7017", "Stadium Ops Item 1", "2/6/2026", "€36 117"], status: "active" as const },
    { id: "2091339588", cells: ["SPO-1588", "Stadium Ops Item 2", "17/1/2026", "€39 688"], status: "pending" as const },
    { id: "2091343159", cells: ["SPO-5159", "Stadium Ops Item 3", "4/8/2026", "€43 259"], status: "completed" as const },
    { id: "2091346730", cells: ["SPO-8730", "Stadium Ops Item 4", "19/3/2026", "€46 830"], status: "warning" as const },
    { id: "2091350301", cells: ["SPO-3301", "Stadium Ops Item 5", "6/10/2026", "€401"], status: "active" as const },
];
...
export default function SportsMgmtStadiumOpsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Stadium Ops</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Sports Mgmt • Stadium Ops</p>
                    </div>
                </div>
