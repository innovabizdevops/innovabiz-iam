...
/* ═══ Sports Mgmt — Broadcast Rights ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "1086", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "448", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "33", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "225032684", cells: ["SPO-6684", "Broadcast Rights Item 1", "17/9/2026", "€32 784"], status: "active" as const },
    { id: "225036255", cells: ["SPO-1255", "Broadcast Rights Item 2", "4/4/2026", "€36 355"], status: "pending" as const },
    { id: "225039826", cells: ["SPO-4826", "Broadcast Rights Item 3", "19/11/2026", "€39 926"], status: "completed" as const },
    { id: "225043397", cells: ["SPO-8397", "Broadcast Rights Item 4", "6/6/2026", "€43 497"], status: "warning" as const },
    { id: "225046968", cells: ["SPO-2968", "Broadcast Rights Item 5", "21/1/2026", "€47 068"], status: "active" as const },
];
...
export default function SportsMgmtBroadcastRightsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Broadcast Rights</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Sports Mgmt • Broadcast Rights</p>
                    </div>
                </div>
