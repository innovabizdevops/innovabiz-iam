...
/* ═══ Sports Mgmt — Sponsorship Mgmt ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total", value: "1749", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "445", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3876", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1668397641", cells: ["SPO-5641", "Sponsorship Mgmt Item 1", "2/10/2026", "€47 741"], status: "active" as const },
    { id: "1668401212", cells: ["SPO-9212", "Sponsorship Mgmt Item 2", "17/5/2026", "€1312"], status: "pending" as const },
    { id: "1668404783", cells: ["SPO-3783", "Sponsorship Mgmt Item 3", "4/12/2026", "€4883"], status: "completed" as const },
    { id: "1668408354", cells: ["SPO-7354", "Sponsorship Mgmt Item 4", "19/7/2026", "€8454"], status: "warning" as const },
    { id: "1668411925", cells: ["SPO-1925", "Sponsorship Mgmt Item 5", "6/2/2026", "€12 025"], status: "active" as const },
];
...
export default function SportsMgmtSponsorshipMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sponsorship Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Sports Mgmt • Sponsorship Mgmt</p>
                    </div>
                </div>
