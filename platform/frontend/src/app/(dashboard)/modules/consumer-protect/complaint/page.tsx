...
const ACCENT = "#0891b2";
const MODULE = "Consumer Protection";
const PAGE = "Complaint";
const KPIS = [{"l":"Total Consumer Protect","v":"5.186","t":"+14.5%","d":"up"},{"l":"Complaint Ativos","v":"1.460","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"-0.2%","d":"down"},{"l":"Score Performance","v":"89","t":"+8.8%","d":"up"}];
const COLS = ["ID","Complaint","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Consumer Protect #001","Consumer Protect #002","6.249","3.974","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Consumer Protect #002","Consumer Protect #003","3.835","4.384","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Consumer Protect #003","Consumer Protect #004","5.982","7.099","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Consumer Protect #004","Consumer Protect #005","3.512","2.157","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Consumer Protect #005","Consumer Protect #001","5.112","6.191","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":726},{"label":"Mar","value":717},{"label":"Abr","value":511},{"label":"Mai","value":633},{"label":"Jun","value":487},{"label":"Jul","value":613},{"label":"Ago","value":844},{"label":"Set","value":561},{"label":"Out","value":731},{"label":"Nov","value":598},{"label":"Dez","value":772}];
const MX = 844;
