...
const KPIS = [
    { label: "Total Registos", value: "9709", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4099", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€443K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1000325409", cells: ["CON-3409", "Consumer Protection Item 1", "14/10/2026", "€25 509"], status: "active" as const },
    { id: "1000328980", cells: ["CON-6980", "Consumer Protection Item 2", "1/5/2026", "€29 080"], status: "pending" as const },
    { id: "1000332551", cells: ["CON-1551", "Consumer Protection Item 3", "16/12/2026", "€32 651"], status: "completed" as const },
    { id: "1000336122", cells: ["CON-5122", "Consumer Protection Item 4", "3/7/2026", "€36 222"], status: "warning" as const },
    { id: "1000339693", cells: ["CON-8693", "Consumer Protection Item 5", "18/2/2026", "€39 793"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Consumer Protection</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Consumer Protection</p>
                    </div>
                </div>
