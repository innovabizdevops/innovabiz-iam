...
const PAGE = "Mediate";
const KPIS = [{"l":"Integrações Ativas","v":"3.198","t":"+3.1%","d":"up"},{"l":"Chamadas/Hora","v":"4025","t":"-2.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"66.7%","t":"-1.5%","d":"down"},{"l":"Latência Média (ms)","v":"85ms","t":"+16.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","785","6.207","88.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","941","6.272","79.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.078","5.785","91.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.727","3.050","77.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.365","6.788","100.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":554},{"label":"Mar","value":650},{"label":"Abr","value":612},{"label":"Mai","value":482},{"label":"Jun","value":618},{"label":"Jul","value":707},{"label":"Ago","value":451},{"label":"Set","value":507},{"label":"Out","value":532},{"label":"Nov","value":437},{"label":"Dez","value":453}];
const MX = 707;
