...
const ACCENT = "#6366f1";
const MODULE = "Accounting Firm";
const PAGE = "Client";
const KPIS = [{"l":"Total Accounting Firm","v":"3.060","t":"+3.2%","d":"up"},{"l":"Client Ativos","v":"5.155","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"84","t":"+11.7%","d":"up"}];
const COLS = ["ID","Client","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Accounting Firm #001","Accounting Firm #002","6.346","5.510","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Accounting Firm #002","Accounting Firm #003","1.559","2.248","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Accounting Firm #003","Accounting Firm #004","9.058","2.101","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Accounting Firm #004","Accounting Firm #005","6.404","6.130","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Accounting Firm #005","Accounting Firm #001","6.695","2.359","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":597},{"label":"Fev","value":760},{"label":"Mar","value":775},{"label":"Abr","value":738},{"label":"Mai","value":606},{"label":"Jun","value":720},{"label":"Jul","value":776},{"label":"Ago","value":782},{"label":"Set","value":598},{"label":"Out","value":679},{"label":"Nov","value":710},{"label":"Dez","value":632}];
const MX = 782;
