...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.096","t":"-2.0%","d":"down"},{"l":"NC Abertas","v":"8.083","t":"-4.9%","d":"down"},{"l":"Conformidade (%)","v":"80.3%","t":"+1.6%","d":"up"},{"l":"CAPAs Pendentes","v":"852","t":"-4.5%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.656","82.7%","4.464","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.375","79.2%","741","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.146","74.0%","1.289","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.130","97.3%","1.638","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.766","99.4%","6.360","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":345},{"label":"Mar","value":407},{"label":"Abr","value":308},{"label":"Mai","value":400},{"label":"Jun","value":471},{"label":"Jul","value":360},{"label":"Ago","value":561},{"label":"Set","value":242},{"label":"Out","value":428},{"label":"Nov","value":429},{"label":"Dez","value":467}];
const MX = 576;
