...
const KPIS = [{"l":"eNPS","v":"69","t":"+4.3%","d":"up"},{"l":"Engagement (%)","v":"90.8%","t":"-1.2%","d":"down"},{"l":"Turnover (%)","v":"70.0%","t":"+2.5%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.206","t":"+1.4%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.954","2026-01-09","65","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.496","2026-02-21","74","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.672","2026-01-08","89","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","777","2026-02-05","56","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.645","2026-01-12","76","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":288},{"label":"Mar","value":317},{"label":"Abr","value":569},{"label":"Mai","value":325},{"label":"Jun","value":461},{"label":"Jul","value":388},{"label":"Ago","value":506},{"label":"Set","value":573},{"label":"Out","value":261},{"label":"Nov","value":451},{"label":"Dez","value":467}];
const MX = 573;
