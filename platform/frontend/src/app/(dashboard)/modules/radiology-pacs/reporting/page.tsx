...
const KPIS = [{"l":"Total Radiology Pacs","v":"1.351","t":"+2.7%","d":"up"},{"l":"Reporting Ativos","v":"4.478","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"82.0%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"89","t":"+17.1%","d":"up"}];
const COLS = ["ID","Reporting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Radiology Pacs #001","Radiology Pacs #002","5.428","5.310","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Radiology Pacs #002","Radiology Pacs #003","8.653","3.477","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Radiology Pacs #003","Radiology Pacs #004","8.018","1.025","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Radiology Pacs #004","Radiology Pacs #005","3.614","8.686","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Radiology Pacs #005","Radiology Pacs #001","5.892","7.774","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":487},{"label":"Mar","value":597},{"label":"Abr","value":593},{"label":"Mai","value":642},{"label":"Jun","value":402},{"label":"Jul","value":628},{"label":"Ago","value":358},{"label":"Set","value":596},{"label":"Out","value":457},{"label":"Nov","value":552},{"label":"Dez","value":566}];
const MX = 642;
