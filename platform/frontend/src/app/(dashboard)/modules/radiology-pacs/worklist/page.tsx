...
const PAGE = "Worklist";
const KPIS = [{"l":"Total Radiology Pacs","v":"1.125","t":"-2.7%","d":"down"},{"l":"Worklist Ativos","v":"2.734","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"86.7%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"67","t":"+16.4%","d":"up"}];
const COLS = ["ID","Worklist","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Radiology Pacs #001","Radiology Pacs #002","4.524","770","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Radiology Pacs #002","Radiology Pacs #003","5.990","1.443","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Radiology Pacs #003","Radiology Pacs #004","1.246","537","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Radiology Pacs #004","Radiology Pacs #005","5.727","2.975","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Radiology Pacs #005","Radiology Pacs #001","4.522","894","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":792},{"label":"Mar","value":582},{"label":"Abr","value":640},{"label":"Mai","value":469},{"label":"Jun","value":778},{"label":"Jul","value":690},{"label":"Ago","value":627},{"label":"Set","value":496},{"label":"Out","value":765},{"label":"Nov","value":472},{"label":"Dez","value":794}];
const MX = 794;
