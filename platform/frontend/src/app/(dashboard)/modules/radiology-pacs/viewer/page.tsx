...
const PAGE = "Image Viewer";
const KPIS = [{"l":"Total Radiology Pacs","v":"1.853","t":"-1.0%","d":"down"},{"l":"Image Viewer Ativos","v":"6.006","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"90.9%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"65","t":"+3.9%","d":"up"}];
const COLS = ["ID","Image Viewer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Radiology Pacs #001","Radiology Pacs #002","8.016","8.579","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Radiology Pacs #002","Radiology Pacs #003","7.177","4.752","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Radiology Pacs #003","Radiology Pacs #004","2.190","1.302","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Radiology Pacs #004","Radiology Pacs #005","3.057","1.575","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Radiology Pacs #005","Radiology Pacs #001","8.412","6.687","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":380},{"label":"Fev","value":236},{"label":"Mar","value":247},{"label":"Abr","value":272},{"label":"Mai","value":550},{"label":"Jun","value":301},{"label":"Jul","value":404},{"label":"Ago","value":572},{"label":"Set","value":385},{"label":"Out","value":419},{"label":"Nov","value":330},{"label":"Dez","value":444}];
const MX = 572;
