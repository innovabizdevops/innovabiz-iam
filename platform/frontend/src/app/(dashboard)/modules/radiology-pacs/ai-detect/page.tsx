...
const ACCENT = "#166534";
const MODULE = "Radiology PACS";
const PAGE = "AI Detect";
const KPIS = [{"l":"Total Radiology Pacs","v":"5.634","t":"-5.6%","d":"down"},{"l":"AI Detect Ativos","v":"4.023","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"94.2%","t":"+6.7%","d":"up"},{"l":"Score Performance","v":"80","t":"+15.4%","d":"up"}];
const COLS = ["ID","AI Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Radiology Pacs #001","Radiology Pacs #002","2.845","2.596","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Radiology Pacs #002","Radiology Pacs #003","1.115","3.744","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Radiology Pacs #003","Radiology Pacs #004","6.123","5.939","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Radiology Pacs #004","Radiology Pacs #005","2.561","5.616","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Radiology Pacs #005","Radiology Pacs #001","8.089","2.902","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":694},{"label":"Fev","value":535},{"label":"Mar","value":589},{"label":"Abr","value":441},{"label":"Mai","value":596},{"label":"Jun","value":633},{"label":"Jul","value":638},{"label":"Ago","value":442},{"label":"Set","value":499},{"label":"Out","value":809},{"label":"Nov","value":646},{"label":"Dez","value":440}];
const MX = 809;
