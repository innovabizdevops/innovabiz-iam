...
const ACCENT = "#6366f1";
const MODULE = "Bioinformatics";
const PAGE = "Metabolomics";
const KPIS = [{"l":"Formulários Ativos","v":"1.977","t":"+7.9%","d":"up"},{"l":"Submissões/Dia","v":"2672","t":"+10.1%","d":"up"},{"l":"Documentos Gerados","v":"6.424","t":"+2.0%","d":"up"},{"l":"Templates","v":"2.804","t":"+16.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.206","2026-03-26","4.170","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","514","2026-01-23","1.307","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.542","2026-03-05","6.312","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.079","2026-03-18","5.075","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.810","2026-03-17","6.474","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":411},{"label":"Fev","value":637},{"label":"Mar","value":598},{"label":"Abr","value":348},{"label":"Mai","value":578},{"label":"Jun","value":288},{"label":"Jul","value":424},{"label":"Ago","value":298},{"label":"Set","value":332},{"label":"Out","value":506},{"label":"Nov","value":333},{"label":"Dez","value":457}];
const MX = 637;
