...
const PAGE = "Proteomics";
const KPIS = [{"l":"Formulários Ativos","v":"7.958","t":"+11.9%","d":"up"},{"l":"Submissões/Dia","v":"263","t":"+5.9%","d":"up"},{"l":"Documentos Gerados","v":"591","t":"+16.5%","d":"up"},{"l":"Templates","v":"415","t":"+8.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.180","2026-02-17","5.165","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.947","2026-03-16","5.141","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.560","2026-03-25","6.412","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.752","2026-02-12","6.675","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.546","2026-03-24","4.224","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":589},{"label":"Mar","value":773},{"label":"Abr","value":549},{"label":"Mai","value":795},{"label":"Jun","value":588},{"label":"Jul","value":664},{"label":"Ago","value":461},{"label":"Set","value":836},{"label":"Out","value":588},{"label":"Nov","value":544},{"label":"Dez","value":571}];
const MX = 836;
