...
const PAGE = "Sequence";
const KPIS = [{"l":"Formulários Ativos","v":"8.956","t":"-4.5%","d":"down"},{"l":"Submissões/Dia","v":"154","t":"+10.2%","d":"up"},{"l":"Documentos Gerados","v":"5.415","t":"+0.6%","d":"up"},{"l":"Templates","v":"1.069","t":"-3.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.171","2026-01-01","2.855","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.900","2026-03-01","4.845","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.013","2026-02-07","3.055","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.139","2026-03-27","7.922","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.246","2026-01-26","8.347","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":486},{"label":"Fev","value":533},{"label":"Mar","value":427},{"label":"Abr","value":553},{"label":"Mai","value":591},{"label":"Jun","value":570},{"label":"Jul","value":341},{"label":"Ago","value":364},{"label":"Set","value":272},{"label":"Out","value":221},{"label":"Nov","value":290},{"label":"Dez","value":335}];
const MX = 591;
