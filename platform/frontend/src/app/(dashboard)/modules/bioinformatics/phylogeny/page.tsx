...
const PAGE = "Phylogeny";
const KPIS = [{"l":"Formulários Ativos","v":"7.545","t":"-4.6%","d":"down"},{"l":"Submissões/Dia","v":"2526","t":"+4.6%","d":"up"},{"l":"Documentos Gerados","v":"3.646","t":"+2.0%","d":"up"},{"l":"Templates","v":"5.377","t":"+7.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.371","2026-03-27","8.116","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.613","2026-03-25","803","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.593","2026-03-21","3.121","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.480","2026-02-23","1.047","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.871","2026-02-13","8.656","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":995},{"label":"Mar","value":672},{"label":"Abr","value":672},{"label":"Mai","value":745},{"label":"Jun","value":716},{"label":"Jul","value":888},{"label":"Ago","value":924},{"label":"Set","value":705},{"label":"Out","value":752},{"label":"Nov","value":648},{"label":"Dez","value":632}];
const MX = 995;
