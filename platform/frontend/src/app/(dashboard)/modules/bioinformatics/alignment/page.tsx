...
const PAGE = "Alignment";
const KPIS = [{"l":"Formulários Ativos","v":"734","t":"+8.6%","d":"up"},{"l":"Submissões/Dia","v":"4024","t":"+14.5%","d":"up"},{"l":"Documentos Gerados","v":"3.825","t":"-2.3%","d":"down"},{"l":"Templates","v":"5.950","t":"+17.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.543","2026-03-04","1.005","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.848","2026-02-21","1.513","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.565","2026-03-01","4.184","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.939","2026-01-06","8.678","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.704","2026-02-23","7.183","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":845},{"label":"Mar","value":541},{"label":"Abr","value":724},{"label":"Mai","value":794},{"label":"Jun","value":505},{"label":"Jul","value":841},{"label":"Ago","value":779},{"label":"Set","value":588},{"label":"Out","value":761},{"label":"Nov","value":687},{"label":"Dez","value":635}];
const MX = 845;
