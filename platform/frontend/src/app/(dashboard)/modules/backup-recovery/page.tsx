...
const KPIS = [
    { label: "Total Registos", value: "3465", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3517", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€162K", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "60898265", cells: ["BAC-5265", "Backup & Recovery Item 1", "2/6/2026", "€48 365"], status: "active" as const },
    { id: "60901836", cells: ["BAC-8836", "Backup & Recovery Item 2", "17/1/2026", "€1936"], status: "pending" as const },
    { id: "60905407", cells: ["BAC-3407", "Backup & Recovery Item 3", "4/8/2026", "€5507"], status: "completed" as const },
    { id: "60908978", cells: ["BAC-6978", "Backup & Recovery Item 4", "19/3/2026", "€9078"], status: "warning" as const },
    { id: "60912549", cells: ["BAC-1549", "Backup & Recovery Item 5", "6/10/2026", "€12 649"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Backup & Recovery</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Backup & Recovery</p>
                    </div>
                </div>
