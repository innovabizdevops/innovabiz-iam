...
const PAGE = "Policy";
const KPIS = [{"l":"BCP Plans Ativos","v":"3.654","t":"+0.2%","d":"up"},{"l":"RTO Médio (h)","v":"85h","t":"+16.1%","d":"up"},{"l":"RPO Médio (h)","v":"88h","t":"+7.9%","d":"up"},{"l":"Testes DR (YTD)","v":"736","t":"+0.6%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","116h","143h","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","149h","105h","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","146h","185h","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","197h","14h","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","82h","11h","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":868},{"label":"Fev","value":950},{"label":"Mar","value":894},{"label":"Abr","value":792},{"label":"Mai","value":734},{"label":"Jun","value":989},{"label":"Jul","value":817},{"label":"Ago","value":835},{"label":"Set","value":807},{"label":"Out","value":717},{"label":"Nov","value":814},{"label":"Dez","value":1058}];
const MX = 1058;
