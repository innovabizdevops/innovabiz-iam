...
const ACCENT = "#dc2626";
const MODULE = "Backup & Recovery";
const PAGE = "Test";
const KPIS = [{"l":"BCP Plans Ativos","v":"7.950","t":"+11.5%","d":"up"},{"l":"RTO Médio (h)","v":"60h","t":"+5.6%","d":"up"},{"l":"RPO Médio (h)","v":"77h","t":"+11.2%","d":"up"},{"l":"Testes DR (YTD)","v":"6.592","t":"+17.5%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","175h","188h","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","119h","29h","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","151h","150h","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","14h","182h","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","33h","120h","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":696},{"label":"Mar","value":644},{"label":"Abr","value":558},{"label":"Mai","value":625},{"label":"Jun","value":601},{"label":"Jul","value":661},{"label":"Ago","value":681},{"label":"Set","value":446},{"label":"Out","value":596},{"label":"Nov","value":461},{"label":"Dez","value":525}];
const MX = 696;
