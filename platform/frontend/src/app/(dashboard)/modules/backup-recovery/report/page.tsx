...
const PAGE = "Report";
const KPIS = [{"l":"BCP Plans Ativos","v":"1.328","t":"+7.9%","d":"up"},{"l":"RTO Médio (h)","v":"131h","t":"+13.4%","d":"up"},{"l":"RPO Médio (h)","v":"199h","t":"+0.0%","d":"up"},{"l":"Testes DR (YTD)","v":"806","t":"+14.1%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","29h","59h","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","56h","82h","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","37h","54h","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","171h","173h","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","16h","20h","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":752},{"label":"Mar","value":770},{"label":"Abr","value":967},{"label":"Mai","value":975},{"label":"Jun","value":808},{"label":"Jul","value":646},{"label":"Ago","value":594},{"label":"Set","value":766},{"label":"Out","value":939},{"label":"Nov","value":931},{"label":"Dez","value":776}];
const MX = 975;
