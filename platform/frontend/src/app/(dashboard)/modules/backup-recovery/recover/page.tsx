...
const PAGE = "Recover";
const KPIS = [{"l":"BCP Plans Ativos","v":"5.252","t":"-4.2%","d":"down"},{"l":"RTO Médio (h)","v":"83h","t":"+18.0%","d":"up"},{"l":"RPO Médio (h)","v":"209h","t":"+2.8%","d":"up"},{"l":"Testes DR (YTD)","v":"4.323","t":"+4.0%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","40h","191h","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","20h","70h","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","80h","83h","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","100h","101h","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","185h","150h","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":761},{"label":"Mar","value":673},{"label":"Abr","value":791},{"label":"Mai","value":586},{"label":"Jun","value":669},{"label":"Jul","value":748},{"label":"Ago","value":490},{"label":"Set","value":666},{"label":"Out","value":732},{"label":"Nov","value":872},{"label":"Dez","value":793}];
const MX = 872;
