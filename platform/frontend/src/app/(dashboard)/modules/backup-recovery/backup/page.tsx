...
const PAGE = "Backup";
const KPIS = [{"l":"BCP Plans Ativos","v":"3.102","t":"+6.6%","d":"up"},{"l":"RTO Médio (h)","v":"87h","t":"+11.8%","d":"up"},{"l":"RPO Médio (h)","v":"141h","t":"-0.7%","d":"down"},{"l":"Testes DR (YTD)","v":"2.655","t":"+3.0%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","100h","79h","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","73h","197h","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","114h","189h","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","156h","104h","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","154h","116h","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":849},{"label":"Mar","value":595},{"label":"Abr","value":576},{"label":"Mai","value":705},{"label":"Jun","value":830},{"label":"Jul","value":721},{"label":"Ago","value":923},{"label":"Set","value":611},{"label":"Out","value":668},{"label":"Nov","value":677},{"label":"Dez","value":553}];
const MX = 923;
