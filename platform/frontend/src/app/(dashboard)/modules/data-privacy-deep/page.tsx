...
/* ═══ Data Privacy Deep — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "3809", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3731", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€450K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1969767109", cells: ["DAT-1109", "Data Privacy Deep Item 1", "10/2/2026", "€17 209"], status: "active" as const },
    { id: "1969770680", cells: ["DAT-4680", "Data Privacy Deep Item 2", "25/9/2026", "€20 780"], status: "pending" as const },
    { id: "1969774251", cells: ["DAT-8251", "Data Privacy Deep Item 3", "12/4/2026", "€24 351"], status: "completed" as const },
    { id: "1969777822", cells: ["DAT-2822", "Data Privacy Deep Item 4", "27/11/2026", "€27 922"], status: "warning" as const },
    { id: "1969781393", cells: ["DAT-6393", "Data Privacy Deep Item 5", "14/6/2026", "€31 493"], status: "active" as const },
];
...
export default function DataPrivacyDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Privacy Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Privacy Deep</p>
                    </div>
                </div>
