...
const PAGE = "Discover";
const KPIS = [{"l":"Dashboards Ativos","v":"1.614","t":"+3.0%","d":"up"},{"l":"Queries/Dia","v":"421","t":"+2.6%","d":"up"},{"l":"Dados Processados (GB)","v":"6.185","t":"+0.4%","d":"up"},{"l":"Utilizadores Analytics","v":"4.244","t":"-0.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2807","2026-03-20","1.340","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1293","2026-03-20","6.327","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3968","2026-02-09","1.300","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4925","2026-02-02","6.547","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4402","2026-01-13","4.753","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":427},{"label":"Fev","value":273},{"label":"Mar","value":236},{"label":"Abr","value":313},{"label":"Mai","value":513},{"label":"Jun","value":544},{"label":"Jul","value":461},{"label":"Ago","value":402},{"label":"Set","value":416},{"label":"Out","value":355},{"label":"Nov","value":542},{"label":"Dez","value":365}];
const MX = 544;
