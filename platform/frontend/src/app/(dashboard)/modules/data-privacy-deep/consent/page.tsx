...
const PAGE = "Consent";
const KPIS = [{"l":"Dashboards Ativos","v":"4.045","t":"-0.4%","d":"down"},{"l":"Queries/Dia","v":"1205","t":"+12.2%","d":"up"},{"l":"Dados Processados (GB)","v":"482","t":"+9.4%","d":"up"},{"l":"Utilizadores Analytics","v":"7.859","t":"+11.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1476","2026-03-06","7.191","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","244","2026-03-14","5.264","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1071","2026-03-18","7.734","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3671","2026-01-25","8.163","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3473","2026-01-09","4.364","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":689},{"label":"Fev","value":675},{"label":"Mar","value":620},{"label":"Abr","value":795},{"label":"Mai","value":919},{"label":"Jun","value":911},{"label":"Jul","value":938},{"label":"Ago","value":671},{"label":"Set","value":678},{"label":"Out","value":609},{"label":"Nov","value":688},{"label":"Dez","value":730}];
const MX = 938;
