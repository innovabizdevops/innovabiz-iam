...
const PAGE = "SAR";
const KPIS = [{"l":"Dashboards Ativos","v":"8.293","t":"+2.9%","d":"up"},{"l":"Queries/Dia","v":"3446","t":"+4.9%","d":"up"},{"l":"Dados Processados (GB)","v":"3.842","t":"+0.8%","d":"up"},{"l":"Utilizadores Analytics","v":"8.251","t":"+0.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4948","2026-01-08","5.914","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4102","2026-03-15","4.529","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2296","2026-02-22","6.897","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","900","2026-03-08","1.834","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3092","2026-02-03","1.218","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":547},{"label":"Mar","value":679},{"label":"Abr","value":753},{"label":"Mai","value":475},{"label":"Jun","value":717},{"label":"Jul","value":659},{"label":"Ago","value":478},{"label":"Set","value":582},{"label":"Out","value":560},{"label":"Nov","value":749},{"label":"Dez","value":641}];
const MX = 753;
