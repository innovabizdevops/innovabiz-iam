...
const PAGE = "Mask";
const KPIS = [{"l":"Dashboards Ativos","v":"100","t":"-4.0%","d":"down"},{"l":"Queries/Dia","v":"1332","t":"+5.4%","d":"up"},{"l":"Dados Processados (GB)","v":"609","t":"+16.3%","d":"up"},{"l":"Utilizadores Analytics","v":"1.751","t":"+2.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2651","2026-01-13","8.576","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3804","2026-01-22","7.206","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3459","2026-01-12","5.449","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1767","2026-02-07","6.559","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2648","2026-01-03","676","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":998},{"label":"Fev","value":870},{"label":"Mar","value":836},{"label":"Abr","value":922},{"label":"Mai","value":654},{"label":"Jun","value":933},{"label":"Jul","value":623},{"label":"Ago","value":631},{"label":"Set","value":667},{"label":"Out","value":821},{"label":"Nov","value":887},{"label":"Dez","value":734}];
const MX = 998;
