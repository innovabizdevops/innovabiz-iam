...
const ACCENT = "#1e3a5f";
const MODULE = "Data Privacy Deep";
const PAGE = "Classify";
const KPIS = [{"l":"Dashboards Ativos","v":"4.890","t":"-4.5%","d":"down"},{"l":"Queries/Dia","v":"2320","t":"+2.0%","d":"up"},{"l":"Dados Processados (GB)","v":"1.750","t":"+2.8%","d":"up"},{"l":"Utilizadores Analytics","v":"3.551","t":"-2.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5026","2026-03-22","5.423","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4218","2026-02-25","7.279","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1122","2026-02-22","1.231","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3794","2026-03-24","6.268","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3150","2026-01-19","4.958","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1023},{"label":"Fev","value":731},{"label":"Mar","value":1004},{"label":"Abr","value":1003},{"label":"Mai","value":836},{"label":"Jun","value":941},{"label":"Jul","value":907},{"label":"Ago","value":868},{"label":"Set","value":889},{"label":"Out","value":965},{"label":"Nov","value":996},{"label":"Dez","value":1072}];
const MX = 1072;
