...
const PAGE = "Automate Flows";
const KPIS = [{"l":"Formulários Ativos","v":"1.007","t":"-2.5%","d":"down"},{"l":"Submissões/Dia","v":"891","t":"+14.8%","d":"up"},{"l":"Documentos Gerados","v":"2.023","t":"+8.6%","d":"up"},{"l":"Templates","v":"5.815","t":"+10.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","430","2026-03-16","2.966","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.687","2026-01-16","810","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.654","2026-03-07","2.790","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.966","2026-02-17","2.696","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","162","2026-02-15","3.488","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":545},{"label":"Mar","value":742},{"label":"Abr","value":712},{"label":"Mai","value":528},{"label":"Jun","value":433},{"label":"Jul","value":543},{"label":"Ago","value":578},{"label":"Set","value":588},{"label":"Out","value":575},{"label":"Nov","value":660},{"label":"Dez","value":667}];
const MX = 742;
