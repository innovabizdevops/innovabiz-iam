...
const ACCENT = "#7c3aed";
const MODULE = "Power Platform";
const PAGE = "Virtual Agents";
const KPIS = [{"l":"Formulários Ativos","v":"115","t":"-5.7%","d":"down"},{"l":"Submissões/Dia","v":"1650","t":"+8.9%","d":"up"},{"l":"Documentos Gerados","v":"990","t":"+1.5%","d":"up"},{"l":"Templates","v":"2.701","t":"+2.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.353","2026-01-06","4.823","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.030","2026-03-13","8.084","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.283","2026-02-13","360","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.296","2026-03-27","8.442","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.329","2026-03-04","8.496","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":756},{"label":"Mar","value":684},{"label":"Abr","value":826},{"label":"Mai","value":568},{"label":"Jun","value":475},{"label":"Jul","value":753},{"label":"Ago","value":778},{"label":"Set","value":707},{"label":"Out","value":773},{"label":"Nov","value":649},{"label":"Dez","value":631}];
const MX = 826;
