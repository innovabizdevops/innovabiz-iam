...
const KPIS = [{"l":"Formulários Ativos","v":"6.385","t":"+13.0%","d":"up"},{"l":"Submissões/Dia","v":"3855","t":"+14.5%","d":"up"},{"l":"Documentos Gerados","v":"5.265","t":"+10.2%","d":"up"},{"l":"Templates","v":"8.487","t":"-3.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.679","2026-03-07","1.590","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.352","2026-03-04","3.329","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.168","2026-01-20","5.084","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.576","2026-01-15","8.127","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.867","2026-03-14","6.473","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":425},{"label":"Fev","value":310},{"label":"Mar","value":405},{"label":"Abr","value":380},{"label":"Mai","value":565},{"label":"Jun","value":354},{"label":"Jul","value":427},{"label":"Ago","value":494},{"label":"Set","value":290},{"label":"Out","value":451},{"label":"Nov","value":294},{"label":"Dez","value":605}];
const MX = 605;
