...
const PAGE = "Power Pages";
const KPIS = [{"l":"Formulários Ativos","v":"8.665","t":"+11.2%","d":"up"},{"l":"Submissões/Dia","v":"3791","t":"+15.8%","d":"up"},{"l":"Documentos Gerados","v":"2.825","t":"+12.4%","d":"up"},{"l":"Templates","v":"4.373","t":"+7.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.857","2026-02-07","6.621","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.635","2026-03-22","6.809","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.381","2026-01-21","3.029","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.661","2026-02-16","5.350","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.453","2026-01-03","6.641","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":705},{"label":"Mar","value":650},{"label":"Abr","value":550},{"label":"Mai","value":415},{"label":"Jun","value":573},{"label":"Jul","value":542},{"label":"Ago","value":446},{"label":"Set","value":734},{"label":"Out","value":682},{"label":"Nov","value":454},{"label":"Dez","value":400}];
const MX = 734;
