...
const PAGE = "Dataverse";
const KPIS = [{"l":"Formulários Ativos","v":"1.185","t":"+-0.0%","d":"up"},{"l":"Submissões/Dia","v":"1076","t":"+9.9%","d":"up"},{"l":"Documentos Gerados","v":"3.155","t":"+4.5%","d":"up"},{"l":"Templates","v":"2.729","t":"+13.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.834","2026-02-28","5.704","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.401","2026-01-22","4.370","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.012","2026-03-07","6.911","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.741","2026-03-03","587","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.780","2026-01-08","8.665","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":514},{"label":"Mar","value":532},{"label":"Abr","value":496},{"label":"Mai","value":572},{"label":"Jun","value":524},{"label":"Jul","value":603},{"label":"Ago","value":783},{"label":"Set","value":703},{"label":"Out","value":519},{"label":"Nov","value":804},{"label":"Dez","value":678}];
const MX = 804;
