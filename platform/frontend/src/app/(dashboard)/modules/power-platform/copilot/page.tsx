...
const PAGE = "Copilot Studio";
const KPIS = [{"l":"Formulários Ativos","v":"4.945","t":"+14.4%","d":"up"},{"l":"Submissões/Dia","v":"2754","t":"+0.1%","d":"up"},{"l":"Documentos Gerados","v":"9.026","t":"-4.3%","d":"down"},{"l":"Templates","v":"8.087","t":"+0.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.133","2026-01-05","4.232","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.978","2026-02-24","975","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.568","2026-01-22","324","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","242","2026-02-22","4.404","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.435","2026-02-16","1.099","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":595},{"label":"Mar","value":371},{"label":"Abr","value":454},{"label":"Mai","value":629},{"label":"Jun","value":406},{"label":"Jul","value":398},{"label":"Ago","value":287},{"label":"Set","value":434},{"label":"Out","value":562},{"label":"Nov","value":368},{"label":"Dez","value":508}];
const MX = 629;
