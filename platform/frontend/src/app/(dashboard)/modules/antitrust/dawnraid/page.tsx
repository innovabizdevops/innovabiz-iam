...
const ACCENT = "#dc2626";
const MODULE = "Antitrust Compliance";
const PAGE = "Dawn Raid";
const KPIS = [{"l":"Total Antitrust","v":"7.148","t":"-1.9%","d":"down"},{"l":"Dawn Raid Ativos","v":"106","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"87.5%","t":"+6.7%","d":"up"},{"l":"Score Performance","v":"81","t":"-1.2%","d":"down"}];
const COLS = ["ID","Dawn Raid","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Antitrust #001","Antitrust #002","3.861","7.914","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Antitrust #002","Antitrust #003","7.504","5.667","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Antitrust #003","Antitrust #004","4.658","931","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Antitrust #004","Antitrust #005","2.134","4.825","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Antitrust #005","Antitrust #001","883","8.315","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":308},{"label":"Fev","value":337},{"label":"Mar","value":390},{"label":"Abr","value":472},{"label":"Mai","value":349},{"label":"Jun","value":469},{"label":"Jul","value":421},{"label":"Ago","value":460},{"label":"Set","value":369},{"label":"Out","value":357},{"label":"Nov","value":379},{"label":"Dez","value":475}];
const MX = 475;
...
export default function DawnraidPage() {
    return (
