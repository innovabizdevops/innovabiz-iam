...
const PAGE = "Usage";
const KPIS = [{"l":"Projetos Melhoria","v":"717","t":"+2.6%","d":"up"},{"l":"Savings (€)","v":"€38448","t":"-4.6%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"78.2%","t":"-3.5%","d":"down"},{"l":"Ciclos PDCA","v":"6.460","t":"+9.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.948","€ 27463.56","2.690","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.529","€ 21192.63","4.672","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.409","€ 38051.52","1.624","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.249","€ 20677.91","2.617","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.796","€ 19844.64","7.835","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":718},{"label":"Fev","value":746},{"label":"Mar","value":707},{"label":"Abr","value":742},{"label":"Mai","value":617},{"label":"Jun","value":522},{"label":"Jul","value":620},{"label":"Ago","value":448},{"label":"Set","value":706},{"label":"Out","value":643},{"label":"Nov","value":498},{"label":"Dez","value":410}];
const MX = 746;
