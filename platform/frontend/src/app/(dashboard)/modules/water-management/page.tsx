...
const KPIS = [
    { label: "Total Registos", value: "9904", trend: "-5%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3432", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€56K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "-12%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2050329504", cells: ["WAT-4504", "Water Management Item 1", "21/1/2026", "€29 604"], status: "active" as const },
    { id: "2050333075", cells: ["WAT-8075", "Water Management Item 2", "8/8/2026", "€33 175"], status: "pending" as const },
    { id: "2050336646", cells: ["WAT-2646", "Water Management Item 3", "23/3/2026", "€36 746"], status: "completed" as const },
    { id: "2050340217", cells: ["WAT-6217", "Water Management Item 4", "10/10/2026", "€40 317"], status: "warning" as const },
    { id: "2050343788", cells: ["WAT-9788", "Water Management Item 5", "25/5/2026", "€43 888"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Water Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Water Management</p>
                    </div>
                </div>
