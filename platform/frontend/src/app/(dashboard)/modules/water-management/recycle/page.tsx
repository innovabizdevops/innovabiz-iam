...
const PAGE = "Recycle";
const KPIS = [{"l":"Projetos Melhoria","v":"6.051","t":"+5.5%","d":"up"},{"l":"Savings (€)","v":"€30777","t":"+15.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"79.7%","t":"+15.9%","d":"up"},{"l":"Ciclos PDCA","v":"1.655","t":"+1.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.260","€ 33666.68","6.008","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","736","€ 28484.00","8.209","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.232","€ 40501.76","5.455","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.524","€ 4217.86","5.168","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.117","€ 35637.66","1.995","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":919},{"label":"Fev","value":924},{"label":"Mar","value":625},{"label":"Abr","value":794},{"label":"Mai","value":869},{"label":"Jun","value":632},{"label":"Jul","value":634},{"label":"Ago","value":958},{"label":"Set","value":952},{"label":"Out","value":626},{"label":"Nov","value":631},{"label":"Dez","value":631}];
const MX = 958;
