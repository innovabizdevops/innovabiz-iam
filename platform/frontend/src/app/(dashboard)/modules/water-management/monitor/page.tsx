...
const PAGE = "Monitor";
const KPIS = [{"l":"Projetos Melhoria","v":"131","t":"+4.1%","d":"up"},{"l":"Savings (€)","v":"€38541","t":"+1.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"94.0%","t":"+17.5%","d":"up"},{"l":"Ciclos PDCA","v":"3.323","t":"-2.9%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.921","€ 39825.04","3.548","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.875","€ 21652.90","5.275","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.385","€ 24674.41","3.392","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.641","€ 36816.04","4.972","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","389","€ 36031.99","8.939","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":994},{"label":"Mar","value":806},{"label":"Abr","value":880},{"label":"Mai","value":772},{"label":"Jun","value":976},{"label":"Jul","value":672},{"label":"Ago","value":783},{"label":"Set","value":757},{"label":"Out","value":846},{"label":"Nov","value":901},{"label":"Dez","value":709}];
const MX = 994;
