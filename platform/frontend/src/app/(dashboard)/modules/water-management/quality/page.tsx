...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.323","t":"-0.1%","d":"down"},{"l":"NC Abertas","v":"8.281","t":"-5.7%","d":"down"},{"l":"Conformidade (%)","v":"67.1%","t":"+8.7%","d":"up"},{"l":"CAPAs Pendentes","v":"3.241","t":"+13.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.175","88.4%","6.586","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","483","82.2%","1.175","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.233","93.9%","545","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.404","79.2%","6.727","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.255","88.6%","746","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":867},{"label":"Fev","value":772},{"label":"Mar","value":967},{"label":"Abr","value":654},{"label":"Mai","value":884},{"label":"Jun","value":633},{"label":"Jul","value":832},{"label":"Ago","value":978},{"label":"Set","value":933},{"label":"Out","value":847},{"label":"Nov","value":621},{"label":"Dez","value":633}];
const MX = 978;
