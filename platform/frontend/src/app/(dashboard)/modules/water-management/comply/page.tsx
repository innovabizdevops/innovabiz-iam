...
const PAGE = "Comply";
const KPIS = [{"l":"Projetos Melhoria","v":"6.833","t":"+1.7%","d":"up"},{"l":"Savings (€)","v":"€4678","t":"+13.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"90.2%","t":"-4.5%","d":"down"},{"l":"Ciclos PDCA","v":"1.475","t":"+8.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.085","€ 1781.21","5.804","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.178","€ 23006.21","7.957","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.059","€ 16374.46","5.048","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.172","€ 37715.95","1.525","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.142","€ 29959.59","4.864","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":278},{"label":"Fev","value":323},{"label":"Mar","value":530},{"label":"Abr","value":538},{"label":"Mai","value":526},{"label":"Jun","value":296},{"label":"Jul","value":439},{"label":"Ago","value":312},{"label":"Set","value":534},{"label":"Out","value":382},{"label":"Nov","value":296},{"label":"Dez","value":454}];
const MX = 538;
