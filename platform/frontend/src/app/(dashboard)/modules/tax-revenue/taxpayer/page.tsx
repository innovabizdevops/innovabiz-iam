...
const PAGE = "Taxpayer Mgmt";
const KPIS = [{"l":"ARR (€M)","v":"€9.7M","t":"+12.8%","d":"up"},{"l":"MRR (€)","v":"€87748","t":"+16.0%","d":"up"},{"l":"Churn (%)","v":"70.5%","t":"+16.5%","d":"up"},{"l":"ARPU (€)","v":"€44691","t":"+5.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 5751.28","699","€ 1447.07","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 18170.53","7.381","€ 25188.36","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 14612.65","3.330","€ 37845.63","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 10659.28","8.486","€ 28401.61","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 28510.43","3.684","€ 34251.40","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":518},{"label":"Fev","value":494},{"label":"Mar","value":419},{"label":"Abr","value":627},{"label":"Mai","value":472},{"label":"Jun","value":683},{"label":"Jul","value":594},{"label":"Ago","value":594},{"label":"Set","value":323},{"label":"Out","value":325},{"label":"Nov","value":611},{"label":"Dez","value":431}];
const MX = 683;
