...
const KPIS = [{"l":"ARR (€M)","v":"€22.3M","t":"+16.3%","d":"up"},{"l":"MRR (€)","v":"€32818","t":"-4.2%","d":"down"},{"l":"Churn (%)","v":"70.5%","t":"+16.7%","d":"up"},{"l":"ARPU (€)","v":"€90574","t":"+10.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 33389.78","1.779","€ 31064.01","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 338.01","7.055","€ 45737.40","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 18661.10","6.208","€ 37701.99","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 9842.14","704","€ 49490.51","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 9117.16","1.070","€ 2079.12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":1027},{"label":"Mar","value":767},{"label":"Abr","value":740},{"label":"Mai","value":895},{"label":"Jun","value":827},{"label":"Jul","value":690},{"label":"Ago","value":1078},{"label":"Set","value":885},{"label":"Out","value":1076},{"label":"Nov","value":901},{"label":"Dez","value":888}];
const MX = 1078;
