...
const KPIS = [{"l":"ARR (€M)","v":"€47.2M","t":"-3.8%","d":"down"},{"l":"MRR (€)","v":"€13939","t":"+16.9%","d":"up"},{"l":"Churn (%)","v":"91.6%","t":"+4.8%","d":"up"},{"l":"ARPU (€)","v":"€28419","t":"+0.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 11087.66","4.795","€ 5626.75","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 34027.61","3.197","€ 4389.92","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 23219.85","8.615","€ 44282.06","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 2865.54","5.141","€ 12352.63","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 49002.13","8.111","€ 5626.03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":766},{"label":"Mar","value":634},{"label":"Abr","value":721},{"label":"Mai","value":722},{"label":"Jun","value":799},{"label":"Jul","value":624},{"label":"Ago","value":424},{"label":"Set","value":681},{"label":"Out","value":812},{"label":"Nov","value":688},{"label":"Dez","value":625}];
const MX = 812;
