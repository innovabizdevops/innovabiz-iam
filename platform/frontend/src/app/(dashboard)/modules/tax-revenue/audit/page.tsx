...
const ACCENT = "#dc2626";
const MODULE = "Tax Revenue";
const PAGE = "Audit Select";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.206","t":"+8.2%","d":"up"},{"l":"NC Abertas","v":"3.446","t":"+7.3%","d":"up"},{"l":"Conformidade (%)","v":"75.7%","t":"+14.0%","d":"up"},{"l":"CAPAs Pendentes","v":"4.694","t":"+1.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.451","73.7%","7.241","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.734","90.8%","6.178","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.901","82.6%","5.122","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.816","84.6%","6.670","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.584","73.9%","7.296","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":243},{"label":"Fev","value":385},{"label":"Mar","value":271},{"label":"Abr","value":496},{"label":"Mai","value":319},{"label":"Jun","value":327},{"label":"Jul","value":531},{"label":"Ago","value":436},{"label":"Set","value":362},{"label":"Out","value":355},{"label":"Nov","value":565},{"label":"Dez","value":447}];
const MX = 565;
