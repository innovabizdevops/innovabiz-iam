...
const KPIS = [{"l":"ARR (€M)","v":"€13.6M","t":"-5.9%","d":"down"},{"l":"MRR (€)","v":"€57542","t":"+1.1%","d":"up"},{"l":"Churn (%)","v":"88.6%","t":"-1.9%","d":"down"},{"l":"ARPU (€)","v":"€36947","t":"-1.1%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 10717.23","7.409","€ 19947.99","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 4835.17","7.145","€ 48425.88","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 2817.86","7.762","€ 38079.14","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 47365.34","6.881","€ 2927.03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 37647.62","7.324","€ 35248.82","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":317},{"label":"Fev","value":496},{"label":"Mar","value":490},{"label":"Abr","value":347},{"label":"Mai","value":356},{"label":"Jun","value":601},{"label":"Jul","value":537},{"label":"Ago","value":571},{"label":"Set","value":334},{"label":"Out","value":589},{"label":"Nov","value":576},{"label":"Dez","value":430}];
const MX = 601;
