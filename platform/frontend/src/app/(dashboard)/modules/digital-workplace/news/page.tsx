...
const ACCENT = "#4338ca";
const MODULE = "Digital Workplace";
const PAGE = "News &amp; Announcements";
const KPIS = [{"l":"Total Digital Workplace","v":"2.513","t":"+5.9%","d":"up"},{"l":"News & Announcements Ativos","v":"3.407","t":"-4.8%","d":"down"},{"l":"Eficiência (%)","v":"69.8%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"93","t":"-3.4%","d":"down"}];
const COLS = ["ID","News & Announcements","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Digital Workplace #001","Digital Workplace #002","2.087","6.330","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Digital Workplace #002","Digital Workplace #003","6.945","3.783","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Workplace #003","Digital Workplace #004","7.644","4.939","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Digital Workplace #004","Digital Workplace #005","907","8.567","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Workplace #005","Digital Workplace #001","5.610","8.096","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":541},{"label":"Mar","value":433},{"label":"Abr","value":671},{"label":"Mai","value":799},{"label":"Jun","value":600},{"label":"Jul","value":695},{"label":"Ago","value":708},{"label":"Set","value":772},{"label":"Out","value":672},{"label":"Nov","value":794},{"label":"Dez","value":744}];
const MX = 799;
