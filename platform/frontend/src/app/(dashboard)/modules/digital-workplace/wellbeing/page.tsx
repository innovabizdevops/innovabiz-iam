...
const KPIS = [{"l":"eNPS","v":"79","t":"+11.2%","d":"up"},{"l":"Engagement (%)","v":"74.6%","t":"+17.1%","d":"up"},{"l":"Turnover (%)","v":"65.8%","t":"+4.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.610","t":"+17.5%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.250","2026-02-17","90","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.731","2026-03-12","80","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.442","2026-02-18","82","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.080","2026-02-13","78","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.276","2026-01-04","88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":461},{"label":"Mar","value":469},{"label":"Abr","value":437},{"label":"Mai","value":807},{"label":"Jun","value":510},{"label":"Jul","value":493},{"label":"Ago","value":685},{"label":"Set","value":512},{"label":"Out","value":697},{"label":"Nov","value":445},{"label":"Dez","value":530}];
const MX = 807;
