...
const KPIS = [{"l":"eNPS","v":"66","t":"+4.7%","d":"up"},{"l":"Engagement (%)","v":"90.5%","t":"+2.6%","d":"up"},{"l":"Turnover (%)","v":"88.6%","t":"+0.8%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.497","t":"+1.4%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.532","2026-02-02","68","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.499","2026-03-11","58","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.791","2026-03-18","58","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","350","2026-02-14","58","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.370","2026-01-23","60","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":576},{"label":"Mar","value":665},{"label":"Abr","value":426},{"label":"Mai","value":507},{"label":"Jun","value":381},{"label":"Jul","value":415},{"label":"Ago","value":574},{"label":"Set","value":542},{"label":"Out","value":506},{"label":"Nov","value":589},{"label":"Dez","value":652}];
const MX = 665;
