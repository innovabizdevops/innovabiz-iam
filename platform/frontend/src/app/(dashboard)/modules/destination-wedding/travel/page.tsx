...
const PAGE = "Travel";
const KPIS = [{"l":"Total Destination Wedding","v":"4.824","t":"+5.7%","d":"up"},{"l":"Travel Ativos","v":"5.308","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"65.9%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"77","t":"+12.8%","d":"up"}];
const COLS = ["ID","Travel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Destination Wedding #001","Destination Wedding #002","1.268","2.320","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Destination Wedding #002","Destination Wedding #003","4.524","6.479","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Destination Wedding #003","Destination Wedding #004","1.258","4.735","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Destination Wedding #004","Destination Wedding #005","6.141","1.979","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Destination Wedding #005","Destination Wedding #001","7.838","4.695","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":608},{"label":"Mar","value":683},{"label":"Abr","value":867},{"label":"Mai","value":785},{"label":"Jun","value":824},{"label":"Jul","value":875},{"label":"Ago","value":659},{"label":"Set","value":902},{"label":"Out","value":680},{"label":"Nov","value":572},{"label":"Dez","value":787}];
const MX = 902;
