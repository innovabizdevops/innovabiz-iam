...
/* ═══ Destination Wedding — Dashboard ═══ */

const ACCENT = "#9d174d";

const KPIS = [
    { label: "Total Registos", value: "716", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "224", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€90K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "636818116", cells: ["DES-6116", "Destination Wedding Item 1", "5/5/2026", "€18 216"], status: "active" as const },
    { id: "636821687", cells: ["DES-9687", "Destination Wedding Item 2", "20/12/2026", "€21 787"], status: "pending" as const },
    { id: "636825258", cells: ["DES-4258", "Destination Wedding Item 3", "7/7/2026", "€25 358"], status: "completed" as const },
    { id: "636828829", cells: ["DES-7829", "Destination Wedding Item 4", "22/2/2026", "€28 929"], status: "warning" as const },
    { id: "636832400", cells: ["DES-2400", "Destination Wedding Item 5", "9/9/2026", "€32 500"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Destination Wedding</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Destination Wedding</p>
                    </div>
                </div>
