...
const PAGE = "Legal";
const KPIS = [{"l":"Total Destination Wedding","v":"8.275","t":"+9.3%","d":"up"},{"l":"Legal Ativos","v":"1.036","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"83.1%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"73","t":"-1.1%","d":"down"}];
const COLS = ["ID","Legal","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Destination Wedding #001","Destination Wedding #002","5.811","1.868","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Destination Wedding #002","Destination Wedding #003","7.476","1.569","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Destination Wedding #003","Destination Wedding #004","4.643","8.141","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Destination Wedding #004","Destination Wedding #005","6.200","7.858","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Destination Wedding #005","Destination Wedding #001","2.418","7.861","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":506},{"label":"Mar","value":583},{"label":"Abr","value":317},{"label":"Mai","value":386},{"label":"Jun","value":692},{"label":"Jul","value":368},{"label":"Ago","value":552},{"label":"Set","value":669},{"label":"Out","value":317},{"label":"Nov","value":674},{"label":"Dez","value":409}];
const MX = 692;
