...
const ACCENT = "#9d174d";
const MODULE = "Destination Wedding";
const PAGE = "Coordinate";
const KPIS = [{"l":"Total Destination Wedding","v":"3.381","t":"+11.9%","d":"up"},{"l":"Coordinate Ativos","v":"7.504","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"92.1%","t":"+12.2%","d":"up"},{"l":"Score Performance","v":"93","t":"+16.9%","d":"up"}];
const COLS = ["ID","Coordinate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Destination Wedding #001","Destination Wedding #002","3.555","1.276","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Destination Wedding #002","Destination Wedding #003","3.531","4.415","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Destination Wedding #003","Destination Wedding #004","9.026","3.399","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Destination Wedding #004","Destination Wedding #005","2.586","1.275","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Destination Wedding #005","Destination Wedding #001","1.905","6.576","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":925},{"label":"Fev","value":858},{"label":"Mar","value":722},{"label":"Abr","value":1084},{"label":"Mai","value":990},{"label":"Jun","value":856},{"label":"Jul","value":759},{"label":"Ago","value":871},{"label":"Set","value":774},{"label":"Out","value":775},{"label":"Nov","value":911},{"label":"Dez","value":748}];
const MX = 1084;
