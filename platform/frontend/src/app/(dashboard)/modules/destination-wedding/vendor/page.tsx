...
const PAGE = "Vendor";
const KPIS = [{"l":"Fornecedores Ativos","v":"3.995","t":"+4.2%","d":"up"},{"l":"Contratos (€M)","v":"€10.5M","t":"+12.1%","d":"up"},{"l":"On-Time Delivery (%)","v":"81.9%","t":"-1.7%","d":"down"},{"l":"Score Médio","v":"90","t":"+0.2%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","86.4%","€ 34016.50","3.430","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","91.6%","€ 7648.75","4.289","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","75.3%","€ 34516.73","4.265","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","86.6%","€ 15692.94","6.645","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","95.9%","€ 19897.62","2.242","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":863},{"label":"Mar","value":774},{"label":"Abr","value":752},{"label":"Mai","value":834},{"label":"Jun","value":601},{"label":"Jul","value":563},{"label":"Ago","value":715},{"label":"Set","value":523},{"label":"Out","value":869},{"label":"Nov","value":785},{"label":"Dez","value":544}];
const MX = 869;
