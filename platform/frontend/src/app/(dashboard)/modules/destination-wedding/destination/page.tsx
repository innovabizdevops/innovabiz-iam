...
const KPIS = [{"l":"Total Destination Wedding","v":"3.507","t":"+17.5%","d":"up"},{"l":"Destination Ativos","v":"8.986","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"70.8%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"86","t":"-0.8%","d":"down"}];
const COLS = ["ID","Destination","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Destination Wedding #001","Destination Wedding #002","3.345","8.385","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Destination Wedding #002","Destination Wedding #003","8.056","7.831","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Destination Wedding #003","Destination Wedding #004","3.698","8.517","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Destination Wedding #004","Destination Wedding #005","7.024","7.786","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Destination Wedding #005","Destination Wedding #001","8.106","7.603","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":482},{"label":"Mar","value":585},{"label":"Abr","value":682},{"label":"Mai","value":503},{"label":"Jun","value":572},{"label":"Jul","value":430},{"label":"Ago","value":416},{"label":"Set","value":439},{"label":"Out","value":574},{"label":"Nov","value":319},{"label":"Dez","value":524}];
const MX = 682;
