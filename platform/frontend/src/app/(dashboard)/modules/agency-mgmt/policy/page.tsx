...
const PAGE = "Policy";
const KPIS = [{"l":"Total Agency Mgmt","v":"620","t":"+8.7%","d":"up"},{"l":"Policy Ativos","v":"8.015","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"86.3%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"95","t":"+14.9%","d":"up"}];
const COLS = ["ID","Policy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agency Mgmt #001","Agency Mgmt #002","4.518","7.733","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Agency Mgmt #002","Agency Mgmt #003","3.915","5.363","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Agency Mgmt #003","Agency Mgmt #004","7.938","2.537","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Agency Mgmt #004","Agency Mgmt #005","2.322","593","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agency Mgmt #005","Agency Mgmt #001","3.359","908","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":652},{"label":"Mar","value":645},{"label":"Abr","value":624},{"label":"Mai","value":495},{"label":"Jun","value":574},{"label":"Jul","value":658},{"label":"Ago","value":672},{"label":"Set","value":555},{"label":"Out","value":702},{"label":"Nov","value":370},{"label":"Dez","value":659}];
const MX = 702;
