...
/* ═══ Insurance Agency Mgmt — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "4672", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3835", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€129K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "947860272", cells: ["AGE-8272", "Insurance Agency Mgmt Item 1", "17/1/2026", "€10 372"], status: "active" as const },
    { id: "947863843", cells: ["AGE-2843", "Insurance Agency Mgmt Item 2", "4/8/2026", "€13 943"], status: "pending" as const },
    { id: "947867414", cells: ["AGE-6414", "Insurance Agency Mgmt Item 3", "19/3/2026", "€17 514"], status: "completed" as const },
    { id: "947870985", cells: ["AGE-9985", "Insurance Agency Mgmt Item 4", "6/10/2026", "€21 085"], status: "warning" as const },
    { id: "947874556", cells: ["AGE-4556", "Insurance Agency Mgmt Item 5", "21/5/2026", "€24 656"], status: "active" as const },
];
...
export default function InsuranceAgencyMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Insurance Agency Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Insurance Agency Mgmt</p>
                    </div>
                </div>
