...
const PAGE = "CRM";
const KPIS = [{"l":"Total Agency Mgmt","v":"171","t":"+12.4%","d":"up"},{"l":"CRM Ativos","v":"3.079","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"66.7%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"87","t":"+7.6%","d":"up"}];
const COLS = ["ID","CRM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agency Mgmt #001","Agency Mgmt #002","1.261","3.421","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Agency Mgmt #002","Agency Mgmt #003","1.689","1.172","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Agency Mgmt #003","Agency Mgmt #004","4.223","7.732","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Agency Mgmt #004","Agency Mgmt #005","7.316","5.567","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agency Mgmt #005","Agency Mgmt #001","5.866","3.463","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":383},{"label":"Fev","value":515},{"label":"Mar","value":262},{"label":"Abr","value":388},{"label":"Mai","value":345},{"label":"Jun","value":599},{"label":"Jul","value":612},{"label":"Ago","value":526},{"label":"Set","value":403},{"label":"Out","value":542},{"label":"Nov","value":340},{"label":"Dez","value":425}];
const MX = 612;
