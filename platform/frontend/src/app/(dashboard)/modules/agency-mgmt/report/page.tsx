...
const PAGE = "Report";
const KPIS = [{"l":"Total Agency Mgmt","v":"8.005","t":"+9.9%","d":"up"},{"l":"Report Ativos","v":"6.799","t":"+4.4%","d":"up"},{"l":"Eficiência (%)","v":"84.0%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"56","t":"+9.2%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agency Mgmt #001","Agency Mgmt #002","5.226","6.999","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Agency Mgmt #002","Agency Mgmt #003","8.028","3.857","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Agency Mgmt #003","Agency Mgmt #004","8.204","4.894","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Agency Mgmt #004","Agency Mgmt #005","6.809","5.464","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agency Mgmt #005","Agency Mgmt #001","1.097","8.693","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1009},{"label":"Fev","value":617},{"label":"Mar","value":781},{"label":"Abr","value":1000},{"label":"Mai","value":850},{"label":"Jun","value":672},{"label":"Jul","value":656},{"label":"Ago","value":825},{"label":"Set","value":631},{"label":"Out","value":987},{"label":"Nov","value":628},{"label":"Dez","value":1008}];
const MX = 1009;
