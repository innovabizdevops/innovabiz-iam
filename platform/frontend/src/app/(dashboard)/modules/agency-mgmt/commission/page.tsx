...
const ACCENT = "#92400e";
const MODULE = "Insurance Agency Mgmt";
const PAGE = "Commission";
const KPIS = [{"l":"Vendas YTD (€)","v":"€78058","t":"+9.1%","d":"up"},{"l":"Pipeline (€)","v":"€52534","t":"+14.0%","d":"up"},{"l":"Atingimento Quota (%)","v":"78.6%","t":"-2.4%","d":"down"},{"l":"Win Rate (%)","v":"71.2%","t":"+1.1%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 34947.20","€ 4598.90","€ 15972.85","84.1%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 16289.66","€ 7565.32","€ 7808.38","88.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 37167.25","€ 17790.39","€ 30614.93","80.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 29103.32","€ 41454.27","€ 17301.57","83.7%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 8635.42","€ 40771.78","€ 26832.57","95.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":701},{"label":"Mar","value":711},{"label":"Abr","value":959},{"label":"Mai","value":967},{"label":"Jun","value":899},{"label":"Jul","value":894},{"label":"Ago","value":803},{"label":"Set","value":911},{"label":"Out","value":893},{"label":"Nov","value":954},{"label":"Dez","value":903}];
const MX = 967;
