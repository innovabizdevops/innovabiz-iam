...
const KPIS = [{"l":"Total Agency Mgmt","v":"1.762","t":"-0.8%","d":"down"},{"l":"Marketing Ativos","v":"5.260","t":"+1.3%","d":"up"},{"l":"Eficiência (%)","v":"78.7%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"65","t":"+12.5%","d":"up"}];
const COLS = ["ID","Marketing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agency Mgmt #001","Agency Mgmt #002","1.717","5.738","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Agency Mgmt #002","Agency Mgmt #003","614","8.001","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Agency Mgmt #003","Agency Mgmt #004","8.100","5.842","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Agency Mgmt #004","Agency Mgmt #005","4.767","8.275","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agency Mgmt #005","Agency Mgmt #001","3.133","4.306","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":646},{"label":"Fev","value":776},{"label":"Mar","value":867},{"label":"Abr","value":817},{"label":"Mai","value":691},{"label":"Jun","value":721},{"label":"Jul","value":760},{"label":"Ago","value":638},{"label":"Set","value":790},{"label":"Out","value":701},{"label":"Nov","value":920},{"label":"Dez","value":764}];
const MX = 920;
