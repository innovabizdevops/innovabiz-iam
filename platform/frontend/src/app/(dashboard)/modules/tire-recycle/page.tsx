...
/* ═══ Tire Recycling — Dashboard ═══ */

const ACCENT = "#064e3b";

const KPIS = [
    { label: "Total Registos", value: "6739", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "326", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€100K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "958296939", cells: ["TIR-4939", "Tire Recycling Item 1", "20/4/2026", "€47 039"], status: "active" as const },
    { id: "958300510", cells: ["TIR-8510", "Tire Recycling Item 2", "7/11/2026", "€610"], status: "pending" as const },
    { id: "958304081", cells: ["TIR-3081", "Tire Recycling Item 3", "22/6/2026", "€4181"], status: "completed" as const },
    { id: "958307652", cells: ["TIR-6652", "Tire Recycling Item 4", "9/1/2026", "€7752"], status: "warning" as const },
    { id: "958311223", cells: ["TIR-1223", "Tire Recycling Item 5", "24/8/2026", "€11 323"], status: "active" as const },
];
...
export default function TireRecyclingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tire Recycling</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Tire Recycling</p>
                    </div>
                </div>
