...
const ACCENT = "#6d28d9";
const MODULE = "Telecom BSS Platform";
const PAGE = "Product";
const KPIS = [{"l":"Total Telecom Bss","v":"8.268","t":"+15.0%","d":"up"},{"l":"Product Ativos","v":"1.988","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"90.3%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"90","t":"+7.0%","d":"up"}];
const COLS = ["ID","Product","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Bss #001","Telecom Bss #002","6.008","2.655","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Bss #002","Telecom Bss #003","1.379","3.469","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Bss #003","Telecom Bss #004","5.895","6.697","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Bss #004","Telecom Bss #005","7.511","6.690","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Bss #005","Telecom Bss #001","8.270","5.682","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":726},{"label":"Mar","value":755},{"label":"Abr","value":514},{"label":"Mai","value":601},{"label":"Jun","value":677},{"label":"Jul","value":815},{"label":"Ago","value":715},{"label":"Set","value":567},{"label":"Out","value":682},{"label":"Nov","value":619},{"label":"Dez","value":805}];
const MX = 815;
