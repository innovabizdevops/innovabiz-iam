...
const PAGE = "Bill";
const KPIS = [{"l":"Total Telecom Bss","v":"7.358","t":"+14.0%","d":"up"},{"l":"Bill Ativos","v":"7.536","t":"+7.0%","d":"up"},{"l":"Eficiência (%)","v":"66.3%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"74","t":"-1.5%","d":"down"}];
const COLS = ["ID","Bill","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Bss #001","Telecom Bss #002","3.371","3.189","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Bss #002","Telecom Bss #003","5.407","5.361","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Bss #003","Telecom Bss #004","4.997","3.967","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Bss #004","Telecom Bss #005","3.086","6.405","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Bss #005","Telecom Bss #001","3.011","944","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":467},{"label":"Fev","value":585},{"label":"Mar","value":737},{"label":"Abr","value":656},{"label":"Mai","value":455},{"label":"Jun","value":413},{"label":"Jul","value":657},{"label":"Ago","value":447},{"label":"Set","value":669},{"label":"Out","value":425},{"label":"Nov","value":561},{"label":"Dez","value":436}];
const MX = 737;
