...
/* ═══ Telecom BSS Platform — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "4039", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3387", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€252K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "797508339", cells: ["TEL-1339", "Telecom BSS Platform Item 1", "20/4/2026", "€8439"], status: "active" as const },
    { id: "797511910", cells: ["TEL-4910", "Telecom BSS Platform Item 2", "7/11/2026", "€12 010"], status: "pending" as const },
    { id: "797515481", cells: ["TEL-8481", "Telecom BSS Platform Item 3", "22/6/2026", "€15 581"], status: "completed" as const },
    { id: "797519052", cells: ["TEL-3052", "Telecom BSS Platform Item 4", "9/1/2026", "€19 152"], status: "warning" as const },
    { id: "797522623", cells: ["TEL-6623", "Telecom BSS Platform Item 5", "24/8/2026", "€22 723"], status: "active" as const },
];
...
export default function TelecomBssPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Telecom BSS Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Telecom BSS Platform</p>
                    </div>
                </div>
