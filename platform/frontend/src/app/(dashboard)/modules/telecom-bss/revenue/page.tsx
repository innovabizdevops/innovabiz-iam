...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€8.0M","t":"+17.3%","d":"up"},{"l":"MRR (€)","v":"€91385","t":"-0.3%","d":"down"},{"l":"Churn (%)","v":"66.1%","t":"+9.5%","d":"up"},{"l":"ARPU (€)","v":"€27544","t":"+4.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 18047.52","7.020","€ 248.06","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 6112.26","4.693","€ 8011.82","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 12922.45","162","€ 39674.55","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 8879.02","4.332","€ 27179.78","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 39383.47","2.745","€ 7476.83","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":369},{"label":"Fev","value":402},{"label":"Mar","value":380},{"label":"Abr","value":328},{"label":"Mai","value":393},{"label":"Jun","value":676},{"label":"Jul","value":418},{"label":"Ago","value":390},{"label":"Set","value":676},{"label":"Out","value":348},{"label":"Nov","value":611},{"label":"Dez","value":482}];
const MX = 676;
