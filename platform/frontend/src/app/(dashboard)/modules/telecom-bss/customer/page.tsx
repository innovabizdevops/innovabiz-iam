...
const PAGE = "Customer";
const KPIS = [{"l":"Total Telecom Bss","v":"5.625","t":"-0.2%","d":"down"},{"l":"Customer Ativos","v":"€2650","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"80.8%","t":"+6.5%","d":"up"},{"l":"Score Performance","v":"76","t":"+8.4%","d":"up"}];
const COLS = ["ID","Customer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Bss #001","€ 13953.10","2.900","444","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Bss #002","€ 30629.33","5.360","7.142","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Bss #003","€ 34390.24","7.434","4.899","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Bss #004","€ 21412.84","1.656","8.453","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Bss #005","€ 40228.46","7.036","5.268","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":431},{"label":"Fev","value":731},{"label":"Mar","value":793},{"label":"Abr","value":503},{"label":"Mai","value":459},{"label":"Jun","value":610},{"label":"Jul","value":685},{"label":"Ago","value":636},{"label":"Set","value":676},{"label":"Out","value":483},{"label":"Nov","value":666},{"label":"Dez","value":470}];
const MX = 793;
