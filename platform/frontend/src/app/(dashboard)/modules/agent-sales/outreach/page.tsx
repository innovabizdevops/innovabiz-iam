...
const PAGE = "Outreach";
const KPIS = [{"l":"Vendas YTD (€)","v":"€5101","t":"+2.0%","d":"up"},{"l":"Pipeline (€)","v":"€69143","t":"+14.6%","d":"up"},{"l":"Atingimento Quota (%)","v":"92.0%","t":"-4.8%","d":"down"},{"l":"Win Rate (%)","v":"81.9%","t":"+16.2%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 41155.33","€ 5556.93","€ 27518.76","86.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 36065.46","€ 23478.53","€ 27468.99","92.4%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 27929.94","€ 24703.95","€ 31236.32","95.2%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 24284.47","€ 39223.86","€ 18099.55","81.7%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 9891.32","€ 553.33","€ 48662.99","80.4%"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":549},{"label":"Mar","value":719},{"label":"Abr","value":532},{"label":"Mai","value":504},{"label":"Jun","value":548},{"label":"Jul","value":551},{"label":"Ago","value":472},{"label":"Set","value":672},{"label":"Out","value":642},{"label":"Nov","value":757},{"label":"Dez","value":576}];
const MX = 757;
