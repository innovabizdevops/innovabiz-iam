...
const ACCENT = "#7c3aed";
const MODULE = "AI Sales Agent";
const PAGE = "Prospect";
const KPIS = [{"l":"Vendas YTD (€)","v":"€12961","t":"+0.0%","d":"up"},{"l":"Pipeline (€)","v":"€23080","t":"-5.9%","d":"down"},{"l":"Atingimento Quota (%)","v":"65.8%","t":"-4.5%","d":"down"},{"l":"Win Rate (%)","v":"92.9%","t":"-5.9%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 18991.18","€ 32312.70","€ 50029.12","98.4%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 1197.18","€ 9151.35","€ 29448.00","72.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 29022.56","€ 9304.87","€ 8921.99","89.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 45485.71","€ 7098.39","€ 16001.19","80.2%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 46772.07","€ 7021.60","€ 43382.68","87.9%"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":583},{"label":"Mar","value":494},{"label":"Abr","value":501},{"label":"Mai","value":443},{"label":"Jun","value":511},{"label":"Jul","value":301},{"label":"Ago","value":552},{"label":"Set","value":314},{"label":"Out","value":449},{"label":"Nov","value":584},{"label":"Dez","value":500}];
const MX = 584;
