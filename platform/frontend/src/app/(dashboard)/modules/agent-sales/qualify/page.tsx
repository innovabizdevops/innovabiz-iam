...
const PAGE = "Qualify";
const KPIS = [{"l":"Vendas YTD (€)","v":"€58217","t":"-0.4%","d":"down"},{"l":"Pipeline (€)","v":"€39086","t":"-1.6%","d":"down"},{"l":"Atingimento Quota (%)","v":"65.2%","t":"+8.7%","d":"up"},{"l":"Win Rate (%)","v":"90.0%","t":"+14.1%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 4204.45","€ 39378.98","€ 33566.54","88.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 12808.03","€ 29960.45","€ 44678.77","86.3%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 43932.23","€ 50076.57","€ 17698.04","70.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 25032.78","€ 17070.84","€ 26538.01","93.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 49220.49","€ 18541.13","€ 27557.15","84.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":868},{"label":"Mar","value":751},{"label":"Abr","value":1032},{"label":"Mai","value":988},{"label":"Jun","value":717},{"label":"Jul","value":755},{"label":"Ago","value":782},{"label":"Set","value":902},{"label":"Out","value":911},{"label":"Nov","value":916},{"label":"Dez","value":808}];
const MX = 1032;
