...
const KPIS = [{"l":"Vendas YTD (€)","v":"€6065","t":"+15.7%","d":"up"},{"l":"Pipeline (€)","v":"€61867","t":"+0.4%","d":"up"},{"l":"Atingimento Quota (%)","v":"92.4%","t":"+6.5%","d":"up"},{"l":"Win Rate (%)","v":"84.8%","t":"+13.0%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 11332.65","€ 20536.58","€ 27780.04","76.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 26576.19","€ 22448.78","€ 13345.40","92.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 26964.86","€ 20669.50","€ 4863.67","71.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 13926.39","€ 45438.81","€ 22562.51","77.4%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 12816.13","€ 30704.27","€ 12759.69","83.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":692},{"label":"Mar","value":773},{"label":"Abr","value":867},{"label":"Mai","value":843},{"label":"Jun","value":721},{"label":"Jul","value":785},{"label":"Ago","value":877},{"label":"Set","value":1031},{"label":"Out","value":826},{"label":"Nov","value":736},{"label":"Dez","value":982}];
const MX = 1031;
