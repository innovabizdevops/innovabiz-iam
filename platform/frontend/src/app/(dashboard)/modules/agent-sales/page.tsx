...
const KPIS = [
    { label: "Total Registos", value: "8535", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4996", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€440K", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1848635435", cells: ["AGE-9435", "AI Sales Agent Item 1", "4/12/2026", "€35 535"], status: "active" as const },
    { id: "1848639006", cells: ["AGE-4006", "AI Sales Agent Item 2", "19/7/2026", "€39 106"], status: "pending" as const },
    { id: "1848642577", cells: ["AGE-7577", "AI Sales Agent Item 3", "6/2/2026", "€42 677"], status: "completed" as const },
    { id: "1848646148", cells: ["AGE-2148", "AI Sales Agent Item 4", "21/9/2026", "€46 248"], status: "warning" as const },
    { id: "1848649719", cells: ["AGE-5719", "AI Sales Agent Item 5", "8/4/2026", "€49 819"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Sales Agent</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Sales Agent</p>
                    </div>
                </div>
