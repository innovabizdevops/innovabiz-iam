...
const PAGE = "Book";
const KPIS = [{"l":"Vendas YTD (€)","v":"€30362","t":"+16.7%","d":"up"},{"l":"Pipeline (€)","v":"€2449","t":"+5.8%","d":"up"},{"l":"Atingimento Quota (%)","v":"69.3%","t":"-3.5%","d":"down"},{"l":"Win Rate (%)","v":"90.5%","t":"+4.9%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 41485.71","€ 42799.57","€ 1342.82","100.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 17284.48","€ 38811.94","€ 33963.31","76.0%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 29783.07","€ 11331.40","€ 19386.57","97.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 15942.50","€ 35006.86","€ 7010.16","94.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 1397.27","€ 28704.89","€ 6327.68","80.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":575},{"label":"Mar","value":603},{"label":"Abr","value":463},{"label":"Mai","value":557},{"label":"Jun","value":673},{"label":"Jul","value":728},{"label":"Ago","value":460},{"label":"Set","value":540},{"label":"Out","value":818},{"label":"Nov","value":614},{"label":"Dez","value":787}];
const MX = 818;
