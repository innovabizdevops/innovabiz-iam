...
const ACCENT = "#ec4899";
const MODULE = "Wedding & Events";
const PAGE = "Planning";
const KPIS = [{"l":"Total Wedding Events","v":"7.415","t":"+12.0%","d":"up"},{"l":"Planning Ativos","v":"6.755","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"76.4%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"95","t":"+16.3%","d":"up"}];
const COLS = ["ID","Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wedding Events #001","Wedding Events #002","984","3.267","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Wedding Events #002","Wedding Events #003","9.011","3.219","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Wedding Events #003","Wedding Events #004","2.331","8.862","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Wedding Events #004","Wedding Events #005","7.888","7.820","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wedding Events #005","Wedding Events #001","5.367","4.959","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":840},{"label":"Mar","value":859},{"label":"Abr","value":834},{"label":"Mai","value":962},{"label":"Jun","value":689},{"label":"Jul","value":881},{"label":"Ago","value":761},{"label":"Set","value":684},{"label":"Out","value":781},{"label":"Nov","value":777},{"label":"Dez","value":924}];
const MX = 962;
