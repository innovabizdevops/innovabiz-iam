...
const PAGE = "Vendor";
const KPIS = [{"l":"Fornecedores Ativos","v":"8.027","t":"+11.6%","d":"up"},{"l":"Contratos (€M)","v":"€18.9M","t":"-5.2%","d":"down"},{"l":"On-Time Delivery (%)","v":"74.2%","t":"+2.9%","d":"up"},{"l":"Score Médio","v":"78","t":"+8.8%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","93.7%","€ 8339.77","7.422","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","78.1%","€ 28778.91","6.990","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","82.7%","€ 27811.77","1.619","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","75.0%","€ 29400.29","3.153","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","73.3%","€ 41879.34","1.972","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":302},{"label":"Mar","value":375},{"label":"Abr","value":645},{"label":"Mai","value":589},{"label":"Jun","value":339},{"label":"Jul","value":563},{"label":"Ago","value":660},{"label":"Set","value":436},{"label":"Out","value":679},{"label":"Nov","value":686},{"label":"Dez","value":410}];
const MX = 686;
