...
const PAGE = "Registry";
const KPIS = [{"l":"Total Wedding Events","v":"1.203","t":"+11.6%","d":"up"},{"l":"Registry Ativos","v":"876","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"79.3%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"73","t":"+5.6%","d":"up"}];
const COLS = ["ID","Registry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wedding Events #001","Wedding Events #002","304","704","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Wedding Events #002","Wedding Events #003","3.407","1.191","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Wedding Events #003","Wedding Events #004","4.193","2.350","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Wedding Events #004","Wedding Events #005","4.601","2.185","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wedding Events #005","Wedding Events #001","1.742","6.753","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":377},{"label":"Mar","value":630},{"label":"Abr","value":532},{"label":"Mai","value":302},{"label":"Jun","value":594},{"label":"Jul","value":572},{"label":"Ago","value":316},{"label":"Set","value":487},{"label":"Out","value":492},{"label":"Nov","value":505},{"label":"Dez","value":565}];
const MX = 630;
