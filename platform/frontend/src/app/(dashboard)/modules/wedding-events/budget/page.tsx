...
const PAGE = "Budget";
const KPIS = [{"l":"Total Wedding Events","v":"7.201","t":"+10.8%","d":"up"},{"l":"Budget Ativos","v":"€16428","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"72.7%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"72","t":"-2.6%","d":"down"}];
const COLS = ["ID","Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wedding Events #001","€ 931.46","3.704","8.976","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Wedding Events #002","€ 34700.93","977","7.436","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Wedding Events #003","€ 27602.97","7.441","6.190","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Wedding Events #004","€ 49318.77","921","8.558","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wedding Events #005","€ 26089.46","1.326","8.749","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":734},{"label":"Mar","value":508},{"label":"Abr","value":533},{"label":"Mai","value":584},{"label":"Jun","value":666},{"label":"Jul","value":723},{"label":"Ago","value":692},{"label":"Set","value":820},{"label":"Out","value":547},{"label":"Nov","value":700},{"label":"Dez","value":766}];
const MX = 820;
