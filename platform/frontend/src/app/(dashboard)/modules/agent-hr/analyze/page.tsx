...
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"3.562","t":"+2.7%","d":"up"},{"l":"Queries/Dia","v":"2737","t":"+12.7%","d":"up"},{"l":"Dados Processados (GB)","v":"8.533","t":"+9.3%","d":"up"},{"l":"Utilizadores Analytics","v":"4.828","t":"+2.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","584","2026-03-17","661","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3234","2026-02-03","5.526","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","997","2026-01-10","320","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2379","2026-03-05","2.516","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2737","2026-03-25","4.528","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":881},{"label":"Mar","value":688},{"label":"Abr","value":963},{"label":"Mai","value":854},{"label":"Jun","value":654},{"label":"Jul","value":658},{"label":"Ago","value":741},{"label":"Set","value":902},{"label":"Out","value":799},{"label":"Nov","value":968},{"label":"Dez","value":840}];
const MX = 968;
