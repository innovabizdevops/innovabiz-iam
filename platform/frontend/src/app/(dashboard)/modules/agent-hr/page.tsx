...
/* ═══ AI HR Agent — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "2045", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2802", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€262K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1742956345", cells: ["AGE-8345", "AI HR Agent Item 1", "26/2/2026", "€6445"], status: "active" as const },
    { id: "1742959916", cells: ["AGE-2916", "AI HR Agent Item 2", "13/9/2026", "€10 016"], status: "pending" as const },
    { id: "1742963487", cells: ["AGE-6487", "AI HR Agent Item 3", "28/4/2026", "€13 587"], status: "completed" as const },
    { id: "1742967058", cells: ["AGE-1058", "AI HR Agent Item 4", "15/11/2026", "€17 158"], status: "warning" as const },
    { id: "1742970629", cells: ["AGE-4629", "AI HR Agent Item 5", "2/6/2026", "€20 729"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI HR Agent</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI HR Agent</p>
                    </div>
                </div>
