...
const ACCENT = "#7c3aed";
const MODULE = "AI HR Agent";
const PAGE = "Screen";
const KPIS = [{"l":"Total Agent Hr","v":"4.513","t":"+16.0%","d":"up"},{"l":"Screen Ativos","v":"6.645","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"80.4%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"88","t":"-0.2%","d":"down"}];
const COLS = ["ID","Screen","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agent Hr #001","Agent Hr #002","4.825","1.853","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Agent Hr #002","Agent Hr #003","7.508","207","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Agent Hr #003","Agent Hr #004","542","1.956","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Agent Hr #004","Agent Hr #005","364","966","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agent Hr #005","Agent Hr #001","6.968","6.263","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":388},{"label":"Fev","value":404},{"label":"Mar","value":407},{"label":"Abr","value":681},{"label":"Mai","value":508},{"label":"Jun","value":597},{"label":"Jul","value":347},{"label":"Ago","value":446},{"label":"Set","value":435},{"label":"Out","value":656},{"label":"Nov","value":641},{"label":"Dez","value":554}];
const MX = 681;
