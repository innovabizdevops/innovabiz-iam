...
const PAGE = "Onboard";
const KPIS = [{"l":"eNPS","v":"91","t":"+7.3%","d":"up"},{"l":"Engagement (%)","v":"83.3%","t":"+2.1%","d":"up"},{"l":"Turnover (%)","v":"82.0%","t":"+4.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"144","t":"+15.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.825","2026-02-02","88","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.523","2026-03-24","93","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.707","2026-01-28","78","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","211","2026-02-26","86","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.463","2026-03-12","61","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":589},{"label":"Mar","value":568},{"label":"Abr","value":653},{"label":"Mai","value":582},{"label":"Jun","value":678},{"label":"Jul","value":795},{"label":"Ago","value":706},{"label":"Set","value":572},{"label":"Out","value":828},{"label":"Nov","value":684},{"label":"Dez","value":746}];
const MX = 828;
