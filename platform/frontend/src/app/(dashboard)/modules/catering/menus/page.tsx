...
const PAGE = "Menu Planning";
const KPIS = [{"l":"Quartos Ocupados","v":"941","t":"+9.4%","d":"up"},{"l":"RevPAR (€)","v":"€76257","t":"+15.2%","d":"up"},{"l":"Ocupação (%)","v":"93.3%","t":"+5.3%","d":"up"},{"l":"Guest Satisfaction","v":"3.760","t":"+4.9%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.001","2026-02-01","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","2.085","2026-02-03","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.784","2026-03-08","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.014","2026-02-19","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.694","2026-01-08","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":402},{"label":"Fev","value":449},{"label":"Mar","value":255},{"label":"Abr","value":233},{"label":"Mai","value":354},{"label":"Jun","value":472},{"label":"Jul","value":578},{"label":"Ago","value":415},{"label":"Set","value":458},{"label":"Out","value":571},{"label":"Nov","value":388},{"label":"Dez","value":433}];
const MX = 578;
