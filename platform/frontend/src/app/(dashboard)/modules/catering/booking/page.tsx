...
const PAGE = "Event Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"6.467","t":"+10.7%","d":"up"},{"l":"RevPAR (€)","v":"€36999","t":"+15.3%","d":"up"},{"l":"Ocupação (%)","v":"72.7%","t":"+11.3%","d":"up"},{"l":"Guest Satisfaction","v":"8.408","t":"+16.6%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.187","2026-03-23","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.253","2026-02-10","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.972","2026-01-28","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.336","2026-03-27","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.803","2026-02-20","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":713},{"label":"Fev","value":824},{"label":"Mar","value":985},{"label":"Abr","value":937},{"label":"Mai","value":953},{"label":"Jun","value":960},{"label":"Jul","value":1032},{"label":"Ago","value":768},{"label":"Set","value":1027},{"label":"Out","value":824},{"label":"Nov","value":833},{"label":"Dez","value":1008}];
const MX = 1032;
