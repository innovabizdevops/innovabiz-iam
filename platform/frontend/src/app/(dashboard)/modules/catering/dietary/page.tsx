...
const PAGE = "Dietary Filters";
const KPIS = [{"l":"Total Catering","v":"6.738","t":"+9.8%","d":"up"},{"l":"Dietary Filters Ativos","v":"5.419","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"78.6%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"57","t":"-0.2%","d":"down"}];
const COLS = ["ID","Dietary Filters","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Catering #001","2026-03-14","7.022","7.981","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Catering #002","2026-01-04","3.025","2.917","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Catering #003","2026-02-16","8.810","4.895","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Catering #004","2026-03-10","2.795","5.728","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Catering #005","2026-03-21","3.933","7.254","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":1005},{"label":"Mar","value":1085},{"label":"Abr","value":826},{"label":"Mai","value":1081},{"label":"Jun","value":763},{"label":"Jul","value":824},{"label":"Ago","value":702},{"label":"Set","value":788},{"label":"Out","value":896},{"label":"Nov","value":841},{"label":"Dez","value":929}];
const MX = 1085;
