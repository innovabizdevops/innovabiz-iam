...
const PAGE = "Vendor Sourcing";
const KPIS = [{"l":"Fornecedores Ativos","v":"2.296","t":"-1.2%","d":"down"},{"l":"Contratos (€M)","v":"€33.1M","t":"-0.5%","d":"down"},{"l":"On-Time Delivery (%)","v":"76.9%","t":"+9.8%","d":"up"},{"l":"Score Médio","v":"89","t":"+1.5%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","91.1%","€ 48096.03","1.219","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","71.4%","€ 25910.42","4.921","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","71.1%","€ 6518.76","3.495","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","74.3%","€ 49458.10","713","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","99.6%","€ 24464.77","3.625","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":918},{"label":"Fev","value":676},{"label":"Mar","value":895},{"label":"Abr","value":841},{"label":"Mai","value":758},{"label":"Jun","value":864},{"label":"Jul","value":732},{"label":"Ago","value":587},{"label":"Set","value":603},{"label":"Out","value":680},{"label":"Nov","value":893},{"label":"Dez","value":555}];
const MX = 918;
