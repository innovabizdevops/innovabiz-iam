...
const ACCENT = "#059669";
const MODULE = "Catering & Events";
const PAGE = "Portion Calculator";
const KPIS = [{"l":"Total Catering","v":"3.944","t":"-1.9%","d":"down"},{"l":"Portion Calculator Ativos","v":"643","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"91.6%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"60","t":"+11.9%","d":"up"}];
const COLS = ["ID","Portion Calculator","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Catering #001","Catering #002","3.088","8.227","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Catering #002","Catering #003","3.962","2.883","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Catering #003","Catering #004","3.293","2.994","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Catering #004","Catering #005","739","1.658","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Catering #005","Catering #001","2.688","4.803","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":933},{"label":"Fev","value":645},{"label":"Mar","value":956},{"label":"Abr","value":648},{"label":"Mai","value":614},{"label":"Jun","value":800},{"label":"Jul","value":690},{"label":"Ago","value":657},{"label":"Set","value":890},{"label":"Out","value":613},{"label":"Nov","value":655},{"label":"Dez","value":990}];
const MX = 990;
