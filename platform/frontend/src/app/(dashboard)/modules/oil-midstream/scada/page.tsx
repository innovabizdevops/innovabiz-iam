...
const PAGE = "SCADA Midstream";
const KPIS = [{"l":"Dispositivos Online","v":"776","t":"+4.2%","d":"up"},{"l":"Dados/Min (MB)","v":"441","t":"+12.3%","d":"up"},{"l":"Alertas Ativos","v":"8.374","t":"+8.0%","d":"up"},{"l":"Uptime (%)","v":"83.9%","t":"-0.9%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.276","460","4.807","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.379","1.496","5.215","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.711","1.992","1.959","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","426","4.458","4.308","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.445","5.442","7.802","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1027},{"label":"Fev","value":738},{"label":"Mar","value":723},{"label":"Abr","value":778},{"label":"Mai","value":803},{"label":"Jun","value":700},{"label":"Jul","value":1023},{"label":"Ago","value":698},{"label":"Set","value":712},{"label":"Out","value":1030},{"label":"Nov","value":674},{"label":"Dez","value":839}];
const MX = 1030;
