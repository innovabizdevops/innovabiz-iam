...
const KPIS = [{"l":"Total Oil Midstream","v":"472","t":"+8.2%","d":"up"},{"l":"Leak Detect Ativos","v":"8.391","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"74.6%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"69","t":"+12.5%","d":"up"}];
const COLS = ["ID","Leak Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Midstream #001","Oil Midstream #002","3.316","8.123","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Midstream #002","Oil Midstream #003","7.698","1.682","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Midstream #003","Oil Midstream #004","3.895","1.230","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Midstream #004","Oil Midstream #005","2.404","3.991","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Midstream #005","Oil Midstream #001","4.298","4.218","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":712},{"label":"Mar","value":475},{"label":"Abr","value":540},{"label":"Mai","value":765},{"label":"Jun","value":632},{"label":"Jul","value":751},{"label":"Ago","value":477},{"label":"Set","value":769},{"label":"Out","value":582},{"label":"Nov","value":657},{"label":"Dez","value":528}];
const MX = 769;
