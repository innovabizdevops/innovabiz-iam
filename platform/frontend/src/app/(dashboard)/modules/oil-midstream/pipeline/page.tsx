...
const ACCENT = "#475569";
const MODULE = "Oil Midstream";
const PAGE = "Pipeline Monitor";
const KPIS = [{"l":"Total Oil Midstream","v":"1.408","t":"+17.8%","d":"up"},{"l":"Pipeline Monitor Ativos","v":"8.694","t":"+2.7%","d":"up"},{"l":"Eficiência (%)","v":"92.1%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"85","t":"+5.4%","d":"up"}];
const COLS = ["ID","Pipeline Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Midstream #001","Oil Midstream #002","2.836","5.140","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Midstream #002","Oil Midstream #003","4.483","6.030","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Midstream #003","Oil Midstream #004","9.052","2.399","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Midstream #004","Oil Midstream #005","7.302","2.336","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Midstream #005","Oil Midstream #001","2.545","1.889","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":497},{"label":"Fev","value":492},{"label":"Mar","value":825},{"label":"Abr","value":515},{"label":"Mai","value":509},{"label":"Jun","value":640},{"label":"Jul","value":573},{"label":"Ago","value":617},{"label":"Set","value":656},{"label":"Out","value":660},{"label":"Nov","value":683},{"label":"Dez","value":583}];
const MX = 825;
