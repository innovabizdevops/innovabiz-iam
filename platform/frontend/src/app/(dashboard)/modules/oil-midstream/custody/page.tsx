...
const PAGE = "Custody Transfer";
const KPIS = [{"l":"Total Oil Midstream","v":"4.441","t":"+2.2%","d":"up"},{"l":"Custody Transfer Ativos","v":"€38588","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"72.4%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"57","t":"+6.7%","d":"up"}];
const COLS = ["ID","Custody Transfer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Midstream #001","€ 3130.94","6.977","2.922","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Midstream #002","€ 6034.46","4.622","3.595","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Midstream #003","€ 17368.89","2.988","5.232","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Midstream #004","€ 24073.86","8.338","8.570","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Midstream #005","€ 8450.61","8.449","8.367","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":916},{"label":"Mar","value":680},{"label":"Abr","value":622},{"label":"Mai","value":654},{"label":"Jun","value":884},{"label":"Jul","value":766},{"label":"Ago","value":574},{"label":"Set","value":824},{"label":"Out","value":922},{"label":"Nov","value":840},{"label":"Dez","value":838}];
const MX = 922;
