...
export default function OilMidstreamPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Oil Midstream</h1><p className="text-sm text-muted-foreground">Oil Midstream • iBOS Enterprise</p></div>
