...
const PAGE = "Parametric Products";
const KPIS = [{"l":"Configurações","v":"6.757","t":"+5.7%","d":"up"},{"l":"Últimas Alterações","v":"1.990","t":"+7.9%","d":"up"},{"l":"Ambientes","v":"8.569","t":"+6.5%","d":"up"},{"l":"Versão Config","v":"7.754","t":"-4.7%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 25155.42","5.255","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 1737.43","5.808","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 46409.12","327","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 27543.26","2.144","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 13963.98","3.595","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":725},{"label":"Mar","value":952},{"label":"Abr","value":894},{"label":"Mai","value":976},{"label":"Jun","value":895},{"label":"Jul","value":654},{"label":"Ago","value":784},{"label":"Set","value":770},{"label":"Out","value":587},{"label":"Nov","value":604},{"label":"Dez","value":747}];
const MX = 976;
