...
const KPIS = [{"l":"Total Insurtech","v":"1.440","t":"+10.2%","d":"up"},{"l":"Usage Based Ativos","v":"3.631","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"88.4%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"59","t":"+6.8%","d":"up"}];
const COLS = ["ID","Usage Based","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurtech #001","Insurtech #002","1.980","7.461","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Insurtech #002","Insurtech #003","4.598","3.089","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurtech #003","Insurtech #004","870","5.125","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Insurtech #004","Insurtech #005","6.932","7.990","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurtech #005","Insurtech #001","4.318","4.809","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":537},{"label":"Mar","value":509},{"label":"Abr","value":376},{"label":"Mai","value":343},{"label":"Jun","value":516},{"label":"Jul","value":410},{"label":"Ago","value":631},{"label":"Set","value":667},{"label":"Out","value":314},{"label":"Nov","value":567},{"label":"Dez","value":658}];
const MX = 673;
...
export default function UsageBasedPage() {
    return (
