...
const KPIS = [{"l":"Total Insurtech","v":"7.503","t":"+1.6%","d":"up"},{"l":"Fraud Detection Ativos","v":"996","t":"+1.3%","d":"up"},{"l":"Eficiência (%)","v":"85.4%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"94","t":"+7.8%","d":"up"}];
const COLS = ["ID","Fraud Detection","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurtech #001","Insurtech #002","7.039","1.893","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Insurtech #002","Insurtech #003","8.926","4.025","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurtech #003","Insurtech #004","8.549","1.032","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Insurtech #004","Insurtech #005","3.562","4.750","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurtech #005","Insurtech #001","465","8.973","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":584},{"label":"Mar","value":825},{"label":"Abr","value":538},{"label":"Mai","value":803},{"label":"Jun","value":641},{"label":"Jul","value":786},{"label":"Ago","value":451},{"label":"Set","value":733},{"label":"Out","value":824},{"label":"Nov","value":609},{"label":"Dez","value":736}];
const MX = 826;
