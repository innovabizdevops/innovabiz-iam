...
const PAGE = "P2P Insurance";
const KPIS = [{"l":"Total Insurtech","v":"8.075","t":"+15.5%","d":"up"},{"l":"P2P Insurance Ativos","v":"8.500","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"92.4%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"58","t":"+6.2%","d":"up"}];
const COLS = ["ID","P2P Insurance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurtech #001","Insurtech #002","3.765","1.853","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Insurtech #002","Insurtech #003","3.763","1.967","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurtech #003","Insurtech #004","8.755","6.708","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Insurtech #004","Insurtech #005","7.866","657","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurtech #005","Insurtech #001","6.511","6.431","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":552},{"label":"Mar","value":825},{"label":"Abr","value":578},{"label":"Mai","value":895},{"label":"Jun","value":552},{"label":"Jul","value":846},{"label":"Ago","value":671},{"label":"Set","value":653},{"label":"Out","value":650},{"label":"Nov","value":852},{"label":"Dez","value":898}];
const MX = 898;
