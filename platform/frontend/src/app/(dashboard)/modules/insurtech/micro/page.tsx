...
const KPIS = [{"l":"Total Insurtech","v":"8.830","t":"+3.3%","d":"up"},{"l":"Micro Insurance Ativos","v":"1.982","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"83.5%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"59","t":"+1.4%","d":"up"}];
const COLS = ["ID","Micro Insurance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurtech #001","Insurtech #002","1.265","6.753","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Insurtech #002","Insurtech #003","5.485","2.782","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurtech #003","Insurtech #004","2.703","8.344","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Insurtech #004","Insurtech #005","7.481","4.618","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurtech #005","Insurtech #001","3.904","7.920","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":586},{"label":"Mar","value":623},{"label":"Abr","value":686},{"label":"Mai","value":885},{"label":"Jun","value":730},{"label":"Jul","value":869},{"label":"Ago","value":659},{"label":"Set","value":832},{"label":"Out","value":901},{"label":"Nov","value":645},{"label":"Dez","value":782}];
const MX = 901;
