...
const KPIS = [{"l":"Dashboards Ativos","v":"3.735","t":"-1.0%","d":"down"},{"l":"Queries/Dia","v":"4604","t":"+1.9%","d":"up"},{"l":"Dados Processados (GB)","v":"3.172","t":"-4.2%","d":"down"},{"l":"Utilizadores Analytics","v":"8.865","t":"+7.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1661","2026-01-01","6.415","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3520","2026-01-14","3.761","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1131","2026-03-28","163","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3908","2026-01-10","7.607","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","778","2026-01-21","1.752","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":421},{"label":"Fev","value":564},{"label":"Mar","value":325},{"label":"Abr","value":358},{"label":"Mai","value":664},{"label":"Jun","value":316},{"label":"Jul","value":386},{"label":"Ago","value":377},{"label":"Set","value":594},{"label":"Out","value":413},{"label":"Nov","value":539},{"label":"Dez","value":466}];
const MX = 664;
