...
const PAGE = "On-Demand Cover";
const KPIS = [{"l":"Total Insurtech","v":"5.255","t":"+8.9%","d":"up"},{"l":"On Demand Cover Ativos","v":"196","t":"+10.5%","d":"up"},{"l":"Eficiência (%)","v":"83.0%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"87","t":"-0.2%","d":"down"}];
const COLS = ["ID","On Demand Cover","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurtech #001","Insurtech #002","5.195","3.642","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Insurtech #002","Insurtech #003","6.806","7.707","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurtech #003","Insurtech #004","2.207","1.061","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Insurtech #004","Insurtech #005","862","6.044","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurtech #005","Insurtech #001","3.046","6.960","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":559},{"label":"Mar","value":679},{"label":"Abr","value":725},{"label":"Mai","value":656},{"label":"Jun","value":788},{"label":"Jul","value":736},{"label":"Ago","value":736},{"label":"Set","value":522},{"label":"Out","value":402},{"label":"Nov","value":453},{"label":"Dez","value":496}];
const MX = 788;
