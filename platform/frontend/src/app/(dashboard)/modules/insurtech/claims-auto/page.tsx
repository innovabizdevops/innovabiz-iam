...
const ACCENT = "#0e7490";
const MODULE = "InsurTech Platform";
const PAGE = "Claims Automation";
const KPIS = [{"l":"Total Insurtech","v":"5.719","t":"+10.3%","d":"up"},{"l":"Claims Automation Ativos","v":"5.817","t":"+17.3%","d":"up"},{"l":"Eficiência (%)","v":"78.9%","t":"+4.6%","d":"up"},{"l":"Score Performance","v":"73","t":"+0.8%","d":"up"}];
const COLS = ["ID","Claims Automation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurtech #001","Insurtech #002","5.783","5.793","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Insurtech #002","Insurtech #003","6.714","6.829","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurtech #003","Insurtech #004","8.547","321","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Insurtech #004","Insurtech #005","4.282","5.278","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurtech #005","Insurtech #001","3.371","310","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":920},{"label":"Fev","value":882},{"label":"Mar","value":859},{"label":"Abr","value":680},{"label":"Mai","value":719},{"label":"Jun","value":702},{"label":"Jul","value":992},{"label":"Ago","value":909},{"label":"Set","value":845},{"label":"Out","value":637},{"label":"Nov","value":821},{"label":"Dez","value":755}];
const MX = 992;
...
export default function ClaimsAutoPage() {
    return (
