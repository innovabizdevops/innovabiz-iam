...
const ACCENT = "#6366f1";
const MODULE = "Satellite Design";
const PAGE = "Orbit";
const KPIS = [{"l":"Formulários Ativos","v":"3.496","t":"+13.6%","d":"up"},{"l":"Submissões/Dia","v":"2784","t":"+14.6%","d":"up"},{"l":"Documentos Gerados","v":"6.600","t":"-5.4%","d":"down"},{"l":"Templates","v":"4.403","t":"-4.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.258","2026-02-03","4.359","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.574","2026-02-17","2.574","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.052","2026-01-08","393","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.258","2026-03-18","5.008","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.197","2026-01-26","5.405","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":922},{"label":"Fev","value":840},{"label":"Mar","value":622},{"label":"Abr","value":778},{"label":"Mai","value":800},{"label":"Jun","value":839},{"label":"Jul","value":894},{"label":"Ago","value":754},{"label":"Set","value":759},{"label":"Out","value":927},{"label":"Nov","value":724},{"label":"Dez","value":671}];
const MX = 927;
