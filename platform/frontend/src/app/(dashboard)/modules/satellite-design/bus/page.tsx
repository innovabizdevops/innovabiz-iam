...
const PAGE = "Bus";
const KPIS = [{"l":"Formulários Ativos","v":"253","t":"-5.2%","d":"down"},{"l":"Submissões/Dia","v":"3092","t":"-1.9%","d":"down"},{"l":"Documentos Gerados","v":"1.420","t":"-5.3%","d":"down"},{"l":"Templates","v":"754","t":"-4.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.794","2026-01-20","872","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.752","2026-02-08","1.543","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.436","2026-02-10","8.426","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.852","2026-03-21","8.337","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.827","2026-01-23","3.953","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":495},{"label":"Mar","value":410},{"label":"Abr","value":264},{"label":"Mai","value":245},{"label":"Jun","value":406},{"label":"Jul","value":404},{"label":"Ago","value":270},{"label":"Set","value":553},{"label":"Out","value":511},{"label":"Nov","value":598},{"label":"Dez","value":307}];
const MX = 598;
