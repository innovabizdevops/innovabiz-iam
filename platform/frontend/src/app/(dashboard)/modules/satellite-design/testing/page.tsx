...
const PAGE = "Testing";
const KPIS = [{"l":"Formulários Ativos","v":"6.901","t":"-3.8%","d":"down"},{"l":"Submissões/Dia","v":"987","t":"-5.1%","d":"down"},{"l":"Documentos Gerados","v":"2.022","t":"+5.2%","d":"up"},{"l":"Templates","v":"5.906","t":"-1.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.618","2026-02-21","2.790","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.985","2026-03-26","6.423","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.201","2026-02-22","4.781","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","759","2026-01-10","2.603","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.272","2026-01-09","5.079","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":793},{"label":"Mar","value":1060},{"label":"Abr","value":785},{"label":"Mai","value":905},{"label":"Jun","value":841},{"label":"Jul","value":991},{"label":"Ago","value":841},{"label":"Set","value":782},{"label":"Out","value":1029},{"label":"Nov","value":1007},{"label":"Dez","value":881}];
const MX = 1060;
