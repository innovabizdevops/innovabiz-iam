...
const PAGE = "Payload";
const KPIS = [{"l":"Formulários Ativos","v":"2.069","t":"+5.8%","d":"up"},{"l":"Submissões/Dia","v":"2340","t":"-5.6%","d":"down"},{"l":"Documentos Gerados","v":"4.426","t":"-1.4%","d":"down"},{"l":"Templates","v":"1.428","t":"+13.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.549","2026-01-26","3.576","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.064","2026-02-14","2.778","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.261","2026-03-08","7.942","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.532","2026-01-04","5.157","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.196","2026-02-08","1.988","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":453},{"label":"Fev","value":506},{"label":"Mar","value":270},{"label":"Abr","value":360},{"label":"Mai","value":252},{"label":"Jun","value":516},{"label":"Jul","value":570},{"label":"Ago","value":394},{"label":"Set","value":459},{"label":"Out","value":347},{"label":"Nov","value":278},{"label":"Dez","value":548}];
const MX = 570;
