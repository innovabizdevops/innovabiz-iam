...
const PAGE = "Launch";
const KPIS = [{"l":"Formulários Ativos","v":"3.462","t":"+8.8%","d":"up"},{"l":"Submissões/Dia","v":"1121","t":"+2.4%","d":"up"},{"l":"Documentos Gerados","v":"3.049","t":"+1.3%","d":"up"},{"l":"Templates","v":"3.461","t":"-1.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.033","2026-02-28","2.930","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.687","2026-03-22","5.187","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.389","2026-01-13","5.937","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.295","2026-02-19","6.413","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.827","2026-02-11","4.227","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":556},{"label":"Mar","value":743},{"label":"Abr","value":411},{"label":"Mai","value":652},{"label":"Jun","value":658},{"label":"Jul","value":770},{"label":"Ago","value":411},{"label":"Set","value":513},{"label":"Out","value":569},{"label":"Nov","value":399},{"label":"Dez","value":502}];
const MX = 770;
