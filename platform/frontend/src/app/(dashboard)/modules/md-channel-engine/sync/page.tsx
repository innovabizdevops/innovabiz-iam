...
const PAGE = "Sync";
const KPIS = [{"l":"Integrações Ativas","v":"4.366","t":"+1.9%","d":"up"},{"l":"Chamadas/Hora","v":"1241","t":"-1.0%","d":"down"},{"l":"Taxa Sucesso (%)","v":"78.0%","t":"+11.1%","d":"up"},{"l":"Latência Média (ms)","v":"163ms","t":"+17.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.679","4.348","76.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.077","5.816","81.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.229","1.614","89.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.597","5.772","72.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.853","6.719","85.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":661},{"label":"Mar","value":647},{"label":"Abr","value":513},{"label":"Mai","value":804},{"label":"Jun","value":442},{"label":"Jul","value":792},{"label":"Ago","value":698},{"label":"Set","value":486},{"label":"Out","value":811},{"label":"Nov","value":444},{"label":"Dez","value":650}];
const MX = 829;
