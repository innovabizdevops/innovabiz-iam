...
/* ═══ MD: Multi-Channel Engine — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "6031", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "728", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€23K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "-14%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1535545431", cells: ["MD-2431", "MD: Multi-Channel Engine Item 1", "8/4/2026", "€45 531"], status: "active" as const },
    { id: "1535549002", cells: ["MD-6002", "MD: Multi-Channel Engine Item 2", "23/11/2026", "€49 102"], status: "pending" as const },
    { id: "1535552573", cells: ["MD-9573", "MD: Multi-Channel Engine Item 3", "10/6/2026", "€2673"], status: "completed" as const },
    { id: "1535556144", cells: ["MD-4144", "MD: Multi-Channel Engine Item 4", "25/1/2026", "€6244"], status: "warning" as const },
    { id: "1535559715", cells: ["MD-7715", "MD: Multi-Channel Engine Item 5", "12/8/2026", "€9815"], status: "active" as const },
];
...
export default function MdMultichannelEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Channel Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Channel Engine</p>
                    </div>
                </div>
