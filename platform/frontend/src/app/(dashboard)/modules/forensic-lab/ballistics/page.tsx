...
const ACCENT = "#6366f1";
const MODULE = "Forensic Lab";
const PAGE = "Ballistics";
const KPIS = [{"l":"Total Forensic Lab","v":"8.648","t":"-3.6%","d":"down"},{"l":"Ballistics Ativos","v":"4.206","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"67.4%","t":"+16.1%","d":"up"},{"l":"Score Performance","v":"89","t":"+9.3%","d":"up"}];
const COLS = ["ID","Ballistics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forensic Lab #001","Forensic Lab #002","4.462","6.897","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Forensic Lab #002","Forensic Lab #003","1.677","7.650","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Forensic Lab #003","Forensic Lab #004","1.456","2.812","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Forensic Lab #004","Forensic Lab #005","8.015","360","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forensic Lab #005","Forensic Lab #001","9.081","8.000","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":340},{"label":"Fev","value":639},{"label":"Mar","value":566},{"label":"Abr","value":469},{"label":"Mai","value":581},{"label":"Jun","value":492},{"label":"Jul","value":574},{"label":"Ago","value":610},{"label":"Set","value":695},{"label":"Out","value":434},{"label":"Nov","value":337},{"label":"Dez","value":597}];
const MX = 695;
