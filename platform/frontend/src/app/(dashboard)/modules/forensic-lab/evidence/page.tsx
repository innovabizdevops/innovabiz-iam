...
const PAGE = "Evidence";
const KPIS = [{"l":"Total Forensic Lab","v":"5.731","t":"+2.9%","d":"up"},{"l":"Evidence Ativos","v":"369","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"75.2%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"82","t":"+13.7%","d":"up"}];
const COLS = ["ID","Evidence","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forensic Lab #001","Forensic Lab #002","6.846","1.026","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Forensic Lab #002","Forensic Lab #003","3.603","6.742","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Forensic Lab #003","Forensic Lab #004","862","3.022","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Forensic Lab #004","Forensic Lab #005","6.025","8.860","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forensic Lab #005","Forensic Lab #001","6.208","6.784","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":574},{"label":"Mar","value":517},{"label":"Abr","value":597},{"label":"Mai","value":319},{"label":"Jun","value":343},{"label":"Jul","value":510},{"label":"Ago","value":396},{"label":"Set","value":281},{"label":"Out","value":634},{"label":"Nov","value":341},{"label":"Dez","value":415}];
const MX = 634;
