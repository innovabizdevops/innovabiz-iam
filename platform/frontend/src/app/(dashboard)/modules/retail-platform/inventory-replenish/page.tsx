...
/* ═══ Retail Platform — Inventory Replenish ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "3247", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "290", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "198", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "81%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1204244654", cells: ["RET-9654", "Inventory Replenish Item 1", "19/3/2026", "€44 754"], status: "active" as const },
    { id: "1204248225", cells: ["RET-4225", "Inventory Replenish Item 2", "6/10/2026", "€48 325"], status: "pending" as const },
    { id: "1204251796", cells: ["RET-7796", "Inventory Replenish Item 3", "21/5/2026", "€1896"], status: "completed" as const },
    { id: "1204255367", cells: ["RET-2367", "Inventory Replenish Item 4", "8/12/2026", "€5467"], status: "warning" as const },
    { id: "1204258938", cells: ["RET-5938", "Inventory Replenish Item 5", "23/7/2026", "€9038"], status: "active" as const },
];
...
export default function RetailPlatformInventoryReplenishPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Inventory Replenish</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Retail Platform • Inventory Replenish</p>
                    </div>
                </div>
