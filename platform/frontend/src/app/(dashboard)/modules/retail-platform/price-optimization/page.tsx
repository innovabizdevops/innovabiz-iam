...
/* ═══ Retail Platform — Price Optimization ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "3671", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "296", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1482", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "97%", trend: "-18%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1166499060", cells: ["RET-1060", "Price Optimization Item 1", "21/1/2026", "€49 160"], status: "active" as const },
    { id: "1166502631", cells: ["RET-4631", "Price Optimization Item 2", "8/8/2026", "€2731"], status: "pending" as const },
    { id: "1166506202", cells: ["RET-8202", "Price Optimization Item 3", "23/3/2026", "€6302"], status: "completed" as const },
    { id: "1166509773", cells: ["RET-2773", "Price Optimization Item 4", "10/10/2026", "€9873"], status: "warning" as const },
    { id: "1166513344", cells: ["RET-6344", "Price Optimization Item 5", "25/5/2026", "€13 444"], status: "active" as const },
];
...
export default function RetailPlatformPriceOptimizationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Price Optimization</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Retail Platform • Price Optimization</p>
                    </div>
                </div>
