...
/* ═══ Retail Platform — Loss Prevention ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "3629", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "439", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1914", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1928656771", cells: ["RET-2771", "Loss Prevention Item 1", "28/8/2026", "€6871"], status: "active" as const },
    { id: "1928660342", cells: ["RET-6342", "Loss Prevention Item 2", "15/3/2026", "€10 442"], status: "pending" as const },
    { id: "1928663913", cells: ["RET-9913", "Loss Prevention Item 3", "2/10/2026", "€14 013"], status: "completed" as const },
    { id: "1928667484", cells: ["RET-4484", "Loss Prevention Item 4", "17/5/2026", "€17 584"], status: "warning" as const },
    { id: "1928671055", cells: ["RET-8055", "Loss Prevention Item 5", "4/12/2026", "€21 155"], status: "active" as const },
];
...
export default function RetailPlatformLossPreventionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Loss Prevention</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Retail Platform • Loss Prevention</p>
                    </div>
                </div>
