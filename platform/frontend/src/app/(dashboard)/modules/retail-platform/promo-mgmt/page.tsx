...
/* ═══ Retail Platform — Promo Mgmt ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "578", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "342", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1294", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1038299970", cells: ["RET-6970", "Promo Mgmt Item 1", "23/7/2026", "€50 070"], status: "active" as const },
    { id: "1038303541", cells: ["RET-1541", "Promo Mgmt Item 2", "10/2/2026", "€3641"], status: "pending" as const },
    { id: "1038307112", cells: ["RET-5112", "Promo Mgmt Item 3", "25/9/2026", "€7212"], status: "completed" as const },
    { id: "1038310683", cells: ["RET-8683", "Promo Mgmt Item 4", "12/4/2026", "€10 783"], status: "warning" as const },
    { id: "1038314254", cells: ["RET-3254", "Promo Mgmt Item 5", "27/11/2026", "€14 354"], status: "active" as const },
];
...
export default function RetailPlatformPromoMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Promo Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Retail Platform • Promo Mgmt</p>
                    </div>
                </div>
