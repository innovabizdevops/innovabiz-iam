...
/* ═══ Retail Platform — Customer Insights ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "2996", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "167", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "976", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "267338227", cells: ["RET-3227", "Customer Insights Item 1", "24/8/2026", "€38 327"], status: "active" as const },
    { id: "267341798", cells: ["RET-6798", "Customer Insights Item 2", "11/3/2026", "€41 898"], status: "pending" as const },
    { id: "267345369", cells: ["RET-1369", "Customer Insights Item 3", "26/10/2026", "€45 469"], status: "completed" as const },
    { id: "267348940", cells: ["RET-4940", "Customer Insights Item 4", "13/5/2026", "€49 040"], status: "warning" as const },
    { id: "267352511", cells: ["RET-8511", "Customer Insights Item 5", "28/12/2026", "€2611"], status: "active" as const },
];
...
export default function RetailPlatformCustomerInsightsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Customer Insights</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Retail Platform • Customer Insights</p>
                    </div>
                </div>
