...
/* ═══ Retail Platform — Omnichannel Fulfill ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "3319", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "126", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1203", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "218664218", cells: ["RET-1218", "Omnichannel Fulfill Item 1", "11/3/2026", "€14 318"], status: "active" as const },
    { id: "218667789", cells: ["RET-4789", "Omnichannel Fulfill Item 2", "26/10/2026", "€17 889"], status: "pending" as const },
    { id: "218671360", cells: ["RET-8360", "Omnichannel Fulfill Item 3", "13/5/2026", "€21 460"], status: "completed" as const },
    { id: "218674931", cells: ["RET-2931", "Omnichannel Fulfill Item 4", "28/12/2026", "€25 031"], status: "warning" as const },
    { id: "218678502", cells: ["RET-6502", "Omnichannel Fulfill Item 5", "15/7/2026", "€28 602"], status: "active" as const },
];
...
export default function RetailPlatformOmnichannelFulfillPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Omnichannel Fulfill</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Retail Platform • Omnichannel Fulfill</p>
                    </div>
                </div>
