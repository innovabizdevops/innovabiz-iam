...
/* ═══ Retail Platform — Assortment Plan ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "998", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "217", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3922", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1382522357", cells: ["RET-6357", "Assortment Plan Item 1", "14/6/2026", "€22 457"], status: "active" as const },
    { id: "1382525928", cells: ["RET-9928", "Assortment Plan Item 2", "1/1/2026", "€26 028"], status: "pending" as const },
    { id: "1382529499", cells: ["RET-4499", "Assortment Plan Item 3", "16/8/2026", "€29 599"], status: "completed" as const },
    { id: "1382533070", cells: ["RET-8070", "Assortment Plan Item 4", "3/3/2026", "€33 170"], status: "warning" as const },
    { id: "1382536641", cells: ["RET-2641", "Assortment Plan Item 5", "18/10/2026", "€36 741"], status: "active" as const },
];
...
export default function RetailPlatformAssortmentPlanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Assortment Plan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Retail Platform • Assortment Plan</p>
                    </div>
                </div>
