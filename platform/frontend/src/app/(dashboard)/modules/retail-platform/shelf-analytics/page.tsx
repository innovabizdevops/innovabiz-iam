...
/* ═══ Retail Platform — Shelf Analytics ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "960", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "228", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "23", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "95%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "2016648448", cells: ["RET-1448", "Shelf Analytics Item 1", "25/5/2026", "€48 548"], status: "active" as const },
    { id: "2016652019", cells: ["RET-5019", "Shelf Analytics Item 2", "12/12/2026", "€2119"], status: "pending" as const },
    { id: "2016655590", cells: ["RET-8590", "Shelf Analytics Item 3", "27/7/2026", "€5690"], status: "completed" as const },
    { id: "2016659161", cells: ["RET-3161", "Shelf Analytics Item 4", "14/2/2026", "€9261"], status: "warning" as const },
    { id: "2016662732", cells: ["RET-6732", "Shelf Analytics Item 5", "1/9/2026", "€12 832"], status: "active" as const },
];
...
export default function RetailPlatformShelfAnalyticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Shelf Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Retail Platform • Shelf Analytics</p>
                    </div>
                </div>
