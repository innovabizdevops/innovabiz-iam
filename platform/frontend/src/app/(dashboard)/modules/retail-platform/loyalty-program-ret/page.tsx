...
/* ═══ Retail Platform — Loyalty Program Ret ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "3592", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "217", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2123", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "70%", trend: "-6%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "776147973", cells: ["RET-6973", "Loyalty Program Ret Item 1", "14/10/2026", "€48 073"], status: "active" as const },
    { id: "776151544", cells: ["RET-1544", "Loyalty Program Ret Item 2", "1/5/2026", "€1644"], status: "pending" as const },
    { id: "776155115", cells: ["RET-5115", "Loyalty Program Ret Item 3", "16/12/2026", "€5215"], status: "completed" as const },
    { id: "776158686", cells: ["RET-8686", "Loyalty Program Ret Item 4", "3/7/2026", "€8786"], status: "warning" as const },
    { id: "776162257", cells: ["RET-3257", "Loyalty Program Ret Item 5", "18/2/2026", "€12 357"], status: "active" as const },
];
...
export default function RetailPlatformLoyaltyProgramRetPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Loyalty Program Ret</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Retail Platform • Loyalty Program Ret</p>
                    </div>
                </div>
