...
/* ═══ Retail Platform — Store Ops ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "4220", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "407", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1272", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "724515555", cells: ["RET-7555", "Store Ops Item 1", "16/4/2026", "€15 655"], status: "active" as const },
    { id: "724519126", cells: ["RET-2126", "Store Ops Item 2", "3/11/2026", "€19 226"], status: "pending" as const },
    { id: "724522697", cells: ["RET-5697", "Store Ops Item 3", "18/6/2026", "€22 797"], status: "completed" as const },
    { id: "724526268", cells: ["RET-9268", "Store Ops Item 4", "5/1/2026", "€26 368"], status: "warning" as const },
    { id: "724529839", cells: ["RET-3839", "Store Ops Item 5", "20/8/2026", "€29 939"], status: "active" as const },
];
...
export default function RetailPlatformStoreOpsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Store Ops</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Retail Platform • Store Ops</p>
                    </div>
                </div>
