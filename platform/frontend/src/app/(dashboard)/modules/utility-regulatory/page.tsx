...
export default function UtilityRegulatoryPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Utility Regulatory</h1><p className="text-sm text-muted-foreground">Utility Regulatory • iBOS Enterprise</p></div>
