...
const KPIS = [{"l":"Dashboards Ativos","v":"7.118","t":"+3.1%","d":"up"},{"l":"Queries/Dia","v":"4884","t":"+4.5%","d":"up"},{"l":"Dados Processados (GB)","v":"573","t":"+8.0%","d":"up"},{"l":"Utilizadores Analytics","v":"6.331","t":"+11.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4131","2026-02-05","836","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2200","2026-03-01","1.227","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4990","2026-02-28","8.999","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1922","2026-01-15","8.736","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","926","2026-01-01","2.367","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1000},{"label":"Fev","value":786},{"label":"Mar","value":767},{"label":"Abr","value":872},{"label":"Mai","value":864},{"label":"Jun","value":1024},{"label":"Jul","value":1038},{"label":"Ago","value":946},{"label":"Set","value":966},{"label":"Out","value":814},{"label":"Nov","value":955},{"label":"Dez","value":970}];
const MX = 1038;
