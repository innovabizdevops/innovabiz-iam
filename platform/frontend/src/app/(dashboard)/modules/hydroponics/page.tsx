...
const KPIS = [
    { label: "Total Registos", value: "8657", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2670", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€19K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2216257", cells: ["HYD-3257", "Hydroponics System Item 1", "2/2/2026", "€16 357"], status: "active" as const },
    { id: "2219828", cells: ["HYD-6828", "Hydroponics System Item 2", "17/9/2026", "€19 928"], status: "pending" as const },
    { id: "2223399", cells: ["HYD-1399", "Hydroponics System Item 3", "4/4/2026", "€23 499"], status: "completed" as const },
    { id: "2226970", cells: ["HYD-4970", "Hydroponics System Item 4", "19/11/2026", "€27 070"], status: "warning" as const },
    { id: "2230541", cells: ["HYD-8541", "Hydroponics System Item 5", "6/6/2026", "€30 641"], status: "active" as const },
];
...
export default function HydroponicsSystemPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Hydroponics System</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Hydroponics System</p>
                    </div>
                </div>
