...
const KPIS = [{"l":"Total Sat Comm","v":"2.351","t":"-1.6%","d":"down"},{"l":"Transponder Ativos","v":"7.578","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"82.8%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"58","t":"-0.9%","d":"down"}];
const COLS = ["ID","Transponder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sat Comm #001","Sat Comm #002","3.110","5.178","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Sat Comm #002","Sat Comm #003","4.635","8.614","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Sat Comm #003","Sat Comm #004","2.973","3.034","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Sat Comm #004","Sat Comm #005","729","5.329","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sat Comm #005","Sat Comm #001","5.300","8.831","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":1000},{"label":"Mar","value":755},{"label":"Abr","value":808},{"label":"Mai","value":692},{"label":"Jun","value":647},{"label":"Jul","value":956},{"label":"Ago","value":659},{"label":"Set","value":971},{"label":"Out","value":923},{"label":"Nov","value":1011},{"label":"Dez","value":767}];
const MX = 1011;
