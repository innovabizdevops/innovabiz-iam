...
const PAGE = "LEO";
const KPIS = [{"l":"Total Sat Comm","v":"5.942","t":"+9.8%","d":"up"},{"l":"LEO Ativos","v":"2.224","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"71.6%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"92","t":"-1.1%","d":"down"}];
const COLS = ["ID","LEO","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sat Comm #001","Sat Comm #002","2.909","8.835","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Sat Comm #002","Sat Comm #003","1.372","8.271","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Sat Comm #003","Sat Comm #004","2.407","1.723","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Sat Comm #004","Sat Comm #005","6.330","7.283","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sat Comm #005","Sat Comm #001","6.385","855","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":482},{"label":"Fev","value":669},{"label":"Mar","value":618},{"label":"Abr","value":680},{"label":"Mai","value":674},{"label":"Jun","value":514},{"label":"Jul","value":718},{"label":"Ago","value":799},{"label":"Set","value":507},{"label":"Out","value":531},{"label":"Nov","value":793},{"label":"Dez","value":651}];
const MX = 799;
