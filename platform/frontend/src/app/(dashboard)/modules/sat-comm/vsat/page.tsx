...
const PAGE = "VSAT";
const KPIS = [{"l":"Total Sat Comm","v":"2.558","t":"+11.0%","d":"up"},{"l":"VSAT Ativos","v":"1.451","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"91.9%","t":"+11.5%","d":"up"},{"l":"Score Performance","v":"88","t":"-1.8%","d":"down"}];
const COLS = ["ID","VSAT","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sat Comm #001","Sat Comm #002","1.758","160","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Sat Comm #002","Sat Comm #003","6.726","2.088","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Sat Comm #003","Sat Comm #004","4.647","6.327","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Sat Comm #004","Sat Comm #005","801","2.607","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sat Comm #005","Sat Comm #001","6.924","3.399","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1023},{"label":"Fev","value":721},{"label":"Mar","value":772},{"label":"Abr","value":1041},{"label":"Mai","value":937},{"label":"Jun","value":699},{"label":"Jul","value":701},{"label":"Ago","value":882},{"label":"Set","value":757},{"label":"Out","value":724},{"label":"Nov","value":934},{"label":"Dez","value":842}];
const MX = 1041;
