...
const PAGE = "Earth Station";
const KPIS = [{"l":"Total Sat Comm","v":"2.465","t":"+7.0%","d":"up"},{"l":"Earth Station Ativos","v":"3.578","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"68.4%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"85","t":"-5.3%","d":"down"}];
const COLS = ["ID","Earth Station","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sat Comm #001","Sat Comm #002","2.325","2.178","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Sat Comm #002","Sat Comm #003","5.459","7.583","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Sat Comm #003","Sat Comm #004","5.539","7.754","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Sat Comm #004","Sat Comm #005","3.415","6.866","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sat Comm #005","Sat Comm #001","6.009","453","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":233},{"label":"Fev","value":421},{"label":"Mar","value":275},{"label":"Abr","value":443},{"label":"Mai","value":320},{"label":"Jun","value":470},{"label":"Jul","value":552},{"label":"Ago","value":480},{"label":"Set","value":431},{"label":"Out","value":357},{"label":"Nov","value":348},{"label":"Dez","value":530}];
const MX = 552;
