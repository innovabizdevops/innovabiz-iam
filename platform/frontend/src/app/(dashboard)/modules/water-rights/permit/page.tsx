...
const PAGE = "Permit";
const KPIS = [{"l":"Riscos Identificados","v":"3.904","t":"+5.6%","d":"up"},{"l":"Mitigações Ativas","v":"7.586","t":"+11.4%","d":"up"},{"l":"Score Risco Geral","v":"90","t":"+9.3%","d":"up"},{"l":"Incidentes YTD","v":"2.269","t":"+16.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","844","6.051","8.949","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.710","3.039","5.640","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.528","5.938","6.998","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.173","7.443","5.889","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.930","6.735","5.124","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":975},{"label":"Fev","value":752},{"label":"Mar","value":837},{"label":"Abr","value":679},{"label":"Mai","value":615},{"label":"Jun","value":928},{"label":"Jul","value":974},{"label":"Ago","value":850},{"label":"Set","value":882},{"label":"Out","value":892},{"label":"Nov","value":705},{"label":"Dez","value":629}];
const MX = 975;
