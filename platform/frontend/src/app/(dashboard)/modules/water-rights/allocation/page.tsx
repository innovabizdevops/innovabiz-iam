...
const ACCENT = "#0e7490";
const MODULE = "Water Rights Mgmt";
const PAGE = "Allocation";
const KPIS = [{"l":"Total Water Rights","v":"5.427","t":"+11.4%","d":"up"},{"l":"Allocation Ativos","v":"4.272","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"88.2%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"64","t":"+4.9%","d":"up"}];
const COLS = ["ID","Allocation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Rights #001","Water Rights #002","6.040","2.787","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Water Rights #002","Water Rights #003","651","4.723","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Rights #003","Water Rights #004","8.513","7.495","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Water Rights #004","Water Rights #005","209","4.888","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Rights #005","Water Rights #001","6.639","3.740","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":472},{"label":"Fev","value":418},{"label":"Mar","value":422},{"label":"Abr","value":531},{"label":"Mai","value":766},{"label":"Jun","value":722},{"label":"Jul","value":583},{"label":"Ago","value":481},{"label":"Set","value":466},{"label":"Out","value":584},{"label":"Nov","value":393},{"label":"Dez","value":564}];
const MX = 766;
