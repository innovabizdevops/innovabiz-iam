...
const KPIS = [
    { label: "Total Registos", value: "4610", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2466", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€434K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1774440910", cells: ["VET-1910", "Veteran Services Item 1", "19/11/2026", "€41 010"], status: "active" as const },
    { id: "1774444481", cells: ["VET-5481", "Veteran Services Item 2", "6/6/2026", "€44 581"], status: "pending" as const },
    { id: "1774448052", cells: ["VET-9052", "Veteran Services Item 3", "21/1/2026", "€48 152"], status: "completed" as const },
    { id: "1774451623", cells: ["VET-3623", "Veteran Services Item 4", "8/8/2026", "€1723"], status: "warning" as const },
    { id: "1774455194", cells: ["VET-7194", "Veteran Services Item 5", "23/3/2026", "€5294"], status: "active" as const },
];
...
export default function VeteranServicesPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Veteran Services</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Veteran Services</p>
                    </div>
                </div>
