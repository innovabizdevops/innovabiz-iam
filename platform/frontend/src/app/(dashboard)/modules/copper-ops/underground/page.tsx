...
const ACCENT = "#6366f1";
const MODULE = "Copper Operations";
const PAGE = "Underground";
const KPIS = [{"l":"Total Copper Ops","v":"6.326","t":"+3.7%","d":"up"},{"l":"Underground Ativos","v":"4.085","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"82.9%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"77","t":"+13.2%","d":"up"}];
const COLS = ["ID","Underground","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Copper Ops #001","Copper Ops #002","580","4.427","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Copper Ops #002","Copper Ops #003","1.173","6.864","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Copper Ops #003","Copper Ops #004","6.640","3.061","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Copper Ops #004","Copper Ops #005","412","6.456","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Copper Ops #005","Copper Ops #001","7.416","6.309","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":311},{"label":"Fev","value":565},{"label":"Mar","value":648},{"label":"Abr","value":568},{"label":"Mai","value":290},{"label":"Jun","value":429},{"label":"Jul","value":621},{"label":"Ago","value":395},{"label":"Set","value":644},{"label":"Out","value":475},{"label":"Nov","value":422},{"label":"Dez","value":620}];
const MX = 648;
