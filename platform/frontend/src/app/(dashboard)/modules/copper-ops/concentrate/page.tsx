...
const PAGE = "Concentrate";
const KPIS = [{"l":"Total Copper Ops","v":"733","t":"-4.0%","d":"down"},{"l":"Concentrate Ativos","v":"123","t":"+13.4%","d":"up"},{"l":"Eficiência (%)","v":"89.2%","t":"+13.3%","d":"up"},{"l":"Score Performance","v":"88","t":"-1.1%","d":"down"}];
const COLS = ["ID","Concentrate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Copper Ops #001","Copper Ops #002","7.267","3.877","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Copper Ops #002","Copper Ops #003","8.301","1.886","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Copper Ops #003","Copper Ops #004","1.004","1.556","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Copper Ops #004","Copper Ops #005","3.247","5.447","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Copper Ops #005","Copper Ops #001","390","524","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":564},{"label":"Mar","value":619},{"label":"Abr","value":618},{"label":"Mai","value":792},{"label":"Jun","value":667},{"label":"Jul","value":493},{"label":"Ago","value":721},{"label":"Set","value":593},{"label":"Out","value":767},{"label":"Nov","value":786},{"label":"Dez","value":738}];
const MX = 792;
