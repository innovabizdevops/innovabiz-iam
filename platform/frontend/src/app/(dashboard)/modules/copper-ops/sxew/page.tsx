...
const PAGE = "SX-EW";
const KPIS = [{"l":"Total Copper Ops","v":"3.308","t":"+16.1%","d":"up"},{"l":"SX EW Ativos","v":"5.785","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"60","t":"+14.0%","d":"up"}];
const COLS = ["ID","SX EW","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Copper Ops #001","Copper Ops #002","5.661","2.356","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Copper Ops #002","Copper Ops #003","1.935","5.203","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Copper Ops #003","Copper Ops #004","989","9.021","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Copper Ops #004","Copper Ops #005","8.501","8.912","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Copper Ops #005","Copper Ops #001","3.516","6.678","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":836},{"label":"Fev","value":577},{"label":"Mar","value":601},{"label":"Abr","value":856},{"label":"Mai","value":815},{"label":"Jun","value":677},{"label":"Jul","value":715},{"label":"Ago","value":824},{"label":"Set","value":894},{"label":"Out","value":538},{"label":"Nov","value":539},{"label":"Dez","value":564}];
const MX = 894;
...
export default function SxewPage() {
    return (
