...
const PAGE = "Market";
const KPIS = [{"l":"Total Copper Ops","v":"7.099","t":"-1.7%","d":"down"},{"l":"Market Ativos","v":"8.530","t":"-3.7%","d":"down"},{"l":"Eficiência (%)","v":"91.6%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"57","t":"+11.1%","d":"up"}];
const COLS = ["ID","Market","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Copper Ops #001","Copper Ops #002","681","7.257","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Copper Ops #002","Copper Ops #003","8.512","2.232","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Copper Ops #003","Copper Ops #004","561","7.819","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Copper Ops #004","Copper Ops #005","4.006","4.746","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Copper Ops #005","Copper Ops #001","712","1.481","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":310},{"label":"Mar","value":264},{"label":"Abr","value":460},{"label":"Mai","value":374},{"label":"Jun","value":442},{"label":"Jul","value":379},{"label":"Ago","value":299},{"label":"Set","value":566},{"label":"Out","value":419},{"label":"Nov","value":577},{"label":"Dez","value":322}];
const MX = 606;
