...
const ACCENT = "#dc2626";
const MODULE = "AI Governance & TRiSM";
const PAGE = "IEEE Ethics Standard";
const KPIS = [{"l":"Riscos Identificados","v":"2.518","t":"-1.4%","d":"down"},{"l":"Mitigações Ativas","v":"3.280","t":"+0.1%","d":"up"},{"l":"Score Risco Geral","v":"76","t":"+7.5%","d":"up"},{"l":"Incidentes YTD","v":"4.604","t":"+13.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","372","4.988","8.602","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.677","4.961","1.719","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.720","4.526","1.702","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","606","7.331","3.004","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","499","5.835","4.970","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":554},{"label":"Mar","value":314},{"label":"Abr","value":487},{"label":"Mai","value":542},{"label":"Jun","value":619},{"label":"Jul","value":336},{"label":"Ago","value":389},{"label":"Set","value":639},{"label":"Out","value":320},{"label":"Nov","value":531},{"label":"Dez","value":508}];
const MX = 639;
...
export default function IeeeEthicsPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>IEEE</span></h1>
                </div>
