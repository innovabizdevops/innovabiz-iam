...
const KPIS = [{"l":"Riscos Identificados","v":"8.021","t":"+3.6%","d":"up"},{"l":"Mitigações Ativas","v":"2.331","t":"-0.3%","d":"down"},{"l":"Score Risco Geral","v":"58","t":"+10.5%","d":"up"},{"l":"Incidentes YTD","v":"2.247","t":"+17.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.096","8.357","6.242","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.574","5.422","3.163","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.130","7.493","1.012","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.486","8.628","2.775","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.058","9.023","6.031","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":911},{"label":"Fev","value":920},{"label":"Mar","value":630},{"label":"Abr","value":850},{"label":"Mai","value":658},{"label":"Jun","value":919},{"label":"Jul","value":775},{"label":"Ago","value":760},{"label":"Set","value":696},{"label":"Out","value":679},{"label":"Nov","value":846},{"label":"Dez","value":730}];
const MX = 920;
