...
const PAGE = "NIST AI RMF";
const KPIS = [{"l":"Riscos Identificados","v":"6.370","t":"+2.5%","d":"up"},{"l":"Mitigações Ativas","v":"8.292","t":"+8.5%","d":"up"},{"l":"Score Risco Geral","v":"86","t":"+6.1%","d":"up"},{"l":"Incidentes YTD","v":"2.941","t":"+6.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.486","1.529","1.665","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.101","8.052","214","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.057","3.974","1.710","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.178","6.657","3.410","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.363","2.480","375","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":692},{"label":"Mar","value":607},{"label":"Abr","value":637},{"label":"Mai","value":575},{"label":"Jun","value":774},{"label":"Jul","value":818},{"label":"Ago","value":597},{"label":"Set","value":495},{"label":"Out","value":817},{"label":"Nov","value":787},{"label":"Dez","value":846}];
const MX = 846;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>NIST</span></h1>
                </div>
