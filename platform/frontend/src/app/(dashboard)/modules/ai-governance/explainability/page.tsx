...
const PAGE = "Explainability XAI";
const KPIS = [{"l":"Riscos Identificados","v":"187","t":"+14.3%","d":"up"},{"l":"Mitigações Ativas","v":"3.748","t":"+5.4%","d":"up"},{"l":"Score Risco Geral","v":"92","t":"-5.7%","d":"down"},{"l":"Incidentes YTD","v":"7.717","t":"-0.9%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.855","5.518","5.874","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.776","3.049","1.072","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.086","6.415","2.115","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.642","8.034","9.018","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.086","8.261","7.332","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":556},{"label":"Mar","value":554},{"label":"Abr","value":574},{"label":"Mai","value":872},{"label":"Jun","value":737},{"label":"Jul","value":527},{"label":"Ago","value":743},{"label":"Set","value":631},{"label":"Out","value":543},{"label":"Nov","value":746},{"label":"Dez","value":595}];
const MX = 872;
