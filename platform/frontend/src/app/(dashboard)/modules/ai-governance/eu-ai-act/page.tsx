...
const PAGE = "EU AI Act Compliance";
const KPIS = [{"l":"Riscos Identificados","v":"4.613","t":"+2.5%","d":"up"},{"l":"Mitigações Ativas","v":"4.044","t":"+14.0%","d":"up"},{"l":"Score Risco Geral","v":"95","t":"+8.3%","d":"up"},{"l":"Incidentes YTD","v":"2.417","t":"+6.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.412","6.579","3.053","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.315","7.648","4.893","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.928","1.178","1.467","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","645","2.591","8.441","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.016","7.045","4.158","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":812},{"label":"Mar","value":1001},{"label":"Abr","value":808},{"label":"Mai","value":799},{"label":"Jun","value":907},{"label":"Jul","value":845},{"label":"Ago","value":792},{"label":"Set","value":641},{"label":"Out","value":800},{"label":"Nov","value":943},{"label":"Dez","value":841}];
const MX = 1001;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>EU</span></h1>
                </div>
