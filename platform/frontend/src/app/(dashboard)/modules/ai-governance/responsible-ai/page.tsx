...
const PAGE = "Responsible AI";
const KPIS = [{"l":"Riscos Identificados","v":"6.685","t":"-2.6%","d":"down"},{"l":"Mitigações Ativas","v":"5.599","t":"+1.0%","d":"up"},{"l":"Score Risco Geral","v":"56","t":"+6.2%","d":"up"},{"l":"Incidentes YTD","v":"2.685","t":"+6.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.803","8.305","6.032","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.955","2.650","3.877","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.870","126","5.820","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.028","3.580","5.125","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","760","1.519","5.862","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":405},{"label":"Fev","value":464},{"label":"Mar","value":631},{"label":"Abr","value":423},{"label":"Mai","value":511},{"label":"Jun","value":575},{"label":"Jul","value":539},{"label":"Ago","value":276},{"label":"Set","value":497},{"label":"Out","value":413},{"label":"Nov","value":356},{"label":"Dez","value":537}];
const MX = 631;
