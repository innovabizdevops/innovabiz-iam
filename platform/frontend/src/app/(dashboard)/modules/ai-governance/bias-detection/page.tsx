...
const PAGE = "Bias Detection AI";
const KPIS = [{"l":"Riscos Identificados","v":"3.900","t":"+3.5%","d":"up"},{"l":"Mitigações Ativas","v":"6.090","t":"+1.1%","d":"up"},{"l":"Score Risco Geral","v":"89","t":"+6.2%","d":"up"},{"l":"Incidentes YTD","v":"8.679","t":"+6.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.808","6.013","3.872","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.520","3.097","1.152","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.913","5.609","471","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.018","8.967","7.142","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.297","8.604","2.557","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":493},{"label":"Mar","value":742},{"label":"Abr","value":683},{"label":"Mai","value":566},{"label":"Jun","value":840},{"label":"Jul","value":754},{"label":"Ago","value":641},{"label":"Set","value":495},{"label":"Out","value":652},{"label":"Nov","value":823},{"label":"Dez","value":599}];
const MX = 840;
