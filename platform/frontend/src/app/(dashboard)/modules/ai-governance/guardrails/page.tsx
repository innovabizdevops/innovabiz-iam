...
const PAGE = "LLM Guardrails";
const KPIS = [{"l":"Riscos Identificados","v":"5.612","t":"+12.3%","d":"up"},{"l":"Mitigações Ativas","v":"4.771","t":"+7.2%","d":"up"},{"l":"Score Risco Geral","v":"87","t":"-1.5%","d":"down"},{"l":"Incidentes YTD","v":"2.689","t":"-3.4%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.013","5.651","5.540","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.434","5.480","1.162","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.246","7.346","3.741","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.136","6.265","6.855","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.928","4.926","5.483","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":597},{"label":"Fev","value":644},{"label":"Mar","value":661},{"label":"Abr","value":637},{"label":"Mai","value":654},{"label":"Jun","value":543},{"label":"Jul","value":642},{"label":"Ago","value":536},{"label":"Set","value":467},{"label":"Out","value":687},{"label":"Nov","value":715},{"label":"Dez","value":639}];
const MX = 715;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>GenAI</span></h1>
                </div>
