...
const PAGE = "AI Compliance";
const KPIS = [{"l":"Riscos Identificados","v":"2.289","t":"+13.5%","d":"up"},{"l":"Mitigações Ativas","v":"3.008","t":"+17.0%","d":"up"},{"l":"Score Risco Geral","v":"75","t":"+6.5%","d":"up"},{"l":"Incidentes YTD","v":"5.262","t":"+11.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","9.057","4.606","733","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.229","6.237","483","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.205","4.751","2.485","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.992","769","7.009","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.970","815","4.118","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":511},{"label":"Mar","value":817},{"label":"Abr","value":624},{"label":"Mai","value":790},{"label":"Jun","value":722},{"label":"Jul","value":534},{"label":"Ago","value":647},{"label":"Set","value":605},{"label":"Out","value":737},{"label":"Nov","value":870},{"label":"Dez","value":851}];
const MX = 870;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>EU AI Act</span></h1>
                </div>
