...
const PAGE = "AI Risk Assessment";
const KPIS = [{"l":"Riscos Identificados","v":"3.080","t":"-0.5%","d":"down"},{"l":"Mitigações Ativas","v":"2.492","t":"+3.5%","d":"up"},{"l":"Score Risco Geral","v":"77","t":"+1.1%","d":"up"},{"l":"Incidentes YTD","v":"410","t":"+14.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.550","1.627","328","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.836","7.744","7.778","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.877","5.879","8.637","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.497","2.378","5.868","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","828","5.691","120","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":487},{"label":"Mar","value":486},{"label":"Abr","value":543},{"label":"Mai","value":631},{"label":"Jun","value":719},{"label":"Jul","value":769},{"label":"Ago","value":653},{"label":"Set","value":467},{"label":"Out","value":797},{"label":"Nov","value":814},{"label":"Dez","value":725}];
const MX = 814;
