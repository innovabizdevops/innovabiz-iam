...
const PAGE = "Survey";
const KPIS = [{"l":"Surveys Ativos","v":"455","t":"-5.8%","d":"down"},{"l":"Respostas/Semana","v":"190","t":"+4.7%","d":"up"},{"l":"NPS Médio","v":"83","t":"+16.1%","d":"up"},{"l":"Taxa Resposta (%)","v":"80.6%","t":"-1.9%","d":"down"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","7.224","85","89.0%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","5.269","87","96.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","8.947","59","81.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","4.567","76","95.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","8.569","85","98.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":552},{"label":"Mar","value":477},{"label":"Abr","value":609},{"label":"Mai","value":636},{"label":"Jun","value":563},{"label":"Jul","value":678},{"label":"Ago","value":412},{"label":"Set","value":442},{"label":"Out","value":587},{"label":"Nov","value":716},{"label":"Dez","value":431}];
const MX = 716;
