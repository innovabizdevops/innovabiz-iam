...
const KPIS = [{"l":"Total Forest Drone","v":"366","t":"+16.0%","d":"up"},{"l":"Inventory Ativos","v":"6.278","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"82.6%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"92","t":"+11.3%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Drone #001","Forest Drone #002","5.894","676","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Drone #002","Forest Drone #003","2.202","6.499","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Drone #003","Forest Drone #004","5.543","6.317","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Drone #004","Forest Drone #005","6.167","5.273","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Drone #005","Forest Drone #001","7.588","3.559","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":537},{"label":"Mar","value":549},{"label":"Abr","value":569},{"label":"Mai","value":625},{"label":"Jun","value":471},{"label":"Jul","value":728},{"label":"Ago","value":766},{"label":"Set","value":577},{"label":"Out","value":498},{"label":"Nov","value":540},{"label":"Dez","value":428}];
const MX = 766;
