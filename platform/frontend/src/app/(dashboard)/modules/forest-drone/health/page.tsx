...
const ACCENT = "#14532d";
const MODULE = "Forest Drone Service";
const PAGE = "Health";
const KPIS = [{"l":"Total Forest Drone","v":"1.303","t":"+2.8%","d":"up"},{"l":"Health Ativos","v":"6.457","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"85.7%","t":"+11.9%","d":"up"},{"l":"Score Performance","v":"81","t":"+12.8%","d":"up"}];
const COLS = ["ID","Health","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Drone #001","Forest Drone #002","8.529","1.147","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Drone #002","Forest Drone #003","793","2.776","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Drone #003","Forest Drone #004","5.058","779","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Drone #004","Forest Drone #005","208","5.858","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Drone #005","Forest Drone #001","4.826","6.525","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":737},{"label":"Mar","value":679},{"label":"Abr","value":854},{"label":"Mai","value":779},{"label":"Jun","value":521},{"label":"Jul","value":650},{"label":"Ago","value":661},{"label":"Set","value":808},{"label":"Out","value":520},{"label":"Nov","value":819},{"label":"Dez","value":535}];
const MX = 854;
