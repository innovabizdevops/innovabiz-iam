...
/* ═══ Forest Drone Service — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "1811", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2283", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€20K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "717791311", cells: ["FOR-6311", "Forest Drone Service Item 1", "28/8/2026", "€41 411"], status: "active" as const },
    { id: "717794882", cells: ["FOR-9882", "Forest Drone Service Item 2", "15/3/2026", "€44 982"], status: "pending" as const },
    { id: "717798453", cells: ["FOR-4453", "Forest Drone Service Item 3", "2/10/2026", "€48 553"], status: "completed" as const },
    { id: "717802024", cells: ["FOR-8024", "Forest Drone Service Item 4", "17/5/2026", "€2124"], status: "warning" as const },
    { id: "717805595", cells: ["FOR-2595", "Forest Drone Service Item 5", "4/12/2026", "€5695"], status: "active" as const },
];
...
export default function ForestDroneServicePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Forest Drone Service</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Forest Drone Service</p>
                    </div>
                </div>
