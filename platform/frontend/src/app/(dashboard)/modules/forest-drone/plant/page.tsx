...
const PAGE = "Plant";
const KPIS = [{"l":"Total Forest Drone","v":"8.070","t":"+12.4%","d":"up"},{"l":"Plant Ativos","v":"3.595","t":"+2.3%","d":"up"},{"l":"Eficiência (%)","v":"78.1%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"75","t":"-1.6%","d":"down"}];
const COLS = ["ID","Plant","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Drone #001","Forest Drone #002","8.093","1.838","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Drone #002","Forest Drone #003","3.111","8.088","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Drone #003","Forest Drone #004","5.449","5.401","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Drone #004","Forest Drone #005","2.112","3.418","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Drone #005","Forest Drone #001","5.998","3.466","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":686},{"label":"Mar","value":616},{"label":"Abr","value":572},{"label":"Mai","value":471},{"label":"Jun","value":657},{"label":"Jul","value":646},{"label":"Ago","value":540},{"label":"Set","value":578},{"label":"Out","value":454},{"label":"Nov","value":729},{"label":"Dez","value":696}];
const MX = 729;
