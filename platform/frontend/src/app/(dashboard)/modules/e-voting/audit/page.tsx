...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.065","t":"+5.9%","d":"up"},{"l":"NC Abertas","v":"1.311","t":"+17.5%","d":"up"},{"l":"Conformidade (%)","v":"92.9%","t":"-3.6%","d":"down"},{"l":"CAPAs Pendentes","v":"151","t":"+9.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.486","78.2%","489","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.507","71.4%","8.926","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.481","97.2%","8.101","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.266","81.8%","6.640","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","712","93.1%","1.034","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":838},{"label":"Fev","value":894},{"label":"Mar","value":915},{"label":"Abr","value":701},{"label":"Mai","value":690},{"label":"Jun","value":788},{"label":"Jul","value":962},{"label":"Ago","value":714},{"label":"Set","value":681},{"label":"Out","value":737},{"label":"Nov","value":1041},{"label":"Dez","value":964}];
const MX = 1041;
