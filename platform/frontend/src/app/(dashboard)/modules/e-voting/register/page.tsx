...
const ACCENT = "#2d4a6f";
const MODULE = "E-Voting System";
const PAGE = "Register";
const KPIS = [{"l":"Total E Voting","v":"4.468","t":"+1.6%","d":"up"},{"l":"Register Ativos","v":"420","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"79.6%","t":"+8.3%","d":"up"},{"l":"Score Performance","v":"74","t":"+15.9%","d":"up"}];
const COLS = ["ID","Register","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["E Voting #001","E Voting #002","525","2.583","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["E Voting #002","E Voting #003","6.695","3.556","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["E Voting #003","E Voting #004","4.511","6.236","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["E Voting #004","E Voting #005","5.209","7.894","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["E Voting #005","E Voting #001","7.030","6.364","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":1093},{"label":"Mar","value":906},{"label":"Abr","value":736},{"label":"Mai","value":1049},{"label":"Jun","value":766},{"label":"Jul","value":1091},{"label":"Ago","value":1014},{"label":"Set","value":924},{"label":"Out","value":1069},{"label":"Nov","value":982},{"label":"Dez","value":937}];
const MX = 1093;
