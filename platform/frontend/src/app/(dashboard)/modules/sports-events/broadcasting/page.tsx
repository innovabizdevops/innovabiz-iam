...
const PAGE = "Broadcasting Rights";
const KPIS = [{"l":"Atletas Registados","v":"3.637","t":"+3.9%","d":"up"},{"l":"Treinos/Semana","v":"3610","t":"+8.9%","d":"up"},{"l":"Competições","v":"6.425","t":"+11.7%","d":"up"},{"l":"Performance Score","v":"91","t":"+1.6%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","430","1.809","8.991","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.292","8.303","6.790","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.122","4.385","4.851","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.441","547","4.515","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.675","5.296","1.736","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":780},{"label":"Fev","value":444},{"label":"Mar","value":717},{"label":"Abr","value":416},{"label":"Mai","value":716},{"label":"Jun","value":534},{"label":"Jul","value":757},{"label":"Ago","value":419},{"label":"Set","value":500},{"label":"Out","value":507},{"label":"Nov","value":563},{"label":"Dez","value":590}];
const MX = 780;
