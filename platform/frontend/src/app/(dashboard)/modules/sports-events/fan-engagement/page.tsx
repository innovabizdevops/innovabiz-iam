...
const PAGE = "Fan Engagement AI";
const KPIS = [{"l":"eNPS","v":"83","t":"+14.0%","d":"up"},{"l":"Engagement (%)","v":"66.7%","t":"+13.0%","d":"up"},{"l":"Turnover (%)","v":"93.9%","t":"+13.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"515","t":"+10.1%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.047","2026-02-22","58","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.198","2026-03-09","93","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","227","2026-02-11","81","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.876","2026-02-26","60","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.788","2026-01-03","91","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":726},{"label":"Mar","value":620},{"label":"Abr","value":825},{"label":"Mai","value":704},{"label":"Jun","value":603},{"label":"Jul","value":858},{"label":"Ago","value":806},{"label":"Set","value":658},{"label":"Out","value":779},{"label":"Nov","value":839},{"label":"Dez","value":586}];
const MX = 858;
