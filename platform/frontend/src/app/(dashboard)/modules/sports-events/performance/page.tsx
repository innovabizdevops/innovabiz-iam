...
const PAGE = "Performance Analytics";
const KPIS = [{"l":"Formulários Ativos","v":"2.183","t":"+6.9%","d":"up"},{"l":"Submissões/Dia","v":"3249","t":"+7.8%","d":"up"},{"l":"Documentos Gerados","v":"4.704","t":"+7.0%","d":"up"},{"l":"Templates","v":"4.658","t":"-5.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.871","2026-01-27","4.458","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.911","2026-02-22","2.111","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","741","2026-02-17","8.963","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","308","2026-02-27","9.028","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.394","2026-03-21","4.035","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":580},{"label":"Mar","value":630},{"label":"Abr","value":410},{"label":"Mai","value":637},{"label":"Jun","value":443},{"label":"Jul","value":355},{"label":"Ago","value":648},{"label":"Set","value":660},{"label":"Out","value":505},{"label":"Nov","value":469},{"label":"Dez","value":590}];
const MX = 660;
