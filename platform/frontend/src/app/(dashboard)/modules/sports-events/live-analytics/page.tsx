...
const ACCENT = "#ea580c";
const MODULE = "Sports & Events";
const PAGE = "Live Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"2.536","t":"-1.1%","d":"down"},{"l":"Queries/Dia","v":"564","t":"+15.7%","d":"up"},{"l":"Dados Processados (GB)","v":"3.708","t":"+15.5%","d":"up"},{"l":"Utilizadores Analytics","v":"1.392","t":"+2.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3689","2026-02-26","7.090","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","912","2026-01-25","4.381","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","699","2026-01-22","6.084","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1727","2026-01-09","6.716","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1652","2026-01-21","1.221","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":477},{"label":"Mar","value":330},{"label":"Abr","value":470},{"label":"Mai","value":319},{"label":"Jun","value":490},{"label":"Jul","value":644},{"label":"Ago","value":657},{"label":"Set","value":280},{"label":"Out","value":465},{"label":"Nov","value":490},{"label":"Dez","value":645}];
const MX = 658;
