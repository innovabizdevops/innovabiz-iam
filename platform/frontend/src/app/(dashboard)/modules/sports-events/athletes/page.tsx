...
const PAGE = "Athlete Management";
const KPIS = [{"l":"Projetos Melhoria","v":"3.033","t":"+5.9%","d":"up"},{"l":"Savings (€)","v":"€53273","t":"-2.5%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"69.5%","t":"+5.5%","d":"up"},{"l":"Ciclos PDCA","v":"725","t":"+7.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.358","€ 48693.00","6.153","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.284","€ 12324.92","628","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.194","€ 45570.42","1.244","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.333","€ 3272.58","6.620","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.510","€ 486.30","109","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":408},{"label":"Fev","value":539},{"label":"Mar","value":662},{"label":"Abr","value":460},{"label":"Mai","value":633},{"label":"Jun","value":583},{"label":"Jul","value":540},{"label":"Ago","value":317},{"label":"Set","value":522},{"label":"Out","value":644},{"label":"Nov","value":405},{"label":"Dez","value":406}];
const MX = 662;
