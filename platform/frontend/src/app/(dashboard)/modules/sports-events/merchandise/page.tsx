...
const PAGE = "Merchandise &amp; Retail";
const KPIS = [{"l":"Pedidos/Dia","v":"3088","t":"+1.1%","d":"up"},{"l":"GMV (€)","v":"€54821","t":"+9.5%","d":"up"},{"l":"Conversão (%)","v":"84.3%","t":"-5.2%","d":"down"},{"l":"AOV (€)","v":"€30051","t":"-3.6%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 39909.30","2.122","4.918","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 21548.69","3.415","4.669","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 6358.00","6.834","3.145","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 17957.03","5.996","1.445","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 4937.60","1.361","1.664","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":539},{"label":"Fev","value":782},{"label":"Mar","value":605},{"label":"Abr","value":564},{"label":"Mai","value":641},{"label":"Jun","value":673},{"label":"Jul","value":822},{"label":"Ago","value":614},{"label":"Set","value":913},{"label":"Out","value":780},{"label":"Nov","value":604},{"label":"Dez","value":764}];
const MX = 913;
