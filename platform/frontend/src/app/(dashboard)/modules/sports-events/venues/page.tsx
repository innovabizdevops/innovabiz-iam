...
const KPIS = [{"l":"Projetos Melhoria","v":"2.658","t":"-2.5%","d":"down"},{"l":"Savings (€)","v":"€24089","t":"+4.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"83.1%","t":"+5.0%","d":"up"},{"l":"Ciclos PDCA","v":"3.078","t":"+2.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.843","€ 31965.13","8.813","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.500","€ 33299.76","4.966","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.939","€ 28304.75","9.079","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","257","€ 37296.69","8.363","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.698","€ 33202.52","4.647","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":437},{"label":"Mar","value":404},{"label":"Abr","value":541},{"label":"Mai","value":583},{"label":"Jun","value":569},{"label":"Jul","value":477},{"label":"Ago","value":276},{"label":"Set","value":451},{"label":"Out","value":340},{"label":"Nov","value":642},{"label":"Dez","value":308}];
const MX = 642;
