...
const PAGE = "Broadcast Mgmt";
const KPIS = [{"l":"Atletas Registados","v":"1.527","t":"+16.4%","d":"up"},{"l":"Treinos/Semana","v":"918","t":"+1.0%","d":"up"},{"l":"Competições","v":"4.288","t":"-3.4%","d":"down"},{"l":"Performance Score","v":"94","t":"+7.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.459","1.080","7.643","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.141","8.084","7.084","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.358","8.998","3.952","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.087","5.053","1.785","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.540","5.043","7.970","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":834},{"label":"Mar","value":784},{"label":"Abr","value":793},{"label":"Mai","value":842},{"label":"Jun","value":609},{"label":"Jul","value":658},{"label":"Ago","value":723},{"label":"Set","value":925},{"label":"Out","value":741},{"label":"Nov","value":701},{"label":"Dez","value":976}];
const MX = 976;
