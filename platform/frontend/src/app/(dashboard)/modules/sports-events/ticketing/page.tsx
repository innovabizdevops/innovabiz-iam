...
const KPIS = [{"l":"Tickets Abertos","v":"6.905","t":"+9.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"73.0%","t":"+3.7%","d":"up"},{"l":"MTTR (h)","v":"177h","t":"+2.4%","d":"up"},{"l":"Satisfação (%)","v":"72.8%","t":"+3.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.299","2.338","4.436","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.259","161","5.227","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.725","2.728","8.244","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","715","8.597","7.964","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.514","3.481","330","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":862},{"label":"Mar","value":621},{"label":"Abr","value":607},{"label":"Mai","value":966},{"label":"Jun","value":970},{"label":"Jul","value":819},{"label":"Ago","value":847},{"label":"Set","value":611},{"label":"Out","value":919},{"label":"Nov","value":744},{"label":"Dez","value":633}];
const MX = 970;
