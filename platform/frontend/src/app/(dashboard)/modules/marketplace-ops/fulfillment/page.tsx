...
const ACCENT = "#6366f1";
const MODULE = "Marketplace Ops";
const PAGE = "Fulfillment";
const KPIS = [{"l":"Pedidos/Dia","v":"2780","t":"+6.9%","d":"up"},{"l":"GMV (€)","v":"€86984","t":"-1.9%","d":"down"},{"l":"Conversão (%)","v":"94.4%","t":"+16.6%","d":"up"},{"l":"AOV (€)","v":"€41811","t":"+0.4%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 41574.57","5.454","4.430","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 39237.08","7.506","267","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 34969.64","7.471","3.754","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 20631.78","3.708","542","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 37936.71","2.062","3.609","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":502},{"label":"Fev","value":696},{"label":"Mar","value":648},{"label":"Abr","value":811},{"label":"Mai","value":763},{"label":"Jun","value":632},{"label":"Jul","value":756},{"label":"Ago","value":809},{"label":"Set","value":679},{"label":"Out","value":507},{"label":"Nov","value":735},{"label":"Dez","value":802}];
const MX = 811;
