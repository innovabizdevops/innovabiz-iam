...
const ACCENT = "#0e7490";
const MODULE = "Investor Relations";
const PAGE = "Peer Benchmarking";
const KPIS = [{"l":"Total Investor Relations","v":"2.299","t":"+11.3%","d":"up"},{"l":"Peer Benchmarking Ativos","v":"4.404","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"90.1%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"81","t":"+9.8%","d":"up"}];
const COLS = ["ID","Peer Benchmarking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Investor Relations #001","Investor Relations #002","486","703","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Investor Relations #002","Investor Relations #003","784","8.654","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Investor Relations #003","Investor Relations #004","4.750","3.079","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Investor Relations #004","Investor Relations #005","8.116","3.398","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Investor Relations #005","Investor Relations #001","2.856","8.720","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":725},{"label":"Mar","value":708},{"label":"Abr","value":574},{"label":"Mai","value":466},{"label":"Jun","value":386},{"label":"Jul","value":662},{"label":"Ago","value":571},{"label":"Set","value":425},{"label":"Out","value":620},{"label":"Nov","value":522},{"label":"Dez","value":592}];
const MX = 725;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0e7490'}}>AI</span></h1>
                </div>
