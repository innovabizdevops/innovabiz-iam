...
const PAGE = "AGM Management";
const KPIS = [{"l":"Projetos Melhoria","v":"3.267","t":"+16.0%","d":"up"},{"l":"Savings (€)","v":"€38691","t":"+17.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"76.8%","t":"-5.5%","d":"down"},{"l":"Ciclos PDCA","v":"3.934","t":"-1.4%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.424","€ 26441.02","9.013","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.883","€ 18251.24","3.741","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.639","€ 17092.09","5.380","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.298","€ 46689.32","1.018","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.934","€ 9690.95","7.698","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":600},{"label":"Mar","value":489},{"label":"Abr","value":480},{"label":"Mai","value":711},{"label":"Jun","value":787},{"label":"Jul","value":835},{"label":"Ago","value":669},{"label":"Set","value":856},{"label":"Out","value":843},{"label":"Nov","value":595},{"label":"Dez","value":554}];
const MX = 856;
