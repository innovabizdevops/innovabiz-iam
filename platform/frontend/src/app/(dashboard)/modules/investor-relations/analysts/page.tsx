...
const PAGE = "Analyst Coverage";
const KPIS = [{"l":"Dashboards Ativos","v":"4.949","t":"-3.2%","d":"down"},{"l":"Queries/Dia","v":"2093","t":"+6.0%","d":"up"},{"l":"Dados Processados (GB)","v":"7.254","t":"+14.9%","d":"up"},{"l":"Utilizadores Analytics","v":"1.311","t":"+5.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","388","2026-01-01","6.919","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1027","2026-03-01","1.385","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1540","2026-02-28","4.135","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4367","2026-03-08","340","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3243","2026-02-25","3.592","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":488},{"label":"Mar","value":473},{"label":"Abr","value":617},{"label":"Mai","value":611},{"label":"Jun","value":446},{"label":"Jul","value":355},{"label":"Ago","value":508},{"label":"Set","value":414},{"label":"Out","value":643},{"label":"Nov","value":673},{"label":"Dez","value":438}];
const MX = 673;
