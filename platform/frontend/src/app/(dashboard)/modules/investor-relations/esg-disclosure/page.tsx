...
const PAGE = "ESG Disclosure";
const KPIS = [{"l":"Total Investor Relations","v":"4.185","t":"+8.4%","d":"up"},{"l":"ESG Disclosure Ativos","v":"6.862","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"78.7%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"73","t":"-0.7%","d":"down"}];
const COLS = ["ID","ESG Disclosure","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Investor Relations #001","Investor Relations #002","5.574","2.074","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Investor Relations #002","Investor Relations #003","6.409","1.825","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Investor Relations #003","Investor Relations #004","3.062","4.442","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Investor Relations #004","Investor Relations #005","7.930","4.458","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Investor Relations #005","Investor Relations #001","5.895","727","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":239},{"label":"Fev","value":258},{"label":"Mar","value":551},{"label":"Abr","value":506},{"label":"Mai","value":577},{"label":"Jun","value":575},{"label":"Jul","value":363},{"label":"Ago","value":340},{"label":"Set","value":328},{"label":"Out","value":402},{"label":"Nov","value":456},{"label":"Dez","value":229}];
const MX = 577;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0e7490'}}>ESG</span></h1>
                </div>
