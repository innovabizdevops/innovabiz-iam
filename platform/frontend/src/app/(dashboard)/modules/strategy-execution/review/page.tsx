...
const PAGE = "Review";
const KPIS = [{"l":"Total Strategy Execution","v":"1.481","t":"-3.0%","d":"down"},{"l":"Review Ativos","v":"2.580","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"83.9%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"69","t":"+1.1%","d":"up"}];
const COLS = ["ID","Review","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategy Execution #001","Strategy Execution #002","3.949","2.151","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Strategy Execution #002","Strategy Execution #003","2.607","5.928","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategy Execution #003","Strategy Execution #004","1.673","8.098","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Strategy Execution #004","Strategy Execution #005","6.355","4.755","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategy Execution #005","Strategy Execution #001","3.762","5.341","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":494},{"label":"Mar","value":644},{"label":"Abr","value":743},{"label":"Mai","value":459},{"label":"Jun","value":759},{"label":"Jul","value":707},{"label":"Ago","value":790},{"label":"Set","value":734},{"label":"Out","value":639},{"label":"Nov","value":441},{"label":"Dez","value":527}];
const MX = 790;
