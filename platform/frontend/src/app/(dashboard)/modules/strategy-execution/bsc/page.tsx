...
const PAGE = "BSC";
const KPIS = [{"l":"Total Strategy Execution","v":"4.391","t":"+12.5%","d":"up"},{"l":"BSC Ativos","v":"4.216","t":"+2.8%","d":"up"},{"l":"Eficiência (%)","v":"78.7%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"79","t":"-2.6%","d":"down"}];
const COLS = ["ID","BSC","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategy Execution #001","Strategy Execution #002","3.458","7.794","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Strategy Execution #002","Strategy Execution #003","8.571","8.845","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategy Execution #003","Strategy Execution #004","1.024","907","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Strategy Execution #004","Strategy Execution #005","8.589","1.398","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategy Execution #005","Strategy Execution #001","7.588","7.762","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":346},{"label":"Fev","value":403},{"label":"Mar","value":676},{"label":"Abr","value":349},{"label":"Mai","value":390},{"label":"Jun","value":284},{"label":"Jul","value":595},{"label":"Ago","value":323},{"label":"Set","value":490},{"label":"Out","value":579},{"label":"Nov","value":333},{"label":"Dez","value":326}];
const MX = 676;
