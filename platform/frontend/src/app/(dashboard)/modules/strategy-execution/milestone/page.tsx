...
const KPIS = [{"l":"Total Strategy Execution","v":"1.970","t":"+5.5%","d":"up"},{"l":"Milestone Ativos","v":"4.253","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"85.1%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"61","t":"+16.7%","d":"up"}];
const COLS = ["ID","Milestone","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategy Execution #001","Strategy Execution #002","8.007","5.931","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Strategy Execution #002","Strategy Execution #003","7.467","4.275","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategy Execution #003","Strategy Execution #004","4.888","6.202","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Strategy Execution #004","Strategy Execution #005","4.013","7.386","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategy Execution #005","Strategy Execution #001","2.862","3.601","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":503},{"label":"Fev","value":677},{"label":"Mar","value":550},{"label":"Abr","value":658},{"label":"Mai","value":484},{"label":"Jun","value":598},{"label":"Jul","value":355},{"label":"Ago","value":431},{"label":"Set","value":669},{"label":"Out","value":555},{"label":"Nov","value":679},{"label":"Dez","value":503}];
const MX = 679;
