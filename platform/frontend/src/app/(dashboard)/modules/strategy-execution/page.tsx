...
/* ═══ Strategy Execution & BSC — Dashboard ═══ */

const ACCENT = "#1d4ed8";

const KPIS = [
    { label: "Total Registos", value: "6977", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "488", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€35K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1615271077", cells: ["STR-6077", "Strategy Execution & BSC Item 1", "22/2/2026", "€21 177"], status: "active" as const },
    { id: "1615274648", cells: ["STR-9648", "Strategy Execution & BSC Item 2", "9/9/2026", "€24 748"], status: "pending" as const },
    { id: "1615278219", cells: ["STR-4219", "Strategy Execution & BSC Item 3", "24/4/2026", "€28 319"], status: "completed" as const },
    { id: "1615281790", cells: ["STR-7790", "Strategy Execution & BSC Item 4", "11/11/2026", "€31 890"], status: "warning" as const },
    { id: "1615285361", cells: ["STR-2361", "Strategy Execution & BSC Item 5", "26/6/2026", "€35 461"], status: "active" as const },
];
...
export default function StrategyExecutionBscPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Strategy Execution & BSC</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Strategy Execution & BSC</p>
                    </div>
                </div>
