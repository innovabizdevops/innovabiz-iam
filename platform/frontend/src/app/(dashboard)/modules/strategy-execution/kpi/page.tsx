...
const PAGE = "KPI Tree";
const KPIS = [{"l":"Total Strategy Execution","v":"882","t":"+0.1%","d":"up"},{"l":"KPI Tree Ativos","v":"5.706","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"72.0%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"58","t":"+8.8%","d":"up"}];
const COLS = ["ID","KPI Tree","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategy Execution #001","Strategy Execution #002","8.959","7.029","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Strategy Execution #002","Strategy Execution #003","8.224","7.836","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategy Execution #003","Strategy Execution #004","9.061","5.345","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Strategy Execution #004","Strategy Execution #005","1.619","3.870","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategy Execution #005","Strategy Execution #001","6.483","7.257","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":632},{"label":"Mar","value":711},{"label":"Abr","value":637},{"label":"Mai","value":795},{"label":"Jun","value":628},{"label":"Jul","value":730},{"label":"Ago","value":642},{"label":"Set","value":680},{"label":"Out","value":832},{"label":"Nov","value":813},{"label":"Dez","value":914}];
const MX = 914;
