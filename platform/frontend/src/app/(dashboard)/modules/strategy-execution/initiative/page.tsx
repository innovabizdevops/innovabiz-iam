...
const ACCENT = "#1d4ed8";
const MODULE = "Strategy Execution & BSC";
const PAGE = "Initiative";
const KPIS = [{"l":"Total Strategy Execution","v":"3.539","t":"-2.4%","d":"down"},{"l":"Initiative Ativos","v":"7.850","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"75.7%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"69","t":"+1.6%","d":"up"}];
const COLS = ["ID","Initiative","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategy Execution #001","Strategy Execution #002","6.256","7.118","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Strategy Execution #002","Strategy Execution #003","2.528","8.223","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategy Execution #003","Strategy Execution #004","7.866","2.354","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Strategy Execution #004","Strategy Execution #005","7.158","6.870","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategy Execution #005","Strategy Execution #001","3.588","8.177","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":932},{"label":"Fev","value":660},{"label":"Mar","value":653},{"label":"Abr","value":831},{"label":"Mai","value":746},{"label":"Jun","value":620},{"label":"Jul","value":813},{"label":"Ago","value":932},{"label":"Set","value":894},{"label":"Out","value":676},{"label":"Nov","value":858},{"label":"Dez","value":903}];
const MX = 932;
