...
const PAGE = "Ingest";
const KPIS = [{"l":"Total Dam Deep","v":"3.799","t":"+8.2%","d":"up"},{"l":"Ingest Ativos","v":"3.763","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"70.6%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"68","t":"+13.3%","d":"up"}];
const COLS = ["ID","Ingest","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dam Deep #001","Dam Deep #002","3.677","4.663","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Dam Deep #002","Dam Deep #003","4.593","5.497","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Dam Deep #003","Dam Deep #004","3.708","2.212","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Dam Deep #004","Dam Deep #005","4.789","2.450","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dam Deep #005","Dam Deep #001","6.373","8.434","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":766},{"label":"Mar","value":900},{"label":"Abr","value":669},{"label":"Mai","value":679},{"label":"Jun","value":916},{"label":"Jul","value":799},{"label":"Ago","value":804},{"label":"Set","value":897},{"label":"Out","value":1039},{"label":"Nov","value":931},{"label":"Dez","value":934}];
const MX = 1039;
