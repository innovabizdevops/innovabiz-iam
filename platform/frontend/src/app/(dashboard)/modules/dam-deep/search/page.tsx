...
const PAGE = "Search";
const KPIS = [{"l":"Total Dam Deep","v":"1.468","t":"+9.7%","d":"up"},{"l":"Search Ativos","v":"2.115","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"75.4%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"88","t":"+10.3%","d":"up"}];
const COLS = ["ID","Search","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dam Deep #001","Dam Deep #002","5.290","8.982","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Dam Deep #002","Dam Deep #003","1.450","7.034","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Dam Deep #003","Dam Deep #004","5.466","7.379","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Dam Deep #004","Dam Deep #005","165","5.077","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dam Deep #005","Dam Deep #001","359","7.202","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":791},{"label":"Mar","value":744},{"label":"Abr","value":810},{"label":"Mai","value":792},{"label":"Jun","value":553},{"label":"Jul","value":636},{"label":"Ago","value":624},{"label":"Set","value":496},{"label":"Out","value":768},{"label":"Nov","value":544},{"label":"Dez","value":513}];
const MX = 810;
