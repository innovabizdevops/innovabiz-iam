...
const KPIS = [{"l":"Formulários Ativos","v":"2.994","t":"+6.4%","d":"up"},{"l":"Submissões/Dia","v":"1362","t":"+11.6%","d":"up"},{"l":"Documentos Gerados","v":"5.534","t":"+14.7%","d":"up"},{"l":"Templates","v":"6.089","t":"+6.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.147","2026-03-16","7.838","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.139","2026-03-14","7.798","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.269","2026-03-14","1.403","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.601","2026-02-13","6.882","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.128","2026-03-21","3.810","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":466},{"label":"Mar","value":817},{"label":"Abr","value":555},{"label":"Mai","value":741},{"label":"Jun","value":646},{"label":"Jul","value":443},{"label":"Ago","value":525},{"label":"Set","value":539},{"label":"Out","value":757},{"label":"Nov","value":428},{"label":"Dez","value":476}];
const MX = 817;
