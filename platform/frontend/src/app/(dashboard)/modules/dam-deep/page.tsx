...
/* ═══ Digital Asset Management Deep — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "2036", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4242", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€131K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "614118736", cells: ["DAM-4736", "Digital Asset Management Deep Item 1", "1/5/2026", "€18 836"], status: "active" as const },
    { id: "614122307", cells: ["DAM-8307", "Digital Asset Management Deep Item 2", "16/12/2026", "€22 407"], status: "pending" as const },
    { id: "614125878", cells: ["DAM-2878", "Digital Asset Management Deep Item 3", "3/7/2026", "€25 978"], status: "completed" as const },
    { id: "614129449", cells: ["DAM-6449", "Digital Asset Management Deep Item 4", "18/2/2026", "€29 549"], status: "warning" as const },
    { id: "614133020", cells: ["DAM-1020", "Digital Asset Management Deep Item 5", "5/9/2026", "€33 120"], status: "active" as const },
];
...
export default function DigitalAssetManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Digital Asset Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Digital Asset Management Deep</p>
                    </div>
                </div>
