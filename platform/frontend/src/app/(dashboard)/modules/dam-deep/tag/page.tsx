...
const ACCENT = "#6d28d9";
const MODULE = "Digital Asset Management Deep";
const PAGE = "Tag";
const KPIS = [{"l":"Total Dam Deep","v":"3.507","t":"+9.9%","d":"up"},{"l":"Tag Ativos","v":"4.464","t":"+7.5%","d":"up"},{"l":"Eficiência (%)","v":"69.5%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"76","t":"-4.2%","d":"down"}];
const COLS = ["ID","Tag","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dam Deep #001","Dam Deep #002","5.268","805","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Dam Deep #002","Dam Deep #003","1.490","2.910","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Dam Deep #003","Dam Deep #004","4.478","4.648","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Dam Deep #004","Dam Deep #005","4.531","8.991","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dam Deep #005","Dam Deep #001","474","7.374","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":977},{"label":"Fev","value":905},{"label":"Mar","value":821},{"label":"Abr","value":829},{"label":"Mai","value":1013},{"label":"Jun","value":906},{"label":"Jul","value":882},{"label":"Ago","value":746},{"label":"Set","value":891},{"label":"Out","value":1012},{"label":"Nov","value":1019},{"label":"Dez","value":715}];
const MX = 1019;
