...
const ACCENT = "#b91c1c";
const MODULE = "Wound Care Center";
const PAGE = "Photo Track";
const KPIS = [{"l":"Total Wound Care","v":"7.317","t":"+14.7%","d":"up"},{"l":"Photo Track Ativos","v":"6.246","t":"+14.3%","d":"up"},{"l":"Eficiência (%)","v":"65.9%","t":"+1.5%","d":"up"},{"l":"Score Performance","v":"80","t":"+13.1%","d":"up"}];
const COLS = ["ID","Photo Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wound Care #001","Wound Care #002","7.090","2.402","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Wound Care #002","Wound Care #003","168","412","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Wound Care #003","Wound Care #004","2.429","8.247","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Wound Care #004","Wound Care #005","6.815","4.091","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wound Care #005","Wound Care #001","7.605","5.780","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":721},{"label":"Fev","value":534},{"label":"Mar","value":912},{"label":"Abr","value":589},{"label":"Mai","value":656},{"label":"Jun","value":690},{"label":"Jul","value":642},{"label":"Ago","value":807},{"label":"Set","value":784},{"label":"Out","value":778},{"label":"Nov","value":925},{"label":"Dez","value":855}];
const MX = 925;
