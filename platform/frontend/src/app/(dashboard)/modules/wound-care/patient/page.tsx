...
const PAGE = "Patient";
const KPIS = [{"l":"Total Wound Care","v":"9.054","t":"+2.8%","d":"up"},{"l":"Patient Ativos","v":"7.801","t":"-5.3%","d":"down"},{"l":"Eficiência (%)","v":"84.3%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"72","t":"+17.1%","d":"up"}];
const COLS = ["ID","Patient","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wound Care #001","Wound Care #002","4.278","3.935","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Wound Care #002","Wound Care #003","1.236","3.617","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Wound Care #003","Wound Care #004","5.704","1.638","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Wound Care #004","Wound Care #005","1.814","2.695","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wound Care #005","Wound Care #001","2.837","5.773","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":928},{"label":"Fev","value":949},{"label":"Mar","value":627},{"label":"Abr","value":728},{"label":"Mai","value":985},{"label":"Jun","value":877},{"label":"Jul","value":738},{"label":"Ago","value":908},{"label":"Set","value":701},{"label":"Out","value":763},{"label":"Nov","value":696},{"label":"Dez","value":904}];
const MX = 985;
