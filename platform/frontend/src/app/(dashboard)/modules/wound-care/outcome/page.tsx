...
const PAGE = "Outcome";
const KPIS = [{"l":"Total Wound Care","v":"4.031","t":"-5.1%","d":"down"},{"l":"Outcome Ativos","v":"4.345","t":"+0.8%","d":"up"},{"l":"Eficiência (%)","v":"84.9%","t":"+4.2%","d":"up"},{"l":"Score Performance","v":"76","t":"+4.1%","d":"up"}];
const COLS = ["ID","Outcome","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wound Care #001","Wound Care #002","7.638","8.073","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Wound Care #002","Wound Care #003","1.544","8.997","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Wound Care #003","Wound Care #004","8.505","3.700","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Wound Care #004","Wound Care #005","3.605","6.644","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wound Care #005","Wound Care #001","2.824","662","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":378},{"label":"Fev","value":503},{"label":"Mar","value":472},{"label":"Abr","value":427},{"label":"Mai","value":638},{"label":"Jun","value":603},{"label":"Jul","value":375},{"label":"Ago","value":639},{"label":"Set","value":550},{"label":"Out","value":539},{"label":"Nov","value":370},{"label":"Dez","value":605}];
const MX = 639;
