...
/* ═══ Wound Care Center — Dashboard ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total Registos", value: "4802", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3999", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€495K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1324852402", cells: ["WOU-8402", "Wound Care Center Item 1", "7/11/2026", "€2502"], status: "active" as const },
    { id: "1324855973", cells: ["WOU-2973", "Wound Care Center Item 2", "22/6/2026", "€6073"], status: "pending" as const },
    { id: "1324859544", cells: ["WOU-6544", "Wound Care Center Item 3", "9/1/2026", "€9644"], status: "completed" as const },
    { id: "1324863115", cells: ["WOU-1115", "Wound Care Center Item 4", "24/8/2026", "€13 215"], status: "warning" as const },
    { id: "1324866686", cells: ["WOU-4686", "Wound Care Center Item 5", "11/3/2026", "€16 786"], status: "active" as const },
];
...
export default function WoundCareCenterPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wound Care Center</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Wound Care Center</p>
                    </div>
                </div>
