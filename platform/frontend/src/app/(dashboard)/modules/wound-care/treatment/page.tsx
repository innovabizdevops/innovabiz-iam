...
const KPIS = [{"l":"Total Wound Care","v":"2.388","t":"+6.0%","d":"up"},{"l":"Treatment Ativos","v":"5.517","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"69.6%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"88","t":"+13.5%","d":"up"}];
const COLS = ["ID","Treatment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wound Care #001","Wound Care #002","8.085","1.427","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Wound Care #002","Wound Care #003","8.616","8.497","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Wound Care #003","Wound Care #004","3.169","2.705","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Wound Care #004","Wound Care #005","6.213","3.815","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wound Care #005","Wound Care #001","3.788","2.742","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":737},{"label":"Mar","value":784},{"label":"Abr","value":731},{"label":"Mai","value":742},{"label":"Jun","value":651},{"label":"Jul","value":572},{"label":"Ago","value":802},{"label":"Set","value":699},{"label":"Out","value":555},{"label":"Nov","value":775},{"label":"Dez","value":666}];
const MX = 802;
