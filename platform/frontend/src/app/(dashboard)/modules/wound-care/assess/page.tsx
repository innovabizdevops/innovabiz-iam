...
const PAGE = "Assess";
const KPIS = [{"l":"Total Wound Care","v":"841","t":"+0.3%","d":"up"},{"l":"Assess Ativos","v":"2.904","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"88.4%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"77","t":"-5.3%","d":"down"}];
const COLS = ["ID","Assess","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wound Care #001","Wound Care #002","3.507","5.559","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Wound Care #002","Wound Care #003","7.460","4.415","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Wound Care #003","Wound Care #004","5.826","7.987","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Wound Care #004","Wound Care #005","4.323","2.497","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wound Care #005","Wound Care #001","5.958","7.734","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":939},{"label":"Mar","value":757},{"label":"Abr","value":569},{"label":"Mai","value":855},{"label":"Jun","value":934},{"label":"Jul","value":783},{"label":"Ago","value":704},{"label":"Set","value":719},{"label":"Out","value":740},{"label":"Nov","value":645},{"label":"Dez","value":827}];
const MX = 939;
