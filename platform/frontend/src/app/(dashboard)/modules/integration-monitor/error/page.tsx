...
const PAGE = "Error";
const KPIS = [{"l":"Integrações Ativas","v":"6.467","t":"+10.3%","d":"up"},{"l":"Chamadas/Hora","v":"4839","t":"+12.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.6%","t":"+12.3%","d":"up"},{"l":"Latência Média (ms)","v":"111ms","t":"-0.9%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.262","5.581","96.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.561","3.928","74.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.107","1.518","93.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.460","5.548","99.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","216","4.539","93.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":702},{"label":"Mar","value":741},{"label":"Abr","value":659},{"label":"Mai","value":466},{"label":"Jun","value":485},{"label":"Jul","value":457},{"label":"Ago","value":516},{"label":"Set","value":604},{"label":"Out","value":511},{"label":"Nov","value":436},{"label":"Dez","value":541}];
const MX = 741;
