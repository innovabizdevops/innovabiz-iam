...
const PAGE = "Replay";
const KPIS = [{"l":"Integrações Ativas","v":"1.786","t":"-5.6%","d":"down"},{"l":"Chamadas/Hora","v":"3158","t":"-5.0%","d":"down"},{"l":"Taxa Sucesso (%)","v":"80.6%","t":"-3.3%","d":"down"},{"l":"Latência Média (ms)","v":"145ms","t":"+2.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.721","5.164","97.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.387","1.796","96.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.754","7.630","86.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.923","7.756","93.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.780","3.411","84.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":435},{"label":"Fev","value":328},{"label":"Mar","value":416},{"label":"Abr","value":526},{"label":"Mai","value":589},{"label":"Jun","value":511},{"label":"Jul","value":448},{"label":"Ago","value":642},{"label":"Set","value":540},{"label":"Out","value":572},{"label":"Nov","value":429},{"label":"Dez","value":362}];
const MX = 642;
