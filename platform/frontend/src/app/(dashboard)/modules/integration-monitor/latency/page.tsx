...
const PAGE = "Latency";
const KPIS = [{"l":"Integrações Ativas","v":"4.701","t":"+14.0%","d":"up"},{"l":"Chamadas/Hora","v":"1335","t":"+6.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.2%","t":"+13.4%","d":"up"},{"l":"Latência Média (ms)","v":"30ms","t":"+10.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.455","5.076","97.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.167","4.368","91.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.693","5.849","78.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.044","1.411","77.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.227","2.566","86.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":987},{"label":"Fev","value":767},{"label":"Mar","value":990},{"label":"Abr","value":898},{"label":"Mai","value":935},{"label":"Jun","value":794},{"label":"Jul","value":1035},{"label":"Ago","value":956},{"label":"Set","value":858},{"label":"Out","value":975},{"label":"Nov","value":746},{"label":"Dez","value":769}];
const MX = 1035;
