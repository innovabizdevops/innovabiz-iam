...
const KPIS = [{"l":"Integrações Ativas","v":"1.244","t":"+18.0%","d":"up"},{"l":"Chamadas/Hora","v":"932","t":"-4.7%","d":"down"},{"l":"Taxa Sucesso (%)","v":"68.0%","t":"+16.3%","d":"up"},{"l":"Latência Média (ms)","v":"105ms","t":"+13.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.662","1.301","98.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.493","7.100","87.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","207","7.610","72.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.208","815","73.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.902","463","96.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":404},{"label":"Fev","value":252},{"label":"Mar","value":624},{"label":"Abr","value":493},{"label":"Mai","value":308},{"label":"Jun","value":264},{"label":"Jul","value":278},{"label":"Ago","value":472},{"label":"Set","value":633},{"label":"Out","value":435},{"label":"Nov","value":540},{"label":"Dez","value":281}];
const MX = 633;
