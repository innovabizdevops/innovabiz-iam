...
const ACCENT = "#22c55e";
const MODULE = "Integration Monitor";
const PAGE = "Health";
const KPIS = [{"l":"Integrações Ativas","v":"7.478","t":"+16.4%","d":"up"},{"l":"Chamadas/Hora","v":"162","t":"+16.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.8%","t":"+3.7%","d":"up"},{"l":"Latência Média (ms)","v":"191ms","t":"+8.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.335","7.143","94.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.383","7.597","84.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","270","4.100","81.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.967","2.482","95.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.740","1.666","90.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":764},{"label":"Fev","value":507},{"label":"Mar","value":690},{"label":"Abr","value":705},{"label":"Mai","value":606},{"label":"Jun","value":602},{"label":"Jul","value":464},{"label":"Ago","value":491},{"label":"Set","value":486},{"label":"Out","value":436},{"label":"Nov","value":707},{"label":"Dez","value":424}];
const MX = 764;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#22c55e'}}>RTM</span></h1>
                </div>
