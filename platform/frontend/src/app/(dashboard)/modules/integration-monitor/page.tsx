...
const KPIS = [
    { label: "Total Registos", value: "344", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3391", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€478K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1733044744", cells: ["INT-5744", "Integration Monitor Item 1", "5/5/2026", "€44 844"], status: "active" as const },
    { id: "1733048315", cells: ["INT-9315", "Integration Monitor Item 2", "20/12/2026", "€48 415"], status: "pending" as const },
    { id: "1733051886", cells: ["INT-3886", "Integration Monitor Item 3", "7/7/2026", "€1986"], status: "completed" as const },
    { id: "1733055457", cells: ["INT-7457", "Integration Monitor Item 4", "22/2/2026", "€5557"], status: "warning" as const },
    { id: "1733059028", cells: ["INT-2028", "Integration Monitor Item 5", "9/9/2026", "€9128"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Integration Monitor</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Integration Monitor</p>
                    </div>
                </div>
