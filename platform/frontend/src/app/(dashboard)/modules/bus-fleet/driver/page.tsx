...
const PAGE = "Driver";
const KPIS = [{"l":"Integrações Ativas","v":"6.329","t":"+10.9%","d":"up"},{"l":"Chamadas/Hora","v":"1123","t":"+0.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"93.7%","t":"-4.8%","d":"down"},{"l":"Latência Média (ms)","v":"168ms","t":"+9.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.241","3.591","80.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.605","6.273","77.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","271","2.885","73.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.733","5.288","81.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.134","3.374","91.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":761},{"label":"Mar","value":678},{"label":"Abr","value":757},{"label":"Mai","value":488},{"label":"Jun","value":428},{"label":"Jul","value":484},{"label":"Ago","value":416},{"label":"Set","value":543},{"label":"Out","value":368},{"label":"Nov","value":417},{"label":"Dez","value":663}];
const MX = 761;
