...
const KPIS = [{"l":"Integrações Ativas","v":"4.546","t":"-5.0%","d":"down"},{"l":"Chamadas/Hora","v":"2990","t":"+1.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.1%","t":"-2.1%","d":"down"},{"l":"Latência Média (ms)","v":"110ms","t":"+0.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.792","174","74.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.737","4.202","96.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.761","2.860","71.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.470","5.607","76.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.492","8.026","93.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":395},{"label":"Mar","value":429},{"label":"Abr","value":568},{"label":"Mai","value":311},{"label":"Jun","value":467},{"label":"Jul","value":260},{"label":"Ago","value":244},{"label":"Set","value":577},{"label":"Out","value":419},{"label":"Nov","value":587},{"label":"Dez","value":444}];
const MX = 587;
