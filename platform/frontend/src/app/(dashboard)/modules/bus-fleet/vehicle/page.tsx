...
const PAGE = "Vehicle";
const KPIS = [{"l":"Integrações Ativas","v":"6.748","t":"+1.9%","d":"up"},{"l":"Chamadas/Hora","v":"504","t":"+11.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.5%","t":"-5.4%","d":"down"},{"l":"Latência Média (ms)","v":"188ms","t":"+11.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.551","9.001","98.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","749","5.104","83.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.330","254","92.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","9.081","5.354","86.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.180","562","88.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":341},{"label":"Fev","value":640},{"label":"Mar","value":459},{"label":"Abr","value":577},{"label":"Mai","value":580},{"label":"Jun","value":450},{"label":"Jul","value":443},{"label":"Ago","value":581},{"label":"Set","value":363},{"label":"Out","value":410},{"label":"Nov","value":628},{"label":"Dez","value":472}];
const MX = 640;
