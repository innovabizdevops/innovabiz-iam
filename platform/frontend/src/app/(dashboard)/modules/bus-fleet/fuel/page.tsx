...
const ACCENT = "#0284c7";
const MODULE = "Bus Fleet Management";
const PAGE = "Fuel";
const KPIS = [{"l":"Integrações Ativas","v":"578","t":"+1.9%","d":"up"},{"l":"Chamadas/Hora","v":"2096","t":"+11.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.2%","t":"+12.1%","d":"up"},{"l":"Latência Média (ms)","v":"54ms","t":"-4.4%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.465","8.135","88.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.624","8.940","76.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","447","5.965","97.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.714","5.333","89.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.633","8.009","72.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":760},{"label":"Fev","value":521},{"label":"Mar","value":632},{"label":"Abr","value":566},{"label":"Mai","value":759},{"label":"Jun","value":691},{"label":"Jul","value":774},{"label":"Ago","value":669},{"label":"Set","value":709},{"label":"Out","value":575},{"label":"Nov","value":588},{"label":"Dez","value":677}];
const MX = 774;
