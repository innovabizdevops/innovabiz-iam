...
const PAGE = "Route";
const KPIS = [{"l":"Integrações Ativas","v":"6.933","t":"+12.4%","d":"up"},{"l":"Chamadas/Hora","v":"1425","t":"-0.5%","d":"down"},{"l":"Taxa Sucesso (%)","v":"76.3%","t":"+9.8%","d":"up"},{"l":"Latência Média (ms)","v":"37ms","t":"+2.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.504","3.738","75.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.387","8.092","88.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.923","7.328","87.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.690","1.437","81.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.895","4.764","97.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":631},{"label":"Mar","value":533},{"label":"Abr","value":611},{"label":"Mai","value":521},{"label":"Jun","value":519},{"label":"Jul","value":390},{"label":"Ago","value":509},{"label":"Set","value":591},{"label":"Out","value":568},{"label":"Nov","value":443},{"label":"Dez","value":469}];
const MX = 664;
