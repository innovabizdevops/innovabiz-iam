...
const PAGE = "Ship";
const KPIS = [{"l":"Total Parcel Mgmt","v":"7.311","t":"+6.1%","d":"up"},{"l":"Ship Ativos","v":"7.482","t":"+6.8%","d":"up"},{"l":"Eficiência (%)","v":"81.4%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"88","t":"-4.4%","d":"down"}];
const COLS = ["ID","Ship","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Parcel Mgmt #001","Parcel Mgmt #002","7.030","543","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Parcel Mgmt #002","Parcel Mgmt #003","6.940","3.173","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Parcel Mgmt #003","Parcel Mgmt #004","4.527","7.133","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Parcel Mgmt #004","Parcel Mgmt #005","3.166","1.574","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Parcel Mgmt #005","Parcel Mgmt #001","8.536","6.820","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":682},{"label":"Mar","value":858},{"label":"Abr","value":752},{"label":"Mai","value":568},{"label":"Jun","value":552},{"label":"Jul","value":679},{"label":"Ago","value":530},{"label":"Set","value":831},{"label":"Out","value":485},{"label":"Nov","value":550},{"label":"Dez","value":780}];
const MX = 858;
