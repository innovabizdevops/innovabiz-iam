...
const PAGE = "Label";
const KPIS = [{"l":"Total Parcel Mgmt","v":"2.418","t":"+9.1%","d":"up"},{"l":"Label Ativos","v":"3.081","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"78.1%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"86","t":"+4.9%","d":"up"}];
const COLS = ["ID","Label","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Parcel Mgmt #001","Parcel Mgmt #002","3.425","1.455","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Parcel Mgmt #002","Parcel Mgmt #003","3.356","2.769","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Parcel Mgmt #003","Parcel Mgmt #004","2.752","269","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Parcel Mgmt #004","Parcel Mgmt #005","5.357","1.214","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Parcel Mgmt #005","Parcel Mgmt #001","8.498","2.714","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":453},{"label":"Mar","value":400},{"label":"Abr","value":684},{"label":"Mai","value":702},{"label":"Jun","value":449},{"label":"Jul","value":590},{"label":"Ago","value":491},{"label":"Set","value":766},{"label":"Out","value":382},{"label":"Nov","value":511},{"label":"Dez","value":692}];
const MX = 766;
