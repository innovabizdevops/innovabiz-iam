...
const PAGE = "Track";
const KPIS = [{"l":"Total Parcel Mgmt","v":"2.684","t":"+2.7%","d":"up"},{"l":"Track Ativos","v":"2.853","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"91.4%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"93","t":"-1.0%","d":"down"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Parcel Mgmt #001","Parcel Mgmt #002","8.108","1.918","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Parcel Mgmt #002","Parcel Mgmt #003","9.053","2.329","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Parcel Mgmt #003","Parcel Mgmt #004","6.546","1.225","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Parcel Mgmt #004","Parcel Mgmt #005","3.524","6.833","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Parcel Mgmt #005","Parcel Mgmt #001","6.726","5.142","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":398},{"label":"Fev","value":240},{"label":"Mar","value":314},{"label":"Abr","value":313},{"label":"Mai","value":546},{"label":"Jun","value":456},{"label":"Jul","value":328},{"label":"Ago","value":277},{"label":"Set","value":578},{"label":"Out","value":437},{"label":"Nov","value":483},{"label":"Dez","value":510}];
const MX = 578;
