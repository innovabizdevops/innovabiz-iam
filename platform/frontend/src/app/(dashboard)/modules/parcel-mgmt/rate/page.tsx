...
const ACCENT = "#6366f1";
const MODULE = "Parcel Management";
const PAGE = "Rate";
const KPIS = [{"l":"Total Parcel Mgmt","v":"5.589","t":"-4.7%","d":"down"},{"l":"Rate Ativos","v":"6.495","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"74.1%","t":"+4.7%","d":"up"},{"l":"Score Performance","v":"79","t":"+11.7%","d":"up"}];
const COLS = ["ID","Rate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Parcel Mgmt #001","Parcel Mgmt #002","3.462","892","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Parcel Mgmt #002","Parcel Mgmt #003","3.843","5.138","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Parcel Mgmt #003","Parcel Mgmt #004","3.427","7.041","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Parcel Mgmt #004","Parcel Mgmt #005","5.913","2.505","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Parcel Mgmt #005","Parcel Mgmt #001","7.609","1.115","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":768},{"label":"Mar","value":525},{"label":"Abr","value":644},{"label":"Mai","value":620},{"label":"Jun","value":642},{"label":"Jul","value":847},{"label":"Ago","value":678},{"label":"Set","value":792},{"label":"Out","value":819},{"label":"Nov","value":692},{"label":"Dez","value":810}];
const MX = 847;
