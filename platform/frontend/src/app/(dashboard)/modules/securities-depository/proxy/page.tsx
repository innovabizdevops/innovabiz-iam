...
const ACCENT = "#0891b2";
const MODULE = "Depositário Valores";
const PAGE = "Proxy Vote";
const KPIS = [{"l":"Pedidos/Dia","v":"454","t":"-2.1%","d":"down"},{"l":"GMV (€)","v":"€57798","t":"-3.9%","d":"down"},{"l":"Conversão (%)","v":"65.4%","t":"-5.0%","d":"down"},{"l":"AOV (€)","v":"€82728","t":"+1.1%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 5598.22","881","5.308","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 6037.01","455","6.464","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 24645.27","1.253","3.604","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 23393.72","2.901","2.088","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 43902.01","7.128","3.475","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":1025},{"label":"Mar","value":1071},{"label":"Abr","value":1013},{"label":"Mai","value":900},{"label":"Jun","value":848},{"label":"Jul","value":941},{"label":"Ago","value":1074},{"label":"Set","value":828},{"label":"Out","value":993},{"label":"Nov","value":813},{"label":"Dez","value":743}];
const MX = 1074;
