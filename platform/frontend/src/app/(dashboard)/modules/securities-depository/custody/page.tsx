...
const PAGE = "Custody";
const KPIS = [{"l":"Pedidos/Dia","v":"366","t":"-1.0%","d":"down"},{"l":"GMV (€)","v":"€26142","t":"+8.0%","d":"up"},{"l":"Conversão (%)","v":"69.0%","t":"+8.1%","d":"up"},{"l":"AOV (€)","v":"€36361","t":"+5.3%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 16300.92","1.054","4.983","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 16233.50","4.031","5.268","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 44800.54","6.634","6.860","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 33550.18","1.000","9.061","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 19789.10","7.431","344","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":648},{"label":"Mar","value":734},{"label":"Abr","value":851},{"label":"Mai","value":806},{"label":"Jun","value":974},{"label":"Jul","value":966},{"label":"Ago","value":647},{"label":"Set","value":843},{"label":"Out","value":998},{"label":"Nov","value":1010},{"label":"Dez","value":887}];
const MX = 1010;
