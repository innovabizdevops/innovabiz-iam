...
/* ═══ Depositário Valores — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "7486", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2535", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€63K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "-19%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1438457586", cells: ["SEC-6586", "Depositário Valores Item 1", "7/7/2026", "€7686"], status: "active" as const },
    { id: "1438461157", cells: ["SEC-1157", "Depositário Valores Item 2", "22/2/2026", "€11 257"], status: "pending" as const },
    { id: "1438464728", cells: ["SEC-4728", "Depositário Valores Item 3", "9/9/2026", "€14 828"], status: "completed" as const },
    { id: "1438468299", cells: ["SEC-8299", "Depositário Valores Item 4", "24/4/2026", "€18 399"], status: "warning" as const },
    { id: "1438471870", cells: ["SEC-2870", "Depositário Valores Item 5", "11/11/2026", "€21 970"], status: "active" as const },
];
...
export default function DepositrioValoresPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Depositário Valores</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Depositário Valores</p>
                    </div>
                </div>
