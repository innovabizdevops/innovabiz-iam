...
const ACCENT = "#6366f1";
const MODULE = "Proof of Delivery";
const PAGE = "Photo POD";
const KPIS = [{"l":"Total Proof Of Delivery","v":"6.053","t":"+10.0%","d":"up"},{"l":"Photo POD Ativos","v":"3.456","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+13.2%","d":"up"},{"l":"Score Performance","v":"57","t":"+3.6%","d":"up"}];
const COLS = ["ID","Photo POD","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Proof Of Delivery #001","Proof Of Delivery #002","833","2.830","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Proof Of Delivery #002","Proof Of Delivery #003","6.853","1.424","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Proof Of Delivery #003","Proof Of Delivery #004","2.873","3.520","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Proof Of Delivery #004","Proof Of Delivery #005","4.501","2.319","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Proof Of Delivery #005","Proof Of Delivery #001","5.522","6.150","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":560},{"label":"Mar","value":628},{"label":"Abr","value":727},{"label":"Mai","value":836},{"label":"Jun","value":697},{"label":"Jul","value":532},{"label":"Ago","value":708},{"label":"Set","value":871},{"label":"Out","value":847},{"label":"Nov","value":690},{"label":"Dez","value":830}];
const MX = 871;
