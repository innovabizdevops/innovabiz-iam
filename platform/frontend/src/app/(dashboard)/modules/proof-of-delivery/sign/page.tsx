...
const KPIS = [{"l":"Formulários Ativos","v":"3.071","t":"-4.1%","d":"down"},{"l":"Submissões/Dia","v":"2489","t":"+1.1%","d":"up"},{"l":"Documentos Gerados","v":"7.898","t":"+3.5%","d":"up"},{"l":"Templates","v":"8.167","t":"+13.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.331","2026-03-05","4.412","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.497","2026-01-09","2.171","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.587","2026-02-21","1.087","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.760","2026-03-10","4.580","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.780","2026-01-19","6.393","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":802},{"label":"Mar","value":537},{"label":"Abr","value":554},{"label":"Mai","value":849},{"label":"Jun","value":493},{"label":"Jul","value":688},{"label":"Ago","value":871},{"label":"Set","value":527},{"label":"Out","value":784},{"label":"Nov","value":511},{"label":"Dez","value":589}];
const MX = 871;
