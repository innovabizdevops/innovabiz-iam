...
const PAGE = "GPS Stamp";
const KPIS = [{"l":"Total Proof Of Delivery","v":"5.802","t":"+5.7%","d":"up"},{"l":"GPS Stamp Ativos","v":"5.352","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"87.3%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"88","t":"+0.3%","d":"up"}];
const COLS = ["ID","GPS Stamp","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Proof Of Delivery #001","Proof Of Delivery #002","1.322","7.766","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Proof Of Delivery #002","Proof Of Delivery #003","8.216","2.583","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Proof Of Delivery #003","Proof Of Delivery #004","5.618","8.497","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Proof Of Delivery #004","Proof Of Delivery #005","5.837","7.865","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Proof Of Delivery #005","Proof Of Delivery #001","2.998","2.075","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":332},{"label":"Fev","value":640},{"label":"Mar","value":302},{"label":"Abr","value":548},{"label":"Mai","value":621},{"label":"Jun","value":600},{"label":"Jul","value":332},{"label":"Ago","value":412},{"label":"Set","value":400},{"label":"Out","value":575},{"label":"Nov","value":598},{"label":"Dez","value":339}];
const MX = 640;
