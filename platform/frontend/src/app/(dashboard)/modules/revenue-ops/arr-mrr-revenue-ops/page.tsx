...
const PAGE = "ARR/MRR Tracker";
const KPIS = [{"l":"ARR (€M)","v":"€29.2M","t":"+11.9%","d":"up"},{"l":"MRR (€)","v":"€44479","t":"+8.1%","d":"up"},{"l":"Churn (%)","v":"92.0%","t":"+5.1%","d":"up"},{"l":"ARPU (€)","v":"€86035","t":"+2.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 45336.12","1.934","€ 46622.94","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 48124.33","5.997","€ 18637.15","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 33930.69","2.615","€ 41067.42","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 14255.42","5.726","€ 4214.73","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 25587.38","3.281","€ 19146.22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":650},{"label":"Mar","value":709},{"label":"Abr","value":477},{"label":"Mai","value":837},{"label":"Jun","value":583},{"label":"Jul","value":781},{"label":"Ago","value":526},{"label":"Set","value":786},{"label":"Out","value":814},{"label":"Nov","value":521},{"label":"Dez","value":590}];
const MX = 837;
...
export default function ArrMrrRevenueOpsPage() {
    return (
