...
const KPIS = [{"l":"ARR (€M)","v":"€3.6M","t":"+8.1%","d":"up"},{"l":"MRR (€)","v":"€90090","t":"+9.1%","d":"up"},{"l":"Churn (%)","v":"76.8%","t":"+2.2%","d":"up"},{"l":"ARPU (€)","v":"€66967","t":"+7.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 40346.55","2.542","€ 46790.87","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 35163.97","430","€ 6712.47","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 19200.57","1.539","€ 15019.76","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 45157.88","4.894","€ 4392.32","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 7368.02","2.519","€ 30203.25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":613},{"label":"Mar","value":951},{"label":"Abr","value":645},{"label":"Mai","value":986},{"label":"Jun","value":925},{"label":"Jul","value":917},{"label":"Ago","value":745},{"label":"Set","value":720},{"label":"Out","value":988},{"label":"Nov","value":953},{"label":"Dez","value":774}];
const MX = 988;
