...
const PAGE = "Usage Metering";
const KPIS = [{"l":"ARR (€M)","v":"€23.3M","t":"+10.4%","d":"up"},{"l":"MRR (€)","v":"€52471","t":"-5.1%","d":"down"},{"l":"Churn (%)","v":"77.1%","t":"+0.8%","d":"up"},{"l":"ARPU (€)","v":"€52108","t":"+4.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 8667.30","3.040","€ 38888.24","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 1309.63","7.635","€ 23142.15","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 37472.50","1.874","€ 39547.04","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 23844.40","5.904","€ 31807.36","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 12090.49","4.376","€ 15506.99","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":256},{"label":"Mar","value":434},{"label":"Abr","value":258},{"label":"Mai","value":558},{"label":"Jun","value":372},{"label":"Jul","value":627},{"label":"Ago","value":627},{"label":"Set","value":602},{"label":"Out","value":507},{"label":"Nov","value":249},{"label":"Dez","value":518}];
const MX = 639;
