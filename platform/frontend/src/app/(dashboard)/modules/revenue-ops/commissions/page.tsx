...
const PAGE = "Commission Calc";
const KPIS = [{"l":"Vendas YTD (€)","v":"€25373","t":"-1.3%","d":"down"},{"l":"Pipeline (€)","v":"€24266","t":"-5.3%","d":"down"},{"l":"Atingimento Quota (%)","v":"82.6%","t":"+5.2%","d":"up"},{"l":"Win Rate (%)","v":"91.1%","t":"-3.8%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 27810.12","€ 32922.07","€ 4040.53","83.5%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 17985.50","€ 29017.56","€ 26280.21","94.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 44407.83","€ 28709.17","€ 38497.42","85.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 47707.17","€ 9986.21","€ 23044.31","96.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 37827.95","€ 45092.40","€ 24941.05","87.8%"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":598},{"label":"Mar","value":758},{"label":"Abr","value":696},{"label":"Mai","value":402},{"label":"Jun","value":529},{"label":"Jul","value":459},{"label":"Ago","value":618},{"label":"Set","value":686},{"label":"Out","value":520},{"label":"Nov","value":784},{"label":"Dez","value":621}];
const MX = 784;
