...
const KPIS = [{"l":"ARR (€M)","v":"€14.1M","t":"+9.9%","d":"up"},{"l":"MRR (€)","v":"€45245","t":"-4.4%","d":"down"},{"l":"Churn (%)","v":"93.9%","t":"+7.0%","d":"up"},{"l":"ARPU (€)","v":"€45048","t":"+18.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 25692.05","1.864","€ 20761.77","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 40282.77","4.601","€ 6843.64","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 3109.39","7.746","€ 20391.58","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 32223.88","5.935","€ 23042.73","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 49755.97","8.760","€ 441.58","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":806},{"label":"Mar","value":909},{"label":"Abr","value":830},{"label":"Mai","value":712},{"label":"Jun","value":843},{"label":"Jul","value":862},{"label":"Ago","value":818},{"label":"Set","value":871},{"label":"Out","value":657},{"label":"Nov","value":890},{"label":"Dez","value":763}];
const MX = 909;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ca8a04'}}>ASC 606</span></h1>
                </div>
