...
const PAGE = "Sales Velocity";
const KPIS = [{"l":"Vendas YTD (€)","v":"€71958","t":"+10.5%","d":"up"},{"l":"Pipeline (€)","v":"€87647","t":"-3.8%","d":"down"},{"l":"Atingimento Quota (%)","v":"90.2%","t":"+6.5%","d":"up"},{"l":"Win Rate (%)","v":"84.2%","t":"+3.8%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 6551.81","€ 37761.14","€ 33207.81","92.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 7112.99","€ 24747.29","€ 10497.17","98.5%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 34451.44","€ 42440.62","€ 1991.64","80.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 5686.48","€ 49752.57","€ 39541.44","74.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 24872.27","€ 12996.52","€ 5526.04","72.5%"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":593},{"label":"Mar","value":475},{"label":"Abr","value":625},{"label":"Mai","value":435},{"label":"Jun","value":492},{"label":"Jul","value":738},{"label":"Ago","value":730},{"label":"Set","value":703},{"label":"Out","value":549},{"label":"Nov","value":688},{"label":"Dez","value":819}];
const MX = 819;
