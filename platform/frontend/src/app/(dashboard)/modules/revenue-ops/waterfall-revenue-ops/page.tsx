...
const ACCENT = "#ca8a04";
const MODULE = "Revenue Operations";
const PAGE = "Revenue Waterfall";
const KPIS = [{"l":"ARR (€M)","v":"€40.9M","t":"+8.8%","d":"up"},{"l":"MRR (€)","v":"€27754","t":"+11.9%","d":"up"},{"l":"Churn (%)","v":"78.1%","t":"+11.3%","d":"up"},{"l":"ARPU (€)","v":"€69685","t":"+9.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 12179.39","784","€ 17416.68","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 4255.54","2.362","€ 46117.59","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 27326.48","482","€ 25465.34","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 2444.36","7.405","€ 36321.83","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 35458.55","8.024","€ 3651.24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":537},{"label":"Fev","value":771},{"label":"Mar","value":526},{"label":"Abr","value":854},{"label":"Mai","value":569},{"label":"Jun","value":779},{"label":"Jul","value":819},{"label":"Ago","value":570},{"label":"Set","value":796},{"label":"Out","value":869},{"label":"Nov","value":785},{"label":"Dez","value":656}];
const MX = 869;
...
export default function WaterfallRevenueOpsPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ca8a04'}}>Chart</span></h1>
                </div>
