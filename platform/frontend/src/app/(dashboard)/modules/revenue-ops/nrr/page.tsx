...
const PAGE = "Net Revenue Retention";
const KPIS = [{"l":"ARR (€M)","v":"€37.9M","t":"+11.7%","d":"up"},{"l":"MRR (€)","v":"€87128","t":"-1.7%","d":"down"},{"l":"Churn (%)","v":"74.3%","t":"+8.2%","d":"up"},{"l":"ARPU (€)","v":"€32666","t":"-5.8%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 25418.96","4.987","€ 33715.10","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 5992.93","8.659","€ 20365.67","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 36293.05","1.470","€ 8963.69","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 27575.88","5.215","€ 7961.33","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 34141.80","4.824","€ 24872.09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":932},{"label":"Fev","value":742},{"label":"Mar","value":848},{"label":"Abr","value":931},{"label":"Mai","value":981},{"label":"Jun","value":713},{"label":"Jul","value":797},{"label":"Ago","value":826},{"label":"Set","value":766},{"label":"Out","value":902},{"label":"Nov","value":846},{"label":"Dez","value":996}];
const MX = 996;
