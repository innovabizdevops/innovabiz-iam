...
const KPIS = [{"l":"ARR (€M)","v":"€17.4M","t":"-3.6%","d":"down"},{"l":"MRR (€)","v":"€67506","t":"+11.4%","d":"up"},{"l":"Churn (%)","v":"65.6%","t":"+14.8%","d":"up"},{"l":"ARPU (€)","v":"€47765","t":"+1.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 25584.65","4.188","€ 43818.95","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 6248.44","4.361","€ 31031.86","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 19095.62","2.949","€ 26374.67","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 38990.71","5.074","€ 24894.17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 41539.74","8.815","€ 4097.05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":541},{"label":"Mar","value":333},{"label":"Abr","value":333},{"label":"Mai","value":559},{"label":"Jun","value":338},{"label":"Jul","value":707},{"label":"Ago","value":506},{"label":"Set","value":445},{"label":"Out","value":352},{"label":"Nov","value":401},{"label":"Dez","value":436}];
const MX = 707;
