...
const PAGE = "Cohort Analysis";
const KPIS = [{"l":"ARR (€M)","v":"€39.2M","t":"+9.9%","d":"up"},{"l":"MRR (€)","v":"€62879","t":"+0.0%","d":"up"},{"l":"Churn (%)","v":"82.8%","t":"+3.8%","d":"up"},{"l":"ARPU (€)","v":"€3213","t":"+4.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 30952.22","436","€ 652.02","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 19712.24","2.344","€ 48503.83","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 1446.21","5.471","€ 45623.81","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 35460.66","1.164","€ 990.96","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 11939.80","105","€ 27743.73","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":753},{"label":"Mar","value":661},{"label":"Abr","value":774},{"label":"Mai","value":777},{"label":"Jun","value":670},{"label":"Jul","value":767},{"label":"Ago","value":772},{"label":"Set","value":803},{"label":"Out","value":811},{"label":"Nov","value":595},{"label":"Dez","value":795}];
const MX = 811;
