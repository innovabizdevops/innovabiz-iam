...
const PAGE = "Territory Planning";
const KPIS = [{"l":"Vendas YTD (€)","v":"€20265","t":"+5.3%","d":"up"},{"l":"Pipeline (€)","v":"€64636","t":"-1.0%","d":"down"},{"l":"Atingimento Quota (%)","v":"65.1%","t":"+14.6%","d":"up"},{"l":"Win Rate (%)","v":"72.8%","t":"+7.2%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 14799.37","€ 197.92","€ 5094.94","90.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 39569.29","€ 36490.99","€ 36365.45","95.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 17328.62","€ 45774.40","€ 22954.63","74.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 21057.95","€ 49716.08","€ 15777.62","81.7%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 45702.35","€ 9749.46","€ 15567.00","82.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":873},{"label":"Fev","value":655},{"label":"Mar","value":824},{"label":"Abr","value":602},{"label":"Mai","value":676},{"label":"Jun","value":856},{"label":"Jul","value":880},{"label":"Ago","value":697},{"label":"Set","value":887},{"label":"Out","value":931},{"label":"Nov","value":607},{"label":"Dez","value":593}];
const MX = 931;
