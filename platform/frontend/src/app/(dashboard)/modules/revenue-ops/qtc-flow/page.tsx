...
const PAGE = "Quote-to-Cash Flow";
const KPIS = [{"l":"ARR (€M)","v":"€44.9M","t":"-0.2%","d":"down"},{"l":"MRR (€)","v":"€40375","t":"+3.0%","d":"up"},{"l":"Churn (%)","v":"94.5%","t":"+10.7%","d":"up"},{"l":"ARPU (€)","v":"€23643","t":"+12.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 6178.18","7.855","€ 27747.49","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 8501.69","7.872","€ 29897.21","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 43552.70","7.778","€ 36652.43","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 18872.67","6.933","€ 6271.76","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 30337.44","2.962","€ 27238.79","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":923},{"label":"Fev","value":846},{"label":"Mar","value":994},{"label":"Abr","value":801},{"label":"Mai","value":733},{"label":"Jun","value":801},{"label":"Jul","value":663},{"label":"Ago","value":1033},{"label":"Set","value":707},{"label":"Out","value":838},{"label":"Nov","value":827},{"label":"Dez","value":775}];
const MX = 1033;
...
export default function QtcFlowPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ca8a04'}}>BPMN</span></h1>
                </div>
