...
const PAGE = "Pricing Optimizer AI";
const KPIS = [{"l":"ARR (€M)","v":"€15.0M","t":"+8.7%","d":"up"},{"l":"MRR (€)","v":"€86880","t":"+2.0%","d":"up"},{"l":"Churn (%)","v":"74.1%","t":"-2.7%","d":"down"},{"l":"ARPU (€)","v":"€19061","t":"+4.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 29442.72","3.488","€ 26516.24","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 11059.34","8.479","€ 186.75","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 38354.64","8.841","€ 4348.86","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 31214.99","2.011","€ 22055.64","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 17556.10","7.489","€ 30005.53","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":407},{"label":"Mar","value":379},{"label":"Abr","value":591},{"label":"Mai","value":336},{"label":"Jun","value":683},{"label":"Jul","value":554},{"label":"Ago","value":594},{"label":"Set","value":503},{"label":"Out","value":356},{"label":"Nov","value":623},{"label":"Dez","value":651}];
const MX = 683;
