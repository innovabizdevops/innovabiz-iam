...
const PAGE = "ARR/MRR Tracking";
const KPIS = [{"l":"ARR (€M)","v":"€9.0M","t":"+4.9%","d":"up"},{"l":"MRR (€)","v":"€23451","t":"+4.4%","d":"up"},{"l":"Churn (%)","v":"76.0%","t":"+4.6%","d":"up"},{"l":"ARPU (€)","v":"€66938","t":"+2.4%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 22001.15","2.762","€ 3968.09","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 40301.49","8.518","€ 8016.46","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 22369.73","4.798","€ 30194.98","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 46767.20","2.488","€ 32580.87","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 5342.98","8.039","€ 43317.03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":647},{"label":"Mar","value":336},{"label":"Abr","value":535},{"label":"Mai","value":641},{"label":"Jun","value":527},{"label":"Jul","value":518},{"label":"Ago","value":613},{"label":"Set","value":474},{"label":"Out","value":567},{"label":"Nov","value":631},{"label":"Dez","value":389}];
const MX = 647;
...
export default function ArrMrrPage() {
    return (
