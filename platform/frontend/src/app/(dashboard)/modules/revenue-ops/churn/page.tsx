...
const PAGE = "Churn Analysis AI";
const KPIS = [{"l":"ARR (€M)","v":"€3.4M","t":"+0.1%","d":"up"},{"l":"MRR (€)","v":"€36805","t":"-1.7%","d":"down"},{"l":"Churn (%)","v":"81.9%","t":"-5.5%","d":"down"},{"l":"ARPU (€)","v":"€65164","t":"+0.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 5009.71","1.314","€ 16964.52","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 48395.41","4.509","€ 18428.67","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 30280.74","3.094","€ 2783.80","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 33375.67","8.052","€ 43927.97","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 40655.45","2.600","€ 6704.41","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":277},{"label":"Fev","value":630},{"label":"Mar","value":418},{"label":"Abr","value":450},{"label":"Mai","value":534},{"label":"Jun","value":473},{"label":"Jul","value":347},{"label":"Ago","value":257},{"label":"Set","value":402},{"label":"Out","value":457},{"label":"Nov","value":464},{"label":"Dez","value":511}];
const MX = 630;
