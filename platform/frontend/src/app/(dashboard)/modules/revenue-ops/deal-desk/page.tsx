...
const KPIS = [{"l":"ARR (€M)","v":"€30.0M","t":"+17.7%","d":"up"},{"l":"MRR (€)","v":"€80968","t":"+4.3%","d":"up"},{"l":"Churn (%)","v":"82.0%","t":"-2.2%","d":"down"},{"l":"ARPU (€)","v":"€44755","t":"-1.9%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 16846.81","1.900","€ 4363.18","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 38129.81","1.360","€ 650.63","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 18783.13","5.580","€ 35543.16","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 38840.80","1.516","€ 10871.57","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 28915.29","4.891","€ 28153.17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":632},{"label":"Mar","value":589},{"label":"Abr","value":644},{"label":"Mai","value":821},{"label":"Jun","value":723},{"label":"Jul","value":818},{"label":"Ago","value":601},{"label":"Set","value":622},{"label":"Out","value":706},{"label":"Nov","value":962},{"label":"Dez","value":636}];
const MX = 962;
