...
const KPIS = [{"l":"ARR (€M)","v":"€25.9M","t":"+5.8%","d":"up"},{"l":"MRR (€)","v":"€23713","t":"+8.2%","d":"up"},{"l":"Churn (%)","v":"80.4%","t":"+11.7%","d":"up"},{"l":"ARPU (€)","v":"€87041","t":"+15.4%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 30398.71","5.879","€ 40196.78","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 44856.45","2.200","€ 45863.02","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 39572.68","6.207","€ 2888.68","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 6383.98","266","€ 16419.24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 41650.16","7.110","€ 9285.64","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":643},{"label":"Mar","value":748},{"label":"Abr","value":474},{"label":"Mai","value":618},{"label":"Jun","value":706},{"label":"Jul","value":582},{"label":"Ago","value":622},{"label":"Set","value":708},{"label":"Out","value":754},{"label":"Nov","value":594},{"label":"Dez","value":676}];
const MX = 754;
