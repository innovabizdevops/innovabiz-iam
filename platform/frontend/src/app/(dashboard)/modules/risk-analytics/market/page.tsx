...
const PAGE = "Market";
const KPIS = [{"l":"Riscos Identificados","v":"7.112","t":"+3.9%","d":"up"},{"l":"Mitigações Ativas","v":"3.632","t":"+4.5%","d":"up"},{"l":"Score Risco Geral","v":"86","t":"+14.0%","d":"up"},{"l":"Incidentes YTD","v":"994","t":"+8.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.058","7.920","5.532","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.958","8.705","8.311","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.513","1.141","8.589","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.057","216","7.804","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.851","219","172","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":860},{"label":"Fev","value":885},{"label":"Mar","value":800},{"label":"Abr","value":804},{"label":"Mai","value":951},{"label":"Jun","value":703},{"label":"Jul","value":836},{"label":"Ago","value":729},{"label":"Set","value":647},{"label":"Out","value":941},{"label":"Nov","value":814},{"label":"Dez","value":894}];
const MX = 951;
