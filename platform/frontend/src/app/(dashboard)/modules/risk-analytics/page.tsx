...
/* ═══ Risk Analytics Deep — Dashboard ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total Registos", value: "3233", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4168", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€407K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "638978833", cells: ["RIS-6833", "Risk Analytics Deep Item 1", "18/2/2026", "€28 933"], status: "active" as const },
    { id: "638982404", cells: ["RIS-1404", "Risk Analytics Deep Item 2", "5/9/2026", "€32 504"], status: "pending" as const },
    { id: "638985975", cells: ["RIS-4975", "Risk Analytics Deep Item 3", "20/4/2026", "€36 075"], status: "completed" as const },
    { id: "638989546", cells: ["RIS-8546", "Risk Analytics Deep Item 4", "7/11/2026", "€39 646"], status: "warning" as const },
    { id: "638993117", cells: ["RIS-3117", "Risk Analytics Deep Item 5", "22/6/2026", "€43 217"], status: "active" as const },
];
...
export default function RiskAnalyticsDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Risk Analytics Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Risk Analytics Deep</p>
                    </div>
                </div>
