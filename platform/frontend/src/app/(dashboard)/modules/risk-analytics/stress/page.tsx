...
const PAGE = "Stress";
const KPIS = [{"l":"Riscos Identificados","v":"8.219","t":"+13.6%","d":"up"},{"l":"Mitigações Ativas","v":"6.052","t":"+13.9%","d":"up"},{"l":"Score Risco Geral","v":"94","t":"-3.7%","d":"down"},{"l":"Incidentes YTD","v":"7.739","t":"+1.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.285","572","8.895","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.397","2.795","2.880","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.079","3.249","536","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.150","291","2.212","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.820","5.626","233","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":715},{"label":"Fev","value":555},{"label":"Mar","value":625},{"label":"Abr","value":639},{"label":"Mai","value":859},{"label":"Jun","value":753},{"label":"Jul","value":831},{"label":"Ago","value":753},{"label":"Set","value":888},{"label":"Out","value":595},{"label":"Nov","value":748},{"label":"Dez","value":637}];
const MX = 888;
