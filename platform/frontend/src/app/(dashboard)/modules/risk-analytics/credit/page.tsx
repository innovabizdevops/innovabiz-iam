...
const ACCENT = "#4338ca";
const MODULE = "Risk Analytics Deep";
const PAGE = "Credit";
const KPIS = [{"l":"Riscos Identificados","v":"7.493","t":"+4.0%","d":"up"},{"l":"Mitigações Ativas","v":"7.022","t":"+6.4%","d":"up"},{"l":"Score Risco Geral","v":"92","t":"+12.1%","d":"up"},{"l":"Incidentes YTD","v":"3.240","t":"+0.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.182","2.266","2.473","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.563","5.640","6.117","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.013","7.026","8.686","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","841","1.291","1.837","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.198","2.549","5.837","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":676},{"label":"Mar","value":532},{"label":"Abr","value":611},{"label":"Mai","value":389},{"label":"Jun","value":369},{"label":"Jul","value":357},{"label":"Ago","value":512},{"label":"Set","value":688},{"label":"Out","value":700},{"label":"Nov","value":374},{"label":"Dez","value":479}];
const MX = 700;
