...
const PAGE = "Operational";
const KPIS = [{"l":"Riscos Identificados","v":"8.903","t":"+6.0%","d":"up"},{"l":"Mitigações Ativas","v":"8.634","t":"+5.3%","d":"up"},{"l":"Score Risco Geral","v":"58","t":"+3.3%","d":"up"},{"l":"Incidentes YTD","v":"408","t":"-5.6%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.076","1.201","5.742","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.740","5.898","6.788","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.844","2.500","7.296","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.902","2.295","5.202","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.768","1.753","5.796","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":860},{"label":"Mar","value":492},{"label":"Abr","value":681},{"label":"Mai","value":649},{"label":"Jun","value":695},{"label":"Jul","value":656},{"label":"Ago","value":764},{"label":"Set","value":806},{"label":"Out","value":724},{"label":"Nov","value":829},{"label":"Dez","value":853}];
const MX = 860;
