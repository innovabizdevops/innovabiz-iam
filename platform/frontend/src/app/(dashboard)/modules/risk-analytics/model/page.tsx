...
const PAGE = "Model";
const KPIS = [{"l":"Riscos Identificados","v":"5.942","t":"+1.8%","d":"up"},{"l":"Mitigações Ativas","v":"8.178","t":"-2.5%","d":"down"},{"l":"Score Risco Geral","v":"66","t":"+13.0%","d":"up"},{"l":"Incidentes YTD","v":"3.257","t":"+3.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.177","5.639","2.400","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","801","3.820","7.910","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.788","3.788","556","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.091","798","6.987","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","994","1.393","2.112","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":622},{"label":"Mar","value":587},{"label":"Abr","value":556},{"label":"Mai","value":428},{"label":"Jun","value":550},{"label":"Jul","value":614},{"label":"Ago","value":542},{"label":"Set","value":570},{"label":"Out","value":509},{"label":"Nov","value":446},{"label":"Dez","value":609}];
const MX = 622;
