...
/* ═══ Safety Incident Management — Dashboard ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total Registos", value: "7212", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3894", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€371K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2080046612", cells: ["SAF-3612", "Safety Incident Management Item 1", "1/9/2026", "€46 712"], status: "active" as const },
    { id: "2080050183", cells: ["SAF-7183", "Safety Incident Management Item 2", "16/4/2026", "€283"], status: "pending" as const },
    { id: "2080053754", cells: ["SAF-1754", "Safety Incident Management Item 3", "3/11/2026", "€3854"], status: "completed" as const },
    { id: "2080057325", cells: ["SAF-5325", "Safety Incident Management Item 4", "18/6/2026", "€7425"], status: "warning" as const },
    { id: "2080060896", cells: ["SAF-8896", "Safety Incident Management Item 5", "5/1/2026", "€10 996"], status: "active" as const },
];
...
export default function SafetyIncidentManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Safety Incident Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Safety Incident Management</p>
                    </div>
                </div>
