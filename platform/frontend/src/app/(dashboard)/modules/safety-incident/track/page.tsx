...
const PAGE = "Track";
const KPIS = [{"l":"Tickets Abertos","v":"4.954","t":"-0.5%","d":"down"},{"l":"SLA Cumprido (%)","v":"65.8%","t":"+16.6%","d":"up"},{"l":"MTTR (h)","v":"136h","t":"+10.0%","d":"up"},{"l":"Satisfação (%)","v":"69.2%","t":"+13.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.224","628","7.866","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.192","3.083","2.305","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.153","181","4.657","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.293","5.343","2.364","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","568","214","1.625","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":905},{"label":"Fev","value":605},{"label":"Mar","value":861},{"label":"Abr","value":654},{"label":"Mai","value":945},{"label":"Jun","value":686},{"label":"Jul","value":730},{"label":"Ago","value":742},{"label":"Set","value":580},{"label":"Out","value":826},{"label":"Nov","value":679},{"label":"Dez","value":629}];
const MX = 945;
