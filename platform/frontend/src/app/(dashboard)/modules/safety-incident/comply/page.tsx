...
const PAGE = "Comply";
const KPIS = [{"l":"Tickets Abertos","v":"6.695","t":"+14.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"79.7%","t":"+4.6%","d":"up"},{"l":"MTTR (h)","v":"115h","t":"+1.5%","d":"up"},{"l":"Satisfação (%)","v":"65.4%","t":"-1.1%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.188","1.431","4.847","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.301","4.528","794","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.574","5.691","3.706","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.520","1.529","4.391","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.762","982","7.147","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":664},{"label":"Mar","value":1005},{"label":"Abr","value":813},{"label":"Mai","value":639},{"label":"Jun","value":663},{"label":"Jul","value":816},{"label":"Ago","value":679},{"label":"Set","value":647},{"label":"Out","value":648},{"label":"Nov","value":934},{"label":"Dez","value":888}];
const MX = 1005;
