...
const PAGE = "Report";
const KPIS = [{"l":"Tickets Abertos","v":"8.179","t":"-4.1%","d":"down"},{"l":"SLA Cumprido (%)","v":"83.9%","t":"+13.9%","d":"up"},{"l":"MTTR (h)","v":"77h","t":"+12.5%","d":"up"},{"l":"Satisfação (%)","v":"72.1%","t":"+7.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.959","8.401","5.630","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.104","6.595","8.636","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.262","2.288","2.004","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","472","748","5.906","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.452","3.679","4.458","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":376},{"label":"Fev","value":529},{"label":"Mar","value":719},{"label":"Abr","value":521},{"label":"Mai","value":472},{"label":"Jun","value":599},{"label":"Jul","value":463},{"label":"Ago","value":388},{"label":"Set","value":477},{"label":"Out","value":432},{"label":"Nov","value":441},{"label":"Dez","value":606}];
const MX = 719;
