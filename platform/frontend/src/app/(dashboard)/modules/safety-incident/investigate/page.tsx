...
const ACCENT = "#b45309";
const MODULE = "Safety Incident Management";
const PAGE = "Investigate";
const KPIS = [{"l":"Tickets Abertos","v":"5.556","t":"+6.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"86.5%","t":"+3.9%","d":"up"},{"l":"MTTR (h)","v":"154h","t":"+12.5%","d":"up"},{"l":"Satisfação (%)","v":"85.2%","t":"+1.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.240","1.385","7.795","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.490","2.701","955","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.819","649","4.338","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.049","7.900","309","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.076","3.669","2.813","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":483},{"label":"Mar","value":502},{"label":"Abr","value":501},{"label":"Mai","value":567},{"label":"Jun","value":613},{"label":"Jul","value":385},{"label":"Ago","value":507},{"label":"Set","value":644},{"label":"Out","value":475},{"label":"Nov","value":558},{"label":"Dez","value":691}];
const MX = 691;
