...
const PAGE = "Evaluate";
const KPIS = [{"l":"Fornecedores Ativos","v":"1.322","t":"+9.6%","d":"up"},{"l":"Contratos (€M)","v":"€28.5M","t":"+11.8%","d":"up"},{"l":"On-Time Delivery (%)","v":"91.9%","t":"+3.3%","d":"up"},{"l":"Score Médio","v":"73","t":"+4.2%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","73.0%","€ 29377.68","8.157","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","95.6%","€ 4295.42","3.420","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","83.5%","€ 16815.96","2.510","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","88.3%","€ 6542.87","1.342","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","84.6%","€ 13639.18","7.369","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":834},{"label":"Mar","value":657},{"label":"Abr","value":744},{"label":"Mai","value":610},{"label":"Jun","value":521},{"label":"Jul","value":583},{"label":"Ago","value":801},{"label":"Set","value":846},{"label":"Out","value":623},{"label":"Nov","value":617},{"label":"Dez","value":714}];
const MX = 846;
