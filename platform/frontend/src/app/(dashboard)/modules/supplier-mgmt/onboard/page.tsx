...
const PAGE = "Onboard";
const KPIS = [{"l":"eNPS","v":"67","t":"-5.2%","d":"down"},{"l":"Engagement (%)","v":"94.0%","t":"+2.1%","d":"up"},{"l":"Turnover (%)","v":"82.6%","t":"+17.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.091","t":"+8.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.735","2026-01-04","57","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.588","2026-03-22","60","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.880","2026-01-03","59","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.992","2026-03-16","79","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.745","2026-01-11","71","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":964},{"label":"Fev","value":790},{"label":"Mar","value":1002},{"label":"Abr","value":784},{"label":"Mai","value":1025},{"label":"Jun","value":994},{"label":"Jul","value":1025},{"label":"Ago","value":724},{"label":"Set","value":818},{"label":"Out","value":975},{"label":"Nov","value":1054},{"label":"Dez","value":832}];
const MX = 1054;
