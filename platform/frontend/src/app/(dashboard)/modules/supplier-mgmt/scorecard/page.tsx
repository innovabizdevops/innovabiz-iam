...
const PAGE = "Scorecard";
const KPIS = [{"l":"Fornecedores Ativos","v":"4.314","t":"+2.8%","d":"up"},{"l":"Contratos (€M)","v":"€24.1M","t":"+8.1%","d":"up"},{"l":"On-Time Delivery (%)","v":"81.7%","t":"+6.8%","d":"up"},{"l":"Score Médio","v":"55","t":"-1.6%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","80.6%","€ 28936.94","2.655","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","81.3%","€ 37196.06","3.848","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","70.9%","€ 12975.31","794","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","81.6%","€ 20950.33","6.851","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","74.6%","€ 22889.15","3.028","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":813},{"label":"Fev","value":769},{"label":"Mar","value":971},{"label":"Abr","value":919},{"label":"Mai","value":717},{"label":"Jun","value":953},{"label":"Jul","value":781},{"label":"Ago","value":843},{"label":"Set","value":904},{"label":"Out","value":816},{"label":"Nov","value":822},{"label":"Dez","value":728}];
const MX = 971;
