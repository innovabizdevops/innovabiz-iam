...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"4.483","t":"+15.4%","d":"up"},{"l":"Mitigações Ativas","v":"1.968","t":"+12.6%","d":"up"},{"l":"Score Risco Geral","v":"80","t":"+15.0%","d":"up"},{"l":"Incidentes YTD","v":"1.099","t":"+8.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.089","6.600","8.011","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.437","3.214","4.717","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.675","3.171","8.805","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.148","5.036","3.412","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.936","1.766","4.628","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":915},{"label":"Fev","value":912},{"label":"Mar","value":1004},{"label":"Abr","value":726},{"label":"Mai","value":720},{"label":"Jun","value":825},{"label":"Jul","value":640},{"label":"Ago","value":1017},{"label":"Set","value":728},{"label":"Out","value":995},{"label":"Nov","value":767},{"label":"Dez","value":847}];
const MX = 1017;
