...
/* ═══ COSMOS Event Mesh — Dashboard ═══ */

const ACCENT = "#1e1b4b";

const KPIS = [
    { label: "Total Registos", value: "994", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1813", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€135K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1052578794", cells: ["COS-2794", "COSMOS Event Mesh Item 1", "23/7/2026", "€28 894"], status: "active" as const },
    { id: "1052582365", cells: ["COS-6365", "COSMOS Event Mesh Item 2", "10/2/2026", "€32 465"], status: "pending" as const },
    { id: "1052585936", cells: ["COS-9936", "COSMOS Event Mesh Item 3", "25/9/2026", "€36 036"], status: "completed" as const },
    { id: "1052589507", cells: ["COS-4507", "COSMOS Event Mesh Item 4", "12/4/2026", "€39 607"], status: "warning" as const },
    { id: "1052593078", cells: ["COS-8078", "COSMOS Event Mesh Item 5", "27/11/2026", "€43 178"], status: "active" as const },
];
...
export default function CosmosEventMeshPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">COSMOS Event Mesh</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • COSMOS Event Mesh</p>
                    </div>
                </div>
