...
const PAGE = "Replay";
const KPIS = [{"l":"Eventos Planeados","v":"8.609","t":"+3.8%","d":"up"},{"l":"Participantes","v":"1.911","t":"+15.6%","d":"up"},{"l":"NPS Evento","v":"73","t":"-0.5%","d":"down"},{"l":"Receita (€)","v":"€64886","t":"+17.9%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-27","4.593","488","€ 3637.90","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-23","951","4.635","€ 11679.68","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-06","8.497","4.175","€ 28460.50","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-27","3.606","5.062","€ 33773.25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-15","1.856","3.797","€ 748.91","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":535},{"label":"Mar","value":703},{"label":"Abr","value":642},{"label":"Mai","value":775},{"label":"Jun","value":628},{"label":"Jul","value":527},{"label":"Ago","value":624},{"label":"Set","value":480},{"label":"Out","value":561},{"label":"Nov","value":552},{"label":"Dez","value":490}];
const MX = 775;
