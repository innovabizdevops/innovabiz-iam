...
const ACCENT = "#1e1b4b";
const MODULE = "COSMOS Event Mesh";
const PAGE = "Monitor";
const KPIS = [{"l":"Eventos Planeados","v":"3.045","t":"+9.5%","d":"up"},{"l":"Participantes","v":"6.521","t":"+6.5%","d":"up"},{"l":"NPS Evento","v":"58","t":"-3.2%","d":"down"},{"l":"Receita (€)","v":"€46160","t":"+5.1%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-08","8.604","5.204","€ 20906.94","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-14","2.487","4.050","€ 32059.67","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-28","8.941","116","€ 41524.41","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-04","7.755","2.012","€ 41459.55","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-26","5.515","6.483","€ 8648.23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":883},{"label":"Fev","value":653},{"label":"Mar","value":689},{"label":"Abr","value":897},{"label":"Mai","value":933},{"label":"Jun","value":687},{"label":"Jul","value":724},{"label":"Ago","value":891},{"label":"Set","value":767},{"label":"Out","value":749},{"label":"Nov","value":661},{"label":"Dez","value":924}];
const MX = 933;
