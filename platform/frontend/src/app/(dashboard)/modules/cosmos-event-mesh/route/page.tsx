...
const PAGE = "Route";
const KPIS = [{"l":"Eventos Planeados","v":"8.321","t":"+10.1%","d":"up"},{"l":"Participantes","v":"1.491","t":"-1.8%","d":"down"},{"l":"NPS Evento","v":"71","t":"-3.3%","d":"down"},{"l":"Receita (€)","v":"€85080","t":"+15.1%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-18","2.003","4.673","€ 44092.27","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-21","2.617","4.700","€ 41806.04","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-16","7.402","675","€ 11778.30","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-07","8.667","2.213","€ 46690.63","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-08","6.198","6.432","€ 6974.49","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":816},{"label":"Mar","value":646},{"label":"Abr","value":605},{"label":"Mai","value":445},{"label":"Jun","value":469},{"label":"Jul","value":767},{"label":"Ago","value":559},{"label":"Set","value":832},{"label":"Out","value":754},{"label":"Nov","value":777},{"label":"Dez","value":619}];
const MX = 832;
