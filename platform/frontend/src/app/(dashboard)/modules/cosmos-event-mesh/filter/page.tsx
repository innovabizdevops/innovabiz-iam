...
const PAGE = "Filter";
const KPIS = [{"l":"Eventos Planeados","v":"7.667","t":"-1.1%","d":"down"},{"l":"Participantes","v":"7.866","t":"+3.6%","d":"up"},{"l":"NPS Evento","v":"95","t":"+17.2%","d":"up"},{"l":"Receita (€)","v":"€95284","t":"-1.1%","d":"down"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-07","3.002","6.723","€ 33139.30","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-20","7.073","8.176","€ 37278.85","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-19","5.381","6.699","€ 3011.46","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-17","5.776","958","€ 22835.92","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-05","2.124","3.784","€ 33018.59","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":790},{"label":"Mar","value":924},{"label":"Abr","value":703},{"label":"Mai","value":948},{"label":"Jun","value":846},{"label":"Jul","value":844},{"label":"Ago","value":619},{"label":"Set","value":900},{"label":"Out","value":720},{"label":"Nov","value":763},{"label":"Dez","value":925}];
const MX = 948;
