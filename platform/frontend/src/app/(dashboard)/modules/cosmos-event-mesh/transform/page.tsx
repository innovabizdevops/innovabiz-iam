...
const KPIS = [{"l":"Formulários Ativos","v":"5.907","t":"-2.4%","d":"down"},{"l":"Submissões/Dia","v":"4810","t":"+11.1%","d":"up"},{"l":"Documentos Gerados","v":"9.056","t":"+4.0%","d":"up"},{"l":"Templates","v":"9.057","t":"+4.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.867","2026-03-05","2.623","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.033","2026-01-05","6.879","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","976","2026-01-06","692","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.985","2026-01-15","2.253","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.266","2026-03-22","2.706","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":686},{"label":"Mar","value":661},{"label":"Abr","value":733},{"label":"Mai","value":521},{"label":"Jun","value":724},{"label":"Jul","value":487},{"label":"Ago","value":519},{"label":"Set","value":412},{"label":"Out","value":701},{"label":"Nov","value":779},{"label":"Dez","value":723}];
const MX = 779;
