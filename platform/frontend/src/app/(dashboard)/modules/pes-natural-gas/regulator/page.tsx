...
const PAGE = "Regulator Stn";
const KPIS = [{"l":"Total Pes Natural Gas","v":"8.790","t":"-1.1%","d":"down"},{"l":"Regulator Stn Ativos","v":"4.913","t":"+2.3%","d":"up"},{"l":"Eficiência (%)","v":"88.2%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"68","t":"-5.1%","d":"down"}];
const COLS = ["ID","Regulator Stn","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pes Natural Gas #001","Pes Natural Gas #002","8.558","6.453","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Pes Natural Gas #002","Pes Natural Gas #003","7.602","7.419","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Pes Natural Gas #003","Pes Natural Gas #004","1.287","5.356","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Pes Natural Gas #004","Pes Natural Gas #005","6.660","8.809","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pes Natural Gas #005","Pes Natural Gas #001","1.327","7.123","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":703},{"label":"Mar","value":904},{"label":"Abr","value":833},{"label":"Mai","value":672},{"label":"Jun","value":869},{"label":"Jul","value":775},{"label":"Ago","value":1011},{"label":"Set","value":1015},{"label":"Out","value":940},{"label":"Nov","value":670},{"label":"Dez","value":711}];
const MX = 1015;
