...
const PAGE = "Gas Balance";
const KPIS = [{"l":"Total Pes Natural Gas","v":"7.524","t":"-2.7%","d":"down"},{"l":"Gas Balance Ativos","v":"5.702","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"88.1%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"81","t":"+5.9%","d":"up"}];
const COLS = ["ID","Gas Balance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pes Natural Gas #001","Pes Natural Gas #002","7.836","2.567","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Pes Natural Gas #002","Pes Natural Gas #003","3.001","3.310","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Pes Natural Gas #003","Pes Natural Gas #004","535","1.236","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Pes Natural Gas #004","Pes Natural Gas #005","5.778","5.307","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pes Natural Gas #005","Pes Natural Gas #001","8.404","8.937","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":860},{"label":"Fev","value":737},{"label":"Mar","value":606},{"label":"Abr","value":923},{"label":"Mai","value":754},{"label":"Jun","value":865},{"label":"Jul","value":811},{"label":"Ago","value":919},{"label":"Set","value":793},{"label":"Out","value":900},{"label":"Nov","value":914},{"label":"Dez","value":848}];
const MX = 923;
