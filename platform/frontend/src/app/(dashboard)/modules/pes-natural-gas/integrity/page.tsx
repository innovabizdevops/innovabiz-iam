...
const PAGE = "Integrity Mgmt";
const KPIS = [{"l":"Total Pes Natural Gas","v":"7.157","t":"+3.6%","d":"up"},{"l":"Integrity Mgmt Ativos","v":"3.622","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"85.9%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"91","t":"+11.7%","d":"up"}];
const COLS = ["ID","Integrity Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pes Natural Gas #001","Pes Natural Gas #002","7.019","7.308","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Pes Natural Gas #002","Pes Natural Gas #003","4.138","5.771","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Pes Natural Gas #003","Pes Natural Gas #004","9.040","8.944","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Pes Natural Gas #004","Pes Natural Gas #005","1.805","7.388","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pes Natural Gas #005","Pes Natural Gas #001","6.377","4.846","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":642},{"label":"Mar","value":680},{"label":"Abr","value":861},{"label":"Mai","value":745},{"label":"Jun","value":857},{"label":"Jul","value":821},{"label":"Ago","value":693},{"label":"Set","value":933},{"label":"Out","value":885},{"label":"Nov","value":727},{"label":"Dez","value":596}];
const MX = 933;
