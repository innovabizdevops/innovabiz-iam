...
const ACCENT = "#78350f";
const MODULE = "Natural Gas Utility";
const PAGE = "Odorization";
const KPIS = [{"l":"Total Pes Natural Gas","v":"4.323","t":"-2.2%","d":"down"},{"l":"Odorization Ativos","v":"6.143","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"90.1%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"76","t":"+5.5%","d":"up"}];
const COLS = ["ID","Odorization","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pes Natural Gas #001","Pes Natural Gas #002","7.425","7.428","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Pes Natural Gas #002","Pes Natural Gas #003","381","4.500","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Pes Natural Gas #003","Pes Natural Gas #004","5.147","7.636","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Pes Natural Gas #004","Pes Natural Gas #005","2.980","2.093","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pes Natural Gas #005","Pes Natural Gas #001","657","6.443","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":779},{"label":"Fev","value":764},{"label":"Mar","value":899},{"label":"Abr","value":618},{"label":"Mai","value":802},{"label":"Jun","value":880},{"label":"Jul","value":788},{"label":"Ago","value":931},{"label":"Set","value":788},{"label":"Out","value":956},{"label":"Nov","value":714},{"label":"Dez","value":817}];
const MX = 956;
...
export default function OdorizePage() {
    return (
