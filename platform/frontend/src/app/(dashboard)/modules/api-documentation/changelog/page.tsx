...
const KPIS = [{"l":"Formulários Ativos","v":"671","t":"-1.0%","d":"down"},{"l":"Submissões/Dia","v":"295","t":"+15.3%","d":"up"},{"l":"Documentos Gerados","v":"974","t":"+10.3%","d":"up"},{"l":"Templates","v":"5.759","t":"+4.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.279","2026-02-02","3.410","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.493","2026-03-01","6.956","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.584","2026-03-14","8.764","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.986","2026-01-17","4.216","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","654","2026-01-12","178","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":291},{"label":"Fev","value":285},{"label":"Mar","value":544},{"label":"Abr","value":245},{"label":"Mai","value":253},{"label":"Jun","value":376},{"label":"Jul","value":327},{"label":"Ago","value":485},{"label":"Set","value":582},{"label":"Out","value":547},{"label":"Nov","value":438},{"label":"Dez","value":463}];
const MX = 582;
