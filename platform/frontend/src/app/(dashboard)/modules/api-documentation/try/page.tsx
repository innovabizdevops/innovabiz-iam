...
const PAGE = "Try";
const KPIS = [{"l":"Formulários Ativos","v":"2.257","t":"+5.3%","d":"up"},{"l":"Submissões/Dia","v":"1605","t":"+0.0%","d":"up"},{"l":"Documentos Gerados","v":"4.065","t":"+14.1%","d":"up"},{"l":"Templates","v":"622","t":"+17.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.091","2026-03-24","4.924","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.631","2026-01-08","6.798","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.190","2026-03-12","4.274","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.750","2026-02-27","5.755","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.204","2026-03-22","6.057","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":482},{"label":"Mar","value":578},{"label":"Abr","value":245},{"label":"Mai","value":516},{"label":"Jun","value":426},{"label":"Jul","value":273},{"label":"Ago","value":402},{"label":"Set","value":488},{"label":"Out","value":233},{"label":"Nov","value":274},{"label":"Dez","value":455}];
const MX = 578;
