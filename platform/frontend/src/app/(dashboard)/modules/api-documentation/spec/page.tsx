...
const PAGE = "Spec";
const KPIS = [{"l":"Formulários Ativos","v":"2.930","t":"-5.0%","d":"down"},{"l":"Submissões/Dia","v":"1645","t":"+14.9%","d":"up"},{"l":"Documentos Gerados","v":"4.176","t":"+1.5%","d":"up"},{"l":"Templates","v":"6.395","t":"-5.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.135","2026-02-03","6.783","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.850","2026-03-07","377","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.226","2026-02-27","7.729","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.850","2026-02-22","4.850","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.449","2026-01-17","8.065","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":392},{"label":"Fev","value":318},{"label":"Mar","value":382},{"label":"Abr","value":381},{"label":"Mai","value":588},{"label":"Jun","value":332},{"label":"Jul","value":475},{"label":"Ago","value":375},{"label":"Set","value":448},{"label":"Out","value":532},{"label":"Nov","value":339},{"label":"Dez","value":401}];
const MX = 588;
