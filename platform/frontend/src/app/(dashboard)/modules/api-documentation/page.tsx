...
/* ═══ API Documentation Hub — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "7982", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "906", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€14K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "954427282", cells: ["API-5282", "API Documentation Hub Item 1", "19/11/2026", "€27 382"], status: "active" as const },
    { id: "954430853", cells: ["API-8853", "API Documentation Hub Item 2", "6/6/2026", "€30 953"], status: "pending" as const },
    { id: "954434424", cells: ["API-3424", "API Documentation Hub Item 3", "21/1/2026", "€34 524"], status: "completed" as const },
    { id: "954437995", cells: ["API-6995", "API Documentation Hub Item 4", "8/8/2026", "€38 095"], status: "warning" as const },
    { id: "954441566", cells: ["API-1566", "API Documentation Hub Item 5", "23/3/2026", "€41 666"], status: "active" as const },
];
...
export default function ApiDocumentationHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">API Documentation Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • API Documentation Hub</p>
                    </div>
                </div>
