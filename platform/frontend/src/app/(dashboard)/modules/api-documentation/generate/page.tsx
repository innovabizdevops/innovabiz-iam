...
const PAGE = "Generate";
const KPIS = [{"l":"Formulários Ativos","v":"2.429","t":"+17.4%","d":"up"},{"l":"Submissões/Dia","v":"2085","t":"+9.4%","d":"up"},{"l":"Documentos Gerados","v":"101","t":"+12.7%","d":"up"},{"l":"Templates","v":"4.888","t":"+5.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.455","2026-02-28","7.637","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.374","2026-02-09","4.553","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.800","2026-02-28","1.805","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.524","2026-03-09","3.289","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.998","2026-02-08","1.166","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":728},{"label":"Mar","value":1043},{"label":"Abr","value":1078},{"label":"Mai","value":753},{"label":"Jun","value":876},{"label":"Jul","value":860},{"label":"Ago","value":987},{"label":"Set","value":851},{"label":"Out","value":1050},{"label":"Nov","value":880},{"label":"Dez","value":781}];
const MX = 1078;
