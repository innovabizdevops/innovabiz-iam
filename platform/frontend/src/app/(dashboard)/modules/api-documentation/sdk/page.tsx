...
const ACCENT = "#0d9488";
const MODULE = "API Documentation Hub";
const PAGE = "SDK";
const KPIS = [{"l":"Formulários Ativos","v":"3.849","t":"-3.7%","d":"down"},{"l":"Submissões/Dia","v":"3002","t":"-1.9%","d":"down"},{"l":"Documentos Gerados","v":"2.505","t":"+16.9%","d":"up"},{"l":"Templates","v":"6.072","t":"-0.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.800","2026-01-25","8.978","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.570","2026-02-17","6.187","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.341","2026-03-09","2.420","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.432","2026-01-08","2.856","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.285","2026-02-17","8.314","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":366},{"label":"Mar","value":287},{"label":"Abr","value":345},{"label":"Mai","value":282},{"label":"Jun","value":333},{"label":"Jul","value":423},{"label":"Ago","value":326},{"label":"Set","value":505},{"label":"Out","value":634},{"label":"Nov","value":488},{"label":"Dez","value":468}];
const MX = 634;
