...
const PAGE = "Route";
const KPIS = [{"l":"Total Message Broker","v":"4.684","t":"+1.6%","d":"up"},{"l":"Route Ativos","v":"1.124","t":"+14.9%","d":"up"},{"l":"Eficiência (%)","v":"76.4%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"73","t":"+2.4%","d":"up"}];
const COLS = ["ID","Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Message Broker #001","Message Broker #002","1.895","4.428","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Message Broker #002","Message Broker #003","7.943","5.115","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Message Broker #003","Message Broker #004","8.822","8.963","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Message Broker #004","Message Broker #005","2.118","8.231","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Message Broker #005","Message Broker #001","9.011","1.424","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1077},{"label":"Fev","value":896},{"label":"Mar","value":876},{"label":"Abr","value":902},{"label":"Mai","value":895},{"label":"Jun","value":786},{"label":"Jul","value":1010},{"label":"Ago","value":975},{"label":"Set","value":1040},{"label":"Out","value":1042},{"label":"Nov","value":890},{"label":"Dez","value":1026}];
const MX = 1077;
