...
const PAGE = "Exchange";
const KPIS = [{"l":"Total Message Broker","v":"2.165","t":"+17.8%","d":"up"},{"l":"Exchange Ativos","v":"1.401","t":"+10.7%","d":"up"},{"l":"Eficiência (%)","v":"77.1%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"89","t":"+11.0%","d":"up"}];
const COLS = ["ID","Exchange","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Message Broker #001","Message Broker #002","3.481","3.164","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Message Broker #002","Message Broker #003","736","1.701","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Message Broker #003","Message Broker #004","2.793","1.828","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Message Broker #004","Message Broker #005","2.925","5.018","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Message Broker #005","Message Broker #001","9.029","8.912","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":713},{"label":"Mar","value":525},{"label":"Abr","value":476},{"label":"Mai","value":713},{"label":"Jun","value":629},{"label":"Jul","value":572},{"label":"Ago","value":553},{"label":"Set","value":617},{"label":"Out","value":547},{"label":"Nov","value":460},{"label":"Dez","value":655}];
const MX = 727;
