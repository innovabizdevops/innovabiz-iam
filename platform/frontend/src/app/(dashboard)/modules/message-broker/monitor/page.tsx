...
const PAGE = "Monitor";
const KPIS = [{"l":"Total Message Broker","v":"8.923","t":"+13.4%","d":"up"},{"l":"Monitor Ativos","v":"9.061","t":"+14.9%","d":"up"},{"l":"Eficiência (%)","v":"66.7%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"55","t":"-2.2%","d":"down"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Message Broker #001","Message Broker #002","7.386","2.619","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Message Broker #002","Message Broker #003","402","2.748","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Message Broker #003","Message Broker #004","8.781","7.957","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Message Broker #004","Message Broker #005","6.385","3.532","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Message Broker #005","Message Broker #001","7.346","7.798","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":664},{"label":"Mar","value":654},{"label":"Abr","value":568},{"label":"Mai","value":748},{"label":"Jun","value":584},{"label":"Jul","value":529},{"label":"Ago","value":665},{"label":"Set","value":569},{"label":"Out","value":366},{"label":"Nov","value":620},{"label":"Dez","value":408}];
const MX = 755;
