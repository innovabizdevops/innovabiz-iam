...
const PAGE = "Queue";
const KPIS = [{"l":"Total Message Broker","v":"913","t":"-3.4%","d":"down"},{"l":"Queue Ativos","v":"3.757","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"92.6%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"65","t":"-0.7%","d":"down"}];
const COLS = ["ID","Queue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Message Broker #001","Message Broker #002","7.921","5.887","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Message Broker #002","Message Broker #003","3.993","8.337","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Message Broker #003","Message Broker #004","2.718","822","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Message Broker #004","Message Broker #005","2.925","8.858","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Message Broker #005","Message Broker #001","2.735","5.924","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":892},{"label":"Fev","value":968},{"label":"Mar","value":785},{"label":"Abr","value":915},{"label":"Mai","value":796},{"label":"Jun","value":670},{"label":"Jul","value":603},{"label":"Ago","value":859},{"label":"Set","value":664},{"label":"Out","value":815},{"label":"Nov","value":779},{"label":"Dez","value":882}];
const MX = 968;
