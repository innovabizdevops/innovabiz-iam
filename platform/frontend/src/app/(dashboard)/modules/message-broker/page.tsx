...
/* ═══ Message Broker Platform — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "3046", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3546", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€404K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "-4%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1721523846", cells: ["MES-4846", "Message Broker Platform Item 1", "15/7/2026", "€23 946"], status: "active" as const },
    { id: "1721527417", cells: ["MES-8417", "Message Broker Platform Item 2", "2/2/2026", "€27 517"], status: "pending" as const },
    { id: "1721530988", cells: ["MES-2988", "Message Broker Platform Item 3", "17/9/2026", "€31 088"], status: "completed" as const },
    { id: "1721534559", cells: ["MES-6559", "Message Broker Platform Item 4", "4/4/2026", "€34 659"], status: "warning" as const },
    { id: "1721538130", cells: ["MES-1130", "Message Broker Platform Item 5", "19/11/2026", "€38 230"], status: "active" as const },
];
...
export default function MessageBrokerPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Message Broker Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Message Broker Platform</p>
                    </div>
                </div>
