...
const ACCENT = "#0d9488";
const MODULE = "Message Broker Platform";
const PAGE = "DLQ";
const KPIS = [{"l":"Total Message Broker","v":"5.179","t":"-5.8%","d":"down"},{"l":"DLQ Ativos","v":"2.472","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"89.6%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"79","t":"+11.2%","d":"up"}];
const COLS = ["ID","DLQ","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Message Broker #001","Message Broker #002","6.731","7.613","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Message Broker #002","Message Broker #003","8.569","8.881","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Message Broker #003","Message Broker #004","3.177","499","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Message Broker #004","Message Broker #005","7.714","3.508","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Message Broker #005","Message Broker #001","1.926","2.410","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":456},{"label":"Mar","value":543},{"label":"Abr","value":322},{"label":"Mai","value":419},{"label":"Jun","value":500},{"label":"Jul","value":309},{"label":"Ago","value":595},{"label":"Set","value":232},{"label":"Out","value":439},{"label":"Nov","value":347},{"label":"Dez","value":470}];
const MX = 595;
