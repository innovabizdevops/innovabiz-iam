...
/* ═══ AI Marketing Agent — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "9553", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3754", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€134K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "993197253", cells: ["AGE-3253", "AI Marketing Agent Item 1", "14/10/2026", "€47 353"], status: "active" as const },
    { id: "993200824", cells: ["AGE-6824", "AI Marketing Agent Item 2", "1/5/2026", "€924"], status: "pending" as const },
    { id: "993204395", cells: ["AGE-1395", "AI Marketing Agent Item 3", "16/12/2026", "€4495"], status: "completed" as const },
    { id: "993207966", cells: ["AGE-4966", "AI Marketing Agent Item 4", "3/7/2026", "€8066"], status: "warning" as const },
    { id: "993211537", cells: ["AGE-8537", "AI Marketing Agent Item 5", "18/2/2026", "€11 637"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Marketing Agent</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Marketing Agent</p>
                    </div>
                </div>
