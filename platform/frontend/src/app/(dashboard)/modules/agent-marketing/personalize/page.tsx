...
const KPIS = [{"l":"Perfis Unificados","v":"7.019","t":"-0.1%","d":"down"},{"l":"Segmentos Ativos","v":"978","t":"+8.1%","d":"up"},{"l":"NPS Score","v":"71","t":"-3.1%","d":"down"},{"l":"Churn Previsto (%)","v":"68.5%","t":"-0.6%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","2.031","€ 20440.99","90.9%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","1.762","€ 21196.46","72.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","1.574","€ 37945.95","90.5%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","7.838","€ 33993.66","83.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","6.204","€ 39495.71","75.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":646},{"label":"Mar","value":649},{"label":"Abr","value":668},{"label":"Mai","value":823},{"label":"Jun","value":673},{"label":"Jul","value":893},{"label":"Ago","value":701},{"label":"Set","value":758},{"label":"Out","value":645},{"label":"Nov","value":1009},{"label":"Dez","value":723}];
const MX = 1009;
