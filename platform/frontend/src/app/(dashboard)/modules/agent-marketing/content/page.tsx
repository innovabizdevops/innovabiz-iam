...
const ACCENT = "#7c3aed";
const MODULE = "AI Marketing Agent";
const PAGE = "Content";
const KPIS = [{"l":"Total Agent Marketing","v":"1.806","t":"-1.0%","d":"down"},{"l":"Content Ativos","v":"6.378","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"83.4%","t":"+9.7%","d":"up"},{"l":"Score Performance","v":"61","t":"-1.2%","d":"down"}];
const COLS = ["ID","Content","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agent Marketing #001","Agent Marketing #002","8.877","7.780","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Agent Marketing #002","Agent Marketing #003","7.639","8.721","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Agent Marketing #003","Agent Marketing #004","8.306","6.499","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Agent Marketing #004","Agent Marketing #005","4.747","5.454","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agent Marketing #005","Agent Marketing #001","6.765","6.254","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1016},{"label":"Fev","value":707},{"label":"Mar","value":1037},{"label":"Abr","value":724},{"label":"Mai","value":895},{"label":"Jun","value":1028},{"label":"Jul","value":734},{"label":"Ago","value":796},{"label":"Set","value":687},{"label":"Out","value":939},{"label":"Nov","value":1013},{"label":"Dez","value":912}];
const MX = 1037;
