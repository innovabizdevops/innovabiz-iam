...
/* ═══ Cybersecurity Platform Deep — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "6239", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4621", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€253K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1204885639", cells: ["CYB-2639", "Cybersecurity Platform Deep Item 1", "28/8/2026", "€35 739"], status: "active" as const },
    { id: "1204889210", cells: ["CYB-6210", "Cybersecurity Platform Deep Item 2", "15/3/2026", "€39 310"], status: "pending" as const },
    { id: "1204892781", cells: ["CYB-9781", "Cybersecurity Platform Deep Item 3", "2/10/2026", "€42 881"], status: "completed" as const },
    { id: "1204896352", cells: ["CYB-4352", "Cybersecurity Platform Deep Item 4", "17/5/2026", "€46 452"], status: "warning" as const },
    { id: "1204899923", cells: ["CYB-7923", "Cybersecurity Platform Deep Item 5", "4/12/2026", "€50 023"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 59 }, { label: "Fev", value: 68 }, { label: "Mar", value: 77 }, { label: "Abr", value: 86 }, { label: "Mai", value: 95 }, { label: "Jun", value: 24 }];
...
export default function CybersecurityPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cybersecurity Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cybersecurity Platform Deep</p>
                    </div>
                </div>
