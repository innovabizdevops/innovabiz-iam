...
export default function AeroManufacturingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Aero Manufacturing</h1><p className="text-sm text-muted-foreground">Aero Manufacturing • iBOS Enterprise</p></div>
