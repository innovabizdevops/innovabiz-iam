...
/* ═══ MD: Multi-Org Engine — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "9680", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2121", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€417K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "689653480", cells: ["MD-2480", "MD: Multi-Org Engine Item 1", "13/5/2026", "€3580"], status: "active" as const },
    { id: "689657051", cells: ["MD-6051", "MD: Multi-Org Engine Item 2", "28/12/2026", "€7151"], status: "pending" as const },
    { id: "689660622", cells: ["MD-9622", "MD: Multi-Org Engine Item 3", "15/7/2026", "€10 722"], status: "completed" as const },
    { id: "689664193", cells: ["MD-4193", "MD: Multi-Org Engine Item 4", "2/2/2026", "€14 293"], status: "warning" as const },
    { id: "689667764", cells: ["MD-7764", "MD: Multi-Org Engine Item 5", "17/9/2026", "€17 864"], status: "active" as const },
];
...
export default function MdMultiorgEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Org Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Org Engine</p>
                    </div>
                </div>
