...
const ACCENT = "#7c2d12";
const MODULE = "MD: Multi-Org Engine";
const PAGE = "Cross-Org";
const KPIS = [{"l":"Utilizadores Ativos","v":"1.737","t":"+6.0%","d":"up"},{"l":"Sessões/Dia","v":"3615","t":"-3.5%","d":"down"},{"l":"MFA Adoção (%)","v":"94.1%","t":"+8.0%","d":"up"},{"l":"Tentativas Bloqueadas","v":"1.404","t":"+7.3%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","9.080","7.521","7.843","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","577","7.211","8.109","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","645","4.458","8.938","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.541","7.715","8.146","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","702","3.748","5.402","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":947},{"label":"Fev","value":696},{"label":"Mar","value":749},{"label":"Abr","value":591},{"label":"Mai","value":868},{"label":"Jun","value":606},{"label":"Jul","value":662},{"label":"Ago","value":711},{"label":"Set","value":874},{"label":"Out","value":711},{"label":"Nov","value":834},{"label":"Dez","value":784}];
const MX = 947;
