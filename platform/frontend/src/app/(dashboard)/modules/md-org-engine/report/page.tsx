...
const PAGE = "Report";
const KPIS = [{"l":"Total Md Org Engine","v":"1.482","t":"+16.1%","d":"up"},{"l":"Report Ativos","v":"1.210","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"81.2%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"63","t":"+13.4%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Md Org Engine #001","Md Org Engine #002","2.538","7.510","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Md Org Engine #002","Md Org Engine #003","5.095","7.400","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Md Org Engine #003","Md Org Engine #004","1.020","6.020","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Md Org Engine #004","Md Org Engine #005","4.970","6.650","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Md Org Engine #005","Md Org Engine #001","446","5.020","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":807},{"label":"Mar","value":995},{"label":"Abr","value":1007},{"label":"Mai","value":893},{"label":"Jun","value":997},{"label":"Jul","value":983},{"label":"Ago","value":780},{"label":"Set","value":835},{"label":"Out","value":793},{"label":"Nov","value":707},{"label":"Dez","value":681}];
const MX = 1007;
