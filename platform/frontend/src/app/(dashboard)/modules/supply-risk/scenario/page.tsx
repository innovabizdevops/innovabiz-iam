...
const PAGE = "Scenario";
const KPIS = [{"l":"Riscos Identificados","v":"3.542","t":"+3.4%","d":"up"},{"l":"Mitigações Ativas","v":"906","t":"+2.7%","d":"up"},{"l":"Score Risco Geral","v":"80","t":"+16.4%","d":"up"},{"l":"Incidentes YTD","v":"2.937","t":"+11.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.414","6.750","5.922","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.099","5.449","1.161","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.509","417","1.981","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.778","3.327","8.034","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.768","3.538","106","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":472},{"label":"Fev","value":595},{"label":"Mar","value":600},{"label":"Abr","value":605},{"label":"Mai","value":586},{"label":"Jun","value":623},{"label":"Jul","value":771},{"label":"Ago","value":688},{"label":"Set","value":458},{"label":"Out","value":721},{"label":"Nov","value":469},{"label":"Dez","value":503}];
const MX = 771;
