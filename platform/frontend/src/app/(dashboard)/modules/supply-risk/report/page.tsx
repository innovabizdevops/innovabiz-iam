...
const PAGE = "Report";
const KPIS = [{"l":"Riscos Identificados","v":"610","t":"+8.8%","d":"up"},{"l":"Mitigações Ativas","v":"8.941","t":"-0.1%","d":"down"},{"l":"Score Risco Geral","v":"75","t":"+16.6%","d":"up"},{"l":"Incidentes YTD","v":"4.447","t":"+10.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","169","1.450","865","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.406","7.475","6.192","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","998","6.788","217","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.532","4.602","1.158","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.301","3.590","5.344","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":954},{"label":"Mar","value":941},{"label":"Abr","value":582},{"label":"Mai","value":616},{"label":"Jun","value":674},{"label":"Jul","value":785},{"label":"Ago","value":718},{"label":"Set","value":653},{"label":"Out","value":785},{"label":"Nov","value":902},{"label":"Dez","value":949}];
const MX = 954;
