...
const PAGE = "Assess";
const KPIS = [{"l":"Riscos Identificados","v":"1.058","t":"+13.6%","d":"up"},{"l":"Mitigações Ativas","v":"459","t":"+3.0%","d":"up"},{"l":"Score Risco Geral","v":"84","t":"+15.1%","d":"up"},{"l":"Incidentes YTD","v":"7.862","t":"+11.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.577","5.708","7.243","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.650","1.366","6.201","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.020","1.347","4.730","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.281","1.456","9.010","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.283","1.488","3.107","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":788},{"label":"Mar","value":708},{"label":"Abr","value":692},{"label":"Mai","value":1035},{"label":"Jun","value":882},{"label":"Jul","value":677},{"label":"Ago","value":888},{"label":"Set","value":887},{"label":"Out","value":699},{"label":"Nov","value":654},{"label":"Dez","value":1014}];
const MX = 1035;
