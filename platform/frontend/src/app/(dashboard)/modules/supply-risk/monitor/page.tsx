...
const ACCENT = "#6366f1";
const MODULE = "Supply Risk Mgmt";
const PAGE = "Monitor";
const KPIS = [{"l":"Riscos Identificados","v":"3.284","t":"+12.0%","d":"up"},{"l":"Mitigações Ativas","v":"5.722","t":"+11.0%","d":"up"},{"l":"Score Risco Geral","v":"56","t":"-0.1%","d":"down"},{"l":"Incidentes YTD","v":"3.194","t":"+15.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.575","6.329","3.425","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.699","556","3.710","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.844","6.238","3.875","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.650","4.530","5.366","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.333","8.072","3.014","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":401},{"label":"Fev","value":222},{"label":"Mar","value":461},{"label":"Abr","value":432},{"label":"Mai","value":289},{"label":"Jun","value":344},{"label":"Jul","value":385},{"label":"Ago","value":376},{"label":"Set","value":610},{"label":"Out","value":281},{"label":"Nov","value":556},{"label":"Dez","value":455}];
const MX = 610;
