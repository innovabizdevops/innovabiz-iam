...
const PAGE = "Mitigate";
const KPIS = [{"l":"Riscos Identificados","v":"4.447","t":"-0.3%","d":"down"},{"l":"Mitigações Ativas","v":"7.977","t":"+6.0%","d":"up"},{"l":"Score Risco Geral","v":"59","t":"+10.3%","d":"up"},{"l":"Incidentes YTD","v":"3.034","t":"+14.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.845","5.736","3.140","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.894","8.699","5.876","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.727","4.378","1.576","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.253","7.222","6.857","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.388","4.358","3.889","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":684},{"label":"Mar","value":501},{"label":"Abr","value":446},{"label":"Mai","value":359},{"label":"Jun","value":544},{"label":"Jul","value":605},{"label":"Ago","value":622},{"label":"Set","value":526},{"label":"Out","value":682},{"label":"Nov","value":408},{"label":"Dez","value":331}];
const MX = 684;
