...
const PAGE = "Route";
const KPIS = [{"l":"Total Transit Agency","v":"8.960","t":"+2.9%","d":"up"},{"l":"Route Ativos","v":"3.814","t":"+7.7%","d":"up"},{"l":"Eficiência (%)","v":"75.8%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"65","t":"+5.7%","d":"up"}];
const COLS = ["ID","Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Transit Agency #001","Transit Agency #002","4.103","6.900","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Transit Agency #002","Transit Agency #003","4.288","4.016","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Transit Agency #003","Transit Agency #004","6.526","5.676","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Transit Agency #004","Transit Agency #005","5.908","908","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Transit Agency #005","Transit Agency #001","2.836","1.668","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":518},{"label":"Mar","value":579},{"label":"Abr","value":560},{"label":"Mai","value":539},{"label":"Jun","value":674},{"label":"Jul","value":716},{"label":"Ago","value":766},{"label":"Set","value":691},{"label":"Out","value":621},{"label":"Nov","value":711},{"label":"Dez","value":642}];
const MX = 766;
