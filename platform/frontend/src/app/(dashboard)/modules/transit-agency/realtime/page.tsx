...
const ACCENT = "#0c4a6e";
const MODULE = "Transit Agency";
const PAGE = "Real-Time";
const KPIS = [{"l":"Total Transit Agency","v":"6.323","t":"+7.7%","d":"up"},{"l":"Real Time Ativos","v":"9.095","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"74.7%","t":"+15.9%","d":"up"},{"l":"Score Performance","v":"85","t":"+2.4%","d":"up"}];
const COLS = ["ID","Real Time","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Transit Agency #001","Transit Agency #002","5.361","7.424","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Transit Agency #002","Transit Agency #003","6.725","2.723","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Transit Agency #003","Transit Agency #004","3.591","2.543","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Transit Agency #004","Transit Agency #005","5.079","5.345","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Transit Agency #005","Transit Agency #001","1.212","3.558","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":370},{"label":"Mar","value":495},{"label":"Abr","value":452},{"label":"Mai","value":631},{"label":"Jun","value":540},{"label":"Jul","value":570},{"label":"Ago","value":733},{"label":"Set","value":518},{"label":"Out","value":739},{"label":"Nov","value":716},{"label":"Dez","value":484}];
const MX = 739;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0c4a6e'}}>RTM</span></h1>
                </div>
