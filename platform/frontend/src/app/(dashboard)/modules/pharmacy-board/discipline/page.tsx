...
const ACCENT = "#7c3aed";
const MODULE = "Pharmacy Regulatory Board";
const PAGE = "Discipline";
const KPIS = [{"l":"Teams Ativos","v":"4.860","t":"+10.6%","d":"up"},{"l":"Reuniões/Semana","v":"4040","t":"+18.0%","d":"up"},{"l":"Mensagens/Dia","v":"965","t":"-2.2%","d":"down"},{"l":"Ficheiros Partilhados","v":"4.532","t":"+12.2%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","6.572","3617","4.210","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","3.062","2783","5.545","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","7.015","1861","4.870","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","465","491","6.814","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.753","4807","4.323","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":877},{"label":"Fev","value":629},{"label":"Mar","value":688},{"label":"Abr","value":706},{"label":"Mai","value":676},{"label":"Jun","value":545},{"label":"Jul","value":632},{"label":"Ago","value":799},{"label":"Set","value":770},{"label":"Out","value":646},{"label":"Nov","value":665},{"label":"Dez","value":630}];
const MX = 877;
