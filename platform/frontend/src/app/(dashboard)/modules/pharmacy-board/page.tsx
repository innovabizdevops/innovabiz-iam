...
/* ═══ Pharmacy Regulatory Board — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "129", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1937", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€476K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "946638029", cells: ["PHA-1029", "Pharmacy Regulatory Board Item 1", "2/6/2026", "€38 129"], status: "active" as const },
    { id: "946641600", cells: ["PHA-4600", "Pharmacy Regulatory Board Item 2", "17/1/2026", "€41 700"], status: "pending" as const },
    { id: "946645171", cells: ["PHA-8171", "Pharmacy Regulatory Board Item 3", "4/8/2026", "€45 271"], status: "completed" as const },
    { id: "946648742", cells: ["PHA-2742", "Pharmacy Regulatory Board Item 4", "19/3/2026", "€48 842"], status: "warning" as const },
    { id: "946652313", cells: ["PHA-6313", "Pharmacy Regulatory Board Item 5", "6/10/2026", "€2413"], status: "active" as const },
];
...
export default function PharmacyRegulatoryBoardPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pharmacy Regulatory Board</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pharmacy Regulatory Board</p>
                    </div>
                </div>
