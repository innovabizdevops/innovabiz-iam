...
const PAGE = "License";
const KPIS = [{"l":"Teams Ativos","v":"7.034","t":"-3.2%","d":"down"},{"l":"Reuniões/Semana","v":"2862","t":"+14.9%","d":"up"},{"l":"Mensagens/Dia","v":"254","t":"+12.6%","d":"up"},{"l":"Ficheiros Partilhados","v":"6.974","t":"+1.3%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","657","1171","4.876","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.013","2391","3.403","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","8.370","487","2.282","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","9.045","3679","6.093","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","4.491","104","3.750","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":569},{"label":"Mar","value":292},{"label":"Abr","value":455},{"label":"Mai","value":564},{"label":"Jun","value":656},{"label":"Jul","value":397},{"label":"Ago","value":613},{"label":"Set","value":415},{"label":"Out","value":394},{"label":"Nov","value":448},{"label":"Dez","value":382}];
const MX = 656;
