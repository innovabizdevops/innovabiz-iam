...
const PAGE = "Register";
const KPIS = [{"l":"Teams Ativos","v":"260","t":"+11.2%","d":"up"},{"l":"Reuniões/Semana","v":"183","t":"+12.0%","d":"up"},{"l":"Mensagens/Dia","v":"249","t":"-4.3%","d":"down"},{"l":"Ficheiros Partilhados","v":"4.983","t":"+0.9%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","6.308","1873","4.222","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","4.250","3057","960","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","1.040","4934","6.789","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.664","1876","5.270","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","5.952","4673","8.501","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":832},{"label":"Fev","value":664},{"label":"Mar","value":665},{"label":"Abr","value":668},{"label":"Mai","value":652},{"label":"Jun","value":627},{"label":"Jul","value":652},{"label":"Ago","value":633},{"label":"Set","value":638},{"label":"Out","value":661},{"label":"Nov","value":875},{"label":"Dez","value":741}];
const MX = 875;
