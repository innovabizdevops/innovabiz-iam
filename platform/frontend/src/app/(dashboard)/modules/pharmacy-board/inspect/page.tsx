...
const PAGE = "Inspect";
const KPIS = [{"l":"Teams Ativos","v":"1.442","t":"+17.6%","d":"up"},{"l":"Reuniões/Semana","v":"1665","t":"+7.4%","d":"up"},{"l":"Mensagens/Dia","v":"324","t":"+3.0%","d":"up"},{"l":"Ficheiros Partilhados","v":"2.587","t":"-2.9%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","1.727","233","6.597","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.241","4141","5.640","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","2.002","3277","2.025","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.008","4618","8.835","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","4.465","2862","529","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":778},{"label":"Mar","value":775},{"label":"Abr","value":863},{"label":"Mai","value":550},{"label":"Jun","value":534},{"label":"Jul","value":570},{"label":"Ago","value":647},{"label":"Set","value":502},{"label":"Out","value":543},{"label":"Nov","value":807},{"label":"Dez","value":748}];
const MX = 863;
