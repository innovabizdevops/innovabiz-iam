...
const PAGE = "Respond";
const KPIS = [{"l":"Total Sai Security Mesh","v":"8.608","t":"+1.6%","d":"up"},{"l":"Respond Ativos","v":"2.434","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"85.8%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"58","t":"-4.3%","d":"down"}];
const COLS = ["ID","Respond","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sai Security Mesh #001","Sai Security Mesh #002","4.562","8.854","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Sai Security Mesh #002","Sai Security Mesh #003","3.176","8.973","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Sai Security Mesh #003","Sai Security Mesh #004","5.103","5.042","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Sai Security Mesh #004","Sai Security Mesh #005","219","2.248","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sai Security Mesh #005","Sai Security Mesh #001","2.506","1.110","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":525},{"label":"Mar","value":367},{"label":"Abr","value":319},{"label":"Mai","value":311},{"label":"Jun","value":343},{"label":"Jul","value":410},{"label":"Ago","value":407},{"label":"Set","value":292},{"label":"Out","value":294},{"label":"Nov","value":632},{"label":"Dez","value":422}];
const MX = 632;
