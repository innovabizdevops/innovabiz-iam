...
const PAGE = "Policy";
const KPIS = [{"l":"Total Sai Security Mesh","v":"1.444","t":"+7.3%","d":"up"},{"l":"Policy Ativos","v":"7.502","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"84.9%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"64","t":"+6.6%","d":"up"}];
const COLS = ["ID","Policy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sai Security Mesh #001","Sai Security Mesh #002","8.735","7.002","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Sai Security Mesh #002","Sai Security Mesh #003","7.055","8.160","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Sai Security Mesh #003","Sai Security Mesh #004","5.057","1.573","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Sai Security Mesh #004","Sai Security Mesh #005","2.826","4.687","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sai Security Mesh #005","Sai Security Mesh #001","1.651","2.168","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":1017},{"label":"Mar","value":652},{"label":"Abr","value":1028},{"label":"Mai","value":656},{"label":"Jun","value":808},{"label":"Jul","value":981},{"label":"Ago","value":1020},{"label":"Set","value":639},{"label":"Out","value":908},{"label":"Nov","value":844},{"label":"Dez","value":991}];
const MX = 1028;
