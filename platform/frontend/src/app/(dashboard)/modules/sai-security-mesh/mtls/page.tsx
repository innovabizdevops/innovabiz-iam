...
const PAGE = "mTLS";
const KPIS = [{"l":"Total Sai Security Mesh","v":"4.722","t":"+6.9%","d":"up"},{"l":"MTLS Ativos","v":"7.243","t":"+10.0%","d":"up"},{"l":"Eficiência (%)","v":"78.0%","t":"-2.9%","d":"down"},{"l":"Score Performance","v":"73","t":"-1.7%","d":"down"}];
const COLS = ["ID","MTLS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sai Security Mesh #001","Sai Security Mesh #002","1.638","8.771","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Sai Security Mesh #002","Sai Security Mesh #003","2.186","6.702","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Sai Security Mesh #003","Sai Security Mesh #004","4.510","1.718","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Sai Security Mesh #004","Sai Security Mesh #005","5.945","907","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sai Security Mesh #005","Sai Security Mesh #001","8.353","3.995","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":742},{"label":"Mar","value":549},{"label":"Abr","value":622},{"label":"Mai","value":816},{"label":"Jun","value":624},{"label":"Jul","value":571},{"label":"Ago","value":566},{"label":"Set","value":760},{"label":"Out","value":610},{"label":"Nov","value":710},{"label":"Dez","value":631}];
const MX = 816;
