...
const ACCENT = "#991b1b";
const MODULE = "S-AI Security Mesh";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Sai Security Mesh","v":"8.081","t":"+9.6%","d":"up"},{"l":"Monitor Ativos","v":"662","t":"+10.6%","d":"up"},{"l":"Eficiência (%)","v":"90.6%","t":"+10.4%","d":"up"},{"l":"Score Performance","v":"55","t":"+6.2%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sai Security Mesh #001","Sai Security Mesh #002","4.643","6.958","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Sai Security Mesh #002","Sai Security Mesh #003","6.627","6.426","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Sai Security Mesh #003","Sai Security Mesh #004","7.458","1.594","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Sai Security Mesh #004","Sai Security Mesh #005","6.729","560","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sai Security Mesh #005","Sai Security Mesh #001","7.415","2.309","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":916},{"label":"Fev","value":920},{"label":"Mar","value":889},{"label":"Abr","value":1061},{"label":"Mai","value":891},{"label":"Jun","value":1093},{"label":"Jul","value":893},{"label":"Ago","value":851},{"label":"Set","value":908},{"label":"Out","value":877},{"label":"Nov","value":850},{"label":"Dez","value":829}];
const MX = 1093;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#991b1b'}}>RTM</span></h1>
                </div>
