...
/* ═══ S-AI Security Mesh — Dashboard ═══ */

const ACCENT = "#991b1b";

const KPIS = [
    { label: "Total Registos", value: "5489", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4447", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€81K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1494301489", cells: ["SAI-5489", "S-AI Security Mesh Item 1", "10/2/2026", "€1589"], status: "active" as const },
    { id: "1494305060", cells: ["SAI-9060", "S-AI Security Mesh Item 2", "25/9/2026", "€5160"], status: "pending" as const },
    { id: "1494308631", cells: ["SAI-3631", "S-AI Security Mesh Item 3", "12/4/2026", "€8731"], status: "completed" as const },
    { id: "1494312202", cells: ["SAI-7202", "S-AI Security Mesh Item 4", "27/11/2026", "€12 302"], status: "warning" as const },
    { id: "1494315773", cells: ["SAI-1773", "S-AI Security Mesh Item 5", "14/6/2026", "€15 873"], status: "active" as const },
];
...
export default function SaiSecurityMeshPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">S-AI Security Mesh</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • S-AI Security Mesh</p>
                    </div>
                </div>
