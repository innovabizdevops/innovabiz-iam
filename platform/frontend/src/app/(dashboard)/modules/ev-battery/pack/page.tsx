...
const PAGE = "Pack Assem";
const KPIS = [{"l":"Total Ev Battery","v":"853","t":"-3.3%","d":"down"},{"l":"Pack Assem Ativos","v":"6.333","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"84.9%","t":"+9.9%","d":"up"},{"l":"Score Performance","v":"89","t":"-2.7%","d":"down"}];
const COLS = ["ID","Pack Assem","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Battery #001","Ev Battery #002","8.285","4.312","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Battery #002","Ev Battery #003","5.747","7.753","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Battery #003","Ev Battery #004","3.381","8.594","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Battery #004","Ev Battery #005","2.353","6.631","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Battery #005","Ev Battery #001","3.787","6.914","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":950},{"label":"Mar","value":1025},{"label":"Abr","value":663},{"label":"Mai","value":652},{"label":"Jun","value":647},{"label":"Jul","value":723},{"label":"Ago","value":704},{"label":"Set","value":688},{"label":"Out","value":976},{"label":"Nov","value":893},{"label":"Dez","value":997}];
const MX = 1025;
