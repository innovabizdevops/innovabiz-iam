...
const KPIS = [{"l":"Total Ev Battery","v":"2.307","t":"+11.1%","d":"up"},{"l":"Recycling Ativos","v":"2.614","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"74.6%","t":"+8.3%","d":"up"},{"l":"Score Performance","v":"81","t":"-0.6%","d":"down"}];
const COLS = ["ID","Recycling","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Battery #001","Ev Battery #002","4.620","455","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Battery #002","Ev Battery #003","2.293","3.453","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Battery #003","Ev Battery #004","7.170","8.602","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Battery #004","Ev Battery #005","118","3.771","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Battery #005","Ev Battery #001","1.948","6.391","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":552},{"label":"Mar","value":607},{"label":"Abr","value":738},{"label":"Mai","value":821},{"label":"Jun","value":586},{"label":"Jul","value":798},{"label":"Ago","value":537},{"label":"Set","value":855},{"label":"Out","value":505},{"label":"Nov","value":849},{"label":"Dez","value":560}];
const MX = 855;
