...
const ACCENT = "#6366f1";
const MODULE = "EV Battery Mgmt";
const PAGE = "BMS";
const KPIS = [{"l":"Total Ev Battery","v":"1.163","t":"-2.4%","d":"down"},{"l":"BMS Ativos","v":"8.028","t":"-4.8%","d":"down"},{"l":"Eficiência (%)","v":"82.8%","t":"+8.9%","d":"up"},{"l":"Score Performance","v":"86","t":"+7.3%","d":"up"}];
const COLS = ["ID","BMS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Battery #001","Ev Battery #002","6.742","2.110","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Battery #002","Ev Battery #003","4.961","7.121","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Battery #003","Ev Battery #004","4.206","2.309","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Battery #004","Ev Battery #005","231","1.157","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Battery #005","Ev Battery #001","7.630","6.311","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":402},{"label":"Fev","value":557},{"label":"Mar","value":756},{"label":"Abr","value":581},{"label":"Mai","value":410},{"label":"Jun","value":672},{"label":"Jul","value":526},{"label":"Ago","value":477},{"label":"Set","value":425},{"label":"Out","value":501},{"label":"Nov","value":652},{"label":"Dez","value":758}];
const MX = 758;
