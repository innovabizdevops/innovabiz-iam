...
const KPIS = [{"l":"Formulários Ativos","v":"6.269","t":"-1.0%","d":"down"},{"l":"Submissões/Dia","v":"3204","t":"+9.2%","d":"up"},{"l":"Documentos Gerados","v":"6.316","t":"+2.4%","d":"up"},{"l":"Templates","v":"5.049","t":"+14.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.504","2026-02-07","4.161","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.472","2026-01-16","5.460","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.156","2026-02-08","7.531","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.350","2026-01-25","6.850","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.182","2026-01-01","3.798","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":406},{"label":"Mar","value":495},{"label":"Abr","value":409},{"label":"Mai","value":681},{"label":"Jun","value":696},{"label":"Jul","value":565},{"label":"Ago","value":522},{"label":"Set","value":506},{"label":"Out","value":508},{"label":"Nov","value":631},{"label":"Dez","value":730}];
const MX = 730;
