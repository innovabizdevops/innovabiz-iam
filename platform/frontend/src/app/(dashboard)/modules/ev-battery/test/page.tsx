...
const PAGE = "Testing";
const KPIS = [{"l":"Total Ev Battery","v":"443","t":"+17.5%","d":"up"},{"l":"Testing Ativos","v":"5.675","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"79.6%","t":"+15.3%","d":"up"},{"l":"Score Performance","v":"69","t":"-1.8%","d":"down"}];
const COLS = ["ID","Testing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Battery #001","Ev Battery #002","6.564","5.964","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Battery #002","Ev Battery #003","2.906","4.198","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Battery #003","Ev Battery #004","1.114","2.555","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Battery #004","Ev Battery #005","1.000","8.376","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Battery #005","Ev Battery #001","6.420","1.187","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":559},{"label":"Mar","value":545},{"label":"Abr","value":572},{"label":"Mai","value":631},{"label":"Jun","value":721},{"label":"Jul","value":704},{"label":"Ago","value":792},{"label":"Set","value":715},{"label":"Out","value":531},{"label":"Nov","value":743},{"label":"Dez","value":412}];
const MX = 792;
