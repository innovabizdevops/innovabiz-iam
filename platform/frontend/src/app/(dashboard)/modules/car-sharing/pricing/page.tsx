...
const PAGE = "Pricing";
const KPIS = [{"l":"ARR (€M)","v":"€25.1M","t":"+2.5%","d":"up"},{"l":"MRR (€)","v":"€90001","t":"+10.4%","d":"up"},{"l":"Churn (%)","v":"86.5%","t":"+12.1%","d":"up"},{"l":"ARPU (€)","v":"€2090","t":"+14.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 2904.37","2.509","€ 35662.18","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 630.46","2.046","€ 32088.69","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 38936.37","530","€ 35097.66","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 20488.59","1.666","€ 30836.12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 21559.76","1.637","€ 10082.98","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":759},{"label":"Mar","value":487},{"label":"Abr","value":480},{"label":"Mai","value":548},{"label":"Jun","value":499},{"label":"Jul","value":817},{"label":"Ago","value":817},{"label":"Set","value":646},{"label":"Out","value":657},{"label":"Nov","value":442},{"label":"Dez","value":668}];
const MX = 817;
