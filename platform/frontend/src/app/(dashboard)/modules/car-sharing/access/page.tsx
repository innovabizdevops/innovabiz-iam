...
const ACCENT = "#38bdf8";
const MODULE = "Car Sharing";
const PAGE = "Access";
const KPIS = [{"l":"Total Car Sharing","v":"2.208","t":"+2.7%","d":"up"},{"l":"Access Ativos","v":"379","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"84.6%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"90","t":"+3.1%","d":"up"}];
const COLS = ["ID","Access","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Car Sharing #001","Car Sharing #002","6.361","489","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Car Sharing #002","Car Sharing #003","2.025","7.974","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Car Sharing #003","Car Sharing #004","8.761","1.413","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Car Sharing #004","Car Sharing #005","648","2.188","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Car Sharing #005","Car Sharing #001","3.015","3.575","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":939},{"label":"Fev","value":995},{"label":"Mar","value":848},{"label":"Abr","value":1003},{"label":"Mai","value":762},{"label":"Jun","value":1044},{"label":"Jul","value":951},{"label":"Ago","value":757},{"label":"Set","value":924},{"label":"Out","value":934},{"label":"Nov","value":844},{"label":"Dez","value":719}];
const MX = 1044;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#38bdf8'}}>IoT</span></h1>
                </div>
