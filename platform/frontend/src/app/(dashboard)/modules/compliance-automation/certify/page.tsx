...
const PAGE = "Certify";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.089","t":"+10.0%","d":"up"},{"l":"NC Abertas","v":"5.800","t":"+11.3%","d":"up"},{"l":"Conformidade (%)","v":"81.3%","t":"-5.2%","d":"down"},{"l":"CAPAs Pendentes","v":"3.504","t":"+17.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.846","97.8%","6.448","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.668","82.8%","6.840","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.074","90.2%","7.983","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.323","87.6%","3.793","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.477","92.3%","6.677","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":590},{"label":"Mar","value":433},{"label":"Abr","value":410},{"label":"Mai","value":376},{"label":"Jun","value":281},{"label":"Jul","value":604},{"label":"Ago","value":497},{"label":"Set","value":430},{"label":"Out","value":321},{"label":"Nov","value":533},{"label":"Dez","value":397}];
const MX = 605;
