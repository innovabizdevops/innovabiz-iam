...
const KPIS = [
    { label: "Total Registos", value: "4524", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "341", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€222K", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "706607024", cells: ["COM-9024", "Compliance Automation Item 1", "5/9/2026", "€7124"], status: "active" as const },
    { id: "706610595", cells: ["COM-3595", "Compliance Automation Item 2", "20/4/2026", "€10 695"], status: "pending" as const },
    { id: "706614166", cells: ["COM-7166", "Compliance Automation Item 3", "7/11/2026", "€14 266"], status: "completed" as const },
    { id: "706617737", cells: ["COM-1737", "Compliance Automation Item 4", "22/6/2026", "€17 837"], status: "warning" as const },
    { id: "706621308", cells: ["COM-5308", "Compliance Automation Item 5", "9/1/2026", "€21 408"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Compliance Automation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Compliance Automation</p>
                    </div>
                </div>
