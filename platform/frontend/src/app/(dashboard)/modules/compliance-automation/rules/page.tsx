...
const PAGE = "Rule Engine";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.898","t":"+13.6%","d":"up"},{"l":"NC Abertas","v":"3.468","t":"+17.5%","d":"up"},{"l":"Conformidade (%)","v":"75.3%","t":"+8.8%","d":"up"},{"l":"CAPAs Pendentes","v":"949","t":"-4.1%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.508","93.6%","1.079","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.063","71.8%","4.606","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.582","87.5%","7.395","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.278","86.1%","1.974","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","973","98.5%","2.183","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":642},{"label":"Mar","value":862},{"label":"Abr","value":774},{"label":"Mai","value":710},{"label":"Jun","value":884},{"label":"Jul","value":795},{"label":"Ago","value":862},{"label":"Set","value":883},{"label":"Out","value":820},{"label":"Nov","value":908},{"label":"Dez","value":898}];
const MX = 908;
