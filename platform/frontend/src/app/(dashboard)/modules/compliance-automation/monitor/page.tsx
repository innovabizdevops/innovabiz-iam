...
const PAGE = "Monitor";
const KPIS = [{"l":"Auditorias Realizadas","v":"194","t":"+6.0%","d":"up"},{"l":"NC Abertas","v":"3.706","t":"+10.3%","d":"up"},{"l":"Conformidade (%)","v":"82.9%","t":"+1.6%","d":"up"},{"l":"CAPAs Pendentes","v":"4.801","t":"+6.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.530","94.5%","5.531","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.127","94.0%","1.579","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.807","82.8%","4.715","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.170","77.3%","7.803","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.870","71.6%","7.304","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":597},{"label":"Mar","value":457},{"label":"Abr","value":428},{"label":"Mai","value":592},{"label":"Jun","value":592},{"label":"Jul","value":424},{"label":"Ago","value":543},{"label":"Set","value":731},{"label":"Out","value":751},{"label":"Nov","value":629},{"label":"Dez","value":459}];
const MX = 777;
