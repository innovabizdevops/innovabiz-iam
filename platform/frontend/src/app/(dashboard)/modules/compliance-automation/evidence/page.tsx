...
const PAGE = "Evidence";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.253","t":"+15.4%","d":"up"},{"l":"NC Abertas","v":"7.803","t":"-4.1%","d":"down"},{"l":"Conformidade (%)","v":"93.9%","t":"+8.5%","d":"up"},{"l":"CAPAs Pendentes","v":"7.124","t":"+15.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","788","76.1%","3.368","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.961","77.3%","2.198","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.334","93.4%","2.354","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.265","73.6%","5.078","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.242","76.2%","2.090","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":955},{"label":"Fev","value":854},{"label":"Mar","value":801},{"label":"Abr","value":700},{"label":"Mai","value":877},{"label":"Jun","value":983},{"label":"Jul","value":703},{"label":"Ago","value":923},{"label":"Set","value":891},{"label":"Out","value":655},{"label":"Nov","value":852},{"label":"Dez","value":856}];
const MX = 983;
