...
const ACCENT = "#dc2626";
const MODULE = "Compliance Automation";
const PAGE = "Remediate";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.532","t":"-1.4%","d":"down"},{"l":"NC Abertas","v":"5.781","t":"+11.4%","d":"up"},{"l":"Conformidade (%)","v":"66.2%","t":"+11.6%","d":"up"},{"l":"CAPAs Pendentes","v":"6.281","t":"+8.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.112","96.1%","6.129","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.396","78.6%","934","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.133","95.5%","7.954","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.151","72.2%","4.385","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.476","75.9%","3.163","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":851},{"label":"Mar","value":674},{"label":"Abr","value":882},{"label":"Mai","value":678},{"label":"Jun","value":835},{"label":"Jul","value":681},{"label":"Ago","value":857},{"label":"Set","value":916},{"label":"Out","value":1001},{"label":"Nov","value":826},{"label":"Dez","value":942}];
const MX = 1001;
