...
const PAGE = "Downstream Impact";
const KPIS = [{"l":"Dashboards Ativos","v":"7.723","t":"+13.0%","d":"up"},{"l":"Queries/Dia","v":"3600","t":"-5.6%","d":"down"},{"l":"Dados Processados (GB)","v":"2.331","t":"+9.9%","d":"up"},{"l":"Utilizadores Analytics","v":"1.674","t":"+2.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1883","2026-01-06","6.236","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4767","2026-02-28","2.893","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3079","2026-01-26","5.945","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4449","2026-01-12","8.212","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2948","2026-03-24","8.540","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":328},{"label":"Fev","value":393},{"label":"Mar","value":516},{"label":"Abr","value":249},{"label":"Mai","value":569},{"label":"Jun","value":334},{"label":"Jul","value":350},{"label":"Ago","value":385},{"label":"Set","value":234},{"label":"Out","value":464},{"label":"Nov","value":232},{"label":"Dez","value":397}];
const MX = 569;
