...
const PAGE = "Lineage Graph";
const KPIS = [{"l":"Dashboards Ativos","v":"1.621","t":"+16.8%","d":"up"},{"l":"Queries/Dia","v":"4424","t":"+12.0%","d":"up"},{"l":"Dados Processados (GB)","v":"8.217","t":"-3.4%","d":"down"},{"l":"Utilizadores Analytics","v":"4.212","t":"-2.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","148","2026-02-03","745","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1976","2026-02-21","407","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2066","2026-01-14","3.937","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1309","2026-01-21","6.620","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3403","2026-03-04","2.732","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":488},{"label":"Fev","value":674},{"label":"Mar","value":816},{"label":"Abr","value":666},{"label":"Mai","value":651},{"label":"Jun","value":545},{"label":"Jul","value":771},{"label":"Ago","value":478},{"label":"Set","value":768},{"label":"Out","value":668},{"label":"Nov","value":750},{"label":"Dez","value":704}];
const MX = 816;
