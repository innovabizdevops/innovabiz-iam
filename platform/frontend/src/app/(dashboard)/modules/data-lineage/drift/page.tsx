...
const ACCENT = "#4338ca";
const MODULE = "Data Lineage";
const PAGE = "Drift Detection";
const KPIS = [{"l":"Dashboards Ativos","v":"4.060","t":"+1.9%","d":"up"},{"l":"Queries/Dia","v":"4281","t":"+11.9%","d":"up"},{"l":"Dados Processados (GB)","v":"1.439","t":"-0.7%","d":"down"},{"l":"Utilizadores Analytics","v":"5.860","t":"+2.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4821","2026-03-24","4.140","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1885","2026-03-13","8.291","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1957","2026-02-28","1.579","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","550","2026-02-17","1.371","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3961","2026-01-11","3.032","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":716},{"label":"Mar","value":441},{"label":"Abr","value":654},{"label":"Mai","value":346},{"label":"Jun","value":580},{"label":"Jul","value":471},{"label":"Ago","value":454},{"label":"Set","value":706},{"label":"Out","value":347},{"label":"Nov","value":340},{"label":"Dez","value":346}];
const MX = 716;
