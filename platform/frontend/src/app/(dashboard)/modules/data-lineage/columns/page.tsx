...
const PAGE = "Column Tracking";
const KPIS = [{"l":"Dashboards Ativos","v":"4.426","t":"+6.4%","d":"up"},{"l":"Queries/Dia","v":"3642","t":"-3.0%","d":"down"},{"l":"Dados Processados (GB)","v":"112","t":"+12.4%","d":"up"},{"l":"Utilizadores Analytics","v":"4.796","t":"+15.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","932","2026-01-05","8.068","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4099","2026-02-15","6.018","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3374","2026-03-02","3.259","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","912","2026-01-04","2.262","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2268","2026-02-15","315","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":405},{"label":"Mar","value":520},{"label":"Abr","value":517},{"label":"Mai","value":628},{"label":"Jun","value":638},{"label":"Jul","value":790},{"label":"Ago","value":549},{"label":"Set","value":610},{"label":"Out","value":691},{"label":"Nov","value":422},{"label":"Dez","value":736}];
const MX = 790;
