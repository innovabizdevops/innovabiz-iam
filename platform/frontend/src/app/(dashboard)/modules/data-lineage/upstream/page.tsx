...
const PAGE = "Upstream Sources";
const KPIS = [{"l":"Dashboards Ativos","v":"5.267","t":"-5.9%","d":"down"},{"l":"Queries/Dia","v":"4492","t":"+7.4%","d":"up"},{"l":"Dados Processados (GB)","v":"7.556","t":"+8.8%","d":"up"},{"l":"Utilizadores Analytics","v":"5.943","t":"+13.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3171","2026-03-28","4.947","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1890","2026-03-07","3.005","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2113","2026-01-18","3.176","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","682","2026-03-24","5.257","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3795","2026-02-09","3.822","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":714},{"label":"Fev","value":527},{"label":"Mar","value":766},{"label":"Abr","value":597},{"label":"Mai","value":574},{"label":"Jun","value":571},{"label":"Jul","value":538},{"label":"Ago","value":434},{"label":"Set","value":747},{"label":"Out","value":728},{"label":"Nov","value":718},{"label":"Dez","value":693}];
const MX = 766;
