...
const ROWS = [
  { id: "001", c: ["Proof Of Concept-001", "Proof Of Concept Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Proof Of Concept-002", "Proof Of Concept Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Proof Of Concept-003", "Proof Of Concept Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Proof Of Concept-004", "Proof Of Concept Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Proof Of Concept-005", "Proof Of Concept Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Proof Of Concept", ts: "Há 2min", a: "Sistema" },
