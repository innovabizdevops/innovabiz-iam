...
const ROWS = [
  { id: "001", c: ["Reference Arch-001", "Reference Arch Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Reference Arch-002", "Reference Arch Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Reference Arch-003", "Reference Arch Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Reference Arch-004", "Reference Arch Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Reference Arch-005", "Reference Arch Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Reference Arch", ts: "Há 2min", a: "Sistema" },
...
export default function ReferenceArchPage() {
  return (
