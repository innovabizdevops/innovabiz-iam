...
const ROWS = [
  { id: "001", c: ["Security Arch-001", "Security Arch Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Security Arch-002", "Security Arch Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Security Arch-003", "Security Arch Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Security Arch-004", "Security Arch Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Security Arch-005", "Security Arch Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Security Arch", ts: "Há 2min", a: "Sistema" },
...
export default function SecurityArchPage() {
  return (
