...
const ROWS = [
  { id: "001", c: ["Non Functional Req-001", "Non Functional Req Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Non Functional Req-002", "Non Functional Req Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Non Functional Req-003", "Non Functional Req Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Non Functional Req-004", "Non Functional Req Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Non Functional Req-005", "Non Functional Req Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Non Functional Req", ts: "Há 2min", a: "Sistema" },
...
export default function NonFunctionalReqPage() {
  return (
