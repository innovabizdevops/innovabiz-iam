...
const PAGE = "Architecture Decision";
const KPIS = [{"l":"Deploys/Dia","v":"47","d":"+12.3%","u":true},{"l":"Lead Time (min)","v":"23","d":"-15.2%","u":false},{"l":"MTTR (min)","v":"8.4","d":"-22.1%","u":false},{"l":"Uptime (%)","v":"99.99%","d":"+0.01%","u":true}];
const COLS = ["Pipeline","Serviço","Branch","Duração","Resultado","Estado"];
const ROWS = [
  { id: "001", c: ["Architecture Decision-001", "Architecture Decision Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Architecture Decision-002", "Architecture Decision Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Architecture Decision-003", "Architecture Decision Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Architecture Decision-004", "Architecture Decision Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Architecture Decision-005", "Architecture Decision Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Architecture Decision", ts: "Há 2min", a: "Sistema" },
...
export default function ArchitectureDecisionPage() {
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Solution Architecture — iBOS Enterprise</p>
        </div>
