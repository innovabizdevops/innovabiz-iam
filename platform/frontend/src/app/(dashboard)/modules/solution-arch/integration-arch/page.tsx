...
const PAGE = "Integration Arch";
const KPIS = [{"l":"APIs Publicadas","v":"847","d":"+15.2%","u":true},{"l":"Chamadas/Dia (M)","v":"12.4","d":"+8.3%","u":true},{"l":"Uptime (%)","v":"99.97%","d":"+0.02%","u":true},{"l":"Integrações Ativas","v":"342","d":"+6.1%","u":true}];
const COLS = ["API","Versão","Chamadas/Dia","Latência (ms)","Erros (%)","Estado"];
const ROWS = [
  { id: "001", c: ["Integration Arch-001", "Integration Arch Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Integration Arch-002", "Integration Arch Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Integration Arch-003", "Integration Arch Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Integration Arch-004", "Integration Arch Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Integration Arch-005", "Integration Arch Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Integration Arch", ts: "Há 2min", a: "Sistema" },
...
export default function IntegrationArchPage() {
  return (
