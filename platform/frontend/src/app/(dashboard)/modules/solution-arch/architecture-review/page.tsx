...
const PAGE = "Architecture Review";
...
const ROWS = [
  { id: "001", c: ["Architecture Review-001", "Architecture Review Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Architecture Review-002", "Architecture Review Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Architecture Review-003", "Architecture Review Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Architecture Review-004", "Architecture Review Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Architecture Review-005", "Architecture Review Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Architecture Review", ts: "Há 2min", a: "Sistema" },
