...
export default function LabInfoSystemPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Lab Info System</h1><p className="text-sm text-muted-foreground">Lab Info System • iBOS Enterprise</p></div>
