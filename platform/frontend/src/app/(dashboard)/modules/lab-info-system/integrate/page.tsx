...
const KPIS = [{"l":"Integrações Ativas","v":"3.446","t":"+9.6%","d":"up"},{"l":"Chamadas/Hora","v":"3187","t":"+6.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"74.0%","t":"-5.4%","d":"down"},{"l":"Latência Média (ms)","v":"196ms","t":"+13.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.002","634","99.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.276","5.107","85.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.428","7.414","75.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.216","2.935","92.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","796","6.021","91.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":776},{"label":"Fev","value":853},{"label":"Mar","value":637},{"label":"Abr","value":654},{"label":"Mai","value":854},{"label":"Jun","value":853},{"label":"Jul","value":899},{"label":"Ago","value":1011},{"label":"Set","value":860},{"label":"Out","value":848},{"label":"Nov","value":938},{"label":"Dez","value":993}];
const MX = 1011;
