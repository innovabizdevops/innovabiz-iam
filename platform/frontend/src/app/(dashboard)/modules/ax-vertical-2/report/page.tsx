...
const PAGE = "Report";
const KPIS = [{"l":"Total Ax Vertical 2","v":"5.512","t":"+12.2%","d":"up"},{"l":"Report Ativos","v":"2.716","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"90.9%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"86","t":"+13.0%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Vertical 2 #001","Ax Vertical 2 #002","3.793","3.495","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Vertical 2 #002","Ax Vertical 2 #003","2.573","5.217","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Vertical 2 #003","Ax Vertical 2 #004","2.907","5.214","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Vertical 2 #004","Ax Vertical 2 #005","5.672","7.241","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Vertical 2 #005","Ax Vertical 2 #001","187","4.492","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":572},{"label":"Mar","value":530},{"label":"Abr","value":805},{"label":"Mai","value":557},{"label":"Jun","value":582},{"label":"Jul","value":618},{"label":"Ago","value":492},{"label":"Set","value":502},{"label":"Out","value":553},{"label":"Nov","value":820},{"label":"Dez","value":674}];
const MX = 820;
