...
/* ═══ AX Financial Agent Hub — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "7372", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1324", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€497K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1927774872", cells: ["AX-2872", "AX Financial Agent Hub Item 1", "17/1/2026", "€24 972"], status: "active" as const },
    { id: "1927778443", cells: ["AX-6443", "AX Financial Agent Hub Item 2", "4/8/2026", "€28 543"], status: "pending" as const },
    { id: "1927782014", cells: ["AX-1014", "AX Financial Agent Hub Item 3", "19/3/2026", "€32 114"], status: "completed" as const },
    { id: "1927785585", cells: ["AX-4585", "AX Financial Agent Hub Item 4", "6/10/2026", "€35 685"], status: "warning" as const },
    { id: "1927789156", cells: ["AX-8156", "AX Financial Agent Hub Item 5", "21/5/2026", "€39 256"], status: "active" as const },
];
...
export default function AxFinancialAgentHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AX Financial Agent Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AX Financial Agent Hub</p>
                    </div>
                </div>
