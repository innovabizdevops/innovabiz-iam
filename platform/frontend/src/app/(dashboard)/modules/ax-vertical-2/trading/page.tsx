...
const ACCENT = "#4f46e5";
const MODULE = "AX Financial Agent Hub";
const PAGE = "Trading";
const KPIS = [{"l":"Total Ax Vertical 2","v":"5.400","t":"+12.8%","d":"up"},{"l":"Trading Ativos","v":"1.580","t":"+0.6%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"64","t":"+17.0%","d":"up"}];
const COLS = ["ID","Trading","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Vertical 2 #001","Ax Vertical 2 #002","6.420","7.266","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Vertical 2 #002","Ax Vertical 2 #003","3.886","6.052","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Vertical 2 #003","Ax Vertical 2 #004","3.047","2.779","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Vertical 2 #004","Ax Vertical 2 #005","4.487","5.190","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Vertical 2 #005","Ax Vertical 2 #001","8.052","8.764","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":731},{"label":"Mar","value":384},{"label":"Abr","value":633},{"label":"Mai","value":494},{"label":"Jun","value":353},{"label":"Jul","value":727},{"label":"Ago","value":360},{"label":"Set","value":451},{"label":"Out","value":639},{"label":"Nov","value":546},{"label":"Dez","value":661}];
const MX = 731;
