...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"5.250","t":"+13.3%","d":"up"},{"l":"Mitigações Ativas","v":"1.114","t":"+15.4%","d":"up"},{"l":"Score Risco Geral","v":"74","t":"+2.2%","d":"up"},{"l":"Incidentes YTD","v":"4.826","t":"+1.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.757","352","2.966","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.316","8.626","5.921","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.337","8.954","2.067","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.787","7.691","2.128","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.973","6.065","8.444","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":790},{"label":"Fev","value":723},{"label":"Mar","value":748},{"label":"Abr","value":440},{"label":"Mai","value":649},{"label":"Jun","value":528},{"label":"Jul","value":581},{"label":"Ago","value":608},{"label":"Set","value":805},{"label":"Out","value":755},{"label":"Nov","value":838},{"label":"Dez","value":621}];
const MX = 838;
