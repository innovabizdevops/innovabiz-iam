...
const ACCENT = "#6366f1";
const MODULE = "Store Design";
const PAGE = "3D Walk";
const KPIS = [{"l":"Pedidos/Dia","v":"1509","t":"-5.8%","d":"down"},{"l":"GMV (€)","v":"€68973","t":"+1.6%","d":"up"},{"l":"Conversão (%)","v":"82.5%","t":"+9.1%","d":"up"},{"l":"AOV (€)","v":"€19830","t":"+15.5%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 42402.33","164","2.620","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 10824.65","8.768","2.174","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 48828.81","6.317","6.962","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 25699.63","8.848","6.672","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 14890.73","253","8.131","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":766},{"label":"Mar","value":661},{"label":"Abr","value":958},{"label":"Mai","value":959},{"label":"Jun","value":700},{"label":"Jul","value":919},{"label":"Ago","value":923},{"label":"Set","value":765},{"label":"Out","value":692},{"label":"Nov","value":595},{"label":"Dez","value":621}];
const MX = 959;
...
export default function 3dwalkPage() {
    return (
