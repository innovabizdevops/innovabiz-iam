...
/* ═══ FP&A (APQC 7.6) — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "2020", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4225", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€286K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "-3%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2140401720", cells: ["FIN-4720", "FP&A (APQC 7.6) Item 1", "17/1/2026", "€1820"], status: "active" as const },
    { id: "2140405291", cells: ["FIN-8291", "FP&A (APQC 7.6) Item 2", "4/8/2026", "€5391"], status: "pending" as const },
    { id: "2140408862", cells: ["FIN-2862", "FP&A (APQC 7.6) Item 3", "19/3/2026", "€8962"], status: "completed" as const },
    { id: "2140412433", cells: ["FIN-6433", "FP&A (APQC 7.6) Item 4", "6/10/2026", "€12 533"], status: "warning" as const },
    { id: "2140416004", cells: ["FIN-1004", "FP&A (APQC 7.6) Item 5", "21/5/2026", "€16 104"], status: "active" as const },
];
...
export default function FpaApqc76Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">FP&A (APQC 7.6)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • FP&A (APQC 7.6)</p>
                    </div>
                </div>
