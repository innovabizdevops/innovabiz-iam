...
const ACCENT = "#dc2626";
const MODULE = "FP&A (APQC 7.6)";
const PAGE = "Forecast";
const KPIS = [{"l":"Total Financial Planning","v":"5.111","t":"+7.6%","d":"up"},{"l":"Forecast Ativos","v":"1.631","t":"+15.2%","d":"up"},{"l":"Eficiência (%)","v":"90.2%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"69","t":"+14.6%","d":"up"}];
const COLS = ["ID","Forecast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Planning #001","Financial Planning #002","2.954","3.477","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Planning #002","Financial Planning #003","1.536","4.309","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Planning #003","Financial Planning #004","6.581","2.501","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Planning #004","Financial Planning #005","8.015","1.107","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Planning #005","Financial Planning #001","2.227","5.111","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":436},{"label":"Mar","value":601},{"label":"Abr","value":408},{"label":"Mai","value":448},{"label":"Jun","value":526},{"label":"Jul","value":554},{"label":"Ago","value":611},{"label":"Set","value":485},{"label":"Out","value":503},{"label":"Nov","value":507},{"label":"Dez","value":573}];
const MX = 611;
