...
const PAGE = "Budget";
const KPIS = [{"l":"Total Financial Planning","v":"2.769","t":"+12.9%","d":"up"},{"l":"Budget Ativos","v":"€34052","t":"+5.8%","d":"up"},{"l":"Eficiência (%)","v":"75.0%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"76","t":"+4.5%","d":"up"}];
const COLS = ["ID","Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Planning #001","€ 25563.11","3.037","8.225","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Planning #002","€ 38473.77","4.145","5.044","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Planning #003","€ 26792.12","2.203","4.206","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Planning #004","€ 49947.15","6.216","7.600","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Planning #005","€ 19074.37","1.237","7.804","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":893},{"label":"Mar","value":904},{"label":"Abr","value":752},{"label":"Mai","value":1012},{"label":"Jun","value":809},{"label":"Jul","value":1024},{"label":"Ago","value":674},{"label":"Set","value":954},{"label":"Out","value":879},{"label":"Nov","value":679},{"label":"Dez","value":916}];
const MX = 1024;
