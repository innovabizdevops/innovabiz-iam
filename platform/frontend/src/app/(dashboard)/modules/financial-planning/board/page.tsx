...
const PAGE = "Board Pack";
const KPIS = [{"l":"Teams Ativos","v":"1.036","t":"+15.1%","d":"up"},{"l":"Reuniões/Semana","v":"872","t":"+2.3%","d":"up"},{"l":"Mensagens/Dia","v":"1310","t":"+5.1%","d":"up"},{"l":"Ficheiros Partilhados","v":"5.791","t":"+0.7%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.384","4318","395","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","8.488","1793","6.672","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.696","4032","2.572","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","8.462","2207","7.220","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","7.914","2733","6.412","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":889},{"label":"Fev","value":590},{"label":"Mar","value":748},{"label":"Abr","value":695},{"label":"Mai","value":823},{"label":"Jun","value":587},{"label":"Jul","value":696},{"label":"Ago","value":671},{"label":"Set","value":633},{"label":"Out","value":903},{"label":"Nov","value":603},{"label":"Dez","value":598}];
const MX = 903;
