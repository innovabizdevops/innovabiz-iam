...
/* ═══ Golf Course Management — Dashboard ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total Registos", value: "7133", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1028", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€245K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1200035533", cells: ["GOL-3533", "Golf Course Management Item 1", "26/2/2026", "€35 633"], status: "active" as const },
    { id: "1200039104", cells: ["GOL-7104", "Golf Course Management Item 2", "13/9/2026", "€39 204"], status: "pending" as const },
    { id: "1200042675", cells: ["GOL-1675", "Golf Course Management Item 3", "28/4/2026", "€42 775"], status: "completed" as const },
    { id: "1200046246", cells: ["GOL-5246", "Golf Course Management Item 4", "15/11/2026", "€46 346"], status: "warning" as const },
    { id: "1200049817", cells: ["GOL-8817", "Golf Course Management Item 5", "2/6/2026", "€49 917"], status: "active" as const },
];
...
export default function GolfCourseManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Golf Course Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Golf Course Management</p>
                    </div>
                </div>
