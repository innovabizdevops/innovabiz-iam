...
const PAGE = "Tee Time";
const KPIS = [{"l":"Total Golf Mgmt","v":"2.868","t":"+11.5%","d":"up"},{"l":"Tee Time Ativos","v":"1.296","t":"+11.9%","d":"up"},{"l":"Eficiência (%)","v":"84.4%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"60","t":"+2.7%","d":"up"}];
const COLS = ["ID","Tee Time","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Golf Mgmt #001","Golf Mgmt #002","1.095","163","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Golf Mgmt #002","Golf Mgmt #003","8.998","4.551","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Golf Mgmt #003","Golf Mgmt #004","4.216","2.115","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Golf Mgmt #004","Golf Mgmt #005","7.765","8.753","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Golf Mgmt #005","Golf Mgmt #001","815","9.049","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":628},{"label":"Mar","value":826},{"label":"Abr","value":513},{"label":"Mai","value":506},{"label":"Jun","value":809},{"label":"Jul","value":525},{"label":"Ago","value":802},{"label":"Set","value":602},{"label":"Out","value":558},{"label":"Nov","value":538},{"label":"Dez","value":628}];
const MX = 826;
