...
const PAGE = "Event";
const KPIS = [{"l":"Total Golf Mgmt","v":"8.655","t":"+11.6%","d":"up"},{"l":"Event Ativos","v":"7.508","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"+7.4%","d":"up"},{"l":"Score Performance","v":"66","t":"-5.0%","d":"down"}];
const COLS = ["ID","Event","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Golf Mgmt #001","Golf Mgmt #002","5.949","4.977","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Golf Mgmt #002","Golf Mgmt #003","3.586","4.185","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Golf Mgmt #003","Golf Mgmt #004","3.254","7.387","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Golf Mgmt #004","Golf Mgmt #005","4.721","4.335","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Golf Mgmt #005","Golf Mgmt #001","4.534","1.951","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":766},{"label":"Mar","value":570},{"label":"Abr","value":566},{"label":"Mai","value":578},{"label":"Jun","value":671},{"label":"Jul","value":451},{"label":"Ago","value":643},{"label":"Set","value":724},{"label":"Out","value":736},{"label":"Nov","value":821},{"label":"Dez","value":572}];
const MX = 821;
