...
const ACCENT = "#b91c1c";
const MODULE = "Golf Course Management";
const PAGE = "Course";
const KPIS = [{"l":"Total Golf Mgmt","v":"6.078","t":"-2.0%","d":"down"},{"l":"Course Ativos","v":"1.828","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"92.1%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"82","t":"-4.6%","d":"down"}];
const COLS = ["ID","Course","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Golf Mgmt #001","Golf Mgmt #002","3.649","5.318","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Golf Mgmt #002","Golf Mgmt #003","176","2.150","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Golf Mgmt #003","Golf Mgmt #004","4.284","6.358","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Golf Mgmt #004","Golf Mgmt #005","5.989","2.706","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Golf Mgmt #005","Golf Mgmt #001","8.490","1.857","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":597},{"label":"Mar","value":456},{"label":"Abr","value":396},{"label":"Mai","value":431},{"label":"Jun","value":757},{"label":"Jul","value":554},{"label":"Ago","value":384},{"label":"Set","value":437},{"label":"Out","value":710},{"label":"Nov","value":634},{"label":"Dez","value":474}];
const MX = 757;
