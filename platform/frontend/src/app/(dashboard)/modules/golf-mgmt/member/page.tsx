...
const PAGE = "Member";
const KPIS = [{"l":"Total Golf Mgmt","v":"1.095","t":"+7.6%","d":"up"},{"l":"Member Ativos","v":"2.016","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"73.5%","t":"-2.8%","d":"down"},{"l":"Score Performance","v":"85","t":"+6.8%","d":"up"}];
const COLS = ["ID","Member","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Golf Mgmt #001","Golf Mgmt #002","1.901","5.431","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Golf Mgmt #002","Golf Mgmt #003","6.363","6.468","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Golf Mgmt #003","Golf Mgmt #004","652","253","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Golf Mgmt #004","Golf Mgmt #005","1.290","9.096","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Golf Mgmt #005","Golf Mgmt #001","305","6.170","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":858},{"label":"Fev","value":685},{"label":"Mar","value":795},{"label":"Abr","value":707},{"label":"Mai","value":940},{"label":"Jun","value":801},{"label":"Jul","value":732},{"label":"Ago","value":891},{"label":"Set","value":746},{"label":"Out","value":950},{"label":"Nov","value":679},{"label":"Dez","value":675}];
const MX = 950;
