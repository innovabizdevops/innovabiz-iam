...
const PAGE = "Exp Design";
const KPIS = [{"l":"Formulários Ativos","v":"2.813","t":"+14.3%","d":"up"},{"l":"Submissões/Dia","v":"730","t":"+13.3%","d":"up"},{"l":"Documentos Gerados","v":"6.178","t":"-4.1%","d":"down"},{"l":"Templates","v":"6.808","t":"-1.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.692","2026-01-05","1.162","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.215","2026-01-22","3.649","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.284","2026-03-08","735","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","941","2026-03-06","4.635","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.903","2026-01-28","8.828","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":745},{"label":"Mar","value":677},{"label":"Abr","value":436},{"label":"Mai","value":790},{"label":"Jun","value":620},{"label":"Jul","value":785},{"label":"Ago","value":729},{"label":"Set","value":456},{"label":"Out","value":645},{"label":"Nov","value":590},{"label":"Dez","value":791}];
const MX = 791;
