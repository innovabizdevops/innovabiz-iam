...
const ACCENT = "#6366f1";
const MODULE = "Cross-Docking";
const PAGE = "Sort Lane";
const KPIS = [{"l":"Total Cross Docking","v":"6.011","t":"+5.2%","d":"up"},{"l":"Sort Lane Ativos","v":"3.206","t":"+15.0%","d":"up"},{"l":"Eficiência (%)","v":"66.6%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"89","t":"+11.5%","d":"up"}];
const COLS = ["ID","Sort Lane","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cross Docking #001","Cross Docking #002","7.555","7.010","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Cross Docking #002","Cross Docking #003","2.823","977","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Cross Docking #003","Cross Docking #004","3.089","8.083","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Cross Docking #004","Cross Docking #005","8.506","4.048","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cross Docking #005","Cross Docking #001","7.339","1.802","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":804},{"label":"Mar","value":1037},{"label":"Abr","value":791},{"label":"Mai","value":998},{"label":"Jun","value":1079},{"label":"Jul","value":750},{"label":"Ago","value":1017},{"label":"Set","value":740},{"label":"Out","value":858},{"label":"Nov","value":795},{"label":"Dez","value":703}];
const MX = 1079;
