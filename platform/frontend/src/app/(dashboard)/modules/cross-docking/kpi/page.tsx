...
const PAGE = "KPI";
const KPIS = [{"l":"Total Cross Docking","v":"1.060","t":"+2.7%","d":"up"},{"l":"KPI Ativos","v":"7.696","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"94.0%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"80","t":"+12.5%","d":"up"}];
const COLS = ["ID","KPI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cross Docking #001","Cross Docking #002","6.497","8.648","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Cross Docking #002","Cross Docking #003","3.596","9.044","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Cross Docking #003","Cross Docking #004","4.881","3.877","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Cross Docking #004","Cross Docking #005","3.301","1.277","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cross Docking #005","Cross Docking #001","2.766","2.069","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":737},{"label":"Mar","value":624},{"label":"Abr","value":643},{"label":"Mai","value":649},{"label":"Jun","value":788},{"label":"Jul","value":960},{"label":"Ago","value":733},{"label":"Set","value":824},{"label":"Out","value":894},{"label":"Nov","value":818},{"label":"Dez","value":816}];
const MX = 960;
