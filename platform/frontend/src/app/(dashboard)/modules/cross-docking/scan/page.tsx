...
const PAGE = "Scan";
const KPIS = [{"l":"Total Cross Docking","v":"2.952","t":"-3.3%","d":"down"},{"l":"Scan Ativos","v":"7.877","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"67.8%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"72","t":"-2.2%","d":"down"}];
const COLS = ["ID","Scan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cross Docking #001","Cross Docking #002","2.937","4.417","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Cross Docking #002","Cross Docking #003","8.977","6.884","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Cross Docking #003","Cross Docking #004","1.397","1.089","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Cross Docking #004","Cross Docking #005","4.492","4.347","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cross Docking #005","Cross Docking #001","393","3.999","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":542},{"label":"Mar","value":456},{"label":"Abr","value":539},{"label":"Mai","value":362},{"label":"Jun","value":499},{"label":"Jul","value":511},{"label":"Ago","value":463},{"label":"Set","value":488},{"label":"Out","value":361},{"label":"Nov","value":689},{"label":"Dez","value":704}];
const MX = 708;
