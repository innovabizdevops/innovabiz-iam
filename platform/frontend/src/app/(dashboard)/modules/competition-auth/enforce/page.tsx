...
const PAGE = "Enforce";
const KPIS = [{"l":"Utilizadores Ativos","v":"1.213","t":"+12.8%","d":"up"},{"l":"Sessões/Dia","v":"2873","t":"+17.5%","d":"up"},{"l":"MFA Adoção (%)","v":"65.1%","t":"+4.7%","d":"up"},{"l":"Tentativas Bloqueadas","v":"8.338","t":"+4.4%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","963","1.004","6.522","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.440","9.068","2.868","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.166","915","1.401","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.321","3.125","494","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.520","6.757","2.374","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":808},{"label":"Fev","value":751},{"label":"Mar","value":952},{"label":"Abr","value":879},{"label":"Mai","value":831},{"label":"Jun","value":652},{"label":"Jul","value":921},{"label":"Ago","value":946},{"label":"Set","value":885},{"label":"Out","value":1004},{"label":"Nov","value":727},{"label":"Dez","value":877}];
const MX = 1004;
