...
/* ═══ Competition Authority — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "7891", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4342", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€483K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "-24%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "789225891", cells: ["COM-7891", "Competition Authority Item 1", "28/4/2026", "€25 991"], status: "active" as const },
    { id: "789229462", cells: ["COM-2462", "Competition Authority Item 2", "15/11/2026", "€29 562"], status: "pending" as const },
    { id: "789233033", cells: ["COM-6033", "Competition Authority Item 3", "2/6/2026", "€33 133"], status: "completed" as const },
    { id: "789236604", cells: ["COM-9604", "Competition Authority Item 4", "17/1/2026", "€36 704"], status: "warning" as const },
    { id: "789240175", cells: ["COM-4175", "Competition Authority Item 5", "4/8/2026", "€40 275"], status: "active" as const },
];
...
export default function CompetitionAuthorityPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Competition Authority</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Competition Authority</p>
                    </div>
                </div>
