...
const PAGE = "Cartel";
const KPIS = [{"l":"Utilizadores Ativos","v":"4.603","t":"+4.1%","d":"up"},{"l":"Sessões/Dia","v":"171","t":"+16.4%","d":"up"},{"l":"MFA Adoção (%)","v":"70.0%","t":"+3.7%","d":"up"},{"l":"Tentativas Bloqueadas","v":"5.361","t":"+10.9%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","8.422","4.124","343","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","173","8.223","3.149","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","644","638","7.920","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","409","2.949","2.231","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.348","8.344","4.385","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":743},{"label":"Mar","value":618},{"label":"Abr","value":984},{"label":"Mai","value":969},{"label":"Jun","value":934},{"label":"Jul","value":994},{"label":"Ago","value":755},{"label":"Set","value":911},{"label":"Out","value":931},{"label":"Nov","value":738},{"label":"Dez","value":785}];
const MX = 994;
