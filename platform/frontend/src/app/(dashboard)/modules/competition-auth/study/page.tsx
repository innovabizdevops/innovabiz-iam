...
const ACCENT = "#7c2d12";
const MODULE = "Competition Authority";
const PAGE = "Market Study";
const KPIS = [{"l":"Utilizadores Ativos","v":"8.595","t":"+4.7%","d":"up"},{"l":"Sessões/Dia","v":"2483","t":"-0.8%","d":"down"},{"l":"MFA Adoção (%)","v":"71.6%","t":"+10.5%","d":"up"},{"l":"Tentativas Bloqueadas","v":"6.131","t":"+17.9%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","8.629","6.493","2.024","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","832","576","1.338","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","2.574","3.594","4.481","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.675","1.503","7.658","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","2.696","7.944","2.385","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":550},{"label":"Fev","value":608},{"label":"Mar","value":326},{"label":"Abr","value":331},{"label":"Mai","value":531},{"label":"Jun","value":480},{"label":"Jul","value":303},{"label":"Ago","value":547},{"label":"Set","value":491},{"label":"Out","value":428},{"label":"Nov","value":607},{"label":"Dez","value":491}];
const MX = 608;
