...
const PAGE = "Merger";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.083","t":"+8.3%","d":"up"},{"l":"Sessões/Dia","v":"479","t":"+14.6%","d":"up"},{"l":"MFA Adoção (%)","v":"84.4%","t":"+6.2%","d":"up"},{"l":"Tentativas Bloqueadas","v":"454","t":"+0.1%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","8.109","7.590","5.231","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.143","7.728","2.322","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.166","7.486","2.650","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.667","1.446","3.683","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","309","342","5.388","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":361},{"label":"Fev","value":437},{"label":"Mar","value":381},{"label":"Abr","value":604},{"label":"Mai","value":601},{"label":"Jun","value":645},{"label":"Jul","value":331},{"label":"Ago","value":346},{"label":"Set","value":295},{"label":"Out","value":558},{"label":"Nov","value":599},{"label":"Dez","value":357}];
const MX = 645;
