...
const ACCENT = "#155e75";
const MODULE = "Uniform Rental";
const PAGE = "Track";
const KPIS = [{"l":"Formulários Ativos","v":"9.071","t":"+0.2%","d":"up"},{"l":"Submissões/Dia","v":"3918","t":"+7.0%","d":"up"},{"l":"Documentos Gerados","v":"8.265","t":"-4.9%","d":"down"},{"l":"Templates","v":"1.197","t":"+0.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.844","2026-02-03","3.324","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.883","2026-03-16","7.271","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.460","2026-01-12","2.192","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.863","2026-02-26","3.467","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.294","2026-01-22","4.147","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":973},{"label":"Fev","value":761},{"label":"Mar","value":1049},{"label":"Abr","value":718},{"label":"Mai","value":1001},{"label":"Jun","value":886},{"label":"Jul","value":834},{"label":"Ago","value":1054},{"label":"Set","value":1037},{"label":"Out","value":846},{"label":"Nov","value":1053},{"label":"Dez","value":1063}];
const MX = 1063;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#155e75'}}>IoT</span></h1>
                </div>
