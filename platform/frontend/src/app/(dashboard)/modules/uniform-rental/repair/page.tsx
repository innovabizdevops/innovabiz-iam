...
const PAGE = "Repair";
const KPIS = [{"l":"Formulários Ativos","v":"3.415","t":"-3.7%","d":"down"},{"l":"Submissões/Dia","v":"4913","t":"+17.2%","d":"up"},{"l":"Documentos Gerados","v":"6.682","t":"-5.8%","d":"down"},{"l":"Templates","v":"2.056","t":"+13.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.098","2026-01-25","5.780","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.404","2026-01-23","7.119","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.723","2026-03-27","7.392","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.937","2026-01-13","281","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.659","2026-01-05","7.840","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":448},{"label":"Fev","value":466},{"label":"Mar","value":360},{"label":"Abr","value":359},{"label":"Mai","value":415},{"label":"Jun","value":436},{"label":"Jul","value":667},{"label":"Ago","value":428},{"label":"Set","value":434},{"label":"Out","value":441},{"label":"Nov","value":435},{"label":"Dez","value":536}];
const MX = 667;
