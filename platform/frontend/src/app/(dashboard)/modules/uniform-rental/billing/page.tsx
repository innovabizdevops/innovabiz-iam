...
const PAGE = "Billing";
const KPIS = [{"l":"Formulários Ativos","v":"8.305","t":"+3.3%","d":"up"},{"l":"Submissões/Dia","v":"3383","t":"+15.5%","d":"up"},{"l":"Documentos Gerados","v":"6.405","t":"-2.8%","d":"down"},{"l":"Templates","v":"7.294","t":"+0.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.367","2026-03-17","8.076","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.144","2026-02-15","1.077","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.602","2026-01-28","6.017","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.148","2026-01-02","3.075","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.025","2026-02-14","4.859","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":736},{"label":"Mar","value":651},{"label":"Abr","value":616},{"label":"Mai","value":523},{"label":"Jun","value":476},{"label":"Jul","value":568},{"label":"Ago","value":673},{"label":"Set","value":611},{"label":"Out","value":397},{"label":"Nov","value":442},{"label":"Dez","value":591}];
const MX = 736;
