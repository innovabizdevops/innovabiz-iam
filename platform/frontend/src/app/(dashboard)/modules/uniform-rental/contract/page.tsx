...
const PAGE = "Contract";
const KPIS = [{"l":"Formulários Ativos","v":"4.685","t":"+1.0%","d":"up"},{"l":"Submissões/Dia","v":"455","t":"+5.3%","d":"up"},{"l":"Documentos Gerados","v":"858","t":"+12.1%","d":"up"},{"l":"Templates","v":"1.992","t":"+16.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.692","2026-03-04","8.661","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.960","2026-01-21","4.356","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.409","2026-02-22","6.309","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.859","2026-02-27","3.386","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.953","2026-03-17","7.920","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":414},{"label":"Mar","value":589},{"label":"Abr","value":325},{"label":"Mai","value":661},{"label":"Jun","value":626},{"label":"Jul","value":528},{"label":"Ago","value":408},{"label":"Set","value":460},{"label":"Out","value":428},{"label":"Nov","value":438},{"label":"Dez","value":355}];
const MX = 661;
