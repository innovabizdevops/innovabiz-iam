...
/* ═══ Uniform Rental — Dashboard ═══ */

const ACCENT = "#155e75";

const KPIS = [
    { label: "Total Registos", value: "6696", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1053", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€282K", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "280532996", cells: ["UNI-3996", "Uniform Rental Item 1", "17/9/2026", "€33 096"], status: "active" as const },
    { id: "280536567", cells: ["UNI-7567", "Uniform Rental Item 2", "4/4/2026", "€36 667"], status: "pending" as const },
    { id: "280540138", cells: ["UNI-2138", "Uniform Rental Item 3", "19/11/2026", "€40 238"], status: "completed" as const },
    { id: "280543709", cells: ["UNI-5709", "Uniform Rental Item 4", "6/6/2026", "€43 809"], status: "warning" as const },
    { id: "280547280", cells: ["UNI-9280", "Uniform Rental Item 5", "21/1/2026", "€47 380"], status: "active" as const },
];
...
export default function UniformRentalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Uniform Rental</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Uniform Rental</p>
                    </div>
                </div>
