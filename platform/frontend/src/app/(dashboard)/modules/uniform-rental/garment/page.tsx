...
const PAGE = "Garment";
const KPIS = [{"l":"Formulários Ativos","v":"7.806","t":"+4.7%","d":"up"},{"l":"Submissões/Dia","v":"1309","t":"+16.7%","d":"up"},{"l":"Documentos Gerados","v":"314","t":"+6.2%","d":"up"},{"l":"Templates","v":"5.536","t":"+8.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.649","2026-03-22","6.392","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.344","2026-03-21","1.300","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","367","2026-03-18","5.967","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.718","2026-02-15","7.074","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.949","2026-01-05","690","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":566},{"label":"Mar","value":405},{"label":"Abr","value":626},{"label":"Mai","value":609},{"label":"Jun","value":536},{"label":"Jul","value":366},{"label":"Ago","value":386},{"label":"Set","value":597},{"label":"Out","value":623},{"label":"Nov","value":643},{"label":"Dez","value":638}];
const MX = 643;
