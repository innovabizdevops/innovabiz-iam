...
const KPIS = [{"l":"Dispositivos Online","v":"127","t":"+14.9%","d":"up"},{"l":"Dados/Min (MB)","v":"6.063","t":"+17.6%","d":"up"},{"l":"Alertas Ativos","v":"5.404","t":"+3.8%","d":"up"},{"l":"Uptime (%)","v":"70.0%","t":"+6.5%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.244","3.110","2.828","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.678","430","2.777","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.049","6.640","8.752","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","4.083","5.189","8.179","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.872","2.093","7.764","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":211},{"label":"Fev","value":359},{"label":"Mar","value":347},{"label":"Abr","value":544},{"label":"Mai","value":529},{"label":"Jun","value":478},{"label":"Jul","value":587},{"label":"Ago","value":498},{"label":"Set","value":394},{"label":"Out","value":240},{"label":"Nov","value":581},{"label":"Dez","value":375}];
const MX = 587;
