...
const PAGE = "LIMS";
const KPIS = [{"l":"Dispositivos Online","v":"886","t":"+11.5%","d":"up"},{"l":"Dados/Min (MB)","v":"3.600","t":"+5.6%","d":"up"},{"l":"Alertas Ativos","v":"8.086","t":"-1.7%","d":"down"},{"l":"Uptime (%)","v":"80.9%","t":"+5.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.291","3.529","3.357","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.395","3.653","7.787","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.972","5.774","511","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.378","4.737","2.967","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.227","3.629","5.196","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":229},{"label":"Fev","value":514},{"label":"Mar","value":560},{"label":"Abr","value":608},{"label":"Mai","value":469},{"label":"Jun","value":576},{"label":"Jul","value":400},{"label":"Ago","value":606},{"label":"Set","value":263},{"label":"Out","value":446},{"label":"Nov","value":310},{"label":"Dez","value":312}];
const MX = 608;
