...
const PAGE = "Genomics";
const KPIS = [{"l":"Dispositivos Online","v":"5.256","t":"+6.2%","d":"up"},{"l":"Dados/Min (MB)","v":"8.910","t":"+1.6%","d":"up"},{"l":"Alertas Ativos","v":"1.502","t":"+12.4%","d":"up"},{"l":"Uptime (%)","v":"88.6%","t":"+4.6%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","8.381","759","2.312","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","1.438","3.183","6.194","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.173","339","683","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.460","3.377","6.481","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.370","7.491","7.095","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":986},{"label":"Mar","value":1059},{"label":"Abr","value":871},{"label":"Mai","value":911},{"label":"Jun","value":817},{"label":"Jul","value":918},{"label":"Ago","value":892},{"label":"Set","value":787},{"label":"Out","value":782},{"label":"Nov","value":886},{"label":"Dez","value":854}];
const MX = 1059;
