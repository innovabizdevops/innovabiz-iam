...
const PAGE = "Report";
const KPIS = [{"l":"Dispositivos Online","v":"1.517","t":"-0.8%","d":"down"},{"l":"Dados/Min (MB)","v":"7.238","t":"+0.8%","d":"up"},{"l":"Alertas Ativos","v":"101","t":"+3.5%","d":"up"},{"l":"Uptime (%)","v":"86.2%","t":"-2.1%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.475","7.515","1.116","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.179","1.063","8.332","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.536","4.689","2.650","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","691","3.277","4.825","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.153","588","5.699","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":945},{"label":"Mar","value":807},{"label":"Abr","value":749},{"label":"Mai","value":951},{"label":"Jun","value":699},{"label":"Jul","value":799},{"label":"Ago","value":836},{"label":"Set","value":746},{"label":"Out","value":745},{"label":"Nov","value":618},{"label":"Dez","value":947}];
const MX = 951;
