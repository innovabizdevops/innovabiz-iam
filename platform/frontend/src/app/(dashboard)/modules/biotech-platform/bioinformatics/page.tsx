...
const ACCENT = "#9333ea";
const MODULE = "Biotech Research Platform";
const PAGE = "Bioinformatics";
const KPIS = [{"l":"Dispositivos Online","v":"263","t":"-3.9%","d":"down"},{"l":"Dados/Min (MB)","v":"1.626","t":"-1.4%","d":"down"},{"l":"Alertas Ativos","v":"7.274","t":"+16.8%","d":"up"},{"l":"Uptime (%)","v":"86.5%","t":"+7.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.137","8.511","2.744","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.325","1.135","106","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.874","1.331","3.519","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.574","3.540","8.686","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.309","6.375","596","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":614},{"label":"Fev","value":612},{"label":"Mar","value":718},{"label":"Abr","value":738},{"label":"Mai","value":798},{"label":"Jun","value":754},{"label":"Jul","value":597},{"label":"Ago","value":860},{"label":"Set","value":836},{"label":"Out","value":611},{"label":"Nov","value":577},{"label":"Dez","value":625}];
const MX = 860;
