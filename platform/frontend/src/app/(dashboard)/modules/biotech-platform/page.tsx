...
/* ═══ Biotech Research Platform — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "1159", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1678", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€169K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "-17%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1618918359", cells: ["BIO-8359", "Biotech Research Platform Item 1", "24/4/2026", "€18 459"], status: "active" as const },
    { id: "1618921930", cells: ["BIO-2930", "Biotech Research Platform Item 2", "11/11/2026", "€22 030"], status: "pending" as const },
    { id: "1618925501", cells: ["BIO-6501", "Biotech Research Platform Item 3", "26/6/2026", "€25 601"], status: "completed" as const },
    { id: "1618929072", cells: ["BIO-1072", "Biotech Research Platform Item 4", "13/1/2026", "€29 172"], status: "warning" as const },
    { id: "1618932643", cells: ["BIO-4643", "Biotech Research Platform Item 5", "28/8/2026", "€32 743"], status: "active" as const },
];
...
export default function BiotechResearchPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Biotech Research Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Biotech Research Platform</p>
                    </div>
                </div>
