...
const PAGE = "Clause";
const KPIS = [{"l":"Contratos Ativos","v":"4.049","t":"+2.3%","d":"up"},{"l":"Valor Total (€M)","v":"€44.3M","t":"+5.5%","d":"up"},{"l":"Renovações Próx. 30d","v":"6.288","t":"+6.3%","d":"up"},{"l":"Obrigações Pendentes","v":"3.979","t":"+5.6%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 42372.48","2026-03-23","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 15988.61","2026-03-09","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 4032.37","2026-02-22","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 27019.65","2026-02-22","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 226.58","2026-03-06","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":950},{"label":"Fev","value":980},{"label":"Mar","value":816},{"label":"Abr","value":684},{"label":"Mai","value":818},{"label":"Jun","value":749},{"label":"Jul","value":795},{"label":"Ago","value":965},{"label":"Set","value":979},{"label":"Out","value":695},{"label":"Nov","value":744},{"label":"Dez","value":896}];
const MX = 980;
