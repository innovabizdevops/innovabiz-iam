...
const PAGE = "Comply";
const KPIS = [{"l":"Contratos Ativos","v":"6.106","t":"-0.1%","d":"down"},{"l":"Valor Total (€M)","v":"€32.4M","t":"+17.9%","d":"up"},{"l":"Renovações Próx. 30d","v":"915","t":"+10.3%","d":"up"},{"l":"Obrigações Pendentes","v":"1.530","t":"+1.3%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 32905.29","2026-03-27","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 41851.16","2026-01-06","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 47120.19","2026-03-13","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 48535.97","2026-03-11","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 19541.72","2026-01-02","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":423},{"label":"Fev","value":489},{"label":"Mar","value":564},{"label":"Abr","value":712},{"label":"Mai","value":535},{"label":"Jun","value":407},{"label":"Jul","value":703},{"label":"Ago","value":632},{"label":"Set","value":795},{"label":"Out","value":641},{"label":"Nov","value":695},{"label":"Dez","value":668}];
const MX = 795;
