...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"653","t":"-0.2%","d":"down"},{"l":"Mitigações Ativas","v":"7.361","t":"+14.8%","d":"up"},{"l":"Score Risco Geral","v":"87","t":"-2.4%","d":"down"},{"l":"Incidentes YTD","v":"2.168","t":"-0.1%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.132","442","5.897","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.582","6.197","1.123","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.475","726","2.575","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","684","5.232","7.135","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.454","8.766","483","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":397},{"label":"Mar","value":702},{"label":"Abr","value":600},{"label":"Mai","value":461},{"label":"Jun","value":368},{"label":"Jul","value":413},{"label":"Ago","value":447},{"label":"Set","value":501},{"label":"Out","value":656},{"label":"Nov","value":559},{"label":"Dez","value":582}];
const MX = 702;
