...
const ACCENT = "#0891b2";
const MODULE = "Contract Intelligence";
const PAGE = "Extract";
const KPIS = [{"l":"Contratos Ativos","v":"1.393","t":"+8.0%","d":"up"},{"l":"Valor Total (€M)","v":"€18.1M","t":"+2.2%","d":"up"},{"l":"Renovações Próx. 30d","v":"1.405","t":"-2.7%","d":"down"},{"l":"Obrigações Pendentes","v":"2.985","t":"+2.4%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 46416.94","2026-03-09","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 6068.61","2026-02-16","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 38874.66","2026-03-07","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 13304.36","2026-03-05","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 7121.33","2026-03-24","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":931},{"label":"Fev","value":874},{"label":"Mar","value":781},{"label":"Abr","value":783},{"label":"Mai","value":964},{"label":"Jun","value":793},{"label":"Jul","value":1017},{"label":"Ago","value":832},{"label":"Set","value":991},{"label":"Out","value":885},{"label":"Nov","value":831},{"label":"Dez","value":1025}];
const MX = 1025;
