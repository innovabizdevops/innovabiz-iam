...
const KPIS = [
    { label: "Total Registos", value: "9886", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1383", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€302K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1839885186", cells: ["CON-7186", "Contract Intelligence Item 1", "7/7/2026", "€35 286"], status: "active" as const },
    { id: "1839888757", cells: ["CON-1757", "Contract Intelligence Item 2", "22/2/2026", "€38 857"], status: "pending" as const },
    { id: "1839892328", cells: ["CON-5328", "Contract Intelligence Item 3", "9/9/2026", "€42 428"], status: "completed" as const },
    { id: "1839895899", cells: ["CON-8899", "Contract Intelligence Item 4", "24/4/2026", "€45 999"], status: "warning" as const },
    { id: "1839899470", cells: ["CON-3470", "Contract Intelligence Item 5", "11/11/2026", "€49 570"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Contract Intelligence</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Contract Intelligence</p>
                    </div>
                </div>
