...
const KPIS = [
    ...
    { label: "Ativos", value: "4492", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€322K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "-16%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1626691533", cells: ["ESP-5533", "Esports Team Item 1", "6/10/2026", "€41 633"], status: "active" as const },
    { id: "1626695104", cells: ["ESP-9104", "Esports Team Item 2", "21/5/2026", "€45 204"], status: "pending" as const },
    { id: "1626698675", cells: ["ESP-3675", "Esports Team Item 3", "8/12/2026", "€48 775"], status: "completed" as const },
    { id: "1626702246", cells: ["ESP-7246", "Esports Team Item 4", "23/7/2026", "€2346"], status: "warning" as const },
    { id: "1626705817", cells: ["ESP-1817", "Esports Team Item 5", "10/2/2026", "€5917"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Esports Team</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Esports Team</p>
                    </div>
                </div>
