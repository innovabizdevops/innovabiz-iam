...
const PAGE = "Content";
const KPIS = [{"l":"Teams Ativos","v":"4.077","t":"-4.4%","d":"down"},{"l":"Reuniões/Semana","v":"1534","t":"+11.3%","d":"up"},{"l":"Mensagens/Dia","v":"2865","t":"+2.0%","d":"up"},{"l":"Ficheiros Partilhados","v":"3.898","t":"+4.6%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.487","1472","7.843","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","390","2111","5.206","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","444","3899","1.072","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.609","4000","1.649","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","8.948","1890","3.492","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":891},{"label":"Fev","value":828},{"label":"Mar","value":804},{"label":"Abr","value":641},{"label":"Mai","value":592},{"label":"Jun","value":572},{"label":"Jul","value":608},{"label":"Ago","value":832},{"label":"Set","value":597},{"label":"Out","value":707},{"label":"Nov","value":695},{"label":"Dez","value":964}];
const MX = 964;
