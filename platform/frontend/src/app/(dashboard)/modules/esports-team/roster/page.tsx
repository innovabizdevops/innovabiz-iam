...
const PAGE = "Roster";
const KPIS = [{"l":"Teams Ativos","v":"5.027","t":"+10.6%","d":"up"},{"l":"Reuniões/Semana","v":"1236","t":"+13.0%","d":"up"},{"l":"Mensagens/Dia","v":"2764","t":"+5.9%","d":"up"},{"l":"Ficheiros Partilhados","v":"2.098","t":"+16.7%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","2.340","4311","2.635","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.330","551","2.854","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","4.110","4965","5.988","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","3.666","757","5.260","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","7.288","3321","2.328","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":459},{"label":"Mar","value":619},{"label":"Abr","value":753},{"label":"Mai","value":493},{"label":"Jun","value":455},{"label":"Jul","value":791},{"label":"Ago","value":416},{"label":"Set","value":450},{"label":"Out","value":730},{"label":"Nov","value":553},{"label":"Dez","value":527}];
const MX = 791;
