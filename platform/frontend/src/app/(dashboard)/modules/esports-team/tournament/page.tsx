...
const ACCENT = "#6d28d9";
const MODULE = "Esports Team";
const PAGE = "Tournament";
const KPIS = [{"l":"Teams Ativos","v":"2.282","t":"+11.8%","d":"up"},{"l":"Reuniões/Semana","v":"1453","t":"+17.9%","d":"up"},{"l":"Mensagens/Dia","v":"3652","t":"-4.3%","d":"down"},{"l":"Ficheiros Partilhados","v":"793","t":"+15.9%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","2.837","503","6.854","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","9.019","1797","5.720","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","8.062","3128","5.536","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.326","1801","3.123","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","4.040","1427","1.788","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":802},{"label":"Mar","value":526},{"label":"Abr","value":847},{"label":"Mai","value":674},{"label":"Jun","value":839},{"label":"Jul","value":838},{"label":"Ago","value":784},{"label":"Set","value":791},{"label":"Out","value":823},{"label":"Nov","value":676},{"label":"Dez","value":687}];
const MX = 847;
