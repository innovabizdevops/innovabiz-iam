...
const PAGE = "Practice";
const KPIS = [{"l":"Teams Ativos","v":"1.186","t":"+14.8%","d":"up"},{"l":"Reuniões/Semana","v":"3435","t":"+16.3%","d":"up"},{"l":"Mensagens/Dia","v":"2182","t":"-1.2%","d":"down"},{"l":"Ficheiros Partilhados","v":"1.948","t":"+1.6%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","8.222","102","2.440","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.349","1498","2.222","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","3.240","1728","6.464","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.902","2123","4.656","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","318","3484","7.063","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":470},{"label":"Mar","value":545},{"label":"Abr","value":490},{"label":"Mai","value":592},{"label":"Jun","value":651},{"label":"Jul","value":771},{"label":"Ago","value":670},{"label":"Set","value":377},{"label":"Out","value":721},{"label":"Nov","value":535},{"label":"Dez","value":651}];
const MX = 771;
