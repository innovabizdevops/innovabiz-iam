...
const PAGE = "Consult";
const KPIS = [{"l":"Riscos Identificados","v":"5.361","t":"-5.7%","d":"down"},{"l":"Mitigações Ativas","v":"3.231","t":"+10.2%","d":"up"},{"l":"Score Risco Geral","v":"61","t":"+13.6%","d":"up"},{"l":"Incidentes YTD","v":"4.622","t":"+2.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.290","7.183","5.311","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","529","128","496","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.381","8.746","2.126","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.902","3.079","6.360","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.142","6.368","250","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":419},{"label":"Mar","value":755},{"label":"Abr","value":605},{"label":"Mai","value":538},{"label":"Jun","value":575},{"label":"Jul","value":511},{"label":"Ago","value":608},{"label":"Set","value":788},{"label":"Out","value":714},{"label":"Nov","value":645},{"label":"Dez","value":575}];
const MX = 788;
