...
const KPIS = [{"l":"Riscos Identificados","v":"5.408","t":"-1.9%","d":"down"},{"l":"Mitigações Ativas","v":"2.332","t":"+10.5%","d":"up"},{"l":"Score Risco Geral","v":"81","t":"+16.1%","d":"up"},{"l":"Incidentes YTD","v":"4.311","t":"-3.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.477","2.343","615","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.733","5.001","1.747","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.321","4.380","8.170","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.078","3.854","6.275","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.127","211","769","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":435},{"label":"Mar","value":448},{"label":"Abr","value":273},{"label":"Mai","value":539},{"label":"Jun","value":616},{"label":"Jul","value":636},{"label":"Ago","value":356},{"label":"Set","value":630},{"label":"Out","value":521},{"label":"Nov","value":349},{"label":"Dez","value":324}];
const MX = 636;
