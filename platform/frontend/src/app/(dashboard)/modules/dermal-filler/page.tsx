...
/* ═══ Dermal Filler Clinic — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "4221", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "957", trend: "+16%", trendDirection: "up" as const, icon: Users },
...
const TABLE_ROWS = [
    { id: "2011634621", cells: ["DER-9621", "Dermal Filler Clinic Item 1", "18/6/2026", "€34 721"], status: "active" as const },
    { id: "2011638192", cells: ["DER-4192", "Dermal Filler Clinic Item 2", "5/1/2026", "€38 292"], status: "pending" as const },
    { id: "2011641763", cells: ["DER-7763", "Dermal Filler Clinic Item 3", "20/8/2026", "€41 863"], status: "completed" as const },
    { id: "2011645334", cells: ["DER-2334", "Dermal Filler Clinic Item 4", "7/3/2026", "€45 434"], status: "warning" as const },
    { id: "2011648905", cells: ["DER-5905", "Dermal Filler Clinic Item 5", "22/10/2026", "€49 005"], status: "active" as const },
];
...
export default function DermalFillerClinicPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Dermal Filler Clinic</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Dermal Filler Clinic</p>
                    </div>
                </div>
