...
const ACCENT = "#be185d";
const MODULE = "Dermal Filler Clinic";
const PAGE = "Map";
const KPIS = [{"l":"Riscos Identificados","v":"2.136","t":"-5.3%","d":"down"},{"l":"Mitigações Ativas","v":"2.581","t":"+3.3%","d":"up"},{"l":"Score Risco Geral","v":"64","t":"+17.4%","d":"up"},{"l":"Incidentes YTD","v":"6.458","t":"-2.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.037","8.338","1.077","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.510","3.867","3.243","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.317","7.459","4.707","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.296","4.496","997","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.334","8.372","1.691","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":570},{"label":"Mar","value":666},{"label":"Abr","value":372},{"label":"Mai","value":514},{"label":"Jun","value":326},{"label":"Jul","value":492},{"label":"Ago","value":588},{"label":"Set","value":399},{"label":"Out","value":501},{"label":"Nov","value":492},{"label":"Dez","value":388}];
const MX = 666;
