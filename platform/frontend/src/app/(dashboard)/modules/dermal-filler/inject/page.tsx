...
const PAGE = "Inject";
const KPIS = [{"l":"Riscos Identificados","v":"4.105","t":"-4.4%","d":"down"},{"l":"Mitigações Ativas","v":"2.273","t":"-4.1%","d":"down"},{"l":"Score Risco Geral","v":"76","t":"+15.5%","d":"up"},{"l":"Incidentes YTD","v":"624","t":"+8.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.840","7.129","7.974","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.555","9.099","3.833","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.466","3.714","5.968","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.472","294","3.144","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.692","6.429","139","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":453},{"label":"Fev","value":641},{"label":"Mar","value":316},{"label":"Abr","value":466},{"label":"Mai","value":367},{"label":"Jun","value":575},{"label":"Jul","value":649},{"label":"Ago","value":409},{"label":"Set","value":261},{"label":"Out","value":274},{"label":"Nov","value":459},{"label":"Dez","value":581}];
const MX = 649;
