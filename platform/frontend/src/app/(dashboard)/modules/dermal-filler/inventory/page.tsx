...
const KPIS = [{"l":"Riscos Identificados","v":"7.297","t":"-4.4%","d":"down"},{"l":"Mitigações Ativas","v":"2.201","t":"+4.6%","d":"up"},{"l":"Score Risco Geral","v":"86","t":"+15.1%","d":"up"},{"l":"Incidentes YTD","v":"7.888","t":"+14.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.850","698","6.110","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.203","6.869","743","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.366","3.563","2.952","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.959","5.972","234","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.071","4.712","1.741","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":768},{"label":"Fev","value":900},{"label":"Mar","value":862},{"label":"Abr","value":678},{"label":"Mai","value":747},{"label":"Jun","value":767},{"label":"Jul","value":892},{"label":"Ago","value":738},{"label":"Set","value":751},{"label":"Out","value":772},{"label":"Nov","value":900},{"label":"Dez","value":757}];
const MX = 900;
