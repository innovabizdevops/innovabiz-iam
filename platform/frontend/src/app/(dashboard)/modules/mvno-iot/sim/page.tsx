...
const ACCENT = "#6366f1";
const MODULE = "MVNO IoT";
const PAGE = "IoT SIM";
const KPIS = [{"l":"Dispositivos Online","v":"3.354","t":"-5.9%","d":"down"},{"l":"Dados/Min (MB)","v":"7.863","t":"-4.5%","d":"down"},{"l":"Alertas Ativos","v":"7.319","t":"+8.6%","d":"up"},{"l":"Uptime (%)","v":"72.7%","t":"+4.2%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.265","6.393","2.104","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.327","2.972","1.003","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.710","8.615","2.199","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","9.076","1.788","4.927","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.877","6.261","2.926","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":655},{"label":"Mar","value":502},{"label":"Abr","value":518},{"label":"Mai","value":757},{"label":"Jun","value":598},{"label":"Jul","value":512},{"label":"Ago","value":687},{"label":"Set","value":516},{"label":"Out","value":768},{"label":"Nov","value":507},{"label":"Dez","value":801}];
const MX = 801;
