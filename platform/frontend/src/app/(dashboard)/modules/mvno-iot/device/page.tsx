...
const KPIS = [{"l":"Dispositivos Online","v":"3.789","t":"-1.1%","d":"down"},{"l":"Dados/Min (MB)","v":"2.823","t":"+1.8%","d":"up"},{"l":"Alertas Ativos","v":"5.714","t":"+14.2%","d":"up"},{"l":"Uptime (%)","v":"80.1%","t":"+11.4%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","8.982","1.057","7.950","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.910","5.736","4.607","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.209","7.399","8.883","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","8.359","1.067","7.357","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","823","1.268","885","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":449},{"label":"Fev","value":815},{"label":"Mar","value":586},{"label":"Abr","value":448},{"label":"Mai","value":488},{"label":"Jun","value":804},{"label":"Jul","value":760},{"label":"Ago","value":819},{"label":"Set","value":715},{"label":"Out","value":574},{"label":"Nov","value":461},{"label":"Dez","value":752}];
const MX = 819;
