...
const PAGE = "Platform";
const KPIS = [{"l":"Dispositivos Online","v":"4.903","t":"+13.0%","d":"up"},{"l":"Dados/Min (MB)","v":"8.254","t":"+8.5%","d":"up"},{"l":"Alertas Ativos","v":"5.173","t":"+7.5%","d":"up"},{"l":"Uptime (%)","v":"85.5%","t":"+0.7%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.046","7.025","4.836","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.927","8.473","8.205","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.762","5.938","7.068","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.903","8.313","2.587","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.143","229","7.897","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":811},{"label":"Mar","value":813},{"label":"Abr","value":517},{"label":"Mai","value":766},{"label":"Jun","value":585},{"label":"Jul","value":708},{"label":"Ago","value":834},{"label":"Set","value":472},{"label":"Out","value":599},{"label":"Nov","value":488},{"label":"Dez","value":560}];
const MX = 834;
