...
const PAGE = "Vertical";
const KPIS = [{"l":"Dispositivos Online","v":"5.456","t":"+7.4%","d":"up"},{"l":"Dados/Min (MB)","v":"6.399","t":"-2.5%","d":"down"},{"l":"Alertas Ativos","v":"3.845","t":"-5.8%","d":"down"},{"l":"Uptime (%)","v":"68.3%","t":"+14.5%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.621","5.954","2.149","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.967","5.280","1.881","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","3.074","4.265","4.102","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.864","3.929","1.006","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.704","1.597","9.072","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":607},{"label":"Mar","value":466},{"label":"Abr","value":573},{"label":"Mai","value":707},{"label":"Jun","value":589},{"label":"Jul","value":744},{"label":"Ago","value":548},{"label":"Set","value":620},{"label":"Out","value":767},{"label":"Nov","value":460},{"label":"Dez","value":681}];
const MX = 767;
