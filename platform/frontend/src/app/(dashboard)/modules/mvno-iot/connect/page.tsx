...
const KPIS = [{"l":"Dispositivos Online","v":"4.798","t":"+5.2%","d":"up"},{"l":"Dados/Min (MB)","v":"6.660","t":"-5.0%","d":"down"},{"l":"Alertas Ativos","v":"199","t":"-1.8%","d":"down"},{"l":"Uptime (%)","v":"75.4%","t":"+11.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.013","4.315","6.340","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.218","4.454","6.717","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.300","6.205","156","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.345","2.572","8.541","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.947","438","7.815","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":901},{"label":"Fev","value":811},{"label":"Mar","value":836},{"label":"Abr","value":554},{"label":"Mai","value":549},{"label":"Jun","value":818},{"label":"Jul","value":635},{"label":"Ago","value":699},{"label":"Set","value":750},{"label":"Out","value":665},{"label":"Nov","value":586},{"label":"Dez","value":898}];
const MX = 901;
