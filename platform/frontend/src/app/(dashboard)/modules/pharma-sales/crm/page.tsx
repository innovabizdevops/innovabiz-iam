...
const PAGE = "CRM";
const KPIS = [{"l":"Vendas YTD (€)","v":"€88305","t":"+7.8%","d":"up"},{"l":"Pipeline (€)","v":"€60885","t":"+10.8%","d":"up"},{"l":"Atingimento Quota (%)","v":"82.6%","t":"+6.0%","d":"up"},{"l":"Win Rate (%)","v":"89.0%","t":"+16.6%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 19085.25","€ 47810.35","€ 44115.24","86.6%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 19570.81","€ 48217.90","€ 1269.39","88.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 35665.35","€ 26467.51","€ 40618.86","92.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 46302.32","€ 28354.25","€ 27897.93","76.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 27375.21","€ 49926.94","€ 16133.06","79.1%"],"status":"active"}];
const CHART = [{"label":"Jan","value":400},{"label":"Fev","value":352},{"label":"Mar","value":440},{"label":"Abr","value":473},{"label":"Mai","value":393},{"label":"Jun","value":314},{"label":"Jul","value":625},{"label":"Ago","value":641},{"label":"Set","value":269},{"label":"Out","value":495},{"label":"Nov","value":526},{"label":"Dez","value":469}];
const MX = 641;
