...
/* ═══ Pharma Sales Force — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "5645", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3784", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€377K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "477175645", cells: ["PHA-5645", "Pharma Sales Force Item 1", "10/2/2026", "€25 745"], status: "active" as const },
    { id: "477179216", cells: ["PHA-9216", "Pharma Sales Force Item 2", "25/9/2026", "€29 316"], status: "pending" as const },
    { id: "477182787", cells: ["PHA-3787", "Pharma Sales Force Item 3", "12/4/2026", "€32 887"], status: "completed" as const },
    { id: "477186358", cells: ["PHA-7358", "Pharma Sales Force Item 4", "27/11/2026", "€36 458"], status: "warning" as const },
    { id: "477189929", cells: ["PHA-1929", "Pharma Sales Force Item 5", "14/6/2026", "€40 029"], status: "active" as const },
];
...
export default function PharmaSalesForcePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pharma Sales Force</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pharma Sales Force</p>
                    </div>
                </div>
