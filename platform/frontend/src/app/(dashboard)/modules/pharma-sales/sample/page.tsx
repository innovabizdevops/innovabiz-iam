...
const PAGE = "Sample";
const KPIS = [{"l":"Vendas YTD (€)","v":"€22733","t":"-3.1%","d":"down"},{"l":"Pipeline (€)","v":"€61066","t":"+16.4%","d":"up"},{"l":"Atingimento Quota (%)","v":"87.8%","t":"+4.8%","d":"up"},{"l":"Win Rate (%)","v":"81.9%","t":"+8.9%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 25733.60","€ 48130.55","€ 29875.26","92.7%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 756.18","€ 17968.90","€ 38601.14","76.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 12596.19","€ 6102.66","€ 20845.39","76.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 5252.39","€ 23256.45","€ 11953.31","90.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 43033.66","€ 18737.74","€ 14841.78","86.1%"],"status":"active"}];
const CHART = [{"label":"Jan","value":472},{"label":"Fev","value":515},{"label":"Mar","value":435},{"label":"Abr","value":494},{"label":"Mai","value":440},{"label":"Jun","value":580},{"label":"Jul","value":525},{"label":"Ago","value":725},{"label":"Set","value":570},{"label":"Out","value":563},{"label":"Nov","value":438},{"label":"Dez","value":731}];
const MX = 731;
