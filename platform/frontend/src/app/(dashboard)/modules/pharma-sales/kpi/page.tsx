...
const PAGE = "KPI";
const KPIS = [{"l":"Vendas YTD (€)","v":"€82136","t":"+11.7%","d":"up"},{"l":"Pipeline (€)","v":"€83149","t":"+16.3%","d":"up"},{"l":"Atingimento Quota (%)","v":"66.2%","t":"+14.6%","d":"up"},{"l":"Win Rate (%)","v":"91.1%","t":"-0.8%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 20945.88","€ 47141.15","€ 24662.81","87.7%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 4142.14","€ 8002.54","€ 1382.07","94.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 13279.42","€ 16477.40","€ 42063.14","98.8%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 3834.85","€ 27538.55","€ 6336.15","97.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 38011.62","€ 3888.44","€ 17890.42","97.8%"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":801},{"label":"Mar","value":603},{"label":"Abr","value":553},{"label":"Mai","value":857},{"label":"Jun","value":581},{"label":"Jul","value":597},{"label":"Ago","value":647},{"label":"Set","value":571},{"label":"Out","value":776},{"label":"Nov","value":651},{"label":"Dez","value":605}];
const MX = 857;
