...
const KPIS = [{"l":"Vendas YTD (€)","v":"€68882","t":"+8.2%","d":"up"},{"l":"Pipeline (€)","v":"€17108","t":"-4.4%","d":"down"},{"l":"Atingimento Quota (%)","v":"94.5%","t":"-1.4%","d":"down"},{"l":"Win Rate (%)","v":"66.6%","t":"+14.6%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 14137.48","€ 22730.17","€ 41213.81","71.6%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 31127.50","€ 40341.67","€ 42707.94","88.3%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 22875.74","€ 49712.40","€ 34584.79","72.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 34252.81","€ 33350.17","€ 40836.24","90.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 32857.55","€ 45252.58","€ 40916.61","88.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":878},{"label":"Fev","value":657},{"label":"Mar","value":647},{"label":"Abr","value":1008},{"label":"Mai","value":1000},{"label":"Jun","value":708},{"label":"Jul","value":760},{"label":"Ago","value":850},{"label":"Set","value":795},{"label":"Out","value":770},{"label":"Nov","value":886},{"label":"Dez","value":646}];
const MX = 1008;
