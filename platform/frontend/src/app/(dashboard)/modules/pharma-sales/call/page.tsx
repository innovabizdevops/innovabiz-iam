...
const ACCENT = "#7c3aed";
const MODULE = "Pharma Sales Force";
const PAGE = "Call Plan";
const KPIS = [{"l":"Vendas YTD (€)","v":"€12660","t":"+6.3%","d":"up"},{"l":"Pipeline (€)","v":"€86204","t":"-0.2%","d":"down"},{"l":"Atingimento Quota (%)","v":"86.7%","t":"+17.5%","d":"up"},{"l":"Win Rate (%)","v":"79.9%","t":"+14.7%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 41171.57","€ 18857.82","€ 9007.15","88.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 4999.37","€ 49298.30","€ 547.12","83.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 49454.50","€ 26081.06","€ 5584.11","96.4%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 26238.96","€ 21121.50","€ 9551.19","78.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 22334.52","€ 1477.26","€ 25245.47","88.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":357},{"label":"Mar","value":326},{"label":"Abr","value":279},{"label":"Mai","value":294},{"label":"Jun","value":277},{"label":"Jul","value":414},{"label":"Ago","value":314},{"label":"Set","value":665},{"label":"Out","value":554},{"label":"Nov","value":482},{"label":"Dez","value":473}];
const MX = 665;
