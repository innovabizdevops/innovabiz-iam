...
const PAGE = "Client";
const KPIS = [{"l":"Projetos Melhoria","v":"3.168","t":"+3.4%","d":"up"},{"l":"Savings (€)","v":"€45528","t":"+8.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"83.8%","t":"+7.9%","d":"up"},{"l":"Ciclos PDCA","v":"6.010","t":"+12.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.295","€ 33903.86","3.336","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.683","€ 36657.96","4.566","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.014","€ 10975.28","8.086","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.982","€ 7941.31","2.581","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.592","€ 48173.92","2.241","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":652},{"label":"Mar","value":897},{"label":"Abr","value":759},{"label":"Mai","value":921},{"label":"Jun","value":668},{"label":"Jul","value":920},{"label":"Ago","value":866},{"label":"Set","value":925},{"label":"Out","value":888},{"label":"Nov","value":637},{"label":"Dez","value":931}];
const MX = 931;
