...
const PAGE = "Crew";
const KPIS = [{"l":"Projetos Melhoria","v":"8.585","t":"+8.3%","d":"up"},{"l":"Savings (€)","v":"€44801","t":"+15.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"90.9%","t":"-2.5%","d":"down"},{"l":"Ciclos PDCA","v":"8.137","t":"-4.7%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.668","€ 2986.17","7.333","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","9.063","€ 36291.17","4.237","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.799","€ 23926.35","1.488","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.771","€ 2659.86","8.709","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","205","€ 1542.40","8.834","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":560},{"label":"Mar","value":736},{"label":"Abr","value":780},{"label":"Mai","value":510},{"label":"Jun","value":771},{"label":"Jul","value":423},{"label":"Ago","value":487},{"label":"Set","value":435},{"label":"Out","value":773},{"label":"Nov","value":764},{"label":"Dez","value":639}];
const MX = 780;
