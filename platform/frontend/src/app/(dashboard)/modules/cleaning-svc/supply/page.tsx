...
const PAGE = "Supply";
const KPIS = [{"l":"Projetos Melhoria","v":"635","t":"+9.1%","d":"up"},{"l":"Savings (€)","v":"€22919","t":"-3.5%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"90.5%","t":"+3.6%","d":"up"},{"l":"Ciclos PDCA","v":"7.536","t":"+6.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.451","€ 31499.57","5.447","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.267","€ 39100.13","1.783","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.550","€ 20904.05","2.647","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.596","€ 37479.22","7.242","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","701","€ 2476.83","5.993","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":1048},{"label":"Mar","value":733},{"label":"Abr","value":1014},{"label":"Mai","value":732},{"label":"Jun","value":1004},{"label":"Jul","value":747},{"label":"Ago","value":959},{"label":"Set","value":680},{"label":"Out","value":860},{"label":"Nov","value":704},{"label":"Dez","value":1039}];
const MX = 1048;
