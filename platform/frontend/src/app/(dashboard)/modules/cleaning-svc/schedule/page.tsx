...
const ACCENT = "#6366f1";
const MODULE = "Cleaning Services";
const PAGE = "Schedule";
const KPIS = [{"l":"Projetos Melhoria","v":"2.357","t":"-1.6%","d":"down"},{"l":"Savings (€)","v":"€34300","t":"-4.1%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"82.8%","t":"-4.7%","d":"down"},{"l":"Ciclos PDCA","v":"5.938","t":"+3.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.599","€ 38350.32","7.158","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.088","€ 19968.47","8.014","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.365","€ 227.43","3.215","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.883","€ 11110.45","3.713","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.737","€ 39763.87","7.372","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":443},{"label":"Mar","value":552},{"label":"Abr","value":412},{"label":"Mai","value":259},{"label":"Jun","value":517},{"label":"Jul","value":270},{"label":"Ago","value":280},{"label":"Set","value":437},{"label":"Out","value":350},{"label":"Nov","value":249},{"label":"Dez","value":424}];
const MX = 627;
