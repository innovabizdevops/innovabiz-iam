...
const PAGE = "Therapy";
const KPIS = [{"l":"Total Sleep Clinic","v":"1.477","t":"+7.6%","d":"up"},{"l":"Therapy Ativos","v":"2.314","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"65.5%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"57","t":"+16.8%","d":"up"}];
const COLS = ["ID","Therapy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sleep Clinic #001","Sleep Clinic #002","6.410","6.363","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Sleep Clinic #002","Sleep Clinic #003","323","146","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Sleep Clinic #003","Sleep Clinic #004","8.585","7.515","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Sleep Clinic #004","Sleep Clinic #005","6.678","1.303","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sleep Clinic #005","Sleep Clinic #001","1.311","2.096","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":465},{"label":"Mar","value":392},{"label":"Abr","value":546},{"label":"Mai","value":390},{"label":"Jun","value":615},{"label":"Jul","value":719},{"label":"Ago","value":719},{"label":"Set","value":642},{"label":"Out","value":409},{"label":"Nov","value":713},{"label":"Dez","value":532}];
const MX = 719;
