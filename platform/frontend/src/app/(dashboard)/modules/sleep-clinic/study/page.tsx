...
const ACCENT = "#6366f1";
const MODULE = "Sleep Clinic";
const PAGE = "Study";
const KPIS = [{"l":"Total Sleep Clinic","v":"5.309","t":"+13.1%","d":"up"},{"l":"Study Ativos","v":"3.291","t":"+4.9%","d":"up"},{"l":"Eficiência (%)","v":"72.2%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"61","t":"+6.1%","d":"up"}];
const COLS = ["ID","Study","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sleep Clinic #001","Sleep Clinic #002","5.153","8.059","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Sleep Clinic #002","Sleep Clinic #003","1.554","5.759","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Sleep Clinic #003","Sleep Clinic #004","1.563","4.156","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Sleep Clinic #004","Sleep Clinic #005","8.428","4.755","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sleep Clinic #005","Sleep Clinic #001","8.671","5.690","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":713},{"label":"Fev","value":740},{"label":"Mar","value":577},{"label":"Abr","value":475},{"label":"Mai","value":696},{"label":"Jun","value":641},{"label":"Jul","value":525},{"label":"Ago","value":519},{"label":"Set","value":590},{"label":"Out","value":768},{"label":"Nov","value":516},{"label":"Dez","value":523}];
const MX = 768;
