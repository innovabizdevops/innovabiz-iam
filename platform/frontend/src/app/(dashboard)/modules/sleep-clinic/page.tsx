...
export default function SleepClinicPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Sleep Clinic</h1><p className="text-sm text-muted-foreground">Sleep Clinic • iBOS Enterprise</p></div>
