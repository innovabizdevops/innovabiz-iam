...
const PAGE = "Device";
const KPIS = [{"l":"Dispositivos Online","v":"3.171","t":"+16.8%","d":"up"},{"l":"Dados/Min (MB)","v":"4.603","t":"+15.1%","d":"up"},{"l":"Alertas Ativos","v":"7.678","t":"+10.0%","d":"up"},{"l":"Uptime (%)","v":"82.1%","t":"+11.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","1.807","619","5.550","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.155","1.925","2.440","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.783","5.125","4.484","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.568","8.738","6.453","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.836","6.336","2.590","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":938},{"label":"Fev","value":1011},{"label":"Mar","value":687},{"label":"Abr","value":889},{"label":"Mai","value":937},{"label":"Jun","value":1067},{"label":"Jul","value":767},{"label":"Ago","value":913},{"label":"Set","value":1017},{"label":"Out","value":956},{"label":"Nov","value":739},{"label":"Dez","value":864}];
const MX = 1067;
