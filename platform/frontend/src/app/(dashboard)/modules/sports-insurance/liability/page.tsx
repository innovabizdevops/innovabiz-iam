...
const ACCENT = "#6366f1";
const MODULE = "Sports Insurance";
const PAGE = "Liability";
const KPIS = [{"l":"Atletas Registados","v":"7.711","t":"-1.5%","d":"down"},{"l":"Treinos/Semana","v":"4373","t":"+9.5%","d":"up"},{"l":"Competições","v":"8.896","t":"+11.0%","d":"up"},{"l":"Performance Score","v":"65","t":"+3.5%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.274","3.487","6.571","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","5.819","3.578","3.752","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","661","7.133","6.993","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.838","3.427","8.985","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.378","856","4.800","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":871},{"label":"Mar","value":669},{"label":"Abr","value":841},{"label":"Mai","value":912},{"label":"Jun","value":725},{"label":"Jul","value":719},{"label":"Ago","value":632},{"label":"Set","value":876},{"label":"Out","value":677},{"label":"Nov","value":963},{"label":"Dez","value":726}];
const MX = 963;
