...
const PAGE = "Travel";
const KPIS = [{"l":"Atletas Registados","v":"6.650","t":"+16.6%","d":"up"},{"l":"Treinos/Semana","v":"2916","t":"+17.7%","d":"up"},{"l":"Competições","v":"8.562","t":"-0.1%","d":"down"},{"l":"Performance Score","v":"66","t":"+5.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.644","1.193","4.955","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.924","2.000","8.825","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.150","4.800","3.881","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.712","6.827","2.056","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.535","4.911","6.219","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":346},{"label":"Fev","value":500},{"label":"Mar","value":334},{"label":"Abr","value":219},{"label":"Mai","value":314},{"label":"Jun","value":287},{"label":"Jul","value":260},{"label":"Ago","value":372},{"label":"Set","value":344},{"label":"Out","value":491},{"label":"Nov","value":338},{"label":"Dez","value":379}];
const MX = 500;
