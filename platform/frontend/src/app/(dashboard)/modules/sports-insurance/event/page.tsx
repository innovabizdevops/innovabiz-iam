...
const PAGE = "Event";
const KPIS = [{"l":"Atletas Registados","v":"1.341","t":"+4.9%","d":"up"},{"l":"Treinos/Semana","v":"3880","t":"+13.6%","d":"up"},{"l":"Competições","v":"1.441","t":"+7.6%","d":"up"},{"l":"Performance Score","v":"68","t":"-3.6%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.707","1.922","1.792","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.242","7.832","8.201","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.201","5.843","7.885","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.267","9.043","217","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.086","2.069","297","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":905},{"label":"Fev","value":639},{"label":"Mar","value":628},{"label":"Abr","value":654},{"label":"Mai","value":799},{"label":"Jun","value":912},{"label":"Jul","value":941},{"label":"Ago","value":696},{"label":"Set","value":752},{"label":"Out","value":941},{"label":"Nov","value":599},{"label":"Dez","value":798}];
const MX = 941;
