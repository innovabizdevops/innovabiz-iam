...
const PAGE = "Claims";
const KPIS = [{"l":"Atletas Registados","v":"7.927","t":"+9.4%","d":"up"},{"l":"Treinos/Semana","v":"1164","t":"-5.1%","d":"down"},{"l":"Competições","v":"410","t":"+15.9%","d":"up"},{"l":"Performance Score","v":"82","t":"+17.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.338","2.411","4.746","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","5.271","4.117","2.998","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.251","6.314","3.435","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.485","6.725","8.948","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.156","448","2.056","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":497},{"label":"Mar","value":605},{"label":"Abr","value":265},{"label":"Mai","value":322},{"label":"Jun","value":581},{"label":"Jul","value":414},{"label":"Ago","value":318},{"label":"Set","value":431},{"label":"Out","value":385},{"label":"Nov","value":464},{"label":"Dez","value":568}];
const MX = 605;
