...
const PAGE = "Athlete";
const KPIS = [{"l":"Atletas Registados","v":"2.550","t":"-2.3%","d":"down"},{"l":"Treinos/Semana","v":"1957","t":"+13.6%","d":"up"},{"l":"Competições","v":"5.836","t":"-3.0%","d":"down"},{"l":"Performance Score","v":"68","t":"-4.4%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.650","7.993","414","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.814","6.764","8.710","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","558","6.709","3.411","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.984","7.494","6.748","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.303","3.010","2.550","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":646},{"label":"Mar","value":772},{"label":"Abr","value":682},{"label":"Mai","value":551},{"label":"Jun","value":605},{"label":"Jul","value":608},{"label":"Ago","value":621},{"label":"Set","value":847},{"label":"Out","value":853},{"label":"Nov","value":724},{"label":"Dez","value":806}];
const MX = 853;
