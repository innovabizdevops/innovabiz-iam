...
const PAGE = "Ash Mgmt";
const KPIS = [{"l":"Total Biomass Plant","v":"9.049","t":"-2.3%","d":"down"},{"l":"Ash Mgmt Ativos","v":"6.663","t":"+15.0%","d":"up"},{"l":"Eficiência (%)","v":"78.2%","t":"+17.5%","d":"up"},{"l":"Score Performance","v":"85","t":"-2.5%","d":"down"}];
const COLS = ["ID","Ash Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Biomass Plant #001","Biomass Plant #002","716","6.887","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Biomass Plant #002","Biomass Plant #003","4.985","4.747","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Biomass Plant #003","Biomass Plant #004","1.206","6.416","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Biomass Plant #004","Biomass Plant #005","5.440","715","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Biomass Plant #005","Biomass Plant #001","7.878","907","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":277},{"label":"Fev","value":383},{"label":"Mar","value":344},{"label":"Abr","value":519},{"label":"Mai","value":473},{"label":"Jun","value":492},{"label":"Jul","value":596},{"label":"Ago","value":513},{"label":"Set","value":547},{"label":"Out","value":461},{"label":"Nov","value":581},{"label":"Dez","value":374}];
const MX = 596;
