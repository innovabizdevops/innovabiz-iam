...
const PAGE = "Emission";
const KPIS = [{"l":"Total Biomass Plant","v":"8.364","t":"+9.1%","d":"up"},{"l":"Emission Ativos","v":"231","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"81.4%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"79","t":"+4.5%","d":"up"}];
const COLS = ["ID","Emission","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Biomass Plant #001","Biomass Plant #002","2.275","2.892","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Biomass Plant #002","Biomass Plant #003","6.024","3.262","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Biomass Plant #003","Biomass Plant #004","6.979","2.716","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Biomass Plant #004","Biomass Plant #005","6.542","3.863","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Biomass Plant #005","Biomass Plant #001","7.154","2.472","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":786},{"label":"Fev","value":787},{"label":"Mar","value":706},{"label":"Abr","value":574},{"label":"Mai","value":583},{"label":"Jun","value":801},{"label":"Jul","value":484},{"label":"Ago","value":837},{"label":"Set","value":629},{"label":"Out","value":815},{"label":"Nov","value":574},{"label":"Dez","value":829}];
const MX = 837;
