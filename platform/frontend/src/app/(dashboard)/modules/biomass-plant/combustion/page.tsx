...
const ACCENT = "#6366f1";
const MODULE = "Biomass Plant";
const PAGE = "Combustion";
const KPIS = [{"l":"Total Biomass Plant","v":"2.911","t":"+13.1%","d":"up"},{"l":"Combustion Ativos","v":"6.049","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"75.3%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"59","t":"+10.5%","d":"up"}];
const COLS = ["ID","Combustion","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Biomass Plant #001","Biomass Plant #002","3.627","3.455","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Biomass Plant #002","Biomass Plant #003","2.167","8.049","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Biomass Plant #003","Biomass Plant #004","1.569","2.758","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Biomass Plant #004","Biomass Plant #005","8.481","4.830","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Biomass Plant #005","Biomass Plant #001","5.868","2.103","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":843},{"label":"Mar","value":546},{"label":"Abr","value":572},{"label":"Mai","value":684},{"label":"Jun","value":549},{"label":"Jul","value":715},{"label":"Ago","value":644},{"label":"Set","value":687},{"label":"Out","value":670},{"label":"Nov","value":800},{"label":"Dez","value":695}];
const MX = 843;
