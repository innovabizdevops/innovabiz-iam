...
const PAGE = "CHP";
const KPIS = [{"l":"Total Biomass Plant","v":"1.906","t":"-5.6%","d":"down"},{"l":"CHP Ativos","v":"8.833","t":"+6.0%","d":"up"},{"l":"Eficiência (%)","v":"83.4%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"86","t":"-4.8%","d":"down"}];
const COLS = ["ID","CHP","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Biomass Plant #001","Biomass Plant #002","725","3.871","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Biomass Plant #002","Biomass Plant #003","5.560","5.678","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Biomass Plant #003","Biomass Plant #004","7.019","1.257","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Biomass Plant #004","Biomass Plant #005","6.127","4.832","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Biomass Plant #005","Biomass Plant #001","5.746","2.399","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":554},{"label":"Mar","value":595},{"label":"Abr","value":492},{"label":"Mai","value":770},{"label":"Jun","value":861},{"label":"Jul","value":520},{"label":"Ago","value":862},{"label":"Set","value":855},{"label":"Out","value":865},{"label":"Nov","value":623},{"label":"Dez","value":825}];
const MX = 865;
