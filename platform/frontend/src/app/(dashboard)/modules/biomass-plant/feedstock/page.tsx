...
const KPIS = [{"l":"Total Biomass Plant","v":"2.475","t":"+8.0%","d":"up"},{"l":"Feedstock Ativos","v":"575","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"79.5%","t":"+8.3%","d":"up"},{"l":"Score Performance","v":"71","t":"-3.2%","d":"down"}];
const COLS = ["ID","Feedstock","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Biomass Plant #001","Biomass Plant #002","253","1.283","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Biomass Plant #002","Biomass Plant #003","6.258","6.394","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Biomass Plant #003","Biomass Plant #004","7.042","473","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Biomass Plant #004","Biomass Plant #005","5.688","4.364","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Biomass Plant #005","Biomass Plant #001","8.956","5.719","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":926},{"label":"Fev","value":965},{"label":"Mar","value":957},{"label":"Abr","value":919},{"label":"Mai","value":711},{"label":"Jun","value":695},{"label":"Jul","value":731},{"label":"Ago","value":929},{"label":"Set","value":877},{"label":"Out","value":883},{"label":"Nov","value":879},{"label":"Dez","value":731}];
const MX = 965;
