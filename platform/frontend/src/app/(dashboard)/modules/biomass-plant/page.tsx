...
export default function BiomassPlantPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Biomass Plant</h1><p className="text-sm text-muted-foreground">Biomass Plant • iBOS Enterprise</p></div>
