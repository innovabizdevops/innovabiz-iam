...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.846","t":"+12.9%","d":"up"},{"l":"NC Abertas","v":"7.199","t":"+14.0%","d":"up"},{"l":"Conformidade (%)","v":"94.0%","t":"+8.6%","d":"up"},{"l":"CAPAs Pendentes","v":"2.892","t":"-2.4%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.789","95.8%","2.367","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.493","97.2%","2.413","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.811","92.4%","1.514","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","855","86.4%","7.788","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.035","79.4%","5.151","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":949},{"label":"Fev","value":774},{"label":"Mar","value":803},{"label":"Abr","value":881},{"label":"Mai","value":1011},{"label":"Jun","value":733},{"label":"Jul","value":770},{"label":"Ago","value":832},{"label":"Set","value":688},{"label":"Out","value":700},{"label":"Nov","value":672},{"label":"Dez","value":754}];
const MX = 1011;
