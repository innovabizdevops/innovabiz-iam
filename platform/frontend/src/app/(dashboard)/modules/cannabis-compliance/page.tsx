...
/* ═══ Cannabis Compliance — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "8558", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "448", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€251K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "65388058", cells: ["CAN-4058", "Cannabis Compliance Item 1", "23/11/2026", "€38 158"], status: "active" as const },
    { id: "65391629", cells: ["CAN-7629", "Cannabis Compliance Item 2", "10/6/2026", "€41 729"], status: "pending" as const },
    { id: "65395200", cells: ["CAN-2200", "Cannabis Compliance Item 3", "25/1/2026", "€45 300"], status: "completed" as const },
    { id: "65398771", cells: ["CAN-5771", "Cannabis Compliance Item 4", "12/8/2026", "€48 871"], status: "warning" as const },
    { id: "65402342", cells: ["CAN-9342", "Cannabis Compliance Item 5", "27/3/2026", "€2442"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cannabis Compliance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cannabis Compliance</p>
                    </div>
                </div>
