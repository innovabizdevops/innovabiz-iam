...
const ACCENT = "#14532d";
const MODULE = "Cannabis Compliance";
const PAGE = "Tax";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.070","t":"-4.5%","d":"down"},{"l":"NC Abertas","v":"6.571","t":"-3.4%","d":"down"},{"l":"Conformidade (%)","v":"83.0%","t":"+10.2%","d":"up"},{"l":"CAPAs Pendentes","v":"4.219","t":"+11.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.522","91.0%","4.173","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.808","98.6%","6.389","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.499","72.8%","2.088","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.654","77.8%","1.818","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.986","90.8%","1.731","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":408},{"label":"Fev","value":389},{"label":"Mar","value":360},{"label":"Abr","value":665},{"label":"Mai","value":625},{"label":"Jun","value":676},{"label":"Jul","value":714},{"label":"Ago","value":502},{"label":"Set","value":582},{"label":"Out","value":381},{"label":"Nov","value":749},{"label":"Dez","value":427}];
const MX = 749;
