...
const PAGE = "License";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.742","t":"-5.7%","d":"down"},{"l":"NC Abertas","v":"7.686","t":"+12.9%","d":"up"},{"l":"Conformidade (%)","v":"89.2%","t":"+5.3%","d":"up"},{"l":"CAPAs Pendentes","v":"2.992","t":"+4.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.420","95.8%","1.116","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.787","75.0%","599","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.369","93.5%","6.053","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.121","80.2%","5.948","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.976","83.7%","6.904","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":999},{"label":"Fev","value":821},{"label":"Mar","value":798},{"label":"Abr","value":858},{"label":"Mai","value":880},{"label":"Jun","value":727},{"label":"Jul","value":865},{"label":"Ago","value":818},{"label":"Set","value":666},{"label":"Out","value":757},{"label":"Nov","value":882},{"label":"Dez","value":750}];
const MX = 999;
