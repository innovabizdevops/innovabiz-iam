...
const PAGE = "Inspect";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.545","t":"+13.2%","d":"up"},{"l":"NC Abertas","v":"7.297","t":"+3.3%","d":"up"},{"l":"Conformidade (%)","v":"74.3%","t":"+13.2%","d":"up"},{"l":"CAPAs Pendentes","v":"1.662","t":"+11.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.639","83.5%","3.444","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.098","89.7%","7.925","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.131","82.2%","561","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","9.020","80.5%","1.101","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.525","92.9%","8.135","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":298},{"label":"Mar","value":666},{"label":"Abr","value":638},{"label":"Mai","value":549},{"label":"Jun","value":669},{"label":"Jul","value":462},{"label":"Ago","value":313},{"label":"Set","value":629},{"label":"Out","value":397},{"label":"Nov","value":531},{"label":"Dez","value":487}];
const MX = 669;
