...
const ACCENT = "#6366f1";
const MODULE = "Construction Quality";
const PAGE = "Defect";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.662","t":"+10.4%","d":"up"},{"l":"NC Abertas","v":"2.486","t":"-5.0%","d":"down"},{"l":"Conformidade (%)","v":"67.6%","t":"-5.9%","d":"down"},{"l":"CAPAs Pendentes","v":"2.319","t":"-3.5%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.939","89.9%","6.429","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.417","77.8%","2.854","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.728","73.3%","8.741","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.058","71.1%","8.888","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.990","95.2%","3.747","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":826},{"label":"Mar","value":797},{"label":"Abr","value":789},{"label":"Mai","value":871},{"label":"Jun","value":939},{"label":"Jul","value":883},{"label":"Ago","value":647},{"label":"Set","value":664},{"label":"Out","value":852},{"label":"Nov","value":867},{"label":"Dez","value":559}];
const MX = 939;
