...
/* ═══ Indigenous Affairs — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "1055", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3306", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€481K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "869418955", cells: ["IND-1955", "Indigenous Affairs Item 1", "28/8/2026", "€19 055"], status: "active" as const },
    { id: "869422526", cells: ["IND-5526", "Indigenous Affairs Item 2", "15/3/2026", "€22 626"], status: "pending" as const },
    { id: "869426097", cells: ["IND-9097", "Indigenous Affairs Item 3", "2/10/2026", "€26 197"], status: "completed" as const },
    { id: "869429668", cells: ["IND-3668", "Indigenous Affairs Item 4", "17/5/2026", "€29 768"], status: "warning" as const },
    { id: "869433239", cells: ["IND-7239", "Indigenous Affairs Item 5", "4/12/2026", "€33 339"], status: "active" as const },
];
...
export default function IndigenousAffairsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Indigenous Affairs</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Indigenous Affairs</p>
                    </div>
                </div>
