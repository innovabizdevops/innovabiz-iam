...
const PAGE = "Service";
const KPIS = [{"l":"Total Indigenous Affairs","v":"245","t":"-5.2%","d":"down"},{"l":"Service Ativos","v":"8.163","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"66.5%","t":"+2.5%","d":"up"},{"l":"Score Performance","v":"67","t":"-3.4%","d":"down"}];
const COLS = ["ID","Service","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Indigenous Affairs #001","Indigenous Affairs #002","1.068","4.652","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Indigenous Affairs #002","Indigenous Affairs #003","8.882","8.040","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Indigenous Affairs #003","Indigenous Affairs #004","2.846","5.181","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Indigenous Affairs #004","Indigenous Affairs #005","805","7.352","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Indigenous Affairs #005","Indigenous Affairs #001","2.339","5.804","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":960},{"label":"Fev","value":751},{"label":"Mar","value":892},{"label":"Abr","value":868},{"label":"Mai","value":786},{"label":"Jun","value":678},{"label":"Jul","value":676},{"label":"Ago","value":825},{"label":"Set","value":782},{"label":"Out","value":710},{"label":"Nov","value":714},{"label":"Dez","value":689}];
const MX = 960;
