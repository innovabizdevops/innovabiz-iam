...
const KPIS = [{"l":"Projetos Sociais","v":"809","t":"+5.4%","d":"up"},{"l":"Beneficiários","v":"7.907","t":"-3.6%","d":"down"},{"l":"Investimento CSR (€)","v":"€96363","t":"+2.8%","d":"up"},{"l":"Score Impacto","v":"94","t":"-2.4%","d":"down"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","4.165","€ 14532.22","5.838","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","5.243","€ 31363.42","6.041","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","5.527","€ 4168.61","5.225","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","2.082","€ 20858.97","8.180","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","5.682","€ 34634.15","4.111","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":311},{"label":"Fev","value":537},{"label":"Mar","value":330},{"label":"Abr","value":446},{"label":"Mai","value":459},{"label":"Jun","value":441},{"label":"Jul","value":398},{"label":"Ago","value":583},{"label":"Set","value":515},{"label":"Out","value":420},{"label":"Nov","value":627},{"label":"Dez","value":434}];
const MX = 627;
