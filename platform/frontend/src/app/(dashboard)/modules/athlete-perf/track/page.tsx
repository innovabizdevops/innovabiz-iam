...
const PAGE = "Tracking";
const KPIS = [{"l":"Atletas Registados","v":"1.986","t":"+4.2%","d":"up"},{"l":"Treinos/Semana","v":"594","t":"+12.3%","d":"up"},{"l":"Competições","v":"4.596","t":"+1.6%","d":"up"},{"l":"Performance Score","v":"57","t":"+0.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.391","4.161","2.399","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.491","4.615","6.349","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.321","429","7.051","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.067","5.388","4.550","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.314","424","1.361","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":435},{"label":"Mar","value":658},{"label":"Abr","value":726},{"label":"Mai","value":723},{"label":"Jun","value":642},{"label":"Jul","value":596},{"label":"Ago","value":489},{"label":"Set","value":531},{"label":"Out","value":366},{"label":"Nov","value":654},{"label":"Dez","value":629}];
const MX = 726;
