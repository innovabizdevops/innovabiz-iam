...
export default function AthletePerfPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Athlete Perf</h1><p className="text-sm text-muted-foreground">Athlete Perf • iBOS Enterprise</p></div>
