...
const PAGE = "Recovery";
const KPIS = [{"l":"BCP Plans Ativos","v":"5.200","t":"-6.0%","d":"down"},{"l":"RTO Médio (h)","v":"137h","t":"+13.5%","d":"up"},{"l":"RPO Médio (h)","v":"15h","t":"-0.6%","d":"down"},{"l":"Testes DR (YTD)","v":"5.916","t":"-3.3%","d":"down"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","191h","35h","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","116h","121h","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","106h","99h","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","63h","54h","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","32h","20h","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":699},{"label":"Mar","value":859},{"label":"Abr","value":727},{"label":"Mai","value":494},{"label":"Jun","value":700},{"label":"Jul","value":719},{"label":"Ago","value":498},{"label":"Set","value":602},{"label":"Out","value":602},{"label":"Nov","value":779},{"label":"Dez","value":547}];
const MX = 859;
