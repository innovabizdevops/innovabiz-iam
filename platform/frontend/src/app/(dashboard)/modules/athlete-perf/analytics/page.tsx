...
const ACCENT = "#6366f1";
const MODULE = "Athlete Performance";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"4.400","t":"+14.7%","d":"up"},{"l":"Queries/Dia","v":"2390","t":"+16.5%","d":"up"},{"l":"Dados Processados (GB)","v":"2.011","t":"+8.6%","d":"up"},{"l":"Utilizadores Analytics","v":"3.423","t":"+0.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1250","2026-02-08","2.488","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3983","2026-02-22","388","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3246","2026-03-18","8.973","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3843","2026-01-07","4.705","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","468","2026-03-09","3.953","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":436},{"label":"Fev","value":482},{"label":"Mar","value":600},{"label":"Abr","value":546},{"label":"Mai","value":555},{"label":"Jun","value":318},{"label":"Jul","value":247},{"label":"Ago","value":431},{"label":"Set","value":605},{"label":"Out","value":461},{"label":"Nov","value":440},{"label":"Dez","value":365}];
const MX = 605;
