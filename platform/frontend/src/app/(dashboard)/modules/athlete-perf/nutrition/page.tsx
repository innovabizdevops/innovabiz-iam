...
const KPIS = [{"l":"Atletas Registados","v":"8.248","t":"+5.7%","d":"up"},{"l":"Treinos/Semana","v":"1594","t":"+4.7%","d":"up"},{"l":"Competições","v":"2.822","t":"-2.6%","d":"down"},{"l":"Performance Score","v":"78","t":"+10.2%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.575","7.628","253","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","5.965","8.003","2.736","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.579","6.087","8.524","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.749","1.183","8.765","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.704","8.430","4.772","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":594},{"label":"Mar","value":316},{"label":"Abr","value":440},{"label":"Mai","value":356},{"label":"Jun","value":395},{"label":"Jul","value":659},{"label":"Ago","value":278},{"label":"Set","value":440},{"label":"Out","value":420},{"label":"Nov","value":630},{"label":"Dez","value":394}];
const MX = 659;
