...
const PAGE = "Biomechanics";
const KPIS = [{"l":"Atletas Registados","v":"5.984","t":"+14.3%","d":"up"},{"l":"Treinos/Semana","v":"4138","t":"-2.9%","d":"down"},{"l":"Competições","v":"5.343","t":"+17.8%","d":"up"},{"l":"Performance Score","v":"70","t":"+10.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.672","1.680","235","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.580","2.113","3.005","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.022","2.759","3.829","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.677","5.159","8.852","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","395","3.985","4.952","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":420},{"label":"Mar","value":430},{"label":"Abr","value":427},{"label":"Mai","value":735},{"label":"Jun","value":532},{"label":"Jul","value":557},{"label":"Ago","value":789},{"label":"Set","value":605},{"label":"Out","value":431},{"label":"Nov","value":439},{"label":"Dez","value":732}];
const MX = 789;
