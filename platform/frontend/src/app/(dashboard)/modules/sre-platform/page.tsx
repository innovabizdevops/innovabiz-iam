...
/* ═══ SRE Platform Deep — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "129", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3557", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€80K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "817532129", cells: ["SRE-9129", "SRE Platform Deep Item 1", "2/6/2026", "€32 229"], status: "active" as const },
    { id: "817535700", cells: ["SRE-3700", "SRE Platform Deep Item 2", "17/1/2026", "€35 800"], status: "pending" as const },
    { id: "817539271", cells: ["SRE-7271", "SRE Platform Deep Item 3", "4/8/2026", "€39 371"], status: "completed" as const },
    { id: "817542842", cells: ["SRE-1842", "SRE Platform Deep Item 4", "19/3/2026", "€42 942"], status: "warning" as const },
    { id: "817546413", cells: ["SRE-5413", "SRE Platform Deep Item 5", "6/10/2026", "€46 513"], status: "active" as const },
];
...
export default function SrePlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SRE Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SRE Platform Deep</p>
                    </div>
                </div>
