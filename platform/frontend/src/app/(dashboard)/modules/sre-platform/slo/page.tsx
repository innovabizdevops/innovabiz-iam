...
const PAGE = "SLO";
const KPIS = [{"l":"Formulários Ativos","v":"5.834","t":"-3.2%","d":"down"},{"l":"Submissões/Dia","v":"4946","t":"+10.8%","d":"up"},{"l":"Documentos Gerados","v":"6.757","t":"+12.4%","d":"up"},{"l":"Templates","v":"2.920","t":"+6.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.033","2026-03-10","3.142","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.499","2026-02-10","7.158","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.114","2026-02-04","8.239","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.030","2026-02-19","931","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.333","2026-01-09","563","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":994},{"label":"Mar","value":786},{"label":"Abr","value":838},{"label":"Mai","value":1084},{"label":"Jun","value":828},{"label":"Jul","value":933},{"label":"Ago","value":733},{"label":"Set","value":983},{"label":"Out","value":1044},{"label":"Nov","value":888},{"label":"Dez","value":1073}];
const MX = 1084;
