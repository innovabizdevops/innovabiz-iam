...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"6.065","t":"+14.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"85.4%","t":"+0.5%","d":"up"},{"l":"MTTR (h)","v":"86h","t":"+4.9%","d":"up"},{"l":"Satisfação (%)","v":"65.3%","t":"+10.2%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","9.001","8.825","8.456","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.877","7.635","2.378","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.738","2.284","7.043","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.839","1.630","7.857","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.604","1.903","7.168","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":681},{"label":"Mar","value":922},{"label":"Abr","value":759},{"label":"Mai","value":705},{"label":"Jun","value":868},{"label":"Jul","value":709},{"label":"Ago","value":667},{"label":"Set","value":831},{"label":"Out","value":897},{"label":"Nov","value":922},{"label":"Dez","value":953}];
const MX = 953;
