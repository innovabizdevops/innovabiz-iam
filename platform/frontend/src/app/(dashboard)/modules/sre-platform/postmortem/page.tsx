...
const PAGE = "Postmortem";
const KPIS = [{"l":"Pedidos/Dia","v":"989","t":"+9.5%","d":"up"},{"l":"GMV (€)","v":"€44591","t":"+5.8%","d":"up"},{"l":"Conversão (%)","v":"68.5%","t":"-1.7%","d":"down"},{"l":"AOV (€)","v":"€95634","t":"+9.0%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 6982.54","8.224","8.430","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 10602.58","3.520","6.891","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 23882.76","5.254","7.719","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 17130.08","7.369","736","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 30321.55","1.437","1.203","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":958},{"label":"Fev","value":912},{"label":"Mar","value":858},{"label":"Abr","value":945},{"label":"Mai","value":755},{"label":"Jun","value":720},{"label":"Jul","value":686},{"label":"Ago","value":874},{"label":"Set","value":1049},{"label":"Out","value":1058},{"label":"Nov","value":783},{"label":"Dez","value":760}];
const MX = 1058;
