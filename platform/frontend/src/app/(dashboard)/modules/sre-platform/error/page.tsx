...
const ACCENT = "#1e40af";
const MODULE = "SRE Platform Deep";
const PAGE = "Error Budget";
const KPIS = [{"l":"Formulários Ativos","v":"2.744","t":"+14.5%","d":"up"},{"l":"Submissões/Dia","v":"3018","t":"+6.2%","d":"up"},{"l":"Documentos Gerados","v":"6.942","t":"-1.0%","d":"down"},{"l":"Templates","v":"8.918","t":"+11.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.063","2026-02-23","6.809","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.469","2026-03-17","7.889","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.168","2026-01-13","8.815","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.961","2026-02-28","3.913","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.546","2026-02-05","4.004","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":853},{"label":"Mar","value":790},{"label":"Abr","value":964},{"label":"Mai","value":1012},{"label":"Jun","value":956},{"label":"Jul","value":933},{"label":"Ago","value":833},{"label":"Set","value":988},{"label":"Out","value":841},{"label":"Nov","value":1026},{"label":"Dez","value":962}];
const MX = 1026;
