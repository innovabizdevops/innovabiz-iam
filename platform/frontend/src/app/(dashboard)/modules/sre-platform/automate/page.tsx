...
const PAGE = "Automate";
const KPIS = [{"l":"Formulários Ativos","v":"8.444","t":"+6.2%","d":"up"},{"l":"Submissões/Dia","v":"3920","t":"+4.6%","d":"up"},{"l":"Documentos Gerados","v":"1.247","t":"+8.5%","d":"up"},{"l":"Templates","v":"3.757","t":"+10.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.100","2026-02-14","5.260","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.823","2026-02-12","7.788","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.582","2026-02-17","4.572","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.957","2026-03-09","7.402","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.369","2026-01-12","151","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":726},{"label":"Mar","value":921},{"label":"Abr","value":947},{"label":"Mai","value":628},{"label":"Jun","value":618},{"label":"Jul","value":675},{"label":"Ago","value":687},{"label":"Set","value":788},{"label":"Out","value":729},{"label":"Nov","value":592},{"label":"Dez","value":698}];
const MX = 947;
