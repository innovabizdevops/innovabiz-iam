...
const PAGE = "Traffic Overview";
const KPIS = [{"l":"Dashboards Ativos","v":"2.635","t":"+16.7%","d":"up"},{"l":"Queries/Dia","v":"1210","t":"+7.6%","d":"up"},{"l":"Dados Processados (GB)","v":"1.723","t":"-5.5%","d":"down"},{"l":"Utilizadores Analytics","v":"5.026","t":"+10.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2955","2026-02-10","7.116","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1735","2026-02-05","5.788","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3004","2026-02-03","433","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1381","2026-02-02","3.329","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1078","2026-02-23","5.251","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":700},{"label":"Mar","value":845},{"label":"Abr","value":933},{"label":"Mai","value":852},{"label":"Jun","value":708},{"label":"Jul","value":877},{"label":"Ago","value":777},{"label":"Set","value":746},{"label":"Out","value":1026},{"label":"Nov","value":744},{"label":"Dez","value":711}];
const MX = 1026;
