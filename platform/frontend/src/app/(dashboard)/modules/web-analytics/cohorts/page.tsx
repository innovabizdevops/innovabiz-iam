...
const KPIS = [{"l":"Dashboards Ativos","v":"7.766","t":"-0.4%","d":"down"},{"l":"Queries/Dia","v":"1339","t":"+-0.0%","d":"up"},{"l":"Dados Processados (GB)","v":"6.148","t":"+6.1%","d":"up"},{"l":"Utilizadores Analytics","v":"7.922","t":"+15.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3298","2026-01-27","6.870","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3854","2026-01-07","6.334","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2064","2026-03-07","2.025","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","984","2026-02-20","7.179","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4920","2026-03-26","8.466","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":491},{"label":"Fev","value":451},{"label":"Mar","value":581},{"label":"Abr","value":577},{"label":"Mai","value":715},{"label":"Jun","value":762},{"label":"Jul","value":587},{"label":"Ago","value":403},{"label":"Set","value":624},{"label":"Out","value":757},{"label":"Nov","value":552},{"label":"Dez","value":471}];
const MX = 762;
