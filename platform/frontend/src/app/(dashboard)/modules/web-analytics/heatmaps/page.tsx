...
const PAGE = "Heatmaps";
const KPIS = [{"l":"Dashboards Ativos","v":"5.292","t":"-1.4%","d":"down"},{"l":"Queries/Dia","v":"560","t":"+14.9%","d":"up"},{"l":"Dados Processados (GB)","v":"3.968","t":"-1.2%","d":"down"},{"l":"Utilizadores Analytics","v":"8.196","t":"+14.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","781","2026-02-05","3.971","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2964","2026-02-13","2.919","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2219","2026-03-22","4.135","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4646","2026-02-23","2.705","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4035","2026-02-14","5.893","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":677},{"label":"Mar","value":622},{"label":"Abr","value":532},{"label":"Mai","value":534},{"label":"Jun","value":557},{"label":"Jul","value":630},{"label":"Ago","value":358},{"label":"Set","value":591},{"label":"Out","value":449},{"label":"Nov","value":423},{"label":"Dez","value":598}];
const MX = 677;
