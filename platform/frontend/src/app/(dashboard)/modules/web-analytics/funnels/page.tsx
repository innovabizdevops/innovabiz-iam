...
const ACCENT = "#4338ca";
const MODULE = "Web Analytics";
const PAGE = "Funnel Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"4.367","t":"-4.5%","d":"down"},{"l":"Queries/Dia","v":"2000","t":"+11.8%","d":"up"},{"l":"Dados Processados (GB)","v":"6.425","t":"+6.8%","d":"up"},{"l":"Utilizadores Analytics","v":"2.319","t":"+1.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4473","2026-02-12","6.366","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4899","2026-03-20","4.674","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","791","2026-03-07","1.276","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3527","2026-01-01","5.172","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4815","2026-03-10","3.135","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":924},{"label":"Mar","value":1025},{"label":"Abr","value":882},{"label":"Mai","value":851},{"label":"Jun","value":770},{"label":"Jul","value":965},{"label":"Ago","value":996},{"label":"Set","value":822},{"label":"Out","value":722},{"label":"Nov","value":835},{"label":"Dez","value":1017}];
const MX = 1025;
