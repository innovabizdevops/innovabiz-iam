...
const KPIS = [{"l":"Dashboards Ativos","v":"8.333","t":"+10.7%","d":"up"},{"l":"Queries/Dia","v":"3735","t":"+3.1%","d":"up"},{"l":"Dados Processados (GB)","v":"4.446","t":"+16.4%","d":"up"},{"l":"Utilizadores Analytics","v":"3.154","t":"+17.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4066","2026-02-17","8.593","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2219","2026-02-22","1.590","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2706","2026-03-25","4.804","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3156","2026-03-01","7.999","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2295","2026-01-12","2.090","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":957},{"label":"Fev","value":860},{"label":"Mar","value":1047},{"label":"Abr","value":975},{"label":"Mai","value":744},{"label":"Jun","value":937},{"label":"Jul","value":965},{"label":"Ago","value":805},{"label":"Set","value":990},{"label":"Out","value":830},{"label":"Nov","value":710},{"label":"Dez","value":861}];
const MX = 1047;
