...
const KPIS = [
    { label: "Total Registos", value: "5192", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2067", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€422K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "173552092", cells: ["SOC-6092", "Social Housing Item 1", "1/5/2026", "€2192"], status: "active" as const },
    { id: "173555663", cells: ["SOC-9663", "Social Housing Item 2", "16/12/2026", "€5763"], status: "pending" as const },
    { id: "173559234", cells: ["SOC-4234", "Social Housing Item 3", "3/7/2026", "€9334"], status: "completed" as const },
    { id: "173562805", cells: ["SOC-7805", "Social Housing Item 4", "18/2/2026", "€12 905"], status: "warning" as const },
    { id: "173566376", cells: ["SOC-2376", "Social Housing Item 5", "5/9/2026", "€16 476"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Social Housing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Social Housing</p>
                    </div>
                </div>
