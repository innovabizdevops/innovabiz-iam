...
const PAGE = "Apply";
const KPIS = [{"l":"Total Social Housing","v":"2.054","t":"+17.9%","d":"up"},{"l":"Apply Ativos","v":"8.526","t":"+4.0%","d":"up"},{"l":"Eficiência (%)","v":"89.2%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"81","t":"+5.4%","d":"up"}];
const COLS = ["ID","Apply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Social Housing #001","Social Housing #002","8.533","7.472","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Social Housing #002","Social Housing #003","1.270","651","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Social Housing #003","Social Housing #004","5.388","4.774","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Social Housing #004","Social Housing #005","4.859","6.736","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Social Housing #005","Social Housing #001","1.589","4.742","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":809},{"label":"Mar","value":869},{"label":"Abr","value":978},{"label":"Mai","value":841},{"label":"Jun","value":666},{"label":"Jul","value":790},{"label":"Ago","value":811},{"label":"Set","value":852},{"label":"Out","value":631},{"label":"Nov","value":784},{"label":"Dez","value":810}];
const MX = 978;
