...
const PAGE = "Maintain";
const KPIS = [{"l":"Total Social Housing","v":"8.966","t":"+3.0%","d":"up"},{"l":"Maintain Ativos","v":"7.391","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"85.1%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"73","t":"+7.8%","d":"up"}];
const COLS = ["ID","Maintain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Social Housing #001","Social Housing #002","7.216","8.373","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Social Housing #002","Social Housing #003","6.296","7.346","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Social Housing #003","Social Housing #004","266","5.468","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Social Housing #004","Social Housing #005","8.500","2.144","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Social Housing #005","Social Housing #001","7.548","3.249","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":747},{"label":"Mar","value":727},{"label":"Abr","value":678},{"label":"Mai","value":921},{"label":"Jun","value":859},{"label":"Jul","value":884},{"label":"Ago","value":968},{"label":"Set","value":886},{"label":"Out","value":622},{"label":"Nov","value":843},{"label":"Dez","value":937}];
const MX = 968;
