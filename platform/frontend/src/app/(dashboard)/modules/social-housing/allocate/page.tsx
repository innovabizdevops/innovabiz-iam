...
const ACCENT = "#831843";
const MODULE = "Social Housing";
const PAGE = "Allocate";
const KPIS = [{"l":"Total Social Housing","v":"4.217","t":"+0.7%","d":"up"},{"l":"Allocate Ativos","v":"5.451","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"77.6%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"63","t":"+5.3%","d":"up"}];
const COLS = ["ID","Allocate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Social Housing #001","Social Housing #002","1.583","7.030","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Social Housing #002","Social Housing #003","1.455","8.992","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Social Housing #003","Social Housing #004","3.852","8.003","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Social Housing #004","Social Housing #005","8.461","7.058","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Social Housing #005","Social Housing #001","6.663","1.552","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":339},{"label":"Fev","value":379},{"label":"Mar","value":521},{"label":"Abr","value":447},{"label":"Mai","value":676},{"label":"Jun","value":573},{"label":"Jul","value":711},{"label":"Ago","value":482},{"label":"Set","value":382},{"label":"Out","value":640},{"label":"Nov","value":714},{"label":"Dez","value":548}];
const MX = 714;
