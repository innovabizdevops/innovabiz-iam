...
const PAGE = "Report";
const KPIS = [{"l":"Total Social Housing","v":"2.493","t":"+13.9%","d":"up"},{"l":"Report Ativos","v":"8.407","t":"+14.6%","d":"up"},{"l":"Eficiência (%)","v":"67.2%","t":"+0.1%","d":"up"},{"l":"Score Performance","v":"92","t":"+2.4%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Social Housing #001","Social Housing #002","9.057","6.374","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Social Housing #002","Social Housing #003","7.309","751","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Social Housing #003","Social Housing #004","5.668","4.380","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Social Housing #004","Social Housing #005","7.978","1.257","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Social Housing #005","Social Housing #001","4.735","8.735","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":676},{"label":"Mar","value":844},{"label":"Abr","value":761},{"label":"Mai","value":863},{"label":"Jun","value":985},{"label":"Jul","value":833},{"label":"Ago","value":940},{"label":"Set","value":661},{"label":"Out","value":871},{"label":"Nov","value":790},{"label":"Dez","value":881}];
const MX = 985;
