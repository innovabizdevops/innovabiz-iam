...
const PAGE = "Manage";
const KPIS = [{"l":"Total Social Housing","v":"1.258","t":"+4.1%","d":"up"},{"l":"Manage Ativos","v":"2.840","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"92.0%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"63","t":"-1.8%","d":"down"}];
const COLS = ["ID","Manage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Social Housing #001","Social Housing #002","3.236","3.352","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Social Housing #002","Social Housing #003","8.876","5.064","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Social Housing #003","Social Housing #004","1.915","5.575","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Social Housing #004","Social Housing #005","4.922","4.897","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Social Housing #005","Social Housing #001","7.581","8.161","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":939},{"label":"Fev","value":885},{"label":"Mar","value":697},{"label":"Abr","value":862},{"label":"Mai","value":880},{"label":"Jun","value":1011},{"label":"Jul","value":898},{"label":"Ago","value":1019},{"label":"Set","value":890},{"label":"Out","value":834},{"label":"Nov","value":770},{"label":"Dez","value":866}];
const MX = 1019;
