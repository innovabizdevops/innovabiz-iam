...
const PAGE = "Event";
const KPIS = [{"l":"Formulários Ativos","v":"785","t":"+16.5%","d":"up"},{"l":"Submissões/Dia","v":"2084","t":"+14.3%","d":"up"},{"l":"Documentos Gerados","v":"5.857","t":"-1.6%","d":"down"},{"l":"Templates","v":"6.224","t":"-5.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.388","2026-01-18","5.024","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.557","2026-03-06","8.820","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.564","2026-02-18","5.286","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.857","2026-02-15","8.872","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","9.014","2026-03-25","1.484","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":996},{"label":"Mar","value":974},{"label":"Abr","value":724},{"label":"Mai","value":795},{"label":"Jun","value":723},{"label":"Jul","value":775},{"label":"Ago","value":917},{"label":"Set","value":1044},{"label":"Out","value":846},{"label":"Nov","value":880},{"label":"Dez","value":822}];
const MX = 1044;
