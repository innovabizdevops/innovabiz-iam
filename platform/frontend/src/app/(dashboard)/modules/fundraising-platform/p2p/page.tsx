...
const KPIS = [{"l":"Formulários Ativos","v":"781","t":"+1.2%","d":"up"},{"l":"Submissões/Dia","v":"4124","t":"+3.6%","d":"up"},{"l":"Documentos Gerados","v":"7.198","t":"+17.7%","d":"up"},{"l":"Templates","v":"6.997","t":"+17.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.289","2026-01-16","4.025","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.295","2026-01-09","8.326","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.974","2026-03-28","2.479","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.349","2026-02-24","8.446","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.986","2026-02-01","2.902","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":639},{"label":"Mar","value":940},{"label":"Abr","value":684},{"label":"Mai","value":906},{"label":"Jun","value":856},{"label":"Jul","value":641},{"label":"Ago","value":723},{"label":"Set","value":818},{"label":"Out","value":891},{"label":"Nov","value":733},{"label":"Dez","value":595}];
const MX = 940;
