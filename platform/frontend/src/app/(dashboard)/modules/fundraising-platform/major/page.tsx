...
const ACCENT = "#6366f1";
const MODULE = "Fundraising Platform";
const PAGE = "Major Gift";
const KPIS = [{"l":"Formulários Ativos","v":"4.413","t":"+10.9%","d":"up"},{"l":"Submissões/Dia","v":"4298","t":"+6.4%","d":"up"},{"l":"Documentos Gerados","v":"2.823","t":"-5.6%","d":"down"},{"l":"Templates","v":"4.625","t":"-0.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.606","2026-03-21","7.956","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.773","2026-01-20","7.780","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.039","2026-02-23","2.198","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.631","2026-01-21","750","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","612","2026-01-23","5.783","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":445},{"label":"Fev","value":565},{"label":"Mar","value":532},{"label":"Abr","value":783},{"label":"Mai","value":673},{"label":"Jun","value":782},{"label":"Jul","value":799},{"label":"Ago","value":647},{"label":"Set","value":626},{"label":"Out","value":511},{"label":"Nov","value":818},{"label":"Dez","value":549}];
const MX = 818;
