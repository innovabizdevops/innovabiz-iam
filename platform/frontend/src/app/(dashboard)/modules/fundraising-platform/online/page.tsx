...
const PAGE = "Online";
const KPIS = [{"l":"Formulários Ativos","v":"7.448","t":"+12.3%","d":"up"},{"l":"Submissões/Dia","v":"2948","t":"+4.1%","d":"up"},{"l":"Documentos Gerados","v":"3.377","t":"+15.7%","d":"up"},{"l":"Templates","v":"8.363","t":"+9.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.525","2026-03-18","2.952","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","151","2026-03-16","3.214","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.624","2026-03-01","5.127","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.867","2026-02-01","1.113","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.094","2026-03-13","6.094","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":871},{"label":"Mar","value":812},{"label":"Abr","value":713},{"label":"Mai","value":847},{"label":"Jun","value":869},{"label":"Jul","value":911},{"label":"Ago","value":768},{"label":"Set","value":848},{"label":"Out","value":736},{"label":"Nov","value":764},{"label":"Dez","value":729}];
const MX = 911;
