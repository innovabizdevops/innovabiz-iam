...
const PAGE = "Grant";
const KPIS = [{"l":"Formulários Ativos","v":"240","t":"+5.5%","d":"up"},{"l":"Submissões/Dia","v":"4033","t":"+7.0%","d":"up"},{"l":"Documentos Gerados","v":"8.918","t":"+13.4%","d":"up"},{"l":"Templates","v":"7.316","t":"-4.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.902","2026-02-09","6.911","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.148","2026-02-08","2.435","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.050","2026-02-26","7.127","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.657","2026-01-21","1.205","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.170","2026-03-16","2.701","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":690},{"label":"Mar","value":761},{"label":"Abr","value":799},{"label":"Mai","value":657},{"label":"Jun","value":981},{"label":"Jul","value":931},{"label":"Ago","value":806},{"label":"Set","value":859},{"label":"Out","value":953},{"label":"Nov","value":843},{"label":"Dez","value":747}];
const MX = 981;
