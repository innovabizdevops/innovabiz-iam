...
const ACCENT = "#e11d48";
const MODULE = "Media & Publishing";
const PAGE = "Audience Analytics AI";
const KPIS = [{"l":"Dashboards Ativos","v":"8.456","t":"+2.5%","d":"up"},{"l":"Queries/Dia","v":"4375","t":"+12.5%","d":"up"},{"l":"Dados Processados (GB)","v":"8.991","t":"+0.0%","d":"up"},{"l":"Utilizadores Analytics","v":"8.347","t":"-2.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2090","2026-03-16","4.299","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4122","2026-02-17","8.651","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3045","2026-01-27","2.436","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2437","2026-03-02","7.510","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2424","2026-03-08","4.074","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":661},{"label":"Mar","value":942},{"label":"Abr","value":894},{"label":"Mai","value":564},{"label":"Jun","value":734},{"label":"Jul","value":734},{"label":"Ago","value":567},{"label":"Set","value":893},{"label":"Out","value":671},{"label":"Nov","value":939},{"label":"Dez","value":854}];
const MX = 942;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#e11d48'}}>AI</span></h1>
                </div>
