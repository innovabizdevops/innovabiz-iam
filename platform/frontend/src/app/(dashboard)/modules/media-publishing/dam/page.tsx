...
const KPIS = [{"l":"Integrações Ativas","v":"6.472","t":"+1.5%","d":"up"},{"l":"Chamadas/Hora","v":"508","t":"+12.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.5%","t":"+8.7%","d":"up"},{"l":"Latência Média (ms)","v":"42ms","t":"+15.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","830","6.759","99.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.280","7.962","89.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.113","4.276","73.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.411","887","78.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.018","5.162","98.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":462},{"label":"Mar","value":426},{"label":"Abr","value":701},{"label":"Mai","value":567},{"label":"Jun","value":446},{"label":"Jul","value":780},{"label":"Ago","value":665},{"label":"Set","value":488},{"label":"Out","value":556},{"label":"Nov","value":751},{"label":"Dez","value":558}];
const MX = 780;
