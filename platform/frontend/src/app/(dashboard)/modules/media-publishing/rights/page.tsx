...
const PAGE = "Rights Management";
const KPIS = [{"l":"Integrações Ativas","v":"8.818","t":"-3.2%","d":"down"},{"l":"Chamadas/Hora","v":"3051","t":"+8.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.4%","t":"+16.0%","d":"up"},{"l":"Latência Média (ms)","v":"32ms","t":"+15.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.236","3.936","89.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.251","4.537","76.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.397","7.559","96.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.748","7.881","70.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.623","5.813","86.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":512},{"label":"Mar","value":497},{"label":"Abr","value":620},{"label":"Mai","value":534},{"label":"Jun","value":693},{"label":"Jul","value":382},{"label":"Ago","value":418},{"label":"Set","value":571},{"label":"Out","value":570},{"label":"Nov","value":649},{"label":"Dez","value":441}];
const MX = 693;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#e11d48'}}>DRM</span></h1>
                </div>
