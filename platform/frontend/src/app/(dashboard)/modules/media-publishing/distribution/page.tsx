...
const PAGE = "Distribution Channels";
const KPIS = [{"l":"Integrações Ativas","v":"7.608","t":"-4.6%","d":"down"},{"l":"Chamadas/Hora","v":"3669","t":"+8.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.9%","t":"+17.1%","d":"up"},{"l":"Latência Média (ms)","v":"72ms","t":"+14.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.603","3.208","82.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.038","1.621","82.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.737","5.756","85.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","987","5.911","95.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.393","229","98.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":362},{"label":"Fev","value":273},{"label":"Mar","value":465},{"label":"Abr","value":652},{"label":"Mai","value":278},{"label":"Jun","value":456},{"label":"Jul","value":289},{"label":"Ago","value":567},{"label":"Set","value":613},{"label":"Out","value":605},{"label":"Nov","value":597},{"label":"Dez","value":640}];
const MX = 652;
