...
const PAGE = "Content Pipeline";
const KPIS = [{"l":"Integrações Ativas","v":"6.644","t":"+13.4%","d":"up"},{"l":"Chamadas/Hora","v":"1457","t":"-5.8%","d":"down"},{"l":"Taxa Sucesso (%)","v":"89.7%","t":"+14.0%","d":"up"},{"l":"Latência Média (ms)","v":"25ms","t":"+7.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","370","8.416","84.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.946","4.219","90.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.582","3.565","91.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.434","3.714","93.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.062","3.306","97.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":710},{"label":"Mar","value":758},{"label":"Abr","value":479},{"label":"Mai","value":775},{"label":"Jun","value":646},{"label":"Jul","value":636},{"label":"Ago","value":658},{"label":"Set","value":608},{"label":"Out","value":521},{"label":"Nov","value":476},{"label":"Dez","value":613}];
const MX = 825;
