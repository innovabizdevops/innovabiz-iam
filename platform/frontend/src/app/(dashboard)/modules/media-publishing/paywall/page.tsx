...
const PAGE = "Subscription Paywall";
const KPIS = [{"l":"ARR (€M)","v":"€40.6M","t":"-3.5%","d":"down"},{"l":"MRR (€)","v":"€18848","t":"-1.5%","d":"down"},{"l":"Churn (%)","v":"74.1%","t":"+13.3%","d":"up"},{"l":"ARPU (€)","v":"€3387","t":"+13.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 42358.18","238","€ 47298.76","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 36119.91","7.309","€ 14777.12","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 36942.08","2.446","€ 33172.42","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 7681.85","3.499","€ 712.03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 537.04","903","€ 46852.82","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":935},{"label":"Fev","value":893},{"label":"Mar","value":807},{"label":"Abr","value":726},{"label":"Mai","value":938},{"label":"Jun","value":962},{"label":"Jul","value":989},{"label":"Ago","value":1001},{"label":"Set","value":920},{"label":"Out","value":1008},{"label":"Nov","value":1011},{"label":"Dez","value":869}];
const MX = 1011;
