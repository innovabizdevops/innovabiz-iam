...
const PAGE = "Editorial Calendar";
const KPIS = [{"l":"Integrações Ativas","v":"6.946","t":"+3.2%","d":"up"},{"l":"Chamadas/Hora","v":"1078","t":"+12.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"84.4%","t":"+6.5%","d":"up"},{"l":"Latência Média (ms)","v":"182ms","t":"+4.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.570","5.392","96.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.392","1.614","70.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.106","7.286","75.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.910","4.554","71.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.403","4.954","92.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":522},{"label":"Mar","value":490},{"label":"Abr","value":812},{"label":"Mai","value":714},{"label":"Jun","value":608},{"label":"Jul","value":671},{"label":"Ago","value":488},{"label":"Set","value":481},{"label":"Out","value":666},{"label":"Nov","value":755},{"label":"Dez","value":619}];
const MX = 812;
