...
const PAGE = "Ad Revenue Mgmt";
const KPIS = [{"l":"ARR (€M)","v":"€3.6M","t":"+6.6%","d":"up"},{"l":"MRR (€)","v":"€51570","t":"+0.2%","d":"up"},{"l":"Churn (%)","v":"67.9%","t":"+9.6%","d":"up"},{"l":"ARPU (€)","v":"€60360","t":"-0.3%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 35532.13","7.431","€ 31716.49","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 21662.26","3.872","€ 28007.84","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 42221.10","2.644","€ 12535.96","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 39950.10","2.485","€ 24870.04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 4689.46","5.917","€ 21995.18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":590},{"label":"Mar","value":833},{"label":"Abr","value":758},{"label":"Mai","value":814},{"label":"Jun","value":582},{"label":"Jul","value":708},{"label":"Ago","value":767},{"label":"Set","value":813},{"label":"Out","value":864},{"label":"Nov","value":649},{"label":"Dez","value":641}];
const MX = 864;
