...
const PAGE = "Label";
const KPIS = [{"l":"Total Ready Meal","v":"8.289","t":"-3.4%","d":"down"},{"l":"Label Ativos","v":"5.886","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"88.4%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"86","t":"+4.2%","d":"up"}];
const COLS = ["ID","Label","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ready Meal #001","Ready Meal #002","2.369","8.264","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Ready Meal #002","Ready Meal #003","5.049","6.335","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Ready Meal #003","Ready Meal #004","1.956","3.193","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Ready Meal #004","Ready Meal #005","3.377","3.675","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ready Meal #005","Ready Meal #001","988","2.041","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":649},{"label":"Mar","value":376},{"label":"Abr","value":446},{"label":"Mai","value":658},{"label":"Jun","value":424},{"label":"Jul","value":536},{"label":"Ago","value":638},{"label":"Set","value":489},{"label":"Out","value":412},{"label":"Nov","value":563},{"label":"Dez","value":286}];
const MX = 658;
