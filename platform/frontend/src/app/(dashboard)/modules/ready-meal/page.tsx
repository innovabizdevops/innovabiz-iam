...
export default function ReadyMealPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Ready Meal</h1><p className="text-sm text-muted-foreground">Ready Meal • iBOS Enterprise</p></div>
