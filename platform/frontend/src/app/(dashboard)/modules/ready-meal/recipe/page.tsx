...
const PAGE = "Recipe";
const KPIS = [{"l":"Total Ready Meal","v":"1.565","t":"-3.7%","d":"down"},{"l":"Recipe Ativos","v":"4.968","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"87.4%","t":"+10.7%","d":"up"},{"l":"Score Performance","v":"72","t":"+1.7%","d":"up"}];
const COLS = ["ID","Recipe","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ready Meal #001","Ready Meal #002","1.890","169","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Ready Meal #002","Ready Meal #003","3.069","4.570","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Ready Meal #003","Ready Meal #004","3.297","2.661","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Ready Meal #004","Ready Meal #005","3.913","1.859","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ready Meal #005","Ready Meal #001","3.834","4.058","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":864},{"label":"Mar","value":604},{"label":"Abr","value":713},{"label":"Mai","value":649},{"label":"Jun","value":918},{"label":"Jul","value":888},{"label":"Ago","value":589},{"label":"Set","value":756},{"label":"Out","value":844},{"label":"Nov","value":947},{"label":"Dez","value":850}];
const MX = 947;
