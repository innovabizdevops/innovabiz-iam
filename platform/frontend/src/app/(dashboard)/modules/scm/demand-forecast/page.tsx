...
const PAGE = "Demand Forecast AI";
const KPIS = [{"l":"Total Scm","v":"1.119","t":"+3.1%","d":"up"},{"l":"Demand Forecast AI Ativos","v":"2.153","t":"+14.5%","d":"up"},{"l":"Eficiência (%)","v":"67.1%","t":"+4.8%","d":"up"},{"l":"Score Performance","v":"65","t":"+10.4%","d":"up"}];
const COLS = ["ID","Demand Forecast AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Scm #001","Scm #002","411","6.766","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Scm #002","Scm #003","6.635","3.289","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Scm #003","Scm #004","8.971","4.709","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Scm #004","Scm #005","5.512","4.303","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Scm #005","Scm #001","5.723","4.554","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":902},{"label":"Mar","value":603},{"label":"Abr","value":856},{"label":"Mai","value":598},{"label":"Jun","value":802},{"label":"Jul","value":846},{"label":"Ago","value":724},{"label":"Set","value":737},{"label":"Out","value":855},{"label":"Nov","value":581},{"label":"Dez","value":806}];
const MX = 902;
