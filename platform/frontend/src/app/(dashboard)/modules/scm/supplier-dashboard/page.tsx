...
const PAGE = "Supplier Dashboard";
const KPIS = [{"l":"Ideias Submetidas","v":"2.527","t":"+0.9%","d":"up"},{"l":"Patentes (YTD)","v":"8.719","t":"+7.9%","d":"up"},{"l":"Projetos Innovation Lab","v":"1.599","t":"+13.1%","d":"up"},{"l":"Budget I&D (€M)","v":"€31.5M","t":"+14.1%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","196","92.0%","7.822","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.043","72.7%","8.343","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","5.276","88.4%","1.508","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","8.499","92.9%","1.547","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","5.006","72.4%","6.674","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":705},{"label":"Mar","value":716},{"label":"Abr","value":713},{"label":"Mai","value":488},{"label":"Jun","value":631},{"label":"Jul","value":726},{"label":"Ago","value":602},{"label":"Set","value":550},{"label":"Out","value":777},{"label":"Nov","value":523},{"label":"Dez","value":821}];
const MX = 821;
