...
const PAGE = "Product Config";
const KPIS = [{"l":"Configurações","v":"2.578","t":"+17.5%","d":"up"},{"l":"Últimas Alterações","v":"4.287","t":"+0.2%","d":"up"},{"l":"Ambientes","v":"2.131","t":"+15.4%","d":"up"},{"l":"Versão Config","v":"2.883","t":"+17.2%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 45975.42","6.716","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 9423.87","3.350","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 14241.18","6.347","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 39473.04","5.137","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 44128.87","4.494","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":933},{"label":"Mar","value":903},{"label":"Abr","value":787},{"label":"Mai","value":931},{"label":"Jun","value":789},{"label":"Jul","value":1002},{"label":"Ago","value":1022},{"label":"Set","value":698},{"label":"Out","value":821},{"label":"Nov","value":909},{"label":"Dez","value":912}];
const MX = 1022;
