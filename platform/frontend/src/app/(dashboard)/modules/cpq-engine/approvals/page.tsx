...
const KPIS = [{"l":"Aprovações Pendentes","v":"8.487","t":"+1.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"68.5%","t":"-2.5%","d":"down"},{"l":"Tempo Médio (h)","v":"132h","t":"+14.2%","d":"up"},{"l":"Rejeitadas (%)","v":"72.0%","t":"+7.2%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","2.331","€ 24408.28","918","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","8.583","€ 18178.80","2.641","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","225","€ 5265.88","7.958","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","4.361","€ 24792.34","3.104","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","3.501","€ 31110.56","6.139","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":975},{"label":"Fev","value":656},{"label":"Mar","value":704},{"label":"Abr","value":953},{"label":"Mai","value":1010},{"label":"Jun","value":695},{"label":"Jul","value":967},{"label":"Ago","value":703},{"label":"Set","value":824},{"label":"Out","value":989},{"label":"Nov","value":656},{"label":"Dez","value":931}];
const MX = 1010;
