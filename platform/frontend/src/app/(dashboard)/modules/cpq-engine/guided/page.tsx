...
const ACCENT = "#dc2626";
const MODULE = "CPQ Engine";
const PAGE = "Guided Selling";
const KPIS = [{"l":"Artigos Publicados","v":"7.370","t":"+15.2%","d":"up"},{"l":"Views/Semana","v":"547","t":"-3.5%","d":"down"},{"l":"Feedback Útil (%)","v":"75.7%","t":"+7.5%","d":"up"},{"l":"Artigos Desatualizados","v":"6.579","t":"+10.8%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","4.329","99.5%","5.668","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","1.083","77.7%","411","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","7.232","96.2%","732","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","6.672","96.4%","5.901","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","6.008","73.9%","112","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1000},{"label":"Fev","value":965},{"label":"Mar","value":764},{"label":"Abr","value":960},{"label":"Mai","value":729},{"label":"Jun","value":1071},{"label":"Jul","value":899},{"label":"Ago","value":1003},{"label":"Set","value":718},{"label":"Out","value":798},{"label":"Nov","value":1063},{"label":"Dez","value":989}];
const MX = 1071;
