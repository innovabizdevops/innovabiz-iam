...
const KPIS = [{"l":"ARR (€M)","v":"€37.1M","t":"+9.0%","d":"up"},{"l":"MRR (€)","v":"€8646","t":"+13.6%","d":"up"},{"l":"Churn (%)","v":"85.6%","t":"+10.2%","d":"up"},{"l":"ARPU (€)","v":"€52379","t":"+2.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 42483.57","6.561","€ 24851.35","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 47698.23","6.332","€ 137.38","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 333.93","6.517","€ 43134.66","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 39113.75","2.108","€ 44364.93","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 39098.43","1.454","€ 44888.32","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":646},{"label":"Fev","value":666},{"label":"Mar","value":997},{"label":"Abr","value":993},{"label":"Mai","value":817},{"label":"Jun","value":638},{"label":"Jul","value":973},{"label":"Ago","value":721},{"label":"Set","value":647},{"label":"Out","value":736},{"label":"Nov","value":986},{"label":"Dez","value":742}];
const MX = 997;
