...
const PAGE = "Volume Discount";
const KPIS = [{"l":"ARR (€M)","v":"€14.5M","t":"+4.8%","d":"up"},{"l":"MRR (€)","v":"€59110","t":"-3.2%","d":"down"},{"l":"Churn (%)","v":"82.9%","t":"+9.2%","d":"up"},{"l":"ARPU (€)","v":"€74522","t":"-0.5%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 19238.85","827","€ 39278.56","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 29405.01","1.172","€ 36588.53","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 1267.65","1.745","€ 13872.07","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 47977.61","4.768","€ 10063.42","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 46437.96","7.717","€ 44456.95","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":428},{"label":"Fev","value":243},{"label":"Mar","value":573},{"label":"Abr","value":271},{"label":"Mai","value":286},{"label":"Jun","value":325},{"label":"Jul","value":393},{"label":"Ago","value":301},{"label":"Set","value":419},{"label":"Out","value":472},{"label":"Nov","value":220},{"label":"Dez","value":451}];
const MX = 573;
