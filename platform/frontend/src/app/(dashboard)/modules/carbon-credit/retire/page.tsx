...
const KPIS = [{"l":"Integrações Ativas","v":"5.619","t":"+9.3%","d":"up"},{"l":"Chamadas/Hora","v":"3207","t":"-3.7%","d":"down"},{"l":"Taxa Sucesso (%)","v":"90.1%","t":"+17.7%","d":"up"},{"l":"Latência Média (ms)","v":"152ms","t":"-2.4%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.061","4.835","92.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.835","6.692","99.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.077","7.929","94.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.936","7.721","79.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.522","342","88.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":518},{"label":"Fev","value":481},{"label":"Mar","value":761},{"label":"Abr","value":631},{"label":"Mai","value":734},{"label":"Jun","value":492},{"label":"Jul","value":673},{"label":"Ago","value":730},{"label":"Set","value":709},{"label":"Out","value":685},{"label":"Nov","value":651},{"label":"Dez","value":783}];
const MX = 783;
