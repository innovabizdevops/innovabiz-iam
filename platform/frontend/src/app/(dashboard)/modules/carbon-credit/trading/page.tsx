...
const PAGE = "Trading";
const KPIS = [{"l":"Integrações Ativas","v":"8.482","t":"+2.6%","d":"up"},{"l":"Chamadas/Hora","v":"4972","t":"+7.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.9%","t":"-3.5%","d":"down"},{"l":"Latência Média (ms)","v":"121ms","t":"-1.2%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.263","4.158","72.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.634","2.413","91.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.955","1.500","74.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.828","6.316","92.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.519","7.837","80.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":589},{"label":"Mar","value":849},{"label":"Abr","value":794},{"label":"Mai","value":788},{"label":"Jun","value":666},{"label":"Jul","value":727},{"label":"Ago","value":864},{"label":"Set","value":799},{"label":"Out","value":913},{"label":"Nov","value":710},{"label":"Dez","value":930}];
const MX = 930;
