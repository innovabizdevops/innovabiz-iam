...
const ACCENT = "#6366f1";
const MODULE = "Carbon Credit Trading";
const PAGE = "MRV";
const KPIS = [{"l":"Integrações Ativas","v":"2.983","t":"+10.6%","d":"up"},{"l":"Chamadas/Hora","v":"1522","t":"+0.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"91.0%","t":"+0.6%","d":"up"},{"l":"Latência Média (ms)","v":"45ms","t":"+17.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.773","8.952","77.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.189","8.211","82.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.590","8.015","94.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.778","2.475","98.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.406","889","93.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":892},{"label":"Fev","value":996},{"label":"Mar","value":925},{"label":"Abr","value":689},{"label":"Mai","value":754},{"label":"Jun","value":937},{"label":"Jul","value":995},{"label":"Ago","value":872},{"label":"Set","value":991},{"label":"Out","value":710},{"label":"Nov","value":1008},{"label":"Dez","value":1056}];
const MX = 1056;
