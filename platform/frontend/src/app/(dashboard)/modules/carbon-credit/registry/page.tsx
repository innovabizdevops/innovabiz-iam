...
const PAGE = "Registry";
const KPIS = [{"l":"Integrações Ativas","v":"3.700","t":"+5.9%","d":"up"},{"l":"Chamadas/Hora","v":"1363","t":"-1.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"76.2%","t":"+0.5%","d":"up"},{"l":"Latência Média (ms)","v":"27ms","t":"-2.9%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.817","2.120","75.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","910","7.383","72.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.536","1.802","85.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.011","1.869","74.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.288","4.367","99.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":779},{"label":"Mar","value":740},{"label":"Abr","value":734},{"label":"Mai","value":901},{"label":"Jun","value":959},{"label":"Jul","value":957},{"label":"Ago","value":771},{"label":"Set","value":928},{"label":"Out","value":852},{"label":"Nov","value":781},{"label":"Dez","value":714}];
const MX = 959;
