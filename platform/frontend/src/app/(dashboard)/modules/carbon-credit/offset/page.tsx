...
const PAGE = "Offset";
const KPIS = [{"l":"Integrações Ativas","v":"3.722","t":"+11.8%","d":"up"},{"l":"Chamadas/Hora","v":"2455","t":"+1.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.3%","t":"+6.4%","d":"up"},{"l":"Latência Média (ms)","v":"65ms","t":"+5.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.130","7.459","77.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.427","3.342","73.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.578","4.325","77.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.195","7.031","75.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.006","2.833","92.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":604},{"label":"Mar","value":642},{"label":"Abr","value":616},{"label":"Mai","value":894},{"label":"Jun","value":918},{"label":"Jul","value":824},{"label":"Ago","value":898},{"label":"Set","value":817},{"label":"Out","value":904},{"label":"Nov","value":600},{"label":"Dez","value":830}];
const MX = 918;
