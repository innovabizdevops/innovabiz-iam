...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"5.335","t":"-4.2%","d":"down"},{"l":"Submissões/Dia","v":"3899","t":"+9.6%","d":"up"},{"l":"Documentos Gerados","v":"6.709","t":"+0.6%","d":"up"},{"l":"Templates","v":"4.336","t":"+14.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.554","2026-03-13","7.284","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.370","2026-03-05","2.607","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.935","2026-03-22","1.084","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.529","2026-01-15","4.580","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.340","2026-03-15","525","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":413},{"label":"Fev","value":559},{"label":"Mar","value":733},{"label":"Abr","value":573},{"label":"Mai","value":548},{"label":"Jun","value":650},{"label":"Jul","value":491},{"label":"Ago","value":480},{"label":"Set","value":722},{"label":"Out","value":664},{"label":"Nov","value":502},{"label":"Dez","value":454}];
const MX = 733;
