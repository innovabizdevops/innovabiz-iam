...
const PAGE = "Scan";
const KPIS = [{"l":"Total 3d Dental Print","v":"7.864","t":"+11.6%","d":"up"},{"l":"Scan Ativos","v":"7.300","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"69.6%","t":"+17.2%","d":"up"},{"l":"Score Performance","v":"61","t":"-5.3%","d":"down"}];
const COLS = ["ID","Scan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Dental Print #001","3d Dental Print #002","6.277","3.482","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["3d Dental Print #002","3d Dental Print #003","3.889","5.943","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Dental Print #003","3d Dental Print #004","8.867","8.417","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["3d Dental Print #004","3d Dental Print #005","3.158","1.472","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Dental Print #005","3d Dental Print #001","4.817","5.129","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":354},{"label":"Fev","value":436},{"label":"Mar","value":343},{"label":"Abr","value":317},{"label":"Mai","value":400},{"label":"Jun","value":565},{"label":"Jul","value":302},{"label":"Ago","value":488},{"label":"Set","value":626},{"label":"Out","value":304},{"label":"Nov","value":498},{"label":"Dez","value":564}];
const MX = 626;
