...
const PAGE = "Print";
const KPIS = [{"l":"Total 3d Dental Print","v":"3.691","t":"+16.2%","d":"up"},{"l":"Print Ativos","v":"3.806","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"88.2%","t":"+10.8%","d":"up"},{"l":"Score Performance","v":"75","t":"+1.7%","d":"up"}];
const COLS = ["ID","Print","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Dental Print #001","3d Dental Print #002","4.812","4.399","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["3d Dental Print #002","3d Dental Print #003","1.889","8.248","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Dental Print #003","3d Dental Print #004","121","1.964","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["3d Dental Print #004","3d Dental Print #005","2.090","2.157","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Dental Print #005","3d Dental Print #001","1.732","4.782","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":862},{"label":"Mar","value":930},{"label":"Abr","value":788},{"label":"Mai","value":721},{"label":"Jun","value":806},{"label":"Jul","value":833},{"label":"Ago","value":938},{"label":"Set","value":828},{"label":"Out","value":983},{"label":"Nov","value":947},{"label":"Dez","value":787}];
const MX = 983;
