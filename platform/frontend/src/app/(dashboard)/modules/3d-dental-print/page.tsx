...
/* ═══ Dental 3D Printing — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "9171", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4936", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€233K", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "533232971", cells: ["3D-1971", "Dental 3D Printing Item 1", "20/12/2026", "€33 071"], status: "active" as const },
    { id: "533236542", cells: ["3D-5542", "Dental 3D Printing Item 2", "7/7/2026", "€36 642"], status: "pending" as const },
    { id: "533240113", cells: ["3D-9113", "Dental 3D Printing Item 3", "22/2/2026", "€40 213"], status: "completed" as const },
    { id: "533243684", cells: ["3D-3684", "Dental 3D Printing Item 4", "9/9/2026", "€43 784"], status: "warning" as const },
    { id: "533247255", cells: ["3D-7255", "Dental 3D Printing Item 5", "24/4/2026", "€47 355"], status: "active" as const },
];
...
export default function Dental3dPrintingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Dental 3D Printing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Dental 3D Printing</p>
                    </div>
                </div>
