...
const ACCENT = "#4f46e5";
const MODULE = "Dental 3D Printing";
const PAGE = "Deliver";
const KPIS = [{"l":"Total 3d Dental Print","v":"6.269","t":"-2.3%","d":"down"},{"l":"Deliver Ativos","v":"8.904","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"78","t":"+7.9%","d":"up"}];
const COLS = ["ID","Deliver","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Dental Print #001","3d Dental Print #002","2.153","2.905","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["3d Dental Print #002","3d Dental Print #003","7.493","545","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Dental Print #003","3d Dental Print #004","2.798","6.684","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["3d Dental Print #004","3d Dental Print #005","2.168","2.125","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Dental Print #005","3d Dental Print #001","2.986","7.974","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":762},{"label":"Mar","value":900},{"label":"Abr","value":880},{"label":"Mai","value":716},{"label":"Jun","value":831},{"label":"Jul","value":640},{"label":"Ago","value":582},{"label":"Set","value":828},{"label":"Out","value":620},{"label":"Nov","value":959},{"label":"Dez","value":759}];
const MX = 959;
