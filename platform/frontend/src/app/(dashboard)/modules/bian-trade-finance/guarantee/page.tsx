...
const PAGE = "Guarantee";
const KPIS = [{"l":"BCP Plans Ativos","v":"1.510","t":"+9.3%","d":"up"},{"l":"RTO Médio (h)","v":"40h","t":"+8.6%","d":"up"},{"l":"RPO Médio (h)","v":"165h","t":"+7.0%","d":"up"},{"l":"Testes DR (YTD)","v":"8.906","t":"+11.5%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","134h","136h","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","15h","185h","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","139h","161h","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","91h","48h","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","161h","63h","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":760},{"label":"Fev","value":713},{"label":"Mar","value":601},{"label":"Abr","value":567},{"label":"Mai","value":619},{"label":"Jun","value":718},{"label":"Jul","value":850},{"label":"Ago","value":612},{"label":"Set","value":876},{"label":"Out","value":847},{"label":"Nov","value":512},{"label":"Dez","value":647}];
const MX = 876;
