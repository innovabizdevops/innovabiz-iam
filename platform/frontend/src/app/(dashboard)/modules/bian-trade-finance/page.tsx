...
/* ═══ Trade Finance (BIAN) — Dashboard ═══ */

const ACCENT = "#164e63";

const KPIS = [
    { label: "Total Registos", value: "3003", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4274", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€304K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "799586303", cells: ["BIA-9303", "Trade Finance (BIAN) Item 1", "20/12/2026", "€36 403"], status: "active" as const },
    { id: "799589874", cells: ["BIA-3874", "Trade Finance (BIAN) Item 2", "7/7/2026", "€39 974"], status: "pending" as const },
    { id: "799593445", cells: ["BIA-7445", "Trade Finance (BIAN) Item 3", "22/2/2026", "€43 545"], status: "completed" as const },
    { id: "799597016", cells: ["BIA-2016", "Trade Finance (BIAN) Item 4", "9/9/2026", "€47 116"], status: "warning" as const },
    { id: "799600587", cells: ["BIA-5587", "Trade Finance (BIAN) Item 5", "24/4/2026", "€687"], status: "active" as const },
];
...
export default function TradeFinanceBianPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Trade Finance (BIAN)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Trade Finance (BIAN)</p>
                    </div>
                </div>
