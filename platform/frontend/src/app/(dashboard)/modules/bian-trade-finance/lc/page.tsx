...
const PAGE = "LC";
const KPIS = [{"l":"BCP Plans Ativos","v":"4.918","t":"+16.3%","d":"up"},{"l":"RTO Médio (h)","v":"116h","t":"+14.2%","d":"up"},{"l":"RPO Médio (h)","v":"194h","t":"+13.2%","d":"up"},{"l":"Testes DR (YTD)","v":"8.598","t":"+2.2%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","24h","149h","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","75h","23h","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","115h","158h","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","73h","131h","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","53h","182h","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":923},{"label":"Mar","value":740},{"label":"Abr","value":617},{"label":"Mai","value":970},{"label":"Jun","value":934},{"label":"Jul","value":693},{"label":"Ago","value":678},{"label":"Set","value":815},{"label":"Out","value":970},{"label":"Nov","value":916},{"label":"Dez","value":839}];
const MX = 970;
