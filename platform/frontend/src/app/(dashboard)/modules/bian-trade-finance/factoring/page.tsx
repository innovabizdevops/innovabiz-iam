...
const KPIS = [{"l":"BCP Plans Ativos","v":"801","t":"+1.9%","d":"up"},{"l":"RTO Médio (h)","v":"79h","t":"+16.2%","d":"up"},{"l":"RPO Médio (h)","v":"127h","t":"+17.1%","d":"up"},{"l":"Testes DR (YTD)","v":"5.246","t":"+5.6%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","201h","133h","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","56h","113h","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","25h","146h","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","123h","125h","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","91h","114h","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":381},{"label":"Fev","value":308},{"label":"Mar","value":561},{"label":"Abr","value":313},{"label":"Mai","value":395},{"label":"Jun","value":417},{"label":"Jul","value":451},{"label":"Ago","value":408},{"label":"Set","value":383},{"label":"Out","value":395},{"label":"Nov","value":443},{"label":"Dez","value":312}];
const MX = 561;
