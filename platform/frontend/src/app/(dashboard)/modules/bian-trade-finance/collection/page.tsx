...
const KPIS = [{"l":"BCP Plans Ativos","v":"4.960","t":"+12.7%","d":"up"},{"l":"RTO Médio (h)","v":"94h","t":"-4.4%","d":"down"},{"l":"RPO Médio (h)","v":"119h","t":"+10.4%","d":"up"},{"l":"Testes DR (YTD)","v":"2.366","t":"+7.5%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","180h","15h","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","127h","28h","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","185h","155h","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","69h","53h","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","71h","153h","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":843},{"label":"Mar","value":704},{"label":"Abr","value":994},{"label":"Mai","value":713},{"label":"Jun","value":1040},{"label":"Jul","value":935},{"label":"Ago","value":988},{"label":"Set","value":865},{"label":"Out","value":866},{"label":"Nov","value":779},{"label":"Dez","value":872}];
const MX = 1040;
