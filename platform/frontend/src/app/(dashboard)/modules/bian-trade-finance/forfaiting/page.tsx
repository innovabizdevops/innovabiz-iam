...
const ACCENT = "#164e63";
const MODULE = "Trade Finance (BIAN)";
const PAGE = "Forfaiting";
const KPIS = [{"l":"BCP Plans Ativos","v":"7.837","t":"+8.8%","d":"up"},{"l":"RTO Médio (h)","v":"46h","t":"+8.3%","d":"up"},{"l":"RPO Médio (h)","v":"15h","t":"-1.6%","d":"down"},{"l":"Testes DR (YTD)","v":"9.070","t":"+14.6%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","194h","120h","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","119h","96h","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","22h","105h","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","200h","87h","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","152h","23h","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":584},{"label":"Fev","value":583},{"label":"Mar","value":595},{"label":"Abr","value":577},{"label":"Mai","value":681},{"label":"Jun","value":458},{"label":"Jul","value":609},{"label":"Ago","value":470},{"label":"Set","value":765},{"label":"Out","value":612},{"label":"Nov","value":626},{"label":"Dez","value":531}];
const MX = 765;
...
export default function ForfaitingPage() {
    return (
