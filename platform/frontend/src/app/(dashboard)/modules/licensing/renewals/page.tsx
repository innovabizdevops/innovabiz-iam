...
const PAGE = "Renewal Engine";
const KPIS = [{"l":"Contratos Ativos","v":"8.532","t":"+2.9%","d":"up"},{"l":"Valor Total (€M)","v":"€22.7M","t":"+1.1%","d":"up"},{"l":"Renovações Próx. 30d","v":"5.826","t":"+2.0%","d":"up"},{"l":"Obrigações Pendentes","v":"8.253","t":"+2.5%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 42637.60","2026-01-12","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 43281.20","2026-02-05","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 32969.60","2026-03-26","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 19191.64","2026-03-25","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 33937.71","2026-02-18","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":813},{"label":"Fev","value":717},{"label":"Mar","value":734},{"label":"Abr","value":817},{"label":"Mai","value":881},{"label":"Jun","value":827},{"label":"Jul","value":781},{"label":"Ago","value":755},{"label":"Set","value":592},{"label":"Out","value":863},{"label":"Nov","value":700},{"label":"Dez","value":905}];
const MX = 905;
