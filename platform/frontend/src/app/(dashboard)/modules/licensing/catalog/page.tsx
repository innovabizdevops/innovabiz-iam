...
const ACCENT = "#0d9488";
const MODULE = "Licensing & Entitlements";
const PAGE = "License Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"7.940","t":"-5.7%","d":"down"},{"l":"Queries/Dia","v":"3213","t":"-4.8%","d":"down"},{"l":"Dados Processados (GB)","v":"3.951","t":"+6.3%","d":"up"},{"l":"Utilizadores Analytics","v":"4.346","t":"+13.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1665","2026-03-26","1.769","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2464","2026-02-12","7.683","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1989","2026-02-07","4.365","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3534","2026-02-08","5.284","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3897","2026-03-19","8.322","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":572},{"label":"Mar","value":376},{"label":"Abr","value":655},{"label":"Mai","value":588},{"label":"Jun","value":536},{"label":"Jul","value":483},{"label":"Ago","value":367},{"label":"Set","value":630},{"label":"Out","value":345},{"label":"Nov","value":657},{"label":"Dez","value":398}];
const MX = 657;
