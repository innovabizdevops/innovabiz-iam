...
const PAGE = "IP Rights Management";
const KPIS = [{"l":"Projetos Melhoria","v":"2.666","t":"-2.8%","d":"down"},{"l":"Savings (€)","v":"€65830","t":"+8.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"83.8%","t":"+7.6%","d":"up"},{"l":"Ciclos PDCA","v":"5.359","t":"-2.7%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.525","€ 34028.70","7.598","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","995","€ 39427.90","2.082","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.277","€ 44443.31","6.881","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.076","€ 7187.37","7.670","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.265","€ 45465.86","7.531","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":536},{"label":"Mar","value":867},{"label":"Abr","value":559},{"label":"Mai","value":865},{"label":"Jun","value":721},{"label":"Jul","value":799},{"label":"Ago","value":734},{"label":"Set","value":804},{"label":"Out","value":811},{"label":"Nov","value":605},{"label":"Dez","value":852}];
const MX = 867;
