...
const KPIS = [{"l":"Auditorias Realizadas","v":"9.088","t":"-4.9%","d":"down"},{"l":"NC Abertas","v":"107","t":"-2.1%","d":"down"},{"l":"Conformidade (%)","v":"80.7%","t":"+11.9%","d":"up"},{"l":"CAPAs Pendentes","v":"2.630","t":"-0.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.059","91.9%","3.316","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.930","98.9%","6.819","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.710","92.8%","8.644","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.877","93.0%","7.986","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.894","84.8%","8.668","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":401},{"label":"Mar","value":390},{"label":"Abr","value":623},{"label":"Mai","value":690},{"label":"Jun","value":538},{"label":"Jul","value":507},{"label":"Ago","value":513},{"label":"Set","value":582},{"label":"Out","value":352},{"label":"Nov","value":609},{"label":"Dez","value":686}];
const MX = 690;
