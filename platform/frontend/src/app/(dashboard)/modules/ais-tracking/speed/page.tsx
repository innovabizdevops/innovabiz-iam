...
const ACCENT = "#4338ca";
const MODULE = "AIS Tracking";
const PAGE = "Speed Monitor";
const KPIS = [{"l":"Total Ais Tracking","v":"7.380","t":"+15.0%","d":"up"},{"l":"Speed Monitor Ativos","v":"8.087","t":"+13.5%","d":"up"},{"l":"Eficiência (%)","v":"80.8%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"75","t":"-0.3%","d":"down"}];
const COLS = ["ID","Speed Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ais Tracking #001","Ais Tracking #002","1.180","4.335","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Ais Tracking #002","Ais Tracking #003","1.043","3.383","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Ais Tracking #003","Ais Tracking #004","4.556","3.947","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Ais Tracking #004","Ais Tracking #005","5.779","3.179","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ais Tracking #005","Ais Tracking #001","7.376","1.090","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":882},{"label":"Fev","value":1022},{"label":"Mar","value":913},{"label":"Abr","value":959},{"label":"Mai","value":727},{"label":"Jun","value":766},{"label":"Jul","value":782},{"label":"Ago","value":909},{"label":"Set","value":836},{"label":"Out","value":724},{"label":"Nov","value":863},{"label":"Dez","value":1043}];
const MX = 1043;
