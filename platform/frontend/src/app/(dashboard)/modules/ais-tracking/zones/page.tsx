...
const PAGE = "Zone Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"6.222","t":"+2.4%","d":"up"},{"l":"Taxa Entrega (%)","v":"86.5%","t":"-5.2%","d":"down"},{"l":"Taxa Abertura (%)","v":"88.6%","t":"+7.7%","d":"up"},{"l":"Escalações","v":"5.673","t":"+10.7%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","5.027","77.3%","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","2.949","81.2%","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","6.722","87.1%","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","8.547","87.5%","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","5.115","88.3%","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":980},{"label":"Mar","value":704},{"label":"Abr","value":875},{"label":"Mai","value":869},{"label":"Jun","value":637},{"label":"Jul","value":621},{"label":"Ago","value":878},{"label":"Set","value":962},{"label":"Out","value":668},{"label":"Nov","value":949},{"label":"Dez","value":940}];
const MX = 980;
