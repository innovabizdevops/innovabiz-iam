...
export default function ActuarialModelPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Actuarial Model</h1><p className="text-sm text-muted-foreground">Actuarial Model • iBOS Enterprise</p></div>
